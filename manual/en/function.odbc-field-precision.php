...
<head>
  ...
  <title>PHP: odbc_field_precision - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-field-precision.php">
 <link rel="shorturl" href="https://www.php.net/odbc-field-precision">
 <link rel="alternate" href="https://www.php.net/odbc-field-precision" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-field-num.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-field-scale.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-field-precision.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-field-precision.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-field-precision.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-field-precision.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-field-precision.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-field-precision.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-field-precision.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-field-precision.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-field-precision.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-field-precision.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-field-precision.php" hreflang="zh">
...
<meta name="Description" content="Alias of odbc_field_len" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_field_precision - Manual" />
<meta name="twitter:description" content="Alias of odbc_field_len" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_field_precision - Manual" />
<meta itemprop="description" content="Alias of odbc_field_len" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of odbc_field_len" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-field-scale.php">
          odbc_field_scale &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-field-num.php">
          &laquo; odbc_field_num        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-field-precision.php' selected="selected">English</option>
            <option value='de/function.odbc-field-precision.php'>German</option>
            <option value='es/function.odbc-field-precision.php'>Spanish</option>
            <option value='fr/function.odbc-field-precision.php'>French</option>
            <option value='it/function.odbc-field-precision.php'>Italian</option>
            <option value='ja/function.odbc-field-precision.php'>Japanese</option>
            <option value='pt_BR/function.odbc-field-precision.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-field-precision.php'>Russian</option>
            <option value='tr/function.odbc-field-precision.php'>Turkish</option>
            <option value='uk/function.odbc-field-precision.php'>Ukrainian</option>
            <option value='zh/function.odbc-field-precision.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-field-precision" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_field_precision</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_field_precision</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.odbc-field-len.php" class="function">odbc_field_len()</a></span></span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-field-precision-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.odbc-field-precision-seealso">
   ...
   <ul class="simplelist">
    ...
    floating point number.</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-field-precision.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-field-precision%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-field-precision&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-field-precision.php">＋<small>add a note</small></a></span>
