...
<head>
  ...
  <title>PHP: Phar::apiVersion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.apiversion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.apiversion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.apiversion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.addfromstring.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.buildfromdirectory.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.apiversion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.apiversion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.apiversion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.apiversion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.apiversion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.apiversion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.apiversion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.apiversion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.apiversion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.apiversion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.apiversion.php" hreflang="zh">
...
<meta name="Description" content="Returns the api version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::apiVersion - Manual" />
<meta name="twitter:description" content="Returns the api version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::apiVersion - Manual" />
<meta itemprop="description" content="Returns the api version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the api version" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.buildfromdirectory.php">
          Phar::buildFromDirectory &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.addfromstring.php">
          &laquo; Phar::addFromString        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.apiversion.php' selected="selected">English</option>
            <option value='de/phar.apiversion.php'>German</option>
            <option value='es/phar.apiversion.php'>Spanish</option>
            <option value='fr/phar.apiversion.php'>French</option>
            <option value='it/phar.apiversion.php'>Italian</option>
            <option value='ja/phar.apiversion.php'>Japanese</option>
            <option value='pt_BR/phar.apiversion.php'>Brazilian Portuguese</option>
            <option value='ru/phar.apiversion.php'>Russian</option>
            <option value='tr/phar.apiversion.php'>Turkish</option>
            <option value='uk/phar.apiversion.php'>Ukrainian</option>
            <option value='zh/phar.apiversion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.apiversion" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-phar.apiversion-examples">
  ...
  <p class="para">
   <div class="example" id="example-800">
    <p><strong>Example #1 A <span class="function"><strong>Phar::apiVersion()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">1.1.1</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/apiVersion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.apiversion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.apiversion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.apiversion.php">＋<small>add a note</small></a></span>
