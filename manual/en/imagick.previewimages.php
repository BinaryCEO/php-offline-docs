...
<head>
  ...
  <title>PHP: Imagick::previewImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.previewimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.previewimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.previewimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.posterizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.previousimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.previewimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.previewimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.previewimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.previewimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.previewimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.previewimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.previewimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.previewimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.previewimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.previewimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.previewimages.php" hreflang="zh">
...
<meta name="Description" content="Quickly pin-point appropriate parameters for image processing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::previewImages - Manual" />
<meta name="twitter:description" content="Quickly pin-point appropriate parameters for image processing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::previewImages - Manual" />
<meta itemprop="description" content="Quickly pin-point appropriate parameters for image processing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Quickly pin-point appropriate parameters for image processing" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.previousimage.php">
          Imagick::previousImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.posterizeimage.php">
          &laquo; Imagick::posterizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.previewimages.php' selected="selected">English</option>
            <option value='de/imagick.previewimages.php'>German</option>
            <option value='es/imagick.previewimages.php'>Spanish</option>
            <option value='fr/imagick.previewimages.php'>French</option>
            <option value='it/imagick.previewimages.php'>Italian</option>
            <option value='ja/imagick.previewimages.php'>Japanese</option>
            <option value='pt_BR/imagick.previewimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.previewimages.php'>Russian</option>
            <option value='tr/imagick.previewimages.php'>Turkish</option>
            <option value='uk/imagick.previewimages.php'>Ukrainian</option>
            <option value='zh/imagick.previewimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.previewimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::previewImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::previewImages</span> &mdash; <span class="dc-title">Quickly pin-point appropriate parameters for image processing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.previewimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::previewImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$preview</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.previewimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">preview</code></dt>
     <dd>
      <p class="para">
       Preview type. See <a href="imagick.constants.php#imagick.constants.preview" class="link">Preview type constants</a>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.previewimages-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.previewimages-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/previewimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.previewimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.previewimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.previewimages.php">＋<small>add a note</small></a></span>
