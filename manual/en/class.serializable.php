...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.serializable.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/arrayaccess.offsetunset.php">
 <link rel="next" href="https://www.php.net/manual/en/serializable.serialize.php">
...
<meta name="Description" content="The Serializable interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Serializable - Manual" />
<meta name="twitter:description" content="The Serializable interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Serializable - Manual" />
<meta itemprop="description" content="The Serializable interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Serializable interface" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.serializable.php' selected="selected">English</option>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="serializable.intro">
   ...
   <div class="warning"><strong class="warning">Warning</strong>
    <p class="para">
     As of PHP 8.1.0, a class which implements <span class="interfacename"><strong class="interfacename">Serializable</strong></span> without also implementing <a href="language.oop5.magic.php#object.serialize" class="link">__serialize()</a> and <a href="language.oop5.magic.php#object.unserialize" class="link">__unserialize()</a> will generate a deprecation warning.
    </p>
   </div>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="serializable.serialize.php">Serializable::serialize</a> — String representation of object</li><li><a href="serializable.unserialize.php">Serializable::unserialize</a> — Constructs the object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/serializable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.serializable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.serializable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.serializable.php">＋<small>add a note</small></a></span>
...
<div class="foot"><a href="/manual/add-note.php?sect=class.serializable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.serializable.php">＋<small>add a note</small></a></div>
