...
<head>
  ...
  <title>PHP: sodium_crypto_generichash_update - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-update.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-generichash-update">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-generichash-update" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-update.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-generichash-update.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-generichash-update.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-generichash-update.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-generichash-update.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-generichash-update.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-generichash-update.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-generichash-update.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-generichash-update.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-generichash-update.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-generichash-update.php" hreflang="zh">
...
<meta name="Description" content="Add message to a hash" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_generichash_update - Manual" />
<meta name="twitter:description" content="Add message to a hash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_generichash_update - Manual" />
<meta itemprop="description" content="Add message to a hash" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add message to a hash" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-kdf-derive-from-key.php">
          sodium_crypto_kdf_derive_from_key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-generichash-keygen.php">
          &laquo; sodium_crypto_generichash_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-generichash-update.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-generichash-update.php'>German</option>
            <option value='es/function.sodium-crypto-generichash-update.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-generichash-update.php'>French</option>
            <option value='it/function.sodium-crypto-generichash-update.php'>Italian</option>
            <option value='ja/function.sodium-crypto-generichash-update.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-generichash-update.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-generichash-update.php'>Russian</option>
            <option value='tr/function.sodium-crypto-generichash-update.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-generichash-update.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-generichash-update.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-generichash-update" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_generichash_update</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_generichash_update</span> &mdash; <span class="dc-title">Add message to a hash</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-generichash-update-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>sodium_crypto_generichash_update</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$state</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-generichash-update-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      The return value of <span class="function"><a href="function.sodium-crypto-generichash-init.php" class="function">sodium_crypto_generichash_init()</a></span>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-generichash-update-returnvalues">
...
string(64) &quot;e16e28bbbbcc39d9f5b1cbc33c41f1d217808640103e57a41f24870f79831e04&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-generichash-update.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-generichash-update%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-generichash-update&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-generichash-update.php">＋<small>add a note</small></a></span>
