...
<head>
  ...
  <title>PHP: ocistatementtype - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocistatementtype.php">
 <link rel="shorturl" href="https://www.php.net/ocistatementtype">
 <link rel="alternate" href="https://www.php.net/ocistatementtype" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocisetprefetch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociwritelobtofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocistatementtype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocistatementtype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocistatementtype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocistatementtype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocistatementtype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocistatementtype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocistatementtype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocistatementtype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocistatementtype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocistatementtype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocistatementtype.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_statement_type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocistatementtype - Manual" />
<meta name="twitter:description" content="Alias of oci_statement_type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocistatementtype - Manual" />
<meta itemprop="description" content="Alias of oci_statement_type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_statement_type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ociwritelobtofile.php">
          ociwritelobtofile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocisetprefetch.php">
          &laquo; ocisetprefetch        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocistatementtype.php' selected="selected">English</option>
            <option value='de/function.ocistatementtype.php'>German</option>
            <option value='es/function.ocistatementtype.php'>Spanish</option>
            <option value='fr/function.ocistatementtype.php'>French</option>
            <option value='it/function.ocistatementtype.php'>Italian</option>
            <option value='ja/function.ocistatementtype.php'>Japanese</option>
            <option value='pt_BR/function.ocistatementtype.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocistatementtype.php'>Russian</option>
            <option value='tr/function.ocistatementtype.php'>Turkish</option>
            <option value='uk/function.ocistatementtype.php'>Ukrainian</option>
            <option value='zh/function.ocistatementtype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocistatementtype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocistatementtype</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocistatementtype</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-statement-type.php" class="function">oci_statement_type()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocistatementtype-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-statement-type.php" class="function">oci_statement_type()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocistatementtype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocistatementtype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocistatementtype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocistatementtype.php">＋<small>add a note</small></a></span>
