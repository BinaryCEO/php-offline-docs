...
<head>
  ...
  <title>PHP: UI\Exception\InvalidArgumentException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-exception-invalidargumentexception.php">
 <link rel="shorturl" href="https://www.php.net/ui-exception-invalidargumentexception">
 <link rel="alternate" href="https://www.php.net/ui-exception-invalidargumentexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.ui-key.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ui-exception-runtimeexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-exception-invalidargumentexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-exception-invalidargumentexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-exception-invalidargumentexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-exception-invalidargumentexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-exception-invalidargumentexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-exception-invalidargumentexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-exception-invalidargumentexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-exception-invalidargumentexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-exception-invalidargumentexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-exception-invalidargumentexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-exception-invalidargumentexception.php" hreflang="zh">
...
<meta name="Description" content="InvalidArgumentException" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Exception\InvalidArgumentException - Manual" />
<meta name="twitter:description" content="InvalidArgumentException" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Exception\InvalidArgumentException - Manual" />
<meta itemprop="description" content="InvalidArgumentException" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="InvalidArgumentException" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.ui-exception-runtimeexception.php">
          UI\Exception\RuntimeException &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-exception-invalidargumentexception.php' selected="selected">English</option>
            <option value='de/class.ui-exception-invalidargumentexception.php'>German</option>
            <option value='es/class.ui-exception-invalidargumentexception.php'>Spanish</option>
            <option value='fr/class.ui-exception-invalidargumentexception.php'>French</option>
            <option value='it/class.ui-exception-invalidargumentexception.php'>Italian</option>
            <option value='ja/class.ui-exception-invalidargumentexception.php'>Japanese</option>
            <option value='pt_BR/class.ui-exception-invalidargumentexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-exception-invalidargumentexception.php'>Russian</option>
            <option value='tr/class.ui-exception-invalidargumentexception.php'>Turkish</option>
            <option value='uk/class.ui-exception-invalidargumentexception.php'>Ukrainian</option>
            <option value='zh/class.ui-exception-invalidargumentexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-exception-invalidargumentexception" class="reference">

 <h1 class="title">InvalidArgumentException</h1>
 

 <div class="partintro"><p class="verinfo">(UI 1.0.3)</p>


  <div class="section" id="ui-exception-invalidargumentexception.intro">
  ...
  <div class="section" id="ui-exception-invalidargumentexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Exception\InvalidArgumentException</strong>
     </span>
     ...
     <span class="oointerface"><span class="modifier">implements</span> 
       <a href="class.throwable.php" class="interfacename">Throwable</a></span> {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.exception.invalidargumentexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-exception-invalidargumentexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-exception-invalidargumentexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-exception-invalidargumentexception.php">＋<small>add a note</small></a></span>
