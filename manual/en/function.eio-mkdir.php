...
<head>
  ...
  <title>PHP: eio_mkdir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-mkdir.php">
 <link rel="shorturl" href="https://www.php.net/eio-mkdir">
 <link rel="alternate" href="https://www.php.net/eio-mkdir" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-lstat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-mknod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-mkdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-mkdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-mkdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-mkdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-mkdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-mkdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-mkdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-mkdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-mkdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-mkdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-mkdir.php" hreflang="zh">
...
<meta name="Description" content="Create directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_mkdir - Manual" />
<meta name="twitter:description" content="Create directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_mkdir - Manual" />
<meta itemprop="description" content="Create directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create directory" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-mknod.php">
          eio_mknod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-lstat.php">
          &laquo; eio_lstat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-mkdir.php' selected="selected">English</option>
            <option value='de/function.eio-mkdir.php'>German</option>
            <option value='es/function.eio-mkdir.php'>Spanish</option>
            <option value='fr/function.eio-mkdir.php'>French</option>
            <option value='it/function.eio-mkdir.php'>Italian</option>
            <option value='ja/function.eio-mkdir.php'>Japanese</option>
            <option value='pt_BR/function.eio-mkdir.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-mkdir.php'>Russian</option>
            <option value='tr/function.eio-mkdir.php'>Turkish</option>
            <option value='uk/function.eio-mkdir.php'>Ukrainian</option>
            <option value='zh/function.eio-mkdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-mkdir" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_mkdir</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_mkdir</span> &mdash; <span class="dc-title">Create directory</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-mkdir-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_mkdir</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_mkdir()</strong></span> creates directory with specified access
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-mkdir-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-mkdir-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_mkdir()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.eio-mkdir-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-3516">
   <p><strong>Example #1 <span class="function"><strong>eio_mkdir()</strong></span> example</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$temp_dirname </span><span style="color: #007700">= </span><span style="color: #DD0000">"eio-temp-dir"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Is called when eio_mkdir() finishes */<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">my_mkdir_callback</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br /> if (</span><span style="color: #0000BB">$result </span><span style="color: #007700">== </span><span style="color: #0000BB">0 </span><span style="color: #007700">&amp;&amp; </span><span style="color: #0000BB">is_dir</span><span style="color: #007700">(</span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">)<br />   &amp;&amp; !</span><span style="color: #0000BB">is_readable</span><span style="color: #007700">(</span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">)<br />   &amp;&amp; </span><span style="color: #0000BB">is_writable</span><span style="color: #007700">(</span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">)) {<br />  echo </span><span style="color: #DD0000">"eio_mkdir_ok"</span><span style="color: #007700">;<br /> }<br /><br /> </span><span style="color: #FF8000">// Remove directory<br />    </span><span style="color: #007700">if (</span><span style="color: #0000BB">file_exists</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">))<br />        </span><span style="color: #0000BB">rmdir</span><span style="color: #007700">(</span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #FF8000">// Create directory with access mode 0300<br /></span><span style="color: #0000BB">eio_mkdir</span><span style="color: #007700">(</span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">, </span><span style="color: #0000BB">0300</span><span style="color: #007700">, </span><span style="color: #0000BB">EIO_PRI_DEFAULT</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_mkdir_callback"</span><span style="color: #007700">, </span><span style="color: #0000BB">$temp_dirname</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">eio_event_loop</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

   <div class="example-contents"><p>The above example will output
something similar to:</p></div>
   <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">eio_mkdir_ok</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-mkdir-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-rmdir.php" class="function" rel="rdfs-seeAlso">eio_rmdir()</a> - Remove a directory</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-mkdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-mkdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-mkdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-mkdir.php">＋<small>add a note</small></a></span>
