...
<head>
  ...
  <title>PHP: pg_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-prepare.php">
 <link rel="shorturl" href="https://www.php.net/pg-prepare">
 <link rel="alternate" href="https://www.php.net/pg-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-port.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-put-line.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-prepare.php" hreflang="zh">
...
<meta name="Description" content="Submits a request to the server to create a prepared statement with the
   given parameters, and waits for completion" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_prepare - Manual" />
<meta name="twitter:description" content="Submits a request to the server to create a prepared statement with the
   given parameters, and waits for completion" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_prepare - Manual" />
<meta itemprop="description" content="Submits a request to the server to create a prepared statement with the
   given parameters, and waits for completion" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Submits a request to the server to create a prepared statement with the
   given parameters, and waits for completion" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-prepare.php' selected="selected">English</option>
            <option value='de/function.pg-prepare.php'>German</option>
            <option value='es/function.pg-prepare.php'>Spanish</option>
            <option value='fr/function.pg-prepare.php'>French</option>
            <option value='it/function.pg-prepare.php'>Italian</option>
            <option value='ja/function.pg-prepare.php'>Japanese</option>
            <option value='pt_BR/function.pg-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-prepare.php'>Russian</option>
            <option value='tr/function.pg-prepare.php'>Turkish</option>
            <option value='uk/function.pg-prepare.php'>Ukrainian</option>
            <option value='zh/function.pg-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-prepare" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-send-execute.php" class="function" rel="rdfs-seeAlso">pg_send_execute()</a> - Sends a request to execute a prepared statement with given parameters, without waiting for the result(s)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-prepare.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="51951">  <div class="votes">
    <div id="Vu51951">
    <a href="/manual/vote-note.php?id=51951&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51951">
    <a href="/manual/vote-note.php?id=51951&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51951" title="75% like this...">
    4
    </div>
  </div>
  <a href="#51951" class="name">
  <strong class="user"><em>david at fetter dot org</em></strong></a><a class="genanchor" href="#51951"> &para;</a><div class="date" title="2005-04-16 08:33"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51951">
<div class="phpcode"><code><span class="html">SQL is often a complicated piece of code by itself, so you may wish put it inside a "here doc."  This will help you read it wherever it appears and test it by itself via a command-line or gui client.<br /><br />$sql = &lt;&lt;&lt;SQL<br />SELECT a.foo, b.bar, c.baz<br />FROM<br />    table_a a<br />LEFT JOIN<br />    table_b b<br />ON (<br />    a.a_id = b.a_id<br />)<br />JOIN<br />    table_c c<br />ON (<br />    b.c_id = c.c_id<br />)<br />WHERE c.name = $1<br />SQL;</span></code></div>
  </div>
 </div>
  <div class="note" id="70987">  <div class="votes">
    <div id="Vu70987">
    <a href="/manual/vote-note.php?id=70987&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd70987">
    <a href="/manual/vote-note.php?id=70987&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V70987" title="61% like this...">
    3
    </div>
  </div>
  <a href="#70987" class="name">
  <strong class="user"><em>rodrigo at fabricadeideias dot com</em></strong></a><a class="genanchor" href="#70987"> &para;</a><div class="date" title="2006-11-07 04:05"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70987">
<div class="phpcode"><code><span class="html">If you decide to deallocate (unprepare) a previously prepared sql command it might be better to quote the sql name as in<br /><br />  DEALLOCATE "theNameOfMySQL"<br /><br />instead of (the more natural)<br /><br />  DEALLOCATE theNameOfMySQL<br /><br />PostgerSQL preserves the case of your identifiers if, and only if, you quote them. The pg_prepare function preserves the case of the sql name you use.<br /><br />A complete example would be<br /><br />  $sql = 'SELECT * FROM user WHERE cod_user = $1';<br />  $sqlName = 'selectUserByCode';<br />  if (!pg_prepare ($sqlName, $sql)) {<br />    die("Can't prepare '$sql': " . pg_last_error());<br />  }<br />  $rs = pg_execute($sqlName, array(1));<br />  do whatever you want with $rs and finally<br />  $sql = sprintf(<br />    'DEALLOCATE "%s"',<br />    pg_escape_string($sqlName)<br />  );<br />  if(!pg_query($sql)) {<br />    die("Can't query '$sql': " . pg_last_error());<br />  }</span></code></div>
  </div>
 </div>
  <div class="note" id="78068">  <div class="votes">
    <div id="Vu78068">
    <a href="/manual/vote-note.php?id=78068&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78068">
    <a href="/manual/vote-note.php?id=78068&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78068" title="66% like this...">
    1
    </div>
  </div>
  <a href="#78068" class="name">
  <strong class="user"><em>mike at musskopf dot com</em></strong></a><a class="genanchor" href="#78068"> &para;</a><div class="date" title="2007-09-26 02:14"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom78068">
<div class="phpcode"><code><span class="html">I had some problems with this function. When you use pg_prepare() with a function like date_trunc('day', $1) you need to specify the data type.<br /><br />The solution was use the Pear MDB2 but with some changes in code. The original code try to use pg_prepare() too, with errors.</span></code></div>
  </div>
 </div>
  <div class="note" id="108232">  <div class="votes">
    <div id="Vu108232">
    <a href="/manual/vote-note.php?id=108232&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108232">
    <a href="/manual/vote-note.php?id=108232&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108232" title="60% like this...">
    1
    </div>
  </div>
  <a href="#108232" class="name">
  <strong class="user"><em>geompse at gmail dot com</em></strong></a><a class="genanchor" href="#108232"> &para;</a><div class="date" title="2012-04-09 11:04"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108232">
<div class="phpcode"><code><span class="html">The given name cannot be the statement itself.<br />It has a maximum length and will truncate.<br /><br />If two queries begin the same way, only the first one will be used.</span></code></div>
  </div>
 </div>
  <div class="note" id="62675">  <div class="votes">
    <div id="Vu62675">
    <a href="/manual/vote-note.php?id=62675&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd62675">
    <a href="/manual/vote-note.php?id=62675&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V62675" title="50% like this...">
    0
    </div>
  </div>
  <a href="#62675" class="name">
  <strong class="user"><em>scott dot marlowe at gmail dot com</em></strong></a><a class="genanchor" href="#62675"> &para;</a><div class="date" title="2006-03-06 07:20"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom62675">
<div class="phpcode"><code><span class="html">Note that if you are preparing a query with an in clause with a list of items, you will need to prepare each item separately.
<br />
<br />$result = pg_prepare($dbconn, "my_query", 'SELECT * FROM shops WHERE name IN($1,$2,$3)');
<br />
<br />$result = pg_execute($dbconn, "my_query", array("coffee", "beer", "hard"));
<br />
<br />This means that you can't just prepare a query with an arbitrary in() list.</span></code></div>
  </div>
 </div>
  <div class="note" id="80088">  <div class="votes">
    <div id="Vu80088">
    <a href="/manual/vote-note.php?id=80088&amp;page=function.pg-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80088">
    <a href="/manual/vote-note.php?id=80088&amp;page=function.pg-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80088" title="16% like this...">
    -4
    </div>
  </div>
  <a href="#80088" class="name">
  <strong class="user"><em>andy at petdance dot com</em></strong></a><a class="genanchor" href="#80088"> &para;</a><div class="date" title="2007-12-28 07:57"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80088">
<div class="phpcode"><code><span class="html">Any error in the prepare is available from pg_last_error().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-prepare.php">＋<small>add a note</small></a></div>
