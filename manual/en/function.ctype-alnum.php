...
<head>
  ...
  <title>PHP: ctype_alnum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-alnum.php">
 <link rel="shorturl" href="https://www.php.net/ctype-alnum">
 <link rel="alternate" href="https://www.php.net/ctype-alnum" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-alpha.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-alnum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-alnum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-alnum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-alnum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-alnum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-alnum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-alnum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-alnum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-alnum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-alnum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-alnum.php" hreflang="zh">
...
<meta name="Description" content="Check for alphanumeric character(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_alnum - Manual" />
<meta name="twitter:description" content="Check for alphanumeric character(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_alnum - Manual" />
<meta itemprop="description" content="Check for alphanumeric character(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for alphanumeric character(s)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ctype-alpha.php">
          ctype_alpha &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.ctype.php">
          &laquo; Ctype Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-alnum.php' selected="selected">English</option>
            <option value='de/function.ctype-alnum.php'>German</option>
            <option value='es/function.ctype-alnum.php'>Spanish</option>
            <option value='fr/function.ctype-alnum.php'>French</option>
            <option value='it/function.ctype-alnum.php'>Italian</option>
            <option value='ja/function.ctype-alnum.php'>Japanese</option>
            <option value='pt_BR/function.ctype-alnum.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-alnum.php'>Russian</option>
            <option value='tr/function.ctype-alnum.php'>Turkish</option>
            <option value='uk/function.ctype-alnum.php'>Ukrainian</option>
            <option value='zh/function.ctype-alnum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-alnum" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isalnum.php" class="function" rel="rdfs-seeAlso">IntlChar::isalnum()</a> - Check if code point is an alphanumeric character</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-alnum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-alnum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-alnum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-alnum.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92393">  <div class="votes">
    <div id="Vu92393">
    <a href="/manual/vote-note.php?id=92393&amp;page=function.ctype-alnum&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92393">
    <a href="/manual/vote-note.php?id=92393&amp;page=function.ctype-alnum&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92393" title="80% like this...">
    98
    </div>
  </div>
  <a href="#92393" class="name">
  <strong class="user"><em>thinice at gmail dot com</em></strong></a><a class="genanchor" href="#92393"> &para;</a><div class="date" title="2009-07-22 02:46"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92393">
<div class="phpcode"><code><span class="html">ctype_alnum() is a godsend for quick and easy username/data filtering when used in conjunction with str_replace().
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="118587">  <div class="votes">
    <div id="Vu118587">
    <a href="/manual/vote-note.php?id=118587&amp;page=function.ctype-alnum&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118587">
    <a href="/manual/vote-note.php?id=118587&amp;page=function.ctype-alnum&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118587" title="68% like this...">
    11
    </div>
  </div>
  <a href="#118587" class="name">
  <strong class="user"><em>marcelocamargo at linuxmail dot org</em></strong></a><a class="genanchor" href="#118587"> &para;</a><div class="date" title="2016-01-04 04:42"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118587">
<div class="phpcode"><code><span class="html">It is also important to note that the behavior of `ctype_alnum` differs according to the operating system. For UNIX-based operating system, if you pass a value that is not a string (or an overloaded object), independently of the value, it will always result in false. However, if we do the same on Windows, using, for example, -1 as literal (a minus and a number greater than 0), we'll have true as result.<br /><br /><span class="default">&lt;?php var_dump</span><span class="keyword">(</span><span class="default">ctype_alnum</span><span class="keyword">(-</span><span class="default">1</span><span class="keyword">));<br /></span><span class="comment">// UNIX: bool(false)<br />// Windows: bool(true)</span></span></code></div>
  </div>
 </div>
  <div class="note" id="111224">  <div class="votes">
    <div id="Vu111224">
    <a href="/manual/vote-note.php?id=111224&amp;page=function.ctype-alnum&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111224">
    <a href="/manual/vote-note.php?id=111224&amp;page=function.ctype-alnum&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111224" title="61% like this...">
    23
    </div>
  </div>
  <a href="#111224" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#111224"> &para;</a><div class="date" title="2013-01-28 05:12"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111224">
<div class="phpcode"><code><span class="html">Quicktip: If ctype is not enabled by default on your server, replace ctype_alnum($var) with preg_match('/^[a-zA-Z0-9]+$/', $var).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ctype-alnum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-alnum.php">＋<small>add a note</small></a></div>
