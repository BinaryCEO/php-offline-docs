...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.hashook.php">
...
<meta name="Description" content="Checks if property has a default value declared" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::hasDefaultValue - Manual" />
<meta name="twitter:description" content="Checks if property has a default value declared" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::hasDefaultValue - Manual" />
<meta itemprop="description" content="Checks if property has a default value declared" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if property has a default value declared" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.hasdefaultvalue.php' selected="selected">English</option>
            ...
            <option value='fr/reflectionproperty.hasdefaultvalue.php'>French</option>
 ...
 <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::hasDefaultValue()</strong></span> example</strong></p>
...
Fatal error: Uncaught ReflectionException: Property Foo::$pong does not exist in example.php</pre>
 ...
 <li><span class="methodname"><a href="reflectionproperty.getdefaultvalue.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::getDefaultValue()</a> - Returns the default value declared for a property</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/hasdefaultvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.hasdefaultvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.hasdefaultvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php">＋<small>add a note</small></a></span>
