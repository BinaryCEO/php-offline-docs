...
<head>
  ...
  <title>PHP: imagegrabwindow - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegrabwindow.php">
 <link rel="shorturl" href="https://www.php.net/imagegrabwindow">
 <link rel="alternate" href="https://www.php.net/imagegrabwindow" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegrabscreen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageinterlace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagegrabwindow.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagegrabwindow.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagegrabwindow.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagegrabwindow.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagegrabwindow.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagegrabwindow.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagegrabwindow.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagegrabwindow.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagegrabwindow.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagegrabwindow.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagegrabwindow.php" hreflang="zh">
...
<meta name="Description" content="Captures a window" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegrabwindow - Manual" />
<meta name="twitter:description" content="Captures a window" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegrabwindow - Manual" />
<meta itemprop="description" content="Captures a window" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Captures a window" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imageinterlace.php">
          imageinterlace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagegrabscreen.php">
          &laquo; imagegrabscreen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegrabwindow.php' selected="selected">English</option>
            <option value='de/function.imagegrabwindow.php'>German</option>
            <option value='es/function.imagegrabwindow.php'>Spanish</option>
            <option value='fr/function.imagegrabwindow.php'>French</option>
            <option value='it/function.imagegrabwindow.php'>Italian</option>
            <option value='ja/function.imagegrabwindow.php'>Japanese</option>
            <option value='pt_BR/function.imagegrabwindow.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagegrabwindow.php'>Russian</option>
            <option value='tr/function.imagegrabwindow.php'>Turkish</option>
            <option value='uk/function.imagegrabwindow.php'>Ukrainian</option>
            <option value='zh/function.imagegrabwindow.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagegrabwindow" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagegrabwindow</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagegrabwindow</span> &mdash; <span class="dc-title">Captures a window</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imagegrabwindow-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagegrabwindow</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$client_area</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagegrabwindow-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">client_area</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagegrabwindow-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an image object on success, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-function.imagegrabwindow-errors">
  <h3 class="title">Errors/Exceptions</h3>
  <p class="para">
   E_NOTICE is issued if <code class="parameter">handle</code> is invalid
   window handle.
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagegrabwindow-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">client_area</code> expects a <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> now;
 ...
 <div class="refsect1 examples" id="refsect1-function.imagegrabwindow-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2912">
    <p><strong>Example #1 <span class="function"><strong>imagegrabwindow()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$browser </span><span style="color: #007700">= new </span><span style="color: #0000BB">COM</span><span style="color: #007700">(</span><span style="color: #DD0000">"InternetExplorer.Application"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">$browser</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">HWND</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$browser</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Visible </span><span style="color: #007700">= </span><span style="color: #0000BB">true</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$browser</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Navigate</span><span style="color: #007700">(</span><span style="color: #DD0000">"http://www.libgd.org"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Still working? */<br /></span><span style="color: #007700">while (</span><span style="color: #0000BB">$browser</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Busy</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">com_message_pump</span><span style="color: #007700">(</span><span style="color: #0000BB">4000</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagegrabwindow</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$browser</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Quit</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">"iesnap.png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagegrabwindow-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagegrabscreen.php" class="function" rel="rdfs-seeAlso">imagegrabscreen()</a> - Captures the whole screen</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegrabwindow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegrabwindow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegrabwindow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegrabwindow.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="78135">  <div class="votes">
    <div id="Vu78135">
    <a href="/manual/vote-note.php?id=78135&amp;page=function.imagegrabwindow&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78135">
    <a href="/manual/vote-note.php?id=78135&amp;page=function.imagegrabwindow&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78135" title="69% like this...">
    5
    </div>
  </div>
  <a href="#78135" class="name">
  <strong class="user"><em>nico -&gt;atdot</em></strong></a><a class="genanchor" href="#78135"> &para;</a><div class="date" title="2007-09-29 08:37"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom78135">
<div class="phpcode"><code><span class="html">If you just want to take a screenshot of a website WITHOUT the ugly IE window around it, the easiest way is setting the "Fullscreen" property to TRUE.<br /><br />$browser-&gt;Fullscreen = true;<br /><br />This is basically the same as pressing F11 once the browser is open, so you just get the actual website.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagegrabwindow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegrabwindow.php">＋<small>add a note</small></a></div>
