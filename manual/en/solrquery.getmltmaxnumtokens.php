...
<head>
  ...
  <title>PHP: SolrQuery::getMltMaxNumTokens - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltmaxnumqueryterms.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltmaxnumtokens.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltmaxnumtokens.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltmaxnumtokens.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltmaxnumtokens.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltmaxnumtokens.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltmaxnumtokens.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltmaxnumtokens.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltmaxnumtokens.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltmaxnumtokens.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltmaxnumtokens.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of tokens to parse in each document field that is not stored with TermVector support" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltMaxNumTokens - Manual" />
<meta name="twitter:description" content="Returns the maximum number of tokens to parse in each document field that is not stored with TermVector support" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltMaxNumTokens - Manual" />
<meta itemprop="description" content="Returns the maximum number of tokens to parse in each document field that is not stored with TermVector support" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of tokens to parse in each document field that is not stored with TermVector support" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getmltmaxwordlength.php">
          SolrQuery::getMltMaxWordLength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltmaxnumqueryterms.php">
          &laquo; SolrQuery::getMltMaxNumQueryTerms        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltmaxnumtokens.php' selected="selected">English</option>
            <option value='de/solrquery.getmltmaxnumtokens.php'>German</option>
            <option value='es/solrquery.getmltmaxnumtokens.php'>Spanish</option>
            <option value='fr/solrquery.getmltmaxnumtokens.php'>French</option>
            <option value='it/solrquery.getmltmaxnumtokens.php'>Italian</option>
            <option value='ja/solrquery.getmltmaxnumtokens.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltmaxnumtokens.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltmaxnumtokens.php'>Russian</option>
            <option value='tr/solrquery.getmltmaxnumtokens.php'>Turkish</option>
            <option value='uk/solrquery.getmltmaxnumtokens.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltmaxnumtokens.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltmaxnumtokens" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltMaxNumTokens</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltMaxNumTokens</span> &mdash; <span class="dc-title">Returns the maximum number of tokens to parse in each document field that is not stored with TermVector support</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltmaxnumtokens-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltMaxNumTokens</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltmaxnumtokens-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltmaxnumtokens-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltmaxnumtokens.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltmaxnumtokens%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltmaxnumtokens&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltmaxnumtokens.php">＋<small>add a note</small></a></span>
