...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/uopz.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/uopz.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/uopz.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.uopz.php">
 <link rel="prev" href="https://www.php.net/manual/en/uopz.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.uopz.php">

 <link rel="alternate" href="https://www.php.net/manual/en/uopz.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/uopz.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/uopz.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/uopz.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/uopz.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/uopz.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/uopz.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/uopz.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/uopz.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/uopz.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/uopz.constants.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ref.uopz.php">
          Uopz Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="uopz.configuration.php">
          &laquo; Runtime Configuration        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.php.php'>Affecting PHP's Behaviour</a></li>      <li><a href='book.uopz.php'>uopz</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/uopz.constants.php' selected="selected">English</option>
            <option value='de/uopz.constants.php'>German</option>
            <option value='es/uopz.constants.php'>Spanish</option>
            <option value='fr/uopz.constants.php'>French</option>
            <option value='it/uopz.constants.php'>Italian</option>
            <option value='ja/uopz.constants.php'>Japanese</option>
            <option value='pt_BR/uopz.constants.php'>Brazilian Portuguese</option>
            <option value='ru/uopz.constants.php'>Russian</option>
            <option value='tr/uopz.constants.php'>Turkish</option>
            <option value='uk/uopz.constants.php'>Ukrainian</option>
            <option value='zh/uopz.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="uopz.constants" class="appendix">
  ...
  <dl>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uopz/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fuopz.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=uopz.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/uopz.constants.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122526">  <div class="votes">
    <div id="Vu122526">
    <a href="/manual/vote-note.php?id=122526&amp;page=uopz.constants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122526">
    <a href="/manual/vote-note.php?id=122526&amp;page=uopz.constants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122526" title="50% like this...">
    0
    </div>
  </div>
  <a href="#122526" class="name">
  <strong class="user"><em>ASchmidt at Anamera dot net</em></strong></a><a class="genanchor" href="#122526"> &para;</a><div class="date" title="2018-03-20 03:37"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122526">
<div class="phpcode"><code><span class="html">At least with uops 5.02 and PHP 7.2 (Win64), the constant ZEND_ACC_FETCH is not defined - while others are.<br /><br />You can use:<br /><br />if ( !defined( 'ZEND_ACC_FETCH' ) )<br />    define( 'ZEND_ACC_FETCH', PHP_INT_MAX );</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=uopz.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/uopz.constants.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="book.uopz.php">uopz</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="intro.uopz.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
                            <a href="uopz.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="current">
                            <a href="uopz.constants.php" title="Predefined Constants">Predefined Constants</a>
                        </li>
                                                <li class="">
                            <a href="ref.uopz.php" title="Uopz Functions">Uopz Functions</a>
                        </li>
