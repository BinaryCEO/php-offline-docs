...
<head>
  ...
  <title>PHP: Gmagick::queryfonts - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.queryfonts.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.queryfonts.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryfonts.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.queryfontmetrics.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.queryformats.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.queryfonts.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.queryfonts.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.queryfonts.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.queryfonts.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.queryfonts.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.queryfonts.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.queryfonts.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.queryfonts.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.queryfonts.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.queryfonts.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.queryfonts.php" hreflang="zh">
...
<meta name="Description" content="Returns the configured fonts" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::queryfonts - Manual" />
<meta name="twitter:description" content="Returns the configured fonts" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::queryfonts - Manual" />
<meta itemprop="description" content="Returns the configured fonts" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the configured fonts" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.queryformats.php">
          Gmagick::queryformats &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.queryfontmetrics.php">
          &laquo; Gmagick::queryfontmetrics        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.queryfonts.php' selected="selected">English</option>
            <option value='de/gmagick.queryfonts.php'>German</option>
            <option value='es/gmagick.queryfonts.php'>Spanish</option>
            <option value='fr/gmagick.queryfonts.php'>French</option>
            <option value='it/gmagick.queryfonts.php'>Italian</option>
            <option value='ja/gmagick.queryfonts.php'>Japanese</option>
            <option value='pt_BR/gmagick.queryfonts.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.queryfonts.php'>Russian</option>
            <option value='tr/gmagick.queryfonts.php'>Turkish</option>
            <option value='uk/gmagick.queryfonts.php'>Ukrainian</option>
            <option value='zh/gmagick.queryfonts.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.queryfonts" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::queryfonts</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::queryfonts</span> &mdash; <span class="dc-title">Returns the configured fonts</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.queryfonts-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::queryfonts</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code><span class="initializer"> = &quot;*&quot;</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.queryfonts-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.queryfonts-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.queryfonts-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/queryfonts.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.queryfonts%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.queryfonts&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.queryfonts.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94404">  <div class="votes">
    <div id="Vu94404">
    <a href="/manual/vote-note.php?id=94404&amp;page=gmagick.queryfonts&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94404">
    <a href="/manual/vote-note.php?id=94404&amp;page=gmagick.queryfonts&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94404" title="no votes...">
    0
    </div>
  </div>
  <a href="#94404" class="name">
  <strong class="user"><em>Mathew Oransky</em></strong></a><a class="genanchor" href="#94404"> &para;</a><div class="date" title="2009-11-02 06:39"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94404">
<div class="phpcode"><code><span class="html">An example of how to get the fonts available.<br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Gmagick</span><span class="keyword">();<br /></span><span class="default">$fonts </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">queryfonts</span><span class="keyword">();<br />foreach(</span><span class="default">$fonts </span><span class="keyword">as </span><span class="default">$font</span><span class="keyword">){<br />  echo </span><span class="default">$font</span><span class="keyword">.</span><span class="string">"\n"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.queryfonts&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.queryfonts.php">＋<small>add a note</small></a></div>
