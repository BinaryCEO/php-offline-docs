...
<head>
  ...
  <title>PHP: Phar::extractTo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.extractto.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.extractto.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.extractto.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.destruct.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.getalias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.extractto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.extractto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.extractto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.extractto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.extractto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.extractto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.extractto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.extractto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.extractto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.extractto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.extractto.php" hreflang="zh">
...
<meta name="Description" content="Extract the contents of a phar archive to a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::extractTo - Manual" />
<meta name="twitter:description" content="Extract the contents of a phar archive to a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::extractTo - Manual" />
<meta itemprop="description" content="Extract the contents of a phar archive to a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extract the contents of a phar archive to a directory" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.getalias.php">
          Phar::getAlias &raquo;
              ...
              <div class="prev">
        <a href="phar.destruct.php">
          &laquo; Phar::__destruct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.extractto.php' selected="selected">English</option>
            <option value='de/phar.extractto.php'>German</option>
            <option value='es/phar.extractto.php'>Spanish</option>
            <option value='fr/phar.extractto.php'>French</option>
            <option value='it/phar.extractto.php'>Italian</option>
            <option value='ja/phar.extractto.php'>Japanese</option>
            <option value='pt_BR/phar.extractto.php'>Brazilian Portuguese</option>
            <option value='ru/phar.extractto.php'>Russian</option>
            <option value='tr/phar.extractto.php'>Turkish</option>
            <option value='uk/phar.extractto.php'>Ukrainian</option>
            <option value='zh/phar.extractto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.extractto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::extractTo</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::extractTo</span> &mdash; <span class="dc-title">Extract the contents of a phar archive to a directory</span></p>
 ...
 <div class="refsect1 description" id="refsect1-phar.extractto-description">
  ...
  <p class="para rdfs-comment">
   ...
   The second parameter <code class="parameter">files</code> can be either the name of a file or
 ...
 <div class="refsect1 parameters" id="refsect1-phar.extractto-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Path to extract the given <code class="parameter">files</code> to
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to skip this param
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-phar.extractto-examples">
  ...
  <p class="para">
   <div class="example" id="example-818">
    <p><strong>Example #1 A <span class="function"><strong>Phar::extractTo()</strong></span> example</strong></p>
...
an underscore, but instead fails to extract such files.</p></p></blockquote>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.extractto-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="phardata.extractto.php" class="function" rel="rdfs-seeAlso">PharData::extractTo()</a> - Extract the contents of a tar/zip archive to a directory</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/extractTo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.extractto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.extractto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.extractto.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124081">  <div class="votes">
    <div id="Vu124081">
    <a href="/manual/vote-note.php?id=124081&amp;page=phar.extractto&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124081">
    <a href="/manual/vote-note.php?id=124081&amp;page=phar.extractto&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124081" title="66% like this...">
    3
    </div>
  </div>
  <a href="#124081" class="name">
  <strong class="user"><em>msucco at mac dot com</em></strong></a><a class="genanchor" href="#124081"> &para;</a><div class="date" title="2019-07-30 08:09"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124081">
<div class="phpcode"><code><span class="html">On the command line (*nix) you can use the following command to extract a phar file:<br /><br />$ mkdir tmp &amp;&amp; cd $_<br />$ phar extract -f ../file.phar</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.extractto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.extractto.php">＋<small>add a note</small></a></div>
