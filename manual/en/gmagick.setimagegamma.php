...
<head>
  ...
  <title>PHP: Gmagick::setimagegamma - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagegamma.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagegamma.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagegamma.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageformat.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagegamma.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagegamma.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagegamma.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagegamma.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagegamma.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagegamma.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagegamma.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagegamma.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagegamma.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagegamma.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagegamma.php" hreflang="zh">
...
<meta name="Description" content="Sets the image gamma" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setimagegamma - Manual" />
<meta name="twitter:description" content="Sets the image gamma" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagegamma - Manual" />
<meta itemprop="description" content="Sets the image gamma" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image gamma" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagegreenprimary.php">
          Gmagick::setimagegreenprimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageformat.php">
          &laquo; Gmagick::setimageformat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagegamma.php' selected="selected">English</option>
            <option value='de/gmagick.setimagegamma.php'>German</option>
            <option value='es/gmagick.setimagegamma.php'>Spanish</option>
            <option value='fr/gmagick.setimagegamma.php'>French</option>
            <option value='it/gmagick.setimagegamma.php'>Italian</option>
            <option value='ja/gmagick.setimagegamma.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagegamma.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagegamma.php'>Russian</option>
            <option value='tr/gmagick.setimagegamma.php'>Turkish</option>
            <option value='uk/gmagick.setimagegamma.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagegamma.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagegamma" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagegamma</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagegamma</span> &mdash; <span class="dc-title">Sets the image gamma</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagegamma-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagegamma</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$gamma</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagegamma-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagegamma-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagegamma-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagegamma.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagegamma%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagegamma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagegamma.php">＋<small>add a note</small></a></span>
