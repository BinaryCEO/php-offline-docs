...
<head>
  ...
  <title>PHP: ldap_delete_ext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-delete-ext.php">
 <link rel="shorturl" href="https://www.php.net/ldap-delete-ext">
 <link rel="alternate" href="https://www.php.net/ldap-delete-ext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-dn2ufn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-delete-ext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-delete-ext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-delete-ext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-delete-ext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-delete-ext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-delete-ext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-delete-ext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-delete-ext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-delete-ext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-delete-ext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-delete-ext.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_delete_ext - Manual" />
<meta name="twitter:description" content="Delete an entry from a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_delete_ext - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-delete-ext.php' selected="selected">English</option>
            <option value='de/function.ldap-delete-ext.php'>German</option>
            <option value='es/function.ldap-delete-ext.php'>Spanish</option>
            <option value='fr/function.ldap-delete-ext.php'>French</option>
            <option value='it/function.ldap-delete-ext.php'>Italian</option>
            <option value='ja/function.ldap-delete-ext.php'>Japanese</option>
            <option value='pt_BR/function.ldap-delete-ext.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-delete-ext.php'>Russian</option>
            <option value='tr/function.ldap-delete-ext.php'>Turkish</option>
            <option value='uk/function.ldap-delete-ext.php'>Ukrainian</option>
            <option value='zh/function.ldap-delete-ext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-delete-ext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_delete_ext</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_delete_ext</span> &mdash; <span class="dc-title">Delete an entry from a directory</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-delete-ext-description">
  ...
  <p class="para rdfs-comment">
   Does the same thing as <span class="function"><a href="function.ldap-delete.php" class="function">ldap_delete()</a></span> but returns
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-delete-ext-parameters">
  ...
  <p class="para">
    See <span class="function"><a href="function.ldap-delete.php" class="function">ldap_delete()</a></span>
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-parse-result.php" class="function" rel="rdfs-seeAlso">ldap_parse_result()</a> - Extract information from result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-delete-ext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-delete-ext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-delete-ext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-delete-ext.php">＋<small>add a note</small></a></span>
