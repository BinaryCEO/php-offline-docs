...
<head>
  ...
  <title>PHP: Imagick::transposeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.transposeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.transposeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transposeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.transverseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transposeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.transposeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.transposeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.transposeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.transposeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.transposeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.transposeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.transposeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.transposeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.transposeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.transposeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::transposeImage - Manual" />
<meta name="twitter:description" content="Creates a vertical mirror image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::transposeImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.transverseimage.php">
          Imagick::transverseImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.transparentpaintimage.php">
          &laquo; Imagick::transparentPaintImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.transposeimage.php' selected="selected">English</option>
            <option value='de/imagick.transposeimage.php'>German</option>
            <option value='es/imagick.transposeimage.php'>Spanish</option>
            <option value='fr/imagick.transposeimage.php'>French</option>
            <option value='it/imagick.transposeimage.php'>Italian</option>
            <option value='ja/imagick.transposeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.transposeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.transposeimage.php'>Russian</option>
            <option value='tr/imagick.transposeimage.php'>Turkish</option>
            <option value='uk/imagick.transposeimage.php'>Ukrainian</option>
            <option value='zh/imagick.transposeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.transposeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::transposeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::transposeImage</span> &mdash; <span class="dc-title">Creates a vertical mirror image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.transposeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::transposeImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.transposeimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.transposeimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.transposeimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3137">
      <p><strong>Example #1  <span class="function"><strong>Imagick::transposeImage()</strong></span></strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.transposeimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.transverseimage.php" class="function" rel="rdfs-seeAlso">Imagick::transverseImage()</a> - Creates a horizontal mirror image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/transposeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.transposeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.transposeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transposeimage.php">＋<small>add a note</small></a></span>
