...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-name-from-abbr.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-location-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-name-get.php">
...
<meta name="Description" content="Returns a timezone name by guessing from abbreviation and UTC offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_name_from_abbr - Manual" />
<meta name="twitter:description" content="Returns a timezone name by guessing from abbreviation and UTC offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_name_from_abbr - Manual" />
<meta itemprop="description" content="Returns a timezone name by guessing from abbreviation and UTC offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a timezone name by guessing from abbreviation and UTC offset" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-name-from-abbr.php' selected="selected">English</option>
            ...
            <option value='fr/function.timezone-name-from-abbr.php'>French</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.timezone-name-from-abbr-returnvalues">
  ...
  <p class="para">
   Returns time zone name on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.timezone-abbreviations-list.php" class="function" rel="rdfs-seeAlso">timezone_abbreviations_list()</a> - Alias of DateTimeZone::listAbbreviations</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-name-from-abbr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-name-from-abbr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-name-from-abbr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-name-from-abbr.php">＋<small>add a note</small></a></span>
