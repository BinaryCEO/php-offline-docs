...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-recvfrom.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-pair.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-socket-sendto.php">
...
<meta name="Description" content="Receives data from a socket, connected or not" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_socket_recvfrom - Manual" />
<meta name="twitter:description" content="Receives data from a socket, connected or not" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_recvfrom - Manual" />
<meta itemprop="description" content="Receives data from a socket, connected or not" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Receives data from a socket, connected or not" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-recvfrom.php' selected="selected">English</option>
            ...
            <option value='fr/function.stream-socket-recvfrom.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_socket_recvfrom</span> &mdash; <span class="dc-title">Receives data from a socket, connected or not</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-socket-recvfrom-returnvalues">
  ...
  <p class="para">
   Returns the read data, as a string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-socket-recvfrom-examples">
  ...
  <p class="para">
   <div class="example" id="example-4074">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Open a server socket to port 1234 on localhost */<br /></span><span style="color: #0000BB">$server </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_socket_server</span><span style="color: #007700">(</span><span style="color: #DD0000">'tcp://127.0.0.1:1234'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Accept a connection */<br /></span><span style="color: #0000BB">$socket </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_socket_accept</span><span style="color: #007700">(</span><span style="color: #0000BB">$server</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Grab a packet (1500 is a typical MTU size) of OOB data */<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"Received Out-Of-Band: '" </span><span style="color: #007700">. </span><span style="color: #0000BB">stream_socket_recvfrom</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">, </span><span style="color: #0000BB">1500</span><span style="color: #007700">, </span><span style="color: #0000BB">STREAM_OOB</span><span style="color: #007700">) . </span><span style="color: #DD0000">"'\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Take a peek at the normal in-band data, but don't consume it. */<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"Data: '" </span><span style="color: #007700">. </span><span style="color: #0000BB">stream_socket_recvfrom</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">, </span><span style="color: #0000BB">1500</span><span style="color: #007700">, </span><span style="color: #0000BB">STREAM_PEEK</span><span style="color: #007700">) . </span><span style="color: #DD0000">"'\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Get the exact same packet again, but remove it from the buffer this time. */<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"Data: '" </span><span style="color: #007700">. </span><span style="color: #0000BB">stream_socket_recvfrom</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">, </span><span style="color: #0000BB">1500</span><span style="color: #007700">) . </span><span style="color: #DD0000">"'\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Close it up */<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$socket</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$server</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.stream-socket-recvfrom-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="function"><a href="function.fread.php" class="function">fread()</a></span> or <span class="function"><a href="function.stream-get-line.php" class="function">stream_get_line()</a></span>) read
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-socket-recvfrom-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.stream-socket-sendto.php" class="function" rel="rdfs-seeAlso">stream_socket_sendto()</a> - Sends a message to a socket, whether it is connected or not</span></li>
   ...
   <li><span class="function"><a href="function.stream-socket-server.php" class="function" rel="rdfs-seeAlso">stream_socket_server()</a> - Create an Internet or Unix domain server socket</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-recvfrom.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-recvfrom%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-recvfrom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-recvfrom.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Note that stream_socket_recvfrom() bypasses stream wrappers including TLS/SSL. While reading from an encrypted stream with fread() will return decrypted data, using stream_socket_recvfrom() will give you the original encrypted bytes.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">This method may return a peer address not compatible with stream_socket_sendto() if in ipv6.<br /><br />The ip returned by recvfrom is not within brackets ([]), and has the port appended, which makes it look like ::1:1234. To cut it properly, use strrpos()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-socket-recvfrom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-recvfrom.php">＋<small>add a note</small></a></div>
