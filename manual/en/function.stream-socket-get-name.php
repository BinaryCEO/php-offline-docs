...
<head>
  ...
  <title>PHP: stream_socket_get_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-get-name.php">
 <link rel="shorturl" href="https://www.php.net/stream-socket-get-name">
 <link rel="alternate" href="https://www.php.net/stream-socket-get-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-enable-crypto.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-socket-pair.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-socket-get-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-socket-get-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-socket-get-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-socket-get-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-socket-get-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-socket-get-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-socket-get-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-socket-get-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-socket-get-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-socket-get-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-socket-get-name.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the name of the local or remote sockets" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_socket_get_name - Manual" />
<meta name="twitter:description" content="Retrieve the name of the local or remote sockets" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_get_name - Manual" />
<meta itemprop="description" content="Retrieve the name of the local or remote sockets" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the name of the local or remote sockets" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-socket-pair.php">
          stream_socket_pair &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-socket-enable-crypto.php">
          &laquo; stream_socket_enable_crypto        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-get-name.php' selected="selected">English</option>
            <option value='de/function.stream-socket-get-name.php'>German</option>
            <option value='es/function.stream-socket-get-name.php'>Spanish</option>
            <option value='fr/function.stream-socket-get-name.php'>French</option>
            <option value='it/function.stream-socket-get-name.php'>Italian</option>
            <option value='ja/function.stream-socket-get-name.php'>Japanese</option>
            <option value='pt_BR/function.stream-socket-get-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-socket-get-name.php'>Russian</option>
            <option value='tr/function.stream-socket-get-name.php'>Turkish</option>
            <option value='uk/function.stream-socket-get-name.php'>Ukrainian</option>
            <option value='zh/function.stream-socket-get-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-socket-get-name" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-socket-get-name-returnvalues">
  ...
  <p class="para">
   The name of the socket, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.stream-socket-accept.php" class="function" rel="rdfs-seeAlso">stream_socket_accept()</a> - Accept a connection on a socket created by stream_socket_server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-get-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-get-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-get-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-get-name.php">＋<small>add a note</small></a></span>
