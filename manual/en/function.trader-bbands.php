...
<head>
  ...
  <title>PHP: trader_bbands - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-bbands.php">
 <link rel="shorturl" href="https://www.php.net/trader-bbands">
 <link rel="alternate" href="https://www.php.net/trader-bbands" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-avgprice.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-beta.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-bbands.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-bbands.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-bbands.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-bbands.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-bbands.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-bbands.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-bbands.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-bbands.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-bbands.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-bbands.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-bbands.php" hreflang="zh">
...
<meta name="Description" content="Bollinger Bands" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_bbands - Manual" />
<meta name="twitter:description" content="Bollinger Bands" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_bbands - Manual" />
<meta itemprop="description" content="Bollinger Bands" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bollinger Bands" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-beta.php">
          trader_beta &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-avgprice.php">
          &laquo; trader_avgprice        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-bbands.php' selected="selected">English</option>
            <option value='de/function.trader-bbands.php'>German</option>
            <option value='es/function.trader-bbands.php'>Spanish</option>
            <option value='fr/function.trader-bbands.php'>French</option>
            <option value='it/function.trader-bbands.php'>Italian</option>
            <option value='ja/function.trader-bbands.php'>Japanese</option>
            <option value='pt_BR/function.trader-bbands.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-bbands.php'>Russian</option>
            <option value='tr/function.trader-bbands.php'>Turkish</option>
            <option value='uk/function.trader-bbands.php'>Ukrainian</option>
            <option value='zh/function.trader-bbands.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-bbands" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_bbands</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_bbands</span> &mdash; <span class="dc-title">Bollinger Bands</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-bbands-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_bbands</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$nbDevUp</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$nbDevDn</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-bbands-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">nbDevUp</code></dt>
    <dd>
     <p class="para">
      Deviation multiplier for upper band. Valid range from <a href="trader.constants.php#constant.trader-real-min" class="link">TRADER_REAL_MIN</a> to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">nbDevDn</code></dt>
    <dd>
     <p class="para">
      Deviation multiplier for lower band. Valid range from <a href="trader.constants.php#constant.trader-real-min" class="link">TRADER_REAL_MIN</a> to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-bbands-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-bbands.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-bbands%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-bbands&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-bbands.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125837">  <div class="votes">
    <div id="Vu125837">
    <a href="/manual/vote-note.php?id=125837&amp;page=function.trader-bbands&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125837">
    <a href="/manual/vote-note.php?id=125837&amp;page=function.trader-bbands&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125837" title="66% like this...">
    6
    </div>
  </div>
  <a href="#125837" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125837"> &para;</a><div class="date" title="2021-02-17 08:33"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125837">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// According to Wikipedia and the internet:<br />// Bollinger Bands chart the price and volatility of a financial instrument over time <br />// and yield an "envelope" minimum and maximum and middle "bands" of moving averages<br />// which provide a relative definition of high and low market prices<br />// Prices are "high" at or near the upper band and "low" at or near the lower band. <br />// Bollinger Bands are considered useful for pattern recognition<br /><br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">112.82</span><span class="keyword">, </span><span class="default">117.32</span><span class="keyword">, </span><span class="default">113.49</span><span class="keyword">, </span><span class="default">112</span><span class="keyword">, </span><span class="default">115.355</span><span class="keyword">, </span><span class="default">115.54</span><span class="keyword">, </span><span class="default">112.13</span><span class="keyword">, </span><span class="default">110.34</span><span class="keyword">, </span><span class="default">106.84</span><span class="keyword">, </span><span class="default">110.08</span><span class="keyword">, </span><span class="default">111.81</span><span class="keyword">, </span><span class="default">107.12</span><span class="keyword">, </span><span class="default">108.22</span><span class="keyword">, </span><span class="default">112.28</span><span class="keyword">);<br /></span><span class="default">$time_period </span><span class="keyword">= </span><span class="default">5</span><span class="keyword">;<br /></span><span class="default">$upper_deviation_multiplier </span><span class="keyword">= </span><span class="default">2.0</span><span class="keyword">;<br /></span><span class="default">$lower_deviation_multiplier </span><span class="keyword">= </span><span class="default">2.0</span><span class="keyword">;<br /><br /></span><span class="default">$ma_type </span><span class="keyword">= </span><span class="default">TRADER_MA_TYPE_SMA</span><span class="keyword">;  </span><span class="comment">// Simple Moving Average<br />           //TRADER_MA_TYPE_EMA   - Exponential Moving Average<br />           //TRADER_MA_TYPE_WMA   - Weighted Moving Average<br />           //TRADER_MA_TYPE_DEMA  - Double Exponential Moving Average <br />           //TRADER_MA_TYPE_TEMA  - Triple Exponential Moving Average <br />           //TRADER_MA_TYPE_TRIMA - Triangular Moving Average<br />           //TRADER_MA_TYPE_KAMA  - Kaufman's Adaptive Moving Average<br />           //TRADER_MA_TYPE_MAMA  - MESA Adaptive Moving Average<br />           //TRADER_MA_TYPE_T3)   - T3 Moving Average<br />                 <br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">trader_bbands</span><span class="keyword">(</span><span class="default">$closes</span><span class="keyword">, </span><span class="default">$time_period</span><span class="keyword">, </span><span class="default">$upper_deviation_multiplier</span><span class="keyword">, </span><span class="default">$lower_deviation_multiplier</span><span class="keyword">, </span><span class="default">$ma_type</span><span class="keyword">));<br /><br /></span><span class="comment">// Index 0 is "upper" band.<br />// Index 1 is "middle" band.<br />// Index 2 is "lower" band.<br /><br />/*<br />array(3) {<br />  [0]=&gt;<br />  array(10) {<br />    [4]=&gt;<br />    float(118.025)<br />    [5]=&gt;<br />    float(118.401)<br />    [6]=&gt;<br />    float(116.739)<br />    [7]=&gt;<br />    float(117.153)<br />    [8]=&gt;<br />    float(118.563)<br />    [9]=&gt;<br />    float(116.676)<br />    [10]=&gt;<br />    float(113.996)<br />    [11]=&gt;<br />    float(113.114)<br />    [12]=&gt;<br />    float(112.577)<br />    [13]=&gt;<br />    float(113.892)<br />  }<br />  [1]=&gt;<br />  array(10) {<br />    [4]=&gt;<br />    float(114.197)<br />    [5]=&gt;<br />    float(114.741)<br />    [6]=&gt;<br />    float(113.703)<br />    [7]=&gt;<br />    float(113.073)<br />    [8]=&gt;<br />    float(112.041)<br />    [9]=&gt;<br />    float(110.986)<br />    [10]=&gt;<br />    float(110.24)<br />    [11]=&gt;<br />    float(109.238)<br />    [12]=&gt;<br />    float(108.814)<br />    [13]=&gt;<br />    float(109.902)<br />  }<br />  [2]=&gt;<br />  array(10) {<br />    [4]=&gt;<br />    float(110.369)<br />    [5]=&gt;<br />    float(111.081)<br />    [6]=&gt;<br />    float(110.667)<br />    [7]=&gt;<br />    float(108.993)<br />    [8]=&gt;<br />    float(105.519)<br />    [9]=&gt;<br />    float(105.296)<br />    [10]=&gt;<br />    float(106.484)<br />    [11]=&gt;<br />    float(105.362)<br />    [12]=&gt;<br />    float(105.051)<br />    [13]=&gt;<br />    float(105.912)<br />  }<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-bbands&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-bbands.php">＋<small>add a note</small></a></div>
