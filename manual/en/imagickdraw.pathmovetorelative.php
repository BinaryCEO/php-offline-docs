...
<head>
  ...
  <title>PHP: ImagickDraw::pathMoveToRelative - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathstart.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathmovetorelative.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathmovetorelative.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathmovetorelative.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathmovetorelative.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathmovetorelative.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathmovetorelative.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathmovetorelative.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathmovetorelative.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathmovetorelative.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathmovetorelative.php" hreflang="zh">
...
<meta name="Description" content="Starts a new sub-path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathMoveToRelative - Manual" />
<meta name="twitter:description" content="Starts a new sub-path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathMoveToRelative - Manual" />
<meta itemprop="description" content="Starts a new sub-path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Starts a new sub-path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathstart.php">
          ImagickDraw::pathStart &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathmovetoabsolute.php">
          &laquo; ImagickDraw::pathMoveToAbsolute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathmovetorelative.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathmovetorelative.php'>German</option>
            <option value='es/imagickdraw.pathmovetorelative.php'>Spanish</option>
            <option value='fr/imagickdraw.pathmovetorelative.php'>French</option>
            <option value='it/imagickdraw.pathmovetorelative.php'>Italian</option>
            <option value='ja/imagickdraw.pathmovetorelative.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathmovetorelative.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathmovetorelative.php'>Russian</option>
            <option value='tr/imagickdraw.pathmovetorelative.php'>Turkish</option>
            <option value='uk/imagickdraw.pathmovetorelative.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathmovetorelative.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathmovetorelative" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathMoveToRelative</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathMoveToRelative</span> &mdash; <span class="dc-title">Starts a new sub-path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathmovetorelative-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathMoveToRelative</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathmovetorelative-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathmovetorelative-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathmovetorelative.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathmovetorelative%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathmovetorelative&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php">＋<small>add a note</small></a></span>
