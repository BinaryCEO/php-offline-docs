...
<head>
  ...
  <title>PHP: fann_get_activation_function - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-activation-function.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-activation-function">
 <link rel="alternate" href="https://www.php.net/fann-get-activation-function" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-duplicate-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-activation-steepness.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-activation-function.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-activation-function.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-activation-function.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-activation-function.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-activation-function.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-activation-function.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-activation-function.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-activation-function.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-activation-function.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-activation-function.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-activation-function.php" hreflang="zh">
...
<meta name="Description" content="Returns the activation function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_activation_function - Manual" />
<meta name="twitter:description" content="Returns the activation function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_activation_function - Manual" />
<meta itemprop="description" content="Returns the activation function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the activation function" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-get-activation-steepness.php">
          fann_get_activation_steepness &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-duplicate-train-data.php">
          &laquo; fann_duplicate_train_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-activation-function.php' selected="selected">English</option>
            <option value='de/function.fann-get-activation-function.php'>German</option>
            <option value='es/function.fann-get-activation-function.php'>Spanish</option>
            <option value='fr/function.fann-get-activation-function.php'>French</option>
            <option value='it/function.fann-get-activation-function.php'>Italian</option>
            <option value='ja/function.fann-get-activation-function.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-activation-function.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-activation-function.php'>Russian</option>
            <option value='tr/function.fann-get-activation-function.php'>Turkish</option>
            <option value='uk/function.fann-get-activation-function.php'>Ukrainian</option>
            <option value='zh/function.fann-get-activation-function.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-activation-function" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_activation_function</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_activation_function</span> &mdash; <span class="dc-title">Returns the activation function</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-activation-function-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_activation_function</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$layer</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$neuron</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Get the activation function for neuron number <code class="literal">neuron</code> in layer number
  ...
  <p class="para">
   The return value is one of the <a href="fann.constants.php#constants.fann-activation-funcs" class="link">activation functions</a> constants.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-get-activation-function-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-activation-function-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <a href="fann.constants.php#constants.fann-train" class="link">Learning functions</a> constant or -1
   if the neuron is not defined in the neural network, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-activation-function-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-activation-function.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function()</a> - Sets the activation function for supplied neuron and layer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-activation-function.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-activation-function%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-activation-function&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-activation-function.php">＋<small>add a note</small></a></span>
