...
<head>
  ...
  <title>PHP: ibase_trans - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-trans.php">
 <link rel="shorturl" href="https://www.php.net/ibase-trans">
 <link rel="alternate" href="https://www.php.net/ibase-trans" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-set-event-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-wait-event.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-trans.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-trans.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-trans.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-trans.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-trans.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-trans.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-trans.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-trans.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-trans.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-trans.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-trans.php" hreflang="zh">
...
<meta name="Description" content="Begin a transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_trans - Manual" />
<meta name="twitter:description" content="Begin a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_trans - Manual" />
<meta itemprop="description" content="Begin a transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Begin a transaction" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-wait-event.php">
          ibase_wait_event &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-set-event-handler.php">
          &laquo; ibase_set_event_handler        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-trans.php' selected="selected">English</option>
            <option value='de/function.ibase-trans.php'>German</option>
            <option value='es/function.ibase-trans.php'>Spanish</option>
            <option value='fr/function.ibase-trans.php'>French</option>
            <option value='it/function.ibase-trans.php'>Italian</option>
            <option value='ja/function.ibase-trans.php'>Japanese</option>
            <option value='pt_BR/function.ibase-trans.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-trans.php'>Russian</option>
            <option value='tr/function.ibase-trans.php'>Turkish</option>
            <option value='uk/function.ibase-trans.php'>Ukrainian</option>
            <option value='zh/function.ibase-trans.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-trans" class="refentry">
  ...
  <p class="para">
   Returns a transaction handle, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-trans.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-trans%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-trans&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-trans.php">＋<small>add a note</small></a></span>
