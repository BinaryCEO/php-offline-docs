...
<head>
  ...
  <title>PHP: stream_bucket_make_writeable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-bucket-make-writeable.php">
 <link rel="shorturl" href="https://www.php.net/stream-bucket-make-writeable">
 <link rel="alternate" href="https://www.php.net/stream-bucket-make-writeable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-bucket-append.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-bucket-new.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-bucket-make-writeable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-bucket-make-writeable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-bucket-make-writeable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-bucket-make-writeable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-bucket-make-writeable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-bucket-make-writeable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-bucket-make-writeable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-bucket-make-writeable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-bucket-make-writeable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-bucket-make-writeable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-bucket-make-writeable.php" hreflang="zh">
...
<meta name="Description" content="Returns a bucket object from the brigade to operate on" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_bucket_make_writeable - Manual" />
<meta name="twitter:description" content="Returns a bucket object from the brigade to operate on" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_bucket_make_writeable - Manual" />
<meta itemprop="description" content="Returns a bucket object from the brigade to operate on" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a bucket object from the brigade to operate on" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-bucket-new.php">
          stream_bucket_new &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-bucket-append.php">
          &laquo; stream_bucket_append        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-bucket-make-writeable.php' selected="selected">English</option>
            <option value='de/function.stream-bucket-make-writeable.php'>German</option>
            <option value='es/function.stream-bucket-make-writeable.php'>Spanish</option>
            <option value='fr/function.stream-bucket-make-writeable.php'>French</option>
            <option value='it/function.stream-bucket-make-writeable.php'>Italian</option>
            <option value='ja/function.stream-bucket-make-writeable.php'>Japanese</option>
            <option value='pt_BR/function.stream-bucket-make-writeable.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-bucket-make-writeable.php'>Russian</option>
            <option value='tr/function.stream-bucket-make-writeable.php'>Turkish</option>
            <option value='uk/function.stream-bucket-make-writeable.php'>Ukrainian</option>
            <option value='zh/function.stream-bucket-make-writeable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-bucket-make-writeable" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.stream-bucket-make-writeable-description">
  ...
  <p class="para rdfs-comment">
   ...
   typically called from <span class="methodname"><a href="php-user-filter.filter.php" class="methodname">php_user_filter::filter()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-bucket-make-writeable-returnvalues">
  ...
  <p class="para">
   Returns a bucket object or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.stream-bucket-make-writeable-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>This function returns a <span class="classname"><strong class="classname">StreamBucket</strong></span> instance now; previously, an <span class="classname"><a href="class.stdclass.php" class="classname">stdClass</a></span> was returned.</td>
     </tr>
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-bucket-make-writeable-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.stream-bucket-append.php" class="function" rel="rdfs-seeAlso">stream_bucket_append()</a> - Append bucket to brigade</span></li>
    <li><span class="function"><a href="function.stream-bucket-prepend.php" class="function" rel="rdfs-seeAlso">stream_bucket_prepend()</a> - Prepend bucket to brigade</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-bucket-make-writeable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-bucket-make-writeable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-bucket-make-writeable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-bucket-make-writeable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127593">  <div class="votes">
    <div id="Vu127593">
    <a href="/manual/vote-note.php?id=127593&amp;page=function.stream-bucket-make-writeable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127593">
    <a href="/manual/vote-note.php?id=127593&amp;page=function.stream-bucket-make-writeable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127593" title="50% like this...">
    0
    </div>
  </div>
  <a href="#127593" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#127593"> &para;</a><div class="date" title="2022-09-06 04:03"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127593">
<div class="phpcode"><code><span class="html">the object $bucket which is returned also includes a third parameter, $bucket-&gt;bucket, which is a reference to the resource</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-bucket-make-writeable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-bucket-make-writeable.php">＋<small>add a note</small></a></div>
