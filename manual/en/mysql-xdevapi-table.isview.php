...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-table.isview.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-table.isview.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-table.isview.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-table.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-table.insert.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-table.select.php">
...
<meta name="Description" content="Check if table is view" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Table::isView - Manual" />
<meta name="twitter:description" content="Check if table is view" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Table::isView - Manual" />
<meta itemprop="description" content="Check if table is view" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if table is view" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-table.isview.php' selected="selected">English</option>
            ...
            <option value='fr/mysql-xdevapi-table.isview.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">Table::isView</span> &mdash; <span class="dc-title">Check if table is view</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysql-xdevapi-table.isview-returnvalues">
  ...
  <p class="para">
    <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the underlying object is a view, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-table.isview-examples">
  ...
  <div class="example" id="example-1842">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\Table::isView()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">This is not a view.</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/table/isview.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-table.isview%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-table.isview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-table.isview.php">＋<small>add a note</small></a></span>
