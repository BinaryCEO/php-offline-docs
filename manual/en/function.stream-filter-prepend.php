...
<head>
  ...
  <title>PHP: stream_filter_prepend - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-filter-prepend.php">
 <link rel="shorturl" href="https://www.php.net/stream-filter-prepend">
 <link rel="alternate" href="https://www.php.net/stream-filter-prepend" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-filter-append.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-filter-register.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-filter-prepend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-filter-prepend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-filter-prepend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-filter-prepend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-filter-prepend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-filter-prepend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-filter-prepend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-filter-prepend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-filter-prepend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-filter-prepend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-filter-prepend.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: stream_filter_prepend - Manual" />
<meta name="twitter:description" content="Attach a filter to a stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_filter_prepend - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-filter-register.php">
          stream_filter_register &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-filter-append.php">
          &laquo; stream_filter_append        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-filter-prepend.php' selected="selected">English</option>
            <option value='de/function.stream-filter-prepend.php'>German</option>
            <option value='es/function.stream-filter-prepend.php'>Spanish</option>
            <option value='fr/function.stream-filter-prepend.php'>French</option>
            <option value='it/function.stream-filter-prepend.php'>Italian</option>
            <option value='ja/function.stream-filter-prepend.php'>Japanese</option>
            <option value='pt_BR/function.stream-filter-prepend.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-filter-prepend.php'>Russian</option>
            <option value='tr/function.stream-filter-prepend.php'>Turkish</option>
            <option value='uk/function.stream-filter-prepend.php'>Ukrainian</option>
            <option value='zh/function.stream-filter-prepend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-filter-prepend" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.stream-filter-append.php" class="function" rel="rdfs-seeAlso">stream_filter_append()</a> - Attach a filter to a stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-filter-prepend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-filter-prepend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-filter-prepend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-filter-prepend.php">＋<small>add a note</small></a></span>
