...
<head>
  ...
  <title>PHP: oci_set_edition - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-set-edition.php">
 <link rel="shorturl" href="https://www.php.net/oci-set-edition">
 <link rel="alternate" href="https://www.php.net/oci-set-edition" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-set-db-operation.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-set-module-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-set-edition.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-set-edition.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-set-edition.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-set-edition.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-set-edition.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-set-edition.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-set-edition.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-set-edition.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-set-edition.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-set-edition.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-set-edition.php" hreflang="zh">
...
<meta name="Description" content="Sets the database edition" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_set_edition - Manual" />
<meta name="twitter:description" content="Sets the database edition" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_set_edition - Manual" />
<meta itemprop="description" content="Sets the database edition" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the database edition" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-set-module-name.php">
          oci_set_module_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-set-db-operation.php">
          &laquo; oci_set_db_operation        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-set-edition.php' selected="selected">English</option>
            <option value='de/function.oci-set-edition.php'>German</option>
            <option value='es/function.oci-set-edition.php'>Spanish</option>
            <option value='fr/function.oci-set-edition.php'>French</option>
            <option value='it/function.oci-set-edition.php'>Italian</option>
            <option value='ja/function.oci-set-edition.php'>Japanese</option>
            <option value='pt_BR/function.oci-set-edition.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-set-edition.php'>Russian</option>
            <option value='tr/function.oci-set-edition.php'>Turkish</option>
            <option value='uk/function.oci-set-edition.php'>Ukrainian</option>
            <option value='zh/function.oci-set-edition.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-set-edition" class="refentry">
   ...
   <p class="para">
    ...
    This restriction has been removed with Oracle 11.2.0.2.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-set-edition.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-set-edition%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-set-edition&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-edition.php">＋<small>add a note</small></a></span>
