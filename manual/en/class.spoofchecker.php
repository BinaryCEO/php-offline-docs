...
<head>
  ...
  <title>PHP: Spoofchecker - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.spoofchecker.php">
 <link rel="shorturl" href="https://www.php.net/spoofchecker">
 <link rel="alternate" href="https://www.php.net/spoofchecker" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/resourcebundle.locales.php">
 <link rel="next" href="https://www.php.net/manual/en/spoofchecker.areconfusable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.spoofchecker.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.spoofchecker.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.spoofchecker.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.spoofchecker.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.spoofchecker.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.spoofchecker.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.spoofchecker.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.spoofchecker.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.spoofchecker.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.spoofchecker.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.spoofchecker.php" hreflang="zh">
...
<meta name="Description" content="The Spoofchecker class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Spoofchecker - Manual" />
<meta name="twitter:description" content="The Spoofchecker class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Spoofchecker - Manual" />
<meta itemprop="description" content="The Spoofchecker class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Spoofchecker class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="spoofchecker.areconfusable.php">
          Spoofchecker::areConfusable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="resourcebundle.locales.php">
          &laquo; ResourceBundle::getLocales        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.spoofchecker.php' selected="selected">English</option>
            <option value='de/class.spoofchecker.php'>German</option>
            <option value='es/class.spoofchecker.php'>Spanish</option>
            <option value='fr/class.spoofchecker.php'>French</option>
            <option value='it/class.spoofchecker.php'>Italian</option>
            <option value='ja/class.spoofchecker.php'>Japanese</option>
            <option value='pt_BR/class.spoofchecker.php'>Brazilian Portuguese</option>
            <option value='ru/class.spoofchecker.php'>Russian</option>
            <option value='tr/class.spoofchecker.php'>Turkish</option>
            <option value='uk/class.spoofchecker.php'>Ukrainian</option>
            <option value='zh/class.spoofchecker.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.spoofchecker" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="spoofchecker.areconfusable.php">Spoofchecker::areConfusable</a> — Checks if given strings can be confused</li><li><a href="spoofchecker.construct.php">Spoofchecker::__construct</a> — Constructor</li><li><a href="spoofchecker.issuspicious.php">Spoofchecker::isSuspicious</a> — Checks if a given text contains any suspicious characters</li><li><a href="spoofchecker.setallowedlocales.php">Spoofchecker::setAllowedLocales</a> — Locales to use when running checks</li><li><a href="spoofchecker.setchecks.php">Spoofchecker::setChecks</a> — Set the checks to run</li><li><a href="spoofchecker.setrestrictionlevel.php">Spoofchecker::setRestrictionLevel</a> — Set the restriction level</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/spoofchecker.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.spoofchecker%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.spoofchecker&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.spoofchecker.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121142">  <div class="votes">
    <div id="Vu121142">
    <a href="/manual/vote-note.php?id=121142&amp;page=class.spoofchecker&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121142">
    <a href="/manual/vote-note.php?id=121142&amp;page=class.spoofchecker&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121142" title="71% like this...">
    3
    </div>
  </div>
  <a href="#121142" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#121142"> &para;</a><div class="date" title="2017-05-27 07:07"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121142">
<div class="phpcode"><code><span class="html">From <a href="http://icu-project.org/apiref/icu4j/com/ibm/icu/text/SpoofChecker.html" rel="nofollow" target="_blank">http://icu-project.org/apiref/icu4j/com/ibm/icu/text/SpoofChecker.html</a> :<br />SINGLE_SCRIPT_CONFUSABLE: indicates that the two strings are visually confusable and that they are from the same script<br />MIXED_SCRIPT_CONFUSABLE: indicates that the two strings are visually confusable and that they are NOT from the same script<br />WHOLE_SCRIPT_CONFUSABLE: indicates that the two strings are visually confusable and that they are NOT from the same script BUT both of them are single-script strings<br />ANY_CASE: Deprecated.<br />SINGLE_SCRIPT: Deprecated.<br />INVISIBLE: Check an identifier for the presence of invisible characters, such as zero-width spaces, or character sequences that are likely not to display, such as multiple occurrences of the same non-spacing mark.<br />CHAR_LIMIT: Check that an identifier contains only characters from a specified set of acceptable characters.<br /><br />Explanation of whole script, mixed script and single script confusables in UTS 39 section 4 : <a href="http://unicode.org/reports/tr39/#Confusable_Detection" rel="nofollow" target="_blank">http://unicode.org/reports/tr39/#Confusable_Detection</a><br /><br />Details from Java SpoofChecker class at <a href="http://icu-project.org/apiref/icu4j/com/ibm/icu/text/SpoofChecker.html" rel="nofollow" target="_blank">http://icu-project.org/apiref/icu4j/com/ibm/icu/text/SpoofChecker.html</a></span></code></div>
  </div>
 </div>
  <div class="note" id="122649">  <div class="votes">
    <div id="Vu122649">
    <a href="/manual/vote-note.php?id=122649&amp;page=class.spoofchecker&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122649">
    <a href="/manual/vote-note.php?id=122649&amp;page=class.spoofchecker&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122649" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#122649" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#122649"> &para;</a><div class="date" title="2018-04-20 12:38"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122649">
<div class="phpcode"><code><span class="html">Spoofchecker yields false positives by defaut when Whole-Script Confusables (WSC) and Mixed-Script Confusables (MSC) checks are used.<br />They have been deprecated since ICU 58:<br /><a href="http://bugs.icu-project.org/trac/ticket/12549#comment:10" rel="nofollow" target="_blank">http://bugs.icu-project.org/trac/ticket/12549#comment:10</a><br /><br />Workarounds: upgrade ICU to 58+, or avoid the MSC and WSC checks with Spoofcheckers' setChecks() function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.spoofchecker&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.spoofchecker.php">＋<small>add a note</small></a></div>
