...
<head>
  ...
  <title>PHP: Imagick::evaluateImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.evaluateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.evaluateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.evaluateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.equalizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.exportimagepixels.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.evaluateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.evaluateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.evaluateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.evaluateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.evaluateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.evaluateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.evaluateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.evaluateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.evaluateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.evaluateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.evaluateimage.php" hreflang="zh">
...
<meta name="Description" content="Applies an expression to an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::evaluateImage - Manual" />
<meta name="twitter:description" content="Applies an expression to an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::evaluateImage - Manual" />
<meta itemprop="description" content="Applies an expression to an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies an expression to an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.exportimagepixels.php">
          Imagick::exportImagePixels &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.equalizeimage.php">
          &laquo; Imagick::equalizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.evaluateimage.php' selected="selected">English</option>
            <option value='de/imagick.evaluateimage.php'>German</option>
            <option value='es/imagick.evaluateimage.php'>Spanish</option>
            <option value='fr/imagick.evaluateimage.php'>French</option>
            <option value='it/imagick.evaluateimage.php'>Italian</option>
            <option value='ja/imagick.evaluateimage.php'>Japanese</option>
            <option value='pt_BR/imagick.evaluateimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.evaluateimage.php'>Russian</option>
            <option value='tr/imagick.evaluateimage.php'>Turkish</option>
            <option value='uk/imagick.evaluateimage.php'>Ukrainian</option>
            <option value='zh/imagick.evaluateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.evaluateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::evaluateImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::evaluateImage</span> &mdash; <span class="dc-title">Applies an expression to an image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.evaluateimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::evaluateImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$op</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$constant</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.evaluateimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">op</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">constant</code></dt>
     <dd>
      <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create new object with the image<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'example-alpha.png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Reduce the alpha by 50%<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">evaluateImage</span><span style="color: #007700">(</span><span style="color: #0000BB">Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">EVALUATE_DIVIDE</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">CHANNEL_ALPHA</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Output the image<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$im</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/evaluateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.evaluateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.evaluateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.evaluateimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="107068">  <div class="votes">
    <div id="Vu107068">
    <a href="/manual/vote-note.php?id=107068&amp;page=imagick.evaluateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107068">
    <a href="/manual/vote-note.php?id=107068&amp;page=imagick.evaluateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107068" title="100% like this...">
    1
    </div>
  </div>
  <a href="#107068" class="name">
  <strong class="user"><em>nils dot rocine at gmail dot com</em></strong></a><a class="genanchor" href="#107068"> &para;</a><div class="date" title="2012-01-04 11:10"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107068">
<div class="phpcode"><code><span class="html">What worked for me to convert a JPG source file to a semi-transparent PNG.
<br />
<br /><span class="default">&lt;?php
<br />    $srcImagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$srcPath</span><span class="keyword">);
<br />    
<br />    </span><span class="default">$pathTo50Perc </span><span class="keyword">= </span><span class="string">'transparent1.png'</span><span class="keyword">;
<br />    
<br />    </span><span class="default">$srcImagick</span><span class="keyword">-&gt;</span><span class="default">setImageAlphaChannel</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">ALPHACHANNEL_OPAQUE</span><span class="keyword">);
<br />    
<br />    </span><span class="default">$srcImagick</span><span class="keyword">-&gt;</span><span class="default">evaluateImage</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">EVALUATE_DIVIDE</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">CHANNEL_ALPHA</span><span class="keyword">);
<br />
<br />    </span><span class="default">$srcImagick</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$pathTo50Perc</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.evaluateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.evaluateimage.php">＋<small>add a note</small></a></div>
