...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegetclip.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegd2.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegetinterpolation.php">
...
<meta name="Description" content="Get the clipping rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegetclip - Manual" />
<meta name="twitter:description" content="Get the clipping rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegetclip - Manual" />
<meta itemprop="description" content="Get the clipping rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the clipping rectangle" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegetclip.php' selected="selected">English</option>
            ...
            <option value='ja/function.imagegetclip.php'>Japanese</option>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagegetclip-examples">
  ...
  <div class="example" id="imagegetclip.example.basic">
   <p><strong>Example #1 <span class="function"><strong>imagegetclip()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagesetclip.php" class="function" rel="rdfs-seeAlso">imagesetclip()</a> - Set the clipping rectangle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegetclip.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegetclip%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegetclip&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegetclip.php">＋<small>add a note</small></a></span>
