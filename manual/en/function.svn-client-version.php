...
<head>
  ...
  <title>PHP: svn_client_version - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-client-version.php">
 <link rel="shorturl" href="https://www.php.net/svn-client-version">
 <link rel="alternate" href="https://www.php.net/svn-client-version" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-cleanup.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-commit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-client-version.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-client-version.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-client-version.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-client-version.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-client-version.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-client-version.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-client-version.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-client-version.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-client-version.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-client-version.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-client-version.php" hreflang="zh">
...
<meta name="Description" content="Returns the version of the SVN client libraries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_client_version - Manual" />
<meta name="twitter:description" content="Returns the version of the SVN client libraries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_client_version - Manual" />
<meta itemprop="description" content="Returns the version of the SVN client libraries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the version of the SVN client libraries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-commit.php">
          svn_commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-cleanup.php">
          &laquo; svn_cleanup        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-client-version.php' selected="selected">English</option>
            <option value='de/function.svn-client-version.php'>German</option>
            <option value='es/function.svn-client-version.php'>Spanish</option>
            <option value='fr/function.svn-client-version.php'>French</option>
            <option value='it/function.svn-client-version.php'>Italian</option>
            <option value='ja/function.svn-client-version.php'>Japanese</option>
            <option value='pt_BR/function.svn-client-version.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-client-version.php'>Russian</option>
            <option value='tr/function.svn-client-version.php'>Turkish</option>
            <option value='uk/function.svn-client-version.php'>Ukrainian</option>
            <option value='zh/function.svn-client-version.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-client-version" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_client_version</h1>
  <p class="verinfo">(PECL svn &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">svn_client_version</span> &mdash; <span class="dc-title">Returns the version of the SVN client libraries</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-client-version-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_client_version</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.svn-client-version-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.svn-client-version-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.svn-client-version-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-4869">
    <p><strong>Example #1 Basic example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">svn_client_version</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">1.3.1</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-client-version-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-client-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-client-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-client-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-client-version.php">＋<small>add a note</small></a></span>
