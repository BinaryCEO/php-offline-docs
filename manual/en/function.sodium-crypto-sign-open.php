...
<head>
  ...
  <title>PHP: sodium_crypto_sign_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign-open.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign-open">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-sign-keypair-from-secretkey-and-publickey.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-sign-publickey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign-open.php" hreflang="zh">
...
<meta name="Description" content="Check that the signed message has a valid signature" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_sign_open - Manual" />
<meta name="twitter:description" content="Check that the signed message has a valid signature" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_sign_open - Manual" />
<meta itemprop="description" content="Check that the signed message has a valid signature" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check that the signed message has a valid signature" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-sign-publickey.php">
          sodium_crypto_sign_publickey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-sign-keypair-from-secretkey-and-publickey.php">
          &laquo; sodium_crypto_sign_keypair_from_secretkey_and_publickey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign-open.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign-open.php'>German</option>
            <option value='es/function.sodium-crypto-sign-open.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign-open.php'>French</option>
            <option value='it/function.sodium-crypto-sign-open.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign-open.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign-open.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign-open.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign-open.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_sign_open</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_sign_open</span> &mdash; <span class="dc-title">Check that the signed message has a valid signature</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-open-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign_open</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$signed_message</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$public_key</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-sign-open-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">signed_message</code></dt>
    <dd>
     <p class="para">
      A message signed with <span class="function"><a href="function.sodium-crypto-sign.php" class="function">sodium_crypto_sign()</a></span>
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-sign-open-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the original signed message on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-open.php">＋<small>add a note</small></a></span>
