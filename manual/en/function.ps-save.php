...
<head>
  ...
  <title>PHP: ps_save - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-save.php">
 <link rel="shorturl" href="https://www.php.net/ps-save">
 <link rel="alternate" href="https://www.php.net/ps-save" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-rotate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-scale.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-save.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-save.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-save.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-save.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-save.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-save.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-save.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-save.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-save.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-save.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-save.php" hreflang="zh">
...
<meta name="Description" content="Save current context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_save - Manual" />
<meta name="twitter:description" content="Save current context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_save - Manual" />
<meta itemprop="description" content="Save current context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Save current context" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-save.php' selected="selected">English</option>
            <option value='de/function.ps-save.php'>German</option>
            <option value='es/function.ps-save.php'>Spanish</option>
            <option value='fr/function.ps-save.php'>French</option>
            <option value='it/function.ps-save.php'>Italian</option>
            <option value='ja/function.ps-save.php'>Japanese</option>
            <option value='pt_BR/function.ps-save.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-save.php'>Russian</option>
            <option value='tr/function.ps-save.php'>Turkish</option>
            <option value='uk/function.ps-save.php'>Ukrainian</option>
            <option value='zh/function.ps-save.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-save" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_save</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_save</span> &mdash; <span class="dc-title">Save current context</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-save-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_save</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.ps-restore.php" class="function">ps_restore()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-save-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-save-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-save-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-restore.php" class="function" rel="rdfs-seeAlso">ps_restore()</a> - Restore previously save context</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-save.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-save%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-save&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-save.php">＋<small>add a note</small></a></span>
