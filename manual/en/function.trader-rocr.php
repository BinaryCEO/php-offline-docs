...
<head>
  ...
  <title>PHP: trader_rocr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-rocr.php">
 <link rel="shorturl" href="https://www.php.net/trader-rocr">
 <link rel="alternate" href="https://www.php.net/trader-rocr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-rocp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-rocr100.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-rocr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-rocr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-rocr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-rocr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-rocr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-rocr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-rocr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-rocr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-rocr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-rocr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-rocr.php" hreflang="zh">
...
<meta name="Description" content="Rate of change ratio: (price/prevPrice)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_rocr - Manual" />
<meta name="twitter:description" content="Rate of change ratio: (price/prevPrice)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_rocr - Manual" />
<meta itemprop="description" content="Rate of change ratio: (price/prevPrice)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rate of change ratio: (price/prevPrice)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-rocr100.php">
          trader_rocr100 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-rocp.php">
          &laquo; trader_rocp        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-rocr.php' selected="selected">English</option>
            <option value='de/function.trader-rocr.php'>German</option>
            <option value='es/function.trader-rocr.php'>Spanish</option>
            <option value='fr/function.trader-rocr.php'>French</option>
            <option value='it/function.trader-rocr.php'>Italian</option>
            <option value='ja/function.trader-rocr.php'>Japanese</option>
            <option value='pt_BR/function.trader-rocr.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-rocr.php'>Russian</option>
            <option value='tr/function.trader-rocr.php'>Turkish</option>
            <option value='uk/function.trader-rocr.php'>Ukrainian</option>
            <option value='zh/function.trader-rocr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-rocr" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_rocr</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_rocr</span> &mdash; <span class="dc-title">Rate of change ratio: (price/prevPrice)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-rocr-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_rocr</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-rocr-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-rocr-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-rocr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-rocr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-rocr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-rocr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114512">  <div class="votes">
    <div id="Vu114512">
    <a href="/manual/vote-note.php?id=114512&amp;page=function.trader-rocr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114512">
    <a href="/manual/vote-note.php?id=114512&amp;page=function.trader-rocr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114512" title="no votes...">
    0
    </div>
  </div>
  <a href="#114512" class="name">
  <strong class="user"><em>mityaev_ivan at mail dot ru</em></strong></a><a class="genanchor" href="#114512"> &para;</a><div class="date" title="2014-03-02 09:59"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114512">
<div class="phpcode"><code><span class="html">timePeriod can be from 1 (not from 2)<br />Working correctly, and tis is common need to calculate change from previos period.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-rocr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-rocr.php">＋<small>add a note</small></a></div>
