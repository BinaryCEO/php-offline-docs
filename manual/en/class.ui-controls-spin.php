...
<head>
  ...
  <title>PHP: UI\Controls\Spin - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-spin.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-spin">
 <link rel="alternate" href="https://www.php.net/ui-controls-spin" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-multilineentry.settext.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-spin.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-spin.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-spin.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-spin.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-spin.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-spin.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-spin.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-spin.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-spin.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-spin.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-spin.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-spin.php" hreflang="zh">
...
<meta name="Description" content="Spin Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Spin - Manual" />
<meta name="twitter:description" content="Spin Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Spin - Manual" />
<meta itemprop="description" content="Spin Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Spin Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-spin.construct.php">
          UI\Controls\Spin::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-multilineentry.settext.php">
          &laquo; UI\Controls\MultilineEntry::setText        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-spin.php' selected="selected">English</option>
            <option value='de/class.ui-controls-spin.php'>German</option>
            <option value='es/class.ui-controls-spin.php'>Spanish</option>
            <option value='fr/class.ui-controls-spin.php'>French</option>
            <option value='it/class.ui-controls-spin.php'>Italian</option>
            <option value='ja/class.ui-controls-spin.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-spin.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-spin.php'>Russian</option>
            <option value='tr/class.ui-controls-spin.php'>Turkish</option>
            <option value='uk/class.ui-controls-spin.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-spin.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-spin" class="reference">

 <h1 class="title">Spin Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-spin.intro">
  ...
  <div class="section" id="ui-controls-spin.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Spin</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-spin.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$min</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$max</code></span>)</div>

    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-spin.getvalue.php" class="methodname">getValue</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-spin.onchange.php" class="methodname">onChange</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-spin.setvalue.php" class="methodname">setValue</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-spin.construct.php">UI\Controls\Spin::__construct</a> — Construct a new Spin</li><li><a href="ui-controls-spin.getvalue.php">UI\Controls\Spin::getValue</a> — Get Value</li><li><a href="ui-controls-spin.onchange.php">UI\Controls\Spin::onChange</a> — Change Handler</li><li><a href="ui-controls-spin.setvalue.php">UI\Controls\Spin::setValue</a> — Set Value</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.spin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-spin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-spin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-spin.php">＋<small>add a note</small></a></span>
