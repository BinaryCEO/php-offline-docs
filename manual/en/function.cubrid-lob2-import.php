...
<head>
  ...
  <title>PHP: cubrid_lob2_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-import.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-import">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-new.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-import.php" hreflang="zh">
...
<meta name="Description" content="Import BLOB/CLOB data from a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_import - Manual" />
<meta name="twitter:description" content="Import BLOB/CLOB data from a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_import - Manual" />
<meta itemprop="description" content="Import BLOB/CLOB data from a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Import BLOB/CLOB data from a file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lob2-new.php">
          cubrid_lob2_new &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-export.php">
          &laquo; cubrid_lob2_export        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-import.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-import.php'>German</option>
            <option value='es/function.cubrid-lob2-import.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-import.php'>French</option>
            <option value='it/function.cubrid-lob2-import.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-import.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-import.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-import.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-import.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-import" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-import-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_import</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$file_name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.cubrid-lob2-new.php" class="function">cubrid_lob2_new()</a></span> or fetch a lob object from CUBRID database
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob2-import-examples">
  ...
  <div class="example" id="example-1253">
   <p><strong>Example #1 <span class="function"><a href="function.cubrid-lob2-export.php" class="function">cubrid_lob2_export()</a></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"DROP TABLE if exists test_lob"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"CREATE TABLE test_lob (id INT, contents CLOB)"</span><span style="color: #007700">);<br /> <br /></span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_prepare</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"INSERT INTO test_lob VALUES (?, ?)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$lob </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"clob"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_lob2_import</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #DD0000">"doc_1.txt"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_lob2_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #DD0000">'CLOB'</span><span style="color: #007700">); </span><span style="color: #FF8000">// or cubrid_lob2_bind($req, 2, $lob);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_lob2_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-lob2-import-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-export.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_export()</a> - Export the lob object to a file</span></li>
   <li><span class="function"><a href="function.cubrid-lob2-bind.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_bind()</a> - Bind a lob object or a string as a lob object to a prepared statement as parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-import.php">＋<small>add a note</small></a></span>
