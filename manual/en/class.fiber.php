...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.fiber.php">
 <link rel="shorturl" href="https://www.php.net/fiber">
 <link rel="alternate" href="https://www.php.net/fiber" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.interfaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/generator.wakeup.php">
 <link rel="next" href="https://www.php.net/manual/en/fiber.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.fiber.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.fiber.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.fiber.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.fiber.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.fiber.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.fiber.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.fiber.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.fiber.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.fiber.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.fiber.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.fiber.php" hreflang="zh">
...
<meta name="Description" content="The Fiber class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Fiber - Manual" />
<meta name="twitter:description" content="The Fiber class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Fiber - Manual" />
<meta itemprop="description" content="The Fiber class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Fiber class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="fiber.construct.php">
          Fiber::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="generator.wakeup.php">
          &laquo; Generator::__wakeup        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.fiber.php' selected="selected">English</option>
            <option value='de/class.fiber.php'>German</option>
            <option value='es/class.fiber.php'>Spanish</option>
            <option value='fr/class.fiber.php'>French</option>
            <option value='it/class.fiber.php'>Italian</option>
            <option value='ja/class.fiber.php'>Japanese</option>
            <option value='pt_BR/class.fiber.php'>Brazilian Portuguese</option>
            <option value='ru/class.fiber.php'>Russian</option>
            <option value='tr/class.fiber.php'>Turkish</option>
            <option value='uk/class.fiber.php'>Ukrainian</option>
            <option value='zh/class.fiber.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.fiber" class="reference">
 <h1 class="title">The Fiber class</h1>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="fiber.getcurrent.php" class="methodname">getCurrent</a></span>(): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.fiber.php" class="type Fiber">Fiber</a></span></span></div>
  ...
  <div class="section" id="fiber.seealso">
   ...
   <p class="para"><a href="language.fibers.php" class="link">Fibers overview</a></p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="fiber.construct.php">Fiber::__construct</a> — Creates a new Fiber instance</li><li><a href="fiber.start.php">Fiber::start</a> — Start execution of the fiber</li><li><a href="fiber.resume.php">Fiber::resume</a> — Resumes execution of the fiber with a value</li><li><a href="fiber.throw.php">Fiber::throw</a> — Resumes execution of the fiber with an exception</li><li><a href="fiber.getreturn.php">Fiber::getReturn</a> — Gets the value returned by the Fiber</li><li><a href="fiber.isstarted.php">Fiber::isStarted</a> — Determines if the fiber has started</li><li><a href="fiber.issuspended.php">Fiber::isSuspended</a> — Determines if the fiber is suspended</li><li><a href="fiber.isrunning.php">Fiber::isRunning</a> — Determines if the fiber is running</li><li><a href="fiber.isterminated.php">Fiber::isTerminated</a> — Determines if the fiber has terminated</li><li><a href="fiber.suspend.php">Fiber::suspend</a> — Suspends execution of the current fiber</li><li><a href="fiber.getcurrent.php">Fiber::getCurrent</a> — Gets the currently executing Fiber instance</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/fiber.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.fiber%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.fiber&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.fiber.php">＋<small>add a note</small></a></span>
