...
<head>
  ...
  <title>PHP: mysqli::real_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.real-connect.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.real-connect.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.real-connect.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.query.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.real-escape-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.real-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.real-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.real-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.real-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.real-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.real-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.real-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.real-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.real-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.real-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.real-connect.php" hreflang="zh">
...
<meta name="Description" content="Opens a connection to a mysql server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::real_connect - Manual" />
<meta name="twitter:description" content="Opens a connection to a mysql server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::real_connect - Manual" />
<meta itemprop="description" content="Opens a connection to a mysql server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a connection to a mysql server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.real-escape-string.php">
          mysqli::real_escape_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.query.php">
          &laquo; mysqli::query        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.real-connect.php' selected="selected">English</option>
            <option value='de/mysqli.real-connect.php'>German</option>
            <option value='es/mysqli.real-connect.php'>Spanish</option>
            <option value='fr/mysqli.real-connect.php'>French</option>
            <option value='it/mysqli.real-connect.php'>Italian</option>
            <option value='ja/mysqli.real-connect.php'>Japanese</option>
            <option value='pt_BR/mysqli.real-connect.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.real-connect.php'>Russian</option>
            <option value='tr/mysqli.real-connect.php'>Turkish</option>
            <option value='uk/mysqli.real-connect.php'>Ukrainian</option>
            <option value='zh/mysqli.real-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.real-connect" class="refentry">
...
a <span class="classname"><a href="class.mysqli-sql-exception.php" class="classname">mysqli_sql_exception</a></span> is thrown instead.</p>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.real-connect-examples">
  ...
  <div class="example" id="example-1610">
   <p><strong>Example #1 <span class="methodname"><strong>mysqli::real_connect()</strong></span> example</strong></p>
...
calling <span class="function"><strong>mysqli_real_connect()</strong></span>, but after <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>.</p></p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.close.php" class="function" rel="rdfs-seeAlso">mysqli_close()</a> - Closes a previously opened database connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/real-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.real-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.real-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.real-connect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130384">  <div class="votes">
    <div id="Vu130384">
    <a href="/manual/vote-note.php?id=130384&amp;page=mysqli.real-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130384">
    <a href="/manual/vote-note.php?id=130384&amp;page=mysqli.real-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130384" title="no votes...">
    0
    </div>
  </div>
  <a href="#130384" class="name">
  <strong class="user"><em>aschmidt at anamera dot net</em></strong></a><a class="genanchor" href="#130384"> &para;</a><div class="date" title="2025-06-22 11:41"><strong>3 months ago</strong></div>
  <div class="text" id="Hcom130384">
<div class="phpcode"><code><span class="html">Despite native driver (mysqlnd 8.3.20) and MySQL &gt;5.6, the flag<br /><br /> MYSQLI_CLIENT_SSL_DONT_VERIFY_SERVER_CERT <br /><br />will cause connection to be rejected as "not secure", if server is set to require SSL connection (--require-secure-transport=ON). <br /><br />It appears that MYSQLI_CLIENT_SSL_DONT_VERIFY_SERVER_CERT is seemingly accepted, but will not actually initiate a secure connection.<br /><br />Similarly, if one tries to turn off certificate validation by setting options:<br /><br /> $mysqli-&gt;options(MYSQLI_OPT_SSL_VERIFY_SERVER_CERT, 0)<br /><br />then this will return "false", indicating that the option setting was not successful.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.real-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.real-connect.php">＋<small>add a note</small></a></div>
