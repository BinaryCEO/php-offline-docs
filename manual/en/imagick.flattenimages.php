...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.flattenimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.flattenimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.flattenimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.filter.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.flipimage.php">
...
<meta name="Description" content="Merges a sequence of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::flattenImages - Manual" />
<meta name="twitter:description" content="Merges a sequence of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::flattenImages - Manual" />
<meta itemprop="description" content="Merges a sequence of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Merges a sequence of images" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.flattenimages.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.flattenimages.php'>Russian</option>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/flattenimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.flattenimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.flattenimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.flattenimages.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The actual replacement now that flattenImages() has been deprecated is:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">mergeImageLayers</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">LAYERMETHOD_FLATTEN</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />So you need to (re)assign the returned Imagick object.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>nick at nickdobie dot com</em></strong></a><a class="genanchor" href="#116114"> &para;</a><div class="date" title="2014-11-11 02:38"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116114">
<div class="phpcode"><code><span class="html">This function is deprecated and will throw a warning in PHP 5.6. Simply replace this call with Imagick::mergeImageLayers(Imagick::LAYERMETHOD_FLATTEN) and it will behave the same way.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As nick said, the function Imagick::flattenImages() is deprecated. Replacing it by Imagick::mergeImageLayers(Imagick::LAYERMETHOD_FLATTEN) partially worked. Images with transparency (ex: .png) get black background even if the image background is set to white.<br /><br />Old working code:<br />$im-&gt;setImageBackgroundColor('white');<br />$im = $im-&gt;flattenImages();<br /><br />New working code:<br />$im-&gt;setImageBackgroundColor('white');<br />$im-&gt;setImageAlphaChannel(imagick::ALPHACHANNEL_REMOVE);<br />$im-&gt;mergeImageLayers(imagick::LAYERMETHOD_FLATTEN);<br /><br />imagick::ALPHACHANNEL_REMOVE is not shown on the constants page but do works with Imagick 3.2.0RC1.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Jairu5</em></strong></a><a class="genanchor" href="#101164"> &para;</a><div class="date" title="2010-11-30 08:29"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101164">
<div class="phpcode"><code><span class="html">Note that the function returns an Imagick object and does not modify the existing object. Below is my code for converting a PNG with transparency into a JPG with a background color. This code illustrates the difference.<br /><br /><span class="default">&lt;?php<br /><br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'image.png'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">(</span><span class="string">'white'</span><span class="keyword">);<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">flattenImages</span><span class="keyword">(); </span><span class="comment">// This does not do anything.<br /></span><span class="default">$im </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">flattenImages</span><span class="keyword">(); </span><span class="comment">// Use this instead.<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpg'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'image.jpg'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Samuel Fine (hi at samuelfine dot com)</em></strong></a><a class="genanchor" href="#106770"> &para;</a><div class="date" title="2011-12-05 09:32"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106770">
<div class="phpcode"><code><span class="html">This is also useful for accurately converting .ico files to .png. (Other types as well, in theory, but I've only tested ico-&gt;png.) Simply using setFormat will create a valid .png file, but will result in image artifacts if the original .ico had any transparency. The following code will create an accurate copy:<br /><br /><span class="default">&lt;?php<br /><br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /><br /></span><span class="comment">// When dealing with .ico files, make sure to setFormat before loading the image or you'll get a nasty exception. See <a href="https://bugs.php.net/bug.php?id=58515" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=58515</a> for more details.<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"ico"</span><span class="keyword">);<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">"favicon.ico"</span><span class="keyword">);<br /><br /></span><span class="default">$im </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">flattenImages</span><span class="keyword">(); </span><span class="comment">// Thanks for the tip, Jairu5!<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br /><br /></span><span class="default">$new </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"favicon.png"</span><span class="keyword">, </span><span class="string">"w"</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImageFile</span><span class="keyword">(</span><span class="default">$new</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">clear</span><span class="keyword">();<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Small correction to Jairu5's code:<br /><br />If you want to set the background color of a transparent image you have to set it _before_ loading the image.<br />Flattening images by default uses the background color 'white'. That's why Jairu5's code seem to work at first, but only until you want to actually change the background color to something different than white.<br /><br />Try using this instead:<br /><br /><span class="default">&lt;?php<br /><br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">(</span><span class="string">'green'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readimage</span><span class="keyword">(</span><span class="string">'image.png'</span><span class="keyword">);<br /><br /></span><span class="default">$im </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">flattenImages</span><span class="keyword">();<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpg'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'image.jpg'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.flattenimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.flattenimages.php">＋<small>add a note</small></a></div>
