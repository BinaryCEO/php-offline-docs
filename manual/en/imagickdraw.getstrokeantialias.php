...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeAntialias - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getgravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokeantialias.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokeantialias.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokeantialias.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokeantialias.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokeantialias.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokeantialias.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokeantialias.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokeantialias.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokeantialias.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokeantialias.php" hreflang="zh">
...
<meta name="Description" content="Returns the current stroke antialias setting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeAntialias - Manual" />
<meta name="twitter:description" content="Returns the current stroke antialias setting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeAntialias - Manual" />
<meta itemprop="description" content="Returns the current stroke antialias setting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current stroke antialias setting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getstrokecolor.php">
          ImagickDraw::getStrokeColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getgravity.php">
          &laquo; ImagickDraw::getGravity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokeantialias.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokeantialias.php'>German</option>
            <option value='es/imagickdraw.getstrokeantialias.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokeantialias.php'>French</option>
            <option value='it/imagickdraw.getstrokeantialias.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokeantialias.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokeantialias.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokeantialias.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokeantialias.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokeantialias.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokeantialias.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokeantialias" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeAntialias</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeAntialias</span> &mdash; <span class="dc-title">Returns the current stroke antialias setting</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokeantialias-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if antialiasing is on and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if it is off.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokeantialias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokeantialias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokeantialias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokeantialias.php">＋<small>add a note</small></a></span>
