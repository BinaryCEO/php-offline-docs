...
<head>
  ...
  <title>PHP: fann_destroy_train - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-destroy-train.php">
 <link rel="shorturl" href="https://www.php.net/fann-destroy-train">
 <link rel="alternate" href="https://www.php.net/fann-destroy-train" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-duplicate-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-destroy-train.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-destroy-train.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-destroy-train.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-destroy-train.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-destroy-train.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-destroy-train.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-destroy-train.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-destroy-train.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-destroy-train.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-destroy-train.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-destroy-train.php" hreflang="zh">
...
<meta name="Description" content="Destructs the training data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_destroy_train - Manual" />
<meta name="twitter:description" content="Destructs the training data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_destroy_train - Manual" />
<meta itemprop="description" content="Destructs the training data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Destructs the training data" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-duplicate-train-data.php">
          fann_duplicate_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-destroy.php">
          &laquo; fann_destroy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-destroy-train.php' selected="selected">English</option>
            <option value='de/function.fann-destroy-train.php'>German</option>
            <option value='es/function.fann-destroy-train.php'>Spanish</option>
            <option value='fr/function.fann-destroy-train.php'>French</option>
            <option value='it/function.fann-destroy-train.php'>Italian</option>
            <option value='ja/function.fann-destroy-train.php'>Japanese</option>
            <option value='pt_BR/function.fann-destroy-train.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-destroy-train.php'>Russian</option>
            <option value='tr/function.fann-destroy-train.php'>Turkish</option>
            <option value='uk/function.fann-destroy-train.php'>Ukrainian</option>
            <option value='zh/function.fann-destroy-train.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-destroy-train" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_destroy_train</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_destroy_train</span> &mdash; <span class="dc-title">Destructs the training data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-destroy-train-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_destroy_train</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$train_data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-destroy-train-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-destroy-train-returnvalues">
  ...
  <p class="para">Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-destroy-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-destroy-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-destroy-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-destroy-train.php">＋<small>add a note</small></a></span>
