...
<head>
  ...
  <title>PHP: svn_diff - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-diff.php">
 <link rel="shorturl" href="https://www.php.net/svn-diff">
 <link rel="alternate" href="https://www.php.net/svn-diff" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-diff.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-diff.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-diff.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-diff.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-diff.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-diff.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-diff.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-diff.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-diff.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-diff.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-diff.php" hreflang="zh">
...
<meta name="Description" content="Recursively diffs two paths" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_diff - Manual" />
<meta name="twitter:description" content="Recursively diffs two paths" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_diff - Manual" />
<meta itemprop="description" content="Recursively diffs two paths" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Recursively diffs two paths" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-diff.php' selected="selected">English</option>
            <option value='de/function.svn-diff.php'>German</option>
            <option value='es/function.svn-diff.php'>Spanish</option>
            <option value='fr/function.svn-diff.php'>French</option>
            <option value='it/function.svn-diff.php'>Italian</option>
            <option value='ja/function.svn-diff.php'>Japanese</option>
            <option value='pt_BR/function.svn-diff.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-diff.php'>Russian</option>
            <option value='tr/function.svn-diff.php'>Turkish</option>
            <option value='uk/function.svn-diff.php'>Ukrainian</option>
            <option value='zh/function.svn-diff.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-diff" class="refentry">
   ...
   <ul class="simplelist">
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.diff.html" class="link external">&raquo;&nbsp;SVN documentation on svn diff</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-diff.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-diff%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-diff&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-diff.php">＋<small>add a note</small></a></span>
