...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setmiterlimit.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setlinewidth.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setoverprintmode.php">
...
<meta name="Description" content="Sets the miter limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setmiterlimit - Manual" />
<meta name="twitter:description" content="Sets the miter limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setmiterlimit - Manual" />
<meta itemprop="description" content="Sets the miter limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the miter limit" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setmiterlimit.php' selected="selected">English</option>
            <option value='de/function.ps-setmiterlimit.php'>German</option>
            <option value='es/function.ps-setmiterlimit.php'>Spanish</option>
            <option value='fr/function.ps-setmiterlimit.php'>French</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setlinewidth.php" class="function" rel="rdfs-seeAlso">ps_setlinewidth()</a> - Sets width of a line</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setmiterlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setmiterlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setmiterlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setmiterlimit.php">＋<small>add a note</small></a></span>
