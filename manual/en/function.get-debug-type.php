...
<head>
  ...
  <title>PHP: get_debug_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-debug-type.php">
 <link rel="shorturl" href="https://www.php.net/get-debug-type">
 <link rel="alternate" href="https://www.php.net/get-debug-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.var.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.floatval.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-defined-vars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-debug-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-debug-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-debug-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-debug-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-debug-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-debug-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-debug-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-debug-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-debug-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-debug-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-debug-type.php" hreflang="zh">
...
<meta name="Description" content="Gets the type name of a variable in a way that is suitable for debugging" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_debug_type - Manual" />
<meta name="twitter:description" content="Gets the type name of a variable in a way that is suitable for debugging" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_debug_type - Manual" />
<meta itemprop="description" content="Gets the type name of a variable in a way that is suitable for debugging" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the type name of a variable in a way that is suitable for debugging" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.get-defined-vars.php">
          get_defined_vars &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-debug-type.php' selected="selected">English</option>
            <option value='de/function.get-debug-type.php'>German</option>
            <option value='es/function.get-debug-type.php'>Spanish</option>
            <option value='fr/function.get-debug-type.php'>French</option>
            <option value='it/function.get-debug-type.php'>Italian</option>
            <option value='ja/function.get-debug-type.php'>Japanese</option>
            <option value='pt_BR/function.get-debug-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-debug-type.php'>Russian</option>
            <option value='tr/function.get-debug-type.php'>Turkish</option>
            <option value='uk/function.get-debug-type.php'>Ukrainian</option>
            <option value='zh/function.get-debug-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-debug-type" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.get-class.php" class="function" rel="rdfs-seeAlso">get_class()</a> - Returns the name of the class of an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/get-debug-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-debug-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-debug-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-debug-type.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128994">  <div class="votes">
    <div id="Vu128994">
    <a href="/manual/vote-note.php?id=128994&amp;page=function.get-debug-type&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128994">
    <a href="/manual/vote-note.php?id=128994&amp;page=function.get-debug-type&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128994" title="63% like this...">
    3
    </div>
  </div>
  <a href="#128994" class="name">
  <strong class="user"><em>vyacheslav dot belchuk at gmail dot com</em></strong></a><a class="genanchor" href="#128994"> &para;</a><div class="date" title="2023-11-02 05:52"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom128994">
<div class="phpcode"><code><span class="html">Also, the function returns the correct type of Closure, as opposed to gettype()<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">echo </span><span class="default">get_debug_type</span><span class="keyword">(function () {}) . </span><span class="default">PHP_EOL</span><span class="keyword">;<br />echo </span><span class="default">get_debug_type</span><span class="keyword">(fn () =&gt; </span><span class="string">''</span><span class="keyword">) . </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br />echo </span><span class="default">gettype</span><span class="keyword">(function () {}) . </span><span class="default">PHP_EOL</span><span class="keyword">;<br />echo </span><span class="default">gettype</span><span class="keyword">(fn () =&gt; </span><span class="string">''</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Output:<br /><br />Closure<br />Closure<br /><br />object<br />object</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.get-debug-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-debug-type.php">＋<small>add a note</small></a></div>
