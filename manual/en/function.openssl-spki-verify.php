...
<head>
  ...
  <title>PHP: openssl_spki_verify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-spki-verify.php">
 <link rel="shorturl" href="https://www.php.net/openssl-spki-verify">
 <link rel="alternate" href="https://www.php.net/openssl-spki-verify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-spki-new.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-verify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-spki-verify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-spki-verify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-spki-verify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-spki-verify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-spki-verify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-spki-verify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-spki-verify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-spki-verify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-spki-verify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-spki-verify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-spki-verify.php" hreflang="zh">
...
<meta name="Description" content="Verifies a signed public key and challenge" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_spki_verify - Manual" />
<meta name="twitter:description" content="Verifies a signed public key and challenge" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_spki_verify - Manual" />
<meta itemprop="description" content="Verifies a signed public key and challenge" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verifies a signed public key and challenge" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-verify.php">
          openssl_verify &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-spki-new.php">
          &laquo; openssl_spki_new        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-spki-verify.php' selected="selected">English</option>
            <option value='de/function.openssl-spki-verify.php'>German</option>
            <option value='es/function.openssl-spki-verify.php'>Spanish</option>
            <option value='fr/function.openssl-spki-verify.php'>French</option>
            <option value='it/function.openssl-spki-verify.php'>Italian</option>
            <option value='ja/function.openssl-spki-verify.php'>Japanese</option>
            <option value='pt_BR/function.openssl-spki-verify.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-spki-verify.php'>Russian</option>
            <option value='tr/function.openssl-spki-verify.php'>Turkish</option>
            <option value='uk/function.openssl-spki-verify.php'>Ukrainian</option>
            <option value='zh/function.openssl-spki-verify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-spki-verify" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_spki_verify</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_spki_verify</span> &mdash; <span class="dc-title">Verifies a signed public key and challenge</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-spki-verify-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_spki_verify</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$spki</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-spki-verify-examples">
  ...
  <div class="example" id="openssl_spki_verify.example.basic">
   <p><strong>Example #1 <span class="function"><strong>openssl_spki_verify()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-spki-verify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-spki-verify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-spki-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-verify.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121026">  <div class="votes">
    <div id="Vu121026">
    <a href="/manual/vote-note.php?id=121026&amp;page=function.openssl-spki-verify&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121026">
    <a href="/manual/vote-note.php?id=121026&amp;page=function.openssl-spki-verify&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121026" title="100% like this...">
    4
    </div>
  </div>
  <a href="#121026" class="name">
  <strong class="user"><em>carloshlfzanon at gmail dot com</em></strong></a><a class="genanchor" href="#121026"> &para;</a><div class="date" title="2017-04-26 08:54"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121026">
<div class="phpcode"><code><span class="html">This openssl_spki_* funcs are very usefull to use with &lt;keygen/&gt; tag in html5.<br /><br />Example:<br /><br /><span class="default">&lt;?php<br />session_start</span><span class="keyword">();<br /><br /></span><span class="comment">// form submitted... (?)<br /></span><span class="keyword">if(isset(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'security'</span><span class="keyword">]))<br />{<br />    </span><span class="comment">// If true, the send from &lt;keygen/&gt; is valid and you can<br />    // test the challenge too<br />    </span><span class="keyword">if(</span><span class="default">openssl_spki_verify</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'security'</span><span class="keyword">]))<br />    {<br />        </span><span class="comment">// Gets challenge string<br />        </span><span class="default">$challenge </span><span class="keyword">= </span><span class="default">openssl_spki_export_challenge</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'security'</span><span class="keyword">]);<br /><br />        </span><span class="comment">// If true... you are not trying to trick it.<br />        // If user open 2 windows to prevent data lost from a "mistake" or him just press "back" button<br />        //  and re-send last data... you can handle it using something like it.<br />        </span><span class="keyword">if(</span><span class="default">$challenge </span><span class="keyword">== </span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'lastForm'</span><span class="keyword">])<br />        {<br />            echo </span><span class="string">'Ok, this one is valid.'</span><span class="keyword">, </span><span class="string">'&lt;br&gt;&lt;br&gt;'</span><span class="keyword">;<br />        }<br />        else<br />        {<br />            echo </span><span class="string">'Nice try... nice try...'</span><span class="keyword">, </span><span class="string">'&lt;br&gt;&lt;br&gt;'</span><span class="keyword">; <br />        }<br />    }<br /><br />}<br /><br /></span><span class="comment">// If you open two window, the challenge won't match!<br /></span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'lastForm'</span><span class="keyword">] = </span><span class="default">hash</span><span class="keyword">(</span><span class="string">'md5'</span><span class="keyword">, </span><span class="default">microtime</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;<br /></span><br />&lt;!DOCTYPE html&gt;<br />&lt;html&gt;<br />&lt;body&gt;<br /><br />&lt;form action="/index.php" method="post"&gt;<br />  Encryption: &lt;keygen name="security" keytype="rsa" challenge="<span class="default">&lt;?php </span><span class="keyword">echo </span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'lastForm'</span><span class="keyword">]; </span><span class="default">?&gt;</span>"/&gt;<br />  &lt;input type="submit"&gt;<br />&lt;/form&gt;<br /><br />&lt;/body&gt;<br />&lt;/html&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="125143">  <div class="votes">
    <div id="Vu125143">
    <a href="/manual/vote-note.php?id=125143&amp;page=function.openssl-spki-verify&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125143">
    <a href="/manual/vote-note.php?id=125143&amp;page=function.openssl-spki-verify&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125143" title="no votes...">
    0
    </div>
  </div>
  <a href="#125143" class="name">
  <strong class="user"><em>neat at neato dot com</em></strong></a><a class="genanchor" href="#125143"> &para;</a><div class="date" title="2020-06-25 10:40"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125143">
<div class="phpcode"><code><span class="html">The challenge is not how to very a "trick". It is used as a partial non-repudiation method.<br /><br />The idea was the challenge could be extracted from the base64 encoded ASN.1 PKCS#1 bits provided from the 'keygen' element.<br /><br />The SPKAC is a form of CSR which if the right about of information such as the commonName, emailAddress, countryName, stateOrProvinceName, localityName et al., a signed x509 could generated and provided to the requestor.<br /><br />This would then be installed in the browser and if the webserver was configured to accept client x509 certificates, it would be used in lieu of a password for authentication.<br /><br />A recommendation was to use the 'challenge' as a form of non-repudiation in the event someone else was on your keyboard. If the application required it could prompt you for the challenge and compare it to a hashed version it stored upon the initial SPKAC process.<br /><br />Hope that helps clear it up.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-spki-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-verify.php">＋<small>add a note</small></a></div>
