...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-real-escape-string.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-result.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-real-escape-string.php' selected="selected">English</option>
            ...
            <option value='zh/function.cubrid-real-escape-string.php'>Chinese (Simplified)</option>
...
<div class="examplescode"><pre class="examplescode">array(1) {
  ...
  string(95) &quot; !&quot;#$%&amp;&#039;()*+,-./0123456789:;&lt;=&gt;?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-real-escape-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-real-escape-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-real-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-real-escape-string.php">＋<small>add a note</small></a></span>
