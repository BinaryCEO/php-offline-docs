...
<head>
  ...
  <title>PHP: mysql_field_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-seek.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-seek">
 <link rel="alternate" href="https://www.php.net/mysql-field-seek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-table.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-seek.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_field_seek - Manual" />
<meta name="twitter:description" content="Set result pointer to a specified field offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_seek - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-field-table.php">
          mysql_field_table &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-name.php">
          &laquo; mysql_field_name        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-seek.php' selected="selected">English</option>
            <option value='de/function.mysql-field-seek.php'>German</option>
            <option value='es/function.mysql-field-seek.php'>Spanish</option>
            <option value='fr/function.mysql-field-seek.php'>French</option>
            <option value='it/function.mysql-field-seek.php'>Italian</option>
            <option value='ja/function.mysql-field-seek.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-seek.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-seek.php'>Russian</option>
            <option value='tr/function.mysql-field-seek.php'>Turkish</option>
            <option value='uk/function.mysql-field-seek.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-seek" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-fetch-field.php" class="function" rel="rdfs-seeAlso">mysql_fetch_field()</a> - Get column information from a result and return as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-seek.php">＋<small>add a note</small></a></span>
