...
<head>
  ...
  <title>PHP: fann_get_cascade_output_change_fraction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-cascade-output-change-fraction.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-cascade-output-change-fraction">
 <link rel="alternate" href="https://www.php.net/fann-get-cascade-output-change-fraction" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-cascade-num-candidates.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-cascade-output-stagnation-epochs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-cascade-output-change-fraction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-cascade-output-change-fraction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-cascade-output-change-fraction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-cascade-output-change-fraction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-cascade-output-change-fraction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-cascade-output-change-fraction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-cascade-output-change-fraction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-cascade-output-change-fraction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-cascade-output-change-fraction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-cascade-output-change-fraction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-cascade-output-change-fraction.php" hreflang="zh">
...
<meta name="Description" content="Returns the cascade output change fraction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_cascade_output_change_fraction - Manual" />
<meta name="twitter:description" content="Returns the cascade output change fraction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_cascade_output_change_fraction - Manual" />
<meta itemprop="description" content="Returns the cascade output change fraction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the cascade output change fraction" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-get-cascade-output-stagnation-epochs.php">
          fann_get_cascade_output_stagnation_epochs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-cascade-num-candidates.php">
          &laquo; fann_get_cascade_num_candidates        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-cascade-output-change-fraction.php' selected="selected">English</option>
            <option value='de/function.fann-get-cascade-output-change-fraction.php'>German</option>
            <option value='es/function.fann-get-cascade-output-change-fraction.php'>Spanish</option>
            <option value='fr/function.fann-get-cascade-output-change-fraction.php'>French</option>
            <option value='it/function.fann-get-cascade-output-change-fraction.php'>Italian</option>
            <option value='ja/function.fann-get-cascade-output-change-fraction.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-cascade-output-change-fraction.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-cascade-output-change-fraction.php'>Russian</option>
            <option value='tr/function.fann-get-cascade-output-change-fraction.php'>Turkish</option>
            <option value='uk/function.fann-get-cascade-output-change-fraction.php'>Ukrainian</option>
            <option value='zh/function.fann-get-cascade-output-change-fraction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-cascade-output-change-fraction" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.fann-get-cascade-output-change-fraction-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_cascade_output_change_fraction</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   The cascade output change fraction is a number between 0 and 1 determining how large a fraction of the <span class="function"><a href="function.fann-get-mse.php" class="function">fann_get_MSE()</a></span>
   value should change within <span class="function"><a href="function.fann-get-cascade-output-stagnation-epochs.php" class="function">fann_get_cascade_output_stagnation_epochs()</a></span> during training of the output connections,
  ...
  <p class="para">
   ...
   a period of <span class="function"><a href="function.fann-get-cascade-output-stagnation-epochs.php" class="function">fann_get_cascade_output_stagnation_epochs()</a></span>, the training of the output connections is
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-cascade-output-change-fraction-returnvalues">
  ...
  <p class="para">
   The cascade output change fraction, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-get-cascade-output-change-fraction-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-cascade-output-change-fraction.php" class="function" rel="rdfs-seeAlso">fann_set_cascade_output_change_fraction()</a> - Sets the cascade output change fraction</span></li>
    ...
    <li><span class="function"><a href="function.fann-get-cascade-output-stagnation-epochs.php" class="function" rel="rdfs-seeAlso">fann_get_cascade_output_stagnation_epochs()</a> - Returns the number of cascade output stagnation epochs</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-cascade-output-change-fraction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-cascade-output-change-fraction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-cascade-output-change-fraction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-cascade-output-change-fraction.php">＋<small>add a note</small></a></span>
