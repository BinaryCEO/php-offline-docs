...
<head>
  ...
  <title>PHP: ldap_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-delete.php">
 <link rel="shorturl" href="https://www.php.net/ldap-delete">
 <link rel="alternate" href="https://www.php.net/ldap-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-count-references.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-delete-ext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-delete.php" hreflang="zh">
...
<meta name="Description" content="Delete an entry from a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_delete - Manual" />
<meta name="twitter:description" content="Delete an entry from a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_delete - Manual" />
<meta itemprop="description" content="Delete an entry from a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an entry from a directory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-delete-ext.php">
          ldap_delete_ext &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-count-references.php">
          &laquo; ldap_count_references        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-delete.php' selected="selected">English</option>
            <option value='de/function.ldap-delete.php'>German</option>
            <option value='es/function.ldap-delete.php'>Spanish</option>
            <option value='fr/function.ldap-delete.php'>French</option>
            <option value='it/function.ldap-delete.php'>Italian</option>
            <option value='ja/function.ldap-delete.php'>Japanese</option>
            <option value='pt_BR/function.ldap-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-delete.php'>Russian</option>
            <option value='tr/function.ldap-delete.php'>Turkish</option>
            <option value='uk/function.ldap-delete.php'>Ukrainian</option>
            <option value='zh/function.ldap-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-delete" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_delete</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_delete</span> &mdash; <span class="dc-title">Delete an entry from a directory</span></p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.ldap-delete-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-delete-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-delete-ext.php" class="function" rel="rdfs-seeAlso">ldap_delete_ext()</a> - Delete an entry from a directory</span></li>
    <li><span class="function"><a href="function.ldap-add.php" class="function" rel="rdfs-seeAlso">ldap_add()</a> - Add entries to LDAP directory</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-delete.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="21467">  <div class="votes">
    <div id="Vu21467">
    <a href="/manual/vote-note.php?id=21467&amp;page=function.ldap-delete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd21467">
    <a href="/manual/vote-note.php?id=21467&amp;page=function.ldap-delete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V21467" title="58% like this...">
    2
    </div>
  </div>
  <a href="#21467" class="name">
  <strong class="user"><em>gabriel at hrz dot uni-marburg dot de</em></strong></a><a class="genanchor" href="#21467"> &para;</a><div class="date" title="2002-05-14 08:16"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom21467">
<div class="phpcode"><code><span class="html">Useful function to delete dn entries recursively<br /><br />bool myldap_delete ( resource ds, string dn, bool recursive)<br /><br />Returns TRUE on success, FALSE on failure<br />recursive is by default FALSE (same behaviour as ldap_delete)<br /><br />function myldap_delete($ds,$dn,$recursive=false){<br />    if($recursive == false){<br />        return(ldap_delete($ds,$dn));<br />    }else{<br />        //searching for sub entries<br />        $sr=ldap_list($ds,$dn,"ObjectClass=*",array(""));<br />        $info = ldap_get_entries($ds, $sr);<br />        for($i=0;$i&lt;$info['count'];$i++){<br />            //deleting recursively sub entries<br />            $result=myldap_delete($ds,$info[$i]['dn'],$recursive);<br />            if(!$result){<br />                //return result code, if delete fails<br />                return($result);<br />            }<br />        }<br />        return(ldap_delete($ds,$dn));<br />    }<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="122302">  <div class="votes">
    <div id="Vu122302">
    <a href="/manual/vote-note.php?id=122302&amp;page=function.ldap-delete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122302">
    <a href="/manual/vote-note.php?id=122302&amp;page=function.ldap-delete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122302" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#122302" class="name">
  <strong class="user"><em>grossman at post dot cz</em></strong></a><a class="genanchor" href="#122302"> &para;</a><div class="date" title="2018-01-23 10:56"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122302">
<div class="phpcode"><code><span class="html">Be aware! Operation not allowed on non-leaf.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-delete.php">＋<small>add a note</small></a></div>
