...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reserved.variables.request.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reserved.variables.request.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reserved.variables.request.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.variables.php">
 <link rel="prev" href="https://www.php.net/manual/en/reserved.variables.files.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.variables.session.php">
...
<meta name="Description" content="HTTP Request variables" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: $_REQUEST - Manual" />
<meta name="twitter:description" content="HTTP Request variables" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: $_REQUEST - Manual" />
<meta itemprop="description" content="HTTP Request variables" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="HTTP Request variables" />
  ...
  <ul class="simplelist">
   ...
   <li><a href="book.filter.php" class="link">The filter extension</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/variables/request.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freserved.variables.request%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reserved.variables.request&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.request.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The default php.ini on your system as of in PHP 5.3.0 may exclude cookies from $_REQUEST.  The request_order ini directive specifies what goes in the $_REQUEST array; if that does not exist, then the variables_order directive does.  Your distribution's php.ini may exclude cookies by default, so beware.</span></code></div>
  </div>
 </div>
  <div class="note" id="125436">  <div class="votes">
    ...
    <div class="tally" id="V125436" title="50% like this...">
    2
    </div>
  </div>
  <a href="#125436" class="name">
  <strong class="user"><em>codeblog.pro</em></strong></a><a class="genanchor" href="#125436"> &para;</a><div class="date" title="2020-10-13 12:43"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125436">
<div class="phpcode"><code><span class="html">In PHP version 7.0 with the default settings.+, $_REQUEST array does not contain cookies.</span></code></div>
  </div>
 </div>
  <div class="note" id="119368">  <div class="votes">
    ...
    <div class="tally" id="V119368" title="50% like this...">
    3
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">To access $_POST, $_GET, etc, use the function filter_input(TYPE, varname, filter) to ensure that your data is clean. <br /><br />Also, I was brought up to believe that modifying superglobals is a BAD idea. I stand by this belief and would recommend you do too</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reserved.variables.request&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.request.php">＋<small>add a note</small></a></div>
