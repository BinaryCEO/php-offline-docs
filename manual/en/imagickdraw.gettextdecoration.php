...
<head>
  ...
  <title>PHP: ImagickDraw::getTextDecoration - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextantialias.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextencoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.gettextdecoration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.gettextdecoration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.gettextdecoration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.gettextdecoration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.gettextdecoration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.gettextdecoration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.gettextdecoration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.gettextdecoration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.gettextdecoration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.gettextdecoration.php" hreflang="zh">
...
<meta name="Description" content="Returns the text decoration" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextDecoration - Manual" />
<meta name="twitter:description" content="Returns the text decoration" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextDecoration - Manual" />
<meta itemprop="description" content="Returns the text decoration" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the text decoration" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.gettextencoding.php">
          ImagickDraw::getTextEncoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.gettextantialias.php">
          &laquo; ImagickDraw::getTextAntialias        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextdecoration.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextdecoration.php'>German</option>
            <option value='es/imagickdraw.gettextdecoration.php'>Spanish</option>
            <option value='fr/imagickdraw.gettextdecoration.php'>French</option>
            <option value='it/imagickdraw.gettextdecoration.php'>Italian</option>
            <option value='ja/imagickdraw.gettextdecoration.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.gettextdecoration.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.gettextdecoration.php'>Russian</option>
            <option value='tr/imagickdraw.gettextdecoration.php'>Turkish</option>
            <option value='uk/imagickdraw.gettextdecoration.php'>Ukrainian</option>
            <option value='zh/imagickdraw.gettextdecoration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.gettextdecoration" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getTextDecoration</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextDecoration</span> &mdash; <span class="dc-title">Returns the text decoration</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.gettextdecoration-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getTextDecoration</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextdecoration-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <a href="imagick.constants.php#imagick.constants.decoration" class="link">DECORATION</a> constant
   (<code class="literal">imagick::DECORATION_*</code>), and 0 if no decoration is set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextdecoration.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextdecoration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextdecoration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextdecoration.php">＋<small>add a note</small></a></span>
