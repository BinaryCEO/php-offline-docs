...
<head>
  ...
  <title>PHP: ImagickKernel::scale - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickkernel.scale.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickkernel.scale.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickkernel.scale.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickkernel.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickkernel.getmatrix.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickkernel.separate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickkernel.scale.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickkernel.scale.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickkernel.scale.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickkernel.scale.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickkernel.scale.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickkernel.scale.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickkernel.scale.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickkernel.scale.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickkernel.scale.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickkernel.scale.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickkernel.scale.php" hreflang="zh">
...
<meta name="Description" content="Scales a kernel list by the given amount" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickKernel::scale - Manual" />
<meta name="twitter:description" content="Scales a kernel list by the given amount" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickKernel::scale - Manual" />
<meta itemprop="description" content="Scales a kernel list by the given amount" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scales a kernel list by the given amount" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickkernel.separate.php">
          ImagickKernel::separate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickkernel.getmatrix.php">
          &laquo; ImagickKernel::getMatrix        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickkernel.scale.php' selected="selected">English</option>
            <option value='de/imagickkernel.scale.php'>German</option>
            <option value='es/imagickkernel.scale.php'>Spanish</option>
            <option value='fr/imagickkernel.scale.php'>French</option>
            <option value='it/imagickkernel.scale.php'>Italian</option>
            <option value='ja/imagickkernel.scale.php'>Japanese</option>
            <option value='pt_BR/imagickkernel.scale.php'>Brazilian Portuguese</option>
            <option value='ru/imagickkernel.scale.php'>Russian</option>
            <option value='tr/imagickkernel.scale.php'>Turkish</option>
            <option value='uk/imagickkernel.scale.php'>Ukrainian</option>
            <option value='zh/imagickkernel.scale.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickkernel.scale" class="refentry">
  ...
  <p class="para">
    <div class="example" id="example-3223">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickkernel/scale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickkernel.scale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickkernel.scale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickkernel.scale.php">＋<small>add a note</small></a></span>
