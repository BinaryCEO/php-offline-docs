...
<head>
  ...
  <title>PHP: IntlChar::getPropertyValueEnum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.getpropertyvalueenum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.getpropertyvalueenum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getpropertyvalueenum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.getpropertyname.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.getpropertyvaluename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getpropertyvalueenum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.getpropertyvalueenum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.getpropertyvalueenum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.getpropertyvalueenum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.getpropertyvalueenum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.getpropertyvalueenum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.getpropertyvalueenum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.getpropertyvalueenum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.getpropertyvalueenum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.getpropertyvalueenum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.getpropertyvalueenum.php" hreflang="zh">
...
<meta name="Description" content="Get the property value for a given value name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::getPropertyValueEnum - Manual" />
<meta name="twitter:description" content="Get the property value for a given value name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::getPropertyValueEnum - Manual" />
<meta itemprop="description" content="Get the property value for a given value name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the property value for a given value name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.getpropertyvaluename.php">
          IntlChar::getPropertyValueName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.getpropertyname.php">
          &laquo; IntlChar::getPropertyName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.getpropertyvalueenum.php' selected="selected">English</option>
            <option value='de/intlchar.getpropertyvalueenum.php'>German</option>
            <option value='es/intlchar.getpropertyvalueenum.php'>Spanish</option>
            <option value='fr/intlchar.getpropertyvalueenum.php'>French</option>
            <option value='it/intlchar.getpropertyvalueenum.php'>Italian</option>
            <option value='ja/intlchar.getpropertyvalueenum.php'>Japanese</option>
            <option value='pt_BR/intlchar.getpropertyvalueenum.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.getpropertyvalueenum.php'>Russian</option>
            <option value='tr/intlchar.getpropertyvalueenum.php'>Turkish</option>
            <option value='uk/intlchar.getpropertyvalueenum.php'>Ukrainian</option>
            <option value='zh/intlchar.getpropertyvalueenum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.getpropertyvalueenum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::getPropertyValueEnum</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::getPropertyValueEnum</span> &mdash; <span class="dc-title">Get the property value for a given value name</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.getpropertyvalueenum-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::getPropertyValueEnum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$property</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <dl>
    ...
    <dd>
     ...
     <p class="para">
      ...
      <strong><code><a href="class.intlchar.php#intlchar.constants.property-invalid-code">IntlChar::PROPERTY_INVALID_CODE</a></code></strong> is returned.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.getpropertyvalueenum-returnvalues">
  ...
  <p class="para">
   Returns the corresponding value integer, or <strong><code><a href="class.intlchar.php#intlchar.constants.property-invalid-code">IntlChar::PROPERTY_INVALID_CODE</a></code></strong> if the given name
...
bool(true)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/getpropertyvalueenum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.getpropertyvalueenum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.getpropertyvalueenum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.getpropertyvalueenum.php">＋<small>add a note</small></a></span>
