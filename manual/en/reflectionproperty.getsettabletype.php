...
<head>
  ...
  <title>PHP: ReflectionProperty::getSettableType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getrawvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.gettype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.getsettabletype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.getsettabletype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.getsettabletype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.getsettabletype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.getsettabletype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.getsettabletype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.getsettabletype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.getsettabletype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.getsettabletype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.getsettabletype.php" hreflang="zh">
...
<meta name="Description" content="Returns the parameter type of a setter hook" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getSettableType - Manual" />
<meta name="twitter:description" content="Returns the parameter type of a setter hook" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getSettableType - Manual" />
<meta itemprop="description" content="Returns the parameter type of a setter hook" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the parameter type of a setter hook" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.gettype.php">
          ReflectionProperty::getType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.getrawvalue.php">
          &laquo; ReflectionProperty::getRawValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.getsettabletype.php' selected="selected">English</option>
            <option value='de/reflectionproperty.getsettabletype.php'>German</option>
            <option value='es/reflectionproperty.getsettabletype.php'>Spanish</option>
            <option value='fr/reflectionproperty.getsettabletype.php'>French</option>
            <option value='it/reflectionproperty.getsettabletype.php'>Italian</option>
            <option value='ja/reflectionproperty.getsettabletype.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.getsettabletype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.getsettabletype.php'>Russian</option>
            <option value='tr/reflectionproperty.getsettabletype.php'>Turkish</option>
            <option value='uk/reflectionproperty.getsettabletype.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.getsettabletype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.getsettabletype" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-reflectionproperty.getsettabletype-description">
  ...
  <p class="simpara">
   ...
   to <span class="methodname"><a href="reflectionproperty.gettype.php" class="methodname">ReflectionProperty::getType()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionproperty.getsettabletype-returnvalues">
  ...
  <ul class="simplelist">
   <li>
    This method returns an instance of <span class="classname"><a href="class.reflectiontype.php" class="classname">ReflectionType</a></span> that matches
   ...
   <li>
    ...
    returned, identically to <span class="methodname"><a href="reflectionproperty.gettype.php" class="methodname">ReflectionProperty::getType()</a></span>.  This value may be <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>
    if the property is untyped.
   </li>
   <li>
    If the property is virtual and has no <code class="literal">set</code> hook, a <span class="classname"><a href="class.reflectiontype.php" class="classname">ReflectionType</a></span>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="reflectionproperty.gettype.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::getType()</a> - Gets a property's type</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/getsettabletype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.getsettabletype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.getsettabletype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getsettabletype.php">＋<small>add a note</small></a></span>
