...
<head>
  ...
  <title>PHP: Imagick::setImageMatte - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagematte.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagematte.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagematte.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageiterations.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagemattecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagematte.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagematte.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagematte.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagematte.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagematte.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagematte.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagematte.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagematte.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagematte.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagematte.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagematte.php" hreflang="zh">
...
<meta name="Description" content="Sets the image matte channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageMatte - Manual" />
<meta name="twitter:description" content="Sets the image matte channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageMatte - Manual" />
<meta itemprop="description" content="Sets the image matte channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image matte channel" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagemattecolor.php">
          Imagick::setImageMatteColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageiterations.php">
          &laquo; Imagick::setImageIterations        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagematte.php' selected="selected">English</option>
            <option value='de/imagick.setimagematte.php'>German</option>
            <option value='es/imagick.setimagematte.php'>Spanish</option>
            <option value='fr/imagick.setimagematte.php'>French</option>
            <option value='it/imagick.setimagematte.php'>Italian</option>
            <option value='ja/imagick.setimagematte.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagematte.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagematte.php'>Russian</option>
            <option value='tr/imagick.setimagematte.php'>Turkish</option>
            <option value='uk/imagick.setimagematte.php'>Ukrainian</option>
            <option value='zh/imagick.setimagematte.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagematte" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageMatte</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageMatte</span> &mdash; <span class="dc-title">Sets the image matte channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagematte-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageMatte</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$matte</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagematte-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">matte</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagematte-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagematte.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagematte%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagematte&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagematte.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106051">  <div class="votes">
    <div id="Vu106051">
    <a href="/manual/vote-note.php?id=106051&amp;page=imagick.setimagematte&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106051">
    <a href="/manual/vote-note.php?id=106051&amp;page=imagick.setimagematte&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106051" title="100% like this...">
    6
    </div>
  </div>
  <a href="#106051" class="name">
  <strong class="user"><em>martin at psinas dot com</em></strong></a><a class="genanchor" href="#106051"> &para;</a><div class="date" title="2011-10-05 06:33"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106051">
<div class="phpcode"><code><span class="html">I found this method is needed when creating a font / image mask, and needs to be set to false otherwise the mask won't take effect. Here is an example:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Create objects<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'myImage.png'</span><span class="keyword">);<br /></span><span class="default">$watermark </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$mask </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br /><br /></span><span class="comment">// Define dimensions<br /></span><span class="default">$width </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">();<br /><br /></span><span class="comment">// Create some palettes<br /></span><span class="default">$watermark</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'grey30'</span><span class="keyword">));<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'black'</span><span class="keyword">));<br /><br /></span><span class="comment">// Watermark text<br /></span><span class="default">$text </span><span class="keyword">= </span><span class="string">'Copyright'</span><span class="keyword">;<br /><br /></span><span class="comment">// Set font properties<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFont</span><span class="keyword">(</span><span class="string">'Bookman-Demi'</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">20</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'grey70'</span><span class="keyword">);<br /><br /></span><span class="comment">// Position text<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setGravity</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">GRAVITY_SOUTHEAST</span><span class="keyword">);<br /><br /></span><span class="comment">// Draw text on the watermark palette<br /></span><span class="default">$watermark</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="default">12</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br /><br /></span><span class="comment">// Draw text on the mask palette<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'white'</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">, </span><span class="default">11</span><span class="keyword">, </span><span class="default">13</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="default">12</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'black'</span><span class="keyword">);<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">, </span><span class="default">9</span><span class="keyword">, </span><span class="default">11</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br /><br /></span><span class="comment">// This is apparently needed for the mask to work<br /></span><span class="default">$mask</span><span class="keyword">-&gt;</span><span class="default">setImageMatte</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">);<br /><br /></span><span class="comment">// Apply mask to watermark<br /></span><span class="default">$watermark</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$mask</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_COPYOPACITY</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="comment">// Overlay watermark on image<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$watermark</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_DISSOLVE</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="comment">// Set output image format<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);<br /><br /></span><span class="comment">// Output the new image<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/png'</span><span class="keyword">);<br />echo </span><span class="default">$image</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagematte&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagematte.php">＋<small>add a note</small></a></div>
