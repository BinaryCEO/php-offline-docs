...
<head>
  ...
  <title>PHP: imap_thread - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-thread.php">
 <link rel="shorturl" href="https://www.php.net/imap-thread">
 <link rel="alternate" href="https://www.php.net/imap-thread" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-subscribe.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-timeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-thread.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-thread.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-thread.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-thread.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-thread.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-thread.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-thread.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-thread.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-thread.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-thread.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-thread.php" hreflang="zh">
...
<meta name="Description" content="Returns a tree of threaded message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_thread - Manual" />
<meta name="twitter:description" content="Returns a tree of threaded message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_thread - Manual" />
<meta itemprop="description" content="Returns a tree of threaded message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a tree of threaded message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-timeout.php">
          imap_timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-subscribe.php">
          &laquo; imap_subscribe        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-thread.php' selected="selected">English</option>
            <option value='de/function.imap-thread.php'>German</option>
            <option value='es/function.imap-thread.php'>Spanish</option>
            <option value='fr/function.imap-thread.php'>French</option>
            <option value='it/function.imap-thread.php'>Italian</option>
            <option value='ja/function.imap-thread.php'>Japanese</option>
            <option value='pt_BR/function.imap-thread.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-thread.php'>Russian</option>
            <option value='tr/function.imap-thread.php'>Turkish</option>
            <option value='uk/function.imap-thread.php'>Ukrainian</option>
            <option value='zh/function.imap-thread.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-thread" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_thread</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.7, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_thread</span> &mdash; <span class="dc-title">Returns a tree of threaded message</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-thread-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_thread</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="imap.constants.php#constant.se-free">SE_FREE</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-thread-returnvalues">
  ...
  <p class="para">
   ...
   a tree of messages threaded by <code class="literal">REFERENCES</code>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
   on error.
  </p>
  <p class="para">
   ...
   <ul class="itemizedlist">
    <li class="listitem"><p class="para">
     <var class="varname">$thread["XX.num"]</var> - current message number
    </p></li>
    <li class="listitem"><p class="para">
     <var class="varname">$thread["XX.next"]</var>
    </p></li>
    <li class="listitem"><p class="para">
     <var class="varname">$thread["XX.branch"]</var>
    </p></li>
   </ul>
  </p>
 </div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-thread-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Here we're outputting the threads of a newsgroup, in HTML<br /><br /></span><span style="color: #0000BB">$nntp </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">'{news.example.com:119/nntp}some.newsgroup'</span><span style="color: #007700">, </span><span style="color: #DD0000">''</span><span style="color: #007700">, </span><span style="color: #DD0000">''</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$threads </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_thread</span><span style="color: #007700">(</span><span style="color: #0000BB">$nntp</span><span style="color: #007700">);<br /><br />foreach (</span><span style="color: #0000BB">$threads </span><span style="color: #007700">as </span><span style="color: #0000BB">$key </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$val</span><span style="color: #007700">) {<br />  </span><span style="color: #0000BB">$tree </span><span style="color: #007700">= </span><span style="color: #0000BB">explode</span><span style="color: #007700">(</span><span style="color: #DD0000">'.'</span><span style="color: #007700">, </span><span style="color: #0000BB">$key</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$tree</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">] == </span><span style="color: #DD0000">'num'</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$header </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_headerinfo</span><span style="color: #007700">(</span><span style="color: #0000BB">$nntp</span><span style="color: #007700">, </span><span style="color: #0000BB">$val</span><span style="color: #007700">);<br />    echo </span><span style="color: #DD0000">"&lt;ul&gt;\n\t&lt;li&gt;" </span><span style="color: #007700">. </span><span style="color: #0000BB">$header</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">fromaddress </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />  } elseif (</span><span style="color: #0000BB">$tree</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">] == </span><span style="color: #DD0000">'branch'</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"\t&lt;/li&gt;\n&lt;/ul&gt;\n"</span><span style="color: #007700">;<br />  }<br />}<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$nntp</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-thread.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-thread%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-thread&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-thread.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104056">  <div class="votes">
    <div id="Vu104056">
    <a href="/manual/vote-note.php?id=104056&amp;page=function.imap-thread&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104056">
    <a href="/manual/vote-note.php?id=104056&amp;page=function.imap-thread&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104056" title="82% like this...">
    18
    </div>
  </div>
  <a href="#104056" class="name">
  <strong class="user"><em>cblanquera at gmail dot com</em></strong></a><a class="genanchor" href="#104056"> &para;</a><div class="date" title="2011-05-19 08:13"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104056">
<div class="phpcode"><code><span class="html">imap_thread() returns threads, but are confined to the current open mailbox you defined in imap_open(). This is not useful for, lets say, getting full threads ( from "Sent Messages" and "Inbox" [took me a day to figure this out]). 
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="97576">  <div class="votes">
    <div id="Vu97576">
    <a href="/manual/vote-note.php?id=97576&amp;page=function.imap-thread&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97576">
    <a href="/manual/vote-note.php?id=97576&amp;page=function.imap-thread&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97576" title="62% like this...">
    2
    </div>
  </div>
  <a href="#97576" class="name">
  <strong class="user"><em>whamill at google mail</em></strong></a><a class="genanchor" href="#97576"> &para;</a><div class="date" title="2010-04-26 02:23"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97576">
<div class="phpcode"><code><span class="html">I figure other people may benefit from an explanation of the resulting array, My understanding is:<br /><br />Key: Essentially a node ID<br />Num: The mail ID (where 0 indicates the start of a conversation)<br />Next: The node ID of the first child (where 0 indicates there are no children)<br />Branch: The node ID of the next sibling (where 0 indicates there is no sibling)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-thread&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-thread.php">＋<small>add a note</small></a></div>
