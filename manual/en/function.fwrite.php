...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fwrite.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ftruncate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.glob.php">
...
<meta name="Description" content="Binary-safe file write" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fwrite - Manual" />
<meta name="twitter:description" content="Binary-safe file write" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fwrite - Manual" />
<meta itemprop="description" content="Binary-safe file write" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Binary-safe file write" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fwrite.php' selected="selected">English</option>
            <option value='de/function.fwrite.php'>German</option>
            <option value='es/function.fwrite.php'>Spanish</option>
            <option value='fr/function.fwrite.php'>French</option>
...
that is typically created using <span class="function"><a href="function.fopen.php" class="function">fopen()</a></span>.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fwrite-returnvalues">
  ...
  <p class="simpara">
   ...
   written,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.fwrite-examples">
  ...
  <p class="para">
   <div class="example" id="example-2384">
    <p><strong>Example #1 A simple <span class="function"><strong>fwrite()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pack.php" class="function" rel="rdfs-seeAlso">pack()</a> - Pack data into binary string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fwrite.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fwrite%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fwrite&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fwrite.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">if you need a function that writes all data, maybe try<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="comment">/**<br />     * writes all data or throws<br />     *<br />     * @param mixed $handle<br />     * @param string $data<br />     * @throws \RuntimeException when fwrite returned &lt;1 but still more data to write<br />     * @return void<br />     */<br />    /*private static*/ </span><span class="keyword">function </span><span class="default">fwrite_all</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">, </span><span class="default">string $data</span><span class="keyword">): </span><span class="default">void<br />    </span><span class="keyword">{<br />        </span><span class="default">$original_len </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">);<br />        if (</span><span class="default">$original_len </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">) {<br />            </span><span class="default">$len </span><span class="keyword">= </span><span class="default">$original_len</span><span class="keyword">;<br />            </span><span class="default">$written_total </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />            for (;;) {<br />                </span><span class="default">$written_now </span><span class="keyword">= </span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$handle</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">);<br />                if (</span><span class="default">$written_now </span><span class="keyword">=== </span><span class="default">$len</span><span class="keyword">) {<br />                    return;<br />                }<br />                if (</span><span class="default">$written_now </span><span class="keyword">&lt; </span><span class="default">1</span><span class="keyword">) {<br />                    throw new </span><span class="default">\RuntimeException</span><span class="keyword">(</span><span class="string">"could only write </span><span class="keyword">{</span><span class="default">$written_total</span><span class="keyword">}</span><span class="string">/</span><span class="keyword">{</span><span class="default">$original_len</span><span class="keyword">}</span><span class="string"> bytes!"</span><span class="keyword">);<br />                }<br />                </span><span class="default">$written_total </span><span class="keyword">+= </span><span class="default">$written_now</span><span class="keyword">;<br />                </span><span class="default">$data </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">, </span><span class="default">$written_now</span><span class="keyword">);<br />                </span><span class="default">$len </span><span class="keyword">-= </span><span class="default">$written_now</span><span class="keyword">;<br />                </span><span class="comment">// assert($len &gt; 0);<br />                // assert($len === strlen($data));<br />            </span><span class="keyword">}<br />        }<br />    }</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">$handles can also be used to output in console like below example<br /><br />fwrite(STDOUT, "Console Output");</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">// you want copy dummy file or send dummy file <br />// it is possible to send a file larger than 4GB and write without FSEEK used is limited by PHP_INT_MAX. it works on a system 32-bit or 64-bit<br />// fwrite and fread non pas de limite de position du pointeur <br /><br /><span class="default">&lt;?php<br /><br />$gfz </span><span class="keyword">=  </span><span class="default">filesize_dir</span><span class="keyword">(</span><span class="string">"d:\\starwars.mkv"</span><span class="keyword">); </span><span class="comment">// 11,5GB<br /></span><span class="keyword">echo </span><span class="string">'Z:'</span><span class="keyword">,</span><span class="default">$gfz</span><span class="keyword">,</span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">$fz </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">'d:\\test2.mkv'</span><span class="keyword">, </span><span class="string">'wb'</span><span class="keyword">); <br /></span><span class="default">$fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">'d:\\starwars.mkv'</span><span class="keyword">, </span><span class="string">'rb'</span><span class="keyword">);<br />echo </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">$a </span><span class="keyword">= (float) </span><span class="default">0</span><span class="keyword">;<br />while((</span><span class="default">$l</span><span class="keyword">=</span><span class="default">fread</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">65536</span><span class="keyword">))) { <br />    </span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$fz</span><span class="keyword">, </span><span class="default">$l</span><span class="keyword">);<br />    if((</span><span class="default">$a</span><span class="keyword">+=</span><span class="default">65536</span><span class="keyword">)%</span><span class="default">5</span><span class="keyword">) echo </span><span class="string">"\r"</span><span class="keyword">, </span><span class="string">'&gt;'</span><span class="keyword">, </span><span class="default">$a</span><span class="keyword">, </span><span class="string">' : ' </span><span class="keyword">, </span><span class="default">$gfz</span><span class="keyword">;<br />}<br /><br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fz</span><span class="keyword">);<br /><br /></span><span class="comment">// test2.mkv' is 11,5GB<br /><br />    </span><span class="keyword">function </span><span class="default">filesize_dir</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">) {<br />        </span><span class="default">exec</span><span class="keyword">(</span><span class="string">'dir ' </span><span class="keyword">. </span><span class="default">$file</span><span class="keyword">, </span><span class="default">$inf</span><span class="keyword">);<br />        </span><span class="default">$size_raw </span><span class="keyword">= </span><span class="default">$inf</span><span class="keyword">[</span><span class="default">6</span><span class="keyword">];<br />        </span><span class="default">$size_exp </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">" "</span><span class="keyword">,</span><span class="default">$size_raw</span><span class="keyword">);<br />        </span><span class="default">$size_ext </span><span class="keyword">= </span><span class="default">$size_exp</span><span class="keyword">[</span><span class="default">19</span><span class="keyword">];<br />        </span><span class="default">$size_int </span><span class="keyword">= (float) </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">chr</span><span class="keyword">(</span><span class="default">255</span><span class="keyword">), </span><span class="string">''</span><span class="keyword">, </span><span class="default">$size_ext</span><span class="keyword">);<br />        return </span><span class="default">$size_int</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">the fwrite output striped the slashes if without length argument given, example:<br /><br /><span class="default">&lt;?php<br />$str </span><span class="keyword">= </span><span class="string">"c:\\01.txt"</span><span class="keyword">;<br /></span><span class="default">$out </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"out.txt"</span><span class="keyword">, </span><span class="string">"w"</span><span class="keyword">);<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$out</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">);<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$out</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />the out.txt will be:<br />c:^@1.txt<br />the '\\0' without escape will be '\0' ==&gt; 0x00.<br /><br />the correct one is change fwrite to:<br />fwrite($out, $str, strlen($str));</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you write with the pointer in the middle of a file, it overwrites what's there rather than shifting the rest of the file along.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Hope this helps other newbies.<br /><br />If you are writing data to a txt file on a windows system and need a line break. use \r\n . This will write hex OD OA.<br /><br />i.e.<br />$batch_data= "some data... \r\n";<br />fwrite($fbatch,$batch_data);<br /><br />The is the equivalent of opening a txt file in notepad pressing enter and the end of the line and saving it.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fwrite&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fwrite.php">＋<small>add a note</small></a></div>
