...
<head>
  ...
  <title>PHP: Mail Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.mail.php">
 ...
 <link rel="index" href="https://www.php.net/manual/en/book.mail.php">
 <link rel="prev" href="https://www.php.net/manual/en/mail.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ezmlm-hash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.mail.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.mail.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.mail.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.mail.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.mail.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.mail.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.mail.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.mail.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.mail.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.mail.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.mail.php" hreflang="zh">
...
<meta name="Description" content="Mail Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Mail Functions - Manual" />
<meta name="twitter:description" content="Mail Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Mail Functions - Manual" />
<meta itemprop="description" content="Mail Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Mail Functions" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ezmlm-hash.php">
          ezmlm_hash &raquo;
              ...
              <div class="prev">
        <a href="mail.configuration.php">
          &laquo; Runtime Configuration        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.remote.mail.php'>Mail Related Extensions</a></li>      <li><a href='book.mail.php'>Mail</a></li>      </ul>
    </div>
  </div>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.mail.php' selected="selected">English</option>
            <option value='de/ref.mail.php'>German</option>
            <option value='es/ref.mail.php'>Spanish</option>
            <option value='fr/ref.mail.php'>French</option>
            <option value='it/ref.mail.php'>Italian</option>
            <option value='ja/ref.mail.php'>Japanese</option>
            <option value='pt_BR/ref.mail.php'>Brazilian Portuguese</option>
            <option value='ru/ref.mail.php'>Russian</option>
            <option value='tr/ref.mail.php'>Turkish</option>
            <option value='uk/ref.mail.php'>Ukrainian</option>
            <option value='zh/ref.mail.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.mail" class="reference">
 ...
 <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.ezmlm-hash.php">ezmlm_hash</a> — Calculate the hash value needed by EZMLM</li><li><a href="function.mail.php">mail</a> — Send mail</li></ul>
</div>
...
<br />
<br />[EDITOR thiago NOTE: Code has a fix from o.straesser AT gmx DOT de]</span></code></div>
  </div>
 </div>
  <div class="note" id="59752">  <div class="votes">
    <div id="Vu59752">
    <a href="/manual/vote-note.php?id=59752&amp;page=ref.mail&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd59752">
    <a href="/manual/vote-note.php?id=59752&amp;page=ref.mail&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V59752" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#59752" class="name">
  <strong class="user"><em>aweather88 at gmail dot com</em></strong></a><a class="genanchor" href="#59752"> &para;</a><div class="date" title="2005-12-14 02:45"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom59752">
<div class="phpcode"><code><span class="html">I spent hours searching the web trying to figure out why I was getting a "WARNING: mail(): SMTP server response: 501 5.5.4 Invalid Address " every time I was using the mail() function on my server (Win2K3,IIS 6.0,PHP4.4.1).  I knew everything was setup properly for SMTP based on other non IIS 6.0 configurations.<br /><br />Turns out that the IIS 6.0 SMTP service does not like formatting of the "From" field in mail headers.  For instance:<br /><span class="default">&lt;?PHP<br />   </span><span class="comment">//This line DOES NOT send  mail message correctly<br />   </span><span class="default">$headers </span><span class="keyword">.= </span><span class="string">"From: \""</span><span class="keyword">.</span><span class="default">$fromname</span><span class="keyword">.</span><span class="string">"\" &lt;"</span><span class="keyword">.</span><span class="default">$fromaddress</span><span class="keyword">.</span><span class="string">"&gt;\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;</span> <br />However this works:<br /><span class="default">&lt;?PHP<br />   </span><span class="comment">//This line sends mail message correctly<br />   </span><span class="default">$headers </span><span class="keyword">.= </span><span class="string">"From: \""</span><span class="keyword">.</span><span class="default">$fromaddress</span><span class="keyword">.</span><span class="string">"\"\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />The fix is in Microsoft Article ID 291828 ( <a href="http://support.microsoft.com/?id=291828" rel="nofollow" target="_blank">http://support.microsoft.com/?id=291828</a> ).  Even though the "bug" workaround is for IIS 6.0 on Exchange 2003 communicating with a UNIX server, THIS SOLVES THE PROBLEM.  Just skip down to the last section for Exchange 2003 and follow the instructions to modify the IIS 6 MetaBase with the MetaBase Explorer found in the IIS 6 Resource Kit.</span></code></div>
  </div>
 </div>
  <div class="note" id="71065">  <div class="votes">
    <div id="Vu71065">
    <a href="/manual/vote-note.php?id=71065&amp;page=ref.mail&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71065">
    <a href="/manual/vote-note.php?id=71065&amp;page=ref.mail&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71065" title="47% like this...">
    -2
    </div>
  </div>
  <a href="#71065" class="name">
  <strong class="user"><em>anselm at netuxo dot co dot uk</em></strong></a><a class="genanchor" href="#71065"> &para;</a><div class="date" title="2006-11-10 02:31"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71065">
<div class="phpcode"><code><span class="html">In case you don't want to, or can't, configure sendmail for your server, a good alternative is esmtp - it's an smtp mailer with minimum configuration that can be used as a sendmail drop-in : <a href="http://esmtp.sourceforge.net/" rel="nofollow" target="_blank">http://esmtp.sourceforge.net/</a></span></code></div>
  </div>
 </div>
  <div class="note" id="61296">  <div class="votes">
    <div id="Vu61296">
    <a href="/manual/vote-note.php?id=61296&amp;page=ref.mail&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61296">
    <a href="/manual/vote-note.php?id=61296&amp;page=ref.mail&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61296" title="46% like this...">
    -2
    </div>
  </div>
  <a href="#61296" class="name">
  <strong class="user"><em>lawcd at ntlworld dot com</em></strong></a><a class="genanchor" href="#61296"> &para;</a><div class="date" title="2006-01-30 09:38"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61296">
<div class="phpcode"><code><span class="html">For those of you with the exim, if its not sending mail with the -i option and you cant easily change this, you might want to check out the imap_mail() function which works almost exactly the same and doesnt use exim, most web hosts provide this. If you using your own server then php needs to be compiled with imap libraries etc.
<br />
<br />See <a href="http://php.net/manual/en/function.imap-mail.php" rel="nofollow" target="_blank">http://php.net/manual/en/function.imap-mail.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="41595">  <div class="votes">
    <div id="Vu41595">
    <a href="/manual/vote-note.php?id=41595&amp;page=ref.mail&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd41595">
    <a href="/manual/vote-note.php?id=41595&amp;page=ref.mail&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V41595" title="45% like this...">
    -4
    </div>
  </div>
  <a href="#41595" class="name">
  <strong class="user"><em>josh at sdfahrenheit dot com</em></strong></a><a class="genanchor" href="#41595"> &para;</a><div class="date" title="2004-04-15 07:52"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom41595">
<div class="phpcode"><code><span class="html">For anyone having problems with attached files coming through garbled, make sure you have magic_quotes_runtime set to Off in your php.ini - it adds funky escape chars to your attached data and garbles the attachment.<br /><br />This was giving me all kinds of grief.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ref.mail&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.mail.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="book.mail.php">Mail</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="intro.mail.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
                            <a href="mail.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="current">
                            <a href="ref.mail.php" title="Mail Functions">Mail Functions</a>
                        </li>
