...
<head>
  ...
  <title>PHP: Imagick::fxImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.fximage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.fximage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.fximage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.functionimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.gammaimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.fximage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.fximage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.fximage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.fximage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.fximage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.fximage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.fximage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.fximage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.fximage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.fximage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.fximage.php" hreflang="zh">
...
<meta name="Description" content="Evaluate expression for each pixel in the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::fxImage - Manual" />
<meta name="twitter:description" content="Evaluate expression for each pixel in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::fxImage - Manual" />
<meta itemprop="description" content="Evaluate expression for each pixel in the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Evaluate expression for each pixel in the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.gammaimage.php">
          Imagick::gammaImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.functionimage.php">
          &laquo; Imagick::functionImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.fximage.php' selected="selected">English</option>
            <option value='de/imagick.fximage.php'>German</option>
            <option value='es/imagick.fximage.php'>Spanish</option>
            <option value='fr/imagick.fximage.php'>French</option>
            <option value='it/imagick.fximage.php'>Italian</option>
            <option value='ja/imagick.fximage.php'>Japanese</option>
            <option value='pt_BR/imagick.fximage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.fximage.php'>Russian</option>
            <option value='tr/imagick.fximage.php'>Turkish</option>
            <option value='uk/imagick.fximage.php'>Ukrainian</option>
            <option value='zh/imagick.fximage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.fximage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::fxImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::fxImage</span> &mdash; <span class="dc-title">Evaluate expression for each pixel in the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.fximage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::fxImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$expression</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.fximage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3007">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/fximage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.fximage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.fximage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.fximage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115044">  <div class="votes">
    <div id="Vu115044">
    <a href="/manual/vote-note.php?id=115044&amp;page=imagick.fximage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115044">
    <a href="/manual/vote-note.php?id=115044&amp;page=imagick.fximage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115044" title="100% like this...">
    4
    </div>
  </div>
  <a href="#115044" class="name">
  <strong class="user"><em>thomasgf22 at NOSPAM dot gmail dot com</em></strong></a><a class="genanchor" href="#115044"> &para;</a><div class="date" title="2014-05-16 02:00"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115044">
<div class="phpcode"><code><span class="html">Beware that fxImage return value's type is a new object(Imagick), opposing the current documentation (boolean). Therefore it does not affect the caller object. Example:<br /><span class="default">&lt;?php<br />            $canvas </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />            </span><span class="default">$canvas</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">256</span><span class="keyword">, </span><span class="default">256</span><span class="keyword">, </span><span class="string">"white"</span><span class="keyword">, </span><span class="string">"jpg"</span><span class="keyword">);<br /><br />            </span><span class="default">$gradient </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />            </span><span class="default">$gradient</span><span class="keyword">-&gt;</span><span class="default">newPseudoImage</span><span class="keyword">(</span><span class="default">256</span><span class="keyword">, </span><span class="default">256</span><span class="keyword">, </span><span class="string">"gradient:white-black"</span><span class="keyword">);<br />            </span><span class="default">$canvas</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">( </span><span class="default">$gradient</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_OVER</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0 </span><span class="keyword">);<br />            </span><span class="default">$canvas</span><span class="keyword">-&gt;</span><span class="default">rotateImage</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(), </span><span class="default">90</span><span class="keyword">);<br />            </span><span class="comment">/*instead of just $canvas-&gt;fxImage("floor(s*10+0.5)/10"); we must store fxImage()'s result*/<br />            </span><span class="default">$canvas</span><span class="keyword">= </span><span class="default">$canvas</span><span class="keyword">-&gt;</span><span class="default">fxImage</span><span class="keyword">(</span><span class="string">"floor(s*10+0.5)/10"</span><span class="keyword">);<br /><br />            </span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpg" </span><span class="keyword">);<br />            echo </span><span class="default">$canvas</span><span class="keyword">; <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.fximage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.fximage.php">＋<small>add a note</small></a></div>
