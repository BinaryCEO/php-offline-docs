...
<head>
  ...
  <title>PHP: SolrQuery::getExpandRows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getexpandrows.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getexpandrows.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandrows.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getexpandquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandrows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getexpandrows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getexpandrows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getexpandrows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getexpandrows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getexpandrows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getexpandrows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getexpandrows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getexpandrows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getexpandrows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getexpandrows.php" hreflang="zh">
...
<meta name="Description" content="Returns The number of rows to display in each group (expand.rows)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getExpandRows - Manual" />
<meta name="twitter:description" content="Returns The number of rows to display in each group (expand.rows)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getExpandRows - Manual" />
<meta itemprop="description" content="Returns The number of rows to display in each group (expand.rows)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns The number of rows to display in each group (expand.rows)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getexpandsortfields.php">
          SolrQuery::getExpandSortFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getexpandquery.php">
          &laquo; SolrQuery::getExpandQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getexpandrows.php' selected="selected">English</option>
            <option value='de/solrquery.getexpandrows.php'>German</option>
            <option value='es/solrquery.getexpandrows.php'>Spanish</option>
            <option value='fr/solrquery.getexpandrows.php'>French</option>
            <option value='it/solrquery.getexpandrows.php'>Italian</option>
            <option value='ja/solrquery.getexpandrows.php'>Japanese</option>
            <option value='pt_BR/solrquery.getexpandrows.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getexpandrows.php'>Russian</option>
            <option value='tr/solrquery.getexpandrows.php'>Turkish</option>
            <option value='uk/solrquery.getexpandrows.php'>Ukrainian</option>
            <option value='zh/solrquery.getexpandrows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getexpandrows" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getExpandRows</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getExpandRows</span> &mdash; <span class="dc-title">Returns The number of rows to display in each group (expand.rows)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getexpandrows-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getExpandRows</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getexpandrows-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getexpandrows-returnvalues">
  ...
  <p class="para">
   Returns the number of rows.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getexpandrows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getexpandrows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getexpandrows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getexpandrows.php">＋<small>add a note</small></a></span>
