...
<head>
  ...
  <title>PHP: request_parse_body - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.request-parse-body.php">
 <link rel="shorturl" href="https://www.php.net/request-parse-body">
 <link rel="alternate" href="https://www.php.net/request-parse-body" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pfsockopen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.setcookie.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.request-parse-body.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.request-parse-body.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.request-parse-body.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.request-parse-body.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.request-parse-body.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.request-parse-body.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.request-parse-body.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.request-parse-body.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.request-parse-body.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.request-parse-body.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.request-parse-body.php" hreflang="zh">
...
<meta name="Description" content="Read and parse the request body and return the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: request_parse_body - Manual" />
<meta name="twitter:description" content="Read and parse the request body and return the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: request_parse_body - Manual" />
<meta itemprop="description" content="Read and parse the request body and return the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read and parse the request body and return the result" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.request-parse-body.php' selected="selected">English</option>
            <option value='de/function.request-parse-body.php'>German</option>
            <option value='es/function.request-parse-body.php'>Spanish</option>
            <option value='fr/function.request-parse-body.php'>French</option>
            <option value='it/function.request-parse-body.php'>Italian</option>
            <option value='ja/function.request-parse-body.php'>Japanese</option>
            <option value='pt_BR/function.request-parse-body.php'>Brazilian Portuguese</option>
            <option value='ru/function.request-parse-body.php'>Russian</option>
            <option value='tr/function.request-parse-body.php'>Turkish</option>
            <option value='uk/function.request-parse-body.php'>Ukrainian</option>
            <option value='zh/function.request-parse-body.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.request-parse-body" class="refentry">
 ...
 <div class="refsect1 errors" id="refsect1-function.request-parse-body-errors">
  ...
  <p class="simpara">
   ...
   a <span class="exceptionname"><a href="class.requestparsebodyexception.php" class="exceptionname">RequestParseBodyException</a></span> is thrown.
  </p>
  <p class="simpara">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// form.php<br /><br /></span><span style="color: #0000BB">assert_logged_in</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">// Only for this form, we allow a bigger upload size.<br /></span><span style="color: #007700">[</span><span style="color: #0000BB">$_POST</span><span style="color: #007700">, </span><span style="color: #0000BB">$_FILES</span><span style="color: #007700">] = </span><span style="color: #0000BB">request_parse_body</span><span style="color: #007700">([<br />    </span><span style="color: #DD0000">'post_max_size' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'10M'</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">'upload_max_filesize' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'10M'</span><span style="color: #007700">,<br />]);<br /><br /></span><span style="color: #FF8000">// Do something with the uploaded files.<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/request-parse-body.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.request-parse-body%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.request-parse-body&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.request-parse-body.php">＋<small>add a note</small></a></span>
