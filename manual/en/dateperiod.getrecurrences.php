...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/dateperiod.getrecurrences.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/dateperiod.getrecurrences.php">
 <link rel="alternate" href="https://www.php.net/manual/en/dateperiod.getrecurrences.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.dateperiod.php">
 <link rel="prev" href="https://www.php.net/manual/en/dateperiod.getenddate.php">
 <link rel="next" href="https://www.php.net/manual/en/dateperiod.getstartdate.php">
...
<meta name="Description" content="Gets the number of recurrences" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DatePeriod::getRecurrences - Manual" />
<meta name="twitter:description" content="Gets the number of recurrences" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DatePeriod::getRecurrences - Manual" />
<meta itemprop="description" content="Gets the number of recurrences" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of recurrences" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/dateperiod.getrecurrences.php' selected="selected">English</option>
            <option value='de/dateperiod.getrecurrences.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.17/7.3.4, PHP 8)</p><p class="refpurpose"><span class="refname">DatePeriod::getRecurrences</span> &mdash; <span class="dc-title">Gets the number of recurrences</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-dateperiod.getrecurrences-returnvalues">
  ...
  <p class="para">
   ...
   <code class="literal">$recurrences</code> to the contructor of the
   <span class="classname"><a href="class.dateperiod.php" class="classname">DatePeriod</a></span> class, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> otherwise.
  </p>
 </div>
  ...
  <ul class="simplelist">
   <li><a href="class.dateperiod.php#dateperiod.props.recurrences" class="link">DatePeriod::$recurrences</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateperiod/getrecurrences.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdateperiod.getrecurrences%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=dateperiod.getrecurrences&amp;repo=en&amp;redirect=https://www.php.net/manual/en/dateperiod.getrecurrences.php">＋<small>add a note</small></a></span>
