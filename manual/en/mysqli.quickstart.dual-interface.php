...
<head>
  ...
  <title>PHP: Dual procedural and object-oriented interface - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqli.quickstart.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.quickstart.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.quickstart.connections.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.quickstart.dual-interface.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.quickstart.dual-interface.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.quickstart.dual-interface.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.quickstart.dual-interface.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.quickstart.dual-interface.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.quickstart.dual-interface.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.quickstart.dual-interface.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.quickstart.dual-interface.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.quickstart.dual-interface.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.quickstart.dual-interface.php" hreflang="zh">
...
<meta name="Description" content="Dual procedural and object-oriented interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dual procedural and object-oriented interface - Manual" />
<meta name="twitter:description" content="Dual procedural and object-oriented interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dual procedural and object-oriented interface - Manual" />
<meta itemprop="description" content="Dual procedural and object-oriented interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Dual procedural and object-oriented interface" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.quickstart.connections.php">
          Connections &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.quickstart.php">
          &laquo; Quick start guide        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.quickstart.dual-interface.php' selected="selected">English</option>
            <option value='de/mysqli.quickstart.dual-interface.php'>German</option>
            <option value='es/mysqli.quickstart.dual-interface.php'>Spanish</option>
            <option value='fr/mysqli.quickstart.dual-interface.php'>French</option>
            <option value='it/mysqli.quickstart.dual-interface.php'>Italian</option>
            <option value='ja/mysqli.quickstart.dual-interface.php'>Japanese</option>
            <option value='pt_BR/mysqli.quickstart.dual-interface.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.quickstart.dual-interface.php'>Russian</option>
            <option value='tr/mysqli.quickstart.dual-interface.php'>Turkish</option>
            <option value='uk/mysqli.quickstart.dual-interface.php'>Ukrainian</option>
            <option value='zh/mysqli.quickstart.dual-interface.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.quickstart.dual-interface" class="section">
...
Please do not use the deprecated mysql extension for new development. Use the mysqli extension instead.
  ...
  <p class="para">
   <strong>The object-oriented interface</strong>
  </p>
  <p class="para">
...
Possible but bad style.
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="mysqli.summary.php" class="link">The MySQLi Extension Function Summary</a></li>
   </ul>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.quickstart.dual-interface%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.quickstart.dual-interface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116461">  <div class="votes">
    <div id="Vu116461">
    <a href="/manual/vote-note.php?id=116461&amp;page=mysqli.quickstart.dual-interface&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116461">
    <a href="/manual/vote-note.php?id=116461&amp;page=mysqli.quickstart.dual-interface&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116461" title="64% like this...">
    33
    </div>
  </div>
  <a href="#116461" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#116461"> &para;</a><div class="date" title="2015-01-06 11:36"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116461">
<div class="phpcode"><code><span class="html">Just want to add that both procedural mysqli_connect_errno and mysqli_connect_error DON'T accept any arguments!<br /><a href="http://php.net/manual/de/mysqli.connect-errno.php" rel="nofollow" target="_blank">http://php.net/manual/de/mysqli.connect-errno.php</a><br /><a href="http://php.net/manual/de/mysqli.connect-error.php" rel="nofollow" target="_blank">http://php.net/manual/de/mysqli.connect-error.php</a><br />"int mysqli_connect_errno ( void )"<br />"string mysqli_connect_error ( void )"<br />It clearly states "void" there.<br /><br />Adding the mysqli-Instance as a parameter makes it look like it pulls the error-number out of the provided instance, which is not actually happening. This could end in a hard to detect bug when connecting to multiple SQL servers.<br />And it is confusing for beginners.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.quickstart.dual-interface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.quickstart.dual-interface.php">＋<small>add a note</small></a></div>
