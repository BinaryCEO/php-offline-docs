...
<head>
  ...
  <title>PHP: SplFileObject::current - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.current.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.current.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.current.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.eof.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.current.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.current.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.current.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.current.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.current.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.current.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.current.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.current.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.current.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.current.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.current.php" hreflang="zh">
...
<meta name="Description" content="Retrieve current line of file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::current - Manual" />
<meta name="twitter:description" content="Retrieve current line of file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::current - Manual" />
<meta itemprop="description" content="Retrieve current line of file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve current line of file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileobject.eof.php">
          SplFileObject::eof &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.construct.php">
          &laquo; SplFileObject::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.current.php' selected="selected">English</option>
            <option value='de/splfileobject.current.php'>German</option>
            <option value='es/splfileobject.current.php'>Spanish</option>
            <option value='fr/splfileobject.current.php'>French</option>
            <option value='it/splfileobject.current.php'>Italian</option>
            <option value='ja/splfileobject.current.php'>Japanese</option>
            <option value='pt_BR/splfileobject.current.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.current.php'>Russian</option>
            <option value='tr/splfileobject.current.php'>Turkish</option>
            <option value='uk/splfileobject.current.php'>Ukrainian</option>
            <option value='zh/splfileobject.current.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.current" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="splfileobject.valid.php" class="methodname" rel="rdfs-seeAlso">SplFileObject::valid()</a> - Not at EOF</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/current.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.current%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.current&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.current.php">＋<small>add a note</small></a></span>
