...
<head>
  ...
  <title>PHP: db2_server_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-server-info.php">
 <link rel="shorturl" href="https://www.php.net/db2-server-info">
 <link rel="alternate" href="https://www.php.net/db2-server-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-rollback.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-set-option.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-server-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-server-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-server-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-server-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-server-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-server-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-server-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-server-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-server-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-server-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-server-info.php" hreflang="zh">
...
<meta name="Description" content="Returns an object with properties that describe the DB2 database server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_server_info - Manual" />
<meta name="twitter:description" content="Returns an object with properties that describe the DB2 database server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_server_info - Manual" />
<meta itemprop="description" content="Returns an object with properties that describe the DB2 database server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an object with properties that describe the DB2 database server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-set-option.php">
          db2_set_option &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-rollback.php">
          &laquo; db2_rollback        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-server-info.php' selected="selected">English</option>
            <option value='de/function.db2-server-info.php'>German</option>
            <option value='es/function.db2-server-info.php'>Spanish</option>
            <option value='fr/function.db2-server-info.php'>French</option>
            <option value='it/function.db2-server-info.php'>Italian</option>
            <option value='ja/function.db2-server-info.php'>Japanese</option>
            <option value='pt_BR/function.db2-server-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-server-info.php'>Russian</option>
            <option value='tr/function.db2-server-info.php'>Turkish</option>
            <option value='uk/function.db2-server-info.php'>Ukrainian</option>
            <option value='zh/function.db2-server-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-server-info" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-server-info-returnvalues">
  ...
  <p class="para">
   Returns an object on a successful call, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.db2-client-info.php" class="function" rel="rdfs-seeAlso">db2_client_info()</a> - Returns an object with properties that describe the DB2 database client</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-server-info.php">＋<small>add a note</small></a></span>
