...
<head>
  ...
  <title>PHP: openssl_pbkdf2 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pbkdf2.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pbkdf2">
 <link rel="alternate" href="https://www.php.net/openssl-pbkdf2" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkcs12-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pbkdf2.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pbkdf2.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pbkdf2.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pbkdf2.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pbkdf2.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pbkdf2.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pbkdf2.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pbkdf2.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pbkdf2.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pbkdf2.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pbkdf2.php" hreflang="zh">
...
<meta name="Description" content="Generates a PKCS5 v2 PBKDF2 string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pbkdf2 - Manual" />
<meta name="twitter:description" content="Generates a PKCS5 v2 PBKDF2 string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pbkdf2 - Manual" />
<meta itemprop="description" content="Generates a PKCS5 v2 PBKDF2 string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a PKCS5 v2 PBKDF2 string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkcs12-export.php">
          openssl_pkcs12_export &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-open.php">
          &laquo; openssl_open        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pbkdf2.php' selected="selected">English</option>
            <option value='de/function.openssl-pbkdf2.php'>German</option>
            <option value='es/function.openssl-pbkdf2.php'>Spanish</option>
            <option value='fr/function.openssl-pbkdf2.php'>French</option>
            <option value='it/function.openssl-pbkdf2.php'>Italian</option>
            <option value='ja/function.openssl-pbkdf2.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pbkdf2.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pbkdf2.php'>Russian</option>
            <option value='tr/function.openssl-pbkdf2.php'>Turkish</option>
            <option value='uk/function.openssl-pbkdf2.php'>Ukrainian</option>
            <option value='zh/function.openssl-pbkdf2.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pbkdf2" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-get-md-methods.php" class="function" rel="rdfs-seeAlso">openssl_get_md_methods()</a> - Gets available digest methods</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pbkdf2.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pbkdf2%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pbkdf2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pbkdf2.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114670">  <div class="votes">
    <div id="Vu114670">
    <a href="/manual/vote-note.php?id=114670&amp;page=function.openssl-pbkdf2&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114670">
    <a href="/manual/vote-note.php?id=114670&amp;page=function.openssl-pbkdf2&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114670" title="50% like this...">
    0
    </div>
  </div>
  <a href="#114670" class="name">
  <strong class="user"><em>McGlockenshire</em></strong></a><a class="genanchor" href="#114670"> &para;</a><div class="date" title="2014-03-20 08:10"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114670">
<div class="phpcode"><code><span class="html">Despite the manual claiming that this is available in PHP 5.5 and above, this function wasn't made available in my local install.<br /><br />I expect that having a prehistoric OpenSSL library version installed is the likely culprit.<br /><br />If you're using PHP 5.5 and don't have this function available in your OpenSSL extension, look at the functionally equivalent hash_pbkdf2 function instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pbkdf2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pbkdf2.php">＋<small>add a note</small></a></div>
