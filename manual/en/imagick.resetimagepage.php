...
<head>
  ...
  <title>PHP: Imagick::resetImagePage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.resetimagepage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.resetimagepage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.resetimagepage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.resampleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.resizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.resetimagepage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.resetimagepage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.resetimagepage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.resetimagepage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.resetimagepage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.resetimagepage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.resetimagepage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.resetimagepage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.resetimagepage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.resetimagepage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.resetimagepage.php" hreflang="zh">
...
<meta name="Description" content="Reset image page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::resetImagePage - Manual" />
<meta name="twitter:description" content="Reset image page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::resetImagePage - Manual" />
<meta itemprop="description" content="Reset image page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reset image page" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.resizeimage.php">
          Imagick::resizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.resampleimage.php">
          &laquo; Imagick::resampleImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.resetimagepage.php' selected="selected">English</option>
            <option value='de/imagick.resetimagepage.php'>German</option>
            <option value='es/imagick.resetimagepage.php'>Spanish</option>
            <option value='fr/imagick.resetimagepage.php'>French</option>
            <option value='it/imagick.resetimagepage.php'>Italian</option>
            <option value='ja/imagick.resetimagepage.php'>Japanese</option>
            <option value='pt_BR/imagick.resetimagepage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.resetimagepage.php'>Russian</option>
            <option value='tr/imagick.resetimagepage.php'>Turkish</option>
            <option value='uk/imagick.resetimagepage.php'>Ukrainian</option>
            <option value='zh/imagick.resetimagepage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.resetimagepage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::resetImagePage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::resetImagePage</span> &mdash; <span class="dc-title">Reset image page</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.resetimagepage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::resetImagePage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$page</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.resetimagepage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The page definition. For example <code class="literal">7168x5147+0+0</code>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.resetimagepage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/resetimagepage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.resetimagepage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.resetimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.resetimagepage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110376">  <div class="votes">
    <div id="Vu110376">
    <a href="/manual/vote-note.php?id=110376&amp;page=imagick.resetimagepage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110376">
    <a href="/manual/vote-note.php?id=110376&amp;page=imagick.resetimagepage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110376" title="100% like this...">
    1
    </div>
  </div>
  <a href="#110376" class="name">
  <strong class="user"><em>Roman T.</em></strong></a><a class="genanchor" href="#110376"> &para;</a><div class="date" title="2012-10-16 05:45"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110376">
<div class="phpcode"><code><span class="html">This function seems to do the same thing as photoshop feture convas size, you set size of convas and position of your image's top left corner (x,y) inside that convas.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.resetimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.resetimagepage.php">＋<small>add a note</small></a></div>
