...
<head>
  ...
  <title>PHP: IntlChar::getIntPropertyMinValue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.getintpropertymaxvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.getintpropertyvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.getintpropertyminvalue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.getintpropertyminvalue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.getintpropertyminvalue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.getintpropertyminvalue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.getintpropertyminvalue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.getintpropertyminvalue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.getintpropertyminvalue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.getintpropertyminvalue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.getintpropertyminvalue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.getintpropertyminvalue.php" hreflang="zh">
...
<meta name="Description" content="Get the min value for a Unicode property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::getIntPropertyMinValue - Manual" />
<meta name="twitter:description" content="Get the min value for a Unicode property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::getIntPropertyMinValue - Manual" />
<meta itemprop="description" content="Get the min value for a Unicode property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the min value for a Unicode property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.getintpropertyvalue.php">
          IntlChar::getIntPropertyValue &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.getintpropertymaxvalue.php">
          &laquo; IntlChar::getIntPropertyMaxValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.getintpropertyminvalue.php' selected="selected">English</option>
            <option value='de/intlchar.getintpropertyminvalue.php'>German</option>
            <option value='es/intlchar.getintpropertyminvalue.php'>Spanish</option>
            <option value='fr/intlchar.getintpropertyminvalue.php'>French</option>
            <option value='it/intlchar.getintpropertyminvalue.php'>Italian</option>
            <option value='ja/intlchar.getintpropertyminvalue.php'>Japanese</option>
            <option value='pt_BR/intlchar.getintpropertyminvalue.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.getintpropertyminvalue.php'>Russian</option>
            <option value='tr/intlchar.getintpropertyminvalue.php'>Turkish</option>
            <option value='uk/intlchar.getintpropertyminvalue.php'>Ukrainian</option>
            <option value='zh/intlchar.getintpropertyminvalue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.getintpropertyminvalue" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::getIntPropertyMinValue</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::getIntPropertyMinValue</span> &mdash; <span class="dc-title">Get the min value for a Unicode property</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.getintpropertyminvalue-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::getIntPropertyMinValue</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$property</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.getintpropertyminvalue-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.getintpropertyminvalue-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The minimum value returned by <span class="function"><a href="intlchar.getintpropertyvalue.php" class="function">IntlChar::getIntPropertyValue()</a></span> for a Unicode property.
   <code class="literal">0</code> if the property selector is out of range.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.getintpropertyminvalue-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2711">
   <p><strong>Example #1 Testing different properties</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">getIntPropertyMinValue</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">PROPERTY_BIDI_CLASS</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">getIntPropertyMinValue</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">PROPERTY_SCRIPT</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">getIntPropertyMinValue</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">PROPERTY_IDEOGRAPHIC</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">getIntPropertyMinValue</span><span style="color: #007700">(</span><span style="color: #0000BB">999999999</span><span style="color: #007700">)); </span><span style="color: #FF8000">// Some made-up value<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
int(0)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.getintpropertyminvalue-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.getunicodeversion.php" class="function" rel="rdfs-seeAlso">IntlChar::getUnicodeVersion()</a> - Get the Unicode version</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/getintpropertyminvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.getintpropertyminvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.getintpropertyminvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.getintpropertyminvalue.php">＋<small>add a note</small></a></span>
