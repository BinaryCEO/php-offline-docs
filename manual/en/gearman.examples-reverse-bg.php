...
<head>
  ...
  <title>PHP: Basic Gearman client and worker, background - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearman.examples-reverse-bg.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearman.examples-reverse-bg.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearman.examples-reverse-bg.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/gearman.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearman.examples-reverse.php">
 <link rel="next" href="https://www.php.net/manual/en/gearman.examples-reverse-task.php">
...
<meta name="Description" content="Basic Gearman client and worker, background" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Basic Gearman client and worker, background - Manual" />
<meta name="twitter:description" content="Basic Gearman client and worker, background" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Basic Gearman client and worker, background - Manual" />
<meta itemprop="description" content="Basic Gearman client and worker, background" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Basic Gearman client and worker, background" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearman.examples-reverse-task.php">
          Basic Gearman client and worker, submitting tasks &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearman.examples-reverse-bg.php' selected="selected">English</option>
            ...
            <option value='ru/gearman.examples-reverse-bg.php'>Russian</option>
...
% php reverse_client_bg.php
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearman.examples-reverse-bg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearman.examples-reverse-bg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearman.examples-reverse-bg.php">＋<small>add a note</small></a></span>
