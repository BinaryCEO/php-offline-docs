...
<head>
  ...
  <title>PHP: imap_createmailbox - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-createmailbox.php">
 <link rel="shorturl" href="https://www.php.net/imap-createmailbox">
 <link rel="alternate" href="https://www.php.net/imap-createmailbox" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-createmailbox.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-createmailbox.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-createmailbox.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-createmailbox.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-createmailbox.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-createmailbox.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-createmailbox.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-createmailbox.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-createmailbox.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-createmailbox.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-createmailbox.php" hreflang="zh">
...
<meta name="Description" content="Create a new mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_createmailbox - Manual" />
<meta name="twitter:description" content="Create a new mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_createmailbox - Manual" />
<meta itemprop="description" content="Create a new mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new mailbox" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-delete.php">
          imap_delete &raquo;
              ...
              <div class="prev">
        <a href="function.imap-create.php">
          &laquo; imap_create        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-createmailbox.php' selected="selected">English</option>
            <option value='de/function.imap-createmailbox.php'>German</option>
            <option value='es/function.imap-createmailbox.php'>Spanish</option>
            <option value='fr/function.imap-createmailbox.php'>French</option>
            <option value='it/function.imap-createmailbox.php'>Italian</option>
            <option value='ja/function.imap-createmailbox.php'>Japanese</option>
            <option value='pt_BR/function.imap-createmailbox.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-createmailbox.php'>Russian</option>
            <option value='tr/function.imap-createmailbox.php'>Turkish</option>
            <option value='uk/function.imap-createmailbox.php'>Ukrainian</option>
            <option value='zh/function.imap-createmailbox.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-createmailbox" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_createmailbox</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_createmailbox</span> &mdash; <span class="dc-title">Create a new mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-createmailbox-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_createmailbox</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Creates a new mailbox specified by <code class="parameter">mailbox</code>. 
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-createmailbox-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       encoded by <span class="function"><a href="function.imap-utf7-encode.php" class="function">imap_utf7_encode()</a></span>
      </p>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-createmailbox-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-createmailbox-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">, </span><span style="color: #0000BB">OP_HALFOPEN</span><span style="color: #007700">)<br />     or die(</span><span style="color: #DD0000">"can't connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">$name1 </span><span style="color: #007700">= </span><span style="color: #DD0000">"phpnewbox"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$name2 </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_utf7_encode</span><span style="color: #007700">(</span><span style="color: #DD0000">"phpnewböx"</span><span style="color: #007700">); </span><span style="color: #FF8000">// phpnewb&amp;w7Y-x<br /><br /></span><span style="color: #0000BB">$newname </span><span style="color: #007700">= </span><span style="color: #0000BB">$name1</span><span style="color: #007700">;<br /><br />echo </span><span style="color: #DD0000">"Newname will be '</span><span style="color: #0000BB">$name1</span><span style="color: #DD0000">'&lt;br /&gt;\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// we will now create a new mailbox "phptestbox" in your inbox folder,<br />// check its status after creation and finally remove it to restore<br />// your inbox to its initial state<br /><br /></span><span style="color: #007700">if (@</span><span style="color: #0000BB">imap_createmailbox</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #0000BB">imap_utf7_encode</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org}INBOX.</span><span style="color: #0000BB">$newname</span><span style="color: #DD0000">"</span><span style="color: #007700">))) {<br />    </span><span style="color: #0000BB">$status </span><span style="color: #007700">= @</span><span style="color: #0000BB">imap_status</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX.</span><span style="color: #0000BB">$newname</span><span style="color: #DD0000">"</span><span style="color: #007700">, </span><span style="color: #0000BB">SA_ALL</span><span style="color: #007700">);<br />    if (</span><span style="color: #0000BB">$status</span><span style="color: #007700">) {<br />        echo </span><span style="color: #DD0000">"your new mailbox '</span><span style="color: #0000BB">$name1</span><span style="color: #DD0000">' has the following status:&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Messages:   " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">messages    </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Recent:     " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">recent      </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Unseen:     " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">unseen      </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"UIDnext:    " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uidnext     </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"UIDvalidity:" </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uidvalidity </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br /><br />        if (</span><span style="color: #0000BB">imap_renamemailbox</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX.</span><span style="color: #0000BB">$newname</span><span style="color: #DD0000">"</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX.</span><span style="color: #0000BB">$name2</span><span style="color: #DD0000">"</span><span style="color: #007700">)) {<br />            echo </span><span style="color: #DD0000">"renamed new mailbox from '</span><span style="color: #0000BB">$name1</span><span style="color: #DD0000">' to '</span><span style="color: #0000BB">$name2</span><span style="color: #DD0000">'&lt;br /&gt;\n"</span><span style="color: #007700">;<br />            </span><span style="color: #0000BB">$newname </span><span style="color: #007700">= </span><span style="color: #0000BB">$name2</span><span style="color: #007700">;<br />        } else {<br />            echo </span><span style="color: #DD0000">"imap_renamemailbox on new mailbox failed: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">() . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />        }<br />    } else {<br />        echo </span><span style="color: #DD0000">"imap_status on new mailbox failed: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">() . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />    }<br /><br />    if (@</span><span style="color: #0000BB">imap_deletemailbox</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX.</span><span style="color: #0000BB">$newname</span><span style="color: #DD0000">"</span><span style="color: #007700">)) {<br />        echo </span><span style="color: #DD0000">"new mailbox removed to restore initial state&lt;br /&gt;\n"</span><span style="color: #007700">;<br />    } else {<br />        echo </span><span style="color: #DD0000">"imap_deletemailbox on new mailbox failed: " </span><span style="color: #007700">. </span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">imap_errors</span><span style="color: #007700">()) . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />    }<br /><br />} else {<br />    echo </span><span style="color: #DD0000">"could not create new mailbox: " </span><span style="color: #007700">. </span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">imap_errors</span><span style="color: #007700">()) . </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-createmailbox-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-deletemailbox.php" class="function" rel="rdfs-seeAlso">imap_deletemailbox()</a> - Delete a mailbox</span></li>
   </ul>
  </p>
 </div>
