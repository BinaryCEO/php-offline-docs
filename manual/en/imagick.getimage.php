...
<head>
  ...
  <title>PHP: Imagick::getImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.gethomeurl.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimage.php" hreflang="zh">
...
<meta name="Description" content="Returns a new Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImage - Manual" />
<meta name="twitter:description" content="Returns a new Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImage - Manual" />
<meta itemprop="description" content="Returns a new Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a new Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagealphachannel.php">
          Imagick::getImageAlphaChannel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.gethomeurl.php">
          &laquo; Imagick::getHomeURL        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimage.php' selected="selected">English</option>
            <option value='de/imagick.getimage.php'>German</option>
            <option value='es/imagick.getimage.php'>Spanish</option>
            <option value='fr/imagick.getimage.php'>French</option>
            <option value='it/imagick.getimage.php'>Italian</option>
            <option value='ja/imagick.getimage.php'>Japanese</option>
            <option value='pt_BR/imagick.getimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimage.php'>Russian</option>
            <option value='tr/imagick.getimage.php'>Turkish</option>
            <option value='uk/imagick.getimage.php'>Ukrainian</option>
            <option value='zh/imagick.getimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimage" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126057">  <div class="votes">
    <div id="Vu126057">
    <a href="/manual/vote-note.php?id=126057&amp;page=imagick.getimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126057">
    <a href="/manual/vote-note.php?id=126057&amp;page=imagick.getimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126057" title="50% like this...">
    0
    </div>
  </div>
  <a href="#126057" class="name">
  <strong class="user"><em>Abe</em></strong></a><a class="genanchor" href="#126057"> &para;</a><div class="date" title="2021-05-06 12:56"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126057">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />  <br /></span><span class="comment">// Create a new imagick object<br /></span><span class="default">$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />  <br /></span><span class="comment">// Read the image<br /></span><span class="default">$pngfn</span><span class="keyword">=</span><span class="string">'myfile.png'</span><span class="keyword">;<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$pngfn</span><span class="keyword">);<br />  <br /></span><span class="comment">// Display the image<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />echo </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimage.php">＋<small>add a note</small></a></div>
