...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mailparse-msg-get-structure.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mailparse-msg-get-part-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mailparse-msg-parse.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mailparse-msg-get-structure.php' selected="selected">English</option>
            <option value='de/function.mailparse-msg-get-structure.php'>German</option>
   ...
   <dl>
     ...
     <dd>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mailparse/functions/mailparse-msg-get-structure.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mailparse-msg-get-structure%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mailparse-msg-get-structure&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mailparse-msg-get-structure.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Example of this function output:<br /><br /><span class="default">&lt;?php<br /><br />$parse </span><span class="keyword">= </span><span class="default">mailparse_msg_parse_file</span><span class="keyword">(</span><span class="string">'mail.txt'</span><span class="keyword">);<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">mailparse_msg_get_structure</span><span class="keyword">(</span><span class="default">$parse</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Output will be:<br /><br />Array<br />(<br />    [0] =&gt; 1<br />    [1] =&gt; 1.1<br />    [2] =&gt; 1.1.1<br />    [3] =&gt; 1.1.2<br />    [4] =&gt; 1.2<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mailparse-msg-get-structure&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mailparse-msg-get-structure.php">＋<small>add a note</small></a></div>
