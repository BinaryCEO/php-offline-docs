...
<head>
  ...
  <title>PHP: imap_listmailbox - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-listmailbox.php">
 <link rel="shorturl" href="https://www.php.net/imap-listmailbox">
 <link rel="alternate" href="https://www.php.net/imap-listmailbox" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-list.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-listscan.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-listmailbox.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-listmailbox.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-listmailbox.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-listmailbox.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-listmailbox.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-listmailbox.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-listmailbox.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-listmailbox.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-listmailbox.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-listmailbox.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-listmailbox.php" hreflang="zh">
...
<meta name="Description" content="Alias of imap_list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_listmailbox - Manual" />
<meta name="twitter:description" content="Alias of imap_list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_listmailbox - Manual" />
<meta itemprop="description" content="Alias of imap_list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of imap_list" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-listmailbox.php' selected="selected">English</option>
            <option value='de/function.imap-listmailbox.php'>German</option>
            <option value='es/function.imap-listmailbox.php'>Spanish</option>
            <option value='fr/function.imap-listmailbox.php'>French</option>
            <option value='it/function.imap-listmailbox.php'>Italian</option>
            <option value='ja/function.imap-listmailbox.php'>Japanese</option>
            <option value='pt_BR/function.imap-listmailbox.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-listmailbox.php'>Russian</option>
            <option value='tr/function.imap-listmailbox.php'>Turkish</option>
            <option value='uk/function.imap-listmailbox.php'>Ukrainian</option>
            <option value='zh/function.imap-listmailbox.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-listmailbox" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_listmailbox</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_listmailbox</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.imap-list.php" class="function">imap_list()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imap-listmailbox-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.imap-list.php" class="function">imap_list()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-listmailbox.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-listmailbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-listmailbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-listmailbox.php">＋<small>add a note</small></a></span>
