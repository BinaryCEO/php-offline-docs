...
<head>
  ...
  <title>PHP: Gmagick::blurimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.blurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.blurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.blurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.annotateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.borderimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.blurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.blurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.blurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.blurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.blurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.blurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.blurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.blurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.blurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.blurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.blurimage.php" hreflang="zh">
...
<meta name="Description" content="Adds blur filter to image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::blurimage - Manual" />
<meta name="twitter:description" content="Adds blur filter to image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::blurimage - Manual" />
<meta itemprop="description" content="Adds blur filter to image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds blur filter to image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.borderimage.php">
          Gmagick::borderimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.annotateimage.php">
          &laquo; Gmagick::annotateimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.blurimage.php' selected="selected">English</option>
            <option value='de/gmagick.blurimage.php'>German</option>
            <option value='es/gmagick.blurimage.php'>Spanish</option>
            <option value='fr/gmagick.blurimage.php'>French</option>
            <option value='it/gmagick.blurimage.php'>Italian</option>
            <option value='ja/gmagick.blurimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.blurimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.blurimage.php'>Russian</option>
            <option value='tr/gmagick.blurimage.php'>Turkish</option>
            <option value='uk/gmagick.blurimage.php'>Ukrainian</option>
            <option value='zh/gmagick.blurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.blurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::blurimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::blurimage</span> &mdash; <span class="dc-title">Adds blur filter to image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.blurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::blurimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.blurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.blurimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The blurred <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.blurimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/blurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.blurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.blurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.blurimage.php">＋<small>add a note</small></a></span>
