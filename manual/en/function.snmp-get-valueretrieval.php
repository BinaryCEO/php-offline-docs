...
<head>
  ...
  <title>PHP: snmp_get_valueretrieval - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp-get-valueretrieval.php">
 <link rel="shorturl" href="https://www.php.net/snmp-get-valueretrieval">
 <link rel="alternate" href="https://www.php.net/snmp-get-valueretrieval" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.snmp-get-quick-print.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmp-read-mib.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmp-get-valueretrieval.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmp-get-valueretrieval.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmp-get-valueretrieval.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmp-get-valueretrieval.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmp-get-valueretrieval.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmp-get-valueretrieval.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmp-get-valueretrieval.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmp-get-valueretrieval.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmp-get-valueretrieval.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmp-get-valueretrieval.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmp-get-valueretrieval.php" hreflang="zh">
...
<meta name="Description" content="Return the method how the SNMP values will be returned" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: snmp_get_valueretrieval - Manual" />
<meta name="twitter:description" content="Return the method how the SNMP values will be returned" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: snmp_get_valueretrieval - Manual" />
<meta itemprop="description" content="Return the method how the SNMP values will be returned" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the method how the SNMP values will be returned" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp-get-valueretrieval.php' selected="selected">English</option>
            <option value='de/function.snmp-get-valueretrieval.php'>German</option>
            <option value='es/function.snmp-get-valueretrieval.php'>Spanish</option>
            <option value='fr/function.snmp-get-valueretrieval.php'>French</option>
            <option value='it/function.snmp-get-valueretrieval.php'>Italian</option>
            <option value='ja/function.snmp-get-valueretrieval.php'>Japanese</option>
            <option value='pt_BR/function.snmp-get-valueretrieval.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmp-get-valueretrieval.php'>Russian</option>
            <option value='tr/function.snmp-get-valueretrieval.php'>Turkish</option>
            <option value='uk/function.snmp-get-valueretrieval.php'>Ukrainian</option>
            <option value='zh/function.snmp-get-valueretrieval.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmp-get-valueretrieval" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="snmp.constants.php" class="xref">Predefined Constants</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp-get-valueretrieval.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp-get-valueretrieval%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp-get-valueretrieval&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp-get-valueretrieval.php">＋<small>add a note</small></a></span>
