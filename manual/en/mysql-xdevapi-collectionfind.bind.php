...
<head>
  ...
  <title>PHP: CollectionFind::bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.bind.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.bind.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.bind.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionfind.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionfind.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionfind.bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collectionfind.bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collectionfind.bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collectionfind.bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collectionfind.bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collectionfind.bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collectionfind.bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collectionfind.bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collectionfind.bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collectionfind.bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collectionfind.bind.php" hreflang="zh">
...
<meta name="Description" content="Bind value to query placeholder" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CollectionFind::bind - Manual" />
<meta name="twitter:description" content="Bind value to query placeholder" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CollectionFind::bind - Manual" />
<meta itemprop="description" content="Bind value to query placeholder" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bind value to query placeholder" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-collectionfind.construct.php">
          CollectionFind::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mysql-xdevapi-collectionfind.php">
          &laquo; mysql_xdevapi\CollectionFind        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionfind.bind.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collectionfind.bind.php'>German</option>
            <option value='es/mysql-xdevapi-collectionfind.bind.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collectionfind.bind.php'>French</option>
            <option value='it/mysql-xdevapi-collectionfind.bind.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collectionfind.bind.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collectionfind.bind.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collectionfind.bind.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collectionfind.bind.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collectionfind.bind.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collectionfind.bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collectionfind.bind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">CollectionFind::bind</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">CollectionFind::bind</span> &mdash; <span class="dc-title">Bind value to query placeholder</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-mysql-xdevapi-collectionfind.bind-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Values to substitute in the search condition; multiple values are allowed
      and are passed as an array where &quot;PLACEHOLDER_NAME =&gt; PLACEHOLDER_VALUE&quot;.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysql-xdevapi-collectionfind.bind-returnvalues">
  ...
  <p class="para">
   A CollectionFind object, 
   or chain with execute() to return a Result object.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collectionfind.bind-examples">
  ...
  <div class="example" id="example-1710">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\CollectionFind::bind()</strong></span> example</strong></p>
  ...
  array(4) {
    ...
    string(6) &quot;Alfred&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionfind/bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionfind.bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionfind.bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionfind.bind.php">＋<small>add a note</small></a></span>
