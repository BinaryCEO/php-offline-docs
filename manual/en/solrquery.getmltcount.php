...
<head>
  ...
  <title>PHP: SolrQuery::getMltCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltcount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltcount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltcount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltboost.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltcount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltcount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltcount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltcount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltcount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltcount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltcount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltcount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltcount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltcount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltcount.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of similar documents to return for each result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltCount - Manual" />
<meta name="twitter:description" content="Returns the number of similar documents to return for each result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltCount - Manual" />
<meta itemprop="description" content="Returns the number of similar documents to return for each result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of similar documents to return for each result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getmltfields.php">
          SolrQuery::getMltFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltboost.php">
          &laquo; SolrQuery::getMltBoost        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltcount.php' selected="selected">English</option>
            <option value='de/solrquery.getmltcount.php'>German</option>
            <option value='es/solrquery.getmltcount.php'>Spanish</option>
            <option value='fr/solrquery.getmltcount.php'>French</option>
            <option value='it/solrquery.getmltcount.php'>Italian</option>
            <option value='ja/solrquery.getmltcount.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltcount.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltcount.php'>Russian</option>
            <option value='tr/solrquery.getmltcount.php'>Turkish</option>
            <option value='uk/solrquery.getmltcount.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltcount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltcount" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltCount</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltCount</span> &mdash; <span class="dc-title">Returns the number of similar documents to return for each result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltcount-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltCount</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltcount-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltcount-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltcount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltcount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltcount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltcount.php">＋<small>add a note</small></a></span>
