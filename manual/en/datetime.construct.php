...
<head>
  ...
  <title>PHP: DateTime::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.add.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.createfromformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.construct.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.construct.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.construct.php" hreflang="uk">
...
<meta name="Description" content="Returns new DateTime object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTime::__construct - Manual" />
<meta name="twitter:description" content="Returns new DateTime object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTime::__construct - Manual" />
<meta itemprop="description" content="Returns new DateTime object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns new DateTime object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.createfromformat.php">
          DateTime::createFromFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.add.php">
          &laquo; DateTime::add        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.construct.php' selected="selected">English</option>
            <option value='de/datetime.construct.php'>German</option>
            <option value='es/datetime.construct.php'>Spanish</option>
            <option value='fr/datetime.construct.php'>French</option>
            <option value='it/datetime.construct.php'>Italian</option>
            <option value='ja/datetime.construct.php'>Japanese</option>
            <option value='pt_BR/datetime.construct.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.construct.php'>Russian</option>
            <option value='tr/datetime.construct.php'>Turkish</option>
            <option value='uk/datetime.construct.php'>Ukrainian</option>
            <option value='zh/datetime.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.construct" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="datetimeimmutable.construct.php" class="methodname" rel="rdfs-seeAlso">DateTimeImmutable::__construct()</a> - Returns new DateTimeImmutable object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetime/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.construct.php">＋<small>add a note</small></a></span>
