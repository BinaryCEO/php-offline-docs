...
<head>
  ...
  <title>PHP: snmpgetnext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmpgetnext.php">
 <link rel="shorturl" href="https://www.php.net/snmpgetnext">
 <link rel="alternate" href="https://www.php.net/snmpgetnext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.snmpget.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmprealwalk.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmpgetnext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmpgetnext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmpgetnext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmpgetnext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmpgetnext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmpgetnext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmpgetnext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmpgetnext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmpgetnext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmpgetnext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmpgetnext.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmpgetnext.php' selected="selected">English</option>
            <option value='de/function.snmpgetnext.php'>German</option>
            <option value='es/function.snmpgetnext.php'>Spanish</option>
            <option value='fr/function.snmpgetnext.php'>French</option>
            <option value='it/function.snmpgetnext.php'>Italian</option>
            <option value='ja/function.snmpgetnext.php'>Japanese</option>
            <option value='pt_BR/function.snmpgetnext.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmpgetnext.php'>Russian</option>
            <option value='tr/function.snmpgetnext.php'>Turkish</option>
            <option value='uk/function.snmpgetnext.php'>Ukrainian</option>
            <option value='zh/function.snmpgetnext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmpgetnext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">snmpgetnext</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">snmpgetnext</span> &mdash; <span class="dc-title">
   Fetch the <abbr title="Simple Network Management Protocol">SNMP</abbr> object which follows the given object id
  </span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.snmpgetnext-description">
  ...
  <p class="para rdfs-comment">
   The <span class="function"><strong>snmpgetnext()</strong></span> function is used to read the
 ...
 <div class="refsect1 examples" id="refsect1-function.snmpgetnext-examples">
  ...
  <p class="para">
   <div class="example" id="example-4773">
    <p><strong>Example #1 Using <span class="function"><strong>snmpgetnext()</strong></span></strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.snmpwalk.php" class="function" rel="rdfs-seeAlso">snmpwalk()</a> - Fetch all the SNMP objects from an agent</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmpgetnext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmpgetnext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmpgetnext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmpgetnext.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96968">  <div class="votes">
    <div id="Vu96968">
    <a href="/manual/vote-note.php?id=96968&amp;page=function.snmpgetnext&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96968">
    <a href="/manual/vote-note.php?id=96968&amp;page=function.snmpgetnext&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96968" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#96968" class="name">
  <strong class="user"><em>achalsaraiya at yahoo dot co dot in</em></strong></a><a class="genanchor" href="#96968"> &para;</a><div class="date" title="2010-03-25 02:46"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96968">
<div class="phpcode"><code><span class="html">with snmpget api, the agent returns the value associated <br />with the OID (or OIDs) specified in the original request.<br />The snmpgetnext api is  similar, but the agent returns the <br />value associated with the next (valid) OID<br /><br />eg:<br />snmpgetnext('192.168.40.134',<br />                   'public',<br />                   'SNMPv2-MIB::sysUpTime.0');<br /><br />will give the output:<br />STRING: user@hostname</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.snmpgetnext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmpgetnext.php">＋<small>add a note</small></a></div>
