...
<head>
  ...
  <title>PHP: ldap_err2str - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-err2str.php">
 <link rel="shorturl" href="https://www.php.net/ldap-err2str">
 <link rel="alternate" href="https://www.php.net/ldap-err2str" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-dn2ufn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-err2str.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-err2str.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-err2str.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-err2str.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-err2str.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-err2str.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-err2str.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-err2str.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-err2str.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-err2str.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-err2str.php" hreflang="zh">
...
<meta name="Description" content="Convert LDAP error number into string error message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_err2str - Manual" />
<meta name="twitter:description" content="Convert LDAP error number into string error message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_err2str - Manual" />
<meta itemprop="description" content="Convert LDAP error number into string error message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert LDAP error number into string error message" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-errno.php">
          ldap_errno &raquo;
              ...
              <div class="prev">
        <a href="function.ldap-dn2ufn.php">
          &laquo; ldap_dn2ufn        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-err2str.php' selected="selected">English</option>
            <option value='de/function.ldap-err2str.php'>German</option>
            <option value='es/function.ldap-err2str.php'>Spanish</option>
            <option value='fr/function.ldap-err2str.php'>French</option>
            <option value='it/function.ldap-err2str.php'>Italian</option>
            <option value='ja/function.ldap-err2str.php'>Japanese</option>
            <option value='pt_BR/function.ldap-err2str.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-err2str.php'>Russian</option>
            <option value='tr/function.ldap-err2str.php'>Turkish</option>
            <option value='uk/function.ldap-err2str.php'>Ukrainian</option>
            <option value='zh/function.ldap-err2str.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-err2str" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_err2str</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_err2str</span> &mdash; <span class="dc-title">Convert LDAP error number into string error message</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-err2str-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_err2str</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$errno</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  </span><span style="color: #007700">for (</span><span style="color: #0000BB">$i</span><span style="color: #007700">=</span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">&lt;</span><span style="color: #0000BB">100</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Error </span><span style="color: #0000BB">$i</span><span style="color: #DD0000">: %s&lt;br /&gt;\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">ldap_err2str</span><span style="color: #007700">(</span><span style="color: #0000BB">$i</span><span style="color: #007700">));<br />  }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-err2str-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-errno.php" class="function" rel="rdfs-seeAlso">ldap_errno()</a> - Return the LDAP error number of the last LDAP command</span></li>
    <li><span class="function"><a href="function.ldap-error.php" class="function" rel="rdfs-seeAlso">ldap_error()</a> - Return the LDAP error message of the last LDAP command</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-err2str.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-err2str%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-err2str&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-err2str.php">＋<small>add a note</small></a></span>
