...
<head>
  ...
  <title>PHP: GearmanClient::setClientCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setclientcallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setclientcallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setclientcallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.runtasks.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.setcompletecallback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setclientcallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.setclientcallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.setclientcallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.setclientcallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.setclientcallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.setclientcallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.setclientcallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.setclientcallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.setclientcallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.setclientcallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.setclientcallback.php" hreflang="zh">
...
<meta name="Description" content="Callback function when there is a data packet for a task (deprecated)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setClientCallback - Manual" />
<meta name="twitter:description" content="Callback function when there is a data packet for a task (deprecated)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setClientCallback - Manual" />
<meta itemprop="description" content="Callback function when there is a data packet for a task (deprecated)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Callback function when there is a data packet for a task (deprecated)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.setcompletecallback.php">
          GearmanClient::setCompleteCallback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.runtasks.php">
          &laquo; GearmanClient::runTasks        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setclientcallback.php' selected="selected">English</option>
            <option value='de/gearmanclient.setclientcallback.php'>German</option>
            <option value='es/gearmanclient.setclientcallback.php'>Spanish</option>
            <option value='fr/gearmanclient.setclientcallback.php'>French</option>
            <option value='it/gearmanclient.setclientcallback.php'>Italian</option>
            <option value='ja/gearmanclient.setclientcallback.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.setclientcallback.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.setclientcallback.php'>Russian</option>
            <option value='tr/gearmanclient.setclientcallback.php'>Turkish</option>
            <option value='uk/gearmanclient.setclientcallback.php'>Ukrainian</option>
            <option value='zh/gearmanclient.setclientcallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.setclientcallback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::setClientCallback</h1>
  <p class="verinfo">(PECL gearman &lt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::setClientCallback</span> &mdash; <span class="dc-title">Callback function when there is a data packet for a task (deprecated)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gearmanclient.setclientcallback-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::setClientCallback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This method has been replaced by <span class="methodname"><a href="gearmanclient.setdatacallback.php" class="methodname">GearmanClient::setDataCallback()</a></span> in
 ...
 <div class="refsect1 parameters" id="refsect1-gearmanclient.setclientcallback-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.setclientcallback-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanclient.setclientcallback-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setclientcallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setclientcallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setclientcallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setclientcallback.php">＋<small>add a note</small></a></span>
