...
<head>
  ...
  <title>PHP: Imagick::equalizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.equalizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.equalizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.equalizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.enhanceimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.evaluateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.equalizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.equalizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.equalizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.equalizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.equalizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.equalizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.equalizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.equalizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.equalizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.equalizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.equalizeimage.php" hreflang="zh">
...
<meta name="Description" content="Equalizes the image histogram" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::equalizeImage - Manual" />
<meta name="twitter:description" content="Equalizes the image histogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::equalizeImage - Manual" />
<meta itemprop="description" content="Equalizes the image histogram" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Equalizes the image histogram" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.evaluateimage.php">
          Imagick::evaluateImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.enhanceimage.php">
          &laquo; Imagick::enhanceImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.equalizeimage.php' selected="selected">English</option>
            <option value='de/imagick.equalizeimage.php'>German</option>
            <option value='es/imagick.equalizeimage.php'>Spanish</option>
            <option value='fr/imagick.equalizeimage.php'>French</option>
            <option value='it/imagick.equalizeimage.php'>Italian</option>
            <option value='ja/imagick.equalizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.equalizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.equalizeimage.php'>Russian</option>
            <option value='tr/imagick.equalizeimage.php'>Turkish</option>
            <option value='uk/imagick.equalizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.equalizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.equalizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::equalizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::equalizeImage</span> &mdash; <span class="dc-title">Equalizes the image histogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.equalizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::equalizeImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.equalizeimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.equalizeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.equalizeimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-2995">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/equalizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.equalizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.equalizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.equalizeimage.php">＋<small>add a note</small></a></span>
