...
<head>
  ...
  <title>PHP: Parle\ParserException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.parle-parserexception.php">
 <link rel="shorturl" href="https://www.php.net/parle-parserexception">
 <link rel="alternate" href="https://www.php.net/parle-parserexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.parle.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.parle-lexerexception.php">
 <link rel="next" href="https://www.php.net/manual/en/book.pcre.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.parle-parserexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.parle-parserexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.parle-parserexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.parle-parserexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.parle-parserexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.parle-parserexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.parle-parserexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.parle-parserexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.parle-parserexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.parle-parserexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.parle-parserexception.php" hreflang="zh">
...
<meta name="Description" content="The Parle\ParserException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Parle\ParserException - Manual" />
<meta name="twitter:description" content="The Parle\ParserException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Parle\ParserException - Manual" />
<meta itemprop="description" content="The Parle\ParserException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Parle\ParserException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.pcre.php">
          PCRE &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.parle-lexerexception.php">
          &laquo; Parle\LexerException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.parle-parserexception.php' selected="selected">English</option>
            <option value='de/class.parle-parserexception.php'>German</option>
            <option value='es/class.parle-parserexception.php'>Spanish</option>
            <option value='fr/class.parle-parserexception.php'>French</option>
            <option value='it/class.parle-parserexception.php'>Italian</option>
            <option value='ja/class.parle-parserexception.php'>Japanese</option>
            <option value='pt_BR/class.parle-parserexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.parle-parserexception.php'>Russian</option>
            <option value='tr/class.parle-parserexception.php'>Turkish</option>
            <option value='uk/class.parle-parserexception.php'>Ukrainian</option>
            <option value='zh/class.parle-parserexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.parle-parserexception" class="reference">

 <h1 class="title">The Parle\ParserException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL parle &gt;= 0.5.1)</p>


  <div class="section" id="parle-parserexception.intro">
  ...
  <div class="section" id="parle-parserexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Parle\ParserException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parle/parle.parserexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.parle-parserexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.parle-parserexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.parle-parserexception.php">＋<small>add a note</small></a></span>
