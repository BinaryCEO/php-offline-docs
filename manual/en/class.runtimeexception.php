...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.runtimeexception.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.rangeexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.underflowexception.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.runtimeexception.php' selected="selected">English</option>
            ...
            <option value='tr/class.runtimeexception.php'>Turkish</option>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/runtimeexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.runtimeexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.runtimeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.runtimeexception.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="116699">  <div class="votes">
    ...
    <div class="tally" id="V116699" title="79% like this...">
    50
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Whole exception-class hierarchy is shown at <a href="http://php.net/manual/en/spl.exceptions.php#spl.exceptions.tree" rel="nofollow" target="_blank">http://php.net/manual/en/spl.exceptions.php#spl.exceptions.tree</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.runtimeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.runtimeexception.php">＋<small>add a note</small></a></div>
