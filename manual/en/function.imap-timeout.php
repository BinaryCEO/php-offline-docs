...
<head>
  ...
  <title>PHP: imap_timeout - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-timeout.php">
 <link rel="shorturl" href="https://www.php.net/imap-timeout">
 <link rel="alternate" href="https://www.php.net/imap-timeout" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-thread.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-uid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-timeout.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-timeout.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-timeout.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-timeout.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-timeout.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-timeout.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-timeout.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-timeout.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-timeout.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-timeout.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-timeout.php" hreflang="zh">
...
<meta name="Description" content="Set or fetch imap timeout" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_timeout - Manual" />
<meta name="twitter:description" content="Set or fetch imap timeout" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_timeout - Manual" />
<meta itemprop="description" content="Set or fetch imap timeout" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set or fetch imap timeout" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-timeout.php' selected="selected">English</option>
            <option value='de/function.imap-timeout.php'>German</option>
            <option value='es/function.imap-timeout.php'>Spanish</option>
            <option value='fr/function.imap-timeout.php'>French</option>
            <option value='it/function.imap-timeout.php'>Italian</option>
            <option value='ja/function.imap-timeout.php'>Japanese</option>
            <option value='pt_BR/function.imap-timeout.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-timeout.php'>Russian</option>
            <option value='tr/function.imap-timeout.php'>Turkish</option>
            <option value='uk/function.imap-timeout.php'>Ukrainian</option>
            <option value='zh/function.imap-timeout.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-timeout" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_timeout</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.3, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_timeout</span> &mdash; <span class="dc-title">Set or fetch imap timeout</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-timeout-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_timeout</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timeout_type</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timeout</code><span class="initializer"> = -1</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-timeout-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">timeout_type</code></dt>
     <dd>
      <p class="para">
       ...
       <strong><code><a href="imap.constants.php#constant.imap-writetimeout">IMAP_WRITETIMEOUT</a></code></strong>, or
 ...
 <div class="refsect1 examples" id="refsect1-function.imap-timeout-examples">
  ...
  <p class="para">
   <div class="example" id="example-3252">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"The current read timeout is " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_timeout</span><span style="color: #007700">(</span><span style="color: #0000BB">IMAP_READTIMEOUT</span><span style="color: #007700">) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-timeout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-timeout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-timeout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-timeout.php">＋<small>add a note</small></a></span>
