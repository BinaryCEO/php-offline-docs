...
<head>
  ...
  <title>PHP: IntlCalendar::createInstance - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.createinstance.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.createinstance.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.createinstance.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.equals.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.createinstance.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.createinstance.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.createinstance.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.createinstance.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.createinstance.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.createinstance.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.createinstance.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.createinstance.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.createinstance.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.createinstance.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.createinstance.php" hreflang="zh">
...
<meta name="Description" content="Create a new IntlCalendar" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::createInstance - Manual" />
<meta name="twitter:description" content="Create a new IntlCalendar" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::createInstance - Manual" />
<meta itemprop="description" content="Create a new IntlCalendar" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new IntlCalendar" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlcalendar.equals.php">
          IntlCalendar::equals &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.construct.php">
          &laquo; IntlCalendar::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.createinstance.php' selected="selected">English</option>
            <option value='de/intlcalendar.createinstance.php'>German</option>
            <option value='es/intlcalendar.createinstance.php'>Spanish</option>
            <option value='fr/intlcalendar.createinstance.php'>French</option>
            <option value='it/intlcalendar.createinstance.php'>Italian</option>
            <option value='ja/intlcalendar.createinstance.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.createinstance.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.createinstance.php'>Russian</option>
            <option value='tr/intlcalendar.createinstance.php'>Turkish</option>
            <option value='uk/intlcalendar.createinstance.php'>Ukrainian</option>
            <option value='zh/intlcalendar.createinstance.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.createinstance" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::createInstance</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::createInstance</span> &mdash; <span class="dc-title">Create a new IntlCalendar</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.createinstance-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="classname"><a href="class.intlcalendar.php" class="classname">IntlCalendar</a></span> object. This factory method may return
   a subclass of <span class="classname"><a href="class.intlcalendar.php" class="classname">IntlCalendar</a></span>.
  </p>
  <p class="para">
...
<ul class="itemizedlist">
 ...
 <li class="listitem">
  <p class="para">
   ...
   offsets such as <code class="literal">&quot;GMT+08:30&quot;</code> are also accepted.
    ...
    <dd>
     <p class="para">
      A locale to use or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to use <a href="intl.configuration.php#ini.intl.default-locale" class="link">the default locale</a>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.createinstance-returnvalues">
  ...
  <p class="para">
   The created <span class="classname"><a href="class.intlcalendar.php" class="classname">IntlCalendar</a></span> instance or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on
   failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="intlgregoriancalendar.construct.php" class="methodname" rel="rdfs-seeAlso">IntlGregorianCalendar::__construct()</a> - Create the Gregorian Calendar class</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/createinstance.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.createinstance%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.createinstance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.createinstance.php">＋<small>add a note</small></a></span>
