...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-bool.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.is-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-callable.php">
...
<meta name="Description" content="Finds out whether a variable is a boolean" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_bool - Manual" />
<meta name="twitter:description" content="Finds out whether a variable is a boolean" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_bool - Manual" />
<meta itemprop="description" content="Finds out whether a variable is a boolean" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds out whether a variable is a boolean" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-bool.php' selected="selected">English</option>
            ...
            <option value='ru/function.is-bool.php'>Russian</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.is-bool-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if <code class="parameter">value</code> is a <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>,
 ...
 <div class="refsect1 examples" id="refsect1-function.is-bool-examples">
  ...
  <p class="para">
   <div class="example" id="example-5647">
    <p><strong>Example #1 <span class="function"><strong>is_bool()</strong></span> examples</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$a </span><span style="color: #007700">= </span><span style="color: #0000BB">false</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Since $a is a boolean, it will return true<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">is_bool</span><span style="color: #007700">(</span><span style="color: #0000BB">$a</span><span style="color: #007700">) === </span><span style="color: #0000BB">true</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"Yes, this is a boolean\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// Since $b is not a boolean, it will return false<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">is_bool</span><span style="color: #007700">(</span><span style="color: #0000BB">$b</span><span style="color: #007700">) === </span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"No, this is not a boolean\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.is-array.php" class="function" rel="rdfs-seeAlso">is_array()</a> - Finds whether a variable is an array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-bool.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-bool%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-bool&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-bool.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="124179">  <div class="votes">
    ...
    <div class="tally" id="V124179" title="72% like this...">
    11
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">To check if a variable is boolean is one thing, to evaluate if the value of a variable represents a boolean condition (true or false) is another.
<br />
<br />Here is a simple function that checks the status of the received variable in regard to boolean equivalencies (case-insensitive).
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">/** 
<br /> * Check "Booleanic" Conditions :)
<br /> *
<br /> * @param  [mixed]  $variable  Can be anything (string, bol, integer, etc.)
<br /> * @return [boolean]           Returns TRUE  for "1", "true", "on" and "yes"
<br /> *                             Returns FALSE for "0", "false", "off" and "no"
<br /> *                             Returns NULL otherwise.
<br /> */
<br /></span><span class="keyword">function </span><span class="default">is_enabled</span><span class="keyword">(</span><span class="default">$variable</span><span class="keyword">)
<br />{
<br />    if (!isset(</span><span class="default">$variable</span><span class="keyword">)) return </span><span class="default">null</span><span class="keyword">;
<br />    return </span><span class="default">filter_var</span><span class="keyword">(</span><span class="default">$variable</span><span class="keyword">, </span><span class="default">FILTER_VALIDATE_BOOLEAN</span><span class="keyword">, </span><span class="default">FILTER_NULL_ON_FAILURE</span><span class="keyword">);
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />Of course, it is a simplistic approach, but for the majority of cases it will do the job right.
<br />
<br />And, just to put the thing from the right perspective, here's a real function that does what Phill disclosed:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">/** 
<br /> * Convert $variable to boolean (adapted from Phill answer)
<br /> *
<br /> * @param  [mixed]  $variable  Can be anything
<br /> * @return [boolean]           Returns the booelan equivalent to $variable based on Zend Enegine interpretation
<br /> */
<br /></span><span class="keyword">function </span><span class="default">to_bool</span><span class="keyword">(</span><span class="default">$variable</span><span class="keyword">) 
<br />{ 
<br />    return (bool)</span><span class="default">$variable</span><span class="keyword">;
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />I hope it helps someone. Happy coding.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>phil</em></strong></a><a class="genanchor" href="#123510"> &para;</a><div class="date" title="2019-01-10 06:21"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123510">
<div class="phpcode"><code><span class="html">It should be stated that this function returns true if the _type_ of it's argument is boolean. It does not convert or coerce the value to a boolean type, not sure why so many comments focus on how to do this.<br />However, if you arrived here looking for a solution to convert a value to a boolean type, use this:<br /><br />to_bool($x) { return (bool)$x; }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-bool&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-bool.php">＋<small>add a note</small></a></div>
