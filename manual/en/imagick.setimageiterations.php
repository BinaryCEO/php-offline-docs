...
<head>
  ...
  <title>PHP: Imagick::setImageIterations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageiterations.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageiterations.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageiterations.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageinterpolatemethod.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagematte.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageiterations.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageiterations.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageiterations.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageiterations.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageiterations.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageiterations.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageiterations.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageiterations.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageiterations.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageiterations.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageiterations.php" hreflang="zh">
...
<meta name="Description" content="Sets the image iterations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageIterations - Manual" />
<meta name="twitter:description" content="Sets the image iterations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageIterations - Manual" />
<meta itemprop="description" content="Sets the image iterations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image iterations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagematte.php">
          Imagick::setImageMatte &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageinterpolatemethod.php">
          &laquo; Imagick::setImageInterpolateMethod        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageiterations.php' selected="selected">English</option>
            <option value='de/imagick.setimageiterations.php'>German</option>
            <option value='es/imagick.setimageiterations.php'>Spanish</option>
            <option value='fr/imagick.setimageiterations.php'>French</option>
            <option value='it/imagick.setimageiterations.php'>Italian</option>
            <option value='ja/imagick.setimageiterations.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageiterations.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageiterations.php'>Russian</option>
            <option value='tr/imagick.setimageiterations.php'>Turkish</option>
            <option value='uk/imagick.setimageiterations.php'>Ukrainian</option>
            <option value='zh/imagick.setimageiterations.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageiterations" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageIterations</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageIterations</span> &mdash; <span class="dc-title">Sets the image iterations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageiterations-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageIterations</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$iterations</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageiterations-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageiterations-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageiterations-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimageiterations-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3097">
    <p><strong>Example #1 Basic <span class="function"><strong>Imagick::setImageIterations()</strong></span> usage</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"Test.gif"</span><span style="color: #007700">));<br /><br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">coalesceImages</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageIterations</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">deconstructImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImages</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/save/OnceOnly.gif'</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageiterations.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageiterations%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageiterations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageiterations.php">＋<small>add a note</small></a></span>
