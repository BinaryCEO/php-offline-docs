...
<head>
  ...
  <title>PHP: trader_sin - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-sin.php">
 <link rel="shorturl" href="https://www.php.net/trader-sin">
 <link rel="alternate" href="https://www.php.net/trader-sin" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-set-unstable-period.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-sinh.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-sin.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-sin.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-sin.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-sin.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-sin.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-sin.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-sin.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-sin.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-sin.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-sin.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-sin.php" hreflang="zh">
...
<meta name="Description" content="Vector Trigonometric Sin" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_sin - Manual" />
<meta name="twitter:description" content="Vector Trigonometric Sin" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_sin - Manual" />
<meta itemprop="description" content="Vector Trigonometric Sin" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Trigonometric Sin" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-set-unstable-period.php">
          &laquo; trader_set_unstable_period        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-sin.php' selected="selected">English</option>
            <option value='de/function.trader-sin.php'>German</option>
            <option value='es/function.trader-sin.php'>Spanish</option>
            <option value='fr/function.trader-sin.php'>French</option>
            <option value='it/function.trader-sin.php'>Italian</option>
            <option value='ja/function.trader-sin.php'>Japanese</option>
            <option value='pt_BR/function.trader-sin.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-sin.php'>Russian</option>
            <option value='tr/function.trader-sin.php'>Turkish</option>
            <option value='uk/function.trader-sin.php'>Ukrainian</option>
            <option value='zh/function.trader-sin.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-sin" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_sin</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_sin</span> &mdash; <span class="dc-title">Vector Trigonometric Sin</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-sin-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_sin</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-sin-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-sin-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-sin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-sin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-sin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-sin.php">＋<small>add a note</small></a></span>
