...
<head>
  ...
  <title>PHP: Gmagick::getversion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getversion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getversion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getversion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getsize.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.hasnextimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getversion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getversion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getversion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getversion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getversion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getversion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getversion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getversion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getversion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getversion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getversion.php" hreflang="zh">
...
<meta name="Description" content="Returns the GraphicsMagick API version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getversion - Manual" />
<meta name="twitter:description" content="Returns the GraphicsMagick API version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getversion - Manual" />
<meta itemprop="description" content="Returns the GraphicsMagick API version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the GraphicsMagick API version" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.hasnextimage.php">
          Gmagick::hasnextimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getsize.php">
          &laquo; Gmagick::getsize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getversion.php' selected="selected">English</option>
            <option value='de/gmagick.getversion.php'>German</option>
            <option value='es/gmagick.getversion.php'>Spanish</option>
            <option value='fr/gmagick.getversion.php'>French</option>
            <option value='it/gmagick.getversion.php'>Italian</option>
            <option value='ja/gmagick.getversion.php'>Japanese</option>
            <option value='pt_BR/gmagick.getversion.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getversion.php'>Russian</option>
            <option value='tr/gmagick.getversion.php'>Turkish</option>
            <option value='uk/gmagick.getversion.php'>Ukrainian</option>
            <option value='zh/gmagick.getversion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getversion" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getversion</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getversion</span> &mdash; <span class="dc-title">Returns the GraphicsMagick API version</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getversion-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getversion</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getversion-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getversion-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getversion-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getversion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getversion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getversion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getversion.php">＋<small>add a note</small></a></span>
