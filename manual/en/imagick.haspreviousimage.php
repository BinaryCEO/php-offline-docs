...
<head>
  ...
  <title>PHP: Imagick::hasPreviousImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.haspreviousimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.haspreviousimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.haspreviousimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.hasnextimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.identifyformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.haspreviousimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.haspreviousimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.haspreviousimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.haspreviousimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.haspreviousimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.haspreviousimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.haspreviousimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.haspreviousimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.haspreviousimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.haspreviousimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.haspreviousimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::hasPreviousImage - Manual" />
<meta name="twitter:description" content="Checks if the object has a previous image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::hasPreviousImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.identifyformat.php">
          Imagick::identifyFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.hasnextimage.php">
          &laquo; Imagick::hasNextImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.haspreviousimage.php' selected="selected">English</option>
            <option value='de/imagick.haspreviousimage.php'>German</option>
            <option value='es/imagick.haspreviousimage.php'>Spanish</option>
            <option value='fr/imagick.haspreviousimage.php'>French</option>
            <option value='it/imagick.haspreviousimage.php'>Italian</option>
            <option value='ja/imagick.haspreviousimage.php'>Japanese</option>
            <option value='pt_BR/imagick.haspreviousimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.haspreviousimage.php'>Russian</option>
            <option value='tr/imagick.haspreviousimage.php'>Turkish</option>
            <option value='uk/imagick.haspreviousimage.php'>Ukrainian</option>
            <option value='zh/imagick.haspreviousimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.haspreviousimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::hasPreviousImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::hasPreviousImage</span> &mdash; <span class="dc-title">Checks if the object has a previous image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.haspreviousimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::hasPreviousImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.haspreviousimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.haspreviousimage-returnvalues">
  ...
  <p class="para">
   ...
   reverse direction, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there are none.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/haspreviousimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.haspreviousimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.haspreviousimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.haspreviousimage.php">＋<small>add a note</small></a></span>
