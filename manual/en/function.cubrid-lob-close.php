...
<head>
  ...
  <title>PHP: cubrid_lob_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob-close.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob-close">
 <link rel="alternate" href="https://www.php.net/cubrid-lob-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-is-instance.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob-close.php" hreflang="zh">
...
<meta name="Description" content="Close BLOB/CLOB data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob_close - Manual" />
<meta name="twitter:description" content="Close BLOB/CLOB data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob_close - Manual" />
<meta itemprop="description" content="Close BLOB/CLOB data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close BLOB/CLOB data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lob-export.php">
          cubrid_lob_export &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-is-instance.php">
          &laquo; cubrid_is_instance        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob-close.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob-close.php'>German</option>
            <option value='es/function.cubrid-lob-close.php'>Spanish</option>
            <option value='fr/function.cubrid-lob-close.php'>French</option>
            <option value='it/function.cubrid-lob-close.php'>Italian</option>
            <option value='ja/function.cubrid-lob-close.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob-close.php'>Russian</option>
            <option value='tr/function.cubrid-lob-close.php'>Turkish</option>
            <option value='uk/function.cubrid-lob-close.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob_close</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.1)</p><p class="refpurpose"><span class="refname">cubrid_lob_close</span> &mdash; <span class="dc-title">Close BLOB/CLOB data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-lob-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob_close</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$lob_identifier_array</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>cubrid_lob_close()</strong></span> is used to close all BLOB/CLOB
   returned from <span class="function"><a href="function.cubrid-lob-get.php" class="function">cubrid_lob_get()</a></span>. 
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-lob-close-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
  <dl>
    
  <dt><code class="parameter">lob_identifier_array</code></dt>
  <dd><p class="para">LOB identifier array returned from <span class="function"><a href="function.cubrid-lob-get.php" class="function">cubrid_lob_get()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lob-close-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob-close-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1246">
   <p><strong>Example #1 <span class="function"><strong>cubrid_lob_close()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect </span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"DROP TABLE if exists doc"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"CREATE TABLE doc (id INT, doc_content CLOB)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"INSERT INTO doc VALUES (5,'hello,cubrid')"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$lobs </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob_get</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT doc_content FROM doc WHERE id=5"</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"Doc size: "</span><span style="color: #007700">.</span><span style="color: #0000BB">cubrid_lob_size</span><span style="color: #007700">(</span><span style="color: #0000BB">$lobs</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">]).</span><span style="color: #DD0000">" bytes"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">cubrid_lob_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$lobs</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">], </span><span style="color: #DD0000">"doc_5.txt"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_lob_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$lobs</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-lob-close-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-lob-get.php" class="function" rel="rdfs-seeAlso">cubrid_lob_get()</a> - Get BLOB/CLOB data</span></li>  
    <li><span class="function"><a href="function.cubrid-lob-size.php" class="function" rel="rdfs-seeAlso">cubrid_lob_size()</a> - Get BLOB/CLOB data size</span></li>  
    <li><span class="function"><a href="function.cubrid-lob-export.php" class="function" rel="rdfs-seeAlso">cubrid_lob_export()</a> - Export BLOB/CLOB data to file</span></li>     
    <li><span class="function"><a href="function.cubrid-lob-send.php" class="function" rel="rdfs-seeAlso">cubrid_lob_send()</a> - Read BLOB/CLOB data and send straight to browser</span></li>     
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob-close.php">＋<small>add a note</small></a></span>
