...
<head>
  ...
  <title>PHP: Imagick::addNoiseImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.addnoiseimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.addnoiseimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.addnoiseimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.addimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.affinetransformimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.addnoiseimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.addnoiseimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.addnoiseimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.addnoiseimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.addnoiseimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.addnoiseimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.addnoiseimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.addnoiseimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.addnoiseimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.addnoiseimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.addnoiseimage.php" hreflang="zh">
...
<meta name="Description" content="Adds random noise to the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::addNoiseImage - Manual" />
<meta name="twitter:description" content="Adds random noise to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::addNoiseImage - Manual" />
<meta itemprop="description" content="Adds random noise to the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds random noise to the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.affinetransformimage.php">
          Imagick::affineTransformImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.addimage.php">
          &laquo; Imagick::addImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.addnoiseimage.php' selected="selected">English</option>
            <option value='de/imagick.addnoiseimage.php'>German</option>
            <option value='es/imagick.addnoiseimage.php'>Spanish</option>
            <option value='fr/imagick.addnoiseimage.php'>French</option>
            <option value='it/imagick.addnoiseimage.php'>Italian</option>
            <option value='ja/imagick.addnoiseimage.php'>Japanese</option>
            <option value='pt_BR/imagick.addnoiseimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.addnoiseimage.php'>Russian</option>
            <option value='tr/imagick.addnoiseimage.php'>Turkish</option>
            <option value='uk/imagick.addnoiseimage.php'>Ukrainian</option>
            <option value='zh/imagick.addnoiseimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.addnoiseimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::addNoiseImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::addNoiseImage</span> &mdash; <span class="dc-title">Adds random noise to the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.addnoiseimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::addNoiseImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$noise_type</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.addnoiseimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">noise_type</code></dt>
     <dd>
      <p class="para">
       The type of the noise. Refer to this list of
       <a href="imagick.constants.php#imagick.constants.noise" class="link">noise constants</a>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.addnoiseimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-2966">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/addnoiseimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.addnoiseimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.addnoiseimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.addnoiseimage.php">＋<small>add a note</small></a></span>
