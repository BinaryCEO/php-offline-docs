...
<head>
  ...
  <title>PHP: date_create_immutable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-create-immutable.php">
 <link rel="shorturl" href="https://www.php.net/date-create-immutable">
 <link rel="alternate" href="https://www.php.net/date-create-immutable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-create-from-format.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-create-immutable-from-format.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-create-immutable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-create-immutable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-create-immutable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-create-immutable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-create-immutable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-create-immutable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-create-immutable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-create-immutable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-create-immutable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-create-immutable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-create-immutable.php" hreflang="zh">
...
<meta name="Description" content="create a new DateTimeImmutable object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_create_immutable - Manual" />
<meta name="twitter:description" content="create a new DateTimeImmutable object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_create_immutable - Manual" />
<meta itemprop="description" content="create a new DateTimeImmutable object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="create a new DateTimeImmutable object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-create-immutable-from-format.php">
          date_create_immutable_from_format &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-create-from-format.php">
          &laquo; date_create_from_format        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-create-immutable.php' selected="selected">English</option>
            <option value='de/function.date-create-immutable.php'>German</option>
            <option value='es/function.date-create-immutable.php'>Spanish</option>
            <option value='fr/function.date-create-immutable.php'>French</option>
            <option value='it/function.date-create-immutable.php'>Italian</option>
            <option value='ja/function.date-create-immutable.php'>Japanese</option>
            <option value='pt_BR/function.date-create-immutable.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-create-immutable.php'>Russian</option>
            <option value='tr/function.date-create-immutable.php'>Turkish</option>
            <option value='uk/function.date-create-immutable.php'>Ukrainian</option>
            <option value='zh/function.date-create-immutable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-create-immutable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_create_immutable</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_create_immutable</span> &mdash; <span class="dc-title">create a new <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span> object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-create-immutable-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>date_create_immutable</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$datetime</code><span class="initializer"> = &quot;now&quot;</span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.datetimezone.php" class="type DateTimeZone">DateTimeZone</a></span></span> <code class="parameter">$timezone</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.datetimeimmutable.php" class="type DateTimeImmutable">DateTimeImmutable</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   This is the procedural version of
   <span class="methodname"><a href="datetimeimmutable.construct.php" class="methodname">DateTimeImmutable::__construct()</a></span>.
  </p>
  <p class="para">
   Unlike the <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span> constructor, it will return
 ...
 <div class="refsect1 parameters" id="refsect1-function.date-create-immutable-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.date-create-immutable-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.date-create-immutable-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="datetimeimmutable.createfromformat.php" class="methodname" rel="rdfs-seeAlso">DateTimeImmutable::createFromFormat()</a> - Parses a time string according to a specified format</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-create-immutable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-create-immutable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-create-immutable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-create-immutable.php">＋<small>add a note</small></a></span>
