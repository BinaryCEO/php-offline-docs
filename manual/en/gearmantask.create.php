...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmantask.create.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmantask.create.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmantask.create.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmantask.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmantask.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmantask.data.php">
...
<meta name="Description" content="Create a task (deprecated)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanTask::create - Manual" />
<meta name="twitter:description" content="Create a task (deprecated)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanTask::create - Manual" />
<meta itemprop="description" content="Create a task (deprecated)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a task (deprecated)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmantask.create.php' selected="selected">English</option>
            ...
            <option value='ru/gearmantask.create.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gearman &lt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanTask::create</span> &mdash; <span class="dc-title">Create a task (deprecated)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-gearmantask.create-description">
  ...
  <p class="para rdfs-comment">
   Returns a new <span class="classname"><a href="class.gearmantask.php" class="classname">GearmanTask</a></span> object.
  </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmantask.create-returnvalues">
  ...
  <p class="para">
   A <span class="classname"><a href="class.gearmantask.php" class="classname">GearmanTask</a></span> oject or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmantask/create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmantask.create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmantask.create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmantask.create.php">＋<small>add a note</small></a></span>
