...
<head>
  ...
  <title>PHP: Collection::createIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collection.createindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collection.createindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.createindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collection.count.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collection.dropindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.createindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collection.createindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collection.createindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collection.createindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collection.createindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collection.createindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collection.createindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collection.createindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collection.createindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collection.createindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collection.createindex.php" hreflang="zh">
...
<meta name="Description" content="Create collection index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collection::createIndex - Manual" />
<meta name="twitter:description" content="Create collection index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collection::createIndex - Manual" />
<meta itemprop="description" content="Create collection index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create collection index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-collection.dropindex.php">
          Collection::dropIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collection.count.php">
          &laquo; Collection::count        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collection.createindex.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collection.createindex.php'>German</option>
            <option value='es/mysql-xdevapi-collection.createindex.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collection.createindex.php'>French</option>
            <option value='it/mysql-xdevapi-collection.createindex.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collection.createindex.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collection.createindex.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collection.createindex.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collection.createindex.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collection.createindex.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collection.createindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collection.createindex" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$session </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_xdevapi\getSession</span><span style="color: #007700">(</span><span style="color: #DD0000">"mysqlx://user:password@localhost"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sql</span><span style="color: #007700">(</span><span style="color: #DD0000">"DROP DATABASE IF EXISTS addressbook"</span><span style="color: #007700">)-&gt;</span><span style="color: #0000BB">execute</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sql</span><span style="color: #007700">(</span><span style="color: #DD0000">"CREATE DATABASE addressbook"</span><span style="color: #007700">)-&gt;</span><span style="color: #0000BB">execute</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$schema     </span><span style="color: #007700">= </span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getSchema</span><span style="color: #007700">(</span><span style="color: #DD0000">"addressbook"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$collection </span><span style="color: #007700">= </span><span style="color: #0000BB">$schema</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createCollection</span><span style="color: #007700">(</span><span style="color: #DD0000">"people"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Creating a text index<br /></span><span style="color: #0000BB">$collection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createIndex</span><span style="color: #007700">(<br />  </span><span style="color: #DD0000">'myindex1'</span><span style="color: #007700">, <br />  </span><span style="color: #DD0000">'{"fields": [{<br />    "field": "$.name", <br />    "type": "TEXT(25)", <br />    "required": true}], <br />    "unique": false}'<br /></span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// A spatial index<br /></span><span style="color: #0000BB">$collection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createIndex</span><span style="color: #007700">(<br />  </span><span style="color: #DD0000">'myindex2'</span><span style="color: #007700">, <br />  </span><span style="color: #DD0000">'{"fields": [{<br />    "field": "$.home", <br />    "type": "GEOJSON", <br />    "required": true}], <br />    "type": "SPATIAL"}'<br /></span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Index with multiple fields<br /></span><span style="color: #0000BB">$collection</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createIndex</span><span style="color: #007700">(<br />  </span><span style="color: #DD0000">'myindex3'</span><span style="color: #007700">, <br />  </span><span style="color: #DD0000">'{"fields": [<br />    {<br />      "field": "$.name",<br />      "type": "TEXT(20)",<br />      "required": true<br />    },<br />    {<br />      "field": "$.age",<br />      "type": "INTEGER"<br />    },<br />    {<br />      "field": "$.job",<br />      "type": "TEXT(30)",<br />      "required": false<br />    }<br />  ],<br />  "unique": true<br />  }'<br /></span><span style="color: #007700">);</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collection/createindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collection.createindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collection.createindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collection.createindex.php">＋<small>add a note</small></a></span>
