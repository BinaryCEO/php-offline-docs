...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-connection-busy.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-connect-poll.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-connection-reset.php">
...
<meta name="Description" content="Get connection is busy or not" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_connection_busy - Manual" />
<meta name="twitter:description" content="Get connection is busy or not" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_connection_busy - Manual" />
<meta itemprop="description" content="Get connection is busy or not" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get connection is busy or not" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-connection-busy.php' selected="selected">English</option>
            ...
            <option value='ja/function.pg-connection-busy.php'>Japanese</option>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-connection-busy-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_connection_busy()</strong></span> determines whether or not a connection
   is busy.  If it is busy, a previous query is still executing.
   If <span class="function"><a href="function.pg-get-result.php" class="function">pg_get_result()</a></span> is used on the connection, it will be blocked.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-connection-busy-returnvalues">
  <h3 class="title">Return Values</h3>
   <p class="para">
    Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the connection is busy, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
   </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-connection-busy-examples">
  ...
  <p class="para">
   <div class="example" id="example-2043">
    <p><strong>Example #1 <span class="function"><strong>pg_connection_busy()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-get-result.php" class="function" rel="rdfs-seeAlso">pg_get_result()</a> - Get asynchronous query result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-connection-busy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-connection-busy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-connection-busy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-connection-busy.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">There doesn't seem to be any documented way of using this function here, and I'm sore most people trying this are going to default to using a busy loop if there is nothing else to do while waiting (in which case pg_get_result would be better, since it just blocks until a result is ready) or a sleep loop if trying to cancel the query after a certain time.<br /><br />The C documentation for libPq reccomends using PQisBusy (the C equivalent of pg_connection_busy) by waiting on a socket instead, which lets you timeout if the state doesn't change after a certain period but immediately react if it changes. If you want to cancel after a timeout, you would have something like this :<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">SomeKindOfTimeoutException </span><span class="keyword">extends </span><span class="default">Exception </span><span class="keyword">{ }<br /><br />class </span><span class="default">SomeKindOfSQLErrorException </span><span class="keyword">extends </span><span class="default">Exception </span><span class="keyword">{ }<br /><br />function </span><span class="default">query_with_timeout</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$query</span><span class="keyword">, </span><span class="default">$timeout_seconds</span><span class="keyword">) {<br />    </span><span class="default">assert</span><span class="keyword">(</span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">) === </span><span class="default">false</span><span class="keyword">); </span><span class="comment">// Ensure that nothing is running<br /><br />    </span><span class="default">$socket </span><span class="keyword">= [</span><span class="default">pg_socket</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">)];<br />    </span><span class="default">$null </span><span class="keyword">= [];<br /><br />    </span><span class="default">$dispatch_ok </span><span class="keyword">= </span><span class="default">pg_send_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$query</span><span class="keyword">);<br /><br />    </span><span class="default">$still_running </span><span class="keyword">= </span><span class="default">pg_connection_busy</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br /><br />    while(</span><span class="default">$still_running</span><span class="keyword">) {<br />        </span><span class="comment">// <a href="https://www.postgresql.org/docs/current/libpq-async.html" rel="nofollow" target="_blank">https://www.postgresql.org/docs/current/libpq-async.html</a><br />        // "A typical application using these functions will have a main loop that uses select() or poll() to wait for all the conditions that it must respond to."<br />        // "One of the conditions will be input available from the server, which in terms of select() means readable data on the file descriptor identified by PQsocket."<br />        // PQisBusy is mapped to pg_connection_busy<br />        </span><span class="default">stream_select</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="default">$null</span><span class="keyword">, </span><span class="default">$null</span><span class="keyword">, </span><span class="default">$timeout_seconds</span><span class="keyword">); </span><span class="comment">// Will wait on that socket until that happens or the timeout is reached<br />        </span><span class="default">$still_running </span><span class="keyword">= </span><span class="default">pg_connection_busy</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">); </span><span class="comment">// False on timeout, true if complete<br /><br />        // You could keep polling like that, this just breaks and throws immediately on first loop<br />        </span><span class="keyword">if (</span><span class="default">$still_running</span><span class="keyword">) {<br />            </span><span class="default">$cancel_ok </span><span class="keyword">= </span><span class="default">pg_cancel_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br />            throw new </span><span class="default">SomeKindOfTimeoutException</span><span class="keyword">(</span><span class="string">"TIMEOUT"</span><span class="keyword">);<br />        }<br />    }<br /><br />    </span><span class="default">$res </span><span class="keyword">= </span><span class="default">pg_get_result</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">);<br /><br />    try {<br />        </span><span class="default">$error_msg </span><span class="keyword">= </span><span class="default">pg_result_error</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">);<br />        if (</span><span class="default">$error_msg</span><span class="keyword">) throw new </span><span class="default">SomeKindOfSQLErrorException</span><span class="keyword">(</span><span class="default">$error_msg</span><span class="keyword">);<br /><br />        return </span><span class="default">pg_fetch_all</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">);<br />    } finally {<br />        </span><span class="default">pg_free_result</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">);<br />    }<br />}<br /><br /></span><span class="default">$conn_string </span><span class="keyword">= </span><span class="string">"host=localhost port=5433 dbname=postgres"</span><span class="keyword">;<br /></span><span class="default">$db </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="default">$conn_string</span><span class="keyword">);<br /><br /></span><span class="default">query_with_timeout</span><span class="keyword">(</span><span class="default">$db</span><span class="keyword">, </span><span class="string">"SELECT pg_sleep(10)"</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">); </span><span class="comment">// Will throw<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>levi at alliancesoftware dot com dot au</em></strong></a><a class="genanchor" href="#94499"> &para;</a><div class="date" title="2009-11-08 05:00"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94499">
<div class="phpcode"><code><span class="html">pg_connection_busy() returning true does not necessarily mean that there are results waiting for pg_get_result(); it also stays true for some time after a query that causes any sort of postgres error. (See <a href="http://bugs.php.net/bug.php?id=36469" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=36469</a>)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-connection-busy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-connection-busy.php">＋<small>add a note</small></a></div>
