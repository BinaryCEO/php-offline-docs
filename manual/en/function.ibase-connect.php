...
<head>
  ...
  <title>PHP: ibase_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-connect.php">
 <link rel="shorturl" href="https://www.php.net/ibase-connect">
 <link rel="alternate" href="https://www.php.net/ibase-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-commit-ret.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-db-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-connect.php" hreflang="zh">
...
<meta name="Description" content="Open a connection to a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_connect - Manual" />
<meta name="twitter:description" content="Open a connection to a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_connect - Manual" />
<meta itemprop="description" content="Open a connection to a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a connection to a database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-connect.php' selected="selected">English</option>
            <option value='de/function.ibase-connect.php'>German</option>
            <option value='es/function.ibase-connect.php'>Spanish</option>
            <option value='fr/function.ibase-connect.php'>French</option>
            <option value='it/function.ibase-connect.php'>Italian</option>
            <option value='ja/function.ibase-connect.php'>Japanese</option>
            <option value='pt_BR/function.ibase-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-connect.php'>Russian</option>
            <option value='tr/function.ibase-connect.php'>Turkish</option>
            <option value='uk/function.ibase-connect.php'>Ukrainian</option>
            <option value='zh/function.ibase-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-connect" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-close.php" class="function" rel="rdfs-seeAlso">ibase_close()</a> - Close a connection to an InterBase database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-connect.php">＋<small>add a note</small></a></span>
