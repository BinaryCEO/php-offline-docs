...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.oop5.interfaces.php">
 <link rel="shorturl" href="https://www.php.net/oop5.interfaces">
 <link rel="alternate" href="https://www.php.net/oop5.interfaces" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.oop5.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.oop5.abstract.php">
 <link rel="next" href="https://www.php.net/manual/en/language.oop5.traits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.oop5.interfaces.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.oop5.interfaces.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.oop5.interfaces.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.oop5.interfaces.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.oop5.interfaces.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.oop5.interfaces.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.oop5.interfaces.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.oop5.interfaces.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.oop5.interfaces.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.oop5.interfaces.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.oop5.interfaces.php" hreflang="zh">
...
<meta name="Description" content="Object Interfaces" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Object Interfaces - Manual" />
<meta name="twitter:description" content="Object Interfaces" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Object Interfaces - Manual" />
<meta itemprop="description" content="Object Interfaces" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Object Interfaces" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/language.oop5.interfaces.php'>Italian</option>
            ...
            <option value='uk/language.oop5.interfaces.php'>Ukrainian</option>
   ...
   <p class="para">
     ...
     <a href="language.types.declarations.php" class="link">type declarations</a>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/oop5/interfaces.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.oop5.interfaces%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.interfaces&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.interfaces.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="102755">  <div class="votes">
    ...
    <div class="tally" id="V102755" title="62% like this...">
    39
    </div>
  </div>
  <a href="#102755" class="name">
  <strong class="user"><em>thanhn2001 at gmail dot com</em></strong></a><a class="genanchor" href="#102755"> &para;</a><div class="date" title="2011-03-03 01:37"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102755">
<div class="phpcode"><code><span class="html">PHP prevents interface a contant to be overridden by a class/interface that DIRECTLY inherits it.  However, further inheritance allows it.  That means that interface constants are not final as mentioned in a previous comment.  Is this a bug or a feature?<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">interface </span><span class="default">a<br /></span><span class="keyword">{<br />    const </span><span class="default">b </span><span class="keyword">= </span><span class="string">'Interface constant'</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// Prints: Interface constant<br /></span><span class="keyword">echo </span><span class="default">a</span><span class="keyword">::</span><span class="default">b</span><span class="keyword">;<br /><br />class </span><span class="default">b </span><span class="keyword">implements </span><span class="default">a<br /></span><span class="keyword">{<br />}<br /><br /></span><span class="comment">// This works!!!<br /></span><span class="keyword">class </span><span class="default">c </span><span class="keyword">extends </span><span class="default">b<br /></span><span class="keyword">{<br />    const </span><span class="default">b </span><span class="keyword">= </span><span class="string">'Class constant'</span><span class="keyword">;<br />}<br /><br />echo </span><span class="default">c</span><span class="keyword">::</span><span class="default">b</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126731">  <div class="votes">
    <div id="Vu126731">
    <a href="/manual/vote-note.php?id=126731&amp;page=language.oop5.interfaces&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126731">
    <a href="/manual/vote-note.php?id=126731&amp;page=language.oop5.interfaces&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126731" title="66% like this...">
    22
    </div>
  </div>
  <a href="#126731" class="name">
  <strong class="user"><em>vcnbianchi</em></strong></a><a class="genanchor" href="#126731"> &para;</a><div class="date" title="2021-12-30 09:07"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126731">
<div class="phpcode"><code><span class="html">Just as all interface methods are public, all interface methods are abstract as well.</span></code></div>
  </div>
 </div>
  <div class="note" id="115529">  <div class="votes">
    ...
    <div class="tally" id="V115529" title="54% like this...">
    5
    </div>
  </div>
  <a href="#115529" class="name">
  <strong class="user"><em>williebegoode at att dot net</em></strong></a><a class="genanchor" href="#115529"> &para;</a><div class="date" title="2014-08-10 10:42"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115529">
<div class="phpcode"><code><span class="html">In their book on Design Patterns, Erich Gamma and his associates (AKA: "The Gang of Four") use the term "interface" and "abstract class" interchangeably. In working with PHP and design patterns, the interface, while clearly a "contract" of what to include in an implementation is also a helpful guide for both re-use and making changes. As long as the implemented changes follow the interface (whether it is an interface or abstract class with abstract methods), large complex programs can be safely updated without having to re-code an entire program or module.<br /><br />In PHP coding with object interfaces (as a keyword) and "interfaces" in the more general context of use that includes both object interfaces and abstract classes, the purpose of "loose binding" (loosely bound objects) for ease of change and re-use is a helpful way to think about both uses of the  term "interface." The focus shifts from "contractual" to "loose binding" for the purpose of cooperative development and re-use.</span></code></div>
  </div>
 </div>
  <div class="note" id="125893">  <div class="votes">
    <div id="Vu125893">
    <a href="/manual/vote-note.php?id=125893&amp;page=language.oop5.interfaces&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125893">
    <a href="/manual/vote-note.php?id=125893&amp;page=language.oop5.interfaces&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125893" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#125893" class="name">
  <strong class="user"><em>xedin dot unknown at gmail dot com</em></strong></a><a class="genanchor" href="#125893"> &para;</a><div class="date" title="2021-03-09 09:44"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125893">
<div class="phpcode"><code><span class="html">This page says that if extending multiple interfaces with the same methods, the signature must be compatible. But this is not all there is to it: the order of `extends` matters. This is a known issue, and while it is disputable whether or not it is a bug, one should be aware of it, and code interfaces with this in mind.<br /><br /><a href="https://bugs.php.net/bug.php?id=67270" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=67270</a><br /><a href="https://bugs.php.net/bug.php?id=76361" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=76361</a><br /><a href="https://bugs.php.net/bug.php?id=80785" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=80785</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.oop5.interfaces&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.interfaces.php">＋<small>add a note</small></a></div>
