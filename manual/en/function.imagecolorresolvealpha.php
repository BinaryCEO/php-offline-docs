...
<head>
  ...
  <title>PHP: imagecolorresolvealpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorresolvealpha.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorresolvealpha">
 <link rel="alternate" href="https://www.php.net/imagecolorresolvealpha" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorresolve.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorresolvealpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorresolvealpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorresolvealpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorresolvealpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorresolvealpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorresolvealpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorresolvealpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorresolvealpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorresolvealpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorresolvealpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorresolvealpha.php" hreflang="zh">
...
<meta name="Description" content="Get the index of the specified color + alpha or its closest possible alternative" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolorresolvealpha - Manual" />
<meta name="twitter:description" content="Get the index of the specified color + alpha or its closest possible alternative" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorresolvealpha - Manual" />
<meta itemprop="description" content="Get the index of the specified color + alpha or its closest possible alternative" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the index of the specified color + alpha or its closest possible alternative" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorresolvealpha.php' selected="selected">English</option>
            <option value='de/function.imagecolorresolvealpha.php'>German</option>
            <option value='es/function.imagecolorresolvealpha.php'>Spanish</option>
            <option value='fr/function.imagecolorresolvealpha.php'>French</option>
            <option value='it/function.imagecolorresolvealpha.php'>Italian</option>
            <option value='ja/function.imagecolorresolvealpha.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorresolvealpha.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorresolvealpha.php'>Russian</option>
            <option value='tr/function.imagecolorresolvealpha.php'>Turkish</option>
            <option value='uk/function.imagecolorresolvealpha.php'>Ukrainian</option>
            <option value='zh/function.imagecolorresolvealpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorresolvealpha" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecolorresolvealpha</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecolorresolvealpha</span> &mdash; <span class="dc-title">Get the index of the specified color + alpha or its closest possible alternative</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecolorresolvealpha-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecolorresolvealpha</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$red</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$green</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$blue</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$alpha</code></span><br>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagecolorresolvealpha-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecolorresolvealpha-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecolorresolvealpha-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolorresolvealpha-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2850">
   <p><strong>Example #1 Using <span class="function"><strong>imagecoloresolvealpha()</strong></span> to get colors from an image</strong></p>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagecolorresolvealpha-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecolorclosestalpha.php" class="function" rel="rdfs-seeAlso">imagecolorclosestalpha()</a> - Get the index of the closest color to the specified color + alpha</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorresolvealpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorresolvealpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorresolvealpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorresolvealpha.php">＋<small>add a note</small></a></span>
