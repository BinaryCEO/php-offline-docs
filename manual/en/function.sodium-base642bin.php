...
<head>
  ...
  <title>PHP: sodium_base642bin - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-base642bin.php">
 <link rel="shorturl" href="https://www.php.net/sodium-base642bin">
 <link rel="alternate" href="https://www.php.net/sodium-base642bin" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-bin2base64.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-base642bin.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-base642bin.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-base642bin.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-base642bin.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-base642bin.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-base642bin.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-base642bin.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-base642bin.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-base642bin.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-base642bin.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-base642bin.php" hreflang="zh">
...
<meta name="Description" content="Decodes a base64-encoded string into raw binary." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_base642bin - Manual" />
<meta name="twitter:description" content="Decodes a base64-encoded string into raw binary." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_base642bin - Manual" />
<meta itemprop="description" content="Decodes a base64-encoded string into raw binary." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decodes a base64-encoded string into raw binary." />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-bin2base64.php">
          sodium_bin2base64 &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-base642bin.php' selected="selected">English</option>
            <option value='de/function.sodium-base642bin.php'>German</option>
            <option value='es/function.sodium-base642bin.php'>Spanish</option>
            <option value='fr/function.sodium-base642bin.php'>French</option>
            <option value='it/function.sodium-base642bin.php'>Italian</option>
            <option value='ja/function.sodium-base642bin.php'>Japanese</option>
            <option value='pt_BR/function.sodium-base642bin.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-base642bin.php'>Russian</option>
            <option value='tr/function.sodium-base642bin.php'>Turkish</option>
            <option value='uk/function.sodium-base642bin.php'>Ukrainian</option>
            <option value='zh/function.sodium-base642bin.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-base642bin" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_base642bin</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_base642bin</span> &mdash; <span class="dc-title">Decodes a base64-encoded string into raw binary.</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-base642bin-description">
  ...
  <p class="para rdfs-comment">
   Converts a base64 encoded string into raw binary. Unlike <span class="function"><a href="function.base64-decode.php" class="function">base64_decode()</a></span>,
   <span class="function"><strong>sodium_base642bin()</strong></span> is constant-time (a property that is important for any code that
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-base642bin-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      <span class="type"><a href="language.types.string.php" class="type string">string</a></span>; Encoded string.
     </p>
    </dd>
  ...
  <p class="para">
   Decoded string.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-base642bin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-base642bin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-base642bin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-base642bin.php">＋<small>add a note</small></a></span>
