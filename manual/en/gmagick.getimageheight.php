...
<head>
  ...
  <title>PHP: Gmagick::getimageheight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageheight.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageheight.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageheight.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageheight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageheight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageheight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageheight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageheight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageheight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageheight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageheight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageheight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageheight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageheight.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageheight - Manual" />
<meta name="twitter:description" content="Returns the image height" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageheight - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagehistogram.php">
          Gmagick::getimagehistogram &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagegreenprimary.php">
          &laquo; Gmagick::getimagegreenprimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageheight.php' selected="selected">English</option>
            <option value='de/gmagick.getimageheight.php'>German</option>
            <option value='es/gmagick.getimageheight.php'>Spanish</option>
            <option value='fr/gmagick.getimageheight.php'>French</option>
            <option value='it/gmagick.getimageheight.php'>Italian</option>
            <option value='ja/gmagick.getimageheight.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageheight.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageheight.php'>Russian</option>
            <option value='tr/gmagick.getimageheight.php'>Turkish</option>
            <option value='uk/gmagick.getimageheight.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageheight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageheight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageheight</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageheight</span> &mdash; <span class="dc-title">Returns the image height</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageheight-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageheight</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageheight-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageheight-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageheight-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageheight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageheight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageheight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageheight.php">＋<small>add a note</small></a></span>
