...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.grapheme-strstr.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.grapheme-strrpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.grapheme-substr.php">
...
<meta name="Description" content="Returns part of haystack string from the first occurrence of needle to the end of haystack" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: grapheme_strstr - Manual" />
<meta name="twitter:description" content="Returns part of haystack string from the first occurrence of needle to the end of haystack" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: grapheme_strstr - Manual" />
<meta itemprop="description" content="Returns part of haystack string from the first occurrence of needle to the end of haystack" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns part of haystack string from the first occurrence of needle to the end of haystack" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.grapheme-strstr.php' selected="selected">English</option>
            <option value='de/function.grapheme-strstr.php'>German</option>
            <option value='es/function.grapheme-strstr.php'>Spanish</option>
            <option value='fr/function.grapheme-strstr.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">grapheme_strstr</span> &mdash; <span class="dc-title">Returns part of haystack string from the first occurrence of needle to the end of haystack</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.grapheme-strstr-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, <span class="function"><strong>grapheme_strstr()</strong></span> returns the part of the
       <code class="parameter">haystack</code> before the first occurrence of the <code class="parameter">needle</code> (excluding the <code class="parameter">needle</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.grapheme-strstr-examples">
  ...
  <div class="example" id="example-2689">
   <p><strong>Example #1 <span class="function"><strong>grapheme_strstr()</strong></span> example</strong></p>
    ...
    <li>
     <a href="http://unicode.org/reports/tr29/#Grapheme_Cluster_Boundaries" class="link external">&raquo;&nbsp;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/grapheme/grapheme-strstr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.grapheme-strstr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.grapheme-strstr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.grapheme-strstr.php">＋<small>add a note</small></a></span>
