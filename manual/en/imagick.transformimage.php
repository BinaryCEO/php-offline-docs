...
<head>
  ...
  <title>PHP: Imagick::transformImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.transformimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.transformimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transformimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transformimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.transformimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.transformimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.transformimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.transformimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.transformimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.transformimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.transformimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.transformimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.transformimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.transformimage.php" hreflang="zh">
...
<meta name="Description" content="Convenience method for setting crop size and the image geometry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::transformImage - Manual" />
<meta name="twitter:description" content="Convenience method for setting crop size and the image geometry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::transformImage - Manual" />
<meta itemprop="description" content="Convenience method for setting crop size and the image geometry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convenience method for setting crop size and the image geometry" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.transformimagecolorspace.php">
          Imagick::transformImageColorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.tostring.php">
          &laquo; Imagick::__toString        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.transformimage.php' selected="selected">English</option>
            <option value='de/imagick.transformimage.php'>German</option>
            <option value='es/imagick.transformimage.php'>Spanish</option>
            <option value='fr/imagick.transformimage.php'>French</option>
            <option value='it/imagick.transformimage.php'>Italian</option>
            <option value='ja/imagick.transformimage.php'>Japanese</option>
            <option value='pt_BR/imagick.transformimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.transformimage.php'>Russian</option>
            <option value='tr/imagick.transformimage.php'>Turkish</option>
            <option value='uk/imagick.transformimage.php'>Ukrainian</option>
            <option value='zh/imagick.transformimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.transformimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::transformImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::transformImage</span> &mdash; <span class="dc-title">Convenience method for setting crop size and the image geometry</span></p>

 </div>

 <div id="imagick.transformimage-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.transformimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::transformImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$crop</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$geometry</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.transformimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">crop</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">geometry</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.transformimage-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #DD0000">"black"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$new_image </span><span style="color: #007700">= </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">transformImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"100x100"</span><span style="color: #007700">, </span><span style="color: #DD0000">"100x100"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$new_image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImage</span><span style="color: #007700">(</span><span style="color: #DD0000">'test_out.jpg'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.transformimage-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.thumbnailimage.php" class="function" rel="rdfs-seeAlso">Imagick::thumbnailImage()</a> - Changes the size of an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/transformimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.transformimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.transformimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transformimage.php">＋<small>add a note</small></a></span>
