...
<head>
  ...
  <title>PHP: Imagick::setImageExtent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageextent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageextent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageextent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagedispose.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagefilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageextent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageextent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageextent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageextent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageextent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageextent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageextent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageextent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageextent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageextent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageextent.php" hreflang="zh">
...
<meta name="Description" content="Sets the image size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageExtent - Manual" />
<meta name="twitter:description" content="Sets the image size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageExtent - Manual" />
<meta itemprop="description" content="Sets the image size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagefilename.php">
          Imagick::setImageFilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagedispose.php">
          &laquo; Imagick::setImageDispose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageextent.php' selected="selected">English</option>
            <option value='de/imagick.setimageextent.php'>German</option>
            <option value='es/imagick.setimageextent.php'>Spanish</option>
            <option value='fr/imagick.setimageextent.php'>French</option>
            <option value='it/imagick.setimageextent.php'>Italian</option>
            <option value='ja/imagick.setimageextent.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageextent.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageextent.php'>Russian</option>
            <option value='tr/imagick.setimageextent.php'>Turkish</option>
            <option value='uk/imagick.setimageextent.php'>Ukrainian</option>
            <option value='zh/imagick.setimageextent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageextent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageExtent</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageExtent</span> &mdash; <span class="dc-title">Sets the image size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageextent-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageExtent</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageextent-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageextent-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageextent-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageextent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageextent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageextent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageextent.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94148">  <div class="votes">
    <div id="Vu94148">
    <a href="/manual/vote-note.php?id=94148&amp;page=imagick.setimageextent&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94148">
    <a href="/manual/vote-note.php?id=94148&amp;page=imagick.setimageextent&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94148" title="64% like this...">
    4
    </div>
  </div>
  <a href="#94148" class="name">
  <strong class="user"><em>tim at komta dot com</em></strong></a><a class="genanchor" href="#94148"> &para;</a><div class="date" title="2009-10-19 12:02"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94148">
<div class="phpcode"><code><span class="html">This function actually sets the width and height of the image (in pixels).
<br />
<br />Took me forever to figure this out.</span></code></div>
  </div>
 </div>
  <div class="note" id="116012">  <div class="votes">
    <div id="Vu116012">
    <a href="/manual/vote-note.php?id=116012&amp;page=imagick.setimageextent&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116012">
    <a href="/manual/vote-note.php?id=116012&amp;page=imagick.setimageextent&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116012" title="66% like this...">
    2
    </div>
  </div>
  <a href="#116012" class="name">
  <strong class="user"><em>charles dot p dot hall at gmail dot com</em></strong></a><a class="genanchor" href="#116012"> &para;</a><div class="date" title="2014-10-29 05:31"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116012">
<div class="phpcode"><code><span class="html">In other graphics systems I have seen this referred to as Canvas size or re-dimensioning. It changes the dimension of the image without re-scaling. Added pixels appear black, removed pixels are simply cropped away.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageextent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageextent.php">＋<small>add a note</small></a></div>
