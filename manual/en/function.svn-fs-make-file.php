...
<head>
  ...
  <title>PHP: svn_fs_make_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-fs-make-file.php">
 <link rel="shorturl" href="https://www.php.net/svn-fs-make-file">
 <link rel="alternate" href="https://www.php.net/svn-fs-make-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-fs-make-dir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-node-created-rev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-fs-make-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-fs-make-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-fs-make-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-fs-make-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-fs-make-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-fs-make-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-fs-make-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-fs-make-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-fs-make-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-fs-make-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-fs-make-file.php" hreflang="zh">
...
<meta name="Description" content="Creates a new empty file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_fs_make_file - Manual" />
<meta name="twitter:description" content="Creates a new empty file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_fs_make_file - Manual" />
<meta itemprop="description" content="Creates a new empty file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new empty file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-fs-node-created-rev.php">
          svn_fs_node_created_rev &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-fs-make-dir.php">
          &laquo; svn_fs_make_dir        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-fs-make-file.php' selected="selected">English</option>
            <option value='de/function.svn-fs-make-file.php'>German</option>
            <option value='es/function.svn-fs-make-file.php'>Spanish</option>
            <option value='fr/function.svn-fs-make-file.php'>French</option>
            <option value='it/function.svn-fs-make-file.php'>Italian</option>
            <option value='ja/function.svn-fs-make-file.php'>Japanese</option>
            <option value='pt_BR/function.svn-fs-make-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-fs-make-file.php'>Russian</option>
            <option value='tr/function.svn-fs-make-file.php'>Turkish</option>
            <option value='uk/function.svn-fs-make-file.php'>Ukrainian</option>
            <option value='zh/function.svn-fs-make-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-fs-make-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_fs_make_file</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_fs_make_file</span> &mdash; <span class="dc-title">Creates a new empty file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-fs-make-file-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_fs_make_file</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$root</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.svn-fs-make-file-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.svn-fs-make-file-returnvalues">
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-fs-make-file-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-fs-make-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-fs-make-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-fs-make-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-fs-make-file.php">＋<small>add a note</small></a></span>
