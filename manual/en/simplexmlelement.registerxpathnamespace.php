...
<head>
  ...
  <title>PHP: SimpleXMLElement::registerXPathNamespace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.simplexmlelement.php">
 <link rel="prev" href="https://www.php.net/manual/en/simplexmlelement.next.php">
 <link rel="next" href="https://www.php.net/manual/en/simplexmlelement.rewind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/simplexmlelement.registerxpathnamespace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/simplexmlelement.registerxpathnamespace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/simplexmlelement.registerxpathnamespace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/simplexmlelement.registerxpathnamespace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/simplexmlelement.registerxpathnamespace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/simplexmlelement.registerxpathnamespace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/simplexmlelement.registerxpathnamespace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/simplexmlelement.registerxpathnamespace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/simplexmlelement.registerxpathnamespace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/simplexmlelement.registerxpathnamespace.php" hreflang="zh">
...
<meta name="Description" content="Creates a prefix/ns context for the next XPath query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SimpleXMLElement::registerXPathNamespace - Manual" />
<meta name="twitter:description" content="Creates a prefix/ns context for the next XPath query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SimpleXMLElement::registerXPathNamespace - Manual" />
<meta itemprop="description" content="Creates a prefix/ns context for the next XPath query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a prefix/ns context for the next XPath query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="simplexmlelement.rewind.php">
          SimpleXMLElement::rewind &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="simplexmlelement.next.php">
          &laquo; SimpleXMLElement::next        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/simplexmlelement.registerxpathnamespace.php' selected="selected">English</option>
            <option value='de/simplexmlelement.registerxpathnamespace.php'>German</option>
            <option value='es/simplexmlelement.registerxpathnamespace.php'>Spanish</option>
            <option value='fr/simplexmlelement.registerxpathnamespace.php'>French</option>
            <option value='it/simplexmlelement.registerxpathnamespace.php'>Italian</option>
            <option value='ja/simplexmlelement.registerxpathnamespace.php'>Japanese</option>
            <option value='pt_BR/simplexmlelement.registerxpathnamespace.php'>Brazilian Portuguese</option>
            <option value='ru/simplexmlelement.registerxpathnamespace.php'>Russian</option>
            <option value='tr/simplexmlelement.registerxpathnamespace.php'>Turkish</option>
            <option value='uk/simplexmlelement.registerxpathnamespace.php'>Ukrainian</option>
            <option value='zh/simplexmlelement.registerxpathnamespace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="simplexmlelement.registerxpathnamespace" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-simplexmlelement.registerxpathnamespace-examples">
  ...
  <p class="para">
   <div class="example" id="example-5892">
    <p><strong>Example #1 Setting a namespace prefix to use in an XPath query</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="simplexmlelement.getnamespaces.php" class="methodname" rel="rdfs-seeAlso">SimpleXMLElement::getNamespaces()</a> - Returns namespaces used in document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/simplexml/simplexmlelement/registerXPathNamespace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsimplexmlelement.registerxpathnamespace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=simplexmlelement.registerxpathnamespace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="101816">  <div class="votes">
    <div id="Vu101816">
    <a href="/manual/vote-note.php?id=101816&amp;page=simplexmlelement.registerxpathnamespace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101816">
    <a href="/manual/vote-note.php?id=101816&amp;page=simplexmlelement.registerxpathnamespace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101816" title="51% like this...">
    3
    </div>
  </div>
  <a href="#101816" class="name">
  <strong class="user"><em>Lea Hayes</em></strong></a><a class="genanchor" href="#101816"> &para;</a><div class="date" title="2011-01-12 09:56"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101816">
<div class="phpcode"><code><span class="html">Looks like you have to use registerXPathNamespace for each node when using XPath:
<br />
<br /><span class="default">&lt;?php
<br />$xml </span><span class="keyword">= </span><span class="default">simplexml_load_file</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">);
<br />
<br /></span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">registerXPathNamespace</span><span class="keyword">(</span><span class="string">'test'</span><span class="keyword">, </span><span class="string">'<a href="http://example.com" rel="nofollow" target="_blank">http://example.com</a>'</span><span class="keyword">);
<br />
<br /></span><span class="default">$shopping_element </span><span class="keyword">= </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">xpath</span><span class="keyword">(</span><span class="string">'test:shopping-list'</span><span class="keyword">);
<br />
<br /></span><span class="comment">// Breaks with out the following line:
<br />
<br /></span><span class="default">$shopping_element</span><span class="keyword">-&gt;</span><span class="default">registerXPathNamespace</span><span class="keyword">(</span><span class="string">'test'</span><span class="keyword">, </span><span class="string">'<a href="http://example.com" rel="nofollow" target="_blank">http://example.com</a>'</span><span class="keyword">);
<br />
<br /></span><span class="default">$fruit </span><span class="keyword">= </span><span class="default">$shopping_element</span><span class="keyword">-&gt;</span><span class="default">xpath</span><span class="keyword">(</span><span class="string">'test:fruit'</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=simplexmlelement.registerxpathnamespace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/simplexmlelement.registerxpathnamespace.php">＋<small>add a note</small></a></div>
