...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-get-proto-info.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-get-host-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-get-server-info.php">
...
<meta name="Description" content="Get MySQL protocol info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_get_proto_info - Manual" />
<meta name="twitter:description" content="Get MySQL protocol info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_get_proto_info - Manual" />
<meta itemprop="description" content="Get MySQL protocol info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get MySQL protocol info" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-get-proto-info.php' selected="selected">English</option>
            <option value='de/function.mysql-get-proto-info.php'>German</option>
            <option value='es/function.mysql-get-proto-info.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_get_proto_info</span> &mdash; <span class="dc-title">Get MySQL protocol info</span></p>
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-get-proto-info-returnvalues">
  ...
  <p class="para">
   Returns the MySQL protocol on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-get-proto-info-examples">
  ...
  <p class="para">
   <div class="example" id="example-1907">
    <p><strong>Example #1 <span class="function"><strong>mysql_get_proto_info()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">MySQL protocol version: 10</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-get-server-info.php" class="function" rel="rdfs-seeAlso">mysql_get_server_info()</a> - Get MySQL server info</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-get-proto-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-get-proto-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-get-proto-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-get-proto-info.php">＋<small>add a note</small></a></span>
