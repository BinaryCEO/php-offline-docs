...
<head>
  ...
  <title>PHP: svn_fs_txn_root - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-fs-txn-root.php">
 <link rel="shorturl" href="https://www.php.net/svn-fs-txn-root">
 <link rel="alternate" href="https://www.php.net/svn-fs-txn-root" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-fs-revision-root.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-youngest-rev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-fs-txn-root.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-fs-txn-root.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-fs-txn-root.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-fs-txn-root.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-fs-txn-root.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-fs-txn-root.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-fs-txn-root.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-fs-txn-root.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-fs-txn-root.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-fs-txn-root.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-fs-txn-root.php" hreflang="zh">
...
<meta name="Description" content="Creates and returns a transaction root" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_fs_txn_root - Manual" />
<meta name="twitter:description" content="Creates and returns a transaction root" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_fs_txn_root - Manual" />
<meta itemprop="description" content="Creates and returns a transaction root" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates and returns a transaction root" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-fs-youngest-rev.php">
          svn_fs_youngest_rev &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-fs-revision-root.php">
          &laquo; svn_fs_revision_root        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-fs-txn-root.php' selected="selected">English</option>
            <option value='de/function.svn-fs-txn-root.php'>German</option>
            <option value='es/function.svn-fs-txn-root.php'>Spanish</option>
            <option value='fr/function.svn-fs-txn-root.php'>French</option>
            <option value='it/function.svn-fs-txn-root.php'>Italian</option>
            <option value='ja/function.svn-fs-txn-root.php'>Japanese</option>
            <option value='pt_BR/function.svn-fs-txn-root.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-fs-txn-root.php'>Russian</option>
            <option value='tr/function.svn-fs-txn-root.php'>Turkish</option>
            <option value='uk/function.svn-fs-txn-root.php'>Ukrainian</option>
            <option value='zh/function.svn-fs-txn-root.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-fs-txn-root" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_fs_txn_root</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_fs_txn_root</span> &mdash; <span class="dc-title">Creates and returns a transaction root</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-fs-txn-root-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_fs_txn_root</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$txn</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-fs-txn-root-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-fs-txn-root.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-fs-txn-root%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-fs-txn-root&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-fs-txn-root.php">＋<small>add a note</small></a></span>
