...
<head>
  ...
  <title>PHP: ZipArchive::addPattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.addpattern.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.addpattern.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.addpattern.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.addglob.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.clearerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.addpattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.addpattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.addpattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.addpattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.addpattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.addpattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.addpattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.addpattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.addpattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.addpattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.addpattern.php" hreflang="zh">
...
<meta name="Description" content="Add files from a directory by PCRE pattern" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::addPattern - Manual" />
<meta name="twitter:description" content="Add files from a directory by PCRE pattern" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::addPattern - Manual" />
<meta itemprop="description" content="Add files from a directory by PCRE pattern" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add files from a directory by PCRE pattern" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.clearerror.php">
          ZipArchive::clearError &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.addglob.php">
          &laquo; ZipArchive::addGlob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.addpattern.php' selected="selected">English</option>
            <option value='de/ziparchive.addpattern.php'>German</option>
            <option value='es/ziparchive.addpattern.php'>Spanish</option>
            <option value='fr/ziparchive.addpattern.php'>French</option>
            <option value='it/ziparchive.addpattern.php'>Italian</option>
            <option value='ja/ziparchive.addpattern.php'>Japanese</option>
            <option value='pt_BR/ziparchive.addpattern.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.addpattern.php'>Russian</option>
            <option value='tr/ziparchive.addpattern.php'>Turkish</option>
            <option value='uk/ziparchive.addpattern.php'>Ukrainian</option>
            <option value='zh/ziparchive.addpattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.addpattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::addPattern</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL zip &gt;= 1.9.0)</p><p class="refpurpose"><span class="refname">ZipArchive::addPattern</span> &mdash; <span class="dc-title">Add files from a directory by PCRE pattern</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-ziparchive.addpattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::addPattern</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code><span class="initializer"> = &quot;.&quot;</span></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$options</code><span class="initializer"> = []</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Add files from a directory which match the regular expression <code class="parameter">pattern</code>.
   The operation is not recursive. The pattern will be matched against the file name only.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-ziparchive.addpattern-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      A <a href="book.pcre.php" class="link">PCRE</a> pattern against which files will be matched.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
      An associative array of options accepted by <span class="methodname"><a href="ziparchive.addglob.php" class="methodname">ZipArchive::addGlob()</a></span>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.addpattern-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$ret </span><span style="color: #007700">= </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'application.zip'</span><span style="color: #007700">, </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">CREATE </span><span style="color: #007700">| </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">OVERWRITE</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$ret </span><span style="color: #007700">!== </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">'Failed with code %d'</span><span style="color: #007700">, </span><span style="color: #0000BB">$ret</span><span style="color: #007700">);<br />} else {<br />    </span><span style="color: #0000BB">$directory </span><span style="color: #007700">= </span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">'.'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$options </span><span style="color: #007700">= array(</span><span style="color: #DD0000">'add_path' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'sources/'</span><span style="color: #007700">, </span><span style="color: #DD0000">'remove_path' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$directory</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addPattern</span><span style="color: #007700">(</span><span style="color: #DD0000">'/\.(?:php|txt)$/'</span><span style="color: #007700">, </span><span style="color: #0000BB">$directory</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.addpattern-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="ziparchive.addglob.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::addGlob()</a> - Add files from a directory by glob pattern</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/addpattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.addpattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.addpattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.addpattern.php">＋<small>add a note</small></a></span>
