...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-channel.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/swoole-buffer.write.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-channel.construct.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-channel.php' selected="selected">English</option>
            <option value='de/class.swoole-channel.php'>German</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-channel.construct.php">Swoole\Channel::__construct</a> — Construct a Swoole Channel</li><li><a href="swoole-channel.destruct.php">Swoole\Channel::__destruct</a> — Destruct a Swoole channel.</li><li><a href="swoole-channel.pop.php">Swoole\Channel::pop</a> — Read and pop data from swoole channel.</li><li><a href="swoole-channel.push.php">Swoole\Channel::push</a> — Write and push data into Swoole channel.</li><li><a href="swoole-channel.stats.php">Swoole\Channel::stats</a> — Get stats of swoole channel.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.channel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-channel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-channel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-channel.php">＋<small>add a note</small></a></span>
