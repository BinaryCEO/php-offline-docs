...
<head>
  ...
  <title>PHP: UI\Controls\Entry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-entry.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-entry">
 <link rel="alternate" href="https://www.php.net/ui-controls-entry" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-label.settext.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-entry.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-entry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-entry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-entry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-entry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-entry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-entry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-entry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-entry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-entry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-entry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-entry.php" hreflang="zh">
...
<meta name="Description" content="Entry Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Entry - Manual" />
<meta name="twitter:description" content="Entry Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Entry - Manual" />
<meta itemprop="description" content="Entry Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Entry Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-entry.construct.php">
          UI\Controls\Entry::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-label.settext.php">
          &laquo; UI\Controls\Label::setText        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-entry.php' selected="selected">English</option>
            <option value='de/class.ui-controls-entry.php'>German</option>
            <option value='es/class.ui-controls-entry.php'>Spanish</option>
            <option value='fr/class.ui-controls-entry.php'>French</option>
            <option value='it/class.ui-controls-entry.php'>Italian</option>
            <option value='ja/class.ui-controls-entry.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-entry.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-entry.php'>Russian</option>
            <option value='tr/class.ui-controls-entry.php'>Turkish</option>
            <option value='uk/class.ui-controls-entry.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-entry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-entry" class="reference">

 <h1 class="title">Entry Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-entry.intro">
  ...
  <div class="section" id="ui-controls-entry.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Entry</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-entry.php#ui-controls-entry.constants.normal"><var class="varname">Normal</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-entry.php#ui-controls-entry.constants.password"><var class="varname">Password</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.ui-controls-entry.php#ui-controls-entry.constants.search"><var class="varname">Search</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Constructor */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-entry.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code><span class="initializer"> = UI\Controls\Entry::Normal</span></span>)</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-entry.gettext.php" class="methodname">getText</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-entry.isreadonly.php" class="methodname">isReadOnly</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-entry.onchange.php" class="methodname">onChange</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-entry.setreadonly.php" class="methodname">setReadOnly</a></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$readOnly</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-entry.settext.php" class="methodname">setText</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-entry.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>

    
     <dt id="ui-controls-entry.constants.normal"><strong><code><a href="class.ui-controls-entry.php#ui-controls-entry.constants.normal">UI\Controls\Entry::Normal</a></code></strong></dt>
     <dd>
      <p class="para">A normal single line entry</p>
     </dd>
    

    
     <dt id="ui-controls-entry.constants.password"><strong><code><a href="class.ui-controls-entry.php#ui-controls-entry.constants.password">UI\Controls\Entry::Password</a></code></strong></dt>
     <dd>
      <p class="para">A password entry</p>
     </dd>
    

    
     <dt id="ui-controls-entry.constants.search"><strong><code><a href="class.ui-controls-entry.php#ui-controls-entry.constants.search">UI\Controls\Entry::Search</a></code></strong></dt>
     <dd>
      <p class="para">A search entry</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-entry.construct.php">UI\Controls\Entry::__construct</a> — Construct a new Entry</li><li><a href="ui-controls-entry.gettext.php">UI\Controls\Entry::getText</a> — Get Text</li><li><a href="ui-controls-entry.isreadonly.php">UI\Controls\Entry::isReadOnly</a> — Detect Read Only</li><li><a href="ui-controls-entry.onchange.php">UI\Controls\Entry::onChange</a> — Change Handler</li><li><a href="ui-controls-entry.setreadonly.php">UI\Controls\Entry::setReadOnly</a> — Set Read Only</li><li><a href="ui-controls-entry.settext.php">UI\Controls\Entry::setText</a> — Set Text</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.entry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-entry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-entry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-entry.php">＋<small>add a note</small></a></span>
