...
<head>
  ...
  <title>PHP: MongoDB\BSON\toPHP - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mongodb.bson-tophp.php">
 <link rel="shorturl" href="https://www.php.net/mongodb.bson-tophp">
 <link rel="alternate" href="https://www.php.net/mongodb.bson-tophp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.bson.functions.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mongodb.bson-tojson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mongodb.bson-torelaxedextendedjson.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mongodb.bson-tophp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mongodb.bson-tophp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mongodb.bson-tophp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mongodb.bson-tophp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mongodb.bson-tophp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mongodb.bson-tophp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mongodb.bson-tophp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mongodb.bson-tophp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mongodb.bson-tophp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mongodb.bson-tophp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mongodb.bson-tophp.php" hreflang="zh">
...
<meta name="Description" content="Returns the PHP representation of a BSON value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\toPHP - Manual" />
<meta name="twitter:description" content="Returns the PHP representation of a BSON value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\toPHP - Manual" />
<meta itemprop="description" content="Returns the PHP representation of a BSON value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the PHP representation of a BSON value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mongodb.bson-torelaxedextendedjson.php">
          MongoDB\BSON\toRelaxedExtendedJSON &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mongodb.bson-tojson.php">
          &laquo; MongoDB\BSON\toJSON        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mongodb.bson-tophp.php' selected="selected">English</option>
            <option value='de/function.mongodb.bson-tophp.php'>German</option>
            <option value='es/function.mongodb.bson-tophp.php'>Spanish</option>
            <option value='fr/function.mongodb.bson-tophp.php'>French</option>
            <option value='it/function.mongodb.bson-tophp.php'>Italian</option>
            <option value='ja/function.mongodb.bson-tophp.php'>Japanese</option>
            <option value='pt_BR/function.mongodb.bson-tophp.php'>Brazilian Portuguese</option>
            <option value='ru/function.mongodb.bson-tophp.php'>Russian</option>
            <option value='tr/function.mongodb.bson-tophp.php'>Turkish</option>
            <option value='uk/function.mongodb.bson-tophp.php'>Ukrainian</option>
            <option value='zh/function.mongodb.bson-tophp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mongodb.bson-tophp" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="mongodb.persistence.php" class="xref">Persisting Data</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/functions/bson/tophp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mongodb.bson-tophp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mongodb.bson-tophp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mongodb.bson-tophp.php">＋<small>add a note</small></a></span>
