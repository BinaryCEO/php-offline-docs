...
<head>
  ...
  <title>PHP: MongoDB\Driver\ReadConcern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-readconcern.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-readconcern">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-readconcern" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-readpreference.gettagsets.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-readconcern.bsonserialize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-readconcern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-readconcern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-readconcern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-readconcern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-readconcern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-readconcern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-readconcern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-readconcern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-readconcern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-readconcern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-readconcern.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\ReadConcern class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ReadConcern - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\ReadConcern class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ReadConcern - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\ReadConcern class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\ReadConcern class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-readconcern.bsonserialize.php">
          MongoDB\Driver\ReadConcern::bsonSerialize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-readpreference.gettagsets.php">
          &laquo; MongoDB\Driver\ReadPreference::getTagSets        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-readconcern.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-readconcern.php'>German</option>
            <option value='es/class.mongodb-driver-readconcern.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-readconcern.php'>French</option>
            <option value='it/class.mongodb-driver-readconcern.php'>Italian</option>
            <option value='ja/class.mongodb-driver-readconcern.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-readconcern.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-readconcern.php'>Russian</option>
            <option value='tr/class.mongodb-driver-readconcern.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-readconcern.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-readconcern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-readconcern" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-readconcern.bsonserialize.php">MongoDB\Driver\ReadConcern::bsonSerialize</a> — Returns an object for BSON serialization</li><li><a href="mongodb-driver-readconcern.construct.php">MongoDB\Driver\ReadConcern::__construct</a> — Create a new ReadConcern</li><li><a href="mongodb-driver-readconcern.getlevel.php">MongoDB\Driver\ReadConcern::getLevel</a> — Returns the ReadConcern's &quot;level&quot; option</li><li><a href="mongodb-driver-readconcern.isdefault.php">MongoDB\Driver\ReadConcern::isDefault</a> — Checks if this is the default read concern</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/readconcern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-readconcern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-readconcern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-readconcern.php">＋<small>add a note</small></a></span>
