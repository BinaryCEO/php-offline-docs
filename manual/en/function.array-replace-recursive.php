...
<head>
  ...
  <title>PHP: array_replace_recursive - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-replace-recursive.php">
 <link rel="shorturl" href="https://www.php.net/array-replace-recursive">
 <link rel="alternate" href="https://www.php.net/array-replace-recursive" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-replace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-reverse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-replace-recursive.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-replace-recursive.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-replace-recursive.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-replace-recursive.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-replace-recursive.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-replace-recursive.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-replace-recursive.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-replace-recursive.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-replace-recursive.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-replace-recursive.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-replace-recursive.php" hreflang="zh">
...
<meta name="Description" content="Replaces elements from passed arrays into the first array recursively" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_replace_recursive - Manual" />
<meta name="twitter:description" content="Replaces elements from passed arrays into the first array recursively" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_replace_recursive - Manual" />
<meta itemprop="description" content="Replaces elements from passed arrays into the first array recursively" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces elements from passed arrays into the first array recursively" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-replace-recursive.php' selected="selected">English</option>
            <option value='de/function.array-replace-recursive.php'>German</option>
            <option value='es/function.array-replace-recursive.php'>Spanish</option>
            <option value='fr/function.array-replace-recursive.php'>French</option>
            <option value='it/function.array-replace-recursive.php'>Italian</option>
            <option value='ja/function.array-replace-recursive.php'>Japanese</option>
            <option value='pt_BR/function.array-replace-recursive.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-replace-recursive.php'>Russian</option>
            <option value='tr/function.array-replace-recursive.php'>Turkish</option>
            <option value='uk/function.array-replace-recursive.php'>Ukrainian</option>
            <option value='zh/function.array-replace-recursive.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-replace-recursive" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-merge-recursive.php" class="function" rel="rdfs-seeAlso">array_merge_recursive()</a> - Merge one or more arrays recursively</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-replace-recursive.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-replace-recursive%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-replace-recursive&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-replace-recursive.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124705">  <div class="votes">
    <div id="Vu124705">
    <a href="/manual/vote-note.php?id=124705&amp;page=function.array-replace-recursive&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124705">
    <a href="/manual/vote-note.php?id=124705&amp;page=function.array-replace-recursive&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124705" title="68% like this...">
    9
    </div>
  </div>
  <a href="#124705" class="name">
  <strong class="user"><em>Pau Prat Torrella</em></strong></a><a class="genanchor" href="#124705"> &para;</a><div class="date" title="2020-02-10 05:14"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124705">
<div class="phpcode"><code><span class="html">Note that function will NOT replace a sub-tree from you $array1 if its value in $array2 is an empty array. <br />Even tho the key for this dimension is technically 'set'. <br /><br />(I suppose it treats it as just another recursive level to dive in, finding no key to compare, backtracking while leaving this sub-tree alone)<br /><br />For example:<br /><br />$array1  = ['first' =&gt; ['second' =&gt; 'hello']];<br />$array2  = ['first' =&gt; []];              <br />$result = array_replace_recursive($array1, $array2);<br /><br />$result is still: ['first' =&gt; ['second' =&gt; 'hello']].</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array-replace-recursive&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-replace-recursive.php">＋<small>add a note</small></a></div>
