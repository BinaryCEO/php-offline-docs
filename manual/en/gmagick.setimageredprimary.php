...
<head>
  ...
  <title>PHP: Gmagick::setimageredprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimageprofile.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagerenderingintent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimageredprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimageredprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimageredprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimageredprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimageredprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimageredprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimageredprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimageredprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimageredprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimageredprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimageredprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimageredprimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity red primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimageredprimary - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimagerenderingintent.php">
          Gmagick::setimagerenderingintent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimageprofile.php">
          &laquo; Gmagick::setimageprofile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimageredprimary.php' selected="selected">English</option>
            <option value='de/gmagick.setimageredprimary.php'>German</option>
            <option value='es/gmagick.setimageredprimary.php'>Spanish</option>
            <option value='fr/gmagick.setimageredprimary.php'>French</option>
            <option value='it/gmagick.setimageredprimary.php'>Italian</option>
            <option value='ja/gmagick.setimageredprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimageredprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimageredprimary.php'>Russian</option>
            <option value='tr/gmagick.setimageredprimary.php'>Turkish</option>
            <option value='uk/gmagick.setimageredprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.setimageredprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimageredprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimageredprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimageredprimary</span> &mdash; <span class="dc-title">Sets the image chromaticity red primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimageredprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimageredprimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimageredprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimageredprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimageredprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimageredprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimageredprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimageredprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimageredprimary.php">＋<small>add a note</small></a></span>
