...
<head>
  ...
  <title>PHP: SolrQuery::setTermsUpperBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsupperbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsupperbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsupperbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermssort.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settimeallowed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsupperbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsupperbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsupperbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsupperbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsupperbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsupperbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsupperbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsupperbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsupperbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsupperbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsupperbound.php" hreflang="zh">
...
<meta name="Description" content="Sets the term to stop at" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsUpperBound - Manual" />
<meta name="twitter:description" content="Sets the term to stop at" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsUpperBound - Manual" />
<meta itemprop="description" content="Sets the term to stop at" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the term to stop at" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settimeallowed.php">
          SolrQuery::setTimeAllowed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermssort.php">
          &laquo; SolrQuery::setTermsSort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsupperbound.php' selected="selected">English</option>
            <option value='de/solrquery.settermsupperbound.php'>German</option>
            <option value='es/solrquery.settermsupperbound.php'>Spanish</option>
            <option value='fr/solrquery.settermsupperbound.php'>French</option>
            <option value='it/solrquery.settermsupperbound.php'>Italian</option>
            <option value='ja/solrquery.settermsupperbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsupperbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsupperbound.php'>Russian</option>
            <option value='tr/solrquery.settermsupperbound.php'>Turkish</option>
            <option value='uk/solrquery.settermsupperbound.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsupperbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsupperbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsUpperBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsUpperBound</span> &mdash; <span class="dc-title">Sets the term to stop at</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsupperbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsUpperBound</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$upperBound</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsupperbound-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">upperBound</code></dt>
     <dd>
      <p class="para">
       The term to stop at
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsupperbound-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsupperbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsupperbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsupperbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsupperbound.php">＋<small>add a note</small></a></span>
