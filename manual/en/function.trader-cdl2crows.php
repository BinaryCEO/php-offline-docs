...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdl2crows.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cci.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdl3blackcrows.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdl2crows.php' selected="selected">English</option>
            <option value='de/function.trader-cdl2crows.php'>German</option>
            <option value='es/function.trader-cdl2crows.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdl2crows</span> &mdash; <span class="dc-title">Two Crows</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdl2crows-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdl2crows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdl2crows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdl2crows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdl2crows.php">＋<small>add a note</small></a></span>
