...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-db-name.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-data-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-db-query.php">
...
<meta name="Description" content="Retrieves database name from the call to mysql_list_dbs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_db_name - Manual" />
<meta name="twitter:description" content="Retrieves database name from the call to mysql_list_dbs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_db_name - Manual" />
<meta itemprop="description" content="Retrieves database name from the call to mysql_list_dbs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves database name from the call to mysql_list_dbs" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-db-name.php' selected="selected">English</option>
            <option value='de/function.mysql-db-name.php'>German</option>
            <option value='es/function.mysql-db-name.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_db_name</span> &mdash; <span class="dc-title">Retrieves database name from the call to <span class="function"><a href="function.mysql-list-dbs.php" class="function">mysql_list_dbs()</a></span></span></p>
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li>Query: <code class="literal">SELECT DATABASE()</code></li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mysql-db-name-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The result pointer from a call to <span class="function"><a href="function.mysql-list-dbs.php" class="function">mysql_list_dbs()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-db-name-returnvalues">
  ...
  <p class="para">
   ...
   is returned, use <span class="function"><a href="function.mysql-error.php" class="function">mysql_error()</a></span> to determine the nature
   of the error.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-db-name-examples">
  ...
  <p class="para">
   <div class="example" id="example-1883">
    <p><strong>Example #1 <span class="function"><strong>mysql_db_name()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-tablename.php" class="function" rel="rdfs-seeAlso">mysql_tablename()</a> - Get table name of field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-db-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-db-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-db-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-db-name.php">＋<small>add a note</small></a></span>
