...
<head>
  ...
  <title>PHP: ImagickDraw::skewX - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.skewx.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.skewx.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.skewx.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setviewbox.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.skewy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.skewx.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.skewx.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.skewx.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.skewx.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.skewx.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.skewx.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.skewx.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.skewx.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.skewx.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.skewx.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.skewx.php" hreflang="zh">
...
<meta name="Description" content="Skews the current coordinate system in the horizontal direction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::skewX - Manual" />
<meta name="twitter:description" content="Skews the current coordinate system in the horizontal direction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::skewX - Manual" />
<meta itemprop="description" content="Skews the current coordinate system in the horizontal direction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Skews the current coordinate system in the horizontal direction" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.skewy.php">
          ImagickDraw::skewY &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setviewbox.php">
          &laquo; ImagickDraw::setViewbox        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.skewx.php' selected="selected">English</option>
            <option value='de/imagickdraw.skewx.php'>German</option>
            <option value='es/imagickdraw.skewx.php'>Spanish</option>
            <option value='fr/imagickdraw.skewx.php'>French</option>
            <option value='it/imagickdraw.skewx.php'>Italian</option>
            <option value='ja/imagickdraw.skewx.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.skewx.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.skewx.php'>Russian</option>
            <option value='tr/imagickdraw.skewx.php'>Turkish</option>
            <option value='uk/imagickdraw.skewx.php'>Ukrainian</option>
            <option value='zh/imagickdraw.skewx.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.skewx" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::skewX</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::skewX</span> &mdash; <span class="dc-title">Skews the current coordinate system in the horizontal direction</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.skewx-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::skewX</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.skewx-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.skewx-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3197">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/skewx.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.skewx%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.skewx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.skewx.php">＋<small>add a note</small></a></span>
