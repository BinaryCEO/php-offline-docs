...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightRegexPattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightregexslop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightregexpattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightregexpattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightregexpattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightregexpattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightregexpattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightregexpattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightregexpattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightregexpattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightregexpattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightregexpattern.php" hreflang="zh">
...
<meta name="Description" content="Specify the regular expression for fragmenting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightRegexPattern - Manual" />
<meta name="twitter:description" content="Specify the regular expression for fragmenting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightRegexPattern - Manual" />
<meta itemprop="description" content="Specify the regular expression for fragmenting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specify the regular expression for fragmenting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightregexslop.php">
          SolrQuery::setHighlightRegexSlop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightregexmaxanalyzedchars.php">
          &laquo; SolrQuery::setHighlightRegexMaxAnalyzedChars        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightregexpattern.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightregexpattern.php'>German</option>
            <option value='es/solrquery.sethighlightregexpattern.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightregexpattern.php'>French</option>
            <option value='it/solrquery.sethighlightregexpattern.php'>Italian</option>
            <option value='ja/solrquery.sethighlightregexpattern.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightregexpattern.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightregexpattern.php'>Russian</option>
            <option value='tr/solrquery.sethighlightregexpattern.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightregexpattern.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightregexpattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightregexpattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightRegexPattern</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightRegexPattern</span> &mdash; <span class="dc-title">Specify the regular expression for fragmenting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightregexpattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightRegexPattern</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightregexpattern-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightregexpattern-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightregexpattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightregexpattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightregexpattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php">＋<small>add a note</small></a></span>
