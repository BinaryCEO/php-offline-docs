...
<div class="examplescode"><pre class="examplescode">/usr/share/myapp/locale</pre>
 ...
 <div class="head">
  ...
  <strong class="user"><em>n8klatt</em></strong></a><a class="genanchor" href="#116199"> &para;</a><div class="date" title="2014-11-20 05:47"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116199">
<div class="phpcode"><code><span class="html">The name of your .mo file must match the $domain, e.g. name your files messages.mo and call bindtextdomain("messages", $directory).</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I recommend using absolute paths in the $directory parameter. This caused me several hours to debug as Ajax calls to my localization functions messed up the path. And since no error if thrown if the path in $directory cannot be found, one should check the result always:<br /><br /><span class="default">&lt;?php<br />    </span><span class="comment">// Imagine the path for this file is "/localization" and your locales are in the "/locale" directory.<br />    </span><span class="default">$pathToDomain </span><span class="keyword">= </span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">"/../locale"</span><span class="keyword">;<br />    if (</span><span class="default">$pathToDomain </span><span class="keyword">!= </span><span class="default">bindtextdomain</span><span class="keyword">(</span><span class="default">$domain</span><span class="keyword">, </span><span class="default">$pathToDomain</span><span class="keyword">)) {<br />        </span><span class="comment">// Error handling.<br />    </span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
