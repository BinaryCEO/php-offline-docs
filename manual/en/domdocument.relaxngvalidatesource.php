...
<head>
  ...
  <title>PHP: DOMDocument::relaxNGValidateSource - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.relaxngvalidatesource.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.relaxngvalidatesource.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.relaxngvalidatesource.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.relaxngvalidate.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocument.replacechildren.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.relaxngvalidatesource.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.relaxngvalidatesource.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.relaxngvalidatesource.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.relaxngvalidatesource.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.relaxngvalidatesource.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.relaxngvalidatesource.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.relaxngvalidatesource.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.relaxngvalidatesource.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.relaxngvalidatesource.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.relaxngvalidatesource.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.relaxngvalidatesource.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: DOMDocument::relaxNGValidateSource - Manual" />
<meta name="twitter:description" content="Performs relaxNG validation on the document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::relaxNGValidateSource - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domdocument.replacechildren.php">
          DOMDocument::replaceChildren &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.relaxngvalidate.php">
          &laquo; DOMDocument::relaxNGValidate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.relaxngvalidatesource.php' selected="selected">English</option>
            <option value='de/domdocument.relaxngvalidatesource.php'>German</option>
            <option value='es/domdocument.relaxngvalidatesource.php'>Spanish</option>
            <option value='fr/domdocument.relaxngvalidatesource.php'>French</option>
            <option value='it/domdocument.relaxngvalidatesource.php'>Italian</option>
            <option value='ja/domdocument.relaxngvalidatesource.php'>Japanese</option>
            <option value='pt_BR/domdocument.relaxngvalidatesource.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.relaxngvalidatesource.php'>Russian</option>
            <option value='tr/domdocument.relaxngvalidatesource.php'>Turkish</option>
            <option value='uk/domdocument.relaxngvalidatesource.php'>Ukrainian</option>
            <option value='zh/domdocument.relaxngvalidatesource.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.relaxngvalidatesource" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domdocument.validate.php" class="methodname" rel="rdfs-seeAlso">DOMDocument::validate()</a> - Validates the document based on its DTD</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocument/relaxngvalidatesource.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomdocument.relaxngvalidatesource%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocument.relaxngvalidatesource&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.relaxngvalidatesource.php">＋<small>add a note</small></a></span>
