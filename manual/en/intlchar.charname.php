...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.charname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.charname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.charmirror.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.chartype.php">
...
<meta name="Description" content="Retrieve the name of a Unicode character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::charName - Manual" />
<meta name="twitter:description" content="Retrieve the name of a Unicode character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::charName - Manual" />
<meta itemprop="description" content="Retrieve the name of a Unicode character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the name of a Unicode character" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.charname.php' selected="selected">English</option>
            <option value='de/intlchar.charname.php'>German</option>
            <option value='es/intlchar.charname.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::charName</span> &mdash; <span class="dc-title">Retrieve the name of a Unicode character</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.charname-description">
  ...
  <p class="para">
   Depending on <code class="parameter">type</code>, the resulting character name is the &quot;modern&quot; name or the name that
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.charname-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there is no such code point.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.enumcharnames.php" class="function" rel="rdfs-seeAlso">IntlChar::enumCharNames()</a> - Enumerate all assigned Unicode characters within a range</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/charname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.charname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.charname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.charname.php">＋<small>add a note</small></a></span>
