...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/errorexception.getseverity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/errorexception.getseverity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/errorexception.getseverity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.errorexception.php">
 <link rel="prev" href="https://www.php.net/manual/en/errorexception.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/class.closedgeneratorexception.php">
...
<meta name="Description" content="Gets the exception severity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ErrorException::getSeverity - Manual" />
<meta name="twitter:description" content="Gets the exception severity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ErrorException::getSeverity - Manual" />
<meta itemprop="description" content="Gets the exception severity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the exception severity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="errorexception.construct.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='langref.php'>Language Reference</a></li>      <li><a href='reserved.exceptions.php'>Predefined Exceptions</a></li>      <li><a href='class.errorexception.php'>ErrorException</a></li>      </ul>
    </div>
  </div>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/errorexception.getseverity.php' selected="selected">English</option>
            ...
            <option value='pt_BR/errorexception.getseverity.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ErrorException::getSeverity</span> &mdash; <span class="dc-title">Gets the exception severity</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-errorexception.getseverity-examples">
  ...
  <p class="para">
   <div class="example" id="example-460">
    <p><strong>Example #1 <span class="function"><strong>ErrorException::getSeverity()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">This exception severity is: 256
bool(true)</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/errorexception/getseverity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ferrorexception.getseverity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=errorexception.getseverity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/errorexception.getseverity.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Try this as replacement for error_reporting(...)
<br />
...
<br />        </span><span class="default">$severity </span><span class="keyword">=
<br />            </span><span class="default">1 </span><span class="keyword">* </span><span class="default">E_ERROR </span><span class="keyword">|
<br />            </span><span class="default">1 </span><span class="keyword">* </span><span class="default">E_WARNING </span><span class="keyword">| 
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_PARSE </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_NOTICE </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_CORE_ERROR </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_CORE_WARNING </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_COMPILE_ERROR </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_COMPILE_WARNING </span><span class="keyword">| 
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_USER_ERROR </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_USER_WARNING </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_USER_NOTICE </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_STRICT </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_RECOVERABLE_ERROR </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_DEPRECATED </span><span class="keyword">|
<br />            </span><span class="default">0 </span><span class="keyword">* </span><span class="default">E_USER_DEPRECATED</span><span class="keyword">;
<br />        </span><span class="default">$ex </span><span class="keyword">= new </span><span class="default">ErrorException</span><span class="keyword">(</span><span class="default">$errstr</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$errno</span><span class="keyword">, </span><span class="default">$errfile</span><span class="keyword">, </span><span class="default">$errline</span><span class="keyword">);
<br />        if ((</span><span class="default">$ex</span><span class="keyword">-&gt;</span><span class="default">getSeverity</span><span class="keyword">() &amp; </span><span class="default">$severity</span><span class="keyword">) != </span><span class="default">0</span><span class="keyword">) {
<br />                       throw </span><span class="default">$ex</span><span class="keyword">;
<br />                }
<br />    }
...
<div class="phpcode"><code><span class="html">function friendly_severity($severity) {<br />    $names = [];<br /><br />    $consts = array_flip(<br />        array_slice(<br />            get_defined_constants(true)['Core'], 0, 15, true));<br /><br />    foreach ($consts as $code =&gt; $name) {<br />        if ($severity &amp; $code) $names []= $name;<br />    }<br /><br />    return join(' | ', $names);<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=errorexception.getseverity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/errorexception.getseverity.php">＋<small>add a note</small></a></div>
