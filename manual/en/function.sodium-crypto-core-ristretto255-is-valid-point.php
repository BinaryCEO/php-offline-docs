...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-is-valid-point.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-from-hash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-random.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-core-ristretto255-is-valid-point.php' selected="selected">English</option>
            ...
            <option value='zh/function.sodium-crypto-core-ristretto255-is-valid-point.php'>Chinese (Simplified)</option>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-core-ristretto255-is-valid-point-examples">
  ...
  <p class="para">
   <div class="example" id="example-1066">
    <p><strong>Example #1 <span class="function"><strong>sodium_crypto_core_ristretto255_is_valid_point()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sodium-crypto-scalarmult-ristretto255-base.php" class="function" rel="rdfs-seeAlso">sodium_crypto_scalarmult_ristretto255_base()</a> - Calculates the public key from a secret key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-core-ristretto255-is-valid-point.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-core-ristretto255-is-valid-point%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-core-ristretto255-is-valid-point&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-is-valid-point.php">＋<small>add a note</small></a></span>
