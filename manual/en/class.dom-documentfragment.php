...
<head>
  ...
  <title>PHP: Dom\DocumentFragment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-documentfragment.php">
 <link rel="shorturl" href="https://www.php.net/dom-documentfragment">
 <link rel="alternate" href="https://www.php.net/dom-documentfragment" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-document.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-documenttype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-documentfragment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-documentfragment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-documentfragment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-documentfragment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-documentfragment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-documentfragment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-documentfragment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-documentfragment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-documentfragment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-documentfragment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-documentfragment.php" hreflang="zh">
...
<meta name="Description" content="The Dom\DocumentFragment class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\DocumentFragment - Manual" />
<meta name="twitter:description" content="The Dom\DocumentFragment class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\DocumentFragment - Manual" />
<meta itemprop="description" content="The Dom\DocumentFragment class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\DocumentFragment class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-documenttype.php">
          Dom\DocumentType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-document.php">
          &laquo; Dom\Document        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-documentfragment.php' selected="selected">English</option>
            <option value='de/class.dom-documentfragment.php'>German</option>
            <option value='es/class.dom-documentfragment.php'>Spanish</option>
            <option value='fr/class.dom-documentfragment.php'>French</option>
            <option value='it/class.dom-documentfragment.php'>Italian</option>
            <option value='ja/class.dom-documentfragment.php'>Japanese</option>
            <option value='pt_BR/class.dom-documentfragment.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-documentfragment.php'>Russian</option>
            <option value='tr/class.dom-documentfragment.php'>Turkish</option>
            <option value='uk/class.dom-documentfragment.php'>Ukrainian</option>
            <option value='zh/class.dom-documentfragment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-documentfragment" class="reference">
 <h1 class="title">The Dom\DocumentFragment class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-documentfragment.intro">
   ...
   <p class="simpara">
    ...
    <span class="classname"><a href="class.domdocumentfragment.php" class="classname">DOMDocumentFragment</a></span>.
   </p>
  </div>

  <div class="section" id="dom-documentfragment.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\DocumentFragment</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-documentfragment.php#dom-documentfragment.props.firstelementchild">$<var class="varname">firstElementChild</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-documentfragment.php#dom-documentfragment.props.lastelementchild">$<var class="varname">lastElementChild</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.dom-documentfragment.php#dom-documentfragment.props.childelementcount">$<var class="varname">childElementCount</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-documentfragment.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-documentfragment.props.firstelementchild"><var class="varname">firstElementChild</var></dt><dd>
      <p class="para">First child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-documentfragment.props.lastelementchild"><var class="varname">lastElementChild</var></dt><dd>
      <p class="para">Last child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-documentfragment.props.childelementcount"><var class="varname">childElementCount</var></dt><dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-documentfragment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-documentfragment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-documentfragment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-documentfragment.php">＋<small>add a note</small></a></span>
