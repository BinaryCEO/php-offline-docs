...
<head>
  ...
  <title>PHP: EventHttp::setCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventhttp.setcallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventhttp.setcallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.setcallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventhttp.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttp.setallowedmethods.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttp.setdefaultcallback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventhttp.setcallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventhttp.setcallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventhttp.setcallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventhttp.setcallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventhttp.setcallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventhttp.setcallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventhttp.setcallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventhttp.setcallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventhttp.setcallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventhttp.setcallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventhttp.setcallback.php" hreflang="zh">
...
<meta name="Description" content="Sets a callback for specified URI" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttp::setCallback - Manual" />
<meta name="twitter:description" content="Sets a callback for specified URI" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttp::setCallback - Manual" />
<meta itemprop="description" content="Sets a callback for specified URI" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets a callback for specified URI" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="eventhttp.setdefaultcallback.php">
          EventHttp::setDefaultCallback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttp.setallowedmethods.php">
          &laquo; EventHttp::setAllowedMethods        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventhttp.setcallback.php' selected="selected">English</option>
            <option value='de/eventhttp.setcallback.php'>German</option>
            <option value='es/eventhttp.setcallback.php'>Spanish</option>
            <option value='fr/eventhttp.setcallback.php'>French</option>
            <option value='it/eventhttp.setcallback.php'>Italian</option>
            <option value='ja/eventhttp.setcallback.php'>Japanese</option>
            <option value='pt_BR/eventhttp.setcallback.php'>Brazilian Portuguese</option>
            <option value='ru/eventhttp.setcallback.php'>Russian</option>
            <option value='tr/eventhttp.setcallback.php'>Turkish</option>
            <option value='uk/eventhttp.setcallback.php'>Ukrainian</option>
            <option value='zh/eventhttp.setcallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventhttp.setcallback" class="refentry">
...
Connection: close</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-eventhttp.setcallback-seealso">
  ...
  <ul class="simplelist">
   <li>
    <span class="methodname"><a href="eventhttp.setdefaultcallback.php" class="methodname" rel="rdfs-seeAlso">EventHttp::setDefaultCallback()</a> - Sets default callback to handle requests that are not caught by specific callbacks</span>
   </li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttp/setcallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventhttp.setcallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventhttp.setcallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttp.setcallback.php">＋<small>add a note</small></a></span>
