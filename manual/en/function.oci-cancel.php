...
<head>
  ...
  <title>PHP: oci_cancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-cancel.php">
 <link rel="shorturl" href="https://www.php.net/oci-cancel">
 <link rel="alternate" href="https://www.php.net/oci-cancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-bind-by-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-client-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-cancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-cancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-cancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-cancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-cancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-cancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-cancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-cancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-cancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-cancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-cancel.php" hreflang="zh">
...
<meta name="Description" content="Cancels reading from cursor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_cancel - Manual" />
<meta name="twitter:description" content="Cancels reading from cursor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_cancel - Manual" />
<meta itemprop="description" content="Cancels reading from cursor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancels reading from cursor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-client-version.php">
          oci_client_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-bind-by-name.php">
          &laquo; oci_bind_by_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-cancel.php' selected="selected">English</option>
            <option value='de/function.oci-cancel.php'>German</option>
            <option value='es/function.oci-cancel.php'>Spanish</option>
            <option value='fr/function.oci-cancel.php'>French</option>
            <option value='it/function.oci-cancel.php'>Italian</option>
            <option value='ja/function.oci-cancel.php'>Japanese</option>
            <option value='pt_BR/function.oci-cancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-cancel.php'>Russian</option>
            <option value='tr/function.oci-cancel.php'>Turkish</option>
            <option value='uk/function.oci-cancel.php'>Ukrainian</option>
            <option value='zh/function.oci-cancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-cancel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_cancel</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_cancel</span> &mdash; <span class="dc-title">Cancels reading from cursor</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.oci-cancel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_cancel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.oci-cancel-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-cancel-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-cancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-cancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-cancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-cancel.php">＋<small>add a note</small></a></span>
