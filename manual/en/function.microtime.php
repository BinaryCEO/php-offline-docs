...
<head>
  ...
  <title>PHP: microtime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.microtime.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.localtime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mktime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.microtime.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.microtime.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.microtime.php" hreflang="uk">
...
<meta name="Description" content="Return current Unix timestamp with microseconds" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: microtime - Manual" />
<meta name="twitter:description" content="Return current Unix timestamp with microseconds" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: microtime - Manual" />
<meta itemprop="description" content="Return current Unix timestamp with microseconds" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return current Unix timestamp with microseconds" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.microtime.php' selected="selected">English</option>
            <option value='de/function.microtime.php'>German</option>
            <option value='es/function.microtime.php'>Spanish</option>
            <option value='fr/function.microtime.php'>French</option>
            <option value='it/function.microtime.php'>Italian</option>
            <option value='ja/function.microtime.php'>Japanese</option>
            <option value='pt_BR/function.microtime.php'>Brazilian Portuguese</option>
            <option value='ru/function.microtime.php'>Russian</option>
            <option value='tr/function.microtime.php'>Turkish</option>
            <option value='uk/function.microtime.php'>Ukrainian</option>
            <option value='zh/function.microtime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.microtime" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">microtime</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">microtime</span> &mdash; <span class="dc-title">Return current Unix timestamp with microseconds</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.microtime-description">
  ...
  <p class="para">
   For performance measurements, using <span class="function"><a href="function.hrtime.php" class="function">hrtime()</a></span> is recommended.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.microtime-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If used and set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, <span class="function"><strong>microtime()</strong></span> will return a
       <span class="type"><a href="language.types.float.php" class="type float">float</a></span> instead of a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>, as described in
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.microtime-returnvalues">
  ...
  <p class="para">
   By default, <span class="function"><strong>microtime()</strong></span> returns a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> in
  ...
  <p class="para">
   If <code class="parameter">as_float</code> is set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, then
   <span class="function"><strong>microtime()</strong></span> returns a <span class="type"><a href="language.types.float.php" class="type float">float</a></span>, which
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.hrtime.php" class="function" rel="rdfs-seeAlso">hrtime()</a> - Get the system's high resolution time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/microtime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.microtime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.microtime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.microtime.php">＋<small>add a note</small></a></span>
