...
<head>
  ...
  <title>PHP: mysqli::use_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.use-result.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.use-result.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.use-result.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.thread-safe.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.warning-count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.use-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.use-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.use-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.use-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.use-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.use-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.use-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.use-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.use-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.use-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.use-result.php" hreflang="zh">
...
<meta name="Description" content="Initiate a result set retrieval" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::use_result - Manual" />
<meta name="twitter:description" content="Initiate a result set retrieval" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::use_result - Manual" />
<meta itemprop="description" content="Initiate a result set retrieval" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initiate a result set retrieval" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.warning-count.php">
          mysqli::$warning_count &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.thread-safe.php">
          &laquo; mysqli::thread_safe        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.use-result.php' selected="selected">English</option>
            <option value='de/mysqli.use-result.php'>German</option>
            <option value='es/mysqli.use-result.php'>Spanish</option>
            <option value='fr/mysqli.use-result.php'>French</option>
            <option value='it/mysqli.use-result.php'>Italian</option>
            <option value='ja/mysqli.use-result.php'>Japanese</option>
            <option value='pt_BR/mysqli.use-result.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.use-result.php'>Russian</option>
            <option value='tr/mysqli.use-result.php'>Turkish</option>
            <option value='uk/mysqli.use-result.php'>Ukrainian</option>
            <option value='zh/mysqli.use-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.use-result" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mysqli.use-result-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>mysqli::use_result</strong></span>(): <span class="type"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">Procedural style</p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>mysqli_use_result</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>): <span class="type"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Used to initiate the retrieval of a result set from the last query
   executed using the <span class="function"><a href="mysqli.real-query.php" class="function">mysqli_real_query()</a></span> function on the
   database connection.
  </p>
  <p class="para">
   Either this or the <span class="function"><a href="mysqli.store-result.php" class="function">mysqli_store_result()</a></span> function must
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    such as <span class="function"><a href="mysqli-result.data-seek.php" class="function">mysqli_data_seek()</a></span> to move to a particular
    row within the set. To use this functionality, the result set must be
    stored using <span class="function"><a href="mysqli.store-result.php" class="function">mysqli_store_result()</a></span>. One should not
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.use-result-returnvalues">
  ...
  <p class="para">
   Returns an unbuffered result object or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an error occurred.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-mysqli.use-result-errors">
...
a <span class="classname"><a href="class.mysqli-sql-exception.php" class="classname">mysqli_sql_exception</a></span> is thrown instead.</p>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.use-result-examples">
  ...
  <div class="example" id="example-1617">
   <p><strong>Example #1 <span class="methodname"><strong>mysqli::use_result()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.store-result.php" class="function" rel="rdfs-seeAlso">mysqli_store_result()</a> - Transfers a result set from the last query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/use-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.use-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.use-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.use-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110044">  <div class="votes">
    <div id="Vu110044">
    <a href="/manual/vote-note.php?id=110044&amp;page=mysqli.use-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110044">
    <a href="/manual/vote-note.php?id=110044&amp;page=mysqli.use-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110044" title="56% like this...">
    3
    </div>
  </div>
  <a href="#110044" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#110044"> &para;</a><div class="date" title="2012-09-14 05:30"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom110044">
<div class="phpcode"><code><span class="html">&gt; One should not use mysqli_use_result() if a lot of processing on the client side is performed, since this will tie up the server and prevent other threads from updating any tables from which the data is being fetched. <br /><br />Another way of understanding the "blocking" behavior of this "use_result" method is that by using this method (or the MYSQLI_USE_RESULT flag on the "query" method), if attempting to run a second query of any kind - updates, inserts, selects, or other - while still working with these first results, the second query will fail.  Checking mysqli-&gt;error, you should get a "Commands out of sync" error on the second query call.<br /><br />However, if you use the "store_result" method (or the default MYSQLI_STORE_RESULT flag on the "query" method) instead, the second query will execute just fine.<br /><br />Just to demonstrate this "blocking" behavior of this "use_result" method, the second query on line 7 below would otherwise fail if you instead used "use_result" on line 3:<br /><br /><span class="default">&lt;?php<br />$mysqli</span><span class="keyword">-&gt;</span><span class="default">real_query</span><span class="keyword">(</span><span class="string">'SELECT * FROM `test`'</span><span class="keyword">);<br /></span><span class="default">$query </span><span class="keyword">= </span><span class="default">$mysqli</span><span class="keyword">-&gt;</span><span class="default">store_result</span><span class="keyword">();<br />while (</span><span class="default">$row </span><span class="keyword">= </span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">fetch_assoc</span><span class="keyword">()) {<br />    </span><span class="default">$id </span><span class="keyword">= (int) </span><span class="default">$row</span><span class="keyword">[</span><span class="string">'id'</span><span class="keyword">];<br />    </span><span class="default">$query2 </span><span class="keyword">= </span><span class="default">$mysqli</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">"UPDATE `test` SET `label` = md5(rand()) WHERE `id` = </span><span class="default">$id</span><span class="string">"</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.use-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.use-result.php">＋<small>add a note</small></a></div>
