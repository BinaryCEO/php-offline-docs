...
<head>
  ...
  <title>PHP: stream_socket_pair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-pair.php">
 <link rel="shorturl" href="https://www.php.net/stream-socket-pair">
 <link rel="alternate" href="https://www.php.net/stream-socket-pair" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-get-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-socket-recvfrom.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-socket-pair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-socket-pair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-socket-pair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-socket-pair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-socket-pair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-socket-pair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-socket-pair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-socket-pair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-socket-pair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-socket-pair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-socket-pair.php" hreflang="zh">
...
<meta name="Description" content="Creates a pair of connected, indistinguishable socket streams" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_socket_pair - Manual" />
<meta name="twitter:description" content="Creates a pair of connected, indistinguishable socket streams" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_pair - Manual" />
<meta itemprop="description" content="Creates a pair of connected, indistinguishable socket streams" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a pair of connected, indistinguishable socket streams" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-socket-recvfrom.php">
          stream_socket_recvfrom &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-socket-get-name.php">
          &laquo; stream_socket_get_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-pair.php' selected="selected">English</option>
            <option value='de/function.stream-socket-pair.php'>German</option>
            <option value='es/function.stream-socket-pair.php'>Spanish</option>
            <option value='fr/function.stream-socket-pair.php'>French</option>
            <option value='it/function.stream-socket-pair.php'>Italian</option>
            <option value='ja/function.stream-socket-pair.php'>Japanese</option>
            <option value='pt_BR/function.stream-socket-pair.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-socket-pair.php'>Russian</option>
            <option value='tr/function.stream-socket-pair.php'>Turkish</option>
            <option value='uk/function.stream-socket-pair.php'>Ukrainian</option>
            <option value='zh/function.stream-socket-pair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-socket-pair" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_socket_pair</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_socket_pair</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.stream-socket-pair-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_socket_pair</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$domain</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$protocol</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-socket-pair-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The protocol family to be used: <strong><code><a href="stream.constants.php#constant.stream-pf-inet">STREAM_PF_INET</a></code></strong>,
       <strong><code><a href="stream.constants.php#constant.stream-pf-inet6">STREAM_PF_INET6</a></code></strong> or
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="stream.constants.php#constant.stream-sock-seqpacket">STREAM_SOCK_SEQPACKET</a></code></strong> or
     ...
     <dd>
      <p class="para">
       The protocol to be used: <strong><code><a href="stream.constants.php#constant.stream-ipproto-icmp">STREAM_IPPROTO_ICMP</a></code></strong>,
       ...
       <strong><code><a href="stream.constants.php#constant.stream-ipproto-tcp">STREAM_IPPROTO_TCP</a></code></strong> or
  ...
  <p class="para">
   <div class="example" id="example-4073">
    ...
    <div class="example-contents"><p>
     ...
     <span class="function"><strong>stream_socket_pair()</strong></span> in Inter-Process Communication.
    </p></div>
...
<div class="examplescode"><pre class="examplescode">child PID: 1378
message from child</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-pair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-pair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-pair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-pair.php">＋<small>add a note</small></a></span>
