...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.parle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.parle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.parle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.parle.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.parle.php">
 <link rel="next" href="https://www.php.net/manual/en/parle.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.parle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.parle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.parle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.parle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.parle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.parle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.parle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.parle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.parle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.parle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.parle.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.parle.php' selected="selected">English</option>
            <option value='de/intro.parle.php'>German</option>
            <option value='es/intro.parle.php'>Spanish</option>
            <option value='fr/intro.parle.php'>French</option>
            <option value='it/intro.parle.php'>Italian</option>
            <option value='ja/intro.parle.php'>Japanese</option>
            <option value='pt_BR/intro.parle.php'>Brazilian Portuguese</option>
            <option value='ru/intro.parle.php'>Russian</option>
            <option value='tr/intro.parle.php'>Turkish</option>
            <option value='uk/intro.parle.php'>Ukrainian</option>
            <option value='zh/intro.parle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.parle" class="preface">
  ...
  <p class="para">  
   The common use case for parle is, when a data format is too complex to be handled by the regex matching with PCRE. The practical application is herewith wide. Be it a specific data format, a behavior modification of existing functions, even an own programming language and beyond. The helper methods such as <span class="methodname"><a href="parle-lexer.dump.php" class="methodname">Parle\Lexer::dump()</a></span> to inspect the generated state machine, or <span class="methodname"><a href="parle-parser.dump.php" class="methodname">Parle\Parser::dump()</a></span> to inspect the generated grammar, are useful. The method <span class="methodname"><a href="parle-parser.trace.php" class="methodname">Parle\Parser::trace()</a></span> can also be used to track the parsing operation.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.parle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.parle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.parle.php">＋<small>add a note</small></a></span>
