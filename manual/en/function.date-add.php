...
<head>
  ...
  <title>PHP: date_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-add.php">
 <link rel="shorturl" href="https://www.php.net/date-add">
 <link rel="alternate" href="https://www.php.net/date-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-add.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::add" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_add - Manual" />
<meta name="twitter:description" content="Alias of DateTime::add" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_add - Manual" />
<meta itemprop="description" content="Alias of DateTime::add" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::add" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-add.php' selected="selected">English</option>
            <option value='de/function.date-add.php'>German</option>
            <option value='es/function.date-add.php'>Spanish</option>
            <option value='fr/function.date-add.php'>French</option>
            <option value='it/function.date-add.php'>Italian</option>
            <option value='ja/function.date-add.php'>Japanese</option>
            <option value='pt_BR/function.date-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-add.php'>Russian</option>
            <option value='tr/function.date-add.php'>Turkish</option>
            <option value='uk/function.date-add.php'>Ukrainian</option>
            <option value='zh/function.date-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_add</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_add</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.add.php" class="methodname">DateTime::add()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-add-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.add.php" class="methodname">DateTime::add()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-add.php">＋<small>add a note</small></a></span>
