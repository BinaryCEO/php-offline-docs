...
<head>
  ...
  <title>PHP: Imagick::getImageColors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecolors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecolors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecolors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecolors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagecolors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagecolors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagecolors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagecolors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagecolors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagecolors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagecolors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagecolors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagecolors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagecolors.php" hreflang="zh">
...
<meta name="Description" content="Gets the number of unique colors in the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageColors - Manual" />
<meta name="twitter:description" content="Gets the number of unique colors in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageColors - Manual" />
<meta itemprop="description" content="Gets the number of unique colors in the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of unique colors in the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagecolorspace.php">
          Imagick::getImageColorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagecolormapcolor.php">
          &laquo; Imagick::getImageColormapColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecolors.php' selected="selected">English</option>
            <option value='de/imagick.getimagecolors.php'>German</option>
            <option value='es/imagick.getimagecolors.php'>Spanish</option>
            <option value='fr/imagick.getimagecolors.php'>French</option>
            <option value='it/imagick.getimagecolors.php'>Italian</option>
            <option value='ja/imagick.getimagecolors.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagecolors.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagecolors.php'>Russian</option>
            <option value='tr/imagick.getimagecolors.php'>Turkish</option>
            <option value='uk/imagick.getimagecolors.php'>Ukrainian</option>
            <option value='zh/imagick.getimagecolors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagecolors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageColors</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageColors</span> &mdash; <span class="dc-title">Gets the number of unique colors in the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecolors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageColors</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagecolors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagecolors-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>, the number of unique colors in the image.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecolors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecolors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecolors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecolors.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108203">  <div class="votes">
    <div id="Vu108203">
    <a href="/manual/vote-note.php?id=108203&amp;page=imagick.getimagecolors&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108203">
    <a href="/manual/vote-note.php?id=108203&amp;page=imagick.getimagecolors&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108203" title="100% like this...">
    3
    </div>
  </div>
  <a href="#108203" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108203"> &para;</a><div class="date" title="2012-04-06 10:54"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108203">
<div class="phpcode"><code><span class="html">I've had difficulty getting this function to return the number of unique colors.  Also, I wanted to be able to have an array with each $key value being the RGB of the pixel, and each $value value being the number of times that pixel occurs.  Basically, a frequency list.  For example, you would have "1 / 0 / 0" for red as a $key value, and "25" for the number of times that pixel color was in the image.  So, I wrote some code to do that, using a combination of readImageFile, getImageWidth, getImageHeight, getImagePixelColor, and a simple x/y parser, like so :<br /><br /><span class="default">&lt;?php<br /><br />        </span><span class="comment">// Test File<br />        // ---------------------------------------------<br /><br />            // Note: This file was just a picture of a 5x5 red square<br />            //    inside of a gigantic 521x512 black square, and<br />            //    then I did a bunch of random, yellow zigzags.<br /><br />    </span><span class="default">$file_to_grab_with_location </span><span class="keyword">= </span><span class="string">"test.bmp"</span><span class="keyword">;<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />            <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />                    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Preset Information<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$frequency_list_of_values </span><span class="keyword">= array();<br />    <br />        </span><span class="comment">// Parse Pixels<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_resolution_width </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br />    </span><span class="default">$image_resolution_height </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">();<br />        <br />    print(</span><span class="string">"Image Resolution:  Width - </span><span class="default">$image_resolution_width</span><span class="string"> / Height - </span><span class="default">$image_resolution_height</span><span class="string">&lt;br&gt;&lt;br&gt;"</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Parse Image Top-to-Bottom (Y-Variable)<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">for(</span><span class="default">$y </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$y </span><span class="keyword">&lt; </span><span class="default">$image_resolution_height</span><span class="keyword">; </span><span class="default">$y</span><span class="keyword">++)<br />    {<br />            </span><span class="comment">// Parse Image Left-to-Right (X-Variable)<br />            // ---------------------------------------------<br />        <br />        </span><span class="keyword">for(</span><span class="default">$x </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$x </span><span class="keyword">&lt; </span><span class="default">$image_resolution_width</span><span class="keyword">; </span><span class="default">$x</span><span class="keyword">++)<br />        {<br />        <br />                </span><span class="comment">// Image Pixel Color<br />                // ---------------------------------------------<br />        <br />            </span><span class="default">$pixel_to_examine </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImagePixelColor</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">,</span><span class="default">$y</span><span class="keyword">);<br />            <br />            </span><span class="default">$pixel_to_examine_color_value_red </span><span class="keyword">= </span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorValue</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COLOR_RED</span><span class="keyword">);<br />            </span><span class="default">$pixel_to_examine_color_value_green </span><span class="keyword">= </span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorValue</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COLOR_GREEN</span><span class="keyword">);<br />            </span><span class="default">$pixel_to_examine_color_value_blue </span><span class="keyword">= </span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorValue</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COLOR_BLUE</span><span class="keyword">);<br /><br />                </span><span class="comment">// Set Key Value<br />                // ---------------------------------------------<br />        <br />            </span><span class="default">$key_value </span><span class="keyword">=    </span><span class="default">$pixel_to_examine_color_value_red    </span><span class="keyword">.    </span><span class="string">" / "    </span><span class="keyword">.<br />                    </span><span class="default">$pixel_to_examine_color_value_green    </span><span class="keyword">.    </span><span class="string">" / "    </span><span class="keyword">.<br />                    </span><span class="default">$pixel_to_examine_color_value_blue            </span><span class="keyword">;<br />    <br />                </span><span class="comment">// Increment Array Entry for Color<br />                // ---------------------------------------------<br />                    <br />            </span><span class="keyword">if(isset(</span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$key_value</span><span class="keyword">]) == </span><span class="default">TRUE</span><span class="keyword">)<br />            {<br />                </span><span class="default">$temp </span><span class="keyword">= </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$key_value</span><span class="keyword">];<br />                </span><span class="default">$temp</span><span class="keyword">++;<br />                </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$key_value</span><span class="keyword">] = </span><span class="default">$temp</span><span class="keyword">;<br />            }<br />            else<br />            {<br />                </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$key_value</span><span class="keyword">] = </span><span class="default">1</span><span class="keyword">;<br />            }<br />        }<br />    }<br />                <br />        </span><span class="comment">// Print Out Array of Values<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$frequency_list_of_values</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /><br />    Results:<br />    ------------------<br /><br />Image Resolution: Width - 521 / Height - 512<br /><br />Array<br />(<br />    [1 / 0 / 0] =&gt; 25<br />    [0 / 0 / 1] =&gt; 264107<br />    [1 / 1 / 0] =&gt; 2620<br />)<br /><br />*/<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="122583">  <div class="votes">
    <div id="Vu122583">
    <a href="/manual/vote-note.php?id=122583&amp;page=imagick.getimagecolors&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122583">
    <a href="/manual/vote-note.php?id=122583&amp;page=imagick.getimagecolors&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122583" title="0% like this...">
    -4
    </div>
  </div>
  <a href="#122583" class="name">
  <strong class="user"><em>amaral dot regis at hotmail dot com</em></strong></a><a class="genanchor" href="#122583"> &para;</a><div class="date" title="2018-04-03 01:27"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122583">
<div class="phpcode"><code><span class="html">O exemplo anterior apresentou números fracionados nas chaves da variável $frequency_list_of_values:<br /><br />Array<br />(<br />    [1 / 0 / 1] =&gt; 157295<br />    [0.83529411764706 / 0.87843137254902 / 0.82352941176471] =&gt; 1<br />    [0.80392156862745 / 0.84705882352941 / 0.7843137254902] =&gt; 2<br />    [0.8156862745098 / 0.84705882352941 / 0.78823529411765] =&gt; 1<br />...<br /><br />Então eu fiz uma alteração que melhora o resultado para quem esta buscando saber quais as cores dominantes na imagem, mostrando a chave com o valor rgb exato:<br /><span class="default">&lt;?php<br /><br />        $file_to_grab_with_location </span><span class="keyword">= </span><span class="default">$imagepath</span><span class="keyword">; </span><span class="comment">//caminho relativo ao arquivo de imagem<br /><br />        </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">\Imagick</span><span class="keyword">();<br /><br />        </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab_with_location</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />        </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br /><br />        </span><span class="default">$frequency_list_of_values </span><span class="keyword">= array();<br /><br />        </span><span class="default">$image_resolution_width </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br />        </span><span class="default">$image_resolution_height </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">();<br /><br />        print(</span><span class="string">"Image Resolution:  Width - </span><span class="default">$image_resolution_width</span><span class="string"> / Height - </span><span class="default">$image_resolution_height</span><span class="string">&lt;br&gt;&lt;br&gt;"</span><span class="keyword">);<br /><br />        for(</span><span class="default">$y </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$y </span><span class="keyword">&lt; </span><span class="default">$image_resolution_height</span><span class="keyword">; </span><span class="default">$y</span><span class="keyword">++)<br />        {<br /><br />            for(</span><span class="default">$x </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$x </span><span class="keyword">&lt; </span><span class="default">$image_resolution_width</span><span class="keyword">; </span><span class="default">$x</span><span class="keyword">++)<br />            {<br /><br />                </span><span class="default">$pixel_to_examine </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImagePixelColor</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">,</span><span class="default">$y</span><span class="keyword">);<br /><br />                if(isset(</span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorAsString</span><span class="keyword">()]) == </span><span class="default">TRUE</span><span class="keyword">)<br />                {<br />                    </span><span class="default">$temp </span><span class="keyword">= </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorAsString</span><span class="keyword">()];<br />                    </span><span class="default">$temp</span><span class="keyword">++;<br />                    </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorAsString</span><span class="keyword">()] = </span><span class="default">$temp</span><span class="keyword">;<br />                }<br />                else<br />                {<br />                    </span><span class="default">$frequency_list_of_values</span><span class="keyword">[</span><span class="default">$pixel_to_examine</span><span class="keyword">-&gt;</span><span class="default">getColorAsString</span><span class="keyword">()] = </span><span class="default">1</span><span class="keyword">;<br />                }<br />            }<br /><br />            </span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$frequency_list_of_values</span><span class="keyword">);<br />        }<br /><br />        print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />        </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$frequency_list_of_values</span><span class="keyword">);<br />        print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Resultado:<br />Image Resolution: Width - 1965 / Height - 998<br /><br />Array<br />(<br />    [srgba(255,0,255,0)] =&gt; 451654<br />    [srgb(54,52,53)] =&gt; 281069<br />    [srgb(177,51,54)] =&gt; 130449<br />    [srgb(236,50,55)] =&gt; 64001<br />...<br /><br />O método é demorado para imagens muito grandes, pois ele analisa pixel a pixel.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagecolors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecolors.php">＋<small>add a note</small></a></div>
