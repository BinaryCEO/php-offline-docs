...
<head>
  ...
  <title>PHP: ctype_lower - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-lower.php">
 <link rel="shorturl" href="https://www.php.net/ctype-lower">
 <link rel="alternate" href="https://www.php.net/ctype-lower" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-graph.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-print.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-lower.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-lower.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-lower.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-lower.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-lower.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-lower.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-lower.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-lower.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-lower.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-lower.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-lower.php" hreflang="zh">
...
<meta name="Description" content="Check for lowercase character(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_lower - Manual" />
<meta name="twitter:description" content="Check for lowercase character(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_lower - Manual" />
<meta itemprop="description" content="Check for lowercase character(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for lowercase character(s)" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-lower.php' selected="selected">English</option>
            <option value='de/function.ctype-lower.php'>German</option>
            <option value='es/function.ctype-lower.php'>Spanish</option>
            <option value='fr/function.ctype-lower.php'>French</option>
            <option value='it/function.ctype-lower.php'>Italian</option>
            <option value='ja/function.ctype-lower.php'>Japanese</option>
            <option value='pt_BR/function.ctype-lower.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-lower.php'>Russian</option>
            <option value='tr/function.ctype-lower.php'>Turkish</option>
            <option value='uk/function.ctype-lower.php'>Ukrainian</option>
            <option value='zh/function.ctype-lower.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-lower" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ctype_lower</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ctype_lower</span> &mdash; <span class="dc-title">Check for lowercase character(s)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ctype-lower-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">text</code>, are lowercase letters.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.ctype-lower-examples">
  ...
  <p class="para">
   <div class="example" id="example-5368">
    <p><strong>Example #1 A <span class="function"><strong>ctype_lower()</strong></span> example (using the default locale)</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.islower.php" class="function" rel="rdfs-seeAlso">IntlChar::islower()</a> - Check if code point is a lowercase letter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-lower.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-lower%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-lower&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-lower.php">＋<small>add a note</small></a></span>
