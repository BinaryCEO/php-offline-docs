...
<head>
  ...
  <title>PHP: Imagick::getImageChannelKurtosis - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechannelextrema.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechannelkurtosis.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechannelkurtosis.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechannelkurtosis.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechannelkurtosis.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechannelkurtosis.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechannelkurtosis.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechannelkurtosis.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechannelkurtosis.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechannelkurtosis.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechannelkurtosis.php" hreflang="zh">
...
<meta name="Description" content="The getImageChannelKurtosis purpose" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelKurtosis - Manual" />
<meta name="twitter:description" content="The getImageChannelKurtosis purpose" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelKurtosis - Manual" />
<meta itemprop="description" content="The getImageChannelKurtosis purpose" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The getImageChannelKurtosis purpose" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagechannelmean.php">
          Imagick::getImageChannelMean &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechannelextrema.php">
          &laquo; Imagick::getImageChannelExtrema        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechannelkurtosis.php' selected="selected">English</option>
            <option value='de/imagick.getimagechannelkurtosis.php'>German</option>
            <option value='es/imagick.getimagechannelkurtosis.php'>Spanish</option>
            <option value='fr/imagick.getimagechannelkurtosis.php'>French</option>
            <option value='it/imagick.getimagechannelkurtosis.php'>Italian</option>
            <option value='ja/imagick.getimagechannelkurtosis.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechannelkurtosis.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechannelkurtosis.php'>Russian</option>
            <option value='tr/imagick.getimagechannelkurtosis.php'>Turkish</option>
            <option value='uk/imagick.getimagechannelkurtosis.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechannelkurtosis.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechannelkurtosis" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageChannelKurtosis</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageChannelKurtosis</span> &mdash; <span class="dc-title">The getImageChannelKurtosis purpose</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagechannelkurtosis-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageChannelKurtosis</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagechannelkurtosis-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagechannelkurtosis-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array with <code class="literal">kurtosis</code> and <code class="literal">skewness</code>
   members.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-imagick.getimagechannelkurtosis-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechannelkurtosis.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechannelkurtosis%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechannelkurtosis&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108663">  <div class="votes">
    <div id="Vu108663">
    <a href="/manual/vote-note.php?id=108663&amp;page=imagick.getimagechannelkurtosis&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108663">
    <a href="/manual/vote-note.php?id=108663&amp;page=imagick.getimagechannelkurtosis&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108663" title="no votes...">
    0
    </div>
  </div>
  <a href="#108663" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108663"> &para;</a><div class="date" title="2012-05-15 11:52"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108663">
<div class="phpcode"><code><span class="html">The getImageChannelKurtosis function accepts as a parameter any of the ImageMagick channel constants and returns an array containing elements with the two element values of 'kurtosis' and 'skewness.'<br /><br />For the inputted color values, you have the ImageMagick channel constant values that look like imagick::CHANNEL_UNDEFINED, with "_VALUE" values of: undefined, red, gray, cyan, green, magenta, blue, yellow, alpha, opacity, matte, black, index, all, and default.  This is for measuring the particular channel for these colors of their own associated colorspaces.<br /><br />According to Wikipedia, the Kurtosis is "any measure of the 'peakedness' of the probability distribution of a real-valued random variable" and Skewness (its opposite) is "a measure of the asymmetry of the probability distribution of a real-valued random variable."  The more colors vary from the inputted channel constant, you'll be more likely to get a skewness close to zero, and you'll get the opposite behavior from checking the kurtosis value, which makes sense, since skewness and kurtosis are considered mathematical antonyms.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Quantum Range<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type_channel_kurtosis_red </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageChannelKurtosis</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">CHANNEL_RED</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Print Results<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$imagick_type_channel_kurtosis_red</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />The results for performing this function upon a photo of the ocean...<br /><br />ImageMagick - Channel Kurtosis<br />  Channel - Undefined :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - Red :<br /><br />Kurtosis : 0.920611158888<br />Skewness : 1.52701528976<br /><br />  Channel - Gray :<br /><br />Kurtosis : 0.920611158888<br />Skewness : 1.52701528976<br /><br />  Channel - Cyan :<br /><br />Kurtosis : 0.920611158888<br />Skewness : 1.52701528976<br /><br />  Channel - Green :<br /><br />Kurtosis : -0.286520845928<br />Skewness : 1.05203603783<br /><br />  Channel - Magenta :<br /><br />Kurtosis : -0.286520845928<br />Skewness : 1.05203603783<br /><br />  Channel - Blue :<br /><br />Kurtosis : -0.849997917796<br />Skewness : 0.807852655795<br /><br />  Channel - Yellow :<br /><br />Kurtosis : -0.849997917796<br />Skewness : 0.807852655795<br /><br />  Channel - Alpha :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - Opacity :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - Matte :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - Black :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - Index :<br /><br />Kurtosis : 0<br />Skewness : 0<br /><br />  Channel - All :<br /><br />Kurtosis : 0.509521246195<br />Skewness : 1.33491479552<br /><br />  Channel - Default :<br /><br />Kurtosis : -0.349955122843<br />Skewness : 1.00561407035</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagechannelkurtosis&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">＋<small>add a note</small></a></div>
