...
<head>
  ...
  <title>PHP: imagecolorresolve - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorresolve.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorresolve">
 <link rel="alternate" href="https://www.php.net/imagecolorresolve" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolormatch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorresolvealpha.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorresolve.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorresolve.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorresolve.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorresolve.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorresolve.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorresolve.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorresolve.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorresolve.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorresolve.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorresolve.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorresolve.php" hreflang="zh">
...
<meta name="Description" content="Get the index of the specified color or its closest possible alternative" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolorresolve - Manual" />
<meta name="twitter:description" content="Get the index of the specified color or its closest possible alternative" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorresolve - Manual" />
<meta itemprop="description" content="Get the index of the specified color or its closest possible alternative" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the index of the specified color or its closest possible alternative" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolorresolvealpha.php">
          imagecolorresolvealpha &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolormatch.php">
          &laquo; imagecolormatch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorresolve.php' selected="selected">English</option>
            <option value='de/function.imagecolorresolve.php'>German</option>
            <option value='es/function.imagecolorresolve.php'>Spanish</option>
            <option value='fr/function.imagecolorresolve.php'>French</option>
            <option value='it/function.imagecolorresolve.php'>Italian</option>
            <option value='ja/function.imagecolorresolve.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorresolve.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorresolve.php'>Russian</option>
            <option value='tr/function.imagecolorresolve.php'>Turkish</option>
            <option value='uk/function.imagecolorresolve.php'>Ukrainian</option>
            <option value='zh/function.imagecolorresolve.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorresolve" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecolorresolve</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecolorresolve</span> &mdash; <span class="dc-title">Get the index of the specified color or its closest possible alternative</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecolorresolve-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecolorresolve</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$red</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$green</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$blue</code></span><br>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagecolorresolve-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecolorresolve-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecolorresolve-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolorresolve-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2849">
   <p><strong>Example #1 Using <span class="function"><strong>imagecoloresolve()</strong></span> to get colors from an image</strong></p>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagecolorresolve-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecolorclosest.php" class="function" rel="rdfs-seeAlso">imagecolorclosest()</a> - Get the index of the closest color to the specified color</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorresolve.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorresolve%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorresolve&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorresolve.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="17924">  <div class="votes">
    <div id="Vu17924">
    <a href="/manual/vote-note.php?id=17924&amp;page=function.imagecolorresolve&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd17924">
    <a href="/manual/vote-note.php?id=17924&amp;page=function.imagecolorresolve&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V17924" title="66% like this...">
    1
    </div>
  </div>
  <a href="#17924" class="name">
  <strong class="user"><em>ceo at l-i-e dot com</em></strong></a><a class="genanchor" href="#17924"> &para;</a><div class="date" title="2002-01-03 03:55"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom17924">
<div class="phpcode"><code><span class="html">Okay, so sometimes it's really IMPORTANT to get the exact color you want, only it's not *IN* the Image, and ImageColorResolve just isn't "close enough".<br /><br />The following code is a disgustingly gross hack, rather slow, but it does that.<br /><br />$colorcount = array();<br />for ($x = 0; $x &lt; $width; $x++){<br />    for ($y = 0; $y &lt; $height; $y++){<br />        $colorindex = imagecolorat($jpg, $x, $y);<br />        if (!isset($colorcount[$colorindex])){<br />            $colorcount[$colorindex] = 1;<br />        }<br />        else{<br />            $colorcount[$colorindex]++;<br />        }<br />    }<br />}<br />asort($colorcount);<br />reset($colorcount);<br /><br />$black = imagecolorexact($jpg, 0, 0, 0);<br />if ($black == -1){<br />    $goner = key($colorcount);<br />    $rgb = imagecolorsforindex($jpg, $goner);<br />    #error_log("Need black: About to kill $goner ($rgb[red], $rgb[green], $rgb[blue]) which was only used in $colorcount[$goner] pixels", 0);<br />    unset($colorcount[$goner]);<br />    imagecolordeallocate($jpg, $goner);<br />    $black = imagecolorallocate($jpg, 0, 0, 0);<br />}<br />if ($black == -1){<br />    $black = imagecolorresolve($jpg, 0, 0, 0);<br />    #error_log("Damn!  STILL couldn't allocate the color!", 0);<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecolorresolve&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorresolve.php">＋<small>add a note</small></a></div>
