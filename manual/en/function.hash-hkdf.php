...
<head>
  ...
  <title>PHP: hash_hkdf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.hash-hkdf.php">
 <link rel="shorturl" href="https://www.php.net/hash-hkdf">
 <link rel="alternate" href="https://www.php.net/hash-hkdf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.hash.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.hash-final.php">
 <link rel="next" href="https://www.php.net/manual/en/function.hash-hmac.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.hash-hkdf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.hash-hkdf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.hash-hkdf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.hash-hkdf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.hash-hkdf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.hash-hkdf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.hash-hkdf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.hash-hkdf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.hash-hkdf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.hash-hkdf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.hash-hkdf.php" hreflang="zh">
...
<meta name="Description" content="Generate a HKDF key derivation of a supplied key input" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: hash_hkdf - Manual" />
<meta name="twitter:description" content="Generate a HKDF key derivation of a supplied key input" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: hash_hkdf - Manual" />
<meta itemprop="description" content="Generate a HKDF key derivation of a supplied key input" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a HKDF key derivation of a supplied key input" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.hash-hkdf.php' selected="selected">English</option>
            <option value='de/function.hash-hkdf.php'>German</option>
            <option value='es/function.hash-hkdf.php'>Spanish</option>
            <option value='fr/function.hash-hkdf.php'>French</option>
            <option value='it/function.hash-hkdf.php'>Italian</option>
            <option value='ja/function.hash-hkdf.php'>Japanese</option>
            <option value='pt_BR/function.hash-hkdf.php'>Brazilian Portuguese</option>
            <option value='ru/function.hash-hkdf.php'>Russian</option>
            <option value='tr/function.hash-hkdf.php'>Turkish</option>
            <option value='uk/function.hash-hkdf.php'>Ukrainian</option>
            <option value='zh/function.hash-hkdf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.hash-hkdf" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="https://github.com/narfbg/hash_hkdf_compat" class="link external">&raquo;&nbsp;userland implementation</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/hash/functions/hash-hkdf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.hash-hkdf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.hash-hkdf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.hash-hkdf.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127277">  <div class="votes">
    <div id="Vu127277">
    <a href="/manual/vote-note.php?id=127277&amp;page=function.hash-hkdf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127277">
    <a href="/manual/vote-note.php?id=127277&amp;page=function.hash-hkdf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127277" title="100% like this...">
    3
    </div>
  </div>
  <a href="#127277" class="name">
  <strong class="user"><em>landers dot robert at gmail dot com</em></strong></a><a class="genanchor" href="#127277"> &para;</a><div class="date" title="2022-07-13 03:42"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127277">
<div class="phpcode"><code><span class="html">Make sure the info parameter contains random elements.<br /><br />From: <a href="https://soatok.blog/2021/11/17/understanding-hkdf/" rel="nofollow" target="_blank">https://soatok.blog/2021/11/17/understanding-hkdf/</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.hash-hkdf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.hash-hkdf.php">＋<small>add a note</small></a></div>
