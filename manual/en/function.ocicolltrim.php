...
<head>
  ...
  <title>PHP: ocicolltrim - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicolltrim.php">
 <link rel="shorturl" href="https://www.php.net/ocicolltrim">
 <link rel="alternate" href="https://www.php.net/ocicolltrim" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicollsize.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicolumnisnull.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicolltrim.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicolltrim.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicolltrim.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicolltrim.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicolltrim.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicolltrim.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicolltrim.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicolltrim.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicolltrim.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicolltrim.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicolltrim.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::trim" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicolltrim - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::trim" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicolltrim - Manual" />
<meta itemprop="description" content="Alias of OCICollection::trim" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::trim" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocicolumnisnull.php">
          ocicolumnisnull &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicollsize.php">
          &laquo; ocicollsize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicolltrim.php' selected="selected">English</option>
            <option value='de/function.ocicolltrim.php'>German</option>
            <option value='es/function.ocicolltrim.php'>Spanish</option>
            <option value='fr/function.ocicolltrim.php'>French</option>
            <option value='it/function.ocicolltrim.php'>Italian</option>
            <option value='ja/function.ocicolltrim.php'>Japanese</option>
            <option value='pt_BR/function.ocicolltrim.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicolltrim.php'>Russian</option>
            <option value='tr/function.ocicolltrim.php'>Turkish</option>
            <option value='uk/function.ocicolltrim.php'>Ukrainian</option>
            <option value='zh/function.ocicolltrim.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicolltrim" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicolltrim</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicolltrim</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.trim.php" class="function">OCICollection::trim()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicolltrim-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.trim.php" class="function">OCICollection::trim()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicolltrim.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicolltrim%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicolltrim&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicolltrim.php">＋<small>add a note</small></a></span>
