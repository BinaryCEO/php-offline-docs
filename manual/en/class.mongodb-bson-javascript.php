...
<head>
  ...
  <title>PHP: MongoDB\BSON\Javascript - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-javascript.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-javascript">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-javascript" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-decimal128.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-javascript.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-javascript.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-javascript.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-javascript.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-javascript.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-javascript.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-javascript.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-javascript.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-javascript.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-javascript.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-javascript.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-javascript.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Javascript class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Javascript - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Javascript class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Javascript - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Javascript class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Javascript class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-javascript.construct.php">
          MongoDB\BSON\Javascript::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-decimal128.tostring.php">
          &laquo; MongoDB\BSON\Decimal128::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-javascript.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-javascript.php'>German</option>
            <option value='es/class.mongodb-bson-javascript.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-javascript.php'>French</option>
            <option value='it/class.mongodb-bson-javascript.php'>Italian</option>
            <option value='ja/class.mongodb-bson-javascript.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-javascript.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-javascript.php'>Russian</option>
            <option value='tr/class.mongodb-bson-javascript.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-javascript.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-javascript.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-javascript" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-javascript.construct.php">MongoDB\BSON\Javascript::__construct</a> — Construct a new Javascript</li><li><a href="mongodb-bson-javascript.getcode.php">MongoDB\BSON\Javascript::getCode</a> — Returns the Javascript's code</li><li><a href="mongodb-bson-javascript.getscope.php">MongoDB\BSON\Javascript::getScope</a> — Returns the Javascript's scope document</li><li><a href="mongodb-bson-javascript.jsonserialize.php">MongoDB\BSON\Javascript::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="mongodb-bson-javascript.tostring.php">MongoDB\BSON\Javascript::__toString</a> — Returns the Javascript's code</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/javascript.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-javascript%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-javascript&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-javascript.php">＋<small>add a note</small></a></span>
