...
<head>
  ...
  <title>PHP: GearmanClient::doBackground - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.dobackground.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.dobackground.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dobackground.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.do.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.dohigh.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dobackground.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.dobackground.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.dobackground.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.dobackground.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.dobackground.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.dobackground.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.dobackground.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.dobackground.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.dobackground.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.dobackground.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.dobackground.php" hreflang="zh">
...
<meta name="Description" content="Run a task in the background" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doBackground - Manual" />
<meta name="twitter:description" content="Run a task in the background" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doBackground - Manual" />
<meta itemprop="description" content="Run a task in the background" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a task in the background" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.dohigh.php">
          GearmanClient::doHigh &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.do.php">
          &laquo; GearmanClient::do        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.dobackground.php' selected="selected">English</option>
            <option value='de/gearmanclient.dobackground.php'>German</option>
            <option value='es/gearmanclient.dobackground.php'>Spanish</option>
            <option value='fr/gearmanclient.dobackground.php'>French</option>
            <option value='it/gearmanclient.dobackground.php'>Italian</option>
            <option value='ja/gearmanclient.dobackground.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.dobackground.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.dobackground.php'>Russian</option>
            <option value='tr/gearmanclient.dobackground.php'>Turkish</option>
            <option value='uk/gearmanclient.dobackground.php'>Ukrainian</option>
            <option value='zh/gearmanclient.dobackground.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.dobackground" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.dobackground-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::doBackground</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$function</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$workload</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$unique</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dolowbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doLowBackground()</a> - Run a low priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/dobackground.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.dobackground%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.dobackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dobackground.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121534">  <div class="votes">
    <div id="Vu121534">
    <a href="/manual/vote-note.php?id=121534&amp;page=gearmanclient.dobackground&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121534">
    <a href="/manual/vote-note.php?id=121534&amp;page=gearmanclient.dobackground&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121534" title="83% like this...">
    8
    </div>
  </div>
  <a href="#121534" class="name">
  <strong class="user"><em>felix at passcod dot name</em></strong></a><a class="genanchor" href="#121534"> &para;</a><div class="date" title="2017-08-18 01:16"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121534">
<div class="phpcode"><code><span class="html">Behaviour of the unique ID argument:<br /><br />If it's not provided, it defaults to a UUIDv1 (timestamp + mac address).<br /><br />Otherwise, if a job with the same unique ID exists (i.e. is either queued or currently executing), then that job is used, not the one you're submitting. This does not apply to past (completed) jobs, and works across the entire job server pool, assuming no partitioning.<br /><br />Or with code (the values in [brackets] are the server-assigned job identifiers):<br /><br /><span class="default">&lt;?php<br /><br />$gearman</span><span class="keyword">-&gt;</span><span class="default">doBackground</span><span class="keyword">(</span><span class="string">'sleep'</span><span class="keyword">, </span><span class="string">'3'</span><span class="keyword">, </span><span class="string">'123'</span><span class="keyword">); </span><span class="comment">// [H:host:1] Starts sleep(3)<br /></span><span class="default">$gearman</span><span class="keyword">-&gt;</span><span class="default">doBackground</span><span class="keyword">(</span><span class="string">'sleep'</span><span class="keyword">, </span><span class="string">'5'</span><span class="keyword">, </span><span class="string">'456'</span><span class="keyword">); </span><span class="comment">// [H:host:2] Queues sleep(5)<br /></span><span class="default">$gearman</span><span class="keyword">-&gt;</span><span class="default">doBackground</span><span class="keyword">(</span><span class="string">'sleep'</span><span class="keyword">, </span><span class="string">'3'</span><span class="keyword">, </span><span class="string">'123'</span><span class="keyword">); </span><span class="comment">// [H:host:1] Does nothing<br /></span><span class="default">$gearman</span><span class="keyword">-&gt;</span><span class="default">doBackground</span><span class="keyword">(</span><span class="string">'sleep'</span><span class="keyword">, </span><span class="string">'1'</span><span class="keyword">, </span><span class="string">'123'</span><span class="keyword">); </span><span class="comment">// [H:host:1] Also does nothing (diff args don't trigger new jobs)<br /><br /></span><span class="default">sleep </span><span class="keyword">(</span><span class="default">3</span><span class="keyword">);<br /></span><span class="comment">// Job 123 [sleep(3)] has finished by now<br /><br /></span><span class="default">$gearman</span><span class="keyword">-&gt;</span><span class="default">doBackground</span><span class="keyword">(</span><span class="string">'sleep'</span><span class="keyword">, </span><span class="string">'3'</span><span class="keyword">, </span><span class="string">'123'</span><span class="keyword">); </span><span class="comment">// [H:host:3] Starts a new job<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmanclient.dobackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dobackground.php">＋<small>add a note</small></a></div>
