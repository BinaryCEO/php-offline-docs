...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.dohighbackground.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.dohighbackground.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dohighbackground.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.dohigh.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.dojobhandle.php">
...
<meta name="Description" content="Run a high priority task in the background" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doHighBackground - Manual" />
<meta name="twitter:description" content="Run a high priority task in the background" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doHighBackground - Manual" />
<meta itemprop="description" content="Run a high priority task in the background" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a high priority task in the background" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.dohighbackground.php' selected="selected">English</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dolowbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doLowBackground()</a> - Run a low priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/dohighbackground.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.dohighbackground%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.dohighbackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dohighbackground.php">＋<small>add a note</small></a></span>
