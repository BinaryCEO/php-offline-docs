...
<head>
  ...
  <title>PHP: SolrQuery::getFacetQueries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetqueries.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetqueries.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetqueries.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetprefix.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetsort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetqueries.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetqueries.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetqueries.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetqueries.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetqueries.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetqueries.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetqueries.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetqueries.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetqueries.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetqueries.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetqueries.php" hreflang="zh">
...
<meta name="Description" content="Returns all the facet queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetQueries - Manual" />
<meta name="twitter:description" content="Returns all the facet queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetQueries - Manual" />
<meta itemprop="description" content="Returns all the facet queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the facet queries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfacetsort.php">
          SolrQuery::getFacetSort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetprefix.php">
          &laquo; SolrQuery::getFacetPrefix        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetqueries.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetqueries.php'>German</option>
            <option value='es/solrquery.getfacetqueries.php'>Spanish</option>
            <option value='fr/solrquery.getfacetqueries.php'>French</option>
            <option value='it/solrquery.getfacetqueries.php'>Italian</option>
            <option value='ja/solrquery.getfacetqueries.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetqueries.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetqueries.php'>Russian</option>
            <option value='tr/solrquery.getfacetqueries.php'>Turkish</option>
            <option value='uk/solrquery.getfacetqueries.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetqueries.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetqueries" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetQueries</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetQueries</span> &mdash; <span class="dc-title">Returns all the facet queries</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetqueries-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetQueries</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
Returns all the facet queries
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetqueries-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetqueries-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetqueries.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetqueries%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetqueries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetqueries.php">＋<small>add a note</small></a></span>
