...
<head>
  ...
  <title>PHP: streamWrapper::mkdir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.mkdir.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.mkdir.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.mkdir.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.dir-rewinddir.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.rename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.mkdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.mkdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.mkdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.mkdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.mkdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.mkdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.mkdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.mkdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.mkdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.mkdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.mkdir.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: streamWrapper::mkdir - Manual" />
<meta name="twitter:description" content="Create a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::mkdir - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="streamwrapper.rename.php">
          streamWrapper::rename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.dir-rewinddir.php">
          &laquo; streamWrapper::dir_rewinddir        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.mkdir.php' selected="selected">English</option>
            <option value='de/streamwrapper.mkdir.php'>German</option>
            <option value='es/streamwrapper.mkdir.php'>Spanish</option>
            <option value='fr/streamwrapper.mkdir.php'>French</option>
            <option value='it/streamwrapper.mkdir.php'>Italian</option>
            <option value='ja/streamwrapper.mkdir.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.mkdir.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.mkdir.php'>Russian</option>
            <option value='tr/streamwrapper.mkdir.php'>Turkish</option>
            <option value='uk/streamwrapper.mkdir.php'>Ukrainian</option>
            <option value='zh/streamwrapper.mkdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.mkdir" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="streamwrapper.rmdir.php" class="methodname" rel="rdfs-seeAlso">streamwrapper::rmdir()</a> - Removes a directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/mkdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.mkdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.mkdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.mkdir.php">＋<small>add a note</small></a></span>
