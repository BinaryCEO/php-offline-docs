...
<head>
  ...
  <title>PHP: cubrid_bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-bind.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-bind">
 <link rel="alternate" href="https://www.php.net/cubrid-bind" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-close-prepare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-bind.php" hreflang="zh">
...
<meta name="Description" content="Bind variables to a prepared statement as parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_bind - Manual" />
<meta name="twitter:description" content="Bind variables to a prepared statement as parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_bind - Manual" />
<meta itemprop="description" content="Bind variables to a prepared statement as parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bind variables to a prepared statement as parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-close-prepare.php">
          cubrid_close_prepare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.cubrid.php">
          &laquo; CUBRID Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-bind.php' selected="selected">English</option>
            <option value='de/function.cubrid-bind.php'>German</option>
            <option value='es/function.cubrid-bind.php'>Spanish</option>
            <option value='fr/function.cubrid-bind.php'>French</option>
            <option value='it/function.cubrid-bind.php'>Italian</option>
            <option value='ja/function.cubrid-bind.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-bind.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-bind.php'>Russian</option>
            <option value='tr/function.cubrid-bind.php'>Turkish</option>
            <option value='uk/function.cubrid-bind.php'>Ukrainian</option>
            <option value='zh/function.cubrid-bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-bind" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-prepare.php" class="function" rel="rdfs-seeAlso">cubrid_prepare()</a> - Prepare a SQL statement for execution</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-bind.php">＋<small>add a note</small></a></span>
