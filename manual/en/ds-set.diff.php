...
<head>
  ...
  <title>PHP: Ds\Set::diff - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-set.diff.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-set.diff.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.diff.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-set.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-set.count.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-set.filter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.diff.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-set.diff.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-set.diff.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-set.diff.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-set.diff.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-set.diff.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-set.diff.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-set.diff.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-set.diff.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-set.diff.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-set.diff.php" hreflang="zh">
...
<meta name="Description" content="Creates a new set using values that aren't in another set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Set::diff - Manual" />
<meta name="twitter:description" content="Creates a new set using values that aren't in another set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Set::diff - Manual" />
<meta itemprop="description" content="Creates a new set using values that aren't in another set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new set using values that aren't in another set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-set.diff.php' selected="selected">English</option>
            <option value='de/ds-set.diff.php'>German</option>
            <option value='es/ds-set.diff.php'>Spanish</option>
            <option value='fr/ds-set.diff.php'>French</option>
            <option value='it/ds-set.diff.php'>Italian</option>
            <option value='ja/ds-set.diff.php'>Japanese</option>
            <option value='pt_BR/ds-set.diff.php'>Brazilian Portuguese</option>
            <option value='ru/ds-set.diff.php'>Russian</option>
            <option value='tr/ds-set.diff.php'>Turkish</option>
            <option value='uk/ds-set.diff.php'>Ukrainian</option>
            <option value='zh/ds-set.diff.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-set.diff" class="refentry">
...
<div class="examplescode"><pre class="examplescode">object(Ds\Set)#3 (2) {
  ...
  int(2)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/set/diff.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-set.diff%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-set.diff&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-set.diff.php">＋<small>add a note</small></a></span>
