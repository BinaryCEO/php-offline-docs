...
<head>
  ...
  <title>PHP: radius_put_addr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-put-addr.php">
 <link rel="shorturl" href="https://www.php.net/radius-put-addr">
 <link rel="alternate" href="https://www.php.net/radius-put-addr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-get-vendor-attr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-put-attr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-put-addr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-put-addr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-put-addr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-put-addr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-put-addr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-put-addr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-put-addr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-put-addr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-put-addr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-put-addr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-put-addr.php" hreflang="zh">
...
<meta name="Description" content="Attaches an IP address attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_put_addr - Manual" />
<meta name="twitter:description" content="Attaches an IP address attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_put_addr - Manual" />
<meta itemprop="description" content="Attaches an IP address attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Attaches an IP address attribute" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.radius-put-attr.php">
          radius_put_attr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-get-vendor-attr.php">
          &laquo; radius_get_vendor_attr        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-put-addr.php' selected="selected">English</option>
            <option value='de/function.radius-put-addr.php'>German</option>
            <option value='es/function.radius-put-addr.php'>Spanish</option>
            <option value='fr/function.radius-put-addr.php'>French</option>
            <option value='it/function.radius-put-addr.php'>Italian</option>
            <option value='ja/function.radius-put-addr.php'>Japanese</option>
            <option value='pt_BR/function.radius-put-addr.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-put-addr.php'>Russian</option>
            <option value='tr/function.radius-put-addr.php'>Turkish</option>
            <option value='uk/function.radius-put-addr.php'>Ukrainian</option>
            <option value='zh/function.radius-put-addr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-put-addr" class="refentry">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-put-addr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-put-addr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-put-addr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-put-addr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123143">  <div class="votes">
    <div id="Vu123143">
    <a href="/manual/vote-note.php?id=123143&amp;page=function.radius-put-addr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123143">
    <a href="/manual/vote-note.php?id=123143&amp;page=function.radius-put-addr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123143" title="75% like this...">
    2
    </div>
  </div>
  <a href="#123143" class="name">
  <strong class="user"><em>Do-not-spam at me dot nospam dot com</em></strong></a><a class="genanchor" href="#123143"> &para;</a><div class="date" title="2018-09-20 12:43"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123143">
<div class="phpcode"><code><span class="html">radius_put_addr() doesn't support IPv6 yet<br /><br />A workaround is to use radius_put_string when using IPv6</span></code></div>
  </div>
 </div>
  <div class="note" id="129706">  <div class="votes">
    <div id="Vu129706">
    <a href="/manual/vote-note.php?id=129706&amp;page=function.radius-put-addr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129706">
    <a href="/manual/vote-note.php?id=129706&amp;page=function.radius-put-addr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129706" title="100% like this...">
    2
    </div>
  </div>
  <a href="#129706" class="name">
  <strong class="user"><em>zervu1boris at gmail dot com</em></strong></a><a class="genanchor" href="#129706"> &para;</a><div class="date" title="2024-08-14 09:21"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129706">
<div class="phpcode"><code><span class="html">Attaches an IPv6 prefix attribute:<br /><br />$ipv6Prefix = "2001:1111:2222:3333::";<br />$ipv6PrefixLength = "64";<br /><br />// Framed-IPv6-Prefix<br />radius_put_attr($res, 97, chr(0).chr($ipv6PrefixLength).inet_pton($ipv6Prefix));<br /><br />// Delegated-IPv6-Prefix<br />radius_put_attr($res, 123, chr(0).chr($ipv6PrefixLength).inet_pton($ipv6Prefix));</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.radius-put-addr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-put-addr.php">＋<small>add a note</small></a></div>
