...
<head>
  ...
  <title>PHP: streamWrapper::unlink - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.unlink.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.unlink.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.unlink.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-write.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.url-stat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.unlink.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.unlink.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.unlink.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.unlink.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.unlink.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.unlink.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.unlink.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.unlink.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.unlink.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.unlink.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.unlink.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: streamWrapper::unlink - Manual" />
<meta name="twitter:description" content="Delete a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::unlink - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="streamwrapper.url-stat.php">
          streamWrapper::url_stat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-write.php">
          &laquo; streamWrapper::stream_write        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.unlink.php' selected="selected">English</option>
            <option value='de/streamwrapper.unlink.php'>German</option>
            <option value='es/streamwrapper.unlink.php'>Spanish</option>
            <option value='fr/streamwrapper.unlink.php'>French</option>
            <option value='it/streamwrapper.unlink.php'>Italian</option>
            <option value='ja/streamwrapper.unlink.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.unlink.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.unlink.php'>Russian</option>
            <option value='tr/streamwrapper.unlink.php'>Turkish</option>
            <option value='uk/streamwrapper.unlink.php'>Ukrainian</option>
            <option value='zh/streamwrapper.unlink.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.unlink" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">streamWrapper::unlink</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">streamWrapper::unlink</span> &mdash; <span class="dc-title">Delete a file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-streamwrapper.unlink-description">
  ...
  <p class="para rdfs-comment">
   This method is called in response to <span class="function"><a href="function.unlink.php" class="function">unlink()</a></span>.
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="streamwrapper.rmdir.php" class="methodname" rel="rdfs-seeAlso">streamWrapper::rmdir()</a> - Removes a directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/unlink.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.unlink%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.unlink&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.unlink.php">＋<small>add a note</small></a></span>
