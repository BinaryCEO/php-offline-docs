...
<head>
  ...
  <title>PHP: mb_ereg_search_pos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ereg-search-pos.php">
 <link rel="shorturl" href="https://www.php.net/mb-ereg-search-pos">
 <link rel="alternate" href="https://www.php.net/mb-ereg-search-pos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg-search-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg-search-regs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ereg-search-pos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ereg-search-pos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ereg-search-pos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ereg-search-pos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ereg-search-pos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ereg-search-pos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ereg-search-pos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ereg-search-pos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ereg-search-pos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ereg-search-pos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ereg-search-pos.php" hreflang="zh">
...
<meta name="Description" content="Returns position and length of a matched part of the multibyte regular expression for a predefined multibyte string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ereg_search_pos - Manual" />
<meta name="twitter:description" content="Returns position and length of a matched part of the multibyte regular expression for a predefined multibyte string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ereg_search_pos - Manual" />
<meta itemprop="description" content="Returns position and length of a matched part of the multibyte regular expression for a predefined multibyte string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns position and length of a matched part of the multibyte regular expression for a predefined multibyte string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-ereg-search-regs.php">
          mb_ereg_search_regs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg-search-init.php">
          &laquo; mb_ereg_search_init        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ereg-search-pos.php' selected="selected">English</option>
            <option value='de/function.mb-ereg-search-pos.php'>German</option>
            <option value='es/function.mb-ereg-search-pos.php'>Spanish</option>
            <option value='fr/function.mb-ereg-search-pos.php'>French</option>
            <option value='it/function.mb-ereg-search-pos.php'>Italian</option>
            <option value='ja/function.mb-ereg-search-pos.php'>Japanese</option>
            <option value='pt_BR/function.mb-ereg-search-pos.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ereg-search-pos.php'>Russian</option>
            <option value='tr/function.mb-ereg-search-pos.php'>Turkish</option>
            <option value='uk/function.mb-ereg-search-pos.php'>Ukrainian</option>
            <option value='zh/function.mb-ereg-search-pos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ereg-search-pos" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_ereg_search_pos</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_ereg_search_pos</span> &mdash; <span class="dc-title">Returns position and length of a matched part of the multibyte regular expression for a predefined multibyte string</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-ereg-search-pos-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_ereg_search_pos</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$pattern</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.mb-ereg-search-init.php" class="function">mb_ereg_search_init()</a></span>. If it is not specified,
   the previous one will be used.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mb-ereg-search-pos-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-ereg-search-pos-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="simpara">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> containing two elements. The first element is the
 ...
 <div class="refsect1 changelog" id="refsect1-function.mb-ereg-search-pos-changelog">
 ...
 <div class="refsect1 notes" id="refsect1-function.mb-ereg-search-pos-notes">
...
will be used as the character encoding for this function.</p></p></blockquote>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-ereg-search-pos-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-ereg-search-init.php" class="function" rel="rdfs-seeAlso">mb_ereg_search_init()</a> - Setup string and regular expression for a multibyte regular expression match</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ereg-search-pos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ereg-search-pos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ereg-search-pos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-search-pos.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126033">  <div class="votes">
    <div id="Vu126033">
    <a href="/manual/vote-note.php?id=126033&amp;page=function.mb-ereg-search-pos&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126033">
    <a href="/manual/vote-note.php?id=126033&amp;page=function.mb-ereg-search-pos&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126033" title="66% like this...">
    2
    </div>
  </div>
  <a href="#126033" class="name">
  <strong class="user"><em>v dot picture at free dot fr</em></strong></a><a class="genanchor" href="#126033"> &para;</a><div class="date" title="2021-04-22 02:57"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126033">
<div class="phpcode"><code><span class="html">This function is absolutely not multibyte-safe, it actually returns the position of the match as if the string was not multibyte.<br /><br />The results of this function are exactly the same as if you were using preg_match_all with PREG_OFFSET_CAPTURE, even with the "unicode" flag it's simply NOT working<br /><br />(Bug report filed)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-ereg-search-pos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-search-pos.php">＋<small>add a note</small></a></div>
