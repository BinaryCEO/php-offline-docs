...
<head>
  ...
  <title>PHP: fann_create_shortcut_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-create-shortcut-array.php">
 <link rel="shorturl" href="https://www.php.net/fann-create-shortcut-array">
 <link rel="alternate" href="https://www.php.net/fann-create-shortcut-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-create-shortcut.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-sparse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-create-shortcut-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-create-shortcut-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-create-shortcut-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-create-shortcut-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-create-shortcut-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-create-shortcut-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-create-shortcut-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-create-shortcut-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-create-shortcut-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-create-shortcut-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-create-shortcut-array.php" hreflang="zh">
...
<meta name="Description" content="Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_create_shortcut_array - Manual" />
<meta name="twitter:description" content="Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_create_shortcut_array - Manual" />
<meta itemprop="description" content="Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-create-sparse.php">
          fann_create_sparse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-create-shortcut.php">
          &laquo; fann_create_shortcut        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-create-shortcut-array.php' selected="selected">English</option>
            <option value='de/function.fann-create-shortcut-array.php'>German</option>
            <option value='es/function.fann-create-shortcut-array.php'>Spanish</option>
            <option value='fr/function.fann-create-shortcut-array.php'>French</option>
            <option value='it/function.fann-create-shortcut-array.php'>Italian</option>
            <option value='ja/function.fann-create-shortcut-array.php'>Japanese</option>
            <option value='pt_BR/function.fann-create-shortcut-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-create-shortcut-array.php'>Russian</option>
            <option value='tr/function.fann-create-shortcut-array.php'>Turkish</option>
            <option value='uk/function.fann-create-shortcut-array.php'>Ukrainian</option>
            <option value='zh/function.fann-create-shortcut-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-create-shortcut-array" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_create_shortcut_array</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_create_shortcut_array</span> &mdash; <span class="dc-title">Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-create-shortcut-array-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_create_shortcut_array</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$num_layers</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$layers</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-create-shortcut-array-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-create-shortcut-array-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-create-shortcut-array-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-create-standard.php" class="function" rel="rdfs-seeAlso">fann_create_standard()</a> - Creates a standard fully connected backpropagation neural network</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-create-shortcut-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-create-shortcut-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-create-shortcut-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-shortcut-array.php">＋<small>add a note</small></a></span>
