...
<head>
  ...
  <title>PHP: ReflectionClass::getModifiers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getmodifiers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getmodifiers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getmodifiers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getmethods.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getmodifiers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getmodifiers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getmodifiers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getmodifiers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getmodifiers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getmodifiers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getmodifiers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getmodifiers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getmodifiers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getmodifiers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getmodifiers.php" hreflang="zh">
...
<meta name="Description" content="Gets the class modifiers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getModifiers - Manual" />
<meta name="twitter:description" content="Gets the class modifiers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getModifiers - Manual" />
<meta itemprop="description" content="Gets the class modifiers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the class modifiers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getname.php">
          ReflectionClass::getName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getmethods.php">
          &laquo; ReflectionClass::getMethods        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getmodifiers.php' selected="selected">English</option>
            <option value='de/reflectionclass.getmodifiers.php'>German</option>
            <option value='es/reflectionclass.getmodifiers.php'>Spanish</option>
            <option value='fr/reflectionclass.getmodifiers.php'>French</option>
            <option value='it/reflectionclass.getmodifiers.php'>Italian</option>
            <option value='ja/reflectionclass.getmodifiers.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getmodifiers.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getmodifiers.php'>Russian</option>
            <option value='tr/reflectionclass.getmodifiers.php'>Turkish</option>
            <option value='uk/reflectionclass.getmodifiers.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getmodifiers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getmodifiers" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getModifiers</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getModifiers</span> &mdash; <span class="dc-title">Gets the class modifiers</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getmodifiers-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getModifiers</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.getmodifiers-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getmodifiers-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns bitmask of <a href="class.reflectionclass.php#reflectionclass.constants.modifiers" class="link">
   modifier constants</a>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-reflectionclass.getmodifiers-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflection.getmodifiernames.php" class="methodname" rel="rdfs-seeAlso">Reflection::getModifierNames()</a> - Gets modifier names</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getmodifiers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getmodifiers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getmodifiers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getmodifiers.php">＋<small>add a note</small></a></span>
