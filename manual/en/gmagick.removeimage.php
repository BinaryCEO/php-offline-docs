...
<head>
  ...
  <title>PHP: Gmagick::removeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.removeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.removeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.removeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.reducenoiseimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.removeimageprofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.removeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.removeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.removeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.removeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.removeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.removeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.removeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.removeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.removeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.removeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.removeimage.php" hreflang="zh">
...
<meta name="Description" content="Removes an image from the image list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::removeimage - Manual" />
<meta name="twitter:description" content="Removes an image from the image list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::removeimage - Manual" />
<meta itemprop="description" content="Removes an image from the image list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes an image from the image list" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.removeimageprofile.php">
          Gmagick::removeimageprofile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.reducenoiseimage.php">
          &laquo; Gmagick::reducenoiseimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.removeimage.php' selected="selected">English</option>
            <option value='de/gmagick.removeimage.php'>German</option>
            <option value='es/gmagick.removeimage.php'>Spanish</option>
            <option value='fr/gmagick.removeimage.php'>French</option>
            <option value='it/gmagick.removeimage.php'>Italian</option>
            <option value='ja/gmagick.removeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.removeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.removeimage.php'>Russian</option>
            <option value='tr/gmagick.removeimage.php'>Turkish</option>
            <option value='uk/gmagick.removeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.removeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.removeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::removeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::removeimage</span> &mdash; <span class="dc-title">Removes an image from the image list</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.removeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::removeimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.removeimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.removeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.removeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/removeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.removeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.removeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.removeimage.php">＋<small>add a note</small></a></span>
