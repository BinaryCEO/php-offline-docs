...
<head>
  ...
  <title>PHP: EventBufferEvent::setWatermark - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.setwatermark.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.setwatermark.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.setwatermark.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.settimeouts.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.sslerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.setwatermark.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventbufferevent.setwatermark.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventbufferevent.setwatermark.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventbufferevent.setwatermark.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventbufferevent.setwatermark.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventbufferevent.setwatermark.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventbufferevent.setwatermark.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventbufferevent.setwatermark.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventbufferevent.setwatermark.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventbufferevent.setwatermark.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventbufferevent.setwatermark.php" hreflang="zh">
...
<meta name="Description" content="Adjusts read and/or write watermarks" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventBufferEvent::setWatermark - Manual" />
<meta name="twitter:description" content="Adjusts read and/or write watermarks" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventBufferEvent::setWatermark - Manual" />
<meta itemprop="description" content="Adjusts read and/or write watermarks" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjusts read and/or write watermarks" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventbufferevent.sslerror.php">
          EventBufferEvent::sslError &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventbufferevent.settimeouts.php">
          &laquo; EventBufferEvent::setTimeouts        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.setwatermark.php' selected="selected">English</option>
            <option value='de/eventbufferevent.setwatermark.php'>German</option>
            <option value='es/eventbufferevent.setwatermark.php'>Spanish</option>
            <option value='fr/eventbufferevent.setwatermark.php'>French</option>
            <option value='it/eventbufferevent.setwatermark.php'>Italian</option>
            <option value='ja/eventbufferevent.setwatermark.php'>Japanese</option>
            <option value='pt_BR/eventbufferevent.setwatermark.php'>Brazilian Portuguese</option>
            <option value='ru/eventbufferevent.setwatermark.php'>Russian</option>
            <option value='tr/eventbufferevent.setwatermark.php'>Turkish</option>
            <option value='uk/eventbufferevent.setwatermark.php'>Ukrainian</option>
            <option value='zh/eventbufferevent.setwatermark.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventbufferevent.setwatermark" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">EventBufferEvent::setWatermark</h1>
  <p class="verinfo">(PECL event &gt;= 1.2.6-beta)</p><p class="refpurpose"><span class="refname">EventBufferEvent::setWatermark</span> &mdash; <span class="dc-title">Adjusts read and/or write watermarks</span></p>
 ...
 <div class="refsect1 description" id="refsect1-eventbufferevent.setwatermark-description">
  ...
  <p class="para">
   ...
   <a href="http://www.wangafu.net/~nickm/libevent-book/Ref6_bufferevent.html#_callbacks_and_watermarks" class="link external">&raquo;&nbsp;Fast
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/setwatermark.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.setwatermark%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.setwatermark&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.setwatermark.php">＋<small>add a note</small></a></span>
