...
<head>
  ...
  <title>PHP: Covariance and Contravariance - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.oop5.variance.php">
 <link rel="shorturl" href="https://www.php.net/oop5.variance">
 <link rel="alternate" href="https://www.php.net/oop5.variance" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.oop5.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.oop5.serialization.php">
 <link rel="next" href="https://www.php.net/manual/en/language.oop5.lazy-objects.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.oop5.variance.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.oop5.variance.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.oop5.variance.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.oop5.variance.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.oop5.variance.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.oop5.variance.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.oop5.variance.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.oop5.variance.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.oop5.variance.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.oop5.variance.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.oop5.variance.php" hreflang="zh">
...
<meta name="Description" content="Covariance and Contravariance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Covariance and Contravariance - Manual" />
<meta name="twitter:description" content="Covariance and Contravariance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Covariance and Contravariance - Manual" />
<meta itemprop="description" content="Covariance and Contravariance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Covariance and Contravariance" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.oop5.variance.php' selected="selected">English</option>
            <option value='de/language.oop5.variance.php'>German</option>
            <option value='es/language.oop5.variance.php'>Spanish</option>
            <option value='fr/language.oop5.variance.php'>French</option>
            <option value='it/language.oop5.variance.php'>Italian</option>
            <option value='ja/language.oop5.variance.php'>Japanese</option>
            <option value='pt_BR/language.oop5.variance.php'>Brazilian Portuguese</option>
            <option value='ru/language.oop5.variance.php'>Russian</option>
            <option value='tr/language.oop5.variance.php'>Turkish</option>
            <option value='uk/language.oop5.variance.php'>Ukrainian</option>
            <option value='zh/language.oop5.variance.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.oop5.variance" class="sect1">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class </span><span style="color: #0000BB">Animal </span><span style="color: #007700">{}<br />class </span><span style="color: #0000BB">Dog </span><span style="color: #007700">extends </span><span style="color: #0000BB">Animal </span><span style="color: #007700">{}<br />class </span><span style="color: #0000BB">Poodle </span><span style="color: #007700">extends </span><span style="color: #0000BB">Dog </span><span style="color: #007700">{}<br /><br />interface </span><span style="color: #0000BB">PetOwner<br /></span><span style="color: #007700">{<br />    </span><span style="color: #FF8000">// Only a get operation is required, so this may be covariant.<br />    </span><span style="color: #007700">public </span><span style="color: #0000BB">Animal $pet </span><span style="color: #007700">{ </span><span style="color: #0000BB">get</span><span style="color: #007700">; }<br />}<br /><br />class </span><span style="color: #0000BB">DogOwner </span><span style="color: #007700">implements </span><span style="color: #0000BB">PetOwner<br /></span><span style="color: #007700">{<br />    </span><span style="color: #FF8000">// This may be a more restrictive type since the "get" side<br />    // still returns an Animal.  However, as a native property<br />    // children of this class may not change the type anymore.<br />    </span><span style="color: #007700">public </span><span style="color: #0000BB">Dog $pet</span><span style="color: #007700">;<br />}<br /><br />class </span><span style="color: #0000BB">PoodleOwner </span><span style="color: #007700">extends </span><span style="color: #0000BB">DogOwner<br /></span><span style="color: #007700">{<br />    </span><span style="color: #FF8000">// This is NOT ALLOWED, because DogOwner::$pet has both<br />    // get and set operations defined and required.<br />    </span><span style="color: #007700">public </span><span style="color: #0000BB">Poodle $pet</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/oop5/variance.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.oop5.variance%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.variance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.variance.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124609">  <div class="votes">
    <div id="Vu124609">
    <a href="/manual/vote-note.php?id=124609&amp;page=language.oop5.variance&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124609">
    <a href="/manual/vote-note.php?id=124609&amp;page=language.oop5.variance&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124609" title="92% like this...">
    98
    </div>
  </div>
  <a href="#124609" class="name">
  <strong class="user"><em>xedin dot unknown at gmail dot com</em></strong></a><a class="genanchor" href="#124609"> &para;</a><div class="date" title="2020-01-13 04:20"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124609">
<div class="phpcode"><code><span class="html">I would like to explain why covariance and contravariance are important, and why they apply to return types and parameter types respectively, and not the other way around.<br /><br />Covariance is probably easiest to understand, and is directly related to the Liskov Substitution Principle. Using the above example, let's say that we receive an `AnimalShelter` object, and then we want to use it by invoking its `adopt()` method. We know that it returns an `Animal` object, and no matter what exactly that object is, i.e. whether it is a `Cat` or a `Dog`, we can treat them the same. Therefore, it is OK to specialize the return type: we know at least the common interface of any thing that can be returned, and we can treat all of those values in the same way.<br /><br />Contravariance is slightly more complicated. It is related very much to the practicality of increasing the flexibility of a method. Using the above example again, perhaps the "base" method `eat()` accepts a specific type of food; however, a _particular_ animal may want to support a _wider range_ of food types. Maybe it, like in the above example, adds functionality to the original method that allows it to consume _any_ kind of food, not just that meant for animals. The "base" method in `Animal` already implements the functionality allowing it to consume food specialized for animals. The overriding method in the `Dog` class can check if the parameter is of type `AnimalFood`, and simply invoke `parent::eat($food)`. If the parameter is _not_ of the specialized type, it can perform additional or even completely different processing of that parameter - without breaking the original signature, because it _still_ handles the specialized type, but also more. That's why it is also related closely to the Liskov Substitution: consumers may still pass a specialized food type to the `Animal` without knowing exactly whether it is a `Cat` or `Dog`.</span></code></div>
  </div>
 </div>
  <div class="note" id="127860">  <div class="votes">
    <div id="Vu127860">
    <a href="/manual/vote-note.php?id=127860&amp;page=language.oop5.variance&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127860">
    <a href="/manual/vote-note.php?id=127860&amp;page=language.oop5.variance&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127860" title="78% like this...">
    8
    </div>
  </div>
  <a href="#127860" class="name">
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#127860"> &para;</a><div class="date" title="2022-10-26 12:48"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127860">
<div class="phpcode"><code><span class="html">The gist of how the Liskov Substition Princple applies to class types is, basically: "If an object is an instance of something, it should be possible to use it wherever an instance of something is allowed". The Co- and Contravariance rules come from this expectation when you remember that "something" could be a parent class of the object.<br /><br />For the Cat/Animal example of the text, Cats are Animals, so it should be possible for Cats to go anywhere Animals can go. The variance rules formalise this.<br /><br />Covariance: A subclass can override a method in the parent class with one that has a narrower return type. (Return values can be more specific in more specific subclasses; they "vary in the same direction", hence "covariant").<br />If an object has a method you expect to produce Animals, you should be able to replace it with an object where that method produces only Cats. You'll only get Cats from it but Cats are Animals, which are what you expected from the object.<br /><br />Contravariance: A subclass can override a method in the parent class with one that has a parameter with a wider type. (Parameters can be less specific in more specific subclasses; they "vary in the opposite direction", hence "contravariant").<br />If an object has a method you expect to take Cats, you should be able to replace it with an object where that method takes any sort of Animal. You'll only be giving it Cats but Cats are Animals, which are what the object expected from you.<br /><br />So, if your code is working with an object of a certain class, and it's given an instance of a subclass to work with, it shouldn't cause any trouble:<br />It might accept any sort of Animal where you're only giving it Cats, or it might only return Cats when you're happy to receive any sort of Animal, but LSP says "so what? Cats are Animals so you should both be satisfied."</span></code></div>
  </div>
 </div>
  <div class="note" id="124712">  <div class="votes">
    <div id="Vu124712">
    <a href="/manual/vote-note.php?id=124712&amp;page=language.oop5.variance&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124712">
    <a href="/manual/vote-note.php?id=124712&amp;page=language.oop5.variance&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124712" title="69% like this...">
    9
    </div>
  </div>
  <a href="#124712" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#124712"> &para;</a><div class="date" title="2020-02-12 08:47"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124712">
<div class="phpcode"><code><span class="html">Covariance also works with general type-hinting, note also the interface:<br /><br />interface xInterface<br />{<br />    public function y() : object;<br />}<br /><br />abstract class x implements xInterface<br />{<br />    abstract public function y() : object;<br />}<br /><br />class a extends x<br />{<br />    public function y() : \DateTime<br />    {<br />        return new \DateTime("now");<br />    }<br />}<br /><br />$a = new a;<br />echo '&lt;pre&gt;';<br />var_dump($a-&gt;y());<br />echo '&lt;/pre&gt;';</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.oop5.variance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.variance.php">＋<small>add a note</small></a></div>
