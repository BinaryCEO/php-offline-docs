...
<head>
  ...
  <title>PHP: Imagick::setPointSize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setpointsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setpointsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setpointsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setpage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setprogressmonitor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setpointsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setpointsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setpointsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setpointsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setpointsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setpointsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setpointsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setpointsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setpointsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setpointsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setpointsize.php" hreflang="zh">
...
<meta name="Description" content="Sets point size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setPointSize - Manual" />
<meta name="twitter:description" content="Sets point size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setPointSize - Manual" />
<meta itemprop="description" content="Sets point size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets point size" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setprogressmonitor.php">
          Imagick::setProgressMonitor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setpage.php">
          &laquo; Imagick::setPage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setpointsize.php' selected="selected">English</option>
            <option value='de/imagick.setpointsize.php'>German</option>
            <option value='es/imagick.setpointsize.php'>Spanish</option>
            <option value='fr/imagick.setpointsize.php'>French</option>
            <option value='it/imagick.setpointsize.php'>Italian</option>
            <option value='ja/imagick.setpointsize.php'>Japanese</option>
            <option value='pt_BR/imagick.setpointsize.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setpointsize.php'>Russian</option>
            <option value='tr/imagick.setpointsize.php'>Turkish</option>
            <option value='uk/imagick.setpointsize.php'>Ukrainian</option>
            <option value='zh/imagick.setpointsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setpointsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setPointSize</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.1.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setPointSize</span> &mdash; <span class="dc-title">Sets point size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setpointsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setPointSize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$point_size</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setpointsize-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setpointsize-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create new imagick object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* Set the font for the object */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFont</span><span style="color: #007700">(</span><span style="color: #DD0000">"example.ttf"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set the point size */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setPointSize</span><span style="color: #007700">(</span><span style="color: #0000BB">12</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Create new caption */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #DD0000">"caption:Hello"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Do something with the image */<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setpointsize-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.getpointsize.php" class="function" rel="rdfs-seeAlso">Imagick::getPointSize()</a> - Gets point size</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setpointsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setpointsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setpointsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setpointsize.php">＋<small>add a note</small></a></span>
