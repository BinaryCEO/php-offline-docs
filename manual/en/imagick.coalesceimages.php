...
<head>
  ...
  <title>PHP: Imagick::coalesceImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.coalesceimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.coalesceimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.coalesceimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clutimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.colorfloodfillimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.coalesceimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.coalesceimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.coalesceimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.coalesceimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.coalesceimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.coalesceimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.coalesceimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.coalesceimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.coalesceimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.coalesceimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.coalesceimages.php" hreflang="zh">
...
<meta name="Description" content="Composites a set of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::coalesceImages - Manual" />
<meta name="twitter:description" content="Composites a set of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::coalesceImages - Manual" />
<meta itemprop="description" content="Composites a set of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Composites a set of images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.colorfloodfillimage.php">
          Imagick::colorFloodfillImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clutimage.php">
          &laquo; Imagick::clutImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.coalesceimages.php' selected="selected">English</option>
            <option value='de/imagick.coalesceimages.php'>German</option>
            <option value='es/imagick.coalesceimages.php'>Spanish</option>
            <option value='fr/imagick.coalesceimages.php'>French</option>
            <option value='it/imagick.coalesceimages.php'>Italian</option>
            <option value='ja/imagick.coalesceimages.php'>Japanese</option>
            <option value='pt_BR/imagick.coalesceimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.coalesceimages.php'>Russian</option>
            <option value='tr/imagick.coalesceimages.php'>Turkish</option>
            <option value='uk/imagick.coalesceimages.php'>Ukrainian</option>
            <option value='zh/imagick.coalesceimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.coalesceimages" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/coalesceimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.coalesceimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.coalesceimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.coalesceimages.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110393">  <div class="votes">
    <div id="Vu110393">
    <a href="/manual/vote-note.php?id=110393&amp;page=imagick.coalesceimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110393">
    <a href="/manual/vote-note.php?id=110393&amp;page=imagick.coalesceimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110393" title="57% like this...">
    6
    </div>
  </div>
  <a href="#110393" class="name">
  <strong class="user"><em>ktr</em></strong></a><a class="genanchor" href="#110393"> &para;</a><div class="date" title="2012-10-17 08:06"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110393">
<div class="phpcode"><code><span class="html">resize and/or crop an animated GIF
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="103751">  <div class="votes">
    <div id="Vu103751">
    <a href="/manual/vote-note.php?id=103751&amp;page=imagick.coalesceimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103751">
    <a href="/manual/vote-note.php?id=103751&amp;page=imagick.coalesceimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103751" title="56% like this...">
    2
    </div>
  </div>
  <a href="#103751" class="name">
  <strong class="user"><em>vikomic at gmail dot com</em></strong></a><a class="genanchor" href="#103751"> &para;</a><div class="date" title="2011-05-02 03:58"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103751">
<div class="phpcode"><code><span class="html">Here goes an exaple how to resize GIF-s.<br /><br /><span class="default">&lt;?php<br />$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"original.gif"</span><span class="keyword">);<br /><br /></span><span class="default">$format </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImageFormat</span><span class="keyword">();<br />if (</span><span class="default">$format </span><span class="keyword">== </span><span class="string">'GIF'</span><span class="keyword">) {<br />  </span><span class="default">$imagick </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">coalesceImages</span><span class="keyword">();<br />  do {<br />     </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">resizeImage</span><span class="keyword">(</span><span class="default">120</span><span class="keyword">, </span><span class="default">120</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">FILTER_BOX</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />  } while (</span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">nextImage</span><span class="keyword">());<br />  </span><span class="default">$imagick </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">deconstructImages</span><span class="keyword">();<br />  </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'new_120x120.gif'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br />  </span><span class="comment">// can be added some more gifs<br />  </span><span class="default">$imagick </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">coalesceImages</span><span class="keyword">();<br />  do {<br />     </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">resizeImage</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">FILTER_BOX</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />  } while (</span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">nextImage</span><span class="keyword">());<br />  </span><span class="default">$imagick </span><span class="keyword">= </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">deconstructImages</span><span class="keyword">();<br />  </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'new_100x100.gif'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />}<br /><br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">clear</span><span class="keyword">();<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();<br /></span><span class="default">?&gt;<br /></span><br />You can use any resize method (resizeImage) with this example.<br /><br />This example works fine with *imagick module version 2.2.1-dev*, but doesn't work correctly with *imagick module version 3.0.1*.</span></code></div>
  </div>
 </div>
  <div class="note" id="118800">  <div class="votes">
    <div id="Vu118800">
    <a href="/manual/vote-note.php?id=118800&amp;page=imagick.coalesceimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118800">
    <a href="/manual/vote-note.php?id=118800&amp;page=imagick.coalesceimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118800" title="60% like this...">
    1
    </div>
  </div>
  <a href="#118800" class="name">
  <strong class="user"><em>Anony</em></strong></a><a class="genanchor" href="#118800"> &para;</a><div class="date" title="2016-02-08 04:09"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118800">
<div class="phpcode"><code><span class="html">If you wish to open an animated gif, don't ping the image with $imagick-&gt;pingImage(), you will get the same amount of frames you have in the gif, added to the start - but they're all black with stripes. So you have then double the amounts of frames the gif actually has.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.coalesceimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.coalesceimages.php">＋<small>add a note</small></a></div>
