...
<head>
  ...
  <title>PHP: gmp_div_q - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-div-q.php">
 <link rel="shorturl" href="https://www.php.net/gmp-div-q">
 <link rel="alternate" href="https://www.php.net/gmp-div-q" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-div.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-div-qr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-div-q.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-div-q.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-div-q.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-div-q.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-div-q.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-div-q.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-div-q.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-div-q.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-div-q.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-div-q.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-div-q.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: gmp_div_q - Manual" />
<meta name="twitter:description" content="Divide numbers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_div_q - Manual" />
<meta itemprop="description" content="Divide numbers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Divide numbers" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-div-q.php' selected="selected">English</option>
            <option value='de/function.gmp-div-q.php'>German</option>
            <option value='es/function.gmp-div-q.php'>Spanish</option>
            <option value='fr/function.gmp-div-q.php'>French</option>
            <option value='it/function.gmp-div-q.php'>Italian</option>
            <option value='ja/function.gmp-div-q.php'>Japanese</option>
            <option value='pt_BR/function.gmp-div-q.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-div-q.php'>Russian</option>
            <option value='tr/function.gmp-div-q.php'>Turkish</option>
            <option value='uk/function.gmp-div-q.php'>Ukrainian</option>
            <option value='zh/function.gmp-div-q.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-div-q" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_div_q</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_div_q</span> &mdash; <span class="dc-title">Divide numbers</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-div-q-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_div_q</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rounding_mode</code><span class="initializer"> = <strong><code><a href="gmp.constants.php#constant.gmp-round-zero">GMP_ROUND_ZERO</a></code></strong></span></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>

  <p class="para rdfs-comment">
   Divides <code class="parameter">num1</code> by <code class="parameter">num2</code> and
   returns the integer result. 
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-div-q-parameters">
 ...
 base detection (i.e. when <code class="parameter">base</code> is equal to 0).
     ...
     <dd>
      <p class="para">
       ...
       <code class="parameter">rounding_mode</code>, which can have the following
       values:
       <ul class="itemizedlist">
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="gmp.constants.php#constant.gmp-round-zero">GMP_ROUND_ZERO</a></code></strong>: The result is truncated
          towards 0.
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="gmp.constants.php#constant.gmp-round-plusinf">GMP_ROUND_PLUSINF</a></code></strong>: The result is
          rounded towards <code class="literal">+infinity</code>.
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="gmp.constants.php#constant.gmp-round-minusinf">GMP_ROUND_MINUSINF</a></code></strong>: The result is
          rounded towards <code class="literal">-infinity</code>.
         </span>
        </li>
       </ul>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-div-q-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-div-q-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3318">
    <p><strong>Example #1 <span class="function"><strong>gmp_div_q()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">20
0
1
0
-1</pre>
 ...
 <div class="refsect1 notes" id="refsect1-function.gmp-div-q-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function can also be called as <span class="function"><a href="function.gmp-div.php" class="function">gmp_div()</a></span>.
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.gmp-div-q-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-div-qr.php" class="function" rel="rdfs-seeAlso">gmp_div_qr()</a> - Divide numbers and get quotient and remainder</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-div-q.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-div-q%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-div-q&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-div-q.php">＋<small>add a note</small></a></span>
