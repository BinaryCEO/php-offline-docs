...
<head>
  ...
  <title>PHP: imap_mime_header_decode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-mime-header-decode.php">
 <link rel="shorturl" href="https://www.php.net/imap-mime-header-decode">
 <link rel="alternate" href="https://www.php.net/imap-mime-header-decode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-mailboxmsginfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-msgno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-mime-header-decode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-mime-header-decode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-mime-header-decode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-mime-header-decode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-mime-header-decode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-mime-header-decode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-mime-header-decode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-mime-header-decode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-mime-header-decode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-mime-header-decode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-mime-header-decode.php" hreflang="zh">
...
<meta name="Description" content="Decode MIME header elements" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_mime_header_decode - Manual" />
<meta name="twitter:description" content="Decode MIME header elements" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_mime_header_decode - Manual" />
<meta itemprop="description" content="Decode MIME header elements" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decode MIME header elements" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-msgno.php">
          imap_msgno &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-mailboxmsginfo.php">
          &laquo; imap_mailboxmsginfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-mime-header-decode.php' selected="selected">English</option>
            <option value='de/function.imap-mime-header-decode.php'>German</option>
            <option value='es/function.imap-mime-header-decode.php'>Spanish</option>
            <option value='fr/function.imap-mime-header-decode.php'>French</option>
            <option value='it/function.imap-mime-header-decode.php'>Italian</option>
            <option value='ja/function.imap-mime-header-decode.php'>Japanese</option>
            <option value='pt_BR/function.imap-mime-header-decode.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-mime-header-decode.php'>Russian</option>
            <option value='tr/function.imap-mime-header-decode.php'>Turkish</option>
            <option value='uk/function.imap-mime-header-decode.php'>Ukrainian</option>
            <option value='zh/function.imap-mime-header-decode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-mime-header-decode" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_mime_header_decode</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_mime_header_decode</span> &mdash; <span class="dc-title">Decode MIME header elements</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-mime-header-decode-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_mime_header_decode</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Decodes MIME message header extensions that are non ASCII text (see <a href="https://datatracker.ietf.org/doc/html/rfc2047" class="link external">&raquo;&nbsp;RFC2047</a>).
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-mime-header-decode-returnvalues">
  ...
  <p class="para">
   ...
   object has two properties, <code class="literal">charset</code> and 
   <code class="literal">text</code>.
  </p>
  <p class="para">
   If the element hasn&#039;t been encoded, and in other words is in
   plain US-ASCII, the <code class="literal">charset</code> property of that element is
   set to <code class="literal">default</code>.
  </p>
  <p class="para">
...
<div class="examplescode"><pre class="examplescode">Charset: ISO-8859-1
Text: Keld Jørn Simonsen

Charset: default
Text:  &lt;keld@example.com&gt;</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-mime-header-decode-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-utf8.php" class="function" rel="rdfs-seeAlso">imap_utf8()</a> - Converts MIME-encoded text to UTF-8</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-mime-header-decode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-mime-header-decode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-mime-header-decode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mime-header-decode.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111564">  <div class="votes">
    <div id="Vu111564">
    <a href="/manual/vote-note.php?id=111564&amp;page=function.imap-mime-header-decode&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111564">
    <a href="/manual/vote-note.php?id=111564&amp;page=function.imap-mime-header-decode&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111564" title="84% like this...">
    9
    </div>
  </div>
  <a href="#111564" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#111564"> &para;</a><div class="date" title="2013-03-04 09:42"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111564">
<div class="phpcode"><code><span class="html">A nice way to decode strings is to use the mb_list_encodings(), but I had two problems with it: <br />sometimes, the charset is uppercase in the header an lowercase in mb_list_encodings() and sometimes, the charset is not in the mb_list_encodings() list.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">upperListEncode</span><span class="keyword">() { </span><span class="comment">//convert mb_list_encodings() to uppercase<br />    </span><span class="default">$encodes</span><span class="keyword">=</span><span class="default">mb_list_encodings</span><span class="keyword">();<br />    foreach (</span><span class="default">$encodes </span><span class="keyword">as </span><span class="default">$encode</span><span class="keyword">) </span><span class="default">$tencode</span><span class="keyword">[]=</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$encode</span><span class="keyword">);<br />    return </span><span class="default">$tencode</span><span class="keyword">;<br />    }<br /><br />function </span><span class="default">decode</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">) {<br />    </span><span class="default">$tabChaine</span><span class="keyword">=</span><span class="default">imap_mime_header_decode</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);<br />    </span><span class="default">$texte</span><span class="keyword">=</span><span class="string">''</span><span class="keyword">;<br />    for (</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">count</span><span class="keyword">(</span><span class="default">$tabChaine</span><span class="keyword">); </span><span class="default">$i</span><span class="keyword">++) {<br />        <br />        switch (</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">charset</span><span class="keyword">)) { </span><span class="comment">//convert charset to uppercase<br />            </span><span class="keyword">case </span><span class="string">'UTF-8'</span><span class="keyword">: </span><span class="default">$texte</span><span class="keyword">.= </span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">text</span><span class="keyword">; </span><span class="comment">//utf8 is ok<br />                </span><span class="keyword">break;<br />            case </span><span class="string">'DEFAULT'</span><span class="keyword">: </span><span class="default">$texte</span><span class="keyword">.= </span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">text</span><span class="keyword">; </span><span class="comment">//no convert<br />                </span><span class="keyword">break;<br />            default: if (</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">charset</span><span class="keyword">),</span><span class="default">upperListEncode</span><span class="keyword">())) </span><span class="comment">//found in mb_list_encodings()<br />                        </span><span class="keyword">{</span><span class="default">$texte</span><span class="keyword">.= </span><span class="default">mb_convert_encoding</span><span class="keyword">(</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">text</span><span class="keyword">,</span><span class="string">'UTF-8'</span><span class="keyword">,</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">charset</span><span class="keyword">);}<br />                     else { </span><span class="comment">//try to convert with iconv()<br />                          </span><span class="default">$ret </span><span class="keyword">= </span><span class="default">iconv</span><span class="keyword">(</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">charset</span><span class="keyword">, </span><span class="string">"UTF-8"</span><span class="keyword">, </span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">text</span><span class="keyword">);    <br />                          if (!</span><span class="default">$ret</span><span class="keyword">) </span><span class="default">$texte</span><span class="keyword">.=</span><span class="default">$tabChaine</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">text</span><span class="keyword">;  </span><span class="comment">//an error occurs (unknown charset) <br />                          </span><span class="keyword">else </span><span class="default">$texte</span><span class="keyword">.=</span><span class="default">$ret</span><span class="keyword">;<br />                        }                    <br />                break;<br />            }<br />        }<br />        <br />    return </span><span class="default">$texte</span><span class="keyword">;    <br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-mime-header-decode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mime-header-decode.php">＋<small>add a note</small></a></div>
