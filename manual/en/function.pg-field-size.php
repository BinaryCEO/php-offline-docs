...
<head>
  ...
  <title>PHP: pg_field_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-field-size.php">
 <link rel="shorturl" href="https://www.php.net/pg-field-size">
 <link rel="alternate" href="https://www.php.net/pg-field-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-field-prtlen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-field-table.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-field-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-field-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-field-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-field-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-field-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-field-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-field-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-field-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-field-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-field-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-field-size.php" hreflang="zh">
...
<meta name="Description" content="Returns the internal storage size of the named field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_field_size - Manual" />
<meta name="twitter:description" content="Returns the internal storage size of the named field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_field_size - Manual" />
<meta itemprop="description" content="Returns the internal storage size of the named field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the internal storage size of the named field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-field-table.php">
          pg_field_table &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-field-prtlen.php">
          &laquo; pg_field_prtlen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-field-size.php' selected="selected">English</option>
            <option value='de/function.pg-field-size.php'>German</option>
            <option value='es/function.pg-field-size.php'>Spanish</option>
            <option value='fr/function.pg-field-size.php'>French</option>
            <option value='it/function.pg-field-size.php'>Italian</option>
            <option value='ja/function.pg-field-size.php'>Japanese</option>
            <option value='pt_BR/function.pg-field-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-field-size.php'>Russian</option>
            <option value='tr/function.pg-field-size.php'>Turkish</option>
            <option value='uk/function.pg-field-size.php'>Ukrainian</option>
            <option value='zh/function.pg-field-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-field-size" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-field-size-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_field_size</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_field_size()</strong></span> returns the internal storage
   size (in bytes) of the field number in the given PostgreSQL
   <code class="parameter">result</code>.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_fieldsize()</strong></span>.
   </p>
  </p></blockquote>
 </div>
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-field-size-changelog">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-field-type.php" class="function" rel="rdfs-seeAlso">pg_field_type()</a> - Returns the type name for the corresponding field number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-field-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-field-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-field-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-size.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="53820">  <div class="votes">
    <div id="Vu53820">
    <a href="/manual/vote-note.php?id=53820&amp;page=function.pg-field-size&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53820">
    <a href="/manual/vote-note.php?id=53820&amp;page=function.pg-field-size&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53820" title="no votes...">
    0
    </div>
  </div>
  <a href="#53820" class="name">
  <strong class="user"><em>ij at NOSPAM dot irj dot co dot za</em></strong></a><a class="genanchor" href="#53820"> &para;</a><div class="date" title="2005-06-14 04:21"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53820">
<div class="phpcode"><code><span class="html">To view the file structure of a table using a sql query<br /><br />select pg_class.relname, pg_attribute.attname, pg_type.typname, pg_type.typlen from pg_class, pg_attribute, pg_type  where pg_class.relname = 'YOURTABLENAME' and pg_class.oid = pg_attribute.attrelid and pg_type.oid = pg_attribute.atttypid having attnum &gt; 0</span></code></div>
  </div>
 </div>
  <div class="note" id="50271">  <div class="votes">
    <div id="Vu50271">
    <a href="/manual/vote-note.php?id=50271&amp;page=function.pg-field-size&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd50271">
    <a href="/manual/vote-note.php?id=50271&amp;page=function.pg-field-size&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V50271" title="no votes...">
    0
    </div>
  </div>
  <a href="#50271" class="name">
  <strong class="user"><em>php at tribun dot de</em></strong></a><a class="genanchor" href="#50271"> &para;</a><div class="date" title="2005-02-23 05:49"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom50271">
<div class="phpcode"><code><span class="html">function get_create_syntax( $table )<br />{<br />  $qry  =  "<br />            SELECT    *<br />            FROM      $table<br />            LIMIT     1<br />          ";<br />  $res = pg_query( $qry );<br />  $row = pg_fetch_assoc( $res );<br /><br />  $create = "CREATE TABLE $table \n(\n";<br /><br />  $item = array();<br />  for( $i = 0; $i &lt; count( $row ); $i++ )<br />  {<br />    $name = pg_field_name( $res, $i );<br />    $type = pg_field_type( $res, $i );<br />    $size = pg_field_size( $res, $i );<br /><br />    $item[$i] = '"'.$name.'" '.$type;<br /><br />    $qry  =  "<br />              SELECT    a.atttypmod    AS size,<br />                        a.attnotnull  AS notnull<br />              FROM      pg_attribute  AS a,<br />                        pg_class      AS c<br />              WHERE     c.relname   = '$table'<br />              AND       a.attrelid  =  c.oid<br />              AND       a.attname    =  '$name'<br />             ";<br />    $res2  = pg_query( $qry );<br />    $out  = pg_fetch_object( $res2 );<br /><br />    if( $out -&gt; size != -1 )<br />    {<br />      $item[$i] .= '('.( $out -&gt; size - 4 ).')';<br />    }<br />    if( $out -&gt; notnull == 't' )<br />    $item[$i] .= ' NOT';<br /><br />    $item[$i] .= ' NULL';<br /><br />  }<br />  $create .= implode( ",\n", $item ) ."\n);";<br /><br />  return $create;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="22872">  <div class="votes">
    <div id="Vu22872">
    <a href="/manual/vote-note.php?id=22872&amp;page=function.pg-field-size&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd22872">
    <a href="/manual/vote-note.php?id=22872&amp;page=function.pg-field-size&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V22872" title="0% like this...">
    -3
    </div>
  </div>
  <a href="#22872" class="name">
  <strong class="user"><em>alex at linuxNOSPAM dot org dot pe</em></strong></a><a class="genanchor" href="#22872"> &para;</a><div class="date" title="2002-07-02 09:44"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom22872">
<div class="phpcode"><code><span class="html">How i can extract the struct of a Postgresql Table?<br /><br />I want to do a dynamic php code, that see the pg table, and print name, type and size of fields</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-field-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-size.php">＋<small>add a note</small></a></div>
