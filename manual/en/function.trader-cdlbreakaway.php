...
<head>
  ...
  <title>PHP: trader_cdlbreakaway - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdlbreakaway.php">
 <link rel="shorturl" href="https://www.php.net/trader-cdlbreakaway">
 <link rel="alternate" href="https://www.php.net/trader-cdlbreakaway" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdlbelthold.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdlclosingmarubozu.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cdlbreakaway.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cdlbreakaway.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cdlbreakaway.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cdlbreakaway.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cdlbreakaway.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cdlbreakaway.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cdlbreakaway.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cdlbreakaway.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cdlbreakaway.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cdlbreakaway.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cdlbreakaway.php" hreflang="zh">
...
<meta name="Description" content="Breakaway" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cdlbreakaway - Manual" />
<meta name="twitter:description" content="Breakaway" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cdlbreakaway - Manual" />
<meta itemprop="description" content="Breakaway" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-cdlclosingmarubozu.php">
          trader_cdlclosingmarubozu &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-cdlbelthold.php">
          &laquo; trader_cdlbelthold        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdlbreakaway.php' selected="selected">English</option>
            <option value='de/function.trader-cdlbreakaway.php'>German</option>
            <option value='es/function.trader-cdlbreakaway.php'>Spanish</option>
            <option value='fr/function.trader-cdlbreakaway.php'>French</option>
            <option value='it/function.trader-cdlbreakaway.php'>Italian</option>
            <option value='ja/function.trader-cdlbreakaway.php'>Japanese</option>
            <option value='pt_BR/function.trader-cdlbreakaway.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cdlbreakaway.php'>Russian</option>
            <option value='tr/function.trader-cdlbreakaway.php'>Turkish</option>
            <option value='uk/function.trader-cdlbreakaway.php'>Ukrainian</option>
            <option value='zh/function.trader-cdlbreakaway.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cdlbreakaway" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cdlbreakaway</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdlbreakaway</span> &mdash; <span class="dc-title">Breakaway</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cdlbreakaway-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cdlbreakaway</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cdlbreakaway-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdlbreakaway-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdlbreakaway.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdlbreakaway%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdlbreakaway&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdlbreakaway.php">＋<small>add a note</small></a></span>
