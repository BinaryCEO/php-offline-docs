...
<head>
  ...
  <title>PHP: opendir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.opendir.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.getcwd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.readdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.opendir.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.opendir.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.opendir.php" hreflang="uk">
...
<meta name="Description" content="Open directory handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: opendir - Manual" />
<meta name="twitter:description" content="Open directory handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: opendir - Manual" />
<meta itemprop="description" content="Open directory handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open directory handle" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.opendir.php' selected="selected">English</option>
            <option value='de/function.opendir.php'>German</option>
            <option value='es/function.opendir.php'>Spanish</option>
            <option value='fr/function.opendir.php'>French</option>
            <option value='it/function.opendir.php'>Italian</option>
            <option value='ja/function.opendir.php'>Japanese</option>
            <option value='pt_BR/function.opendir.php'>Brazilian Portuguese</option>
            <option value='ru/function.opendir.php'>Russian</option>
            <option value='tr/function.opendir.php'>Turkish</option>
            <option value='uk/function.opendir.php'>Ukrainian</option>
            <option value='zh/function.opendir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.opendir" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">opendir</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">opendir</span> &mdash; <span class="dc-title">Open directory handle</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.opendir-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.closedir.php" class="function">closedir()</a></span>, <span class="function"><a href="function.readdir.php" class="function">readdir()</a></span>, and
   <span class="function"><a href="function.rewinddir.php" class="function">rewinddir()</a></span> calls.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.opendir-returnvalues">
  ...
  <p class="para">
   Returns a directory handle <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> on success,
...
Upon failure, an <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> is emitted.
  ...
  <p class="para">
   This may happen if <code class="parameter">directory</code> is not a valid directory,
 ...
 <div class="refsect1 examples" id="refsect1-function.opendir-examples">
  ...
  <p class="para">
   <div class="example" id="example-2324">
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="35198">  <div class="votes">
    <div id="Vu35198">
    <a href="/manual/vote-note.php?id=35198&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd35198">
    <a href="/manual/vote-note.php?id=35198&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V35198" title="50% like this...">
    0
    </div>
  </div>
  <a href="#35198" class="name">
  <strong class="user"><em>info at 4design dot nu</em></strong></a><a class="genanchor" href="#35198"> &para;</a><div class="date" title="2003-08-22 06:31"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom35198">
<div class="phpcode"><code><span class="html">In addition to notes above about IIS &amp; PHP reading network shares, here's one solution that works better for me.<br /><br />in the management console I created a folder where my "read_dir" script runs. click on properties then select the security tab. here you can set the anonymous account to the standard IUSR_$computername% , BUT.. in this case I chose another account that I set up for reading my shares. (make sure login name and password match the credantials you set on the remote machin ;-))<br /><br />I use this to read a dir and it's contents into a searchable database. and it works like a charm...</span></code></div>
  </div>
 </div>
  <div class="note" id="32782">  <div class="votes">
    <div id="Vu32782">
    <a href="/manual/vote-note.php?id=32782&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd32782">
    <a href="/manual/vote-note.php?id=32782&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V32782" title="50% like this...">
    0
    </div>
  </div>
  <a href="#32782" class="name">
  <strong class="user"><em>Matt Grimm</em></strong></a><a class="genanchor" href="#32782"> &para;</a><div class="date" title="2003-06-06 01:25"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom32782">
<div class="phpcode"><code><span class="html">Thought I could help clarify something with accessing network shares on a Windows network (2000 in this case), running PHP 4.3.2 under Apache 2.0.44.<br /><br />However you are logged into the Windows box, your Apache service must be running under an account which has access to the share.  The easiest (and probably least safe) way for me was to change the user for the Apache service to the computer administrator (do this in the service properties, under the "Log On" tab).  After restarting Apache, I could access mapped drives by their assigned drive letter ("z:\\") or regular shares by their UNC path ("\\\\shareDrive\\shareDir").</span></code></div>
  </div>
 </div>
  <div class="note" id="121616">  <div class="votes">
    <div id="Vu121616">
    <a href="/manual/vote-note.php?id=121616&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121616">
    <a href="/manual/vote-note.php?id=121616&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121616" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#121616" class="name">
  <strong class="user"><em>hxss at ya dot ru</em></strong></a><a class="genanchor" href="#121616"> &para;</a><div class="date" title="2017-09-06 11:02"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121616">
<div class="phpcode"><code><span class="html">The TRUE recursive map function for working with dirs &amp; files.<br />You can create, read(find), update(or move) or delete files/dirs/tree by your callable function.<br />You can use flags for select what content you need.<br /><br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">dirmap</span><span class="keyword">(</span><span class="default">$dst</span><span class="keyword">, function(</span><span class="default">$v</span><span class="keyword">) {<br />    </span><span class="default">pre</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />    return </span><span class="default">true</span><span class="keyword">;<br />}, </span><span class="default">1</span><span class="keyword">|</span><span class="default">2</span><span class="keyword">|</span><span class="default">4</span><span class="keyword">|</span><span class="default">8</span><span class="keyword">));<br /><br /></span><span class="comment">/**<br /> * Applies the callback to the entries of the given dir path<br /> * In accordance with the received flags<br /> * @param  string   $path   path of the working directory<br /> * @param  Callable $action Callable function that would be<br /> *     executed for every entry in path<br /> * @param  integer  $flags  can be the following flag:<br /> *     1: apply Callable function for files<br /> *     2: apply Callable function for directories<br /> *     4: apply Callable function for $path<br /> *     8: work recursively<br /> * @return bool bitwise AND of all (bool)$action calls results<br /> */<br /></span><span class="keyword">function </span><span class="default">dirmap</span><span class="keyword">(</span><span class="default">string $path</span><span class="keyword">, Callable </span><span class="default">$action</span><span class="keyword">, </span><span class="default">int $flags </span><span class="keyword">= </span><span class="default">15</span><span class="keyword">) {<br />    </span><span class="default">$flF </span><span class="keyword">= </span><span class="default">boolval</span><span class="keyword">(</span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">1</span><span class="keyword">);<br />    </span><span class="default">$flD </span><span class="keyword">= </span><span class="default">boolval</span><span class="keyword">(</span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">2</span><span class="keyword">);<br />    </span><span class="default">$flP </span><span class="keyword">= </span><span class="default">boolval</span><span class="keyword">(</span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">4</span><span class="keyword">);<br />    </span><span class="default">$flR </span><span class="keyword">= </span><span class="default">boolval</span><span class="keyword">(</span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">8</span><span class="keyword">);<br />    </span><span class="default">$result </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br /><br />    if (</span><span class="default">is_dir</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">)) {<br /><br />        </span><span class="default">$dir </span><span class="keyword">= </span><span class="default">opendir</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br />        while (</span><span class="default">$entry </span><span class="keyword">= </span><span class="default">readdir</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">))<br />            if (!</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$entry</span><span class="keyword">, [</span><span class="string">'.'</span><span class="keyword">, </span><span class="string">'..'</span><span class="keyword">])) {<br />                </span><span class="default">$fullEntry </span><span class="keyword">= </span><span class="string">"</span><span class="keyword">{</span><span class="default">$path</span><span class="keyword">}</span><span class="string">/</span><span class="keyword">{</span><span class="default">$entry</span><span class="keyword">}</span><span class="string">"</span><span class="keyword">;<br /><br />                if (</span><span class="default">$flR</span><span class="keyword">)<br />                    </span><span class="default">$result </span><span class="keyword">&amp;= </span><span class="default">dirmap</span><span class="keyword">(</span><span class="default">$fullEntry</span><span class="keyword">, </span><span class="default">$action</span><span class="keyword">, </span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">11</span><span class="keyword">);<br /><br />                if (</span><span class="default">$flF </span><span class="keyword">&amp;&amp; </span><span class="default">is_file</span><span class="keyword">(</span><span class="default">$fullEntry</span><span class="keyword">) || </span><span class="default">$flD </span><span class="keyword">&amp;&amp; </span><span class="default">is_dir</span><span class="keyword">(</span><span class="default">$fullEntry</span><span class="keyword">))<br />                    </span><span class="default">$result </span><span class="keyword">&amp;= (bool)</span><span class="default">call_user_func</span><span class="keyword">(</span><span class="default">$action</span><span class="keyword">, </span><span class="default">$fullEntry</span><span class="keyword">);<br />            }<br /><br />        if (</span><span class="default">$flP</span><span class="keyword">)<br />            </span><span class="default">$result </span><span class="keyword">&amp;= (bool)</span><span class="default">call_user_func</span><span class="keyword">(</span><span class="default">$action</span><span class="keyword">, </span><span class="default">$fullEntry</span><span class="keyword">);<br /><br />        return (bool)</span><span class="default">$result</span><span class="keyword">;<br />    } else<br />        return </span><span class="default">is_file</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="72492">  <div class="votes">
    <div id="Vu72492">
    <a href="/manual/vote-note.php?id=72492&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72492">
    <a href="/manual/vote-note.php?id=72492&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72492" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#72492" class="name">
  <strong class="user"><em>frogstarr78 at yahoo dot com</em></strong></a><a class="genanchor" href="#72492"> &para;</a><div class="date" title="2007-01-21 12:30"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72492">
<div class="phpcode"><code><span class="html">Here's a function that will recrusively turn a directory into a hash of directory hashes and file arrays, automatically ignoring "dot" files. <br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">hashify_directory</span><span class="keyword">(</span><span class="default">$topdir</span><span class="keyword">, &amp;</span><span class="default">$list</span><span class="keyword">, </span><span class="default">$ignoredDirectories</span><span class="keyword">=array()) {<br />    if (</span><span class="default">is_dir</span><span class="keyword">(</span><span class="default">$topdir</span><span class="keyword">)) {<br />        if (</span><span class="default">$dh </span><span class="keyword">= </span><span class="default">opendir</span><span class="keyword">(</span><span class="default">$topdir</span><span class="keyword">)) {<br />            while ((</span><span class="default">$file </span><span class="keyword">= </span><span class="default">readdir</span><span class="keyword">(</span><span class="default">$dh</span><span class="keyword">)) !== </span><span class="default">false</span><span class="keyword">) {<br />                if (!(</span><span class="default">array_search</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">,</span><span class="default">$ignoredDirectories</span><span class="keyword">) &gt; -</span><span class="default">1</span><span class="keyword">) &amp;&amp; </span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/^\./'</span><span class="keyword">, </span><span class="default">$file</span><span class="keyword">) == </span><span class="default">0</span><span class="keyword">) {<br />                    if (</span><span class="default">is_dir</span><span class="keyword">(</span><span class="string">"</span><span class="default">$topdir$file</span><span class="string">"</span><span class="keyword">)) {<br />                        if(!isset(</span><span class="default">$list</span><span class="keyword">[</span><span class="default">$file</span><span class="keyword">])) {<br />                            </span><span class="default">$list</span><span class="keyword">[</span><span class="default">$file</span><span class="keyword">] = array();<br />                        }<br />                        </span><span class="default">ksort</span><span class="keyword">(</span><span class="default">$list</span><span class="keyword">);<br />                        </span><span class="default">hashify_directory</span><span class="keyword">(</span><span class="string">"</span><span class="default">$topdir$file</span><span class="string">/"</span><span class="keyword">, </span><span class="default">$list</span><span class="keyword">[</span><span class="default">$file</span><span class="keyword">]);<br />                    } else {<br />                        </span><span class="default">array_push</span><span class="keyword">(</span><span class="default">$list</span><span class="keyword">, </span><span class="default">$file</span><span class="keyword">);<br />                    }<br />                }<br />            }<br />            </span><span class="default">closedir</span><span class="keyword">(</span><span class="default">$dh</span><span class="keyword">);<br />        }<br />    }<br />}<br /></span><span class="default">?&gt;<br /></span><br />e.g.<br /><span class="default">&lt;?php<br />$public_html</span><span class="keyword">[</span><span class="string">"StudentFiles"</span><span class="keyword">] = array();<br /></span><span class="default">hashify_directory</span><span class="keyword">(</span><span class="string">"StudentFiles/"</span><span class="keyword">, </span><span class="default">$public_html</span><span class="keyword">[</span><span class="string">"StudentFiles"</span><span class="keyword">]);<br /></span><span class="default">?&gt;<br /></span>on the directory structure: <br />./StudentFiles/tutorial_01/case1/file1.html<br />./StudentFiles/tutorial_01/case1/file2.html<br />./StudentFiles/tutorial_02/case1/file1.html<br />./StudentFiles/tutorial_02/case2/file2.html<br />./StudentFiles/tutorial_03/case1/file2.html<br />etc...<br />becomes:<br /><span class="default">&lt;?php<br />print_r</span><span class="keyword">(</span><span class="default">$public_html</span><span class="keyword">); <br /></span><span class="comment">/*<br />outputs:<br />array(<br />  "StudentFiles" =&gt; array (<br />        "tutorial_01" =&gt; array (<br />              "case1" =&gt; array( "file1.html", "file2.html")<br />        ),<br />        "tutorial_02" =&gt; array (<br />              "case1" =&gt; array( "file1.html"),<br />              "case2" =&gt; array( "file2.html")<br />        ),<br />       "tutorial_03" =&gt; array (<br />              "case1" =&gt; array( "file2.html")<br />       )<br />  )<br />)<br />*/<br /></span><span class="default">?&gt;<br /></span>I'm using it to create a tree view of a directory.</span></code></div>
  </div>
 </div>
  <div class="note" id="71742">  <div class="votes">
    <div id="Vu71742">
    <a href="/manual/vote-note.php?id=71742&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71742">
    <a href="/manual/vote-note.php?id=71742&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71742" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#71742" class="name">
  <strong class="user"><em>phpguy at mailstop dot yogelements dot omitme dot com</em></strong></a><a class="genanchor" href="#71742"> &para;</a><div class="date" title="2006-12-13 01:40"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71742">
<div class="phpcode"><code><span class="html">An issue that I ran into is that opendir() could care less if you've got server authentication set on sub directories and so any such authentication is bypassed completely when accesses in this way. I did solve it for my application of a pretty file manager, by redirecting to all sub directories thusly:<br />$fdir = "./subdirectory_I_want_to_visit/";<br />if ($fdir != './') { //basically where we are or the parent<br />    //redirect the browser to force authentication check on any subdirectories<br />    header("Location: <a href="http://my.domain.com" rel="nofollow" target="_blank">http://my.domain.com</a>".dirname($_SERVER["PHP_SELF"]).substr($fdir,2));<br />    exit;<br />} else {<br />    $dir = opendir($fdir);<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="90789">  <div class="votes">
    <div id="Vu90789">
    <a href="/manual/vote-note.php?id=90789&amp;page=function.opendir&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90789">
    <a href="/manual/vote-note.php?id=90789&amp;page=function.opendir&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90789" title="46% like this...">
    -1
    </div>
  </div>
  <a href="#90789" class="name">
  <strong class="user"><em>Madog Llwyd</em></strong></a><a class="genanchor" href="#90789"> &para;</a><div class="date" title="2009-05-09 05:22"><strong>16 years ago</strong></div>
