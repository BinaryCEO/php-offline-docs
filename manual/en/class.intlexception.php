...
<head>
  ...
  <title>PHP: IntlException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.intlexception.php">
 <link rel="shorturl" href="https://www.php.net/intlexception">
 <link rel="alternate" href="https://www.php.net/intlexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.intl.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.toupper.php">
 <link rel="next" href="https://www.php.net/manual/en/class.intliterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.intlexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.intlexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.intlexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.intlexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.intlexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.intlexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.intlexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.intlexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.intlexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.intlexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.intlexception.php" hreflang="zh">
...
<meta name="Description" content="Exception class for intl errors" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlException - Manual" />
<meta name="twitter:description" content="Exception class for intl errors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlException - Manual" />
<meta itemprop="description" content="Exception class for intl errors" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exception class for intl errors" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.intlexception.php' selected="selected">English</option>
            <option value='de/class.intlexception.php'>German</option>
            <option value='es/class.intlexception.php'>Spanish</option>
            <option value='fr/class.intlexception.php'>French</option>
            <option value='it/class.intlexception.php'>Italian</option>
            <option value='ja/class.intlexception.php'>Japanese</option>
            <option value='pt_BR/class.intlexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.intlexception.php'>Russian</option>
            <option value='tr/class.intlexception.php'>Turkish</option>
            <option value='uk/class.intlexception.php'>Ukrainian</option>
            <option value='zh/class.intlexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.intlexception" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt; 5.5.0, PHP 7, PHP 8, PECL intl &gt; 3.0.0a1)</p>
  ...
  <div class="section" id="intlexception.intro">
   ...
   <p class="para">
    ...
    functions. Such exceptions are only generated when <a href="intl.configuration.php#ini.intl.use-exceptions" class="link">intl.use_exceptions</a> is enabled.
   </p>
  </div>
...
<p class="para"/>
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">IntlException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.intlexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.intlexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.intlexception.php">＋<small>add a note</small></a></span>
