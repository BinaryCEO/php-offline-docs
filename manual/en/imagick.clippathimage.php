...
<head>
  ...
  <title>PHP: Imagick::clipPathImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clippathimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clippathimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clippathimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clipimagepath.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clippathimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clippathimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clippathimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clippathimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clippathimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clippathimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clippathimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clippathimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clippathimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clippathimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clippathimage.php" hreflang="zh">
...
<meta name="Description" content="Clips along the named paths from the 8BIM profile" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clipPathImage - Manual" />
<meta name="twitter:description" content="Clips along the named paths from the 8BIM profile" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clipPathImage - Manual" />
<meta itemprop="description" content="Clips along the named paths from the 8BIM profile" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clips along the named paths from the 8BIM profile" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.clone.php">
          Imagick::clone &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clipimagepath.php">
          &laquo; Imagick::clipImagePath        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clippathimage.php' selected="selected">English</option>
            <option value='de/imagick.clippathimage.php'>German</option>
            <option value='es/imagick.clippathimage.php'>Spanish</option>
            <option value='fr/imagick.clippathimage.php'>French</option>
            <option value='it/imagick.clippathimage.php'>Italian</option>
            <option value='ja/imagick.clippathimage.php'>Japanese</option>
            <option value='pt_BR/imagick.clippathimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clippathimage.php'>Russian</option>
            <option value='tr/imagick.clippathimage.php'>Turkish</option>
            <option value='uk/imagick.clippathimage.php'>Ukrainian</option>
            <option value='zh/imagick.clippathimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clippathimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::clipPathImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::clipPathImage</span> &mdash; <span class="dc-title">Clips along the named paths from the 8BIM profile</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.clippathimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::clipPathImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pathname</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$inside</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.clippathimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> later operations take effect inside clipping path.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.clippathimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.clippathimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clippathimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clippathimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clippathimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clippathimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="81819">  <div class="votes">
    <div id="Vu81819">
    <a href="/manual/vote-note.php?id=81819&amp;page=imagick.clippathimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81819">
    <a href="/manual/vote-note.php?id=81819&amp;page=imagick.clippathimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81819" title="66% like this...">
    1
    </div>
  </div>
  <a href="#81819" class="name">
  <strong class="user"><em>Coleman Nitroy</em></strong></a><a class="genanchor" href="#81819"> &para;</a><div class="date" title="2008-03-14 05:15"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81819">
<div class="phpcode"><code><span class="html">I found Imagick::clipPathImage and Imagic::clipImage did not work as I had expected. I thought they would just clip the path and throw away the extra data and you are done. Not the case. <br /><br />Here is how I was able to use a clipping path:<br /><br /><span class="default">&lt;?php<br />      $img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"/Path/To/Test/Image.psd"</span><span class="keyword">);<br />      </span><span class="default">$geometry </span><span class="keyword">= </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br /><br />      </span><span class="comment">// Uses the first path as the clipping path<br />      </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">clipPathImage</span><span class="keyword">(</span><span class="string">"#1"</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br /><br />      </span><span class="comment">// Fill the clipped part with a color<br />      </span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();<br />      </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">"#000000"</span><span class="keyword">);<br />      </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">color</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">PAINT_RESET</span><span class="keyword">);<br />      </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);<br /><br />      </span><span class="comment">// Composite the clipped image with the old image. Set the color of the composite to any color you want to be the outside part.<br />      </span><span class="default">$composite </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br />      </span><span class="default">$composite</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">( </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">], </span><span class="default">$geometry</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">], new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">"white"</span><span class="keyword">), </span><span class="string">'png'</span><span class="keyword">);<br />      </span><span class="default">$composite</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_COPY</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Then doing any resizing or creating thumbnails from the resulting image  disregarded all the previous commands so I "saved" it and started with a new Imagick object<br /><br /><span class="default">&lt;?php<br />      </span><span class="comment">// Copy the image so clip is "saved"<br />      </span><span class="default">$clipped </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />      </span><span class="default">$clipped</span><span class="keyword">-&gt;</span><span class="default">readImageBlob</span><span class="keyword">(</span><span class="default">$composite</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">());<br /></span><span class="default">?&gt;<br /></span><br />I'm sure there is a simpler way, but this took me awhile to get right and there were some hurdles to cross so I hope it is able to help someone on the way.<br /><br />This is all the convert equivalent of:<br /><br />$ convert Test.psd -fill white -colorspace rgb -draw "color 0 0 reset" -clip -colorspace rgb -draw "Image Copy 0,0 0,0 'Test.psd'" OutputFile.png</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.clippathimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clippathimage.php">＋<small>add a note</small></a></div>
