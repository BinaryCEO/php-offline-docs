...
<head>
  ...
  <title>PHP: imap_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-status.php">
 <link rel="shorturl" href="https://www.php.net/imap-status">
 <link rel="alternate" href="https://www.php.net/imap-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-sort.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-subscribe.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-status.php" hreflang="zh">
...
<meta name="Description" content="Returns status information on a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_status - Manual" />
<meta name="twitter:description" content="Returns status information on a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_status - Manual" />
<meta itemprop="description" content="Returns status information on a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns status information on a mailbox" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-subscribe.php">
          imap_subscribe &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-sort.php">
          &laquo; imap_sort        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-status.php' selected="selected">English</option>
            <option value='de/function.imap-status.php'>German</option>
            <option value='es/function.imap-status.php'>Spanish</option>
            <option value='fr/function.imap-status.php'>French</option>
            <option value='it/function.imap-status.php'>Italian</option>
            <option value='ja/function.imap-status.php'>Japanese</option>
            <option value='pt_BR/function.imap-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-status.php'>Russian</option>
            <option value='tr/function.imap-status.php'>Turkish</option>
            <option value='uk/function.imap-status.php'>Ukrainian</option>
            <option value='zh/function.imap-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-status" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_status</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_status</span> &mdash; <span class="dc-title">Returns status information on a mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-status-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_status</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>): <span class="type"><span class="type"><a href="class.stdclass.php" class="type stdClass">stdClass</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Gets status information about the given <code class="parameter">mailbox</code>.
  </p>
 </div>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
     ...
     <dd>
      <p class="para">
       ...
       <ul class="itemizedlist">
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-messages">SA_MESSAGES</a></code></strong> - set <var class="varname">$status->messages</var> to the
          number of messages in the mailbox
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-recent">SA_RECENT</a></code></strong> - set <var class="varname">$status->recent</var> to the number
          of recent messages in the mailbox
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-unseen">SA_UNSEEN</a></code></strong> - set <var class="varname">$status->unseen</var> to the number
          of unseen (new) messages in the mailbox
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-uidnext">SA_UIDNEXT</a></code></strong> - set <var class="varname">$status->uidnext</var> to the next
          uid to be used in the mailbox
         </span>
        </li>
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-uidvalidity">SA_UIDVALIDITY</a></code></strong> - set <var class="varname">$status->uidvalidity</var> to a
        ...
        <li class="listitem">
         <span class="simpara">
          <strong><code><a href="imap.constants.php#constant.sa-all">SA_ALL</a></code></strong> - set all of the above
         </span>
        </li>
       </ul>
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-status-returnvalues">
  ...
  <p class="para">
   This function returns an object containing status information,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   The object has the following properties: <code class="literal">messages</code>,
   <code class="literal">recent</code>, <code class="literal">unseen</code>, 
   <code class="literal">uidnext</code>, and <code class="literal">uidvalidity</code>.  
  </p>
  <p class="para">
   <code class="literal">flags</code> is also set, which contains a bitmask which can
   be checked against any of the above constants.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imap-status-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.com}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">, </span><span style="color: #0000BB">OP_HALFOPEN</span><span style="color: #007700">)<br />      or die(</span><span style="color: #DD0000">"can't connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">$status </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_status</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">, </span><span style="color: #DD0000">"{imap.example.org}INBOX"</span><span style="color: #007700">, </span><span style="color: #0000BB">SA_ALL</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$status</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"Messages:   " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">messages    </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />  echo </span><span style="color: #DD0000">"Recent:     " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">recent      </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />  echo </span><span style="color: #DD0000">"Unseen:     " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">unseen      </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />  echo </span><span style="color: #DD0000">"UIDnext:    " </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uidnext     </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />  echo </span><span style="color: #DD0000">"UIDvalidity:" </span><span style="color: #007700">. </span><span style="color: #0000BB">$status</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uidvalidity </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />} else {<br />  echo </span><span style="color: #DD0000">"imap_status failed: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">() . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-status.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="109381">  <div class="votes">
    <div id="Vu109381">
    <a href="/manual/vote-note.php?id=109381&amp;page=function.imap-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109381">
    <a href="/manual/vote-note.php?id=109381&amp;page=function.imap-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109381" title="100% like this...">
    2
    </div>
  </div>
  <a href="#109381" class="name">
  <strong class="user"><em>mwwaygoo AT hotmail DOT com</em></strong></a><a class="genanchor" href="#109381"> &para;</a><div class="date" title="2012-07-12 01:33"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109381">
<div class="phpcode"><code><span class="html">I had issues with imap_status not working correctly, while other imap functions seemed okay. I always got the ['flags']=0 response. No notes here and Google searching suggests it doesn't working properly with Exchange, so I wrote a little workaround, to at least get some information.<br /><br /><span class="default">&lt;?php<br />    </span><span class="keyword">function </span><span class="default">my_imap_status</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$mailbox</span><span class="keyword">=</span><span class="string">''</span><span class="keyword">, </span><span class="default">$info</span><span class="keyword">=</span><span class="default">SA_ALL</span><span class="keyword">)<br />    {<br />        </span><span class="comment">// get current mailbox name (and info)<br />        </span><span class="default">$curr_obj</span><span class="keyword">=</span><span class="default">imap_check</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">);<br />        if(!</span><span class="default">$curr_obj</span><span class="keyword">) return </span><span class="default">false</span><span class="keyword">;<br />        <br />        </span><span class="comment">// if request if for current mailbox then just return it<br />        </span><span class="keyword">if( (empty(</span><span class="default">$mailbox</span><span class="keyword">)) || (</span><span class="default">$mailbox</span><span class="keyword">==</span><span class="default">$curr_obj</span><span class="keyword">-&gt;</span><span class="default">Mailbox</span><span class="keyword">) ) return </span><span class="default">$curr_obj</span><span class="keyword">;<br />        <br />        </span><span class="comment">// get current mailbox<br />        </span><span class="default">$current_mailbox</span><span class="keyword">=</span><span class="default">$curr_obj</span><span class="keyword">-&gt;</span><span class="default">Mailbox</span><span class="keyword">;<br />        <br />        </span><span class="comment">//switch to new mailbox<br />        </span><span class="keyword">if(!</span><span class="default">imap_reopen</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$mailbox</span><span class="keyword">)) return </span><span class="default">false</span><span class="keyword">;<br />        <br />        </span><span class="comment">// get info<br />        </span><span class="default">$obj</span><span class="keyword">=</span><span class="default">imap_check</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">);<br />        <br />        </span><span class="comment">// switch back to original mailbox<br />        </span><span class="default">imap_reopen</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$current_mailbox</span><span class="keyword">);<br />        <br />        </span><span class="comment">//return info<br />        </span><span class="keyword">return </span><span class="default">$obj</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-status.php">＋<small>add a note</small></a></div>
