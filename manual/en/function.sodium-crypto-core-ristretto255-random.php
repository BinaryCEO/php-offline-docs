...
<head>
  ...
  <title>PHP: sodium_crypto_core_ristretto255_random - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-random.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-core-ristretto255-random">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-core-ristretto255-random" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-is-valid-point.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-scalar-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-random.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-core-ristretto255-random.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-core-ristretto255-random.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-core-ristretto255-random.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-core-ristretto255-random.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-core-ristretto255-random.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-core-ristretto255-random.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-core-ristretto255-random.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-core-ristretto255-random.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-core-ristretto255-random.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-core-ristretto255-random.php" hreflang="zh">
...
<meta name="Description" content="Generates a random key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_core_ristretto255_random - Manual" />
<meta name="twitter:description" content="Generates a random key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_core_ristretto255_random - Manual" />
<meta itemprop="description" content="Generates a random key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a random key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-core-ristretto255-scalar-add.php">
          sodium_crypto_core_ristretto255_scalar_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-core-ristretto255-is-valid-point.php">
          &laquo; sodium_crypto_core_ristretto255_is_valid_point        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-core-ristretto255-random.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-core-ristretto255-random.php'>German</option>
            <option value='es/function.sodium-crypto-core-ristretto255-random.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-core-ristretto255-random.php'>French</option>
            <option value='it/function.sodium-crypto-core-ristretto255-random.php'>Italian</option>
            <option value='ja/function.sodium-crypto-core-ristretto255-random.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-core-ristretto255-random.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-core-ristretto255-random.php'>Russian</option>
            <option value='tr/function.sodium-crypto-core-ristretto255-random.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-core-ristretto255-random.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-core-ristretto255-random.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-core-ristretto255-random" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_core_ristretto255_random</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_core_ristretto255_random</span> &mdash; <span class="dc-title">Generates a random key</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-core-ristretto255-random-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_core_ristretto255_random</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-core-ristretto255-random-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-core-ristretto255-random-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-core-ristretto255-random-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1067">
    <p><strong>Example #1 <span class="function"><strong>sodium_crypto_core_ristretto255_random()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-core-ristretto255-random-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sodium-crypto-core-ristretto255-sub.php" class="function" rel="rdfs-seeAlso">sodium_crypto_core_ristretto255_sub()</a> - Subtracts an element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-core-ristretto255-random.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-core-ristretto255-random%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-core-ristretto255-random&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-core-ristretto255-random.php">＋<small>add a note</small></a></span>
