...
<head>
  ...
  <title>PHP: mysqli::debug - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.debug.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.debug.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.debug.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.dump-debug-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.debug.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.debug.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.debug.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.debug.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.debug.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.debug.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.debug.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.debug.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.debug.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.debug.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.debug.php" hreflang="zh">
...
<meta name="Description" content="Performs debugging operations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::debug - Manual" />
<meta name="twitter:description" content="Performs debugging operations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::debug - Manual" />
<meta itemprop="description" content="Performs debugging operations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs debugging operations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.dump-debug-info.php">
          mysqli::dump_debug_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.construct.php">
          &laquo; mysqli::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.debug.php' selected="selected">English</option>
            <option value='de/mysqli.debug.php'>German</option>
            <option value='es/mysqli.debug.php'>Spanish</option>
            <option value='fr/mysqli.debug.php'>French</option>
            <option value='it/mysqli.debug.php'>Italian</option>
            <option value='ja/mysqli.debug.php'>Japanese</option>
            <option value='pt_BR/mysqli.debug.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.debug.php'>Russian</option>
            <option value='tr/mysqli.debug.php'>Turkish</option>
            <option value='uk/mysqli.debug.php'>Ukrainian</option>
            <option value='zh/mysqli.debug.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.debug" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.debug-examples">
  ...
  <p class="para">
   <div class="example" id="example-1587">
    <p><strong>Example #1 Generating a Trace File</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.debug-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysqli-report.php" class="function" rel="rdfs-seeAlso">mysqli_report()</a> - Alias of mysqli_driver-&gt;report_mode</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/debug.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.debug%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.debug&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.debug.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114991">  <div class="votes">
    <div id="Vu114991">
    <a href="/manual/vote-note.php?id=114991&amp;page=mysqli.debug&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114991">
    <a href="/manual/vote-note.php?id=114991&amp;page=mysqli.debug&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114991" title="73% like this...">
    28
    </div>
  </div>
  <a href="#114991" class="name">
  <strong class="user"><em>Peter</em></strong></a><a class="genanchor" href="#114991"> &para;</a><div class="date" title="2014-05-10 10:59"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114991">
<div class="phpcode"><code><span class="html">can there be more documenation with a small (but working) example script on how to use this ?<br /><br />Some issues  (Ive seen the "same" code example in dozens of tutorials):-<br /><br />( I'll use capitals for emphasis only)<br /><br />QUESTION: what does D:T:O mean ? UNEXPLAINED.<br /><br />QUESTION: Do we *ONLY* use these 3 lines in a self-contained script ? Does this log ALL future MYSQL commands ?<br /><br />QUESTION :- Do we put that one line just<br /><br />- immediately after we connect to MYSQL ?<br />- before we connect to MYSQL ?<br />- before our suspected error ?</span></code></div>
  </div>
 </div>
  <div class="note" id="122219">  <div class="votes">
    <div id="Vu122219">
    <a href="/manual/vote-note.php?id=122219&amp;page=mysqli.debug&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122219">
    <a href="/manual/vote-note.php?id=122219&amp;page=mysqli.debug&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122219" title="68% like this...">
    6
    </div>
  </div>
  <a href="#122219" class="name">
  <strong class="user"><em>riversnowchang at gmail dot com</em></strong></a><a class="genanchor" href="#122219"> &para;</a><div class="date" title="2018-01-03 02:42"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122219">
<div class="phpcode"><code><span class="html">Here are the information about debug options on mysqli_debug()<br /><br />O,o:MYSQLND_DEBUG_FLUSH<br />A,a:MYSQLND_DEBUG_APPEND<br />F:MYSQLND_DEBUG_DUMP_FILE<br />L:MYSQLND_DEBUG_DUMP_LINE<br />m:MYSQLND_DEBUG_TRACE_MEMORY_CALLS<br />n:MYSQLND_DEBUG_DUMP_LEVEL<br />o:output to file<br />T:MYSQLND_DEBUG_DUMP_TIME<br />t:MYSQLND_DEBUG_DUMP_TRACE<br />x:MYSQLND_DEBUG_PROFILE_CALLS<br />f:? still investigating<br /><br />For example, mysqli_debug("T:n:t:m:x:F:L:o,/tmp/client.trace");<br />mysqlnd will write Time, Level, trace, memory calls, profile calls, File, Line to client.trace file.<br /><br />22:35:42.704501 ../mysqlnd_connection.c:  269   0:&gt;mysqlnd_connection_init<br />22:35:42.704538 ../mysqlnd_driver.c:   10   1:| &gt;mysqlnd_driver::get_connection<br />22:35:42.704549 ../mysqlnd_driver.c:   10   2:| | info : persistent=1<br />22:35:42.704558 ../mysqlnd_alloc.c:   21   2:| | &gt;_mysqlnd_pecalloc<br />22:35:42.704570 ../mysqlnd_alloc.c:   23   2:| | &lt;_mysqlnd_pecalloc (total=3 own=3 in_calls=0)<br />22:35:42.704602 ../mysqlnd_alloc.c:   21   2:| | &gt;_mysqlnd_pecalloc<br />22:35:42.704626 ../mysqlnd_alloc.c:   23   2:| | &lt;_mysqlnd_pecalloc (total=2 own=2 in_calls=0)<br />22:35:42.704650 ../mysqlnd_connection.c:   15   2:| | &gt;mysqlnd_error_info_init<br />22:35:42.704675 ../mysqlnd_connection.c:   10   3:| | | &gt;mysqlnd_error_info::reset<br />22:35:42.704697 ../mysqlnd_connection.c:   10   3:| | | &lt;mysqlnd_error_info::reset (total=1 own=1 in_calls=0)<br />22:35:42.704725 ../mysqlnd_connection.c:   16   2:| | &lt;mysqlnd_error_info_init (total=51 own=50 in_calls=1)<br />22:35:42.704744 ../mysqlnd_connection.c:   21   2:| | &gt;mysqlnd_connection_state_init<br /><br />If there is anything wrong, please let me know.</span></code></div>
  </div>
 </div>
  <div class="note" id="122730">  <div class="votes">
    <div id="Vu122730">
    <a href="/manual/vote-note.php?id=122730&amp;page=mysqli.debug&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122730">
    <a href="/manual/vote-note.php?id=122730&amp;page=mysqli.debug&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122730" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#122730" class="name">
  <strong class="user"><em>Domenic</em></strong></a><a class="genanchor" href="#122730"> &para;</a><div class="date" title="2018-05-14 10:17"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122730">
<div class="phpcode"><code><span class="html">Looks like this manual could be referred to:<br /><br /><a href="http://tiebing.blogspot.com.au/2011/10/cc-dbug-library.html" rel="nofollow" target="_blank">http://tiebing.blogspot.com.au/2011/10/cc-dbug-library.html</a><br /><br />(I haven't tested it)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.debug&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.debug.php">＋<small>add a note</small></a></div>
