...
<head>
  ...
  <title>PHP: Phar::isBuffering - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.isbuffering.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.isbuffering.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.isbuffering.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.iscompressed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.isbuffering.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.isbuffering.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.isbuffering.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.isbuffering.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.isbuffering.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.isbuffering.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.isbuffering.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.isbuffering.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.isbuffering.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.isbuffering.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.isbuffering.php" hreflang="zh">
...
<meta name="Description" content="Used to determine whether Phar write operations are being buffered, or are flushing directly to disk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::isBuffering - Manual" />
<meta name="twitter:description" content="Used to determine whether Phar write operations are being buffered, or are flushing directly to disk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::isBuffering - Manual" />
<meta itemprop="description" content="Used to determine whether Phar write operations are being buffered, or are flushing directly to disk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Used to determine whether Phar write operations are being buffered, or are flushing directly to disk" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.iscompressed.php">
          Phar::isCompressed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.interceptfilefuncs.php">
          &laquo; Phar::interceptFileFuncs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.isbuffering.php' selected="selected">English</option>
            <option value='de/phar.isbuffering.php'>German</option>
            <option value='es/phar.isbuffering.php'>Spanish</option>
            <option value='fr/phar.isbuffering.php'>French</option>
            <option value='it/phar.isbuffering.php'>Italian</option>
            <option value='ja/phar.isbuffering.php'>Japanese</option>
            <option value='pt_BR/phar.isbuffering.php'>Brazilian Portuguese</option>
            <option value='ru/phar.isbuffering.php'>Russian</option>
            <option value='tr/phar.isbuffering.php'>Turkish</option>
            <option value='uk/phar.isbuffering.php'>Ukrainian</option>
            <option value='zh/phar.isbuffering.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.isbuffering" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::isBuffering</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Phar::isBuffering</span> &mdash; <span class="dc-title">Used to determine whether Phar write operations are being buffered, or are flushing directly to disk</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.isbuffering-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::isBuffering</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>


  <p class="para rdfs-comment">
   This method can be used to determine whether a Phar will save changes
   to disk immediately, or whether a call to <span class="function"><a href="phar.stopbuffering.php" class="function">Phar::stopBuffering()</a></span>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.isbuffering-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.stopbuffering.php" class="function" rel="rdfs-seeAlso">Phar::stopBuffering()</a> - Stop buffering write requests to the Phar archive, and save changes to disk</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/isBuffering.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.isbuffering%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.isbuffering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.isbuffering.php">＋<small>add a note</small></a></span>
