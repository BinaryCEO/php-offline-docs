...
<head>
  ...
  <title>PHP: odbc_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-prepare.php">
 <link rel="shorturl" href="https://www.php.net/odbc-prepare">
 <link rel="alternate" href="https://www.php.net/odbc-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-primarykeys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-prepare.php" hreflang="zh">
...
<meta name="Description" content="Prepares a statement for execution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_prepare - Manual" />
<meta name="twitter:description" content="Prepares a statement for execution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_prepare - Manual" />
<meta itemprop="description" content="Prepares a statement for execution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepares a statement for execution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.odbc-primarykeys.php">
          odbc_primarykeys &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-pconnect.php">
          &laquo; odbc_pconnect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-prepare.php' selected="selected">English</option>
            <option value='de/function.odbc-prepare.php'>German</option>
            <option value='es/function.odbc-prepare.php'>Spanish</option>
            <option value='fr/function.odbc-prepare.php'>French</option>
            <option value='it/function.odbc-prepare.php'>Italian</option>
            <option value='ja/function.odbc-prepare.php'>Japanese</option>
            <option value='pt_BR/function.odbc-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-prepare.php'>Russian</option>
            <option value='tr/function.odbc-prepare.php'>Turkish</option>
            <option value='uk/function.odbc-prepare.php'>Ukrainian</option>
            <option value='zh/function.odbc-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-prepare" class="refentry">
...
see <span class="function"><a href="function.odbc-connect.php" class="function">odbc_connect()</a></span> for details.</p>
 ...
 <div class="refsect1 examples" id="refsect1-function.odbc-prepare-examples">
  ...
  <p class="para">
   <div class="example" id="example-1101">
    <p><strong>Example #1 <span class="function"><a href="function.odbc-execute.php" class="function">odbc_execute()</a></span> and <span class="function"><strong>odbc_prepare()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.odbc-execute.php" class="function" rel="rdfs-seeAlso">odbc_execute()</a> - Execute a prepared statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-prepare.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="71616">  <div class="votes">
    <div id="Vu71616">
    <a href="/manual/vote-note.php?id=71616&amp;page=function.odbc-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71616">
    <a href="/manual/vote-note.php?id=71616&amp;page=function.odbc-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71616" title="63% like this...">
    13
    </div>
  </div>
  <a href="#71616" class="name">
  <strong class="user"><em>bslorence</em></strong></a><a class="genanchor" href="#71616"> &para;</a><div class="date" title="2006-12-07 01:50"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71616">
<div class="phpcode"><code><span class="html">Is it just me or is the code above misleading? It makes it look like odbc_execute() returns a resource suitable, say, for passing to one of the odbc_fetch_* functions.<br /><br />In fact, odbc_execute() returns a boolean, which simply indicates success (TRUE) or failure (FALSE). The variable to pass to odbc_fetch_* is the same one that you pass to odbc_execute():<br /><br /><span class="default">&lt;?php<br />$res </span><span class="keyword">= </span><span class="default">odbc_prepare</span><span class="keyword">(</span><span class="default">$db_conn</span><span class="keyword">, </span><span class="default">$query_string</span><span class="keyword">);<br />if(!</span><span class="default">$res</span><span class="keyword">) die(</span><span class="string">"could not prepare statement "</span><span class="keyword">.</span><span class="default">$query_string</span><span class="keyword">);<br /><br />if(</span><span class="default">odbc_execute</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">, </span><span class="default">$parameters</span><span class="keyword">)) {<br />    </span><span class="default">$row </span><span class="keyword">= </span><span class="default">odbc_fetch_array</span><span class="keyword">(</span><span class="default">$res</span><span class="keyword">);<br />} else {<br />    </span><span class="comment">// handle error<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="123796">  <div class="votes">
    <div id="Vu123796">
    <a href="/manual/vote-note.php?id=123796&amp;page=function.odbc-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123796">
    <a href="/manual/vote-note.php?id=123796&amp;page=function.odbc-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123796" title="66% like this...">
    1
    </div>
  </div>
  <a href="#123796" class="name">
  <strong class="user"><em>lzsiga at freemail dot c3 dot hu</em></strong></a><a class="genanchor" href="#123796"> &para;</a><div class="date" title="2019-04-24 08:22"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123796">
<div class="phpcode"><code><span class="html">The resource returned by odbc_prepare can be freed with odbc_free_result.</span></code></div>
  </div>
 </div>
  <div class="note" id="129227">  <div class="votes">
    <div id="Vu129227">
    <a href="/manual/vote-note.php?id=129227&amp;page=function.odbc-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129227">
    <a href="/manual/vote-note.php?id=129227&amp;page=function.odbc-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129227" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129227" class="name">
  <strong class="user"><em>info dot codesquare at gmail dot com</em></strong></a><a class="genanchor" href="#129227"> &para;</a><div class="date" title="2024-02-08 01:38"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129227">
<div class="phpcode"><code><span class="html">after 2 days finaly got a working code<br />(SQL SERVER stored procedure with parameters through ODBC)<br /><br />STORED PROCEDURE<br /><br />SET ANSI_NULLS ON<br />GO<br />SET QUOTED_IDENTIFIER ON<br />GO<br /><br />ALTER PROCEDURE [dbo].[sp_prev_frm_prev2]<br />    @id int, <br />    @cli nchar(20)<br />AS<br />BEGIN<br />    SET NOCOUNT ON;<br />    --SELECT 1<br />END<br /><br />PHP<br /><br />$stmt=odbc_prepare($conn,'{call db.dbo.sp_prev_frm_prev2(?,?)}');<br /><br />$params=array(1,"clie");<br /><br />$result = odbc_execute($stmt, $params);</span></code></div>
  </div>
 </div>
  <div class="note" id="48235">  <div class="votes">
    <div id="Vu48235">
    <a href="/manual/vote-note.php?id=48235&amp;page=function.odbc-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd48235">
    <a href="/manual/vote-note.php?id=48235&amp;page=function.odbc-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V48235" title="52% like this...">
    1
    </div>
  </div>
  <a href="#48235" class="name">
  <strong class="user"><em>Marek</em></strong></a><a class="genanchor" href="#48235"> &para;</a><div class="date" title="2004-12-16 12:59"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom48235">
<div class="phpcode"><code><span class="html">Use this example for IBM DB/2:<br /><br />$q = "update TABLE set PASS=? where NAME=?";<br />$res = odbc_prepare ($con, $q);<br /><br />$a = "secret"; $b="user";<br />$exc = odbc_execute($res, array($a, $b));</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-prepare.php">＋<small>add a note</small></a></div>
