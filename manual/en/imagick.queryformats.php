...
<head>
  ...
  <title>PHP: Imagick::queryFormats - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.queryformats.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.queryformats.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.queryformats.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.queryfonts.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.radialblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.queryformats.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.queryformats.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.queryformats.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.queryformats.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.queryformats.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.queryformats.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.queryformats.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.queryformats.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.queryformats.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.queryformats.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.queryformats.php" hreflang="zh">
...
<meta name="Description" content="Returns formats supported by Imagick" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::queryFormats - Manual" />
<meta name="twitter:description" content="Returns formats supported by Imagick" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::queryFormats - Manual" />
<meta itemprop="description" content="Returns formats supported by Imagick" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns formats supported by Imagick" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.radialblurimage.php">
          Imagick::radialBlurImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.queryfonts.php">
          &laquo; Imagick::queryFonts        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.queryformats.php' selected="selected">English</option>
            <option value='de/imagick.queryformats.php'>German</option>
            <option value='es/imagick.queryformats.php'>Spanish</option>
            <option value='fr/imagick.queryformats.php'>French</option>
            <option value='it/imagick.queryformats.php'>Italian</option>
            <option value='ja/imagick.queryformats.php'>Japanese</option>
            <option value='pt_BR/imagick.queryformats.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.queryformats.php'>Russian</option>
            <option value='tr/imagick.queryformats.php'>Turkish</option>
            <option value='uk/imagick.queryformats.php'>Ukrainian</option>
            <option value='zh/imagick.queryformats.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.queryformats" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::queryFormats</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::queryFormats</span> &mdash; <span class="dc-title">Returns formats supported by Imagick</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.queryformats-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::queryFormats</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code><span class="initializer"> = &quot;*&quot;</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.queryformats-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.queryformats-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.queryformats-errors">
  ...
  <p class="para">
    <div class="example" id="example-3071">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/queryformats.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.queryformats%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.queryformats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.queryformats.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126257">  <div class="votes">
    <div id="Vu126257">
    <a href="/manual/vote-note.php?id=126257&amp;page=imagick.queryformats&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126257">
    <a href="/manual/vote-note.php?id=126257&amp;page=imagick.queryformats&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126257" title="no votes...">
    0
    </div>
  </div>
  <a href="#126257" class="name">
  <strong class="user"><em>kawewong at gmail dot com</em></strong></a><a class="genanchor" href="#126257"> &para;</a><div class="date" title="2021-07-21 05:28"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126257">
<div class="phpcode"><code><span class="html">The pattern argument is case sensitive. Example:<br /><br /><span class="default">&lt;?php<br />$input </span><span class="keyword">= </span><span class="default">\Imagick</span><span class="keyword">::</span><span class="default">queryformats</span><span class="keyword">(</span><span class="string">'PNG*'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The PNG* will be included PNG, PNG00, PNG24, PNG32, PNG48, PNG64, PNG8<br /><br />(Reference <a href="https://www.geeksforgeeks.org/php-imagick-queryformats-function/" rel="nofollow" target="_blank">https://www.geeksforgeeks.org/php-imagick-queryformats-function/</a> )<br /><br />If you enter png* then it will be return nothing.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.queryformats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.queryformats.php">＋<small>add a note</small></a></div>
