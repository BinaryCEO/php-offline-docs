...
<head>
  ...
  <title>PHP: MemcachedException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.memcachedexception.php">
 <link rel="shorturl" href="https://www.php.net/memcachedexception">
 <link rel="alternate" href="https://www.php.net/memcachedexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.touchbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/book.mqseries.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.memcachedexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.memcachedexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.memcachedexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.memcachedexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.memcachedexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.memcachedexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.memcachedexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.memcachedexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.memcachedexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.memcachedexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.memcachedexception.php" hreflang="zh">
...
<meta name="Description" content="The MemcachedException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MemcachedException - Manual" />
<meta name="twitter:description" content="The MemcachedException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MemcachedException - Manual" />
<meta itemprop="description" content="The MemcachedException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MemcachedException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.mqseries.php">
          mqseries &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.touchbykey.php">
          &laquo; Memcached::touchByKey        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.memcachedexception.php' selected="selected">English</option>
            <option value='de/class.memcachedexception.php'>German</option>
            <option value='es/class.memcachedexception.php'>Spanish</option>
            <option value='fr/class.memcachedexception.php'>French</option>
            <option value='it/class.memcachedexception.php'>Italian</option>
            <option value='ja/class.memcachedexception.php'>Japanese</option>
            <option value='pt_BR/class.memcachedexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.memcachedexception.php'>Russian</option>
            <option value='tr/class.memcachedexception.php'>Turkish</option>
            <option value='uk/class.memcachedexception.php'>Ukrainian</option>
            <option value='zh/class.memcachedexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.memcachedexception" class="reference">

 <h1 class="title">The MemcachedException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL memcached &gt;= 0.1.0)</p>


  <div class="section" id="memcachedexception.intro">
  ...
  <div class="section" id="memcachedexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MemcachedException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcachedexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.memcachedexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.memcachedexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.memcachedexception.php">＋<small>add a note</small></a></span>
