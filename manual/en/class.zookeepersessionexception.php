...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeepersessionexception.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.zookeeperoperationtimeoutexception.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.search.php">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="refs.search.php">
          Search Engine Extensions &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeepersessionexception.php' selected="selected">English</option>
            ...
            <option value='zh/class.zookeepersessionexception.php'>Chinese (Simplified)</option>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeepersessionexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeepersessionexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeepersessionexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeepersessionexception.php">＋<small>add a note</small></a></span>
