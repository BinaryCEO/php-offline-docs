...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-random-bits.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-random.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-random-range.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-random-bits.php' selected="selected">English</option>
            <option value='de/function.gmp-random-bits.php'>German</option>
            <option value='es/function.gmp-random-bits.php'>Spanish</option>
            <option value='fr/function.gmp-random-bits.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.6.3, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_random_bits</span> &mdash; <span class="dc-title">Random number</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-random-bits-description">
  ...
  <p class="para">
   <code class="parameter">bits</code> must greater than 0,
 ...
 <div class="refsect1 errors" id="refsect1-function.gmp-random-bits-errors">
  ...
  <p class="para">
   If <code class="parameter">bits</code> is less than <code class="literal">1</code>,
...
15</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-random-bits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-random-bits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-random-bits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-random-bits.php">＋<small>add a note</small></a></span>
