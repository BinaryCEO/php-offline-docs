...
<head>
  ...
  <title>PHP: Gmagick::getimagecolors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagecolors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagecolors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecolors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecolors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagecolors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagecolors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagecolors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagecolors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagecolors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagecolors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagecolors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagecolors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagecolors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagecolors.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagecolors - Manual" />
<meta name="twitter:description" content="Returns the color of the specified colormap index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagecolors - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagecolorspace.php">
          Gmagick::getimagecolorspace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagechanneldepth.php">
          &laquo; Gmagick::getimagechanneldepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagecolors.php' selected="selected">English</option>
            <option value='de/gmagick.getimagecolors.php'>German</option>
            <option value='es/gmagick.getimagecolors.php'>Spanish</option>
            <option value='fr/gmagick.getimagecolors.php'>French</option>
            <option value='it/gmagick.getimagecolors.php'>Italian</option>
            <option value='ja/gmagick.getimagecolors.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagecolors.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagecolors.php'>Russian</option>
            <option value='tr/gmagick.getimagecolors.php'>Turkish</option>
            <option value='uk/gmagick.getimagecolors.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagecolors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagecolors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagecolors</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagecolors</span> &mdash; <span class="dc-title">Returns the color of the specified colormap index</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagecolors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagecolors</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagecolors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagecolors-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagecolors-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagecolors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagecolors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagecolors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagecolors.php">＋<small>add a note</small></a></span>
