...
<head>
  ...
  <title>PHP: SolrQuery::setTermsMaxCount - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermslowerbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsmincount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsmaxcount.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsmaxcount.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsmaxcount.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsmaxcount.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsmaxcount.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsmaxcount.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsmaxcount.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsmaxcount.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsmaxcount.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsmaxcount.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsmaxcount.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum document frequency" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsMaxCount - Manual" />
<meta name="twitter:description" content="Sets the maximum document frequency" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsMaxCount - Manual" />
<meta itemprop="description" content="Sets the maximum document frequency" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum document frequency" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settermsmincount.php">
          SolrQuery::setTermsMinCount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermslowerbound.php">
          &laquo; SolrQuery::setTermsLowerBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsmaxcount.php' selected="selected">English</option>
            <option value='de/solrquery.settermsmaxcount.php'>German</option>
            <option value='es/solrquery.settermsmaxcount.php'>Spanish</option>
            <option value='fr/solrquery.settermsmaxcount.php'>French</option>
            <option value='it/solrquery.settermsmaxcount.php'>Italian</option>
            <option value='ja/solrquery.settermsmaxcount.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsmaxcount.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsmaxcount.php'>Russian</option>
            <option value='tr/solrquery.settermsmaxcount.php'>Turkish</option>
            <option value='uk/solrquery.settermsmaxcount.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsmaxcount.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsmaxcount" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsMaxCount</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsMaxCount</span> &mdash; <span class="dc-title">Sets the maximum document frequency</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsmaxcount-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsMaxCount</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$frequency</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsmaxcount-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">frequency</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsmaxcount-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsmaxcount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsmaxcount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsmaxcount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsmaxcount.php">＋<small>add a note</small></a></span>
