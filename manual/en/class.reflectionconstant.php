...
<head>
  ...
  <title>PHP: ReflectionConstant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionconstant.php">
 <link rel="shorturl" href="https://www.php.net/reflectionconstant">
 <link rel="alternate" href="https://www.php.net/reflectionconstant" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclassconstant.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionconstant.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionconstant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionconstant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionconstant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionconstant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionconstant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionconstant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionconstant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionconstant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionconstant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionconstant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionconstant.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionConstant class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionConstant - Manual" />
<meta name="twitter:description" content="The ReflectionConstant class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionConstant - Manual" />
<meta itemprop="description" content="The ReflectionConstant class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionConstant class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionconstant.construct.php">
          ReflectionConstant::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclassconstant.tostring.php">
          &laquo; ReflectionClassConstant::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionconstant.php' selected="selected">English</option>
            <option value='de/class.reflectionconstant.php'>German</option>
            <option value='es/class.reflectionconstant.php'>Spanish</option>
            <option value='fr/class.reflectionconstant.php'>French</option>
            <option value='it/class.reflectionconstant.php'>Italian</option>
            <option value='ja/class.reflectionconstant.php'>Japanese</option>
            <option value='pt_BR/class.reflectionconstant.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionconstant.php'>Russian</option>
            <option value='tr/class.reflectionconstant.php'>Turkish</option>
            <option value='uk/class.reflectionconstant.php'>Ukrainian</option>
            <option value='zh/class.reflectionconstant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionconstant" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionconstant.construct.php">ReflectionConstant::__construct</a> — Constructs a ReflectionConstant</li><li><a href="reflectionconstant.getextension.php">ReflectionConstant::getExtension</a> — Gets ReflectionExtension of the defining extension</li><li><a href="reflectionconstant.getextensionname.php">ReflectionConstant::getExtensionName</a> — Gets name of the defining extension</li><li><a href="reflectionconstant.getfilename.php">ReflectionConstant::getFileName</a> — Gets name of the defining file</li><li><a href="reflectionconstant.getname.php">ReflectionConstant::getName</a> — Gets name</li><li><a href="reflectionconstant.getnamespacename.php">ReflectionConstant::getNamespaceName</a> — Gets namespace name</li><li><a href="reflectionconstant.getshortname.php">ReflectionConstant::getShortName</a> — Gets short name</li><li><a href="reflectionconstant.getvalue.php">ReflectionConstant::getValue</a> — Gets value</li><li><a href="reflectionconstant.isdeprecated.php">ReflectionConstant::isDeprecated</a> — Checks if deprecated</li><li><a href="reflectionconstant.tostring.php">ReflectionConstant::__toString</a> — Returns string representation</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionconstant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionconstant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionconstant.php">＋<small>add a note</small></a></span>
