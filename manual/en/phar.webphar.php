...
<head>
  ...
  <title>PHP: Phar::webPhar - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.webphar.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.webphar.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.webphar.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.unlinkarchive.php">
 <link rel="next" href="https://www.php.net/manual/en/class.phardata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.webphar.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.webphar.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.webphar.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.webphar.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.webphar.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.webphar.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.webphar.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.webphar.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.webphar.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.webphar.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.webphar.php" hreflang="zh">
...
<meta name="Description" content="Routes a request from a web browser to an internal file within the phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::webPhar - Manual" />
<meta name="twitter:description" content="Routes a request from a web browser to an internal file within the phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::webPhar - Manual" />
<meta itemprop="description" content="Routes a request from a web browser to an internal file within the phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Routes a request from a web browser to an internal file within the phar archive" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.phardata.php">
          PharData &raquo;
              ...
              <div class="prev">
        <a href="phar.unlinkarchive.php">
          &laquo; Phar::unlinkArchive        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.webphar.php' selected="selected">English</option>
            <option value='de/phar.webphar.php'>German</option>
            <option value='es/phar.webphar.php'>Spanish</option>
            <option value='fr/phar.webphar.php'>French</option>
            <option value='it/phar.webphar.php'>Italian</option>
            <option value='ja/phar.webphar.php'>Japanese</option>
            <option value='pt_BR/phar.webphar.php'>Brazilian Portuguese</option>
            <option value='ru/phar.webphar.php'>Russian</option>
            <option value='tr/phar.webphar.php'>Turkish</option>
            <option value='uk/phar.webphar.php'>Ukrainian</option>
            <option value='zh/phar.webphar.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.webphar" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.interceptfilefuncs.php" class="function" rel="rdfs-seeAlso">Phar::interceptFileFuncs()</a> - Instructs phar to intercept fopen, file_get_contents, opendir, and all of the stat-related functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/webPhar.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.webphar%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.webphar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.webphar.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110271">  <div class="votes">
    <div id="Vu110271">
    <a href="/manual/vote-note.php?id=110271&amp;page=phar.webphar&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110271">
    <a href="/manual/vote-note.php?id=110271&amp;page=phar.webphar&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110271" title="57% like this...">
    1
    </div>
  </div>
  <a href="#110271" class="name">
  <strong class="user"><em>James</em></strong></a><a class="genanchor" href="#110271"> &para;</a><div class="date" title="2012-10-06 07:55"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110271">
<div class="phpcode"><code><span class="html">It seems that calling Phar::webPhar() from inside a function is a bad idea.  Doing so will cause global variables in included files to not be global.  For instance, do NOT try this:<br /><br /><span class="default">&lt;?php<br />$phar </span><span class="keyword">= new </span><span class="default">Phar</span><span class="keyword">(</span><span class="string">'test.phar.php'</span><span class="keyword">);<br /></span><span class="default">$phar</span><span class="keyword">[</span><span class="string">'test.php'</span><span class="keyword">] = </span><span class="string">'&lt;?php<br />$FOO = "globals work";<br />function test() {<br />  global $FOO;<br />  echo "test: $FOO\n";<br />}<br />test();<br />?&gt;'</span><span class="keyword">;<br /></span><span class="default">$phar</span><span class="keyword">-&gt;</span><span class="default">setStub</span><span class="keyword">(</span><span class="string">'&lt;?php<br />function _bootstrap() {<br />Phar::webPhar();<br />}<br />_bootstrap();<br />__HALT_COMPILER(); ?&gt;'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The output will be "test:", not "test: globals work".</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.webphar&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.webphar.php">＋<small>add a note</small></a></div>
