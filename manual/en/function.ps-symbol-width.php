...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-symbol-width.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-symbol-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-translate.php">
...
<meta name="Description" content="Gets width of a glyph" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_symbol_width - Manual" />
<meta name="twitter:description" content="Gets width of a glyph" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_symbol_width - Manual" />
<meta itemprop="description" content="Gets width of a glyph" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets width of a glyph" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-symbol-width.php' selected="selected">English</option>
            <option value='de/function.ps-symbol-width.php'>German</option>
            <option value='es/function.ps-symbol-width.php'>Spanish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-symbol-name.php" class="function" rel="rdfs-seeAlso">ps_symbol_name()</a> - Gets name of a glyph</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-symbol-width.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-symbol-width%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-symbol-width&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-symbol-width.php">＋<small>add a note</small></a></span>
