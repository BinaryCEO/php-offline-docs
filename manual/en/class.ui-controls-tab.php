...
<head>
  ...
  <title>PHP: UI\Controls\Tab - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-tab.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-tab">
 <link rel="alternate" href="https://www.php.net/ui-controls-tab" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-executor.setinterval.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-tab.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-tab.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-tab.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-tab.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-tab.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-tab.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-tab.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-tab.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-tab.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-tab.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-tab.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-tab.php" hreflang="zh">
...
<meta name="Description" content="Tab Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Tab - Manual" />
<meta name="twitter:description" content="Tab Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Tab - Manual" />
<meta itemprop="description" content="Tab Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tab Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-tab.append.php">
          UI\Controls\Tab::append &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-executor.setinterval.php">
          &laquo; UI\Executor::setInterval        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-tab.php' selected="selected">English</option>
            <option value='de/class.ui-controls-tab.php'>German</option>
            <option value='es/class.ui-controls-tab.php'>Spanish</option>
            <option value='fr/class.ui-controls-tab.php'>French</option>
            <option value='it/class.ui-controls-tab.php'>Italian</option>
            <option value='ja/class.ui-controls-tab.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-tab.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-tab.php'>Russian</option>
            <option value='tr/class.ui-controls-tab.php'>Turkish</option>
            <option value='uk/class.ui-controls-tab.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-tab.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-tab" class="reference">

 <h1 class="title">Tab Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-tab.intro">
  ...
  <div class="section" id="ui-controls-tab.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Tab</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     <span class="modifier">protected</span>
      <var class="varname"><a href="class.ui-controls-tab.php#ui-controls-tab.props.controls">$<var class="varname">controls</var></a></var>;</div>

    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.append.php" class="methodname">append</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="class.ui-control.php" class="type UI\Control">UI\Control</a></span> <code class="parameter">$control</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.delete.php" class="methodname">delete</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.hasmargin.php" class="methodname">hasMargin</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$page</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.insertat.php" class="methodname">insertAt</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$page</code></span>, <span class="methodparam"><span class="type"><a href="class.ui-control.php" class="type UI\Control">UI\Control</a></span> <code class="parameter">$control</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.pages.php" class="methodname">pages</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-tab.setmargin.php" class="methodname">setMargin</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$page</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$margin</code></span>)</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-control.show.php" class="methodname">UI\Control::show</a></span>()</div>
  ...
  <div class="section" id="ui-controls-tab.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="ui-controls-tab.props.controls"><var class="varname">controls</var></dt>
     <dd>
      <p class="para">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-tab.append.php">UI\Controls\Tab::append</a> — Append Page</li><li><a href="ui-controls-tab.delete.php">UI\Controls\Tab::delete</a> — Delete Page</li><li><a href="ui-controls-tab.hasmargin.php">UI\Controls\Tab::hasMargin</a> — Margin Detection</li><li><a href="ui-controls-tab.insertat.php">UI\Controls\Tab::insertAt</a> — Insert Page</li><li><a href="ui-controls-tab.pages.php">UI\Controls\Tab::pages</a> — Page Count</li><li><a href="ui-controls-tab.setmargin.php">UI\Controls\Tab::setMargin</a> — Set Margin</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.tab.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-tab%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-tab&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-tab.php">＋<small>add a note</small></a></span>
