...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-seek.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-read-all.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-tell.php">
...
<meta name="Description" content="Seeks position within a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_seek - Manual" />
<meta name="twitter:description" content="Seeks position within a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_seek - Manual" />
<meta itemprop="description" content="Seeks position within a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seeks position within a large object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-seek.php' selected="selected">English</option>
            ...
            <option value='ru/function.pg-lo-seek.php'>Russian</option>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-seek-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_lo_seek()</strong></span> seeks a position within an <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-lo-seek-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the constants <strong><code><a href="pgsql.constants.php#constant.pgsql-seek-set">PGSQL_SEEK_SET</a></code></strong> (seek from object start), 
       <strong><code><a href="pgsql.constants.php#constant.pgsql-seek-cur">PGSQL_SEEK_CUR</a></code></strong> (seek from current position)
       or <strong><code><a href="pgsql.constants.php#constant.pgsql-seek-end">PGSQL_SEEK_END</a></code></strong> (seek from object end) .
      </p>
     </dd>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-tell.php" class="function" rel="rdfs-seeAlso">pg_lo_tell()</a> - Returns current seek position a of large object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-seek.php">＋<small>add a note</small></a></span>
