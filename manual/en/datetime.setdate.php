...
<head>
  ...
  <title>PHP: DateTime::setDate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.setdate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.setdate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setdate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.set-state.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.setisodate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.setdate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.setdate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.setdate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.setdate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.setdate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.setdate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.setdate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.setdate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.setdate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.setdate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.setdate.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: DateTime::setDate - Manual" />
<meta name="twitter:description" content="Sets the date" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTime::setDate - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.setisodate.php">
          DateTime::setISODate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.set-state.php">
          &laquo; DateTime::__set_state        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.setdate.php' selected="selected">English</option>
            <option value='de/datetime.setdate.php'>German</option>
            <option value='es/datetime.setdate.php'>Spanish</option>
            <option value='fr/datetime.setdate.php'>French</option>
            <option value='it/datetime.setdate.php'>Italian</option>
            <option value='ja/datetime.setdate.php'>Japanese</option>
            <option value='pt_BR/datetime.setdate.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.setdate.php'>Russian</option>
            <option value='tr/datetime.setdate.php'>Turkish</option>
            <option value='uk/datetime.setdate.php'>Ukrainian</option>
            <option value='zh/datetime.setdate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.setdate" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="datetimeimmutable.setdate.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setDate()</a> - Sets the date</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetime/setdate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.setdate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.setdate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.setdate.php">＋<small>add a note</small></a></span>
