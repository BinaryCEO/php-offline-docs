...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightRequireFieldMatch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightregexslop.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightrequirefieldmatch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightrequirefieldmatch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightrequirefieldmatch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightrequirefieldmatch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightrequirefieldmatch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightrequirefieldmatch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightrequirefieldmatch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightrequirefieldmatch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightrequirefieldmatch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightrequirefieldmatch.php" hreflang="zh">
...
<meta name="Description" content="Require field matching during highlighting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightRequireFieldMatch - Manual" />
<meta name="twitter:description" content="Require field matching during highlighting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightRequireFieldMatch - Manual" />
<meta itemprop="description" content="Require field matching during highlighting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Require field matching during highlighting" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightsimplepost.php">
          SolrQuery::setHighlightSimplePost &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightregexslop.php">
          &laquo; SolrQuery::setHighlightRegexSlop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightrequirefieldmatch.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightrequirefieldmatch.php'>German</option>
            <option value='es/solrquery.sethighlightrequirefieldmatch.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightrequirefieldmatch.php'>French</option>
            <option value='it/solrquery.sethighlightrequirefieldmatch.php'>Italian</option>
            <option value='ja/solrquery.sethighlightrequirefieldmatch.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightrequirefieldmatch.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightrequirefieldmatch.php'>Russian</option>
            <option value='tr/solrquery.sethighlightrequirefieldmatch.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightrequirefieldmatch.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightrequirefieldmatch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightrequirefieldmatch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightRequireFieldMatch</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightRequireFieldMatch</span> &mdash; <span class="dc-title">Require field matching during highlighting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightrequirefieldmatch-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightRequireFieldMatch</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>

  <p class="para rdfs-comment">
   If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, then a field will only be highlighted if the query matched in this particular field.
  </p>

  <p class="para">This will only work if SolrQuery::setHighlightUsePhraseHighlighter() was set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong></p>

 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightrequirefieldmatch-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightrequirefieldmatch-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightrequirefieldmatch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightrequirefieldmatch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightrequirefieldmatch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php">＋<small>add a note</small></a></span>
