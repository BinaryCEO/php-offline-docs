...
<head>
  ...
  <title>PHP: openssl_free_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-free-key.php">
 <link rel="shorturl" href="https://www.php.net/openssl-free-key">
 <link rel="alternate" href="https://www.php.net/openssl-free-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-error-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-get-cert-locations.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-free-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-free-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-free-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-free-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-free-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-free-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-free-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-free-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-free-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-free-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-free-key.php" hreflang="zh">
...
<meta name="Description" content="Free key resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_free_key - Manual" />
<meta name="twitter:description" content="Free key resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_free_key - Manual" />
<meta itemprop="description" content="Free key resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Free key resource" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-get-cert-locations.php">
          openssl_get_cert_locations &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-error-string.php">
          &laquo; openssl_error_string        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-free-key.php' selected="selected">English</option>
            <option value='de/function.openssl-free-key.php'>German</option>
            <option value='es/function.openssl-free-key.php'>Spanish</option>
            <option value='fr/function.openssl-free-key.php'>French</option>
            <option value='it/function.openssl-free-key.php'>Italian</option>
            <option value='ja/function.openssl-free-key.php'>Japanese</option>
            <option value='pt_BR/function.openssl-free-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-free-key.php'>Russian</option>
            <option value='tr/function.openssl-free-key.php'>Turkish</option>
            <option value='uk/function.openssl-free-key.php'>Ukrainian</option>
            <option value='zh/function.openssl-free-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-free-key" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_free_key</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_free_key</span> &mdash; <span class="dc-title">Free key resource</span></p>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-free-key-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_free_key()</strong></span> frees the key associated with
   the specified <code class="parameter">key</code> from memory.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">key</code> accepts an <span class="classname"><a href="class.opensslasymmetrickey.php" class="classname">OpenSSLAsymmetricKey</a></span> now;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-free-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-free-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-free-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-free-key.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121853">  <div class="votes">
    <div id="Vu121853">
    <a href="/manual/vote-note.php?id=121853&amp;page=function.openssl-free-key&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121853">
    <a href="/manual/vote-note.php?id=121853&amp;page=function.openssl-free-key&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121853" title="61% like this...">
    5
    </div>
  </div>
  <a href="#121853" class="name">
  <strong class="user"><em>Lawri van Bul</em></strong></a><a class="genanchor" href="#121853"> &para;</a><div class="date" title="2017-11-10 11:05"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121853">
<div class="phpcode"><code><span class="html">I just checked the code for PHP 7.1 and in there openssl_free_key is an alias for opnessl_pkey_free (PHP_FALIAS). <br /><br />This supports Richards assumption. <br /><br />I would also suggest to not use the alias,<br />but use the openssl_pkey_free function in new code.<br /><br />This is because it is more descriptive about what its intend is and is the same structure as similar function in the openssl section.</span></code></div>
  </div>
 </div>
  <div class="note" id="112731">  <div class="votes">
    <div id="Vu112731">
    <a href="/manual/vote-note.php?id=112731&amp;page=function.openssl-free-key&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112731">
    <a href="/manual/vote-note.php?id=112731&amp;page=function.openssl-free-key&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112731" title="51% like this...">
    1
    </div>
  </div>
  <a href="#112731" class="name">
  <strong class="user"><em>Richard Lynch</em></strong></a><a class="genanchor" href="#112731"> &para;</a><div class="date" title="2013-07-17 03:44"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112731">
<div class="phpcode"><code><span class="html">openssl_free_key and openssl_pkey_free are probably aliases.<br /><br />And the preferred one is probably openssl_pkey_free.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-free-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-free-key.php">＋<small>add a note</small></a></div>
