...
<head>
  ...
  <title>PHP: db2_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-prepare.php">
 <link rel="shorturl" href="https://www.php.net/db2-prepare">
 <link rel="alternate" href="https://www.php.net/db2-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-primary-keys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-prepare.php" hreflang="zh">
...
<meta name="Description" content="Prepares an SQL statement to be executed" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_prepare - Manual" />
<meta name="twitter:description" content="Prepares an SQL statement to be executed" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_prepare - Manual" />
<meta itemprop="description" content="Prepares an SQL statement to be executed" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepares an SQL statement to be executed" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-primary-keys.php">
          db2_primary_keys &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-pconnect.php">
          &laquo; db2_pconnect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-prepare.php' selected="selected">English</option>
            <option value='de/function.db2-prepare.php'>German</option>
            <option value='es/function.db2-prepare.php'>Spanish</option>
            <option value='fr/function.db2-prepare.php'>French</option>
            <option value='it/function.db2-prepare.php'>Italian</option>
            <option value='ja/function.db2-prepare.php'>Japanese</option>
            <option value='pt_BR/function.db2-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-prepare.php'>Russian</option>
            <option value='tr/function.db2-prepare.php'>Turkish</option>
            <option value='uk/function.db2-prepare.php'>Ukrainian</option>
            <option value='zh/function.db2-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-prepare" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-stmt-errormsg.php" class="function" rel="rdfs-seeAlso">db2_stmt_errormsg()</a> - Returns a string containing the last SQL statement error message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-prepare.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120093">  <div class="votes">
    <div id="Vu120093">
    <a href="/manual/vote-note.php?id=120093&amp;page=function.db2-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120093">
    <a href="/manual/vote-note.php?id=120093&amp;page=function.db2-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120093" title="50% like this...">
    0
    </div>
  </div>
  <a href="#120093" class="name">
  <strong class="user"><em>agr dot valayam at gmail dot com</em></strong></a><a class="genanchor" href="#120093"> &para;</a><div class="date" title="2016-10-27 12:08"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120093">
<div class="phpcode"><code><span class="html">A simple select example.<br />  <br />$pr_stmt = db2_prepare ($this-&gt;conn,"select count(*) from note where city=? and year= ?");<br />  db2_execute($pr_stmt,array('test',2016));<br />   $count_res = db2_fetch_array($pr_stmt);<br />echo "Count =".$count_res[0]</span></code></div>
  </div>
 </div>
  <div class="note" id="94687">  <div class="votes">
    <div id="Vu94687">
    <a href="/manual/vote-note.php?id=94687&amp;page=function.db2-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94687">
    <a href="/manual/vote-note.php?id=94687&amp;page=function.db2-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94687" title="no votes...">
    0
    </div>
  </div>
  <a href="#94687" class="name">
  <strong class="user"><em>NormInNorman</em></strong></a><a class="genanchor" href="#94687"> &para;</a><div class="date" title="2009-11-18 07:52"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94687">
<div class="phpcode"><code><span class="html">If you are having problems with scrollable cursors and the prepare statement, I've found that you cant set the scrollable option on the connection.  The following code (which tries to get the 2nd record):<br /><br /><span class="default">&lt;?php<br />$sql </span><span class="keyword">= </span><span class="string">"SELECT * FROM SCHEMA.TABLENAME"</span><span class="keyword">;<br /></span><span class="default">$options </span><span class="keyword">= array(</span><span class="string">'cursor' </span><span class="keyword">=&gt; </span><span class="default">DB2_SCROLLABLE</span><span class="keyword">);<br /></span><span class="default">$conn </span><span class="keyword">= </span><span class="default">db2_connect</span><span class="keyword">(</span><span class="default">$database</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">$password</span><span class="keyword">,</span><span class="default">$options</span><span class="keyword">);<br /></span><span class="default">$stmt </span><span class="keyword">= </span><span class="default">db2_prepare</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$sql</span><span class="keyword">);<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">db2_execute</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">);<br /></span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_both</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br /><br /></span><span class="default">$conn </span><span class="keyword">= </span><span class="default">db2_connect</span><span class="keyword">(</span><span class="default">$database</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">$password</span><span class="keyword">);<br /></span><span class="default">$stmt </span><span class="keyword">= </span><span class="default">db2_prepare</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="default">$sql</span><span class="keyword">, </span><span class="default">$options</span><span class="keyword">);<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">db2_execute</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">);<br /></span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_both</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Will result in the following error:<br /><br />Warning: db2_fetch_both() [function.db2-fetch-both]: Fetch Failure in dbtest.php on line 7<br /><br />In fact, even if you set the options on both the connection and the prepare your fetch will not work. You must only set that option on the prepare.</span></code></div>
  </div>
 </div>
  <div class="note" id="68846">  <div class="votes">
    <div id="Vu68846">
    <a href="/manual/vote-note.php?id=68846&amp;page=function.db2-prepare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68846">
    <a href="/manual/vote-note.php?id=68846&amp;page=function.db2-prepare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68846" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#68846" class="name">
  <strong class="user"><em>ndt.db2 at google mail</em></strong></a><a class="genanchor" href="#68846"> &para;</a><div class="date" title="2006-08-12 06:41"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68846">
<div class="phpcode"><code><span class="html">if you have the error message : PHP Warning:  db2_prepare() [&lt;a href='function.db2-prepare'&gt;function.db2-prepare&lt;/a&gt;]: Statement Prepare Failed in (....)<br />and cannot display the error message using db2_stmt_errormsg() , then check if your database connection handle is (still) valid</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-prepare.php">＋<small>add a note</small></a></div>
