...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-escape-literal.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-escape-identifier.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-escape-string.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-escape-literal.php' selected="selected">English</option>
            ...
            <option value='zh/function.pg-escape-literal.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-escape-literal-examples">
  ...
  <p class="para">
   <div class="example" id="example-2054">
    <p><strong>Example #1 <span class="function"><strong>pg_escape_literal()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-escape-string.php" class="function" rel="rdfs-seeAlso">pg_escape_string()</a> - Escape a string for query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-escape-literal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-escape-literal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-escape-literal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-escape-literal.php">＋<small>add a note</small></a></span>
