...
<head>
  ...
  <title>PHP: Yaf_Exception_RouterFailed - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-exception-routerfailed.php">
 <link rel="shorturl" href="https://www.php.net/yaf-exception-routerfailed">
 <link rel="alternate" href="https://www.php.net/yaf-exception-routerfailed" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.yaf-exception-dispatchfailed.php">
 <link rel="next" href="https://www.php.net/manual/en/class.yaf-exception-loadfailed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-exception-routerfailed.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-exception-routerfailed.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-exception-routerfailed.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-exception-routerfailed.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-exception-routerfailed.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-exception-routerfailed.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-exception-routerfailed.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-exception-routerfailed.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-exception-routerfailed.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-exception-routerfailed.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-exception-routerfailed.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Exception_RouterFailed class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Exception_RouterFailed - Manual" />
<meta name="twitter:description" content="The Yaf_Exception_RouterFailed class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Exception_RouterFailed - Manual" />
<meta itemprop="description" content="The Yaf_Exception_RouterFailed class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Exception_RouterFailed class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.yaf-exception-loadfailed.php">
          Yaf_Exception_LoadFailed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.yaf-exception-dispatchfailed.php">
          &laquo; Yaf_Exception_DispatchFailed        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-exception-routerfailed.php' selected="selected">English</option>
            <option value='de/class.yaf-exception-routerfailed.php'>German</option>
            <option value='es/class.yaf-exception-routerfailed.php'>Spanish</option>
            <option value='fr/class.yaf-exception-routerfailed.php'>French</option>
            <option value='it/class.yaf-exception-routerfailed.php'>Italian</option>
            <option value='ja/class.yaf-exception-routerfailed.php'>Japanese</option>
            <option value='pt_BR/class.yaf-exception-routerfailed.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-exception-routerfailed.php'>Russian</option>
            <option value='tr/class.yaf-exception-routerfailed.php'>Turkish</option>
            <option value='uk/class.yaf-exception-routerfailed.php'>Ukrainian</option>
            <option value='zh/class.yaf-exception-routerfailed.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-exception-routerfailed" class="reference">
  ...
  <div class="section" id="yaf-exception-routerfailed.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Yaf_Exception_RouterFailed</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="yaf-exception.getprevious.php" class="methodname">Yaf_Exception::getPrevious</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-exception-routerfailed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-exception-routerfailed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-exception-routerfailed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-exception-routerfailed.php">＋<small>add a note</small></a></span>
