...
<head>
  ...
  <title>PHP: Dom\Element - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-element.php">
 <link rel="shorturl" href="https://www.php.net/dom-element">
 <link rel="alternate" href="https://www.php.net/dom-element" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-dtdnamednodemap.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-entity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-element.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-element.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-element.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-element.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-element.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-element.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-element.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-element.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-element.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-element.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-element.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Element class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Element - Manual" />
<meta name="twitter:description" content="The Dom\Element class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Element - Manual" />
<meta itemprop="description" content="The Dom\Element class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Element class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-entity.php">
          Dom\Entity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-dtdnamednodemap.php">
          &laquo; Dom\DtdNamedNodeMap        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-element.php' selected="selected">English</option>
            <option value='de/class.dom-element.php'>German</option>
            <option value='es/class.dom-element.php'>Spanish</option>
            <option value='fr/class.dom-element.php'>French</option>
            <option value='it/class.dom-element.php'>Italian</option>
            <option value='ja/class.dom-element.php'>Japanese</option>
            <option value='pt_BR/class.dom-element.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-element.php'>Russian</option>
            <option value='tr/class.dom-element.php'>Turkish</option>
            <option value='uk/class.dom-element.php'>Ukrainian</option>
            <option value='zh/class.dom-element.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-element" class="reference">
 <h1 class="title">The Dom\Element class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-element.intro">
   ...
   <p class="simpara">
    ...
    <span class="classname"><a href="class.domelement.php" class="classname">DOMElement</a></span>.
   </p>
  </div>

  <div class="section" id="dom-element.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Element</strong></strong>
     ...
     <span class="modifier">implements</span>
      <a href="class.dom-parentnode.php" class="interfacename">Dom\ParentNode</a>,
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.namespaceuri">$<var class="varname">namespaceURI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.prefix">$<var class="varname">prefix</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.localname">$<var class="varname">localName</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.tagname">$<var class="varname">tagName</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.id">$<var class="varname">id</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.classname">$<var class="varname">className</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.dom-tokenlist.php" class="type Dom\TokenList">Dom\TokenList</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.classlist">$<var class="varname">classList</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="class.dom-namednodemap.php" class="type Dom\NamedNodeMap">Dom\NamedNodeMap</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.attributes">$<var class="varname">attributes</var></a></var>;</div>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.firstelementchild">$<var class="varname">firstElementChild</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.lastelementchild">$<var class="varname">lastElementChild</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.childelementcount">$<var class="varname">childElementCount</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.previouselementsibling">$<var class="varname">previousElementSibling</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.nextelementsibling">$<var class="varname">nextElementSibling</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.innerhtml">$<var class="varname">innerHTML</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.dom-element.php#dom-element.props.substitutednodevalue">$<var class="varname">substitutedNodeValue</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-element.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-element.props.namespaceuri"><var class="varname">namespaceURI</var></dt>
     <dd>
      <span class="simpara">The namespace <abbr class="abbrev">URI</abbr> of the element.</span>
     </dd>
    
    
     <dt id="dom-element.props.prefix"><var class="varname">prefix</var></dt>
     <dd>
      <span class="simpara">The namespace prefix of the element.</span>
     </dd>
    
    
     <dt id="dom-element.props.localname"><var class="varname">localName</var></dt>
     <dd>
      <span class="simpara">The local name of the element.</span>
     </dd>
    
    
     <dt id="dom-element.props.tagname"><var class="varname">tagName</var></dt>
     <dd>
      <span class="simpara">The HTML-uppercased qualified name of the element.</span>
     </dd>
    
    
     <dt id="dom-element.props.classname"><var class="varname">className</var></dt><dd>
      <p class="para">A string representing the classes of the element separated by spaces.</p>
     </dd>
    
    
     <dt id="dom-element.props.classlist"><var class="varname">classList</var></dt>
     <dd>
      <span class="simpara">
       Returns an instance of <span class="classname"><a href="class.dom-tokenlist.php" class="classname">Dom\TokenList</a></span> to
       easily manage the classes on this element.
      </span>
     </dd>
    
    
     <dt id="dom-element.props.attributes"><var class="varname">attributes</var></dt>
     <dd>
      <span class="simpara">
       Returns an instance of <span class="classname"><a href="class.dom-namednodemap.php" class="classname">Dom\NamedNodeMap</a></span> that
       represents the attributes of this element.
      </span>
     </dd>
    
    
     <dt id="dom-element.props.id"><var class="varname">id</var></dt><dd>
      <p class="para">Reflects the element ID through the <code class="literal">&quot;id&quot;</code> attribute.</p>
     </dd>
    
    
     <dt id="dom-element.props.firstelementchild"><var class="varname">firstElementChild</var></dt><dd>
      <p class="para">First child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-element.props.lastelementchild"><var class="varname">lastElementChild</var></dt><dd>
      <p class="para">Last child element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-element.props.childelementcount"><var class="varname">childElementCount</var></dt><dd>
      <p class="para">The number of child elements.</p>
     </dd>
    
    
     <dt id="dom-element.props.previouselementsibling"><var class="varname">previousElementSibling</var></dt><dd>
     ...
     <dt id="dom-element.props.nextelementsibling"><var class="varname">nextElementSibling</var></dt><dd>
      <p class="para">The next sibling element or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.</p>
     </dd>
    
    
     <dt id="dom-element.props.innerhtml"><var class="varname">innerHTML</var></dt>
     <dd>
      <span class="simpara">The inner HTML (or XML for XML documents) of the element.</span>
     </dd>
    
    
     <dt id="dom-element.props.substitutednodevalue"><var class="varname">substitutedNodeValue</var></dt>
     <dd>
      <span class="simpara">The node value with entity substitution enabled.</span>
     </dd>
  ...
  The parser methods auto-detect the encoding or allow the caller to specify an encoding.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-element.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-element%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-element&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-element.php">＋<small>add a note</small></a></span>
