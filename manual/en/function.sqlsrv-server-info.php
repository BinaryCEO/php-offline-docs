...
<head>
  ...
  <title>PHP: sqlsrv_server_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-server-info.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-server-info">
 <link rel="alternate" href="https://www.php.net/sqlsrv-server-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-send-stream-data.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.calendar.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-server-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-server-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-server-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-server-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-server-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-server-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-server-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-server-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-server-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-server-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-server-info.php" hreflang="zh">
...
<meta name="Description" content="Returns information about the server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_server_info - Manual" />
<meta name="twitter:description" content="Returns information about the server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_server_info - Manual" />
<meta itemprop="description" content="Returns information about the server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns information about the server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="refs.calendar.php">
          Date and Time Related Extensions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-send-stream-data.php">
          &laquo; sqlsrv_send_stream_data        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-server-info.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-server-info.php'>German</option>
            <option value='es/function.sqlsrv-server-info.php'>Spanish</option>
            <option value='fr/function.sqlsrv-server-info.php'>French</option>
            <option value='it/function.sqlsrv-server-info.php'>Italian</option>
            <option value='ja/function.sqlsrv-server-info.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-server-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-server-info.php'>Russian</option>
            <option value='tr/function.sqlsrv-server-info.php'>Turkish</option>
            <option value='uk/function.sqlsrv-server-info.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-server-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-server-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_server_info</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_server_info</span> &mdash; <span class="dc-title">Returns information about the server</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.sqlsrv-server-info-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_server_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-client-info.php" class="function" rel="rdfs-seeAlso">sqlsrv_client_info()</a> - Returns information about the client and specified connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-server-info.php">＋<small>add a note</small></a></span>
