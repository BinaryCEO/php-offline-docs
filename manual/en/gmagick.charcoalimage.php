...
<head>
  ...
  <title>PHP: Gmagick::charcoalimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.charcoalimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.charcoalimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.charcoalimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.borderimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.chopimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.charcoalimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.charcoalimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.charcoalimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.charcoalimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.charcoalimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.charcoalimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.charcoalimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.charcoalimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.charcoalimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.charcoalimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.charcoalimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::charcoalimage - Manual" />
<meta name="twitter:description" content="Simulates a charcoal drawing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::charcoalimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.chopimage.php">
          Gmagick::chopimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.borderimage.php">
          &laquo; Gmagick::borderimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.charcoalimage.php' selected="selected">English</option>
            <option value='de/gmagick.charcoalimage.php'>German</option>
            <option value='es/gmagick.charcoalimage.php'>Spanish</option>
            <option value='fr/gmagick.charcoalimage.php'>French</option>
            <option value='it/gmagick.charcoalimage.php'>Italian</option>
            <option value='ja/gmagick.charcoalimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.charcoalimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.charcoalimage.php'>Russian</option>
            <option value='tr/gmagick.charcoalimage.php'>Turkish</option>
            <option value='uk/gmagick.charcoalimage.php'>Ukrainian</option>
            <option value='zh/gmagick.charcoalimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.charcoalimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::charcoalimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::charcoalimage</span> &mdash; <span class="dc-title">Simulates a charcoal drawing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.charcoalimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::charcoalimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.charcoalimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.charcoalimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with charcoal simulation.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.charcoalimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/charcoalimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.charcoalimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.charcoalimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.charcoalimage.php">＋<small>add a note</small></a></span>
