...
<head>
  ...
  <title>PHP: SolrQuery::setFacetPrefix - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetsort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetprefix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetprefix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetprefix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetprefix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetprefix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetprefix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetprefix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetprefix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetprefix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetprefix.php" hreflang="zh">
...
<meta name="Description" content="Specifies a string prefix with which to limits the terms on which to facet" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetPrefix - Manual" />
<meta name="twitter:description" content="Specifies a string prefix with which to limits the terms on which to facet" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetPrefix - Manual" />
<meta itemprop="description" content="Specifies a string prefix with which to limits the terms on which to facet" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies a string prefix with which to limits the terms on which to facet" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setfacetsort.php">
          SolrQuery::setFacetSort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetoffset.php">
          &laquo; SolrQuery::setFacetOffset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetprefix.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetprefix.php'>German</option>
            <option value='es/solrquery.setfacetprefix.php'>Spanish</option>
            <option value='fr/solrquery.setfacetprefix.php'>French</option>
            <option value='it/solrquery.setfacetprefix.php'>Italian</option>
            <option value='ja/solrquery.setfacetprefix.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetprefix.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetprefix.php'>Russian</option>
            <option value='tr/solrquery.setfacetprefix.php'>Turkish</option>
            <option value='uk/solrquery.setfacetprefix.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetprefix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetprefix" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetPrefix</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetPrefix</span> &mdash; <span class="dc-title">Specifies a string prefix with which to limits the terms on which to facet</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetprefix-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetPrefix</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$prefix</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetprefix-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetprefix-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetprefix.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetprefix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetprefix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetprefix.php">＋<small>add a note</small></a></span>
