...
<head>
  ...
  <title>PHP: db2_free_stmt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-free-stmt.php">
 <link rel="shorturl" href="https://www.php.net/db2-free-stmt">
 <link rel="alternate" href="https://www.php.net/db2-free-stmt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-free-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-get-option.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-free-stmt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-free-stmt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-free-stmt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-free-stmt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-free-stmt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-free-stmt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-free-stmt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-free-stmt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-free-stmt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-free-stmt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-free-stmt.php" hreflang="zh">
...
<meta name="Description" content="Frees resources associated with the indicated statement resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_free_stmt - Manual" />
<meta name="twitter:description" content="Frees resources associated with the indicated statement resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_free_stmt - Manual" />
<meta itemprop="description" content="Frees resources associated with the indicated statement resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Frees resources associated with the indicated statement resource" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-get-option.php">
          db2_get_option &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-free-result.php">
          &laquo; db2_free_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-free-stmt.php' selected="selected">English</option>
            <option value='de/function.db2-free-stmt.php'>German</option>
            <option value='es/function.db2-free-stmt.php'>Spanish</option>
            <option value='fr/function.db2-free-stmt.php'>French</option>
            <option value='it/function.db2-free-stmt.php'>Italian</option>
            <option value='ja/function.db2-free-stmt.php'>Japanese</option>
            <option value='pt_BR/function.db2-free-stmt.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-free-stmt.php'>Russian</option>
            <option value='tr/function.db2-free-stmt.php'>Turkish</option>
            <option value='uk/function.db2-free-stmt.php'>Ukrainian</option>
            <option value='zh/function.db2-free-stmt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-free-stmt" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.db2-free-result.php" class="function" rel="rdfs-seeAlso">db2_free_result()</a> - Frees resources associated with a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-free-stmt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-free-stmt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-free-stmt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-free-stmt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119624">  <div class="votes">
    <div id="Vu119624">
    <a href="/manual/vote-note.php?id=119624&amp;page=function.db2-free-stmt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119624">
    <a href="/manual/vote-note.php?id=119624&amp;page=function.db2-free-stmt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119624" title="100% like this...">
    1
    </div>
  </div>
  <a href="#119624" class="name">
  <strong class="user"><em>alan at alanseiden dot com</em></strong></a><a class="genanchor" href="#119624"> &para;</a><div class="date" title="2016-07-19 07:29"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119624">
<div class="phpcode"><code><span class="html">Update: as of version 1.9.2, db2_free_stmt() was not only deprecated, but its functionality removed completely. It returns TRUE but does nothing.<br /><br />Instead of db2_free_stmt(), use the aforementioned $stmt = ''; to trigger the statement's destructor. <br /><br />It is advised to destroy the statement resource in this way if the statement variable is later re-used with another db2_prepare in the same request. <br /><br />Example:<br />$stmt = db2_prepare($conn, $sql1);<br />// more code goes here<br />$stmt = ''; // destroy statement resource before assigning another statement to the same variable.<br />$stmt = db2_prepare($conn, $sql2);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-free-stmt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-free-stmt.php">＋<small>add a note</small></a></div>
