...
<head>
  ...
  <title>PHP: pg_cancel_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-cancel-query.php">
 <link rel="shorturl" href="https://www.php.net/pg-cancel-query">
 <link rel="alternate" href="https://www.php.net/pg-cancel-query" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-affected-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-client-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-cancel-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-cancel-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-cancel-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-cancel-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-cancel-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-cancel-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-cancel-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-cancel-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-cancel-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-cancel-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-cancel-query.php" hreflang="zh">
...
<meta name="Description" content="Cancel an asynchronous query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_cancel_query - Manual" />
<meta name="twitter:description" content="Cancel an asynchronous query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_cancel_query - Manual" />
<meta itemprop="description" content="Cancel an asynchronous query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancel an asynchronous query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-client-encoding.php">
          pg_client_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-affected-rows.php">
          &laquo; pg_affected_rows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-cancel-query.php' selected="selected">English</option>
            <option value='de/function.pg-cancel-query.php'>German</option>
            <option value='es/function.pg-cancel-query.php'>Spanish</option>
            <option value='fr/function.pg-cancel-query.php'>French</option>
            <option value='it/function.pg-cancel-query.php'>Italian</option>
            <option value='ja/function.pg-cancel-query.php'>Japanese</option>
            <option value='pt_BR/function.pg-cancel-query.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-cancel-query.php'>Russian</option>
            <option value='tr/function.pg-cancel-query.php'>Turkish</option>
            <option value='uk/function.pg-cancel-query.php'>Ukrainian</option>
            <option value='zh/function.pg-cancel-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-cancel-query" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-cancel-query-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_cancel_query</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_cancel_query()</strong></span> cancels an asynchronous query sent with 
   <span class="function"><a href="function.pg-send-query.php" class="function">pg_send_query()</a></span>, <span class="function"><a href="function.pg-send-query-params.php" class="function">pg_send_query_params()</a></span>
   or <span class="function"><a href="function.pg-send-execute.php" class="function">pg_send_execute()</a></span>. You cannot cancel a query executed using 
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-connection-busy.php" class="function" rel="rdfs-seeAlso">pg_connection_busy()</a> - Get connection is busy or not</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-cancel-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-cancel-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-cancel-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-cancel-query.php">＋<small>add a note</small></a></span>
