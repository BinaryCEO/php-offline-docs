...
<head>
  ...
  <title>PHP: mcrypt_get_block_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-get-block-size.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-get-block-size">
 <link rel="alternate" href="https://www.php.net/mcrypt-get-block-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-generic-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-get-cipher-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-get-block-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-get-block-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-get-block-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-get-block-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-get-block-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-get-block-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-get-block-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-get-block-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-get-block-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-get-block-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-get-block-size.php" hreflang="zh">
...
<meta name="Description" content="Gets the block size of the specified cipher" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_get_block_size - Manual" />
<meta name="twitter:description" content="Gets the block size of the specified cipher" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_get_block_size - Manual" />
<meta itemprop="description" content="Gets the block size of the specified cipher" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the block size of the specified cipher" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mcrypt-get-cipher-name.php">
          mcrypt_get_cipher_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-generic-init.php">
          &laquo; mcrypt_generic_init        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-get-block-size.php' selected="selected">English</option>
            <option value='de/function.mcrypt-get-block-size.php'>German</option>
            <option value='es/function.mcrypt-get-block-size.php'>Spanish</option>
            <option value='fr/function.mcrypt-get-block-size.php'>French</option>
            <option value='it/function.mcrypt-get-block-size.php'>Italian</option>
            <option value='ja/function.mcrypt-get-block-size.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-get-block-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-get-block-size.php'>Russian</option>
            <option value='tr/function.mcrypt-get-block-size.php'>Turkish</option>
            <option value='uk/function.mcrypt-get-block-size.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-get-block-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-get-block-size" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_get_block_size</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_get_block_size</span> &mdash; <span class="dc-title">Gets the block size of the specified cipher</span></p>
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.mcrypt-get-block-size-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mcrypt_get_block_size</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$cipher</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>mcrypt_get_block_size</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$cipher</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mode</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para">
   ...
   size of a block of the specified <code class="parameter">cipher</code> (in
   combination with an encryption mode).
  </p>
  <p class="para">
   It is more useful to use the <span class="function"><a href="function.mcrypt-enc-get-block-size.php" class="function">mcrypt_enc_get_block_size()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mcrypt-get-block-size-returnvalues">
  ...
  <p class="para">
   Returns the algorithm block size in bytes  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">mcrypt_get_block_size</span><span style="color: #007700">(</span><span style="color: #DD0000">'tripledes'</span><span style="color: #007700">, </span><span style="color: #DD0000">'ecb'</span><span style="color: #007700">); </span><span style="color: #FF8000">// 8<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mcrypt-get-block-size-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mcrypt-get-key-size.php" class="function" rel="rdfs-seeAlso">mcrypt_get_key_size()</a> - Gets the key size of the specified cipher</span></li>
    <li><span class="function"><a href="function.mcrypt-enc-get-block-size.php" class="function" rel="rdfs-seeAlso">mcrypt_enc_get_block_size()</a> - Returns the blocksize of the opened algorithm</span></li>
    <li><span class="function"><a href="function.mcrypt-encrypt.php" class="function" rel="rdfs-seeAlso">mcrypt_encrypt()</a> - Encrypts plaintext with given parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-get-block-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-get-block-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-get-block-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-get-block-size.php">＋<small>add a note</small></a></span>
