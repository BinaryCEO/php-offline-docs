...
<head>
  ...
  <title>PHP: MongoDB\Driver\ClientEncryption::encryptExpression - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.encryptexpression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.encryptexpression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.encryptexpression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-clientencryption.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.getkey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-clientencryption.encryptexpression.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-clientencryption.encryptexpression.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-clientencryption.encryptexpression.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-clientencryption.encryptexpression.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-clientencryption.encryptexpression.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-clientencryption.encryptexpression.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-clientencryption.encryptexpression.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-clientencryption.encryptexpression.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-clientencryption.encryptexpression.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-clientencryption.encryptexpression.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-clientencryption.encryptexpression.php" hreflang="zh">
...
<meta name="Description" content="Encrypts a match or aggregate expression" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ClientEncryption::encryptExpression - Manual" />
<meta name="twitter:description" content="Encrypts a match or aggregate expression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ClientEncryption::encryptExpression - Manual" />
<meta itemprop="description" content="Encrypts a match or aggregate expression" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypts a match or aggregate expression" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-clientencryption.getkey.php">
          MongoDB\Driver\ClientEncryption::getKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-clientencryption.encrypt.php">
          &laquo; MongoDB\Driver\ClientEncryption::encrypt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-clientencryption.encryptexpression.php' selected="selected">English</option>
            <option value='de/mongodb-driver-clientencryption.encryptexpression.php'>German</option>
            <option value='es/mongodb-driver-clientencryption.encryptexpression.php'>Spanish</option>
            <option value='fr/mongodb-driver-clientencryption.encryptexpression.php'>French</option>
            <option value='it/mongodb-driver-clientencryption.encryptexpression.php'>Italian</option>
            <option value='ja/mongodb-driver-clientencryption.encryptexpression.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-clientencryption.encryptexpression.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-clientencryption.encryptexpression.php'>Russian</option>
            <option value='tr/mongodb-driver-clientencryption.encryptexpression.php'>Turkish</option>
            <option value='uk/mongodb-driver-clientencryption.encryptexpression.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-clientencryption.encryptexpression.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-clientencryption.encryptexpression" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-clientencryption.encrypt.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\ClientEncryption::encrypt()</a> - Encrypt a value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/clientencryption/encryptexpression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-clientencryption.encryptexpression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-clientencryption.encryptexpression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-clientencryption.encryptexpression.php">＋<small>add a note</small></a></span>
