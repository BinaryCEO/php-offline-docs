...
<head>
  ...
  <title>PHP: sodium_crypto_sign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-shorthash-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign.php" hreflang="zh">
...
<meta name="Description" content="Sign a message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_sign - Manual" />
<meta name="twitter:description" content="Sign a message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_sign - Manual" />
<meta itemprop="description" content="Sign a message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sign a message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-sign-detached.php">
          sodium_crypto_sign_detached &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-shorthash-keygen.php">
          &laquo; sodium_crypto_shorthash_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign.php'>German</option>
            <option value='es/function.sodium-crypto-sign.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign.php'>French</option>
            <option value='it/function.sodium-crypto-sign.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$secret_key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Sign a message with a secret key, that can be verified by the corresponding public key.
   This function attaches the signature to the message. See <span class="function"><a href="function.sodium-crypto-sign-detached.php" class="function">sodium_crypto_sign_detached()</a></span>
  ...
  <p class="para">
   Signed message (not encrypted).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123079">  <div class="votes">
    <div id="Vu123079">
    <a href="/manual/vote-note.php?id=123079&amp;page=function.sodium-crypto-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123079">
    <a href="/manual/vote-note.php?id=123079&amp;page=function.sodium-crypto-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123079" title="83% like this...">
    4
    </div>
  </div>
  <a href="#123079" class="name">
  <strong class="user"><em>craig at craigfrancis dot co dot uk</em></strong></a><a class="genanchor" href="#123079"> &para;</a><div class="date" title="2018-08-25 07:34"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom123079">
<div class="phpcode"><code><span class="html">Here's a quick example on how to use sodium_crypto_sign(); where you have a message that you want to sign, so anyone with the public key can confirm that the message hasn't been tampered with.<br /><br />This is similar to sodium_crypto_sign_detached(), but the returned string contains the original message as well (in plain text, at the end, so anyone can read it).<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// $sign_seed = random_bytes(SODIUM_CRYPTO_SIGN_SEEDBYTES);<br />// $sign_pair = sodium_crypto_sign_seed_keypair($sign_seed);<br /><br /></span><span class="default">$sign_pair </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_keypair</span><span class="keyword">();<br /></span><span class="default">$sign_secret </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_secretkey</span><span class="keyword">(</span><span class="default">$sign_pair</span><span class="keyword">);<br /></span><span class="default">$sign_public </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_publickey</span><span class="keyword">(</span><span class="default">$sign_pair</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 1, signing<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="string">'Hello'</span><span class="keyword">;<br /><br /></span><span class="default">$message_signed </span><span class="keyword">= </span><span class="default">sodium_crypto_sign</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$sign_secret</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 2, verifying<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="default">sodium_crypto_sign_open</span><span class="keyword">(</span><span class="default">$message_signed</span><span class="keyword">, </span><span class="default">$sign_public</span><span class="keyword">);<br /><br />echo </span><span class="default">$message </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign.php">＋<small>add a note</small></a></div>
