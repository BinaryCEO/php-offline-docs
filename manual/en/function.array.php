...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-all.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array.php" hreflang="zh">
...
<meta name="Description" content="Create an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array - Manual" />
<meta name="twitter:description" content="Create an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array - Manual" />
<meta itemprop="description" content="Create an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create an array" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.array-all.php">
          array_all &raquo;
              ...
              <div class="prev">
        <a href="ref.array.php">
          &laquo; Array Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array.php' selected="selected">English</option>
            <option value='de/function.array.php'>German</option>
            <option value='es/function.array.php'>Spanish</option>
            <option value='fr/function.array.php'>French</option>
            <option value='it/function.array.php'>Italian</option>
            <option value='ja/function.array.php'>Japanese</option>
            <option value='pt_BR/function.array.php'>Brazilian Portuguese</option>
            <option value='ru/function.array.php'>Russian</option>
            <option value='tr/function.array.php'>Turkish</option>
            <option value='uk/function.array.php'>Ukrainian</option>
            <option value='zh/function.array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.array-examples">
  ...
  <p class="para">
   ...
   arrays.
   <div class="example" id="example-5204">
    <p><strong>Example #1 <span class="function"><strong>array()</strong></span> example</strong></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fruits </span><span style="color: #007700">= array (<br />    </span><span style="color: #DD0000">"fruits"  </span><span style="color: #007700">=&gt; array(</span><span style="color: #DD0000">"a" </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"orange"</span><span style="color: #007700">, </span><span style="color: #DD0000">"b" </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"banana"</span><span style="color: #007700">, </span><span style="color: #DD0000">"c" </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"apple"</span><span style="color: #007700">),<br />    </span><span style="color: #DD0000">"numbers" </span><span style="color: #007700">=&gt; array(</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">4</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">, </span><span style="color: #0000BB">6</span><span style="color: #007700">),<br />    </span><span style="color: #DD0000">"holes"   </span><span style="color: #007700">=&gt; array(</span><span style="color: #DD0000">"first"</span><span style="color: #007700">, </span><span style="color: #0000BB">5 </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"second"</span><span style="color: #007700">, </span><span style="color: #DD0000">"third"</span><span style="color: #007700">)<br />);<br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">$fruits</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-5205">
    <p><strong>Example #2 Automatic index with <span class="function"><strong>array()</strong></span></strong></p>
    <div class="example-contents">
...
(
  ...
  <p class="para">
   ...
   <div class="example" id="example-5206">
    <p><strong>Example #3 1-based index with <span class="function"><strong>array()</strong></span></strong></p>
    <div class="example-contents">
...
(
  ...
  <p class="para">
   ...
   <div class="example" id="example-5207">
    <p><strong>Example #4 Accessing an array inside double quotes</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li>The <a href="language.types.array.php" class="link">array</a> type</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115181">  <div class="votes">
    <div id="Vu115181">
    <a href="/manual/vote-note.php?id=115181&amp;page=function.array&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115181">
    <a href="/manual/vote-note.php?id=115181&amp;page=function.array&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115181" title="63% like this...">
    115
    </div>
  </div>
  <a href="#115181" class="name">
  <strong class="user"><em>ole dot aanensen at gmail dot com</em></strong></a><a class="genanchor" href="#115181"> &para;</a><div class="date" title="2014-06-10 08:13"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115181">
<div class="phpcode"><code><span class="html">As of PHP 5.4.x you can now use 'short syntax arrays' which eliminates the need of this function.<br /><br />Example #1 'short syntax array'<br /><span class="default">&lt;?php<br />    $a </span><span class="keyword">= [</span><span class="default">1</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">];<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The above example will output:<br />Array<br />(<br />    [0] =&gt; 1<br />    [1] =&gt; 2<br />    [2] =&gt; 3<br />    [3] =&gt; 4<br />)<br /><br />Example #2 'short syntax associative array'<br /><span class="default">&lt;?php<br />    $a </span><span class="keyword">= [</span><span class="string">'one' </span><span class="keyword">=&gt; </span><span class="default">1</span><span class="keyword">, </span><span class="string">'two' </span><span class="keyword">=&gt; </span><span class="default">2</span><span class="keyword">, </span><span class="string">'three' </span><span class="keyword">=&gt; </span><span class="default">3</span><span class="keyword">, </span><span class="string">'four' </span><span class="keyword">=&gt; </span><span class="default">4</span><span class="keyword">];<br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The above example will output:<br />Array<br />(<br />    [one] =&gt; 1<br />    [two] =&gt; 2<br />    [three] =&gt; 3<br />    [four] =&gt; 4<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array.php">＋<small>add a note</small></a></div>
