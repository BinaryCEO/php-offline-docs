...
<head>
  ...
  <title>PHP: Imagick::medianFilterImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.medianfilterimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.medianfilterimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.medianfilterimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.mattefloodfillimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.mergeimagelayers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.medianfilterimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.medianfilterimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.medianfilterimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.medianfilterimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.medianfilterimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.medianfilterimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.medianfilterimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.medianfilterimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.medianfilterimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.medianfilterimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.medianfilterimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::medianFilterImage - Manual" />
<meta name="twitter:description" content="Applies a digital filter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::medianFilterImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.mergeimagelayers.php">
          Imagick::mergeImageLayers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.mattefloodfillimage.php">
          &laquo; Imagick::matteFloodfillImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.medianfilterimage.php' selected="selected">English</option>
            <option value='de/imagick.medianfilterimage.php'>German</option>
            <option value='es/imagick.medianfilterimage.php'>Spanish</option>
            <option value='fr/imagick.medianfilterimage.php'>French</option>
            <option value='it/imagick.medianfilterimage.php'>Italian</option>
            <option value='ja/imagick.medianfilterimage.php'>Japanese</option>
            <option value='pt_BR/imagick.medianfilterimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.medianfilterimage.php'>Russian</option>
            <option value='tr/imagick.medianfilterimage.php'>Turkish</option>
            <option value='uk/imagick.medianfilterimage.php'>Ukrainian</option>
            <option value='zh/imagick.medianfilterimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.medianfilterimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::medianFilterImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::medianFilterImage</span> &mdash; <span class="dc-title">Applies a digital filter</span></p>

 </div>

 <div id="imagick.medianfilterimage-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.medianfilterimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::medianFilterImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.medianfilterimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.medianfilterimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.medianfilterimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3027">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/medianfilterimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.medianfilterimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.medianfilterimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.medianfilterimage.php">＋<small>add a note</small></a></span>
