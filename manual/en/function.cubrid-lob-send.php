...
<head>
  ...
  <title>PHP: cubrid_lob_send - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob-send.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob-send">
 <link rel="alternate" href="https://www.php.net/cubrid-lob-send" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob-send.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob-send.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob-send.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob-send.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob-send.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob-send.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob-send.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob-send.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob-send.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob-send.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob-send.php" hreflang="zh">
...
<meta name="Description" content="Read BLOB/CLOB data and send straight to browser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob_send - Manual" />
<meta name="twitter:description" content="Read BLOB/CLOB data and send straight to browser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob_send - Manual" />
<meta itemprop="description" content="Read BLOB/CLOB data and send straight to browser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read BLOB/CLOB data and send straight to browser" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lob-size.php">
          cubrid_lob_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob-get.php">
          &laquo; cubrid_lob_get        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob-send.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob-send.php'>German</option>
            <option value='es/function.cubrid-lob-send.php'>Spanish</option>
            <option value='fr/function.cubrid-lob-send.php'>French</option>
            <option value='it/function.cubrid-lob-send.php'>Italian</option>
            <option value='ja/function.cubrid-lob-send.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob-send.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob-send.php'>Russian</option>
            <option value='tr/function.cubrid-lob-send.php'>Turkish</option>
            <option value='uk/function.cubrid-lob-send.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob-send.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob-send" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob_send</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.1)</p><p class="refpurpose"><span class="refname">cubrid_lob_send</span> &mdash; <span class="dc-title">Read BLOB/CLOB data and send straight to browser</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob-send-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob_send</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>cubrid_lob_send()</strong></span> reads BLOB/CLOB data and passes it straight through to the browser.  
   To use this function, you must use <span class="function"><a href="function.cubrid-lob-get.php" class="function">cubrid_lob_get()</a></span> first to get BLOB/CLOB info from CUBRID.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-lob-send-parameters">
  ...
  <dl>
    ...
    <dd><p class="para">LOB identifier.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob-send-examples">
  ...
  <div class="example" id="example-1249">
   <p><strong>Example #1 <span class="function"><strong>cubrid_lob_send()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect </span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"DROP TABLE if exists doc"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"CREATE TABLE doc (id INT, doc_content CLOB)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"INSERT INTO doc VALUES (5,'hello,cubrid')"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$lobs </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob_get</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT doc_content FROM doc WHERE id=5"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_lob_send</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$lobs</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br /></span><span style="color: #0000BB">cubrid_lob_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$lobs</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-lob-close.php" class="function" rel="rdfs-seeAlso">cubrid_lob_close()</a> - Close BLOB/CLOB data</span></li>  
    ...
    <li><span class="function"><a href="function.cubrid-lob-export.php" class="function" rel="rdfs-seeAlso">cubrid_lob_export()</a> - Export BLOB/CLOB data to file</span></li>     
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob-send.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob-send%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob-send&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob-send.php">＋<small>add a note</small></a></span>
