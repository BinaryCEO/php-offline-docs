...
<head>
  ...
  <title>PHP: Gmagick::write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.write.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.write.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.write.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.trimimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.writeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.write.php" hreflang="zh">
...
<meta name="Description" content="Alias of Gmagick::writeimage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::write - Manual" />
<meta name="twitter:description" content="Alias of Gmagick::writeimage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::write - Manual" />
<meta itemprop="description" content="Alias of Gmagick::writeimage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of Gmagick::writeimage" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.writeimage.php">
          Gmagick::writeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.trimimage.php">
          &laquo; Gmagick::trimimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.write.php' selected="selected">English</option>
            <option value='de/gmagick.write.php'>German</option>
            <option value='es/gmagick.write.php'>Spanish</option>
            <option value='fr/gmagick.write.php'>French</option>
            <option value='it/gmagick.write.php'>Italian</option>
            <option value='ja/gmagick.write.php'>Japanese</option>
            <option value='pt_BR/gmagick.write.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.write.php'>Russian</option>
            <option value='tr/gmagick.write.php'>Turkish</option>
            <option value='uk/gmagick.write.php'>Ukrainian</option>
            <option value='zh/gmagick.write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.write" class="refentry">
 
 <div class="refnamediv">
  <h1 class="refname">Gmagick::write</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::write</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="gmagick.writeimage.php" class="methodname">Gmagick::writeimage()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.write-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This method is an alias of:  <span class="methodname"><a href="gmagick.writeimage.php" class="methodname">Gmagick::writeimage()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.write.php">＋<small>add a note</small></a></span>
