...
<head>
  ...
  <title>PHP: SolrQuery::getGroupLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupmain.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgrouplimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgrouplimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgrouplimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgrouplimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgrouplimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgrouplimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgrouplimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgrouplimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgrouplimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgrouplimit.php" hreflang="zh">
...
<meta name="Description" content="Returns the group.limit value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupLimit - Manual" />
<meta name="twitter:description" content="Returns the group.limit value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupLimit - Manual" />
<meta itemprop="description" content="Returns the group.limit value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.limit value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgroupmain.php">
          SolrQuery::getGroupMain &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupfunctions.php">
          &laquo; SolrQuery::getGroupFunctions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgrouplimit.php' selected="selected">English</option>
            <option value='de/solrquery.getgrouplimit.php'>German</option>
            <option value='es/solrquery.getgrouplimit.php'>Spanish</option>
            <option value='fr/solrquery.getgrouplimit.php'>French</option>
            <option value='it/solrquery.getgrouplimit.php'>Italian</option>
            <option value='ja/solrquery.getgrouplimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgrouplimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgrouplimit.php'>Russian</option>
            <option value='tr/solrquery.getgrouplimit.php'>Turkish</option>
            <option value='uk/solrquery.getgrouplimit.php'>Ukrainian</option>
            <option value='zh/solrquery.getgrouplimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgrouplimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupLimit</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupLimit</span> &mdash; <span class="dc-title">Returns the group.limit value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgrouplimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupLimit</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgrouplimit-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgrouplimit-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgrouplimit-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgrouplimit.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupLimit()</a> - Specifies the number of results to return for each group. The server default value is 1</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgrouplimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgrouplimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgrouplimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgrouplimit.php">＋<small>add a note</small></a></span>
