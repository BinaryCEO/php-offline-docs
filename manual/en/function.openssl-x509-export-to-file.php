...
<head>
  ...
  <title>PHP: openssl_x509_export_to_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-x509-export-to-file.php">
 <link rel="shorturl" href="https://www.php.net/openssl-x509-export-to-file">
 <link rel="alternate" href="https://www.php.net/openssl-x509-export-to-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-x509-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-x509-fingerprint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-x509-export-to-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-x509-export-to-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-x509-export-to-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-x509-export-to-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-x509-export-to-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-x509-export-to-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-x509-export-to-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-x509-export-to-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-x509-export-to-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-x509-export-to-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-x509-export-to-file.php" hreflang="zh">
...
<meta name="Description" content="Exports a certificate to file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_x509_export_to_file - Manual" />
<meta name="twitter:description" content="Exports a certificate to file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_x509_export_to_file - Manual" />
<meta itemprop="description" content="Exports a certificate to file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a certificate to file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-x509-fingerprint.php">
          openssl_x509_fingerprint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-x509-export.php">
          &laquo; openssl_x509_export        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-x509-export-to-file.php' selected="selected">English</option>
            <option value='de/function.openssl-x509-export-to-file.php'>German</option>
            <option value='es/function.openssl-x509-export-to-file.php'>Spanish</option>
            <option value='fr/function.openssl-x509-export-to-file.php'>French</option>
            <option value='it/function.openssl-x509-export-to-file.php'>Italian</option>
            <option value='ja/function.openssl-x509-export-to-file.php'>Japanese</option>
            <option value='pt_BR/function.openssl-x509-export-to-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-x509-export-to-file.php'>Russian</option>
            <option value='tr/function.openssl-x509-export-to-file.php'>Turkish</option>
            <option value='uk/function.openssl-x509-export-to-file.php'>Ukrainian</option>
            <option value='zh/function.openssl-x509-export-to-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-x509-export-to-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_x509_export_to_file</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_x509_export_to_file</span> &mdash; <span class="dc-title">Exports a certificate to file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-x509-export-to-file-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_x509_export_to_file()</strong></span> stores
   <code class="parameter">certificate</code> into a file named by
   <code class="parameter">output_filename</code> in a <abbr title="Privacy-Enhanced Mail">PEM</abbr> encoded format.
  </p>
 </div>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-x509-export-to-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-x509-export-to-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-x509-export-to-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-export-to-file.php">＋<small>add a note</small></a></span>
