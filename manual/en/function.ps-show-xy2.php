...
<head>
  ...
  <title>PHP: ps_show_xy2 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-show-xy2.php">
 <link rel="shorturl" href="https://www.php.net/ps-show-xy2">
 <link rel="alternate" href="https://www.php.net/ps-show-xy2" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-show-xy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-show2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-show-xy2.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-show-xy2.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-show-xy2.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-show-xy2.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-show-xy2.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-show-xy2.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-show-xy2.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-show-xy2.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-show-xy2.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-show-xy2.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-show-xy2.php" hreflang="zh">
...
<meta name="Description" content="Output text at position" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_show_xy2 - Manual" />
<meta name="twitter:description" content="Output text at position" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_show_xy2 - Manual" />
<meta itemprop="description" content="Output text at position" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output text at position" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-show-xy2.php' selected="selected">English</option>
            <option value='de/function.ps-show-xy2.php'>German</option>
            <option value='es/function.ps-show-xy2.php'>Spanish</option>
            <option value='fr/function.ps-show-xy2.php'>French</option>
            <option value='it/function.ps-show-xy2.php'>Italian</option>
            <option value='ja/function.ps-show-xy2.php'>Japanese</option>
            <option value='pt_BR/function.ps-show-xy2.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-show-xy2.php'>Russian</option>
            <option value='tr/function.ps-show-xy2.php'>Turkish</option>
            <option value='uk/function.ps-show-xy2.php'>Ukrainian</option>
            <option value='zh/function.ps-show-xy2.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-show-xy2" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_show_xy2</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_show_xy2</span> &mdash; <span class="dc-title">Output text at position</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-show-xy2-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_show_xy2</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$len</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$xcoor</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ycoor</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-show-xy2-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-show-xy2.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-show-xy2%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-show-xy2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-show-xy2.php">＋<small>add a note</small></a></span>
