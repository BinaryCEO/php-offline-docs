...
<head>
  ...
  <title>PHP: Event flags - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/event.flags.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/event.flags.php">
 <link rel="alternate" href="https://www.php.net/manual/en/event.flags.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/event.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/event.persistence.php">

 <link rel="alternate" href="https://www.php.net/manual/en/event.flags.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/event.flags.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/event.flags.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/event.flags.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/event.flags.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/event.flags.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/event.flags.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/event.flags.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/event.flags.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/event.flags.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/event.flags.php" hreflang="zh">
...
<meta name="Description" content="Event flags" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Event flags - Manual" />
<meta name="twitter:description" content="Event flags" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Event flags - Manual" />
<meta itemprop="description" content="Event flags" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Event flags" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/event.flags.php' selected="selected">English</option>
            <option value='de/event.flags.php'>German</option>
            <option value='es/event.flags.php'>Spanish</option>
            <option value='fr/event.flags.php'>French</option>
            <option value='it/event.flags.php'>Italian</option>
            <option value='ja/event.flags.php'>Japanese</option>
            <option value='pt_BR/event.flags.php'>Brazilian Portuguese</option>
            <option value='ru/event.flags.php'>Russian</option>
            <option value='tr/event.flags.php'>Turkish</option>
            <option value='uk/event.flags.php'>Ukrainian</option>
            <option value='zh/event.flags.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="event.flags" class="chapter">
 ...
 Event flags</a>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/event.flags.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fevent.flags%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=event.flags&amp;repo=en&amp;redirect=https://www.php.net/manual/en/event.flags.php">＋<small>add a note</small></a></span>
