...
<head>
  ...
  <title>PHP: Phar::hasMetadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.hasmetadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.hasmetadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.hasmetadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.getversion.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.interceptfilefuncs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.hasmetadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.hasmetadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.hasmetadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.hasmetadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.hasmetadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.hasmetadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.hasmetadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.hasmetadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.hasmetadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.hasmetadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.hasmetadata.php" hreflang="zh">
...
<meta name="Description" content="Returns whether phar has global meta-data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::hasMetadata - Manual" />
<meta name="twitter:description" content="Returns whether phar has global meta-data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::hasMetadata - Manual" />
<meta itemprop="description" content="Returns whether phar has global meta-data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether phar has global meta-data" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.interceptfilefuncs.php">
          Phar::interceptFileFuncs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.getversion.php">
          &laquo; Phar::getVersion        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.hasmetadata.php' selected="selected">English</option>
            <option value='de/phar.hasmetadata.php'>German</option>
            <option value='es/phar.hasmetadata.php'>Spanish</option>
            <option value='fr/phar.hasmetadata.php'>French</option>
            <option value='it/phar.hasmetadata.php'>Italian</option>
            <option value='ja/phar.hasmetadata.php'>Japanese</option>
            <option value='pt_BR/phar.hasmetadata.php'>Brazilian Portuguese</option>
            <option value='ru/phar.hasmetadata.php'>Russian</option>
            <option value='tr/phar.hasmetadata.php'>Turkish</option>
            <option value='uk/phar.hasmetadata.php'>Ukrainian</option>
            <option value='zh/phar.hasmetadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.hasmetadata" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::hasMetadata</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">Phar::hasMetadata</span> &mdash; <span class="dc-title">Returns whether phar has global meta-data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.hasmetadata-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::hasMetadata</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.hasmetadata-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.hasmetadata-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if meta-data has been set, and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-phar.hasmetadata-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-821">
    <p><strong>Example #1 A <span class="function"><strong>Phar::hasMetadata()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$phar </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'myphar.phar'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">hasMetadata</span><span style="color: #007700">());<br />    </span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setMetadata</span><span style="color: #007700">(array(</span><span style="color: #DD0000">'thing' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'hi'</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">hasMetadata</span><span style="color: #007700">());<br />    </span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">delMetadata</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">hasMetadata</span><span style="color: #007700">());<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle error<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.hasmetadata-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.delmetadata.php" class="function" rel="rdfs-seeAlso">Phar::delMetadata()</a> - Deletes the global metadata of the phar</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/hasMetadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.hasmetadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.hasmetadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.hasmetadata.php">＋<small>add a note</small></a></span>
