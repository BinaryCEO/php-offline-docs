...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.roll.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.roll.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.roll.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.isweekend.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.set.php">
...
<meta name="Description" content="Add value to field without carrying into more significant fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::roll - Manual" />
<meta name="twitter:description" content="Add value to field without carrying into more significant fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::roll - Manual" />
<meta itemprop="description" content="Add value to field without carrying into more significant fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add value to field without carrying into more significant fields" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.roll.php' selected="selected">English</option>
            <option value='de/intlcalendar.roll.php'>German</option>
            <option value='es/intlcalendar.roll.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::roll</span> &mdash; <span class="dc-title">Add value to field without carrying into more significant fields</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.roll-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="intlcalendar.add.php" class="function">IntlCalendar::add()</a></span> is that when the field value
...
<p class="para">
 ...
 <strong><code>IntlCalendar::FIELD_COUNT</code></strong>.
    ...
    <dd>
     <p class="para">
      The (signed) amount to add to the field, <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for rolling up (adding
      <code class="literal">1</code>), or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for rolling down (subtracting
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="intlcalendar.set.php" class="methodname" rel="rdfs-seeAlso">IntlCalendar::set()</a> - Set a time field or several common fields at once</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/roll.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.roll%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.roll&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.roll.php">＋<small>add a note</small></a></span>
