...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightSimplePost - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightrequirefieldmatch.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightsimplepost.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightsimplepost.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightsimplepost.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightsimplepost.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightsimplepost.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightsimplepost.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightsimplepost.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightsimplepost.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightsimplepost.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightsimplepost.php" hreflang="zh">
...
<meta name="Description" content="Sets the text which appears after a highlighted term" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightSimplePost - Manual" />
<meta name="twitter:description" content="Sets the text which appears after a highlighted term" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightSimplePost - Manual" />
<meta itemprop="description" content="Sets the text which appears after a highlighted term" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text which appears after a highlighted term" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightsimplepre.php">
          SolrQuery::setHighlightSimplePre &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightrequirefieldmatch.php">
          &laquo; SolrQuery::setHighlightRequireFieldMatch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightsimplepost.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightsimplepost.php'>German</option>
            <option value='es/solrquery.sethighlightsimplepost.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightsimplepost.php'>French</option>
            <option value='it/solrquery.sethighlightsimplepost.php'>Italian</option>
            <option value='ja/solrquery.sethighlightsimplepost.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightsimplepost.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightsimplepost.php'>Russian</option>
            <option value='tr/solrquery.sethighlightsimplepost.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightsimplepost.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightsimplepost.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightsimplepost" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightSimplePost</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightSimplePost</span> &mdash; <span class="dc-title">Sets the text which appears after a highlighted term</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightsimplepost-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightSimplePost</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$simplePost</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightsimplepost-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">simplePost</code></dt>
     <dd>
      <p class="para">
       Sets the text which appears after a highlighted term
      </p>
      <p class="para"><div class="parameterscode"><pre class="parameterscode">The default is &lt;/em&gt;</pre>
</div></p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightsimplepost-returnvalues">
  ...
  <p class="para">
   Returns an instance of <span class="classname"><a href="class.solrquery.php" class="classname">SolrQuery</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightsimplepost.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightsimplepost%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightsimplepost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightsimplepost.php">＋<small>add a note</small></a></span>
