...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.sparsecolorimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.sparsecolorimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sparsecolorimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.solarizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.spliceimage.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.sparsecolorimage.php' selected="selected">English</option>
            <option value='de/imagick.sparsecolorimage.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.sparsecolorimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3119">
      <p><strong>Example #1 SPARSECOLORMETHOD_BARYCENTRIC <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
    ...
    <div class="example" id="example-3120">
      <p><strong>Example #2 SPARSECOLORMETHOD_BILINEAR <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
      <div class="example-contents">
    ...
    <div class="example" id="example-3121">
      <p><strong>Example #3 SPARSECOLORMETHOD_SPEPARDS <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
      <div class="example-contents">
    ...
    <div class="example" id="example-3122">
      <p><strong>Example #4 SPARSECOLORMETHOD_VORONOI <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
      <div class="example-contents">
    ...
    <div class="example" id="example-3123">
      <p><strong>Example #5 SPARSECOLORMETHOD_BARYCENTRIC <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
      <div class="example-contents">
    ...
    <div class="example" id="example-3124">
      <p><strong>Example #6 createGradientImage is used by other examples. <span class="function"><strong>Imagick::sparseColorImage()</strong></span></strong></p>
      <div class="example-contents">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/sparsecolorimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.sparsecolorimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.sparsecolorimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.sparsecolorimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">For those curious how to use sparseColorImage() directly without the seperate createGradientImage() function.. here is the format of the array used:<br /><br />Array ( <br />[0]  =&gt; 0   // X1 (X coordinate value #1)<br />[1]  =&gt; 0   // Y1 (Y coordinate value #1)<br />[2]  =&gt; 1   // R (red value between 0 and 1)<br />[3]  =&gt; 0   // G (green value between 0 and 1)<br />[4]  =&gt; 0   // B (blue value between 0 and 1)<br />[5]  =&gt; 1   // A (alpha value between 0 and 1)<br />[6]  =&gt; 400 // X2 <br />[7]  =&gt; 0   // Y2 <br />[8]  =&gt; 0   // R <br />[9]  =&gt; 1   // G <br />[10] =&gt; 0   // B <br />[11] =&gt; 1   // A<br />[12] =&gt; 0   // X3 <br />[13] =&gt; 400 // Y3 <br />[14] =&gt; 1   // R <br />[15] =&gt; 1   // G <br />[16] =&gt; 0   // B <br />[17] =&gt; 1   // A <br />[18] =&gt; 400 // X4<br />[19] =&gt; 400 // Y4<br />[20] =&gt; 0   // R <br />[21] =&gt; 0   // G <br />[22] =&gt; 1   // B <br />[23] =&gt; 1   // A <br />)<br /><br /><span class="default">&lt;?php<br /><br />$imagick </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">();<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">400</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">,</span><span class="string">"white"</span><span class="keyword">);<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br /><br /></span><span class="default">$array </span><span class="keyword">= Array(</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">sparseColorImage</span><span class="keyword">(</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">SPARSECOLORMETHOD_BILINEAR</span><span class="keyword">,</span><span class="default">$array</span><span class="keyword">);<br />    <br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />echo </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImageBlob</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.sparsecolorimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.sparsecolorimage.php">＋<small>add a note</small></a></div>
