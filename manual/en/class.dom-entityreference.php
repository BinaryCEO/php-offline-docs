...
<head>
  ...
  <title>PHP: Dom\EntityReference - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-entityreference.php">
 <link rel="shorturl" href="https://www.php.net/dom-entityreference">
 <link rel="alternate" href="https://www.php.net/dom-entityreference" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-entity.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-htmlcollection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-entityreference.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-entityreference.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-entityreference.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-entityreference.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-entityreference.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-entityreference.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-entityreference.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-entityreference.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-entityreference.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-entityreference.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-entityreference.php" hreflang="zh">
...
<meta name="Description" content="The Dom\EntityReference class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\EntityReference - Manual" />
<meta name="twitter:description" content="The Dom\EntityReference class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\EntityReference - Manual" />
<meta itemprop="description" content="The Dom\EntityReference class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\EntityReference class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-entityreference.php' selected="selected">English</option>
            <option value='de/class.dom-entityreference.php'>German</option>
            <option value='es/class.dom-entityreference.php'>Spanish</option>
            <option value='fr/class.dom-entityreference.php'>French</option>
            <option value='it/class.dom-entityreference.php'>Italian</option>
            <option value='ja/class.dom-entityreference.php'>Japanese</option>
            <option value='pt_BR/class.dom-entityreference.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-entityreference.php'>Russian</option>
            <option value='tr/class.dom-entityreference.php'>Turkish</option>
            <option value='uk/class.dom-entityreference.php'>Ukrainian</option>
            <option value='zh/class.dom-entityreference.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-entityreference" class="reference">
 <h1 class="title">The Dom\EntityReference class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-entityreference.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    This is the modern, spec-compliant equivalent of
    <span class="classname"><a href="class.domentityreference.php" class="classname">DOMEntityReference</a></span>.
   </p>
  </div>

  <div class="section" id="dom-entityreference.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\EntityReference</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-entityreference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-entityreference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-entityreference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-entityreference.php">＋<small>add a note</small></a></span>
