...
<head>
  ...
  <title>PHP: oci_statement_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-statement-type.php">
 <link rel="shorturl" href="https://www.php.net/oci-statement-type">
 <link rel="alternate" href="https://www.php.net/oci-statement-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-set-prefetch-lob.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-unregister-taf-callback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-statement-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-statement-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-statement-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-statement-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-statement-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-statement-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-statement-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-statement-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-statement-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-statement-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-statement-type.php" hreflang="zh">
...
<meta name="Description" content="Returns the type of a statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_statement_type - Manual" />
<meta name="twitter:description" content="Returns the type of a statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_statement_type - Manual" />
<meta itemprop="description" content="Returns the type of a statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the type of a statement" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-unregister-taf-callback.php">
          oci_unregister_taf_callback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-set-prefetch-lob.php">
          &laquo; oci_set_prefetch_lob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-statement-type.php' selected="selected">English</option>
            <option value='de/function.oci-statement-type.php'>German</option>
            <option value='es/function.oci-statement-type.php'>Spanish</option>
            <option value='fr/function.oci-statement-type.php'>French</option>
            <option value='it/function.oci-statement-type.php'>Italian</option>
            <option value='ja/function.oci-statement-type.php'>Japanese</option>
            <option value='pt_BR/function.oci-statement-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-statement-type.php'>Russian</option>
            <option value='tr/function.oci-statement-type.php'>Turkish</option>
            <option value='uk/function.oci-statement-type.php'>Ukrainian</option>
            <option value='zh/function.oci-statement-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-statement-type" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_statement_type</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_statement_type</span> &mdash; <span class="dc-title">Returns the type of a statement</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.oci-statement-type-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_statement_type</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Returns a keyword identifying the type of the
   OCI8 <code class="parameter">statement</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.oci-statement-type-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A valid OCI8 statement identifier from <span class="function"><a href="function.oci-parse.php" class="function">oci_parse()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-statement-type-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the type of <code class="parameter">statement</code> as one of the
   following strings.
   <table class="doctable table">
    <caption><strong>Statement type</strong></caption>
     ...
     <tbody class="tbody">
      ...
      <tr>
       <td><code class="literal">BEGIN</code></td>
       <td class="empty">&nbsp;</td>
      </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.oci-statement-type-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2035">
    <p><strong>Example #1 <span class="function"><strong>oci_statement_type()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'hr'</span><span style="color: #007700">, </span><span style="color: #DD0000">'welcome'</span><span style="color: #007700">, </span><span style="color: #DD0000">'localhost/XE'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$stid </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'DELETE FROM departments WHERE department_id = 130;'</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">oci_statement_type</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">) == </span><span style="color: #DD0000">"DELETE"</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">trigger_error</span><span style="color: #007700">(</span><span style="color: #DD0000">'You are not allowed to delete from this table'</span><span style="color: #007700">, </span><span style="color: #0000BB">E_USER_ERROR</span><span style="color: #007700">);<br />}<br />else {<br />    </span><span style="color: #0000BB">oci_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);  </span><span style="color: #FF8000">// delete the row<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #0000BB">oci_free_statement</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-statement-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-statement-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-statement-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-statement-type.php">＋<small>add a note</small></a></span>
