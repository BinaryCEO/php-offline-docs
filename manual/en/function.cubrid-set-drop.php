...
<head>
  ...
  <title>PHP: cubrid_set_drop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-set-drop.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-set-drop">
 <link rel="alternate" href="https://www.php.net/cubrid-set-drop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-set-db-parameter.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-set-query-timeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-set-drop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-set-drop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-set-drop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-set-drop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-set-drop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-set-drop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-set-drop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-set-drop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-set-drop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-set-drop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-set-drop.php" hreflang="zh">
...
<meta name="Description" content="Delete an element from set type column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_set_drop - Manual" />
<meta name="twitter:description" content="Delete an element from set type column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_set_drop - Manual" />
<meta itemprop="description" content="Delete an element from set type column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an element from set type column using OID" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-set-query-timeout.php">
          cubrid_set_query_timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-set-db-parameter.php">
          &laquo; cubrid_set_db_parameter        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-set-drop.php' selected="selected">English</option>
            <option value='de/function.cubrid-set-drop.php'>German</option>
            <option value='es/function.cubrid-set-drop.php'>Spanish</option>
            <option value='fr/function.cubrid-set-drop.php'>French</option>
            <option value='it/function.cubrid-set-drop.php'>Italian</option>
            <option value='ja/function.cubrid-set-drop.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-set-drop.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-set-drop.php'>Russian</option>
            <option value='tr/function.cubrid-set-drop.php'>Turkish</option>
            <option value='uk/function.cubrid-set-drop.php'>Ukrainian</option>
            <option value='zh/function.cubrid-set-drop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-set-drop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_set_drop</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_set_drop</span> &mdash; <span class="dc-title">Delete an element from set type column using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-set-drop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_set_drop</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$attr_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$set_element</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_set_drop()</strong></span> function is used to delete an
...
<div class="refsect1 parameters" id="refsect1-function.cubrid-set-drop-parameters">
  ...
  <dd><p class="para">Name of the attribute you want to delete an element from.</p></dd>
   
  
  <dt><code class="parameter">set_element</code></dt>
  <dd><p class="para">Content of the element you want to delete.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-set-drop-returnvalues">
...
array(2) {
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-set-drop-seealso">
   ...
   <ul class="simplelist"> 
    <li><span class="function"><a href="function.cubrid-set-add.php" class="function" rel="rdfs-seeAlso">cubrid_set_add()</a> - Insert a single element to set type column using OID</span></li>  
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-set-drop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-set-drop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-set-drop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-set-drop.php">＋<small>add a note</small></a></span>
