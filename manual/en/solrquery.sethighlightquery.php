...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightquery.php" hreflang="zh">
...
<meta name="Description" content="A query designated for highlighting (hl.q)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightQuery - Manual" />
<meta name="twitter:description" content="A query designated for highlighting (hl.q)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightQuery - Manual" />
<meta itemprop="description" content="A query designated for highlighting (hl.q)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="A query designated for highlighting (hl.q)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightregexmaxanalyzedchars.php">
          SolrQuery::setHighlightRegexMaxAnalyzedChars &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightmergecontiguous.php">
          &laquo; SolrQuery::setHighlightMergeContiguous        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightquery.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightquery.php'>German</option>
            <option value='es/solrquery.sethighlightquery.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightquery.php'>French</option>
            <option value='it/solrquery.sethighlightquery.php'>Italian</option>
            <option value='ja/solrquery.sethighlightquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightquery.php'>Russian</option>
            <option value='tr/solrquery.sethighlightquery.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightquery.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 2.7.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightQuery</span> &mdash; <span class="dc-title">A query designated for highlighting (hl.q)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$q</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
  ...
  <p class="para">Default value when not set: the value of the request&#039;s q parameter</p>
  <p class="para">Solr Parameter reference: hl.q</p>
 </div>


 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightquery-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightquery-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the current <span class="classname"><a href="class.solrquery.php" class="classname">SolrQuery</a></span> object, if the return value is used.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightquery.php">＋<small>add a note</small></a></span>
