...
<head>
  ...
  <title>PHP: IntlChar::charFromName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.charfromname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.charfromname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charfromname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.chardirection.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.charmirror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charfromname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.charfromname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.charfromname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.charfromname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.charfromname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.charfromname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.charfromname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.charfromname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.charfromname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.charfromname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.charfromname.php" hreflang="zh">
...
<meta name="Description" content="Find Unicode character by name and return its code point value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::charFromName - Manual" />
<meta name="twitter:description" content="Find Unicode character by name and return its code point value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::charFromName - Manual" />
<meta itemprop="description" content="Find Unicode character by name and return its code point value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find Unicode character by name and return its code point value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.charmirror.php">
          IntlChar::charMirror &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.chardirection.php">
          &laquo; IntlChar::charDirection        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.charfromname.php' selected="selected">English</option>
            <option value='de/intlchar.charfromname.php'>German</option>
            <option value='es/intlchar.charfromname.php'>Spanish</option>
            <option value='fr/intlchar.charfromname.php'>French</option>
            <option value='it/intlchar.charfromname.php'>Italian</option>
            <option value='ja/intlchar.charfromname.php'>Japanese</option>
            <option value='pt_BR/intlchar.charfromname.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.charfromname.php'>Russian</option>
            <option value='tr/intlchar.charfromname.php'>Turkish</option>
            <option value='uk/intlchar.charfromname.php'>Ukrainian</option>
            <option value='zh/intlchar.charfromname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.charfromname" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-intlchar.charfromname-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::charFromName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code><span class="initializer"> = IntlChar::UNICODE_CHAR_NAME</span></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span></div>

  <p class="para rdfs-comment">
   Finds a Unicode character by its name and returns its code point value.
  </p>
  <p class="para">
   The name is matched exactly and completely. If the name does not correspond to a code point, <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> is returned.
  </p>
  <p class="para">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      ...
      <ul class="simplelist">
       <li><strong><code><a href="class.intlchar.php#intlchar.constants.unicode-char-name">IntlChar::UNICODE_CHAR_NAME</a></code></strong> (default)</li>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.charfromname-returnvalues">
  ...
  <p class="para">
   The Unicode value of the code point with the given name (as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>), or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there is no such code point.
  </p>
 </div>
...
NULL</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.charfromname-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="intlchar.charname.php" class="function" rel="rdfs-seeAlso">IntlChar::charName()</a> - Retrieve the name of a Unicode character</span></li>
    <li><span class="function"><a href="intlchar.enumcharnames.php" class="function" rel="rdfs-seeAlso">IntlChar::enumCharNames()</a> - Enumerate all assigned Unicode characters within a range</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/charfromname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.charfromname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.charfromname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.charfromname.php">＋<small>add a note</small></a></span>
