...
<head>
  ...
  <title>PHP: posix_uname - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-uname.php">
 <link rel="shorturl" href="https://www.php.net/posix-uname">
 <link rel="alternate" href="https://www.php.net/posix-uname" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-ttyname.php">
 <link rel="next" href="https://www.php.net/manual/en/book.exec.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-uname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-uname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-uname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-uname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-uname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-uname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-uname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-uname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-uname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-uname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-uname.php" hreflang="zh">
...
<meta name="Description" content="Get system name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_uname - Manual" />
<meta name="twitter:description" content="Get system name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_uname - Manual" />
<meta itemprop="description" content="Get system name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get system name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.exec.php">
          Program execution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-ttyname.php">
          &laquo; posix_ttyname        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-uname.php' selected="selected">English</option>
            <option value='de/function.posix-uname.php'>German</option>
            <option value='es/function.posix-uname.php'>Spanish</option>
            <option value='fr/function.posix-uname.php'>French</option>
            <option value='it/function.posix-uname.php'>Italian</option>
            <option value='ja/function.posix-uname.php'>Japanese</option>
            <option value='pt_BR/function.posix-uname.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-uname.php'>Russian</option>
            <option value='tr/function.posix-uname.php'>Turkish</option>
            <option value='uk/function.posix-uname.php'>Ukrainian</option>
            <option value='zh/function.posix-uname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-uname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_uname</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_uname</span> &mdash; <span class="dc-title">Get system name</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.posix-uname-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>posix_uname</strong></span>(): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.posix-uname-parameters">
...
(
    ...
    [machine] =&gt; i686
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-uname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-uname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-uname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-uname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="61257">  <div class="votes">
    <div id="Vu61257">
    <a href="/manual/vote-note.php?id=61257&amp;page=function.posix-uname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61257">
    <a href="/manual/vote-note.php?id=61257&amp;page=function.posix-uname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61257" title="38% like this...">
    -4
    </div>
  </div>
  <a href="#61257" class="name">
  <strong class="user"><em>boards at gmail dot com</em></strong></a><a class="genanchor" href="#61257"> &para;</a><div class="date" title="2006-01-29 09:24"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61257">
<div class="phpcode"><code><span class="html">Or, a simpler way to do that:<br /><br /><span class="default">&lt;?php<br />print_r</span><span class="keyword">(</span><span class="default">posix_uname</span><span class="keyword">());<br /></span><span class="default">?&gt;<br /></span><br />Should print something like:<br /><br />Array<br />(<br />    [sysname] =&gt; Linux<br />    [nodename] =&gt; vaio<br />    [release] =&gt; 2.6.15-1-686<br />    [version] =&gt; #2 Tue Jan 10 22:48:31 UTC 2006<br />    [machine] =&gt; i686<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-uname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-uname.php">＋<small>add a note</small></a></div>
