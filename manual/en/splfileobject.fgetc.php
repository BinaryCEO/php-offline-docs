...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.fgetc.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.fgetc.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fgetc.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.fflush.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.fgetcsv.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.fgetc.php' selected="selected">English</option>
            ...
            <option value='tr/splfileobject.fgetc.php'>Turkish</option>
 ...
 <div class="refsect1 examples" id="refsect1-splfileobject.fgetc-examples">
  ...
  <p class="para">
   <div class="example" id="example-3995">
    <p><strong>Example #1 <span class="methodname"><strong>SplFileObject::fgetc()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="splfileobject.fgets.php" class="methodname" rel="rdfs-seeAlso">SplFileObject::fgets()</a> - Gets line from file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/fgetc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.fgetc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.fgetc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.fgetc.php">＋<small>add a note</small></a></span>
