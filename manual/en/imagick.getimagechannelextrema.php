...
<head>
  ...
  <title>PHP: Imagick::getImageChannelExtrema - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechannelextrema.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechannelextrema.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelextrema.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechanneldistortions.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelextrema.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechannelextrema.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechannelextrema.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechannelextrema.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechannelextrema.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechannelextrema.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechannelextrema.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechannelextrema.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechannelextrema.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechannelextrema.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechannelextrema.php" hreflang="zh">
...
<meta name="Description" content="Gets the extrema for one or more image channels" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelExtrema - Manual" />
<meta name="twitter:description" content="Gets the extrema for one or more image channels" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelExtrema - Manual" />
<meta itemprop="description" content="Gets the extrema for one or more image channels" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the extrema for one or more image channels" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagechannelkurtosis.php">
          Imagick::getImageChannelKurtosis &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechanneldistortions.php">
          &laquo; Imagick::getImageChannelDistortions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechannelextrema.php' selected="selected">English</option>
            <option value='de/imagick.getimagechannelextrema.php'>German</option>
            <option value='es/imagick.getimagechannelextrema.php'>Spanish</option>
            <option value='fr/imagick.getimagechannelextrema.php'>French</option>
            <option value='it/imagick.getimagechannelextrema.php'>Italian</option>
            <option value='ja/imagick.getimagechannelextrema.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechannelextrema.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechannelextrema.php'>Russian</option>
            <option value='tr/imagick.getimagechannelextrema.php'>Turkish</option>
            <option value='uk/imagick.getimagechannelextrema.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechannelextrema.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechannelextrema" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageChannelExtrema</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageChannelExtrema</span> &mdash; <span class="dc-title">Gets the extrema for one or more image channels</span></p>

 </div>

 <div id="imagick.getimagechannelextrema-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagechannelextrema-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageChannelExtrema</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagechannelextrema-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagechannelextrema-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagechannelextrema-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechannelextrema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechannelextrema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechannelextrema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelextrema.php">＋<small>add a note</small></a></span>
