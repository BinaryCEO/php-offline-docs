...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageopacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageopacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageopacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagemattecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageorientation.php">
...
<meta name="Description" content="Sets the image opacity level" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageOpacity - Manual" />
<meta name="twitter:description" content="Sets the image opacity level" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageOpacity - Manual" />
<meta itemprop="description" content="Sets the image opacity level" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image opacity level" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageopacity.php' selected="selected">English</option>
            <option value='de/imagick.setimageopacity.php'>German</option>
            <option value='es/imagick.setimageopacity.php'>Spanish</option>
            <option value='fr/imagick.setimageopacity.php'>French</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create the object */<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'source.png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set the opacity */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageOpacity</span><span style="color: #007700">(</span><span style="color: #0000BB">0.7</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* output the image */<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageopacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageopacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageopacity.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>hola at rafaeltovar dot info</em></strong></a><a class="genanchor" href="#124296"> &para;</a><div class="date" title="2019-10-15 03:18"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124296">
<div class="phpcode"><code><span class="html">This function is deprecated from last stable version (3.4.4 - 2019-05-02) of PECL Imagick extension. <br /><br />More info: <a href="http://pecl.php.net/package-changelog.php?package=imagick&amp;release=3.4.4" rel="nofollow" target="_blank">http://pecl.php.net/package-changelog.php?package=imagick&amp;release=3.4.4</a><br /><br />"setImageAlpha" is the new alternative function, but doesn't work with ImageMagick &lt; 7.<br /><br />More info: <a href="https://github.com/avalanche123/Imagine/issues/715" rel="nofollow" target="_blank">https://github.com/avalanche123/Imagine/issues/715</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageopacity.php">＋<small>add a note</small></a></div>
