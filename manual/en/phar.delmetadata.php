...
<head>
  ...
  <title>PHP: Phar::delMetadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.delmetadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.delmetadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.delmetadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.decompressfiles.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.delmetadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.delmetadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.delmetadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.delmetadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.delmetadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.delmetadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.delmetadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.delmetadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.delmetadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.delmetadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.delmetadata.php" hreflang="zh">
...
<meta name="Description" content="Deletes the global metadata of the phar" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::delMetadata - Manual" />
<meta name="twitter:description" content="Deletes the global metadata of the phar" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::delMetadata - Manual" />
<meta itemprop="description" content="Deletes the global metadata of the phar" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes the global metadata of the phar" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.delete.php">
          Phar::delete &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.decompressfiles.php">
          &laquo; Phar::decompressFiles        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.delmetadata.php' selected="selected">English</option>
            <option value='de/phar.delmetadata.php'>German</option>
            <option value='es/phar.delmetadata.php'>Spanish</option>
            <option value='fr/phar.delmetadata.php'>French</option>
            <option value='it/phar.delmetadata.php'>Italian</option>
            <option value='ja/phar.delmetadata.php'>Japanese</option>
            <option value='pt_BR/phar.delmetadata.php'>Brazilian Portuguese</option>
            <option value='ru/phar.delmetadata.php'>Russian</option>
            <option value='tr/phar.delmetadata.php'>Turkish</option>
            <option value='uk/phar.delmetadata.php'>Ukrainian</option>
            <option value='zh/phar.delmetadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.delmetadata" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::delMetadata</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">Phar::delMetadata</span> &mdash; <span class="dc-title">Deletes the global metadata of the phar</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.delmetadata-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::delMetadata</strong></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.delmetadata-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.delmetadata-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-phar.delmetadata-errors">
 ...
 <div class="refsect1 examples" id="refsect1-phar.delmetadata-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-816">
    <p><strong>Example #1 A <span class="function"><strong>Phar::delMetaData()</strong></span> example</strong></p>
...
NULL</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.delmetadata-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.hasmetadata.php" class="function" rel="rdfs-seeAlso">Phar::hasMetadata()</a> - Returns whether phar has global meta-data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/delMetadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.delmetadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.delmetadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.delmetadata.php">＋<small>add a note</small></a></span>
