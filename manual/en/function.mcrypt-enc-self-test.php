...
<head>
  ...
  <title>PHP: mcrypt_enc_self_test - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-enc-self-test.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-enc-self-test">
 <link rel="alternate" href="https://www.php.net/mcrypt-enc-self-test" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-enc-is-block-mode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-enc-self-test.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-enc-self-test.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-enc-self-test.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-enc-self-test.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-enc-self-test.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-enc-self-test.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-enc-self-test.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-enc-self-test.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-enc-self-test.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-enc-self-test.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-enc-self-test.php" hreflang="zh">
...
<meta name="Description" content="Runs a self test on the opened module" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_enc_self_test - Manual" />
<meta name="twitter:description" content="Runs a self test on the opened module" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_enc_self_test - Manual" />
<meta itemprop="description" content="Runs a self test on the opened module" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Runs a self test on the opened module" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mcrypt-encrypt.php">
          mcrypt_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-enc-is-block-mode.php">
          &laquo; mcrypt_enc_is_block_mode        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-enc-self-test.php' selected="selected">English</option>
            <option value='de/function.mcrypt-enc-self-test.php'>German</option>
            <option value='es/function.mcrypt-enc-self-test.php'>Spanish</option>
            <option value='fr/function.mcrypt-enc-self-test.php'>French</option>
            <option value='it/function.mcrypt-enc-self-test.php'>Italian</option>
            <option value='ja/function.mcrypt-enc-self-test.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-enc-self-test.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-enc-self-test.php'>Russian</option>
            <option value='tr/function.mcrypt-enc-self-test.php'>Turkish</option>
            <option value='uk/function.mcrypt-enc-self-test.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-enc-self-test.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-enc-self-test" class="refentry">
  ...
  <p class="para">
   Returns <code class="literal">0</code> on success and a negative <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-enc-self-test.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-enc-self-test%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-enc-self-test&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-enc-self-test.php">＋<small>add a note</small></a></span>
