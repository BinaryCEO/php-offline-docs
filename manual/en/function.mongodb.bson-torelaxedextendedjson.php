...
<head>
  ...
  <title>PHP: MongoDB\BSON\toRelaxedExtendedJSON - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mongodb.bson-torelaxedextendedjson.php">
 <link rel="shorturl" href="https://www.php.net/mongodb.bson-torelaxedextendedjson">
 <link rel="alternate" href="https://www.php.net/mongodb.bson-torelaxedextendedjson" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.bson.functions.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mongodb.bson-tophp.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-bson-document.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mongodb.bson-torelaxedextendedjson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mongodb.bson-torelaxedextendedjson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mongodb.bson-torelaxedextendedjson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mongodb.bson-torelaxedextendedjson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mongodb.bson-torelaxedextendedjson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mongodb.bson-torelaxedextendedjson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mongodb.bson-torelaxedextendedjson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mongodb.bson-torelaxedextendedjson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mongodb.bson-torelaxedextendedjson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mongodb.bson-torelaxedextendedjson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mongodb.bson-torelaxedextendedjson.php" hreflang="zh">
...
<meta name="Description" content="Returns the Relaxed Extended JSON representation of a BSON value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\toRelaxedExtendedJSON - Manual" />
<meta name="twitter:description" content="Returns the Relaxed Extended JSON representation of a BSON value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\toRelaxedExtendedJSON - Manual" />
<meta itemprop="description" content="Returns the Relaxed Extended JSON representation of a BSON value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Relaxed Extended JSON representation of a BSON value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.mongodb-bson-document.php">
          MongoDB\BSON\Document &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mongodb.bson-tophp.php">
          &laquo; MongoDB\BSON\toPHP        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.vendors.php'>Vendor Specific Database Extensions</a></li>      <li><a href='book.mongodb.php'>MongoDB</a></li>      <li><a href='mongodb.bson.php'>MongoDB\BSON</a></li>      <li><a href='ref.bson.functions.php'>Functions</a></li>      </ul>
    </div>
  </div>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mongodb.bson-torelaxedextendedjson.php' selected="selected">English</option>
            <option value='de/function.mongodb.bson-torelaxedextendedjson.php'>German</option>
            <option value='es/function.mongodb.bson-torelaxedextendedjson.php'>Spanish</option>
            <option value='fr/function.mongodb.bson-torelaxedextendedjson.php'>French</option>
            <option value='it/function.mongodb.bson-torelaxedextendedjson.php'>Italian</option>
            <option value='ja/function.mongodb.bson-torelaxedextendedjson.php'>Japanese</option>
            <option value='pt_BR/function.mongodb.bson-torelaxedextendedjson.php'>Brazilian Portuguese</option>
            <option value='ru/function.mongodb.bson-torelaxedextendedjson.php'>Russian</option>
            <option value='tr/function.mongodb.bson-torelaxedextendedjson.php'>Turkish</option>
            <option value='uk/function.mongodb.bson-torelaxedextendedjson.php'>Ukrainian</option>
            <option value='zh/function.mongodb.bson-torelaxedextendedjson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mongodb.bson-torelaxedextendedjson" class="refentry">
 ...
 <div id="function.mongodb.bson-torelaxedextendedjson-refsynopsisdiv">
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    ...
    <span class="methodname"><a href="mongodb-bson-document.torelaxedextendedjson.php" class="methodname">MongoDB\BSON\Document::toRelaxedExtendedJSON()</a></span>
    instead.
   </p>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mongodb.bson-torelaxedextendedjson-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>MongoDB\BSON\toRelaxedExtendedJSON</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$bson</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.mongodb.bson-torelaxedextendedjson-changelog">
...
{ &quot;maxkey&quot; : { &quot;$maxKey&quot; : 1 } }</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mongodb.bson-torelaxedextendedjson-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="mongodb-bson-document.torelaxedextendedjson.php" class="methodname" rel="rdfs-seeAlso">MongoDB\BSON\Document::toRelaxedExtendedJSON()</a> - Returns the Relaxed Extended JSON representation of the BSON document</span></li>
   <li><span class="function"><a href="function.mongodb.bson-fromjson.php" class="function" rel="rdfs-seeAlso">MongoDB\BSON\fromJSON()</a> - Returns the BSON representation of a JSON value</span></li>
   ...
   <li><a href="https://github.com/mongodb/specifications/blob/master/source/extended-json/extended-json.md" class="link external">&raquo;&nbsp;Extended JSON</a></li>
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;MongoDB BSON</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/functions/bson/torelaxedextendedjson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mongodb.bson-torelaxedextendedjson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mongodb.bson-torelaxedextendedjson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mongodb.bson-torelaxedextendedjson.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="ref.bson.functions.php">Functions</a>
                ...
                <ul class="child-menu-list">
                                    <li class="">
                        <a href="function.mongodb.bson-fromjson.php" title="MongoDB\BSON\fromJSON">MongoDB\BSON\fromJSON</a>
                    </li>
                                    <li class="">
                        <a href="function.mongodb.bson-fromphp.php" title="MongoDB\BSON\fromPHP">MongoDB\BSON\fromPHP</a>
                    </li>
                                    <li class="">
                        <a href="function.mongodb.bson-tocanonicalextendedjson.php" title="MongoDB\BSON\toCanonicalExtendedJSON">MongoDB\BSON\toCanonicalExtendedJSON</a>
                    </li>
                                    <li class="">
                        <a href="function.mongodb.bson-tojson.php" title="MongoDB\BSON\toJSON">MongoDB\BSON\toJSON</a>
                    </li>
                                    <li class="">
                        <a href="function.mongodb.bson-tophp.php" title="MongoDB\BSON\toPHP">MongoDB\BSON\toPHP</a>
                    </li>
                                    <li class="current">
                        <a href="function.mongodb.bson-torelaxedextendedjson.php" title="MongoDB\BSON\toRelaxedExtendedJSON">MongoDB\BSON\toRelaxedExtendedJSON</a>
                    </li>
                                </ul>
            </li>
                    </ul>
