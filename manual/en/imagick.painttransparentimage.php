...
<head>
  ...
  <title>PHP: Imagick::paintTransparentImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.painttransparentimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.painttransparentimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.painttransparentimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.paintopaqueimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.pingimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.painttransparentimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.painttransparentimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.painttransparentimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.painttransparentimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.painttransparentimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.painttransparentimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.painttransparentimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.painttransparentimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.painttransparentimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.painttransparentimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.painttransparentimage.php" hreflang="zh">
...
<meta name="Description" content="Changes any pixel that matches color with the color defined by fill" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::paintTransparentImage - Manual" />
<meta name="twitter:description" content="Changes any pixel that matches color with the color defined by fill" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::paintTransparentImage - Manual" />
<meta itemprop="description" content="Changes any pixel that matches color with the color defined by fill" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes any pixel that matches color with the color defined by fill" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.pingimage.php">
          Imagick::pingImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.paintopaqueimage.php">
          &laquo; Imagick::paintOpaqueImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.painttransparentimage.php' selected="selected">English</option>
            <option value='de/imagick.painttransparentimage.php'>German</option>
            <option value='es/imagick.painttransparentimage.php'>Spanish</option>
            <option value='fr/imagick.painttransparentimage.php'>French</option>
            <option value='it/imagick.painttransparentimage.php'>Italian</option>
            <option value='ja/imagick.painttransparentimage.php'>Japanese</option>
            <option value='pt_BR/imagick.painttransparentimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.painttransparentimage.php'>Russian</option>
            <option value='tr/imagick.painttransparentimage.php'>Turkish</option>
            <option value='uk/imagick.painttransparentimage.php'>Ukrainian</option>
            <option value='zh/imagick.painttransparentimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.painttransparentimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::paintTransparentImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::paintTransparentImage</span> &mdash; <span class="dc-title">Changes any pixel that matches color with the color defined by fill</span></p>

 </div>

 <div id="imagick.painttransparentimage-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.painttransparentimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::paintTransparentImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$target</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$alpha</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.painttransparentimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.painttransparentimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.painttransparentimage-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.painttransparentimage-changelog">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/painttransparentimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.painttransparentimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.painttransparentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.painttransparentimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89409">  <div class="votes">
    <div id="Vu89409">
    <a href="/manual/vote-note.php?id=89409&amp;page=imagick.painttransparentimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89409">
    <a href="/manual/vote-note.php?id=89409&amp;page=imagick.painttransparentimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89409" title="100% like this...">
    2
    </div>
  </div>
  <a href="#89409" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#89409"> &para;</a><div class="date" title="2009-03-06 08:11"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89409">
<div class="phpcode"><code><span class="html">Actually it does seem to work just not the way expected perhaps.<br /><br />Looking at the fuzz option on ImageMagick's site (<a href="http://www.imagemagick.org/script/command-line-options.php#fuzz" rel="nofollow" target="_blank">http://www.imagemagick.org/script/command-line-options.php#fuzz</a>), "The distance can be in absolute intensity units or, by appending % as a percentage of the maximum possible intensity (255, 65535, or 4294967295)."<br /><br />As it requires a float, the percentage value won't work so it actually one of the max intensity values.  In my case, the images I was working with seemed to have max intensity values of 65535.  So a fuzz of 6500, for roughly 10%, seemed to do the trick.<br /><br />The part that might be problematic though is how do you determine the max intensity of a color/image?  Using a static 6500 would be fine until I would have to convert an image with a max intensity other than 65535.  If it's 255 it would wipe the entire image.  Or fall far short on the fuzz with the larger value.</span></code></div>
  </div>
 </div>
  <div class="note" id="115876">  <div class="votes">
    <div id="Vu115876">
    <a href="/manual/vote-note.php?id=115876&amp;page=imagick.painttransparentimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115876">
    <a href="/manual/vote-note.php?id=115876&amp;page=imagick.painttransparentimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115876" title="no votes...">
    0
    </div>
  </div>
  <a href="#115876" class="name">
  <strong class="user"><em>quickshiftin at gmail dot com</em></strong></a><a class="genanchor" href="#115876"> &para;</a><div class="date" title="2014-10-07 04:22"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115876">
<div class="phpcode"><code><span class="html">Have a look at this thread on Stackoverflow for the answer regarding how to determine the max intensity of an image.<br /><br /><a href="http://stackoverflow.com/questions/26239130/determine-max-possible-intensity-of-image/26240656#26240656" rel="nofollow" target="_blank">http://stackoverflow.com/questions/26239130/determine-max-possible-intensity-of-image/26240656#26240656</a><br /><br />In short here is the code to make the $fuzz parameter behave more like you would expect (it now represents a percentage between 0-100). The $fuzz value should now be a float between 0 and 1.<br /><br />class SaneImagick extends Imagick<br />{<br />    public function paintTransparentImage($target, $alpha, $fuzz)<br />    {<br />        $iQuantumDepth = pow(2, $this-&gt;getQuantumDepth()['quantumDepthLong']);<br />        return parent::paintTransparentImage($target, $alpha, $fuzz * $iQuantumDepth);<br />    }<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="106185">  <div class="votes">
    <div id="Vu106185">
    <a href="/manual/vote-note.php?id=106185&amp;page=imagick.painttransparentimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106185">
    <a href="/manual/vote-note.php?id=106185&amp;page=imagick.painttransparentimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106185" title="no votes...">
    0
    </div>
  </div>
  <a href="#106185" class="name">
  <strong class="user"><em>alain at ocarina dot fr</em></strong></a><a class="genanchor" href="#106185"> &para;</a><div class="date" title="2011-10-17 02:14"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106185">
<div class="phpcode"><code><span class="html">The fuzz is just working well in a range of 0 to 65535.<br /><br />I suggest you to try to move fuzz on a color spectrum image.<br /><br />1/ Get a color spectrum ( Google Image has a lot )<br /><br />2/ Try this code :<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="keyword">function </span><span class="default">fuzzTest</span><span class="keyword">(</span><span class="default">$source</span><span class="keyword">, </span><span class="default">$target</span><span class="keyword">, </span><span class="default">$fuzz</span><span class="keyword">) {<br /><br />        </span><span class="comment">// Loads image<br />        </span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$source</span><span class="keyword">);<br /><br />        </span><span class="comment">// Resizes images to make them easily comparable<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">resizeImage</span><span class="keyword">(</span><span class="default">320</span><span class="keyword">, </span><span class="default">240</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">FILTER_LANCZOS</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />        <br />        </span><span class="comment">// Apply fuzz<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">paintTransparentImage</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImagePixelColor</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">), </span><span class="default">0</span><span class="keyword">, </span><span class="default">$fuzz</span><span class="keyword">);<br />        <br />         </span><span class="comment">// Writes image<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$target</span><span class="keyword">);<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();<br />         <br />        return </span><span class="default">true</span><span class="keyword">;<br />     }<br /><br />     for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; (</span><span class="default">$i </span><span class="keyword">&lt;= </span><span class="default">10</span><span class="keyword">); </span><span class="default">$i</span><span class="keyword">++) {<br />         </span><span class="default">fuzzTest</span><span class="keyword">(</span><span class="string">'spectrum.png'</span><span class="keyword">, </span><span class="string">"test_</span><span class="keyword">{</span><span class="default">$i</span><span class="keyword">}</span><span class="string">.png"</span><span class="keyword">, (</span><span class="default">6553.5 </span><span class="keyword">* </span><span class="default">$i</span><span class="keyword">));<br />         echo </span><span class="string">'&lt;img src="test_' </span><span class="keyword">. </span><span class="default">$i </span><span class="keyword">. </span><span class="string">'.png" /&gt;&amp;nbsp;'</span><span class="keyword">;<br />     }<br /> <br /> </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.painttransparentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.painttransparentimage.php">＋<small>add a note</small></a></div>
