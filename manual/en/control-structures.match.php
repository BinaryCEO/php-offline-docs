...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/control-structures.match.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/control-structures.switch.php">
 <link rel="next" href="https://www.php.net/manual/en/control-structures.declare.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/control-structures.match.php' selected="selected">English</option>
            ...
            <option value='tr/control-structures.match.php'>Turkish</option>
...
string(19) &quot;This food is a cake&quot;
  ...
  <div class="example" id="example-192">
   <p><strong>Example #3 Example of using <code class="literal">match</code> with comparison operators</strong></p>
    <div class="example-contents">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$expressionResult </span><span style="color: #007700">= match (</span><span style="color: #0000BB">$condition</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">2 </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">foo</span><span style="color: #007700">(),<br />    </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">4 </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">bar</span><span style="color: #007700">(),<br />    default =&gt; </span><span style="color: #0000BB">baz</span><span style="color: #007700">(),<br />};<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="example" id="example-195">
  <p><strong>Example #4 Example of an unhandled match expression</strong></p>
  <div class="example-contents">
...
object(UnhandledMatchError)#1 (7) {
 ...
 <div class="sect2">
  ...
  <div class="example" id="example-196">
   <p><strong>Example #5 Using a generalized match expressions to branch on integer ranges</strong></p>
   <div class="example-contents">
...
string(11) &quot;young adult&quot;
  ...
  <div class="example" id="example-197">
   <p><strong>Example #6 Using a generalized match expressions to branch on string content</strong></p>
   <div class="example-contents">
...
string(2) &quot;fr&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/control-structures/match.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcontrol-structures.match%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=control-structures.match&amp;repo=en&amp;redirect=https://www.php.net/manual/en/control-structures.match.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This will allow for a nicer FizzBuzz solution:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">fizzbuzz</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">) {<br />    print match (</span><span class="default">0</span><span class="keyword">) {<br />        </span><span class="default">$num </span><span class="keyword">% </span><span class="default">15 </span><span class="keyword">=&gt; </span><span class="string">"FizzBuzz" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">,<br />        </span><span class="default">$num </span><span class="keyword">% </span><span class="default">3  </span><span class="keyword">=&gt; </span><span class="string">"Fizz" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">,<br />        </span><span class="default">$num </span><span class="keyword">% </span><span class="default">5  </span><span class="keyword">=&gt; </span><span class="string">"Buzz" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">,<br />        default   =&gt; </span><span class="default">$num </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">,<br />    };<br />}<br /><br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt;=</span><span class="default">100</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++)<br />{<br />    </span><span class="default">fizzbuzz</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">);<br />}</span></span></code></div>
  </div>
 </div>
...
<br /></span><span class="keyword">function </span><span class="default">days_in_month</span><span class="keyword">(</span><span class="default">string $month</span><span class="keyword">, </span><span class="default">$year</span><span class="keyword">): </span><span class="default">int
<br /></span><span class="keyword">{
<br />    return match(</span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$month</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">))) {
<br />        </span><span class="string">'jan' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'feb' </span><span class="keyword">=&gt; </span><span class="default">is_leap</span><span class="keyword">(</span><span class="default">$year</span><span class="keyword">) ? </span><span class="default">29 </span><span class="keyword">: </span><span class="default">28</span><span class="keyword">,
<br />        </span><span class="string">'mar' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'apr' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />        </span><span class="string">'may' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'jun' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />        </span><span class="string">'jul' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'aug' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'sep' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />        </span><span class="string">'oct' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'nov' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />        </span><span class="string">'dec' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        default =&gt; throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">"Bogus month"</span><span class="keyword">),
<br />    };
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />can be more concisely written as
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">days_in_month</span><span class="keyword">(</span><span class="default">string $month</span><span class="keyword">, </span><span class="default">$year</span><span class="keyword">): </span><span class="default">int
<br /></span><span class="keyword">{
<br />    return match(</span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$month</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">))) {
<br />        </span><span class="string">'apr'</span><span class="keyword">, </span><span class="string">'jun'</span><span class="keyword">, </span><span class="string">'sep'</span><span class="keyword">,  </span><span class="string">'nov'  </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,        
<br />        </span><span class="string">'jan'</span><span class="keyword">, </span><span class="string">'mar'</span><span class="keyword">, </span><span class="string">'may'</span><span class="keyword">, </span><span class="string">'jul'</span><span class="keyword">, </span><span class="string">'aug'</span><span class="keyword">,  </span><span class="string">'oct'</span><span class="keyword">, </span><span class="string">'dec'  </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />        </span><span class="string">'feb' </span><span class="keyword">=&gt; </span><span class="default">is_leap</span><span class="keyword">(</span><span class="default">$year</span><span class="keyword">) ? </span><span class="default">29 </span><span class="keyword">: </span><span class="default">28</span><span class="keyword">,
<br />        default =&gt; throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">"Bogus month"</span><span class="keyword">),
<br />    };
<br />}
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#125580"> &para;</a><div class="date" title="2020-12-09 12:50"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125580">
<div class="phpcode"><code><span class="html">As well as being similar to a switch, match expressions can be thought of as enhanced lookup tables — for when a simple array lookup isn't enough without extra handling of edge cases, but a full switch statement would be overweight.
<br />
<br />For a familiar example, the following
<br /><span class="default">&lt;?php
<br />
<br /></span><span class="keyword">function </span><span class="default">days_in_month</span><span class="keyword">(</span><span class="default">string $month</span><span class="keyword">): </span><span class="default">int
<br /></span><span class="keyword">{
<br />    static </span><span class="default">$lookup </span><span class="keyword">= [
<br />    </span><span class="string">'jan' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />    </span><span class="string">'feb' </span><span class="keyword">=&gt; </span><span class="default">0</span><span class="keyword">,
<br />    </span><span class="string">'mar' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />    </span><span class="string">'apr' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />    </span><span class="string">'may' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />    </span><span class="string">'jun' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
...
<br />    </span><span class="string">'oct' </span><span class="keyword">=&gt; </span><span class="default">31</span><span class="keyword">,
<br />    </span><span class="string">'nov' </span><span class="keyword">=&gt; </span><span class="default">30</span><span class="keyword">,
<br />    </span><span class="string">'dec' </span><span class="keyword">=&gt; </span><span class="default">31
<br />    </span><span class="keyword">];
<br />
<br />    </span><span class="default">$name </span><span class="keyword">= </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">));
<br />
<br />    if(isset(</span><span class="default">$lookup</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">])) {
<br />        if(</span><span class="default">$name </span><span class="keyword">== </span><span class="string">'feb'</span><span class="keyword">) {
<br />            return </span><span class="default">is_leap</span><span class="keyword">(</span><span class="default">$year</span><span class="keyword">) ? </span><span class="default">29 </span><span class="keyword">: </span><span class="default">28</span><span class="keyword">;
<br />        } else {
<br />            return </span><span class="default">$lookup</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">];
<br />        }
<br />    }
<br />    throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">"Bogus month"</span><span class="keyword">);
<br />}
<br />
<br /></span><span class="default">?&gt;
<br /></span>
<br />with the fiddly stuff at the end, can be replaced by
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">days_in_month</span><span class="keyword">(</span><span class="default">string $month</span><span class="keyword">): </span><span class="default">int
<br /></span><span class="keyword">{
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />Which also takes advantage of "throw" being handled as of PHP 8.0 as an expression instead of a statement.</span></code></div>
  </div>
 </div>
  <div class="note" id="129315">  <div class="votes">
    ...
    <div class="tally" id="V129315" title="73% like this...">
    9
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Yes it currently does not support code blocks but this hack works:<br /><br />match ($foo){<br />    'bar'=&gt;(function(){<br />        echo "bar";<br />    })(),<br />    default =&gt; (function(){<br />        echo "baz";<br />    })()<br />};</span></code></div>
  </div>
 </div>
  <div class="note" id="128256">  <div class="votes">
    ...
    <div class="tally" id="V128256" title="72% like this...">
    10
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">While match allows chaining multiple conditions with ",", like:<br /><span class="default">&lt;?php<br />$result </span><span class="keyword">= match (</span><span class="default">$source</span><span class="keyword">) {<br />    </span><span class="default">cond1</span><span class="keyword">, </span><span class="default">cond2 </span><span class="keyword">=&gt; </span><span class="default">val1</span><span class="keyword">,<br />    default =&gt; </span><span class="default">val2<br /></span><span class="keyword">};<br /></span><span class="default">?&gt;<br /></span>it seems not valid to chain conditions with default, like:<br /><span class="default">&lt;?php<br />$result </span><span class="keyword">= match (</span><span class="default">$source</span><span class="keyword">) {<br />    </span><span class="default">cond1 </span><span class="keyword">=&gt; </span><span class="default">val1</span><span class="keyword">,<br />    </span><span class="default">cond2</span><span class="keyword">, default =&gt; </span><span class="default">val2<br /></span><span class="keyword">};<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you want to execute multiple return expressions when matching a conditional expression, you can do so by stating all return expressions inside an array.<br /><br /><span class="default">&lt;?php<br />    $countries </span><span class="keyword">= [</span><span class="string">'Belgium'</span><span class="keyword">, </span><span class="string">'Netherlands'</span><span class="keyword">];<br />    </span><span class="default">$spoken_languages </span><span class="keyword">= [<br />        </span><span class="string">'Dutch' </span><span class="keyword">=&gt; </span><span class="default">false</span><span class="keyword">,<br />        </span><span class="string">'French' </span><span class="keyword">=&gt; </span><span class="default">false</span><span class="keyword">,<br />        </span><span class="string">'German' </span><span class="keyword">=&gt; </span><span class="default">false</span><span class="keyword">,<br />        </span><span class="string">'English' </span><span class="keyword">=&gt; </span><span class="default">false</span><span class="keyword">,<br />    ];<br /><br />    foreach (</span><span class="default">$countries </span><span class="keyword">as </span><span class="default">$country</span><span class="keyword">) {<br />        match(</span><span class="default">$country</span><span class="keyword">) {<br />            </span><span class="string">'Belgium' </span><span class="keyword">=&gt; [<br />                </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'Dutch'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />                </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'French'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />                </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'German'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />            ],<br />            </span><span class="string">'Netherlands' </span><span class="keyword">=&gt; </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'Dutch'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />            </span><span class="string">'Germany' </span><span class="keyword">=&gt; </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'German'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />            </span><span class="string">'United Kingdom' </span><span class="keyword">=&gt; </span><span class="default">$spoken_languages</span><span class="keyword">[</span><span class="string">'English'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">,<br />        };<br />    }<br /><br />    </span><span class="default">var_export</span><span class="keyword">(</span><span class="default">$spoken_languages</span><span class="keyword">); <br />    </span><span class="comment">// array ( 'Dutch' =&gt; true, 'French' =&gt; true, 'German' =&gt; true, 'English' =&gt; false, )<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I use match instead of storing PDOStatement::rowCount() result and chaining if/elseif conditions or use the ugly switch/break :<br /><br /><span class="default">&lt;?php<br /><br />$sql </span><span class="keyword">= &lt;&lt;&lt;SQL<br /></span><span class="string">    INSERT INTO ...<br />    ON DUPLICATE KEY UPDATE ...<br /></span><span class="keyword">    SQL;<br /><br /></span><span class="default">$upkeep </span><span class="keyword">= </span><span class="default">$pdo</span><span class="keyword">-&gt;</span><span class="default">prepare</span><span class="keyword">(</span><span class="default">$sql</span><span class="keyword">);<br /><br /></span><span class="default">$count_untouched </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /></span><span class="default">$count_inserted </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /></span><span class="default">$count_updated </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /><br />foreach (</span><span class="default">$data </span><span class="keyword">as </span><span class="default">$record</span><span class="keyword">) {<br />    </span><span class="default">$upkeep</span><span class="keyword">-&gt;</span><span class="default">execute</span><span class="keyword">(</span><span class="default">$record</span><span class="keyword">);<br />    match (</span><span class="default">$upkeep</span><span class="keyword">-&gt;</span><span class="default">rowCount</span><span class="keyword">()) {<br />        </span><span class="default">0 </span><span class="keyword">=&gt; </span><span class="default">$count_untouched</span><span class="keyword">++,<br />        </span><span class="default">1 </span><span class="keyword">=&gt; </span><span class="default">$count_inserted</span><span class="keyword">++,<br />        </span><span class="default">2 </span><span class="keyword">=&gt; </span><span class="default">$count_updated</span><span class="keyword">++,<br />    };<br />}<br /><br />echo </span><span class="string">"Untouched rows : </span><span class="keyword">{</span><span class="default">$count_untouched</span><span class="keyword">}</span><span class="string">\r\n"</span><span class="keyword">;<br />echo </span><span class="string">"Inserted rows : </span><span class="keyword">{</span><span class="default">$count_inserted</span><span class="keyword">}</span><span class="string">\r\n"</span><span class="keyword">;<br />echo </span><span class="string">"Updated rows : </span><span class="keyword">{</span><span class="default">$count_updated</span><span class="keyword">}</span><span class="string">\r\n"</span><span class="keyword">;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">While you can’t polyfill a language construct, you can mimic the basic behaviour with a simple array.<br /><br />Using example 2 above:<br /><br /><span class="default">&lt;?php<br />    $food </span><span class="keyword">= </span><span class="string">'apple'</span><span class="keyword">;<br />    </span><span class="default">$return_value </span><span class="keyword">= match (</span><span class="default">$food</span><span class="keyword">) {<br />        </span><span class="string">'apple' </span><span class="keyword">=&gt; </span><span class="string">'This food is an apple'</span><span class="keyword">,<br />        </span><span class="string">'bar' </span><span class="keyword">=&gt; </span><span class="string">'This food is a bar'</span><span class="keyword">,<br />        </span><span class="string">'cake' </span><span class="keyword">=&gt; </span><span class="string">'This food is a cake'</span><span class="keyword">,<br />    };    <br />    print </span><span class="default">$return_value</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />… you can get something similar with:<br /><br /><span class="default">&lt;?php<br />    $food </span><span class="keyword">= </span><span class="string">'apple'</span><span class="keyword">;    <br />    </span><span class="default">$return_value </span><span class="keyword">= [<br />        </span><span class="string">'apple' </span><span class="keyword">=&gt; </span><span class="string">'This food is an apple'</span><span class="keyword">,<br />        </span><span class="string">'bar' </span><span class="keyword">=&gt; </span><span class="string">'This food is a bar'</span><span class="keyword">,<br />        </span><span class="string">'cake' </span><span class="keyword">=&gt; </span><span class="string">'This food is a cake'</span><span class="keyword">,<br />    ][</span><span class="default">$food</span><span class="keyword">];<br />    print </span><span class="default">$return_value</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126542">  <div class="votes">
    ...
    <div class="tally" id="V126542" title="52% like this...">
    1
    </div>
  </div>
  <a href="#126542" class="name">
  <strong class="user"><em>tm</em></strong></a><a class="genanchor" href="#126542"> &para;</a><div class="date" title="2021-10-28 03:02"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126542">
<div class="phpcode"><code><span class="html">If you are using a match expression for non-identity checks as described above make sure whatever you are using is actually returning `true` on success.<br /><br />Quite often you rely on truthy vs. falsy when using if conditions and that will not work for match (for example `preg_match`). Casting to bool will solve this issue.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=control-structures.match&amp;repo=en&amp;redirect=https://www.php.net/manual/en/control-structures.match.php">＋<small>add a note</small></a></div>
