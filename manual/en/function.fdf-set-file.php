...
<head>
  ...
  <title>PHP: fdf_set_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-set-file.php">
 <link rel="shorturl" href="https://www.php.net/fdf-set-file">
 <link rel="alternate" href="https://www.php.net/fdf-set-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-set-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-set-flags.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-set-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-set-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-set-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-set-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-set-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-set-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-set-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-set-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-set-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-set-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-set-file.php" hreflang="zh">
...
<meta name="Description" content="Set PDF document to display FDF data in" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_set_file - Manual" />
<meta name="twitter:description" content="Set PDF document to display FDF data in" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_set_file - Manual" />
<meta itemprop="description" content="Set PDF document to display FDF data in" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set PDF document to display FDF data in" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-set-file.php' selected="selected">English</option>
            <option value='de/function.fdf-set-file.php'>German</option>
            <option value='es/function.fdf-set-file.php'>Spanish</option>
            <option value='fr/function.fdf-set-file.php'>French</option>
            <option value='it/function.fdf-set-file.php'>Italian</option>
            <option value='ja/function.fdf-set-file.php'>Japanese</option>
            <option value='pt_BR/function.fdf-set-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-set-file.php'>Russian</option>
            <option value='tr/function.fdf-set-file.php'>Turkish</option>
            <option value='uk/function.fdf-set-file.php'>Ukrainian</option>
            <option value='zh/function.fdf-set-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-set-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_set_file</h1>
  <p class="verinfo">(PHP 4, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_set_file</span> &mdash; <span class="dc-title">Set PDF document to display FDF data in</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="function"><a href="function.fdf-set-target-frame.php" class="function">fdf_set_target_frame()</a></span>.
      </p>
     </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  </span><span style="color: #FF8000">/* set content type for Adobe FDF */<br />  </span><span style="color: #0000BB">fdf_header</span><span style="color: #007700">();<br /><br />  </span><span style="color: #FF8000">/* start new fdf */<br />  </span><span style="color: #0000BB">$fdf </span><span style="color: #007700">= </span><span style="color: #0000BB">fdf_create</span><span style="color: #007700">();<br /><br />  </span><span style="color: #FF8000">/* set field "foo" to value "bar" */<br />  </span><span style="color: #0000BB">fdf_set_value</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">, </span><span style="color: #DD0000">"foo"</span><span style="color: #007700">, </span><span style="color: #DD0000">"bar"</span><span style="color: #007700">);<br /><br />  </span><span style="color: #FF8000">/* tell client to display FDF data using "fdf_form.pdf" */<br />  </span><span style="color: #0000BB">fdf_set_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">, </span><span style="color: #DD0000">"http://www.example.com/fdf_form.pdf"</span><span style="color: #007700">);<br /><br />  </span><span style="color: #FF8000">/* output fdf */<br />  </span><span style="color: #0000BB">fdf_save</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">);<br /><br />  </span><span style="color: #FF8000">/* clean up */<br />  </span><span style="color: #0000BB">fdf_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-set-file-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-get-file.php" class="function" rel="rdfs-seeAlso">fdf_get_file()</a> - Get the value of the /F key</span></li>
    <li><span class="function"><a href="function.fdf-set-target-frame.php" class="function" rel="rdfs-seeAlso">fdf_set_target_frame()</a> - Set target frame for form display</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-set-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-set-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-set-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-set-file.php">＋<small>add a note</small></a></span>
