...
<head>
  ...
  <title>PHP: oci_commit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-commit.php">
 <link rel="shorturl" href="https://www.php.net/oci-commit">
 <link rel="alternate" href="https://www.php.net/oci-commit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-commit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-commit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-commit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-commit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-commit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-commit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-commit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-commit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-commit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-commit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-commit.php" hreflang="zh">
...
<meta name="Description" content="Commits the outstanding database transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_commit - Manual" />
<meta name="twitter:description" content="Commits the outstanding database transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_commit - Manual" />
<meta itemprop="description" content="Commits the outstanding database transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commits the outstanding database transaction" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-commit.php' selected="selected">English</option>
            <option value='de/function.oci-commit.php'>German</option>
            <option value='es/function.oci-commit.php'>Spanish</option>
            <option value='fr/function.oci-commit.php'>French</option>
            <option value='it/function.oci-commit.php'>Italian</option>
            <option value='ja/function.oci-commit.php'>Japanese</option>
            <option value='pt_BR/function.oci-commit.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-commit.php'>Russian</option>
            <option value='tr/function.oci-commit.php'>Turkish</option>
            <option value='uk/function.oci-commit.php'>Ukrainian</option>
            <option value='zh/function.oci-commit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-commit" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-rollback.php" class="function" rel="rdfs-seeAlso">oci_rollback()</a> - Rolls back the outstanding database transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-commit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-commit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-commit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-commit.php">＋<small>add a note</small></a></span>
