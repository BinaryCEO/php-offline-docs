...
<head>
  ...
  <title>PHP: Imagick::randomThresholdImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.raiseimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.readimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.randomthresholdimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.randomthresholdimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.randomthresholdimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.randomthresholdimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.randomthresholdimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.randomthresholdimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.randomthresholdimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.randomthresholdimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.randomthresholdimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.randomthresholdimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a high-contrast, two-color image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::randomThresholdImage - Manual" />
<meta name="twitter:description" content="Creates a high-contrast, two-color image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::randomThresholdImage - Manual" />
<meta itemprop="description" content="Creates a high-contrast, two-color image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a high-contrast, two-color image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.readimage.php">
          Imagick::readImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.raiseimage.php">
          &laquo; Imagick::raiseImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.randomthresholdimage.php' selected="selected">English</option>
            <option value='de/imagick.randomthresholdimage.php'>German</option>
            <option value='es/imagick.randomthresholdimage.php'>Spanish</option>
            <option value='fr/imagick.randomthresholdimage.php'>French</option>
            <option value='it/imagick.randomthresholdimage.php'>Italian</option>
            <option value='ja/imagick.randomthresholdimage.php'>Japanese</option>
            <option value='pt_BR/imagick.randomthresholdimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.randomthresholdimage.php'>Russian</option>
            <option value='tr/imagick.randomthresholdimage.php'>Turkish</option>
            <option value='uk/imagick.randomthresholdimage.php'>Ukrainian</option>
            <option value='zh/imagick.randomthresholdimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.randomthresholdimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::randomThresholdImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::randomThresholdImage</span> &mdash; <span class="dc-title">Creates a high-contrast, two-color image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.randomthresholdimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::randomThresholdImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$low</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$high</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>


  <p class="para rdfs-comment">
   Changes the value of individual pixels based on the
   intensity of each pixel compared to threshold. The
   result is a high-contrast, two color image. This method is available if Imagick has been compiled against ImageMagick version 6.2.9 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.randomthresholdimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.randomthresholdimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3074">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/randomthresholdimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.randomthresholdimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.randomthresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.randomthresholdimage.php">＋<small>add a note</small></a></span>
