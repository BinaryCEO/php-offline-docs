...
<head>
  ...
  <title>PHP: Gmagick::getimageextrema - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageextrema.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageextrema.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageextrema.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagedispose.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagefilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageextrema.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageextrema.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageextrema.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageextrema.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageextrema.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageextrema.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageextrema.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageextrema.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageextrema.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageextrema.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageextrema.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageextrema - Manual" />
<meta name="twitter:description" content="Gets the extrema for the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageextrema - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagefilename.php">
          Gmagick::getimagefilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagedispose.php">
          &laquo; Gmagick::getimagedispose        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageextrema.php' selected="selected">English</option>
            <option value='de/gmagick.getimageextrema.php'>German</option>
            <option value='es/gmagick.getimageextrema.php'>Spanish</option>
            <option value='fr/gmagick.getimageextrema.php'>French</option>
            <option value='it/gmagick.getimageextrema.php'>Italian</option>
            <option value='ja/gmagick.getimageextrema.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageextrema.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageextrema.php'>Russian</option>
            <option value='tr/gmagick.getimageextrema.php'>Turkish</option>
            <option value='uk/gmagick.getimageextrema.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageextrema.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageextrema" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageextrema</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageextrema</span> &mdash; <span class="dc-title">Gets the extrema for the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageextrema-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageextrema</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageextrema-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageextrema-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageextrema-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageextrema.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageextrema%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageextrema&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageextrema.php">＋<small>add a note</small></a></span>
