...
<head>
  ...
  <title>PHP: ibase_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-prepare.php">
 <link rel="shorturl" href="https://www.php.net/ibase-prepare">
 <link rel="alternate" href="https://www.php.net/ibase-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-prepare.php" hreflang="zh">
...
<meta name="Description" content="Prepare a query for later binding of parameter placeholders and execution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_prepare - Manual" />
<meta name="twitter:description" content="Prepare a query for later binding of parameter placeholders and execution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_prepare - Manual" />
<meta itemprop="description" content="Prepare a query for later binding of parameter placeholders and execution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepare a query for later binding of parameter placeholders and execution" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-query.php">
          ibase_query &raquo;
              ...
              <div class="prev">
        <a href="function.ibase-pconnect.php">
          &laquo; ibase_pconnect        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-prepare.php' selected="selected">English</option>
            <option value='de/function.ibase-prepare.php'>German</option>
            <option value='es/function.ibase-prepare.php'>Spanish</option>
            <option value='fr/function.ibase-prepare.php'>French</option>
            <option value='it/function.ibase-prepare.php'>Italian</option>
            <option value='ja/function.ibase-prepare.php'>Japanese</option>
            <option value='pt_BR/function.ibase-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-prepare.php'>Russian</option>
            <option value='tr/function.ibase-prepare.php'>Turkish</option>
            <option value='uk/function.ibase-prepare.php'>Ukrainian</option>
            <option value='zh/function.ibase-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-prepare" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_prepare</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_prepare</span> &mdash; <span class="dc-title">Prepare a query for later binding of parameter placeholders and execution</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-prepare-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_prepare</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>ibase_prepare</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>ibase_prepare</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$trans</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="simpara">
   Prepare a query for later binding of parameter placeholders and execution
   (via <span class="function"><a href="function.ibase-execute.php" class="function">ibase_execute()</a></span>).
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="function"><a href="function.ibase-connect.php" class="function">ibase_connect()</a></span>. If omitted, the last opened link
       is assumed.
      </p>
     </dd>
    
    
     <dt><code class="parameter">trans</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-prepare-returnvalues">
  ...
  <p class="para">
   Returns a prepared query handle, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-prepare.php">＋<small>add a note</small></a></span>
