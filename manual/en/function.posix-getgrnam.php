...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getgrnam.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getgrgid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getgroups.php">
...
<meta name="Description" content="Return info about a group by name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getgrnam - Manual" />
<meta name="twitter:description" content="Return info about a group by name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getgrnam - Manual" />
<meta itemprop="description" content="Return info about a group by name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return info about a group by name" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getgrnam.php' selected="selected">English</option>
            <option value='de/function.posix-getgrnam.php'>German</option>
            <option value='es/function.posix-getgrnam.php'>Spanish</option>
            <option value='fr/function.posix-getgrnam.php'>French</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-getgrnam-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   ...
   <ul class="simplelist">
    ...
    <li>POSIX man page GETGRNAM(3)</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getgrnam.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getgrnam%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getgrnam&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getgrnam.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This function returns 'false' if the group is not found.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-getgrnam&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getgrnam.php">＋<small>add a note</small></a></div>
