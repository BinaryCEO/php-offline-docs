...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.crc32.php">
 <link rel="next" href="https://www.php.net/manual/en/function.echo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.crypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.crypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.crypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.crypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.crypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.crypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.crypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.crypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.crypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.crypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.crypt.php" hreflang="zh">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$user_input </span><span style="color: #007700">= </span><span style="color: #DD0000">'rasmuslerdorf'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$hashed_password </span><span style="color: #007700">= </span><span style="color: #DD0000">'$6$rounds=1000000$NJy4rIPjpOaU$0ACEYGg/aKCY3v8O8AfyiO7CTfZQ8/W231Qfh2tRLmfdvFD6XfHk12u6hMr9cYIA4hnpjLNSTRtUwYr9km9Ij/'</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Validate an existing crypt() hash in a way that is compatible with non-PHP software.<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">hash_equals</span><span style="color: #007700">(</span><span style="color: #0000BB">$hashed_password</span><span style="color: #007700">, </span><span style="color: #0000BB">crypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$user_input</span><span style="color: #007700">, </span><span style="color: #0000BB">$hashed_password</span><span style="color: #007700">))) {<br />   echo </span><span style="color: #DD0000">"Password verified!"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.crypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.crypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129923">  <div class="votes">
    <div id="Vu129923">
    <a href="/manual/vote-note.php?id=129923&amp;page=function.crypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129923">
    <a href="/manual/vote-note.php?id=129923&amp;page=function.crypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129923" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#129923" class="name">
  <strong class="user"><em>remi at php dot net</em></strong></a><a class="genanchor" href="#129923"> &para;</a><div class="date" title="2024-12-19 11:06"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129923">
<div class="phpcode"><code><span class="html">The crypt_gensalt function (from the xpass extension) makes usage of this function much easier, ex:<br /><br /><span class="default">&lt;?php<br /><br />$salt </span><span class="keyword">= </span><span class="default">crypt_gensalt</span><span class="keyword">(</span><span class="default">CRYPT_PREFIX_BLOWFISH</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">);<br /></span><span class="default">$hash </span><span class="keyword">= </span><span class="default">crypt</span><span class="keyword">(</span><span class="default">$secret</span><span class="keyword">, </span><span class="default">$salt</span><span class="keyword">);</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.crypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.crypt.php">＋<small>add a note</small></a></div>
