...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfontstretch.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfontstretch.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontstretch.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfontstyle.php">
...
<meta name="Description" content="Sets the font stretch to use when annotating with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFontStretch - Manual" />
<meta name="twitter:description" content="Sets the font stretch to use when annotating with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFontStretch - Manual" />
<meta itemprop="description" content="Sets the font stretch to use when annotating with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the font stretch to use when annotating with text" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfontstretch.php' selected="selected">English</option>
            ...
            <option value='ja/imagickdraw.setfontstretch.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFontStretch</span> &mdash; <span class="dc-title">Sets the font stretch to use when annotating with text</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfontstretch-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.stretch" class="link">STRETCH</a> constant
       (<code class="literal">imagick::STRETCH_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setfontstretch-examples">
  ...
  <p class="para">
    <div class="example" id="example-3177">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::setFontStretch()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfontstretch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfontstretch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfontstretch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontstretch.php">＋<small>add a note</small></a></span>
