...
<head>
  ...
  <title>PHP: DOMDocument::createAttributeNS - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.createattributens.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.createattributens.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createattributens.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.createattribute.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocument.createcdatasection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.createattributens.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.createattributens.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.createattributens.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.createattributens.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.createattributens.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.createattributens.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.createattributens.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.createattributens.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.createattributens.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.createattributens.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.createattributens.php" hreflang="zh">
...
<meta name="Description" content="Create new attribute node with an associated namespace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocument::createAttributeNS - Manual" />
<meta name="twitter:description" content="Create new attribute node with an associated namespace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::createAttributeNS - Manual" />
<meta itemprop="description" content="Create new attribute node with an associated namespace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create new attribute node with an associated namespace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domdocument.createcdatasection.php">
          DOMDocument::createCDATASection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.createattribute.php">
          &laquo; DOMDocument::createAttribute        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.createattributens.php' selected="selected">English</option>
            <option value='de/domdocument.createattributens.php'>German</option>
            <option value='es/domdocument.createattributens.php'>Spanish</option>
            <option value='fr/domdocument.createattributens.php'>French</option>
            <option value='it/domdocument.createattributens.php'>Italian</option>
            <option value='ja/domdocument.createattributens.php'>Japanese</option>
            <option value='pt_BR/domdocument.createattributens.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.createattributens.php'>Russian</option>
            <option value='tr/domdocument.createattributens.php'>Turkish</option>
            <option value='uk/domdocument.createattributens.php'>Ukrainian</option>
            <option value='zh/domdocument.createattributens.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.createattributens" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-domdocument.createattributens-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="classname"><a href="class.domattr.php" class="classname">DOMAttr</a></span>. This node will not show up in the document unless
