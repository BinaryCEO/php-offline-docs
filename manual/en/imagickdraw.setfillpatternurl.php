...
<head>
  ...
  <title>PHP: ImagickDraw::setFillPatternURL - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfillopacity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfillrule.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfillpatternurl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfillpatternurl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfillpatternurl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfillpatternurl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfillpatternurl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfillpatternurl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfillpatternurl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfillpatternurl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfillpatternurl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfillpatternurl.php" hreflang="zh">
...
<meta name="Description" content="Sets the URL to use as a fill pattern for filling objects" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFillPatternURL - Manual" />
<meta name="twitter:description" content="Sets the URL to use as a fill pattern for filling objects" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFillPatternURL - Manual" />
<meta itemprop="description" content="Sets the URL to use as a fill pattern for filling objects" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the URL to use as a fill pattern for filling objects" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfillrule.php">
          ImagickDraw::setFillRule &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfillopacity.php">
          &laquo; ImagickDraw::setFillOpacity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfillpatternurl.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfillpatternurl.php'>German</option>
            <option value='es/imagickdraw.setfillpatternurl.php'>Spanish</option>
            <option value='fr/imagickdraw.setfillpatternurl.php'>French</option>
            <option value='it/imagickdraw.setfillpatternurl.php'>Italian</option>
            <option value='ja/imagickdraw.setfillpatternurl.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfillpatternurl.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfillpatternurl.php'>Russian</option>
            <option value='tr/imagickdraw.setfillpatternurl.php'>Turkish</option>
            <option value='uk/imagickdraw.setfillpatternurl.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfillpatternurl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfillpatternurl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFillPatternURL</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFillPatternURL</span> &mdash; <span class="dc-title">Sets the URL to use as a fill pattern for filling objects</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfillpatternurl-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFillPatternURL</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fill_url</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfillpatternurl-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">fill_url</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfillpatternurl-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfillpatternurl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfillpatternurl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfillpatternurl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php">＋<small>add a note</small></a></span>
