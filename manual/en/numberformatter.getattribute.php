...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/numberformatter.getattribute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/numberformatter.getattribute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/numberformatter.getattribute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.numberformatter.php">
 <link rel="prev" href="https://www.php.net/manual/en/numberformatter.formatcurrency.php">
 <link rel="next" href="https://www.php.net/manual/en/numberformatter.geterrorcode.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/numberformatter.getattribute.php' selected="selected">English</option>
            <option value='de/numberformatter.getattribute.php'>German</option>
            <option value='es/numberformatter.getattribute.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">NumberFormatter::getAttribute</span> -- <span class="refname">numfmt_get_attribute</span> &mdash; <span class="dc-title">Get an attribute</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-numberformatter.getattribute-examples">
  ...
  <div class="example" id="example-2500">
   <p><strong>Example #1 <span class="function"><strong>numfmt_get_attribute()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="numberformatter.setattribute.php" class="function" rel="rdfs-seeAlso">numfmt_set_attribute()</a> - Set an attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/numberformatter/get-attribute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fnumberformatter.getattribute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=numberformatter.getattribute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/numberformatter.getattribute.php">＋<small>add a note</small></a></span>
