...
<head>
  ...
  <title>PHP: Gmagick::flipimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.flipimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.flipimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.flipimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.equalizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.flopimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.flipimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.flipimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.flipimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.flipimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.flipimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.flipimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.flipimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.flipimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.flipimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.flipimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.flipimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::flipimage - Manual" />
<meta name="twitter:description" content="Creates a vertical mirror image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::flipimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.flopimage.php">
          Gmagick::flopimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.equalizeimage.php">
          &laquo; Gmagick::equalizeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.flipimage.php' selected="selected">English</option>
            <option value='de/gmagick.flipimage.php'>German</option>
            <option value='es/gmagick.flipimage.php'>Spanish</option>
            <option value='fr/gmagick.flipimage.php'>French</option>
            <option value='it/gmagick.flipimage.php'>Italian</option>
            <option value='ja/gmagick.flipimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.flipimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.flipimage.php'>Russian</option>
            <option value='tr/gmagick.flipimage.php'>Turkish</option>
            <option value='uk/gmagick.flipimage.php'>Ukrainian</option>
            <option value='zh/gmagick.flipimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.flipimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::flipimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::flipimage</span> &mdash; <span class="dc-title">Creates a vertical mirror image</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.flipimage-returnvalues">
  ...
  <p class="para">
   The flipped <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
 ...
 <div class="refsect1 seealso" id="refsect1-gmagick.flipimage-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="gmagick.flopimage.php" class="function" rel="rdfs-seeAlso">Gmagick::flopimage()</a> - Creates a horizontal mirror image</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/flipimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.flipimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.flipimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.flipimage.php">＋<small>add a note</small></a></span>
