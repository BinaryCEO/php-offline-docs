...
<head>
  ...
  <title>PHP: rnp_op_encrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-op-encrypt.php">
 <link rel="shorturl" href="https://www.php.net/rnp-op-encrypt">
 <link rel="alternate" href="https://www.php.net/rnp-op-encrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-locate-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-op-generate-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-op-encrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-op-encrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-op-encrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-op-encrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-op-encrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-op-encrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-op-encrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-op-encrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-op-encrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-op-encrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-op-encrypt.php" hreflang="zh">
...
<meta name="Description" content="Encrypt message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_op_encrypt - Manual" />
<meta name="twitter:description" content="Encrypt message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_op_encrypt - Manual" />
<meta itemprop="description" content="Encrypt message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypt message" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-op-generate-key.php">
          rnp_op_generate_key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-locate-key.php">
          &laquo; rnp_locate_key        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-op-encrypt.php' selected="selected">English</option>
            <option value='de/function.rnp-op-encrypt.php'>German</option>
            <option value='es/function.rnp-op-encrypt.php'>Spanish</option>
            <option value='fr/function.rnp-op-encrypt.php'>French</option>
            <option value='it/function.rnp-op-encrypt.php'>Italian</option>
            <option value='ja/function.rnp-op-encrypt.php'>Japanese</option>
            <option value='pt_BR/function.rnp-op-encrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-op-encrypt.php'>Russian</option>
            <option value='tr/function.rnp-op-encrypt.php'>Turkish</option>
            <option value='uk/function.rnp-op-encrypt.php'>Ukrainian</option>
            <option value='zh/function.rnp-op-encrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-op-encrypt" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-op-encrypt-returnvalues">
  ...
  <p class="para">
   Encrypted data on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-op-encrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-op-encrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-op-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-op-encrypt.php">＋<small>add a note</small></a></span>
