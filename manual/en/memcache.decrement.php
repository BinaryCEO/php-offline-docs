...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcache.decrement.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcache.decrement.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcache.decrement.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcache.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcache.connect.php">
 <link rel="next" href="https://www.php.net/manual/en/memcache.delete.php">
...
<meta name="Description" content="Decrement item's value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcache::decrement - Manual" />
<meta name="twitter:description" content="Decrement item's value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcache::decrement - Manual" />
<meta itemprop="description" content="Decrement item's value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrement item's value" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcache.decrement.php' selected="selected">English</option>
            ...
            <option value='ja/memcache.decrement.php'>Japanese</option>
 ...
 <div class="refsect1 examples" id="refsect1-memcache.decrement-examples">
  ...
  <p class="para">
   <div class="example" id="example-4655">
    <p><strong>Example #1 <span class="function"><strong>Memcache::decrement()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="memcache.replace.php" class="function" rel="rdfs-seeAlso">Memcache::replace()</a> - Replace value of the existing item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcache/memcache/decrement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcache.decrement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcache.decrement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.decrement.php">＋<small>add a note</small></a></span>
