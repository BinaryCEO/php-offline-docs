...
<head>
  ...
  <title>PHP: Gmagick::clear - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.clear.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.clear.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.clear.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.chopimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.commentimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.clear.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.clear.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.clear.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.clear.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.clear.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.clear.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.clear.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.clear.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.clear.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.clear.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.clear.php" hreflang="zh">
...
<meta name="Description" content="Clears all resources associated to Gmagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::clear - Manual" />
<meta name="twitter:description" content="Clears all resources associated to Gmagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::clear - Manual" />
<meta itemprop="description" content="Clears all resources associated to Gmagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clears all resources associated to Gmagick object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.commentimage.php">
          Gmagick::commentimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.chopimage.php">
          &laquo; Gmagick::chopimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.clear.php' selected="selected">English</option>
            <option value='de/gmagick.clear.php'>German</option>
            <option value='es/gmagick.clear.php'>Spanish</option>
            <option value='fr/gmagick.clear.php'>French</option>
            <option value='it/gmagick.clear.php'>Italian</option>
            <option value='ja/gmagick.clear.php'>Japanese</option>
            <option value='pt_BR/gmagick.clear.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.clear.php'>Russian</option>
            <option value='tr/gmagick.clear.php'>Turkish</option>
            <option value='uk/gmagick.clear.php'>Ukrainian</option>
            <option value='zh/gmagick.clear.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.clear" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::clear</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::clear</span> &mdash; <span class="dc-title">Clears all resources associated to Gmagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.clear-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::clear</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>

  <p class="para rdfs-comment">
  Clears all resources associated to <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.clear-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.clear-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    The cleared <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.clear-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.clear.php">＋<small>add a note</small></a></span>
