...
<head>
  ...
  <title>PHP: ZookeeperNoNodeException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeepernonodeexception.php">
 <link rel="shorturl" href="https://www.php.net/zookeepernonodeexception">
 <link rel="alternate" href="https://www.php.net/zookeepernonodeexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.zookeepermarshallingexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.zookeeperoperationtimeoutexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zookeepernonodeexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zookeepernonodeexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zookeepernonodeexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zookeepernonodeexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zookeepernonodeexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zookeepernonodeexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zookeepernonodeexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zookeepernonodeexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zookeepernonodeexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zookeepernonodeexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zookeepernonodeexception.php" hreflang="zh">
...
<meta name="Description" content="The ZookeeperNoNodeException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperNoNodeException - Manual" />
<meta name="twitter:description" content="The ZookeeperNoNodeException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperNoNodeException - Manual" />
<meta itemprop="description" content="The ZookeeperNoNodeException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZookeeperNoNodeException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.zookeeperoperationtimeoutexception.php">
          ZookeeperOperationTimeoutException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.zookeepermarshallingexception.php">
          &laquo; ZookeeperMarshallingException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeepernonodeexception.php' selected="selected">English</option>
            <option value='de/class.zookeepernonodeexception.php'>German</option>
            <option value='es/class.zookeepernonodeexception.php'>Spanish</option>
            <option value='fr/class.zookeepernonodeexception.php'>French</option>
            <option value='it/class.zookeepernonodeexception.php'>Italian</option>
            <option value='ja/class.zookeepernonodeexception.php'>Japanese</option>
            <option value='pt_BR/class.zookeepernonodeexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.zookeepernonodeexception.php'>Russian</option>
            <option value='tr/class.zookeepernonodeexception.php'>Turkish</option>
            <option value='uk/class.zookeepernonodeexception.php'>Ukrainian</option>
            <option value='zh/class.zookeepernonodeexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zookeepernonodeexception" class="reference">
 <h1 class="title">The ZookeeperNoNodeException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PECL zookeeper &gt;= 0.3.0)</p>
 

  <div class="section" id="zookeepernonodeexception.intro">
  ...
  <div class="section" id="zookeepernonodeexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">ZookeeperNoNodeException</strong>
     </span>
     <span class="ooclass">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeepernonodeexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeepernonodeexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeepernonodeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeepernonodeexception.php">＋<small>add a note</small></a></span>
