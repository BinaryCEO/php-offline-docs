 ...
 <p class="para">
  <dl>
     ...
     <dd><p class="para">A SQL query.</p></dd>
      ...
      <dd><p class="para">The CUBRID connection. If the connection identifier is not specified, the last connection opened by <span class="function"><a href="function.cubrid-connect.php" class="function">cubrid_connect()</a></span> is assumed.</p></dd>
