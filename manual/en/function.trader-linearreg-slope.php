...
<head>
  ...
  <title>PHP: trader_linearreg_slope - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-linearreg-slope.php">
 <link rel="shorturl" href="https://www.php.net/trader-linearreg-slope">
 <link rel="alternate" href="https://www.php.net/trader-linearreg-slope" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-linearreg-intercept.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-ln.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-linearreg-slope.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-linearreg-slope.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-linearreg-slope.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-linearreg-slope.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-linearreg-slope.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-linearreg-slope.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-linearreg-slope.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-linearreg-slope.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-linearreg-slope.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-linearreg-slope.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-linearreg-slope.php" hreflang="zh">
...
<meta name="Description" content="Linear Regression Slope" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_linearreg_slope - Manual" />
<meta name="twitter:description" content="Linear Regression Slope" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_linearreg_slope - Manual" />
<meta itemprop="description" content="Linear Regression Slope" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Linear Regression Slope" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-ln.php">
          trader_ln &raquo;
              ...
              <div class="prev">
        <a href="function.trader-linearreg-intercept.php">
          &laquo; trader_linearreg_intercept        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-linearreg-slope.php' selected="selected">English</option>
            <option value='de/function.trader-linearreg-slope.php'>German</option>
            <option value='es/function.trader-linearreg-slope.php'>Spanish</option>
            <option value='fr/function.trader-linearreg-slope.php'>French</option>
            <option value='it/function.trader-linearreg-slope.php'>Italian</option>
            <option value='ja/function.trader-linearreg-slope.php'>Japanese</option>
            <option value='pt_BR/function.trader-linearreg-slope.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-linearreg-slope.php'>Russian</option>
            <option value='tr/function.trader-linearreg-slope.php'>Turkish</option>
            <option value='uk/function.trader-linearreg-slope.php'>Ukrainian</option>
            <option value='zh/function.trader-linearreg-slope.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-linearreg-slope" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-linearreg-slope-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_linearreg_slope</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-linearreg-slope-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-linearreg-slope.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-linearreg-slope%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-linearreg-slope&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-linearreg-slope.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118790">  <div class="votes">
    <div id="Vu118790">
    <a href="/manual/vote-note.php?id=118790&amp;page=function.trader-linearreg-slope&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118790">
    <a href="/manual/vote-note.php?id=118790&amp;page=function.trader-linearreg-slope&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118790" title="72% like this...">
    11
    </div>
  </div>
  <a href="#118790" class="name">
  <strong class="user"><em>Angel J. Salinas</em></strong></a><a class="genanchor" href="#118790"> &para;</a><div class="date" title="2016-02-06 11:26"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118790">
<div class="phpcode"><code><span class="html">// If you don't have the php_trader library or needs more than 3 precision digits,<br />// you can use this function:<br />public static function linearreg_slope( $valuesIn, $period )<br />{<br />  $valuesOut = array();<br />  <br />  $startIdx = 0;<br />  $endIdx = count($valuesIn) - 1;<br />  <br />  $sumX = $period * ( $period - 1 ) * 0.5;<br />  $sumXSqr = $period * ( $period - 1 ) * ( 2 * $period - 1 ) / 6;<br />  $divisor = $sumX * $sumX - $period * $sumXSqr;<br />  <br />  for ( $today = $startIdx, $outIdx = 0; $today &lt;= $endIdx; $today++, $outIdx++ )<br />  {<br />    $sumXY = 0;<br />    $sumY = 0;<br />    if ( $today &gt;= $period - 1 ) {<br />      for( $aux = $period; $aux-- != 0; )<br />      {<br />        $sumY += $tempValue = $valuesIn[$today - $aux];<br />        $sumXY += (double)$aux * $tempValue;<br />      }<br />      $valuesOut[$outIdx] = ( $period * $sumXY - $sumX * $sumY) / $divisor;<br />    }<br />  }<br />  <br />  return $valuesOut;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="123762">  <div class="votes">
    <div id="Vu123762">
    <a href="/manual/vote-note.php?id=123762&amp;page=function.trader-linearreg-slope&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123762">
    <a href="/manual/vote-note.php?id=123762&amp;page=function.trader-linearreg-slope&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123762" title="71% like this...">
    3
    </div>
  </div>
  <a href="#123762" class="name">
  <strong class="user"><em>Angel J. Salinas</em></strong></a><a class="genanchor" href="#123762"> &para;</a><div class="date" title="2019-04-09 10:30"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123762">
<div class="phpcode"><code><span class="html">Default value of precision in trader library is 3, but can be increased easily with something like this:<br /><br />ini_set( 'trader.real_precision', '6' );</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-linearreg-slope&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-linearreg-slope.php">＋<small>add a note</small></a></div>
