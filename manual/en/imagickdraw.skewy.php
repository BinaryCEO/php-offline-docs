...
<head>
  ...
  <title>PHP: ImagickDraw::skewY - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.skewy.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.skewy.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.skewy.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.skewx.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.translate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.skewy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.skewy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.skewy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.skewy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.skewy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.skewy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.skewy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.skewy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.skewy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.skewy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.skewy.php" hreflang="zh">
...
<meta name="Description" content="Skews the current coordinate system in the vertical direction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::skewY - Manual" />
<meta name="twitter:description" content="Skews the current coordinate system in the vertical direction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::skewY - Manual" />
<meta itemprop="description" content="Skews the current coordinate system in the vertical direction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Skews the current coordinate system in the vertical direction" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.translate.php">
          ImagickDraw::translate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.skewx.php">
          &laquo; ImagickDraw::skewX        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.skewy.php' selected="selected">English</option>
            <option value='de/imagickdraw.skewy.php'>German</option>
            <option value='es/imagickdraw.skewy.php'>Spanish</option>
            <option value='fr/imagickdraw.skewy.php'>French</option>
            <option value='it/imagickdraw.skewy.php'>Italian</option>
            <option value='ja/imagickdraw.skewy.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.skewy.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.skewy.php'>Russian</option>
            <option value='tr/imagickdraw.skewy.php'>Turkish</option>
            <option value='uk/imagickdraw.skewy.php'>Ukrainian</option>
            <option value='zh/imagickdraw.skewy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.skewy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::skewY</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::skewY</span> &mdash; <span class="dc-title">Skews the current coordinate system in the vertical direction</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.skewy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::skewY</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.skewy-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.skewy-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.skewy-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3198">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::skewY()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/skewy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.skewy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.skewy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.skewy.php">＋<small>add a note</small></a></span>
