...
<head>
  ...
  <title>PHP: fdf_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-open.php">
 <link rel="shorturl" href="https://www.php.net/fdf-open">
 <link rel="alternate" href="https://www.php.net/fdf-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-next-field-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-open-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-open.php" hreflang="zh">
...
<meta name="Description" content="Open a FDF document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_open - Manual" />
<meta name="twitter:description" content="Open a FDF document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_open - Manual" />
<meta itemprop="description" content="Open a FDF document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a FDF document" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fdf-open-string.php">
          fdf_open_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fdf-next-field-name.php">
          &laquo; fdf_next_field_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-open.php' selected="selected">English</option>
            <option value='de/function.fdf-open.php'>German</option>
            <option value='es/function.fdf-open.php'>Spanish</option>
            <option value='fr/function.fdf-open.php'>French</option>
            <option value='it/function.fdf-open.php'>Italian</option>
            <option value='ja/function.fdf-open.php'>Japanese</option>
            <option value='pt_BR/function.fdf-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-open.php'>Russian</option>
            <option value='tr/function.fdf-open.php'>Turkish</option>
            <option value='uk/function.fdf-open.php'>Ukrainian</option>
            <option value='zh/function.fdf-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_open</h1>
  <p class="verinfo">(PHP 4, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_open</span> &mdash; <span class="dc-title">Open a FDF document</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-open-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fdf_open</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   Opens a file with form data. 
  </p>
  <p class="para">
   You can also use <span class="function"><a href="function.fdf-open-string.php" class="function">fdf_open_string()</a></span> to process the
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       a PDF form or created using <span class="function"><a href="function.fdf-create.php" class="function">fdf_create()</a></span> and
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Save the FDF data into a temp file<br /></span><span style="color: #0000BB">$fdffp </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">"test.fdf"</span><span style="color: #007700">, </span><span style="color: #DD0000">"w"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdffp</span><span style="color: #007700">, </span><span style="color: #0000BB">$HTTP_FDF_DATA</span><span style="color: #007700">, </span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$HTTP_FDF_DATA</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdffp</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Open temp file and evaluate data<br /></span><span style="color: #0000BB">$fdf </span><span style="color: #007700">= </span><span style="color: #0000BB">fdf_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"test.fdf"</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">/* ... */<br /></span><span style="color: #0000BB">fdf_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-open-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-open-string.php" class="function" rel="rdfs-seeAlso">fdf_open_string()</a> - Read a FDF document from a string</span></li>
    ...
    <li><span class="function"><a href="function.fdf-save.php" class="function" rel="rdfs-seeAlso">fdf_save()</a> - Save a FDF document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-open.php">＋<small>add a note</small></a></span>
