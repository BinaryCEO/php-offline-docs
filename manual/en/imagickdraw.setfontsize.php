...
<head>
  ...
  <title>PHP: ImagickDraw::setFontSize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfontfamily.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfontstretch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfontsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfontsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfontsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfontsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfontsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfontsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfontsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfontsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfontsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfontsize.php" hreflang="zh">
...
<meta name="Description" content="Sets the font pointsize to use when annotating with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFontSize - Manual" />
<meta name="twitter:description" content="Sets the font pointsize to use when annotating with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFontSize - Manual" />
<meta itemprop="description" content="Sets the font pointsize to use when annotating with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the font pointsize to use when annotating with text" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setfontstretch.php">
          ImagickDraw::setFontStretch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfontfamily.php">
          &laquo; ImagickDraw::setFontFamily        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfontsize.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfontsize.php'>German</option>
            <option value='es/imagickdraw.setfontsize.php'>Spanish</option>
            <option value='fr/imagickdraw.setfontsize.php'>French</option>
            <option value='it/imagickdraw.setfontsize.php'>Italian</option>
            <option value='ja/imagickdraw.setfontsize.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfontsize.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfontsize.php'>Russian</option>
            <option value='tr/imagickdraw.setfontsize.php'>Turkish</option>
            <option value='uk/imagickdraw.setfontsize.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfontsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfontsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFontSize</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFontSize</span> &mdash; <span class="dc-title">Sets the font pointsize to use when annotating with text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfontsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFontSize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$point_size</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfontsize-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">point_size</code></dt>
     <dd>
      <p class="para">
       the point size
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfontsize-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3176">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfontsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfontsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfontsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontsize.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92670">  <div class="votes">
    <div id="Vu92670">
    <a href="/manual/vote-note.php?id=92670&amp;page=imagickdraw.setfontsize&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92670">
    <a href="/manual/vote-note.php?id=92670&amp;page=imagickdraw.setfontsize&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92670" title="87% like this...">
    6
    </div>
  </div>
  <a href="#92670" class="name">
  <strong class="user"><em>hmkrox at gmail dot com</em></strong></a><a class="genanchor" href="#92670"> &para;</a><div class="date" title="2009-08-03 07:10"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92670">
<div class="phpcode"><code><span class="html">The font size taken in parameter is not the size in point (1 point = 1/72 inch) but the font's height in pixel. <br />Therefore you should do a conversion to have the correct font size if you want to modify a document destined to print.<br />For example, if your document's resolution is 300ppi, you should add a 25/6 multiplying factor to your fontsize in order to have a correct behaviour of the font.</span></code></div>
  </div>
 </div>
  <div class="note" id="92241">  <div class="votes">
    <div id="Vu92241">
    <a href="/manual/vote-note.php?id=92241&amp;page=imagickdraw.setfontsize&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92241">
    <a href="/manual/vote-note.php?id=92241&amp;page=imagickdraw.setfontsize&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92241" title="0% like this...">
    -4
    </div>
  </div>
  <a href="#92241" class="name">
  <strong class="user"><em>jgsujith at in dot com</em></strong></a><a class="genanchor" href="#92241"> &para;</a><div class="date" title="2009-07-15 06:23"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92241">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php
<br />$sourceFile</span><span class="keyword">=</span><span class="string">'in.jpg'</span><span class="keyword">;
<br /></span><span class="default">$textWrite</span><span class="keyword">=</span><span class="string">'God is Great'</span><span class="keyword">;
<br /></span><span class="default">$x</span><span class="keyword">=</span><span class="default">50</span><span class="keyword">;
<br /></span><span class="default">$y</span><span class="keyword">=</span><span class="default">50</span><span class="keyword">;    
<br /></span><span class="default">$fontColor</span><span class="keyword">=</span><span class="string">'#000000'</span><span class="keyword">;
<br /></span><span class="default">$fontSize</span><span class="keyword">=</span><span class="default">34</span><span class="keyword">;
<br />  
<br /></span><span class="default">$colorPix</span><span class="keyword">=new </span><span class="default">ImagickPixel </span><span class="keyword">(</span><span class="default">$fontColor</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">=new </span><span class="default">Imagick </span><span class="keyword">(</span><span class="default">$sourceFile</span><span class="keyword">);
<br /></span><span class="default">$draw</span><span class="keyword">=new </span><span class="default">ImagickDraw</span><span class="keyword">();
<br />        
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFontSize</span><span class="keyword">(</span><span class="default">$fontSize</span><span class="keyword">);</span><span class="comment">//Sets the font pointsize to use when annotating with text
<br />
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$colorPix</span><span class="keyword">);</span><span class="comment">//Sets the fill color to be used for drawing filled objects
<br />            
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">annotateImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">,</span><span class="default">$x</span><span class="keyword">,</span><span class="default">$y</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$textWrite</span><span class="keyword">);</span><span class="comment">//Annotates an image with text
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'out.jpg'</span><span class="keyword">);</span><span class="comment">//Writes an image to the specified filename
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setfontsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontsize.php">＋<small>add a note</small></a></div>
