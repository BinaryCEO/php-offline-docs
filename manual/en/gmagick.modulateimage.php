...
<head>
  ...
  <title>PHP: Gmagick::modulateimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.modulateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.modulateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.modulateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.minifyimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.motionblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.modulateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.modulateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.modulateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.modulateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.modulateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.modulateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.modulateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.modulateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.modulateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.modulateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.modulateimage.php" hreflang="zh">
...
<meta name="Description" content="Control the brightness, saturation, and hue" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::modulateimage - Manual" />
<meta name="twitter:description" content="Control the brightness, saturation, and hue" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::modulateimage - Manual" />
<meta itemprop="description" content="Control the brightness, saturation, and hue" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Control the brightness, saturation, and hue" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.motionblurimage.php">
          Gmagick::motionblurimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.minifyimage.php">
          &laquo; Gmagick::minifyimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.modulateimage.php' selected="selected">English</option>
            <option value='de/gmagick.modulateimage.php'>German</option>
            <option value='es/gmagick.modulateimage.php'>Spanish</option>
            <option value='fr/gmagick.modulateimage.php'>French</option>
            <option value='it/gmagick.modulateimage.php'>Italian</option>
            <option value='ja/gmagick.modulateimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.modulateimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.modulateimage.php'>Russian</option>
            <option value='tr/gmagick.modulateimage.php'>Turkish</option>
            <option value='uk/gmagick.modulateimage.php'>Ukrainian</option>
            <option value='zh/gmagick.modulateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.modulateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::modulateimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::modulateimage</span> &mdash; <span class="dc-title">Control the brightness, saturation, and hue</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.modulateimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::modulateimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$brightness</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$saturation</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$hue</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.modulateimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.modulateimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.modulateimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/modulateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.modulateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.modulateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.modulateimage.php">＋<small>add a note</small></a></span>
