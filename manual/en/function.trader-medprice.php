...
<head>
  ...
  <title>PHP: trader_medprice - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-medprice.php">
 <link rel="shorturl" href="https://www.php.net/trader-medprice">
 <link rel="alternate" href="https://www.php.net/trader-medprice" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-maxindex.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-mfi.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-medprice.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-medprice.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-medprice.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-medprice.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-medprice.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-medprice.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-medprice.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-medprice.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-medprice.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-medprice.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-medprice.php" hreflang="zh">
...
<meta name="Description" content="Median Price" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_medprice - Manual" />
<meta name="twitter:description" content="Median Price" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_medprice - Manual" />
<meta itemprop="description" content="Median Price" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Median Price" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-mfi.php">
          trader_mfi &raquo;
              ...
              <div class="prev">
        <a href="function.trader-maxindex.php">
          &laquo; trader_maxindex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-medprice.php' selected="selected">English</option>
            <option value='de/function.trader-medprice.php'>German</option>
            <option value='es/function.trader-medprice.php'>Spanish</option>
            <option value='fr/function.trader-medprice.php'>French</option>
            <option value='it/function.trader-medprice.php'>Italian</option>
            <option value='ja/function.trader-medprice.php'>Japanese</option>
            <option value='pt_BR/function.trader-medprice.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-medprice.php'>Russian</option>
            <option value='tr/function.trader-medprice.php'>Turkish</option>
            <option value='uk/function.trader-medprice.php'>Ukrainian</option>
            <option value='zh/function.trader-medprice.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-medprice" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_medprice</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_medprice</span> &mdash; <span class="dc-title">Median Price</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-medprice-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_medprice</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-medprice-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-medprice-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-medprice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-medprice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-medprice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-medprice.php">＋<small>add a note</small></a></span>
