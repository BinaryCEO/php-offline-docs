...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration83.new-features.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration83.new-features.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration83.new-features.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration83.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration83.php">
 <link rel="next" href="https://www.php.net/manual/en/migration83.new-classes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration83.new-features.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration83.new-features.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration83.new-features.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration83.new-features.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration83.new-features.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration83.new-features.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration83.new-features.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration83.new-features.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration83.new-features.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration83.new-features.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration83.new-features.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="migration83.new-classes.php">
          New Classes and Interfaces &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration83.php">
          &laquo; Migrating from PHP 8.2.x to PHP 8.3.x        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration83.new-features.php' selected="selected">English</option>
            <option value='de/migration83.new-features.php'>German</option>
            <option value='es/migration83.new-features.php'>Spanish</option>
            <option value='fr/migration83.new-features.php'>French</option>
            <option value='it/migration83.new-features.php'>Italian</option>
            <option value='ja/migration83.new-features.php'>Japanese</option>
            <option value='pt_BR/migration83.new-features.php'>Brazilian Portuguese</option>
            <option value='ru/migration83.new-features.php'>Russian</option>
            <option value='tr/migration83.new-features.php'>Turkish</option>
            <option value='uk/migration83.new-features.php'>Ukrainian</option>
            <option value='zh/migration83.new-features.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration83.new-features" class="sect1">
  ...
  <p class="para">
   ...
   notification. This was previously not implemented.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration83/new-features.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration83.new-features%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration83.new-features&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration83.new-features.php">＋<small>add a note</small></a></span>
