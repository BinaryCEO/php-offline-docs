...
<head>
  ...
  <title>PHP: ocicancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicancel.php">
 <link rel="shorturl" href="https://www.php.net/ocicancel">
 <link rel="alternate" href="https://www.php.net/ocicancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocibindbyname.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicloselob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicancel.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_cancel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicancel - Manual" />
<meta name="twitter:description" content="Alias of oci_cancel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicancel - Manual" />
<meta itemprop="description" content="Alias of oci_cancel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_cancel" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicancel.php' selected="selected">English</option>
            <option value='de/function.ocicancel.php'>German</option>
            <option value='es/function.ocicancel.php'>Spanish</option>
            <option value='fr/function.ocicancel.php'>French</option>
            <option value='it/function.ocicancel.php'>Italian</option>
            <option value='ja/function.ocicancel.php'>Japanese</option>
            <option value='pt_BR/function.ocicancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicancel.php'>Russian</option>
            <option value='tr/function.ocicancel.php'>Turkish</option>
            <option value='uk/function.ocicancel.php'>Ukrainian</option>
            <option value='zh/function.ocicancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicancel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicancel</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicancel</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-cancel.php" class="function">oci_cancel()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicancel-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-cancel.php" class="function">oci_cancel()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicancel.php">＋<small>add a note</small></a></span>
