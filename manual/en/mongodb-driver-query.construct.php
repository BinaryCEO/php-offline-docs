...
<head>
  ...
  <title>PHP: MongoDB\Driver\Query::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-query.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-query.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-query.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-query.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-query.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwrite.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-query.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-query.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-query.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-query.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-query.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-query.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-query.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-query.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-query.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-query.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-query.construct.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: MongoDB\Driver\Query::__construct - Manual" />
<meta name="twitter:description" content="Create a new Query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Query::__construct - Manual" />
<meta itemprop="description" content="Create a new Query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new Query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mongodb-driver-bulkwrite.php">
          MongoDB\Driver\BulkWrite &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mongodb-driver-query.php">
          &laquo; MongoDB\Driver\Query        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.vendors.php'>Vendor Specific Database Extensions</a></li>      <li><a href='book.mongodb.php'>MongoDB</a></li>      <li><a href='mongodb.mongodb.php'>MongoDB\Driver</a></li>      <li><a href='class.mongodb-driver-query.php'>MongoDB\Driver\Query</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-query.construct.php' selected="selected">English</option>
            <option value='de/mongodb-driver-query.construct.php'>German</option>
            <option value='es/mongodb-driver-query.construct.php'>Spanish</option>
            <option value='fr/mongodb-driver-query.construct.php'>French</option>
            <option value='it/mongodb-driver-query.construct.php'>Italian</option>
            <option value='ja/mongodb-driver-query.construct.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-query.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-query.construct.php'>Russian</option>
            <option value='tr/mongodb-driver-query.construct.php'>Turkish</option>
            <option value='uk/mongodb-driver-query.construct.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-query.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-query.construct" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Select only documents authord by "bjori" with at least 100 views */<br /></span><span style="color: #0000BB">$filter </span><span style="color: #007700">= [<br />    </span><span style="color: #DD0000">'author' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'bjori'</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">'views' </span><span style="color: #007700">=&gt; [<br />        </span><span style="color: #DD0000">'$gte' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">100</span><span style="color: #007700">,<br />    ],<br />];<br /><br /></span><span style="color: #0000BB">$options </span><span style="color: #007700">= [<br />    </span><span style="color: #FF8000">/* Only return the following fields in the matching documents */<br />    </span><span style="color: #DD0000">'projection' </span><span style="color: #007700">=&gt; [<br />        </span><span style="color: #DD0000">'title' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'article' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">,<br />    ],<br />    </span><span style="color: #FF8000">/* Return the documents in descending order of views */<br />    </span><span style="color: #DD0000">'sort' </span><span style="color: #007700">=&gt; [<br />        </span><span style="color: #DD0000">'views' </span><span style="color: #007700">=&gt; -</span><span style="color: #0000BB">1<br />    </span><span style="color: #007700">],<br />];<br /><br /></span><span style="color: #0000BB">$query </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Query</span><span style="color: #007700">(</span><span style="color: #0000BB">$filter</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$manager </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Manager</span><span style="color: #007700">(</span><span style="color: #DD0000">'mongodb://localhost:27017'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$readPreference </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\ReadPreference</span><span style="color: #007700">(</span><span style="color: #0000BB">MongoDB\Driver\ReadPreference</span><span style="color: #007700">::</span><span style="color: #0000BB">PRIMARY</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$cursor </span><span style="color: #007700">= </span><span style="color: #0000BB">$manager</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">executeQuery</span><span style="color: #007700">(</span><span style="color: #DD0000">'databaseName.collectionName'</span><span style="color: #007700">, </span><span style="color: #0000BB">$query</span><span style="color: #007700">, [</span><span style="color: #DD0000">'readPreference' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$readPreference</span><span style="color: #007700">]);<br /><br />foreach(</span><span style="color: #0000BB">$cursor </span><span style="color: #007700">as </span><span style="color: #0000BB">$document</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$document</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-cursor.php" class="classname">MongoDB\Driver\Cursor</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/query/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-query.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-query.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-query.construct.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="class.mongodb-driver-query.php">MongoDB\Driver\Query</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="mongodb-driver-query.construct.php" title="_&#8203;_&#8203;construct">_&#8203;_&#8203;construct</a>
                        </li>
