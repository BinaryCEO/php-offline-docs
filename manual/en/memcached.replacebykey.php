...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.replacebykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.replacebykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.replacebykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.replace.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.resetserverlist.php">
...
<meta name="Description" content="Replace the item under an existing key on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::replaceByKey - Manual" />
<meta name="twitter:description" content="Replace the item under an existing key on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::replaceByKey - Manual" />
<meta itemprop="description" content="Replace the item under an existing key on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace the item under an existing key on a specific server" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.replacebykey.php' selected="selected">English</option>
            <option value='de/memcached.replacebykey.php'>German</option>
            <option value='es/memcached.replacebykey.php'>Spanish</option>
            <option value='fr/memcached.replacebykey.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::replaceByKey</span> &mdash; <span class="dc-title">Replace the item under an existing key on a specific server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.replacebykey-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::replaceByKey()</strong></span> is functionally equivalent to
   <span class="methodname"><a href="memcached.replace.php" class="methodname">Memcached::replace()</a></span>, except that the free-form
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.add.php" class="methodname" rel="rdfs-seeAlso">Memcached::add()</a> - Add an item under a new key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/replacebykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.replacebykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.replacebykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.replacebykey.php">＋<small>add a note</small></a></span>
