...
<head>
  ...
  <title>PHP: Imagick::oilPaintImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.oilpaintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.oilpaintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.oilpaintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.normalizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.oilpaintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.oilpaintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.oilpaintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.oilpaintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.oilpaintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.oilpaintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.oilpaintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.oilpaintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.oilpaintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.oilpaintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.oilpaintimage.php" hreflang="zh">
...
<meta name="Description" content="Simulates an oil painting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::oilPaintImage - Manual" />
<meta name="twitter:description" content="Simulates an oil painting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::oilPaintImage - Manual" />
<meta itemprop="description" content="Simulates an oil painting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Simulates an oil painting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.opaquepaintimage.php">
          Imagick::opaquePaintImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.normalizeimage.php">
          &laquo; Imagick::normalizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.oilpaintimage.php' selected="selected">English</option>
            <option value='de/imagick.oilpaintimage.php'>German</option>
            <option value='es/imagick.oilpaintimage.php'>Spanish</option>
            <option value='fr/imagick.oilpaintimage.php'>French</option>
            <option value='it/imagick.oilpaintimage.php'>Italian</option>
            <option value='ja/imagick.oilpaintimage.php'>Japanese</option>
            <option value='pt_BR/imagick.oilpaintimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.oilpaintimage.php'>Russian</option>
            <option value='tr/imagick.oilpaintimage.php'>Turkish</option>
            <option value='uk/imagick.oilpaintimage.php'>Ukrainian</option>
            <option value='zh/imagick.oilpaintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.oilpaintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::oilPaintImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::oilPaintImage</span> &mdash; <span class="dc-title">Simulates an oil painting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.oilpaintimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::oilPaintImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.oilpaintimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.oilpaintimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.oilpaintimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3061">
      <p><strong>Example #1  <span class="function"><strong>Imagick::oilPaintImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/oilpaintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.oilpaintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.oilpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.oilpaintimage.php">＋<small>add a note</small></a></span>
