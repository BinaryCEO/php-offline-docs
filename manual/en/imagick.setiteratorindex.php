...
<head>
  ...
  <title>PHP: Imagick::setIteratorIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setiteratorindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setiteratorindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setiteratorindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setlastiterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setiteratorindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setiteratorindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setiteratorindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setiteratorindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setiteratorindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setiteratorindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setiteratorindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setiteratorindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setiteratorindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setiteratorindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setiteratorindex.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setIteratorIndex - Manual" />
<meta name="twitter:description" content="Set the iterator position" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setIteratorIndex - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setlastiterator.php">
          Imagick::setLastIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setinterlacescheme.php">
          &laquo; Imagick::setInterlaceScheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setiteratorindex.php' selected="selected">English</option>
            <option value='de/imagick.setiteratorindex.php'>German</option>
            <option value='es/imagick.setiteratorindex.php'>Spanish</option>
            <option value='fr/imagick.setiteratorindex.php'>French</option>
            <option value='it/imagick.setiteratorindex.php'>Italian</option>
            <option value='ja/imagick.setiteratorindex.php'>Japanese</option>
            <option value='pt_BR/imagick.setiteratorindex.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setiteratorindex.php'>Russian</option>
            <option value='tr/imagick.setiteratorindex.php'>Turkish</option>
            <option value='uk/imagick.setiteratorindex.php'>Ukrainian</option>
            <option value='zh/imagick.setiteratorindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setiteratorindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setIteratorIndex</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setIteratorIndex</span> &mdash; <span class="dc-title">Set the iterator position</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.setiteratorindex-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setIteratorIndex</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"red"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"green"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"blue"</span><span style="color: #007700">));<br /><br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setIteratorIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getIteratorIndex</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setiteratorindex-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.getiteratorindex.php" class="function" rel="rdfs-seeAlso">Imagick::getIteratorIndex()</a> - Gets the index of the current active image</span></li>
    ...
    <li><span class="function"><a href="imagick.setimageindex.php" class="function" rel="rdfs-seeAlso">Imagick::setImageIndex()</a> - Set the iterator position</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setiteratorindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setiteratorindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setiteratorindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setiteratorindex.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102911">  <div class="votes">
    <div id="Vu102911">
    <a href="/manual/vote-note.php?id=102911&amp;page=imagick.setiteratorindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102911">
    <a href="/manual/vote-note.php?id=102911&amp;page=imagick.setiteratorindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102911" title="66% like this...">
    1
    </div>
  </div>
  <a href="#102911" class="name">
  <strong class="user"><em>wilcobeekhuizen at gmail dot com</em></strong></a><a class="genanchor" href="#102911"> &para;</a><div class="date" title="2011-03-14 10:06"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102911">
<div class="phpcode"><code><span class="html">This function returns true on success but setting the iterator to an invalid index throws an exception instead of returning false:
<br />Fatal error: Uncaught exception 'ImagickException' with message 'Unable to set iterator index'
<br />
<br />This can happen when counting images inside a gif file, because the iterator count starts at zero and not one. If you count the number of images in a gif file be sure to use iterator 0 for the first image, like this:
<br />
<br /><span class="default">&lt;?php
<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'simple.gif'</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setIteratorIndex</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setiteratorindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setiteratorindex.php">＋<small>add a note</small></a></div>
