...
<head>
  ...
  <title>PHP: ibase_blob_cancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-cancel.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-cancel">
 <link rel="alternate" href="https://www.php.net/ibase-blob-cancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-cancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-cancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-cancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-cancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-cancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-cancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-cancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-cancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-cancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-cancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-cancel.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ibase_blob_cancel - Manual" />
<meta name="twitter:description" content="Cancel creating blob" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_cancel - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-blob-close.php">
          ibase_blob_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-add.php">
          &laquo; ibase_blob_add        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-cancel.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-cancel.php'>German</option>
            <option value='es/function.ibase-blob-cancel.php'>Spanish</option>
            <option value='fr/function.ibase-blob-cancel.php'>French</option>
            <option value='it/function.ibase-blob-cancel.php'>Italian</option>
            <option value='ja/function.ibase-blob-cancel.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-cancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-cancel.php'>Russian</option>
            <option value='tr/function.ibase-blob-cancel.php'>Turkish</option>
            <option value='uk/function.ibase-blob-cancel.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-cancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-cancel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_blob_cancel</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_cancel</span> &mdash; <span class="dc-title">Cancel creating blob</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-blob-cancel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_blob_cancel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$blob_handle</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-cancel-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-cancel-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-blob-cancel-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-import.php" class="function" rel="rdfs-seeAlso">ibase_blob_import()</a> - Create blob, copy file in it, and close it</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-cancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-cancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-cancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-cancel.php">＋<small>add a note</small></a></span>
