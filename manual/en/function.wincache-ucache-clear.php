...
<head>
  ...
  <title>PHP: wincache_ucache_clear - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-clear.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-clear">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-clear" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-cas.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-dec.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-clear.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-clear.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-clear.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-clear.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-clear.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-clear.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-clear.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-clear.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-clear.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-clear.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-clear.php" hreflang="zh">
...
<meta name="Description" content="Deletes entire content of the user cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_clear - Manual" />
<meta name="twitter:description" content="Deletes entire content of the user cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_clear - Manual" />
<meta itemprop="description" content="Deletes entire content of the user cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes entire content of the user cache" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-ucache-dec.php">
          wincache_ucache_dec &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-cas.php">
          &laquo; wincache_ucache_cas        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-clear.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-clear.php'>German</option>
            <option value='es/function.wincache-ucache-clear.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-clear.php'>French</option>
            <option value='it/function.wincache-ucache-clear.php'>Italian</option>
            <option value='ja/function.wincache-ucache-clear.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-clear.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-clear.php'>Russian</option>
            <option value='tr/function.wincache-ucache-clear.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-clear.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-clear.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-clear" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">wincache_ucache_clear</h1>
  <p class="verinfo">(PECL wincache &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">wincache_ucache_clear</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.wincache-ucache-clear-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>wincache_ucache_clear</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.wincache-ucache-clear-parameters">
...
<div class="examplescode"><pre class="examplescode">array(5) { [&quot;green&quot;]=&gt; int(1) 
           [&quot;red&quot;]=&gt; int(2) 
           [&quot;orange&quot;]=&gt; int(4) 
           [&quot;blue&quot;]=&gt; int(8) 
           [&quot;cyan&quot;]=&gt; int(16) } 
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-ucache-info.php" class="function" rel="rdfs-seeAlso">wincache_ucache_info()</a> - Retrieves information about data stored in the user cache</span></li>    
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-clear.php">＋<small>add a note</small></a></span>
