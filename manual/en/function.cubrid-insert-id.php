...
<head>
  ...
  <title>PHP: cubrid_insert_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-insert-id.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-insert-id">
 <link rel="alternate" href="https://www.php.net/cubrid-insert-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-server-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-is-instance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-insert-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-insert-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-insert-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-insert-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-insert-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-insert-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-insert-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-insert-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-insert-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-insert-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-insert-id.php" hreflang="zh">
...
<meta name="Description" content="Return the ID generated for the last updated AUTO_INCREMENT column" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_insert_id - Manual" />
<meta name="twitter:description" content="Return the ID generated for the last updated AUTO_INCREMENT column" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_insert_id - Manual" />
<meta itemprop="description" content="Return the ID generated for the last updated AUTO_INCREMENT column" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the ID generated for the last updated AUTO_INCREMENT column" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-is-instance.php">
          cubrid_is_instance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-server-info.php">
          &laquo; cubrid_get_server_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-insert-id.php' selected="selected">English</option>
            <option value='de/function.cubrid-insert-id.php'>German</option>
            <option value='es/function.cubrid-insert-id.php'>Spanish</option>
            <option value='fr/function.cubrid-insert-id.php'>French</option>
            <option value='it/function.cubrid-insert-id.php'>Italian</option>
            <option value='ja/function.cubrid-insert-id.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-insert-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-insert-id.php'>Russian</option>
            <option value='tr/function.cubrid-insert-id.php'>Turkish</option>
            <option value='uk/function.cubrid-insert-id.php'>Ukrainian</option>
            <option value='zh/function.cubrid-insert-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-insert-id" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-insert-id-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_insert_id</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
<div class="examplescode"><pre class="examplescode">string(2) &quot;19&quot;</pre>
</div>
    </div>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-insert-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-insert-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-insert-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-insert-id.php">＋<small>add a note</small></a></span>
