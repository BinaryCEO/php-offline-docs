...
<head>
  ...
  <title>PHP: odbc_errormsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-errormsg.php">
 <link rel="shorturl" href="https://www.php.net/odbc-errormsg">
 <link rel="alternate" href="https://www.php.net/odbc-errormsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-exec.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-errormsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-errormsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-errormsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-errormsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-errormsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-errormsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-errormsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-errormsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-errormsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-errormsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-errormsg.php" hreflang="zh">
...
<meta name="Description" content="Get the last error message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_errormsg - Manual" />
<meta name="twitter:description" content="Get the last error message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_errormsg - Manual" />
<meta itemprop="description" content="Get the last error message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the last error message" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-errormsg.php' selected="selected">English</option>
            <option value='de/function.odbc-errormsg.php'>German</option>
            <option value='es/function.odbc-errormsg.php'>Spanish</option>
            <option value='fr/function.odbc-errormsg.php'>French</option>
            <option value='it/function.odbc-errormsg.php'>Italian</option>
            <option value='ja/function.odbc-errormsg.php'>Japanese</option>
            <option value='pt_BR/function.odbc-errormsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-errormsg.php'>Russian</option>
            <option value='tr/function.odbc-errormsg.php'>Turkish</option>
            <option value='uk/function.odbc-errormsg.php'>Ukrainian</option>
            <option value='zh/function.odbc-errormsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-errormsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_errormsg</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_errormsg</span> &mdash; <span class="dc-title">Get the last error message</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-errormsg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_errormsg</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type">Odbc\Connection</span></span> <code class="parameter">$odbc</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.odbc-errormsg-parameters">
...
see <span class="function"><a href="function.odbc-connect.php" class="function">odbc_connect()</a></span> for details.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-errormsg-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.odbc-errormsg-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.odbc-errormsg-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.odbc-error.php" class="function" rel="rdfs-seeAlso">odbc_error()</a> - Get the last error code</span></li>
    <li><span class="function"><a href="function.odbc-exec.php" class="function" rel="rdfs-seeAlso">odbc_exec()</a> - Directly execute an SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-errormsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-errormsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-errormsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-errormsg.php">＋<small>add a note</small></a></span>
