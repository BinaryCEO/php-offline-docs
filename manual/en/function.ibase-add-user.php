...
<head>
  ...
  <title>PHP: ibase_add_user - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-add-user.php">
 <link rel="shorturl" href="https://www.php.net/ibase-add-user">
 <link rel="alternate" href="https://www.php.net/ibase-add-user" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-wait-event.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-affected-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-add-user.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-add-user.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-add-user.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-add-user.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-add-user.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-add-user.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-add-user.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-add-user.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-add-user.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-add-user.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-add-user.php" hreflang="zh">
...
<meta name="Description" content="Add a user to a security database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_add_user - Manual" />
<meta name="twitter:description" content="Add a user to a security database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_add_user - Manual" />
<meta itemprop="description" content="Add a user to a security database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a user to a security database" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-affected-rows.php">
          ibase_affected_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-wait-event.php">
          &laquo; fbird_wait_event        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-add-user.php' selected="selected">English</option>
            <option value='de/function.ibase-add-user.php'>German</option>
            <option value='es/function.ibase-add-user.php'>Spanish</option>
            <option value='fr/function.ibase-add-user.php'>French</option>
            <option value='it/function.ibase-add-user.php'>Italian</option>
            <option value='ja/function.ibase-add-user.php'>Japanese</option>
            <option value='pt_BR/function.ibase-add-user.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-add-user.php'>Russian</option>
            <option value='tr/function.ibase-add-user.php'>Turkish</option>
            <option value='uk/function.ibase-add-user.php'>Ukrainian</option>
            <option value='zh/function.ibase-add-user.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-add-user" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_add_user</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_add_user</span> &mdash; <span class="dc-title">Add a user to a security database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-add-user-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_add_user</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$user_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$password</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$first_name</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$middle_name</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$last_name</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

 </div>

 
 <div class="refsect1 parameters" id="refsect1-function.ibase-add-user-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-add-user-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-add-user-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-modify-user.php" class="function" rel="rdfs-seeAlso">ibase_modify_user()</a> - Modify a user to a security database</span></li>
    <li><span class="function"><a href="function.ibase-delete-user.php" class="function" rel="rdfs-seeAlso">ibase_delete_user()</a> - Delete a user from a security database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-add-user.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-add-user%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-add-user&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-add-user.php">＋<small>add a note</small></a></span>
