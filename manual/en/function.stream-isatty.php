...
<head>
  ...
  <title>PHP: stream_isatty - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-isatty.php">
 <link rel="shorturl" href="https://www.php.net/stream-isatty">
 <link rel="alternate" href="https://www.php.net/stream-isatty" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-is-local.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-notification-callback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-isatty.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-isatty.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-isatty.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-isatty.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-isatty.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-isatty.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-isatty.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-isatty.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-isatty.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-isatty.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-isatty.php" hreflang="zh">
...
<meta name="Description" content="Check if a stream is a TTY" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_isatty - Manual" />
<meta name="twitter:description" content="Check if a stream is a TTY" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_isatty - Manual" />
<meta itemprop="description" content="Check if a stream is a TTY" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if a stream is a TTY" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-notification-callback.php">
          stream_notification_callback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-is-local.php">
          &laquo; stream_is_local        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-isatty.php' selected="selected">English</option>
            <option value='de/function.stream-isatty.php'>German</option>
            <option value='es/function.stream-isatty.php'>Spanish</option>
            <option value='fr/function.stream-isatty.php'>French</option>
            <option value='it/function.stream-isatty.php'>Italian</option>
            <option value='ja/function.stream-isatty.php'>Japanese</option>
            <option value='pt_BR/function.stream-isatty.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-isatty.php'>Russian</option>
            <option value='tr/function.stream-isatty.php'>Turkish</option>
            <option value='uk/function.stream-isatty.php'>Ukrainian</option>
            <option value='zh/function.stream-isatty.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-isatty" class="refentry">
    ...
    <div class="example-contents screen"><br />
     false<br />
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-isatty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-isatty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-isatty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-isatty.php">＋<small>add a note</small></a></span>
