...
<head>
  ...
  <title>PHP: Dom\XMLDocument - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-xmldocument.php">
 <link rel="shorturl" href="https://www.php.net/dom-xmldocument">
 <link rel="alternate" href="https://www.php.net/dom-xmldocument" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/dom-tokenlist.toggle.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-xpath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-xmldocument.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-xmldocument.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-xmldocument.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-xmldocument.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-xmldocument.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-xmldocument.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-xmldocument.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-xmldocument.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-xmldocument.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-xmldocument.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-xmldocument.php" hreflang="zh">
...
<meta name="Description" content="The Dom\XMLDocument class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\XMLDocument - Manual" />
<meta name="twitter:description" content="The Dom\XMLDocument class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\XMLDocument - Manual" />
<meta itemprop="description" content="The Dom\XMLDocument class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\XMLDocument class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-xpath.php">
          Dom\XPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="dom-tokenlist.toggle.php">
          &laquo; Dom\TokenList::toggle        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-xmldocument.php' selected="selected">English</option>
            <option value='de/class.dom-xmldocument.php'>German</option>
            <option value='es/class.dom-xmldocument.php'>Spanish</option>
            <option value='fr/class.dom-xmldocument.php'>French</option>
            <option value='it/class.dom-xmldocument.php'>Italian</option>
            <option value='ja/class.dom-xmldocument.php'>Japanese</option>
            <option value='pt_BR/class.dom-xmldocument.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-xmldocument.php'>Russian</option>
            <option value='tr/class.dom-xmldocument.php'>Turkish</option>
            <option value='uk/class.dom-xmldocument.php'>Ukrainian</option>
            <option value='zh/class.dom-xmldocument.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-xmldocument" class="reference">
 <h1 class="title">The Dom\XMLDocument class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  ...
  <div class="section" id="dom-xmldocument.intro">
   ...
   <p class="simpara">
    Represents an <abbr title="eXtensible Markup Language">XML</abbr> document.
   </p>
  </div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-xmldocument.props">
   ...
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <span class="simpara">
     While the <span class="classname"><a href="class.domdocument.php" class="classname">DOMDocument</a></span> class allows setting certain
     properties to influence parser behaviour, this class only uses the
     <strong><code><a href="libxml.constants.php#constant.libxml-biglines">LIBXML_<span class="replaceable">*</span></a></code></strong> constants to
   ...
   <dl>
     ...
     <dd>
      <span class="simpara">Nicely formats output with indentation and extra space.</span>
     </dd>
  ...
  The parser methods auto-detect the encoding or allow the caller to specify an encoding.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-xmldocument.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-xmldocument%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-xmldocument&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-xmldocument.php">＋<small>add a note</small></a></span>
