...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickpixel.gethsl.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickpixel.gethsl.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickpixel.gethsl.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickpixel.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickpixel.getcolorvaluequantum.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickpixel.getindex.php">
...
<meta name="Description" content="Returns the normalized HSL color of the ImagickPixel object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickPixel::getHSL - Manual" />
<meta name="twitter:description" content="Returns the normalized HSL color of the ImagickPixel object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickPixel::getHSL - Manual" />
<meta itemprop="description" content="Returns the normalized HSL color of the ImagickPixel object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the normalized HSL color of the ImagickPixel object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickpixel.gethsl.php' selected="selected">English</option>
            ...
            <option value='ja/imagickpixel.gethsl.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickPixel::getHSL</span> &mdash; <span class="dc-title">Returns the normalized HSL color of the ImagickPixel object</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagickpixel.gethsl-examples">
  ...
  <p class="para">
   <div class="example" id="example-3206">
    <p><strong>Example #1 Basic <span class="function"><strong>Imagick::getHSL()</strong></span> example</strong></p>
   ...
   <p class="para">
    Available with ImageMagick library version 6.2.9 and higher.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickpixel/gethsl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickpixel.gethsl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickpixel.gethsl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickpixel.gethsl.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This function needs ImageMagick &gt; 6.2.8<br /><br />In imagickpixel_class.c<br />#if MagickLibVersion &gt; 0x628<br />/* {{{ proto array ImagickPixel::getHSL()<br />        Returns the normalized HSL color of the pixel wand in an array with the keys "hue", "saturation", and "luminosity".<br />*/</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickpixel.gethsl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickpixel.gethsl.php">＋<small>add a note</small></a></div>
