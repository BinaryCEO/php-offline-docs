...
<head>
  ...
  <title>PHP: EventHttpConnection::makeRequest - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventhttpconnection.makerequest.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventhttpconnection.makerequest.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventhttpconnection.makerequest.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventhttpconnection.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttpconnection.getpeer.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttpconnection.setclosecallback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventhttpconnection.makerequest.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventhttpconnection.makerequest.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventhttpconnection.makerequest.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventhttpconnection.makerequest.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventhttpconnection.makerequest.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventhttpconnection.makerequest.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventhttpconnection.makerequest.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventhttpconnection.makerequest.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventhttpconnection.makerequest.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventhttpconnection.makerequest.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventhttpconnection.makerequest.php" hreflang="zh">
...
<meta name="Description" content="Makes an HTTP request over the specified connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttpConnection::makeRequest - Manual" />
<meta name="twitter:description" content="Makes an HTTP request over the specified connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttpConnection::makeRequest - Manual" />
<meta itemprop="description" content="Makes an HTTP request over the specified connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes an HTTP request over the specified connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventhttpconnection.setclosecallback.php">
          EventHttpConnection::setCloseCallback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttpconnection.getpeer.php">
          &laquo; EventHttpConnection::getPeer        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventhttpconnection.makerequest.php' selected="selected">English</option>
            <option value='de/eventhttpconnection.makerequest.php'>German</option>
            <option value='es/eventhttpconnection.makerequest.php'>Spanish</option>
            <option value='fr/eventhttpconnection.makerequest.php'>French</option>
            <option value='it/eventhttpconnection.makerequest.php'>Italian</option>
            <option value='ja/eventhttpconnection.makerequest.php'>Japanese</option>
            <option value='pt_BR/eventhttpconnection.makerequest.php'>Brazilian Portuguese</option>
            <option value='ru/eventhttpconnection.makerequest.php'>Russian</option>
            <option value='tr/eventhttpconnection.makerequest.php'>Turkish</option>
            <option value='uk/eventhttpconnection.makerequest.php'>Ukrainian</option>
            <option value='zh/eventhttpconnection.makerequest.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventhttpconnection.makerequest" class="refentry">
   ...
   <li>
    <span class="methodname"><a href="eventhttprequest.addheader.php" class="methodname" rel="rdfs-seeAlso">EventHttpRequest::addHeader()</a> - Adds an HTTP header to the headers of the request</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttpconnection/makerequest.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventhttpconnection.makerequest%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventhttpconnection.makerequest&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttpconnection.makerequest.php">＋<small>add a note</small></a></span>
