...
<head>
  ...
  <title>PHP: SolrQuery::getExpandSortFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getexpandrows.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getexpandsortfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getexpandsortfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getexpandsortfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getexpandsortfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getexpandsortfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getexpandsortfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getexpandsortfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getexpandsortfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getexpandsortfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getexpandsortfields.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getExpandSortFields - Manual" />
<meta name="twitter:description" content="Returns an array of fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getExpandSortFields - Manual" />
<meta itemprop="description" content="Returns an array of fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacet.php">
          SolrQuery::getFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getexpandrows.php">
          &laquo; SolrQuery::getExpandRows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getexpandsortfields.php' selected="selected">English</option>
            <option value='de/solrquery.getexpandsortfields.php'>German</option>
            <option value='es/solrquery.getexpandsortfields.php'>Spanish</option>
            <option value='fr/solrquery.getexpandsortfields.php'>French</option>
            <option value='it/solrquery.getexpandsortfields.php'>Italian</option>
            <option value='ja/solrquery.getexpandsortfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getexpandsortfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getexpandsortfields.php'>Russian</option>
            <option value='tr/solrquery.getexpandsortfields.php'>Turkish</option>
            <option value='uk/solrquery.getexpandsortfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getexpandsortfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getexpandsortfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getExpandSortFields</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getExpandSortFields</span> &mdash; <span class="dc-title">Returns an array of fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getexpandsortfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getExpandSortFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getexpandsortfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getexpandsortfields-returnvalues">
  ...
  <p class="para">
   Returns an array of fields.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getexpandsortfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getexpandsortfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getexpandsortfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getexpandsortfields.php">＋<small>add a note</small></a></span>
