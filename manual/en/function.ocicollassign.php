...
<head>
  ...
  <title>PHP: ocicollassign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicollassign.php">
 <link rel="shorturl" href="https://www.php.net/ocicollassign">
 <link rel="alternate" href="https://www.php.net/ocicollassign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicollappend.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicollassignelem.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicollassign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicollassign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicollassign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicollassign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicollassign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicollassign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicollassign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicollassign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicollassign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicollassign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicollassign.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::assign" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicollassign - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::assign" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicollassign - Manual" />
<meta itemprop="description" content="Alias of OCICollection::assign" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::assign" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocicollassignelem.php">
          ocicollassignelem &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicollappend.php">
          &laquo; ocicollappend        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicollassign.php' selected="selected">English</option>
            <option value='de/function.ocicollassign.php'>German</option>
            <option value='es/function.ocicollassign.php'>Spanish</option>
            <option value='fr/function.ocicollassign.php'>French</option>
            <option value='it/function.ocicollassign.php'>Italian</option>
            <option value='ja/function.ocicollassign.php'>Japanese</option>
            <option value='pt_BR/function.ocicollassign.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicollassign.php'>Russian</option>
            <option value='tr/function.ocicollassign.php'>Turkish</option>
            <option value='uk/function.ocicollassign.php'>Ukrainian</option>
            <option value='zh/function.ocicollassign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicollassign" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicollassign</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicollassign</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.assign.php" class="function">OCICollection::assign()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicollassign-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.assign.php" class="function">OCICollection::assign()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicollassign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicollassign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicollassign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicollassign.php">＋<small>add a note</small></a></span>
