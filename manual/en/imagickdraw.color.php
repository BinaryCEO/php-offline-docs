...
<head>
  ...
  <title>PHP: ImagickDraw::color - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.color.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.color.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.color.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.clone.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.comment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.color.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.color.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.color.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.color.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.color.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.color.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.color.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.color.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.color.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.color.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.color.php" hreflang="zh">
...
<meta name="Description" content="Draws color on image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::color - Manual" />
<meta name="twitter:description" content="Draws color on image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::color - Manual" />
<meta itemprop="description" content="Draws color on image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws color on image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.comment.php">
          ImagickDraw::comment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.clone.php">
          &laquo; ImagickDraw::clone        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.color.php' selected="selected">English</option>
            <option value='de/imagickdraw.color.php'>German</option>
            <option value='es/imagickdraw.color.php'>Spanish</option>
            <option value='fr/imagickdraw.color.php'>French</option>
            <option value='it/imagickdraw.color.php'>Italian</option>
            <option value='ja/imagickdraw.color.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.color.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.color.php'>Russian</option>
            <option value='tr/imagickdraw.color.php'>Turkish</option>
            <option value='uk/imagickdraw.color.php'>Ukrainian</option>
            <option value='zh/imagickdraw.color.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.color" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::color</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::color</span> &mdash; <span class="dc-title">Draws color on image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.color-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::color</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$paint</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.color-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">paint</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.paint" class="link">PAINT</a> constant
       (<code class="literal">imagick::PAINT_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.color-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/color.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.color%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.color&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.color.php">＋<small>add a note</small></a></span>
