...
<head>
  ...
  <title>PHP: pg_port - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-port.php">
 <link rel="shorturl" href="https://www.php.net/pg-port">
 <link rel="alternate" href="https://www.php.net/pg-port" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-ping.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-prepare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-port.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-port.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-port.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-port.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-port.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-port.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-port.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-port.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-port.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-port.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-port.php" hreflang="zh">
...
<meta name="Description" content="Return the port number associated with the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_port - Manual" />
<meta name="twitter:description" content="Return the port number associated with the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_port - Manual" />
<meta itemprop="description" content="Return the port number associated with the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the port number associated with the connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-port.php' selected="selected">English</option>
            <option value='de/function.pg-port.php'>German</option>
            <option value='es/function.pg-port.php'>Spanish</option>
            <option value='fr/function.pg-port.php'>French</option>
            <option value='it/function.pg-port.php'>Italian</option>
            <option value='ja/function.pg-port.php'>Japanese</option>
            <option value='pt_BR/function.pg-port.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-port.php'>Russian</option>
            <option value='tr/function.pg-port.php'>Turkish</option>
            <option value='uk/function.pg-port.php'>Ukrainian</option>
            <option value='zh/function.pg-port.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-port" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_port</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_port</span> &mdash; <span class="dc-title">
   Return the port number associated with the connection
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-port-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_port</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_port()</strong></span> returns the port number that the
   given PostgreSQL <code class="parameter">connection</code> instance is
   connected to.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-port-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-port-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the port number of the database
   server the <code class="parameter">connection</code> is to, 
   or empty string on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-port-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-port-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2100">
    <p><strong>Example #1 <span class="function"><strong>pg_port()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pgsql_conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=mark host=localhost"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) {<br />   print </span><span style="color: #DD0000">"Successfully connected to port: " </span><span style="color: #007700">. </span><span style="color: #0000BB">pg_port</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br/&gt;\n"</span><span style="color: #007700">;<br />} else {<br />   print </span><span style="color: #0000BB">pg_last_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   exit;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-port.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-port%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-port&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-port.php">＋<small>add a note</small></a></span>
