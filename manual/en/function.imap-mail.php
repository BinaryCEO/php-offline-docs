...
<head>
  ...
  <title>PHP: imap_mail - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-mail.php">
 <link rel="shorturl" href="https://www.php.net/imap-mail">
 <link rel="alternate" href="https://www.php.net/imap-mail" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-lsub.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-mail-compose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-mail.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-mail.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-mail.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-mail.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-mail.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-mail.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-mail.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-mail.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-mail.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-mail.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-mail.php" hreflang="zh">
...
<meta name="Description" content="Send an email message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_mail - Manual" />
<meta name="twitter:description" content="Send an email message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_mail - Manual" />
<meta itemprop="description" content="Send an email message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send an email message" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-mail.php' selected="selected">English</option>
            <option value='de/function.imap-mail.php'>German</option>
            <option value='es/function.imap-mail.php'>Spanish</option>
            <option value='fr/function.imap-mail.php'>French</option>
            <option value='it/function.imap-mail.php'>Italian</option>
            <option value='ja/function.imap-mail.php'>Japanese</option>
            <option value='pt_BR/function.imap-mail.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-mail.php'>Russian</option>
            <option value='tr/function.imap-mail.php'>Turkish</option>
            <option value='uk/function.imap-mail.php'>Ukrainian</option>
            <option value='zh/function.imap-mail.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-mail" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.imap-mail-description">
  ...
  <p class="para">
   ...
   as <a href="https://datatracker.ietf.org/doc/html/rfc822" class="link external">&raquo;&nbsp;RFC822</a> address lists.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-mail-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The mail body, see <span class="function"><a href="function.imap-mail-compose.php" class="function">imap_mail_compose()</a></span>
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-mail-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-mail-compose.php" class="function" rel="rdfs-seeAlso">imap_mail_compose()</a> - Create a MIME message based on given envelope and body sections</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-mail.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-mail%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-mail&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-mail.php">＋<small>add a note</small></a></span>
