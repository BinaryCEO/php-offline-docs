...
<head>
  ...
  <title>PHP: Imagick::levelImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.levelimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.levelimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.levelimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.labelimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.linearstretchimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.levelimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.levelimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.levelimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.levelimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.levelimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.levelimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.levelimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.levelimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.levelimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.levelimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.levelimage.php" hreflang="zh">
...
<meta name="Description" content="Adjusts the levels of an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::levelImage - Manual" />
<meta name="twitter:description" content="Adjusts the levels of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::levelImage - Manual" />
<meta itemprop="description" content="Adjusts the levels of an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjusts the levels of an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.linearstretchimage.php">
          Imagick::linearStretchImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.labelimage.php">
          &laquo; Imagick::labelImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.levelimage.php' selected="selected">English</option>
            <option value='de/imagick.levelimage.php'>German</option>
            <option value='es/imagick.levelimage.php'>Spanish</option>
            <option value='fr/imagick.levelimage.php'>French</option>
            <option value='it/imagick.levelimage.php'>Italian</option>
            <option value='ja/imagick.levelimage.php'>Japanese</option>
            <option value='pt_BR/imagick.levelimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.levelimage.php'>Russian</option>
            <option value='tr/imagick.levelimage.php'>Turkish</option>
            <option value='uk/imagick.levelimage.php'>Ukrainian</option>
            <option value='zh/imagick.levelimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.levelimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::levelImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::levelImage</span> &mdash; <span class="dc-title">Adjusts the levels of an image</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.levelimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3024">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/levelimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.levelimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.levelimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.levelimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="101584">  <div class="votes">
    <div id="Vu101584">
    <a href="/manual/vote-note.php?id=101584&amp;page=imagick.levelimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101584">
    <a href="/manual/vote-note.php?id=101584&amp;page=imagick.levelimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101584" title="81% like this...">
    7
    </div>
  </div>
  <a href="#101584" class="name">
  <strong class="user"><em>Maxim Lovchikov</em></strong></a><a class="genanchor" href="#101584"> &para;</a><div class="date" title="2010-12-28 12:18"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101584">
<div class="phpcode"><code><span class="html">I have a trouble with this method because think that quantum range is 0 - 255.<br />But quantum range for levelImage is 0-65535. You can get quantum range with Imagick::getQuantumRange<br />There is a right piece of code<br /><br />$img-&gt;levelImage (0, 1.0, 65535);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.levelimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.levelimage.php">＋<small>add a note</small></a></div>
