...
<head>
  ...
  <title>PHP: xdiff_file_bpatch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xdiff-file-bpatch.php">
 <link rel="shorturl" href="https://www.php.net/xdiff-file-bpatch">
 <link rel="alternate" href="https://www.php.net/xdiff-file-bpatch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xdiff.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xdiff-file-bdiff-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xdiff-file-diff.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xdiff-file-bpatch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xdiff-file-bpatch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xdiff-file-bpatch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xdiff-file-bpatch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xdiff-file-bpatch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xdiff-file-bpatch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xdiff-file-bpatch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xdiff-file-bpatch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xdiff-file-bpatch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xdiff-file-bpatch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xdiff-file-bpatch.php" hreflang="zh">
...
<meta name="Description" content="Patch a file with a binary diff" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xdiff_file_bpatch - Manual" />
<meta name="twitter:description" content="Patch a file with a binary diff" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xdiff_file_bpatch - Manual" />
<meta itemprop="description" content="Patch a file with a binary diff" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Patch a file with a binary diff" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.xdiff-file-diff.php">
          xdiff_file_diff &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xdiff-file-bdiff-size.php">
          &laquo; xdiff_file_bdiff_size        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xdiff-file-bpatch.php' selected="selected">English</option>
            <option value='de/function.xdiff-file-bpatch.php'>German</option>
            <option value='es/function.xdiff-file-bpatch.php'>Spanish</option>
            <option value='fr/function.xdiff-file-bpatch.php'>French</option>
            <option value='it/function.xdiff-file-bpatch.php'>Italian</option>
            <option value='ja/function.xdiff-file-bpatch.php'>Japanese</option>
            <option value='pt_BR/function.xdiff-file-bpatch.php'>Brazilian Portuguese</option>
            <option value='ru/function.xdiff-file-bpatch.php'>Russian</option>
            <option value='tr/function.xdiff-file-bpatch.php'>Turkish</option>
            <option value='uk/function.xdiff-file-bpatch.php'>Ukrainian</option>
            <option value='zh/function.xdiff-file-bpatch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xdiff-file-bpatch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">xdiff_file_bpatch</h1>
  <p class="verinfo">(PECL xdiff &gt;= 1.5.0)</p><p class="refpurpose"><span class="refname">xdiff_file_bpatch</span> &mdash; <span class="dc-title">Patch a file with a binary diff</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.xdiff-file-bpatch-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>xdiff_file_bpatch</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$file</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$patch</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dest</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   and <span class="function"><a href="function.xdiff-file-rabdiff.php" class="function">xdiff_file_rabdiff()</a></span> functions or their string counterparts.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.xdiff-file-rabdiff.php" class="function" rel="rdfs-seeAlso">xdiff_file_rabdiff()</a> - Make binary diff of two files using the Rabin's polynomial fingerprinting algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xdiff/functions/xdiff-file-bpatch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xdiff-file-bpatch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xdiff-file-bpatch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xdiff-file-bpatch.php">＋<small>add a note</small></a></span>
