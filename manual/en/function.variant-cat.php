...
<head>
  ...
  <title>PHP: variant_cat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-cat.php">
 <link rel="shorturl" href="https://www.php.net/variant-cat">
 <link rel="alternate" href="https://www.php.net/variant-cat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-cast.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-cmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-cat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-cat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-cat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-cat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-cat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-cat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-cat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-cat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-cat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-cat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-cat.php" hreflang="zh">
...
<meta name="Description" content="Concatenates two variant values together and returns the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_cat - Manual" />
<meta name="twitter:description" content="Concatenates two variant values together and returns the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_cat - Manual" />
<meta itemprop="description" content="Concatenates two variant values together and returns the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Concatenates two variant values together and returns the result" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-cat.php' selected="selected">English</option>
            <option value='de/function.variant-cat.php'>German</option>
            <option value='es/function.variant-cat.php'>Spanish</option>
            <option value='fr/function.variant-cat.php'>French</option>
            <option value='it/function.variant-cat.php'>Italian</option>
            <option value='ja/function.variant-cat.php'>Japanese</option>
            <option value='pt_BR/function.variant-cat.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-cat.php'>Russian</option>
            <option value='tr/function.variant-cat.php'>Turkish</option>
            <option value='uk/function.variant-cat.php'>Ukrainian</option>
            <option value='zh/function.variant-cat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-cat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_cat</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_cat</span> &mdash; <span class="dc-title">Concatenates two variant values together and returns the result</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.variant-cat-description">
  ...
  <p class="para rdfs-comment">
   Concatenates <code class="parameter">left</code> with
   <code class="parameter">right</code> and returns the result.
  </p>
  <p class="para">
...
<p class="para">
 ...
 <div class="refsect1 seealso" id="refsect1-function.variant-cat-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><a href="language.operators.string.php" class="xref">String</a> for the string
   concatenation operator</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-cat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-cat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-cat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-cat.php">＋<small>add a note</small></a></span>
