...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-bulletlist.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-blockquote.php">
 <link rel="next" href="https://www.php.net/manual/en/commonmark-node-bulletlist.construct.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-bulletlist.php' selected="selected">English</option>
            ...
            <option value='ja/class.commonmark-node-bulletlist.php'>Japanese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="commonmark-node-bulletlist.construct.php">CommonMark\Node\BulletList::__construct</a> — BulletList Construction</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.bulletlist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-bulletlist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-bulletlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-bulletlist.php">＋<small>add a note</small></a></span>
