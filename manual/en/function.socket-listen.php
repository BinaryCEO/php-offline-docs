...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-listen.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-read.php">
...
<meta name="Description" content="Listens for a connection on a socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_listen - Manual" />
<meta name="twitter:description" content="Listens for a connection on a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_listen - Manual" />
<meta itemprop="description" content="Listens for a connection on a socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Listens for a connection on a socket" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-listen.php' selected="selected">English</option>
            ...
            <option value='zh/function.socket-listen.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-addrinfo-bind.php" class="function" rel="rdfs-seeAlso">socket_addrinfo_bind()</a> - Create and bind to a socket from a given addrinfo</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-listen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-listen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-listen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-listen.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123750">  <div class="votes">
    <div id="Vu123750">
    <a href="/manual/vote-note.php?id=123750&amp;page=function.socket-listen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123750">
    <a href="/manual/vote-note.php?id=123750&amp;page=function.socket-listen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123750" title="45% like this...">
    -5
    </div>
  </div>
  <a href="#123750" class="name">
  <strong class="user"><em>renmengyang567 at gmail dot com</em></strong></a><a class="genanchor" href="#123750"> &para;</a><div class="date" title="2019-04-07 05:52"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123750">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">// create for tcp<br /></span><span class="default">$sock </span><span class="keyword">= </span><span class="default">socket_create</span><span class="keyword">(</span><span class="default">AF_INET</span><span class="keyword">, </span><span class="default">SOCK_STREAM</span><span class="keyword">, </span><span class="default">getprotobyname</span><span class="keyword">(</span><span class="string">'tcp'</span><span class="keyword">));<br /></span><span class="default">socket_bind</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="string">'127.0.0.1'</span><span class="keyword">,</span><span class="default">5000</span><span class="keyword">);<br /></span><span class="default">socket_listen</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">sleep</span><span class="keyword">(</span><span class="default">20</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />&lt;fruit&gt;<br />netstat  -ntpl<br />Active Internet connections (only servers)<br />Proto Recv-Q Send-Q Local Address           Foreign Address         State       PID/Program name<br />tcp        0      0 127.0.0.1:5000          0.0.0.0:*               LISTEN      1839/php</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-listen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-listen.php">＋<small>add a note</small></a></div>
