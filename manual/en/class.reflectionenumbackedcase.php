...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionenumbackedcase.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/reflectionenumunitcase.getvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionenumbackedcase.construct.php">
...
<meta name="Description" content="The ReflectionEnumBackedCase class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionEnumBackedCase - Manual" />
<meta name="twitter:description" content="The ReflectionEnumBackedCase class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionEnumBackedCase - Manual" />
<meta itemprop="description" content="The ReflectionEnumBackedCase class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionEnumBackedCase class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionenumbackedcase.php' selected="selected">English</option>
            ...
            <option value='tr/class.reflectionenumbackedcase.php'>Turkish</option>
 ...
 <h1 class="title">The ReflectionEnumBackedCase class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.1.0)</p>
  ...
  <div class="section" id="reflectionenumbackedcase.intro">
   ...
   <p class="para">
    The <span class="classname"><strong class="classname">ReflectionEnumBackedCase</strong></span> class reports
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionenumbackedcase.construct.php">ReflectionEnumBackedCase::__construct</a> — Instantiates a ReflectionEnumBackedCase object</li><li><a href="reflectionenumbackedcase.getbackingvalue.php">ReflectionEnumBackedCase::getBackingValue</a> — Gets the scalar value backing this Enum case</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionenumbackedcase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionenumbackedcase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionenumbackedcase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionenumbackedcase.php">＋<small>add a note</small></a></span>
