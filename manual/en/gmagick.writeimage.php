...
<head>
  ...
  <title>PHP: Gmagick::writeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.writeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.writeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.writeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.write.php">
 <link rel="next" href="https://www.php.net/manual/en/class.gmagickdraw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.writeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.writeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.writeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.writeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.writeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.writeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.writeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.writeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.writeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.writeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.writeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::writeimage - Manual" />
<meta name="twitter:description" content="Writes an image to the specified filename" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::writeimage - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.writeimage.php' selected="selected">English</option>
            <option value='de/gmagick.writeimage.php'>German</option>
            <option value='es/gmagick.writeimage.php'>Spanish</option>
            <option value='fr/gmagick.writeimage.php'>French</option>
            <option value='it/gmagick.writeimage.php'>Italian</option>
            <option value='ja/gmagick.writeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.writeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.writeimage.php'>Russian</option>
            <option value='tr/gmagick.writeimage.php'>Turkish</option>
            <option value='uk/gmagick.writeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.writeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.writeimage" class="refentry">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/writeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.writeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.writeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.writeimage.php">＋<small>add a note</small></a></span>
