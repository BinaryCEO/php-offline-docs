...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-bson-binary.getdata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-bson-binary.getdata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-binary.getdata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-bson-binary.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-binary.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-binary.gettype.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-bson-binary.getdata.php' selected="selected">English</option>
            <option value='de/mongodb-bson-binary.getdata.php'>German</option>
            <option value='es/mongodb-bson-binary.getdata.php'>Spanish</option>
  ...
  <ul class="simplelist">
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;BSON Types</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/binary/getdata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-bson-binary.getdata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-bson-binary.getdata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-bson-binary.getdata.php">＋<small>add a note</small></a></span>
