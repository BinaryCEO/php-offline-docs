...
<head>
  ...
  <title>PHP: sodium_crypto_box_seal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-box-seal">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-box-seal" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-box-publickey-from-secretkey.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-box-seal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-box-seal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-box-seal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-box-seal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-box-seal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-box-seal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-box-seal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-box-seal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-box-seal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-box-seal.php" hreflang="zh">
...
<meta name="Description" content="Anonymous public-key encryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box_seal - Manual" />
<meta name="twitter:description" content="Anonymous public-key encryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box_seal - Manual" />
<meta itemprop="description" content="Anonymous public-key encryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Anonymous public-key encryption" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-box-seal-open.php">
          sodium_crypto_box_seal_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-box-publickey-from-secretkey.php">
          &laquo; sodium_crypto_box_publickey_from_secretkey        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box-seal.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-box-seal.php'>German</option>
            <option value='es/function.sodium-crypto-box-seal.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-box-seal.php'>French</option>
            <option value='it/function.sodium-crypto-box-seal.php'>Italian</option>
            <option value='ja/function.sodium-crypto-box-seal.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-box-seal.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-box-seal.php'>Russian</option>
            <option value='tr/function.sodium-crypto-box-seal.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-box-seal.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-box-seal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-box-seal" class="refentry">
...
string(41) &quot;Writing software in PHP can be a delight!&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box-seal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box-seal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-seal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-seal.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122305">  <div class="votes">
    <div id="Vu122305">
    <a href="/manual/vote-note.php?id=122305&amp;page=function.sodium-crypto-box-seal&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122305">
    <a href="/manual/vote-note.php?id=122305&amp;page=function.sodium-crypto-box-seal&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122305" title="90% like this...">
    9
    </div>
  </div>
  <a href="#122305" class="name">
  <strong class="user"><em>craig at craigfrancis dot co dot uk</em></strong></a><a class="genanchor" href="#122305"> &para;</a><div class="date" title="2018-01-23 01:36"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122305">
<div class="phpcode"><code><span class="html">Here's a quick example on how to use sodium_crypto_box_seal(); where you have 2 people exchanging a $message - person 1 encrypts it so that only person 2 can decrypt it. It does not allow person 2 to know who sent it, as only their public key way used (see sodium_crypto_box to do that).<br /><br /><span class="default">&lt;?php<br /><br />$keypair </span><span class="keyword">= </span><span class="default">sodium_crypto_box_keypair</span><span class="keyword">();<br /></span><span class="default">$keypair_public </span><span class="keyword">= </span><span class="default">sodium_crypto_box_publickey</span><span class="keyword">(</span><span class="default">$keypair</span><span class="keyword">);<br /></span><span class="default">$keypair_secret </span><span class="keyword">= </span><span class="default">sodium_crypto_box_secretkey</span><span class="keyword">(</span><span class="default">$keypair</span><span class="keyword">);<br /><br /></span><span class="comment">// $key_public = sodium_crypto_box_publickey_from_secretkey($keypair_secret);<br />// $keypair = sodium_crypto_box_keypair_from_secretkey_and_publickey($keypair_secret, $key_public);<br /><br />//--------------------------------------------------<br />// Person 1, encrypting<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="string">'hello'</span><span class="keyword">;<br /><br /></span><span class="default">$encrypted </span><span class="keyword">= </span><span class="default">sodium_crypto_box_seal</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$keypair_public</span><span class="keyword">);<br /><br />echo </span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">$encrypted</span><span class="keyword">) . </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 2, decrypting<br /><br /></span><span class="default">$decrypted </span><span class="keyword">= </span><span class="default">sodium_crypto_box_seal_open</span><span class="keyword">(</span><span class="default">$encrypted</span><span class="keyword">, </span><span class="default">$keypair</span><span class="keyword">);<br /><br />echo </span><span class="default">$decrypted </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-seal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-seal.php">＋<small>add a note</small></a></div>
