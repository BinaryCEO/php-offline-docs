...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-or.php">
 <link rel="shorturl" href="https://www.php.net/gmp-or">
 <link rel="alternate" href="https://www.php.net/gmp-or" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-nextprime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-perfect-power.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-or.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-or.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-or.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-or.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-or.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-or.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-or.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-or.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-or.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-or.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-or.php" hreflang="zh">
...
<meta name="Description" content="Bitwise OR" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_or - Manual" />
<meta name="twitter:description" content="Bitwise OR" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_or - Manual" />
<meta itemprop="description" content="Bitwise OR" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bitwise OR" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.gmp-perfect-power.php">
          gmp_perfect_power &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-nextprime.php">
          &laquo; gmp_nextprime        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-or.php' selected="selected">English</option>
            <option value='de/function.gmp-or.php'>German</option>
            <option value='es/function.gmp-or.php'>Spanish</option>
            <option value='fr/function.gmp-or.php'>French</option>
            <option value='it/function.gmp-or.php'>Italian</option>
            <option value='ja/function.gmp-or.php'>Japanese</option>
            <option value='pt_BR/function.gmp-or.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-or.php'>Russian</option>
            <option value='tr/function.gmp-or.php'>Turkish</option>
            <option value='uk/function.gmp-or.php'>Ukrainian</option>
            <option value='zh/function.gmp-or.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-or" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_or</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_or</span> &mdash; <span class="dc-title">Bitwise OR</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-or-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_or</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-or-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-or-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-or-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3337">
    <p><strong>Example #1 <span class="function"><strong>gmp_or()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">fffffff6
fffffff2</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-or.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-or%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-or&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-or.php">＋<small>add a note</small></a></span>
