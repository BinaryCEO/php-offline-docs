...
<head>
  ...
  <title>PHP: ocifreedesc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocifreedesc.php">
 <link rel="shorturl" href="https://www.php.net/ocifreedesc">
 <link rel="alternate" href="https://www.php.net/ocifreedesc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocifreecursor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocifreestatement.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocifreedesc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocifreedesc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocifreedesc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocifreedesc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocifreedesc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocifreedesc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocifreedesc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocifreedesc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocifreedesc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocifreedesc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocifreedesc.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCILob::free" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocifreedesc - Manual" />
<meta name="twitter:description" content="Alias of OCILob::free" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocifreedesc - Manual" />
<meta itemprop="description" content="Alias of OCILob::free" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCILob::free" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocifreestatement.php">
          ocifreestatement &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocifreecursor.php">
          &laquo; ocifreecursor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocifreedesc.php' selected="selected">English</option>
            <option value='de/function.ocifreedesc.php'>German</option>
            <option value='es/function.ocifreedesc.php'>Spanish</option>
            <option value='fr/function.ocifreedesc.php'>French</option>
            <option value='it/function.ocifreedesc.php'>Italian</option>
            <option value='ja/function.ocifreedesc.php'>Japanese</option>
            <option value='pt_BR/function.ocifreedesc.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocifreedesc.php'>Russian</option>
            <option value='tr/function.ocifreedesc.php'>Turkish</option>
            <option value='uk/function.ocifreedesc.php'>Ukrainian</option>
            <option value='zh/function.ocifreedesc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocifreedesc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocifreedesc</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocifreedesc</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocilob.free.php" class="function">OCILob::free()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocifreedesc-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocilob.free.php" class="function">OCILob::free()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocifreedesc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocifreedesc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocifreedesc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocifreedesc.php">＋<small>add a note</small></a></span>
