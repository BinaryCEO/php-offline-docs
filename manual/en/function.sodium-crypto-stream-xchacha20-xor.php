...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor-ic.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-stream-xchacha20-xor.php' selected="selected">English</option>
            ...
            <option value='fr/function.sodium-crypto-stream-xchacha20-xor.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_stream_xchacha20_xor</span> &mdash; <span class="dc-title">Encrypts a message using a nonce and a secret key (no authentication)</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-stream-xchacha20-xor-description">
  ...
  <p class="para rdfs-comment">
   Encrypts a <code class="parameter">message</code> using a <code class="parameter">nonce</code>
   and a secret <code class="parameter">key</code> (no authentication).
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-stream-xchacha20-xor-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-stream-xchacha20-xor-ic.php" class="function" rel="rdfs-seeAlso">sodium_crypto_stream_xchacha20_xor_ic()</a> - Encrypts a message using a nonce and a secret key (no authentication)</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-stream-xchacha20-xor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-stream-xchacha20-xor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-stream-xchacha20-xor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor.php">＋<small>add a note</small></a></span>
