...
<head>
  ...
  <title>PHP: MongoDB\Driver\Exception\ConnectionTimeoutException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-exception-connectiontimeoutexception.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-exception-connectiontimeoutexception">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-exception-connectiontimeoutexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-exception-connectionexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-exception-encryptionexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-exception-connectiontimeoutexception.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Exception\ConnectionTimeoutException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Exception\ConnectionTimeoutException - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Exception\ConnectionTimeoutException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Exception\ConnectionTimeoutException - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Exception\ConnectionTimeoutException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Exception\ConnectionTimeoutException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.mongodb-driver-exception-encryptionexception.php">
          MongoDB\Driver\Exception\EncryptionException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mongodb-driver-exception-connectionexception.php">
          &laquo; MongoDB\Driver\Exception\ConnectionException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-exception-connectiontimeoutexception.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-exception-connectiontimeoutexception.php'>German</option>
            <option value='es/class.mongodb-driver-exception-connectiontimeoutexception.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-exception-connectiontimeoutexception.php'>French</option>
            <option value='it/class.mongodb-driver-exception-connectiontimeoutexception.php'>Italian</option>
            <option value='ja/class.mongodb-driver-exception-connectiontimeoutexception.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-exception-connectiontimeoutexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-exception-connectiontimeoutexception.php'>Russian</option>
            <option value='tr/class.mongodb-driver-exception-connectiontimeoutexception.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-exception-connectiontimeoutexception.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-exception-connectiontimeoutexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-exception-connectiontimeoutexception" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;= 1.0.0)</p>
  ...
  <div class="section" id="mongodb-driver-exception-connectiontimeoutexception.intro">
   ...
   <p class="para">
    ...
    (<a href="mongodb-driver-manager.construct.php#mongodb-driver-manager.construct-urioptions" class="link">connectTimeoutMS</a>)
    or server selection fails
    (<a href="mongodb-driver-manager.construct.php#mongodb-driver-manager.construct-urioptions" class="link">serverSelectionTimeoutMS</a>).
   </p>
  </div>
  ...
  <div class="section" id="mongodb-driver-exception-connectiontimeoutexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     ...
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MongoDB\Driver\Exception\ConnectionTimeoutException</strong>
     </span>

     <span class="ooclass">
      <span class="modifier">extends</span>
       <a href="class.mongodb-driver-exception-connectionexception.php" class="classname">MongoDB\Driver\Exception\ConnectionException</a>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/exception/connectiontimeoutexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-exception-connectiontimeoutexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-exception-connectiontimeoutexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-exception-connectiontimeoutexception.php">＋<small>add a note</small></a></span>
