...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/swoole.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/swoole.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/swoole.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.swoole.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/swoole.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/swoole.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/swoole.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/swoole.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/swoole.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/swoole.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/swoole.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/swoole.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/swoole.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/swoole.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/swoole.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/swoole.setup.php' selected="selected">English</option>
            <option value='de/swoole.setup.php'>German</option>
            <option value='es/swoole.setup.php'>Spanish</option>
            <option value='fr/swoole.setup.php'>French</option>
            <option value='it/swoole.setup.php'>Italian</option>
            <option value='ja/swoole.setup.php'>Japanese</option>
            <option value='pt_BR/swoole.setup.php'>Brazilian Portuguese</option>
            <option value='ru/swoole.setup.php'>Russian</option>
            <option value='tr/swoole.setup.php'>Turkish</option>
            <option value='uk/swoole.setup.php'>Ukrainian</option>
            <option value='zh/swoole.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="swoole.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="swoole.requirements.php">Requirements</a></li><li><a href="swoole.installation.php">Installation</a></li><li><a href="swoole.configuration.php">Runtime Configuration</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fswoole.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=swoole.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/swoole.setup.php">＋<small>add a note</small></a></span>
