...
<head>
  ...
  <title>PHP: ps_shfill - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-shfill.php">
 <link rel="shorturl" href="https://www.php.net/ps-shfill">
 <link rel="alternate" href="https://www.php.net/ps-shfill" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-shading-pattern.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-show.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-shfill.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-shfill.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-shfill.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-shfill.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-shfill.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-shfill.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-shfill.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-shfill.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-shfill.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-shfill.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-shfill.php" hreflang="zh">
...
<meta name="Description" content="Fills an area with a shading" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_shfill - Manual" />
<meta name="twitter:description" content="Fills an area with a shading" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_shfill - Manual" />
<meta itemprop="description" content="Fills an area with a shading" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fills an area with a shading" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-shfill.php' selected="selected">English</option>
            <option value='de/function.ps-shfill.php'>German</option>
            <option value='es/function.ps-shfill.php'>Spanish</option>
            <option value='fr/function.ps-shfill.php'>French</option>
            <option value='it/function.ps-shfill.php'>Italian</option>
            <option value='ja/function.ps-shfill.php'>Japanese</option>
            <option value='pt_BR/function.ps-shfill.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-shfill.php'>Russian</option>
            <option value='tr/function.ps-shfill.php'>Turkish</option>
            <option value='uk/function.ps-shfill.php'>Ukrainian</option>
            <option value='zh/function.ps-shfill.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-shfill" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_shfill</h1>
  <p class="verinfo">(PECL ps &gt;= 1.3.0)</p><p class="refpurpose"><span class="refname">ps_shfill</span> &mdash; <span class="dc-title">Fills an area with a shading</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-shfill-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_shfill</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$shadingid</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Fills an area with a shading, which has to be created before with
   <span class="function"><a href="function.ps-shading.php" class="function">ps_shading()</a></span>. This is an alternative way to creating
   a pattern from a shading <span class="function"><a href="function.ps-shading-pattern.php" class="function">ps_shading_pattern()</a></span> and using
   the pattern as the filling color.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-shfill-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-shfill-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-shfill-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-shading-pattern.php" class="function" rel="rdfs-seeAlso">ps_shading_pattern()</a> - Creates a pattern based on a shading</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-shfill.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-shfill%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-shfill&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-shfill.php">＋<small>add a note</small></a></span>
