...
<head>
  ...
  <title>PHP: SNMPException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.snmpexception.php">
 <link rel="shorturl" href="https://www.php.net/snmpexception">
 <link rel="alternate" href="https://www.php.net/snmpexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/snmp.walk.php">
 <link rel="next" href="https://www.php.net/manual/en/book.sockets.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.snmpexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.snmpexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.snmpexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.snmpexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.snmpexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.snmpexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.snmpexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.snmpexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.snmpexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.snmpexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.snmpexception.php" hreflang="zh">
...
<meta name="Description" content="The SNMPException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SNMPException - Manual" />
<meta name="twitter:description" content="The SNMPException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SNMPException - Manual" />
<meta itemprop="description" content="The SNMPException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SNMPException class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.snmpexception.php' selected="selected">English</option>
            <option value='de/class.snmpexception.php'>German</option>
            <option value='es/class.snmpexception.php'>Spanish</option>
            <option value='fr/class.snmpexception.php'>French</option>
            <option value='it/class.snmpexception.php'>Italian</option>
            <option value='ja/class.snmpexception.php'>Japanese</option>
            <option value='pt_BR/class.snmpexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.snmpexception.php'>Russian</option>
            <option value='tr/class.snmpexception.php'>Turkish</option>
            <option value='uk/class.snmpexception.php'>Ukrainian</option>
            <option value='zh/class.snmpexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.snmpexception" class="reference">
 <h1 class="title">The SNMPException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="snmpexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Represents an error raised by SNMP.  You should not throw a 
    <span class="classname"><strong class="classname">SNMPException</strong></span> from your own code.
  ...
  <div class="section" id="snmpexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">SNMPException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="snmpexception.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="snmpexception.props.code"><var class="varname">code</var></dt>
     <dd>
      <p class="para">
       <code class="literal">SNMP</code> library error code. Use <span class="function"><a href="exception.getcode.php" class="function">Exception::getCode()</a></span> to access it.
      </p>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/snmpexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.snmpexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.snmpexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.snmpexception.php">＋<small>add a note</small></a></span>
