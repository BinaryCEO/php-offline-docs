...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/outcontrol.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/outcontrol.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/outcontrol.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/outcontrol.setup.php">
 <link rel="next" href="https://www.php.net/manual/en/outcontrol.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/outcontrol.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/outcontrol.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/outcontrol.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/outcontrol.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/outcontrol.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/outcontrol.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/outcontrol.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/outcontrol.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/outcontrol.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/outcontrol.configuration.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="outcontrol.constants.php">
          Predefined Constants &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="outcontrol.setup.php">
          &laquo; Installing/Configuring        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.php.php'>Affecting PHP's Behaviour</a></li>      <li><a href='book.outcontrol.php'>Output Control</a></li>      <li><a href='outcontrol.setup.php'>Installing/Configuring</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/outcontrol.configuration.php' selected="selected">English</option>
            <option value='de/outcontrol.configuration.php'>German</option>
            <option value='es/outcontrol.configuration.php'>Spanish</option>
            <option value='fr/outcontrol.configuration.php'>French</option>
            <option value='it/outcontrol.configuration.php'>Italian</option>
            <option value='ja/outcontrol.configuration.php'>Japanese</option>
            <option value='pt_BR/outcontrol.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/outcontrol.configuration.php'>Russian</option>
            <option value='tr/outcontrol.configuration.php'>Turkish</option>
            <option value='uk/outcontrol.configuration.php'>Ukrainian</option>
            <option value='zh/outcontrol.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="outcontrol.configuration" class="section">
    ...
    <span class="simpara">
     ...
     For example <code class="literal">&quot;php.net,wiki.php.net,bugs.php.net&quot;</code>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foutcontrol.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=outcontrol.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.configuration.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112938">  <div class="votes">
    <div id="Vu112938">
    <a href="/manual/vote-note.php?id=112938&amp;page=outcontrol.configuration&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112938">
    <a href="/manual/vote-note.php?id=112938&amp;page=outcontrol.configuration&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112938" title="53% like this...">
    7
    </div>
  </div>
  <a href="#112938" class="name">
  <strong class="user"><em>support at losalgendesign dot com</em></strong></a><a class="genanchor" href="#112938"> &para;</a><div class="date" title="2013-08-09 04:46"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112938">
<div class="phpcode"><code><span class="html">Using "OFF" or no value on output_buffering will disable header modifications, like redirects or content-type or content-disposition resulting in the error we commonly attribute to output before header modifications:<br /><br />Warning: Cannot modify header information - headers already sent by (output started at C:\PATH\filename.php:1) C:\PATH\filename.php on line 1<br /><br />Example code with output_buffering = OFF which results in this behavior.  Changing it to "ON" or giving it a value will likely cause normal behavior.<br /><br /><span class="default">&lt;?php header</span><span class="keyword">(</span><span class="string">"Location: <a href="http://www.php.net" rel="nofollow" target="_blank">http://www.php.net</a>"</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />or<br /><br /><span class="default">&lt;?php header</span><span class="keyword">(</span><span class="string">"Content-Type: text/Calendar"</span><span class="keyword">); </span><span class="default">?&gt;<br />&lt;?php header</span><span class="keyword">(</span><span class="string">"Content-Disposition: inline; filename=appointment.ics"</span><span class="keyword">); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=outcontrol.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.configuration.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="outcontrol.setup.php">Installing/Configuring</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="outcontrol.configuration.php" title="Runtime Configuration">Runtime Configuration</a>
                        </li>
