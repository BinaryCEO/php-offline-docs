...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.chown.php">
 <link rel="shorturl" href="https://www.php.net/chown">
 <link rel="alternate" href="https://www.php.net/chown" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.chmod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.clearstatcache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.chown.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.chown.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.chown.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.chown.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.chown.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.chown.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.chown.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.chown.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.chown.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.chown.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.chown.php" hreflang="zh">
...
<meta name="Description" content="Changes file owner" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: chown - Manual" />
<meta name="twitter:description" content="Changes file owner" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: chown - Manual" />
<meta itemprop="description" content="Changes file owner" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes file owner" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.clearstatcache.php">
          clearstatcache &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.chmod.php">
          &laquo; chmod        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.chown.php' selected="selected">English</option>
            <option value='de/function.chown.php'>German</option>
            <option value='es/function.chown.php'>Spanish</option>
            <option value='fr/function.chown.php'>French</option>
            <option value='it/function.chown.php'>Italian</option>
            <option value='ja/function.chown.php'>Japanese</option>
            <option value='pt_BR/function.chown.php'>Brazilian Portuguese</option>
            <option value='ru/function.chown.php'>Russian</option>
            <option value='tr/function.chown.php'>Turkish</option>
            <option value='uk/function.chown.php'>Ukrainian</option>
            <option value='zh/function.chown.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.chown" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">chown</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">chown</span> &mdash; <span class="dc-title">Changes file owner</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.chown-description">
  ...
  <p class="para rdfs-comment">
   Attempts to change the owner of the file <code class="parameter">filename</code>
   to user <code class="parameter">user</code>. Only the superuser may change the
   owner of a file.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.chgrp.php" class="function" rel="rdfs-seeAlso">chgrp()</a> - Changes file group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/chown.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.chown%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.chown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.chown.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="33261">  <div class="votes">
    <div id="Vu33261">
    <a href="/manual/vote-note.php?id=33261&amp;page=function.chown&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd33261">
    <a href="/manual/vote-note.php?id=33261&amp;page=function.chown&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V33261" title="60% like this...">
    7
    </div>
  </div>
  <a href="#33261" class="name">
  <strong class="user"><em>martijn at sigterm dot nl</em></strong></a><a class="genanchor" href="#33261"> &para;</a><div class="date" title="2003-06-20 07:28"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom33261">
<div class="phpcode"><code><span class="html">If chown is filled with a variable (  chown ("myfile", $uid) the uid will be looked up through pwget_uid.<br /><br />So if you need to set a non existing uid use inval($uid).</span></code></div>
  </div>
 </div>
  <div class="note" id="129999">  <div class="votes">
    <div id="Vu129999">
    <a href="/manual/vote-note.php?id=129999&amp;page=function.chown&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129999">
    <a href="/manual/vote-note.php?id=129999&amp;page=function.chown&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129999" title="100% like this...">
    2
    </div>
  </div>
  <a href="#129999" class="name">
  <strong class="user"><em>mindlessconsumer+phpnet at gmail dot com</em></strong></a><a class="genanchor" href="#129999"> &para;</a><div class="date" title="2025-01-28 07:22"><strong>8 months ago</strong></div>
  <div class="text" id="Hcom129999">
<div class="phpcode"><code><span class="html">It may be worth making explicitly clear that, while the shell's `chown` command allows both user and group to be set in one system call like this `chown username:groupname filename`, PHP's version unfortunately does not: <br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// This will not work. <br /></span><span class="default">chown</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="string">'username:groupname'</span><span class="keyword">);<br /><br /></span><span class="comment">// You have to use two separate calls.<br /></span><span class="default">chown</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="string">'username'</span><span class="keyword">);<br /></span><span class="default">chgrp</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="string">'groupname'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.chown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.chown.php">＋<small>add a note</small></a></div>
