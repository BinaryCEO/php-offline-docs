...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.yaz.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/varnishlog.gettagname.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.yaz.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.yaz.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.yaz.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.yaz.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.yaz.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.yaz.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.yaz.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.yaz.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.yaz.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.yaz.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.yaz.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.yaz.php" hreflang="zh">
...
<meta name="Description" content="YAZ" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: YAZ - Manual" />
<meta name="twitter:description" content="YAZ" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: YAZ - Manual" />
<meta itemprop="description" content="YAZ" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="YAZ" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.yaz.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="varnishlog.gettagname.php">
          &laquo; VarnishLog::getTagName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.yaz.php' selected="selected">English</option>
            <option value='de/book.yaz.php'>German</option>
            <option value='es/book.yaz.php'>Spanish</option>
            <option value='fr/book.yaz.php'>French</option>
            <option value='it/book.yaz.php'>Italian</option>
            <option value='ja/book.yaz.php'>Japanese</option>
            <option value='pt_BR/book.yaz.php'>Brazilian Portuguese</option>
            <option value='ru/book.yaz.php'>Russian</option>
            <option value='tr/book.yaz.php'>Turkish</option>
            <option value='uk/book.yaz.php'>Ukrainian</option>
            <option value='zh/book.yaz.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.yaz" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.yaz.php">Introduction</a></li><li><a href="yaz.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="yaz.requirements.php">Requirements</a></li><li><a href="yaz.installation.php">Installation</a></li></ul></li><li><a href="yaz.examples.php">Examples</a></li><li><a href="ref.yaz.php">YAZ Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.yaz-addinfo.php">yaz_addinfo</a> — Returns additional error information</li><li><a href="function.yaz-ccl-conf.php">yaz_ccl_conf</a> — Configure CCL parser</li><li><a href="function.yaz-ccl-parse.php">yaz_ccl_parse</a> — Invoke CCL Parser</li><li><a href="function.yaz-close.php">yaz_close</a> — Close YAZ connection</li><li><a href="function.yaz-connect.php">yaz_connect</a> — Prepares for a connection to a Z39.50 server</li><li><a href="function.yaz-database.php">yaz_database</a> — Specifies the databases within a session</li><li><a href="function.yaz-element.php">yaz_element</a> — Specifies Element-Set Name for retrieval</li><li><a href="function.yaz-errno.php">yaz_errno</a> — Returns error number</li><li><a href="function.yaz-error.php">yaz_error</a> — Returns error description</li><li><a href="function.yaz-es.php">yaz_es</a> — Prepares for an Extended Service Request</li><li><a href="function.yaz-es-result.php">yaz_es_result</a> — Inspects Extended Services Result</li><li><a href="function.yaz-get-option.php">yaz_get_option</a> — Returns value of option for connection</li><li><a href="function.yaz-hits.php">yaz_hits</a> — Returns number of hits for last search</li><li><a href="function.yaz-itemorder.php">yaz_itemorder</a> — Prepares for Z39.50 Item Order with an ILL-Request package</li><li><a href="function.yaz-present.php">yaz_present</a> — Prepares for retrieval (Z39.50 present)</li><li><a href="function.yaz-range.php">yaz_range</a> — Specifies a range of records to retrieve</li><li><a href="function.yaz-record.php">yaz_record</a> — Returns a record</li><li><a href="function.yaz-scan.php">yaz_scan</a> — Prepares for a scan</li><li><a href="function.yaz-scan-result.php">yaz_scan_result</a> — Returns Scan Response result</li><li><a href="function.yaz-schema.php">yaz_schema</a> — Specifies schema for retrieval</li><li><a href="function.yaz-search.php">yaz_search</a> — Prepares for a search</li><li><a href="function.yaz-set-option.php">yaz_set_option</a> — Sets one or more options for connection</li><li><a href="function.yaz-sort.php">yaz_sort</a> — Sets sorting criteria</li><li><a href="function.yaz-syntax.php">yaz_syntax</a> — Specifies the preferred record syntax for retrieval</li><li><a href="function.yaz-wait.php">yaz_wait</a> — Wait for Z39.50 requests to complete</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.yaz%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.yaz&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.yaz.php">＋<small>add a note</small></a></span>
