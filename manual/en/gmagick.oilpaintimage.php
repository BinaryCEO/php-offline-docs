...
<head>
  ...
  <title>PHP: Gmagick::oilpaintimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.normalizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.previousimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.oilpaintimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.oilpaintimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.oilpaintimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.oilpaintimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.oilpaintimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.oilpaintimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.oilpaintimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.oilpaintimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.oilpaintimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.oilpaintimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::oilpaintimage - Manual" />
<meta name="twitter:description" content="Simulates an oil painting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::oilpaintimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.previousimage.php">
          Gmagick::previousimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.normalizeimage.php">
          &laquo; Gmagick::normalizeimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.oilpaintimage.php' selected="selected">English</option>
            <option value='de/gmagick.oilpaintimage.php'>German</option>
            <option value='es/gmagick.oilpaintimage.php'>Spanish</option>
            <option value='fr/gmagick.oilpaintimage.php'>French</option>
            <option value='it/gmagick.oilpaintimage.php'>Italian</option>
            <option value='ja/gmagick.oilpaintimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.oilpaintimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.oilpaintimage.php'>Russian</option>
            <option value='tr/gmagick.oilpaintimage.php'>Turkish</option>
            <option value='uk/gmagick.oilpaintimage.php'>Ukrainian</option>
            <option value='zh/gmagick.oilpaintimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.oilpaintimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::oilpaintimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::oilpaintimage</span> &mdash; <span class="dc-title">Simulates an oil painting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.oilpaintimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::oilpaintimage</strong></span>(<span class="methodparam">
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.oilpaintimage-parameters">
  <h3 class="title">Parameters</h3>
   <p class="para">
     <dl>
       
         <dt>
           <code class="parameter">radius</code>
         </dt>
         <dd>
           <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.oilpaintimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.oilpaintimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/oilpaintimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.oilpaintimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.oilpaintimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.oilpaintimage.php">＋<small>add a note</small></a></span>
