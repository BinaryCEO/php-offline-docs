...
<head>
  ...
  <title>PHP: ImagickKernel::fromMatrix - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickkernel.frommatrix.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickkernel.frommatrix.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickkernel.frommatrix.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickkernel.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickkernel.frombuiltin.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickkernel.getmatrix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickkernel.frommatrix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickkernel.frommatrix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickkernel.frommatrix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickkernel.frommatrix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickkernel.frommatrix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickkernel.frommatrix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickkernel.frommatrix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickkernel.frommatrix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickkernel.frommatrix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickkernel.frommatrix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickkernel.frommatrix.php" hreflang="zh">
...
<meta name="Description" content="Create a kernel from a 2d matrix of values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickKernel::fromMatrix - Manual" />
<meta name="twitter:description" content="Create a kernel from a 2d matrix of values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickKernel::fromMatrix - Manual" />
<meta itemprop="description" content="Create a kernel from a 2d matrix of values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a kernel from a 2d matrix of values" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickkernel.getmatrix.php">
          ImagickKernel::getMatrix &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickkernel.frombuiltin.php">
          &laquo; ImagickKernel::fromBuiltIn        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickkernel.frommatrix.php' selected="selected">English</option>
            <option value='de/imagickkernel.frommatrix.php'>German</option>
            <option value='es/imagickkernel.frommatrix.php'>Spanish</option>
            <option value='fr/imagickkernel.frommatrix.php'>French</option>
            <option value='it/imagickkernel.frommatrix.php'>Italian</option>
            <option value='ja/imagickkernel.frommatrix.php'>Japanese</option>
            <option value='pt_BR/imagickkernel.frommatrix.php'>Brazilian Portuguese</option>
            <option value='ru/imagickkernel.frommatrix.php'>Russian</option>
            <option value='tr/imagickkernel.frommatrix.php'>Turkish</option>
            <option value='uk/imagickkernel.frommatrix.php'>Ukrainian</option>
            <option value='zh/imagickkernel.frommatrix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickkernel.frommatrix" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickKernel::fromMatrix</h1>
  <p class="verinfo">(PECL imagick &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">ImagickKernel::fromMatrix</span> &mdash; <span class="dc-title">Create a kernel from a 2d matrix of values</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagickkernel.frommatrix-examples">
  ...
  <p class="para">
    <div class="example" id="example-3221">
      <p><strong>Example #1  <span class="function"><strong>ImagickKernel::fromMatrix()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickkernel/frommatrix.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickkernel.frommatrix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickkernel.frommatrix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickkernel.frommatrix.php">＋<small>add a note</small></a></span>
