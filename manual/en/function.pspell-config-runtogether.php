...
<head>
  ...
  <title>PHP: pspell_config_runtogether - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-config-runtogether.php">
 <link rel="shorturl" href="https://www.php.net/pspell-config-runtogether">
 <link rel="alternate" href="https://www.php.net/pspell-config-runtogether" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-config-repl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-config-save-repl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-config-runtogether.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-config-runtogether.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-config-runtogether.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-config-runtogether.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-config-runtogether.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-config-runtogether.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-config-runtogether.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-config-runtogether.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-config-runtogether.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-config-runtogether.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-config-runtogether.php" hreflang="zh">
...
<meta name="Description" content="Consider run-together words as valid compounds" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_config_runtogether - Manual" />
<meta name="twitter:description" content="Consider run-together words as valid compounds" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_config_runtogether - Manual" />
<meta itemprop="description" content="Consider run-together words as valid compounds" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Consider run-together words as valid compounds" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-config-save-repl.php">
          pspell_config_save_repl &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-config-repl.php">
          &laquo; pspell_config_repl        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-config-runtogether.php' selected="selected">English</option>
            <option value='de/function.pspell-config-runtogether.php'>German</option>
            <option value='es/function.pspell-config-runtogether.php'>Spanish</option>
            <option value='fr/function.pspell-config-runtogether.php'>French</option>
            <option value='it/function.pspell-config-runtogether.php'>Italian</option>
            <option value='ja/function.pspell-config-runtogether.php'>Japanese</option>
            <option value='pt_BR/function.pspell-config-runtogether.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-config-runtogether.php'>Russian</option>
            <option value='tr/function.pspell-config-runtogether.php'>Turkish</option>
            <option value='uk/function.pspell-config-runtogether.php'>Ukrainian</option>
            <option value='zh/function.pspell-config-runtogether.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-config-runtogether" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pspell_config_runtogether</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pspell_config_runtogether</span> &mdash; <span class="dc-title">Consider run-together words as valid compounds</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pspell-config-runtogether-description">
  ...
  <p class="para rdfs-comment">
   ...
   affects the results returned by <span class="function"><a href="function.pspell-check.php" class="function">pspell_check()</a></span>;
   <span class="function"><a href="function.pspell-suggest.php" class="function">pspell_suggest()</a></span> will still return suggestions.
  </p>
  <p class="para">
   <span class="function"><strong>pspell_config_runtogether()</strong></span> should be used on a config
 ...
 <div class="refsect1 parameters" id="refsect1-function.pspell-config-runtogether-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if run-together words should be treated as legal compounds,
 ...
 <div class="refsect1 examples" id="refsect1-function.pspell-config-runtogether-examples">
  ...
  <p class="para">
   <div class="example" id="example-2803">
    <p><strong>Example #1 <span class="function"><strong>pspell_config_runtogether()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell_config </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_config_create</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_config_runtogether</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new_config</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">, </span><span style="color: #DD0000">"thecat"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-config-runtogether.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-config-runtogether%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-config-runtogether&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-config-runtogether.php">＋<small>add a note</small></a></span>
