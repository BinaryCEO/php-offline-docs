...
<head>
  ...
  <title>PHP: Yaf_Route_Interface - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-route-interface.php">
 <link rel="shorturl" href="https://www.php.net/yaf-route-interface">
 <link rel="alternate" href="https://www.php.net/yaf-route-interface" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-response-abstract.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-route-interface.assemble.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-route-interface.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-route-interface.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-route-interface.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-route-interface.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-route-interface.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-route-interface.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-route-interface.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-route-interface.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-route-interface.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-route-interface.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-route-interface.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Route_Interface class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Route_Interface - Manual" />
<meta name="twitter:description" content="The Yaf_Route_Interface class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Route_Interface - Manual" />
<meta itemprop="description" content="The Yaf_Route_Interface class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Route_Interface class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yaf-route-interface.assemble.php">
          Yaf_Route_Interface::assemble &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yaf-response-abstract.tostring.php">
          &laquo; Yaf_Response_Abstract::__toString        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-route-interface.php' selected="selected">English</option>
            <option value='de/class.yaf-route-interface.php'>German</option>
            <option value='es/class.yaf-route-interface.php'>Spanish</option>
            <option value='fr/class.yaf-route-interface.php'>French</option>
            <option value='it/class.yaf-route-interface.php'>Italian</option>
            <option value='ja/class.yaf-route-interface.php'>Japanese</option>
            <option value='pt_BR/class.yaf-route-interface.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-route-interface.php'>Russian</option>
            <option value='tr/class.yaf-route-interface.php'>Turkish</option>
            <option value='uk/class.yaf-route-interface.php'>Ukrainian</option>
            <option value='zh/class.yaf-route-interface.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-route-interface" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>
  ...
  <div class="section" id="yaf-route-interface.intro">
   ...
   <p class="para">
    <span class="classname"><strong class="classname">Yaf_Route_Interface</strong></span> used for developer defined
    their custom route.
   </p>
  </div>
  ...
  <div class="section" id="yaf-route-interface.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Yaf_Route_Interface</strong>
     </span>
     {</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-route-interface.assemble.php">Yaf_Route_Interface::assemble</a> — Assemble a request</li><li><a href="yaf-route-interface.route.php">Yaf_Route_Interface::route</a> — Route a request</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-route-interface.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-route-interface%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-route-interface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-route-interface.php">＋<small>add a note</small></a></span>
