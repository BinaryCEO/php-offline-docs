...
<head>
  ...
  <title>PHP: fbird_errcode - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-errcode.php">
 <link rel="shorturl" href="https://www.php.net/fbird-errcode">
 <link rel="alternate" href="https://www.php.net/fbird-errcode" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-drop-db.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-errmsg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-errcode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-errcode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-errcode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-errcode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-errcode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-errcode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-errcode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-errcode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-errcode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-errcode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-errcode.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_errcode" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_errcode - Manual" />
<meta name="twitter:description" content="Alias of ibase_errcode" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_errcode - Manual" />
<meta itemprop="description" content="Alias of ibase_errcode" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_errcode" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-errmsg.php">
          fbird_errmsg &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-drop-db.php">
          &laquo; fbird_drop_db        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-errcode.php' selected="selected">English</option>
            <option value='de/function.fbird-errcode.php'>German</option>
            <option value='es/function.fbird-errcode.php'>Spanish</option>
            <option value='fr/function.fbird-errcode.php'>French</option>
            <option value='it/function.fbird-errcode.php'>Italian</option>
            <option value='ja/function.fbird-errcode.php'>Japanese</option>
            <option value='pt_BR/function.fbird-errcode.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-errcode.php'>Russian</option>
            <option value='tr/function.fbird-errcode.php'>Turkish</option>
            <option value='uk/function.fbird-errcode.php'>Ukrainian</option>
            <option value='zh/function.fbird-errcode.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-errcode" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_errcode</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_errcode</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-errcode.php" class="function">ibase_errcode()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-errcode-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-errcode.php" class="function">ibase_errcode()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fbird-errcode-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-errmsg.php" class="function" rel="rdfs-seeAlso">fbird_errmsg()</a> - Alias of ibase_errmsg</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-errcode.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-errcode%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-errcode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-errcode.php">＋<small>add a note</small></a></span>
