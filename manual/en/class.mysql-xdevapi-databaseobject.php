...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mysql-xdevapi-databaseobject.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-crudoperationsortable.sort.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-databaseobject.existsindatabase.php">
...
<meta name="Description" content="DatabaseObject interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_xdevapi\DatabaseObject - Manual" />
<meta name="twitter:description" content="DatabaseObject interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_xdevapi\DatabaseObject - Manual" />
<meta itemprop="description" content="DatabaseObject interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="DatabaseObject interface" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mysql-xdevapi-databaseobject.php' selected="selected">English</option>
            <option value='de/class.mysql-xdevapi-databaseobject.php'>German</option>
 ...
 <h1 class="title">DatabaseObject interface</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mysql-xdevapi-databaseobject.existsindatabase.php">DatabaseObject::existsInDatabase</a> — Check if object exists in database</li><li><a href="mysql-xdevapi-databaseobject.getname.php">DatabaseObject::getName</a> — Get object name</li><li><a href="mysql-xdevapi-databaseobject.getsession.php">DatabaseObject::getSession</a> — Get session name</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql-xdevapi.databaseobject.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mysql-xdevapi-databaseobject%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mysql-xdevapi-databaseobject&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mysql-xdevapi-databaseobject.php">＋<small>add a note</small></a></span>
