...
<head>
  ...
  <title>PHP: WinCache - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.wincache.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.uopz-unset-return.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.wincache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.wincache.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.wincache.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.wincache.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.wincache.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.wincache.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.wincache.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.wincache.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.wincache.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.wincache.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.wincache.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.wincache.php" hreflang="zh">
...
<meta name="Description" content="Windows Cache for PHP" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: WinCache - Manual" />
<meta name="twitter:description" content="Windows Cache for PHP" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: WinCache - Manual" />
<meta itemprop="description" content="Windows Cache for PHP" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Windows Cache for PHP" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.wincache.php' selected="selected">English</option>
            <option value='de/book.wincache.php'>German</option>
            <option value='es/book.wincache.php'>Spanish</option>
            <option value='fr/book.wincache.php'>French</option>
            <option value='it/book.wincache.php'>Italian</option>
            <option value='ja/book.wincache.php'>Japanese</option>
            <option value='pt_BR/book.wincache.php'>Brazilian Portuguese</option>
            <option value='ru/book.wincache.php'>Russian</option>
            <option value='tr/book.wincache.php'>Turkish</option>
            <option value='uk/book.wincache.php'>Ukrainian</option>
            <option value='zh/book.wincache.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.wincache" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.wincache.php">Introduction</a></li><li><a href="wincache.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="wincache.requirements.php">Requirements</a></li><li><a href="wincache.installation.php">Installation</a></li><li><a href="wincache.configuration.php">Runtime Configuration</a></li><li><a href="wincache.stats.php">WinCache Statistics Script</a></li><li><a href="wincache.sessionhandler.php">WinCache Session Handler</a></li><li><a href="wincache.reroutes.php">WinCache Functions Reroutes</a></li></ul></li><li><a href="ref.wincache.php">WinCache Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.wincache-fcache-fileinfo.php">wincache_fcache_fileinfo</a> — Retrieves information about files cached in the file cache</li><li><a href="function.wincache-fcache-meminfo.php">wincache_fcache_meminfo</a> — Retrieves information about file cache memory usage</li><li><a href="function.wincache-lock.php">wincache_lock</a> — Acquires an exclusive lock on a given key</li><li><a href="function.wincache-ocache-fileinfo.php">wincache_ocache_fileinfo</a> — Retrieves information about files cached in the opcode cache</li><li><a href="function.wincache-ocache-meminfo.php">wincache_ocache_meminfo</a> — Retrieves information about opcode cache memory usage</li><li><a href="function.wincache-refresh-if-changed.php">wincache_refresh_if_changed</a> — Refreshes the cache entries for the cached files</li><li><a href="function.wincache-rplist-fileinfo.php">wincache_rplist_fileinfo</a> — Retrieves information about resolve file path cache</li><li><a href="function.wincache-rplist-meminfo.php">wincache_rplist_meminfo</a> — Retrieves information about memory usage by the resolve file path cache</li><li><a href="function.wincache-scache-info.php">wincache_scache_info</a> — Retrieves information about files cached in the session cache</li><li><a href="function.wincache-scache-meminfo.php">wincache_scache_meminfo</a> — Retrieves information about session cache memory usage</li><li><a href="function.wincache-ucache-add.php">wincache_ucache_add</a> — Adds a variable in user cache only if variable does not already exist in the cache</li><li><a href="function.wincache-ucache-cas.php">wincache_ucache_cas</a> — Compares the variable with old value and assigns new value to it</li><li><a href="function.wincache-ucache-clear.php">wincache_ucache_clear</a> — Deletes entire content of the user cache</li><li><a href="function.wincache-ucache-dec.php">wincache_ucache_dec</a> — Decrements the value associated with the key</li><li><a href="function.wincache-ucache-delete.php">wincache_ucache_delete</a> — Deletes variables from the user cache</li><li><a href="function.wincache-ucache-exists.php">wincache_ucache_exists</a> — Checks if a variable exists in the user cache</li><li><a href="function.wincache-ucache-get.php">wincache_ucache_get</a> — Gets a variable stored in the user cache</li><li><a href="function.wincache-ucache-inc.php">wincache_ucache_inc</a> — Increments the value associated with the key</li><li><a href="function.wincache-ucache-info.php">wincache_ucache_info</a> — Retrieves information about data stored in the user cache</li><li><a href="function.wincache-ucache-meminfo.php">wincache_ucache_meminfo</a> — Retrieves information about user cache memory usage</li><li><a href="function.wincache-ucache-set.php">wincache_ucache_set</a> — Adds a variable in user cache and overwrites a variable if it already exists in the cache</li><li><a href="function.wincache-unlock.php">wincache_unlock</a> — Releases an exclusive lock on a given key</li></ul></li><li><a href="wincache.win32build.php">Building for Windows</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="wincache.win32build.prereq.php">Prerequisites</a></li><li><a href="wincache.win32build.building.php">Compiling and building</a></li><li><a href="wincache.win32build.verify.php">Verifying the build</a></li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.wincache%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.wincache&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.wincache.php">＋<small>add a note</small></a></span>
