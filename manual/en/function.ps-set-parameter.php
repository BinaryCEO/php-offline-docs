...
<head>
  ...
  <title>PHP: ps_set_parameter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-parameter.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-parameter">
 <link rel="alternate" href="https://www.php.net/ps-set-parameter" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-text-pos.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-parameter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-parameter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-parameter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-parameter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-parameter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-parameter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-parameter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-parameter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-parameter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-parameter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-parameter.php" hreflang="zh">
...
<meta name="Description" content="Sets certain parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_parameter - Manual" />
<meta name="twitter:description" content="Sets certain parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_parameter - Manual" />
<meta itemprop="description" content="Sets certain parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets certain parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-set-text-pos.php">
          ps_set_text_pos &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-set-info.php">
          &laquo; ps_set_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-parameter.php' selected="selected">English</option>
            <option value='de/function.ps-set-parameter.php'>German</option>
            <option value='es/function.ps-set-parameter.php'>Spanish</option>
            <option value='fr/function.ps-set-parameter.php'>French</option>
            <option value='it/function.ps-set-parameter.php'>Italian</option>
            <option value='ja/function.ps-set-parameter.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-parameter.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-parameter.php'>Russian</option>
            <option value='tr/function.ps-set-parameter.php'>Turkish</option>
            <option value='uk/function.ps-set-parameter.php'>Ukrainian</option>
            <option value='zh/function.ps-set-parameter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-parameter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_set_parameter</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_set_parameter</span> &mdash; <span class="dc-title">Sets certain parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-set-parameter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_parameter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-set-parameter-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       For a list of possible names see <span class="function"><a href="function.ps-get-parameter.php" class="function">ps_get_parameter()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-set-parameter-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-set-parameter-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><strong>ps_get_parameters()</strong></span></li>
    <li><span class="function"><a href="function.ps-set-value.php" class="function" rel="rdfs-seeAlso">ps_set_value()</a> - Sets certain values</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-parameter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-parameter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-parameter.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91495">  <div class="votes">
    <div id="Vu91495">
    <a href="/manual/vote-note.php?id=91495&amp;page=function.ps-set-parameter&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91495">
    <a href="/manual/vote-note.php?id=91495&amp;page=function.ps-set-parameter&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91495" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#91495" class="name">
  <strong class="user"><em>php at catchall dot toao dot net</em></strong></a><a class="genanchor" href="#91495"> &para;</a><div class="date" title="2009-06-12 08:54"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91495">
<div class="phpcode"><code><span class="html">Note that when setting a parameter such as "true" or "false", in this case "true" and "false" are strings.<br />Correct syntax would be:<br /><span class="default">&lt;?php ps_set_parameter</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="string">"linebreak"</span><span class="keyword">, </span><span class="string">"true"</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>This does NOT work:<br /><span class="default">&lt;?php ps_set_parameter</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="string">"linebreak"</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-set-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-parameter.php">＋<small>add a note</small></a></div>
