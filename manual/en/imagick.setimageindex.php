...
<head>
  ...
  <title>PHP: Imagick::setImageIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageindex.php" hreflang="zh">
...
<meta name="Description" content="Set the iterator position" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageIndex - Manual" />
<meta name="twitter:description" content="Set the iterator position" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageIndex - Manual" />
<meta itemprop="description" content="Set the iterator position" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the iterator position" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageinterlacescheme.php">
          Imagick::setImageInterlaceScheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagegreenprimary.php">
          &laquo; Imagick::setImageGreenPrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageindex.php' selected="selected">English</option>
            <option value='de/imagick.setimageindex.php'>German</option>
            <option value='es/imagick.setimageindex.php'>Spanish</option>
            <option value='fr/imagick.setimageindex.php'>French</option>
            <option value='it/imagick.setimageindex.php'>Italian</option>
            <option value='ja/imagick.setimageindex.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageindex.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageindex.php'>Russian</option>
            <option value='tr/imagick.setimageindex.php'>Turkish</option>
            <option value='uk/imagick.setimageindex.php'>Ukrainian</option>
            <option value='zh/imagick.setimageindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageIndex</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageIndex</span> &mdash; <span class="dc-title">Set the iterator position</span></p>

 </div>

 <div id="imagick.setimageindex-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimageindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageIndex</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="imagick.setiteratorindex.php" class="function">Imagick::setIteratorIndex()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.setimageindex-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageindex-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageindex-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageindex.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110296">  <div class="votes">
    <div id="Vu110296">
    <a href="/manual/vote-note.php?id=110296&amp;page=imagick.setimageindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110296">
    <a href="/manual/vote-note.php?id=110296&amp;page=imagick.setimageindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110296" title="100% like this...">
    2
    </div>
  </div>
  <a href="#110296" class="name">
  <strong class="user"><em>Rob Hidalgo</em></strong></a><a class="genanchor" href="#110296"> &para;</a><div class="date" title="2012-10-09 05:05"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110296">
<div class="phpcode"><code><span class="html">When reading a PDF from an ImageBlob, and you want to set the page to be used, this is the function to use.</span></code></div>
  </div>
 </div>
  <div class="note" id="112013">  <div class="votes">
    <div id="Vu112013">
    <a href="/manual/vote-note.php?id=112013&amp;page=imagick.setimageindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112013">
    <a href="/manual/vote-note.php?id=112013&amp;page=imagick.setimageindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112013" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#112013" class="name">
  <strong class="user"><em>maulik_Vr at yahoo dot co dot in</em></strong></a><a class="genanchor" href="#112013"> &para;</a><div class="date" title="2013-04-22 07:37"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112013">
<div class="phpcode"><code><span class="html">when you read pdf by getImageBlog and want to get the image or blob of a specific page, use this function as below.<br /><br />$ims = new Imagick();<br />        <br />$ims-&gt;readImageBlob($pdfFileContent);<br />        <br />$ims-&gt;setImageIndex(5); //this will return 6th page of the pdf file<br />$image-&gt;setImageFormat('png');<br />            //etc <br />$blob = $image-&gt;getImageBlob();</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimageindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageindex.php">＋<small>add a note</small></a></div>
