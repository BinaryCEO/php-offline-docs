...
<head>
  ...
  <title>PHP: nl_langinfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.nl-langinfo.php">
 <link rel="shorturl" href="https://www.php.net/nl-langinfo">
 <link rel="alternate" href="https://www.php.net/nl-langinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.money-format.php">
 <link rel="next" href="https://www.php.net/manual/en/function.nl2br.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.nl-langinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.nl-langinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.nl-langinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.nl-langinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.nl-langinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.nl-langinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.nl-langinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.nl-langinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.nl-langinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.nl-langinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.nl-langinfo.php" hreflang="zh">
...
<meta name="Description" content="Query language and locale information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: nl_langinfo - Manual" />
<meta name="twitter:description" content="Query language and locale information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: nl_langinfo - Manual" />
<meta itemprop="description" content="Query language and locale information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Query language and locale information" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.nl-langinfo.php' selected="selected">English</option>
            <option value='de/function.nl-langinfo.php'>German</option>
            <option value='es/function.nl-langinfo.php'>Spanish</option>
            <option value='fr/function.nl-langinfo.php'>French</option>
            <option value='it/function.nl-langinfo.php'>Italian</option>
            <option value='ja/function.nl-langinfo.php'>Japanese</option>
            <option value='pt_BR/function.nl-langinfo.php'>Brazilian Portuguese</option>
            <option value='ru/function.nl-langinfo.php'>Russian</option>
            <option value='tr/function.nl-langinfo.php'>Turkish</option>
            <option value='uk/function.nl-langinfo.php'>Ukrainian</option>
            <option value='zh/function.nl-langinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.nl-langinfo" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.nl-langinfo-examples">
  ...
  <p class="para">
   <div class="example" id="example-5091">
    <p><strong>Example #1 <span class="function"><strong>nl_langinfo()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.localeconv.php" class="function" rel="rdfs-seeAlso">localeconv()</a> - Get numeric formatting information</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/nl-langinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.nl-langinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.nl-langinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.nl-langinfo.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="62871">  <div class="votes">
    <div id="Vu62871">
    <a href="/manual/vote-note.php?id=62871&amp;page=function.nl-langinfo&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd62871">
    <a href="/manual/vote-note.php?id=62871&amp;page=function.nl-langinfo&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V62871" title="75% like this...">
    6
    </div>
  </div>
  <a href="#62871" class="name">
  <strong class="user"><em>avatar_at_hot_ee</em></strong></a><a class="genanchor" href="#62871"> &para;</a><div class="date" title="2006-03-11 07:58"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom62871">
<div class="phpcode"><code><span class="html">The value MON_(1-12) has special behavior in Russian locale: it returns declinated month names, that can be used as part of a date string, but not on their own.<br /><br />For instance instead of "Январь" (the proper nominative form) it returns "Января" (form declinated for use in dates).<br /><br />There seems to be no way to get the nominative form of the month name - one has to use translations instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.nl-langinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.nl-langinfo.php">＋<small>add a note</small></a></div>
