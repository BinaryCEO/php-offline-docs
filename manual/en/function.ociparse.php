...
<head>
  ...
  <title>PHP: ociparse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ociparse.php">
 <link rel="shorturl" href="https://www.php.net/ociparse">
 <link rel="alternate" href="https://www.php.net/ociparse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocinumcols.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociplogon.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ociparse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ociparse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ociparse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ociparse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ociparse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ociparse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ociparse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ociparse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ociparse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ociparse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ociparse.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_parse" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ociparse - Manual" />
<meta name="twitter:description" content="Alias of oci_parse" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ociparse - Manual" />
<meta itemprop="description" content="Alias of oci_parse" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_parse" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ociparse.php' selected="selected">English</option>
            <option value='de/function.ociparse.php'>German</option>
            <option value='es/function.ociparse.php'>Spanish</option>
            <option value='fr/function.ociparse.php'>French</option>
            <option value='it/function.ociparse.php'>Italian</option>
            <option value='ja/function.ociparse.php'>Japanese</option>
            <option value='pt_BR/function.ociparse.php'>Brazilian Portuguese</option>
            <option value='ru/function.ociparse.php'>Russian</option>
            <option value='tr/function.ociparse.php'>Turkish</option>
            <option value='uk/function.ociparse.php'>Ukrainian</option>
            <option value='zh/function.ociparse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ociparse" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ociparse</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ociparse</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-parse.php" class="function">oci_parse()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ociparse-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-parse.php" class="function">oci_parse()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ociparse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ociparse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ociparse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ociparse.php">＋<small>add a note</small></a></span>
