...
<head>
  ...
  <title>PHP: GearmanClient::setStatusCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setstatuscallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setstatuscallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setstatuscallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.setoptions.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.settimeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setstatuscallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.setstatuscallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.setstatuscallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.setstatuscallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.setstatuscallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.setstatuscallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.setstatuscallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.setstatuscallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.setstatuscallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.setstatuscallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.setstatuscallback.php" hreflang="zh">
...
<meta name="Description" content="Set a callback for collecting task status" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setStatusCallback - Manual" />
<meta name="twitter:description" content="Set a callback for collecting task status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setStatusCallback - Manual" />
<meta itemprop="description" content="Set a callback for collecting task status" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a callback for collecting task status" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.settimeout.php">
          GearmanClient::setTimeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.setoptions.php">
          &laquo; GearmanClient::setOptions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setstatuscallback.php' selected="selected">English</option>
            <option value='de/gearmanclient.setstatuscallback.php'>German</option>
            <option value='es/gearmanclient.setstatuscallback.php'>Spanish</option>
            <option value='fr/gearmanclient.setstatuscallback.php'>French</option>
            <option value='it/gearmanclient.setstatuscallback.php'>Italian</option>
            <option value='ja/gearmanclient.setstatuscallback.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.setstatuscallback.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.setstatuscallback.php'>Russian</option>
            <option value='tr/gearmanclient.setstatuscallback.php'>Turkish</option>
            <option value='uk/gearmanclient.setstatuscallback.php'>Ukrainian</option>
            <option value='zh/gearmanclient.setstatuscallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.setstatuscallback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::setStatusCallback</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::setStatusCallback</span> &mdash; <span class="dc-title">Set a callback for collecting task status</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gearmanclient.setstatuscallback-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::setStatusCallback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gearmanclient.setstatuscallback-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.setstatuscallback-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanclient.setstatuscallback-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setstatuscallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setstatuscallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setstatuscallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setstatuscallback.php">＋<small>add a note</small></a></span>
