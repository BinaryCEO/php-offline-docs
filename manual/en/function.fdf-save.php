...
<head>
  ...
  <title>PHP: fdf_save - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-save.php">
 <link rel="shorturl" href="https://www.php.net/fdf-save">
 <link rel="alternate" href="https://www.php.net/fdf-save" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-remove-item.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-save-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-save.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-save.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-save.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-save.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-save.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-save.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-save.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-save.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-save.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-save.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-save.php" hreflang="zh">
...
<meta name="Description" content="Save a FDF document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_save - Manual" />
<meta name="twitter:description" content="Save a FDF document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_save - Manual" />
<meta itemprop="description" content="Save a FDF document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Save a FDF document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fdf-save-string.php">
          fdf_save_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fdf-remove-item.php">
          &laquo; fdf_remove_item        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-save.php' selected="selected">English</option>
            <option value='de/function.fdf-save.php'>German</option>
            <option value='es/function.fdf-save.php'>Spanish</option>
            <option value='fr/function.fdf-save.php'>French</option>
            <option value='it/function.fdf-save.php'>Italian</option>
            <option value='ja/function.fdf-save.php'>Japanese</option>
            <option value='pt_BR/function.fdf-save.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-save.php'>Russian</option>
            <option value='tr/function.fdf-save.php'>Turkish</option>
            <option value='uk/function.fdf-save.php'>Ukrainian</option>
            <option value='zh/function.fdf-save.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-save" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fdf-save-string.php" class="function" rel="rdfs-seeAlso">fdf_save_string()</a> - Returns the FDF document as a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-save.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-save%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-save&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-save.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="31164">  <div class="votes">
    <div id="Vu31164">
    <a href="/manual/vote-note.php?id=31164&amp;page=function.fdf-save&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31164">
    <a href="/manual/vote-note.php?id=31164&amp;page=function.fdf-save&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31164" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#31164" class="name">
  <strong class="user"><em>karsten at k-fish dot de</em></strong></a><a class="genanchor" href="#31164"> &para;</a><div class="date" title="2003-04-11 10:18"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31164">
<div class="phpcode"><code><span class="html">The doc says that an empty file name will cause PHP to output the FDF to 'stdout'. I had no success on this (with PHP 4.2.3 and fdftk v5): no string, an empty string and null all returned a message complaining about 'wrong parameter count'.<br /><br />So I used the way (saving to a file and using passthru) given as an example on the page describing fdf_create(), and added a uniqid(rand(),1) to the filename to avoid clashes. This worked well.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fdf-save&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-save.php">＋<small>add a note</small></a></div>
