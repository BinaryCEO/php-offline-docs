...
<head>
  ...
  <title>PHP: sodium_crypto_shorthash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-shorthash.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-shorthash">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-shorthash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-secretstream-xchacha20poly1305-rekey.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-shorthash-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-shorthash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-shorthash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-shorthash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-shorthash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-shorthash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-shorthash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-shorthash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-shorthash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-shorthash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-shorthash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-shorthash.php" hreflang="zh">
...
<meta name="Description" content="Compute a short hash of a message and key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_shorthash - Manual" />
<meta name="twitter:description" content="Compute a short hash of a message and key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_shorthash - Manual" />
<meta itemprop="description" content="Compute a short hash of a message and key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compute a short hash of a message and key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-shorthash-keygen.php">
          sodium_crypto_shorthash_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-secretstream-xchacha20poly1305-rekey.php">
          &laquo; sodium_crypto_secretstream_xchacha20poly1305_rekey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-shorthash.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-shorthash.php'>German</option>
            <option value='es/function.sodium-crypto-shorthash.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-shorthash.php'>French</option>
            <option value='it/function.sodium-crypto-shorthash.php'>Italian</option>
            <option value='ja/function.sodium-crypto-shorthash.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-shorthash.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-shorthash.php'>Russian</option>
            <option value='tr/function.sodium-crypto-shorthash.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-shorthash.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-shorthash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-shorthash" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_shorthash</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_shorthash</span> &mdash; <span class="dc-title">Compute a short hash of a message and key</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-shorthash-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_shorthash</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>sodium_crypto_shorthash()</strong></span> wraps a hash function called
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-shorthash-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-shorthash-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-shorthash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-shorthash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-shorthash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-shorthash.php">＋<small>add a note</small></a></span>
