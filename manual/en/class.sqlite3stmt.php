...
<head>
  ...
  <title>PHP: SQLite3Stmt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.sqlite3stmt.php">
 <link rel="shorturl" href="https://www.php.net/sqlite3stmt">
 <link rel="alternate" href="https://www.php.net/sqlite3stmt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.sqlite3exception.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3stmt.bindparam.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.sqlite3stmt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.sqlite3stmt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.sqlite3stmt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.sqlite3stmt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.sqlite3stmt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.sqlite3stmt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.sqlite3stmt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.sqlite3stmt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.sqlite3stmt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.sqlite3stmt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.sqlite3stmt.php" hreflang="zh">
...
<meta name="Description" content="The SQLite3Stmt class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3Stmt - Manual" />
<meta name="twitter:description" content="The SQLite3Stmt class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3Stmt - Manual" />
<meta itemprop="description" content="The SQLite3Stmt class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SQLite3Stmt class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="sqlite3stmt.bindparam.php">
          SQLite3Stmt::bindParam &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.sqlite3exception.php">
          &laquo; SQLite3Exception        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.sqlite3stmt.php' selected="selected">English</option>
            <option value='de/class.sqlite3stmt.php'>German</option>
            <option value='es/class.sqlite3stmt.php'>Spanish</option>
            <option value='fr/class.sqlite3stmt.php'>French</option>
            <option value='it/class.sqlite3stmt.php'>Italian</option>
            <option value='ja/class.sqlite3stmt.php'>Japanese</option>
            <option value='pt_BR/class.sqlite3stmt.php'>Brazilian Portuguese</option>
            <option value='ru/class.sqlite3stmt.php'>Russian</option>
            <option value='tr/class.sqlite3stmt.php'>Turkish</option>
            <option value='uk/class.sqlite3stmt.php'>Ukrainian</option>
            <option value='zh/class.sqlite3stmt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.sqlite3stmt" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="sqlite3stmt.bindparam.php">SQLite3Stmt::bindParam</a> — Binds a parameter to a statement variable</li><li><a href="sqlite3stmt.bindvalue.php">SQLite3Stmt::bindValue</a> — Binds the value of a parameter to a statement variable</li><li><a href="sqlite3stmt.clear.php">SQLite3Stmt::clear</a> — Clears all current bound parameters</li><li><a href="sqlite3stmt.close.php">SQLite3Stmt::close</a> — Closes the prepared statement</li><li><a href="sqlite3stmt.construct.php">SQLite3Stmt::__construct</a> — Constructs an SQLite3Stmt object</li><li><a href="sqlite3stmt.execute.php">SQLite3Stmt::execute</a> — Executes a prepared statement and returns a result set object</li><li><a href="sqlite3stmt.getsql.php">SQLite3Stmt::getSQL</a> — Get the SQL of the statement</li><li><a href="sqlite3stmt.paramcount.php">SQLite3Stmt::paramCount</a> — Returns the number of parameters within the prepared statement</li><li><a href="sqlite3stmt.readonly.php">SQLite3Stmt::readOnly</a> — Returns whether a statement is definitely read only</li><li><a href="sqlite3stmt.reset.php">SQLite3Stmt::reset</a> — Resets the prepared statement</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3stmt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.sqlite3stmt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.sqlite3stmt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.sqlite3stmt.php">＋<small>add a note</small></a></span>
