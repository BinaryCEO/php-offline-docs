...
<head>
  ...
  <title>PHP: gmp_mul - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-mul.php">
 <link rel="shorturl" href="https://www.php.net/gmp-mul">
 <link rel="alternate" href="https://www.php.net/gmp-mul" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-mod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-neg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-mul.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-mul.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-mul.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-mul.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-mul.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-mul.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-mul.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-mul.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-mul.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-mul.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-mul.php" hreflang="zh">
...
<meta name="Description" content="Multiply numbers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_mul - Manual" />
<meta name="twitter:description" content="Multiply numbers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_mul - Manual" />
<meta itemprop="description" content="Multiply numbers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Multiply numbers" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-mul.php' selected="selected">English</option>
            <option value='de/function.gmp-mul.php'>German</option>
            <option value='es/function.gmp-mul.php'>Spanish</option>
            <option value='fr/function.gmp-mul.php'>French</option>
            <option value='it/function.gmp-mul.php'>Italian</option>
            <option value='ja/function.gmp-mul.php'>Japanese</option>
            <option value='pt_BR/function.gmp-mul.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-mul.php'>Russian</option>
            <option value='tr/function.gmp-mul.php'>Turkish</option>
            <option value='uk/function.gmp-mul.php'>Ukrainian</option>
            <option value='zh/function.gmp-mul.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-mul" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_mul</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_mul</span> &mdash; <span class="dc-title">Multiply numbers</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-mul-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_mul</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>

  <p class="para rdfs-comment">
   Multiplies <code class="parameter">num1</code> by <code class="parameter">num2</code>
   and returns the result.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-mul-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A number that will be multiplied by <code class="parameter">num2</code>.
      </p>
      <p class="para">
 ...
 base detection (i.e. when <code class="parameter">base</code> is equal to 0).
     ...
     <dd>
      <p class="para">
       A number that will be multiplied by <code class="parameter">num1</code>.
      </p>
      <p class="para">
 A <span class="classname"><a href="class.gmp.php" class="classname">GMP</a></span> object, an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>,
 or a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> that can be interpreted as a number following the same logic
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-mul-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-mul-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3334">
    <p><strong>Example #1 <span class="function"><strong>gmp_mul()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">24691356000</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-mul.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-mul%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-mul&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-mul.php">＋<small>add a note</small></a></span>
