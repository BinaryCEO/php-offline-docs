...
<head>
  ...
  <title>PHP: oci_new_collection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-new-collection.php">
 <link rel="shorturl" href="https://www.php.net/oci-new-collection">
 <link rel="alternate" href="https://www.php.net/oci-new-collection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-lob-is-equal.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-new-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-new-collection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-new-collection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-new-collection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-new-collection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-new-collection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-new-collection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-new-collection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-new-collection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-new-collection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-new-collection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-new-collection.php" hreflang="zh">
...
<meta name="Description" content="Allocates new collection object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_new_collection - Manual" />
<meta name="twitter:description" content="Allocates new collection object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_new_collection - Manual" />
<meta itemprop="description" content="Allocates new collection object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Allocates new collection object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-new-connect.php">
          oci_new_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-lob-is-equal.php">
          &laquo; oci_lob_is_equal        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-new-collection.php' selected="selected">English</option>
            <option value='de/function.oci-new-collection.php'>German</option>
            <option value='es/function.oci-new-collection.php'>Spanish</option>
            <option value='fr/function.oci-new-collection.php'>French</option>
            <option value='it/function.oci-new-collection.php'>Italian</option>
            <option value='ja/function.oci-new-collection.php'>Japanese</option>
            <option value='pt_BR/function.oci-new-collection.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-new-collection.php'>Russian</option>
            <option value='tr/function.oci-new-collection.php'>Turkish</option>
            <option value='uk/function.oci-new-collection.php'>Ukrainian</option>
            <option value='zh/function.oci-new-collection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-new-collection" class="refentry">
   ...
   <p class="para">
    The <span class="classname"><a href="class.ocicollection.php" class="classname">OCICollection</a></span> class was called <span class="classname"><strong class="classname">OCI-Collection</strong></span> prior to PHP 8 and OCI8 3.0.0.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-new-collection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-new-collection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-new-collection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-new-collection.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122552">  <div class="votes">
    <div id="Vu122552">
    <a href="/manual/vote-note.php?id=122552&amp;page=function.oci-new-collection&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122552">
    <a href="/manual/vote-note.php?id=122552&amp;page=function.oci-new-collection&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122552" title="57% like this...">
    1
    </div>
  </div>
  <a href="#122552" class="name">
  <strong class="user"><em>VLroyrenn</em></strong></a><a class="genanchor" href="#122552"> &para;</a><div class="date" title="2018-03-27 03:39"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122552">
<div class="phpcode"><code><span class="html">This is a woefully underdocumented feature (at least here), but being able to bind collections to prepared statements instead of rolling your own SQL arrays is a massive improvement in terms of safety and conveinience, and a feature I think more DBMS should have in their API.<br /><br />You can basically send collections of the types listed by the following query :<br /><br />SELECT * FROM SYS.ALL_TYPES WHERE TYPECODE = 'COLLECTION' AND TYPE_NAME LIKE 'ODCI%'<br /><br />Those are all collections that can contain any number of the SQL type indicated in their name. <br /><br /><span class="default">&lt;?php<br />$my_array </span><span class="keyword">= [</span><span class="string">"foo"</span><span class="keyword">, </span><span class="string">"bar"</span><span class="keyword">, </span><span class="string">"baz"</span><span class="keyword">];<br /><br /></span><span class="default">$my_collection </span><span class="keyword">= </span><span class="default">oci_new_collection</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'ODCIVARCHAR2LIST'</span><span class="keyword">, </span><span class="string">'SYS'</span><span class="keyword">);<br /><br />foreach(</span><span class="default">$my_array </span><span class="keyword">as </span><span class="default">$elem</span><span class="keyword">) {<br />    </span><span class="default">$cell_collection</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="default">$elem</span><span class="keyword">);<br />}<br /><br /></span><span class="default">oci_bind_by_name</span><span class="keyword">(</span><span class="default">$statement</span><span class="keyword">, </span><span class="string">":collection"</span><span class="keyword">, </span><span class="default">$my_collection</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">SQLT_NTY</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />The collection ressource can be appended with numbers, strings or dates (which need to be passed as strings in the "DD-MON-YY" format, such as "27-MAR-18", apparently) depending on the types supported by the collection you're using, and none of these appear to support timestamps or any of the more complex data types.<br /><br />Code for the OCI collection type, for reference :<br /><br /><a href="http://git.php.net/?p=php-src.git;a=blob;f=ext/oci8/oci8_collection.c;hb=refs/heads/master#l429" rel="nofollow" target="_blank">http://git.php.net/?p=php-src.git;a=blob;f=ext/oci8/oci8_collection.c;hb=refs/heads/master#l429</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-new-collection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-new-collection.php">＋<small>add a note</small></a></div>
