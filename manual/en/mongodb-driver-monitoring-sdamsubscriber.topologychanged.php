...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-monitoring-sdamsubscriber.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.serveropening.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.topologyclosed.php">
...
<meta name="Description" content="Notification method for a topology description change" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Monitoring\SDAMSubscriber::topologyChanged - Manual" />
<meta name="twitter:description" content="Notification method for a topology description change" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Monitoring\SDAMSubscriber::topologyChanged - Manual" />
<meta itemprop="description" content="Notification method for a topology description change" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Notification method for a topology description change" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php' selected="selected">English</option>
            ...
            <option value='fr/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(mongodb &gt;=1.13.0)</p><p class="refpurpose"><span class="refname">MongoDB\Driver\Monitoring\SDAMSubscriber::topologyChanged</span> &mdash; <span class="dc-title">Notification method for a topology description change</span></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-manager.addsubscriber.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Manager::addSubscriber()</a> - Registers a monitoring event subscriber with this Manager</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/monitoring/sdamsubscriber/topologychanged.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-monitoring-sdamsubscriber.topologychanged%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-monitoring-sdamsubscriber.topologychanged&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-monitoring-sdamsubscriber.topologychanged.php">＋<small>add a note</small></a></span>
