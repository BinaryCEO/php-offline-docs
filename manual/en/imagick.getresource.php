...
<head>
  ...
  <title>PHP: Imagick::getResource - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getresource.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getresource.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getresource.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getreleasedate.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getresourcelimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getresource.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getresource.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getresource.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getresource.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getresource.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getresource.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getresource.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getresource.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getresource.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getresource.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getresource.php" hreflang="zh">
...
<meta name="Description" content="Returns the specified resource's memory usage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getResource - Manual" />
<meta name="twitter:description" content="Returns the specified resource's memory usage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getResource - Manual" />
<meta itemprop="description" content="Returns the specified resource's memory usage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the specified resource's memory usage" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getresourcelimit.php">
          Imagick::getResourceLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getreleasedate.php">
          &laquo; Imagick::getReleaseDate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getresource.php' selected="selected">English</option>
            <option value='de/imagick.getresource.php'>German</option>
            <option value='es/imagick.getresource.php'>Spanish</option>
            <option value='fr/imagick.getresource.php'>French</option>
            <option value='it/imagick.getresource.php'>Italian</option>
            <option value='ja/imagick.getresource.php'>Japanese</option>
            <option value='pt_BR/imagick.getresource.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getresource.php'>Russian</option>
            <option value='tr/imagick.getresource.php'>Turkish</option>
            <option value='uk/imagick.getresource.php'>Ukrainian</option>
            <option value='zh/imagick.getresource.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getresource" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getResource</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getResource</span> &mdash; <span class="dc-title">Returns the specified resource&#039;s memory usage</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getresource-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getResource</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getresource-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getresource-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getresource-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getresource.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getresource%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getresource&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getresource.php">＋<small>add a note</small></a></span>
