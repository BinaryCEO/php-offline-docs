...
<head>
  ...
  <title>PHP: stats_dens_t - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-dens-t.php">
 <link rel="shorturl" href="https://www.php.net/stats-dens-t">
 <link rel="alternate" href="https://www.php.net/stats-dens-t" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-dens-pmf-poisson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-dens-uniform.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-dens-t.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-dens-t.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-dens-t.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-dens-t.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-dens-t.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-dens-t.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-dens-t.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-dens-t.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-dens-t.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-dens-t.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-dens-t.php" hreflang="zh">
...
<meta name="Description" content="Probability density function of the t-distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_dens_t - Manual" />
<meta name="twitter:description" content="Probability density function of the t-distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_dens_t - Manual" />
<meta itemprop="description" content="Probability density function of the t-distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Probability density function of the t-distribution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-dens-uniform.php">
          stats_dens_uniform &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-dens-pmf-poisson.php">
          &laquo; stats_dens_pmf_poisson        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-dens-t.php' selected="selected">English</option>
            <option value='de/function.stats-dens-t.php'>German</option>
            <option value='es/function.stats-dens-t.php'>Spanish</option>
            <option value='fr/function.stats-dens-t.php'>French</option>
            <option value='it/function.stats-dens-t.php'>Italian</option>
            <option value='ja/function.stats-dens-t.php'>Japanese</option>
            <option value='pt_BR/function.stats-dens-t.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-dens-t.php'>Russian</option>
            <option value='tr/function.stats-dens-t.php'>Turkish</option>
            <option value='uk/function.stats-dens-t.php'>Ukrainian</option>
            <option value='zh/function.stats-dens-t.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-dens-t" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_dens_t</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_dens_t</span> &mdash; <span class="dc-title">Probability density function of the t-distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-dens-t-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_dens_t</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$dfr</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-dens-t-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-dens-t-returnvalues">
  ...
  <p class="para">
   The probability density at <code class="parameter">x</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-dens-t.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-dens-t%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-dens-t&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-t.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89268">  <div class="votes">
    <div id="Vu89268">
    <a href="/manual/vote-note.php?id=89268&amp;page=function.stats-dens-t&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89268">
    <a href="/manual/vote-note.php?id=89268&amp;page=function.stats-dens-t&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89268" title="no votes...">
    0
    </div>
  </div>
  <a href="#89268" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#89268"> &para;</a><div class="date" title="2009-02-28 02:12"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89268">
<div class="phpcode"><code><span class="html">This function returns the value of a student-T-distribution with the total area of 1.<br />$dfr are the degrees of freedom for that distribution (aka k)<br />$x is the X-Value for which the value should be returned</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-dens-t&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-t.php">＋<small>add a note</small></a></div>
