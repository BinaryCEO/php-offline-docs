...
<head>
  ...
  <title>PHP: openssl_cipher_key_length - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-cipher-key-length.php">
 <link rel="shorturl" href="https://www.php.net/openssl-cipher-key-length">
 <link rel="alternate" href="https://www.php.net/openssl-cipher-key-length" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cipher-iv-length.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-cms-decrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-cipher-key-length.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-cipher-key-length.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-cipher-key-length.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-cipher-key-length.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-cipher-key-length.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-cipher-key-length.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-cipher-key-length.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-cipher-key-length.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-cipher-key-length.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-cipher-key-length.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-cipher-key-length.php" hreflang="zh">
...
<meta name="Description" content="Gets the cipher key length" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_cipher_key_length - Manual" />
<meta name="twitter:description" content="Gets the cipher key length" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_cipher_key_length - Manual" />
<meta itemprop="description" content="Gets the cipher key length" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the cipher key length" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-cms-decrypt.php">
          openssl_cms_decrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-cipher-iv-length.php">
          &laquo; openssl_cipher_iv_length        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-cipher-key-length.php' selected="selected">English</option>
            <option value='de/function.openssl-cipher-key-length.php'>German</option>
            <option value='es/function.openssl-cipher-key-length.php'>Spanish</option>
            <option value='fr/function.openssl-cipher-key-length.php'>French</option>
            <option value='it/function.openssl-cipher-key-length.php'>Italian</option>
            <option value='ja/function.openssl-cipher-key-length.php'>Japanese</option>
            <option value='pt_BR/function.openssl-cipher-key-length.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-cipher-key-length.php'>Russian</option>
            <option value='tr/function.openssl-cipher-key-length.php'>Turkish</option>
            <option value='uk/function.openssl-cipher-key-length.php'>Ukrainian</option>
            <option value='zh/function.openssl-cipher-key-length.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-cipher-key-length" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-cipher-key-length-examples">
  ...
  <div class="example" id="example-1011">
   <p><strong>Example #1 <span class="function"><strong>openssl_cipher_key_length()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">int(16)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-cipher-key-length.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-cipher-key-length%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-cipher-key-length&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cipher-key-length.php">＋<small>add a note</small></a></span>
