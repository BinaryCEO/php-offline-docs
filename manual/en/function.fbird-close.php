...
<head>
  ...
  <title>PHP: fbird_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-close.php">
 <link rel="shorturl" href="https://www.php.net/fbird-close">
 <link rel="alternate" href="https://www.php.net/fbird-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-blob-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-commit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-close.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_close" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_close - Manual" />
<meta name="twitter:description" content="Alias of ibase_close" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_close - Manual" />
<meta itemprop="description" content="Alias of ibase_close" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_close" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-commit.php">
          fbird_commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-blob-open.php">
          &laquo; fbird_blob_open        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-close.php' selected="selected">English</option>
            <option value='de/function.fbird-close.php'>German</option>
            <option value='es/function.fbird-close.php'>Spanish</option>
            <option value='fr/function.fbird-close.php'>French</option>
            <option value='it/function.fbird-close.php'>Italian</option>
            <option value='ja/function.fbird-close.php'>Japanese</option>
            <option value='pt_BR/function.fbird-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-close.php'>Russian</option>
            <option value='tr/function.fbird-close.php'>Turkish</option>
            <option value='uk/function.fbird-close.php'>Ukrainian</option>
            <option value='zh/function.fbird-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_close</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_close</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-close.php" class="function">ibase_close()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-close-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-close-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-connect.php" class="function" rel="rdfs-seeAlso">fbird_connect()</a> - Alias of ibase_connect</span></li>
    <li><span class="function"><a href="function.fbird-pconnect.php" class="function" rel="rdfs-seeAlso">fbird_pconnect()</a> - Alias of ibase_pconnect</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-close.php">＋<small>add a note</small></a></span>
