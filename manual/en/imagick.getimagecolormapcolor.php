...
<head>
  ...
  <title>PHP: Imagick::getImageColormapColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageclipmask.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecolors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagecolormapcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagecolormapcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagecolormapcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagecolormapcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagecolormapcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagecolormapcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagecolormapcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagecolormapcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagecolormapcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagecolormapcolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the color of the specified colormap index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageColormapColor - Manual" />
<meta name="twitter:description" content="Returns the color of the specified colormap index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageColormapColor - Manual" />
<meta itemprop="description" content="Returns the color of the specified colormap index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the color of the specified colormap index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagecolors.php">
          Imagick::getImageColors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageclipmask.php">
          &laquo; Imagick::getImageClipMask        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecolormapcolor.php' selected="selected">English</option>
            <option value='de/imagick.getimagecolormapcolor.php'>German</option>
            <option value='es/imagick.getimagecolormapcolor.php'>Spanish</option>
            <option value='fr/imagick.getimagecolormapcolor.php'>French</option>
            <option value='it/imagick.getimagecolormapcolor.php'>Italian</option>
            <option value='ja/imagick.getimagecolormapcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagecolormapcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagecolormapcolor.php'>Russian</option>
            <option value='tr/imagick.getimagecolormapcolor.php'>Turkish</option>
            <option value='uk/imagick.getimagecolormapcolor.php'>Ukrainian</option>
            <option value='zh/imagick.getimagecolormapcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagecolormapcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageColormapColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageColormapColor</span> &mdash; <span class="dc-title">Returns the color of the specified colormap index</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecolormapcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageColormapColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagecolormapcolor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagecolormapcolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagecolormapcolor-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecolormapcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecolormapcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecolormapcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecolormapcolor.php">＋<small>add a note</small></a></span>
