...
<head>
  ...
  <title>PHP: Yaf_Route_Map - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-route-map.php">
 <link rel="shorturl" href="https://www.php.net/yaf-route-map">
 <link rel="alternate" href="https://www.php.net/yaf-route-map" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-route-interface.route.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-route-map.assemble.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-route-map.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-route-map.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-route-map.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-route-map.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-route-map.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-route-map.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-route-map.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-route-map.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-route-map.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-route-map.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-route-map.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Route_Map class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Route_Map - Manual" />
<meta name="twitter:description" content="The Yaf_Route_Map class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Route_Map - Manual" />
<meta itemprop="description" content="The Yaf_Route_Map class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Route_Map class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="yaf-route-map.assemble.php">
          Yaf_Route_Map::assemble &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yaf-route-interface.route.php">
          &laquo; Yaf_Route_Interface::route        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-route-map.php' selected="selected">English</option>
            <option value='de/class.yaf-route-map.php'>German</option>
            <option value='es/class.yaf-route-map.php'>Spanish</option>
            <option value='fr/class.yaf-route-map.php'>French</option>
            <option value='it/class.yaf-route-map.php'>Italian</option>
            <option value='ja/class.yaf-route-map.php'>Japanese</option>
            <option value='pt_BR/class.yaf-route-map.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-route-map.php'>Russian</option>
            <option value='tr/class.yaf-route-map.php'>Turkish</option>
            <option value='uk/class.yaf-route-map.php'>Ukrainian</option>
            <option value='zh/class.yaf-route-map.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-route-map" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>
  ...
  <div class="section" id="yaf-route-map.intro">
   ...
   <p class="para">
     <span class="classname"><strong class="classname">Yaf_Route_Map</strong></span> is a built-in route, it simply
    ...
    <p class="para">
     ...
     <span class="methodname"><a href="yaf-route-map.construct.php" class="methodname">Yaf_Route_Map::__construct()</a></span> is specified, then
  ...
  <div class="section" id="yaf-route-map.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Yaf_Route_Map</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     <span class="modifier">protected</span>
      <var class="varname"><a href="class.yaf-route-map.php#yaf-route-map.props.ctl-router">$<var class="varname">_ctl_router</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">protected</span>
      <var class="varname"><a href="class.yaf-route-map.php#yaf-route-map.props.delimiter">$<var class="varname">_delimiter</var></a></var>;</div>


    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="yaf-route-map.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$controller_prefer</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$delimiter</code><span class="initializer"> = &quot;&quot;</span></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="yaf-route-map.assemble.php" class="methodname">assemble</a></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$info</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$query</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="yaf-route-map.route.php" class="methodname">route</a></span>(<span class="methodparam"><span class="type"><a href="class.yaf-request-abstract.php" class="type Yaf_Request_Abstract">Yaf_Request_Abstract</a></span> <code class="parameter">$request</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="yaf-route-map.props">
   ...
   <dl>
     ...
     <dt id="yaf-route-map.props.ctl-router"><var class="varname">_ctl_router</var></dt>
     <dd>
      <p class="para"/>
     </dd>
    
    
     <dt id="yaf-route-map.props.delimiter"><var class="varname">_delimiter</var></dt>
     <dd>
      <p class="para"/>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-route-map.assemble.php">Yaf_Route_Map::assemble</a> — Assemble a url</li><li><a href="yaf-route-map.construct.php">Yaf_Route_Map::__construct</a> — The __construct purpose</li><li><a href="yaf-route-map.route.php">Yaf_Route_Map::route</a> — The route purpose</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-route-map.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-route-map%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-route-map&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-route-map.php">＋<small>add a note</small></a></span>
