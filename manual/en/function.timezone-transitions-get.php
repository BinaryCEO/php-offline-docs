...
<head>
  ...
  <title>PHP: timezone_transitions_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-transitions-get.php">
 <link rel="shorturl" href="https://www.php.net/timezone-transitions-get">
 <link rel="alternate" href="https://www.php.net/timezone-transitions-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.timezone-version-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-transitions-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-transitions-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-transitions-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-transitions-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-transitions-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-transitions-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-transitions-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-transitions-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-transitions-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-transitions-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-transitions-get.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTimeZone::getTransitions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_transitions_get - Manual" />
<meta name="twitter:description" content="Alias of DateTimeZone::getTransitions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_transitions_get - Manual" />
<meta itemprop="description" content="Alias of DateTimeZone::getTransitions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTimeZone::getTransitions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.timezone-version-get.php">
          timezone_version_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.timezone-open.php">
          &laquo; timezone_open        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-transitions-get.php' selected="selected">English</option>
            <option value='de/function.timezone-transitions-get.php'>German</option>
            <option value='es/function.timezone-transitions-get.php'>Spanish</option>
            <option value='fr/function.timezone-transitions-get.php'>French</option>
            <option value='it/function.timezone-transitions-get.php'>Italian</option>
            <option value='ja/function.timezone-transitions-get.php'>Japanese</option>
            <option value='pt_BR/function.timezone-transitions-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-transitions-get.php'>Russian</option>
            <option value='tr/function.timezone-transitions-get.php'>Turkish</option>
            <option value='uk/function.timezone-transitions-get.php'>Ukrainian</option>
            <option value='zh/function.timezone-transitions-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-transitions-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">timezone_transitions_get</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">timezone_transitions_get</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetimezone.gettransitions.php" class="methodname">DateTimeZone::getTransitions()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.timezone-transitions-get-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetimezone.gettransitions.php" class="methodname">DateTimeZone::getTransitions()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-transitions-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-transitions-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-transitions-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-transitions-get.php">＋<small>add a note</small></a></span>
