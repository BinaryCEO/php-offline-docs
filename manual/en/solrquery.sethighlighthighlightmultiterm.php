...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightHighlightMultiTerm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightfragsize.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlighthighlightmultiterm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlighthighlightmultiterm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlighthighlightmultiterm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlighthighlightmultiterm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlighthighlightmultiterm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlighthighlightmultiterm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlighthighlightmultiterm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlighthighlightmultiterm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlighthighlightmultiterm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlighthighlightmultiterm.php" hreflang="zh">
...
<meta name="Description" content="Use SpanScorer to highlight phrase terms" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightHighlightMultiTerm - Manual" />
<meta name="twitter:description" content="Use SpanScorer to highlight phrase terms" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightHighlightMultiTerm - Manual" />
<meta itemprop="description" content="Use SpanScorer to highlight phrase terms" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Use SpanScorer to highlight phrase terms" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightmaxalternatefieldlength.php">
          SolrQuery::setHighlightMaxAlternateFieldLength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightfragsize.php">
          &laquo; SolrQuery::setHighlightFragsize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlighthighlightmultiterm.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlighthighlightmultiterm.php'>German</option>
            <option value='es/solrquery.sethighlighthighlightmultiterm.php'>Spanish</option>
            <option value='fr/solrquery.sethighlighthighlightmultiterm.php'>French</option>
            <option value='it/solrquery.sethighlighthighlightmultiterm.php'>Italian</option>
            <option value='ja/solrquery.sethighlighthighlightmultiterm.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlighthighlightmultiterm.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlighthighlightmultiterm.php'>Russian</option>
            <option value='tr/solrquery.sethighlighthighlightmultiterm.php'>Turkish</option>
            <option value='uk/solrquery.sethighlighthighlightmultiterm.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlighthighlightmultiterm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlighthighlightmultiterm" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightHighlightMultiTerm</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightHighlightMultiTerm</span> &mdash; <span class="dc-title">Use SpanScorer to highlight phrase terms</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlighthighlightmultiterm-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightHighlightMultiTerm</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlighthighlightmultiterm-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlighthighlightmultiterm-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlighthighlightmultiterm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlighthighlightmultiterm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlighthighlightmultiterm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php">＋<small>add a note</small></a></span>
