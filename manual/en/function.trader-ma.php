...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ma.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-log10.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-macd.php">
...
<meta name="Description" content="Moving average" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ma - Manual" />
<meta name="twitter:description" content="Moving average" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ma - Manual" />
<meta itemprop="description" content="Moving average" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Moving average" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ma.php' selected="selected">English</option>
            ...
            <option value='ru/function.trader-ma.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ma</span> &mdash; <span class="dc-title">Moving average</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ma-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ma.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ma%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ma.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />$closes </span><span class="keyword">= array(</span><span class="default">112.82</span><span class="keyword">, </span><span class="default">117.32</span><span class="keyword">, </span><span class="default">113.49</span><span class="keyword">, </span><span class="default">112</span><span class="keyword">, </span><span class="default">115.355</span><span class="keyword">, </span><span class="default">115.54</span><span class="keyword">, </span><span class="default">112.13</span><span class="keyword">, </span><span class="default">110.34</span><span class="keyword">, </span><span class="default">106.84</span><span class="keyword">, </span><span class="default">110.08</span><span class="keyword">, </span><span class="default">111.81</span><span class="keyword">, </span><span class="default">107.12</span><span class="keyword">, </span><span class="default">108.22</span><span class="keyword">, </span><span class="default">112.28</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">trader_ma</span><span class="keyword">(</span><span class="default">$closes</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">TRADER_MA_TYPE_SMA</span><span class="keyword">));<br /><br /></span><span class="comment">/*<br />array(12) {<br />  [2]=&gt;<br />  float(114.543)  // (112.82 + 117.32 + 113.49) / 3 = 114.54333333333<br />  [3]=&gt;<br />  float(114.27)   // (117.32 + 113.49 + 112) / 3 = 114.27<br />  [4]=&gt;<br />  float(113.615)  // (113.49 + 112 + 115.355) / 3 = 113.615<br />  [5]=&gt;<br />  float(114.298)  // (112 + 115.355 + 115.54) / 3 = 114.29833333333<br />  [6]=&gt;<br />  float(114.342)  // (115.355 + 115.54 + 112.13) / 3 = 114.34166666667<br />  [7]=&gt;<br />  float(112.67)   // (115.54 + 112.13 + 110.34) / 3 = 112.67<br />  [8]=&gt;<br />  float(109.77)   // (112.13 + 110.34 + 106.84) / 3 = 109.77<br />  [9]=&gt;<br />  float(109.087)  // (110.34 + 106.84 + 110.08) / 3 = 109.08666666667<br />  [10]=&gt;<br />  float(109.577)  // (106.84 + 110.08 + 111.81) / 3 = 109.57666666667<br />  [11]=&gt;<br />  float(109.67)   // (110.08 + 111.81 + 107.12) / 3 = 109.67<br />  [12]=&gt;<br />  float(109.05)   // (111.81 + 107.12 + 108.22) / 3 = 109.05<br />  [13]=&gt;<br />  float(109.207)  // (107.12 + 108.22 + 112.28) /3 = 109.20666666667<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-ma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ma.php">＋<small>add a note</small></a></div>
