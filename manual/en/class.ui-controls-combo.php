...
<head>
  ...
  <title>PHP: UI\Controls\Combo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-combo.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-combo">
 <link rel="alternate" href="https://www.php.net/ui-controls-combo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-separator.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-combo.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-combo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-combo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-combo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-combo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-combo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-combo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-combo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-combo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-combo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-combo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-combo.php" hreflang="zh">
...
<meta name="Description" content="Combo Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Combo - Manual" />
<meta name="twitter:description" content="Combo Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Combo - Manual" />
<meta itemprop="description" content="Combo Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Combo Control" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-controls-combo.append.php">
          UI\Controls\Combo::append &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-separator.construct.php">
          &laquo; UI\Controls\Separator::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-combo.php' selected="selected">English</option>
            <option value='de/class.ui-controls-combo.php'>German</option>
            <option value='es/class.ui-controls-combo.php'>Spanish</option>
            <option value='fr/class.ui-controls-combo.php'>French</option>
            <option value='it/class.ui-controls-combo.php'>Italian</option>
            <option value='ja/class.ui-controls-combo.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-combo.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-combo.php'>Russian</option>
            <option value='tr/class.ui-controls-combo.php'>Turkish</option>
            <option value='uk/class.ui-controls-combo.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-combo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-combo" class="reference">

 <h1 class="title">Combo Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-combo.intro">
  ...
  <div class="section" id="ui-controls-combo.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Combo</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-combo.append.php" class="methodname">append</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-combo.getselected.php" class="methodname">getSelected</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-combo.onselected.php" class="methodname">onSelected</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-combo.setselected.php" class="methodname">setSelected</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-combo.append.php">UI\Controls\Combo::append</a> — Append Option</li><li><a href="ui-controls-combo.getselected.php">UI\Controls\Combo::getSelected</a> — Get Selected Option</li><li><a href="ui-controls-combo.onselected.php">UI\Controls\Combo::onSelected</a> — Selected Handler</li><li><a href="ui-controls-combo.setselected.php">UI\Controls\Combo::setSelected</a> — Set Selected Option</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.combo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-combo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-combo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-combo.php">＋<small>add a note</small></a></span>
