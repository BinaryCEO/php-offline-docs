...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-seek64.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-size.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-seek64.php' selected="selected">English</option>
            ...
            <option value='fr/function.cubrid-lob2-seek64.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-seek64-description">
  ...
  <p class="para rdfs-comment">
   ...
   If the <code class="parameter">offset</code> you want to move is larger than an integer 
  ...
  <p class="para">
   If you use <strong><code>CUBRID_CURSOR_LAST</code></strong> for <code class="parameter">origin</code>, you can move backward
   <code class="parameter">offset</code> units from the end of LOB object and <code class="parameter">offset</code> only can be positive.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>:    
  <p class="para">
   If you use this function to move the cursor position of the lob object, you should pass <code class="parameter">offset</code> as a string.
  </p>
  </p></blockquote>
 </div>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-size64.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_size64()</a> - Get a lob object's size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-seek64.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-seek64%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-seek64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-seek64.php">＋<small>add a note</small></a></span>
