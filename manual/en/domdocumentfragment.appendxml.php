...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/domdocumentfragment.append.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocumentfragment.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocumentfragment.appendxml.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocumentfragment.appendxml.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocumentfragment.appendxml.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocumentfragment.appendxml.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocumentfragment.appendxml.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocumentfragment.appendxml.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocumentfragment.appendxml.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocumentfragment.appendxml.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocumentfragment.appendxml.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocumentfragment.appendxml.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocumentfragment.appendxml.php" hreflang="zh">
...
<div id="layout" class="clearfix">
 ...
 <div class="refsect1 examples" id="refsect1-domdocumentfragment.appendxml-examples">
  ...
  <p class="para">
   <div class="example" id="example-5792">
...
&lt;root&gt;&lt;foo&gt;text&lt;/foo&gt;&lt;bar&gt;text2&lt;/bar&gt;&lt;/root&gt;</pre>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocumentfragment.appendxml&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocumentfragment.appendxml.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="76580">  <div class="votes">
    ...
    <div class="tally" id="V76580" title="60% like this...">
    2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Here is (maybe) a better example:<br />/** <br />* Helper function for replacing $node (DOMNode) <br />* with an XML code (string) <br />* <br />* @var DOMNode $node <br />* @var string $xml <br />*/ <br />public function replaceNodeXML(&amp;$node,$xml) { <br /> $f = $this-&gt;dom-&gt;createDocumentFragment(); <br /> $f-&gt;appendXML($xml); <br /> $node-&gt;parentNode-&gt;replaceChild($f,$node); <br />}<br /><br />Copied from the "PHP5 Dom Based Template" article at:<br /><a href="http://blog.axisvista.com/?p=35" rel="nofollow" target="_blank">http://blog.axisvista.com/?p=35</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Strings such as " ' &amp; &lt; &gt; may need to be escaped in advance.<br />In that case, you can use htmlspecialchars().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=domdocumentfragment.appendxml&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocumentfragment.appendxml.php">＋<small>add a note</small></a></div>
