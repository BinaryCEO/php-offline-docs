...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.uniqid.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.time-sleep-until.php">
 <link rel="next" href="https://www.php.net/manual/en/function.unpack.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.uniqid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.uniqid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.uniqid.php" hreflang="uk">
...
<meta name="Description" content="Generate a time-based identifier" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: uniqid - Manual" />
<meta name="twitter:description" content="Generate a time-based identifier" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: uniqid - Manual" />
<meta itemprop="description" content="Generate a time-based identifier" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a time-based identifier" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.uniqid.php' selected="selected">English</option>
            ...
            <option value='ru/function.uniqid.php'>Russian</option>
            <option value='tr/function.uniqid.php'>Turkish</option>
            <option value='uk/function.uniqid.php'>Ukrainian</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.uniqid-examples">
  ...
  <p class="para">
   <div class="example" id="example-3764">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.random-bytes.php" class="function" rel="rdfs-seeAlso">random_bytes()</a> - Get cryptographically secure random bytes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/uniqid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.uniqid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.uniqid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.uniqid.php">＋<small>add a note</small></a></span>
