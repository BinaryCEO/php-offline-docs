...
<head>
  ...
  <title>PHP: Zookeeper::setAcl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.setacl.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.setacl.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.setacl.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.set.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.setdebuglevel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.setacl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zookeeper.setacl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zookeeper.setacl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zookeeper.setacl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zookeeper.setacl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zookeeper.setacl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zookeeper.setacl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zookeeper.setacl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zookeeper.setacl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zookeeper.setacl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zookeeper.setacl.php" hreflang="zh">
...
<meta name="Description" content="Sets the acl associated with a node synchronously" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Zookeeper::setAcl - Manual" />
<meta name="twitter:description" content="Sets the acl associated with a node synchronously" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Zookeeper::setAcl - Manual" />
<meta itemprop="description" content="Sets the acl associated with a node synchronously" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the acl associated with a node synchronously" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="zookeeper.setdebuglevel.php">
          Zookeeper::setDebugLevel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="zookeeper.set.php">
          &laquo; Zookeeper::set        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.setacl.php' selected="selected">English</option>
            <option value='de/zookeeper.setacl.php'>German</option>
            <option value='es/zookeeper.setacl.php'>Spanish</option>
            <option value='fr/zookeeper.setacl.php'>French</option>
            <option value='it/zookeeper.setacl.php'>Italian</option>
            <option value='ja/zookeeper.setacl.php'>Japanese</option>
            <option value='pt_BR/zookeeper.setacl.php'>Brazilian Portuguese</option>
            <option value='ru/zookeeper.setacl.php'>Russian</option>
            <option value='tr/zookeeper.setacl.php'>Turkish</option>
            <option value='uk/zookeeper.setacl.php'>Ukrainian</option>
            <option value='zh/zookeeper.setacl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zookeeper.setacl" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-zookeeper.setacl-description">
  ...
  <div class="methodsynopsis dc-description">
   ...
   <span class="methodname"><strong>Zookeeper::setAcl</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$version</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$acl</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-zookeeper.setacl-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">acl</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-zookeeper.setacl-examples">
  ...
  <div class="example" id="zookeeper.setacl.example.basic">
...
<div class="examplescode"><pre class="examplescode">array(1) {
 ...
 <div class="refsect1 seealso" id="refsect1-zookeeper.setacl-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="zookeeper.getacl.php" class="methodname" rel="rdfs-seeAlso">Zookeeper::getAcl()</a> - Gets the acl associated with a node synchronously</span></li>
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/setacl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.setacl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.setacl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.setacl.php">＋<small>add a note</small></a></span>
