...
<head>
  ...
  <title>PHP: SolrQuery::setFacetDateHardEnd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetdatehardend.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetdatehardend.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetdatehardend.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetdategap.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetdatestart.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetdatehardend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetdatehardend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetdatehardend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetdatehardend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetdatehardend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetdatehardend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetdatehardend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetdatehardend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetdatehardend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetdatehardend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetdatehardend.php" hreflang="zh">
...
<meta name="Description" content="Maps to facet.date.hardend" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetDateHardEnd - Manual" />
<meta name="twitter:description" content="Maps to facet.date.hardend" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetDateHardEnd - Manual" />
<meta itemprop="description" content="Maps to facet.date.hardend" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to facet.date.hardend" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setfacetdatestart.php">
          SolrQuery::setFacetDateStart &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetdategap.php">
          &laquo; SolrQuery::setFacetDateGap        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetdatehardend.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetdatehardend.php'>German</option>
            <option value='es/solrquery.setfacetdatehardend.php'>Spanish</option>
            <option value='fr/solrquery.setfacetdatehardend.php'>French</option>
            <option value='it/solrquery.setfacetdatehardend.php'>Italian</option>
            <option value='ja/solrquery.setfacetdatehardend.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetdatehardend.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetdatehardend.php'>Russian</option>
            <option value='tr/solrquery.setfacetdatehardend.php'>Turkish</option>
            <option value='uk/solrquery.setfacetdatehardend.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetdatehardend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetdatehardend" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetDateHardEnd</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetDateHardEnd</span> &mdash; <span class="dc-title">Maps to facet.date.hardend</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetdatehardend-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetDateHardEnd</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetdatehardend-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetdatehardend-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetdatehardend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetdatehardend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetdatehardend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetdatehardend.php">＋<small>add a note</small></a></span>
