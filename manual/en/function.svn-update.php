...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-update.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-status.php">
 <link rel="next" href="https://www.php.net/manual/en/book.tcpwrap.php">
...
<meta name="Description" content="Update working copy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_update - Manual" />
<meta name="twitter:description" content="Update working copy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_update - Manual" />
<meta itemprop="description" content="Update working copy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Update working copy" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-update.php' selected="selected">English</option>
            <option value='de/function.svn-update.php'>German</option>
            <option value='es/function.svn-update.php'>Spanish</option>
            <option value='fr/function.svn-update.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL svn &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">svn_update</span> &mdash; <span class="dc-title">Update working copy</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.svn-update-description">
  ...
  <p class="para rdfs-comment">
   Update working copy at <code class="parameter">path</code> to revision
   <code class="parameter">revno</code>. If <code class="parameter">recurse</code> is true,
 ...
 <div class="refsect1 parameters" id="refsect1-function.svn-update-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Revision number to update to, default is <strong><code><a href="svn.constants.php#constant.svn-revision-head">SVN_REVISION_HEAD</a></code></strong>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.svn-update-returnvalues">
  ...
  <p class="para">
   Returns new revision number on success, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
This function should be used at your own risk.
 ...
 <div class="refsect1 seealso" id="refsect1-function.svn-update-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.svn-checkout.php" class="function" rel="rdfs-seeAlso">svn_checkout()</a> - Checks out a working copy from the repository</span></li>
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.update.html" class="link external">&raquo;&nbsp;SVN documentation for svn update</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-update.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-update%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-update&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-update.php">＋<small>add a note</small></a></span>
