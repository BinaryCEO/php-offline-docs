...
<head>
  ...
  <title>PHP: eio_rmdir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-rmdir.php">
 <link rel="shorturl" href="https://www.php.net/eio-rmdir">
 <link rel="alternate" href="https://www.php.net/eio-rmdir" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-rename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-rmdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-rmdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-rmdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-rmdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-rmdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-rmdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-rmdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-rmdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-rmdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-rmdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-rmdir.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_rmdir - Manual" />
<meta name="twitter:description" content="Remove a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_rmdir - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-rmdir.php' selected="selected">English</option>
            <option value='de/function.eio-rmdir.php'>German</option>
            <option value='es/function.eio-rmdir.php'>Spanish</option>
            <option value='fr/function.eio-rmdir.php'>French</option>
            <option value='it/function.eio-rmdir.php'>Italian</option>
            <option value='ja/function.eio-rmdir.php'>Japanese</option>
            <option value='pt_BR/function.eio-rmdir.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-rmdir.php'>Russian</option>
            <option value='tr/function.eio-rmdir.php'>Turkish</option>
            <option value='uk/function.eio-rmdir.php'>Ukrainian</option>
            <option value='zh/function.eio-rmdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-rmdir" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-rmdir-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_rmdir</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_rmdir()</strong></span> removes a directory.
  </p>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-rmdir-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_rmdir()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-rmdir-examples">
  ...
  <div class="example" id="example-3526">
   <p><strong>Example #1 <span class="function"><strong>eio_rmdir()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">eio_rmdir_ok</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-rmdir-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-mkdir.php" class="function" rel="rdfs-seeAlso">eio_mkdir()</a> - Create directory</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-rmdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-rmdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-rmdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-rmdir.php">＋<small>add a note</small></a></span>
