...
<head>
  ...
  <title>PHP: DateTimeInterface::getOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.getoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.getoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.getoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetimeinterface.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.format.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.gettimestamp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.getoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.getoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.getoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.getoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.getoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.getoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.getoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.getoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.getoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.getoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.getoffset.php" hreflang="zh">
...
<meta name="Description" content="Returns the timezone offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTimeInterface::getOffset - Manual" />
<meta name="twitter:description" content="Returns the timezone offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTimeInterface::getOffset - Manual" />
<meta itemprop="description" content="Returns the timezone offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the timezone offset" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.gettimestamp.php">
          DateTimeInterface::getTimestamp &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.format.php">
          &laquo; DateTimeInterface::format        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.getoffset.php' selected="selected">English</option>
            <option value='de/datetime.getoffset.php'>German</option>
            <option value='es/datetime.getoffset.php'>Spanish</option>
            <option value='fr/datetime.getoffset.php'>French</option>
            <option value='it/datetime.getoffset.php'>Italian</option>
            <option value='ja/datetime.getoffset.php'>Japanese</option>
            <option value='pt_BR/datetime.getoffset.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.getoffset.php'>Russian</option>
            <option value='tr/datetime.getoffset.php'>Turkish</option>
            <option value='uk/datetime.getoffset.php'>Ukrainian</option>
            <option value='zh/datetime.getoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.getoffset" class="refentry">
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">DateTimeInterface::getOffset</span> -- <span class="refname">DateTimeImmutable::getOffset</span> -- <span class="refname">DateTime::getOffset</span> -- <span class="refname">date_offset_get</span> &mdash; <span class="dc-title">Returns the timezone offset</span></p>
...
returned by <span class="function"><a href="function.date-create.php" class="function">date_create()</a></span></p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-datetime.getoffset-examples">
  ...
  <div class="example" id="example-2232">
   <p><strong>Example #1 <span class="function"><strong>DateTime::getOffset()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">-18000
-14400</pre>
</div>
   </div>
   <div class="example-contents"><p>
    Note: -18000 = -5 hours, -14400 = -4 hours.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetimeinterface/getoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.getoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.getoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.getoffset.php">＋<small>add a note</small></a></span>
