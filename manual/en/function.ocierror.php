...
<head>
  ...
  <title>PHP: ocierror - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocierror.php">
 <link rel="shorturl" href="https://www.php.net/ocierror">
 <link rel="alternate" href="https://www.php.net/ocierror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocidefinebyname.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociexecute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocierror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocierror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocierror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocierror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocierror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocierror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocierror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocierror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocierror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocierror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocierror.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_error" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocierror - Manual" />
<meta name="twitter:description" content="Alias of oci_error" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocierror - Manual" />
<meta itemprop="description" content="Alias of oci_error" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_error" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ociexecute.php">
          ociexecute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocidefinebyname.php">
          &laquo; ocidefinebyname        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocierror.php' selected="selected">English</option>
            <option value='de/function.ocierror.php'>German</option>
            <option value='es/function.ocierror.php'>Spanish</option>
            <option value='fr/function.ocierror.php'>French</option>
            <option value='it/function.ocierror.php'>Italian</option>
            <option value='ja/function.ocierror.php'>Japanese</option>
            <option value='pt_BR/function.ocierror.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocierror.php'>Russian</option>
            <option value='tr/function.ocierror.php'>Turkish</option>
            <option value='uk/function.ocierror.php'>Ukrainian</option>
            <option value='zh/function.ocierror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocierror" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocierror</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocierror</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-error.php" class="function">oci_error()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocierror-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-error.php" class="function">oci_error()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocierror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocierror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocierror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocierror.php">＋<small>add a note</small></a></span>
