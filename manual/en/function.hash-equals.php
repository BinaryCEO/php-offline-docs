...
<head>
  ...
  <title>PHP: hash_equals - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.hash-equals.php">
 <link rel="shorturl" href="https://www.php.net/hash-equals">
 <link rel="alternate" href="https://www.php.net/hash-equals" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.hash.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.hash-copy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.hash-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.hash-equals.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.hash-equals.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.hash-equals.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.hash-equals.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.hash-equals.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.hash-equals.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.hash-equals.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.hash-equals.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.hash-equals.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.hash-equals.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.hash-equals.php" hreflang="zh">
...
<meta name="Description" content="Timing attack safe string comparison" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: hash_equals - Manual" />
<meta name="twitter:description" content="Timing attack safe string comparison" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: hash_equals - Manual" />
<meta itemprop="description" content="Timing attack safe string comparison" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Timing attack safe string comparison" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.hash-equals.php' selected="selected">English</option>
            <option value='de/function.hash-equals.php'>German</option>
            <option value='es/function.hash-equals.php'>Spanish</option>
            <option value='fr/function.hash-equals.php'>French</option>
            <option value='it/function.hash-equals.php'>Italian</option>
            <option value='ja/function.hash-equals.php'>Japanese</option>
            <option value='pt_BR/function.hash-equals.php'>Brazilian Portuguese</option>
            <option value='ru/function.hash-equals.php'>Russian</option>
            <option value='tr/function.hash-equals.php'>Turkish</option>
            <option value='uk/function.hash-equals.php'>Ukrainian</option>
            <option value='zh/function.hash-equals.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.hash-equals" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.hash-hmac.php" class="function" rel="rdfs-seeAlso">hash_hmac()</a> - Generate a keyed hash value using the HMAC method</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/hash/functions/hash-equals.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.hash-equals%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.hash-equals&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.hash-equals.php">＋<small>add a note</small></a></span>
