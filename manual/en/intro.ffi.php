...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.ffi.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.ffi.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.ffi.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ffi.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.ffi.php">
 <link rel="next" href="https://www.php.net/manual/en/ffi.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.ffi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.ffi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.ffi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.ffi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.ffi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.ffi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.ffi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.ffi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.ffi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.ffi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.ffi.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.ffi.php' selected="selected">English</option>
            <option value='de/intro.ffi.php'>German</option>
            <option value='es/intro.ffi.php'>Spanish</option>
            <option value='fr/intro.ffi.php'>French</option>
            <option value='it/intro.ffi.php'>Italian</option>
            <option value='ja/intro.ffi.php'>Japanese</option>
            <option value='pt_BR/intro.ffi.php'>Brazilian Portuguese</option>
            <option value='ru/intro.ffi.php'>Russian</option>
            <option value='tr/intro.ffi.php'>Turkish</option>
            <option value='uk/intro.ffi.php'>Ukrainian</option>
            <option value='zh/intro.ffi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.ffi" class="preface">
   ...
   <p class="para">
    ...
    consumption.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.ffi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.ffi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.ffi.php">＋<small>add a note</small></a></span>
