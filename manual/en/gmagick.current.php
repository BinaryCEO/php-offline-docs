...
<head>
  ...
  <title>PHP: Gmagick::current - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.current.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.current.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.current.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.cropthumbnailimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.cyclecolormapimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.current.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.current.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.current.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.current.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.current.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.current.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.current.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.current.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.current.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.current.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.current.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::current - Manual" />
<meta name="twitter:description" content="The current purpose" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::current - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.cyclecolormapimage.php">
          Gmagick::cyclecolormapimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.cropthumbnailimage.php">
          &laquo; Gmagick::cropthumbnailimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.current.php' selected="selected">English</option>
            <option value='de/gmagick.current.php'>German</option>
            <option value='es/gmagick.current.php'>Spanish</option>
            <option value='fr/gmagick.current.php'>French</option>
            <option value='it/gmagick.current.php'>Italian</option>
            <option value='ja/gmagick.current.php'>Japanese</option>
            <option value='pt_BR/gmagick.current.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.current.php'>Russian</option>
            <option value='tr/gmagick.current.php'>Turkish</option>
            <option value='uk/gmagick.current.php'>Ukrainian</option>
            <option value='zh/gmagick.current.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.current" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::current</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::current</span> &mdash; <span class="dc-title">The current purpose</span></p>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/current.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.current%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.current&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.current.php">＋<small>add a note</small></a></span>
