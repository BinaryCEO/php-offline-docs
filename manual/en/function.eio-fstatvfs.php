...
<head>
  ...
  <title>PHP: eio_fstatvfs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-fstatvfs.php">
 <link rel="shorturl" href="https://www.php.net/eio-fstatvfs">
 <link rel="alternate" href="https://www.php.net/eio-fstatvfs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-fstat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-fsync.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-fstatvfs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-fstatvfs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-fstatvfs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-fstatvfs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-fstatvfs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-fstatvfs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-fstatvfs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-fstatvfs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-fstatvfs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-fstatvfs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-fstatvfs.php" hreflang="zh">
...
<meta name="Description" content="Get file system statistics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_fstatvfs - Manual" />
<meta name="twitter:description" content="Get file system statistics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_fstatvfs - Manual" />
<meta itemprop="description" content="Get file system statistics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get file system statistics" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-fsync.php">
          eio_fsync &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-fstat.php">
          &laquo; eio_fstat        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-fstatvfs.php' selected="selected">English</option>
            <option value='de/function.eio-fstatvfs.php'>German</option>
            <option value='es/function.eio-fstatvfs.php'>Spanish</option>
            <option value='fr/function.eio-fstatvfs.php'>French</option>
            <option value='it/function.eio-fstatvfs.php'>Italian</option>
            <option value='ja/function.eio-fstatvfs.php'>Japanese</option>
            <option value='pt_BR/function.eio-fstatvfs.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-fstatvfs.php'>Russian</option>
            <option value='tr/function.eio-fstatvfs.php'>Turkish</option>
            <option value='uk/function.eio-fstatvfs.php'>Ukrainian</option>
            <option value='zh/function.eio-fstatvfs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-fstatvfs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_fstatvfs</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_fstatvfs</span> &mdash; <span class="dc-title">Get file system statistics</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-fstatvfs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_fstatvfs</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_fstatvfs()</strong></span> returns file system statistics in
  <code class="parameter">result</code> of <code class="parameter">callback</code>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-fstatvfs-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-fstatvfs-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_fstatvfs()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.eio-fstatvfs-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-statvfs.php" class="function" rel="rdfs-seeAlso">eio_statvfs()</a> - Get file system statistics</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-fstatvfs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-fstatvfs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-fstatvfs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-fstatvfs.php">＋<small>add a note</small></a></span>
