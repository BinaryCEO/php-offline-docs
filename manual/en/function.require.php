...
<div class="phpcode"><code><span class="html">If your included file returns a value, you can get it as a result from require(), i.e.<br /><br />foo.php:<br /><span class="default">&lt;?php<br /></span><span class="keyword">return </span><span class="string">"foo"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />$bar = require("foo.php");<br />echo $bar; // equals to "foo"</span></code></div>
  </div>
 </div>
  <div class="note" id="129162">  <div class="votes">
    ...
    <div class="tally" id="V129162" title="59% like this...">
    9
    </div>
  </div>
  <a href="#129162" class="name">
  <strong class="user"><em>jave dot web at seznam dot cz</em></strong></a><a class="genanchor" href="#129162"> &para;</a><div class="date" title="2024-01-15 02:29"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129162">
<div class="phpcode"><code><span class="html">Always use __DIR__ to define path relative to your current __FILE__. <br />(Or another setting that is originally based on __DIR__/__FILE__)<br /><br />try &amp; catch - don't get confused by the words "fatal E_COMPILE_ERROR" - it's still just an internal Error that implements Throwable - it can be caught:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">try {<br />    require(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/something_that_does_not_exist'</span><span class="keyword">);<br />} catch (</span><span class="default">\Throwable $e</span><span class="keyword">) {<br />    echo </span><span class="string">"This was caught: " </span><span class="keyword">. </span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">();<br />}<br />echo </span><span class="string">" End of script."</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Note that this will still emit a warning "Failed to open stream: No such file or directory..." ...unless you prefix the require with "@" - which I strongly don't recommend as it would ignore/supress any diagnostic error (unless you have specified set_error_handler()). But even if you'd prefix the require with "@" it would still be caught.</span></code></div>
  </div>
 </div></div>
