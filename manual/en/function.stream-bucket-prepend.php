...
<head>
  ...
  <title>PHP: stream_bucket_prepend - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-bucket-prepend.php">
 <link rel="shorturl" href="https://www.php.net/stream-bucket-prepend">
 <link rel="alternate" href="https://www.php.net/stream-bucket-prepend" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-bucket-new.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-bucket-prepend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-bucket-prepend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-bucket-prepend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-bucket-prepend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-bucket-prepend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-bucket-prepend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-bucket-prepend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-bucket-prepend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-bucket-prepend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-bucket-prepend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-bucket-prepend.php" hreflang="zh">
...
<meta name="Description" content="Prepend bucket to brigade" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_bucket_prepend - Manual" />
<meta name="twitter:description" content="Prepend bucket to brigade" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_bucket_prepend - Manual" />
<meta itemprop="description" content="Prepend bucket to brigade" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepend bucket to brigade" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-context-create.php">
          stream_context_create &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-bucket-new.php">
          &laquo; stream_bucket_new        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-bucket-prepend.php' selected="selected">English</option>
            <option value='de/function.stream-bucket-prepend.php'>German</option>
            <option value='es/function.stream-bucket-prepend.php'>Spanish</option>
            <option value='fr/function.stream-bucket-prepend.php'>French</option>
            <option value='it/function.stream-bucket-prepend.php'>Italian</option>
            <option value='ja/function.stream-bucket-prepend.php'>Japanese</option>
            <option value='pt_BR/function.stream-bucket-prepend.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-bucket-prepend.php'>Russian</option>
            <option value='tr/function.stream-bucket-prepend.php'>Turkish</option>
            <option value='uk/function.stream-bucket-prepend.php'>Ukrainian</option>
            <option value='zh/function.stream-bucket-prepend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-bucket-prepend" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.stream-bucket-prepend-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_bucket_prepend</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$brigade</code></span>, <span class="methodparam"><span class="type">StreamBucket</span> <code class="parameter">$bucket</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
    This function can be called to prepend a bucket to a bucket brigade. It
    is typically called from <span class="methodname"><a href="php-user-filter.filter.php" class="methodname">php_user_filter::filter()</a></span>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">class </span><span style="color: #0000BB">foo </span><span style="color: #007700">extends </span><span style="color: #0000BB">php_user_filter </span><span style="color: #007700">{<br />  protected </span><span style="color: #0000BB">$calls </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br />  public function </span><span style="color: #0000BB">filter</span><span style="color: #007700">(</span><span style="color: #0000BB">$in</span><span style="color: #007700">, </span><span style="color: #0000BB">$out</span><span style="color: #007700">, &amp;</span><span style="color: #0000BB">$consumed</span><span style="color: #007700">, </span><span style="color: #0000BB">$closing</span><span style="color: #007700">) {<br />    while (</span><span style="color: #0000BB">$bucket </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_bucket_make_writeable</span><span style="color: #007700">(</span><span style="color: #0000BB">$in</span><span style="color: #007700">)) {<br />      </span><span style="color: #0000BB">$consumed </span><span style="color: #007700">+= </span><span style="color: #0000BB">$bucket</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">datalen</span><span style="color: #007700">;<br />      if (</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">calls</span><span style="color: #007700">++ == </span><span style="color: #0000BB">2</span><span style="color: #007700">) {<br />        </span><span style="color: #FF8000">// This bucket will appear again before any other bucket.<br />        </span><span style="color: #0000BB">stream_bucket_prepend</span><span style="color: #007700">(</span><span style="color: #0000BB">$in</span><span style="color: #007700">, </span><span style="color: #0000BB">$bucket</span><span style="color: #007700">);<br />      }<br />    }<br />    return </span><span style="color: #0000BB">PSFS_FEED_ME</span><span style="color: #007700">;<br />  }<br />}<br /></span><span style="color: #0000BB">stream_filter_register</span><span style="color: #007700">(</span><span style="color: #DD0000">'test'</span><span style="color: #007700">, </span><span style="color: #DD0000">'foo'</span><span style="color: #007700">);<br />print  </span><span style="color: #0000BB">file_get_contents</span><span style="color: #007700">(</span><span style="color: #DD0000">'php://filter/read=test/resource=foo'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-bucket-prepend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-bucket-prepend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-bucket-prepend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-bucket-prepend.php">＋<small>add a note</small></a></span>
