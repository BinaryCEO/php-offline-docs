...
<head>
  ...
  <title>PHP: Imagick::setPage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setpage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setpage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setpage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setoption.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setpointsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setpage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setpage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setpage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setpage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setpage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setpage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setpage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setpage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setpage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setpage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setpage.php" hreflang="zh">
...
<meta name="Description" content="Sets the page geometry of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setPage - Manual" />
<meta name="twitter:description" content="Sets the page geometry of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setPage - Manual" />
<meta itemprop="description" content="Sets the page geometry of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the page geometry of the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setpointsize.php">
          Imagick::setPointSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setoption.php">
          &laquo; Imagick::setOption        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setpage.php' selected="selected">English</option>
            <option value='de/imagick.setpage.php'>German</option>
            <option value='es/imagick.setpage.php'>Spanish</option>
            <option value='fr/imagick.setpage.php'>French</option>
            <option value='it/imagick.setpage.php'>Italian</option>
            <option value='ja/imagick.setpage.php'>Japanese</option>
            <option value='pt_BR/imagick.setpage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setpage.php'>Russian</option>
            <option value='tr/imagick.setpage.php'>Turkish</option>
            <option value='uk/imagick.setpage.php'>Ukrainian</option>
            <option value='zh/imagick.setpage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setpage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setPage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setPage</span> &mdash; <span class="dc-title">Sets the page geometry of the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setpage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setPage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setpage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setpage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setpage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setpage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setpage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setpage.php">＋<small>add a note</small></a></span>
