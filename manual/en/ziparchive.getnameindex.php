...
<head>
  ...
  <title>PHP: ZipArchive::getNameIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getnameindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getnameindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getnameindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getfromname.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getnameindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.getnameindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.getnameindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.getnameindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.getnameindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.getnameindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.getnameindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.getnameindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.getnameindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.getnameindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.getnameindex.php" hreflang="zh">
...
<meta name="Description" content="Returns the name of an entry using its index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::getNameIndex - Manual" />
<meta name="twitter:description" content="Returns the name of an entry using its index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::getNameIndex - Manual" />
<meta itemprop="description" content="Returns the name of an entry using its index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of an entry using its index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.getstatusstring.php">
          ZipArchive::getStatusString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.getfromname.php">
          &laquo; ZipArchive::getFromName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getnameindex.php' selected="selected">English</option>
            <option value='de/ziparchive.getnameindex.php'>German</option>
            <option value='es/ziparchive.getnameindex.php'>Spanish</option>
            <option value='fr/ziparchive.getnameindex.php'>French</option>
            <option value='it/ziparchive.getnameindex.php'>Italian</option>
            <option value='ja/ziparchive.getnameindex.php'>Japanese</option>
            <option value='pt_BR/ziparchive.getnameindex.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.getnameindex.php'>Russian</option>
            <option value='tr/ziparchive.getnameindex.php'>Turkish</option>
            <option value='uk/ziparchive.getnameindex.php'>Ukrainian</option>
            <option value='zh/ziparchive.getnameindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.getnameindex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::getNameIndex</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.5.0)</p><p class="refpurpose"><span class="refname">ZipArchive::getNameIndex</span> &mdash; <span class="dc-title">Returns the name of an entry using its index</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.getnameindex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::getNameIndex</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.getnameindex-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.getnameindex-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the name on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>

 <div class="refsect1 examples" id="refsect1-ziparchive.getnameindex-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-931">
    <p><strong>Example #1 <span class="function"><strong>ZipArchive::getNameIndex()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">) == </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br /> for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">numFiles</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />     </span><span style="color: #0000BB">$filename </span><span style="color: #007700">= </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getNameIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">$i</span><span style="color: #007700">);<br />     </span><span style="color: #FF8000">// ...<br /> </span><span style="color: #007700">}<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getnameindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getnameindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getnameindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getnameindex.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89314">  <div class="votes">
    <div id="Vu89314">
    <a href="/manual/vote-note.php?id=89314&amp;page=ziparchive.getnameindex&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89314">
    <a href="/manual/vote-note.php?id=89314&amp;page=ziparchive.getnameindex&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89314" title="76% like this...">
    22
    </div>
  </div>
  <a href="#89314" class="name">
  <strong class="user"><em>Yeslifer</em></strong></a><a class="genanchor" href="#89314"> &para;</a><div class="date" title="2009-03-03 04:13"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89314">
<div class="phpcode"><code><span class="html">I couldn't find any how-to example for getting the filenames, so I made an easy one.
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.getnameindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getnameindex.php">＋<small>add a note</small></a></div>
