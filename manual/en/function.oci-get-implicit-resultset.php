...
<head>
  ...
  <title>PHP: oci_get_implicit_resultset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-get-implicit-resultset.php">
 <link rel="shorturl" href="https://www.php.net/oci-get-implicit-resultset">
 <link rel="alternate" href="https://www.php.net/oci-get-implicit-resultset" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-free-statement.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-lob-copy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-get-implicit-resultset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-get-implicit-resultset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-get-implicit-resultset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-get-implicit-resultset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-get-implicit-resultset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-get-implicit-resultset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-get-implicit-resultset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-get-implicit-resultset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-get-implicit-resultset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-get-implicit-resultset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-get-implicit-resultset.php" hreflang="zh">
...
<meta name="Description" content="Returns the next child statement resource from a parent statement resource that has Oracle Database Implicit Result Sets" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_get_implicit_resultset - Manual" />
<meta name="twitter:description" content="Returns the next child statement resource from a parent statement resource that has Oracle Database Implicit Result Sets" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_get_implicit_resultset - Manual" />
<meta itemprop="description" content="Returns the next child statement resource from a parent statement resource that has Oracle Database Implicit Result Sets" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the next child statement resource from a parent statement resource that has Oracle Database Implicit Result Sets" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.oci-lob-copy.php">
          oci_lob_copy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-free-statement.php">
          &laquo; oci_free_statement        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-get-implicit-resultset.php' selected="selected">English</option>
            <option value='de/function.oci-get-implicit-resultset.php'>German</option>
            <option value='es/function.oci-get-implicit-resultset.php'>Spanish</option>
            <option value='fr/function.oci-get-implicit-resultset.php'>French</option>
            <option value='it/function.oci-get-implicit-resultset.php'>Italian</option>
            <option value='ja/function.oci-get-implicit-resultset.php'>Japanese</option>
            <option value='pt_BR/function.oci-get-implicit-resultset.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-get-implicit-resultset.php'>Russian</option>
            <option value='tr/function.oci-get-implicit-resultset.php'>Turkish</option>
            <option value='uk/function.oci-get-implicit-resultset.php'>Ukrainian</option>
            <option value='zh/function.oci-get-implicit-resultset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-get-implicit-resultset" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.oci-get-implicit-resultset-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_get_implicit_resultset</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para">
    ...
    functions: <span class="function"><a href="function.oci-fetch.php" class="function">oci_fetch()</a></span>, <span class="function"><a href="function.oci-fetch-all.php" class="function">oci_fetch_all()</a></span>,
    <span class="function"><a href="function.oci-fetch-array.php" class="function">oci_fetch_array()</a></span>, <span class="function"><a href="function.oci-fetch-object.php" class="function">oci_fetch_object()</a></span>,
    <span class="function"><a href="function.oci-fetch-assoc.php" class="function">oci_fetch_assoc()</a></span> or <span class="function"><a href="function.oci-fetch-row.php" class="function">oci_fetch_row()</a></span>
  </p>
  <p class="para">
    Child statements inherit their parent statement&#039;s prefetch value,
    or it can be explicitly set with <span class="function"><a href="function.oci-set-prefetch.php" class="function">oci_set_prefetch()</a></span>.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
       <p class="para">A valid OCI8 statement identifier created
         by <span class="function"><a href="function.oci-parse.php" class="function">oci_parse()</a></span> and executed
         by <span class="function"><a href="function.oci-execute.php" class="function">oci_execute()</a></span>.  The statement
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-get-implicit-resultset-returnvalues">
  ...
  <p class="para">
   ...
   on <code class="parameter">statement</code>.  Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> when child
...
or using <span class="function"><a href="function.oci-set-prefetch.php" class="function">oci_set_prefetch()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-get-implicit-resultset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-get-implicit-resultset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-get-implicit-resultset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-get-implicit-resultset.php">＋<small>add a note</small></a></span>
