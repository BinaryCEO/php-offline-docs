...
<head>
  ...
  <title>PHP: array_uintersect_assoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-uintersect-assoc.php">
 <link rel="shorturl" href="https://www.php.net/array-uintersect-assoc">
 <link rel="alternate" href="https://www.php.net/array-uintersect-assoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-uintersect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-uintersect-uassoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-uintersect-assoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-uintersect-assoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-uintersect-assoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-uintersect-assoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-uintersect-assoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-uintersect-assoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-uintersect-assoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-uintersect-assoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-uintersect-assoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-uintersect-assoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-uintersect-assoc.php" hreflang="zh">
...
<meta name="Description" content="Computes the intersection of arrays with additional index check, compares data by a callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_uintersect_assoc - Manual" />
<meta name="twitter:description" content="Computes the intersection of arrays with additional index check, compares data by a callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_uintersect_assoc - Manual" />
<meta itemprop="description" content="Computes the intersection of arrays with additional index check, compares data by a callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the intersection of arrays with additional index check, compares data by a callback function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.array-uintersect-uassoc.php">
          array_uintersect_uassoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.array-uintersect.php">
          &laquo; array_uintersect        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-uintersect-assoc.php' selected="selected">English</option>
            <option value='de/function.array-uintersect-assoc.php'>German</option>
            <option value='es/function.array-uintersect-assoc.php'>Spanish</option>
            <option value='fr/function.array-uintersect-assoc.php'>French</option>
            <option value='it/function.array-uintersect-assoc.php'>Italian</option>
            <option value='ja/function.array-uintersect-assoc.php'>Japanese</option>
            <option value='pt_BR/function.array-uintersect-assoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-uintersect-assoc.php'>Russian</option>
            <option value='tr/function.array-uintersect-assoc.php'>Turkish</option>
            <option value='uk/function.array-uintersect-assoc.php'>Ukrainian</option>
            <option value='zh/function.array-uintersect-assoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-uintersect-assoc" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.array-uintersect-assoc-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>array_uintersect_assoc</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">...$arrays</code></span>, <span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$value_compare_func</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.array-uintersect.php" class="function">array_uintersect()</a></span>.
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-uintersect-uassoc.php" class="function" rel="rdfs-seeAlso">array_uintersect_uassoc()</a> - Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-uintersect-assoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-uintersect-assoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-uintersect-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-uintersect-assoc.php">＋<small>add a note</small></a></span>
