...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightalternatefield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightfields.php" hreflang="zh">
...
<meta name="Description" content="Returns all the fields that Solr should generate highlighted snippets for" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightFields - Manual" />
<meta name="twitter:description" content="Returns all the fields that Solr should generate highlighted snippets for" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightFields - Manual" />
<meta itemprop="description" content="Returns all the fields that Solr should generate highlighted snippets for" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the fields that Solr should generate highlighted snippets for" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightformatter.php">
          SolrQuery::getHighlightFormatter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightalternatefield.php">
          &laquo; SolrQuery::getHighlightAlternateField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightfields.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightfields.php'>German</option>
            <option value='es/solrquery.gethighlightfields.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightfields.php'>French</option>
            <option value='it/solrquery.gethighlightfields.php'>Italian</option>
            <option value='ja/solrquery.gethighlightfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightfields.php'>Russian</option>
            <option value='tr/solrquery.gethighlightfields.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightfields.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightFields</span> &mdash; <span class="dc-title">Returns all the fields that Solr should generate highlighted snippets for</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightfields-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightfields.php">＋<small>add a note</small></a></span>
