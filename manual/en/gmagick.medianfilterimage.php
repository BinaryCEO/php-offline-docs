...
<head>
  ...
  <title>PHP: Gmagick::medianfilterimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.mapimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.minifyimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.medianfilterimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.medianfilterimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.medianfilterimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.medianfilterimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.medianfilterimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.medianfilterimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.medianfilterimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.medianfilterimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.medianfilterimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.medianfilterimage.php" hreflang="zh">
...
<meta name="Description" content="Applies a digital filter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::medianfilterimage - Manual" />
<meta name="twitter:description" content="Applies a digital filter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::medianfilterimage - Manual" />
<meta itemprop="description" content="Applies a digital filter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a digital filter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.minifyimage.php">
          Gmagick::minifyimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.mapimage.php">
          &laquo; Gmagick::mapimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.medianfilterimage.php' selected="selected">English</option>
            <option value='de/gmagick.medianfilterimage.php'>German</option>
            <option value='es/gmagick.medianfilterimage.php'>Spanish</option>
            <option value='fr/gmagick.medianfilterimage.php'>French</option>
            <option value='it/gmagick.medianfilterimage.php'>Italian</option>
            <option value='ja/gmagick.medianfilterimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.medianfilterimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.medianfilterimage.php'>Russian</option>
            <option value='tr/gmagick.medianfilterimage.php'>Turkish</option>
            <option value='uk/gmagick.medianfilterimage.php'>Ukrainian</option>
            <option value='zh/gmagick.medianfilterimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.medianfilterimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::medianfilterimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::medianfilterimage</span> &mdash; <span class="dc-title">Applies a digital filter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.medianfilterimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::medianfilterimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.medianfilterimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.medianfilterimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with median filter applied.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.medianfilterimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/medianfilterimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.medianfilterimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.medianfilterimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.medianfilterimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116867">  <div class="votes">
    <div id="Vu116867">
    <a href="/manual/vote-note.php?id=116867&amp;page=gmagick.medianfilterimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116867">
    <a href="/manual/vote-note.php?id=116867&amp;page=gmagick.medianfilterimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116867" title="no votes...">
    0
    </div>
  </div>
  <a href="#116867" class="name">
  <strong class="user"><em>jeff at arizonacoders dot com</em></strong></a><a class="genanchor" href="#116867"> &para;</a><div class="date" title="2015-03-12 09:40"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116867">
<div class="phpcode"><code><span class="html">For people like me who like a quick reference, the filters are:<br /><br />FILTER_UNDEFINED =&gt; UndefinedFilter<br />FILTER_POINT =&gt; PointFilter<br />FILTER_BOX =&gt; BoxFilter<br />FILTER_TRIANGLE =&gt; TriangleFilter<br />FILTER_HERMITE =&gt; HermiteFilter<br />FILTER_HANNING =&gt; HanningFilter<br />FILTER_HAMMING =&gt; HammingFilter<br />FILTER_BLACKMAN =&gt; BlackmanFilter<br />FILTER_GAUSSIAN =&gt; GaussianFilter<br />FILTER_QUADRATIC =&gt; QuadraticFilter<br />FILTER_CUBIC =&gt; CubicFilter<br />FILTER_CATROM =&gt; CatromFilter<br />FILTER_MITCHELL =&gt; MitchellFilter<br />FILTER_LANCZOS =&gt; LanczosFilter<br />FILTER_BESSEL =&gt; BesselFilter<br />FILTER_SINC =&gt; SincFilter<br /><br />Ref: <a href="https://github.com/vitoc/gmagick/blob/master/gmagick_helpers.c" rel="nofollow" target="_blank">https://github.com/vitoc/gmagick/blob/master/gmagick_helpers.c</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.medianfilterimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.medianfilterimage.php">＋<small>add a note</small></a></div>
