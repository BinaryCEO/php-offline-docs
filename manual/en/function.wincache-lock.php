...
<head>
  ...
  <title>PHP: wincache_lock - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-lock.php">
 <link rel="shorturl" href="https://www.php.net/wincache-lock">
 <link rel="alternate" href="https://www.php.net/wincache-lock" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-fcache-meminfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ocache-fileinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-lock.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-lock.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-lock.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-lock.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-lock.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-lock.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-lock.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-lock.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-lock.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-lock.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-lock.php" hreflang="zh">
...
<meta name="Description" content="Acquires an exclusive lock on a given key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_lock - Manual" />
<meta name="twitter:description" content="Acquires an exclusive lock on a given key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_lock - Manual" />
<meta itemprop="description" content="Acquires an exclusive lock on a given key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Acquires an exclusive lock on a given key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-ocache-fileinfo.php">
          wincache_ocache_fileinfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-fcache-meminfo.php">
          &laquo; wincache_fcache_meminfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-lock.php' selected="selected">English</option>
            <option value='de/function.wincache-lock.php'>German</option>
            <option value='es/function.wincache-lock.php'>Spanish</option>
            <option value='fr/function.wincache-lock.php'>French</option>
            <option value='it/function.wincache-lock.php'>Italian</option>
            <option value='ja/function.wincache-lock.php'>Japanese</option>
            <option value='pt_BR/function.wincache-lock.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-lock.php'>Russian</option>
            <option value='tr/function.wincache-lock.php'>Turkish</option>
            <option value='uk/function.wincache-lock.php'>Ukrainian</option>
            <option value='zh/function.wincache-lock.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-lock" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.wincache-lock-description">
  ...
  <p class="para rdfs-comment">
   ...
   key will be blocked, until the current script releases the lock by using <span class="function"><a href="function.wincache-unlock.php" class="function">wincache_unlock()</a></span>.
  </p>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    Using of the <span class="function"><strong>wincache_lock()</strong></span> and <span class="function"><a href="function.wincache-unlock.php" class="function">wincache_unlock()</a></span> can cause deadlocks when 
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fp </span><span style="color: #007700">= </span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">"/tmp/lock.txt"</span><span style="color: #007700">, </span><span style="color: #DD0000">"r+"</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">wincache_lock</span><span style="color: #007700">(</span><span style="color: #0000BB">“lock_txt_lock”</span><span style="color: #007700">)) { </span><span style="color: #FF8000">// do an exclusive lock<br />    </span><span style="color: #0000BB">ftruncate</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">); </span><span style="color: #FF8000">// truncate file<br />    </span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #DD0000">"Write something here\n"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">wincache_unlock</span><span style="color: #007700">(</span><span style="color: #0000BB">“lock_txt_lock”</span><span style="color: #007700">); </span><span style="color: #FF8000">// release the lock<br /></span><span style="color: #007700">} else {<br />    echo </span><span style="color: #DD0000">"Couldn't get the lock!"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.wincache-lock-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.wincache-unlock.php" class="function" rel="rdfs-seeAlso">wincache_unlock()</a> - Releases an exclusive lock on a given key</span></li>
    ...
    <li><span class="function"><a href="function.wincache-scache-info.php" class="function" rel="rdfs-seeAlso">wincache_scache_info()</a> - Retrieves information about files cached in the session cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-lock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-lock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-lock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-lock.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123990">  <div class="votes">
    <div id="Vu123990">
    <a href="/manual/vote-note.php?id=123990&amp;page=function.wincache-lock&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123990">
    <a href="/manual/vote-note.php?id=123990&amp;page=function.wincache-lock&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123990" title="100% like this...">
    1
    </div>
  </div>
  <a href="#123990" class="name">
  <strong class="user"><em>PrisonDoom</em></strong></a><a class="genanchor" href="#123990"> &para;</a><div class="date" title="2019-06-28 10:04"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123990">
<div class="phpcode"><code><span class="html">The external link was off and the backslash "\" most of time are used for "scape character". Anyway, regards.</span></code></div>
  </div>
 </div>
  <div class="note" id="97528">  <div class="votes">
    <div id="Vu97528">
    <a href="/manual/vote-note.php?id=97528&amp;page=function.wincache-lock&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97528">
    <a href="/manual/vote-note.php?id=97528&amp;page=function.wincache-lock&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97528" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#97528" class="name">
  <strong class="user"><em>donraman at microsoft dot com</em></strong></a><a class="genanchor" href="#97528"> &para;</a><div class="date" title="2010-04-23 06:11"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97528">
<div class="phpcode"><code><span class="html">User should be aware that character '\' is not allowed as part of lock name. The reason why backslash is not allowed is because we are using CreateMutex call as described at <a href="http://msdn.microsoft.com/en-us/library/ms682411(VS.85" rel="nofollow" target="_blank">http://msdn.microsoft.com/en-us/library/ms682411(VS.85</a>).aspx. As per this article third parameter cannot have '\' character which is the lock name.<br /><br />This means below code will not work.<br /><br /><span class="default">&lt;?php<br /><br />   $ret_val </span><span class="keyword">= </span><span class="default">wincache_lock</span><span class="keyword">(</span><span class="string">"C:\WINDOWS\Temp/cache"</span><span class="keyword">);<br />   echo </span><span class="default">$ret_val </span><span class="keyword">. </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />   </span><span class="default">$ret_val </span><span class="keyword">= </span><span class="default">wincache_unlock</span><span class="keyword">(</span><span class="string">"C:\WINDOWS\Temp/cache"</span><span class="keyword">);<br />   echo </span><span class="default">$ret_val </span><span class="keyword">. </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.wincache-lock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-lock.php">＋<small>add a note</small></a></div>
