...
<head>
  ...
  <title>PHP: ReflectionClass::isReadOnly - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.issubclassof.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isreadonly.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isreadonly.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isreadonly.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isreadonly.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isreadonly.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isreadonly.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isreadonly.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isreadonly.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isreadonly.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isreadonly.php" hreflang="zh">
...
<meta name="Description" content="Checks if class is readonly" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isReadOnly - Manual" />
<meta name="twitter:description" content="Checks if class is readonly" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isReadOnly - Manual" />
<meta itemprop="description" content="Checks if class is readonly" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if class is readonly" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.issubclassof.php">
          ReflectionClass::isSubclassOf &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isiterateable.php">
          &laquo; ReflectionClass::isIterateable        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isreadonly.php' selected="selected">English</option>
            <option value='de/reflectionclass.isreadonly.php'>German</option>
            <option value='es/reflectionclass.isreadonly.php'>Spanish</option>
            <option value='fr/reflectionclass.isreadonly.php'>French</option>
            <option value='it/reflectionclass.isreadonly.php'>Italian</option>
            <option value='ja/reflectionclass.isreadonly.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isreadonly.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isreadonly.php'>Russian</option>
            <option value='tr/reflectionclass.isreadonly.php'>Turkish</option>
            <option value='uk/reflectionclass.isreadonly.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isreadonly.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isreadonly" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isReadOnly</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.2.0)</p><p class="refpurpose"><span class="refname">ReflectionClass::isReadOnly</span> &mdash; <span class="dc-title">Checks if class is readonly</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isreadonly-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isReadOnly</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Checks if a class is <a href="language.oop5.basic.php#language.oop5.basic.class.readonly" class="link">readonly</a>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-reflectionclass.isreadonly-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isreadonly-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if a class is readonly, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-reflectionclass.isreadonly-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5505">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::isReadOnly()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class </span><span style="color: #0000BB">TestClass </span><span style="color: #007700">{ }<br />readonly class </span><span style="color: #0000BB">TestReadOnlyClass </span><span style="color: #007700">{ }<br /><br /></span><span style="color: #0000BB">$normalClass </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #DD0000">'TestClass'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$readonlyClass </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #DD0000">'TestReadOnlyClass'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$normalClass</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isReadOnly</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$readonlyClass</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isReadOnly</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isreadonly-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.isabstract.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isAbstract()</a> - Checks if class is abstract</span></li>
    <li><a href="language.oop5.basic.php#language.oop5.basic.class.readonly" class="link">Readonly classes</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isreadonly.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isreadonly%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isreadonly&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isreadonly.php">＋<small>add a note</small></a></span>
