...
<head>
  ...
  <title>PHP: array_diff_uassoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-diff-uassoc.php">
 <link rel="shorturl" href="https://www.php.net/array-diff-uassoc">
 <link rel="alternate" href="https://www.php.net/array-diff-uassoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-diff-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-diff-ukey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-diff-uassoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-diff-uassoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-diff-uassoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-diff-uassoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-diff-uassoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-diff-uassoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-diff-uassoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-diff-uassoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-diff-uassoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-diff-uassoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-diff-uassoc.php" hreflang="zh">
...
<meta name="Description" content="Computes the difference of arrays with additional index check which is performed by a user supplied callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_diff_uassoc - Manual" />
<meta name="twitter:description" content="Computes the difference of arrays with additional index check which is performed by a user supplied callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_diff_uassoc - Manual" />
<meta itemprop="description" content="Computes the difference of arrays with additional index check which is performed by a user supplied callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the difference of arrays with additional index check which is performed by a user supplied callback function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.array-diff-ukey.php">
          array_diff_ukey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.array-diff-key.php">
          &laquo; array_diff_key        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-diff-uassoc.php' selected="selected">English</option>
            <option value='de/function.array-diff-uassoc.php'>German</option>
            <option value='es/function.array-diff-uassoc.php'>Spanish</option>
            <option value='fr/function.array-diff-uassoc.php'>French</option>
            <option value='it/function.array-diff-uassoc.php'>Italian</option>
            <option value='ja/function.array-diff-uassoc.php'>Japanese</option>
            <option value='pt_BR/function.array-diff-uassoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-diff-uassoc.php'>Russian</option>
            <option value='tr/function.array-diff-uassoc.php'>Turkish</option>
            <option value='uk/function.array-diff-uassoc.php'>Ukrainian</option>
            <option value='zh/function.array-diff-uassoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-diff-uassoc" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-uintersect-uassoc.php" class="function" rel="rdfs-seeAlso">array_uintersect_uassoc()</a> - Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-diff-uassoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-diff-uassoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-diff-uassoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-diff-uassoc.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114603">  <div class="votes">
    <div id="Vu114603">
    <a href="/manual/vote-note.php?id=114603&amp;page=function.array-diff-uassoc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114603">
    <a href="/manual/vote-note.php?id=114603&amp;page=function.array-diff-uassoc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114603" title="50% like this...">
    0
    </div>
  </div>
  <a href="#114603" class="name">
  <strong class="user"><em>MD. ABU SAYEM</em></strong></a><a class="genanchor" href="#114603"> &para;</a><div class="date" title="2014-03-11 06:12"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114603">
<div class="phpcode"><code><span class="html">//array_diff_uassoc for multidimenssional array<br />$color_1=array('a'=&gt;'white','b'=&gt;'red','c'=&gt;array('a'=&gt;'green','b'=&gt;'blue','c'=&gt;'yellow'));<br />$color_2=array('a'=&gt;'white','b'=&gt;'red','c'=&gt;array('a'=&gt;'white','b'=&gt;'red','c'=&gt;'yellow'));<br /><br />function key_compare($a,$b){<br />    if($a===$b)        return 0;<br />    return($a&gt;$b)?1:-1;<br />}<br />print_r(array_diff_uassoc($color_1['c'], $color_2['c'],"key_compare"));<br /><br />//Output<br /> Array<br />(<br />    [a] =&gt; green<br />    [b] =&gt; blue<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array-diff-uassoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-diff-uassoc.php">＋<small>add a note</small></a></div>
