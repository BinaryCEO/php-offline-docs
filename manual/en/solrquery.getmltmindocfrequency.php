...
<head>
  ...
  <title>PHP: SolrQuery::getMltMinDocFrequency - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltmaxwordlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltmintermfrequency.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltmindocfrequency.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltmindocfrequency.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltmindocfrequency.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltmindocfrequency.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltmindocfrequency.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltmindocfrequency.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltmindocfrequency.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltmindocfrequency.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltmindocfrequency.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltmindocfrequency.php" hreflang="zh">
...
<meta name="Description" content="Returns the treshold frequency at which words will be ignored which do not occur in at least this many docs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltMinDocFrequency - Manual" />
<meta name="twitter:description" content="Returns the treshold frequency at which words will be ignored which do not occur in at least this many docs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltMinDocFrequency - Manual" />
<meta itemprop="description" content="Returns the treshold frequency at which words will be ignored which do not occur in at least this many docs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the treshold frequency at which words will be ignored which do not occur in at least this many docs" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getmltmintermfrequency.php">
          SolrQuery::getMltMinTermFrequency &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltmaxwordlength.php">
          &laquo; SolrQuery::getMltMaxWordLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltmindocfrequency.php' selected="selected">English</option>
            <option value='de/solrquery.getmltmindocfrequency.php'>German</option>
            <option value='es/solrquery.getmltmindocfrequency.php'>Spanish</option>
            <option value='fr/solrquery.getmltmindocfrequency.php'>French</option>
            <option value='it/solrquery.getmltmindocfrequency.php'>Italian</option>
            <option value='ja/solrquery.getmltmindocfrequency.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltmindocfrequency.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltmindocfrequency.php'>Russian</option>
            <option value='tr/solrquery.getmltmindocfrequency.php'>Turkish</option>
            <option value='uk/solrquery.getmltmindocfrequency.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltmindocfrequency.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltmindocfrequency" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltMinDocFrequency</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltMinDocFrequency</span> &mdash; <span class="dc-title">Returns the treshold frequency at which words will be ignored which do not occur in at least this many docs</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltmindocfrequency-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltMinDocFrequency</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltmindocfrequency-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltmindocfrequency-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltmindocfrequency.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltmindocfrequency%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltmindocfrequency&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltmindocfrequency.php">＋<small>add a note</small></a></span>
