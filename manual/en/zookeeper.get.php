...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.get.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.get.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.get.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.exists.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.getacl.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.get.php' selected="selected">English</option>
            ...
            <option value='zh/zookeeper.get.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-zookeeper.get-examples">
  ...
  <div class="example" id="zookeeper.get.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>Zookeeper::get()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">nodevalue</pre>
  ...
  <div class="example" id="zookeeper.get.example.stat">
   <p><strong>Example #2 <span class="methodname"><strong>Zookeeper::get()</strong></span> stat example</strong></p>
   <div class="example-contents"><p>
     Get node stat info.
   </p></div>
   <div class="example-contents">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.get.php">＋<small>add a note</small></a></span>
