...
<head>
  ...
  <title>PHP: Imagick::getPixelRegionIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getpixelregioniterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getpixelregioniterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpixelregioniterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getpixeliterator.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getpointsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpixelregioniterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getpixelregioniterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getpixelregioniterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getpixelregioniterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getpixelregioniterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getpixelregioniterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getpixelregioniterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getpixelregioniterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getpixelregioniterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getpixelregioniterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getpixelregioniterator.php" hreflang="zh">
...
<meta name="Description" content="Get an ImagickPixelIterator for an image section" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getPixelRegionIterator - Manual" />
<meta name="twitter:description" content="Get an ImagickPixelIterator for an image section" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getPixelRegionIterator - Manual" />
<meta itemprop="description" content="Get an ImagickPixelIterator for an image section" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get an ImagickPixelIterator for an image section" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getpointsize.php">
          Imagick::getPointSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getpixeliterator.php">
          &laquo; Imagick::getPixelIterator        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getpixelregioniterator.php' selected="selected">English</option>
            <option value='de/imagick.getpixelregioniterator.php'>German</option>
            <option value='es/imagick.getpixelregioniterator.php'>Spanish</option>
            <option value='fr/imagick.getpixelregioniterator.php'>French</option>
            <option value='it/imagick.getpixelregioniterator.php'>Italian</option>
            <option value='ja/imagick.getpixelregioniterator.php'>Japanese</option>
            <option value='pt_BR/imagick.getpixelregioniterator.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getpixelregioniterator.php'>Russian</option>
            <option value='tr/imagick.getpixelregioniterator.php'>Turkish</option>
            <option value='uk/imagick.getpixelregioniterator.php'>Ukrainian</option>
            <option value='zh/imagick.getpixelregioniterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getpixelregioniterator" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getPixelRegionIterator</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getPixelRegionIterator</span> &mdash; <span class="dc-title">Get an ImagickPixelIterator for an image section</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-imagick.getpixelregioniterator-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getPixelRegionIterator</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span><br>): <span class="type"><a href="class.imagickpixeliterator.php" class="type ImagickPixelIterator">ImagickPixelIterator</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getpixelregioniterator-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getpixelregioniterator-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getpixelregioniterator-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.getpixelregioniterator-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3017">
    <p><strong>Example #1 <span class="methodname"><strong>Imagick::getPixelRegionIterator()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     Iterate over the pixels in the top left of the image, changing them to be black.
    </p></div>
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"./testImage.png"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$areaIterator </span><span style="color: #007700">= </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getPixelRegionIterator</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">, </span><span style="color: #0000BB">10</span><span style="color: #007700">);<br /><br />foreach (</span><span style="color: #0000BB">$areaIterator </span><span style="color: #007700">as </span><span style="color: #0000BB">$rowIterator</span><span style="color: #007700">) {<br />    foreach (</span><span style="color: #0000BB">$rowIterator </span><span style="color: #007700">as </span><span style="color: #0000BB">$pixel</span><span style="color: #007700">) {<br />        </span><span style="color: #FF8000">// Paint every pixel black<br />        </span><span style="color: #0000BB">$pixel</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setColor</span><span style="color: #007700">(</span><span style="color: #DD0000">"rgba(0, 0, 0, 0)"</span><span style="color: #007700">);<br />    }<br />    </span><span style="color: #0000BB">$areaIterator</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">syncIterator</span><span style="color: #007700">();<br />}<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"./output.png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getpixelregioniterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getpixelregioniterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getpixelregioniterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getpixelregioniterator.php">＋<small>add a note</small></a></span>
