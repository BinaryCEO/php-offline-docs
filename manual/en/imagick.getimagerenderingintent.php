...
<head>
  ...
  <title>PHP: Imagick::getImageRenderingIntent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageregion.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageresolution.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagerenderingintent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagerenderingintent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagerenderingintent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagerenderingintent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagerenderingintent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagerenderingintent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagerenderingintent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagerenderingintent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagerenderingintent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagerenderingintent.php" hreflang="zh">
...
<meta name="Description" content="Gets the image rendering intent" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageRenderingIntent - Manual" />
<meta name="twitter:description" content="Gets the image rendering intent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageRenderingIntent - Manual" />
<meta itemprop="description" content="Gets the image rendering intent" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image rendering intent" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageresolution.php">
          Imagick::getImageResolution &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageregion.php">
          &laquo; Imagick::getImageRegion        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagerenderingintent.php' selected="selected">English</option>
            <option value='de/imagick.getimagerenderingintent.php'>German</option>
            <option value='es/imagick.getimagerenderingintent.php'>Spanish</option>
            <option value='fr/imagick.getimagerenderingintent.php'>French</option>
            <option value='it/imagick.getimagerenderingintent.php'>Italian</option>
            <option value='ja/imagick.getimagerenderingintent.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagerenderingintent.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagerenderingintent.php'>Russian</option>
            <option value='tr/imagick.getimagerenderingintent.php'>Turkish</option>
            <option value='uk/imagick.getimagerenderingintent.php'>Ukrainian</option>
            <option value='zh/imagick.getimagerenderingintent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagerenderingintent" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagerenderingintent-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageRenderingIntent</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagerenderingintent-returnvalues">
  ...
  <p class="para">
   Returns the image <a href="imagick.constants.php#imagick.constants.renderingintent" class="link">rendering intent</a>.
  </p>
 </div>
