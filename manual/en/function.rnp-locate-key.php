...
<head>
  ...
  <title>PHP: rnp_locate_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-locate-key.php">
 <link rel="shorturl" href="https://www.php.net/rnp-locate-key">
 <link rel="alternate" href="https://www.php.net/rnp-locate-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-load-keys-from-path.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-op-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-locate-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-locate-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-locate-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-locate-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-locate-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-locate-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-locate-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-locate-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-locate-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-locate-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-locate-key.php" hreflang="zh">
...
<meta name="Description" content="Search for the key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_locate_key - Manual" />
<meta name="twitter:description" content="Search for the key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_locate_key - Manual" />
<meta itemprop="description" content="Search for the key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Search for the key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.rnp-op-encrypt.php">
          rnp_op_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-load-keys-from-path.php">
          &laquo; rnp_load_keys_from_path        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-locate-key.php' selected="selected">English</option>
            <option value='de/function.rnp-locate-key.php'>German</option>
            <option value='es/function.rnp-locate-key.php'>Spanish</option>
            <option value='fr/function.rnp-locate-key.php'>French</option>
            <option value='it/function.rnp-locate-key.php'>Italian</option>
            <option value='ja/function.rnp-locate-key.php'>Japanese</option>
            <option value='pt_BR/function.rnp-locate-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-locate-key.php'>Russian</option>
            <option value='tr/function.rnp-locate-key.php'>Turkish</option>
            <option value='uk/function.rnp-locate-key.php'>Ukrainian</option>
            <option value='zh/function.rnp-locate-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-locate-key" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-locate-key-returnvalues">
  ...
  <p class="para">
   Returns hexadecimal fingerprint of the key found on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-locate-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-locate-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-locate-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-locate-key.php">＋<small>add a note</small></a></span>
