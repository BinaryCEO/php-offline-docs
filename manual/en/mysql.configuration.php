...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysql.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql.resources.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql.configuration.php' selected="selected">English</option>
            ...
            <option value='tr/mysql.configuration.php'>Turkish</option>
    ...
    <p class="para">
     ...
     waiting for the first answer from the server.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql.configuration.php">＋<small>add a note</small></a></span>
