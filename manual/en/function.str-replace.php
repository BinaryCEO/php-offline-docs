...
<head>
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.str-replace.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.str-replace.php" hreflang="uk">
...
<meta name="Description" content="Replace all occurrences of the search string with the replacement string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: str_replace - Manual" />
<meta name="twitter:description" content="Replace all occurrences of the search string with the replacement string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: str_replace - Manual" />
<meta itemprop="description" content="Replace all occurrences of the search string with the replacement string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace all occurrences of the search string with the replacement string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/function.str-replace.php'>Italian</option>
            ...
            <option value='uk/function.str-replace.php'>Ukrainian</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.str-replace-examples">
  ...
  <p class="para">
   <div class="example" id="example-5139">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Provides: &lt;body text='black'&gt;<br /></span><span style="color: #0000BB">$bodytag </span><span style="color: #007700">= </span><span style="color: #0000BB">str_replace</span><span style="color: #007700">(</span><span style="color: #DD0000">"%body%"</span><span style="color: #007700">, </span><span style="color: #DD0000">"black"</span><span style="color: #007700">, </span><span style="color: #DD0000">"&lt;body text='%body%'&gt;"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$bodytag</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Provides: Hll Wrld f PHP<br /></span><span style="color: #0000BB">$vowels </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"a"</span><span style="color: #007700">, </span><span style="color: #DD0000">"e"</span><span style="color: #007700">, </span><span style="color: #DD0000">"i"</span><span style="color: #007700">, </span><span style="color: #DD0000">"o"</span><span style="color: #007700">, </span><span style="color: #DD0000">"u"</span><span style="color: #007700">, </span><span style="color: #DD0000">"A"</span><span style="color: #007700">, </span><span style="color: #DD0000">"E"</span><span style="color: #007700">, </span><span style="color: #DD0000">"I"</span><span style="color: #007700">, </span><span style="color: #DD0000">"O"</span><span style="color: #007700">, </span><span style="color: #DD0000">"U"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$onlyconsonants </span><span style="color: #007700">= </span><span style="color: #0000BB">str_replace</span><span style="color: #007700">(</span><span style="color: #0000BB">$vowels</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #DD0000">"Hello World of PHP"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$onlyconsonants</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Provides: You should eat pizza, beer, and ice cream every day<br /></span><span style="color: #0000BB">$phrase  </span><span style="color: #007700">= </span><span style="color: #DD0000">"You should eat fruits, vegetables, and fiber every day."</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$healthy </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"fruits"</span><span style="color: #007700">, </span><span style="color: #DD0000">"vegetables"</span><span style="color: #007700">, </span><span style="color: #DD0000">"fiber"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$yummy   </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"pizza"</span><span style="color: #007700">, </span><span style="color: #DD0000">"beer"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ice cream"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$newphrase </span><span style="color: #007700">= </span><span style="color: #0000BB">str_replace</span><span style="color: #007700">(</span><span style="color: #0000BB">$healthy</span><span style="color: #007700">, </span><span style="color: #0000BB">$yummy</span><span style="color: #007700">, </span><span style="color: #0000BB">$phrase</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$newphrase</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Provides: 2<br /></span><span style="color: #0000BB">$str </span><span style="color: #007700">= </span><span style="color: #0000BB">str_replace</span><span style="color: #007700">(</span><span style="color: #DD0000">"ll"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #DD0000">"good golly miss molly!"</span><span style="color: #007700">, </span><span style="color: #0000BB">$count</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-5140">
...
binary-safe.</span></p></blockquote>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strtr.php" class="function" rel="rdfs-seeAlso">strtr()</a> - Translate characters or replace substrings</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/str-replace.xml">Submit a Pull Request</a>
        •
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.str-replace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.str-replace.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>nikolaz dot tang at hotmail dot com</em></strong></a><a class="genanchor" href="#100871"> &para;</a><div class="date" title="2010-11-11 08:57"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100871">
<div class="phpcode"><code><span class="html">A faster way to replace the strings in multidimensional array is to json_encode() it, do the str_replace() and then json_decode() it, like this:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="126182">  <div class="votes">
    ...
    <div class="tally" id="V126182" title="78% like this...">
    11
    </div>
  </div>
  <a href="#126182" class="name">
  <strong class="user"><em>ressing1 at gmail dot com</em></strong></a><a class="genanchor" href="#126182"> &para;</a><div class="date" title="2021-06-21 08:34"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126182">
<div class="phpcode"><code><span class="html">To remove all characters from string $b that exist in string $a:<br /><br />$a="ABC";<br />$b="teAsBtC";<br />echo str_replace(str_split($a),'',$b); <br /><br />Output: test<br /><br />To remove all characters from string $b that don't exist in string $a:<br /><br />$a="ABC";<br />$b="teAsBtC";<br />echo str_replace(str_split(str_replace(str_split($a),'',$b)),'',$b);<br /><br />Output: ABC</span></code></div>
  </div>
 </div>
  <div class="note" id="91536">  <div class="votes">
    ...
    <div class="tally" id="V91536" title="66% like this...">
    52
    </div>
  </div>
  <a href="#91536" class="name">
  <strong class="user"><em>Alberto Lepe</em></strong></a><a class="genanchor" href="#91536"> &para;</a><div class="date" title="2009-06-15 07:44"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91536">
<div class="phpcode"><code><span class="html">Be careful when replacing characters (or repeated patterns in the FROM and TO arrays):
<br />
<br />For example:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />This returns: "ZDDB"</span></code></div>
  </div>
 </div>
  <div class="note" id="105939">  <div class="votes">
    ...
    <div class="tally" id="V105939" title="64% like this...">
    60
    </div>
  </div>
  <a href="#105939" class="name">
  <strong class="user"><em>moostende at gmail dot com</em></strong></a><a class="genanchor" href="#105939"> &para;</a><div class="date" title="2011-09-26 11:20"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105939">
<div class="phpcode"><code><span class="html">Note that this does not replace strings that become part of replacement strings. This may be a problem when you want to remove multiple instances of the same repetative pattern, several times in a row.
<br />
...
<br />-aaa--b-c---d-e--f
<br />-aaa-b-c-d-e-f</span></code></div>
  </div>
 </div>
  <div class="note" id="115946">  <div class="votes">
    ...
    <div class="tally" id="V115946" title="67% like this...">
    10
    </div>
  </div>
  <a href="#115946" class="name">
  <strong class="user"><em>karst at onlinq dot nl</em></strong></a><a class="genanchor" href="#115946"> &para;</a><div class="date" title="2014-10-17 01:57"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115946">
<div class="phpcode"><code><span class="html">"If search is an array and replace is a string, then this replacement string is used for every value of search. The converse would not make sense, though. "<br /><br />I think one important (and not at all vaguely theoretical) use-case is completely ignored here. Take, for example, the way the PDO handles parameter replacement.<br /><br />If we have the following query:<br />"SELECT * FROM my_table WHERE (id = ? AND my_column = ? AND other_column = ?);"<br />The "?"s should be replaced by each successive variable in a $parameters array. That is EXACTLY the use case for "search" being a value and "replace" being an array. <br /><br />Considering that this is not only a real-world example but also part of a core PHP functionality I find it very strange that it's dismissed so easily here.</span></code></div>
  </div>
 </div>
  <div class="note" id="122929">  <div class="votes">
    ...
    <div class="tally" id="V122929" title="62% like this...">
    11
    </div>
  </div>
  <a href="#122929" class="name">
  <strong class="user"><em>ravenswd at gmail dot com</em></strong></a><a class="genanchor" href="#122929"> &para;</a><div class="date" title="2018-07-11 01:33"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122929">
<div class="phpcode"><code><span class="html">This is what happens when the search and replace arrays are different sizes:<br /><br /><span class="default">&lt;?php<br />$search  </span><span class="keyword">= array(</span><span class="string">'a'</span><span class="keyword">, </span><span class="string">'b'</span><span class="keyword">, </span><span class="string">'c'</span><span class="keyword">, </span><span class="string">'d'</span><span class="keyword">, </span><span class="string">'e'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'A'</span><span class="keyword">, </span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'abcdefg'</span><span class="keyword">;<br />echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">);<br /></span><span class="comment">// result: 'ABCfg'<br /><br /></span><span class="default">$search  </span><span class="keyword">= array(</span><span class="string">'a'</span><span class="keyword">, </span><span class="string">'b'</span><span class="keyword">, </span><span class="string">'c'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'A'</span><span class="keyword">, </span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'abcdefg'</span><span class="keyword">;<br />echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">);<br /></span><span class="comment">// result: 'ABCdefg'<br /></span><span class="default">?&gt;<br /></span><br />No warning or error is generated in either of these cases.</span></code></div>
  </div>
 </div>
  <div class="note" id="95198">  <div class="votes">
    ...
    <div class="tally" id="V95198" title="60% like this...">
    38
    </div>
  </div>
  <a href="#95198" class="name">
  <strong class="user"><em>Wes Foster</em></strong></a><a class="genanchor" href="#95198"> &para;</a><div class="date" title="2009-12-17 01:32"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95198">
<div class="phpcode"><code><span class="html">Feel free to optimize this using the while/for or anything else, but this is a bit of code that allows you to replace strings found in an associative array.
<br />
<br />For example:
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />[Jun 1st, 2010 - EDIT BY thiago AT php DOT net: Function has been replaced with an updated version sent by ljelinek AT gmail DOT com]</span></code></div>
  </div>
 </div>
  <div class="note" id="119793">  <div class="votes">
    ...
    <div class="tally" id="V119793" title="61% like this...">
    4
    </div>
  </div>
  <a href="#119793" class="name">
  <strong class="user"><em>viundan at gmail dot com</em></strong></a><a class="genanchor" href="#119793"> &para;</a><div class="date" title="2016-08-26 04:08"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119793">
<div class="phpcode"><code><span class="html">Decision to avoid problem "it might replace a previously inserted value when doing multiple replacements. See also the examples in this document." <br /><br />$urls - array of urls i want to replace with tag &lt;a&gt; and urls could be similar<br /><a href="http://abc.com/parameter/" rel="nofollow" target="_blank">http://abc.com/parameter/</a><br /><a href="http://abc.com/" rel="nofollow" target="_blank">http://abc.com/</a><br /><br />// at first sort by length to have longest firstly<br />usort($urls,'sortByLen');<br /><br />$replaces=[];<br /><br />// replace all urls with unique<br />foreach($urls as $url){<br />    $replace = '__REPLACE' . uniqid() . '__';     <br />    $text = str_replace($url,$replace, $text);<br />    $replaces[$replace] = '&lt;a href="' . $url . '"&gt;' . $url . '&lt;/a&gt;';<br />}<br /><br />foreach($replaces as $key =&gt; $replace){<br />    $text = str_replace($key,$replace, $text);<br />}<br /><br />--------------<br /><br />function sortByLen($a,$b){<br />    return strlen($b)-strlen($a);<br />}<br /><br />Hope it will help others like me</span></code></div>
  </div>
 </div>
  <div class="note" id="118785">  <div class="votes">
    ...
    <div class="tally" id="V118785" title="59% like this...">
    15
    </div>
  </div>
  <a href="#118785" class="name">
  <strong class="user"><em>David Holt</em></strong></a><a class="genanchor" href="#118785"> &para;</a><div class="date" title="2016-02-05 02:59"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118785">
<div class="phpcode"><code><span class="html">Be aware that if you use this for filtering &amp; sanitizing some form of user input, or remove ALL instances of a string, there's another gotcha to watch out for:<br /><br />// Remove all double characters<br />$string="1001011010";<br />$string=str_replace(array("11","00"),"",$string);<br />// Output: "110010"<br /><br />$string="&lt;ht&lt;html&gt;ml&gt; Malicious code &lt;/&lt;html&gt;html&gt; etc";<br />$string=str_replace(array("&lt;html&gt;","&lt;/html&gt;"),"",$string);<br />// Output: "&lt;html&gt; Malicious code &lt;/html&gt; etc"</span></code></div>
  </div>
 </div>
  <div class="note" id="98511">  <div class="votes">
    ...
    <div class="tally" id="V98511" title="61% like this...">
    6
    </div>
  </div>
  <a href="#98511" class="name">
  <strong class="user"><em>apmuthu at usa dot net</em></strong></a><a class="genanchor" href="#98511"> &para;</a><div class="date" title="2010-06-19 12:31"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98511">
<div class="phpcode"><code><span class="html">If we have a html template that contains placeholders in curly braces that need to be replaced in runtime, the following function will do it using str_replace:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">parse_template</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">) {<br /></span><span class="comment">// example template variables {a} and {bc}<br />// example $data array<br />// $data = Array("a" =&gt; 'one', "bc" =&gt; 'two');<br />    </span><span class="default">$q </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">);<br />    foreach (</span><span class="default">$data </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">) {<br />        </span><span class="default">$q </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'{'</span><span class="keyword">.</span><span class="default">$key</span><span class="keyword">.</span><span class="string">'}'</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">, </span><span class="default">$q</span><span class="keyword">);<br />    }<br />    return </span><span class="default">$q</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As previous commentators mentioned, when $search contains values that occur earlier in $replace, str_replace will factor those previous replacements into the process rather than operating solely on the original string.  This may produce unexpected output.<br /><br />Example:<br /><br /><span class="default">&lt;?php<br />$search </span><span class="keyword">= array(</span><span class="string">'A'</span><span class="keyword">, </span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">, </span><span class="string">'F'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'ABCDE'</span><span class="keyword">;<br /><br />echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: 'FFFFFF'<br /></span><span class="default">?&gt;<br /></span><br />In the above code, the $search and $replace should replace each occurrence in the $subject with the next letter in the alphabet.  The expected output for this sample is 'BCDEF'; however, the actual output is 'FFFFF'.<br /><br />To more clearly illustrate this, consider the following example:<br /><br /><span class="default">&lt;?php<br />$search </span><span class="keyword">= array(</span><span class="string">'A'</span><span class="keyword">, </span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">, </span><span class="string">'F'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'A'</span><span class="keyword">;<br /><br />echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: 'F'<br /></span><span class="default">?&gt;<br /></span><br />Since 'A' is the only letter in the $search array that appears in $subject, one would expect the result to be 'B'; however, replacement number $n does *not* operate on $subject, it operates on $subject after the previous $n-1 replacements have been completed.<br /><br />The following function utilizes array_combine and strtr to produce the expected output, and I believe it is the most efficient way to perform the desired string replacement without prior replacements affecting the final result.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br />* When using str_replace(...), values that did not exist in the original string (but were put there by previous<br />* replacements) will be replaced continuously.  This string replacement function is designed replace the values<br />* in $search with those in $replace while not factoring in prior replacements.  Note that this function will<br />* always look for the longest possible match first and then work its way down to individual characters.<br />*<br />* The "o" in "stro_replace" represents "original", indicating that the function operates only on the original string.<br />*<br />* @param array $search list of strings or characters that need to be replaced<br />* @param array $replace list of strings or characters that will replace the corresponding values in $search<br />* @param string $subject the string on which this operation is being performed<br />*<br />* @return string $subject with all substrings in the $search array replaced by the values in the $replace array<br />*/<br /></span><span class="keyword">function </span><span class="default">stro_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">)<br />{<br />    return </span><span class="default">strtr</span><span class="keyword">( </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">array_combine</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">) );<br />}<br /><br /></span><span class="default">$search </span><span class="keyword">= array(</span><span class="string">'A'</span><span class="keyword">, </span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'B'</span><span class="keyword">, </span><span class="string">'C'</span><span class="keyword">, </span><span class="string">'D'</span><span class="keyword">, </span><span class="string">'E'</span><span class="keyword">, </span><span class="string">'F'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'ABCDE'</span><span class="keyword">;<br /><br />echo </span><span class="default">stro_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: 'BCDEF'<br /></span><span class="default">?&gt;<br /></span><br />Some other examples:<br /><br /><span class="default">&lt;?php<br />$search </span><span class="keyword">= array(</span><span class="string">' '</span><span class="keyword">, </span><span class="string">'&amp;'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'&amp;nbsp;'</span><span class="keyword">, </span><span class="string">'&amp;amp;'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'Hello &amp; goodbye!'</span><span class="keyword">;<br /><br /></span><span class="comment">// We want to replace the spaces with &amp;nbsp; and the ampersand with &amp;amp;<br /></span><span class="keyword">echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: "Hello&amp;amp;nbsp&amp;amp;&amp;amp;nbspgoodbye!" - wrong!<br /><br /></span><span class="keyword">echo </span><span class="default">stro_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: "Hello&amp;nbsp;&amp;amp;&amp;nbsp;goodbye!" - correct!<br /><br />/*<br />    Note:  Run the above code in the CLI or view source on your web browser - the replacement strings for stro_replace are HTML entities which the browser interprets.<br />*/<br /></span><span class="default">?&gt;<br /></span><br /><span class="default">&lt;?php<br />$search </span><span class="keyword">= array(</span><span class="string">'ERICA'</span><span class="keyword">, </span><span class="string">'AMERICA'</span><span class="keyword">);<br /></span><span class="default">$replace </span><span class="keyword">= array(</span><span class="string">'JON'</span><span class="keyword">, </span><span class="string">'PHP'</span><span class="keyword">);<br /></span><span class="default">$subject </span><span class="keyword">= </span><span class="string">'MIKE AND ERICA LIKE AMERICA'</span><span class="keyword">;<br /><br /></span><span class="comment">// We want to replace the name "ERICA" with "JON" and the word "AMERICA" with "PHP"<br /></span><span class="keyword">echo </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: "MIKE AND JON LIKE AMJON", which is not correct<br /><br /></span><span class="keyword">echo </span><span class="default">stro_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">); </span><span class="comment">// output: "MIKE AND JON LIKE PHP", which is correct<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="97574">  <div class="votes">
    ...
    <div class="tally" id="V97574" title="60% like this...">
    13
    </div>
  </div>
  <a href="#97574" class="name">
  <strong class="user"><em>jbarnett at jmbelite dot com</em></strong></a><a class="genanchor" href="#97574"> &para;</a><div class="date" title="2010-04-26 01:23"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97574">
<div class="phpcode"><code><span class="html">Might be worth mentioning that a SIMPLE way to accomplish Example 2 (potential gotchas) is to simply start your "replacements" in reverse.
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />So basically start from the "end" and put the replacements in an order where the "replaced value" won't equal a value that exists later in the "search array".</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As an effort to remove those Word copy and paste smart quotes, I've found that this works with UTF8 encoded strings (where $text in the following example is UTF8). Also the elipsis and em and en dashes are replaced.<br /><br />There is an "invisible" character after the â€ for the right side double smart quote that doesn't seem to display here. It is chr(157).<br /><br /><span class="default">&lt;?php<br />  $find</span><span class="keyword">[] = </span><span class="string">'â€œ'</span><span class="keyword">;  </span><span class="comment">// left side double smart quote<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€'</span><span class="keyword">;  </span><span class="comment">// right side double smart quote<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€˜'</span><span class="keyword">;  </span><span class="comment">// left side single smart quote<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€™'</span><span class="keyword">;  </span><span class="comment">// right side single smart quote<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€¦'</span><span class="keyword">;  </span><span class="comment">// elipsis<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€”'</span><span class="keyword">;  </span><span class="comment">// em dash<br />  </span><span class="default">$find</span><span class="keyword">[] = </span><span class="string">'â€“'</span><span class="keyword">;  </span><span class="comment">// en dash<br /><br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">'"'</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">'"'</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">"'"</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">"'"</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">"..."</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">"-"</span><span class="keyword">;<br />  </span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">"-"</span><span class="keyword">;<br /><br />  </span><span class="default">$text </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$find</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="97526">  <div class="votes">
    ...
    <div class="tally" id="V97526" title="58% like this...">
    8
    </div>
  </div>
  <a href="#97526" class="name">
  <strong class="user"><em>pjcdawkins at googlemail dot com</em></strong></a><a class="genanchor" href="#97526"> &para;</a><div class="date" title="2010-04-23 05:23"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97526">
<div class="phpcode"><code><span class="html">Here's a deep replace function allowing multi-dimensional arrays in $search, $replace and $subject. The keys and other structure of $subject are preserved.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Auxiliary function:<br /></span><span class="keyword">function </span><span class="default">_replaceWithAnything</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">,</span><span class="default">$subject</span><span class="keyword">){<br />  if(!</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">) || !</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$replace</span><span class="keyword">)){<br />    </span><span class="default">$search</span><span class="keyword">=array(</span><span class="default">$search</span><span class="keyword">);<br />    </span><span class="default">$replace</span><span class="keyword">=array(</span><span class="default">$replace</span><span class="keyword">);<br />  }<br />  </span><span class="default">$match</span><span class="keyword">=</span><span class="default">array_search</span><span class="keyword">(</span><span class="default">$subject</span><span class="keyword">,</span><span class="default">$search</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">);<br />  if(</span><span class="default">$match</span><span class="keyword">!==</span><span class="default">false </span><span class="keyword">&amp;&amp; </span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$match</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">))<br />    </span><span class="default">$subject</span><span class="keyword">=</span><span class="default">$replace</span><span class="keyword">[</span><span class="default">$match</span><span class="keyword">];<br />  return </span><span class="default">$subject</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// Main function:<br /></span><span class="keyword">function </span><span class="default">deepReplace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">,</span><span class="default">$subject</span><span class="keyword">){<br />  if(!</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$subject</span><span class="keyword">))<br />    return </span><span class="default">_replaceWithAnything</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">,</span><span class="default">$subject</span><span class="keyword">);<br />  foreach(</span><span class="default">$subject </span><span class="keyword">as &amp;</span><span class="default">$val</span><span class="keyword">){<br />    if(</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$val</span><span class="keyword">)){<br />      </span><span class="default">$val</span><span class="keyword">=</span><span class="default">deepReplace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">,</span><span class="default">$val</span><span class="keyword">);<br />      continue;<br />    }<br />    </span><span class="default">$val</span><span class="keyword">=</span><span class="default">_replaceWithAnything</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">,</span><span class="default">$replace</span><span class="keyword">,</span><span class="default">$val</span><span class="keyword">);<br />  }<br />  return </span><span class="default">$subject</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">this is a simple function to replace all newlines to &lt;br&gt; tags.<br /><br />\r\n - windows line break<br />\n - linux line break<br />\r - mac line break<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">nl_to_br</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">) {<br />return </span><span class="default">str_replace</span><span class="keyword">(array(</span><span class="string">"\r\n"</span><span class="keyword">,</span><span class="string">"\n"</span><span class="keyword">,</span><span class="string">"\r"</span><span class="keyword">), </span><span class="string">"&lt;br/&gt;"</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">);<br />}<br />echo </span><span class="default">nl_to_br</span><span class="keyword">(</span><span class="string">'Hello world\n I am Oyedele Hammed Horlah'</span><span class="keyword">); </span><span class="comment">// =&gt; Hello World &lt;br&gt; I am Oyedele Hammed Horlah<br /></span><span class="default">?&gt;<br /></span><br />Enjoy</span></code></div>
  ...
  <div class="note" id="108196">  <div class="votes">
    ...
    <div class="tally" id="V108196" title="56% like this...">
    6
    </div>
  </div>
  <a href="#108196" class="name">
  <strong class="user"><em>Denzel Morris</em></strong></a><a class="genanchor" href="#108196"> &para;</a><div class="date" title="2012-04-06 02:43"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108196">
<div class="phpcode"><code><span class="html">Maybe obvious to veteran PHP programmers but less so to novice PHP programmers is the fact that this is invalid:<br /><span class="default">&lt;?php<br />str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>At a glance it appears to be a reasonable request, until you realize that the fourth parameter must be a variable in order to be passed as a reference. A replacement:<br /><span class="default">&lt;?php<br />str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">$temp </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">);<br /></span><span class="comment">// or<br /></span><span class="default">$temp </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br /></span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$search</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">$temp</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">$myString = “It was the best of mine it was the worst of mine,”;<br />// Displays “It was the best of bananas, it was the worst of bananas,”<br />echo str_replace( “mine”, “bananas”, $myString );<br />If you want to know how many times the search string was replaced, pass in a variable as an optional<br />fourth argument. After the function runs, this variable holds the number of replacements:<br />$myString = “It was the best of mine, it was the worst of mine,”;<br />// Displays “It was the best of bananas, it was the worst of bananas,”<br />echo str_replace( “mine”, “bananas”, $myString, $num ) . “ &lt; br/ &gt; ”;<br />// Displays “The text was replaced 2 times.”<br />echo “The text was replaced $num times. &lt; br/ &gt; ”;</span></code></div>
  ...
  <strong class="user"><em>Ing. Mirko Plazotta</em></strong></a><a class="genanchor" href="#115660"> &para;</a><div class="date" title="2014-09-04 09:27"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115660">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">// a very beatiful way to do multiple replacements is this one, using just one array<br /></span><span class="default">$replaceThis </span><span class="keyword">= Array(<br /></span><span class="string">'old word' </span><span class="keyword">=&gt; </span><span class="string">'new word'</span><span class="keyword">,<br /></span><span class="string">'was' </span><span class="keyword">=&gt; </span><span class="string">'it'</span><span class="keyword">,<br /></span><span class="string">'past' </span><span class="keyword">=&gt; </span><span class="string">'future'</span><span class="keyword">,<br />);<br /><br /></span><span class="default">$originalText </span><span class="keyword">= </span><span class="string">"every old word was a thing of the past..."</span><span class="keyword">;<br /></span><span class="default">$replacedText </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$replaceThis</span><span class="keyword">), </span><span class="default">$replaceThis</span><span class="keyword">, </span><span class="default">$originalText</span><span class="keyword">);<br />echo </span><span class="default">$replacedText</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Insert space after comma.<br /><br />If you have a form that stores results in a database field as comma separated values, when you display this data you can use the following to insert a space after each comma:<br /><br /><span class="default">&lt;?php<br />$find</span><span class="keyword">[] = </span><span class="string">','</span><span class="keyword">;<br /></span><span class="default">$replace</span><span class="keyword">[] = </span><span class="string">'&amp;#44;&amp;nbsp;'</span><span class="keyword">;<br /></span><span class="default">$text </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$find</span><span class="keyword">, </span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$row_rsRecordset</span><span class="keyword">[</span><span class="string">'Field'</span><span class="keyword">]);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$text</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Notes:<br />1) To get round the Replacement Order Gotcha, the comma is also replaced with its code equivalent: &amp;#44;<br />2) You can adapt the $replace section to suit your needs: swap out the &amp;nbsp; code with &lt;br/&gt; or replace comma and space with &amp;nbsp;&amp;middot;&amp;nbsp; etc.</span></code></div>
  ...
  <div class="note" id="109487">  <div class="votes">
    ...
    <div class="tally" id="V109487" title="52% like this...">
    3
    </div>
  </div>
  <a href="#109487" class="name">
  <strong class="user"><em>kriscraig at php dot net</em></strong></a><a class="genanchor" href="#109487"> &para;</a><div class="date" title="2012-07-20 11:03"><strong>13 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Replace chars in multi-byte string.<br />In example, replacing 'f'=&gt;'b', 'o'=&gt;'e', 't'=&gt;'r' and etc.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">mb_chars_replace</span><span class="keyword">(</span><span class="default">$from</span><span class="keyword">, </span><span class="default">$to</span><span class="keyword">, </span><span class="default">$subj</span><span class="keyword">, </span><span class="default">$delSymb</span><span class="keyword">=</span><span class="string">'_'</span><span class="keyword">) {<br />     </span><span class="default">$nsubj</span><span class="keyword">=</span><span class="string">''</span><span class="keyword">;<br />     </span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'/(.)/u'</span><span class="keyword">, </span><span class="default">$subj</span><span class="keyword">, </span><span class="default">$subj</span><span class="keyword">);</span><span class="default">$subj</span><span class="keyword">=</span><span class="default">$subj</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];<br />     if (!</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$from</span><span class="keyword">)) {</span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'/(.)/u'</span><span class="keyword">, </span><span class="default">$from</span><span class="keyword">, </span><span class="default">$from</span><span class="keyword">);</span><span class="default">$from</span><span class="keyword">=</span><span class="default">$from</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];} <br />     if (!</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$to</span><span class="keyword">)) {</span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'/(.)/u'</span><span class="keyword">, </span><span class="default">$to</span><span class="keyword">, </span><span class="default">$to</span><span class="keyword">);</span><span class="default">$to</span><span class="keyword">=</span><span class="default">$to</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];}<br />     if (</span><span class="default">count</span><span class="keyword">(</span><span class="default">$from</span><span class="keyword">)!==</span><span class="default">count</span><span class="keyword">(</span><span class="default">$to</span><span class="keyword">)) return </span><span class="default">false</span><span class="keyword">;<br /><br />     foreach(</span><span class="default">$subj </span><span class="keyword">as </span><span class="default">$s</span><span class="keyword">) {<br />       foreach(</span><span class="default">$from </span><span class="keyword">as </span><span class="default">$k</span><span class="keyword">=&gt;</span><span class="default">$f</span><span class="keyword">) {<br />         if(</span><span class="default">$s</span><span class="keyword">===</span><span class="default">$f</span><span class="keyword">) {<br />                    </span><span class="default">$s</span><span class="keyword">=</span><span class="default">$to</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">];<br />                    break;<br />         }<br />       }<br />       if(</span><span class="default">$s</span><span class="keyword">!==</span><span class="default">$delSymb</span><span class="keyword">) </span><span class="default">$nsubj</span><span class="keyword">.=</span><span class="default">$s</span><span class="keyword">;<br />     }<br />    return </span><span class="default">$nsubj</span><span class="keyword">;<br />} <br /><br /></span><span class="comment">//examples:<br /><br /></span><span class="default">$from</span><span class="keyword">=</span><span class="string">"fotber, "</span><span class="keyword">;<br /></span><span class="default">$to</span><span class="keyword">=</span><span class="string">"berfot+_"</span><span class="keyword">;<br /><br /></span><span class="comment">// or<br /><br /></span><span class="default">$from</span><span class="keyword">=array(</span><span class="string">"f"</span><span class="keyword">,</span><span class="string">"o"</span><span class="keyword">,</span><span class="string">"t"</span><span class="keyword">,</span><span class="string">"b"</span><span class="keyword">,</span><span class="string">"e"</span><span class="keyword">,</span><span class="string">"r"</span><span class="keyword">,</span><span class="string">","</span><span class="keyword">,</span><span class="string">" "</span><span class="keyword">);<br /></span><span class="default">$to</span><span class="keyword">=array(</span><span class="string">"b"</span><span class="keyword">,</span><span class="string">"e"</span><span class="keyword">,</span><span class="string">"r"</span><span class="keyword">,</span><span class="string">"f"</span><span class="keyword">,</span><span class="string">"o"</span><span class="keyword">,</span><span class="string">"t"</span><span class="keyword">,</span><span class="string">"+"</span><span class="keyword">,</span><span class="string">"_"</span><span class="keyword">);<br /><br /></span><span class="comment">//out:<br /></span><span class="keyword">echo </span><span class="default">mb_chars_replace</span><span class="keyword">(</span><span class="default">$from</span><span class="keyword">,</span><span class="default">$to</span><span class="keyword">,</span><span class="string">"foot, beer"</span><span class="keyword">); </span><span class="comment">//beer+foot<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="108134">  <div class="votes">
    ...
    <div class="tally" id="V108134" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#108134" class="name">
  <strong class="user"><em>cc at cc dot com</em></strong></a><a class="genanchor" href="#108134"> &para;</a><div class="date" title="2012-03-31 05:26"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108134">
<div class="phpcode"><code><span class="html">I found a pretty low tech solution to avoid the "gotcha" without worrying about the array order of how things are replaced. I could not "order" the replacement array easily because it was being read from a database table.<br /><br />Anyway if you add an identifiable token to each replaced word, then just filter this out at the very end, no nested search terms are found. I just dynamically add the %% after the first char of each word before pumping it into the str_ireplace function.<br /><br />$find = array("as1", "as2", "as3", "flex");<br />$replace = array("&lt;a href = \"#as1\"&gt;A%%uto S%%entry R%%ev. A%%&lt;/a&gt;", "&lt;a href = \"#as2\"&gt;A%%uto S%%entry E%%xp&lt;/a&gt;", "&lt;a href = \"#as3\"&gt;A%%uto S%%entry f%%lex&lt;/a&gt;", "&lt;a style = \"color: red;\" href = \"#flex\"&gt;f%%lex&lt;/a&gt;");<br />$text = str_ireplace($find, $replace, $text);<br />echo str_ireplace("%%", "", $text);<br /><br />In this case I am using %% as my token as this is an unlikely char combo for me.</span></code></div>
  </div>
 </div>
  <div class="note" id="108430">  <div class="votes">
    ...
    <div class="tally" id="V108430" title="47% like this...">
    -2
    </div>
  </div>
  <a href="#108430" class="name">
  <strong class="user"><em>christof dot rieger at r-tron dot de</em></strong></a><a class="genanchor" href="#108430"> &para;</a><div class="date" title="2012-04-25 08:41"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108430">
<div class="phpcode"><code><span class="html">In many countries the numeric format is 1.000,33 in english it is 1,000.33<br /><br />This function converts numeric arguments always into the PHP confirm numeric format. If only one seperator is into the numericstring so it is interpreted as the decimalpoint.<br /><br /> function dp($zahl)<br />{<br />  if ((strpos($zahl,".") &gt; "-1") | (strpos($zahl,",") &gt; "-1")) {<br />    if ((strpos($zahl,".") &gt; "-1") &amp; (strpos($zahl,",") &gt; "-1")) {<br />      if (strpos($zahl,".") &gt; strpos($zahl,",")){<br />          return str_replace(",","",$zahl);<br />    } else {<br />          return str_replace(",",".",str_replace(".","",$zahl));<br />      }<br />  } else {<br />      if (strpos($zahl,".") &gt; "-1") {<br />        if (strpos($zahl,".") == strrpos($zahl,".")) {<br />            return $zahl;<br />      } else {<br />          return str_replace(".","",$zahl);          <br />        } <br />    } else {<br />        if (strpos($zahl,",") == strrpos($zahl,",")) {<br />          return str_replace(",",".",$zahl);<br />      } else {<br />          return str_replace(",","",$zahl);          <br />        } <br />    } }<br />} else {<br />    return $zahl;<br />} }</span></code></div>
  </div>
 </div>
  <div class="note" id="116797">  <div class="votes">
    ...
    <div class="tally" id="V116797" title="46% like this...">
    -2
    </div>
  </div>
  <a href="#116797" class="name">
  <strong class="user"><em>borasahin at gmail dot com</em></strong></a><a class="genanchor" href="#116797"> &para;</a><div class="date" title="2015-03-02 08:59"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116797">
<div class="phpcode"><code><span class="html">jSON Turkish Characters Problem - (PHP &lt; 5.4 for example)<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">json_decode_tr</span><span class="keyword">(</span><span class="default">$json</span><span class="keyword">){<br />       </span><span class="default">$json_char </span><span class="keyword">= array(</span><span class="string">"u00e7"</span><span class="keyword">,</span><span class="string">"u0131"</span><span class="keyword">,</span><span class="string">"u00fc"</span><span class="keyword">,</span><span class="string">"u011f"</span><span class="keyword">,</span><span class="string">"u00f6"</span><span class="keyword">,</span><span class="string">"u015f"</span><span class="keyword">,</span><span class="string">"u0130"</span><span class="keyword">,</span><span class="string">"u011e"</span><span class="keyword">,</span><span class="string">"u00dc"</span><span class="keyword">,</span><span class="string">"u00d6"</span><span class="keyword">,</span><span class="string">"u015e"</span><span class="keyword">,</span><span class="string">"u00c7"</span><span class="keyword">);<br />       </span><span class="default">$turkish </span><span class="keyword">= array(</span><span class="string">"ç"</span><span class="keyword">,</span><span class="string">"ı"</span><span class="keyword">,</span><span class="string">"ü"</span><span class="keyword">,</span><span class="string">"ğ"</span><span class="keyword">,</span><span class="string">"ö"</span><span class="keyword">,</span><span class="string">"ş"</span><span class="keyword">,</span><span class="string">"İ"</span><span class="keyword">,</span><span class="string">"Ğ"</span><span class="keyword">,</span><span class="string">"Ü"</span><span class="keyword">,</span><span class="string">"Ö"</span><span class="keyword">,</span><span class="string">"Ş"</span><span class="keyword">,</span><span class="string">"Ç"</span><span class="keyword">);<br />       </span><span class="default">$result </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="default">$json_char</span><span class="keyword">, </span><span class="default">$turkish</span><span class="keyword">, </span><span class="default">$json</span><span class="keyword">);<br />       return </span><span class="default">json_decode</span><span class="keyword">(</span><span class="default">$json</span><span class="keyword">);<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Escaping strings with control characters, quotes and backslashes for subsequent use in MySQL commands.<br /><br />MySQL has documented a number of backslash escape sequences that need to be used to pass certain values in SQL commands: <a href="https://dev.mysql.com/doc/refman/5.7/en/string-literals.html" rel="nofollow" target="_blank">https://dev.mysql.com/doc/refman/5.7/en/string-literals.html</a><br /><br />It's crucial to escape existing backslashes first to prevent double-escaping, before escaping the various control sequences:<br /><br /><span class="default">&lt;?php<br />$result </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(<br />                array( </span><span class="string">'\\'</span><span class="keyword">,    </span><span class="string">"\0"</span><span class="keyword">,   </span><span class="string">"'"</span><span class="keyword">,    </span><span class="string">"\x8" </span><span class="comment">/* BS */</span><span class="keyword">, </span><span class="string">"\n"</span><span class="keyword">,   </span><span class="string">"\r"</span><span class="keyword">,   </span><span class="string">"\t"</span><span class="keyword">,   </span><span class="string">"\x1A" </span><span class="comment">/* Ctrl+Z */ </span><span class="keyword">),<br />                array( </span><span class="string">'\\\\'</span><span class="keyword">,  </span><span class="string">'\\0'</span><span class="keyword">,  </span><span class="string">'\\\''</span><span class="keyword">, </span><span class="string">'\\b'</span><span class="keyword">,          </span><span class="string">'\\n'</span><span class="keyword">,  </span><span class="string">'\\r'</span><span class="keyword">,  </span><span class="string">'\\t'</span><span class="keyword">,  </span><span class="string">'\\Z' </span><span class="keyword">),<br />                </span><span class="default">$value </span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This code is NOT intended to protect against SQL insertions, it's intended to PRESERVE string content correctly, if it contains control characters.</span></code></div>
  ...
  <div class="note" id="125165">  <div class="votes">
    ...
    <div class="tally" id="V125165" title="43% like this...">
    -2
    </div>
  </div>
  <a href="#125165" class="name">
  <strong class="user"><em>hyperzlib at outlook dot com</em></strong></a><a class="genanchor" href="#125165"> &para;</a><div class="date" title="2020-07-04 12:33"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125165">
<div class="phpcode"><code><span class="html">Use str_replace to remove all dashes but one from the string '-aaa----b-c-----d--e---f' (resulting is: '-aaa-b-c-d-e-f')<br /><br /><span class="default">&lt;?php<br />$challenge </span><span class="keyword">= </span><span class="string">'-aaa----b-c-----d--e---f'</span><span class="keyword">;<br />do </span><span class="default">$challenge </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'--'</span><span class="keyword">, </span><span class="string">'-'</span><span class="keyword">, </span><span class="default">$challenge</span><span class="keyword">, </span><span class="default">$count</span><span class="keyword">); while(</span><span class="default">$count</span><span class="keyword">);<br />echo </span><span class="default">$challenge</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="121612">  <div class="votes">
    ...
    <div class="tally" id="V121612" title="40% like this...">
    -4
    </div>
  </div>
  <a href="#121612" class="name">
  <strong class="user"><em>vuabid at hotmail dot com</em></strong></a><a class="genanchor" href="#121612"> &para;</a><div class="date" title="2017-09-06 08:44"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121612">
<div class="phpcode"><code><span class="html">Consider this while using str_replace function when $search and $replace are arrays.<br /><br />$search = array( 'login_reactivate', 'login_reactivate_date' );<br />$replace = array( 'login reactivate status', 'login reactivate date' );<br />$subject = "fname, email, login_reactivate, login_reactivate_date";<br /><br />$returnValue = str_replace( $search, $replace, $subject );<br /><br />$returnValue will be:<br />fname, email, login reactivate status, login reactivate status_date<br /><br />You can see we are expecting "login_reactivate_date" to be replaced with "login reactivate date" but it will replace to "login reactivate status_date"</span></code></div>
  </div>
 </div>
  <div class="note" id="97904">  <div class="votes">
    ...
    <div class="tally" id="V97904" title="40% like this...">
    -4
    </div>
  </div>
  <a href="#97904" class="name">
  <strong class="user"><em>christian dot reinecke at web dot de</em></strong></a><a class="genanchor" href="#97904"> &para;</a><div class="date" title="2010-05-14 12:06"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97904">
<div class="phpcode"><code><span class="html">If you need to replace a string in another, but only once but still in all possible combinations (f.e. to replace "a" with "x" in "aba" to get array("xba", "abx")) you can use this function:<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">getSingleReplaceCombinations</span><span class="keyword">(</span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$with</span><span class="keyword">, </span><span class="default">$inHaystack</span><span class="keyword">)<br />{<br />    </span><span class="default">$splits </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="default">$replace</span><span class="keyword">, </span><span class="default">$inHaystack</span><span class="keyword">);<br />    </span><span class="default">$result </span><span class="keyword">= array();<br />    for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">, </span><span class="default">$ix </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$splits</span><span class="keyword">); </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$ix</span><span class="keyword">; ++</span><span class="default">$i</span><span class="keyword">) {<br />        </span><span class="default">$previous </span><span class="keyword">= </span><span class="default">array_slice</span><span class="keyword">(</span><span class="default">$splits</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />        </span><span class="default">$next     </span><span class="keyword">= </span><span class="default">array_slice</span><span class="keyword">(</span><span class="default">$splits</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />        <br />        </span><span class="default">$combine  </span><span class="keyword">= </span><span class="default">array_pop</span><span class="keyword">(</span><span class="default">$previous</span><span class="keyword">) . </span><span class="default">$with </span><span class="keyword">. </span><span class="default">array_shift</span><span class="keyword">(</span><span class="default">$next</span><span class="keyword">);<br />        </span><span class="default">$result</span><span class="keyword">[] = </span><span class="default">implode</span><span class="keyword">(</span><span class="default">$replace</span><span class="keyword">, </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">$previous</span><span class="keyword">, array(</span><span class="default">$combine</span><span class="keyword">), </span><span class="default">$next</span><span class="keyword">));<br />    }<br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">getSingleReplaceCombinations</span><span class="keyword">(</span><span class="string">"a"</span><span class="keyword">, </span><span class="string">"x"</span><span class="keyword">, </span><span class="string">"aba"</span><span class="keyword">)); </span><span class="comment">// result as mentioned above<br /></span><span class="default">?&gt;<br /></span>It may not be the best in performance, but it works.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.str-replace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.str-replace.php">＋<small>add a note</small></a></div>
