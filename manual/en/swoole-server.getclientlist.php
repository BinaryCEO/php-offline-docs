...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/swoole-server.getclientlist.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/swoole-server.getclientlist.php">
 <link rel="alternate" href="https://www.php.net/manual/en/swoole-server.getclientlist.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.swoole-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-server.getclientinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-server.getlasterror.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/swoole-server.getclientlist.php' selected="selected">English</option>
            ...
            <option value='pt_BR/swoole-server.getclientlist.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL swoole &gt;= 1.9.0)</p><p class="refpurpose"><span class="refname">Swoole\Server::getClientList</span> &mdash; <span class="dc-title">Get all of the established connections.</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-swoole-server.getclientlist-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole/server/getclientlist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fswoole-server.getclientlist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=swoole-server.getclientlist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/swoole-server.getclientlist.php">＋<small>add a note</small></a></span>
