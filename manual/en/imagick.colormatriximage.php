...
<head>
  ...
  <title>PHP: Imagick::colorMatrixImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.colormatriximage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.colormatriximage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colormatriximage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.colorizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.combineimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.colormatriximage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.colormatriximage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.colormatriximage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.colormatriximage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.colormatriximage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.colormatriximage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.colormatriximage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.colormatriximage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.colormatriximage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.colormatriximage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.colormatriximage.php" hreflang="zh">
...
<meta name="Description" content="Apply color transformation to an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::colorMatrixImage - Manual" />
<meta name="twitter:description" content="Apply color transformation to an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::colorMatrixImage - Manual" />
<meta itemprop="description" content="Apply color transformation to an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Apply color transformation to an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.combineimages.php">
          Imagick::combineImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.colorizeimage.php">
          &laquo; Imagick::colorizeImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.colormatriximage.php' selected="selected">English</option>
            <option value='de/imagick.colormatriximage.php'>German</option>
            <option value='es/imagick.colormatriximage.php'>Spanish</option>
            <option value='fr/imagick.colormatriximage.php'>French</option>
            <option value='it/imagick.colormatriximage.php'>Italian</option>
            <option value='ja/imagick.colormatriximage.php'>Japanese</option>
            <option value='pt_BR/imagick.colormatriximage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.colormatriximage.php'>Russian</option>
            <option value='tr/imagick.colormatriximage.php'>Turkish</option>
            <option value='uk/imagick.colormatriximage.php'>Ukrainian</option>
            <option value='zh/imagick.colormatriximage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.colormatriximage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::colorMatrixImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::colorMatrixImage</span> &mdash; <span class="dc-title">Apply color transformation to an image</span></p>
  ...
  <p class="para">
    <div class="example" id="example-2981">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/colormatriximage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.colormatriximage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.colormatriximage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.colormatriximage.php">＋<small>add a note</small></a></span>
