...
<head>
  ...
  <title>PHP: Memcached::addByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.addbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.addbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.addbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.add.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.addserver.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.addbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.addbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.addbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.addbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.addbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.addbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.addbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.addbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.addbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.addbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.addbykey.php" hreflang="zh">
...
<meta name="Description" content="Add an item under a new key on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::addByKey - Manual" />
<meta name="twitter:description" content="Add an item under a new key on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::addByKey - Manual" />
<meta itemprop="description" content="Add an item under a new key on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add an item under a new key on a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.addserver.php">
          Memcached::addServer &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.add.php">
          &laquo; Memcached::add        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.addbykey.php' selected="selected">English</option>
            <option value='de/memcached.addbykey.php'>German</option>
            <option value='es/memcached.addbykey.php'>Spanish</option>
            <option value='fr/memcached.addbykey.php'>French</option>
            <option value='it/memcached.addbykey.php'>Italian</option>
            <option value='ja/memcached.addbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.addbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.addbykey.php'>Russian</option>
            <option value='tr/memcached.addbykey.php'>Turkish</option>
            <option value='uk/memcached.addbykey.php'>Ukrainian</option>
            <option value='zh/memcached.addbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.addbykey" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.replace.php" class="methodname" rel="rdfs-seeAlso">Memcached::replace()</a> - Replace the item under an existing key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/addbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.addbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.addbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.addbykey.php">＋<small>add a note</small></a></span>
