...
<head>
  ...
  <title>PHP: SolrQuery::addFilterQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addfilterquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addfilterquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfilterquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addgroupfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfilterquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addfilterquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addfilterquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addfilterquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addfilterquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addfilterquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addfilterquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addfilterquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addfilterquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addfilterquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addfilterquery.php" hreflang="zh">
...
<meta name="Description" content="Specifies a filter query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addFilterQuery - Manual" />
<meta name="twitter:description" content="Specifies a filter query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addFilterQuery - Manual" />
<meta itemprop="description" content="Specifies a filter query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies a filter query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addgroupfield.php">
          SolrQuery::addGroupField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addfield.php">
          &laquo; SolrQuery::addField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addfilterquery.php' selected="selected">English</option>
            <option value='de/solrquery.addfilterquery.php'>German</option>
            <option value='es/solrquery.addfilterquery.php'>Spanish</option>
            <option value='fr/solrquery.addfilterquery.php'>French</option>
            <option value='it/solrquery.addfilterquery.php'>Italian</option>
            <option value='ja/solrquery.addfilterquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.addfilterquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addfilterquery.php'>Russian</option>
            <option value='tr/solrquery.addfilterquery.php'>Turkish</option>
            <option value='uk/solrquery.addfilterquery.php'>Ukrainian</option>
            <option value='zh/solrquery.addfilterquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addfilterquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addFilterQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addFilterQuery</span> &mdash; <span class="dc-title">Specifies a filter query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addfilterquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addFilterQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fq</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addfilterquery-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addfilterquery-returnvalues">
...
<div class="examplescode"><pre class="examplescode">&amp;fq=color:blue,green</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addfilterquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addfilterquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addfilterquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addfilterquery.php">＋<small>add a note</small></a></span>
