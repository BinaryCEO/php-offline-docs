...
<head>
  ...
  <title>PHP: Imagick::trimImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.trimimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.trimimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.trimimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.transverseimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.uniqueimagecolors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.trimimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.trimimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.trimimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.trimimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.trimimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.trimimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.trimimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.trimimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.trimimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.trimimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.trimimage.php" hreflang="zh">
...
<meta name="Description" content="Remove edges from the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::trimImage - Manual" />
<meta name="twitter:description" content="Remove edges from the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::trimImage - Manual" />
<meta itemprop="description" content="Remove edges from the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove edges from the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.uniqueimagecolors.php">
          Imagick::uniqueImageColors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.transverseimage.php">
          &laquo; Imagick::transverseImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.trimimage.php' selected="selected">English</option>
            <option value='de/imagick.trimimage.php'>German</option>
            <option value='es/imagick.trimimage.php'>Spanish</option>
            <option value='fr/imagick.trimimage.php'>French</option>
            <option value='it/imagick.trimimage.php'>Italian</option>
            <option value='ja/imagick.trimimage.php'>Japanese</option>
            <option value='pt_BR/imagick.trimimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.trimimage.php'>Russian</option>
            <option value='tr/imagick.trimimage.php'>Turkish</option>
            <option value='uk/imagick.trimimage.php'>Ukrainian</option>
            <option value='zh/imagick.trimimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.trimimage" class="refentry">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.trimimage-errors">
  ...
  <p class="para">
   <div class="example" id="example-3139">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imagecropauto.php" class="function" rel="rdfs-seeAlso">imagecropauto()</a> - Crop an image automatically using one of the available modes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/trimimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.trimimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.trimimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.trimimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="90458">  <div class="votes">
    <div id="Vu90458">
    <a href="/manual/vote-note.php?id=90458&amp;page=imagick.trimimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90458">
    <a href="/manual/vote-note.php?id=90458&amp;page=imagick.trimimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90458" title="94% like this...">
    16
    </div>
  </div>
  <a href="#90458" class="name">
  <strong class="user"><em>dhp</em></strong></a><a class="genanchor" href="#90458"> &para;</a><div class="date" title="2009-04-23 04:31"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90458">
<div class="phpcode"><code><span class="html">After operations that change the crop of the image, like trimImage does, IM preserves the old canvas and positioning info. If you need to do additional operations on the image based on the new size, you'll need to reset this info with setImagePage. This is the equivalent of the +repage command line argument.
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="111332">  <div class="votes">
    <div id="Vu111332">
    <a href="/manual/vote-note.php?id=111332&amp;page=imagick.trimimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111332">
    <a href="/manual/vote-note.php?id=111332&amp;page=imagick.trimimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111332" title="100% like this...">
    8
    </div>
  </div>
  <a href="#111332" class="name">
  <strong class="user"><em>Kirsty Forrester</em></strong></a><a class="genanchor" href="#111332"> &para;</a><div class="date" title="2013-02-08 11:17"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111332">
<div class="phpcode"><code><span class="html">The command for trim can return info which tells you the coordinates of where the image was cropped and the new dimensions of the trimmed image. I couldn't find an example for how to do that with this class, so here's how I did it:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Create and trim image<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'image.png'</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">trimImage</span><span class="keyword">(</span><span class="default">0.3</span><span class="keyword">);<br /><br /></span><span class="comment">/**<br />* Imagick:: getImagePage() gives us an array with the width, height, x and y coordinates of the trimmed image<br />* However, the width and height are of the original image<br />*/<br /></span><span class="default">$imagePage </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImagePage</span><span class="keyword">();<br />list(</span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">) = array(</span><span class="default">$imagePage</span><span class="keyword">[</span><span class="string">'x'</span><span class="keyword">], </span><span class="default">$imagePage</span><span class="keyword">[</span><span class="string">'y'</span><span class="keyword">]);<br /><br /></span><span class="comment">// So we need to reset the image page to get the right height and width of the trimmed image<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImagePage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />list(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">) = array(</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">width</span><span class="keyword">, </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">height</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />This will leave you with two variables for the width and height of the trimmed image, plus two variables for the x-coordinate and y-coordinate of the trimmed area relative to the original image.<br /><br />This information is useful when the image you're trimming is the difference between two images (e.g. from Imagick::compareImages(), and you want to crop the original image to the same size and position as the difference.</span></code></div>
  </div>
 </div>
  <div class="note" id="126438">  <div class="votes">
    <div id="Vu126438">
    <a href="/manual/vote-note.php?id=126438&amp;page=imagick.trimimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126438">
    <a href="/manual/vote-note.php?id=126438&amp;page=imagick.trimimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126438" title="100% like this...">
    2
    </div>
  </div>
  <a href="#126438" class="name">
  <strong class="user"><em>tamucola</em></strong></a><a class="genanchor" href="#126438"> &para;</a><div class="date" title="2021-09-20 04:31"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126438">
<div class="phpcode"><code><span class="html">fuzz needs getQuantum<br />/**<br /> * @param string $imagePath<br /> * @param float  $fuzz 0.1=10%<br /> * @return bool<br /> * @throws ImagickException<br /> */<br />public static function trimImage($imagePath, $fuzz = 0.1)<br />{<br />    if (empty($imagePath)) {<br />        return false;<br />    }<br />    $imagePath = realpath($imagePath);<br />    if (!is_file($imagePath)) {<br />        return false;<br />    }<br />    if (!class_exists('Imagick')) {<br />        return false;<br />    }<br />    $im = new Imagick($imagePath);<br />    $result = $im-&gt;trimImage($fuzz * $im::getQuantum());<br />    if (!$result) {<br />        return false;<br />    }<br /><br />    return $im-&gt;writeImage($imagePath);<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="79638">  <div class="votes">
    <div id="Vu79638">
    <a href="/manual/vote-note.php?id=79638&amp;page=imagick.trimimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79638">
    <a href="/manual/vote-note.php?id=79638&amp;page=imagick.trimimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79638" title="no votes...">
    0
    </div>
  </div>
  <a href="#79638" class="name">
  <strong class="user"><em>Mark van der Velden</em></strong></a><a class="genanchor" href="#79638"> &para;</a><div class="date" title="2007-12-06 01:35"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79638">
<div class="phpcode"><code><span class="html">This method requires ImageMagick version &gt;= 6.2.8</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.trimimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.trimimage.php">＋<small>add a note</small></a></div>
