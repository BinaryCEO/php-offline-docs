...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightMaxAnalyzedChars - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightmergecontiguous.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightmaxanalyzedchars.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightmaxanalyzedchars.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightmaxanalyzedchars.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightmaxanalyzedchars.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightmaxanalyzedchars.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightmaxanalyzedchars.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightmaxanalyzedchars.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightmaxanalyzedchars.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightmaxanalyzedchars.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightmaxanalyzedchars.php" hreflang="zh">
...
<meta name="Description" content="Specifies the number of characters into a document to look for suitable snippets" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightMaxAnalyzedChars - Manual" />
<meta name="twitter:description" content="Specifies the number of characters into a document to look for suitable snippets" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightMaxAnalyzedChars - Manual" />
<meta itemprop="description" content="Specifies the number of characters into a document to look for suitable snippets" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the number of characters into a document to look for suitable snippets" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightmergecontiguous.php">
          SolrQuery::setHighlightMergeContiguous &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightmaxalternatefieldlength.php">
          &laquo; SolrQuery::setHighlightMaxAlternateFieldLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightmaxanalyzedchars.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightmaxanalyzedchars.php'>German</option>
            <option value='es/solrquery.sethighlightmaxanalyzedchars.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightmaxanalyzedchars.php'>French</option>
            <option value='it/solrquery.sethighlightmaxanalyzedchars.php'>Italian</option>
            <option value='ja/solrquery.sethighlightmaxanalyzedchars.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightmaxanalyzedchars.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightmaxanalyzedchars.php'>Russian</option>
            <option value='tr/solrquery.sethighlightmaxanalyzedchars.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightmaxanalyzedchars.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightmaxanalyzedchars.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightmaxanalyzedchars" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightMaxAnalyzedChars</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightMaxAnalyzedChars</span> &mdash; <span class="dc-title">Specifies the number of characters into a document to look for suitable snippets</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightmaxanalyzedchars-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightMaxAnalyzedChars</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightmaxanalyzedchars-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightmaxanalyzedchars-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightmaxanalyzedchars.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightmaxanalyzedchars%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightmaxanalyzedchars&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php">＋<small>add a note</small></a></span>
