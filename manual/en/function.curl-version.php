...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-version.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.curl_upkeep.php">
 <link rel="next" href="https://www.php.net/manual/en/class.curlhandle.php">
...
<meta name="Description" content="Gets cURL version information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_version - Manual" />
<meta name="twitter:description" content="Gets cURL version information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_version - Manual" />
<meta itemprop="description" content="Gets cURL version information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets cURL version information" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-version.php' selected="selected">English</option>
            <option value='de/function.curl-version.php'>German</option>
            <option value='es/function.curl-version.php'>Spanish</option>
            <option value='fr/function.curl-version.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">curl_version</span> &mdash; <span class="dc-title">Gets cURL version information</span></p>
  ...
  <p class="para">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <tr>
       <td>features</td>
       <td>A bitmask of the <strong><code><a href="curl.constants.php#constant.curl-version-altsvc">CURL_VERSION_<span class="replaceable">*</span></a></code></strong> constants</td>
      </tr>
      ...
      <tr>
       ...
       <td>
        ...
        are supported (<strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>) or not (<strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>)
       </td>
      </tr>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       <code class="literal">features_list</code> added.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       The optional <code class="parameter">age</code> parameter has been removed.
      </td>
     </tr>
     ...
     <tr>
      <td>7.4.0</td>
      <td>
       The optional <code class="parameter">age</code> parameter has been deprecated;
  ...
  <p class="para">
   <div class="example" id="example-4506">
    ...
    <div class="example-contents"><p>
     ...
     in cURL build by using the <code class="literal">&#039;features&#039;</code> bitmask returned 
     by <span class="function"><strong>curl_version()</strong></span>.
    </p></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Get curl version array<br /></span><span style="color: #0000BB">$version </span><span style="color: #007700">= </span><span style="color: #0000BB">curl_version</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">// These are the bitfields that can be used <br />// to check for features in the curl build<br /></span><span style="color: #0000BB">$bitfields </span><span style="color: #007700">= Array(<br />            </span><span style="color: #DD0000">'CURL_VERSION_IPV6'</span><span style="color: #007700">, <br />            </span><span style="color: #DD0000">'CURL_VERSION_KERBEROS4'</span><span style="color: #007700">, <br />            </span><span style="color: #DD0000">'CURL_VERSION_SSL'</span><span style="color: #007700">, <br />            </span><span style="color: #DD0000">'CURL_VERSION_LIBZ'<br />            </span><span style="color: #007700">);<br /><br /><br />foreach(</span><span style="color: #0000BB">$bitfields </span><span style="color: #007700">as </span><span style="color: #0000BB">$feature</span><span style="color: #007700">)<br />{<br />    echo </span><span style="color: #0000BB">$feature </span><span style="color: #007700">. (</span><span style="color: #0000BB">$version</span><span style="color: #007700">[</span><span style="color: #DD0000">'features'</span><span style="color: #007700">] &amp; </span><span style="color: #0000BB">constant</span><span style="color: #007700">(</span><span style="color: #0000BB">$feature</span><span style="color: #007700">) ? </span><span style="color: #DD0000">' matches' </span><span style="color: #007700">: </span><span style="color: #DD0000">' does not match'</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-version.php">＋<small>add a note</small></a></span>
