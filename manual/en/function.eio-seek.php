...
<head>
  ...
  <title>PHP: eio_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-seek.php">
 <link rel="shorturl" href="https://www.php.net/eio-seek">
 <link rel="alternate" href="https://www.php.net/eio-seek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-rmdir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-sendfile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-seek.php" hreflang="zh">
...
<meta name="Description" content="Seek to a position" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_seek - Manual" />
<meta name="twitter:description" content="Seek to a position" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_seek - Manual" />
<meta itemprop="description" content="Seek to a position" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seek to a position" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-sendfile.php">
          eio_sendfile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-rmdir.php">
          &laquo; eio_rmdir        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-seek.php' selected="selected">English</option>
            <option value='de/function.eio-seek.php'>German</option>
            <option value='es/function.eio-seek.php'>Spanish</option>
            <option value='fr/function.eio-seek.php'>French</option>
            <option value='it/function.eio-seek.php'>Italian</option>
            <option value='ja/function.eio-seek.php'>Japanese</option>
            <option value='pt_BR/function.eio-seek.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-seek.php'>Russian</option>
            <option value='tr/function.eio-seek.php'>Turkish</option>
            <option value='uk/function.eio-seek.php'>Ukrainian</option>
            <option value='zh/function.eio-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-seek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_seek</h1>
  <p class="verinfo">(PECL eio &gt;= 0.5.0b)</p><p class="refpurpose"><span class="refname">eio_seek</span> &mdash; <span class="dc-title">Seek to a position</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-seek-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_seek</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$whence</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_seek()</strong></span> repositions the offset of the open file associated with 
   stream, <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instance, or file descriptor specified by <code class="parameter">fd</code> to
   the argument <code class="parameter">offset</code> according to
   the directive <code class="parameter">whence</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-seek-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
     Stream, <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instance, or numeric file descriptor.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
       ...
       <ul class="simplelist">
        <li><strong><code><a href="eio.constants.php#constant.eio-seek-set">EIO_SEEK_SET</a></code></strong> - Set position equal to <code class="parameter">offset</code> bytes.</li>
        <li><strong><code><a href="eio.constants.php#constant.eio-seek-cur">EIO_SEEK_CUR</a></code></strong> - Set position to current location plus <code class="parameter">offset</code>.</li>
        <li><strong><code><a href="eio.constants.php#constant.eio-seek-end">EIO_SEEK_END</a></code></strong> - Set position to end-of-file plus <code class="parameter">offset</code>.</li>
       </ul>
      </p>
    </dd>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-seek-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_seek()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-seek.php">＋<small>add a note</small></a></span>
