...
<head>
  ...
  <title>PHP: imagesx - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagesx.php">
 <link rel="shorturl" href="https://www.php.net/imagesx">
 <link rel="alternate" href="https://www.php.net/imagesx" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagestringup.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagesx.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagesx.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagesx.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagesx.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagesx.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagesx.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagesx.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagesx.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagesx.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagesx.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagesx.php" hreflang="zh">
...
<meta name="Description" content="Get image width" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagesx - Manual" />
<meta name="twitter:description" content="Get image width" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagesx - Manual" />
<meta itemprop="description" content="Get image width" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get image width" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagesy.php">
          imagesy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagestringup.php">
          &laquo; imagestringup        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagesx.php' selected="selected">English</option>
            <option value='de/function.imagesx.php'>German</option>
            <option value='es/function.imagesx.php'>Spanish</option>
            <option value='fr/function.imagesx.php'>French</option>
            <option value='it/function.imagesx.php'>Italian</option>
            <option value='ja/function.imagesx.php'>Japanese</option>
            <option value='pt_BR/function.imagesx.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagesx.php'>Russian</option>
            <option value='tr/function.imagesx.php'>Turkish</option>
            <option value='uk/function.imagesx.php'>Ukrainian</option>
            <option value='zh/function.imagesx.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagesx" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagesx</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagesx</span> &mdash; <span class="dc-title">Get image width</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagesx-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagesx</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the width of the given <code class="parameter">image</code> object.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imagesx-parameters">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagesx-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Return the width of the <code class="parameter">image</code>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imagesx-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagesx-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2937">
    <p><strong>Example #1 Using <span class="function"><strong>imagesx()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// create a 300*200 image<br /></span><span style="color: #0000BB">$img </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatetruecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #0000BB">imagesx</span><span style="color: #007700">(</span><span style="color: #0000BB">$img</span><span style="color: #007700">); </span><span style="color: #FF8000">// 300<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imagesx-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagesy.php" class="function" rel="rdfs-seeAlso">imagesy()</a> - Get image height</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagesx.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagesx%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagesx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesx.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="37632">  <div class="votes">
    <div id="Vu37632">
    <a href="/manual/vote-note.php?id=37632&amp;page=function.imagesx&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd37632">
    <a href="/manual/vote-note.php?id=37632&amp;page=function.imagesx&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V37632" title="57% like this...">
    6
    </div>
  </div>
  <a href="#37632" class="name">
  <strong class="user"><em>leonardo AT saochico DOT com</em></strong></a><a class="genanchor" href="#37632"> &para;</a><div class="date" title="2003-11-21 07:24"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom37632">
<div class="phpcode"><code><span class="html">This function convert image size of Pixel to Centimeter<br /><br />&lt;?<br />#$imagem - source of image<br />#$dpi - resolution to convert E.g.: 72dpi or 300dpi<br /><br />function px2cm($image, $dpi) {<br />    #Create a new image from file or URL<br />    $img = ImageCreateFromJpeg($image);<br /><br />    #Get image width / height<br />    $x = ImageSX($img);<br />    $y = ImageSY($img);<br />    <br />    #Convert to centimeter<br />    $h = $x * 2.54 / $dpi;<br />    $l = $y * 2.54 / $dpi;<br />    <br />    #Format a number with grouped thousands<br />    $h = number_format($h, 2, ',', ' ');<br />    $l = number_format($l, 2, ',', ' ');<br />    <br />    #add size unit<br />    $px2cm[] = $h."cm";<br />    $px2cm[] = $l."cm";<br />    <br />    #return array w values<br />    #$px2cm[0] = X<br />    #$px2cm[1] = Y    <br />    return $px2cm;<br />}<br /><br />$image = "C:\\inetpub\\wwwroot\\lab\\trata_img\\l0gik.jpg";<br />$dpi = 300;<br /><br />$result = px2cm($image, $dpi);<br /><br />print ($result[0]." x ".$result[1]);<br />?&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagesx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesx.php">＋<small>add a note</small></a></div>
