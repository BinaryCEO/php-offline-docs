...
<head>
  ...
  <title>PHP: trader_cci - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cci.php">
 <link rel="shorturl" href="https://www.php.net/trader-cci">
 <link rel="alternate" href="https://www.php.net/trader-cci" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-bop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdl2crows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cci.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cci.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cci.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cci.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cci.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cci.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cci.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cci.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cci.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cci.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cci.php" hreflang="zh">
...
<meta name="Description" content="Commodity Channel Index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cci - Manual" />
<meta name="twitter:description" content="Commodity Channel Index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cci - Manual" />
<meta itemprop="description" content="Commodity Channel Index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commodity Channel Index" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-cdl2crows.php">
          trader_cdl2crows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-bop.php">
          &laquo; trader_bop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cci.php' selected="selected">English</option>
            <option value='de/function.trader-cci.php'>German</option>
            <option value='es/function.trader-cci.php'>Spanish</option>
            <option value='fr/function.trader-cci.php'>French</option>
            <option value='it/function.trader-cci.php'>Italian</option>
            <option value='ja/function.trader-cci.php'>Japanese</option>
            <option value='pt_BR/function.trader-cci.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cci.php'>Russian</option>
            <option value='tr/function.trader-cci.php'>Turkish</option>
            <option value='uk/function.trader-cci.php'>Ukrainian</option>
            <option value='zh/function.trader-cci.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cci" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cci</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cci</span> &mdash; <span class="dc-title">Commodity Channel Index</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cci-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cci</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cci-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cci-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cci.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cci%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cci&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cci.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125876">  <div class="votes">
    <div id="Vu125876">
    <a href="/manual/vote-note.php?id=125876&amp;page=function.trader-cci&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125876">
    <a href="/manual/vote-note.php?id=125876&amp;page=function.trader-cci&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125876" title="100% like this...">
    3
    </div>
  </div>
  <a href="#125876" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125876"> &para;</a><div class="date" title="2021-03-03 07:31"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125876">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// The CCI (Commodity Channel Index) is an oscillator that <br />// relies on historical price momentum to determine if it is "overbought" or "oversold". <br />// When greater than zero the price is "above" the historic average.<br />// When less than zero the price is "below" the historic average.<br />// Investopedia claims:<br />// "The CCI is an unbounded oscillator, meaning it can go higher or lower indefinitely. For this reason, overbought and oversold levels are typically determined for each individual asset by looking at historical extreme CCI levels where the price reversed from."<br /><br /></span><span class="default">$highs </span><span class="keyword">= array(</span><span class="default">118.99</span><span class="keyword">, </span><span class="default">119.14</span><span class="keyword">, </span><span class="default">120.5</span><span class="keyword">, </span><span class="default">115.23</span><span class="keyword">, </span><span class="default">115.93</span><span class="keyword">, </span><span class="default">118.829</span><span class="keyword">, </span><span class="default">116</span><span class="keyword">, </span><span class="default">112.2</span><span class="keyword">, </span><span class="default">110.88</span><span class="keyword">, </span><span class="default">110.19</span><span class="keyword">, </span><span class="default">112.86</span><span class="keyword">, </span><span class="default">112.11</span><span class="keyword">, </span><span class="default">110.25</span><span class="keyword">, </span><span class="default">112.44</span><span class="keyword">);<br /></span><span class="default">$lows </span><span class="keyword">= array(</span><span class="default">112.68</span><span class="keyword">, </span><span class="default">115.26</span><span class="keyword">, </span><span class="default">112.5</span><span class="keyword">, </span><span class="default">110</span><span class="keyword">, </span><span class="default">112.8</span><span class="keyword">, </span><span class="default">113.61</span><span class="keyword">, </span><span class="default">112.04</span><span class="keyword">, </span><span class="default">108.71</span><span class="keyword">, </span><span class="default">106.09</span><span class="keyword">, </span><span class="default">103.1</span><span class="keyword">, </span><span class="default">109.16</span><span class="keyword">, </span><span class="default">106.77</span><span class="keyword">, </span><span class="default">105</span><span class="keyword">, </span><span class="default">107.67</span><span class="keyword">);<br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">112.82</span><span class="keyword">, </span><span class="default">117.32</span><span class="keyword">, </span><span class="default">113.49</span><span class="keyword">, </span><span class="default">112</span><span class="keyword">, </span><span class="default">115.355</span><span class="keyword">, </span><span class="default">115.54</span><span class="keyword">, </span><span class="default">112.13</span><span class="keyword">, </span><span class="default">110.34</span><span class="keyword">, </span><span class="default">106.84</span><span class="keyword">, </span><span class="default">110.08</span><span class="keyword">, </span><span class="default">111.81</span><span class="keyword">, </span><span class="default">107.12</span><span class="keyword">, </span><span class="default">108.22</span><span class="keyword">, </span><span class="default">112.28</span><span class="keyword">);<br /><br /></span><span class="default">$time_period </span><span class="keyword">= </span><span class="default">7</span><span class="keyword">;<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">trader_cci </span><span class="keyword">(</span><span class="default">$highs</span><span class="keyword">, </span><span class="default">$lows</span><span class="keyword">, </span><span class="default">$closes</span><span class="keyword">, </span><span class="default">$time_period</span><span class="keyword">));<br /></span><span class="comment">/*<br />array(8) {<br />  [6]=&gt;<br />  float(-83.234)<br />  [7]=&gt;<br />  float(-137.329)<br />  [8]=&gt;<br />  float(-145.78)<br />  [9]=&gt;<br />  float(-101.047)<br />  [10]=&gt;<br />  float(-9.331)<br />  [11]=&gt;<br />  float(-59.339)<br />  [12]=&gt;<br />  float(-66.964)<br />  [13]=&gt;<br />  float(76.143)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-cci&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cci.php">＋<small>add a note</small></a></div>
