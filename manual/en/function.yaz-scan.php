...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaz-scan.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.yaz-record.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaz-scan-result.php">
...
<meta name="Description" content="Prepares for a scan" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: yaz_scan - Manual" />
<meta name="twitter:description" content="Prepares for a scan" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: yaz_scan - Manual" />
<meta itemprop="description" content="Prepares for a scan" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prepares for a scan" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaz-scan.php' selected="selected">English</option>
            <option value='de/function.yaz-scan.php'>German</option>
            <option value='es/function.yaz-scan.php'>Spanish</option>
            <option value='fr/function.yaz-scan.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PECL yaz &gt;= 0.9.0)</p><p class="refpurpose"><span class="refname">yaz_scan</span> &mdash; <span class="dc-title">Prepares for a scan</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.yaz-scan-description">
  ...
  <p class="para">
   ...
   Scan Response, <span class="function"><a href="function.yaz-wait.php" class="function">yaz_wait()</a></span> must be called. Upon
   completion of <span class="function"><a href="function.yaz-wait.php" class="function">yaz_wait()</a></span> call
   <span class="function"><a href="function.yaz-error.php" class="function">yaz_error()</a></span> and <span class="function"><a href="function.yaz-scan-result.php" class="function">yaz_scan_result()</a></span> to
   handle the response.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.yaz-scan-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Currently only type <code class="literal">rpn</code> is supported.
      </p>
     </dd>
     ...
     <dd>
      ...
      <p class="para">
       ...
       <span class="function"><a href="function.yaz-search.php" class="function">yaz_search()</a></span>. It consists of zero or more 
       <code class="literal">@attr</code>-operator specifications, then followed by 
       exactly one token.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       <code class="literal">number</code> (number of terms requested),
       <code class="literal">position</code> (preferred position of term) and
       <code class="literal">stepSize</code> (preferred step size).
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.yaz-scan-examples">
  ...
  <p class="para">
   <div class="example" id="example-4891">
    <p><strong>Example #1 PHP function that scans titles</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">scan_titles</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$startterm</span><span style="color: #007700">) <br />{<br />  </span><span style="color: #0000BB">yaz_scan</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #DD0000">"rpn"</span><span style="color: #007700">, </span><span style="color: #DD0000">"@attr 1=4 " </span><span style="color: #007700">. </span><span style="color: #0000BB">$startterm</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">yaz_wait</span><span style="color: #007700">();<br />  </span><span style="color: #0000BB">$errno </span><span style="color: #007700">= </span><span style="color: #0000BB">yaz_errno</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$errno </span><span style="color: #007700">== </span><span style="color: #0000BB">0</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$ar </span><span style="color: #007700">= </span><span style="color: #0000BB">yaz_scan_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br />    echo </span><span style="color: #DD0000">'Scan ok; '</span><span style="color: #007700">;<br />    foreach (</span><span style="color: #0000BB">$options </span><span style="color: #007700">as </span><span style="color: #0000BB">$key </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$val</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$key</span><span style="color: #DD0000"> = </span><span style="color: #0000BB">$val</span><span style="color: #DD0000"> &amp;nbsp;"</span><span style="color: #007700">;<br />    }<br />    echo </span><span style="color: #DD0000">'&lt;br /&gt;&lt;table&gt;'</span><span style="color: #007700">;<br />    while (list(</span><span style="color: #0000BB">$key</span><span style="color: #007700">, list(</span><span style="color: #0000BB">$k</span><span style="color: #007700">, </span><span style="color: #0000BB">$term</span><span style="color: #007700">, </span><span style="color: #0000BB">$tcount</span><span style="color: #007700">)) = </span><span style="color: #0000BB">each</span><span style="color: #007700">(</span><span style="color: #0000BB">$ar</span><span style="color: #007700">)) {<br />      if (empty(</span><span style="color: #0000BB">$k</span><span style="color: #007700">)) continue;<br />      echo </span><span style="color: #DD0000">"&lt;tr&gt;&lt;td&gt;</span><span style="color: #0000BB">$term</span><span style="color: #DD0000">&lt;/td&gt;&lt;td&gt;</span><span style="color: #0000BB">$tcount</span><span style="color: #DD0000">&lt;/td&gt;&lt;/tr&gt;"</span><span style="color: #007700">;<br />    }<br />    echo </span><span style="color: #DD0000">'&lt;/table&gt;'</span><span style="color: #007700">;<br />  } else {<br />    echo </span><span style="color: #DD0000">"Scan failed. Error: " </span><span style="color: #007700">. </span><span style="color: #0000BB">yaz_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br />  }<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/functions/yaz-scan.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaz-scan%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaz-scan&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaz-scan.php">＋<small>add a note</small></a></span>
