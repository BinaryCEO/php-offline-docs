...
<head>
  ...
  <title>PHP: Gmagick::profileimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.profileimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.profileimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.profileimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.previousimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.quantizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.profileimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.profileimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.profileimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.profileimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.profileimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.profileimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.profileimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.profileimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.profileimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.profileimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.profileimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::profileimage - Manual" />
<meta name="twitter:description" content="Adds or removes a profile from an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::profileimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.quantizeimage.php">
          Gmagick::quantizeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.previousimage.php">
          &laquo; Gmagick::previousimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.profileimage.php' selected="selected">English</option>
            <option value='de/gmagick.profileimage.php'>German</option>
            <option value='es/gmagick.profileimage.php'>Spanish</option>
            <option value='fr/gmagick.profileimage.php'>French</option>
            <option value='it/gmagick.profileimage.php'>Italian</option>
            <option value='ja/gmagick.profileimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.profileimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.profileimage.php'>Russian</option>
            <option value='tr/gmagick.profileimage.php'>Turkish</option>
            <option value='uk/gmagick.profileimage.php'>Ukrainian</option>
            <option value='zh/gmagick.profileimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.profileimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::profileimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::profileimage</span> &mdash; <span class="dc-title">Adds or removes a profile from an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.profileimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::profileimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$profile</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>

  <p class="para rdfs-comment">
   Adds or removes a ICC, IPTC, or generic profile from an image. If the profile is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, it is removed from the image otherwise added.
   Use a name of <code class="literal">*</code> and a profile of <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to remove all profiles from the image. 
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.profileimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.profileimage-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.profileimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/profileimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.profileimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.profileimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.profileimage.php">＋<small>add a note</small></a></span>
