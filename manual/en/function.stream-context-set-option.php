...
<head>
  ...
  <title>PHP: stream_context_set_option - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-set-option.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-set-option">
 <link rel="alternate" href="https://www.php.net/stream-context-set-option" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-set-default.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-set-options.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-set-option.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-set-option.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-set-option.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-set-option.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-set-option.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-set-option.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-set-option.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-set-option.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-set-option.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-set-option.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-set-option.php" hreflang="zh">
...
<meta name="Description" content="Sets an option for a stream/wrapper/context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_set_option - Manual" />
<meta name="twitter:description" content="Sets an option for a stream/wrapper/context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_set_option - Manual" />
<meta itemprop="description" content="Sets an option for a stream/wrapper/context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets an option for a stream/wrapper/context" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-context-set-options.php">
          stream_context_set_options &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-set-default.php">
          &laquo; stream_context_set_default        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-set-option.php' selected="selected">English</option>
            <option value='de/function.stream-context-set-option.php'>German</option>
            <option value='es/function.stream-context-set-option.php'>Spanish</option>
            <option value='fr/function.stream-context-set-option.php'>French</option>
            <option value='it/function.stream-context-set-option.php'>Italian</option>
            <option value='ja/function.stream-context-set-option.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-set-option.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-set-option.php'>Russian</option>
            <option value='tr/function.stream-context-set-option.php'>Turkish</option>
            <option value='uk/function.stream-context-set-option.php'>Ukrainian</option>
            <option value='zh/function.stream-context-set-option.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-set-option" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.stream-context-set-option-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_context_set_option</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream_or_context</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$wrapper</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$option</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-set-option.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-set-option%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-set-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-set-option.php">＋<small>add a note</small></a></span>
