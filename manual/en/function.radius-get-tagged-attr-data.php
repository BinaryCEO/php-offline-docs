...
<head>
  ...
  <title>PHP: radius_get_tagged_attr_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-get-tagged-attr-data.php">
 <link rel="shorturl" href="https://www.php.net/radius-get-tagged-attr-data">
 <link rel="alternate" href="https://www.php.net/radius-get-tagged-attr-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-get-attr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-get-tagged-attr-tag.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-get-tagged-attr-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-get-tagged-attr-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-get-tagged-attr-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-get-tagged-attr-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-get-tagged-attr-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-get-tagged-attr-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-get-tagged-attr-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-get-tagged-attr-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-get-tagged-attr-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-get-tagged-attr-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-get-tagged-attr-data.php" hreflang="zh">
...
<meta name="Description" content="Extracts the data from a tagged attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_get_tagged_attr_data - Manual" />
<meta name="twitter:description" content="Extracts the data from a tagged attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_get_tagged_attr_data - Manual" />
<meta itemprop="description" content="Extracts the data from a tagged attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extracts the data from a tagged attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.radius-get-tagged-attr-tag.php">
          radius_get_tagged_attr_tag &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-get-attr.php">
          &laquo; radius_get_attr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-get-tagged-attr-data.php' selected="selected">English</option>
            <option value='de/function.radius-get-tagged-attr-data.php'>German</option>
            <option value='es/function.radius-get-tagged-attr-data.php'>Spanish</option>
            <option value='fr/function.radius-get-tagged-attr-data.php'>French</option>
            <option value='it/function.radius-get-tagged-attr-data.php'>Italian</option>
            <option value='ja/function.radius-get-tagged-attr-data.php'>Japanese</option>
            <option value='pt_BR/function.radius-get-tagged-attr-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-get-tagged-attr-data.php'>Russian</option>
            <option value='tr/function.radius-get-tagged-attr-data.php'>Turkish</option>
            <option value='uk/function.radius-get-tagged-attr-data.php'>Ukrainian</option>
            <option value='zh/function.radius-get-tagged-attr-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-get-tagged-attr-data" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.radius-get-tagged-attr-data-returnvalues">
  ...
  <p class="para">
   Returns the data from the tagged attribute  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.radius-get-tagged-attr-data-examples">
  ...
  <p class="para">
   <div class="example" id="example-777">
    <p><strong>Example #1 <span class="function"><strong>radius_get_tagged_attr_data()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.radius-get-tagged-attr-tag.php" class="function" rel="rdfs-seeAlso">radius_get_tagged_attr_tag()</a> - Extracts the tag from a tagged attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-get-tagged-attr-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-get-tagged-attr-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-get-tagged-attr-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-get-tagged-attr-data.php">＋<small>add a note</small></a></span>
