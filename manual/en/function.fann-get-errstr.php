...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-errstr.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-layer-array.php">
...
<meta name="Description" content="Returns the last errstr" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_errstr - Manual" />
<meta name="twitter:description" content="Returns the last errstr" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_errstr - Manual" />
<meta itemprop="description" content="Returns the last errstr" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last errstr" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-errstr.php' selected="selected">English</option>
            ...
            <option value='zh/function.fann-get-errstr.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_errstr</span> &mdash; <span class="dc-title">Returns the last errstr</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-errstr-returnvalues">
  ...
  <p class="para">
   The last error string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-errno.php" class="function" rel="rdfs-seeAlso">fann_get_errno()</a> - Returns the last error number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-errstr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-errstr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-errstr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-errstr.php">＋<small>add a note</small></a></span>
