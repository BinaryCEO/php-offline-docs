...
<head>
  ...
  <title>PHP: cubrid_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-result.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-result">
 <link rel="alternate" href="https://www.php.net/cubrid-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-real-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-unbuffered-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-result.php" hreflang="zh">
...
<meta name="Description" content="Return the value of a specific field in a specific row" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_result - Manual" />
<meta name="twitter:description" content="Return the value of a specific field in a specific row" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_result - Manual" />
<meta itemprop="description" content="Return the value of a specific field in a specific row" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the value of a specific field in a specific row" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-unbuffered-query.php">
          cubrid_unbuffered_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-real-escape-string.php">
          &laquo; cubrid_real_escape_string        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-result.php' selected="selected">English</option>
            <option value='de/function.cubrid-result.php'>German</option>
            <option value='es/function.cubrid-result.php'>Spanish</option>
            <option value='fr/function.cubrid-result.php'>French</option>
            <option value='it/function.cubrid-result.php'>Italian</option>
            <option value='ja/function.cubrid-result.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-result.php'>Russian</option>
            <option value='tr/function.cubrid-result.php'>Turkish</option>
            <option value='uk/function.cubrid-result.php'>Ukrainian</option>
            <option value='zh/function.cubrid-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-result" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-result-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$row</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$field</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <p class="para">
  ...
  <dd><p class="para">The row number from the result that is being retrieved. Row numbers start at 0.</p></dd>
...
<div class="examplescode"><pre class="examplescode">string(1) &quot;X&quot;
string(5) &quot;Mixed&quot;
string(4) &quot;Gold&quot;</pre>
</div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-result.php">＋<small>add a note</small></a></span>
