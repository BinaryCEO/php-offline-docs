...
<head>
  ...
  <title>PHP: variant_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-add.php">
 <link rel="shorturl" href="https://www.php.net/variant-add">
 <link rel="alternate" href="https://www.php.net/variant-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-abs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-and.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-add.php" hreflang="zh">
...
<meta name="Description" content="&quot;Adds&quot; two variant values together and returns the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_add - Manual" />
<meta name="twitter:description" content="&quot;Adds&quot; two variant values together and returns the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_add - Manual" />
<meta itemprop="description" content="&quot;Adds&quot; two variant values together and returns the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="&quot;Adds&quot; two variant values together and returns the result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-and.php">
          variant_and &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-add.php' selected="selected">English</option>
            <option value='de/function.variant-add.php'>German</option>
            <option value='es/function.variant-add.php'>Spanish</option>
            <option value='fr/function.variant-add.php'>French</option>
            <option value='it/function.variant-add.php'>Italian</option>
            <option value='ja/function.variant-add.php'>Japanese</option>
            <option value='pt_BR/function.variant-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-add.php'>Russian</option>
            <option value='tr/function.variant-add.php'>Turkish</option>
            <option value='uk/function.variant-add.php'>Ukrainian</option>
            <option value='zh/function.variant-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_add</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_add</span> &mdash; <span class="dc-title">&quot;Adds&quot; two variant values together and returns the result</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.variant-add-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>variant_add</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$left</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$right</code></span>): <span class="type"><a href="class.variant.php" class="type variant">variant</a></span></div>
...
<p class="para">
 ...
 <span class="function"><strong>variant_add()</strong></span> in PHP corresponds to <code class="literal">VarAdd()
 ...
 <div class="refsect1 errors" id="refsect1-function.variant-add-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-function.variant-add-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-sub.php" class="function" rel="rdfs-seeAlso">variant_sub()</a> - Subtracts the value of the right variant from the left variant value</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-add.php">＋<small>add a note</small></a></span>
