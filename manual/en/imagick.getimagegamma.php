...
<head>
  ...
  <title>PHP: Imagick::getImageGamma - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagegamma.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagegamma.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagegamma.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageformat.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagegeometry.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagegamma.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagegamma.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagegamma.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagegamma.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagegamma.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagegamma.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagegamma.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagegamma.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagegamma.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagegamma.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagegamma.php" hreflang="zh">
...
<meta name="Description" content="Gets the image gamma" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageGamma - Manual" />
<meta name="twitter:description" content="Gets the image gamma" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageGamma - Manual" />
<meta itemprop="description" content="Gets the image gamma" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image gamma" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagegeometry.php">
          Imagick::getImageGeometry &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageformat.php">
          &laquo; Imagick::getImageFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagegamma.php' selected="selected">English</option>
            <option value='de/imagick.getimagegamma.php'>German</option>
            <option value='es/imagick.getimagegamma.php'>Spanish</option>
            <option value='fr/imagick.getimagegamma.php'>French</option>
            <option value='it/imagick.getimagegamma.php'>Italian</option>
            <option value='ja/imagick.getimagegamma.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagegamma.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagegamma.php'>Russian</option>
            <option value='tr/imagick.getimagegamma.php'>Turkish</option>
            <option value='uk/imagick.getimagegamma.php'>Ukrainian</option>
            <option value='zh/imagick.getimagegamma.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagegamma" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageGamma</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageGamma</span> &mdash; <span class="dc-title">Gets the image gamma</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagegamma-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageGamma</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagegamma-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagegamma-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagegamma-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagegamma.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagegamma%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagegamma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagegamma.php">＋<small>add a note</small></a></span>
