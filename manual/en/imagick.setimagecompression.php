...
<head>
  ...
  <title>PHP: Imagick::setImageCompression - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagecompression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagecompression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecompression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagecompose.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagecompressionquality.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecompression.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagecompression.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagecompression.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagecompression.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagecompression.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagecompression.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagecompression.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagecompression.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagecompression.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagecompression.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagecompression.php" hreflang="zh">
...
<meta name="Description" content="Sets the image compression" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageCompression - Manual" />
<meta name="twitter:description" content="Sets the image compression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageCompression - Manual" />
<meta itemprop="description" content="Sets the image compression" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image compression" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagecompressionquality.php">
          Imagick::setImageCompressionQuality &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagecompose.php">
          &laquo; Imagick::setImageCompose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagecompression.php' selected="selected">English</option>
            <option value='de/imagick.setimagecompression.php'>German</option>
            <option value='es/imagick.setimagecompression.php'>Spanish</option>
            <option value='fr/imagick.setimagecompression.php'>French</option>
            <option value='it/imagick.setimagecompression.php'>Italian</option>
            <option value='ja/imagick.setimagecompression.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagecompression.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagecompression.php'>Russian</option>
            <option value='tr/imagick.setimagecompression.php'>Turkish</option>
            <option value='uk/imagick.setimagecompression.php'>Ukrainian</option>
            <option value='zh/imagick.setimagecompression.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagecompression" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageCompression</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageCompression</span> &mdash; <span class="dc-title">Sets the image compression</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagecompression-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageCompression</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compression</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagecompression-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
      One of the <strong><code>COMPRESSION</code></strong> constants
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagecompression-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagecompression-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagecompression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagecompression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagecompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecompression.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97014">  <div class="votes">
    <div id="Vu97014">
    <a href="/manual/vote-note.php?id=97014&amp;page=imagick.setimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97014">
    <a href="/manual/vote-note.php?id=97014&amp;page=imagick.setimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97014" title="81% like this...">
    10
    </div>
  </div>
  <a href="#97014" class="name">
  <strong class="user"><em>snipes2083 [at] yahoo com</em></strong></a><a class="genanchor" href="#97014"> &para;</a><div class="date" title="2010-03-28 10:03"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97014">
<div class="phpcode"><code><span class="html">Above it says "One of the COMPRESSION constants" for the parameters.  For any of you that found this confusing, you can find a list of the constants here:<br /><br />Predefined Constants<br /><a href="http://www.php.net/manual/en/imagick.constants.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.constants.php</a><br /><br />As an example for working with a jpeg image:<br /><br /><span class="default">&lt;?php<br />    $image </span><span class="keyword">= </span><span class="string">'jpeg_image.jpg'</span><span class="keyword">;<br />    </span><span class="default">$comression_type </span><span class="keyword">= </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPRESSION_JPEG</span><span class="keyword">;<br />    <br />    </span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">);<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageCompression</span><span class="keyword">(</span><span class="default">$compression_type</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This class does not actually compress the images but rather sets the compression type that is going to be used.  <br /><br />If you would like to see how to compress the image see:<br />Imagick::setImageCompressionQuality</span></code></div>
  </div>
 </div>
  <div class="note" id="124102">  <div class="votes">
    <div id="Vu124102">
    <a href="/manual/vote-note.php?id=124102&amp;page=imagick.setimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124102">
    <a href="/manual/vote-note.php?id=124102&amp;page=imagick.setimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124102" title="60% like this...">
    1
    </div>
  </div>
  <a href="#124102" class="name">
  <strong class="user"><em>xudongding</em></strong></a><a class="genanchor" href="#124102"> &para;</a><div class="date" title="2019-08-09 09:14"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124102">
<div class="phpcode"><code><span class="html">const COMPRESSION_UNDEFINED = 0;<br />const COMPRESSION_NO = 1;<br />const COMPRESSION_BZIP = 2;<br />const COMPRESSION_FAX = 6;<br />const COMPRESSION_GROUP4 = 7;<br />const COMPRESSION_JPEG = 8;<br />const COMPRESSION_JPEG2000 = 9;<br />const COMPRESSION_LOSSLESSJPEG = 10;<br />const COMPRESSION_LZW = 11;<br />const COMPRESSION_RLE = 12;<br />const COMPRESSION_ZIP = 13;<br />const COMPRESSION_DXT1 = 3;<br />const COMPRESSION_DXT3 = 4;<br />const COMPRESSION_DXT5 = 5;<br />const COMPRESSION_ZIPS = 14;<br />const COMPRESSION_PIZ = 15;<br />const COMPRESSION_PXR24 = 16;<br />const COMPRESSION_B44 = 17;<br />const COMPRESSION_B44A = 18;<br />const COMPRESSION_LZMA = 19;<br />const COMPRESSION_JBIG1 = 20;<br />const COMPRESSION_JBIG2 = 21;</span></code></div>
  </div>
 </div>
  <div class="note" id="123786">  <div class="votes">
    <div id="Vu123786">
    <a href="/manual/vote-note.php?id=123786&amp;page=imagick.setimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123786">
    <a href="/manual/vote-note.php?id=123786&amp;page=imagick.setimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123786" title="100% like this...">
    2
    </div>
  </div>
  <a href="#123786" class="name">
  <strong class="user"><em>jacob at fragdev dot com</em></strong></a><a class="genanchor" href="#123786"> &para;</a><div class="date" title="2019-04-19 04:12"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123786">
<div class="phpcode"><code><span class="html">On Ubuntu 18.04, these are the default compression methods used for the following common image formats:<br /><br />PNG:  Imagick::COMPRESSION_ZIP<br />JPEG: Imagick::COMPRESSION_JPEG<br />GIF:  Imagick::COMPRESSION_LZW</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagecompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecompression.php">＋<small>add a note</small></a></div>
