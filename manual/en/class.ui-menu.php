...
<head>
  ...
  <title>PHP: UI\Menu - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-menu.php">
 <link rel="shorturl" href="https://www.php.net/ui-menu">
 <link rel="alternate" href="https://www.php.net/ui-menu" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-control.show.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-menu.append.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-menu.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-menu.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-menu.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-menu.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-menu.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-menu.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-menu.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-menu.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-menu.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-menu.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-menu.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: UI\Menu - Manual" />
<meta name="twitter:description" content="Menu" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Menu - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-menu.append.php">
          UI\Menu::append &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-control.show.php">
          &laquo; UI\Control::show        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-menu.php' selected="selected">English</option>
            <option value='de/class.ui-menu.php'>German</option>
            <option value='es/class.ui-menu.php'>Spanish</option>
            <option value='fr/class.ui-menu.php'>French</option>
            <option value='it/class.ui-menu.php'>Italian</option>
            <option value='ja/class.ui-menu.php'>Japanese</option>
            <option value='pt_BR/class.ui-menu.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-menu.php'>Russian</option>
            <option value='tr/class.ui-menu.php'>Turkish</option>
            <option value='uk/class.ui-menu.php'>Ukrainian</option>
            <option value='zh/class.ui-menu.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-menu" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-menu.append.php">UI\Menu::append</a> — Append Menu Item</li><li><a href="ui-menu.appendabout.php">UI\Menu::appendAbout</a> — Append About Menu Item</li><li><a href="ui-menu.appendcheck.php">UI\Menu::appendCheck</a> — Append Checkable Menu Item</li><li><a href="ui-menu.appendpreferences.php">UI\Menu::appendPreferences</a> — Append Preferences Menu Item</li><li><a href="ui-menu.appendquit.php">UI\Menu::appendQuit</a> — Append Quit Menu Item</li><li><a href="ui-menu.appendseparator.php">UI\Menu::appendSeparator</a> — Append Menu Item Separator</li><li><a href="ui-menu.construct.php">UI\Menu::__construct</a> — Construct a new Menu</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.menu.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-menu%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-menu&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-menu.php">＋<small>add a note</small></a></span>
