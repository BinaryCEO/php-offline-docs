...
<head>
  ...
  <title>PHP: cubrid_list_dbs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-list-dbs.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-list-dbs">
 <link rel="alternate" href="https://www.php.net/cubrid-list-dbs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-field-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-num-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-list-dbs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-list-dbs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-list-dbs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-list-dbs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-list-dbs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-list-dbs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-list-dbs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-list-dbs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-list-dbs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-list-dbs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-list-dbs.php" hreflang="zh">
...
<meta name="Description" content="Return an array with the list of all existing CUBRID databases" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_list_dbs - Manual" />
<meta name="twitter:description" content="Return an array with the list of all existing CUBRID databases" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_list_dbs - Manual" />
<meta itemprop="description" content="Return an array with the list of all existing CUBRID databases" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return an array with the list of all existing CUBRID databases" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-num-fields.php">
          cubrid_num_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-field-type.php">
          &laquo; cubrid_field_type        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-list-dbs.php' selected="selected">English</option>
            <option value='de/function.cubrid-list-dbs.php'>German</option>
            <option value='es/function.cubrid-list-dbs.php'>Spanish</option>
            <option value='fr/function.cubrid-list-dbs.php'>French</option>
            <option value='it/function.cubrid-list-dbs.php'>Italian</option>
            <option value='ja/function.cubrid-list-dbs.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-list-dbs.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-list-dbs.php'>Russian</option>
            <option value='tr/function.cubrid-list-dbs.php'>Turkish</option>
            <option value='uk/function.cubrid-list-dbs.php'>Ukrainian</option>
            <option value='zh/function.cubrid-list-dbs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-list-dbs" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-list-dbs-examples">
  ...
  <div class="example" id="example-1299">
   <p><strong>Example #1 <span class="function"><strong>cubrid_list_dbs()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">array(1) {
  ...
  string(6) &quot;demodb&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-list-dbs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-list-dbs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-list-dbs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-list-dbs.php">＋<small>add a note</small></a></span>
