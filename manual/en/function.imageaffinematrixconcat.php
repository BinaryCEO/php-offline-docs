...
<head>
  ...
  <title>PHP: imageaffinematrixconcat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imageaffinematrixconcat.php">
 <link rel="shorturl" href="https://www.php.net/imageaffinematrixconcat">
 <link rel="alternate" href="https://www.php.net/imageaffinematrixconcat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imageaffine.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageaffinematrixget.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imageaffinematrixconcat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imageaffinematrixconcat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imageaffinematrixconcat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imageaffinematrixconcat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imageaffinematrixconcat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imageaffinematrixconcat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imageaffinematrixconcat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imageaffinematrixconcat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imageaffinematrixconcat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imageaffinematrixconcat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imageaffinematrixconcat.php" hreflang="zh">
...
<meta name="Description" content="Concatenate two affine transformation matrices" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imageaffinematrixconcat - Manual" />
<meta name="twitter:description" content="Concatenate two affine transformation matrices" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imageaffinematrixconcat - Manual" />
<meta itemprop="description" content="Concatenate two affine transformation matrices" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Concatenate two affine transformation matrices" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imageaffinematrixget.php">
          imageaffinematrixget &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imageaffine.php">
          &laquo; imageaffine        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imageaffinematrixconcat.php' selected="selected">English</option>
            <option value='de/function.imageaffinematrixconcat.php'>German</option>
            <option value='es/function.imageaffinematrixconcat.php'>Spanish</option>
            <option value='fr/function.imageaffinematrixconcat.php'>French</option>
            <option value='it/function.imageaffinematrixconcat.php'>Italian</option>
            <option value='ja/function.imageaffinematrixconcat.php'>Japanese</option>
            <option value='pt_BR/function.imageaffinematrixconcat.php'>Brazilian Portuguese</option>
            <option value='ru/function.imageaffinematrixconcat.php'>Russian</option>
            <option value='tr/function.imageaffinematrixconcat.php'>Turkish</option>
            <option value='uk/function.imageaffinematrixconcat.php'>Ukrainian</option>
            <option value='zh/function.imageaffinematrixconcat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imageaffinematrixconcat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imageaffinematrixconcat</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imageaffinematrixconcat</span> &mdash; <span class="dc-title">Concatenate two affine transformation matrices</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imageaffinematrixconcat-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imageaffinematrixconcat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$matrix1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$matrix2</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imageaffinematrixconcat-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">matrix1</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">matrix2</code></dt>
    <dd>
     <p class="para">
      An affine transformation matrix (an array with keys
      <code class="literal">0</code> to <code class="literal">5</code> and float values).
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.imageaffinematrixconcat-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imageaffinematrixget.php" class="function" rel="rdfs-seeAlso">imageaffinematrixget()</a> - Get an affine transformation matrix</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imageaffinematrixconcat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imageaffinematrixconcat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imageaffinematrixconcat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageaffinematrixconcat.php">＋<small>add a note</small></a></span>
