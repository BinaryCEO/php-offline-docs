...
<head>
  ...
  <title>PHP: IntlCalendar::getKeywordValuesForLocale - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getkeywordvaluesforlocale.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getkeywordvaluesforlocale.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getkeywordvaluesforlocale.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getgreatestminimum.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getleastmaximum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getkeywordvaluesforlocale.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.getkeywordvaluesforlocale.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.getkeywordvaluesforlocale.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.getkeywordvaluesforlocale.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.getkeywordvaluesforlocale.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.getkeywordvaluesforlocale.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.getkeywordvaluesforlocale.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.getkeywordvaluesforlocale.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.getkeywordvaluesforlocale.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.getkeywordvaluesforlocale.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.getkeywordvaluesforlocale.php" hreflang="zh">
...
<meta name="Description" content="Get set of locale keyword values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getKeywordValuesForLocale - Manual" />
<meta name="twitter:description" content="Get set of locale keyword values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getKeywordValuesForLocale - Manual" />
<meta itemprop="description" content="Get set of locale keyword values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get set of locale keyword values" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlcalendar.getleastmaximum.php">
          IntlCalendar::getLeastMaximum &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.getgreatestminimum.php">
          &laquo; IntlCalendar::getGreatestMinimum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getkeywordvaluesforlocale.php' selected="selected">English</option>
            <option value='de/intlcalendar.getkeywordvaluesforlocale.php'>German</option>
            <option value='es/intlcalendar.getkeywordvaluesforlocale.php'>Spanish</option>
            <option value='fr/intlcalendar.getkeywordvaluesforlocale.php'>French</option>
            <option value='it/intlcalendar.getkeywordvaluesforlocale.php'>Italian</option>
            <option value='ja/intlcalendar.getkeywordvaluesforlocale.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.getkeywordvaluesforlocale.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.getkeywordvaluesforlocale.php'>Russian</option>
            <option value='tr/intlcalendar.getkeywordvaluesforlocale.php'>Turkish</option>
            <option value='uk/intlcalendar.getkeywordvaluesforlocale.php'>Ukrainian</option>
            <option value='zh/intlcalendar.getkeywordvaluesforlocale.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.getkeywordvaluesforlocale" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getkeywordvaluesforlocale-returnvalues">
  ...
  <p class="para">
   ...
   values or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-intlcalendar.getkeywordvaluesforlocale-examples">
  ...
  <p class="para">
   ...
   <p><strong>Example #1 <span class="function"><strong>IntlCalendar::getKeyworkValuesForLocale()</strong></span></strong></p>
...
(
    ...
    [12] =&gt; ethiopic-amete-alem
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getkeywordvaluesforlocale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getkeywordvaluesforlocale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getkeywordvaluesforlocale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getkeywordvaluesforlocale.php">＋<small>add a note</small></a></span>
