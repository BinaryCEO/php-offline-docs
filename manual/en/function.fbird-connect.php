...
<head>
  ...
  <title>PHP: fbird_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-connect.php">
 <link rel="shorturl" href="https://www.php.net/fbird-connect">
 <link rel="alternate" href="https://www.php.net/fbird-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-commit-ret.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-db-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-connect.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_connect" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_connect - Manual" />
<meta name="twitter:description" content="Alias of ibase_connect" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_connect - Manual" />
<meta itemprop="description" content="Alias of ibase_connect" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_connect" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-db-info.php">
          fbird_db_info &raquo;
              ...
              <div class="prev">
        <a href="function.fbird-commit-ret.php">
          &laquo; fbird_commit_ret        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-connect.php' selected="selected">English</option>
            <option value='de/function.fbird-connect.php'>German</option>
            <option value='es/function.fbird-connect.php'>Spanish</option>
            <option value='fr/function.fbird-connect.php'>French</option>
            <option value='it/function.fbird-connect.php'>Italian</option>
            <option value='ja/function.fbird-connect.php'>Japanese</option>
            <option value='pt_BR/function.fbird-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-connect.php'>Russian</option>
            <option value='tr/function.fbird-connect.php'>Turkish</option>
            <option value='uk/function.fbird-connect.php'>Ukrainian</option>
            <option value='zh/function.fbird-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-connect" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_connect</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_connect</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-connect.php" class="function">ibase_connect()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-connect-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-connect-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-pconnect.php" class="function" rel="rdfs-seeAlso">fbird_pconnect()</a> - Alias of ibase_pconnect</span></li>
    <li><span class="function"><a href="function.fbird-close.php" class="function" rel="rdfs-seeAlso">fbird_close()</a> - Alias of ibase_close</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-connect.php">＋<small>add a note</small></a></span>
