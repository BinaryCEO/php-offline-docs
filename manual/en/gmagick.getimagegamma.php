...
<head>
  ...
  <title>PHP: Gmagick::getimagegamma - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagegamma.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagegamma.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagegamma.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageformat.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagegreenprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagegamma.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagegamma.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagegamma.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagegamma.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagegamma.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagegamma.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagegamma.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagegamma.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagegamma.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagegamma.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagegamma.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagegamma - Manual" />
<meta name="twitter:description" content="Gets the image gamma" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagegamma - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagegreenprimary.php">
          Gmagick::getimagegreenprimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageformat.php">
          &laquo; Gmagick::getimageformat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagegamma.php' selected="selected">English</option>
            <option value='de/gmagick.getimagegamma.php'>German</option>
            <option value='es/gmagick.getimagegamma.php'>Spanish</option>
            <option value='fr/gmagick.getimagegamma.php'>French</option>
            <option value='it/gmagick.getimagegamma.php'>Italian</option>
            <option value='ja/gmagick.getimagegamma.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagegamma.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagegamma.php'>Russian</option>
            <option value='tr/gmagick.getimagegamma.php'>Turkish</option>
            <option value='uk/gmagick.getimagegamma.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagegamma.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagegamma" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagegamma</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagegamma</span> &mdash; <span class="dc-title">Gets the image gamma</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagegamma-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagegamma</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagegamma-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagegamma-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagegamma-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagegamma.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagegamma%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagegamma&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagegamma.php">＋<small>add a note</small></a></span>
