...
<head>
  ...
  <title>PHP: IntlCalendar::getMinimum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getminimum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getminimum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getminimum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getminimaldaysinfirstweek.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getnow.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getminimum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.getminimum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.getminimum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.getminimum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.getminimum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.getminimum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.getminimum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.getminimum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.getminimum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.getminimum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.getminimum.php" hreflang="zh">
...
<meta name="Description" content="Get the global minimum value for a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getMinimum - Manual" />
<meta name="twitter:description" content="Get the global minimum value for a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getMinimum - Manual" />
<meta itemprop="description" content="Get the global minimum value for a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the global minimum value for a field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlcalendar.getnow.php">
          IntlCalendar::getNow &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.getminimaldaysinfirstweek.php">
          &laquo; IntlCalendar::getMinimalDaysInFirstWeek        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getminimum.php' selected="selected">English</option>
            <option value='de/intlcalendar.getminimum.php'>German</option>
            <option value='es/intlcalendar.getminimum.php'>Spanish</option>
            <option value='fr/intlcalendar.getminimum.php'>French</option>
            <option value='it/intlcalendar.getminimum.php'>Italian</option>
            <option value='ja/intlcalendar.getminimum.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.getminimum.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.getminimum.php'>Russian</option>
            <option value='tr/intlcalendar.getminimum.php'>Turkish</option>
            <option value='uk/intlcalendar.getminimum.php'>Ukrainian</option>
            <option value='zh/intlcalendar.getminimum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.getminimum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::getMinimum</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::getMinimum</span> &mdash; <span class="dc-title">Get the global minimum value for a field</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.getminimum-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::getMinimum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_get_minimum</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="intlcalendar.getgreatestminimum.php" class="function">IntlCalendar::getGreatestMinimum()</a></span>. For the Gregorian
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getminimum-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> representing a value for the given
   field in the fieldʼs unit or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getminimum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getminimum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getminimum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getminimum.php">＋<small>add a note</small></a></span>
