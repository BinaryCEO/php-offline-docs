...
<head>
  ...
  <title>PHP: ReflectionClass::isInterface - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isinterface.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isinterface.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isinterface.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isinstantiable.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isinternal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isinterface.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isinterface.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isinterface.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isinterface.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isinterface.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isinterface.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isinterface.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isinterface.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isinterface.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isinterface.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isinterface.php" hreflang="zh">
...
<meta name="Description" content="Checks if the class is an interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isInterface - Manual" />
<meta name="twitter:description" content="Checks if the class is an interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isInterface - Manual" />
<meta itemprop="description" content="Checks if the class is an interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the class is an interface" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.isinternal.php">
          ReflectionClass::isInternal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isinstantiable.php">
          &laquo; ReflectionClass::isInstantiable        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isinterface.php' selected="selected">English</option>
            <option value='de/reflectionclass.isinterface.php'>German</option>
            <option value='es/reflectionclass.isinterface.php'>Spanish</option>
            <option value='fr/reflectionclass.isinterface.php'>French</option>
            <option value='it/reflectionclass.isinterface.php'>Italian</option>
            <option value='ja/reflectionclass.isinterface.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isinterface.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isinterface.php'>Russian</option>
            <option value='tr/reflectionclass.isinterface.php'>Turkish</option>
            <option value='uk/reflectionclass.isinterface.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isinterface.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isinterface" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isInterface</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isInterface</span> &mdash; <span class="dc-title">Checks if the class is an interface</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isinterface-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isInterface</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.isinterface-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isinterface-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.isinterface-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5502">
    <p><strong>Example #1 Basic usage of <span class="methodname"><strong>ReflectionClass::isInterface()</strong></span></strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">interface </span><span style="color: #0000BB">SomeInterface </span><span style="color: #007700">{<br />    public function </span><span style="color: #0000BB">interfaceMethod</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">$class </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #DD0000">'SomeInterface'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$class</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isInterface</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isinterface-seealso">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.isinstance.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isInstance()</a> - Checks class for instance</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isinterface.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isinterface%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isinterface&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isinterface.php">＋<small>add a note</small></a></span>
