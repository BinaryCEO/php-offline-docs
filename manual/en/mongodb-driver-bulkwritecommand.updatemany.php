...
<head>
  ...
  <title>PHP: MongoDB\Driver\BulkWriteCommand::updateMany - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updatemany.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updatemany.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwritecommand.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.replaceone.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updateone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-bulkwritecommand.updatemany.php" hreflang="zh">
...
<meta name="Description" content="Add an updateMany operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\BulkWriteCommand::updateMany - Manual" />
<meta name="twitter:description" content="Add an updateMany operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\BulkWriteCommand::updateMany - Manual" />
<meta itemprop="description" content="Add an updateMany operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add an updateMany operation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-bulkwritecommand.updateone.php">
          MongoDB\Driver\BulkWriteCommand::updateOne &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-bulkwritecommand.replaceone.php">
          &laquo; MongoDB\Driver\BulkWriteCommand::replaceOne        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-bulkwritecommand.updatemany.php' selected="selected">English</option>
            <option value='de/mongodb-driver-bulkwritecommand.updatemany.php'>German</option>
            <option value='es/mongodb-driver-bulkwritecommand.updatemany.php'>Spanish</option>
            <option value='fr/mongodb-driver-bulkwritecommand.updatemany.php'>French</option>
            <option value='it/mongodb-driver-bulkwritecommand.updatemany.php'>Italian</option>
            <option value='ja/mongodb-driver-bulkwritecommand.updatemany.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-bulkwritecommand.updatemany.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-bulkwritecommand.updatemany.php'>Russian</option>
            <option value='tr/mongodb-driver-bulkwritecommand.updatemany.php'>Turkish</option>
            <option value='uk/mongodb-driver-bulkwritecommand.updatemany.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-bulkwritecommand.updatemany.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-bulkwritecommand.updatemany" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-mongodb-driver-bulkwritecommand.updatemany-examples">
  ...
  <div class="example" id="example-1426">
   <p><strong>Example #1 <span class="function"><strong>MongoDB\Driver\BulkWriteCommand::updateMany()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-bulkwritecommandresult.php" class="classname">MongoDB\Driver\BulkWriteCommandResult</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/bulkwritecommand/updatemany.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-bulkwritecommand.updatemany%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-bulkwritecommand.updatemany&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.updatemany.php">＋<small>add a note</small></a></span>
