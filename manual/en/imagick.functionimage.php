...
<head>
  ...
  <title>PHP: Imagick::functionImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.functionimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.functionimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.functionimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.frameimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.fximage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.functionimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.functionimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.functionimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.functionimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.functionimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.functionimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.functionimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.functionimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.functionimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.functionimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.functionimage.php" hreflang="zh">
...
<meta name="Description" content="Applies a function on the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::functionImage - Manual" />
<meta name="twitter:description" content="Applies a function on the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::functionImage - Manual" />
<meta itemprop="description" content="Applies a function on the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a function on the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.fximage.php">
          Imagick::fxImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.frameimage.php">
          &laquo; Imagick::frameImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.functionimage.php' selected="selected">English</option>
            <option value='de/imagick.functionimage.php'>German</option>
            <option value='es/imagick.functionimage.php'>Spanish</option>
            <option value='fr/imagick.functionimage.php'>French</option>
            <option value='it/imagick.functionimage.php'>Italian</option>
            <option value='ja/imagick.functionimage.php'>Japanese</option>
            <option value='pt_BR/imagick.functionimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.functionimage.php'>Russian</option>
            <option value='tr/imagick.functionimage.php'>Turkish</option>
            <option value='uk/imagick.functionimage.php'>Ukrainian</option>
            <option value='zh/imagick.functionimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.functionimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::functionImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::functionImage</span> &mdash; <span class="dc-title">Applies a function on the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.functionimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::functionImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$function</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$arguments</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Applies an arithmetic, relational, or logical expression to a pseudo image.
  </p>
  <p class="para">
   See also <a href="http://www.imagemagick.org/Usage/transform/#function" class="link external">&raquo;&nbsp;ImageMagick
   v6 Examples - Image Transformations — Function, Multi-Argument Evaluate</a>
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.functionimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Refer to this list of <a href="imagick.constants.php#imagick.constants.function" class="link">function constants</a>
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.functionimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.functionimage-errors">
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-functionImage_sinusoidal.png" alt="Output of create a sinusoidal gradient" width="200" height="200" />
     </div>
    </div>
   </div>
   
   <div class="example" id="example-3005">
    <p><strong>Example #2 Create a gradient from the polynomial (4x^2 - 4x + 1) </strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #DD0000">'gradient:black-white'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$arguments </span><span style="color: #007700">= array(</span><span style="color: #0000BB">4</span><span style="color: #007700">, -</span><span style="color: #0000BB">4</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">functionImage</span><span style="color: #007700">(</span><span style="color: #0000BB">Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">FUNCTION_POLYNOMIAL</span><span style="color: #007700">, </span><span style="color: #0000BB">$arguments</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setimageformat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-functionImage_multiplied.png" alt="Output of create complex gradient" width="200" height="200" />
     </div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/functionimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.functionimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.functionimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.functionimage.php">＋<small>add a note</small></a></span>
