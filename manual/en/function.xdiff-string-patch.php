...
<head>
  ...
  <title>PHP: xdiff_string_patch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xdiff-string-patch.php">
 <link rel="shorturl" href="https://www.php.net/xdiff-string-patch">
 <link rel="alternate" href="https://www.php.net/xdiff-string-patch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xdiff.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xdiff-string-merge3.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xdiff-string-patch-binary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xdiff-string-patch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xdiff-string-patch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xdiff-string-patch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xdiff-string-patch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xdiff-string-patch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xdiff-string-patch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xdiff-string-patch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xdiff-string-patch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xdiff-string-patch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xdiff-string-patch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xdiff-string-patch.php" hreflang="zh">
...
<meta name="Description" content="Patch a string with an unified diff" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xdiff_string_patch - Manual" />
<meta name="twitter:description" content="Patch a string with an unified diff" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xdiff_string_patch - Manual" />
<meta itemprop="description" content="Patch a string with an unified diff" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Patch a string with an unified diff" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.xdiff-string-patch-binary.php">
          xdiff_string_patch_binary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xdiff-string-merge3.php">
          &laquo; xdiff_string_merge3        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xdiff-string-patch.php' selected="selected">English</option>
            <option value='de/function.xdiff-string-patch.php'>German</option>
            <option value='es/function.xdiff-string-patch.php'>Spanish</option>
            <option value='fr/function.xdiff-string-patch.php'>French</option>
            <option value='it/function.xdiff-string-patch.php'>Italian</option>
            <option value='ja/function.xdiff-string-patch.php'>Japanese</option>
            <option value='pt_BR/function.xdiff-string-patch.php'>Brazilian Portuguese</option>
            <option value='ru/function.xdiff-string-patch.php'>Russian</option>
            <option value='tr/function.xdiff-string-patch.php'>Turkish</option>
            <option value='uk/function.xdiff-string-patch.php'>Ukrainian</option>
            <option value='zh/function.xdiff-string-patch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xdiff-string-patch" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.xdiff-string-patch-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>xdiff_string_patch</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$str</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$patch</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$error</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.xdiff-string-patch-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The unified patch string. It has to be created using <span class="function"><a href="function.xdiff-string-diff.php" class="function">xdiff_string_diff()</a></span>, 
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="xdiff.constants.php#constant.xdiff-patch-normal">XDIFF_PATCH_NORMAL</a></code></strong> (default mode, normal patch)
       or <strong><code><a href="xdiff.constants.php#constant.xdiff-patch-reverse">XDIFF_PATCH_REVERSE</a></code></strong> (reversed patch).
      </p>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.xdiff-string-patch-returnvalues">
  ...
  <p class="para">
   Returns the patched string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.xdiff-string-patch-examples">
  ...
  <p class="para">
   <div class="example" id="example-2450">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$old_article </span><span style="color: #007700">= </span><span style="color: #0000BB">file_get_contents</span><span style="color: #007700">(</span><span style="color: #DD0000">'./old_article.txt'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$diff </span><span style="color: #007700">= </span><span style="color: #0000BB">$_SERVER</span><span style="color: #007700">[</span><span style="color: #DD0000">'patch'</span><span style="color: #007700">]; </span><span style="color: #FF8000">/* Let's say that someone pasted a patch to html form */<br /><br /></span><span style="color: #0000BB">$errors </span><span style="color: #007700">= </span><span style="color: #DD0000">''</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$new_article </span><span style="color: #007700">= </span><span style="color: #0000BB">xdiff_string_patch</span><span style="color: #007700">(</span><span style="color: #0000BB">$old_article</span><span style="color: #007700">, </span><span style="color: #0000BB">$diff</span><span style="color: #007700">, </span><span style="color: #0000BB">XDIFF_PATCH_NORMAL</span><span style="color: #007700">, </span><span style="color: #0000BB">$errors</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">is_string</span><span style="color: #007700">(</span><span style="color: #0000BB">$new_article</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"New article:\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #0000BB">$new_article</span><span style="color: #007700">;<br />}<br /><br />if (</span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$errors</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"Rejects: \n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #0000BB">$errors</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.xdiff-string-patch-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.xdiff-string-diff.php" class="function" rel="rdfs-seeAlso">xdiff_string_diff()</a> - Make unified diff of two strings</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xdiff/functions/xdiff-string-patch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xdiff-string-patch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xdiff-string-patch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xdiff-string-patch.php">＋<small>add a note</small></a></span>
