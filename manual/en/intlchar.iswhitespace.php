...
<head>
  ...
  <title>PHP: IntlChar::isWhitespace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.iswhitespace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.iswhitespace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.iswhitespace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isuwhitespace.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isxdigit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.iswhitespace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.iswhitespace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.iswhitespace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.iswhitespace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.iswhitespace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.iswhitespace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.iswhitespace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.iswhitespace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.iswhitespace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.iswhitespace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.iswhitespace.php" hreflang="zh">
...
<meta name="Description" content="Check if code point is a whitespace character according to ICU" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isWhitespace - Manual" />
<meta name="twitter:description" content="Check if code point is a whitespace character according to ICU" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isWhitespace - Manual" />
<meta itemprop="description" content="Check if code point is a whitespace character according to ICU" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point is a whitespace character according to ICU" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.isxdigit.php">
          IntlChar::isxdigit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isuwhitespace.php">
          &laquo; IntlChar::isUWhiteSpace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.iswhitespace.php' selected="selected">English</option>
            <option value='de/intlchar.iswhitespace.php'>German</option>
            <option value='es/intlchar.iswhitespace.php'>Spanish</option>
            <option value='fr/intlchar.iswhitespace.php'>French</option>
            <option value='it/intlchar.iswhitespace.php'>Italian</option>
            <option value='ja/intlchar.iswhitespace.php'>Japanese</option>
            <option value='pt_BR/intlchar.iswhitespace.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.iswhitespace.php'>Russian</option>
            <option value='tr/intlchar.iswhitespace.php'>Turkish</option>
            <option value='uk/intlchar.iswhitespace.php'>Ukrainian</option>
            <option value='zh/intlchar.iswhitespace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.iswhitespace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isWhitespace</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isWhitespace</span> &mdash; <span class="dc-title">Check if code point is a whitespace character according to ICU</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.iswhitespace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isWhitespace</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.iswhitespace-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.iswhitespace-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">codepoint</code> is a whitespace character according to ICU, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.iswhitespace-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2746">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">iswhitespace</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">iswhitespace</span><span style="color: #007700">(</span><span style="color: #DD0000">" "</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">iswhitespace</span><span style="color: #007700">(</span><span style="color: #DD0000">"\n"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">iswhitespace</span><span style="color: #007700">(</span><span style="color: #DD0000">"\t"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">iswhitespace</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{00A0}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.iswhitespace-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.isuwhitespace.php" class="function" rel="rdfs-seeAlso">IntlChar::isUWhiteSpace()</a> - Check if code point has the White_Space Unicode property</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/iswhitespace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.iswhitespace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.iswhitespace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.iswhitespace.php">＋<small>add a note</small></a></span>
