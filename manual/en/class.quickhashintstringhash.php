...
<head>
  ...
  <title>PHP: QuickHashIntStringHash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.quickhashintstringhash.php">
 <link rel="shorturl" href="https://www.php.net/quickhashintstringhash">
 <link rel="alternate" href="https://www.php.net/quickhashintstringhash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.quickhash.php">
 <link rel="prev" href="https://www.php.net/manual/en/quickhashstringinthash.update.php">
 <link rel="next" href="https://www.php.net/manual/en/quickhashintstringhash.add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.quickhashintstringhash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.quickhashintstringhash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.quickhashintstringhash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.quickhashintstringhash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.quickhashintstringhash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.quickhashintstringhash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.quickhashintstringhash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.quickhashintstringhash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.quickhashintstringhash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.quickhashintstringhash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.quickhashintstringhash.php" hreflang="zh">
...
<meta name="Description" content="The QuickHashIntStringHash class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: QuickHashIntStringHash - Manual" />
<meta name="twitter:description" content="The QuickHashIntStringHash class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: QuickHashIntStringHash - Manual" />
<meta itemprop="description" content="The QuickHashIntStringHash class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The QuickHashIntStringHash class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="quickhashintstringhash.add.php">
          QuickHashIntStringHash::add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="quickhashstringinthash.update.php">
          &laquo; QuickHashStringIntHash::update        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.quickhashintstringhash.php' selected="selected">English</option>
            <option value='de/class.quickhashintstringhash.php'>German</option>
            <option value='es/class.quickhashintstringhash.php'>Spanish</option>
            <option value='fr/class.quickhashintstringhash.php'>French</option>
            <option value='it/class.quickhashintstringhash.php'>Italian</option>
            <option value='ja/class.quickhashintstringhash.php'>Japanese</option>
            <option value='pt_BR/class.quickhashintstringhash.php'>Brazilian Portuguese</option>
            <option value='ru/class.quickhashintstringhash.php'>Russian</option>
            <option value='tr/class.quickhashintstringhash.php'>Turkish</option>
            <option value='uk/class.quickhashintstringhash.php'>Ukrainian</option>
            <option value='zh/class.quickhashintstringhash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.quickhashintstringhash" class="reference">

 <h1 class="title">The QuickHashIntStringHash class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PECL quickhash &gt;= Unknown)</p>
  ...
  <div class="section" id="quickhashintstringhash.intro">
   ...
   <p class="para">
    ...
    <span class="interfacename"><a href="class.arrayaccess.php" class="interfacename">ArrayAccess</a></span> interface.
   </p>
   <p class="para">
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="quickhashintstringhash.update.php" class="methodname">update</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="quickhashintstringhash.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">If enabled, adding duplicate elements to a set (through either <span class="methodname"><a href="quickhashintstringhash.add.php" class="methodname">QuickHashIntStringHash::add()</a></span> or
       <span class="methodname"><a href="quickhashintstringhash.loadfromfile.php" class="methodname">QuickHashIntStringHash::loadFromFile()</a></span>) will result in those elements to be dropped from the
  ...
  adds a new one if the entry doesn't exist</li><li><a href="quickhashintstringhash.update.php">QuickHashIntStringHash::update</a> — This method updates an entry in the hash with a new value</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/quickhashintstringhash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.quickhashintstringhash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.quickhashintstringhash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.quickhashintstringhash.php">＋<small>add a note</small></a></span>
