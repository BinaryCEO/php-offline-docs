...
<head>
  ...
  <title>PHP: svn_fs_begin_txn2 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-fs-begin-txn2.php">
 <link rel="shorturl" href="https://www.php.net/svn-fs-begin-txn2">
 <link rel="alternate" href="https://www.php.net/svn-fs-begin-txn2" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-fs-apply-text.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-change-node-prop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-fs-begin-txn2.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-fs-begin-txn2.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-fs-begin-txn2.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-fs-begin-txn2.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-fs-begin-txn2.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-fs-begin-txn2.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-fs-begin-txn2.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-fs-begin-txn2.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-fs-begin-txn2.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-fs-begin-txn2.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-fs-begin-txn2.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: svn_fs_begin_txn2 - Manual" />
<meta name="twitter:description" content="Create a new transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_fs_begin_txn2 - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-fs-change-node-prop.php">
          svn_fs_change_node_prop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-fs-apply-text.php">
          &laquo; svn_fs_apply_text        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-fs-begin-txn2.php' selected="selected">English</option>
            <option value='de/function.svn-fs-begin-txn2.php'>German</option>
            <option value='es/function.svn-fs-begin-txn2.php'>Spanish</option>
            <option value='fr/function.svn-fs-begin-txn2.php'>French</option>
            <option value='it/function.svn-fs-begin-txn2.php'>Italian</option>
            <option value='ja/function.svn-fs-begin-txn2.php'>Japanese</option>
            <option value='pt_BR/function.svn-fs-begin-txn2.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-fs-begin-txn2.php'>Russian</option>
            <option value='tr/function.svn-fs-begin-txn2.php'>Turkish</option>
            <option value='uk/function.svn-fs-begin-txn2.php'>Ukrainian</option>
            <option value='zh/function.svn-fs-begin-txn2.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-fs-begin-txn2" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_fs_begin_txn2</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_fs_begin_txn2</span> &mdash; <span class="dc-title">Create a new transaction</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-fs-begin-txn2-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_fs_begin_txn2</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$repos</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rev</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-fs-begin-txn2-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-fs-begin-txn2.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-fs-begin-txn2%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-fs-begin-txn2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-fs-begin-txn2.php">＋<small>add a note</small></a></span>
