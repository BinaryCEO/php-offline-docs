...
<head>
  ...
  <title>PHP: openssl_cms_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-cms-read.php">
 <link rel="shorturl" href="https://www.php.net/openssl-cms-read">
 <link rel="alternate" href="https://www.php.net/openssl-cms-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cms-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-cms-sign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-cms-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-cms-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-cms-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-cms-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-cms-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-cms-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-cms-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-cms-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-cms-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-cms-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-cms-read.php" hreflang="zh">
...
<meta name="Description" content="Export the CMS file to an array of PEM certificates" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_cms_read - Manual" />
<meta name="twitter:description" content="Export the CMS file to an array of PEM certificates" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_cms_read - Manual" />
<meta itemprop="description" content="Export the CMS file to an array of PEM certificates" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export the CMS file to an array of PEM certificates" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-cms-sign.php">
          openssl_cms_sign &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-cms-encrypt.php">
          &laquo; openssl_cms_encrypt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-cms-read.php' selected="selected">English</option>
            <option value='de/function.openssl-cms-read.php'>German</option>
            <option value='es/function.openssl-cms-read.php'>Spanish</option>
            <option value='fr/function.openssl-cms-read.php'>French</option>
            <option value='it/function.openssl-cms-read.php'>Italian</option>
            <option value='ja/function.openssl-cms-read.php'>Japanese</option>
            <option value='pt_BR/function.openssl-cms-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-cms-read.php'>Russian</option>
            <option value='tr/function.openssl-cms-read.php'>Turkish</option>
            <option value='uk/function.openssl-cms-read.php'>Ukrainian</option>
            <option value='zh/function.openssl-cms-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-cms-read" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-cms-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-cms-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-cms-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-read.php">＋<small>add a note</small></a></span>
