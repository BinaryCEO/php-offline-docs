...
<head>
  ...
  <title>PHP: Imagick::readImageBlob - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.readimageblob.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.readimageblob.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimageblob.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.readimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.readimagefile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimageblob.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.readimageblob.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.readimageblob.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.readimageblob.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.readimageblob.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.readimageblob.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.readimageblob.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.readimageblob.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.readimageblob.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.readimageblob.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.readimageblob.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::readImageBlob - Manual" />
<meta name="twitter:description" content="Reads image from a binary string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::readImageBlob - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.readimagefile.php">
          Imagick::readImageFile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.readimage.php">
          &laquo; Imagick::readImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.readimageblob.php' selected="selected">English</option>
            <option value='de/imagick.readimageblob.php'>German</option>
            <option value='es/imagick.readimageblob.php'>Spanish</option>
            <option value='fr/imagick.readimageblob.php'>French</option>
            <option value='it/imagick.readimageblob.php'>Italian</option>
            <option value='ja/imagick.readimageblob.php'>Japanese</option>
            <option value='pt_BR/imagick.readimageblob.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.readimageblob.php'>Russian</option>
            <option value='tr/imagick.readimageblob.php'>Turkish</option>
            <option value='uk/imagick.readimageblob.php'>Ukrainian</option>
            <option value='zh/imagick.readimageblob.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.readimageblob" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::readImageBlob</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::readImageBlob</span> &mdash; <span class="dc-title">Reads image from a binary string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.readimageblob-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::readImageBlob</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$image</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.readimageblob-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.readimageblob-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.readimageblob-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.readimageblob-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3075">
      <p><strong>Example #1  <span class="function"><strong>Imagick::readImageBlob()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">readImageBlob</span><span style="color: #007700">() {<br />    </span><span style="color: #0000BB">$base64 </span><span style="color: #007700">= </span><span style="color: #DD0000">"iVBORw0KGgoAAAANSUhEUgAAAM0AAAD<br /> NCAMAAAAsYgRbAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5c<br /> cllPAAAABJQTFRF3NSmzMewPxIG//ncJEJsldTou1jHgAAAARBJREFUeNrs2EEK<br /> gCAQBVDLuv+V20dENbMY831wKz4Y/VHb/5RGQ0NDQ0NDQ0NDQ0NDQ0NDQ<br /> 0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0PzMWtyaGhoaGhoaGhoaGhoaGhoxtb0QGho<br /> aGhoaGhoaGhoaGhoaMbRLEvv50VTQ9OTQ5OpyZ01GpM2g0bfmDQaL7S+ofFC6x<br /> v3ZpxJiywakzbvd9r3RWPS9I2+MWk0+kbf0Hih9Y17U0nTHibrDDQ0NDQ0NDQ0<br /> NDQ0NDQ0NTXbRSL/AK72o6GhoaGhoRlL8951vwsNDQ0NDQ1NDc0WyHtDTEhD<br /> Q0NDQ0NTS5MdGhoaGhoaGhoaGhoaGhoaGhoaGhoaGposzSHAAErMwwQ2HwRQ<br /> AAAAAElFTkSuQmCC"</span><span style="color: #007700">;<br /><br />    </span><span style="color: #0000BB">$imageBlob </span><span style="color: #007700">= </span><span style="color: #0000BB">base64_decode</span><span style="color: #007700">(</span><span style="color: #0000BB">$base64</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">readImageBlob</span><span style="color: #007700">(</span><span style="color: #0000BB">$imageBlob</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/readimageblob.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.readimageblob%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.readimageblob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimageblob.php">＋<small>add a note</small></a></span>
