...
<head>
  ...
  <title>PHP: ReflectionClass::getInterfaceNames - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getinterfacenames.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getinterfacenames.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getinterfacenames.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getfilename.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getinterfaces.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getinterfacenames.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getinterfacenames.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getinterfacenames.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getinterfacenames.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getinterfacenames.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getinterfacenames.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getinterfacenames.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getinterfacenames.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getinterfacenames.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getinterfacenames.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getinterfacenames.php" hreflang="zh">
...
<meta name="Description" content="Gets the interface names" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getInterfaceNames - Manual" />
<meta name="twitter:description" content="Gets the interface names" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getInterfaceNames - Manual" />
<meta itemprop="description" content="Gets the interface names" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the interface names" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.getinterfaces.php">
          ReflectionClass::getInterfaces &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getfilename.php">
          &laquo; ReflectionClass::getFileName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getinterfacenames.php' selected="selected">English</option>
            <option value='de/reflectionclass.getinterfacenames.php'>German</option>
            <option value='es/reflectionclass.getinterfacenames.php'>Spanish</option>
            <option value='fr/reflectionclass.getinterfacenames.php'>French</option>
            <option value='it/reflectionclass.getinterfacenames.php'>Italian</option>
            <option value='ja/reflectionclass.getinterfacenames.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getinterfacenames.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getinterfacenames.php'>Russian</option>
            <option value='tr/reflectionclass.getinterfacenames.php'>Turkish</option>
            <option value='uk/reflectionclass.getinterfacenames.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getinterfacenames.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getinterfacenames" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getinterfacenames-examples">
  ...
  <p class="para">
   <div class="example" id="example-5479">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::getInterfaceNames()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getinterfaces.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getInterfaces()</a> - Gets the interfaces</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getinterfacenames.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getinterfacenames%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getinterfacenames&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getinterfacenames.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103122">  <div class="votes">
    <div id="Vu103122">
    <a href="/manual/vote-note.php?id=103122&amp;page=reflectionclass.getinterfacenames&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103122">
    <a href="/manual/vote-note.php?id=103122&amp;page=reflectionclass.getinterfacenames&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103122" title="100% like this...">
    12
    </div>
  </div>
  <a href="#103122" class="name">
  <strong class="user"><em>pinpin</em></strong></a><a class="genanchor" href="#103122"> &para;</a><div class="date" title="2011-03-27 04:11"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103122">
<div class="phpcode"><code><span class="html">It seems the interface names are actually listed in a defined order:<br />- "extends" takes precedence over "implements" (i.e. first will be interfaces from (implemented in) the parent class (if any), then interfaces implemented in the class itself)<br />- when multiple interfaces are implemented at one time/level, it can be:<br />+ from an "implements" : they're listed in the defined order<br />+ from an "extends" (a class extends another class which implements multiple interfaces; or an interface extends multiple interfaces) : they're listed in REVERSE order<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">interface </span><span class="default">Foo </span><span class="keyword">{}<br />interface </span><span class="default">Bar </span><span class="keyword">{}<br />interface </span><span class="default">Other </span><span class="keyword">{}<br />interface </span><span class="default">Foobar </span><span class="keyword">extends </span><span class="default">Foo</span><span class="keyword">, </span><span class="default">Bar </span><span class="keyword">{}<br />interface </span><span class="default">Barfoo </span><span class="keyword">extends </span><span class="default">Bar</span><span class="keyword">, </span><span class="default">Foo </span><span class="keyword">{}<br /><br />class </span><span class="default">Test1 </span><span class="keyword">implements </span><span class="default">Foo</span><span class="keyword">, </span><span class="default">Bar </span><span class="keyword">{}<br />class </span><span class="default">Test2 </span><span class="keyword">implements </span><span class="default">Bar</span><span class="keyword">, </span><span class="default">Foo </span><span class="keyword">{}<br /><br />class </span><span class="default">Test3 </span><span class="keyword">extends </span><span class="default">Test1 </span><span class="keyword">{}<br />class </span><span class="default">Test4 </span><span class="keyword">extends </span><span class="default">Test2 </span><span class="keyword">{}<br /><br />class </span><span class="default">Test5 </span><span class="keyword">extends </span><span class="default">Test1 </span><span class="keyword">implements </span><span class="default">Other </span><span class="keyword">{}<br /><br />class </span><span class="default">Test6 </span><span class="keyword">implements </span><span class="default">Foobar</span><span class="keyword">, </span><span class="default">Other </span><span class="keyword">{}<br />class </span><span class="default">TestO </span><span class="keyword">implements </span><span class="default">Other </span><span class="keyword">{}<br />class </span><span class="default">Test7 </span><span class="keyword">extends </span><span class="default">TestO </span><span class="keyword">implements </span><span class="default">Barfoo </span><span class="keyword">{}<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test1'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Foo, Bar<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test2'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Bar, Foo<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test3'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Bar, Foo<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test4'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Foo, Bar<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test5'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Bar, Foo, Other<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test6'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Foobar, Bar, Foo, Other<br /><br /></span><span class="default">$r</span><span class="keyword">=new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Test7'</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getInterfaceNames</span><span class="keyword">()); </span><span class="comment">// Other, Barfoo, Foo, Bar<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="125202">  <div class="votes">
    <div id="Vu125202">
    <a href="/manual/vote-note.php?id=125202&amp;page=reflectionclass.getinterfacenames&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125202">
    <a href="/manual/vote-note.php?id=125202&amp;page=reflectionclass.getinterfacenames&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125202" title="100% like this...">
    3
    </div>
  </div>
  <a href="#125202" class="name">
  <strong class="user"><em>pvdhurk</em></strong></a><a class="genanchor" href="#125202"> &para;</a><div class="date" title="2020-07-23 12:43"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125202">
<div class="phpcode"><code><span class="html">For the record, it will return the full name (not the short name) for each Interface<br /><br />Example with namespace would've helped.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getinterfacenames&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getinterfacenames.php">＋<small>add a note</small></a></div>
