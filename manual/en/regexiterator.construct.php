...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/regexiterator.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/regexiterator.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/regexiterator.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.regexiterator.php">
 <link rel="prev" href="https://www.php.net/manual/en/regexiterator.accept.php">
 <link rel="next" href="https://www.php.net/manual/en/regexiterator.getflags.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/regexiterator.construct.php' selected="selected">English</option>
            ...
            <option value='zh/regexiterator.construct.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 description" id="refsect1-regexiterator.construct-description">
  ...
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>RegexIterator::__construct</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.iterator.php" class="type Iterator">Iterator</a></span> <code class="parameter">$iterator</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = RegexIterator::MATCH</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pregFlags</code><span class="initializer"> = 0</span></span><br>)</div>
...
<div class="refsect1 errors" id="refsect1-regexiterator.construct-errors">
 ...
 <div class="refsect1 examples" id="refsect1-regexiterator.construct-examples">
  ...
  <p class="para">
   <div class="example" id="example-3957">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.preg-split.php" class="function" rel="rdfs-seeAlso">preg_split()</a> - Split string by a regular expression</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/regexiterator/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fregexiterator.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=regexiterator.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexiterator.construct.php">＋<small>add a note</small></a></span>
