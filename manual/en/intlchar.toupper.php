...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.toupper.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.toupper.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.toupper.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.totitle.php">
 <link rel="next" href="https://www.php.net/manual/en/class.intlexception.php">
...
<meta name="Description" content="Make Unicode character uppercase" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::toupper - Manual" />
<meta name="twitter:description" content="Make Unicode character uppercase" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::toupper - Manual" />
<meta itemprop="description" content="Make Unicode character uppercase" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Make Unicode character uppercase" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.toupper.php' selected="selected">English</option>
            ...
            <option value='ru/intlchar.toupper.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::toupper</span> &mdash; <span class="dc-title">Make Unicode character uppercase</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.toupper-returnvalues">
  ...
  <p class="para">
   Returns the Simple_Uppercase_Mapping of the code point, if any;
 ...
 <div class="refsect1 examples" id="refsect1-intlchar.toupper-examples">
  ...
  <div class="example" id="example-2751">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-strtoupper.php" class="function" rel="rdfs-seeAlso">mb_strtoupper()</a> - Make a string uppercase</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/toupper.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.toupper%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.toupper&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.toupper.php">＋<small>add a note</small></a></span>
