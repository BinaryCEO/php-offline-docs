...
<head>
  ...
  <title>PHP: stream_set_chunk_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-set-chunk-size.php">
 <link rel="shorturl" href="https://www.php.net/stream-set-chunk-size">
 <link rel="alternate" href="https://www.php.net/stream-set-chunk-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-set-blocking.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-set-read-buffer.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-set-chunk-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-set-chunk-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-set-chunk-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-set-chunk-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-set-chunk-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-set-chunk-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-set-chunk-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-set-chunk-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-set-chunk-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-set-chunk-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-set-chunk-size.php" hreflang="zh">
...
<meta name="Description" content="Set the stream chunk size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_set_chunk_size - Manual" />
<meta name="twitter:description" content="Set the stream chunk size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_set_chunk_size - Manual" />
<meta itemprop="description" content="Set the stream chunk size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the stream chunk size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-set-read-buffer.php">
          stream_set_read_buffer &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-set-blocking.php">
          &laquo; stream_set_blocking        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-set-chunk-size.php' selected="selected">English</option>
            <option value='de/function.stream-set-chunk-size.php'>German</option>
            <option value='es/function.stream-set-chunk-size.php'>Spanish</option>
            <option value='fr/function.stream-set-chunk-size.php'>French</option>
            <option value='it/function.stream-set-chunk-size.php'>Italian</option>
            <option value='ja/function.stream-set-chunk-size.php'>Japanese</option>
            <option value='pt_BR/function.stream-set-chunk-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-set-chunk-size.php'>Russian</option>
            <option value='tr/function.stream-set-chunk-size.php'>Turkish</option>
            <option value='uk/function.stream-set-chunk-size.php'>Ukrainian</option>
            <option value='zh/function.stream-set-chunk-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-set-chunk-size" class="refentry">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-set-chunk-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-set-chunk-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-set-chunk-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-set-chunk-size.php">＋<small>add a note</small></a></span>
