...
<head>
  ...
  <title>PHP: Imagick::transformImageColorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.transformimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.transparentpaintimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.transformimagecolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.transformimagecolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.transformimagecolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.transformimagecolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.transformimagecolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.transformimagecolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.transformimagecolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.transformimagecolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.transformimagecolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.transformimagecolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.transformimagecolorspace.php" hreflang="zh">
...
<meta name="Description" content="Transforms an image to a new colorspace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::transformImageColorspace - Manual" />
<meta name="twitter:description" content="Transforms an image to a new colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::transformImageColorspace - Manual" />
<meta itemprop="description" content="Transforms an image to a new colorspace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Transforms an image to a new colorspace" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.transparentpaintimage.php">
          Imagick::transparentPaintImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.transformimage.php">
          &laquo; Imagick::transformImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.transformimagecolorspace.php' selected="selected">English</option>
            <option value='de/imagick.transformimagecolorspace.php'>German</option>
            <option value='es/imagick.transformimagecolorspace.php'>Spanish</option>
            <option value='fr/imagick.transformimagecolorspace.php'>French</option>
            <option value='it/imagick.transformimagecolorspace.php'>Italian</option>
            <option value='ja/imagick.transformimagecolorspace.php'>Japanese</option>
            <option value='pt_BR/imagick.transformimagecolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.transformimagecolorspace.php'>Russian</option>
            <option value='tr/imagick.transformimagecolorspace.php'>Turkish</option>
            <option value='uk/imagick.transformimagecolorspace.php'>Ukrainian</option>
            <option value='zh/imagick.transformimagecolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.transformimagecolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::transformImageColorspace</h1>

  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::transformImageColorspace</span> &mdash; <span class="dc-title">Transforms an image to a new colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.transformimagecolorspace-description">
  <h3 class="title">Description</h3>

  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::transformImageColorspace</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colorspace</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.transformimagecolorspace-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
       The colorspace the image should be transformed to, one of the <a href="imagick.constants.php#imagick.constants.colorspace" class="link">COLORSPACE constants</a> e.g. Imagick::COLORSPACE_CMYK.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.transformimagecolorspace-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.transformimagecolorspace-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="classname.methodname.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>Imagick::transformImageColorspace()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">transformImageColorspace</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">, </span><span style="color: #0000BB">$colorSpace</span><span style="color: #007700">, </span><span style="color: #0000BB">$channel</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">transformimagecolorspace</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorSpace</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">//channel should be one of the channel constants e.g. \Imagick::CHANNEL_BLUE <br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">separateImageChannel</span><span style="color: #007700">(</span><span style="color: #0000BB">$channel</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.transformimagecolorspace-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="methodname"><a href="imagick.setcolorspace.php" class="methodname" rel="rdfs-seeAlso">Imagick::setColorSpace()</a> - Set colorspace</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/transformimagecolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.transformimagecolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.transformimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transformimagecolorspace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117100">  <div class="votes">
    <div id="Vu117100">
    <a href="/manual/vote-note.php?id=117100&amp;page=imagick.transformimagecolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117100">
    <a href="/manual/vote-note.php?id=117100&amp;page=imagick.transformimagecolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117100" title="50% like this...">
    0
    </div>
  </div>
  <a href="#117100" class="name">
  <strong class="user"><em>A.Ross</em></strong></a><a class="genanchor" href="#117100"> &para;</a><div class="date" title="2015-04-15 07:31"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117100">
<div class="phpcode"><code><span class="html">This SO question and answer might help clarify why transformImageColorspace is useful: <a href="http://stackoverflow.com/questions/29296779/convert-pdf-with-transparency-and-cmyk-to-jpg" rel="nofollow" target="_blank">http://stackoverflow.com/questions/29296779/convert-pdf-with-transparency-and-cmyk-to-jpg</a><br /><br />Also, there's a Github issue here that explains the difference between transformImageColorspace and setImageColorspace: <a href="https://github.com/rmagick/rmagick/pull/75" rel="nofollow" target="_blank">https://github.com/rmagick/rmagick/pull/75</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.transformimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.transformimagecolorspace.php">＋<small>add a note</small></a></div>
