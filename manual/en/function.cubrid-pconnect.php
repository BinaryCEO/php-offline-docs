...
<head>
  ...
  <title>PHP: cubrid_pconnect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-pconnect.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-pconnect">
 <link rel="alternate" href="https://www.php.net/cubrid-pconnect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-num-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-pconnect-with-url.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-pconnect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-pconnect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-pconnect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-pconnect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-pconnect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-pconnect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-pconnect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-pconnect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-pconnect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-pconnect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-pconnect.php" hreflang="zh">
...
<meta name="Description" content="Open a persistent connection to a CUBRID server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_pconnect - Manual" />
<meta name="twitter:description" content="Open a persistent connection to a CUBRID server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_pconnect - Manual" />
<meta itemprop="description" content="Open a persistent connection to a CUBRID server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a persistent connection to a CUBRID server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-pconnect-with-url.php">
          cubrid_pconnect_with_url &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-num-rows.php">
          &laquo; cubrid_num_rows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-pconnect.php' selected="selected">English</option>
            <option value='de/function.cubrid-pconnect.php'>German</option>
            <option value='es/function.cubrid-pconnect.php'>Spanish</option>
            <option value='fr/function.cubrid-pconnect.php'>French</option>
            <option value='it/function.cubrid-pconnect.php'>Italian</option>
            <option value='ja/function.cubrid-pconnect.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-pconnect.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-pconnect.php'>Russian</option>
            <option value='tr/function.cubrid-pconnect.php'>Turkish</option>
            <option value='uk/function.cubrid-pconnect.php'>Ukrainian</option>
            <option value='zh/function.cubrid-pconnect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-pconnect" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-pconnect-description">
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.cubrid-connect.php" class="function">cubrid_connect()</a></span> with two major differences. 
  </p>
  <p class="para">
 ...
 <p class="para">
  <dl>
    ...
    <dd><p class="para">Host name or IP address of CUBRID CAS server.</p></dd>
   
   
    <dt><code class="parameter">port</code></dt>
    <dd><p class="para">Port number of CUBRID CAS server (BROKER_PORT configured in $CUBRID/conf/cubrid_broker.conf).</p></dd>
   
   
    <dt><code class="parameter">dbname</code></dt>
    <dd><p class="para">Name of database.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-pconnect-examples">
  ...
  <div class="example" id="example-1266">
   <p><strong>Example #1 <span class="function"><a href="function.cubrid-connect.php" class="function">cubrid_connect()</a></span> example</strong></p>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-close.php" class="function" rel="rdfs-seeAlso">cubrid_close()</a> - Close CUBRID connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-pconnect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-pconnect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-pconnect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-pconnect.php">＋<small>add a note</small></a></span>
