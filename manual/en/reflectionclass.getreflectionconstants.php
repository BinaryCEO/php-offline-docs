...
<head>
  ...
  <title>PHP: ReflectionClass::getReflectionConstants - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstant.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getshortname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getreflectionconstants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getreflectionconstants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getreflectionconstants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getreflectionconstants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getreflectionconstants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getreflectionconstants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getreflectionconstants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getreflectionconstants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getreflectionconstants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getreflectionconstants.php" hreflang="zh">
...
<meta name="Description" content="Gets class constants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getReflectionConstants - Manual" />
<meta name="twitter:description" content="Gets class constants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getReflectionConstants - Manual" />
<meta itemprop="description" content="Gets class constants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets class constants" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getshortname.php">
          ReflectionClass::getShortName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getreflectionconstant.php">
          &laquo; ReflectionClass::getReflectionConstant        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getreflectionconstants.php' selected="selected">English</option>
            <option value='de/reflectionclass.getreflectionconstants.php'>German</option>
            <option value='es/reflectionclass.getreflectionconstants.php'>Spanish</option>
            <option value='fr/reflectionclass.getreflectionconstants.php'>French</option>
            <option value='it/reflectionclass.getreflectionconstants.php'>Italian</option>
            <option value='ja/reflectionclass.getreflectionconstants.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getreflectionconstants.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getreflectionconstants.php'>Russian</option>
            <option value='tr/reflectionclass.getreflectionconstants.php'>Turkish</option>
            <option value='uk/reflectionclass.getreflectionconstants.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getreflectionconstants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getreflectionconstants" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getReflectionConstants</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.1.0, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getReflectionConstants</span> &mdash; <span class="dc-title">Gets class constants</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getreflectionconstants-returnvalues">
  ...
  <p class="para">
   An array of <span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span> objects.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getreflectionconstants-examples">
  ...
  <div class="example" id="reflectionclass.getreflectionconstants.example">
   <p><strong>Example #1 Basic <span class="function"><strong>ReflectionClass::getReflectionConstants()</strong></span> example</strong></p>
...
array(3) {
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getreflectionconstants-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getreflectionconstant.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getReflectionConstant()</a> - Gets a ReflectionClassConstant for a class's constant</span></li>
    <li><span class="classname"><a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getreflectionconstants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getreflectionconstants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getreflectionconstants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getreflectionconstants.php">＋<small>add a note</small></a></span>
