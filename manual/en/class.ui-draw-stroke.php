...
<head>
  ...
  <title>PHP: UI\Draw\Stroke - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-stroke.php">
 <link rel="shorturl" href="https://www.php.net/ui-draw-stroke">
 <link rel="alternate" href="https://www.php.net/ui-draw-stroke" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-draw-color.setchannel.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-draw-stroke.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-draw-stroke.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-draw-stroke.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-draw-stroke.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-draw-stroke.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-draw-stroke.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-draw-stroke.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-draw-stroke.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-draw-stroke.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-draw-stroke.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-draw-stroke.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-draw-stroke.php" hreflang="zh">
...
<meta name="Description" content="Draw Stroke" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Draw\Stroke - Manual" />
<meta name="twitter:description" content="Draw Stroke" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Stroke - Manual" />
<meta itemprop="description" content="Draw Stroke" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draw Stroke" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-draw-stroke.construct.php">
          UI\Draw\Stroke::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-draw-color.setchannel.php">
          &laquo; UI\Draw\Color::setChannel        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-stroke.php' selected="selected">English</option>
            <option value='de/class.ui-draw-stroke.php'>German</option>
            <option value='es/class.ui-draw-stroke.php'>Spanish</option>
            <option value='fr/class.ui-draw-stroke.php'>French</option>
            <option value='it/class.ui-draw-stroke.php'>Italian</option>
            <option value='ja/class.ui-draw-stroke.php'>Japanese</option>
            <option value='pt_BR/class.ui-draw-stroke.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-draw-stroke.php'>Russian</option>
            <option value='tr/class.ui-draw-stroke.php'>Turkish</option>
            <option value='uk/class.ui-draw-stroke.php'>Ukrainian</option>
            <option value='zh/class.ui-draw-stroke.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-draw-stroke" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-draw-stroke.construct.php">UI\Draw\Stroke::__construct</a> — Construct a new Stroke</li><li><a href="ui-draw-stroke.getcap.php">UI\Draw\Stroke::getCap</a> — Get Line Cap</li><li><a href="ui-draw-stroke.getjoin.php">UI\Draw\Stroke::getJoin</a> — Get Line Join</li><li><a href="ui-draw-stroke.getmiterlimit.php">UI\Draw\Stroke::getMiterLimit</a> — Get Miter Limit</li><li><a href="ui-draw-stroke.getthickness.php">UI\Draw\Stroke::getThickness</a> — Get Thickness</li><li><a href="ui-draw-stroke.setcap.php">UI\Draw\Stroke::setCap</a> — Set Line Cap</li><li><a href="ui-draw-stroke.setjoin.php">UI\Draw\Stroke::setJoin</a> — Set Line Join</li><li><a href="ui-draw-stroke.setmiterlimit.php">UI\Draw\Stroke::setMiterLimit</a> — Set Miter Limit</li><li><a href="ui-draw-stroke.setthickness.php">UI\Draw\Stroke::setThickness</a> — Set Thickness</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.stroke.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-stroke%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-stroke&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-stroke.php">＋<small>add a note</small></a></span>
