...
<head>
  ...
  <title>PHP: ps_curveto - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-curveto.php">
 <link rel="shorturl" href="https://www.php.net/ps-curveto">
 <link rel="alternate" href="https://www.php.net/ps-curveto" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-continue-text.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-curveto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-curveto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-curveto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-curveto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-curveto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-curveto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-curveto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-curveto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-curveto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-curveto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-curveto.php" hreflang="zh">
...
<meta name="Description" content="Draws a curve" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_curveto - Manual" />
<meta name="twitter:description" content="Draws a curve" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_curveto - Manual" />
<meta itemprop="description" content="Draws a curve" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a curve" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-delete.php">
          ps_delete &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-continue-text.php">
          &laquo; ps_continue_text        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-curveto.php' selected="selected">English</option>
            <option value='de/function.ps-curveto.php'>German</option>
            <option value='es/function.ps-curveto.php'>Spanish</option>
            <option value='fr/function.ps-curveto.php'>French</option>
            <option value='it/function.ps-curveto.php'>Italian</option>
            <option value='ja/function.ps-curveto.php'>Japanese</option>
            <option value='pt_BR/function.ps-curveto.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-curveto.php'>Russian</option>
            <option value='tr/function.ps-curveto.php'>Turkish</option>
            <option value='uk/function.ps-curveto.php'>Ukrainian</option>
            <option value='zh/function.ps-curveto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-curveto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_curveto</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_curveto</span> &mdash; <span class="dc-title">Draws a curve</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-curveto-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_curveto</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x3</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y3</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-curveto-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">x3</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">y3</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-curveto-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-curveto-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-lineto.php" class="function" rel="rdfs-seeAlso">ps_lineto()</a> - Draws a line</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-curveto.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-curveto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-curveto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-curveto.php">＋<small>add a note</small></a></span>
