...
<head>
  ...
  <title>PHP: fann_read_train_from_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-read-train-from-file.php">
 <link rel="shorturl" href="https://www.php.net/fann-read-train-from-file">
 <link rel="alternate" href="https://www.php.net/fann-read-train-from-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-randomize-weights.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-reset-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-read-train-from-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-read-train-from-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-read-train-from-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-read-train-from-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-read-train-from-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-read-train-from-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-read-train-from-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-read-train-from-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-read-train-from-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-read-train-from-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-read-train-from-file.php" hreflang="zh">
...
<meta name="Description" content="Reads a file that stores training data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_read_train_from_file - Manual" />
<meta name="twitter:description" content="Reads a file that stores training data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_read_train_from_file - Manual" />
<meta itemprop="description" content="Reads a file that stores training data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads a file that stores training data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-reset-errno.php">
          fann_reset_errno &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-randomize-weights.php">
          &laquo; fann_randomize_weights        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-read-train-from-file.php' selected="selected">English</option>
            <option value='de/function.fann-read-train-from-file.php'>German</option>
            <option value='es/function.fann-read-train-from-file.php'>Spanish</option>
            <option value='fr/function.fann-read-train-from-file.php'>French</option>
            <option value='it/function.fann-read-train-from-file.php'>Italian</option>
            <option value='ja/function.fann-read-train-from-file.php'>Japanese</option>
            <option value='pt_BR/function.fann-read-train-from-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-read-train-from-file.php'>Russian</option>
            <option value='tr/function.fann-read-train-from-file.php'>Turkish</option>
            <option value='uk/function.fann-read-train-from-file.php'>Ukrainian</option>
            <option value='zh/function.fann-read-train-from-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-read-train-from-file" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-save-train.php" class="function" rel="rdfs-seeAlso">fann_save_train()</a> - Save the training structure to a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-read-train-from-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-read-train-from-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-read-train-from-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-read-train-from-file.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120734">  <div class="votes">
    <div id="Vu120734">
    <a href="/manual/vote-note.php?id=120734&amp;page=function.fann-read-train-from-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120734">
    <a href="/manual/vote-note.php?id=120734&amp;page=function.fann-read-train-from-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120734" title="no votes...">
    0
    </div>
  </div>
  <a href="#120734" class="name">
  <strong class="user"><em>Ray.Paseur sometimes uses Gmail</em></strong></a><a class="genanchor" href="#120734"> &para;</a><div class="date" title="2017-03-03 08:40"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120734">
<div class="phpcode"><code><span class="html">An explanation of the values used in xor.data is available here:<br /><a href="http://php.net/manual/en/fann.examples-1.php#117242" rel="nofollow" target="_blank">http://php.net/manual/en/fann.examples-1.php#117242</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-read-train-from-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-read-train-from-file.php">＋<small>add a note</small></a></div>
