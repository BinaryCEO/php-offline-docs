...
<head>
  ...
  <title>PHP: oci_set_client_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-set-client-info.php">
 <link rel="shorturl" href="https://www.php.net/oci-set-client-info">
 <link rel="alternate" href="https://www.php.net/oci-set-client-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-set-client-identifier.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-set-db-operation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-set-client-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-set-client-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-set-client-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-set-client-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-set-client-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-set-client-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-set-client-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-set-client-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-set-client-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-set-client-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-set-client-info.php" hreflang="zh">
...
<meta name="Description" content="Sets the client information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_set_client_info - Manual" />
<meta name="twitter:description" content="Sets the client information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_set_client_info - Manual" />
<meta itemprop="description" content="Sets the client information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the client information" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.oci-set-db-operation.php">
          oci_set_db_operation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-set-client-identifier.php">
          &laquo; oci_set_client_identifier        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-set-client-info.php' selected="selected">English</option>
            <option value='de/function.oci-set-client-info.php'>German</option>
            <option value='es/function.oci-set-client-info.php'>Spanish</option>
            <option value='fr/function.oci-set-client-info.php'>French</option>
            <option value='it/function.oci-set-client-info.php'>Italian</option>
            <option value='ja/function.oci-set-client-info.php'>Japanese</option>
            <option value='pt_BR/function.oci-set-client-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-set-client-info.php'>Russian</option>
            <option value='tr/function.oci-set-client-info.php'>Turkish</option>
            <option value='uk/function.oci-set-client-info.php'>Ukrainian</option>
            <option value='zh/function.oci-set-client-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-set-client-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_set_client_info</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.2, PHP 7, PHP 8, PECL OCI8 &gt;= 1.4.0)</p><p class="refpurpose"><span class="refname">oci_set_client_info</span> &mdash; <span class="dc-title">Sets the client information</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.oci-set-client-info-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_set_client_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$client_info</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   administration views such as <code class="literal">V$SESSION</code>.
  </p>
  <p class="para">
...
or <span class="function"><a href="function.oci-new-connect.php" class="function">oci_new_connect()</a></span>.</p>
     ...
     <dt><code class="parameter">client_info</code></dt>
     <dd>
      <p class="para">
...
using <span class="function"><strong>oci_set_client_info()</strong></span>.</p></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-set-db-operation.php" class="function" rel="rdfs-seeAlso">oci_set_db_operation()</a> - Sets the database operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-set-client-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-set-client-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-set-client-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-client-info.php">＋<small>add a note</small></a></span>
