...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-test-data.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-test.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-train.php">
...
<meta name="Description" content="Test a set of training data and calculates the MSE for the training data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_test_data - Manual" />
<meta name="twitter:description" content="Test a set of training data and calculates the MSE for the training data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_test_data - Manual" />
<meta itemprop="description" content="Test a set of training data and calculates the MSE for the training data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Test a set of training data and calculates the MSE for the training data" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-test-data.php' selected="selected">English</option>
            ...
            <option value='ru/function.fann-test-data.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_test_data</span> &mdash; <span class="dc-title">Test a set of training data and calculates the MSE for the training data</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-test-data-returnvalues">
  ...
  <p class="para">
   The updated MSE, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-training-algorithm.php" class="function" rel="rdfs-seeAlso">fann_set_training_algorithm()</a> - Sets the training algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-test-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-test-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-test-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-test-data.php">＋<small>add a note</small></a></span>
