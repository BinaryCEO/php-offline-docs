...
<head>
  ...
  <title>PHP: Phar::compressFiles - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.compressfiles.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.compressfiles.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.compressfiles.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.compress.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.compressfiles.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.compressfiles.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.compressfiles.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.compressfiles.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.compressfiles.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.compressfiles.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.compressfiles.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.compressfiles.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.compressfiles.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.compressfiles.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.compressfiles.php" hreflang="zh">
...
<meta name="Description" content="Compresses all files in the current Phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::compressFiles - Manual" />
<meta name="twitter:description" content="Compresses all files in the current Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::compressFiles - Manual" />
<meta itemprop="description" content="Compresses all files in the current Phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compresses all files in the current Phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.construct.php">
          Phar::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.compress.php">
          &laquo; Phar::compress        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.compressfiles.php' selected="selected">English</option>
            <option value='de/phar.compressfiles.php'>German</option>
            <option value='es/phar.compressfiles.php'>Spanish</option>
            <option value='fr/phar.compressfiles.php'>French</option>
            <option value='it/phar.compressfiles.php'>Italian</option>
            <option value='ja/phar.compressfiles.php'>Japanese</option>
            <option value='pt_BR/phar.compressfiles.php'>Brazilian Portuguese</option>
            <option value='ru/phar.compressfiles.php'>Russian</option>
            <option value='tr/phar.compressfiles.php'>Turkish</option>
            <option value='uk/phar.compressfiles.php'>Ukrainian</option>
            <option value='zh/phar.compressfiles.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.compressfiles" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::compressFiles</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::compressFiles</span> &mdash; <span class="dc-title">Compresses all files in the current Phar archive</span></p>
 ...
 <div class="refsect1 description" id="refsect1-phar.compressfiles-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::compressFiles</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compression</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  ...
  <p class="para">
   ...
   <span class="function"><a href="phar.compress.php" class="function">Phar::compress()</a></span> to compress an entire tar-based phar archive.
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-phar.compressfiles-examples">
  ...
  <p class="para">
   <div class="example" id="example-807">
    <p><strong>Example #1 A <span class="function"><strong>Phar::compressFiles()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.decompress.php" class="function" rel="rdfs-seeAlso">Phar::decompress()</a> - Decompresses the entire Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/compressFiles.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.compressfiles%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.compressfiles&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.compressfiles.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103735">  <div class="votes">
    <div id="Vu103735">
    <a href="/manual/vote-note.php?id=103735&amp;page=phar.compressfiles&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103735">
    <a href="/manual/vote-note.php?id=103735&amp;page=phar.compressfiles&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103735" title="100% like this...">
    3
    </div>
  </div>
  <a href="#103735" class="name">
  <strong class="user"><em>alex at phpguide dot co dot il</em></strong></a><a class="genanchor" href="#103735"> &para;</a><div class="date" title="2011-04-30 01:55"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103735">
<div class="phpcode"><code><span class="html">Compressing the entire archive
<br />$phar-&gt;compress();
<br />overrides your stub file.
<br />
<br />Use compressFiles to have the the files compressed keeping your own stub in tact (which is not being compressed).
<br />The compression is a little bit worth (since one file is left uncompressed), but enables you to have your own stub file executed with browser requests.
<br />
<br />Don't get confused, compressing doesn't rise the security level of your code or obfuscating it strongly enough. The source code of your compressed phar is still easy to read.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.compressfiles&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.compressfiles.php">＋<small>add a note</small></a></div>
