...
<head>
  ...
  <title>PHP: Imagick::getImageHeight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageheight.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageheight.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageheight.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagegreenprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagehistogram.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageheight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageheight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageheight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageheight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageheight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageheight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageheight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageheight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageheight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageheight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageheight.php" hreflang="zh">
...
<meta name="Description" content="Returns the image height" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageHeight - Manual" />
<meta name="twitter:description" content="Returns the image height" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageHeight - Manual" />
<meta itemprop="description" content="Returns the image height" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image height" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagehistogram.php">
          Imagick::getImageHistogram &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagegreenprimary.php">
          &laquo; Imagick::getImageGreenPrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageheight.php' selected="selected">English</option>
            <option value='de/imagick.getimageheight.php'>German</option>
            <option value='es/imagick.getimageheight.php'>Spanish</option>
            <option value='fr/imagick.getimageheight.php'>French</option>
            <option value='it/imagick.getimageheight.php'>Italian</option>
            <option value='ja/imagick.getimageheight.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageheight.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageheight.php'>Russian</option>
            <option value='tr/imagick.getimageheight.php'>Turkish</option>
            <option value='uk/imagick.getimageheight.php'>Ukrainian</option>
            <option value='zh/imagick.getimageheight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageheight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageHeight</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageHeight</span> &mdash; <span class="dc-title">Returns the image height</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageheight-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageHeight</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageheight-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageheight-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageheight-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageheight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageheight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageheight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageheight.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="78272">  <div class="votes">
    <div id="Vu78272">
    <a href="/manual/vote-note.php?id=78272&amp;page=imagick.getimageheight&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78272">
    <a href="/manual/vote-note.php?id=78272&amp;page=imagick.getimageheight&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78272" title="69% like this...">
    5
    </div>
  </div>
  <a href="#78272" class="name">
  <strong class="user"><em>perching_eagle at yahoo dot com</em></strong></a><a class="genanchor" href="#78272"> &para;</a><div class="date" title="2007-10-04 06:19"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78272">
<div class="phpcode"><code><span class="html">//file location c:/htdocs/rose.jpg<br />$image=new Imagick("c:/htdocs/rose.jpg");<br />$height=$image-&gt;getImageHeight();<br />print "the image height is ".$height;<br /><br />result:<br />the image height is 134</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageheight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageheight.php">＋<small>add a note</small></a></div>
