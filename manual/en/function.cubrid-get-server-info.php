...
<head>
  ...
  <title>PHP: cubrid_get_server_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-server-info.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-server-info">
 <link rel="alternate" href="https://www.php.net/cubrid-get-server-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-query-timeout.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-insert-id.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-server-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-server-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-server-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-server-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-server-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-server-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-server-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-server-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-server-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-server-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-server-info.php" hreflang="zh">
...
<meta name="Description" content="Return the CUBRID server version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get_server_info - Manual" />
<meta name="twitter:description" content="Return the CUBRID server version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_server_info - Manual" />
<meta itemprop="description" content="Return the CUBRID server version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the CUBRID server version" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-insert-id.php">
          cubrid_insert_id &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-query-timeout.php">
          &laquo; cubrid_get_query_timeout        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-server-info.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-server-info.php'>German</option>
            <option value='es/function.cubrid-get-server-info.php'>Spanish</option>
            <option value='fr/function.cubrid-get-server-info.php'>French</option>
            <option value='it/function.cubrid-get-server-info.php'>Italian</option>
            <option value='ja/function.cubrid-get-server-info.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-server-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-server-info.php'>Russian</option>
            <option value='tr/function.cubrid-get-server-info.php'>Turkish</option>
            <option value='uk/function.cubrid-get-server-info.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-server-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-server-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_get_server_info</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_get_server_info</span> &mdash; <span class="dc-title">Return the CUBRID server version</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-get-server-info-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_get_server_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-get-server-info-parameters">
 <h3 class="title">Parameters</h3>
 <p class="para">
  <dl>
    
  <dt><code class="parameter">conn_identifier</code></dt>
  <dd><p class="para">The CUBRID connection.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-get-server-info-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A string that represents the CUBRID server version on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.cubrid-get-server-info-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1243">
   <p><strong>Example #1 <span class="function"><strong>cubrid_get_server_info()</strong></span> example</strong></p>
...
CUBRID Charset:                iso8859-1</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-server-info.php">＋<small>add a note</small></a></span>
