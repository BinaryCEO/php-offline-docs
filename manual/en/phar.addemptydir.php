...
<head>
  ...
  <title>PHP: Phar::addEmptyDir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.addemptydir.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.addemptydir.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.addemptydir.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.addfile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.addemptydir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.addemptydir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.addemptydir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.addemptydir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.addemptydir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.addemptydir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.addemptydir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.addemptydir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.addemptydir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.addemptydir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.addemptydir.php" hreflang="zh">
...
<meta name="Description" content="Add an empty directory to the phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::addEmptyDir - Manual" />
<meta name="twitter:description" content="Add an empty directory to the phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::addEmptyDir - Manual" />
<meta itemprop="description" content="Add an empty directory to the phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add an empty directory to the phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.addfile.php">
          Phar::addFile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.phar.php">
          &laquo; Phar        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.addemptydir.php' selected="selected">English</option>
            <option value='de/phar.addemptydir.php'>German</option>
            <option value='es/phar.addemptydir.php'>Spanish</option>
            <option value='fr/phar.addemptydir.php'>French</option>
            <option value='it/phar.addemptydir.php'>Italian</option>
            <option value='ja/phar.addemptydir.php'>Japanese</option>
            <option value='pt_BR/phar.addemptydir.php'>Brazilian Portuguese</option>
            <option value='ru/phar.addemptydir.php'>Russian</option>
            <option value='tr/phar.addemptydir.php'>Turkish</option>
            <option value='uk/phar.addemptydir.php'>Ukrainian</option>
            <option value='zh/phar.addemptydir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.addemptydir" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::addEmptyDir</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::addEmptyDir</span> &mdash; <span class="dc-title">Add an empty directory to the phar archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.addemptydir-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::addEmptyDir</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$directory</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.addemptydir-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.addemptydir-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-phar.addemptydir-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-797">
    <p><strong>Example #1 A <span class="function"><strong>Phar::addEmptyDir()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$a </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/phar.phar'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addEmptyDir</span><span style="color: #007700">(</span><span style="color: #DD0000">'/full/path/to/file'</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// demonstrates how this file is stored<br />    </span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'full/path/to/file'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">isDir</span><span style="color: #007700">();<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle errors here<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.addemptydir-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.addfromstring.php" class="function" rel="rdfs-seeAlso">Phar::addFromString()</a> - Add a file from a string to the phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/addEmptyDir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.addemptydir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.addemptydir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.addemptydir.php">＋<small>add a note</small></a></span>
