...
<head>
  ...
  <title>PHP: odbc_rollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-rollback.php">
 <link rel="shorturl" href="https://www.php.net/odbc-rollback">
 <link rel="alternate" href="https://www.php.net/odbc-rollback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-result-all.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-setoption.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-rollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-rollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-rollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-rollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-rollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-rollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-rollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-rollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-rollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-rollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-rollback.php" hreflang="zh">
...
<meta name="Description" content="Rollback a transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_rollback - Manual" />
<meta name="twitter:description" content="Rollback a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_rollback - Manual" />
<meta itemprop="description" content="Rollback a transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rollback a transaction" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-setoption.php">
          odbc_setoption &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-result-all.php">
          &laquo; odbc_result_all        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-rollback.php' selected="selected">English</option>
            <option value='de/function.odbc-rollback.php'>German</option>
            <option value='es/function.odbc-rollback.php'>Spanish</option>
            <option value='fr/function.odbc-rollback.php'>French</option>
            <option value='it/function.odbc-rollback.php'>Italian</option>
            <option value='ja/function.odbc-rollback.php'>Japanese</option>
            <option value='pt_BR/function.odbc-rollback.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-rollback.php'>Russian</option>
            <option value='tr/function.odbc-rollback.php'>Turkish</option>
            <option value='uk/function.odbc-rollback.php'>Ukrainian</option>
            <option value='zh/function.odbc-rollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-rollback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_rollback</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_rollback</span> &mdash; <span class="dc-title">Rollback a transaction</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-rollback-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_rollback</strong></span>(<span class="methodparam"><span class="type">Odbc\Connection</span> <code class="parameter">$odbc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.odbc-rollback-parameters">
...
see <span class="function"><a href="function.odbc-connect.php" class="function">odbc_connect()</a></span> for details.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-rollback-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.odbc-rollback-changelog">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-rollback.php">＋<small>add a note</small></a></span>
