...
<head>
  ...
  <title>PHP: radius_put_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-put-string.php">
 <link rel="shorturl" href="https://www.php.net/radius-put-string">
 <link rel="alternate" href="https://www.php.net/radius-put-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-put-int.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-put-vendor-addr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-put-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-put-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-put-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-put-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-put-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-put-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-put-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-put-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-put-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-put-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-put-string.php" hreflang="zh">
...
<meta name="Description" content="Attaches a string attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_put_string - Manual" />
<meta name="twitter:description" content="Attaches a string attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_put_string - Manual" />
<meta itemprop="description" content="Attaches a string attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Attaches a string attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.radius-put-vendor-addr.php">
          radius_put_vendor_addr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-put-int.php">
          &laquo; radius_put_int        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-put-string.php' selected="selected">English</option>
            <option value='de/function.radius-put-string.php'>German</option>
            <option value='es/function.radius-put-string.php'>Spanish</option>
            <option value='fr/function.radius-put-string.php'>French</option>
            <option value='it/function.radius-put-string.php'>Italian</option>
            <option value='ja/function.radius-put-string.php'>Japanese</option>
            <option value='pt_BR/function.radius-put-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-put-string.php'>Russian</option>
            <option value='tr/function.radius-put-string.php'>Turkish</option>
            <option value='uk/function.radius-put-string.php'>Ukrainian</option>
            <option value='zh/function.radius-put-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-put-string" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.radius-put-vendor-string.php" class="function" rel="rdfs-seeAlso">radius_put_vendor_string()</a> - Attaches a vendor specific string attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-put-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-put-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-put-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-put-string.php">＋<small>add a note</small></a></span>
