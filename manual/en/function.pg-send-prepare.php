...
<head>
  ...
  <title>PHP: pg_send_prepare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-send-prepare.php">
 <link rel="shorturl" href="https://www.php.net/pg-send-prepare">
 <link rel="alternate" href="https://www.php.net/pg-send-prepare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-send-execute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-send-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-send-prepare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-send-prepare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-send-prepare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-send-prepare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-send-prepare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-send-prepare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-send-prepare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-send-prepare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-send-prepare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-send-prepare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-send-prepare.php" hreflang="zh">
...
<meta name="Description" content="Sends a request to create a prepared statement with the given parameters, without waiting for completion" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_send_prepare - Manual" />
<meta name="twitter:description" content="Sends a request to create a prepared statement with the given parameters, without waiting for completion" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_send_prepare - Manual" />
<meta itemprop="description" content="Sends a request to create a prepared statement with the given parameters, without waiting for completion" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sends a request to create a prepared statement with the given parameters, without waiting for completion" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-send-prepare.php' selected="selected">English</option>
            <option value='de/function.pg-send-prepare.php'>German</option>
            <option value='es/function.pg-send-prepare.php'>Spanish</option>
            <option value='fr/function.pg-send-prepare.php'>French</option>
            <option value='it/function.pg-send-prepare.php'>Italian</option>
            <option value='ja/function.pg-send-prepare.php'>Japanese</option>
            <option value='pt_BR/function.pg-send-prepare.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-send-prepare.php'>Russian</option>
            <option value='tr/function.pg-send-prepare.php'>Turkish</option>
            <option value='uk/function.pg-send-prepare.php'>Ukrainian</option>
            <option value='zh/function.pg-send-prepare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-send-prepare" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-send-query-params.php" class="function" rel="rdfs-seeAlso">pg_send_query_params()</a> - Submits a command and separate parameters to the server without waiting for the result(s)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-send-prepare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-send-prepare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-send-prepare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-send-prepare.php">＋<small>add a note</small></a></span>
