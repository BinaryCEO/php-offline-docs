...
<head>
  ...
  <title>PHP: ps_setlinecap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setlinecap.php">
 <link rel="shorturl" href="https://www.php.net/ps-setlinecap">
 <link rel="alternate" href="https://www.php.net/ps-setlinecap" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setgray.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setlinejoin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setlinecap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setlinecap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setlinecap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setlinecap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setlinecap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setlinecap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setlinecap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setlinecap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setlinecap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setlinecap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setlinecap.php" hreflang="zh">
...
<meta name="Description" content="Sets appearance of line ends" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setlinecap - Manual" />
<meta name="twitter:description" content="Sets appearance of line ends" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setlinecap - Manual" />
<meta itemprop="description" content="Sets appearance of line ends" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets appearance of line ends" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-setlinejoin.php">
          ps_setlinejoin &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setlinecap.php' selected="selected">English</option>
            <option value='de/function.ps-setlinecap.php'>German</option>
            <option value='es/function.ps-setlinecap.php'>Spanish</option>
            <option value='fr/function.ps-setlinecap.php'>French</option>
            <option value='it/function.ps-setlinecap.php'>Italian</option>
            <option value='ja/function.ps-setlinecap.php'>Japanese</option>
            <option value='pt_BR/function.ps-setlinecap.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setlinecap.php'>Russian</option>
            <option value='tr/function.ps-setlinecap.php'>Turkish</option>
            <option value='uk/function.ps-setlinecap.php'>Ukrainian</option>
            <option value='zh/function.ps-setlinecap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setlinecap" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setlinecap</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setlinecap</span> &mdash; <span class="dc-title">Sets appearance of line ends</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setlinecap-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setlinecap</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setlinecap-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <code class="literal">PS_LINECAP_BUTT</code>,
       <code class="literal">PS_LINECAP_ROUND</code>, or
       <code class="literal">PS_LINECAP_SQUARED</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setlinecap-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setlinecap-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setmiterlimit.php" class="function" rel="rdfs-seeAlso">ps_setmiterlimit()</a> - Sets the miter limit</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setlinecap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setlinecap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setlinecap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setlinecap.php">＋<small>add a note</small></a></span>
