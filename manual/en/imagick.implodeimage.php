...
<head>
  ...
  <title>PHP: Imagick::implodeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.implodeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.implodeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.implodeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.identifyimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.importimagepixels.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.implodeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.implodeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.implodeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.implodeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.implodeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.implodeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.implodeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.implodeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.implodeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.implodeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.implodeimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a new image as a copy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::implodeImage - Manual" />
<meta name="twitter:description" content="Creates a new image as a copy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::implodeImage - Manual" />
<meta itemprop="description" content="Creates a new image as a copy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new image as a copy" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.importimagepixels.php">
          Imagick::importImagePixels &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.identifyimage.php">
          &laquo; Imagick::identifyImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.implodeimage.php' selected="selected">English</option>
            <option value='de/imagick.implodeimage.php'>German</option>
            <option value='es/imagick.implodeimage.php'>Spanish</option>
            <option value='fr/imagick.implodeimage.php'>French</option>
            <option value='it/imagick.implodeimage.php'>Italian</option>
            <option value='ja/imagick.implodeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.implodeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.implodeimage.php'>Russian</option>
            <option value='tr/imagick.implodeimage.php'>Turkish</option>
            <option value='uk/imagick.implodeimage.php'>Ukrainian</option>
            <option value='zh/imagick.implodeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.implodeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::implodeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::implodeImage</span> &mdash; <span class="dc-title">Creates a new image as a copy</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.implodeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::implodeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.implodeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.implodeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.implodeimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3022">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/implodeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.implodeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.implodeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.implodeimage.php">＋<small>add a note</small></a></span>
