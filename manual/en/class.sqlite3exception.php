...
<head>
  ...
  <title>PHP: SQLite3Exception - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.sqlite3exception.php">
 <link rel="shorturl" href="https://www.php.net/sqlite3exception">
 <link rel="alternate" href="https://www.php.net/sqlite3exception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.version.php">
 <link rel="next" href="https://www.php.net/manual/en/class.sqlite3stmt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.sqlite3exception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.sqlite3exception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.sqlite3exception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.sqlite3exception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.sqlite3exception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.sqlite3exception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.sqlite3exception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.sqlite3exception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.sqlite3exception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.sqlite3exception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.sqlite3exception.php" hreflang="zh">
...
<meta name="Description" content="The SQLite3Exception class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3Exception - Manual" />
<meta name="twitter:description" content="The SQLite3Exception class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3Exception - Manual" />
<meta itemprop="description" content="The SQLite3Exception class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SQLite3Exception class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.sqlite3exception.php' selected="selected">English</option>
            <option value='de/class.sqlite3exception.php'>German</option>
            <option value='es/class.sqlite3exception.php'>Spanish</option>
            <option value='fr/class.sqlite3exception.php'>French</option>
            <option value='it/class.sqlite3exception.php'>Italian</option>
            <option value='ja/class.sqlite3exception.php'>Japanese</option>
            <option value='pt_BR/class.sqlite3exception.php'>Brazilian Portuguese</option>
            <option value='ru/class.sqlite3exception.php'>Russian</option>
            <option value='tr/class.sqlite3exception.php'>Turkish</option>
            <option value='uk/class.sqlite3exception.php'>Ukrainian</option>
            <option value='zh/class.sqlite3exception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.sqlite3exception" class="reference">
 <h1 class="title">The SQLite3Exception class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="sqlite3exception.intro">
  ...
  <div class="section" id="sqlite3exception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">SQLite3Exception</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3exception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.sqlite3exception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.sqlite3exception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.sqlite3exception.php">＋<small>add a note</small></a></span>
