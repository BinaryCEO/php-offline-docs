...
<head>
  ...
  <title>PHP: fann_create_from_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-create-from-file.php">
 <link rel="shorturl" href="https://www.php.net/fann-create-from-file">
 <link rel="alternate" href="https://www.php.net/fann-create-from-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-copy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-shortcut.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-create-from-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-create-from-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-create-from-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-create-from-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-create-from-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-create-from-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-create-from-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-create-from-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-create-from-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-create-from-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-create-from-file.php" hreflang="zh">
...
<meta name="Description" content="Constructs a backpropagation neural network from a configuration file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_create_from_file - Manual" />
<meta name="twitter:description" content="Constructs a backpropagation neural network from a configuration file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_create_from_file - Manual" />
<meta itemprop="description" content="Constructs a backpropagation neural network from a configuration file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructs a backpropagation neural network from a configuration file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-create-shortcut.php">
          fann_create_shortcut &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-create-from-file.php' selected="selected">English</option>
            <option value='de/function.fann-create-from-file.php'>German</option>
            <option value='es/function.fann-create-from-file.php'>Spanish</option>
            <option value='fr/function.fann-create-from-file.php'>French</option>
            <option value='it/function.fann-create-from-file.php'>Italian</option>
            <option value='ja/function.fann-create-from-file.php'>Japanese</option>
            <option value='pt_BR/function.fann-create-from-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-create-from-file.php'>Russian</option>
            <option value='tr/function.fann-create-from-file.php'>Turkish</option>
            <option value='uk/function.fann-create-from-file.php'>Ukrainian</option>
            <option value='zh/function.fann-create-from-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-create-from-file" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_create_from_file</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_create_from_file</span> &mdash; <span class="dc-title">Constructs a backpropagation neural network from a configuration file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-create-from-file-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_create_from_file</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$configuration_file</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   Constructs a backpropagation neural network from a configuration file, which have been saved by <span class="function"><a href="function.fann-save.php" class="function">fann_save()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-create-from-file-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">configuration_file</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-create-from-file-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para"> Returns a neural network <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.</p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-create-from-file-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-save.php" class="function" rel="rdfs-seeAlso">fann_save()</a> - Saves the entire network to a configuration file</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-create-from-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-create-from-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-create-from-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-from-file.php">＋<small>add a note</small></a></span>
