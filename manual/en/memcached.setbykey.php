...
<head>
  ...
  <title>PHP: Memcached::setByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.setbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.setbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.set.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.setencodingkey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.setbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.setbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.setbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.setbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.setbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.setbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.setbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.setbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.setbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.setbykey.php" hreflang="zh">
...
<meta name="Description" content="Store an item on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::setByKey - Manual" />
<meta name="twitter:description" content="Store an item on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::setByKey - Manual" />
<meta itemprop="description" content="Store an item on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Store an item on a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.setencodingkey.php">
          Memcached::setEncodingKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.set.php">
          &laquo; Memcached::set        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.setbykey.php' selected="selected">English</option>
            <option value='de/memcached.setbykey.php'>German</option>
            <option value='es/memcached.setbykey.php'>Spanish</option>
            <option value='fr/memcached.setbykey.php'>French</option>
            <option value='it/memcached.setbykey.php'>Italian</option>
            <option value='ja/memcached.setbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.setbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.setbykey.php'>Russian</option>
            <option value='tr/memcached.setbykey.php'>Turkish</option>
            <option value='uk/memcached.setbykey.php'>Ukrainian</option>
            <option value='zh/memcached.setbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.setbykey" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.set.php" class="methodname" rel="rdfs-seeAlso">Memcached::set()</a> - Store an item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/setbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.setbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.setbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.setbykey.php">＋<small>add a note</small></a></span>
