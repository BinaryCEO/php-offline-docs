...
<head>
  ...
  <title>PHP: pg_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-free-result.php">
 <link rel="shorturl" href="https://www.php.net/pg-free-result">
 <link rel="alternate" href="https://www.php.net/pg-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-flush.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-get-notify.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-free-result.php" hreflang="zh">
...
<meta name="Description" content="Free result memory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_free_result - Manual" />
<meta name="twitter:description" content="Free result memory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_free_result - Manual" />
<meta itemprop="description" content="Free result memory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Free result memory" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-free-result.php' selected="selected">English</option>
            <option value='de/function.pg-free-result.php'>German</option>
            <option value='es/function.pg-free-result.php'>Spanish</option>
            <option value='fr/function.pg-free-result.php'>French</option>
            <option value='it/function.pg-free-result.php'>Italian</option>
            <option value='ja/function.pg-free-result.php'>Japanese</option>
            <option value='pt_BR/function.pg-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-free-result.php'>Russian</option>
            <option value='tr/function.pg-free-result.php'>Turkish</option>
            <option value='uk/function.pg-free-result.php'>Ukrainian</option>
            <option value='zh/function.pg-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-free-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_free_result</h1> 
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_free_result</span> &mdash; <span class="dc-title">Free result memory</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-free-result-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_free_result()</strong></span> frees the memory and data associated with the
   specified <span class="classname"><a href="class.pgsql-result.php" class="classname">PgSql\Result</a></span> instance.
  </p>
  <p class="para">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_freeresult()</strong></span>.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-free-result-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-result-memory-size.php" class="function" rel="rdfs-seeAlso">pg_result_memory_size()</a> - Returns the amount of memory allocated for a query result</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-free-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113105">  <div class="votes">
    <div id="Vu113105">
    <a href="/manual/vote-note.php?id=113105&amp;page=function.pg-free-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113105">
    <a href="/manual/vote-note.php?id=113105&amp;page=function.pg-free-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113105" title="63% like this...">
    3
    </div>
  </div>
  <a href="#113105" class="name">
  <strong class="user"><em>Stefan W</em></strong></a><a class="genanchor" href="#113105"> &para;</a><div class="date" title="2013-08-30 12:12"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113105">
<div class="phpcode"><code><span class="html">You do NOT need to call pg_free_result() on every result resource you create.<br />When result resources go out of scope, they are garbage collected just like everything else.<br />Unless you're hoarding your results somewhere, you can basically ignore this function.<br /><br />Here's a little test you can run to confirm this: <a href="http://pastebin.com/ghw1PHuE" rel="nofollow" target="_blank">http://pastebin.com/ghw1PHuE</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-free-result.php">＋<small>add a note</small></a></div>
