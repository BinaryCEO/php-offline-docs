...
<head>
  ...
  <title>PHP: SplFileObject::rewind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.rewind.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.rewind.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.rewind.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.next.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.rewind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.rewind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.rewind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.rewind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.rewind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.rewind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.rewind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.rewind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.rewind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.rewind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.rewind.php" hreflang="zh">
...
<meta name="Description" content="Rewind the file to the first line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::rewind - Manual" />
<meta name="twitter:description" content="Rewind the file to the first line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::rewind - Manual" />
<meta itemprop="description" content="Rewind the file to the first line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rewind the file to the first line" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileobject.seek.php">
          SplFileObject::seek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.next.php">
          &laquo; SplFileObject::next        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.rewind.php' selected="selected">English</option>
            <option value='de/splfileobject.rewind.php'>German</option>
            <option value='es/splfileobject.rewind.php'>Spanish</option>
            <option value='fr/splfileobject.rewind.php'>French</option>
            <option value='it/splfileobject.rewind.php'>Italian</option>
            <option value='ja/splfileobject.rewind.php'>Japanese</option>
            <option value='pt_BR/splfileobject.rewind.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.rewind.php'>Russian</option>
            <option value='tr/splfileobject.rewind.php'>Turkish</option>
            <option value='uk/splfileobject.rewind.php'>Ukrainian</option>
            <option value='zh/splfileobject.rewind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.rewind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SplFileObject::rewind</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileObject::rewind</span> &mdash; <span class="dc-title">Rewind the file to the first line</span></p>
 ...
 <div class="refsect1 description" id="refsect1-splfileobject.rewind-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SplFileObject::rewind</strong></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 errors" id="refsect1-splfileobject.rewind-errors">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.runtimeexception.php" class="classname">RuntimeException</a></span> if cannot be rewound.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="splfileobject.valid.php" class="methodname" rel="rdfs-seeAlso">SplFileObject::valid()</a> - Not at EOF</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/rewind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.rewind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.rewind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.rewind.php">＋<small>add a note</small></a></span>
