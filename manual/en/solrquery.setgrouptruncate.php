...
<head>
  ...
  <title>PHP: SolrQuery::setGroupTruncate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgrouptruncate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgrouptruncate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgrouptruncate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgrouptruncate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgrouptruncate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgrouptruncate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgrouptruncate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgrouptruncate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgrouptruncate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgrouptruncate.php" hreflang="zh">
...
<meta name="Description" content="If true, facet counts are based on the most relevant document of each group matching the query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupTruncate - Manual" />
<meta name="twitter:description" content="If true, facet counts are based on the most relevant document of each group matching the query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupTruncate - Manual" />
<meta itemprop="description" content="If true, facet counts are based on the most relevant document of each group matching the query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="If true, facet counts are based on the most relevant document of each group matching the query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlight.php">
          SolrQuery::setHighlight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgroupoffset.php">
          &laquo; SolrQuery::setGroupOffset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgrouptruncate.php' selected="selected">English</option>
            <option value='de/solrquery.setgrouptruncate.php'>German</option>
            <option value='es/solrquery.setgrouptruncate.php'>Spanish</option>
            <option value='fr/solrquery.setgrouptruncate.php'>French</option>
            <option value='it/solrquery.setgrouptruncate.php'>Italian</option>
            <option value='ja/solrquery.setgrouptruncate.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgrouptruncate.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgrouptruncate.php'>Russian</option>
            <option value='tr/solrquery.setgrouptruncate.php'>Turkish</option>
            <option value='uk/solrquery.setgrouptruncate.php'>Ukrainian</option>
            <option value='zh/solrquery.setgrouptruncate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgrouptruncate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setGroupTruncate</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setGroupTruncate</span> &mdash; <span class="dc-title">If true, facet counts are based on the most relevant document of each group matching the query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setgrouptruncate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setGroupTruncate</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setgrouptruncate-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setgrouptruncate-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.setgrouptruncate-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgrouptruncate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgrouptruncate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgrouptruncate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgrouptruncate.php">＋<small>add a note</small></a></span>
