...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.print.php">
 <link rel="shorturl" href="https://www.php.net/print">
 <link rel="alternate" href="https://www.php.net/print" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.parse-str.php">
 <link rel="next" href="https://www.php.net/manual/en/function.printf.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.print.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.print.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.print.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.print.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.print.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.print.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.print.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.print.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.print.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.print.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.print.php" hreflang="zh">
...
<meta name="Description" content="Output a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: print - Manual" />
<meta name="twitter:description" content="Output a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: print - Manual" />
<meta itemprop="description" content="Output a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.print.php' selected="selected">English</option>
            <option value='de/function.print.php'>German</option>
            <option value='es/function.print.php'>Spanish</option>
            <option value='fr/function.print.php'>French</option>
            <option value='it/function.print.php'>Italian</option>
            <option value='ja/function.print.php'>Japanese</option>
            <option value='pt_BR/function.print.php'>Brazilian Portuguese</option>
            <option value='ru/function.print.php'>Russian</option>
            <option value='tr/function.print.php'>Turkish</option>
            <option value='uk/function.print.php'>Ukrainian</option>
            <option value='zh/function.print.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.print" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.print-examples">
  ...
  <p class="para">
   <div class="example" id="example-5101">
    <p><strong>Example #1 <code class="literal">print</code> examples</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.types.string.php" class="link">Ways to specify literal strings</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/print.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.print%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.print&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.print.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="85310">  <div class="votes">
    <div id="Vu85310">
    <a href="/manual/vote-note.php?id=85310&amp;page=function.print&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85310">
    <a href="/manual/vote-note.php?id=85310&amp;page=function.print&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85310" title="58% like this...">
    30
    </div>
  </div>
  <a href="#85310" class="name">
  <strong class="user"><em>user at example dot net</em></strong></a><a class="genanchor" href="#85310"> &para;</a><div class="date" title="2008-08-25 09:45"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85310">
<div class="phpcode"><code><span class="html">Be careful when using print. Since print is a language construct and not a function, the parentheses around the argument is not required.<br />In fact, using parentheses can cause confusion with the syntax of a function and SHOULD be omited.<br /><br />Most would expect the following behavior:<br /><span class="default">&lt;?php<br />    </span><span class="keyword">if (print(</span><span class="string">"foo"</span><span class="keyword">) &amp;&amp; print(</span><span class="string">"bar"</span><span class="keyword">)) {<br />        </span><span class="comment">// "foo" and "bar" had been printed<br />    </span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />But since the parenthesis around the argument are not required, they are interpretet as part of the argument.<br />This means that the argument of the first print is<br /><br />    ("foo") &amp;&amp; print("bar")<br /><br />and the argument of the second print is just<br /><br />    ("bar")<br /><br />For the expected behavior of the first example, you need to write: <br /><span class="default">&lt;?php<br />    </span><span class="keyword">if ((print </span><span class="string">"foo"</span><span class="keyword">) &amp;&amp; (print </span><span class="string">"bar"</span><span class="keyword">)) {<br />        </span><span class="comment">// "foo" and "bar" had been printed<br />    </span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="128857">  <div class="votes">
    <div id="Vu128857">
    <a href="/manual/vote-note.php?id=128857&amp;page=function.print&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128857">
    <a href="/manual/vote-note.php?id=128857&amp;page=function.print&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128857" title="87% like this...">
    6
    </div>
  </div>
  <a href="#128857" class="name">
  <strong class="user"><em>mark at manngo dot net</em></strong></a><a class="genanchor" href="#128857"> &para;</a><div class="date" title="2023-09-05 04:34"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128857">
<div class="phpcode"><code><span class="html">The other major difference with echo is that print returns a value, even it’s always 1.<br /><br />That might not look like much, but you can use print in another expression. Here are some examples:<br /><br /><span class="default">&lt;?php<br />    rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">) ? print </span><span class="string">'Hello' </span><span class="keyword">: print </span><span class="string">'goodbye'</span><span class="keyword">;<br />    print </span><span class="default">PHP_EOL</span><span class="keyword">;<br />    print </span><span class="string">'Hello ' </span><span class="keyword">and print </span><span class="string">'goodbye'</span><span class="keyword">;<br />    print </span><span class="default">PHP_EOL</span><span class="keyword">;<br />    </span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">) or print </span><span class="string">'whatever'</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Here’s a more serious example:<br /><br /><span class="default">&lt;?php<br />    </span><span class="keyword">function </span><span class="default">test</span><span class="keyword">() {<br />        return !!</span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br />    }<br />    </span><span class="default">test</span><span class="keyword">() or print </span><span class="string">'failed'</span><span class="keyword">;    <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="83241">  <div class="votes">
    <div id="Vu83241">
    <a href="/manual/vote-note.php?id=83241&amp;page=function.print&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83241">
    <a href="/manual/vote-note.php?id=83241&amp;page=function.print&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83241" title="61% like this...">
    16
    </div>
  </div>
  <a href="#83241" class="name">
  <strong class="user"><em>danielxmorris @ gmail dotcom</em></strong></a><a class="genanchor" href="#83241"> &para;</a><div class="date" title="2008-05-16 04:08"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83241">
<div class="phpcode"><code><span class="html">I wrote a println function that determines whether a \n or a &lt;br /&gt; should be appended to the line depending on whether it's being executed in a shell or a browser window.  People have probably thought of this before but I thought I'd post it anyway - it may help a couple of people.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">println </span><span class="keyword">(</span><span class="default">$string_message</span><span class="keyword">) {<br />    </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'SERVER_PROTOCOL'</span><span class="keyword">] ? print </span><span class="string">"</span><span class="default">$string_message</span><span class="string">&lt;br /&gt;" </span><span class="keyword">: print </span><span class="string">"</span><span class="default">$string_message</span><span class="string">\n"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />Examples:<br /><br />Running in a browser:<br /><br /><span class="default">&lt;?php println </span><span class="keyword">(</span><span class="string">"Hello, world!"</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>Output: Hello, world!&lt;br /&gt;<br /><br />Running in a shell:<br /><br /><span class="default">&lt;?php println </span><span class="keyword">(</span><span class="string">"Hello, world!"</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>Output: Hello, world!\n</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.print&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.print.php">＋<small>add a note</small></a></div>
