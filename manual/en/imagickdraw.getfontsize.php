...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfontsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfontsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfontsize.php' selected="selected">English</option>
            ...
            <option value='zh/imagickdraw.getfontsize.php'>Chinese (Simplified)</option>
  ...
  <p class="para">
   Returns the font size associated with the current <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfontsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfontsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfontsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfontsize.php">＋<small>add a note</small></a></span>
