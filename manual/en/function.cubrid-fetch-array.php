...
<head>
  ...
  <title>PHP: cubrid_fetch_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-fetch-array.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-fetch-array">
 <link rel="alternate" href="https://www.php.net/cubrid-fetch-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-fetch-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-fetch-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-fetch-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-fetch-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-fetch-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-fetch-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-fetch-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-fetch-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-fetch-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-fetch-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-fetch-array.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: cubrid_fetch_array - Manual" />
...
<meta itemprop="name" content="PHP: cubrid_fetch_array - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-fetch-assoc.php">
          cubrid_fetch_assoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-error.php">
          &laquo; cubrid_error        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-fetch-array.php' selected="selected">English</option>
            <option value='de/function.cubrid-fetch-array.php'>German</option>
            <option value='es/function.cubrid-fetch-array.php'>Spanish</option>
            <option value='fr/function.cubrid-fetch-array.php'>French</option>
            <option value='it/function.cubrid-fetch-array.php'>Italian</option>
            <option value='ja/function.cubrid-fetch-array.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-fetch-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-fetch-array.php'>Russian</option>
            <option value='tr/function.cubrid-fetch-array.php'>Turkish</option>
            <option value='uk/function.cubrid-fetch-array.php'>Ukrainian</option>
            <option value='zh/function.cubrid-fetch-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-fetch-array" class="refentry">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-fetch-object.php" class="function" rel="rdfs-seeAlso">cubrid_fetch_object()</a> - Fetch the next row and return it as an object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-fetch-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-fetch-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-fetch-array.php">＋<small>add a note</small></a></span>
