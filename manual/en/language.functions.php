...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.functions.php">
 <link rel="shorturl" href="https://www.php.net/functions">
 <link rel="alternate" href="https://www.php.net/functions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/langref.php">
 <link rel="prev" href="https://www.php.net/manual/en/control-structures.goto.php">
 <link rel="next" href="https://www.php.net/manual/en/functions.user-defined.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.functions.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.functions.php' selected="selected">English</option>
            ...
            <option value='it/language.functions.php'>Italian</option>
            ...
            <option value='uk/language.functions.php'>Ukrainian</option>
  ...
  </div><div id="language.functions" class="chapter">
  <h1 class="title">Functions</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="functions.user-defined.php">User-defined functions</a></li><li><a href="functions.arguments.php">Function parameters and arguments</a></li><li><a href="functions.returning-values.php">Returning values</a></li><li><a href="functions.variable-functions.php">Variable functions</a></li><li><a href="functions.internal.php">Internal (built-in) functions</a></li><li><a href="functions.anonymous.php">Anonymous functions</a></li><li><a href="functions.arrow.php">Arrow Functions</a></li><li><a href="functions.first_class_callable_syntax.php">First class callable syntax</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.functions.php">＋<small>add a note</small></a></span>
