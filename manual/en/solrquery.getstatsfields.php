...
<head>
  ...
  <title>PHP: SolrQuery::getStatsFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getstatsfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getstatsfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstatsfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getstatsfacets.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getterms.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getstatsfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getstatsfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getstatsfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getstatsfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getstatsfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getstatsfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getstatsfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getstatsfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getstatsfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getstatsfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getstatsfields.php" hreflang="zh">
...
<meta name="Description" content="Returns all the statistics fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getStatsFields - Manual" />
<meta name="twitter:description" content="Returns all the statistics fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getStatsFields - Manual" />
<meta itemprop="description" content="Returns all the statistics fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the statistics fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getterms.php">
          SolrQuery::getTerms &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getstatsfacets.php">
          &laquo; SolrQuery::getStatsFacets        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getstatsfields.php' selected="selected">English</option>
            <option value='de/solrquery.getstatsfields.php'>German</option>
            <option value='es/solrquery.getstatsfields.php'>Spanish</option>
            <option value='fr/solrquery.getstatsfields.php'>French</option>
            <option value='it/solrquery.getstatsfields.php'>Italian</option>
            <option value='ja/solrquery.getstatsfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getstatsfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getstatsfields.php'>Russian</option>
            <option value='tr/solrquery.getstatsfields.php'>Turkish</option>
            <option value='uk/solrquery.getstatsfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getstatsfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getstatsfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getStatsFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getStatsFields</span> &mdash; <span class="dc-title">Returns all the statistics fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getstatsfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getStatsFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getstatsfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getstatsfields-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getstatsfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getstatsfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getstatsfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getstatsfields.php">＋<small>add a note</small></a></span>
