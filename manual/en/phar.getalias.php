...
<head>
  ...
  <title>PHP: Phar::getAlias - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.getalias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.getalias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.getalias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.extractto.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.getmetadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.getalias.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.getalias.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.getalias.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.getalias.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.getalias.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.getalias.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.getalias.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.getalias.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.getalias.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.getalias.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.getalias.php" hreflang="zh">
...
<meta name="Description" content="Get the alias for Phar" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::getAlias - Manual" />
<meta name="twitter:description" content="Get the alias for Phar" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::getAlias - Manual" />
<meta itemprop="description" content="Get the alias for Phar" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the alias for Phar" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.getmetadata.php">
          Phar::getMetadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.extractto.php">
          &laquo; Phar::extractTo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.getalias.php' selected="selected">English</option>
            <option value='de/phar.getalias.php'>German</option>
            <option value='es/phar.getalias.php'>Spanish</option>
            <option value='fr/phar.getalias.php'>French</option>
            <option value='it/phar.getalias.php'>Italian</option>
            <option value='ja/phar.getalias.php'>Japanese</option>
            <option value='pt_BR/phar.getalias.php'>Brazilian Portuguese</option>
            <option value='ru/phar.getalias.php'>Russian</option>
            <option value='tr/phar.getalias.php'>Turkish</option>
            <option value='uk/phar.getalias.php'>Ukrainian</option>
            <option value='zh/phar.getalias.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.getalias" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::getAlias</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.2.1)</p><p class="refpurpose"><span class="refname">Phar::getAlias</span> &mdash; <span class="dc-title">Get the alias for Phar</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.getalias-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::getAlias</strong></span>(): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-phar.getalias-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-phar.getalias-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the alias or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there&#039;s no alias.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/getAlias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.getalias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.getalias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.getalias.php">＋<small>add a note</small></a></span>
