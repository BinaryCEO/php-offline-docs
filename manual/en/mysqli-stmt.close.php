...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.close.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.close.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.close.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.bind-result.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.construct.php">
...
<meta name="Description" content="Closes a prepared statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::close - Manual" />
<meta name="twitter:description" content="Closes a prepared statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::close - Manual" />
<meta itemprop="description" content="Closes a prepared statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes a prepared statement" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.close.php' selected="selected">English</option>
            ...
            <option value='ru/mysqli-stmt.close.php'>Russian</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.prepare.php" class="function" rel="rdfs-seeAlso">mysqli_prepare()</a> - Prepares an SQL statement for execution</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.close.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="60815">  <div class="votes">
    <div id="Vu60815">
    <a href="/manual/vote-note.php?id=60815&amp;page=mysqli-stmt.close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd60815">
    <a href="/manual/vote-note.php?id=60815&amp;page=mysqli-stmt.close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V60815" title="46% like this...">
    -4
    </div>
  </div>
  <a href="#60815" class="name">
  <strong class="user"><em>daniel dot kipp at web dot de</em></strong></a><a class="genanchor" href="#60815"> &para;</a><div class="date" title="2006-01-17 09:06"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60815">
<div class="phpcode"><code><span class="html">if you are repeating an statement in an loop using bind_param and so on inside it for a larger operation. i thougt id would be good to clean it with stmt-&gt;close. but it broke always with an error after aprox. 250 operations . As i tried it with  stmt-&gt;reset it worked for me.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli-stmt.close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.close.php">＋<small>add a note</small></a></div>
