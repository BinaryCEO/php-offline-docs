...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.hash-hmac-algos.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.hash-hmac.php">
 <link rel="next" href="https://www.php.net/manual/en/function.hash-hmac-file.php">
...
<meta name="Description" content="Return a list of registered hashing algorithms suitable for hash_hmac" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: hash_hmac_algos - Manual" />
<meta name="twitter:description" content="Return a list of registered hashing algorithms suitable for hash_hmac" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: hash_hmac_algos - Manual" />
<meta itemprop="description" content="Return a list of registered hashing algorithms suitable for hash_hmac" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return a list of registered hashing algorithms suitable for hash_hmac" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.hash-hmac-algos.php' selected="selected">English</option>
            ...
            <option value='ru/function.hash-hmac-algos.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">hash_hmac_algos</span> &mdash; <span class="dc-title">Return a list of registered hashing algorithms suitable for hash_hmac</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.hash-hmac-algos-returnvalues">
  ...
  <p class="para">
   ...
   algorithms suitable for <span class="function"><a href="function.hash-hmac.php" class="function">hash_hmac()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 notes" id="refsect1-function.hash-hmac-algos-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    has been to call <span class="function"><a href="function.hash-algos.php" class="function">hash_algos()</a></span> which also returns hash
    algorithms that are not suitable for <span class="function"><a href="function.hash-hmac.php" class="function">hash_hmac()</a></span>.
   </p>
  </p></blockquote>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.hash-algos.php" class="function" rel="rdfs-seeAlso">hash_algos()</a> - Return a list of registered hashing algorithms</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/hash/functions/hash-hmac-algos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.hash-hmac-algos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.hash-hmac-algos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.hash-hmac-algos.php">＋<small>add a note</small></a></span>
