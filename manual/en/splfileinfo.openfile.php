...
<head>
  ...
  <title>PHP: SplFileInfo::openFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.openfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.openfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.openfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.iswritable.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.setfileclass.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.openfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileinfo.openfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileinfo.openfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileinfo.openfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileinfo.openfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileinfo.openfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileinfo.openfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileinfo.openfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileinfo.openfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileinfo.openfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileinfo.openfile.php" hreflang="zh">
...
<meta name="Description" content="Gets an SplFileObject object for the file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::openFile - Manual" />
<meta name="twitter:description" content="Gets an SplFileObject object for the file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::openFile - Manual" />
<meta itemprop="description" content="Gets an SplFileObject object for the file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets an SplFileObject object for the file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileinfo.setfileclass.php">
          SplFileInfo::setFileClass &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileinfo.iswritable.php">
          &laquo; SplFileInfo::isWritable        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.openfile.php' selected="selected">English</option>
            <option value='de/splfileinfo.openfile.php'>German</option>
            <option value='es/splfileinfo.openfile.php'>Spanish</option>
            <option value='fr/splfileinfo.openfile.php'>French</option>
            <option value='it/splfileinfo.openfile.php'>Italian</option>
            <option value='ja/splfileinfo.openfile.php'>Japanese</option>
            <option value='pt_BR/splfileinfo.openfile.php'>Brazilian Portuguese</option>
            <option value='ru/splfileinfo.openfile.php'>Russian</option>
            <option value='tr/splfileinfo.openfile.php'>Turkish</option>
            <option value='uk/splfileinfo.openfile.php'>Ukrainian</option>
            <option value='zh/splfileinfo.openfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileinfo.openfile" class="refentry">
 ...
 <div class="refsect1 parameters" id="refsect1-splfileinfo.openfile-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       When set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, the filename is also
searched for within the <a href="ini.core.php#ini.include-path" class="link">include_path</a>
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       Refer to the <a href="context.php" class="link">context</a>
section of the manual for a description of <code class="literal">contexts</code>.
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fopen.php" class="function" rel="rdfs-seeAlso">fopen()</a> - Opens file or URL</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/openfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.openfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.openfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.openfile.php">＋<small>add a note</small></a></span>
