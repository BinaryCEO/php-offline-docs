...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-cql.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/commonmark-parser.finish.php">
 <link rel="next" href="https://www.php.net/manual/en/commonmark-cql.construct.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-cql.php' selected="selected">English</option>
            <option value='de/class.commonmark-cql.php'>German</option>
            <option value='es/class.commonmark-cql.php'>Spanish</option>
            <option value='fr/class.commonmark-cql.php'>French</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="commonmark-cql.construct.php">CommonMark\CQL::__construct</a> — CQL Construction</li><li><a href="commonmark-cql.invoke.php">CommonMark\CQL::__invoke</a> — CQL Execution</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.cql.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-cql%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-cql&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-cql.php">＋<small>add a note</small></a></span>
