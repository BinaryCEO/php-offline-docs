...
<head>
  ...
  <title>PHP: call_user_func - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.call-user-func.php">
 <link rel="shorturl" href="https://www.php.net/call-user-func">
 <link rel="alternate" href="https://www.php.net/call-user-func" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.funchand.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.funchand.php">
 <link rel="next" href="https://www.php.net/manual/en/function.call-user-func-array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.call-user-func.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.call-user-func.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.call-user-func.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.call-user-func.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.call-user-func.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.call-user-func.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.call-user-func.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.call-user-func.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.call-user-func.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.call-user-func.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.call-user-func.php" hreflang="zh">
...
<meta name="Description" content="Call the callback given by the first parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: call_user_func - Manual" />
<meta name="twitter:description" content="Call the callback given by the first parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: call_user_func - Manual" />
<meta itemprop="description" content="Call the callback given by the first parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Call the callback given by the first parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.call-user-func-array.php">
          call_user_func_array &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.funchand.php">
          &laquo; Function handling Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.call-user-func.php' selected="selected">English</option>
            <option value='de/function.call-user-func.php'>German</option>
            <option value='es/function.call-user-func.php'>Spanish</option>
            <option value='fr/function.call-user-func.php'>French</option>
            <option value='it/function.call-user-func.php'>Italian</option>
            <option value='ja/function.call-user-func.php'>Japanese</option>
            <option value='pt_BR/function.call-user-func.php'>Brazilian Portuguese</option>
            <option value='ru/function.call-user-func.php'>Russian</option>
            <option value='tr/function.call-user-func.php'>Turkish</option>
            <option value='uk/function.call-user-func.php'>Ukrainian</option>
            <option value='zh/function.call-user-func.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.call-user-func" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">call_user_func</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">call_user_func</span> &mdash; <span class="dc-title">Call the callback given by the first parameter</span></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">barber</span><span style="color: #007700">(</span><span style="color: #0000BB">$type</span><span style="color: #007700">)<br />{<br />    echo </span><span style="color: #DD0000">"You wanted a </span><span style="color: #0000BB">$type</span><span style="color: #DD0000"> haircut, no problem\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">call_user_func</span><span style="color: #007700">(</span><span style="color: #DD0000">'barber'</span><span style="color: #007700">, </span><span style="color: #DD0000">"mushroom"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">call_user_func</span><span style="color: #007700">(</span><span style="color: #DD0000">'barber'</span><span style="color: #007700">, </span><span style="color: #DD0000">"shave"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">You wanted a mushroom haircut, no problem
You wanted a shave haircut, no problem</pre>
</div>
    </div>
   </div>
...
with functions such as <span class="function"><strong>call_user_func()</strong></span> and <span class="function"><a href="function.call-user-func-array.php" class="function">call_user_func_array()</a></span> will not be
 ...
 <div class="refsect1 seealso" id="refsect1-function.call-user-func-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="functions.variable-functions.php" class="link">Variable functions</a></li>
    ...
    <li><span class="methodname"><a href="reflectionmethod.invoke.php" class="methodname" rel="rdfs-seeAlso">ReflectionMethod::invoke()</a> - Invoke</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/funchand/functions/call-user-func.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.call-user-func%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.call-user-func&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.call-user-func.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99870">  <div class="votes">
    <div id="Vu99870">
    <a href="/manual/vote-note.php?id=99870&amp;page=function.call-user-func&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99870">
    <a href="/manual/vote-note.php?id=99870&amp;page=function.call-user-func&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99870" title="75% like this...">
    60
    </div>
  </div>
  <a href="#99870" class="name">
  <strong class="user"><em>gskluzacek dot nospam at gmail dot com</em></strong></a><a class="genanchor" href="#99870"> &para;</a><div class="date" title="2010-09-11 10:38"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99870">
<div class="phpcode"><code><span class="html">if you simply want to dynamically call a method on an object it is not necessary to use call_user_function but instead you can do the following:<br /><br /><span class="default">&lt;?php<br /><br />$method_name </span><span class="keyword">= </span><span class="string">"AMethodName"</span><span class="keyword">;<br /><br /></span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">ClassName</span><span class="keyword">();<br /><br /></span><span class="default">$obj</span><span class="keyword">-&gt;{</span><span class="default">$method_name</span><span class="keyword">}();<br /><br /></span><span class="default">?&gt;<br /></span><br />I've used the above so I know it works.<br /><br />Regards,<br />-- Greg</span></code></div>
  </div>
 </div>
  <div class="note" id="77663">  <div class="votes">
    <div id="Vu77663">
    <a href="/manual/vote-note.php?id=77663&amp;page=function.call-user-func&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd77663">
    <a href="/manual/vote-note.php?id=77663&amp;page=function.call-user-func&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V77663" title="69% like this...">
    18
    </div>
  </div>
  <a href="#77663" class="name">
  <strong class="user"><em>Knightnet</em></strong></a><a class="genanchor" href="#77663"> &para;</a><div class="date" title="2007-09-07 05:31"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom77663">
<div class="phpcode"><code><span class="html">You don't need to use this function to call a variable class function. Instead you can do the following:<br /><br />$this-&gt;{$fnname}();<br /><br />The example works in PHP 5 from within the class. It is the {} that do the trick.<br /><br />Regards,<br />Julian.</span></code></div>
  </div>
 </div>
  <div class="note" id="93869">  <div class="votes">
    <div id="Vu93869">
    <a href="/manual/vote-note.php?id=93869&amp;page=function.call-user-func&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93869">
    <a href="/manual/vote-note.php?id=93869&amp;page=function.call-user-func&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93869" title="66% like this...">
    18
    </div>
  </div>
  <a href="#93869" class="name">
  <strong class="user"><em>Nitrogen</em></strong></a><a class="genanchor" href="#93869"> &para;</a><div class="date" title="2009-10-04 04:08"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom93869">
<div class="phpcode"><code><span class="html">A good use for call_user_func(); is for recursive functions.<br />If you're distributing code, you will often come across users who will rename functions and break the code..<br />Use this: call_user_func(__FUNCTION__, ... ); inside a function to call itself with whatever parameters you want.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// example, an extremely simplified factorial calculator..<br />// it's quite obvious when someone renames the function, it'll spit out an error because it wants to call itself.<br /></span><span class="keyword">function </span><span class="default">Factorial</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">1</span><span class="keyword">) {<br />  return(</span><span class="default">$i</span><span class="keyword">==</span><span class="default">1</span><span class="keyword">?</span><span class="default">1</span><span class="keyword">:</span><span class="default">$i</span><span class="keyword">*</span><span class="default">Factorial</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">-</span><span class="default">1</span><span class="keyword">));<br />}<br /><br /></span><span class="comment">// you can give this function whatever name you want, it'll always work, of course if you initially call it using the name you gave it.<br /></span><span class="keyword">function </span><span class="default">qwertyuiop</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">1</span><span class="keyword">) {<br />  return(</span><span class="default">$i</span><span class="keyword">==</span><span class="default">1</span><span class="keyword">?</span><span class="default">1</span><span class="keyword">:</span><span class="default">$i</span><span class="keyword">*</span><span class="default">call_user_func</span><span class="keyword">(</span><span class="default">__FUNCTION__</span><span class="keyword">,</span><span class="default">$i</span><span class="keyword">-</span><span class="default">1</span><span class="keyword">));<br />}<br /></span><span class="default">?&gt;<br /></span><br />Just that I didn't see any reference to recursive functions when user_call_func(); really helps.</span></code></div>
  </div>
 </div>
  <div class="note" id="124500">  <div class="votes">
    <div id="Vu124500">
    <a href="/manual/vote-note.php?id=124500&amp;page=function.call-user-func&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124500">
    <a href="/manual/vote-note.php?id=124500&amp;page=function.call-user-func&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124500" title="64% like this...">
    7
    </div>
  </div>
  <a href="#124500" class="name">
  <strong class="user"><em>James at enfsolar dot com</em></strong></a><a class="genanchor" href="#124500"> &para;</a><div class="date" title="2019-12-11 12:08"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124500">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">MyClass</span><span class="keyword">{<br /><br />    public function </span><span class="default">hello</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">)<br /><br />    {<br /><br />        echo </span><span class="string">'hello ' </span><span class="keyword">. </span><span class="default">$str</span><span class="keyword">;<br /><br />    }<br /><br />}<br /><br /></span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">MyClass</span><span class="keyword">();<br /><br />[</span><span class="default">$obj</span><span class="keyword">, </span><span class="string">'hello'</span><span class="keyword">](</span><span class="string">'World'</span><span class="keyword">); </span><span class="comment">// the array can be called as a function</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.call-user-func&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.call-user-func.php">＋<small>add a note</small></a></div>
