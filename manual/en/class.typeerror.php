...
<head>
  ...
  <title>PHP: TypeError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.typeerror.php">
 <link rel="shorturl" href="https://www.php.net/typeerror">
 <link rel="alternate" href="https://www.php.net/typeerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.parseerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.valueerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.typeerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.typeerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.typeerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.typeerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.typeerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.typeerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.typeerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.typeerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.typeerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.typeerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.typeerror.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: TypeError - Manual" />
<meta name="twitter:description" content="TypeError" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: TypeError - Manual" />
<meta itemprop="description" content="TypeError" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="TypeError" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.typeerror.php' selected="selected">English</option>
            <option value='de/class.typeerror.php'>German</option>
            <option value='es/class.typeerror.php'>Spanish</option>
            <option value='fr/class.typeerror.php'>French</option>
            <option value='it/class.typeerror.php'>Italian</option>
            <option value='ja/class.typeerror.php'>Japanese</option>
            <option value='pt_BR/class.typeerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.typeerror.php'>Russian</option>
            <option value='tr/class.typeerror.php'>Turkish</option>
            <option value='uk/class.typeerror.php'>Ukrainian</option>
            <option value='zh/class.typeerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.typeerror" class="reference">
 <h1 class="title">TypeError</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 7, PHP 8)</p>


  <div class="section" id="typeerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    A <span class="classname"><strong class="classname">TypeError</strong></span> may be thrown when:
    <ul class="simplelist">
     <li>
  ...
  <div class="section" id="typeerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">TypeError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="typeerror.changelog">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>7.1.0</td>
       <td>
        In strict mode, passing an incorrect number of arguments to a built-in
        PHP function no longer results in a generic <span class="classname"><strong class="classname">TypeError</strong></span>.
        Instead, a more specific <span class="classname"><a href="class.argumentcounterror.php" class="classname">ArgumentCountError</a></span>, which
        extends <span class="classname"><strong class="classname">TypeError</strong></span>, is thrown.
       </td>
      </tr>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/typeerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.typeerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.typeerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.typeerror.php">＋<small>add a note</small></a></span>
