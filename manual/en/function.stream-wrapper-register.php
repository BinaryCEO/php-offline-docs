...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-wrapper-register.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-supports-lock.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-wrapper-restore.php">
...
<meta name="Description" content="Register a URL wrapper implemented as a PHP class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_wrapper_register - Manual" />
<meta name="twitter:description" content="Register a URL wrapper implemented as a PHP class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_wrapper_register - Manual" />
<meta itemprop="description" content="Register a URL wrapper implemented as a PHP class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a URL wrapper implemented as a PHP class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-wrapper-register.php' selected="selected">English</option>
            ...
            <option value='ja/function.stream-wrapper-register.php'>Japanese</option>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-wrapper-register-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Should be set to <strong><code><a href="stream.constants.php#constant.stream-is-url">STREAM_IS_URL</a></code></strong> if
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-wrapper-register-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>stream_wrapper_register()</strong></span> will return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-wrapper-register-examples">
  ...
  <p class="para">
   <div class="example" id="example-4079">
...
&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-wrapper-register-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li>The <a href="class.streamwrapper.php" class="xref">streamWrapper</a> prototype class</li>
    <li><a href="stream.streamwrapper.example-1.php" class="xref">Example class registered as stream wrapper</a></li>
    <li><span class="function"><a href="function.stream-wrapper-unregister.php" class="function" rel="rdfs-seeAlso">stream_wrapper_unregister()</a> - Unregister a URL wrapper</span></li>
    <li><span class="function"><a href="function.stream-wrapper-restore.php" class="function" rel="rdfs-seeAlso">stream_wrapper_restore()</a> - Restores a previously unregistered built-in wrapper</span></li>
    <li><span class="function"><a href="function.stream-get-wrappers.php" class="function" rel="rdfs-seeAlso">stream_get_wrappers()</a> - Retrieve list of registered streams</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-wrapper-register.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-wrapper-register%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-wrapper-register&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-wrapper-register.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If you plan to use your wrapper in a require_once you need to define stream_stat().  If you plan to allow any other tests like is_file()/is_dir(), you have to define url_stat().<br /><br />stream_stat() must define the size of the file, or it will never be included.  url_stat() must define mode, or is_file()/is_dir()/is_executable(), and any of those functions affected by clearstatcache() simply won't work.<br /><br />It's not documented, but directories must be a mode like 040777 (octal), and files a mode like 0100666.  If you wish the file to be executable, use 7s instead of 6s.  The last 3 digits are exactly the same thing as what you pass to chmod.  040000 defines a directory, and 0100000 defines a file.  It would be really helpful to add this to the official manual!</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It is worth noting that if your wrapper supports stream_flush() then when you flcose() your stream this function will be called prior to closing the stream.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-wrapper-register&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-wrapper-register.php">＋<small>add a note</small></a></div>
