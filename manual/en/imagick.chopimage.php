...
<head>
  ...
  <title>PHP: Imagick::chopImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.chopimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.chopimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.chopimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.charcoalimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clampimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.chopimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.chopimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.chopimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.chopimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.chopimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.chopimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.chopimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.chopimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.chopimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.chopimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.chopimage.php" hreflang="zh">
...
<meta name="Description" content="Removes a region of an image and trims" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::chopImage - Manual" />
<meta name="twitter:description" content="Removes a region of an image and trims" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::chopImage - Manual" />
<meta itemprop="description" content="Removes a region of an image and trims" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes a region of an image and trims" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.clampimage.php">
          Imagick::clampImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.charcoalimage.php">
          &laquo; Imagick::charcoalImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.chopimage.php' selected="selected">English</option>
            <option value='de/imagick.chopimage.php'>German</option>
            <option value='es/imagick.chopimage.php'>Spanish</option>
            <option value='fr/imagick.chopimage.php'>French</option>
            <option value='it/imagick.chopimage.php'>Italian</option>
            <option value='ja/imagick.chopimage.php'>Japanese</option>
            <option value='pt_BR/imagick.chopimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.chopimage.php'>Russian</option>
            <option value='tr/imagick.chopimage.php'>Turkish</option>
            <option value='uk/imagick.chopimage.php'>Ukrainian</option>
            <option value='zh/imagick.chopimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.chopimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::chopImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::chopImage</span> &mdash; <span class="dc-title">Removes a region of an image and trims</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.chopimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::chopImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.chopimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.chopimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.chopimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.chopimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2977">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::chopImage()</strong></span>:</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create some objects */<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$pixel </span><span style="color: #007700">= new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">( </span><span style="color: #DD0000">'gray' </span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* New image */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">400</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">$pixel</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Chop image */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">chopImage</span><span style="color: #007700">(</span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Give image a format */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Output the image with headers */<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.chopimage-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.cropimage.php" class="function" rel="rdfs-seeAlso">Imagick::cropImage()</a> - Extracts a region of the image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/chopimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.chopimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.chopimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.chopimage.php">＋<small>add a note</small></a></span>
