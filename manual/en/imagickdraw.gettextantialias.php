...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.gettextantialias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.gettextantialias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.gettextantialias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.gettextalignment.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.gettextdecoration.php">
...
<meta name="Description" content="Returns the current text antialias setting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getTextAntialias - Manual" />
<meta name="twitter:description" content="Returns the current text antialias setting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getTextAntialias - Manual" />
<meta itemprop="description" content="Returns the current text antialias setting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current text antialias setting" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.gettextantialias.php' selected="selected">English</option>
            <option value='de/imagickdraw.gettextantialias.php'>German</option>
            <option value='es/imagickdraw.gettextantialias.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getTextAntialias</span> &mdash; <span class="dc-title">Returns the current text antialias setting</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.gettextantialias-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if text is antialiased and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/gettextantialias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.gettextantialias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.gettextantialias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.gettextantialias.php">＋<small>add a note</small></a></span>
