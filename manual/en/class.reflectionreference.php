...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionreference.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/reflectionintersectiontype.gettypes.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionreference.construct.php">
...
<meta name="Description" content="The ReflectionReference class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionReference - Manual" />
<meta name="twitter:description" content="The ReflectionReference class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionReference - Manual" />
<meta itemprop="description" content="The ReflectionReference class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionReference class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionreference.php' selected="selected">English</option>
            <option value='de/class.reflectionreference.php'>German</option>
            <option value='es/class.reflectionreference.php'>Spanish</option>
            <option value='fr/class.reflectionreference.php'>French</option>
 ...
 <h1 class="title">The ReflectionReference class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 7 &gt;= 7.4.0, PHP 8)</p>
  ...
  <div class="section" id="reflectionreference.intro">
   ...
   <p class="para">
    The <span class="classname"><strong class="classname">ReflectionReference</strong></span> class provides information about
    a reference.
   </p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionreference.construct.php">ReflectionReference::__construct</a> — Private constructor to disallow direct instantiation</li><li><a href="reflectionreference.fromarrayelement.php">ReflectionReference::fromArrayElement</a> — Create a ReflectionReference from an array element</li><li><a href="reflectionreference.getid.php">ReflectionReference::getId</a> — Get unique ID of a reference</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionreference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionreference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionreference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionreference.php">＋<small>add a note</small></a></span>
