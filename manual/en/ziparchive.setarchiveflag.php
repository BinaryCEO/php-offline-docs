...
<head>
  ...
  <title>PHP: ZipArchive::setArchiveFlag - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setarchiveflag.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setarchiveflag.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setarchiveflag.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setarchivecomment.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setcommentindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setarchiveflag.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setarchiveflag.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setarchiveflag.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setarchiveflag.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setarchiveflag.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setarchiveflag.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setarchiveflag.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setarchiveflag.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setarchiveflag.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setarchiveflag.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setarchiveflag.php" hreflang="zh">
...
<meta name="Description" content="Set a global flag of a ZIP archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setArchiveFlag - Manual" />
<meta name="twitter:description" content="Set a global flag of a ZIP archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setArchiveFlag - Manual" />
<meta itemprop="description" content="Set a global flag of a ZIP archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a global flag of a ZIP archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ziparchive.setcommentindex.php">
          ZipArchive::setCommentIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setarchivecomment.php">
          &laquo; ZipArchive::setArchiveComment        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setarchiveflag.php' selected="selected">English</option>
            <option value='de/ziparchive.setarchiveflag.php'>German</option>
            <option value='es/ziparchive.setarchiveflag.php'>Spanish</option>
            <option value='fr/ziparchive.setarchiveflag.php'>French</option>
            <option value='it/ziparchive.setarchiveflag.php'>Italian</option>
            <option value='ja/ziparchive.setarchiveflag.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setarchiveflag.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setarchiveflag.php'>Russian</option>
            <option value='tr/ziparchive.setarchiveflag.php'>Turkish</option>
            <option value='uk/ziparchive.setarchiveflag.php'>Ukrainian</option>
            <option value='zh/ziparchive.setarchiveflag.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setarchiveflag" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::setArchiveFlag</h1>
  <p class="verinfo">(PHP &gt;= 8.3.0, PECL zip &gt;= 1.22.0)</p><p class="refpurpose"><span class="refname">ZipArchive::setArchiveFlag</span> &mdash; <span class="dc-title">Set a global flag of a ZIP archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.setarchiveflag-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::setArchiveFlag</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flag</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.setarchiveflag-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The global flag to change, among <code class="literal">AFL_*</code> constants.
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.setarchiveflag-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$res </span><span style="color: #007700">= </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">, </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">CREATE</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$res </span><span style="color: #007700">=== </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setArchiveFlag</span><span style="color: #007700">(</span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">AFL_WANT_TORRENTZIP</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFromString</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.txt'</span><span style="color: #007700">, </span><span style="color: #DD0000">'file content goes here'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">'ok'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'failed'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.setarchiveflag-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.getarchiveflag.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::getArchiveFlag()</a> - Returns the value of a Zip archive global flag</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setarchiveflag.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setarchiveflag%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setarchiveflag&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setarchiveflag.php">＋<small>add a note</small></a></span>
