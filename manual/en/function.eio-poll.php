...
<head>
  ...
  <title>PHP: eio_poll - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-poll.php">
 <link rel="shorturl" href="https://www.php.net/eio-poll">
 <link rel="alternate" href="https://www.php.net/eio-poll" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-poll.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-poll.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-poll.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-poll.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-poll.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-poll.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-poll.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-poll.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-poll.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-poll.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-poll.php" hreflang="zh">
...
<meta name="Description" content="Can be to be called whenever there are pending requests that need finishing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_poll - Manual" />
<meta name="twitter:description" content="Can be to be called whenever there are pending requests that need finishing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_poll - Manual" />
<meta itemprop="description" content="Can be to be called whenever there are pending requests that need finishing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Can be to be called whenever there are pending requests that need finishing" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-poll.php' selected="selected">English</option>
            <option value='de/function.eio-poll.php'>German</option>
            <option value='es/function.eio-poll.php'>Spanish</option>
            <option value='fr/function.eio-poll.php'>French</option>
            <option value='it/function.eio-poll.php'>Italian</option>
            <option value='ja/function.eio-poll.php'>Japanese</option>
            <option value='pt_BR/function.eio-poll.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-poll.php'>Russian</option>
            <option value='tr/function.eio-poll.php'>Turkish</option>
            <option value='uk/function.eio-poll.php'>Ukrainian</option>
            <option value='zh/function.eio-poll.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-poll" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-nreqs.php" class="function" rel="rdfs-seeAlso">eio_nreqs()</a> - Returns number of requests to be processed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-poll.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-poll%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-poll&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-poll.php">＋<small>add a note</small></a></span>
