...
<head>
  ...
  <title>PHP: SolrQuery::getFacetLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetlimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetlimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetlimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetlimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetlimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetlimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetlimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetlimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetlimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetlimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetlimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetlimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetlimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetlimit.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of constraint counts that should be returned for the facet fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetLimit - Manual" />
<meta name="twitter:description" content="Returns the maximum number of constraint counts that should be returned for the facet fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetLimit - Manual" />
<meta itemprop="description" content="Returns the maximum number of constraint counts that should be returned for the facet fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of constraint counts that should be returned for the facet fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetmethod.php">
          SolrQuery::getFacetMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetfields.php">
          &laquo; SolrQuery::getFacetFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetlimit.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetlimit.php'>German</option>
            <option value='es/solrquery.getfacetlimit.php'>Spanish</option>
            <option value='fr/solrquery.getfacetlimit.php'>French</option>
            <option value='it/solrquery.getfacetlimit.php'>Italian</option>
            <option value='ja/solrquery.getfacetlimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetlimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetlimit.php'>Russian</option>
            <option value='tr/solrquery.getfacetlimit.php'>Turkish</option>
            <option value='uk/solrquery.getfacetlimit.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetlimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetlimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetLimit</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetLimit</span> &mdash; <span class="dc-title">Returns the maximum number of constraint counts that should be returned for the facet fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetlimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetlimit-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetlimit-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetlimit.php">＋<small>add a note</small></a></span>
