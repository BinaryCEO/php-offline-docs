...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-blob-add.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-backup.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-blob-cancel.php">
...
<meta name="Description" content="Alias of ibase_blob_add" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_blob_add - Manual" />
<meta name="twitter:description" content="Alias of ibase_blob_add" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_blob_add - Manual" />
<meta itemprop="description" content="Alias of ibase_blob_add" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_blob_add" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-blob-add.php' selected="selected">English</option>
            ...
            <option value='zh/function.fbird-blob-add.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_blob_add</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-blob-add.php" class="function">ibase_blob_add()</a></span></span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fbird-blob-import.php" class="function" rel="rdfs-seeAlso">fbird_blob_import()</a> - Alias of ibase_blob_import</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-blob-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-blob-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-blob-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-blob-add.php">＋<small>add a note</small></a></span>
