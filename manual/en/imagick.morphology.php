...
<head>
  ...
  <title>PHP: Imagick::morphology - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.morphology.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.morphology.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.morphology.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.morphimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.mosaicimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.morphology.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.morphology.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.morphology.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.morphology.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.morphology.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.morphology.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.morphology.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.morphology.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.morphology.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.morphology.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.morphology.php" hreflang="zh">
...
<meta name="Description" content="Applies a user supplied kernel to the image according to the given morphology method." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::morphology - Manual" />
<meta name="twitter:description" content="Applies a user supplied kernel to the image according to the given morphology method." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::morphology - Manual" />
<meta itemprop="description" content="Applies a user supplied kernel to the image according to the given morphology method." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies a user supplied kernel to the image according to the given morphology method." />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.mosaicimages.php">
          Imagick::mosaicImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.morphimages.php">
          &laquo; Imagick::morphImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.morphology.php' selected="selected">English</option>
            <option value='de/imagick.morphology.php'>German</option>
            <option value='es/imagick.morphology.php'>Spanish</option>
            <option value='fr/imagick.morphology.php'>French</option>
            <option value='it/imagick.morphology.php'>Italian</option>
            <option value='ja/imagick.morphology.php'>Japanese</option>
            <option value='pt_BR/imagick.morphology.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.morphology.php'>Russian</option>
            <option value='tr/imagick.morphology.php'>Turkish</option>
            <option value='uk/imagick.morphology.php'>Ukrainian</option>
            <option value='zh/imagick.morphology.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.morphology" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::morphology</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::morphology</span> &mdash; <span class="dc-title">Applies a user supplied kernel to the image according to the given morphology method.</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.morphology-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::morphology</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$morphologyMethod</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$iterations</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imagickkernel.php" class="type ImagickKernel">ImagickKernel</a></span> <code class="parameter">$ImagickKernel</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.morphology-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">morphologyMethod</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.morphology-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.morphology-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3030">
      <p><strong>Example #1 Convolve <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacter</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_GAUSSIAN</span><span style="color: #007700">, </span><span style="color: #DD0000">"5,1"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CONVOLVE</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3031">
      <p><strong>Example #2 Correlate <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />        </span><span style="color: #FF8000">// Top-left pixel must be black<br />        // Bottom right pixel must be white<br />        // We don't care about the rest.<br />        <br /><br />        </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">(</span><span style="color: #0000BB">self</span><span style="color: #007700">::</span><span style="color: #0000BB">$correlateMatrix</span><span style="color: #007700">, [</span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">]);<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CORRELATE</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3032">
      <p><strong>Example #3 Erode <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_ERODE</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3033">
      <p><strong>Example #4 Erode Intensity <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacter</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"1"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_ERODE_INTENSITY</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3034">
      <p><strong>Example #5 Dilate <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_DILATE</span><span style="color: #007700">, </span><span style="color: #0000BB">4</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3035">
      <p><strong>Example #6 Dilate intensity <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacter</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"1"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_DILATE_INTENSITY</span><span style="color: #007700">, </span><span style="color: #0000BB">4</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3036">
      <p><strong>Example #7 Distance with Chebyshev kernel <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_CHEBYSHEV</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_DISTANCE</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">autoLevelImage</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3037">
      <p><strong>Example #8 Distance with Manhattan kernel <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
    ...
    <div class="example" id="example-3038">
      <p><strong>Example #9 Distance with ocatagonal kernel <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGONAL</span><span style="color: #007700">, </span><span style="color: #DD0000">"5"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_DISTANCE</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">autoLevelImage</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3039">
      <p><strong>Example #10 Distance with Euclidean kernel <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_EUCLIDEAN</span><span style="color: #007700">, </span><span style="color: #DD0000">"4"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_DISTANCE</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">autoLevelImage</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3040">
      <p><strong>Example #11 Edge <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_EDGE</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3041">
      <p><strong>Example #12 Open <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        </span><span style="color: #FF8000">// As a result you will see that 'Open' smoothed the outline, by rounding off any sharp points, and remove any parts that is smaller than the shape used. It will also disconnect or 'open' any thin bridges.<br />        </span><span style="color: #0000BB">$canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"6"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_OPEN</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3042">
      <p><strong>Example #13 Open intensity <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        </span><span style="color: #FF8000">// As a result you will see that 'Open' smoothed the outline, by rounding off any sharp points, and remove any parts that is smaller than the shape used. It will also disconnect or 'open' any thin bridges.<br /><br />        </span><span style="color: #0000BB">$canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacter</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"6"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_OPEN_INTENSITY</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3043">
      <p><strong>Example #14 Close <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        </span><span style="color: #FF8000">//The basic use of the 'Close' method is to reduce or remove any 'holes' or 'gaps' about the size of the kernel 'Structure Element'. That is 'close' parts of the background that are about that size.<br />        </span><span style="color: #0000BB">$canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"6"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CLOSE</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3044">
      <p><strong>Example #15 Close Intensity <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        </span><span style="color: #FF8000">//The basic use of the 'Close' method is to reduce or remove any 'holes' or 'gaps' about the size of the kernel 'Structure Element'. That is 'close' parts of the background that are about that size.<br />        </span><span style="color: #0000BB">$canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacter</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"6"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CLOSE_INTENSITY</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3045">
      <p><strong>Example #16 Smooth <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_SMOOTH</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3046">
      <p><strong>Example #17 Edge in <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_EDGE_IN</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3047">
      <p><strong>Example #18 Edge out <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_OCTAGON</span><span style="color: #007700">, </span><span style="color: #DD0000">"3"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_EDGE_OUT</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3048">
      <p><strong>Example #19 The &#039;TopHat&#039; method, or more specifically &#039;White Top Hat&#039;, returns the pixels that were removed by a Opening of the shape, that is the pixels that were removed to round off the points, and the connecting bridged between shapes. <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"5"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_TOP_HAT</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3049">
      <p><strong>Example #20 The &#039;BottomHat&#039; method, also known as &#039;Black TopHat&#039; is the pixels that a Closing of the shape adds to the image. That is the pixels that were used to fill in the &#039;holes&#039;, &#039;gaps&#039;, and &#039;bridges&#039;. <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"5"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_BOTTOM_HAT</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3050">
      <p><strong>Example #21 Hit and Miss <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #FF8000">//This finds all the pixels with 3 pixels of the right edge<br />        </span><span style="color: #0000BB">$matrix </span><span style="color: #007700">= [[</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">false</span><span style="color: #007700">, </span><span style="color: #0000BB">false</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]];<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">(<br />            </span><span style="color: #0000BB">$matrix</span><span style="color: #007700">,<br />            [</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]<br />        );<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_HIT_AND_MISS</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3051">
      <p><strong>Example #22 Thinning <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$leftEdgeKernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">([[</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">]], [</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br />        </span><span style="color: #0000BB">$rightEdgeKernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">([[</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]], [</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br />        </span><span style="color: #0000BB">$leftEdgeKernel</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addKernel</span><span style="color: #007700">(</span><span style="color: #0000BB">$rightEdgeKernel</span><span style="color: #007700">);<br />        <br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_THINNING</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$leftEdgeKernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3052">
      <p><strong>Example #23 Thicken <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$leftEdgeKernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">([[</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">]], [</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br />        </span><span style="color: #0000BB">$rightEdgeKernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromMatrix</span><span style="color: #007700">([[</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]], [</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br />        </span><span style="color: #0000BB">$leftEdgeKernel</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addKernel</span><span style="color: #007700">(</span><span style="color: #0000BB">$rightEdgeKernel</span><span style="color: #007700">);<br /><br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_THICKEN</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$leftEdgeKernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3053">
      <p><strong>Example #24 Thick to generate a convex hull <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$diamondKernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DIAMOND</span><span style="color: #007700">, </span><span style="color: #DD0000">"1"</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$convexKernel </span><span style="color: #007700">=  </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_CONVEX_HULL</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// The thicken morphology doesn't handle small gaps. We close them<br />        // with the close morphology.<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CLOSE</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$diamondKernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_THICKEN</span><span style="color: #007700">, -</span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$convexKernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_CLOSE</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$diamondKernel</span><span style="color: #007700">);<br /><br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3054">
      <p><strong>Example #25 Iterative morphology <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />        $canvas </span><span style="color: #007700">= </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$kernel </span><span style="color: #007700">= </span><span style="color: #0000BB">\ImagickKernel</span><span style="color: #007700">::</span><span style="color: #0000BB">fromBuiltIn</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">KERNEL_DISK</span><span style="color: #007700">, </span><span style="color: #DD0000">"2"</span><span style="color: #007700">);        <br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">morphology</span><span style="color: #007700">(</span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">MORPHOLOGY_ITERATIVE</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">$kernel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">autoLevelImage</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />        echo </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>

    </div>

    <div class="example" id="example-3055">
      <p><strong>Example #26 Helper function to get an image silhouette <span class="function"><strong>Imagick::morphology()</strong></span></strong></p>
      <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">getCharacterOutline</span><span style="color: #007700">() {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"./images/character.png"</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$character </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$character</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageWidth</span><span style="color: #007700">(),<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageHeight</span><span style="color: #007700">(),<br />        </span><span style="color: #DD0000">"canvas:white"<br />    </span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$canvas </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageWidth</span><span style="color: #007700">(),<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageHeight</span><span style="color: #007700">(),<br />        </span><span style="color: #DD0000">"canvas:black"<br />    </span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$character</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">compositeimage</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">,<br />        </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COMPOSITE_COPYOPACITY</span><span style="color: #007700">,<br />        </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0<br />    </span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">compositeimage</span><span style="color: #007700">(<br />        </span><span style="color: #0000BB">$character</span><span style="color: #007700">,<br />        </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COMPOSITE_ATOP</span><span style="color: #007700">,<br />        </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0<br />    </span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br />    return </span><span style="color: #0000BB">$canvas</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/morphology.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.morphology%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.morphology&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.morphology.php">＋<small>add a note</small></a></span>
