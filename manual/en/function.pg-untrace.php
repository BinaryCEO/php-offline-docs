...
<head>
  ...
  <title>PHP: pg_untrace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-untrace.php">
 <link rel="shorturl" href="https://www.php.net/pg-untrace">
 <link rel="alternate" href="https://www.php.net/pg-untrace" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-unescape-bytea.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-update.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-untrace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-untrace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-untrace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-untrace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-untrace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-untrace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-untrace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-untrace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-untrace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-untrace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-untrace.php" hreflang="zh">
...
<meta name="Description" content="Disable tracing of a PostgreSQL connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_untrace - Manual" />
<meta name="twitter:description" content="Disable tracing of a PostgreSQL connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_untrace - Manual" />
<meta itemprop="description" content="Disable tracing of a PostgreSQL connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Disable tracing of a PostgreSQL connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-untrace.php' selected="selected">English</option>
            <option value='de/function.pg-untrace.php'>German</option>
            <option value='es/function.pg-untrace.php'>Spanish</option>
            <option value='fr/function.pg-untrace.php'>French</option>
            <option value='it/function.pg-untrace.php'>Italian</option>
            <option value='ja/function.pg-untrace.php'>Japanese</option>
            <option value='pt_BR/function.pg-untrace.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-untrace.php'>Russian</option>
            <option value='tr/function.pg-untrace.php'>Turkish</option>
            <option value='uk/function.pg-untrace.php'>Ukrainian</option>
            <option value='zh/function.pg-untrace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-untrace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_untrace</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.1, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_untrace</span> &mdash; <span class="dc-title">Disable tracing of a PostgreSQL connection</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-untrace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_untrace</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Stop tracing started by <span class="function"><a href="function.pg-trace.php" class="function">pg_trace()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-untrace-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-untrace-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-untrace-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-untrace-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2124">
    <p><strong>Example #1 <span class="function"><strong>pg_untrace()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pgsql_conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=mark host=localhost"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) {<br />   </span><span style="color: #0000BB">pg_trace</span><span style="color: #007700">(</span><span style="color: #DD0000">'/tmp/trace.log'</span><span style="color: #007700">, </span><span style="color: #DD0000">'w'</span><span style="color: #007700">, </span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT 1"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_untrace</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   </span><span style="color: #FF8000">// Now tracing of backend communication is disabled<br /></span><span style="color: #007700">} else {<br />   print </span><span style="color: #0000BB">pg_last_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   exit;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-untrace-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-trace.php" class="function" rel="rdfs-seeAlso">pg_trace()</a> - Enable tracing a PostgreSQL connection</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-untrace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-untrace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-untrace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-untrace.php">＋<small>add a note</small></a></span>
