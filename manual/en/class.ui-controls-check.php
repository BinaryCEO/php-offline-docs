...
<head>
  ...
  <title>PHP: UI\Controls\Check - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-check.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-check">
 <link rel="alternate" href="https://www.php.net/ui-controls-check" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-tab.setmargin.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-check.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-check.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-check.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-check.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-check.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-check.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-check.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-check.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-check.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-check.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-check.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-check.php" hreflang="zh">
...
<meta name="Description" content="Check Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Check - Manual" />
<meta name="twitter:description" content="Check Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Check - Manual" />
<meta itemprop="description" content="Check Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ui-controls-check.construct.php">
          UI\Controls\Check::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-tab.setmargin.php">
          &laquo; UI\Controls\Tab::setMargin        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-check.php' selected="selected">English</option>
            <option value='de/class.ui-controls-check.php'>German</option>
            <option value='es/class.ui-controls-check.php'>Spanish</option>
            <option value='fr/class.ui-controls-check.php'>French</option>
            <option value='it/class.ui-controls-check.php'>Italian</option>
            <option value='ja/class.ui-controls-check.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-check.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-check.php'>Russian</option>
            <option value='tr/class.ui-controls-check.php'>Turkish</option>
            <option value='uk/class.ui-controls-check.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-check.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-check" class="reference">

 <h1 class="title">Check Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-check.intro">
  ...
  <div class="section" id="ui-controls-check.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Check</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-check.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>

    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-check.gettext.php" class="methodname">getText</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-check.ischecked.php" class="methodname">isChecked</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">protected</span> <span class="methodname"><a href="ui-controls-check.ontoggle.php" class="methodname">onToggle</a></span>()</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-check.setchecked.php" class="methodname">setChecked</a></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$checked</code></span>)</div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-check.settext.php" class="methodname">setText</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-check.construct.php">UI\Controls\Check::__construct</a> — Construct a new Check</li><li><a href="ui-controls-check.gettext.php">UI\Controls\Check::getText</a> — Get Text</li><li><a href="ui-controls-check.ischecked.php">UI\Controls\Check::isChecked</a> — Checked Detection</li><li><a href="ui-controls-check.ontoggle.php">UI\Controls\Check::onToggle</a> — Toggle Callback</li><li><a href="ui-controls-check.setchecked.php">UI\Controls\Check::setChecked</a> — Set Checked</li><li><a href="ui-controls-check.settext.php">UI\Controls\Check::setText</a> — Set Text</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.check.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-check%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-check&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-check.php">＋<small>add a note</small></a></span>
