...
<head>
  ...
  <title>PHP: posix_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-errno.php">
 <link rel="shorturl" href="https://www.php.net/posix-errno">
 <link rel="alternate" href="https://www.php.net/posix-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-eaccess.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-fpathconf.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-errno.php" hreflang="zh">
...
<meta name="Description" content="Alias of posix_get_last_error" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_errno - Manual" />
<meta name="twitter:description" content="Alias of posix_get_last_error" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_errno - Manual" />
<meta itemprop="description" content="Alias of posix_get_last_error" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of posix_get_last_error" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-fpathconf.php">
          posix_fpathconf &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-eaccess.php">
          &laquo; posix_eaccess        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-errno.php' selected="selected">English</option>
            <option value='de/function.posix-errno.php'>German</option>
            <option value='es/function.posix-errno.php'>Spanish</option>
            <option value='fr/function.posix-errno.php'>French</option>
            <option value='it/function.posix-errno.php'>Italian</option>
            <option value='ja/function.posix-errno.php'>Japanese</option>
            <option value='pt_BR/function.posix-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-errno.php'>Russian</option>
            <option value='tr/function.posix-errno.php'>Turkish</option>
            <option value='uk/function.posix-errno.php'>Ukrainian</option>
            <option value='zh/function.posix-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_errno</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_errno</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.posix-get-last-error.php" class="function">posix_get_last_error()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.posix-errno-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.posix-get-last-error.php" class="function">posix_get_last_error()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-errno.php">＋<small>add a note</small></a></span>
