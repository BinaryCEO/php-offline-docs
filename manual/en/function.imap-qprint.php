...
<head>
  ...
  <title>PHP: imap_qprint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-qprint.php">
 <link rel="shorturl" href="https://www.php.net/imap-qprint">
 <link rel="alternate" href="https://www.php.net/imap-qprint" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-ping.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-rename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-qprint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-qprint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-qprint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-qprint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-qprint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-qprint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-qprint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-qprint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-qprint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-qprint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-qprint.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-qprint.php' selected="selected">English</option>
            <option value='de/function.imap-qprint.php'>German</option>
            <option value='es/function.imap-qprint.php'>Spanish</option>
            <option value='fr/function.imap-qprint.php'>French</option>
            <option value='it/function.imap-qprint.php'>Italian</option>
            <option value='ja/function.imap-qprint.php'>Japanese</option>
            <option value='pt_BR/function.imap-qprint.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-qprint.php'>Russian</option>
            <option value='tr/function.imap-qprint.php'>Turkish</option>
            <option value='uk/function.imap-qprint.php'>Ukrainian</option>
            <option value='zh/function.imap-qprint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-qprint" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.imap-qprint-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_qprint</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Convert a quoted-printable string to an 8 bit string according to <a href="https://datatracker.ietf.org/doc/html/rfc2045" class="link external">&raquo;&nbsp;RFC2045</a>, section 6.7.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-qprint-returnvalues">
  ...
  <p class="para">
   Returns an 8 bits string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-8bit.php" class="function" rel="rdfs-seeAlso">imap_8bit()</a> - Convert an 8bit string to a quoted-printable string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-qprint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-qprint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-qprint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-qprint.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="4009">  <div class="votes">
    <div id="Vu4009">
    <a href="/manual/vote-note.php?id=4009&amp;page=function.imap-qprint&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd4009">
    <a href="/manual/vote-note.php?id=4009&amp;page=function.imap-qprint&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V4009" title="70% like this...">
    4
    </div>
  </div>
  <a href="#4009" class="name">
  <strong class="user"><em>bernard at bmpsystems dot com</em></strong></a><a class="genanchor" href="#4009"> &para;</a><div class="date" title="2000-02-26 12:35"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom4009">
<div class="phpcode"><code><span class="html">This function seems to have a bug, when the quoted-printable string contains a "=" without the HEX code of a Character.
<br />I use the regular quoted_printable_decode instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-qprint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-qprint.php">＋<small>add a note</small></a></div>
