...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pdorow.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/pdostatement.setfetchmode.php">
 <link rel="next" href="https://www.php.net/manual/en/class.pdoexception.php">
...
<meta name="Description" content="The PDORow class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PDORow - Manual" />
<meta name="twitter:description" content="The PDORow class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PDORow - Manual" />
<meta itemprop="description" content="The PDORow class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The PDORow class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdostatement.setfetchmode.php">
          &laquo; PDOStatement::setFetchMode        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pdorow.php' selected="selected">English</option>
            ...
            <option value='ja/class.pdorow.php'>Japanese</option>
 ...
 <h1 class="title">The PDORow class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8, PECL pdo &gt;= 1.0.0)</p>
  ...
  <div class="section" id="pdorow.intro">
   ...
   <p class="para">
    ...
    by <span class="methodname"><a href="pdostatement.fetch.php" class="methodname">PDOStatement::fetch()</a></span>
    called with <strong><code>PDO_FETCH_LAZY</code></strong> fetch mode.
   </p>
   <p class="para">
    Objects of this class cannot be instantiated and are not serializable.
   </p>
   <p class="para">
    The <span class="classname"><strong class="classname">PDORow</strong></span> object allows access
    to the returned data as if both <strong><code><a href="pdo.constants.php#pdo.constants.fetch-obj">PDO::FETCH_OBJ</a></code></strong>
    and <strong><code><a href="pdo.constants.php#pdo.constants.fetch-both">PDO::FETCH_BOTH</a></code></strong> mode was used.
   ...
   <div class="caution"><strong class="caution">Caution</strong>
    <p class="simpara">
     Accessing an undefined property returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>
  ...
  <div class="section" id="pdorow.props">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       Query string used by the <span class="classname"><a href="class.pdostatement.php" class="classname">PDOStatement</a></span>
       that returned the <span class="classname"><strong class="classname">PDORow</strong></span> object.
      </p>
     </dd>
  ...
  <div class="section">
   ...
   <p class="para">
    Throws an <span class="classname"><a href="class.error.php" class="classname">Error</a></span> when trying to
    write to or <span class="function"><a href="function.unset.php" class="function">unset()</a></span> any property.
   </p>
  </div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/pdorow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pdorow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pdorow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pdorow.php">＋<small>add a note</small></a></span>
