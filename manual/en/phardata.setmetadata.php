...
<head>
  ...
  <title>PHP: PharData::setMetadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.setmetadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.setmetadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.setmetadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.setdefaultstub.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.setsignaturealgorithm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.setmetadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.setmetadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.setmetadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.setmetadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.setmetadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.setmetadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.setmetadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.setmetadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.setmetadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.setmetadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.setmetadata.php" hreflang="zh">
...
<meta name="Description" content="Sets phar archive meta-data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::setMetadata - Manual" />
<meta name="twitter:description" content="Sets phar archive meta-data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::setMetadata - Manual" />
<meta itemprop="description" content="Sets phar archive meta-data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets phar archive meta-data" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phardata.setsignaturealgorithm.php">
          PharData::setSignatureAlgorithm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.setdefaultstub.php">
          &laquo; PharData::setDefaultStub        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.setmetadata.php' selected="selected">English</option>
            <option value='de/phardata.setmetadata.php'>German</option>
            <option value='es/phardata.setmetadata.php'>Spanish</option>
            <option value='fr/phardata.setmetadata.php'>French</option>
            <option value='it/phardata.setmetadata.php'>Italian</option>
            <option value='ja/phardata.setmetadata.php'>Japanese</option>
            <option value='pt_BR/phardata.setmetadata.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.setmetadata.php'>Russian</option>
            <option value='tr/phardata.setmetadata.php'>Turkish</option>
            <option value='uk/phardata.setmetadata.php'>Ukrainian</option>
            <option value='zh/phardata.setmetadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.setmetadata" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">PharData::setMetadata</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">PharData::setMetadata</span> &mdash; <span class="dc-title">Sets phar archive meta-data</span></p>
 ...
 <div class="refsect1 description" id="refsect1-phardata.setmetadata-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>PharData::setMetadata</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$metadata</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  ...
  <p class="para">
   <span class="function"><a href="phar.setmetadata.php" class="function">Phar::setMetadata()</a></span> should be used to store customized data
  ...
  <p class="para">
   ...
   like <a href="https://pear.php.net/" class="link external">&raquo;&nbsp;PEAR</a>&#039;s package.xml file.
 ...
 <div class="refsect1 examples" id="refsect1-phardata.setmetadata-examples">
  ...
  <p class="para">
   <div class="example" id="example-862">
    <p><strong>Example #1 A <span class="function"><a href="phar.setmetadata.php" class="function">Phar::setMetadata()</a></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.hasmetadata.php" class="function" rel="rdfs-seeAlso">Phar::hasMetadata()</a> - Returns whether phar has global meta-data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/setMetadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.setmetadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.setmetadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.setmetadata.php">＋<small>add a note</small></a></span>
