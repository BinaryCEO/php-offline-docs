...
<head>
  ...
  <title>PHP: posix_access - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-access.php">
 <link rel="shorturl" href="https://www.php.net/posix-access">
 <link rel="alternate" href="https://www.php.net/posix-access" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-ctermid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-access.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-access.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-access.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-access.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-access.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-access.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-access.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-access.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-access.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-access.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-access.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: posix_access - Manual" />
<meta name="twitter:description" content="Determine accessibility of a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_access - Manual" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-ctermid.php">
          posix_ctermid &raquo;
              ...
              <div class="prev">
        <a href="ref.posix.php">
          &laquo; POSIX Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-access.php' selected="selected">English</option>
            <option value='de/function.posix-access.php'>German</option>
            <option value='es/function.posix-access.php'>Spanish</option>
            <option value='fr/function.posix-access.php'>French</option>
            <option value='it/function.posix-access.php'>Italian</option>
            <option value='ja/function.posix-access.php'>Japanese</option>
            <option value='pt_BR/function.posix-access.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-access.php'>Russian</option>
            <option value='tr/function.posix-access.php'>Turkish</option>
            <option value='uk/function.posix-access.php'>Ukrainian</option>
            <option value='zh/function.posix-access.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-access" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-access-examples">
  ...
  <p class="para">
   <div class="example" id="example-3570">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.posix-strerror.php" class="function" rel="rdfs-seeAlso">posix_strerror()</a> - Retrieve the system error message associated with the given errno</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-access.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-access%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-access&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-access.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115212">  <div class="votes">
    <div id="Vu115212">
    <a href="/manual/vote-note.php?id=115212&amp;page=function.posix-access&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115212">
    <a href="/manual/vote-note.php?id=115212&amp;page=function.posix-access&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115212" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#115212" class="name">
  <strong class="user"><em>unixguy at earth dot com</em></strong></a><a class="genanchor" href="#115212"> &para;</a><div class="date" title="2014-06-12 08:00"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115212">
<div class="phpcode"><code><span class="html">It should be noted that this function performs access checks based on the real UID and real GID of the process running PHP.  These aren't necessarily the same as the effective UID and GID.<br /><br />In other words, it may well be that access() returns “true” for a particular permission, but an fopen() operation which requires the same permission will fail, and vice versa.<br /><br />Keep that in mind if you use access() for such checks.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-access&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-access.php">＋<small>add a note</small></a></div>
