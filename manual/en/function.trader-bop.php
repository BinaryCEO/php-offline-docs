...
<head>
  ...
  <title>PHP: trader_bop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-bop.php">
 <link rel="shorturl" href="https://www.php.net/trader-bop">
 <link rel="alternate" href="https://www.php.net/trader-bop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-beta.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cci.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-bop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-bop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-bop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-bop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-bop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-bop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-bop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-bop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-bop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-bop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-bop.php" hreflang="zh">
...
<meta name="Description" content="Balance Of Power" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_bop - Manual" />
<meta name="twitter:description" content="Balance Of Power" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_bop - Manual" />
<meta itemprop="description" content="Balance Of Power" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Balance Of Power" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-bop.php' selected="selected">English</option>
            <option value='de/function.trader-bop.php'>German</option>
            <option value='es/function.trader-bop.php'>Spanish</option>
            <option value='fr/function.trader-bop.php'>French</option>
            <option value='it/function.trader-bop.php'>Italian</option>
            <option value='ja/function.trader-bop.php'>Japanese</option>
            <option value='pt_BR/function.trader-bop.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-bop.php'>Russian</option>
            <option value='tr/function.trader-bop.php'>Turkish</option>
            <option value='uk/function.trader-bop.php'>Ukrainian</option>
            <option value='zh/function.trader-bop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-bop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_bop</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_bop</span> &mdash; <span class="dc-title">Balance Of Power</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-bop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_bop</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-bop-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-bop-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-bop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-bop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-bop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-bop.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125748">  <div class="votes">
    <div id="Vu125748">
    <a href="/manual/vote-note.php?id=125748&amp;page=function.trader-bop&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125748">
    <a href="/manual/vote-note.php?id=125748&amp;page=function.trader-bop&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125748" title="75% like this...">
    2
    </div>
  </div>
  <a href="#125748" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125748"> &para;</a><div class="date" title="2021-01-31 07:21"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125748">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$opens </span><span class="keyword">= array(</span><span class="default">135.83</span><span class="keyword">, </span><span class="default">139.52</span><span class="keyword">, </span><span class="default">143.43</span><span class="keyword">, </span><span class="default">143.6</span><span class="keyword">);<br /></span><span class="default">$highs </span><span class="keyword">= array(</span><span class="default">136.74</span><span class="keyword">, </span><span class="default">141.99</span><span class="keyword">, </span><span class="default">144.3</span><span class="keyword">, </span><span class="default">144.3</span><span class="keyword">);<br /></span><span class="default">$lows </span><span class="keyword">= array(</span><span class="default">130.21</span><span class="keyword">, </span><span class="default">136.7</span><span class="keyword">, </span><span class="default">140.41</span><span class="keyword">, </span><span class="default">141.37</span><span class="keyword">);<br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">131.96</span><span class="keyword">, </span><span class="default">137.09</span><span class="keyword">, </span><span class="default">142.06</span><span class="keyword">, </span><span class="default">143.16</span><span class="keyword">);<br /><br /></span><span class="comment">// (Close - Open) / (High - Low)<br /></span><span class="default">$Balance_Of_Power </span><span class="keyword">= </span><span class="default">trader_bop</span><span class="keyword">(</span><span class="default">$opens</span><span class="keyword">, </span><span class="default">$highs</span><span class="keyword">, </span><span class="default">$lows</span><span class="keyword">, </span><span class="default">$closes</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$Balance_Of_Power</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(4) {<br />  [0]=&gt;<br />  float(-0.593) // (131.96 - 135.83) / (136.74 - 130.21)<br />  [1]=&gt;<br />  float(-0.459) // (137.09 - 139.52) / (141.99 - 136.7)<br />  [2]=&gt;<br />  float(-0.352) // (142.06 - 143.43) / (144.3 - 140.41)<br />  [3]=&gt;<br />  float(-0.15)  // (143.16 - 143.6) / (144.3 - 141.37)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-bop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-bop.php">＋<small>add a note</small></a></div>
