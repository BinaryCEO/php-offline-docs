...
<head>
  ...
  <title>PHP: ZipArchive::setMtimeName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setmtimename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setmtimename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setmtimename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setmtimeindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setpassword.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setmtimename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setmtimename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setmtimename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setmtimename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setmtimename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setmtimename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setmtimename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setmtimename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setmtimename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setmtimename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setmtimename.php" hreflang="zh">
...
<meta name="Description" content="Set the modification time of an entry defined by its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setMtimeName - Manual" />
<meta name="twitter:description" content="Set the modification time of an entry defined by its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setMtimeName - Manual" />
<meta itemprop="description" content="Set the modification time of an entry defined by its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the modification time of an entry defined by its name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.setpassword.php">
          ZipArchive::setPassword &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setmtimeindex.php">
          &laquo; ZipArchive::setMtimeIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setmtimename.php' selected="selected">English</option>
            <option value='de/ziparchive.setmtimename.php'>German</option>
            <option value='es/ziparchive.setmtimename.php'>Spanish</option>
            <option value='fr/ziparchive.setmtimename.php'>French</option>
            <option value='it/ziparchive.setmtimename.php'>Italian</option>
            <option value='ja/ziparchive.setmtimename.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setmtimename.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setmtimename.php'>Russian</option>
            <option value='tr/ziparchive.setmtimename.php'>Turkish</option>
            <option value='uk/ziparchive.setmtimename.php'>Ukrainian</option>
            <option value='zh/ziparchive.setmtimename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setmtimename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::setMtimeName</h1>
  <p class="verinfo">(PHP &gt;= 8.0.0, PECL zip &gt;= 1.16.0)</p><p class="refpurpose"><span class="refname">ZipArchive::setMtimeName</span> &mdash; <span class="dc-title">Set the modification time of an entry defined by its name</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.setmtimename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::setMtimeName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timestamp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.setmtimename-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.setmtimename-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.setmtimename-examples">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">, </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">CREATE</span><span style="color: #007700">) === </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'text.txt'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setMtimeName</span><span style="color: #007700">(</span><span style="color: #DD0000">'text.txt'</span><span style="color: #007700">, </span><span style="color: #0000BB">mktime</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">0</span><span style="color: #007700">,</span><span style="color: #0000BB">12</span><span style="color: #007700">,</span><span style="color: #0000BB">25</span><span style="color: #007700">,</span><span style="color: #0000BB">2019</span><span style="color: #007700">));<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">"Ok\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"KO\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-ziparchive.setmtimename-notes">
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.setmtimename-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.setmtimeindex.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setMtimeIndex()</a> - Set the modification time of an entry defined by its index</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setmtimename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setmtimename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setmtimename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setmtimename.php">＋<small>add a note</small></a></span>
