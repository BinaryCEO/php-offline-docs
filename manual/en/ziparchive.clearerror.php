...
<head>
  ...
  <title>PHP: ZipArchive::clearError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.clearerror.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.clearerror.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.clearerror.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.addpattern.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.clearerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.clearerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.clearerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.clearerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.clearerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.clearerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.clearerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.clearerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.clearerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.clearerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.clearerror.php" hreflang="zh">
...
<meta name="Description" content="Clear the status error message, system and/or zip messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::clearError - Manual" />
<meta name="twitter:description" content="Clear the status error message, system and/or zip messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::clearError - Manual" />
<meta itemprop="description" content="Clear the status error message, system and/or zip messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clear the status error message, system and/or zip messages" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.close.php">
          ZipArchive::close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.addpattern.php">
          &laquo; ZipArchive::addPattern        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.clearerror.php' selected="selected">English</option>
            <option value='de/ziparchive.clearerror.php'>German</option>
            <option value='es/ziparchive.clearerror.php'>Spanish</option>
            <option value='fr/ziparchive.clearerror.php'>French</option>
            <option value='it/ziparchive.clearerror.php'>Italian</option>
            <option value='ja/ziparchive.clearerror.php'>Japanese</option>
            <option value='pt_BR/ziparchive.clearerror.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.clearerror.php'>Russian</option>
            <option value='tr/ziparchive.clearerror.php'>Turkish</option>
            <option value='uk/ziparchive.clearerror.php'>Ukrainian</option>
            <option value='zh/ziparchive.clearerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.clearerror" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::clearError</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.2.0, PECL zip &gt;= 1.20.0)</p><p class="refpurpose"><span class="refname">ZipArchive::clearError</span> &mdash; <span class="dc-title">Clear the status error message, system and/or zip messages</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.clearerror-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::clearError</strong></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.clearerror-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-ziparchive.clearerror-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.clearerror-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.getstatusstring.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::getStatusString()</a> - Returns the status error message, system and/or zip messages</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/clearerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.clearerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.clearerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.clearerror.php">＋<small>add a note</small></a></span>
