...
<head>
  ...
  <title>PHP: odbc_cursor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-cursor.php">
 <link rel="shorturl" href="https://www.php.net/odbc-cursor">
 <link rel="alternate" href="https://www.php.net/odbc-cursor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-connection-string-should-quote.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-data-source.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-cursor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-cursor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-cursor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-cursor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-cursor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-cursor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-cursor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-cursor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-cursor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-cursor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-cursor.php" hreflang="zh">
...
<meta name="Description" content="Get cursorname" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_cursor - Manual" />
<meta name="twitter:description" content="Get cursorname" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_cursor - Manual" />
<meta itemprop="description" content="Get cursorname" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get cursorname" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.odbc-data-source.php">
          odbc_data_source &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-connection-string-should-quote.php">
          &laquo; odbc_connection_string_should_quote        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-cursor.php' selected="selected">English</option>
            <option value='de/function.odbc-cursor.php'>German</option>
            <option value='es/function.odbc-cursor.php'>Spanish</option>
            <option value='fr/function.odbc-cursor.php'>French</option>
            <option value='it/function.odbc-cursor.php'>Italian</option>
            <option value='ja/function.odbc-cursor.php'>Japanese</option>
            <option value='pt_BR/function.odbc-cursor.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-cursor.php'>Russian</option>
            <option value='tr/function.odbc-cursor.php'>Turkish</option>
            <option value='uk/function.odbc-cursor.php'>Ukrainian</option>
            <option value='zh/function.odbc-cursor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-cursor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_cursor</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_cursor</span> &mdash; <span class="dc-title">Get cursorname</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-cursor-returnvalues">
  ...
  <p class="para">
   Returns the cursor name, as a string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-cursor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-cursor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-cursor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-cursor.php">＋<small>add a note</small></a></span>
