...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-quickprop-mu.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-quickprop-decay.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-rprop-decrease-factor.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-quickprop-mu.php' selected="selected">English</option>
            ...
            <option value='ja/function.fann-get-quickprop-mu.php'>Japanese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-quickprop-mu.php" class="function" rel="rdfs-seeAlso">fann_set_quickprop_mu()</a> - Sets the quickprop mu factor</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-quickprop-mu.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-quickprop-mu%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-quickprop-mu&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-quickprop-mu.php">＋<small>add a note</small></a></span>
