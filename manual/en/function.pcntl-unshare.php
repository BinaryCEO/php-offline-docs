...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pcntl-unshare.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-strerror.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pcntl-wait.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pcntl-unshare.php' selected="selected">English</option>
            ...
            <option value='tr/function.pcntl-unshare.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pcntl-get-last-error.php" class="function" rel="rdfs-seeAlso">pcntl_get_last_error()</a> - Retrieve the error number set by the last pcntl function which failed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcntl/functions/pcntl-unshare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pcntl-unshare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pcntl-unshare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-unshare.php">＋<small>add a note</small></a></span>
