...
<head>
  ...
  <title>PHP: mcrypt_generic_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-generic-init.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-generic-init">
 <link rel="alternate" href="https://www.php.net/mcrypt-generic-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-generic-deinit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-get-block-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-generic-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-generic-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-generic-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-generic-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-generic-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-generic-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-generic-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-generic-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-generic-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-generic-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-generic-init.php" hreflang="zh">
...
<meta name="Description" content="This function initializes all buffers needed for encryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_generic_init - Manual" />
<meta name="twitter:description" content="This function initializes all buffers needed for encryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_generic_init - Manual" />
<meta itemprop="description" content="This function initializes all buffers needed for encryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="This function initializes all buffers needed for encryption" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-get-block-size.php">
          mcrypt_get_block_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-generic-deinit.php">
          &laquo; mcrypt_generic_deinit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-generic-init.php' selected="selected">English</option>
            <option value='de/function.mcrypt-generic-init.php'>German</option>
            <option value='es/function.mcrypt-generic-init.php'>Spanish</option>
            <option value='fr/function.mcrypt-generic-init.php'>French</option>
            <option value='it/function.mcrypt-generic-init.php'>Italian</option>
            <option value='ja/function.mcrypt-generic-init.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-generic-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-generic-init.php'>Russian</option>
            <option value='tr/function.mcrypt-generic-init.php'>Turkish</option>
            <option value='uk/function.mcrypt-generic-init.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-generic-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-generic-init" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mcrypt-module-open.php" class="function" rel="rdfs-seeAlso">mcrypt_module_open()</a> - Opens the module of the algorithm and the mode to be used</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-generic-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-generic-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-generic-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-generic-init.php">＋<small>add a note</small></a></span>
