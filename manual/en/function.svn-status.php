...
<head>
  ...
  <title>PHP: svn_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-status.php">
 <link rel="shorturl" href="https://www.php.net/svn-status">
 <link rel="alternate" href="https://www.php.net/svn-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-revert.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-update.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-status.php" hreflang="zh">
...
<meta name="Description" content="Returns the status of working copy files and directories" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_status - Manual" />
<meta name="twitter:description" content="Returns the status of working copy files and directories" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_status - Manual" />
<meta itemprop="description" content="Returns the status of working copy files and directories" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the status of working copy files and directories" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-update.php">
          svn_update &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-revert.php">
          &laquo; svn_revert        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-status.php' selected="selected">English</option>
            <option value='de/function.svn-status.php'>German</option>
            <option value='es/function.svn-status.php'>Spanish</option>
            <option value='fr/function.svn-status.php'>French</option>
            <option value='it/function.svn-status.php'>Italian</option>
            <option value='ja/function.svn-status.php'>Japanese</option>
            <option value='pt_BR/function.svn-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-status.php'>Russian</option>
            <option value='tr/function.svn-status.php'>Turkish</option>
            <option value='uk/function.svn-status.php'>Ukrainian</option>
            <option value='zh/function.svn-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-status" class="refentry">
...
<div class="returnvaluescode"><pre class="returnvaluescode">Array (
  ...
  <dl>
    ...
    <dt><var class="varname">text_status</var></dt>
     <dd>
      <span class="simpara">
       Status of item&#039;s text. Refer to <a href="svn.constants.php#svn.constants.status" class="link">status constants</a> for possible values.
      </span>
     </dd>
    ...
    <dt><var class="varname">repos_text_status</var></dt>
     <dd>
      <span class="simpara">
       ...
       Refer to <a href="svn.constants.php#svn.constants.status" class="link">status constants</a> for possible values.
      </span>
     </dd>
    ...
    <dt><var class="varname">prop_status</var></dt>
     <dd>
      <span class="simpara">
       Status of item&#039;s properties. Refer to <a href="svn.constants.php#svn.constants.status" class="link">status constants</a> for possible values.
      </span>
     </dd>
    ...
    <dt><var class="varname">repos_prop_status</var></dt>
     <dd>
      <span class="simpara">
       ...
       <code class="parameter">update</code> was set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>. Refer to <a href="svn.constants.php#svn.constants.status" class="link">status constants</a> for possible values.
      </span>
     </dd>
  ...
  <dl>
    ...
    <dt><var class="varname">kind</var></dt>
     <dd>
      <span class="simpara">
       Type of item, i.e. file or directory. Refer to <a href="svn.constants.php#svn.constants.type" class="link">type constants</a> for possible values.
      </span>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.status.html" class="link external">&raquo;&nbsp;SVN documentation for svn status</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-status.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104986">  <div class="votes">
    <div id="Vu104986">
    <a href="/manual/vote-note.php?id=104986&amp;page=function.svn-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104986">
    <a href="/manual/vote-note.php?id=104986&amp;page=function.svn-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104986" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#104986" class="name">
  <strong class="user"><em>matthijs at fragfrog dot nl</em></strong></a><a class="genanchor" href="#104986"> &para;</a><div class="date" title="2011-07-20 01:03"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104986">
<div class="phpcode"><code><span class="html">There seems to be an undocumented function svn_info (arguably the proper name for this functionality) that does almost the same as svn_status, but ignores the second parameter.<br /><br />Unfortunately, neither can directly be used to just retrieve the current revision of a working copy, but a combination of svn_status and SVN_NON_RECURSIVE|SVN_ALL will work; simply perform the following command:<br /><br /><span class="default">&lt;?php<br />svn_status</span><span class="keyword">(</span><span class="default">ROOT</span><span class="keyword">,  </span><span class="default">SVN_NON_RECURSIVE</span><span class="keyword">|</span><span class="default">SVN_ALL</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Where ROOT is of course the root of the working directory you wish to examine. One of the entries will be that working directory, including its current status.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-status.php">＋<small>add a note</small></a></div>
