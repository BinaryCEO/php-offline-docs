...
<head>
  ...
  <title>PHP: socket_getpeername - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-getpeername.php">
 <link rel="shorturl" href="https://www.php.net/socket-getpeername">
 <link rel="alternate" href="https://www.php.net/socket-getpeername" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-getopt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-getsockname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-getpeername.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-getpeername.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-getpeername.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-getpeername.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-getpeername.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-getpeername.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-getpeername.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-getpeername.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-getpeername.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-getpeername.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-getpeername.php" hreflang="zh">
...
<meta name="Description" content="Queries the remote side of the given socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_getpeername - Manual" />
<meta name="twitter:description" content="Queries the remote side of the given socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_getpeername - Manual" />
<meta itemprop="description" content="Queries the remote side of the given socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Queries the remote side of the given socket" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.socket-getsockname.php">
          socket_getsockname &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-getopt.php">
          &laquo; socket_getopt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-getpeername.php' selected="selected">English</option>
            <option value='de/function.socket-getpeername.php'>German</option>
            <option value='es/function.socket-getpeername.php'>Spanish</option>
            <option value='fr/function.socket-getpeername.php'>French</option>
            <option value='it/function.socket-getpeername.php'>Italian</option>
            <option value='ja/function.socket-getpeername.php'>Japanese</option>
            <option value='pt_BR/function.socket-getpeername.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-getpeername.php'>Russian</option>
            <option value='tr/function.socket-getpeername.php'>Turkish</option>
            <option value='uk/function.socket-getpeername.php'>Ukrainian</option>
            <option value='zh/function.socket-getpeername.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-getpeername" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_getpeername</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_getpeername</span> &mdash; <span class="dc-title">Queries the remote side of the given socket</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.socket-getpeername-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If the given socket is of type <strong><code><a href="sockets.constants.php#constant.af-inet">AF_INET</a></code></strong> or
       <strong><code><a href="sockets.constants.php#constant.af-inet6">AF_INET6</a></code></strong>, <span class="function"><strong>socket_getpeername()</strong></span>
       will return the peers (remote) <em>IP address</em> in
       appropriate notation (e.g. <code class="literal">127.0.0.1</code> or
       <code class="literal">fe80::1</code>) in the <code class="parameter">address</code>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-getpeername-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. <span class="function"><strong>socket_getpeername()</strong></span> may also return
 ...
 <div class="refsect1 notes" id="refsect1-function.socket-getpeername-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <strong><code><a href="sockets.constants.php#constant.af-unix">AF_UNIX</a></code></strong> sockets created with <span class="function"><a href="function.socket-accept.php" class="function">socket_accept()</a></span>.
    Only sockets created with <span class="function"><a href="function.socket-connect.php" class="function">socket_connect()</a></span> or a primary
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-getpeername-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.socket-getsockname.php" class="function" rel="rdfs-seeAlso">socket_getsockname()</a> - Queries the local side of the given socket which may either result in host/port or in a Unix filesystem path, dependent on its type</span></li>
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-getpeername.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-getpeername%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-getpeername&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-getpeername.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="35656">  <div class="votes">
    <div id="Vu35656">
    <a href="/manual/vote-note.php?id=35656&amp;page=function.socket-getpeername&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd35656">
    <a href="/manual/vote-note.php?id=35656&amp;page=function.socket-getpeername&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V35656" title="54% like this...">
    3
    </div>
  </div>
  <a href="#35656" class="name">
  <strong class="user"><em>redph0enix at hotmail dot com</em></strong></a><a class="genanchor" href="#35656"> &para;</a><div class="date" title="2003-09-09 08:57"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom35656">
<div class="phpcode"><code><span class="html">socket_getpeername will not work for UDP sockets. Instead, use socket_recvfrom - it provides the IP address and port of the source server - eg:<br /><br />$size=socket_recvfrom($socket,$input,65535,0,$ipaddress,$port);<br />echo "Received [$input] ($size bytes) from IP $ipaddress Port $port\n";</span></code></div>
  </div>
 </div>
  <div class="note" id="118984">  <div class="votes">
    <div id="Vu118984">
    <a href="/manual/vote-note.php?id=118984&amp;page=function.socket-getpeername&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118984">
    <a href="/manual/vote-note.php?id=118984&amp;page=function.socket-getpeername&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118984" title="60% like this...">
    2
    </div>
  </div>
  <a href="#118984" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#118984"> &para;</a><div class="date" title="2016-03-12 01:06"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118984">
<div class="phpcode"><code><span class="html">The reason it won't work for UDP is that UDP is stateless; logically there are no peers other than at the time a packet is sent or received. Or more strictly, a UDP socket can interact with 0..N peers.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-getpeername&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-getpeername.php">＋<small>add a note</small></a></div>
