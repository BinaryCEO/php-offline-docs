...
<head>
  ...
  <title>PHP: date_parse_from_format - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-parse-from-format.php">
 <link rel="shorturl" href="https://www.php.net/date-parse-from-format">
 <link rel="alternate" href="https://www.php.net/date-parse-from-format" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-parse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-sub.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-parse-from-format.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-parse-from-format.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-parse-from-format.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-parse-from-format.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-parse-from-format.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-parse-from-format.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-parse-from-format.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-parse-from-format.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-parse-from-format.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-parse-from-format.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-parse-from-format.php" hreflang="zh">
...
<meta name="Description" content="Get info about given date formatted according to the specified format" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_parse_from_format - Manual" />
<meta name="twitter:description" content="Get info about given date formatted according to the specified format" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_parse_from_format - Manual" />
<meta itemprop="description" content="Get info about given date formatted according to the specified format" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get info about given date formatted according to the specified format" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-parse-from-format.php' selected="selected">English</option>
            <option value='de/function.date-parse-from-format.php'>German</option>
            <option value='es/function.date-parse-from-format.php'>Spanish</option>
            <option value='fr/function.date-parse-from-format.php'>French</option>
            <option value='it/function.date-parse-from-format.php'>Italian</option>
            <option value='ja/function.date-parse-from-format.php'>Japanese</option>
            <option value='pt_BR/function.date-parse-from-format.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-parse-from-format.php'>Russian</option>
            <option value='tr/function.date-parse-from-format.php'>Turkish</option>
            <option value='uk/function.date-parse-from-format.php'>Ukrainian</option>
            <option value='zh/function.date-parse-from-format.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-parse-from-format" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$date </span><span style="color: #007700">= </span><span style="color: #DD0000">"26 August 2022 22:30 pm"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$parsed </span><span style="color: #007700">= </span><span style="color: #0000BB">date_parse_from_format</span><span style="color: #007700">(</span><span style="color: #DD0000">"j F Y G:i a"</span><span style="color: #007700">, </span><span style="color: #0000BB">$date</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #DD0000">"Warnings count: "</span><span style="color: #007700">, </span><span style="color: #0000BB">$parsed</span><span style="color: #007700">[</span><span style="color: #DD0000">'warning_count'</span><span style="color: #007700">], </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />foreach (</span><span style="color: #0000BB">$parsed</span><span style="color: #007700">[</span><span style="color: #DD0000">'warnings'</span><span style="color: #007700">] as </span><span style="color: #0000BB">$position </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$message</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"\tOn position </span><span style="color: #007700">{</span><span style="color: #0000BB">$position</span><span style="color: #007700">}</span><span style="color: #DD0000">: </span><span style="color: #007700">{</span><span style="color: #0000BB">$message</span><span style="color: #007700">}</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Warnings count: 1
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$date </span><span style="color: #007700">= </span><span style="color: #DD0000">"26 August 2022 CEST"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$parsed </span><span style="color: #007700">= </span><span style="color: #0000BB">date_parse_from_format</span><span style="color: #007700">(</span><span style="color: #DD0000">"j F Y H:i"</span><span style="color: #007700">, </span><span style="color: #0000BB">$date</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #DD0000">"Errors count: "</span><span style="color: #007700">, </span><span style="color: #0000BB">$parsed</span><span style="color: #007700">[</span><span style="color: #DD0000">'error_count'</span><span style="color: #007700">], </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />foreach (</span><span style="color: #0000BB">$parsed</span><span style="color: #007700">[</span><span style="color: #DD0000">'errors'</span><span style="color: #007700">] as </span><span style="color: #0000BB">$position </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$message</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"\tOn position </span><span style="color: #007700">{</span><span style="color: #0000BB">$position</span><span style="color: #007700">}</span><span style="color: #DD0000">: </span><span style="color: #007700">{</span><span style="color: #0000BB">$message</span><span style="color: #007700">}</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Errors count: 3
	On position 15: A two digit hour could not be found
	On position 19: Data missing</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.checkdate.php" class="function" rel="rdfs-seeAlso">checkdate()</a> - Validate a Gregorian date</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-parse-from-format.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-parse-from-format%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-parse-from-format&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-parse-from-format.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129810">  <div class="votes">
    <div id="Vu129810">
    <a href="/manual/vote-note.php?id=129810&amp;page=function.date-parse-from-format&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129810">
    <a href="/manual/vote-note.php?id=129810&amp;page=function.date-parse-from-format&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129810" title="no votes...">
    0
    </div>
  </div>
  <a href="#129810" class="name">
  <strong class="user"><em>jp dot amarok at email dot cz</em></strong></a><a class="genanchor" href="#129810"> &para;</a><div class="date" title="2024-10-18 05:17"><strong>11 months ago</strong></div>
  <div class="text" id="Hcom129810">
<div class="phpcode"><code><span class="html">It seems that the safest way to check for errors is not by checking the number of errors, but warnings instead. See the following example where "m" and "d" are swapped and thus not correct.<br /><br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">( </span><span class="default">date_parse_from_format</span><span class="keyword">(</span><span class="string">'m.d.Y'</span><span class="keyword">, </span><span class="string">'18.10.2024'</span><span class="keyword">) );<br /><br /></span><span class="default">OUTPUT</span><span class="keyword">:<br />array(</span><span class="default">12</span><span class="keyword">) {<br />  [</span><span class="string">"year"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">2024</span><span class="keyword">)<br />  [</span><span class="string">"month"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">18</span><span class="keyword">)<br />  [</span><span class="string">"day"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">10</span><span class="keyword">)<br />  [</span><span class="string">"hour"</span><span class="keyword">]=&gt;<br />  </span><span class="default">bool</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">)<br />  [</span><span class="string">"minute"</span><span class="keyword">]=&gt;<br />  </span><span class="default">bool</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">)<br />  [</span><span class="string">"second"</span><span class="keyword">]=&gt;<br />  </span><span class="default">bool</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">)<br />  [</span><span class="string">"fraction"</span><span class="keyword">]=&gt;<br />  </span><span class="default">bool</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">)<br />  [</span><span class="string">"warning_count"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">)<br />  [</span><span class="string">"warnings"</span><span class="keyword">]=&gt;<br />  array(</span><span class="default">1</span><span class="keyword">) {<br />    [</span><span class="default">10</span><span class="keyword">]=&gt;<br />    </span><span class="default">string</span><span class="keyword">(</span><span class="default">27</span><span class="keyword">) </span><span class="string">"The parsed date was invalid"<br />  </span><span class="keyword">}<br />  [</span><span class="string">"error_count"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">)<br />  [</span><span class="string">"errors"</span><span class="keyword">]=&gt;<br />  array(</span><span class="default">0</span><span class="keyword">) {<br />  }<br />  [</span><span class="string">"is_localtime"</span><span class="keyword">]=&gt;<br />  </span><span class="default">bool</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">)<br />}<br /></span><span class="default">?&gt;<br /></span><br />The function simply assigns 18 to the "month" field without errors!! So simply use an if-condition and check "warning_count" to detect possible errors.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.date-parse-from-format&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-parse-from-format.php">＋<small>add a note</small></a></div>
