...
<head>
  ...
  <title>PHP: SplFileObject::fscanf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileobject.fscanf.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileobject.fscanf.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fscanf.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileobject.fread.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileobject.fseek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/splfileobject.fscanf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/splfileobject.fscanf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/splfileobject.fscanf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/splfileobject.fscanf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/splfileobject.fscanf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/splfileobject.fscanf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/splfileobject.fscanf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/splfileobject.fscanf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/splfileobject.fscanf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/splfileobject.fscanf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/splfileobject.fscanf.php" hreflang="zh">
...
<meta name="Description" content="Parses input from file according to a format" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileObject::fscanf - Manual" />
<meta name="twitter:description" content="Parses input from file according to a format" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileObject::fscanf - Manual" />
<meta itemprop="description" content="Parses input from file according to a format" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parses input from file according to a format" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="splfileobject.fseek.php">
          SplFileObject::fseek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="splfileobject.fread.php">
          &laquo; SplFileObject::fread        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileobject.fscanf.php' selected="selected">English</option>
            <option value='de/splfileobject.fscanf.php'>German</option>
            <option value='es/splfileobject.fscanf.php'>Spanish</option>
            <option value='fr/splfileobject.fscanf.php'>French</option>
            <option value='it/splfileobject.fscanf.php'>Italian</option>
            <option value='ja/splfileobject.fscanf.php'>Japanese</option>
            <option value='pt_BR/splfileobject.fscanf.php'>Brazilian Portuguese</option>
            <option value='ru/splfileobject.fscanf.php'>Russian</option>
            <option value='tr/splfileobject.fscanf.php'>Turkish</option>
            <option value='uk/splfileobject.fscanf.php'>Ukrainian</option>
            <option value='zh/splfileobject.fscanf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="splfileobject.fscanf" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-splfileobject.fscanf-examples">
  ...
  <p class="para">
   <div class="example" id="example-4004">
    <p><strong>Example #1 <span class="methodname"><strong>SplFileObject::fscanf()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.sprintf.php" class="function" rel="rdfs-seeAlso">sprintf()</a> - Return a formatted string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileobject/fscanf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileobject.fscanf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileobject.fscanf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileobject.fscanf.php">＋<small>add a note</small></a></span>
