...
<head>
  ...
  <title>PHP: ImagickDraw::setTextAntialias - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextdecoration.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextantialias.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextantialias.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextantialias.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextantialias.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextantialias.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextantialias.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextantialias.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextantialias.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextantialias.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextantialias.php" hreflang="zh">
...
<meta name="Description" content="Controls whether text is antialiased" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextAntialias - Manual" />
<meta name="twitter:description" content="Controls whether text is antialiased" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextAntialias - Manual" />
<meta itemprop="description" content="Controls whether text is antialiased" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Controls whether text is antialiased" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.settextdecoration.php">
          ImagickDraw::setTextDecoration &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextalignment.php">
          &laquo; ImagickDraw::setTextAlignment        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextantialias.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextantialias.php'>German</option>
            <option value='es/imagickdraw.settextantialias.php'>Spanish</option>
            <option value='fr/imagickdraw.settextantialias.php'>French</option>
            <option value='it/imagickdraw.settextantialias.php'>Italian</option>
            <option value='ja/imagickdraw.settextantialias.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextantialias.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextantialias.php'>Russian</option>
            <option value='tr/imagickdraw.settextantialias.php'>Turkish</option>
            <option value='uk/imagickdraw.settextantialias.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextantialias.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextantialias" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextAntialias</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextAntialias</span> &mdash; <span class="dc-title">Controls whether text is antialiased</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextantialias-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextAntialias</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$antialias</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextantialias-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">antialias</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextantialias-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3192">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextantialias.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextantialias%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextantialias&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextantialias.php">＋<small>add a note</small></a></span>
