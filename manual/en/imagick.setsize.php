...
<head>
  ...
  <title>PHP: Imagick::setSize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setsizeoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setsize.php" hreflang="zh">
...
<meta name="Description" content="Sets the size of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setSize - Manual" />
<meta name="twitter:description" content="Sets the size of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setSize - Manual" />
<meta itemprop="description" content="Sets the size of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the size of the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setsizeoffset.php">
          Imagick::setSizeOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setsamplingfactors.php">
          &laquo; Imagick::setSamplingFactors        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setsize.php' selected="selected">English</option>
            <option value='de/imagick.setsize.php'>German</option>
            <option value='es/imagick.setsize.php'>Spanish</option>
            <option value='fr/imagick.setsize.php'>French</option>
            <option value='it/imagick.setsize.php'>Italian</option>
            <option value='ja/imagick.setsize.php'>Japanese</option>
            <option value='pt_BR/imagick.setsize.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setsize.php'>Russian</option>
            <option value='tr/imagick.setsize.php'>Turkish</option>
            <option value='uk/imagick.setsize.php'>Ukrainian</option>
            <option value='zh/imagick.setsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setSize</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setSize</span> &mdash; <span class="dc-title">Sets the size of the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setSize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setsize-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setsize-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setsize.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110166">  <div class="votes">
    <div id="Vu110166">
    <a href="/manual/vote-note.php?id=110166&amp;page=imagick.setsize&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110166">
    <a href="/manual/vote-note.php?id=110166&amp;page=imagick.setsize&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110166" title="66% like this...">
    4
    </div>
  </div>
  <a href="#110166" class="name">
  <strong class="user"><em>Mike Pratt</em></strong></a><a class="genanchor" href="#110166"> &para;</a><div class="date" title="2012-09-25 05:48"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom110166">
<div class="phpcode"><code><span class="html">Using setSize before reading an image file tells ImageMagick to resize the image immediately on load - this can give a substantial increase in performance time and save memory and disk resources for large images:<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setSize</span><span class="keyword">(</span><span class="default">800</span><span class="keyword">,</span><span class="default">600</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />This might also save you having to call thumbnailImage to resize the image. <br /><br />On my server, this only made a difference with jpgs - pngs and gifs were loaded at full size which took much longer (30s or more compared to 6s for a similar sized jpg).</span></code></div>
  </div>
 </div>
  <div class="note" id="120912">  <div class="votes">
    <div id="Vu120912">
    <a href="/manual/vote-note.php?id=120912&amp;page=imagick.setsize&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120912">
    <a href="/manual/vote-note.php?id=120912&amp;page=imagick.setsize&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120912" title="57% like this...">
    3
    </div>
  </div>
  <a href="#120912" class="name">
  <strong class="user"><em>Ade</em></strong></a><a class="genanchor" href="#120912"> &para;</a><div class="date" title="2017-03-31 09:40"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120912">
<div class="phpcode"><code><span class="html">This function is not working for me at all.<br />I am trying to generate Images from a PDF and this function does literally NOTHING, even it returns 'true'.....</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setsize.php">＋<small>add a note</small></a></div>
