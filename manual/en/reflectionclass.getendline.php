...
<head>
  ...
  <title>PHP: ReflectionClass::getEndLine - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getendline.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getendline.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getendline.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getdoccomment.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getextension.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getendline.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getendline.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getendline.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getendline.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getendline.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getendline.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getendline.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getendline.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getendline.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getendline.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getendline.php" hreflang="zh">
...
<meta name="Description" content="Gets end line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getEndLine - Manual" />
<meta name="twitter:description" content="Gets end line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getEndLine - Manual" />
<meta itemprop="description" content="Gets end line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets end line" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getextension.php">
          ReflectionClass::getExtension &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getdoccomment.php">
          &laquo; ReflectionClass::getDocComment        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getendline.php' selected="selected">English</option>
            <option value='de/reflectionclass.getendline.php'>German</option>
            <option value='es/reflectionclass.getendline.php'>Spanish</option>
            <option value='fr/reflectionclass.getendline.php'>French</option>
            <option value='it/reflectionclass.getendline.php'>Italian</option>
            <option value='ja/reflectionclass.getendline.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getendline.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getendline.php'>Russian</option>
            <option value='tr/reflectionclass.getendline.php'>Turkish</option>
            <option value='uk/reflectionclass.getendline.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getendline.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getendline" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getEndLine</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getEndLine</span> &mdash; <span class="dc-title">Gets end line</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionclass.getendline-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getEndLine</strong></span>(): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getendline-returnvalues">
  ...
  <p class="para">
   The ending line number of the user defined class, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if unknown.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getendline-examples">
  ...
  <p class="para">
   <div class="example" id="example-5476">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::getEndLine()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">3</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getendline-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getstartline.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getStartLine()</a> - Gets starting line number</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getendline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getendline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getendline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getendline.php">＋<small>add a note</small></a></span>
