...
<head>
  ...
  <title>PHP: sodium_crypto_sign_ed25519_pk_to_curve25519 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign-ed25519-pk-to-curve25519">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign-ed25519-pk-to-curve25519" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-sign-detached.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-sk-to-curve25519.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php" hreflang="zh">
...
<meta name="Description" content="Convert an Ed25519 public key to a Curve25519 public key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_sign_ed25519_pk_to_curve25519 - Manual" />
<meta name="twitter:description" content="Convert an Ed25519 public key to a Curve25519 public key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_sign_ed25519_pk_to_curve25519 - Manual" />
<meta itemprop="description" content="Convert an Ed25519 public key to a Curve25519 public key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert an Ed25519 public key to a Curve25519 public key" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-sign-ed25519-sk-to-curve25519.php">
          sodium_crypto_sign_ed25519_sk_to_curve25519 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-sign-detached.php">
          &laquo; sodium_crypto_sign_detached        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>German</option>
            <option value='es/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>French</option>
            <option value='it/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign-ed25519-pk-to-curve25519" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_sign_ed25519_pk_to_curve25519</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_sign_ed25519_pk_to_curve25519</span> &mdash; <span class="dc-title">Convert an Ed25519 public key to a Curve25519 public key</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-ed25519-pk-to-curve25519-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign_ed25519_pk_to_curve25519</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$public_key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-sign-ed25519-pk-to-curve25519-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-sign-ed25519-pk-to-curve25519-returnvalues">
  ...
  <p class="para">
   Public key suitable for the crypto_box functions.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign-ed25519-pk-to-curve25519.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign-ed25519-pk-to-curve25519%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-ed25519-pk-to-curve25519&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-pk-to-curve25519.php">＋<small>add a note</small></a></span>
