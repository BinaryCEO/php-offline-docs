...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.link.php">
 <link rel="shorturl" href="https://www.php.net/link">
 <link rel="alternate" href="https://www.php.net/link" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.lchown.php">
 <link rel="next" href="https://www.php.net/manual/en/function.linkinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.link.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.link.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.link.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.link.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.link.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.link.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.link.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.link.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.link.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.link.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.link.php" hreflang="zh">
...
<meta name="Description" content="Create a hard link" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: link - Manual" />
<meta name="twitter:description" content="Create a hard link" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: link - Manual" />
<meta itemprop="description" content="Create a hard link" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a hard link" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.link.php' selected="selected">English</option>
            <option value='de/function.link.php'>German</option>
            <option value='es/function.link.php'>Spanish</option>
            <option value='fr/function.link.php'>French</option>
            <option value='it/function.link.php'>Italian</option>
            <option value='ja/function.link.php'>Japanese</option>
            <option value='pt_BR/function.link.php'>Brazilian Portuguese</option>
            <option value='ru/function.link.php'>Russian</option>
            <option value='tr/function.link.php'>Turkish</option>
            <option value='uk/function.link.php'>Ukrainian</option>
            <option value='zh/function.link.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.link" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.unlink.php" class="function" rel="rdfs-seeAlso">unlink()</a> - Deletes a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/link.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.link%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.link&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.link.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="68583">  <div class="votes">
    <div id="Vu68583">
    <a href="/manual/vote-note.php?id=68583&amp;page=function.link&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68583">
    <a href="/manual/vote-note.php?id=68583&amp;page=function.link&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68583" title="50% like this...">
    0
    </div>
  </div>
  <a href="#68583" class="name">
  <strong class="user"><em>Jasper Bekkers</em></strong></a><a class="genanchor" href="#68583"> &para;</a><div class="date" title="2006-08-02 07:16"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68583">
<div class="phpcode"><code><span class="html">For a backup utility I needed link-like functionality on a windows system. As it isn't availible on windows, i tried to do it myself with the help of some tools. All you need is junction.exe from sysinternals in your %PATH%.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if(!</span><span class="default">function_exists</span><span class="keyword">(</span><span class="string">'link'</span><span class="keyword">)){ </span><span class="comment">// Assume a windows system<br />    </span><span class="keyword">function </span><span class="default">link</span><span class="keyword">(</span><span class="default">$target</span><span class="keyword">, </span><span class="default">$link</span><span class="keyword">){<br />        if(</span><span class="default">is_dir</span><span class="keyword">(</span><span class="default">$target</span><span class="keyword">)){<br />            </span><span class="comment">// junctions link to directories in windows<br />            </span><span class="default">exec</span><span class="keyword">(</span><span class="string">"junction </span><span class="default">$link</span><span class="string"> </span><span class="default">$target</span><span class="string">"</span><span class="keyword">, </span><span class="default">$lines</span><span class="keyword">, </span><span class="default">$val</span><span class="keyword">);<br />            return </span><span class="default">0 </span><span class="keyword">== </span><span class="default">$val</span><span class="keyword">;<br />        }elseif(</span><span class="default">is_file</span><span class="keyword">(</span><span class="default">$target</span><span class="keyword">)){<br />            </span><span class="comment">// Hardlinks link to files in windows<br />            </span><span class="default">exec</span><span class="keyword">(</span><span class="string">"fsutil hardlink create </span><span class="default">$link</span><span class="string"> </span><span class="default">$target</span><span class="string">"</span><span class="keyword">, </span><span class="default">$lines</span><span class="keyword">, </span><span class="default">$val</span><span class="keyword">);<br />            return </span><span class="default">0 </span><span class="keyword">== </span><span class="default">$val</span><span class="keyword">;<br />        }<br />        <br />        return </span><span class="default">false</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;<br /></span><br /><a href="http://www.sysinternals.com/Utilities/Junction.html" rel="nofollow" target="_blank">http://www.sysinternals.com/Utilities/Junction.html</a></span></code></div>
  </div>
 </div>
  <div class="note" id="94097">  <div class="votes">
    <div id="Vu94097">
    <a href="/manual/vote-note.php?id=94097&amp;page=function.link&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94097">
    <a href="/manual/vote-note.php?id=94097&amp;page=function.link&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94097" title="49% like this...">
    -1
    </div>
  </div>
  <a href="#94097" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#94097"> &para;</a><div class="date" title="2009-10-16 01:54"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94097">
<div class="phpcode"><code><span class="html">to clarify:<br /><br />in unix/linux:<br />hardlinks (by this function) cannot go across different filesystems.<br />softlinks can point anywhere.<br /><br />in linux, hardlinking to directory is not permited.</span></code></div>
  </div>
 </div>
  <div class="note" id="65155">  <div class="votes">
    <div id="Vu65155">
    <a href="/manual/vote-note.php?id=65155&amp;page=function.link&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd65155">
    <a href="/manual/vote-note.php?id=65155&amp;page=function.link&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V65155" title="48% like this...">
    -1
    </div>
  </div>
  <a href="#65155" class="name">
  <strong class="user"><em>Guilherme Garnier</em></strong></a><a class="genanchor" href="#65155"> &para;</a><div class="date" title="2006-04-25 11:32"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom65155">
<div class="phpcode"><code><span class="html">I noticed that, differently from Unix ln command, the second parameter can´t be a directory name, i.e., if you want to create a link with the same filename of the target file (obviously on different directories), you must specify the filename on the link parameter.<br /><br />Example:<br />Unix ln command:<br />ln /dir1/file /dir2/   // ok, creates /dir2/file link<br /><br />PHP link function:<br />link ("/dir1/file", "/dir2/");   // wrong, gives a "File exists" warning<br />link ("/dir1/file", "/dir2/file");   // ok, creates /dir2/file link</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.link&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.link.php">＋<small>add a note</small></a></div>
