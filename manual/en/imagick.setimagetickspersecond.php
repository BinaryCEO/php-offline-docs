...
<head>
  ...
  <title>PHP: Imagick::setImageTicksPerSecond - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagescene.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagetype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagetickspersecond.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagetickspersecond.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagetickspersecond.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagetickspersecond.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagetickspersecond.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagetickspersecond.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagetickspersecond.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagetickspersecond.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagetickspersecond.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagetickspersecond.php" hreflang="zh">
...
<meta name="Description" content="Sets the image ticks-per-second" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageTicksPerSecond - Manual" />
<meta name="twitter:description" content="Sets the image ticks-per-second" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageTicksPerSecond - Manual" />
<meta itemprop="description" content="Sets the image ticks-per-second" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image ticks-per-second" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagetype.php">
          Imagick::setImageType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagescene.php">
          &laquo; Imagick::setImageScene        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagetickspersecond.php' selected="selected">English</option>
            <option value='de/imagick.setimagetickspersecond.php'>German</option>
            <option value='es/imagick.setimagetickspersecond.php'>Spanish</option>
            <option value='fr/imagick.setimagetickspersecond.php'>French</option>
            <option value='it/imagick.setimagetickspersecond.php'>Italian</option>
            <option value='ja/imagick.setimagetickspersecond.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagetickspersecond.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagetickspersecond.php'>Russian</option>
            <option value='tr/imagick.setimagetickspersecond.php'>Turkish</option>
            <option value='uk/imagick.setimagetickspersecond.php'>Ukrainian</option>
            <option value='zh/imagick.setimagetickspersecond.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagetickspersecond" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageTicksPerSecond</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageTicksPerSecond</span> &mdash; <span class="dc-title">Sets the image ticks-per-second</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagetickspersecond-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageTicksPerSecond</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$ticks_per_second</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   ...
   <p class="para">
    ...
    with an argument of <code class="literal">50</code> the frames are adjusted to be
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagetickspersecond-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">ticks_per_second</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagetickspersecond-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimagetickspersecond-examples">
    <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3102">
    <p><strong>Example #1 Modify animated Gif with <span class="function"><strong>Imagick::setImageTicksPerSecond()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Modify an animated gif so the first half of the gif is played at half the<br />// speed it currently is, and the second half to be played at double the speed<br />// it currently is<br /><br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #DD0000">"Test.gif"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">coalesceImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$totalFrames </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getNumberImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$frameCount </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br /><br />foreach (</span><span style="color: #0000BB">$imagick </span><span style="color: #007700">as </span><span style="color: #0000BB">$frame</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageTicksPerSecond</span><span style="color: #007700">(</span><span style="color: #0000BB">50</span><span style="color: #007700">);<br />    <br />    if (</span><span style="color: #0000BB">$frameCount </span><span style="color: #007700">&lt; (</span><span style="color: #0000BB">$totalFrames </span><span style="color: #007700">/ </span><span style="color: #0000BB">2</span><span style="color: #007700">)) {<br />        </span><span style="color: #FF8000">// Modify the frame to be displayed for twice as long as it currently is<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageTicksPerSecond</span><span style="color: #007700">(</span><span style="color: #0000BB">50</span><span style="color: #007700">);<br />    } else {<br />        </span><span style="color: #FF8000">// Modify the frame to be displayed for half as long as it currently is<br />        </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageTicksPerSecond</span><span style="color: #007700">(</span><span style="color: #0000BB">200</span><span style="color: #007700">);<br />    }<br /><br />    </span><span style="color: #0000BB">$frameCount</span><span style="color: #007700">++;<br />}<br /><br /></span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">deconstructImages</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImages</span><span style="color: #007700">(</span><span style="color: #DD0000">"/path/to/save/output.gif"</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagetickspersecond.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagetickspersecond%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagetickspersecond&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagetickspersecond.php">＋<small>add a note</small></a></span>
