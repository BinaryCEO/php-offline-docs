...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-set-version.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-set-value.php">
 <link rel="next" href="https://www.php.net/manual/en/book.gnupg.php">
...
<meta name="Description" content="Sets version number for a FDF file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_set_version - Manual" />
<meta name="twitter:description" content="Sets version number for a FDF file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_set_version - Manual" />
<meta itemprop="description" content="Sets version number for a FDF file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets version number for a FDF file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-set-version.php' selected="selected">English</option>
            <option value='de/function.fdf-set-version.php'>German</option>
            <option value='es/function.fdf-set-version.php'>Spanish</option>
            <option value='fr/function.fdf-set-version.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_set_version</span> &mdash; <span class="dc-title">Sets version number for a FDF file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-set-version-description">
  ...
  <p class="para rdfs-comment">
   Sets the FDF <code class="parameter">version</code> for the given document.
  </p>
  <p class="para">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       either <code class="literal">1.2</code>, <code class="literal">1.3</code> or
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-set-version-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-get-version.php" class="function" rel="rdfs-seeAlso">fdf_get_version()</a> - Gets version number for FDF API or file</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-set-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-set-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-set-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-set-version.php">＋<small>add a note</small></a></span>
