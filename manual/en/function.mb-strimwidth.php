...
<head>
  ...
  <title>PHP: mb_strimwidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strimwidth.php">
 <link rel="shorturl" href="https://www.php.net/mb-strimwidth">
 <link rel="alternate" href="https://www.php.net/mb-strimwidth" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strcut.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-stripos.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-strimwidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-strimwidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-strimwidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-strimwidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-strimwidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-strimwidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-strimwidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-strimwidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-strimwidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-strimwidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-strimwidth.php" hreflang="zh">
...
<meta name="Description" content="Get truncated string with specified width" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_strimwidth - Manual" />
<meta name="twitter:description" content="Get truncated string with specified width" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strimwidth - Manual" />
<meta itemprop="description" content="Get truncated string with specified width" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get truncated string with specified width" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-stripos.php">
          mb_stripos &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strimwidth.php' selected="selected">English</option>
            <option value='de/function.mb-strimwidth.php'>German</option>
            <option value='es/function.mb-strimwidth.php'>Spanish</option>
            <option value='fr/function.mb-strimwidth.php'>French</option>
            <option value='it/function.mb-strimwidth.php'>Italian</option>
            <option value='ja/function.mb-strimwidth.php'>Japanese</option>
            <option value='pt_BR/function.mb-strimwidth.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-strimwidth.php'>Russian</option>
            <option value='tr/function.mb-strimwidth.php'>Turkish</option>
            <option value='uk/function.mb-strimwidth.php'>Ukrainian</option>
            <option value='zh/function.mb-strimwidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-strimwidth" class="refentry">
...
encoding value will be used.</p>
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-strimwidth-examples">
  ...
  <p class="para">
   <div class="example" id="example-2787">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-internal-encoding.php" class="function" rel="rdfs-seeAlso">mb_internal_encoding()</a> - Set/Get internal character encoding</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strimwidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strimwidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strimwidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strimwidth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128386">  <div class="votes">
    <div id="Vu128386">
    <a href="/manual/vote-note.php?id=128386&amp;page=function.mb-strimwidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128386">
    <a href="/manual/vote-note.php?id=128386&amp;page=function.mb-strimwidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128386" title="57% like this...">
    1
    </div>
  </div>
  <a href="#128386" class="name">
  <strong class="user"><em>dregad at NOSPAM-mantisbt dot org</em></strong></a><a class="genanchor" href="#128386"> &para;</a><div class="date" title="2023-04-12 01:54"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128386">
<div class="phpcode"><code><span class="html">I see a lot of usage in the field where people rely on this function to truncate a string to a given length and append some chars at the end following example #1 in the above documentation.<br /><br />While this works just fine with Western alphabets, it should be noted that a string's width is NOT necessarily the same as its length.<br /><br />In Chinese, Japanese and Korean, some characters can be represented as full or half width, which may lead to unexpected results...<br /><br /><span class="default">&lt;?php<br />$str </span><span class="keyword">= [</span><span class="string">'English' </span><span class="keyword">=&gt; </span><span class="string">'Switzerland'</span><span class="keyword">,<br />        </span><span class="string">'Half width' </span><span class="keyword">=&gt; </span><span class="string">'ｽｲｽ'</span><span class="keyword">,<br />        </span><span class="string">'Full width' </span><span class="keyword">=&gt; </span><span class="string">'スイス'</span><span class="keyword">,<br />       ];<br />foreach (</span><span class="default">$str </span><span class="keyword">as </span><span class="default">$w </span><span class="keyword">=&gt; </span><span class="default">$s</span><span class="keyword">) {<br />    </span><span class="default">printf</span><span class="keyword">(</span><span class="string">"%-10s: %s (bytes=%d chars=%d width=%d)\nSubstring : %s\nTrim width: %s\n\n"</span><span class="keyword">,<br />        </span><span class="default">$w</span><span class="keyword">, </span><span class="default">$s</span><span class="keyword">,<br />        </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">), </span><span class="default">mb_strlen</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">), </span><span class="default">mb_strwidth</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">),<br />        </span><span class="default">mb_substr</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">),<br />        </span><span class="default">mb_strimwidth</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">)<br />    );<br />}<br /></span><span class="comment">/* Output<br /># With ASCII, chars == width, so everything works as expected<br />English   : Switzerland (bytes=11 chars=11 width=11)<br />Substring : Swi<br />Trim width: Swi<br /><br /># With half-width katakanas, it works too<br />Half width: ｽｲｽ (bytes=9 chars=3 width=3)<br />Substring : ｽｲｽ<br />Trim width: ｽｲｽ<br /><br /># Full-width katakanas are twice as wide, so we only get the 1st 'su' !<br />Full width: スイス (bytes=9 chars=3 width=6)<br />Substring : スイス<br />Trim width: ス<br />*/<br /></span><span class="keyword">&gt;?</span></span></code></div>
  </div>
 </div>
  <div class="note" id="128931">  <div class="votes">
    <div id="Vu128931">
    <a href="/manual/vote-note.php?id=128931&amp;page=function.mb-strimwidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128931">
    <a href="/manual/vote-note.php?id=128931&amp;page=function.mb-strimwidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128931" title="50% like this...">
    0
    </div>
  </div>
  <a href="#128931" class="name">
  <strong class="user"><em>jamesgrimshaw2006 at gmail dot com</em></strong></a><a class="genanchor" href="#128931"> &para;</a><div class="date" title="2023-10-05 09:56"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom128931">
<div class="phpcode"><code><span class="html">mb_strimwidth will only append "trim_marker" if the string is over the width.<br /><br />*test code*<br />     $HashTags = 'Results';<br />     $socialmediatext = 'abcdefghijklmnopqrstuvwxyz';<br />     for( $i=0; $i&lt;=20; $i++ )<br />     {<br />         $socialmediatext .= '.';<br />         $Twittext = mb_strimwidth($socialmediatext,0,35,$HashTags);<br />         echo "&lt;p&gt;[".strlen($Twittext)."]$Twittext&lt;/p&gt;";<br />     }<br /><br />*output*<br />[27]abcdefghijklmnopqrstuvwxyz.<br />[28]abcdefghijklmnopqrstuvwxyz..<br />[29]abcdefghijklmnopqrstuvwxyz...<br />[30]abcdefghijklmnopqrstuvwxyz....<br />[31]abcdefghijklmnopqrstuvwxyz.....<br />[32]abcdefghijklmnopqrstuvwxyz......<br />[33]abcdefghijklmnopqrstuvwxyz.......<br />[34]abcdefghijklmnopqrstuvwxyz........<br />[35]abcdefghijklmnopqrstuvwxyz.........<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results<br />[35]abcdefghijklmnopqrstuvwxyz..Results</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-strimwidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strimwidth.php">＋<small>add a note</small></a></div>
