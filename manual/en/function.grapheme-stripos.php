...
<head>
  ...
  <title>PHP: grapheme_stripos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.grapheme-stripos.php">
 <link rel="shorturl" href="https://www.php.net/grapheme-stripos">
 <link rel="alternate" href="https://www.php.net/grapheme-stripos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.intl.grapheme.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.grapheme-str-split.php">
 <link rel="next" href="https://www.php.net/manual/en/function.grapheme-stristr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.grapheme-stripos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.grapheme-stripos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.grapheme-stripos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.grapheme-stripos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.grapheme-stripos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.grapheme-stripos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.grapheme-stripos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.grapheme-stripos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.grapheme-stripos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.grapheme-stripos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.grapheme-stripos.php" hreflang="zh">
...
<meta name="Description" content="Find position (in grapheme units) of first occurrence of a case-insensitive string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: grapheme_stripos - Manual" />
<meta name="twitter:description" content="Find position (in grapheme units) of first occurrence of a case-insensitive string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: grapheme_stripos - Manual" />
<meta itemprop="description" content="Find position (in grapheme units) of first occurrence of a case-insensitive string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find position (in grapheme units) of first occurrence of a case-insensitive string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.grapheme-stristr.php">
          grapheme_stristr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.grapheme-str-split.php">
          &laquo; grapheme_str_split        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.grapheme-stripos.php' selected="selected">English</option>
            <option value='de/function.grapheme-stripos.php'>German</option>
            <option value='es/function.grapheme-stripos.php'>Spanish</option>
            <option value='fr/function.grapheme-stripos.php'>French</option>
            <option value='it/function.grapheme-stripos.php'>Italian</option>
            <option value='ja/function.grapheme-stripos.php'>Japanese</option>
            <option value='pt_BR/function.grapheme-stripos.php'>Brazilian Portuguese</option>
            <option value='ru/function.grapheme-stripos.php'>Russian</option>
            <option value='tr/function.grapheme-stripos.php'>Turkish</option>
            <option value='uk/function.grapheme-stripos.php'>Ukrainian</option>
            <option value='zh/function.grapheme-stripos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.grapheme-stripos" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.grapheme-stripos-examples">
  ...
  <div class="example" id="example-2683">
   <p><strong>Example #1 <span class="function"><strong>grapheme_stripos()</strong></span> example</strong></p>
    ...
    <li>
     <a href="http://unicode.org/reports/tr29/#Grapheme_Cluster_Boundaries" class="link external">&raquo;&nbsp;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/grapheme/grapheme-stripos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.grapheme-stripos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.grapheme-stripos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.grapheme-stripos.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122884">  <div class="votes">
    <div id="Vu122884">
    <a href="/manual/vote-note.php?id=122884&amp;page=function.grapheme-stripos&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122884">
    <a href="/manual/vote-note.php?id=122884&amp;page=function.grapheme-stripos&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122884" title="50% like this...">
    0
    </div>
  </div>
  <a href="#122884" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#122884"> &para;</a><div class="date" title="2018-06-26 06:12"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122884">
<div class="phpcode"><code><span class="html">As expected, grapheme_stripos() does return boolean FALSE if the needle is not found in the haystack.<br />Use strict type comparison to check for that condition, like:<br /><br />if (FALSE === grapheme_stripos('a', 'b')) {print 'Needle not found';}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.grapheme-stripos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.grapheme-stripos.php">＋<small>add a note</small></a></div>
