...
<head>
  ...
  <title>PHP: A comparison of mysqlnd plugins with MySQL Proxy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlnd.plugin.mysql-proxy.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlnd.plugin.mysql-proxy.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.plugin.mysql-proxy.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqlnd.plugin.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlnd.plugin.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlnd.plugin.obtaining.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.plugin.mysql-proxy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlnd.plugin.mysql-proxy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlnd.plugin.mysql-proxy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlnd.plugin.mysql-proxy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlnd.plugin.mysql-proxy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlnd.plugin.mysql-proxy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlnd.plugin.mysql-proxy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlnd.plugin.mysql-proxy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlnd.plugin.mysql-proxy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlnd.plugin.mysql-proxy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlnd.plugin.mysql-proxy.php" hreflang="zh">
...
<meta name="Description" content="A comparison of mysqlnd plugins with MySQL Proxy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: A comparison of mysqlnd plugins with MySQL Proxy - Manual" />
<meta name="twitter:description" content="A comparison of mysqlnd plugins with MySQL Proxy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: A comparison of mysqlnd plugins with MySQL Proxy - Manual" />
<meta itemprop="description" content="A comparison of mysqlnd plugins with MySQL Proxy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="A comparison of mysqlnd plugins with MySQL Proxy" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqlnd.plugin.obtaining.php">
          Obtaining the mysqlnd plugin API &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqlnd.plugin.php">
          &laquo; MySQL Native Driver Plugin API        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlnd.plugin.mysql-proxy.php' selected="selected">English</option>
            <option value='de/mysqlnd.plugin.mysql-proxy.php'>German</option>
            <option value='es/mysqlnd.plugin.mysql-proxy.php'>Spanish</option>
            <option value='fr/mysqlnd.plugin.mysql-proxy.php'>French</option>
            <option value='it/mysqlnd.plugin.mysql-proxy.php'>Italian</option>
            <option value='ja/mysqlnd.plugin.mysql-proxy.php'>Japanese</option>
            <option value='pt_BR/mysqlnd.plugin.mysql-proxy.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlnd.plugin.mysql-proxy.php'>Russian</option>
            <option value='tr/mysqlnd.plugin.mysql-proxy.php'>Turkish</option>
            <option value='uk/mysqlnd.plugin.mysql-proxy.php'>Ukrainian</option>
            <option value='zh/mysqlnd.plugin.mysql-proxy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlnd.plugin.mysql-proxy" class="section">
  ...
  <p class="para">
   ...
   changes to the plugin itself.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlnd.plugin.mysql-proxy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlnd.plugin.mysql-proxy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlnd.plugin.mysql-proxy.php">＋<small>add a note</small></a></span>
