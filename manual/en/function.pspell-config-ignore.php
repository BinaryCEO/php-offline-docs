...
<head>
  ...
  <title>PHP: pspell_config_ignore - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-config-ignore.php">
 <link rel="shorturl" href="https://www.php.net/pspell-config-ignore">
 <link rel="alternate" href="https://www.php.net/pspell-config-ignore" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-config-dict-dir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-config-mode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-config-ignore.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-config-ignore.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-config-ignore.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-config-ignore.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-config-ignore.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-config-ignore.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-config-ignore.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-config-ignore.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-config-ignore.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-config-ignore.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-config-ignore.php" hreflang="zh">
...
<meta name="Description" content="Ignore words less than N characters long" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_config_ignore - Manual" />
<meta name="twitter:description" content="Ignore words less than N characters long" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_config_ignore - Manual" />
<meta itemprop="description" content="Ignore words less than N characters long" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Ignore words less than N characters long" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-config-mode.php">
          pspell_config_mode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-config-dict-dir.php">
          &laquo; pspell_config_dict_dir        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-config-ignore.php' selected="selected">English</option>
            <option value='de/function.pspell-config-ignore.php'>German</option>
            <option value='es/function.pspell-config-ignore.php'>Spanish</option>
            <option value='fr/function.pspell-config-ignore.php'>French</option>
            <option value='it/function.pspell-config-ignore.php'>Italian</option>
            <option value='ja/function.pspell-config-ignore.php'>Japanese</option>
            <option value='pt_BR/function.pspell-config-ignore.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-config-ignore.php'>Russian</option>
            <option value='tr/function.pspell-config-ignore.php'>Turkish</option>
            <option value='uk/function.pspell-config-ignore.php'>Ukrainian</option>
            <option value='zh/function.pspell-config-ignore.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-config-ignore" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pspell_config_ignore</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pspell_config_ignore</span> &mdash; <span class="dc-title">Ignore words less than N characters long</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pspell-config-ignore-description">
  ...
  <p class="simpara">
   <span class="function"><strong>pspell_config_ignore()</strong></span> should be used on a config
 ...
 <div class="refsect1 parameters" id="refsect1-function.pspell-config-ignore-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Words less than <code class="parameter">min_length</code> characters will be skipped.
      </p>
     </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell_config </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_config_create</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_config_ignore</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new_config</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">, </span><span style="color: #DD0000">"abcd"</span><span style="color: #007700">);    </span><span style="color: #FF8000">//will not result in an error<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-config-ignore.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-config-ignore%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-config-ignore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-config-ignore.php">＋<small>add a note</small></a></span>
