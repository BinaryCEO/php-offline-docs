...
<head>
  ...
  <title>PHP: Phar::decompress - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.decompress.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.decompress.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.decompress.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.createdefaultstub.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.decompressfiles.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.decompress.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.decompress.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.decompress.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.decompress.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.decompress.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.decompress.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.decompress.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.decompress.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.decompress.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.decompress.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.decompress.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Phar::decompress - Manual" />
<meta name="twitter:description" content="Decompresses the entire Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::decompress - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.decompressfiles.php">
          Phar::decompressFiles &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.createdefaultstub.php">
          &laquo; Phar::createDefaultStub        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.decompress.php' selected="selected">English</option>
            <option value='de/phar.decompress.php'>German</option>
            <option value='es/phar.decompress.php'>Spanish</option>
            <option value='fr/phar.decompress.php'>French</option>
            <option value='it/phar.decompress.php'>Italian</option>
            <option value='ja/phar.decompress.php'>Japanese</option>
            <option value='pt_BR/phar.decompress.php'>Brazilian Portuguese</option>
            <option value='ru/phar.decompress.php'>Russian</option>
            <option value='tr/phar.decompress.php'>Turkish</option>
            <option value='uk/phar.decompress.php'>Ukrainian</option>
            <option value='zh/phar.decompress.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.decompress" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::decompress</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::decompress</span> &mdash; <span class="dc-title">Decompresses the entire Phar archive</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.decompress-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::decompress</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$extension</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.phar.php" class="type Phar">Phar</a></span></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  ...
  <p class="para">
   ...
   <code class="literal">.phar</code>
   by default for phar archives, or <code class="literal">.phar.tar</code> for tar-based phar archives.
 ...
 <div class="refsect1 parameters" id="refsect1-phar.decompress-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       that all executable phar archives must contain <code class="literal">.phar</code>
       in their filename.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.decompress-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="classname"><a href="class.phar.php" class="classname">Phar</a></span> object is returned on success, and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-phar.decompress-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-phar.decompress-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-phar.decompress-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-814">
    <p><strong>Example #1 A <span class="function"><strong>Phar::decompress()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$p </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/my.phar'</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">'my.phar.gz'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">[</span><span style="color: #DD0000">'myfile.txt'</span><span style="color: #007700">] = </span><span style="color: #DD0000">'hi'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">[</span><span style="color: #DD0000">'myfile2.txt'</span><span style="color: #007700">] = </span><span style="color: #DD0000">'hi'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$p3 </span><span style="color: #007700">= </span><span style="color: #0000BB">$p2</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">decompress</span><span style="color: #007700">(); </span><span style="color: #FF8000">// creates /path/to/my.phar<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.decompress-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.decompressfiles.php" class="function" rel="rdfs-seeAlso">Phar::decompressFiles()</a> - Decompresses all files in the current Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/decompress.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.decompress%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.decompress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.decompress.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119244">  <div class="votes">
    <div id="Vu119244">
    <a href="/manual/vote-note.php?id=119244&amp;page=phar.decompress&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119244">
    <a href="/manual/vote-note.php?id=119244&amp;page=phar.decompress&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119244" title="50% like this...">
    0
    </div>
  </div>
  <a href="#119244" class="name">
  <strong class="user"><em>shevadas at gmail dot com</em></strong></a><a class="genanchor" href="#119244"> &para;</a><div class="date" title="2016-04-26 04:19"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119244">
<div class="phpcode"><code><span class="html">decompress() will truncate any part of the filename after the first period, as it assumes it's part of the extension. For example, if your PharData archive is named "views-3.x-3.13.tar.gz", calling decompress on it will create a tar file named "views-3.tar". See <a href="https://bugs.php.net/bug.php?id=58852" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=58852</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.decompress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.decompress.php">＋<small>add a note</small></a></div>
