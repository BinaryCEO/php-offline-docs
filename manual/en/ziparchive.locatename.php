...
<head>
  ...
  <title>PHP: ZipArchive::locateName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.locatename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.locatename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.locatename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.isencryptionmethoddupported.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.locatename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.locatename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.locatename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.locatename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.locatename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.locatename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.locatename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.locatename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.locatename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.locatename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.locatename.php" hreflang="zh">
...
<meta name="Description" content="Returns the index of the entry in the archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::locateName - Manual" />
<meta name="twitter:description" content="Returns the index of the entry in the archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::locateName - Manual" />
<meta itemprop="description" content="Returns the index of the entry in the archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the index of the entry in the archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ziparchive.open.php">
          ZipArchive::open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.isencryptionmethoddupported.php">
          &laquo; ZipArchive::isEncryptionMethodSupported        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.locatename.php' selected="selected">English</option>
            <option value='de/ziparchive.locatename.php'>German</option>
            <option value='es/ziparchive.locatename.php'>Spanish</option>
            <option value='fr/ziparchive.locatename.php'>French</option>
            <option value='it/ziparchive.locatename.php'>Italian</option>
            <option value='ja/ziparchive.locatename.php'>Japanese</option>
            <option value='pt_BR/ziparchive.locatename.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.locatename.php'>Russian</option>
            <option value='tr/ziparchive.locatename.php'>Turkish</option>
            <option value='uk/ziparchive.locatename.php'>Ukrainian</option>
            <option value='zh/ziparchive.locatename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.locatename" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.locatename-returnvalues">
  ...
  <p class="para">
   Returns the index of the entry on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
2</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/locatename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.locatename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.locatename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.locatename.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110161">  <div class="votes">
    <div id="Vu110161">
    <a href="/manual/vote-note.php?id=110161&amp;page=ziparchive.locatename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110161">
    <a href="/manual/vote-note.php?id=110161&amp;page=ziparchive.locatename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110161" title="91% like this...">
    10
    </div>
  </div>
  <a href="#110161" class="name">
  <strong class="user"><em>thedotwriter</em></strong></a><a class="genanchor" href="#110161"> &para;</a><div class="date" title="2012-09-25 08:22"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom110161">
<div class="phpcode"><code><span class="html">As this is not directly available from this page, here's the meaning of the two flags:<br /><br />ZIPARCHIVE::FL_NOCASE<br />    Ignore case on name lookup<br />    <br />ZIPARCHIVE::FL_NODIR<br />    Ignore directory component<br />    <br />All defined constants can be found here : <a href="http://php.net/manual/en/zip.constants.php" rel="nofollow" target="_blank">http://php.net/manual/en/zip.constants.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="85512">  <div class="votes">
    <div id="Vu85512">
    <a href="/manual/vote-note.php?id=85512&amp;page=ziparchive.locatename&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85512">
    <a href="/manual/vote-note.php?id=85512&amp;page=ziparchive.locatename&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85512" title="80% like this...">
    3
    </div>
  </div>
  <a href="#85512" class="name">
  <strong class="user"><em>me at nowhere dot com</em></strong></a><a class="genanchor" href="#85512"> &para;</a><div class="date" title="2008-09-03 01:04"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85512">
<div class="phpcode"><code><span class="html">If the option ZIPARCHIVE::FL_NODIR is used, the result may be ambiguous as files with the same name may occur in various directories. In this case, the first occurence in the index whoose name matches is returned.<br />E.g.<br /><br /><span class="default">&lt;?php<br />$zip</span><span class="keyword">-&gt;</span><span class="default">addFromString</span><span class="keyword">(</span><span class="string">'afile.txt'</span><span class="keyword">, </span><span class="string">'index 0'</span><span class="keyword">);<br /></span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">addFromString</span><span class="keyword">(</span><span class="string">'double.txt'</span><span class="keyword">, </span><span class="string">'index 1'</span><span class="keyword">);<br /></span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">addFromString</span><span class="keyword">(</span><span class="string">'dir/double.txt'</span><span class="keyword">, </span><span class="string">'index 2'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />$zip-&gt;locateName('double.txt',ZIPARCHIVE::FL_NODIR) returns 1</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.locatename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.locatename.php">＋<small>add a note</small></a></div>
