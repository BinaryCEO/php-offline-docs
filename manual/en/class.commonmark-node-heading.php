...
<head>
  ...
  <title>PHP: CommonMark\Node\Heading - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-heading.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-heading">
 <link rel="alternate" href="https://www.php.net/commonmark-node-heading" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-document.php">
 <link rel="next" href="https://www.php.net/manual/en/commonmark-node-heading.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-heading.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-heading.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-heading.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-heading.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-heading.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-heading.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-heading.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-heading.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-heading.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-heading.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-heading.php" hreflang="zh">
...
<meta name="Description" content="Heading concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\Heading - Manual" />
<meta name="twitter:description" content="Heading concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\Heading - Manual" />
<meta itemprop="description" content="Heading concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Heading concrete CommonMark\Node" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="commonmark-node-heading.construct.php">
          CommonMark\Node\Heading::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.commonmark-node-document.php">
          &laquo; CommonMark\Node\Document        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-heading.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-heading.php'>German</option>
            <option value='es/class.commonmark-node-heading.php'>Spanish</option>
            <option value='fr/class.commonmark-node-heading.php'>French</option>
            <option value='it/class.commonmark-node-heading.php'>Italian</option>
            <option value='ja/class.commonmark-node-heading.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-heading.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-heading.php'>Russian</option>
            <option value='tr/class.commonmark-node-heading.php'>Turkish</option>
            <option value='uk/class.commonmark-node-heading.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-heading.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-heading" class="reference">

 <h1 class="title">Heading concrete CommonMark\Node</h1>
 

 <div class="partintro"><p class="verinfo">(cmark &gt;= 1.0.0)</p>

  <div class="section" id="commonmark-node-heading.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\Heading</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-heading.construct.php" class="methodname">__construct</a></span>()</div>
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-heading.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$level</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="commonmark-node-heading.construct.php">CommonMark\Node\Heading::__construct</a> — Heading Construction</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.heading.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-heading%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-heading&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-heading.php">＋<small>add a note</small></a></span>
