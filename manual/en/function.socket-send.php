...
<head>
  ...
  <title>PHP: socket_send - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-send.php">
 <link rel="shorturl" href="https://www.php.net/socket-send">
 <link rel="alternate" href="https://www.php.net/socket-send" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-select.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-sendmsg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-send.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-send.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-send.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-send.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-send.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-send.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-send.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-send.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-send.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-send.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-send.php" hreflang="zh">
...
<meta name="Description" content="Sends data to a connected socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_send - Manual" />
<meta name="twitter:description" content="Sends data to a connected socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_send - Manual" />
<meta itemprop="description" content="Sends data to a connected socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sends data to a connected socket" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-sendmsg.php">
          socket_sendmsg &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-select.php">
          &laquo; socket_select        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-send.php' selected="selected">English</option>
            <option value='de/function.socket-send.php'>German</option>
            <option value='es/function.socket-send.php'>Spanish</option>
            <option value='fr/function.socket-send.php'>French</option>
            <option value='it/function.socket-send.php'>Italian</option>
            <option value='ja/function.socket-send.php'>Japanese</option>
            <option value='pt_BR/function.socket-send.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-send.php'>Russian</option>
            <option value='tr/function.socket-send.php'>Turkish</option>
            <option value='uk/function.socket-send.php'>Ukrainian</option>
            <option value='zh/function.socket-send.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-send" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.socket-sendto.php" class="function" rel="rdfs-seeAlso">socket_sendto()</a> - Sends a message to a socket, whether it is connected or not</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-send.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-send%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-send&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-send.php">＋<small>add a note</small></a></span>
