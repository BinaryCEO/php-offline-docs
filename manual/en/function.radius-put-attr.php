...
<head>
  ...
  <title>PHP: radius_put_attr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-put-attr.php">
 <link rel="shorturl" href="https://www.php.net/radius-put-attr">
 <link rel="alternate" href="https://www.php.net/radius-put-attr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-put-addr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-put-int.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-put-attr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-put-attr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-put-attr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-put-attr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-put-attr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-put-attr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-put-attr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-put-attr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-put-attr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-put-attr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-put-attr.php" hreflang="zh">
...
<meta name="Description" content="Attaches a binary attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_put_attr - Manual" />
<meta name="twitter:description" content="Attaches a binary attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_put_attr - Manual" />
<meta itemprop="description" content="Attaches a binary attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Attaches a binary attribute" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.radius-put-int.php">
          radius_put_int &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-put-addr.php">
          &laquo; radius_put_addr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-put-attr.php' selected="selected">English</option>
            <option value='de/function.radius-put-attr.php'>German</option>
            <option value='es/function.radius-put-attr.php'>Spanish</option>
            <option value='fr/function.radius-put-attr.php'>French</option>
            <option value='it/function.radius-put-attr.php'>Italian</option>
            <option value='ja/function.radius-put-attr.php'>Japanese</option>
            <option value='pt_BR/function.radius-put-attr.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-put-attr.php'>Russian</option>
            <option value='tr/function.radius-put-attr.php'>Turkish</option>
            <option value='uk/function.radius-put-attr.php'>Ukrainian</option>
            <option value='zh/function.radius-put-attr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-put-attr" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.radius-put-attr-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>radius_put_attr</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$radius_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$tag</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.radius-put-vendor-attr.php" class="function" rel="rdfs-seeAlso">radius_put_vendor_attr()</a> - Attaches a vendor specific binary attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-put-attr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-put-attr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-put-attr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-put-attr.php">＋<small>add a note</small></a></span>
