...
<head>
  ...
  <title>PHP: Imagick::getImageChannelRange - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechannelrange.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechannelrange.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechannelrange.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechannelrange.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechannelrange.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechannelrange.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechannelrange.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechannelrange.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechannelrange.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechannelrange.php" hreflang="zh">
...
<meta name="Description" content="Gets channel range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelRange - Manual" />
<meta name="twitter:description" content="Gets channel range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelRange - Manual" />
<meta itemprop="description" content="Gets channel range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets channel range" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagechannelstatistics.php">
          Imagick::getImageChannelStatistics &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechannelmean.php">
          &laquo; Imagick::getImageChannelMean        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechannelrange.php' selected="selected">English</option>
            <option value='de/imagick.getimagechannelrange.php'>German</option>
            <option value='es/imagick.getimagechannelrange.php'>Spanish</option>
            <option value='fr/imagick.getimagechannelrange.php'>French</option>
            <option value='it/imagick.getimagechannelrange.php'>Italian</option>
            <option value='ja/imagick.getimagechannelrange.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechannelrange.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechannelrange.php'>Russian</option>
            <option value='tr/imagick.getimagechannelrange.php'>Turkish</option>
            <option value='uk/imagick.getimagechannelrange.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechannelrange.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechannelrange" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagechannelrange-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageChannelRange</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechannelrange.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechannelrange%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechannelrange&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelrange.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108570">  <div class="votes">
    <div id="Vu108570">
    <a href="/manual/vote-note.php?id=108570&amp;page=imagick.getimagechannelrange&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108570">
    <a href="/manual/vote-note.php?id=108570&amp;page=imagick.getimagechannelrange&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108570" title="no votes...">
    0
    </div>
  </div>
  <a href="#108570" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108570"> &para;</a><div class="date" title="2012-05-07 11:43"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108570">
<div class="phpcode"><code><span class="html">The getImageChannelRange returns an array with two values mapped to the keys 'minima' and 'maxima', which are simply the minimum and maximum values of that particular channel within the image that this function is performed upon.  For photographs and high-quality imagery, that means that you're almost always guaranteed to have the minima be at 0 and the maxima be at the maximum bit-value allowed.  For most images, that's 65,535, which is the value of 2^16 (if you start counting at 0), meaning 16-bits per Channel imagery.  This goes for all of the channels.<br /><br />If an image is simple, though, you may be able to get a better variety of ranges.  An image that was simply a red square, the maxima and minima values for the Red Channel were both 65,535 (max), while the channels for the maxima and minima values for all other channels was 0 (min).  If you want to know the maximum values you might get back for any of the channels, feed this function the default channel.<br /><br />For your normal channels, you'll have something that looks like "imagick::CHANNEL_RED", but you could have unusual channels like "imagick::CHANNEL_OPACITY".  For colors, you have the "_VALUE" options of: red, gray, cyan, green, magenta, blue, yellow, all, and default.  For unusual channels, you have the "_VALUE" options of: undefined, alpha, opacity, matte, black, and index.  With this function, the unusual channels always produce a minima of 1.0E+37 (10^37) and a maxima of -1.0E-37 (-10^-37), which makes no sense, so stick to the color values I pointed to above.<br /><br />This function doesn't work for you?  No problem.  The function getImageChannelExtrema does the same *EXACT* thing.  The only difference is that the error you get on the unusual channels: their minima and maxima, instead of defaulting to crazy values, simply defaults to 0.<br /><br />In general, this function seems to have the utility of telling you how simple an image might be -- if the difference between a channel maxima and minima is very small, that means there wasn't much expression of color for that given channel.  This will probably be able to tell you whether an image was drawn in some simple paint program or if it's an actual photograph, but beyond that, you'll have to do intensive programming to make it figure something out more complicated.<br /><br />And now, an example of the results for some red-only image:<br /><br />ImageMagick - Channel Range<br />Channel - 'Undefined' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'Red' :     Minima: 65535     Maxima: 65535<br />Channel - 'Gray' :     Minima: 65535     Maxima: 65535<br />Channel - 'Cyan' :     Minima: 65535     Maxima: 65535<br />Channel - 'Green' :     Minima: 0     Maxima: 0<br />Channel - 'Magenta' :     Minima: 0     Maxima: 0<br />Channel - 'Blue' :     Minima: 0     Maxima: 0<br />Channel - 'Yellow' :     Minima: 0     Maxima: 0<br />Channel - 'Alpha' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'Opacity' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'Matte' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'Black' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'Index' :     Minima: 1.0E+37     Maxima: -1.0E-37<br />Channel - 'All' :     Minima: 0     Maxima: 65535<br />Channel - 'Default' :     Minima: 0     Maxima: 65535</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagechannelrange&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelrange.php">＋<small>add a note</small></a></div>
