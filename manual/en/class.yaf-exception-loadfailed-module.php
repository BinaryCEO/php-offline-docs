...
<head>
  ...
  <title>PHP: Yaf_Exception_LoadFailed_Module - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-exception-loadfailed-module.php">
 <link rel="shorturl" href="https://www.php.net/yaf-exception-loadfailed-module">
 <link rel="alternate" href="https://www.php.net/yaf-exception-loadfailed-module" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.yaf-exception-loadfailed.php">
 <link rel="next" href="https://www.php.net/manual/en/class.yaf-exception-loadfailed-controller.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-exception-loadfailed-module.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-exception-loadfailed-module.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-exception-loadfailed-module.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-exception-loadfailed-module.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-exception-loadfailed-module.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-exception-loadfailed-module.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-exception-loadfailed-module.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-exception-loadfailed-module.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-exception-loadfailed-module.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-exception-loadfailed-module.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-exception-loadfailed-module.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Exception_LoadFailed_Module class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Exception_LoadFailed_Module - Manual" />
<meta name="twitter:description" content="The Yaf_Exception_LoadFailed_Module class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Exception_LoadFailed_Module - Manual" />
<meta itemprop="description" content="The Yaf_Exception_LoadFailed_Module class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Exception_LoadFailed_Module class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.yaf-exception-loadfailed-controller.php">
          Yaf_Exception_LoadFailed_Controller &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.yaf-exception-loadfailed.php">
          &laquo; Yaf_Exception_LoadFailed        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-exception-loadfailed-module.php' selected="selected">English</option>
            <option value='de/class.yaf-exception-loadfailed-module.php'>German</option>
            <option value='es/class.yaf-exception-loadfailed-module.php'>Spanish</option>
            <option value='fr/class.yaf-exception-loadfailed-module.php'>French</option>
            <option value='it/class.yaf-exception-loadfailed-module.php'>Italian</option>
            <option value='ja/class.yaf-exception-loadfailed-module.php'>Japanese</option>
            <option value='pt_BR/class.yaf-exception-loadfailed-module.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-exception-loadfailed-module.php'>Russian</option>
            <option value='tr/class.yaf-exception-loadfailed-module.php'>Turkish</option>
            <option value='uk/class.yaf-exception-loadfailed-module.php'>Ukrainian</option>
            <option value='zh/class.yaf-exception-loadfailed-module.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-exception-loadfailed-module" class="reference">
  ...
  <div class="section" id="yaf-exception-loadfailed-module.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Yaf_Exception_LoadFailed_Module</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="yaf-exception.getprevious.php" class="methodname">Yaf_Exception::getPrevious</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-exception-loadfailed-module.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-exception-loadfailed-module%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-exception-loadfailed-module&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-exception-loadfailed-module.php">＋<small>add a note</small></a></span>
