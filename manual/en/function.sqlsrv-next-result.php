...
<head>
  ...
  <title>PHP: sqlsrv_next_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-next-result.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-next-result">
 <link rel="alternate" href="https://www.php.net/sqlsrv-next-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-has-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-num-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-next-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-next-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-next-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-next-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-next-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-next-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-next-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-next-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-next-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-next-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-next-result.php" hreflang="zh">
...
<meta name="Description" content="Makes the next result of the specified statement active" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_next_result - Manual" />
<meta name="twitter:description" content="Makes the next result of the specified statement active" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_next_result - Manual" />
<meta itemprop="description" content="Makes the next result of the specified statement active" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes the next result of the specified statement active" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-num-fields.php">
          sqlsrv_num_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-has-rows.php">
          &laquo; sqlsrv_has_rows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-next-result.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-next-result.php'>German</option>
            <option value='es/function.sqlsrv-next-result.php'>Spanish</option>
            <option value='fr/function.sqlsrv-next-result.php'>French</option>
            <option value='it/function.sqlsrv-next-result.php'>Italian</option>
            <option value='ja/function.sqlsrv-next-result.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-next-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-next-result.php'>Russian</option>
            <option value='tr/function.sqlsrv-next-result.php'>Turkish</option>
            <option value='uk/function.sqlsrv-next-result.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-next-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-next-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_next_result</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_next_result</span> &mdash; <span class="dc-title">Makes the next result of the specified statement active</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.sqlsrv-next-result-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_next_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-next-result-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the next result was successfully retrieved, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an error 
   occurred, and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there are no more results to retrieve.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-next-result-seealso">
  ...
  DELETE query executed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-next-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-next-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-next-result.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114693">  <div class="votes">
    <div id="Vu114693">
    <a href="/manual/vote-note.php?id=114693&amp;page=function.sqlsrv-next-result&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114693">
    <a href="/manual/vote-note.php?id=114693&amp;page=function.sqlsrv-next-result&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114693" title="45% like this...">
    -1
    </div>
  </div>
  <a href="#114693" class="name">
  <strong class="user"><em>chakin</em></strong></a><a class="genanchor" href="#114693"> &para;</a><div class="date" title="2014-03-24 01:09"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114693">
<div class="phpcode"><code><span class="html">You can use a for loop to iterate through the results:<br /><br />If you know how many results there should be it's easier, otherwise you can put a large number in the loop constructor and break when done:<br /><br />&lt;?<br />for ($i=0; $i&lt; (Large # or Exact #); $i++)<br />{<br />  $rows_affected = sqlsrv_rows_affected($q2);<br />   if ($rows_affected === false) <br />    {<br />       echo 'Inserts Failed&lt;br /&gt;\n';<br />    } else if ( $rows_affected == -1) {<br />       echo "No information available.&lt;br /&gt;\n";<br />    }  else  {<br />       echo $rows_affected." rows were added.&lt;br /&gt;\n";<br />    }<br /><br />   $next_result = sqlsrv_next_result($q2);<br /><br />    if (!$next_result)<br />    {<br />     break;<br />    }<br />}<br />?&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sqlsrv-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-next-result.php">＋<small>add a note</small></a></div>
