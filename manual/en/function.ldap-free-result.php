...
<head>
  ...
  <title>PHP: ldap_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-free-result.php">
 <link rel="shorturl" href="https://www.php.net/ldap-free-result">
 <link rel="alternate" href="https://www.php.net/ldap-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-first-reference.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-get-attributes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-free-result.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_free_result - Manual" />
<meta name="twitter:description" content="Free result memory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_free_result - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-get-attributes.php">
          ldap_get_attributes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-first-reference.php">
          &laquo; ldap_first_reference        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-free-result.php' selected="selected">English</option>
            <option value='de/function.ldap-free-result.php'>German</option>
            <option value='es/function.ldap-free-result.php'>Spanish</option>
            <option value='fr/function.ldap-free-result.php'>French</option>
            <option value='it/function.ldap-free-result.php'>Italian</option>
            <option value='ja/function.ldap-free-result.php'>Japanese</option>
            <option value='pt_BR/function.ldap-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-free-result.php'>Russian</option>
            <option value='tr/function.ldap-free-result.php'>Turkish</option>
            <option value='uk/function.ldap-free-result.php'>Ukrainian</option>
            <option value='zh/function.ldap-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-free-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_free_result</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_free_result</span> &mdash; <span class="dc-title">Free result memory</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ldap-free-result-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_free_result</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-result.php" class="type LDAP\Result">LDAP\Result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   return large result sets, <span class="function"><strong>ldap_free_result()</strong></span> could be
   called to keep the runtime memory usage by the script low.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ldap-free-result-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-free-result-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.ldap-free-result-changelog">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">ldap result</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-free-result.php">＋<small>add a note</small></a></span>
