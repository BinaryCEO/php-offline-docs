...
<head>
  ...
  <title>PHP: svn_checkout - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-checkout.php">
 <link rel="shorturl" href="https://www.php.net/svn-checkout">
 <link rel="alternate" href="https://www.php.net/svn-checkout" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-cat.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-cleanup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-checkout.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-checkout.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-checkout.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-checkout.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-checkout.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-checkout.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-checkout.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-checkout.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-checkout.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-checkout.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-checkout.php" hreflang="zh">
...
<meta name="Description" content="Checks out a working copy from the repository" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_checkout - Manual" />
<meta name="twitter:description" content="Checks out a working copy from the repository" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_checkout - Manual" />
<meta itemprop="description" content="Checks out a working copy from the repository" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks out a working copy from the repository" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-checkout.php' selected="selected">English</option>
            <option value='de/function.svn-checkout.php'>German</option>
            <option value='es/function.svn-checkout.php'>Spanish</option>
            <option value='fr/function.svn-checkout.php'>French</option>
            <option value='it/function.svn-checkout.php'>Italian</option>
            <option value='ja/function.svn-checkout.php'>Japanese</option>
            <option value='pt_BR/function.svn-checkout.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-checkout.php'>Russian</option>
            <option value='tr/function.svn-checkout.php'>Turkish</option>
            <option value='uk/function.svn-checkout.php'>Ukrainian</option>
            <option value='zh/function.svn-checkout.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-checkout" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.checkout.html" class="link external">&raquo;&nbsp;SVN documentation on svn checkout</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-checkout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-checkout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-checkout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-checkout.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119279">  <div class="votes">
    <div id="Vu119279">
    <a href="/manual/vote-note.php?id=119279&amp;page=function.svn-checkout&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119279">
    <a href="/manual/vote-note.php?id=119279&amp;page=function.svn-checkout&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119279" title="50% like this...">
    0
    </div>
  </div>
  <a href="#119279" class="name">
  <strong class="user"><em>leonardodarosa23 at gmail dot com</em></strong></a><a class="genanchor" href="#119279"> &para;</a><div class="date" title="2016-05-02 06:08"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119279">
<div class="phpcode"><code><span class="html">For those who are trying to use this while they don't patch out the  SVN_IGNORE_EXTERNALS constant that is missing, I've found the equivalent integer flag if you want to use before the official release:<br /><br />if(!defined('SVN_IGNORE_EXTERNALS'))<br />    define('SVN_IGNORE_EXTERNALS', 128);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-checkout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-checkout.php">＋<small>add a note</small></a></div>
