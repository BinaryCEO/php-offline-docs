...
<head>
  ...
  <title>PHP: General Information - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/faq.general.php">
 <link rel="shorturl" href="https://www.php.net/general">
 <link rel="alternate" href="https://www.php.net/general" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/faq.php">
 <link rel="prev" href="https://www.php.net/manual/en/faq.php">
 <link rel="next" href="https://www.php.net/manual/en/faq.mailinglist.php">

 <link rel="alternate" href="https://www.php.net/manual/en/faq.general.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/faq.general.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/faq.general.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/faq.general.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/faq.general.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/faq.general.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/faq.general.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/faq.general.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/faq.general.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/faq.general.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/faq.general.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: General Information - Manual" />
<meta name="twitter:description" content="General Information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: General Information - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/faq.general.php' selected="selected">English</option>
            <option value='de/faq.general.php'>German</option>
            <option value='es/faq.general.php'>Spanish</option>
            <option value='fr/faq.general.php'>French</option>
            <option value='it/faq.general.php'>Italian</option>
            <option value='ja/faq.general.php'>Japanese</option>
            <option value='pt_BR/faq.general.php'>Brazilian Portuguese</option>
            <option value='ru/faq.general.php'>Russian</option>
            <option value='tr/faq.general.php'>Turkish</option>
            <option value='uk/faq.general.php'>Ukrainian</option>
            <option value='zh/faq.general.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="faq.general" class="chapter">
  ...
  <div class="qandaset"><ol class="qandaset_questions"><li><a href="#faq.general.what">
   ...
   <dl class="qandaentry" id="faq.general.what">
    ...
    <dd class="answer">
     <p class="para">
      From the <a href="preface.php" class="link">preface of the manual</a>:
     </p>
     <p class="para">
   ...
   <dl class="qandaentry" id="faq.general.acronym">
    ...
    <dd class="answer">
     <p class="para">
     PHP stands for <em>PHP: Hypertext Preprocessor</em>. 
   ...
   <dl class="qandaentry" id="faq.general.relation-versions">
    ...
    <dd class="answer">
     <p class="para">
      ...
      <a href="language.oop5.php" class="link">OOP</a> features.
     </p>
    </dd>
   </dl>
   ...
   <dl class="qandaentry" id="faq.general.bug">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/faq/general.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffaq.general%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=faq.general&amp;repo=en&amp;redirect=https://www.php.net/manual/en/faq.general.php">＋<small>add a note</small></a></span>
