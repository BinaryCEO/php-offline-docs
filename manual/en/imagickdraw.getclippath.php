...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getclippath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getclippath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getclippath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.ellipse.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getcliprule.php">
...
<meta name="Description" content="Obtains the current clipping path ID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getClipPath - Manual" />
<meta name="twitter:description" content="Obtains the current clipping path ID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getClipPath - Manual" />
<meta itemprop="description" content="Obtains the current clipping path ID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Obtains the current clipping path ID" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getclippath.php' selected="selected">English</option>
            ...
            <option value='pt_BR/imagickdraw.getclippath.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getClipPath</span> &mdash; <span class="dc-title">Obtains the current clipping path ID</span></p>
  ...
  <p class="para">
   Returns a string containing the clip path ID or false if no clip path exists.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getclippath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getclippath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getclippath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getclippath.php">＋<small>add a note</small></a></span>
