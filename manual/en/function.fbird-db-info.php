...
<head>
  ...
  <title>PHP: fbird_db_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-db-info.php">
 <link rel="shorturl" href="https://www.php.net/fbird-db-info">
 <link rel="alternate" href="https://www.php.net/fbird-db-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-delete-user.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-db-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-db-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-db-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-db-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-db-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-db-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-db-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-db-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-db-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-db-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-db-info.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_db_info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_db_info - Manual" />
<meta name="twitter:description" content="Alias of ibase_db_info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_db_info - Manual" />
<meta itemprop="description" content="Alias of ibase_db_info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_db_info" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-delete-user.php">
          fbird_delete_user &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-connect.php">
          &laquo; fbird_connect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-db-info.php' selected="selected">English</option>
            <option value='de/function.fbird-db-info.php'>German</option>
            <option value='es/function.fbird-db-info.php'>Spanish</option>
            <option value='fr/function.fbird-db-info.php'>French</option>
            <option value='it/function.fbird-db-info.php'>Italian</option>
            <option value='ja/function.fbird-db-info.php'>Japanese</option>
            <option value='pt_BR/function.fbird-db-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-db-info.php'>Russian</option>
            <option value='tr/function.fbird-db-info.php'>Turkish</option>
            <option value='uk/function.fbird-db-info.php'>Ukrainian</option>
            <option value='zh/function.fbird-db-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-db-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_db_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_db_info</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-db-info.php" class="function">ibase_db_info()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-db-info-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-db-info.php" class="function">ibase_db_info()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-db-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-db-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-db-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-db-info.php">＋<small>add a note</small></a></span>
