...
<head>
  ...
  <title>PHP: Memcached::getByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getbykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getbykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getbykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getallkeys.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getdelayed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getbykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.getbykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.getbykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.getbykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.getbykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.getbykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.getbykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.getbykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.getbykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.getbykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.getbykey.php" hreflang="zh">
...
<meta name="Description" content="Retrieve an item from a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::getByKey - Manual" />
<meta name="twitter:description" content="Retrieve an item from a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::getByKey - Manual" />
<meta itemprop="description" content="Retrieve an item from a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve an item from a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.getdelayed.php">
          Memcached::getDelayed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.getallkeys.php">
          &laquo; Memcached::getAllKeys        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getbykey.php' selected="selected">English</option>
            <option value='de/memcached.getbykey.php'>German</option>
            <option value='es/memcached.getbykey.php'>Spanish</option>
            <option value='fr/memcached.getbykey.php'>French</option>
            <option value='it/memcached.getbykey.php'>Italian</option>
            <option value='ja/memcached.getbykey.php'>Japanese</option>
            <option value='pt_BR/memcached.getbykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.getbykey.php'>Russian</option>
            <option value='tr/memcached.getbykey.php'>Turkish</option>
            <option value='uk/memcached.getbykey.php'>Ukrainian</option>
            <option value='zh/memcached.getbykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.getbykey" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.getdelayed.php" class="methodname" rel="rdfs-seeAlso">Memcached::getDelayed()</a> - Request multiple items</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getbykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getbykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getbykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getbykey.php">＋<small>add a note</small></a></span>
