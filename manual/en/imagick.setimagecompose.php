...
<head>
  ...
  <title>PHP: Imagick::setImageCompose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagecompose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagecompose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecompose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagecolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagecompression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagecompose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagecompose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagecompose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagecompose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagecompose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagecompose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagecompose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagecompose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagecompose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagecompose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagecompose.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setImageCompose - Manual" />
<meta name="twitter:description" content="Sets the image composite operator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageCompose - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagecompression.php">
          Imagick::setImageCompression &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagecolorspace.php">
          &laquo; Imagick::setImageColorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagecompose.php' selected="selected">English</option>
            <option value='de/imagick.setimagecompose.php'>German</option>
            <option value='es/imagick.setimagecompose.php'>Spanish</option>
            <option value='fr/imagick.setimagecompose.php'>French</option>
            <option value='it/imagick.setimagecompose.php'>Italian</option>
            <option value='ja/imagick.setimagecompose.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagecompose.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagecompose.php'>Russian</option>
            <option value='tr/imagick.setimagecompose.php'>Turkish</option>
            <option value='uk/imagick.setimagecompose.php'>Ukrainian</option>
            <option value='zh/imagick.setimagecompose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagecompose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageCompose</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageCompose</span> &mdash; <span class="dc-title">Sets the image composite operator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagecompose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageCompose</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compose</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagecompose-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagecompose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagecompose-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagecompose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagecompose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagecompose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagecompose.php">＋<small>add a note</small></a></span>
