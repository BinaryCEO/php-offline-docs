...
<head>
  ...
  <title>PHP: trader_tanh - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-tanh.php">
 <link rel="shorturl" href="https://www.php.net/trader-tanh">
 <link rel="alternate" href="https://www.php.net/trader-tanh" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-tan.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-tema.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-tanh.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-tanh.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-tanh.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-tanh.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-tanh.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-tanh.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-tanh.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-tanh.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-tanh.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-tanh.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-tanh.php" hreflang="zh">
...
<meta name="Description" content="Vector Trigonometric Tanh" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_tanh - Manual" />
<meta name="twitter:description" content="Vector Trigonometric Tanh" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_tanh - Manual" />
<meta itemprop="description" content="Vector Trigonometric Tanh" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Trigonometric Tanh" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-tanh.php' selected="selected">English</option>
            <option value='de/function.trader-tanh.php'>German</option>
            <option value='es/function.trader-tanh.php'>Spanish</option>
            <option value='fr/function.trader-tanh.php'>French</option>
            <option value='it/function.trader-tanh.php'>Italian</option>
            <option value='ja/function.trader-tanh.php'>Japanese</option>
            <option value='pt_BR/function.trader-tanh.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-tanh.php'>Russian</option>
            <option value='tr/function.trader-tanh.php'>Turkish</option>
            <option value='uk/function.trader-tanh.php'>Ukrainian</option>
            <option value='zh/function.trader-tanh.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-tanh" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_tanh</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_tanh</span> &mdash; <span class="dc-title">Vector Trigonometric Tanh</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-tanh-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_tanh</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-tanh-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-tanh-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-tanh.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-tanh%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-tanh&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-tanh.php">＋<small>add a note</small></a></span>
