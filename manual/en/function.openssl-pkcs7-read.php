...
<head>
  ...
  <title>PHP: openssl_pkcs7_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkcs7-read.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkcs7-read">
 <link rel="alternate" href="https://www.php.net/openssl-pkcs7-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkcs7-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkcs7-sign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkcs7-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkcs7-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkcs7-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkcs7-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkcs7-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkcs7-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkcs7-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkcs7-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkcs7-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkcs7-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkcs7-read.php" hreflang="zh">
...
<meta name="Description" content="Export the PKCS7 file to an array of PEM certificates" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkcs7_read - Manual" />
<meta name="twitter:description" content="Export the PKCS7 file to an array of PEM certificates" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkcs7_read - Manual" />
<meta itemprop="description" content="Export the PKCS7 file to an array of PEM certificates" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export the PKCS7 file to an array of PEM certificates" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-pkcs7-sign.php">
          openssl_pkcs7_sign &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkcs7-encrypt.php">
          &laquo; openssl_pkcs7_encrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkcs7-read.php' selected="selected">English</option>
            <option value='de/function.openssl-pkcs7-read.php'>German</option>
            <option value='es/function.openssl-pkcs7-read.php'>Spanish</option>
            <option value='fr/function.openssl-pkcs7-read.php'>French</option>
            <option value='it/function.openssl-pkcs7-read.php'>Italian</option>
            <option value='ja/function.openssl-pkcs7-read.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkcs7-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkcs7-read.php'>Russian</option>
            <option value='tr/function.openssl-pkcs7-read.php'>Turkish</option>
            <option value='uk/function.openssl-pkcs7-read.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkcs7-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkcs7-read" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkcs7_read</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkcs7_read</span> &mdash; <span class="dc-title">Export the PKCS7 file to an array of <abbr title="Privacy-Enhanced Mail">PEM</abbr> certificates</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-pkcs7-read-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_pkcs7_read</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$certificates</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.openssl-pkcs7-read-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      The array of <abbr title="Privacy-Enhanced Mail">PEM</abbr> certificates from the p7b input data.
     </p>
    </dd>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkcs7-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkcs7-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkcs7-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs7-read.php">＋<small>add a note</small></a></span>
