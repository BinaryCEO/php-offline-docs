...
<head>
  ...
  <title>PHP: SolrQuery::addSortField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addsortfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addsortfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addsortfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addsortfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addsortfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addsortfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addsortfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addsortfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addsortfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addsortfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addsortfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addsortfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addsortfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addsortfield.php" hreflang="zh">
...
<meta name="Description" content="Used to control how the results should be sorted" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addSortField - Manual" />
<meta name="twitter:description" content="Used to control how the results should be sorted" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addSortField - Manual" />
<meta itemprop="description" content="Used to control how the results should be sorted" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Used to control how the results should be sorted" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addstatsfacet.php">
          SolrQuery::addStatsFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addmltqueryfield.php">
          &laquo; SolrQuery::addMltQueryField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addsortfield.php' selected="selected">English</option>
            <option value='de/solrquery.addsortfield.php'>German</option>
            <option value='es/solrquery.addsortfield.php'>Spanish</option>
            <option value='fr/solrquery.addsortfield.php'>French</option>
            <option value='it/solrquery.addsortfield.php'>Italian</option>
            <option value='ja/solrquery.addsortfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addsortfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addsortfield.php'>Russian</option>
            <option value='tr/solrquery.addsortfield.php'>Turkish</option>
            <option value='uk/solrquery.addsortfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addsortfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addsortfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addSortField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addSortField</span> &mdash; <span class="dc-title">Used to control how the results should be sorted</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addsortfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addSortField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$order</code><span class="initializer"> = SolrQuery::ORDER_DESC</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addsortfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addsortfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addsortfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addsortfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addsortfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addsortfield.php">＋<small>add a note</small></a></span>
