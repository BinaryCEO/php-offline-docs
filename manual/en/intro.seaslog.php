...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.seaslog.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.seaslog.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.seaslog.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.seaslog.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.seaslog.php">
 <link rel="next" href="https://www.php.net/manual/en/seaslog.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.seaslog.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.seaslog.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.seaslog.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.seaslog.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.seaslog.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.seaslog.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.seaslog.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.seaslog.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.seaslog.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.seaslog.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.seaslog.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.seaslog.php' selected="selected">English</option>
            <option value='de/intro.seaslog.php'>German</option>
            <option value='es/intro.seaslog.php'>Spanish</option>
            <option value='fr/intro.seaslog.php'>French</option>
            <option value='it/intro.seaslog.php'>Italian</option>
            <option value='ja/intro.seaslog.php'>Japanese</option>
            <option value='pt_BR/intro.seaslog.php'>Brazilian Portuguese</option>
            <option value='ru/intro.seaslog.php'>Russian</option>
            <option value='tr/intro.seaslog.php'>Turkish</option>
            <option value='uk/intro.seaslog.php'>Ukrainian</option>
            <option value='zh/intro.seaslog.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.seaslog" class="preface">
  ...
  <p class="para">
   Read More <a href="https://seasx.github.io/SeasLog/" class="link external">&raquo;&nbsp;SeasLog Document</a> at Github.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.seaslog%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.seaslog&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.seaslog.php">＋<small>add a note</small></a></span>
