...
<head>
  ...
  <title>PHP: CMS Flags/Constants - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/openssl.cms.flags.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/openssl.cms.flags.php">
 <link rel="alternate" href="https://www.php.net/manual/en/openssl.cms.flags.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/openssl.constants.php">
 <link rel="prev" href="https://www.php.net/manual/en/openssl.pkcs7.flags.php">
 <link rel="next" href="https://www.php.net/manual/en/openssl.signature-algos.php">
...
<meta name="Description" content="CMS Flags/Constants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CMS Flags/Constants - Manual" />
<meta name="twitter:description" content="CMS Flags/Constants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CMS Flags/Constants - Manual" />
<meta itemprop="description" content="CMS Flags/Constants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CMS Flags/Constants" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="openssl.signature-algos.php">
          Signature Algorithms &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="openssl.pkcs7.flags.php">
          &laquo; PKCS7 Flags/Constants        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
  ...
  <div class="page-tools">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/openssl.cms.flags.php' selected="selected">English</option>
            <option value='de/openssl.cms.flags.php'>German</option>
   ...
   <h2 class="title"><abbr>CMS</abbr> Flags/Constants</h2>
   <p class="para">
    ...
    <table class="doctable table">
     <caption><strong><abbr>CMS</abbr> CONSTANTS</strong></caption>
       ...
       <tbody class="tbody">
        ...
        <tr id="constant.openssl-cms-nointern">
         ...
         <td>
          ...
          parameter of <span class="function"><a href="function.openssl-cms-verify.php" class="function">openssl_cms_verify()</a></span> are
        ...
        <tr id="constant.openssl-cms-oldmimetype">
         ...
         <td>
          ...
          Sets the content-type to <code class="literal">application/x-pkcs7-mime</code> instead of
          <code class="literal">application/pkcs7-mime</code> to encrypt a message.
         </td>
        </tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fopenssl.cms.flags%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=openssl.cms.flags&amp;repo=en&amp;redirect=https://www.php.net/manual/en/openssl.cms.flags.php">＋<small>add a note</small></a></span>
