...
<head>
  ...
  <title>PHP: ReflectionClass::resetAsLazyGhost - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.resetaslazyghost.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.resetaslazyghost.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.resetaslazyghost.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.newlazyproxy.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.resetaslazyproxy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.resetaslazyghost.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.resetaslazyghost.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.resetaslazyghost.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.resetaslazyghost.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.resetaslazyghost.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.resetaslazyghost.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.resetaslazyghost.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.resetaslazyghost.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.resetaslazyghost.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.resetaslazyghost.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.resetaslazyghost.php" hreflang="zh">
...
<meta name="Description" content="Resets an object and marks it as lazy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::resetAsLazyGhost - Manual" />
<meta name="twitter:description" content="Resets an object and marks it as lazy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::resetAsLazyGhost - Manual" />
<meta itemprop="description" content="Resets an object and marks it as lazy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resets an object and marks it as lazy" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.resetaslazyproxy.php">
          ReflectionClass::resetAsLazyProxy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.newlazyproxy.php">
          &laquo; ReflectionClass::newLazyProxy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.resetaslazyghost.php' selected="selected">English</option>
            <option value='de/reflectionclass.resetaslazyghost.php'>German</option>
            <option value='es/reflectionclass.resetaslazyghost.php'>Spanish</option>
            <option value='fr/reflectionclass.resetaslazyghost.php'>French</option>
            <option value='it/reflectionclass.resetaslazyghost.php'>Italian</option>
            <option value='ja/reflectionclass.resetaslazyghost.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.resetaslazyghost.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.resetaslazyghost.php'>Russian</option>
            <option value='tr/reflectionclass.resetaslazyghost.php'>Turkish</option>
            <option value='uk/reflectionclass.resetaslazyghost.php'>Ukrainian</option>
            <option value='zh/reflectionclass.resetaslazyghost.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.resetaslazyghost" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-reflectionclass.resetaslazyghost-description">
  ...
  <p class="simpara">
   ...
   <strong><code><a href="class.reflectionclass.php#reflectionclass.constants.skip-destructor">ReflectionClass::SKIP_DESTRUCTOR</a></code></strong> flag is specified. In
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionclass.resetaslazyproxy.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::resetAsLazyProxy()</a> - Resets an object and marks it as lazy</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/resetaslazyghost.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.resetaslazyghost%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.resetaslazyghost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.resetaslazyghost.php">＋<small>add a note</small></a></span>
