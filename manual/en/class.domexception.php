...
<head>
  ...
  <title>PHP: DOMException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.domexception.php">
 <link rel="shorturl" href="https://www.php.net/domexception">
 <link rel="alternate" href="https://www.php.net/domexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/domentityreference.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domimplementation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.domexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.domexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.domexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.domexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.domexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.domexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.domexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.domexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.domexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.domexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.domexception.php" hreflang="zh">
...
<meta name="Description" content="The DOMException / Dom\Exception class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMException - Manual" />
<meta name="twitter:description" content="The DOMException / Dom\Exception class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMException - Manual" />
<meta itemprop="description" content="The DOMException / Dom\Exception class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DOMException / Dom\Exception class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.domimplementation.php">
          DOMImplementation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domentityreference.construct.php">
          &laquo; DOMEntityReference::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.domexception.php' selected="selected">English</option>
            <option value='de/class.domexception.php'>German</option>
            <option value='es/class.domexception.php'>Spanish</option>
            <option value='fr/class.domexception.php'>French</option>
            <option value='it/class.domexception.php'>Italian</option>
            <option value='ja/class.domexception.php'>Japanese</option>
            <option value='pt_BR/class.domexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.domexception.php'>Russian</option>
            <option value='tr/class.domexception.php'>Turkish</option>
            <option value='uk/class.domexception.php'>Ukrainian</option>
            <option value='zh/class.domexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.domexception" class="reference">
 <h1 class="title">The DOMException / Dom\Exception class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>
 

  <div class="section" id="domexception.intro">
   ...
   <p class="simpara">
    This class is aliased as <span class="classname"><strong class="classname">Dom\Exception</strong></span> in the
    Dom namespace.
   </p>
   <p class="para">
    See also <a href="language.exceptions.php" class="xref">Exceptions</a>.
   </p>
  </div>

 
  <div class="section" id="domexception.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DOMException</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.domexception.php#domexception.props.code">$<var class="varname">code</var></a></var>;</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="domexception.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="domexception.props.code"><var class="varname">code</var></dt>
     <dd>
      <p class="para">An integer indicating the type of error generated</p>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.domexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.domexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.domexception.php">＋<small>add a note</small></a></span>
