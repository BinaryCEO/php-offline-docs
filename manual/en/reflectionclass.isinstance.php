...
<head>
  ...
  <title>PHP: ReflectionClass::isInstance - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isinstance.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isinstance.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isinstance.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isfinal.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isinstantiable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isinstance.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isinstance.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isinstance.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isinstance.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isinstance.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isinstance.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isinstance.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isinstance.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isinstance.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isinstance.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isinstance.php" hreflang="zh">
...
<meta name="Description" content="Checks class for instance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isInstance - Manual" />
<meta name="twitter:description" content="Checks class for instance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isInstance - Manual" />
<meta itemprop="description" content="Checks class for instance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks class for instance" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.isinstantiable.php">
          ReflectionClass::isInstantiable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isfinal.php">
          &laquo; ReflectionClass::isFinal        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isinstance.php' selected="selected">English</option>
            <option value='de/reflectionclass.isinstance.php'>German</option>
            <option value='es/reflectionclass.isinstance.php'>Spanish</option>
            <option value='fr/reflectionclass.isinstance.php'>French</option>
            <option value='it/reflectionclass.isinstance.php'>Italian</option>
            <option value='ja/reflectionclass.isinstance.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isinstance.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isinstance.php'>Russian</option>
            <option value='tr/reflectionclass.isinstance.php'>Turkish</option>
            <option value='uk/reflectionclass.isinstance.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isinstance.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isinstance" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isInstance</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isInstance</span> &mdash; <span class="dc-title">Checks class for instance</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isinstance-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isInstance</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.object.php" class="type object">object</a></span> <code class="parameter">$object</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.isinstance-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isinstance-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.isinstance-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5500">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::isInstance()</strong></span> related examples</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">Yes
Yes
Yes</pre>
</div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isinstance-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="language.operators.type.php" class="link">Type operators (instanceof)</a></li>
    ...
    <li><span class="function"><a href="function.is-a.php" class="function" rel="rdfs-seeAlso">is_a()</a> - Checks whether the object is of a given type or subtype</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isinstance.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isinstance%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isinstance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isinstance.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118817">  <div class="votes">
    <div id="Vu118817">
    <a href="/manual/vote-note.php?id=118817&amp;page=reflectionclass.isinstance&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118817">
    <a href="/manual/vote-note.php?id=118817&amp;page=reflectionclass.isinstance&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118817" title="50% like this...">
    0
    </div>
  </div>
  <a href="#118817" class="name">
  <strong class="user"><em>dhairya lakhera</em></strong></a><a class="genanchor" href="#118817"> &para;</a><div class="date" title="2016-02-11 04:55"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118817">
<div class="phpcode"><code><span class="html">class  TestClass { }<br /><br />$TestObj=new TestClass();<br /><br />$TestObj_assigned=$TestObj;<br />$TestObj_Refrenced=&amp;$TestObj;<br />$TestObj_cloned=clone $TestObj;<br /><br />$obj=new ReflectionClass('TestClass');<br /><br />var_dump($obj-&gt;isInstance($TestObj)); <br />var_dump($obj-&gt;isInstance($TestObj_assigned)); <br />var_dump($obj-&gt;isInstance($TestObj_Refrenced)); <br />var_dump($obj-&gt;isInstance($TestObj_cloned));</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.isinstance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isinstance.php">＋<small>add a note</small></a></div>
