...
<head>
  ...
  <title>PHP: ImagickDraw::clear - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.clear.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.clear.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.clear.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.circle.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.clone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.clear.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.clear.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.clear.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.clear.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.clear.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.clear.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.clear.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.clear.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.clear.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.clear.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.clear.php" hreflang="zh">
...
<meta name="Description" content="Clears the ImagickDraw" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::clear - Manual" />
<meta name="twitter:description" content="Clears the ImagickDraw" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::clear - Manual" />
<meta itemprop="description" content="Clears the ImagickDraw" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clears the ImagickDraw" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.clone.php">
          ImagickDraw::clone &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.circle.php">
          &laquo; ImagickDraw::circle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.clear.php' selected="selected">English</option>
            <option value='de/imagickdraw.clear.php'>German</option>
            <option value='es/imagickdraw.clear.php'>Spanish</option>
            <option value='fr/imagickdraw.clear.php'>French</option>
            <option value='it/imagickdraw.clear.php'>Italian</option>
            <option value='ja/imagickdraw.clear.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.clear.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.clear.php'>Russian</option>
            <option value='tr/imagickdraw.clear.php'>Turkish</option>
            <option value='uk/imagickdraw.clear.php'>Ukrainian</option>
            <option value='zh/imagickdraw.clear.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.clear" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::clear</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::clear</span> &mdash; <span class="dc-title">Clears the ImagickDraw</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.clear-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::clear</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.clear-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="classname"><a href="class.imagickdraw.php" class="classname">ImagickDraw</a></span> object.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/clear.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.clear%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.clear&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.clear.php">＋<small>add a note</small></a></span>
