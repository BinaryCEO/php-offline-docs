...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intldateformatter.parse.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intldateformatter.parse.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intldateformatter.parse.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intldateformatter.php">
 <link rel="prev" href="https://www.php.net/manual/en/intldateformatter.localtime.php">
 <link rel="next" href="https://www.php.net/manual/en/intldateformatter.setcalendar.php">
...
<meta name="Description" content="Parse string to a timestamp value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlDateFormatter::parse - Manual" />
<meta name="twitter:description" content="Parse string to a timestamp value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlDateFormatter::parse - Manual" />
<meta itemprop="description" content="Parse string to a timestamp value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parse string to a timestamp value" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intldateformatter.parse.php' selected="selected">English</option>
            <option value='de/intldateformatter.parse.php'>German</option>
            <option value='es/intldateformatter.parse.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">IntlDateFormatter::parse</span> -- <span class="refname">datefmt_parse</span> &mdash; <span class="dc-title">Parse string to a timestamp value</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intldateformatter.parse-description">
  ...
  <p class="para rdfs-comment">
   Converts <code class="parameter">string</code> to an incremental time value, starting at 
   <code class="parameter">offset</code> and consuming as much of the input value as possible.
  </p> 
  </div>
 ...
 <div class="refsect1 parameters" id="refsect1-intldateformatter.parse-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Position at which to start the parsing in <code class="parameter">string</code> (zero-based).
       If no error occurs before <code class="parameter">string</code> is consumed, <code class="parameter">offset</code> will contain -1
       otherwise it will contain the position at which parsing ended (and the error occurred).
       This variable will contain the end position if the parse fails.
       If <code class="parameter">offset</code> &gt; <code class="code">strlen($string)</code>, the parse fails immediately.
     </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intldateformatter.parse-returnvalues">
  ...
  <p class="para">
   Timestamp of parsed value, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if value cannot be parsed.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-intldateformatter.parse-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intldateformatter.localtime.php" class="function" rel="rdfs-seeAlso">datefmt_localtime()</a> - Parse string to a field-based time value</span></li>
    ...
    <li><span class="function"><a href="intldateformatter.geterrormessage.php" class="function" rel="rdfs-seeAlso">datefmt_get_error_message()</a> - Get the error text from the last operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/dateformatter/parse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintldateformatter.parse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intldateformatter.parse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intldateformatter.parse.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Please note:<br />* on  a 32-bit system, parse() will return float if the value gets out of integer range<br />* while parse() parses fractional seconds with a format like 'yyyy-MM-dd HH:mm:ss.SSSSSS', it only returns an int. This is also true when the value is returned as float, msecs remain absent in the return value.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=intldateformatter.parse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intldateformatter.parse.php">＋<small>add a note</small></a></div>
