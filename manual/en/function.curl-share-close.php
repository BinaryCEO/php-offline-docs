...
<head>
  ...
  <title>PHP: curl_share_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-share-close.php">
 <link rel="shorturl" href="https://www.php.net/curl-share-close">
 <link rel="alternate" href="https://www.php.net/curl-share-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-setopt-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-share-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-share-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-share-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-share-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-share-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-share-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-share-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-share-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-share-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-share-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-share-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-share-close.php" hreflang="zh">
...
<meta name="Description" content="Close a cURL share handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_share_close - Manual" />
<meta name="twitter:description" content="Close a cURL share handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_share_close - Manual" />
<meta itemprop="description" content="Close a cURL share handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close a cURL share handle" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-share-close.php' selected="selected">English</option>
            <option value='de/function.curl-share-close.php'>German</option>
            <option value='es/function.curl-share-close.php'>Spanish</option>
            <option value='fr/function.curl-share-close.php'>French</option>
            <option value='it/function.curl-share-close.php'>Italian</option>
            <option value='ja/function.curl-share-close.php'>Japanese</option>
            <option value='pt_BR/function.curl-share-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-share-close.php'>Russian</option>
            <option value='tr/function.curl-share-close.php'>Turkish</option>
            <option value='uk/function.curl-share-close.php'>Ukrainian</option>
            <option value='zh/function.curl-share-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-share-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">curl_share_close</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">curl_share_close</span> &mdash; <span class="dc-title">Close a cURL share handle</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.curl-share-close-examples">
  ...
  <p class="para">
   <div class="example" id="example-4499">
    <p><strong>Example #1 <span class="function"><a href="function.curl-share-setopt.php" class="function">curl_share_setopt()</a></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.curl-share-init.php" class="function" rel="rdfs-seeAlso">curl_share_init()</a> - Initialize a cURL share handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-share-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-share-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-share-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-share-close.php">＋<small>add a note</small></a></span>
