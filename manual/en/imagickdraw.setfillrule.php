...
<head>
  ...
  <title>PHP: ImagickDraw::setFillRule - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfillrule.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfillrule.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillrule.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfillpatternurl.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfillrule.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfillrule.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfillrule.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfillrule.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfillrule.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfillrule.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfillrule.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfillrule.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfillrule.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfillrule.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfillrule.php" hreflang="zh">
...
<meta name="Description" content="Sets the fill rule to use while drawing polygons" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFillRule - Manual" />
<meta name="twitter:description" content="Sets the fill rule to use while drawing polygons" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFillRule - Manual" />
<meta itemprop="description" content="Sets the fill rule to use while drawing polygons" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the fill rule to use while drawing polygons" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setfont.php">
          ImagickDraw::setFont &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfillpatternurl.php">
          &laquo; ImagickDraw::setFillPatternURL        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfillrule.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfillrule.php'>German</option>
            <option value='es/imagickdraw.setfillrule.php'>Spanish</option>
            <option value='fr/imagickdraw.setfillrule.php'>French</option>
            <option value='it/imagickdraw.setfillrule.php'>Italian</option>
            <option value='ja/imagickdraw.setfillrule.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfillrule.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfillrule.php'>Russian</option>
            <option value='tr/imagickdraw.setfillrule.php'>Turkish</option>
            <option value='uk/imagickdraw.setfillrule.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfillrule.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfillrule" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFillRule</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFillRule</span> &mdash; <span class="dc-title">Sets the fill rule to use while drawing polygons</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfillrule-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFillRule</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fillrule</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfillrule-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">fillrule</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.fillrule" class="link">FILLRULE</a> constant
       (<code class="literal">imagick::FILLRULE_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfillrule-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3173">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfillrule.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfillrule%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfillrule&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfillrule.php">＋<small>add a note</small></a></span>
