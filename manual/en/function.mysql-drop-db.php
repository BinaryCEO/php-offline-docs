...
<head>
  ...
  <title>PHP: mysql_drop_db - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-drop-db.php">
 <link rel="shorturl" href="https://www.php.net/mysql-drop-db">
 <link rel="alternate" href="https://www.php.net/mysql-drop-db" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-db-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-drop-db.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-drop-db.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-drop-db.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-drop-db.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-drop-db.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-drop-db.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-drop-db.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-drop-db.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-drop-db.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-drop-db.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-drop-db.php" hreflang="zh">
...
<meta name="Description" content="Drop (delete) a MySQL database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_drop_db - Manual" />
<meta name="twitter:description" content="Drop (delete) a MySQL database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_drop_db - Manual" />
<meta itemprop="description" content="Drop (delete) a MySQL database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Drop (delete) a MySQL database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-drop-db.php' selected="selected">English</option>
            <option value='de/function.mysql-drop-db.php'>German</option>
            <option value='es/function.mysql-drop-db.php'>Spanish</option>
            <option value='fr/function.mysql-drop-db.php'>French</option>
            <option value='it/function.mysql-drop-db.php'>Italian</option>
            <option value='ja/function.mysql-drop-db.php'>Japanese</option>
            <option value='pt_BR/function.mysql-drop-db.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-drop-db.php'>Russian</option>
            <option value='tr/function.mysql-drop-db.php'>Turkish</option>
            <option value='uk/function.mysql-drop-db.php'>Ukrainian</option>
            <option value='zh/function.mysql-drop-db.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-drop-db" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_drop_db</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_drop_db</span> &mdash; <span class="dc-title">Drop (delete) a MySQL database</span></p>

 </div>

 <div id="function.mysql-drop-db-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li>Execute a <code class="literal">DROP DATABASE</code> query</li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-drop-db-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_drop_db</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$database_name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_drop_db()</strong></span> attempts to drop (remove) an
   entire database from the server associated with the specified
   link identifier. This function is deprecated, it is preferable to use 
   <span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span> to issue an sql 
   <code class="literal">DROP DATABASE</code> statement instead.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mysql-drop-db-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-drop-db-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-drop-db-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1885">
    <p><strong>Example #1 <span class="function"><strong>mysql_drop_db()</strong></span> alternative example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$link </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_user'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_password'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$link</span><span style="color: #007700">) {<br />    die(</span><span style="color: #DD0000">'Could not connect: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">());<br />}<br /><br /></span><span style="color: #0000BB">$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">'DROP DATABASE my_db'</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$sql</span><span style="color: #007700">, </span><span style="color: #0000BB">$link</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"Database my_db was successfully dropped\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'Error dropping database: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">() . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-drop-db-notes">
...
deprecated alias may be used: 
    <span class="function"><strong>mysql_dropdb()</strong></span>
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.mysql-drop-db-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-drop-db.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-drop-db%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-drop-db&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-drop-db.php">＋<small>add a note</small></a></span>
