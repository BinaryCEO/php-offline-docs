...
<head>
  ...
  <title>PHP: mb_output_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-output-handler.php">
 <link rel="shorturl" href="https://www.php.net/mb-output-handler">
 <link rel="alternate" href="https://www.php.net/mb-output-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ord.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-parse-str.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-output-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-output-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-output-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-output-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-output-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-output-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-output-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-output-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-output-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-output-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-output-handler.php" hreflang="zh">
...
<meta name="Description" content="Callback function converts character encoding in output buffer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_output_handler - Manual" />
<meta name="twitter:description" content="Callback function converts character encoding in output buffer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_output_handler - Manual" />
<meta itemprop="description" content="Callback function converts character encoding in output buffer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Callback function converts character encoding in output buffer" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-output-handler.php' selected="selected">English</option>
            <option value='de/function.mb-output-handler.php'>German</option>
            <option value='es/function.mb-output-handler.php'>Spanish</option>
            <option value='fr/function.mb-output-handler.php'>French</option>
            <option value='it/function.mb-output-handler.php'>Italian</option>
            <option value='ja/function.mb-output-handler.php'>Japanese</option>
            <option value='pt_BR/function.mb-output-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-output-handler.php'>Russian</option>
            <option value='tr/function.mb-output-handler.php'>Turkish</option>
            <option value='uk/function.mb-output-handler.php'>Ukrainian</option>
            <option value='zh/function.mb-output-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-output-handler" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ob-start.php" class="function" rel="rdfs-seeAlso">ob_start()</a> - Turn on output buffering</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-output-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-output-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-output-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-output-handler.php">＋<small>add a note</small></a></span>
