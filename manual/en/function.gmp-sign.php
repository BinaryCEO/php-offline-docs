...
<head>
  ...
  <title>PHP: gmp_sign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-sign.php">
 <link rel="shorturl" href="https://www.php.net/gmp-sign">
 <link rel="alternate" href="https://www.php.net/gmp-sign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-setbit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-sqrt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-sign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-sign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-sign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-sign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-sign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-sign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-sign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-sign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-sign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-sign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-sign.php" hreflang="zh">
...
<meta name="Description" content="Sign of number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_sign - Manual" />
<meta name="twitter:description" content="Sign of number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_sign - Manual" />
<meta itemprop="description" content="Sign of number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sign of number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmp-sqrt.php">
          gmp_sqrt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-setbit.php">
          &laquo; gmp_setbit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-sign.php' selected="selected">English</option>
            <option value='de/function.gmp-sign.php'>German</option>
            <option value='es/function.gmp-sign.php'>Spanish</option>
            <option value='fr/function.gmp-sign.php'>French</option>
            <option value='it/function.gmp-sign.php'>Italian</option>
            <option value='ja/function.gmp-sign.php'>Japanese</option>
            <option value='pt_BR/function.gmp-sign.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-sign.php'>Russian</option>
            <option value='tr/function.gmp-sign.php'>Turkish</option>
            <option value='uk/function.gmp-sign.php'>Ukrainian</option>
            <option value='zh/function.gmp-sign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-sign" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_sign</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_sign</span> &mdash; <span class="dc-title">Sign of number</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-sign-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_sign</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-sign-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Either a <span class="classname"><a href="class.gmp.php" class="classname">GMP</a></span> object, or a numeric
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-sign-returnvalues">
  ...
  <p class="para">
   Returns 1 if <code class="parameter">num</code> is positive,
   -1 if <code class="parameter">num</code> is negative,
   and 0 if <code class="parameter">num</code> is zero.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.gmp-sign-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.abs.php" class="function" rel="rdfs-seeAlso">abs()</a> - Absolute value</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-sign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-sign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-sign.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106246">  <div class="votes">
    <div id="Vu106246">
    <a href="/manual/vote-note.php?id=106246&amp;page=function.gmp-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106246">
    <a href="/manual/vote-note.php?id=106246&amp;page=function.gmp-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106246" title="69% like this...">
    18
    </div>
  </div>
  <a href="#106246" class="name">
  <strong class="user"><em>thomas at zilliox dot me</em></strong></a><a class="genanchor" href="#106246"> &para;</a><div class="date" title="2011-10-21 03:11"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106246">
...
<br /></span>
<br />Thomas.</span></code></div>
  </div>
 </div>
  <div class="note" id="121393">  <div class="votes">
    <div id="Vu121393">
    <a href="/manual/vote-note.php?id=121393&amp;page=function.gmp-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121393">
    <a href="/manual/vote-note.php?id=121393&amp;page=function.gmp-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121393" title="77% like this...">
    12
    </div>
  </div>
  <a href="#121393" class="name">
  <strong class="user"><em>Andrew Martin</em></strong></a><a class="genanchor" href="#121393"> &para;</a><div class="date" title="2017-07-18 01:28"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121393">
<div class="phpcode"><code><span class="html">Using a spaceship in PHP7:<br /><br /><span class="default">&lt;?php<br />$sign </span><span class="keyword">= </span><span class="default">$number </span><span class="keyword">&lt;=&gt; </span><span class="default">0</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmp-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-sign.php">＋<small>add a note</small></a></div>
