...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pcntl-wexitstatus.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-waitpid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pcntl-wifexited.php">
...
<meta name="Description" content="Returns the return code of a terminated child" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pcntl_wexitstatus - Manual" />
<meta name="twitter:description" content="Returns the return code of a terminated child" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pcntl_wexitstatus - Manual" />
<meta itemprop="description" content="Returns the return code of a terminated child" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the return code of a terminated child" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pcntl-wexitstatus.php' selected="selected">English</option>
            ...
            <option value='ru/function.pcntl-wexitstatus.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pcntl_wexitstatus</span> &mdash; <span class="dc-title">Returns the return code of a terminated child</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pcntl-wexitstatus-description">
  ...
  <p class="para rdfs-comment">
   ...
   only useful if <span class="function"><a href="function.pcntl-wifexited.php" class="function">pcntl_wifexited()</a></span> returned
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pcntl-wifexited.php" class="function" rel="rdfs-seeAlso">pcntl_wifexited()</a> - Checks if status code represents a normal exit</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcntl/functions/pcntl-wexitstatus.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pcntl-wexitstatus%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pcntl-wexitstatus&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-wexitstatus.php">＋<small>add a note</small></a></span>
