...
<head>
  ...
  <title>PHP: Imagick::clutImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clutimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clutimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clutimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clone.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.coalesceimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clutimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clutimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clutimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clutimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clutimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clutimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clutimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clutimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clutimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clutimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clutimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::clutImage - Manual" />
<meta name="twitter:description" content="Replaces colors in the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clutImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.coalesceimages.php">
          Imagick::coalesceImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clone.php">
          &laquo; Imagick::clone        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clutimage.php' selected="selected">English</option>
            <option value='de/imagick.clutimage.php'>German</option>
            <option value='es/imagick.clutimage.php'>Spanish</option>
            <option value='fr/imagick.clutimage.php'>French</option>
            <option value='it/imagick.clutimage.php'>Italian</option>
            <option value='ja/imagick.clutimage.php'>Japanese</option>
            <option value='pt_BR/imagick.clutimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clutimage.php'>Russian</option>
            <option value='tr/imagick.clutimage.php'>Turkish</option>
            <option value='uk/imagick.clutimage.php'>Ukrainian</option>
            <option value='zh/imagick.clutimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clutimage" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.radialblurimage.php" class="function" rel="rdfs-seeAlso">Imagick::radialBlurImage()</a> - Radial blurs an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clutimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clutimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clutimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clutimage.php">＋<small>add a note</small></a></span>
