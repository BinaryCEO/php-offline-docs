...
<head>
  ...
  <title>PHP: oci_free_descriptor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-free-descriptor.php">
 <link rel="shorturl" href="https://www.php.net/oci-free-descriptor">
 <link rel="alternate" href="https://www.php.net/oci-free-descriptor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-field-type-raw.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-free-statement.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-free-descriptor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-free-descriptor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-free-descriptor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-free-descriptor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-free-descriptor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-free-descriptor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-free-descriptor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-free-descriptor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-free-descriptor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-free-descriptor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-free-descriptor.php" hreflang="zh">
...
<meta name="Description" content="Frees a descriptor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_free_descriptor - Manual" />
<meta name="twitter:description" content="Frees a descriptor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_free_descriptor - Manual" />
<meta itemprop="description" content="Frees a descriptor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Frees a descriptor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-free-statement.php">
          oci_free_statement &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-field-type-raw.php">
          &laquo; oci_field_type_raw        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-free-descriptor.php' selected="selected">English</option>
            <option value='de/function.oci-free-descriptor.php'>German</option>
            <option value='es/function.oci-free-descriptor.php'>Spanish</option>
            <option value='fr/function.oci-free-descriptor.php'>French</option>
            <option value='it/function.oci-free-descriptor.php'>Italian</option>
            <option value='ja/function.oci-free-descriptor.php'>Japanese</option>
            <option value='pt_BR/function.oci-free-descriptor.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-free-descriptor.php'>Russian</option>
            <option value='tr/function.oci-free-descriptor.php'>Turkish</option>
            <option value='uk/function.oci-free-descriptor.php'>Ukrainian</option>
            <option value='zh/function.oci-free-descriptor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-free-descriptor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_free_descriptor</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_free_descriptor</span> &mdash; <span class="dc-title">Frees a descriptor</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.oci-free-descriptor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_free_descriptor</strong></span>(<span class="methodparam"><span class="type"><a href="class.ocilob.php" class="type OCILob">OCILob</a></span> <code class="parameter">$lob</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Frees a descriptor allocated by <span class="function"><a href="function.oci-new-descriptor.php" class="function">oci_new_descriptor()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.oci-free-descriptor-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Descriptor allocated by <span class="function"><a href="function.oci-new-descriptor.php" class="function">oci_new_descriptor()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-free-descriptor-returnvalues">
 ...
 <div class="refsect1 notes" id="refsect1-function.oci-free-descriptor-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function is commonly used as a method <a href="ocilob.free.php" class="link">OCILOB::free</a>.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.oci-free-descriptor-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><a href="ocilob.free.php" class="link">OCILOB::free</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-free-descriptor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-free-descriptor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-free-descriptor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-free-descriptor.php">＋<small>add a note</small></a></span>
