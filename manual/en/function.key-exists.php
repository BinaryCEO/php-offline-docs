...
<head>
  ...
  <title>PHP: key_exists - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.key-exists.php">
 <link rel="shorturl" href="https://www.php.net/key-exists">
 <link rel="alternate" href="https://www.php.net/key-exists" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.krsort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.key-exists.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.key-exists.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.key-exists.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.key-exists.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.key-exists.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.key-exists.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.key-exists.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.key-exists.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.key-exists.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.key-exists.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.key-exists.php" hreflang="zh">
...
<meta name="Description" content="Alias of array_key_exists" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: key_exists - Manual" />
<meta name="twitter:description" content="Alias of array_key_exists" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: key_exists - Manual" />
<meta itemprop="description" content="Alias of array_key_exists" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of array_key_exists" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.key-exists.php' selected="selected">English</option>
            <option value='de/function.key-exists.php'>German</option>
            <option value='es/function.key-exists.php'>Spanish</option>
            <option value='fr/function.key-exists.php'>French</option>
            <option value='it/function.key-exists.php'>Italian</option>
            <option value='ja/function.key-exists.php'>Japanese</option>
            <option value='pt_BR/function.key-exists.php'>Brazilian Portuguese</option>
            <option value='ru/function.key-exists.php'>Russian</option>
            <option value='tr/function.key-exists.php'>Turkish</option>
            <option value='uk/function.key-exists.php'>Ukrainian</option>
            <option value='zh/function.key-exists.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.key-exists" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">key_exists</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">key_exists</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.array-key-exists.php" class="function">array_key_exists()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.key-exists-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.array-key-exists.php" class="function">array_key_exists()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/key-exists.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.key-exists%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.key-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.key-exists.php">＋<small>add a note</small></a></span>
