...
<head>
  ...
  <title>PHP: ocinlogon - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocinlogon.php">
 <link rel="shorturl" href="https://www.php.net/ocinlogon">
 <link rel="alternate" href="https://www.php.net/ocinlogon" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocinewdescriptor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocinumcols.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocinlogon.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocinlogon.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocinlogon.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocinlogon.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocinlogon.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocinlogon.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocinlogon.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocinlogon.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocinlogon.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocinlogon.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocinlogon.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_new_connect" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocinlogon - Manual" />
<meta name="twitter:description" content="Alias of oci_new_connect" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocinlogon - Manual" />
<meta itemprop="description" content="Alias of oci_new_connect" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_new_connect" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocinumcols.php">
          ocinumcols &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocinewdescriptor.php">
          &laquo; ocinewdescriptor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocinlogon.php' selected="selected">English</option>
            <option value='de/function.ocinlogon.php'>German</option>
            <option value='es/function.ocinlogon.php'>Spanish</option>
            <option value='fr/function.ocinlogon.php'>French</option>
            <option value='it/function.ocinlogon.php'>Italian</option>
            <option value='ja/function.ocinlogon.php'>Japanese</option>
            <option value='pt_BR/function.ocinlogon.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocinlogon.php'>Russian</option>
            <option value='tr/function.ocinlogon.php'>Turkish</option>
            <option value='uk/function.ocinlogon.php'>Ukrainian</option>
            <option value='zh/function.ocinlogon.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocinlogon" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocinlogon</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocinlogon</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-new-connect.php" class="function">oci_new_connect()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocinlogon-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-new-connect.php" class="function">oci_new_connect()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocinlogon.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocinlogon%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocinlogon&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocinlogon.php">＋<small>add a note</small></a></span>
