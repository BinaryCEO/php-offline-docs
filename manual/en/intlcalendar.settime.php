...
<head>
  ...
  <title>PHP: IntlCalendar::setTime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.settime.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.settime.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.settime.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.setskippedwalltimeoption.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.settimezone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.settime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.settime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.settime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.settime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.settime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.settime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.settime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.settime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.settime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.settime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.settime.php" hreflang="zh">
...
<meta name="Description" content="Set the calendar time in milliseconds since the epoch" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::setTime - Manual" />
<meta name="twitter:description" content="Set the calendar time in milliseconds since the epoch" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::setTime - Manual" />
<meta itemprop="description" content="Set the calendar time in milliseconds since the epoch" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the calendar time in milliseconds since the epoch" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlcalendar.settimezone.php">
          IntlCalendar::setTimeZone &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.setskippedwalltimeoption.php">
          &laquo; IntlCalendar::setSkippedWallTimeOption        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.settime.php' selected="selected">English</option>
            <option value='de/intlcalendar.settime.php'>German</option>
            <option value='es/intlcalendar.settime.php'>Spanish</option>
            <option value='fr/intlcalendar.settime.php'>French</option>
            <option value='it/intlcalendar.settime.php'>Italian</option>
            <option value='ja/intlcalendar.settime.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.settime.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.settime.php'>Russian</option>
            <option value='tr/intlcalendar.settime.php'>Turkish</option>
            <option value='uk/intlcalendar.settime.php'>Ukrainian</option>
            <option value='zh/intlcalendar.settime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.settime" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::setTime</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::setTime</span> &mdash; <span class="dc-title">Set the calendar time in milliseconds since the epoch</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.settime-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::setTime</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$timestamp</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_set_time</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$timestamp</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets the instant represented by this object. The instant is represented by
   a <span class="type"><a href="language.types.float.php" class="type float">float</a></span> whose value should be an integer number of
...
<div class="examplescode"><pre class="examplescode">samedi 1 juin 2013 12:00:00 heure avancée d’Europe de l’Ouest
dimanche 27 octobre 2013 01:30:00 heure avancée d’Europe de l’Ouest
dimanche 27 octobre 2013 01:30:00 heure normale d’Europe de l’Ouest</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/settime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.settime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.settime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.settime.php">＋<small>add a note</small></a></span>
