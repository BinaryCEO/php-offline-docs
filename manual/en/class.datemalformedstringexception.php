...
<head>
  ...
  <title>PHP: DateMalformedStringException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.datemalformedstringexception.php">
 <link rel="shorturl" href="https://www.php.net/datemalformedstringexception">
 <link rel="alternate" href="https://www.php.net/datemalformedstringexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.datemalformedperiodstringexception.php">
 <link rel="next" href="https://www.php.net/manual/en/book.hrtime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.datemalformedstringexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.datemalformedstringexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.datemalformedstringexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.datemalformedstringexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.datemalformedstringexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.datemalformedstringexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.datemalformedstringexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.datemalformedstringexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.datemalformedstringexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.datemalformedstringexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.datemalformedstringexception.php" hreflang="zh">
...
<meta name="Description" content="The DateMalformedStringException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateMalformedStringException - Manual" />
<meta name="twitter:description" content="The DateMalformedStringException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateMalformedStringException - Manual" />
<meta itemprop="description" content="The DateMalformedStringException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateMalformedStringException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.hrtime.php">
          HRTime &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.datemalformedperiodstringexception.php">
          &laquo; DateMalformedPeriodStringException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.datemalformedstringexception.php' selected="selected">English</option>
            <option value='de/class.datemalformedstringexception.php'>German</option>
            <option value='es/class.datemalformedstringexception.php'>Spanish</option>
            <option value='fr/class.datemalformedstringexception.php'>French</option>
            <option value='it/class.datemalformedstringexception.php'>Italian</option>
            <option value='ja/class.datemalformedstringexception.php'>Japanese</option>
            <option value='pt_BR/class.datemalformedstringexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.datemalformedstringexception.php'>Russian</option>
            <option value='tr/class.datemalformedstringexception.php'>Turkish</option>
            <option value='uk/class.datemalformedstringexception.php'>Ukrainian</option>
            <option value='zh/class.datemalformedstringexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.datemalformedstringexception" class="reference">
 <h1 class="title">The DateMalformedStringException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="datemalformedstringexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown when an invalid Date/Time string is detected.
   </p>
   <p class="para">
    This can be as value to
    <span class="methodname"><a href="datetimeimmutable.construct.php" class="methodname">DateTimeImmutable::__construct()</a></span>,
    <span class="methodname"><a href="datetimeimmutable.modify.php" class="methodname">DateTimeImmutable::modify()</a></span>,
    <span class="methodname"><a href="datetime.construct.php" class="methodname">DateTime::__construct()</a></span>, or
    <span class="methodname"><a href="datetime.modify.php" class="methodname">DateTime::modify()</a></span>.
   </p>
  </div>


  <div class="section" id="datemalformedstringexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateMalformedStringException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datemalformedstringexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.datemalformedstringexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.datemalformedstringexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.datemalformedstringexception.php">＋<small>add a note</small></a></span>
