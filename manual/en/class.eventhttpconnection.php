...
<head>
  ...
  <title>PHP: EventHttpConnection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.eventhttpconnection.php">
 <link rel="shorturl" href="https://www.php.net/eventhttpconnection">
 <link rel="alternate" href="https://www.php.net/eventhttpconnection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttp.settimeout.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttpconnection.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.eventhttpconnection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.eventhttpconnection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.eventhttpconnection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.eventhttpconnection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.eventhttpconnection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.eventhttpconnection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.eventhttpconnection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.eventhttpconnection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.eventhttpconnection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.eventhttpconnection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.eventhttpconnection.php" hreflang="zh">
...
<meta name="Description" content="The EventHttpConnection class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttpConnection - Manual" />
<meta name="twitter:description" content="The EventHttpConnection class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttpConnection - Manual" />
<meta itemprop="description" content="The EventHttpConnection class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EventHttpConnection class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventhttpconnection.construct.php">
          EventHttpConnection::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttp.settimeout.php">
          &laquo; EventHttp::setTimeout        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.eventhttpconnection.php' selected="selected">English</option>
            <option value='de/class.eventhttpconnection.php'>German</option>
            <option value='es/class.eventhttpconnection.php'>Spanish</option>
            <option value='fr/class.eventhttpconnection.php'>French</option>
            <option value='it/class.eventhttpconnection.php'>Italian</option>
            <option value='ja/class.eventhttpconnection.php'>Japanese</option>
            <option value='pt_BR/class.eventhttpconnection.php'>Brazilian Portuguese</option>
            <option value='ru/class.eventhttpconnection.php'>Russian</option>
            <option value='tr/class.eventhttpconnection.php'>Turkish</option>
            <option value='uk/class.eventhttpconnection.php'>Ukrainian</option>
            <option value='zh/class.eventhttpconnection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.eventhttpconnection" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="eventhttpconnection.construct.php">EventHttpConnection::__construct</a> — Constructs EventHttpConnection object</li><li><a href="eventhttpconnection.getbase.php">EventHttpConnection::getBase</a> — Returns event base associated with the connection</li><li><a href="eventhttpconnection.getpeer.php">EventHttpConnection::getPeer</a> — Gets the remote address and port associated with the connection</li><li><a href="eventhttpconnection.makerequest.php">EventHttpConnection::makeRequest</a> — Makes an HTTP request over the specified connection</li><li><a href="eventhttpconnection.setclosecallback.php">EventHttpConnection::setCloseCallback</a> — Set callback for connection close</li><li><a href="eventhttpconnection.setlocaladdress.php">EventHttpConnection::setLocalAddress</a> — Sets the IP address from which HTTP connections are made</li><li><a href="eventhttpconnection.setlocalport.php">EventHttpConnection::setLocalPort</a> — Sets the local port from which connections are made</li><li><a href="eventhttpconnection.setmaxbodysize.php">EventHttpConnection::setMaxBodySize</a> — Sets maximum body size for the connection</li><li><a href="eventhttpconnection.setmaxheaderssize.php">EventHttpConnection::setMaxHeadersSize</a> — Sets maximum header size</li><li><a href="eventhttpconnection.setretries.php">EventHttpConnection::setRetries</a> — Sets the retry limit for the connection</li><li><a href="eventhttpconnection.settimeout.php">EventHttpConnection::setTimeout</a> — Sets the timeout for the connection</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttpconnection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.eventhttpconnection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.eventhttpconnection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.eventhttpconnection.php">＋<small>add a note</small></a></span>
