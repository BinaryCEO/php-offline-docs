...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightMaxAlternateFieldLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightmaxanalyzedchars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightmaxalternatefieldlength.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of characters of the field to return" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightMaxAlternateFieldLength - Manual" />
<meta name="twitter:description" content="Returns the maximum number of characters of the field to return" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightMaxAlternateFieldLength - Manual" />
<meta itemprop="description" content="Returns the maximum number of characters of the field to return" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of characters of the field to return" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightmaxanalyzedchars.php">
          SolrQuery::getHighlightMaxAnalyzedChars &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlighthighlightmultiterm.php">
          &laquo; SolrQuery::getHighlightHighlightMultiTerm        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightmaxalternatefieldlength.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightmaxalternatefieldlength.php'>German</option>
            <option value='es/solrquery.gethighlightmaxalternatefieldlength.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightmaxalternatefieldlength.php'>French</option>
            <option value='it/solrquery.gethighlightmaxalternatefieldlength.php'>Italian</option>
            <option value='ja/solrquery.gethighlightmaxalternatefieldlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightmaxalternatefieldlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightmaxalternatefieldlength.php'>Russian</option>
            <option value='tr/solrquery.gethighlightmaxalternatefieldlength.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightmaxalternatefieldlength.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightmaxalternatefieldlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightmaxalternatefieldlength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightMaxAlternateFieldLength</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightMaxAlternateFieldLength</span> &mdash; <span class="dc-title">Returns the maximum number of characters of the field to return</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightmaxalternatefieldlength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightMaxAlternateFieldLength</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightmaxalternatefieldlength-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightmaxalternatefieldlength-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightmaxalternatefieldlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightmaxalternatefieldlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightmaxalternatefieldlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php">＋<small>add a note</small></a></span>
