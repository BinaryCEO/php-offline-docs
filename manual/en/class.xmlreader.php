...
<head>
  ...
  <title>PHP: XMLReader - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.xmlreader.php">
 <link rel="shorturl" href="https://www.php.net/xmlreader">
 <link rel="alternate" href="https://www.php.net/xmlreader" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.xmlreader.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlreader.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlreader.close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.xmlreader.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.xmlreader.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.xmlreader.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.xmlreader.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.xmlreader.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.xmlreader.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.xmlreader.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.xmlreader.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.xmlreader.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.xmlreader.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.xmlreader.php" hreflang="zh">
...
<meta name="Description" content="The XMLReader class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: XMLReader - Manual" />
<meta name="twitter:description" content="The XMLReader class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: XMLReader - Manual" />
<meta itemprop="description" content="The XMLReader class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The XMLReader class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="xmlreader.close.php">
          XMLReader::close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="xmlreader.installation.php">
          &laquo; Installation        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.xml.php'>XML Manipulation</a></li>      <li><a href='book.xmlreader.php'>XMLReader</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.xmlreader.php' selected="selected">English</option>
            <option value='de/class.xmlreader.php'>German</option>
            <option value='es/class.xmlreader.php'>Spanish</option>
            <option value='fr/class.xmlreader.php'>French</option>
            <option value='it/class.xmlreader.php'>Italian</option>
            <option value='ja/class.xmlreader.php'>Japanese</option>
            <option value='pt_BR/class.xmlreader.php'>Brazilian Portuguese</option>
            <option value='ru/class.xmlreader.php'>Russian</option>
            <option value='tr/class.xmlreader.php'>Turkish</option>
            <option value='uk/class.xmlreader.php'>Ukrainian</option>
            <option value='zh/class.xmlreader.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.xmlreader" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="xmlreader.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">XMLReader</strong></strong>
     {</div>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.none"><var class="varname">NONE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.element"><var class="varname">ELEMENT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.attribute"><var class="varname">ATTRIBUTE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.text"><var class="varname">TEXT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.cdata"><var class="varname">CDATA</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.entity-ref"><var class="varname">ENTITY_REF</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.entity"><var class="varname">ENTITY</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.pi"><var class="varname">PI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.comment"><var class="varname">COMMENT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.doc"><var class="varname">DOC</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.doc-type"><var class="varname">DOC_TYPE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.doc-fragment"><var class="varname">DOC_FRAGMENT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.notation"><var class="varname">NOTATION</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.whitespace"><var class="varname">WHITESPACE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.significant-whitespace"><var class="varname">SIGNIFICANT_WHITESPACE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.end-element"><var class="varname">END_ELEMENT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.end-entity"><var class="varname">END_ENTITY</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.xml-declaration"><var class="varname">XML_DECLARATION</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.loaddtd"><var class="varname">LOADDTD</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.defaultattrs"><var class="varname">DEFAULTATTRS</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.validate"><var class="varname">VALIDATE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.xmlreader.php#xmlreader.constants.subst-entities"><var class="varname">SUBST_ENTITIES</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Properties */</div>
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.attributecount">$<var class="varname">attributeCount</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.baseuri">$<var class="varname">baseURI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.depth">$<var class="varname">depth</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.hasattributes">$<var class="varname">hasAttributes</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.hasvalue">$<var class="varname">hasValue</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.isdefault">$<var class="varname">isDefault</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.isemptyelement">$<var class="varname">isEmptyElement</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.localname">$<var class="varname">localName</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.name">$<var class="varname">name</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.namespaceuri">$<var class="varname">namespaceURI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.nodetype">$<var class="varname">nodeType</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.prefix">$<var class="varname">prefix</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.value">$<var class="varname">value</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
      <var class="varname"><a href="class.xmlreader.php#xmlreader.props.xmllang">$<var class="varname">xmlLang</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="xmlreader.close.php" class="methodname">close</a></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.expand.php" class="methodname">expand</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.domnode.php" class="type DOMNode">DOMNode</a></span></span> <code class="parameter">$baseNode</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.domnode.php" class="type DOMNode">DOMNode</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="xmlreader.fromstream.php" class="methodname">fromStream</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$documentUri</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type">static</span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="xmlreader.fromstring.php" class="methodname">fromString</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type">static</span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="xmlreader.fromuri.php" class="methodname">fromUri</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$uri</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type">static</span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.getattribute.php" class="methodname">getAttribute</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.getattributeno.php" class="methodname">getAttributeNo</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.getattributens.php" class="methodname">getAttributeNs</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$namespace</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.getparserproperty.php" class="methodname">getParserProperty</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$property</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.isvalid.php" class="methodname">isValid</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.lookupnamespace.php" class="methodname">lookupNamespace</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$prefix</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetoattribute.php" class="methodname">moveToAttribute</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetoattributeno.php" class="methodname">moveToAttributeNo</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetoattributens.php" class="methodname">moveToAttributeNs</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$namespace</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetoelement.php" class="methodname">moveToElement</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetofirstattribute.php" class="methodname">moveToFirstAttribute</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.movetonextattribute.php" class="methodname">moveToNextAttribute</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.next.php" class="methodname">next</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$name</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="xmlreader.open.php" class="methodname">open</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$uri</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="class.xmlreader.php" class="type XMLReader">XMLReader</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.open.php" class="methodname">open</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$uri</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.read.php" class="methodname">read</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.readinnerxml.php" class="methodname">readInnerXml</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.readouterxml.php" class="methodname">readOuterXml</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.readstring.php" class="methodname">readString</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.setparserproperty.php" class="methodname">setParserProperty</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$property</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.setrelaxngschema.php" class="methodname">setRelaxNGSchema</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.setrelaxngschemasource.php" class="methodname">setRelaxNGSchemaSource</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$source</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.setschema.php" class="methodname">setSchema</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="xmlreader.xml.php" class="methodname">XML</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="class.xmlreader.php" class="type XMLReader">XMLReader</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="xmlreader.xml.php" class="methodname">XML</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="xmlreader.props">
   ...
   <dl>
     ...
     <dt id="xmlreader.props.attributecount"><var class="varname">attributeCount</var></dt>
     <dd>
      <p class="para">
     ...
     <dt id="xmlreader.props.baseuri"><var class="varname">baseURI</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.depth"><var class="varname">depth</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.hasattributes"><var class="varname">hasAttributes</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.hasvalue"><var class="varname">hasValue</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.isdefault"><var class="varname">isDefault</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.isemptyelement"><var class="varname">isEmptyElement</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.localname"><var class="varname">localName</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.name"><var class="varname">name</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.namespaceuri"><var class="varname">namespaceURI</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.nodetype"><var class="varname">nodeType</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.prefix"><var class="varname">prefix</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.value"><var class="varname">value</var></dt>
     <dd>
     ...
     <dt id="xmlreader.props.xmllang"><var class="varname">xmlLang</var></dt>
     <dd>
  ...
  <div class="section" id="xmlreader.constants">
   ...
   <div class="section" id="xmlreader.constants.types">
    ...
    <dl>
      ...
      <dt id="xmlreader.constants.none"><strong><code><a href="class.xmlreader.php#xmlreader.constants.none">XMLReader::NONE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.element"><strong><code><a href="class.xmlreader.php#xmlreader.constants.element">XMLReader::ELEMENT</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.attribute"><strong><code><a href="class.xmlreader.php#xmlreader.constants.attribute">XMLReader::ATTRIBUTE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.text"><strong><code><a href="class.xmlreader.php#xmlreader.constants.text">XMLReader::TEXT</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.cdata"><strong><code><a href="class.xmlreader.php#xmlreader.constants.cdata">XMLReader::CDATA</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.entity-ref"><strong><code><a href="class.xmlreader.php#xmlreader.constants.entity-ref">XMLReader::ENTITY_REF</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.entity"><strong><code><a href="class.xmlreader.php#xmlreader.constants.entity">XMLReader::ENTITY</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.pi"><strong><code><a href="class.xmlreader.php#xmlreader.constants.pi">XMLReader::PI</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.comment"><strong><code><a href="class.xmlreader.php#xmlreader.constants.comment">XMLReader::COMMENT</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.doc"><strong><code><a href="class.xmlreader.php#xmlreader.constants.doc">XMLReader::DOC</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.doc-type"><strong><code><a href="class.xmlreader.php#xmlreader.constants.doc-type">XMLReader::DOC_TYPE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.doc-fragment"><strong><code><a href="class.xmlreader.php#xmlreader.constants.doc-fragment">XMLReader::DOC_FRAGMENT</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.notation"><strong><code><a href="class.xmlreader.php#xmlreader.constants.notation">XMLReader::NOTATION</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.whitespace"><strong><code><a href="class.xmlreader.php#xmlreader.constants.whitespace">XMLReader::WHITESPACE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.significant-whitespace"><strong><code><a href="class.xmlreader.php#xmlreader.constants.significant-whitespace">XMLReader::SIGNIFICANT_WHITESPACE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.end-element"><strong><code><a href="class.xmlreader.php#xmlreader.constants.end-element">XMLReader::END_ELEMENT</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.end-entity"><strong><code><a href="class.xmlreader.php#xmlreader.constants.end-entity">XMLReader::END_ENTITY</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.xml-declaration"><strong><code><a href="class.xmlreader.php#xmlreader.constants.xml-declaration">XMLReader::XML_DECLARATION</a></code></strong></dt>
      <dd>
   ...
   <div class="section" id="xmlreader.constants.options">
    ...
    <dl>
      ...
      <dt id="xmlreader.constants.loaddtd"><strong><code><a href="class.xmlreader.php#xmlreader.constants.loaddtd">XMLReader::LOADDTD</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.defaultattrs"><strong><code><a href="class.xmlreader.php#xmlreader.constants.defaultattrs">XMLReader::DEFAULTATTRS</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.validate"><strong><code><a href="class.xmlreader.php#xmlreader.constants.validate">XMLReader::VALIDATE</a></code></strong></dt>
      <dd>
      ...
      <dt id="xmlreader.constants.subst-entities"><strong><code><a href="class.xmlreader.php#xmlreader.constants.subst-entities">XMLReader::SUBST_ENTITIES</a></code></strong></dt>
      <dd>
...
<br />may be some xml has emptyelement</span></code></div>
  </div>
 </div>
  <div class="note" id="111837">  <div class="votes">
    <div id="Vu111837">
    <a href="/manual/vote-note.php?id=111837&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111837">
    <a href="/manual/vote-note.php?id=111837&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111837" title="73% like this...">
    11
    </div>
  </div>
  <a href="#111837" class="name">
  <strong class="user"><em>kula_shakerz</em></strong></a><a class="genanchor" href="#111837"> &para;</a><div class="date" title="2013-04-03 02:27"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111837">
<div class="phpcode"><code><span class="html">Found this in the IXmlReader docs at msdn but it's also valid for XMLReader in PHP.<br /><br />You should save the value of $isEmptyElement before processing attributes, or call moveToElement to make $isEmptyElement valid after processing attributes.<br /><br />$isEmptyElement returns FALSE when XMLReader is positioned on an attribute node, even if attribute's parent element is empty.</span></code></div>
  </div>
 </div>
  <div class="note" id="120426">  <div class="votes">
    <div id="Vu120426">
    <a href="/manual/vote-note.php?id=120426&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120426">
    <a href="/manual/vote-note.php?id=120426&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120426" title="83% like this...">
    4
    </div>
  </div>
  <a href="#120426" class="name">
  <strong class="user"><em>Sean Colin Ruiz</em></strong></a><a class="genanchor" href="#120426"> &para;</a><div class="date" title="2017-01-08 03:11"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120426">
<div class="phpcode"><code><span class="html">As japos mentioned. Take care how you use isEmptyElement. After you are done looping through the attributes: isEmptyElement will be false.  You can use moveToElement() to move the cursor back to the element and then you can use isEmptyElement like normal again.</span></code></div>
  </div>
 </div>
  <div class="note" id="113381">  <div class="votes">
    <div id="Vu113381">
    <a href="/manual/vote-note.php?id=113381&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113381">
    <a href="/manual/vote-note.php?id=113381&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113381" title="68% like this...">
    13
    </div>
  </div>
  <a href="#113381" class="name">
  <strong class="user"><em>dkrnl at yandex dot ru</em></strong></a><a class="genanchor" href="#113381"> &para;</a><div class="date" title="2013-10-04 04:10"><strong>11 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Wrapper XMLReader class, for simple SAX-reading huge xml:<br /><a href="https://github.com/dkrnl/SimpleXMLReader" rel="nofollow" target="_blank">https://github.com/dkrnl/SimpleXMLReader</a><br /><br />Usage example: <a href="http://github.com/dkrnl/SimpleXMLReader/blob/master/examples/example1.php" rel="nofollow" target="_blank">http://github.com/dkrnl/SimpleXMLReader/blob/master/examples/example1.php</a><br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/**<br /> * Simple XML Reader<br /> *<br /> * @license Public Domain<br /> * @author Dmitry Pyatkov(aka dkrnl) &lt;dkrnl@yandex.ru&gt;<br /> * @url <a href="http://github.com/dkrnl/SimpleXMLReader" rel="nofollow" target="_blank">http://github.com/dkrnl/SimpleXMLReader</a><br /> */<br /></span><span class="keyword">class </span><span class="default">SimpleXMLReader </span><span class="keyword">extends </span><span class="default">XMLReader<br /></span><span class="keyword">{<br /><br />    </span><span class="comment">/**<br />     * Callbacks<br />     *<br />     * @var array<br />     */<br />    </span><span class="keyword">protected </span><span class="default">$callback </span><span class="keyword">= array();<br /><br />    </span><span class="comment">/**<br />     * Add node callback<br />     *<br />     * @param  string   $name<br />     * @param  callback $callback<br />     * @param  integer  $nodeType<br />     * @return SimpleXMLReader<br />     */<br />    </span><span class="keyword">public function </span><span class="default">registerCallback</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$callback</span><span class="keyword">, </span><span class="default">$nodeType </span><span class="keyword">= </span><span class="default">XMLREADER</span><span class="keyword">::</span><span class="default">ELEMENT</span><span class="keyword">)<br />    {<br />        if (isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$nodeType</span><span class="keyword">][</span><span class="default">$name</span><span class="keyword">])) {<br />            throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Already exists callback </span><span class="default">$name</span><span class="string">(</span><span class="default">$nodeType</span><span class="string">)."</span><span class="keyword">);<br />        }<br />        if (!</span><span class="default">is_callable</span><span class="keyword">(</span><span class="default">$callback</span><span class="keyword">)) {<br />            throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Already exists parser callback </span><span class="default">$name</span><span class="string">(</span><span class="default">$nodeType</span><span class="string">)."</span><span class="keyword">);<br />        }<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$nodeType</span><span class="keyword">][</span><span class="default">$name</span><span class="keyword">] = </span><span class="default">$callback</span><span class="keyword">;<br />        return </span><span class="default">$this</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">/**<br />     * Remove node callback<br />     *<br />     * @param  string  $name<br />     * @param  integer $nodeType<br />     * @return SimpleXMLReader<br />     */<br />    </span><span class="keyword">public function </span><span class="default">unRegisterCallback</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$nodeType </span><span class="keyword">= </span><span class="default">XMLREADER</span><span class="keyword">::</span><span class="default">ELEMENT</span><span class="keyword">)<br />    {<br />        if (!isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$nodeType</span><span class="keyword">][</span><span class="default">$name</span><span class="keyword">])) {<br />            throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Unknow parser callback </span><span class="default">$name</span><span class="string">(</span><span class="default">$nodeType</span><span class="string">)."</span><span class="keyword">);<br />        }<br />        unset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$nodeType</span><span class="keyword">][</span><span class="default">$name</span><span class="keyword">]);<br />        return </span><span class="default">$this</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">/**<br />     * Run parser<br />     *<br />     * @return void<br />     */<br />    </span><span class="keyword">public function </span><span class="default">parse</span><span class="keyword">()<br />    {<br />        if (empty(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">)) {<br />            throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Empty parser callback."</span><span class="keyword">);<br />        }<br />        </span><span class="default">$continue </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;<br />        while (</span><span class="default">$continue </span><span class="keyword">&amp;&amp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">read</span><span class="keyword">()) {<br />            if (isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">nodeType</span><span class="keyword">][</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">])) {<br />                </span><span class="default">$continue </span><span class="keyword">= </span><span class="default">call_user_func</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">[</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">nodeType</span><span class="keyword">][</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">], </span><span class="default">$this</span><span class="keyword">);<br />            }<br />        }<br />    }<br /><br />    </span><span class="comment">/**<br />     * Run XPath query on current node<br />     *<br />     * @param  string $path<br />     * @param  string $version<br />     * @param  string $encoding<br />     * @return array(SimpleXMLElement)<br />     */<br />    </span><span class="keyword">public function </span><span class="default">expandXpath</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">, </span><span class="default">$version </span><span class="keyword">= </span><span class="string">"1.0"</span><span class="keyword">, </span><span class="default">$encoding </span><span class="keyword">= </span><span class="string">"UTF-8"</span><span class="keyword">)<br />    {<br />        return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">expandSimpleXml</span><span class="keyword">(</span><span class="default">$version</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">)-&gt;</span><span class="default">xpath</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br />    }<br /><br />    </span><span class="comment">/**<br />     * Expand current node to string<br />     *<br />     * @param  string $version<br />     * @param  string $encoding<br />     * @return SimpleXMLElement<br />     */<br />    </span><span class="keyword">public function </span><span class="default">expandString</span><span class="keyword">(</span><span class="default">$version </span><span class="keyword">= </span><span class="string">"1.0"</span><span class="keyword">, </span><span class="default">$encoding </span><span class="keyword">= </span><span class="string">"UTF-8"</span><span class="keyword">)<br />    {<br />        return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">expandSimpleXml</span><span class="keyword">(</span><span class="default">$version</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">)-&gt;</span><span class="default">asXML</span><span class="keyword">();<br />    }<br /><br />    </span><span class="comment">/**<br />     * Expand current node to SimpleXMLElement<br />     *<br />     * @param  string $version<br />     * @param  string $encoding<br />     * @param  string $className<br />     * @return SimpleXMLElement<br />     */<br />    </span><span class="keyword">public function </span><span class="default">expandSimpleXml</span><span class="keyword">(</span><span class="default">$version </span><span class="keyword">= </span><span class="string">"1.0"</span><span class="keyword">, </span><span class="default">$encoding </span><span class="keyword">= </span><span class="string">"UTF-8"</span><span class="keyword">, </span><span class="default">$className </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">)<br />    {<br />        </span><span class="default">$element </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">expand</span><span class="keyword">();<br />        </span><span class="default">$document </span><span class="keyword">= new </span><span class="default">DomDocument</span><span class="keyword">(</span><span class="default">$version</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">);<br />        </span><span class="default">$node </span><span class="keyword">= </span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">importNode</span><span class="keyword">(</span><span class="default">$element</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />        </span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">appendChild</span><span class="keyword">(</span><span class="default">$node</span><span class="keyword">);<br />        return </span><span class="default">simplexml_import_dom</span><span class="keyword">(</span><span class="default">$node</span><span class="keyword">, </span><span class="default">$className</span><span class="keyword">);<br />    }<br /><br />    </span><span class="comment">/**<br />     * Expand current node to DomDocument<br />     *<br />     * @param  string $version<br />     * @param  string $encoding<br />     * @return DomDocument<br />     */<br />    </span><span class="keyword">public function </span><span class="default">expandDomDocument</span><span class="keyword">(</span><span class="default">$version </span><span class="keyword">= </span><span class="string">"1.0"</span><span class="keyword">, </span><span class="default">$encoding </span><span class="keyword">= </span><span class="string">"UTF-8"</span><span class="keyword">)<br />    {<br />        </span><span class="default">$element </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">expand</span><span class="keyword">();<br />        </span><span class="default">$document </span><span class="keyword">= new </span><span class="default">DomDocument</span><span class="keyword">(</span><span class="default">$version</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">);<br />        </span><span class="default">$node </span><span class="keyword">= </span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">importNode</span><span class="keyword">(</span><span class="default">$element</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />        </span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">appendChild</span><span class="keyword">(</span><span class="default">$node</span><span class="keyword">);<br />        return </span><span class="default">$document</span><span class="keyword">;<br />    }<br /><br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="87288">  <div class="votes">
    <div id="Vu87288">
    <a href="/manual/vote-note.php?id=87288&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87288">
    <a href="/manual/vote-note.php?id=87288&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87288" title="71% like this...">
    9
    </div>
  </div>
  <a href="#87288" class="name">
  <strong class="user"><em>godseth at o2 dot pl</em></strong></a><a class="genanchor" href="#87288"> &para;</a><div class="date" title="2008-11-28 02:34"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87288">
<div class="phpcode"><code><span class="html">Thanks rein_baarsma33 AT hotmail DOT com for bugfixes. 
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />[EDIT BY danbrown AT php DOT net:  Fixes were also provided by "Alex" and (qdog AT qview DOT org) in user notes on this page (since removed).]</span></code></div>
  </div>
 </div>
  <div class="note" id="100347">  <div class="votes">
    <div id="Vu100347">
    <a href="/manual/vote-note.php?id=100347&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100347">
    <a href="/manual/vote-note.php?id=100347&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100347" title="69% like this...">
    5
    </div>
  </div>
  <a href="#100347" class="name">
  <strong class="user"><em>japos dot trash at googlemail dot com</em></strong></a><a class="genanchor" href="#100347"> &para;</a><div class="date" title="2010-10-09 02:17"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100347">
<div class="phpcode"><code><span class="html">Take care about how to use XMLReader::$isElementEmpty. I don't know if it is a bug or not, but $isElementEmpty is set for the current context and NOT just for the element. If you move your cursor to an attribute, $isElementEmpty will ALWAYS be false.<br /><br /><span class="default">&lt;?php<br /> $xml </span><span class="keyword">= new </span><span class="default">XMLReader</span><span class="keyword">();<br /> </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">XML</span><span class="keyword">(</span><span class="string">'&lt;tag attr="value" /&gt;'</span><span class="keyword">);<br /> </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">read</span><span class="keyword">();<br /> </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">isEmptyElement</span><span class="keyword">);<br /> </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">moveToNextAttribute</span><span class="keyword">();<br /> </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">isEmptyElement</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />will output<br /><br />(bool) true<br />(bool) false<br /><br />So be sure to store $isEmptyElement before moving the cursor.</span></code></div>
  </div>
 </div>
  <div class="note" id="121505">  <div class="votes">
    <div id="Vu121505">
    <a href="/manual/vote-note.php?id=121505&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121505">
    <a href="/manual/vote-note.php?id=121505&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121505" title="66% like this...">
    1
    </div>
  </div>
  <a href="#121505" class="name">
  <strong class="user"><em>eef dot vreeland at gmail dot com</em></strong></a><a class="genanchor" href="#121505"> &para;</a><div class="date" title="2017-08-10 05:08"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121505">
<div class="phpcode"><code><span class="html">Note that when:<br /><br />A) &lt;tag&gt;&lt;/tag&gt;<br />   $xmlRdr-&gt;isEmptyElement =&gt; false<br />   $xmlRdr-&gt;hasValue       =&gt; true<br />   $xmlRdr-&gt;value          =&gt; ''<br />   $xmlRdr-&gt;hasAttributes  =&gt; false<br /><br />B) &lt;tag /&gt;<br />   $xmlRdr-&gt;isEmptyElement =&gt; true<br />   $xmlRdr-&gt;hasValue       =&gt; false<br />   $xmlRdr-&gt;value          =&gt; ''<br />   $xmlRdr-&gt;hasAttributes  =&gt; false<br /><br />C) &lt;tag attribute="value"&gt;&lt;/tag&gt;<br />   $xmlRdr-&gt;isEmptyElement =&gt; false<br />   $xmlRdr-&gt;hasValue       =&gt; false<br />   $xmlRdr-&gt;value          =&gt; ''<br />   $xmlRdr-&gt;hasAttributes  =&gt; true<br /><br />D) &lt;tag attribute="value" /&gt;<br />   $xmlRdr-&gt;isEmptyElement =&gt; true<br />   $xmlRdr-&gt;hasValue       =&gt; false<br />   $xmlRdr-&gt;value          =&gt; ''<br />   $xmlRdr-&gt;hasAttributes  =&gt; true</span></code></div>
  </div>
 </div>
  <div class="note" id="88264">  <div class="votes">
    <div id="Vu88264">
    <a href="/manual/vote-note.php?id=88264&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd88264">
    <a href="/manual/vote-note.php?id=88264&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V88264" title="62% like this...">
    2
    </div>
  </div>
  <a href="#88264" class="name">
  <strong class="user"><em>boukeversteegh at gmail dot com</em></strong></a><a class="genanchor" href="#88264"> &para;</a><div class="date" title="2009-01-18 02:06"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom88264">
<div class="phpcode"><code><span class="html">XML to ASSOCIATIVE ARRAY
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="83929">  <div class="votes">
    <div id="Vu83929">
    <a href="/manual/vote-note.php?id=83929&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83929">
    <a href="/manual/vote-note.php?id=83929&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83929" title="53% like this...">
    1
    </div>
  </div>
  <a href="#83929" class="name">
  <strong class="user"><em>Sergey Aikinkulov</em></strong></a><a class="genanchor" href="#83929"> &para;</a><div class="date" title="2008-06-19 03:51"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83929">
<div class="phpcode"><code><span class="html">Next version xml2assoc with some improve fixes:<br /> - no doubled data<br /> - no buffer arrays<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/*<br />    Read XML structure to associative array<br />    --<br />    Using:<br />    $xml = new XMLReader();<br />    $xml-&gt;open([XML file]);<br />    $assoc = xml2assoc($xml);<br />    $xml-&gt;close();<br />*/<br />    </span><span class="keyword">function </span><span class="default">xml2assoc</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">) {<br />      </span><span class="default">$assoc </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />      while(</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">read</span><span class="keyword">()){<br />        switch (</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">nodeType</span><span class="keyword">) {<br />          case </span><span class="default">XMLReader</span><span class="keyword">::</span><span class="default">END_ELEMENT</span><span class="keyword">: return </span><span class="default">$assoc</span><span class="keyword">;<br />          case </span><span class="default">XMLReader</span><span class="keyword">::</span><span class="default">ELEMENT</span><span class="keyword">:<br />            </span><span class="default">$assoc</span><span class="keyword">[</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">][] = array(</span><span class="string">'value' </span><span class="keyword">=&gt; </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">isEmptyElement </span><span class="keyword">? </span><span class="string">'' </span><span class="keyword">: </span><span class="default">xml2assoc</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">));<br />            if(</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">hasAttributes</span><span class="keyword">){<br />              </span><span class="default">$el </span><span class="keyword">=&amp; </span><span class="default">$assoc</span><span class="keyword">[</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">][</span><span class="default">count</span><span class="keyword">(</span><span class="default">$assoc</span><span class="keyword">[</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">]) - </span><span class="default">1</span><span class="keyword">];<br />              while(</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">moveToNextAttribute</span><span class="keyword">()) </span><span class="default">$el</span><span class="keyword">[</span><span class="string">'attributes'</span><span class="keyword">][</span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">] = </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">;<br />            }<br />            break;<br />          case </span><span class="default">XMLReader</span><span class="keyword">::</span><span class="default">TEXT</span><span class="keyword">:<br />          case </span><span class="default">XMLReader</span><span class="keyword">::</span><span class="default">CDATA</span><span class="keyword">: </span><span class="default">$assoc </span><span class="keyword">.= </span><span class="default">$xml</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">;<br />        }<br />      }<br />      return </span><span class="default">$assoc</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="121506">  <div class="votes">
    <div id="Vu121506">
    <a href="/manual/vote-note.php?id=121506&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121506">
    <a href="/manual/vote-note.php?id=121506&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121506" title="100% like this...">
    2
    </div>
  </div>
  <a href="#121506" class="name">
  <strong class="user"><em>eef dot vreeland at gmail dot com</em></strong></a><a class="genanchor" href="#121506"> &para;</a><div class="date" title="2017-08-10 05:43"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121506">
<div class="phpcode"><code><span class="html">Please discard my previous note; I pressed 'Add Note' too quickly<br /><br />About (non-)self-closing tags:<br /><br /> A) &lt;tag&gt;&lt;/tag&gt;<br />    $xmlRdr-&gt;isEmptyElement =&gt; false<br />    $xmlRdr-&gt;hasValue       =&gt; false<br />    $xmlRdr-&gt;value          =&gt; ''<br />    $xmlRdr-&gt;hasAttributes  =&gt; false<br /> <br /> B) &lt;tag /&gt;<br />    $xmlRdr-&gt;isEmptyElement =&gt; true<br />    $xmlRdr-&gt;hasValue       =&gt; false<br />    $xmlRdr-&gt;value          =&gt; ''<br />    $xmlRdr-&gt;hasAttributes  =&gt; false<br /> <br /> C) &lt;tag attribute="value"&gt;&lt;/tag&gt;<br />    $xmlRdr-&gt;isEmptyElement =&gt; false<br />    $xmlRdr-&gt;hasValue       =&gt; false<br />    $xmlRdr-&gt;value          =&gt; ''<br />    $xmlRdr-&gt;hasAttributes  =&gt; true<br /> <br /> D) &lt;tag attribute="value" /&gt;<br />    $xmlRdr-&gt;isEmptyElement =&gt; true<br />    $xmlRdr-&gt;hasValue       =&gt; false<br />    $xmlRdr-&gt;value          =&gt; ''<br />    $xmlRdr-&gt;hasAttributes  =&gt; true<br /> <br />... and always use the '===' operator when testing properties</span></code></div>
  </div>
 </div>
  <div class="note" id="130416">  <div class="votes">
    <div id="Vu130416">
    <a href="/manual/vote-note.php?id=130416&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130416">
    <a href="/manual/vote-note.php?id=130416&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130416" title="no votes...">
    0
    </div>
  </div>
  <a href="#130416" class="name">
  <strong class="user"><em>infinitum11 dot dev at gmail dot com</em></strong></a><a class="genanchor" href="#130416"> &para;</a><div class="date" title="2025-07-14 01:04"><strong>2 months ago</strong></div>
  <div class="text" id="Hcom130416">
<div class="phpcode"><code><span class="html">Be aware that the property "attributeCount" doesn't count #FIXED marked DTD properties. Call the getAttribute method to get the default value.<br /><br />```XML<br /># file.xml<br /><br />&lt;?xml version="1.0" encoding="UTF-8" ?&gt;<br />&lt;!DOCTYPE user [<br />    &lt;!ELEMENT user (#PCDATA)&gt;<br />    &lt;!ATTLIST user<br />        race CDATA #FIXED "human"&gt;<br />]&gt;<br />&lt;user&gt;John&lt;/user&gt;<br />```<br /><br /><span class="default">&lt;?php<br />$reader </span><span class="keyword">= </span><span class="default">XMLReader</span><span class="keyword">::</span><span class="default">open</span><span class="keyword">(</span><span class="string">'file.xml'</span><span class="keyword">);<br /><br /></span><span class="default">$reader</span><span class="keyword">-&gt;</span><span class="default">read</span><span class="keyword">(); </span><span class="comment">// nodeType === XMLReader::DOC_TYPE<br /></span><span class="default">$reader</span><span class="keyword">-&gt;</span><span class="default">read</span><span class="keyword">(); </span><span class="comment">// nodeType === XMLReader::ELEMENT<br /></span><span class="keyword">echo </span><span class="default">$reader</span><span class="keyword">-&gt;</span><span class="default">attributeCount</span><span class="keyword">, </span><span class="default">PHP_EOL</span><span class="keyword">; </span><span class="comment">// 0<br /></span><span class="keyword">echo </span><span class="default">$reader</span><span class="keyword">-&gt;</span><span class="default">getAttribute</span><span class="keyword">(</span><span class="string">'race'</span><span class="keyword">), </span><span class="default">PHP_EOL</span><span class="keyword">; </span><span class="comment">// "human"<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="88420">  <div class="votes">
    <div id="Vu88420">
    <a href="/manual/vote-note.php?id=88420&amp;page=class.xmlreader&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd88420">
    <a href="/manual/vote-note.php?id=88420&amp;page=class.xmlreader&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V88420" title="50% like this...">
    0
    </div>
  </div>
  <a href="#88420" class="name">
  <strong class="user"><em>PxL</em></strong></a><a class="genanchor" href="#88420"> &para;</a><div class="date" title="2009-01-23 03:36"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom88420">
<div class="phpcode"><code><span class="html">A basic parser<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">xml2assoc</span><span class="keyword">(</span><span class="default">$xml</span><span class="keyword">) {<br />    </span><span class="default">$arr </span><span class="keyword">= array();<br />    if (!</span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'|\&lt;\s*?(\w+).*?\&gt;(.*)\&lt;\/\s*\\1.*?\&gt;|s'</span><span class="keyword">, </span><span class="default">$xml</span><span class="keyword">, </span><span class="default">$m</span><span class="keyword">)) return </span><span class="default">$xml</span><span class="keyword">;<br />    if (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]))<br />        for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;</span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">sizeof</span><span class="keyword">(</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]); </span><span class="default">$i</span><span class="keyword">++) </span><span class="default">$arr</span><span class="keyword">[</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">][</span><span class="default">$i</span><span class="keyword">]] = </span><span class="default">xml2assoc</span><span class="keyword">(</span><span class="default">$m</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">][</span><span class="default">$i</span><span class="keyword">]);<br />    else </span><span class="default">$arr</span><span class="keyword">[</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]] = </span><span class="default">xml2assoc</span><span class="keyword">(</span><span class="default">$m</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">]);<br /><br />    return </span><span class="default">$arr</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.xmlreader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.xmlreader.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="book.xmlreader.php">XMLReader</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="intro.xmlreader.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
                            <a href="xmlreader.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="current">
                            <a href="class.xmlreader.php" title="XMLReader">XMLReader</a>
                        </li>
