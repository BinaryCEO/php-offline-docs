...
<head>
  ...
  <title>PHP: MongoDB\Driver\Exception\AuthenticationException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-exception-authenticationexception.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-exception-authenticationexception">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-exception-authenticationexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb.exceptions.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-exception-bulkwriteexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-exception-authenticationexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-exception-authenticationexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-exception-authenticationexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-exception-authenticationexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-exception-authenticationexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-exception-authenticationexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-exception-authenticationexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-exception-authenticationexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-exception-authenticationexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-exception-authenticationexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-exception-authenticationexception.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Exception\AuthenticationException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Exception\AuthenticationException - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Exception\AuthenticationException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Exception\AuthenticationException - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Exception\AuthenticationException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Exception\AuthenticationException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.mongodb-driver-exception-bulkwriteexception.php">
          MongoDB\Driver\Exception\BulkWriteException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb.exceptions.php">
          &laquo; MongoDB\Driver\Exception        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-exception-authenticationexception.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-exception-authenticationexception.php'>German</option>
            <option value='es/class.mongodb-driver-exception-authenticationexception.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-exception-authenticationexception.php'>French</option>
            <option value='it/class.mongodb-driver-exception-authenticationexception.php'>Italian</option>
            <option value='ja/class.mongodb-driver-exception-authenticationexception.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-exception-authenticationexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-exception-authenticationexception.php'>Russian</option>
            <option value='tr/class.mongodb-driver-exception-authenticationexception.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-exception-authenticationexception.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-exception-authenticationexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-exception-authenticationexception" class="reference">
  ...
  <div class="section" id="mongodb-driver-exception-authenticationexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MongoDB\Driver\Exception\AuthenticationException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/exception/authenticationexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-exception-authenticationexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-exception-authenticationexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-exception-authenticationexception.php">＋<small>add a note</small></a></span>
