...
<head>
  ...
  <title>PHP: timezone_version_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.timezone-version-get.php">
 <link rel="shorturl" href="https://www.php.net/timezone-version-get">
 <link rel="alternate" href="https://www.php.net/timezone-version-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.timezone-transitions-get.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.error.tree.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.timezone-version-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.timezone-version-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.timezone-version-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.timezone-version-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.timezone-version-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.timezone-version-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.timezone-version-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.timezone-version-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.timezone-version-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.timezone-version-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.timezone-version-get.php" hreflang="zh">
...
<meta name="Description" content="Gets the version of the timezonedb" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: timezone_version_get - Manual" />
<meta name="twitter:description" content="Gets the version of the timezonedb" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: timezone_version_get - Manual" />
<meta itemprop="description" content="Gets the version of the timezonedb" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the version of the timezonedb" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="datetime.error.tree.php">
          Date/Time Errors and Exceptions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.timezone-transitions-get.php">
          &laquo; timezone_transitions_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.timezone-version-get.php' selected="selected">English</option>
            <option value='de/function.timezone-version-get.php'>German</option>
            <option value='es/function.timezone-version-get.php'>Spanish</option>
            <option value='fr/function.timezone-version-get.php'>French</option>
            <option value='it/function.timezone-version-get.php'>Italian</option>
            <option value='ja/function.timezone-version-get.php'>Japanese</option>
            <option value='pt_BR/function.timezone-version-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.timezone-version-get.php'>Russian</option>
            <option value='tr/function.timezone-version-get.php'>Turkish</option>
            <option value='uk/function.timezone-version-get.php'>Ukrainian</option>
            <option value='zh/function.timezone-version-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.timezone-version-get" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">timezone_version_get</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>The above example will output
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">2022.2</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    <li><a href="timezones.php" class="link">List of Supported Timezones</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/timezone-version-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.timezone-version-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.timezone-version-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-version-get.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130015">  <div class="votes">
    <div id="Vu130015">
    <a href="/manual/vote-note.php?id=130015&amp;page=function.timezone-version-get&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130015">
    <a href="/manual/vote-note.php?id=130015&amp;page=function.timezone-version-get&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130015" title="no votes...">
    0
    </div>
  </div>
  <a href="#130015" class="name">
  <strong class="user"><em>gwenbrod at gmail dot com</em></strong></a><a class="genanchor" href="#130015"> &para;</a><div class="date" title="2025-02-09 07:51"><strong>7 months ago</strong></div>
  <div class="text" id="Hcom130015">
<div class="phpcode"><code><span class="html">If the output of timezone_version_get() is "0.system", the documentation encourages to install the timezonedb PECL package. However, consider leaving it as is, because "0.system"indicates the operating system's tzdata database is being used, which is actually desirable, since the tzdata package gets updated by the operating system's package manager.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.timezone-version-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.timezone-version-get.php">＋<small>add a note</small></a></div>
