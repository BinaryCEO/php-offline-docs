...
<head>
  ...
  <title>PHP: Dom\HTMLDocument - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-htmldocument.php">
 <link rel="shorturl" href="https://www.php.net/dom-htmldocument">
 <link rel="alternate" href="https://www.php.net/dom-htmldocument" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-htmlcollection.php">
 <link rel="next" href="https://www.php.net/manual/en/dom-htmldocument.createempty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-htmldocument.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-htmldocument.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-htmldocument.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-htmldocument.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-htmldocument.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-htmldocument.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-htmldocument.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-htmldocument.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-htmldocument.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-htmldocument.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-htmldocument.php" hreflang="zh">
...
<meta name="Description" content="The Dom\HTMLDocument class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\HTMLDocument - Manual" />
<meta name="twitter:description" content="The Dom\HTMLDocument class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\HTMLDocument - Manual" />
<meta itemprop="description" content="The Dom\HTMLDocument class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\HTMLDocument class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="dom-htmldocument.createempty.php">
          Dom\HTMLDocument::createEmpty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-htmlcollection.php">
          &laquo; Dom\HTMLCollection        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-htmldocument.php' selected="selected">English</option>
            <option value='de/class.dom-htmldocument.php'>German</option>
            <option value='es/class.dom-htmldocument.php'>Spanish</option>
            <option value='fr/class.dom-htmldocument.php'>French</option>
            <option value='it/class.dom-htmldocument.php'>Italian</option>
            <option value='ja/class.dom-htmldocument.php'>Japanese</option>
            <option value='pt_BR/class.dom-htmldocument.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-htmldocument.php'>Russian</option>
            <option value='tr/class.dom-htmldocument.php'>Turkish</option>
            <option value='uk/class.dom-htmldocument.php'>Ukrainian</option>
            <option value='zh/class.dom-htmldocument.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-htmldocument" class="reference">
 <h1 class="title">The Dom\HTMLDocument class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-htmldocument.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    Represents an <abbr title="Hyper Text Markup Language">HTML</abbr> document.
   </p>
  </div>

  <div class="section" id="dom-htmldocument.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">final</span>
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\HTMLDocument</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="dom-htmldocument.createempty.php" class="methodname">createEmpty</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$encoding</code><span class="initializer"> = &quot;UTF-8&quot;</span></span>): <span class="type"><a href="class.dom-htmldocument.php" class="type Dom\HTMLDocument">Dom\HTMLDocument</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="dom-htmldocument.createfromfile.php" class="methodname">createFromFile</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$overrideEncoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="class.dom-htmldocument.php" class="type Dom\HTMLDocument">Dom\HTMLDocument</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><a href="dom-htmldocument.createfromstring.php" class="methodname">createFromString</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$overrideEncoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="class.dom-htmldocument.php" class="type Dom\HTMLDocument">Dom\HTMLDocument</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="dom-htmldocument.savehtml.php" class="methodname">saveHtml</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.dom-node.php" class="type Dom\Node">Dom\Node</a></span></span> <code class="parameter">$node</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="dom-htmldocument.savehtmlfile.php" class="methodname">saveHtmlFile</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="dom-htmldocument.savexml.php" class="methodname">saveXml</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.dom-node.php" class="type Dom\Node">Dom\Node</a></span></span> <code class="parameter">$node</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="dom-htmldocument.savexmlfile.php" class="methodname">saveXmlFile</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="dom-htmldocument.createempty.php">Dom\HTMLDocument::createEmpty</a> — Creates an empty HTML document</li><li><a href="dom-htmldocument.createfromfile.php">Dom\HTMLDocument::createFromFile</a> — Parses an HTML document from a file</li><li><a href="dom-htmldocument.createfromstring.php">Dom\HTMLDocument::createFromString</a> — Parses an HTML document from a string</li><li><a href="dom-htmldocument.savehtml.php">Dom\HTMLDocument::saveHtml</a> — Serializes the document as an HTML string</li><li><a href="dom-htmldocument.savehtmlfile.php">Dom\HTMLDocument::saveHtmlFile</a> — Serializes the document as an HTML file</li><li><a href="dom-htmldocument.savexml.php">Dom\HTMLDocument::saveXml</a> — Serializes the document as an XML string</li><li><a href="dom-htmldocument.savexmlfile.php">Dom\HTMLDocument::saveXmlFile</a> — Serializes the document as an XML file</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-htmldocument.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-htmldocument%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-htmldocument&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-htmldocument.php">＋<small>add a note</small></a></span>
