...
<head>
  ...
  <title>PHP: Imagick::setResourceLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setresourcelimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setresourcelimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setresourcelimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setresolution.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setresourcelimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setresourcelimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setresourcelimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setresourcelimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setresourcelimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setresourcelimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setresourcelimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setresourcelimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setresourcelimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setresourcelimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setresourcelimit.php" hreflang="zh">
...
<meta name="Description" content="Sets the limit for a particular resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setResourceLimit - Manual" />
<meta name="twitter:description" content="Sets the limit for a particular resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setResourceLimit - Manual" />
<meta itemprop="description" content="Sets the limit for a particular resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the limit for a particular resource" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setsamplingfactors.php">
          Imagick::setSamplingFactors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setresolution.php">
          &laquo; Imagick::setResolution        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setresourcelimit.php' selected="selected">English</option>
            <option value='de/imagick.setresourcelimit.php'>German</option>
            <option value='es/imagick.setresourcelimit.php'>Spanish</option>
            <option value='fr/imagick.setresourcelimit.php'>French</option>
            <option value='it/imagick.setresourcelimit.php'>Italian</option>
            <option value='ja/imagick.setresourcelimit.php'>Japanese</option>
            <option value='pt_BR/imagick.setresourcelimit.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setresourcelimit.php'>Russian</option>
            <option value='tr/imagick.setresourcelimit.php'>Turkish</option>
            <option value='uk/imagick.setresourcelimit.php'>Ukrainian</option>
            <option value='zh/imagick.setresourcelimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setresourcelimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setResourceLimit</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setResourceLimit</span> &mdash; <span class="dc-title">Sets the limit for a particular resource</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setresourcelimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::setResourceLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$limit</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setresourcelimit-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Refer to the list of <a href="imagick.constants.php#imagick.constants.resourcetypes" class="link">resourcetype constants</a>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setresourcelimit-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setresourcelimit-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="methodname"><a href="imagick.getresourcelimit.php" class="methodname" rel="rdfs-seeAlso">Imagick::getResourceLimit()</a> - Returns the specified resource limit</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setresourcelimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setresourcelimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setresourcelimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setresourcelimit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106419">  <div class="votes">
    <div id="Vu106419">
    <a href="/manual/vote-note.php?id=106419&amp;page=imagick.setresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106419">
    <a href="/manual/vote-note.php?id=106419&amp;page=imagick.setresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106419" title="77% like this...">
    5
    </div>
  </div>
  <a href="#106419" class="name">
  <strong class="user"><em>rodneyrehm</em></strong></a><a class="genanchor" href="#106419"> &para;</a><div class="date" title="2011-11-08 12:00"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106419">
<div class="phpcode"><code><span class="html">IMagick::RESOURCETYPE_THREADS is missing, yet you're still able to limit the number of thready ImageMagick should use:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// IMagick::setResourceLimit(IMagick::RESOURCETYPE_THREADS, 2);<br /></span><span class="default">IMagick</span><span class="keyword">::</span><span class="default">setResourceLimit</span><span class="keyword">(</span><span class="default">6</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);</span></span></code></div>
  </div>
 </div>
  <div class="note" id="115014">  <div class="votes">
    <div id="Vu115014">
    <a href="/manual/vote-note.php?id=115014&amp;page=imagick.setresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115014">
    <a href="/manual/vote-note.php?id=115014&amp;page=imagick.setresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115014" title="80% like this...">
    3
    </div>
  </div>
  <a href="#115014" class="name">
  <strong class="user"><em>Anonymous user</em></strong></a><a class="genanchor" href="#115014"> &para;</a><div class="date" title="2014-05-12 08:30"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115014">
<div class="phpcode"><code><span class="html">Note that the limits are given in bytes instead of megabytes. You can verify with:<br /><br /><span class="default">&lt;?php </span><span class="keyword">echo </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">getResourceLimit</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">RESOURCETYPE_MEMORY</span><span class="keyword">); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="107489">  <div class="votes">
    <div id="Vu107489">
    <a href="/manual/vote-note.php?id=107489&amp;page=imagick.setresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd107489">
    <a href="/manual/vote-note.php?id=107489&amp;page=imagick.setresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V107489" title="80% like this...">
    3
    </div>
  </div>
  <a href="#107489" class="name">
  <strong class="user"><em>Arkadiy Kulev</em></strong></a><a class="genanchor" href="#107489"> &para;</a><div class="date" title="2012-02-13 11:54"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107489">
<div class="phpcode"><code><span class="html">This list should help setting the limits:<br /><br />imagick::RESOURCETYPE_AREA (integer)   //equivalent of MAGICK_AREA_LIMIT<br />imagick::RESOURCETYPE_DISK (integer)   //equivalent of MAGICK_DISK_LIMIT<br />imagick::RESOURCETYPE_FILE (integer)   //equivalent of MAGICK_FILE_LIMIT<br />imagick::RESOURCETYPE_MAP (integer)    //equivalent of MAGICK_MAP_LIMIT<br />imagick::RESOURCETYPE_MEMORY (integer) //equivalent of MAGICK_MEMORY_LIMIT</span></code></div>
  </div>
 </div>
  <div class="note" id="125842">  <div class="votes">
    <div id="Vu125842">
    <a href="/manual/vote-note.php?id=125842&amp;page=imagick.setresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125842">
    <a href="/manual/vote-note.php?id=125842&amp;page=imagick.setresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125842" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125842" class="name">
  <strong class="user"><em>raphael dot droz at gmail dot com</em></strong></a><a class="genanchor" href="#125842"> &para;</a><div class="date" title="2021-02-18 04:01"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125842">
<div class="phpcode"><code><span class="html">Here are the RESOURCETYPE actually supported by today:<br /><a href="https://github.com/Imagick/imagick/blob/master/imagick_helpers.c" rel="nofollow" target="_blank">https://github.com/Imagick/imagick/blob/master/imagick_helpers.c</a><br /><a href="https://github.com/Imagick/imagick/blob/master/ChangeLog" rel="nofollow" target="_blank">https://github.com/Imagick/imagick/blob/master/ChangeLog</a><br /><br />Added in 3.3:<br />* Imagick::RESOURCETYPE_TIME<br />* Imagick::RESOURCETYPE_THROTTLE<br /><br />Added in 3.2:<br />* Imagick::RESOURCETYPE_THREAD</span></code></div>
  </div>
 </div>
  <div class="note" id="129049">  <div class="votes">
    <div id="Vu129049">
    <a href="/manual/vote-note.php?id=129049&amp;page=imagick.setresourcelimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129049">
    <a href="/manual/vote-note.php?id=129049&amp;page=imagick.setresourcelimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129049" title="no votes...">
    0
    </div>
  </div>
  <a href="#129049" class="name">
  <strong class="user"><em>anonymous</em></strong></a><a class="genanchor" href="#129049"> &para;</a><div class="date" title="2023-11-16 12:18"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129049">
<div class="phpcode"><code><span class="html">Note that Imagick::setResourceLimit may return success without actually changing the limits (verify with Imagick::getResourceLimit). This is at least true for Imagick::RESOURCETYPE_WIDTH and Imagick::RESOURCETYPE_HEIGHT, where values exceeding the limits defined in policy.xml are silently ignored.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setresourcelimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setresourcelimit.php">＋<small>add a note</small></a></div>
