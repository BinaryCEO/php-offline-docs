...
<head>
  ...
  <title>PHP: ImagickDraw::getFontStretch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfontsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontstretch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfontstretch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfontstretch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfontstretch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfontstretch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfontstretch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfontstretch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfontstretch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfontstretch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfontstretch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfontstretch.php" hreflang="zh">
...
<meta name="Description" content="Gets the font stretch to use when annotating with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFontStretch - Manual" />
<meta name="twitter:description" content="Gets the font stretch to use when annotating with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFontStretch - Manual" />
<meta itemprop="description" content="Gets the font stretch to use when annotating with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the font stretch to use when annotating with text" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getfontstyle.php">
          ImagickDraw::getFontStyle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfontsize.php">
          &laquo; ImagickDraw::getFontSize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfontstretch.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfontstretch.php'>German</option>
            <option value='es/imagickdraw.getfontstretch.php'>Spanish</option>
            <option value='fr/imagickdraw.getfontstretch.php'>French</option>
            <option value='it/imagickdraw.getfontstretch.php'>Italian</option>
            <option value='ja/imagickdraw.getfontstretch.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfontstretch.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfontstretch.php'>Russian</option>
            <option value='tr/imagickdraw.getfontstretch.php'>Turkish</option>
            <option value='uk/imagickdraw.getfontstretch.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfontstretch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfontstretch" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfontstretch-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfontstretch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfontstretch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfontstretch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfontstretch.php">＋<small>add a note</small></a></span>
