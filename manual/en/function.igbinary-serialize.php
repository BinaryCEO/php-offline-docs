...
<head>
  ...
  <title>PHP: igbinary_serialize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.igbinary-serialize.php">
 <link rel="shorturl" href="https://www.php.net/igbinary-serialize">
 <link rel="alternate" href="https://www.php.net/igbinary-serialize" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.igbinary.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.igbinary.php">
 <link rel="next" href="https://www.php.net/manual/en/function.igbinary-unserialize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.igbinary-serialize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.igbinary-serialize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.igbinary-serialize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.igbinary-serialize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.igbinary-serialize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.igbinary-serialize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.igbinary-serialize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.igbinary-serialize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.igbinary-serialize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.igbinary-serialize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.igbinary-serialize.php" hreflang="zh">
...
<meta name="Description" content="Generates a compact, storable binary representation of a value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: igbinary_serialize - Manual" />
<meta name="twitter:description" content="Generates a compact, storable binary representation of a value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: igbinary_serialize - Manual" />
<meta itemprop="description" content="Generates a compact, storable binary representation of a value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a compact, storable binary representation of a value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.igbinary-unserialize.php">
          igbinary_unserialize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.igbinary.php">
          &laquo; Igbinary Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.igbinary-serialize.php' selected="selected">English</option>
            <option value='de/function.igbinary-serialize.php'>German</option>
            <option value='es/function.igbinary-serialize.php'>Spanish</option>
            <option value='fr/function.igbinary-serialize.php'>French</option>
            <option value='it/function.igbinary-serialize.php'>Italian</option>
            <option value='ja/function.igbinary-serialize.php'>Japanese</option>
            <option value='pt_BR/function.igbinary-serialize.php'>Brazilian Portuguese</option>
            <option value='ru/function.igbinary-serialize.php'>Russian</option>
            <option value='tr/function.igbinary-serialize.php'>Turkish</option>
            <option value='uk/function.igbinary-serialize.php'>Ukrainian</option>
            <option value='zh/function.igbinary-serialize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.igbinary-serialize" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.igbinary-serialize-examples">
  ...
  <p class="para">
   <div class="example" id="example-3698">
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.unserialize" class="link">__unserialize()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/igbinary/functions/igbinary-serialize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.igbinary-serialize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.igbinary-serialize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.igbinary-serialize.php">＋<small>add a note</small></a></span>
