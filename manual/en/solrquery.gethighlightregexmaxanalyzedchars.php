...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightRegexMaxAnalyzedChars - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightregexmaxanalyzedchars.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of characters from a field when using the regex fragmenter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightRegexMaxAnalyzedChars - Manual" />
<meta name="twitter:description" content="Returns the maximum number of characters from a field when using the regex fragmenter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightRegexMaxAnalyzedChars - Manual" />
<meta itemprop="description" content="Returns the maximum number of characters from a field when using the regex fragmenter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of characters from a field when using the regex fragmenter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightregexpattern.php">
          SolrQuery::getHighlightRegexPattern &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightquery.php">
          &laquo; SolrQuery::getHighlightQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightregexmaxanalyzedchars.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightregexmaxanalyzedchars.php'>German</option>
            <option value='es/solrquery.gethighlightregexmaxanalyzedchars.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightregexmaxanalyzedchars.php'>French</option>
            <option value='it/solrquery.gethighlightregexmaxanalyzedchars.php'>Italian</option>
            <option value='ja/solrquery.gethighlightregexmaxanalyzedchars.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightregexmaxanalyzedchars.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightregexmaxanalyzedchars.php'>Russian</option>
            <option value='tr/solrquery.gethighlightregexmaxanalyzedchars.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightregexmaxanalyzedchars.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightregexmaxanalyzedchars.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightregexmaxanalyzedchars" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightRegexMaxAnalyzedChars</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightRegexMaxAnalyzedChars</span> &mdash; <span class="dc-title">Returns the maximum number of characters from a field when using the regex fragmenter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightregexmaxanalyzedchars-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightRegexMaxAnalyzedChars</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightregexmaxanalyzedchars-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightregexmaxanalyzedchars-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightregexmaxanalyzedchars.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightregexmaxanalyzedchars%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightregexmaxanalyzedchars&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php">＋<small>add a note</small></a></span>
