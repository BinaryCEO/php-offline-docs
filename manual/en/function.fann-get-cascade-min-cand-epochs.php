...
<head>
  ...
  <title>PHP: fann_get_cascade_min_cand_epochs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-cascade-min-cand-epochs.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-cascade-min-cand-epochs">
 <link rel="alternate" href="https://www.php.net/fann-get-cascade-min-cand-epochs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-cascade-max-out-epochs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-cascade-min-out-epochs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-cascade-min-cand-epochs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-cascade-min-cand-epochs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-cascade-min-cand-epochs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-cascade-min-cand-epochs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-cascade-min-cand-epochs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-cascade-min-cand-epochs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-cascade-min-cand-epochs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-cascade-min-cand-epochs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-cascade-min-cand-epochs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-cascade-min-cand-epochs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-cascade-min-cand-epochs.php" hreflang="zh">
...
<meta name="Description" content="Returns the minimum candidate epochs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_cascade_min_cand_epochs - Manual" />
<meta name="twitter:description" content="Returns the minimum candidate epochs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_cascade_min_cand_epochs - Manual" />
<meta itemprop="description" content="Returns the minimum candidate epochs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the minimum candidate epochs" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-cascade-min-out-epochs.php">
          fann_get_cascade_min_out_epochs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-cascade-max-out-epochs.php">
          &laquo; fann_get_cascade_max_out_epochs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-cascade-min-cand-epochs.php' selected="selected">English</option>
            <option value='de/function.fann-get-cascade-min-cand-epochs.php'>German</option>
            <option value='es/function.fann-get-cascade-min-cand-epochs.php'>Spanish</option>
            <option value='fr/function.fann-get-cascade-min-cand-epochs.php'>French</option>
            <option value='it/function.fann-get-cascade-min-cand-epochs.php'>Italian</option>
            <option value='ja/function.fann-get-cascade-min-cand-epochs.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-cascade-min-cand-epochs.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-cascade-min-cand-epochs.php'>Russian</option>
            <option value='tr/function.fann-get-cascade-min-cand-epochs.php'>Turkish</option>
            <option value='uk/function.fann-get-cascade-min-cand-epochs.php'>Ukrainian</option>
            <option value='zh/function.fann-get-cascade-min-cand-epochs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-cascade-min-cand-epochs" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-cascade-min-cand-epochs.php" class="function" rel="rdfs-seeAlso">fann_set_cascade_min_cand_epochs()</a> - Sets the min candidate epochs</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-cascade-min-cand-epochs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-cascade-min-cand-epochs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-cascade-min-cand-epochs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-cascade-min-cand-epochs.php">＋<small>add a note</small></a></span>
