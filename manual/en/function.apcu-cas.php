...
<head>
  ...
  <title>PHP: apcu_cas - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.apcu-cas.php">
 <link rel="shorturl" href="https://www.php.net/apcu-cas">
 <link rel="alternate" href="https://www.php.net/apcu-cas" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.apcu.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.apcu-cache-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.apcu-clear-cache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.apcu-cas.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.apcu-cas.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.apcu-cas.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.apcu-cas.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.apcu-cas.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.apcu-cas.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.apcu-cas.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.apcu-cas.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.apcu-cas.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.apcu-cas.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.apcu-cas.php" hreflang="zh">
...
<meta name="Description" content="Updates an old value with a new value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: apcu_cas - Manual" />
<meta name="twitter:description" content="Updates an old value with a new value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: apcu_cas - Manual" />
<meta itemprop="description" content="Updates an old value with a new value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Updates an old value with a new value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.apcu-clear-cache.php">
          apcu_clear_cache &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.apcu-cache-info.php">
          &laquo; apcu_cache_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.apcu-cas.php' selected="selected">English</option>
            <option value='de/function.apcu-cas.php'>German</option>
            <option value='es/function.apcu-cas.php'>Spanish</option>
            <option value='fr/function.apcu-cas.php'>French</option>
            <option value='it/function.apcu-cas.php'>Italian</option>
            <option value='ja/function.apcu-cas.php'>Japanese</option>
            <option value='pt_BR/function.apcu-cas.php'>Brazilian Portuguese</option>
            <option value='ru/function.apcu-cas.php'>Russian</option>
            <option value='tr/function.apcu-cas.php'>Turkish</option>
            <option value='uk/function.apcu-cas.php'>Ukrainian</option>
            <option value='zh/function.apcu-cas.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.apcu-cas" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.apcu-cas-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>apcu_cas</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$old</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$new</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.apcu-cas-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">old</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">new</code></dt>
    <dd>
     <p class="para">
...
<div class="examplescode"><pre class="examplescode">$foobar = 2
$foobar == 1 ? 2 : 1 = fail
$foobar == 2 ? 1 : 2 = ok
$foobar = 1
$f__bar == 1 ? 2 : 1 = fail
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.apcu-store.php" class="function" rel="rdfs-seeAlso">apcu_store()</a> - Cache a variable in the data store</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/apcu/functions/apcu-cas.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.apcu-cas%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.apcu-cas&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.apcu-cas.php">＋<small>add a note</small></a></span>
