...
<head>
  ...
  <title>PHP: localtime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.localtime.php">
 <link rel="shorturl" href="https://www.php.net/localtime">
 <link rel="alternate" href="https://www.php.net/localtime" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.idate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.microtime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.localtime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.localtime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.localtime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.localtime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.localtime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.localtime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.localtime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.localtime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.localtime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.localtime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.localtime.php" hreflang="zh">
...
<meta name="Description" content="Get the local time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: localtime - Manual" />
<meta name="twitter:description" content="Get the local time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: localtime - Manual" />
<meta itemprop="description" content="Get the local time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the local time" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.localtime.php' selected="selected">English</option>
            <option value='de/function.localtime.php'>German</option>
            <option value='es/function.localtime.php'>Spanish</option>
            <option value='fr/function.localtime.php'>French</option>
            <option value='it/function.localtime.php'>Italian</option>
            <option value='ja/function.localtime.php'>Japanese</option>
            <option value='pt_BR/function.localtime.php'>Brazilian Portuguese</option>
            <option value='ru/function.localtime.php'>Russian</option>
            <option value='tr/function.localtime.php'>Turkish</option>
            <option value='uk/function.localtime.php'>Ukrainian</option>
            <option value='zh/function.localtime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.localtime" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.getdate.php" class="function" rel="rdfs-seeAlso">getdate()</a> - Get date/time information</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/localtime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.localtime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.localtime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.localtime.php">＋<small>add a note</small></a></span>
