...
<head>
  ...
  <title>PHP: win32_remove_service_env_var - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-remove-service-env-var.php">
 <link rel="shorturl" href="https://www.php.net/win32-remove-service-env-var">
 <link rel="alternate" href="https://www.php.net/win32-remove-service-env-var" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-remove-right-access-service.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-send-custom-control.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-remove-service-env-var.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-remove-service-env-var.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-remove-service-env-var.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-remove-service-env-var.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-remove-service-env-var.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-remove-service-env-var.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-remove-service-env-var.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-remove-service-env-var.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-remove-service-env-var.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-remove-service-env-var.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-remove-service-env-var.php" hreflang="zh">
...
<meta name="Description" content="Remove a custom environment variables on service" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_remove_service_env_var - Manual" />
<meta name="twitter:description" content="Remove a custom environment variables on service" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_remove_service_env_var - Manual" />
<meta itemprop="description" content="Remove a custom environment variables on service" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove a custom environment variables on service" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.win32-send-custom-control.php">
          win32_send_custom_control &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-remove-right-access-service.php">
          &laquo; win32_remove_right_access_service        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-remove-service-env-var.php' selected="selected">English</option>
            <option value='de/function.win32-remove-service-env-var.php'>German</option>
            <option value='es/function.win32-remove-service-env-var.php'>Spanish</option>
            <option value='fr/function.win32-remove-service-env-var.php'>French</option>
            <option value='it/function.win32-remove-service-env-var.php'>Italian</option>
            <option value='ja/function.win32-remove-service-env-var.php'>Japanese</option>
            <option value='pt_BR/function.win32-remove-service-env-var.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-remove-service-env-var.php'>Russian</option>
            <option value='tr/function.win32-remove-service-env-var.php'>Turkish</option>
            <option value='uk/function.win32-remove-service-env-var.php'>Ukrainian</option>
            <option value='zh/function.win32-remove-service-env-var.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-remove-service-env-var" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.win32-add-service-env-var.php" class="function" rel="rdfs-seeAlso">win32_add_service_env_var()</a> - Add a custom environment variables on service</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-remove-service-env-var.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-remove-service-env-var%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-remove-service-env-var&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-remove-service-env-var.php">＋<small>add a note</small></a></span>
