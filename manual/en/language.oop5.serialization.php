...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.oop5.serialization.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/language.oop5.references.php">
 <link rel="next" href="https://www.php.net/manual/en/language.oop5.variance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.oop5.serialization.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/language.oop5.serialization.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/language.oop5.serialization.php" hreflang="uk">
...
<meta name="Description" content="Serializing objects - objects in sessions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Object Serialization - Manual" />
<meta name="twitter:description" content="Serializing objects - objects in sessions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Object Serialization - Manual" />
<meta itemprop="description" content="Serializing objects - objects in sessions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Serializing objects - objects in sessions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.oop5.variance.php">
          Covariance and Contravariance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.oop5.references.php">
          &laquo; Objects and references        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.oop5.serialization.php' selected="selected">English</option>
            ...
            <option value='it/language.oop5.serialization.php'>Italian</option>
            ...
            <option value='uk/language.oop5.serialization.php'>Ukrainian</option>
  ...
  </div><div id="language.oop5.serialization" class="sect1">
  ...
  <p class="para">
   ...
   serialize a subset of the object&#039;s properties.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/oop5/serialization.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.oop5.serialization%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.serialization&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.serialization.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94139">  <div class="votes">
    <div id="Vu94139">
    <a href="/manual/vote-note.php?id=94139&amp;page=language.oop5.serialization&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94139">
    <a href="/manual/vote-note.php?id=94139&amp;page=language.oop5.serialization&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94139" title="79% like this...">
    241
    </div>
  </div>
  <a href="#94139" class="name">
  <strong class="user"><em>php at lanar dot com dot au</em></strong></a><a class="genanchor" href="#94139"> &para;</a><div class="date" title="2009-10-18 04:47"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94139">
<div class="phpcode"><code><span class="html">Note that static members of an object are not serialized.</span></code></div>
  </div>
 </div>
  <div class="note" id="116756">  <div class="votes">
    <div id="Vu116756">
    <a href="/manual/vote-note.php?id=116756&amp;page=language.oop5.serialization&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116756">
    <a href="/manual/vote-note.php?id=116756&amp;page=language.oop5.serialization&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116756" title="64% like this...">
    35
    </div>
  </div>
  <a href="#116756" class="name">
  <strong class="user"><em>michael at smith-li dot com</em></strong></a><a class="genanchor" href="#116756"> &para;</a><div class="date" title="2015-02-23 07:28"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116756">
<div class="phpcode"><code><span class="html">Reading this page you'd be left with the impression that a class's `serialize` and `unserialize` methods are unrelated to the `serialize` and `unserialize` core functions; that only `__sleep` and `__unsleep` allow you to customize an object's serialization interface. But look at <a href="http://php.net/manual/en/class.serializable.php" rel="nofollow" target="_blank">http://php.net/manual/en/class.serializable.php</a> and you'll see that there is a more straightforward way to control how a user-defined object is serialized and unserialized.</span></code></div>
  </div>
 </div>
  <div class="note" id="125588">  <div class="votes">
    <div id="Vu125588">
    <a href="/manual/vote-note.php?id=125588&amp;page=language.oop5.serialization&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125588">
    <a href="/manual/vote-note.php?id=125588&amp;page=language.oop5.serialization&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125588" title="61% like this...">
    8
    </div>
  </div>
  <a href="#125588" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#125588"> &para;</a><div class="date" title="2020-12-09 06:58"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125588">
<div class="phpcode"><code><span class="html">Until such time as these documents are updated, note that `session_register()` is not needed to automatically serialize &amp; unserialize objects in sessions. Any objects in `$_SESSION` are serialized when the session is closed (via `session_write_close()` or upon script exit) &amp; unserialized when opened (via `session_start()`). The note about including classes throughout an app (either by including the definition globally or autoloading it) still holds.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.oop5.serialization&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.oop5.serialization.php">＋<small>add a note</small></a></div>
