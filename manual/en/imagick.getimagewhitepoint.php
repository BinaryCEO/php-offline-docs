...
<head>
  ...
  <title>PHP: Imagick::getImageWhitePoint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagevirtualpixelmethod.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagewidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagewhitepoint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagewhitepoint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagewhitepoint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagewhitepoint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagewhitepoint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagewhitepoint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagewhitepoint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagewhitepoint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagewhitepoint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagewhitepoint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagewhitepoint.php" hreflang="zh">
...
<meta name="Description" content="Returns the chromaticity white point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageWhitePoint - Manual" />
<meta name="twitter:description" content="Returns the chromaticity white point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageWhitePoint - Manual" />
<meta itemprop="description" content="Returns the chromaticity white point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the chromaticity white point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagewidth.php">
          Imagick::getImageWidth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagevirtualpixelmethod.php">
          &laquo; Imagick::getImageVirtualPixelMethod        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagewhitepoint.php' selected="selected">English</option>
            <option value='de/imagick.getimagewhitepoint.php'>German</option>
            <option value='es/imagick.getimagewhitepoint.php'>Spanish</option>
            <option value='fr/imagick.getimagewhitepoint.php'>French</option>
            <option value='it/imagick.getimagewhitepoint.php'>Italian</option>
            <option value='ja/imagick.getimagewhitepoint.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagewhitepoint.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagewhitepoint.php'>Russian</option>
            <option value='tr/imagick.getimagewhitepoint.php'>Turkish</option>
            <option value='uk/imagick.getimagewhitepoint.php'>Ukrainian</option>
            <option value='zh/imagick.getimagewhitepoint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagewhitepoint" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageWhitePoint</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageWhitePoint</span> &mdash; <span class="dc-title">Returns the chromaticity white point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagewhitepoint-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageWhitePoint</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagewhitepoint-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagewhitepoint-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagewhitepoint-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagewhitepoint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagewhitepoint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagewhitepoint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagewhitepoint.php">＋<small>add a note</small></a></span>
