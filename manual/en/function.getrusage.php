...
<head>
  ...
  <title>PHP: getrusage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getrusage.php">
 <link rel="shorturl" href="https://www.php.net/getrusage">
 <link rel="alternate" href="https://www.php.net/getrusage" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.getopt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ini-alter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.getrusage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.getrusage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.getrusage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.getrusage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.getrusage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.getrusage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.getrusage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.getrusage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.getrusage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.getrusage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.getrusage.php" hreflang="zh">
...
<meta name="Description" content="Gets the current resource usages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getrusage - Manual" />
<meta name="twitter:description" content="Gets the current resource usages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getrusage - Manual" />
<meta itemprop="description" content="Gets the current resource usages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the current resource usages" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getrusage.php' selected="selected">English</option>
            <option value='de/function.getrusage.php'>German</option>
            <option value='es/function.getrusage.php'>Spanish</option>
            <option value='fr/function.getrusage.php'>French</option>
            <option value='it/function.getrusage.php'>Italian</option>
            <option value='ja/function.getrusage.php'>Japanese</option>
            <option value='pt_BR/function.getrusage.php'>Brazilian Portuguese</option>
            <option value='ru/function.getrusage.php'>Russian</option>
            <option value='tr/function.getrusage.php'>Turkish</option>
            <option value='uk/function.getrusage.php'>Ukrainian</option>
            <option value='zh/function.getrusage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.getrusage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">getrusage</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">getrusage</span> &mdash; <span class="dc-title">Gets the current resource usages</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.getrusage-description">
  ...
  <p class="para rdfs-comment">
   This is an interface to <strong class="command">getrusage(2)</strong>. It gets data returned
 ...
 <div class="refsect1 parameters" id="refsect1-function.getrusage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If <code class="parameter">mode</code> is 1, getrusage will be called with
       <strong><code>RUSAGE_CHILDREN</code></strong>.
      </p>
     </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$dat </span><span style="color: #007700">= </span><span style="color: #0000BB">getrusage</span><span style="color: #007700">();<br />echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_oublock"</span><span style="color: #007700">];       </span><span style="color: #FF8000">// number of block output operations<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_inblock"</span><span style="color: #007700">];       </span><span style="color: #FF8000">// number of block input operations<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_msgsnd"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// number of IPC messages sent<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_msgrcv"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// number of IPC messages received<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_maxrss"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// maximum resident set size<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_ixrss"</span><span style="color: #007700">];         </span><span style="color: #FF8000">// integral shared memory size<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_idrss"</span><span style="color: #007700">];         </span><span style="color: #FF8000">// integral unshared data size<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_minflt"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// number of page reclaims (soft page faults)<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_majflt"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// number of page faults (hard page faults)<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_nsignals"</span><span style="color: #007700">];      </span><span style="color: #FF8000">// number of signals received<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_nvcsw"</span><span style="color: #007700">];         </span><span style="color: #FF8000">// number of voluntary context switches<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_nivcsw"</span><span style="color: #007700">];        </span><span style="color: #FF8000">// number of involuntary context switches<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_nswap"</span><span style="color: #007700">];         </span><span style="color: #FF8000">// number of swaps<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_utime.tv_usec"</span><span style="color: #007700">]; </span><span style="color: #FF8000">// user time used (microseconds)<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_utime.tv_sec"</span><span style="color: #007700">];  </span><span style="color: #FF8000">// user time used (seconds)<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_stime.tv_usec"</span><span style="color: #007700">]; </span><span style="color: #FF8000">// system time used (microseconds)<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$dat</span><span style="color: #007700">[</span><span style="color: #DD0000">"ru_stime.tv_sec"</span><span style="color: #007700">];  </span><span style="color: #FF8000">// system time used (seconds)<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.getrusage-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    On Windows <span class="function"><strong>getrusage()</strong></span> will only return the following 
    members:
   </p>
   <p class="para">
    <ul class="simplelist">
     ...
     <li>
      <code class="literal">&quot;ru_majflt&quot;</code> (only if <code class="parameter">mode</code> is 
      <strong><code>RUSAGE_SELF</code></strong>)
     </li>
     <li>
      <code class="literal">&quot;ru_maxrss&quot;</code> (only if <code class="parameter">mode</code> is 
      <strong><code>RUSAGE_SELF</code></strong>)
     </li>
    </ul>
   </p>
   <p class="para">
    If <span class="function"><strong>getrusage()</strong></span> is called with <code class="parameter">mode</code> 
    set to <code class="literal">1</code> (<strong><code>RUSAGE_CHILDREN</code></strong>), then 
 ...
 <div class="refsect1 seealso" id="refsect1-function.getrusage-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li>Your system's man page on <strong class="command">getrusage(2)</strong></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/getrusage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getrusage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getrusage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getrusage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120453">  <div class="votes">
    <div id="Vu120453">
    <a href="/manual/vote-note.php?id=120453&amp;page=function.getrusage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120453">
    <a href="/manual/vote-note.php?id=120453&amp;page=function.getrusage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120453" title="72% like this...">
    10
    </div>
  </div>
  <a href="#120453" class="name">
  <strong class="user"><em>jlh at gmx dot ch</em></strong></a><a class="genanchor" href="#120453"> &para;</a><div class="date" title="2017-01-11 04:09"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120453">
<div class="phpcode"><code><span class="html">Note that this function returns rusage of the current process. In a web environment where you have long running apache processes that serve several requests with PHP executions, this will return cumulative timings and is therefore not suitable for telling how much user time your used. The best you could do is to call getrusage() once at the beginning and once at the end and calculate the difference.</span></code></div>
  </div>
 </div>
  <div class="note" id="122856">  <div class="votes">
    <div id="Vu122856">
    <a href="/manual/vote-note.php?id=122856&amp;page=function.getrusage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122856">
    <a href="/manual/vote-note.php?id=122856&amp;page=function.getrusage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122856" title="60% like this...">
    2
    </div>
  </div>
  <a href="#122856" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#122856"> &para;</a><div class="date" title="2018-06-19 03:07"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122856">
<div class="phpcode"><code><span class="html">BeOS support is removed in PHP 7.3:<br /><a href="https://github.com/php/php-src/blob/php-7.3.0alpha1/NEWS" rel="nofollow" target="_blank">https://github.com/php/php-src/blob/php-7.3.0alpha1/NEWS</a></span></code></div>
  </div>
 </div>
  <div class="note" id="80411">  <div class="votes">
    <div id="Vu80411">
    <a href="/manual/vote-note.php?id=80411&amp;page=function.getrusage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80411">
    <a href="/manual/vote-note.php?id=80411&amp;page=function.getrusage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80411" title="53% like this...">
    3
    </div>
  </div>
  <a href="#80411" class="name">
  <strong class="user"><em>Domas Mituzas</em></strong></a><a class="genanchor" href="#80411"> &para;</a><div class="date" title="2008-01-14 01:22"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80411">
<div class="phpcode"><code><span class="html">getrusage() reports kernel counters that are updated only once application loses context and a switch to kernel space happens. For example on modern Linux server kernels that would mean that getrusage() calls would return information rounded at 10ms, desktop kernels - at 1ms.<br /><br />getrusage() isn't usable for micro-measurements at all - and getmicrotime(true) might be much more valuable resource.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getrusage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getrusage.php">＋<small>add a note</small></a></div>
