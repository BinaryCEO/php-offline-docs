...
<head>
  ...
  <title>PHP: win32_start_service - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-start-service.php">
 <link rel="shorturl" href="https://www.php.net/win32-start-service">
 <link rel="alternate" href="https://www.php.net/win32-start-service" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-set-service-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-start-service-ctrl-dispatcher.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-start-service.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-start-service.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-start-service.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-start-service.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-start-service.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-start-service.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-start-service.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-start-service.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-start-service.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-start-service.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-start-service.php" hreflang="zh">
...
<meta name="Description" content="Starts a service" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_start_service - Manual" />
<meta name="twitter:description" content="Starts a service" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_start_service - Manual" />
<meta itemprop="description" content="Starts a service" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Starts a service" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.win32-start-service-ctrl-dispatcher.php">
          win32_start_service_ctrl_dispatcher &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-set-service-status.php">
          &laquo; win32_set_service_status        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-start-service.php' selected="selected">English</option>
            <option value='de/function.win32-start-service.php'>German</option>
            <option value='es/function.win32-start-service.php'>Spanish</option>
            <option value='fr/function.win32-start-service.php'>French</option>
            <option value='it/function.win32-start-service.php'>Italian</option>
            <option value='ja/function.win32-start-service.php'>Japanese</option>
            <option value='pt_BR/function.win32-start-service.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-start-service.php'>Russian</option>
            <option value='tr/function.win32-start-service.php'>Turkish</option>
            <option value='uk/function.win32-start-service.php'>Ukrainian</option>
            <option value='zh/function.win32-start-service.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-start-service" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">win32_start_service</h1>
  <p class="verinfo">(PECL win32service &gt;=0.1.0)</p><p class="refpurpose"><span class="refname">win32_start_service</span> &mdash; <span class="dc-title">Starts a service</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.win32-start-service-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>win32_start_service</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$servicename</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$machine</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>


  <p class="para rdfs-comment">
   Attempts to start the named service. Requires administrative privileges or 
 ...
 <div class="refsect1 errors" id="refsect1-function.win32-start-service-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-function.win32-start-service-changelog">
   ...
   <ul class="simplelist">
    ...
    <li><a href="win32service.constants.php#win32service.constants.errors" class="link">Win32 Error Codes</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-start-service.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-start-service%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-start-service&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-start-service.php">＋<small>add a note</small></a></span>
