...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.require-once.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.include.php">
 <link rel="next" href="https://www.php.net/manual/en/function.include-once.php">
 ...
 <p class="para">
  ...
  its non <code class="literal">_once</code> siblings.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/control-structures/require-once.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.require-once%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.require-once&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.require-once.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If your code is running on multiple servers with different environments (locations from where your scripts run) the following idea may be useful to you:
<br />
...
<br />
<br />[EDIT BY danbrown AT php DOT net: Contains a typofix (missing ')') provided by 'JoeB' on 09-JUN-2011.]</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be careful when using include_once and require_once for files that return a value:<br /><br />fiddle2.php<br /><span class="default">&lt;?php<br /></span><span class="keyword">return </span><span class="string">"Some String"</span><span class="keyword">;<br /><br /></span><span class="default">fiddle</span><span class="keyword">.</span><span class="default">php<br /></span><span class="keyword">&lt;?</span><span class="default">php<br />$s </span><span class="keyword">= require_once(</span><span class="string">'fiddle2.php'</span><span class="keyword">);<br />echo </span><span class="string">"\n" </span><span class="keyword">. </span><span class="default">$s</span><span class="keyword">;<br /></span><span class="default">$s </span><span class="keyword">= require_once(</span><span class="string">'fiddle2.php'</span><span class="keyword">);<br />echo </span><span class="string">"\n" </span><span class="keyword">. </span><span class="default">$s</span><span class="keyword">;<br /><br /></span><span class="comment">/* output  <br /> Some String<br />1 <br />*/<br /><br /></span><span class="default">The second time </span><span class="keyword">require_once </span><span class="default">occurs</span><span class="keyword">, </span><span class="default">it returns 1 because the file has already been included</span><span class="keyword">.</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">"require_once" and "require" are language constructs and not functions. Therefore they should be written without "()" brackets!</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.require-once&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.require-once.php">＋<small>add a note</small></a></div>
