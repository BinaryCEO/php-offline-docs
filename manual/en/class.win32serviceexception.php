...
<head>
  ...
  <title>PHP: Win32ServiceException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.win32serviceexception.php">
 <link rel="shorturl" href="https://www.php.net/win32serviceexception">
 <link rel="alternate" href="https://www.php.net/win32serviceexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/win32service.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/class.win32service-rightinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.win32serviceexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.win32serviceexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.win32serviceexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.win32serviceexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.win32serviceexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.win32serviceexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.win32serviceexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.win32serviceexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.win32serviceexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.win32serviceexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.win32serviceexception.php" hreflang="zh">
...
<meta name="Description" content="The Win32ServiceException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Win32ServiceException - Manual" />
<meta name="twitter:description" content="The Win32ServiceException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Win32ServiceException - Manual" />
<meta itemprop="description" content="The Win32ServiceException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Win32ServiceException class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.win32serviceexception.php' selected="selected">English</option>
            <option value='de/class.win32serviceexception.php'>German</option>
            <option value='es/class.win32serviceexception.php'>Spanish</option>
            <option value='fr/class.win32serviceexception.php'>French</option>
            <option value='it/class.win32serviceexception.php'>Italian</option>
            <option value='ja/class.win32serviceexception.php'>Japanese</option>
            <option value='pt_BR/class.win32serviceexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.win32serviceexception.php'>Russian</option>
            <option value='tr/class.win32serviceexception.php'>Turkish</option>
            <option value='uk/class.win32serviceexception.php'>Ukrainian</option>
            <option value='zh/class.win32serviceexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.win32serviceexception" class="reference">
 <h1 class="title">The Win32ServiceException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL win32service &gt;=1.0.0)</p>


  <div class="section" id="win32serviceexception.intro">
  ...
  <div class="section" id="win32serviceexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Win32ServiceException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/win32serviceexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.win32serviceexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.win32serviceexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.win32serviceexception.php">＋<small>add a note</small></a></span>
