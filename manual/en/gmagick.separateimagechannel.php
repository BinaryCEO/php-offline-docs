...
<head>
  ...
  <title>PHP: Gmagick::separateimagechannel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.scaleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.separateimagechannel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.separateimagechannel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.separateimagechannel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.separateimagechannel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.separateimagechannel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.separateimagechannel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.separateimagechannel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.separateimagechannel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.separateimagechannel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.separateimagechannel.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::separateimagechannel - Manual" />
<meta name="twitter:description" content="Separates a channel from the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::separateimagechannel - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setcompressionquality.php">
          Gmagick::setCompressionQuality &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.scaleimage.php">
          &laquo; Gmagick::scaleimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.separateimagechannel.php' selected="selected">English</option>
            <option value='de/gmagick.separateimagechannel.php'>German</option>
            <option value='es/gmagick.separateimagechannel.php'>Spanish</option>
            <option value='fr/gmagick.separateimagechannel.php'>French</option>
            <option value='it/gmagick.separateimagechannel.php'>Italian</option>
            <option value='ja/gmagick.separateimagechannel.php'>Japanese</option>
            <option value='pt_BR/gmagick.separateimagechannel.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.separateimagechannel.php'>Russian</option>
            <option value='tr/gmagick.separateimagechannel.php'>Turkish</option>
            <option value='uk/gmagick.separateimagechannel.php'>Ukrainian</option>
            <option value='zh/gmagick.separateimagechannel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.separateimagechannel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::separateimagechannel</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::separateimagechannel</span> &mdash; <span class="dc-title">Separates a channel from the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.separateimagechannel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::separateimagechannel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.separateimagechannel-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.separateimagechannel-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.separateimagechannel-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/separateimagechannel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.separateimagechannel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.separateimagechannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.separateimagechannel.php">＋<small>add a note</small></a></span>
