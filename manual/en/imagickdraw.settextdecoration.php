...
<head>
  ...
  <title>PHP: ImagickDraw::setTextDecoration - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextdecoration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextdecoration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextdecoration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextantialias.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextencoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextdecoration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextdecoration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextdecoration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextdecoration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextdecoration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextdecoration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextdecoration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextdecoration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextdecoration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextdecoration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextdecoration.php" hreflang="zh">
...
<meta name="Description" content="Specifies a decoration" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextDecoration - Manual" />
<meta name="twitter:description" content="Specifies a decoration" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextDecoration - Manual" />
<meta itemprop="description" content="Specifies a decoration" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies a decoration" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.settextencoding.php">
          ImagickDraw::setTextEncoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextantialias.php">
          &laquo; ImagickDraw::setTextAntialias        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextdecoration.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextdecoration.php'>German</option>
            <option value='es/imagickdraw.settextdecoration.php'>Spanish</option>
            <option value='fr/imagickdraw.settextdecoration.php'>French</option>
            <option value='it/imagickdraw.settextdecoration.php'>Italian</option>
            <option value='ja/imagickdraw.settextdecoration.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextdecoration.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextdecoration.php'>Russian</option>
            <option value='tr/imagickdraw.settextdecoration.php'>Turkish</option>
            <option value='uk/imagickdraw.settextdecoration.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextdecoration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextdecoration" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextDecoration</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextDecoration</span> &mdash; <span class="dc-title">Specifies a decoration</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextdecoration-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextDecoration</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$decoration</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextdecoration-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">decoration</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.decoration" class="link">DECORATION</a> constant
       (<code class="literal">imagick::DECORATION_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextdecoration-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3193">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextdecoration.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextdecoration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextdecoration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextdecoration.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="101815">  <div class="votes">
    <div id="Vu101815">
    <a href="/manual/vote-note.php?id=101815&amp;page=imagickdraw.settextdecoration&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101815">
    <a href="/manual/vote-note.php?id=101815&amp;page=imagickdraw.settextdecoration&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101815" title="86% like this...">
    11
    </div>
  </div>
  <a href="#101815" class="name">
  <strong class="user"><em>mark-paspirgilis at web dot de</em></strong></a><a class="genanchor" href="#101815"> &para;</a><div class="date" title="2011-01-12 09:41"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101815">
<div class="phpcode"><code><span class="html">Hi, guys.<br />I was looking half the day for a documentation about how to set the damn underline...<br />I found it out myself now.. happy to be able to share my new knowledge with you out there.<br />$decoration can be those:<br /><br />1  -  Text will be normal<br />2  -  Underline<br />3  -  Upperline<br />4  -  Stroke-through<br /><br />regards,<br />Mark Paspirgilis</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.settextdecoration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextdecoration.php">＋<small>add a note</small></a></div>
