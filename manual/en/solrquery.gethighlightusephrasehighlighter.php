...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightUsePhraseHighlighter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightsnippets.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmlt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightusephrasehighlighter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightusephrasehighlighter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightusephrasehighlighter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightusephrasehighlighter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightusephrasehighlighter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightusephrasehighlighter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightusephrasehighlighter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightusephrasehighlighter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightusephrasehighlighter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightusephrasehighlighter.php" hreflang="zh">
...
<meta name="Description" content="Returns the state of the hl.usePhraseHighlighter parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightUsePhraseHighlighter - Manual" />
<meta name="twitter:description" content="Returns the state of the hl.usePhraseHighlighter parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightUsePhraseHighlighter - Manual" />
<meta itemprop="description" content="Returns the state of the hl.usePhraseHighlighter parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the state of the hl.usePhraseHighlighter parameter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getmlt.php">
          SolrQuery::getMlt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightsnippets.php">
          &laquo; SolrQuery::getHighlightSnippets        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightusephrasehighlighter.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightusephrasehighlighter.php'>German</option>
            <option value='es/solrquery.gethighlightusephrasehighlighter.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightusephrasehighlighter.php'>French</option>
            <option value='it/solrquery.gethighlightusephrasehighlighter.php'>Italian</option>
            <option value='ja/solrquery.gethighlightusephrasehighlighter.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightusephrasehighlighter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightusephrasehighlighter.php'>Russian</option>
            <option value='tr/solrquery.gethighlightusephrasehighlighter.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightusephrasehighlighter.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightusephrasehighlighter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightusephrasehighlighter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightUsePhraseHighlighter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightUsePhraseHighlighter</span> &mdash; <span class="dc-title">Returns the state of the hl.usePhraseHighlighter parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightusephrasehighlighter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightUsePhraseHighlighter</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightusephrasehighlighter-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightusephrasehighlighter-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightusephrasehighlighter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightusephrasehighlighter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightusephrasehighlighter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php">＋<small>add a note</small></a></span>
