...
<head>
  ...
  <title>PHP: oci_field_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-field-type.php">
 <link rel="shorturl" href="https://www.php.net/oci-field-type">
 <link rel="alternate" href="https://www.php.net/oci-field-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-field-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-field-type-raw.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-field-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-field-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-field-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-field-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-field-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-field-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-field-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-field-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-field-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-field-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-field-type.php" hreflang="zh">
...
<meta name="Description" content="Returns a field's data type name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_field_type - Manual" />
<meta name="twitter:description" content="Returns a field's data type name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_field_type - Manual" />
<meta itemprop="description" content="Returns a field's data type name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a field's data type name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.oci-field-type-raw.php">
          oci_field_type_raw &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-field-size.php">
          &laquo; oci_field_size        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-field-type.php' selected="selected">English</option>
            <option value='de/function.oci-field-type.php'>German</option>
            <option value='es/function.oci-field-type.php'>Spanish</option>
            <option value='fr/function.oci-field-type.php'>French</option>
            <option value='it/function.oci-field-type.php'>Italian</option>
            <option value='ja/function.oci-field-type.php'>Japanese</option>
            <option value='pt_BR/function.oci-field-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-field-type.php'>Russian</option>
            <option value='tr/function.oci-field-type.php'>Turkish</option>
            <option value='uk/function.oci-field-type.php'>Ukrainian</option>
            <option value='zh/function.oci-field-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-field-type" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_field_type</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_field_type</span> &mdash; <span class="dc-title">Returns a field&#039;s data type name</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-field-type-returnvalues">
  ...
  <p class="para">
   Returns the field data type as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> or an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.oci-field-type-examples">
  ...
  <p class="para">
   <div class="example" id="example-2003">
    <p><strong>Example #1 <span class="function"><strong>oci_field_type()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-field-size.php" class="function" rel="rdfs-seeAlso">oci_field_size()</a> - Returns field's size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-field-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-field-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-field-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-field-type.php">＋<small>add a note</small></a></span>
