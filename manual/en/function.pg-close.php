...
<head>
  ...
  <title>PHP: pg_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-close.php">
 <link rel="shorturl" href="https://www.php.net/pg-close">
 <link rel="alternate" href="https://www.php.net/pg-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-client-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-close.php" hreflang="zh">
...
<meta name="Description" content="Closes a PostgreSQL connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_close - Manual" />
<meta name="twitter:description" content="Closes a PostgreSQL connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_close - Manual" />
<meta itemprop="description" content="Closes a PostgreSQL connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes a PostgreSQL connection" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-connect.php">
          pg_connect &raquo;
              ...
              <div class="prev">
        <a href="function.pg-client-encoding.php">
          &laquo; pg_client_encoding        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-close.php' selected="selected">English</option>
            <option value='de/function.pg-close.php'>German</option>
            <option value='es/function.pg-close.php'>Spanish</option>
            <option value='fr/function.pg-close.php'>French</option>
            <option value='it/function.pg-close.php'>Italian</option>
            <option value='ja/function.pg-close.php'>Japanese</option>
            <option value='pt_BR/function.pg-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-close.php'>Russian</option>
            <option value='tr/function.pg-close.php'>Turkish</option>
            <option value='uk/function.pg-close.php'>Ukrainian</option>
            <option value='zh/function.pg-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_close</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_close</span> &mdash; <span class="dc-title">Closes a PostgreSQL connection</span></p>
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-close-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-close-examples">
  ...
  <p class="para">
   <div class="example" id="example-2041">
    <p><strong>Example #1 <span class="function"><strong>pg_close()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-connect.php" class="function" rel="rdfs-seeAlso">pg_connect()</a> - Open a PostgreSQL connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-close.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="58783">  <div class="votes">
    <div id="Vu58783">
    <a href="/manual/vote-note.php?id=58783&amp;page=function.pg-close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd58783">
    <a href="/manual/vote-note.php?id=58783&amp;page=function.pg-close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V58783" title="80% like this...">
    6
    </div>
  </div>
  <a href="#58783" class="name">
  <strong class="user"><em>amays</em></strong></a><a class="genanchor" href="#58783"> &para;</a><div class="date" title="2005-11-15 03:47"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom58783">
<div class="phpcode"><code><span class="html">pg_close(...) will not technically close a persistent connection but instead returns it back to the connection pool thus giving you the desired effect of having the connection closed within your script.<br /><br /><a href="http://www.sitepoint.com/article/accessing-postgresql-php/3" rel="nofollow" target="_blank">http://www.sitepoint.com/article/accessing-postgresql-php/3</a><br /><br />best wishes to all.</span></code></div>
  </div>
 </div>
  <div class="note" id="30628">  <div class="votes">
    <div id="Vu30628">
    <a href="/manual/vote-note.php?id=30628&amp;page=function.pg-close&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30628">
    <a href="/manual/vote-note.php?id=30628&amp;page=function.pg-close&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30628" title="60% like this...">
    2
    </div>
  </div>
  <a href="#30628" class="name">
  <strong class="user"><em>mark at redbrick dot dcu dot ie</em></strong></a><a class="genanchor" href="#30628"> &para;</a><div class="date" title="2003-03-24 06:31"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30628">
<div class="phpcode"><code><span class="html">This function closes the current database connection specified by a handle returned from a pg_connect() call.<br /><br /><span class="default">&lt;?php<br />    $pgsql_conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"dbname=mark host=localhost"</span><span class="keyword">);<br /><br />    if (</span><span class="default">$pgsql_conn</span><span class="keyword">) {<br />        print </span><span class="string">"Successfully connected to: " </span><span class="keyword">. </span><span class="default">pg_host</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />    } else {<br />        print </span><span class="default">pg_last_error</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">);<br />        exit;<br />    }<br /><br />    </span><span class="comment">// Do database stuff here.<br /><br />    </span><span class="keyword">if(!</span><span class="default">pg_close</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">)) {<br />        print </span><span class="string">"Failed to close connection to " </span><span class="keyword">. </span><span class="default">pg_host</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) . </span><span class="string">": " </span><span class="keyword">.<br />       </span><span class="default">pg_last_error</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />    } else {<br />        print </span><span class="string">"Successfully disconnected from database"</span><span class="keyword">;<br />    }<br /></span><span class="default">?&gt;<br /></span><br />Of course you normally wouldn't print a message.  <br /><br />Regards, --mark</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-close.php">＋<small>add a note</small></a></div>
