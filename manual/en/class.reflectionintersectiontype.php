...
<head>
  ...
  <title>PHP: ReflectionIntersectionType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionintersectiontype.php">
 <link rel="shorturl" href="https://www.php.net/reflectionintersectiontype">
 <link rel="alternate" href="https://www.php.net/reflectionintersectiontype" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfiber.gettrace.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionintersectiontype.gettypes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionintersectiontype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionintersectiontype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionintersectiontype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionintersectiontype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionintersectiontype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionintersectiontype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionintersectiontype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionintersectiontype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionintersectiontype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionintersectiontype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionintersectiontype.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionIntersectionType class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionIntersectionType - Manual" />
<meta name="twitter:description" content="The ReflectionIntersectionType class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionIntersectionType - Manual" />
<meta itemprop="description" content="The ReflectionIntersectionType class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionIntersectionType class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionintersectiontype.gettypes.php">
          ReflectionIntersectionType::getTypes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionfiber.gettrace.php">
          &laquo; ReflectionFiber::getTrace        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionintersectiontype.php' selected="selected">English</option>
            <option value='de/class.reflectionintersectiontype.php'>German</option>
            <option value='es/class.reflectionintersectiontype.php'>Spanish</option>
            <option value='fr/class.reflectionintersectiontype.php'>French</option>
            <option value='it/class.reflectionintersectiontype.php'>Italian</option>
            <option value='ja/class.reflectionintersectiontype.php'>Japanese</option>
            <option value='pt_BR/class.reflectionintersectiontype.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionintersectiontype.php'>Russian</option>
            <option value='tr/class.reflectionintersectiontype.php'>Turkish</option>
            <option value='uk/class.reflectionintersectiontype.php'>Ukrainian</option>
            <option value='zh/class.reflectionintersectiontype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionintersectiontype" class="reference">

 <h1 class="title">The ReflectionIntersectionType class</h1>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionintersectiontype.gettypes.php">ReflectionIntersectionType::getTypes</a> — Returns the types included in the intersection type</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionintersectiontype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionintersectiontype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionintersectiontype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionintersectiontype.php">＋<small>add a note</small></a></span>
