...
<head>
  ...
  <title>PHP: pg_set_chunked_rows_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-set-chunked-rows-size.php">
 <link rel="shorturl" href="https://www.php.net/pg-set-chunked-rows-size">
 <link rel="alternate" href="https://www.php.net/pg-set-chunked-rows-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-send-query-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-set-client-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-set-chunked-rows-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-set-chunked-rows-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-set-chunked-rows-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-set-chunked-rows-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-set-chunked-rows-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-set-chunked-rows-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-set-chunked-rows-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-set-chunked-rows-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-set-chunked-rows-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-set-chunked-rows-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-set-chunked-rows-size.php" hreflang="zh">
...
<meta name="Description" content="Set the query results to be retrieved in chunk mode" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_set_chunked_rows_size - Manual" />
<meta name="twitter:description" content="Set the query results to be retrieved in chunk mode" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_set_chunked_rows_size - Manual" />
<meta itemprop="description" content="Set the query results to be retrieved in chunk mode" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the query results to be retrieved in chunk mode" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-set-client-encoding.php">
          pg_set_client_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-send-query-params.php">
          &laquo; pg_send_query_params        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-set-chunked-rows-size.php' selected="selected">English</option>
            <option value='de/function.pg-set-chunked-rows-size.php'>German</option>
            <option value='es/function.pg-set-chunked-rows-size.php'>Spanish</option>
            <option value='fr/function.pg-set-chunked-rows-size.php'>French</option>
            <option value='it/function.pg-set-chunked-rows-size.php'>Italian</option>
            <option value='ja/function.pg-set-chunked-rows-size.php'>Japanese</option>
            <option value='pt_BR/function.pg-set-chunked-rows-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-set-chunked-rows-size.php'>Russian</option>
            <option value='tr/function.pg-set-chunked-rows-size.php'>Turkish</option>
            <option value='uk/function.pg-set-chunked-rows-size.php'>Ukrainian</option>
            <option value='zh/function.pg-set-chunked-rows-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-set-chunked-rows-size" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-set-chunked-rows-size-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_set_chunked_rows_size</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$size</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="simpara">
   ...
   This function must be called before retrieving results with <span class="function"><a href="function.pg-get-result.php" class="function">pg_get_result()</a></span>.
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-set-chunked-rows-size-examples">
  ...
  <div class="example" id="example-2116">
   <p><strong>Example #1 <span class="function"><a href="function.pg-result-memory-size.php" class="function">pg_result_memory_size()</a></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.pg-result-status.php" class="function" rel="rdfs-seeAlso">pg_result_status()</a> - Get status of query result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-set-chunked-rows-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-set-chunked-rows-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-set-chunked-rows-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-set-chunked-rows-size.php">＋<small>add a note</small></a></span>
