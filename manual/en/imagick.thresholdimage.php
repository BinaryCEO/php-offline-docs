...
<head>
  ...
  <title>PHP: Imagick::thresholdImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.thresholdimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.thresholdimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.thresholdimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.textureimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.thumbnailimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.thresholdimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.thresholdimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.thresholdimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.thresholdimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.thresholdimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.thresholdimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.thresholdimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.thresholdimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.thresholdimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.thresholdimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.thresholdimage.php" hreflang="zh">
...
<meta name="Description" content="Changes the value of individual pixels based on a threshold" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::thresholdImage - Manual" />
<meta name="twitter:description" content="Changes the value of individual pixels based on a threshold" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::thresholdImage - Manual" />
<meta itemprop="description" content="Changes the value of individual pixels based on a threshold" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the value of individual pixels based on a threshold" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.thumbnailimage.php">
          Imagick::thumbnailImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.textureimage.php">
          &laquo; Imagick::textureImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.thresholdimage.php' selected="selected">English</option>
            <option value='de/imagick.thresholdimage.php'>German</option>
            <option value='es/imagick.thresholdimage.php'>Spanish</option>
            <option value='fr/imagick.thresholdimage.php'>French</option>
            <option value='it/imagick.thresholdimage.php'>Italian</option>
            <option value='ja/imagick.thresholdimage.php'>Japanese</option>
            <option value='pt_BR/imagick.thresholdimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.thresholdimage.php'>Russian</option>
            <option value='tr/imagick.thresholdimage.php'>Turkish</option>
            <option value='uk/imagick.thresholdimage.php'>Ukrainian</option>
            <option value='zh/imagick.thresholdimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.thresholdimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::thresholdImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::thresholdImage</span> &mdash; <span class="dc-title">Changes the value of individual pixels based on a threshold</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.thresholdimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::thresholdImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$threshold</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.thresholdimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.thresholdimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3131">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/thresholdimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.thresholdimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.thresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.thresholdimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="109244">  <div class="votes">
    <div id="Vu109244">
    <a href="/manual/vote-note.php?id=109244&amp;page=imagick.thresholdimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109244">
    <a href="/manual/vote-note.php?id=109244&amp;page=imagick.thresholdimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109244" title="66% like this...">
    1
    </div>
  </div>
  <a href="#109244" class="name">
  <strong class="user"><em>php t traction dot de</em></strong></a><a class="genanchor" href="#109244"> &para;</a><div class="date" title="2012-06-29 07:25"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109244">
<div class="phpcode"><code><span class="html">getQuantumRange() can be handy here:
<br />
<br /><span class="default">&lt;?php
<br />$i </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$imageFile</span><span class="keyword">);
<br /></span><span class="default">$max </span><span class="keyword">= </span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">getQuantumRange</span><span class="keyword">();
<br /></span><span class="default">$max </span><span class="keyword">= </span><span class="default">$max</span><span class="keyword">[</span><span class="string">"quantumRangeLong"</span><span class="keyword">]; 
<br /></span><span class="default">$i</span><span class="keyword">-&gt;</span><span class="default">thresholdImage</span><span class="keyword">(</span><span class="default">0.77 </span><span class="keyword">* </span><span class="default">$max</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.thresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.thresholdimage.php">＋<small>add a note</small></a></div>
