...
<head>
  ...
  <title>PHP: posix_setegid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-setegid.php">
 <link rel="shorturl" href="https://www.php.net/posix-setegid">
 <link rel="alternate" href="https://www.php.net/posix-setegid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-pathconf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-seteuid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-setegid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-setegid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-setegid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-setegid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-setegid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-setegid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-setegid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-setegid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-setegid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-setegid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-setegid.php" hreflang="zh">
...
<meta name="Description" content="Set the effective GID of the current process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_setegid - Manual" />
<meta name="twitter:description" content="Set the effective GID of the current process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_setegid - Manual" />
<meta itemprop="description" content="Set the effective GID of the current process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the effective GID of the current process" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-setegid.php' selected="selected">English</option>
            <option value='de/function.posix-setegid.php'>German</option>
            <option value='es/function.posix-setegid.php'>Spanish</option>
            <option value='fr/function.posix-setegid.php'>French</option>
            <option value='it/function.posix-setegid.php'>Italian</option>
            <option value='ja/function.posix-setegid.php'>Japanese</option>
            <option value='pt_BR/function.posix-setegid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-setegid.php'>Russian</option>
            <option value='tr/function.posix-setegid.php'>Turkish</option>
            <option value='uk/function.posix-setegid.php'>Ukrainian</option>
            <option value='zh/function.posix-setegid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-setegid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_setegid</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_setegid</span> &mdash; <span class="dc-title">Set the effective GID of the current process</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.posix-setegid-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>posix_setegid</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$group_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.posix-setegid-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-setegid-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-setegid-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3593">
    <p><strong>Example #1 <span class="function"><strong>posix_setegid()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br /></span><span style="color: #0000BB">posix_setegid</span><span style="color: #007700">(</span><span style="color: #0000BB">40</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My effective group id is '</span><span style="color: #007700">.</span><span style="color: #0000BB">posix_getegid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//40<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.posix-setegid-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li>
     <span class="function"><a href="function.posix-getgrgid.php" class="function" rel="rdfs-seeAlso">posix_getgrgid()</a> - Return info about a group by group id</span></li>
    ...
    <li><span class="function"><a href="function.posix-setgid.php" class="function" rel="rdfs-seeAlso">posix_setgid()</a> - Set the GID of the current process</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-setegid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-setegid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-setegid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-setegid.php">＋<small>add a note</small></a></span>
