...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.apcuiterator.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.apcu-store.php">
 <link rel="next" href="https://www.php.net/manual/en/apcuiterator.construct.php">
...
<meta name="Description" content="The APCUIterator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: APCUIterator - Manual" />
<meta name="twitter:description" content="The APCUIterator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: APCUIterator - Manual" />
<meta itemprop="description" content="The APCUIterator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The APCUIterator class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.apcuiterator.php' selected="selected">English</option>
            ...
            <option value='pt_BR/class.apcuiterator.php'>Brazilian Portuguese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="apcuiterator.construct.php">APCUIterator::__construct</a> — Constructs an APCUIterator iterator object</li><li><a href="apcuiterator.current.php">APCUIterator::current</a> — Get current item</li><li><a href="apcuiterator.gettotalcount.php">APCUIterator::getTotalCount</a> — Get total count</li><li><a href="apcuiterator.gettotalhits.php">APCUIterator::getTotalHits</a> — Get total cache hits</li><li><a href="apcuiterator.gettotalsize.php">APCUIterator::getTotalSize</a> — Get total cache size</li><li><a href="apcuiterator.key.php">APCUIterator::key</a> — Get iterator key</li><li><a href="apcuiterator.next.php">APCUIterator::next</a> — Move pointer to next item</li><li><a href="apcuiterator.rewind.php">APCUIterator::rewind</a> — Rewinds iterator</li><li><a href="apcuiterator.valid.php">APCUIterator::valid</a> — Checks if current position is valid</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/apcu/apcuiterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.apcuiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.apcuiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.apcuiterator.php">＋<small>add a note</small></a></span>
