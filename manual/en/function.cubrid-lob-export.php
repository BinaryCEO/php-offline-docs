...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob-export.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob-get.php">
...
<meta name="Description" content="Export BLOB/CLOB data to file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob_export - Manual" />
<meta name="twitter:description" content="Export BLOB/CLOB data to file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob_export - Manual" />
<meta itemprop="description" content="Export BLOB/CLOB data to file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export BLOB/CLOB data to file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob-export.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.cubrid-lob-export.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.1)</p><p class="refpurpose"><span class="refname">cubrid_lob_export</span> &mdash; <span class="dc-title">Export BLOB/CLOB data to file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob-export-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>cubrid_lob_export()</strong></span> is used to get BLOB/CLOB data from CUBRID database, and saves its contents to a file.
 ...
 <div class="refsect1 parameters" id="refsect1-function.cubrid-lob-export-parameters">
  ...
  <dd><p class="para">Path name of the file.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob-export-examples">
  ...
  <div class="example" id="example-1247">
   <p><strong>Example #1 <span class="function"><strong>cubrid_lob_export()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-lob-send.php" class="function" rel="rdfs-seeAlso">cubrid_lob_send()</a> - Read BLOB/CLOB data and send straight to browser</span></li>     
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob-export.php">＋<small>add a note</small></a></span>
