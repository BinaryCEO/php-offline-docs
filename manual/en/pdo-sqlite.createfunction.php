...
<head>
  ...
  <title>PHP: Pdo\Sqlite::createFunction - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdo-sqlite.createfunction.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdo-sqlite.createfunction.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdo-sqlite.createfunction.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.pdo-sqlite.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdo-sqlite.createcollation.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo-sqlite.loadextension.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pdo-sqlite.createfunction.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pdo-sqlite.createfunction.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pdo-sqlite.createfunction.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pdo-sqlite.createfunction.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pdo-sqlite.createfunction.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pdo-sqlite.createfunction.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pdo-sqlite.createfunction.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pdo-sqlite.createfunction.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pdo-sqlite.createfunction.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pdo-sqlite.createfunction.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pdo-sqlite.createfunction.php" hreflang="zh">
...
<meta name="Description" content="Registers a user-defined function for use in SQL statements" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Pdo\Sqlite::createFunction - Manual" />
<meta name="twitter:description" content="Registers a user-defined function for use in SQL statements" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Pdo\Sqlite::createFunction - Manual" />
<meta itemprop="description" content="Registers a user-defined function for use in SQL statements" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Registers a user-defined function for use in SQL statements" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="pdo-sqlite.loadextension.php">
          Pdo\Sqlite::loadExtension &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdo-sqlite.createcollation.php">
          &laquo; Pdo\Sqlite::createCollation        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdo-sqlite.createfunction.php' selected="selected">English</option>
            <option value='de/pdo-sqlite.createfunction.php'>German</option>
            <option value='es/pdo-sqlite.createfunction.php'>Spanish</option>
            <option value='fr/pdo-sqlite.createfunction.php'>French</option>
            <option value='it/pdo-sqlite.createfunction.php'>Italian</option>
            <option value='ja/pdo-sqlite.createfunction.php'>Japanese</option>
            <option value='pt_BR/pdo-sqlite.createfunction.php'>Brazilian Portuguese</option>
            <option value='ru/pdo-sqlite.createfunction.php'>Russian</option>
            <option value='tr/pdo-sqlite.createfunction.php'>Turkish</option>
            <option value='uk/pdo-sqlite.createfunction.php'>Ukrainian</option>
            <option value='zh/pdo-sqlite.createfunction.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pdo-sqlite.createfunction" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-pdo-sqlite.createfunction-examples">
  ...
  <div class="example" id="pdo-sqlite.createfunction.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>Pdo\Sqlite::createFunction()</strong></span> example</strong></p>
   ...
   <div class="example-contents"><p>
    ...
    result using a <a href="control-structures.foreach.php" class="link"><code class="literal">foreach</code></a> loop after the query.
   </p></div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><strong>sqlite_create_aggregate()</strong></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo_sqlite/pdo/sqlite/createfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdo-sqlite.createfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdo-sqlite.createfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdo-sqlite.createfunction.php">＋<small>add a note</small></a></span>
