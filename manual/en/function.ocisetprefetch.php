...
<head>
  ...
  <title>PHP: ocisetprefetch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocisetprefetch.php">
 <link rel="shorturl" href="https://www.php.net/ocisetprefetch">
 <link rel="alternate" href="https://www.php.net/ocisetprefetch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ociserverversion.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocistatementtype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocisetprefetch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocisetprefetch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocisetprefetch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocisetprefetch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocisetprefetch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocisetprefetch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocisetprefetch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocisetprefetch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocisetprefetch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocisetprefetch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocisetprefetch.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_set_prefetch" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocisetprefetch - Manual" />
<meta name="twitter:description" content="Alias of oci_set_prefetch" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocisetprefetch - Manual" />
<meta itemprop="description" content="Alias of oci_set_prefetch" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_set_prefetch" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocistatementtype.php">
          ocistatementtype &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ociserverversion.php">
          &laquo; ociserverversion        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocisetprefetch.php' selected="selected">English</option>
            <option value='de/function.ocisetprefetch.php'>German</option>
            <option value='es/function.ocisetprefetch.php'>Spanish</option>
            <option value='fr/function.ocisetprefetch.php'>French</option>
            <option value='it/function.ocisetprefetch.php'>Italian</option>
            <option value='ja/function.ocisetprefetch.php'>Japanese</option>
            <option value='pt_BR/function.ocisetprefetch.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocisetprefetch.php'>Russian</option>
            <option value='tr/function.ocisetprefetch.php'>Turkish</option>
            <option value='uk/function.ocisetprefetch.php'>Ukrainian</option>
            <option value='zh/function.ocisetprefetch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocisetprefetch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocisetprefetch</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocisetprefetch</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-set-prefetch.php" class="function">oci_set_prefetch()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocisetprefetch-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-set-prefetch.php" class="function">oci_set_prefetch()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocisetprefetch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocisetprefetch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocisetprefetch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocisetprefetch.php">＋<small>add a note</small></a></span>
