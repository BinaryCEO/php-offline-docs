...
<head>
  ...
  <title>PHP: Gmagick::gammaimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.gammaimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.gammaimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.gammaimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.frameimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getcopyright.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.gammaimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.gammaimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.gammaimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.gammaimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.gammaimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.gammaimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.gammaimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.gammaimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.gammaimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.gammaimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.gammaimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::gammaimage - Manual" />
<meta name="twitter:description" content="Gamma-corrects an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::gammaimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getcopyright.php">
          Gmagick::getcopyright &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.frameimage.php">
          &laquo; Gmagick::frameimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.gammaimage.php' selected="selected">English</option>
            <option value='de/gmagick.gammaimage.php'>German</option>
            <option value='es/gmagick.gammaimage.php'>Spanish</option>
            <option value='fr/gmagick.gammaimage.php'>French</option>
            <option value='it/gmagick.gammaimage.php'>Italian</option>
            <option value='ja/gmagick.gammaimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.gammaimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.gammaimage.php'>Russian</option>
            <option value='tr/gmagick.gammaimage.php'>Turkish</option>
            <option value='uk/gmagick.gammaimage.php'>Ukrainian</option>
            <option value='zh/gmagick.gammaimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.gammaimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::gammaimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::gammaimage</span> &mdash; <span class="dc-title">Gamma-corrects an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.gammaimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::gammaimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$gamma</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.gammaimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.gammaimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
  The gamma corrected <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.gammaimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/gammaimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.gammaimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.gammaimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.gammaimage.php">＋<small>add a note</small></a></span>
