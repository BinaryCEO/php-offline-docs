...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.unpack.php">
 <link rel="shorturl" href="https://www.php.net/unpack">
 <link rel="alternate" href="https://www.php.net/unpack" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.uniqid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.usleep.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.unpack.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.unpack.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.unpack.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.unpack.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.unpack.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.unpack.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.unpack.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.unpack.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.unpack.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.unpack.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.unpack.php" hreflang="zh">
...
<meta name="Description" content="Unpack data from binary string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: unpack - Manual" />
<meta name="twitter:description" content="Unpack data from binary string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: unpack - Manual" />
<meta itemprop="description" content="Unpack data from binary string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unpack data from binary string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.unpack.php' selected="selected">English</option>
            <option value='de/function.unpack.php'>German</option>
            <option value='es/function.unpack.php'>Spanish</option>
            <option value='fr/function.unpack.php'>French</option>
            <option value='it/function.unpack.php'>Italian</option>
            <option value='ja/function.unpack.php'>Japanese</option>
            <option value='pt_BR/function.unpack.php'>Brazilian Portuguese</option>
            <option value='ru/function.unpack.php'>Russian</option>
            <option value='tr/function.unpack.php'>Turkish</option>
            <option value='uk/function.unpack.php'>Ukrainian</option>
            <option value='zh/function.unpack.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.unpack" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.unpack-returnvalues">
  ...
  <p class="para">
   ...
   string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
(
 ...
 <div class="refsect1 notes" id="refsect1-function.unpack-notes">
  ...
  <div class="caution"><strong class="caution">Caution</strong>
   ...
   <p class="para">
    <div class="example" id="example-3767">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pack.php" class="function" rel="rdfs-seeAlso">pack()</a> - Pack data into binary string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/unpack.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.unpack%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.unpack&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.unpack.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">14 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119403">  <div class="votes">
    <div id="Vu119403">
    <a href="/manual/vote-note.php?id=119403&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119403">
    <a href="/manual/vote-note.php?id=119403&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119403" title="78% like this...">
    19
    </div>
  </div>
  <a href="#119403" class="name">
  <strong class="user"><em>stanislav dot eckert at vizson dot de</em></strong></a><a class="genanchor" href="#119403"> &para;</a><div class="date" title="2016-05-29 03:15"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119403">
<div class="phpcode"><code><span class="html">A helper class to convert integer to binary strings and vice versa. Useful for writing and reading integers to / from files or sockets.<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="keyword">class </span><span class="default">int_helper<br />    </span><span class="keyword">{<br />        public static function </span><span class="default">int8</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) {<br />            return </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">pack</span><span class="keyword">(</span><span class="string">"c"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) : </span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"c"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)[</span><span class="default">1</span><span class="keyword">];<br />        }<br /><br />        public static function </span><span class="default">uInt8</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) {<br />            return </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">pack</span><span class="keyword">(</span><span class="string">"C"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) : </span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"C"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)[</span><span class="default">1</span><span class="keyword">];<br />        }<br /><br />        public static function </span><span class="default">int16</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) {<br />            return </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">pack</span><span class="keyword">(</span><span class="string">"s"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) : </span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"s"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)[</span><span class="default">1</span><span class="keyword">];<br />        }<br /><br />        public static function </span><span class="default">uInt16</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">, </span><span class="default">$endianness</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">) {<br />            </span><span class="default">$f </span><span class="keyword">= </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="string">"pack" </span><span class="keyword">: </span><span class="string">"unpack"</span><span class="keyword">;<br /><br />            if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">true</span><span class="keyword">) {  </span><span class="comment">// big-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"n"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {  </span><span class="comment">// little-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"v"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">null</span><span class="keyword">) {  </span><span class="comment">// machine byte order<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"S"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br /><br />            return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">$i</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] : </span><span class="default">$i</span><span class="keyword">;<br />        }<br /><br />        public static function </span><span class="default">int32</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) {<br />            return </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">pack</span><span class="keyword">(</span><span class="string">"l"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) : </span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"l"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)[</span><span class="default">1</span><span class="keyword">];<br />        }<br /><br />        public static function </span><span class="default">uInt32</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">, </span><span class="default">$endianness</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">) {<br />            </span><span class="default">$f </span><span class="keyword">= </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="string">"pack" </span><span class="keyword">: </span><span class="string">"unpack"</span><span class="keyword">;<br /><br />            if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">true</span><span class="keyword">) {  </span><span class="comment">// big-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"N"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {  </span><span class="comment">// little-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"V"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">null</span><span class="keyword">) {  </span><span class="comment">// machine byte order<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"L"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br /><br />            return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">$i</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] : </span><span class="default">$i</span><span class="keyword">;<br />        }<br /><br />        public static function </span><span class="default">int64</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) {<br />            return </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">pack</span><span class="keyword">(</span><span class="string">"q"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) : </span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"q"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)[</span><span class="default">1</span><span class="keyword">];<br />        }<br /><br />        public static function </span><span class="default">uInt64</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">, </span><span class="default">$endianness</span><span class="keyword">=</span><span class="default">false</span><span class="keyword">) {<br />            </span><span class="default">$f </span><span class="keyword">= </span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="string">"pack" </span><span class="keyword">: </span><span class="string">"unpack"</span><span class="keyword">;<br /><br />            if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">true</span><span class="keyword">) {  </span><span class="comment">// big-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"J"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {  </span><span class="comment">// little-endian<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"P"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br />            else if (</span><span class="default">$endianness </span><span class="keyword">=== </span><span class="default">null</span><span class="keyword">) {  </span><span class="comment">// machine byte order<br />                </span><span class="default">$i </span><span class="keyword">= </span><span class="default">$f</span><span class="keyword">(</span><span class="string">"Q"</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />            }<br /><br />            return </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">) ? </span><span class="default">$i</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] : </span><span class="default">$i</span><span class="keyword">;<br />        }<br />    }<br /></span><span class="default">?&gt;<br /></span><br />Usage example:<br /><span class="default">&lt;?php<br />    Header</span><span class="keyword">(</span><span class="string">"Content-Type: text/plain"</span><span class="keyword">);<br />    include(</span><span class="string">"int_helper.php"</span><span class="keyword">);<br /><br />    echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt8</span><span class="keyword">(</span><span class="default">0x6b</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// k<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt8</span><span class="keyword">(</span><span class="default">107</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// k<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt8</span><span class="keyword">(</span><span class="string">"\x6b"</span><span class="keyword">) . </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// 107<br /><br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt16</span><span class="keyword">(</span><span class="default">4101</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// \x05\x10<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt16</span><span class="keyword">(</span><span class="string">"\x05\x10"</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// 4101<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt16</span><span class="keyword">(</span><span class="string">"\x05\x10"</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">) . </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// 1296<br /><br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt32</span><span class="keyword">(</span><span class="default">2147483647</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// \xff\xff\xff\x7f<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt32</span><span class="keyword">(</span><span class="string">"\xff\xff\xff\x7f"</span><span class="keyword">) . </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// 2147483647<br /><br />    // Note: Test this with 64-bit build of PHP<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt64</span><span class="keyword">(</span><span class="default">9223372036854775807</span><span class="keyword">) . </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// \xff\xff\xff\xff\xff\xff\xff\x7f<br />    </span><span class="keyword">echo </span><span class="default">int_helper</span><span class="keyword">::</span><span class="default">uInt64</span><span class="keyword">(</span><span class="string">"\xff\xff\xff\xff\xff\xff\xff\x7f"</span><span class="keyword">) . </span><span class="default">PHP_EOL </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;  </span><span class="comment">// 9223372036854775807<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="46725">  <div class="votes">
    <div id="Vu46725">
    <a href="/manual/vote-note.php?id=46725&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd46725">
    <a href="/manual/vote-note.php?id=46725&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V46725" title="80% like this...">
    12
    </div>
  </div>
  <a href="#46725" class="name">
  <strong class="user"><em>jjfoerch at earthlink dot net</em></strong></a><a class="genanchor" href="#46725"> &para;</a><div class="date" title="2004-10-21 04:57"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom46725">
<div class="phpcode"><code><span class="html">I had a situation where I had to unpack a file filled with little-endian order double-floats in a way that would work on either little-endian or big-endian machines.  PHP doesn't have a formatting code that will change the byte order of doubles, so I wrote this workaround.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/*The following code is a workaround for php's unpack function<br />which does not have the capability of unpacking double precision<br />floats that were packed in the opposite byte order of the current<br />machine.<br />*/<br /></span><span class="keyword">function </span><span class="default">big_endian_unpack </span><span class="keyword">(</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">) {<br />    </span><span class="default">$ar </span><span class="keyword">= </span><span class="default">unpack </span><span class="keyword">(</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">);<br />    </span><span class="default">$vals </span><span class="keyword">= </span><span class="default">array_values </span><span class="keyword">(</span><span class="default">$ar</span><span class="keyword">);<br />    </span><span class="default">$f </span><span class="keyword">= </span><span class="default">explode </span><span class="keyword">(</span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$format</span><span class="keyword">);<br />    </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    foreach (</span><span class="default">$f </span><span class="keyword">as </span><span class="default">$f_k </span><span class="keyword">=&gt; </span><span class="default">$f_v</span><span class="keyword">) {<br />    </span><span class="default">$repeater </span><span class="keyword">= </span><span class="default">intval </span><span class="keyword">(</span><span class="default">substr </span><span class="keyword">(</span><span class="default">$f_v</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">));<br />    if (</span><span class="default">$repeater </span><span class="keyword">== </span><span class="default">0</span><span class="keyword">) </span><span class="default">$repeater </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />    if (</span><span class="default">$f_v</span><span class="keyword">{</span><span class="default">1</span><span class="keyword">} == </span><span class="string">'*'</span><span class="keyword">)<br />    {<br />        </span><span class="default">$repeater </span><span class="keyword">= </span><span class="default">count </span><span class="keyword">(</span><span class="default">$ar</span><span class="keyword">) - </span><span class="default">$i</span><span class="keyword">;<br />    }<br />    if (</span><span class="default">$f_v</span><span class="keyword">{</span><span class="default">0</span><span class="keyword">} != </span><span class="string">'d'</span><span class="keyword">) { </span><span class="default">$i </span><span class="keyword">+= </span><span class="default">$repeater</span><span class="keyword">; continue; }<br />    </span><span class="default">$j </span><span class="keyword">= </span><span class="default">$i </span><span class="keyword">+ </span><span class="default">$repeater</span><span class="keyword">;<br />    for (</span><span class="default">$a </span><span class="keyword">= </span><span class="default">$i</span><span class="keyword">; </span><span class="default">$a </span><span class="keyword">&lt; </span><span class="default">$j</span><span class="keyword">; ++</span><span class="default">$a</span><span class="keyword">)<br />    {<br />        </span><span class="default">$p </span><span class="keyword">= </span><span class="default">pack </span><span class="keyword">(</span><span class="string">'d'</span><span class="keyword">,</span><span class="default">$vals</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]);<br />        </span><span class="default">$p </span><span class="keyword">= </span><span class="default">strrev </span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">);<br />        list (</span><span class="default">$vals</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]) = </span><span class="default">array_values </span><span class="keyword">(</span><span class="default">unpack </span><span class="keyword">(</span><span class="string">'d1d'</span><span class="keyword">, </span><span class="default">$p</span><span class="keyword">));<br />        ++</span><span class="default">$i</span><span class="keyword">;<br />    }<br />    }<br />    </span><span class="default">$a </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    foreach (</span><span class="default">$ar </span><span class="keyword">as </span><span class="default">$ar_k </span><span class="keyword">=&gt; </span><span class="default">$ar_v</span><span class="keyword">) {<br />    </span><span class="default">$ar</span><span class="keyword">[</span><span class="default">$ar_k</span><span class="keyword">] = </span><span class="default">$vals</span><span class="keyword">[</span><span class="default">$a</span><span class="keyword">];<br />    ++</span><span class="default">$a</span><span class="keyword">;<br />    }<br />    return </span><span class="default">$ar</span><span class="keyword">;<br />}<br /><br />list (</span><span class="default">$endiantest</span><span class="keyword">) = </span><span class="default">array_values </span><span class="keyword">(</span><span class="default">unpack </span><span class="keyword">(</span><span class="string">'L1L'</span><span class="keyword">, </span><span class="default">pack </span><span class="keyword">(</span><span class="string">'V'</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">)));<br />if (</span><span class="default">$endiantest </span><span class="keyword">!= </span><span class="default">1</span><span class="keyword">) </span><span class="default">define </span><span class="keyword">(</span><span class="string">'BIG_ENDIAN_MACHINE'</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br />if (</span><span class="default">defined </span><span class="keyword">(</span><span class="string">'BIG_ENDIAN_MACHINE'</span><span class="keyword">)) </span><span class="default">$unpack_workaround </span><span class="keyword">= </span><span class="string">'big_endian_unpack'</span><span class="keyword">;<br />else </span><span class="default">$unpack_workaround </span><span class="keyword">= </span><span class="string">'unpack'</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />This workaround is used like this:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">foo</span><span class="keyword">() {<br />        global </span><span class="default">$unpack_workaround</span><span class="keyword">;<br />    </span><span class="default">$bar </span><span class="keyword">= </span><span class="default">$unpack_workaround</span><span class="keyword">(</span><span class="string">'N7N/V2V/d8d'</span><span class="keyword">,</span><span class="default">$my_data</span><span class="keyword">);<br /></span><span class="comment">//...<br /></span><span class="keyword">}<br /><br /></span><span class="default">?&gt;<br /></span><br />On a little endian machine, $unpack_workaround will simply point to the function unpack.  On a big endian machine, it will call the workaround function.<br /><br />Note, this solution only works for doubles.  In my project I had no need to check for single precision floats.</span></code></div>
  </div>
 </div>
  <div class="note" id="43945">  <div class="votes">
    <div id="Vu43945">
    <a href="/manual/vote-note.php?id=43945&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd43945">
    <a href="/manual/vote-note.php?id=43945&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V43945" title="75% like this...">
    14
    </div>
  </div>
  <a href="#43945" class="name">
  <strong class="user"><em>Sergio Santana: ssantana at tlaloc dot imta dot mx</em></strong></a><a class="genanchor" href="#43945"> &para;</a><div class="date" title="2004-07-09 10:54"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom43945">
<div class="phpcode"><code><span class="html">This is about the last example of my previous post. For the sake of clarity, I'm including again here the example, which expands the one given in the formal documentation:<br /><br />&lt;?<br />  $binarydata = "AA\0A";<br />  $array = unpack("c2chars/nint", $binarydata);<br />  foreach ($array as $key =&gt; $value)<br />     echo "\$array[$key] = $value &lt;br&gt;\n";<br />?&gt;<br /><br />This outputs:<br /><br />$array[chars1] = 65 <br />$array[chars2] = 65 <br />$array[int] = 65 <br /><br />Here, we assume that the ascii code for character 'A' is decimal 65.<br /><br />Remebering that the format string structure is:<br />&lt;format-code&gt; [&lt;count&gt;] [&lt;array-key&gt;] [/ ...],<br />in this example, the format string instructs the function to<br />  1. ("c2...") Read two chars from the second argument ("AA ...), <br />  2. (...chars...) Use the array-keys "chars1", and "chars2" for <br />      these two chars read,<br />  3. (.../n...) Read a short int from the second argument (...\0A"),<br />  4. (...int") Use the word "int" as the array key for the just read<br />      short.<br /><br />I hope this is clearer now,<br /><br />Sergio.</span></code></div>
  </div>
 </div>
  <div class="note" id="45188">  <div class="votes">
    <div id="Vu45188">
    <a href="/manual/vote-note.php?id=45188&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45188">
    <a href="/manual/vote-note.php?id=45188&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45188" title="68% like this...">
    7
    </div>
  </div>
  <a href="#45188" class="name">
  <strong class="user"><em>kennwhite dot nospam at hotmail dot com</em></strong></a><a class="genanchor" href="#45188"> &para;</a><div class="date" title="2004-08-28 12:32"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45188">
<div class="phpcode"><code><span class="html">If having a zero-based index is useful/necessary, then instead of:<br /><br />$int_list = unpack("s*", $some_binary_data);<br /><br /> try:<br /><br />$int_list = array_merge(unpack("s*", $some_binary_data));<br /><br />This will return a 0-based array:<br /><br />$int_list[0] = x<br />$int_list[1] = y<br />$int_list[2] = z<br />...<br /><br />rather than the default 1-based array returned from unpack when no key is supplied:<br /><br />$int_list[1] = x<br />$int_list[2] = y<br />$int_list[3] = z<br />...<br /><br />It's not used often, but array_merge() with only one parameter will compress a sequentially-ordered numeric-index, starting with an index of [0].</span></code></div>
  </div>
 </div>
  <div class="note" id="43930">  <div class="votes">
    <div id="Vu43930">
    <a href="/manual/vote-note.php?id=43930&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd43930">
    <a href="/manual/vote-note.php?id=43930&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V43930" title="61% like this...">
    4
    </div>
  </div>
  <a href="#43930" class="name">
  <strong class="user"><em>Sergio Santana: ssantana at tlaloc dot imta dot mx</em></strong></a><a class="genanchor" href="#43930"> &para;</a><div class="date" title="2004-07-08 07:41"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom43930">
<div class="phpcode"><code><span class="html">Suppose we need to get some kind of internal representation of an integer, say 65, as a four-byte long. Then we use, something like:<br /><br />&lt;?<br />  $i = 65;<br />  $s = pack("l", $i); // long 32 bit, machine byte order<br />  echo strlen($s) . "&lt;br&gt;\n";<br />  echo "***$s***&lt;br&gt;\n";<br />?&gt;<br /><br />The output is:<br /><br />X-Powered-By: PHP/4.1.2<br />Content-type: text/html<br /><br />4<br />***A*** <br /><br />(That is the string "A\0\0\0")<br /><br />Now we want to go back from string "A\0\0\0" to number 65. In this case we can use:<br /><br />&lt;?<br />  $s = "A\0\0\0"; // This string is the bytes representation of number 65<br />  $arr = unpack("l", $s);<br />  foreach ($arr as $key =&gt; $value)<br />     echo "\$arr[$key] = $value&lt;br&gt;\n";<br />?&gt;<br /><br />And this outpus:<br />X-Powered-By: PHP/4.1.2<br />Content-type: text/html<br /><br />$arr[] = 65<br /><br />Let's give the array key a name, say "mykey". In this case, we can use: <br /><br />&lt;?<br />  $s = "A\0\0\0"; // This string is the bytes representation of number  65<br />  $arr = unpack("lmykey", $s);<br />  foreach ($arr as $key =&gt; $value)<br />     echo "\$arr[$key] = $value\n";<br />?&gt;<br /><br />An this outpus:<br />X-Powered-By: PHP/4.1.2<br />Content-type: text/html<br /><br />$arr[mykey] = 65<br /><br />The "unpack" documentation is a little bit confusing. I think a more complete example could be:<br /><br />&lt;?<br />  $binarydata = "AA\0A";<br />  $array = unpack("c2chars/nint", $binarydata);<br />  foreach ($array as $key =&gt; $value)<br />    echo "\$array[$key] = $value &lt;br&gt;\n";<br />?&gt;<br /><br />whose output is:<br /><br />X-Powered-By: PHP/4.1.2<br />Content-type: text/html<br /><br />$array[chars1] = 65 &lt;br&gt;<br />$array[chars2] = 65 &lt;br&gt;<br />$array[int] = 65 &lt;br&gt;<br /><br />Note that the format string is something like<br />&lt;format-code&gt; [&lt;count&gt;] [&lt;array-key&gt;] [/ ...]<br /><br />I hope this clarifies something<br /><br />Sergio</span></code></div>
  </div>
 </div>
  <div class="note" id="93714">  <div class="votes">
    <div id="Vu93714">
    <a href="/manual/vote-note.php?id=93714&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93714">
    <a href="/manual/vote-note.php?id=93714&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93714" title="57% like this...">
    1
    </div>
  </div>
  <a href="#93714" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#93714"> &para;</a><div class="date" title="2009-09-23 08:02"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom93714">
<div class="phpcode"><code><span class="html">Functions I found useful when dealing with fixed width file processing, related to unpack/pack functions.<br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br />* funpack<br />* format: array of key, length pairs<br />* data: string to unpack<br />*/<br /></span><span class="keyword">function </span><span class="default">funpack</span><span class="keyword">(</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">){<br />    foreach (</span><span class="default">$format </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$len</span><span class="keyword">) {<br />        </span><span class="default">$result</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">trim</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">, </span><span class="default">$pos</span><span class="keyword">, </span><span class="default">$len</span><span class="keyword">));<br />        </span><span class="default">$pos</span><span class="keyword">+= </span><span class="default">$len</span><span class="keyword">;<br />    }<br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">/**<br />* fpack<br />* format: array of key, length pairs<br />* data: array of key, value pairs to pack<br />* pad: padding direction<br />*/<br /></span><span class="keyword">function </span><span class="default">fpack</span><span class="keyword">(</span><span class="default">$format</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">, </span><span class="default">$pad </span><span class="keyword">= </span><span class="default">STR_PAD_RIGHT</span><span class="keyword">){<br />    foreach (</span><span class="default">$format </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$len</span><span class="keyword">){<br />        </span><span class="default">$result </span><span class="keyword">.= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">str_pad</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">], </span><span class="default">$len</span><span class="keyword">, </span><span class="default">$pad</span><span class="keyword">), </span><span class="default">0</span><span class="keyword">, </span><span class="default">$len</span><span class="keyword">);<br />    }<br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="124664">  <div class="votes">
    <div id="Vu124664">
    <a href="/manual/vote-note.php?id=124664&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124664">
    <a href="/manual/vote-note.php?id=124664&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124664" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124664" class="name">
  <strong class="user"><em>ludwig at kni-online dot de</em></strong></a><a class="genanchor" href="#124664"> &para;</a><div class="date" title="2020-01-30 11:57"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124664">
<div class="phpcode"><code><span class="html">Don't forget to decode user-defined-pseudo-byte-sequences before unpacking...<br /><span class="default">&lt;?php<br />  $byte_code_string </span><span class="keyword">=  </span><span class="string">'00004040'</span><span class="keyword">;<br />  </span><span class="default">var_dump </span><span class="keyword">( </span><span class="default">unpack </span><span class="keyword">( </span><span class="string">'f'</span><span class="keyword">, </span><span class="default">$byte_code_string </span><span class="keyword">) );<br /></span><span class="default">?&gt;<br /></span>Result:<br />  array(1) {<br />    [1]=&gt;<br />    float(6.4096905560973E-10)<br />  }<br /><br />whereas<br /><span class="default">&lt;?php<br />   $byte_code_string </span><span class="keyword">=  </span><span class="string">'00004040'</span><span class="keyword">;<br />   </span><span class="default">var_dump </span><span class="keyword">( </span><span class="default">unpack </span><span class="keyword">( </span><span class="string">'f'</span><span class="keyword">, </span><span class="default">hex2bin </span><span class="keyword">( </span><span class="default">$byte_code_string </span><span class="keyword">) ) );<br /></span><span class="default">?&gt;<br /></span>Result:<br />  array(1) {<br />    [1]=&gt;<br />    float(3)<br />  }</span></code></div>
  </div>
 </div>
  <div class="note" id="82146">  <div class="votes">
    <div id="Vu82146">
    <a href="/manual/vote-note.php?id=82146&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82146">
    <a href="/manual/vote-note.php?id=82146&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82146" title="50% like this...">
    0
    </div>
  </div>
  <a href="#82146" class="name">
  <strong class="user"><em>Anonymous Coward</em></strong></a><a class="genanchor" href="#82146"> &para;</a><div class="date" title="2008-03-28 10:52"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82146">
<div class="phpcode"><code><span class="html">Warning: This unpack function makes the array with keys starting at 1 instead of starting at 0.<br /><br />For example:<br /><span class="default">&lt;?php<br /> </span><span class="keyword">function </span><span class="default">read_field</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">) {<br />  </span><span class="default">$a</span><span class="keyword">=</span><span class="default">unpack</span><span class="keyword">(</span><span class="string">"V"</span><span class="keyword">,</span><span class="default">fread</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">,</span><span class="default">4</span><span class="keyword">));<br />  return </span><span class="default">fread</span><span class="keyword">(</span><span class="default">$h</span><span class="keyword">,</span><span class="default">$a</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]);<br /> }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="100326">  <div class="votes">
    <div id="Vu100326">
    <a href="/manual/vote-note.php?id=100326&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100326">
    <a href="/manual/vote-note.php?id=100326&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100326" title="46% like this...">
    -1
    </div>
  </div>
  <a href="#100326" class="name">
  <strong class="user"><em>Aaron Wells</em></strong></a><a class="genanchor" href="#100326"> &para;</a><div class="date" title="2010-10-08 03:06"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100326">
<div class="phpcode"><code><span class="html">Another option for converting binary data into PHP data types, is to use the Zend Framework's Zend_Io_Reader class:<br /><a href="http://bit.ly/9zAhgz" rel="nofollow" target="_blank">http://bit.ly/9zAhgz</a><br /><br />There's also a Zend_Io_Writer class that does the reverse.</span></code></div>
  </div>
 </div>
  <div class="note" id="97177">  <div class="votes">
    <div id="Vu97177">
    <a href="/manual/vote-note.php?id=97177&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97177">
    <a href="/manual/vote-note.php?id=97177&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97177" title="37% like this...">
    -2
    </div>
  </div>
  <a href="#97177" class="name">
  <strong class="user"><em>norwood at computer dot org</em></strong></a><a class="genanchor" href="#97177"> &para;</a><div class="date" title="2010-04-06 02:15"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97177">
<div class="phpcode"><code><span class="html">Reading a text cell from an Excel spreadsheet returned a string with low-order embedded nulls: 0x4100 0x4200 etc. To remove the nulls, used
<br />
...
<br /></span>
<br />(unpack() didn't seem to help much here; needed chars back to re-constitute the string, not integers.)</span></code></div>
  </div>
 </div>
  <div class="note" id="110102">  <div class="votes">
    <div id="Vu110102">
    <a href="/manual/vote-note.php?id=110102&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110102">
    <a href="/manual/vote-note.php?id=110102&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110102" title="38% like this...">
    -3
    </div>
  </div>
  <a href="#110102" class="name">
  <strong class="user"><em>googlybash24 at aol dot com</em></strong></a><a class="genanchor" href="#110102"> &para;</a><div class="date" title="2012-09-19 05:20"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom110102">
<div class="phpcode"><code><span class="html">To convert big endian to little endian or to convert little endian to big endian, use the following approach as an example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// file_get_contents() returns a binary value, unpack("V*", _ ) returns an unsigned long 32-bit little endian decimal value, but bin2hex() after that would just give the hex data in the file if alone, so instead we use:<br />// file_get_contents(), unpack("V*", _ ), then dechex(), in that order, to get the byte-swapping effect.<br /></span><span class="default">?&gt;<br /></span><br />With the logic of the approach in this example, you can discover how to swap the endian byte order as you need.</span></code></div>
  </div>
 </div>
  <div class="note" id="106041">  <div class="votes">
    <div id="Vu106041">
    <a href="/manual/vote-note.php?id=106041&amp;page=function.unpack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106041">
    <a href="/manual/vote-note.php?id=106041&amp;page=function.unpack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106041" title="35% like this...">
    -4
    </div>
  </div>
  <a href="#106041" class="name">
  <strong class="user"><em>rogier</em></strong></a><a class="genanchor" href="#106041"> &para;</a><div class="date" title="2011-10-05 07:19"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106041">
<div class="phpcode"><code><span class="html">be aware of the behavior of your system that PHP resides on.
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=function.unpack&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.unpack.php">＋<small>add a note</small></a></div>
