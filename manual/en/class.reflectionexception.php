...
<head>
  ...
  <title>PHP: ReflectionException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionexception.php">
 <link rel="shorturl" href="https://www.php.net/reflectionexception">
 <link rel="alternate" href="https://www.php.net/reflectionexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflector.export.php">
 <link rel="next" href="https://www.php.net/manual/en/enum.propertyhooktype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionexception.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionException - Manual" />
<meta name="twitter:description" content="The ReflectionException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionException - Manual" />
<meta itemprop="description" content="The ReflectionException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="enum.propertyhooktype.php">
          PropertyHookType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflector.export.php">
          &laquo; Reflector::export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionexception.php' selected="selected">English</option>
            <option value='de/class.reflectionexception.php'>German</option>
            <option value='es/class.reflectionexception.php'>Spanish</option>
            <option value='fr/class.reflectionexception.php'>French</option>
            <option value='it/class.reflectionexception.php'>Italian</option>
            <option value='ja/class.reflectionexception.php'>Japanese</option>
            <option value='pt_BR/class.reflectionexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionexception.php'>Russian</option>
            <option value='tr/class.reflectionexception.php'>Turkish</option>
            <option value='uk/class.reflectionexception.php'>Ukrainian</option>
            <option value='zh/class.reflectionexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionexception" class="reference">

 <h1 class="title">The ReflectionException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>


  <div class="section" id="reflectionexception.intro">
  ...
  <div class="section" id="reflectionexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">ReflectionException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionexception.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123784">  <div class="votes">
    <div id="Vu123784">
    <a href="/manual/vote-note.php?id=123784&amp;page=class.reflectionexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123784">
    <a href="/manual/vote-note.php?id=123784&amp;page=class.reflectionexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123784" title="75% like this...">
    10
    </div>
  </div>
  <a href="#123784" class="name">
  <strong class="user"><em>temirkhan.nasukhov</em></strong></a><a class="genanchor" href="#123784"> &para;</a><div class="date" title="2019-04-18 11:50"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123784">
<div class="phpcode"><code><span class="html">Note that this exception is unchecked even if it is not based on RuntimeException.  Such error must lead to direct fixes in code and not in catch-handle of situation.<br /><br />Also keep in mind that IDE (mine is Phpstorm 2018.3.4) inspections will highlight it for that reason so do not create phpdoc with throws for any Runtime exceptions.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/**<br /> * This way is wrong<br /> *<br /> * @throws \ReflectionException<br /> */<br /></span><span class="keyword">function </span><span class="default">createReflection</span><span class="keyword">()<br />{<br />    return new </span><span class="default">\ReflectionClass</span><span class="keyword">(</span><span class="string">'invalid argument'</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">/**<br /> * This way is fine(I don't mean the code of course)<br /> */<br /></span><span class="keyword">function </span><span class="default">createReflection</span><span class="keyword">()<br />{<br />    return new </span><span class="default">\ReflectionClass</span><span class="keyword">(</span><span class="string">'invalid argument'</span><span class="keyword">);<br />}</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.reflectionexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionexception.php">＋<small>add a note</small></a></div>
