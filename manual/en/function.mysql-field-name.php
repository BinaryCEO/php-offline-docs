...
<head>
  ...
  <title>PHP: mysql_field_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-name.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-name">
 <link rel="alternate" href="https://www.php.net/mysql-field-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-len.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-name.php" hreflang="zh">
...
<meta name="Description" content="Get the name of the specified field in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_field_name - Manual" />
<meta name="twitter:description" content="Get the name of the specified field in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_name - Manual" />
<meta itemprop="description" content="Get the name of the specified field in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the name of the specified field in a result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-field-seek.php">
          mysql_field_seek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-len.php">
          &laquo; mysql_field_len        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-name.php' selected="selected">English</option>
            <option value='de/function.mysql-field-name.php'>German</option>
            <option value='es/function.mysql-field-name.php'>Spanish</option>
            <option value='fr/function.mysql-field-name.php'>French</option>
            <option value='it/function.mysql-field-name.php'>Italian</option>
            <option value='ja/function.mysql-field-name.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-name.php'>Russian</option>
            <option value='tr/function.mysql-field-name.php'>Turkish</option>
            <option value='uk/function.mysql-field-name.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_field_name</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_field_name</span> &mdash; <span class="dc-title">Get the name of the specified field in a result</span></p>

 </div>

 <div id="function.mysql-field-name-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.fetch-field-direct.php" class="function">mysqli_fetch_field_direct()</a></span> [name] or [orgname]</li>
    <li><span class="methodname"><a href="pdostatement.getcolumnmeta.php" class="methodname">PDOStatement::getColumnMeta()</a></span> [name]</li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-field-name-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_field_name</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field_offset</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_field_name()</strong></span> returns the name of the
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> is also issued.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-field-name-returnvalues">
  ...
  <p class="para">
   The name of the specified field index on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-field-len.php" class="function" rel="rdfs-seeAlso">mysql_field_len()</a> - Returns the length of the specified field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-name.php">＋<small>add a note</small></a></span>
