...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokelinecap.php' selected="selected">English</option>
            ...
            <option value='zh/imagickdraw.setstrokelinecap.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setstrokelinecap-examples">
  ...
  <p class="para">
    <div class="example" id="example-3186">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::setStrokeLineCap()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokelinecap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokelinecap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokelinecap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>sudopeople gmail</em></strong></a><a class="genanchor" href="#94198"> &para;</a><div class="date" title="2009-10-21 03:35"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94198">
<div class="phpcode"><code><span class="html">Possible values are:<br /><br />LINEJOIN_UNDEFINED<br />LINEJOIN_MITER<br />LINEJOIN_ROUND<br />LINEJOIN_BEVEL<br /><br />...all prefixed with Imagick:: like:<br /><br />Imagick::LINEJOIN_ROUND</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setstrokelinecap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">＋<small>add a note</small></a></div>
