...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-hidden.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-activation-steepness.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-layer.php">
...
<meta name="Description" content="Sets the steepness of the activation steepness for all neurons in the all hidden layers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_activation_steepness_hidden - Manual" />
<meta name="twitter:description" content="Sets the steepness of the activation steepness for all neurons in the all hidden layers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_activation_steepness_hidden - Manual" />
<meta itemprop="description" content="Sets the steepness of the activation steepness for all neurons in the all hidden layers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the steepness of the activation steepness for all neurons in the all hidden layers" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-activation-steepness-hidden.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.fann-set-activation-steepness-hidden.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-activation-function.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function()</a> - Sets the activation function for supplied neuron and layer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-activation-steepness-hidden.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-activation-steepness-hidden%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-activation-steepness-hidden&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-activation-steepness-hidden.php">＋<small>add a note</small></a></span>
