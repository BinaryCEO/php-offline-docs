...
<head>
  ...
  <title>PHP: trader_ultosc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ultosc.php">
 <link rel="shorturl" href="https://www.php.net/trader-ultosc">
 <link rel="alternate" href="https://www.php.net/trader-ultosc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-typprice.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-var.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ultosc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ultosc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ultosc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ultosc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ultosc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ultosc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ultosc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ultosc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ultosc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ultosc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ultosc.php" hreflang="zh">
...
<meta name="Description" content="Ultimate Oscillator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ultosc - Manual" />
<meta name="twitter:description" content="Ultimate Oscillator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ultosc - Manual" />
<meta itemprop="description" content="Ultimate Oscillator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Ultimate Oscillator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-var.php">
          trader_var &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-typprice.php">
          &laquo; trader_typprice        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ultosc.php' selected="selected">English</option>
            <option value='de/function.trader-ultosc.php'>German</option>
            <option value='es/function.trader-ultosc.php'>Spanish</option>
            <option value='fr/function.trader-ultosc.php'>French</option>
            <option value='it/function.trader-ultosc.php'>Italian</option>
            <option value='ja/function.trader-ultosc.php'>Japanese</option>
            <option value='pt_BR/function.trader-ultosc.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ultosc.php'>Russian</option>
            <option value='tr/function.trader-ultosc.php'>Turkish</option>
            <option value='uk/function.trader-ultosc.php'>Ukrainian</option>
            <option value='zh/function.trader-ultosc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ultosc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_ultosc</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ultosc</span> &mdash; <span class="dc-title">Ultimate Oscillator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-ultosc-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_ultosc</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod1</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod2</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod3</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-ultosc-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">timePeriod1</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">timePeriod2</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">timePeriod3</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ultosc-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ultosc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ultosc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ultosc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ultosc.php">＋<small>add a note</small></a></span>
