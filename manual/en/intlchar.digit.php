...
<head>
  ...
  <title>PHP: IntlChar::digit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.digit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.digit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.digit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.chr.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.enumcharnames.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.digit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.digit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.digit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.digit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.digit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.digit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.digit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.digit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.digit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.digit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.digit.php" hreflang="zh">
...
<meta name="Description" content="Get the decimal digit value of a code point for a given radix" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::digit - Manual" />
<meta name="twitter:description" content="Get the decimal digit value of a code point for a given radix" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::digit - Manual" />
<meta itemprop="description" content="Get the decimal digit value of a code point for a given radix" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the decimal digit value of a code point for a given radix" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.enumcharnames.php">
          IntlChar::enumCharNames &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.chr.php">
          &laquo; IntlChar::chr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.digit.php' selected="selected">English</option>
            <option value='de/intlchar.digit.php'>German</option>
            <option value='es/intlchar.digit.php'>Spanish</option>
            <option value='fr/intlchar.digit.php'>French</option>
            <option value='it/intlchar.digit.php'>Italian</option>
            <option value='ja/intlchar.digit.php'>Japanese</option>
            <option value='pt_BR/intlchar.digit.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.digit.php'>Russian</option>
            <option value='tr/intlchar.digit.php'>Turkish</option>
            <option value='uk/intlchar.digit.php'>Ukrainian</option>
            <option value='zh/intlchar.digit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.digit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::digit</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::digit</span> &mdash; <span class="dc-title">Get the decimal digit value of a code point for a given radix</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.digit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::digit</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$base</code><span class="initializer"> = 10</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span></div>

  <p class="para rdfs-comment">
   Returns the decimal digit value of the code point in the specified radix.
  </p>
  <p class="para">
   If the radix is not in the range <code class="literal">2&lt;=radix&lt;=36</code> or if the value of <code class="parameter">codepoint</code>
   is not a valid digit in the specified radix, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
   A character is a valid digit if at least one of the following is true:
   <ul class="simplelist">
    <li>The character has a decimal digit value. Such characters have the general category "Nd" (decimal digit numbers) and a Numeric_Type of Decimal. In this case the value is the character's decimal digit value.</li>
    <li>The character is one of the uppercase Latin letters 'A' through 'Z'. In this case the value is c-'A'+10.</li>
    <li>The character is one of the lowercase Latin letters 'a' through 'z'. In this case the value is ch-'a'+10.</li>
    <li>Latin letters from both the ASCII range (0061..007A, 0041..005A) as well as from the Fullwidth ASCII range (FF41..FF5A, FF21..FF3A) are recognized.</li>
   </ul>
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.digit-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there is no value or if the value exceeds the radix. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
...
int(10)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.digit-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="intlchar.fordigit.php" class="function" rel="rdfs-seeAlso">IntlChar::forDigit()</a> - Get character representation for a given digit and radix</span></li>
    ...
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-numeric-type">IntlChar::PROPERTY_NUMERIC_TYPE</a></code></strong></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/digit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.digit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.digit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.digit.php">＋<small>add a note</small></a></span>
