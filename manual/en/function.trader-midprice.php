...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-midprice.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-midpoint.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-min.php">
...
<meta name="Description" content="Midpoint Price over period" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_midprice - Manual" />
<meta name="twitter:description" content="Midpoint Price over period" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_midprice - Manual" />
<meta itemprop="description" content="Midpoint Price over period" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Midpoint Price over period" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-midprice.php' selected="selected">English</option>
            <option value='de/function.trader-midprice.php'>German</option>
            <option value='es/function.trader-midprice.php'>Spanish</option>
            <option value='fr/function.trader-midprice.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_midprice</span> &mdash; <span class="dc-title">Midpoint Price over period</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-midprice-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-midprice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-midprice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-midprice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-midprice.php">＋<small>add a note</small></a></span>
