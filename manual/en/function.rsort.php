...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rsort.php">
 <link rel="shorturl" href="https://www.php.net/rsort">
 <link rel="alternate" href="https://www.php.net/rsort" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.reset.php">
 <link rel="next" href="https://www.php.net/manual/en/function.shuffle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rsort.php" hreflang="zh">
...
<meta name="Description" content="Sort an array in descending order" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rsort - Manual" />
<meta name="twitter:description" content="Sort an array in descending order" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rsort - Manual" />
<meta itemprop="description" content="Sort an array in descending order" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort an array in descending order" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rsort.php' selected="selected">English</option>
            <option value='de/function.rsort.php'>German</option>
            <option value='es/function.rsort.php'>Spanish</option>
            <option value='fr/function.rsort.php'>French</option>
            <option value='it/function.rsort.php'>Italian</option>
            <option value='ja/function.rsort.php'>Japanese</option>
            <option value='pt_BR/function.rsort.php'>Brazilian Portuguese</option>
            <option value='ru/function.rsort.php'>Russian</option>
            <option value='tr/function.rsort.php'>Turkish</option>
            <option value='uk/function.rsort.php'>Ukrainian</option>
            <option value='zh/function.rsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">rsort</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">rsort</span> &mdash; <span class="dc-title">Sort an array in descending order</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.rsort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>rsort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="array.constants.php#constant.sort-regular">SORT_REGULAR</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
than just reordering the keys.</span></p></blockquote>
 ...
 <div class="refsect1 changelog" id="refsect1-function.rsort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.rsort-examples">
  ...
  <p class="para">
   <div class="example" id="example-5325">
    <p><strong>Example #1 <span class="function"><strong>rsort()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">0 = orange
1 = lemon
2 = banana
3 = apple</pre>
</div>
  ...
  <ul class="simplelist">
   ...
   <li>The <a href="array.sorting.php" class="link">comparison of array sorting functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/rsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rsort.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="54227">  <div class="votes">
    <div id="Vu54227">
    <a href="/manual/vote-note.php?id=54227&amp;page=function.rsort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54227">
    <a href="/manual/vote-note.php?id=54227&amp;page=function.rsort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54227" title="59% like this...">
    6
    </div>
  </div>
  <a href="#54227" class="name">
  <strong class="user"><em>Alex M</em></strong></a><a class="genanchor" href="#54227"> &para;</a><div class="date" title="2005-06-27 07:39"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54227">
<div class="phpcode"><code><span class="html">A cleaner (I think) way to sort a list of files into reversed order based on their modification date.<br /><br /><span class="default">&lt;?php<br />   $path </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="default">DOCUMENT_ROOT</span><span class="keyword">].</span><span class="string">"/files/"</span><span class="keyword">;<br />   </span><span class="default">$dh </span><span class="keyword">= @</span><span class="default">opendir</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br /><br />   while (</span><span class="default">false </span><span class="keyword">!== (</span><span class="default">$file</span><span class="keyword">=</span><span class="default">readdir</span><span class="keyword">(</span><span class="default">$dh</span><span class="keyword">)))<br />   {<br />      if (</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">)!=</span><span class="string">"."</span><span class="keyword">)<br />         </span><span class="default">$files</span><span class="keyword">[]=array(</span><span class="default">filemtime</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">.</span><span class="default">$file</span><span class="keyword">),</span><span class="default">$file</span><span class="keyword">);   </span><span class="comment">#2-D array<br />   </span><span class="keyword">}<br />   </span><span class="default">closedir</span><span class="keyword">(</span><span class="default">$dh</span><span class="keyword">);<br /><br />   if (</span><span class="default">$files</span><span class="keyword">)<br />   {<br />      </span><span class="default">rsort</span><span class="keyword">(</span><span class="default">$files</span><span class="keyword">); </span><span class="comment">#sorts by filemtime<br /><br />      #done! Show the files sorted by modification date<br />      </span><span class="keyword">foreach (</span><span class="default">$files </span><span class="keyword">as </span><span class="default">$file</span><span class="keyword">)<br />         echo </span><span class="string">"</span><span class="default">$file</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]</span><span class="string"> </span><span class="default">$file</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]</span><span class="string">&lt;br&gt;\n"</span><span class="keyword">;  </span><span class="comment">#file[0]=Unix timestamp; file[1]=filename<br />   </span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="47092">  <div class="votes">
    <div id="Vu47092">
    <a href="/manual/vote-note.php?id=47092&amp;page=function.rsort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd47092">
    <a href="/manual/vote-note.php?id=47092&amp;page=function.rsort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V47092" title="50% like this...">
    1
    </div>
  </div>
  <a href="#47092" class="name">
  <strong class="user"><em>ray at non-aol dot com</em></strong></a><a class="genanchor" href="#47092"> &para;</a><div class="date" title="2004-11-02 07:49"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom47092">
<div class="phpcode"><code><span class="html">Like sort(), rsort() assigns new keys for the elements in array. It will remove any existing keys you may have assigned, rather than just reordering the keys.  This means that it will destroy associative keys.<br /><br />$animals = array("dog"=&gt;"large",  "cat"=&gt;"medium",  "mouse"=&gt;"small");<br />print_r($animals);<br />//Array ( [dog] =&gt; large [cat] =&gt; medium [mouse] =&gt; small )<br /><br />rsort($animals);<br />print_r($animals);<br />//Array ( [0] =&gt; small [1] =&gt; medium [2] =&gt; large ) <br /><br />Use KSORT() or KRSORT() to preserve associative keys.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.rsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rsort.php">＋<small>add a note</small></a></div>
