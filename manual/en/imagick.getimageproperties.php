...
<head>
  ...
  <title>PHP: Imagick::getImageProperties - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageproperties.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageproperties.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageproperties.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageprofiles.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageproperty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageproperties.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageproperties.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageproperties.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageproperties.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageproperties.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageproperties.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageproperties.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageproperties.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageproperties.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageproperties.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageproperties.php" hreflang="zh">
...
<meta name="Description" content="Returns the image properties" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageProperties - Manual" />
<meta name="twitter:description" content="Returns the image properties" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageProperties - Manual" />
<meta itemprop="description" content="Returns the image properties" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image properties" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageproperty.php">
          Imagick::getImageProperty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageprofiles.php">
          &laquo; Imagick::getImageProfiles        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageproperties.php' selected="selected">English</option>
            <option value='de/imagick.getimageproperties.php'>German</option>
            <option value='es/imagick.getimageproperties.php'>Spanish</option>
            <option value='fr/imagick.getimageproperties.php'>French</option>
            <option value='it/imagick.getimageproperties.php'>Italian</option>
            <option value='ja/imagick.getimageproperties.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageproperties.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageproperties.php'>Russian</option>
            <option value='tr/imagick.getimageproperties.php'>Turkish</option>
            <option value='uk/imagick.getimageproperties.php'>Ukrainian</option>
            <option value='zh/imagick.getimageproperties.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageproperties" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageProperties</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageProperties</span> &mdash; <span class="dc-title">Returns the image properties</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageproperties-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageProperties</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code><span class="initializer"> = &quot;*&quot;</span></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$include_values</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong></span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>


  <p class="para rdfs-comment">
   Returns all associated properties that match the pattern. If <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is passed as second parameter
   only the property names are returned. This method is available if Imagick has been compiled against ImageMagick version 6.3.6 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.getimageproperties-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
      Whether to return only property names. If <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> then only property names will be returned.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageproperties-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.getimageproperties-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3013">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::getImageProperties()</strong></span>:</strong></p>
    <div class="example-contents"><p>
     An example of extracting EXIF information.
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Create the object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">"/path/to/example.jpg"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Get the EXIF information */<br /></span><span style="color: #0000BB">$exifArray </span><span style="color: #007700">= </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageProperties</span><span style="color: #007700">(</span><span style="color: #DD0000">"exif:*"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Loop trough the EXIF properties */<br /></span><span style="color: #007700">foreach (</span><span style="color: #0000BB">$exifArray </span><span style="color: #007700">as </span><span style="color: #0000BB">$name </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$property</span><span style="color: #007700">)<br />{<br />    echo </span><span style="color: #DD0000">"</span><span style="color: #007700">{</span><span style="color: #0000BB">$name</span><span style="color: #007700">}</span><span style="color: #DD0000"> =&gt; </span><span style="color: #007700">{</span><span style="color: #0000BB">$property</span><span style="color: #007700">}</span><span style="color: #DD0000">&lt;br /&gt;\n"</span><span style="color: #007700">; <br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageproperties.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageproperties%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageproperties.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108715">  <div class="votes">
    <div id="Vu108715">
    <a href="/manual/vote-note.php?id=108715&amp;page=imagick.getimageproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108715">
    <a href="/manual/vote-note.php?id=108715&amp;page=imagick.getimageproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108715" title="100% like this...">
    1
    </div>
  </div>
  <a href="#108715" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108715"> &para;</a><div class="date" title="2012-05-19 11:29"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108715">
<div class="phpcode"><code><span class="html">The getImageProperties function in PHP returns an array of property keys available for an image.  To get these property values, you use getImageProperty function, giving it one of the available keys provided by the getImageProperties function result.  For some images, you may have a lot of properties and for some, you may have few.  The two that almost every image seems to have are "date:create" and "date:modify", but some images may have forty or more properties, some titled "exif:Compression", "photoshop:Credit", "jpeg:colorspace", "rdf:Alt", "stRef:documentID", and "xap:CreatorTool."  PNG files will also have properties like "png:IHDR.bit_depth" and "png:IHDR.width,height."  So far, it appears generally that GIF and BMP files, being simpler, have fewer properties, whereas JPEG and PNG files, being more complicated, have much wider array of properties.  It seems incredibly useful in document management.<br /><br />And now, some sample code and results :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.png"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Properties<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type_properties </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageProperties</span><span class="keyword">(</span><span class="string">'*'</span><span class="keyword">, </span><span class="default">FALSE</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Print Image Properties<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />        <br />    </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$imagick_type_properties</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Print Each Individual, Image Property<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">foreach(</span><span class="default">$imagick_type_properties </span><span class="keyword">as </span><span class="default">$value</span><span class="keyword">)<br />    {<br />        print(</span><span class="string">"</span><span class="default">$value</span><span class="string"> --- "</span><span class="keyword">);<br />        print(</span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageProperty</span><span class="keyword">(</span><span class="string">"</span><span class="default">$value</span><span class="string">"</span><span class="keyword">));<br />        print(</span><span class="string">"&lt;br&gt;&lt;br&gt;"</span><span class="keyword">);<br />    }<br />                <br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Results of this done on a standard PNG image :<br /><br />Array<br />(<br />    [0] =&gt; date:create<br />    [1] =&gt; date:modify<br />    [2] =&gt; png:cHRM                 <br />    [3] =&gt; png:gAMA                 <br />    [4] =&gt; png:IHDR.bit_depth       <br />    [5] =&gt; png:IHDR.color_type      <br />    [6] =&gt; png:IHDR.interlace_method<br />    [7] =&gt; png:IHDR.width,height    <br />    [8] =&gt; png:sRGB                 <br />)<br />date:create --- 2012-05-19T18:26:45-05:00<br /><br />date:modify --- 2012-05-19T18:26:45-05:00<br /><br />png:cHRM                  --- chunk was found (see Chromaticity, above)<br /><br />png:gAMA                  --- gamma=0.45455 (See Gamma, above)<br /><br />png:IHDR.bit_depth        --- 8<br /><br />png:IHDR.color_type       --- 2<br /><br />png:IHDR.interlace_method --- 0<br /><br />png:IHDR.width,height     --- 320, 320<br /><br />png:sRGB                  --- intent=0 (See Rendering intent)</span></code></div>
  </div>
 </div>
  <div class="note" id="111194">  <div class="votes">
    <div id="Vu111194">
    <a href="/manual/vote-note.php?id=111194&amp;page=imagick.getimageproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111194">
    <a href="/manual/vote-note.php?id=111194&amp;page=imagick.getimageproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111194" title="no votes...">
    0
    </div>
  </div>
  <a href="#111194" class="name">
  <strong class="user"><em>benkuhl at gmail dot com</em></strong></a><a class="genanchor" href="#111194"> &para;</a><div class="date" title="2013-01-24 06:40"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111194">
<div class="phpcode"><code><span class="html">The output of this method on a PDF:<br /><br />Array<br />        (<br />            [date:create] =&gt; 2013-01-24T13:27:37-05:00<br />            [date:modify] =&gt; 2013-01-24T13:27:37-05:00<br />            [pdf:HiResBoundingBox] =&gt; 1089x396+0+0<br />            [pdf:SpotColor-0] =&gt; PANTONE 697 C<br />            [pdf:SpotColor-1] =&gt; Black<br />            [pdf:SpotColor-10] =&gt; PANTONE 504 M C<br />            [pdf:SpotColor-2] =&gt; Strike_Thru<br />            [pdf:SpotColor-3] =&gt; PANTONE 7421 C<br />            [pdf:SpotColor-4] =&gt; PANTONE 697 C<br />            [pdf:SpotColor-5] =&gt; PANTONE 873 C<br />            [pdf:SpotColor-6] =&gt; PANTONE 504 M C<br />            [pdf:SpotColor-7] =&gt; Die<br />            [pdf:SpotColor-8] =&gt; PANTONE 697 C<br />            [pdf:SpotColor-9] =&gt; PANTONE 504 M C<br />            [pdf:Version] =&gt; PDF-1.5<br />            [signature] =&gt; 4d871b27b26537c523326f92454ecb2e19fa9e0e86e2a075f97354ad4f3bf122<br />        )</span></code></div>
  </div>
 </div>
  <div class="note" id="92680">  <div class="votes">
    <div id="Vu92680">
    <a href="/manual/vote-note.php?id=92680&amp;page=imagick.getimageproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92680">
    <a href="/manual/vote-note.php?id=92680&amp;page=imagick.getimageproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92680" title="no votes...">
    0
    </div>
  </div>
  <a href="#92680" class="name">
  <strong class="user"><em>mhufford</em></strong></a><a class="genanchor" href="#92680"> &para;</a><div class="date" title="2009-08-03 02:03"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92680">
<div class="phpcode"><code><span class="html">ImageMagick only supports setting a very small number of EXIF properties.  <br /><br />See <a href="http://www.imagemagick.org/discourse-server/viewtopic.php?t=14234" rel="nofollow" target="_blank">http://www.imagemagick.org/discourse-server/viewtopic.php?t=14234</a></span></code></div>
  </div>
 </div>
  <div class="note" id="105716">  <div class="votes">
    <div id="Vu105716">
    <a href="/manual/vote-note.php?id=105716&amp;page=imagick.getimageproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105716">
    <a href="/manual/vote-note.php?id=105716&amp;page=imagick.getimageproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105716" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#105716" class="name">
  <strong class="user"><em>www dot query at gmail dot com</em></strong></a><a class="genanchor" href="#105716"> &para;</a><div class="date" title="2011-09-08 11:58"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105716">
<div class="phpcode"><code><span class="html">To access a photograph's EXIF data an alternative method is the normal PHP Exif function.<br /><br /><span class="default">&lt;?php<br /><br />        $exif_data </span><span class="keyword">= </span><span class="default">exif_read_data</span><span class="keyword">(</span><span class="default">$pic1</span><span class="keyword">);<br />        </span><span class="default">$edate </span><span class="keyword">= </span><span class="default">$exif_data</span><span class="keyword">[</span><span class="string">'DateTime'</span><span class="keyword">];<br /><br /></span><span class="default">?&gt;<br /></span><br />See: <a href="http://php.net/manual/en/book.exif.php" rel="nofollow" target="_blank">http://php.net/manual/en/book.exif.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageproperties.php">＋<small>add a note</small></a></div>
