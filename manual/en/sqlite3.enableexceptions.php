...
<head>
  ...
  <title>PHP: SQLite3::enableExceptions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/sqlite3.enableexceptions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/sqlite3.enableexceptions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.enableexceptions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.createfunction.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3.escapestring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.enableexceptions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/sqlite3.enableexceptions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/sqlite3.enableexceptions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/sqlite3.enableexceptions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/sqlite3.enableexceptions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/sqlite3.enableexceptions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/sqlite3.enableexceptions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/sqlite3.enableexceptions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/sqlite3.enableexceptions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/sqlite3.enableexceptions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/sqlite3.enableexceptions.php" hreflang="zh">
...
<meta name="Description" content="Enable throwing exceptions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3::enableExceptions - Manual" />
<meta name="twitter:description" content="Enable throwing exceptions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3::enableExceptions - Manual" />
<meta itemprop="description" content="Enable throwing exceptions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enable throwing exceptions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="sqlite3.escapestring.php">
          SQLite3::escapeString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sqlite3.createfunction.php">
          &laquo; SQLite3::createFunction        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/sqlite3.enableexceptions.php' selected="selected">English</option>
            <option value='de/sqlite3.enableexceptions.php'>German</option>
            <option value='es/sqlite3.enableexceptions.php'>Spanish</option>
            <option value='fr/sqlite3.enableexceptions.php'>French</option>
            <option value='it/sqlite3.enableexceptions.php'>Italian</option>
            <option value='ja/sqlite3.enableexceptions.php'>Japanese</option>
            <option value='pt_BR/sqlite3.enableexceptions.php'>Brazilian Portuguese</option>
            <option value='ru/sqlite3.enableexceptions.php'>Russian</option>
            <option value='tr/sqlite3.enableexceptions.php'>Turkish</option>
            <option value='uk/sqlite3.enableexceptions.php'>Ukrainian</option>
            <option value='zh/sqlite3.enableexceptions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="sqlite3.enableexceptions" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-sqlite3.enableexceptions-examples">
  ...
  <div class="example" id="sqlite3.enableexceptions.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>SQLite3::enableExceptions()</strong></span> example</strong></p>
...
Caught exception: near &quot;bar&quot;: syntax error</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3/enableExceptions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsqlite3.enableexceptions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=sqlite3.enableexceptions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.enableexceptions.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123415">  <div class="votes">
    <div id="Vu123415">
    <a href="/manual/vote-note.php?id=123415&amp;page=sqlite3.enableexceptions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123415">
    <a href="/manual/vote-note.php?id=123415&amp;page=sqlite3.enableexceptions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123415" title="90% like this...">
    16
    </div>
  </div>
  <a href="#123415" class="name">
  <strong class="user"><em>Yoann</em></strong></a><a class="genanchor" href="#123415"> &para;</a><div class="date" title="2018-12-11 01:51"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123415">
<div class="phpcode"><code><span class="html">Be sure to note the poorly chosen name and default value.<br /><br />The following snippet does not throw an exception, despite calling a function with the name "enableExceptions" immediately prior to the bad query.<br /><span class="default">&lt;?php<br />$sqlite </span><span class="keyword">= new </span><span class="default">SQLite3</span><span class="keyword">(</span><span class="string">'test.tmp'</span><span class="keyword">);<br /></span><span class="default">$sqlite</span><span class="keyword">-&gt;</span><span class="default">enableExceptions</span><span class="keyword">();<br /></span><span class="default">$sqlite</span><span class="keyword">-&gt;</span><span class="default">exec</span><span class="keyword">(</span><span class="string">'invalid query'</span><span class="keyword">);<br />echo </span><span class="string">'code still running since no exception was thrown'</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Note that this is still error-prone if the passed value is false. One is likely to read "enableExceptions" and ignore the parameter list since the function name conveys a strong (but incorrect) meaning.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=sqlite3.enableexceptions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.enableexceptions.php">＋<small>add a note</small></a></div>
