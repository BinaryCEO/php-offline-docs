...
<head>
  ...
  <title>PHP: ocicollsize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicollsize.php">
 <link rel="shorturl" href="https://www.php.net/ocicollsize">
 <link rel="alternate" href="https://www.php.net/ocicollsize" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicollmax.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicolltrim.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicollsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicollsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicollsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicollsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicollsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicollsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicollsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicollsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicollsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicollsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicollsize.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicollsize - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicollsize - Manual" />
<meta itemprop="description" content="Alias of OCICollection::size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::size" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicollsize.php' selected="selected">English</option>
            <option value='de/function.ocicollsize.php'>German</option>
            <option value='es/function.ocicollsize.php'>Spanish</option>
            <option value='fr/function.ocicollsize.php'>French</option>
            <option value='it/function.ocicollsize.php'>Italian</option>
            <option value='ja/function.ocicollsize.php'>Japanese</option>
            <option value='pt_BR/function.ocicollsize.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicollsize.php'>Russian</option>
            <option value='tr/function.ocicollsize.php'>Turkish</option>
            <option value='uk/function.ocicollsize.php'>Ukrainian</option>
            <option value='zh/function.ocicollsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicollsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicollsize</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicollsize</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.size.php" class="function">OCICollection::size()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicollsize-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.size.php" class="function">OCICollection::size()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicollsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicollsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicollsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicollsize.php">＋<small>add a note</small></a></span>
