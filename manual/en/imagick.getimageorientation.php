...
<head>
  ...
  <title>PHP: Imagick::getImageOrientation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageorientation.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageorientation.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageorientation.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagemimetype.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagepage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageorientation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageorientation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageorientation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageorientation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageorientation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageorientation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageorientation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageorientation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageorientation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageorientation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageorientation.php" hreflang="zh">
...
<meta name="Description" content="Gets the image orientation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageOrientation - Manual" />
<meta name="twitter:description" content="Gets the image orientation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageOrientation - Manual" />
<meta itemprop="description" content="Gets the image orientation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image orientation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagepage.php">
          Imagick::getImagePage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagemimetype.php">
          &laquo; Imagick::getImageMimeType        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageorientation.php' selected="selected">English</option>
            <option value='de/imagick.getimageorientation.php'>German</option>
            <option value='es/imagick.getimageorientation.php'>Spanish</option>
            <option value='fr/imagick.getimageorientation.php'>French</option>
            <option value='it/imagick.getimageorientation.php'>Italian</option>
            <option value='ja/imagick.getimageorientation.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageorientation.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageorientation.php'>Russian</option>
            <option value='tr/imagick.getimageorientation.php'>Turkish</option>
            <option value='uk/imagick.getimageorientation.php'>Ukrainian</option>
            <option value='zh/imagick.getimageorientation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageorientation" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageOrientation</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageOrientation</span> &mdash; <span class="dc-title">Gets the image orientation</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageorientation-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageOrientation</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>


  <p class="para rdfs-comment">
   Gets the image orientation. The return value is one of the <a href="imagick.constants.php#imagick.constants.orientation" class="link">orientation constants</a>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.getimageorientation-parameters">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageorientation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageorientation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageorientation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageorientation.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111448">  <div class="votes">
    <div id="Vu111448">
    <a href="/manual/vote-note.php?id=111448&amp;page=imagick.getimageorientation&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111448">
    <a href="/manual/vote-note.php?id=111448&amp;page=imagick.getimageorientation&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111448" title="86% like this...">
    44
    </div>
  </div>
  <a href="#111448" class="name">
  <strong class="user"><em>orrd101 at yahoo dot com</em></strong></a><a class="genanchor" href="#111448"> &para;</a><div class="date" title="2013-02-20 09:23"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111448">
<div class="phpcode"><code><span class="html">Here's how you can use the getImageOrientation() information to auto-rotate images to their correct orientation...
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="109271">  <div class="votes">
    <div id="Vu109271">
    <a href="/manual/vote-note.php?id=109271&amp;page=imagick.getimageorientation&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109271">
    <a href="/manual/vote-note.php?id=109271&amp;page=imagick.getimageorientation&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109271" title="70% like this...">
    4
    </div>
  </div>
  <a href="#109271" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#109271"> &para;</a><div class="date" title="2012-07-01 02:54"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109271">
<div class="phpcode"><code><span class="html">Using the getImageOrientation function, you'll get the Orientation value for an image as defined within the EXIF file format.  That means you will get back an integer representation one of the Orientation constants for ImageMagick, which looks like " imagick::ORIENTATION_UNDEFINED", with "_VALUE" values of: undefined (0), topleft (1), topright (2), bottomright (3), bottomleft (4), lefttop (5), righttop (6), rightbottom (7), and leftbottom (8).  When printed out directly, these predefined constants produce the number in parenthesis.  The undefined being set to 0 makes sense, since -- according to Wikipedia -- EXIF allows for eight possible values for an image (and not every image has a set of EXIF properties).<br /><br />The EXIF Orientation is also called "the Rotation," again, according to Wikipedia: <a href="http://en.wikipedia.org/wiki/Exchangeable_image_file_format" rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Exchangeable_image_file_format</a> .  What's the point of that?  According to the official ImageMagick documentation, it's to rotate a photograph so that it is properly oriented after the shot.  This really seems to be a camera thing, since the ImageMagick documentation mentions: "If you pointed your camera almost straight up or down, the EXIF orientation setting may not resolve correctly. The same goes for angled or slanted shots. The orientation (and cameras) just have no senses for these situations." ( <a href="http://www.imagemagick.org/Usage/photos/" rel="nofollow" target="_blank">http://www.imagemagick.org/Usage/photos/</a> )<br /><br />If you're having trouble getting this function to show the value for Image Orientation, then use the function and parameters of getImageProperties('*', FALSE); .  This produces an array of all properties associated with an image, and one of them will have the key value of exif:Orientation.  If it doesn't, then that means you will be getting back a zero from this function, indicating an "Undefined" orientation.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.jpg"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Orientation Values<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_orientation </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageOrientation</span><span class="keyword">();<br />    <br />    switch(</span><span class="default">$imagick_orientation</span><span class="keyword">)<br />    {<br />        case </span><span class="string">'0'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Undefined"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'1'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Top-Left"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'2'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Top-Right"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'3'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Bottom-Right"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'4'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Bottom-Left"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'5'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Left-Top"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'6'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Right-Top"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'7'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Right-Bottom"</span><span class="keyword">;<br />            break;<br />        <br />        case </span><span class="string">'8'</span><span class="keyword">:<br />            </span><span class="default">$imagick_orientation_evaluated </span><span class="keyword">= </span><span class="string">"Left-Bottom"</span><span class="keyword">;<br />            break;<br />    }<br />    <br />        </span><span class="comment">// Print Orientation Values<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">print(</span><span class="string">"# </span><span class="default">$imagick_orientation</span><span class="string"> - </span><span class="default">$imagick_orientation_evaluated</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageorientation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageorientation.php">＋<small>add a note</small></a></div>
