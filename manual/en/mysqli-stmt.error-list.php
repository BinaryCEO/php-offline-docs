...
<head>
  ...
  <title>PHP: mysqli_stmt::$error_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.error-list.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.error-list.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.error-list.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.error.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.execute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.error-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-stmt.error-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-stmt.error-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-stmt.error-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-stmt.error-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-stmt.error-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-stmt.error-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-stmt.error-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-stmt.error-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-stmt.error-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-stmt.error-list.php" hreflang="zh">
...
<meta name="Description" content="Returns a list of errors from the last statement executed" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::$error_list - Manual" />
<meta name="twitter:description" content="Returns a list of errors from the last statement executed" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::$error_list - Manual" />
<meta itemprop="description" content="Returns a list of errors from the last statement executed" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a list of errors from the last statement executed" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-stmt.execute.php">
          mysqli_stmt::execute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-stmt.error.php">
          &laquo; mysqli_stmt::$error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.error-list.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.error-list.php'>German</option>
            <option value='es/mysqli-stmt.error-list.php'>Spanish</option>
            <option value='fr/mysqli-stmt.error-list.php'>French</option>
            <option value='it/mysqli-stmt.error-list.php'>Italian</option>
            <option value='ja/mysqli-stmt.error-list.php'>Japanese</option>
            <option value='pt_BR/mysqli-stmt.error-list.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-stmt.error-list.php'>Russian</option>
            <option value='tr/mysqli-stmt.error-list.php'>Turkish</option>
            <option value='uk/mysqli-stmt.error-list.php'>Ukrainian</option>
            <option value='zh/mysqli-stmt.error-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-stmt.error-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli_stmt::$error_list</h1>
  <h1 class="refname">mysqli_stmt_error_list</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_stmt::$error_list</span> -- <span class="refname">mysqli_stmt_error_list</span> &mdash; <span class="dc-title">Returns a list of errors from the last statement executed</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli-stmt.error-list-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <var class="varname"><a href="mysqli-stmt.error-list.php">$mysqli_stmt-&gt;error_list</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_stmt_error_list</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-stmt.php" class="type mysqli_stmt">mysqli_stmt</a></span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli-stmt.error-list-parameters">
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli-stmt.error-list-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-stmt.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_stmt_sqlstate()</a> - Returns SQLSTATE error from previous statement operation</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/error-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.error-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.error-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.error-list.php">＋<small>add a note</small></a></span>
