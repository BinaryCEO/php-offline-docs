...
<head>
  ...
  <title>PHP: Memcached::deleteByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.deletebykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.deletebykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletebykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.delete.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.deletemulti.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.deletebykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.deletebykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.deletebykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.deletebykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.deletebykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.deletebykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.deletebykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.deletebykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.deletebykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.deletebykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.deletebykey.php" hreflang="zh">
...
<meta name="Description" content="Delete an item from a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::deleteByKey - Manual" />
<meta name="twitter:description" content="Delete an item from a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::deleteByKey - Manual" />
<meta itemprop="description" content="Delete an item from a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an item from a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.deletemulti.php">
          Memcached::deleteMulti &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.delete.php">
          &laquo; Memcached::delete        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.deletebykey.php' selected="selected">English</option>
            <option value='de/memcached.deletebykey.php'>German</option>
            <option value='es/memcached.deletebykey.php'>Spanish</option>
            <option value='fr/memcached.deletebykey.php'>French</option>
            <option value='it/memcached.deletebykey.php'>Italian</option>
            <option value='ja/memcached.deletebykey.php'>Japanese</option>
            <option value='pt_BR/memcached.deletebykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.deletebykey.php'>Russian</option>
            <option value='tr/memcached.deletebykey.php'>Turkish</option>
            <option value='uk/memcached.deletebykey.php'>Ukrainian</option>
            <option value='zh/memcached.deletebykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.deletebykey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::deleteByKey</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::deleteByKey</span> &mdash; <span class="dc-title">Delete an item from a specific server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.deletebykey-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::deleteByKey()</strong></span> is functionally equivalent to
   <span class="methodname"><a href="memcached.delete.php" class="methodname">Memcached::delete()</a></span>, except that the free-form
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.deletemultibykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::deleteMultiByKey()</a> - Delete multiple items from a specific server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/deletebykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.deletebykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.deletebykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.deletebykey.php">＋<small>add a note</small></a></span>
