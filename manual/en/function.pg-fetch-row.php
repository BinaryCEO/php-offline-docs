...
<head>
  ...
  <title>PHP: pg_fetch_row - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-fetch-row.php">
 <link rel="shorturl" href="https://www.php.net/pg-fetch-row">
 <link rel="alternate" href="https://www.php.net/pg-fetch-row" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-fetch-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-field-is-null.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-fetch-row.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-fetch-row.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-fetch-row.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-fetch-row.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-fetch-row.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-fetch-row.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-fetch-row.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-fetch-row.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-fetch-row.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-fetch-row.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-fetch-row.php" hreflang="zh">
...
<meta name="Description" content="Get a row as an enumerated array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_fetch_row - Manual" />
<meta name="twitter:description" content="Get a row as an enumerated array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_fetch_row - Manual" />
<meta itemprop="description" content="Get a row as an enumerated array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a row as an enumerated array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-field-is-null.php">
          pg_field_is_null &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-fetch-result.php">
          &laquo; pg_fetch_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-fetch-row.php' selected="selected">English</option>
            <option value='de/function.pg-fetch-row.php'>German</option>
            <option value='es/function.pg-fetch-row.php'>Spanish</option>
            <option value='fr/function.pg-fetch-row.php'>French</option>
            <option value='it/function.pg-fetch-row.php'>Italian</option>
            <option value='ja/function.pg-fetch-row.php'>Japanese</option>
            <option value='pt_BR/function.pg-fetch-row.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-fetch-row.php'>Russian</option>
            <option value='tr/function.pg-fetch-row.php'>Turkish</option>
            <option value='uk/function.pg-fetch-row.php'>Ukrainian</option>
            <option value='zh/function.pg-fetch-row.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-fetch-row" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_fetch_row</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_fetch_row</span> &mdash; <span class="dc-title">Get a row as an enumerated array</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-fetch-row-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_fetch_row</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$row</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = <strong><code><a href="pgsql.constants.php#constant.pgsql-num">PGSQL_NUM</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_fetch_row()</strong></span> fetches one row of data from
   the result associated with the specified <code class="parameter">result</code> instance.
  </p>
...
while <strong><code><a href="pgsql.constants.php#constant.pgsql-both">PGSQL_BOTH</a></code></strong> will return both numerical and associative indices.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-fetch-row-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span>, indexed from 0 upwards, with each value
   represented as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.  Database <code class="literal">NULL</code>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-fetch-result.php" class="function" rel="rdfs-seeAlso">pg_fetch_result()</a> - Returns values from a result instance</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-fetch-row.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="52278">  <div class="votes">
    <div id="Vu52278">
    <a href="/manual/vote-note.php?id=52278&amp;page=function.pg-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd52278">
    <a href="/manual/vote-note.php?id=52278&amp;page=function.pg-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V52278" title="83% like this...">
    4
    </div>
  </div>
  <a href="#52278" class="name">
  <strong class="user"><em>post at zeller-johannes dot de</em></strong></a><a class="genanchor" href="#52278"> &para;</a><div class="date" title="2005-04-26 02:51"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom52278">
<div class="phpcode"><code><span class="html">I wondered whether array values of PostgreSQL are converted to PHP arrays by this functions. This is not the case, they are stored in the returned array as a string in the form "{value1 delimiter value2 delimiter value3}" (See <a href="http://www.postgresql.org/docs/8.0/interactive/arrays.html#AEN5389" rel="nofollow" target="_blank">http://www.postgresql.org/docs/8.0/interactive/arrays.html#AEN5389</a>).</span></code></div>
  </div>
 </div>
  <div class="note" id="67281">  <div class="votes">
    <div id="Vu67281">
    <a href="/manual/vote-note.php?id=67281&amp;page=function.pg-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd67281">
    <a href="/manual/vote-note.php?id=67281&amp;page=function.pg-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V67281" title="58% like this...">
    3
    </div>
  </div>
  <a href="#67281" class="name">
  <strong class="user"><em>pletiplot at seznam dot cz</em></strong></a><a class="genanchor" href="#67281"> &para;</a><div class="date" title="2006-06-06 03:18"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom67281">
<div class="phpcode"><code><span class="html">Note, that when you retrieve some PG boolean value, you get 't' or 'f' characters which are not compatible with PHP bool.</span></code></div>
  </div>
 </div>
  <div class="note" id="93923">  <div class="votes">
    <div id="Vu93923">
    <a href="/manual/vote-note.php?id=93923&amp;page=function.pg-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93923">
    <a href="/manual/vote-note.php?id=93923&amp;page=function.pg-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93923" title="50% like this...">
    0
    </div>
  </div>
  <a href="#93923" class="name">
  <strong class="user"><em>eddie at eddiemonge dot com</em></strong></a><a class="genanchor" href="#93923"> &para;</a><div class="date" title="2009-10-06 05:09"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom93923">
<div class="phpcode"><code><span class="html">pg_fetch_row is faster than pg_fetch_assoc when doing a query with * as the select parameter. Otherwise, with declared columns, the two are similar in speed.</span></code></div>
  </div>
 </div>
  <div class="note" id="32298">  <div class="votes">
    <div id="Vu32298">
    <a href="/manual/vote-note.php?id=32298&amp;page=function.pg-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd32298">
    <a href="/manual/vote-note.php?id=32298&amp;page=function.pg-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V32298" title="45% like this...">
    -1
    </div>
  </div>
  <a href="#32298" class="name">
  <strong class="user"><em>Matthew Wheeler</em></strong></a><a class="genanchor" href="#32298"> &para;</a><div class="date" title="2003-05-22 09:29"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom32298">
<div class="phpcode"><code><span class="html">Note that the internal row counter is incremented BEFORE the row is retrieved. This causes an off by one error if you try to do:<br /><br />pg_result_seek($resid,0);<br />pg_fetch_row($resid);<br /><br />you will get back the SECOND result not the FIRST.</span></code></div>
  </div>
 </div>
  <div class="note" id="14969">  <div class="votes">
    <div id="Vu14969">
    <a href="/manual/vote-note.php?id=14969&amp;page=function.pg-fetch-row&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd14969">
    <a href="/manual/vote-note.php?id=14969&amp;page=function.pg-fetch-row&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V14969" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#14969" class="name">
  <strong class="user"><em>darw75 at swbell dot net</em></strong></a><a class="genanchor" href="#14969"> &para;</a><div class="date" title="2001-08-22 05:39"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom14969">
<div class="phpcode"><code><span class="html">a way to do this with 2 loops to insert data into a table...
<br />
<br />$num = pg_numrows($result);
<br />$col_num = pg_numfields($result);
<br />
<br />for ($i=0; $i&lt;$num; $i++) {
<br />  $line  = pg_fetch_array($result, $i, PGSQL_ASSOC);
<br />  print "\t&lt;tr bgcolor=#dddddd&gt;\n";
<br />    for ($j=0; $j&lt;$col_num; $j++){
<br />    list($col_name, $col_value) =each($line);
<br />    print "\t\t&lt;TD ALIGN=RIGHT&gt;&lt;FONT SIZE=1 FACE='Geneva'&gt;$col_value&lt;/FONT&gt;&lt;/TD&gt;\n";
<br />    }
<br />  echo "&lt;br&gt;";
<br />  }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-fetch-row.php">＋<small>add a note</small></a></div>
