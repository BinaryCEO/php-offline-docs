...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.stripimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.stripimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.stripimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.stereoimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.subimagematch.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.stripimage.php' selected="selected">English</option>
            <option value='de/imagick.stripimage.php'>German</option>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/stripimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.stripimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.stripimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.stripimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">StripImage also delete ICC image profile by default.<br />The resulting images seem to lose a lot of color information and look "flat" compared to their non-stripped versions.<br /><br />Consider keeping the ICC profile (which causes richer colors) while removing all other EXIF data:<br /><br />1. Extract the ICC profile<br />2. Strip EXIF data and image profile<br />3. Add the ICC profile back<br /><br />The code is:<br /><span class="default">&lt;?php<br />$profiles </span><span class="keyword">= </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">getImageProfiles</span><span class="keyword">(</span><span class="string">"icc"</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">stripImage</span><span class="keyword">();<br /><br />if(!empty(</span><span class="default">$profiles</span><span class="keyword">))<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">profileImage</span><span class="keyword">(</span><span class="string">"icc"</span><span class="keyword">, </span><span class="default">$profiles</span><span class="keyword">[</span><span class="string">'icc'</span><span class="keyword">]);<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>g dot a dot karthikeyan at gmail dot com</em></strong></a><a class="genanchor" href="#113964"> &para;</a><div class="date" title="2013-12-23 07:09"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113964">
<div class="phpcode"><code><span class="html">Please note that striping off the exif information without handling the orientation information available in the exif will lead to wrong orientation of the image</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">this will actually clear exif data so if you run an image uploading script with privacy concerns, this will effectively clear all GPS / metadata from the image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.stripimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.stripimage.php">＋<small>add a note</small></a></div>
