...
<head>
  ...
  <title>PHP: ocicolumntyperaw - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicolumntyperaw.php">
 <link rel="shorturl" href="https://www.php.net/ocicolumntyperaw">
 <link rel="alternate" href="https://www.php.net/ocicolumntyperaw" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicolumntype.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicommit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicolumntyperaw.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicolumntyperaw.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicolumntyperaw.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicolumntyperaw.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicolumntyperaw.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicolumntyperaw.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicolumntyperaw.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicolumntyperaw.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicolumntyperaw.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicolumntyperaw.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicolumntyperaw.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_field_type_raw" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicolumntyperaw - Manual" />
<meta name="twitter:description" content="Alias of oci_field_type_raw" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicolumntyperaw - Manual" />
<meta itemprop="description" content="Alias of oci_field_type_raw" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_field_type_raw" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocicommit.php">
          ocicommit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicolumntype.php">
          &laquo; ocicolumntype        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicolumntyperaw.php' selected="selected">English</option>
            <option value='de/function.ocicolumntyperaw.php'>German</option>
            <option value='es/function.ocicolumntyperaw.php'>Spanish</option>
            <option value='fr/function.ocicolumntyperaw.php'>French</option>
            <option value='it/function.ocicolumntyperaw.php'>Italian</option>
            <option value='ja/function.ocicolumntyperaw.php'>Japanese</option>
            <option value='pt_BR/function.ocicolumntyperaw.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicolumntyperaw.php'>Russian</option>
            <option value='tr/function.ocicolumntyperaw.php'>Turkish</option>
            <option value='uk/function.ocicolumntyperaw.php'>Ukrainian</option>
            <option value='zh/function.ocicolumntyperaw.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicolumntyperaw" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicolumntyperaw</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicolumntyperaw</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-field-type-raw.php" class="function">oci_field_type_raw()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicolumntyperaw-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-field-type-raw.php" class="function">oci_field_type_raw()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicolumntyperaw.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicolumntyperaw%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicolumntyperaw&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicolumntyperaw.php">＋<small>add a note</small></a></span>
