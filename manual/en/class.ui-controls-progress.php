...
<head>
  ...
  <title>PHP: UI\Controls\Progress - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-controls-progress.php">
 <link rel="shorturl" href="https://www.php.net/ui-controls-progress">
 <link rel="alternate" href="https://www.php.net/ui-controls-progress" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-controls-slider.setvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-controls-progress.getvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-controls-progress.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-controls-progress.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-controls-progress.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-controls-progress.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-controls-progress.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-controls-progress.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-controls-progress.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-controls-progress.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-controls-progress.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-controls-progress.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-controls-progress.php" hreflang="zh">
...
<meta name="Description" content="Progress Control" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Controls\Progress - Manual" />
<meta name="twitter:description" content="Progress Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Controls\Progress - Manual" />
<meta itemprop="description" content="Progress Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Progress Control" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-controls-progress.getvalue.php">
          UI\Controls\Progress::getValue &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-controls-slider.setvalue.php">
          &laquo; UI\Controls\Slider::setValue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-controls-progress.php' selected="selected">English</option>
            <option value='de/class.ui-controls-progress.php'>German</option>
            <option value='es/class.ui-controls-progress.php'>Spanish</option>
            <option value='fr/class.ui-controls-progress.php'>French</option>
            <option value='it/class.ui-controls-progress.php'>Italian</option>
            <option value='ja/class.ui-controls-progress.php'>Japanese</option>
            <option value='pt_BR/class.ui-controls-progress.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-controls-progress.php'>Russian</option>
            <option value='tr/class.ui-controls-progress.php'>Turkish</option>
            <option value='uk/class.ui-controls-progress.php'>Ukrainian</option>
            <option value='zh/class.ui-controls-progress.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-controls-progress" class="reference">

 <h1 class="title">Progress Control</h1>
 

 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>


  <div class="section" id="ui-controls-progress.intro">
  ...
  <div class="section" id="ui-controls-progress.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Controls\Progress</strong>
     </span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-controls-progress.getvalue.php" class="methodname">getValue</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-controls-progress.setvalue.php" class="methodname">setValue</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-controls-progress.getvalue.php">UI\Controls\Progress::getValue</a> — Get Value</li><li><a href="ui-controls-progress.setvalue.php">UI\Controls\Progress::setValue</a> — Set Value</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.controls.progress.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-controls-progress%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-controls-progress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-controls-progress.php">＋<small>add a note</small></a></span>
