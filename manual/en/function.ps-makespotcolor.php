...
<head>
  ...
  <title>PHP: ps_makespotcolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-makespotcolor.php">
 <link rel="shorturl" href="https://www.php.net/ps-makespotcolor">
 <link rel="alternate" href="https://www.php.net/ps-makespotcolor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-lineto.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-moveto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-makespotcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-makespotcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-makespotcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-makespotcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-makespotcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-makespotcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-makespotcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-makespotcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-makespotcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-makespotcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-makespotcolor.php" hreflang="zh">
...
<meta name="Description" content="Create spot color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_makespotcolor - Manual" />
<meta name="twitter:description" content="Create spot color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_makespotcolor - Manual" />
<meta itemprop="description" content="Create spot color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create spot color" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-makespotcolor.php' selected="selected">English</option>
            <option value='de/function.ps-makespotcolor.php'>German</option>
            <option value='es/function.ps-makespotcolor.php'>Spanish</option>
            <option value='fr/function.ps-makespotcolor.php'>French</option>
            <option value='it/function.ps-makespotcolor.php'>Italian</option>
            <option value='ja/function.ps-makespotcolor.php'>Japanese</option>
            <option value='pt_BR/function.ps-makespotcolor.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-makespotcolor.php'>Russian</option>
            <option value='tr/function.ps-makespotcolor.php'>Turkish</option>
            <option value='uk/function.ps-makespotcolor.php'>Ukrainian</option>
            <option value='zh/function.ps-makespotcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-makespotcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_makespotcolor</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_makespotcolor</span> &mdash; <span class="dc-title">Create spot color</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ps-makespotcolor-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.ps-setcolor.php" class="function">ps_setcolor()</a></span>. When the document is not printed
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-setcolor.php" class="function" rel="rdfs-seeAlso">ps_setcolor()</a> - Sets current color</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-makespotcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-makespotcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-makespotcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-makespotcolor.php">＋<small>add a note</small></a></span>
