...
<head>
  ...
  <title>PHP: com_get_active_object - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.com-get-active-object.php">
 <link rel="shorturl" href="https://www.php.net/com-get-active-object">
 <link rel="alternate" href="https://www.php.net/com-get-active-object" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.com-event-sink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.com-load-typelib.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.com-get-active-object.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.com-get-active-object.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.com-get-active-object.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.com-get-active-object.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.com-get-active-object.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.com-get-active-object.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.com-get-active-object.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.com-get-active-object.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.com-get-active-object.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.com-get-active-object.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.com-get-active-object.php" hreflang="zh">
...
<meta name="Description" content="Returns a handle to an already running instance of a COM object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: com_get_active_object - Manual" />
<meta name="twitter:description" content="Returns a handle to an already running instance of a COM object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: com_get_active_object - Manual" />
<meta itemprop="description" content="Returns a handle to an already running instance of a COM object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a handle to an already running instance of a COM object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.com-load-typelib.php">
          com_load_typelib &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.com-event-sink.php">
          &laquo; com_event_sink        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.com-get-active-object.php' selected="selected">English</option>
            <option value='de/function.com-get-active-object.php'>German</option>
            <option value='es/function.com-get-active-object.php'>Spanish</option>
            <option value='fr/function.com-get-active-object.php'>French</option>
            <option value='it/function.com-get-active-object.php'>Italian</option>
            <option value='ja/function.com-get-active-object.php'>Japanese</option>
            <option value='pt_BR/function.com-get-active-object.php'>Brazilian Portuguese</option>
            <option value='ru/function.com-get-active-object.php'>Russian</option>
            <option value='tr/function.com-get-active-object.php'>Turkish</option>
            <option value='uk/function.com-get-active-object.php'>Ukrainian</option>
            <option value='zh/function.com-get-active-object.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.com-get-active-object" class="refentry">
   ...
   <p class="para">
    ...
    involved.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/com-get-active-object.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.com-get-active-object%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.com-get-active-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.com-get-active-object.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="87981">  <div class="votes">
    <div id="Vu87981">
    <a href="/manual/vote-note.php?id=87981&amp;page=function.com-get-active-object&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87981">
    <a href="/manual/vote-note.php?id=87981&amp;page=function.com-get-active-object&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87981" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#87981" class="name">
  <strong class="user"><em>gerrit at timingteam dot nl</em></strong></a><a class="genanchor" href="#87981"> &para;</a><div class="date" title="2009-01-04 09:25"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87981">
<div class="phpcode"><code><span class="html">Please note the next behavior (Apache 2.2.8, W2K, WXP)<br /><br />If Apache runs as a service, com_get_active_object() always returns MK_E_UNAVAILABLE, even when it is definitely sure that the Running Object Table contains a reference to the required object.<br /><br />If Apache runs in a console, com_get_active_object()  returns the object handle as required.<br /><br />This apparently is a Windows issue.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.com-get-active-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.com-get-active-object.php">＋<small>add a note</small></a></div>
