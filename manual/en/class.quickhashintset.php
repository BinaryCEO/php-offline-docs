...
<head>
  ...
  <title>PHP: QuickHashIntSet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.quickhashintset.php">
 <link rel="shorturl" href="https://www.php.net/quickhashintset">
 <link rel="alternate" href="https://www.php.net/quickhashintset" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.quickhash.php">
 <link rel="prev" href="https://www.php.net/manual/en/quickhash.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/quickhashintset.add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.quickhashintset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.quickhashintset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.quickhashintset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.quickhashintset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.quickhashintset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.quickhashintset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.quickhashintset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.quickhashintset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.quickhashintset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.quickhashintset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.quickhashintset.php" hreflang="zh">
...
<meta name="Description" content="The QuickHashIntSet class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: QuickHashIntSet - Manual" />
<meta name="twitter:description" content="The QuickHashIntSet class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: QuickHashIntSet - Manual" />
<meta itemprop="description" content="The QuickHashIntSet class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The QuickHashIntSet class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="quickhashintset.add.php">
          QuickHashIntSet::add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="quickhash.examples.php">
          &laquo; Examples        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.quickhashintset.php' selected="selected">English</option>
            <option value='de/class.quickhashintset.php'>German</option>
            <option value='es/class.quickhashintset.php'>Spanish</option>
            <option value='fr/class.quickhashintset.php'>French</option>
            <option value='it/class.quickhashintset.php'>Italian</option>
            <option value='ja/class.quickhashintset.php'>Japanese</option>
            <option value='pt_BR/class.quickhashintset.php'>Brazilian Portuguese</option>
            <option value='ru/class.quickhashintset.php'>Russian</option>
            <option value='tr/class.quickhashintset.php'>Turkish</option>
            <option value='uk/class.quickhashintset.php'>Ukrainian</option>
            <option value='zh/class.quickhashintset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.quickhashintset" class="reference">

 <h1 class="title">The QuickHashIntSet class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PECL quickhash &gt;= Unknown)</p>
  ...
  <div class="section" id="quickhashintset.intro">
   ...
   <p class="para">
    Sets can also be iterated over with <a href="control-structures.foreach.php" class="link"><code class="literal">foreach</code></a> as the <span class="interfacename"><a href="class.iterator.php" class="interfacename">Iterator</a></span> interface is
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="quickhashintset.savetostring.php" class="methodname">saveToString</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <div class="section" id="quickhashintset.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">If enabled, adding duplicate elements to a set (through either <span class="methodname"><a href="quickhashintset.add.php" class="methodname">QuickHashIntSet::add()</a></span> or
      <span class="methodname"><a href="quickhashintset.loadfromfile.php" class="methodname">QuickHashIntSet::loadFromFile()</a></span>) will result in those elements to be dropped from the
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="quickhashintset.add.php">QuickHashIntSet::add</a> — This method adds a new entry to the set</li><li><a href="quickhashintset.construct.php">QuickHashIntSet::__construct</a> — Creates a new QuickHashIntSet object</li><li><a href="quickhashintset.delete.php">QuickHashIntSet::delete</a> — This method deletes an entry from the set</li><li><a href="quickhashintset.exists.php">QuickHashIntSet::exists</a> — This method checks whether a key is part of the set</li><li><a href="quickhashintset.getsize.php">QuickHashIntSet::getSize</a> — Returns the number of elements in the set</li><li><a href="quickhashintset.loadfromfile.php">QuickHashIntSet::loadFromFile</a> — This factory method creates a set from a file</li><li><a href="quickhashintset.loadfromstring.php">QuickHashIntSet::loadFromString</a> — This factory method creates a set from a string</li><li><a href="quickhashintset.savetofile.php">QuickHashIntSet::saveToFile</a> — This method stores an in-memory set to disk</li><li><a href="quickhashintset.savetostring.php">QuickHashIntSet::saveToString</a> — This method returns a serialized version of the set</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/quickhash/quickhashintset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.quickhashintset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.quickhashintset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.quickhashintset.php">＋<small>add a note</small></a></span>
