...
<head>
  ...
  <title>PHP: DOMElement::setAttributeNS - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domelement.setattributens.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domelement.setattributens.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domelement.setattributens.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domelement.php">
 <link rel="prev" href="https://www.php.net/manual/en/domelement.setattributenodens.php">
 <link rel="next" href="https://www.php.net/manual/en/domelement.setidattribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domelement.setattributens.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domelement.setattributens.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domelement.setattributens.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domelement.setattributens.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domelement.setattributens.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domelement.setattributens.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domelement.setattributens.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domelement.setattributens.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domelement.setattributens.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domelement.setattributens.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domelement.setattributens.php" hreflang="zh">
...
<meta name="Description" content="Adds new attribute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMElement::setAttributeNS - Manual" />
<meta name="twitter:description" content="Adds new attribute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMElement::setAttributeNS - Manual" />
<meta itemprop="description" content="Adds new attribute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds new attribute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domelement.setidattribute.php">
          DOMElement::setIdAttribute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domelement.setattributenodens.php">
          &laquo; DOMElement::setAttributeNodeNS        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domelement.setattributens.php' selected="selected">English</option>
            <option value='de/domelement.setattributens.php'>German</option>
            <option value='es/domelement.setattributens.php'>Spanish</option>
            <option value='fr/domelement.setattributens.php'>French</option>
            <option value='it/domelement.setattributens.php'>Italian</option>
            <option value='ja/domelement.setattributens.php'>Japanese</option>
            <option value='pt_BR/domelement.setattributens.php'>Brazilian Portuguese</option>
            <option value='ru/domelement.setattributens.php'>Russian</option>
            <option value='tr/domelement.setattributens.php'>Turkish</option>
            <option value='uk/domelement.setattributens.php'>Ukrainian</option>
            <option value='zh/domelement.setattributens.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domelement.setattributens" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domelement.removeattributens.php" class="methodname" rel="rdfs-seeAlso">DOMElement::removeAttributeNS()</a> - Removes attribute</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domelement/setattributens.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomelement.setattributens%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domelement.setattributens&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domelement.setattributens.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104032">  <div class="votes">
    <div id="Vu104032">
    <a href="/manual/vote-note.php?id=104032&amp;page=domelement.setattributens&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104032">
    <a href="/manual/vote-note.php?id=104032&amp;page=domelement.setattributens&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104032" title="63% like this...">
    5
    </div>
  </div>
  <a href="#104032" class="name">
  <strong class="user"><em>catalinenache78 at gmail dot com</em></strong></a><a class="genanchor" href="#104032"> &para;</a><div class="date" title="2011-05-18 07:39"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104032">
<div class="phpcode"><code><span class="html">To add new brand xml namespace use:<br /><br /><span class="default">&lt;?php<br />    $element</span><span class="keyword">-&gt;</span><span class="default">setAttributeNS</span><span class="keyword">(<br />        </span><span class="string">'<a href="http://www.w3.org/2000/xmlns/" rel="nofollow" target="_blank">http://www.w3.org/2000/xmlns/</a>'</span><span class="keyword">, </span><span class="comment">// xmlns namespace URI<br />        </span><span class="string">'xmlns:mynamespace'</span><span class="keyword">,<br />        </span><span class="string">'example.com/mynamespace'<br />    </span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />'<a href="http://www.w3.org/2000/xmlns/" rel="nofollow" target="_blank">http://www.w3.org/2000/xmlns/</a>' URI is important<br />to be able to add  new namespaces !!!<br /><br />Later you can use your namespace like:<br /><br /><span class="default">&lt;?php<br />    $element</span><span class="keyword">-&gt;</span><span class="default">setAttributeNS</span><span class="keyword">(<br />        </span><span class="string">'example.com/mynamespace'</span><span class="keyword">,<br />        </span><span class="string">'mynamespace:something'</span><span class="keyword">, <br />        </span><span class="string">'value'<br />    </span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=domelement.setattributens&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domelement.setattributens.php">＋<small>add a note</small></a></div>
