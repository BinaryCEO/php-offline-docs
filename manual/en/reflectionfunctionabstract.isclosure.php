...
<head>
  ...
  <title>PHP: ReflectionFunctionAbstract::isClosure - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.isclosure.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.isclosure.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.isclosure.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.innamespace.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.isdeprecated.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.isclosure.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionfunctionabstract.isclosure.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionfunctionabstract.isclosure.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionfunctionabstract.isclosure.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionfunctionabstract.isclosure.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionfunctionabstract.isclosure.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionfunctionabstract.isclosure.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionfunctionabstract.isclosure.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionfunctionabstract.isclosure.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionfunctionabstract.isclosure.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionfunctionabstract.isclosure.php" hreflang="zh">
...
<meta name="Description" content="Checks if closure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::isClosure - Manual" />
<meta name="twitter:description" content="Checks if closure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::isClosure - Manual" />
<meta itemprop="description" content="Checks if closure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if closure" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionfunctionabstract.isdeprecated.php">
          ReflectionFunctionAbstract::isDeprecated &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionfunctionabstract.innamespace.php">
          &laquo; ReflectionFunctionAbstract::inNamespace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.isclosure.php' selected="selected">English</option>
            <option value='de/reflectionfunctionabstract.isclosure.php'>German</option>
            <option value='es/reflectionfunctionabstract.isclosure.php'>Spanish</option>
            <option value='fr/reflectionfunctionabstract.isclosure.php'>French</option>
            <option value='it/reflectionfunctionabstract.isclosure.php'>Italian</option>
            <option value='ja/reflectionfunctionabstract.isclosure.php'>Japanese</option>
            <option value='pt_BR/reflectionfunctionabstract.isclosure.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionfunctionabstract.isclosure.php'>Russian</option>
            <option value='tr/reflectionfunctionabstract.isclosure.php'>Turkish</option>
            <option value='uk/reflectionfunctionabstract.isclosure.php'>Ukrainian</option>
            <option value='zh/reflectionfunctionabstract.isclosure.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionfunctionabstract.isclosure" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionFunctionAbstract::isClosure</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionFunctionAbstract::isClosure</span> &mdash; <span class="dc-title">Checks if closure</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionfunctionabstract.isclosure-description">
  ...
  <p class="para rdfs-comment">
   Checks whether the reflected function is a <span class="classname"><a href="class.closure.php" class="classname">Closure</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionfunctionabstract.isclosure-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the function is a <span class="classname"><a href="class.closure.php" class="classname">Closure</a></span>, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionfunctionabstract.isclosure-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionfunctionabstract.isgenerator.php" class="methodname" rel="rdfs-seeAlso">ReflectionFunctionAbstract::isGenerator()</a> - Returns whether this function is a generator</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/isclosure.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.isclosure%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.isclosure&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.isclosure.php">＋<small>add a note</small></a></span>
