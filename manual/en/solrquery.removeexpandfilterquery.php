...
<head>
  ...
  <title>PHP: SolrQuery::removeExpandFilterQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettimeallowed.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removeexpandfilterquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removeexpandfilterquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removeexpandfilterquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removeexpandfilterquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removeexpandfilterquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removeexpandfilterquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removeexpandfilterquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removeexpandfilterquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removeexpandfilterquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removeexpandfilterquery.php" hreflang="zh">
...
<meta name="Description" content="Removes an expand filter query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeExpandFilterQuery - Manual" />
<meta name="twitter:description" content="Removes an expand filter query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeExpandFilterQuery - Manual" />
<meta itemprop="description" content="Removes an expand filter query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes an expand filter query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.removeexpandsortfield.php">
          SolrQuery::removeExpandSortField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettimeallowed.php">
          &laquo; SolrQuery::getTimeAllowed        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removeexpandfilterquery.php' selected="selected">English</option>
            <option value='de/solrquery.removeexpandfilterquery.php'>German</option>
            <option value='es/solrquery.removeexpandfilterquery.php'>Spanish</option>
            <option value='fr/solrquery.removeexpandfilterquery.php'>French</option>
            <option value='it/solrquery.removeexpandfilterquery.php'>Italian</option>
            <option value='ja/solrquery.removeexpandfilterquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.removeexpandfilterquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removeexpandfilterquery.php'>Russian</option>
            <option value='tr/solrquery.removeexpandfilterquery.php'>Turkish</option>
            <option value='uk/solrquery.removeexpandfilterquery.php'>Ukrainian</option>
            <option value='zh/solrquery.removeexpandfilterquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removeexpandfilterquery" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.addexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::addExpandFilterQuery()</a> - Overrides main filter query, determines which documents to include in the main group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removeexpandfilterquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removeexpandfilterquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removeexpandfilterquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removeexpandfilterquery.php">＋<small>add a note</small></a></span>
