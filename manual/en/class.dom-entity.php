...
<head>
  ...
  <title>PHP: Dom\Entity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-entity.php">
 <link rel="shorturl" href="https://www.php.net/dom-entity">
 <link rel="alternate" href="https://www.php.net/dom-entity" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-element.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-entityreference.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-entity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-entity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-entity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-entity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-entity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-entity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-entity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-entity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-entity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-entity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-entity.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Entity class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Entity - Manual" />
<meta name="twitter:description" content="The Dom\Entity class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Entity - Manual" />
<meta itemprop="description" content="The Dom\Entity class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Entity class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-entityreference.php">
          Dom\EntityReference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-element.php">
          &laquo; Dom\Element        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-entity.php' selected="selected">English</option>
            <option value='de/class.dom-entity.php'>German</option>
            <option value='es/class.dom-entity.php'>Spanish</option>
            <option value='fr/class.dom-entity.php'>French</option>
            <option value='it/class.dom-entity.php'>Italian</option>
            <option value='ja/class.dom-entity.php'>Japanese</option>
            <option value='pt_BR/class.dom-entity.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-entity.php'>Russian</option>
            <option value='tr/class.dom-entity.php'>Turkish</option>
            <option value='uk/class.dom-entity.php'>Ukrainian</option>
            <option value='zh/class.dom-entity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-entity" class="reference">
 <h1 class="title">The Dom\Entity class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  <div class="section" id="dom-entity.intro">
   <h2 class="title">Introduction</h2><p class="para">
    This interface represents a known entity, either parsed or unparsed, in an XML document.
   </p>
   <p class="simpara">
    This is the modern, spec-compliant equivalent of
    <span class="classname"><a href="class.domentity.php" class="classname">DOMEntity</a></span>.
   </p>
  </div>

  <div class="section" id="dom-entity.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Entity</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-entity.php#dom-entity.props.publicid">$<var class="varname">publicId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-entity.php#dom-entity.props.systemid">$<var class="varname">systemId</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">readonly</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-entity.php#dom-entity.props.notationname">$<var class="varname">notationName</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
  ...
  <div class="section" id="dom-entity.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-entity.props.publicid"><var class="varname">publicId</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-entity.props.systemid"><var class="varname">systemId</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-entity.props.notationname"><var class="varname">notationName</var></dt><dd>
      <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-entity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-entity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-entity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-entity.php">＋<small>add a note</small></a></span>
