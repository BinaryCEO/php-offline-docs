...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-sarprop-step-error-threshold-factor.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-sarprop-step-error-shift.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-sarprop-temperature.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-sarprop-step-error-threshold-factor.php' selected="selected">English</option>
            <option value='de/function.fann-get-sarprop-step-error-threshold-factor.php'>German</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-sarprop-step-error-threshold-factor.php" class="function" rel="rdfs-seeAlso">fann_set_sarprop_step_error_threshold_factor()</a> - Sets the sarprop step error threshold factor</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-sarprop-step-error-threshold-factor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-sarprop-step-error-threshold-factor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-sarprop-step-error-threshold-factor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-sarprop-step-error-threshold-factor.php">＋<small>add a note</small></a></span>
