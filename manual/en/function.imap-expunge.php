...
<head>
  ...
  <title>PHP: imap_expunge - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-expunge.php">
 <link rel="shorturl" href="https://www.php.net/imap-expunge">
 <link rel="alternate" href="https://www.php.net/imap-expunge" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-errors.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-fetch-overview.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-expunge.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-expunge.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-expunge.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-expunge.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-expunge.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-expunge.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-expunge.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-expunge.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-expunge.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-expunge.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-expunge.php" hreflang="zh">
...
<meta name="Description" content="Delete all messages marked for deletion" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_expunge - Manual" />
<meta name="twitter:description" content="Delete all messages marked for deletion" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_expunge - Manual" />
<meta itemprop="description" content="Delete all messages marked for deletion" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete all messages marked for deletion" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-expunge.php' selected="selected">English</option>
            <option value='de/function.imap-expunge.php'>German</option>
            <option value='es/function.imap-expunge.php'>Spanish</option>
            <option value='fr/function.imap-expunge.php'>French</option>
            <option value='it/function.imap-expunge.php'>Italian</option>
            <option value='ja/function.imap-expunge.php'>Japanese</option>
            <option value='pt_BR/function.imap-expunge.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-expunge.php'>Russian</option>
            <option value='tr/function.imap-expunge.php'>Turkish</option>
            <option value='uk/function.imap-expunge.php'>Ukrainian</option>
            <option value='zh/function.imap-expunge.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-expunge" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-expunge.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-expunge%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-expunge&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-expunge.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="60626">  <div class="votes">
    <div id="Vu60626">
    <a href="/manual/vote-note.php?id=60626&amp;page=function.imap-expunge&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd60626">
    <a href="/manual/vote-note.php?id=60626&amp;page=function.imap-expunge&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V60626" title="63% like this...">
    11
    </div>
  </div>
  <a href="#60626" class="name">
  <strong class="user"><em>boswachter at xs4all dot nl</em></strong></a><a class="genanchor" href="#60626"> &para;</a><div class="date" title="2006-01-12 07:57"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60626">
<div class="phpcode"><code><span class="html">You shouldn't call imap_expunge until before closing the connection. imap_delete tags a message for deletion, imap_expunge deletes all tagged messages. i.e.:
<br />for ($i = 0; $i &lt; $num; $i++) {
<br />  imap_delete($box, $i);
<br />}
<br />imap_expunge($box);
<br />
<br />imap_expunge should not be in your inner loop.</span></code></div>
  </div>
 </div>
  <div class="note" id="119264">  <div class="votes">
    <div id="Vu119264">
    <a href="/manual/vote-note.php?id=119264&amp;page=function.imap-expunge&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119264">
    <a href="/manual/vote-note.php?id=119264&amp;page=function.imap-expunge&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119264" title="70% like this...">
    4
    </div>
  </div>
  <a href="#119264" class="name">
  <strong class="user"><em>Pavel Cernik</em></strong></a><a class="genanchor" href="#119264"> &para;</a><div class="date" title="2016-04-29 02:44"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119264">
<div class="phpcode"><code><span class="html">imap_expunge() may change order of messages which were loaded using imap_sort(). <br />That means, if you use foreach() on result of imap_sort() function and each pass you move/delete a message and instantly expunge them, next cycle, messages will have different numbers than imap_sort() returned and the script will fail.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-expunge&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-expunge.php">＋<small>add a note</small></a></div>
