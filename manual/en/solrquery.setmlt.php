...
<head>
  ...
  <title>PHP: SolrQuery::setMlt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmlt.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmlt.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmlt.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltboost.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmlt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmlt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmlt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmlt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmlt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmlt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmlt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmlt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmlt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmlt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmlt.php" hreflang="zh">
...
<meta name="Description" content="Enables or disables moreLikeThis" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMlt - Manual" />
<meta name="twitter:description" content="Enables or disables moreLikeThis" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMlt - Manual" />
<meta itemprop="description" content="Enables or disables moreLikeThis" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enables or disables moreLikeThis" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setmltboost.php">
          SolrQuery::setMltBoost &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightusephrasehighlighter.php">
          &laquo; SolrQuery::setHighlightUsePhraseHighlighter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmlt.php' selected="selected">English</option>
            <option value='de/solrquery.setmlt.php'>German</option>
            <option value='es/solrquery.setmlt.php'>Spanish</option>
            <option value='fr/solrquery.setmlt.php'>French</option>
            <option value='it/solrquery.setmlt.php'>Italian</option>
            <option value='ja/solrquery.setmlt.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmlt.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmlt.php'>Russian</option>
            <option value='tr/solrquery.setmlt.php'>Turkish</option>
            <option value='uk/solrquery.setmlt.php'>Ukrainian</option>
            <option value='zh/solrquery.setmlt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmlt" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-solrquery.setmlt-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMlt</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmlt-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> enables it and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> turns it off.
      </p>
     </dd>
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmlt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmlt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmlt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmlt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100986">  <div class="votes">
    <div id="Vu100986">
    <a href="/manual/vote-note.php?id=100986&amp;page=solrquery.setmlt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100986">
    <a href="/manual/vote-note.php?id=100986&amp;page=solrquery.setmlt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100986" title="no votes...">
    0
    </div>
  </div>
  <a href="#100986" class="name">
  <strong class="user"><em>duerra at nospam dot yahoo dot com</em></strong></a><a class="genanchor" href="#100986"> &para;</a><div class="date" title="2010-11-18 04:34"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100986">
<div class="phpcode"><code><span class="html">Note that currently, if enabling MLT results in Solr, you also need to set the MinDocFrequency and MinTermFrequency, or you will not get any results back.<br /><br /><span class="default">&lt;?php<br />$client </span><span class="keyword">= new </span><span class="default">SolrClient</span><span class="keyword">(</span><span class="default">$params</span><span class="keyword">);<br /></span><span class="default">$query </span><span class="keyword">= new </span><span class="default">SolrQuery</span><span class="keyword">();<br /></span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">setMlt</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">addField</span><span class="keyword">(</span><span class="string">'*,score'</span><span class="keyword">);<br /></span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">setMltMinDocFrequency</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">setMltMinTermFrequency</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /><br /></span><span class="comment">//What the MLT documents will be based off of<br /></span><span class="default">$query</span><span class="keyword">-&gt;</span><span class="default">setQuery</span><span class="keyword">(</span><span class="string">'id:doc_10'</span><span class="keyword">);<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">$client</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">);<br /></span><span class="default">$result</span><span class="keyword">-&gt;</span><span class="default">setParseMode</span><span class="keyword">(</span><span class="default">SolrQueryResponse</span><span class="keyword">::</span><span class="default">PARSE_SOLR_OBJ</span><span class="keyword">);<br /></span><span class="default">$response </span><span class="keyword">= </span><span class="default">$result</span><span class="keyword">-&gt;</span><span class="default">getResponse</span><span class="keyword">();<br /><br /></span><span class="comment">//MLT returns an array of documents based off of the id field value of EACH result returned in the primary search, with an array of MLT documents for each main result document returned<br /><br />//Presuming the unique field in our schema above is "id" and I know that I will only be getting one document returned in the primary result set, then:<br /></span><span class="default">$similarDocs </span><span class="keyword">= </span><span class="default">$response</span><span class="keyword">-&gt;</span><span class="default">moreLikeThis</span><span class="keyword">-&gt;</span><span class="default">doc_10</span><span class="keyword">-&gt;</span><span class="default">docs</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;<br /></span><br />Hope this helps.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=solrquery.setmlt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmlt.php">＋<small>add a note</small></a></div>
