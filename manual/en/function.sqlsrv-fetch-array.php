...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-fetch-array.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-fetch-array">
 <link rel="alternate" href="https://www.php.net/sqlsrv-fetch-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-fetch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-fetch-object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-fetch-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-fetch-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-fetch-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-fetch-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-fetch-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-fetch-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-fetch-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-fetch-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-fetch-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-fetch-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-fetch-array.php" hreflang="zh">
...
<meta name="Description" content="Returns a row as an array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_fetch_array - Manual" />
<meta name="twitter:description" content="Returns a row as an array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_fetch_array - Manual" />
<meta itemprop="description" content="Returns a row as an array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a row as an array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sqlsrv-fetch-object.php">
          sqlsrv_fetch_object &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-fetch.php">
          &laquo; sqlsrv_fetch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/function.sqlsrv-fetch-array.php'>Italian</option>
            ...
            <option value='uk/function.sqlsrv-fetch-array.php'>Ukrainian</option>
 ...
 <div class="refsect1 description" id="refsect1-function.sqlsrv-fetch-array-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_fetch_array</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fetchType</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$row</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sqlsrv-fetch-array-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">fetchType</code></dt>
     <dd>
      <p class="para">
       A predefined constant specifying the type of array to return. Possible 
       values are <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-fetch-assoc">SQLSRV_FETCH_ASSOC</a></code></strong>, 
       <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-fetch-numeric">SQLSRV_FETCH_NUMERIC</a></code></strong>, and 
       <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-fetch-both">SQLSRV_FETCH_BOTH</a></code></strong> (the default).
      </p>
      <p class="para">
     ...
     <dd>
      <p class="para">
       ...
       Possible values are <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-next">SQLSRV_SCROLL_NEXT</a></code></strong>, 
       <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-prior">SQLSRV_SCROLL_PRIOR</a></code></strong>, <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-first">SQLSRV_SCROLL_FIRST</a></code></strong>, 
       <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-last">SQLSRV_SCROLL_LAST</a></code></strong>, <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-absolute">SQLSRV_SCROLL_ABSOLUTE</a></code></strong> and, 
       <strong><code><a href="sqlsrv.constants.php#constant.sqlsrv-scroll-relative">SQLSRV_SCROLL_RELATIVE</a></code></strong> (the default). When this parameter 
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-fetch-array-returnvalues">
  ...
  <p class="para">
   Returns an array on success, <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there are no more rows to return, and 
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an error occurs.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\instanceName"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #0000BB">$serverName</span><span style="color: #007700">, </span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">);<br />if( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">=== </span><span style="color: #0000BB">false </span><span style="color: #007700">) {<br />    die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #0000BB">$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT FirstName, LastName FROM SomeTable"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql </span><span style="color: #007700">);<br />if( </span><span style="color: #0000BB">$stmt </span><span style="color: #007700">=== </span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />    die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true</span><span style="color: #007700">) );<br />}<br /><br />while( </span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_fetch_array</span><span style="color: #007700">( </span><span style="color: #0000BB">$stmt</span><span style="color: #007700">, </span><span style="color: #0000BB">SQLSRV_FETCH_NUMERIC</span><span style="color: #007700">) ) {<br />      echo </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">].</span><span style="color: #DD0000">", "</span><span style="color: #007700">.</span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">sqlsrv_free_stmt</span><span style="color: #007700">( </span><span style="color: #0000BB">$stmt</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.sqlsrv-fetch-array-notes">
  ...
  <p class="para">
   Not specifying the <code class="parameter">fetchType</code> or explicitly using the 
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-fetch-array-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-connect.php" class="function" rel="rdfs-seeAlso">sqlsrv_connect()</a> - Opens a connection to a Microsoft SQL Server database</span></li>
    ...
    <li><span class="function"><a href="function.sqlsrv-fetch.php" class="function" rel="rdfs-seeAlso">sqlsrv_fetch()</a> - Makes the next row in a result set available for reading</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-fetch-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-fetch-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-fetch-array.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123312">  <div class="votes">
    <div id="Vu123312">
    <a href="/manual/vote-note.php?id=123312&amp;page=function.sqlsrv-fetch-array&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123312">
    <a href="/manual/vote-note.php?id=123312&amp;page=function.sqlsrv-fetch-array&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123312" title="50% like this...">
    0
    </div>
  </div>
  <a href="#123312" class="name">
  <strong class="user"><em>albornozg dot rene at gmail dot com</em></strong></a><a class="genanchor" href="#123312"> &para;</a><div class="date" title="2018-11-06 04:43"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123312">
<div class="phpcode"><code><span class="html">Example with an iteration ( SQLSRV_SCROLL_ABSOLUTE ).<br /><br />for ($i=0; $i &lt; sqlsrv_num_rows($stmt); $i++) {<br /><br />     $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_NUMERIC,   SQLSRV_SCROLL_ABSOLUTE   ,  $i  ); <br />     echo "value of column 1: '.trim($row[0]).', value of column 2: '.trim($row[1]);<br /><br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sqlsrv-fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-fetch-array.php">＋<small>add a note</small></a></div>
