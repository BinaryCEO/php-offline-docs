...
<head>
  ...
  <title>PHP: Imagick::removeImageProfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.removeimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.removeimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.removeimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.removeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.render.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.removeimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.removeimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.removeimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.removeimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.removeimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.removeimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.removeimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.removeimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.removeimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.removeimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.removeimageprofile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::removeImageProfile - Manual" />
<meta name="twitter:description" content="Removes the named image profile and returns it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::removeImageProfile - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.render.php">
          Imagick::render &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.removeimage.php">
          &laquo; Imagick::removeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.removeimageprofile.php' selected="selected">English</option>
            <option value='de/imagick.removeimageprofile.php'>German</option>
            <option value='es/imagick.removeimageprofile.php'>Spanish</option>
            <option value='fr/imagick.removeimageprofile.php'>French</option>
            <option value='it/imagick.removeimageprofile.php'>Italian</option>
            <option value='ja/imagick.removeimageprofile.php'>Japanese</option>
            <option value='pt_BR/imagick.removeimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.removeimageprofile.php'>Russian</option>
            <option value='tr/imagick.removeimageprofile.php'>Turkish</option>
            <option value='uk/imagick.removeimageprofile.php'>Ukrainian</option>
            <option value='zh/imagick.removeimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.removeimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::removeImageProfile</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::removeImageProfile</span> &mdash; <span class="dc-title">Removes the named image profile and returns it</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.removeimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::removeImageProfile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.removeimageprofile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.removeimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.removeimageprofile-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/removeimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.removeimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.removeimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.removeimageprofile.php">＋<small>add a note</small></a></span>
