...
<head>
  ...
  <title>PHP: fbird_server_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-server-info.php">
 <link rel="shorturl" href="https://www.php.net/fbird-server-info">
 <link rel="alternate" href="https://www.php.net/fbird-server-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-rollback-ret.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-service-attach.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-server-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-server-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-server-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-server-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-server-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-server-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-server-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-server-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-server-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-server-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-server-info.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_server_info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_server_info - Manual" />
<meta name="twitter:description" content="Alias of ibase_server_info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_server_info - Manual" />
<meta itemprop="description" content="Alias of ibase_server_info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_server_info" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-service-attach.php">
          fbird_service_attach &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-rollback-ret.php">
          &laquo; fbird_rollback_ret        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-server-info.php' selected="selected">English</option>
            <option value='de/function.fbird-server-info.php'>German</option>
            <option value='es/function.fbird-server-info.php'>Spanish</option>
            <option value='fr/function.fbird-server-info.php'>French</option>
            <option value='it/function.fbird-server-info.php'>Italian</option>
            <option value='ja/function.fbird-server-info.php'>Japanese</option>
            <option value='pt_BR/function.fbird-server-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-server-info.php'>Russian</option>
            <option value='tr/function.fbird-server-info.php'>Turkish</option>
            <option value='uk/function.fbird-server-info.php'>Ukrainian</option>
            <option value='zh/function.fbird-server-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-server-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_server_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_server_info</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-server-info.php" class="function">ibase_server_info()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-server-info-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-server-info.php" class="function">ibase_server_info()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-server-info.php">＋<small>add a note</small></a></span>
