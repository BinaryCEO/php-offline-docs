...
<head>
  ...
  <title>PHP: cubrid_error_code - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-error-code.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-error-code">
 <link rel="alternate" href="https://www.php.net/cubrid-error-code" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-drop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-error-code-facility.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-error-code.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-error-code.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-error-code.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-error-code.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-error-code.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-error-code.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-error-code.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-error-code.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-error-code.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-error-code.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-error-code.php" hreflang="zh">
...
<meta name="Description" content="Get error code for the most recent function call" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_error_code - Manual" />
<meta name="twitter:description" content="Get error code for the most recent function call" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_error_code - Manual" />
<meta itemprop="description" content="Get error code for the most recent function call" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get error code for the most recent function call" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-error-code-facility.php">
          cubrid_error_code_facility &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-error-code.php' selected="selected">English</option>
            <option value='de/function.cubrid-error-code.php'>German</option>
            <option value='es/function.cubrid-error-code.php'>Spanish</option>
            <option value='fr/function.cubrid-error-code.php'>French</option>
            <option value='it/function.cubrid-error-code.php'>Italian</option>
            <option value='ja/function.cubrid-error-code.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-error-code.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-error-code.php'>Russian</option>
            <option value='tr/function.cubrid-error-code.php'>Turkish</option>
            <option value='uk/function.cubrid-error-code.php'>Ukrainian</option>
            <option value='zh/function.cubrid-error-code.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-error-code" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-error-code-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_error_code</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-error-code-returnvalues">
  ...
  <p class="para">
   Error code of the error that occurred, or <code class="literal">0</code> (zero) if no
   error occurred. 
  </p>
  <p class="para">
 </div>
...
<div class="examplescode"><pre class="examplescode">Error facility: 4
Error code: -30015
Error msg: Some parameter not binded</pre>
</div>
   </div>
  </div>
 </div>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-error-msg.php" class="function" rel="rdfs-seeAlso">cubrid_error_msg()</a> - Get last error message for the most recent function call</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-error-code.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-error-code%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-error-code&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-error-code.php">＋<small>add a note</small></a></span>
