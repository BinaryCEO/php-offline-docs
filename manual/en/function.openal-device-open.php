...
<head>
  ...
  <title>PHP: openal_device_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openal-device-open.php">
 <link rel="shorturl" href="https://www.php.net/openal-device-open">
 <link rel="alternate" href="https://www.php.net/openal-device-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openal.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openal-device-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-listener-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openal-device-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openal-device-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openal-device-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openal-device-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openal-device-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openal-device-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openal-device-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openal-device-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openal-device-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openal-device-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openal-device-open.php" hreflang="zh">
...
<meta name="Description" content="Initialize the OpenAL audio layer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openal_device_open - Manual" />
<meta name="twitter:description" content="Initialize the OpenAL audio layer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openal_device_open - Manual" />
<meta itemprop="description" content="Initialize the OpenAL audio layer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize the OpenAL audio layer" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openal-listener-get.php">
          openal_listener_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openal-device-close.php">
          &laquo; openal_device_close        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openal-device-open.php' selected="selected">English</option>
            <option value='de/function.openal-device-open.php'>German</option>
            <option value='es/function.openal-device-open.php'>Spanish</option>
            <option value='fr/function.openal-device-open.php'>French</option>
            <option value='it/function.openal-device-open.php'>Italian</option>
            <option value='ja/function.openal-device-open.php'>Japanese</option>
            <option value='pt_BR/function.openal-device-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.openal-device-open.php'>Russian</option>
            <option value='tr/function.openal-device-open.php'>Turkish</option>
            <option value='uk/function.openal-device-open.php'>Ukrainian</option>
            <option value='zh/function.openal-device-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openal-device-open" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openal-context-create.php" class="function" rel="rdfs-seeAlso">openal_context_create()</a> - Create an audio processing context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/functions/openal-device-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openal-device-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openal-device-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openal-device-open.php">＋<small>add a note</small></a></span>
