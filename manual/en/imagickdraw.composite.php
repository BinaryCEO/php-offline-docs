...
<head>
  ...
  <title>PHP: ImagickDraw::composite - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.composite.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.composite.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.composite.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.comment.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.composite.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.composite.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.composite.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.composite.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.composite.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.composite.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.composite.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.composite.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.composite.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.composite.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.composite.php" hreflang="zh">
...
<meta name="Description" content="Composites an image onto the current image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::composite - Manual" />
<meta name="twitter:description" content="Composites an image onto the current image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::composite - Manual" />
<meta itemprop="description" content="Composites an image onto the current image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Composites an image onto the current image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.construct.php">
          ImagickDraw::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.comment.php">
          &laquo; ImagickDraw::comment        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.composite.php' selected="selected">English</option>
            <option value='de/imagickdraw.composite.php'>German</option>
            <option value='es/imagickdraw.composite.php'>Spanish</option>
            <option value='fr/imagickdraw.composite.php'>French</option>
            <option value='it/imagickdraw.composite.php'>Italian</option>
            <option value='ja/imagickdraw.composite.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.composite.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.composite.php'>Russian</option>
            <option value='tr/imagickdraw.composite.php'>Turkish</option>
            <option value='uk/imagickdraw.composite.php'>Ukrainian</option>
            <option value='zh/imagickdraw.composite.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.composite" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::composite</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::composite</span> &mdash; <span class="dc-title">Composites an image onto the current image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.composite-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::composite</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$composite</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$image</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.composite-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">composite</code></dt>
     <dd>
      <p class="para">
       composition operator.
       One of the <a href="imagick.constants.php#imagick.constants.compositeop" class="link">Composite Operator</a> constant
       (<code class="literal">imagick::COMPOSITE_*</code>).
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       the <span class="classname"><a href="class.imagick.php" class="classname">Imagick</a></span> object where composition image is taken from.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.composite-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3149">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/composite.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.composite%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.composite&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.composite.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91684">  <div class="votes">
    <div id="Vu91684">
    <a href="/manual/vote-note.php?id=91684&amp;page=imagickdraw.composite&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91684">
    <a href="/manual/vote-note.php?id=91684&amp;page=imagickdraw.composite&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91684" title="no votes...">
    0
    </div>
  </div>
  <a href="#91684" class="name">
  <strong class="user"><em>christian dot reinecke at web dot de</em></strong></a><a class="genanchor" href="#91684"> &para;</a><div class="date" title="2009-06-23 01:31"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91684">
<div class="phpcode"><code><span class="html">To see some examples how the COMPOSITE_* constants work, see this page:<br /><a href="http://www.imagemagick.org/Usage/compose/#duff-porter" rel="nofollow" target="_blank">http://www.imagemagick.org/Usage/compose/#duff-porter</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.composite&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.composite.php">＋<small>add a note</small></a></div>
