...
<head>
  ...
  <title>PHP: win32_query_service_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.win32-query-service-status.php">
 <link rel="shorturl" href="https://www.php.net/win32-query-service-status">
 <link rel="alternate" href="https://www.php.net/win32-query-service-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.win32-pause-service.php">
 <link rel="next" href="https://www.php.net/manual/en/function.win32-read-all-rights-access-service.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.win32-query-service-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.win32-query-service-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.win32-query-service-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.win32-query-service-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.win32-query-service-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.win32-query-service-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.win32-query-service-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.win32-query-service-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.win32-query-service-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.win32-query-service-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.win32-query-service-status.php" hreflang="zh">
...
<meta name="Description" content="Queries the status of a service" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: win32_query_service_status - Manual" />
<meta name="twitter:description" content="Queries the status of a service" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: win32_query_service_status - Manual" />
<meta itemprop="description" content="Queries the status of a service" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Queries the status of a service" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.win32-read-all-rights-access-service.php">
          win32_read_all_rights_access_service &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.win32-pause-service.php">
          &laquo; win32_pause_service        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.win32-query-service-status.php' selected="selected">English</option>
            <option value='de/function.win32-query-service-status.php'>German</option>
            <option value='es/function.win32-query-service-status.php'>Spanish</option>
            <option value='fr/function.win32-query-service-status.php'>French</option>
            <option value='it/function.win32-query-service-status.php'>Italian</option>
            <option value='ja/function.win32-query-service-status.php'>Japanese</option>
            <option value='pt_BR/function.win32-query-service-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.win32-query-service-status.php'>Russian</option>
            <option value='tr/function.win32-query-service-status.php'>Turkish</option>
            <option value='uk/function.win32-query-service-status.php'>Ukrainian</option>
            <option value='zh/function.win32-query-service-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.win32-query-service-status" class="refentry">
   ...
   <ul class="simplelist">
    <li><a href="win32service.constants.php" class="link">Win32Service Predefined Constants</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/functions/win32-query-service-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.win32-query-service-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.win32-query-service-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-query-service-status.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92365">  <div class="votes">
    <div id="Vu92365">
    <a href="/manual/vote-note.php?id=92365&amp;page=function.win32-query-service-status&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92365">
    <a href="/manual/vote-note.php?id=92365&amp;page=function.win32-query-service-status&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92365" title="75% like this...">
    2
    </div>
  </div>
  <a href="#92365" class="name">
  <strong class="user"><em>demers dot alex at gmail dot com</em></strong></a><a class="genanchor" href="#92365"> &para;</a><div class="date" title="2009-07-21 08:39"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92365">
<div class="phpcode"><code><span class="html">This function will return an array containing the above information as a return value, but if this fails it will return an integer which is a System Error Code. All the System Error Codes can be found here:<br /><br /><a href="http://msdn.microsoft.com/en-us/library/ms681381%28VS.85%29.aspx" rel="nofollow" target="_blank">http://msdn.microsoft.com/en-us/library/ms681381%28VS.85%29.aspx</a><br /><br />In my case, it returned 5, in which I immediately knew why and fixed the issue right away.<br /><br />In the case of mnemotronic at netscape dot net, here in the documentation notes, it returned 1060 which is:<br /><br />ERROR_SERVICE_DOES_NOT_EXIST<br />1060 (0x424)<br />The specified service does not exist as an installed service.<br /><br />Again, it should not return FALSE, instead an System Error Code for Windows.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.win32-query-service-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.win32-query-service-status.php">＋<small>add a note</small></a></div>
