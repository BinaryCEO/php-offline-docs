...
<head>
  ...
  <title>PHP: ocinewcursor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocinewcursor.php">
 <link rel="shorturl" href="https://www.php.net/ocinewcursor">
 <link rel="alternate" href="https://www.php.net/ocinewcursor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocinewcollection.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocinewdescriptor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocinewcursor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocinewcursor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocinewcursor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocinewcursor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocinewcursor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocinewcursor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocinewcursor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocinewcursor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocinewcursor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocinewcursor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocinewcursor.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_new_cursor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocinewcursor - Manual" />
<meta name="twitter:description" content="Alias of oci_new_cursor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocinewcursor - Manual" />
<meta itemprop="description" content="Alias of oci_new_cursor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_new_cursor" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocinewdescriptor.php">
          ocinewdescriptor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocinewcollection.php">
          &laquo; ocinewcollection        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocinewcursor.php' selected="selected">English</option>
            <option value='de/function.ocinewcursor.php'>German</option>
            <option value='es/function.ocinewcursor.php'>Spanish</option>
            <option value='fr/function.ocinewcursor.php'>French</option>
            <option value='it/function.ocinewcursor.php'>Italian</option>
            <option value='ja/function.ocinewcursor.php'>Japanese</option>
            <option value='pt_BR/function.ocinewcursor.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocinewcursor.php'>Russian</option>
            <option value='tr/function.ocinewcursor.php'>Turkish</option>
            <option value='uk/function.ocinewcursor.php'>Ukrainian</option>
            <option value='zh/function.ocinewcursor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocinewcursor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocinewcursor</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocinewcursor</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-new-cursor.php" class="function">oci_new_cursor()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocinewcursor-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-new-cursor.php" class="function">oci_new_cursor()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocinewcursor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocinewcursor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocinewcursor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocinewcursor.php">＋<small>add a note</small></a></span>
