...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.pcntl.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.expect-popen.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.pcntl.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.pcntl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.pcntl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.pcntl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.pcntl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.pcntl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.pcntl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.pcntl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.pcntl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.pcntl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.pcntl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.pcntl.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: PCNTL - Manual" />
<meta name="twitter:description" content="Process Control" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PCNTL - Manual" />
<meta itemprop="description" content="Process Control" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Process Control" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.pcntl.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.expect-popen.php">
          &laquo; expect_popen        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.pcntl.php' selected="selected">English</option>
            <option value='de/book.pcntl.php'>German</option>
            <option value='es/book.pcntl.php'>Spanish</option>
            <option value='fr/book.pcntl.php'>French</option>
            <option value='it/book.pcntl.php'>Italian</option>
            <option value='ja/book.pcntl.php'>Japanese</option>
            <option value='pt_BR/book.pcntl.php'>Brazilian Portuguese</option>
            <option value='ru/book.pcntl.php'>Russian</option>
            <option value='tr/book.pcntl.php'>Turkish</option>
            <option value='uk/book.pcntl.php'>Ukrainian</option>
            <option value='zh/book.pcntl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.pcntl" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.pcntl.php">Introduction</a></li><li><a href="pcntl.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="pcntl.installation.php">Installation</a></li></ul></li><li><a href="pcntl.constants.php">Predefined Constants</a></li><li><a href="pcntl.examples.php">Examples</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="pcntl.example.php">Basic usage</a></li></ul></li><li><a href="enum.pcntl-qosclass.php">Pcntl\QosClass</a> — The Pcntl\QosClass Enum</li><li><a href="ref.pcntl.php">PCNTL Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.pcntl-alarm.php">pcntl_alarm</a> — Set an alarm clock for delivery of a signal</li><li><a href="function.pcntl-async-signals.php">pcntl_async_signals</a> — Enable/disable asynchronous signal handling or return the old setting</li><li><a href="function.pcntl-errno.php">pcntl_errno</a> — Alias of pcntl_get_last_error</li><li><a href="function.pcntl-exec.php">pcntl_exec</a> — Executes specified program in current process space</li><li><a href="function.pcntl-fork.php">pcntl_fork</a> — Forks the currently running process</li><li><a href="function.pcntl-get-last-error.php">pcntl_get_last_error</a> — Retrieve the error number set by the last pcntl function which failed</li><li><a href="function.pcntl-getcpuaffinity.php">pcntl_getcpuaffinity</a> — Get the cpu affinity of a process</li><li><a href="function.pcntl-getpriority.php">pcntl_getpriority</a> — Get the priority of any process</li><li><a href="function.pcntl-rfork.php">pcntl_rfork</a> — Manipulates process resources</li><li><a href="function.pcntl-setcpuaffinity.php">pcntl_setcpuaffinity</a> — Set the cpu affinity of a process</li><li><a href="function.pcntl-setpriority.php">pcntl_setpriority</a> — Change the priority of any process</li><li><a href="function.pcntl-signal.php">pcntl_signal</a> — Installs a signal handler</li><li><a href="function.pcntl-signal-dispatch.php">pcntl_signal_dispatch</a> — Calls signal handlers for pending signals</li><li><a href="function.pcntl-signal-get-handler.php">pcntl_signal_get_handler</a> — Get the current handler for specified signal</li><li><a href="function.pcntl-sigprocmask.php">pcntl_sigprocmask</a> — Sets and retrieves blocked signals</li><li><a href="function.pcntl-sigtimedwait.php">pcntl_sigtimedwait</a> — Waits for signals, with a timeout</li><li><a href="function.pcntl-sigwaitinfo.php">pcntl_sigwaitinfo</a> — Waits for signals</li><li><a href="function.pcntl-strerror.php">pcntl_strerror</a> — Retrieve the system error message associated with the given errno</li><li><a href="function.pcntl-unshare.php">pcntl_unshare</a> — Dissociates parts of the process execution context</li><li><a href="function.pcntl-wait.php">pcntl_wait</a> — Waits on or returns the status of a forked child</li><li><a href="function.pcntl-waitid.php">pcntl_waitid</a> — Waits for a child process to change state</li><li><a href="function.pcntl-waitpid.php">pcntl_waitpid</a> — Waits on or returns the status of a forked child</li><li><a href="function.pcntl-wexitstatus.php">pcntl_wexitstatus</a> — Returns the return code of a terminated child</li><li><a href="function.pcntl-wifexited.php">pcntl_wifexited</a> — Checks if status code represents a normal exit</li><li><a href="function.pcntl-wifsignaled.php">pcntl_wifsignaled</a> — Checks whether the status code represents a termination due to a signal</li><li><a href="function.pcntl-wifstopped.php">pcntl_wifstopped</a> — Checks whether the child process is currently stopped</li><li><a href="function.pcntl-wstopsig.php">pcntl_wstopsig</a> — Returns the signal which caused the child to stop</li><li><a href="function.pcntl-wtermsig.php">pcntl_wtermsig</a> — Returns the signal which caused the child to terminate</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.pcntl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.pcntl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.pcntl.php">＋<small>add a note</small></a></span>
