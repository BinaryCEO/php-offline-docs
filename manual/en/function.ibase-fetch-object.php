...
<head>
  ...
  <title>PHP: ibase_fetch_object - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-fetch-object.php">
 <link rel="shorturl" href="https://www.php.net/ibase-fetch-object">
 <link rel="alternate" href="https://www.php.net/ibase-fetch-object" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-fetch-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-fetch-row.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-fetch-object.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-fetch-object.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-fetch-object.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-fetch-object.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-fetch-object.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-fetch-object.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-fetch-object.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-fetch-object.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-fetch-object.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-fetch-object.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-fetch-object.php" hreflang="zh">
...
<meta name="Description" content="Get an object from a InterBase database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_fetch_object - Manual" />
<meta name="twitter:description" content="Get an object from a InterBase database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_fetch_object - Manual" />
<meta itemprop="description" content="Get an object from a InterBase database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get an object from a InterBase database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-fetch-row.php">
          ibase_fetch_row &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-fetch-assoc.php">
          &laquo; ibase_fetch_assoc        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-fetch-object.php' selected="selected">English</option>
            <option value='de/function.ibase-fetch-object.php'>German</option>
            <option value='es/function.ibase-fetch-object.php'>Spanish</option>
            <option value='fr/function.ibase-fetch-object.php'>French</option>
            <option value='it/function.ibase-fetch-object.php'>Italian</option>
            <option value='ja/function.ibase-fetch-object.php'>Japanese</option>
            <option value='pt_BR/function.ibase-fetch-object.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-fetch-object.php'>Russian</option>
            <option value='tr/function.ibase-fetch-object.php'>Turkish</option>
            <option value='uk/function.ibase-fetch-object.php'>Ukrainian</option>
            <option value='zh/function.ibase-fetch-object.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-fetch-object" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_fetch_object</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_fetch_object</span> &mdash; <span class="dc-title">Get an object from a InterBase database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-fetch-object-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_fetch_object</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result_id</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fetch_flag</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.object.php" class="type object">object</a></span></div>

  <p class="para rdfs-comment">
   Fetches a row as a pseudo-object from a given result identifier.
  </p>
  <p class="para">
   Subsequent calls to <span class="function"><strong>ibase_fetch_object()</strong></span>
   return the next row in the result set.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-fetch-object-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">result_id</code></dt>
     <dd>
      <p class="para">
       An InterBase result identifier obtained either by
       <span class="function"><a href="function.ibase-query.php" class="function">ibase_query()</a></span> or <span class="function"><a href="function.ibase-execute.php" class="function">ibase_execute()</a></span>.
      </p>
     </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$dbh </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_connect</span><span style="color: #007700">(</span><span style="color: #0000BB">$host</span><span style="color: #007700">, </span><span style="color: #0000BB">$username</span><span style="color: #007700">, </span><span style="color: #0000BB">$password</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$stmt </span><span style="color: #007700">= </span><span style="color: #DD0000">'SELECT * FROM tblname'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$sth </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbh</span><span style="color: #007700">, </span><span style="color: #0000BB">$stmt</span><span style="color: #007700">);<br />while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_fetch_object</span><span style="color: #007700">(</span><span style="color: #0000BB">$sth</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #0000BB">$row</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">email </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">ibase_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$dbh</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-fetch-object-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-fetch-assoc.php" class="function" rel="rdfs-seeAlso">ibase_fetch_assoc()</a> - Fetch a result row from a query as an associative array</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-fetch-object.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-fetch-object%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-fetch-object&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-fetch-object.php">＋<small>add a note</small></a></span>
