...
<head>
  ...
  <title>PHP: ImagickDraw::pathCurveToSmoothAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathcurvetorelative.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothrelative.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathcurvetosmoothabsolute.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::pathCurveToSmoothAbsolute - Manual" />
<meta name="twitter:description" content="Draws a cubic Bezier curve" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathCurveToSmoothAbsolute - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathcurvetosmoothrelative.php">
          ImagickDraw::pathCurveToSmoothRelative &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathcurvetorelative.php">
          &laquo; ImagickDraw::pathCurveToRelative        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathcurvetosmoothabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathcurvetosmoothabsolute.php'>German</option>
            <option value='es/imagickdraw.pathcurvetosmoothabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathcurvetosmoothabsolute.php'>French</option>
            <option value='it/imagickdraw.pathcurvetosmoothabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathcurvetosmoothabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathcurvetosmoothabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathcurvetosmoothabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathcurvetosmoothabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathcurvetosmoothabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathcurvetosmoothabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathcurvetosmoothabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathCurveToSmoothAbsolute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathCurveToSmoothAbsolute</span> &mdash; <span class="dc-title">Draws a cubic Bezier curve</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathcurvetosmoothabsolute-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathCurveToSmoothAbsolute</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathcurvetosmoothabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathcurvetosmoothabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathcurvetosmoothabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathcurvetosmoothabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathcurvetosmoothabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothabsolute.php">＋<small>add a note</small></a></span>
