...
<head>
  ...
  <title>PHP: func_get_args - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.func-get-args.php">
 <link rel="shorturl" href="https://www.php.net/func-get-args">
 <link rel="alternate" href="https://www.php.net/func-get-args" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.funchand.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.func-get-arg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.func-num-args.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.func-get-args.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.func-get-args.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.func-get-args.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.func-get-args.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.func-get-args.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.func-get-args.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.func-get-args.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.func-get-args.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.func-get-args.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.func-get-args.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.func-get-args.php" hreflang="zh">
...
<meta name="Description" content="Returns an array comprising a function's argument list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: func_get_args - Manual" />
<meta name="twitter:description" content="Returns an array comprising a function's argument list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: func_get_args - Manual" />
<meta itemprop="description" content="Returns an array comprising a function's argument list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array comprising a function's argument list" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.func-get-args.php' selected="selected">English</option>
            <option value='de/function.func-get-args.php'>German</option>
            <option value='es/function.func-get-args.php'>Spanish</option>
            <option value='fr/function.func-get-args.php'>French</option>
            <option value='it/function.func-get-args.php'>Italian</option>
            <option value='ja/function.func-get-args.php'>Japanese</option>
            <option value='pt_BR/function.func-get-args.php'>Brazilian Portuguese</option>
            <option value='ru/function.func-get-args.php'>Russian</option>
            <option value='tr/function.func-get-args.php'>Turkish</option>
            <option value='uk/function.func-get-args.php'>Ukrainian</option>
            <option value='zh/function.func-get-args.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.func-get-args" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionfunctionabstract.getparameters.php" class="methodname" rel="rdfs-seeAlso">ReflectionFunctionAbstract::getParameters()</a> - Gets parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/funchand/functions/func-get-args.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.func-get-args%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.func-get-args&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.func-get-args.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124416">  <div class="votes">
    <div id="Vu124416">
    <a href="/manual/vote-note.php?id=124416&amp;page=function.func-get-args&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124416">
    <a href="/manual/vote-note.php?id=124416&amp;page=function.func-get-args&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124416" title="84% like this...">
    13
    </div>
  </div>
  <a href="#124416" class="name">
  <strong class="user"><em>cobrattila at gmail dot com</em></strong></a><a class="genanchor" href="#124416"> &para;</a><div class="date" title="2019-11-20 04:17"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124416">
<div class="phpcode"><code><span class="html">If you want to get the arguments by reference, instead of func_get_args() you can simply use<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">args_byref</span><span class="keyword">(&amp;...</span><span class="default">$args</span><span class="keyword">) {<br />    </span><span class="comment">// Modify the $args array here<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />Credits should go to Markus Malkusch for pointing this out on Stackoverflow.<br /><a href="https://stackoverflow.com/a/29181826/1426064" rel="nofollow" target="_blank">https://stackoverflow.com/a/29181826/1426064</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.func-get-args&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.func-get-args.php">＋<small>add a note</small></a></div>
