...
<head>
  ...
  <title>PHP: fann_get_layer_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-layer-array.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-layer-array">
 <link rel="alternate" href="https://www.php.net/fann-get-layer-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-errstr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-learning-momentum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-layer-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-layer-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-layer-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-layer-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-layer-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-layer-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-layer-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-layer-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-layer-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-layer-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-layer-array.php" hreflang="zh">
...
<meta name="Description" content="Get the number of neurons in each layer in the network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_layer_array - Manual" />
<meta name="twitter:description" content="Get the number of neurons in each layer in the network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_layer_array - Manual" />
<meta itemprop="description" content="Get the number of neurons in each layer in the network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of neurons in each layer in the network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-learning-momentum.php">
          fann_get_learning_momentum &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-errstr.php">
          &laquo; fann_get_errstr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-layer-array.php' selected="selected">English</option>
            <option value='de/function.fann-get-layer-array.php'>German</option>
            <option value='es/function.fann-get-layer-array.php'>Spanish</option>
            <option value='fr/function.fann-get-layer-array.php'>French</option>
            <option value='it/function.fann-get-layer-array.php'>Italian</option>
            <option value='ja/function.fann-get-layer-array.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-layer-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-layer-array.php'>Russian</option>
            <option value='tr/function.fann-get-layer-array.php'>Turkish</option>
            <option value='uk/function.fann-get-layer-array.php'>Ukrainian</option>
            <option value='zh/function.fann-get-layer-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-layer-array" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_layer_array</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_layer_array</span> &mdash; <span class="dc-title">Get the number of neurons in each layer in the network</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-layer-array-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_layer_array</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-get-layer-array-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-layer-array-returnvalues">
  ...
  <p class="para">
   An array of numbers of neurons in each leayer
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-layer-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-layer-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-layer-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-layer-array.php">＋<small>add a note</small></a></span>
