...
<head>
  ...
  <title>PHP: CollectionModify::bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionmodify.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.arrayinsert.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collectionmodify.bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collectionmodify.bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collectionmodify.bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collectionmodify.bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collectionmodify.bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collectionmodify.bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collectionmodify.bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collectionmodify.bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collectionmodify.bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collectionmodify.bind.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: CollectionModify::bind - Manual" />
<meta name="twitter:description" content="Bind value to query placeholder" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CollectionModify::bind - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysql-xdevapi-collectionmodify.construct.php">
          CollectionModify::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collectionmodify.arrayinsert.php">
          &laquo; CollectionModify::arrayInsert        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionmodify.bind.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collectionmodify.bind.php'>German</option>
            <option value='es/mysql-xdevapi-collectionmodify.bind.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collectionmodify.bind.php'>French</option>
            <option value='it/mysql-xdevapi-collectionmodify.bind.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collectionmodify.bind.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collectionmodify.bind.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collectionmodify.bind.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collectionmodify.bind.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collectionmodify.bind.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collectionmodify.bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collectionmodify.bind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">CollectionModify::bind</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">CollectionModify::bind</span> &mdash; <span class="dc-title">Bind value to query placeholder</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collectionmodify.bind-examples">
  ...
  <div class="example" id="example-1723">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\CollectionModify::bind()</strong></span> example</strong></p>
...
(
    [0] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionmodify/bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionmodify.bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionmodify.bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.bind.php">＋<small>add a note</small></a></span>
