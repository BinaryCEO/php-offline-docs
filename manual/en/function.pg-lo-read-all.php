...
<head>
  ...
  <title>PHP: pg_lo_read_all - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-read-all.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-read-all">
 <link rel="alternate" href="https://www.php.net/pg-lo-read-all" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-read-all.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-read-all.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-read-all.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-read-all.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-read-all.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-read-all.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-read-all.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-read-all.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-read-all.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-read-all.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-read-all.php" hreflang="zh">
...
<meta name="Description" content="Reads an entire large object and send straight to browser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_read_all - Manual" />
<meta name="twitter:description" content="Reads an entire large object and send straight to browser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_read_all - Manual" />
<meta itemprop="description" content="Reads an entire large object and send straight to browser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads an entire large object and send straight to browser" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-lo-seek.php">
          pg_lo_seek &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-read-all.php' selected="selected">English</option>
            <option value='de/function.pg-lo-read-all.php'>German</option>
            <option value='es/function.pg-lo-read-all.php'>Spanish</option>
            <option value='fr/function.pg-lo-read-all.php'>French</option>
            <option value='it/function.pg-lo-read-all.php'>Italian</option>
            <option value='ja/function.pg-lo-read-all.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-read-all.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-read-all.php'>Russian</option>
            <option value='tr/function.pg-lo-read-all.php'>Turkish</option>
            <option value='uk/function.pg-lo-read-all.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-read-all.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-read-all" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-read.php" class="function" rel="rdfs-seeAlso">pg_lo_read()</a> - Read a large object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-read-all.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-read-all%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-read-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-read-all.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="45957">  <div class="votes">
    <div id="Vu45957">
    <a href="/manual/vote-note.php?id=45957&amp;page=function.pg-lo-read-all&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45957">
    <a href="/manual/vote-note.php?id=45957&amp;page=function.pg-lo-read-all&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45957" title="100% like this...">
    2
    </div>
  </div>
  <a href="#45957" class="name">
  <strong class="user"><em>robert dot bernier5 at sympatico dot ca</em></strong></a><a class="genanchor" href="#45957"> &para;</a><div class="date" title="2004-09-24 07:45"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45957">
<div class="phpcode"><code><span class="html">// remember, large objects must be obtained from within a transaction<br />pg_query ($dbconn, "begin");<br /><br />// "assume" for this example that the large object resource number of the zipped file is "17899"<br /><br />$lo_oid = 17899;<br /><br />$handle_lo = pg_lo_open($dbconn,$lo_oid,"r") or die("&lt;h1&gt;Error.. can't get handle&lt;/h1&gt;");<br /><br />//headers to send to the browser before beginning the binary download<br />header('Accept-Ranges: bytes');<br />header('Content-Length: 32029974'); //this is the size of the zipped file<br />header('Keep-Alive: timeout=15, max=100');<br />header('Content-type: Application/x-zip');<br />header('Content-Disposition: attachment; filename="superjob.zip"');<br /><br />pg_lo_read_all($handle_lo) or <br />  die("&lt;h1&gt;Error, can't read large object.&lt;/h1&gt;");<br /><br />// committing the data transaction<br />pg_query ($dbconn, "commit");</span></code></div>
  </div>
 </div>
  <div class="note" id="106083">  <div class="votes">
    <div id="Vu106083">
    <a href="/manual/vote-note.php?id=106083&amp;page=function.pg-lo-read-all&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106083">
    <a href="/manual/vote-note.php?id=106083&amp;page=function.pg-lo-read-all&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106083" title="no votes...">
    0
    </div>
  </div>
  <a href="#106083" class="name">
  <strong class="user"><em>fabar2 at libero dot it</em></strong></a><a class="genanchor" href="#106083"> &para;</a><div class="date" title="2011-10-08 08:36"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106083">
<div class="phpcode"><code><span class="html">Pay attention that if you omit the "length" parameter it will read a 8192 bytes object regardless to its real dimensions. If you want to use this function think to save the object size somewhere (usually a field in its table) before reading the object. Alternatively use the pg_lo_readall function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-read-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-read-all.php">＋<small>add a note</small></a></div>
