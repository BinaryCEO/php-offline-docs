...
<head>
  ...
  <title>PHP: SolrQuery::getFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetsort.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfields.php" hreflang="zh">
...
<meta name="Description" content="Returns the list of fields that will be returned in the response" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFields - Manual" />
<meta name="twitter:description" content="Returns the list of fields that will be returned in the response" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFields - Manual" />
<meta itemprop="description" content="Returns the list of fields that will be returned in the response" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the list of fields that will be returned in the response" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfilterqueries.php">
          SolrQuery::getFilterQueries &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetsort.php">
          &laquo; SolrQuery::getFacetSort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfields.php' selected="selected">English</option>
            <option value='de/solrquery.getfields.php'>German</option>
            <option value='es/solrquery.getfields.php'>Spanish</option>
            <option value='fr/solrquery.getfields.php'>French</option>
            <option value='it/solrquery.getfields.php'>Italian</option>
            <option value='ja/solrquery.getfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfields.php'>Russian</option>
            <option value='tr/solrquery.getfields.php'>Turkish</option>
            <option value='uk/solrquery.getfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFields</span> &mdash; <span class="dc-title">Returns the list of fields that will be returned in the response</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfields-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfields.php">＋<small>add a note</small></a></span>
