...
<head>
  ...
  <title>PHP: Memcached::setEncodingKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.setencodingkey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.setencodingkey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setencodingkey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.setbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.setmulti.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setencodingkey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.setencodingkey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.setencodingkey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.setencodingkey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.setencodingkey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.setencodingkey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.setencodingkey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.setencodingkey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.setencodingkey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.setencodingkey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.setencodingkey.php" hreflang="zh">
...
<meta name="Description" content="Set AES encryption key for data in Memcached" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::setEncodingKey - Manual" />
<meta name="twitter:description" content="Set AES encryption key for data in Memcached" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::setEncodingKey - Manual" />
<meta itemprop="description" content="Set AES encryption key for data in Memcached" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set AES encryption key for data in Memcached" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.setmulti.php">
          Memcached::setMulti &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.setbykey.php">
          &laquo; Memcached::setByKey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.setencodingkey.php' selected="selected">English</option>
            <option value='de/memcached.setencodingkey.php'>German</option>
            <option value='es/memcached.setencodingkey.php'>Spanish</option>
            <option value='fr/memcached.setencodingkey.php'>French</option>
            <option value='it/memcached.setencodingkey.php'>Italian</option>
            <option value='ja/memcached.setencodingkey.php'>Japanese</option>
            <option value='pt_BR/memcached.setencodingkey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.setencodingkey.php'>Russian</option>
            <option value='tr/memcached.setencodingkey.php'>Turkish</option>
            <option value='uk/memcached.setencodingkey.php'>Ukrainian</option>
            <option value='zh/memcached.setencodingkey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.setencodingkey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::setEncodingKey</h1>
  <p class="verinfo">(PECL memcached &gt;= 3.1.0)</p><p class="refpurpose"><span class="refname">Memcached::setEncodingKey</span> &mdash; <span class="dc-title">Set AES encryption key for data in Memcached</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-memcached.setencodingkey-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::setEncodingKey</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-memcached.setencodingkey-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.setencodingkey-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.setencodingkey-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="memcached.set.php" class="methodname" rel="rdfs-seeAlso">Memcached::set()</a> - Store an item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/setencodingkey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.setencodingkey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.setencodingkey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.setencodingkey.php">＋<small>add a note</small></a></span>
