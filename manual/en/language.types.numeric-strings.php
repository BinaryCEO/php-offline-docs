...
<head>
  ...
  <title>PHP: Numeric strings - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.types.numeric-strings.php">
 <link rel="shorturl" href="https://www.php.net/types.numeric-strings">
 <link rel="alternate" href="https://www.php.net/types.numeric-strings" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.types.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.types.string.php">
 <link rel="next" href="https://www.php.net/manual/en/language.types.array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.types.numeric-strings.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.types.numeric-strings.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.types.numeric-strings.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.types.numeric-strings.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.types.numeric-strings.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.types.numeric-strings.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.types.numeric-strings.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.types.numeric-strings.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.types.numeric-strings.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.types.numeric-strings.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.types.numeric-strings.php" hreflang="zh">
...
<meta name="Description" content="Numeric strings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Numeric strings - Manual" />
<meta name="twitter:description" content="Numeric strings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Numeric strings - Manual" />
<meta itemprop="description" content="Numeric strings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Numeric strings" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.types.numeric-strings.php' selected="selected">English</option>
            <option value='de/language.types.numeric-strings.php'>German</option>
            <option value='es/language.types.numeric-strings.php'>Spanish</option>
            <option value='fr/language.types.numeric-strings.php'>French</option>
            <option value='it/language.types.numeric-strings.php'>Italian</option>
            <option value='ja/language.types.numeric-strings.php'>Japanese</option>
            <option value='pt_BR/language.types.numeric-strings.php'>Brazilian Portuguese</option>
            <option value='ru/language.types.numeric-strings.php'>Russian</option>
            <option value='tr/language.types.numeric-strings.php'>Turkish</option>
            <option value='uk/language.types.numeric-strings.php'>Ukrainian</option>
            <option value='zh/language.types.numeric-strings.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.types.numeric-strings" class="sect1">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">1 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"10.5"</span><span style="color: #007700">;                </span><span style="color: #FF8000">// $foo is float (11.5)<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">1 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"-1.3e3"</span><span style="color: #007700">;              </span><span style="color: #FF8000">// $foo is float (-1299)<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">1 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"bob-1.3e3"</span><span style="color: #007700">;           </span><span style="color: #FF8000">// TypeError as of PHP 8.0.0, $foo is integer (1) previously<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">1 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"bob3"</span><span style="color: #007700">;                </span><span style="color: #FF8000">// TypeError as of PHP 8.0.0, $foo is integer (1) previously<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">1 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"10 Small Pigs"</span><span style="color: #007700">;       </span><span style="color: #FF8000">// $foo is integer (11) and an E_WARNING is raised in PHP 8.0.0, E_NOTICE previously<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #0000BB">4 </span><span style="color: #007700">+ </span><span style="color: #DD0000">"10.2 Little Piggies"</span><span style="color: #007700">; </span><span style="color: #FF8000">// $foo is float (14.2) and an E_WARNING is raised in PHP 8.0.0, E_NOTICE previously<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #DD0000">"10.0 pigs " </span><span style="color: #007700">+ </span><span style="color: #0000BB">1</span><span style="color: #007700">;          </span><span style="color: #FF8000">// $foo is float (11) and an E_WARNING is raised in PHP 8.0.0, E_NOTICE previously<br /></span><span style="color: #0000BB">$foo </span><span style="color: #007700">= </span><span style="color: #DD0000">"10.0 pigs " </span><span style="color: #007700">+ </span><span style="color: #0000BB">1.0</span><span style="color: #007700">;        </span><span style="color: #FF8000">// $foo is float (11) and an E_WARNING is raised in PHP 8.0.0, E_NOTICE previously<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/types/numeric-strings.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types.numeric-strings%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.numeric-strings&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.numeric-strings.php">＋<small>add a note</small></a></span>
