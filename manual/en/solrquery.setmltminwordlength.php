...
<head>
  ...
  <title>PHP: SolrQuery::setMltMinWordLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setomitheader.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltminwordlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltminwordlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltminwordlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltminwordlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltminwordlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltminwordlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltminwordlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltminwordlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltminwordlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltminwordlength.php" hreflang="zh">
...
<meta name="Description" content="Sets the minimum word length" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMinWordLength - Manual" />
<meta name="twitter:description" content="Sets the minimum word length" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMinWordLength - Manual" />
<meta itemprop="description" content="Sets the minimum word length" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the minimum word length" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setomitheader.php">
          SolrQuery::setOmitHeader &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltmintermfrequency.php">
          &laquo; SolrQuery::setMltMinTermFrequency        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltminwordlength.php' selected="selected">English</option>
            <option value='de/solrquery.setmltminwordlength.php'>German</option>
            <option value='es/solrquery.setmltminwordlength.php'>Spanish</option>
            <option value='fr/solrquery.setmltminwordlength.php'>French</option>
            <option value='it/solrquery.setmltminwordlength.php'>Italian</option>
            <option value='ja/solrquery.setmltminwordlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltminwordlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltminwordlength.php'>Russian</option>
            <option value='tr/solrquery.setmltminwordlength.php'>Turkish</option>
            <option value='uk/solrquery.setmltminwordlength.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltminwordlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltminwordlength" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-solrquery.setmltminwordlength-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMinWordLength</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$minWordLength</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltminwordlength-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">minWordLength</code></dt>
     <dd>
      <p class="para">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltminwordlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltminwordlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltminwordlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltminwordlength.php">＋<small>add a note</small></a></span>
