...
<head>
  ...
  <title>PHP: eio_chown - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-chown.php">
 <link rel="shorturl" href="https://www.php.net/eio-chown">
 <link rel="alternate" href="https://www.php.net/eio-chown" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-chmod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-chown.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-chown.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-chown.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-chown.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-chown.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-chown.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-chown.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-chown.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-chown.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-chown.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-chown.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_chown - Manual" />
<meta name="twitter:description" content="Change file/directory permissions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_chown - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-close.php">
          eio_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-chmod.php">
          &laquo; eio_chmod        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-chown.php' selected="selected">English</option>
            <option value='de/function.eio-chown.php'>German</option>
            <option value='es/function.eio-chown.php'>Spanish</option>
            <option value='fr/function.eio-chown.php'>French</option>
            <option value='it/function.eio-chown.php'>Italian</option>
            <option value='ja/function.eio-chown.php'>Japanese</option>
            <option value='pt_BR/function.eio-chown.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-chown.php'>Russian</option>
            <option value='tr/function.eio-chown.php'>Turkish</option>
            <option value='uk/function.eio-chown.php'>Ukrainian</option>
            <option value='zh/function.eio-chown.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-chown" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_chown</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_chown</span> &mdash; <span class="dc-title">Change file/directory permissions</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-chown-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_chown</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$uid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$gid</code><span class="initializer"> = -1</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-chown-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-chown-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_chown()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>



 <div class="refsect1 seealso" id="refsect1-function.eio-chown-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-chmod.php" class="function" rel="rdfs-seeAlso">eio_chmod()</a> - Change file/directory permissions</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-chown.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-chown%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-chown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-chown.php">＋<small>add a note</small></a></span>
