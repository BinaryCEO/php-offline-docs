...
<head>
  ...
  <title>PHP: Imagick::steganoImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.steganoimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.steganoimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.steganoimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.statisticimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.stereoimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.steganoimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.steganoimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.steganoimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.steganoimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.steganoimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.steganoimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.steganoimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.steganoimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.steganoimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.steganoimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.steganoimage.php" hreflang="zh">
...
<meta name="Description" content="Hides a digital watermark within the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::steganoImage - Manual" />
<meta name="twitter:description" content="Hides a digital watermark within the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::steganoImage - Manual" />
<meta itemprop="description" content="Hides a digital watermark within the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hides a digital watermark within the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.stereoimage.php">
          Imagick::stereoImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.statisticimage.php">
          &laquo; Imagick::statisticImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.steganoimage.php' selected="selected">English</option>
            <option value='de/imagick.steganoimage.php'>German</option>
            <option value='es/imagick.steganoimage.php'>Spanish</option>
            <option value='fr/imagick.steganoimage.php'>French</option>
            <option value='it/imagick.steganoimage.php'>Italian</option>
            <option value='ja/imagick.steganoimage.php'>Japanese</option>
            <option value='pt_BR/imagick.steganoimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.steganoimage.php'>Russian</option>
            <option value='tr/imagick.steganoimage.php'>Turkish</option>
            <option value='uk/imagick.steganoimage.php'>Ukrainian</option>
            <option value='zh/imagick.steganoimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.steganoimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::steganoImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::steganoImage</span> &mdash; <span class="dc-title">Hides a digital watermark within the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.steganoimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::steganoImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$watermark_wand</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.steganoimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">watermark_wand</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.steganoimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/steganoimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.steganoimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.steganoimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.steganoimage.php">＋<small>add a note</small></a></span>
