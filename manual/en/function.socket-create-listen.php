...
<head>
  ...
  <title>PHP: socket_create_listen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-create-listen.php">
 <link rel="shorturl" href="https://www.php.net/socket-create-listen">
 <link rel="alternate" href="https://www.php.net/socket-create-listen" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-create.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-create-pair.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-create-listen.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-create-listen.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-create-listen.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-create-listen.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-create-listen.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-create-listen.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-create-listen.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-create-listen.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-create-listen.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-create-listen.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-create-listen.php" hreflang="zh">
...
<meta name="Description" content="Opens a socket on port to accept connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_create_listen - Manual" />
<meta name="twitter:description" content="Opens a socket on port to accept connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_create_listen - Manual" />
<meta itemprop="description" content="Opens a socket on port to accept connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a socket on port to accept connections" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.socket-create-pair.php">
          socket_create_pair &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-create.php">
          &laquo; socket_create        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-create-listen.php' selected="selected">English</option>
            <option value='de/function.socket-create-listen.php'>German</option>
            <option value='es/function.socket-create-listen.php'>Spanish</option>
            <option value='fr/function.socket-create-listen.php'>French</option>
            <option value='it/function.socket-create-listen.php'>Italian</option>
            <option value='ja/function.socket-create-listen.php'>Japanese</option>
            <option value='pt_BR/function.socket-create-listen.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-create-listen.php'>Russian</option>
            <option value='tr/function.socket-create-listen.php'>Turkish</option>
            <option value='uk/function.socket-create-listen.php'>Ukrainian</option>
            <option value='zh/function.socket-create-listen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-create-listen" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-create-listen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-create-listen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-create-listen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-create-listen.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="44187">  <div class="votes">
    <div id="Vu44187">
    <a href="/manual/vote-note.php?id=44187&amp;page=function.socket-create-listen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd44187">
    <a href="/manual/vote-note.php?id=44187&amp;page=function.socket-create-listen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V44187" title="61% like this...">
    10
    </div>
  </div>
  <a href="#44187" class="name">
  <strong class="user"><em>jdittmer at ppp0 dot net</em></strong></a><a class="genanchor" href="#44187"> &para;</a><div class="date" title="2004-07-17 04:42"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom44187">
<div class="phpcode"><code><span class="html">If you specify no port number, or 0, a random free port will be chosen.
<br />To use ports for ipc between client/server on the same machine you can use (minus error checking)
<br />
<br />server.php:
<br /><span class="default">&lt;?php
<br />$sock </span><span class="keyword">= </span><span class="default">socket_create_listen</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);
<br /></span><span class="default">socket_getsockname</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="default">$addr</span><span class="keyword">, </span><span class="default">$port</span><span class="keyword">);
<br />print </span><span class="string">"Server Listening on </span><span class="default">$addr</span><span class="string">:</span><span class="default">$port</span><span class="string">\n"</span><span class="keyword">;
<br /></span><span class="default">$fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$port_file</span><span class="keyword">, </span><span class="string">'w'</span><span class="keyword">);
<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">$port</span><span class="keyword">);
<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);
<br />while(</span><span class="default">$c </span><span class="keyword">= </span><span class="default">socket_accept</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">)) {
<br />   </span><span class="comment">/* do something useful */
<br />   </span><span class="default">socket_getpeername</span><span class="keyword">(</span><span class="default">$c</span><span class="keyword">, </span><span class="default">$raddr</span><span class="keyword">, </span><span class="default">$rport</span><span class="keyword">);
<br />   print </span><span class="string">"Received Connection from </span><span class="default">$raddr</span><span class="string">:</span><span class="default">$rport</span><span class="string">\n"</span><span class="keyword">;
<br />}
...
<br />client.php:
<br /><span class="default">&lt;?php
<br />$fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$port_file</span><span class="keyword">, </span><span class="string">'r'</span><span class="keyword">);
<br /></span><span class="default">$port </span><span class="keyword">= </span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">1024</span><span class="keyword">);
<br /></span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);
<br /></span><span class="default">$sock </span><span class="keyword">= </span><span class="default">socket_create</span><span class="keyword">(</span><span class="default">AF_INET</span><span class="keyword">, </span><span class="default">SOCK_STREAM</span><span class="keyword">, </span><span class="default">SOL_TCP</span><span class="keyword">);
<br /></span><span class="default">socket_connect</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">, </span><span class="string">'127.0.0.1'</span><span class="keyword">, </span><span class="default">$port</span><span class="keyword">);
<br /></span><span class="default">socket_close</span><span class="keyword">(</span><span class="default">$sock</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="81623">  <div class="votes">
    <div id="Vu81623">
    <a href="/manual/vote-note.php?id=81623&amp;page=function.socket-create-listen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81623">
    <a href="/manual/vote-note.php?id=81623&amp;page=function.socket-create-listen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81623" title="59% like this...">
    4
    </div>
  </div>
  <a href="#81623" class="name">
  <strong class="user"><em>sysspoof at ng-lab dot org</em></strong></a><a class="genanchor" href="#81623"> &para;</a><div class="date" title="2008-03-06 11:03"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81623">
<div class="phpcode"><code><span class="html">Please note that port 1 to and with 1024 on linux and bsd system require root privileges. So it is recommended to choose a higher port for your own application.</span></code></div>
  </div>
 </div>
  <div class="note" id="39669">  <div class="votes">
    <div id="Vu39669">
    <a href="/manual/vote-note.php?id=39669&amp;page=function.socket-create-listen&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd39669">
    <a href="/manual/vote-note.php?id=39669&amp;page=function.socket-create-listen&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V39669" title="54% like this...">
    2
    </div>
  </div>
  <a href="#39669" class="name">
  <strong class="user"><em>basim at baassiri dot com</em></strong></a><a class="genanchor" href="#39669"> &para;</a><div class="date" title="2004-02-06 02:50"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom39669">
<div class="phpcode"><code><span class="html">Remember that ports are only valid from 1 - 65535
<br />
<br />[editor's note: typo fixed, thanks abryant at apple dot com]</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-create-listen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-create-listen.php">＋<small>add a note</small></a></div>
