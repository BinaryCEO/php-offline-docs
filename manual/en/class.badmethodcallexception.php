...
<head>
  ...
  <title>PHP: BadMethodCallException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.badmethodcallexception.php">
 <link rel="shorturl" href="https://www.php.net/badmethodcallexception">
 <link rel="alternate" href="https://www.php.net/badmethodcallexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.badfunctioncallexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domainexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.badmethodcallexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.badmethodcallexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.badmethodcallexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.badmethodcallexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.badmethodcallexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.badmethodcallexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.badmethodcallexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.badmethodcallexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.badmethodcallexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.badmethodcallexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.badmethodcallexception.php" hreflang="zh">
...
<meta name="Description" content="The BadMethodCallException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: BadMethodCallException - Manual" />
<meta name="twitter:description" content="The BadMethodCallException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: BadMethodCallException - Manual" />
<meta itemprop="description" content="The BadMethodCallException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The BadMethodCallException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.domainexception.php">
          DomainException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.badfunctioncallexception.php">
          &laquo; BadFunctionCallException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.badmethodcallexception.php' selected="selected">English</option>
            <option value='de/class.badmethodcallexception.php'>German</option>
            <option value='es/class.badmethodcallexception.php'>Spanish</option>
            <option value='fr/class.badmethodcallexception.php'>French</option>
            <option value='it/class.badmethodcallexception.php'>Italian</option>
            <option value='ja/class.badmethodcallexception.php'>Japanese</option>
            <option value='pt_BR/class.badmethodcallexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.badmethodcallexception.php'>Russian</option>
            <option value='tr/class.badmethodcallexception.php'>Turkish</option>
            <option value='uk/class.badmethodcallexception.php'>Ukrainian</option>
            <option value='zh/class.badmethodcallexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.badmethodcallexception" class="reference">
 <h1 class="title">The BadMethodCallException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="badmethodcallexception.intro">
  ...
  <div class="section" id="badmethodcallexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">BadMethodCallException</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.badfunctioncallexception.php" class="classname">BadFunctionCallException</a>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/badmethodcallexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.badmethodcallexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.badmethodcallexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.badmethodcallexception.php">＋<small>add a note</small></a></span>
