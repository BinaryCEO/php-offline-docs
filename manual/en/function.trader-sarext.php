...
<head>
  ...
  <title>PHP: trader_sarext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-sarext.php">
 <link rel="shorturl" href="https://www.php.net/trader-sarext">
 <link rel="alternate" href="https://www.php.net/trader-sarext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-sar.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-set-compat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-sarext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-sarext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-sarext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-sarext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-sarext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-sarext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-sarext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-sarext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-sarext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-sarext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-sarext.php" hreflang="zh">
...
<meta name="Description" content="Parabolic SAR - Extended" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_sarext - Manual" />
<meta name="twitter:description" content="Parabolic SAR - Extended" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_sarext - Manual" />
<meta itemprop="description" content="Parabolic SAR - Extended" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parabolic SAR - Extended" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-set-compat.php">
          trader_set_compat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-sar.php">
          &laquo; trader_sar        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-sarext.php' selected="selected">English</option>
            <option value='de/function.trader-sarext.php'>German</option>
            <option value='es/function.trader-sarext.php'>Spanish</option>
            <option value='fr/function.trader-sarext.php'>French</option>
            <option value='it/function.trader-sarext.php'>Italian</option>
            <option value='ja/function.trader-sarext.php'>Japanese</option>
            <option value='pt_BR/function.trader-sarext.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-sarext.php'>Russian</option>
            <option value='tr/function.trader-sarext.php'>Turkish</option>
            <option value='uk/function.trader-sarext.php'>Ukrainian</option>
            <option value='zh/function.trader-sarext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-sarext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_sarext</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_sarext</span> &mdash; <span class="dc-title">Parabolic SAR - Extended</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.trader-sarext-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_sarext</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$startValue</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$offsetOnReverse</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationInitLong</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationLong</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationMaxLong</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationInitShort</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationShort</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$accelerationMaxShort</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-sarext-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">startValue</code></dt>
    <dd>
     <p class="para">
       Start value and direction. 0 for Auto, &gt;0 for Long, &lt;0 for Short. Valid range from <a href="trader.constants.php#constant.trader-real-min" class="link">TRADER_REAL_MIN</a> to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">offsetOnReverse</code></dt>
    <dd>
     <p class="para">
      Percent offset added/removed to initial stop on short/long reversal. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationInitLong</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor initial value for the Long direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationLong</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor for the Long direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationMaxLong</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor maximum value for the Long direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationInitShort</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor initial value for the Short direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationShort</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor for the Short direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
   
   
    <dt><code class="parameter">accelerationMaxShort</code></dt>
    <dd>
     <p class="para">
      Acceleration Factor maximum value for the Short direction. Valid range from 0 to <a href="trader.constants.php#constant.trader-real-max" class="link">TRADER_REAL_MAX</a>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-sarext-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-sarext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-sarext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-sarext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-sarext.php">＋<small>add a note</small></a></span>
