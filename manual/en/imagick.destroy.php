...
<head>
  ...
  <title>PHP: Imagick::destroy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.destroy.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.destroy.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.destroy.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.despeckleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.displayimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.destroy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.destroy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.destroy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.destroy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.destroy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.destroy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.destroy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.destroy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.destroy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.destroy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.destroy.php" hreflang="zh">
...
<meta name="Description" content="Destroys the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::destroy - Manual" />
<meta name="twitter:description" content="Destroys the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::destroy - Manual" />
<meta itemprop="description" content="Destroys the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Destroys the Imagick object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.displayimage.php">
          Imagick::displayImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.despeckleimage.php">
          &laquo; Imagick::despeckleImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.destroy.php' selected="selected">English</option>
            <option value='de/imagick.destroy.php'>German</option>
            <option value='es/imagick.destroy.php'>Spanish</option>
            <option value='fr/imagick.destroy.php'>French</option>
            <option value='it/imagick.destroy.php'>Italian</option>
            <option value='ja/imagick.destroy.php'>Japanese</option>
            <option value='pt_BR/imagick.destroy.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.destroy.php'>Russian</option>
            <option value='tr/imagick.destroy.php'>Turkish</option>
            <option value='uk/imagick.destroy.php'>Ukrainian</option>
            <option value='zh/imagick.destroy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.destroy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::destroy</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::destroy</span> &mdash; <span class="dc-title">Destroys the Imagick object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.destroy-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::destroy</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Destroys the Imagick object and frees all resources associated with it. 
   This method is deprecated in favour of <a href="imagick.clear.php" class="link">Imagick::clear</a>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.destroy-parameters">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/destroy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.destroy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.destroy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.destroy.php">＋<small>add a note</small></a></span>
