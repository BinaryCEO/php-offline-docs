...
<head>
  ...
  <title>PHP: SolrQuery::getExpandQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getexpandquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getexpandquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getexpandfilterqueries.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getexpandrows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getexpandquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getexpandquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getexpandquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getexpandquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getexpandquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getexpandquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getexpandquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getexpandquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getexpandquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getexpandquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getexpandquery.php" hreflang="zh">
...
<meta name="Description" content="Returns the expand query expand.q parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getExpandQuery - Manual" />
<meta name="twitter:description" content="Returns the expand query expand.q parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getExpandQuery - Manual" />
<meta itemprop="description" content="Returns the expand query expand.q parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the expand query expand.q parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getexpandrows.php">
          SolrQuery::getExpandRows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getexpandfilterqueries.php">
          &laquo; SolrQuery::getExpandFilterQueries        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getexpandquery.php' selected="selected">English</option>
            <option value='de/solrquery.getexpandquery.php'>German</option>
            <option value='es/solrquery.getexpandquery.php'>Spanish</option>
            <option value='fr/solrquery.getexpandquery.php'>French</option>
            <option value='it/solrquery.getexpandquery.php'>Italian</option>
            <option value='ja/solrquery.getexpandquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.getexpandquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getexpandquery.php'>Russian</option>
            <option value='tr/solrquery.getexpandquery.php'>Turkish</option>
            <option value='uk/solrquery.getexpandquery.php'>Ukrainian</option>
            <option value='zh/solrquery.getexpandquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getexpandquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getExpandQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getExpandQuery</span> &mdash; <span class="dc-title">Returns the expand query expand.q parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getexpandquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getExpandQuery</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getexpandquery-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getexpandquery-returnvalues">
  ...
  <p class="para">
   Returns the expand query.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getexpandquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getexpandquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getexpandquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getexpandquery.php">＋<small>add a note</small></a></span>
