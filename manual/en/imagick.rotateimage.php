...
<head>
  ...
  <title>PHP: Imagick::rotateImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.rotateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.rotateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rotateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.rollimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rotateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.rotateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.rotateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.rotateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.rotateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.rotateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.rotateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.rotateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.rotateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.rotateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.rotateimage.php" hreflang="zh">
...
<meta name="Description" content="Rotates an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::rotateImage - Manual" />
<meta name="twitter:description" content="Rotates an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::rotateImage - Manual" />
<meta itemprop="description" content="Rotates an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rotates an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.rotationalblurimage.php">
          Imagick::rotationalBlurImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.rollimage.php">
          &laquo; Imagick::rollImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.rotateimage.php' selected="selected">English</option>
            <option value='de/imagick.rotateimage.php'>German</option>
            <option value='es/imagick.rotateimage.php'>Spanish</option>
            <option value='fr/imagick.rotateimage.php'>French</option>
            <option value='it/imagick.rotateimage.php'>Italian</option>
            <option value='ja/imagick.rotateimage.php'>Japanese</option>
            <option value='pt_BR/imagick.rotateimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.rotateimage.php'>Russian</option>
            <option value='tr/imagick.rotateimage.php'>Turkish</option>
            <option value='uk/imagick.rotateimage.php'>Ukrainian</option>
            <option value='zh/imagick.rotateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.rotateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::rotateImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::rotateImage</span> &mdash; <span class="dc-title">Rotates an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.rotateimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::rotateImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$background</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.rotateimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">background</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">degrees</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.rotateimage-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.rotateimage-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.rotateimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3081">
      <p><strong>Example #1  <span class="function"><strong>Imagick::rotateImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/rotateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.rotateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.rotateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.rotateimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119455">  <div class="votes">
    <div id="Vu119455">
    <a href="/manual/vote-note.php?id=119455&amp;page=imagick.rotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119455">
    <a href="/manual/vote-note.php?id=119455&amp;page=imagick.rotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119455" title="72% like this...">
    5
    </div>
  </div>
  <a href="#119455" class="name">
  <strong class="user"><em>gleb dot deykalo at gmail dot com</em></strong></a><a class="genanchor" href="#119455"> &para;</a><div class="date" title="2016-06-10 12:59"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119455">
<div class="phpcode"><code><span class="html">Some transformations including Imagick ::rotateImage() may change "image page" -- working area inside the image you work on.<br /><br />Be careful with future modifications afterwards because the image page would be different from new sizes of the image.<br /><br />For example, if you do Imagic::cropImage() after rotation, you need to set image page properly, otherwise your crop would be performed relating to wrong coordinates (depending on rotation angle, resulting image size may vary).<br /><br /><span class="default">&lt;?php<br />$Image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$sourceImagePath</span><span class="keyword">);<br /><br /></span><span class="default">$transparent </span><span class="keyword">= </span><span class="string">'#00000000'</span><span class="keyword">;<br /></span><span class="default">$Image</span><span class="keyword">-&gt;</span><span class="default">rotateImage</span><span class="keyword">(new </span><span class="default">\ImagickPixel</span><span class="keyword">(), </span><span class="default">45</span><span class="keyword">); </span><span class="comment">// This makes resulting image bigger<br /><br />// Set page to be of the full size of new image, starting at top left corner (0, 0)<br /></span><span class="default">$Image</span><span class="keyword">-&gt;</span><span class="default">setImagePage</span><span class="keyword">(</span><span class="default">$Image</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">(), </span><span class="default">$Image</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">(), </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="default">$Image</span><span class="keyword">-&gt;</span><span class="default">cropImage</span><span class="keyword">(</span><span class="default">$crop_w</span><span class="keyword">, </span><span class="default">$crop_h</span><span class="keyword">, </span><span class="default">$crop_x</span><span class="keyword">, </span><span class="default">$crop_y</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="119184">  <div class="votes">
    <div id="Vu119184">
    <a href="/manual/vote-note.php?id=119184&amp;page=imagick.rotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119184">
    <a href="/manual/vote-note.php?id=119184&amp;page=imagick.rotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119184" title="64% like this...">
    4
    </div>
  </div>
  <a href="#119184" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#119184"> &para;</a><div class="date" title="2016-04-17 10:43"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119184">
<div class="phpcode"><code><span class="html">The degrees for imagick and gd is difference!<br />GD &gt; rotate 90 means counter clockwise.<br />Imagick &gt; rotate 90 means clockwise.<br /><br />GD 90 = Imagick 270 or Imagick 90 = GD 270.<br /><br />Use this function.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)<br />{<br />    if (</span><span class="default">$value </span><span class="keyword">== </span><span class="default">0 </span><span class="keyword">|| </span><span class="default">$value </span><span class="keyword">== </span><span class="default">180</span><span class="keyword">) {<br />        return </span><span class="default">$value</span><span class="keyword">;<br />    }<br />    if (</span><span class="default">$value </span><span class="keyword">&lt; </span><span class="default">0 </span><span class="keyword">|| </span><span class="default">$value </span><span class="keyword">&gt; </span><span class="default">360</span><span class="keyword">) {<br />        </span><span class="default">$value </span><span class="keyword">= </span><span class="default">90</span><span class="keyword">;<br />    }<br /><br />    </span><span class="default">$total_degree </span><span class="keyword">= </span><span class="default">360</span><span class="keyword">;<br />    </span><span class="default">$output </span><span class="keyword">= </span><span class="default">intval</span><span class="keyword">(</span><span class="default">$total_degree</span><span class="keyword">-</span><span class="default">$value</span><span class="keyword">);<br />    return </span><span class="default">$output</span><span class="keyword">;<br />}</span><span class="comment">// calculateCounterClockwise<br /><br /></span><span class="keyword">echo </span><span class="string">'1 = '</span><span class="keyword">.</span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">).</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />echo </span><span class="string">'90 = '</span><span class="keyword">.</span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">90</span><span class="keyword">).</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />echo </span><span class="string">'270 = '</span><span class="keyword">.</span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">270</span><span class="keyword">).</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />echo </span><span class="string">'359 = '</span><span class="keyword">.</span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">359</span><span class="keyword">).</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />echo </span><span class="string">'360 = '</span><span class="keyword">.</span><span class="default">calculateCounterClockwise</span><span class="keyword">(</span><span class="default">360</span><span class="keyword">).</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />test results:<br />1 = 359<br />90 = 270<br />270 = 90<br />359 = 1<br />360 = 0</span></code></div>
  </div>
 </div>
  <div class="note" id="110214">  <div class="votes">
    <div id="Vu110214">
    <a href="/manual/vote-note.php?id=110214&amp;page=imagick.rotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110214">
    <a href="/manual/vote-note.php?id=110214&amp;page=imagick.rotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110214" title="57% like this...">
    2
    </div>
  </div>
  <a href="#110214" class="name">
  <strong class="user"><em>AlexG</em></strong></a><a class="genanchor" href="#110214"> &para;</a><div class="date" title="2012-10-01 03:56"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110214">
<div class="phpcode"><code><span class="html">Transparent 
<br />
<br /><span class="default">&lt;?php $im</span><span class="keyword">-&gt;</span><span class="default">rotateImage</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'#00000000'</span><span class="keyword">), </span><span class="default">75</span><span class="keyword">); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="87177">  <div class="votes">
    <div id="Vu87177">
    <a href="/manual/vote-note.php?id=87177&amp;page=imagick.rotateimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87177">
    <a href="/manual/vote-note.php?id=87177&amp;page=imagick.rotateimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87177" title="55% like this...">
    1
    </div>
  </div>
  <a href="#87177" class="name">
  <strong class="user"><em>wjsams at gmail dot com</em></strong></a><a class="genanchor" href="#87177"> &para;</a><div class="date" title="2008-11-22 09:49"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87177">
<div class="phpcode"><code><span class="html">If you want to rotate an image by a certain degree you can do this:
<br />
<br /><span class="default">&lt;?php
<br />header</span><span class="keyword">(</span><span class="string">'content-type: image/jpeg'</span><span class="keyword">);
<br /></span><span class="default">$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'castle.jpg'</span><span class="keyword">);
<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">rotateImage</span><span class="keyword">(new </span><span class="default">ImagickPixel</span><span class="keyword">(), </span><span class="default">90</span><span class="keyword">);
<br />print </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">getImage</span><span class="keyword">();
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.rotateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.rotateimage.php">＋<small>add a note</small></a></div>
