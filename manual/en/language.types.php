...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.types.php">
 <link rel="shorturl" href="https://www.php.net/types">
 <link rel="alternate" href="https://www.php.net/types" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/langref.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.basic-syntax.comments.php">
 <link rel="next" href="https://www.php.net/manual/en/language.types.intro.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.types.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.types.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.types.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.types.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.types.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.types.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.types.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.types.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.types.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.types.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.types.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Types - Manual" />
<meta name="twitter:description" content="Types" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Types - Manual" />
<meta itemprop="description" content="Types" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.types.php' selected="selected">English</option>
            ...
            <option value='it/language.types.php'>Italian</option>
            ...
            <option value='uk/language.types.php'>Ukrainian</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="language.types.intro.php">Introduction</a></li><li><a href="language.types.type-system.php">Type System</a></li><li><a href="language.types.null.php">NULL</a></li><li><a href="language.types.boolean.php">Booleans</a></li><li><a href="language.types.integer.php">Integers</a></li><li><a href="language.types.float.php">Floating point numbers</a></li><li><a href="language.types.string.php">Strings</a></li><li><a href="language.types.numeric-strings.php">Numeric strings</a></li><li><a href="language.types.array.php">Arrays</a></li><li><a href="language.types.object.php">Objects</a></li><li><a href="language.types.enumerations.php">Enumerations</a></li><li><a href="language.types.resource.php">Resources</a></li><li><a href="language.types.callable.php">Callbacks / Callables</a></li><li><a href="language.types.mixed.php">Mixed</a></li><li><a href="language.types.void.php">Void</a></li><li><a href="language.types.never.php">Never</a></li><li><a href="language.types.relative-class-types.php">Relative class types</a></li><li><a href="language.types.singleton.php">Singleton types</a></li><li><a href="language.types.iterable.php">Iterables</a></li><li><a href="language.types.declarations.php">Type declarations</a></li><li><a href="language.types.type-juggling.php">Type Juggling</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.php">＋<small>add a note</small></a></span>
