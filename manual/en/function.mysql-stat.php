...
<head>
  ...
  <title>PHP: mysql_stat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-stat.php">
 <link rel="shorturl" href="https://www.php.net/mysql-stat">
 <link rel="alternate" href="https://www.php.net/mysql-stat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-set-charset.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-tablename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-stat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-stat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-stat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-stat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-stat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-stat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-stat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-stat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-stat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-stat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-stat.php" hreflang="zh">
...
<meta name="Description" content="Get current system status" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_stat - Manual" />
<meta name="twitter:description" content="Get current system status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_stat - Manual" />
<meta itemprop="description" content="Get current system status" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get current system status" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-tablename.php">
          mysql_tablename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-set-charset.php">
          &laquo; mysql_set_charset        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-stat.php' selected="selected">English</option>
            <option value='de/function.mysql-stat.php'>German</option>
            <option value='es/function.mysql-stat.php'>Spanish</option>
            <option value='fr/function.mysql-stat.php'>French</option>
            <option value='it/function.mysql-stat.php'>Italian</option>
            <option value='ja/function.mysql-stat.php'>Japanese</option>
            <option value='pt_BR/function.mysql-stat.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-stat.php'>Russian</option>
            <option value='tr/function.mysql-stat.php'>Turkish</option>
            <option value='uk/function.mysql-stat.php'>Ukrainian</option>
            <option value='zh/function.mysql-stat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-stat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_stat</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_stat</span> &mdash; <span class="dc-title">Get current system status</span></p>
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    ...
    <li>
     ...
     with <code class="parameter">attribute</code> as <strong><code><a href="pdo.constants.php#pdo.constants.attr-server-info">PDO::ATTR_SERVER_INFO</a></code></strong>
    </li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-stat-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_stat()</strong></span> returns the current server status.
  </p>
 </div>
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-stat-returnvalues">
  ...
  <p class="para">
   ...
   variables, you have to use the <code class="literal">SHOW STATUS</code> SQL command.
   If <code class="parameter">link_identifier</code> is invalid, <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> is returned.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-stat-examples">
  ...
  <p class="para">
   <div class="example" id="example-1925">
    <p><strong>Example #1 <span class="function"><strong>mysql_stat()</strong></span> example</strong></p>
...
(
  ...
  <p class="para">
   <div class="example" id="example-1926">
    <p><strong>Example #2 Alternative <span class="function"><strong>mysql_stat()</strong></span> example</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-list-processes.php" class="function" rel="rdfs-seeAlso">mysql_list_processes()</a> - List MySQL processes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-stat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-stat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-stat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-stat.php">＋<small>add a note</small></a></span>
