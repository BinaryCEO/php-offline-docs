...
<head>
  ...
  <title>PHP: Imagick::hasNextImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.hasnextimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.hasnextimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.hasnextimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.haldclutimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.haspreviousimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.hasnextimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.hasnextimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.hasnextimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.hasnextimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.hasnextimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.hasnextimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.hasnextimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.hasnextimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.hasnextimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.hasnextimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.hasnextimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::hasNextImage - Manual" />
<meta name="twitter:description" content="Checks if the object has more images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::hasNextImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.haspreviousimage.php">
          Imagick::hasPreviousImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.haldclutimage.php">
          &laquo; Imagick::haldClutImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.hasnextimage.php' selected="selected">English</option>
            <option value='de/imagick.hasnextimage.php'>German</option>
            <option value='es/imagick.hasnextimage.php'>Spanish</option>
            <option value='fr/imagick.hasnextimage.php'>French</option>
            <option value='it/imagick.hasnextimage.php'>Italian</option>
            <option value='ja/imagick.hasnextimage.php'>Japanese</option>
            <option value='pt_BR/imagick.hasnextimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.hasnextimage.php'>Russian</option>
            <option value='tr/imagick.hasnextimage.php'>Turkish</option>
            <option value='uk/imagick.hasnextimage.php'>Ukrainian</option>
            <option value='zh/imagick.hasnextimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.hasnextimage" class="refentry">
  ...
  <p class="para">
   ...
   forward direction, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there are none.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/hasnextimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.hasnextimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.hasnextimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.hasnextimage.php">＋<small>add a note</small></a></span>
