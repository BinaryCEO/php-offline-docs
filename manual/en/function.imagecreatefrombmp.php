...
<head>
  ...
  <title>PHP: imagecreatefrombmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefrombmp.php">
 <link rel="shorturl" href="https://www.php.net/imagecreatefrombmp">
 <link rel="alternate" href="https://www.php.net/imagecreatefrombmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatefromavif.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatefromgd.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecreatefrombmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecreatefrombmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecreatefrombmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecreatefrombmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecreatefrombmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecreatefrombmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecreatefrombmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecreatefrombmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecreatefrombmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecreatefrombmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecreatefrombmp.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecreatefrombmp - Manual" />
<meta name="twitter:description" content="Create a new image from file or URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecreatefrombmp - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagecreatefromgd.php">
          imagecreatefromgd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecreatefromavif.php">
          &laquo; imagecreatefromavif        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefrombmp.php' selected="selected">English</option>
            <option value='de/function.imagecreatefrombmp.php'>German</option>
            <option value='es/function.imagecreatefrombmp.php'>Spanish</option>
            <option value='fr/function.imagecreatefrombmp.php'>French</option>
            <option value='it/function.imagecreatefrombmp.php'>Italian</option>
            <option value='ja/function.imagecreatefrombmp.php'>Japanese</option>
            <option value='pt_BR/function.imagecreatefrombmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecreatefrombmp.php'>Russian</option>
            <option value='tr/function.imagecreatefrombmp.php'>Turkish</option>
            <option value='uk/function.imagecreatefrombmp.php'>Ukrainian</option>
            <option value='zh/function.imagecreatefrombmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecreatefrombmp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecreatefrombmp</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">imagecreatefrombmp</span> &mdash; <span class="dc-title">Create a new image from file or URL</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.imagecreatefrombmp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecreatefrombmp</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagecreatefrombmp()</strong></span> returns an image identifier
...
provide.</p></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imagecreatefrombmp-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecreatefrombmp-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecreatefrombmp-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecreatefrombmp-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2864">
    <p><strong>Example #1 Convert an BMP image to a PNG image using <span class="function"><strong>imagecreatefrombmp()</strong></span></strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Load the BMP file<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefrombmp</span><span style="color: #007700">(</span><span style="color: #DD0000">'./example.bmp'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Convert it to a PNG file with default settings<br /></span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'./example.png'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefrombmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefrombmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefrombmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefrombmp.php">＋<small>add a note</small></a></span>
