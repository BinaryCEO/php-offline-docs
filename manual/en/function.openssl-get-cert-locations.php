...
<head>
  ...
  <title>PHP: openssl_get_cert_locations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-get-cert-locations.php">
 <link rel="shorturl" href="https://www.php.net/openssl-get-cert-locations">
 <link rel="alternate" href="https://www.php.net/openssl-get-cert-locations" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-free-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-get-cipher-methods.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-get-cert-locations.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-get-cert-locations.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-get-cert-locations.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-get-cert-locations.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-get-cert-locations.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-get-cert-locations.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-get-cert-locations.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-get-cert-locations.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-get-cert-locations.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-get-cert-locations.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-get-cert-locations.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the available certificate locations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_get_cert_locations - Manual" />
<meta name="twitter:description" content="Retrieve the available certificate locations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_get_cert_locations - Manual" />
<meta itemprop="description" content="Retrieve the available certificate locations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the available certificate locations" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-get-cipher-methods.php">
          openssl_get_cipher_methods &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-free-key.php">
          &laquo; openssl_free_key        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-get-cert-locations.php' selected="selected">English</option>
            <option value='de/function.openssl-get-cert-locations.php'>German</option>
            <option value='es/function.openssl-get-cert-locations.php'>Spanish</option>
            <option value='fr/function.openssl-get-cert-locations.php'>French</option>
            <option value='it/function.openssl-get-cert-locations.php'>Italian</option>
            <option value='ja/function.openssl-get-cert-locations.php'>Japanese</option>
            <option value='pt_BR/function.openssl-get-cert-locations.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-get-cert-locations.php'>Russian</option>
            <option value='tr/function.openssl-get-cert-locations.php'>Turkish</option>
            <option value='uk/function.openssl-get-cert-locations.php'>Ukrainian</option>
            <option value='zh/function.openssl-get-cert-locations.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-get-cert-locations" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_get_cert_locations</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_get_cert_locations</span> &mdash; <span class="dc-title">Retrieve the available certificate locations</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-get-cert-locations-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_get_cert_locations</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<div class="examplescode"><pre class="examplescode">array(8) {
  ...
  string(0) &quot;&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-get-cert-locations.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-get-cert-locations%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-get-cert-locations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-get-cert-locations.php">＋<small>add a note</small></a></span>
