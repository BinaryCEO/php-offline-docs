...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.hash.php">
 ...
 <link rel="index" href="https://www.php.net/manual/en/book.hash.php">
 <link rel="prev" href="https://www.php.net/manual/en/hashcontext.unserialize.php">
 <link rel="next" href="https://www.php.net/manual/en/function.hash.php">
...
<meta name="Description" content="Hash Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Hash Functions - Manual" />
<meta name="twitter:description" content="Hash Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Hash Functions - Manual" />
<meta itemprop="description" content="Hash Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Hash Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="hashcontext.unserialize.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.crypto.php'>Cryptography Extensions</a></li>      <li><a href='book.hash.php'>Hash</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.hash.php' selected="selected">English</option>
            ...
            <option value='ja/ref.hash.php'>Japanese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.hash.php">hash</a> — Generate a hash value (message digest)</li><li><a href="function.hash-algos.php">hash_algos</a> — Return a list of registered hashing algorithms</li><li><a href="function.hash-copy.php">hash_copy</a> — Copy hashing context</li><li><a href="function.hash-equals.php">hash_equals</a> — Timing attack safe string comparison</li><li><a href="function.hash-file.php">hash_file</a> — Generate a hash value using the contents of a given file</li><li><a href="function.hash-final.php">hash_final</a> — Finalize an incremental hash and return resulting digest</li><li><a href="function.hash-hkdf.php">hash_hkdf</a> — Generate a HKDF key derivation of a supplied key input</li><li><a href="function.hash-hmac.php">hash_hmac</a> — Generate a keyed hash value using the HMAC method</li><li><a href="function.hash-hmac-algos.php">hash_hmac_algos</a> — Return a list of registered hashing algorithms suitable for hash_hmac</li><li><a href="function.hash-hmac-file.php">hash_hmac_file</a> — Generate a keyed hash value using the HMAC method and the contents of a given file</li><li><a href="function.hash-init.php">hash_init</a> — Initialize an incremental hashing context</li><li><a href="function.hash-pbkdf2.php">hash_pbkdf2</a> — Generate a PBKDF2 key derivation of a supplied password</li><li><a href="function.hash-update.php">hash_update</a> — Pump data into an active hashing context</li><li><a href="function.hash-update-file.php">hash_update_file</a> — Pump data into an active hashing context from a file</li><li><a href="function.hash-update-stream.php">hash_update_stream</a> — Pump data into an active hashing context from an open stream</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/hash/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.hash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.hash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.hash.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">For thoes of you who're looking to generate an NTLM hash (not an LM hash), I found out it's quite simple..<br /><br />It uses the basic MD4 function, but the password needs to be in Unicode Little Endian encode first (this canbe achieved by the iconv function).<br /><br />This can be done easily by using the following code:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">NTLMHash</span><span class="keyword">(</span><span class="default">$Input</span><span class="keyword">) {<br />  </span><span class="comment">// Convert the password from UTF8 to UTF16 (little endian)<br />  </span><span class="default">$Input</span><span class="keyword">=</span><span class="default">iconv</span><span class="keyword">(</span><span class="string">'UTF-8'</span><span class="keyword">,</span><span class="string">'UTF-16LE'</span><span class="keyword">,</span><span class="default">$Input</span><span class="keyword">);<br /><br />  </span><span class="comment">// Encrypt it with the MD4 hash<br />  </span><span class="default">$MD4Hash</span><span class="keyword">=</span><span class="default">bin2hex</span><span class="keyword">(</span><span class="default">mhash</span><span class="keyword">(</span><span class="default">MHASH_MD4</span><span class="keyword">,</span><span class="default">$Input</span><span class="keyword">));<br /><br />  </span><span class="comment">// You could use this instead, but mhash works on PHP 4 and 5 or above<br />  // The hash function only works on 5 or above<br />  //$MD4Hash=hash('md4',$Input);<br /><br />  // Make it uppercase, not necessary, but it's common to do so with NTLM hashes<br />  </span><span class="default">$NTLMHash</span><span class="keyword">=</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$MD4Hash</span><span class="keyword">);<br /><br />  </span><span class="comment">// Return the result<br />  </span><span class="keyword">return(</span><span class="default">$NTLMHash</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />To produce an LM hash requires a fully-written script containing the algorithm used to make it.<br /><br />Enjoy,<br />CraquePipe.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">And some code for LM hash:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">LMhash</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">)<br />{<br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">14</span><span class="keyword">));<br /><br />    </span><span class="default">$p1 </span><span class="keyword">= </span><span class="default">LMhash_DESencrypt</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">7</span><span class="keyword">));<br />    </span><span class="default">$p2 </span><span class="keyword">= </span><span class="default">LMhash_DESencrypt</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">7</span><span class="keyword">, </span><span class="default">7</span><span class="keyword">));<br /><br />    return </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$p1</span><span class="keyword">.</span><span class="default">$p2</span><span class="keyword">);<br />}<br /><br />function </span><span class="default">LMhash_DESencrypt</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">)<br />{<br />    </span><span class="default">$key </span><span class="keyword">= array();<br />    </span><span class="default">$tmp </span><span class="keyword">= array();<br />    </span><span class="default">$len </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">);<br /><br />    for (</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">7</span><span class="keyword">; ++</span><span class="default">$i</span><span class="keyword">)<br />        </span><span class="default">$tmp</span><span class="keyword">[] = </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$len </span><span class="keyword">? </span><span class="default">ord</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]) : </span><span class="default">0</span><span class="keyword">;<br /><br />    </span><span class="default">$key</span><span class="keyword">[] = </span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">] &amp; </span><span class="default">254</span><span class="keyword">;<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">] &lt;&lt; </span><span class="default">7</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] &gt;&gt; </span><span class="default">1</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">] &lt;&lt; </span><span class="default">6</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">] &gt;&gt; </span><span class="default">2</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">] &lt;&lt; </span><span class="default">5</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">] &gt;&gt; </span><span class="default">3</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">] &lt;&lt; </span><span class="default">4</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">4</span><span class="keyword">] &gt;&gt; </span><span class="default">4</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">4</span><span class="keyword">] &lt;&lt; </span><span class="default">3</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">5</span><span class="keyword">] &gt;&gt; </span><span class="default">5</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">5</span><span class="keyword">] &lt;&lt; </span><span class="default">2</span><span class="keyword">) | (</span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">6</span><span class="keyword">] &gt;&gt; </span><span class="default">6</span><span class="keyword">);<br />    </span><span class="default">$key</span><span class="keyword">[] = </span><span class="default">$tmp</span><span class="keyword">[</span><span class="default">6</span><span class="keyword">] &lt;&lt; </span><span class="default">1</span><span class="keyword">;<br />   <br />    </span><span class="default">$is </span><span class="keyword">= </span><span class="default">mcrypt_get_iv_size</span><span class="keyword">(</span><span class="default">MCRYPT_DES</span><span class="keyword">, </span><span class="default">MCRYPT_MODE_ECB</span><span class="keyword">);<br />    </span><span class="default">$iv </span><span class="keyword">= </span><span class="default">mcrypt_create_iv</span><span class="keyword">(</span><span class="default">$is</span><span class="keyword">, </span><span class="default">MCRYPT_RAND</span><span class="keyword">);<br />    </span><span class="default">$key0 </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />   <br />    foreach (</span><span class="default">$key </span><span class="keyword">as </span><span class="default">$k</span><span class="keyword">)<br />        </span><span class="default">$key0 </span><span class="keyword">.= </span><span class="default">chr</span><span class="keyword">(</span><span class="default">$k</span><span class="keyword">);<br />    </span><span class="default">$crypt </span><span class="keyword">= </span><span class="default">mcrypt_encrypt</span><span class="keyword">(</span><span class="default">MCRYPT_DES</span><span class="keyword">, </span><span class="default">$key0</span><span class="keyword">, </span><span class="string">"KGS!@#$%"</span><span class="keyword">, </span><span class="default">MCRYPT_MODE_ECB</span><span class="keyword">, </span><span class="default">$iv</span><span class="keyword">);<br /><br />    return </span><span class="default">bin2hex</span><span class="keyword">(</span><span class="default">$crypt</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />Some optimization?</span></code></div>
  ...
  <strong class="user"><em>kungla at gmail dot com</em></strong></a><a class="genanchor" href="#94990"> &para;</a><div class="date" title="2009-12-07 05:00"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94990">
<div class="phpcode"><code><span class="html">For Samba ueserPassword you can use:
<br />
<br />(I am not very sure aboute the salt part, but it works for me like that)
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">CRYPThash</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$salt </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">)
<br />{
<br />    if (!</span><span class="default">$salt</span><span class="keyword">)
<br />        </span><span class="default">$salt </span><span class="keyword">= </span><span class="default">rand</span><span class="keyword">(</span><span class="default">10</span><span class="keyword">,</span><span class="default">99</span><span class="keyword">);
<br />    
<br />    return </span><span class="string">"{CRYPT}"</span><span class="keyword">.</span><span class="default">crypt</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$salt</span><span class="keyword">);
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />In posted NTLMHash function you can also use:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">// Encrypt it with the MD4 hash
<br /></span><span class="default">$MD4Hash</span><span class="keyword">=</span><span class="default">hash</span><span class="keyword">(</span><span class="string">'md4'</span><span class="keyword">,</span><span class="default">$Input</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />So you don't need to install mhash libraries</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ocarter at mirabeau dot nl</em></strong></a><a class="genanchor" href="#95595"> &para;</a><div class="date" title="2010-01-11 07:22"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95595">
<div class="phpcode"><code><span class="html">Note for FreeBSD with PHP-5. <br /><br />This is disabled by default; use the security/php5-hash port:<br />cd /usr/ports/security/php5-hash ; make install clean<br />(do not use the security/pecl-hash port as in the past, see the /usr/ports/UPDATING post from 20081211)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ref.hash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.hash.php">＋<small>add a note</small></a></div>
        ...
        <ul class='parent-menu-list'>
                ...
                <a href="book.hash.php">Hash</a>
                                    ...
                                    <ul class='child-menu-list'>
                                                ...
                                                <li class="">
                            <a href="intro.hash.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
                            <a href="hash.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="">
                            <a href="hash.constants.php" title="Predefined Constants">Predefined Constants</a>
                        </li>
                                                <li class="">
                            <a href="class.hashcontext.php" title="HashContext">HashContext</a>
                        </li>
                                                <li class="current">
                            <a href="ref.hash.php" title="Hash Functions">Hash Functions</a>
                        </li>
