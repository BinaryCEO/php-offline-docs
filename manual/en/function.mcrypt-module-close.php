...
<head>
  ...
  <title>PHP: mcrypt_module_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-close.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-module-close">
 <link rel="alternate" href="https://www.php.net/mcrypt-module-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-list-modes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-get-algo-block-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-module-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-module-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-module-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-module-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-module-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-module-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-module-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-module-close.php" hreflang="zh">
...
<meta name="Description" content="Closes the mcrypt module" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_module_close - Manual" />
<meta name="twitter:description" content="Closes the mcrypt module" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_module_close - Manual" />
<meta itemprop="description" content="Closes the mcrypt module" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes the mcrypt module" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-module-get-algo-block-size.php">
          mcrypt_module_get_algo_block_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-list-modes.php">
          &laquo; mcrypt_list_modes        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-close.php' selected="selected">English</option>
            <option value='de/function.mcrypt-module-close.php'>German</option>
            <option value='es/function.mcrypt-module-close.php'>Spanish</option>
            <option value='fr/function.mcrypt-module-close.php'>French</option>
            <option value='it/function.mcrypt-module-close.php'>Italian</option>
            <option value='ja/function.mcrypt-module-close.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-module-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-module-close.php'>Russian</option>
            <option value='tr/function.mcrypt-module-close.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-close.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-module-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-module-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_module_close</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_module_close</span> &mdash; <span class="dc-title">Closes the mcrypt module</span></p>

 </div>
 <div id="function.mcrypt-module-close-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.mcrypt-module-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mcrypt_module_close</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$td</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mcrypt-module-close-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mcrypt-module-close-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.mcrypt-module-close-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mcrypt-module-open.php" class="function" rel="rdfs-seeAlso">mcrypt_module_open()</a> - Opens the module of the algorithm and the mode to be used</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-close.php">＋<small>add a note</small></a></span>
