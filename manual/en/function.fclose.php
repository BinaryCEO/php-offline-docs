...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fclose.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.diskfreespace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdatasync.php">
...
<meta name="Description" content="Closes an open file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fclose - Manual" />
<meta name="twitter:description" content="Closes an open file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fclose - Manual" />
<meta itemprop="description" content="Closes an open file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Closes an open file pointer" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fclose.php' selected="selected">English</option>
            <option value='de/function.fclose.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fclose</span> &mdash; <span class="dc-title">Closes an open file pointer</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fclose-description">
  ...
  <p class="para rdfs-comment">
   The file pointed to by <code class="parameter">stream</code> is closed.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       opened by <span class="function"><a href="function.fopen.php" class="function">fopen()</a></span> or <span class="function"><a href="function.fsockopen.php" class="function">fsockopen()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.fclose-examples">
  ...
  <p class="para">
   <div class="example" id="example-2341">
    <p><strong>Example #1 A simple <span class="function"><strong>fclose()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fsockopen.php" class="function" rel="rdfs-seeAlso">fsockopen()</a> - Open Internet or Unix domain socket connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fclose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fclose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fclose.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">It is a GOOD_THING to check the return value from fclose(), as some operating systems only flush file output on close, and can, therefore, return an error from fclose(). You can catch severe data-eating errors by doing this. <br /><br />I learned this the hard way.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Note that from PHP 8.0 onwards, attempting to close a stream that is already closed will throw a fatal TypeError.<br /><br />Prior to PHP 8, this just caused a warning (that you can silence with @).</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">In case you have some trouble to properly disconnect some client streams opened with stream_socket_server / stream_select you should give a try to stream_socket_shutdown.
<br />
<br /><span class="default">&lt;?php stream_socket_shutdown</span><span class="keyword">(</span><span class="default">$clientStream</span><span class="keyword">,</span><span class="default">STREAM_SHUT_RDWR</span><span class="keyword">); </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Generally, it's always a good idea to close a file when you're done with it. It's very easy for something to go wrong and corrupt a file that hasn't been closed properly. If you're concerned about efficiency, the overhead is negligible.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It is very important to make sure you clear any incoming packets out of the incoming buffer using fread() or some equivalent.  Although you can call fclose() the socket does not actually shut down until the inbound packets have been cleared.  This can lead to some confusion.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">if you want to daysychain a filehandle through some functions and each function is allowed to close th file you might look in a following function first, if the handle is still valid.<br /><br />Opening a file, there often will be used a code like<br /><br />if (!$fh = fopen($filename, $mode)) return false;<br /><br />But if you possably have closed the file and you want to check that, a smililar statement would not work.<br /><br />DOES NOT WORK:   if (!$fh)  end_of_chain();<br /><br />use beter: if (is_resource($fh))   end_of_chain();</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fclose.php">＋<small>add a note</small></a></div>
