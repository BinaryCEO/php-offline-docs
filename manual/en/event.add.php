...
<head>
  ...
  <title>PHP: Event::add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/event.add.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/event.add.php">
 <link rel="alternate" href="https://www.php.net/manual/en/event.add.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.event.php">
 <link rel="next" href="https://www.php.net/manual/en/event.addsignal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/event.add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/event.add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/event.add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/event.add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/event.add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/event.add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/event.add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/event.add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/event.add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/event.add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/event.add.php" hreflang="zh">
...
<meta name="Description" content="Makes event pending" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Event::add - Manual" />
<meta name="twitter:description" content="Makes event pending" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Event::add - Manual" />
<meta itemprop="description" content="Makes event pending" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes event pending" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="event.addsignal.php">
          Event::addSignal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.event.php">
          &laquo; Event        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/event.add.php' selected="selected">English</option>
            <option value='de/event.add.php'>German</option>
            <option value='es/event.add.php'>Spanish</option>
            <option value='fr/event.add.php'>French</option>
            <option value='it/event.add.php'>Italian</option>
            <option value='ja/event.add.php'>Japanese</option>
            <option value='pt_BR/event.add.php'>Brazilian Portuguese</option>
            <option value='ru/event.add.php'>Russian</option>
            <option value='tr/event.add.php'>Turkish</option>
            <option value='uk/event.add.php'>Ukrainian</option>
            <option value='zh/event.add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="event.add" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="event.timer.php" class="methodname" rel="rdfs-seeAlso">Event::timer()</a> - Constructs timer event object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/event/add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fevent.add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=event.add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/event.add.php">＋<small>add a note</small></a></span>
