...
<head>
  ...
  <title>PHP: ReflectionMethod::export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionmethod.export.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionmethod.export.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.export.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionmethod.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionmethod.createfrommethodname.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionmethod.getclosure.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionmethod.export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionmethod.export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionmethod.export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionmethod.export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionmethod.export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionmethod.export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionmethod.export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionmethod.export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionmethod.export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionmethod.export.php" hreflang="zh">
...
<meta name="Description" content="Export a reflection method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionMethod::export - Manual" />
<meta name="twitter:description" content="Export a reflection method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionMethod::export - Manual" />
<meta itemprop="description" content="Export a reflection method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export a reflection method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionmethod.getclosure.php">
          ReflectionMethod::getClosure &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionmethod.createfrommethodname.php">
          &laquo; ReflectionMethod::createFromMethodName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionmethod.export.php' selected="selected">English</option>
            <option value='de/reflectionmethod.export.php'>German</option>
            <option value='es/reflectionmethod.export.php'>Spanish</option>
            <option value='fr/reflectionmethod.export.php'>French</option>
            <option value='it/reflectionmethod.export.php'>Italian</option>
            <option value='ja/reflectionmethod.export.php'>Japanese</option>
            <option value='pt_BR/reflectionmethod.export.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionmethod.export.php'>Russian</option>
            <option value='tr/reflectionmethod.export.php'>Turkish</option>
            <option value='uk/reflectionmethod.export.php'>Ukrainian</option>
            <option value='zh/reflectionmethod.export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionmethod.export" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionMethod::export</h1>
  <p class="verinfo">(PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">ReflectionMethod::export</span> &mdash; <span class="dc-title">Export a reflection method</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionmethod.tostring.php" class="methodname" rel="rdfs-seeAlso">ReflectionMethod::__toString()</a> - Returns the string representation of the Reflection method object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionmethod/export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionmethod.export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionmethod.export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionmethod.export.php">＋<small>add a note</small></a></span>
