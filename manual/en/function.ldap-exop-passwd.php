...
<head>
  ...
  <title>PHP: ldap_exop_passwd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-exop-passwd.php">
 <link rel="shorturl" href="https://www.php.net/ldap-exop-passwd">
 <link rel="alternate" href="https://www.php.net/ldap-exop-passwd" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-exop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-exop-refresh.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-exop-passwd.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-exop-passwd.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-exop-passwd.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-exop-passwd.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-exop-passwd.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-exop-passwd.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-exop-passwd.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-exop-passwd.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-exop-passwd.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-exop-passwd.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-exop-passwd.php" hreflang="zh">
...
<meta name="Description" content="PASSWD extended operation helper" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_exop_passwd - Manual" />
<meta name="twitter:description" content="PASSWD extended operation helper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_exop_passwd - Manual" />
<meta itemprop="description" content="PASSWD extended operation helper" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="PASSWD extended operation helper" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-exop-refresh.php">
          ldap_exop_refresh &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-exop-passwd.php' selected="selected">English</option>
            <option value='de/function.ldap-exop-passwd.php'>German</option>
            <option value='es/function.ldap-exop-passwd.php'>Spanish</option>
            <option value='fr/function.ldap-exop-passwd.php'>French</option>
            <option value='it/function.ldap-exop-passwd.php'>Italian</option>
            <option value='ja/function.ldap-exop-passwd.php'>Japanese</option>
            <option value='pt_BR/function.ldap-exop-passwd.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-exop-passwd.php'>Russian</option>
            <option value='tr/function.ldap-exop-passwd.php'>Turkish</option>
            <option value='uk/function.ldap-exop-passwd.php'>Ukrainian</option>
            <option value='zh/function.ldap-exop-passwd.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-exop-passwd" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_exop_passwd</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_exop_passwd</span> &mdash; <span class="dc-title">PASSWD extended operation helper</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-exop-passwd-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_exop_passwd</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$user</code><span class="initializer"> = &quot;&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$old_password</code><span class="initializer"> = &quot;&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_password</code><span class="initializer"> = &quot;&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$controls</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
  ...
  <dl>
    ...
    <dd>
     <p class="para">
       ...
       filled with an array of <a href="ldap.controls.php" class="link">LDAP Controls</a>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-exop-passwd-returnvalues">
  ...
  <p class="para">
    Returns the generated password if <code class="parameter">new_password</code> is empty or omitted.
    Otherwise returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.ldap-exop-passwd-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.ldap-exop-passwd-examples">
  ...
  <p class="para">
   <div class="example" id="example-4634">
    <p><strong>Example #1 PASSWD extended operation</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-parse-exop.php" class="function" rel="rdfs-seeAlso">ldap_parse_exop()</a> - Parse result object from an LDAP extended operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-exop-passwd.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-exop-passwd%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-exop-passwd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop-passwd.php">＋<small>add a note</small></a></span>
