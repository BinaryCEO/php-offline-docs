...
<head>
  ...
  <title>PHP: snmp3_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp3-set.php">
 <link rel="shorturl" href="https://www.php.net/snmp3-set">
 <link rel="alternate" href="https://www.php.net/snmp3-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.snmp3-real-walk.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmp3-walk.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmp3-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmp3-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmp3-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmp3-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmp3-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmp3-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmp3-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmp3-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmp3-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmp3-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmp3-set.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: snmp3_set - Manual" />
<meta name="twitter:description" content="Set the value of an SNMP object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: snmp3_set - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp3-set.php' selected="selected">English</option>
            <option value='de/function.snmp3-set.php'>German</option>
            <option value='es/function.snmp3-set.php'>Spanish</option>
            <option value='fr/function.snmp3-set.php'>French</option>
            <option value='it/function.snmp3-set.php'>Italian</option>
            <option value='ja/function.snmp3-set.php'>Japanese</option>
            <option value='pt_BR/function.snmp3-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmp3-set.php'>Russian</option>
            <option value='tr/function.snmp3-set.php'>Turkish</option>
            <option value='uk/function.snmp3-set.php'>Ukrainian</option>
            <option value='zh/function.snmp3-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmp3-set" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  snmp3_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'james'</span><span style="color: #007700">, </span><span style="color: #DD0000">'authPriv'</span><span style="color: #007700">, </span><span style="color: #DD0000">'SHA'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'IF-MIB::ifAlias.3'</span><span style="color: #007700">, </span><span style="color: #DD0000">'s'</span><span style="color: #007700">, </span><span style="color: #DD0000">"foo"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example" id="example-4770">
    <p><strong>Example #2 Using <span class="function"><strong>snmp3_set()</strong></span> for setting BITS <abbr title="Simple Network Management Protocol">SNMP</abbr> object id</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  snmp3_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'james'</span><span style="color: #007700">, </span><span style="color: #DD0000">'authPriv'</span><span style="color: #007700">, </span><span style="color: #DD0000">'SHA'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'FOO-MIB::bar.42'</span><span style="color: #007700">, </span><span style="color: #DD0000">'b'</span><span style="color: #007700">, </span><span style="color: #DD0000">'0 1 2 3 4'</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">// or<br />  </span><span style="color: #0000BB">snmp3_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #DD0000">'james'</span><span style="color: #007700">, </span><span style="color: #DD0000">'authPriv'</span><span style="color: #007700">, </span><span style="color: #DD0000">'SHA'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret007'</span><span style="color: #007700">, </span><span style="color: #DD0000">'FOO-MIB::bar.42'</span><span style="color: #007700">, </span><span style="color: #DD0000">'x'</span><span style="color: #007700">, </span><span style="color: #DD0000">'F0'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp3-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp3-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp3-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp3-set.php">＋<small>add a note</small></a></span>
