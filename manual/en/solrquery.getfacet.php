...
<head>
  ...
  <title>PHP: SolrQuery::getFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getexpandsortfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetdateend.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacet.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the facet parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacet - Manual" />
<meta name="twitter:description" content="Returns the value of the facet parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacet - Manual" />
<meta itemprop="description" content="Returns the value of the facet parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the facet parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetdateend.php">
          SolrQuery::getFacetDateEnd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getexpandsortfields.php">
          &laquo; SolrQuery::getExpandSortFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacet.php' selected="selected">English</option>
            <option value='de/solrquery.getfacet.php'>German</option>
            <option value='es/solrquery.getfacet.php'>Spanish</option>
            <option value='fr/solrquery.getfacet.php'>French</option>
            <option value='it/solrquery.getfacet.php'>Italian</option>
            <option value='ja/solrquery.getfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacet.php'>Russian</option>
            <option value='tr/solrquery.getfacet.php'>Turkish</option>
            <option value='uk/solrquery.getfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacet</span> &mdash; <span class="dc-title">Returns the value of the facet parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacet</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacet-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacet-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacet.php">＋<small>add a note</small></a></span>
