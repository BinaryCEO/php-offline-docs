...
<head>
  ...
  <title>PHP: mb_ereg_search_getregs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ereg-search-getregs.php">
 <link rel="shorturl" href="https://www.php.net/mb-ereg-search-getregs">
 <link rel="alternate" href="https://www.php.net/mb-ereg-search-getregs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg-search-getpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg-search-init.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ereg-search-getregs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ereg-search-getregs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ereg-search-getregs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ereg-search-getregs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ereg-search-getregs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ereg-search-getregs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ereg-search-getregs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ereg-search-getregs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ereg-search-getregs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ereg-search-getregs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ereg-search-getregs.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the result from the last multibyte regular expression match" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ereg_search_getregs - Manual" />
<meta name="twitter:description" content="Retrieve the result from the last multibyte regular expression match" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ereg_search_getregs - Manual" />
<meta itemprop="description" content="Retrieve the result from the last multibyte regular expression match" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the result from the last multibyte regular expression match" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-ereg-search-init.php">
          mb_ereg_search_init &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg-search-getpos.php">
          &laquo; mb_ereg_search_getpos        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ereg-search-getregs.php' selected="selected">English</option>
            <option value='de/function.mb-ereg-search-getregs.php'>German</option>
            <option value='es/function.mb-ereg-search-getregs.php'>Spanish</option>
            <option value='fr/function.mb-ereg-search-getregs.php'>French</option>
            <option value='it/function.mb-ereg-search-getregs.php'>Italian</option>
            <option value='ja/function.mb-ereg-search-getregs.php'>Japanese</option>
            <option value='pt_BR/function.mb-ereg-search-getregs.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ereg-search-getregs.php'>Russian</option>
            <option value='tr/function.mb-ereg-search-getregs.php'>Turkish</option>
            <option value='uk/function.mb-ereg-search-getregs.php'>Ukrainian</option>
            <option value='zh/function.mb-ereg-search-getregs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ereg-search-getregs" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-ereg-search-init.php" class="function" rel="rdfs-seeAlso">mb_ereg_search_init()</a> - Setup string and regular expression for a multibyte regular expression match</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ereg-search-getregs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ereg-search-getregs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ereg-search-getregs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-search-getregs.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="72613">  <div class="votes">
    <div id="Vu72613">
    <a href="/manual/vote-note.php?id=72613&amp;page=function.mb-ereg-search-getregs&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72613">
    <a href="/manual/vote-note.php?id=72613&amp;page=function.mb-ereg-search-getregs&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72613" title="37% like this...">
    -2
    </div>
  </div>
  <a href="#72613" class="name">
  <strong class="user"><em>Marius Kažemėkaitis</em></strong></a><a class="genanchor" href="#72613"> &para;</a><div class="date" title="2007-01-25 11:48"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72613">
<div class="phpcode"><code><span class="html">Get unicode characters from string.<br /><br /><span class="default">&lt;?php<br /><br />mb_regex_encoding</span><span class="keyword">(</span><span class="string">"UTF-8"</span><span class="keyword">);<br /></span><span class="default">mb_ereg_search_init</span><span class="keyword">(</span><span class="string">"12345=ąčęėįšųūĄČĘĖĮŠŲŪ"</span><span class="keyword">);<br /></span><span class="default">mb_ereg_search</span><span class="keyword">(</span><span class="string">"=(\w+)"</span><span class="keyword">);<br /></span><span class="default">$match </span><span class="keyword">= </span><span class="default">mb_ereg_search_getregs</span><span class="keyword">();<br /><br />print(</span><span class="default">$match</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]); </span><span class="comment">//ąčęėįšųūĄČĘĖĮŠŲŪ<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-ereg-search-getregs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-search-getregs.php">＋<small>add a note</small></a></div>
