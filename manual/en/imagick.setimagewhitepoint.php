...
<head>
  ...
  <title>PHP: Imagick::setImageWhitePoint - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagevirtualpixelmethod.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagewhitepoint.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagewhitepoint.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagewhitepoint.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagewhitepoint.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagewhitepoint.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagewhitepoint.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagewhitepoint.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagewhitepoint.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagewhitepoint.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagewhitepoint.php" hreflang="zh">
...
<meta name="Description" content="Sets the image chromaticity white point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageWhitePoint - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity white point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageWhitePoint - Manual" />
<meta itemprop="description" content="Sets the image chromaticity white point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image chromaticity white point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setinterlacescheme.php">
          Imagick::setInterlaceScheme &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagevirtualpixelmethod.php">
          &laquo; Imagick::setImageVirtualPixelMethod        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagewhitepoint.php' selected="selected">English</option>
            <option value='de/imagick.setimagewhitepoint.php'>German</option>
            <option value='es/imagick.setimagewhitepoint.php'>Spanish</option>
            <option value='fr/imagick.setimagewhitepoint.php'>French</option>
            <option value='it/imagick.setimagewhitepoint.php'>Italian</option>
            <option value='ja/imagick.setimagewhitepoint.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagewhitepoint.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagewhitepoint.php'>Russian</option>
            <option value='tr/imagick.setimagewhitepoint.php'>Turkish</option>
            <option value='uk/imagick.setimagewhitepoint.php'>Ukrainian</option>
            <option value='zh/imagick.setimagewhitepoint.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagewhitepoint" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageWhitePoint</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageWhitePoint</span> &mdash; <span class="dc-title">Sets the image chromaticity white point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagewhitepoint-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageWhitePoint</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagewhitepoint-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagewhitepoint-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagewhitepoint-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagewhitepoint.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagewhitepoint%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagewhitepoint&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagewhitepoint.php">＋<small>add a note</small></a></span>
