...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-x509-read.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-x509-parse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-x509-verify.php">
...
<meta name="Description" content="Parse an X.509 certificate and return an object for
  it" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_x509_read - Manual" />
<meta name="twitter:description" content="Parse an X.509 certificate and return an object for
  it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_x509_read - Manual" />
<meta itemprop="description" content="Parse an X.509 certificate and return an object for
  it" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parse an X.509 certificate and return an object for
  it" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-x509-read.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.openssl-x509-read.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_x509_read</span> &mdash; <span class="dc-title">Parse an X.509 certificate and return an object for
  it</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-x509-read-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_x509_read()</strong></span> parses the certificate supplied by
   <code class="parameter">certificate</code> and returns an <span class="classname"><a href="class.opensslcertificate.php" class="classname">OpenSSLCertificate</a></span> object for
   it.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-x509-read-returnvalues">
  ...
  <p class="para">
   Returns an <span class="classname"><a href="class.opensslcertificate.php" class="classname">OpenSSLCertificate</a></span> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
    ...
    <tbody class="tbody">
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-x509-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-x509-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-x509-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-read.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To get the real timestamps as integer values for the validity daterange you can use as follows:<br /><br /><span class="default">&lt;?php<br />$data </span><span class="keyword">= </span><span class="default">openssl_x509_parse</span><span class="keyword">(</span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'/path/to/cert.crt'</span><span class="keyword">));<br /><br /></span><span class="default">$validFrom </span><span class="keyword">= </span><span class="default">date</span><span class="keyword">(</span><span class="string">'Y-m-d H:i:s'</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">[</span><span class="string">'validFrom_time_t'</span><span class="keyword">]);<br /></span><span class="default">$validTo </span><span class="keyword">) </span><span class="default">date</span><span class="keyword">(</span><span class="string">'Y-m-d H:i:s'</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">[</span><span class="string">'validTo_time_t'</span><span class="keyword">]);<br /><br />echo </span><span class="default">$validFrom </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />echo </span><span class="default">$validTo </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">After some tests I've been able to get some results this way ...
<br />
<br /><span class="default">&lt;?php
<br />
<br /> $fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="string">"/etc/httpd/conf/ssl/moncertif.crt"</span><span class="keyword">, </span><span class="string">"r"</span><span class="keyword">);
<br /> </span><span class="default">$cert </span><span class="keyword">= </span><span class="default">fread</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">8192</span><span class="keyword">);
<br /> </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);
<br />
<br />echo </span><span class="string">"Read&lt;br&gt;"</span><span class="keyword">;
<br />echo </span><span class="default">openssl_x509_read</span><span class="keyword">(</span><span class="default">$cert</span><span class="keyword">);
<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;
<br />echo </span><span class="string">"*********************"</span><span class="keyword">;
<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;
<br />echo </span><span class="string">"Parse&lt;br&gt;"</span><span class="keyword">;
<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">openssl_x509_parse</span><span class="keyword">(</span><span class="default">$cert</span><span class="keyword">));
<br /></span><span class="comment">/*
<br />// or
<br />print_r(openssl_x509_parse( openssl_x509_read($cert) ) );
<br />*/
<br />
...
<div class="phpcode"><code><span class="html">Short HOWTO for getting data out of a client certificate via an SSL enabled iPlanet (Netscape Enterprise or Sun ONE) web server.<br /><br />The iPlanet server sets $_SERVER["CLIENT_CERT"] whenever a client authenticates with a certificate. This variable contains an encoded representation of the certificate presented by the client. This in itself is useless to scripts or applications, we need to extract the actual information from the encoding. It turns out that we are in luck, the encoding is NEARLY a standard PEM encoding which can be read by the openssl_x509_read() function. A standard PEM has a begin line, an end line and inbetween is a base64 encoding of the DER representation of the certificate. PEM requires that linefeeds be present every 64 characters, however this is already the case with our CLIENT_CERT variable. For some reason the iPlanet server neglects to attach the begin and end headers, all that is required to allow access to the certificate is replacing these headers. Here is a small code excerpt for doing just that and printing out the raw certificate data.<br /><br /><span class="default">&lt;?php<br />    $beginpem </span><span class="keyword">= </span><span class="string">"-----BEGIN CERTIFICATE-----\n"</span><span class="keyword">;<br />    </span><span class="default">$endpem </span><span class="keyword">= </span><span class="string">"-----END CERTIFICATE-----\n"</span><span class="keyword">;<br /><br />    </span><span class="comment">// Small function to print the data recursivly.<br />    </span><span class="keyword">function </span><span class="default">print_element</span><span class="keyword">(</span><span class="default">$item</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">)<br />    {<br />        if( </span><span class="default">is_array</span><span class="keyword">( </span><span class="default">$item </span><span class="keyword">) )<br />        {<br />            echo </span><span class="string">"</span><span class="default">$key</span><span class="string"> is Array:\n"</span><span class="keyword">;<br />            </span><span class="default">array_walk</span><span class="keyword">( </span><span class="default">$item</span><span class="keyword">, </span><span class="string">'print_element' </span><span class="keyword">);<br />            echo </span><span class="string">"</span><span class="default">$key</span><span class="string"> done\n"</span><span class="keyword">;<br />        }<br />        else<br />            echo </span><span class="string">"</span><span class="default">$key</span><span class="string"> = </span><span class="default">$item</span><span class="string">\n"</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">// Build the PEM string.<br />    </span><span class="default">$pemdata </span><span class="keyword">= </span><span class="default">$beginpem</span><span class="keyword">.</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">"CLIENT_CERT"</span><span class="keyword">].</span><span class="string">"\n"</span><span class="keyword">.</span><span class="default">$endpem</span><span class="keyword">;<br /><br />    </span><span class="comment">// Get a certificate resource from the PEM string.<br />    </span><span class="default">$cert </span><span class="keyword">= </span><span class="default">openssl_x509_read</span><span class="keyword">( </span><span class="default">$pemdata </span><span class="keyword">);<br /><br />    </span><span class="comment">// Parse the resource and print out the contents.<br />    </span><span class="default">$cert_data </span><span class="keyword">= </span><span class="default">openssl_x509_parse</span><span class="keyword">( </span><span class="default">$cert </span><span class="keyword">);<br />    </span><span class="default">array_walk</span><span class="keyword">( </span><span class="default">$cert_data</span><span class="keyword">, </span><span class="string">'print_element' </span><span class="keyword">);<br /><br />    </span><span class="comment">// Free the resource<br />    </span><span class="default">openssl_x509_free</span><span class="keyword">( </span><span class="default">$cert </span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-x509-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-x509-read.php">＋<small>add a note</small></a></div>
