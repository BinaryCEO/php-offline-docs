...
<head>
  ...
  <title>PHP: fdf_set_value - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-set-value.php">
 <link rel="shorturl" href="https://www.php.net/fdf-set-value">
 <link rel="alternate" href="https://www.php.net/fdf-set-value" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-set-target-frame.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-set-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-set-value.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-set-value.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-set-value.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-set-value.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-set-value.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-set-value.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-set-value.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-set-value.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-set-value.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-set-value.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-set-value.php" hreflang="zh">
...
<meta name="Description" content="Set the value of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_set_value - Manual" />
<meta name="twitter:description" content="Set the value of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_set_value - Manual" />
<meta itemprop="description" content="Set the value of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the value of a field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fdf-set-version.php">
          fdf_set_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fdf-set-target-frame.php">
          &laquo; fdf_set_target_frame        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-set-value.php' selected="selected">English</option>
            <option value='de/function.fdf-set-value.php'>German</option>
            <option value='es/function.fdf-set-value.php'>Spanish</option>
            <option value='fr/function.fdf-set-value.php'>French</option>
            <option value='it/function.fdf-set-value.php'>Italian</option>
            <option value='ja/function.fdf-set-value.php'>Japanese</option>
            <option value='pt_BR/function.fdf-set-value.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-set-value.php'>Russian</option>
            <option value='tr/function.fdf-set-value.php'>Turkish</option>
            <option value='uk/function.fdf-set-value.php'>Ukrainian</option>
            <option value='zh/function.fdf-set-value.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-set-value" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fdf-remove-item.php" class="function" rel="rdfs-seeAlso">fdf_remove_item()</a> - Sets target frame for form</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-set-value.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-set-value%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-set-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-set-value.php">＋<small>add a note</small></a></span>
