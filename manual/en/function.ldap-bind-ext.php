...
<head>
  ...
  <title>PHP: ldap_bind_ext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-bind-ext.php">
 <link rel="shorturl" href="https://www.php.net/ldap-bind-ext">
 <link rel="alternate" href="https://www.php.net/ldap-bind-ext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-bind.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-bind-ext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-bind-ext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-bind-ext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-bind-ext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-bind-ext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-bind-ext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-bind-ext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-bind-ext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-bind-ext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-bind-ext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-bind-ext.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_bind_ext - Manual" />
<meta name="twitter:description" content="Bind to LDAP directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_bind_ext - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-bind-ext.php' selected="selected">English</option>
            <option value='de/function.ldap-bind-ext.php'>German</option>
            <option value='es/function.ldap-bind-ext.php'>Spanish</option>
            <option value='fr/function.ldap-bind-ext.php'>French</option>
            <option value='it/function.ldap-bind-ext.php'>Italian</option>
            <option value='ja/function.ldap-bind-ext.php'>Japanese</option>
            <option value='pt_BR/function.ldap-bind-ext.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-bind-ext.php'>Russian</option>
            <option value='tr/function.ldap-bind-ext.php'>Turkish</option>
            <option value='uk/function.ldap-bind-ext.php'>Ukrainian</option>
            <option value='zh/function.ldap-bind-ext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-bind-ext" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-parse-result.php" class="function" rel="rdfs-seeAlso">ldap_parse_result()</a> - Extract information from result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-bind-ext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-bind-ext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-bind-ext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-bind-ext.php">＋<small>add a note</small></a></span>
