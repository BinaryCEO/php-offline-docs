...
<head>
  ...
  <title>PHP: SolrQuery::setGroupMain - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupmain.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupmain.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupmain.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgrouplimit.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupmain.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgroupmain.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgroupmain.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgroupmain.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgroupmain.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgroupmain.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgroupmain.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgroupmain.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgroupmain.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgroupmain.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgroupmain.php" hreflang="zh">
...
<meta name="Description" content="If true, the result of the first field grouping command is used as the main result list in the response, using group.format=simple" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupMain - Manual" />
<meta name="twitter:description" content="If true, the result of the first field grouping command is used as the main result list in the response, using group.format=simple" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupMain - Manual" />
<meta itemprop="description" content="If true, the result of the first field grouping command is used as the main result list in the response, using group.format=simple" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="If true, the result of the first field grouping command is used as the main result list in the response, using group.format=simple" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setgroupngroups.php">
          SolrQuery::setGroupNGroups &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgrouplimit.php">
          &laquo; SolrQuery::setGroupLimit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupmain.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupmain.php'>German</option>
            <option value='es/solrquery.setgroupmain.php'>Spanish</option>
            <option value='fr/solrquery.setgroupmain.php'>French</option>
            <option value='it/solrquery.setgroupmain.php'>Italian</option>
            <option value='ja/solrquery.setgroupmain.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgroupmain.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgroupmain.php'>Russian</option>
            <option value='tr/solrquery.setgroupmain.php'>Turkish</option>
            <option value='uk/solrquery.setgroupmain.php'>Ukrainian</option>
            <option value='zh/solrquery.setgroupmain.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgroupmain" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupmain.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupmain%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupmain&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupmain.php">＋<small>add a note</small></a></span>
