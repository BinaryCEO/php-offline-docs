...
<head>
  ...
  <title>PHP: ldap_first_reference - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-first-reference.php">
 <link rel="shorturl" href="https://www.php.net/ldap-first-reference">
 <link rel="alternate" href="https://www.php.net/ldap-first-reference" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-first-entry.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-free-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-first-reference.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-first-reference.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-first-reference.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-first-reference.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-first-reference.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-first-reference.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-first-reference.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-first-reference.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-first-reference.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-first-reference.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-first-reference.php" hreflang="zh">
...
<meta name="Description" content="Return first reference" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_first_reference - Manual" />
<meta name="twitter:description" content="Return first reference" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_first_reference - Manual" />
<meta itemprop="description" content="Return first reference" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return first reference" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-free-result.php">
          ldap_free_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-first-entry.php">
          &laquo; ldap_first_entry        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-first-reference.php' selected="selected">English</option>
            <option value='de/function.ldap-first-reference.php'>German</option>
            <option value='es/function.ldap-first-reference.php'>Spanish</option>
            <option value='fr/function.ldap-first-reference.php'>French</option>
            <option value='it/function.ldap-first-reference.php'>Italian</option>
            <option value='ja/function.ldap-first-reference.php'>Japanese</option>
            <option value='pt_BR/function.ldap-first-reference.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-first-reference.php'>Russian</option>
            <option value='tr/function.ldap-first-reference.php'>Turkish</option>
            <option value='uk/function.ldap-first-reference.php'>Ukrainian</option>
            <option value='zh/function.ldap-first-reference.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-first-reference" class="refentry">
...
currently not documented; only its argument list is available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-first-reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-first-reference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-first-reference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-first-reference.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="47432">  <div class="votes">
    <div id="Vu47432">
    <a href="/manual/vote-note.php?id=47432&amp;page=function.ldap-first-reference&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd47432">
    <a href="/manual/vote-note.php?id=47432&amp;page=function.ldap-first-reference&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V47432" title="100% like this...">
    1
    </div>
  </div>
  <a href="#47432" class="name">
  <strong class="user"><em>sami at sipponen dot com</em></strong></a><a class="genanchor" href="#47432"> &para;</a><div class="date" title="2004-11-16 03:56"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom47432">
<div class="phpcode"><code><span class="html">Hopefully the code below help you to loop through references with LDAP3 servers. It took me a significant amount of time to figure out how this thing works and now I have successfully used this with Active Directory to loop through severial subdomains.<br /><br />Special thanks to Stig Venaas who helped me to get started. (the original problem was that ldap_parse_reference function was missing in Windows builds. At least it will now work with Windows PHP versions 5.1.0-DEV and higher after I made a bug report)<br /><br />function crawlRefs($user, $passw, $host, $dn, $port, $filter) {<br /><br />  //Create the basic connection for fetching referrals<br />  $adConn = ldap_connect($host, $port) or die("System couldn't connect!");<br />  ldap_set_option($adConn, LDAP_OPT_PROTOCOL_VERSION, 3) or die ("System couldn't make first protocol option setting!");<br />  ldap_set_option($adConn, LDAP_OPT_REFERRALS, 0) or die ("System couldn't make second protocol option setting!");<br />  $bd = ldap_bind($adConn, $user, $passw) or die ("System couldn't bind the connection!");<br />  $search = ldap_search($adConn, $dn, $filter);<br /><br />  //Find referrals<br />  $ref = ldap_first_reference($adConn, $search);<br />  while ($ref) {<br />    if (ldap_parse_reference($adConn, $ref, $referrals)) {<br />      while ($referral = array_shift($referrals)) {<br />        echo $referral . "&lt;br&gt;\n";<br />      }<br />    }<br />  $ref = ldap_next_reference($adConn, $ref);<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-first-reference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-first-reference.php">＋<small>add a note</small></a></div>
