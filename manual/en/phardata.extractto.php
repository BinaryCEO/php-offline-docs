...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.extractto.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.extractto.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.extractto.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.destruct.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.iswritable.php">
...
<meta name="Description" content="Extract the contents of a tar/zip archive to a directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::extractTo - Manual" />
<meta name="twitter:description" content="Extract the contents of a tar/zip archive to a directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::extractTo - Manual" />
<meta itemprop="description" content="Extract the contents of a tar/zip archive to a directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extract the contents of a tar/zip archive to a directory" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.extractto.php' selected="selected">English</option>
            ...
            <option value='ja/phardata.extractto.php'>Japanese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="phar.extractto.php" class="function" rel="rdfs-seeAlso">Phar::extractTo()</a> - Extract the contents of a phar archive to a directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/extractTo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.extractto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.extractto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.extractto.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Note that PHAR only supports extracting the 'ustar' variant of the tar archives.<br /><br />Some systems (such as older versions of Mac OS X) generate the 'pax' format by default.<br /><br />See here for more information:<br /><a href="http://php.net/manual/pl/phar.fileformat.tar.php" rel="nofollow" target="_blank">http://php.net/manual/pl/phar.fileformat.tar.php</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I'm unable to extract the first directory from a tar archive:<br />the destination dir remains empty,<br />no error is thrown<br /><br /><span class="default">&lt;?php<br />$tar </span><span class="keyword">= new </span><span class="default">\PharData</span><span class="keyword">(</span><span class="string">'archive.tar'</span><span class="keyword">);<br />if (</span><span class="default">$tar</span><span class="keyword">-&gt;</span><span class="default">current</span><span class="keyword">()-&gt;</span><span class="default">isDir</span><span class="keyword">()) {<br />                echo </span><span class="string">'is_dir'</span><span class="keyword">;<br />                </span><span class="default">$dir </span><span class="keyword">= </span><span class="default">$tar</span><span class="keyword">-&gt;</span><span class="default">current</span><span class="keyword">()-&gt;</span><span class="default">getPathname</span><span class="keyword">();<br />                </span><span class="default">$dir </span><span class="keyword">= </span><span class="default">basename</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">);<br />                </span><span class="default">$tar</span><span class="keyword">-&gt;</span><span class="default">extractTo</span><span class="keyword">(</span><span class="string">'destination'</span><span class="keyword">, </span><span class="default">$dir</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />the docs hint that the second param could be a name of file OR DIR to be extracted from the archive, is that really possible?</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">This is an example of how to decompress and unarchive a TAR.GZ file using Phar decompress() and extractTo() methods:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">echo </span><span class="string">'&lt;h1&gt;TAR.GZ decompress&lt;/h1&gt;'</span><span class="keyword">;<br /><br /></span><span class="default">$file_name </span><span class="keyword">= </span><span class="string">'your_file.tar.gz'</span><span class="keyword">;<br /></span><span class="default">$tar_file_name </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'.gz'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$file_name</span><span class="keyword">);<br /></span><span class="default">$dir_file_name </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'.tar.gz'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$file_name</span><span class="keyword">);<br /><br /></span><span class="comment">// decompress from gz and creates your_file.tar<br /></span><span class="default">$p </span><span class="keyword">= new </span><span class="default">PharData</span><span class="keyword">(</span><span class="default">$file_name</span><span class="keyword">);<br /></span><span class="default">$p</span><span class="keyword">-&gt;</span><span class="default">decompress</span><span class="keyword">();<br /><br /></span><span class="comment">// unarchive from the tar to folder 'your_file'<br /></span><span class="default">$phar </span><span class="keyword">= new </span><span class="default">PharData</span><span class="keyword">(</span><span class="default">$tar_file_name</span><span class="keyword">);<br /></span><span class="default">$phar</span><span class="keyword">-&gt;</span><span class="default">extractTo</span><span class="keyword">(</span><span class="default">$dir_file_name</span><span class="keyword">);<br /><br />echo </span><span class="string">'&lt;h1&gt;DONE&lt;/h1&gt;'</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phardata.extractto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.extractto.php">＋<small>add a note</small></a></div>
