...
<head>
  ...
  <title>PHP: DateTimeImmutable::modify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetimeimmutable.modify.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetimeimmutable.modify.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.modify.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetimeimmutable.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetimeimmutable.getlasterrors.php">
 <link rel="next" href="https://www.php.net/manual/en/datetimeimmutable.set-state.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetimeimmutable.modify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetimeimmutable.modify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetimeimmutable.modify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetimeimmutable.modify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetimeimmutable.modify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetimeimmutable.modify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetimeimmutable.modify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetimeimmutable.modify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetimeimmutable.modify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetimeimmutable.modify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetimeimmutable.modify.php" hreflang="zh">
...
<meta name="Description" content="Creates a new object with modified timestamp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTimeImmutable::modify - Manual" />
<meta name="twitter:description" content="Creates a new object with modified timestamp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTimeImmutable::modify - Manual" />
<meta itemprop="description" content="Creates a new object with modified timestamp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new object with modified timestamp" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetimeimmutable.set-state.php">
          DateTimeImmutable::__set_state &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetimeimmutable.getlasterrors.php">
          &laquo; DateTimeImmutable::getLastErrors        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetimeimmutable.modify.php' selected="selected">English</option>
            <option value='de/datetimeimmutable.modify.php'>German</option>
            <option value='es/datetimeimmutable.modify.php'>Spanish</option>
            <option value='fr/datetimeimmutable.modify.php'>French</option>
            <option value='it/datetimeimmutable.modify.php'>Italian</option>
            <option value='ja/datetimeimmutable.modify.php'>Japanese</option>
            <option value='pt_BR/datetimeimmutable.modify.php'>Brazilian Portuguese</option>
            <option value='ru/datetimeimmutable.modify.php'>Russian</option>
            <option value='tr/datetimeimmutable.modify.php'>Turkish</option>
            <option value='uk/datetimeimmutable.modify.php'>Ukrainian</option>
            <option value='zh/datetimeimmutable.modify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetimeimmutable.modify" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">DateTimeImmutable::modify</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">DateTimeImmutable::modify</span> &mdash; <span class="dc-title">Creates a new object with modified timestamp</span></p>
 ...
 <div class="refsect1 description" id="refsect1-datetimeimmutable.modify-description">
  ...
  <p class="para rdfs-comment">
   Creates a new <span class="type"><a href="class.datetimeimmutable.php" class="type DateTimeImmutable">DateTimeImmutable</a></span> object with modified timestamp.
 ...
 <div class="refsect1 returnvalues" id="refsect1-datetimeimmutable.modify-returnvalues">
  ...
  <p class="para">
   Returns <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span> on success.
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.3.0</td>
      <td>
       <span class="methodname"><strong>DateTimeImmutable::modify()</strong></span> now throws
 ...
 <div class="refsect1 examples" id="refsect1-datetimeimmutable.modify-examples">
  ...
  <div class="example" id="example-2211">
   <p><strong>Example #1 <span class="function"><strong>DateTimeImmutable::modify()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="datetimeimmutable.settimestamp.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setTimestamp()</a> - Sets the date and time based on a Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetimeimmutable/modify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetimeimmutable.modify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetimeimmutable.modify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetimeimmutable.modify.php">＋<small>add a note</small></a></span>
