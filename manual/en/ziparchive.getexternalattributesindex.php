...
<head>
  ...
  <title>PHP: ZipArchive::getExternalAttributesIndex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getexternalattributesindex.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getexternalattributesindex.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getexternalattributesindex.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getcommentname.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getexternalattributesname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getexternalattributesindex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.getexternalattributesindex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.getexternalattributesindex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.getexternalattributesindex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.getexternalattributesindex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.getexternalattributesindex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.getexternalattributesindex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.getexternalattributesindex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.getexternalattributesindex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.getexternalattributesindex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.getexternalattributesindex.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the external attributes of an entry defined by its index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::getExternalAttributesIndex - Manual" />
<meta name="twitter:description" content="Retrieve the external attributes of an entry defined by its index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::getExternalAttributesIndex - Manual" />
<meta itemprop="description" content="Retrieve the external attributes of an entry defined by its index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the external attributes of an entry defined by its index" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.getexternalattributesname.php">
          ZipArchive::getExternalAttributesName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.getcommentname.php">
          &laquo; ZipArchive::getCommentName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getexternalattributesindex.php' selected="selected">English</option>
            <option value='de/ziparchive.getexternalattributesindex.php'>German</option>
            <option value='es/ziparchive.getexternalattributesindex.php'>Spanish</option>
            <option value='fr/ziparchive.getexternalattributesindex.php'>French</option>
            <option value='it/ziparchive.getexternalattributesindex.php'>Italian</option>
            <option value='ja/ziparchive.getexternalattributesindex.php'>Japanese</option>
            <option value='pt_BR/ziparchive.getexternalattributesindex.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.getexternalattributesindex.php'>Russian</option>
            <option value='tr/ziparchive.getexternalattributesindex.php'>Turkish</option>
            <option value='uk/ziparchive.getexternalattributesindex.php'>Ukrainian</option>
            <option value='zh/ziparchive.getexternalattributesindex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.getexternalattributesindex" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.getexternalattributesindex-examples">
  <h3 class="title">Examples</h3>
    ...
    <div class="example" id="ziparchive.getexternalattributesindex.examples.perms">
     <p><strong>Example #1 Extract all entries with Unix rights</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">) === </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    for (</span><span style="color: #0000BB">$idx</span><span style="color: #007700">=</span><span style="color: #0000BB">0 </span><span style="color: #007700">; </span><span style="color: #0000BB">$s </span><span style="color: #007700">= </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">statIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">$idx</span><span style="color: #007700">) ; </span><span style="color: #0000BB">$idx</span><span style="color: #007700">++) {<br />        if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">extractTo</span><span style="color: #007700">(</span><span style="color: #DD0000">'.'</span><span style="color: #007700">, </span><span style="color: #0000BB">$s</span><span style="color: #007700">[</span><span style="color: #DD0000">'name'</span><span style="color: #007700">])) {<br />            if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getExternalAttributesIndex</span><span style="color: #007700">(</span><span style="color: #0000BB">$idx</span><span style="color: #007700">, </span><span style="color: #0000BB">$opsys</span><span style="color: #007700">, </span><span style="color: #0000BB">$attr</span><span style="color: #007700">) <br />                &amp;&amp; </span><span style="color: #0000BB">$opsys</span><span style="color: #007700">==</span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">::</span><span style="color: #0000BB">OPSYS_UNIX</span><span style="color: #007700">) {<br />               </span><span style="color: #0000BB">chmod</span><span style="color: #007700">(</span><span style="color: #0000BB">$s</span><span style="color: #007700">[</span><span style="color: #DD0000">'name'</span><span style="color: #007700">], (</span><span style="color: #0000BB">$attr </span><span style="color: #007700">&gt;&gt; </span><span style="color: #0000BB">16</span><span style="color: #007700">) &amp; </span><span style="color: #0000BB">0777</span><span style="color: #007700">);<br />            }<br />        }<br />    }<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">"Ok\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"KO\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getexternalattributesindex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getexternalattributesindex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getexternalattributesindex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getexternalattributesindex.php">＋<small>add a note</small></a></span>
