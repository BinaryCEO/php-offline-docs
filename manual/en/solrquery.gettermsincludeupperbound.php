...
<head>
  ...
  <title>PHP: SolrQuery::getTermsIncludeUpperBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermsincludelowerbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermslimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermsincludeupperbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermsincludeupperbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermsincludeupperbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermsincludeupperbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermsincludeupperbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermsincludeupperbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermsincludeupperbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermsincludeupperbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermsincludeupperbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermsincludeupperbound.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not to include the upper bound term in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsIncludeUpperBound - Manual" />
<meta name="twitter:description" content="Returns whether or not to include the upper bound term in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsIncludeUpperBound - Manual" />
<meta itemprop="description" content="Returns whether or not to include the upper bound term in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not to include the upper bound term in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gettermslimit.php">
          SolrQuery::getTermsLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermsincludelowerbound.php">
          &laquo; SolrQuery::getTermsIncludeLowerBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsincludeupperbound.php' selected="selected">English</option>
            <option value='de/solrquery.gettermsincludeupperbound.php'>German</option>
            <option value='es/solrquery.gettermsincludeupperbound.php'>Spanish</option>
            <option value='fr/solrquery.gettermsincludeupperbound.php'>French</option>
            <option value='it/solrquery.gettermsincludeupperbound.php'>Italian</option>
            <option value='ja/solrquery.gettermsincludeupperbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermsincludeupperbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermsincludeupperbound.php'>Russian</option>
            <option value='tr/solrquery.gettermsincludeupperbound.php'>Turkish</option>
            <option value='uk/solrquery.gettermsincludeupperbound.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermsincludeupperbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermsincludeupperbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsIncludeUpperBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsIncludeUpperBound</span> &mdash; <span class="dc-title">Returns whether or not to include the upper bound term in the result set</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermsincludeupperbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsIncludeUpperBound</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermsincludeupperbound-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermsincludeupperbound-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsincludeupperbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsincludeupperbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsincludeupperbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php">＋<small>add a note</small></a></span>
