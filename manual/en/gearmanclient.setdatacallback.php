...
<head>
  ...
  <title>PHP: GearmanClient::setDataCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setdatacallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setdatacallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setdatacallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.setdata.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setdatacallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.setdatacallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.setdatacallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.setdatacallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.setdatacallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.setdatacallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.setdatacallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.setdatacallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.setdatacallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.setdatacallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.setdatacallback.php" hreflang="zh">
...
<meta name="Description" content="Callback function when there is a data packet for a task" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setDataCallback - Manual" />
<meta name="twitter:description" content="Callback function when there is a data packet for a task" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setDataCallback - Manual" />
<meta itemprop="description" content="Callback function when there is a data packet for a task" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Callback function when there is a data packet for a task" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.setexceptioncallback.php">
          GearmanClient::setExceptionCallback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.setdata.php">
          &laquo; GearmanClient::setData        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setdatacallback.php' selected="selected">English</option>
            <option value='de/gearmanclient.setdatacallback.php'>German</option>
            <option value='es/gearmanclient.setdatacallback.php'>Spanish</option>
            <option value='fr/gearmanclient.setdatacallback.php'>French</option>
            <option value='it/gearmanclient.setdatacallback.php'>Italian</option>
            <option value='ja/gearmanclient.setdatacallback.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.setdatacallback.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.setdatacallback.php'>Russian</option>
            <option value='tr/gearmanclient.setdatacallback.php'>Turkish</option>
            <option value='uk/gearmanclient.setdatacallback.php'>Ukrainian</option>
            <option value='zh/gearmanclient.setdatacallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.setdatacallback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::setDataCallback</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.6.0)</p><p class="refpurpose"><span class="refname">GearmanClient::setDataCallback</span> &mdash; <span class="dc-title">Callback function when there is a data packet for a task</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gearmanclient.setdatacallback-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::setDataCallback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gearmanclient.setdatacallback-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.setdatacallback-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanclient.setdatacallback-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setdatacallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setdatacallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setdatacallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setdatacallback.php">＋<small>add a note</small></a></span>
