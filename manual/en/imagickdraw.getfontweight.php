...
<head>
  ...
  <title>PHP: ImagickDraw::getFontWeight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfontweight.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfontweight.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontweight.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfontstyle.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getgravity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontweight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfontweight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfontweight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfontweight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfontweight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfontweight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfontweight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfontweight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfontweight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfontweight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfontweight.php" hreflang="zh">
...
<meta name="Description" content="Returns the font weight" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFontWeight - Manual" />
<meta name="twitter:description" content="Returns the font weight" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFontWeight - Manual" />
<meta itemprop="description" content="Returns the font weight" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the font weight" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getgravity.php">
          ImagickDraw::getGravity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfontstyle.php">
          &laquo; ImagickDraw::getFontStyle        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfontweight.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfontweight.php'>German</option>
            <option value='es/imagickdraw.getfontweight.php'>Spanish</option>
            <option value='fr/imagickdraw.getfontweight.php'>French</option>
            <option value='it/imagickdraw.getfontweight.php'>Italian</option>
            <option value='ja/imagickdraw.getfontweight.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfontweight.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfontweight.php'>Russian</option>
            <option value='tr/imagickdraw.getfontweight.php'>Turkish</option>
            <option value='uk/imagickdraw.getfontweight.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfontweight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfontweight" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFontWeight</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFontWeight</span> &mdash; <span class="dc-title">Returns the font weight</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfontweight-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> on success and 0 if no weight is set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfontweight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfontweight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfontweight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfontweight.php">＋<small>add a note</small></a></span>
