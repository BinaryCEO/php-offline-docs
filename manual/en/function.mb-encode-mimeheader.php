...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-encode-mimeheader.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-detect-order.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-encode-numericentity.php">
...
<meta name="Description" content="Encode string for MIME header" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_encode_mimeheader - Manual" />
<meta name="twitter:description" content="Encode string for MIME header" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_encode_mimeheader - Manual" />
<meta itemprop="description" content="Encode string for MIME header" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encode string for MIME header" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-encode-mimeheader.php' selected="selected">English</option>
            ...
            <option value='zh/function.mb-encode-mimeheader.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_encode_mimeheader</span> &mdash; <span class="dc-title">Encode string for MIME header</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-encode-mimeheader-description">
  ...
  <p class="para rdfs-comment">
   Encodes a given <span class="type"><a href="language.types.string.php" class="type string">string</a></span>
   <code class="parameter">string</code> by the MIME header encoding scheme.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       Its encoding should be same as <span class="function"><a href="function.mb-internal-encoding.php" class="function">mb_internal_encoding()</a></span>.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">charset</code> specifies the name of the character set
       in which <code class="parameter">string</code> is represented in. The default value
       is determined by the current NLS setting (<code class="literal">mbstring.language</code>).
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">transfer_encoding</code> specifies the scheme of MIME
       encoding. It should be either <code class="literal">&quot;B&quot;</code> (Base64) or
       <code class="literal">&quot;Q&quot;</code> (Quoted-Printable). Falls back to
       <code class="literal">&quot;B&quot;</code> if not given.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">newline</code> specifies the EOL (end-of-line) marker
       with which <span class="function"><strong>mb_encode_mimeheader()</strong></span> performs
       line-folding (a <a href="https://datatracker.ietf.org/doc/html/rfc2822" class="link external">&raquo;&nbsp;RFC</a> term,
       ...
       Falls back to <code class="literal">&quot;\r\n&quot;</code> (CRLF) if not given.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       before <code class="parameter">string</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-encode-mimeheader-returnvalues">
  ...
  <p class="para">
   A converted version of the <span class="type"><a href="language.types.string.php" class="type string">string</a></span> represented in ASCII.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.3.0</td>
      <td>
       <code class="literal">NUL</code> (0) bytes are no longer dropped when encoded
       using Quoted-Printable encoding, but encoded as <code class="literal">=00</code>.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">charset</code> and <code class="parameter">transfer_encoding</code>
       are nullable now.
      </td>
     </tr>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mb-decode-mimeheader.php" class="function" rel="rdfs-seeAlso">mb_decode_mimeheader()</a> - Decode string in MIME header field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-encode-mimeheader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-encode-mimeheader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-encode-mimeheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-encode-mimeheader.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Some solution for using national chars and have problem with UTF-8 for example in mail subject. Before you use mb_encode_mimeheader with UTF-8 set mb_internal_encoding('UTF-8').</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">True, function is broken (PHP5.1, encoding from UTF-8 with pl_PL charset). Below is about 15% faster version of proposed _mb_mime_encode. Also it has header more like othe mb_* functions and doesn't trigger any errors/warnings/notices.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">mb_mime_header</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">=</span><span class="default">null</span><span class="keyword">, </span><span class="default">$linefeed</span><span class="keyword">=</span><span class="string">"\r\n"</span><span class="keyword">) {<br />  if(!</span><span class="default">$encoding</span><span class="keyword">) </span><span class="default">$encoding </span><span class="keyword">= </span><span class="default">mb_internal_encoding</span><span class="keyword">();<br />  </span><span class="default">$encoded </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br /><br />  while(</span><span class="default">$length </span><span class="keyword">= </span><span class="default">mb_strlen</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">)) {<br />    </span><span class="default">$encoded </span><span class="keyword">.= </span><span class="string">"=?</span><span class="default">$encoding</span><span class="string">?B?"<br />             </span><span class="keyword">. </span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">mb_substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">24</span><span class="keyword">,</span><span class="default">$encoding</span><span class="keyword">))<br />             . </span><span class="string">"?=</span><span class="default">$linefeed</span><span class="string">"</span><span class="keyword">;<br /><br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">mb_substr</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">24</span><span class="keyword">,</span><span class="default">$length</span><span class="keyword">,</span><span class="default">$encoding</span><span class="keyword">);<br />  }<br /><br />  return </span><span class="default">$encoded</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Read this FIRST: <a href="http://bugs.php.net/bug.php?id=23192" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=23192</a> because mb_encode_mimeheaders is BUGGY!<br /><br />a work around for the multibyte broken error for too long subjects for ISO-2022-JP:<br /><br />$pos=0;<br />$split=36; // after 36 single bytes characters, if then comes MB, it is broken<br />while ($pos&lt;mb_strlen($string,$encoding))<br />{<br />  $output=mb_strimwidth($string,$pos,$split,"",$encoding);<br />  $pos+=mb_strlen($output,$encoding);<br />  $_string.=(($_string)?' ':'').mb_encode_mimeheader($output,$encoding);<br />}<br />$string=$_string;<br /><br />is not the best, but it works</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I could not find a PHP function to MIME encode the name for a n email address.
<br />
<br />Input   = "Karl Müller&lt;kmueller@gmx.de&gt;"
<br />Output = "Karl%20M%FCller&lt;kmueller@gmx.de&gt;"
<br />
<br />I wrote it on my own:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">// required to encode names in email addresses    
<br />// replace " " with "%20"
<br />// replace "ü" with "%FC" 
<br />// replace "%" with "%25"      etc....
<br />// Use "%" as Delimiter for MIME
<br />// Use "=" as Delimiter for Quoted Printable
<br />// Input string must be UTF8 encoded
<br /></span><span class="keyword">public static function </span><span class="default">EncodeMime</span><span class="keyword">(</span><span class="default">$Text</span><span class="keyword">, </span><span class="default">$Delimiter</span><span class="keyword">)
<br />{
<br />    </span><span class="default">$Text </span><span class="keyword">= </span><span class="default">utf8_decode</span><span class="keyword">(</span><span class="default">$Text</span><span class="keyword">);
<br />    </span><span class="default">$Len  </span><span class="keyword">= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$Text</span><span class="keyword">);
...
<br />    {
<br />        </span><span class="default">$Chr </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$Text</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);
<br />        </span><span class="default">$Asc </span><span class="keyword">= </span><span class="default">ord</span><span class="keyword">(</span><span class="default">$Chr</span><span class="keyword">);
<br />
<br />        if (</span><span class="default">$Asc </span><span class="keyword">&gt; </span><span class="default">0x255</span><span class="keyword">) </span><span class="comment">// Unicode not allowed
<br />        </span><span class="keyword">{
<br />            </span><span class="default">$Out </span><span class="keyword">.= </span><span class="string">"?"</span><span class="keyword">;
<br />        }
<br />        else if (</span><span class="default">$Chr </span><span class="keyword">== </span><span class="string">" " </span><span class="keyword">|| </span><span class="default">$Chr </span><span class="keyword">== </span><span class="default">$Delimiter </span><span class="keyword">|| </span><span class="default">$Asc </span><span class="keyword">&gt; </span><span class="default">127</span><span class="keyword">) 
<br />        {
<br />            </span><span class="default">$Out </span><span class="keyword">.= </span><span class="default">$Delimiter </span><span class="keyword">. </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">bin2hex</span><span class="keyword">(</span><span class="default">$Chr</span><span class="keyword">));
<br />        }
<br />        else </span><span class="default">$Out </span><span class="keyword">.= </span><span class="default">$Chr</span><span class="keyword">;
<br />    }
...
<div class="phpcode"><code><span class="html">mb_encode_mimeheader() depends on correct mbstring.internal_encoding setting. It tries to convert $str from internal encoding to $charset. If you ignore mbstring internal encoding, function might encode strings incorrectly even when $str character set matches $charset</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>gullevek at gullevek dot org</em></strong></a><a class="genanchor" href="#58515"> &para;</a><div class="date" title="2005-11-06 05:29"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom58515">
<div class="phpcode"><code><span class="html">My first post was around 2003, and still the mb_mime_header is broken. It is *NOT* usable with longer subjects, and mostly unusable with anything else than japanese.<br /><br />iwakura at junx dot org is also not working for me, it produces also some gargabe.<br /><br />I updated my old function (the one I posted 2003) and I tested it with overlong subjects in UTF-8, ISO-2022-JP (japanese), GB2312 (simplified chinese) and EUC-KR (korean) and I got readable results in thunderbird, mail.app, outlook, etc.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">_mb_mime_encode</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">)<br />{<br />    </span><span class="default">$pos </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />    </span><span class="comment">// after 36 single bytes characters if then comes MB, it is broken<br />    // but I trimmed it down to 24, to stay 100% &lt; 76 chars per line<br />    </span><span class="default">$split </span><span class="keyword">= </span><span class="default">24</span><span class="keyword">;<br />    while (</span><span class="default">$pos </span><span class="keyword">&lt; </span><span class="default">mb_strlen</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">))<br />    {<br />        </span><span class="default">$output </span><span class="keyword">= </span><span class="default">mb_strimwidth</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">, </span><span class="default">$pos</span><span class="keyword">, </span><span class="default">$split</span><span class="keyword">, </span><span class="string">""</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">);<br />        </span><span class="default">$pos </span><span class="keyword">+= </span><span class="default">mb_strlen</span><span class="keyword">(</span><span class="default">$output</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">);<br />        </span><span class="default">$_string_encoded </span><span class="keyword">= </span><span class="string">"=?"</span><span class="keyword">.</span><span class="default">$encoding</span><span class="keyword">.</span><span class="string">"?B?"</span><span class="keyword">.</span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">$output</span><span class="keyword">).</span><span class="string">"?="</span><span class="keyword">;<br />        if (</span><span class="default">$_string</span><span class="keyword">)<br />            </span><span class="default">$_string </span><span class="keyword">.= </span><span class="string">"\r\n"</span><span class="keyword">;<br />        </span><span class="default">$_string </span><span class="keyword">.= </span><span class="default">$_string_encoded</span><span class="keyword">;<br />    }<br />    </span><span class="default">$string </span><span class="keyword">= </span><span class="default">$_string</span><span class="keyword">;<br />    return </span><span class="default">$string</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If mb_ version doesn't work for you in MIME-B mode:<br /><br />function encode_mimeheader($string, $charset=null, $linefeed="\r\n") {<br />    if (!$charset)<br />        $charset = mb_internal_encoding();<br /><br />    $start = "=?$charset?B?";<br />    $end = "?=";<br />    $encoded = '';<br /><br />    /* Each line must have length &lt;= 75, including $start and $end */<br />    $length = 75 - strlen($start) - strlen($end);<br />    /* Average multi-byte ratio */<br />    $ratio = mb_strlen($string, $charset) / strlen($string);<br />    /* Base64 has a 4:3 ratio */<br />    $magic = $avglength = floor(3 * $length * $ratio / 4);<br /><br />    for ($i=0; $i &lt;= mb_strlen($string, $charset); $i+=$magic) {<br />        $magic = $avglength;<br />        $offset = 0;<br />        /* Recalculate magic for each line to be 100% sure */<br />        do {<br />            $magic -= $offset;<br />            $chunk = mb_substr($string, $i, $magic, $charset);<br />            $chunk = base64_encode($chunk);<br />            $offset++;<br />        } while (strlen($chunk) &gt; $length);<br />        if ($chunk)<br />            $encoded .= ' '.$start.$chunk.$end.$linefeed;<br />    }<br />    /* Chomp the first space and the last linefeed */<br />    $encoded = substr($encoded, 1, -strlen($linefeed));<br /><br />    return $encoded;<br />}</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>chappy at citromail dot hu</em></strong></a><a class="genanchor" href="#58262"> &para;</a><div class="date" title="2005-10-28 11:14"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom58262">
<div class="phpcode"><code><span class="html">In countries where there's non-us ASCII, it's a very good example, for sending mail:<br /><br />mb_internal_encoding('iso-8859-2');<br />setlocale(LC_CTYPE, 'hu_HU');<br /><br />function encode($str,$charset){<br />    $str=mb_encode_mimeheader(trim($str),$charset, 'Q', "\n\t");<br />    return $str;<br />}<br /><br />print encode('the text with spec. chars: &amp;#337; &amp;#368; &amp;#336; &amp;#369;, ?','iso-8859-2');<br /><br />It creates a 7bit string</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">i think mb_encode_mimeheader still have bug. here is sample code:<br /><br />function mb_encode_mimeheader2($string, $encoding = "ISO-2022-JP") {<br />    $string_array = array();<br />    $pos = 0;<br />    $row = 0;<br />    $mode = 0;<br />    <br />    while ($pos &lt; mb_strlen($string)) {<br />        $word = mb_strimwidth($string, $pos, 1);<br />        if (!$word) {<br />            $word = mb_strimwidth($string, $pos, 2);<br />        }<br />        if (mb_ereg_match("[ -~]", $word)) {    // ascii<br />            if ($mode != 1) {<br />                $row++;<br />                $mode = 1;<br />                $string_array[$row] = NULL;<br />            }<br />        } else {                                // multibyte<br />            if ($mode != 2) {<br />                $row++;<br />                $mode = 2;<br />                $string_array[$row] = NULL;<br />            }<br />        }<br />        $string_array[$row] .= $word;<br />        $pos++;<br />    }<br />    <br />    //echo "&lt;pre&gt;";<br />    //print_r($string_array);<br />    //echo "&lt;/pre&gt;";<br />    <br />    foreach ($string_array as $key =&gt; $value) {<br />        $value = mb_convert_encoding($value, $encoding);<br />        $string_array[$key] = mb_encode_mimeheader($value, $encoding);<br />    }<br />    <br />    //echo "&lt;pre&gt;";<br />    //print_r($string_array);<br />    //echo "&lt;/pre&gt;";<br />    <br />    return implode("", $string_array);<br />}<br /><br />is not the best, but it works</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">At least for Q encoding, this function is unsafe and does not encode correctly. Raw characters which appear as RFC2047 sequences are simply left as is.<br /><br />Ex:<br /><br />mb_encode_mimeheader( '=?iso-8859-1?q?this=20is=20some=20text?=' );<br /><br />returns '=?iso-8859-1?q?this=20is=20some=20text?='<br /><br />The exact same string, which is obviously not the encoding for the source string.  That is, mb_encode_mimeheader does not do any type of escaping.<br /><br />That is, the following condition is not always true:<br />    mb_decode_mimeheader( mb_encode_mimeheader( $text ) ) == $text</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-encode-mimeheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-encode-mimeheader.php">＋<small>add a note</small></a></div>
