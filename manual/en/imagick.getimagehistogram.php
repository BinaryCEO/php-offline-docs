...
<head>
  ...
  <title>PHP: Imagick::getImageHistogram - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagehistogram.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagehistogram.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagehistogram.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageheight.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagehistogram.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagehistogram.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagehistogram.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagehistogram.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagehistogram.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagehistogram.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagehistogram.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagehistogram.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagehistogram.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagehistogram.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagehistogram.php" hreflang="zh">
...
<meta name="Description" content="Gets the image histogram" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageHistogram - Manual" />
<meta name="twitter:description" content="Gets the image histogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageHistogram - Manual" />
<meta itemprop="description" content="Gets the image histogram" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image histogram" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageindex.php">
          Imagick::getImageIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageheight.php">
          &laquo; Imagick::getImageHeight        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagehistogram.php' selected="selected">English</option>
            <option value='de/imagick.getimagehistogram.php'>German</option>
            <option value='es/imagick.getimagehistogram.php'>Spanish</option>
            <option value='fr/imagick.getimagehistogram.php'>French</option>
            <option value='it/imagick.getimagehistogram.php'>Italian</option>
            <option value='ja/imagick.getimagehistogram.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagehistogram.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagehistogram.php'>Russian</option>
            <option value='tr/imagick.getimagehistogram.php'>Turkish</option>
            <option value='uk/imagick.getimagehistogram.php'>Ukrainian</option>
            <option value='zh/imagick.getimagehistogram.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagehistogram" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageHistogram</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageHistogram</span> &mdash; <span class="dc-title">Gets the image histogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagehistogram-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageHistogram</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagehistogram-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagehistogram-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagehistogram-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.getimagehistogram-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3011">
      <p><strong>Example #1 Generates  <span class="function"><strong>Imagick::getImageHistogram()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">getColorStatistics</span><span style="color: #007700">(</span><span style="color: #0000BB">$histogramElements</span><span style="color: #007700">, </span><span style="color: #0000BB">$colorChannel</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$colorStatistics </span><span style="color: #007700">= [];<br /><br />    foreach (</span><span style="color: #0000BB">$histogramElements </span><span style="color: #007700">as </span><span style="color: #0000BB">$histogramElement</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$color </span><span style="color: #007700">= </span><span style="color: #0000BB">$histogramElement</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getColorValue</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorChannel</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$color </span><span style="color: #007700">= </span><span style="color: #0000BB">intval</span><span style="color: #007700">(</span><span style="color: #0000BB">$color </span><span style="color: #007700">* </span><span style="color: #0000BB">255</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$count </span><span style="color: #007700">= </span><span style="color: #0000BB">$histogramElement</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getColorCount</span><span style="color: #007700">();<br /><br />        if (</span><span style="color: #0000BB">array_key_exists</span><span style="color: #007700">(</span><span style="color: #0000BB">$color</span><span style="color: #007700">, </span><span style="color: #0000BB">$colorStatistics</span><span style="color: #007700">)) {<br />            </span><span style="color: #0000BB">$colorStatistics</span><span style="color: #007700">[</span><span style="color: #0000BB">$color</span><span style="color: #007700">] += </span><span style="color: #0000BB">$count</span><span style="color: #007700">;<br />        }<br />        else {<br />            </span><span style="color: #0000BB">$colorStatistics</span><span style="color: #007700">[</span><span style="color: #0000BB">$color</span><span style="color: #007700">] = </span><span style="color: #0000BB">$count</span><span style="color: #007700">;<br />        }<br />    }<br /><br />    </span><span style="color: #0000BB">ksort</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorStatistics</span><span style="color: #007700">);<br />    <br />    return </span><span style="color: #0000BB">$colorStatistics</span><span style="color: #007700">;<br />}<br />    <br /><br /><br />function </span><span style="color: #0000BB">getImageHistogram</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">) {<br /><br />    </span><span style="color: #0000BB">$backgroundColor </span><span style="color: #007700">= </span><span style="color: #DD0000">'black'</span><span style="color: #007700">;<br /><br />    </span><span style="color: #0000BB">$draw </span><span style="color: #007700">= new </span><span style="color: #0000BB">\ImagickDraw</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeWidth</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">); </span><span style="color: #FF8000">//make the lines be as thin as possible<br /><br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">500</span><span style="color: #007700">, </span><span style="color: #0000BB">500</span><span style="color: #007700">, </span><span style="color: #0000BB">$backgroundColor</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">drawImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$histogramWidth </span><span style="color: #007700">= </span><span style="color: #0000BB">256</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$histogramHeight </span><span style="color: #007700">= </span><span style="color: #0000BB">100</span><span style="color: #007700">; </span><span style="color: #FF8000">// the height for each RGB segment<br /><br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">(</span><span style="color: #0000BB">realpath</span><span style="color: #007700">(</span><span style="color: #0000BB">$imagePath</span><span style="color: #007700">));<br />    </span><span style="color: #FF8000">//Resize the image to be small, otherwise PHP tends to run out of memory<br />    //This might lead to bad results for images that are pathologically 'pixelly'<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">adaptiveResizeImage</span><span style="color: #007700">(</span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">200</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$histogramElements </span><span style="color: #007700">= </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageHistogram</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">$histogram </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$histogram</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newpseudoimage</span><span style="color: #007700">(</span><span style="color: #0000BB">$histogramWidth</span><span style="color: #007700">, </span><span style="color: #0000BB">$histogramHeight </span><span style="color: #007700">* </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #DD0000">'xc:black'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$histogram</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'png'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$getMax </span><span style="color: #007700">= function (</span><span style="color: #0000BB">$carry</span><span style="color: #007700">, </span><span style="color: #0000BB">$item</span><span style="color: #007700">)  {<br />        if (</span><span style="color: #0000BB">$item </span><span style="color: #007700">&gt; </span><span style="color: #0000BB">$carry</span><span style="color: #007700">) {<br />            return </span><span style="color: #0000BB">$item</span><span style="color: #007700">;<br />        }<br />        return </span><span style="color: #0000BB">$carry</span><span style="color: #007700">;<br />    };<br /><br />    </span><span style="color: #0000BB">$colorValues </span><span style="color: #007700">= [<br />        </span><span style="color: #DD0000">'red' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">getColorStatistics</span><span style="color: #007700">(</span><span style="color: #0000BB">$histogramElements</span><span style="color: #007700">, </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COLOR_RED</span><span style="color: #007700">),<br />        </span><span style="color: #DD0000">'lime' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">getColorStatistics</span><span style="color: #007700">(</span><span style="color: #0000BB">$histogramElements</span><span style="color: #007700">, </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COLOR_GREEN</span><span style="color: #007700">),<br />        </span><span style="color: #DD0000">'blue' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">getColorStatistics</span><span style="color: #007700">(</span><span style="color: #0000BB">$histogramElements</span><span style="color: #007700">, </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">COLOR_BLUE</span><span style="color: #007700">),<br />    ];<br /><br />    </span><span style="color: #0000BB">$max </span><span style="color: #007700">= </span><span style="color: #0000BB">array_reduce</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorValues</span><span style="color: #007700">[</span><span style="color: #DD0000">'red'</span><span style="color: #007700">] , </span><span style="color: #0000BB">$getMax</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$max </span><span style="color: #007700">= </span><span style="color: #0000BB">array_reduce</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorValues</span><span style="color: #007700">[</span><span style="color: #DD0000">'lime'</span><span style="color: #007700">] , </span><span style="color: #0000BB">$getMax</span><span style="color: #007700">, </span><span style="color: #0000BB">$max</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$max </span><span style="color: #007700">= </span><span style="color: #0000BB">array_reduce</span><span style="color: #007700">(</span><span style="color: #0000BB">$colorValues</span><span style="color: #007700">[</span><span style="color: #DD0000">'blue'</span><span style="color: #007700">] , </span><span style="color: #0000BB">$getMax</span><span style="color: #007700">, </span><span style="color: #0000BB">$max</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$scale </span><span style="color: #007700">=  </span><span style="color: #0000BB">$histogramHeight </span><span style="color: #007700">/ </span><span style="color: #0000BB">$max</span><span style="color: #007700">;<br /><br />    </span><span style="color: #0000BB">$count </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br />    foreach (</span><span style="color: #0000BB">$colorValues </span><span style="color: #007700">as </span><span style="color: #0000BB">$color </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$values</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setstrokecolor</span><span style="color: #007700">(</span><span style="color: #0000BB">$color</span><span style="color: #007700">);<br /><br />        </span><span style="color: #0000BB">$offset </span><span style="color: #007700">= (</span><span style="color: #0000BB">$count </span><span style="color: #007700">+ </span><span style="color: #0000BB">1</span><span style="color: #007700">) * </span><span style="color: #0000BB">$histogramHeight</span><span style="color: #007700">;<br /><br />        foreach (</span><span style="color: #0000BB">$values </span><span style="color: #007700">as </span><span style="color: #0000BB">$index </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">$value</span><span style="color: #007700">) {<br />            </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">line</span><span style="color: #007700">(</span><span style="color: #0000BB">$index</span><span style="color: #007700">, </span><span style="color: #0000BB">$offset</span><span style="color: #007700">, </span><span style="color: #0000BB">$index</span><span style="color: #007700">, </span><span style="color: #0000BB">$offset </span><span style="color: #007700">- (</span><span style="color: #0000BB">$value </span><span style="color: #007700">* </span><span style="color: #0000BB">$scale</span><span style="color: #007700">));<br />        }<br />        </span><span style="color: #0000BB">$count</span><span style="color: #007700">++;<br />    }<br /><br />    </span><span style="color: #0000BB">$histogram</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">drawImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw</span><span style="color: #007700">);<br />    <br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">( </span><span style="color: #DD0000">"Content-Type: image/png" </span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$histogram</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagehistogram.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagehistogram%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagehistogram&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagehistogram.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104514">  <div class="votes">
    <div id="Vu104514">
    <a href="/manual/vote-note.php?id=104514&amp;page=imagick.getimagehistogram&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104514">
    <a href="/manual/vote-note.php?id=104514&amp;page=imagick.getimagehistogram&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104514" title="54% like this...">
    2
    </div>
  </div>
  <a href="#104514" class="name">
  <strong class="user"><em>Iddles</em></strong></a><a class="genanchor" href="#104514"> &para;</a><div class="date" title="2011-06-20 04:02"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104514">
<div class="phpcode"><code><span class="html">Scratched my head for a while trying to figure out why this only returned a list of coloured pixels, and seemingly no colour count. Well it turns out that for some reason, the ImagickPixel class has a "getColorCount" method, which seems a strange place for it but hey.<br /><br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"thing.png"</span><span class="keyword">);<br /></span><span class="default">$pixels</span><span class="keyword">=</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageHistogram</span><span class="keyword">();<br />foreach(</span><span class="default">$pixels </span><span class="keyword">as </span><span class="default">$p</span><span class="keyword">){<br /> </span><span class="default">$colors </span><span class="keyword">= </span><span class="default">$p</span><span class="keyword">-&gt;</span><span class="default">getColor</span><span class="keyword">();<br /> foreach(</span><span class="default">$colors </span><span class="keyword">as </span><span class="default">$c</span><span class="keyword">){<br />        print( </span><span class="string">"</span><span class="default">$c</span><span class="string">\t" </span><span class="keyword">);<br /> }<br /> print( </span><span class="string">"\t:\t" </span><span class="keyword">. </span><span class="default">$p</span><span class="keyword">-&gt;</span><span class="default">getColorCount</span><span class="keyword">() . </span><span class="string">"\n" </span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />This will print out something like:<br /><br />252    250    252    1    :    125<br />194    156    182    1    :    126<br />109    18    79    1    :    11440<br />2    117    162    1    :    12761<br />255    255    255    1    :    40769<br /><br />...where the colums are red, green, blue, alpha, followed by the number of times that colour appears in the image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagehistogram&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagehistogram.php">＋<small>add a note</small></a></div>
