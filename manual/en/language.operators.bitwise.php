...
<head>
  ...
  <title>PHP: Bitwise - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.operators.bitwise.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/language.operators.assignment.php">
 <link rel="next" href="https://www.php.net/manual/en/language.operators.comparison.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/language.operators.bitwise.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/language.operators.bitwise.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.operators.bitwise.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.operators.bitwise.php" hreflang="uk">
...
<meta name="twitter:title" content="PHP: Bitwise - Manual" />
<meta name="twitter:description" content="Bitwise Operators" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Bitwise - Manual" />
<meta itemprop="description" content="Bitwise Operators" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/language.operators.bitwise.php'>Italian</option>
            ...
            <option value='uk/language.operators.bitwise.php'>Ukrainian</option>
  ...
  <caption><strong>Bitwise Operators</strong></caption>
   ...
   <tbody class="tbody">
    <tr>
     ...
     <td>And</td>
     <td>Bits that are set in both <var class="varname">$a</var> and <var class="varname">$b</var> are set.</td>
    </tr>

    <tr>
     <td><strong class="userinput"><code>$a | $b</code></strong></td>
     <td>Or (inclusive or)</td>
     <td>Bits that are set in either <var class="varname">$a</var> or <var class="varname">$b</var> are set.</td>
    </tr>
 ...
 <p class="para">
  ...
  For example, <code class="literal">$a &amp; $b == true</code> evaluates
  the equivalency then the bitwise and; while
  <code class="literal">($a &amp; $b) == true</code> evaluates the bitwise and
  then the equivalency.
 </p>
 <p class="para">
  If both operands for the <code class="literal">&amp;</code>, <code class="literal">|</code> and
  <code class="literal">^</code> operators are strings, then the operation will be
 ...
 <p class="para">
  If the operand for the <code class="literal">~</code> operator is a string, the
 ...
 <p class="para">
  Both operands and the result for the <code class="literal">&lt;&lt;</code> and
  <code class="literal">&gt;&gt;</code> operators are always treated as integers.
 </p>
 <p class="para">
 ...
 <p class="para">
  Another way to accomplish that is using XOR (<code class="literal">^</code>) to find
  bits that are on in only one value or the other: <strong class="userinput"><code>E_ALL ^
  E_NOTICE</code></strong>
 </p>
 <p class="para">
...
(13 = 1101) = ( 8 = 1000) ^ ( 5 = 0101)
 ...
 <p class="para">
  <div class="example" id="example-164">
   ...
   <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">12 </span><span style="color: #007700">^ </span><span style="color: #0000BB">9</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">; </span><span style="color: #FF8000">// Outputs '5'<br /><br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"12" </span><span style="color: #007700">^ </span><span style="color: #DD0000">"9"</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">; </span><span style="color: #FF8000">// Outputs the Backspace character (ascii 8)<br />                          // ('1' (ascii 49)) ^ ('9' (ascii 57)) = #8<br /><br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"hallo" </span><span style="color: #007700">^ </span><span style="color: #DD0000">"hello"</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">; </span><span style="color: #FF8000">// Outputs the ascii values #0 #4 #0 #0 #0<br />                                 // 'a' ^ 'e' = #4<br /><br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">2 </span><span style="color: #007700">^ </span><span style="color: #DD0000">"3"</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">; </span><span style="color: #FF8000">// Outputs 1<br />                       // 2 ^ ((int) "3") == 1<br /><br /></span><span style="color: #007700">echo </span><span style="color: #DD0000">"2" </span><span style="color: #007700">^ </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">; </span><span style="color: #FF8000">// Outputs 1<br />                       // ((int) "2") ^ 3 == 1<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
Expression: 0 = -4 &lt;&lt; 62
 ...
 <div class="warning"><strong class="warning">Warning</strong>
  <p class="para">
   ...
   bitwise manipulation on numbers beyond <strong><code><a href="reserved.constants.php#constant.php-int-max">PHP_INT_MAX</a></code></strong>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-clrbit.php" class="function">gmp_clrbit()</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/operators/bitwise.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.operators.bitwise%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.operators.bitwise&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.operators.bitwise.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Initially, I found bitmasking to be a confusing concept and found no use for it. So I've whipped up this code snippet in case anyone else is confused:<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="comment">// The various details a vehicle can have<br />    </span><span class="default">$hasFourWheels </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />    </span><span class="default">$hasTwoWheels  </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">;<br />    </span><span class="default">$hasDoors      </span><span class="keyword">= </span><span class="default">4</span><span class="keyword">;<br />    </span><span class="default">$hasRedColour  </span><span class="keyword">= </span><span class="default">8</span><span class="keyword">;<br /><br />    </span><span class="default">$bike          </span><span class="keyword">= </span><span class="default">$hasTwoWheels</span><span class="keyword">;<br />    </span><span class="default">$golfBuggy     </span><span class="keyword">= </span><span class="default">$hasFourWheels</span><span class="keyword">;<br />    </span><span class="default">$ford          </span><span class="keyword">= </span><span class="default">$hasFourWheels </span><span class="keyword">| </span><span class="default">$hasDoors</span><span class="keyword">;<br />    </span><span class="default">$ferrari       </span><span class="keyword">= </span><span class="default">$hasFourWheels </span><span class="keyword">| </span><span class="default">$hasDoors </span><span class="keyword">| </span><span class="default">$hasRedColour</span><span class="keyword">;<br /><br />    </span><span class="default">$isBike        </span><span class="keyword">= </span><span class="default">$hasFourWheels </span><span class="keyword">&amp; </span><span class="default">$bike</span><span class="keyword">; </span><span class="comment"># False, because $bike doens't have four wheels<br />    </span><span class="default">$isGolfBuggy   </span><span class="keyword">= </span><span class="default">$hasFourWheels </span><span class="keyword">&amp; </span><span class="default">$golfBuggy</span><span class="keyword">; </span><span class="comment"># True, because $golfBuggy has four wheels<br />    </span><span class="default">$isFord        </span><span class="keyword">= </span><span class="default">$hasFourWheels </span><span class="keyword">&amp; </span><span class="default">$ford</span><span class="keyword">; </span><span class="comment"># True, because $ford $hasFourWheels<br /><br /></span><span class="default">?&gt;<br /></span><br />And you can apply this to a lot of things, for example, security:<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="comment">// Security permissions:<br />    </span><span class="default">$writePost </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />    </span><span class="default">$readPost </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">;<br />    </span><span class="default">$deletePost </span><span class="keyword">= </span><span class="default">4</span><span class="keyword">;<br />    </span><span class="default">$addUser </span><span class="keyword">= </span><span class="default">8</span><span class="keyword">;<br />    </span><span class="default">$deleteUser </span><span class="keyword">= </span><span class="default">16</span><span class="keyword">;<br />    <br />    </span><span class="comment">// User groups:<br />    </span><span class="default">$administrator </span><span class="keyword">= </span><span class="default">$writePost </span><span class="keyword">| </span><span class="default">$readPosts </span><span class="keyword">| </span><span class="default">$deletePosts </span><span class="keyword">| </span><span class="default">$addUser </span><span class="keyword">| </span><span class="default">$deleteUser</span><span class="keyword">;<br />    </span><span class="default">$moderator </span><span class="keyword">= </span><span class="default">$readPost </span><span class="keyword">| </span><span class="default">$deletePost </span><span class="keyword">| </span><span class="default">$deleteUser</span><span class="keyword">;<br />    </span><span class="default">$writer </span><span class="keyword">= </span><span class="default">$writePost </span><span class="keyword">| </span><span class="default">$readPost</span><span class="keyword">;<br />    </span><span class="default">$guest </span><span class="keyword">= </span><span class="default">$readPost</span><span class="keyword">;<br /><br />    </span><span class="comment">// function to check for permission<br />    </span><span class="keyword">function </span><span class="default">checkPermission</span><span class="keyword">(</span><span class="default">$user</span><span class="keyword">, </span><span class="default">$permission</span><span class="keyword">) {<br />        if(</span><span class="default">$user </span><span class="keyword">&amp; </span><span class="default">$permission</span><span class="keyword">) {<br />            return </span><span class="default">true</span><span class="keyword">;<br />        } else {<br />            return </span><span class="default">false</span><span class="keyword">;<br />        }<br />    }<br /><br />    </span><span class="comment">// Now we apply all of this!<br />    </span><span class="keyword">if(</span><span class="default">checkPermission</span><span class="keyword">(</span><span class="default">$administrator</span><span class="keyword">, </span><span class="default">$deleteUser</span><span class="keyword">)) {<br />        </span><span class="default">deleteUser</span><span class="keyword">(</span><span class="string">"Some User"</span><span class="keyword">); </span><span class="comment"># This is executed because $administrator can $deleteUser<br />    </span><span class="keyword">}<br /><br /></span><span class="default">?&gt;<br /></span><br />Once you get your head around it, it's VERY useful! Just remember to raise each value by the power of two to avoid problems</span></code></div>
  ...
  <strong class="user"><em>S?b.</em></strong></a><a class="genanchor" href="#50622"> &para;</a><div class="date" title="2005-03-04 03:13"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom50622">
<div class="phpcode"><code><span class="html">A bitwise operators practical case :<br /><br /><span class="default">&lt;?php<br />    </span><span class="comment">// We want to know the red, green and blue values of this color :<br />    </span><span class="default">$color </span><span class="keyword">= </span><span class="default">0xFEA946 </span><span class="keyword">;<br /><br />    </span><span class="default">$red </span><span class="keyword">= </span><span class="default">$color </span><span class="keyword">&gt;&gt; </span><span class="default">16 </span><span class="keyword">;<br />    </span><span class="default">$green </span><span class="keyword">= (</span><span class="default">$color </span><span class="keyword">&amp; </span><span class="default">0x00FF00</span><span class="keyword">) &gt;&gt; </span><span class="default">8 </span><span class="keyword">;<br />    </span><span class="default">$blue </span><span class="keyword">= </span><span class="default">$color </span><span class="keyword">&amp; </span><span class="default">0x0000FF </span><span class="keyword">;<br /><br />    </span><span class="default">printf</span><span class="keyword">(</span><span class="string">'Red : %X (%d), Green : %X (%d), Blue : %X (%d)'</span><span class="keyword">,<br />        </span><span class="default">$red</span><span class="keyword">, </span><span class="default">$red</span><span class="keyword">, </span><span class="default">$green</span><span class="keyword">, </span><span class="default">$green</span><span class="keyword">, </span><span class="default">$blue</span><span class="keyword">, </span><span class="default">$blue</span><span class="keyword">) ;<br /><br />    </span><span class="comment">// Will display...<br />    // Red : FE (254), Green : A9 (169), Blue : 46 (70)<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="109792">  <div class="votes">
    ...
    <div class="tally" id="V109792" title="75% like this...">
    14
    </div>
  </div>
  <a href="#109792" class="name">
  <strong class="user"><em>frankemeks77 at yahoo dot com</em></strong></a><a class="genanchor" href="#109792"> &para;</a><div class="date" title="2012-08-21 01:24"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109792">
<div class="phpcode"><code><span class="html">Just learning Bitwise Shift Operators.
<br />
...
<br /></span>
<br />//Solving on a paper 8/2 = 4/2 = 2/2 = 1</span></code></div>
  </div>
 </div>
  <div class="note" id="90850">  <div class="votes">
    ...
    <div class="tally" id="V90850" title="73% like this...">
    11
    </div>
  </div>
  <a href="#90850" class="name">
  <strong class="user"><em>Silver</em></strong></a><a class="genanchor" href="#90850"> &para;</a><div class="date" title="2009-05-12 04:36"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90850">
<div class="phpcode"><code><span class="html">Regarding what Bob said about flags, I'd like to point out there's a 100% safe way of defining flags, which is using hexadecimal notation for integers:<br /><br /><span class="default">&lt;?php<br />define</span><span class="keyword">(</span><span class="string">"f0"</span><span class="keyword">, </span><span class="default">0x1</span><span class="keyword">); </span><span class="comment">// 2^0<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f1"</span><span class="keyword">, </span><span class="default">0x2</span><span class="keyword">); </span><span class="comment">// 2^1<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f2"</span><span class="keyword">, </span><span class="default">0x4</span><span class="keyword">); </span><span class="comment">// 2^2<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f3"</span><span class="keyword">, </span><span class="default">0x8</span><span class="keyword">); </span><span class="comment">// 2^3<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f4"</span><span class="keyword">, </span><span class="default">0x10</span><span class="keyword">); </span><span class="comment">// 2^4<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f5"</span><span class="keyword">, </span><span class="default">0x20</span><span class="keyword">); </span><span class="comment">// 2^5<br />// ...<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f20"</span><span class="keyword">, </span><span class="default">0x1000000</span><span class="keyword">); </span><span class="comment">// 2^20<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f21"</span><span class="keyword">, </span><span class="default">0x2000000</span><span class="keyword">); </span><span class="comment">// 2^21<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f22"</span><span class="keyword">, </span><span class="default">0x4000000</span><span class="keyword">); </span><span class="comment">// 2^22<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f23"</span><span class="keyword">, </span><span class="default">0x8000000</span><span class="keyword">); </span><span class="comment">// 2^23<br /></span><span class="default">define</span><span class="keyword">(</span><span class="string">"f24"</span><span class="keyword">, </span><span class="default">0x10000000</span><span class="keyword">); </span><span class="comment">// 2^24<br />// ... up to 2^31<br /></span><span class="default">?&gt;<br /></span><br />I always avoid using decimal notation when I have a large amount of different flags, because it's very easy to misspell numbers like 2^20 (1048576).</span></code></div>
  </div>
 </div>
  <div class="note" id="72300">  <div class="votes">
    ...
    <div class="tally" id="V72300" title="73% like this...">
    9
    </div>
  </div>
  <a href="#72300" class="name">
  <strong class="user"><em>zewt at hotmail dot com</em></strong></a><a class="genanchor" href="#72300"> &para;</a><div class="date" title="2007-01-11 11:28"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72300">
<div class="phpcode"><code><span class="html">if you use bitwise you MUST make sure your variables are integers, otherwise you can get incorrect results.<br /><br />I recommend ALWAYS<br /><br />(int)$var &amp; (int)$var2<br /><br />This will save you many headaches when troubleshooting a completely illogical result.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If, like me, you've never thought about how PHP deals with binary, the output of the bitwise NOT may confuse you.  For instance, this:<br /><br />$bin = 2;<br />$notbin = ~$bin;<br /><br />echo "Bin: " . decbin($bin) . "  !bin:  " . decbin($notbin) . "\n";<br /><br />returns this:<br /><br />Bin: 10  !bin:  1111111111111111111111111111111111111111111111111111111111111101<br /><br />The reason is that all binary numbers are treated as 32 bits, even if you've manually entered less.  In order to get the result I expected (01), it was necessary to AND the result with the number of bits I wanted:  in this case, 2 (the number 3, in decimal).  Be aware that all return values will have zeros removed from the left until they reach a bit that is set to 1.  Continuing the above example, the following:<br /><br />$notbin_2 = ~$bin &amp; '3';<br />echo "!bin &amp; 3:  " . decbin($notbin_2) . "\n";<br /><br />returns this:<br /><br />!bin &amp; 3:  1<br /><br />Note that the actual value was a string of 31 zeros followed by a 1, but the zeros were not shown.  This is probably a good thing.<br /><br />Furthermore, the NOT operator uses two's complement, which means the number you get may be even stranger than you expect:  using two's complement means that ~2 == -3.  There are plenty of good explanations of two's complement online, so I won't go into that question here.<br /><br />If what you want is just to reverse a string of bits without any interpretation, you can use a function like this:<br /><br />function bitnot($bin)<br /> {<br />   $not = "";<br />   for ($i = 0; $i &lt; strlen($bin); $i++)<br />   {<br />      if($bin[$i] == 0) { $not .= '1'; }<br />      if($bin[$i] == 1) { $not .= '0'; }<br />   }<br />   return $not;<br /> }<br /><br />It takes a binary string of any length, reverses the bits, and returns the new string.  You can then treat it as a binary number, use bindec() to turn it into a decimal, or whatever you want.<br /><br />I hope this helps someone as much as it would have helped me a week ago!</span></code></div>
  ...
  <div class="note" id="84954">  <div class="votes">
    ...
    <div class="tally" id="V84954" title="69% like this...">
    5
    </div>
  </div>
  <a href="#84954" class="name">
  <strong class="user"><em>m0sh at hotmail dot com</em></strong></a><a class="genanchor" href="#84954"> &para;</a><div class="date" title="2008-08-07 12:03"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom84954">
<div class="phpcode"><code><span class="html">@greenone - nice function, thanks. I've adapted it for key usage:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">bitxor</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">) {<br />    </span><span class="default">$xorWidth </span><span class="keyword">= </span><span class="default">PHP_INT_SIZE</span><span class="keyword">*</span><span class="default">8</span><span class="keyword">;<br />    </span><span class="comment">// split<br />    </span><span class="default">$o1 </span><span class="keyword">= </span><span class="default">str_split</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">$xorWidth</span><span class="keyword">);<br />    </span><span class="default">$o2 </span><span class="keyword">= </span><span class="default">str_split</span><span class="keyword">(</span><span class="default">str_pad</span><span class="keyword">(</span><span class="string">''</span><span class="keyword">, </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">), </span><span class="default">$key</span><span class="keyword">), </span><span class="default">$xorWidth</span><span class="keyword">);<br />    </span><span class="default">$res </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />    </span><span class="default">$runs </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$o1</span><span class="keyword">);<br />    for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">$runs</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">++)<br />        </span><span class="default">$res </span><span class="keyword">.= </span><span class="default">decbin</span><span class="keyword">(</span><span class="default">bindec</span><span class="keyword">(</span><span class="default">$o1</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]) ^ </span><span class="default">bindec</span><span class="keyword">(</span><span class="default">$o2</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]));       <br />    return </span><span class="default">$res</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It is true that if both the left-hand and right-hand parameters are strings, the bitwise operator will operate on the characters' ASCII values. However, a complement is necessary to complete this sentence.<br />It is not irrelevant to point out that the decimal character's ASCII value have different binary values.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if ((</span><span class="string">'18' </span><span class="keyword">&amp; </span><span class="string">'32'</span><span class="keyword">) == </span><span class="string">'10'</span><span class="keyword">) {<br />    echo </span><span class="default">ord</span><span class="keyword">(</span><span class="string">'18'</span><span class="keyword">); </span><span class="comment">//return decimal value 49, which have binary value 110001<br />    </span><span class="keyword">echo </span><span class="default">ord</span><span class="keyword">(</span><span class="string">'32'</span><span class="keyword">); </span><span class="comment">//return decimal value 51, which have binary value 110011<br />    </span><span class="keyword">echo </span><span class="default">ord</span><span class="keyword">(</span><span class="string">'10'</span><span class="keyword">); </span><span class="comment">//return decimal value 49, which have binary value 110001<br />    //Therefore 110001 &amp; 110011 = 110001<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="102403">  <div class="votes">
    ...
    <div class="tally" id="V102403" title="61% like this...">
    3
    </div>
  </div>
  <a href="#102403" class="name">
  <strong class="user"><em>josh at joshstrike dot com</em></strong></a><a class="genanchor" href="#102403"> &para;</a><div class="date" title="2011-02-11 07:54"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102403">
<div class="phpcode"><code><span class="html">More referencing this for myself than anything... if you need to iterate through every possible binary combination where $n number of flags are set to 1 in a mask of $bits length:
<br />
...
<div class="phpcode"><code><span class="html">Perl vs. PHP implementation of the ^ operator:<br /><br />After attempting to translate a Perl module into PHP, I realized that Perl's implementation of the ^ operator is different than the PHP implementation.  By default, Perl treats the variables as floats and PHP as integers.  I was able to verify the PHP use of the operator by stating "use integer;" within the Perl module, which output the exact same result as PHP was using.<br /><br />The logical decision would be to cast every variable as (float) when using the ^ operator in PHP.  However, this will not yield the same results.  After about a half hour of banging my head against the wall, I discovered a gem and wrote a function using the binary-decimal conversions in PHP.<br /><br />/*<br />not having much experience with bitwise operations, I cannot tell you that this is the BEST solution, but it certainly is a solution that finally works and always returns the EXACT same result Perl provides.<br />*/<br />function binxor($a, $b) {<br />    return bindec(decbin((float)$a ^ (float)$b));<br />}<br /><br />//normal PHP code will not yeild the same result as Perl<br />$result = 3851235679 ^ 43814; //= -443704711<br /><br />//to get the same result as Perl<br />$result = binxor(3851235679, 43814); //= 3851262585<br />//YIPPEE!!!<br /><br />//to see the differences, try the following<br />$a = 3851235679 XOR 43814;<br />$b = 3851235679 ^ 43814; //integer result<br />$c = (float)3851235679 ^ (float)43814; //same as $b<br />$d = binxor(3851235679, 43814); //same as Perl!!<br /><br />echo("A: $a&lt;br /&gt;");<br />echo("B: $b&lt;br /&gt;");<br />echo("C: $c&lt;br /&gt;");<br />echo("D: $d&lt;br /&gt;");</span></code></div>
  ...
  <div class="note" id="79662">  <div class="votes">
    ...
    <div class="tally" id="V79662" title="57% like this...">
    1
    </div>
  </div>
  <a href="#79662" class="name">
  <strong class="user"><em>forlamp at msn dot com</em></strong></a><a class="genanchor" href="#79662"> &para;</a><div class="date" title="2007-12-06 06:35"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79662">
<div class="phpcode"><code><span class="html">two's complement logical operation for 32-bit.<br /><br />$x must be (int) when passing it to this function to work properly.<br /><br />function comp2($x)      // 32bit bitwise complement<br />{<br />    $mask = 0x80000000;<br /><br />    if ($x &lt; 0)<br />    {<br />        $x &amp;= 0x7FFFFFFF;<br />        $x = ~$x;<br /><br />        return $x ^ $mask;<br />    }<br />    else<br />    {<br />        $x = $x ^ 0x7FFFFFFF;<br /><br />        return $x | $mask;<br />    }<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="104291">  <div class="votes">
    ...
    <div class="tally" id="V104291" title="55% like this...">
    2
    </div>
  </div>
  <a href="#104291" class="name">
  <strong class="user"><em>ivoras at gmail dot com</em></strong></a><a class="genanchor" href="#104291"> &para;</a><div class="date" title="2011-06-06 04:44"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104291">
<div class="phpcode"><code><span class="html">As an additional curiosity, for some reason the result of the operation ("18" &amp; "32") is "10". In other words, try avoiding using the binary operators on strings :)</span></code></div>
  </div>
 </div>
  <div class="note" id="112699">  <div class="votes">
    ...
    <div class="tally" id="V112699" title="53% like this...">
    1
    </div>
  </div>
  <a href="#112699" class="name">
  <strong class="user"><em>sag at ich dot net</em></strong></a><a class="genanchor" href="#112699"> &para;</a><div class="date" title="2013-07-14 06:52"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112699">
<div class="phpcode"><code><span class="html">me reimplement for bitwise NOT (~)<br /><br />    protected function flipBin($number) {<br />        $bin = str_pad(base_convert($number, 10, 2), 32, 0, STR_PAD_LEFT);<br />        for ($i = 0; $i &lt; 32; $i++) {<br />            switch ($bin{$i}) {<br />                case '0' :<br />                    $bin{$i} = '1';<br />                    break;<br />                case '1' :<br />                    $bin{$i} = '0';<br />                    break;<br />            }<br />        }<br />        return bindec($bin);<br />    }<br /><br />the benefit is, it works with numbers greater MAX_INT</span></code></div>
  </div>
 </div>
  <div class="note" id="97917">  <div class="votes">
    ...
    <div class="tally" id="V97917" title="53% like this...">
    1
    </div>
  </div>
  <a href="#97917" class="name">
  <strong class="user"><em>Adam</em></strong></a><a class="genanchor" href="#97917"> &para;</a><div class="date" title="2010-05-15 01:25"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97917">
<div class="phpcode"><code><span class="html">Be careful of order of operations.<br /><br />for example, you may want to check if the second bit is set:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">$x </span><span class="keyword">&amp; </span><span class="default">2 </span><span class="keyword">== </span><span class="default">2</span><span class="keyword">) {<br />    </span><span class="comment">/* code */<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />is different than<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if ((</span><span class="default">$x </span><span class="keyword">&amp; </span><span class="default">2</span><span class="keyword">) == </span><span class="default">2</span><span class="keyword">) {<br />    </span><span class="comment">/* code */<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />and the latter of the two should be used.</span></code></div>
  </div>
 </div>
  <div class="note" id="130446">  <div class="votes">
    <div id="Vu130446">
    <a href="/manual/vote-note.php?id=130446&amp;page=language.operators.bitwise&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130446">
    <a href="/manual/vote-note.php?id=130446&amp;page=language.operators.bitwise&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130446" title="no votes...">
    0
    </div>
  </div>
  <a href="#130446" class="name">
  <strong class="user"><em>admin at infis dot net dot ru</em></strong></a><a class="genanchor" href="#130446"> &para;</a><div class="date" title="2025-08-14 01:31"><strong>1 month ago</strong></div>
  <div class="text" id="Hcom130446">
<div class="phpcode"><code><span class="html">Sample function for convert flags to array<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">flags2array</span><span class="keyword">(</span><span class="default">int $flags</span><span class="keyword">, </span><span class="default">int $max</span><span class="keyword">): array<br />{<br />    </span><span class="default">$result </span><span class="keyword">= [];<br /><br />    for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt;= </span><span class="default">$max</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">+= </span><span class="default">$i</span><span class="keyword">) {<br />        if (</span><span class="default">$flags </span><span class="keyword">&amp; </span><span class="default">$i</span><span class="keyword">) {<br />            </span><span class="default">$result</span><span class="keyword">[] = </span><span class="default">$i</span><span class="keyword">;<br />        }<br />    }<br />    <br />    return </span><span class="default">$result</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$flags </span><span class="keyword">= </span><span class="default">1 </span><span class="keyword">| </span><span class="default">32 </span><span class="keyword">| </span><span class="default">4</span><span class="keyword">;<br /><br /></span><span class="default">$arr </span><span class="keyword">= </span><span class="default">flags2array</span><span class="keyword">(</span><span class="default">$flags</span><span class="keyword">, </span><span class="default">32</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$arr</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br />array(3) {<br />  [0]=&gt;<br />  int(1)<br />  [1]=&gt;<br />  int(4)<br />  [2]=&gt;<br />  int(32)<br />}<br />*/</span></span></code></div>
  </div>
 </div>
  <div class="note" id="110846">  <div class="votes">
    ...
    <div class="tally" id="V110846" title="50% like this...">
    0
    </div>
  </div>
  <a href="#110846" class="name">
  <strong class="user"><em>erich at seachawaii dot com</em></strong></a><a class="genanchor" href="#110846"> &para;</a><div class="date" title="2012-12-14 03:15"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110846">
<div class="phpcode"><code><span class="html">Just a note regarding negative shift values, as the documentation states each shift is an integer multiply or divide (left or right respectively) by 2.  That means a negative shift value (the right hand operand) effects the sign of the shift and NOT the direction of the shift as I would have expected.  <br />FE. 0xff &gt;&gt; -2 results in 0x0 <br />and 0xff &lt;&lt; -2 result in 0xFFFFFFFFC0000000 (dependant on PHP_INT_MAX)</span></code></div>
  </div>
 </div>
  <div class="note" id="99335">  <div class="votes">
    ...
    <div class="tally" id="V99335" title="50% like this...">
    0
    </div>
  </div>
  <a href="#99335" class="name">
  <strong class="user"><em>Core Xii</em></strong></a><a class="genanchor" href="#99335"> &para;</a><div class="date" title="2010-08-11 10:24"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99335">
<div class="phpcode"><code><span class="html">Be very careful when XOR-ing strings! If one of the values is empty (0, '', null) the result will also be empty!<br /><br /><span class="default">&lt;?php<br />var_dump</span><span class="keyword">(</span><span class="default">1234 </span><span class="keyword">^ </span><span class="default">0</span><span class="keyword">); </span><span class="comment">// int(1234)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">1234 </span><span class="keyword">^ </span><span class="string">''</span><span class="keyword">); </span><span class="comment">// int(1234)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">1234 </span><span class="keyword">^ </span><span class="default">null</span><span class="keyword">); </span><span class="comment">// int(1234)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="string">'hello world' </span><span class="keyword">^ </span><span class="default">0</span><span class="keyword">); </span><span class="comment">// int(0)<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="string">'hello world' </span><span class="keyword">^ </span><span class="string">''</span><span class="keyword">); </span><span class="comment">// string(0) ""<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="string">'hello world' </span><span class="keyword">^ </span><span class="default">null</span><span class="keyword">); </span><span class="comment">// int(0)<br /></span><span class="default">?&gt;<br /></span><br />This seems rather inconsistent behavior. An integer XOR'd with zero results the original integer. But a string XOR'd with an empty value results an empty value!<br /><br />My password hashing function was always returning the same hash... Because I was XOR-ing it with a salt that was sometimes empty!</span></code></div>
  </div>
 </div>
  <div class="note" id="106123">  <div class="votes">
    ...
    <div class="tally" id="V106123" title="47% like this...">
    -1
    </div>
  </div>
  <a href="#106123" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#106123"> &para;</a><div class="date" title="2011-10-12 07:56"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106123">
<div class="phpcode"><code><span class="html">To make very clear why ("18" &amp; "32") is "10".<br />1) they they are both strings ,<br />2) "&amp;" operator works on strings by taking each !Character! from each string and make a bit wise &amp; between them and add this value to the resulting string<br /><br />So:<br />"18" is made up of two characters: 0x31, 0x38<br />"32" is made up of two characters: 0x33, 0x32<br />----RESULT-----<br />0x31 &amp; 0x33 = 0x31 =&gt; "1"<br />0x38 &amp; 0x32 = 0x30 =&gt; "0"<br /><br />and the result is "10" which is 100% correct.</span></code></div>
  </div>
 </div>
