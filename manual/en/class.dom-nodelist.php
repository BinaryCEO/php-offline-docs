...
<head>
  ...
  <title>PHP: Dom\NodeList - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-nodelist.php">
 <link rel="shorturl" href="https://www.php.net/dom-nodelist">
 <link rel="alternate" href="https://www.php.net/dom-nodelist" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-node.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-notation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-nodelist.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-nodelist.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-nodelist.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-nodelist.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-nodelist.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-nodelist.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-nodelist.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-nodelist.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-nodelist.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-nodelist.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-nodelist.php" hreflang="zh">
...
<meta name="Description" content="The Dom\NodeList class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\NodeList - Manual" />
<meta name="twitter:description" content="The Dom\NodeList class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\NodeList - Manual" />
<meta itemprop="description" content="The Dom\NodeList class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\NodeList class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-nodelist.php' selected="selected">English</option>
            <option value='de/class.dom-nodelist.php'>German</option>
            <option value='es/class.dom-nodelist.php'>Spanish</option>
            <option value='fr/class.dom-nodelist.php'>French</option>
            <option value='it/class.dom-nodelist.php'>Italian</option>
            <option value='ja/class.dom-nodelist.php'>Japanese</option>
            <option value='pt_BR/class.dom-nodelist.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-nodelist.php'>Russian</option>
            <option value='tr/class.dom-nodelist.php'>Turkish</option>
            <option value='uk/class.dom-nodelist.php'>Ukrainian</option>
            <option value='zh/class.dom-nodelist.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-nodelist" class="reference">
 <h1 class="title">The <span class="classname"><a href="class.dom-nodelist.php" class="classname">Dom\NodeList</a></span> class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-nodelist.intro">
  ...
  <div class="section" id="dom-nodelist.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\NodeList</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.dom-nodelist.php#dom-nodelist.props.length">$<var class="varname">length</var></a></var>;</div>
  ...
  <div class="section" id="dom-nodelist.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-nodelist.props.length"><var class="varname">length</var></dt><dd>
      <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-nodelist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-nodelist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-nodelist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-nodelist.php">＋<small>add a note</small></a></span>
