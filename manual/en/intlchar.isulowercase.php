...
<head>
  ...
  <title>PHP: IntlChar::isULowercase - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isulowercase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isulowercase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isulowercase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isualphabetic.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isupper.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isulowercase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isulowercase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isulowercase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isulowercase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isulowercase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isulowercase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isulowercase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isulowercase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isulowercase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isulowercase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isulowercase.php" hreflang="zh">
...
<meta name="Description" content="Check if code point has the Lowercase Unicode property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isULowercase - Manual" />
<meta name="twitter:description" content="Check if code point has the Lowercase Unicode property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isULowercase - Manual" />
<meta itemprop="description" content="Check if code point has the Lowercase Unicode property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point has the Lowercase Unicode property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.isupper.php">
          IntlChar::isupper &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isualphabetic.php">
          &laquo; IntlChar::isUAlphabetic        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isulowercase.php' selected="selected">English</option>
            <option value='de/intlchar.isulowercase.php'>German</option>
            <option value='es/intlchar.isulowercase.php'>Spanish</option>
            <option value='fr/intlchar.isulowercase.php'>French</option>
            <option value='it/intlchar.isulowercase.php'>Italian</option>
            <option value='ja/intlchar.isulowercase.php'>Japanese</option>
            <option value='pt_BR/intlchar.isulowercase.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isulowercase.php'>Russian</option>
            <option value='tr/intlchar.isulowercase.php'>Turkish</option>
            <option value='uk/intlchar.isulowercase.php'>Ukrainian</option>
            <option value='zh/intlchar.isulowercase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isulowercase" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isULowercase</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isULowercase</span> &mdash; <span class="dc-title">Check if code point has the Lowercase Unicode property</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.isulowercase-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isULowercase</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Check if a code point has the Lowercase Unicode property.
  </p>
  <p class="para">
   This is the same as <code class="literal">IntlChar::hasBinaryProperty($codepoint, IntlChar::PROPERTY_LOWERCASE)</code>
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This is different than <span class="function"><a href="intlchar.islower.php" class="function">IntlChar::islower()</a></span> and will return <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for more characters.
   </p>
  </p></blockquote>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isulowercase-returnvalues">
  ...
  <p class="para">
   ...
   <code class="parameter">codepoint</code> has the Lowercase Unicode property, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-lowercase">IntlChar::PROPERTY_LOWERCASE</a></code></strong></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isulowercase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isulowercase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isulowercase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isulowercase.php">＋<small>add a note</small></a></span>
