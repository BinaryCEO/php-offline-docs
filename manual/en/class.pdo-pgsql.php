...
<head>
  ...
  <title>PHP: Pdo\Pgsql - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pdo-pgsql.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/pdo.pgsqllobunlink.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo-pgsql.copyfromarray.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.pdo-pgsql.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.pdo-pgsql.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.pdo-pgsql.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.pdo-pgsql.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.pdo-pgsql.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.pdo-pgsql.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.pdo-pgsql.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.pdo-pgsql.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.pdo-pgsql.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.pdo-pgsql.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.pdo-pgsql.php" hreflang="zh">
...
<meta name="Description" content="The Pdo\Pgsql class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Pdo\Pgsql - Manual" />
<meta name="twitter:description" content="The Pdo\Pgsql class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Pdo\Pgsql - Manual" />
<meta itemprop="description" content="The Pdo\Pgsql class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Pdo\Pgsql class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="pdo-pgsql.copyfromarray.php">
          Pdo\Pgsql::copyFromArray &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdo.pgsqllobunlink.php">
          &laquo; PDO::pgsqlLOBUnlink        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pdo-pgsql.php' selected="selected">English</option>
            <option value='de/class.pdo-pgsql.php'>German</option>
            <option value='es/class.pdo-pgsql.php'>Spanish</option>
            <option value='fr/class.pdo-pgsql.php'>French</option>
            <option value='it/class.pdo-pgsql.php'>Italian</option>
            <option value='ja/class.pdo-pgsql.php'>Japanese</option>
            <option value='pt_BR/class.pdo-pgsql.php'>Brazilian Portuguese</option>
            <option value='ru/class.pdo-pgsql.php'>Russian</option>
            <option value='tr/class.pdo-pgsql.php'>Turkish</option>
            <option value='uk/class.pdo-pgsql.php'>Ukrainian</option>
            <option value='zh/class.pdo-pgsql.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.pdo-pgsql" class="reference">
 <h1 class="title">The Pdo\Pgsql class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  ...
  <div class="section" id="pdo-pgsql.synopsis">
   <h2 class="title">Class synopsis</h2>

   
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Pdo\Pgsql</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.attr-disable-prepares"><var class="varname">ATTR_DISABLE_PREPARES</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.attr-result-memory-size"><var class="varname">ATTR_RESULT_MEMORY_SIZE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-idle"><var class="varname">TRANSACTION_IDLE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-active"><var class="varname">TRANSACTION_ACTIVE</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-intrans"><var class="varname">TRANSACTION_INTRANS</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-inerror"><var class="varname">TRANSACTION_INERROR</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-unknown"><var class="varname">TRANSACTION_UNKNOWN</var></a></var>;</div>


    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.copyfromarray.php" class="methodname">copyFromArray</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$tableName</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$rows</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;\t&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nullAs</code><span class="initializer"> = &quot;\\\\N&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$fields</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.copyfromfile.php" class="methodname">copyFromFile</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$tableName</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;\t&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nullAs</code><span class="initializer"> = &quot;\\\\N&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$fields</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.copytoarray.php" class="methodname">copyToArray</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$tableName</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;\t&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nullAs</code><span class="initializer"> = &quot;\\\\N&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$fields</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.copytofile.php" class="methodname">copyToFile</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$tableName</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$separator</code><span class="initializer"> = &quot;\t&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nullAs</code><span class="initializer"> = &quot;\\\\N&quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$fields</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.escapeidentifier.php" class="methodname">escapeIdentifier</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$input</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.getnotify.php" class="methodname">getNotify</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fetchMode</code><span class="initializer"> = PDO::FETCH_DEFAULT</span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timeoutMilliseconds</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.getpid.php" class="methodname">getPid</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.lobcreate.php" class="methodname">lobCreate</a></span>(): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.lobopen.php" class="methodname">lobOpen</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mode</code><span class="initializer"> = &quot;rb&quot;</span></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.lobunlink.php" class="methodname">lobUnlink</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo-pgsql.setnoticecallback.php" class="methodname">setNoticeCallback</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo.setattribute.php" class="methodname">PDO::setAttribute</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$attribute</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="pdo-pgsql.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>
    
     <dt id="pdo-pgsql.constants.attr-disable-prepares"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.attr-disable-prepares">Pdo\Pgsql::ATTR_DISABLE_PREPARES</a></code></strong></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="pdo-pgsql.constants.attr-result-memory-size"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.attr-result-memory-size">Pdo\Pgsql::ATTR_RESULT_MEMORY_SIZE</a></code></strong></dt>
     <dd>
      <span class="simpara">
       Returns the amount of memory, in bytes, allocated to the specified
       query result <span class="classname"><a href="class.pdostatement.php" class="classname">PDOStatement</a></span> instance,
       or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if no results exist before the query is executed.
      </span>
     </dd>
    
    
     <dt id="pdo-pgsql.constants.transaction-idle"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-idle">Pdo\Pgsql::TRANSACTION_IDLE</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-pgsql.constants.transaction-active"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-active">Pdo\Pgsql::TRANSACTION_ACTIVE</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-pgsql.constants.transaction-intrans"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-intrans">Pdo\Pgsql::TRANSACTION_INTRANS</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-pgsql.constants.transaction-inerror"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-inerror">Pdo\Pgsql::TRANSACTION_INERROR</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-pgsql.constants.transaction-unknown"><strong><code><a href="class.pdo-pgsql.php#pdo-pgsql.constants.transaction-unknown">Pdo\Pgsql::TRANSACTION_UNKNOWN</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="pdo-pgsql.copyfromarray.php">Pdo\Pgsql::copyFromArray</a> — Copy data from a PHP array into a table</li><li><a href="pdo-pgsql.copyfromfile.php">Pdo\Pgsql::copyFromFile</a> — Copy data from file into table</li><li><a href="pdo-pgsql.copytoarray.php">Pdo\Pgsql::copyToArray</a> — Copy data from database table into PHP array</li><li><a href="pdo-pgsql.copytofile.php">Pdo\Pgsql::copyToFile</a> — Copy data from table into file</li><li><a href="pdo-pgsql.escapeidentifier.php">Pdo\Pgsql::escapeIdentifier</a> — Escapes a string for use as an SQL identifier</li><li><a href="pdo-pgsql.getnotify.php">Pdo\Pgsql::getNotify</a> — Get asynchronous notification</li><li><a href="pdo-pgsql.getpid.php">Pdo\Pgsql::getPid</a> — Get the PID of the backend process handling this connection</li><li><a href="pdo-pgsql.lobcreate.php">Pdo\Pgsql::lobCreate</a> — Creates a new large object</li><li><a href="pdo-pgsql.lobopen.php">Pdo\Pgsql::lobOpen</a> — Opens an existing large object stream</li><li><a href="pdo-pgsql.lobunlink.php">Pdo\Pgsql::lobUnlink</a> — Deletes the large object</li><li><a href="pdo-pgsql.setnoticecallback.php">Pdo\Pgsql::setNoticeCallback</a> — Set a callback to handle notice and warning messages generated by the backend</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo_pgsql/pdo-pgsql.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pdo-pgsql%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pdo-pgsql&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pdo-pgsql.php">＋<small>add a note</small></a></span>
