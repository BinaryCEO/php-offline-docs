...
<head>
  ...
  <title>PHP: OAuth::disableSSLChecks - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/oauth.disablesslchecks.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/oauth.disablesslchecks.php">
 <link rel="alternate" href="https://www.php.net/manual/en/oauth.disablesslchecks.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.oauth.php">
 <link rel="prev" href="https://www.php.net/manual/en/oauth.disableredirects.php">
 <link rel="next" href="https://www.php.net/manual/en/oauth.enabledebug.php">

 <link rel="alternate" href="https://www.php.net/manual/en/oauth.disablesslchecks.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/oauth.disablesslchecks.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/oauth.disablesslchecks.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/oauth.disablesslchecks.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/oauth.disablesslchecks.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/oauth.disablesslchecks.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/oauth.disablesslchecks.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/oauth.disablesslchecks.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/oauth.disablesslchecks.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/oauth.disablesslchecks.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/oauth.disablesslchecks.php" hreflang="zh">
...
<meta name="Description" content="Turn off SSL checks" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: OAuth::disableSSLChecks - Manual" />
<meta name="twitter:description" content="Turn off SSL checks" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: OAuth::disableSSLChecks - Manual" />
<meta itemprop="description" content="Turn off SSL checks" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Turn off SSL checks" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="oauth.enabledebug.php">
          OAuth::enableDebug &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="oauth.disableredirects.php">
          &laquo; OAuth::disableRedirects        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/oauth.disablesslchecks.php' selected="selected">English</option>
            <option value='de/oauth.disablesslchecks.php'>German</option>
            <option value='es/oauth.disablesslchecks.php'>Spanish</option>
            <option value='fr/oauth.disablesslchecks.php'>French</option>
            <option value='it/oauth.disablesslchecks.php'>Italian</option>
            <option value='ja/oauth.disablesslchecks.php'>Japanese</option>
            <option value='pt_BR/oauth.disablesslchecks.php'>Brazilian Portuguese</option>
            <option value='ru/oauth.disablesslchecks.php'>Russian</option>
            <option value='tr/oauth.disablesslchecks.php'>Turkish</option>
            <option value='uk/oauth.disablesslchecks.php'>Ukrainian</option>
            <option value='zh/oauth.disablesslchecks.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="oauth.disablesslchecks" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="oauth.enablesslchecks.php" class="methodname" rel="rdfs-seeAlso">OAuth::enableSSLChecks()</a> - Turn on SSL checks</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oauth/oauth/disablesslchecks.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foauth.disablesslchecks%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=oauth.disablesslchecks&amp;repo=en&amp;redirect=https://www.php.net/manual/en/oauth.disablesslchecks.php">＋<small>add a note</small></a></span>
