...
<head>
  ...
  <title>PHP: pg_lo_tell - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-tell.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-tell">
 <link rel="alternate" href="https://www.php.net/pg-lo-tell" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-truncate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-tell.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-tell.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-tell.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-tell.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-tell.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-tell.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-tell.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-tell.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-tell.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-tell.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-tell.php" hreflang="zh">
...
<meta name="Description" content="Returns current seek position a of large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_tell - Manual" />
<meta name="twitter:description" content="Returns current seek position a of large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_tell - Manual" />
<meta itemprop="description" content="Returns current seek position a of large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns current seek position a of large object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-lo-truncate.php">
          pg_lo_truncate &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-tell.php' selected="selected">English</option>
            <option value='de/function.pg-lo-tell.php'>German</option>
            <option value='es/function.pg-lo-tell.php'>Spanish</option>
            <option value='fr/function.pg-lo-tell.php'>French</option>
            <option value='it/function.pg-lo-tell.php'>Italian</option>
            <option value='ja/function.pg-lo-tell.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-tell.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-tell.php'>Russian</option>
            <option value='tr/function.pg-lo-tell.php'>Turkish</option>
            <option value='uk/function.pg-lo-tell.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-tell.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-tell" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-tell-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_lo_tell</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-lob.php" class="type PgSql\Lob">PgSql\Lob</a></span> <code class="parameter">$lob</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
<div class="examplescode"><pre class="examplescode">Seek position is: 50000</pre>
</div>
    </div>
   </div> 
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-lo-tell-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-seek.php" class="function" rel="rdfs-seeAlso">pg_lo_seek()</a> - Seeks position within a large object</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-tell.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-tell%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-tell&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-tell.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="100928">  <div class="votes">
    <div id="Vu100928">
    <a href="/manual/vote-note.php?id=100928&amp;page=function.pg-lo-tell&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd100928">
    <a href="/manual/vote-note.php?id=100928&amp;page=function.pg-lo-tell&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V100928" title="no votes...">
    0
    </div>
  </div>
  <a href="#100928" class="name">
  <strong class="user"><em>Marv-CZ</em></strong></a><a class="genanchor" href="#100928"> &para;</a><div class="date" title="2010-11-15 10:26"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100928">
<div class="phpcode"><code><span class="html">Function to take a large object size:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">pg_lo_size </span><span class="keyword">(</span><span class="default">$lo</span><span class="keyword">) {
<br />  </span><span class="default">$pos </span><span class="keyword">= </span><span class="default">pg_lo_tell </span><span class="keyword">(</span><span class="default">$lo</span><span class="keyword">);
<br />  </span><span class="default">pg_lo_seek </span><span class="keyword">(</span><span class="default">$lo</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">PGSQL_SEEK_END</span><span class="keyword">);
<br />  </span><span class="default">$size </span><span class="keyword">= </span><span class="default">pg_lo_tell </span><span class="keyword">(</span><span class="default">$lo</span><span class="keyword">);
<br />  </span><span class="default">pg_lo_seek </span><span class="keyword">(</span><span class="default">$lo</span><span class="keyword">, </span><span class="default">$pos</span><span class="keyword">, </span><span class="default">PGSQL_SEEK_SET</span><span class="keyword">);
<br />  return </span><span class="default">$size</span><span class="keyword">;
<br />}
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-tell&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-tell.php">＋<small>add a note</small></a></div>
