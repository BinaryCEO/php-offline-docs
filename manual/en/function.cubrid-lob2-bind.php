...
<head>
  ...
  <title>PHP: cubrid_lob2_bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-bind.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-bind">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-bind" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-bind.php" hreflang="zh">
...
<meta name="Description" content="Bind a lob object or a string as a lob object to a prepared statement as parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_bind - Manual" />
<meta name="twitter:description" content="Bind a lob object or a string as a lob object to a prepared statement as parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_bind - Manual" />
<meta itemprop="description" content="Bind a lob object or a string as a lob object to a prepared statement as parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bind a lob object or a string as a lob object to a prepared statement as parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lob2-close.php">
          cubrid_lob2_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob-size.php">
          &laquo; cubrid_lob_size        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-bind.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-bind.php'>German</option>
            <option value='es/function.cubrid-lob2-bind.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-bind.php'>French</option>
            <option value='it/function.cubrid-lob2-bind.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-bind.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-bind.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-bind.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-bind.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-bind.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-bind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob2_bind</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.1)</p><p class="refpurpose"><span class="refname">cubrid_lob2_bind</span> &mdash; <span class="dc-title">Bind a lob object or a string as a lob object to a prepared statement as parameters</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-bind-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_bind</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$bind_index</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$bind_value</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$bind_value_type</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_lob2_bind()</strong></span> function is used to bind BLOB/CLOB datas
   to a corresponding question mark placeholder in the SQL statement that was passed 
   to <span class="function"><a href="function.cubrid-prepare.php" class="function">cubrid_prepare()</a></span>. If <code class="parameter">bind_value_type</code> 
   is not given, string will be &quot;BLOB&quot; as the default. But if you use
   <span class="function"><a href="function.cubrid-lob2-new.php" class="function">cubrid_lob2_new()</a></span> before, <code class="parameter">bind_value_type</code>
   will be consistent with <code class="parameter">type</code> in <span class="function"><a href="function.cubrid-lob2-new.php" class="function">cubrid_lob2_new()</a></span> as the default.
  </p>
 </div>
 ...
 <p class="para">
  <dl>
    ...
    <dd>
     <p class="para">Request identifier as a result of <span class="function"><a href="function.cubrid-prepare.php" class="function">cubrid_prepare()</a></span>.</p>
    </dd>
   
   
    <dt><code class="parameter">bind_index</code></dt>
    <dd>
     <p class="para">Location of binding parameters. It starts with 1.</p>
    </dd>
   
   
    <dt><code class="parameter">bind_value</code></dt>
    <dd>
     <p class="para">Actual value for binding.</p>
    </dd>
   
   
    <dt><code class="parameter">bind_value_type</code></dt>
    <dd>
     <p class="para">It must be &quot;BLOB&quot; or &quot;CLOB&quot; and it won&#039;t be case-sensitive. If it not be given, the default value is &quot;BLOB&quot;.</p>
    </dd>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-close.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_close()</a> - Close LOB object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-bind.php">＋<small>add a note</small></a></span>
