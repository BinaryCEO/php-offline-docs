...
<head>
  ...
  <title>PHP: IntlChar::enumCharNames - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.enumcharnames.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.enumcharnames.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.enumcharnames.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.digit.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.enumchartypes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.enumcharnames.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.enumcharnames.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.enumcharnames.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.enumcharnames.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.enumcharnames.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.enumcharnames.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.enumcharnames.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.enumcharnames.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.enumcharnames.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.enumcharnames.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.enumcharnames.php" hreflang="zh">
...
<meta name="Description" content="Enumerate all assigned Unicode characters within a range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::enumCharNames - Manual" />
<meta name="twitter:description" content="Enumerate all assigned Unicode characters within a range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::enumCharNames - Manual" />
<meta itemprop="description" content="Enumerate all assigned Unicode characters within a range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enumerate all assigned Unicode characters within a range" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intlchar.enumchartypes.php">
          IntlChar::enumCharTypes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.digit.php">
          &laquo; IntlChar::digit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.enumcharnames.php' selected="selected">English</option>
            <option value='de/intlchar.enumcharnames.php'>German</option>
            <option value='es/intlchar.enumcharnames.php'>Spanish</option>
            <option value='fr/intlchar.enumcharnames.php'>French</option>
            <option value='it/intlchar.enumcharnames.php'>Italian</option>
            <option value='ja/intlchar.enumcharnames.php'>Japanese</option>
            <option value='pt_BR/intlchar.enumcharnames.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.enumcharnames.php'>Russian</option>
            <option value='tr/intlchar.enumcharnames.php'>Turkish</option>
            <option value='uk/intlchar.enumcharnames.php'>Ukrainian</option>
            <option value='zh/intlchar.enumcharnames.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.enumcharnames" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::enumCharNames</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::enumCharNames</span> &mdash; <span class="dc-title">Enumerate all assigned Unicode characters within a range</span></p>
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      ...
      <ul class="simplelist">
       <li><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="literal">$codepoint</code> - The numeric code point value</li>
       <li><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="literal">$nameChoice</code> - The same value as the <code class="parameter">type</code> parameter below</li>
       <li><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="literal">$name</code> - The name of the character</li>
      </ul>
     </p>
    </dd>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.3.0</td>
       <td>
        This method now returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure; previously it returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>.
       </td>
      </tr>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.enumcharnames-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="intlchar.charfromname.php" class="function" rel="rdfs-seeAlso">IntlChar::charFromName()</a> - Find Unicode character by name and return its code point value</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/enumcharnames.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.enumcharnames%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.enumcharnames&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.enumcharnames.php">＋<small>add a note</small></a></span>
