...
<head>
  ...
  <title>PHP: Imagick::labelImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.labelimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.labelimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.labelimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.levelimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.labelimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.labelimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.labelimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.labelimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.labelimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.labelimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.labelimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.labelimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.labelimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.labelimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.labelimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::labelImage - Manual" />
<meta name="twitter:description" content="Adds a label to an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::labelImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.levelimage.php">
          Imagick::levelImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.inversefouriertransformimage.php">
          &laquo; Imagick::inverseFourierTransformImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.labelimage.php' selected="selected">English</option>
            <option value='de/imagick.labelimage.php'>German</option>
            <option value='es/imagick.labelimage.php'>Spanish</option>
            <option value='fr/imagick.labelimage.php'>French</option>
            <option value='it/imagick.labelimage.php'>Italian</option>
            <option value='ja/imagick.labelimage.php'>Japanese</option>
            <option value='pt_BR/imagick.labelimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.labelimage.php'>Russian</option>
            <option value='tr/imagick.labelimage.php'>Turkish</option>
            <option value='uk/imagick.labelimage.php'>Ukrainian</option>
            <option value='zh/imagick.labelimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.labelimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::labelImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::labelImage</span> &mdash; <span class="dc-title">Adds a label to an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.labelimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::labelImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$label</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.labelimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.labelimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/labelimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.labelimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.labelimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.labelimage.php">＋<small>add a note</small></a></span>
