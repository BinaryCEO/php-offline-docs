...
<head>
  ...
  <title>PHP: ps_restore - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-restore.php">
 <link rel="shorturl" href="https://www.php.net/ps-restore">
 <link rel="alternate" href="https://www.php.net/ps-restore" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-rect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-rotate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-restore.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-restore.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-restore.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-restore.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-restore.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-restore.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-restore.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-restore.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-restore.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-restore.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-restore.php" hreflang="zh">
...
<meta name="Description" content="Restore previously save context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_restore - Manual" />
<meta name="twitter:description" content="Restore previously save context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_restore - Manual" />
<meta itemprop="description" content="Restore previously save context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restore previously save context" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-restore.php' selected="selected">English</option>
            <option value='de/function.ps-restore.php'>German</option>
            <option value='es/function.ps-restore.php'>Spanish</option>
            <option value='fr/function.ps-restore.php'>French</option>
            <option value='it/function.ps-restore.php'>Italian</option>
            <option value='ja/function.ps-restore.php'>Japanese</option>
            <option value='pt_BR/function.ps-restore.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-restore.php'>Russian</option>
            <option value='tr/function.ps-restore.php'>Turkish</option>
            <option value='uk/function.ps-restore.php'>Ukrainian</option>
            <option value='zh/function.ps-restore.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-restore" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_restore</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_restore</span> &mdash; <span class="dc-title">Restore previously save context</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-restore-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_restore</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Restores a previously saved graphics context. Any call of
   <span class="function"><a href="function.ps-save.php" class="function">ps_save()</a></span> must be accompanied by a call to
   <span class="function"><strong>ps_restore()</strong></span>. All coordinate transformations, line
   style settings, color settings, etc. are being restored to the state
   before the call of <span class="function"><a href="function.ps-save.php" class="function">ps_save()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-restore-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-restore-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-restore-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-save.php" class="function" rel="rdfs-seeAlso">ps_save()</a> - Save current context</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-restore.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-restore%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-restore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-restore.php">＋<small>add a note</small></a></span>
