...
<head>
  ...
  <title>PHP: gmp_testbit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-testbit.php">
 <link rel="shorturl" href="https://www.php.net/gmp-testbit">
 <link rel="alternate" href="https://www.php.net/gmp-testbit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-sub.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-xor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-testbit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-testbit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-testbit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-testbit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-testbit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-testbit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-testbit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-testbit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-testbit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-testbit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-testbit.php" hreflang="zh">
...
<meta name="Description" content="Tests if a bit is set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_testbit - Manual" />
<meta name="twitter:description" content="Tests if a bit is set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_testbit - Manual" />
<meta itemprop="description" content="Tests if a bit is set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tests if a bit is set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-testbit.php' selected="selected">English</option>
            <option value='de/function.gmp-testbit.php'>German</option>
            <option value='es/function.gmp-testbit.php'>Spanish</option>
            <option value='fr/function.gmp-testbit.php'>French</option>
            <option value='it/function.gmp-testbit.php'>Italian</option>
            <option value='ja/function.gmp-testbit.php'>Japanese</option>
            <option value='pt_BR/function.gmp-testbit.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-testbit.php'>Russian</option>
            <option value='tr/function.gmp-testbit.php'>Turkish</option>
            <option value='uk/function.gmp-testbit.php'>Ukrainian</option>
            <option value='zh/function.gmp-testbit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-testbit" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-testbit-examples">
  ...
  <p class="para">
   <div class="example" id="example-3357">
    <p><strong>Example #1 <span class="function"><strong>gmp_testbit()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-clrbit.php" class="function" rel="rdfs-seeAlso">gmp_clrbit()</a> - Clear bit</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-testbit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-testbit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-testbit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-testbit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="76546">  <div class="votes">
    <div id="Vu76546">
    <a href="/manual/vote-note.php?id=76546&amp;page=function.gmp-testbit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76546">
    <a href="/manual/vote-note.php?id=76546&amp;page=function.gmp-testbit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76546" title="100% like this...">
    1
    </div>
  </div>
  <a href="#76546" class="name">
  <strong class="user"><em>bluej100@gmail</em></strong></a><a class="genanchor" href="#76546"> &para;</a><div class="date" title="2007-07-19 02:48"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76546">
<div class="phpcode"><code><span class="html">gmp_testbit will be very useful for my (over 64-bit) bitmask checking.<br /><br />In the meantime, I think these are the best replacements.<br /><br />Mostly full:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">(</span><span class="default">gmp_scan1</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$index</span><span class="keyword">) == </span><span class="default">$index</span><span class="keyword">)<br /></span><span class="default">?&gt;<br /></span><br />Mostly empty:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">(</span><span class="default">gmp_scan0</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$index</span><span class="keyword">) != </span><span class="default">$index</span><span class="keyword">)<br /></span><span class="default">?&gt;<br /></span><br />Still worst-case O(N), though.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmp-testbit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-testbit.php">＋<small>add a note</small></a></div>
