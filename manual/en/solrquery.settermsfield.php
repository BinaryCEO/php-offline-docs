...
<head>
  ...
  <title>PHP: SolrQuery::setTermsField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setterms.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsfield.php" hreflang="zh">
...
<meta name="Description" content="Sets the name of the field to get the Terms from" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsField - Manual" />
<meta name="twitter:description" content="Sets the name of the field to get the Terms from" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsField - Manual" />
<meta itemprop="description" content="Sets the name of the field to get the Terms from" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the name of the field to get the Terms from" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settermsincludelowerbound.php">
          SolrQuery::setTermsIncludeLowerBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setterms.php">
          &laquo; SolrQuery::setTerms        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsfield.php' selected="selected">English</option>
            <option value='de/solrquery.settermsfield.php'>German</option>
            <option value='es/solrquery.settermsfield.php'>Spanish</option>
            <option value='fr/solrquery.settermsfield.php'>French</option>
            <option value='it/solrquery.settermsfield.php'>Italian</option>
            <option value='ja/solrquery.settermsfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsfield.php'>Russian</option>
            <option value='tr/solrquery.settermsfield.php'>Turkish</option>
            <option value='uk/solrquery.settermsfield.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsField</span> &mdash; <span class="dc-title">Sets the name of the field to get the Terms from</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fieldname</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsfield.php">＋<small>add a note</small></a></span>
