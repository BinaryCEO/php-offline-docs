...
<head>
  ...
  <title>PHP: gmp_and - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-and.php">
 <link rel="shorturl" href="https://www.php.net/gmp-and">
 <link rel="alternate" href="https://www.php.net/gmp-and" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-binomial.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-and.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-and.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-and.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-and.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-and.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-and.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-and.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-and.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-and.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-and.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-and.php" hreflang="zh">
...
<meta name="Description" content="Bitwise AND" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_and - Manual" />
<meta name="twitter:description" content="Bitwise AND" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_and - Manual" />
<meta itemprop="description" content="Bitwise AND" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bitwise AND" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-and.php' selected="selected">English</option>
            <option value='de/function.gmp-and.php'>German</option>
            <option value='es/function.gmp-and.php'>Spanish</option>
            <option value='fr/function.gmp-and.php'>French</option>
            <option value='it/function.gmp-and.php'>Italian</option>
            <option value='ja/function.gmp-and.php'>Japanese</option>
            <option value='pt_BR/function.gmp-and.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-and.php'>Russian</option>
            <option value='tr/function.gmp-and.php'>Turkish</option>
            <option value='uk/function.gmp-and.php'>Ukrainian</option>
            <option value='zh/function.gmp-and.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-and" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_and</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_and</span> &mdash; <span class="dc-title">Bitwise AND</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-and-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_and</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-and-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-and-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A GMP number representing the bitwise <code class="literal">AND</code> comparison.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-and-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-3314">
   <p><strong>Example #1 <span class="function"><strong>gmp_and()</strong></span> example</strong></p>
...
0</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-and.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-and%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-and&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-and.php">＋<small>add a note</small></a></span>
