...
<head>
  ...
  <title>PHP: Imagick::getImageScene - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagescene.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagescene.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagescene.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagesblob.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagesignature.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagescene.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagescene.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagescene.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagescene.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagescene.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagescene.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagescene.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagescene.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagescene.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagescene.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagescene.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageScene - Manual" />
<meta name="twitter:description" content="Gets the image scene" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageScene - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagesignature.php">
          Imagick::getImageSignature &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagesblob.php">
          &laquo; Imagick::getImagesBlob        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagescene.php' selected="selected">English</option>
            <option value='de/imagick.getimagescene.php'>German</option>
            <option value='es/imagick.getimagescene.php'>Spanish</option>
            <option value='fr/imagick.getimagescene.php'>French</option>
            <option value='it/imagick.getimagescene.php'>Italian</option>
            <option value='ja/imagick.getimagescene.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagescene.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagescene.php'>Russian</option>
            <option value='tr/imagick.getimagescene.php'>Turkish</option>
            <option value='uk/imagick.getimagescene.php'>Ukrainian</option>
            <option value='zh/imagick.getimagescene.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagescene" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageScene</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageScene</span> &mdash; <span class="dc-title">Gets the image scene</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagescene-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageScene</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagescene-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagescene-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagescene-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagescene.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagescene%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagescene&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagescene.php">＋<small>add a note</small></a></span>
