...
<head>
  ...
  <title>PHP: ReflectionProperty::getRawValue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.getrawvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.getrawvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getrawvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getname.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getrawvalue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.getrawvalue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.getrawvalue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.getrawvalue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.getrawvalue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.getrawvalue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.getrawvalue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.getrawvalue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.getrawvalue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.getrawvalue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.getrawvalue.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of a property, bypassing a get hook if defined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getRawValue - Manual" />
<meta name="twitter:description" content="Returns the value of a property, bypassing a get hook if defined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getRawValue - Manual" />
<meta itemprop="description" content="Returns the value of a property, bypassing a get hook if defined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of a property, bypassing a get hook if defined" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.getsettabletype.php">
          ReflectionProperty::getSettableType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.getname.php">
          &laquo; ReflectionProperty::getName        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.getrawvalue.php' selected="selected">English</option>
            <option value='de/reflectionproperty.getrawvalue.php'>German</option>
            <option value='es/reflectionproperty.getrawvalue.php'>Spanish</option>
            <option value='fr/reflectionproperty.getrawvalue.php'>French</option>
            <option value='it/reflectionproperty.getrawvalue.php'>Italian</option>
            <option value='ja/reflectionproperty.getrawvalue.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.getrawvalue.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.getrawvalue.php'>Russian</option>
            <option value='tr/reflectionproperty.getrawvalue.php'>Turkish</option>
            <option value='uk/reflectionproperty.getrawvalue.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.getrawvalue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.getrawvalue" class="refentry">
  ...
  <ul class="simplelist">
   <li><a href="language.oop5.visibility.php#language.oop5.visibility-members-aviz" class="link">Asymmetric property visibility</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/getrawvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.getrawvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.getrawvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getrawvalue.php">＋<small>add a note</small></a></span>
