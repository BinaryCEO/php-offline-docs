...
<head>
  ...
  <title>PHP: sodium_crypto_box - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-box">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-box" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-auth-verify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-keypair.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-box.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-box.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-box.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-box.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-box.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-box.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-box.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-box.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-box.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-box.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-box.php" hreflang="zh">
...
<meta name="Description" content="Authenticated public-key encryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box - Manual" />
<meta name="twitter:description" content="Authenticated public-key encryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box - Manual" />
<meta itemprop="description" content="Authenticated public-key encryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Authenticated public-key encryption" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-box-keypair.php">
          sodium_crypto_box_keypair &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-auth-verify.php">
          &laquo; sodium_crypto_auth_verify        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-box.php'>German</option>
            <option value='es/function.sodium-crypto-box.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-box.php'>French</option>
            <option value='it/function.sodium-crypto-box.php'>Italian</option>
            <option value='ja/function.sodium-crypto-box.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-box.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-box.php'>Russian</option>
            <option value='tr/function.sodium-crypto-box.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-box.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-box.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-box" class="refentry">
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-box-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      See <span class="function"><a href="function.sodium-crypto-box-keypair-from-secretkey-and-publickey.php" class="function">sodium_crypto_box_keypair_from_secretkey_and_publickey()</a></span>.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-box-returnvalues">
  ...
  <p class="para">
   ...
   16 bytes longer than the plaintext, and a raw binary string. See <span class="function"><a href="function.sodium-bin2base64.php" class="function">sodium_bin2base64()</a></span>
   for safe encoding for storage.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122304">  <div class="votes">
    <div id="Vu122304">
    <a href="/manual/vote-note.php?id=122304&amp;page=function.sodium-crypto-box&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122304">
    <a href="/manual/vote-note.php?id=122304&amp;page=function.sodium-crypto-box&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122304" title="78% like this...">
    11
    </div>
  </div>
  <a href="#122304" class="name">
  <strong class="user"><em>craig at craigfrancis dot co dot uk</em></strong></a><a class="genanchor" href="#122304"> &para;</a><div class="date" title="2018-01-23 01:13"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122304">
<div class="phpcode"><code><span class="html">Here's a quick example on how to use sodium_crypto_box(); where you have 2 people exchanging a $message, where person 1 encrypts it so that only person 2 can decrypt it, and be sure that person 1 actually sent it (without it being tampered with).<br /><br /><span class="default">&lt;?php<br /><br />$keypair1 </span><span class="keyword">= </span><span class="default">sodium_crypto_box_keypair</span><span class="keyword">();<br /></span><span class="default">$keypair1_public </span><span class="keyword">= </span><span class="default">sodium_crypto_box_publickey</span><span class="keyword">(</span><span class="default">$keypair1</span><span class="keyword">);<br /></span><span class="default">$keypair1_secret </span><span class="keyword">= </span><span class="default">sodium_crypto_box_secretkey</span><span class="keyword">(</span><span class="default">$keypair1</span><span class="keyword">);<br /><br /></span><span class="default">$keypair2 </span><span class="keyword">= </span><span class="default">sodium_crypto_box_keypair</span><span class="keyword">();<br /></span><span class="default">$keypair2_public </span><span class="keyword">= </span><span class="default">sodium_crypto_box_publickey</span><span class="keyword">(</span><span class="default">$keypair2</span><span class="keyword">);<br /></span><span class="default">$keypair2_secret </span><span class="keyword">= </span><span class="default">sodium_crypto_box_secretkey</span><span class="keyword">(</span><span class="default">$keypair2</span><span class="keyword">);<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 1, encrypting<br /><br /></span><span class="default">$message </span><span class="keyword">= </span><span class="string">'hello'</span><span class="keyword">;<br /><br /></span><span class="default">$nonce </span><span class="keyword">= </span><span class="default">random_bytes</span><span class="keyword">(</span><span class="default">SODIUM_CRYPTO_BOX_NONCEBYTES</span><span class="keyword">);<br /><br /></span><span class="default">$encryption_key </span><span class="keyword">= </span><span class="default">sodium_crypto_box_keypair_from_secretkey_and_publickey</span><span class="keyword">(</span><span class="default">$keypair1_secret</span><span class="keyword">, </span><span class="default">$keypair2_public</span><span class="keyword">);<br /></span><span class="default">$encrypted </span><span class="keyword">= </span><span class="default">sodium_crypto_box</span><span class="keyword">(</span><span class="default">$message</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$encryption_key</span><span class="keyword">);<br /><br />echo </span><span class="default">base64_encode</span><span class="keyword">(</span><span class="default">$encrypted</span><span class="keyword">) . </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="comment">//--------------------------------------------------<br />// Person 2, decrypting<br /><br /></span><span class="default">$decryption_key </span><span class="keyword">= </span><span class="default">sodium_crypto_box_keypair_from_secretkey_and_publickey</span><span class="keyword">(</span><span class="default">$keypair2_secret</span><span class="keyword">, </span><span class="default">$keypair1_public</span><span class="keyword">);<br /></span><span class="default">$decrypted </span><span class="keyword">= </span><span class="default">sodium_crypto_box_open</span><span class="keyword">(</span><span class="default">$encrypted</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$decryption_key</span><span class="keyword">);<br /><br />echo </span><span class="default">$decrypted </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-box&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box.php">＋<small>add a note</small></a></div>
