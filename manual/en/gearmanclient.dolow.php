...
<head>
  ...
  <title>PHP: GearmanClient::doLow - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.dolow.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.dolow.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dolow.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.dojobhandle.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dolow.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.dolow.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.dolow.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.dolow.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.dolow.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.dolow.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.dolow.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.dolow.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.dolow.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.dolow.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.dolow.php" hreflang="zh">
...
<meta name="Description" content="Run a single low priority task" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doLow - Manual" />
<meta name="twitter:description" content="Run a single low priority task" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doLow - Manual" />
<meta itemprop="description" content="Run a single low priority task" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a single low priority task" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.dolowbackground.php">
          GearmanClient::doLowBackground &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.dojobhandle.php">
          &laquo; GearmanClient::doJobHandle        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.dolow.php' selected="selected">English</option>
            <option value='de/gearmanclient.dolow.php'>German</option>
            <option value='es/gearmanclient.dolow.php'>Spanish</option>
            <option value='fr/gearmanclient.dolow.php'>French</option>
            <option value='it/gearmanclient.dolow.php'>Italian</option>
            <option value='ja/gearmanclient.dolow.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.dolow.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.dolow.php'>Russian</option>
            <option value='tr/gearmanclient.dolow.php'>Turkish</option>
            <option value='uk/gearmanclient.dolow.php'>Ukrainian</option>
            <option value='zh/gearmanclient.dolow.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.dolow" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.dolow-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::doLow</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$function</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$workload</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$unique</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dolowbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doLowBackground()</a> - Run a low priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/dolow.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.dolow%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.dolow&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dolow.php">＋<small>add a note</small></a></span>
