...
<head>
  ...
  <title>PHP: MongoDB\Driver\Server::executeReadCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-server.executereadcommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-server.executereadcommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.executereadcommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-server.executequery.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-server.executereadwritecommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.executereadcommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-server.executereadcommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-server.executereadcommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-server.executereadcommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-server.executereadcommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-server.executereadcommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-server.executereadcommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-server.executereadcommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-server.executereadcommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-server.executereadcommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-server.executereadcommand.php" hreflang="zh">
...
<meta name="Description" content="Execute a database command that reads on this server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Server::executeReadCommand - Manual" />
<meta name="twitter:description" content="Execute a database command that reads on this server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Server::executeReadCommand - Manual" />
<meta itemprop="description" content="Execute a database command that reads on this server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a database command that reads on this server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-server.executereadwritecommand.php">
          MongoDB\Driver\Server::executeReadWriteCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-server.executequery.php">
          &laquo; MongoDB\Driver\Server::executeQuery        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-server.executereadcommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-server.executereadcommand.php'>German</option>
            <option value='es/mongodb-driver-server.executereadcommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-server.executereadcommand.php'>French</option>
            <option value='it/mongodb-driver-server.executereadcommand.php'>Italian</option>
            <option value='ja/mongodb-driver-server.executereadcommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-server.executereadcommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-server.executereadcommand.php'>Russian</option>
            <option value='tr/mongodb-driver-server.executereadcommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-server.executereadcommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-server.executereadcommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-server.executereadcommand" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-manager.executereadcommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Manager::executeReadCommand()</a> - Execute a database command that reads</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/server/executereadcommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-server.executereadcommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-server.executereadcommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-server.executereadcommand.php">＋<small>add a note</small></a></span>
