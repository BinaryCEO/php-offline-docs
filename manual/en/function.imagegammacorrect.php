...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagegammacorrect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imagefttext.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagegd.php">
...
<meta name="Description" content="Apply a gamma correction to a GD image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagegammacorrect - Manual" />
<meta name="twitter:description" content="Apply a gamma correction to a GD image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagegammacorrect - Manual" />
<meta itemprop="description" content="Apply a gamma correction to a GD image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Apply a gamma correction to a GD image" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagegammacorrect.php' selected="selected">English</option>
            <option value='de/function.imagegammacorrect.php'>German</option>
            <option value='es/function.imagegammacorrect.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagegammacorrect</span> &mdash; <span class="dc-title">Apply a gamma correction to a GD image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imagegammacorrect-description">
  ...
  <p class="para rdfs-comment">
   Applies gamma correction to the given gd <code class="parameter">image</code> 
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create image instance<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromgif</span><span style="color: #007700">(</span><span style="color: #DD0000">'php.gif'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Correct gamma, out = 1.537<br /></span><span style="color: #0000BB">imagegammacorrect</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">1.0</span><span style="color: #007700">, </span><span style="color: #0000BB">1.537</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Save<br /></span><span style="color: #0000BB">imagegif</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'./php_gamma_corrected.gif'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagegammacorrect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagegammacorrect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagegammacorrect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagegammacorrect.php">＋<small>add a note</small></a></span>
