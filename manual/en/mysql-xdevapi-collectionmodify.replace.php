...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.replace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.replace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.replace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionmodify.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.patch.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.set.php">
...
<meta name="Description" content="Replace document field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CollectionModify::replace - Manual" />
<meta name="twitter:description" content="Replace document field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CollectionModify::replace - Manual" />
<meta itemprop="description" content="Replace document field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace document field" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionmodify.replace.php' selected="selected">English</option>
            ...
            <option value='ja/mysql-xdevapi-collectionmodify.replace.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">CollectionModify::replace</span> &mdash; <span class="dc-title">Replace document field</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collectionmodify.replace-examples">
  ...
  <div class="example" id="example-1728">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\CollectionModify::replace()</strong></span> example</strong></p>
...
(
    [0] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionmodify/replace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionmodify.replace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionmodify.replace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.replace.php">＋<small>add a note</small></a></span>
