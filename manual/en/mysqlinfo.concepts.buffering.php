...
<head>
  ...
  <title>PHP: Buffered and Unbuffered queries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqlinfo.concepts.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlinfo.concepts.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlinfo.concepts.charset.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlinfo.concepts.buffering.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlinfo.concepts.buffering.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlinfo.concepts.buffering.php" hreflang="uk">
...
<meta name="Description" content="Buffered and Unbuffered queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Buffered and Unbuffered queries - Manual" />
<meta name="twitter:description" content="Buffered and Unbuffered queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Buffered and Unbuffered queries - Manual" />
<meta itemprop="description" content="Buffered and Unbuffered queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Buffered and Unbuffered queries" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqlinfo.concepts.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.vendors.php'>Vendor Specific Database Extensions</a></li>      <li><a href='set.mysqlinfo.php'>MySQL</a></li>      <li><a href='mysql.php'>Overview of the MySQL PHP drivers</a></li>      <li><a href='mysqlinfo.concepts.php'>Concepts</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlinfo.concepts.buffering.php' selected="selected">English</option>
            ...
            <option value='ru/mysqlinfo.concepts.buffering.php'>Russian</option>
            <option value='tr/mysqlinfo.concepts.buffering.php'>Turkish</option>
            <option value='uk/mysqlinfo.concepts.buffering.php'>Ukrainian</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pdo </span><span style="color: #007700">= new </span><span style="color: #0000BB">PDO</span><span style="color: #007700">(</span><span style="color: #DD0000">"mysql:host=localhost;dbname=world"</span><span style="color: #007700">, </span><span style="color: #DD0000">'my_user'</span><span style="color: #007700">, </span><span style="color: #DD0000">'my_password'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setAttribute</span><span style="color: #007700">(</span><span style="color: #0000BB">PDO</span><span style="color: #007700">::</span><span style="color: #0000BB">MYSQL_ATTR_USE_BUFFERED_QUERY</span><span style="color: #007700">, </span><span style="color: #0000BB">false</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$unbufferedResult </span><span style="color: #007700">= </span><span style="color: #0000BB">$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT Name FROM City"</span><span style="color: #007700">);<br />foreach (</span><span style="color: #0000BB">$unbufferedResult </span><span style="color: #007700">as </span><span style="color: #0000BB">$row</span><span style="color: #007700">) {<br />    echo </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'Name'</span><span style="color: #007700">] . </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlinfo.concepts.buffering%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlinfo.concepts.buffering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128760">  <div class="votes">
    <div id="Vu128760">
    <a href="/manual/vote-note.php?id=128760&amp;page=mysqlinfo.concepts.buffering&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128760">
    <a href="/manual/vote-note.php?id=128760&amp;page=mysqlinfo.concepts.buffering&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128760" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#128760" class="name">
  <strong class="user"><em>polygon dot co dot in at gmail dot com</em></strong></a><a class="genanchor" href="#128760"> &para;</a><div class="date" title="2023-07-25 05:20"><strong>2 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=mysqlinfo.concepts.buffering&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="mysqlinfo.concepts.php">Concepts</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="mysqlinfo.concepts.buffering.php" title="Buffered and Unbuffered queries">Buffered and Unbuffered queries</a>
                        </li>
                                                <li class="">
                            <a href="mysqlinfo.concepts.charset.php" title="Character sets">Character sets</a>
                        </li>
