...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.sslfilter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.sslfilter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.sslfilter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.sslerror.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.sslgetcipherinfo.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.sslfilter.php' selected="selected">English</option>
            ...
            <option value='zh/eventbufferevent.sslfilter.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-eventbufferevent.sslfilter-examples">
  ...
  <p class="para">
   <div class="example" id="example-4535">
    <p><strong>Example #1 Simple SMTP server</strong></p><div class="example-contents">
   ...
   <li>
    <span class="methodname"><a href="eventbufferevent.sslsocket.php" class="methodname" rel="rdfs-seeAlso">EventBufferEvent::sslSocket()</a> - Creates a new SSL buffer event to send its data over an SSL on a socket</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/sslfilter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.sslfilter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.sslfilter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.sslfilter.php">＋<small>add a note</small></a></span>
