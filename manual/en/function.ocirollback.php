...
<head>
  ...
  <title>PHP: ocirollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocirollback.php">
 <link rel="shorturl" href="https://www.php.net/ocirollback">
 <link rel="alternate" href="https://www.php.net/ocirollback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ociresult.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocirowcount.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocirollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocirollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocirollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocirollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocirollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocirollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocirollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocirollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocirollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocirollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocirollback.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_rollback" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocirollback - Manual" />
<meta name="twitter:description" content="Alias of oci_rollback" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocirollback - Manual" />
<meta itemprop="description" content="Alias of oci_rollback" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_rollback" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocirowcount.php">
          ocirowcount &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ociresult.php">
          &laquo; ociresult        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocirollback.php' selected="selected">English</option>
            <option value='de/function.ocirollback.php'>German</option>
            <option value='es/function.ocirollback.php'>Spanish</option>
            <option value='fr/function.ocirollback.php'>French</option>
            <option value='it/function.ocirollback.php'>Italian</option>
            <option value='ja/function.ocirollback.php'>Japanese</option>
            <option value='pt_BR/function.ocirollback.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocirollback.php'>Russian</option>
            <option value='tr/function.ocirollback.php'>Turkish</option>
            <option value='uk/function.ocirollback.php'>Ukrainian</option>
            <option value='zh/function.ocirollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocirollback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocirollback</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocirollback</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-rollback.php" class="function">oci_rollback()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocirollback-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-rollback.php" class="function">oci_rollback()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocirollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocirollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocirollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocirollback.php">＋<small>add a note</small></a></span>
