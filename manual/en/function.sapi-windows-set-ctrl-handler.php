...
<head>
  ...
  <title>PHP: sapi_windows_set_ctrl_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sapi-windows-set-ctrl-handler.php">
 <link rel="shorturl" href="https://www.php.net/sapi-windows-set-ctrl-handler">
 <link rel="alternate" href="https://www.php.net/sapi-windows-set-ctrl-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sapi-windows-generate-ctrl-event.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sapi-windows-vt100-support.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sapi-windows-set-ctrl-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sapi-windows-set-ctrl-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sapi-windows-set-ctrl-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sapi-windows-set-ctrl-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sapi-windows-set-ctrl-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sapi-windows-set-ctrl-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sapi-windows-set-ctrl-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sapi-windows-set-ctrl-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sapi-windows-set-ctrl-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sapi-windows-set-ctrl-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sapi-windows-set-ctrl-handler.php" hreflang="zh">
...
<meta name="Description" content="Set or remove a CTRL event handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sapi_windows_set_ctrl_handler - Manual" />
<meta name="twitter:description" content="Set or remove a CTRL event handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sapi_windows_set_ctrl_handler - Manual" />
<meta itemprop="description" content="Set or remove a CTRL event handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set or remove a CTRL event handler" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sapi-windows-vt100-support.php">
          sapi_windows_vt100_support &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sapi-windows-generate-ctrl-event.php">
          &laquo; sapi_windows_generate_ctrl_event        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sapi-windows-set-ctrl-handler.php' selected="selected">English</option>
            <option value='de/function.sapi-windows-set-ctrl-handler.php'>German</option>
            <option value='es/function.sapi-windows-set-ctrl-handler.php'>Spanish</option>
            <option value='fr/function.sapi-windows-set-ctrl-handler.php'>French</option>
            <option value='it/function.sapi-windows-set-ctrl-handler.php'>Italian</option>
            <option value='ja/function.sapi-windows-set-ctrl-handler.php'>Japanese</option>
            <option value='pt_BR/function.sapi-windows-set-ctrl-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.sapi-windows-set-ctrl-handler.php'>Russian</option>
            <option value='tr/function.sapi-windows-set-ctrl-handler.php'>Turkish</option>
            <option value='uk/function.sapi-windows-set-ctrl-handler.php'>Ukrainian</option>
            <option value='zh/function.sapi-windows-set-ctrl-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sapi-windows-set-ctrl-handler" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.sapi-windows-generate-ctrl-event.php" class="function" rel="rdfs-seeAlso">sapi_windows_generate_ctrl_event()</a> - Send a CTRL event to another process</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/sapi-windows-set-ctrl-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sapi-windows-set-ctrl-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sapi-windows-set-ctrl-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sapi-windows-set-ctrl-handler.php">＋<small>add a note</small></a></span>
