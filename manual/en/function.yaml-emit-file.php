...
<head>
  ...
  <title>PHP: yaml_emit_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaml-emit-file.php">
 <link rel="shorturl" href="https://www.php.net/yaml-emit-file">
 <link rel="alternate" href="https://www.php.net/yaml-emit-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.yaml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.yaml-emit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaml-parse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.yaml-emit-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.yaml-emit-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.yaml-emit-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.yaml-emit-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.yaml-emit-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.yaml-emit-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.yaml-emit-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.yaml-emit-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.yaml-emit-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.yaml-emit-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.yaml-emit-file.php" hreflang="zh">
...
<meta name="Description" content="Send the YAML representation of a value to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: yaml_emit_file - Manual" />
<meta name="twitter:description" content="Send the YAML representation of a value to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: yaml_emit_file - Manual" />
<meta itemprop="description" content="Send the YAML representation of a value to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send the YAML representation of a value to a file" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaml-emit-file.php' selected="selected">English</option>
            <option value='de/function.yaml-emit-file.php'>German</option>
            <option value='es/function.yaml-emit-file.php'>Spanish</option>
            <option value='fr/function.yaml-emit-file.php'>French</option>
            <option value='it/function.yaml-emit-file.php'>Italian</option>
            <option value='ja/function.yaml-emit-file.php'>Japanese</option>
            <option value='pt_BR/function.yaml-emit-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.yaml-emit-file.php'>Russian</option>
            <option value='tr/function.yaml-emit-file.php'>Turkish</option>
            <option value='uk/function.yaml-emit-file.php'>Ukrainian</option>
            <option value='zh/function.yaml-emit-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.yaml-emit-file" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.yaml-parse.php" class="function" rel="rdfs-seeAlso">yaml_parse()</a> - Parse a YAML stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaml/functions/yaml-emit-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaml-emit-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaml-emit-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaml-emit-file.php">＋<small>add a note</small></a></span>
