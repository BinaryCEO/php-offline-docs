...
<head>
  ...
  <title>PHP: ps_begin_template - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-begin-template.php">
 <link rel="shorturl" href="https://www.php.net/ps-begin-template">
 <link rel="alternate" href="https://www.php.net/ps-begin-template" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-begin-pattern.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-circle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-begin-template.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-begin-template.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-begin-template.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-begin-template.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-begin-template.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-begin-template.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-begin-template.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-begin-template.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-begin-template.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-begin-template.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-begin-template.php" hreflang="zh">
...
<meta name="Description" content="Start a new template" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_begin_template - Manual" />
<meta name="twitter:description" content="Start a new template" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_begin_template - Manual" />
<meta itemprop="description" content="Start a new template" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Start a new template" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-circle.php">
          ps_circle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-begin-pattern.php">
          &laquo; ps_begin_pattern        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-begin-template.php' selected="selected">English</option>
            <option value='de/function.ps-begin-template.php'>German</option>
            <option value='es/function.ps-begin-template.php'>Spanish</option>
            <option value='fr/function.ps-begin-template.php'>French</option>
            <option value='it/function.ps-begin-template.php'>Italian</option>
            <option value='ja/function.ps-begin-template.php'>Japanese</option>
            <option value='pt_BR/function.ps-begin-template.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-begin-template.php'>Russian</option>
            <option value='tr/function.ps-begin-template.php'>Turkish</option>
            <option value='uk/function.ps-begin-template.php'>Ukrainian</option>
            <option value='zh/function.ps-begin-template.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-begin-template" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_begin_template</h1>
   <p class="verinfo">(PECL ps &gt;= 1.2.0)</p><p class="refpurpose"><span class="refname">ps_begin_template</span> &mdash; <span class="dc-title">Start a new template</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-begin-template-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_begin_template</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$height</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   it is placed by <span class="function"><a href="function.ps-place-image.php" class="function">ps_place_image()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-begin-template-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-begin-template-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ps </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_new</span><span style="color: #007700">();<br /><br />if (!</span><span style="color: #0000BB">ps_open_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"template.ps"</span><span style="color: #007700">)) {<br />  print </span><span style="color: #DD0000">"Cannot open PostScript file\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #0000BB">ps_set_parameter</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"warning"</span><span style="color: #007700">, </span><span style="color: #DD0000">"true"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Creator"</span><span style="color: #007700">, </span><span style="color: #DD0000">"template.php"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Author"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Uwe Steinmann"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Title"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Template example"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$pstemplate </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_begin_template</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">30.0</span><span style="color: #007700">, </span><span style="color: #0000BB">30.0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_moveto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_moveto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_lineto</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">30</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_stroke</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_template</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_begin_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">596</span><span style="color: #007700">, </span><span style="color: #0000BB">842</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_place_image</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">$pstemplate</span><span style="color: #007700">, </span><span style="color: #0000BB">20.0</span><span style="color: #007700">, </span><span style="color: #0000BB">20.0</span><span style="color: #007700">, </span><span style="color: #0000BB">1.0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_place_image</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">$pstemplate</span><span style="color: #007700">, </span><span style="color: #0000BB">50.0</span><span style="color: #007700">, </span><span style="color: #0000BB">30.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.5</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_place_image</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">$pstemplate</span><span style="color: #007700">, </span><span style="color: #0000BB">70.0</span><span style="color: #007700">, </span><span style="color: #0000BB">70.0</span><span style="color: #007700">, </span><span style="color: #0000BB">0.6</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_place_image</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">$pstemplate</span><span style="color: #007700">, </span><span style="color: #0000BB">30.0</span><span style="color: #007700">, </span><span style="color: #0000BB">50.0</span><span style="color: #007700">, </span><span style="color: #0000BB">1.3</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-begin-template-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-end-template.php" class="function" rel="rdfs-seeAlso">ps_end_template()</a> - End a template</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-begin-template.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-begin-template%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-begin-template&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-begin-template.php">＋<small>add a note</small></a></span>
