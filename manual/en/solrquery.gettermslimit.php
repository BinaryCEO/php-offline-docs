...
<head>
  ...
  <title>PHP: SolrQuery::getTermsLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermslimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermslimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermslimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermsincludeupperbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermslowerbound.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermslimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermslimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermslimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermslimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermslimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermslimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermslimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermslimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermslimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermslimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermslimit.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of terms Solr should return" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsLimit - Manual" />
<meta name="twitter:description" content="Returns the maximum number of terms Solr should return" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsLimit - Manual" />
<meta itemprop="description" content="Returns the maximum number of terms Solr should return" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of terms Solr should return" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gettermslowerbound.php">
          SolrQuery::getTermsLowerBound &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermsincludeupperbound.php">
          &laquo; SolrQuery::getTermsIncludeUpperBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermslimit.php' selected="selected">English</option>
            <option value='de/solrquery.gettermslimit.php'>German</option>
            <option value='es/solrquery.gettermslimit.php'>Spanish</option>
            <option value='fr/solrquery.gettermslimit.php'>French</option>
            <option value='it/solrquery.gettermslimit.php'>Italian</option>
            <option value='ja/solrquery.gettermslimit.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermslimit.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermslimit.php'>Russian</option>
            <option value='tr/solrquery.gettermslimit.php'>Turkish</option>
            <option value='uk/solrquery.gettermslimit.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermslimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermslimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsLimit</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsLimit</span> &mdash; <span class="dc-title">Returns the maximum number of terms Solr should return</span></p>
 ...
 <div class="refsect1 description" id="refsect1-solrquery.gettermslimit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsLimit</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermslimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermslimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermslimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermslimit.php">＋<small>add a note</small></a></span>
