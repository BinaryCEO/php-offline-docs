...
<head>
  ...
  <title>PHP: imap_headers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-headers.php">
 <link rel="shorturl" href="https://www.php.net/imap-headers">
 <link rel="alternate" href="https://www.php.net/imap-headers" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-headerinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-is-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-headers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-headers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-headers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-headers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-headers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-headers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-headers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-headers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-headers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-headers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-headers.php" hreflang="zh">
...
<meta name="Description" content="Returns headers for all messages in a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_headers - Manual" />
<meta name="twitter:description" content="Returns headers for all messages in a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_headers - Manual" />
<meta itemprop="description" content="Returns headers for all messages in a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns headers for all messages in a mailbox" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-headers.php' selected="selected">English</option>
            <option value='de/function.imap-headers.php'>German</option>
            <option value='es/function.imap-headers.php'>Spanish</option>
            <option value='fr/function.imap-headers.php'>French</option>
            <option value='it/function.imap-headers.php'>Italian</option>
            <option value='ja/function.imap-headers.php'>Japanese</option>
            <option value='pt_BR/function.imap-headers.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-headers.php'>Russian</option>
            <option value='tr/function.imap-headers.php'>Turkish</option>
            <option value='uk/function.imap-headers.php'>Ukrainian</option>
            <option value='zh/function.imap-headers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-headers" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-headers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-headers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-headers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-headers.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112447">  <div class="votes">
    <div id="Vu112447">
    <a href="/manual/vote-note.php?id=112447&amp;page=function.imap-headers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112447">
    <a href="/manual/vote-note.php?id=112447&amp;page=function.imap-headers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112447" title="65% like this...">
    18
    </div>
  </div>
  <a href="#112447" class="name">
  <strong class="user"><em>paulwright75 at hotmail dot com</em></strong></a><a class="genanchor" href="#112447"> &para;</a><div class="date" title="2013-06-18 12:54"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112447">
<div class="phpcode"><code><span class="html">Ok, this page is driving me crazy. Parsing the lines returned in the array is simple enough but there is no definitions on what the flags mean. So I searched the web to find the answer and this is what I was able to gather:<br /><br />A - Answered: email has been replied to<br />N - New: Recent and not seen<br />R - Recent: Recent and seen<br />U - Unread: The message has not been read yet<br />F - Flagged: Message is "flagged" for urgent/special attention<br />D - Deleted: Message is "deleted" for removal by later EXPUNGE<br />X - Draft: Message has not completed composition (marked as a draft).<br /><br />please correct me if I am wrong...</span></code></div>
  </div>
 </div>
  <div class="note" id="126005">  <div class="votes">
    <div id="Vu126005">
    <a href="/manual/vote-note.php?id=126005&amp;page=function.imap-headers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126005">
    <a href="/manual/vote-note.php?id=126005&amp;page=function.imap-headers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126005" title="75% like this...">
    2
    </div>
  </div>
  <a href="#126005" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#126005"> &para;</a><div class="date" title="2021-04-13 10:29"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126005">
<div class="phpcode"><code><span class="html">the format returned is very fixed:<br /><br />FLAGS (space) NUMBER (*) DATE (space) SENDER (space) SUBJECT (space) LENGTH<br /><br />NUMBER will be a left-padded string of up to 4 digits + ")", starting with 5 digits, it is those 5 digits (without the ")")<br /><br />DATE will be a left-padded string like " 2-Apr-2021" or a non-padded string like "13-Apr-2021"<br /><br />SENDER is 20 chars long<br /><br />SUBJECT is 25 chars long<br /><br />LENGTH is a string like "(1248 chars)" , however it allows more digits and is not padded.</span></code></div>
  </div>
 </div>
  <div class="note" id="94019">  <div class="votes">
    <div id="Vu94019">
    <a href="/manual/vote-note.php?id=94019&amp;page=function.imap-headers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94019">
    <a href="/manual/vote-note.php?id=94019&amp;page=function.imap-headers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94019" title="66% like this...">
    2
    </div>
  </div>
  <a href="#94019" class="name">
  <strong class="user"><em>mmuoio at gmail dot com</em></strong></a><a class="genanchor" href="#94019"> &para;</a><div class="date" title="2009-10-12 10:39"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94019">
<div class="phpcode"><code><span class="html">This function will not return a full subject line if it is longer than 25 characters.  I found this out after trying to search each header and move the email to a different folder depending on what the subject was (searching for year and project number).</span></code></div>
  </div>
 </div>
  <div class="note" id="122705">  <div class="votes">
    <div id="Vu122705">
    <a href="/manual/vote-note.php?id=122705&amp;page=function.imap-headers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122705">
    <a href="/manual/vote-note.php?id=122705&amp;page=function.imap-headers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122705" title="66% like this...">
    1
    </div>
  </div>
  <a href="#122705" class="name">
  <strong class="user"><em>webmaster at RealityRipple dot com</em></strong></a><a class="genanchor" href="#122705"> &para;</a><div class="date" title="2018-05-06 11:32"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122705">
<div class="phpcode"><code><span class="html">Just a helpful hint, many IMAP servers will include non-standard flags in curly braces before the subject in the response of this function. Pretty sure this is the only way to determine if a message has been forwarded, for example, when using the IMAP functions. The first flag (or more) may be prefixed with a dollar sign ($). It's (probably) likely that any such flags received by a server can be passed through imap_append to that server, as well.</span></code></div>
  </div>
 </div>
  <div class="note" id="112873">  <div class="votes">
    <div id="Vu112873">
    <a href="/manual/vote-note.php?id=112873&amp;page=function.imap-headers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112873">
    <a href="/manual/vote-note.php?id=112873&amp;page=function.imap-headers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112873" title="58% like this...">
    3
    </div>
  </div>
  <a href="#112873" class="name">
  <strong class="user"><em>antispam at katiheta dot net</em></strong></a><a class="genanchor" href="#112873"> &para;</a><div class="date" title="2013-07-31 02:44"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112873">
<div class="phpcode"><code><span class="html">Message flag descriptions can be found on official imap_headerinfo page (<a href="http://www.php.net/manual/en/function.imap-headerinfo.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/function.imap-headerinfo.php</a>) in "Return Value" paragraph.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-headers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-headers.php">＋<small>add a note</small></a></div>
