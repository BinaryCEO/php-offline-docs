...
<head>
  ...
  <title>PHP: ldap_exop_refresh - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-exop-refresh.php">
 <link rel="shorturl" href="https://www.php.net/ldap-exop-refresh">
 <link rel="alternate" href="https://www.php.net/ldap-exop-refresh" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-exop-passwd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-exop-sync.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-exop-refresh.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-exop-refresh.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-exop-refresh.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-exop-refresh.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-exop-refresh.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-exop-refresh.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-exop-refresh.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-exop-refresh.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-exop-refresh.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-exop-refresh.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-exop-refresh.php" hreflang="zh">
...
<meta name="Description" content="Refresh extended operation helper" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_exop_refresh - Manual" />
<meta name="twitter:description" content="Refresh extended operation helper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_exop_refresh - Manual" />
<meta itemprop="description" content="Refresh extended operation helper" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Refresh extended operation helper" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-exop-sync.php">
          ldap_exop_sync &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-exop-passwd.php">
          &laquo; ldap_exop_passwd        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-exop-refresh.php' selected="selected">English</option>
            <option value='de/function.ldap-exop-refresh.php'>German</option>
            <option value='es/function.ldap-exop-refresh.php'>Spanish</option>
            <option value='fr/function.ldap-exop-refresh.php'>French</option>
            <option value='it/function.ldap-exop-refresh.php'>Italian</option>
            <option value='ja/function.ldap-exop-refresh.php'>Japanese</option>
            <option value='pt_BR/function.ldap-exop-refresh.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-exop-refresh.php'>Russian</option>
            <option value='tr/function.ldap-exop-refresh.php'>Turkish</option>
            <option value='uk/function.ldap-exop-refresh.php'>Ukrainian</option>
            <option value='zh/function.ldap-exop-refresh.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-exop-refresh" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-exop.php" class="function" rel="rdfs-seeAlso">ldap_exop()</a> - Performs an extended operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-exop-refresh.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-exop-refresh%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-exop-refresh&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop-refresh.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122949">  <div class="votes">
    <div id="Vu122949">
    <a href="/manual/vote-note.php?id=122949&amp;page=function.ldap-exop-refresh&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122949">
    <a href="/manual/vote-note.php?id=122949&amp;page=function.ldap-exop-refresh&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122949" title="50% like this...">
    0
    </div>
  </div>
  <a href="#122949" class="name">
  <strong class="user"><em>Roland Gruber</em></strong></a><a class="genanchor" href="#122949"> &para;</a><div class="date" title="2018-07-16 03:48"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122949">
<div class="phpcode"><code><span class="html">The following workaround can be used to run the refresh command in PHP 7.2.<br /><br />$dn= 'cn=user,dc=test,dc=org';<br />$ttl = 3600;<br />$data = '';<br />$data .= '80' . sprintf("%'.02x", strlen($dn)) . bin2hex($dn);<br />$data .= '81' . sprintf("%'.02x", 4) . sprintf("%'.08x", $ttl);<br />$data = hex2bin('30' . sprintf("%'.02x", strlen($data)/2) . $data);<br />$success = ldap_exop($ldapHandle, LDAP_EXOP_REFRESH, $data);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-exop-refresh&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop-refresh.php">＋<small>add a note</small></a></div>
