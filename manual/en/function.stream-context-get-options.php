...
<head>
  ...
  <title>PHP: stream_context_get_options - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-get-options.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-get-options">
 <link rel="alternate" href="https://www.php.net/stream-context-get-options" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-get-default.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-get-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-get-options.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-get-options.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-get-options.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-get-options.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-get-options.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-get-options.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-get-options.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-get-options.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-get-options.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-get-options.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-get-options.php" hreflang="zh">
...
<meta name="Description" content="Retrieve options for a stream/wrapper/context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_get_options - Manual" />
<meta name="twitter:description" content="Retrieve options for a stream/wrapper/context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_get_options - Manual" />
<meta itemprop="description" content="Retrieve options for a stream/wrapper/context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve options for a stream/wrapper/context" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-context-get-params.php">
          stream_context_get_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-get-default.php">
          &laquo; stream_context_get_default        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-get-options.php' selected="selected">English</option>
            <option value='de/function.stream-context-get-options.php'>German</option>
            <option value='es/function.stream-context-get-options.php'>Spanish</option>
            <option value='fr/function.stream-context-get-options.php'>French</option>
            <option value='it/function.stream-context-get-options.php'>Italian</option>
            <option value='ja/function.stream-context-get-options.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-get-options.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-get-options.php'>Russian</option>
            <option value='tr/function.stream-context-get-options.php'>Turkish</option>
            <option value='uk/function.stream-context-get-options.php'>Ukrainian</option>
            <option value='zh/function.stream-context-get-options.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-get-options" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_context_get_options</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_context_get_options</span> &mdash; <span class="dc-title">Retrieve options for a stream/wrapper/context</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stream-context-get-options-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_context_get_options</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream_or_context</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-context-get-options-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type">stream</span> or <span class="type">context</span> to get options from
      </p>
     </dd>
  ...
  array(1) {
    ...
    string(4) &quot;POST&quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-get-options.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-get-options%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-get-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-get-options.php">＋<small>add a note</small></a></span>
