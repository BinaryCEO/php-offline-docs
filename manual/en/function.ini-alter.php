...
<head>
  ...
  <title>PHP: ini_alter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ini-alter.php">
 <link rel="shorturl" href="https://www.php.net/ini-alter">
 <link rel="alternate" href="https://www.php.net/ini-alter" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.getrusage.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ini-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ini-alter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ini-alter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ini-alter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ini-alter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ini-alter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ini-alter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ini-alter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ini-alter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ini-alter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ini-alter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ini-alter.php" hreflang="zh">
...
<meta name="Description" content="Alias of ini_set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ini_alter - Manual" />
<meta name="twitter:description" content="Alias of ini_set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ini_alter - Manual" />
<meta itemprop="description" content="Alias of ini_set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ini_set" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ini-alter.php' selected="selected">English</option>
            <option value='de/function.ini-alter.php'>German</option>
            <option value='es/function.ini-alter.php'>Spanish</option>
            <option value='fr/function.ini-alter.php'>French</option>
            <option value='it/function.ini-alter.php'>Italian</option>
            <option value='ja/function.ini-alter.php'>Japanese</option>
            <option value='pt_BR/function.ini-alter.php'>Brazilian Portuguese</option>
            <option value='ru/function.ini-alter.php'>Russian</option>
            <option value='tr/function.ini-alter.php'>Turkish</option>
            <option value='uk/function.ini-alter.php'>Ukrainian</option>
            <option value='zh/function.ini-alter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ini-alter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ini_alter</h1> 
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ini_alter</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ini-set.php" class="function">ini_set()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ini-alter-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of:  <span class="function"><a href="function.ini-set.php" class="function">ini_set()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/ini-alter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ini-alter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ini-alter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ini-alter.php">＋<small>add a note</small></a></span>
