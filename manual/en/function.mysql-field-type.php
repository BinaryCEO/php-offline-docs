...
<head>
  ...
  <title>PHP: mysql_field_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-type.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-type">
 <link rel="alternate" href="https://www.php.net/mysql-field-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-table.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-free-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-type.php" hreflang="zh">
...
<meta name="Description" content="Get the type of the specified field in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_field_type - Manual" />
<meta name="twitter:description" content="Get the type of the specified field in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_type - Manual" />
<meta itemprop="description" content="Get the type of the specified field in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the type of the specified field in a result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-free-result.php">
          mysql_free_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-table.php">
          &laquo; mysql_field_table        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-type.php' selected="selected">English</option>
            <option value='de/function.mysql-field-type.php'>German</option>
            <option value='es/function.mysql-field-type.php'>Spanish</option>
            <option value='fr/function.mysql-field-type.php'>French</option>
            <option value='it/function.mysql-field-type.php'>Italian</option>
            <option value='ja/function.mysql-field-type.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-type.php'>Russian</option>
            <option value='tr/function.mysql-field-type.php'>Turkish</option>
            <option value='uk/function.mysql-field-type.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-type" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_field_type</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_field_type</span> &mdash; <span class="dc-title">Get the type of the specified field in a result</span></p>
...
Alternatives to this function include:</p>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-field-type-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_field_type()</strong></span> is similar to the
   <span class="function"><a href="function.mysql-field-name.php" class="function">mysql_field_name()</a></span> function. The arguments are
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-field-type-examples">
  ...
  <p class="para">
   <div class="example" id="example-1903">
    <p><strong>Example #1 <span class="function"><strong>mysql_field_type()</strong></span> example</strong></p>
...
deprecated alias may be used: 
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-field-type-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-field-name.php" class="function" rel="rdfs-seeAlso">mysql_field_name()</a> - Get the name of the specified field in a result</span></li>
    <li><span class="function"><a href="function.mysql-field-len.php" class="function" rel="rdfs-seeAlso">mysql_field_len()</a> - Returns the length of the specified field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-type.php">＋<small>add a note</small></a></span>
