...
<head>
  ...
  <title>PHP: Imagick::getImageCompose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecompose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecompose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecompression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagecompose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagecompose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagecompose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagecompose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagecompose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagecompose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagecompose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagecompose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagecompose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagecompose.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageCompose - Manual" />
<meta name="twitter:description" content="Returns the composite operator associated with the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageCompose - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagecompression.php">
          Imagick::getImageCompression &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagecolorspace.php">
          &laquo; Imagick::getImageColorspace        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecompose.php' selected="selected">English</option>
            <option value='de/imagick.getimagecompose.php'>German</option>
            <option value='es/imagick.getimagecompose.php'>Spanish</option>
            <option value='fr/imagick.getimagecompose.php'>French</option>
            <option value='it/imagick.getimagecompose.php'>Italian</option>
            <option value='ja/imagick.getimagecompose.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagecompose.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagecompose.php'>Russian</option>
            <option value='tr/imagick.getimagecompose.php'>Turkish</option>
            <option value='uk/imagick.getimagecompose.php'>Ukrainian</option>
            <option value='zh/imagick.getimagecompose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagecompose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageCompose</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageCompose</span> &mdash; <span class="dc-title">Returns the composite operator associated with the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecompose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageCompose</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagecompose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagecompose-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecompose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecompose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecompose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecompose.php">＋<small>add a note</small></a></span>
