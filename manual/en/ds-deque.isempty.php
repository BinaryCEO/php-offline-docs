...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-deque.isempty.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-deque.isempty.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-deque.isempty.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-deque.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-deque.insert.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-deque.join.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-deque.isempty.php' selected="selected">English</option>
            ...
            <option value='ja/ds-deque.isempty.php'>Japanese</option>
 ...
 <div class="refsect1 examples" id="refsect1-ds-deque.isempty-examples">
  ...
  <div class="example" id="example-4341">
   <p><strong>Example #1 <span class="function"><strong>Ds\Deque::isEmpty()</strong></span> example</strong></p>
...
bool(true)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/deque/isempty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-deque.isempty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-deque.isempty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-deque.isempty.php">＋<small>add a note</small></a></span>
