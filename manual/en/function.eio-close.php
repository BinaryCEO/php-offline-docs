...
<head>
  ...
  <title>PHP: eio_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-close.php">
 <link rel="shorturl" href="https://www.php.net/eio-close">
 <link rel="alternate" href="https://www.php.net/eio-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-chown.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-custom.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-close.php" hreflang="zh">
...
<meta name="Description" content="Close file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_close - Manual" />
<meta name="twitter:description" content="Close file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_close - Manual" />
<meta itemprop="description" content="Close file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-close.php' selected="selected">English</option>
            <option value='de/function.eio-close.php'>German</option>
            <option value='es/function.eio-close.php'>Spanish</option>
            <option value='fr/function.eio-close.php'>French</option>
            <option value='it/function.eio-close.php'>Italian</option>
            <option value='ja/function.eio-close.php'>Japanese</option>
            <option value='pt_BR/function.eio-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-close.php'>Russian</option>
            <option value='tr/function.eio-close.php'>Turkish</option>
            <option value='uk/function.eio-close.php'>Ukrainian</option>
            <option value='zh/function.eio-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_close</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_close</span> &mdash; <span class="dc-title">Close file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_close</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_close()</strong></span> closes file specified by
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-close-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-close-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_close()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.eio-close-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-open.php" class="function" rel="rdfs-seeAlso">eio_open()</a> - Opens a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-close.php">＋<small>add a note</small></a></span>
