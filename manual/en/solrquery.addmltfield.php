...
<head>
  ...
  <title>PHP: SolrQuery::addMltField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addmltfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addmltfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addmltfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addhighlightfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addmltfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addmltfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addmltfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addmltfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addmltfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addmltfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addmltfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addmltfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addmltfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addmltfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addmltfield.php" hreflang="zh">
...
<meta name="Description" content="Sets a field to use for similarity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addMltField - Manual" />
<meta name="twitter:description" content="Sets a field to use for similarity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addMltField - Manual" />
<meta itemprop="description" content="Sets a field to use for similarity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets a field to use for similarity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addmltqueryfield.php">
          SolrQuery::addMltQueryField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addhighlightfield.php">
          &laquo; SolrQuery::addHighlightField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addmltfield.php' selected="selected">English</option>
            <option value='de/solrquery.addmltfield.php'>German</option>
            <option value='es/solrquery.addmltfield.php'>Spanish</option>
            <option value='fr/solrquery.addmltfield.php'>French</option>
            <option value='it/solrquery.addmltfield.php'>Italian</option>
            <option value='ja/solrquery.addmltfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addmltfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addmltfield.php'>Russian</option>
            <option value='tr/solrquery.addmltfield.php'>Turkish</option>
            <option value='uk/solrquery.addmltfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addmltfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addmltfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addMltField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addMltField</span> &mdash; <span class="dc-title">Sets a field to use for similarity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addmltfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addMltField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addmltfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addmltfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addmltfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addmltfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addmltfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addmltfield.php">＋<small>add a note</small></a></span>
