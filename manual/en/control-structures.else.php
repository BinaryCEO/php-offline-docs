...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/control-structures.else.php">
 <link rel="shorturl" href="https://www.php.net/else">
 <link rel="alternate" href="https://www.php.net/else" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.control-structures.php">
 <link rel="prev" href="https://www.php.net/manual/en/control-structures.if.php">
 <link rel="next" href="https://www.php.net/manual/en/control-structures.elseif.php">

 <link rel="alternate" href="https://www.php.net/manual/en/control-structures.else.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/control-structures.else.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/control-structures.else.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/control-structures.else.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/control-structures.else.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/control-structures.else.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/control-structures.else.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/control-structures.else.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/control-structures.else.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/control-structures.else.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/control-structures.else.php" hreflang="zh">
...
<meta name="Description" content="else" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: else - Manual" />
<meta name="twitter:description" content="else" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: else - Manual" />
<meta itemprop="description" content="else" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="else" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/control-structures.else.php'>Italian</option>
            ...
            <option value='uk/control-structures.else.php'>Ukrainian</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$a </span><span style="color: #007700">= </span><span style="color: #0000BB">false</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">true</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">$a</span><span style="color: #007700">)<br />    if (</span><span style="color: #0000BB">$b</span><span style="color: #007700">)<br />        echo </span><span style="color: #DD0000">"b"</span><span style="color: #007700">;<br />else<br />    echo </span><span style="color: #DD0000">"c"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   it by using curly braces to resolve potential ambiguities.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/control-structures/else.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcontrol-structures.else%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=control-structures.else&amp;repo=en&amp;redirect=https://www.php.net/manual/en/control-structures.else.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="82472">  <div class="votes">
    ...
    <div class="tally" id="V82472" title="58% like this...">
    29
    </div>
  </div>
  <a href="#82472" class="name">
  <strong class="user"><em>dormeydo at gmail dot com</em></strong></a><a class="genanchor" href="#82472"> &para;</a><div class="date" title="2008-04-12 04:51"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82472">
<div class="phpcode"><code><span class="html">An alternative and very useful syntax is the following one:<br /><br />statement ? execute if true : execute if false<br /><br />Ths is very usefull for dynamic outout inside strings, for example:<br /><br />print('$a is ' . ($a &gt; $b ? 'bigger than' : ($a == $b ? 'equal to' : 'smaler than' )) .  '  $b');<br /><br />This will print "$a is smaler than $b" is $b is bigger than $a, "$a is bigger than $b" if $a si bigger and "$a is equal to $b" if they are same.</span></code></div>
  </div>
 </div>
