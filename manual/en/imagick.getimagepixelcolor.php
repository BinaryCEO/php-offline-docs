...
<head>
  ...
  <title>PHP: Imagick::getImagePixelColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagepage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageprofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagepixelcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagepixelcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagepixelcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagepixelcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagepixelcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagepixelcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagepixelcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagepixelcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagepixelcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagepixelcolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the color of the specified pixel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImagePixelColor - Manual" />
<meta name="twitter:description" content="Returns the color of the specified pixel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImagePixelColor - Manual" />
<meta itemprop="description" content="Returns the color of the specified pixel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the color of the specified pixel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageprofile.php">
          Imagick::getImageProfile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagepage.php">
          &laquo; Imagick::getImagePage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagepixelcolor.php' selected="selected">English</option>
            <option value='de/imagick.getimagepixelcolor.php'>German</option>
            <option value='es/imagick.getimagepixelcolor.php'>Spanish</option>
            <option value='fr/imagick.getimagepixelcolor.php'>French</option>
            <option value='it/imagick.getimagepixelcolor.php'>Italian</option>
            <option value='ja/imagick.getimagepixelcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagepixelcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagepixelcolor.php'>Russian</option>
            <option value='tr/imagick.getimagepixelcolor.php'>Turkish</option>
            <option value='uk/imagick.getimagepixelcolor.php'>Ukrainian</option>
            <option value='zh/imagick.getimagepixelcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagepixelcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImagePixelColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImagePixelColor</span> &mdash; <span class="dc-title">Returns the color of the specified pixel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagepixelcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImagePixelColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.imagickpixel.php" class="type ImagickPixel">ImagickPixel</a></span></div>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagepixelcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagepixelcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagepixelcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagepixelcolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="109459">  <div class="votes">
    <div id="Vu109459">
    <a href="/manual/vote-note.php?id=109459&amp;page=imagick.getimagepixelcolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109459">
    <a href="/manual/vote-note.php?id=109459&amp;page=imagick.getimagepixelcolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109459" title="80% like this...">
    12
    </div>
  </div>
  <a href="#109459" class="name">
  <strong class="user"><em>sheldon at hyperlinked dot com</em></strong></a><a class="genanchor" href="#109459"> &para;</a><div class="date" title="2012-07-18 11:57"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109459">
<div class="phpcode"><code><span class="html">I'm sure there are a lot of people like me who have been wondering, "How you manage to produce a human readable output of this operation?"
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagepixelcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagepixelcolor.php">＋<small>add a note</small></a></div>
