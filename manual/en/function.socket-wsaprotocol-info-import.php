...
<head>
  ...
  <title>PHP: socket_wsaprotocol_info_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-import.php">
 <link rel="shorturl" href="https://www.php.net/socket-wsaprotocol-info-import">
 <link rel="alternate" href="https://www.php.net/socket-wsaprotocol-info-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-release.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-wsaprotocol-info-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-wsaprotocol-info-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-wsaprotocol-info-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-wsaprotocol-info-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-wsaprotocol-info-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-wsaprotocol-info-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-wsaprotocol-info-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-wsaprotocol-info-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-wsaprotocol-info-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-wsaprotocol-info-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-wsaprotocol-info-import.php" hreflang="zh">
...
<meta name="Description" content="Imports a Socket from another Process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_wsaprotocol_info_import - Manual" />
<meta name="twitter:description" content="Imports a Socket from another Process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_wsaprotocol_info_import - Manual" />
<meta itemprop="description" content="Imports a Socket from another Process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Imports a Socket from another Process" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.socket-wsaprotocol-info-release.php">
          socket_wsaprotocol_info_release &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-wsaprotocol-info-export.php">
          &laquo; socket_wsaprotocol_info_export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-wsaprotocol-info-import.php' selected="selected">English</option>
            <option value='de/function.socket-wsaprotocol-info-import.php'>German</option>
            <option value='es/function.socket-wsaprotocol-info-import.php'>Spanish</option>
            <option value='fr/function.socket-wsaprotocol-info-import.php'>French</option>
            <option value='it/function.socket-wsaprotocol-info-import.php'>Italian</option>
            <option value='ja/function.socket-wsaprotocol-info-import.php'>Japanese</option>
            <option value='pt_BR/function.socket-wsaprotocol-info-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-wsaprotocol-info-import.php'>Russian</option>
            <option value='tr/function.socket-wsaprotocol-info-import.php'>Turkish</option>
            <option value='uk/function.socket-wsaprotocol-info-import.php'>Ukrainian</option>
            <option value='zh/function.socket-wsaprotocol-info-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-wsaprotocol-info-import" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_wsaprotocol_info_import</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">socket_wsaprotocol_info_import</span> &mdash; <span class="dc-title">Imports a Socket from another Process</span></p>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.socket-wsaprotocol-info-export.php" class="function" rel="rdfs-seeAlso">socket_wsaprotocol_info_export()</a> - Exports the WSAPROTOCOL_INFO Structure</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-wsaprotocol-info-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-wsaprotocol-info-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-wsaprotocol-info-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-wsaprotocol-info-import.php">＋<small>add a note</small></a></span>
