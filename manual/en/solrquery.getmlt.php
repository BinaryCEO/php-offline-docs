...
<head>
  ...
  <title>PHP: SolrQuery::getMlt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmlt.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmlt.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmlt.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightusephrasehighlighter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getmltboost.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmlt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmlt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmlt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmlt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmlt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmlt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmlt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmlt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmlt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmlt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmlt.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not MoreLikeThis results should be enabled" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMlt - Manual" />
<meta name="twitter:description" content="Returns whether or not MoreLikeThis results should be enabled" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMlt - Manual" />
<meta itemprop="description" content="Returns whether or not MoreLikeThis results should be enabled" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not MoreLikeThis results should be enabled" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getmltboost.php">
          SolrQuery::getMltBoost &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightusephrasehighlighter.php">
          &laquo; SolrQuery::getHighlightUsePhraseHighlighter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmlt.php' selected="selected">English</option>
            <option value='de/solrquery.getmlt.php'>German</option>
            <option value='es/solrquery.getmlt.php'>Spanish</option>
            <option value='fr/solrquery.getmlt.php'>French</option>
            <option value='it/solrquery.getmlt.php'>Italian</option>
            <option value='ja/solrquery.getmlt.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmlt.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmlt.php'>Russian</option>
            <option value='tr/solrquery.getmlt.php'>Turkish</option>
            <option value='uk/solrquery.getmlt.php'>Ukrainian</option>
            <option value='zh/solrquery.getmlt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmlt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMlt</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMlt</span> &mdash; <span class="dc-title">Returns whether or not MoreLikeThis results should be enabled</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmlt-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMlt</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmlt-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmlt-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmlt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmlt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmlt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmlt.php">＋<small>add a note</small></a></span>
