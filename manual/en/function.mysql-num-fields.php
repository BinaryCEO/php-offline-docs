...
<head>
  ...
  <title>PHP: mysql_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/mysql-num-fields">
 <link rel="alternate" href="https://www.php.net/mysql-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-list-tables.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Get number of fields in result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_num_fields - Manual" />
<meta name="twitter:description" content="Get number of fields in result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_num_fields - Manual" />
<meta itemprop="description" content="Get number of fields in result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get number of fields in result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-num-rows.php">
          mysql_num_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-list-tables.php">
          &laquo; mysql_list_tables        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-num-fields.php' selected="selected">English</option>
            <option value='de/function.mysql-num-fields.php'>German</option>
            <option value='es/function.mysql-num-fields.php'>Spanish</option>
            <option value='fr/function.mysql-num-fields.php'>French</option>
            <option value='it/function.mysql-num-fields.php'>Italian</option>
            <option value='ja/function.mysql-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.mysql-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-num-fields.php'>Russian</option>
            <option value='tr/function.mysql-num-fields.php'>Turkish</option>
            <option value='uk/function.mysql-num-fields.php'>Ukrainian</option>
            <option value='zh/function.mysql-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_num_fields</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_num_fields</span> &mdash; <span class="dc-title">Get number of fields in result</span></p>
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.field-count.php" class="function">mysqli_num_fields()</a></span></li>
    <li><span class="methodname"><a href="pdostatement.columncount.php" class="methodname">PDOStatement::columnCount()</a></span></li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-num-fields-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_num_fields</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-num-fields-returnvalues">
  ...
  <p class="para">
   Returns the number of fields in the result set <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> on
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-num-fields-examples">
  ...
  <p class="para">
   <div class="example" id="example-1915">
    <p><strong>Example #1 A <span class="function"><strong>mysql_num_fields()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-num-rows.php" class="function" rel="rdfs-seeAlso">mysql_num_rows()</a> - Get number of rows in result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-num-fields.php">＋<small>add a note</small></a></span>
