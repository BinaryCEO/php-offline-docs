...
<head>
  ...
  <title>PHP: Gmagick::getimageresolution - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageresolution.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageresolution.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageresolution.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagescene.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageresolution.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageresolution.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageresolution.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageresolution.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageresolution.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageresolution.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageresolution.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageresolution.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageresolution.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageresolution.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageresolution.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageresolution - Manual" />
<meta name="twitter:description" content="Gets the image X and Y resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageresolution - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagescene.php">
          Gmagick::getimagescene &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagerenderingintent.php">
          &laquo; Gmagick::getimagerenderingintent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageresolution.php' selected="selected">English</option>
            <option value='de/gmagick.getimageresolution.php'>German</option>
            <option value='es/gmagick.getimageresolution.php'>Spanish</option>
            <option value='fr/gmagick.getimageresolution.php'>French</option>
            <option value='it/gmagick.getimageresolution.php'>Italian</option>
            <option value='ja/gmagick.getimageresolution.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageresolution.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageresolution.php'>Russian</option>
            <option value='tr/gmagick.getimageresolution.php'>Turkish</option>
            <option value='uk/gmagick.getimageresolution.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageresolution.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageresolution" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageresolution</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageresolution</span> &mdash; <span class="dc-title">Gets the image X and Y resolution</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageresolution-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageresolution</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageresolution-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageresolution-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageresolution-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageresolution.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageresolution%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageresolution.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112474">  <div class="votes">
    <div id="Vu112474">
    <a href="/manual/vote-note.php?id=112474&amp;page=gmagick.getimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112474">
    <a href="/manual/vote-note.php?id=112474&amp;page=gmagick.getimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112474" title="83% like this...">
    4
    </div>
  </div>
  <a href="#112474" class="name">
  <strong class="user"><em>Clive Walkden</em></strong></a><a class="genanchor" href="#112474"> &para;</a><div class="date" title="2013-06-20 09:17"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112474">
<div class="phpcode"><code><span class="html">The array returned is in the format<br /><br />Array<br />(<br />    [x] =&gt; 300<br />    [y] =&gt; 300<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.getimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageresolution.php">＋<small>add a note</small></a></div>
