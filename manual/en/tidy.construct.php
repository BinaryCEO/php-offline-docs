...
<head>
  ...
  <title>PHP: tidy::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/tidy.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/tidy.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/tidy.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.tidy.php">
 <link rel="prev" href="https://www.php.net/manual/en/tidy.cleanrepair.php">
 <link rel="next" href="https://www.php.net/manual/en/tidy.diagnose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/tidy.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/tidy.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/tidy.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/tidy.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/tidy.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/tidy.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/tidy.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/tidy.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/tidy.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/tidy.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/tidy.construct.php" hreflang="zh">
...
<meta name="Description" content="Constructs a new tidy object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: tidy::__construct - Manual" />
<meta name="twitter:description" content="Constructs a new tidy object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: tidy::__construct - Manual" />
<meta itemprop="description" content="Constructs a new tidy object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructs a new tidy object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/tidy.construct.php' selected="selected">English</option>
            <option value='de/tidy.construct.php'>German</option>
            <option value='es/tidy.construct.php'>Spanish</option>
            <option value='fr/tidy.construct.php'>French</option>
            <option value='it/tidy.construct.php'>Italian</option>
            <option value='ja/tidy.construct.php'>Japanese</option>
            <option value='pt_BR/tidy.construct.php'>Brazilian Portuguese</option>
            <option value='ru/tidy.construct.php'>Russian</option>
            <option value='tr/tidy.construct.php'>Turkish</option>
            <option value='uk/tidy.construct.php'>Ukrainian</option>
            <option value='zh/tidy.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="tidy.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">tidy::__construct</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL tidy &gt;= 0.5.2)</p><p class="refpurpose"><span class="refname">tidy::__construct</span> &mdash; <span class="dc-title">Constructs a new <span class="classname"><a href="class.tidy.php" class="classname">tidy</a></span> object</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-tidy.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>tidy::__construct</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$filename</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$config</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$useIncludePath</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span><br>)</div>

  <p class="para rdfs-comment">
   Constructs a new <span class="classname"><a href="class.tidy.php" class="classname">tidy</a></span> object.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       acting like <span class="function"><a href="tidy.parsefile.php" class="function">tidy_parse_file()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 errors" id="refsect1-tidy.construct-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-tidy.construct-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">filename</code>, <code class="parameter">config</code>,
       <code class="parameter">encoding</code> and <code class="parameter">useIncludePath</code> are nullable now.
      </td>
     </tr>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="tidy.parsestring.php" class="function" rel="rdfs-seeAlso">tidy::parseString()</a> - Parse a document stored in a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/tidy/tidy/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ftidy.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=tidy.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/tidy.construct.php">＋<small>add a note</small></a></span>
