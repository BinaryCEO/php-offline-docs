...
<head>
  ...
  <title>PHP: Imagick::getPixelIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getpixeliterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getpixeliterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpixeliterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getpage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getpixelregioniterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpixeliterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getpixeliterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getpixeliterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getpixeliterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getpixeliterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getpixeliterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getpixeliterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getpixeliterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getpixeliterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getpixeliterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getpixeliterator.php" hreflang="zh">
...
<meta name="Description" content="Returns a MagickPixelIterator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getPixelIterator - Manual" />
<meta name="twitter:description" content="Returns a MagickPixelIterator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getPixelIterator - Manual" />
<meta itemprop="description" content="Returns a MagickPixelIterator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a MagickPixelIterator" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getpixelregioniterator.php">
          Imagick::getPixelRegionIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getpage.php">
          &laquo; Imagick::getPage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getpixeliterator.php' selected="selected">English</option>
            <option value='de/imagick.getpixeliterator.php'>German</option>
            <option value='es/imagick.getpixeliterator.php'>Spanish</option>
            <option value='fr/imagick.getpixeliterator.php'>French</option>
            <option value='it/imagick.getpixeliterator.php'>Italian</option>
            <option value='ja/imagick.getpixeliterator.php'>Japanese</option>
            <option value='pt_BR/imagick.getpixeliterator.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getpixeliterator.php'>Russian</option>
            <option value='tr/imagick.getpixeliterator.php'>Turkish</option>
            <option value='uk/imagick.getpixeliterator.php'>Ukrainian</option>
            <option value='zh/imagick.getpixeliterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getpixeliterator" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getPixelIterator</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getPixelIterator</span> &mdash; <span class="dc-title">Returns a MagickPixelIterator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getpixeliterator-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getPixelIterator</strong></span>(): <span class="type"><a href="class.imagickpixeliterator.php" class="type ImagickPixelIterator">ImagickPixelIterator</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getpixeliterator-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getpixeliterator-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getpixeliterator-errors">
  ...
  <p class="para">
    <div class="example" id="example-3016">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getpixeliterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getpixeliterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getpixeliterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getpixeliterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="84126">  <div class="votes">
    <div id="Vu84126">
    <a href="/manual/vote-note.php?id=84126&amp;page=imagick.getpixeliterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd84126">
    <a href="/manual/vote-note.php?id=84126&amp;page=imagick.getpixeliterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V84126" title="100% like this...">
    1
    </div>
  </div>
  <a href="#84126" class="name">
  <strong class="user"><em>Sebastian Herold</em></strong></a><a class="genanchor" href="#84126"> &para;</a><div class="date" title="2008-06-30 01:06"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom84126">
<div class="phpcode"><code><span class="html">For me it was very helpful to read a article at Mikko's blog. He showed that the PixelIterator is not read-only, if you sync it regularly:<br /><br /><span class="default">&lt;?php<br />      </span><span class="comment">/* Create new object with the image */<br />      </span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">"strawberry.png" </span><span class="keyword">);<br /><br />      </span><span class="comment">/* Get iterator */<br />      </span><span class="default">$it </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getPixelIterator</span><span class="keyword">();<br />       <br />      </span><span class="comment">/* Loop trough pixel rows */<br />      </span><span class="keyword">foreach( </span><span class="default">$it </span><span class="keyword">as </span><span class="default">$row </span><span class="keyword">=&gt; </span><span class="default">$pixels </span><span class="keyword">)<br />      {<br />          </span><span class="comment">/* For every second row */<br />          </span><span class="keyword">if ( </span><span class="default">$row </span><span class="keyword">% </span><span class="default">2 </span><span class="keyword">)<br />          {<br />              </span><span class="comment">/* Loop trough the pixels in the row (columns) */<br />              </span><span class="keyword">foreach ( </span><span class="default">$pixels </span><span class="keyword">as </span><span class="default">$column </span><span class="keyword">=&gt; </span><span class="default">$pixel </span><span class="keyword">)<br />              {<br />                      </span><span class="comment">/* Paint every second pixel black*/<br />                      </span><span class="keyword">if ( </span><span class="default">$column </span><span class="keyword">% </span><span class="default">2 </span><span class="keyword">)<br />                      {<br />                              </span><span class="default">$pixel</span><span class="keyword">-&gt;</span><span class="default">setColor</span><span class="keyword">( </span><span class="string">"black" </span><span class="keyword">);<br />                      }<br />              }<br /><br />          }<br />         <br />          </span><span class="comment">/* Sync the iterator, this is important to do on each iteration */<br />          </span><span class="default">$it</span><span class="keyword">-&gt;</span><span class="default">syncIterator</span><span class="keyword">();<br />      }<br />       <br />      </span><span class="comment">/* Display the image */<br />      </span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/png" </span><span class="keyword">);<br />      echo </span><span class="default">$im</span><span class="keyword">;<br />       <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getpixeliterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getpixeliterator.php">＋<small>add a note</small></a></div>
