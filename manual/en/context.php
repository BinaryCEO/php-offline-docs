...
<head>
  ...
  <title>PHP: Context options and parameters - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/context.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/context.php">
 <link rel="alternate" href="https://www.php.net/manual/en/context.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/langref.php">
 <link rel="prev" href="https://www.php.net/manual/en/sensitiveparameter.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/context.socket.php">

 <link rel="alternate" href="https://www.php.net/manual/en/context.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/context.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/context.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/context.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/context.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/context.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/context.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/context.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/context.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/context.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/context.php" hreflang="zh">
...
<meta name="Description" content="Context options and parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Context options and parameters - Manual" />
<meta name="twitter:description" content="Context options and parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Context options and parameters - Manual" />
<meta itemprop="description" content="Context options and parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Context options and parameters" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="context.socket.php">
          Socket context options &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sensitiveparameter.construct.php">
          &laquo; SensitiveParameter::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/context.php' selected="selected">English</option>
            <option value='de/context.php'>German</option>
            <option value='es/context.php'>Spanish</option>
            <option value='fr/context.php'>French</option>
            <option value='it/context.php'>Italian</option>
            <option value='ja/context.php'>Japanese</option>
            <option value='pt_BR/context.php'>Brazilian Portuguese</option>
            <option value='ru/context.php'>Russian</option>
            <option value='tr/context.php'>Turkish</option>
            <option value='uk/context.php'>Ukrainian</option>
            <option value='zh/context.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="context" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="context.socket.php">Socket context options</a> — Socket context option listing</li><li><a href="context.http.php">HTTP context options</a> — HTTP context option listing</li><li><a href="context.ftp.php">FTP context options</a> — FTP context option listing</li><li><a href="context.ssl.php">SSL context options</a> — SSL context option listing</li><li><a href="context.phar.php">Phar context options</a> — Phar context option listing</li><li><a href="context.params.php">Context parameters</a> — Context parameter listing</li><li><a href="context.zip.php">Zip context options</a> — Zip context option listing</li><li><a href="context.zlib.php">Zlib context options</a> — Zlib context option listing</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/context.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcontext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=context&amp;repo=en&amp;redirect=https://www.php.net/manual/en/context.php">＋<small>add a note</small></a></span>
