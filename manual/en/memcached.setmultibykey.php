...
<head>
  ...
  <title>PHP: Memcached::setMultiByKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.setmultibykey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.setmultibykey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setmultibykey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.setmulti.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.setoption.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setmultibykey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.setmultibykey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.setmultibykey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.setmultibykey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.setmultibykey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.setmultibykey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.setmultibykey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.setmultibykey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.setmultibykey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.setmultibykey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.setmultibykey.php" hreflang="zh">
...
<meta name="Description" content="Store multiple items on a specific server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::setMultiByKey - Manual" />
<meta name="twitter:description" content="Store multiple items on a specific server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::setMultiByKey - Manual" />
<meta itemprop="description" content="Store multiple items on a specific server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Store multiple items on a specific server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.setoption.php">
          Memcached::setOption &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.setmulti.php">
          &laquo; Memcached::setMulti        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.setmultibykey.php' selected="selected">English</option>
            <option value='de/memcached.setmultibykey.php'>German</option>
            <option value='es/memcached.setmultibykey.php'>Spanish</option>
            <option value='fr/memcached.setmultibykey.php'>French</option>
            <option value='it/memcached.setmultibykey.php'>Italian</option>
            <option value='ja/memcached.setmultibykey.php'>Japanese</option>
            <option value='pt_BR/memcached.setmultibykey.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.setmultibykey.php'>Russian</option>
            <option value='tr/memcached.setmultibykey.php'>Turkish</option>
            <option value='uk/memcached.setmultibykey.php'>Ukrainian</option>
            <option value='zh/memcached.setmultibykey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.setmultibykey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::setMultiByKey</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::setMultiByKey</span> &mdash; <span class="dc-title">Store multiple items on a specific server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.setmultibykey-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::setMultiByKey()</strong></span> is functionally equivalent to
   <span class="methodname"><a href="memcached.setmulti.php" class="methodname">Memcached::setMulti()</a></span>, except that the free-form
   <code class="parameter">server_key</code> can be used to map the keys from
   <code class="parameter">items</code> to a specific server. This is useful if you
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.setmultibykey-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.setmulti.php" class="methodname" rel="rdfs-seeAlso">Memcached::setMulti()</a> - Store multiple items</span></li>
    <li><span class="methodname"><a href="memcached.set.php" class="methodname" rel="rdfs-seeAlso">Memcached::set()</a> - Store an item</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/setmultibykey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.setmultibykey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.setmultibykey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.setmultibykey.php">＋<small>add a note</small></a></span>
