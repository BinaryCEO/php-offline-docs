...
<head>
  ...
  <title>PHP: ReflectionClass::getParentClass - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getparentclass.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getparentclass.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getparentclass.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getnamespacename.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getproperties.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getparentclass.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getparentclass.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getparentclass.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getparentclass.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getparentclass.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getparentclass.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getparentclass.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getparentclass.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getparentclass.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getparentclass.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getparentclass.php" hreflang="zh">
...
<meta name="Description" content="Gets parent class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getParentClass - Manual" />
<meta name="twitter:description" content="Gets parent class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getParentClass - Manual" />
<meta itemprop="description" content="Gets parent class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets parent class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getproperties.php">
          ReflectionClass::getProperties &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getnamespacename.php">
          &laquo; ReflectionClass::getNamespaceName        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getparentclass.php' selected="selected">English</option>
            <option value='de/reflectionclass.getparentclass.php'>German</option>
            <option value='es/reflectionclass.getparentclass.php'>Spanish</option>
            <option value='fr/reflectionclass.getparentclass.php'>French</option>
            <option value='it/reflectionclass.getparentclass.php'>Italian</option>
            <option value='ja/reflectionclass.getparentclass.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getparentclass.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getparentclass.php'>Russian</option>
            <option value='tr/reflectionclass.getparentclass.php'>Turkish</option>
            <option value='uk/reflectionclass.getparentclass.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getparentclass.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getparentclass" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getParentClass</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getParentClass</span> &mdash; <span class="dc-title">Gets parent class</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionclass.getparentclass-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getParentClass</strong></span>(): <span class="type"><span class="type"><a href="class.reflectionclass.php" class="type ReflectionClass">ReflectionClass</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getparentclass-returnvalues">
  ...
  <p class="para">
   A <span class="classname"><a href="class.reflectionclass.php" class="classname">ReflectionClass</a></span> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there&#039;s no parent.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getparentclass-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.construct.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::__construct()</a> - Constructs a ReflectionClass</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getparentclass.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getparentclass%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getparentclass&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getparentclass.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112427">  <div class="votes">
    <div id="Vu112427">
    <a href="/manual/vote-note.php?id=112427&amp;page=reflectionclass.getparentclass&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112427">
    <a href="/manual/vote-note.php?id=112427&amp;page=reflectionclass.getparentclass&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112427" title="84% like this...">
    18
    </div>
  </div>
  <a href="#112427" class="name">
  <strong class="user"><em>isaac dot z dot foster at gmail dot com</em></strong></a><a class="genanchor" href="#112427"> &para;</a><div class="date" title="2013-06-15 09:02"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112427">
<div class="phpcode"><code><span class="html">To find all parents of a class you can use the following code:
<br />
<br />        $class = new ReflectionClass('classname');
<br />        
<br />        $parents = [];
<br />        
<br />        while ($parent = $class-&gt;getParentClass()) {
<br />            $parents[] = $parent-&gt;getName();
<br />            $class = $parent;
<br />        }
<br />        
<br />        echo "Parents: " . implode(", ", $parents);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getparentclass&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getparentclass.php">＋<small>add a note</small></a></div>
