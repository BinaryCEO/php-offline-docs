...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-connect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-create-db.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-connect.php" hreflang="uk">
...
<meta name="Description" content="Open a connection to a MySQL Server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_connect - Manual" />
<meta name="twitter:description" content="Open a connection to a MySQL Server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_connect - Manual" />
<meta itemprop="description" content="Open a connection to a MySQL Server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a connection to a MySQL Server" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-connect.php' selected="selected">English</option>
            ...
            <option value='ru/function.mysql-connect.php'>Russian</option>
            <option value='tr/function.mysql-connect.php'>Turkish</option>
            <option value='uk/function.mysql-connect.php'>Ukrainian</option>
...
Alternatives to this function include:</p>
   ...
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       ...
       value is &#039;localhost:3306&#039;. In <a href="ini.core.php#ini.sql.safe-mode" class="link">SQL safe mode</a>, this parameter is ignored
     ...
     <dd>
      <p class="para">
       ...
       <a href="ini.core.php#ini.sql.safe-mode" class="link">SQL safe mode</a>, this parameter is ignored and the name of the user that
     ...
     <dd>
      <p class="para">
       ...
       <a href="ini.core.php#ini.sql.safe-mode" class="link">SQL safe mode</a>, this parameter is ignored and empty password is used.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       In <a href="ini.core.php#ini.sql.safe-mode" class="link">SQL safe mode</a>, this parameter is ignored.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-connect-returnvalues">
  ...
  <p class="para">
   Returns a MySQL link identifier on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-close.php" class="function" rel="rdfs-seeAlso">mysql_close()</a> - Close MySQL connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-connect.php">＋<small>add a note</small></a></span>
