...
<head>
  ...
  <title>PHP: streamWrapper::stream_write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-write.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-write.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-write.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-truncate.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.unlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.stream-write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.stream-write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.stream-write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.stream-write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.stream-write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.stream-write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.stream-write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.stream-write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.stream-write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.stream-write.php" hreflang="zh">
...
<meta name="Description" content="Write to stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: streamWrapper::stream_write - Manual" />
<meta name="twitter:description" content="Write to stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_write - Manual" />
<meta itemprop="description" content="Write to stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write to stream" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="streamwrapper.unlink.php">
          streamWrapper::unlink &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-truncate.php">
          &laquo; streamWrapper::stream_truncate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-write.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-write.php'>German</option>
            <option value='es/streamwrapper.stream-write.php'>Spanish</option>
            <option value='fr/streamwrapper.stream-write.php'>French</option>
            <option value='it/streamwrapper.stream-write.php'>Italian</option>
            <option value='ja/streamwrapper.stream-write.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.stream-write.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.stream-write.php'>Russian</option>
            <option value='tr/streamwrapper.stream-write.php'>Turkish</option>
            <option value='uk/streamwrapper.stream-write.php'>Ukrainian</option>
            <option value='zh/streamwrapper.stream-write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.stream-write" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fwrite.php" class="function" rel="rdfs-seeAlso">fwrite()</a> - Binary-safe file write</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-write.php">＋<small>add a note</small></a></span>
