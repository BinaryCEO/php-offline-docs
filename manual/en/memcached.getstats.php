...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getstats.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getstats.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getstats.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getserverlist.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getversion.php">
...
<meta name="Description" content="Get server pool statistics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::getStats - Manual" />
<meta name="twitter:description" content="Get server pool statistics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::getStats - Manual" />
<meta itemprop="description" content="Get server pool statistics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get server pool statistics" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getstats.php' selected="selected">English</option>
            ...
            <option value='ja/memcached.getstats.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::getStats</span> &mdash; <span class="dc-title">Get server pool statistics</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.getstats-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::getStats()</strong></span> returns an array containing the
   state of all available memcache servers. See
   <a href="https://github.com/memcached/memcached/blob/master/doc/protocol.txt" class="link external">&raquo;&nbsp;memcache protocol</a>
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.getstats-returnvalues">
  ...
  <p class="para">
   Array of server statistics, one entry per server,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-memcached.getstats-examples">
  ...
  <p class="para">
   <div class="example" id="example-4693">
    <p><strong>Example #1 <span class="function"><strong>Memcached::getStats()</strong></span> example</strong></p>
...
(
    [localhost:11211] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getstats.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getstats%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getstats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getstats.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>ar knownat plista with com</em></strong></a><a class="genanchor" href="#95197"> &para;</a><div class="date" title="2009-12-17 11:13"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95197">
<div class="phpcode"><code><span class="html">The method currently does not support the optional (and subject to change) type parameter for the stats command:<br /> - "items", "sizes", "slabs"<br /><br />The documentation for the optional parameters can be found here (sections below General-purpose statistics):<br /><a href="http://code.sixapart.com/svn/memcached/trunk/server/doc/protocol.txt" rel="nofollow" target="_blank">http://code.sixapart.com/svn/memcached/trunk/server/doc/protocol.txt</a><br /><br />The Memcache Extension can be uses to retrieve that information:<br /><a href="http://www.php.net/manual/en/function.memcache-getstats.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/function.memcache-getstats.php</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">new url for memcache protocol documents.<br /><a href="https://github.com/memcached/memcached/blob/master/doc/protocol.txt" rel="nofollow" target="_blank">https://github.com/memcached/memcached/blob/master/doc/protocol.txt</a></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>billfeller at gmail dot com</em></strong></a><a class="genanchor" href="#113572"> &para;</a><div class="date" title="2013-10-31 08:27"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113572">
<div class="phpcode"><code><span class="html">the link to memcache protocol is out date. the new link is <a href="https://github.com/facebook/memcached/blob/master/doc/protocol.txt" rel="nofollow" target="_blank">https://github.com/facebook/memcached/blob/master/doc/protocol.txt</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.getstats&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getstats.php">＋<small>add a note</small></a></div>
