...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-parse-exop.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-next-reference.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-parse-reference.php">
...
<meta name="Description" content="Parse result object from an LDAP extended operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_parse_exop - Manual" />
<meta name="twitter:description" content="Parse result object from an LDAP extended operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_parse_exop - Manual" />
<meta itemprop="description" content="Parse result object from an LDAP extended operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parse result object from an LDAP extended operation" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-parse-exop.php' selected="selected">English</option>
            ...
            <option value='ja/function.ldap-parse-exop.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_parse_exop</span> &mdash; <span class="dc-title">Parse result object from an LDAP extended operation</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-parse-exop-description">
  ...
  <p class="para rdfs-comment">
   Parse LDAP extended operation data from result object <code class="parameter">result</code>
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-exop.php" class="function" rel="rdfs-seeAlso">ldap_exop()</a> - Performs an extended operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-parse-exop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-parse-exop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-parse-exop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-parse-exop.php">＋<small>add a note</small></a></span>
