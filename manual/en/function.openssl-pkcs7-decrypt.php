...
<head>
  ...
  <title>PHP: openssl_pkcs7_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-pkcs7-decrypt.php">
 <link rel="shorturl" href="https://www.php.net/openssl-pkcs7-decrypt">
 <link rel="alternate" href="https://www.php.net/openssl-pkcs7-decrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkcs12-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-pkcs7-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-pkcs7-decrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-pkcs7-decrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-pkcs7-decrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-pkcs7-decrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-pkcs7-decrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-pkcs7-decrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-pkcs7-decrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-pkcs7-decrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-pkcs7-decrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-pkcs7-decrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-pkcs7-decrypt.php" hreflang="zh">
...
<meta name="Description" content="Decrypts an S/MIME encrypted message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_pkcs7_decrypt - Manual" />
<meta name="twitter:description" content="Decrypts an S/MIME encrypted message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_pkcs7_decrypt - Manual" />
<meta itemprop="description" content="Decrypts an S/MIME encrypted message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrypts an S/MIME encrypted message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-pkcs7-encrypt.php">
          openssl_pkcs7_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkcs12-read.php">
          &laquo; openssl_pkcs12_read        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-pkcs7-decrypt.php' selected="selected">English</option>
            <option value='de/function.openssl-pkcs7-decrypt.php'>German</option>
            <option value='es/function.openssl-pkcs7-decrypt.php'>Spanish</option>
            <option value='fr/function.openssl-pkcs7-decrypt.php'>French</option>
            <option value='it/function.openssl-pkcs7-decrypt.php'>Italian</option>
            <option value='ja/function.openssl-pkcs7-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.openssl-pkcs7-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-pkcs7-decrypt.php'>Russian</option>
            <option value='tr/function.openssl-pkcs7-decrypt.php'>Turkish</option>
            <option value='uk/function.openssl-pkcs7-decrypt.php'>Ukrainian</option>
            <option value='zh/function.openssl-pkcs7-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-pkcs7-decrypt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_pkcs7_decrypt</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_pkcs7_decrypt</span> &mdash; <span class="dc-title">Decrypts an S/MIME encrypted message</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-pkcs7-decrypt-examples">
  ...
  <p class="para">
   <div class="example" id="example-1032">
    <p><strong>Example #1 <span class="function"><strong>openssl_pkcs7_decrypt()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// $cert and $key are assumed to contain your personal certificate and private<br />// key pair, and that you are the recipient of an S/MIME message<br /></span><span style="color: #0000BB">$infilename </span><span style="color: #007700">= </span><span style="color: #DD0000">"encrypted.msg"</span><span style="color: #007700">;  </span><span style="color: #FF8000">// this file holds your encrypted message<br /></span><span style="color: #0000BB">$outfilename </span><span style="color: #007700">= </span><span style="color: #DD0000">"decrypted.msg"</span><span style="color: #007700">; </span><span style="color: #FF8000">// make sure you can write to this file<br /><br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">openssl_pkcs7_decrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$infilename</span><span style="color: #007700">, </span><span style="color: #0000BB">$outfilename</span><span style="color: #007700">, </span><span style="color: #0000BB">$cert</span><span style="color: #007700">, </span><span style="color: #0000BB">$key</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"decrypted!"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"failed to decrypt!"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-pkcs7-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-pkcs7-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-pkcs7-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs7-decrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103707">  <div class="votes">
    <div id="Vu103707">
    <a href="/manual/vote-note.php?id=103707&amp;page=function.openssl-pkcs7-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103707">
    <a href="/manual/vote-note.php?id=103707&amp;page=function.openssl-pkcs7-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103707" title="58% like this...">
    2
    </div>
  </div>
  <a href="#103707" class="name">
  <strong class="user"><em>oliver at anonsphere dot com</em></strong></a><a class="genanchor" href="#103707"> &para;</a><div class="date" title="2011-04-28 09:16"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103707">
<div class="phpcode"><code><span class="html">If you want to decrypt a received email, keep in mind that you need the full encrypted message including the mime header.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Get the full message<br /></span><span class="default">$encrypted </span><span class="keyword">= </span><span class="default">imap_fetchmime</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$msg_number</span><span class="keyword">, </span><span class="string">"1"</span><span class="keyword">, </span><span class="default">FT_UID</span><span class="keyword">);<br /></span><span class="default">$encrypted </span><span class="keyword">.= </span><span class="default">imap_fetchbody</span><span class="keyword">(</span><span class="default">$stream</span><span class="keyword">, </span><span class="default">$msg_number</span><span class="keyword">, </span><span class="string">"1"</span><span class="keyword">, </span><span class="default">FT_UID</span><span class="keyword">);<br /><br /></span><span class="comment">// Write the needed temporary files<br /></span><span class="default">$infile </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="string">""</span><span class="keyword">, </span><span class="string">"enc"</span><span class="keyword">);<br /></span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="default">$infile</span><span class="keyword">, </span><span class="default">$encrypted</span><span class="keyword">); <br /></span><span class="default">$outfile </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="string">""</span><span class="keyword">, </span><span class="string">"dec"</span><span class="keyword">);<br /><br /></span><span class="comment">// The certification stuff<br /></span><span class="default">$public </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">"/path/to/your/cert.pem"</span><span class="keyword">);<br /></span><span class="default">$private </span><span class="keyword">= array(</span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">"/path/to/your/cert.pem"</span><span class="keyword">), </span><span class="string">"password"</span><span class="keyword">);<br /><br /></span><span class="comment">// Ready? Go!<br /></span><span class="keyword">if(</span><span class="default">openssl_pkcs7_decrypt</span><span class="keyword">(</span><span class="default">$infile</span><span class="keyword">, </span><span class="default">$outfile</span><span class="keyword">, </span><span class="default">$public</span><span class="keyword">, </span><span class="default">$private</span><span class="keyword">))<br />{<br />    </span><span class="comment">// Decryption successful<br />    </span><span class="keyword">echo </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$outfile</span><span class="keyword">);<br />}<br />else<br />{<br />    </span><span class="comment">// Decryption failed<br />    </span><span class="keyword">echo </span><span class="string">"Oh oh! Decryption failed!"</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// Remove the temp files<br /></span><span class="keyword">@</span><span class="default">unlink</span><span class="keyword">(</span><span class="default">$infile</span><span class="keyword">);<br />@</span><span class="default">unlink</span><span class="keyword">(</span><span class="default">$outfile</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-pkcs7-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-pkcs7-decrypt.php">＋<small>add a note</small></a></div>
