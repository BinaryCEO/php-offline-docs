...
<head>
  ...
  <title>PHP: ldap_add_ext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-add-ext.php">
 <link rel="shorturl" href="https://www.php.net/ldap-add-ext">
 <link rel="alternate" href="https://www.php.net/ldap-add-ext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-add-ext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-add-ext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-add-ext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-add-ext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-add-ext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-add-ext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-add-ext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-add-ext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-add-ext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-add-ext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-add-ext.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_add_ext - Manual" />
<meta name="twitter:description" content="Add entries to LDAP directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_add_ext - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-add-ext.php' selected="selected">English</option>
            <option value='de/function.ldap-add-ext.php'>German</option>
            <option value='es/function.ldap-add-ext.php'>Spanish</option>
            <option value='fr/function.ldap-add-ext.php'>French</option>
            <option value='it/function.ldap-add-ext.php'>Italian</option>
            <option value='ja/function.ldap-add-ext.php'>Japanese</option>
            <option value='pt_BR/function.ldap-add-ext.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-add-ext.php'>Russian</option>
            <option value='tr/function.ldap-add-ext.php'>Turkish</option>
            <option value='uk/function.ldap-add-ext.php'>Ukrainian</option>
            <option value='zh/function.ldap-add-ext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-add-ext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_add_ext</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_add_ext</span> &mdash; <span class="dc-title">Add entries to LDAP directory</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-add-ext-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_add_ext</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$entry</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$controls</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="class.ldap-result.php" class="type LDAP\Result">LDAP\Result</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Does the same thing as <span class="function"><a href="function.ldap-add.php" class="function">ldap_add()</a></span> but returns
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-add-ext-parameters">
  ...
  <p class="para">
    See <span class="function"><a href="function.ldap-add.php" class="function">ldap_add()</a></span>
  </p>
 </div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.ldap-add-ext-changelog">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-parse-result.php" class="function" rel="rdfs-seeAlso">ldap_parse_result()</a> - Extract information from result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-add-ext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-add-ext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-add-ext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-add-ext.php">＋<small>add a note</small></a></span>
