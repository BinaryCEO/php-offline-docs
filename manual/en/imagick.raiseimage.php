...
<head>
  ...
  <title>PHP: Imagick::raiseImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.raiseimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.raiseimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.raiseimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.radialblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.randomthresholdimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.raiseimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.raiseimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.raiseimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.raiseimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.raiseimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.raiseimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.raiseimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.raiseimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.raiseimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.raiseimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.raiseimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a simulated 3d button-like effect" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::raiseImage - Manual" />
<meta name="twitter:description" content="Creates a simulated 3d button-like effect" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::raiseImage - Manual" />
<meta itemprop="description" content="Creates a simulated 3d button-like effect" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a simulated 3d button-like effect" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.randomthresholdimage.php">
          Imagick::randomThresholdImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.radialblurimage.php">
          &laquo; Imagick::radialBlurImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.raiseimage.php' selected="selected">English</option>
            <option value='de/imagick.raiseimage.php'>German</option>
            <option value='es/imagick.raiseimage.php'>Spanish</option>
            <option value='fr/imagick.raiseimage.php'>French</option>
            <option value='it/imagick.raiseimage.php'>Italian</option>
            <option value='ja/imagick.raiseimage.php'>Japanese</option>
            <option value='pt_BR/imagick.raiseimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.raiseimage.php'>Russian</option>
            <option value='tr/imagick.raiseimage.php'>Turkish</option>
            <option value='uk/imagick.raiseimage.php'>Ukrainian</option>
            <option value='zh/imagick.raiseimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.raiseimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::raiseImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::raiseImage</span> &mdash; <span class="dc-title">Creates a simulated 3d button-like effect</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.raiseimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::raiseImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$raise</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.raiseimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.raiseimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3073">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/raiseimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.raiseimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.raiseimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.raiseimage.php">＋<small>add a note</small></a></span>
