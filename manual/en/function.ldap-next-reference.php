...
<head>
  ...
  <title>PHP: ldap_next_reference - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-next-reference.php">
 <link rel="shorturl" href="https://www.php.net/ldap-next-reference">
 <link rel="alternate" href="https://www.php.net/ldap-next-reference" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-next-entry.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-parse-exop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-next-reference.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-next-reference.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-next-reference.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-next-reference.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-next-reference.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-next-reference.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-next-reference.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-next-reference.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-next-reference.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-next-reference.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-next-reference.php" hreflang="zh">
...
<meta name="Description" content="Get next reference" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_next_reference - Manual" />
<meta name="twitter:description" content="Get next reference" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_next_reference - Manual" />
<meta itemprop="description" content="Get next reference" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get next reference" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-parse-exop.php">
          ldap_parse_exop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-next-entry.php">
          &laquo; ldap_next_entry        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-next-reference.php' selected="selected">English</option>
            <option value='de/function.ldap-next-reference.php'>German</option>
            <option value='es/function.ldap-next-reference.php'>Spanish</option>
            <option value='fr/function.ldap-next-reference.php'>French</option>
            <option value='it/function.ldap-next-reference.php'>Italian</option>
            <option value='ja/function.ldap-next-reference.php'>Japanese</option>
            <option value='pt_BR/function.ldap-next-reference.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-next-reference.php'>Russian</option>
            <option value='tr/function.ldap-next-reference.php'>Turkish</option>
            <option value='uk/function.ldap-next-reference.php'>Ukrainian</option>
            <option value='zh/function.ldap-next-reference.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-next-reference" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_next_reference</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_next_reference</span> &mdash; <span class="dc-title">Get next reference</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ldap-next-reference-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_next_reference</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type">LDAP\ResultEntry</span> <code class="parameter">$entry</code></span>): <span class="type"><span class="type">LDAP\ResultEntry</span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
currently not documented; only its argument list is available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-next-reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-next-reference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-next-reference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-next-reference.php">＋<small>add a note</small></a></span>
