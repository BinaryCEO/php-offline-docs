...
<div class="phpcode"><code><span class="html">It's not explicitly documented; number_format also rounds:<br /><br /><span class="default">&lt;?php<br />$numbers </span><span class="keyword">= array(</span><span class="default">0.001</span><span class="keyword">, </span><span class="default">0.002</span><span class="keyword">, </span><span class="default">0.003</span><span class="keyword">, </span><span class="default">0.004</span><span class="keyword">, </span><span class="default">0.005</span><span class="keyword">, </span><span class="default">0.006</span><span class="keyword">, </span><span class="default">0.007</span><span class="keyword">, </span><span class="default">0.008</span><span class="keyword">, </span><span class="default">0.009</span><span class="keyword">);<br />foreach (</span><span class="default">$numbers </span><span class="keyword">as </span><span class="default">$number</span><span class="keyword">)<br />    print </span><span class="default">$number</span><span class="keyword">.</span><span class="string">"-&gt;"</span><span class="keyword">.</span><span class="default">number_format</span><span class="keyword">(</span><span class="default">$number</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="string">'.'</span><span class="keyword">, </span><span class="string">','</span><span class="keyword">).</span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />0.001-&gt;0.00<br />0.002-&gt;0.00<br />0.003-&gt;0.00<br />0.004-&gt;0.00<br />0.005-&gt;0.01<br />0.006-&gt;0.01<br />0.007-&gt;0.01<br />0.008-&gt;0.01<br />0.009-&gt;0.01</span></code></div>
  ...
  <div class="note" id="126729">  <div class="votes">
    ...
    <div class="tally" id="V126729" title="59% like this...">
    10
    </div>
  </div>
  <a href="#126729" class="name">
  <strong class="user"><em>info at ensostudio dot ru</em></strong></a><a class="genanchor" href="#126729"> &para;</a><div class="date" title="2021-12-30 08:28"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126729">
<div class="phpcode"><code><span class="html">Note: use NumberFormatter to convert in human-readable format instead  user function from comments:<br /><span class="default">&lt;?php<br /></span><span class="keyword">echo </span><span class="default">NumberFormatter</span><span class="keyword">::</span><span class="default">create</span><span class="keyword">(</span><span class="string">'en'</span><span class="keyword">, </span><span class="default">NumberFormatter</span><span class="keyword">::</span><span class="default">SPELLOUT</span><span class="keyword">)-&gt;</span><span class="default">format</span><span class="keyword">(</span><span class="default">12309</span><span class="keyword">); </span><span class="comment">// twelve thousand three hundred nine<br /></span><span class="keyword">echo </span><span class="default">NumberFormatter</span><span class="keyword">::</span><span class="default">create</span><span class="keyword">(</span><span class="string">'ru'</span><span class="keyword">, </span><span class="default">NumberFormatter</span><span class="keyword">::</span><span class="default">SPELLOUT</span><span class="keyword">)-&gt;</span><span class="default">format</span><span class="keyword">(</span><span class="default">12307.5</span><span class="keyword">); </span><span class="comment">//  двенадцать тысяч триста семь целых пять десятых<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Outputs a human readable number.<br /><br /><span class="default">&lt;?php<br />    </span><span class="comment">#    Output easy-to-read numbers<br />    #    by james at bandit.co.nz<br />    </span><span class="keyword">function </span><span class="default">bd_nice_number</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">) {<br />        </span><span class="comment">// first strip any formatting;<br />        </span><span class="default">$n </span><span class="keyword">= (</span><span class="default">0</span><span class="keyword">+</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">","</span><span class="keyword">,</span><span class="string">""</span><span class="keyword">,</span><span class="default">$n</span><span class="keyword">));<br />        <br />        </span><span class="comment">// is this a number?<br />        </span><span class="keyword">if(!</span><span class="default">is_numeric</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">)) return </span><span class="default">false</span><span class="keyword">;<br />        <br />        </span><span class="comment">// now filter it;<br />        </span><span class="keyword">if(</span><span class="default">$n</span><span class="keyword">&gt;</span><span class="default">1000000000000</span><span class="keyword">) return </span><span class="default">round</span><span class="keyword">((</span><span class="default">$n</span><span class="keyword">/</span><span class="default">1000000000000</span><span class="keyword">),</span><span class="default">1</span><span class="keyword">).</span><span class="string">' trillion'</span><span class="keyword">;<br />        else if(</span><span class="default">$n</span><span class="keyword">&gt;</span><span class="default">1000000000</span><span class="keyword">) return </span><span class="default">round</span><span class="keyword">((</span><span class="default">$n</span><span class="keyword">/</span><span class="default">1000000000</span><span class="keyword">),</span><span class="default">1</span><span class="keyword">).</span><span class="string">' billion'</span><span class="keyword">;<br />        else if(</span><span class="default">$n</span><span class="keyword">&gt;</span><span class="default">1000000</span><span class="keyword">) return </span><span class="default">round</span><span class="keyword">((</span><span class="default">$n</span><span class="keyword">/</span><span class="default">1000000</span><span class="keyword">),</span><span class="default">1</span><span class="keyword">).</span><span class="string">' million'</span><span class="keyword">;<br />        else if(</span><span class="default">$n</span><span class="keyword">&gt;</span><span class="default">1000</span><span class="keyword">) return </span><span class="default">round</span><span class="keyword">((</span><span class="default">$n</span><span class="keyword">/</span><span class="default">1000</span><span class="keyword">),</span><span class="default">1</span><span class="keyword">).</span><span class="string">' thousand'</span><span class="keyword">;<br />        <br />        return </span><span class="default">number_format</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">);<br />    }<br /></span><span class="default">?&gt;<br /></span><br />Outputs:<br /><br />247,704,360 -&gt; 247.7 million<br />866,965,260,000 -&gt; 867 billion</span></code></div>
  </div>
 </div>
  <div class="note" id="62141">  <div class="votes">
    ...
    <div class="tally" id="V62141" title="57% like this...">
    22
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">For Zero fill - just use the sprintf() function<br /><br />$pr_id = 1;<br />$pr_id = sprintf("%03d", $pr_id);<br />echo $pr_id;<br /><br />//outputs 001<br />-----------------<br /><br />$pr_id = 10;<br />$pr_id = sprintf("%03d", $pr_id);<br />echo $pr_id;<br /><br />//outputs 010<br />-----------------<br /><br />You can change %03d to %04d, etc.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">formatting numbers may be more easy if u use number_format function.<br /><br />I also wrote this :<br />function something($number)<br />{<br />    $locale = localeconv();<br />    return number_format($number,<br />       $locale['frac_digits'],<br />        $locale['decimal_point'],<br />        $locale['thousands_sep']);<br />}<br /><br />hope this helps =)<br />[]'s</span></code></div>
  </div>
 </div>
  <div class="note" id="57376">  <div class="votes">
    ...
    <div class="tally" id="V57376" title="57% like this...">
    5
    </div>
  </div>
  <a href="#57376" class="name">
  <strong class="user"><em>Jeroen de Bruijn [NL]</em></strong></a><a class="genanchor" href="#57376"> &para;</a><div class="date" title="2005-10-01 03:02"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom57376">
<div class="phpcode"><code><span class="html">If you want to display a number ending with ,- (like 200,-) when there are no decimal characters and display the decimals when there are decimal characters i use:<br /><br />function DisplayDouble($value)<br />  {<br />  list($whole, $decimals) = split ('[.,]', $value, 2);<br />  if (intval($decimals) &gt; 0)<br />    return number_format($value,2,".",",");<br />  else<br />    return number_format($value,0,".",",") .",-";<br />  }</span></code></div>
  </div>
 </div>
