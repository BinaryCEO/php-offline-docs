...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightSnippets - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightsimplepre.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightsnippets.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightsnippets.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightsnippets.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightsnippets.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightsnippets.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightsnippets.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightsnippets.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightsnippets.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightsnippets.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightsnippets.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum number of highlighted snippets to generate per field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightSnippets - Manual" />
<meta name="twitter:description" content="Sets the maximum number of highlighted snippets to generate per field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightSnippets - Manual" />
<meta itemprop="description" content="Sets the maximum number of highlighted snippets to generate per field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum number of highlighted snippets to generate per field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightusephrasehighlighter.php">
          SolrQuery::setHighlightUsePhraseHighlighter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightsimplepre.php">
          &laquo; SolrQuery::setHighlightSimplePre        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightsnippets.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightsnippets.php'>German</option>
            <option value='es/solrquery.sethighlightsnippets.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightsnippets.php'>French</option>
            <option value='it/solrquery.sethighlightsnippets.php'>Italian</option>
            <option value='ja/solrquery.sethighlightsnippets.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightsnippets.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightsnippets.php'>Russian</option>
            <option value='tr/solrquery.sethighlightsnippets.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightsnippets.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightsnippets.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightsnippets" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightSnippets</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightSnippets</span> &mdash; <span class="dc-title">Sets the maximum number of highlighted snippets to generate per field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightsnippets-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightSnippets</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightsnippets-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightsnippets-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightsnippets.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightsnippets%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightsnippets&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightsnippets.php">＋<small>add a note</small></a></span>
