...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gnupg-export.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gnupg-encryptsign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gnupg-getengineinfo.php">
...
<meta name="Description" content="Exports a key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gnupg_export - Manual" />
<meta name="twitter:description" content="Exports a key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gnupg_export - Manual" />
<meta itemprop="description" content="Exports a key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gnupg-export.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.gnupg-export.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gnupg &gt;= 0.1)</p><p class="refpurpose"><span class="refname">gnupg_export</span> &mdash; <span class="dc-title">Exports a key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gnupg-export-description">
  ...
  <p class="para rdfs-comment">
   Exports the key <code class="parameter">fingerprint</code>.
  </p>
 </div>
...
<span class="function"><a href="function.gnupg-init.php" class="function">gnupg_init()</a></span> or <span class="classname"><strong class="classname">gnupg</strong></span>.</p>
 ...
 <div class="refsect1 examples" id="refsect1-function.gnupg-export-examples">
  ...
  <p class="para">
   <div class="example" id="example-3431">
    <p><strong>Example #1 Procedural <span class="function"><strong>gnupg_export()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$res </span><span style="color: #007700">= </span><span style="color: #0000BB">gnupg_init</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$export </span><span style="color: #007700">= </span><span style="color: #0000BB">gnupg_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$res</span><span style="color: #007700">,</span><span style="color: #DD0000">"8660281B6051D071D94B5B230549F9DC851566DC"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$export</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example" id="example-3432">
    <p><strong>Example #2 OO <span class="function"><strong>gnupg_export()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$gpg </span><span style="color: #007700">= new </span><span style="color: #0000BB">gnupg</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$export </span><span style="color: #007700">= </span><span style="color: #0000BB">$gpg</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">export</span><span style="color: #007700">(</span><span style="color: #DD0000">"8660281B6051D071D94B5B230549F9DC851566DC"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gnupg/functions/gnupg-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gnupg-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gnupg-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gnupg-export.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>php at cdauth dot de</em></strong></a><a class="genanchor" href="#79549"> &para;</a><div class="date" title="2007-12-02 02:21"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79549">
<div class="phpcode"><code><span class="html">Just to ensure you, because it is not mentioned in the manual: of course, only the public key is exported, even if you have the private key in your keyring.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gnupg-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gnupg-export.php">＋<small>add a note</small></a></div>
