...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/apcu.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/apcu.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/apcu.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.apcu.php">
 <link rel="prev" href="https://www.php.net/manual/en/apcu.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.apcu.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/apcu.constants.php' selected="selected">English</option>
            ...
            <option value='pt_BR/apcu.constants.php'>Brazilian Portuguese</option>
  ...
  <dl>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/apcu/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fapcu.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=apcu.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/apcu.constants.php">＋<small>add a note</small></a></span>
