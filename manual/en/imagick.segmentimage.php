...
<head>
  ...
  <title>PHP: Imagick::segmentImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.segmentimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.segmentimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.segmentimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.scaleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.segmentimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.segmentimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.segmentimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.segmentimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.segmentimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.segmentimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.segmentimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.segmentimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.segmentimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.segmentimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.segmentimage.php" hreflang="zh">
...
<meta name="Description" content="Segments an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::segmentImage - Manual" />
<meta name="twitter:description" content="Segments an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::segmentImage - Manual" />
<meta itemprop="description" content="Segments an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Segments an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.selectiveblurimage.php">
          Imagick::selectiveBlurImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.scaleimage.php">
          &laquo; Imagick::scaleImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.segmentimage.php' selected="selected">English</option>
            <option value='de/imagick.segmentimage.php'>German</option>
            <option value='es/imagick.segmentimage.php'>Spanish</option>
            <option value='fr/imagick.segmentimage.php'>French</option>
            <option value='it/imagick.segmentimage.php'>Italian</option>
            <option value='ja/imagick.segmentimage.php'>Japanese</option>
            <option value='pt_BR/imagick.segmentimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.segmentimage.php'>Russian</option>
            <option value='tr/imagick.segmentimage.php'>Turkish</option>
            <option value='uk/imagick.segmentimage.php'>Ukrainian</option>
            <option value='zh/imagick.segmentimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.segmentimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::segmentImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::segmentImage</span> &mdash; <span class="dc-title">Segments an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.segmentimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::segmentImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$COLORSPACE</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$cluster_threshold</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$smooth_threshold</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$verbose</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.segmentimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">cluster_threshold</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">smooth_threshold</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.segmentimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3085">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/segmentimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.segmentimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.segmentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.segmentimage.php">＋<small>add a note</small></a></span>
