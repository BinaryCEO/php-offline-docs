...
<head>
  ...
  <title>PHP: Imagick::getImageRegion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageregion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageregion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageregion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageredprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageregion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageregion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageregion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageregion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageregion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageregion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageregion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageregion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageregion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageregion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageregion.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageRegion - Manual" />
<meta name="twitter:description" content="Extracts a region of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageRegion - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagerenderingintent.php">
          Imagick::getImageRenderingIntent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageredprimary.php">
          &laquo; Imagick::getImageRedPrimary        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageregion.php' selected="selected">English</option>
            <option value='de/imagick.getimageregion.php'>German</option>
            <option value='es/imagick.getimageregion.php'>Spanish</option>
            <option value='fr/imagick.getimageregion.php'>French</option>
            <option value='it/imagick.getimageregion.php'>Italian</option>
            <option value='ja/imagick.getimageregion.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageregion.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageregion.php'>Russian</option>
            <option value='tr/imagick.getimageregion.php'>Turkish</option>
            <option value='uk/imagick.getimageregion.php'>Ukrainian</option>
            <option value='zh/imagick.getimageregion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageregion" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageRegion</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageRegion</span> &mdash; <span class="dc-title">Extracts a region of the image</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-imagick.getimageregion-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageRegion</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageregion-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageregion-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageregion-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageregion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageregion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageregion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageregion.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92392">  <div class="votes">
    <div id="Vu92392">
    <a href="/manual/vote-note.php?id=92392&amp;page=imagick.getimageregion&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92392">
    <a href="/manual/vote-note.php?id=92392&amp;page=imagick.getimageregion&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92392" title="100% like this...">
    6
    </div>
  </div>
  <a href="#92392" class="name">
  <strong class="user"><em>zolcos at hotmail dot com</em></strong></a><a class="genanchor" href="#92392"> &para;</a><div class="date" title="2009-07-22 02:45"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92392">
<div class="phpcode"><code><span class="html">getImageRegion has the same side effect that was mentioned for operations that change the crop of the image -- the new image preserves the old canvas and positioning info. For example, using annotateImage on the new image will interpret the positioning arguments relative to the old image. To correct it, reset this info with setImagePage.<br /><br /><span class="default">&lt;?php<br />$im</span><span class="keyword">-&gt;</span><span class="default">setImagePage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageregion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageregion.php">＋<small>add a note</small></a></div>
