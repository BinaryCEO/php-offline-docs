...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zlib.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zlib.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zlib.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/zlib.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/zlib.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/zlib.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/zlib.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/zlib.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/zlib.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/zlib.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/zlib.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/zlib.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/zlib.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/zlib.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/zlib.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/zlib.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zlib.constants.php' selected="selected">English</option>
            <option value='de/zlib.constants.php'>German</option>
            <option value='es/zlib.constants.php'>Spanish</option>
            <option value='fr/zlib.constants.php'>French</option>
            <option value='it/zlib.constants.php'>Italian</option>
            <option value='ja/zlib.constants.php'>Japanese</option>
            <option value='pt_BR/zlib.constants.php'>Brazilian Portuguese</option>
            <option value='ru/zlib.constants.php'>Russian</option>
            <option value='tr/zlib.constants.php'>Turkish</option>
            <option value='uk/zlib.constants.php'>Ukrainian</option>
            <option value='zh/zlib.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="zlib.constants" class="appendix">
...
been compiled into PHP or dynamically loaded at runtime.
 ...
 <dl>
   ...
   <dd>
    <span class="simpara">
     <code class="literal">zlib</code> version number as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     <code class="literal">zlib</code> version number as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     No errors or additional status information.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     Stream state is inconsistent or a parameter is invalid.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     No progress is possible due to insufficient buffer space or unexpected ending of an input stream.
    </span>
   </dd>
   ...
   <dd>
    <span class="simpara">
     <code class="literal">zlib</code> library version is incompatible with the version assumed by the caller.
    </span>
   </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzlib.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zlib.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zlib.constants.php">＋<small>add a note</small></a></span>
