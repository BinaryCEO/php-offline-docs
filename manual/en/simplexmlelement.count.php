...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/simplexmlelement.count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/simplexmlelement.count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/simplexmlelement.count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.simplexmlelement.php">
 <link rel="prev" href="https://www.php.net/manual/en/simplexmlelement.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/simplexmlelement.current.php">
...
<meta name="Description" content="Counts the children of an element" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SimpleXMLElement::count - Manual" />
<meta name="twitter:description" content="Counts the children of an element" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SimpleXMLElement::count - Manual" />
<meta itemprop="description" content="Counts the children of an element" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Counts the children of an element" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/simplexmlelement.count.php' selected="selected">English</option>
            <option value='de/simplexmlelement.count.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">SimpleXMLElement::count</span> &mdash; <span class="dc-title">Counts the children of an element</span></p>
...
Person 2 has got 5 children.</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-simplexmlelement.count-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="simplexmlelement.children.php" class="methodname" rel="rdfs-seeAlso">SimpleXMLElement::children()</a> - Finds children of given node</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/simplexml/simplexmlelement/count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsimplexmlelement.count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=simplexmlelement.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/simplexmlelement.count.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Alternative code for PHP &lt; 5.3:<br /><span class="default">&lt;?php<br />$count </span><span class="keyword">= </span><span class="default">$node</span><span class="keyword">-&gt;</span><span class="default">count</span><span class="keyword">(); </span><span class="comment">// PHP &gt; 5.3<br /></span><span class="default">$count </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$node</span><span class="keyword">-&gt;</span><span class="default">children</span><span class="keyword">()); </span><span class="comment">// PHP &lt; 5.3<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=simplexmlelement.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/simplexmlelement.count.php">＋<small>add a note</small></a></div>
