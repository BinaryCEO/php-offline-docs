...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::createClientEncryption - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.createclientencryption.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.createclientencryption.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.createclientencryption.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwrite.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.createclientencryption.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.createclientencryption.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.createclientencryption.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.createclientencryption.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.createclientencryption.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.createclientencryption.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.createclientencryption.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.createclientencryption.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.createclientencryption.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.createclientencryption.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.createclientencryption.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::createClientEncryption - Manual" />
<meta name="twitter:description" content="Create a new ClientEncryption object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::createClientEncryption - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-manager.executebulkwrite.php">
          MongoDB\Driver\Manager::executeBulkWrite &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.construct.php">
          &laquo; MongoDB\Driver\Manager::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.createclientencryption.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.createclientencryption.php'>German</option>
            <option value='es/mongodb-driver-manager.createclientencryption.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.createclientencryption.php'>French</option>
            <option value='it/mongodb-driver-manager.createclientencryption.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.createclientencryption.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.createclientencryption.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.createclientencryption.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.createclientencryption.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.createclientencryption.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.createclientencryption.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.createclientencryption" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/core/security-explicit-client-side-encryption/" class="link external">&raquo;&nbsp;Explicit (Manual) Client-Side Field Level Encryption</a> in the MongoDB manual</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/createclientencryption.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.createclientencryption%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.createclientencryption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.createclientencryption.php">＋<small>add a note</small></a></span>
