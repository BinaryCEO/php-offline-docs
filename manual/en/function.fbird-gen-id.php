...
<head>
  ...
  <title>PHP: fbird_gen_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-gen-id.php">
 <link rel="shorturl" href="https://www.php.net/fbird-gen-id">
 <link rel="alternate" href="https://www.php.net/fbird-gen-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-free-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-maintain-db.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-gen-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-gen-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-gen-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-gen-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-gen-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-gen-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-gen-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-gen-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-gen-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-gen-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-gen-id.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_gen_id" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_gen_id - Manual" />
<meta name="twitter:description" content="Alias of ibase_gen_id" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_gen_id - Manual" />
<meta itemprop="description" content="Alias of ibase_gen_id" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_gen_id" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-maintain-db.php">
          fbird_maintain_db &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-free-result.php">
          &laquo; fbird_free_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-gen-id.php' selected="selected">English</option>
            <option value='de/function.fbird-gen-id.php'>German</option>
            <option value='es/function.fbird-gen-id.php'>Spanish</option>
            <option value='fr/function.fbird-gen-id.php'>French</option>
            <option value='it/function.fbird-gen-id.php'>Italian</option>
            <option value='ja/function.fbird-gen-id.php'>Japanese</option>
            <option value='pt_BR/function.fbird-gen-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-gen-id.php'>Russian</option>
            <option value='tr/function.fbird-gen-id.php'>Turkish</option>
            <option value='uk/function.fbird-gen-id.php'>Ukrainian</option>
            <option value='zh/function.fbird-gen-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-gen-id" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_gen_id</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_gen_id</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-gen-id.php" class="function">ibase_gen_id()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-gen-id-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-gen-id.php" class="function">ibase_gen_id()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-gen-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-gen-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-gen-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-gen-id.php">＋<small>add a note</small></a></span>
