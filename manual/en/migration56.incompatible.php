...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration56.incompatible.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration56.incompatible.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration56.incompatible.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration56.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration56.php">
 <link rel="next" href="https://www.php.net/manual/en/migration56.new-features.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration56.incompatible.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration56.incompatible.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration56.incompatible.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration56.incompatible.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration56.incompatible.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration56.incompatible.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration56.incompatible.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration56.incompatible.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration56.incompatible.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration56.incompatible.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration56.incompatible.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration56.php">
          &laquo; Migrating from PHP 5.5.x to PHP 5.6.x        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration56.incompatible.php' selected="selected">English</option>
            <option value='de/migration56.incompatible.php'>German</option>
            <option value='es/migration56.incompatible.php'>Spanish</option>
            <option value='fr/migration56.incompatible.php'>French</option>
            <option value='it/migration56.incompatible.php'>Italian</option>
            <option value='ja/migration56.incompatible.php'>Japanese</option>
            <option value='pt_BR/migration56.incompatible.php'>Brazilian Portuguese</option>
            <option value='ru/migration56.incompatible.php'>Russian</option>
            <option value='tr/migration56.incompatible.php'>Turkish</option>
            <option value='uk/migration56.incompatible.php'>Ukrainian</option>
            <option value='zh/migration56.incompatible.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration56.incompatible" class="sect1">
  ...
  <p class="para">
   ...
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>. <span class="classname"><a href="class.curlfile.php" class="classname">CURLFile</a></span> should be used instead.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration56/incompatible.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration56.incompatible%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration56.incompatible&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration56.incompatible.php">＋<small>add a note</small></a></span>
