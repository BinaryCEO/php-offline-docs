...
<head>
  ...
  <title>PHP: Imagick::setImageDispose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagedispose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagedispose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedispose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagedepth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageextent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedispose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagedispose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagedispose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagedispose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagedispose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagedispose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagedispose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagedispose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagedispose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagedispose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagedispose.php" hreflang="zh">
...
<meta name="Description" content="Sets the image disposal method" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageDispose - Manual" />
<meta name="twitter:description" content="Sets the image disposal method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageDispose - Manual" />
<meta itemprop="description" content="Sets the image disposal method" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image disposal method" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageextent.php">
          Imagick::setImageExtent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagedepth.php">
          &laquo; Imagick::setImageDepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagedispose.php' selected="selected">English</option>
            <option value='de/imagick.setimagedispose.php'>German</option>
            <option value='es/imagick.setimagedispose.php'>Spanish</option>
            <option value='fr/imagick.setimagedispose.php'>French</option>
            <option value='it/imagick.setimagedispose.php'>Italian</option>
            <option value='ja/imagick.setimagedispose.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagedispose.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagedispose.php'>Russian</option>
            <option value='tr/imagick.setimagedispose.php'>Turkish</option>
            <option value='uk/imagick.setimagedispose.php'>Ukrainian</option>
            <option value='zh/imagick.setimagedispose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagedispose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageDispose</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageDispose</span> &mdash; <span class="dc-title">Sets the image disposal method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagedispose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageDispose</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$dispose</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagedispose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">dispose</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagedispose-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagedispose-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagedispose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagedispose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagedispose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagedispose.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="95701">  <div class="votes">
    <div id="Vu95701">
    <a href="/manual/vote-note.php?id=95701&amp;page=imagick.setimagedispose&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95701">
    <a href="/manual/vote-note.php?id=95701&amp;page=imagick.setimagedispose&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95701" title="100% like this...">
    1
    </div>
  </div>
  <a href="#95701" class="name">
  <strong class="user"><em>malou_pitawawa at hotmail dot com</em></strong></a><a class="genanchor" href="#95701"> &para;</a><div class="date" title="2010-01-16 04:00"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95701">
<div class="phpcode"><code><span class="html">The layer disposal method defines the way each the displayed image is to be modified after the current 'frame' of an animation has finished being displayed (after its 'delay' period), but before the next frame on an animation is to be overlaid onto the display.<br /><br />Value for $dispose:<br /><br />Undefined: 0 -&gt; No disposal specified (equivalent to 'none').<br />None: 1 -&gt; Do not dispose, just overlay next frame image.<br />Background: 2 -&gt; Clear the frame area with the background color.<br />Previous: 3 -&gt; Clear to the image prior to this frames overlay.<br /><br />from: <a href="http://www.imagemagick.org/script/command-line-options.php?#dispose" rel="nofollow" target="_blank">http://www.imagemagick.org/script/command-line-options.php?#dispose</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagedispose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagedispose.php">＋<small>add a note</small></a></div>
