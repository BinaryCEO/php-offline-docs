...
<head>
  ...
  <title>PHP: Imagick::textureImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.textureimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.textureimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.textureimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.swirlimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.thresholdimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.textureimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.textureimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.textureimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.textureimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.textureimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.textureimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.textureimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.textureimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.textureimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.textureimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.textureimage.php" hreflang="zh">
...
<meta name="Description" content="Repeatedly tiles the texture image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::textureImage - Manual" />
<meta name="twitter:description" content="Repeatedly tiles the texture image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::textureImage - Manual" />
<meta itemprop="description" content="Repeatedly tiles the texture image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Repeatedly tiles the texture image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.thresholdimage.php">
          Imagick::thresholdImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.swirlimage.php">
          &laquo; Imagick::swirlImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.textureimage.php' selected="selected">English</option>
            <option value='de/imagick.textureimage.php'>German</option>
            <option value='es/imagick.textureimage.php'>Spanish</option>
            <option value='fr/imagick.textureimage.php'>French</option>
            <option value='it/imagick.textureimage.php'>Italian</option>
            <option value='ja/imagick.textureimage.php'>Japanese</option>
            <option value='pt_BR/imagick.textureimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.textureimage.php'>Russian</option>
            <option value='tr/imagick.textureimage.php'>Turkish</option>
            <option value='uk/imagick.textureimage.php'>Ukrainian</option>
            <option value='zh/imagick.textureimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.textureimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::textureImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::textureImage</span> &mdash; <span class="dc-title">Repeatedly tiles the texture image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.textureimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">

   <span class="methodname"><strong>Imagick::textureImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$texture_wand</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.textureimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">texture_wand</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.textureimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.textureimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.textureimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3130">
      <p><strong>Example #1  <span class="function"><strong>Imagick::textureImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/textureimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.textureimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.textureimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.textureimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114121">  <div class="votes">
    <div id="Vu114121">
    <a href="/manual/vote-note.php?id=114121&amp;page=imagick.textureimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114121">
    <a href="/manual/vote-note.php?id=114121&amp;page=imagick.textureimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114121" title="87% like this...">
    6
    </div>
  </div>
  <a href="#114121" class="name">
  <strong class="user"><em>Dirk</em></strong></a><a class="genanchor" href="#114121"> &para;</a><div class="date" title="2014-01-13 03:56"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114121">
<div class="phpcode"><code><span class="html">This method doesn't actually return TRUE on success, it returns an Imagick with the texture applied, but the original Imagick object is not modified. As per the other examples on here, you need to use the result of textureImage call as your new tiled image.</span></code></div>
  </div>
 </div>
  <div class="note" id="99809">  <div class="votes">
    <div id="Vu99809">
    <a href="/manual/vote-note.php?id=99809&amp;page=imagick.textureimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99809">
    <a href="/manual/vote-note.php?id=99809&amp;page=imagick.textureimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99809" title="100% like this...">
    2
    </div>
  </div>
  <a href="#99809" class="name">
  <strong class="user"><em>truthseekercz at email dot cz</em></strong></a><a class="genanchor" href="#99809"> &para;</a><div class="date" title="2010-09-08 05:41"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99809">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">500</span><span class="keyword">, </span><span class="default">500</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'red'</span><span class="keyword">));<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br /></span><span class="default">$type</span><span class="keyword">=</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getFormat</span><span class="keyword">();<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-type: </span><span class="default">$type</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">$texture </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$texture</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'texture.png'</span><span class="keyword">);<br /></span><span class="default">$image </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">textureImage</span><span class="keyword">(</span><span class="default">$texture</span><span class="keyword">);<br /><br />echo </span><span class="default">$image</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;<br /></span><br />This works for me, however, I give no guarantees that the above example is the proper usage of this function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.textureimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.textureimage.php">＋<small>add a note</small></a></div>
