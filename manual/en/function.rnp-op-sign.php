...
<head>
  ...
  <title>PHP: rnp_op_sign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-op-sign.php">
 <link rel="shorturl" href="https://www.php.net/rnp-op-sign">
 <link rel="alternate" href="https://www.php.net/rnp-op-sign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-op-generate-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-op-sign-cleartext.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-op-sign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-op-sign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-op-sign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-op-sign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-op-sign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-op-sign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-op-sign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-op-sign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-op-sign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-op-sign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-op-sign.php" hreflang="zh">
...
<meta name="Description" content="Perform signing operation on a binary data, return embedded signature(s)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_op_sign - Manual" />
<meta name="twitter:description" content="Perform signing operation on a binary data, return embedded signature(s)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_op_sign - Manual" />
<meta itemprop="description" content="Perform signing operation on a binary data, return embedded signature(s)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform signing operation on a binary data, return embedded signature(s)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-op-sign-cleartext.php">
          rnp_op_sign_cleartext &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-op-generate-key.php">
          &laquo; rnp_op_generate_key        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-op-sign.php' selected="selected">English</option>
            <option value='de/function.rnp-op-sign.php'>German</option>
            <option value='es/function.rnp-op-sign.php'>Spanish</option>
            <option value='fr/function.rnp-op-sign.php'>French</option>
            <option value='it/function.rnp-op-sign.php'>Italian</option>
            <option value='ja/function.rnp-op-sign.php'>Japanese</option>
            <option value='pt_BR/function.rnp-op-sign.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-op-sign.php'>Russian</option>
            <option value='tr/function.rnp-op-sign.php'>Turkish</option>
            <option value='uk/function.rnp-op-sign.php'>Ukrainian</option>
            <option value='zh/function.rnp-op-sign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-op-sign" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">rnp_op_sign</h1>
  <p class="verinfo">(PECL rnp &gt;= 0.1.1)</p><p class="refpurpose"><span class="refname">rnp_op_sign</span> &mdash; <span class="dc-title">Perform signing operation on a binary data, return embedded signature(s)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.rnp-op-sign-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>rnp_op_sign</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.rnpffi.php" class="type RnpFFI">RnpFFI</a></span> <code class="parameter">$ffi</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$keys_fp</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$options</code><span class="initializer"> = ?</span></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.rnp-op-sign-parameters">
     ...
     <table class="doctable informaltable">
	   ...
	   must be set in order to enable data compression.
        ...
        <tr>
         ...
         <td>string</td>
         <td>Set input file name.Special value _CONSOLE may be used to mark message
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rnp-op-sign-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Data with embedded signature(s) on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-op-sign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-op-sign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-op-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-op-sign.php">＋<small>add a note</small></a></span>
