...
<head>
  ...
  <title>PHP: db2_columns - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-columns.php">
 <link rel="shorturl" href="https://www.php.net/db2-columns">
 <link rel="alternate" href="https://www.php.net/db2-columns" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-column-privileges.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-commit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-columns.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-columns.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-columns.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-columns.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-columns.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-columns.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-columns.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-columns.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-columns.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-columns.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-columns.php" hreflang="zh">
...
<meta name="Description" content="Returns a result set listing the columns and associated metadata for a table" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_columns - Manual" />
<meta name="twitter:description" content="Returns a result set listing the columns and associated metadata for a table" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_columns - Manual" />
<meta itemprop="description" content="Returns a result set listing the columns and associated metadata for a table" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the columns and associated metadata for a table" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-commit.php">
          db2_commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-column-privileges.php">
          &laquo; db2_column_privileges        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-columns.php' selected="selected">English</option>
            <option value='de/function.db2-columns.php'>German</option>
            <option value='es/function.db2-columns.php'>Spanish</option>
            <option value='fr/function.db2-columns.php'>French</option>
            <option value='it/function.db2-columns.php'>Italian</option>
            <option value='ja/function.db2-columns.php'>Japanese</option>
            <option value='pt_BR/function.db2-columns.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-columns.php'>Russian</option>
            <option value='tr/function.db2-columns.php'>Turkish</option>
            <option value='uk/function.db2-columns.php'>Ukrainian</option>
            <option value='zh/function.db2-columns.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-columns" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-tables.php" class="function" rel="rdfs-seeAlso">db2_tables()</a> - Returns a result set listing the tables and associated metadata in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-columns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-columns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-columns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-columns.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115801">  <div class="votes">
    <div id="Vu115801">
    <a href="/manual/vote-note.php?id=115801&amp;page=function.db2-columns&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115801">
    <a href="/manual/vote-note.php?id=115801&amp;page=function.db2-columns&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115801" title="no votes...">
    0
    </div>
  </div>
  <a href="#115801" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#115801"> &para;</a><div class="date" title="2014-09-25 10:22"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115801">
<div class="phpcode"><code><span class="html">As with previous message, passing null as the last param with db2_columns results in nothing being returned. Passing '%' instead works. The documentation really needs to be updated to correct this error as it's very misleading and was reported as wrong 8 years ago!</span></code></div>
  </div>
 </div>
  <div class="note" id="84932">  <div class="votes">
    <div id="Vu84932">
    <a href="/manual/vote-note.php?id=84932&amp;page=function.db2-columns&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd84932">
    <a href="/manual/vote-note.php?id=84932&amp;page=function.db2-columns&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V84932" title="no votes...">
    0
    </div>
  </div>
  <a href="#84932" class="name">
  <strong class="user"><em>david dot rekowski at gmx dot de</em></strong></a><a class="genanchor" href="#84932"> &para;</a><div class="date" title="2008-08-06 07:21"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom84932">
<div class="phpcode"><code><span class="html">must be
<br />db2_columns($conn, '', '%', $table, '%');
<br />
<br />Don't forget that table names are UPPERCASE. That gave me quite some headache.</span></code></div>
  </div>
 </div>
  <div class="note" id="69403">  <div class="votes">
    <div id="Vu69403">
    <a href="/manual/vote-note.php?id=69403&amp;page=function.db2-columns&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd69403">
    <a href="/manual/vote-note.php?id=69403&amp;page=function.db2-columns&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V69403" title="no votes...">
    0
    </div>
  </div>
  <a href="#69403" class="name">
  <strong class="user"><em>lada(at)hoidekr.net</em></strong></a><a class="genanchor" href="#69403"> &para;</a><div class="date" title="2006-09-04 11:48"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom69403">
<div class="phpcode"><code><span class="html">This is not true!<br />column-name<br />    The name of the column. To match all columns in the table, pass NULL or an empty string. <br /><br />You should pass '%' to match all columns</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-columns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-columns.php">＋<small>add a note</small></a></div>
