...
<head>
  ...
  <title>PHP: UI\Draw\Brush - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-brush.php">
 <link rel="shorturl" href="https://www.php.net/ui-draw-brush">
 <link rel="alternate" href="https://www.php.net/ui-draw-brush" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-draw-stroke.setthickness.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-draw-brush.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-draw-brush.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-draw-brush.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-draw-brush.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-draw-brush.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-draw-brush.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-draw-brush.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-draw-brush.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-draw-brush.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-draw-brush.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-draw-brush.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-draw-brush.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: UI\Draw\Brush - Manual" />
<meta name="twitter:description" content="Brushes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Brush - Manual" />
<meta itemprop="description" content="Brushes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Brushes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-draw-brush.construct.php">
          UI\Draw\Brush::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-draw-stroke.setthickness.php">
          &laquo; UI\Draw\Stroke::setThickness        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-brush.php' selected="selected">English</option>
            <option value='de/class.ui-draw-brush.php'>German</option>
            <option value='es/class.ui-draw-brush.php'>Spanish</option>
            <option value='fr/class.ui-draw-brush.php'>French</option>
            <option value='it/class.ui-draw-brush.php'>Italian</option>
            <option value='ja/class.ui-draw-brush.php'>Japanese</option>
            <option value='pt_BR/class.ui-draw-brush.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-draw-brush.php'>Russian</option>
            <option value='tr/class.ui-draw-brush.php'>Turkish</option>
            <option value='uk/class.ui-draw-brush.php'>Ukrainian</option>
            <option value='zh/class.ui-draw-brush.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-draw-brush" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(UI 0.9.9)</p>
  ...
  <div class="section" id="ui-draw-brush.intro">
  ...
  <div class="section" id="ui-draw-brush.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">UI\Draw\Brush</strong>
     </span>
     {</div>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="ui-draw-brush.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="class.ui-draw-color.php" class="type UI\Draw\Color">UI\Draw\Color</a></span> <code class="parameter">$color</code></span>)</div>
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-draw-brush.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$color</code></span>)</div>

    
    <div class="classsynopsisinfo classsynopsisinfo_comment">/* Methods */</div>
    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-draw-brush.getcolor.php" class="methodname">getColor</a></span>(): <span class="type"><a href="class.ui-draw-color.php" class="type UI\Draw\Color">UI\Draw\Color</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="ui-draw-brush.setcolor.php" class="methodname">setColor</a></span>(<span class="methodparam"><span class="type"><a href="class.ui-draw-color.php" class="type UI\Draw\Color">UI\Draw\Color</a></span> <code class="parameter">$color</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-draw-brush.construct.php">UI\Draw\Brush::__construct</a> — Construct a new Brush</li><li><a href="ui-draw-brush.getcolor.php">UI\Draw\Brush::getColor</a> — Get Color</li><li><a href="ui-draw-brush.setcolor.php">UI\Draw\Brush::setColor</a> — Set Color</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.brush.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-brush%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-brush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-brush.php">＋<small>add a note</small></a></span>
