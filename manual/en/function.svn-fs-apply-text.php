...
<head>
  ...
  <title>PHP: svn_fs_apply_text - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-fs-apply-text.php">
 <link rel="shorturl" href="https://www.php.net/svn-fs-apply-text">
 <link rel="alternate" href="https://www.php.net/svn-fs-apply-text" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-fs-abort-txn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-fs-begin-txn2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-fs-apply-text.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-fs-apply-text.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-fs-apply-text.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-fs-apply-text.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-fs-apply-text.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-fs-apply-text.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-fs-apply-text.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-fs-apply-text.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-fs-apply-text.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-fs-apply-text.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-fs-apply-text.php" hreflang="zh">
...
<meta name="Description" content="Creates and returns a stream that will be used to replace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_fs_apply_text - Manual" />
<meta name="twitter:description" content="Creates and returns a stream that will be used to replace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_fs_apply_text - Manual" />
<meta itemprop="description" content="Creates and returns a stream that will be used to replace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates and returns a stream that will be used to replace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-fs-begin-txn2.php">
          svn_fs_begin_txn2 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-fs-abort-txn.php">
          &laquo; svn_fs_abort_txn        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-fs-apply-text.php' selected="selected">English</option>
            <option value='de/function.svn-fs-apply-text.php'>German</option>
            <option value='es/function.svn-fs-apply-text.php'>Spanish</option>
            <option value='fr/function.svn-fs-apply-text.php'>French</option>
            <option value='it/function.svn-fs-apply-text.php'>Italian</option>
            <option value='ja/function.svn-fs-apply-text.php'>Japanese</option>
            <option value='pt_BR/function.svn-fs-apply-text.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-fs-apply-text.php'>Russian</option>
            <option value='tr/function.svn-fs-apply-text.php'>Turkish</option>
            <option value='uk/function.svn-fs-apply-text.php'>Ukrainian</option>
            <option value='zh/function.svn-fs-apply-text.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-fs-apply-text" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_fs_apply_text</h1>
  <p class="verinfo">(PECL svn &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">svn_fs_apply_text</span> &mdash; <span class="dc-title">Creates and returns a stream that will be used to replace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-fs-apply-text-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_fs_apply_text</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$root</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-fs-apply-text-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-fs-apply-text.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-fs-apply-text%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-fs-apply-text&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-fs-apply-text.php">＋<small>add a note</small></a></span>
