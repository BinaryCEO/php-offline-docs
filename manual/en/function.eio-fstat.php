...
<head>
  ...
  <title>PHP: eio_fstat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-fstat.php">
 <link rel="shorturl" href="https://www.php.net/eio-fstat">
 <link rel="alternate" href="https://www.php.net/eio-fstat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-fdatasync.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-fstatvfs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-fstat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-fstat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-fstat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-fstat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-fstat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-fstat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-fstat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-fstat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-fstat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-fstat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-fstat.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_fstat - Manual" />
<meta name="twitter:description" content="Get file status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_fstat - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-fstat.php' selected="selected">English</option>
            <option value='de/function.eio-fstat.php'>German</option>
            <option value='es/function.eio-fstat.php'>Spanish</option>
            <option value='fr/function.eio-fstat.php'>French</option>
            <option value='it/function.eio-fstat.php'>Italian</option>
            <option value='ja/function.eio-fstat.php'>Japanese</option>
            <option value='pt_BR/function.eio-fstat.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-fstat.php'>Russian</option>
            <option value='tr/function.eio-fstat.php'>Turkish</option>
            <option value='uk/function.eio-fstat.php'>Ukrainian</option>
            <option value='zh/function.eio-fstat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-fstat" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-fstat-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_fstat</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.eio-fstat-examples">
  ...
  <div class="example" id="example-3510">
   <p><strong>Example #1 <span class="function"><a href="function.eio-lstat.php" class="function">eio_lstat()</a></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">array(12) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-fstat-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-stat.php" class="function" rel="rdfs-seeAlso">eio_stat()</a> - Get file status</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-fstat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-fstat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-fstat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-fstat.php">＋<small>add a note</small></a></span>
