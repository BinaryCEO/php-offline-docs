...
<head>
  ...
  <title>PHP: ReflectionMethod::getPrototype - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionmethod.getprototype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionmethod.getprototype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.getprototype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionmethod.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionmethod.getmodifiers.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionmethod.hasprototype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.getprototype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionmethod.getprototype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionmethod.getprototype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionmethod.getprototype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionmethod.getprototype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionmethod.getprototype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionmethod.getprototype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionmethod.getprototype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionmethod.getprototype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionmethod.getprototype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionmethod.getprototype.php" hreflang="zh">
...
<meta name="Description" content="Gets the method prototype (if there is one)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionMethod::getPrototype - Manual" />
<meta name="twitter:description" content="Gets the method prototype (if there is one)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionMethod::getPrototype - Manual" />
<meta itemprop="description" content="Gets the method prototype (if there is one)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the method prototype (if there is one)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionmethod.hasprototype.php">
          ReflectionMethod::hasPrototype &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionmethod.getmodifiers.php">
          &laquo; ReflectionMethod::getModifiers        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionmethod.getprototype.php' selected="selected">English</option>
            <option value='de/reflectionmethod.getprototype.php'>German</option>
            <option value='es/reflectionmethod.getprototype.php'>Spanish</option>
            <option value='fr/reflectionmethod.getprototype.php'>French</option>
            <option value='it/reflectionmethod.getprototype.php'>Italian</option>
            <option value='ja/reflectionmethod.getprototype.php'>Japanese</option>
            <option value='pt_BR/reflectionmethod.getprototype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionmethod.getprototype.php'>Russian</option>
            <option value='tr/reflectionmethod.getprototype.php'>Turkish</option>
            <option value='uk/reflectionmethod.getprototype.php'>Ukrainian</option>
            <option value='zh/reflectionmethod.getprototype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionmethod.getprototype" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionmethod.hasprototype.php" class="methodname" rel="rdfs-seeAlso">ReflectionMethod::hasPrototype()</a> - Returns whether a method has a prototype</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionmethod/getprototype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionmethod.getprototype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionmethod.getprototype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionmethod.getprototype.php">＋<small>add a note</small></a></span>
