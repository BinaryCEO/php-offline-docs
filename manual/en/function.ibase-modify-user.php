...
<head>
  ...
  <title>PHP: ibase_modify_user - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-modify-user.php">
 <link rel="shorturl" href="https://www.php.net/ibase-modify-user">
 <link rel="alternate" href="https://www.php.net/ibase-modify-user" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-maintain-db.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-name-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-modify-user.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-modify-user.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-modify-user.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-modify-user.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-modify-user.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-modify-user.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-modify-user.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-modify-user.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-modify-user.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-modify-user.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-modify-user.php" hreflang="zh">
...
<meta name="Description" content="Modify a user to a security database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_modify_user - Manual" />
<meta name="twitter:description" content="Modify a user to a security database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_modify_user - Manual" />
<meta itemprop="description" content="Modify a user to a security database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Modify a user to a security database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-name-result.php">
          ibase_name_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-maintain-db.php">
          &laquo; ibase_maintain_db        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-modify-user.php' selected="selected">English</option>
            <option value='de/function.ibase-modify-user.php'>German</option>
            <option value='es/function.ibase-modify-user.php'>Spanish</option>
            <option value='fr/function.ibase-modify-user.php'>French</option>
            <option value='it/function.ibase-modify-user.php'>Italian</option>
            <option value='ja/function.ibase-modify-user.php'>Japanese</option>
            <option value='pt_BR/function.ibase-modify-user.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-modify-user.php'>Russian</option>
            <option value='tr/function.ibase-modify-user.php'>Turkish</option>
            <option value='uk/function.ibase-modify-user.php'>Ukrainian</option>
            <option value='zh/function.ibase-modify-user.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-modify-user" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_modify_user</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_modify_user</span> &mdash; <span class="dc-title">Modify a user to a security database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-modify-user-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_modify_user</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$user_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$password</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$first_name</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$middle_name</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$last_name</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-modify-user-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">user_name</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">first_name</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">middle_name</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">last_name</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-modify-user-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-modify-user-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-add-user.php" class="function" rel="rdfs-seeAlso">ibase_add_user()</a> - Add a user to a security database</span></li>
    <li><span class="function"><a href="function.ibase-delete-user.php" class="function" rel="rdfs-seeAlso">ibase_delete_user()</a> - Delete a user from a security database</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-modify-user.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-modify-user%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-modify-user&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-modify-user.php">＋<small>add a note</small></a></span>
