...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.charmirror.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.charmirror.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.charmirror.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.charfromname.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.charname.php">
...
<meta name="Description" content="Get the &quot;mirror-image&quot; character for a code point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::charMirror - Manual" />
<meta name="twitter:description" content="Get the &quot;mirror-image&quot; character for a code point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::charMirror - Manual" />
<meta itemprop="description" content="Get the &quot;mirror-image&quot; character for a code point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the &quot;mirror-image&quot; character for a code point" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.charmirror.php' selected="selected">English</option>
            ...
            <option value='ru/intlchar.charmirror.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::charMirror</span> &mdash; <span class="dc-title">Get the &quot;mirror-image&quot; character for a code point</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.charmirror-description">
  ...
  <p class="para">
   For characters with the <em>Bidi_Mirrored</em> property, implementations sometimes need a &quot;poor man&#039;s&quot; mapping to another
   Unicode character (code point) such that the default glyph may serve as the mirror-image of the default glyph of the
   specified character. This is useful for text conversion to and from codepages with visual order, and for displays
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.charmirror-returnvalues">
  ...
  <p class="para">
   Returns another Unicode code point that may serve as a mirror-image substitute, or <code class="parameter">codepoint</code>
   itself if there is no such mapping or <code class="parameter">codepoint</code> does not have the
   <em>Bidi_Mirrored</em> property.
  </p>
...
string(2) &quot;)&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.charmirror-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="intlchar.ismirrored.php" class="function" rel="rdfs-seeAlso">IntlChar::isMirrored()</a> - Check if code point has the Bidi_Mirrored property</span></li>
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-bidi-mirrored">IntlChar::PROPERTY_BIDI_MIRRORED</a></code></strong></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/charmirror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.charmirror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.charmirror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.charmirror.php">＋<small>add a note</small></a></span>
