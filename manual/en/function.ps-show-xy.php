...
<head>
  ...
  <title>PHP: ps_show_xy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-show-xy.php">
 <link rel="shorturl" href="https://www.php.net/ps-show-xy">
 <link rel="alternate" href="https://www.php.net/ps-show-xy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-show-boxed.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-show-xy2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-show-xy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-show-xy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-show-xy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-show-xy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-show-xy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-show-xy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-show-xy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-show-xy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-show-xy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-show-xy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-show-xy.php" hreflang="zh">
...
<meta name="Description" content="Output text at given position" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_show_xy - Manual" />
<meta name="twitter:description" content="Output text at given position" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_show_xy - Manual" />
<meta itemprop="description" content="Output text at given position" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output text at given position" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-show-xy.php' selected="selected">English</option>
            <option value='de/function.ps-show-xy.php'>German</option>
            <option value='es/function.ps-show-xy.php'>Spanish</option>
            <option value='fr/function.ps-show-xy.php'>French</option>
            <option value='it/function.ps-show-xy.php'>Italian</option>
            <option value='ja/function.ps-show-xy.php'>Japanese</option>
            <option value='pt_BR/function.ps-show-xy.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-show-xy.php'>Russian</option>
            <option value='tr/function.ps-show-xy.php'>Turkish</option>
            <option value='uk/function.ps-show-xy.php'>Ukrainian</option>
            <option value='zh/function.ps-show-xy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-show-xy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_show_xy</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_show_xy</span> &mdash; <span class="dc-title">Output text at given position</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-show-xy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_show_xy</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$text</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-show-xy-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-show-xy-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-show-xy-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-show.php" class="function" rel="rdfs-seeAlso">ps_show()</a> - Output text</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-show-xy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-show-xy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-show-xy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-show-xy.php">＋<small>add a note</small></a></span>
