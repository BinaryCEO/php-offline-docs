...
<head>
  ...
  <title>PHP: sodium_crypto_generichash_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-init.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-generichash-init">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-generichash-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-final.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-generichash-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-generichash-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-generichash-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-generichash-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-generichash-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-generichash-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-generichash-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-generichash-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-generichash-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-generichash-init.php" hreflang="zh">
...
<meta name="Description" content="Initialize a hash for streaming" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_generichash_init - Manual" />
<meta name="twitter:description" content="Initialize a hash for streaming" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_generichash_init - Manual" />
<meta itemprop="description" content="Initialize a hash for streaming" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize a hash for streaming" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-generichash-keygen.php">
          sodium_crypto_generichash_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-generichash-final.php">
          &laquo; sodium_crypto_generichash_final        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-generichash-init.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-generichash-init.php'>German</option>
            <option value='es/function.sodium-crypto-generichash-init.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-generichash-init.php'>French</option>
            <option value='it/function.sodium-crypto-generichash-init.php'>Italian</option>
            <option value='ja/function.sodium-crypto-generichash-init.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-generichash-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-generichash-init.php'>Russian</option>
            <option value='tr/function.sodium-crypto-generichash-init.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-generichash-init.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-generichash-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-generichash-init" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_generichash_init</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_generichash_init</span> &mdash; <span class="dc-title">Initialize a hash for streaming</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-generichash-init-examples">
  ...
  <div class="example" id="sodium-crypto-generichash-init.example.basic">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_generichash_init()</strong></span> example</strong></p>
...
string(64) &quot;a2939a9163cb7c796ec28e01028489e72475c136b2697ea59e3e760ab4a8ab20&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-generichash-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-generichash-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-generichash-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-generichash-init.php">＋<small>add a note</small></a></span>
