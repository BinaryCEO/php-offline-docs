...
<head>
  ...
  <title>PHP: EventHttp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.eventhttp.php">
 <link rel="shorturl" href="https://www.php.net/eventhttp">
 <link rel="alternate" href="https://www.php.net/eventhttp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventdnsbase.setsearchndots.php">
 <link rel="next" href="https://www.php.net/manual/en/eventhttp.accept.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.eventhttp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.eventhttp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.eventhttp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.eventhttp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.eventhttp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.eventhttp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.eventhttp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.eventhttp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.eventhttp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.eventhttp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.eventhttp.php" hreflang="zh">
...
<meta name="Description" content="The EventHttp class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttp - Manual" />
<meta name="twitter:description" content="The EventHttp class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttp - Manual" />
<meta itemprop="description" content="The EventHttp class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EventHttp class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventhttp.accept.php">
          EventHttp::accept &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventdnsbase.setsearchndots.php">
          &laquo; EventDnsBase::setSearchNdots        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.eventhttp.php' selected="selected">English</option>
            <option value='de/class.eventhttp.php'>German</option>
            <option value='es/class.eventhttp.php'>Spanish</option>
            <option value='fr/class.eventhttp.php'>French</option>
            <option value='it/class.eventhttp.php'>Italian</option>
            <option value='ja/class.eventhttp.php'>Japanese</option>
            <option value='pt_BR/class.eventhttp.php'>Brazilian Portuguese</option>
            <option value='ru/class.eventhttp.php'>Russian</option>
            <option value='tr/class.eventhttp.php'>Turkish</option>
            <option value='uk/class.eventhttp.php'>Ukrainian</option>
            <option value='zh/class.eventhttp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.eventhttp" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="eventhttp.accept.php">EventHttp::accept</a> — Makes an HTTP server accept connections on the specified socket stream or resource</li><li><a href="eventhttp.addserveralias.php">EventHttp::addServerAlias</a> — Adds a server alias to the HTTP server object</li><li><a href="eventhttp.bind.php">EventHttp::bind</a> — Binds an HTTP server on the specified address and port</li><li><a href="eventhttp.construct.php">EventHttp::__construct</a> — Constructs EventHttp object (the HTTP server)</li><li><a href="eventhttp.removeserveralias.php">EventHttp::removeServerAlias</a> — Removes server alias</li><li><a href="eventhttp.setallowedmethods.php">EventHttp::setAllowedMethods</a> — Sets the what HTTP methods are supported in requests accepted by this server, and passed to user callbacks</li><li><a href="eventhttp.setcallback.php">EventHttp::setCallback</a> — Sets a callback for specified URI</li><li><a href="eventhttp.setdefaultcallback.php">EventHttp::setDefaultCallback</a> — Sets default callback to handle requests that are not caught by specific callbacks</li><li><a href="eventhttp.setmaxbodysize.php">EventHttp::setMaxBodySize</a> — Sets maximum request body size</li><li><a href="eventhttp.setmaxheaderssize.php">EventHttp::setMaxHeadersSize</a> — Sets maximum HTTP header size</li><li><a href="eventhttp.settimeout.php">EventHttp::setTimeout</a> — Sets the timeout for an HTTP request</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.eventhttp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.eventhttp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.eventhttp.php">＋<small>add a note</small></a></span>
