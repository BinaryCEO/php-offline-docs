...
<head>
  ...
  <title>PHP: SolrQuery::getFacetMissing - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetmissing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetmissing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetmissing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetmincount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetmissing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetmissing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetmissing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetmissing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetmissing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetmissing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetmissing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetmissing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetmissing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetmissing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetmissing.php" hreflang="zh">
...
<meta name="Description" content="Returns the current state of the facet.missing parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetMissing - Manual" />
<meta name="twitter:description" content="Returns the current state of the facet.missing parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetMissing - Manual" />
<meta itemprop="description" content="Returns the current state of the facet.missing parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the current state of the facet.missing parameter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfacetoffset.php">
          SolrQuery::getFacetOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetmincount.php">
          &laquo; SolrQuery::getFacetMinCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetmissing.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetmissing.php'>German</option>
            <option value='es/solrquery.getfacetmissing.php'>Spanish</option>
            <option value='fr/solrquery.getfacetmissing.php'>French</option>
            <option value='it/solrquery.getfacetmissing.php'>Italian</option>
            <option value='ja/solrquery.getfacetmissing.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetmissing.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetmissing.php'>Russian</option>
            <option value='tr/solrquery.getfacetmissing.php'>Turkish</option>
            <option value='uk/solrquery.getfacetmissing.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetmissing.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetmissing" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetMissing</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetMissing</span> &mdash; <span class="dc-title">Returns the current state of the facet.missing parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetmissing-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetMissing</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetmissing-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetmissing-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetmissing.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetmissing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetmissing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetmissing.php">＋<small>add a note</small></a></span>
