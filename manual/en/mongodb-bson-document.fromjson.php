...
<head>
  ...
  <title>PHP: MongoDB\BSON\Document::fromJSON - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-bson-document.fromjson.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-bson-document.fromjson.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-document.fromjson.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-bson-document.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-document.frombson.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-document.fromphp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-document.fromjson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-bson-document.fromjson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-bson-document.fromjson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-bson-document.fromjson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-bson-document.fromjson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-bson-document.fromjson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-bson-document.fromjson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-bson-document.fromjson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-bson-document.fromjson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-bson-document.fromjson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-bson-document.fromjson.php" hreflang="zh">
...
<meta name="Description" content="Construct a new document instance from a JSON string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Document::fromJSON - Manual" />
<meta name="twitter:description" content="Construct a new document instance from a JSON string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Document::fromJSON - Manual" />
<meta itemprop="description" content="Construct a new document instance from a JSON string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a new document instance from a JSON string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-document.fromphp.php">
          MongoDB\BSON\Document::fromPHP &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-document.frombson.php">
          &laquo; MongoDB\BSON\Document::fromBSON        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-bson-document.fromjson.php' selected="selected">English</option>
            <option value='de/mongodb-bson-document.fromjson.php'>German</option>
            <option value='es/mongodb-bson-document.fromjson.php'>Spanish</option>
            <option value='fr/mongodb-bson-document.fromjson.php'>French</option>
            <option value='it/mongodb-bson-document.fromjson.php'>Italian</option>
            <option value='ja/mongodb-bson-document.fromjson.php'>Japanese</option>
            <option value='pt_BR/mongodb-bson-document.fromjson.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-bson-document.fromjson.php'>Russian</option>
            <option value='tr/mongodb-bson-document.fromjson.php'>Turkish</option>
            <option value='uk/mongodb-bson-document.fromjson.php'>Ukrainian</option>
            <option value='zh/mongodb-bson-document.fromjson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-bson-document.fromjson" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;BSON Types</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/document/fromjson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-bson-document.fromjson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-bson-document.fromjson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-bson-document.fromjson.php">＋<small>add a note</small></a></span>
