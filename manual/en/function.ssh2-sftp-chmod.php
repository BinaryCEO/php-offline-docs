...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-sftp-chmod.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-sftp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-sftp-lstat.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-sftp-chmod.php' selected="selected">English</option>
            <option value='de/function.ssh2-sftp-chmod.php'>German</option>
            <option value='es/function.ssh2-sftp-chmod.php'>Spanish</option>
            <option value='fr/function.ssh2-sftp-chmod.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL ssh2 &gt;= 0.12)</p><p class="refpurpose"><span class="refname">ssh2_sftp_chmod</span> &mdash; <span class="dc-title">Changes file mode</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ssh2-sftp-chmod-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Permissions on the file. See the <span class="function"><a href="function.chmod.php" class="function">chmod()</a></span> for more details on this parameter.
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ssh2-sftp-chmod-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-sftp.php" class="function" rel="rdfs-seeAlso">ssh2_sftp()</a> - Initialize SFTP subsystem</span></li>
    <li><span class="function"><a href="function.ssh2-connect.php" class="function" rel="rdfs-seeAlso">ssh2_connect()</a> - Connect to an SSH server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-sftp-chmod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-sftp-chmod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-sftp-chmod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-sftp-chmod.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>boris at brdaric dot com</em></strong></a><a class="genanchor" href="#124624"> &para;</a><div class="date" title="2020-01-17 09:40"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124624">
<div class="phpcode"><code><span class="html">It seems that when creating directory using this function, permissions are affected by the system umask setting.<br /><br />If you want to make sure proper permissions are set, after creating directory, set permissions by using ssh2_​sftp_​chmod function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ssh2-sftp-chmod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-sftp-chmod.php">＋<small>add a note</small></a></div>
