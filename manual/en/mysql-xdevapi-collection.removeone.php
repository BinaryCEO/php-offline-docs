...
<head>
  ...
  <title>PHP: Collection::removeOne - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collection.removeone.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collection.removeone.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.removeone.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collection.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collection.remove.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collection.replaceone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collection.removeone.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi-collection.removeone.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi-collection.removeone.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi-collection.removeone.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi-collection.removeone.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi-collection.removeone.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi-collection.removeone.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi-collection.removeone.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi-collection.removeone.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi-collection.removeone.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi-collection.removeone.php" hreflang="zh">
...
<meta name="Description" content="Remove one collection document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collection::removeOne - Manual" />
<meta name="twitter:description" content="Remove one collection document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collection::removeOne - Manual" />
<meta itemprop="description" content="Remove one collection document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove one collection document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi-collection.replaceone.php">
          Collection::replaceOne &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysql-xdevapi-collection.remove.php">
          &laquo; Collection::remove        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collection.removeone.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi-collection.removeone.php'>German</option>
            <option value='es/mysql-xdevapi-collection.removeone.php'>Spanish</option>
            <option value='fr/mysql-xdevapi-collection.removeone.php'>French</option>
            <option value='it/mysql-xdevapi-collection.removeone.php'>Italian</option>
            <option value='ja/mysql-xdevapi-collection.removeone.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi-collection.removeone.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi-collection.removeone.php'>Russian</option>
            <option value='tr/mysql-xdevapi-collection.removeone.php'>Turkish</option>
            <option value='uk/mysql-xdevapi-collection.removeone.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi-collection.removeone.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi-collection.removeone" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mysql-xdevapi-collection.removeone-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>mysql_xdevapi\Collection::removeOne</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$id</code></span>): <span class="type"><a href="class.mysql-xdevapi-result.php" class="type mysql_xdevapi\Result">mysql_xdevapi\Result</a></span></div>
...
<div class="examplescode"><pre class="examplescode">Goodbye, Alfred, you can take _id 00005b6b536100000000000000cb with you.</pre>
</div>
   </div>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collection/removeone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collection.removeone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collection.removeone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collection.removeone.php">＋<small>add a note</small></a></span>
