...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql.installation.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql.installation.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql.installation.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysql.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql.requirements.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql.configuration.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql.installation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql.installation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql.installation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql.installation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql.installation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql.installation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql.installation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql.installation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql.installation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql.installation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql.installation.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql.installation.php' selected="selected">English</option>
            <option value='de/mysql.installation.php'>German</option>
            <option value='es/mysql.installation.php'>Spanish</option>
            <option value='fr/mysql.installation.php'>French</option>
            <option value='it/mysql.installation.php'>Italian</option>
            <option value='ja/mysql.installation.php'>Japanese</option>
            <option value='pt_BR/mysql.installation.php'>Brazilian Portuguese</option>
            <option value='ru/mysql.installation.php'>Russian</option>
            <option value='tr/mysql.installation.php'>Turkish</option>
            <option value='uk/mysql.installation.php'>Ukrainian</option>
            <option value='zh/mysql.installation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql.installation" class="section">
   ...
   <caption><strong>ext/mysql compile time support matrix</strong></caption>
    ...
    <thead>
     <tr>
      <th>PHP Version</th>
      <th>Default</th>
      <th>Configure Options: <a href="mysqlnd.overview.php" class="link">mysqlnd</a></th>
      <th>Configure Options: <code class="literal">libmysqlclient</code></th>
      <th>Changelog</th>
     </tr>
    ...
    <p class="para">
     ...
     support. 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/configure.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql.installation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql.installation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql.installation.php">＋<small>add a note</small></a></span>
