...
<head>
  ...
  <title>PHP: Imagick::smushImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.smushimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.smushimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.smushimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.sketchimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.solarizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.smushimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.smushimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.smushimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.smushimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.smushimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.smushimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.smushimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.smushimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.smushimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.smushimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.smushimages.php" hreflang="zh">
...
<meta name="Description" content="Takes all images from the current image pointer to the end of the image list and smushs them" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::smushImages - Manual" />
<meta name="twitter:description" content="Takes all images from the current image pointer to the end of the image list and smushs them" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::smushImages - Manual" />
<meta itemprop="description" content="Takes all images from the current image pointer to the end of the image list and smushs them" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Takes all images from the current image pointer to the end of the image list and smushs them" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.solarizeimage.php">
          Imagick::solarizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.sketchimage.php">
          &laquo; Imagick::sketchImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.smushimages.php' selected="selected">English</option>
            <option value='de/imagick.smushimages.php'>German</option>
            <option value='es/imagick.smushimages.php'>Spanish</option>
            <option value='fr/imagick.smushimages.php'>French</option>
            <option value='it/imagick.smushimages.php'>Italian</option>
            <option value='ja/imagick.smushimages.php'>Japanese</option>
            <option value='pt_BR/imagick.smushimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.smushimages.php'>Russian</option>
            <option value='tr/imagick.smushimages.php'>Turkish</option>
            <option value='uk/imagick.smushimages.php'>Ukrainian</option>
            <option value='zh/imagick.smushimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.smushimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::smushImages</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::smushImages</span> &mdash; <span class="dc-title">Takes all images from the current image pointer to the end of the image list and smushs them</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.smushimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::smushImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$stack</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.smushimages-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.smushimages-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3117">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/smushimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.smushimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.smushimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.smushimages.php">＋<small>add a note</small></a></span>
