...
<head>
  ...
  <title>PHP: mysql_field_len - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-len.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-len">
 <link rel="alternate" href="https://www.php.net/mysql-field-len" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-flags.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-len.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-len.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-len.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-len.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-len.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-len.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-len.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-len.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-len.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-len.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-len.php" hreflang="zh">
...
<meta name="Description" content="Returns the length of the specified field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_field_len - Manual" />
<meta name="twitter:description" content="Returns the length of the specified field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_len - Manual" />
<meta itemprop="description" content="Returns the length of the specified field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the length of the specified field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-field-name.php">
          mysql_field_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-flags.php">
          &laquo; mysql_field_flags        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-len.php' selected="selected">English</option>
            <option value='de/function.mysql-field-len.php'>German</option>
            <option value='es/function.mysql-field-len.php'>Spanish</option>
            <option value='fr/function.mysql-field-len.php'>French</option>
            <option value='it/function.mysql-field-len.php'>Italian</option>
            <option value='ja/function.mysql-field-len.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-len.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-len.php'>Russian</option>
            <option value='tr/function.mysql-field-len.php'>Turkish</option>
            <option value='uk/function.mysql-field-len.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-len.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-len" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_field_len</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_field_len</span> &mdash; <span class="dc-title">Returns the length of the specified field</span></p>

 </div>

 <div id="function.mysql-field-len-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.fetch-field-direct.php" class="function">mysqli_fetch_field_direct()</a></span> [length]</li>
    <li><span class="methodname"><a href="pdostatement.getcolumnmeta.php" class="methodname">PDOStatement::getColumnMeta()</a></span> [len]</li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-field-len-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_field_len</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field_offset</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_field_len()</strong></span> returns the length of the
   specified field.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mysql-field-len-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> is also issued.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-field-len-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The length of the specified field index on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.mysql-field-len-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1900">
    <p><strong>Example #1 <span class="function"><strong>mysql_field_len()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT id,email FROM people WHERE id = '42'"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">'Could not run query: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">();<br />    exit;<br />}<br /><br /></span><span style="color: #FF8000">// Will get the length of the id field as specified in the database<br />// schema. <br /></span><span style="color: #0000BB">$length </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_field_len</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$length</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-field-len-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    For backward compatibility, the following
deprecated alias may be used: 
    <span class="function"><strong>mysql_fieldlen()</strong></span>
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.mysql-field-len-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-fetch-lengths.php" class="function" rel="rdfs-seeAlso">mysql_fetch_lengths()</a> - Get the length of each output in a result</span></li>
    <li><span class="function"><a href="function.strlen.php" class="function" rel="rdfs-seeAlso">strlen()</a> - Get string length</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-len.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-len%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-len&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-len.php">＋<small>add a note</small></a></span>
