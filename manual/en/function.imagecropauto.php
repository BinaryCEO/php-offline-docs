...
<head>
  ...
  <title>PHP: imagecropauto - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecropauto.php">
 <link rel="shorturl" href="https://www.php.net/imagecropauto">
 <link rel="alternate" href="https://www.php.net/imagecropauto" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecrop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagedashedline.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecropauto.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecropauto.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecropauto.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecropauto.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecropauto.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecropauto.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecropauto.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecropauto.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecropauto.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecropauto.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecropauto.php" hreflang="zh">
...
<meta name="Description" content="Crop an image automatically using one of the available modes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecropauto - Manual" />
<meta name="twitter:description" content="Crop an image automatically using one of the available modes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecropauto - Manual" />
<meta itemprop="description" content="Crop an image automatically using one of the available modes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Crop an image automatically using one of the available modes" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecropauto.php' selected="selected">English</option>
            <option value='de/function.imagecropauto.php'>German</option>
            <option value='es/function.imagecropauto.php'>Spanish</option>
            <option value='fr/function.imagecropauto.php'>French</option>
            <option value='it/function.imagecropauto.php'>Italian</option>
            <option value='ja/function.imagecropauto.php'>Japanese</option>
            <option value='pt_BR/function.imagecropauto.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecropauto.php'>Russian</option>
            <option value='tr/function.imagecropauto.php'>Turkish</option>
            <option value='uk/function.imagecropauto.php'>Ukrainian</option>
            <option value='zh/function.imagecropauto.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecropauto" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecropauto</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecropauto</span> &mdash; <span class="dc-title">Crop an image automatically using one of the available modes</span></p>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
    ...
    <dd>
     ...
     <dl>
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-default">IMG_CROP_DEFAULT</a></code></strong></dt>
       <dd>
        <span class="simpara">
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-transparent">IMG_CROP_TRANSPARENT</a></code></strong></dt>
       <dd>
        <span class="simpara">
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-black">IMG_CROP_BLACK</a></code></strong></dt>
       <dd>
        <span class="simpara">
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-white">IMG_CROP_WHITE</a></code></strong></dt>
       <dd>
        <span class="simpara">
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-sides">IMG_CROP_SIDES</a></code></strong></dt>
       <dd>
        <span class="simpara">
       ...
       <dt><strong><code><a href="image.constants.php#constant.img-crop-threshold">IMG_CROP_THRESHOLD</a></code></strong></dt>
       <dd>
        <span class="simpara">
    ...
    <dd>
     ...
     <p class="para">
      Used only in <strong><code><a href="image.constants.php#constant.img-crop-threshold">IMG_CROP_THRESHOLD</a></code></strong> mode.
     </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecropauto-returnvalues">
  ...
  <p class="para">
   Returns a cropped image object on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is also returned if the whole image was cropped.
  </p>
 </div>
  ...
  instance now; previously, a valid <code class="literal">gd</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <td>
       ...
       that of system libgd: <strong><code><a href="image.constants.php#constant.img-crop-default">IMG_CROP_DEFAULT</a></code></strong> no longer falls
       back to <strong><code><a href="image.constants.php#constant.img-crop-sides">IMG_CROP_SIDES</a></code></strong> and threshold-cropping now uses
     ...
     <tr>
      ...
      <td>
       ...
       <code class="literal">-1</code> which corresponds to <strong><code><a href="image.constants.php#constant.img-crop-default">IMG_CROP_DEFAULT</a></code></strong>,
       but passing <code class="literal">-1</code> is now deprecated.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecropauto-examples">
  ...
  <p class="para">
   <div class="example" id="example-2878">
    ...
    <div class="example-contents"><p>
     ...
     returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the whole image
     was cropped. In this example we have an image object
     <code class="literal">$im</code> which should be automatically cropped only if there
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.imagecrop.php" class="function" rel="rdfs-seeAlso">imagecrop()</a> - Crop an image to the given rectangle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecropauto.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecropauto%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecropauto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecropauto.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119620">  <div class="votes">
    <div id="Vu119620">
    <a href="/manual/vote-note.php?id=119620&amp;page=function.imagecropauto&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119620">
    <a href="/manual/vote-note.php?id=119620&amp;page=function.imagecropauto&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119620" title="57% like this...">
    3
    </div>
  </div>
  <a href="#119620" class="name">
  <strong class="user"><em>raphael.deiana</em></strong></a><a class="genanchor" href="#119620"> &para;</a><div class="date" title="2016-07-18 11:49"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119620">
<div class="phpcode"><code><span class="html">In some cases the use of the IMG_CROP_WHITE or IMG_CROP_BLACK does not work. The function returns FALSE. It is best to use the IMG_CROP_THRESHOLD mode and specify the color in fourth argument as in the example below :<br /><br /><span class="default">&lt;?php<br /><br />$original_img </span><span class="keyword">= </span><span class="default">imagecreatefromjpeg</span><span class="keyword">(</span><span class="default">$image_path</span><span class="keyword">);<br /><br /></span><span class="comment">// Use this :<br /></span><span class="default">$cropped_img_white </span><span class="keyword">= </span><span class="default">imagecropauto</span><span class="keyword">(</span><span class="default">$original_img </span><span class="keyword">, </span><span class="default">IMG_CROP_THRESHOLD</span><span class="keyword">, </span><span class="default">null</span><span class="keyword">, </span><span class="default">16777215</span><span class="keyword">);<br /></span><span class="comment">// Rather than :<br /></span><span class="default">$cropped_img_white </span><span class="keyword">= </span><span class="default">imagecropauto</span><span class="keyword">(</span><span class="default">$original_img </span><span class="keyword">, </span><span class="default">IMG_CROP_WHITE</span><span class="keyword">);<br /><br /></span><span class="comment">// AND<br /><br />// Use this :<br /></span><span class="default">$cropped_img_black </span><span class="keyword">= </span><span class="default">imagecropauto</span><span class="keyword">(</span><span class="default">$original_img </span><span class="keyword">, </span><span class="default">IMG_CROP_THRESHOLD</span><span class="keyword">, </span><span class="default">null</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="comment">// Rather than :<br /></span><span class="default">$cropped_img_black </span><span class="keyword">= </span><span class="default">imagecropauto</span><span class="keyword">(</span><span class="default">$original_img </span><span class="keyword">, </span><span class="default">IMG_CROP_BLACK</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126972">  <div class="votes">
    <div id="Vu126972">
    <a href="/manual/vote-note.php?id=126972&amp;page=function.imagecropauto&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126972">
    <a href="/manual/vote-note.php?id=126972&amp;page=function.imagecropauto&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126972" title="50% like this...">
    0
    </div>
  </div>
  <a href="#126972" class="name">
  <strong class="user"><em>pj dot mueller at protonmail dot ch</em></strong></a><a class="genanchor" href="#126972"> &para;</a><div class="date" title="2022-04-06 06:21"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom126972">
<div class="phpcode"><code><span class="html">I don’t know why you can’t set the threshold for the four sides filter (IMG_CROP_SIDES) so here’s how to do it manually using the IMG_CROP_THRESHOLD filter instead.<br /><br />$threshold = .5;<br /><br />$im = imagecreatefromjpeg('somefile.jpg');<br /><br />$width = imagesx($im);<br />$height = imagesy($im);<br /><br />$arr = [<br />    [0,0],<br />    [$width-1,0],<br />    [0,$height-1],<br />    [$width-1,$height-1],<br />];<br /><br />$red = 0;<br />$green = 0;<br />$blue = 0;<br /><br />// grab the colours from all four corners<br />foreach( $arr as $arr2 ) {<br />    $thisColor = imagecolorat($im, $arr2[0], $arr2[1]); <br /><br />    $rgb = imagecolorsforindex($im, $thisColor); <br />    $red += round(round(($rgb['red'] / 0x33)) * 0x33); <br />    $green += round(round(($rgb['green'] / 0x33)) * 0x33); <br />    $blue += round(round(($rgb['blue'] / 0x33)) * 0x33); <br />}<br /><br />// and average them<br />$red /= 4;<br />$green /= 4;<br />$blue /= 4;<br /><br />$newColor = imagecolorallocate($im, $red, $green, $blue);            <br /><br />$cropped = imagecropauto($im, IMG_CROP_THRESHOLD, $threshold, $newColor);<br /><br />imagejpg($cropped, 'somefile.cropped.jpg');<br /><br />imagedestroy($im);<br />imagedestroy($cropped);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecropauto&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecropauto.php">＋<small>add a note</small></a></div>
