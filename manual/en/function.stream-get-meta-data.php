...
<head>
  ...
  <title>PHP: stream_get_meta_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-get-meta-data.php">
 <link rel="shorturl" href="https://www.php.net/stream-get-meta-data">
 <link rel="alternate" href="https://www.php.net/stream-get-meta-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-line.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-get-transports.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-get-meta-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-get-meta-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-get-meta-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-get-meta-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-get-meta-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-get-meta-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-get-meta-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-get-meta-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-get-meta-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-get-meta-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-get-meta-data.php" hreflang="zh">
...
<meta name="Description" content="Retrieves header/meta data from streams/file pointers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_get_meta_data - Manual" />
<meta name="twitter:description" content="Retrieves header/meta data from streams/file pointers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_get_meta_data - Manual" />
<meta itemprop="description" content="Retrieves header/meta data from streams/file pointers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves header/meta data from streams/file pointers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-get-transports.php">
          stream_get_transports &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-get-line.php">
          &laquo; stream_get_line        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-get-meta-data.php' selected="selected">English</option>
            <option value='de/function.stream-get-meta-data.php'>German</option>
            <option value='es/function.stream-get-meta-data.php'>Spanish</option>
            <option value='fr/function.stream-get-meta-data.php'>French</option>
            <option value='it/function.stream-get-meta-data.php'>Italian</option>
            <option value='ja/function.stream-get-meta-data.php'>Japanese</option>
            <option value='pt_BR/function.stream-get-meta-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-get-meta-data.php'>Russian</option>
            <option value='tr/function.stream-get-meta-data.php'>Turkish</option>
            <option value='uk/function.stream-get-meta-data.php'>Ukrainian</option>
            <option value='zh/function.stream-get-meta-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-get-meta-data" class="refentry">
  ...
  <ul class="itemizedlist">
   ...
   <li class="listitem">
    <p class="para">
     ...
     See <a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a> for more information about wrappers.
    </p>
   </li>
   <li class="listitem">
    <p class="para">
     <code class="literal">wrapper_data</code> (mixed) - wrapper specific
     data attached to this stream.  See <a href="wrappers.php" class="xref">Supported Protocols and Wrappers</a> for
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-get-meta-data-examples">
  ...
  <p class="para">
   <div class="example" id="example-4057">
    <p><strong>Example #1 <span class="function"><strong>stream_get_meta_data()</strong></span> example using <span class="function"><a href="function.fopen.php" class="function">fopen()</a></span> with http</strong></p>
...
<div class="examplescode"><pre class="examplescode">array(10) {
  ...
  string(23) &quot;http://www.example.com/&quot;
   ...
   <div class="example" id="example-4058">
    <p><strong>Example #2 <span class="function"><strong>stream_get_meta_data()</strong></span> example using <span class="function"><a href="function.stream-socket-client.php" class="function">stream_socket_client()</a></span> with https</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><a href="reserved.variables.httpresponseheader.php" class="link">$http_response_header</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-get-meta-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-get-meta-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-get-meta-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-meta-data.php">＋<small>add a note</small></a></span>
