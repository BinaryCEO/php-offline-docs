...
<head>
  ...
  <title>PHP: EventException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.eventexception.php">
 <link rel="shorturl" href="https://www.php.net/eventexception">
 <link rel="alternate" href="https://www.php.net/eventexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventutil.sslrandpoll.php">
 <link rel="next" href="https://www.php.net/manual/en/book.ftp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.eventexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.eventexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.eventexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.eventexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.eventexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.eventexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.eventexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.eventexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.eventexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.eventexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.eventexception.php" hreflang="zh">
...
<meta name="Description" content="The EventException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventException - Manual" />
<meta name="twitter:description" content="The EventException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventException - Manual" />
<meta itemprop="description" content="The EventException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EventException class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.eventexception.php' selected="selected">English</option>
            <option value='de/class.eventexception.php'>German</option>
            <option value='es/class.eventexception.php'>Spanish</option>
            <option value='fr/class.eventexception.php'>French</option>
            <option value='it/class.eventexception.php'>Italian</option>
            <option value='ja/class.eventexception.php'>Japanese</option>
            <option value='pt_BR/class.eventexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.eventexception.php'>Russian</option>
            <option value='tr/class.eventexception.php'>Turkish</option>
            <option value='uk/class.eventexception.php'>Ukrainian</option>
            <option value='zh/class.eventexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.eventexception" class="reference">
 <h1 class="title">The EventException class</h1>
 ...
 <div class="partintro"><p class="verinfo">(No version information available, might only be in Git)</p>
  ...
  <div class="section" id="eventexception.intro">
   ...
   <p class="para">
    A <span class="classname"><strong class="classname">EventException</strong></span> is thrown when the Event extension methods
    encounter invalid user input or identify an unrecoverable error. This exception
    serves as a signal for developers to handle exceptional situations gracefully.
   </p>
  </div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.eventexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.eventexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.eventexception.php">＋<small>add a note</small></a></span>
