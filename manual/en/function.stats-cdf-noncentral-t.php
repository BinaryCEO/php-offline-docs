...
<head>
  ...
  <title>PHP: stats_cdf_noncentral_t - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-cdf-noncentral-t.php">
 <link rel="shorturl" href="https://www.php.net/stats-cdf-noncentral-t">
 <link rel="alternate" href="https://www.php.net/stats-cdf-noncentral-t" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-cdf-noncentral-f.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-cdf-normal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-cdf-noncentral-t.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-cdf-noncentral-t.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-cdf-noncentral-t.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-cdf-noncentral-t.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-cdf-noncentral-t.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-cdf-noncentral-t.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-cdf-noncentral-t.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-cdf-noncentral-t.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-cdf-noncentral-t.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-cdf-noncentral-t.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-cdf-noncentral-t.php" hreflang="zh">
...
<meta name="Description" content="Calculates any one parameter of the non-central t-distribution give values for the others" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_cdf_noncentral_t - Manual" />
<meta name="twitter:description" content="Calculates any one parameter of the non-central t-distribution give values for the others" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_cdf_noncentral_t - Manual" />
<meta itemprop="description" content="Calculates any one parameter of the non-central t-distribution give values for the others" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculates any one parameter of the non-central t-distribution give values for the others" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-cdf-normal.php">
          stats_cdf_normal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-cdf-noncentral-f.php">
          &laquo; stats_cdf_noncentral_f        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-cdf-noncentral-t.php' selected="selected">English</option>
            <option value='de/function.stats-cdf-noncentral-t.php'>German</option>
            <option value='es/function.stats-cdf-noncentral-t.php'>Spanish</option>
            <option value='fr/function.stats-cdf-noncentral-t.php'>French</option>
            <option value='it/function.stats-cdf-noncentral-t.php'>Italian</option>
            <option value='ja/function.stats-cdf-noncentral-t.php'>Japanese</option>
            <option value='pt_BR/function.stats-cdf-noncentral-t.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-cdf-noncentral-t.php'>Russian</option>
            <option value='tr/function.stats-cdf-noncentral-t.php'>Turkish</option>
            <option value='uk/function.stats-cdf-noncentral-t.php'>Ukrainian</option>
            <option value='zh/function.stats-cdf-noncentral-t.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-cdf-noncentral-t" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_cdf_noncentral_t</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_cdf_noncentral_t</span> &mdash; <span class="dc-title">Calculates any one parameter of the non-central t-distribution give values for the others</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.stats-cdf-noncentral-t-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_cdf_noncentral_t</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$par1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$par2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$par3</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$which</code></span><br>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-cdf-noncentral-t-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-cdf-noncentral-t-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns CDF, x, nu, or mu, determined by <code class="parameter">which</code>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-cdf-noncentral-t.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-cdf-noncentral-t%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-cdf-noncentral-t&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-noncentral-t.php">＋<small>add a note</small></a></span>
