...
<head>
  ...
  <title>PHP: fbird_trans - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-trans.php">
 <link rel="shorturl" href="https://www.php.net/fbird-trans">
 <link rel="alternate" href="https://www.php.net/fbird-trans" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-set-event-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-wait-event.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-trans.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-trans.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-trans.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-trans.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-trans.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-trans.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-trans.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-trans.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-trans.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-trans.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-trans.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_trans" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_trans - Manual" />
<meta name="twitter:description" content="Alias of ibase_trans" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_trans - Manual" />
<meta itemprop="description" content="Alias of ibase_trans" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_trans" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-wait-event.php">
          fbird_wait_event &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-set-event-handler.php">
          &laquo; fbird_set_event_handler        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-trans.php' selected="selected">English</option>
            <option value='de/function.fbird-trans.php'>German</option>
            <option value='es/function.fbird-trans.php'>Spanish</option>
            <option value='fr/function.fbird-trans.php'>French</option>
            <option value='it/function.fbird-trans.php'>Italian</option>
            <option value='ja/function.fbird-trans.php'>Japanese</option>
            <option value='pt_BR/function.fbird-trans.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-trans.php'>Russian</option>
            <option value='tr/function.fbird-trans.php'>Turkish</option>
            <option value='uk/function.fbird-trans.php'>Ukrainian</option>
            <option value='zh/function.fbird-trans.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-trans" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_trans</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_trans</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-trans.php" class="function">ibase_trans()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-trans-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.ibase-trans.php" class="function">ibase_trans()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-trans.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-trans%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-trans&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-trans.php">＋<small>add a note</small></a></span>
