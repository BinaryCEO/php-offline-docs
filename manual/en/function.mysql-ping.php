...
<head>
  ...
  <title>PHP: mysql_ping - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-ping.php">
 <link rel="shorturl" href="https://www.php.net/mysql-ping">
 <link rel="alternate" href="https://www.php.net/mysql-ping" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-ping.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-ping.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-ping.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-ping.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-ping.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-ping.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-ping.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-ping.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-ping.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-ping.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-ping.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_ping - Manual" />
...
<meta itemprop="name" content="PHP: mysql_ping - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-ping.php' selected="selected">English</option>
            <option value='de/function.mysql-ping.php'>German</option>
            <option value='es/function.mysql-ping.php'>Spanish</option>
            <option value='fr/function.mysql-ping.php'>French</option>
            <option value='it/function.mysql-ping.php'>Italian</option>
            <option value='ja/function.mysql-ping.php'>Japanese</option>
            <option value='pt_BR/function.mysql-ping.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-ping.php'>Russian</option>
            <option value='tr/function.mysql-ping.php'>Turkish</option>
            <option value='uk/function.mysql-ping.php'>Ukrainian</option>
            <option value='zh/function.mysql-ping.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-ping" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-list-processes.php" class="function" rel="rdfs-seeAlso">mysql_list_processes()</a> - List MySQL processes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-ping.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-ping%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-ping&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-ping.php">＋<small>add a note</small></a></span>
