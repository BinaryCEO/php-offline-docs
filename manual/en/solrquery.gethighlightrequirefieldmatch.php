...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightRequireFieldMatch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightsimplepost.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightrequirefieldmatch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightrequirefieldmatch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightrequirefieldmatch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightrequirefieldmatch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightrequirefieldmatch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightrequirefieldmatch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightrequirefieldmatch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightrequirefieldmatch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightrequirefieldmatch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightrequirefieldmatch.php" hreflang="zh">
...
<meta name="Description" content="Returns if a field will only be highlighted if the query matched in this particular field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightRequireFieldMatch - Manual" />
<meta name="twitter:description" content="Returns if a field will only be highlighted if the query matched in this particular field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightRequireFieldMatch - Manual" />
<meta itemprop="description" content="Returns if a field will only be highlighted if the query matched in this particular field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns if a field will only be highlighted if the query matched in this particular field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightsimplepost.php">
          SolrQuery::getHighlightSimplePost &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightregexslop.php">
          &laquo; SolrQuery::getHighlightRegexSlop        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightrequirefieldmatch.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightrequirefieldmatch.php'>German</option>
            <option value='es/solrquery.gethighlightrequirefieldmatch.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightrequirefieldmatch.php'>French</option>
            <option value='it/solrquery.gethighlightrequirefieldmatch.php'>Italian</option>
            <option value='ja/solrquery.gethighlightrequirefieldmatch.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightrequirefieldmatch.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightrequirefieldmatch.php'>Russian</option>
            <option value='tr/solrquery.gethighlightrequirefieldmatch.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightrequirefieldmatch.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightrequirefieldmatch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightrequirefieldmatch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightRequireFieldMatch</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightRequireFieldMatch</span> &mdash; <span class="dc-title">Returns if a field will only be highlighted if the query matched in this particular field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightrequirefieldmatch-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightRequireFieldMatch</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightrequirefieldmatch-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightrequirefieldmatch-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightrequirefieldmatch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightrequirefieldmatch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightrequirefieldmatch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightrequirefieldmatch.php">＋<small>add a note</small></a></span>
