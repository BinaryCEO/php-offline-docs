...
<head>
  ...
  <title>PHP: ZipArchive::getStatusString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getnameindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getstream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.getstatusstring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.getstatusstring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.getstatusstring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.getstatusstring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.getstatusstring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.getstatusstring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.getstatusstring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.getstatusstring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.getstatusstring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.getstatusstring.php" hreflang="zh">
...
<meta name="Description" content="Returns the status error message, system and/or zip messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::getStatusString - Manual" />
<meta name="twitter:description" content="Returns the status error message, system and/or zip messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::getStatusString - Manual" />
<meta itemprop="description" content="Returns the status error message, system and/or zip messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the status error message, system and/or zip messages" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.getstream.php">
          ZipArchive::getStream &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.getnameindex.php">
          &laquo; ZipArchive::getNameIndex        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getstatusstring.php' selected="selected">English</option>
            <option value='de/ziparchive.getstatusstring.php'>German</option>
            <option value='es/ziparchive.getstatusstring.php'>Spanish</option>
            <option value='fr/ziparchive.getstatusstring.php'>French</option>
            <option value='it/ziparchive.getstatusstring.php'>Italian</option>
            <option value='ja/ziparchive.getstatusstring.php'>Japanese</option>
            <option value='pt_BR/ziparchive.getstatusstring.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.getstatusstring.php'>Russian</option>
            <option value='tr/ziparchive.getstatusstring.php'>Turkish</option>
            <option value='uk/ziparchive.getstatusstring.php'>Ukrainian</option>
            <option value='zh/ziparchive.getstatusstring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.getstatusstring" class="refentry">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getstatusstring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getstatusstring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getstatusstring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getstatusstring.php">＋<small>add a note</small></a></span>
