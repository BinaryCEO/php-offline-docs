...
<head>
  ...
  <title>PHP: SolrQuery::addStatsFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addsortfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addstatsfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addstatsfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addstatsfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addstatsfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addstatsfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addstatsfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addstatsfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addstatsfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addstatsfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addstatsfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addstatsfacet.php" hreflang="zh">
...
<meta name="Description" content="Requests a return of sub results for values within the given facet" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addStatsFacet - Manual" />
<meta name="twitter:description" content="Requests a return of sub results for values within the given facet" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addStatsFacet - Manual" />
<meta itemprop="description" content="Requests a return of sub results for values within the given facet" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Requests a return of sub results for values within the given facet" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addstatsfield.php">
          SolrQuery::addStatsField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addsortfield.php">
          &laquo; SolrQuery::addSortField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addstatsfacet.php' selected="selected">English</option>
            <option value='de/solrquery.addstatsfacet.php'>German</option>
            <option value='es/solrquery.addstatsfacet.php'>Spanish</option>
            <option value='fr/solrquery.addstatsfacet.php'>French</option>
            <option value='it/solrquery.addstatsfacet.php'>Italian</option>
            <option value='ja/solrquery.addstatsfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.addstatsfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addstatsfacet.php'>Russian</option>
            <option value='tr/solrquery.addstatsfacet.php'>Turkish</option>
            <option value='uk/solrquery.addstatsfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.addstatsfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addstatsfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addStatsFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addStatsFacet</span> &mdash; <span class="dc-title">Requests a return of sub results for values within the given facet</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addstatsfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addStatsFacet</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addstatsfacet-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addstatsfacet-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addstatsfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addstatsfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addstatsfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addstatsfacet.php">＋<small>add a note</small></a></span>
