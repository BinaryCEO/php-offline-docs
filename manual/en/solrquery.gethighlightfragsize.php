...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightFragsize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightfragsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightfragsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightfragsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightfragsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightfragsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightfragsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightfragsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightfragsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightfragsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightfragsize.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of characters of fragments to consider for highlighting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightFragsize - Manual" />
<meta name="twitter:description" content="Returns the number of characters of fragments to consider for highlighting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightFragsize - Manual" />
<meta itemprop="description" content="Returns the number of characters of fragments to consider for highlighting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of characters of fragments to consider for highlighting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlighthighlightmultiterm.php">
          SolrQuery::getHighlightHighlightMultiTerm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightfragmenter.php">
          &laquo; SolrQuery::getHighlightFragmenter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightfragsize.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightfragsize.php'>German</option>
            <option value='es/solrquery.gethighlightfragsize.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightfragsize.php'>French</option>
            <option value='it/solrquery.gethighlightfragsize.php'>Italian</option>
            <option value='ja/solrquery.gethighlightfragsize.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightfragsize.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightfragsize.php'>Russian</option>
            <option value='tr/solrquery.gethighlightfragsize.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightfragsize.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightfragsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightfragsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightFragsize</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightFragsize</span> &mdash; <span class="dc-title">Returns the number of characters of fragments to consider for highlighting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightfragsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightFragsize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightfragsize-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightfragsize-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
Returns an integer on success or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightfragsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightfragsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightfragsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightfragsize.php">＋<small>add a note</small></a></span>
