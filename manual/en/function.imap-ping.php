...
<head>
  ...
  <title>PHP: imap_ping - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-ping.php">
 <link rel="shorturl" href="https://www.php.net/imap-ping">
 <link rel="alternate" href="https://www.php.net/imap-ping" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-qprint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-ping.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-ping.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-ping.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-ping.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-ping.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-ping.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-ping.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-ping.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-ping.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-ping.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-ping.php" hreflang="zh">
...
<meta name="Description" content="Check if the IMAP stream is still active" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_ping - Manual" />
<meta name="twitter:description" content="Check if the IMAP stream is still active" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_ping - Manual" />
<meta itemprop="description" content="Check if the IMAP stream is still active" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if the IMAP stream is still active" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-qprint.php">
          imap_qprint &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-ping.php' selected="selected">English</option>
            <option value='de/function.imap-ping.php'>German</option>
            <option value='es/function.imap-ping.php'>Spanish</option>
            <option value='fr/function.imap-ping.php'>French</option>
            <option value='it/function.imap-ping.php'>Italian</option>
            <option value='ja/function.imap-ping.php'>Japanese</option>
            <option value='pt_BR/function.imap-ping.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-ping.php'>Russian</option>
            <option value='tr/function.imap-ping.php'>Turkish</option>
            <option value='uk/function.imap-ping.php'>Ukrainian</option>
            <option value='zh/function.imap-ping.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-ping" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_ping</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_ping</span> &mdash; <span class="dc-title">Check if the IMAP stream is still active</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-ping-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_ping</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-ping-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the stream is still alive, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imap-ping-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$imap </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org}"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mailadmin"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// after some sleeping<br /></span><span style="color: #007700">if (!</span><span style="color: #0000BB">imap_ping</span><span style="color: #007700">(</span><span style="color: #0000BB">$imap</span><span style="color: #007700">)) {<br />    </span><span style="color: #FF8000">// do some stuff to reconnect<br /></span><span style="color: #007700">}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-ping.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-ping%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-ping&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-ping.php">＋<small>add a note</small></a></span>
