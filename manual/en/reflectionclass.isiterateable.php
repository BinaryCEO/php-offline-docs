...
<head>
  ...
  <title>PHP: ReflectionClass::isIterateable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isiterable.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isreadonly.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isiterateable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isiterateable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isiterateable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isiterateable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isiterateable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isiterateable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isiterateable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isiterateable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isiterateable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isiterateable.php" hreflang="zh">
...
<meta name="Description" content="Alias of ReflectionClass::isIterable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isIterateable - Manual" />
<meta name="twitter:description" content="Alias of ReflectionClass::isIterable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isIterateable - Manual" />
<meta itemprop="description" content="Alias of ReflectionClass::isIterable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ReflectionClass::isIterable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isreadonly.php">
          ReflectionClass::isReadOnly &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isiterable.php">
          &laquo; ReflectionClass::isIterable        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isiterateable.php' selected="selected">English</option>
            <option value='de/reflectionclass.isiterateable.php'>German</option>
            <option value='es/reflectionclass.isiterateable.php'>Spanish</option>
            <option value='fr/reflectionclass.isiterateable.php'>French</option>
            <option value='it/reflectionclass.isiterateable.php'>Italian</option>
            <option value='ja/reflectionclass.isiterateable.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isiterateable.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isiterateable.php'>Russian</option>
            <option value='tr/reflectionclass.isiterateable.php'>Turkish</option>
            <option value='uk/reflectionclass.isiterateable.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isiterateable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isiterateable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isIterateable</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isIterateable</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="reflectionclass.isiterable.php" class="methodname">ReflectionClass::isIterable()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isiterateable-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="methodname"><a href="reflectionclass.isiterable.php" class="methodname">ReflectionClass::isIterable()</a></span></p>
  <p class="para">
   As of PHP 7.2.0, instead of the missspelled <span class="methodname"><strong>RefectionClass::isIterateable()</strong></span>,
   <span class="methodname"><a href="reflectionclass.isiterable.php" class="methodname">ReflectionClass::isIterable()</a></span> should be preferred.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isiterateable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isiterateable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isiterateable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isiterateable.php">＋<small>add a note</small></a></span>
