...
<head>
  ...
  <title>PHP: trader_acos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-acos.php">
 <link rel="shorturl" href="https://www.php.net/trader-acos">
 <link rel="alternate" href="https://www.php.net/trader-acos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-ad.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-acos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-acos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-acos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-acos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-acos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-acos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-acos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-acos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-acos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-acos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-acos.php" hreflang="zh">
...
<meta name="Description" content="Vector Trigonometric ACos" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_acos - Manual" />
<meta name="twitter:description" content="Vector Trigonometric ACos" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_acos - Manual" />
<meta itemprop="description" content="Vector Trigonometric ACos" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Trigonometric ACos" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-acos.php' selected="selected">English</option>
            <option value='de/function.trader-acos.php'>German</option>
            <option value='es/function.trader-acos.php'>Spanish</option>
            <option value='fr/function.trader-acos.php'>French</option>
            <option value='it/function.trader-acos.php'>Italian</option>
            <option value='ja/function.trader-acos.php'>Japanese</option>
            <option value='pt_BR/function.trader-acos.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-acos.php'>Russian</option>
            <option value='tr/function.trader-acos.php'>Turkish</option>
            <option value='uk/function.trader-acos.php'>Ukrainian</option>
            <option value='zh/function.trader-acos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-acos" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_acos</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_acos</span> &mdash; <span class="dc-title">Vector Trigonometric ACos</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-acos-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_acos</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-acos-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-acos-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-acos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-acos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-acos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-acos.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125744">  <div class="votes">
    <div id="Vu125744">
    <a href="/manual/vote-note.php?id=125744&amp;page=function.trader-acos&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125744">
    <a href="/manual/vote-note.php?id=125744&amp;page=function.trader-acos&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125744" title="66% like this...">
    2
    </div>
  </div>
  <a href="#125744" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125744"> &para;</a><div class="date" title="2021-01-31 05:24"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125744">
<div class="phpcode"><code><span class="html">$real = array(1, 0.5, 1, 0.5, 0.2, 0.3, 0.5, 0.8, 0.9, 0.5);<br />$result = trader_acos($real);<br />var_dump($result);<br />/*<br />array(10) {<br />  [0]=&gt;<br />  float(0)<br />  [1]=&gt;<br />  float(1.047)<br />  [2]=&gt;<br />  float(0)<br />  [3]=&gt;<br />  float(1.047)<br />  [4]=&gt;<br />  float(1.369)<br />  [5]=&gt;<br />  float(1.266)<br />  [6]=&gt;<br />  float(1.047)<br />  [7]=&gt;<br />  float(0.644)<br />  [8]=&gt;<br />  float(0.451)<br />  [9]=&gt;<br />  float(1.047)<br />}<br />*/</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-acos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-acos.php">＋<small>add a note</small></a></div>
