...
<head>
  ...
  <title>PHP: sodium_increment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-increment.php">
 <link rel="shorturl" href="https://www.php.net/sodium-increment">
 <link rel="alternate" href="https://www.php.net/sodium-increment" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-hex2bin.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-memcmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-increment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-increment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-increment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-increment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-increment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-increment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-increment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-increment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-increment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-increment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-increment.php" hreflang="zh">
...
<meta name="Description" content="Increment large number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_increment - Manual" />
<meta name="twitter:description" content="Increment large number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_increment - Manual" />
<meta itemprop="description" content="Increment large number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Increment large number" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-increment.php' selected="selected">English</option>
            <option value='de/function.sodium-increment.php'>German</option>
            <option value='es/function.sodium-increment.php'>Spanish</option>
            <option value='fr/function.sodium-increment.php'>French</option>
            <option value='it/function.sodium-increment.php'>Italian</option>
            <option value='ja/function.sodium-increment.php'>Japanese</option>
            <option value='pt_BR/function.sodium-increment.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-increment.php'>Russian</option>
            <option value='tr/function.sodium-increment.php'>Turkish</option>
            <option value='uk/function.sodium-increment.php'>Ukrainian</option>
            <option value='zh/function.sodium-increment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-increment" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_increment</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_increment</span> &mdash; <span class="dc-title">Increment large number</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-increment-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_increment</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$string</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   Treat the string as a little-endian unsigned integer, then increase it by 1.
   Constant-time.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-increment-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-increment-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-increment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-increment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-increment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-increment.php">＋<small>add a note</small></a></span>
