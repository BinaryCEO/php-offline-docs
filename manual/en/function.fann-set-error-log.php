...
<head>
  ...
  <title>PHP: fann_set_error_log - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-error-log.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-error-log">
 <link rel="alternate" href="https://www.php.net/fann-set-error-log" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-cascade-weight-multiplier.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-input-scaling-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-error-log.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-error-log.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-error-log.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-error-log.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-error-log.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-error-log.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-error-log.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-error-log.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-error-log.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-error-log.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-error-log.php" hreflang="zh">
...
<meta name="Description" content="Sets where the errors are logged to" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_error_log - Manual" />
<meta name="twitter:description" content="Sets where the errors are logged to" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_error_log - Manual" />
<meta itemprop="description" content="Sets where the errors are logged to" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets where the errors are logged to" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-input-scaling-params.php">
          fann_set_input_scaling_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-cascade-weight-multiplier.php">
          &laquo; fann_set_cascade_weight_multiplier        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-error-log.php' selected="selected">English</option>
            <option value='de/function.fann-set-error-log.php'>German</option>
            <option value='es/function.fann-set-error-log.php'>Spanish</option>
            <option value='fr/function.fann-set-error-log.php'>French</option>
            <option value='it/function.fann-set-error-log.php'>Italian</option>
            <option value='ja/function.fann-set-error-log.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-error-log.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-error-log.php'>Russian</option>
            <option value='tr/function.fann-set-error-log.php'>Turkish</option>
            <option value='uk/function.fann-set-error-log.php'>Ukrainian</option>
            <option value='zh/function.fann-set-error-log.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-error-log" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_error_log</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_error_log</span> &mdash; <span class="dc-title">Sets where the errors are logged to</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-error-log-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_error_log</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$errdat</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$log_file</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-error-log-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">log_file</code></dt>
    <dd>
     <p class="para">
      The log file path.
     </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-error-log-returnvalues">
  ...
  <p class="para">No value is returned.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-error-log.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-error-log%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-error-log&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-error-log.php">＋<small>add a note</small></a></span>
