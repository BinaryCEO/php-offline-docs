...
<head>
  ...
  <title>PHP: Imagick::optimizeImageLayers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.opaquepaintimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.optimizeimagelayers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.optimizeimagelayers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.optimizeimagelayers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.optimizeimagelayers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.optimizeimagelayers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.optimizeimagelayers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.optimizeimagelayers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.optimizeimagelayers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.optimizeimagelayers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.optimizeimagelayers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.optimizeimagelayers.php" hreflang="zh">
...
<meta name="Description" content="Removes repeated portions of images to optimize" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::optimizeImageLayers - Manual" />
<meta name="twitter:description" content="Removes repeated portions of images to optimize" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::optimizeImageLayers - Manual" />
<meta itemprop="description" content="Removes repeated portions of images to optimize" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes repeated portions of images to optimize" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.orderedposterizeimage.php">
          Imagick::orderedPosterizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.opaquepaintimage.php">
          &laquo; Imagick::opaquePaintImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.optimizeimagelayers.php' selected="selected">English</option>
            <option value='de/imagick.optimizeimagelayers.php'>German</option>
            <option value='es/imagick.optimizeimagelayers.php'>Spanish</option>
            <option value='fr/imagick.optimizeimagelayers.php'>French</option>
            <option value='it/imagick.optimizeimagelayers.php'>Italian</option>
            <option value='ja/imagick.optimizeimagelayers.php'>Japanese</option>
            <option value='pt_BR/imagick.optimizeimagelayers.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.optimizeimagelayers.php'>Russian</option>
            <option value='tr/imagick.optimizeimagelayers.php'>Turkish</option>
            <option value='uk/imagick.optimizeimagelayers.php'>Ukrainian</option>
            <option value='zh/imagick.optimizeimagelayers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.optimizeimagelayers" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.optimizeimagelayers-examples">
  ...
  <p class="para">
   <div class="example" id="example-3062">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.writeimage.php" class="function" rel="rdfs-seeAlso">Imagick::writeImage()</a> - Writes an image to the specified filename</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/optimizeimagelayers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.optimizeimagelayers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.optimizeimagelayers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.optimizeimagelayers.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112428">  <div class="votes">
    <div id="Vu112428">
    <a href="/manual/vote-note.php?id=112428&amp;page=imagick.optimizeimagelayers&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112428">
    <a href="/manual/vote-note.php?id=112428&amp;page=imagick.optimizeimagelayers&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112428" title="50% like this...">
    0
    </div>
  </div>
  <a href="#112428" class="name">
  <strong class="user"><em>f21 dot groups at gmail dot com</em></strong></a><a class="genanchor" href="#112428"> &para;</a><div class="date" title="2013-06-16 02:37"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112428">
<div class="phpcode"><code><span class="html">In imagick 3.x (have not checked 2.x), this returns an imagemagick object and not a boolean.<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'myanimation.gif'</span><span class="keyword">);<br /><br /></span><span class="default">$image </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">optimizeImageLayers</span><span class="keyword">(); </span><span class="comment">//Does not return a boolean!<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'optimized.gif'</span><span class="keyword">);</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.optimizeimagelayers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.optimizeimagelayers.php">＋<small>add a note</small></a></div>
