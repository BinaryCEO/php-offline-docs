...
<head>
  ...
  <title>PHP: mb_regex_set_options - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-regex-set-options.php">
 <link rel="shorturl" href="https://www.php.net/mb-regex-set-options">
 <link rel="alternate" href="https://www.php.net/mb-regex-set-options" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-regex-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-rtrim.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-regex-set-options.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-regex-set-options.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-regex-set-options.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-regex-set-options.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-regex-set-options.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-regex-set-options.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-regex-set-options.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-regex-set-options.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-regex-set-options.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-regex-set-options.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-regex-set-options.php" hreflang="zh">
...
<meta name="Description" content="Set/Get the default options for mbregex functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_regex_set_options - Manual" />
<meta name="twitter:description" content="Set/Get the default options for mbregex functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_regex_set_options - Manual" />
<meta itemprop="description" content="Set/Get the default options for mbregex functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/Get the default options for mbregex functions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-rtrim.php">
          mb_rtrim &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-regex-encoding.php">
          &laquo; mb_regex_encoding        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-regex-set-options.php' selected="selected">English</option>
            <option value='de/function.mb-regex-set-options.php'>German</option>
            <option value='es/function.mb-regex-set-options.php'>Spanish</option>
            <option value='fr/function.mb-regex-set-options.php'>French</option>
            <option value='it/function.mb-regex-set-options.php'>Italian</option>
            <option value='ja/function.mb-regex-set-options.php'>Japanese</option>
            <option value='pt_BR/function.mb-regex-set-options.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-regex-set-options.php'>Russian</option>
            <option value='tr/function.mb-regex-set-options.php'>Turkish</option>
            <option value='uk/function.mb-regex-set-options.php'>Ukrainian</option>
            <option value='zh/function.mb-regex-set-options.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-regex-set-options" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-eregi.php" class="function" rel="rdfs-seeAlso">mb_eregi()</a> - Regular expression match ignoring case with multibyte support</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-regex-set-options.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-regex-set-options%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-regex-set-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-regex-set-options.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="87612">  <div class="votes">
    <div id="Vu87612">
    <a href="/manual/vote-note.php?id=87612&amp;page=function.mb-regex-set-options&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd87612">
    <a href="/manual/vote-note.php?id=87612&amp;page=function.mb-regex-set-options&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V87612" title="66% like this...">
    1
    </div>
  </div>
  <a href="#87612" class="name">
  <strong class="user"><em>patryk dot szczyglowski at gmail dot com</em></strong></a><a class="genanchor" href="#87612"> &para;</a><div class="date" title="2008-12-12 10:12"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87612">
<div class="phpcode"><code><span class="html">Supported options are:<br /><br />i - ONIG_OPTION_IGNORECASE<br />x - ONIG_OPTION_EXTEND<br />m - ONIG_OPTION_MULTILINE<br />s - ONIG_OPTION_SINGLELINE<br />p - ONIG_OPTION_MULTILINE | ONIG_OPTION_SINGLELINE<br />l - ONIG_OPTION_FIND_LONGEST<br />n - ONIG_OPTION_FIND_NOT_EMPTY<br />j - ONIG_SYNTAX_JAVA<br />u - ONIG_SYNTAX_GNU_REGEX<br />g - ONIG_SYNTAX_GREP<br />c - ONIG_SYNTAX_EMACS<br />r - ONIG_SYNTAX_RUBY<br />z - ONIG_SYNTAX_PERL<br />b - ONIG_SYNTAX_POSIX_BASIC<br />d - ONIG_SYNTAX_POSIX_EXTENDED<br />e - eval() resulting code<br /><br />Constants above are from Oniguruma regexp library, which is used internally. Default value for PHP 5.2.x is 'pr'.</span></code></div>
  </div>
 </div>
  <div class="note" id="94843">  <div class="votes">
    <div id="Vu94843">
    <a href="/manual/vote-note.php?id=94843&amp;page=function.mb-regex-set-options&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94843">
    <a href="/manual/vote-note.php?id=94843&amp;page=function.mb-regex-set-options&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94843" title="60% like this...">
    1
    </div>
  </div>
  <a href="#94843" class="name">
  <strong class="user"><em>indeyets at php dot net</em></strong></a><a class="genanchor" href="#94843"> &para;</a><div class="date" title="2009-11-27 02:58"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94843">
<div class="phpcode"><code><span class="html">It's a bit trickier, than patryk wrote:<br /><br />There are parameters (you can specify several of these at the same time):<br /><br />'i': ONIG_OPTION_IGNORECASE;<br />'x': ONIG_OPTION_EXTEND;<br />'m': ONIG_OPTION_MULTILINE;<br />'s': ONIG_OPTION_SINGLELINE;<br />'p': ONIG_OPTION_MULTILINE | ONIG_OPTION_SINGLELINE;<br />'l': ONIG_OPTION_FIND_LONGEST;<br />'n': ONIG_OPTION_FIND_NOT_EMPTY;<br />'e': eval() resulting code<br /><br />And there are "modes" (if you specify several of these, the LAST one will be used):<br />'j': ONIG_SYNTAX_JAVA;<br />'u': ONIG_SYNTAX_GNU_REGEX;<br />'g': ONIG_SYNTAX_GREP;<br />'c': ONIG_SYNTAX_EMACS;<br />'r': ONIG_SYNTAX_RUBY;<br />'z': ONIG_SYNTAX_PERL;<br />'b': ONIG_SYNTAX_POSIX_BASIC;<br />'d': ONIG_SYNTAX_POSIX_EXTENDED;<br /><br />You can find descriptions of these constants here: <a href="http://www.geocities.jp/kosako3/oniguruma/doc/API.txt" rel="nofollow" target="_blank">http://www.geocities.jp/kosako3/oniguruma/doc/API.txt</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-regex-set-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-regex-set-options.php">＋<small>add a note</small></a></div>
