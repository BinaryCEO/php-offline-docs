...
<head>
  ...
  <title>PHP: Imagick::getSizeOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getsizeoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getsizeoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsizeoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getversion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsizeoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getsizeoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getsizeoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getsizeoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getsizeoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getsizeoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getsizeoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getsizeoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getsizeoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getsizeoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getsizeoffset.php" hreflang="zh">
...
<meta name="Description" content="Returns the size offset" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getSizeOffset - Manual" />
<meta name="twitter:description" content="Returns the size offset" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getSizeOffset - Manual" />
<meta itemprop="description" content="Returns the size offset" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the size offset" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getversion.php">
          Imagick::getVersion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getsize.php">
          &laquo; Imagick::getSize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getsizeoffset.php' selected="selected">English</option>
            <option value='de/imagick.getsizeoffset.php'>German</option>
            <option value='es/imagick.getsizeoffset.php'>Spanish</option>
            <option value='fr/imagick.getsizeoffset.php'>French</option>
            <option value='it/imagick.getsizeoffset.php'>Italian</option>
            <option value='ja/imagick.getsizeoffset.php'>Japanese</option>
            <option value='pt_BR/imagick.getsizeoffset.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getsizeoffset.php'>Russian</option>
            <option value='tr/imagick.getsizeoffset.php'>Turkish</option>
            <option value='uk/imagick.getsizeoffset.php'>Ukrainian</option>
            <option value='zh/imagick.getsizeoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getsizeoffset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getSizeOffset</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getSizeOffset</span> &mdash; <span class="dc-title">Returns the size offset</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getsizeoffset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getSizeOffset</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getsizeoffset-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getsizeoffset-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getsizeoffset-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getsizeoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getsizeoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getsizeoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getsizeoffset.php">＋<small>add a note</small></a></span>
