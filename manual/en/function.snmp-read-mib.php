...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp-read-mib.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.snmp-get-valueretrieval.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmp-set-enum-print.php">
...
<meta name="Description" content="Reads and parses a MIB file into the active MIB tree" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: snmp_read_mib - Manual" />
<meta name="twitter:description" content="Reads and parses a MIB file into the active MIB tree" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: snmp_read_mib - Manual" />
<meta itemprop="description" content="Reads and parses a MIB file into the active MIB tree" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads and parses a MIB file into the active MIB tree" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp-read-mib.php' selected="selected">English</option>
            ...
            <option value='ru/function.snmp-read-mib.php'>Russian</option>
 ...
 <div class="refsect1 description" id="refsect1-function.snmp-read-mib-description">
  ...
  <p class="para rdfs-comment">
   ...
   human readable OIDs like <code class="literal">VENDOR-MIB::foo.1</code> instead of error prone numeric OIDs
   can be used.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-function.snmp-read-mib-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd><p class="para">The filename of the <abbr>MIB</abbr>.</p></dd>
...
(
    [FOO-BAR-MIB::someTable.0] =&gt; Gauge32: 6
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp-read-mib.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp-read-mib%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp-read-mib&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp-read-mib.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If you are trying to import mibs with dependencies on other mibs you will have to set the MIBDIRS environment variable.<br /><br />Unix / Linux: export MIBDIRS=/home/&lt;user&gt;/MIBS:/usr/share/snmp/mibs<br />Window: Good luck! No really.  Try this url out.  It has everything that you need to know about setting environment vars in windows.<br /><br /><a href="http://vlaurie.com/computers2/Articles/environment.htm" rel="nofollow" target="_blank">http://vlaurie.com/computers2/Articles/environment.htm</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.snmp-read-mib&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp-read-mib.php">＋<small>add a note</small></a></div>
