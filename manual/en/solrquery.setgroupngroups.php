...
<head>
  ...
  <title>PHP: SolrQuery::setGroupNGroups - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupmain.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupoffset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgroupngroups.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgroupngroups.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgroupngroups.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgroupngroups.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgroupngroups.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgroupngroups.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgroupngroups.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgroupngroups.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgroupngroups.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgroupngroups.php" hreflang="zh">
...
<meta name="Description" content="If true, Solr includes the number of groups that have matched the query in the results" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupNGroups - Manual" />
<meta name="twitter:description" content="If true, Solr includes the number of groups that have matched the query in the results" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupNGroups - Manual" />
<meta itemprop="description" content="If true, Solr includes the number of groups that have matched the query in the results" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="If true, Solr includes the number of groups that have matched the query in the results" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setgroupoffset.php">
          SolrQuery::setGroupOffset &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgroupmain.php">
          &laquo; SolrQuery::setGroupMain        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupngroups.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupngroups.php'>German</option>
            <option value='es/solrquery.setgroupngroups.php'>Spanish</option>
            <option value='fr/solrquery.setgroupngroups.php'>French</option>
            <option value='it/solrquery.setgroupngroups.php'>Italian</option>
            <option value='ja/solrquery.setgroupngroups.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgroupngroups.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgroupngroups.php'>Russian</option>
            <option value='tr/solrquery.setgroupngroups.php'>Turkish</option>
            <option value='uk/solrquery.setgroupngroups.php'>Ukrainian</option>
            <option value='zh/solrquery.setgroupngroups.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgroupngroups" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setGroupNGroups</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setGroupNGroups</span> &mdash; <span class="dc-title">If true, Solr includes the number of groups that have matched the query in the results</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setgroupngroups-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setGroupNGroups</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setgroupngroups-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setgroupngroups-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.setgroupngroups-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupngroups.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupngroups%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupngroups&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupngroups.php">＋<small>add a note</small></a></span>
