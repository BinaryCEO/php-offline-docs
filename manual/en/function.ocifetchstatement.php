...
<head>
  ...
  <title>PHP: ocifetchstatement - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocifetchstatement.php">
 <link rel="shorturl" href="https://www.php.net/ocifetchstatement">
 <link rel="alternate" href="https://www.php.net/ocifetchstatement" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocifetchinto.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocifreecollection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocifetchstatement.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocifetchstatement.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocifetchstatement.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocifetchstatement.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocifetchstatement.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocifetchstatement.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocifetchstatement.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocifetchstatement.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocifetchstatement.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocifetchstatement.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocifetchstatement.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_fetch_all" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocifetchstatement - Manual" />
<meta name="twitter:description" content="Alias of oci_fetch_all" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocifetchstatement - Manual" />
<meta itemprop="description" content="Alias of oci_fetch_all" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_fetch_all" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocifreecollection.php">
          ocifreecollection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocifetchinto.php">
          &laquo; ocifetchinto        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocifetchstatement.php' selected="selected">English</option>
            <option value='de/function.ocifetchstatement.php'>German</option>
            <option value='es/function.ocifetchstatement.php'>Spanish</option>
            <option value='fr/function.ocifetchstatement.php'>French</option>
            <option value='it/function.ocifetchstatement.php'>Italian</option>
            <option value='ja/function.ocifetchstatement.php'>Japanese</option>
            <option value='pt_BR/function.ocifetchstatement.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocifetchstatement.php'>Russian</option>
            <option value='tr/function.ocifetchstatement.php'>Turkish</option>
            <option value='uk/function.ocifetchstatement.php'>Ukrainian</option>
            <option value='zh/function.ocifetchstatement.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocifetchstatement" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocifetchstatement</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocifetchstatement</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-fetch-all.php" class="function">oci_fetch_all()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocifetchstatement-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-fetch-all.php" class="function">oci_fetch_all()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocifetchstatement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocifetchstatement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocifetchstatement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocifetchstatement.php">＋<small>add a note</small></a></span>
