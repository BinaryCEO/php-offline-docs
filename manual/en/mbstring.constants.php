...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mbstring.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mbstring.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mbstring.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/mbstring.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/mbstring.encodings.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mbstring.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mbstring.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mbstring.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mbstring.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mbstring.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mbstring.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mbstring.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mbstring.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mbstring.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mbstring.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mbstring.constants.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mbstring.encodings.php">
          Summaries of supported encodings &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mbstring.configuration.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mbstring.constants.php' selected="selected">English</option>
            <option value='de/mbstring.constants.php'>German</option>
            <option value='es/mbstring.constants.php'>Spanish</option>
            <option value='fr/mbstring.constants.php'>French</option>
            <option value='it/mbstring.constants.php'>Italian</option>
            <option value='ja/mbstring.constants.php'>Japanese</option>
            <option value='pt_BR/mbstring.constants.php'>Brazilian Portuguese</option>
            <option value='ru/mbstring.constants.php'>Russian</option>
            <option value='tr/mbstring.constants.php'>Turkish</option>
            <option value='uk/mbstring.constants.php'>Ukrainian</option>
            <option value='zh/mbstring.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mbstring.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmbstring.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mbstring.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mbstring.constants.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129855">  <div class="votes">
    <div id="Vu129855">
    <a href="/manual/vote-note.php?id=129855&amp;page=mbstring.constants&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129855">
    <a href="/manual/vote-note.php?id=129855&amp;page=mbstring.constants&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129855" title="27% like this...">
    -5
    </div>
  </div>
  <a href="#129855" class="name">
  <strong class="user"><em>php dot thus653 at passmail dot net</em></strong></a><a class="genanchor" href="#129855"> &para;</a><div class="date" title="2024-11-14 07:04"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129855">
<div class="phpcode"><code><span class="html">The MB_CASE_TITLE flag does not result in true title case but simply upper-cases each word in the title and changes all others to lowercase.<br /><br />Example:<br /><br />$string = "Mrs. Frisby and the Rats of NIMH";<br />echo mb_convert_case($string, MB_CASE_TITLE);<br /><br />Result:<br /><br />Mrs. Frisby And The Rats Of Nimh</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mbstring.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mbstring.constants.php">＋<small>add a note</small></a></div>
