...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-procedures.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-procedurecolumns.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-result.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-procedures.php' selected="selected">English</option>
            ...
            <option value='zh/function.odbc-procedures.php'>Chinese (Simplified)</option>
...
and <code class="literal">_</code> to match a single character.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-procedures-returnvalues">
  ...
  <p class="para">
   Returns an ODBC result object containing the information or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
  <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.odbc-procedures-examples">
  ...
  <div class="example" id="odbc-procedures.example.basic">
   <p><strong>Example #1 List stored Procedures of a Database</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.odbc-tables.php" class="function" rel="rdfs-seeAlso">odbc_tables()</a> - Get the list of table names stored in a specific data source</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-procedures.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-procedures%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-procedures&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-procedures.php">＋<small>add a note</small></a></span>
