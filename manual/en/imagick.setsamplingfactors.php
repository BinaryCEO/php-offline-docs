...
<head>
  ...
  <title>PHP: Imagick::setSamplingFactors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setresourcelimit.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsamplingfactors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setsamplingfactors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setsamplingfactors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setsamplingfactors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setsamplingfactors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setsamplingfactors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setsamplingfactors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setsamplingfactors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setsamplingfactors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setsamplingfactors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setsamplingfactors.php" hreflang="zh">
...
<meta name="Description" content="Sets the image sampling factors" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setSamplingFactors - Manual" />
<meta name="twitter:description" content="Sets the image sampling factors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setSamplingFactors - Manual" />
<meta itemprop="description" content="Sets the image sampling factors" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image sampling factors" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setsize.php">
          Imagick::setSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setresourcelimit.php">
          &laquo; Imagick::setResourceLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setsamplingfactors.php' selected="selected">English</option>
            <option value='de/imagick.setsamplingfactors.php'>German</option>
            <option value='es/imagick.setsamplingfactors.php'>Spanish</option>
            <option value='fr/imagick.setsamplingfactors.php'>French</option>
            <option value='it/imagick.setsamplingfactors.php'>Italian</option>
            <option value='ja/imagick.setsamplingfactors.php'>Japanese</option>
            <option value='pt_BR/imagick.setsamplingfactors.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setsamplingfactors.php'>Russian</option>
            <option value='tr/imagick.setsamplingfactors.php'>Turkish</option>
            <option value='uk/imagick.setsamplingfactors.php'>Ukrainian</option>
            <option value='zh/imagick.setsamplingfactors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setsamplingfactors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setSamplingFactors</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setSamplingFactors</span> &mdash; <span class="dc-title">Sets the image sampling factors</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setsamplingfactors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setSamplingFactors</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$factors</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setsamplingfactors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">factors</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setsamplingfactors-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3109">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setsamplingfactors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setsamplingfactors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setsamplingfactors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setsamplingfactors.php">＋<small>add a note</small></a></span>
