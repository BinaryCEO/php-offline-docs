...
<head>
  ...
  <title>PHP: Imagick::deleteImageArtifact - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.deleteimageartifact.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.deleteimageartifact.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.deleteimageartifact.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.deconstructimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.deleteimageproperty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.deleteimageartifact.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.deleteimageartifact.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.deleteimageartifact.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.deleteimageartifact.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.deleteimageartifact.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.deleteimageartifact.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.deleteimageartifact.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.deleteimageartifact.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.deleteimageartifact.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.deleteimageartifact.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.deleteimageartifact.php" hreflang="zh">
...
<meta name="Description" content="Delete image artifact" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::deleteImageArtifact - Manual" />
<meta name="twitter:description" content="Delete image artifact" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::deleteImageArtifact - Manual" />
<meta itemprop="description" content="Delete image artifact" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete image artifact" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.deleteimageproperty.php">
          Imagick::deleteImageProperty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.deconstructimages.php">
          &laquo; Imagick::deconstructImages        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.deleteimageartifact.php' selected="selected">English</option>
            <option value='de/imagick.deleteimageartifact.php'>German</option>
            <option value='es/imagick.deleteimageartifact.php'>Spanish</option>
            <option value='fr/imagick.deleteimageartifact.php'>French</option>
            <option value='it/imagick.deleteimageartifact.php'>Italian</option>
            <option value='ja/imagick.deleteimageartifact.php'>Japanese</option>
            <option value='pt_BR/imagick.deleteimageartifact.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.deleteimageartifact.php'>Russian</option>
            <option value='tr/imagick.deleteimageartifact.php'>Turkish</option>
            <option value='uk/imagick.deleteimageartifact.php'>Ukrainian</option>
            <option value='zh/imagick.deleteimageartifact.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.deleteimageartifact" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.getimageartifact.php" class="function" rel="rdfs-seeAlso">Imagick::getImageArtifact()</a> - Get image artifact</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/deleteimageartifact.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.deleteimageartifact%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.deleteimageartifact&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.deleteimageartifact.php">＋<small>add a note</small></a></span>
