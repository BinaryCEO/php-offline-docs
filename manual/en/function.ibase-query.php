...
<head>
  ...
  <title>PHP: ibase_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-query.php">
 <link rel="shorturl" href="https://www.php.net/ibase-query">
 <link rel="alternate" href="https://www.php.net/ibase-query" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-prepare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-restore.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-query.php" hreflang="zh">
...
<meta name="Description" content="Execute a query on an InterBase database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_query - Manual" />
<meta name="twitter:description" content="Execute a query on an InterBase database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_query - Manual" />
<meta itemprop="description" content="Execute a query on an InterBase database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a query on an InterBase database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-query.php' selected="selected">English</option>
            <option value='de/function.ibase-query.php'>German</option>
            <option value='es/function.ibase-query.php'>Spanish</option>
            <option value='fr/function.ibase-query.php'>French</option>
            <option value='it/function.ibase-query.php'>Italian</option>
            <option value='ja/function.ibase-query.php'>Japanese</option>
            <option value='pt_BR/function.ibase-query.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-query.php'>Russian</option>
            <option value='tr/function.ibase-query.php'>Turkish</option>
            <option value='uk/function.ibase-query.php'>Ukrainian</option>
            <option value='zh/function.ibase-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-query" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-free-result.php" class="function" rel="rdfs-seeAlso">ibase_free_result()</a> - Free a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-query.php">＋<small>add a note</small></a></span>
