...
<head>
  ...
  <title>PHP: GearmanClient::setExceptionCallback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.setdatacallback.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.setfailcallback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.setexceptioncallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.setexceptioncallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.setexceptioncallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.setexceptioncallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.setexceptioncallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.setexceptioncallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.setexceptioncallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.setexceptioncallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.setexceptioncallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.setexceptioncallback.php" hreflang="zh">
...
<meta name="Description" content="Set a callback for worker exceptions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setExceptionCallback - Manual" />
<meta name="twitter:description" content="Set a callback for worker exceptions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setExceptionCallback - Manual" />
<meta itemprop="description" content="Set a callback for worker exceptions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set a callback for worker exceptions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.setfailcallback.php">
          GearmanClient::setFailCallback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.setdatacallback.php">
          &laquo; GearmanClient::setDataCallback        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setexceptioncallback.php' selected="selected">English</option>
            <option value='de/gearmanclient.setexceptioncallback.php'>German</option>
            <option value='es/gearmanclient.setexceptioncallback.php'>Spanish</option>
            <option value='fr/gearmanclient.setexceptioncallback.php'>French</option>
            <option value='it/gearmanclient.setexceptioncallback.php'>Italian</option>
            <option value='ja/gearmanclient.setexceptioncallback.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.setexceptioncallback.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.setexceptioncallback.php'>Russian</option>
            <option value='tr/gearmanclient.setexceptioncallback.php'>Turkish</option>
            <option value='uk/gearmanclient.setexceptioncallback.php'>Ukrainian</option>
            <option value='zh/gearmanclient.setexceptioncallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.setexceptioncallback" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.setexceptioncallback-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::setExceptionCallback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setexceptioncallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setexceptioncallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setexceptioncallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php">＋<small>add a note</small></a></span>
