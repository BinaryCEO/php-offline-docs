...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqli.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.persistconns.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.configuration.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.persistconns.php">
          The mysqli Extension and Persistent Connections &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.configuration.php' selected="selected">English</option>
            <option value='de/mysqli.configuration.php'>German</option>
            <option value='es/mysqli.configuration.php'>Spanish</option>
            <option value='fr/mysqli.configuration.php'>French</option>
            <option value='it/mysqli.configuration.php'>Italian</option>
            <option value='ja/mysqli.configuration.php'>Japanese</option>
            <option value='pt_BR/mysqli.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.configuration.php'>Russian</option>
            <option value='tr/mysqli.configuration.php'>Turkish</option>
            <option value='uk/mysqli.configuration.php'>Ukrainian</option>
            <option value='zh/mysqli.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.configuration" class="section">
 ...
 <p class="para">
   ...
   streams would interpret the value of <code class="literal">MYSQL_OPT_READ_TIMEOUT</code>. 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.configuration.php">＋<small>add a note</small></a></span>
