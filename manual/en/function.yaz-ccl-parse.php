...
<head>
  ...
  <title>PHP: yaz_ccl_parse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaz-ccl-parse.php">
 <link rel="shorturl" href="https://www.php.net/yaz-ccl-parse">
 <link rel="alternate" href="https://www.php.net/yaz-ccl-parse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.yaz.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.yaz-ccl-conf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaz-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.yaz-ccl-parse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.yaz-ccl-parse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.yaz-ccl-parse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.yaz-ccl-parse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.yaz-ccl-parse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.yaz-ccl-parse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.yaz-ccl-parse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.yaz-ccl-parse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.yaz-ccl-parse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.yaz-ccl-parse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.yaz-ccl-parse.php" hreflang="zh">
...
<meta name="Description" content="Invoke CCL Parser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: yaz_ccl_parse - Manual" />
<meta name="twitter:description" content="Invoke CCL Parser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: yaz_ccl_parse - Manual" />
<meta itemprop="description" content="Invoke CCL Parser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Invoke CCL Parser" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaz-ccl-parse.php' selected="selected">English</option>
            <option value='de/function.yaz-ccl-parse.php'>German</option>
            <option value='es/function.yaz-ccl-parse.php'>Spanish</option>
            <option value='fr/function.yaz-ccl-parse.php'>French</option>
            <option value='it/function.yaz-ccl-parse.php'>Italian</option>
            <option value='ja/function.yaz-ccl-parse.php'>Japanese</option>
            <option value='pt_BR/function.yaz-ccl-parse.php'>Brazilian Portuguese</option>
            <option value='ru/function.yaz-ccl-parse.php'>Russian</option>
            <option value='tr/function.yaz-ccl-parse.php'>Turkish</option>
            <option value='uk/function.yaz-ccl-parse.php'>Ukrainian</option>
            <option value='zh/function.yaz-ccl-parse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.yaz-ccl-parse" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.yaz-ccl-parse-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>yaz_ccl_parse</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$id</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$query</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$result</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function invokes a CCL parser. It converts a given CCL FIND query to
   an RPN query which may be passed to the <span class="function"><a href="function.yaz-search.php" class="function">yaz_search()</a></span> 
   function to perform a search.
  </p>
  <p class="para">
   To define a set of valid CCL fields call <span class="function"><a href="function.yaz-ccl-conf.php" class="function">yaz_ccl_conf()</a></span> 
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />yaz_ccl_conf</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$fields</span><span style="color: #007700">);  </span><span style="color: #FF8000">// see example for yaz_ccl_conf<br /></span><span style="color: #007700">if (!</span><span style="color: #0000BB">yaz_ccl_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$ccl</span><span style="color: #007700">, </span><span style="color: #0000BB">$cclresult</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">'Error: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">$cclresult</span><span style="color: #007700">[</span><span style="color: #DD0000">"errorstring"</span><span style="color: #007700">];<br />} else {<br />    </span><span style="color: #0000BB">$rpn </span><span style="color: #007700">= </span><span style="color: #0000BB">$cclresult</span><span style="color: #007700">[</span><span style="color: #DD0000">"rpn"</span><span style="color: #007700">];<br />    </span><span style="color: #0000BB">yaz_search</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #DD0000">"rpn"</span><span style="color: #007700">, </span><span style="color: #0000BB">$rpn</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/functions/yaz-ccl-parse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaz-ccl-parse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaz-ccl-parse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaz-ccl-parse.php">＋<small>add a note</small></a></span>
