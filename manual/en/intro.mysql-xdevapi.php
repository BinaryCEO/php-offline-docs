...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.mysql-xdevapi.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.mysql-xdevapi.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.mysql-xdevapi.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.mysql-xdevapi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.mysql-xdevapi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.mysql-xdevapi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.mysql-xdevapi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.mysql-xdevapi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.mysql-xdevapi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.mysql-xdevapi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.mysql-xdevapi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.mysql-xdevapi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.mysql-xdevapi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.mysql-xdevapi.php" hreflang="zh">
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="mysql-xdevapi.setup.php">
          Installing/Configuring &raquo;
              ...
              <div class="prev">
        <a href="book.mysql-xdevapi.php">
          &laquo; Mysql_xdevapi        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.mysql-xdevapi.php' selected="selected">English</option>
            <option value='de/intro.mysql-xdevapi.php'>German</option>
            <option value='es/intro.mysql-xdevapi.php'>Spanish</option>
            <option value='fr/intro.mysql-xdevapi.php'>French</option>
            <option value='it/intro.mysql-xdevapi.php'>Italian</option>
            <option value='ja/intro.mysql-xdevapi.php'>Japanese</option>
            <option value='pt_BR/intro.mysql-xdevapi.php'>Brazilian Portuguese</option>
            <option value='ru/intro.mysql-xdevapi.php'>Russian</option>
            <option value='tr/intro.mysql-xdevapi.php'>Turkish</option>
            <option value='uk/intro.mysql-xdevapi.php'>Ukrainian</option>
            <option value='zh/intro.mysql-xdevapi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.mysql-xdevapi" class="preface">
  ...
  <p class="para">
   ...
   chapter in the MySQL manual.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.mysql-xdevapi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.mysql-xdevapi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.mysql-xdevapi.php">＋<small>add a note</small></a></span>
