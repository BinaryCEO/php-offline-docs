...
<head>
  ...
  <title>PHP: mysql_list_dbs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-list-dbs.php">
 <link rel="shorturl" href="https://www.php.net/mysql-list-dbs">
 <link rel="alternate" href="https://www.php.net/mysql-list-dbs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-insert-id.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-list-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-list-dbs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-list-dbs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-list-dbs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-list-dbs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-list-dbs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-list-dbs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-list-dbs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-list-dbs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-list-dbs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-list-dbs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-list-dbs.php" hreflang="zh">
...
<meta name="Description" content="List databases available on a MySQL server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_list_dbs - Manual" />
<meta name="twitter:description" content="List databases available on a MySQL server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_list_dbs - Manual" />
<meta itemprop="description" content="List databases available on a MySQL server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List databases available on a MySQL server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-list-fields.php">
          mysql_list_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-insert-id.php">
          &laquo; mysql_insert_id        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-list-dbs.php' selected="selected">English</option>
            <option value='de/function.mysql-list-dbs.php'>German</option>
            <option value='es/function.mysql-list-dbs.php'>Spanish</option>
            <option value='fr/function.mysql-list-dbs.php'>French</option>
            <option value='it/function.mysql-list-dbs.php'>Italian</option>
            <option value='ja/function.mysql-list-dbs.php'>Japanese</option>
            <option value='pt_BR/function.mysql-list-dbs.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-list-dbs.php'>Russian</option>
            <option value='tr/function.mysql-list-dbs.php'>Turkish</option>
            <option value='uk/function.mysql-list-dbs.php'>Ukrainian</option>
            <option value='zh/function.mysql-list-dbs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-list-dbs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_list_dbs</h1>
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_list_dbs</span> &mdash; <span class="dc-title">List databases available on a MySQL server</span></p>

 </div>

 <div id="function.mysql-list-dbs-refsynopsisdiv">
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">This function was deprecated in PHP 5.4.0, and it
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li>SQL Query: <code class="literal">SHOW DATABASES</code></li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-list-dbs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_list_dbs</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mysql-list-dbs-parameters">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-list-dbs-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a result pointer <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on
   failure. Use the <span class="function"><a href="function.mysql-tablename.php" class="function">mysql_tablename()</a></span> function to traverse 
...
database3</pre>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-list-dbs-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    For backward compatibility, the following
deprecated alias may be used: 
    <span class="function"><strong>mysql_listdbs()</strong></span>
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.mysql-list-dbs-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-select-db.php" class="function" rel="rdfs-seeAlso">mysql_select_db()</a> - Select a MySQL database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-list-dbs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-list-dbs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-list-dbs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-list-dbs.php">＋<small>add a note</small></a></span>
