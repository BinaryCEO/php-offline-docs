...
<head>
  ...
  <title>PHP: SolrQuery::addFacetQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addfacetquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addfacetquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfacetfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfacetquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addfacetquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addfacetquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addfacetquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addfacetquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addfacetquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addfacetquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addfacetquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addfacetquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addfacetquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addfacetquery.php" hreflang="zh">
...
<meta name="Description" content="Adds a facet query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addFacetQuery - Manual" />
<meta name="twitter:description" content="Adds a facet query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addFacetQuery - Manual" />
<meta itemprop="description" content="Adds a facet query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a facet query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addfield.php">
          SolrQuery::addField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addfacetfield.php">
          &laquo; SolrQuery::addFacetField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addfacetquery.php' selected="selected">English</option>
            <option value='de/solrquery.addfacetquery.php'>German</option>
            <option value='es/solrquery.addfacetquery.php'>Spanish</option>
            <option value='fr/solrquery.addfacetquery.php'>French</option>
            <option value='it/solrquery.addfacetquery.php'>Italian</option>
            <option value='ja/solrquery.addfacetquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.addfacetquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addfacetquery.php'>Russian</option>
            <option value='tr/solrquery.addfacetquery.php'>Turkish</option>
            <option value='uk/solrquery.addfacetquery.php'>Ukrainian</option>
            <option value='zh/solrquery.addfacetquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addfacetquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addFacetQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addFacetQuery</span> &mdash; <span class="dc-title">Adds a facet query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addfacetquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addFacetQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$facetQuery</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addfacetquery-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">facetQuery</code></dt>
     <dd>
      <p class="para">
       The facet query
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addfacetquery-returnvalues">
...
(
    ...
    [price:[500 TO *]] =&gt; 2
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addfacetquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addfacetquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addfacetquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addfacetquery.php">＋<small>add a note</small></a></span>
