...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-htmlinline.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-htmlblock.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node-image.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-htmlinline.php' selected="selected">English</option>
            ...
            <option value='zh/class.commonmark-node-htmlinline.php'>Chinese (Simplified)</option>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node.accept.php" class="methodname">CommonMark\Node::accept</a></span>(<span class="methodparam"><span class="type"><a href="class.commonmark-interfaces-ivisitor.php" class="type CommonMark\Interfaces\IVisitor">CommonMark\Interfaces\IVisitor</a></span> <code class="parameter">$visitor</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.htmlinline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-htmlinline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-htmlinline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-htmlinline.php">＋<small>add a note</small></a></span>
