...
<head>
  ...
  <title>PHP: ldap_next_attribute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-next-attribute.php">
 <link rel="shorturl" href="https://www.php.net/ldap-next-attribute">
 <link rel="alternate" href="https://www.php.net/ldap-next-attribute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-modify-batch.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-next-entry.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-next-attribute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-next-attribute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-next-attribute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-next-attribute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-next-attribute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-next-attribute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-next-attribute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-next-attribute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-next-attribute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-next-attribute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-next-attribute.php" hreflang="zh">
...
<meta name="Description" content="Get the next attribute in result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_next_attribute - Manual" />
<meta name="twitter:description" content="Get the next attribute in result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_next_attribute - Manual" />
<meta itemprop="description" content="Get the next attribute in result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the next attribute in result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-next-entry.php">
          ldap_next_entry &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-modify-batch.php">
          &laquo; ldap_modify_batch        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-next-attribute.php' selected="selected">English</option>
            <option value='de/function.ldap-next-attribute.php'>German</option>
            <option value='es/function.ldap-next-attribute.php'>Spanish</option>
            <option value='fr/function.ldap-next-attribute.php'>French</option>
            <option value='it/function.ldap-next-attribute.php'>Italian</option>
            <option value='ja/function.ldap-next-attribute.php'>Japanese</option>
            <option value='pt_BR/function.ldap-next-attribute.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-next-attribute.php'>Russian</option>
            <option value='tr/function.ldap-next-attribute.php'>Turkish</option>
            <option value='uk/function.ldap-next-attribute.php'>Ukrainian</option>
            <option value='zh/function.ldap-next-attribute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-next-attribute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_next_attribute</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_next_attribute</span> &mdash; <span class="dc-title">Get the next attribute in result</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-next-attribute-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_next_attribute</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type">LDAP\ResultEntry</span> <code class="parameter">$entry</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">entry</code> returned from
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-next-attribute-returnvalues">
  ...
  <p class="para">
   Returns the next attribute in an entry on success and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on
   error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-get-attributes.php" class="function" rel="rdfs-seeAlso">ldap_get_attributes()</a> - Get attributes from a search result entry</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-next-attribute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-next-attribute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-next-attribute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-next-attribute.php">＋<small>add a note</small></a></span>
