...
<head>
  ...
  <title>PHP: date_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-create.php">
 <link rel="shorturl" href="https://www.php.net/date-create">
 <link rel="alternate" href="https://www.php.net/date-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-create-from-format.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-create.php" hreflang="zh">
...
<meta name="Description" content="create a new DateTime object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_create - Manual" />
<meta name="twitter:description" content="create a new DateTime object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_create - Manual" />
<meta itemprop="description" content="create a new DateTime object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="create a new DateTime object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-create-from-format.php">
          date_create_from_format &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-create.php' selected="selected">English</option>
            <option value='de/function.date-create.php'>German</option>
            <option value='es/function.date-create.php'>Spanish</option>
            <option value='fr/function.date-create.php'>French</option>
            <option value='it/function.date-create.php'>Italian</option>
            <option value='ja/function.date-create.php'>Japanese</option>
            <option value='pt_BR/function.date-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-create.php'>Russian</option>
            <option value='tr/function.date-create.php'>Turkish</option>
            <option value='uk/function.date-create.php'>Ukrainian</option>
            <option value='zh/function.date-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-create" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_create</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_create</span> &mdash; <span class="dc-title">create a new <span class="classname"><a href="class.datetime.php" class="classname">DateTime</a></span> object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.date-create-description">
  ...
  <p class="para">
   Unlike the <span class="classname"><a href="class.datetime.php" class="classname">DateTime</a></span> constructor, it will return
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> instead of an exception if the passed in
   <code class="parameter">datetime</code> string is invalid.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.date-create-parameters">
  ...
  <p class="para">
   See <a href="datetimeimmutable.construct.php" class="link">DateTimeImmutable::__construct</a>.
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="datetime.construct.php" class="methodname" rel="rdfs-seeAlso">DateTime::__construct()</a> - Returns new DateTime object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-create.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130432">  <div class="votes">
    <div id="Vu130432">
    <a href="/manual/vote-note.php?id=130432&amp;page=function.date-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130432">
    <a href="/manual/vote-note.php?id=130432&amp;page=function.date-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130432" title="50% like this...">
    0
    </div>
  </div>
  <a href="#130432" class="name">
  <strong class="user"><em>bugarindev at gmail dot com</em></strong></a><a class="genanchor" href="#130432"> &para;</a><div class="date" title="2025-07-29 02:11"><strong>2 months ago</strong></div>
  <div class="text" id="Hcom130432">
<div class="phpcode"><code><span class="html">If $datetime value is `null`, empty string, or whitespace(s), it will default to the current datetime or 'now'.<br /><br /><span class="default">&lt;?php<br />$date </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">; </span><span class="comment">// or '' or '     '<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">date_create</span><span class="keyword">(</span><span class="default">$date</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />returns<br /><br /><span class="default">&lt;?php<br />object</span><span class="keyword">(</span><span class="default">DateTime</span><span class="keyword">)</span><span class="comment">#1 (3) {<br />  </span><span class="keyword">[</span><span class="string">"date"</span><span class="keyword">]=&gt;<br />  </span><span class="default">string</span><span class="keyword">(</span><span class="default">26</span><span class="keyword">) </span><span class="string">"2025-07-29 00:59:02.992777"<br />  </span><span class="keyword">[</span><span class="string">"timezone_type"</span><span class="keyword">]=&gt;<br />  </span><span class="default">int</span><span class="keyword">(</span><span class="default">3</span><span class="keyword">)<br />  [</span><span class="string">"timezone"</span><span class="keyword">]=&gt;<br />  </span><span class="default">string</span><span class="keyword">(</span><span class="default">3</span><span class="keyword">) </span><span class="string">"UTC"<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.date-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-create.php">＋<small>add a note</small></a></div>
