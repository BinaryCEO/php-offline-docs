...
<head>
  ...
  <title>PHP: EvPeriodic - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.evperiodic.php">
 <link rel="shorturl" href="https://www.php.net/evperiodic">
 <link rel="alternate" href="https://www.php.net/evperiodic" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ev.php">
 <link rel="prev" href="https://www.php.net/manual/en/evloop.verify.php">
 <link rel="next" href="https://www.php.net/manual/en/evperiodic.again.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.evperiodic.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.evperiodic.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.evperiodic.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.evperiodic.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.evperiodic.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.evperiodic.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.evperiodic.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.evperiodic.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.evperiodic.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.evperiodic.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.evperiodic.php" hreflang="zh">
...
<meta name="Description" content="The EvPeriodic class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EvPeriodic - Manual" />
<meta name="twitter:description" content="The EvPeriodic class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EvPeriodic - Manual" />
<meta itemprop="description" content="The EvPeriodic class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EvPeriodic class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="evperiodic.again.php">
          EvPeriodic::again &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="evloop.verify.php">
          &laquo; EvLoop::verify        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.evperiodic.php' selected="selected">English</option>
            <option value='de/class.evperiodic.php'>German</option>
            <option value='es/class.evperiodic.php'>Spanish</option>
            <option value='fr/class.evperiodic.php'>French</option>
            <option value='it/class.evperiodic.php'>Italian</option>
            <option value='ja/class.evperiodic.php'>Japanese</option>
            <option value='pt_BR/class.evperiodic.php'>Brazilian Portuguese</option>
            <option value='ru/class.evperiodic.php'>Russian</option>
            <option value='tr/class.evperiodic.php'>Turkish</option>
            <option value='uk/class.evperiodic.php'>Ukrainian</option>
            <option value='zh/class.evperiodic.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.evperiodic" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="evperiodic.again.php">EvPeriodic::again</a> — Simply stops and restarts the periodic watcher again</li><li><a href="evperiodic.at.php">EvPeriodic::at</a> — Returns the absolute time that this
  watcher is supposed to trigger next</li><li><a href="evperiodic.construct.php">EvPeriodic::__construct</a> — Constructs EvPeriodic watcher object</li><li><a href="evperiodic.createstopped.php">EvPeriodic::createStopped</a> — Create a stopped EvPeriodic watcher</li><li><a href="evperiodic.set.php">EvPeriodic::set</a> — Configures the watcher</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ev/evperiodic.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.evperiodic%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.evperiodic&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.evperiodic.php">＋<small>add a note</small></a></span>
