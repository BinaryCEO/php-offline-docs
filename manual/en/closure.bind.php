...
<head>
  ...
  <title>PHP: Closure::bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/closure.bind.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/closure.bind.php">
 <link rel="alternate" href="https://www.php.net/manual/en/closure.bind.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.closure.php">
 <link rel="prev" href="https://www.php.net/manual/en/closure.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/closure.bindto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/closure.bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/closure.bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/closure.bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/closure.bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/closure.bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/closure.bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/closure.bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/closure.bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/closure.bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/closure.bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/closure.bind.php" hreflang="zh">
...
<meta name="Description" content="Duplicates a closure with a specific bound object and class scope" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Closure::bind - Manual" />
<meta name="twitter:description" content="Duplicates a closure with a specific bound object and class scope" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Closure::bind - Manual" />
<meta itemprop="description" content="Duplicates a closure with a specific bound object and class scope" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Duplicates a closure with a specific bound object and class scope" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="closure.bindto.php">
          Closure::bindTo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="closure.construct.php">
          &laquo; Closure::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/closure.bind.php' selected="selected">English</option>
            <option value='de/closure.bind.php'>German</option>
            <option value='es/closure.bind.php'>Spanish</option>
            <option value='fr/closure.bind.php'>French</option>
            <option value='it/closure.bind.php'>Italian</option>
            <option value='ja/closure.bind.php'>Japanese</option>
            <option value='pt_BR/closure.bind.php'>Brazilian Portuguese</option>
            <option value='ru/closure.bind.php'>Russian</option>
            <option value='tr/closure.bind.php'>Turkish</option>
            <option value='uk/closure.bind.php'>Ukrainian</option>
            <option value='zh/closure.bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="closure.bind" class="refentry">
...
2</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-closure.bind-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="closure.bindto.php" class="methodname" rel="rdfs-seeAlso">Closure::bindTo()</a> - Duplicates the closure with a new bound object and class scope</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/closure/bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclosure.bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=closure.bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/closure.bind.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110845">  <div class="votes">
    <div id="Vu110845">
    <a href="/manual/vote-note.php?id=110845&amp;page=closure.bind&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110845">
    <a href="/manual/vote-note.php?id=110845&amp;page=closure.bind&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110845" title="85% like this...">
    97
    </div>
  </div>
  <a href="#110845" class="name">
  <strong class="user"><em>Vincius Krolow</em></strong></a><a class="genanchor" href="#110845"> &para;</a><div class="date" title="2012-12-14 12:08"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110845">
<div class="phpcode"><code><span class="html">With this class and method, it's possible to do nice things, like add methods on the fly to an object.<br /><br />MetaTrait.php<br /><span class="default">&lt;?php<br /></span><span class="keyword">trait </span><span class="default">MetaTrait<br /></span><span class="keyword">{<br />    <br />    private </span><span class="default">$methods </span><span class="keyword">= array();<br /> <br />    public function </span><span class="default">addMethod</span><span class="keyword">(</span><span class="default">$methodName</span><span class="keyword">, </span><span class="default">$methodCallable</span><span class="keyword">)<br />    {<br />        if (!</span><span class="default">is_callable</span><span class="keyword">(</span><span class="default">$methodCallable</span><span class="keyword">)) {<br />            throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">'Second param must be callable'</span><span class="keyword">);<br />        }<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">methods</span><span class="keyword">[</span><span class="default">$methodName</span><span class="keyword">] = </span><span class="default">Closure</span><span class="keyword">::</span><span class="default">bind</span><span class="keyword">(</span><span class="default">$methodCallable</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">, </span><span class="default">get_class</span><span class="keyword">());<br />    }<br /> <br />    public function </span><span class="default">__call</span><span class="keyword">(</span><span class="default">$methodName</span><span class="keyword">, array </span><span class="default">$args</span><span class="keyword">)<br />    {<br />        if (isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">methods</span><span class="keyword">[</span><span class="default">$methodName</span><span class="keyword">])) {<br />            return </span><span class="default">call_user_func_array</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">methods</span><span class="keyword">[</span><span class="default">$methodName</span><span class="keyword">], </span><span class="default">$args</span><span class="keyword">);<br />        }<br /> <br />        throw </span><span class="default">RunTimeException</span><span class="keyword">(</span><span class="string">'There is no method with the given name to call'</span><span class="keyword">);<br />    }<br /> <br />}<br /></span><span class="default">?&gt;<br /></span><br />test.php<br /><span class="default">&lt;?php<br /></span><span class="keyword">require </span><span class="string">'MetaTrait.php'</span><span class="keyword">;<br /> <br />class </span><span class="default">HackThursday </span><span class="keyword">{<br />    use </span><span class="default">MetaTrait</span><span class="keyword">;<br /> <br />    private </span><span class="default">$dayOfWeek </span><span class="keyword">= </span><span class="string">'Thursday'</span><span class="keyword">;<br /> <br />}<br /> <br /></span><span class="default">$test </span><span class="keyword">= new </span><span class="default">HackThursday</span><span class="keyword">();<br /></span><span class="default">$test</span><span class="keyword">-&gt;</span><span class="default">addMethod</span><span class="keyword">(</span><span class="string">'when'</span><span class="keyword">, function () {<br />    return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">dayOfWeek</span><span class="keyword">;<br />});<br /> <br />echo </span><span class="default">$test</span><span class="keyword">-&gt;</span><span class="default">when</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116267">  <div class="votes">
    <div id="Vu116267">
    <a href="/manual/vote-note.php?id=116267&amp;page=closure.bind&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116267">
    <a href="/manual/vote-note.php?id=116267&amp;page=closure.bind&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116267" title="72% like this...">
    11
    </div>
  </div>
  <a href="#116267" class="name">
  <strong class="user"><em>potherca at hotmail dot com</em></strong></a><a class="genanchor" href="#116267"> &para;</a><div class="date" title="2014-12-03 08:22"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116267">
<div class="phpcode"><code><span class="html">If you need to validate whether or not a closure can be bound to a PHP object, you will have to resort to using reflection.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/**<br /> * @param \Closure $callable<br /> *<br /> * @return bool<br /> */<br /></span><span class="keyword">function </span><span class="default">isBindable</span><span class="keyword">(</span><span class="default">\Closure $callable</span><span class="keyword">)<br />{<br />    </span><span class="default">$bindable </span><span class="keyword">= </span><span class="default">false</span><span class="keyword">;<br /><br />    </span><span class="default">$reflectionFunction </span><span class="keyword">= new </span><span class="default">\ReflectionFunction</span><span class="keyword">(</span><span class="default">$callable</span><span class="keyword">);<br />    if (<br />        </span><span class="default">$reflectionFunction</span><span class="keyword">-&gt;</span><span class="default">getClosureScopeClass</span><span class="keyword">() === </span><span class="default">null<br />        </span><span class="keyword">|| </span><span class="default">$reflectionFunction</span><span class="keyword">-&gt;</span><span class="default">getClosureThis</span><span class="keyword">() !== </span><span class="default">null<br />    </span><span class="keyword">) {<br />        </span><span class="default">$bindable </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;<br />    }<br /><br />    return </span><span class="default">$bindable</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=closure.bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/closure.bind.php">＋<small>add a note</small></a></div>
