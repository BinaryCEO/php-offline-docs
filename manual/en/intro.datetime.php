...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.datetime.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.datetime.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.datetime.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.datetime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.datetime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.datetime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.datetime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.datetime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.datetime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.datetime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.datetime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.datetime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.datetime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.datetime.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.datetime.php' selected="selected">English</option>
            <option value='de/intro.datetime.php'>German</option>
            <option value='es/intro.datetime.php'>Spanish</option>
            <option value='fr/intro.datetime.php'>French</option>
            <option value='it/intro.datetime.php'>Italian</option>
            <option value='ja/intro.datetime.php'>Japanese</option>
            <option value='pt_BR/intro.datetime.php'>Brazilian Portuguese</option>
            <option value='ru/intro.datetime.php'>Russian</option>
            <option value='tr/intro.datetime.php'>Turkish</option>
            <option value='uk/intro.datetime.php'>Ukrainian</option>
            <option value='zh/intro.datetime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.datetime" class="preface">
   ...
   <span class="simpara">
    ...
    <a href="timezones.php" class="xref">List of Supported Timezones</a>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.datetime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.datetime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.datetime.php">＋<small>add a note</small></a></span>
