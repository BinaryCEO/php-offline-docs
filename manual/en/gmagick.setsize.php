...
<head>
  ...
  <title>PHP: Gmagick::setsize - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setsize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setsize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setsize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setsamplingfactors.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.shearimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setsize.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setsize.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setsize.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setsize.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setsize.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setsize.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setsize.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setsize.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setsize.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setsize.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setsize.php" hreflang="zh">
...
<meta name="Description" content="Sets the size of the Gmagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::setsize - Manual" />
<meta name="twitter:description" content="Sets the size of the Gmagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setsize - Manual" />
<meta itemprop="description" content="Sets the size of the Gmagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the size of the Gmagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.shearimage.php">
          Gmagick::shearimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setsamplingfactors.php">
          &laquo; Gmagick::setsamplingfactors        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setsize.php' selected="selected">English</option>
            <option value='de/gmagick.setsize.php'>German</option>
            <option value='es/gmagick.setsize.php'>Spanish</option>
            <option value='fr/gmagick.setsize.php'>French</option>
            <option value='it/gmagick.setsize.php'>Italian</option>
            <option value='ja/gmagick.setsize.php'>Japanese</option>
            <option value='pt_BR/gmagick.setsize.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setsize.php'>Russian</option>
            <option value='tr/gmagick.setsize.php'>Turkish</option>
            <option value='uk/gmagick.setsize.php'>Ukrainian</option>
            <option value='zh/gmagick.setsize.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setsize" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setsize</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setsize</span> &mdash; <span class="dc-title">Sets the size of the Gmagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setsize-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setsize</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>

  <p class="para rdfs-comment">
   Sets the size of the Gmagick object. Set it before you read a raw image format such as <strong><code><a href="gmagick.constants.php#gmagick.constants.colorspace-rgb">Gmagick::COLORSPACE_RGB</a></code></strong>,
   <strong><code><a href="gmagick.constants.php#gmagick.constants.colorspace-gray">Gmagick::COLORSPACE_GRAY</a></code></strong>, or <strong><code><a href="gmagick.constants.php#gmagick.constants.colorspace-cmyk">Gmagick::COLORSPACE_CMYK</a></code></strong>. 
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.setsize-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setsize-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setsize-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setsize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setsize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setsize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setsize.php">＋<small>add a note</small></a></span>
