...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunction.invokeargs.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunction.invokeargs.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunction.invokeargs.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunction.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunction.invoke.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunction.isanonymous.php">
...
<meta name="Description" content="Invokes function args" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunction::invokeArgs - Manual" />
<meta name="twitter:description" content="Invokes function args" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunction::invokeArgs - Manual" />
<meta itemprop="description" content="Invokes function args" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Invokes function args" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunction.invokeargs.php' selected="selected">English</option>
            ...
            <option value='pt_BR/reflectionfunction.invokeargs.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionFunction::invokeArgs</span> &mdash; <span class="dc-title">Invokes function args</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="function"><a href="function.call-user-func-array.php" class="function">call_user_func_array()</a></span> works.
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionfunction.invokeargs-examples">
  ...
  <p class="para">
   <div class="example" id="example-5544">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionFunction::invokeArgs()</strong></span> example</strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">Dr. Phil</pre>
  ...
  <p class="para">
   <div class="example" id="example-5545">
    <p><strong>Example #2 <span class="methodname"><strong>ReflectionFunction::invokeArgs()</strong></span> with references example</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.call-user-func-array.php" class="function" rel="rdfs-seeAlso">call_user_func_array()</a> - Call a callback with an array of parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunction/invokeargs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunction.invokeargs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunction.invokeargs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunction.invokeargs.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>theyourcomputer at gmail dot com</em></strong></a><a class="genanchor" href="#121978"> &para;</a><div class="date" title="2017-12-05 01:40"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121978">
<div class="phpcode"><code><span class="html">In the case of call_user_func_array(), if you were to pass around an anonymous function and reference $this within the anonymous function, $this will faithfully refer to the class in the context in which the function was defined. Using ReflectionFunction::invokeArgs() does not seem to retain its original context--yeah, even if you bind the anonymous function before invoking. I recommend call_user_func_array() where context is a concern.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I encountered a weird problem with ReflectionFunction, described in ticket 44139 of PHP Bugs.
<br />
<br />If for some reason you need to call with invoke, or invokeArgs, a function like array_unshift (that accepts internally the array by reference) you could use this code to avoid the generated warning or fatal error.
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">unshift</span><span class="keyword">(){
<br />    </span><span class="default">$ref        </span><span class="keyword">= new </span><span class="default">ReflectionFunction</span><span class="keyword">(</span><span class="string">'array_unshift'</span><span class="keyword">);
<br />    </span><span class="default">$arguments    </span><span class="keyword">= </span><span class="default">func_get_args</span><span class="keyword">();
<br />    return        </span><span class="default">$ref</span><span class="keyword">-&gt;</span><span class="default">invokeArgs</span><span class="keyword">(</span><span class="default">array_merge</span><span class="keyword">(array(&amp;</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">arr</span><span class="keyword">), </span><span class="default">$arguments</span><span class="keyword">));
<br />}
<br /></span><span class="default">?&gt;
<br /></span>
<br />I don't know about performances (you can create an array manually too, starting from array(&amp;$this-&gt;something) and adding arguments). However, it seems to work correctly without problems, at least until the send by reference will be usable with one single value ...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionfunction.invokeargs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunction.invokeargs.php">＋<small>add a note</small></a></div>
