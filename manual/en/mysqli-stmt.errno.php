...
<head>
  ...
  <title>PHP: mysqli_stmt::$errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.errno.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.errno.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.errno.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.data-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-stmt.errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-stmt.errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-stmt.errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-stmt.errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-stmt.errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-stmt.errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-stmt.errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-stmt.errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-stmt.errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-stmt.errno.php" hreflang="zh">
...
<meta name="Description" content="Returns the error code for the most recent statement call" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::$errno - Manual" />
<meta name="twitter:description" content="Returns the error code for the most recent statement call" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::$errno - Manual" />
<meta itemprop="description" content="Returns the error code for the most recent statement call" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the error code for the most recent statement call" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-stmt.error.php">
          mysqli_stmt::$error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-stmt.data-seek.php">
          &laquo; mysqli_stmt::data_seek        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.errno.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.errno.php'>German</option>
            <option value='es/mysqli-stmt.errno.php'>Spanish</option>
            <option value='fr/mysqli-stmt.errno.php'>French</option>
            <option value='it/mysqli-stmt.errno.php'>Italian</option>
            <option value='ja/mysqli-stmt.errno.php'>Japanese</option>
            <option value='pt_BR/mysqli-stmt.errno.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-stmt.errno.php'>Russian</option>
            <option value='tr/mysqli-stmt.errno.php'>Turkish</option>
            <option value='uk/mysqli-stmt.errno.php'>Ukrainian</option>
            <option value='zh/mysqli-stmt.errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-stmt.errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli_stmt::$errno</h1>
  <h1 class="refname">mysqli_stmt_errno</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_stmt::$errno</span> -- <span class="refname">mysqli_stmt_errno</span> &mdash; <span class="dc-title">Returns the error code for the most recent statement call</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli-stmt.errno-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli-stmt.errno.php">$mysqli_stmt-&gt;errno</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_stmt_errno</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-stmt.php" class="type mysqli_stmt">mysqli_stmt</a></span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli-stmt.errno-parameters">
...
returned by <span class="function"><a href="mysqli.stmt-init.php" class="function">mysqli_stmt_init()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli-stmt.errno-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli-stmt.errno-examples">
...
<div class="examplescode"><pre class="examplescode">Error: 1146.</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli-stmt.errno-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-stmt.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_stmt_sqlstate()</a> - Returns SQLSTATE error from previous statement operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.errno.php">＋<small>add a note</small></a></span>
