...
<head>
  ...
  <title>PHP: pg_set_error_verbosity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-set-error-verbosity.php">
 <link rel="shorturl" href="https://www.php.net/pg-set-error-verbosity">
 <link rel="alternate" href="https://www.php.net/pg-set-error-verbosity" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-set-error-context-visibility.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-socket.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-set-error-verbosity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-set-error-verbosity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-set-error-verbosity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-set-error-verbosity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-set-error-verbosity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-set-error-verbosity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-set-error-verbosity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-set-error-verbosity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-set-error-verbosity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-set-error-verbosity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-set-error-verbosity.php" hreflang="zh">
...
<meta name="Description" content="Determines the verbosity of messages returned by pg_last_error 
   and pg_result_error" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_set_error_verbosity - Manual" />
<meta name="twitter:description" content="Determines the verbosity of messages returned by pg_last_error 
   and pg_result_error" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_set_error_verbosity - Manual" />
<meta itemprop="description" content="Determines the verbosity of messages returned by pg_last_error 
   and pg_result_error" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines the verbosity of messages returned by pg_last_error 
   and pg_result_error" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-socket.php">
          pg_socket &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-set-error-context-visibility.php">
          &laquo; pg_set_error_context_visibility        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-set-error-verbosity.php' selected="selected">English</option>
            <option value='de/function.pg-set-error-verbosity.php'>German</option>
            <option value='es/function.pg-set-error-verbosity.php'>Spanish</option>
            <option value='fr/function.pg-set-error-verbosity.php'>French</option>
            <option value='it/function.pg-set-error-verbosity.php'>Italian</option>
            <option value='ja/function.pg-set-error-verbosity.php'>Japanese</option>
            <option value='pt_BR/function.pg-set-error-verbosity.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-set-error-verbosity.php'>Russian</option>
            <option value='tr/function.pg-set-error-verbosity.php'>Turkish</option>
            <option value='uk/function.pg-set-error-verbosity.php'>Ukrainian</option>
            <option value='zh/function.pg-set-error-verbosity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-set-error-verbosity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_set_error_verbosity</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_set_error_verbosity</span> &mdash; <span class="dc-title">
   Determines the verbosity of messages returned by <span class="function"><a href="function.pg-last-error.php" class="function">pg_last_error()</a></span> 
 ...
 <div class="refsect1 description" id="refsect1-function.pg-set-error-verbosity-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_set_error_verbosity</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$verbosity</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   ...
   setting. In <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-terse">PGSQL_ERRORS_TERSE</a></code></strong> mode, returned messages include severity, primary text, and 
   position only; this will normally fit on a single line. The default mode (<strong><code><a href="pgsql.constants.php#constant.pgsql-errors-default">PGSQL_ERRORS_DEFAULT</a></code></strong>)
   produces messages that include the above plus any detail, hint, or context 
   fields (these may span multiple lines). The <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-verbose">PGSQL_ERRORS_VERBOSE</a></code></strong> mode includes all available 
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
     ...
     <dt><code class="parameter">verbosity</code></dt>
     <dd>
      <p class="para">
       The required verbosity: <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-terse">PGSQL_ERRORS_TERSE</a></code></strong>,
       <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-default">PGSQL_ERRORS_DEFAULT</a></code></strong>
       or <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-verbose">PGSQL_ERRORS_VERBOSE</a></code></strong>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-set-error-verbosity-returnvalues">
  ...
  <p class="para">
   The previous verbosity level: <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-terse">PGSQL_ERRORS_TERSE</a></code></strong>,
   <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-default">PGSQL_ERRORS_DEFAULT</a></code></strong>
   or <strong><code><a href="pgsql.constants.php#constant.pgsql-errors-verbose">PGSQL_ERRORS_VERBOSE</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-set-error-verbosity-changelog">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-result-error.php" class="function" rel="rdfs-seeAlso">pg_result_error()</a> - Get error message associated with result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-set-error-verbosity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-set-error-verbosity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-set-error-verbosity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-set-error-verbosity.php">＋<small>add a note</small></a></span>
