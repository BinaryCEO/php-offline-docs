...
<head>
  ...
  <title>PHP: gmp_gcdext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-gcdext.php">
 <link rel="shorturl" href="https://www.php.net/gmp-gcdext">
 <link rel="alternate" href="https://www.php.net/gmp-gcdext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-gcd.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-hamdist.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-gcdext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-gcdext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-gcdext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-gcdext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-gcdext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-gcdext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-gcdext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-gcdext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-gcdext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-gcdext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-gcdext.php" hreflang="zh">
...
<meta name="Description" content="Calculate GCD and multipliers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_gcdext - Manual" />
<meta name="twitter:description" content="Calculate GCD and multipliers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_gcdext - Manual" />
<meta itemprop="description" content="Calculate GCD and multipliers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Calculate GCD and multipliers" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmp-hamdist.php">
          gmp_hamdist &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-gcdext.php' selected="selected">English</option>
            <option value='de/function.gmp-gcdext.php'>German</option>
            <option value='es/function.gmp-gcdext.php'>Spanish</option>
            <option value='fr/function.gmp-gcdext.php'>French</option>
            <option value='it/function.gmp-gcdext.php'>Italian</option>
            <option value='ja/function.gmp-gcdext.php'>Japanese</option>
            <option value='pt_BR/function.gmp-gcdext.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-gcdext.php'>Russian</option>
            <option value='tr/function.gmp-gcdext.php'>Turkish</option>
            <option value='uk/function.gmp-gcdext.php'>Ukrainian</option>
            <option value='zh/function.gmp-gcdext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-gcdext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_gcdext</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_gcdext</span> &mdash; <span class="dc-title">Calculate GCD and multipliers</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-gcdext-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_gcdext</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Calculates g, s, and t, such that <code class="literal">a*s + b*t = g =
   gcd(a,b)</code>, where gcd is the greatest common divisor. Returns
  ...
  <p class="para">
   ...
   <code class="literal">a*x + b*y = c</code>.
   For more information, go to the <a href="http://mathworld.wolfram.com/DiophantineEquation.html" class="link external">&raquo;&nbsp;&quot;Diophantine
   Equation&quot; page at MathWorld</a>
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.gmp-gcdext-parameters">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Solve the equation a*s + b*t = g<br />// where a = 12, b = 21, g = gcd(12, 21) = 3<br /></span><span style="color: #0000BB">$a </span><span style="color: #007700">= </span><span style="color: #0000BB">gmp_init</span><span style="color: #007700">(</span><span style="color: #0000BB">12</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">gmp_init</span><span style="color: #007700">(</span><span style="color: #0000BB">21</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$g </span><span style="color: #007700">= </span><span style="color: #0000BB">gmp_gcd</span><span style="color: #007700">(</span><span style="color: #0000BB">$a</span><span style="color: #007700">, </span><span style="color: #0000BB">$b</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$r </span><span style="color: #007700">= </span><span style="color: #0000BB">gmp_gcdext</span><span style="color: #007700">(</span><span style="color: #0000BB">$a</span><span style="color: #007700">, </span><span style="color: #0000BB">$b</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$check_gcd </span><span style="color: #007700">= (</span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$g</span><span style="color: #007700">) == </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'g'</span><span style="color: #007700">]));<br /></span><span style="color: #0000BB">$eq_res </span><span style="color: #007700">= </span><span style="color: #0000BB">gmp_add</span><span style="color: #007700">(</span><span style="color: #0000BB">gmp_mul</span><span style="color: #007700">(</span><span style="color: #0000BB">$a</span><span style="color: #007700">, </span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'s'</span><span style="color: #007700">]), </span><span style="color: #0000BB">gmp_mul</span><span style="color: #007700">(</span><span style="color: #0000BB">$b</span><span style="color: #007700">, </span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'t'</span><span style="color: #007700">]));<br /></span><span style="color: #0000BB">$check_res </span><span style="color: #007700">= (</span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$g</span><span style="color: #007700">) == </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$eq_res</span><span style="color: #007700">));<br /><br />if (</span><span style="color: #0000BB">$check_gcd </span><span style="color: #007700">&amp;&amp; </span><span style="color: #0000BB">$check_res</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$fmt </span><span style="color: #007700">= </span><span style="color: #DD0000">"Solution: %d*%d + %d*%d = %d\n"</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$a</span><span style="color: #007700">), </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'s'</span><span style="color: #007700">]), </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$b</span><span style="color: #007700">),<br />    </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'t'</span><span style="color: #007700">]), </span><span style="color: #0000BB">gmp_strval</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'g'</span><span style="color: #007700">]));<br />} else {<br />    echo </span><span style="color: #DD0000">"Error while solving the equation\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// output: Solution: 12*2 + 21*-1 = 3<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-gcdext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-gcdext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-gcdext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-gcdext.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="33057">  <div class="votes">
    <div id="Vu33057">
    <a href="/manual/vote-note.php?id=33057&amp;page=function.gmp-gcdext&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd33057">
    <a href="/manual/vote-note.php?id=33057&amp;page=function.gmp-gcdext&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V33057" title="66% like this...">
    1
    </div>
  </div>
  <a href="#33057" class="name">
  <strong class="user"><em>FatPhil</em></strong></a><a class="genanchor" href="#33057"> &para;</a><div class="date" title="2003-06-15 06:47"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom33057">
<div class="phpcode"><code><span class="html">The extended GCD can be used to calculate mutual modular inverses of two<br />coprime numbers. Internally gmp_invert uses this extended GCD routine, <br />but effectively throws away one of the inverses.<br /><br />If gcd(a,b)=1, then r.a+s.b=1<br />Therefore  r.a == 1 (mod s) and s.b == 1 (mod r)<br />Note that one of r and s will be negative, and so you'll want to<br />canonicalise it.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmp-gcdext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-gcdext.php">＋<small>add a note</small></a></div>
