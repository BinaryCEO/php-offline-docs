...
<head>
  ...
  <title>PHP: mysql_client_encoding - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-client-encoding.php">
 <link rel="shorturl" href="https://www.php.net/mysql-client-encoding">
 <link rel="alternate" href="https://www.php.net/mysql-client-encoding" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-affected-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-client-encoding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-client-encoding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-client-encoding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-client-encoding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-client-encoding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-client-encoding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-client-encoding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-client-encoding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-client-encoding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-client-encoding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-client-encoding.php" hreflang="zh">
...
<meta name="Description" content="Returns the name of the character set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_client_encoding - Manual" />
<meta name="twitter:description" content="Returns the name of the character set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_client_encoding - Manual" />
<meta itemprop="description" content="Returns the name of the character set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of the character set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-close.php">
          mysql_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-affected-rows.php">
          &laquo; mysql_affected_rows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-client-encoding.php' selected="selected">English</option>
            <option value='de/function.mysql-client-encoding.php'>German</option>
            <option value='es/function.mysql-client-encoding.php'>Spanish</option>
            <option value='fr/function.mysql-client-encoding.php'>French</option>
            <option value='it/function.mysql-client-encoding.php'>Italian</option>
            <option value='ja/function.mysql-client-encoding.php'>Japanese</option>
            <option value='pt_BR/function.mysql-client-encoding.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-client-encoding.php'>Russian</option>
            <option value='tr/function.mysql-client-encoding.php'>Turkish</option>
            <option value='uk/function.mysql-client-encoding.php'>Ukrainian</option>
            <option value='zh/function.mysql-client-encoding.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-client-encoding" class="refentry">
 ...
 <div id="function.mysql-client-encoding-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.character-set-name.php" class="function">mysqli_character_set_name()</a></span></li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-client-encoding-examples">
  ...
  <p class="para">
   <div class="example" id="example-1876">
    <p><strong>Example #1 <span class="function"><strong>mysql_client_encoding()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">The current character set is: latin1</pre>
</div>
    </div>
   </div>
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-real-escape-string.php" class="function" rel="rdfs-seeAlso">mysql_real_escape_string()</a> - Escapes special characters in a string for use in an SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-client-encoding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-client-encoding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-client-encoding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-client-encoding.php">＋<small>add a note</small></a></span>
