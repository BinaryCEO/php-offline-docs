...
<head>
  ...
  <title>PHP: Yaf_Router::addRoute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/yaf-router.addroute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/yaf-router.addroute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/yaf-router.addroute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.yaf-router.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-router.addconfig.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-router.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/yaf-router.addroute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/yaf-router.addroute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/yaf-router.addroute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/yaf-router.addroute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/yaf-router.addroute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/yaf-router.addroute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/yaf-router.addroute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/yaf-router.addroute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/yaf-router.addroute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/yaf-router.addroute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/yaf-router.addroute.php" hreflang="zh">
...
<meta name="Description" content="Add new Route into Router" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Router::addRoute - Manual" />
<meta name="twitter:description" content="Add new Route into Router" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Router::addRoute - Manual" />
<meta itemprop="description" content="Add new Route into Router" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add new Route into Router" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yaf-router.construct.php">
          Yaf_Router::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yaf-router.addconfig.php">
          &laquo; Yaf_Router::addConfig        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/yaf-router.addroute.php' selected="selected">English</option>
            <option value='de/yaf-router.addroute.php'>German</option>
            <option value='es/yaf-router.addroute.php'>Spanish</option>
            <option value='fr/yaf-router.addroute.php'>French</option>
            <option value='it/yaf-router.addroute.php'>Italian</option>
            <option value='ja/yaf-router.addroute.php'>Japanese</option>
            <option value='pt_BR/yaf-router.addroute.php'>Brazilian Portuguese</option>
            <option value='ru/yaf-router.addroute.php'>Russian</option>
            <option value='tr/yaf-router.addroute.php'>Turkish</option>
            <option value='uk/yaf-router.addroute.php'>Ukrainian</option>
            <option value='zh/yaf-router.addroute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="yaf-router.addroute" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.yaf-route-map.php" class="classname">Yaf_Route_Map</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf_router/addroute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fyaf-router.addroute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=yaf-router.addroute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/yaf-router.addroute.php">＋<small>add a note</small></a></span>
