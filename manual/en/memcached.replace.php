...
<head>
  ...
  <title>PHP: Memcached::replace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.replace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.replace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.replace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.quit.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.replacebykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.replace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.replace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.replace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.replace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.replace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.replace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.replace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.replace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.replace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.replace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.replace.php" hreflang="zh">
...
<meta name="Description" content="Replace the item under an existing key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::replace - Manual" />
<meta name="twitter:description" content="Replace the item under an existing key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::replace - Manual" />
<meta itemprop="description" content="Replace the item under an existing key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replace the item under an existing key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.replacebykey.php">
          Memcached::replaceByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.quit.php">
          &laquo; Memcached::quit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.replace.php' selected="selected">English</option>
            <option value='de/memcached.replace.php'>German</option>
            <option value='es/memcached.replace.php'>Spanish</option>
            <option value='fr/memcached.replace.php'>French</option>
            <option value='it/memcached.replace.php'>Italian</option>
            <option value='ja/memcached.replace.php'>Japanese</option>
            <option value='pt_BR/memcached.replace.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.replace.php'>Russian</option>
            <option value='tr/memcached.replace.php'>Turkish</option>
            <option value='uk/memcached.replace.php'>Ukrainian</option>
            <option value='zh/memcached.replace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.replace" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="memcached.add.php" class="methodname" rel="rdfs-seeAlso">Memcached::add()</a> - Add an item under a new key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/replace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.replace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.replace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.replace.php">＋<small>add a note</small></a></span>
