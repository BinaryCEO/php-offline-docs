...
<head>
  ...
  <title>PHP: cubrid_close_request - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-close-request.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-close-request">
 <link rel="alternate" href="https://www.php.net/cubrid-close-request" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-close-prepare.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-col-get.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-close-request.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-close-request.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-close-request.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-close-request.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-close-request.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-close-request.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-close-request.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-close-request.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-close-request.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-close-request.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-close-request.php" hreflang="zh">
...
<meta name="Description" content="Close the request handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_close_request - Manual" />
<meta name="twitter:description" content="Close the request handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_close_request - Manual" />
<meta itemprop="description" content="Close the request handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close the request handle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-col-get.php">
          cubrid_col_get &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-close-prepare.php">
          &laquo; cubrid_close_prepare        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-close-request.php' selected="selected">English</option>
            <option value='de/function.cubrid-close-request.php'>German</option>
            <option value='es/function.cubrid-close-request.php'>Spanish</option>
            <option value='fr/function.cubrid-close-request.php'>French</option>
            <option value='it/function.cubrid-close-request.php'>Italian</option>
            <option value='ja/function.cubrid-close-request.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-close-request.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-close-request.php'>Russian</option>
            <option value='tr/function.cubrid-close-request.php'>Turkish</option>
            <option value='uk/function.cubrid-close-request.php'>Ukrainian</option>
            <option value='zh/function.cubrid-close-request.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-close-request" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_close_request</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_close_request</span> &mdash; <span class="dc-title">Close the request handle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-close-request-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_close_request</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_close_request()</strong></span> function closes the request
    handle given by the <code class="parameter">req_identifier</code> argument, and
  ...
  <div class="refsect1 parameters" id="refsect1-function.cubrid-close-request-parameters">
 <h3 class="title">Parameters</h3>
 <p class="para">
  <dl>
    
  <dt><code class="parameter">req_identifier</code></dt>
  <dd><p class="para">Request identifier.</p></dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$con </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect </span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$con</span><span style="color: #007700">) {<br />   echo </span><span style="color: #DD0000">"connected successfully"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute </span><span style="color: #007700">( </span><span style="color: #0000BB">$con</span><span style="color: #007700">, </span><span style="color: #DD0000">"select * from members"</span><span style="color: #007700">, <br />                           </span><span style="color: #0000BB">CUBRID_INCLUDE_OID </span><span style="color: #007700">| </span><span style="color: #0000BB">CUBRID_ASYNC</span><span style="color: #007700">);<br />   if (</span><span style="color: #0000BB">$req</span><span style="color: #007700">) {<br />      while ( list (</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$name</span><span style="color: #007700">) = </span><span style="color: #0000BB">cubrid_fetch </span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">) ){<br />         echo </span><span style="color: #0000BB">$id</span><span style="color: #007700">;<br />         echo </span><span style="color: #0000BB">$name</span><span style="color: #007700">;<br />      } <br />      </span><span style="color: #0000BB">cubrid_close_request</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">); </span><span style="color: #FF8000">// or you can use cubrid_close_prepare($req)<br />   </span><span style="color: #007700">}<br />   </span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-close-request-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.cubrid-close-prepare.php" class="function" rel="rdfs-seeAlso">cubrid_close_prepare()</a> - Close the request handle</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-close-request.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-close-request%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-close-request&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-close-request.php">＋<small>add a note</small></a></span>
