...
<head>
  ...
  <title>PHP: oci_set_client_identifier - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-set-client-identifier.php">
 <link rel="shorturl" href="https://www.php.net/oci-set-client-identifier">
 <link rel="alternate" href="https://www.php.net/oci-set-client-identifier" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-set-call-timout.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-set-client-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-set-client-identifier.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-set-client-identifier.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-set-client-identifier.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-set-client-identifier.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-set-client-identifier.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-set-client-identifier.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-set-client-identifier.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-set-client-identifier.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-set-client-identifier.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-set-client-identifier.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-set-client-identifier.php" hreflang="zh">
...
<meta name="Description" content="Sets the client identifier" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_set_client_identifier - Manual" />
<meta name="twitter:description" content="Sets the client identifier" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_set_client_identifier - Manual" />
<meta itemprop="description" content="Sets the client identifier" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the client identifier" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.oci-set-client-info.php">
          oci_set_client_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-set-call-timout.php">
          &laquo; oci_set_call_timeout        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-set-client-identifier.php' selected="selected">English</option>
            <option value='de/function.oci-set-client-identifier.php'>German</option>
            <option value='es/function.oci-set-client-identifier.php'>Spanish</option>
            <option value='fr/function.oci-set-client-identifier.php'>French</option>
            <option value='it/function.oci-set-client-identifier.php'>Italian</option>
            <option value='ja/function.oci-set-client-identifier.php'>Japanese</option>
            <option value='pt_BR/function.oci-set-client-identifier.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-set-client-identifier.php'>Russian</option>
            <option value='tr/function.oci-set-client-identifier.php'>Turkish</option>
            <option value='uk/function.oci-set-client-identifier.php'>Ukrainian</option>
            <option value='zh/function.oci-set-client-identifier.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-set-client-identifier" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-set-db-operation.php" class="function" rel="rdfs-seeAlso">oci_set_db_operation()</a> - Sets the database operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-set-client-identifier.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-set-client-identifier%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-set-client-identifier&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-client-identifier.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103535">  <div class="votes">
    <div id="Vu103535">
    <a href="/manual/vote-note.php?id=103535&amp;page=function.oci-set-client-identifier&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103535">
    <a href="/manual/vote-note.php?id=103535&amp;page=function.oci-set-client-identifier&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103535" title="57% like this...">
    1
    </div>
  </div>
  <a href="#103535" class="name">
  <strong class="user"><em>sixd at php dot net</em></strong></a><a class="genanchor" href="#103535"> &para;</a><div class="date" title="2011-04-18 04:22"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103535">
<div class="phpcode"><code><span class="html">There's an article "PHP Web Auditing, Authorization and Monitoring with Oracle Database" at www.oracle.com/technetwork/articles/dsl/php-web-auditing-171451.html which is all about using oci_set_client_identifier()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.oci-set-client-identifier&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-client-identifier.php">＋<small>add a note</small></a></div>
