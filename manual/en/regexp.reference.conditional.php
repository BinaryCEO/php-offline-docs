...
<head>
  ...
  <title>PHP: Conditional subpatterns - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/regexp.reference.conditional.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/regexp.reference.conditional.php">
 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.conditional.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reference.pcre.pattern.syntax.php">
 <link rel="prev" href="https://www.php.net/manual/en/regexp.reference.onlyonce.php">
 <link rel="next" href="https://www.php.net/manual/en/regexp.reference.comments.php">

 <link rel="alternate" href="https://www.php.net/manual/en/regexp.reference.conditional.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/regexp.reference.conditional.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/regexp.reference.conditional.php" hreflang="uk">
...
<meta name="Description" content="Conditional subpatterns" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Conditional subpatterns - Manual" />
<meta name="twitter:description" content="Conditional subpatterns" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Conditional subpatterns - Manual" />
<meta itemprop="description" content="Conditional subpatterns" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Conditional subpatterns" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/regexp.reference.conditional.php' selected="selected">English</option>
            <option value='de/regexp.reference.conditional.php'>German</option>
            <option value='es/regexp.reference.conditional.php'>Spanish</option>
            <option value='fr/regexp.reference.conditional.php'>French</option>
            <option value='it/regexp.reference.conditional.php'>Italian</option>
            <option value='ja/regexp.reference.conditional.php'>Japanese</option>
            <option value='pt_BR/regexp.reference.conditional.php'>Brazilian Portuguese</option>
            <option value='ru/regexp.reference.conditional.php'>Russian</option>
            <option value='tr/regexp.reference.conditional.php'>Turkish</option>
            <option value='uk/regexp.reference.conditional.php'>Ukrainian</option>
            <option value='zh/regexp.reference.conditional.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="regexp.reference.conditional" class="section">
...
(?(condition)yes-pattern|no-pattern)
  ...
  <p class="para">
   ...
   more readable (assume the <a href="reference.pcre.pattern.modifiers.php" class="link">PCRE_EXTENDED</a>
...
( \( )? [^()]+ (?(1) \) )
  ...
  <p class="para">
   ...
   with an opening parenthesis, the condition is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, and so
  ...
  <p class="para">
   ...
   letters and dd are digits.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fregexp.reference.conditional%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=regexp.reference.conditional&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexp.reference.conditional.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102285">  <div class="votes">
    <div id="Vu102285">
    <a href="/manual/vote-note.php?id=102285&amp;page=regexp.reference.conditional&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102285">
    <a href="/manual/vote-note.php?id=102285&amp;page=regexp.reference.conditional&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102285" title="58% like this...">
    3
    </div>
  </div>
  <a href="#102285" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#102285"> &para;</a><div class="date" title="2011-02-06 09:26"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102285">
<div class="phpcode"><code><span class="html">Repetition of a subpattern will repeat conditionals that are contained inside it, updating subpattern matches with iteration.
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=regexp.reference.conditional&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexp.reference.conditional.php">＋<small>add a note</small></a></div>
