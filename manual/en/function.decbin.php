...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.decbin.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cosh.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dechex.php">
...
<meta itemprop="description" content="Decimal to binary" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.decbin.php' selected="selected">English</option>
            <option value='de/function.decbin.php'>German</option>
            <option value='es/function.decbin.php'>Spanish</option>
            <option value='fr/function.decbin.php'>French</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.decbin-examples">
  ...
  <p class="para">
   <div class="example" id="example-3365">
    <p><strong>Example #1 <span class="function"><strong>decbin()</strong></span> example</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.decbin-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li>
     <span class="function"><a href="function.printf.php" class="function" rel="rdfs-seeAlso">printf()</a> - Output a formatted string</span>, using <code class="literal">%b</code>,
     <code class="literal">%032b</code> or <code class="literal">%064b</code> as the format
    </li>
    <li>
     <span class="function"><a href="function.sprintf.php" class="function" rel="rdfs-seeAlso">sprintf()</a> - Return a formatted string</span>, using <code class="literal">%b</code>,
     <code class="literal">%032b</code> or <code class="literal">%064b</code> as the format
    </li>
   </ul>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/decbin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.decbin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.decbin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.decbin.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>rambabusaravanan at gmail dot com</em></strong></a><a class="genanchor" href="#120413"> &para;</a><div class="date" title="2017-01-05 01:08"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120413">
<div class="phpcode"><code><span class="html">Print as binary format with leading zeros into a variable in one simple statement.<br /><br /><span class="default">&lt;?php<br />    $binary </span><span class="keyword">= </span><span class="default">sprintf</span><span class="keyword">(</span><span class="string">'%08b'</span><span class="keyword">,  </span><span class="default">$decimal</span><span class="keyword">);    </span><span class="comment">// $decimal = 5;<br />    </span><span class="keyword">echo </span><span class="default">$binary</span><span class="keyword">;    </span><span class="comment">// $binary = "00000101";<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <a href="#60425" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#60425"> &para;</a><div class="date" title="2006-01-06 06:29"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60425">
<div class="phpcode"><code><span class="html">Just an example:<br />If you convert 26 to bin you'll get 11010, which is 5 chars long. If you need the full 8-bit value use this:<br /><br />$bin = decbin(26);<br />$bin = substr("00000000",0,8 - strlen($bin)) . $bin;<br /><br />This will convert 11010 to 00011010.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.decbin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.decbin.php">＋<small>add a note</small></a></div>
