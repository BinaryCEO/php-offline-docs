...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php">
 <link rel="next" href="https://www.php.net/manual/en/pdostatement.errorinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.errorcode.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pdostatement.errorcode.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pdostatement.errorcode.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pdostatement.errorcode.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pdostatement.errorcode.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pdostatement.errorcode.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pdostatement.errorcode.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pdostatement.errorcode.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pdostatement.errorcode.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pdostatement.errorcode.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pdostatement.errorcode.php" hreflang="zh">
...
<div id="layout" class="clearfix">
 ...
 <div class="refsect1 examples" id="refsect1-pdostatement.errorcode-examples">
  ...
  <p class="para">
   <div class="example" id="example-1157"><p><strong>Example #1 Retrieving an SQLSTATE code</strong></p>
...
<div class="examplescode"><pre class="examplescode">PDOStatement::errorCode(): 42S02</pre>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdostatement.errorcode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.errorcode.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Statement's errorCode() returns an empty string before execution, and '00000' (five zeros) after a sucessfull execution:<br /><br /><span class="default">&lt;?php<br />$stmt </span><span class="keyword">= </span><span class="default">$pdo</span><span class="keyword">-&gt;</span><span class="default">prepare</span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">);<br /></span><span class="default">assert</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">-&gt;</span><span class="default">errorCode </span><span class="keyword">=== </span><span class="string">''</span><span class="keyword">);<br /><br /></span><span class="default">$stmt</span><span class="keyword">-&gt;</span><span class="default">execute</span><span class="keyword">();<br /></span><span class="default">assert</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">-&gt;</span><span class="default">errorCode </span><span class="keyword">=== </span><span class="string">'00000'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Neither this property nor the PDOStatement::errorInfo() properties are available if you create  your own exception handler.<br /><br />I am using PHP 5.2.4, PDO_INFORMIX 1.2.0.<br /><br />Making this call at any point in the program after setting your own exception handler produces an error:<br /><br />PHP Notice:  Undefined property:  PDOStatement::$errorCode in new_query.php on line<br /><br />or<br /><br />PHP Notice:  Undefined property:  PDOStatement::$errorInfo in new_query.php on line<br /><br />But if I set the PDO to SILENT, only set error codes with:<br /><br />$dbh-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT)<br /><br />Then process with if/else the call to this functions works fine.  The examples below only do error checking to show the result codes of this function.  Normally you would want more.<br /><br />FAILS:<br /><br />$dbh = new PDO("informix...")<br />$dbh-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br /><br />try  {<br />      $result = $dbh-&gt;query("asdfkjasdfkjasdfjk");  /* obvious sql error */<br />      if ($result) print "success!";<br />      }<br />catch<br />      {<br />      $myeCode = $dbh-&gt;errorCode();<br />      /* do stuff with error */<br />      };<br /><br />$dbh=0;<br /><br />The error handler gets called but knows nothing about $dbh-&gt;errorCode or $dbh-&gt;errorInfo.<br /><br />WORKS:<br /><br />$dbh = new PDO("informix...")<br />$dbh-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);<br /><br />$result = $dbh-&gt;query("asdfkjasdfkjasdfjk");  /* obvious sql error */<br />if ($result) <br />      {<br />      /* process result */<br />      print "success!";<br /><br />      /* all done, didn't make any changes */<br />      $dbh-&gt;rollback();<br />      }<br />else<br />      {<br />      $myeCode = $dbh-&gt;errorCode();<br />      print_r($myeCode);<br />      };<br /><br />$dbh=0;  /* close connection */<br /><br />I hope this helps someone else.<br />Cheers,<br />David</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=pdostatement.errorcode&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.errorcode.php">＋<small>add a note</small></a></div>
