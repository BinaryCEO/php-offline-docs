...
<head>
  ...
  <title>PHP: ps_setgray - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setgray.php">
 <link rel="shorturl" href="https://www.php.net/ps-setgray">
 <link rel="alternate" href="https://www.php.net/ps-setgray" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setfont.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setlinecap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setgray.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setgray.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setgray.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setgray.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setgray.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setgray.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setgray.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setgray.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setgray.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setgray.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setgray.php" hreflang="zh">
...
<meta name="Description" content="Sets gray value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setgray - Manual" />
<meta name="twitter:description" content="Sets gray value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setgray - Manual" />
<meta itemprop="description" content="Sets gray value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets gray value" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-setlinecap.php">
          ps_setlinecap &raquo;
              ...
              <div class="prev">
        <a href="function.ps-setfont.php">
          &laquo; ps_setfont        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setgray.php' selected="selected">English</option>
            <option value='de/function.ps-setgray.php'>German</option>
            <option value='es/function.ps-setgray.php'>Spanish</option>
            <option value='fr/function.ps-setgray.php'>French</option>
            <option value='it/function.ps-setgray.php'>Italian</option>
            <option value='ja/function.ps-setgray.php'>Japanese</option>
            <option value='pt_BR/function.ps-setgray.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setgray.php'>Russian</option>
            <option value='tr/function.ps-setgray.php'>Turkish</option>
            <option value='uk/function.ps-setgray.php'>Ukrainian</option>
            <option value='zh/function.ps-setgray.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setgray" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setgray</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setgray</span> &mdash; <span class="dc-title">Sets gray value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setgray-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setgray</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$gray</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setgray-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setgray-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setgray-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-setcolor.php" class="function" rel="rdfs-seeAlso">ps_setcolor()</a> - Sets current color</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setgray.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setgray%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setgray&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setgray.php">＋<small>add a note</small></a></span>
