...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/dom.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/dom.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/dom.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/dom.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/class.domattr.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/dom.examples.php' selected="selected">English</option>
            <option value='de/dom.examples.php'>German</option>
            <option value='es/dom.examples.php'>Spanish</option>
 ...
 <p class="para">
  ...
  <var class="filename">book.xml</var> that contains the following:
 </p>
 <p class="para">
...
&lt;/book&gt;</pre>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdom.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=dom.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/dom.examples.php">＋<small>add a note</small></a></span>
