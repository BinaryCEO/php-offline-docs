...
<head>
  ...
  <title>PHP: Gmagick::getimagebackgroundcolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getfilename.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagebackgroundcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagebackgroundcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagebackgroundcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagebackgroundcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagebackgroundcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagebackgroundcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagebackgroundcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagebackgroundcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagebackgroundcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagebackgroundcolor.php" hreflang="zh">
...
<meta name="Description" content="Returns the image background color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagebackgroundcolor - Manual" />
<meta name="twitter:description" content="Returns the image background color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagebackgroundcolor - Manual" />
<meta itemprop="description" content="Returns the image background color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the image background color" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageblueprimary.php">
          Gmagick::getimageblueprimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getfilename.php">
          &laquo; Gmagick::getfilename        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagebackgroundcolor.php' selected="selected">English</option>
            <option value='de/gmagick.getimagebackgroundcolor.php'>German</option>
            <option value='es/gmagick.getimagebackgroundcolor.php'>Spanish</option>
            <option value='fr/gmagick.getimagebackgroundcolor.php'>French</option>
            <option value='it/gmagick.getimagebackgroundcolor.php'>Italian</option>
            <option value='ja/gmagick.getimagebackgroundcolor.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagebackgroundcolor.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagebackgroundcolor.php'>Russian</option>
            <option value='tr/gmagick.getimagebackgroundcolor.php'>Turkish</option>
            <option value='uk/gmagick.getimagebackgroundcolor.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagebackgroundcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagebackgroundcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagebackgroundcolor</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagebackgroundcolor</span> &mdash; <span class="dc-title">Returns the image background color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagebackgroundcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagebackgroundcolor</strong></span>(): <span class="type"><a href="class.gmagickpixel.php" class="type GmagickPixel">GmagickPixel</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagebackgroundcolor-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagebackgroundcolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagebackgroundcolor-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagebackgroundcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagebackgroundcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagebackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php">＋<small>add a note</small></a></span>
