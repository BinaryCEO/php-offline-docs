...
<head>
  ...
  <title>PHP: streamWrapper::stream_lock - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-lock.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-lock.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-lock.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-flush.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-metadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-lock.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.stream-lock.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.stream-lock.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.stream-lock.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.stream-lock.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.stream-lock.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.stream-lock.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.stream-lock.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.stream-lock.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.stream-lock.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.stream-lock.php" hreflang="zh">
...
<meta name="Description" content="Advisory file locking" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: streamWrapper::stream_lock - Manual" />
<meta name="twitter:description" content="Advisory file locking" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_lock - Manual" />
<meta itemprop="description" content="Advisory file locking" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Advisory file locking" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="streamwrapper.stream-metadata.php">
          streamWrapper::stream_metadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-flush.php">
          &laquo; streamWrapper::stream_flush        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-lock.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-lock.php'>German</option>
            <option value='es/streamwrapper.stream-lock.php'>Spanish</option>
            <option value='fr/streamwrapper.stream-lock.php'>French</option>
            <option value='it/streamwrapper.stream-lock.php'>Italian</option>
            <option value='ja/streamwrapper.stream-lock.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.stream-lock.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.stream-lock.php'>Russian</option>
            <option value='tr/streamwrapper.stream-lock.php'>Turkish</option>
            <option value='uk/streamwrapper.stream-lock.php'>Ukrainian</option>
            <option value='zh/streamwrapper.stream-lock.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.stream-lock" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.flock.php" class="function" rel="rdfs-seeAlso">flock()</a> - Portable advisory file locking</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-lock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-lock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-lock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-lock.php">＋<small>add a note</small></a></span>
