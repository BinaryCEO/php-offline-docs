...
<head>
  ...
  <title>PHP: mcrypt_get_key_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-get-key-size.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-get-key-size">
 <link rel="alternate" href="https://www.php.net/mcrypt-get-key-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-get-iv-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-list-algorithms.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-get-key-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-get-key-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-get-key-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-get-key-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-get-key-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-get-key-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-get-key-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-get-key-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-get-key-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-get-key-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-get-key-size.php" hreflang="zh">
...
<meta name="Description" content="Gets the key size of the specified cipher" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_get_key_size - Manual" />
<meta name="twitter:description" content="Gets the key size of the specified cipher" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_get_key_size - Manual" />
<meta itemprop="description" content="Gets the key size of the specified cipher" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the key size of the specified cipher" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-list-algorithms.php">
          mcrypt_list_algorithms &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-get-iv-size.php">
          &laquo; mcrypt_get_iv_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-get-key-size.php' selected="selected">English</option>
            <option value='de/function.mcrypt-get-key-size.php'>German</option>
            <option value='es/function.mcrypt-get-key-size.php'>Spanish</option>
            <option value='fr/function.mcrypt-get-key-size.php'>French</option>
            <option value='it/function.mcrypt-get-key-size.php'>Italian</option>
            <option value='ja/function.mcrypt-get-key-size.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-get-key-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-get-key-size.php'>Russian</option>
            <option value='tr/function.mcrypt-get-key-size.php'>Turkish</option>
            <option value='uk/function.mcrypt-get-key-size.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-get-key-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-get-key-size" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mcrypt-encrypt.php" class="function" rel="rdfs-seeAlso">mcrypt_encrypt()</a> - Encrypts plaintext with given parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-get-key-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-get-key-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-get-key-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-get-key-size.php">＋<small>add a note</small></a></span>
