...
<head>
  ...
  <title>PHP: Imagick::contrastImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.contrastimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.contrastimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.contrastimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.contraststretchimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.contrastimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.contrastimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.contrastimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.contrastimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.contrastimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.contrastimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.contrastimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.contrastimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.contrastimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.contrastimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.contrastimage.php" hreflang="zh">
...
<meta name="Description" content="Change the contrast of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::contrastImage - Manual" />
<meta name="twitter:description" content="Change the contrast of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::contrastImage - Manual" />
<meta itemprop="description" content="Change the contrast of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Change the contrast of the image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.contraststretchimage.php">
          Imagick::contrastStretchImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.construct.php">
          &laquo; Imagick::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.contrastimage.php' selected="selected">English</option>
            <option value='de/imagick.contrastimage.php'>German</option>
            <option value='es/imagick.contrastimage.php'>Spanish</option>
            <option value='fr/imagick.contrastimage.php'>French</option>
            <option value='it/imagick.contrastimage.php'>Italian</option>
            <option value='ja/imagick.contrastimage.php'>Japanese</option>
            <option value='pt_BR/imagick.contrastimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.contrastimage.php'>Russian</option>
            <option value='tr/imagick.contrastimage.php'>Turkish</option>
            <option value='uk/imagick.contrastimage.php'>Ukrainian</option>
            <option value='zh/imagick.contrastimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.contrastimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::contrastImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::contrastImage</span> &mdash; <span class="dc-title">Change the contrast of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.contrastimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::contrastImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$sharpen</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.contrastimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.contrastimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.contrastimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-2986">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/contrastimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.contrastimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.contrastimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.contrastimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116698">  <div class="votes">
    <div id="Vu116698">
    <a href="/manual/vote-note.php?id=116698&amp;page=imagick.contrastimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116698">
    <a href="/manual/vote-note.php?id=116698&amp;page=imagick.contrastimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116698" title="80% like this...">
    3
    </div>
  </div>
  <a href="#116698" class="name">
  <strong class="user"><em>removespam dot roland at tannerritchie dot com</em></strong></a><a class="genanchor" href="#116698"> &para;</a><div class="date" title="2015-02-12 07:14"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116698">
<div class="phpcode"><code><span class="html">Both xyking and quickshiftin include errors in their comments. xyking's error is in looping through negative numbers. quickshifting is incorrect in stating that 0 *increases* contrast (it does not - it decreases it).<br /><br />Here is a (tested, working) method to increment or decrement contrast:<br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">Images </span><span class="keyword">{<br />public function </span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">$contrast</span><span class="keyword">, </span><span class="default">$imagePath</span><span class="keyword">){<br /><br /></span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$imagePath</span><span class="keyword">);                     <br /><br /> if (</span><span class="default">$contrast </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">){<br />                for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$contrast</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++){<br />                    </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br />                }<br />            }else if (</span><span class="default">$contrast </span><span class="keyword">&lt;= </span><span class="default">0</span><span class="keyword">) {<br /><br />                for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&gt; </span><span class="default">$contrast</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">--) {<br /><br />                    </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);<br />                }<br />            }<br />     }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="97376">  <div class="votes">
    <div id="Vu97376">
    <a href="/manual/vote-note.php?id=97376&amp;page=imagick.contrastimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97376">
    <a href="/manual/vote-note.php?id=97376&amp;page=imagick.contrastimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97376" title="30% like this...">
    -4
    </div>
  </div>
  <a href="#97376" class="name">
  <strong class="user"><em>xyking</em></strong></a><a class="genanchor" href="#97376"> &para;</a><div class="date" title="2010-04-16 08:14"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97376">
<div class="phpcode"><code><span class="html">Tip: <br /><span class="default">&lt;?php<br />$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">); </span><span class="comment">//Increase contrast once<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">); </span><span class="comment">//Increase contrast more<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">); </span><span class="comment">//Increase contrast even more<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">); </span><span class="comment">//Decrease contrast once<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">); </span><span class="comment">//Decrease contrast more<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">); </span><span class="comment">//Decrease contrast even more<br /><br />//This could be made into a function like this:<br /></span><span class="keyword">public function </span><span class="default">contrast</span><span class="keyword">(</span><span class="default">$level</span><span class="keyword">) {<br />        </span><span class="default">$level </span><span class="keyword">= (int)</span><span class="default">$level</span><span class="keyword">;<br />        if (</span><span class="default">$level </span><span class="keyword">&lt; -</span><span class="default">10</span><span class="keyword">) {<br />            </span><span class="default">$level </span><span class="keyword">= -</span><span class="default">10</span><span class="keyword">;<br />        } else if (</span><span class="default">$level </span><span class="keyword">&gt; </span><span class="default">10</span><span class="keyword">) {<br />            </span><span class="default">$level </span><span class="keyword">= </span><span class="default">10</span><span class="keyword">;<br />        }<br />        if (</span><span class="default">$level </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">) {<br />            for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$level</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />                </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br />            }<br />        } else if (</span><span class="default">$level </span><span class="keyword">&lt; </span><span class="default">0</span><span class="keyword">) {<br />            for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">$level</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">--) {<br />                </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">image</span><span class="keyword">-&gt;</span><span class="default">contrastImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">);<br />            }<br />        }<br />    }<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116089">  <div class="votes">
    <div id="Vu116089">
    <a href="/manual/vote-note.php?id=116089&amp;page=imagick.contrastimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116089">
    <a href="/manual/vote-note.php?id=116089&amp;page=imagick.contrastimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116089" title="14% like this...">
    -5
    </div>
  </div>
  <a href="#116089" class="name">
  <strong class="user"><em>quickshiftin at gmail dot com</em></strong></a><a class="genanchor" href="#116089"> &para;</a><div class="date" title="2014-11-07 09:24"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116089">
<div class="phpcode"><code><span class="html">xyking's comment is wrong so be careful if you read it. You pass a value of 0 to *increase* the contrast.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.contrastimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.contrastimage.php">＋<small>add a note</small></a></div>
