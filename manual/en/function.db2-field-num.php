...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-field-num.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-field-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-field-precision.php">
...
<meta name="Description" content="Returns the position of the named column in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_field_num - Manual" />
<meta name="twitter:description" content="Returns the position of the named column in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_field_num - Manual" />
<meta itemprop="description" content="Returns the position of the named column in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the position of the named column in a result set" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-field-num.php' selected="selected">English</option>
            <option value='de/function.db2-field-num.php'>German</option>
            <option value='es/function.db2-field-num.php'>Spanish</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-field-num-returnvalues">
  ...
  <p class="para">
   ...
   <span class="function"><strong>db2_field_num()</strong></span> returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-field-width.php" class="function" rel="rdfs-seeAlso">db2_field_width()</a> - Returns the width of the current value of the indicated column in a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-field-num.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-field-num%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-field-num&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-field-num.php">＋<small>add a note</small></a></span>
