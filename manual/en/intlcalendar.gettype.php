...
<head>
  ...
  <title>PHP: IntlCalendar::getType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.gettype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.gettype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.gettype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.gettimezone.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getweekendtransition.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.gettype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.gettype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.gettype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.gettype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.gettype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.gettype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.gettype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.gettype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.gettype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.gettype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.gettype.php" hreflang="zh">
...
<meta name="Description" content="Get the calendar type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getType - Manual" />
<meta name="twitter:description" content="Get the calendar type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getType - Manual" />
<meta itemprop="description" content="Get the calendar type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the calendar type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.getweekendtransition.php">
          IntlCalendar::getWeekendTransition &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.gettimezone.php">
          &laquo; IntlCalendar::getTimeZone        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.gettype.php' selected="selected">English</option>
            <option value='de/intlcalendar.gettype.php'>German</option>
            <option value='es/intlcalendar.gettype.php'>Spanish</option>
            <option value='fr/intlcalendar.gettype.php'>French</option>
            <option value='it/intlcalendar.gettype.php'>Italian</option>
            <option value='ja/intlcalendar.gettype.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.gettype.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.gettype.php'>Russian</option>
            <option value='tr/intlcalendar.gettype.php'>Turkish</option>
            <option value='uk/intlcalendar.gettype.php'>Ukrainian</option>
            <option value='zh/intlcalendar.gettype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.gettype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::getType</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::getType</span> &mdash; <span class="dc-title">Get the calendar type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlcalendar.gettype-description">
  <h3 class="title">Description</h3>
  <p class="para">
   Object-oriented style
  </p>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::getType</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_get_type</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   A string describing the type of this calendar. This is one of the <a href="intlcalendar.getkeywordvaluesforlocale.php" class="link">valid values</a> for
   the calendar keyword value <code class="literal">&#039;calendar&#039;</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-intlcalendar.gettype-parameters">
...
string(9) &quot;gregorian&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/gettype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.gettype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.gettype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.gettype.php">＋<small>add a note</small></a></span>
