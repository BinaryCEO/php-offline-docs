...
<head>
  ...
  <title>PHP: Random\BrokenRandomEngineError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.random-brokenrandomengineerror.php">
 <link rel="shorturl" href="https://www.php.net/random-brokenrandomengineerror">
 <link rel="alternate" href="https://www.php.net/random-brokenrandomengineerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.random.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.random-randomerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.random-randomexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.random-brokenrandomengineerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.random-brokenrandomengineerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.random-brokenrandomengineerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.random-brokenrandomengineerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.random-brokenrandomengineerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.random-brokenrandomengineerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.random-brokenrandomengineerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.random-brokenrandomengineerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.random-brokenrandomengineerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.random-brokenrandomengineerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.random-brokenrandomengineerror.php" hreflang="zh">
...
<meta name="Description" content="The Random\BrokenRandomEngineError class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Random\BrokenRandomEngineError - Manual" />
<meta name="twitter:description" content="The Random\BrokenRandomEngineError class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Random\BrokenRandomEngineError - Manual" />
<meta itemprop="description" content="The Random\BrokenRandomEngineError class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Random\BrokenRandomEngineError class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.random-randomexception.php">
          Random\RandomException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.random-randomerror.php">
          &laquo; Random\RandomError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.random-brokenrandomengineerror.php' selected="selected">English</option>
            <option value='de/class.random-brokenrandomengineerror.php'>German</option>
            <option value='es/class.random-brokenrandomengineerror.php'>Spanish</option>
            <option value='fr/class.random-brokenrandomengineerror.php'>French</option>
            <option value='it/class.random-brokenrandomengineerror.php'>Italian</option>
            <option value='ja/class.random-brokenrandomengineerror.php'>Japanese</option>
            <option value='pt_BR/class.random-brokenrandomengineerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.random-brokenrandomengineerror.php'>Russian</option>
            <option value='tr/class.random-brokenrandomengineerror.php'>Turkish</option>
            <option value='uk/class.random-brokenrandomengineerror.php'>Ukrainian</option>
            <option value='zh/class.random-brokenrandomengineerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.random-brokenrandomengineerror" class="reference">
 <h1 class="title">The Random\BrokenRandomEngineError class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.2.0)</p>


  <div class="section" id="random-brokenrandomengineerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Indicates that the used <span class="classname"><a href="class.random-engine.php" class="classname">Random\Engine</a></span> is broken, e.g. because it is severely biased.
   </p>
  </div>


  <div class="section" id="random-brokenrandomengineerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">Random\BrokenRandomEngineError</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.random-randomerror.php" class="classname">Random\RandomError</a>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/random.brokenrandomengineerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.random-brokenrandomengineerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.random-brokenrandomengineerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.random-brokenrandomengineerror.php">＋<small>add a note</small></a></span>
