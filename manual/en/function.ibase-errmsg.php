...
<head>
  ...
  <title>PHP: ibase_errmsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-errmsg.php">
 <link rel="shorturl" href="https://www.php.net/ibase-errmsg">
 <link rel="alternate" href="https://www.php.net/ibase-errmsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-errcode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-execute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-errmsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-errmsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-errmsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-errmsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-errmsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-errmsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-errmsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-errmsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-errmsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-errmsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-errmsg.php" hreflang="zh">
...
<meta name="Description" content="Return error messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_errmsg - Manual" />
<meta name="twitter:description" content="Return error messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_errmsg - Manual" />
<meta itemprop="description" content="Return error messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return error messages" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-execute.php">
          ibase_execute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-errcode.php">
          &laquo; ibase_errcode        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-errmsg.php' selected="selected">English</option>
            <option value='de/function.ibase-errmsg.php'>German</option>
            <option value='es/function.ibase-errmsg.php'>Spanish</option>
            <option value='fr/function.ibase-errmsg.php'>French</option>
            <option value='it/function.ibase-errmsg.php'>Italian</option>
            <option value='ja/function.ibase-errmsg.php'>Japanese</option>
            <option value='pt_BR/function.ibase-errmsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-errmsg.php'>Russian</option>
            <option value='tr/function.ibase-errmsg.php'>Turkish</option>
            <option value='uk/function.ibase-errmsg.php'>Ukrainian</option>
            <option value='zh/function.ibase-errmsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-errmsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_errmsg</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_errmsg</span> &mdash; <span class="dc-title">Return error messages</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-errmsg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_errmsg</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-errmsg-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.ibase-errmsg-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the error message as a string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if no error occurred.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.ibase-errmsg-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-errcode.php" class="function" rel="rdfs-seeAlso">ibase_errcode()</a> - Return an error code</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-errmsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-errmsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-errmsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-errmsg.php">＋<small>add a note</small></a></span>
