...
<head>
  ...
  <title>PHP: variant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.variant.php">
 <link rel="shorturl" href="https://www.php.net/variant">
 <link rel="alternate" href="https://www.php.net/variant" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/dotnet.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/variant.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.variant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.variant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.variant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.variant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.variant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.variant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.variant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.variant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.variant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.variant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.variant.php" hreflang="zh">
...
<meta name="Description" content="variant class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant - Manual" />
<meta name="twitter:description" content="variant class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant - Manual" />
<meta itemprop="description" content="variant class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="variant class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="variant.construct.php">
          variant::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="dotnet.construct.php">
          &laquo; dotnet::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.variant.php' selected="selected">English</option>
            <option value='de/class.variant.php'>German</option>
            <option value='es/class.variant.php'>Spanish</option>
            <option value='fr/class.variant.php'>French</option>
            <option value='it/class.variant.php'>Italian</option>
            <option value='ja/class.variant.php'>Japanese</option>
            <option value='pt_BR/class.variant.php'>Brazilian Portuguese</option>
            <option value='ru/class.variant.php'>Russian</option>
            <option value='tr/class.variant.php'>Turkish</option>
            <option value='uk/class.variant.php'>Ukrainian</option>
            <option value='zh/class.variant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.variant" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="variant.construct.php">variant::__construct</a> — variant class constructor</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/variant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.variant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.variant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.variant.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="76471">  <div class="votes">
    <div id="Vu76471">
    <a href="/manual/vote-note.php?id=76471&amp;page=class.variant&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76471">
    <a href="/manual/vote-note.php?id=76471&amp;page=class.variant&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76471" title="81% like this...">
    20
    </div>
  </div>
  <a href="#76471" class="name">
  <strong class="user"><em>darren at dcook dot org</em></strong></a><a class="genanchor" href="#76471"> &para;</a><div class="date" title="2007-07-17 05:59"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76471">
<div class="phpcode"><code><span class="html">If you are frustrated that print_r($obj) (where $obj is something returned from a call to a function on a COM object) does not return anything helpful, and that variant_get_type($obj) just returns a number, the function you are actually after is:<br />  com_print_typeinfo($obj);<br /><br />It lists all functions, variables, their types in a human-readable (well, programmer-readable) format. Lovely!</span></code></div>
  </div>
 </div>
  <div class="note" id="29830">  <div class="votes">
    <div id="Vu29830">
    <a href="/manual/vote-note.php?id=29830&amp;page=class.variant&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd29830">
    <a href="/manual/vote-note.php?id=29830&amp;page=class.variant&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V29830" title="63% like this...">
    3
    </div>
  </div>
  <a href="#29830" class="name">
  <strong class="user"><em>richard dot quadling at carval dot co dot uk</em></strong></a><a class="genanchor" href="#29830"> &para;</a><div class="date" title="2003-02-26 05:50"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom29830">
...
<div class="foot"><a href="/manual/add-note.php?sect=class.variant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.variant.php">＋<small>add a note</small></a></div>
