...
<head>
  ...
  <title>PHP: imagecolorclosestalpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorclosestalpha.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorclosestalpha">
 <link rel="alternate" href="https://www.php.net/imagecolorclosestalpha" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorclosest.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorclosesthwb.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorclosestalpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorclosestalpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorclosestalpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorclosestalpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorclosestalpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorclosestalpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorclosestalpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorclosestalpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorclosestalpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorclosestalpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorclosestalpha.php" hreflang="zh">
...
<meta name="Description" content="Get the index of the closest color to the specified color + alpha" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagecolorclosestalpha - Manual" />
<meta name="twitter:description" content="Get the index of the closest color to the specified color + alpha" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorclosestalpha - Manual" />
<meta itemprop="description" content="Get the index of the closest color to the specified color + alpha" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the index of the closest color to the specified color + alpha" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolorclosesthwb.php">
          imagecolorclosesthwb &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecolorclosest.php">
          &laquo; imagecolorclosest        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorclosestalpha.php' selected="selected">English</option>
            <option value='de/function.imagecolorclosestalpha.php'>German</option>
            <option value='es/function.imagecolorclosestalpha.php'>Spanish</option>
            <option value='fr/function.imagecolorclosestalpha.php'>French</option>
            <option value='it/function.imagecolorclosestalpha.php'>Italian</option>
            <option value='ja/function.imagecolorclosestalpha.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorclosestalpha.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorclosestalpha.php'>Russian</option>
            <option value='tr/function.imagecolorclosestalpha.php'>Turkish</option>
            <option value='uk/function.imagecolorclosestalpha.php'>Ukrainian</option>
            <option value='zh/function.imagecolorclosestalpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorclosestalpha" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagecolorclosesthwb.php" class="function" rel="rdfs-seeAlso">imagecolorclosesthwb()</a> - Get the index of the color which has the hue, white and blackness</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorclosestalpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorclosestalpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorclosestalpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorclosestalpha.php">＋<small>add a note</small></a></span>
