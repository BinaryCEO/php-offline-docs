...
<head>
  ...
  <title>PHP: ImagickDraw::popDefs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.popdefs.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.popdefs.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.popdefs.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.popclippath.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.poppattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.popdefs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.popdefs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.popdefs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.popdefs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.popdefs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.popdefs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.popdefs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.popdefs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.popdefs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.popdefs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.popdefs.php" hreflang="zh">
...
<meta name="Description" content="Terminates a definition list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::popDefs - Manual" />
<meta name="twitter:description" content="Terminates a definition list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::popDefs - Manual" />
<meta itemprop="description" content="Terminates a definition list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Terminates a definition list" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.poppattern.php">
          ImagickDraw::popPattern &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.popclippath.php">
          &laquo; ImagickDraw::popClipPath        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.popdefs.php' selected="selected">English</option>
            <option value='de/imagickdraw.popdefs.php'>German</option>
            <option value='es/imagickdraw.popdefs.php'>Spanish</option>
            <option value='fr/imagickdraw.popdefs.php'>French</option>
            <option value='it/imagickdraw.popdefs.php'>Italian</option>
            <option value='ja/imagickdraw.popdefs.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.popdefs.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.popdefs.php'>Russian</option>
            <option value='tr/imagickdraw.popdefs.php'>Turkish</option>
            <option value='uk/imagickdraw.popdefs.php'>Ukrainian</option>
            <option value='zh/imagickdraw.popdefs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.popdefs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::popDefs</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::popDefs</span> &mdash; <span class="dc-title">Terminates a definition list</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.popdefs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::popDefs</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.popdefs-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3160">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/popdefs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.popdefs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.popdefs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.popdefs.php">＋<small>add a note</small></a></span>
