...
<head>
  ...
  <title>PHP: imap_unsubscribe - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-unsubscribe.php">
 <link rel="shorturl" href="https://www.php.net/imap-unsubscribe">
 <link rel="alternate" href="https://www.php.net/imap-unsubscribe" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-undelete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-utf7-decode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-unsubscribe.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-unsubscribe.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-unsubscribe.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-unsubscribe.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-unsubscribe.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-unsubscribe.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-unsubscribe.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-unsubscribe.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-unsubscribe.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-unsubscribe.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-unsubscribe.php" hreflang="zh">
...
<meta name="Description" content="Unsubscribe from a mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_unsubscribe - Manual" />
<meta name="twitter:description" content="Unsubscribe from a mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_unsubscribe - Manual" />
<meta itemprop="description" content="Unsubscribe from a mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unsubscribe from a mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-utf7-decode.php">
          imap_utf7_decode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-undelete.php">
          &laquo; imap_undelete        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-unsubscribe.php' selected="selected">English</option>
            <option value='de/function.imap-unsubscribe.php'>German</option>
            <option value='es/function.imap-unsubscribe.php'>Spanish</option>
            <option value='fr/function.imap-unsubscribe.php'>French</option>
            <option value='it/function.imap-unsubscribe.php'>Italian</option>
            <option value='ja/function.imap-unsubscribe.php'>Japanese</option>
            <option value='pt_BR/function.imap-unsubscribe.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-unsubscribe.php'>Russian</option>
            <option value='tr/function.imap-unsubscribe.php'>Turkish</option>
            <option value='uk/function.imap-unsubscribe.php'>Ukrainian</option>
            <option value='zh/function.imap-unsubscribe.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-unsubscribe" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_unsubscribe</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_unsubscribe</span> &mdash; <span class="dc-title">Unsubscribe from a mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-unsubscribe-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_unsubscribe</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$mailbox</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Unsubscribe from the specified <code class="parameter">mailbox</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.imap-unsubscribe-parameters">
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-unsubscribe-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-unsubscribe-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-unsubscribe-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-subscribe.php" class="function" rel="rdfs-seeAlso">imap_subscribe()</a> - Subscribe to a mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-unsubscribe.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-unsubscribe%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-unsubscribe&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-unsubscribe.php">＋<small>add a note</small></a></span>
