...
<head>
  ...
  <title>PHP: pspell_config_save_repl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-config-save-repl.php">
 <link rel="shorturl" href="https://www.php.net/pspell-config-save-repl">
 <link rel="alternate" href="https://www.php.net/pspell-config-save-repl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-config-runtogether.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-new.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-config-save-repl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-config-save-repl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-config-save-repl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-config-save-repl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-config-save-repl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-config-save-repl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-config-save-repl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-config-save-repl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-config-save-repl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-config-save-repl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-config-save-repl.php" hreflang="zh">
...
<meta name="Description" content="Determine whether to save a replacement pairs list
  along with the wordlist" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_config_save_repl - Manual" />
<meta name="twitter:description" content="Determine whether to save a replacement pairs list
  along with the wordlist" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_config_save_repl - Manual" />
<meta itemprop="description" content="Determine whether to save a replacement pairs list
  along with the wordlist" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determine whether to save a replacement pairs list
  along with the wordlist" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-config-runtogether.php">
          &laquo; pspell_config_runtogether        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-config-save-repl.php' selected="selected">English</option>
            <option value='de/function.pspell-config-save-repl.php'>German</option>
            <option value='es/function.pspell-config-save-repl.php'>Spanish</option>
            <option value='fr/function.pspell-config-save-repl.php'>French</option>
            <option value='it/function.pspell-config-save-repl.php'>Italian</option>
            <option value='ja/function.pspell-config-save-repl.php'>Japanese</option>
            <option value='pt_BR/function.pspell-config-save-repl.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-config-save-repl.php'>Russian</option>
            <option value='tr/function.pspell-config-save-repl.php'>Turkish</option>
            <option value='uk/function.pspell-config-save-repl.php'>Ukrainian</option>
            <option value='zh/function.pspell-config-save-repl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-config-save-repl" class="refentry">
   ...
   <p class="para">
    ...
    or later.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-config-save-repl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-config-save-repl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-config-save-repl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-config-save-repl.php">＋<small>add a note</small></a></span>
