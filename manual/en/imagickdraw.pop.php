...
<head>
  ...
  <title>PHP: ImagickDraw::pop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pop.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pop.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pop.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.polyline.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.popclippath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pop.php" hreflang="zh">
...
<meta name="Description" content="Destroys the current ImagickDraw in the stack, and returns to the previously pushed ImagickDraw" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pop - Manual" />
<meta name="twitter:description" content="Destroys the current ImagickDraw in the stack, and returns to the previously pushed ImagickDraw" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pop - Manual" />
<meta itemprop="description" content="Destroys the current ImagickDraw in the stack, and returns to the previously pushed ImagickDraw" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Destroys the current ImagickDraw in the stack, and returns to the previously pushed ImagickDraw" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.popclippath.php">
          ImagickDraw::popClipPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.polyline.php">
          &laquo; ImagickDraw::polyline        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pop.php' selected="selected">English</option>
            <option value='de/imagickdraw.pop.php'>German</option>
            <option value='es/imagickdraw.pop.php'>Spanish</option>
            <option value='fr/imagickdraw.pop.php'>French</option>
            <option value='it/imagickdraw.pop.php'>Italian</option>
            <option value='ja/imagickdraw.pop.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pop.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pop.php'>Russian</option>
            <option value='tr/imagickdraw.pop.php'>Turkish</option>
            <option value='uk/imagickdraw.pop.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pop</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pop</span> &mdash; <span class="dc-title">Destroys the current ImagickDraw in the stack, and returns to the previously pushed ImagickDraw</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pop</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pop-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pop.php">＋<small>add a note</small></a></span>
