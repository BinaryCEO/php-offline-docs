...
<head>
  ...
  <title>PHP: restore_include_path - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.restore-include-path.php">
 <link rel="shorturl" href="https://www.php.net/restore-include-path">
 <link rel="alternate" href="https://www.php.net/restore-include-path" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.putenv.php">
 <link rel="next" href="https://www.php.net/manual/en/function.set-include-path.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.restore-include-path.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.restore-include-path.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.restore-include-path.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.restore-include-path.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.restore-include-path.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.restore-include-path.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.restore-include-path.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.restore-include-path.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.restore-include-path.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.restore-include-path.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.restore-include-path.php" hreflang="zh">
...
<meta name="Description" content="Restores the value of the include_path configuration option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: restore_include_path - Manual" />
<meta name="twitter:description" content="Restores the value of the include_path configuration option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: restore_include_path - Manual" />
<meta itemprop="description" content="Restores the value of the include_path configuration option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restores the value of the include_path configuration option" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.restore-include-path.php' selected="selected">English</option>
            <option value='de/function.restore-include-path.php'>German</option>
            <option value='es/function.restore-include-path.php'>Spanish</option>
            <option value='fr/function.restore-include-path.php'>French</option>
            <option value='it/function.restore-include-path.php'>Italian</option>
            <option value='ja/function.restore-include-path.php'>Japanese</option>
            <option value='pt_BR/function.restore-include-path.php'>Brazilian Portuguese</option>
            <option value='ru/function.restore-include-path.php'>Russian</option>
            <option value='tr/function.restore-include-path.php'>Turkish</option>
            <option value='uk/function.restore-include-path.php'>Ukrainian</option>
            <option value='zh/function.restore-include-path.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.restore-include-path" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.include.php" class="function" rel="rdfs-seeAlso">include</a> - include</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/restore-include-path.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.restore-include-path%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.restore-include-path&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.restore-include-path.php">＋<small>add a note</small></a></span>
