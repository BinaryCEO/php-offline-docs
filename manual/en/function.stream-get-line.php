...
<head>
  ...
  <title>PHP: stream_get_line - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-get-line.php">
 <link rel="shorturl" href="https://www.php.net/stream-get-line">
 <link rel="alternate" href="https://www.php.net/stream-get-line" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-filters.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-get-meta-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-get-line.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-get-line.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-get-line.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-get-line.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-get-line.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-get-line.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-get-line.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-get-line.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-get-line.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-get-line.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-get-line.php" hreflang="zh">
...
<meta name="Description" content="Gets line from stream resource up to a given delimiter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_get_line - Manual" />
<meta name="twitter:description" content="Gets line from stream resource up to a given delimiter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_get_line - Manual" />
<meta itemprop="description" content="Gets line from stream resource up to a given delimiter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets line from stream resource up to a given delimiter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-get-meta-data.php">
          stream_get_meta_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-get-filters.php">
          &laquo; stream_get_filters        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-get-line.php' selected="selected">English</option>
            <option value='de/function.stream-get-line.php'>German</option>
            <option value='es/function.stream-get-line.php'>Spanish</option>
            <option value='fr/function.stream-get-line.php'>French</option>
            <option value='it/function.stream-get-line.php'>Italian</option>
            <option value='ja/function.stream-get-line.php'>Japanese</option>
            <option value='pt_BR/function.stream-get-line.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-get-line.php'>Russian</option>
            <option value='tr/function.stream-get-line.php'>Turkish</option>
            <option value='uk/function.stream-get-line.php'>Ukrainian</option>
            <option value='zh/function.stream-get-line.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-get-line" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-get-line-returnvalues">
  ...
  <p class="para">
   ...
   pointed to by <code class="parameter">stream</code>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.fgetc.php" class="function" rel="rdfs-seeAlso">fgetc()</a> - Gets character from file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-get-line.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-get-line%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-get-line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-line.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94879">  <div class="votes">
    <div id="Vu94879">
    <a href="/manual/vote-note.php?id=94879&amp;page=function.stream-get-line&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94879">
    <a href="/manual/vote-note.php?id=94879&amp;page=function.stream-get-line&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94879" title="83% like this...">
    12
    </div>
  </div>
  <a href="#94879" class="name">
  <strong class="user"><em>pk at ritm dot ru</em></strong></a><a class="genanchor" href="#94879"> &para;</a><div class="date" title="2009-11-30 09:30"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94879">
<div class="phpcode"><code><span class="html">fgets is faster but stream_get_line is more useful in a tcp server scripts.<br /><br />when fgets reads some bytes from socket, where EOF is reached, it returns bool(false) same as stream_get_line<br /><br />BUT if remote client drops connection, and server script will try to read some data with function fgets, function will return bool(false), and stream_get_line will return string(0) ""<br /><br />so you can detect remote client disconnection with stream_get_line, and cannot with fgets</span></code></div>
  </div>
 </div>
  <div class="note" id="130180">  <div class="votes">
    <div id="Vu130180">
    <a href="/manual/vote-note.php?id=130180&amp;page=function.stream-get-line&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130180">
    <a href="/manual/vote-note.php?id=130180&amp;page=function.stream-get-line&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130180" title="100% like this...">
    1
    </div>
  </div>
  <a href="#130180" class="name">
  <strong class="user"><em>cool at user dot com</em></strong></a><a class="genanchor" href="#130180"> &para;</a><div class="date" title="2025-03-21 03:37"><strong>6 months ago</strong></div>
  <div class="text" id="Hcom130180">
<div class="phpcode"><code><span class="html">This function is very efficient to redirect streams. I have older scripts to compare, and recent versions of PHP are so fast, that sometimes 2 lines might get fed into one, and this happens only on PHP 8.3 and 8.4.<br /><br />After digging, i found that throttling a bit is the best to do to maintain retro compatibility.<br /><br />$line = stream_get_line($response, 1024, "\n");<br />usleep(10000);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-get-line&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-line.php">＋<small>add a note</small></a></div>
