...
<head>
  ...
  <title>PHP: Imagick::extentImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.extentimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.extentimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.extentimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.exportimagepixels.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.filter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.extentimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.extentimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.extentimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.extentimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.extentimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.extentimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.extentimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.extentimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.extentimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.extentimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.extentimage.php" hreflang="zh">
...
<meta name="Description" content="Set image size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::extentImage - Manual" />
<meta name="twitter:description" content="Set image size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::extentImage - Manual" />
<meta itemprop="description" content="Set image size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set image size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.filter.php">
          Imagick::filter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.exportimagepixels.php">
          &laquo; Imagick::exportImagePixels        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.extentimage.php' selected="selected">English</option>
            <option value='de/imagick.extentimage.php'>German</option>
            <option value='es/imagick.extentimage.php'>Spanish</option>
            <option value='fr/imagick.extentimage.php'>French</option>
            <option value='it/imagick.extentimage.php'>Italian</option>
            <option value='ja/imagick.extentimage.php'>Japanese</option>
            <option value='pt_BR/imagick.extentimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.extentimage.php'>Russian</option>
            <option value='tr/imagick.extentimage.php'>Turkish</option>
            <option value='uk/imagick.extentimage.php'>Ukrainian</option>
            <option value='zh/imagick.extentimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.extentimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::extentImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::extentImage</span> &mdash; <span class="dc-title">Set image size</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.extentimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::extentImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.cropimage.php" class="function" rel="rdfs-seeAlso">Imagick::cropImage()</a> - Extracts a region of the image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/extentimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.extentimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.extentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.extentimage.php">＋<small>add a note</small></a></span>
