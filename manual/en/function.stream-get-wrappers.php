...
<head>
  ...
  <title>PHP: stream_get_wrappers - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-get-wrappers.php">
 <link rel="shorturl" href="https://www.php.net/stream-get-wrappers">
 <link rel="alternate" href="https://www.php.net/stream-get-wrappers" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-get-transports.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-is-local.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-get-wrappers.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-get-wrappers.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-get-wrappers.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-get-wrappers.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-get-wrappers.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-get-wrappers.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-get-wrappers.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-get-wrappers.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-get-wrappers.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-get-wrappers.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-get-wrappers.php" hreflang="zh">
...
<meta name="Description" content="Retrieve list of registered streams" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_get_wrappers - Manual" />
<meta name="twitter:description" content="Retrieve list of registered streams" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_get_wrappers - Manual" />
<meta itemprop="description" content="Retrieve list of registered streams" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve list of registered streams" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-is-local.php">
          stream_is_local &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-get-transports.php">
          &laquo; stream_get_transports        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-get-wrappers.php' selected="selected">English</option>
            <option value='de/function.stream-get-wrappers.php'>German</option>
            <option value='es/function.stream-get-wrappers.php'>Spanish</option>
            <option value='fr/function.stream-get-wrappers.php'>French</option>
            <option value='it/function.stream-get-wrappers.php'>Italian</option>
            <option value='ja/function.stream-get-wrappers.php'>Japanese</option>
            <option value='pt_BR/function.stream-get-wrappers.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-get-wrappers.php'>Russian</option>
            <option value='tr/function.stream-get-wrappers.php'>Turkish</option>
            <option value='uk/function.stream-get-wrappers.php'>Ukrainian</option>
            <option value='zh/function.stream-get-wrappers.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-get-wrappers" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_get_wrappers</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_get_wrappers</span> &mdash; <span class="dc-title">Retrieve list of registered streams</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stream-get-wrappers-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_get_wrappers</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-get-wrappers-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.stream-get-wrappers-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-get-wrappers-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-4060">
    <p><strong>Example #1 <span class="function"><strong>stream_get_wrappers()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">stream_get_wrappers</span><span style="color: #007700">());<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
(
  ...
  <p class="para">
   <div class="example" id="example-4061">
    <p><strong>Example #2 Checking for the existence of a stream wrapper</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// check for the existence of the bzip2 stream wrapper<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">in_array</span><span style="color: #007700">(</span><span style="color: #DD0000">'compress.bzip2'</span><span style="color: #007700">, </span><span style="color: #0000BB">stream_get_wrappers</span><span style="color: #007700">())) {<br />    echo </span><span style="color: #DD0000">'compress.bzip2:// support enabled.'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'compress.bzip2:// support not enabled.'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-get-wrappers-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.stream-wrapper-register.php" class="function" rel="rdfs-seeAlso">stream_wrapper_register()</a> - Register a URL wrapper implemented as a PHP class</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-get-wrappers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-get-wrappers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-get-wrappers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-get-wrappers.php">＋<small>add a note</small></a></span>
