...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.matte.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.matte.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.matte.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.line.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathclose.php">
...
<meta name="Description" content="Paints on the image's opacity channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::matte - Manual" />
<meta name="twitter:description" content="Paints on the image's opacity channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::matte - Manual" />
<meta itemprop="description" content="Paints on the image's opacity channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Paints on the image's opacity channel" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.matte.php' selected="selected">English</option>
            ...
            <option value='tr/imagickdraw.matte.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::matte</span> &mdash; <span class="dc-title">Paints on the image&#039;s opacity channel</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.matte-examples">
  ...
  <p class="para">
    <div class="example" id="example-3152">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::matte()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/matte.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.matte%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.matte&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.matte.php">＋<small>add a note</small></a></span>
