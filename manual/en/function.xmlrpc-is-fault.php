...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xmlrpc-is-fault.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.xmlrpc-get-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xmlrpc-parse-method-descriptions.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xmlrpc-is-fault.php' selected="selected">English</option>
            <option value='de/function.xmlrpc-is-fault.php'>German</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.xmlrpc-decode.php" class="function" rel="rdfs-seeAlso">xmlrpc_decode()</a> - Decodes XML into native PHP types</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlrpc/functions/xmlrpc-is-fault.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xmlrpc-is-fault%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xmlrpc-is-fault&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xmlrpc-is-fault.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>angelo at at dot com</em></strong></a><a class="genanchor" href="#102062"> &para;</a><div class="date" title="2011-01-25 12:31"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102062">
<div class="phpcode"><code><span class="html">A note, response from xmlrpc_decode is not always an array. Whenever the XMLRPC server returns a string, xmlrpc_is_fault will complain about not being an array.<br /><br />Best way to detect errors is<br /><br /><span class="default">&lt;?php<br /><br />    <br />    $response </span><span class="keyword">= </span><span class="default">xmlrpc_decode</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br /><br />    if (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">) &amp;&amp; </span><span class="default">xmlrpc_is_fault</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">)) {<br />        throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">[</span><span class="string">'faultString'</span><span class="keyword">], </span><span class="default">$response</span><span class="keyword">[</span><span class="string">'faultCode'</span><span class="keyword">]);<br />    }<br />    <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.xmlrpc-is-fault&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xmlrpc-is-fault.php">＋<small>add a note</small></a></div>
