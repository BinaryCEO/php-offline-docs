...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-multi-info-read.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-multi-getcontent.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-multi-init.php">
...
<meta name="Description" content="Get information about the current transfers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_multi_info_read - Manual" />
<meta name="twitter:description" content="Get information about the current transfers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_multi_info_read - Manual" />
<meta itemprop="description" content="Get information about the current transfers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get information about the current transfers" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-multi-info-read.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.curl-multi-info-read.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.curl-multi-init.php" class="function" rel="rdfs-seeAlso">curl_multi_init()</a> - Returns a new cURL multi handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-multi-info-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-multi-info-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-multi-info-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-multi-info-read.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Just to let others who might be struggling to get it to work, curl_multi_info_read() doesn't work in PHP versions before 5.2.0, and instead returns NULL immediately.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-multi-info-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-multi-info-read.php">＋<small>add a note</small></a></div>
