...
<head>
  ...
  <title>PHP: headers_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.headers-list.php">
 <link rel="shorturl" href="https://www.php.net/headers-list">
 <link rel="alternate" href="https://www.php.net/headers-list" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.header-remove.php">
 <link rel="next" href="https://www.php.net/manual/en/function.headers-sent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.headers-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.headers-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.headers-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.headers-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.headers-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.headers-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.headers-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.headers-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.headers-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.headers-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.headers-list.php" hreflang="zh">
...
<meta name="Description" content="Returns a list of response headers sent (or ready to send)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: headers_list - Manual" />
<meta name="twitter:description" content="Returns a list of response headers sent (or ready to send)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: headers_list - Manual" />
<meta itemprop="description" content="Returns a list of response headers sent (or ready to send)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a list of response headers sent (or ready to send)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.headers-sent.php">
          headers_sent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.header-remove.php">
          &laquo; header_remove        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.headers-list.php' selected="selected">English</option>
            <option value='de/function.headers-list.php'>German</option>
            <option value='es/function.headers-list.php'>Spanish</option>
            <option value='fr/function.headers-list.php'>French</option>
            <option value='it/function.headers-list.php'>Italian</option>
            <option value='ja/function.headers-list.php'>Japanese</option>
            <option value='pt_BR/function.headers-list.php'>Brazilian Portuguese</option>
            <option value='ru/function.headers-list.php'>Russian</option>
            <option value='tr/function.headers-list.php'>Turkish</option>
            <option value='uk/function.headers-list.php'>Ukrainian</option>
            <option value='zh/function.headers-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.headers-list" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.headers-list-examples">
  ...
  <p class="para">
   <div class="example" id="example-4731">
    <p><strong>Example #1 Example using <span class="function"><strong>headers_list()</strong></span></strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.http-response-code.php" class="function" rel="rdfs-seeAlso">http_response_code()</a> - Get or Set the HTTP response code</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/headers-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.headers-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.headers-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.headers-list.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110330">  <div class="votes">
    <div id="Vu110330">
    <a href="/manual/vote-note.php?id=110330&amp;page=function.headers-list&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110330">
    <a href="/manual/vote-note.php?id=110330&amp;page=function.headers-list&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110330" title="67% like this...">
    22
    </div>
  </div>
  <a href="#110330" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#110330"> &para;</a><div class="date" title="2012-10-11 12:50"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110330">
<div class="phpcode"><code><span class="html">note that it does not return the status header<br /><br /><span class="default">&lt;?php<br /><br />header</span><span class="keyword">(</span><span class="string">'HTTP/1.1 301 Moved Permanently'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">, </span><span class="default">301</span><span class="keyword">);<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'foo: bar'</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'a: b'</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'colon less example'</span><span class="keyword">);<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">headers_list</span><span class="keyword">());<br /></span><span class="default">?&gt;<br /></span><br />Array<br />(<br />    [0] =&gt; X-Powered-By: PHP/5.4.7<br />    [1] =&gt; foo: bar<br />    [2] =&gt; a: b<br />)</span></code></div>
  </div>
 </div>
  <div class="note" id="120539">  <div class="votes">
    <div id="Vu120539">
    <a href="/manual/vote-note.php?id=120539&amp;page=function.headers-list&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120539">
    <a href="/manual/vote-note.php?id=120539&amp;page=function.headers-list&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120539" title="75% like this...">
    19
    </div>
  </div>
  <a href="#120539" class="name">
  <strong class="user"><em>arnold at jasny dot net</em></strong></a><a class="genanchor" href="#120539"> &para;</a><div class="date" title="2017-01-26 04:31"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120539">
<div class="phpcode"><code><span class="html">This function won't work for when you're running PHP from the command line. If will always return an empty array. This can be an issue when testing your project using PHPUnit or Codeception.<br /><br />To solve this, install the xdebug extension and use `xdebug_get_headers` when on the cli.<br /><br /><span class="default">&lt;?php<br />$headers </span><span class="keyword">= </span><span class="default">php_sapi_name</span><span class="keyword">() === </span><span class="string">'cli' </span><span class="keyword">? </span><span class="default">xdebug_get_headers</span><span class="keyword">() : </span><span class="default">headers_list</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.headers-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.headers-list.php">＋<small>add a note</small></a></div>
