...
<head>
  ...
  <title>PHP: sodium_crypto_aead_chacha20poly1305_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-decrypt.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-aead-chacha20poly1305-decrypt">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-aead-chacha20poly1305-decrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-aead-chacha20poly1305-decrypt.php" hreflang="zh">
...
<meta name="Description" content="Verify then decrypt with ChaCha20-Poly1305" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_chacha20poly1305_decrypt - Manual" />
<meta name="twitter:description" content="Verify then decrypt with ChaCha20-Poly1305" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_chacha20poly1305_decrypt - Manual" />
<meta itemprop="description" content="Verify then decrypt with ChaCha20-Poly1305" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify then decrypt with ChaCha20-Poly1305" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-aead-chacha20poly1305-encrypt.php">
          sodium_crypto_aead_chacha20poly1305_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-aes256gcm-keygen.php">
          &laquo; sodium_crypto_aead_aes256gcm_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-chacha20poly1305-decrypt.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>German</option>
            <option value='es/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>French</option>
            <option value='it/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Italian</option>
            <option value='ja/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Russian</option>
            <option value='tr/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-aead-chacha20poly1305-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-aead-chacha20poly1305-decrypt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_aead_chacha20poly1305_decrypt</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_aead_chacha20poly1305_decrypt</span> &mdash; <span class="dc-title">Verify then decrypt with ChaCha20-Poly1305</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-chacha20poly1305-decrypt-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_aead_chacha20poly1305_decrypt</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$ciphertext</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$additional_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-aead-chacha20poly1305-decrypt-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Must be in the format provided by <span class="function"><a href="function.sodium-crypto-aead-chacha20poly1305-encrypt.php" class="function">sodium_crypto_aead_chacha20poly1305_encrypt()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-chacha20poly1305-decrypt-returnvalues">
  ...
  <p class="para">
   Returns the plaintext on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-chacha20poly1305-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-chacha20poly1305-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-chacha20poly1305-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-decrypt.php">＋<small>add a note</small></a></span>
