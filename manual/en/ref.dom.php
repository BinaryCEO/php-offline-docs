...
<head>
  ...
  <title>PHP: DOM Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.dom.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-xpath.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dom-import-simplexml.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.dom.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.dom.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.dom.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.dom.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.dom.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.dom.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.dom.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.dom.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.dom.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.dom.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.dom.php" hreflang="zh">
...
<meta name="Description" content="DOM Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOM Functions - Manual" />
<meta name="twitter:description" content="DOM Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOM Functions - Manual" />
<meta itemprop="description" content="DOM Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="DOM Functions" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.dom.php' selected="selected">English</option>
            <option value='de/ref.dom.php'>German</option>
            <option value='es/ref.dom.php'>Spanish</option>
            <option value='fr/ref.dom.php'>French</option>
            <option value='it/ref.dom.php'>Italian</option>
            <option value='ja/ref.dom.php'>Japanese</option>
            <option value='pt_BR/ref.dom.php'>Brazilian Portuguese</option>
            <option value='ru/ref.dom.php'>Russian</option>
            <option value='tr/ref.dom.php'>Turkish</option>
            <option value='uk/ref.dom.php'>Ukrainian</option>
            <option value='zh/ref.dom.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.dom" class="reference">
  <h1 class="title">DOM Functions</h1>
 ...
 <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.dom-import-simplexml.php">dom_import_simplexml</a> — Gets a DOMAttr or DOMElement object from a
   ...
   SimpleXMLElement object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.dom%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.dom&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.dom.php">＋<small>add a note</small></a></span>
