...
<head>
  ...
  <title>PHP: LogicException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.logicexception.php">
 <link rel="shorturl" href="https://www.php.net/logicexception">
 <link rel="alternate" href="https://www.php.net/logicexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.lengthexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.outofboundsexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.logicexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.logicexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.logicexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.logicexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.logicexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.logicexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.logicexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.logicexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.logicexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.logicexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.logicexception.php" hreflang="zh">
...
<meta name="Description" content="The LogicException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: LogicException - Manual" />
<meta name="twitter:description" content="The LogicException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: LogicException - Manual" />
<meta itemprop="description" content="The LogicException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The LogicException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.outofboundsexception.php">
          OutOfBoundsException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.lengthexception.php">
          &laquo; LengthException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.logicexception.php' selected="selected">English</option>
            <option value='de/class.logicexception.php'>German</option>
            <option value='es/class.logicexception.php'>Spanish</option>
            <option value='fr/class.logicexception.php'>French</option>
            <option value='it/class.logicexception.php'>Italian</option>
            <option value='ja/class.logicexception.php'>Japanese</option>
            <option value='pt_BR/class.logicexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.logicexception.php'>Russian</option>
            <option value='tr/class.logicexception.php'>Turkish</option>
            <option value='uk/class.logicexception.php'>Ukrainian</option>
            <option value='zh/class.logicexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.logicexception" class="reference">
 <h1 class="title">The LogicException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="logicexception.intro">
  ...
  <div class="section" id="logicexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">LogicException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/logicexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.logicexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.logicexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.logicexception.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102228">  <div class="votes">
    <div id="Vu102228">
    <a href="/manual/vote-note.php?id=102228&amp;page=class.logicexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102228">
    <a href="/manual/vote-note.php?id=102228&amp;page=class.logicexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102228" title="54% like this...">
    12
    </div>
  </div>
  <a href="#102228" class="name">
  <strong class="user"><em>Dawid Krysiak</em></strong></a><a class="genanchor" href="#102228"> &para;</a><div class="date" title="2011-02-03 02:32"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102228">
<div class="phpcode"><code><span class="html">Direct known subclasses:<br />BadFunctionCallException, DomainException, InvalidArgumentException, LengthException, OutOfRangeException</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.logicexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.logicexception.php">＋<small>add a note</small></a></div>
