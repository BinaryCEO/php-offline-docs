...
<head>
  ...
  <title>PHP: dbase_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-open.php">
 <link rel="shorturl" href="https://www.php.net/dbase-open">
 <link rel="alternate" href="https://www.php.net/dbase-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-numrecords.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dbase-pack.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dbase-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dbase-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dbase-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dbase-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dbase-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dbase-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dbase-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dbase-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dbase-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dbase-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dbase-open.php" hreflang="zh">
...
<meta name="Description" content="Opens a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_open - Manual" />
<meta name="twitter:description" content="Opens a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_open - Manual" />
<meta itemprop="description" content="Opens a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a database" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-open.php' selected="selected">English</option>
            <option value='de/function.dbase-open.php'>German</option>
            <option value='es/function.dbase-open.php'>Spanish</option>
            <option value='fr/function.dbase-open.php'>French</option>
            <option value='it/function.dbase-open.php'>Italian</option>
            <option value='ja/function.dbase-open.php'>Japanese</option>
            <option value='pt_BR/function.dbase-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.dbase-open.php'>Russian</option>
            <option value='tr/function.dbase-open.php'>Turkish</option>
            <option value='uk/function.dbase-open.php'>Ukrainian</option>
            <option value='zh/function.dbase-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dbase-open" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.dbase-open-description">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: <p class="para">This function is affected by <a href="ini.core.php#ini.open-basedir" class="link">open_basedir</a>.</p></p></blockquote>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.dbase-open-returnvalues">
  ...
  <p class="para">
   Returns a database resource on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.dbase-open-examples">
  ...
  <p class="para">
   <div class="example" id="example-1318">
    <p><strong>Example #1 Opening a dBase database file</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dbase-close.php" class="function" rel="rdfs-seeAlso">dbase_close()</a> - Closes a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-open.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="16113">  <div class="votes">
    <div id="Vu16113">
    <a href="/manual/vote-note.php?id=16113&amp;page=function.dbase-open&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd16113">
    <a href="/manual/vote-note.php?id=16113&amp;page=function.dbase-open&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V16113" title="44% like this...">
    -5
    </div>
  </div>
  <a href="#16113" class="name">
  <strong class="user"><em>jmertic at ncscredit dot com</em></strong></a><a class="genanchor" href="#16113"> &para;</a><div class="date" title="2001-10-16 04:57"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom16113">
<div class="phpcode"><code><span class="html">If you are wanting to open Foxpro tables using this, make sure they are in the 2.x format or php will not respond. In VFP use the following:
<br />
<br />COPY TO tablename.dbf TYPE FOX2X
<br />
<br />This is an easy way to bring database info to the web if you have a small foxpro setup.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.dbase-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-open.php">＋<small>add a note</small></a></div>
