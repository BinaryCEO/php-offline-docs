...
<head>
  ...
  <title>PHP: trader_ppo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ppo.php">
 <link rel="shorturl" href="https://www.php.net/trader-ppo">
 <link rel="alternate" href="https://www.php.net/trader-ppo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-plus-dm.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-roc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ppo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ppo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ppo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ppo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ppo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ppo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ppo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ppo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ppo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ppo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ppo.php" hreflang="zh">
...
<meta name="Description" content="Percentage Price Oscillator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ppo - Manual" />
<meta name="twitter:description" content="Percentage Price Oscillator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ppo - Manual" />
<meta itemprop="description" content="Percentage Price Oscillator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Percentage Price Oscillator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-roc.php">
          trader_roc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-plus-dm.php">
          &laquo; trader_plus_dm        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ppo.php' selected="selected">English</option>
            <option value='de/function.trader-ppo.php'>German</option>
            <option value='es/function.trader-ppo.php'>Spanish</option>
            <option value='fr/function.trader-ppo.php'>French</option>
            <option value='it/function.trader-ppo.php'>Italian</option>
            <option value='ja/function.trader-ppo.php'>Japanese</option>
            <option value='pt_BR/function.trader-ppo.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ppo.php'>Russian</option>
            <option value='tr/function.trader-ppo.php'>Turkish</option>
            <option value='uk/function.trader-ppo.php'>Ukrainian</option>
            <option value='zh/function.trader-ppo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ppo" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_ppo</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ppo</span> &mdash; <span class="dc-title">Percentage Price Oscillator</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-ppo-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_ppo</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-ppo-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ppo-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ppo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ppo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ppo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ppo.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122335">  <div class="votes">
    <div id="Vu122335">
    <a href="/manual/vote-note.php?id=122335&amp;page=function.trader-ppo&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122335">
    <a href="/manual/vote-note.php?id=122335&amp;page=function.trader-ppo&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122335" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#122335" class="name">
  <strong class="user"><em>vito</em></strong></a><a class="genanchor" href="#122335"> &para;</a><div class="date" title="2018-01-30 11:28"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122335">
<div class="phpcode"><code><span class="html">It's always returing an array of 0 to me</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-ppo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ppo.php">＋<small>add a note</small></a></div>
