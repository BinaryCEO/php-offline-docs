...
<head>
  ...
  <title>PHP: DateRangeError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.daterangeerror.php">
 <link rel="shorturl" href="https://www.php.net/daterangeerror">
 <link rel="alternate" href="https://www.php.net/daterangeerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dateobjecterror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dateexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.daterangeerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.daterangeerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.daterangeerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.daterangeerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.daterangeerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.daterangeerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.daterangeerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.daterangeerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.daterangeerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.daterangeerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.daterangeerror.php" hreflang="zh">
...
<meta name="Description" content="The DateRangeError class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateRangeError - Manual" />
<meta name="twitter:description" content="The DateRangeError class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateRangeError - Manual" />
<meta itemprop="description" content="The DateRangeError class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateRangeError class" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dateexception.php">
          DateException &raquo;
              ...
              <div class="prev">
        <a href="class.dateobjecterror.php">
          &laquo; DateObjectError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.daterangeerror.php' selected="selected">English</option>
            <option value='de/class.daterangeerror.php'>German</option>
            <option value='es/class.daterangeerror.php'>Spanish</option>
            <option value='fr/class.daterangeerror.php'>French</option>
            <option value='it/class.daterangeerror.php'>Italian</option>
            <option value='ja/class.daterangeerror.php'>Japanese</option>
            <option value='pt_BR/class.daterangeerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.daterangeerror.php'>Russian</option>
            <option value='tr/class.daterangeerror.php'>Turkish</option>
            <option value='uk/class.daterangeerror.php'>Ukrainian</option>
            <option value='zh/class.daterangeerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.daterangeerror" class="reference">
 <h1 class="title">The DateRangeError class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="daterangeerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown by <span class="methodname"><a href="datetime.gettimestamp.php" class="methodname">DateTime::getTimestamp()</a></span>,
    <span class="methodname"><a href="datetime.gettimestamp.php" class="methodname">DateTimeImmutable::getTimestamp()</a></span>, and
    <span class="function"><a href="function.date-timestamp-get.php" class="function">date_timestamp_get()</a></span>, on 32-bit platforms if the date
    object represents a date outside of the 32-bit signed range.
   </p>
  </div>


  <div class="section" id="daterangeerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateRangeError</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.dateerror.php" class="classname">DateError</a>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section">
   ...
   <ul class="simplelist">
    <li><span class="exceptionname"><a href="class.dateerror.php" class="exceptionname">DateError</a></span></li>
    <li><span class="exceptionname"><a href="class.dateobjecterror.php" class="exceptionname">DateObjectError</a></span></li>
   </ul>
  </div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/daterangeerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.daterangeerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.daterangeerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.daterangeerror.php">＋<small>add a note</small></a></span>
