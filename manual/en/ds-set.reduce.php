...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-set.reduce.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-set.reduce.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-set.reduce.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-set.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-set.merge.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-set.remove.php">
...
<meta name="Description" content="Reduces the set to a single value using a callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Set::reduce - Manual" />
<meta name="twitter:description" content="Reduces the set to a single value using a callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Set::reduce - Manual" />
<meta itemprop="description" content="Reduces the set to a single value using a callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reduces the set to a single value using a callback function" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-set.reduce.php' selected="selected">English</option>
            ...
            <option value='pt_BR/ds-set.reduce.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL ds &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Ds\Set::reduce</span> &mdash; <span class="dc-title">Reduces the set to a single value using a callback function</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-ds-set.reduce-examples">
  ...
  <div class="example" id="example-4437">
   <p><strong>Example #1 <span class="function"><strong>Ds\Set::reduce()</strong></span> with initial value example</strong></p>
...
<div class="examplescode"><pre class="examplescode">int(30)</pre>
  ...
  <div class="example" id="example-4438">
   <p><strong>Example #2 <span class="function"><strong>Ds\Set::reduce()</strong></span> without an initial value example</strong></p>
   <div class="example-contents">
...
<div class="examplescode"><pre class="examplescode">int(21)</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/set/reduce.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-set.reduce%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-set.reduce&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-set.reduce.php">＋<small>add a note</small></a></span>
