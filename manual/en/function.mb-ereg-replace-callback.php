...
<head>
  ...
  <title>PHP: mb_ereg_replace_callback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ereg-replace-callback.php">
 <link rel="shorturl" href="https://www.php.net/mb-ereg-replace-callback">
 <link rel="alternate" href="https://www.php.net/mb-ereg-replace-callback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-ereg-replace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-ereg-search.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ereg-replace-callback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ereg-replace-callback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ereg-replace-callback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ereg-replace-callback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ereg-replace-callback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ereg-replace-callback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ereg-replace-callback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ereg-replace-callback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ereg-replace-callback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ereg-replace-callback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ereg-replace-callback.php" hreflang="zh">
...
<meta name="Description" content="Perform a regular expression search and replace with multibyte support using a callback" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_ereg_replace_callback - Manual" />
<meta name="twitter:description" content="Perform a regular expression search and replace with multibyte support using a callback" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_ereg_replace_callback - Manual" />
<meta itemprop="description" content="Perform a regular expression search and replace with multibyte support using a callback" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform a regular expression search and replace with multibyte support using a callback" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-ereg-search.php">
          mb_ereg_search &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-ereg-replace.php">
          &laquo; mb_ereg_replace        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ereg-replace-callback.php' selected="selected">English</option>
            <option value='de/function.mb-ereg-replace-callback.php'>German</option>
            <option value='es/function.mb-ereg-replace-callback.php'>Spanish</option>
            <option value='fr/function.mb-ereg-replace-callback.php'>French</option>
            <option value='it/function.mb-ereg-replace-callback.php'>Italian</option>
            <option value='ja/function.mb-ereg-replace-callback.php'>Japanese</option>
            <option value='pt_BR/function.mb-ereg-replace-callback.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ereg-replace-callback.php'>Russian</option>
            <option value='tr/function.mb-ereg-replace-callback.php'>Turkish</option>
            <option value='uk/function.mb-ereg-replace-callback.php'>Ukrainian</option>
            <option value='zh/function.mb-ereg-replace-callback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ereg-replace-callback" class="refentry">
...
Last christmas was 12/24/2002</pre>
  ...
  <p class="para">
   <div class="example" id="example-2780">
    <p><strong>Example #2 <span class="function"><strong>mb_ereg_replace_callback()</strong></span> using anonymous function</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><a href="functions.anonymous.php" class="link">Anonymous functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ereg-replace-callback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ereg-replace-callback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ereg-replace-callback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ereg-replace-callback.php">＋<small>add a note</small></a></span>
