...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration82.new-functions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration82.new-functions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration82.new-functions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration82.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration82.new-features.php">
 <link rel="next" href="https://www.php.net/manual/en/migration82.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration82.new-functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration82.new-functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration82.new-functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration82.new-functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration82.new-functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration82.new-functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration82.new-functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration82.new-functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration82.new-functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration82.new-functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration82.new-functions.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration82.new-functions.php' selected="selected">English</option>
            <option value='de/migration82.new-functions.php'>German</option>
            <option value='es/migration82.new-functions.php'>Spanish</option>
            <option value='fr/migration82.new-functions.php'>French</option>
            <option value='it/migration82.new-functions.php'>Italian</option>
            <option value='ja/migration82.new-functions.php'>Japanese</option>
            <option value='pt_BR/migration82.new-functions.php'>Brazilian Portuguese</option>
            <option value='ru/migration82.new-functions.php'>Russian</option>
            <option value='tr/migration82.new-functions.php'>Turkish</option>
            <option value='uk/migration82.new-functions.php'>Ukrainian</option>
            <option value='zh/migration82.new-functions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration82.new-functions" class="sect1">
  ...
  <ul class="simplelist">
    <li><span class="function"><a href="function.libxml-get-external-entity-loader.php" class="function">libxml_get_external_entity_loader()</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration82/new-functions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration82.new-functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration82.new-functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration82.new-functions.php">＋<small>add a note</small></a></span>
