...
<head>
  ...
  <title>PHP: cubrid_set_autocommit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-set-autocommit.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-set-autocommit">
 <link rel="alternate" href="https://www.php.net/cubrid-set-autocommit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-set-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-set-db-parameter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-set-autocommit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-set-autocommit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-set-autocommit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-set-autocommit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-set-autocommit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-set-autocommit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-set-autocommit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-set-autocommit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-set-autocommit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-set-autocommit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-set-autocommit.php" hreflang="zh">
...
<meta name="Description" content="Set autocommit mode of the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_set_autocommit - Manual" />
<meta name="twitter:description" content="Set autocommit mode of the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_set_autocommit - Manual" />
<meta itemprop="description" content="Set autocommit mode of the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set autocommit mode of the connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-set-db-parameter.php">
          cubrid_set_db_parameter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-set-add.php">
          &laquo; cubrid_set_add        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-set-autocommit.php' selected="selected">English</option>
            <option value='de/function.cubrid-set-autocommit.php'>German</option>
            <option value='es/function.cubrid-set-autocommit.php'>Spanish</option>
            <option value='fr/function.cubrid-set-autocommit.php'>French</option>
            <option value='it/function.cubrid-set-autocommit.php'>Italian</option>
            <option value='ja/function.cubrid-set-autocommit.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-set-autocommit.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-set-autocommit.php'>Russian</option>
            <option value='tr/function.cubrid-set-autocommit.php'>Turkish</option>
            <option value='uk/function.cubrid-set-autocommit.php'>Ukrainian</option>
            <option value='zh/function.cubrid-set-autocommit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-set-autocommit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_set_autocommit</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">cubrid_set_autocommit</span> &mdash; <span class="dc-title">Set autocommit mode of the connection</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-set-autocommit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_set_autocommit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$mode</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <p class="para">
  <dl>
    ...
    <dd>
     ...
     <p class="para">
     <ul class="simplelist">
       <li><strong><code>CUBRID_AUTOCOMMIT_FALSE</code></strong></li>
       <li><strong><code>CUBRID_AUTOCOMMIT_TRUE</code></strong></li>
     </ul>
     </p>
    </dd>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-commit.php" class="function" rel="rdfs-seeAlso">cubrid_commit()</a> - Commit a transaction</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-set-autocommit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-set-autocommit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-set-autocommit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-set-autocommit.php">＋<small>add a note</small></a></span>
