...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fstat.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fseek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fsync.php">
...
<meta name="Description" content="Gets information about a file using an open file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fstat - Manual" />
<meta name="twitter:description" content="Gets information about a file using an open file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fstat - Manual" />
<meta itemprop="description" content="Gets information about a file using an open file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets information about a file using an open file pointer" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fstat.php' selected="selected">English</option>
            <option value='de/function.fstat.php'>German</option>
            <option value='es/function.fstat.php'>Spanish</option>
            <option value='fr/function.fstat.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fstat</span> &mdash; <span class="dc-title">Gets information about a file using an open file pointer</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fstat-description">
  ...
  <p class="para rdfs-comment">
   ...
   pointer <code class="parameter">stream</code>. This function is similar to the
   <span class="function"><a href="function.stat.php" class="function">stat()</a></span> function except that it operates
...
be examined must be accessible via the server&#039;s filesystem.</span></p></blockquote>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fstat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fstat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fstat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fstat.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>broom at alturnanetworks dot com</em></strong></a><a class="genanchor" href="#86104"> &para;</a><div class="date" title="2008-10-03 03:21"><strong>16 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=function.fstat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fstat.php">＋<small>add a note</small></a></div>
