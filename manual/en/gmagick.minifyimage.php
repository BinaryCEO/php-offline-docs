...
<head>
  ...
  <title>PHP: Gmagick::minifyimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.minifyimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.minifyimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.minifyimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.modulateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.minifyimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.minifyimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.minifyimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.minifyimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.minifyimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.minifyimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.minifyimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.minifyimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.minifyimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.minifyimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.minifyimage.php" hreflang="zh">
...
<meta name="Description" content="Scales an image proportionally to half its size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::minifyimage - Manual" />
<meta name="twitter:description" content="Scales an image proportionally to half its size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::minifyimage - Manual" />
<meta itemprop="description" content="Scales an image proportionally to half its size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scales an image proportionally to half its size" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.modulateimage.php">
          Gmagick::modulateimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.medianfilterimage.php">
          &laquo; Gmagick::medianfilterimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.minifyimage.php' selected="selected">English</option>
            <option value='de/gmagick.minifyimage.php'>German</option>
            <option value='es/gmagick.minifyimage.php'>Spanish</option>
            <option value='fr/gmagick.minifyimage.php'>French</option>
            <option value='it/gmagick.minifyimage.php'>Italian</option>
            <option value='ja/gmagick.minifyimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.minifyimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.minifyimage.php'>Russian</option>
            <option value='tr/gmagick.minifyimage.php'>Turkish</option>
            <option value='uk/gmagick.minifyimage.php'>Ukrainian</option>
            <option value='zh/gmagick.minifyimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.minifyimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::minifyimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::minifyimage</span> &mdash; <span class="dc-title">Scales an image proportionally to half its size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.minifyimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::minifyimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.minifyimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.minifyimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.minifyimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/minifyimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.minifyimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.minifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.minifyimage.php">＋<small>add a note</small></a></span>
