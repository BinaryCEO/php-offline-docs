...
<head>
  ...
  <title>PHP: fann_scale_input - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-scale-input.php">
 <link rel="shorturl" href="https://www.php.net/fann-scale-input">
 <link rel="alternate" href="https://www.php.net/fann-scale-input" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-save-train.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-scale-input-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-scale-input.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-scale-input.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-scale-input.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-scale-input.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-scale-input.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-scale-input.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-scale-input.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-scale-input.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-scale-input.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-scale-input.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-scale-input.php" hreflang="zh">
...
<meta name="Description" content="Scale data in input vector before feed it to ann based on previously calculated parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_scale_input - Manual" />
<meta name="twitter:description" content="Scale data in input vector before feed it to ann based on previously calculated parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_scale_input - Manual" />
<meta itemprop="description" content="Scale data in input vector before feed it to ann based on previously calculated parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scale data in input vector before feed it to ann based on previously calculated parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-scale-input-train-data.php">
          fann_scale_input_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-save-train.php">
          &laquo; fann_save_train        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-scale-input.php' selected="selected">English</option>
            <option value='de/function.fann-scale-input.php'>German</option>
            <option value='es/function.fann-scale-input.php'>Spanish</option>
            <option value='fr/function.fann-scale-input.php'>French</option>
            <option value='it/function.fann-scale-input.php'>Italian</option>
            <option value='ja/function.fann-scale-input.php'>Japanese</option>
            <option value='pt_BR/function.fann-scale-input.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-scale-input.php'>Russian</option>
            <option value='tr/function.fann-scale-input.php'>Turkish</option>
            <option value='uk/function.fann-scale-input.php'>Ukrainian</option>
            <option value='zh/function.fann-scale-input.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-scale-input" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_scale_input</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_scale_input</span> &mdash; <span class="dc-title">Scale data in input vector before feed it to ann based on previously calculated parameters</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fann-scale-input-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_scale_input</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$input_vector</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-scale-input-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">input_vector</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-scale-input-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-descale-input.php" class="function" rel="rdfs-seeAlso">fann_descale_input()</a> - Scale data in input vector after get it from ann based on previously calculated parameters</span></li>
    <li><span class="function"><a href="function.fann-scale-output.php" class="function" rel="rdfs-seeAlso">fann_scale_output()</a> - Scale data in output vector before feed it to ann based on previously calculated parameters</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-scale-input.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-scale-input%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-scale-input&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-scale-input.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126121">  <div class="votes">
    <div id="Vu126121">
    <a href="/manual/vote-note.php?id=126121&amp;page=function.fann-scale-input&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126121">
    <a href="/manual/vote-note.php?id=126121&amp;page=function.fann-scale-input&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126121" title="100% like this...">
    1
    </div>
  </div>
  <a href="#126121" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#126121"> &para;</a><div class="date" title="2021-05-29 06:27"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126121">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// This example will use the XOR dataset with negative one represented <br />// as zero and one represented as one-hundred and demonstrate how to<br />// scale those values so that FANN can understand them and then how <br />// to de-scale the value FANN returns so that you can understand them.<br /><br />// Scaling allows you to take raw data numbers like -1234.975 or 4502012 <br />// in your dataset and convert them into an input/output range that<br />// your neural network can understand. <br /><br />// De-scaling lets you take the scaled data and convert it back into <br />// the original range.<br /><br />// scale_test.data<br />// Note the values are "raw" or un-scaled.<br />/*<br />4 2 1<br />0 0<br />0<br />0 100<br />100<br />100 0<br />100<br />100 100<br />0<br />*/<br /><br />////////////////////<br />// Configure ANN  //<br />////////////////////<br /><br />// New ANN<br /></span><span class="default">$ann </span><span class="keyword">= </span><span class="default">fann_create_standard_array</span><span class="keyword">(</span><span class="default">3</span><span class="keyword">, [</span><span class="default">2</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">]);<br /><br /></span><span class="comment">// Set activation functions<br /></span><span class="default">fann_set_activation_function_hidden</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br /></span><span class="default">fann_set_activation_function_output</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br /><br /></span><span class="comment">// Read raw (un-scaled) training data from file<br /></span><span class="default">$train_data </span><span class="keyword">= </span><span class="default">fann_read_train_from_file</span><span class="keyword">(</span><span class="string">"scale_test.data"</span><span class="keyword">);<br /><br /></span><span class="comment">// Scale the data range to -1 to 1<br /></span><span class="default">fann_set_input_scaling_params</span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$train_data</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">fann_set_output_scaling_params</span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$train_data</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /><br /></span><span class="comment">///////////<br />// Train //<br />///////////<br /><br />// Presumably you would train here (uncomment to perform training)...<br /><br />// fann_train_on_data($ann, $train_data, 100, 10, 0.01);<br /><br />// But it's not needed to test the scaling because the training file <br />// in this case is just used to compute/derive the scale range. <br />// However, doing the training will improve the answer the ANN gives<br />// in correlation to the training data.<br /><br />//////////<br />// Test //<br />//////////<br /><br /></span><span class="default">$raw_input </span><span class="keyword">= array(</span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">); </span><span class="comment">// test XOR (0,100) input<br /></span><span class="default">$scaled_input </span><span class="keyword">= </span><span class="default">fann_scale_input </span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$raw_input</span><span class="keyword">); </span><span class="comment">// scaled XOR (-1,1) input<br /></span><span class="default">$descaled_input </span><span class="keyword">= </span><span class="default">fann_descale_input </span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$scaled_input</span><span class="keyword">); </span><span class="comment">// de-scaled XOR (0,100) input<br /></span><span class="default">$raw_output </span><span class="keyword">= </span><span class="default">fann_run</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$scaled_input</span><span class="keyword">); </span><span class="comment">// get the answer/output from the ANN<br /></span><span class="default">$output_descale </span><span class="keyword">= </span><span class="default">fann_descale_output</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$raw_output</span><span class="keyword">); </span><span class="comment">// de-scale the output <br /><br />////////////////////<br />// Report Results //<br />////////////////////<br /></span><span class="keyword">echo </span><span class="string">'The raw_input:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$raw_input</span><span class="keyword">); <br /><br />echo </span><span class="string">'The raw_input Scaled then De-Scaled (values are unchanged/correct):' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$descaled_input</span><span class="keyword">); <br /><br />echo </span><span class="string">'The Scaled input:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$scaled_input</span><span class="keyword">); <br /><br />echo </span><span class="string">"The raw_output of the ANN (Scaled input):" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$raw_output</span><span class="keyword">);<br /> <br />echo </span><span class="string">'The De-Scaled output:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$output_descale</span><span class="keyword">); <br /> <br /> <br /></span><span class="comment">////////////////////<br />// Example Output //<br />////////////////////<br /><br /> /*<br />The raw_input:<br />array(2) {<br />  [0]=&gt;<br />  float(0)<br />  [1]=&gt;<br />  float(100)<br />}<br />The raw_input Scaled then De-Scaled (values are unchanged/correct):<br />array(2) {<br />  [0]=&gt;<br />  float(0)<br />  [1]=&gt;<br />  float(100)<br />}<br />The Scaled input:<br />array(2) {<br />  [0]=&gt;<br />  float(-1)<br />  [1]=&gt;<br />  float(1)<br />}<br />The raw_output of the ANN (Scaled input):<br />array(1) {<br />  [0]=&gt;<br />  float(1)<br />}<br />The De-Scaled output:<br />array(1) {<br />  [0]=&gt;<br />  float(100)<br />}<br />*/</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126120">  <div class="votes">
    <div id="Vu126120">
    <a href="/manual/vote-note.php?id=126120&amp;page=function.fann-scale-input&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126120">
    <a href="/manual/vote-note.php?id=126120&amp;page=function.fann-scale-input&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126120" title="no votes...">
    0
    </div>
  </div>
  <a href="#126120" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#126120"> &para;</a><div class="date" title="2021-05-29 06:27"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126120">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// This example will use the XOR dataset with negative one represented <br />// as zero and one represented as one-hundred and demonstrate how to<br />// scale those values so that FANN can understand them and then how <br />// to de-scale the value FANN returns so that you can understand them.<br /><br />// Scaling allows you to take raw data numbers like -1234.975 or 4502012 <br />// in your dataset and convert them into an input/output range that<br />// your neural network can understand. <br /><br />// De-scaling lets you take the scaled data and convert it back into <br />// the original range.<br /><br />// scale_test.data<br />// Note the values are "raw" or un-scaled.<br />/*<br />4 2 1<br />0 0<br />0<br />0 100<br />100<br />100 0<br />100<br />100 100<br />0<br />*/<br /><br />////////////////////<br />// Configure ANN  //<br />////////////////////<br /><br />// New ANN<br /></span><span class="default">$ann </span><span class="keyword">= </span><span class="default">fann_create_standard_array</span><span class="keyword">(</span><span class="default">3</span><span class="keyword">, [</span><span class="default">2</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">]);<br /><br /></span><span class="comment">// Set activation functions<br /></span><span class="default">fann_set_activation_function_hidden</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br /></span><span class="default">fann_set_activation_function_output</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br /><br /></span><span class="comment">// Read raw (un-scaled) training data from file<br /></span><span class="default">$train_data </span><span class="keyword">= </span><span class="default">fann_read_train_from_file</span><span class="keyword">(</span><span class="string">"scale_test.data"</span><span class="keyword">);<br /><br /></span><span class="comment">// Scale the data range to -1 to 1<br /></span><span class="default">fann_set_input_scaling_params</span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$train_data</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">fann_set_output_scaling_params</span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$train_data</span><span class="keyword">, -</span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /><br /></span><span class="comment">///////////<br />// Train //<br />///////////<br /><br />// Presumably you would train here (uncomment to perform training)...<br /><br />// fann_train_on_data($ann, $train_data, 100, 10, 0.01);<br /><br />// But it's not needed to test the scaling because the training file <br />// in this case is just used to compute/derive the scale range. <br />// However, doing the training will improve the answer the ANN gives<br />// in correlation to the training data.<br /><br />//////////<br />// Test //<br />//////////<br /><br /></span><span class="default">$raw_input </span><span class="keyword">= array(</span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">); </span><span class="comment">// test XOR (0,100) input<br /></span><span class="default">$scaled_input </span><span class="keyword">= </span><span class="default">fann_scale_input </span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$raw_input</span><span class="keyword">); </span><span class="comment">// scaled XOR (-1,1) input<br /></span><span class="default">$descaled_input </span><span class="keyword">= </span><span class="default">fann_descale_input </span><span class="keyword">(</span><span class="default">$ann </span><span class="keyword">, </span><span class="default">$scaled_input</span><span class="keyword">); </span><span class="comment">// de-scaled XOR (0,100) input<br /></span><span class="default">$raw_output </span><span class="keyword">= </span><span class="default">fann_run</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$scaled_input</span><span class="keyword">); </span><span class="comment">// get the answer/output from the ANN<br /></span><span class="default">$output_descale </span><span class="keyword">= </span><span class="default">fann_descale_output</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$raw_output</span><span class="keyword">); </span><span class="comment">// de-scale the output <br /><br />////////////////////<br />// Report Results //<br />////////////////////<br /></span><span class="keyword">echo </span><span class="string">'The raw_input:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$raw_input</span><span class="keyword">); <br /><br />echo </span><span class="string">'The raw_input Scaled then De-Scaled (values are unchanged/correct):' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$descaled_input</span><span class="keyword">); <br /><br />echo </span><span class="string">'The Scaled input:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$scaled_input</span><span class="keyword">); <br /><br />echo </span><span class="string">"The raw_output of the ANN (Scaled input):" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$raw_output</span><span class="keyword">);<br /> <br />echo </span><span class="string">'The De-Scaled output:' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$output_descale</span><span class="keyword">); <br /> <br /> <br /></span><span class="comment">////////////////////<br />// Example Output //<br />////////////////////<br /><br /> /*<br />The raw_input:<br />array(2) {<br />  [0]=&gt;<br />  float(0)<br />  [1]=&gt;<br />  float(100)<br />}<br />The raw_input Scaled then De-Scaled (values are unchanged/correct):<br />array(2) {<br />  [0]=&gt;<br />  float(0)<br />  [1]=&gt;<br />  float(100)<br />}<br />The Scaled input:<br />array(2) {<br />  [0]=&gt;<br />  float(-1)<br />  [1]=&gt;<br />  float(1)<br />}<br />The raw_output of the ANN (Scaled input):<br />array(1) {<br />  [0]=&gt;<br />  float(1)<br />}<br />The De-Scaled output:<br />array(1) {<br />  [0]=&gt;<br />  float(100)<br />}<br />*/</span></span></code></div>
  </div>
 </div>
  <div class="note" id="124448">  <div class="votes">
    <div id="Vu124448">
    <a href="/manual/vote-note.php?id=124448&amp;page=function.fann-scale-input&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124448">
    <a href="/manual/vote-note.php?id=124448&amp;page=function.fann-scale-input&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124448" title="no votes...">
    0
    </div>
  </div>
  <a href="#124448" class="name">
  <strong class="user"><em>saakyanalexandr at gmail dot com</em></strong></a><a class="genanchor" href="#124448"> &para;</a><div class="date" title="2019-11-27 08:38"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124448">
<div class="phpcode"><code><span class="html">fann_scale_input and fann_scale_output return not bool value. This function return scaling vector.<br /><br />Example<br />$r = fann_scale_input($ann, $input);<br />$output = fann_run($ann, $input);<br />$s = fann_scale_output ( $ann, $output);<br /><br />$r and $s is array</span></code></div>
  </div>
 </div>
  <div class="note" id="121743">  <div class="votes">
    <div id="Vu121743">
    <a href="/manual/vote-note.php?id=121743&amp;page=function.fann-scale-input&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121743">
    <a href="/manual/vote-note.php?id=121743&amp;page=function.fann-scale-input&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121743" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#121743" class="name">
  <strong class="user"><em>Nolife</em></strong></a><a class="genanchor" href="#121743"> &para;</a><div class="date" title="2017-10-10 04:55"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121743">
<div class="phpcode"><code><span class="html">Please note -&gt; ALLfann  scaling related functions are not functional.<br />They are implemented wrong so the scaling is calculated within the library but it's not referenced back to the input variables.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-scale-input&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-scale-input.php">＋<small>add a note</small></a></div>
