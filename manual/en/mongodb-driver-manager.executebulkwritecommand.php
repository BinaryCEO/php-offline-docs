...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::executeBulkWriteCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwrite.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.executebulkwritecommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.executebulkwritecommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.executebulkwritecommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.executebulkwritecommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.executebulkwritecommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.executebulkwritecommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.executebulkwritecommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.executebulkwritecommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.executebulkwritecommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.executebulkwritecommand.php" hreflang="zh">
...
<meta name="Description" content="Execute write operations using the bulkWrite command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::executeBulkWriteCommand - Manual" />
<meta name="twitter:description" content="Execute write operations using the bulkWrite command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::executeBulkWriteCommand - Manual" />
<meta itemprop="description" content="Execute write operations using the bulkWrite command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute write operations using the bulkWrite command" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-manager.executecommand.php">
          MongoDB\Driver\Manager::executeCommand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.executebulkwrite.php">
          &laquo; MongoDB\Driver\Manager::executeBulkWrite        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.executebulkwritecommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.executebulkwritecommand.php'>German</option>
            <option value='es/mongodb-driver-manager.executebulkwritecommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.executebulkwritecommand.php'>French</option>
            <option value='it/mongodb-driver-manager.executebulkwritecommand.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.executebulkwritecommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.executebulkwritecommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.executebulkwritecommand.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.executebulkwritecommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.executebulkwritecommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.executebulkwritecommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.executebulkwritecommand" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">MongoDB\Driver\Manager::executeBulkWriteCommand</h1>
  <p class="verinfo">(mongodb &gt;=2.1.0)</p><p class="refpurpose"><span class="refname">MongoDB\Driver\Manager::executeBulkWriteCommand</span> &mdash; <span class="dc-title">Execute write operations using the bulkWrite command</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mongodb-driver-manager.executebulkwritecommand-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><strong>MongoDB\Driver\Manager::executeBulkWriteCommand</strong></span>(<span class="methodparam"><span class="type"><a href="class.mongodb-driver-bulkwritecommand.php" class="type MongoDB\Driver\BulkWriteCommand">MongoDB\Driver\BulkWriteCommand</a></span> <code class="parameter">$bulk</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="class.mongodb-driver-bulkwritecommandresult.php" class="type MongoDB\Driver\BulkWriteCommandResult">MongoDB\Driver\BulkWriteCommandResult</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mongodb-driver-manager.executebulkwritecommand-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-mongodb-driver-manager.executebulkwritecommand-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-mongodb-driver-manager.executebulkwritecommand-errors">
 ...
 <div class="refsect1 examples" id="refsect1-mongodb-driver-manager.executebulkwritecommand-examples">
...
Inserted 2 document(s)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mongodb-driver-manager.executebulkwritecommand-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-server.executebulkwritecommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::executeBulkWriteCommand()</a> - Execute write operations on this server using the bulkWrite command</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/executebulkwritecommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.executebulkwritecommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.executebulkwritecommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php">＋<small>add a note</small></a></span>
