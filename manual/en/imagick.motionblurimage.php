...
<head>
  ...
  <title>PHP: Imagick::motionBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.motionblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.motionblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.motionblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.mosaicimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.negateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.motionblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.motionblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.motionblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.motionblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.motionblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.motionblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.motionblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.motionblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.motionblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.motionblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.motionblurimage.php" hreflang="zh">
...
<meta name="Description" content="Simulates motion blur" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::motionBlurImage - Manual" />
<meta name="twitter:description" content="Simulates motion blur" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::motionBlurImage - Manual" />
<meta itemprop="description" content="Simulates motion blur" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Simulates motion blur" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.negateimage.php">
          Imagick::negateImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.mosaicimages.php">
          &laquo; Imagick::mosaicImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.motionblurimage.php' selected="selected">English</option>
            <option value='de/imagick.motionblurimage.php'>German</option>
            <option value='es/imagick.motionblurimage.php'>Spanish</option>
            <option value='fr/imagick.motionblurimage.php'>French</option>
            <option value='it/imagick.motionblurimage.php'>Italian</option>
            <option value='ja/imagick.motionblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.motionblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.motionblurimage.php'>Russian</option>
            <option value='tr/imagick.motionblurimage.php'>Turkish</option>
            <option value='uk/imagick.motionblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.motionblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.motionblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::motionBlurImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::motionBlurImage</span> &mdash; <span class="dc-title">Simulates motion blur</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.motionblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::motionBlurImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$angle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.motionblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.motionblurimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3056">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/motionblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.motionblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.motionblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.motionblurimage.php">＋<small>add a note</small></a></span>
