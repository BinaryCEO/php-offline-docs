...
<head>
  ...
  <title>PHP: SolrQuery::getRows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getrows.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getrows.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getrows.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getsortfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getrows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getrows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getrows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getrows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getrows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getrows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getrows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getrows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getrows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getrows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getrows.php" hreflang="zh">
...
<meta name="Description" content="Returns the maximum number of documents" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getRows - Manual" />
<meta name="twitter:description" content="Returns the maximum number of documents" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getRows - Manual" />
<meta itemprop="description" content="Returns the maximum number of documents" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the maximum number of documents" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getsortfields.php">
          SolrQuery::getSortFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getquery.php">
          &laquo; SolrQuery::getQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getrows.php' selected="selected">English</option>
            <option value='de/solrquery.getrows.php'>German</option>
            <option value='es/solrquery.getrows.php'>Spanish</option>
            <option value='fr/solrquery.getrows.php'>French</option>
            <option value='it/solrquery.getrows.php'>Italian</option>
            <option value='ja/solrquery.getrows.php'>Japanese</option>
            <option value='pt_BR/solrquery.getrows.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getrows.php'>Russian</option>
            <option value='tr/solrquery.getrows.php'>Turkish</option>
            <option value='uk/solrquery.getrows.php'>Ukrainian</option>
            <option value='zh/solrquery.getrows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getrows" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getRows</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getRows</span> &mdash; <span class="dc-title">Returns the maximum number of documents</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getrows-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getRows</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getrows-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getrows-returnvalues">
...
Returns an integer on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getrows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getrows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getrows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getrows.php">＋<small>add a note</small></a></span>
