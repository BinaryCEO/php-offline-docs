...
<head>
  ...
  <title>PHP: UI\Draw\Text\Font\Weight - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-text-font-weight.php">
 <link rel="shorturl" href="https://www.php.net/ui-draw-text-font-weight">
 <link rel="alternate" href="https://www.php.net/ui-draw-text-font-weight" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ui-run.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ui-draw-text-font-italic.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-draw-text-font-weight.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-draw-text-font-weight.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-draw-text-font-weight.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-draw-text-font-weight.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-draw-text-font-weight.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-draw-text-font-weight.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-draw-text-font-weight.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-draw-text-font-weight.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-draw-text-font-weight.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-draw-text-font-weight.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-draw-text-font-weight.php" hreflang="zh">
...
<meta name="Description" content="Font Weight Settings" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Draw\Text\Font\Weight - Manual" />
<meta name="twitter:description" content="Font Weight Settings" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Text\Font\Weight - Manual" />
<meta itemprop="description" content="Font Weight Settings" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Font Weight Settings" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.ui-draw-text-font-italic.php">
          UI\Draw\Text\Font\Italic &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-text-font-weight.php' selected="selected">English</option>
            <option value='de/class.ui-draw-text-font-weight.php'>German</option>
            <option value='es/class.ui-draw-text-font-weight.php'>Spanish</option>
            <option value='fr/class.ui-draw-text-font-weight.php'>French</option>
            <option value='it/class.ui-draw-text-font-weight.php'>Italian</option>
            <option value='ja/class.ui-draw-text-font-weight.php'>Japanese</option>
            <option value='pt_BR/class.ui-draw-text-font-weight.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-draw-text-font-weight.php'>Russian</option>
            <option value='tr/class.ui-draw-text-font-weight.php'>Turkish</option>
            <option value='uk/class.ui-draw-text-font-weight.php'>Ukrainian</option>
            <option value='zh/class.ui-draw-text-font-weight.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-draw-text-font-weight" class="reference">

 <h1 class="title">Font Weight Settings</h1>
   ...
   <dl>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.text.font.weight.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-text-font-weight%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-text-font-weight&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-text-font-weight.php">＋<small>add a note</small></a></span>
