...
<head>
  ...
  <title>PHP: mb_substr_count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-substr-count.php">
 <link rel="shorturl" href="https://www.php.net/mb-substr-count">
 <link rel="alternate" href="https://www.php.net/mb-substr-count" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-substr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-trim.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-substr-count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-substr-count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-substr-count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-substr-count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-substr-count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-substr-count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-substr-count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-substr-count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-substr-count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-substr-count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-substr-count.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mb_substr_count - Manual" />
<meta name="twitter:description" content="Count the number of substring occurrences" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_substr_count - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-substr-count.php' selected="selected">English</option>
            <option value='de/function.mb-substr-count.php'>German</option>
            <option value='es/function.mb-substr-count.php'>Spanish</option>
            <option value='fr/function.mb-substr-count.php'>French</option>
            <option value='it/function.mb-substr-count.php'>Italian</option>
            <option value='ja/function.mb-substr-count.php'>Japanese</option>
            <option value='pt_BR/function.mb-substr-count.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-substr-count.php'>Russian</option>
            <option value='tr/function.mb-substr-count.php'>Turkish</option>
            <option value='uk/function.mb-substr-count.php'>Ukrainian</option>
            <option value='zh/function.mb-substr-count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-substr-count" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_substr_count</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_substr_count</span> &mdash; <span class="dc-title">Count the number of substring occurrences</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-substr-count-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_substr_count</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$haystack</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$needle</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Counts the number of times the
   <code class="parameter">needle</code> substring occurs in the
   <code class="parameter">haystack</code> <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mb-substr-count-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> being found.
      </p>
     </dd>
...
encoding value will be used.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-substr-count-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.mb-substr-count-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-substr-count-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2794">
    <p><strong>Example #1 <span class="function"><strong>mb_substr_count()</strong></span> example</strong></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">mb_substr_count</span><span style="color: #007700">(</span><span style="color: #DD0000">"This is a test"</span><span style="color: #007700">, </span><span style="color: #DD0000">"is"</span><span style="color: #007700">); </span><span style="color: #FF8000">// prints out 2<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-substr-count-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.substr-count.php" class="function" rel="rdfs-seeAlso">substr_count()</a> - Count the number of substring occurrences</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-substr-count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-substr-count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-substr-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-substr-count.php">＋<small>add a note</small></a></span>
