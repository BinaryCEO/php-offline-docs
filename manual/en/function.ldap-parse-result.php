...
<head>
  ...
  <title>PHP: ldap_parse_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-parse-result.php">
 <link rel="shorturl" href="https://www.php.net/ldap-parse-result">
 <link rel="alternate" href="https://www.php.net/ldap-parse-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-parse-reference.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-parse-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-parse-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-parse-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-parse-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-parse-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-parse-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-parse-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-parse-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-parse-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-parse-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-parse-result.php" hreflang="zh">
...
<meta name="Description" content="Extract information from result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_parse_result - Manual" />
<meta name="twitter:description" content="Extract information from result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_parse_result - Manual" />
<meta itemprop="description" content="Extract information from result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extract information from result" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-parse-result.php' selected="selected">English</option>
            <option value='de/function.ldap-parse-result.php'>German</option>
            <option value='es/function.ldap-parse-result.php'>Spanish</option>
            <option value='fr/function.ldap-parse-result.php'>French</option>
            <option value='it/function.ldap-parse-result.php'>Italian</option>
            <option value='ja/function.ldap-parse-result.php'>Japanese</option>
            <option value='pt_BR/function.ldap-parse-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-parse-result.php'>Russian</option>
            <option value='tr/function.ldap-parse-result.php'>Turkish</option>
            <option value='uk/function.ldap-parse-result.php'>Ukrainian</option>
            <option value='zh/function.ldap-parse-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-parse-result" class="refentry">
    ...
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$result </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_search</span><span style="color: #007700">(</span><span style="color: #0000BB">$ldap</span><span style="color: #007700">, </span><span style="color: #DD0000">"cn=userref,dc=my-domain,dc=com"</span><span style="color: #007700">, </span><span style="color: #DD0000">"(cn=user*)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$errcode </span><span style="color: #007700">= </span><span style="color: #0000BB">$dn </span><span style="color: #007700">= </span><span style="color: #0000BB">$errmsg </span><span style="color: #007700">= </span><span style="color: #0000BB">$refs </span><span style="color: #007700">=  </span><span style="color: #0000BB">null</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">ldap_parse_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$ldap</span><span style="color: #007700">, </span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">$errcode</span><span style="color: #007700">, </span><span style="color: #0000BB">$dn</span><span style="color: #007700">, </span><span style="color: #0000BB">$errmsg</span><span style="color: #007700">, </span><span style="color: #0000BB">$refs</span><span style="color: #007700">)) {<br />    </span><span style="color: #FF8000">// do something with $errcode, $dn, $errmsg and $refs<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-parse-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-parse-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-parse-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-parse-result.php">＋<small>add a note</small></a></span>
