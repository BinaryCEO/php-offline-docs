...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-get-parameter.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-get-buffer.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-get-value.php">
...
<meta name="Description" content="Gets certain parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_get_parameter - Manual" />
<meta name="twitter:description" content="Gets certain parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_get_parameter - Manual" />
<meta itemprop="description" content="Gets certain parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets certain parameters" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-get-parameter.php' selected="selected">English</option>
            ...
            <option value='ru/function.ps-get-parameter.php'>Russian</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-get-parameter-returnvalues">
  ...
  <p class="para">
   Returns the value of the parameter  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-set-parameter.php" class="function" rel="rdfs-seeAlso">ps_set_parameter()</a> - Sets certain parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-get-parameter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-get-parameter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-get-parameter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-get-parameter.php">＋<small>add a note</small></a></span>
