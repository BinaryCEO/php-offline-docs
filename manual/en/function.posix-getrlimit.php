...
<head>
  ...
  <title>PHP: posix_getrlimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getrlimit.php">
 <link rel="shorturl" href="https://www.php.net/posix-getrlimit">
 <link rel="alternate" href="https://www.php.net/posix-getrlimit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getpwuid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getsid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getrlimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getrlimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getrlimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getrlimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getrlimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getrlimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getrlimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getrlimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getrlimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getrlimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getrlimit.php" hreflang="zh">
...
<meta name="Description" content="Return info about system resource limits" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getrlimit - Manual" />
<meta name="twitter:description" content="Return info about system resource limits" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getrlimit - Manual" />
<meta itemprop="description" content="Return info about system resource limits" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return info about system resource limits" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getrlimit.php' selected="selected">English</option>
            <option value='de/function.posix-getrlimit.php'>German</option>
            <option value='es/function.posix-getrlimit.php'>Spanish</option>
            <option value='fr/function.posix-getrlimit.php'>French</option>
            <option value='it/function.posix-getrlimit.php'>Italian</option>
            <option value='ja/function.posix-getrlimit.php'>Japanese</option>
            <option value='pt_BR/function.posix-getrlimit.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getrlimit.php'>Russian</option>
            <option value='tr/function.posix-getrlimit.php'>Turkish</option>
            <option value='uk/function.posix-getrlimit.php'>Ukrainian</option>
            <option value='zh/function.posix-getrlimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getrlimit" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.posix-setrlimit.php" class="function" rel="rdfs-seeAlso">posix_setrlimit()</a> - Set system resource limits</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getrlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getrlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getrlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getrlimit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="8152">  <div class="votes">
    <div id="Vu8152">
    <a href="/manual/vote-note.php?id=8152&amp;page=function.posix-getrlimit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd8152">
    <a href="/manual/vote-note.php?id=8152&amp;page=function.posix-getrlimit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V8152" title="16% like this...">
    -4
    </div>
  </div>
  <a href="#8152" class="name">
  <strong class="user"><em>petert at tebault dot org</em></strong></a><a class="genanchor" href="#8152"> &para;</a><div class="date" title="2000-08-29 12:58"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom8152">
<div class="phpcode"><code><span class="html">The array returned (on a RH6.2 box) is:
<br />     soft core = 0
<br />     hard core = unlimited
<br />     soft data = unlimited
<br />     hard data = unlimited
<br />     soft stack = 8388608
<br />     hard stack = unlimited
<br />     soft totalmem = unlimited
<br />     hard totalmem = unlimited
<br />     soft rss = unlimited
<br />     hard rss = unlimited
<br />     soft maxproc = 2048
<br />     hard maxproc = 2048
<br />     soft memlock = unlimited
<br />     hard memlock = unlimited
<br />     soft cpu = unlimited
<br />     hard cpu = unlimited
<br />     soft filesize = unlimited
<br />     hard filesize = unlimited
<br />     soft openfiles = 1024
<br />     hard openfiles = 1024</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-getrlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getrlimit.php">＋<small>add a note</small></a></div>
