...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeDashOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokedashoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokedashoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokedashoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokedashoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokedashoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokedashoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokedashoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokedashoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokedashoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokedashoffset.php" hreflang="zh">
...
<meta name="Description" content="Specifies the offset into the dash pattern to start the dash" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeDashOffset - Manual" />
<meta name="twitter:description" content="Specifies the offset into the dash pattern to start the dash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeDashOffset - Manual" />
<meta itemprop="description" content="Specifies the offset into the dash pattern to start the dash" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the offset into the dash pattern to start the dash" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokelinecap.php">
          ImagickDraw::setStrokeLineCap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokedasharray.php">
          &laquo; ImagickDraw::setStrokeDashArray        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokedashoffset.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokedashoffset.php'>German</option>
            <option value='es/imagickdraw.setstrokedashoffset.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokedashoffset.php'>French</option>
            <option value='it/imagickdraw.setstrokedashoffset.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokedashoffset.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokedashoffset.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokedashoffset.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokedashoffset.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokedashoffset.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokedashoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokedashoffset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeDashOffset</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeDashOffset</span> &mdash; <span class="dc-title">Specifies the offset into the dash pattern to start the dash</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokedashoffset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeDashOffset</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$dash_offset</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokedashoffset-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">dash_offset</code></dt>
     <dd>
      <p class="para">
       dash offset
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokedashoffset-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3185">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokedashoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokedashoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokedashoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php">＋<small>add a note</small></a></span>
