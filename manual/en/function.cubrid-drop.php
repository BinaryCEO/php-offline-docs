...
<head>
  ...
  <title>PHP: cubrid_drop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-drop.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-drop">
 <link rel="alternate" href="https://www.php.net/cubrid-drop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-disconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-error-code.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-drop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-drop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-drop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-drop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-drop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-drop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-drop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-drop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-drop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-drop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-drop.php" hreflang="zh">
...
<meta name="Description" content="Delete an instance using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_drop - Manual" />
<meta name="twitter:description" content="Delete an instance using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_drop - Manual" />
<meta itemprop="description" content="Delete an instance using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an instance using OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-error-code.php">
          cubrid_error_code &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-disconnect.php">
          &laquo; cubrid_disconnect        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-drop.php' selected="selected">English</option>
            <option value='de/function.cubrid-drop.php'>German</option>
            <option value='es/function.cubrid-drop.php'>Spanish</option>
            <option value='fr/function.cubrid-drop.php'>French</option>
            <option value='it/function.cubrid-drop.php'>Italian</option>
            <option value='ja/function.cubrid-drop.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-drop.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-drop.php'>Russian</option>
            <option value='tr/function.cubrid-drop.php'>Turkish</option>
            <option value='uk/function.cubrid-drop.php'>Ukrainian</option>
            <option value='zh/function.cubrid-drop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-drop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_drop</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_drop</span> &mdash; <span class="dc-title">Delete an instance using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-drop-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_drop</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_drop()</strong></span> function is used to delete an
    instance from database by using the <code class="parameter">oid</code> of the instance.
  </p>
 </div>


  <div class="refsect1 parameters" id="refsect1-function.cubrid-drop-parameters">
 ...
 <p class="para">
  ...
  <dd><p class="para">Oid of the instance that you want to delete.</p></dd>
  ...
  <div class="refsect1 returnvalues" id="refsect1-function.cubrid-drop-returnvalues">
...
array(4) {
  ...
  <div class="refsect1 seealso" id="refsect1-function.cubrid-drop-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-is-instance.php" class="function" rel="rdfs-seeAlso">cubrid_is_instance()</a> - Check whether the instance pointed by OID exists</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-drop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-drop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-drop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-drop.php">＋<small>add a note</small></a></span>
