...
<head>
  ...
  <title>PHP: Imagick::setSizeOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setsizeoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setsizeoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsizeoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setsize.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.settype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setsizeoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setsizeoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setsizeoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setsizeoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setsizeoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setsizeoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setsizeoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setsizeoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setsizeoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setsizeoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setsizeoffset.php" hreflang="zh">
...
<meta name="Description" content="Sets the size and offset of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setSizeOffset - Manual" />
<meta name="twitter:description" content="Sets the size and offset of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setSizeOffset - Manual" />
<meta itemprop="description" content="Sets the size and offset of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the size and offset of the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.settype.php">
          Imagick::setType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setsize.php">
          &laquo; Imagick::setSize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setsizeoffset.php' selected="selected">English</option>
            <option value='de/imagick.setsizeoffset.php'>German</option>
            <option value='es/imagick.setsizeoffset.php'>Spanish</option>
            <option value='fr/imagick.setsizeoffset.php'>French</option>
            <option value='it/imagick.setsizeoffset.php'>Italian</option>
            <option value='ja/imagick.setsizeoffset.php'>Japanese</option>
            <option value='pt_BR/imagick.setsizeoffset.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setsizeoffset.php'>Russian</option>
            <option value='tr/imagick.setsizeoffset.php'>Turkish</option>
            <option value='uk/imagick.setsizeoffset.php'>Ukrainian</option>
            <option value='zh/imagick.setsizeoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setsizeoffset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setSizeOffset</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setSizeOffset</span> &mdash; <span class="dc-title">Sets the size and offset of the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setsizeoffset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setSizeOffset</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setsizeoffset-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setsizeoffset-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setsizeoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setsizeoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setsizeoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setsizeoffset.php">＋<small>add a note</small></a></span>
