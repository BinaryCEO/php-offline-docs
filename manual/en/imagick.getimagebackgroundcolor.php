...
<head>
  ...
  <title>PHP: Imagick::getImageBackgroundColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageattribute.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageblob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagebackgroundcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagebackgroundcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagebackgroundcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagebackgroundcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagebackgroundcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagebackgroundcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagebackgroundcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagebackgroundcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagebackgroundcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagebackgroundcolor.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageBackgroundColor - Manual" />
<meta name="twitter:description" content="Returns the image background color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageBackgroundColor - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageblob.php">
          Imagick::getImageBlob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageattribute.php">
          &laquo; Imagick::getImageAttribute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagebackgroundcolor.php' selected="selected">English</option>
            <option value='de/imagick.getimagebackgroundcolor.php'>German</option>
            <option value='es/imagick.getimagebackgroundcolor.php'>Spanish</option>
            <option value='fr/imagick.getimagebackgroundcolor.php'>French</option>
            <option value='it/imagick.getimagebackgroundcolor.php'>Italian</option>
            <option value='ja/imagick.getimagebackgroundcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagebackgroundcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagebackgroundcolor.php'>Russian</option>
            <option value='tr/imagick.getimagebackgroundcolor.php'>Turkish</option>
            <option value='uk/imagick.getimagebackgroundcolor.php'>Ukrainian</option>
            <option value='zh/imagick.getimagebackgroundcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagebackgroundcolor" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagebackgroundcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagebackgroundcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagebackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagebackgroundcolor.php">＋<small>add a note</small></a></span>
