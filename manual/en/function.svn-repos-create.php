...
<head>
  ...
  <title>PHP: svn_repos_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-repos-create.php">
 <link rel="shorturl" href="https://www.php.net/svn-repos-create">
 <link rel="alternate" href="https://www.php.net/svn-repos-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-mkdir.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-repos-fs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-repos-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-repos-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-repos-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-repos-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-repos-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-repos-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-repos-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-repos-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-repos-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-repos-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-repos-create.php" hreflang="zh">
...
<meta name="Description" content="Create a new subversion repository at path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_repos_create - Manual" />
<meta name="twitter:description" content="Create a new subversion repository at path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_repos_create - Manual" />
<meta itemprop="description" content="Create a new subversion repository at path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new subversion repository at path" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-repos-create.php' selected="selected">English</option>
            <option value='de/function.svn-repos-create.php'>German</option>
            <option value='es/function.svn-repos-create.php'>Spanish</option>
            <option value='fr/function.svn-repos-create.php'>French</option>
            <option value='it/function.svn-repos-create.php'>Italian</option>
            <option value='ja/function.svn-repos-create.php'>Japanese</option>
            <option value='pt_BR/function.svn-repos-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-repos-create.php'>Russian</option>
            <option value='tr/function.svn-repos-create.php'>Turkish</option>
            <option value='uk/function.svn-repos-create.php'>Ukrainian</option>
            <option value='zh/function.svn-repos-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-repos-create" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_repos_create</h1>
  <p class="verinfo">(PECL svn &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">svn_repos_create</span> &mdash; <span class="dc-title">Create a new subversion repository at path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-repos-create-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_repos_create</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$config</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$fsconfig</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-repos-create-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-repos-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-repos-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-repos-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-repos-create.php">＋<small>add a note</small></a></span>
