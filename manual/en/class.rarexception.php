...
<head>
  ...
  <title>PHP: RarException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.rarexception.php">
 <link rel="shorturl" href="https://www.php.net/rarexception">
 <link rel="alternate" href="https://www.php.net/rarexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.rar.php">
 <link rel="prev" href="https://www.php.net/manual/en/rarentry.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/rarexception.isusingexceptions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.rarexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.rarexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.rarexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.rarexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.rarexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.rarexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.rarexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.rarexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.rarexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.rarexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.rarexception.php" hreflang="zh">
...
<meta name="Description" content="The RarException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: RarException - Manual" />
<meta name="twitter:description" content="The RarException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: RarException - Manual" />
<meta itemprop="description" content="The RarException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The RarException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="rarexception.isusingexceptions.php">
          RarException::isUsingExceptions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="rarentry.tostring.php">
          &laquo; RarEntry::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.rarexception.php' selected="selected">English</option>
            <option value='de/class.rarexception.php'>German</option>
            <option value='es/class.rarexception.php'>Spanish</option>
            <option value='fr/class.rarexception.php'>French</option>
            <option value='it/class.rarexception.php'>Italian</option>
            <option value='ja/class.rarexception.php'>Japanese</option>
            <option value='pt_BR/class.rarexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.rarexception.php'>Russian</option>
            <option value='tr/class.rarexception.php'>Turkish</option>
            <option value='uk/class.rarexception.php'>Ukrainian</option>
            <option value='zh/class.rarexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.rarexception" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="rarexception.isusingexceptions.php">RarException::isUsingExceptions</a> — Check whether error handling with exceptions is in use</li><li><a href="rarexception.setusingexceptions.php">RarException::setUsingExceptions</a> — Activate and deactivate error handling with exceptions</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rar/rarexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.rarexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.rarexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.rarexception.php">＋<small>add a note</small></a></span>
