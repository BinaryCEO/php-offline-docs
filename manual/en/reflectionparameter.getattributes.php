...
<head>
  ...
  <title>PHP: ReflectionParameter::getAttributes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.getattributes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.getattributes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.getattributes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.export.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionparameter.getclass.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.getattributes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.getattributes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.getattributes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.getattributes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.getattributes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.getattributes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.getattributes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.getattributes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.getattributes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.getattributes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.getattributes.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ReflectionParameter::getAttributes - Manual" />
<meta name="twitter:description" content="Gets Attributes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::getAttributes - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionparameter.getclass.php">
          ReflectionParameter::getClass &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.export.php">
          &laquo; ReflectionParameter::export        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.getattributes.php' selected="selected">English</option>
            <option value='de/reflectionparameter.getattributes.php'>German</option>
            <option value='es/reflectionparameter.getattributes.php'>Spanish</option>
            <option value='fr/reflectionparameter.getattributes.php'>French</option>
            <option value='it/reflectionparameter.getattributes.php'>Italian</option>
            <option value='ja/reflectionparameter.getattributes.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.getattributes.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.getattributes.php'>Russian</option>
            <option value='tr/reflectionparameter.getattributes.php'>Turkish</option>
            <option value='uk/reflectionparameter.getattributes.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.getattributes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.getattributes" class="refentry">
...
<dd>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.getattributes-examples">
  ...
  <p class="para">
   <div class="example" id="example-5579">
...
(
  ...
  <p class="para">
   <div class="example" id="example-5580">
...
(
  ...
  <p class="para">
   <div class="example" id="example-5581">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionproperty.getattributes.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::getAttributes()</a> - Gets Attributes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/getattributes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.getattributes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.getattributes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.getattributes.php">＋<small>add a note</small></a></span>
