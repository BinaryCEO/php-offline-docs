...
<head>
  ...
  <title>PHP: Imagick::radialBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.radialblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.radialblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.radialblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.queryformats.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.raiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.radialblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.radialblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.radialblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.radialblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.radialblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.radialblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.radialblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.radialblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.radialblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.radialblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.radialblurimage.php" hreflang="zh">
...
<meta name="Description" content="Radial blurs an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::radialBlurImage - Manual" />
<meta name="twitter:description" content="Radial blurs an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::radialBlurImage - Manual" />
<meta itemprop="description" content="Radial blurs an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Radial blurs an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.raiseimage.php">
          Imagick::raiseImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.queryformats.php">
          &laquo; Imagick::queryFormats        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.radialblurimage.php' selected="selected">English</option>
            <option value='de/imagick.radialblurimage.php'>German</option>
            <option value='es/imagick.radialblurimage.php'>Spanish</option>
            <option value='fr/imagick.radialblurimage.php'>French</option>
            <option value='it/imagick.radialblurimage.php'>Italian</option>
            <option value='ja/imagick.radialblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.radialblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.radialblurimage.php'>Russian</option>
            <option value='tr/imagick.radialblurimage.php'>Turkish</option>
            <option value='uk/imagick.radialblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.radialblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.radialblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::radialBlurImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::radialBlurImage</span> &mdash; <span class="dc-title">Radial blurs an image</span></p>

 </div>

 <div id="imagick.radialblurimage-refsynopsisdiv">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.radialblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.radialblurimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3072">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/radialblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.radialblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.radialblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.radialblurimage.php">＋<small>add a note</small></a></span>
