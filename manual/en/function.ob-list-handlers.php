...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ob-list-handlers.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ob-implicit-flush.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ob-start.php">
...
<meta name="Description" content="List all output handlers in use" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ob_list_handlers - Manual" />
<meta name="twitter:description" content="List all output handlers in use" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ob_list_handlers - Manual" />
<meta itemprop="description" content="List all output handlers in use" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List all output handlers in use" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ob-list-handlers.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.ob-list-handlers.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ob_list_handlers</span> &mdash; <span class="dc-title">List all output handlers in use</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ob-list-handlers-returnvalues">
  ...
  <p class="para">
   If <a href="outcontrol.configuration.php#ini.output-buffering" class="link">output_buffering</a> is enabled
   and no <a href="outcontrol.configuration.php#ini.output-handler" class="link">output_handler</a> is set,
   or no callback or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> was passed to <span class="function"><a href="function.ob-start.php" class="function">ob_start()</a></span>,
   <code class="literal">&quot;default output handler&quot;</code> is returned.
   Enabling <a href="outcontrol.configuration.php#ini.output-buffering" class="link">output_buffering</a>
   and setting an <a href="outcontrol.configuration.php#ini.output-handler" class="link">output_handler</a>
   is equivalent to passing
   an <a href="functions.internal.php" class="link">internal (built-in) function</a>
   to <span class="function"><a href="function.ob-start.php" class="function">ob_start()</a></span>.
  </p>
  <p class="para">
   If a <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> was passed to <span class="function"><a href="function.ob-start.php" class="function">ob_start()</a></span>,
   the <a href="language.namespaces.basics.php" class="link">fully qualified name</a>
   of the <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> is returned.
   If the <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> is an object implementing
   <a href="language.oop5.magic.php#language.oop5.magic.invoke" class="link">__invoke()</a>,
   the <a href="language.namespaces.basics.php" class="link">fully qualified name</a>
   of the object&#039;s <a href="language.oop5.magic.php#language.oop5.magic.invoke" class="link">__invoke()</a>
   method is returned.
   If the <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> is a <span class="classname"><a href="class.closure.php" class="classname">Closure</a></span>,
   <code class="literal">&quot;Closure::__invoke&quot;</code> is returned.
  </p>
 </div>
   ...
   return the contents of the active output buffer and turn it off</span></li>
    <li><span class="function"><a href="function.ob-start.php" class="function" rel="rdfs-seeAlso">ob_start()</a> - Turn on output buffering</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/functions/ob-list-handlers.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ob-list-handlers%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ob-list-handlers&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ob-list-handlers.php">＋<small>add a note</small></a></span>
