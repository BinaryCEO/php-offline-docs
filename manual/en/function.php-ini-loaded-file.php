...
<head>
  ...
  <title>PHP: php_ini_loaded_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.php-ini-loaded-file.php">
 <link rel="shorturl" href="https://www.php.net/php-ini-loaded-file">
 <link rel="alternate" href="https://www.php.net/php-ini-loaded-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.memory-reset-peak-usage.php">
 <link rel="next" href="https://www.php.net/manual/en/function.php-ini-scanned-files.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.php-ini-loaded-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.php-ini-loaded-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.php-ini-loaded-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.php-ini-loaded-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.php-ini-loaded-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.php-ini-loaded-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.php-ini-loaded-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.php-ini-loaded-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.php-ini-loaded-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.php-ini-loaded-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.php-ini-loaded-file.php" hreflang="zh">
...
<meta name="Description" content="Retrieve a path to the loaded php.ini file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: php_ini_loaded_file - Manual" />
<meta name="twitter:description" content="Retrieve a path to the loaded php.ini file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: php_ini_loaded_file - Manual" />
<meta itemprop="description" content="Retrieve a path to the loaded php.ini file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve a path to the loaded php.ini file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.php-ini-scanned-files.php">
          php_ini_scanned_files &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.memory-reset-peak-usage.php">
          &laquo; memory_reset_peak_usage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.php-ini-loaded-file.php' selected="selected">English</option>
            <option value='de/function.php-ini-loaded-file.php'>German</option>
            <option value='es/function.php-ini-loaded-file.php'>Spanish</option>
            <option value='fr/function.php-ini-loaded-file.php'>French</option>
            <option value='it/function.php-ini-loaded-file.php'>Italian</option>
            <option value='ja/function.php-ini-loaded-file.php'>Japanese</option>
            <option value='pt_BR/function.php-ini-loaded-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.php-ini-loaded-file.php'>Russian</option>
            <option value='tr/function.php-ini-loaded-file.php'>Turkish</option>
            <option value='uk/function.php-ini-loaded-file.php'>Ukrainian</option>
            <option value='zh/function.php-ini-loaded-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.php-ini-loaded-file" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.php-ini-loaded-file-examples">
  ...
  <p class="para">
   <div class="example" id="example-664">
    <p><strong>Example #1 <span class="function"><strong>php_ini_loaded_file()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Loaded php.ini: /usr/local/php/php.ini</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.php-ini-loaded-file-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.php-ini-scanned-files.php" class="function" rel="rdfs-seeAlso">php_ini_scanned_files()</a> - Return a list of .ini files parsed from the additional ini dir</span></li>
    ...
    <li><a href="configuration.file.php" class="link">The configuration file</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/php-ini-loaded-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.php-ini-loaded-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.php-ini-loaded-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.php-ini-loaded-file.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124436">  <div class="votes">
    <div id="Vu124436">
    <a href="/manual/vote-note.php?id=124436&amp;page=function.php-ini-loaded-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124436">
    <a href="/manual/vote-note.php?id=124436&amp;page=function.php-ini-loaded-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124436" title="56% like this...">
    4
    </div>
  </div>
  <a href="#124436" class="name">
  <strong class="user"><em>geekcom</em></strong></a><a class="genanchor" href="#124436"> &para;</a><div class="date" title="2019-11-26 06:45"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124436">
<div class="phpcode"><code><span class="html">To find your php.ini just run<br /><br />php --ini</span></code></div>
  </div>
 </div>
  <div class="note" id="117357">  <div class="votes">
    <div id="Vu117357">
    <a href="/manual/vote-note.php?id=117357&amp;page=function.php-ini-loaded-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117357">
    <a href="/manual/vote-note.php?id=117357&amp;page=function.php-ini-loaded-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117357" title="48% like this...">
    -2
    </div>
  </div>
  <a href="#117357" class="name">
  <strong class="user"><em>Andy Dodd</em></strong></a><a class="genanchor" href="#117357"> &para;</a><div class="date" title="2015-05-27 07:31"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117357">
<div class="phpcode"><code><span class="html">Or you could use<br />php -i | grep php.ini</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.php-ini-loaded-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.php-ini-loaded-file.php">＋<small>add a note</small></a></div>
