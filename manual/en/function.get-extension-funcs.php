...
<head>
  ...
  <title>PHP: get_extension_funcs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-extension-funcs.php">
 <link rel="shorturl" href="https://www.php.net/get-extension-funcs">
 <link rel="alternate" href="https://www.php.net/get-extension-funcs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.get-defined-constants.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-include-path.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-extension-funcs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-extension-funcs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-extension-funcs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-extension-funcs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-extension-funcs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-extension-funcs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-extension-funcs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-extension-funcs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-extension-funcs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-extension-funcs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-extension-funcs.php" hreflang="zh">
...
<meta name="Description" content="Returns an array with the names of the functions of a module" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_extension_funcs - Manual" />
<meta name="twitter:description" content="Returns an array with the names of the functions of a module" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_extension_funcs - Manual" />
<meta itemprop="description" content="Returns an array with the names of the functions of a module" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array with the names of the functions of a module" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.get-include-path.php">
          get_include_path &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.get-defined-constants.php">
          &laquo; get_defined_constants        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-extension-funcs.php' selected="selected">English</option>
            <option value='de/function.get-extension-funcs.php'>German</option>
            <option value='es/function.get-extension-funcs.php'>Spanish</option>
            <option value='fr/function.get-extension-funcs.php'>French</option>
            <option value='it/function.get-extension-funcs.php'>Italian</option>
            <option value='ja/function.get-extension-funcs.php'>Japanese</option>
            <option value='pt_BR/function.get-extension-funcs.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-extension-funcs.php'>Russian</option>
            <option value='tr/function.get-extension-funcs.php'>Turkish</option>
            <option value='uk/function.get-extension-funcs.php'>Ukrainian</option>
            <option value='zh/function.get-extension-funcs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-extension-funcs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">get_extension_funcs</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">get_extension_funcs</span> &mdash; <span class="dc-title">Returns an array with the names of the functions of a module</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.get-extension-funcs-description">
  ...
  <p class="para rdfs-comment">
   ...
   the module indicated by <code class="parameter">extension</code>.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      ...
      <blockquote class="note"><p><strong class="note">Note</strong>: 
       <p class="para">
        This parameter must be in <em>lowercase</em>.
       </p>
      </p></blockquote>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.get-extension-funcs-returnvalues">
  ...
  <p class="para">
   Returns an array with all the functions, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if 
   <code class="parameter">extension</code> is not a valid extension.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.get-extension-funcs-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionextension.getfunctions.php" class="methodname" rel="rdfs-seeAlso">ReflectionExtension::getFunctions()</a> - Gets extension functions</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-extension-funcs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-extension-funcs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-extension-funcs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-extension-funcs.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="67192">  <div class="votes">
    <div id="Vu67192">
    <a href="/manual/vote-note.php?id=67192&amp;page=function.get-extension-funcs&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd67192">
    <a href="/manual/vote-note.php?id=67192&amp;page=function.get-extension-funcs&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V67192" title="63% like this...">
    6
    </div>
  </div>
  <a href="#67192" class="name">
  <strong class="user"><em>JM</em></strong></a><a class="genanchor" href="#67192"> &para;</a><div class="date" title="2006-06-05 07:40"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom67192">
<div class="phpcode"><code><span class="html">FALSE is returned if there are no functions in that extension.  For example, <span class="default">&lt;?php get_extension_funcs</span><span class="keyword">(</span><span class="string">"xmlreader"</span><span class="keyword">); </span><span class="default">?&gt;</span> returns FALSE because that extension defines the XMLReader class but not functions.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.get-extension-funcs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-extension-funcs.php">＋<small>add a note</small></a></div>
