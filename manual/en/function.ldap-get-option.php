...
<head>
  ...
  <title>PHP: ldap_get_option - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-get-option.php">
 <link rel="shorturl" href="https://www.php.net/ldap-get-option">
 <link rel="alternate" href="https://www.php.net/ldap-get-option" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-get-entries.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-get-values.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-get-option.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-get-option.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-get-option.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-get-option.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-get-option.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-get-option.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-get-option.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-get-option.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-get-option.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-get-option.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-get-option.php" hreflang="zh">
...
<meta name="Description" content="Get the current value for given option" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_get_option - Manual" />
<meta name="twitter:description" content="Get the current value for given option" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_get_option - Manual" />
<meta itemprop="description" content="Get the current value for given option" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the current value for given option" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-get-values.php">
          ldap_get_values &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-get-entries.php">
          &laquo; ldap_get_entries        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-get-option.php' selected="selected">English</option>
            <option value='de/function.ldap-get-option.php'>German</option>
            <option value='es/function.ldap-get-option.php'>Spanish</option>
            <option value='fr/function.ldap-get-option.php'>French</option>
            <option value='it/function.ldap-get-option.php'>Italian</option>
            <option value='ja/function.ldap-get-option.php'>Japanese</option>
            <option value='pt_BR/function.ldap-get-option.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-get-option.php'>Russian</option>
            <option value='tr/function.ldap-get-option.php'>Turkish</option>
            <option value='uk/function.ldap-get-option.php'>Ukrainian</option>
            <option value='zh/function.ldap-get-option.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-get-option" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_get_option</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_get_option</span> &mdash; <span class="dc-title">Get the current value for given option</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-get-option-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_get_option</strong></span>(<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$option</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter reference">&$value</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets <code class="parameter">value</code> to the value of the specified option.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.ldap-get-option-examples">
  ...
  <p class="para">
   <div class="example" id="example-4636">
    <p><strong>Example #1 Check protocol version</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// $ds is a valid LDAP\Connection instance for a directory server<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">ldap_get_option</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">LDAP_OPT_PROTOCOL_VERSION</span><span style="color: #007700">, </span><span style="color: #0000BB">$version</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"Using protocol version </span><span style="color: #0000BB">$version</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"Unable to determine protocol version\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-get-option-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-set-option.php" class="function" rel="rdfs-seeAlso">ldap_set_option()</a> - Set the value of the given option</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-get-option.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-get-option%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-get-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-option.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119393">  <div class="votes">
    <div id="Vu119393">
    <a href="/manual/vote-note.php?id=119393&amp;page=function.ldap-get-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119393">
    <a href="/manual/vote-note.php?id=119393&amp;page=function.ldap-get-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119393" title="90% like this...">
    9
    </div>
  </div>
  <a href="#119393" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#119393"> &para;</a><div class="date" title="2016-05-27 01:03"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119393">
<div class="phpcode"><code><span class="html">Following on from Jeremy S's example. <br />Instead of defining LDAP_OPT_DIAGNOSTIC_MESSAGE as 0x32 then using it, you can just use the option already defined as that value :)<br /><br />LDAP_OPT_ERROR_STRING</span></code></div>
  </div>
 </div>
  <div class="note" id="112593">  <div class="votes">
    <div id="Vu112593">
    <a href="/manual/vote-note.php?id=112593&amp;page=function.ldap-get-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112593">
    <a href="/manual/vote-note.php?id=112593&amp;page=function.ldap-get-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112593" title="71% like this...">
    6
    </div>
  </div>
  <a href="#112593" class="name">
  <strong class="user"><em>Jeremy S</em></strong></a><a class="genanchor" href="#112593"> &para;</a><div class="date" title="2013-07-02 11:37"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112593">
<div class="phpcode"><code><span class="html">Here is how to tell if an Active Directory user account expired:<br /><br />define('LDAP_OPT_DIAGNOSTIC_MESSAGE', 0x0032);<br /><br />ldap_set_option($conn, LDAP_OPT_PROTOCOL_VERSION, 3);<br />ldap_set_option($conn, LDAP_OPT_REFERRALS, 0);<br /><br />$bind = ldap_bind($conn, $user, $pass);<br /><br />ldap_get_option($conn, LDAP_OPT_DIAGNOSTIC_MESSAGE, $extended_error);<br /><br />if (!empty($extended_error))<br />{<br />    $errno = explode(',', $extended_error)[2];<br />    $errno = explode(' ', $errno)[2];<br />    $errno = intval($errno);<br /><br />    if ($errno == 532)<br />        $err = 'Unable to login: Password expired.';<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="124601">  <div class="votes">
    <div id="Vu124601">
    <a href="/manual/vote-note.php?id=124601&amp;page=function.ldap-get-option&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124601">
    <a href="/manual/vote-note.php?id=124601&amp;page=function.ldap-get-option&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124601" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124601" class="name">
  <strong class="user"><em>Maarten</em></strong></a><a class="genanchor" href="#124601"> &para;</a><div class="date" title="2020-01-11 09:24"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124601">
...
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-get-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-get-option.php">＋<small>add a note</small></a></div>
