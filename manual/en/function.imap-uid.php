...
<head>
  ...
  <title>PHP: imap_uid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-uid.php">
 <link rel="shorturl" href="https://www.php.net/imap-uid">
 <link rel="alternate" href="https://www.php.net/imap-uid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-timeout.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-undelete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-uid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-uid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-uid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-uid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-uid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-uid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-uid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-uid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-uid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-uid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-uid.php" hreflang="zh">
...
<meta name="Description" content="This function returns the UID for the given message sequence number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_uid - Manual" />
<meta name="twitter:description" content="This function returns the UID for the given message sequence number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_uid - Manual" />
<meta itemprop="description" content="This function returns the UID for the given message sequence number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="This function returns the UID for the given message sequence number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-undelete.php">
          imap_undelete &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-timeout.php">
          &laquo; imap_timeout        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-uid.php' selected="selected">English</option>
            <option value='de/function.imap-uid.php'>German</option>
            <option value='es/function.imap-uid.php'>Spanish</option>
            <option value='fr/function.imap-uid.php'>French</option>
            <option value='it/function.imap-uid.php'>Italian</option>
            <option value='ja/function.imap-uid.php'>Japanese</option>
            <option value='pt_BR/function.imap-uid.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-uid.php'>Russian</option>
            <option value='tr/function.imap-uid.php'>Turkish</option>
            <option value='uk/function.imap-uid.php'>Ukrainian</option>
            <option value='zh/function.imap-uid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-uid" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-msgno.php" class="function" rel="rdfs-seeAlso">imap_msgno()</a> - Gets the message sequence number for the given UID</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-uid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-uid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-uid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-uid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117803">  <div class="votes">
    <div id="Vu117803">
    <a href="/manual/vote-note.php?id=117803&amp;page=function.imap-uid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117803">
    <a href="/manual/vote-note.php?id=117803&amp;page=function.imap-uid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117803" title="72% like this...">
    8
    </div>
  </div>
  <a href="#117803" class="name">
  <strong class="user"><em>Denis Rendler</em></strong></a><a class="genanchor" href="#117803"> &para;</a><div class="date" title="2015-08-12 09:42"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117803">
<div class="phpcode"><code><span class="html">I would like to point out that, at least in the case of Gmail, the UIDs of emails are changed if they are moved from one folder to another. Even if moved back to the same folder the UIDs get incremented and thus changed. <br />I found this the hard way after relaying on the notion that UIDs do not change as I found almost everywhere in the docs.</span></code></div>
  </div>
 </div>
  <div class="note" id="24923">  <div class="votes">
    <div id="Vu24923">
    <a href="/manual/vote-note.php?id=24923&amp;page=function.imap-uid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd24923">
    <a href="/manual/vote-note.php?id=24923&amp;page=function.imap-uid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V24923" title="61% like this...">
    5
    </div>
  </div>
  <a href="#24923" class="name">
  <strong class="user"><em>steve_foley at excite dot com</em></strong></a><a class="genanchor" href="#24923"> &para;</a><div class="date" title="2002-09-04 10:27"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom24923">
<div class="phpcode"><code><span class="html">Please note that message_id in the header is NOT the UID - and its dangerous to use as many mail progs don't put a message id in</span></code></div>
  </div>
 </div>
  <div class="note" id="98904">  <div class="votes">
    <div id="Vu98904">
    <a href="/manual/vote-note.php?id=98904&amp;page=function.imap-uid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98904">
    <a href="/manual/vote-note.php?id=98904&amp;page=function.imap-uid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98904" title="57% like this...">
    4
    </div>
  </div>
  <a href="#98904" class="name">
  <strong class="user"><em>Maikel</em></strong></a><a class="genanchor" href="#98904"> &para;</a><div class="date" title="2010-07-14 05:27"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98904">
<div class="phpcode"><code><span class="html">Be aware that the uid is unique in a single mailbox. That means a message can have as much uids as mailboxes</span></code></div>
  </div>
 </div>
  <div class="note" id="84670">  <div class="votes">
    <div id="Vu84670">
    <a href="/manual/vote-note.php?id=84670&amp;page=function.imap-uid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd84670">
    <a href="/manual/vote-note.php?id=84670&amp;page=function.imap-uid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V84670" title="60% like this...">
    2
    </div>
  </div>
  <a href="#84670" class="name">
  <strong class="user"><em>Andreas Seeger</em></strong></a><a class="genanchor" href="#84670"> &para;</a><div class="date" title="2008-07-24 10:26"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom84670">
<div class="phpcode"><code><span class="html">The uid will change in case of unsing imap_expunge. Be shure that <br />all work ist done before using imap_expunge.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-uid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-uid.php">＋<small>add a note</small></a></div>
