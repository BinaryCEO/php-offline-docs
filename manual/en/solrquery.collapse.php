...
<head>
  ...
  <title>PHP: SolrQuery::collapse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.collapse.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.collapse.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.collapse.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addstatsfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.collapse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.collapse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.collapse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.collapse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.collapse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.collapse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.collapse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.collapse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.collapse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.collapse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.collapse.php" hreflang="zh">
...
<meta name="Description" content="Collapses the result set to a single document per group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::collapse - Manual" />
<meta name="twitter:description" content="Collapses the result set to a single document per group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::collapse - Manual" />
<meta itemprop="description" content="Collapses the result set to a single document per group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Collapses the result set to a single document per group" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.construct.php">
          SolrQuery::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addstatsfield.php">
          &laquo; SolrQuery::addStatsField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.collapse.php' selected="selected">English</option>
            <option value='de/solrquery.collapse.php'>German</option>
            <option value='es/solrquery.collapse.php'>Spanish</option>
            <option value='fr/solrquery.collapse.php'>French</option>
            <option value='it/solrquery.collapse.php'>Italian</option>
            <option value='ja/solrquery.collapse.php'>Japanese</option>
            <option value='pt_BR/solrquery.collapse.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.collapse.php'>Russian</option>
            <option value='tr/solrquery.collapse.php'>Turkish</option>
            <option value='uk/solrquery.collapse.php'>Ukrainian</option>
            <option value='zh/solrquery.collapse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.collapse" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::collapse</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">SolrQuery::collapse</span> &mdash; <span class="dc-title">Collapses the result set to a single document per group</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.collapse-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::collapse</strong></span>(<span class="methodparam"><span class="type"><a href="class.solrcollapsefunction.php" class="type SolrCollapseFunction">SolrCollapseFunction</a></span> <code class="parameter">$collapseFunction</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.collapse-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">collapseFunction</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.collapse-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the current <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span> object
  </p>
 </div>

<div class="refsect1 examples" id="refsect1-solrquery.collapse-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-4953">
   <p><strong>Example #1 <span class="methodname"><strong>SolrQuery::collapse()</strong></span> example</strong></p>
...
(
    ...
    [response] =&gt; SolrObject Object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/collapse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.collapse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.collapse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.collapse.php">＋<small>add a note</small></a></span>
