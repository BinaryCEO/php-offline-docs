...
<head>
  ...
  <title>PHP: ReflectionClass::getStaticProperties - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getstaticproperties.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getstaticproperties.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getstaticproperties.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getstartline.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getstaticproperties.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getstaticproperties.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getstaticproperties.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getstaticproperties.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getstaticproperties.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getstaticproperties.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getstaticproperties.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getstaticproperties.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getstaticproperties.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getstaticproperties.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getstaticproperties.php" hreflang="zh">
...
<meta name="Description" content="Gets static properties" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getStaticProperties - Manual" />
<meta name="twitter:description" content="Gets static properties" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getStaticProperties - Manual" />
<meta itemprop="description" content="Gets static properties" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets static properties" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.getstaticpropertyvalue.php">
          ReflectionClass::getStaticPropertyValue &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getstartline.php">
          &laquo; ReflectionClass::getStartLine        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getstaticproperties.php' selected="selected">English</option>
            <option value='de/reflectionclass.getstaticproperties.php'>German</option>
            <option value='es/reflectionclass.getstaticproperties.php'>Spanish</option>
            <option value='fr/reflectionclass.getstaticproperties.php'>French</option>
            <option value='it/reflectionclass.getstaticproperties.php'>Italian</option>
            <option value='ja/reflectionclass.getstaticproperties.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getstaticproperties.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getstaticproperties.php'>Russian</option>
            <option value='tr/reflectionclass.getstaticproperties.php'>Turkish</option>
            <option value='uk/reflectionclass.getstaticproperties.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getstaticproperties.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getstaticproperties" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.setstaticpropertyvalue.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::setStaticPropertyValue()</a> - Sets public static property value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getstaticproperties.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getstaticproperties%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getstaticproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getstaticproperties.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97791">  <div class="votes">
    <div id="Vu97791">
    <a href="/manual/vote-note.php?id=97791&amp;page=reflectionclass.getstaticproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97791">
    <a href="/manual/vote-note.php?id=97791&amp;page=reflectionclass.getstaticproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97791" title="66% like this...">
    2
    </div>
  </div>
  <a href="#97791" class="name">
  <strong class="user"><em>jlennox @ google mail</em></strong></a><a class="genanchor" href="#97791"> &para;</a><div class="date" title="2010-05-08 10:03"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97791">
<div class="phpcode"><code><span class="html">I had the need to recursive merge the results from a subclass with all of it's parents, and this was the resulting code:
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">GetStaticPropertiesRecursive</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">) {
<br />    </span><span class="default">$currentClass </span><span class="keyword">= </span><span class="default">$class</span><span class="keyword">;
<br />    </span><span class="default">$joinedProperties </span><span class="keyword">= array();
<br />    do {
...
<br />        </span><span class="default">$staticProperties </span><span class="keyword">= </span><span class="default">$reflection</span><span class="keyword">-&gt;</span><span class="default">getStaticProperties</span><span class="keyword">();
<br />        foreach (</span><span class="default">$staticProperties </span><span class="keyword">as </span><span class="default">$name </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">) {
<br />            if (</span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)) {
<br />                if (isset(</span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">]))
<br />                    </span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">, </span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">]);
<br />                else
<br />                    </span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = </span><span class="default">$value</span><span class="keyword">;
<br />            } else {
<br />                if (isset(</span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">]))
<br />                    </span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">][] = </span><span class="default">$value</span><span class="keyword">;
<br />                else
<br />                    </span><span class="default">$joinedProperties</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = array(</span><span class="default">$value</span><span class="keyword">);
<br />            }
<br />        }
...
<br />    return </span><span class="default">$joinedProperties</span><span class="keyword">;
<br />}
<br />
<br /></span><span class="default">Using this </span><span class="keyword">function:
<br />class </span><span class="default">base </span><span class="keyword">{
<br />    public static </span><span class="default">$Test </span><span class="keyword">= array(</span><span class="string">"foo1"</span><span class="keyword">, </span><span class="string">"foo2"</span><span class="keyword">);
<br />}
<br />class </span><span class="default">sub </span><span class="keyword">extends </span><span class="default">base </span><span class="keyword">{
<br />    public static </span><span class="default">$Test </span><span class="keyword">= </span><span class="string">"sub"</span><span class="keyword">;
<br />}
<br />
<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">GetStaticPropertiesRecursive</span><span class="keyword">(</span><span class="string">"sub"</span><span class="keyword">));
...
<br />)
<br />
<br />The merge follows the rules of array_merge on duplicate keys.</span></code></div>
  </div>
 </div>
  <div class="note" id="119051">  <div class="votes">
    <div id="Vu119051">
    <a href="/manual/vote-note.php?id=119051&amp;page=reflectionclass.getstaticproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119051">
    <a href="/manual/vote-note.php?id=119051&amp;page=reflectionclass.getstaticproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119051" title="66% like this...">
    1
    </div>
  </div>
  <a href="#119051" class="name">
  <strong class="user"><em>joao dot felipe dot c dot b at gmail dot com</em></strong></a><a class="genanchor" href="#119051"> &para;</a><div class="date" title="2016-03-24 01:06"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119051">
<div class="phpcode"><code><span class="html">getStaticProperties return a set of the property itself. It's diferente from getProperties(ReflectionProperty::IS_STATIC) because it return a set of ReflectionProperty class.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getstaticproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getstaticproperties.php">＋<small>add a note</small></a></div>
