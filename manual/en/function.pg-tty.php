...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-tty.php">
 <link rel="shorturl" href="https://www.php.net/pg-tty">
 <link rel="alternate" href="https://www.php.net/pg-tty" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-transaction-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-unescape-bytea.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-tty.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-tty.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-tty.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-tty.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-tty.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-tty.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-tty.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-tty.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-tty.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-tty.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-tty.php" hreflang="zh">
...
<meta name="Description" content="Return the TTY name associated with the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_tty - Manual" />
<meta name="twitter:description" content="Return the TTY name associated with the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_tty - Manual" />
<meta itemprop="description" content="Return the TTY name associated with the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the TTY name associated with the connection" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-unescape-bytea.php">
          pg_unescape_bytea &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-transaction-status.php">
          &laquo; pg_transaction_status        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-tty.php' selected="selected">English</option>
            <option value='de/function.pg-tty.php'>German</option>
            <option value='es/function.pg-tty.php'>Spanish</option>
            <option value='fr/function.pg-tty.php'>French</option>
            <option value='it/function.pg-tty.php'>Italian</option>
            <option value='ja/function.pg-tty.php'>Japanese</option>
            <option value='pt_BR/function.pg-tty.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-tty.php'>Russian</option>
            <option value='tr/function.pg-tty.php'>Turkish</option>
            <option value='uk/function.pg-tty.php'>Ukrainian</option>
            <option value='zh/function.pg-tty.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-tty" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_tty</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_tty</span> &mdash; <span class="dc-title">
   Return the TTY name associated with the connection
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-tty-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_tty</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_tty()</strong></span> returns the TTY name that server
   side debugging output is sent to on the given PostgreSQL
   <code class="parameter">connection</code> instance.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    <span class="function"><strong>pg_tty()</strong></span> is obsolete, since the server no longer pays
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-tty-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-tty-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the debug TTY of the <code class="parameter">connection</code>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-tty-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-tty-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2122">
    <p><strong>Example #1 <span class="function"><strong>pg_tty()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pgsql_conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=mark host=localhost"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) {<br />   print </span><span style="color: #DD0000">"Server debug TTY is: " </span><span style="color: #007700">. </span><span style="color: #0000BB">pg_tty</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br/&gt;\n"</span><span style="color: #007700">;<br />} else {<br />   print </span><span style="color: #0000BB">pg_last_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   exit;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-tty.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-tty%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-tty&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-tty.php">＋<small>add a note</small></a></span>
