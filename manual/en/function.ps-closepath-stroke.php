...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-closepath-stroke.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-closepath.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-continue-text.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-closepath-stroke.php' selected="selected">English</option>
            ...
            <option value='zh/function.ps-closepath-stroke.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-closepath.php" class="function" rel="rdfs-seeAlso">ps_closepath()</a> - Closes path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-closepath-stroke.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-closepath-stroke%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-closepath-stroke&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-closepath-stroke.php">＋<small>add a note</small></a></span>
