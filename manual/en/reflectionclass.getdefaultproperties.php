...
<head>
  ...
  <title>PHP: ReflectionClass::getDefaultProperties - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getconstructor.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getdoccomment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getdefaultproperties.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getdefaultproperties.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getdefaultproperties.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getdefaultproperties.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getdefaultproperties.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getdefaultproperties.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getdefaultproperties.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getdefaultproperties.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getdefaultproperties.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getdefaultproperties.php" hreflang="zh">
...
<meta name="Description" content="Gets default properties" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getDefaultProperties - Manual" />
<meta name="twitter:description" content="Gets default properties" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getDefaultProperties - Manual" />
<meta itemprop="description" content="Gets default properties" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets default properties" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.getdoccomment.php">
          ReflectionClass::getDocComment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getconstructor.php">
          &laquo; ReflectionClass::getConstructor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getdefaultproperties.php' selected="selected">English</option>
            <option value='de/reflectionclass.getdefaultproperties.php'>German</option>
            <option value='es/reflectionclass.getdefaultproperties.php'>Spanish</option>
            <option value='fr/reflectionclass.getdefaultproperties.php'>French</option>
            <option value='it/reflectionclass.getdefaultproperties.php'>Italian</option>
            <option value='ja/reflectionclass.getdefaultproperties.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getdefaultproperties.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getdefaultproperties.php'>Russian</option>
            <option value='tr/reflectionclass.getdefaultproperties.php'>Turkish</option>
            <option value='uk/reflectionclass.getdefaultproperties.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getdefaultproperties.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getdefaultproperties" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getdefaultproperties-examples">
  ...
  <p class="para">
   <div class="example" id="example-5474">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::getDefaultProperties()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.getproperty.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getProperty()</a> - Gets a ReflectionProperty for a class's property</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getdefaultproperties.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getdefaultproperties%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getdefaultproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119013">  <div class="votes">
    <div id="Vu119013">
    <a href="/manual/vote-note.php?id=119013&amp;page=reflectionclass.getdefaultproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119013">
    <a href="/manual/vote-note.php?id=119013&amp;page=reflectionclass.getdefaultproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119013" title="83% like this...">
    4
    </div>
  </div>
  <a href="#119013" class="name">
  <strong class="user"><em>articice at ua dot fm</em></strong></a><a class="genanchor" href="#119013"> &para;</a><div class="date" title="2016-03-17 12:15"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119013">
<div class="phpcode"><code><span class="html">runaurufu is not quite right, get_class_vars() does not return protected params, while this one does.<br /><br />Thus it's extremely useful when having an abstract parent class and protected properties overriding in children.<br />For example, I use a class factory and one of the children has some static test methods that still need to output a paramether name, like $this-&gt;name, etc. With this example code, one can use static::getNotStaticProperty('name'), but not get_class_vars('name').<br /><br />Try it:<br /><br />trait static_reflector {<br />    /*<br />     * a purely static function that returns default properties of the non-static instance of the same class<br />     */<br />    static protected function getNonStaticProperty($key) {<br />        $me = get_class();<br />        $reflectionClass = new \ReflectionClass($me);<br />        $properties_list = $reflectionClass-&gt;getDefaultProperties();<br />        if (isset($properties_list[$key]))<br />            return $var_name = $properties_list[$key];<br />        else throw new RuntimeException("BUG: Unable to reflect non-static property '{$key}' from default properties of class {$me}");<br />    }<br />}<br /><br />class a {<br /><br />    use \static_reflector;<br /><br />    protected $key_a = 'test ok';<br /><br />    public static function test() {<br />        echo static::getNonStaticProperty('key_a')."\n";<br /><br />        try {<br />            print static::getNonStaticProperty('key_b');<br />            echo "FAIL No exception thrown";<br />        } catch (RuntimeException $e) {<br />            echo "OK ".$e-&gt;getMessage();<br />        }<br /><br />    }<br />}<br /><br />echo get_class_vars('a')['key_a']; <br />a::test();<br /><br />this will return:<br />Notice: Undefined index: key_a in ...<br />test ok<br />OK BUG: Unable to reflect non-static property 'key_b' from default properties of class a<br /><br />ps: Yes, this is copied from a unit test.</span></code></div>
  </div>
 </div>
  <div class="note" id="105234">  <div class="votes">
    <div id="Vu105234">
    <a href="/manual/vote-note.php?id=105234&amp;page=reflectionclass.getdefaultproperties&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105234">
    <a href="/manual/vote-note.php?id=105234&amp;page=reflectionclass.getdefaultproperties&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105234" title="60% like this...">
    2
    </div>
  </div>
  <a href="#105234" class="name">
  <strong class="user"><em>runaurufu AT gmail.com</em></strong></a><a class="genanchor" href="#105234"> &para;</a><div class="date" title="2011-08-04 01:02"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105234">
<div class="phpcode"><code><span class="html">Worth noting that it will not return private parameters of parent class...<br />so it works exactly as get_class_vars or get_object_vars</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getdefaultproperties&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getdefaultproperties.php">＋<small>add a note</small></a></div>
