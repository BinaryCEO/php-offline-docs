...
<head>
  ...
  <title>PHP: Imagick::setImageDepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagedepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagedepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagedelay.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagedispose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagedepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagedepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagedepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagedepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagedepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagedepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagedepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagedepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagedepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagedepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagedepth.php" hreflang="zh">
...
<meta name="Description" content="Sets the image depth" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageDepth - Manual" />
<meta name="twitter:description" content="Sets the image depth" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageDepth - Manual" />
<meta itemprop="description" content="Sets the image depth" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image depth" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagedispose.php">
          Imagick::setImageDispose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagedelay.php">
          &laquo; Imagick::setImageDelay        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagedepth.php' selected="selected">English</option>
            <option value='de/imagick.setimagedepth.php'>German</option>
            <option value='es/imagick.setimagedepth.php'>Spanish</option>
            <option value='fr/imagick.setimagedepth.php'>French</option>
            <option value='it/imagick.setimagedepth.php'>Italian</option>
            <option value='ja/imagick.setimagedepth.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagedepth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagedepth.php'>Russian</option>
            <option value='tr/imagick.setimagedepth.php'>Turkish</option>
            <option value='uk/imagick.setimagedepth.php'>Ukrainian</option>
            <option value='zh/imagick.setimagedepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagedepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageDepth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageDepth</span> &mdash; <span class="dc-title">Sets the image depth</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagedepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageDepth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$depth</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagedepth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagedepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagedepth-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagedepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagedepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagedepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagedepth.php">＋<small>add a note</small></a></span>
