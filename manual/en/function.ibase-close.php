...
<head>
  ...
  <title>PHP: ibase_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-close.php">
 <link rel="shorturl" href="https://www.php.net/ibase-close">
 <link rel="alternate" href="https://www.php.net/ibase-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-commit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-close.php" hreflang="zh">
...
<meta name="Description" content="Close a connection to an InterBase database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_close - Manual" />
<meta name="twitter:description" content="Close a connection to an InterBase database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_close - Manual" />
<meta itemprop="description" content="Close a connection to an InterBase database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close a connection to an InterBase database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-commit.php">
          ibase_commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-open.php">
          &laquo; ibase_blob_open        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-close.php' selected="selected">English</option>
            <option value='de/function.ibase-close.php'>German</option>
            <option value='es/function.ibase-close.php'>Spanish</option>
            <option value='fr/function.ibase-close.php'>French</option>
            <option value='it/function.ibase-close.php'>Italian</option>
            <option value='ja/function.ibase-close.php'>Japanese</option>
            <option value='pt_BR/function.ibase-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-close.php'>Russian</option>
            <option value='tr/function.ibase-close.php'>Turkish</option>
            <option value='uk/function.ibase-close.php'>Ukrainian</option>
            <option value='zh/function.ibase-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_close</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_close</span> &mdash; <span class="dc-title">Close a connection to an InterBase database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-close-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_close</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection_id</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Closes the link to an InterBase database that&#039;s associated with
   a connection id returned from <span class="function"><a href="function.ibase-connect.php" class="function">ibase_connect()</a></span>.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-close-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">connection_id</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-close-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-close-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-pconnect.php" class="function" rel="rdfs-seeAlso">ibase_pconnect()</a> - Open a persistent connection to an InterBase database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-close.php">＋<small>add a note</small></a></span>
