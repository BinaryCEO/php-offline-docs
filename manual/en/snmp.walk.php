...
<head>
  ...
  <title>PHP: SNMP::walk - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/snmp.walk.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/snmp.walk.php">
 <link rel="alternate" href="https://www.php.net/manual/en/snmp.walk.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/snmp.setsecurity.php">
 <link rel="next" href="https://www.php.net/manual/en/class.snmpexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/snmp.walk.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/snmp.walk.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/snmp.walk.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/snmp.walk.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/snmp.walk.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/snmp.walk.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/snmp.walk.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/snmp.walk.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/snmp.walk.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/snmp.walk.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/snmp.walk.php" hreflang="zh">
...
<meta name="Description" content="Fetch SNMP object subtree" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SNMP::walk - Manual" />
<meta name="twitter:description" content="Fetch SNMP object subtree" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SNMP::walk - Manual" />
<meta itemprop="description" content="Fetch SNMP object subtree" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch SNMP object subtree" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.snmpexception.php">
          SNMPException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="snmp.setsecurity.php">
          &laquo; SNMP::setSecurity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/snmp.walk.php' selected="selected">English</option>
            <option value='de/snmp.walk.php'>German</option>
            <option value='es/snmp.walk.php'>Spanish</option>
            <option value='fr/snmp.walk.php'>French</option>
            <option value='it/snmp.walk.php'>Italian</option>
            <option value='ja/snmp.walk.php'>Japanese</option>
            <option value='pt_BR/snmp.walk.php'>Brazilian Portuguese</option>
            <option value='ru/snmp.walk.php'>Russian</option>
            <option value='tr/snmp.walk.php'>Turkish</option>
            <option value='uk/snmp.walk.php'>Ukrainian</option>
            <option value='zh/snmp.walk.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="snmp.walk" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SNMP::walk</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SNMP::walk</span> &mdash; <span class="dc-title">Fetch <abbr title="Simple Network Management Protocol">SNMP</abbr> object subtree</span></p>
 ...
 <div class="refsect1 description" id="refsect1-snmp.walk-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SNMP::walk</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$objectId</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$suffixAsKey</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$maxRepetitions</code><span class="initializer"> = -1</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$nonRepeaters</code><span class="initializer"> = -1</span></span><br>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="methodname"><strong>SNMP::walk()</strong></span> is used to read <abbr title="Simple Network Management Protocol">SNMP</abbr> subtree rooted at specified <code class="parameter">objectId</code>.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-snmp.walk-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">suffixAsKey</code></dt>
    <dd>
     <p class="para">
      By default full OID notation is used for keys in output array.
      If set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> subtree prefix will be removed from keys leaving only suffix of object_id.
     </p>
    </dd>
   
   
    <dt><code class="parameter">nonRepeaters</code></dt>
    <dd>
     <p class="para">
      This specifies the number of supplied variables that should not be iterated over.
      The default is to use this value from <abbr title="Simple Network Management Protocol">SNMP</abbr> object.
     </p>
    </dd>
   
   
    <dt><code class="parameter">maxRepetitions</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-snmp.walk-returnvalues">
  ...
  <p class="para">
   ...
   When a <abbr title="Simple Network Management Protocol">SNMP</abbr> error occures <span class="methodname"><a href="snmp.geterrno.php" class="methodname">SNMP::getErrno()</a></span> and
   <span class="methodname"><a href="snmp.geterror.php" class="methodname">SNMP::getError()</a></span> can be used for retrieving error
...
(
  ...
  <div class="example" id="snmp.walk.example.suffix-as-key">
   <p><strong>Example #2 <code class="parameter">suffixAsKey</code> example</strong></p>
   <div class="example-contents"><p>
     <code class="parameter">suffixAsKey</code> may be used when merging multiple <abbr title="Simple Network Management Protocol">SNMP</abbr> subtrees into one.
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="snmp.geterror.php" class="methodname" rel="rdfs-seeAlso">SNMP::getError()</a> - Get last error message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/snmp/walk.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsnmp.walk%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=snmp.walk&amp;repo=en&amp;redirect=https://www.php.net/manual/en/snmp.walk.php">＋<small>add a note</small></a></span>
