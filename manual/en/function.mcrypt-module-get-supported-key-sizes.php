...
<head>
  ...
  <title>PHP: mcrypt_module_get_supported_key_sizes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-module-get-supported-key-sizes.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-module-get-supported-key-sizes">
 <link rel="alternate" href="https://www.php.net/mcrypt-module-get-supported-key-sizes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-module-get-algo-key-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-is-block-algorithm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-module-get-supported-key-sizes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-module-get-supported-key-sizes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-module-get-supported-key-sizes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-module-get-supported-key-sizes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-module-get-supported-key-sizes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-module-get-supported-key-sizes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-module-get-supported-key-sizes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-module-get-supported-key-sizes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-module-get-supported-key-sizes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-module-get-supported-key-sizes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-module-get-supported-key-sizes.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mcrypt_module_get_supported_key_sizes - Manual" />
...
<meta itemprop="name" content="PHP: mcrypt_module_get_supported_key_sizes - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-module-is-block-algorithm.php">
          mcrypt_module_is_block_algorithm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-module-get-algo-key-size.php">
          &laquo; mcrypt_module_get_algo_key_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-module-get-supported-key-sizes.php' selected="selected">English</option>
            <option value='de/function.mcrypt-module-get-supported-key-sizes.php'>German</option>
            <option value='es/function.mcrypt-module-get-supported-key-sizes.php'>Spanish</option>
            <option value='fr/function.mcrypt-module-get-supported-key-sizes.php'>French</option>
            <option value='it/function.mcrypt-module-get-supported-key-sizes.php'>Italian</option>
            <option value='ja/function.mcrypt-module-get-supported-key-sizes.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-module-get-supported-key-sizes.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-module-get-supported-key-sizes.php'>Russian</option>
            <option value='tr/function.mcrypt-module-get-supported-key-sizes.php'>Turkish</option>
            <option value='uk/function.mcrypt-module-get-supported-key-sizes.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-module-get-supported-key-sizes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-module-get-supported-key-sizes" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mcrypt-enc-get-supported-key-sizes.php" class="function" rel="rdfs-seeAlso">mcrypt_enc_get_supported_key_sizes()</a> - Returns an array with the supported keysizes of the opened algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-module-get-supported-key-sizes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-module-get-supported-key-sizes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-module-get-supported-key-sizes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-module-get-supported-key-sizes.php">＋<small>add a note</small></a></span>
