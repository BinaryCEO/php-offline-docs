...
<head>
  ...
  <title>PHP: SolrQuery::getFacetSort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetsort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetsort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetsort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetqueries.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetsort.php" hreflang="zh">
...
<meta name="Description" content="Returns the facet sort type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetSort - Manual" />
<meta name="twitter:description" content="Returns the facet sort type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetSort - Manual" />
<meta itemprop="description" content="Returns the facet sort type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the facet sort type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfields.php">
          SolrQuery::getFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetqueries.php">
          &laquo; SolrQuery::getFacetQueries        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetsort.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetsort.php'>German</option>
            <option value='es/solrquery.getfacetsort.php'>Spanish</option>
            <option value='fr/solrquery.getfacetsort.php'>French</option>
            <option value='it/solrquery.getfacetsort.php'>Italian</option>
            <option value='ja/solrquery.getfacetsort.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetsort.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetsort.php'>Russian</option>
            <option value='tr/solrquery.getfacetsort.php'>Turkish</option>
            <option value='uk/solrquery.getfacetsort.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetSort</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetSort</span> &mdash; <span class="dc-title">Returns the facet sort type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetsort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetSort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetsort-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetsort-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an integer (SolrQuery::FACET_SORT_INDEX or SolrQuery::FACET_SORT_COUNT) on success or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set. 
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetsort.php">＋<small>add a note</small></a></span>
