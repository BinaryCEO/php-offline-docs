...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefromwebp.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatefromwbmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatefromxbm.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefromwebp.php' selected="selected">English</option>
            ...
            <option value='fr/function.imagecreatefromwebp.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecreatefromwebp</span> &mdash; <span class="dc-title">Create a new image from file or URL</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imagecreatefromwebp-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>imagecreatefromwebp()</strong></span> returns an image identifier
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecreatefromwebp-examples">
  ...
  <p class="para">
   <div class="example" id="example-2873">
    <p><strong>Example #1 Convert an WebP image to a jpeg image using <span class="function"><strong>imagecreatefromwebp()</strong></span></strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Load the WebP file<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromwebp</span><span style="color: #007700">(</span><span style="color: #DD0000">'./example.webp'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Convert it to a jpeg file with 100% quality<br /></span><span style="color: #0000BB">imagejpeg</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'./example.jpeg'</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefromwebp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefromwebp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefromwebp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromwebp.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">PHP GD and WebP support:<br /><br />Normal WebP (VP8): supported since PHP 5.4<br />Transparent WebP or alpha transparency (VP8X, VP8L): supported since PHP 7.0<br />Animated WebP (VP8X): not supported at all.<br /><br />You can use the images from here <a href="https://developers.google.com/speed/webp/gallery2" rel="nofollow" target="_blank">https://developers.google.com/speed/webp/gallery2</a><br />here <a href="https://ezgif.com/help/alternative-animated-image-formats" rel="nofollow" target="_blank">https://ezgif.com/help/alternative-animated-image-formats</a><br />and here <a href="https://developers.google.com/speed/webp/gallery1" rel="nofollow" target="_blank">https://developers.google.com/speed/webp/gallery1</a><br /><br />Test with imagecreatefromwebp('your-image.webp'); and see the errors.<br /><br />You can detect animated or transparent webp using this code.<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/**<br /> * Get WebP file info.<br /> * <br /> * @link <a href="https://www.php.net/manual/en/function.pack.php" rel="nofollow" target="_blank">https://www.php.net/manual/en/function.pack.php</a> unpack format reference.<br /> * @link <a href="https://developers.google.com/speed/webp/docs/riff_container" rel="nofollow" target="_blank">https://developers.google.com/speed/webp/docs/riff_container</a> WebP document.<br /> * @param string $file<br /> * @return array|false Return associative array if success, return `false` for otherwise.<br /> */<br /></span><span class="keyword">function </span><span class="default">webpinfo</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">) {<br />    if (!</span><span class="default">is_file</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">)) {<br />        return </span><span class="default">false</span><span class="keyword">;<br />    } else {<br />        </span><span class="default">$file </span><span class="keyword">= </span><span class="default">realpath</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">);<br />    }<br /><br />    </span><span class="default">$fp </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="string">'rb'</span><span class="keyword">);<br />    if (!</span><span class="default">$fp</span><span class="keyword">) {<br />        return </span><span class="default">false</span><span class="keyword">;<br />    }<br /><br />    </span><span class="default">$data </span><span class="keyword">= </span><span class="default">fread</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">, </span><span class="default">90</span><span class="keyword">);<br /><br />    </span><span class="default">fclose</span><span class="keyword">(</span><span class="default">$fp</span><span class="keyword">);<br />    unset(</span><span class="default">$fp</span><span class="keyword">);<br /><br />    </span><span class="default">$header_format </span><span class="keyword">= </span><span class="string">'A4Riff/' </span><span class="keyword">. </span><span class="comment">// get n string<br />        </span><span class="string">'I1Filesize/' </span><span class="keyword">. </span><span class="comment">// get integer (file size but not actual size)<br />        </span><span class="string">'A4Webp/' </span><span class="keyword">. </span><span class="comment">// get n string<br />        </span><span class="string">'A4Vp/' </span><span class="keyword">. </span><span class="comment">// get n string<br />        </span><span class="string">'A74Chunk'</span><span class="keyword">;<br />    </span><span class="default">$header </span><span class="keyword">= </span><span class="default">unpack</span><span class="keyword">(</span><span class="default">$header_format</span><span class="keyword">, </span><span class="default">$data</span><span class="keyword">);<br />    unset(</span><span class="default">$data</span><span class="keyword">, </span><span class="default">$header_format</span><span class="keyword">);<br /><br />    if (!isset(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Riff'</span><span class="keyword">]) || </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Riff'</span><span class="keyword">]) !== </span><span class="string">'RIFF'</span><span class="keyword">) {<br />        return </span><span class="default">false</span><span class="keyword">;<br />    }<br />    if (!isset(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Webp'</span><span class="keyword">]) || </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Webp'</span><span class="keyword">]) !== </span><span class="string">'WEBP'</span><span class="keyword">) {<br />        return </span><span class="default">false</span><span class="keyword">;<br />    }<br />    if (!isset(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Vp'</span><span class="keyword">]) || </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Vp'</span><span class="keyword">]), </span><span class="string">'VP8'</span><span class="keyword">) === </span><span class="default">false</span><span class="keyword">) {<br />        return </span><span class="default">false</span><span class="keyword">;<br />    }<br /><br />    if (<br />        </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Chunk'</span><span class="keyword">]), </span><span class="string">'ANIM'</span><span class="keyword">) !== </span><span class="default">false </span><span class="keyword">|| <br />        </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Chunk'</span><span class="keyword">]), </span><span class="string">'ANMF'</span><span class="keyword">) !== </span><span class="default">false<br />    </span><span class="keyword">) {<br />        </span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Animation'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">;<br />    } else {<br />        </span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Animation'</span><span class="keyword">] = </span><span class="default">false</span><span class="keyword">;<br />    }<br /><br />    if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Chunk'</span><span class="keyword">]), </span><span class="string">'ALPH'</span><span class="keyword">) !== </span><span class="default">false</span><span class="keyword">) {<br />        </span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Alpha'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">;<br />    } else {<br />        if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Vp'</span><span class="keyword">]), </span><span class="string">'VP8L'</span><span class="keyword">) !== </span><span class="default">false</span><span class="keyword">) {<br />            </span><span class="comment">// if it is VP8L, I assume that this image will be transparency<br />            // as described in <a href="https://developers.google.com/speed/webp/docs/riff_container#simple_file_format_lossless" rel="nofollow" target="_blank">https://developers.google.com/speed/webp/docs/riff_container#simple_file_format_lossless</a><br />            </span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Alpha'</span><span class="keyword">] = </span><span class="default">true</span><span class="keyword">;<br />        } else {<br />            </span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Alpha'</span><span class="keyword">] = </span><span class="default">false</span><span class="keyword">;<br />        }<br />    }<br /><br />    unset(</span><span class="default">$header</span><span class="keyword">[</span><span class="string">'Chunk'</span><span class="keyword">]);<br />    return </span><span class="default">$header</span><span class="keyword">;<br />}</span><span class="comment">// webpinfo<br /></span><span class="default">?&gt;<br /></span><br />Reference: <a href="https://stackoverflow.com/a/68491679/128761" rel="nofollow" target="_blank">https://stackoverflow.com/a/68491679/128761</a><br /><br />Usage:<br /><br /><span class="default">&lt;?php<br />$info </span><span class="keyword">= </span><span class="default">webpinfo</span><span class="keyword">(</span><span class="string">'your-image.webp'</span><span class="keyword">);<br />if (isset(</span><span class="default">$info</span><span class="keyword">[</span><span class="string">'Animation'</span><span class="keyword">]) &amp;&amp; </span><span class="default">$info</span><span class="keyword">[</span><span class="string">'Animation'</span><span class="keyword">] === </span><span class="default">true</span><span class="keyword">) {<br />    echo </span><span class="string">'It is animated webp.'</span><span class="keyword">;<br />} <br />if (isset(</span><span class="default">$info</span><span class="keyword">[</span><span class="string">'Alpha'</span><span class="keyword">]) &amp;&amp; </span><span class="default">$info</span><span class="keyword">[</span><span class="string">'Alpha'</span><span class="keyword">] === </span><span class="default">true</span><span class="keyword">) {<br />    echo </span><span class="string">'It is transparent webp.'</span><span class="keyword">;<br />} <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecreatefromwebp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromwebp.php">＋<small>add a note</small></a></div>
