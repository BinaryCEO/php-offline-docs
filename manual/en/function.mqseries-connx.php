...
<head>
  ...
  <title>PHP: mqseries_connx - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mqseries-connx.php">
 <link rel="shorturl" href="https://www.php.net/mqseries-connx">
 <link rel="alternate" href="https://www.php.net/mqseries-connx" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mqseries.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mqseries-conn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mqseries-disc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mqseries-connx.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mqseries-connx.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mqseries-connx.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mqseries-connx.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mqseries-connx.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mqseries-connx.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mqseries-connx.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mqseries-connx.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mqseries-connx.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mqseries-connx.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mqseries-connx.php" hreflang="zh">
...
<meta name="Description" content="MQSeries MQCONNX" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mqseries_connx - Manual" />
<meta name="twitter:description" content="MQSeries MQCONNX" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mqseries_connx - Manual" />
<meta itemprop="description" content="MQSeries MQCONNX" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="MQSeries MQCONNX" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mqseries-connx.php' selected="selected">English</option>
            <option value='de/function.mqseries-connx.php'>German</option>
            <option value='es/function.mqseries-connx.php'>Spanish</option>
            <option value='fr/function.mqseries-connx.php'>French</option>
            <option value='it/function.mqseries-connx.php'>Italian</option>
            <option value='ja/function.mqseries-connx.php'>Japanese</option>
            <option value='pt_BR/function.mqseries-connx.php'>Brazilian Portuguese</option>
            <option value='ru/function.mqseries-connx.php'>Russian</option>
            <option value='tr/function.mqseries-connx.php'>Turkish</option>
            <option value='uk/function.mqseries-connx.php'>Ukrainian</option>
            <option value='zh/function.mqseries-connx.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mqseries-connx" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.mqseries-connx-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mqseries_connx</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$qManagerName</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$connOptions</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter reference">&$hconn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter reference">&$compCode</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter reference">&$reason</code></span><br>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.mqseries-conn.php" class="function">mqseries_conn()</a></span> (MQCONN) call, except that MQCONNX 
 ...
 <div class="refsect1 examples" id="refsect1-function.mqseries-connx-examples">
  ...
  <p class="para">
   <div class="example" id="example-4707">
    <p><strong>Example #1 
     <span class="function"><strong>mqseries_connx()</strong></span>
     example
    </strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    $mqcno </span><span style="color: #007700">= array(<br />        </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">MQSERIES_MQCNO_VERSION_2</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'Options' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">MQSERIES_MQCNO_STANDARD_BINDING</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'MQCD' </span><span style="color: #007700">=&gt; array(</span><span style="color: #DD0000">'ChannelName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'MQNX9420.CLIENT'</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'ConnectionName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'TransportType' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">MQSERIES_MQXPT_TCP</span><span style="color: #007700">)<br />    );<br /><br />    </span><span style="color: #0000BB">mqseries_connx</span><span style="color: #007700">(</span><span style="color: #DD0000">'MQNX9420'</span><span style="color: #007700">, </span><span style="color: #0000BB">$mqcno</span><span style="color: #007700">, </span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$comp_code</span><span style="color: #007700">,</span><span style="color: #0000BB">$reason</span><span style="color: #007700">);<br />    if (</span><span style="color: #0000BB">$comp_code </span><span style="color: #007700">!== </span><span style="color: #0000BB">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connx CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$comp_code</span><span style="color: #007700">, </span><span style="color: #0000BB">$reason</span><span style="color: #007700">, </span><span style="color: #0000BB">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #0000BB">$reason</span><span style="color: #007700">));<br />        exit;<br />    }<br /> <br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example" id="example-4708">
    <p><strong>Example #2 
     <span class="function"><strong>mqseries_connx()</strong></span>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mqseries-disc.php" class="function" rel="rdfs-seeAlso">mqseries_disc()</a> - MQSeries MQDISC</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mqseries/functions/mqseries-connx.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mqseries-connx%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mqseries-connx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mqseries-connx.php">＋<small>add a note</small></a></span>
