...
<head>
  ...
  <title>PHP: Dom\XPath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-xpath.php">
 <link rel="shorturl" href="https://www.php.net/dom-xpath">
 <link rel="alternate" href="https://www.php.net/dom-xpath" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-xmldocument.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.dom.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-xpath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-xpath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-xpath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-xpath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-xpath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-xpath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-xpath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-xpath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-xpath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-xpath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-xpath.php" hreflang="zh">
...
<meta name="Description" content="The Dom\XPath class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\XPath - Manual" />
<meta name="twitter:description" content="The Dom\XPath class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\XPath - Manual" />
<meta itemprop="description" content="The Dom\XPath class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\XPath class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-xpath.php' selected="selected">English</option>
            <option value='de/class.dom-xpath.php'>German</option>
            <option value='es/class.dom-xpath.php'>Spanish</option>
            <option value='fr/class.dom-xpath.php'>French</option>
            <option value='it/class.dom-xpath.php'>Italian</option>
            <option value='ja/class.dom-xpath.php'>Japanese</option>
            <option value='pt_BR/class.dom-xpath.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-xpath.php'>Russian</option>
            <option value='tr/class.dom-xpath.php'>Turkish</option>
            <option value='uk/class.dom-xpath.php'>Ukrainian</option>
            <option value='zh/class.dom-xpath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-xpath" class="reference">
 <h1 class="title">The Dom\XPath class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-xpath.intro">
  ...
  <div class="section" id="dom-xpath.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">final</span>
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\XPath</strong></strong>
     {</div>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="class.dom-document.php" class="type Dom\Document">Dom\Document</a></span>
      <var class="varname"><a href="class.dom-xpath.php#dom-xpath.props.document">$<var class="varname">document</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>
      <var class="varname"><a href="class.dom-xpath.php#dom-xpath.props.registernodenamespaces">$<var class="varname">registerNodeNamespaces</var></a></var>;</div>
  ...
  <div class="section" id="dom-xpath.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-xpath.props.document"><var class="varname">document</var></dt><dd>
      <span class="simpara">The document that is linked to this object.</span>
     </dd>
    
    
     <dt id="dom-xpath.props.registernodenamespaces"><var class="varname">registerNodeNamespaces</var></dt><dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-xpath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-xpath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-xpath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-xpath.php">＋<small>add a note</small></a></span>
