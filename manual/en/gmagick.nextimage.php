...
<head>
  ...
  <title>PHP: Gmagick::nextimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.nextimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.nextimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.nextimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.newimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.normalizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.nextimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.nextimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.nextimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.nextimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.nextimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.nextimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.nextimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.nextimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.nextimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.nextimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.nextimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::nextimage - Manual" />
<meta name="twitter:description" content="Moves to the next image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::nextimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.normalizeimage.php">
          Gmagick::normalizeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.newimage.php">
          &laquo; Gmagick::newimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.nextimage.php' selected="selected">English</option>
            <option value='de/gmagick.nextimage.php'>German</option>
            <option value='es/gmagick.nextimage.php'>Spanish</option>
            <option value='fr/gmagick.nextimage.php'>French</option>
            <option value='it/gmagick.nextimage.php'>Italian</option>
            <option value='ja/gmagick.nextimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.nextimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.nextimage.php'>Russian</option>
            <option value='tr/gmagick.nextimage.php'>Turkish</option>
            <option value='uk/gmagick.nextimage.php'>Ukrainian</option>
            <option value='zh/gmagick.nextimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.nextimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::nextimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::nextimage</span> &mdash; <span class="dc-title">Moves to the next image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.nextimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::nextimage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Associates the next image in the image list with an <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object. 
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.nextimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.nextimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.nextimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/nextimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.nextimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.nextimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.nextimage.php">＋<small>add a note</small></a></span>
