...
<head>
  ...
  <title>PHP: eio_nreqs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-nreqs.php">
 <link rel="shorturl" href="https://www.php.net/eio-nreqs">
 <link rel="alternate" href="https://www.php.net/eio-nreqs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-nready.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-nthreads.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-nreqs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-nreqs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-nreqs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-nreqs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-nreqs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-nreqs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-nreqs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-nreqs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-nreqs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-nreqs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-nreqs.php" hreflang="zh">
...
<meta name="Description" content="Returns number of requests to be processed" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_nreqs - Manual" />
<meta name="twitter:description" content="Returns number of requests to be processed" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_nreqs - Manual" />
<meta itemprop="description" content="Returns number of requests to be processed" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns number of requests to be processed" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-nthreads.php">
          eio_nthreads &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-nready.php">
          &laquo; eio_nready        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-nreqs.php' selected="selected">English</option>
            <option value='de/function.eio-nreqs.php'>German</option>
            <option value='es/function.eio-nreqs.php'>Spanish</option>
            <option value='fr/function.eio-nreqs.php'>French</option>
            <option value='it/function.eio-nreqs.php'>Italian</option>
            <option value='ja/function.eio-nreqs.php'>Japanese</option>
            <option value='pt_BR/function.eio-nreqs.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-nreqs.php'>Russian</option>
            <option value='tr/function.eio-nreqs.php'>Turkish</option>
            <option value='uk/function.eio-nreqs.php'>Ukrainian</option>
            <option value='zh/function.eio-nreqs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-nreqs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_nreqs</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_nreqs</span> &mdash; <span class="dc-title">Returns number of requests to be processed</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-nreqs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_nreqs</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>eio_nreqs()</strong></span> could be called in a custom loop calling
   <span class="function"><a href="function.eio-poll.php" class="function">eio_poll()</a></span>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-nreqs-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.eio-nreqs-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_nreqs()</strong></span> returns number of requests to be processed.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.eio-nreqs-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-3518">
   <p><strong>Example #1 <span class="function"><strong>eio_nreqs()</strong></span> example</strong></p>
...
int(0)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-nreqs-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-poll.php" class="function" rel="rdfs-seeAlso">eio_poll()</a> - Can be to be called whenever there are pending requests that need finishing</span></li>
   <li><span class="function"><a href="function.eio-nready.php" class="function" rel="rdfs-seeAlso">eio_nready()</a> - Returns number of not-yet handled requests</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-nreqs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-nreqs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-nreqs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-nreqs.php">＋<small>add a note</small></a></span>
