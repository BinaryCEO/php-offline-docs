...
<head>
  ...
  <title>PHP: UnhandledMatchError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.unhandledmatcherror.php">
 <link rel="shorturl" href="https://www.php.net/unhandledmatcherror">
 <link rel="alternate" href="https://www.php.net/unhandledmatcherror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.valueerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.fibererror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.unhandledmatcherror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.unhandledmatcherror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.unhandledmatcherror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.unhandledmatcherror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.unhandledmatcherror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.unhandledmatcherror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.unhandledmatcherror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.unhandledmatcherror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.unhandledmatcherror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.unhandledmatcherror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.unhandledmatcherror.php" hreflang="zh">
...
<meta name="Description" content="UnhandledMatchError" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UnhandledMatchError - Manual" />
<meta name="twitter:description" content="UnhandledMatchError" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UnhandledMatchError - Manual" />
<meta itemprop="description" content="UnhandledMatchError" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="UnhandledMatchError" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.fibererror.php">
          FiberError &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.valueerror.php">
          &laquo; ValueError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.unhandledmatcherror.php' selected="selected">English</option>
            <option value='de/class.unhandledmatcherror.php'>German</option>
            <option value='es/class.unhandledmatcherror.php'>Spanish</option>
            <option value='fr/class.unhandledmatcherror.php'>French</option>
            <option value='it/class.unhandledmatcherror.php'>Italian</option>
            <option value='ja/class.unhandledmatcherror.php'>Japanese</option>
            <option value='pt_BR/class.unhandledmatcherror.php'>Brazilian Portuguese</option>
            <option value='ru/class.unhandledmatcherror.php'>Russian</option>
            <option value='tr/class.unhandledmatcherror.php'>Turkish</option>
            <option value='uk/class.unhandledmatcherror.php'>Ukrainian</option>
            <option value='zh/class.unhandledmatcherror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.unhandledmatcherror" class="reference">
 <h1 class="title">UnhandledMatchError</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8)</p>


  <div class="section" id="unhandledmatcherror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    An <span class="ooclass"><span class="classname"><strong class="classname">UnhandledMatchError</strong></span></span> is thrown
    when the subject passed to a <a href="control-structures.match.php" class="link">match</a> expression is not handled by any arm
    of the <a href="control-structures.match.php" class="link">match</a> expression.
  </p>
  </div>


  <div class="section" id="unhandledmatcherror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">UnhandledMatchError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/unhandledmatcherror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.unhandledmatcherror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.unhandledmatcherror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.unhandledmatcherror.php">＋<small>add a note</small></a></span>
