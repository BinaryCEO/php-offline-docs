...
<head>
  ...
  <title>PHP: ReflectionFunctionAbstract::__toString - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.tostring.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.tostring.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.tostring.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.returnsreference.php">
 <link rel="next" href="https://www.php.net/manual/en/class.reflectionmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.tostring.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionfunctionabstract.tostring.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionfunctionabstract.tostring.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionfunctionabstract.tostring.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionfunctionabstract.tostring.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionfunctionabstract.tostring.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionfunctionabstract.tostring.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionfunctionabstract.tostring.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionfunctionabstract.tostring.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionfunctionabstract.tostring.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionfunctionabstract.tostring.php" hreflang="zh">
...
<meta name="Description" content="Returns the string representation of the ReflectionFunctionAbstract object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::__toString - Manual" />
<meta name="twitter:description" content="Returns the string representation of the ReflectionFunctionAbstract object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::__toString - Manual" />
<meta itemprop="description" content="Returns the string representation of the ReflectionFunctionAbstract object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the string representation of the ReflectionFunctionAbstract object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.reflectionmethod.php">
          ReflectionMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionfunctionabstract.returnsreference.php">
          &laquo; ReflectionFunctionAbstract::returnsReference        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.tostring.php' selected="selected">English</option>
            <option value='de/reflectionfunctionabstract.tostring.php'>German</option>
            <option value='es/reflectionfunctionabstract.tostring.php'>Spanish</option>
            <option value='fr/reflectionfunctionabstract.tostring.php'>French</option>
            <option value='it/reflectionfunctionabstract.tostring.php'>Italian</option>
            <option value='ja/reflectionfunctionabstract.tostring.php'>Japanese</option>
            <option value='pt_BR/reflectionfunctionabstract.tostring.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionfunctionabstract.tostring.php'>Russian</option>
            <option value='tr/reflectionfunctionabstract.tostring.php'>Turkish</option>
            <option value='uk/reflectionfunctionabstract.tostring.php'>Ukrainian</option>
            <option value='zh/reflectionfunctionabstract.tostring.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionfunctionabstract.tostring" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.magic.php#object.tostring" class="link">__toString()</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/tostring.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.tostring%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.tostring&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.tostring.php">＋<small>add a note</small></a></span>
