...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-uintersect.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.array-udiff-uassoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-uintersect-assoc.php">
...
<meta name="Description" content="Computes the intersection of arrays, compares data by a callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_uintersect - Manual" />
<meta name="twitter:description" content="Computes the intersection of arrays, compares data by a callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_uintersect - Manual" />
<meta itemprop="description" content="Computes the intersection of arrays, compares data by a callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the intersection of arrays, compares data by a callback function" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-uintersect.php' selected="selected">English</option>
            <option value='de/function.array-uintersect.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">array_uintersect</span> &mdash; <span class="dc-title">Computes the intersection of arrays, compares data by a callback function</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.array-uintersect-examples">
  ...
  <p class="para">
   <div class="example" id="example-5283">
    <p><strong>Example #1 <span class="function"><strong>array_uintersect()</strong></span> example</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-uintersect-uassoc.php" class="function" rel="rdfs-seeAlso">array_uintersect_uassoc()</a> - Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-uintersect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-uintersect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-uintersect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-uintersect.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">I want to stress that in the user function, you do need to return either a 1 or a -1 properly; you cannot simply return 0 if the results are equal and 1 if they are not.  <br /><br />The following code is incorrect:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myfunction</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">,</span><span class="default">$v2</span><span class="keyword">) <br />{<br />if (</span><span class="default">$v1</span><span class="keyword">===</span><span class="default">$v2</span><span class="keyword">)<br />    {<br />    return </span><span class="default">0</span><span class="keyword">;<br />    }<br />return </span><span class="default">1</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$a1</span><span class="keyword">=array(</span><span class="default">1</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">$a2</span><span class="keyword">=array(</span><span class="default">1</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">array_uintersect</span><span class="keyword">(</span><span class="default">$a1</span><span class="keyword">,</span><span class="default">$a2</span><span class="keyword">,</span><span class="string">"myfunction"</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />This code is correct:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myfunction</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">,</span><span class="default">$v2</span><span class="keyword">) <br />{<br />if (</span><span class="default">$v1</span><span class="keyword">===</span><span class="default">$v2</span><span class="keyword">)<br />    {<br />    return </span><span class="default">0</span><span class="keyword">;<br />    }<br />if (</span><span class="default">$v1 </span><span class="keyword">&gt; </span><span class="default">$v2</span><span class="keyword">) return </span><span class="default">1</span><span class="keyword">;<br />return -</span><span class="default">1</span><span class="keyword">;<br />}<br /></span><span class="default">$a1</span><span class="keyword">=array(</span><span class="default">1</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">$a2</span><span class="keyword">=array(</span><span class="default">1</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">array_uintersect</span><span class="keyword">(</span><span class="default">$a1</span><span class="keyword">,</span><span class="default">$a2</span><span class="keyword">,</span><span class="string">"myfunction"</span><span class="keyword">));<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="126955">  <div class="votes">
    ...
    <div class="tally" id="V126955" title="83% like this...">
    4
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">If you're rolling your own comparison function, keep in mind that the spaceship operator (i.e. &lt;=&gt;) can be your best friend. It's been around since PHP7. <a href="https://www.php.net/manual/en/language.operators.comparison.php" rel="nofollow" target="_blank">https://www.php.net/manual/en/language.operators.comparison.php</a><br /><br />So, for instance, instead of a clunky function like:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myFunction</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">, </span><span class="default">$v2</span><span class="keyword">) {<br />   if (</span><span class="default">$v1 </span><span class="keyword">=== </span><span class="default">$v2</span><span class="keyword">) {<br />      return </span><span class="default">0</span><span class="keyword">;<br />   }<br />   if (</span><span class="default">$v1 </span><span class="keyword">&gt; </span><span class="default">$v2</span><span class="keyword">) return </span><span class="default">1</span><span class="keyword">;<br />   return -</span><span class="default">1</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />You can simplify it to:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myFunction</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">, </span><span class="default">$v2</span><span class="keyword">) {<br />   return </span><span class="default">$v1 </span><span class="keyword">&lt;=&gt; </span><span class="default">$v2</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>rob dot c dot ruiz at gmail dot com</em></strong></a><a class="genanchor" href="#123348"> &para;</a><div class="date" title="2018-11-15 11:21"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123348">
<div class="phpcode"><code><span class="html">When trying to do a case insensitive comparison between arrays of words, the strcasecmp function works very nicely with this one like so: <br /><br />$arr1 = array('blue', 'green', 'red');<br /><br />$arr2 = array('BLUE', 'Purple', 'Red');<br /><br />$loose_matches = array_uintersect($arr1, $arr2, 'strcasecmp');<br /><br />print_r($loose_matches) // array('blue', 'red');</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Hayley Watson</em></strong></a><a class="genanchor" href="#122213"> &para;</a><div class="date" title="2018-01-01 10:25"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122213">
<div class="phpcode"><code><span class="html">As for the other "compare function" callbacks, the return value from the callback function doesn't need to be -1, 0, or 1.<br /><br />cmp($a,$b) just needs to be &lt;0, =0, or &gt;0 depending on whether $a&lt;$b, $a=$b, or $a&gt;$b.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.array-uintersect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-uintersect.php">＋<small>add a note</small></a></div>
