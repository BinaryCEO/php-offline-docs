...
<head>
  ...
  <title>PHP: Swoole\Table - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-table.php">
 <link rel="shorturl" href="https://www.php.net/swoole-table">
 <link rel="alternate" href="https://www.php.net/swoole-table" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-server.tick.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-table.column.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-table.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-table.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-table.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-table.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-table.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-table.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-table.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-table.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-table.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-table.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-table.php" hreflang="zh">
...
<meta name="Description" content="The Swoole\Table class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Swoole\Table - Manual" />
<meta name="twitter:description" content="The Swoole\Table class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Swoole\Table - Manual" />
<meta itemprop="description" content="The Swoole\Table class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Swoole\Table class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="swoole-table.column.php">
          Swoole\Table::column &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="swoole-server.tick.php">
          &laquo; Swoole\Server::tick        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-table.php' selected="selected">English</option>
            <option value='de/class.swoole-table.php'>German</option>
            <option value='es/class.swoole-table.php'>Spanish</option>
            <option value='fr/class.swoole-table.php'>French</option>
            <option value='it/class.swoole-table.php'>Italian</option>
            <option value='ja/class.swoole-table.php'>Japanese</option>
            <option value='pt_BR/class.swoole-table.php'>Brazilian Portuguese</option>
            <option value='ru/class.swoole-table.php'>Russian</option>
            <option value='tr/class.swoole-table.php'>Turkish</option>
            <option value='uk/class.swoole-table.php'>Ukrainian</option>
            <option value='zh/class.swoole-table.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.swoole-table" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-table.column.php">Swoole\Table::column</a> — Set the data type and size of the columns.</li><li><a href="swoole-table.construct.php">Swoole\Table::__construct</a> — Construct a Swoole memory table with fixed size.</li><li><a href="swoole-table.count.php">Swoole\Table::count</a> — Count the rows in the table, or count all the elements in the table if $mode = 1.</li><li><a href="swoole-table.create.php">Swoole\Table::create</a> — Create the swoole memory table.</li><li><a href="swoole-table.current.php">Swoole\Table::current</a> — Get the current row.</li><li><a href="swoole-table.decr.php">Swoole\Table::decr</a> — Decrement the value in the Swoole table by $key and $column</li><li><a href="swoole-table.del.php">Swoole\Table::del</a> — Delete a row in the Swoole table by $key</li><li><a href="swoole-table.destroy.php">Swoole\Table::destroy</a> — Destroy the Swoole table.</li><li><a href="swoole-table.exist.php">Swoole\Table::exist</a> — Check if a row is existed by $row_key.</li><li><a href="swoole-table.get.php">Swoole\Table::get</a> — Get the value in the Swoole table by $key and $field.</li><li><a href="swoole-table.incr.php">Swoole\Table::incr</a> — Increment the value by $key and $column</li><li><a href="swoole-table.key.php">Swoole\Table::key</a> — Get the key of current row.</li><li><a href="swoole-table.next.php">Swoole\Table::next</a> — Iterator the next row</li><li><a href="swoole-table.rewind.php">Swoole\Table::rewind</a> — Rewind the iterator.</li><li><a href="swoole-table.set.php">Swoole\Table::set</a> — Update a row of the table by $key.</li><li><a href="swoole-table.valid.php">Swoole\Table::valid</a> — Check if the current row is valid.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.table.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-table%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-table&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-table.php">＋<small>add a note</small></a></span>
