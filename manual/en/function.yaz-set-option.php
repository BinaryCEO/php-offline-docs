...
<head>
  ...
  <title>PHP: yaz_set_option - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.yaz-set-option.php">
 <link rel="shorturl" href="https://www.php.net/yaz-set-option">
 <link rel="alternate" href="https://www.php.net/yaz-set-option" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.yaz.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.yaz-search.php">
 <link rel="next" href="https://www.php.net/manual/en/function.yaz-sort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.yaz-set-option.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.yaz-set-option.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.yaz-set-option.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.yaz-set-option.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.yaz-set-option.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.yaz-set-option.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.yaz-set-option.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.yaz-set-option.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.yaz-set-option.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.yaz-set-option.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.yaz-set-option.php" hreflang="zh">
...
<meta name="Description" content="Sets one or more options for connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: yaz_set_option - Manual" />
<meta name="twitter:description" content="Sets one or more options for connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: yaz_set_option - Manual" />
<meta itemprop="description" content="Sets one or more options for connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets one or more options for connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.yaz-set-option.php' selected="selected">English</option>
            <option value='de/function.yaz-set-option.php'>German</option>
            <option value='es/function.yaz-set-option.php'>Spanish</option>
            <option value='fr/function.yaz-set-option.php'>French</option>
            <option value='it/function.yaz-set-option.php'>Italian</option>
            <option value='ja/function.yaz-set-option.php'>Japanese</option>
            <option value='pt_BR/function.yaz-set-option.php'>Brazilian Portuguese</option>
            <option value='ru/function.yaz-set-option.php'>Russian</option>
            <option value='tr/function.yaz-set-option.php'>Turkish</option>
            <option value='uk/function.yaz-set-option.php'>Ukrainian</option>
            <option value='zh/function.yaz-set-option.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.yaz-set-option" class="refentry">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaz/functions/yaz-set-option.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.yaz-set-option%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.yaz-set-option&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.yaz-set-option.php">＋<small>add a note</small></a></span>
