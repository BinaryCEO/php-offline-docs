...
<head>
  ...
  <title>PHP: PharData::compressFiles - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.compressfiles.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.compressfiles.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.compressfiles.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.compress.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.compressfiles.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.compressfiles.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.compressfiles.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.compressfiles.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.compressfiles.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.compressfiles.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.compressfiles.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.compressfiles.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.compressfiles.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.compressfiles.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.compressfiles.php" hreflang="zh">
...
<meta name="Description" content="Compresses all files in the current tar/zip archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::compressFiles - Manual" />
<meta name="twitter:description" content="Compresses all files in the current tar/zip archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::compressFiles - Manual" />
<meta itemprop="description" content="Compresses all files in the current tar/zip archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compresses all files in the current tar/zip archive" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phardata.construct.php">
          PharData::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.compress.php">
          &laquo; PharData::compress        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.compressfiles.php' selected="selected">English</option>
            <option value='de/phardata.compressfiles.php'>German</option>
            <option value='es/phardata.compressfiles.php'>Spanish</option>
            <option value='fr/phardata.compressfiles.php'>French</option>
            <option value='it/phardata.compressfiles.php'>Italian</option>
            <option value='ja/phardata.compressfiles.php'>Japanese</option>
            <option value='pt_BR/phardata.compressfiles.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.compressfiles.php'>Russian</option>
            <option value='tr/phardata.compressfiles.php'>Turkish</option>
            <option value='uk/phardata.compressfiles.php'>Ukrainian</option>
            <option value='zh/phardata.compressfiles.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.compressfiles" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">PharData::compressFiles</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">PharData::compressFiles</span> &mdash; <span class="dc-title">Compresses all files in the current tar/zip archive</span></p>
 ...
 <div class="refsect1 description" id="refsect1-phardata.compressfiles-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>PharData::compressFiles</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compression</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-phardata.compressfiles-examples">
  ...
  <p class="para">
   <div class="example" id="example-850">
    <p><strong>Example #1 A <span class="function"><strong>PharData::compressFiles()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phardata.decompress.php" class="function" rel="rdfs-seeAlso">PharData::decompress()</a> - Decompresses the entire Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/compressFiles.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.compressfiles%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.compressfiles&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.compressfiles.php">＋<small>add a note</small></a></span>
