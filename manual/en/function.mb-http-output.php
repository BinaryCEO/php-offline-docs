...
<head>
  ...
  <title>PHP: mb_http_output - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-http-output.php">
 <link rel="shorturl" href="https://www.php.net/mb-http-output">
 <link rel="alternate" href="https://www.php.net/mb-http-output" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-http-input.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-internal-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-http-output.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-http-output.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-http-output.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-http-output.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-http-output.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-http-output.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-http-output.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-http-output.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-http-output.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-http-output.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-http-output.php" hreflang="zh">
...
<meta name="Description" content="Set/Get HTTP output character encoding" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_http_output - Manual" />
<meta name="twitter:description" content="Set/Get HTTP output character encoding" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_http_output - Manual" />
<meta itemprop="description" content="Set/Get HTTP output character encoding" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/Get HTTP output character encoding" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mb-internal-encoding.php">
          mb_internal_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-http-input.php">
          &laquo; mb_http_input        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-http-output.php' selected="selected">English</option>
            <option value='de/function.mb-http-output.php'>German</option>
            <option value='es/function.mb-http-output.php'>Spanish</option>
            <option value='fr/function.mb-http-output.php'>French</option>
            <option value='it/function.mb-http-output.php'>Italian</option>
            <option value='ja/function.mb-http-output.php'>Japanese</option>
            <option value='pt_BR/function.mb-http-output.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-http-output.php'>Russian</option>
            <option value='tr/function.mb-http-output.php'>Turkish</option>
            <option value='uk/function.mb-http-output.php'>Ukrainian</option>
            <option value='zh/function.mb-http-output.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-http-output" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_http_output</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_http_output</span> &mdash; <span class="dc-title">Set/Get HTTP output character encoding</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-http-output-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_http_output</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Set/Get the HTTP output character encoding.
   Output after this function is called will be converted from the set internal encoding to <code class="parameter">encoding</code>.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-http-output-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If <code class="parameter">encoding</code> is set,
       <span class="function"><strong>mb_http_output()</strong></span> sets the HTTP output character
       encoding to <code class="parameter">encoding</code>.
      </p>
      <p class="para">
       If <code class="parameter">encoding</code> is omitted,
 ...
 <div class="refsect1 errors" id="refsect1-function.mb-http-output-errors">
  <h3 class="title">Errors/Exceptions</h3>
  <p class="simpara">
   Throws a <span class="exceptionname"><a href="class.valueerror.php" class="exceptionname">ValueError</a></span> if
   <code class="parameter">encoding</code> contains null bytes.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       <span class="function"><strong>mb_http_output()</strong></span> now throws a
       <span class="exceptionname"><a href="class.valueerror.php" class="exceptionname">ValueError</a></span> if <code class="parameter">encoding</code>
       contains null bytes.
      </td>
     </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-detect-order.php" class="function" rel="rdfs-seeAlso">mb_detect_order()</a> - Set/Get character encoding detection order</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-http-output.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-http-output%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-http-output&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-http-output.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="78210">  <div class="votes">
    <div id="Vu78210">
    <a href="/manual/vote-note.php?id=78210&amp;page=function.mb-http-output&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78210">
    <a href="/manual/vote-note.php?id=78210&amp;page=function.mb-http-output&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78210" title="56% like this...">
    2
    </div>
  </div>
  <a href="#78210" class="name">
  <strong class="user"><em>anders jenbo pc dk</em></strong></a><a class="genanchor" href="#78210"> &para;</a><div class="date" title="2007-10-03 01:23"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78210">
<div class="phpcode"><code><span class="html">By default this is set to 'pass' witch means that php will not touch the encoding and output it as it is in the source file.<br /><br />Normaly this function isn't needed as long as you save the .php file in the same encoding as you want it to output as well as retrive all input in the same encoding, but it don't seam to herd as long as it able to figure out what encoding the output is in ín the first place.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-http-output&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-http-output.php">＋<small>add a note</small></a></div>
