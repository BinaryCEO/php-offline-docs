...
<head>
  ...
  <title>PHP: Imagick::cycleColormapImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.current.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.decipherimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.cyclecolormapimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.cyclecolormapimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.cyclecolormapimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.cyclecolormapimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.cyclecolormapimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.cyclecolormapimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.cyclecolormapimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.cyclecolormapimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.cyclecolormapimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.cyclecolormapimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::cycleColormapImage - Manual" />
<meta name="twitter:description" content="Displaces an image's colormap" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::cycleColormapImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.decipherimage.php">
          Imagick::decipherImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.current.php">
          &laquo; Imagick::current        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.cyclecolormapimage.php' selected="selected">English</option>
            <option value='de/imagick.cyclecolormapimage.php'>German</option>
            <option value='es/imagick.cyclecolormapimage.php'>Spanish</option>
            <option value='fr/imagick.cyclecolormapimage.php'>French</option>
            <option value='it/imagick.cyclecolormapimage.php'>Italian</option>
            <option value='ja/imagick.cyclecolormapimage.php'>Japanese</option>
            <option value='pt_BR/imagick.cyclecolormapimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.cyclecolormapimage.php'>Russian</option>
            <option value='tr/imagick.cyclecolormapimage.php'>Turkish</option>
            <option value='uk/imagick.cyclecolormapimage.php'>Ukrainian</option>
            <option value='zh/imagick.cyclecolormapimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.cyclecolormapimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::cycleColormapImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::cycleColormapImage</span> &mdash; <span class="dc-title">Displaces an image&#039;s colormap</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.cyclecolormapimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::cycleColormapImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$displace</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.cyclecolormapimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.cyclecolormapimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.cyclecolormapimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/cyclecolormapimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.cyclecolormapimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.cyclecolormapimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.cyclecolormapimage.php">＋<small>add a note</small></a></span>
