...
<head>
  ...
  <title>PHP: OAuth::getRequestToken - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/oauth.getrequesttoken.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/oauth.getrequesttoken.php">
 <link rel="alternate" href="https://www.php.net/manual/en/oauth.getrequesttoken.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.oauth.php">
 <link rel="prev" href="https://www.php.net/manual/en/oauth.getrequestheader.php">
 <link rel="next" href="https://www.php.net/manual/en/oauth.setauthtype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/oauth.getrequesttoken.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/oauth.getrequesttoken.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/oauth.getrequesttoken.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/oauth.getrequesttoken.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/oauth.getrequesttoken.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/oauth.getrequesttoken.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/oauth.getrequesttoken.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/oauth.getrequesttoken.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/oauth.getrequesttoken.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/oauth.getrequesttoken.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/oauth.getrequesttoken.php" hreflang="zh">
...
<meta name="Description" content="Fetch a request token" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: OAuth::getRequestToken - Manual" />
<meta name="twitter:description" content="Fetch a request token" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: OAuth::getRequestToken - Manual" />
<meta itemprop="description" content="Fetch a request token" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch a request token" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="oauth.setauthtype.php">
          OAuth::setAuthType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="oauth.getrequestheader.php">
          &laquo; OAuth::getRequestHeader        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/oauth.getrequesttoken.php' selected="selected">English</option>
            <option value='de/oauth.getrequesttoken.php'>German</option>
            <option value='es/oauth.getrequesttoken.php'>Spanish</option>
            <option value='fr/oauth.getrequesttoken.php'>French</option>
            <option value='it/oauth.getrequesttoken.php'>Italian</option>
            <option value='ja/oauth.getrequesttoken.php'>Japanese</option>
            <option value='pt_BR/oauth.getrequesttoken.php'>Brazilian Portuguese</option>
            <option value='ru/oauth.getrequesttoken.php'>Russian</option>
            <option value='tr/oauth.getrequesttoken.php'>Turkish</option>
            <option value='uk/oauth.getrequesttoken.php'>Ukrainian</option>
            <option value='zh/oauth.getrequesttoken.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="oauth.getrequesttoken" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">OAuth::getRequestToken</h1>
  <p class="verinfo">(PECL OAuth &gt;= 0.99.1)</p><p class="refpurpose"><span class="refname">OAuth::getRequestToken</span> &mdash; <span class="dc-title">Fetch a request token</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-oauth.getrequesttoken-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       OAuth callback URL. If <code class="parameter">callback_url</code> is passed and is an empty value, it is set to &quot;oob&quot; to address the OAuth 2009.1 advisory.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       HTTP method to use, e.g. <code class="literal">GET</code> or <code class="literal">POST</code>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-oauth.getrequesttoken-returnvalues">
  ...
  <p class="para">
   Returns an array containing the parsed OAuth response on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <tr>
       ...
       <td>
        The <code class="parameter">callback_url</code> parameter was added
       </td>
      </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="oauth.getlastresponseinfo.php" class="methodname" rel="rdfs-seeAlso">OAuth::getLastResponseInfo()</a> - Get HTTP information about the last response</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oauth/oauth/getrequesttoken.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foauth.getrequesttoken%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=oauth.getrequesttoken&amp;repo=en&amp;redirect=https://www.php.net/manual/en/oauth.getrequesttoken.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="97034">  <div class="votes">
    <div id="Vu97034">
    <a href="/manual/vote-note.php?id=97034&amp;page=oauth.getrequesttoken&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd97034">
    <a href="/manual/vote-note.php?id=97034&amp;page=oauth.getrequesttoken&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V97034" title="50% like this...">
    0
    </div>
  </div>
  <a href="#97034" class="name">
  <strong class="user"><em>bohwaz</em></strong></a><a class="genanchor" href="#97034"> &para;</a><div class="date" title="2010-03-29 07:29"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom97034">
<div class="phpcode"><code><span class="html">Please note that if you don't supply callback_url, the oauth parameter oauth_callback will not be sent to the server and will result in an error from the server, as this parameter is REQUIRED in the OAuth spec.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=oauth.getrequesttoken&amp;repo=en&amp;redirect=https://www.php.net/manual/en/oauth.getrequesttoken.php">＋<small>add a note</small></a></div>
