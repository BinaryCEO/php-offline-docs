...
<head>
  ...
  <title>PHP: ArrayObject::natcasesort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.natcasesort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.natcasesort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.natcasesort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.ksort.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.natsort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.natcasesort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/arrayobject.natcasesort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/arrayobject.natcasesort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/arrayobject.natcasesort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/arrayobject.natcasesort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/arrayobject.natcasesort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/arrayobject.natcasesort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/arrayobject.natcasesort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/arrayobject.natcasesort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/arrayobject.natcasesort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/arrayobject.natcasesort.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ArrayObject::natcasesort - Manual" />
...
<meta itemprop="name" content="PHP: ArrayObject::natcasesort - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="arrayobject.natsort.php">
          ArrayObject::natsort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="arrayobject.ksort.php">
          &laquo; ArrayObject::ksort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.natcasesort.php' selected="selected">English</option>
            <option value='de/arrayobject.natcasesort.php'>German</option>
            <option value='es/arrayobject.natcasesort.php'>Spanish</option>
            <option value='fr/arrayobject.natcasesort.php'>French</option>
            <option value='it/arrayobject.natcasesort.php'>Italian</option>
            <option value='ja/arrayobject.natcasesort.php'>Japanese</option>
            <option value='pt_BR/arrayobject.natcasesort.php'>Brazilian Portuguese</option>
            <option value='ru/arrayobject.natcasesort.php'>Russian</option>
            <option value='tr/arrayobject.natcasesort.php'>Turkish</option>
            <option value='uk/arrayobject.natcasesort.php'>Ukrainian</option>
            <option value='zh/arrayobject.natcasesort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="arrayobject.natcasesort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ArrayObject::natcasesort</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ArrayObject::natcasesort</span> &mdash; <span class="dc-title">Sort an array using a case insensitive &quot;natural order&quot; algorithm</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-arrayobject.natcasesort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ArrayObject::natcasesort</strong></span>(): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   This method is a case insensitive version of
   <a href="arrayobject.natsort.php" class="link">ArrayObject::natsort</a>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-arrayobject.natcasesort-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-arrayobject.natcasesort-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-arrayobject.natcasesort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-arrayobject.natcasesort-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3866">
    <p><strong>Example #1 <span class="function"><strong>ArrayObject::natcasesort()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Standard sorting
...
object(ArrayObject)#2 (1) {
 ...
 <div class="refsect1 seealso" id="refsect1-arrayobject.natcasesort-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.natcasesort.php" class="function" rel="rdfs-seeAlso">natcasesort()</a> - Sort an array using a case insensitive &quot;natural order&quot; algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/natcasesort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.natcasesort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.natcasesort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.natcasesort.php">＋<small>add a note</small></a></span>
