...
<head>
  ...
  <title>PHP: trader_t3 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-t3.php">
 <link rel="shorturl" href="https://www.php.net/trader-t3">
 <link rel="alternate" href="https://www.php.net/trader-t3" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-sum.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-tan.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-t3.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-t3.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-t3.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-t3.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-t3.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-t3.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-t3.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-t3.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-t3.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-t3.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-t3.php" hreflang="zh">
...
<meta name="Description" content="Triple Exponential Moving Average (T3)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_t3 - Manual" />
<meta name="twitter:description" content="Triple Exponential Moving Average (T3)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_t3 - Manual" />
<meta itemprop="description" content="Triple Exponential Moving Average (T3)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Triple Exponential Moving Average (T3)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-tan.php">
          trader_tan &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-sum.php">
          &laquo; trader_sum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-t3.php' selected="selected">English</option>
            <option value='de/function.trader-t3.php'>German</option>
            <option value='es/function.trader-t3.php'>Spanish</option>
            <option value='fr/function.trader-t3.php'>French</option>
            <option value='it/function.trader-t3.php'>Italian</option>
            <option value='ja/function.trader-t3.php'>Japanese</option>
            <option value='pt_BR/function.trader-t3.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-t3.php'>Russian</option>
            <option value='tr/function.trader-t3.php'>Turkish</option>
            <option value='uk/function.trader-t3.php'>Ukrainian</option>
            <option value='zh/function.trader-t3.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-t3" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_t3</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_t3</span> &mdash; <span class="dc-title">Triple Exponential Moving Average (T3)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-t3-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_t3</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$vFactor</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-t3-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">vFactor</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-t3-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-t3.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-t3%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-t3&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-t3.php">＋<small>add a note</small></a></span>
