...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.preg-match.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.preg-last-error-msg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.preg-match-all.php">
...
<meta name="Description" content="Perform a regular expression match" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: preg_match - Manual" />
<meta name="twitter:description" content="Perform a regular expression match" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: preg_match - Manual" />
<meta itemprop="description" content="Perform a regular expression match" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform a regular expression match" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.preg-match.php' selected="selected">English</option>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// The "i" after the pattern delimiter indicates a case-insensitive search<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">preg_match</span><span style="color: #007700">(</span><span style="color: #DD0000">"/php/i"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PHP is the web scripting language of choice."</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"A match was found."</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"A match was not found."</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-5029">
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* The \b in the pattern indicates a word boundary, so only the distinct<br /> * word "web" is matched, and not a word partial like "webbing" or "cobweb" */<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">preg_match</span><span style="color: #007700">(</span><span style="color: #DD0000">"/\bweb\b/i"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PHP is the web scripting language of choice."</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"A match was found."</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"A match was not found."</span><span style="color: #007700">;<br />}<br /><br />echo </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br />if (</span><span style="color: #0000BB">preg_match</span><span style="color: #007700">(</span><span style="color: #DD0000">"/\bweb\b/i"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PHP is the website scripting language of choice."</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"A match was found."</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"A match was not found."</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-5030">
...
<div class="annotation-interactive examplescode"><pre class="examplescode">domain name is: php.net</pre>
  ...
  <p class="para">
   <div class="example" id="example-5031">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.preg-last-error-msg.php" class="function" rel="rdfs-seeAlso">preg_last_error_msg()</a> - Returns the error message of the last PCRE regex execution</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcre/functions/preg-match.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.preg-match%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.preg-match&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.preg-match.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">There does not seem to be any mention of the PHP version of switches that can be used with regular expressions.
<br />
...
<br />
<br />I am hoping this will save someone from the 4 hours of torture that I endured, trying to workout this issue.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Sometimes its useful to negate a string. The first method which comes to mind to do this is: [^(string)] but this of course won't work. There is a solution, but it is not very well known. This is the simple piece of code on how a negation of a string is done:<br /><br />(?:(?!string).)<br /><br />?: makes a subpattern (see <a href="http://www.php.net/manual/en/regexp.reference.subpatterns.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/regexp.reference.subpatterns.php</a>) and ?! is a negative look ahead. You put the negative look ahead in front of the dot because you want the regex engine to first check if there is an occurrence of the string you are negating. Only if it is not there, you want to match an arbitrary character.<br /><br />Hope this helps some ppl.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">pcre2-migration<br /><br />Status: Implemented (in PHP 7.3)<br /><br />SELinux will prevent PREG_* functions from working<br /><br />Feb  8 12:40:51 servername setroubleshoot: SELinux is preventing httpd from using the execmem access on a process. <br /><br />you need to add preg.jit=0 to php.ini or init_set('preg.jit', 0) if you can't do that<br /><br />try the [PCRE] section so you can find it</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Note that if a parenthesed group is not matched, its key may or may not be present in $matches. For instance,<br /><br /><span class="default">&lt;?php preg_match</span><span class="keyword">(</span><span class="string">'/(foo)?(bar)?(baz)?/'</span><span class="keyword">, </span><span class="string">'bar'</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$matches</span><span class="keyword">); <br /><br /></span><span class="comment">// outputs<br />// Array<br />// (<br />//     [0] =&gt; bar<br />//     [1] =&gt; <br />//     [2] =&gt; bar<br />// )<br /></span><span class="default">?&gt;<br /></span>Note that there is no element with key '3' in $matches, but an element with key '1' (the empty string). This inconsistent behavior also applies to named groups.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you want to validate an email in one line, use filter_var() function !<br /><a href="http://fr.php.net/manual/en/function.filter-var.php" rel="nofollow" target="_blank">http://fr.php.net/manual/en/function.filter-var.php</a><br /><br />easy use, as described in the document example :<br />var_dump(filter_var('bob@example.com', FILTER_VALIDATE_EMAIL));</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">This sample is for checking persian character:<br /><br /><span class="default">&lt;?php<br />   preg_match</span><span class="keyword">(</span><span class="string">"/[\x{0600}-\x{06FF}\x]{1,32}/u"</span><span class="keyword">, </span><span class="string">'محمد'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">For those who search for a unicode regular expression example using preg_match here it is:<br /><br />Check for Persian digits<br />preg_match( "/[^\x{06F0}-\x{06F9}\x]+/u" , '۱۲۳۴۵۶۷۸۹۰' );</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Preg_match returns empty result trying to validate $subject with carriege returns (/n/r).<br />To solve it one need to use /s modifier in $pattern string.<br /><span class="default">&lt;?php<br />$pattern</span><span class="keyword">=</span><span class="string">'/.*/s'</span><span class="keyword">;<br /></span><span class="default">$valid</span><span class="keyword">=</span><span class="default">preg_match</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">$match</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>splattermania at freenet dot de</em></strong></a><a class="genanchor" href="#93824"> &para;</a><div class="date" title="2009-10-01 05:01"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom93824">
<div class="phpcode"><code><span class="html">As I wasted lots of time finding a REAL regex for URLs and resulted in building it on my own, I now have found one, that seems to work for all kinds of urls:
<br />
...
<div class="phpcode"><code><span class="html">for those coming over from ereg, preg_match can be quite intimidating. to get started here is a migration tip.
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>sainnr at gmail dot com</em></strong></a><a class="genanchor" href="#101618"> &para;</a><div class="date" title="2010-12-30 06:12"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101618">
<div class="phpcode"><code><span class="html">This sample regexp may be useful if you are working with DB field types. <br /><br />(?P&lt;type&gt;\w+)($|\((?P&lt;length&gt;(\d+|(.*)))\))<br /><br />For example, if you are have a such type as "varchar(255)" or "text", the next fragment<br /><br /><span class="default">&lt;?php<br />   $type </span><span class="keyword">= </span><span class="string">'varchar(255)'</span><span class="keyword">;  </span><span class="comment">// type of field<br />   </span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/(?P&lt;type&gt;\w+)($|\((?P&lt;length&gt;(\d+|(.*)))\))/'</span><span class="keyword">, </span><span class="default">$type</span><span class="keyword">, </span><span class="default">$field</span><span class="keyword">);<br />   </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$field</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />will output something like this:<br />Array ( [0] =&gt; varchar(255) [type] =&gt; varchar [1] =&gt; varchar [2] =&gt; (255) [length] =&gt; 255 [3] =&gt; 255 [4] =&gt; 255 )</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ian_channing at hotmail dot com</em></strong></a><a class="genanchor" href="#101575"> &para;</a><div class="date" title="2010-12-27 01:55"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101575">
<div class="phpcode"><code><span class="html">When trying to check a file path that could be windows or unix it took me quite a few tries to get the escape characters right.<br /><br />The Unix directory separator must be escaped once and the windows directory separator must be escaped twice.<br /><br />This will match path/to/file and path\to\file.exe<br /><br />preg_match('/^[a-z0-9_.\/\\\]*$/i', $file_string);</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Jonny 5</em></strong></a><a class="genanchor" href="#106804"> &para;</a><div class="date" title="2011-12-07 09:55"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106804">
<div class="phpcode"><code><span class="html">Workaround for getting the offset in UTF-8
...
<div class="phpcode"><code><span class="html">When using a 'bad words reject string' filter, preg_match is MUCH faster than strpos / stripos. Because in the other cases, you would need to do a foreach for each word. With efficient programming, the foreach is ONLY faster when the first word in the ban-list is found.<br /><br />(for 12 words, 100,000 iterations, no word found)<br />stripos - Taken 1.4876 seconds.<br />strpos - Taken 1.4207 seconds.<br />preg_match - Taken 0.189 seconds.<br /><br />Interesting fact:<br />With long words ('averylongwordtospitepreg'), the difference is only much less. Only about a 2/3rd of the time instead of 1/6th<br /><br /><span class="default">&lt;?php<br /><br />$words </span><span class="keyword">= array(</span><span class="string">'word1'</span><span class="keyword">, </span><span class="string">'word2'</span><span class="keyword">, </span><span class="string">'word3'</span><span class="keyword">, </span><span class="string">'word4'</span><span class="keyword">, </span><span class="string">'word5'</span><span class="keyword">, </span><span class="string">'word6'</span><span class="keyword">, </span><span class="string">'word7'</span><span class="keyword">, </span><span class="string">'word8'</span><span class="keyword">, </span><span class="string">'word9'</span><span class="keyword">, </span><span class="string">'word10'</span><span class="keyword">, </span><span class="string">'word11'</span><span class="keyword">, </span><span class="string">'word12' </span><span class="keyword">);<br /></span><span class="default">$teststring </span><span class="keyword">= </span><span class="string">'ThIs Is A tEsTsTrInG fOr TeStInG.'</span><span class="keyword">;<br /></span><span class="default">$count </span><span class="keyword">= </span><span class="default">100000</span><span class="keyword">;<br /></span><span class="default">$find </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /><br /></span><span class="default">$start </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">);<br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$count</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    foreach (</span><span class="default">$words </span><span class="keyword">as </span><span class="default">$word</span><span class="keyword">) {<br />        if (</span><span class="default">stripos</span><span class="keyword">(</span><span class="default">$teststring</span><span class="keyword">, </span><span class="default">$word</span><span class="keyword">) !== </span><span class="default">FALSE</span><span class="keyword">) {<br />            </span><span class="default">$find</span><span class="keyword">++;<br />            break;<br />        }<br />    }<br />}<br />echo </span><span class="string">'stripos - Taken ' </span><span class="keyword">. </span><span class="default">round</span><span class="keyword">(</span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">) - </span><span class="default">$start</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">) . </span><span class="string">' seconds.' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">$start </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">);<br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$count</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    foreach (</span><span class="default">$words </span><span class="keyword">as </span><span class="default">$word</span><span class="keyword">) {<br />        if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$teststring</span><span class="keyword">, </span><span class="default">$word</span><span class="keyword">) !== </span><span class="default">FALSE</span><span class="keyword">) {<br />            </span><span class="default">$find</span><span class="keyword">++;<br />            break;<br />        }<br />    }<br />}<br />echo </span><span class="string">'strpos - Taken ' </span><span class="keyword">. </span><span class="default">round</span><span class="keyword">(</span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">) - </span><span class="default">$start</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">) . </span><span class="string">' seconds.' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">$start </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">);<br /></span><span class="default">$pattern </span><span class="keyword">= </span><span class="string">'/'</span><span class="keyword">;<br /></span><span class="default">$div </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />foreach (</span><span class="default">$words </span><span class="keyword">as </span><span class="default">$word</span><span class="keyword">) {<br />    </span><span class="default">$pattern </span><span class="keyword">.= </span><span class="default">$div </span><span class="keyword">. </span><span class="default">preg_quote</span><span class="keyword">(</span><span class="default">$word</span><span class="keyword">);<br />    </span><span class="default">$div </span><span class="keyword">= </span><span class="string">'|'</span><span class="keyword">;<br />}<br /></span><span class="default">$pattern </span><span class="keyword">.= </span><span class="string">'/i'</span><span class="keyword">;<br /></span><span class="comment">//Pattern could easily be done somewhere else if words are static.<br /></span><span class="keyword">for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$count</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />    if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">$teststring</span><span class="keyword">)) {<br />        </span><span class="default">$find</span><span class="keyword">++;<br />    }<br />}<br /></span><span class="default">$end </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">(</span><span class="default">TRUE</span><span class="keyword">);<br />echo </span><span class="string">'preg_match - Taken ' </span><span class="keyword">. </span><span class="default">round</span><span class="keyword">(</span><span class="default">$end </span><span class="keyword">- </span><span class="default">$start</span><span class="keyword">, </span><span class="default">4</span><span class="keyword">) . </span><span class="string">' seconds.' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="93043">  <div class="votes">
    ...
    <div class="tally" id="V93043" title="58% like this...">
    9
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">This is a function that uses regular expressions to match against the various VAT formats required across the EU.
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">I see a lot of people trying to put together phone regex's and struggling (hey, no worries...they're complicated). Here's one that we use that's pretty nifty. It's not perfect, but it should work for most non-idealists.
<br />
...
<br />1(555)555-5555 :: MATCH</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be aware of bug <a href="https://bugs.php.net/bug.php?id=50887" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=50887</a> when using sub patterns: Un-matched optional sub patterns at the end won't show up in $matches.<br /><br />Here is a workaround: Assign a name to all subpatterns you are interested in, and merge $match afterwards with an constant array containing some reasonable default values:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'/^(?P&lt;lang&gt;[^;*][^;]*){1}(?:;q=(?P&lt;qval&gt;[0-9.]+))?$/u'</span><span class="keyword">, </span><span class="string">'de'</span><span class="keyword">, </span><span class="default">$match</span><span class="keyword">))<br />{<br />  </span><span class="default">$match </span><span class="keyword">= </span><span class="default">array_merge</span><span class="keyword">(array(</span><span class="string">'lang' </span><span class="keyword">=&gt; </span><span class="string">''</span><span class="keyword">, </span><span class="string">'qval' </span><span class="keyword">=&gt; </span><span class="string">''</span><span class="keyword">), </span><span class="default">$match</span><span class="keyword">);<br />  </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$match</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />This outputs:<br />Array<br />(<br />    [lang] =&gt; de<br />    [qval] =&gt; <br />    [0] =&gt; de<br />    [1] =&gt; de<br />)<br /><br />Instead of:<br />Array<br />(<br />    [0] =&gt; de<br />    [lang] =&gt; de<br />    [1] =&gt; de<br />)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The function will return false and raise a warning if the input $subject is too long :<br />[PhpWarning] preg_match(): Subject is too long<br /><br />I believe the limit is 1 or 2 GB because I was using a 2.2GB string.<br />While a parameter might exist to alter this limit, in my case it was possible and wiser to use &lt;500MB strings instead.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">When you use preg_match() for security purpose or huge data processing,<br />mayby you should make consideration for backtrack_limit and recursion_limit.<br /><a href="http://www.php.net/manual/en/pcre.configuration.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/pcre.configuration.php</a><br /><br />These limits may bring wrong matching result.<br />You can verify whether you hit these limits by checking preg_last_error().<br /><a href="http://www.php.net/manual/en/function.preg-last-error.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/function.preg-last-error.php</a></span></code></div>
  ...
  <strong class="user"><em>Stefan</em></strong></a><a class="genanchor" href="#94678"> &para;</a><div class="date" title="2009-11-17 02:47"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94678">
<div class="phpcode"><code><span class="html">I spent a while replacing all my ereg() calls to preg_match(), since ereg() is now deprecated and will not be supported as of v 6.0.
<br />
...
<br />
<br />I believe the preg_match behavior is cleaner. I just thought I would report this to hopefully save others some time.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">To support large Unicode ranges (ie: [\x{E000}-\x{FFFD}] or \x{10FFFFF}) you must use the modifier '/u' at the end of your expression.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">highlight Search Words 
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">If someone is from a country that accepts decimal numbers in format 9.00 and 9,00 (point or comma), number validation would be like that:<br /><span class="default">&lt;?php<br />$number_check </span><span class="keyword">= </span><span class="string">"9,99"</span><span class="keyword">;<br />if (</span><span class="default">preg_match</span><span class="keyword">( </span><span class="string">'/^[\-+]?[0-9]*\.*\,?[0-9]+$/'</span><span class="keyword">, </span><span class="default">$number_check</span><span class="keyword">)) {<br />    return </span><span class="default">TRUE</span><span class="keyword">; <br />}<br /></span><span class="default">?&gt;<br /></span><br />However, if the number will be written in the database, most probably this comma needs to be replaced with a dot. <br />This can be done with use of str_replace, i.e :<br /><span class="default">&lt;?php<br />$number_database </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">"," </span><span class="keyword">, </span><span class="string">"." </span><span class="keyword">, </span><span class="default">$number_check</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#125631"> &para;</a><div class="date" title="2020-12-28 03:43"><strong>4 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">To extract scheme, host, path, ect. simply use 
<br />
<br /><span class="default">&lt;?php
<br />
<br />  $url  </span><span class="keyword">= </span><span class="string">'<a href="http://name:pass@" rel="nofollow" target="_blank">http://name:pass@</a>'</span><span class="keyword">;
...
<br />)
<br />
<br />In my tests parse_url is up to 15x faster than preg_match(_all)!</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Combining flags <br />PREG_OFFSET_CAPTURE | PREG_UNMATCHED_AS_NULL <br />will NOT result in a value of NULL for any submatched subpattern.<br /><br />Instead still results in an array for each unmatched subpattern, in turn containing:<br /><br /> array (size=2)<br />      0 =&gt; null<br />      1 =&gt; int -1<br /><br />Consequently your code needs to expect NULL as the string value:<br /> $matches[ {subpattern+1} ][0] === null <br />and/or a negative string offset:<br /> $matches[ {subpattern+1} ][1] &lt; 0 <br />to detect any unmatched subpattern!</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Here's a regex to validate against the schema for common MySQL 
<br /> identifiers:
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">You can use the following code to detect non-latin (Cyrilic, Arabic, Greek...) characters:
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">The regular expression for breaking-down a URI reference into its components:<br /><br />      ^(([^:/?#]+):)?(//([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?<br />       12            3  4          5       6  7        8 9<br /><br />Source: ietf.org/rfc/rfc2396.txt</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">When using accented characters and "ñ" (áéíóúñ), preg_match does not work. It is a charset problem, use utf8_decode/decode to fix.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As of PHP 7.2, you can use the following.<br /><br />If you work with named subpatterns and dont want to bother with unnamed match result entries and unmatched subpatterns, just replace preg_match() with named_preg_match(). This filters all unwanted stuff out.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">named_preg_match</span><span class="keyword">(</span><span class="default">string $pattern </span><span class="keyword">, </span><span class="default">string $subject</span><span class="keyword">, array &amp;</span><span class="default">$matches </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">, </span><span class="default">int $flags </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">, </span><span class="default">int $offset </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">) {<br />    </span><span class="default">$retval </span><span class="keyword">= </span><span class="default">preg_match</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">$subject</span><span class="keyword">, </span><span class="default">$localmatches</span><span class="keyword">, </span><span class="default">PREG_UNMATCHED_AS_NULL </span><span class="keyword">| </span><span class="default">$flags</span><span class="keyword">, </span><span class="default">$offset</span><span class="keyword">);<br />    if (</span><span class="default">$retval</span><span class="keyword">) {<br />        foreach (</span><span class="default">$localmatches </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">) {<br />            if (</span><span class="default">is_int</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">)) </span><span class="default">$value </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />            if (</span><span class="default">is_null</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)) unset(</span><span class="default">$localmatches</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">]);<br />        }<br />        </span><span class="default">$matches </span><span class="keyword">= </span><span class="default">$localmatches</span><span class="keyword">;<br />    }<br />    return </span><span class="default">$retval</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />Hope this will be useful.</span></code></div>
  ...
  <strong class="user"><em>phil dot taylor at gmail dot com</em></strong></a><a class="genanchor" href="#86525"> &para;</a><div class="date" title="2008-10-22 05:01"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86525">
<div class="phpcode"><code><span class="html">If you need to check for .com.br and .com.au and .uk and all the other crazy domain endings i found the following expression works well if you want to validate an email address. Its quite generous in what it will allow
<br />
<br /><span class="default">&lt;?php
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=function.preg-match&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.preg-match.php">＋<small>add a note</small></a></div>
