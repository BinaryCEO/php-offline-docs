...
<head>
  ...
  <title>PHP: pg_field_num - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-field-num.php">
 <link rel="shorturl" href="https://www.php.net/pg-field-num">
 <link rel="alternate" href="https://www.php.net/pg-field-num" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-field-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-field-prtlen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-field-num.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-field-num.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-field-num.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-field-num.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-field-num.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-field-num.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-field-num.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-field-num.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-field-num.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-field-num.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-field-num.php" hreflang="zh">
...
<meta name="Description" content="Returns the field number of the named field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_field_num - Manual" />
<meta name="twitter:description" content="Returns the field number of the named field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_field_num - Manual" />
<meta itemprop="description" content="Returns the field number of the named field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the field number of the named field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-field-prtlen.php">
          pg_field_prtlen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-field-name.php">
          &laquo; pg_field_name        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-field-num.php' selected="selected">English</option>
            <option value='de/function.pg-field-num.php'>German</option>
            <option value='es/function.pg-field-num.php'>Spanish</option>
            <option value='fr/function.pg-field-num.php'>French</option>
            <option value='it/function.pg-field-num.php'>Italian</option>
            <option value='ja/function.pg-field-num.php'>Japanese</option>
            <option value='pt_BR/function.pg-field-num.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-field-num.php'>Russian</option>
            <option value='tr/function.pg-field-num.php'>Turkish</option>
            <option value='uk/function.pg-field-num.php'>Ukrainian</option>
            <option value='zh/function.pg-field-num.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-field-num" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_field_num</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_field_num</span> &mdash; <span class="dc-title">Returns the field number of the named field</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-field-num-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_field_num()</strong></span> will return the number of the
   field number that corresponds to the
   <code class="parameter">field</code> in the given <code class="parameter">result</code> instance.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_fieldnum()</strong></span>.
   </p>
  </p></blockquote>
 </div>
...
<div class="examplescode"><pre class="examplescode">Column &#039;title&#039; is field number: 2</pre>
</div>
    </div>
   </div> 
  </p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-field-name.php" class="function" rel="rdfs-seeAlso">pg_field_name()</a> - Returns the name of a field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-field-num.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-field-num%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-field-num&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-num.php">＋<small>add a note</small></a></span>
