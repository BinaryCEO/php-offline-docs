...
<head>
  ...
  <title>PHP: cubrid_lob2_write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-write.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-write">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-write" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-tell64.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lock-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-write.php" hreflang="zh">
...
<meta name="Description" content="Write to a lob object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_write - Manual" />
<meta name="twitter:description" content="Write to a lob object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_write - Manual" />
<meta itemprop="description" content="Write to a lob object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write to a lob object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-lock-read.php">
          cubrid_lock_read &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-tell64.php">
          &laquo; cubrid_lob2_tell64        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-write.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-write.php'>German</option>
            <option value='es/function.cubrid-lob2-write.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-write.php'>French</option>
            <option value='it/function.cubrid-lob2-write.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-write.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-write.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-write.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-write.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-write.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-write" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-write-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_write</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$buf</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <p class="para">
  <dl>
    ...
    <dt><code class="parameter">buf</code></dt>
    <dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob2-write-examples">
  ...
  <div class="example" id="example-1258">
   <p><strong>Example #1 <span class="function"><strong>cubrid_lob2_write()</strong></span> example 1</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// test_lob (id INT, contents CLOB)<br /><br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"DROP TABLE if exists test_lob"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"CREATE TABLE test_lob (id INT, contents CLOB)"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_prepare</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"INSERT INTO test_lob VALUES(2, ?)"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$lob </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'CLOB'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$len </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_write</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #DD0000">"Hello world"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_lob2_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$lob</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="example" id="example-1259">
   <p><strong>Example #2 <span class="function"><strong>cubrid_lob2_write()</strong></span> example 2</strong></p>
   <div class="example-contents">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-size64.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_size64()</a> - Get a lob object's size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-write.php">＋<small>add a note</small></a></span>
