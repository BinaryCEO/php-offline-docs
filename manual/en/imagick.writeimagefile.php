...
<head>
  ...
  <title>PHP: Imagick::writeImageFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.writeimagefile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.writeimagefile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimagefile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.writeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.writeimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.writeimagefile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.writeimagefile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.writeimagefile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.writeimagefile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.writeimagefile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.writeimagefile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.writeimagefile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.writeimagefile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.writeimagefile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.writeimagefile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.writeimagefile.php" hreflang="zh">
...
<meta name="Description" content="Writes an image to a filehandle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::writeImageFile - Manual" />
<meta name="twitter:description" content="Writes an image to a filehandle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::writeImageFile - Manual" />
<meta itemprop="description" content="Writes an image to a filehandle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Writes an image to a filehandle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.writeimages.php">
          Imagick::writeImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.writeimage.php">
          &laquo; Imagick::writeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.writeimagefile.php' selected="selected">English</option>
            <option value='de/imagick.writeimagefile.php'>German</option>
            <option value='es/imagick.writeimagefile.php'>Spanish</option>
            <option value='fr/imagick.writeimagefile.php'>French</option>
            <option value='it/imagick.writeimagefile.php'>Italian</option>
            <option value='ja/imagick.writeimagefile.php'>Japanese</option>
            <option value='pt_BR/imagick.writeimagefile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.writeimagefile.php'>Russian</option>
            <option value='tr/imagick.writeimagefile.php'>Turkish</option>
            <option value='uk/imagick.writeimagefile.php'>Ukrainian</option>
            <option value='zh/imagick.writeimagefile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.writeimagefile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::writeImageFile</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::writeImageFile</span> &mdash; <span class="dc-title">Writes an image to a filehandle</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.writeimagefile-description">
  ...
  <p class="para rdfs-comment">
   ...
   for example fopen. This method is available if Imagick has been compiled against ImageMagick version 6.3.6 or newer.
  </p>
 </div>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="imagick.queryformats.php" class="methodname" rel="rdfs-seeAlso">Imagick::queryFormats()</a> - Returns formats supported by Imagick</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/writeimagefile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.writeimagefile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.writeimagefile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.writeimagefile.php">＋<small>add a note</small></a></span>
