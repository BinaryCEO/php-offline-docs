...
<head>
  ...
  <title>PHP: ctype_graph - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ctype-graph.php">
 <link rel="shorturl" href="https://www.php.net/ctype-graph">
 <link rel="alternate" href="https://www.php.net/ctype-graph" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ctype.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ctype-digit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ctype-lower.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ctype-graph.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ctype-graph.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ctype-graph.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ctype-graph.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ctype-graph.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ctype-graph.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ctype-graph.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ctype-graph.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ctype-graph.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ctype-graph.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ctype-graph.php" hreflang="zh">
...
<meta name="Description" content="Check for any printable character(s) except space" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ctype_graph - Manual" />
<meta name="twitter:description" content="Check for any printable character(s) except space" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ctype_graph - Manual" />
<meta itemprop="description" content="Check for any printable character(s) except space" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check for any printable character(s) except space" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ctype-graph.php' selected="selected">English</option>
            <option value='de/function.ctype-graph.php'>German</option>
            <option value='es/function.ctype-graph.php'>Spanish</option>
            <option value='fr/function.ctype-graph.php'>French</option>
            <option value='it/function.ctype-graph.php'>Italian</option>
            <option value='ja/function.ctype-graph.php'>Japanese</option>
            <option value='pt_BR/function.ctype-graph.php'>Brazilian Portuguese</option>
            <option value='ru/function.ctype-graph.php'>Russian</option>
            <option value='tr/function.ctype-graph.php'>Turkish</option>
            <option value='uk/function.ctype-graph.php'>Ukrainian</option>
            <option value='zh/function.ctype-graph.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ctype-graph" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ctype_graph</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ctype_graph</span> &mdash; <span class="dc-title">Check for any printable character(s) except space</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ctype-graph-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">text</code>, creates visible output.
  </p>
 </div>
...
or an explicit call to <span class="function"><a href="function.chr.php" class="function">chr()</a></span> should be made.</p></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ctype-graph-returnvalues">
  ...
  <p class="para">
   ...
   printable and actually creates visible output (no white space), <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
   otherwise.
 ...
 <div class="refsect1 examples" id="refsect1-function.ctype-graph-examples">
  ...
  <p class="para">
   <div class="example" id="example-5367">
    <p><strong>Example #1 A <span class="function"><strong>ctype_graph()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">The string &#039;string1&#039; does not consist of all (visibly) printable characters.
The string &#039;string2&#039; consists of all (visibly) printable characters.
The string &#039;string3&#039; consists of all (visibly) printable characters.</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ctype-graph-seealso">
  ...
  <p class="para">
   ...
   alphanumeric character</span></li>
    <li><span class="function"><a href="intlchar.isgraph.php" class="function" rel="rdfs-seeAlso">IntlChar::isgraph()</a> - Check if code point is a graphic character</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ctype/functions/ctype-graph.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ctype-graph%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ctype-graph&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ctype-graph.php">＋<small>add a note</small></a></span>
