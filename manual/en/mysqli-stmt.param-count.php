...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-stmt.param-count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-stmt.param-count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-stmt.param-count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-stmt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-stmt.num-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-stmt.prepare.php">
...
<meta name="Description" content="Returns the number of parameters for the given statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_stmt::$param_count - Manual" />
<meta name="twitter:description" content="Returns the number of parameters for the given statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_stmt::$param_count - Manual" />
<meta itemprop="description" content="Returns the number of parameters for the given statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of parameters for the given statement" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-stmt.param-count.php' selected="selected">English</option>
            <option value='de/mysqli-stmt.param-count.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_stmt::$param_count</span> -- <span class="refname">mysqli_stmt_param_count</span> &mdash; <span class="dc-title">Returns the number of parameters for the given statement</span></p>
...
<div class="examplescode"><pre class="examplescode">Statement has 2 markers.</pre>
</div>
   </div>
  </div>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.prepare.php" class="function" rel="rdfs-seeAlso">mysqli_prepare()</a> - Prepares an SQL statement for execution</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_stmt/param-count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-stmt.param-count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-stmt.param-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.param-count.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This parameter (and presumably any other parameter in mysqli_stmt) will raise an error with the message "Property access is not allowed yet" if the statement was not prepared properly, or not prepared at all.<br /><br />To prevent this, always ensure that the return value of the "prepare" statement is true before accessing these properties.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli-stmt.param-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-stmt.param-count.php">＋<small>add a note</small></a></div>
