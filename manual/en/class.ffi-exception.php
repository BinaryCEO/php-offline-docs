...
<head>
  ...
  <title>PHP: FFI\Exception - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ffi-exception.php">
 <link rel="shorturl" href="https://www.php.net/ffi-exception">
 <link rel="alternate" href="https://www.php.net/ffi-exception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ffi.php">
 <link rel="prev" href="https://www.php.net/manual/en/ffi-ctype.getstructfieldtype.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ffi-parserexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ffi-exception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ffi-exception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ffi-exception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ffi-exception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ffi-exception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ffi-exception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ffi-exception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ffi-exception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ffi-exception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ffi-exception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ffi-exception.php" hreflang="zh">
...
<meta name="Description" content="FFI Exceptions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: FFI\Exception - Manual" />
<meta name="twitter:description" content="FFI Exceptions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: FFI\Exception - Manual" />
<meta itemprop="description" content="FFI Exceptions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="FFI Exceptions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.ffi-parserexception.php">
          FFI\ParserException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ffi-ctype.getstructfieldtype.php">
          &laquo; FFI\CType::getStructFieldType        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ffi-exception.php' selected="selected">English</option>
            <option value='de/class.ffi-exception.php'>German</option>
            <option value='es/class.ffi-exception.php'>Spanish</option>
            <option value='fr/class.ffi-exception.php'>French</option>
            <option value='it/class.ffi-exception.php'>Italian</option>
            <option value='ja/class.ffi-exception.php'>Japanese</option>
            <option value='pt_BR/class.ffi-exception.php'>Brazilian Portuguese</option>
            <option value='ru/class.ffi-exception.php'>Russian</option>
            <option value='tr/class.ffi-exception.php'>Turkish</option>
            <option value='uk/class.ffi-exception.php'>Ukrainian</option>
            <option value='zh/class.ffi-exception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ffi-exception" class="reference">

 <h1 class="title">FFI Exceptions</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 7 &gt;= 7.4.0, PHP 8)</p>


  <div class="section" id="ffi-exception.intro">
  ...
  <div class="section" id="ffi-exception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">FFI\Exception</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ffi/ffi.exception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ffi-exception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ffi-exception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ffi-exception.php">＋<small>add a note</small></a></span>
