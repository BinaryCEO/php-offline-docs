...
<head>
  ...
  <title>PHP: cubrid_commit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-commit.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-commit">
 <link rel="alternate" href="https://www.php.net/cubrid-commit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-column-types.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-commit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-commit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-commit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-commit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-commit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-commit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-commit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-commit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-commit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-commit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-commit.php" hreflang="zh">
...
<meta name="Description" content="Commit a transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_commit - Manual" />
<meta name="twitter:description" content="Commit a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_commit - Manual" />
<meta itemprop="description" content="Commit a transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commit a transaction" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-connect.php">
          cubrid_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-column-types.php">
          &laquo; cubrid_column_types        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-commit.php' selected="selected">English</option>
            <option value='de/function.cubrid-commit.php'>German</option>
            <option value='es/function.cubrid-commit.php'>Spanish</option>
            <option value='fr/function.cubrid-commit.php'>French</option>
            <option value='it/function.cubrid-commit.php'>Italian</option>
            <option value='ja/function.cubrid-commit.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-commit.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-commit.php'>Russian</option>
            <option value='tr/function.cubrid-commit.php'>Turkish</option>
            <option value='uk/function.cubrid-commit.php'>Ukrainian</option>
            <option value='zh/function.cubrid-commit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-commit" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-commit-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_commit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   You can set it by using <span class="function"><a href="function.cubrid-set-autocommit.php" class="function">cubrid_set_autocommit()</a></span>. 
   You can get its status by using <span class="function"><a href="function.cubrid-get-autocommit.php" class="function">cubrid_get_autocommit()</a></span>. Before you start a transaction, 
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-set-autocommit.php" class="function" rel="rdfs-seeAlso">cubrid_set_autocommit()</a> - Set autocommit mode of the connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-commit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-commit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-commit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-commit.php">＋<small>add a note</small></a></span>
