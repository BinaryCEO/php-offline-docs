...
<head>
  ...
  <title>PHP: cubrid_lob2_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-seek.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-seek">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-seek" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-seek64.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-seek.php" hreflang="zh">
...
<meta name="Description" content="Move the cursor of a lob object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_seek - Manual" />
<meta name="twitter:description" content="Move the cursor of a lob object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_seek - Manual" />
<meta itemprop="description" content="Move the cursor of a lob object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Move the cursor of a lob object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lob2-seek64.php">
          cubrid_lob2_seek64 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-read.php">
          &laquo; cubrid_lob2_read        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-seek.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-seek.php'>German</option>
            <option value='es/function.cubrid-lob2-seek.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-seek.php'>French</option>
            <option value='it/function.cubrid-lob2-seek.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-seek.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-seek.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-seek.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-seek.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-seek.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-seek" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_lob2_seek</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.4.1)</p><p class="refpurpose"><span class="refname">cubrid_lob2_seek</span> &mdash; <span class="dc-title">Move the cursor of a lob object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-lob2-seek-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_lob2_seek</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$lob_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$origin</code><span class="initializer"> = CUBRID_CURSOR_CURRENT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   The <span class="function"><strong>cubrid_lob2_seek()</strong></span> function is used to move the cursor
   position of a lob object by the value set in the <code class="parameter">offset</code>
   argument, to the direction set in the <code class="parameter">origin</code> argument.
  </p>
  <p class="para">
   To set the <code class="parameter">origin</code> argument, you can use <strong><code>CUBRID_CURSOR_FIRST</code></strong>
   to set the cursor position moving forward <code class="parameter">offset</code> units from
   the first beginning. In this case, <code class="parameter">offset</code> must be a positive value.
  </p>
  <p class="para">
   If you use <strong><code>CUBRID_CURSOR_CURRENT</code></strong> for <code class="parameter">origin</code>, you can move 
   forward or backward. and <code class="parameter">offset</code> can be positive or negative.
  </p>
  <p class="para">
   If you use <strong><code>CUBRID_CURSOR_LAST</code></strong> for <code class="parameter">origin</code>, you can move 
   backward <code class="parameter">offset</code> units from the end of LOB object and
   <code class="parameter">offset</code> only can be positive.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-lob2-seek-parameters">
 ...
 <p class="para">
  <dl>
    ...
    <dd>
     <p class="para">Lob identifier as a result of <span class="function"><a href="function.cubrid-lob2-new.php" class="function">cubrid_lob2_new()</a></span> or get from the result set.</p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-lob2-seek-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// test_lob (id INT, contents CLOB)<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">, </span><span style="color: #DD0000">"dba"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"DROP TABLE if exists test_lob"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">,</span><span style="color: #DD0000">"CREATE TABLE test_lob (id INT, contents CLOB)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_prepare</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"INSERT INTO test_lob VALUES(2, ?)"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$lob </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'CLOB'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$len </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_write</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #DD0000">"Hello world"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_lob2_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">CUBRID_CURSOR_LAST</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_lob2_write</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #DD0000">"beautiful"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_lob2_seek</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #0000BB">15</span><span style="color: #007700">, </span><span style="color: #0000BB">CUBRID_CURSOR_FIRST</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_lob2_read</span><span style="color: #007700">(</span><span style="color: #0000BB">$lob</span><span style="color: #007700">, </span><span style="color: #0000BB">5</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #0000BB">$data</span><span style="color: #007700">.</span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">cubrid_lob2_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">, </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #0000BB">$lob</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-lob2-seek-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-lob2-read.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_read()</a> - Read from BLOB/CLOB data</span></li>
   ...
   <li><span class="function"><a href="function.cubrid-lob2-size64.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_size64()</a> - Get a lob object's size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-seek.php">＋<small>add a note</small></a></span>
