...
<head>
  ...
  <title>PHP: sodium_crypto_stream_xor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xor.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-stream-xor">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-stream-xor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xchacha20-xor-ic.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-hex2bin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-stream-xor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-stream-xor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-stream-xor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-stream-xor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-stream-xor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-stream-xor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-stream-xor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-stream-xor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-stream-xor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-stream-xor.php" hreflang="zh">
...
<meta name="Description" content="Encrypt a message without authentication" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_stream_xor - Manual" />
<meta name="twitter:description" content="Encrypt a message without authentication" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_stream_xor - Manual" />
<meta itemprop="description" content="Encrypt a message without authentication" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypt a message without authentication" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-hex2bin.php">
          sodium_hex2bin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-stream-xchacha20-xor-ic.php">
          &laquo; sodium_crypto_stream_xchacha20_xor_ic        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-stream-xor.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-stream-xor.php'>German</option>
            <option value='es/function.sodium-crypto-stream-xor.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-stream-xor.php'>French</option>
            <option value='it/function.sodium-crypto-stream-xor.php'>Italian</option>
            <option value='ja/function.sodium-crypto-stream-xor.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-stream-xor.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-stream-xor.php'>Russian</option>
            <option value='tr/function.sodium-crypto-stream-xor.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-stream-xor.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-stream-xor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-stream-xor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_stream_xor</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_stream_xor</span> &mdash; <span class="dc-title">Encrypt a message without authentication</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-stream-xor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_stream_xor</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   This function encrypts a message with XSalsa20, but does not provide any ciphertext
   guarantees about the plaintext.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-stream-xor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-stream-xor-returnvalues">
  ...
  <p class="para">
   Encrypted message.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-stream-xor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-stream-xor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-stream-xor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-stream-xor.php">＋<small>add a note</small></a></span>
