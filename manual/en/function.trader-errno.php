...
<head>
  ...
  <title>PHP: trader_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-errno.php">
 <link rel="shorturl" href="https://www.php.net/trader-errno">
 <link rel="alternate" href="https://www.php.net/trader-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-ema.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-exp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-errno.php" hreflang="zh">
...
<meta name="Description" content="Get error code" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_errno - Manual" />
<meta name="twitter:description" content="Get error code" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_errno - Manual" />
<meta itemprop="description" content="Get error code" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get error code" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-errno.php' selected="selected">English</option>
            <option value='de/function.trader-errno.php'>German</option>
            <option value='es/function.trader-errno.php'>Spanish</option>
            <option value='fr/function.trader-errno.php'>French</option>
            <option value='it/function.trader-errno.php'>Italian</option>
            <option value='ja/function.trader-errno.php'>Japanese</option>
            <option value='pt_BR/function.trader-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-errno.php'>Russian</option>
            <option value='tr/function.trader-errno.php'>Turkish</option>
            <option value='uk/function.trader-errno.php'>Ukrainian</option>
            <option value='zh/function.trader-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_errno</h1>
  <p class="verinfo">(PECL trader &gt;= 0.3.0)</p><p class="refpurpose"><span class="refname">trader_errno</span> &mdash; <span class="dc-title">Get error code</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-errno-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_errno</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-errno-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.trader-errno-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">Returns the error code identified by one of the <a href="trader.constants.php" class="link">TRADER_ERR_*</a> constants.</p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-errno.php">＋<small>add a note</small></a></span>
