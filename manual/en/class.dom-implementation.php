...
<head>
  ...
  <title>PHP: Dom\Implementation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-implementation.php">
 <link rel="shorturl" href="https://www.php.net/dom-implementation">
 <link rel="alternate" href="https://www.php.net/dom-implementation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-htmlelement.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-namednodemap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-implementation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-implementation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-implementation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-implementation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-implementation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-implementation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-implementation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-implementation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-implementation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-implementation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-implementation.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Implementation class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Implementation - Manual" />
<meta name="twitter:description" content="The Dom\Implementation class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Implementation - Manual" />
<meta itemprop="description" content="The Dom\Implementation class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Implementation class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dom-namednodemap.php">
          Dom\NamedNodeMap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-htmlelement.php">
          &laquo; Dom\HTMLElement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-implementation.php' selected="selected">English</option>
            <option value='de/class.dom-implementation.php'>German</option>
            <option value='es/class.dom-implementation.php'>Spanish</option>
            <option value='fr/class.dom-implementation.php'>French</option>
            <option value='it/class.dom-implementation.php'>Italian</option>
            <option value='ja/class.dom-implementation.php'>Japanese</option>
            <option value='pt_BR/class.dom-implementation.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-implementation.php'>Russian</option>
            <option value='tr/class.dom-implementation.php'>Turkish</option>
            <option value='uk/class.dom-implementation.php'>Ukrainian</option>
            <option value='zh/class.dom-implementation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-implementation" class="reference">
 <h1 class="title">The Dom\Implementation class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-implementation.intro">
  ...
  <div class="section" id="dom-implementation.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Implementation</strong></strong>
     {</div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-implementation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-implementation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-implementation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-implementation.php">＋<small>add a note</small></a></span>
