...
<head>
  ...
  <title>PHP: Gmagick::haspreviousimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.hasnextimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.implodeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.haspreviousimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.haspreviousimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.haspreviousimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.haspreviousimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.haspreviousimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.haspreviousimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.haspreviousimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.haspreviousimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.haspreviousimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.haspreviousimage.php" hreflang="zh">
...
<meta name="Description" content="Checks if the object has a previous image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::haspreviousimage - Manual" />
<meta name="twitter:description" content="Checks if the object has a previous image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::haspreviousimage - Manual" />
<meta itemprop="description" content="Checks if the object has a previous image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the object has a previous image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.implodeimage.php">
          Gmagick::implodeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.hasnextimage.php">
          &laquo; Gmagick::hasnextimage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.haspreviousimage.php' selected="selected">English</option>
            <option value='de/gmagick.haspreviousimage.php'>German</option>
            <option value='es/gmagick.haspreviousimage.php'>Spanish</option>
            <option value='fr/gmagick.haspreviousimage.php'>French</option>
            <option value='it/gmagick.haspreviousimage.php'>Italian</option>
            <option value='ja/gmagick.haspreviousimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.haspreviousimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.haspreviousimage.php'>Russian</option>
            <option value='tr/gmagick.haspreviousimage.php'>Turkish</option>
            <option value='uk/gmagick.haspreviousimage.php'>Ukrainian</option>
            <option value='zh/gmagick.haspreviousimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.haspreviousimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::haspreviousimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::haspreviousimage</span> &mdash; <span class="dc-title">Checks if the object has a previous image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.haspreviousimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::haspreviousimage</strong></span>(): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>

  <p class="para rdfs-comment">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the object has more images when traversing the list in the reverse direction.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.haspreviousimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.haspreviousimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the object has more images when traversing the list in the reverse direction, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there are none. 
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.haspreviousimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/haspreviousimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.haspreviousimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.haspreviousimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.haspreviousimage.php">＋<small>add a note</small></a></span>
