...
<head>
  ...
  <title>PHP: Gmagick::getimagedepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagedepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagedepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagedelay.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagedispose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagedepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagedepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagedepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagedepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagedepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagedepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagedepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagedepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagedepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagedepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagedepth.php" hreflang="zh">
...
<meta name="Description" content="Gets the depth of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagedepth - Manual" />
<meta name="twitter:description" content="Gets the depth of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagedepth - Manual" />
<meta itemprop="description" content="Gets the depth of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the depth of the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagedispose.php">
          Gmagick::getimagedispose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagedelay.php">
          &laquo; Gmagick::getimagedelay        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagedepth.php' selected="selected">English</option>
            <option value='de/gmagick.getimagedepth.php'>German</option>
            <option value='es/gmagick.getimagedepth.php'>Spanish</option>
            <option value='fr/gmagick.getimagedepth.php'>French</option>
            <option value='it/gmagick.getimagedepth.php'>Italian</option>
            <option value='ja/gmagick.getimagedepth.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagedepth.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagedepth.php'>Russian</option>
            <option value='tr/gmagick.getimagedepth.php'>Turkish</option>
            <option value='uk/gmagick.getimagedepth.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagedepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagedepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagedepth</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagedepth</span> &mdash; <span class="dc-title">Gets the depth of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagedepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagedepth</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagedepth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagedepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagedepth-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagedepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagedepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagedepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagedepth.php">＋<small>add a note</small></a></span>
