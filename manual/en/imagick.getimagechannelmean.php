...
<head>
  ...
  <title>PHP: Imagick::getImageChannelMean - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechannelkurtosis.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagechannelrange.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagechannelmean.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagechannelmean.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagechannelmean.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagechannelmean.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagechannelmean.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagechannelmean.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagechannelmean.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagechannelmean.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagechannelmean.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagechannelmean.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagechannelmean.php" hreflang="zh">
...
<meta name="Description" content="Gets the mean and standard deviation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageChannelMean - Manual" />
<meta name="twitter:description" content="Gets the mean and standard deviation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageChannelMean - Manual" />
<meta itemprop="description" content="Gets the mean and standard deviation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the mean and standard deviation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagechannelrange.php">
          Imagick::getImageChannelRange &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechannelkurtosis.php">
          &laquo; Imagick::getImageChannelKurtosis        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagechannelmean.php' selected="selected">English</option>
            <option value='de/imagick.getimagechannelmean.php'>German</option>
            <option value='es/imagick.getimagechannelmean.php'>Spanish</option>
            <option value='fr/imagick.getimagechannelmean.php'>French</option>
            <option value='it/imagick.getimagechannelmean.php'>Italian</option>
            <option value='ja/imagick.getimagechannelmean.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagechannelmean.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagechannelmean.php'>Russian</option>
            <option value='tr/imagick.getimagechannelmean.php'>Turkish</option>
            <option value='uk/imagick.getimagechannelmean.php'>Ukrainian</option>
            <option value='zh/imagick.getimagechannelmean.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagechannelmean" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageChannelMean</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageChannelMean</span> &mdash; <span class="dc-title">Gets the mean and standard deviation</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagechannelmean-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageChannelMean</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagechannelmean-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagechannelmean-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array with <code class="literal">&quot;mean&quot;</code> and <code class="literal">&quot;standardDeviation&quot;</code>
   members.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-imagick.getimagechannelmean-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagechannelmean.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagechannelmean%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagechannelmean&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagechannelmean.php">＋<small>add a note</small></a></span>
