...
<head>
  ...
  <title>PHP: Imagick::setImageProfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagepage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageproperty.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageprofile.php" hreflang="zh">
...
<meta name="Description" content="Adds a named profile to the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageProfile - Manual" />
<meta name="twitter:description" content="Adds a named profile to the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageProfile - Manual" />
<meta itemprop="description" content="Adds a named profile to the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a named profile to the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageproperty.php">
          Imagick::setImageProperty &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagepage.php">
          &laquo; Imagick::setImagePage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageprofile.php' selected="selected">English</option>
            <option value='de/imagick.setimageprofile.php'>German</option>
            <option value='es/imagick.setimageprofile.php'>Spanish</option>
            <option value='fr/imagick.setimageprofile.php'>French</option>
            <option value='it/imagick.setimageprofile.php'>Italian</option>
            <option value='ja/imagick.setimageprofile.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageprofile.php'>Russian</option>
            <option value='tr/imagick.setimageprofile.php'>Turkish</option>
            <option value='uk/imagick.setimageprofile.php'>Ukrainian</option>
            <option value='zh/imagick.setimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageProfile</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageProfile</span> &mdash; <span class="dc-title">Adds a named profile to the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageProfile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$profile</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageprofile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageprofile-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageprofile.php">＋<small>add a note</small></a></span>
