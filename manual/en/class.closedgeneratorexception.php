...
<head>
  ...
  <title>PHP: ClosedGeneratorException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.closedgeneratorexception.php">
 <link rel="shorturl" href="https://www.php.net/closedgeneratorexception">
 <link rel="alternate" href="https://www.php.net/closedgeneratorexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/errorexception.getseverity.php">
 <link rel="next" href="https://www.php.net/manual/en/class.error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.closedgeneratorexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.closedgeneratorexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.closedgeneratorexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.closedgeneratorexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.closedgeneratorexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.closedgeneratorexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.closedgeneratorexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.closedgeneratorexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.closedgeneratorexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.closedgeneratorexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.closedgeneratorexception.php" hreflang="zh">
...
<meta name="Description" content="The ClosedGeneratorException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ClosedGeneratorException - Manual" />
<meta name="twitter:description" content="The ClosedGeneratorException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ClosedGeneratorException - Manual" />
<meta itemprop="description" content="The ClosedGeneratorException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ClosedGeneratorException class" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.error.php">
          Error &raquo;
              ...
              <div class="prev">
        <a href="errorexception.getseverity.php">
          &laquo; ErrorException::getSeverity        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.closedgeneratorexception.php' selected="selected">English</option>
            <option value='de/class.closedgeneratorexception.php'>German</option>
            <option value='es/class.closedgeneratorexception.php'>Spanish</option>
            <option value='fr/class.closedgeneratorexception.php'>French</option>
            <option value='it/class.closedgeneratorexception.php'>Italian</option>
            <option value='ja/class.closedgeneratorexception.php'>Japanese</option>
            <option value='pt_BR/class.closedgeneratorexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.closedgeneratorexception.php'>Russian</option>
            <option value='tr/class.closedgeneratorexception.php'>Turkish</option>
            <option value='uk/class.closedgeneratorexception.php'>Ukrainian</option>
            <option value='zh/class.closedgeneratorexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.closedgeneratorexception" class="reference">
 <h1 class="title">The ClosedGeneratorException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p>


  <div class="section" id="closedgeneratorexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    A <span class="classname"><strong class="classname">ClosedGeneratorException</strong></span> is thrown when trying
    to retrieve a value from a closed <span class="classname"><a href="class.generator.php" class="classname">Generator</a></span>.
   </p>
  </div>


  <div class="section" id="closedgeneratorexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">ClosedGeneratorException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/closedgeneratorexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.closedgeneratorexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.closedgeneratorexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.closedgeneratorexception.php">＋<small>add a note</small></a></span>
