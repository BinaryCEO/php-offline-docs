...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ocache-meminfo.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ocache-fileinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-refresh-if-changed.php">
...
<meta name="Description" content="Retrieves information about opcode cache memory usage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ocache_meminfo - Manual" />
<meta name="twitter:description" content="Retrieves information about opcode cache memory usage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ocache_meminfo - Manual" />
<meta itemprop="description" content="Retrieves information about opcode cache memory usage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves information about opcode cache memory usage" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ocache-meminfo.php' selected="selected">English</option>
            ...
            <option value='fr/function.wincache-ocache-meminfo.php'>French</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-ocache-meminfo-returnvalues">
  ...
  <p class="para">
   Array of meta data about opcode cache memory usage  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
  <p class="para">
   ...
   <ul class="itemizedlist">
    <li class="listitem">
     <span class="simpara">
      <code class="literal">memory_total</code> - amount of memory in bytes allocated for the opcode cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">memory_free</code> - amount of free memory in bytes available for the opcode cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">num_used_blks</code> - number of memory blocks used by the opcode cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">num_free_blks</code> - number of free memory blocks available for the opcode cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">memory_overhead</code> - amount of memory in bytes used for the opcode cache internal structures
     </span>
    </li>
   </ul>
  </p>
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-ocache-meminfo-examples">
  ...
  <p class="para">
   <div class="example" id="example-740">
    <p><strong>Example #1 A <span class="function"><strong>wincache_ocache_meminfo()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-scache-meminfo.php" class="function" rel="rdfs-seeAlso">wincache_scache_meminfo()</a> - Retrieves information about session cache memory usage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ocache-meminfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ocache-meminfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ocache-meminfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ocache-meminfo.php">＋<small>add a note</small></a></span>
