...
<head>
  ...
  <title>PHP: ibase_set_event_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-set-event-handler.php">
 <link rel="shorturl" href="https://www.php.net/ibase-set-event-handler">
 <link rel="alternate" href="https://www.php.net/ibase-set-event-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-service-detach.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-trans.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-set-event-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-set-event-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-set-event-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-set-event-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-set-event-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-set-event-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-set-event-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-set-event-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-set-event-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-set-event-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-set-event-handler.php" hreflang="zh">
...
<meta name="Description" content="Register a callback function to be called when events are posted" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_set_event_handler - Manual" />
<meta name="twitter:description" content="Register a callback function to be called when events are posted" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_set_event_handler - Manual" />
<meta itemprop="description" content="Register a callback function to be called when events are posted" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register a callback function to be called when events are posted" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-trans.php">
          ibase_trans &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-service-detach.php">
          &laquo; ibase_service_detach        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-set-event-handler.php' selected="selected">English</option>
            <option value='de/function.ibase-set-event-handler.php'>German</option>
            <option value='es/function.ibase-set-event-handler.php'>Spanish</option>
            <option value='fr/function.ibase-set-event-handler.php'>French</option>
            <option value='it/function.ibase-set-event-handler.php'>Italian</option>
            <option value='ja/function.ibase-set-event-handler.php'>Japanese</option>
            <option value='pt_BR/function.ibase-set-event-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-set-event-handler.php'>Russian</option>
            <option value='tr/function.ibase-set-event-handler.php'>Turkish</option>
            <option value='uk/function.ibase-set-event-handler.php'>Ukrainian</option>
            <option value='zh/function.ibase-set-event-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-set-event-handler" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-set-event-handler-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_set_event_handler</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$event_handler</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$event_name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">...$even_names</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>ibase_set_event_handler</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$event_handler</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$event_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">...$event_names</code></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      ...
      <p class="para">
       The callback must return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the event handler should be
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-set-event-handler-returnvalues">
  ...
  <p class="para">
   ...
   the event handler using <span class="function"><a href="function.ibase-free-event-handler.php" class="function">ibase_free_event_handler()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-set-event-handler-examples">
  ...
  <p class="para">
   <div class="example" id="example-1338">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-set-event-handler-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-wait-event.php" class="function" rel="rdfs-seeAlso">ibase_wait_event()</a> - Wait for an event to be posted by the database</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-set-event-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-set-event-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-set-event-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-set-event-handler.php">＋<small>add a note</small></a></span>
