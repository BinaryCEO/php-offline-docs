...
<head>
  ...
  <title>PHP: curl_escape - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-escape.php">
 <link rel="shorturl" href="https://www.php.net/curl-escape">
 <link rel="alternate" href="https://www.php.net/curl-escape" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-exec.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-escape.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-escape.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-escape.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-escape.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-escape.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-escape.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-escape.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-escape.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-escape.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-escape.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-escape.php" hreflang="zh">
...
<meta name="Description" content="URL encodes the given string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_escape - Manual" />
<meta name="twitter:description" content="URL encodes the given string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_escape - Manual" />
<meta itemprop="description" content="URL encodes the given string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="URL encodes the given string" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-escape.php' selected="selected">English</option>
            <option value='de/function.curl-escape.php'>German</option>
            <option value='es/function.curl-escape.php'>Spanish</option>
            <option value='fr/function.curl-escape.php'>French</option>
            <option value='it/function.curl-escape.php'>Italian</option>
            <option value='ja/function.curl-escape.php'>Japanese</option>
            <option value='pt_BR/function.curl-escape.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-escape.php'>Russian</option>
            <option value='tr/function.curl-escape.php'>Turkish</option>
            <option value='uk/function.curl-escape.php'>Ukrainian</option>
            <option value='zh/function.curl-escape.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-escape" class="refentry">
...
<span class="function"><a href="function.curl-init.php" class="function">curl_init()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.curl-escape-returnvalues">
  ...
  <p class="para">
   Returns escaped string or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><a href="https://datatracker.ietf.org/doc/html/rfc3986" class="link external">&raquo;&nbsp;RFC 3986</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-escape.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-escape%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-escape&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-escape.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125042">  <div class="votes">
    <div id="Vu125042">
    <a href="/manual/vote-note.php?id=125042&amp;page=function.curl-escape&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125042">
    <a href="/manual/vote-note.php?id=125042&amp;page=function.curl-escape&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125042" title="63% like this...">
    3
    </div>
  </div>
  <a href="#125042" class="name">
  <strong class="user"><em>sam dot tyurenkov at gmail dot com</em></strong></a><a class="genanchor" href="#125042"> &para;</a><div class="date" title="2020-05-24 12:19"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125042">
<div class="phpcode"><code><span class="html">Please someone add an example for escaping ampersands between parameters. <br /><br />E.g. what is the correct approach for using this URL with curl:<br /><a href="https://example.com/?p1=1&amp;p2=2&amp;p3=3" rel="nofollow" target="_blank">https://example.com/?p1=1&amp;p2=2&amp;p3=3</a><br /><br />This is not obvious, and needs explanation.</span></code></div>
  </div>
 </div>
  <div class="note" id="115896">  <div class="votes">
    <div id="Vu115896">
    <a href="/manual/vote-note.php?id=115896&amp;page=function.curl-escape&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115896">
    <a href="/manual/vote-note.php?id=115896&amp;page=function.curl-escape&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115896" title="55% like this...">
    3
    </div>
  </div>
  <a href="#115896" class="name">
  <strong class="user"><em>Franois</em></strong></a><a class="genanchor" href="#115896"> &para;</a><div class="date" title="2014-10-10 09:45"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115896">
<div class="phpcode"><code><span class="html">This function is strictly equivalent to rawurlencode().<br /><br />Internally it uses curl_easy_escape() from libcurl, whose doc says: "This function converts the given input string to an URL encoded string (…). All input characters that are not a-z, A-Z, 0-9, '-', '.', '_' or '~' are converted to their "URL escaped" version (%NN where NN is a two-digit hexadecimal number)."</span></code></div>
  </div>
 </div>
  <div class="note" id="115818">  <div class="votes">
    <div id="Vu115818">
    <a href="/manual/vote-note.php?id=115818&amp;page=function.curl-escape&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115818">
    <a href="/manual/vote-note.php?id=115818&amp;page=function.curl-escape&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115818" title="47% like this...">
    -3
    </div>
  </div>
  <a href="#115818" class="name">
  <strong class="user"><em>Nico</em></strong></a><a class="genanchor" href="#115818"> &para;</a><div class="date" title="2014-09-29 01:51"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115818">
<div class="phpcode"><code><span class="html">What is difference between this function and urlencode()?</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-escape&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-escape.php">＋<small>add a note</small></a></div>
