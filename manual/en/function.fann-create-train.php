...
<head>
  ...
  <title>PHP: fann_create_train - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-create-train.php">
 <link rel="shorturl" href="https://www.php.net/fann-create-train">
 <link rel="alternate" href="https://www.php.net/fann-create-train" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-create-standard-array.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-train-from-callback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-create-train.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-create-train.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-create-train.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-create-train.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-create-train.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-create-train.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-create-train.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-create-train.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-create-train.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-create-train.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-create-train.php" hreflang="zh">
...
<meta name="Description" content="Creates an empty training data struct" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_create_train - Manual" />
<meta name="twitter:description" content="Creates an empty training data struct" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_create_train - Manual" />
<meta itemprop="description" content="Creates an empty training data struct" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates an empty training data struct" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-create-train-from-callback.php">
          fann_create_train_from_callback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-create-standard-array.php">
          &laquo; fann_create_standard_array        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-create-train.php' selected="selected">English</option>
            <option value='de/function.fann-create-train.php'>German</option>
            <option value='es/function.fann-create-train.php'>Spanish</option>
            <option value='fr/function.fann-create-train.php'>French</option>
            <option value='it/function.fann-create-train.php'>Italian</option>
            <option value='ja/function.fann-create-train.php'>Japanese</option>
            <option value='pt_BR/function.fann-create-train.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-create-train.php'>Russian</option>
            <option value='tr/function.fann-create-train.php'>Turkish</option>
            <option value='uk/function.fann-create-train.php'>Ukrainian</option>
            <option value='zh/function.fann-create-train.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-create-train" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_create_train</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_create_train</span> &mdash; <span class="dc-title">Creates an empty training data struct</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-create-train-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_create_train</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$num_data</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$num_input</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$num_output</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-create-train-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-create-train-returnvalues">
 ...
 <div class="refsect1 notes" id="refsect1-function.fann-create-train-notes">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-create-train-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-save-train.php" class="function" rel="rdfs-seeAlso">fann_save_train()</a> - Save the training structure to a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-create-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-create-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-create-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-train.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123297">  <div class="votes">
    <div id="Vu123297">
    <a href="/manual/vote-note.php?id=123297&amp;page=function.fann-create-train&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123297">
    <a href="/manual/vote-note.php?id=123297&amp;page=function.fann-create-train&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123297" title="100% like this...">
    3
    </div>
  </div>
  <a href="#123297" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#123297"> &para;</a><div class="date" title="2018-11-01 07:13"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123297">
<div class="phpcode"><code><span class="html">The result of fann_create_train() is a "blank" or "empty" training data resource which can be saved to a file using fann_save_train(). <br /><br /><span class="default">&lt;?php<br /><br />$num_data </span><span class="keyword">= </span><span class="default">4</span><span class="keyword">;<br /></span><span class="default">$num_input </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">; <br /></span><span class="default">$num_output </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br /><br /></span><span class="comment">// Create an empty 'template' training resource in memory<br /></span><span class="default">$empty_training_resource </span><span class="keyword">= </span><span class="default">fann_create_train </span><span class="keyword">(</span><span class="default">$num_data </span><span class="keyword">, </span><span class="default">$num_input </span><span class="keyword">, </span><span class="default">$num_output</span><span class="keyword">);<br /><br /></span><span class="comment">// Save template.data<br /></span><span class="default">fann_save_train</span><span class="keyword">(</span><span class="default">$empty_training_resource</span><span class="keyword">, </span><span class="string">'template.data'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />File Saved (template.data):<br />4 2 1<br />0 0 <br />0 <br />0 0 <br />0 <br />0 0 <br />0 <br />0 0 <br />0</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-create-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-train.php">＋<small>add a note</small></a></div>
