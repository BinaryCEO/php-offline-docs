...
<head>
  ...
  <title>PHP: pg_result_memory_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-result-memory-size.php">
 <link rel="shorturl" href="https://www.php.net/pg-result-memory-size">
 <link rel="alternate" href="https://www.php.net/pg-result-memory-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-result-error-field.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-result-seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-result-memory-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-result-memory-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-result-memory-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-result-memory-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-result-memory-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-result-memory-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-result-memory-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-result-memory-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-result-memory-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-result-memory-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-result-memory-size.php" hreflang="zh">
...
<meta name="Description" content="Returns the amount of memory allocated for a query result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_result_memory_size - Manual" />
<meta name="twitter:description" content="Returns the amount of memory allocated for a query result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_result_memory_size - Manual" />
<meta itemprop="description" content="Returns the amount of memory allocated for a query result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the amount of memory allocated for a query result" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-result-seek.php">
          pg_result_seek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-result-error-field.php">
          &laquo; pg_result_error_field        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-result-memory-size.php' selected="selected">English</option>
            <option value='de/function.pg-result-memory-size.php'>German</option>
            <option value='es/function.pg-result-memory-size.php'>Spanish</option>
            <option value='fr/function.pg-result-memory-size.php'>French</option>
            <option value='it/function.pg-result-memory-size.php'>Italian</option>
            <option value='ja/function.pg-result-memory-size.php'>Japanese</option>
            <option value='pt_BR/function.pg-result-memory-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-result-memory-size.php'>Russian</option>
            <option value='tr/function.pg-result-memory-size.php'>Turkish</option>
            <option value='uk/function.pg-result-memory-size.php'>Ukrainian</option>
            <option value='zh/function.pg-result-memory-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-result-memory-size" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_result_memory_size</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">pg_result_memory_size</span> &mdash; <span class="dc-title">Returns the amount of memory allocated for a query result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-result-memory-size-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_result_memory_size</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="simpara">
   Returns the amount of memory, in bytes, allocated to the specified query result
   <span class="classname"><a href="class.pgsql-result.php" class="classname">PgSql\Result</a></span> instance.
   This value is the same amount that would be freed by <span class="function"><a href="function.pg-free-result.php" class="function">pg_free_result()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-result-memory-size-parameters">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-result-memory-size-returnvalues">
...
<div class="examplescode"><pre class="examplescode">int(3288)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-result-memory-size-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.pg-free-result.php" class="function" rel="rdfs-seeAlso">pg_free_result()</a> - Free result memory</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-result-memory-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-result-memory-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-result-memory-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-memory-size.php">＋<small>add a note</small></a></span>
