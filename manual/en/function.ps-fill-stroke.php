...
<head>
  ...
  <title>PHP: ps_fill_stroke - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-fill-stroke.php">
 <link rel="shorturl" href="https://www.php.net/ps-fill-stroke">
 <link rel="alternate" href="https://www.php.net/ps-fill-stroke" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-fill.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-findfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-fill-stroke.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-fill-stroke.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-fill-stroke.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-fill-stroke.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-fill-stroke.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-fill-stroke.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-fill-stroke.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-fill-stroke.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-fill-stroke.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-fill-stroke.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-fill-stroke.php" hreflang="zh">
...
<meta name="Description" content="Fills and strokes the current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_fill_stroke - Manual" />
<meta name="twitter:description" content="Fills and strokes the current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_fill_stroke - Manual" />
<meta itemprop="description" content="Fills and strokes the current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fills and strokes the current path" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-findfont.php">
          ps_findfont &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-fill-stroke.php' selected="selected">English</option>
            <option value='de/function.ps-fill-stroke.php'>German</option>
            <option value='es/function.ps-fill-stroke.php'>Spanish</option>
            <option value='fr/function.ps-fill-stroke.php'>French</option>
            <option value='it/function.ps-fill-stroke.php'>Italian</option>
            <option value='ja/function.ps-fill-stroke.php'>Japanese</option>
            <option value='pt_BR/function.ps-fill-stroke.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-fill-stroke.php'>Russian</option>
            <option value='tr/function.ps-fill-stroke.php'>Turkish</option>
            <option value='uk/function.ps-fill-stroke.php'>Ukrainian</option>
            <option value='zh/function.ps-fill-stroke.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-fill-stroke" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_fill_stroke</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_fill_stroke</span> &mdash; <span class="dc-title">Fills and strokes the current path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-fill-stroke-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_fill_stroke</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Fills and draws the path constructed with previously called drawing
   functions like <span class="function"><a href="function.ps-lineto.php" class="function">ps_lineto()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-fill-stroke-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-fill-stroke-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-fill-stroke-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-fill.php" class="function" rel="rdfs-seeAlso">ps_fill()</a> - Fills the current path</span></li>
    <li><span class="function"><a href="function.ps-stroke.php" class="function" rel="rdfs-seeAlso">ps_stroke()</a> - Draws the current path</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-fill-stroke.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-fill-stroke%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-fill-stroke&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-fill-stroke.php">＋<small>add a note</small></a></span>
