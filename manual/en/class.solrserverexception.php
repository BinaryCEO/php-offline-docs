...
<head>
  ...
  <title>PHP: SolrServerException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrserverexception.php">
 <link rel="shorturl" href="https://www.php.net/solrserverexception">
 <link rel="alternate" href="https://www.php.net/solrserverexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrclientexception.getinternalinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/solrserverexception.getinternalinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.solrserverexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.solrserverexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.solrserverexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.solrserverexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.solrserverexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.solrserverexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.solrserverexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.solrserverexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.solrserverexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.solrserverexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.solrserverexception.php" hreflang="zh">
...
<meta name="Description" content="The SolrServerException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrServerException - Manual" />
<meta name="twitter:description" content="The SolrServerException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrServerException - Manual" />
<meta itemprop="description" content="The SolrServerException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SolrServerException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrserverexception.getinternalinfo.php">
          SolrServerException::getInternalInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrclientexception.getinternalinfo.php">
          &laquo; SolrClientException::getInternalInfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrserverexception.php' selected="selected">English</option>
            <option value='de/class.solrserverexception.php'>German</option>
            <option value='es/class.solrserverexception.php'>Spanish</option>
            <option value='fr/class.solrserverexception.php'>French</option>
            <option value='it/class.solrserverexception.php'>Italian</option>
            <option value='ja/class.solrserverexception.php'>Japanese</option>
            <option value='pt_BR/class.solrserverexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.solrserverexception.php'>Russian</option>
            <option value='tr/class.solrserverexception.php'>Turkish</option>
            <option value='uk/class.solrserverexception.php'>Ukrainian</option>
            <option value='zh/class.solrserverexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.solrserverexception" class="reference">

 <h1 class="title">The SolrServerException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL Solr &gt;= 1.1.0, &gt;=2.0.0)</p>


  <div class="section" id="solrserverexception.intro">
  ...
  <div class="section" id="solrserverexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">SolrServerException</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">protected</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="solrserverexception.getinternalinfo.php" class="methodname">getInternalInfo</a></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="solrserverexception.getinternalinfo.php">SolrServerException::getInternalInfo</a> — Returns internal information where the Exception was thrown</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrserverexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrserverexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrserverexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrserverexception.php">＋<small>add a note</small></a></span>
