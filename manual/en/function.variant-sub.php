...
<head>
  ...
  <title>PHP: variant_sub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-sub.php">
 <link rel="shorturl" href="https://www.php.net/variant-sub">
 <link rel="alternate" href="https://www.php.net/variant-sub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-set-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-xor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-sub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-sub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-sub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-sub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-sub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-sub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-sub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-sub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-sub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-sub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-sub.php" hreflang="zh">
...
<meta name="Description" content="Subtracts the value of the right variant from the left variant value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_sub - Manual" />
<meta name="twitter:description" content="Subtracts the value of the right variant from the left variant value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_sub - Manual" />
<meta itemprop="description" content="Subtracts the value of the right variant from the left variant value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Subtracts the value of the right variant from the left variant value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-xor.php">
          variant_xor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.variant-set-type.php">
          &laquo; variant_set_type        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-sub.php' selected="selected">English</option>
            <option value='de/function.variant-sub.php'>German</option>
            <option value='es/function.variant-sub.php'>Spanish</option>
            <option value='fr/function.variant-sub.php'>French</option>
            <option value='it/function.variant-sub.php'>Italian</option>
            <option value='ja/function.variant-sub.php'>Japanese</option>
            <option value='pt_BR/function.variant-sub.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-sub.php'>Russian</option>
            <option value='tr/function.variant-sub.php'>Turkish</option>
            <option value='uk/function.variant-sub.php'>Ukrainian</option>
            <option value='zh/function.variant-sub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-sub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_sub</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_sub</span> &mdash; <span class="dc-title">Subtracts the value of the right variant from the left variant value</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.variant-sub-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>variant_sub</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$left</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$right</code></span>): <span class="type"><a href="class.variant.php" class="type variant">variant</a></span></div>

  <p class="para rdfs-comment">
   Subtracts <code class="parameter">right</code> from <code class="parameter">left</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.variant-sub-parameters">
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.variant-sub-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <table class="doctable table">
    <caption><strong>Variant Subtraction Rules</strong></caption>
 ...
 <div class="refsect1 errors" id="refsect1-function.variant-sub-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-function.variant-sub-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-add.php" class="function" rel="rdfs-seeAlso">variant_add()</a> - &quot;Adds&quot; two variant values together and returns the result</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-sub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-sub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-sub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-sub.php">＋<small>add a note</small></a></span>
