...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeAlpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setresolution.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokeantialias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokealpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokealpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokealpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokealpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokealpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokealpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokealpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokealpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokealpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokealpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokealpha.php" hreflang="zh">
...
<meta name="Description" content="Specifies the opacity of stroked object outlines" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeAlpha - Manual" />
<meta name="twitter:description" content="Specifies the opacity of stroked object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeAlpha - Manual" />
<meta itemprop="description" content="Specifies the opacity of stroked object outlines" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the opacity of stroked object outlines" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setstrokeantialias.php">
          ImagickDraw::setStrokeAntialias &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setresolution.php">
          &laquo; ImagickDraw::setResolution        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokealpha.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokealpha.php'>German</option>
            <option value='es/imagickdraw.setstrokealpha.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokealpha.php'>French</option>
            <option value='it/imagickdraw.setstrokealpha.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokealpha.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokealpha.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokealpha.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokealpha.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokealpha.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokealpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokealpha" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeAlpha</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeAlpha</span> &mdash; <span class="dc-title">Specifies the opacity of stroked object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokealpha-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeAlpha</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$alpha</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokealpha-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokealpha-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3181">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokealpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokealpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokealpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115768">  <div class="votes">
    <div id="Vu115768">
    <a href="/manual/vote-note.php?id=115768&amp;page=imagickdraw.setstrokealpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115768">
    <a href="/manual/vote-note.php?id=115768&amp;page=imagickdraw.setstrokealpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115768" title="100% like this...">
    1
    </div>
  </div>
  <a href="#115768" class="name">
  <strong class="user"><em>Thomas</em></strong></a><a class="genanchor" href="#115768"> &para;</a><div class="date" title="2014-09-19 12:30"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115768">
<div class="phpcode"><code><span class="html">Must be set after setStrokeColor().<br /><br />Values between 0 (invisible) and 1.</span></code></div>
  </div>
 </div>
  <div class="note" id="123218">  <div class="votes">
    <div id="Vu123218">
    <a href="/manual/vote-note.php?id=123218&amp;page=imagickdraw.setstrokealpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123218">
    <a href="/manual/vote-note.php?id=123218&amp;page=imagickdraw.setstrokealpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123218" title="no votes...">
    0
    </div>
  </div>
  <a href="#123218" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#123218"> &para;</a><div class="date" title="2018-10-09 11:10"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123218">
<div class="phpcode"><code><span class="html">ImagickDraw::setStrokeAlpha method is deprecated and it's use should be avoided<br /><br />not sure since which version this became deprecated.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setstrokealpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokealpha.php">＋<small>add a note</small></a></div>
