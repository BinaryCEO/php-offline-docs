...
<head>
  ...
  <title>PHP: Yaf_Router - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-router.php">
 <link rel="shorturl" href="https://www.php.net/yaf-router">
 <link rel="alternate" href="https://www.php.net/yaf-router" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/yaf-route-rewrite.route.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-router.addconfig.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.yaf-router.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.yaf-router.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.yaf-router.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.yaf-router.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.yaf-router.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.yaf-router.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.yaf-router.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.yaf-router.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.yaf-router.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.yaf-router.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.yaf-router.php" hreflang="zh">
...
<meta name="Description" content="The Yaf_Router class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Router - Manual" />
<meta name="twitter:description" content="The Yaf_Router class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Router - Manual" />
<meta itemprop="description" content="The Yaf_Router class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Router class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="yaf-router.addconfig.php">
          Yaf_Router::addConfig &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="yaf-route-rewrite.route.php">
          &laquo; Yaf_Route_Rewrite::route        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-router.php' selected="selected">English</option>
            <option value='de/class.yaf-router.php'>German</option>
            <option value='es/class.yaf-router.php'>Spanish</option>
            <option value='fr/class.yaf-router.php'>French</option>
            <option value='it/class.yaf-router.php'>Italian</option>
            <option value='ja/class.yaf-router.php'>Japanese</option>
            <option value='pt_BR/class.yaf-router.php'>Brazilian Portuguese</option>
            <option value='ru/class.yaf-router.php'>Russian</option>
            <option value='tr/class.yaf-router.php'>Turkish</option>
            <option value='uk/class.yaf-router.php'>Ukrainian</option>
            <option value='zh/class.yaf-router.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.yaf-router" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>
  ...
  <div class="section" id="yaf-router.intro">
   ...
   <span class="classname"><a href="class.yaf-request-abstract.php" class="classname">Yaf_Request_Abstract</a></span> object which is then processed by
   <span class="classname"><a href="class.yaf-dispatcher.php" class="classname">Yaf_Dispatcher</a></span>. Routing occurs only once: when the request
...
<div class="confcode"><pre class="confcode">server {
  ...
  <div class="section" id="yaf-router.default">
   ...
   <p class="para">
    ...
    <span class="classname"><a href="class.yaf-route-static.php" class="classname">Yaf_Route_Static</a></span>, which will match URIs in the shape of 
   ...
   <div class="example" id="example-4228">
    <p><strong>Example #5 <span class="classname"><a href="class.yaf-route-static.php" class="classname">Yaf_Route_Static</a></span>(default route)example</strong></p>
   <div class="example-contents">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-router.addconfig.php">Yaf_Router::addConfig</a> — Add config-defined routes into Router</li><li><a href="yaf-router.addroute.php">Yaf_Router::addRoute</a> — Add new Route into Router</li><li><a href="yaf-router.construct.php">Yaf_Router::__construct</a> — Yaf_Router constructor</li><li><a href="yaf-router.getcurrentroute.php">Yaf_Router::getCurrentRoute</a> — Get the effective route name</li><li><a href="yaf-router.getroute.php">Yaf_Router::getRoute</a> — Retrieve a route by name</li><li><a href="yaf-router.getroutes.php">Yaf_Router::getRoutes</a> — Retrieve registered routes</li><li><a href="yaf-router.route.php">Yaf_Router::route</a> — The route purpose</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-router.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-router%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-router&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-router.php">＋<small>add a note</small></a></span>
