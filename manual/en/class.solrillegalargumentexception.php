...
<head>
  ...
  <title>PHP: SolrIllegalArgumentException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrillegalargumentexception.php">
 <link rel="shorturl" href="https://www.php.net/solrillegalargumentexception">
 <link rel="alternate" href="https://www.php.net/solrillegalargumentexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrserverexception.getinternalinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/solrillegalargumentexception.getinternalinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.solrillegalargumentexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.solrillegalargumentexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.solrillegalargumentexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.solrillegalargumentexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.solrillegalargumentexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.solrillegalargumentexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.solrillegalargumentexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.solrillegalargumentexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.solrillegalargumentexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.solrillegalargumentexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.solrillegalargumentexception.php" hreflang="zh">
...
<meta name="Description" content="The SolrIllegalArgumentException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrIllegalArgumentException - Manual" />
<meta name="twitter:description" content="The SolrIllegalArgumentException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrIllegalArgumentException - Manual" />
<meta itemprop="description" content="The SolrIllegalArgumentException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SolrIllegalArgumentException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrillegalargumentexception.getinternalinfo.php">
          SolrIllegalArgumentException::getInternalInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrserverexception.getinternalinfo.php">
          &laquo; SolrServerException::getInternalInfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrillegalargumentexception.php' selected="selected">English</option>
            <option value='de/class.solrillegalargumentexception.php'>German</option>
            <option value='es/class.solrillegalargumentexception.php'>Spanish</option>
            <option value='fr/class.solrillegalargumentexception.php'>French</option>
            <option value='it/class.solrillegalargumentexception.php'>Italian</option>
            <option value='ja/class.solrillegalargumentexception.php'>Japanese</option>
            <option value='pt_BR/class.solrillegalargumentexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.solrillegalargumentexception.php'>Russian</option>
            <option value='tr/class.solrillegalargumentexception.php'>Turkish</option>
            <option value='uk/class.solrillegalargumentexception.php'>Ukrainian</option>
            <option value='zh/class.solrillegalargumentexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.solrillegalargumentexception" class="reference">

 <h1 class="title">The SolrIllegalArgumentException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL solr &gt;= 0.9.2)</p>


  <div class="section" id="solrillegalargumentexception.intro">
  ...
  <div class="section" id="solrillegalargumentexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">SolrIllegalArgumentException</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">protected</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="solrillegalargumentexception.getinternalinfo.php" class="methodname">getInternalInfo</a></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="solrillegalargumentexception.getinternalinfo.php">SolrIllegalArgumentException::getInternalInfo</a> — Returns internal information where the Exception was thrown</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrillegalargumentexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrillegalargumentexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrillegalargumentexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrillegalargumentexception.php">＋<small>add a note</small></a></span>
