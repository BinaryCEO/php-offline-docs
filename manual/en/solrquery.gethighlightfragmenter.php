...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightFragmenter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightformatter.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightfragmenter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightfragmenter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightfragmenter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightfragmenter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightfragmenter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightfragmenter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightfragmenter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightfragmenter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightfragmenter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightfragmenter.php" hreflang="zh">
...
<meta name="Description" content="Returns the text snippet generator for highlighted text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightFragmenter - Manual" />
<meta name="twitter:description" content="Returns the text snippet generator for highlighted text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightFragmenter - Manual" />
<meta itemprop="description" content="Returns the text snippet generator for highlighted text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the text snippet generator for highlighted text" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightfragsize.php">
          SolrQuery::getHighlightFragsize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightformatter.php">
          &laquo; SolrQuery::getHighlightFormatter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightfragmenter.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightfragmenter.php'>German</option>
            <option value='es/solrquery.gethighlightfragmenter.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightfragmenter.php'>French</option>
            <option value='it/solrquery.gethighlightfragmenter.php'>Italian</option>
            <option value='ja/solrquery.gethighlightfragmenter.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightfragmenter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightfragmenter.php'>Russian</option>
            <option value='tr/solrquery.gethighlightfragmenter.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightfragmenter.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightfragmenter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightfragmenter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightFragmenter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightFragmenter</span> &mdash; <span class="dc-title">Returns the text snippet generator for highlighted text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightfragmenter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightFragmenter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightfragmenter-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightfragmenter-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightfragmenter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightfragmenter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightfragmenter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightfragmenter.php">＋<small>add a note</small></a></span>
