...
<head>
  ...
  <title>PHP: wincache_scache_meminfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-scache-meminfo.php">
 <link rel="shorturl" href="https://www.php.net/wincache-scache-meminfo">
 <link rel="alternate" href="https://www.php.net/wincache-scache-meminfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-scache-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-scache-meminfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-scache-meminfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-scache-meminfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-scache-meminfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-scache-meminfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-scache-meminfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-scache-meminfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-scache-meminfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-scache-meminfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-scache-meminfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-scache-meminfo.php" hreflang="zh">
...
<meta name="Description" content="Retrieves information about session cache memory usage" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_scache_meminfo - Manual" />
<meta name="twitter:description" content="Retrieves information about session cache memory usage" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_scache_meminfo - Manual" />
<meta itemprop="description" content="Retrieves information about session cache memory usage" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves information about session cache memory usage" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.wincache-ucache-add.php">
          wincache_ucache_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-scache-info.php">
          &laquo; wincache_scache_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-scache-meminfo.php' selected="selected">English</option>
            <option value='de/function.wincache-scache-meminfo.php'>German</option>
            <option value='es/function.wincache-scache-meminfo.php'>Spanish</option>
            <option value='fr/function.wincache-scache-meminfo.php'>French</option>
            <option value='it/function.wincache-scache-meminfo.php'>Italian</option>
            <option value='ja/function.wincache-scache-meminfo.php'>Japanese</option>
            <option value='pt_BR/function.wincache-scache-meminfo.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-scache-meminfo.php'>Russian</option>
            <option value='tr/function.wincache-scache-meminfo.php'>Turkish</option>
            <option value='uk/function.wincache-scache-meminfo.php'>Ukrainian</option>
            <option value='zh/function.wincache-scache-meminfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-scache-meminfo" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-scache-meminfo-returnvalues">
  ...
  <p class="para">
   Array of meta data about session cache memory usage  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
  <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-scache-info.php" class="function" rel="rdfs-seeAlso">wincache_scache_info()</a> - Retrieves information about files cached in the session cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-scache-meminfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-scache-meminfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-scache-meminfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-scache-meminfo.php">＋<small>add a note</small></a></span>
