...
<head>
  ...
  <title>PHP: Imagick::addImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.addimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.addimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.addimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.addnoiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.addimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.addimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.addimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.addimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.addimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.addimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.addimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.addimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.addimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.addimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.addimage.php" hreflang="zh">
...
<meta name="Description" content="Adds new image to Imagick object image list" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::addImage - Manual" />
<meta name="twitter:description" content="Adds new image to Imagick object image list" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::addImage - Manual" />
<meta itemprop="description" content="Adds new image to Imagick object image list" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds new image to Imagick object image list" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.addnoiseimage.php">
          Imagick::addNoiseImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.adaptivethresholdimage.php">
          &laquo; Imagick::adaptiveThresholdImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.addimage.php' selected="selected">English</option>
            <option value='de/imagick.addimage.php'>German</option>
            <option value='es/imagick.addimage.php'>Spanish</option>
            <option value='fr/imagick.addimage.php'>French</option>
            <option value='it/imagick.addimage.php'>Italian</option>
            <option value='ja/imagick.addimage.php'>Japanese</option>
            <option value='pt_BR/imagick.addimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.addimage.php'>Russian</option>
            <option value='tr/imagick.addimage.php'>Turkish</option>
            <option value='uk/imagick.addimage.php'>Ukrainian</option>
            <option value='zh/imagick.addimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.addimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::addImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::addImage</span> &mdash; <span class="dc-title">Adds new image to Imagick object image list</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.addimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::addImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$source</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.addimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.addimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.addimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/addimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.addimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.addimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.addimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106708">  <div class="votes">
    <div id="Vu106708">
    <a href="/manual/vote-note.php?id=106708&amp;page=imagick.addimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106708">
    <a href="/manual/vote-note.php?id=106708&amp;page=imagick.addimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106708" title="56% like this...">
    3
    </div>
  </div>
  <a href="#106708" class="name">
  <strong class="user"><em>bernie at dakotanetwork dot com</em></strong></a><a class="genanchor" href="#106708"> &para;</a><div class="date" title="2011-11-29 03:42"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106708">
<div class="phpcode"><code><span class="html">create a favicon.ico with multiple resolutions<br /><br /><span class="default">&lt;?php <br /><br />$src_img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"src_img.png"</span><span class="keyword">);<br /></span><span class="default">$icon </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">setFormat</span><span class="keyword">(</span><span class="string">"ico"</span><span class="keyword">);<br /><br /></span><span class="default">$geo</span><span class="keyword">=</span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();<br /><br /></span><span class="default">$size_w</span><span class="keyword">=</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">];<br /></span><span class="default">$size_h</span><span class="keyword">=</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">]; <br /><br />if (</span><span class="default">128</span><span class="keyword">/</span><span class="default">$size_w</span><span class="keyword">*</span><span class="default">$size_h</span><span class="keyword">&gt;</span><span class="default">128</span><span class="keyword">) {<br />  </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">128</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);<br />} else {<br />  </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">128</span><span class="keyword">); <br />} <br /><br /></span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">cropImage</span><span class="keyword">(</span><span class="default">128</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="default">$clone </span><span class="keyword">= </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br /></span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">16</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);            <br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$clone</span><span class="keyword">);<br /><br /></span><span class="default">$clone </span><span class="keyword">= </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br /></span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">32</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);            <br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$clone</span><span class="keyword">);<br /><br /></span><span class="default">$clone </span><span class="keyword">= </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br /></span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">64</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);            <br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$clone</span><span class="keyword">);<br /><br /></span><span class="default">$clone </span><span class="keyword">= </span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br /></span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">128</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);    <br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$clone</span><span class="keyword">);<br /><br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">"favicon.ico"</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="default">$src_img</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">(); <br /></span><span class="default">$icon</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">(); <br /></span><span class="default">$clone</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">(); <br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.addimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.addimage.php">＋<small>add a note</small></a></div>
