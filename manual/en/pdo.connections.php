...
<head>
  ...
  <title>PHP: Connections and Connection management - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdo.connections.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdo.connections.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdo.connections.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.pdo.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdo.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo.transactions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pdo.connections.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/pdo.connections.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/pdo.connections.php" hreflang="uk">
...
<meta name="Description" content="Connections and Connection management" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Connections and Connection management - Manual" />
<meta name="twitter:description" content="Connections and Connection management" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Connections and Connection management - Manual" />
<meta itemprop="description" content="Connections and Connection management" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Connections and Connection management" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdo.transactions.php">
          Transactions and auto-commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdo.constants.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdo.connections.php' selected="selected">English</option>
            <option value='de/pdo.connections.php'>German</option>
            <option value='es/pdo.connections.php'>Spanish</option>
            <option value='fr/pdo.connections.php'>French</option>
            <option value='it/pdo.connections.php'>Italian</option>
            <option value='ja/pdo.connections.php'>Japanese</option>
            <option value='pt_BR/pdo.connections.php'>Brazilian Portuguese</option>
            <option value='ru/pdo.connections.php'>Russian</option>
            <option value='tr/pdo.connections.php'>Turkish</option>
            <option value='uk/pdo.connections.php'>Ukrainian</option>
            <option value='zh/pdo.connections.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pdo.connections" class="chapter">
 ...
 <p class="para">
  <div class="example" id="example-1111">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$dbh </span><span style="color: #007700">= new </span><span style="color: #0000BB">PDO</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysql:host=localhost;dbname=test'</span><span style="color: #007700">, </span><span style="color: #0000BB">$user</span><span style="color: #007700">, </span><span style="color: #0000BB">$pass</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div> 
 ...
 <p class="para">
  <div class="example" id="example-1112"><p><strong>Example #2 Handling connection errors</strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$dbh </span><span style="color: #007700">= new </span><span style="color: #0000BB">PDO</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysql:host=localhost;dbname=test'</span><span style="color: #007700">, </span><span style="color: #0000BB">$user</span><span style="color: #007700">, </span><span style="color: #0000BB">$pass</span><span style="color: #007700">);<br />} catch (</span><span style="color: #0000BB">PDOException $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// attempt to retry the connection after some timeout for example<br /></span><span style="color: #007700">}</span></span></code></div>
 ...
 <div class="warning"><strong class="warning">Warning</strong>
  <p class="para">
   Just like any other <a href="language.exceptions.php" class="link">exception</a>,
   <span class="classname"><a href="class.pdoexception.php" class="classname">PDOException</a></span> could be caught either explicitly, via
   a <a href="language.exceptions.php#language.exceptions.catch" class="link"><code class="literal">catch</code></a> statement, or implicitly via <span class="function"><a href="function.set-exception-handler.php" class="function">set_exception_handler()</a></span>.
 ...
 <p class="para">
  ...
  deleted—you do this by assigning <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to the variable that holds the
 ...
 <blockquote class="note"><p><strong class="note">Note</strong>: 
  <span class="simpara">
   ...
   instance), these have to be removed also (for instance, by assigning <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$dbh </span><span style="color: #007700">= new </span><span style="color: #0000BB">PDO</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysql:host=localhost;dbname=test'</span><span style="color: #007700">, </span><span style="color: #0000BB">$user</span><span style="color: #007700">, </span><span style="color: #0000BB">$pass</span><span style="color: #007700">, array(<br />    </span><span style="color: #0000BB">PDO</span><span style="color: #007700">::</span><span style="color: #0000BB">ATTR_PERSISTENT </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">true<br /></span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <p class="para">
  The value of the <strong><code><a href="pdo.constants.php#pdo.constants.attr-persistent">PDO::ATTR_PERSISTENT</a></code></strong> option is converted
  to <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> (enable/disable persistent connections), unless it is a non-numeric
  <span class="type"><a href="language.types.string.php" class="type string">string</a></span>, in which case it allows to use multiple persistent connection pools.
  This is useful if different connections use incompatible settings, for instance,
  different values of <strong><code><a href="ref.pdo-mysql.php#pdo.constants.mysql-attr-use-buffered-query">PDO::MYSQL_ATTR_USE_BUFFERED_QUERY</a></code></strong>.
 </p>
 <blockquote class="note"><p><strong class="note">Note</strong>: 
  <p class="para">
   If you wish to use persistent connections, you must set
   <strong><code><a href="pdo.constants.php#pdo.constants.attr-persistent">PDO::ATTR_PERSISTENT</a></code></strong> in the array of driver options
   passed to the PDO constructor. If setting this attribute with
   <span class="methodname"><a href="pdo.setattribute.php" class="methodname">PDO::setAttribute()</a></span> after instantiation of the
   ...
   modules.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/connections.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdo.connections%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdo.connections&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdo.connections.php">＋<small>add a note</small></a></span>
