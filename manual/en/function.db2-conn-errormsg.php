...
<head>
  ...
  <title>PHP: db2_conn_errormsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-conn-errormsg.php">
 <link rel="shorturl" href="https://www.php.net/db2-conn-errormsg">
 <link rel="alternate" href="https://www.php.net/db2-conn-errormsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-conn-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-conn-errormsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-conn-errormsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-conn-errormsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-conn-errormsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-conn-errormsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-conn-errormsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-conn-errormsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-conn-errormsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-conn-errormsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-conn-errormsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-conn-errormsg.php" hreflang="zh">
...
<meta name="Description" content="Returns the last connection error message and SQLCODE value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_conn_errormsg - Manual" />
<meta name="twitter:description" content="Returns the last connection error message and SQLCODE value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_conn_errormsg - Manual" />
<meta itemprop="description" content="Returns the last connection error message and SQLCODE value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last connection error message and SQLCODE value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-connect.php">
          db2_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-conn-error.php">
          &laquo; db2_conn_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-conn-errormsg.php' selected="selected">English</option>
            <option value='de/function.db2-conn-errormsg.php'>German</option>
            <option value='es/function.db2-conn-errormsg.php'>Spanish</option>
            <option value='fr/function.db2-conn-errormsg.php'>French</option>
            <option value='it/function.db2-conn-errormsg.php'>Italian</option>
            <option value='ja/function.db2-conn-errormsg.php'>Japanese</option>
            <option value='pt_BR/function.db2-conn-errormsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-conn-errormsg.php'>Russian</option>
            <option value='tr/function.db2-conn-errormsg.php'>Turkish</option>
            <option value='uk/function.db2-conn-errormsg.php'>Ukrainian</option>
            <option value='zh/function.db2-conn-errormsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-conn-errormsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_conn_errormsg</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_conn_errormsg</span> &mdash; <span class="dc-title">
   Returns the last connection error message and SQLCODE value
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-conn-errormsg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_conn_errormsg</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>


  <p class="para rdfs-comment">
   <span class="function"><strong>db2_conn_errormsg()</strong></span> returns an error message and SQLCODE
   value representing the reason the last database connection attempt failed.
   As <span class="function"><a href="function.db2-connect.php" class="function">db2_connect()</a></span> returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> in the event of a failed
   connection attempt, do not pass any parameters to
   <span class="function"><strong>db2_conn_errormsg()</strong></span> to retrieve the associated error
   message and SQLCODE value.
  </p>
  <p class="para">
   If, however, the connection was successful but becomes invalid over time,
   you can pass the <code class="parameter">connection</code> parameter to retrieve
   the associated error message and SQLCODE value for a specific connection.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.db2-conn-errormsg-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-conn-errormsg-returnvalues">
  ...
  <p class="para">
   ...
   connection attempt, <span class="function"><strong>db2_conn_errormsg()</strong></span> returns an empty
   string.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.db2-conn-errormsg-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1347">
    <p><strong>Example #1 Retrieving the error message returned by a failed connection attempt</strong></p>
    <div class="example-contents"><p>
     ...
     <span class="function"><a href="function.db2-connect.php" class="function">db2_connect()</a></span>.
    </p></div>
...
<div class="examplescode"><pre class="examplescode">[IBM][CLI Driver] SQL1013N  The database alias name
or database name &quot;BADNAME&quot; could not be found.  SQLSTATE=42705
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-conn-errormsg-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-stmt-errormsg.php" class="function" rel="rdfs-seeAlso">db2_stmt_errormsg()</a> - Returns a string containing the last SQL statement error message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-conn-errormsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-conn-errormsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-conn-errormsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-conn-errormsg.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96237">  <div class="votes">
    <div id="Vu96237">
    <a href="/manual/vote-note.php?id=96237&amp;page=function.db2-conn-errormsg&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96237">
    <a href="/manual/vote-note.php?id=96237&amp;page=function.db2-conn-errormsg&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96237" title="no votes...">
    0
    </div>
  </div>
  <a href="#96237" class="name">
  <strong class="user"><em>nnd100216ibmdb2 at smallcue dot com</em></strong></a><a class="genanchor" href="#96237"> &para;</a><div class="date" title="2010-02-16 07:25"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96237">
<div class="phpcode"><code><span class="html">A word of warning:<br /><br />It appears that if you specify an invalid ibm_db2.instance_name  in your php.ini file, your cataloged db2_connect() will fail with a returned value of false and when you use db2_conn_error() or db2_conn_errormsg() to check on the reason, those functions will return an empty string.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-conn-errormsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-conn-errormsg.php">＋<small>add a note</small></a></div>
