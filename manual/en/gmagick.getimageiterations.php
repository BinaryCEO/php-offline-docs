...
<head>
  ...
  <title>PHP: Gmagick::getimageiterations - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageiterations.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageiterations.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageiterations.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageinterlacescheme.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagematte.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageiterations.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageiterations.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageiterations.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageiterations.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageiterations.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageiterations.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageiterations.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageiterations.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageiterations.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageiterations.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageiterations.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageiterations - Manual" />
<meta name="twitter:description" content="Gets the image iterations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageiterations - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagematte.php">
          Gmagick::getimagematte &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageinterlacescheme.php">
          &laquo; Gmagick::getimageinterlacescheme        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageiterations.php' selected="selected">English</option>
            <option value='de/gmagick.getimageiterations.php'>German</option>
            <option value='es/gmagick.getimageiterations.php'>Spanish</option>
            <option value='fr/gmagick.getimageiterations.php'>French</option>
            <option value='it/gmagick.getimageiterations.php'>Italian</option>
            <option value='ja/gmagick.getimageiterations.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageiterations.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageiterations.php'>Russian</option>
            <option value='tr/gmagick.getimageiterations.php'>Turkish</option>
            <option value='uk/gmagick.getimageiterations.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageiterations.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageiterations" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageiterations</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageiterations</span> &mdash; <span class="dc-title">Gets the image iterations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageiterations-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageiterations</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageiterations-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageiterations-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageiterations-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageiterations.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageiterations%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageiterations&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageiterations.php">＋<small>add a note</small></a></span>
