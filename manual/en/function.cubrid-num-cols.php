...
<head>
  ...
  <title>PHP: cubrid_num_cols - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-num-cols.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-num-cols">
 <link rel="alternate" href="https://www.php.net/cubrid-num-cols" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-next-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-num-cols.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-num-cols.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-num-cols.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-num-cols.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-num-cols.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-num-cols.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-num-cols.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-num-cols.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-num-cols.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-num-cols.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-num-cols.php" hreflang="zh">
...
<meta name="Description" content="Return the number of columns in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_num_cols - Manual" />
<meta name="twitter:description" content="Return the number of columns in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_num_cols - Manual" />
<meta itemprop="description" content="Return the number of columns in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the number of columns in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-num-rows.php">
          cubrid_num_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-next-result.php">
          &laquo; cubrid_next_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-num-cols.php' selected="selected">English</option>
            <option value='de/function.cubrid-num-cols.php'>German</option>
            <option value='es/function.cubrid-num-cols.php'>Spanish</option>
            <option value='fr/function.cubrid-num-cols.php'>French</option>
            <option value='it/function.cubrid-num-cols.php'>Italian</option>
            <option value='ja/function.cubrid-num-cols.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-num-cols.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-num-cols.php'>Russian</option>
            <option value='tr/function.cubrid-num-cols.php'>Turkish</option>
            <option value='uk/function.cubrid-num-cols.php'>Ukrainian</option>
            <option value='zh/function.cubrid-num-cols.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-num-cols" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_num_cols</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_num_cols</span> &mdash; <span class="dc-title">Return the number of columns in the result set</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-num-cols-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_num_cols</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_num_cols()</strong></span> function is used to get the
    number of columns from the query result. It can only be used when the
    query executed is a <code class="literal">SELECT</code> statement.
  </p>
</div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-num-cols-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
  <dl>
    
  <dt><code class="parameter">result</code></dt>
  <dd><p class="para">Result.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-num-cols-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    Number of columns, when process is successful.
  </p>
  <p class="para">
    <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, if SQL statement is not SELECT.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.cubrid-num-cols-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1264">
   <p><strong>Example #1 <span class="function"><strong>cubrid_num_cols()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Row Num: 6
Column Num: 2</pre>
</div>
   </div>
  </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-num-cols-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-num-rows.php" class="function" rel="rdfs-seeAlso">cubrid_num_rows()</a> - Get the number of rows in the result set</span></li>  
   </ul>
  </p>
  </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-num-cols.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-num-cols%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-num-cols&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-num-cols.php">＋<small>add a note</small></a></span>
