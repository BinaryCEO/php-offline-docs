...
<head>
  ...
  <title>PHP: ReflectionClass::getExtensionName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getextensionname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getextensionname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getextensionname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getextension.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getfilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getextensionname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getextensionname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getextensionname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getextensionname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getextensionname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getextensionname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getextensionname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getextensionname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getextensionname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getextensionname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getextensionname.php" hreflang="zh">
...
<meta name="Description" content="Gets the name of the extension which defined the class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getExtensionName - Manual" />
<meta name="twitter:description" content="Gets the name of the extension which defined the class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getExtensionName - Manual" />
<meta itemprop="description" content="Gets the name of the extension which defined the class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the name of the extension which defined the class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getfilename.php">
          ReflectionClass::getFileName &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getextension.php">
          &laquo; ReflectionClass::getExtension        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getextensionname.php' selected="selected">English</option>
            <option value='de/reflectionclass.getextensionname.php'>German</option>
            <option value='es/reflectionclass.getextensionname.php'>Spanish</option>
            <option value='fr/reflectionclass.getextensionname.php'>French</option>
            <option value='it/reflectionclass.getextensionname.php'>Italian</option>
            <option value='ja/reflectionclass.getextensionname.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getextensionname.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getextensionname.php'>Russian</option>
            <option value='tr/reflectionclass.getextensionname.php'>Turkish</option>
            <option value='uk/reflectionclass.getextensionname.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getextensionname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getextensionname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getExtensionName</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getExtensionName</span> &mdash; <span class="dc-title">Gets the name of the extension which defined the class</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.getextensionname-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getExtensionName</strong></span>(): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.getextensionname-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getextensionname-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The name of the extension which defined the class, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for user-defined classes.
  </p>
 </div>

 
 <div class="refsect1 examples" id="refsect1-reflectionclass.getextensionname-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5478">
    <p><strong>Example #1 Basic usage of <span class="methodname"><strong>ReflectionClass::getExtensionName()</strong></span></strong></p>
...
<div class="annotation-interactive examplescode"><pre class="examplescode">string(10) &quot;Reflection&quot;</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getextensionname-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getextension.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getExtension()</a> - Gets a ReflectionExtension object for the extension which defined the class</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getextensionname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getextensionname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getextensionname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getextensionname.php">＋<small>add a note</small></a></span>
