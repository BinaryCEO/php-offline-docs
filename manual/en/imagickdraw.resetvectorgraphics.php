...
<head>
  ...
  <title>PHP: ImagickDraw::resetVectorGraphics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.render.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.rotate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.resetvectorgraphics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.resetvectorgraphics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.resetvectorgraphics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.resetvectorgraphics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.resetvectorgraphics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.resetvectorgraphics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.resetvectorgraphics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.resetvectorgraphics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.resetvectorgraphics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.resetvectorgraphics.php" hreflang="zh">
...
<meta name="Description" content="Resets the vector graphics" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::resetVectorGraphics - Manual" />
<meta name="twitter:description" content="Resets the vector graphics" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::resetVectorGraphics - Manual" />
<meta itemprop="description" content="Resets the vector graphics" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resets the vector graphics" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.rotate.php">
          ImagickDraw::rotate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.render.php">
          &laquo; ImagickDraw::render        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.resetvectorgraphics.php' selected="selected">English</option>
            <option value='de/imagickdraw.resetvectorgraphics.php'>German</option>
            <option value='es/imagickdraw.resetvectorgraphics.php'>Spanish</option>
            <option value='fr/imagickdraw.resetvectorgraphics.php'>French</option>
            <option value='it/imagickdraw.resetvectorgraphics.php'>Italian</option>
            <option value='ja/imagickdraw.resetvectorgraphics.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.resetvectorgraphics.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.resetvectorgraphics.php'>Russian</option>
            <option value='tr/imagickdraw.resetvectorgraphics.php'>Turkish</option>
            <option value='uk/imagickdraw.resetvectorgraphics.php'>Ukrainian</option>
            <option value='zh/imagickdraw.resetvectorgraphics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.resetvectorgraphics" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::resetVectorGraphics</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::resetVectorGraphics</span> &mdash; <span class="dc-title">Resets the vector graphics</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.resetvectorgraphics-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::resetVectorGraphics</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.resetvectorgraphics-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.resetvectorgraphics-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/resetvectorgraphics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.resetvectorgraphics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.resetvectorgraphics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php">＋<small>add a note</small></a></span>
