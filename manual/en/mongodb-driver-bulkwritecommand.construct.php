...
<head>
  ...
  <title>PHP: MongoDB\Driver\BulkWriteCommand::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwritecommand.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-bulkwritecommand.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-bulkwritecommand.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-bulkwritecommand.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-bulkwritecommand.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-bulkwritecommand.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-bulkwritecommand.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-bulkwritecommand.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-bulkwritecommand.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-bulkwritecommand.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-bulkwritecommand.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-bulkwritecommand.construct.php" hreflang="zh">
...
<meta name="Description" content="Create a new BulkWriteCommand" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\BulkWriteCommand::__construct - Manual" />
<meta name="twitter:description" content="Create a new BulkWriteCommand" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\BulkWriteCommand::__construct - Manual" />
<meta itemprop="description" content="Create a new BulkWriteCommand" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new BulkWriteCommand" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-bulkwritecommand.count.php">
          MongoDB\Driver\BulkWriteCommand::count &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mongodb-driver-bulkwritecommand.php">
          &laquo; MongoDB\Driver\BulkWriteCommand        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-bulkwritecommand.construct.php' selected="selected">English</option>
            <option value='de/mongodb-driver-bulkwritecommand.construct.php'>German</option>
            <option value='es/mongodb-driver-bulkwritecommand.construct.php'>Spanish</option>
            <option value='fr/mongodb-driver-bulkwritecommand.construct.php'>French</option>
            <option value='it/mongodb-driver-bulkwritecommand.construct.php'>Italian</option>
            <option value='ja/mongodb-driver-bulkwritecommand.construct.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-bulkwritecommand.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-bulkwritecommand.construct.php'>Russian</option>
            <option value='tr/mongodb-driver-bulkwritecommand.construct.php'>Turkish</option>
            <option value='uk/mongodb-driver-bulkwritecommand.construct.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-bulkwritecommand.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-bulkwritecommand.construct" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-bulkwritecommand.construct-description">
  ...
  <p class="para rdfs-comment">
   Constructs a new <span class="classname"><a href="class.mongodb-driver-bulkwritecommand.php" class="classname">MongoDB\Driver\BulkWriteCommand</a></span>,
   ...
   <span class="classname"><a href="class.mongodb-driver-bulkwrite.php" class="classname">MongoDB\Driver\BulkWrite</a></span>, which is supported by all
         ...
         <tr>
          ...
          <td>
           <p class="para">
            ...
            the order in which they were specified. If <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, writes will
            continue to be executed if an individual write fails. If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>,
         ...
         <tr>
          ...
          <td>
           <p class="para">
            ...
            <span class="classname"><a href="class.mongodb-driver-bulkwritecommandresult.php" class="classname">MongoDB\Driver\BulkWriteCommandResult</a></span>.
           </p>
          </td>
          <td><strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></td>
         </tr>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.mongodb-driver-bulkwritecommandresult.php" class="classname">MongoDB\Driver\BulkWriteCommandResult</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/bulkwritecommand/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-bulkwritecommand.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-bulkwritecommand.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-bulkwritecommand.construct.php">＋<small>add a note</small></a></span>
