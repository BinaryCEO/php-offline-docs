...
<head>
  ...
  <title>PHP: eio_set_max_poll_reqs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-set-max-poll-reqs.php">
 <link rel="shorturl" href="https://www.php.net/eio-set-max-poll-reqs">
 <link rel="alternate" href="https://www.php.net/eio-set-max-poll-reqs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-set-max-parallel.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-set-max-poll-time.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-set-max-poll-reqs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-set-max-poll-reqs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-set-max-poll-reqs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-set-max-poll-reqs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-set-max-poll-reqs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-set-max-poll-reqs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-set-max-poll-reqs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-set-max-poll-reqs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-set-max-poll-reqs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-set-max-poll-reqs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-set-max-poll-reqs.php" hreflang="zh">
...
<meta name="Description" content="Set maximum number of requests processed in a poll" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_set_max_poll_reqs - Manual" />
<meta name="twitter:description" content="Set maximum number of requests processed in a poll" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_set_max_poll_reqs - Manual" />
<meta itemprop="description" content="Set maximum number of requests processed in a poll" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set maximum number of requests processed in a poll" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-set-max-poll-time.php">
          eio_set_max_poll_time &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-set-max-parallel.php">
          &laquo; eio_set_max_parallel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-set-max-poll-reqs.php' selected="selected">English</option>
            <option value='de/function.eio-set-max-poll-reqs.php'>German</option>
            <option value='es/function.eio-set-max-poll-reqs.php'>Spanish</option>
            <option value='fr/function.eio-set-max-poll-reqs.php'>French</option>
            <option value='it/function.eio-set-max-poll-reqs.php'>Italian</option>
            <option value='ja/function.eio-set-max-poll-reqs.php'>Japanese</option>
            <option value='pt_BR/function.eio-set-max-poll-reqs.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-set-max-poll-reqs.php'>Russian</option>
            <option value='tr/function.eio-set-max-poll-reqs.php'>Turkish</option>
            <option value='uk/function.eio-set-max-poll-reqs.php'>Ukrainian</option>
            <option value='zh/function.eio-set-max-poll-reqs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-set-max-poll-reqs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_set_max_poll_reqs</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_set_max_poll_reqs</span> &mdash; <span class="dc-title">Set maximum number of requests processed in a poll</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-set-max-poll-reqs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_set_max_poll_reqs</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$nreqs</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-set-max-poll-reqs-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">nreqs</code></dt>
    <dd>
     <p class="para">
     Number of requests
     </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-set-max-poll-reqs-returnvalues">
  ...
  No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-set-max-poll-reqs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-set-max-poll-reqs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-set-max-poll-reqs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-set-max-poll-reqs.php">＋<small>add a note</small></a></span>
