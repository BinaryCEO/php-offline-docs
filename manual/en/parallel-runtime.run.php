...
<head>
  ...
  <title>PHP: parallel\Runtime::run - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/parallel-runtime.run.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/parallel-runtime.run.php">
 <link rel="alternate" href="https://www.php.net/manual/en/parallel-runtime.run.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.parallel-runtime.php">
 <link rel="prev" href="https://www.php.net/manual/en/parallel-runtime.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/parallel-runtime.close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/parallel-runtime.run.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/parallel-runtime.run.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/parallel-runtime.run.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/parallel-runtime.run.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/parallel-runtime.run.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/parallel-runtime.run.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/parallel-runtime.run.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/parallel-runtime.run.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/parallel-runtime.run.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/parallel-runtime.run.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/parallel-runtime.run.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: parallel\Runtime::run - Manual" />
<meta name="twitter:description" content="Execution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: parallel\Runtime::run - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="parallel-runtime.close.php">
          parallel\Runtime::close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="parallel-runtime.construct.php">
          &laquo; parallel\Runtime::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/parallel-runtime.run.php' selected="selected">English</option>
            <option value='de/parallel-runtime.run.php'>German</option>
            <option value='es/parallel-runtime.run.php'>Spanish</option>
            <option value='fr/parallel-runtime.run.php'>French</option>
            <option value='it/parallel-runtime.run.php'>Italian</option>
            <option value='ja/parallel-runtime.run.php'>Japanese</option>
            <option value='pt_BR/parallel-runtime.run.php'>Brazilian Portuguese</option>
            <option value='ru/parallel-runtime.run.php'>Russian</option>
            <option value='tr/parallel-runtime.run.php'>Turkish</option>
            <option value='uk/parallel-runtime.run.php'>Ukrainian</option>
            <option value='zh/parallel-runtime.run.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="parallel-runtime.run" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">parallel\Runtime::run</h1>
  <p class="verinfo">(0.8.0)</p><p class="refpurpose"><span class="refname">parallel\Runtime::run</span> &mdash; <span class="dc-title">Execution</span></p>
   ...
   <p class="para">
    Shall throw <span class="type">parallel\Runtime\Error\IllegalReturn</span> if <code class="parameter">task</code> returns illegally.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parallel/parallel/runtime/run.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fparallel-runtime.run%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=parallel-runtime.run&amp;repo=en&amp;redirect=https://www.php.net/manual/en/parallel-runtime.run.php">＋<small>add a note</small></a></span>
