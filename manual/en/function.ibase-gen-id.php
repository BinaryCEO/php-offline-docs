...
<head>
  ...
  <title>PHP: ibase_gen_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-gen-id.php">
 <link rel="shorturl" href="https://www.php.net/ibase-gen-id">
 <link rel="alternate" href="https://www.php.net/ibase-gen-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-free-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-maintain-db.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-gen-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-gen-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-gen-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-gen-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-gen-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-gen-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-gen-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-gen-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-gen-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-gen-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-gen-id.php" hreflang="zh">
...
<meta name="Description" content="Increments the named generator and returns its new value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_gen_id - Manual" />
<meta name="twitter:description" content="Increments the named generator and returns its new value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_gen_id - Manual" />
<meta itemprop="description" content="Increments the named generator and returns its new value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Increments the named generator and returns its new value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-maintain-db.php">
          ibase_maintain_db &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-free-result.php">
          &laquo; ibase_free_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-gen-id.php' selected="selected">English</option>
            <option value='de/function.ibase-gen-id.php'>German</option>
            <option value='es/function.ibase-gen-id.php'>Spanish</option>
            <option value='fr/function.ibase-gen-id.php'>French</option>
            <option value='it/function.ibase-gen-id.php'>Italian</option>
            <option value='ja/function.ibase-gen-id.php'>Japanese</option>
            <option value='pt_BR/function.ibase-gen-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-gen-id.php'>Russian</option>
            <option value='tr/function.ibase-gen-id.php'>Turkish</option>
            <option value='uk/function.ibase-gen-id.php'>Ukrainian</option>
            <option value='zh/function.ibase-gen-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-gen-id" class="refentry">
  ...
  <p class="para">
   Returns new generator value as integer, or as string if the value is too big.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-gen-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-gen-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-gen-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-gen-id.php">＋<small>add a note</small></a></span>
