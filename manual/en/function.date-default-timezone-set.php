...
<head>
  ...
  <title>PHP: date_default_timezone_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-default-timezone-set.php">
 <link rel="shorturl" href="https://www.php.net/date-default-timezone-set">
 <link rel="alternate" href="https://www.php.net/date-default-timezone-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-default-timezone-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-diff.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-default-timezone-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-default-timezone-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-default-timezone-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-default-timezone-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-default-timezone-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-default-timezone-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-default-timezone-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-default-timezone-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-default-timezone-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-default-timezone-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-default-timezone-set.php" hreflang="zh">
...
<meta name="Description" content="Sets the default timezone used by all date/time functions in a script" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_default_timezone_set - Manual" />
<meta name="twitter:description" content="Sets the default timezone used by all date/time functions in a script" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_default_timezone_set - Manual" />
<meta itemprop="description" content="Sets the default timezone used by all date/time functions in a script" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the default timezone used by all date/time functions in a script" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-diff.php">
          date_diff &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-default-timezone-get.php">
          &laquo; date_default_timezone_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-default-timezone-set.php' selected="selected">English</option>
            <option value='de/function.date-default-timezone-set.php'>German</option>
            <option value='es/function.date-default-timezone-set.php'>Spanish</option>
            <option value='fr/function.date-default-timezone-set.php'>French</option>
            <option value='it/function.date-default-timezone-set.php'>Italian</option>
            <option value='ja/function.date-default-timezone-set.php'>Japanese</option>
            <option value='pt_BR/function.date-default-timezone-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-default-timezone-set.php'>Russian</option>
            <option value='tr/function.date-default-timezone-set.php'>Turkish</option>
            <option value='uk/function.date-default-timezone-set.php'>Ukrainian</option>
            <option value='zh/function.date-default-timezone-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-default-timezone-set" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       available in the <a href="timezones.php" class="xref">List of Supported Timezones</a>.
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.date-default-timezone-set-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="timezones.php" class="xref">List of Supported Timezones</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-default-timezone-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-default-timezone-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-default-timezone-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-default-timezone-set.php">＋<small>add a note</small></a></span>
