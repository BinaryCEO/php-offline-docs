...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getextension.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getextension.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getextension.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getendline.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getextensionname.php">
...
<meta name="Description" content="Gets a ReflectionExtension object for the extension which defined the class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getExtension - Manual" />
<meta name="twitter:description" content="Gets a ReflectionExtension object for the extension which defined the class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getExtension - Manual" />
<meta itemprop="description" content="Gets a ReflectionExtension object for the extension which defined the class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a ReflectionExtension object for the extension which defined the class" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getextension.php' selected="selected">English</option>
            ...
            <option value='zh/reflectionclass.getextension.php'>Chinese (Simplified)</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getExtension</span> &mdash; <span class="dc-title">Gets a <span class="classname"><a href="class.reflectionextension.php" class="classname">ReflectionExtension</a></span> object for the extension which defined the class</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionclass.getextension-description">
  ...
  <p class="para rdfs-comment">
   Gets a <span class="classname"><a href="class.reflectionextension.php" class="classname">ReflectionExtension</a></span> object for the extension which defined the class.
  </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getextension-returnvalues">
  ...
  <p class="para">
   A <span class="classname"><a href="class.reflectionextension.php" class="classname">ReflectionExtension</a></span> object representing the extension which defined the class,
   or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> for user-defined classes.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getextension-examples">
  ...
  <p class="para">
   <div class="example" id="example-5477">
    <p><strong>Example #1 Basic usage of <span class="methodname"><strong>ReflectionClass::getExtension()</strong></span></strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getextensionname.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getExtensionName()</a> - Gets the name of the extension which defined the class</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getextension.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getextension%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getextension&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getextension.php">＋<small>add a note</small></a></span>
