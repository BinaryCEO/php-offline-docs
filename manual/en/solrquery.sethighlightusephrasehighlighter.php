...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightUsePhraseHighlighter - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightsnippets.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmlt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightusephrasehighlighter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightusephrasehighlighter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightusephrasehighlighter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightusephrasehighlighter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightusephrasehighlighter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightusephrasehighlighter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightusephrasehighlighter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightusephrasehighlighter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightusephrasehighlighter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightusephrasehighlighter.php" hreflang="zh">
...
<meta name="Description" content="Whether to highlight phrase terms only when they appear within the query phrase" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightUsePhraseHighlighter - Manual" />
<meta name="twitter:description" content="Whether to highlight phrase terms only when they appear within the query phrase" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightUsePhraseHighlighter - Manual" />
<meta itemprop="description" content="Whether to highlight phrase terms only when they appear within the query phrase" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Whether to highlight phrase terms only when they appear within the query phrase" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.setmlt.php">
          SolrQuery::setMlt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightsnippets.php">
          &laquo; SolrQuery::setHighlightSnippets        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightusephrasehighlighter.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightusephrasehighlighter.php'>German</option>
            <option value='es/solrquery.sethighlightusephrasehighlighter.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightusephrasehighlighter.php'>French</option>
            <option value='it/solrquery.sethighlightusephrasehighlighter.php'>Italian</option>
            <option value='ja/solrquery.sethighlightusephrasehighlighter.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightusephrasehighlighter.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightusephrasehighlighter.php'>Russian</option>
            <option value='tr/solrquery.sethighlightusephrasehighlighter.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightusephrasehighlighter.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightusephrasehighlighter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightusephrasehighlighter" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightUsePhraseHighlighter</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightUsePhraseHighlighter</span> &mdash; <span class="dc-title">Whether to highlight phrase terms only when they appear within the query phrase</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightusephrasehighlighter-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightUsePhraseHighlighter</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightusephrasehighlighter-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightusephrasehighlighter-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightusephrasehighlighter.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightusephrasehighlighter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightusephrasehighlighter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightusephrasehighlighter.php">＋<small>add a note</small></a></span>
