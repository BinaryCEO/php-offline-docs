...
<head>
  ...
  <title>PHP: Imagick::getSamplingFactors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getresourcelimit.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getsamplingfactors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getsamplingfactors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getsamplingfactors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getsamplingfactors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getsamplingfactors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getsamplingfactors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getsamplingfactors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getsamplingfactors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getsamplingfactors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getsamplingfactors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getsamplingfactors.php" hreflang="zh">
...
<meta name="Description" content="Gets the horizontal and vertical sampling factor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getSamplingFactors - Manual" />
<meta name="twitter:description" content="Gets the horizontal and vertical sampling factor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getSamplingFactors - Manual" />
<meta itemprop="description" content="Gets the horizontal and vertical sampling factor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the horizontal and vertical sampling factor" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getsize.php">
          Imagick::getSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getresourcelimit.php">
          &laquo; Imagick::getResourceLimit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getsamplingfactors.php' selected="selected">English</option>
            <option value='de/imagick.getsamplingfactors.php'>German</option>
            <option value='es/imagick.getsamplingfactors.php'>Spanish</option>
            <option value='fr/imagick.getsamplingfactors.php'>French</option>
            <option value='it/imagick.getsamplingfactors.php'>Italian</option>
            <option value='ja/imagick.getsamplingfactors.php'>Japanese</option>
            <option value='pt_BR/imagick.getsamplingfactors.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getsamplingfactors.php'>Russian</option>
            <option value='tr/imagick.getsamplingfactors.php'>Turkish</option>
            <option value='uk/imagick.getsamplingfactors.php'>Ukrainian</option>
            <option value='zh/imagick.getsamplingfactors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getsamplingfactors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getSamplingFactors</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getSamplingFactors</span> &mdash; <span class="dc-title">Gets the horizontal and vertical sampling factor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getsamplingfactors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getSamplingFactors</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getsamplingfactors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getsamplingfactors-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getsamplingfactors-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getsamplingfactors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getsamplingfactors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getsamplingfactors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getsamplingfactors.php">＋<small>add a note</small></a></span>
