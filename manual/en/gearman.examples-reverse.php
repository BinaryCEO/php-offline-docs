...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearman.examples-reverse.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearman.examples-reverse.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearman.examples-reverse.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/gearman.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearman.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/gearman.examples-reverse-bg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearman.examples-reverse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearman.examples-reverse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearman.examples-reverse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearman.examples-reverse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearman.examples-reverse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearman.examples-reverse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearman.examples-reverse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearman.examples-reverse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearman.examples-reverse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearman.examples-reverse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearman.examples-reverse.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearman.examples-reverse-bg.php">
          Basic Gearman client and worker, background &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearman.examples-reverse.php' selected="selected">English</option>
            <option value='de/gearman.examples-reverse.php'>German</option>
            <option value='es/gearman.examples-reverse.php'>Spanish</option>
            <option value='fr/gearman.examples-reverse.php'>French</option>
            <option value='it/gearman.examples-reverse.php'>Italian</option>
            <option value='ja/gearman.examples-reverse.php'>Japanese</option>
            <option value='pt_BR/gearman.examples-reverse.php'>Brazilian Portuguese</option>
            <option value='ru/gearman.examples-reverse.php'>Russian</option>
            <option value='tr/gearman.examples-reverse.php'>Turkish</option>
            <option value='uk/gearman.examples-reverse.php'>Ukrainian</option>
            <option value='zh/gearman.examples-reverse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearman.examples-reverse" class="section">
...
Success: !olleH
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearman.examples-reverse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearman.examples-reverse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearman.examples-reverse.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120121">  <div class="votes">
    <div id="Vu120121">
    <a href="/manual/vote-note.php?id=120121&amp;page=gearman.examples-reverse&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120121">
    <a href="/manual/vote-note.php?id=120121&amp;page=gearman.examples-reverse&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120121" title="66% like this...">
    3
    </div>
  </div>
  <a href="#120121" class="name">
  <strong class="user"><em>dmitriy dot baibuhtin at ya dot ru</em></strong></a><a class="genanchor" href="#120121"> &para;</a><div class="date" title="2016-11-05 10:35"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120121">
<div class="phpcode"><code><span class="html">An example of a client is invalid. Progress will not be displayed on the client side, as doNormal method is synchronous.<br />Code will be executed only after the completion doNormal.<br /><span class="default">&lt;?php <br /> </span><span class="keyword">case </span><span class="default">GEARMAN_WORK_STATUS</span><span class="keyword">:<br />      list(</span><span class="default">$numerator</span><span class="keyword">, </span><span class="default">$denominator</span><span class="keyword">)= </span><span class="default">$gmclient</span><span class="keyword">-&gt;</span><span class="default">doStatus</span><span class="keyword">();<br />      echo </span><span class="string">"Status: </span><span class="default">$numerator</span><span class="string">/</span><span class="default">$denominator</span><span class="string"> complete\n"</span><span class="keyword">;<br />      break;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearman.examples-reverse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearman.examples-reverse.php">＋<small>add a note</small></a></div>
