...
<head>
  ...
  <title>PHP: imageloadfont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imageloadfont.php">
 <link rel="shorturl" href="https://www.php.net/imageloadfont">
 <link rel="alternate" href="https://www.php.net/imageloadfont" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imageline.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageopenpolygon.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imageloadfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imageloadfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imageloadfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imageloadfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imageloadfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imageloadfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imageloadfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imageloadfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imageloadfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imageloadfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imageloadfont.php" hreflang="zh">
...
<meta name="Description" content="Load a new font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imageloadfont - Manual" />
<meta name="twitter:description" content="Load a new font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imageloadfont - Manual" />
<meta itemprop="description" content="Load a new font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Load a new font" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imageopenpolygon.php">
          imageopenpolygon &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imageloadfont.php' selected="selected">English</option>
            <option value='de/function.imageloadfont.php'>German</option>
            <option value='es/function.imageloadfont.php'>Spanish</option>
            <option value='fr/function.imageloadfont.php'>French</option>
            <option value='it/function.imageloadfont.php'>Italian</option>
            <option value='ja/function.imageloadfont.php'>Japanese</option>
            <option value='pt_BR/function.imageloadfont.php'>Brazilian Portuguese</option>
            <option value='ru/function.imageloadfont.php'>Russian</option>
            <option value='tr/function.imageloadfont.php'>Turkish</option>
            <option value='uk/function.imageloadfont.php'>Ukrainian</option>
            <option value='zh/function.imageloadfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imageloadfont" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagestring.php" class="function" rel="rdfs-seeAlso">imagestring()</a> - Draw a string horizontally</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imageloadfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imageloadfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imageloadfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageloadfont.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="56263">  <div class="votes">
    <div id="Vu56263">
    <a href="/manual/vote-note.php?id=56263&amp;page=function.imageloadfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd56263">
    <a href="/manual/vote-note.php?id=56263&amp;page=function.imageloadfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V56263" title="65% like this...">
    6
    </div>
  </div>
  <a href="#56263" class="name">
  <strong class="user"><em>siker at norwinter dot com</em></strong></a><a class="genanchor" href="#56263"> &para;</a><div class="date" title="2005-08-28 06:37"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom56263">
<div class="phpcode"><code><span class="html">Working under the assumption that the only 'architecture dependant' part of the font files is endianness, I wrote a quick and dirty Python script to convert between the two. It has only been tested on a single font on a single machine so don't bet your life on it working. All it does is swap the byte order of the first four ints.<br /><br />#!/usr/bin/env python<br /><br />f = open("myfont.gdf", "rb");<br />d = open("myconvertedfont.gdf", "wb");<br /><br />for i in xrange(4):<br />        b = [f.read(1) for j in xrange(4)];<br />        b.reverse();<br />        d.write(''.join(b));<br /><br />d.write(f.read());<br /><br />I successfully used this script to convert anonymous.gdf, from one of the font links below, into something useable on Mac OS X.</span></code></div>
  </div>
 </div>
  <div class="note" id="54385">  <div class="votes">
    <div id="Vu54385">
    <a href="/manual/vote-note.php?id=54385&amp;page=function.imageloadfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54385">
    <a href="/manual/vote-note.php?id=54385&amp;page=function.imageloadfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54385" title="56% like this...">
    2
    </div>
  </div>
  <a href="#54385" class="name">
  <strong class="user"><em>alex at bestgames dot ro</em></strong></a><a class="genanchor" href="#54385"> &para;</a><div class="date" title="2005-07-02 05:01"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54385">
<div class="phpcode"><code><span class="html">Confirmation code generation for preventing automated registrations on a website.<br /><br />Function arguments are:<br />$code - the code that you shall random generate<br />$location - relative location of the image that shall be generated<br />$fonts_dir - relative location for the GDF fonts directory<br /><br />This function will create an image with the code given by you and will save it in the directory specified with the name formed by MD5 hash of the code.<br /><br />You may insert as many font types in the fonts directory as you wish, with random names.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">generate_image</span><span class="keyword">(</span><span class="default">$code</span><span class="keyword">, </span><span class="default">$location</span><span class="keyword">, </span><span class="default">$fonts_dir</span><span class="keyword">)<br />{<br />     </span><span class="default">$image  </span><span class="keyword">= </span><span class="default">imagecreate</span><span class="keyword">(</span><span class="default">150</span><span class="keyword">, </span><span class="default">60</span><span class="keyword">);           <br />     </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">, </span><span class="default">rand</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">), </span><span class="default">rand</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">, </span><span class="default">150</span><span class="keyword">), </span><span class="default">rand</span><span class="keyword">(</span><span class="default">150</span><span class="keyword">, </span><span class="default">250</span><span class="keyword">));<br />     </span><span class="default">$fonts </span><span class="keyword">= </span><span class="default">scandir</span><span class="keyword">(</span><span class="default">$fonts_dir</span><span class="keyword">);<br />     <br />     </span><span class="default">$max </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$fonts</span><span class="keyword">) - </span><span class="default">2</span><span class="keyword">;<br />     <br />     </span><span class="default">$width </span><span class="keyword">= </span><span class="default">10</span><span class="keyword">;<br />     for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt;= </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$code</span><span class="keyword">); </span><span class="default">$i</span><span class="keyword">++)<br />     {     <br />         </span><span class="default">$textcolor </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">, </span><span class="default">255</span><span class="keyword">);<br />         </span><span class="default">$rand </span><span class="keyword">= </span><span class="default">rand</span><span class="keyword">(</span><span class="default">2</span><span class="keyword">, </span><span class="default">$max</span><span class="keyword">);<br />         </span><span class="default">$font </span><span class="keyword">= </span><span class="default">imageloadfont</span><span class="keyword">(</span><span class="default">$fonts_dir</span><span class="keyword">.</span><span class="string">"/"</span><span class="keyword">.</span><span class="default">$fonts</span><span class="keyword">[</span><span class="default">$rand</span><span class="keyword">]);<br />         <br />         </span><span class="default">$fh </span><span class="keyword">= </span><span class="default">imagefontheight</span><span class="keyword">(</span><span class="default">$font</span><span class="keyword">);<br />         </span><span class="default">$fw </span><span class="keyword">= </span><span class="default">imagefontwidth</span><span class="keyword">(</span><span class="default">$font</span><span class="keyword">);<br /><br />         </span><span class="default">imagechar</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">, </span><span class="default">$font</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">, </span><span class="default">rand</span><span class="keyword">(</span><span class="default">10</span><span class="keyword">, </span><span class="default">50 </span><span class="keyword">- </span><span class="default">$fh</span><span class="keyword">), </span><span class="default">$code</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">], </span><span class="default">$textcolor</span><span class="keyword">);     <br />          </span><span class="default">$width </span><span class="keyword">= </span><span class="default">$width </span><span class="keyword">+ </span><span class="default">$fw</span><span class="keyword">;<br />        <br />     }<br />             <br />     </span><span class="default">imagejpeg</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">, </span><span class="default">$location</span><span class="keyword">.</span><span class="string">"/"</span><span class="keyword">.</span><span class="default">md5</span><span class="keyword">(</span><span class="default">$code</span><span class="keyword">).</span><span class="string">".jpg"</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);<br />     </span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$image</span><span class="keyword">);       <br />    <br />     return </span><span class="default">$code</span><span class="keyword">;<br />     <br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="55849">  <div class="votes">
    <div id="Vu55849">
    <a href="/manual/vote-note.php?id=55849&amp;page=function.imageloadfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55849">
    <a href="/manual/vote-note.php?id=55849&amp;page=function.imageloadfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55849" title="50% like this...">
    0
    </div>
  </div>
  <a href="#55849" class="name">
  <strong class="user"><em>matthew at exanimo dot com</em></strong></a><a class="genanchor" href="#55849"> &para;</a><div class="date" title="2005-08-15 10:28"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55849">
<div class="phpcode"><code><span class="html">Remember - GD fonts aren't antialiased.  If you're planning on using a pre-existing (TrueType) font, you may want to consider using imagettftext() instead of phillip's function.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imageloadfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageloadfont.php">＋<small>add a note</small></a></div>
