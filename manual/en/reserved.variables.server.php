...
<head>
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/reserved.variables.server.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/reserved.variables.server.php" hreflang="uk">
...
<strong class="command">global $variable;</strong> to access it within functions or methods.
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reserved.variables.server&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.server.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To list all the $_SERVER parameters, simply do:<br /><br />foreach ($_SERVER as $parm =&gt; $value)  echo "$parm = '$value'\n";<br /><br />No need to list all possible keys of the array.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">You have missed 'REDIRECT_STATUS'<br /><br />Very useful if you point all your error pages to the same file.<br /><br />File; .htaccess<br /># .htaccess file.<br /><br />ErrorDocument 404 /error-msg.php<br />ErrorDocument 500 /error-msg.php<br />ErrorDocument 400 /error-msg.php<br />ErrorDocument 401 /error-msg.php<br />ErrorDocument 403 /error-msg.php<br /># End of file.<br /><br />File; error-msg.php<br /><span class="default">&lt;?php<br />  $HttpStatus </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">"REDIRECT_STATUS"</span><span class="keyword">] ;<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">200</span><span class="keyword">) {print </span><span class="string">"Document has been processed and sent to you."</span><span class="keyword">;}<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">400</span><span class="keyword">) {print </span><span class="string">"Bad HTTP request "</span><span class="keyword">;}<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">401</span><span class="keyword">) {print </span><span class="string">"Unauthorized - Iinvalid password"</span><span class="keyword">;}<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">403</span><span class="keyword">) {print </span><span class="string">"Forbidden"</span><span class="keyword">;}<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">500</span><span class="keyword">) {print </span><span class="string">"Internal Server Error"</span><span class="keyword">;}<br />  if(</span><span class="default">$HttpStatus</span><span class="keyword">==</span><span class="default">418</span><span class="keyword">) {print </span><span class="string">"I'm a teapot! - This is a real value, defined in 1998"</span><span class="keyword">;}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>Lord Mac</em></strong></a><a class="genanchor" href="#94070"> &para;</a><div class="date" title="2009-10-14 07:56"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94070">
<div class="phpcode"><code><span class="html">An even *more* improved version...<br /><br /><span class="default">&lt;?php<br />phpinfo</span><span class="keyword">(</span><span class="default">32</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you need to know the protocol (http or https) used by the client, then the $_SERVER['HTTPS'] variable may not actually report the truth if your server is behind a proxy or a load balancer (In fact the client could connect to the load balancer using https, and then the load balancer forward the request to the server using http).<br />If the proxy/load balancer is correctly configured it could send the original request protocol in a header, and you will find it in the $_SERVER[HTTP_X_FORWARDED_PROTO] variable.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>krinklemail at gmail dot com</em></strong></a><a class="genanchor" href="#110763"> &para;</a><div class="date" title="2012-12-05 11:39"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110763">
<div class="phpcode"><code><span class="html">If requests to your PHP script send a header "Content-Type" or/ "Content-Length" it will, contrary to regular HTTP headers, not appear in $_SERVER as $_SERVER['HTTP_CONTENT_TYPE']. PHP removes these (per CGI/1.1 specification[1]) from the HTTP_ match group.<br /><br />They are still accessible, but only if the request was a POST request. When it is, it'll be available as:<br />$_SERVER['CONTENT_LENGTH']<br />$_SERVER['CONTENT_TYPE']<br /><br />[1] <a href="https://www.ietf.org/rfc/rfc3875" rel="nofollow" target="_blank">https://www.ietf.org/rfc/rfc3875</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">PHP_SELF is a disgrace of a programmer's work. One of the most widespread PHP vulnerabilities since version 4 and the manual says nothing about the dangers. At least clarify that ITS VALUE CAN BE PROVIDED BY THE USER with capitals preferably if you want to make the internet a safer place...</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you are serving from behind a proxy server, you will almost certainly save time by looking at what these $_SERVER variables do on your machine behind the proxy.   <br /><br />$_SERVER['HTTP_X_FORWARDED_FOR'] in place of $_SERVER['REMOTE_ADDR']<br /><br />$_SERVER['HTTP_X_FORWARDED_HOST'] and <br />$_SERVER['HTTP_X_FORWARDED_SERVER'] in place of (at least in our case,) $_SERVER['SERVER_NAME']</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">On Windows IIS 7 you must use $_SERVER['LOCAL_ADDR'] rather than $_SERVER['SERVER_ADDR'] to get the server's IP address.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">$_SERVER['DOCUMENT_ROOT'] is incredibly useful especially when working in your development environment. If you're working on large projects you'll likely be including a large number of files into your pages. For example:
<br />
...
<br /></span>
<br />In development environments, you're rarely working with your root folder, especially if you're running PHP locally on your box and using DOCUMENT_ROOT is a great way to maintain URL conformity. This will save you hours of work preparing your application for deployment from your box to a production server (not to mention save you the headache of include path failures).</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">This code can be used to help find somone that tries to dig throught the server files to find something.<br /><br />.htaccess<br /><br />ErrorDocument 404 /your.php<br />ErrorDocument 403 /your.php<br /><br /><span class="default">&lt;?php  <br />         </span><span class="comment">//get time<br />         </span><span class="default">$time </span><span class="keyword">= </span><span class="default">date</span><span class="keyword">(</span><span class="string">"H:i:s d.m.y"</span><span class="keyword">); <br />         </span><span class="comment">//get user address<br />         </span><span class="default">$usr </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'REMOTE_ADDR'</span><span class="keyword">];    <br />         </span><span class="comment">//get entered url of the "visitor"<br />         </span><span class="default">$url </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'REQUEST_URI'</span><span class="keyword">];<br />         </span><span class="comment">//get your servers address<br />         </span><span class="default">$ip </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'SERVER_ADDR'</span><span class="keyword">];<br />     </span><span class="comment">//put toogether<br />         </span><span class="default">$sus </span><span class="keyword">= </span><span class="string">"["</span><span class="keyword">.</span><span class="default">$time</span><span class="keyword">.</span><span class="string">"]   "</span><span class="keyword">.</span><span class="default">$usr</span><span class="keyword">.</span><span class="string">"   "</span><span class="keyword">.</span><span class="default">$ip</span><span class="keyword">.</span><span class="default">$url</span><span class="keyword">.</span><span class="default">PHP_EOL</span><span class="keyword">;    <br />         </span><span class="comment">//write an log file     <br />         </span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="string">"susip.txt"</span><span class="keyword">, </span><span class="default">$sus</span><span class="keyword">, </span><span class="default">FILE_APPEND</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">A table of everything in the $_SERVER array can be found near the bottom of the output of phpinfo();</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be warned that most contents of the Server-Array (even $_SERVER['SERVER_NAME']) are provided by the client and can be manipulated. They can also be used for injections and thus MUST be checked and treated like any other user input.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Here's a simple, quick but effective way to block unwanted external visitors to your local server:
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />This will direct all external traffic to your home page. Of course you could send a 404 or other custom error. Best practice is not to stay on the page with a custom error message as you acknowledge that the page does exist. That's why I redirect unwanted calls to (for example) phpmyadmin.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>picov at e-link dot it</em></strong></a><a class="genanchor" href="#106142"> &para;</a><div class="date" title="2011-10-13 10:59"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106142">
<div class="phpcode"><code><span class="html">A simple function to detect if the current page address was rewritten by mod_rewrite:
<br />
<br /><span class="default">&lt;?php
...
<div class="phpcode"><code><span class="html">Use the apache SetEnv directive to set arbitrary $_SERVER variables in your vhost or apache config.<br /><br />SetEnv varname "variable value"</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I think the HTTPS element will only be present under Apache 2.x. It's not in the list of "special" variables here:<br /><a href="http://httpd.apache.org/docs/1.3/mod/mod_rewrite.html#RewriteCond" rel="nofollow" target="_blank">http://httpd.apache.org/docs/1.3/mod/mod_rewrite.html#RewriteCond</a><br />But it is here:<br /><a href="http://httpd.apache.org/docs/2.0/mod/mod_rewrite.html#rewritecond" rel="nofollow" target="_blank">http://httpd.apache.org/docs/2.0/mod/mod_rewrite.html#rewritecond</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Don't forget $_SERVER['HTTP_COOKIE']. It contains the raw value of the 'Cookie' header sent by the user agent.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Guide to script parameters...<br /><br />Data: $_GET<br />Data type: Array (map)<br />Purpose: Contains all GET parameters (i.e. a parsed URL query string).<br />Caveat: GET parameter names have to be compliant with PHP variable naming, e.g. dots are not allowed and get substituted.<br />Works on web mode: Yes<br />Works on CLI mode: No<br /><br />Data: $_SERVER['QUERY_STRING']<br />Data type: String<br />Purpose: Gets an unparsed URL query string.<br />Caveat: Not set on all PHP environments, may need setting via http_build_query($_GET).<br />Works on web mode: Yes<br />Works on CLI mode: No<br /><br />Data: $_SERVER['argv']<br />Data type: Array (list)<br />Purpose: Get CLI call parameters.<br />Works on web mode: Tenuous (just contains a single parameter, the query string)<br />Works on CLI mode: Yes</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reserved.variables.server&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reserved.variables.server.php">＋<small>add a note</small></a></div>
