...
<head>
  ...
  <title>PHP: ocifreecollection - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocifreecollection.php">
 <link rel="shorturl" href="https://www.php.net/ocifreecollection">
 <link rel="alternate" href="https://www.php.net/ocifreecollection" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocifetchstatement.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocifreecursor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocifreecollection.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocifreecollection.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocifreecollection.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocifreecollection.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocifreecollection.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocifreecollection.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocifreecollection.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocifreecollection.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocifreecollection.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocifreecollection.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocifreecollection.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::free" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocifreecollection - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::free" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocifreecollection - Manual" />
<meta itemprop="description" content="Alias of OCICollection::free" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::free" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocifreecursor.php">
          ocifreecursor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocifetchstatement.php">
          &laquo; ocifetchstatement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocifreecollection.php' selected="selected">English</option>
            <option value='de/function.ocifreecollection.php'>German</option>
            <option value='es/function.ocifreecollection.php'>Spanish</option>
            <option value='fr/function.ocifreecollection.php'>French</option>
            <option value='it/function.ocifreecollection.php'>Italian</option>
            <option value='ja/function.ocifreecollection.php'>Japanese</option>
            <option value='pt_BR/function.ocifreecollection.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocifreecollection.php'>Russian</option>
            <option value='tr/function.ocifreecollection.php'>Turkish</option>
            <option value='uk/function.ocifreecollection.php'>Ukrainian</option>
            <option value='zh/function.ocifreecollection.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocifreecollection" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocifreecollection</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.7, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocifreecollection</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.free.php" class="function">OCICollection::free()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocifreecollection-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.free.php" class="function">OCICollection::free()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocifreecollection.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocifreecollection%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocifreecollection&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocifreecollection.php">＋<small>add a note</small></a></span>
