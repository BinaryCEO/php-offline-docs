...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mcrypt.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mcrypt.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mcrypt.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/mcrypt.resources.php">
 <link rel="next" href="https://www.php.net/manual/en/mcrypt.ciphers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mcrypt.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mcrypt.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mcrypt.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mcrypt.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mcrypt.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mcrypt.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mcrypt.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mcrypt.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mcrypt.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mcrypt.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mcrypt.constants.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mcrypt.ciphers.php">
          Mcrypt ciphers &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mcrypt.constants.php' selected="selected">English</option>
            <option value='de/mcrypt.constants.php'>German</option>
            <option value='es/mcrypt.constants.php'>Spanish</option>
            <option value='fr/mcrypt.constants.php'>French</option>
            <option value='it/mcrypt.constants.php'>Italian</option>
            <option value='ja/mcrypt.constants.php'>Japanese</option>
            <option value='pt_BR/mcrypt.constants.php'>Brazilian Portuguese</option>
            <option value='ru/mcrypt.constants.php'>Russian</option>
            <option value='tr/mcrypt.constants.php'>Turkish</option>
            <option value='uk/mcrypt.constants.php'>Ukrainian</option>
            <option value='zh/mcrypt.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mcrypt.constants" class="appendix">
  ...
  <dl>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmcrypt.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mcrypt.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mcrypt.constants.php">＋<small>add a note</small></a></span>
