...
<head>
  ...
  <title>PHP: mb_stristr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-stristr.php">
 <link rel="shorturl" href="https://www.php.net/mb-stristr">
 <link rel="alternate" href="https://www.php.net/mb-stristr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-stripos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strlen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-stristr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-stristr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-stristr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-stristr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-stristr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-stristr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-stristr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-stristr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-stristr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-stristr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-stristr.php" hreflang="zh">
...
<meta name="Description" content="Finds first occurrence of a string within another, case insensitive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_stristr - Manual" />
<meta name="twitter:description" content="Finds first occurrence of a string within another, case insensitive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_stristr - Manual" />
<meta itemprop="description" content="Finds first occurrence of a string within another, case insensitive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds first occurrence of a string within another, case insensitive" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-stristr.php' selected="selected">English</option>
            <option value='de/function.mb-stristr.php'>German</option>
            <option value='es/function.mb-stristr.php'>Spanish</option>
            <option value='fr/function.mb-stristr.php'>French</option>
            <option value='it/function.mb-stristr.php'>Italian</option>
            <option value='ja/function.mb-stristr.php'>Japanese</option>
            <option value='pt_BR/function.mb-stristr.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-stristr.php'>Russian</option>
            <option value='tr/function.mb-stristr.php'>Turkish</option>
            <option value='uk/function.mb-stristr.php'>Ukrainian</option>
            <option value='zh/function.mb-stristr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-stristr" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_stristr</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_stristr</span> &mdash; <span class="dc-title">Finds first occurrence of a string within another, case insensitive</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-stristr-description">
  ...
  <p class="para rdfs-comment">
   ...
   and returns the portion of <code class="parameter">haystack</code>.
   Unlike <span class="function"><a href="function.mb-strstr.php" class="function">mb_strstr()</a></span>, 
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       from the beginning to the first occurrence of <code class="parameter">needle</code> (excluding needle).
       ...
       from the first occurrence of <code class="parameter">needle</code> to the end (including needle).
      </p>
     </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-stristr-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-strstr.php" class="function" rel="rdfs-seeAlso">mb_strstr()</a> - Finds first occurrence of a string within another</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-stristr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-stristr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-stristr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-stristr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127048">  <div class="votes">
    <div id="Vu127048">
    <a href="/manual/vote-note.php?id=127048&amp;page=function.mb-stristr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127048">
    <a href="/manual/vote-note.php?id=127048&amp;page=function.mb-stristr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127048" title="100% like this...">
    1
    </div>
  </div>
  <a href="#127048" class="name">
  <strong class="user"><em>nowfel dot terki at mailfence dot com</em></strong></a><a class="genanchor" href="#127048"> &para;</a><div class="date" title="2022-05-11 09:04"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127048">
<div class="phpcode"><code><span class="html">Be aware that if needle is an empty string, mb_stristr return the haystack by default.<br /><br />For exemple:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">mb_stristr</span><span class="keyword">(</span><span class="string">"foo"</span><span class="keyword">, </span><span class="string">""</span><span class="keyword">)) {<br />    echo </span><span class="string">"We enter in condition"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />Because in the above exemple the return of mb_stristr is "foo".<br /><br />So if we do not want this kind of behaviour, we must set the third argument, ($before_needle) to true.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if (</span><span class="default">mb_stristr</span><span class="keyword">(</span><span class="string">"foo"</span><span class="keyword">, </span><span class="string">""</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">)) {<br />    echo </span><span class="string">"We do not enter in condition"</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;<br /></span><br />It can be useful to know it, specially when needle is dynamic.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-stristr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-stristr.php">＋<small>add a note</small></a></div>
