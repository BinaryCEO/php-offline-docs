...
<head>
  ...
  <title>PHP: Imagick::liquidRescaleImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.linearstretchimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.listregistry.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.liquidrescaleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.liquidrescaleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.liquidrescaleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.liquidrescaleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.liquidrescaleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.liquidrescaleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.liquidrescaleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.liquidrescaleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.liquidrescaleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.liquidrescaleimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::liquidRescaleImage - Manual" />
<meta name="twitter:description" content="Animates an image or images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::liquidRescaleImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.listregistry.php">
          Imagick::listRegistry &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.linearstretchimage.php">
          &laquo; Imagick::linearStretchImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.liquidrescaleimage.php' selected="selected">English</option>
            <option value='de/imagick.liquidrescaleimage.php'>German</option>
            <option value='es/imagick.liquidrescaleimage.php'>Spanish</option>
            <option value='fr/imagick.liquidrescaleimage.php'>French</option>
            <option value='it/imagick.liquidrescaleimage.php'>Italian</option>
            <option value='ja/imagick.liquidrescaleimage.php'>Japanese</option>
            <option value='pt_BR/imagick.liquidrescaleimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.liquidrescaleimage.php'>Russian</option>
            <option value='tr/imagick.liquidrescaleimage.php'>Turkish</option>
            <option value='uk/imagick.liquidrescaleimage.php'>Ukrainian</option>
            <option value='zh/imagick.liquidrescaleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.liquidrescaleimage" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.resizeimage.php" class="function" rel="rdfs-seeAlso">Imagick::resizeImage()</a> - Scales an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/liquidrescaleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.liquidrescaleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.liquidrescaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.liquidrescaleimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106579">  <div class="votes">
    <div id="Vu106579">
    <a href="/manual/vote-note.php?id=106579&amp;page=imagick.liquidrescaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106579">
    <a href="/manual/vote-note.php?id=106579&amp;page=imagick.liquidrescaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106579" title="50% like this...">
    0
    </div>
  </div>
  <a href="#106579" class="name">
  <strong class="user"><em>spider at man dot net</em></strong></a><a class="genanchor" href="#106579"> &para;</a><div class="date" title="2011-11-20 11:00"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106579">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />     <br />    </span><span class="comment">/* Create new object */<br />    </span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">'test.jpg' </span><span class="keyword">);<br />     <br />    </span><span class="comment">/* Scale down */<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">liquidRescaleImage</span><span class="keyword">( </span><span class="default">500</span><span class="keyword">, </span><span class="default">200</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">, </span><span class="default">25 </span><span class="keyword">);<br />     <br />    </span><span class="comment">/* Display */<br />    </span><span class="default">header</span><span class="keyword">( </span><span class="string">'Content-Type: image/jpg' </span><span class="keyword">);<br />    echo </span><span class="default">$im</span><span class="keyword">;<br />     <br />    </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.liquidrescaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.liquidrescaleimage.php">＋<small>add a note</small></a></div>
