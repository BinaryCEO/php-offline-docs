...
<head>
  ...
  <title>PHP: ldap_control_paged_result_response - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-control-paged-result-response.php">
 <link rel="shorturl" href="https://www.php.net/ldap-control-paged-result-response">
 <link rel="alternate" href="https://www.php.net/ldap-control-paged-result-response" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-control-paged-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-count-entries.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-control-paged-result-response.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-control-paged-result-response.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-control-paged-result-response.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-control-paged-result-response.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-control-paged-result-response.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-control-paged-result-response.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-control-paged-result-response.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-control-paged-result-response.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-control-paged-result-response.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-control-paged-result-response.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-control-paged-result-response.php" hreflang="zh">
...
<meta name="Description" content="Retrieve the LDAP pagination cookie" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_control_paged_result_response - Manual" />
<meta name="twitter:description" content="Retrieve the LDAP pagination cookie" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_control_paged_result_response - Manual" />
<meta itemprop="description" content="Retrieve the LDAP pagination cookie" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve the LDAP pagination cookie" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-count-entries.php">
          ldap_count_entries &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-control-paged-result.php">
          &laquo; ldap_control_paged_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-control-paged-result-response.php' selected="selected">English</option>
            <option value='de/function.ldap-control-paged-result-response.php'>German</option>
            <option value='es/function.ldap-control-paged-result-response.php'>Spanish</option>
            <option value='fr/function.ldap-control-paged-result-response.php'>French</option>
            <option value='it/function.ldap-control-paged-result-response.php'>Italian</option>
            <option value='ja/function.ldap-control-paged-result-response.php'>Japanese</option>
            <option value='pt_BR/function.ldap-control-paged-result-response.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-control-paged-result-response.php'>Russian</option>
            <option value='tr/function.ldap-control-paged-result-response.php'>Turkish</option>
            <option value='uk/function.ldap-control-paged-result-response.php'>Ukrainian</option>
            <option value='zh/function.ldap-control-paged-result-response.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-control-paged-result-response" class="refentry">
   ...
   <ul class="simplelist">
    ...
    Paged Results Manipulation</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-control-paged-result-response.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-control-paged-result-response%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-control-paged-result-response&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-control-paged-result-response.php">＋<small>add a note</small></a></span>
