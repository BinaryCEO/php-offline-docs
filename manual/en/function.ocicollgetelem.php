...
<head>
  ...
  <title>PHP: ocicollgetelem - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicollgetelem.php">
 <link rel="shorturl" href="https://www.php.net/ocicollgetelem">
 <link rel="alternate" href="https://www.php.net/ocicollgetelem" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicollassignelem.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicollmax.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicollgetelem.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicollgetelem.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicollgetelem.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicollgetelem.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicollgetelem.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicollgetelem.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicollgetelem.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicollgetelem.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicollgetelem.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicollgetelem.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicollgetelem.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::getElem" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicollgetelem - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::getElem" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicollgetelem - Manual" />
<meta itemprop="description" content="Alias of OCICollection::getElem" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::getElem" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ocicollmax.php">
          ocicollmax &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicollassignelem.php">
          &laquo; ocicollassignelem        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicollgetelem.php' selected="selected">English</option>
            <option value='de/function.ocicollgetelem.php'>German</option>
            <option value='es/function.ocicollgetelem.php'>Spanish</option>
            <option value='fr/function.ocicollgetelem.php'>French</option>
            <option value='it/function.ocicollgetelem.php'>Italian</option>
            <option value='ja/function.ocicollgetelem.php'>Japanese</option>
            <option value='pt_BR/function.ocicollgetelem.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicollgetelem.php'>Russian</option>
            <option value='tr/function.ocicollgetelem.php'>Turkish</option>
            <option value='uk/function.ocicollgetelem.php'>Ukrainian</option>
            <option value='zh/function.ocicollgetelem.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicollgetelem" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicollgetelem</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicollgetelem</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.getelem.php" class="function">OCICollection::getElem()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicollgetelem-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.getelem.php" class="function">OCICollection::getElem()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicollgetelem.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicollgetelem%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicollgetelem&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicollgetelem.php">＋<small>add a note</small></a></span>
