...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/outcontrol.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/outcontrol.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.outcontrol.php">
 <link rel="prev" href="https://www.php.net/manual/en/outcontrol.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/outcontrol.output-buffering.php">

 <link rel="alternate" href="https://www.php.net/manual/en/outcontrol.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/outcontrol.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/outcontrol.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/outcontrol.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/outcontrol.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/outcontrol.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/outcontrol.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/outcontrol.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/outcontrol.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/outcontrol.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/outcontrol.constants.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="outcontrol.output-buffering.php">
          Output Buffering &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="outcontrol.configuration.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/outcontrol.constants.php' selected="selected">English</option>
            <option value='de/outcontrol.constants.php'>German</option>
            <option value='es/outcontrol.constants.php'>Spanish</option>
            <option value='fr/outcontrol.constants.php'>French</option>
            <option value='it/outcontrol.constants.php'>Italian</option>
            <option value='ja/outcontrol.constants.php'>Japanese</option>
            <option value='pt_BR/outcontrol.constants.php'>Brazilian Portuguese</option>
            <option value='ru/outcontrol.constants.php'>Russian</option>
            <option value='tr/outcontrol.constants.php'>Turkish</option>
            <option value='uk/outcontrol.constants.php'>Ukrainian</option>
            <option value='zh/outcontrol.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="outcontrol.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/outcontrol/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Foutcontrol.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=outcontrol.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/outcontrol.constants.php">＋<small>add a note</small></a></span>
