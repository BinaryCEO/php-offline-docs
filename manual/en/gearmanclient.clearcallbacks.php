...
<head>
  ...
  <title>PHP: GearmanClient::clearCallbacks - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.clearcallbacks.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.clearcallbacks.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.clearcallbacks.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.clone.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.clearcallbacks.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.clearcallbacks.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.clearcallbacks.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.clearcallbacks.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.clearcallbacks.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.clearcallbacks.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.clearcallbacks.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.clearcallbacks.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.clearcallbacks.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.clearcallbacks.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.clearcallbacks.php" hreflang="zh">
...
<meta name="Description" content="Clear all task callback functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::clearCallbacks - Manual" />
<meta name="twitter:description" content="Clear all task callback functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::clearCallbacks - Manual" />
<meta itemprop="description" content="Clear all task callback functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clear all task callback functions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.clone.php">
          GearmanClient::clone &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.addtaskstatus.php">
          &laquo; GearmanClient::addTaskStatus        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.clearcallbacks.php' selected="selected">English</option>
            <option value='de/gearmanclient.clearcallbacks.php'>German</option>
            <option value='es/gearmanclient.clearcallbacks.php'>Spanish</option>
            <option value='fr/gearmanclient.clearcallbacks.php'>French</option>
            <option value='it/gearmanclient.clearcallbacks.php'>Italian</option>
            <option value='ja/gearmanclient.clearcallbacks.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.clearcallbacks.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.clearcallbacks.php'>Russian</option>
            <option value='tr/gearmanclient.clearcallbacks.php'>Turkish</option>
            <option value='uk/gearmanclient.clearcallbacks.php'>Ukrainian</option>
            <option value='zh/gearmanclient.clearcallbacks.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.clearcallbacks" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::clearCallbacks</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::clearCallbacks</span> &mdash; <span class="dc-title">Clear all task callback functions</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gearmanclient.clearcallbacks-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::clearCallbacks</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gearmanclient.clearcallbacks-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.clearcallbacks-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanclient.clearcallbacks-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/clearcallbacks.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.clearcallbacks%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.clearcallbacks&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.clearcallbacks.php">＋<small>add a note</small></a></span>
