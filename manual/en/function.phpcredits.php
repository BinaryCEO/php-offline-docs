...
<head>
  ...
  <title>PHP: phpcredits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.phpcredits.php">
 <link rel="shorturl" href="https://www.php.net/phpcredits">
 <link rel="alternate" href="https://www.php.net/phpcredits" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.php-uname.php">
 <link rel="next" href="https://www.php.net/manual/en/function.phpinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.phpcredits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.phpcredits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.phpcredits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.phpcredits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.phpcredits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.phpcredits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.phpcredits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.phpcredits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.phpcredits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.phpcredits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.phpcredits.php" hreflang="zh">
...
<meta name="Description" content="Prints out the credits for PHP" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: phpcredits - Manual" />
<meta name="twitter:description" content="Prints out the credits for PHP" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: phpcredits - Manual" />
<meta itemprop="description" content="Prints out the credits for PHP" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Prints out the credits for PHP" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.phpcredits.php' selected="selected">English</option>
            <option value='de/function.phpcredits.php'>German</option>
            <option value='es/function.phpcredits.php'>Spanish</option>
            <option value='fr/function.phpcredits.php'>French</option>
            <option value='it/function.phpcredits.php'>Italian</option>
            <option value='ja/function.phpcredits.php'>Japanese</option>
            <option value='pt_BR/function.phpcredits.php'>Brazilian Portuguese</option>
            <option value='ru/function.phpcredits.php'>Russian</option>
            <option value='tr/function.phpcredits.php'>Turkish</option>
            <option value='uk/function.phpcredits.php'>Ukrainian</option>
            <option value='zh/function.phpcredits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.phpcredits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">phpcredits</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">phpcredits</span> &mdash; <span class="dc-title">Prints out the credits for PHP</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.phpcredits-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>phpcredits</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="info.constants.php#constant.credits-all">CREDITS_ALL</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
        ...
        <caption><strong>Pre-defined <span class="function"><strong>phpcredits()</strong></span> flags</strong></caption>
         ...
         <tbody class="tbody">
          <tr>
           <td>CREDITS_ALL</td>
           <td>
            All the credits, equivalent to using: <strong><code><a href="info.constants.php#constant.credits-docs">CREDITS_DOCS</a></code></strong> +
            <strong><code><a href="info.constants.php#constant.credits-general">CREDITS_GENERAL</a></code></strong> + <strong><code><a href="info.constants.php#constant.credits-group">CREDITS_GROUP</a></code></strong> +
            <strong><code><a href="info.constants.php#constant.credits-modules">CREDITS_MODULES</a></code></strong> + <strong><code><a href="info.constants.php#constant.credits-fullpage">CREDITS_FULLPAGE</a></code></strong>.
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />phpcredits</span><span style="color: #007700">(</span><span style="color: #0000BB">CREDITS_GENERAL</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.phpinfo.php" class="function" rel="rdfs-seeAlso">phpinfo()</a> - Outputs information about PHP's configuration</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/phpcredits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.phpcredits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.phpcredits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.phpcredits.php">＋<small>add a note</small></a></span>
