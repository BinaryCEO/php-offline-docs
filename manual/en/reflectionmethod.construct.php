...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionmethod.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionmethod.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionmethod.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.reflectionmethod.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionmethod.createfrommethodname.php">
...
<meta name="Description" content="Constructs a ReflectionMethod" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionMethod::__construct - Manual" />
<meta name="twitter:description" content="Constructs a ReflectionMethod" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionMethod::__construct - Manual" />
<meta itemprop="description" content="Constructs a ReflectionMethod" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructs a ReflectionMethod" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionmethod.construct.php' selected="selected">English</option>
            ...
            <option value='ja/reflectionmethod.construct.php'>Japanese</option>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionmethod.construct-examples">
  ...
  <p class="para">
   <div class="example" id="example-5567">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionMethod::__construct()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.decon.php#language.oop5.decon.constructor" class="link">Constructors</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionmethod/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionmethod.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionmethod.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionmethod.construct.php">＋<small>add a note</small></a></span>
