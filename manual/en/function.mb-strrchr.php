...
<head>
  ...
  <title>PHP: mb_strrchr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strrchr.php">
 <link rel="shorturl" href="https://www.php.net/mb-strrchr">
 <link rel="alternate" href="https://www.php.net/mb-strrchr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strrichr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-strrchr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-strrchr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-strrchr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-strrchr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-strrchr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-strrchr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-strrchr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-strrchr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-strrchr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-strrchr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-strrchr.php" hreflang="zh">
...
<meta name="Description" content="Finds the last occurrence of a character in a string within another" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_strrchr - Manual" />
<meta name="twitter:description" content="Finds the last occurrence of a character in a string within another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strrchr - Manual" />
<meta itemprop="description" content="Finds the last occurrence of a character in a string within another" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds the last occurrence of a character in a string within another" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strrchr.php' selected="selected">English</option>
            <option value='de/function.mb-strrchr.php'>German</option>
            <option value='es/function.mb-strrchr.php'>Spanish</option>
            <option value='fr/function.mb-strrchr.php'>French</option>
            <option value='it/function.mb-strrchr.php'>Italian</option>
            <option value='ja/function.mb-strrchr.php'>Japanese</option>
            <option value='pt_BR/function.mb-strrchr.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-strrchr.php'>Russian</option>
            <option value='tr/function.mb-strrchr.php'>Turkish</option>
            <option value='uk/function.mb-strrchr.php'>Ukrainian</option>
            <option value='zh/function.mb-strrchr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-strrchr" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_strrchr</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_strrchr</span> &mdash; <span class="dc-title">Finds the last occurrence of a character in a string within another</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-strrchr-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>mb_strrchr()</strong></span> finds the last occurrence of
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-strrchr-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-strrichr.php" class="function" rel="rdfs-seeAlso">mb_strrichr()</a> - Finds the last occurrence of a character in a string within another, case insensitive</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strrchr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strrchr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strrchr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strrchr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128437">  <div class="votes">
    <div id="Vu128437">
    <a href="/manual/vote-note.php?id=128437&amp;page=function.mb-strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128437">
    <a href="/manual/vote-note.php?id=128437&amp;page=function.mb-strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128437" title="50% like this...">
    0
    </div>
  </div>
  <a href="#128437" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#128437"> &para;</a><div class="date" title="2023-04-28 08:54"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128437">
<div class="phpcode"><code><span class="html">needle: /       <br />string: o/a/i<br /><br />if before_needle is 1  then needle is excluded: "o/a"<br />if before_needle is false  then needle is included:  "/i" <br /><br />as code:<br /><br />$str="o/a/i";<br />$cs="/";<br /><br />echo "if before_needle == 1  then needle is excluded"."\n";<br />$str="o/a/i";<br />$cs="/";<br />echo mb_strrchr ($str,$cs,1)."\n";<br /><br />echo "if before_needle == false  then needle is included"."\n";<br />$str="o/a/i";<br />$cs="/";<br />echo mb_strrchr ($str,$cs,0)."\n";</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-strrchr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strrchr.php">＋<small>add a note</small></a></div>
