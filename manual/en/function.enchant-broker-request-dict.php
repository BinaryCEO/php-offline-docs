...
<head>
  ...
  <title>PHP: enchant_broker_request_dict - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-request-dict.php">
 <link rel="shorturl" href="https://www.php.net/enchant-broker-request-dict">
 <link rel="alternate" href="https://www.php.net/enchant-broker-request-dict" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.enchant.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-list-dicts.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-broker-request-pwl-dict.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.enchant-broker-request-dict.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.enchant-broker-request-dict.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.enchant-broker-request-dict.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.enchant-broker-request-dict.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.enchant-broker-request-dict.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.enchant-broker-request-dict.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.enchant-broker-request-dict.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.enchant-broker-request-dict.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.enchant-broker-request-dict.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.enchant-broker-request-dict.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.enchant-broker-request-dict.php" hreflang="zh">
...
<meta name="Description" content="Create a new dictionary using a tag" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_broker_request_dict - Manual" />
<meta name="twitter:description" content="Create a new dictionary using a tag" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_broker_request_dict - Manual" />
<meta itemprop="description" content="Create a new dictionary using a tag" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new dictionary using a tag" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.enchant-broker-request-pwl-dict.php">
          enchant_broker_request_pwl_dict &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.enchant-broker-list-dicts.php">
          &laquo; enchant_broker_list_dicts        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-request-dict.php' selected="selected">English</option>
            <option value='de/function.enchant-broker-request-dict.php'>German</option>
            <option value='es/function.enchant-broker-request-dict.php'>Spanish</option>
            <option value='fr/function.enchant-broker-request-dict.php'>French</option>
            <option value='it/function.enchant-broker-request-dict.php'>Italian</option>
            <option value='ja/function.enchant-broker-request-dict.php'>Japanese</option>
            <option value='pt_BR/function.enchant-broker-request-dict.php'>Brazilian Portuguese</option>
            <option value='ru/function.enchant-broker-request-dict.php'>Russian</option>
            <option value='tr/function.enchant-broker-request-dict.php'>Turkish</option>
            <option value='uk/function.enchant-broker-request-dict.php'>Ukrainian</option>
            <option value='zh/function.enchant-broker-request-dict.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.enchant-broker-request-dict" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.enchant-broker-free-dict.php" class="function" rel="rdfs-seeAlso">enchant_broker_free_dict()</a> - Free a dictionary resource</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-request-dict.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-request-dict%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-request-dict&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-request-dict.php">＋<small>add a note</small></a></span>
