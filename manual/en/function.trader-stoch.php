...
<head>
  ...
  <title>PHP: trader_stoch - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-stoch.php">
 <link rel="shorturl" href="https://www.php.net/trader-stoch">
 <link rel="alternate" href="https://www.php.net/trader-stoch" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-stddev.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-stochf.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-stoch.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-stoch.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-stoch.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-stoch.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-stoch.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-stoch.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-stoch.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-stoch.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-stoch.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-stoch.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-stoch.php" hreflang="zh">
...
<meta name="Description" content="Stochastic" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_stoch - Manual" />
<meta name="twitter:description" content="Stochastic" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_stoch - Manual" />
<meta itemprop="description" content="Stochastic" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Stochastic" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-stochf.php">
          trader_stochf &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-stddev.php">
          &laquo; trader_stddev        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-stoch.php' selected="selected">English</option>
            <option value='de/function.trader-stoch.php'>German</option>
            <option value='es/function.trader-stoch.php'>Spanish</option>
            <option value='fr/function.trader-stoch.php'>French</option>
            <option value='it/function.trader-stoch.php'>Italian</option>
            <option value='ja/function.trader-stoch.php'>Japanese</option>
            <option value='pt_BR/function.trader-stoch.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-stoch.php'>Russian</option>
            <option value='tr/function.trader-stoch.php'>Turkish</option>
            <option value='uk/function.trader-stoch.php'>Ukrainian</option>
            <option value='zh/function.trader-stoch.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-stoch" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_stoch</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_stoch</span> &mdash; <span class="dc-title">Stochastic</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.trader-stoch-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_stoch</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastK_Period</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowK_Period</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowK_MAType</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowD_Period</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowD_MAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-stoch-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">fastK_Period</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">slowK_Period</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">slowK_MAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for Slow-K. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
   
   
    <dt><code class="parameter">slowD_Period</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">slowD_MAType</code></dt>
    <dd>
     <p class="para">
      Type of Moving Average for Slow-D. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-stoch-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-stoch.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-stoch%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-stoch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stoch.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116218">  <div class="votes">
    <div id="Vu116218">
    <a href="/manual/vote-note.php?id=116218&amp;page=function.trader-stoch&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116218">
    <a href="/manual/vote-note.php?id=116218&amp;page=function.trader-stoch&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116218" title="53% like this...">
    3
    </div>
  </div>
  <a href="#116218" class="name">
  <strong class="user"><em>Bruce D</em></strong></a><a class="genanchor" href="#116218"> &para;</a><div class="date" title="2014-11-23 11:45"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116218">
<div class="phpcode"><code><span class="html">This function returns an array of arrays :<br /><br />index [0]:  %K values<br />index [1]:  %D values</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-stoch&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-stoch.php">＋<small>add a note</small></a></div>
