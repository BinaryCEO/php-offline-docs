...
<head>
  ...
  <title>PHP: Terminology overview - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlinfo.terminology.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlinfo.terminology.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.terminology.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlinfo.intro.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlinfo.api.choosing.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.terminology.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlinfo.terminology.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlinfo.terminology.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlinfo.terminology.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlinfo.terminology.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlinfo.terminology.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlinfo.terminology.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlinfo.terminology.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlinfo.terminology.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlinfo.terminology.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlinfo.terminology.php" hreflang="zh">
...
<meta name="Description" content="Terminology overview" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Terminology overview - Manual" />
<meta name="twitter:description" content="Terminology overview" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Terminology overview - Manual" />
<meta itemprop="description" content="Terminology overview" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Terminology overview" />
...
<div id="layout" class="clearfix">
  ...
  <div class="page-tools">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlinfo.terminology.php' selected="selected">English</option>
            <option value='de/mysqlinfo.terminology.php'>German</option>
            <option value='es/mysqlinfo.terminology.php'>Spanish</option>
            <option value='fr/mysqlinfo.terminology.php'>French</option>
            <option value='it/mysqlinfo.terminology.php'>Italian</option>
            <option value='ja/mysqlinfo.terminology.php'>Japanese</option>
            <option value='pt_BR/mysqlinfo.terminology.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlinfo.terminology.php'>Russian</option>
            <option value='tr/mysqlinfo.terminology.php'>Turkish</option>
            <option value='uk/mysqlinfo.terminology.php'>Ukrainian</option>
            <option value='zh/mysqlinfo.terminology.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlinfo.terminology" class="chapter">
   <h1 class="title">Terminology overview</h1>
   ...
   <p class="para">
    ...
    MySQL-related extension, <code class="literal">mysqli</code>, is
   ...
   <p class="para">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlinfo.terminology%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlinfo.terminology&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.terminology.php">＋<small>add a note</small></a></span>
