...
<head>
  ...
  <title>PHP: Gmagick::commentimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.commentimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.commentimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.commentimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.clear.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.compositeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.commentimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.commentimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.commentimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.commentimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.commentimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.commentimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.commentimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.commentimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.commentimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.commentimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.commentimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::commentimage - Manual" />
<meta name="twitter:description" content="Adds a comment to your image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::commentimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.compositeimage.php">
          Gmagick::compositeimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.clear.php">
          &laquo; Gmagick::clear        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.commentimage.php' selected="selected">English</option>
            <option value='de/gmagick.commentimage.php'>German</option>
            <option value='es/gmagick.commentimage.php'>Spanish</option>
            <option value='fr/gmagick.commentimage.php'>French</option>
            <option value='it/gmagick.commentimage.php'>Italian</option>
            <option value='ja/gmagick.commentimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.commentimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.commentimage.php'>Russian</option>
            <option value='tr/gmagick.commentimage.php'>Turkish</option>
            <option value='uk/gmagick.commentimage.php'>Ukrainian</option>
            <option value='zh/gmagick.commentimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.commentimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::commentimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::commentimage</span> &mdash; <span class="dc-title">Adds a comment to your image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.commentimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::commentimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$comment</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.commentimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.commentimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with comment added.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.commentimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/commentimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.commentimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.commentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.commentimage.php">＋<small>add a note</small></a></span>
