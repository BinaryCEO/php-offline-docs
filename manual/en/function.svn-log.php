...
<head>
  ...
  <title>PHP: svn_log - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-log.php">
 <link rel="shorturl" href="https://www.php.net/svn-log">
 <link rel="alternate" href="https://www.php.net/svn-log" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-import.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-ls.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-log.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-log.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-log.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-log.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-log.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-log.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-log.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-log.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-log.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-log.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-log.php" hreflang="zh">
...
<meta name="Description" content="Returns the commit log messages of a repository URL" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_log - Manual" />
<meta name="twitter:description" content="Returns the commit log messages of a repository URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_log - Manual" />
<meta itemprop="description" content="Returns the commit log messages of a repository URL" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the commit log messages of a repository URL" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.svn-ls.php">
          svn_ls &raquo;
              ...
              <div class="prev">
        <a href="function.svn-import.php">
          &laquo; svn_import        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-log.php' selected="selected">English</option>
            <option value='de/function.svn-log.php'>German</option>
            <option value='es/function.svn-log.php'>Spanish</option>
            <option value='fr/function.svn-log.php'>French</option>
            <option value='it/function.svn-log.php'>Italian</option>
            <option value='ja/function.svn-log.php'>Japanese</option>
            <option value='pt_BR/function.svn-log.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-log.php'>Russian</option>
            <option value='tr/function.svn-log.php'>Turkish</option>
            <option value='uk/function.svn-log.php'>Ukrainian</option>
            <option value='zh/function.svn-log.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-log" class="refentry">
    ...
    <li>
     <a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.log.html" class="link external">&raquo;&nbsp;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-log.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-log%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-log&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-log.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="104326">  <div class="votes">
    <div id="Vu104326">
    <a href="/manual/vote-note.php?id=104326&amp;page=function.svn-log&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104326">
    <a href="/manual/vote-note.php?id=104326&amp;page=function.svn-log&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104326" title="no votes...">
    0
    </div>
  </div>
  <a href="#104326" class="name">
  <strong class="user"><em>php dot net at gnur dot nl</em></strong></a><a class="genanchor" href="#104326"> &para;</a><div class="date" title="2011-06-09 02:42"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104326">
<div class="phpcode"><code><span class="html">Please not that using svn_log without giving revisions is much, much slower then with revisions. Examples:<br /><br />$ time php -r "svn_log('<a href="http://localhost/svn/shopadsl" rel="nofollow" target="_blank">http://localhost/svn/shopadsl</a>');"<br /><br />real    0m2.140s<br />user    0m0.140s<br />sys     0m0.000s<br /><br />VS<br /><br />$ time php -r "svn_log('<a href="http://localhost/svn/shopadsl" rel="nofollow" target="_blank">http://localhost/svn/shopadsl</a>', 0, 45);"<br /><br />real    0m0.063s<br />user    0m0.024s<br />sys     0m0.016s</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.svn-log&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-log.php">＋<small>add a note</small></a></div>
