...
<head>
  ...
  <title>PHP: Imagick::getImageRedPrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageredprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageredprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageredprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageproperty.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageregion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageredprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageredprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageredprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageredprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageredprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageredprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageredprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageredprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageredprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageredprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageredprimary.php" hreflang="zh">
...
<meta name="Description" content="Returns the chromaticity red primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageRedPrimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticity red primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageRedPrimary - Manual" />
<meta itemprop="description" content="Returns the chromaticity red primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the chromaticity red primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageregion.php">
          Imagick::getImageRegion &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageproperty.php">
          &laquo; Imagick::getImageProperty        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageredprimary.php' selected="selected">English</option>
            <option value='de/imagick.getimageredprimary.php'>German</option>
            <option value='es/imagick.getimageredprimary.php'>Spanish</option>
            <option value='fr/imagick.getimageredprimary.php'>French</option>
            <option value='it/imagick.getimageredprimary.php'>Italian</option>
            <option value='ja/imagick.getimageredprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageredprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageredprimary.php'>Russian</option>
            <option value='tr/imagick.getimageredprimary.php'>Turkish</option>
            <option value='uk/imagick.getimageredprimary.php'>Ukrainian</option>
            <option value='zh/imagick.getimageredprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageredprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageRedPrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageRedPrimary</span> &mdash; <span class="dc-title">Returns the chromaticity red primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageredprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageRedPrimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageredprimary-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageredprimary-returnvalues">
...
<span class="classname"><strong class="classname">ImagickException</strong></span> on error.
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageredprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageredprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageredprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageredprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageredprimary.php">＋<small>add a note</small></a></span>
