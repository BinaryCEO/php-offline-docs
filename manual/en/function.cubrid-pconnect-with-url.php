...
<head>
  ...
  <title>PHP: cubrid_pconnect_with_url - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-pconnect-with-url.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-pconnect-with-url">
 <link rel="alternate" href="https://www.php.net/cubrid-pconnect-with-url" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-pconnect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-prepare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-pconnect-with-url.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-pconnect-with-url.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-pconnect-with-url.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-pconnect-with-url.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-pconnect-with-url.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-pconnect-with-url.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-pconnect-with-url.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-pconnect-with-url.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-pconnect-with-url.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-pconnect-with-url.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-pconnect-with-url.php" hreflang="zh">
...
<meta name="Description" content="Open a persistent connection to CUBRID server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_pconnect_with_url - Manual" />
<meta name="twitter:description" content="Open a persistent connection to CUBRID server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_pconnect_with_url - Manual" />
<meta itemprop="description" content="Open a persistent connection to CUBRID server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a persistent connection to CUBRID server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-prepare.php">
          cubrid_prepare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-pconnect.php">
          &laquo; cubrid_pconnect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-pconnect-with-url.php' selected="selected">English</option>
            <option value='de/function.cubrid-pconnect-with-url.php'>German</option>
            <option value='es/function.cubrid-pconnect-with-url.php'>Spanish</option>
            <option value='fr/function.cubrid-pconnect-with-url.php'>French</option>
            <option value='it/function.cubrid-pconnect-with-url.php'>Italian</option>
            <option value='ja/function.cubrid-pconnect-with-url.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-pconnect-with-url.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-pconnect-with-url.php'>Russian</option>
            <option value='tr/function.cubrid-pconnect-with-url.php'>Turkish</option>
            <option value='uk/function.cubrid-pconnect-with-url.php'>Ukrainian</option>
            <option value='zh/function.cubrid-pconnect-with-url.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-pconnect-with-url" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.cubrid-close.php" class="function" rel="rdfs-seeAlso">cubrid_close()</a> - Close CUBRID connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-pconnect-with-url.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-pconnect-with-url%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-pconnect-with-url&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-pconnect-with-url.php">＋<small>add a note</small></a></span>
