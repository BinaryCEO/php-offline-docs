...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intldateformatter.setlenient.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intldateformatter.setlenient.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intldateformatter.setlenient.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intldateformatter.php">
 <link rel="prev" href="https://www.php.net/manual/en/intldateformatter.setcalendar.php">
 <link rel="next" href="https://www.php.net/manual/en/intldateformatter.setpattern.php">
...
<meta name="Description" content="Set the leniency of the parser" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlDateFormatter::setLenient - Manual" />
<meta name="twitter:description" content="Set the leniency of the parser" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlDateFormatter::setLenient - Manual" />
<meta itemprop="description" content="Set the leniency of the parser" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the leniency of the parser" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intldateformatter.setlenient.php' selected="selected">English</option>
            <option value='de/intldateformatter.setlenient.php'>German</option>
            <option value='es/intldateformatter.setlenient.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">IntlDateFormatter::setLenient</span> -- <span class="refname">datefmt_set_lenient</span> &mdash; <span class="dc-title">Set the leniency of the parser</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-intldateformatter.setlenient-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Sets whether the parser is lenient or not, default is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> (lenient).
      </p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-intldateformatter.setlenient-examples">
  <h3 class="title">Examples</h3>
   <div class="example" id="example-2657">
    <p><strong>Example #1 <span class="function"><strong>datefmt_set_lenient()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$fmt </span><span style="color: #007700">= </span><span style="color: #0000BB">datefmt_create</span><span style="color: #007700">(<br />    </span><span style="color: #DD0000">'en_US'</span><span style="color: #007700">, <br />    </span><span style="color: #0000BB">IntlDateFormatter</span><span style="color: #007700">::</span><span style="color: #0000BB">FULL</span><span style="color: #007700">, <br />    </span><span style="color: #0000BB">IntlDateFormatter</span><span style="color: #007700">::</span><span style="color: #0000BB">FULL</span><span style="color: #007700">, <br />    </span><span style="color: #DD0000">'America/Los_Angeles'</span><span style="color: #007700">, <br />    </span><span style="color: #0000BB">IntlDateFormatter</span><span style="color: #007700">::</span><span style="color: #0000BB">GREGORIAN</span><span style="color: #007700">, <br />    </span><span style="color: #DD0000">'dd/MM/yyyy'<br /></span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">'lenient of the formatter is : '</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isLenient</span><span style="color: #007700">()) {<br />    echo </span><span style="color: #DD0000">'TRUE'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'FALSE'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">datefmt_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #DD0000">'35/13/1971'</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"\n Trying to do parse('35/13/1971').\nResult is : " </span><span style="color: #007700">. </span><span style="color: #0000BB">datefmt_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #DD0000">'35/13/1971'</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">intl_get_error_code</span><span style="color: #007700">() != </span><span style="color: #0000BB">0</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"\nError_msg is : " </span><span style="color: #007700">. </span><span style="color: #0000BB">intl_get_error_message</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">"\nError_code is : " </span><span style="color: #007700">. </span><span style="color: #0000BB">intl_get_error_code</span><span style="color: #007700">();<br />}<br /></span><span style="color: #0000BB">datefmt_set_lenient</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #0000BB">false</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"\nNow lenient of the formatter is : "</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">isLenient</span><span style="color: #007700">()) {<br />    echo </span><span style="color: #DD0000">'TRUE'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'FALSE'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">datefmt_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #DD0000">'35/13/1971'</span><span style="color: #007700">);<br />echo </span><span style="color: #DD0000">"\nTrying to do parse('35/13/1971').\nResult is : " </span><span style="color: #007700">. </span><span style="color: #0000BB">datefmt_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$fmt</span><span style="color: #007700">, </span><span style="color: #DD0000">'35/13/1971'</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">intl_get_error_code</span><span style="color: #007700">() != </span><span style="color: #0000BB">0</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"\nError_msg is : "</span><span style="color: #007700">.</span><span style="color: #0000BB">intl_get_error_message</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">"\nError_code is : "</span><span style="color: #007700">.</span><span style="color: #0000BB">intl_get_error_code</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   ...
   <div class="example" id="example-2658">
...
Error_code is : 9</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intldateformatter.setlenient-seealso">
  ...
  <p class="para">
    <ul class="simplelist">
    <li><span class="function"><a href="intldateformatter.islenient.php" class="function" rel="rdfs-seeAlso">datefmt_is_lenient()</a> - Get the lenient used for the IntlDateFormatter</span></li>
    <li><span class="function"><a href="intldateformatter.create.php" class="function" rel="rdfs-seeAlso">datefmt_create()</a> - Create a date formatter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/dateformatter/set-lenient.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintldateformatter.setlenient%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intldateformatter.setlenient&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intldateformatter.setlenient.php">＋<small>add a note</small></a></span>
