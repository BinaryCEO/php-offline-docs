...
<head>
  ...
  <title>PHP: fileowner - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fileowner.php">
 <link rel="shorturl" href="https://www.php.net/fileowner">
 <link rel="alternate" href="https://www.php.net/fileowner" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.filemtime.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fileperms.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fileowner.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fileowner.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fileowner.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fileowner.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fileowner.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fileowner.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fileowner.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fileowner.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fileowner.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fileowner.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fileowner.php" hreflang="zh">
...
<meta name="Description" content="Gets file owner" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fileowner - Manual" />
<meta name="twitter:description" content="Gets file owner" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fileowner - Manual" />
<meta itemprop="description" content="Gets file owner" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets file owner" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fileowner.php' selected="selected">English</option>
            <option value='de/function.fileowner.php'>German</option>
            <option value='es/function.fileowner.php'>Spanish</option>
            <option value='fr/function.fileowner.php'>French</option>
            <option value='it/function.fileowner.php'>Italian</option>
            <option value='ja/function.fileowner.php'>Japanese</option>
            <option value='pt_BR/function.fileowner.php'>Brazilian Portuguese</option>
            <option value='ru/function.fileowner.php'>Russian</option>
            <option value='tr/function.fileowner.php'>Turkish</option>
            <option value='uk/function.fileowner.php'>Ukrainian</option>
            <option value='zh/function.fileowner.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fileowner" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fileowner</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">fileowner</span> &mdash; <span class="dc-title">Gets file owner</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fileowner-returnvalues">
  ...
  <p class="para">
   Returns the user ID of the owner of the file,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
   The user ID is returned in numerical format, use
   <span class="function"><a href="function.posix-getpwuid.php" class="function">posix_getpwuid()</a></span> to resolve it to a username.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.fileowner-examples">
  ...
  <p class="para">
   <div class="example" id="example-2363">
    <p><strong>Example #1 Finding the owner of a file</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.posix-getpwuid.php" class="function" rel="rdfs-seeAlso">posix_getpwuid()</a> - Return info about a user by user id</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/fileowner.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fileowner%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fileowner&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fileowner.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98627">  <div class="votes">
    <div id="Vu98627">
    <a href="/manual/vote-note.php?id=98627&amp;page=function.fileowner&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98627">
    <a href="/manual/vote-note.php?id=98627&amp;page=function.fileowner&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98627" title="63% like this...">
    10
    </div>
  </div>
  <a href="#98627" class="name">
  <strong class="user"><em>dazoe</em></strong></a><a class="genanchor" href="#98627"> &para;</a><div class="date" title="2010-06-27 07:21"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98627">
<div class="phpcode"><code><span class="html">Remember to use if(fileowner(...) === FALSE) instead of if(!fileowner()) or if(fileowner() == FLASE) because if the owner was "root" it would return 0.</span></code></div>
  </div>
 </div>
  <div class="note" id="61248">  <div class="votes">
    <div id="Vu61248">
    <a href="/manual/vote-note.php?id=61248&amp;page=function.fileowner&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61248">
    <a href="/manual/vote-note.php?id=61248&amp;page=function.fileowner&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61248" title="69% like this...">
    9
    </div>
  </div>
  <a href="#61248" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#61248"> &para;</a><div class="date" title="2006-01-29 04:58"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61248">
<div class="phpcode"><code><span class="html">Small note: the function resolves symbolic links. That is, if the link is created by user 999 and maps to a file owned by user 666, this function returns 666 :(</span></code></div>
  </div>
 </div>
  <div class="note" id="124782">  <div class="votes">
    <div id="Vu124782">
    <a href="/manual/vote-note.php?id=124782&amp;page=function.fileowner&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124782">
    <a href="/manual/vote-note.php?id=124782&amp;page=function.fileowner&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124782" title="81% like this...">
    7
    </div>
  </div>
  <a href="#124782" class="name">
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#124782"> &para;</a><div class="date" title="2020-03-02 03:48"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124782">
<div class="phpcode"><code><span class="html">This function will always return 0 on Windows, because Windows does not support numeric user IDs.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fileowner&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fileowner.php">＋<small>add a note</small></a></div>
