...
<head>
  ...
  <title>PHP: ftp_ssl_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-ssl-connect.php">
 <link rel="shorturl" href="https://www.php.net/ftp-ssl-connect">
 <link rel="alternate" href="https://www.php.net/ftp-ssl-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ftp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ftp-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-systype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ftp-ssl-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ftp-ssl-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ftp-ssl-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ftp-ssl-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ftp-ssl-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ftp-ssl-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ftp-ssl-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ftp-ssl-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ftp-ssl-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ftp-ssl-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ftp-ssl-connect.php" hreflang="zh">
...
<meta name="Description" content="Opens a Secure SSL-FTP connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_ssl_connect - Manual" />
<meta name="twitter:description" content="Opens a Secure SSL-FTP connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_ssl_connect - Manual" />
<meta itemprop="description" content="Opens a Secure SSL-FTP connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a Secure SSL-FTP connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-ssl-connect.php' selected="selected">English</option>
            <option value='de/function.ftp-ssl-connect.php'>German</option>
            <option value='es/function.ftp-ssl-connect.php'>Spanish</option>
            <option value='fr/function.ftp-ssl-connect.php'>French</option>
            <option value='it/function.ftp-ssl-connect.php'>Italian</option>
            <option value='ja/function.ftp-ssl-connect.php'>Japanese</option>
            <option value='pt_BR/function.ftp-ssl-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.ftp-ssl-connect.php'>Russian</option>
            <option value='tr/function.ftp-ssl-connect.php'>Turkish</option>
            <option value='uk/function.ftp-ssl-connect.php'>Ukrainian</option>
            <option value='zh/function.ftp-ssl-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ftp-ssl-connect" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ftp-connect.php" class="function" rel="rdfs-seeAlso">ftp_connect()</a> - Opens an FTP connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-ssl-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-ssl-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-ssl-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-ssl-connect.php">＋<small>add a note</small></a></span>
