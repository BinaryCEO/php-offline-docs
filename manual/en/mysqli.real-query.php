...
<head>
  ...
  <title>PHP: mysqli::real_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.real-query.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.real-query.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.real-query.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.real-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.reap-async-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.real-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.real-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.real-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.real-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.real-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.real-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.real-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.real-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.real-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.real-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.real-query.php" hreflang="zh">
...
<meta name="Description" content="Execute an SQL query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::real_query - Manual" />
<meta name="twitter:description" content="Execute an SQL query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::real_query - Manual" />
<meta itemprop="description" content="Execute an SQL query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute an SQL query" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.reap-async-query.php">
          mysqli::reap_async_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.real-escape-string.php">
          &laquo; mysqli::real_escape_string        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.real-query.php' selected="selected">English</option>
            <option value='de/mysqli.real-query.php'>German</option>
            <option value='es/mysqli.real-query.php'>Spanish</option>
            <option value='fr/mysqli.real-query.php'>French</option>
            <option value='it/mysqli.real-query.php'>Italian</option>
            <option value='ja/mysqli.real-query.php'>Japanese</option>
            <option value='pt_BR/mysqli.real-query.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.real-query.php'>Russian</option>
            <option value='tr/mysqli.real-query.php'>Turkish</option>
            <option value='uk/mysqli.real-query.php'>Ukrainian</option>
            <option value='zh/mysqli.real-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.real-query" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.use-result.php" class="function" rel="rdfs-seeAlso">mysqli_use_result()</a> - Initiate a result set retrieval</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/real-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.real-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.real-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.real-query.php">＋<small>add a note</small></a></span>
