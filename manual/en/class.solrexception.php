...
<head>
  ...
  <title>PHP: SolrException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrexception.php">
 <link rel="shorturl" href="https://www.php.net/solrexception">
 <link rel="alternate" href="https://www.php.net/solrexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrcollapsefunction.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/solrexception.getinternalinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.solrexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.solrexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.solrexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.solrexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.solrexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.solrexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.solrexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.solrexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.solrexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.solrexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.solrexception.php" hreflang="zh">
...
<meta name="Description" content="The SolrException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrException - Manual" />
<meta name="twitter:description" content="The SolrException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrException - Manual" />
<meta itemprop="description" content="The SolrException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SolrException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrexception.getinternalinfo.php">
          SolrException::getInternalInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrcollapsefunction.tostring.php">
          &laquo; SolrCollapseFunction::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrexception.php' selected="selected">English</option>
            <option value='de/class.solrexception.php'>German</option>
            <option value='es/class.solrexception.php'>Spanish</option>
            <option value='fr/class.solrexception.php'>French</option>
            <option value='it/class.solrexception.php'>Italian</option>
            <option value='ja/class.solrexception.php'>Japanese</option>
            <option value='pt_BR/class.solrexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.solrexception.php'>Russian</option>
            <option value='tr/class.solrexception.php'>Turkish</option>
            <option value='uk/class.solrexception.php'>Ukrainian</option>
            <option value='zh/class.solrexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.solrexception" class="reference">

 <h1 class="title">The SolrException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL solr &gt;= 0.9.2)</p>


  <div class="section" id="solrexception.intro">
  ...
  <div class="section" id="solrexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">SolrException</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">private</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="solrexception.getinternalinfo.php" class="methodname">getInternalInfo</a></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="solrexception.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="solrexception.props.sourceline"><var class="varname">sourceline</var></dt>
     <dd>
      <p class="para">The line in c-space source file where exception was generated</p>
     </dd>
    
    
     <dt id="solrexception.props.sourcefile"><var class="varname">sourcefile</var></dt>
     <dd>
      <p class="para">The c-space source file where exception was generated</p>
     </dd>
    
    
     <dt id="solrexception.props.zif-name"><var class="varname">zif_name</var></dt>
     <dd>
      <p class="para">The c-space function where exception was generated</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="solrexception.getinternalinfo.php">SolrException::getInternalInfo</a> — Returns internal information where the Exception was thrown</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrexception.php">＋<small>add a note</small></a></span>
