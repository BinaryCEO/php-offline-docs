...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-mod.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-int.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-mul.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-mod.php' selected="selected">English</option>
            ...
            <option value='zh/function.variant-mod.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.variant-idiv.php" class="function" rel="rdfs-seeAlso">variant_idiv()</a> - Converts variants to integers and then returns the result from dividing them</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-mod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-mod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-mod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-mod.php">＋<small>add a note</small></a></span>
