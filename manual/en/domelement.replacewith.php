...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domelement.replacewith.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domelement.replacewith.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domelement.replacewith.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domelement.php">
 <link rel="prev" href="https://www.php.net/manual/en/domelement.replacechildren.php">
 <link rel="next" href="https://www.php.net/manual/en/domelement.setattribute.php">
...
<meta name="Description" content="Replaces the element with new nodes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMElement::replaceWith - Manual" />
<meta name="twitter:description" content="Replaces the element with new nodes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMElement::replaceWith - Manual" />
<meta itemprop="description" content="Replaces the element with new nodes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces the element with new nodes" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domelement.replacewith.php' selected="selected">English</option>
            <option value='de/domelement.replacewith.php'>German</option>
            <option value='es/domelement.replacewith.php'>Spanish</option>
            <option value='fr/domelement.replacewith.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 8)</p><p class="refpurpose"><span class="refname">DOMElement::replaceWith</span> &mdash; <span class="dc-title">Replaces the element with new nodes</span></p>
 ...
 <div class="refsect1 description" id="refsect1-domelement.replacewith-description">
  ...
  <p class="para rdfs-comment">
   Replaces the element with new <code class="parameter">nodes</code>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-domelement.replacewith-examples">
  ...
  <div class="example" id="domelement.replacewith.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>DOMElement::replaceWith()</strong></span> example</strong></p>
...
&lt;container&gt;beautiful&lt;world/&gt;&lt;/container&gt;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-domelement.replacewith-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="domelement.replacechildren.php" class="methodname" rel="rdfs-seeAlso">DOMElement::replaceChildren()</a> - Replace children in element</span></li>
   ...
   <li><span class="methodname"><a href="domelement.remove.php" class="methodname" rel="rdfs-seeAlso">DOMElement::remove()</a> - Removes the element</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domelement/replacewith.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomelement.replacewith%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domelement.replacewith&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domelement.replacewith.php">＋<small>add a note</small></a></span>
