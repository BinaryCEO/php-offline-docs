...
<head>
  ...
  <title>PHP: MongoDB\BSON\toCanonicalExtendedJSON - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mongodb.bson-tocanonicalextendedjson.php">
 <link rel="shorturl" href="https://www.php.net/mongodb.bson-tocanonicalextendedjson">
 <link rel="alternate" href="https://www.php.net/mongodb.bson-tocanonicalextendedjson" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.bson.functions.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mongodb.bson-fromphp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mongodb.bson-tojson.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mongodb.bson-tocanonicalextendedjson.php" hreflang="zh">
...
<meta name="Description" content="Returns the Canonical Extended JSON representation of a BSON value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\toCanonicalExtendedJSON - Manual" />
<meta name="twitter:description" content="Returns the Canonical Extended JSON representation of a BSON value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\toCanonicalExtendedJSON - Manual" />
<meta itemprop="description" content="Returns the Canonical Extended JSON representation of a BSON value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Canonical Extended JSON representation of a BSON value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mongodb.bson-tojson.php">
          MongoDB\BSON\toJSON &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mongodb.bson-fromphp.php">
          &laquo; MongoDB\BSON\fromPHP        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mongodb.bson-tocanonicalextendedjson.php' selected="selected">English</option>
            <option value='de/function.mongodb.bson-tocanonicalextendedjson.php'>German</option>
            <option value='es/function.mongodb.bson-tocanonicalextendedjson.php'>Spanish</option>
            <option value='fr/function.mongodb.bson-tocanonicalextendedjson.php'>French</option>
            <option value='it/function.mongodb.bson-tocanonicalextendedjson.php'>Italian</option>
            <option value='ja/function.mongodb.bson-tocanonicalextendedjson.php'>Japanese</option>
            <option value='pt_BR/function.mongodb.bson-tocanonicalextendedjson.php'>Brazilian Portuguese</option>
            <option value='ru/function.mongodb.bson-tocanonicalextendedjson.php'>Russian</option>
            <option value='tr/function.mongodb.bson-tocanonicalextendedjson.php'>Turkish</option>
            <option value='uk/function.mongodb.bson-tocanonicalextendedjson.php'>Ukrainian</option>
            <option value='zh/function.mongodb.bson-tocanonicalextendedjson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mongodb.bson-tocanonicalextendedjson" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;MongoDB BSON</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/functions/bson/tocanonicalextendedjson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mongodb.bson-tocanonicalextendedjson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mongodb.bson-tocanonicalextendedjson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mongodb.bson-tocanonicalextendedjson.php">＋<small>add a note</small></a></span>
