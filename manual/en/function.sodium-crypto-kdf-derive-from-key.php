...
<head>
  ...
  <title>PHP: sodium_crypto_kdf_derive_from_key - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-kdf-derive-from-key">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-kdf-derive-from-key" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-generichash-update.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-kdf-derive-from-key.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-kdf-derive-from-key.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-kdf-derive-from-key.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-kdf-derive-from-key.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-kdf-derive-from-key.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-kdf-derive-from-key.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-kdf-derive-from-key.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-kdf-derive-from-key.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-kdf-derive-from-key.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-kdf-derive-from-key.php" hreflang="zh">
...
<meta name="Description" content="Derive a subkey" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_kdf_derive_from_key - Manual" />
<meta name="twitter:description" content="Derive a subkey" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_kdf_derive_from_key - Manual" />
<meta itemprop="description" content="Derive a subkey" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Derive a subkey" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-kdf-keygen.php">
          sodium_crypto_kdf_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-generichash-update.php">
          &laquo; sodium_crypto_generichash_update        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-kdf-derive-from-key.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-kdf-derive-from-key.php'>German</option>
            <option value='es/function.sodium-crypto-kdf-derive-from-key.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-kdf-derive-from-key.php'>French</option>
            <option value='it/function.sodium-crypto-kdf-derive-from-key.php'>Italian</option>
            <option value='ja/function.sodium-crypto-kdf-derive-from-key.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-kdf-derive-from-key.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-kdf-derive-from-key.php'>Russian</option>
            <option value='tr/function.sodium-crypto-kdf-derive-from-key.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-kdf-derive-from-key.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-kdf-derive-from-key.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-kdf-derive-from-key" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_kdf_derive_from_key</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_kdf_derive_from_key</span> &mdash; <span class="dc-title">Derive a subkey</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-kdf-derive-from-key-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_kdf_derive_from_key</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$subkey_length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$subkey_id</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$context</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Derive a subkey from a root key and additional context.
  </p>
  <p class="para">
   Similar to <span class="function"><a href="function.hash-hkdf.php" class="function">hash_hkdf()</a></span>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-kdf-derive-from-key-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">subkey_length</code></dt>
    <dd>
     <p class="para">
    ...
    <dt><code class="parameter">subkey_id</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-kdf-derive-from-key-returnvalues">
  ...
  <p class="para">
   A string of pseudorandom (raw binary) bytes.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-kdf-derive-from-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-kdf-derive-from-key%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-kdf-derive-from-key&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php">＋<small>add a note</small></a></span>
