...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagescale.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imagesavealpha.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesetbrush.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagescale.php' selected="selected">English</option>
            ...
            <option value='zh/function.imagescale.php'>Chinese (Simplified)</option>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagescale-returnvalues">
  ...
  <p class="para">
   Return the scaled image object on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagecopyresampled.php" class="function" rel="rdfs-seeAlso">imagecopyresampled()</a> - Copy and resize part of an image with resampling</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagescale.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagescale%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagescale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagescale.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Seemingly, you can't omit the width the same way you do with the height. If you write -1 for the width and specify a number for the height it will return false</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>cognettings at gmail dot com</em></strong></a><a class="genanchor" href="#130219"> &para;</a><div class="date" title="2025-04-02 02:41"><strong>5 months ago</strong></div>
  <div class="text" id="Hcom130219">
<div class="phpcode"><code><span class="html">To resize height without specifying a width you can rotate the image by 90 degrees, resize, then rotate by 270 degrees.<br /><br />        $outputImage = imagerotate($image, 90, 0);<br />        $outputImage = imagescale($outputImage, $minSize);<br />        $outputImage = imagerotate($outputImage, 270, 0);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagescale&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagescale.php">＋<small>add a note</small></a></div>
