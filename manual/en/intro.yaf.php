...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.yaf.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.yaf.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.yaf.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.yaf.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.yaf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.yaf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.yaf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.yaf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.yaf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.yaf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.yaf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.yaf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.yaf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.yaf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.yaf.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.yaf.php' selected="selected">English</option>
            <option value='de/intro.yaf.php'>German</option>
            <option value='es/intro.yaf.php'>Spanish</option>
            <option value='fr/intro.yaf.php'>French</option>
            <option value='it/intro.yaf.php'>Italian</option>
            <option value='ja/intro.yaf.php'>Japanese</option>
            <option value='pt_BR/intro.yaf.php'>Brazilian Portuguese</option>
            <option value='ru/intro.yaf.php'>Russian</option>
            <option value='tr/intro.yaf.php'>Turkish</option>
            <option value='uk/intro.yaf.php'>Ukrainian</option>
            <option value='zh/intro.yaf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.yaf" class="preface">
  ...
  <p class="para">
   For a quick start guide, please refer to the <a href="yaf.tutorials.php" class="link">Tutorials</a> section.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.yaf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.yaf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.yaf.php">＋<small>add a note</small></a></span>
