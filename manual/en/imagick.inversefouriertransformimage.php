...
<head>
  ...
  <title>PHP: Imagick::inverseFourierTransformImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.importimagepixels.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.labelimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.inversefouriertransformimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.inversefouriertransformimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.inversefouriertransformimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.inversefouriertransformimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.inversefouriertransformimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.inversefouriertransformimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.inversefouriertransformimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.inversefouriertransformimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.inversefouriertransformimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.inversefouriertransformimage.php" hreflang="zh">
...
<meta name="Description" content="Implements the inverse discrete Fourier transform (DFT)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::inverseFourierTransformImage - Manual" />
<meta name="twitter:description" content="Implements the inverse discrete Fourier transform (DFT)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::inverseFourierTransformImage - Manual" />
<meta itemprop="description" content="Implements the inverse discrete Fourier transform (DFT)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Implements the inverse discrete Fourier transform (DFT)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.labelimage.php">
          Imagick::labelImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.importimagepixels.php">
          &laquo; Imagick::importImagePixels        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.inversefouriertransformimage.php' selected="selected">English</option>
            <option value='de/imagick.inversefouriertransformimage.php'>German</option>
            <option value='es/imagick.inversefouriertransformimage.php'>Spanish</option>
            <option value='fr/imagick.inversefouriertransformimage.php'>French</option>
            <option value='it/imagick.inversefouriertransformimage.php'>Italian</option>
            <option value='ja/imagick.inversefouriertransformimage.php'>Japanese</option>
            <option value='pt_BR/imagick.inversefouriertransformimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.inversefouriertransformimage.php'>Russian</option>
            <option value='tr/imagick.inversefouriertransformimage.php'>Turkish</option>
            <option value='uk/imagick.inversefouriertransformimage.php'>Ukrainian</option>
            <option value='zh/imagick.inversefouriertransformimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.inversefouriertransformimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::inverseFourierTransformImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::inverseFourierTransformImage</span> &mdash; <span class="dc-title">Implements the inverse discrete Fourier transform (DFT)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.inversefouriertransformimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::inverseFourierTransformImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$complement</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$magnitude</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.inversefouriertransformimage-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">complement</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.inversefouriertransformimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/inversefouriertransformimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.inversefouriertransformimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.inversefouriertransformimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.inversefouriertransformimage.php">＋<small>add a note</small></a></span>
