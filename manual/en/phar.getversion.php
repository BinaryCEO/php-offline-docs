...
<head>
  ...
  <title>PHP: Phar::getVersion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.getversion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.getversion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.getversion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.getsupportedsignatures.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.hasmetadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.getversion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.getversion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.getversion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.getversion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.getversion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.getversion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.getversion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.getversion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.getversion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.getversion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.getversion.php" hreflang="zh">
...
<meta name="Description" content="Return version info of Phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::getVersion - Manual" />
<meta name="twitter:description" content="Return version info of Phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::getVersion - Manual" />
<meta itemprop="description" content="Return version info of Phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return version info of Phar archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.hasmetadata.php">
          Phar::hasMetadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.getsupportedsignatures.php">
          &laquo; Phar::getSupportedSignatures        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.getversion.php' selected="selected">English</option>
            <option value='de/phar.getversion.php'>German</option>
            <option value='es/phar.getversion.php'>Spanish</option>
            <option value='fr/phar.getversion.php'>French</option>
            <option value='it/phar.getversion.php'>Italian</option>
            <option value='ja/phar.getversion.php'>Japanese</option>
            <option value='pt_BR/phar.getversion.php'>Brazilian Portuguese</option>
            <option value='ru/phar.getversion.php'>Russian</option>
            <option value='tr/phar.getversion.php'>Turkish</option>
            <option value='uk/phar.getversion.php'>Ukrainian</option>
            <option value='zh/phar.getversion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.getversion" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::getVersion</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Phar::getVersion</span> &mdash; <span class="dc-title">Return version info of Phar archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.getversion-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::getVersion</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.getversion-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
  </p>
 </div>

 <div class="refsect1 returnvalues" id="refsect1-phar.getversion-returnvalues">
  ...
  <p class="para">
   ...
   its manifest.  See <a href="phar.fileformat.php" class="link">Phar file format</a>
   documentation for more information.
  </p>
 </div>

 <div class="refsect1 seealso" id="refsect1-phar.getversion-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="phar.apiversion.php" class="function" rel="rdfs-seeAlso">Phar::apiVersion()</a> - Returns the api version</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/getVersion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.getversion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.getversion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.getversion.php">＋<small>add a note</small></a></span>
