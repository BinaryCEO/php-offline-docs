...
<head>
  ...
  <title>PHP: Imagick::clipImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clipimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clipimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clipimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clear.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clipimagepath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clipimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clipimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clipimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clipimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clipimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clipimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clipimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clipimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clipimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clipimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clipimage.php" hreflang="zh">
...
<meta name="Description" content="Clips along the first path from the 8BIM profile" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clipImage - Manual" />
<meta name="twitter:description" content="Clips along the first path from the 8BIM profile" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clipImage - Manual" />
<meta itemprop="description" content="Clips along the first path from the 8BIM profile" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clips along the first path from the 8BIM profile" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.clipimagepath.php">
          Imagick::clipImagePath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clear.php">
          &laquo; Imagick::clear        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clipimage.php' selected="selected">English</option>
            <option value='de/imagick.clipimage.php'>German</option>
            <option value='es/imagick.clipimage.php'>Spanish</option>
            <option value='fr/imagick.clipimage.php'>French</option>
            <option value='it/imagick.clipimage.php'>Italian</option>
            <option value='ja/imagick.clipimage.php'>Japanese</option>
            <option value='pt_BR/imagick.clipimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clipimage.php'>Russian</option>
            <option value='tr/imagick.clipimage.php'>Turkish</option>
            <option value='uk/imagick.clipimage.php'>Ukrainian</option>
            <option value='zh/imagick.clipimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clipimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::clipImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::clipImage</span> &mdash; <span class="dc-title">Clips along the first path from the 8BIM profile</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.clipimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::clipImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.clipimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.clipimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.clipimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clipimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clipimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clipimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clipimage.php">＋<small>add a note</small></a></span>
