...
<head>
  ...
  <title>PHP: MongoDB\Driver\Exception\BulkWriteException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-exception-bulkwriteexception.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-exception-bulkwriteexception">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-exception-bulkwriteexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-exception-authenticationexception.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-bulkwriteexception.getwriteresult.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-exception-bulkwriteexception.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Exception\BulkWriteException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Exception\BulkWriteException - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Exception\BulkWriteException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Exception\BulkWriteException - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Exception\BulkWriteException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Exception\BulkWriteException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-bulkwriteexception.getwriteresult.php">
          MongoDB\Driver\Exception\BulkWriteException::getWriteResult &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mongodb-driver-exception-authenticationexception.php">
          &laquo; MongoDB\Driver\Exception\AuthenticationException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-exception-bulkwriteexception.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-exception-bulkwriteexception.php'>German</option>
            <option value='es/class.mongodb-driver-exception-bulkwriteexception.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-exception-bulkwriteexception.php'>French</option>
            <option value='it/class.mongodb-driver-exception-bulkwriteexception.php'>Italian</option>
            <option value='ja/class.mongodb-driver-exception-bulkwriteexception.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-exception-bulkwriteexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-exception-bulkwriteexception.php'>Russian</option>
            <option value='tr/class.mongodb-driver-exception-bulkwriteexception.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-exception-bulkwriteexception.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-exception-bulkwriteexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-exception-bulkwriteexception" class="reference">
  ...
  <div class="section" id="mongodb-driver-exception-bulkwriteexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">MongoDB\Driver\Exception\BulkWriteException</strong>
     </span>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="class.mongodb-driver-writeresult.php" class="type MongoDB\Driver\WriteResult">MongoDB\Driver\WriteResult</a></span>
      <var class="varname"><a href="class.mongodb-driver-exception-bulkwriteexception.php#mongodb-driver-exception-bulkwriteexception.props.writeresult">$<var class="varname">writeResult</var></a></var>;</div>
...
<div class="fieldsynopsis"><span class="modifier">private</span>
   ...
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="mongodb-driver-bulkwriteexception.getwriteresult.php" class="methodname">getWriteResult</a></span>(): <span class="type"><a href="class.mongodb-driver-writeresult.php" class="type MongoDB\Driver\WriteResult">MongoDB\Driver\WriteResult</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section" id="mongodb-driver-exception-bulkwriteexception.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="mongodb-driver-exception-bulkwriteexception.props.writeresult"><var class="varname">writeResult</var></dt>
     <dd>
      <p class="para">
       ...
       <tr>
        ...
        <td>
         <p class="para">
          ...
          instead of
          <span class="classname"><a href="class.mongodb-driver-exception-writeexception.php" class="classname">MongoDB\Driver\Exception\WriteException</a></span>.
         </p>
        </td>
       </tr>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-bulkwriteexception.getwriteresult.php">MongoDB\Driver\Exception\BulkWriteException::getWriteResult</a> — Returns the WriteResult for the failed write operation</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/exception/bulkwriteexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-exception-bulkwriteexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-exception-bulkwriteexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-exception-bulkwriteexception.php">＋<small>add a note</small></a></span>
