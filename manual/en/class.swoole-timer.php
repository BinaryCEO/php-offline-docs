...
<head>
  ...
  <title>PHP: Swoole\Timer - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-timer.php">
 <link rel="shorturl" href="https://www.php.net/swoole-timer">
 <link rel="alternate" href="https://www.php.net/swoole-timer" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-table.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-timer.after.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-timer.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-timer.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-timer.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-timer.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-timer.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-timer.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-timer.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-timer.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-timer.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-timer.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-timer.php" hreflang="zh">
...
<meta name="Description" content="The Swoole\Timer class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Swoole\Timer - Manual" />
<meta name="twitter:description" content="The Swoole\Timer class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Swoole\Timer - Manual" />
<meta itemprop="description" content="The Swoole\Timer class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Swoole\Timer class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="swoole-timer.after.php">
          Swoole\Timer::after &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="swoole-table.valid.php">
          &laquo; Swoole\Table::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-timer.php' selected="selected">English</option>
            <option value='de/class.swoole-timer.php'>German</option>
            <option value='es/class.swoole-timer.php'>Spanish</option>
            <option value='fr/class.swoole-timer.php'>French</option>
            <option value='it/class.swoole-timer.php'>Italian</option>
            <option value='ja/class.swoole-timer.php'>Japanese</option>
            <option value='pt_BR/class.swoole-timer.php'>Brazilian Portuguese</option>
            <option value='ru/class.swoole-timer.php'>Russian</option>
            <option value='tr/class.swoole-timer.php'>Turkish</option>
            <option value='uk/class.swoole-timer.php'>Ukrainian</option>
            <option value='zh/class.swoole-timer.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.swoole-timer" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-timer.after.php">Swoole\Timer::after</a> — Trigger a callback function after a period of time.</li><li><a href="swoole-timer.clear.php">Swoole\Timer::clear</a> — Delete a timer by timer ID.</li><li><a href="swoole-timer.exists.php">Swoole\Timer::exists</a> — Check if a timer is existed.</li><li><a href="swoole-timer.tick.php">Swoole\Timer::tick</a> — Repeats a given function at every given time-interval.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.timer.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-timer%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-timer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-timer.php">＋<small>add a note</small></a></span>
