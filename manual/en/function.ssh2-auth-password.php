...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$connection </span><span style="color: #007700">= </span><span style="color: #0000BB">ssh2_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'shell.example.com'</span><span style="color: #007700">, </span><span style="color: #0000BB">22</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">ssh2_auth_password</span><span style="color: #007700">(</span><span style="color: #0000BB">$connection</span><span style="color: #007700">, </span><span style="color: #DD0000">'username'</span><span style="color: #007700">, </span><span style="color: #DD0000">'secret'</span><span style="color: #007700">)) {<br />  echo </span><span style="color: #DD0000">"Authentication Successful!\n"</span><span style="color: #007700">;<br />} else {<br />  die(</span><span style="color: #DD0000">'Authentication Failed...'</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="head">
  ...
  <div class="note" id="117558">  <div class="votes">
    ...
    <div class="tally" id="V117558" title="51% like this...">
    1
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Please note that the function ssh2_auth_password raises PHP warning(!) on bad authentication. To avoid the warning, use the "silence" ("@") operator.<br /><br /><span class="default">&lt;?php<br />$ssh </span><span class="keyword">= </span><span class="default">ssh2_connect</span><span class="keyword">(</span><span class="default">$host</span><span class="keyword">);<br />if (</span><span class="default">false </span><span class="keyword">=== </span><span class="default">$ssh</span><span class="keyword">) {<br />    die(</span><span class="string">'connection failed'</span><span class="keyword">);<br />}<br /><br /></span><span class="default">$auth </span><span class="keyword">= @</span><span class="default">ssh2_auth_password</span><span class="keyword">(</span><span class="default">$ssh</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">$password</span><span class="keyword">);<br />if (</span><span class="default">false </span><span class="keyword">=== </span><span class="default">$auth</span><span class="keyword">) {<br />    die(</span><span class="string">'authentication failed'</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
