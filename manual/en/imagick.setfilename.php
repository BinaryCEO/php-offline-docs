...
<head>
  ...
  <title>PHP: Imagick::setFilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setfilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setfilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setcompressionquality.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setfirstiterator.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setfilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setfilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setfilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setfilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setfilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setfilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setfilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setfilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setfilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setfilename.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setFilename - Manual" />
<meta name="twitter:description" content="Sets the filename before you read or write the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setFilename - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setfirstiterator.php">
          Imagick::setFirstIterator &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setcompressionquality.php">
          &laquo; Imagick::setCompressionQuality        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setfilename.php' selected="selected">English</option>
            <option value='de/imagick.setfilename.php'>German</option>
            <option value='es/imagick.setfilename.php'>Spanish</option>
            <option value='fr/imagick.setfilename.php'>French</option>
            <option value='it/imagick.setfilename.php'>Italian</option>
            <option value='ja/imagick.setfilename.php'>Japanese</option>
            <option value='pt_BR/imagick.setfilename.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setfilename.php'>Russian</option>
            <option value='tr/imagick.setfilename.php'>Turkish</option>
            <option value='uk/imagick.setfilename.php'>Ukrainian</option>
            <option value='zh/imagick.setfilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setfilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setFilename</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setFilename</span> &mdash; <span class="dc-title">Sets the filename before you read or write the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setfilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setFilename</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setfilename-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setfilename-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setfilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setfilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setfilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setfilename.php">＋<small>add a note</small></a></span>
