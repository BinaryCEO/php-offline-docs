...
<head>
  ...
  <title>PHP: ibase_wait_event - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-wait-event.php">
 <link rel="shorturl" href="https://www.php.net/ibase-wait-event">
 <link rel="alternate" href="https://www.php.net/ibase-wait-event" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-trans.php">
 <link rel="next" href="https://www.php.net/manual/en/book.ibm-db2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-wait-event.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-wait-event.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-wait-event.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-wait-event.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-wait-event.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-wait-event.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-wait-event.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-wait-event.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-wait-event.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-wait-event.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-wait-event.php" hreflang="zh">
...
<meta name="Description" content="Wait for an event to be posted by the database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_wait_event - Manual" />
<meta name="twitter:description" content="Wait for an event to be posted by the database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_wait_event - Manual" />
<meta itemprop="description" content="Wait for an event to be posted by the database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Wait for an event to be posted by the database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-wait-event.php' selected="selected">English</option>
            <option value='de/function.ibase-wait-event.php'>German</option>
            <option value='es/function.ibase-wait-event.php'>Spanish</option>
            <option value='fr/function.ibase-wait-event.php'>French</option>
            <option value='it/function.ibase-wait-event.php'>Italian</option>
            <option value='ja/function.ibase-wait-event.php'>Japanese</option>
            <option value='pt_BR/function.ibase-wait-event.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-wait-event.php'>Russian</option>
            <option value='tr/function.ibase-wait-event.php'>Turkish</option>
            <option value='uk/function.ibase-wait-event.php'>Ukrainian</option>
            <option value='zh/function.ibase-wait-event.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-wait-event" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-free-event-handler.php" class="function" rel="rdfs-seeAlso">ibase_free_event_handler()</a> - Cancels a registered event handler</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-wait-event.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-wait-event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-wait-event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-wait-event.php">＋<small>add a note</small></a></span>
