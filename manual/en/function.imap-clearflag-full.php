...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-clearflag-full.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-check.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-clearflag-full.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-clearflag-full.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-clearflag-full.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-clearflag-full.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-clearflag-full.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-clearflag-full.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-clearflag-full.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-clearflag-full.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-clearflag-full.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-clearflag-full.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-clearflag-full.php" hreflang="zh">
...
<meta name="Description" content="Clears flags on messages" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_clearflag_full - Manual" />
<meta name="twitter:description" content="Clears flags on messages" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_clearflag_full - Manual" />
<meta itemprop="description" content="Clears flags on messages" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clears flags on messages" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-clearflag-full.php' selected="selected">English</option>
            ...
            <option value='tr/function.imap-clearflag-full.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_clearflag_full</span> &mdash; <span class="dc-title">Clears flags on messages</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imap-clearflag-full-description">
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">flag</code> to the flags set for the
   messages in the specified <code class="parameter">sequence</code>.
  </p>
 </div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       ...
       &quot;\\Deleted&quot;, and &quot;\\Draft&quot; (as defined by <a href="https://datatracker.ietf.org/doc/html/rfc2060" class="link external">&raquo;&nbsp;RFC2060</a>)
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       <code class="parameter">options</code> are a bit mask and may contain
       the single option:
 ...
 <div class="refsect1 errors" id="refsect1-function.imap-clearflag-full-errors">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">options</code> is invalid.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-clearflag-full-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-setflag-full.php" class="function" rel="rdfs-seeAlso">imap_setflag_full()</a> - Sets flags on messages</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-clearflag-full.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-clearflag-full%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-clearflag-full&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-clearflag-full.php">＋<small>add a note</small></a></span>
