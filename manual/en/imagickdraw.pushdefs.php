...
<head>
  ...
  <title>PHP: ImagickDraw::pushDefs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pushdefs.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pushdefs.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pushdefs.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pushpattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pushdefs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pushdefs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pushdefs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pushdefs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pushdefs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pushdefs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pushdefs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pushdefs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pushdefs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pushdefs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pushdefs.php" hreflang="zh">
...
<meta name="Description" content="Indicates that following commands create named elements for early processing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pushDefs - Manual" />
<meta name="twitter:description" content="Indicates that following commands create named elements for early processing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pushDefs - Manual" />
<meta itemprop="description" content="Indicates that following commands create named elements for early processing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Indicates that following commands create named elements for early processing" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pushpattern.php">
          ImagickDraw::pushPattern &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pushclippath.php">
          &laquo; ImagickDraw::pushClipPath        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pushdefs.php' selected="selected">English</option>
            <option value='de/imagickdraw.pushdefs.php'>German</option>
            <option value='es/imagickdraw.pushdefs.php'>Spanish</option>
            <option value='fr/imagickdraw.pushdefs.php'>French</option>
            <option value='it/imagickdraw.pushdefs.php'>Italian</option>
            <option value='ja/imagickdraw.pushdefs.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pushdefs.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pushdefs.php'>Russian</option>
            <option value='tr/imagickdraw.pushdefs.php'>Turkish</option>
            <option value='uk/imagickdraw.pushdefs.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pushdefs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pushdefs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pushDefs</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pushDefs</span> &mdash; <span class="dc-title">Indicates that following commands create named elements for early processing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pushdefs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pushDefs</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">This function is
currently not documented; only its argument list is available.
</p></div>
  <p class="para">
   Indicates that commands up to a terminating <span class="methodname"><a href="imagickdraw.popdefs.php" class="methodname">ImagickDraw::popDefs()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pushdefs-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pushdefs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pushdefs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pushdefs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pushdefs.php">＋<small>add a note</small></a></span>
