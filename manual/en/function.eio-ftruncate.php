...
<head>
  ...
  <title>PHP: eio_ftruncate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-ftruncate.php">
 <link rel="shorturl" href="https://www.php.net/eio-ftruncate">
 <link rel="alternate" href="https://www.php.net/eio-ftruncate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-fsync.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-futime.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-ftruncate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-ftruncate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-ftruncate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-ftruncate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-ftruncate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-ftruncate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-ftruncate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-ftruncate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-ftruncate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-ftruncate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-ftruncate.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: eio_ftruncate - Manual" />
<meta name="twitter:description" content="Truncate a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_ftruncate - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-futime.php">
          eio_futime &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-ftruncate.php' selected="selected">English</option>
            <option value='de/function.eio-ftruncate.php'>German</option>
            <option value='es/function.eio-ftruncate.php'>Spanish</option>
            <option value='fr/function.eio-ftruncate.php'>French</option>
            <option value='it/function.eio-ftruncate.php'>Italian</option>
            <option value='ja/function.eio-ftruncate.php'>Japanese</option>
            <option value='pt_BR/function.eio-ftruncate.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-ftruncate.php'>Russian</option>
            <option value='tr/function.eio-ftruncate.php'>Turkish</option>
            <option value='uk/function.eio-ftruncate.php'>Ukrainian</option>
            <option value='zh/function.eio-ftruncate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-ftruncate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_ftruncate</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_ftruncate</span> &mdash; <span class="dc-title">Truncate a file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-ftruncate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_ftruncate</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_ftruncate()</strong></span> causes a regular file referenced by
  <code class="parameter">fd</code> file descriptor to be truncated to precisely
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-ftruncate-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-ftruncate-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_ftruncate()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>



 <div class="refsect1 seealso" id="refsect1-function.eio-ftruncate-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-truncate.php" class="function" rel="rdfs-seeAlso">eio_truncate()</a> - Truncate a file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-ftruncate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-ftruncate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-ftruncate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-ftruncate.php">＋<small>add a note</small></a></span>
