...
<head>
  ...
  <title>PHP: posix_getcwd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getcwd.php">
 <link rel="shorturl" href="https://www.php.net/posix-getcwd">
 <link rel="alternate" href="https://www.php.net/posix-getcwd" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-get-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getegid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getcwd.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getcwd.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getcwd.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getcwd.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getcwd.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getcwd.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getcwd.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getcwd.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getcwd.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getcwd.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getcwd.php" hreflang="zh">
...
<meta name="Description" content="Pathname of current directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getcwd - Manual" />
<meta name="twitter:description" content="Pathname of current directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getcwd - Manual" />
<meta itemprop="description" content="Pathname of current directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Pathname of current directory" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-getegid.php">
          posix_getegid &raquo;
              ...
              <div class="prev">
        <a href="function.posix-get-last-error.php">
          &laquo; posix_get_last_error        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getcwd.php' selected="selected">English</option>
            <option value='de/function.posix-getcwd.php'>German</option>
            <option value='es/function.posix-getcwd.php'>Spanish</option>
            <option value='fr/function.posix-getcwd.php'>French</option>
            <option value='it/function.posix-getcwd.php'>Italian</option>
            <option value='ja/function.posix-getcwd.php'>Japanese</option>
            <option value='pt_BR/function.posix-getcwd.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getcwd.php'>Russian</option>
            <option value='tr/function.posix-getcwd.php'>Turkish</option>
            <option value='uk/function.posix-getcwd.php'>Ukrainian</option>
            <option value='zh/function.posix-getcwd.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getcwd" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-getcwd-examples">
  ...
  <p class="para">
   <div class="example" id="example-3575">
    <p><strong>Example #1 <span class="function"><strong>posix_getcwd()</strong></span> example</strong></p>
    ...
    <ul class="itemizedlist">
     ...
     <li class="listitem">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getcwd.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getcwd%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getcwd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getcwd.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="7106">  <div class="votes">
    <div id="Vu7106">
    <a href="/manual/vote-note.php?id=7106&amp;page=function.posix-getcwd&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd7106">
    <a href="/manual/vote-note.php?id=7106&amp;page=function.posix-getcwd&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V7106" title="50% like this...">
    0
    </div>
  </div>
  <a href="#7106" class="name">
  <strong class="user"><em>phpmanual-getcwd at devin dot com</em></strong></a><a class="genanchor" href="#7106"> &para;</a><div class="date" title="2000-07-26 06:39"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom7106">
<div class="phpcode"><code><span class="html">From the GNU getcwd(3) manpage, paraphrased: returns the absolute pathname of the current working directory.  Fails when the current directory is not eradable.  Complies with POSIX.1 spec.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-getcwd&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getcwd.php">＋<small>add a note</small></a></div>
