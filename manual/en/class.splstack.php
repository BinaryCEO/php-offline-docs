...
<head>
  ...
  <title>PHP: SplStack - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.splstack.php">
 <link rel="shorturl" href="https://www.php.net/splstack">
 <link rel="alternate" href="https://www.php.net/splstack" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.datastructures.php">
 <link rel="prev" href="https://www.php.net/manual/en/spldoublylinkedlist.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/class.splqueue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.splstack.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.splstack.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.splstack.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.splstack.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.splstack.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.splstack.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.splstack.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.splstack.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.splstack.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.splstack.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.splstack.php" hreflang="zh">
...
<meta name="Description" content="The SplStack class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplStack - Manual" />
<meta name="twitter:description" content="The SplStack class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplStack - Manual" />
<meta itemprop="description" content="The SplStack class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SplStack class" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.splqueue.php">
          SplQueue &raquo;
              ...
              <div class="prev">
        <a href="spldoublylinkedlist.valid.php">
          &laquo; SplDoublyLinkedList::valid        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.splstack.php' selected="selected">English</option>
            <option value='de/class.splstack.php'>German</option>
            <option value='es/class.splstack.php'>Spanish</option>
            <option value='fr/class.splstack.php'>French</option>
            <option value='it/class.splstack.php'>Italian</option>
            <option value='ja/class.splstack.php'>Japanese</option>
            <option value='pt_BR/class.splstack.php'>Brazilian Portuguese</option>
            <option value='ru/class.splstack.php'>Russian</option>
            <option value='tr/class.splstack.php'>Turkish</option>
            <option value='uk/class.splstack.php'>Ukrainian</option>
            <option value='zh/class.splstack.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.splstack" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="splstack.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The SplStack class provides the main functionalities of a stack implemented using a doubly linked list by
    setting the iterator mode to <strong><code><a href="class.spldoublylinkedlist.php#spldoublylinkedlist.constants.it-mode-lifo">SplDoublyLinkedList::IT_MODE_LIFO</a></code></strong>.
   </p>
  </div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="spldoublylinkedlist.add.php" class="methodname">SplDoublyLinkedList::add</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
1
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splstack.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.splstack%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.splstack&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.splstack.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114163">  <div class="votes">
    <div id="Vu114163">
    <a href="/manual/vote-note.php?id=114163&amp;page=class.splstack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114163">
    <a href="/manual/vote-note.php?id=114163&amp;page=class.splstack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114163" title="81% like this...">
    42
    </div>
  </div>
  <a href="#114163" class="name">
  <strong class="user"><em>lsroudi at gmail dot com</em></strong></a><a class="genanchor" href="#114163"> &para;</a><div class="date" title="2014-01-19 12:03"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114163">
<div class="phpcode"><code><span class="html">the SplStack is  simply a SplDoublyLinkedList with  an iteration mode IT_MODE_LIFO and IT_MODE_KEEP</span></code></div>
  </div>
 </div>
  <div class="note" id="121365">  <div class="votes">
    <div id="Vu121365">
    <a href="/manual/vote-note.php?id=121365&amp;page=class.splstack&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121365">
    <a href="/manual/vote-note.php?id=121365&amp;page=class.splstack&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121365" title="66% like this...">
    8
    </div>
  </div>
  <a href="#121365" class="name">
  <strong class="user"><em>lincoln dot du dot j at gmail dot com</em></strong></a><a class="genanchor" href="#121365"> &para;</a><div class="date" title="2017-07-12 06:48"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121365">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">//SplStack Mode is LIFO (Last In First Out)<br />  <br /></span><span class="default">$q </span><span class="keyword">= new </span><span class="default">SplStack</span><span class="keyword">();<br /><br /></span><span class="default">$q</span><span class="keyword">[] = </span><span class="default">1</span><span class="keyword">;<br /></span><span class="default">$q</span><span class="keyword">[] = </span><span class="default">2</span><span class="keyword">;<br /></span><span class="default">$q</span><span class="keyword">[] = </span><span class="default">3</span><span class="keyword">;<br /></span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">push</span><span class="keyword">(</span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">add</span><span class="keyword">(</span><span class="default">4</span><span class="keyword">,</span><span class="default">5</span><span class="keyword">);<br /><br /></span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">rewind</span><span class="keyword">();<br />while(</span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">valid</span><span class="keyword">()){<br />    echo </span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">current</span><span class="keyword">(),</span><span class="string">"\n"</span><span class="keyword">;<br />    </span><span class="default">$q</span><span class="keyword">-&gt;</span><span class="default">next</span><span class="keyword">();<br />}<br /></span><span class="default">?&gt;<br /></span><br />Output<br />5<br />4<br />3<br />2<br />1</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.splstack&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.splstack.php">＋<small>add a note</small></a></div>
