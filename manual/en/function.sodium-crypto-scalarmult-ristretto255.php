...
<head>
  ...
  <title>PHP: sodium_crypto_scalarmult_ristretto255 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult-ristretto255.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-scalarmult-ristretto255">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-scalarmult-ristretto255" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult-base.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult-ristretto255-base.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-scalarmult-ristretto255.php" hreflang="zh">
...
<meta name="Description" content="Computes a shared secret" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_scalarmult_ristretto255 - Manual" />
<meta name="twitter:description" content="Computes a shared secret" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_scalarmult_ristretto255 - Manual" />
<meta itemprop="description" content="Computes a shared secret" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes a shared secret" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-scalarmult-ristretto255-base.php">
          sodium_crypto_scalarmult_ristretto255_base &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-scalarmult-base.php">
          &laquo; sodium_crypto_scalarmult_base        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-scalarmult-ristretto255.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-scalarmult-ristretto255.php'>German</option>
            <option value='es/function.sodium-crypto-scalarmult-ristretto255.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-scalarmult-ristretto255.php'>French</option>
            <option value='it/function.sodium-crypto-scalarmult-ristretto255.php'>Italian</option>
            <option value='ja/function.sodium-crypto-scalarmult-ristretto255.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-scalarmult-ristretto255.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-scalarmult-ristretto255.php'>Russian</option>
            <option value='tr/function.sodium-crypto-scalarmult-ristretto255.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-scalarmult-ristretto255.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-scalarmult-ristretto255.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-scalarmult-ristretto255" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_scalarmult_ristretto255</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.1)</p><p class="refpurpose"><span class="refname">sodium_crypto_scalarmult_ristretto255</span> &mdash; <span class="dc-title">Computes a shared secret</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-scalarmult-ristretto255-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_scalarmult_ristretto255</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$n</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$p</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Calculates scalar <code class="parameter">n</code> times point <code class="parameter">p</code>.
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-scalarmult-ristretto255-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-scalarmult-ristretto255-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-scalarmult-ristretto255-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-scalarmult-ristretto255-base.php" class="function" rel="rdfs-seeAlso">sodium_crypto_scalarmult_ristretto255_base()</a> - Calculates the public key from a secret key</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-scalarmult-ristretto255.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-scalarmult-ristretto255%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-scalarmult-ristretto255&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-scalarmult-ristretto255.php">＋<small>add a note</small></a></span>
