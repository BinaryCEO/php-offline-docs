...
<head>
  ...
  <title>PHP: fprintf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fprintf.php">
 <link rel="shorturl" href="https://www.php.net/fprintf">
 <link rel="alternate" href="https://www.php.net/fprintf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.explode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-html-translation-table.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fprintf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fprintf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fprintf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fprintf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fprintf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fprintf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fprintf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fprintf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fprintf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fprintf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fprintf.php" hreflang="zh">
...
<meta name="Description" content="Write a formatted string to a stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fprintf - Manual" />
<meta name="twitter:description" content="Write a formatted string to a stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fprintf - Manual" />
<meta itemprop="description" content="Write a formatted string to a stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write a formatted string to a stream" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.get-html-translation-table.php">
          get_html_translation_table &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fprintf.php' selected="selected">English</option>
            <option value='de/function.fprintf.php'>German</option>
            <option value='es/function.fprintf.php'>Spanish</option>
            <option value='fr/function.fprintf.php'>French</option>
            <option value='it/function.fprintf.php'>Italian</option>
            <option value='ja/function.fprintf.php'>Japanese</option>
            <option value='pt_BR/function.fprintf.php'>Brazilian Portuguese</option>
            <option value='ru/function.fprintf.php'>Russian</option>
            <option value='tr/function.fprintf.php'>Turkish</option>
            <option value='uk/function.fprintf.php'>Ukrainian</option>
            <option value='zh/function.fprintf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fprintf" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.date.php" class="function" rel="rdfs-seeAlso">date()</a> - Format a Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/fprintf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fprintf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fprintf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fprintf.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="126174">  <div class="votes">
    <div id="Vu126174">
    <a href="/manual/vote-note.php?id=126174&amp;page=function.fprintf&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126174">
    <a href="/manual/vote-note.php?id=126174&amp;page=function.fprintf&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126174" title="60% like this...">
    2
    </div>
  </div>
  <a href="#126174" class="name">
  <strong class="user"><em>Julien MOREAU</em></strong></a><a class="genanchor" href="#126174"> &para;</a><div class="date" title="2021-06-16 08:57"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126174">
<div class="phpcode"><code><span class="html">If you use the command line interface (CLI SAPI), you may be interested by the 3 standard input/output streams (STDIN, STDOUT &amp; STDERR) described at: <a href="https://www.php.net/manual/en/features.commandline.io-streams.php" rel="nofollow" target="_blank">https://www.php.net/manual/en/features.commandline.io-streams.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fprintf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fprintf.php">＋<small>add a note</small></a></div>
