...
<head>
  ...
  <title>PHP: Imagick::scaleImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.scaleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.scaleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.scaleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.sampleimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.segmentimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.scaleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.scaleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.scaleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.scaleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.scaleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.scaleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.scaleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.scaleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.scaleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.scaleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.scaleimage.php" hreflang="zh">
...
<meta name="Description" content="Scales the size of an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::scaleImage - Manual" />
<meta name="twitter:description" content="Scales the size of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::scaleImage - Manual" />
<meta itemprop="description" content="Scales the size of an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scales the size of an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.segmentimage.php">
          Imagick::segmentImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.sampleimage.php">
          &laquo; Imagick::sampleImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.scaleimage.php' selected="selected">English</option>
            <option value='de/imagick.scaleimage.php'>German</option>
            <option value='es/imagick.scaleimage.php'>Spanish</option>
            <option value='fr/imagick.scaleimage.php'>French</option>
            <option value='it/imagick.scaleimage.php'>Italian</option>
            <option value='ja/imagick.scaleimage.php'>Japanese</option>
            <option value='pt_BR/imagick.scaleimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.scaleimage.php'>Russian</option>
            <option value='tr/imagick.scaleimage.php'>Turkish</option>
            <option value='uk/imagick.scaleimage.php'>Ukrainian</option>
            <option value='zh/imagick.scaleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.scaleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::scaleImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::scaleImage</span> &mdash; <span class="dc-title">Scales the size of an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.scaleimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::scaleImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$bestfit</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$legacy</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.scaleimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.scaleimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.scaleimage-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.scaleimage-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.scaleimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3084">
      <p><strong>Example #1  <span class="function"><strong>Imagick::scaleImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/scaleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.scaleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.scaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.scaleimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">5 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91546">  <div class="votes">
    <div id="Vu91546">
    <a href="/manual/vote-note.php?id=91546&amp;page=imagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91546">
    <a href="/manual/vote-note.php?id=91546&amp;page=imagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91546" title="83% like this...">
    28
    </div>
  </div>
  <a href="#91546" class="name">
  <strong class="user"><em>benford at bluhelix dot com</em></strong></a><a class="genanchor" href="#91546"> &para;</a><div class="date" title="2009-06-16 08:38"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91546">
<div class="phpcode"><code><span class="html">If anyone finds "The other parameter will be calculated if 0 is passed as either param. " to be a bit confusing, it means approximately this:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'example.jpg'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">300</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This scales the image such that it is now 300 pixels wide, and automatically calculates the height to keep the image at the same aspect ratio.<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'example.jpg'</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">, </span><span class="default">300</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Similarly, this example scales the image to make it 300 pixels tall, and the method automatically recalculates the image's height to maintain the aspect ratio.</span></code></div>
  </div>
 </div>
  <div class="note" id="76853">  <div class="votes">
    <div id="Vu76853">
    <a href="/manual/vote-note.php?id=76853&amp;page=imagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76853">
    <a href="/manual/vote-note.php?id=76853&amp;page=imagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76853" title="76% like this...">
    9
    </div>
  </div>
  <a href="#76853" class="name">
  <strong class="user"><em>vincent dot hoen at gmail dot com</em></strong></a><a class="genanchor" href="#76853"> &para;</a><div class="date" title="2007-08-02 06:37"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76853">
<div class="phpcode"><code><span class="html">Here is an easy way to resize an animated gif : <br /><br />$picture = new Imagick('animated_gif.gif');<br /><br />foreach($picture as $frame){<br />    $frame-&gt;scaleImage($width, $height);<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="92407">  <div class="votes">
    <div id="Vu92407">
    <a href="/manual/vote-note.php?id=92407&amp;page=imagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92407">
    <a href="/manual/vote-note.php?id=92407&amp;page=imagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92407" title="59% like this...">
    6
    </div>
  </div>
  <a href="#92407" class="name">
  <strong class="user"><em>octave at web dot de</em></strong></a><a class="genanchor" href="#92407"> &para;</a><div class="date" title="2009-07-23 02:57"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92407">
<div class="phpcode"><code><span class="html">When using the "fit = true" option, the image will only scale down, but never scale up:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'1600x1200.jpg'</span><span class="keyword">);<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">2000</span><span class="keyword">, </span><span class="default">1500</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">); </span><span class="comment">// =&gt; 1600x1200<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">1000</span><span class="keyword">, </span><span class="default">500</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">); </span><span class="comment">// =&gt; 666x500<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="110577">  <div class="votes">
    <div id="Vu110577">
    <a href="/manual/vote-note.php?id=110577&amp;page=imagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110577">
    <a href="/manual/vote-note.php?id=110577&amp;page=imagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110577" title="59% like this...">
    5
    </div>
  </div>
  <a href="#110577" class="name">
  <strong class="user"><em>clickconvert at gmail dot com</em></strong></a><a class="genanchor" href="#110577"> &para;</a><div class="date" title="2012-11-08 09:50"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110577">
<div class="phpcode"><code><span class="html">Need to resize portrait and landscape images (and convert to 72ppi)? These will fit an area of 800x600 without distorting, no matter how tall or wide.
<br />
<br /><span class="default">&lt;?php
<br />    $img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$img_loc</span><span class="keyword">.</span><span class="default">$file</span><span class="keyword">);
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">setImageResolution</span><span class="keyword">(</span><span class="default">72</span><span class="keyword">,</span><span class="default">72</span><span class="keyword">); 
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">resampleImage</span><span class="keyword">(</span><span class="default">72</span><span class="keyword">,</span><span class="default">72</span><span class="keyword">,</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">FILTER_UNDEFINED</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">800</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);
<br />    </span><span class="default">$d </span><span class="keyword">= </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">(); 
...
<br />    if(</span><span class="default">$h </span><span class="keyword">&gt; </span><span class="default">600</span><span class="keyword">) {
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">scaleImage</span><span class="keyword">(</span><span class="default">0</span><span class="keyword">,</span><span class="default">600</span><span class="keyword">);
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$resized_loc</span><span class="keyword">.</span><span class="default">$file</span><span class="keyword">);
<br />    } else {
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$resized_loc</span><span class="keyword">.</span><span class="default">$file</span><span class="keyword">);
<br />    }
<br />    </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">destroy</span><span class="keyword">();
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114641">  <div class="votes">
    <div id="Vu114641">
    <a href="/manual/vote-note.php?id=114641&amp;page=imagick.scaleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114641">
    <a href="/manual/vote-note.php?id=114641&amp;page=imagick.scaleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114641" title="58% like this...">
    2
    </div>
  </div>
  <a href="#114641" class="name">
  <strong class="user"><em>agamemnus at flyingsoft dot pw</em></strong></a><a class="genanchor" href="#114641"> &para;</a><div class="date" title="2014-03-15 03:34"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114641">
<div class="phpcode"><code><span class="html">Warning: this will blur your edges in possibly unexpected ways. For better control, use resizeImage, instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.scaleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.scaleimage.php">＋<small>add a note</small></a></div>
