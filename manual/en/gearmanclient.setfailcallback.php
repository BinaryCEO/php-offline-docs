...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.setfailcallback.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.setfailcallback.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.setfailcallback.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.setoptions.php">
...
<meta name="Description" content="Set callback for job failure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::setFailCallback - Manual" />
<meta name="twitter:description" content="Set callback for job failure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::setFailCallback - Manual" />
<meta itemprop="description" content="Set callback for job failure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set callback for job failure" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.setfailcallback.php' selected="selected">English</option>
            ...
            <option value='fr/gearmanclient.setfailcallback.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::setFailCallback</span> &mdash; <span class="dc-title">Set callback for job failure</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.setworkloadcallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setWorkloadCallback()</a> - Set a callback for accepting incremental data updates</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/setfailcallback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.setfailcallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.setfailcallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.setfailcallback.php">＋<small>add a note</small></a></span>
