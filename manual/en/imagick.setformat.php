...
<head>
  ...
  <title>PHP: Imagick::setFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setfont.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setgravity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setformat.php" hreflang="zh">
...
<meta name="Description" content="Sets the format of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setFormat - Manual" />
<meta name="twitter:description" content="Sets the format of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setFormat - Manual" />
<meta itemprop="description" content="Sets the format of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the format of the Imagick object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setgravity.php">
          Imagick::setGravity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setfont.php">
          &laquo; Imagick::setFont        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setformat.php' selected="selected">English</option>
            <option value='de/imagick.setformat.php'>German</option>
            <option value='es/imagick.setformat.php'>Spanish</option>
            <option value='fr/imagick.setformat.php'>French</option>
            <option value='it/imagick.setformat.php'>Italian</option>
            <option value='ja/imagick.setformat.php'>Japanese</option>
            <option value='pt_BR/imagick.setformat.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setformat.php'>Russian</option>
            <option value='tr/imagick.setformat.php'>Turkish</option>
            <option value='uk/imagick.setformat.php'>Ukrainian</option>
            <option value='zh/imagick.setformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setFormat</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setFormat</span> &mdash; <span class="dc-title">Sets the format of the Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setFormat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$format</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setformat-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setformat-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setformat.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110725">  <div class="votes">
    <div id="Vu110725">
    <a href="/manual/vote-note.php?id=110725&amp;page=imagick.setformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110725">
    <a href="/manual/vote-note.php?id=110725&amp;page=imagick.setformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110725" title="77% like this...">
    5
    </div>
  </div>
  <a href="#110725" class="name">
  <strong class="user"><em>Meinaart</em></strong></a><a class="genanchor" href="#110725"> &para;</a><div class="date" title="2012-11-28 12:56"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110725">
<div class="phpcode"><code><span class="html">For format see:<br /><a href="http://www.imagemagick.org/script/formats.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/formats.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="86350">  <div class="votes">
    <div id="Vu86350">
    <a href="/manual/vote-note.php?id=86350&amp;page=imagick.setformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86350">
    <a href="/manual/vote-note.php?id=86350&amp;page=imagick.setformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86350" title="60% like this...">
    2
    </div>
  </div>
  <a href="#86350" class="name">
  <strong class="user"><em>scott at thebrain dot ca</em></strong></a><a class="genanchor" href="#86350"> &para;</a><div class="date" title="2008-10-14 08:18"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86350">
<div class="phpcode"><code><span class="html">don't confuse this function with setImageFormat()</span></code></div>
  </div>
 </div>
  <div class="note" id="118027">  <div class="votes">
    <div id="Vu118027">
    <a href="/manual/vote-note.php?id=118027&amp;page=imagick.setformat&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118027">
    <a href="/manual/vote-note.php?id=118027&amp;page=imagick.setformat&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118027" title="60% like this...">
    1
    </div>
  </div>
  <a href="#118027" class="name">
  <strong class="user"><em>winmonaye at gmail dot com</em></strong></a><a class="genanchor" href="#118027"> &para;</a><div class="date" title="2015-09-21 06:15"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom118027">
<div class="phpcode"><code><span class="html">You can only set format listed in $imgic-&gt;queryFormats() . <br />It can be different from <a href="http://www.imagemagick.org/script/formats.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/formats.php</a> .</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setformat.php">＋<small>add a note</small></a></div>
