...
<head>
  ...
  <title>PHP: wincache_fcache_fileinfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-fcache-fileinfo.php">
 <link rel="shorturl" href="https://www.php.net/wincache-fcache-fileinfo">
 <link rel="alternate" href="https://www.php.net/wincache-fcache-fileinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-fcache-meminfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-fcache-fileinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-fcache-fileinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-fcache-fileinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-fcache-fileinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-fcache-fileinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-fcache-fileinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-fcache-fileinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-fcache-fileinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-fcache-fileinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-fcache-fileinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-fcache-fileinfo.php" hreflang="zh">
...
<meta name="Description" content="Retrieves information about files cached in the file cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_fcache_fileinfo - Manual" />
<meta name="twitter:description" content="Retrieves information about files cached in the file cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_fcache_fileinfo - Manual" />
<meta itemprop="description" content="Retrieves information about files cached in the file cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves information about files cached in the file cache" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-fcache-meminfo.php">
          wincache_fcache_meminfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.wincache.php">
          &laquo; WinCache Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-fcache-fileinfo.php' selected="selected">English</option>
            <option value='de/function.wincache-fcache-fileinfo.php'>German</option>
            <option value='es/function.wincache-fcache-fileinfo.php'>Spanish</option>
            <option value='fr/function.wincache-fcache-fileinfo.php'>French</option>
            <option value='it/function.wincache-fcache-fileinfo.php'>Italian</option>
            <option value='ja/function.wincache-fcache-fileinfo.php'>Japanese</option>
            <option value='pt_BR/function.wincache-fcache-fileinfo.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-fcache-fileinfo.php'>Russian</option>
            <option value='tr/function.wincache-fcache-fileinfo.php'>Turkish</option>
            <option value='uk/function.wincache-fcache-fileinfo.php'>Ukrainian</option>
            <option value='zh/function.wincache-fcache-fileinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-fcache-fileinfo" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-fcache-fileinfo-returnvalues">
  ...
  <p class="para">
   Array of meta data about file cache  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
  <p class="para">
   ...
   <ul class="itemizedlist">
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_cache_uptime</code> - total time in seconds that the file cache has been active
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_file_count</code> - total number of files that are currently in the file cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_hit_count</code> - number of times the files have been served from the file cache
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">total_miss_count</code> - number of times the files have not been found in the file cache
     </span>
    </li>
    <li class="listitem">
     <p class="para">
      ...
      <ul class="itemizedlist">
       ...
       <li class="listitem">
        <span class="simpara">
         <code class="literal">add_time</code> - time in seconds since the file has been added to the file cache
        </span>
       </li>
       <li class="listitem">
        <span class="simpara">
         <code class="literal">use_time</code> - time in seconds since the file has been accessed in the file cache
        </span>
       </li>
       <li class="listitem">
        <span class="simpara">
       ...
       <li class="listitem">
        <span class="simpara">
         <code class="literal">file_size</code> - size of the cached file in bytes
        </span>
       </li>
      </ul>
     </p>
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-fcache-fileinfo-examples">
  ...
  <p class="para">
   <div class="example" id="example-736">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-scache-meminfo.php" class="function" rel="rdfs-seeAlso">wincache_scache_meminfo()</a> - Retrieves information about session cache memory usage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-fcache-fileinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-fcache-fileinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-fcache-fileinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-fcache-fileinfo.php">＋<small>add a note</small></a></span>
