...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.borderimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.borderimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.borderimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.blurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.charcoalimage.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.borderimage.php' selected="selected">English</option>
            ...
            <option value='ru/gmagick.borderimage.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::borderimage</span> &mdash; <span class="dc-title">Surrounds the image with a border</span></p>
 ...
 <div class="refsect1 description" id="refsect1-gmagick.borderimage-description">
  ...
  <p class="para rdfs-comment">
   Surrounds the image with a border of the color defined by the bordercolor <span class="classname"><a href="class.gmagickpixel.php" class="classname">GmagickPixel</a></span> object or a color string. 
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.borderimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <span class="classname"><a href="class.gmagickpixel.php" class="classname">GmagickPixel</a></span> object or a string containing the border color.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.borderimage-returnvalues">
  ...
  <p class="para">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with border defined.
  </p>
 </div>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/borderimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.borderimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.borderimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.borderimage.php">＋<small>add a note</small></a></span>
