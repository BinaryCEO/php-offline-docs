...
<head>
  ...
  <title>PHP: Imagick::getImageArtifact - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageartifact.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageartifact.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageartifact.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagealphachannel.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageattribute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageartifact.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageartifact.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageartifact.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageartifact.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageartifact.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageartifact.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageartifact.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageartifact.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageartifact.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageartifact.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageartifact.php" hreflang="zh">
...
<meta name="Description" content="Get image artifact" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageArtifact - Manual" />
<meta name="twitter:description" content="Get image artifact" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageArtifact - Manual" />
<meta itemprop="description" content="Get image artifact" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get image artifact" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageattribute.php">
          Imagick::getImageAttribute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagealphachannel.php">
          &laquo; Imagick::getImageAlphaChannel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageartifact.php' selected="selected">English</option>
            <option value='de/imagick.getimageartifact.php'>German</option>
            <option value='es/imagick.getimageartifact.php'>Spanish</option>
            <option value='fr/imagick.getimageartifact.php'>French</option>
            <option value='it/imagick.getimageartifact.php'>Italian</option>
            <option value='ja/imagick.getimageartifact.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageartifact.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageartifact.php'>Russian</option>
            <option value='tr/imagick.getimageartifact.php'>Turkish</option>
            <option value='uk/imagick.getimageartifact.php'>Ukrainian</option>
            <option value='zh/imagick.getimageartifact.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageartifact" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageArtifact</h1>
  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageArtifact</span> &mdash; <span class="dc-title">Get image artifact</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageartifact-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageArtifact</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$artifact</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Gets an artifact associated with the image.  The difference between image properties and 
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageartifact-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageartifact-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageartifact-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.getimageartifact-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.deleteimageartifact.php" class="function" rel="rdfs-seeAlso">Imagick::deleteImageArtifact()</a> - Delete image artifact</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageartifact.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageartifact%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageartifact&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageartifact.php">＋<small>add a note</small></a></span>
