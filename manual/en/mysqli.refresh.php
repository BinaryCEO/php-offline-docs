...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.refresh.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.refresh.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.refresh.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.reap-async-query.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.release-savepoint.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.refresh.php' selected="selected">English</option>
            <option value='de/mysqli.refresh.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::refresh</span> -- <span class="refname">mysqli_refresh</span> &mdash; <span class="dc-title">Refreshes</span></p>
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
     ...
     <dd>
      <p class="para">
       ...
       within the <a href="mysqli.constants.php" class="link">MySQLi constants</a> documentation.
      </p>
      <p class="para">
       See also the official <a href="https://dev.mysql.com/doc/c-api/8.4/en/mysql-refresh.html" class="link external">&raquo;&nbsp;MySQL Refresh</a>
       documentation.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.refresh-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the refresh was a success, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       Both <span class="methodname"><strong>mysqli::refresh()</strong></span> and
       <span class="function"><strong>mysqli_refresh()</strong></span> are now deprecated.
       Use <code class="literal">FLUSH</code> SQL commands instead.
      </td>
     </tr>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.poll.php" class="function" rel="rdfs-seeAlso">mysqli_poll()</a> - Poll connections</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/refresh.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.refresh%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.refresh&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.refresh.php">＋<small>add a note</small></a></span>
