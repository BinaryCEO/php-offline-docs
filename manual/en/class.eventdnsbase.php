...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.eventdnsbase.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/eventconfig.setmaxdispatchinterval.php">
 <link rel="next" href="https://www.php.net/manual/en/eventdnsbase.addnameserverip.php">
...
<meta name="Description" content="The EventDnsBase class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventDnsBase - Manual" />
<meta name="twitter:description" content="The EventDnsBase class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventDnsBase - Manual" />
<meta itemprop="description" content="The EventDnsBase class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EventDnsBase class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.eventdnsbase.php' selected="selected">English</option>
            <option value='de/class.eventdnsbase.php'>German</option>
            <option value='es/class.eventdnsbase.php'>Spanish</option>
            <option value='fr/class.eventdnsbase.php'>French</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="eventdnsbase.addnameserverip.php">EventDnsBase::addNameserverIp</a> — Adds a nameserver to the DNS base</li><li><a href="eventdnsbase.addsearch.php">EventDnsBase::addSearch</a> — Adds a domain to the list of search domains</li><li><a href="eventdnsbase.clearsearch.php">EventDnsBase::clearSearch</a> — Removes all current search suffixes</li><li><a href="eventdnsbase.construct.php">EventDnsBase::__construct</a> — Constructs EventDnsBase object</li><li><a href="eventdnsbase.countnameservers.php">EventDnsBase::countNameservers</a> — Gets the number of configured nameservers</li><li><a href="eventdnsbase.loadhosts.php">EventDnsBase::loadHosts</a> — Loads a hosts file (in the same format as /etc/hosts) from hosts file</li><li><a href="eventdnsbase.parseresolvconf.php">EventDnsBase::parseResolvConf</a> — Scans the resolv.conf-formatted file</li><li><a href="eventdnsbase.setoption.php">EventDnsBase::setOption</a> — Set the value of a configuration option</li><li><a href="eventdnsbase.setsearchndots.php">EventDnsBase::setSearchNdots</a> — Set the 'ndots' parameter for searches</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventdnsbase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.eventdnsbase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.eventdnsbase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.eventdnsbase.php">＋<small>add a note</small></a></span>
