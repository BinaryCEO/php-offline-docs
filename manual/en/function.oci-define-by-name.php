...
<head>
  ...
  <title>PHP: oci_define_by_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-define-by-name.php">
 <link rel="shorturl" href="https://www.php.net/oci-define-by-name">
 <link rel="alternate" href="https://www.php.net/oci-define-by-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-define-by-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-define-by-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-define-by-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-define-by-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-define-by-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-define-by-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-define-by-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-define-by-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-define-by-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-define-by-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-define-by-name.php" hreflang="zh">
...
<meta name="Description" content="Associates a PHP variable with a column for query fetches" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_define_by_name - Manual" />
<meta name="twitter:description" content="Associates a PHP variable with a column for query fetches" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_define_by_name - Manual" />
<meta itemprop="description" content="Associates a PHP variable with a column for query fetches" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Associates a PHP variable with a column for query fetches" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-error.php">
          oci_error &raquo;
              ...
              <div class="prev">
        <a href="function.oci-connect.php">
          &laquo; oci_connect        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-define-by-name.php' selected="selected">English</option>
            <option value='de/function.oci-define-by-name.php'>German</option>
            <option value='es/function.oci-define-by-name.php'>Spanish</option>
            <option value='fr/function.oci-define-by-name.php'>French</option>
            <option value='it/function.oci-define-by-name.php'>Italian</option>
            <option value='ja/function.oci-define-by-name.php'>Japanese</option>
            <option value='pt_BR/function.oci-define-by-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-define-by-name.php'>Russian</option>
            <option value='tr/function.oci-define-by-name.php'>Turkish</option>
            <option value='uk/function.oci-define-by-name.php'>Ukrainian</option>
            <option value='zh/function.oci-define-by-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-define-by-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_define_by_name</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">oci_define_by_name</span> &mdash; <span class="dc-title">Associates a PHP variable with a column for query fetches</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.oci-define-by-name-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_define_by_name</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$statement</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$column</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter reference">&$var</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$type</code><span class="initializer"> = 0</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Associates a PHP variable with a column for query fetches using <span class="function"><a href="function.oci-fetch.php" class="function">oci_fetch()</a></span>.
  </p>
  <p class="para">
    The <span class="function"><strong>oci_define_by_name()</strong></span> call must occur before
    executing <span class="function"><a href="function.oci-execute.php" class="function">oci_execute()</a></span>.
  </p>
 </div>
...
CURSOR</code> statement identifier.</p>
     ...
     <dd>
      <p class="para">
        ...
        <strong><code><a href="oci8.constants.php#constant.sqlt-int">SQLT_INT</a></code></strong> will be ignored and the returned
        data type will still be <strong><code><a href="oci8.constants.php#constant.sqlt-chr">SQLT_CHR</a></code></strong>.
      </p>
      <p class="para">
       You can optionally use <span class="function"><a href="function.oci-new-descriptor.php" class="function">oci_new_descriptor()</a></span>
 ...
 <div class="refsect1 examples" id="refsect1-function.oci-define-by-name-examples">
  ...
  <p class="para">
   <div class="example" id="example-1965">
    <p><strong>Example #1 <span class="function"><strong>oci_define_by_name()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/*<br />  Before running, create the table with a case sensitive column name:<br />    CREATE TABLE mytab (id NUMBER, "MyDescription" VARCHAR2(30));<br />    INSERT INTO mytab (id, "MyDescription") values (1, 'Iced Coffee');<br />    COMMIT;<br />*/<br /><br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'hr'</span><span style="color: #007700">, </span><span style="color: #DD0000">'welcome'</span><span style="color: #007700">, </span><span style="color: #DD0000">'localhost/XE'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$e </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_error</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">trigger_error</span><span style="color: #007700">(</span><span style="color: #0000BB">htmlentities</span><span style="color: #007700">(</span><span style="color: #0000BB">$e</span><span style="color: #007700">[</span><span style="color: #DD0000">'message'</span><span style="color: #007700">], </span><span style="color: #0000BB">ENT_QUOTES</span><span style="color: #007700">), </span><span style="color: #0000BB">E_USER_ERROR</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">$stid </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'SELECT * FROM mytab'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Use uppercase for non case-sensitive column names<br /></span><span style="color: #0000BB">oci_define_by_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #DD0000">'ID'</span><span style="color: #007700">, </span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Use the exact case for case-sensitive column names<br /></span><span style="color: #0000BB">oci_define_by_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #DD0000">'MyDescription'</span><span style="color: #007700">, </span><span style="color: #0000BB">$mydesc</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">oci_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /><br />while (</span><span style="color: #0000BB">oci_fetch</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">"id </span><span style="color: #0000BB">$id</span><span style="color: #DD0000"> is </span><span style="color: #0000BB">$mydesc</span><span style="color: #DD0000">&lt;br&gt;\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// Displays:<br />//   id 1 is Iced Coffee<br /><br /></span><span style="color: #0000BB">oci_free_statement</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-1967">
    <p><strong>Example #3 <span class="function"><strong>oci_define_by_name()</strong></span> with LOB columns</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/*<br />  Before running, create the table:<br />    CREATE TABLE mytab (id NUMBER, fruit CLOB);<br />    INSERT INTO mytab (id, fruit) values (1, 'apple');<br />    INSERT INTO mytab (id, fruit) values (2, 'orange');<br />    COMMIT;<br />*/<br /><br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'hr'</span><span style="color: #007700">, </span><span style="color: #DD0000">'welcome'</span><span style="color: #007700">, </span><span style="color: #DD0000">'localhost/XE'</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$e </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_error</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">trigger_error</span><span style="color: #007700">(</span><span style="color: #0000BB">htmlentities</span><span style="color: #007700">(</span><span style="color: #0000BB">$e</span><span style="color: #007700">[</span><span style="color: #DD0000">'message'</span><span style="color: #007700">], </span><span style="color: #0000BB">ENT_QUOTES</span><span style="color: #007700">), </span><span style="color: #0000BB">E_USER_ERROR</span><span style="color: #007700">);<br />}<br /><br /></span><span style="color: #0000BB">$stid </span><span style="color: #007700">= </span><span style="color: #0000BB">oci_parse</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">'SELECT * FROM mytab'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// The defines MUST be done before executing<br /></span><span style="color: #0000BB">oci_define_by_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #DD0000">'ID'</span><span style="color: #007700">, </span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_define_by_name</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">, </span><span style="color: #DD0000">'FRUIT'</span><span style="color: #007700">, </span><span style="color: #0000BB">$fruit</span><span style="color: #007700">);  </span><span style="color: #FF8000">// $fruit will become a LOB descriptor<br /><br /></span><span style="color: #0000BB">oci_execute</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /><br />while (</span><span style="color: #0000BB">oci_fetch</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #0000BB">$id </span><span style="color: #007700">. </span><span style="color: #DD0000">" is " </span><span style="color: #007700">. </span><span style="color: #0000BB">$fruit</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">load</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br&gt;\n"</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #FF8000">// Displays:<br />//   1 is apple<br />//   2 is orange<br /><br /></span><span style="color: #0000BB">$fruit</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">free</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">oci_free_statement</span><span style="color: #007700">(</span><span style="color: #0000BB">$stid</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">oci_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
  ...
  <p class="para">
   <div class="example" id="example-1968">
    <p><strong>Example #4 <span class="function"><strong>oci_define_by_name()</strong></span> with an explicit type</strong></p>
    <div class="example-contents">
 ...
 <div class="refsect1 seealso" id="refsect1-function.oci-define-by-name-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-new-descriptor.php" class="function" rel="rdfs-seeAlso">oci_new_descriptor()</a> - Initializes a new empty LOB or FILE descriptor</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-define-by-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-define-by-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-define-by-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-define-by-name.php">＋<small>add a note</small></a></span>
