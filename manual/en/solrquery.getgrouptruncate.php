...
<head>
  ...
  <title>PHP: SolrQuery::getGroupTruncate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgrouptruncate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgrouptruncate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgrouptruncate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupsortfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgrouptruncate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgrouptruncate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgrouptruncate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgrouptruncate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgrouptruncate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgrouptruncate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgrouptruncate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgrouptruncate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgrouptruncate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgrouptruncate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgrouptruncate.php" hreflang="zh">
...
<meta name="Description" content="Returns the group.truncate value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupTruncate - Manual" />
<meta name="twitter:description" content="Returns the group.truncate value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupTruncate - Manual" />
<meta itemprop="description" content="Returns the group.truncate value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.truncate value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlight.php">
          SolrQuery::getHighlight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupsortfields.php">
          &laquo; SolrQuery::getGroupSortFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgrouptruncate.php' selected="selected">English</option>
            <option value='de/solrquery.getgrouptruncate.php'>German</option>
            <option value='es/solrquery.getgrouptruncate.php'>Spanish</option>
            <option value='fr/solrquery.getgrouptruncate.php'>French</option>
            <option value='it/solrquery.getgrouptruncate.php'>Italian</option>
            <option value='ja/solrquery.getgrouptruncate.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgrouptruncate.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgrouptruncate.php'>Russian</option>
            <option value='tr/solrquery.getgrouptruncate.php'>Turkish</option>
            <option value='uk/solrquery.getgrouptruncate.php'>Ukrainian</option>
            <option value='zh/solrquery.getgrouptruncate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgrouptruncate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupTruncate</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupTruncate</span> &mdash; <span class="dc-title">Returns the group.truncate value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgrouptruncate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupTruncate</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgrouptruncate-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgrouptruncate-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgrouptruncate-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgrouptruncate.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupTruncate()</a> - If true, facet counts are based on the most relevant document of each group matching the query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgrouptruncate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgrouptruncate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgrouptruncate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgrouptruncate.php">＋<small>add a note</small></a></span>
