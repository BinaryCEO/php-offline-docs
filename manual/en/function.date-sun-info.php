...
<head>
  ...
  <title>PHP: date_sun_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-sun-info.php">
 <link rel="shorturl" href="https://www.php.net/date-sun-info">
 <link rel="alternate" href="https://www.php.net/date-sun-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-sub.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-sunrise.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-sun-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-sun-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-sun-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-sun-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-sun-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-sun-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-sun-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-sun-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-sun-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-sun-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-sun-info.php" hreflang="zh">
...
<meta name="Description" content="Returns an array with information about sunset/sunrise and twilight begin/end" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_sun_info - Manual" />
<meta name="twitter:description" content="Returns an array with information about sunset/sunrise and twilight begin/end" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_sun_info - Manual" />
<meta itemprop="description" content="Returns an array with information about sunset/sunrise and twilight begin/end" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array with information about sunset/sunrise and twilight begin/end" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-sun-info.php' selected="selected">English</option>
            <option value='de/function.date-sun-info.php'>German</option>
            <option value='es/function.date-sun-info.php'>Spanish</option>
            <option value='fr/function.date-sun-info.php'>French</option>
            <option value='it/function.date-sun-info.php'>Italian</option>
            <option value='ja/function.date-sun-info.php'>Japanese</option>
            <option value='pt_BR/function.date-sun-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-sun-info.php'>Russian</option>
            <option value='tr/function.date-sun-info.php'>Turkish</option>
            <option value='uk/function.date-sun-info.php'>Ukrainian</option>
            <option value='zh/function.date-sun-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-sun-info" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.date-sun-info-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>date_sun_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timestamp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$latitude</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$longitude</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.date-sun-info-returnvalues">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="literal">sunrise</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">sunset</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">transit</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">civil_twilight_begin</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">civil_twilight_end</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">nautical_twilight_begin</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">nautical_twilight_end</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">astronomical_twilight_begin</code></dt>
     <dd>
      <span class="simpara">
     ...
     <dt><code class="literal">astronomical_twilight_end</code></dt>
     <dd>
      <span class="simpara">
  ...
  <p class="para"> 
   The values of the array elements are either UNIX timestamps, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the
   sun is below the respective zenith for the whole day, or <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the sun is
...
<div class="examplescode"><pre class="examplescode">sunrise: 05:52:11
sunset: 15:41:21
transit: 10:46:46
...
astronomical_twilight_end: 17:12:00</pre>
</div>
    </div>
   </div>
  </p>
...
18:03:49 AKST: astronomical_twilight_end</pre>
</div>
    </div>
   </div>
  </p>
  ...
  <p class="para">
   <div class="example" id="example-2285">
    <p><strong>Example #3 Midnight sun (Tromsø, Norway)</strong></p>
    <div class="example-contents">
...
(
  ...
  <p class="para">
   <div class="example" id="example-2286">
    <p><strong>Example #4 Calculating length of day (Kyiv)</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$si </span><span style="color: #007700">= </span><span style="color: #0000BB">date_sun_info</span><span style="color: #007700">(</span><span style="color: #0000BB">strtotime</span><span style="color: #007700">(</span><span style="color: #DD0000">'2022-08-26'</span><span style="color: #007700">), </span><span style="color: #0000BB">50.45</span><span style="color: #007700">, </span><span style="color: #0000BB">30.52</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$diff </span><span style="color: #007700">= </span><span style="color: #0000BB">$si</span><span style="color: #007700">[</span><span style="color: #DD0000">'sunset'</span><span style="color: #007700">] - </span><span style="color: #0000BB">$si</span><span style="color: #007700">[</span><span style="color: #DD0000">'sunrise'</span><span style="color: #007700">];<br />echo </span><span style="color: #DD0000">"Length of day: "</span><span style="color: #007700">,<br />    </span><span style="color: #0000BB">floor</span><span style="color: #007700">(</span><span style="color: #0000BB">$diff </span><span style="color: #007700">/ </span><span style="color: #0000BB">3600</span><span style="color: #007700">), </span><span style="color: #DD0000">"h "</span><span style="color: #007700">,<br />    </span><span style="color: #0000BB">floor</span><span style="color: #007700">((</span><span style="color: #0000BB">$diff </span><span style="color: #007700">% </span><span style="color: #0000BB">3600</span><span style="color: #007700">) / </span><span style="color: #0000BB">60</span><span style="color: #007700">), </span><span style="color: #DD0000">"s\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">Length of day: 13h 56s</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-sun-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-sun-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-sun-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-sun-info.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127979">  <div class="votes">
    <div id="Vu127979">
    <a href="/manual/vote-note.php?id=127979&amp;page=function.date-sun-info&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127979">
    <a href="/manual/vote-note.php?id=127979&amp;page=function.date-sun-info&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127979" title="68% like this...">
    8
    </div>
  </div>
  <a href="#127979" class="name">
  <strong class="user"><em>TheFax</em></strong></a><a class="genanchor" href="#127979"> &para;</a><div class="date" title="2022-12-04 09:27"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127979">
<div class="phpcode"><code><span class="html">In the last example, conversion from seconds to Hour, Minutes, Seconds is wrong.<br />This is the correct verion:<br /><br /><span class="default">&lt;?php<br />$si </span><span class="keyword">= </span><span class="default">date_sun_info</span><span class="keyword">(</span><span class="default">strtotime</span><span class="keyword">(</span><span class="string">'2022-08-26'</span><span class="keyword">), </span><span class="default">50.45</span><span class="keyword">, </span><span class="default">30.52</span><span class="keyword">);<br /></span><span class="default">$diff </span><span class="keyword">= </span><span class="default">$si</span><span class="keyword">[</span><span class="string">'sunset'</span><span class="keyword">] - </span><span class="default">$si</span><span class="keyword">[</span><span class="string">'sunrise'</span><span class="keyword">];  </span><span class="comment"># $diff is measured in seconds.<br /></span><span class="keyword">echo </span><span class="string">"Length of day: "</span><span class="keyword">,<br />    </span><span class="default">floor</span><span class="keyword">(</span><span class="default">$diff </span><span class="keyword">/ </span><span class="default">3600</span><span class="keyword">), </span><span class="string">"h"</span><span class="keyword">,<br />    </span><span class="default">floor</span><span class="keyword">((</span><span class="default">$diff </span><span class="keyword">% </span><span class="default">3600</span><span class="keyword">) / </span><span class="default">60</span><span class="keyword">), </span><span class="string">"m"</span><span class="keyword">,<br />    </span><span class="default">floor</span><span class="keyword">(</span><span class="default">$diff </span><span class="keyword">% </span><span class="default">60</span><span class="keyword">), </span><span class="string">"s\n"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Output:<br />  Length of day: 13h53m15s</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.date-sun-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-sun-info.php">＋<small>add a note</small></a></div>
