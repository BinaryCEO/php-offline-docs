...
<head>
  ...
  <title>PHP: geoip_db_get_all_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.geoip-db-get-all-info.php">
 <link rel="shorturl" href="https://www.php.net/geoip-db-get-all-info">
 <link rel="alternate" href="https://www.php.net/geoip-db-get-all-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.geoip.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.geoip-db-filename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.geoip-domain-by-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.geoip-db-get-all-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.geoip-db-get-all-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.geoip-db-get-all-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.geoip-db-get-all-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.geoip-db-get-all-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.geoip-db-get-all-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.geoip-db-get-all-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.geoip-db-get-all-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.geoip-db-get-all-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.geoip-db-get-all-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.geoip-db-get-all-info.php" hreflang="zh">
...
<meta name="Description" content="Returns detailed information about all GeoIP database types" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: geoip_db_get_all_info - Manual" />
<meta name="twitter:description" content="Returns detailed information about all GeoIP database types" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: geoip_db_get_all_info - Manual" />
<meta itemprop="description" content="Returns detailed information about all GeoIP database types" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns detailed information about all GeoIP database types" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.geoip-domain-by-name.php">
          geoip_domain_by_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.geoip-db-filename.php">
          &laquo; geoip_db_filename        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.geoip-db-get-all-info.php' selected="selected">English</option>
            <option value='de/function.geoip-db-get-all-info.php'>German</option>
            <option value='es/function.geoip-db-get-all-info.php'>Spanish</option>
            <option value='fr/function.geoip-db-get-all-info.php'>French</option>
            <option value='it/function.geoip-db-get-all-info.php'>Italian</option>
            <option value='ja/function.geoip-db-get-all-info.php'>Japanese</option>
            <option value='pt_BR/function.geoip-db-get-all-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.geoip-db-get-all-info.php'>Russian</option>
            <option value='tr/function.geoip-db-get-all-info.php'>Turkish</option>
            <option value='uk/function.geoip-db-get-all-info.php'>Ukrainian</option>
            <option value='zh/function.geoip-db-get-all-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.geoip-db-get-all-info" class="refentry">
...
<div class="examplescode"><pre class="examplescode">GeoIP Country Edition</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/geoip/functions/geoip-db-get-all-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.geoip-db-get-all-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.geoip-db-get-all-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.geoip-db-get-all-info.php">＋<small>add a note</small></a></span>
