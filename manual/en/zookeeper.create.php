...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/zookeeper.create.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/zookeeper.create.php">
 <link rel="alternate" href="https://www.php.net/manual/en/zookeeper.create.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/zookeeper.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/zookeeper.delete.php">
...
<meta name="Description" content="Create a node synchronously" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Zookeeper::create - Manual" />
<meta name="twitter:description" content="Create a node synchronously" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Zookeeper::create - Manual" />
<meta itemprop="description" content="Create a node synchronously" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a node synchronously" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/zookeeper.create.php' selected="selected">English</option>
            ...
            <option value='ru/zookeeper.create.php'>Russian</option>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="class.zookeeperexception.php" class="classname">ZookeeperException</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeper/create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fzookeeper.create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=zookeeper.create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/zookeeper.create.php">＋<small>add a note</small></a></span>
