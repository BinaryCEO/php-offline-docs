...
<head>
  ...
  <title>PHP: cubrid_get_query_timeout - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-get-query-timeout.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-get-query-timeout">
 <link rel="alternate" href="https://www.php.net/cubrid-get-query-timeout" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-get-db-parameter.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-get-server-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-get-query-timeout.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-get-query-timeout.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-get-query-timeout.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-get-query-timeout.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-get-query-timeout.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-get-query-timeout.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-get-query-timeout.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-get-query-timeout.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-get-query-timeout.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-get-query-timeout.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-get-query-timeout.php" hreflang="zh">
...
<meta name="Description" content="Get the query timeout value of the request" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_get_query_timeout - Manual" />
<meta name="twitter:description" content="Get the query timeout value of the request" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_get_query_timeout - Manual" />
<meta itemprop="description" content="Get the query timeout value of the request" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the query timeout value of the request" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-get-server-info.php">
          cubrid_get_server_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-get-db-parameter.php">
          &laquo; cubrid_get_db_parameter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-get-query-timeout.php' selected="selected">English</option>
            <option value='de/function.cubrid-get-query-timeout.php'>German</option>
            <option value='es/function.cubrid-get-query-timeout.php'>Spanish</option>
            <option value='fr/function.cubrid-get-query-timeout.php'>French</option>
            <option value='it/function.cubrid-get-query-timeout.php'>Italian</option>
            <option value='ja/function.cubrid-get-query-timeout.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-get-query-timeout.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-get-query-timeout.php'>Russian</option>
            <option value='tr/function.cubrid-get-query-timeout.php'>Turkish</option>
            <option value='uk/function.cubrid-get-query-timeout.php'>Ukrainian</option>
            <option value='zh/function.cubrid-get-query-timeout.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-get-query-timeout" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-get-query-timeout-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_get_query_timeout</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <p class="para">
  ...
  <p class="para">
   Returns the query timeout value in milliseconds of the current request on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-get-query-timeout-examples">
  ...
  <div class="example" id="example-1242">
   <p><strong>Example #1 <span class="function"><strong>cubrid_get_query_timeout()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">int(5000)
int(1000)</pre>
</div>
   </div>
  </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-get-query-timeout-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-set-query-timeout.php" class="function" rel="rdfs-seeAlso">cubrid_set_query_timeout()</a> - Set the timeout time of query execution</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-get-query-timeout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-get-query-timeout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-get-query-timeout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-get-query-timeout.php">＋<small>add a note</small></a></span>
