...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightHighlightMultiTerm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightfragsize.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightmaxalternatefieldlength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlighthighlightmultiterm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlighthighlightmultiterm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlighthighlightmultiterm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlighthighlightmultiterm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlighthighlightmultiterm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlighthighlightmultiterm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlighthighlightmultiterm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlighthighlightmultiterm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlighthighlightmultiterm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlighthighlightmultiterm.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not to enable highlighting for range/wildcard/fuzzy/prefix queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightHighlightMultiTerm - Manual" />
<meta name="twitter:description" content="Returns whether or not to enable highlighting for range/wildcard/fuzzy/prefix queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightHighlightMultiTerm - Manual" />
<meta itemprop="description" content="Returns whether or not to enable highlighting for range/wildcard/fuzzy/prefix queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not to enable highlighting for range/wildcard/fuzzy/prefix queries" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.gethighlightmaxalternatefieldlength.php">
          SolrQuery::getHighlightMaxAlternateFieldLength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightfragsize.php">
          &laquo; SolrQuery::getHighlightFragsize        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlighthighlightmultiterm.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlighthighlightmultiterm.php'>German</option>
            <option value='es/solrquery.gethighlighthighlightmultiterm.php'>Spanish</option>
            <option value='fr/solrquery.gethighlighthighlightmultiterm.php'>French</option>
            <option value='it/solrquery.gethighlighthighlightmultiterm.php'>Italian</option>
            <option value='ja/solrquery.gethighlighthighlightmultiterm.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlighthighlightmultiterm.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlighthighlightmultiterm.php'>Russian</option>
            <option value='tr/solrquery.gethighlighthighlightmultiterm.php'>Turkish</option>
            <option value='uk/solrquery.gethighlighthighlightmultiterm.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlighthighlightmultiterm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlighthighlightmultiterm" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightHighlightMultiTerm</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightHighlightMultiTerm</span> &mdash; <span class="dc-title">Returns whether or not to enable highlighting for range/wildcard/fuzzy/prefix queries</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlighthighlightmultiterm-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightHighlightMultiTerm</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlighthighlightmultiterm-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlighthighlightmultiterm-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlighthighlightmultiterm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlighthighlightmultiterm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlighthighlightmultiterm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlighthighlightmultiterm.php">＋<small>add a note</small></a></span>
