...
<head>
  ...
  <title>PHP: Imagick::magnifyImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.magnifyimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.magnifyimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.magnifyimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.listregistry.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.mapimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.magnifyimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.magnifyimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.magnifyimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.magnifyimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.magnifyimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.magnifyimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.magnifyimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.magnifyimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.magnifyimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.magnifyimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.magnifyimage.php" hreflang="zh">
...
<meta name="Description" content="Scales an image proportionally 2x" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::magnifyImage - Manual" />
<meta name="twitter:description" content="Scales an image proportionally 2x" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::magnifyImage - Manual" />
<meta itemprop="description" content="Scales an image proportionally 2x" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scales an image proportionally 2x" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.mapimage.php">
          Imagick::mapImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.listregistry.php">
          &laquo; Imagick::listRegistry        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.magnifyimage.php' selected="selected">English</option>
            <option value='de/imagick.magnifyimage.php'>German</option>
            <option value='es/imagick.magnifyimage.php'>Spanish</option>
            <option value='fr/imagick.magnifyimage.php'>French</option>
            <option value='it/imagick.magnifyimage.php'>Italian</option>
            <option value='ja/imagick.magnifyimage.php'>Japanese</option>
            <option value='pt_BR/imagick.magnifyimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.magnifyimage.php'>Russian</option>
            <option value='tr/imagick.magnifyimage.php'>Turkish</option>
            <option value='uk/imagick.magnifyimage.php'>Ukrainian</option>
            <option value='zh/imagick.magnifyimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.magnifyimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::magnifyImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::magnifyImage</span> &mdash; <span class="dc-title">Scales an image proportionally 2x</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.magnifyimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::magnifyImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.magnifyimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.magnifyimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.magnifyimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3026">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/magnifyimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.magnifyimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.magnifyimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.magnifyimage.php">＋<small>add a note</small></a></span>
