...
<head>
  ...
  <title>PHP: Phar::isCompressed - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.iscompressed.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.iscompressed.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.iscompressed.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.isbuffering.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.isfileformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.iscompressed.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.iscompressed.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.iscompressed.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.iscompressed.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.iscompressed.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.iscompressed.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.iscompressed.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.iscompressed.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.iscompressed.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.iscompressed.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.iscompressed.php" hreflang="zh">
...
<meta name="Description" content="Returns Phar::GZ or PHAR::BZ2 if the entire phar archive is compressed (.tar.gz/tar.bz and so on)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::isCompressed - Manual" />
<meta name="twitter:description" content="Returns Phar::GZ or PHAR::BZ2 if the entire phar archive is compressed (.tar.gz/tar.bz and so on)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::isCompressed - Manual" />
<meta itemprop="description" content="Returns Phar::GZ or PHAR::BZ2 if the entire phar archive is compressed (.tar.gz/tar.bz and so on)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns Phar::GZ or PHAR::BZ2 if the entire phar archive is compressed (.tar.gz/tar.bz and so on)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.isfileformat.php">
          Phar::isFileFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.isbuffering.php">
          &laquo; Phar::isBuffering        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.iscompressed.php' selected="selected">English</option>
            <option value='de/phar.iscompressed.php'>German</option>
            <option value='es/phar.iscompressed.php'>Spanish</option>
            <option value='fr/phar.iscompressed.php'>French</option>
            <option value='it/phar.iscompressed.php'>Italian</option>
            <option value='ja/phar.iscompressed.php'>Japanese</option>
            <option value='pt_BR/phar.iscompressed.php'>Brazilian Portuguese</option>
            <option value='ru/phar.iscompressed.php'>Russian</option>
            <option value='tr/phar.iscompressed.php'>Turkish</option>
            <option value='uk/phar.iscompressed.php'>Ukrainian</option>
            <option value='zh/phar.iscompressed.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.iscompressed" class="refentry">
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 examples" id="refsect1-phar.iscompressed-examples">
  ...
  <p class="para">
   <div class="example" id="example-825">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.getsupportedcompression.php" class="function" rel="rdfs-seeAlso">Phar::getSupportedCompression()</a> - Return array of supported compression algorithms</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/isCompressed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.iscompressed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.iscompressed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.iscompressed.php">＋<small>add a note</small></a></span>
