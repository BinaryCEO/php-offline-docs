...
<head>
  ...
  <title>PHP: ocicolumnname - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicolumnname.php">
 <link rel="shorturl" href="https://www.php.net/ocicolumnname">
 <link rel="alternate" href="https://www.php.net/ocicolumnname" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicolumnisnull.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicolumnprecision.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicolumnname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicolumnname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicolumnname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicolumnname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicolumnname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicolumnname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicolumnname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicolumnname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicolumnname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicolumnname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicolumnname.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_field_name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicolumnname - Manual" />
<meta name="twitter:description" content="Alias of oci_field_name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicolumnname - Manual" />
<meta itemprop="description" content="Alias of oci_field_name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_field_name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocicolumnprecision.php">
          ocicolumnprecision &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocicolumnisnull.php">
          &laquo; ocicolumnisnull        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicolumnname.php' selected="selected">English</option>
            <option value='de/function.ocicolumnname.php'>German</option>
            <option value='es/function.ocicolumnname.php'>Spanish</option>
            <option value='fr/function.ocicolumnname.php'>French</option>
            <option value='it/function.ocicolumnname.php'>Italian</option>
            <option value='ja/function.ocicolumnname.php'>Japanese</option>
            <option value='pt_BR/function.ocicolumnname.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicolumnname.php'>Russian</option>
            <option value='tr/function.ocicolumnname.php'>Turkish</option>
            <option value='uk/function.ocicolumnname.php'>Ukrainian</option>
            <option value='zh/function.ocicolumnname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicolumnname" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicolumnname</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicolumnname</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-field-name.php" class="function">oci_field_name()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicolumnname-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-field-name.php" class="function">oci_field_name()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicolumnname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicolumnname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicolumnname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicolumnname.php">＋<small>add a note</small></a></span>
