...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.groupby.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.groupby.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.groupby.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-tableselect.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.execute.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-tableselect.having.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-tableselect.groupby.php' selected="selected">English</option>
            ...
            <option value='zh/mysql-xdevapi-tableselect.groupby.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-tableselect.groupby-examples">
  ...
  <div class="example" id="example-1857">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\TableSelect::groupBy()</strong></span> example</strong></p>
...
(
    ...
    [1] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/tableselect/groupby.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-tableselect.groupby%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-tableselect.groupby&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-tableselect.groupby.php">＋<small>add a note</small></a></span>
