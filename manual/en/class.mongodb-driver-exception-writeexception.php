...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-exception-writeexception.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-exception-unexpectedvalueexception.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-writeexception.getwriteresult.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-exception-writeexception.php' selected="selected">English</option>
            ...
            <option value='zh/class.mongodb-driver-exception-writeexception.php'>Chinese (Simplified)</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-writeexception.getwriteresult.php">MongoDB\Driver\Exception\WriteException::getWriteResult</a> — Returns the WriteResult for the failed write operation</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/exception/writeexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-exception-writeexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-exception-writeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-exception-writeexception.php">＋<small>add a note</small></a></span>
