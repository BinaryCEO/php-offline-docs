...
<head>
  ...
  <title>PHP: ssh2_sftp_realpath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-sftp-realpath.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-sftp-realpath">
 <link rel="alternate" href="https://www.php.net/ssh2-sftp-realpath" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-sftp-readlink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-sftp-rename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-sftp-realpath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-sftp-realpath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-sftp-realpath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-sftp-realpath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-sftp-realpath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-sftp-realpath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-sftp-realpath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-sftp-realpath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-sftp-realpath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-sftp-realpath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-sftp-realpath.php" hreflang="zh">
...
<meta name="Description" content="Resolve the realpath of a provided path string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_sftp_realpath - Manual" />
<meta name="twitter:description" content="Resolve the realpath of a provided path string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_sftp_realpath - Manual" />
<meta itemprop="description" content="Resolve the realpath of a provided path string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resolve the realpath of a provided path string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ssh2-sftp-rename.php">
          ssh2_sftp_rename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ssh2-sftp-readlink.php">
          &laquo; ssh2_sftp_readlink        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-sftp-realpath.php' selected="selected">English</option>
            <option value='de/function.ssh2-sftp-realpath.php'>German</option>
            <option value='es/function.ssh2-sftp-realpath.php'>Spanish</option>
            <option value='fr/function.ssh2-sftp-realpath.php'>French</option>
            <option value='it/function.ssh2-sftp-realpath.php'>Italian</option>
            <option value='ja/function.ssh2-sftp-realpath.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-sftp-realpath.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-sftp-realpath.php'>Russian</option>
            <option value='tr/function.ssh2-sftp-realpath.php'>Turkish</option>
            <option value='uk/function.ssh2-sftp-realpath.php'>Ukrainian</option>
            <option value='zh/function.ssh2-sftp-realpath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-sftp-realpath" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.ssh2-sftp-realpath-examples">
  ...
  <p class="para">
   <div class="example" id="example-4831">
    <p><strong>Example #1 Resolving a pathname</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ssh2-sftp-readlink.php" class="function" rel="rdfs-seeAlso">ssh2_sftp_readlink()</a> - Return the target of a symbolic link</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-sftp-realpath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-sftp-realpath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-sftp-realpath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-sftp-realpath.php">＋<small>add a note</small></a></span>
