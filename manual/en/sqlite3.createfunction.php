...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/sqlite3.createfunction.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/sqlite3.createfunction.php">
 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.createfunction.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.createcollation.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3.enableexceptions.php">
...
<meta name="Description" content="Registers a PHP function for use as an SQL scalar function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3::createFunction - Manual" />
<meta name="twitter:description" content="Registers a PHP function for use as an SQL scalar function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3::createFunction - Manual" />
<meta itemprop="description" content="Registers a PHP function for use as an SQL scalar function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Registers a PHP function for use as an SQL scalar function" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/sqlite3.createfunction.php' selected="selected">English</option>
            ...
            <option value='ja/sqlite3.createfunction.php'>Japanese</option>
...
<div class="examplescode"><pre class="examplescode">string(32) &quot;098f6bcd4621d373cade4e832627b4f6&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3/createfunction.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsqlite3.createfunction%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=sqlite3.createfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.createfunction.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Since regular expression is not supported by default SQLite, we can create a user function to do the job.<br /><br /><span class="default">&lt;?php<br /><br />$db </span><span class="keyword">= new </span><span class="default">SQLite3</span><span class="keyword">(</span><span class="string">"database.sqlit3"</span><span class="keyword">, </span><span class="default">0666</span><span class="keyword">);<br /><br /></span><span class="comment">// create a function named "preg_match"<br />// with the php core function "preg_match"<br /></span><span class="keyword">if (</span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">createFunction</span><span class="keyword">(</span><span class="string">"preg_match"</span><span class="keyword">, </span><span class="string">"preg_match"</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">) === </span><span class="default">FALSE</span><span class="keyword">)<br />  exit(</span><span class="string">"Failed creating function\n"</span><span class="keyword">);<br /><br /></span><span class="comment">// this query will then works as expected<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">"SELECT * FROM table1 WHERE <br />  preg_match('/^(apple|orange)$/', variable1)"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="107707">  <div class="votes">
    ...
    <div class="tally" id="V107707" title="42% like this...">
    -1
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">In PHP 5.4 there will be a createCollation method to use your custom collation method, to be able to sort datasets using unicode, like this:<br /><br /><span class="default">&lt;?php<br />setlocale</span><span class="keyword">(</span><span class="default">LC_COLLATE</span><span class="keyword">, </span><span class="string">'fr_FR.UTF-8'</span><span class="keyword">);<br /></span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">createCollation</span><span class="keyword">(</span><span class="string">'PHP_COLLATE'</span><span class="keyword">, </span><span class="string">'strcoll'</span><span class="keyword">);<br /><br /></span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">'SELECT * FROM my_table ORDER BY name COLLATE PHP_COLLATE;'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />But until this cool feature becomes available, you'll have to do some tricks, like this for french:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">sqlite3_to_ascii</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">$charset </span><span class="keyword">= </span><span class="string">'UTF-8'</span><span class="keyword">)<br />{<br />    </span><span class="comment">// Don't process empty strings<br />    </span><span class="keyword">if (!</span><span class="default">trim</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">))<br />        return </span><span class="default">$str</span><span class="keyword">;<br /><br />    </span><span class="comment">// We only process non-ascii strings<br />    </span><span class="keyword">if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">'!^[[:ascii:]]+$!'</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">))<br />        return </span><span class="default">$str</span><span class="keyword">;<br /><br />    </span><span class="default">$str </span><span class="keyword">= </span><span class="default">htmlentities</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">ENT_NOQUOTES</span><span class="keyword">, </span><span class="default">$charset</span><span class="keyword">);<br /><br />    </span><span class="default">$str </span><span class="keyword">= </span><span class="default">preg_replace</span><span class="keyword">(</span><span class="string">'#&amp;([A-za-z])(?:acute|cedil|circ|grave|orn|ring|slash|th|tilde|uml);#'</span><span class="keyword">, </span><span class="string">'\1'</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">);<br />    </span><span class="default">$str </span><span class="keyword">= </span><span class="default">preg_replace</span><span class="keyword">(</span><span class="string">'#&amp;([A-za-z]{2})(?:lig);#'</span><span class="keyword">, </span><span class="string">'\1'</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">);<br />    </span><span class="default">$str </span><span class="keyword">= </span><span class="default">preg_replace</span><span class="keyword">(</span><span class="string">'#&amp;[^;]+;#'</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">);<br /><br />    return </span><span class="default">$str</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">createFunction</span><span class="keyword">(</span><span class="string">'to_ascii'</span><span class="keyword">, </span><span class="string">'sqlite3_to_ascii'</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">$res </span><span class="keyword">= </span><span class="default">$db</span><span class="keyword">-&gt;</span><span class="default">query</span><span class="keyword">(</span><span class="string">'SELECT * FROM test ORDER BY to_ascii(text);'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This will convert non-ascii characters to ascii ones before collation. In fact this won't work with non-latin languages, but for latin-languages it's better than nothing.<br /><br />Please note that this will slow down about 1.8 times the query (tested on a 10.000 rows table).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=sqlite3.createfunction&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.createfunction.php">＋<small>add a note</small></a></div>
