...
<head>
  ...
  <title>PHP: sqlsrv_rollback - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sqlsrv-rollback.php">
 <link rel="shorturl" href="https://www.php.net/sqlsrv-rollback">
 <link rel="alternate" href="https://www.php.net/sqlsrv-rollback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sqlsrv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sqlsrv-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sqlsrv-rows-affected.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sqlsrv-rollback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sqlsrv-rollback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sqlsrv-rollback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sqlsrv-rollback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sqlsrv-rollback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sqlsrv-rollback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sqlsrv-rollback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sqlsrv-rollback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sqlsrv-rollback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sqlsrv-rollback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sqlsrv-rollback.php" hreflang="zh">
...
<meta name="Description" content="Rolls back a transaction that was begun with 
  sqlsrv_begin_transaction" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sqlsrv_rollback - Manual" />
<meta name="twitter:description" content="Rolls back a transaction that was begun with 
  sqlsrv_begin_transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sqlsrv_rollback - Manual" />
<meta itemprop="description" content="Rolls back a transaction that was begun with 
  sqlsrv_begin_transaction" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rolls back a transaction that was begun with 
  sqlsrv_begin_transaction" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sqlsrv-rows-affected.php">
          sqlsrv_rows_affected &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sqlsrv-query.php">
          &laquo; sqlsrv_query        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sqlsrv-rollback.php' selected="selected">English</option>
            <option value='de/function.sqlsrv-rollback.php'>German</option>
            <option value='es/function.sqlsrv-rollback.php'>Spanish</option>
            <option value='fr/function.sqlsrv-rollback.php'>French</option>
            <option value='it/function.sqlsrv-rollback.php'>Italian</option>
            <option value='ja/function.sqlsrv-rollback.php'>Japanese</option>
            <option value='pt_BR/function.sqlsrv-rollback.php'>Brazilian Portuguese</option>
            <option value='ru/function.sqlsrv-rollback.php'>Russian</option>
            <option value='tr/function.sqlsrv-rollback.php'>Turkish</option>
            <option value='uk/function.sqlsrv-rollback.php'>Ukrainian</option>
            <option value='zh/function.sqlsrv-rollback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sqlsrv-rollback" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sqlsrv_rollback</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_rollback</span> &mdash; <span class="dc-title">Rolls back a transaction that was begun with 
  <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span></span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.sqlsrv-rollback-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sqlsrv_rollback</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Rolls back a transaction that was begun with <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span> 
   and returns the connection to auto-commit mode.
  </p>
 </div>

 
 <div class="refsect1 parameters" id="refsect1-function.sqlsrv-rollback-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The connection resource returned by a call to <span class="function"><a href="function.sqlsrv-connect.php" class="function">sqlsrv_connect()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-rollback-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.sqlsrv-rollback-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2171">
    <p><strong>Example #1 <span class="function"><strong>sqlsrv_rollback()</strong></span> example</strong></p>
    <div class="example-contents"><p>
    The following example demonstrates how to use <span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function">sqlsrv_begin_transaction()</a></span> 
    together with <span class="function"><a href="function.sqlsrv-commit.php" class="function">sqlsrv_commit()</a></span> and <span class="function"><strong>sqlsrv_rollback()</strong></span>.
    </p></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #0000BB">$serverName</span><span style="color: #007700">, </span><span style="color: #0000BB">$connectionInfo</span><span style="color: #007700">);<br />if( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">=== </span><span style="color: #0000BB">false </span><span style="color: #007700">) {<br />    die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true </span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #FF8000">/* Begin the transaction. */<br /></span><span style="color: #007700">if ( </span><span style="color: #0000BB">sqlsrv_begin_transaction</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">) === </span><span style="color: #0000BB">false </span><span style="color: #007700">) {<br />     die( </span><span style="color: #0000BB">print_r</span><span style="color: #007700">( </span><span style="color: #0000BB">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #0000BB">true </span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #FF8000">/* Initialize parameter values. */<br /></span><span style="color: #0000BB">$orderId </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">; </span><span style="color: #0000BB">$qty </span><span style="color: #007700">= </span><span style="color: #0000BB">10</span><span style="color: #007700">; </span><span style="color: #0000BB">$productId </span><span style="color: #007700">= </span><span style="color: #0000BB">100</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">/* Set up and execute the first query. */<br /></span><span style="color: #0000BB">$sql1 </span><span style="color: #007700">= </span><span style="color: #DD0000">"INSERT INTO OrdersTable (ID, Quantity, ProductID)<br />         VALUES (?, ?, ?)"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$params1 </span><span style="color: #007700">= array( </span><span style="color: #0000BB">$orderId</span><span style="color: #007700">, </span><span style="color: #0000BB">$qty</span><span style="color: #007700">, </span><span style="color: #0000BB">$productId </span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$stmt1 </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql1</span><span style="color: #007700">, </span><span style="color: #0000BB">$params1 </span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set up and execute the second query. */<br /></span><span style="color: #0000BB">$sql2 </span><span style="color: #007700">= </span><span style="color: #DD0000">"UPDATE InventoryTable <br />         SET Quantity = (Quantity - ?) <br />         WHERE ProductID = ?"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$params2 </span><span style="color: #007700">= array(</span><span style="color: #0000BB">$qty</span><span style="color: #007700">, </span><span style="color: #0000BB">$productId</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$stmt2 </span><span style="color: #007700">= </span><span style="color: #0000BB">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #0000BB">$sql2</span><span style="color: #007700">, </span><span style="color: #0000BB">$params2 </span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* If both queries were successful, commit the transaction. */<br />/* Otherwise, rollback the transaction. */<br /></span><span style="color: #007700">if( </span><span style="color: #0000BB">$stmt1 </span><span style="color: #007700">&amp;&amp; </span><span style="color: #0000BB">$stmt2 </span><span style="color: #007700">) {<br />     </span><span style="color: #0000BB">sqlsrv_commit</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">);<br />     echo </span><span style="color: #DD0000">"Transaction committed.&lt;br /&gt;"</span><span style="color: #007700">;<br />} else {<br />     </span><span style="color: #0000BB">sqlsrv_rollback</span><span style="color: #007700">( </span><span style="color: #0000BB">$conn </span><span style="color: #007700">);<br />     echo </span><span style="color: #DD0000">"Transaction rolled back.&lt;br /&gt;"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sqlsrv-rollback-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sqlsrv-begin-transaction.php" class="function" rel="rdfs-seeAlso">sqlsrv_begin_transaction()</a> - Begins a database transaction</span></li>
    <li><span class="function"><a href="function.sqlsrv-commit.php" class="function" rel="rdfs-seeAlso">sqlsrv_commit()</a> - Commits a transaction that was begun with sqlsrv_begin_transaction</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlsrv/functions/sqlsrv-rollback.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sqlsrv-rollback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sqlsrv-rollback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sqlsrv-rollback.php">＋<small>add a note</small></a></span>
