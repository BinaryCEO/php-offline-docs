...
<head>
  ...
  <title>PHP: variant_idiv - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-idiv.php">
 <link rel="shorturl" href="https://www.php.net/variant-idiv">
 <link rel="alternate" href="https://www.php.net/variant-idiv" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-get-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-imp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-idiv.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-idiv.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-idiv.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-idiv.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-idiv.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-idiv.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-idiv.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-idiv.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-idiv.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-idiv.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-idiv.php" hreflang="zh">
...
<meta name="Description" content="Converts variants to integers and then returns the result from dividing them" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_idiv - Manual" />
<meta name="twitter:description" content="Converts variants to integers and then returns the result from dividing them" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_idiv - Manual" />
<meta itemprop="description" content="Converts variants to integers and then returns the result from dividing them" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts variants to integers and then returns the result from dividing them" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.variant-imp.php">
          variant_imp &raquo;
              ...
              <div class="prev">
        <a href="function.variant-get-type.php">
          &laquo; variant_get_type        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-idiv.php' selected="selected">English</option>
            <option value='de/function.variant-idiv.php'>German</option>
            <option value='es/function.variant-idiv.php'>Spanish</option>
            <option value='fr/function.variant-idiv.php'>French</option>
            <option value='it/function.variant-idiv.php'>Italian</option>
            <option value='ja/function.variant-idiv.php'>Japanese</option>
            <option value='pt_BR/function.variant-idiv.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-idiv.php'>Russian</option>
            <option value='tr/function.variant-idiv.php'>Turkish</option>
            <option value='uk/function.variant-idiv.php'>Ukrainian</option>
            <option value='zh/function.variant-idiv.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-idiv" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-div.php" class="function" rel="rdfs-seeAlso">variant_div()</a> - Returns the result from dividing two variants</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-idiv.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-idiv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-idiv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-idiv.php">＋<small>add a note</small></a></span>
