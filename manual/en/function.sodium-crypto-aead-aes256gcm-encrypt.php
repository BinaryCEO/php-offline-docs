...
<head>
  ...
  <title>PHP: sodium_crypto_aead_aes256gcm_encrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-encrypt.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-aead-aes256gcm-encrypt">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-aead-aes256gcm-encrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-is-available.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-aead-aes256gcm-encrypt.php" hreflang="zh">
...
<meta name="Description" content="Encrypt then authenticate with AES-256-GCM" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_aes256gcm_encrypt - Manual" />
<meta name="twitter:description" content="Encrypt then authenticate with AES-256-GCM" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_aes256gcm_encrypt - Manual" />
<meta itemprop="description" content="Encrypt then authenticate with AES-256-GCM" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypt then authenticate with AES-256-GCM" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-aead-aes256gcm-is-available.php">
          sodium_crypto_aead_aes256gcm_is_available &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-aes256gcm-decrypt.php">
          &laquo; sodium_crypto_aead_aes256gcm_decrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-aes256gcm-encrypt.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-aead-aes256gcm-encrypt.php'>German</option>
            <option value='es/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-aead-aes256gcm-encrypt.php'>French</option>
            <option value='it/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Italian</option>
            <option value='ja/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Russian</option>
            <option value='tr/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-aead-aes256gcm-encrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-aead-aes256gcm-encrypt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_aead_aes256gcm_encrypt</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_aead_aes256gcm_encrypt</span> &mdash; <span class="dc-title">Encrypt then authenticate with AES-256-GCM</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-aes256gcm-encrypt-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_aead_aes256gcm_encrypt</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$additional_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-aead-aes256gcm-encrypt-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-aes256gcm-encrypt-returnvalues">
  ...
  <p class="para">
   Returns the ciphertext and authentication tag as a string of raw binary bytes. (Format: ciphertext, then tag.)
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-aes256gcm-encrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-aes256gcm-encrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aes256gcm-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-encrypt.php">＋<small>add a note</small></a></span>
