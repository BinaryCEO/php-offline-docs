...
<head>
  ...
  <title>PHP: openssl_cms_encrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-cms-encrypt.php">
 <link rel="shorturl" href="https://www.php.net/openssl-cms-encrypt">
 <link rel="alternate" href="https://www.php.net/openssl-cms-encrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cms-decrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-cms-read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-cms-encrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-cms-encrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-cms-encrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-cms-encrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-cms-encrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-cms-encrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-cms-encrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-cms-encrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-cms-encrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-cms-encrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-cms-encrypt.php" hreflang="zh">
...
<meta name="Description" content="Encrypt a CMS message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_cms_encrypt - Manual" />
<meta name="twitter:description" content="Encrypt a CMS message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_cms_encrypt - Manual" />
<meta itemprop="description" content="Encrypt a CMS message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypt a CMS message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-cms-read.php">
          openssl_cms_read &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-cms-decrypt.php">
          &laquo; openssl_cms_decrypt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-cms-encrypt.php' selected="selected">English</option>
            <option value='de/function.openssl-cms-encrypt.php'>German</option>
            <option value='es/function.openssl-cms-encrypt.php'>Spanish</option>
            <option value='fr/function.openssl-cms-encrypt.php'>French</option>
            <option value='it/function.openssl-cms-encrypt.php'>Italian</option>
            <option value='ja/function.openssl-cms-encrypt.php'>Japanese</option>
            <option value='pt_BR/function.openssl-cms-encrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-cms-encrypt.php'>Russian</option>
            <option value='tr/function.openssl-cms-encrypt.php'>Turkish</option>
            <option value='uk/function.openssl-cms-encrypt.php'>Ukrainian</option>
            <option value='zh/function.openssl-cms-encrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-cms-encrypt" class="refentry">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-cms-encrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-cms-encrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-cms-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-encrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125865">  <div class="votes">
    <div id="Vu125865">
    <a href="/manual/vote-note.php?id=125865&amp;page=function.openssl-cms-encrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125865">
    <a href="/manual/vote-note.php?id=125865&amp;page=function.openssl-cms-encrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125865" title="77% like this...">
    10
    </div>
  </div>
  <a href="#125865" class="name">
  <strong class="user"><em>Sebastian</em></strong></a><a class="genanchor" href="#125865"> &para;</a><div class="date" title="2021-02-28 09:13"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125865">
<div class="phpcode"><code><span class="html">It took me a while to find out the correct way how to sign and encrypt data with these functions.<br />I needed that to communicate with German Health Insurance Providers as part of a DiGA. Maybe someone finds that useful.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">signAndEncrypt</span><span class="keyword">(</span><span class="default">string $rawData</span><span class="keyword">): </span><span class="default">string<br /></span><span class="keyword">{<br />    </span><span class="default">$tempDir </span><span class="keyword">= </span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/tmp'</span><span class="keyword">;<br />    </span><span class="default">$tempfileOriginal </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'original'</span><span class="keyword">);<br />    </span><span class="default">$tempfileSigned </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'signed'</span><span class="keyword">);<br />    </span><span class="default">$tempfileEncrypted </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'signedEncrypted'</span><span class="keyword">);<br /><br />    </span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="default">$tempfileOriginal</span><span class="keyword">, </span><span class="default">$rawData</span><span class="keyword">);<br /><br />    </span><span class="comment">// pick the correct certificate for the recipient<br />    </span><span class="default">$recipientsCertificateFile </span><span class="keyword">= </span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/recipientsCertificate.pem'</span><span class="keyword">;<br />    </span><span class="comment">// -----BEGIN CERTIFICATE----- ...-----END CERTIFICATE-----<br />    </span><span class="default">$recipientsCertificate </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$recipientsCertificateFile</span><span class="keyword">);<br /><br />    </span><span class="comment">// Certificate:<br />    //    Data:<br />    //        Version: 3 (0x2)...<br />    </span><span class="default">$myCertificate </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/my.crt'</span><span class="keyword">);<br />    </span><span class="default">$myPrivateKey </span><span class="keyword">= </span><span class="default">openssl_pkey_get_private</span><span class="keyword">(<br />        </span><span class="comment">// -----BEGIN RSA PRIVATE KEY----- ... -----END RSA PRIVATE KEY-----<br />        </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/my.prv.key.pem'</span><span class="keyword">)<br />    );<br /><br />    </span><span class="default">openssl_cms_sign</span><span class="keyword">(<br />        </span><span class="default">input_filename</span><span class="keyword">: </span><span class="default">$tempfileOriginal</span><span class="keyword">,<br />        </span><span class="default">output_filename</span><span class="keyword">: </span><span class="default">$tempfileSigned</span><span class="keyword">,<br />        </span><span class="default">certificate</span><span class="keyword">: </span><span class="default">$myCertificate</span><span class="keyword">,<br />        </span><span class="default">private_key</span><span class="keyword">: </span><span class="default">$myPrivateKey</span><span class="keyword">,<br />        </span><span class="default">headers</span><span class="keyword">: [],<br />        </span><span class="default">encoding</span><span class="keyword">: </span><span class="default">OPENSSL_ENCODING_DER</span><span class="keyword">,<br />    );<br /><br />    </span><span class="default">openssl_cms_encrypt</span><span class="keyword">(<br />        </span><span class="default">input_filename</span><span class="keyword">: </span><span class="default">$tempfileSigned</span><span class="keyword">,<br />        </span><span class="default">output_filename</span><span class="keyword">: </span><span class="default">$tempfileEncrypted</span><span class="keyword">,<br />        </span><span class="default">certificate</span><span class="keyword">: </span><span class="default">$recipientsCertificate</span><span class="keyword">,<br />        </span><span class="default">headers</span><span class="keyword">: [],<br />        </span><span class="default">flags</span><span class="keyword">: </span><span class="default">OPENSSL_CMS_BINARY </span><span class="keyword">| </span><span class="default">OPENSSL_CMS_NOSIGS </span><span class="keyword">| </span><span class="default">OPENSSL_CMS_NOVERIFY</span><span class="keyword">,<br />        </span><span class="default">encoding</span><span class="keyword">: </span><span class="default">OPENSSL_ENCODING_DER</span><span class="keyword">,<br />        </span><span class="default">cipher_algo</span><span class="keyword">: </span><span class="default">OPENSSL_CIPHER_AES_256_CBC<br />    </span><span class="keyword">);<br />    return </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$tempfileEncrypted</span><span class="keyword">);<br />}</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-cms-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-encrypt.php">＋<small>add a note</small></a></div>
