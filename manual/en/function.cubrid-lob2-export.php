...
<head>
  ...
  <title>PHP: cubrid_lob2_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-lob2-export.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-lob2-export">
 <link rel="alternate" href="https://www.php.net/cubrid-lob2-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-lob2-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-lob2-import.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-lob2-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-lob2-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-lob2-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-lob2-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-lob2-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-lob2-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-lob2-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-lob2-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-lob2-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-lob2-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-lob2-export.php" hreflang="zh">
...
<meta name="Description" content="Export the lob object to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_lob2_export - Manual" />
<meta name="twitter:description" content="Export the lob object to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_lob2_export - Manual" />
<meta itemprop="description" content="Export the lob object to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export the lob object to a file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-lob2-import.php">
          cubrid_lob2_import &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-lob2-close.php">
          &laquo; cubrid_lob2_close        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-lob2-export.php' selected="selected">English</option>
            <option value='de/function.cubrid-lob2-export.php'>German</option>
            <option value='es/function.cubrid-lob2-export.php'>Spanish</option>
            <option value='fr/function.cubrid-lob2-export.php'>French</option>
            <option value='it/function.cubrid-lob2-export.php'>Italian</option>
            <option value='ja/function.cubrid-lob2-export.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-lob2-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-lob2-export.php'>Russian</option>
            <option value='tr/function.cubrid-lob2-export.php'>Turkish</option>
            <option value='uk/function.cubrid-lob2-export.php'>Ukrainian</option>
            <option value='zh/function.cubrid-lob2-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-lob2-export" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-lob2-export-examples">
  ...
  <div class="example" id="example-1252">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-lob2-bind.php" class="function" rel="rdfs-seeAlso">cubrid_lob2_bind()</a> - Bind a lob object or a string as a lob object to a prepared statement as parameters</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-lob2-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-lob2-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-lob2-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-lob2-export.php">＋<small>add a note</small></a></span>
