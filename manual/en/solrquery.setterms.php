...
<head>
  ...
  <title>PHP: SolrQuery::setTerms - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setterms.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setterms.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setterms.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setstats.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermsfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setterms.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setterms.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setterms.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setterms.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setterms.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setterms.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setterms.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setterms.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setterms.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setterms.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setterms.php" hreflang="zh">
...
<meta name="Description" content="Enables or disables the TermsComponent" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTerms - Manual" />
<meta name="twitter:description" content="Enables or disables the TermsComponent" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTerms - Manual" />
<meta itemprop="description" content="Enables or disables the TermsComponent" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enables or disables the TermsComponent" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.settermsfield.php">
          SolrQuery::setTermsField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setstats.php">
          &laquo; SolrQuery::setStats        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setterms.php' selected="selected">English</option>
            <option value='de/solrquery.setterms.php'>German</option>
            <option value='es/solrquery.setterms.php'>Spanish</option>
            <option value='fr/solrquery.setterms.php'>French</option>
            <option value='it/solrquery.setterms.php'>Italian</option>
            <option value='ja/solrquery.setterms.php'>Japanese</option>
            <option value='pt_BR/solrquery.setterms.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setterms.php'>Russian</option>
            <option value='tr/solrquery.setterms.php'>Turkish</option>
            <option value='uk/solrquery.setterms.php'>Ukrainian</option>
            <option value='zh/solrquery.setterms.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setterms" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTerms</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTerms</span> &mdash; <span class="dc-title">Enables or disables the TermsComponent</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setterms-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTerms</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setterms-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> enables it. <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> turns it off
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setterms-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setterms.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setterms%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setterms&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setterms.php">＋<small>add a note</small></a></span>
