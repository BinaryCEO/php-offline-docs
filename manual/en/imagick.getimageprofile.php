...
<head>
  ...
  <title>PHP: Imagick::getImageProfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagepixelcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageprofiles.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageprofile.php" hreflang="zh">
...
<meta name="Description" content="Returns the named image profile" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageProfile - Manual" />
<meta name="twitter:description" content="Returns the named image profile" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageProfile - Manual" />
<meta itemprop="description" content="Returns the named image profile" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the named image profile" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageprofiles.php">
          Imagick::getImageProfiles &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagepixelcolor.php">
          &laquo; Imagick::getImagePixelColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageprofile.php' selected="selected">English</option>
            <option value='de/imagick.getimageprofile.php'>German</option>
            <option value='es/imagick.getimageprofile.php'>Spanish</option>
            <option value='fr/imagick.getimageprofile.php'>French</option>
            <option value='it/imagick.getimageprofile.php'>Italian</option>
            <option value='ja/imagick.getimageprofile.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageprofile.php'>Russian</option>
            <option value='tr/imagick.getimageprofile.php'>Turkish</option>
            <option value='uk/imagick.getimageprofile.php'>Ukrainian</option>
            <option value='zh/imagick.getimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageProfile</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageProfile</span> &mdash; <span class="dc-title">Returns the named image profile</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageProfile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageprofile-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageprofile-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageprofile.php">＋<small>add a note</small></a></span>
