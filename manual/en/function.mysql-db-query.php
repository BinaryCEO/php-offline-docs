...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-db-query.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-db-name.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-drop-db.php">
...
<meta name="Description" content="Selects a database and executes a query on it" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_db_query - Manual" />
<meta name="twitter:description" content="Selects a database and executes a query on it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_db_query - Manual" />
<meta itemprop="description" content="Selects a database and executes a query on it" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Selects a database and executes a query on it" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-db-query.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_db_query</span> &mdash; <span class="dc-title">Selects a database and executes a query on it</span></p>

 </div>

 <div id="function.mysql-db-query-refsynopsisdiv">
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">This function was deprecated in PHP 5.3.0, and it
...
Alternatives to this function include:</p>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-db-query-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_db_query()</strong></span> selects a database, and executes a 
   query on it.
  </p>
 </div>
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-db-query-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error. The function also returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>/<strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-db-query-examples">
  ...
  <p class="para">
   <div class="example" id="example-1884">
    <p><strong>Example #1 <span class="function"><strong>mysql_db_query()</strong></span> alternative example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">if (!</span><span style="color: #0000BB">$link </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysql_host'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_user'</span><span style="color: #007700">, </span><span style="color: #DD0000">'mysql_password'</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">'Could not connect to mysql'</span><span style="color: #007700">;<br />    exit;<br />}<br /><br />if (!</span><span style="color: #0000BB">mysql_select_db</span><span style="color: #007700">(</span><span style="color: #DD0000">'mysql_dbname'</span><span style="color: #007700">, </span><span style="color: #0000BB">$link</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">'Could not select database'</span><span style="color: #007700">;<br />    exit;<br />}<br /><br /></span><span style="color: #0000BB">$sql    </span><span style="color: #007700">= </span><span style="color: #DD0000">'SELECT foo FROM bar WHERE id = 42'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$sql</span><span style="color: #007700">, </span><span style="color: #0000BB">$link</span><span style="color: #007700">);<br /><br />if (!</span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"DB Error, could not query the database\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">'MySQL Error: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">mysql_error</span><span style="color: #007700">();<br />    exit;<br />}<br /><br />while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">mysql_fetch_assoc</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">];<br />}<br /><br /></span><span style="color: #0000BB">mysql_free_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mysql-db-query-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    Be aware that this function does <strong>NOT</strong>
    switch back to the database you were connected before. In other words,
    you can&#039;t use this function to <em>temporarily</em> run a
    sql query on another database, you would have to manually switch back.
    Users are strongly encouraged to use the
    <code class="literal">database.table</code> syntax in their sql queries or
    <span class="function"><a href="function.mysql-select-db.php" class="function">mysql_select_db()</a></span> instead of this function.
   </p>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-select-db.php" class="function" rel="rdfs-seeAlso">mysql_select_db()</a> - Select a MySQL database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-db-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-db-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-db-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-db-query.php">＋<small>add a note</small></a></span>
