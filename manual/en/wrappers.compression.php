...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/wrappers.compression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/wrappers.compression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.compression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/wrappers.php">
 <link rel="prev" href="https://www.php.net/manual/en/wrappers.php.php">
 <link rel="next" href="https://www.php.net/manual/en/wrappers.data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/wrappers.compression.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/wrappers.compression.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/wrappers.compression.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/wrappers.compression.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/wrappers.compression.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/wrappers.compression.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/wrappers.compression.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/wrappers.compression.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/wrappers.compression.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/wrappers.compression.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/wrappers.compression.php" hreflang="zh">
...
<meta name="Description" content="Compression Streams" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: zlib:// - Manual" />
<meta name="twitter:description" content="Compression Streams" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: zlib:// - Manual" />
<meta itemprop="description" content="Compression Streams" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compression Streams" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/wrappers.compression.php' selected="selected">English</option>
            ...
            <option value='it/wrappers.compression.php'>Italian</option>
            ...
            <option value='uk/wrappers.compression.php'>Ukrainian</option>
  ...
  </div><div id="wrappers.compression" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-wrappers.compression-seealso">
  ...
  <ul class="simplelist">
   <li><a href="context.zlib.php" class="xref">Zlib context options</a></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/wrappers/compression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fwrappers.compression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.compression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/wrappers.compression.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120583">  <div class="votes">
    <div id="Vu120583">
    <a href="/manual/vote-note.php?id=120583&amp;page=wrappers.compression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120583">
    <a href="/manual/vote-note.php?id=120583&amp;page=wrappers.compression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120583" title="75% like this...">
    21
    </div>
  </div>
  <a href="#120583" class="name">
  <strong class="user"><em>lewa::cpan.org</em></strong></a><a class="genanchor" href="#120583"> &para;</a><div class="date" title="2017-02-03 01:56"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120583">
<div class="phpcode"><code><span class="html">One-liners to gzip and ungzip a file:<br /><br />copy('file.txt', 'compress.zlib://' . 'file.txt.gz');<br /><br />copy('compress.zlib://' . 'file.txt.gz', 'file.txt');</span></code></div>
  </div>
 </div>
  <div class="note" id="103425">  <div class="votes">
    <div id="Vu103425">
    <a href="/manual/vote-note.php?id=103425&amp;page=wrappers.compression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103425">
    <a href="/manual/vote-note.php?id=103425&amp;page=wrappers.compression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103425" title="68% like this...">
    12
    </div>
  </div>
  <a href="#103425" class="name">
  <strong class="user"><em>alvaro at demogracia dot com</em></strong></a><a class="genanchor" href="#103425"> &para;</a><div class="date" title="2011-04-12 07:41"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103425">
<div class="phpcode"><code><span class="html">Example on how to read an entry from a ZIP archive (file "bar.txt" inside "./foo.zip"):
<br />
...
<br /></span>
<br />Also, apparently, the "zip:" wrapper does not allow writing as of PHP/5.3.6. You can read <a href="http://php.net/ziparchive-getstream" rel="nofollow" target="_blank">http://php.net/ziparchive-getstream</a> for further reference since the underlying code is probably the same.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=wrappers.compression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/wrappers.compression.php">＋<small>add a note</small></a></div>
