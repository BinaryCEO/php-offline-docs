...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/control-structures.for.php">
 <link rel="shorturl" href="https://www.php.net/for">
 <link rel="alternate" href="https://www.php.net/for" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.control-structures.php">
 <link rel="prev" href="https://www.php.net/manual/en/control-structures.do.while.php">
 <link rel="next" href="https://www.php.net/manual/en/control-structures.foreach.php">

 <link rel="alternate" href="https://www.php.net/manual/en/control-structures.for.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/control-structures.for.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/control-structures.for.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/control-structures.for.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/control-structures.for.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/control-structures.for.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/control-structures.for.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/control-structures.for.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/control-structures.for.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/control-structures.for.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/control-structures.for.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: for - Manual" />
<meta name="twitter:description" content="for" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: for - Manual" />
<meta itemprop="description" content="for" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/control-structures.for.php'>Italian</option>
            ...
            <option value='uk/control-structures.for.php'>Ukrainian</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$people </span><span style="color: #007700">= array(<br />    array(</span><span style="color: #DD0000">'name' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'Kalle'</span><span style="color: #007700">, </span><span style="color: #DD0000">'salt' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">856412</span><span style="color: #007700">),<br />    array(</span><span style="color: #DD0000">'name' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'Pierre'</span><span style="color: #007700">, </span><span style="color: #DD0000">'salt' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">215863</span><span style="color: #007700">)<br />);<br /><br />for(</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">$size </span><span style="color: #007700">= </span><span style="color: #0000BB">count</span><span style="color: #007700">(</span><span style="color: #0000BB">$people</span><span style="color: #007700">); </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$size</span><span style="color: #007700">; ++</span><span style="color: #0000BB">$i</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$people</span><span style="color: #007700">[</span><span style="color: #0000BB">$i</span><span style="color: #007700">][</span><span style="color: #DD0000">'salt'</span><span style="color: #007700">] = </span><span style="color: #0000BB">mt_rand</span><span style="color: #007700">(</span><span style="color: #0000BB">000000</span><span style="color: #007700">, </span><span style="color: #0000BB">999999</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/control-structures/for.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcontrol-structures.for%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=control-structures.for&amp;repo=en&amp;redirect=https://www.php.net/manual/en/control-structures.for.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="107427">  <div class="votes">
    ...
    <div class="tally" id="V107427" title="66% like this...">
    332
    </div>
  </div>
  <a href="#107427" class="name">
  <strong class="user"><em>matthiaz</em></strong></a><a class="genanchor" href="#107427"> &para;</a><div class="date" title="2012-02-08 02:37"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107427">
<div class="phpcode"><code><span class="html">Looping through letters is possible. I'm amazed at how few people know that.<br /><br />for($col = 'R'; $col != 'AD'; $col++) {<br />    echo $col.' ';<br />}<br /><br />returns: R S T U V W X Y Z AA AB AC<br /><br />Take note that you can't use $col &lt; 'AD'. It only works with !=<br />Very convenient when working with excel columns.</span></code></div>
  </div>
 </div>
  <div class="note" id="13463">  <div class="votes">
    ...
    <div class="tally" id="V13463" title="56% like this...">
    68
    </div>
  </div>
  <a href="#13463" class="name">
  <strong class="user"><em>nzamani at cyberworldz dot de</em></strong></a><a class="genanchor" href="#13463"> &para;</a><div class="date" title="2001-06-17 11:47"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom13463">
<div class="phpcode"><code><span class="html">The point about the speed in loops is, that the middle and the last expression are executed EVERY time it loops.
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />The $i gets changed after the copy for the function (post-increment).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=control-structures.for&amp;repo=en&amp;redirect=https://www.php.net/manual/en/control-structures.for.php">＋<small>add a note</small></a></div>
