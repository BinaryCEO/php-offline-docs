...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.octdec.php">
 <link rel="shorturl" href="https://www.php.net/octdec">
 <link rel="alternate" href="https://www.php.net/octdec" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.math.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.min.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pi.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.octdec.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.octdec.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.octdec.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.octdec.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.octdec.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.octdec.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.octdec.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.octdec.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.octdec.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.octdec.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.octdec.php" hreflang="zh">
...
<meta name="Description" content="Octal to decimal" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: octdec - Manual" />
<meta name="twitter:description" content="Octal to decimal" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: octdec - Manual" />
<meta itemprop="description" content="Octal to decimal" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Octal to decimal" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.octdec.php' selected="selected">English</option>
            <option value='de/function.octdec.php'>German</option>
            <option value='es/function.octdec.php'>Spanish</option>
            <option value='fr/function.octdec.php'>French</option>
            <option value='it/function.octdec.php'>Italian</option>
            <option value='ja/function.octdec.php'>Japanese</option>
            <option value='pt_BR/function.octdec.php'>Brazilian Portuguese</option>
            <option value='ru/function.octdec.php'>Russian</option>
            <option value='tr/function.octdec.php'>Turkish</option>
            <option value='uk/function.octdec.php'>Ukrainian</option>
            <option value='zh/function.octdec.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.octdec" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">octdec</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">octdec</span> &mdash; <span class="dc-title">Octal to decimal</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.octdec-description">
  ...
  <p class="para rdfs-comment">
   ...
   represented by the <code class="parameter">octal_string</code> argument.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       Any invalid characters in <code class="parameter">octal_string</code> are silently ignored.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.octdec-returnvalues">
  ...
  <p class="para">
   The decimal representation of <code class="parameter">octal_string</code>
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.octdec-examples">
  ...
  <p class="para">
   <div class="example" id="example-3384">
    <p><strong>Example #1 <span class="function"><strong>octdec()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.base-convert.php" class="function" rel="rdfs-seeAlso">base_convert()</a> - Convert a number between arbitrary bases</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/math/functions/octdec.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.octdec%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.octdec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.octdec.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="85170">  <div class="votes">
    <div id="Vu85170">
    <a href="/manual/vote-note.php?id=85170&amp;page=function.octdec&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85170">
    <a href="/manual/vote-note.php?id=85170&amp;page=function.octdec&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85170" title="51% like this...">
    1
    </div>
  </div>
  <a href="#85170" class="name">
  <strong class="user"><em>contato at andersonfraga dot net</em></strong></a><a class="genanchor" href="#85170"> &para;</a><div class="date" title="2008-08-18 01:30"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85170">
<div class="phpcode"><code><span class="html">Number is octal?<br /><br />Simple and easy:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">is_octal</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">) {<br />    return </span><span class="default">decoct</span><span class="keyword">(</span><span class="default">octdec</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">)) == </span><span class="default">$x</span><span class="keyword">;<br />}<br /><br />echo </span><span class="default">is_octal</span><span class="keyword">(</span><span class="default">077</span><span class="keyword">); </span><span class="comment">// true<br /></span><span class="keyword">echo </span><span class="default">is_octal</span><span class="keyword">(</span><span class="default">195</span><span class="keyword">); </span><span class="comment">// false<br /><br /></span><span class="default">?&gt;<br /></span><br />Thanks<br />[]'s</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.octdec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.octdec.php">＋<small>add a note</small></a></div>
