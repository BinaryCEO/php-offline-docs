...
<head>
  ...
  <title>PHP: fann_get_total_connections - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-total-connections.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-total-connections">
 <link rel="alternate" href="https://www.php.net/fann-get-total-connections" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-sarprop-weight-decay-shift.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-total-neurons.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-total-connections.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-total-connections.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-total-connections.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-total-connections.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-total-connections.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-total-connections.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-total-connections.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-total-connections.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-total-connections.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-total-connections.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-total-connections.php" hreflang="zh">
...
<meta name="Description" content="Get the total number of connections in the entire network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_total_connections - Manual" />
<meta name="twitter:description" content="Get the total number of connections in the entire network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_total_connections - Manual" />
<meta itemprop="description" content="Get the total number of connections in the entire network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the total number of connections in the entire network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-total-neurons.php">
          fann_get_total_neurons &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-sarprop-weight-decay-shift.php">
          &laquo; fann_get_sarprop_weight_decay_shift        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-total-connections.php' selected="selected">English</option>
            <option value='de/function.fann-get-total-connections.php'>German</option>
            <option value='es/function.fann-get-total-connections.php'>Spanish</option>
            <option value='fr/function.fann-get-total-connections.php'>French</option>
            <option value='it/function.fann-get-total-connections.php'>Italian</option>
            <option value='ja/function.fann-get-total-connections.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-total-connections.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-total-connections.php'>Russian</option>
            <option value='tr/function.fann-get-total-connections.php'>Turkish</option>
            <option value='uk/function.fann-get-total-connections.php'>Ukrainian</option>
            <option value='zh/function.fann-get-total-connections.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-total-connections" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_total_connections</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_total_connections</span> &mdash; <span class="dc-title">Get the total number of connections in the entire network</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-total-connections-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_total_connections</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-get-total-connections-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-total-connections-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Total number of connections in the entire network, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-total-connections.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-total-connections%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-total-connections&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-total-connections.php">＋<small>add a note</small></a></span>
