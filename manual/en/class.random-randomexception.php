...
<head>
  ...
  <title>PHP: Random\RandomException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.random-randomexception.php">
 <link rel="shorturl" href="https://www.php.net/random-randomexception">
 <link rel="alternate" href="https://www.php.net/random-randomexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.random.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.random-brokenrandomengineerror.php">
 <link rel="next" href="https://www.php.net/manual/en/book.seaslog.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.random-randomexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.random-randomexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.random-randomexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.random-randomexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.random-randomexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.random-randomexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.random-randomexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.random-randomexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.random-randomexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.random-randomexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.random-randomexception.php" hreflang="zh">
...
<meta name="Description" content="The Random\RandomException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Random\RandomException - Manual" />
<meta name="twitter:description" content="The Random\RandomException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Random\RandomException - Manual" />
<meta itemprop="description" content="The Random\RandomException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Random\RandomException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.seaslog.php">
          Seaslog &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.random-brokenrandomengineerror.php">
          &laquo; Random\BrokenRandomEngineError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.random-randomexception.php' selected="selected">English</option>
            <option value='de/class.random-randomexception.php'>German</option>
            <option value='es/class.random-randomexception.php'>Spanish</option>
            <option value='fr/class.random-randomexception.php'>French</option>
            <option value='it/class.random-randomexception.php'>Italian</option>
            <option value='ja/class.random-randomexception.php'>Japanese</option>
            <option value='pt_BR/class.random-randomexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.random-randomexception.php'>Russian</option>
            <option value='tr/class.random-randomexception.php'>Turkish</option>
            <option value='uk/class.random-randomexception.php'>Ukrainian</option>
            <option value='zh/class.random-randomexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.random-randomexception" class="reference">
 <h1 class="title">The Random\RandomException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.2.0)</p>


  <div class="section" id="random-randomexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The base class for <span class="type"><a href="class.exception.php" class="type Exception">Exception</a></span>s that occur during generation or use of randomness.
   </p>
  </div>


  <div class="section" id="random-randomexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">Random\RandomException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/random.randomexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.random-randomexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.random-randomexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.random-randomexception.php">＋<small>add a note</small></a></span>
