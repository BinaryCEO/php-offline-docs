...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightAlternateField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlight.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightformatter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightalternatefield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightalternatefield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightalternatefield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightalternatefield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightalternatefield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightalternatefield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightalternatefield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightalternatefield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightalternatefield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightalternatefield.php" hreflang="zh">
...
<meta name="Description" content="Specifies the backup field to use" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightAlternateField - Manual" />
<meta name="twitter:description" content="Specifies the backup field to use" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightAlternateField - Manual" />
<meta itemprop="description" content="Specifies the backup field to use" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the backup field to use" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightformatter.php">
          SolrQuery::setHighlightFormatter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlight.php">
          &laquo; SolrQuery::setHighlight        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightalternatefield.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightalternatefield.php'>German</option>
            <option value='es/solrquery.sethighlightalternatefield.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightalternatefield.php'>French</option>
            <option value='it/solrquery.sethighlightalternatefield.php'>Italian</option>
            <option value='ja/solrquery.sethighlightalternatefield.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightalternatefield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightalternatefield.php'>Russian</option>
            <option value='tr/solrquery.sethighlightalternatefield.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightalternatefield.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightalternatefield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightalternatefield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightAlternateField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightAlternateField</span> &mdash; <span class="dc-title">Specifies the backup field to use</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightalternatefield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightAlternateField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightalternatefield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightalternatefield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightalternatefield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightalternatefield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightalternatefield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightalternatefield.php">＋<small>add a note</small></a></span>
