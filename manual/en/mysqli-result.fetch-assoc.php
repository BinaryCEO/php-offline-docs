...
<head>
  ...
  <title>PHP: mysqli_result::fetch_assoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-result.fetch-array.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.fetch-column.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-result.fetch-assoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-result.fetch-assoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-result.fetch-assoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-result.fetch-assoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-result.fetch-assoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-result.fetch-assoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-result.fetch-assoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-result.fetch-assoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-result.fetch-assoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-result.fetch-assoc.php" hreflang="zh">
...
<meta name="Description" content="Fetch the next row of a result set as an associative array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::fetch_assoc - Manual" />
<meta name="twitter:description" content="Fetch the next row of a result set as an associative array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::fetch_assoc - Manual" />
<meta itemprop="description" content="Fetch the next row of a result set as an associative array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch the next row of a result set as an associative array" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-result.fetch-column.php">
          mysqli_result::fetch_column &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-result.fetch-array.php">
          &laquo; mysqli_result::fetch_array        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.fetch-assoc.php' selected="selected">English</option>
            <option value='de/mysqli-result.fetch-assoc.php'>German</option>
            <option value='es/mysqli-result.fetch-assoc.php'>Spanish</option>
            <option value='fr/mysqli-result.fetch-assoc.php'>French</option>
            <option value='it/mysqli-result.fetch-assoc.php'>Italian</option>
            <option value='ja/mysqli-result.fetch-assoc.php'>Japanese</option>
            <option value='pt_BR/mysqli-result.fetch-assoc.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-result.fetch-assoc.php'>Russian</option>
            <option value='tr/mysqli-result.fetch-assoc.php'>Turkish</option>
            <option value='uk/mysqli-result.fetch-assoc.php'>Ukrainian</option>
            <option value='zh/mysqli-result.fetch-assoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-result.fetch-assoc" class="refentry">
...
Santa Clara (USA)</pre>
  ...
  <div class="example" id="mysqli-result.example.iterator">
   <p><strong>Example #2 Comparison of <span class="classname"><a href="class.mysqli-result.php" class="classname">mysqli_result</a></span> <span class="classname"><a href="class.iterator.php" class="classname">iterator</a></span> and <span class="methodname"><strong>mysqli_result::fetch_assoc()</strong></span> usage</strong></p>
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />The former will cause your script to run until max_execution_time is reached.</span></code></div>
  </div>
 </div>
  <div class="note" id="128432">  <div class="votes">
    <div id="Vu128432">
    <a href="/manual/vote-note.php?id=128432&amp;page=mysqli-result.fetch-assoc&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128432">
    <a href="/manual/vote-note.php?id=128432&amp;page=mysqli-result.fetch-assoc&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128432" title="63% like this...">
    3
    </div>
  </div>
  <a href="#128432" class="name">
  <strong class="user"><em>Enrique Garcia</em></strong></a><a class="genanchor" href="#128432"> &para;</a><div class="date" title="2023-04-26 08:35"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128432">
<div class="phpcode"><code><span class="html">There is a difference between MariaDB and MySQL(&gt;5.4) whether the input parameter (mysqli object) has data or is empty (it comes from a previus query).<br />-MariaDB:  you get an exception:<br />Fatal error: Uncaught TypeError: mysqli_fetch_assoc(): Argument #1 ($result) must be of type mysqli_result<br />-MySQL: you can continue, in spite of not having data in the mysqli object.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli-result.fetch-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.fetch-assoc.php">＋<small>add a note</small></a></div>
