...
<head>
  ...
  <title>PHP: imap_bodystruct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-bodystruct.php">
 <link rel="shorturl" href="https://www.php.net/imap-bodystruct">
 <link rel="alternate" href="https://www.php.net/imap-bodystruct" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-body.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-check.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-bodystruct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-bodystruct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-bodystruct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-bodystruct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-bodystruct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-bodystruct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-bodystruct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-bodystruct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-bodystruct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-bodystruct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-bodystruct.php" hreflang="zh">
...
<meta name="Description" content="Read the structure of a specified body section of a specific message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_bodystruct - Manual" />
<meta name="twitter:description" content="Read the structure of a specified body section of a specific message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_bodystruct - Manual" />
<meta itemprop="description" content="Read the structure of a specified body section of a specific message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read the structure of a specified body section of a specific message" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-bodystruct.php' selected="selected">English</option>
            <option value='de/function.imap-bodystruct.php'>German</option>
            <option value='es/function.imap-bodystruct.php'>Spanish</option>
            <option value='fr/function.imap-bodystruct.php'>French</option>
            <option value='it/function.imap-bodystruct.php'>Italian</option>
            <option value='ja/function.imap-bodystruct.php'>Japanese</option>
            <option value='pt_BR/function.imap-bodystruct.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-bodystruct.php'>Russian</option>
            <option value='tr/function.imap-bodystruct.php'>Turkish</option>
            <option value='uk/function.imap-bodystruct.php'>Ukrainian</option>
            <option value='zh/function.imap-bodystruct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-bodystruct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_bodystruct</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_bodystruct</span> &mdash; <span class="dc-title">Read the structure of a specified body section of a specific message</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-bodystruct-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_bodystruct</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$message_num</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$section</code></span>): <span class="type"><span class="type"><a href="class.stdclass.php" class="type stdClass">stdClass</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-bodystruct-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-bodystruct-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the information in an object,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-bodystruct-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-bodystruct-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-fetchstructure.php" class="function" rel="rdfs-seeAlso">imap_fetchstructure()</a> - Read the structure of a particular message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-bodystruct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-bodystruct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-bodystruct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-bodystruct.php">＋<small>add a note</small></a></span>
