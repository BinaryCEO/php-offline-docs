...
<head>
  ...
  <title>PHP: ImagickDraw::pushClipPath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.push.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pushdefs.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pushclippath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pushclippath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pushclippath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pushclippath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pushclippath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pushclippath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pushclippath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pushclippath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pushclippath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pushclippath.php" hreflang="zh">
...
<meta name="Description" content="Starts a clip path definition" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pushClipPath - Manual" />
<meta name="twitter:description" content="Starts a clip path definition" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pushClipPath - Manual" />
<meta itemprop="description" content="Starts a clip path definition" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Starts a clip path definition" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.pushdefs.php">
          ImagickDraw::pushDefs &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.push.php">
          &laquo; ImagickDraw::push        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pushclippath.php' selected="selected">English</option>
            <option value='de/imagickdraw.pushclippath.php'>German</option>
            <option value='es/imagickdraw.pushclippath.php'>Spanish</option>
            <option value='fr/imagickdraw.pushclippath.php'>French</option>
            <option value='it/imagickdraw.pushclippath.php'>Italian</option>
            <option value='ja/imagickdraw.pushclippath.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pushclippath.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pushclippath.php'>Russian</option>
            <option value='tr/imagickdraw.pushclippath.php'>Turkish</option>
            <option value='uk/imagickdraw.pushclippath.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pushclippath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pushclippath" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagickdraw.pushclippath-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pushClipPath</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$clip_mask_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
  ...
  <p class="para">
   ...
   commands and terminated by a <span class="methodname"><a href="imagickdraw.popclippath.php" class="methodname">ImagickDraw::popClipPath()</a></span> command.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pushclippath-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">clip_mask_id</code></dt>
     <dd>
      <p class="para">
       Clip mask Id
      </p>
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pushclippath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pushclippath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pushclippath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pushclippath.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103357">  <div class="votes">
    <div id="Vu103357">
    <a href="/manual/vote-note.php?id=103357&amp;page=imagickdraw.pushclippath&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103357">
    <a href="/manual/vote-note.php?id=103357&amp;page=imagickdraw.pushclippath&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103357" title="no votes...">
    0
    </div>
  </div>
  <a href="#103357" class="name">
  <strong class="user"><em>bogdan at moongate dot ro</em></strong></a><a class="genanchor" href="#103357"> &para;</a><div class="date" title="2011-04-08 06:02"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103357">
<div class="phpcode"><code><span class="html">Here's an interactive example for your enjoyment, featuring two intersecting discs. My version doesn't antialias the clipping path; I suppose YMMV.
<br />
<br /><span class="default">&lt;?php
<br />
<br /></span><span class="comment">// Simple clip path example
<br />// Bogdan Stancescu
<br />
<br /></span><span class="default">$showClipping</span><span class="keyword">=</span><span class="default">1</span><span class="keyword">; </span><span class="comment">// Try setting this to 0!
<br /></span><span class="default">$showDrawing</span><span class="keyword">=</span><span class="default">1</span><span class="keyword">;  </span><span class="comment">// Try setting this to 0!
<br />
<br />// Don't edit below this line (at least until you understand the example)
<br />
<br /></span><span class="default">$showBoth</span><span class="keyword">=</span><span class="default">$showClipping </span><span class="keyword">&amp;&amp; </span><span class="default">$showDrawing</span><span class="keyword">;
<br /></span><span class="default">$showAny</span><span class="keyword">=</span><span class="default">$showClipping </span><span class="keyword">|| </span><span class="default">$showDrawing</span><span class="keyword">;
<br />
<br /></span><span class="default">$image</span><span class="keyword">=new </span><span class="default">Imagick</span><span class="keyword">(); </span><span class="comment">// Create image
<br />
<br />// Image size
<br /></span><span class="default">$width</span><span class="keyword">=</span><span class="default">151</span><span class="keyword">;
<br /></span><span class="default">$height</span><span class="keyword">=</span><span class="default">101</span><span class="keyword">;
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'lightgray'</span><span class="keyword">)); </span><span class="comment">// some visible background
<br />
<br /></span><span class="default">$draw</span><span class="keyword">=new </span><span class="default">ImagickDraw</span><span class="keyword">(); </span><span class="comment">// Create draw object
<br />
<br /></span><span class="keyword">if (</span><span class="default">$showBoth</span><span class="keyword">)
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">pushClipPath</span><span class="keyword">(</span><span class="string">'circle_left'</span><span class="keyword">); </span><span class="comment">// Start clipping path
<br />
<br /></span><span class="keyword">if (</span><span class="default">$showClipping</span><span class="keyword">) {
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'red'</span><span class="keyword">); </span><span class="comment">// The color doesn't matter if we clip
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">circle</span><span class="keyword">(</span><span class="default">50</span><span class="keyword">,</span><span class="default">50</span><span class="keyword">,</span><span class="default">50</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">); </span><span class="comment">// A circle that occupies 100x100px on the left
<br /></span><span class="keyword">}
<br />
<br />if (</span><span class="default">$showBoth</span><span class="keyword">) {
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">popClipPath</span><span class="keyword">(); </span><span class="comment">// Finish clipping path
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setClipPath</span><span class="keyword">(</span><span class="string">'circle_left'</span><span class="keyword">); </span><span class="comment">// Use the clipping path above
<br /></span><span class="keyword">}
<br />
<br />if (</span><span class="default">$showDrawing</span><span class="keyword">) {
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'navy'</span><span class="keyword">); </span><span class="comment">// This is the actual drawing color
<br />        </span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">circle</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">,</span><span class="default">50</span><span class="keyword">,</span><span class="default">100</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">); </span><span class="comment">// A circle that occupies 100x100px on the right
<br /></span><span class="keyword">}
<br />
<br />if (</span><span class="default">$showAny</span><span class="keyword">)
<br />        </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">); </span><span class="comment">// Render $draw unto $image
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">); </span><span class="comment">// Tell ImageMagick how to render this
<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">); </span><span class="comment">// Tell the browser how to render this
<br />
<br /></span><span class="keyword">echo </span><span class="default">$image</span><span class="keyword">; </span><span class="comment">// Render the image into the browser
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.pushclippath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pushclippath.php">＋<small>add a note</small></a></div>
