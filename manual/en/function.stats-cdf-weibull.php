...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-cdf-weibull.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-cdf-uniform.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-covariance.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-cdf-weibull.php' selected="selected">English</option>
            ...
            <option value='ja/function.stats-cdf-weibull.php'>Japanese</option>
  ...
  <p class="para">
   Returns CDF, x, k, or lambda, determined by <code class="parameter">which</code>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-cdf-weibull.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-cdf-weibull%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-cdf-weibull&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-cdf-weibull.php">＋<small>add a note</small></a></span>
