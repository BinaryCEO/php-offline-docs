...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.filter.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.filter.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.filter.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.filter.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.filter.php">
 <link rel="next" href="https://www.php.net/manual/en/filter.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.filter.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.filter.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.filter.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.filter.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.filter.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.filter.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.filter.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.filter.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.filter.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.filter.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.filter.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.filter.php' selected="selected">English</option>
            <option value='de/intro.filter.php'>German</option>
            <option value='es/intro.filter.php'>Spanish</option>
            <option value='fr/intro.filter.php'>French</option>
            <option value='it/intro.filter.php'>Italian</option>
            <option value='ja/intro.filter.php'>Japanese</option>
            <option value='pt_BR/intro.filter.php'>Brazilian Portuguese</option>
            <option value='ru/intro.filter.php'>Russian</option>
            <option value='tr/intro.filter.php'>Turkish</option>
            <option value='uk/intro.filter.php'>Ukrainian</option>
            <option value='zh/intro.filter.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.filter" class="preface">
  ...
  <p class="simpara">
   ...
   (e.g. <code class="literal">/foo</code> in <code class="literal">https://example.org/foo</code>).
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.filter%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.filter&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.filter.php">＋<small>add a note</small></a></span>
