...
<head>
  ...
  <title>PHP: Swoole\MySQL\Exception - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-mysql-exception.php">
 <link rel="shorturl" href="https://www.php.net/swoole-mysql-exception">
 <link rel="alternate" href="https://www.php.net/swoole-mysql-exception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/swoole-mysql.query.php">
 <link rel="next" href="https://www.php.net/manual/en/class.swoole-process.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-mysql-exception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-mysql-exception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-mysql-exception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-mysql-exception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-mysql-exception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-mysql-exception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-mysql-exception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-mysql-exception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-mysql-exception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-mysql-exception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-mysql-exception.php" hreflang="zh">
...
<meta name="Description" content="The Swoole\MySQL\Exception class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Swoole\MySQL\Exception - Manual" />
<meta name="twitter:description" content="The Swoole\MySQL\Exception class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Swoole\MySQL\Exception - Manual" />
<meta itemprop="description" content="The Swoole\MySQL\Exception class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Swoole\MySQL\Exception class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.swoole-process.php">
          Swoole\Process &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="swoole-mysql.query.php">
          &laquo; Swoole\MySQL::query        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-mysql-exception.php' selected="selected">English</option>
            <option value='de/class.swoole-mysql-exception.php'>German</option>
            <option value='es/class.swoole-mysql-exception.php'>Spanish</option>
            <option value='fr/class.swoole-mysql-exception.php'>French</option>
            <option value='it/class.swoole-mysql-exception.php'>Italian</option>
            <option value='ja/class.swoole-mysql-exception.php'>Japanese</option>
            <option value='pt_BR/class.swoole-mysql-exception.php'>Brazilian Portuguese</option>
            <option value='ru/class.swoole-mysql-exception.php'>Russian</option>
            <option value='tr/class.swoole-mysql-exception.php'>Turkish</option>
            <option value='uk/class.swoole-mysql-exception.php'>Ukrainian</option>
            <option value='zh/class.swoole-mysql-exception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.swoole-mysql-exception" class="reference">

 <h1 class="title">The Swoole\MySQL\Exception class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL swoole &gt;= 1.9.0)</p>


  <div class="section" id="swoole-mysql-exception.intro">
  ...
  <div class="section" id="swoole-mysql-exception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">Swoole\MySQL\Exception</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">private</span>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.mysql.exception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-mysql-exception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-mysql-exception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-mysql-exception.php">＋<small>add a note</small></a></span>
