...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-random-seed.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-random-range.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-root.php">
...
<meta name="Description" content="Sets the RNG seed" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_random_seed - Manual" />
<meta name="twitter:description" content="Sets the RNG seed" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_random_seed - Manual" />
<meta itemprop="description" content="Sets the RNG seed" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the RNG seed" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-random-seed.php' selected="selected">English</option>
            <option value='de/function.gmp-random-seed.php'>German</option>
            <option value='es/function.gmp-random-seed.php'>Spanish</option>
            <option value='fr/function.gmp-random-seed.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_random_seed</span> &mdash; <span class="dc-title">Sets the RNG seed</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-random-seed-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The seed to be set for the <span class="function"><a href="function.gmp-random.php" class="function">gmp_random()</a></span>,
       <span class="function"><a href="function.gmp-random-bits.php" class="function">gmp_random_bits()</a></span>, and
       <span class="function"><a href="function.gmp-random-range.php" class="function">gmp_random_range()</a></span> functions.
      </p>
 ...
 <div class="refsect1 errors" id="refsect1-function.gmp-random-seed-errors">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span> if <code class="parameter">seed</code>
   is invalid.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       If <code class="parameter">seed</code> is invalid, <span class="function"><strong>gmp_random_seed()</strong></span>
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-random-seed-examples">
  ...
  <p class="para">
   <div class="example" id="example-3346">
    <p><strong>Example #1 <span class="function"><strong>gmp_random_seed()</strong></span> example</strong></p>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.gmp-random-seed-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.gmp-random.php" class="function" rel="rdfs-seeAlso">gmp_random()</a> - Random number</span></li>
   <li><span class="function"><a href="function.gmp-random-bits.php" class="function" rel="rdfs-seeAlso">gmp_random_bits()</a> - Random number</span></li>
   <li><span class="function"><a href="function.gmp-random-range.php" class="function" rel="rdfs-seeAlso">gmp_random_range()</a> - Get a uniformly selected integer</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-random-seed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-random-seed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-random-seed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-random-seed.php">＋<small>add a note</small></a></span>
