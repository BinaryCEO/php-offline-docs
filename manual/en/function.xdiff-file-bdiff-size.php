...
<head>
  ...
  <title>PHP: xdiff_file_bdiff_size - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xdiff-file-bdiff-size.php">
 <link rel="shorturl" href="https://www.php.net/xdiff-file-bdiff-size">
 <link rel="alternate" href="https://www.php.net/xdiff-file-bdiff-size" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xdiff.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xdiff-file-bdiff.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xdiff-file-bpatch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xdiff-file-bdiff-size.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xdiff-file-bdiff-size.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xdiff-file-bdiff-size.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xdiff-file-bdiff-size.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xdiff-file-bdiff-size.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xdiff-file-bdiff-size.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xdiff-file-bdiff-size.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xdiff-file-bdiff-size.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xdiff-file-bdiff-size.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xdiff-file-bdiff-size.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xdiff-file-bdiff-size.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: xdiff_file_bdiff_size - Manual" />
<meta name="twitter:description" content="Read a size of file created by applying a binary diff" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xdiff_file_bdiff_size - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xdiff-file-bpatch.php">
          xdiff_file_bpatch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xdiff-file-bdiff.php">
          &laquo; xdiff_file_bdiff        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xdiff-file-bdiff-size.php' selected="selected">English</option>
            <option value='de/function.xdiff-file-bdiff-size.php'>German</option>
            <option value='es/function.xdiff-file-bdiff-size.php'>Spanish</option>
            <option value='fr/function.xdiff-file-bdiff-size.php'>French</option>
            <option value='it/function.xdiff-file-bdiff-size.php'>Italian</option>
            <option value='ja/function.xdiff-file-bdiff-size.php'>Japanese</option>
            <option value='pt_BR/function.xdiff-file-bdiff-size.php'>Brazilian Portuguese</option>
            <option value='ru/function.xdiff-file-bdiff-size.php'>Russian</option>
            <option value='tr/function.xdiff-file-bdiff-size.php'>Turkish</option>
            <option value='uk/function.xdiff-file-bdiff-size.php'>Ukrainian</option>
            <option value='zh/function.xdiff-file-bdiff-size.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xdiff-file-bdiff-size" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.xdiff-file-bpatch.php" class="function" rel="rdfs-seeAlso">xdiff_file_bpatch()</a> - Patch a file with a binary diff</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xdiff/functions/xdiff-file-bdiff-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xdiff-file-bdiff-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xdiff-file-bdiff-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xdiff-file-bdiff-size.php">＋<small>add a note</small></a></span>
