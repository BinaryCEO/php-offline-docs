...
<head>
  ...
  <title>PHP: ImagickDraw::roundRectangle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.rotate.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.scale.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.roundrectangle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.roundrectangle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.roundrectangle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.roundrectangle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.roundrectangle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.roundrectangle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.roundrectangle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.roundrectangle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.roundrectangle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.roundrectangle.php" hreflang="zh">
...
<meta name="Description" content="Draws a rounded rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::roundRectangle - Manual" />
<meta name="twitter:description" content="Draws a rounded rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::roundRectangle - Manual" />
<meta itemprop="description" content="Draws a rounded rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a rounded rectangle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.scale.php">
          ImagickDraw::scale &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.rotate.php">
          &laquo; ImagickDraw::rotate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.roundrectangle.php' selected="selected">English</option>
            <option value='de/imagickdraw.roundrectangle.php'>German</option>
            <option value='es/imagickdraw.roundrectangle.php'>Spanish</option>
            <option value='fr/imagickdraw.roundrectangle.php'>French</option>
            <option value='it/imagickdraw.roundrectangle.php'>Italian</option>
            <option value='ja/imagickdraw.roundrectangle.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.roundrectangle.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.roundrectangle.php'>Russian</option>
            <option value='tr/imagickdraw.roundrectangle.php'>Turkish</option>
            <option value='uk/imagickdraw.roundrectangle.php'>Ukrainian</option>
            <option value='zh/imagickdraw.roundrectangle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.roundrectangle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::roundRectangle</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::roundRectangle</span> &mdash; <span class="dc-title">Draws a rounded rectangle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.roundrectangle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::roundRectangle</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$top_left_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$top_left_y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$bottom_right_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$bottom_right_y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$rounding_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$rounding_y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.roundrectangle-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">rounding_x</code></dt>
     <dd>
      <p class="para">
       x rounding
      </p>
     ...
     <dt><code class="parameter">rounding_y</code></dt>
     <dd>
      <p class="para">
       y rounding
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.roundrectangle-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3165">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/roundrectangle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.roundrectangle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.roundrectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.roundrectangle.php">＋<small>add a note</small></a></span>
