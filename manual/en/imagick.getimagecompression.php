...
<head>
  ...
  <title>PHP: Imagick::getImageCompression - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecompression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecompression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecompose.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecompressionquality.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecompression.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagecompression.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagecompression.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagecompression.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagecompression.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagecompression.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagecompression.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagecompression.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagecompression.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagecompression.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagecompression.php" hreflang="zh">
...
<meta name="Description" content="Gets the current image's compression type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageCompression - Manual" />
<meta name="twitter:description" content="Gets the current image's compression type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageCompression - Manual" />
<meta itemprop="description" content="Gets the current image's compression type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the current image's compression type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagecompressionquality.php">
          Imagick::getImageCompressionQuality &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagecompose.php">
          &laquo; Imagick::getImageCompose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecompression.php' selected="selected">English</option>
            <option value='de/imagick.getimagecompression.php'>German</option>
            <option value='es/imagick.getimagecompression.php'>Spanish</option>
            <option value='fr/imagick.getimagecompression.php'>French</option>
            <option value='it/imagick.getimagecompression.php'>Italian</option>
            <option value='ja/imagick.getimagecompression.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagecompression.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagecompression.php'>Russian</option>
            <option value='tr/imagick.getimagecompression.php'>Turkish</option>
            <option value='uk/imagick.getimagecompression.php'>Ukrainian</option>
            <option value='zh/imagick.getimagecompression.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagecompression" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageCompression</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::getImageCompression</span> &mdash; <span class="dc-title">Gets the current image&#039;s compression type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecompression-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageCompression</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagecompression-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagecompression-returnvalues">
  ...
  <p class="para">
   Returns the compression constant
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecompression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecompression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecompression.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125195">  <div class="votes">
    <div id="Vu125195">
    <a href="/manual/vote-note.php?id=125195&amp;page=imagick.getimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125195">
    <a href="/manual/vote-note.php?id=125195&amp;page=imagick.getimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125195" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125195" class="name">
  <strong class="user"><em>Mondragon</em></strong></a><a class="genanchor" href="#125195"> &para;</a><div class="date" title="2020-07-16 05:25"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125195">
<div class="phpcode"><code><span class="html">Example use:<br /><br />$im = new Imagick("mypicture.jpg");<br />$ctype = $im-&gt;getImageCompression();<br />if($ctype == Imagick::COMPRESSION_ZIP) echo "PNG file!";<br />if($ctype == Imagick::COMPRESSION_JPEG) echo "JPG file!";<br />if($ctype == Imagick::COMPRESSION_LZW) echo "GIF file!";<br /><br />All options:<br />COMPRESSION_UNDEFINED<br />COMPRESSION_NO<br />COMPRESSION_BZIP<br />COMPRESSION_FAX<br />COMPRESSION_GROUP4<br />COMPRESSION_JPEG<br />COMPRESSION_JPEG2000<br />COMPRESSION_LOSSLESSJPEG<br />COMPRESSION_LZW<br />COMPRESSION_RLE<br />COMPRESSION_ZIP<br />COMPRESSION_DXT1<br />COMPRESSION_DXT3<br />COMPRESSION_DXT5<br />COMPRESSION_ZIPS<br />COMPRESSION_PIZ<br />COMPRESSION_PXR24<br />COMPRESSION_B44<br />COMPRESSION_B44A<br />COMPRESSION_LZMA<br />COMPRESSION_JBIG1<br />COMPRESSION_JBIG2<br /><br />The numbers for which those constants stand differ by version. So always use the constants.</span></code></div>
  </div>
 </div>
  <div class="note" id="121781">  <div class="votes">
    <div id="Vu121781">
    <a href="/manual/vote-note.php?id=121781&amp;page=imagick.getimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121781">
    <a href="/manual/vote-note.php?id=121781&amp;page=imagick.getimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121781" title="50% like this...">
    0
    </div>
  </div>
  <a href="#121781" class="name">
  <strong class="user"><em>alitrix at gmail dot com</em></strong></a><a class="genanchor" href="#121781"> &para;</a><div class="date" title="2017-10-20 12:51"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121781">
<div class="phpcode"><code><span class="html">This function is added in version 3.3.0 and above</span></code></div>
  </div>
 </div>
  <div class="note" id="112603">  <div class="votes">
    <div id="Vu112603">
    <a href="/manual/vote-note.php?id=112603&amp;page=imagick.getimagecompression&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112603">
    <a href="/manual/vote-note.php?id=112603&amp;page=imagick.getimagecompression&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112603" title="43% like this...">
    -2
    </div>
  </div>
  <a href="#112603" class="name">
  <strong class="user"><em>undoable at gmail dot com</em></strong></a><a class="genanchor" href="#112603"> &para;</a><div class="date" title="2013-07-03 10:44"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112603">
<div class="phpcode"><code><span class="html">This function is undefined. You must use getImageCompressionQuality() instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagecompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecompression.php">＋<small>add a note</small></a></div>
