...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-window.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ui-size.setwidth.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-window.add.php">
...
<meta name="twitter:description" content="Window" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Window - Manual" />
<meta itemprop="description" content="Window" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-window.php' selected="selected">English</option>
            <option value='de/class.ui-window.php'>German</option>
            <option value='es/class.ui-window.php'>Spanish</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-window.add.php">UI\Window::add</a> — Add a Control</li><li><a href="ui-window.construct.php">UI\Window::__construct</a> — Construct a new Window</li><li><a href="ui-window.error.php">UI\Window::error</a> — Show Error Box</li><li><a href="ui-window.getsize.php">UI\Window::getSize</a> — Get Window Size</li><li><a href="ui-window.gettitle.php">UI\Window::getTitle</a> — Get Title</li><li><a href="ui-window.hasborders.php">UI\Window::hasBorders</a> — Border Detection</li><li><a href="ui-window.hasmargin.php">UI\Window::hasMargin</a> — Margin Detection</li><li><a href="ui-window.isfullscreen.php">UI\Window::isFullScreen</a> — Full Screen Detection</li><li><a href="ui-window.msg.php">UI\Window::msg</a> — Show Message Box</li><li><a href="ui-window.onclosing.php">UI\Window::onClosing</a> — Closing Callback</li><li><a href="ui-window.open.php">UI\Window::open</a> — Open Dialog</li><li><a href="ui-window.save.php">UI\Window::save</a> — Save Dialog</li><li><a href="ui-window.setborders.php">UI\Window::setBorders</a> — Border Use</li><li><a href="ui-window.setfullscreen.php">UI\Window::setFullScreen</a> — Full Screen Use</li><li><a href="ui-window.setmargin.php">UI\Window::setMargin</a> — Margin Use</li><li><a href="ui-window.setsize.php">UI\Window::setSize</a> — Set Size</li><li><a href="ui-window.settitle.php">UI\Window::setTitle</a> — Window Title</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.window.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-window%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-window&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-window.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This is a example to wizard layout in UI library:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">/*<br /> * Wizard sample layout builded with PHP UI<br /> */<br /><br /></span><span class="keyword">use </span><span class="default">UI\Window</span><span class="keyword">;<br />use </span><span class="default">UI\Size</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Button</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Grid</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Box</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Form</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Entry</span><span class="keyword">;<br />use </span><span class="default">UI\Controls\Label</span><span class="keyword">;<br /><br /></span><span class="comment">/*<br /> * The window<br /> */<br /></span><span class="default">$window </span><span class="keyword">= new </span><span class="default">Window</span><span class="keyword">(</span><span class="string">'Wizard Sample Layout'</span><span class="keyword">, new </span><span class="default">Size</span><span class="keyword">(</span><span class="default">640</span><span class="keyword">, </span><span class="default">480</span><span class="keyword">), </span><span class="default">TRUE</span><span class="keyword">);<br /></span><span class="default">$window</span><span class="keyword">-&gt;</span><span class="default">setMargin</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /> * Wizard content (sample)<br /> */<br /></span><span class="default">$content </span><span class="keyword">= new </span><span class="default">Form</span><span class="keyword">();<br /></span><span class="default">$content</span><span class="keyword">-&gt;</span><span class="default">setPadded</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">$content</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="string">'User:'</span><span class="keyword">, new </span><span class="default">Entry</span><span class="keyword">());<br /></span><span class="default">$content</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="string">'Password:'</span><span class="keyword">, new </span><span class="default">Entry</span><span class="keyword">(</span><span class="default">Entry</span><span class="keyword">::</span><span class="default">Password</span><span class="keyword">));<br /><br /></span><span class="comment">/*<br /> * Layout to title, content and buttons<br /> */<br /></span><span class="default">$grid </span><span class="keyword">= new </span><span class="default">Grid</span><span class="keyword">();<br /></span><span class="default">$grid</span><span class="keyword">-&gt;</span><span class="default">setPadded</span><span class="keyword">(</span><span class="default">false</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /> * Title<br /> */<br /></span><span class="default">$grid</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Label</span><span class="keyword">(</span><span class="string">'Wizard Sample'</span><span class="keyword">), </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">6</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /> * Append content<br /> */<br /></span><span class="default">$grid</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="default">$content</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">6</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /> * Left buttons<br /> */<br /></span><span class="default">$left_box </span><span class="keyword">= new </span><span class="default">Box</span><span class="keyword">(</span><span class="default">Box</span><span class="keyword">::</span><span class="default">Horizontal</span><span class="keyword">);<br /></span><span class="default">$left_box</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Button</span><span class="keyword">(</span><span class="string">'&amp;About'</span><span class="keyword">));<br /></span><span class="default">$left_box</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Button</span><span class="keyword">(</span><span class="string">'&amp;Help'</span><span class="keyword">));<br /><br /></span><span class="comment">/*<br /> * Right buttons<br /> */<br /></span><span class="default">$right_box </span><span class="keyword">= new </span><span class="default">Box</span><span class="keyword">(</span><span class="default">Box</span><span class="keyword">::</span><span class="default">Horizontal</span><span class="keyword">);<br /></span><span class="default">$right_box</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Button</span><span class="keyword">(</span><span class="string">'&amp;Back'</span><span class="keyword">));<br /></span><span class="default">$right_box</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Button</span><span class="keyword">(</span><span class="string">'&amp;Forward'</span><span class="keyword">));<br /></span><span class="default">$right_box</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(new </span><span class="default">Button</span><span class="keyword">(</span><span class="string">'&amp;Close'</span><span class="keyword">));<br /><br /></span><span class="comment">/**<br /> * Append buttons<br /> */<br /></span><span class="default">$grid</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="default">$left_box</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Start</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">);<br /></span><span class="default">$grid</span><span class="keyword">-&gt;</span><span class="default">append</span><span class="keyword">(</span><span class="default">$right_box</span><span class="keyword">, </span><span class="default">5</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">End</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">, </span><span class="default">Grid</span><span class="keyword">::</span><span class="default">Fill</span><span class="keyword">);<br /><br /></span><span class="comment">/*<br /> * Append layout and show.<br /> */<br /></span><span class="default">$window</span><span class="keyword">-&gt;</span><span class="default">add</span><span class="keyword">(</span><span class="default">$grid</span><span class="keyword">);<br /><br /></span><span class="default">$window</span><span class="keyword">-&gt;</span><span class="default">show</span><span class="keyword">();<br /><br /></span><span class="default">UI\run</span><span class="keyword">();<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.ui-window&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-window.php">＋<small>add a note</small></a></div>
