...
<head>
  ...
  <title>PHP: socket_last_error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-last-error.php">
 <link rel="shorturl" href="https://www.php.net/socket-last-error">
 <link rel="alternate" href="https://www.php.net/socket-last-error" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-import-stream.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-listen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-last-error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-last-error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-last-error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-last-error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-last-error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-last-error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-last-error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-last-error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-last-error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-last-error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-last-error.php" hreflang="zh">
...
<meta name="Description" content="Returns the last error on the socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_last_error - Manual" />
<meta name="twitter:description" content="Returns the last error on the socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_last_error - Manual" />
<meta itemprop="description" content="Returns the last error on the socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last error on the socket" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-listen.php">
          socket_listen &raquo;
              ...
              <div class="prev">
        <a href="function.socket-import-stream.php">
          &laquo; socket_import_stream        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-last-error.php' selected="selected">English</option>
            <option value='de/function.socket-last-error.php'>German</option>
            <option value='es/function.socket-last-error.php'>Spanish</option>
            <option value='fr/function.socket-last-error.php'>French</option>
            <option value='it/function.socket-last-error.php'>Italian</option>
            <option value='ja/function.socket-last-error.php'>Japanese</option>
            <option value='pt_BR/function.socket-last-error.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-last-error.php'>Russian</option>
            <option value='tr/function.socket-last-error.php'>Turkish</option>
            <option value='uk/function.socket-last-error.php'>Ukrainian</option>
            <option value='zh/function.socket-last-error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-last-error" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_last_error</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_last_error</span> &mdash; <span class="dc-title">Returns the last error on the socket</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.socket-last-error-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>socket_last_error</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.socket.php" class="type Socket">Socket</a></span></span> <code class="parameter">$socket</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   If a <span class="classname"><a href="class.socket.php" class="classname">Socket</a></span> instance is passed to this function, the last error which
   occurred on this particular socket is returned. If <code class="parameter">socket</code> is
   <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, the error code of the last failed socket function is returned.
   The latter is particularly helpful for functions like
   <span class="function"><a href="function.socket-create.php" class="function">socket_create()</a></span> which don&#039;t return a socket on
   failure and <span class="function"><a href="function.socket-select.php" class="function">socket_select()</a></span> which can fail for reasons
   not directly tied to a particular socket.  The error code is suitable to
   be fed to <span class="function"><a href="function.socket-strerror.php" class="function">socket_strerror()</a></span> which returns a string
   describing the given error code.
  </p>
  <p class="para">
   If no error had occurred, or the error had been cleared with
   <span class="function"><a href="function.socket-clear-error.php" class="function">socket_clear_error()</a></span>, the function returns <code class="literal">0</code>.
  </p>
 </div>
 ...
 <div class="refsect1 notes" id="refsect1-function.socket-last-error-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="function"><a href="function.socket-clear-error.php" class="function">socket_clear_error()</a></span> for this purpose.
   </p>
  </p></blockquote>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-last-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-last-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-last-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-last-error.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="95160">  <div class="votes">
    <div id="Vu95160">
    <a href="/manual/vote-note.php?id=95160&amp;page=function.socket-last-error&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95160">
    <a href="/manual/vote-note.php?id=95160&amp;page=function.socket-last-error&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95160" title="58% like this...">
    16
    </div>
  </div>
  <a href="#95160" class="name">
  <strong class="user"><em>ca at php dot spamtrak dot org</em></strong></a><a class="genanchor" href="#95160"> &para;</a><div class="date" title="2009-12-15 02:33"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95160">
<div class="phpcode"><code><span class="html">This is a bit long, but personally I prefer to use the standard C defines in my code.
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="123535">  <div class="votes">
    <div id="Vu123535">
    <a href="/manual/vote-note.php?id=123535&amp;page=function.socket-last-error&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123535">
    <a href="/manual/vote-note.php?id=123535&amp;page=function.socket-last-error&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123535" title="62% like this...">
    2
    </div>
  </div>
  <a href="#123535" class="name">
  <strong class="user"><em>divinity76 at gmail dot com</em></strong></a><a class="genanchor" href="#123535"> &para;</a><div class="date" title="2019-01-19 08:21"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123535">
<div class="phpcode"><code><span class="html">note that socket_last_error() cache the last error from the last socket syscall, it does not actually query the OS for the last error on the socket, so if an async socket have an error after the last async operation started successfully, socket_last_error() doesn't know about it, but  socket_get_option($sock, SOL_SOCKET, SO_ERROR) actually query the OS, or so it seems... observed on PHP 7.1.16 on Cygwin on win7 x64 SP1 with non-blocking sockets, socket_last_error() never caught on to the fact that the current error had changed from EINPROGRESS (non-blocking connect) to 0 (connection successful)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-last-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-last-error.php">＋<small>add a note</small></a></div>
