...
<head>
  ...
  <title>PHP: mb_str_pad - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-str-pad.php">
 <link rel="shorturl" href="https://www.php.net/mb-str-pad">
 <link rel="alternate" href="https://www.php.net/mb-str-pad" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-split.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-str-split.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-str-pad.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-str-pad.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-str-pad.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-str-pad.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-str-pad.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-str-pad.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-str-pad.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-str-pad.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-str-pad.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-str-pad.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-str-pad.php" hreflang="zh">
...
<meta name="Description" content="Pad a multibyte string to a certain length with another multibyte string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_str_pad - Manual" />
<meta name="twitter:description" content="Pad a multibyte string to a certain length with another multibyte string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_str_pad - Manual" />
<meta itemprop="description" content="Pad a multibyte string to a certain length with another multibyte string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Pad a multibyte string to a certain length with another multibyte string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-str-pad.php' selected="selected">English</option>
            <option value='de/function.mb-str-pad.php'>German</option>
            <option value='es/function.mb-str-pad.php'>Spanish</option>
            <option value='fr/function.mb-str-pad.php'>French</option>
            <option value='it/function.mb-str-pad.php'>Italian</option>
            <option value='ja/function.mb-str-pad.php'>Japanese</option>
            <option value='pt_BR/function.mb-str-pad.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-str-pad.php'>Russian</option>
            <option value='tr/function.mb-str-pad.php'>Turkish</option>
            <option value='uk/function.mb-str-pad.php'>Ukrainian</option>
            <option value='zh/function.mb-str-pad.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-str-pad" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_str_pad</h1>
  <p class="verinfo">(PHP 8 &gt;= PHP 8.3.0)</p><p class="refpurpose"><span class="refname">mb_str_pad</span> &mdash; <span class="dc-title">Pad a multibyte string to a certain length with another multibyte string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.mb-str-pad-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_str_pad</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pad_string</code><span class="initializer"> = &quot; &quot;</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pad_type</code><span class="initializer"> = <strong><code><a href="string.constants.php#constant.str-pad-right">STR_PAD_RIGHT</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   This function returns the <code class="parameter">string</code>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-str-pad-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       or <strong><code><a href="string.constants.php#constant.str-pad-both">STR_PAD_BOTH</a></code></strong>.
       By default <strong><code><a href="string.constants.php#constant.str-pad-right">STR_PAD_RIGHT</a></code></strong>.
      </p>
     </dd>
...
encoding value will be used.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-str-pad-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mb-str-pad-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2786">
    <p><strong>Example #1 <span class="function"><strong>mb_str_pad()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_str_pad</span><span style="color: #007700">(</span><span style="color: #DD0000">'▶▶'</span><span style="color: #007700">, </span><span style="color: #0000BB">6</span><span style="color: #007700">, </span><span style="color: #DD0000">'❤❓❇'</span><span style="color: #007700">, </span><span style="color: #0000BB">STR_PAD_RIGHT</span><span style="color: #007700">)); </span><span style="color: #FF8000">// string(18) "▶▶❤❓❇❤"<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_str_pad</span><span style="color: #007700">(</span><span style="color: #DD0000">'▶▶'</span><span style="color: #007700">, </span><span style="color: #0000BB">6</span><span style="color: #007700">, </span><span style="color: #DD0000">'❤❓❇'</span><span style="color: #007700">, </span><span style="color: #0000BB">STR_PAD_LEFT</span><span style="color: #007700">));  </span><span style="color: #FF8000">// string(18) "❤❓❇❤▶▶"<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_str_pad</span><span style="color: #007700">(</span><span style="color: #DD0000">'▶▶'</span><span style="color: #007700">, </span><span style="color: #0000BB">6</span><span style="color: #007700">, </span><span style="color: #DD0000">'❤❓❇'</span><span style="color: #007700">, </span><span style="color: #0000BB">STR_PAD_BOTH</span><span style="color: #007700">));  </span><span style="color: #FF8000">// string(18) "❤❓▶▶❤❓"<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">mb_str_pad</span><span style="color: #007700">(</span><span style="color: #DD0000">"🎉"</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">, </span><span style="color: #DD0000">"祝"</span><span style="color: #007700">, </span><span style="color: #0000BB">STR_PAD_LEFT</span><span style="color: #007700">));   </span><span style="color: #FF8000">// string(10) "祝祝🎉"<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-str-pad.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-str-pad%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-str-pad&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-str-pad.php">＋<small>add a note</small></a></span>
