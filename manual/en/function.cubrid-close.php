...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-close.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-client-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-data-seek.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-close.php' selected="selected">English</option>
            <option value='de/function.cubrid-close.php'>German</option>
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-connect-with-url.php" class="function" rel="rdfs-seeAlso">cubrid_connect_with_url()</a> - Establish the environment for connecting to CUBRID server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-close.php">＋<small>add a note</small></a></span>
