...
<head>
  ...
  <title>PHP: ps_begin_page - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-begin-page.php">
 <link rel="shorturl" href="https://www.php.net/ps-begin-page">
 <link rel="alternate" href="https://www.php.net/ps-begin-page" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-arcn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-begin-pattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-begin-page.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-begin-page.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-begin-page.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-begin-page.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-begin-page.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-begin-page.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-begin-page.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-begin-page.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-begin-page.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-begin-page.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-begin-page.php" hreflang="zh">
...
<meta name="Description" content="Start a new page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_begin_page - Manual" />
<meta name="twitter:description" content="Start a new page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_begin_page - Manual" />
<meta itemprop="description" content="Start a new page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Start a new page" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-begin-page.php' selected="selected">English</option>
            <option value='de/function.ps-begin-page.php'>German</option>
            <option value='es/function.ps-begin-page.php'>Spanish</option>
            <option value='fr/function.ps-begin-page.php'>French</option>
            <option value='it/function.ps-begin-page.php'>Italian</option>
            <option value='ja/function.ps-begin-page.php'>Japanese</option>
            <option value='pt_BR/function.ps-begin-page.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-begin-page.php'>Russian</option>
            <option value='tr/function.ps-begin-page.php'>Turkish</option>
            <option value='uk/function.ps-begin-page.php'>Ukrainian</option>
            <option value='zh/function.ps-begin-page.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-begin-page" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-set-info.php" class="function" rel="rdfs-seeAlso">ps_set_info()</a> - Sets information fields of document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-begin-page.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-begin-page%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-begin-page&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-begin-page.php">＋<small>add a note</small></a></span>
