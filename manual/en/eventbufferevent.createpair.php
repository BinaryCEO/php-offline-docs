...
<head>
  ...
  <title>PHP: EventBufferEvent::createPair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.createpair.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.createpair.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.createpair.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.disable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.createpair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventbufferevent.createpair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventbufferevent.createpair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventbufferevent.createpair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventbufferevent.createpair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventbufferevent.createpair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventbufferevent.createpair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventbufferevent.createpair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventbufferevent.createpair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventbufferevent.createpair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventbufferevent.createpair.php" hreflang="zh">
...
<meta name="Description" content="Creates two buffer events connected to each other" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventBufferEvent::createPair - Manual" />
<meta name="twitter:description" content="Creates two buffer events connected to each other" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventBufferEvent::createPair - Manual" />
<meta itemprop="description" content="Creates two buffer events connected to each other" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates two buffer events connected to each other" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="eventbufferevent.disable.php">
          EventBufferEvent::disable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventbufferevent.construct.php">
          &laquo; EventBufferEvent::__construct        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.createpair.php' selected="selected">English</option>
            <option value='de/eventbufferevent.createpair.php'>German</option>
            <option value='es/eventbufferevent.createpair.php'>Spanish</option>
            <option value='fr/eventbufferevent.createpair.php'>French</option>
            <option value='it/eventbufferevent.createpair.php'>Italian</option>
            <option value='ja/eventbufferevent.createpair.php'>Japanese</option>
            <option value='pt_BR/eventbufferevent.createpair.php'>Brazilian Portuguese</option>
            <option value='ru/eventbufferevent.createpair.php'>Russian</option>
            <option value='tr/eventbufferevent.createpair.php'>Turkish</option>
            <option value='uk/eventbufferevent.createpair.php'>Ukrainian</option>
            <option value='zh/eventbufferevent.createpair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventbufferevent.createpair" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">EventBufferEvent::createPair</h1>
  <p class="verinfo">(PECL event &gt;= 1.2.6-beta)</p><p class="refpurpose"><span class="refname">EventBufferEvent::createPair</span> &mdash; <span class="dc-title">Creates two buffer events connected to each other</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-eventbufferevent.createpair-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      <a href="" class="link">EventBufferEvent::OPT_* constants</a>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/createpair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.createpair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.createpair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.createpair.php">＋<small>add a note</small></a></span>
