...
<head>
  ...
  <title>PHP: ssh2_forward_listen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-forward-listen.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-forward-listen">
 <link rel="alternate" href="https://www.php.net/ssh2-forward-listen" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-forward-accept.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-methods-negotiated.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-forward-listen.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-forward-listen.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-forward-listen.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-forward-listen.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-forward-listen.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-forward-listen.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-forward-listen.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-forward-listen.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-forward-listen.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-forward-listen.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-forward-listen.php" hreflang="zh">
...
<meta name="Description" content="Bind a port on the remote server and listen for connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_forward_listen - Manual" />
<meta name="twitter:description" content="Bind a port on the remote server and listen for connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_forward_listen - Manual" />
<meta itemprop="description" content="Bind a port on the remote server and listen for connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Bind a port on the remote server and listen for connections" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ssh2-methods-negotiated.php">
          ssh2_methods_negotiated &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ssh2-forward-accept.php">
          &laquo; ssh2_forward_accept        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-forward-listen.php' selected="selected">English</option>
            <option value='de/function.ssh2-forward-listen.php'>German</option>
            <option value='es/function.ssh2-forward-listen.php'>Spanish</option>
            <option value='fr/function.ssh2-forward-listen.php'>French</option>
            <option value='it/function.ssh2-forward-listen.php'>Italian</option>
            <option value='ja/function.ssh2-forward-listen.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-forward-listen.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-forward-listen.php'>Russian</option>
            <option value='tr/function.ssh2-forward-listen.php'>Turkish</option>
            <option value='uk/function.ssh2-forward-listen.php'>Ukrainian</option>
            <option value='zh/function.ssh2-forward-listen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-forward-listen" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ssh2_forward_listen</h1>
  <p class="verinfo">(PECL ssh2 &gt;= 0.9.0)</p><p class="refpurpose"><span class="refname">ssh2_forward_listen</span> &mdash; <span class="dc-title">Bind a port on the remote server and listen for connections</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ssh2-forward-listen-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      An SSH Session resource, obtained from a call to <span class="function"><a href="function.ssh2-connect.php" class="function">ssh2_connect()</a></span>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ssh2-forward-listen-returnvalues">
  ...
  <p class="para">
   Returns an SSH2 Listener,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ssh2-forward-listen-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.ssh2-forward-accept.php" class="function" rel="rdfs-seeAlso">ssh2_forward_accept()</a> - Accept a connection created by a listener</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-forward-listen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-forward-listen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-forward-listen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-forward-listen.php">＋<small>add a note</small></a></span>
