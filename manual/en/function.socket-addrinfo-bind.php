...
<head>
  ...
  <title>PHP: socket_addrinfo_bind - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-addrinfo-bind.php">
 <link rel="shorturl" href="https://www.php.net/socket-addrinfo-bind">
 <link rel="alternate" href="https://www.php.net/socket-addrinfo-bind" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-accept.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-addrinfo-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-addrinfo-bind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-addrinfo-bind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-addrinfo-bind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-addrinfo-bind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-addrinfo-bind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-addrinfo-bind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-addrinfo-bind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-addrinfo-bind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-addrinfo-bind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-addrinfo-bind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-addrinfo-bind.php" hreflang="zh">
...
<meta name="Description" content="Create and bind to a socket from a given addrinfo" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_addrinfo_bind - Manual" />
<meta name="twitter:description" content="Create and bind to a socket from a given addrinfo" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_addrinfo_bind - Manual" />
<meta itemprop="description" content="Create and bind to a socket from a given addrinfo" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create and bind to a socket from a given addrinfo" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-addrinfo-connect.php">
          socket_addrinfo_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-accept.php">
          &laquo; socket_accept        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-addrinfo-bind.php' selected="selected">English</option>
            <option value='de/function.socket-addrinfo-bind.php'>German</option>
            <option value='es/function.socket-addrinfo-bind.php'>Spanish</option>
            <option value='fr/function.socket-addrinfo-bind.php'>French</option>
            <option value='it/function.socket-addrinfo-bind.php'>Italian</option>
            <option value='ja/function.socket-addrinfo-bind.php'>Japanese</option>
            <option value='pt_BR/function.socket-addrinfo-bind.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-addrinfo-bind.php'>Russian</option>
            <option value='tr/function.socket-addrinfo-bind.php'>Turkish</option>
            <option value='uk/function.socket-addrinfo-bind.php'>Ukrainian</option>
            <option value='zh/function.socket-addrinfo-bind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-addrinfo-bind" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-listen.php" class="function" rel="rdfs-seeAlso">socket_listen()</a> - Listens for a connection on a socket</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-addrinfo-bind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-addrinfo-bind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-addrinfo-bind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-addrinfo-bind.php">＋<small>add a note</small></a></span>
