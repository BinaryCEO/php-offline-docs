...
<head>
  ...
  <title>PHP: is_writeable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-writeable.php">
 <link rel="shorturl" href="https://www.php.net/is-writeable">
 <link rel="alternate" href="https://www.php.net/is-writeable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-writable.php">
 <link rel="next" href="https://www.php.net/manual/en/function.lchgrp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-writeable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-writeable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-writeable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-writeable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-writeable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-writeable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-writeable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-writeable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-writeable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-writeable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-writeable.php" hreflang="zh">
...
<meta name="Description" content="Alias of is_writable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_writeable - Manual" />
<meta name="twitter:description" content="Alias of is_writable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_writeable - Manual" />
<meta itemprop="description" content="Alias of is_writable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of is_writable" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-writeable.php' selected="selected">English</option>
            <option value='de/function.is-writeable.php'>German</option>
            <option value='es/function.is-writeable.php'>Spanish</option>
            <option value='fr/function.is-writeable.php'>French</option>
            <option value='it/function.is-writeable.php'>Italian</option>
            <option value='ja/function.is-writeable.php'>Japanese</option>
            <option value='pt_BR/function.is-writeable.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-writeable.php'>Russian</option>
            <option value='tr/function.is-writeable.php'>Turkish</option>
            <option value='uk/function.is-writeable.php'>Ukrainian</option>
            <option value='zh/function.is-writeable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-writeable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">is_writeable</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">is_writeable</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.is-writable.php" class="function">is_writable()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.is-writeable-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.is-writable.php" class="function">is_writable()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/is-writeable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-writeable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-writeable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-writeable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120313">  <div class="votes">
    <div id="Vu120313">
    <a href="/manual/vote-note.php?id=120313&amp;page=function.is-writeable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120313">
    <a href="/manual/vote-note.php?id=120313&amp;page=function.is-writeable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120313" title="66% like this...">
    26
    </div>
  </div>
  <a href="#120313" class="name">
  <strong class="user"><em>hsh at autowise dot dk</em></strong></a><a class="genanchor" href="#120313"> &para;</a><div class="date" title="2016-12-12 12:43"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120313">
<div class="phpcode"><code><span class="html">A tiny benefit of using is_writeable() instead of is_writable() is that is_writable() will pollute search results when searching source code for files containing the word "table".<br /><br />Writeable is an alternative and not as frequently used (but still absolutely correct) spelling of writable.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-writeable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-writeable.php">＋<small>add a note</small></a></div>
