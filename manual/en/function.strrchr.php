...
<head>
  ...
  <title>PHP: strrchr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.strrchr.php">
 <link rel="shorturl" href="https://www.php.net/strrchr">
 <link rel="alternate" href="https://www.php.net/strrchr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.strpos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.strrev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.strrchr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.strrchr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.strrchr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.strrchr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.strrchr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.strrchr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.strrchr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.strrchr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.strrchr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.strrchr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.strrchr.php" hreflang="zh">
...
<meta name="Description" content="Find the last occurrence of a character in a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: strrchr - Manual" />
<meta name="twitter:description" content="Find the last occurrence of a character in a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: strrchr - Manual" />
<meta itemprop="description" content="Find the last occurrence of a character in a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find the last occurrence of a character in a string" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.strrchr.php' selected="selected">English</option>
            <option value='de/function.strrchr.php'>German</option>
            <option value='es/function.strrchr.php'>Spanish</option>
            <option value='fr/function.strrchr.php'>French</option>
            <option value='it/function.strrchr.php'>Italian</option>
            <option value='ja/function.strrchr.php'>Japanese</option>
            <option value='pt_BR/function.strrchr.php'>Brazilian Portuguese</option>
            <option value='ru/function.strrchr.php'>Russian</option>
            <option value='tr/function.strrchr.php'>Turkish</option>
            <option value='uk/function.strrchr.php'>Ukrainian</option>
            <option value='zh/function.strrchr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.strrchr" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.strrchr-examples">
  ...
  <p class="para">
   <div class="example" id="example-5166">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strrpos.php" class="function" rel="rdfs-seeAlso">strrpos()</a> - Find the position of the last occurrence of a substring in a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/strrchr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.strrchr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.strrchr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.strrchr.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">8 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103191">  <div class="votes">
    <div id="Vu103191">
    <a href="/manual/vote-note.php?id=103191&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103191">
    <a href="/manual/vote-note.php?id=103191&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103191" title="75% like this...">
    31
    </div>
  </div>
  <a href="#103191" class="name">
  <strong class="user"><em>matthewkastor at live dot com</em></strong></a><a class="genanchor" href="#103191"> &para;</a><div class="date" title="2011-03-30 01:07"><strong>14 years ago</strong></div>
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="64157">  <div class="votes">
    <div id="Vu64157">
    <a href="/manual/vote-note.php?id=64157&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd64157">
    <a href="/manual/vote-note.php?id=64157&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V64157" title="73% like this...">
    12
    </div>
  </div>
  <a href="#64157" class="name">
  <strong class="user"><em>sekati at gmail dot com</em></strong></a><a class="genanchor" href="#64157"> &para;</a><div class="date" title="2006-04-08 05:43"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom64157">
<div class="phpcode"><code><span class="html">just a small addition to carlos dot lage at gmail dot com note which makes it a bit more useful and flexible:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// return everything up to last instance of needle<br />// use $trail to include needle chars including and past last needle <br /></span><span class="keyword">function </span><span class="default">reverse_strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">, </span><span class="default">$trail</span><span class="keyword">) {<br />    return </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) ? </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) + </span><span class="default">$trail</span><span class="keyword">) : </span><span class="default">false</span><span class="keyword">;<br />}<br /></span><span class="comment">// usage:<br /></span><span class="default">$ns </span><span class="keyword">= (</span><span class="default">reverse_strrchr</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">"SCRIPT_URI"</span><span class="keyword">], </span><span class="string">"/"</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">));<br /></span><span class="default">$ns2 </span><span class="keyword">= (</span><span class="default">reverse_strrchr</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">"SCRIPT_URI"</span><span class="keyword">], </span><span class="string">"/"</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">));<br />echo(</span><span class="default">$ns </span><span class="keyword">. </span><span class="string">"&lt;br&gt;" </span><span class="keyword">. </span><span class="default">$ns2</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="39957">  <div class="votes">
    <div id="Vu39957">
    <a href="/manual/vote-note.php?id=39957&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd39957">
    <a href="/manual/vote-note.php?id=39957&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V39957" title="62% like this...">
    6
    </div>
  </div>
  <a href="#39957" class="name">
  <strong class="user"><em>dchris1 at bigpond dot net dot au</em></strong></a><a class="genanchor" href="#39957"> &para;</a><div class="date" title="2004-02-16 07:16"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom39957">
<div class="phpcode"><code><span class="html">The function provided by marcokonopacki at hotmail dot com isn't really a reverse-version of strrchr(), rather a reverse version of strchr(). It returns everything from the start of $haystack up to the FIRST instance of the $needle. This is basically a reverse of the behavior which you expect from strchr(). A reverse version of strrchr() would return everything in $haystack up to the LAST instance of $needle, eg:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// reverse strrchr() - PHP v4.0b3 and above<br /></span><span class="keyword">function </span><span class="default">reverse_strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">)<br />{<br />    </span><span class="default">$pos </span><span class="keyword">= </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">);<br />    if(</span><span class="default">$pos </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {<br />        return </span><span class="default">$haystack</span><span class="keyword">;<br />    }<br />    return </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$pos </span><span class="keyword">+ </span><span class="default">1</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />Note that this function will need to be modified slightly to work with pre 4.0b3 versions of PHP due to the return type of strrpos() ('0' is not necessarily 'false'). Check the documentation on strrpos() for more info. <br /><br />A function like this can be useful for extracting the path to a script, for example:<br /><br />&lt;?<br />$string = "/path/to/the/file/filename.php";<br /><br />echo reverse_strrchr($string, '/'); // will echo "/path/to/the/file/"<br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="67296">  <div class="votes">
    <div id="Vu67296">
    <a href="/manual/vote-note.php?id=67296&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd67296">
    <a href="/manual/vote-note.php?id=67296&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V67296" title="60% like this...">
    6
    </div>
  </div>
  <a href="#67296" class="name">
  <strong class="user"><em>readless at gmx dot net</em></strong></a><a class="genanchor" href="#67296"> &para;</a><div class="date" title="2006-06-06 07:55"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom67296">
<div class="phpcode"><code><span class="html">to: repley at freemail dot it<br /><br />the code works very well, but as i was trying to cut script names (e.g.: $_SERVER["SCRIPT_NAME"] =&gt; /index.php, cut the string at "/" and return "index.php") it returned nothing (false). i've modified your code and now it works also if the needle is the first char.<br />- regards from germany<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">//strxchr(string haystack, string needle [, bool int leftinclusive [, bool int rightinclusive ]])<br /></span><span class="keyword">function </span><span class="default">strxchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">, </span><span class="default">$l_inclusive </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">, </span><span class="default">$r_inclusive </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">){<br />   if(</span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">)){<br />       </span><span class="comment">//Everything before last $needle in $haystack.<br />       </span><span class="default">$left </span><span class="keyword">=  </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) + </span><span class="default">$l_inclusive</span><span class="keyword">);<br /> <br />       </span><span class="comment">//Switch value of $r_inclusive from 0 to 1 and viceversa.<br />       </span><span class="default">$r_inclusive </span><span class="keyword">= (</span><span class="default">$r_inclusive </span><span class="keyword">== </span><span class="default">0</span><span class="keyword">) ? </span><span class="default">1 </span><span class="keyword">: </span><span class="default">0</span><span class="keyword">;<br /> <br />       </span><span class="comment">//Everything after last $needle in $haystack.<br />       </span><span class="default">$right </span><span class="keyword">=  </span><span class="default">substr</span><span class="keyword">(</span><span class="default">strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">), </span><span class="default">$r_inclusive</span><span class="keyword">);<br /> <br />       </span><span class="comment">//Return $left and $right into an array.<br />       </span><span class="keyword">return array(</span><span class="default">$left</span><span class="keyword">, </span><span class="default">$right</span><span class="keyword">);<br />   } else {<br />       if(</span><span class="default">strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">)) return array(</span><span class="string">''</span><span class="keyword">, </span><span class="default">substr</span><span class="keyword">(</span><span class="default">strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">), </span><span class="default">$r_inclusive</span><span class="keyword">));<br />       else return </span><span class="default">false</span><span class="keyword">;<br />   }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="60075">  <div class="votes">
    <div id="Vu60075">
    <a href="/manual/vote-note.php?id=60075&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd60075">
    <a href="/manual/vote-note.php?id=60075&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V60075" title="62% like this...">
    4
    </div>
  </div>
  <a href="#60075" class="name">
  <strong class="user"><em>freakinunreal at hotmail dot com</em></strong></a><a class="genanchor" href="#60075"> &para;</a><div class="date" title="2005-12-24 10:54"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60075">
<div class="phpcode"><code><span class="html">to marcokonopacki at hotmail dot com.<br /><br />I had to make a slight change in your function for it to return the complete needle inclusive.<br /><br />// Reverse search of strrchr.<br />function strrrchr($haystack,$needle)<br />{<br /><br />   // Returns everything before $needle (inclusive).<br />   //return substr($haystack,0,strpos($haystack,$needle)+1);<br />   // becomes<br />   return substr($haystack,0,strpos($haystack,$needle)+strlen($needle));<br />}<br /><br />Note: the +1 becomes +strlen($needle)<br /><br />Otherwise it only returns the first character in needle backwards.</span></code></div>
  </div>
 </div>
  <div class="note" id="55306">  <div class="votes">
    <div id="Vu55306">
    <a href="/manual/vote-note.php?id=55306&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55306">
    <a href="/manual/vote-note.php?id=55306&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55306" title="58% like this...">
    7
    </div>
  </div>
  <a href="#55306" class="name">
  <strong class="user"><em>Primo Anderson Do S?tio</em></strong></a><a class="genanchor" href="#55306"> &para;</a><div class="date" title="2005-07-29 10:24"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55306">
<div class="phpcode"><code><span class="html">$filename = 'strrchr_test.php';<br />print strrchr( $filename, '.' );<br /><br />Result:<br />.php<br /><br />$other_filename = 'strrchr_test.asp.php';<br />print  strrchr( $other_filename, '.' );<br /><br />Result:<br />.php</span></code></div>
  </div>
 </div>
  <div class="note" id="31232">  <div class="votes">
    <div id="Vu31232">
    <a href="/manual/vote-note.php?id=31232&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31232">
    <a href="/manual/vote-note.php?id=31232&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31232" title="50% like this...">
    0
    </div>
  </div>
  <a href="#31232" class="name">
  <strong class="user"><em>marcokonopacki at hotmail dot com</em></strong></a><a class="genanchor" href="#31232"> &para;</a><div class="date" title="2003-04-14 12:43"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31232">
<div class="phpcode"><code><span class="html">&lt;?<br /><br />// Reverse search of strrchr.<br />function strrrchr($haystack,$needle)<br />{<br /><br />    // Returns everything before $needle (inclusive).<br />    return substr($haystack,0,strpos($haystack,$needle)+1);<br />    <br />}<br /><br />$string = "FIELD NUMBER(9) NOT NULL";<br /><br />echo strrrchr($string,")"); // Will print FIELD (9)<br /><br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="51551">  <div class="votes">
    <div id="Vu51551">
    <a href="/manual/vote-note.php?id=51551&amp;page=function.strrchr&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51551">
    <a href="/manual/vote-note.php?id=51551&amp;page=function.strrchr&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51551" title="36% like this...">
    -5
    </div>
  </div>
  <a href="#51551" class="name">
  <strong class="user"><em>carlos dot lage at gmail dot com</em></strong></a><a class="genanchor" href="#51551"> &para;</a><div class="date" title="2005-04-03 11:45"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51551">
<div class="phpcode"><code><span class="html">I used dchris1 at bigpond dot net dot au 's reverse strrchr and reduced it to one line of code and fixed it's functionality - the real strrchr() returns FALSE if the needle is not found, not the haystack :)<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// reverse strrchr()<br /></span><span class="keyword">function </span><span class="default">reverse_strrchr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">)<br />{<br />                return </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) ? </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">strrpos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) +</span><span class="default">1 </span><span class="keyword">) : </span><span class="default">false</span><span class="keyword">;<br />} <br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.strrchr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.strrchr.php">＋<small>add a note</small></a></div>
