...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventhttprequest.sendreplystart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventhttprequest.sendreplystart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventhttprequest.sendreplystart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventhttprequest.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttprequest.sendreplyend.php">
 <link rel="next" href="https://www.php.net/manual/en/class.eventlistener.php">
...
<meta name="Description" content="Initiate a chunked reply" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventHttpRequest::sendReplyStart - Manual" />
<meta name="twitter:description" content="Initiate a chunked reply" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventHttpRequest::sendReplyStart - Manual" />
<meta itemprop="description" content="Initiate a chunked reply" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initiate a chunked reply" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventhttprequest.sendreplystart.php' selected="selected">English</option>
            ...
            <option value='fr/eventhttprequest.sendreplystart.php'>French</option>
   ...
   <li>
    <span class="methodname"><a href="eventhttprequest.sendreplyend.php" class="methodname" rel="rdfs-seeAlso">EventHttpRequest::sendReplyEnd()</a> - Complete a chunked reply, freeing the request as appropriate</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventhttprequest/sendreplystart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventhttprequest.sendreplystart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventhttprequest.sendreplystart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventhttprequest.sendreplystart.php">＋<small>add a note</small></a></span>
