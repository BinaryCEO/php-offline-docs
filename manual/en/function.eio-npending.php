...
<head>
  ...
  <title>PHP: eio_npending - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-npending.php">
 <link rel="shorturl" href="https://www.php.net/eio-npending">
 <link rel="alternate" href="https://www.php.net/eio-npending" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-nop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-nready.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-npending.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-npending.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-npending.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-npending.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-npending.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-npending.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-npending.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-npending.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-npending.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-npending.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-npending.php" hreflang="zh">
...
<meta name="Description" content="Returns number of finished, but unhandled requests" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_npending - Manual" />
<meta name="twitter:description" content="Returns number of finished, but unhandled requests" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_npending - Manual" />
<meta itemprop="description" content="Returns number of finished, but unhandled requests" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns number of finished, but unhandled requests" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-npending.php' selected="selected">English</option>
            <option value='de/function.eio-npending.php'>German</option>
            <option value='es/function.eio-npending.php'>Spanish</option>
            <option value='fr/function.eio-npending.php'>French</option>
            <option value='it/function.eio-npending.php'>Italian</option>
            <option value='ja/function.eio-npending.php'>Japanese</option>
            <option value='pt_BR/function.eio-npending.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-npending.php'>Russian</option>
            <option value='tr/function.eio-npending.php'>Turkish</option>
            <option value='uk/function.eio-npending.php'>Ukrainian</option>
            <option value='zh/function.eio-npending.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-npending" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_npending</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_npending</span> &mdash; <span class="dc-title">Returns number of finished, but unhandled requests</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-npending-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_npending</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_npending()</strong></span> returns number of finished, but unhandled requests
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-npending-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.eio-npending-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_npending()</strong></span> returns number of finished, but unhandled
   requests.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-npending-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-nthreads.php" class="function" rel="rdfs-seeAlso">eio_nthreads()</a> - Returns number of threads currently in use</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-npending.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-npending%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-npending&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-npending.php">＋<small>add a note</small></a></span>
