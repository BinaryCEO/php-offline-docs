...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeLineJoin - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokelinejoin.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokelinejoin.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokelinejoin.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokelinejoin.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokelinejoin.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokelinejoin.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokelinejoin.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokelinejoin.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokelinejoin.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokelinejoin.php" hreflang="zh">
...
<meta name="Description" content="Specifies the shape to be used at the corners of paths when they are stroked" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeLineJoin - Manual" />
<meta name="twitter:description" content="Specifies the shape to be used at the corners of paths when they are stroked" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeLineJoin - Manual" />
<meta itemprop="description" content="Specifies the shape to be used at the corners of paths when they are stroked" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the shape to be used at the corners of paths when they are stroked" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setstrokemiterlimit.php">
          ImagickDraw::setStrokeMiterLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokelinecap.php">
          &laquo; ImagickDraw::setStrokeLineCap        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokelinejoin.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokelinejoin.php'>German</option>
            <option value='es/imagickdraw.setstrokelinejoin.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokelinejoin.php'>French</option>
            <option value='it/imagickdraw.setstrokelinejoin.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokelinejoin.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokelinejoin.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokelinejoin.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokelinejoin.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokelinejoin.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokelinejoin.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokelinejoin" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeLineJoin</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeLineJoin</span> &mdash; <span class="dc-title">Specifies the shape to be used at the corners of paths when they are stroked</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokelinejoin-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeLineJoin</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$linejoin</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokelinejoin-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">linejoin</code></dt>
     <dd>
      <p class="para">
       One of the <a href="imagick.constants.php#imagick.constants.linejoin" class="link">LINEJOIN</a> constant
       (<code class="literal">imagick::LINEJOIN_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokelinejoin-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3187">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokelinejoin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokelinejoin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokelinejoin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="90947">  <div class="votes">
    <div id="Vu90947">
    <a href="/manual/vote-note.php?id=90947&amp;page=imagickdraw.setstrokelinejoin&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90947">
    <a href="/manual/vote-note.php?id=90947&amp;page=imagickdraw.setstrokelinejoin&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90947" title="100% like this...">
    1
    </div>
  </div>
  <a href="#90947" class="name">
  <strong class="user"><em>Rex Schrader</em></strong></a><a class="genanchor" href="#90947"> &para;</a><div class="date" title="2009-05-17 08:36"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90947">
<div class="phpcode"><code><span class="html">From imagick_helpers.c (pecl release), possible values are:<br />  LINEJOIN_UNDEFINED<br />  LINEJOIN_MITER<br />  LINEJOIN_ROUND<br />  LINEJOIN_BEVEL</span></code></div>
  </div>
 </div>
  <div class="note" id="94197">  <div class="votes">
    <div id="Vu94197">
    <a href="/manual/vote-note.php?id=94197&amp;page=imagickdraw.setstrokelinejoin&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94197">
    <a href="/manual/vote-note.php?id=94197&amp;page=imagickdraw.setstrokelinejoin&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94197" title="no votes...">
    0
    </div>
  </div>
  <a href="#94197" class="name">
  <strong class="user"><em>sudopeople gmail</em></strong></a><a class="genanchor" href="#94197"> &para;</a><div class="date" title="2009-10-21 03:32"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94197">
<div class="phpcode"><code><span class="html">For many (myself included) Rex's note maybe not be blatant enough. The constants are declared for the Imagick class only, so using them requires this syntax: Imagick::LINEJOIN_ constant
<br />
<br />Here's an example oh how you might use it:
<br />
<br /><span class="default">&lt;?php
<br />$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">));
<br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeLineJoin</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">LINEJOIN_ROUND</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />If you're not drawing polylines and are drawing simple lines, also see setStrokeLineCap</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setstrokelinejoin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">＋<small>add a note</small></a></div>
