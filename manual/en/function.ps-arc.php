...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-arc.php">
 <link rel="shorturl" href="https://www.php.net/ps-arc">
 <link rel="alternate" href="https://www.php.net/ps-arc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-add-weblink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-arcn.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-arc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-arc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-arc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-arc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-arc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-arc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-arc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-arc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-arc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-arc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-arc.php" hreflang="zh">
...
<meta name="Description" content="Draws an arc counterclockwise" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_arc - Manual" />
<meta name="twitter:description" content="Draws an arc counterclockwise" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_arc - Manual" />
<meta itemprop="description" content="Draws an arc counterclockwise" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws an arc counterclockwise" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-arcn.php">
          ps_arcn &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-add-weblink.php">
          &laquo; ps_add_weblink        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-arc.php' selected="selected">English</option>
            <option value='de/function.ps-arc.php'>German</option>
            <option value='es/function.ps-arc.php'>Spanish</option>
            <option value='fr/function.ps-arc.php'>French</option>
            <option value='it/function.ps-arc.php'>Italian</option>
            <option value='ja/function.ps-arc.php'>Japanese</option>
            <option value='pt_BR/function.ps-arc.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-arc.php'>Russian</option>
            <option value='tr/function.ps-arc.php'>Turkish</option>
            <option value='uk/function.ps-arc.php'>Ukrainian</option>
            <option value='zh/function.ps-arc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-arc" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_arc</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_arc</span> &mdash; <span class="dc-title">Draws an arc counterclockwise</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-arc-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_arc</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$alpha</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$beta</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   <code class="parameter">beta</code>. It is drawn counterclockwise (use
   <span class="function"><a href="function.ps-arcn.php" class="function">ps_arcn()</a></span> to draw clockwise). The subpath added
   to the current path starts on the arc at angle <code class="parameter">alpha</code>
   and ends on the arc at angle <code class="parameter">beta</code>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-arc-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-arc-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-arc-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-arcn.php" class="function" rel="rdfs-seeAlso">ps_arcn()</a> - Draws an arc clockwise</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-arc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-arc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-arc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-arc.php">＋<small>add a note</small></a></span>
