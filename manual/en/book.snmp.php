...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.snmp.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.scoutapm-list-instrumented-functions.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.snmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.snmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.snmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.snmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.snmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.snmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.snmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.snmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.snmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.snmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.snmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.snmp.php" hreflang="zh">
...
<meta itemprop="description" content="SNMP" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.snmp.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.scoutapm-list-instrumented-functions.php">
          &laquo; scoutapm_list_instrumented_functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.snmp.php' selected="selected">English</option>
            <option value='de/book.snmp.php'>German</option>
            <option value='es/book.snmp.php'>Spanish</option>
            <option value='fr/book.snmp.php'>French</option>
            <option value='it/book.snmp.php'>Italian</option>
            <option value='ja/book.snmp.php'>Japanese</option>
            <option value='pt_BR/book.snmp.php'>Brazilian Portuguese</option>
            <option value='ru/book.snmp.php'>Russian</option>
            <option value='tr/book.snmp.php'>Turkish</option>
            <option value='uk/book.snmp.php'>Ukrainian</option>
            <option value='zh/book.snmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.snmp" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.snmp.php">Introduction</a></li><li><a href="snmp.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="snmp.requirements.php">Requirements</a></li><li><a href="snmp.installation.php">Installation</a></li></ul></li><li><a href="snmp.constants.php">Predefined Constants</a></li><li><a href="ref.snmp.php">SNMP Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.snmp-get-quick-print.php">snmp_get_quick_print</a> — Fetches the current value of the NET-SNMP library's quick_print setting</li><li><a href="function.snmp-get-valueretrieval.php">snmp_get_valueretrieval</a> — Return the method how the SNMP values will be returned</li><li><a href="function.snmp-read-mib.php">snmp_read_mib</a> — Reads and parses a MIB file into the active MIB tree</li><li><a href="function.snmp-set-enum-print.php">snmp_set_enum_print</a> — Return all values that are enums with their enum value instead of the raw integer</li><li><a href="function.snmp-set-oid-numeric-print.php">snmp_set_oid_numeric_print</a> — Alias of snmp_set_oid_output_format</li><li><a href="function.snmp-set-oid-output-format.php">snmp_set_oid_output_format</a> — Set the OID output format</li><li><a href="function.snmp-set-quick-print.php">snmp_set_quick_print</a> — Set the value of enable within the NET-SNMP library</li><li><a href="function.snmp-set-valueretrieval.php">snmp_set_valueretrieval</a> — Specify the method how the SNMP values will be returned</li><li><a href="function.snmp2-get.php">snmp2_get</a> — Fetch an SNMP object</li><li><a href="function.snmp2-getnext.php">snmp2_getnext</a> — Fetch the SNMP object which follows the given object id</li><li><a href="function.snmp2-real-walk.php">snmp2_real_walk</a> — Return all objects including their respective object ID within the specified one</li><li><a href="function.snmp2-set.php">snmp2_set</a> — Set the value of an SNMP object</li><li><a href="function.snmp2-walk.php">snmp2_walk</a> — Fetch all the SNMP objects from an agent</li><li><a href="function.snmp3-get.php">snmp3_get</a> — Fetch an SNMP object</li><li><a href="function.snmp3-getnext.php">snmp3_getnext</a> — Fetch the SNMP object which follows the given object id</li><li><a href="function.snmp3-real-walk.php">snmp3_real_walk</a> — Return all objects including their respective object ID within the specified one</li><li><a href="function.snmp3-set.php">snmp3_set</a> — Set the value of an SNMP object</li><li><a href="function.snmp3-walk.php">snmp3_walk</a> — Fetch all the SNMP objects from an agent</li><li><a href="function.snmpget.php">snmpget</a> — Fetch an SNMP object</li><li><a href="function.snmpgetnext.php">snmpgetnext</a> — Fetch the SNMP object which follows the given object id</li><li><a href="function.snmprealwalk.php">snmprealwalk</a> — Return all objects including their respective object ID within the specified one</li><li><a href="function.snmpset.php">snmpset</a> — Set the value of an SNMP object</li><li><a href="function.snmpwalk.php">snmpwalk</a> — Fetch all the SNMP objects from an agent</li><li><a href="function.snmpwalkoid.php">snmpwalkoid</a> — Query for a tree of information about a network entity</li></ul></li><li><a href="class.snmp.php">SNMP</a> — The SNMP class<ul class="chunklist chunklist_book chunklist_children"><li><a href="snmp.close.php">SNMP::close</a> — Close SNMP session</li><li><a href="snmp.construct.php">SNMP::__construct</a> — Creates SNMP instance representing session to remote SNMP agent</li><li><a href="snmp.get.php">SNMP::get</a> — Fetch an SNMP object</li><li><a href="snmp.geterrno.php">SNMP::getErrno</a> — Get last error code</li><li><a href="snmp.geterror.php">SNMP::getError</a> — Get last error message</li><li><a href="snmp.getnext.php">SNMP::getnext</a> — Fetch an SNMP object which
  follows the given object id</li><li><a href="snmp.set.php">SNMP::set</a> — Set the value of an SNMP object</li><li><a href="snmp.setsecurity.php">SNMP::setSecurity</a> — Configures security-related SNMPv3 session parameters</li><li><a href="snmp.walk.php">SNMP::walk</a> — Fetch SNMP object subtree</li></ul></li><li><a href="class.snmpexception.php">SNMPException</a> — The SNMPException class</li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.snmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.snmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.snmp.php">＋<small>add a note</small></a></span>
