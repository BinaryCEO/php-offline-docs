...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.dbase.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-send-glo.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.dbase.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.dbase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.dbase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.dbase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.dbase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.dbase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.dbase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.dbase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.dbase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.dbase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.dbase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.dbase.php" hreflang="zh">
...
<meta name="Description" content="dBase" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dBase - Manual" />
<meta name="twitter:description" content="dBase" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dBase - Manual" />
<meta itemprop="description" content="dBase" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="dBase" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.dbase.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-send-glo.php">
          &laquo; cubrid_send_glo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.dbase.php' selected="selected">English</option>
            <option value='de/book.dbase.php'>German</option>
            <option value='es/book.dbase.php'>Spanish</option>
            <option value='fr/book.dbase.php'>French</option>
            <option value='it/book.dbase.php'>Italian</option>
            <option value='ja/book.dbase.php'>Japanese</option>
            <option value='pt_BR/book.dbase.php'>Brazilian Portuguese</option>
            <option value='ru/book.dbase.php'>Russian</option>
            <option value='tr/book.dbase.php'>Turkish</option>
            <option value='uk/book.dbase.php'>Ukrainian</option>
            <option value='zh/book.dbase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.dbase" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.dbase.php">Introduction</a></li><li><a href="dbase.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="dbase.installation.php">Installation</a></li><li><a href="dbase.resources.php">Resource Types</a></li></ul></li><li><a href="dbase.constants.php">Predefined Constants</a></li><li><a href="ref.dbase.php">dBase Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.dbase-add-record.php">dbase_add_record</a> — Adds a record to a database</li><li><a href="function.dbase-close.php">dbase_close</a> — Closes a database</li><li><a href="function.dbase-create.php">dbase_create</a> — Creates a database</li><li><a href="function.dbase-delete-record.php">dbase_delete_record</a> — Deletes a record from a database</li><li><a href="function.dbase-get-header-info.php">dbase_get_header_info</a> — Gets the header info of a database</li><li><a href="function.dbase-get-record.php">dbase_get_record</a> — Gets a record from a database as an indexed array</li><li><a href="function.dbase-get-record-with-names.php">dbase_get_record_with_names</a> — Gets a record from a database as an associative array</li><li><a href="function.dbase-numfields.php">dbase_numfields</a> — Gets the number of fields of a database</li><li><a href="function.dbase-numrecords.php">dbase_numrecords</a> — Gets the number of records in a database</li><li><a href="function.dbase-open.php">dbase_open</a> — Opens a database</li><li><a href="function.dbase-pack.php">dbase_pack</a> — Packs a database</li><li><a href="function.dbase-replace-record.php">dbase_replace_record</a> — Replaces a record in a database</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.dbase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.dbase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.dbase.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92631">  <div class="votes">
    <div id="Vu92631">
    <a href="/manual/vote-note.php?id=92631&amp;page=book.dbase&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92631">
    <a href="/manual/vote-note.php?id=92631&amp;page=book.dbase&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92631" title="56% like this...">
    23
    </div>
  </div>
  <a href="#92631" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#92631"> &para;</a><div class="date" title="2009-07-31 09:51"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92631">
<div class="phpcode"><code><span class="html">Unfortunately the dbase functions are not compiled into my commercial server's php and I needed to read some geo data in shape files, which include data in dbfs.
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=book.dbase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.dbase.php">＋<small>add a note</small></a></div>
