...
<head>
  ...
  <title>PHP: Memcached::isPersistent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.ispersistent.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.ispersistent.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.ispersistent.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.incrementbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.ispristine.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.ispersistent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.ispersistent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.ispersistent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.ispersistent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.ispersistent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.ispersistent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.ispersistent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.ispersistent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.ispersistent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.ispersistent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.ispersistent.php" hreflang="zh">
...
<meta name="Description" content="Check if a persitent connection to memcache is being used" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::isPersistent - Manual" />
<meta name="twitter:description" content="Check if a persitent connection to memcache is being used" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::isPersistent - Manual" />
<meta itemprop="description" content="Check if a persitent connection to memcache is being used" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if a persitent connection to memcache is being used" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.ispristine.php">
          Memcached::isPristine &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.incrementbykey.php">
          &laquo; Memcached::incrementByKey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.ispersistent.php' selected="selected">English</option>
            <option value='de/memcached.ispersistent.php'>German</option>
            <option value='es/memcached.ispersistent.php'>Spanish</option>
            <option value='fr/memcached.ispersistent.php'>French</option>
            <option value='it/memcached.ispersistent.php'>Italian</option>
            <option value='ja/memcached.ispersistent.php'>Japanese</option>
            <option value='pt_BR/memcached.ispersistent.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.ispersistent.php'>Russian</option>
            <option value='tr/memcached.ispersistent.php'>Turkish</option>
            <option value='uk/memcached.ispersistent.php'>Ukrainian</option>
            <option value='zh/memcached.ispersistent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.ispersistent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::isPersistent</h1>
  <p class="verinfo">(PECL memcached &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Memcached::isPersistent</span> &mdash; <span class="dc-title">Check if a persitent connection to memcache is being used</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.ispersistent-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::isPersistent()</strong></span> checks if the connections to
   the memcache servers are persistent connections.
  </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.ispersistent-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if Memcache instance uses a persistent connection, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.ispersistent-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.ispristine.php" class="methodname" rel="rdfs-seeAlso">Memcached::isPristine()</a> - Check if the instance was recently created</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/ispersistent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.ispersistent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.ispersistent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.ispersistent.php">＋<small>add a note</small></a></span>
