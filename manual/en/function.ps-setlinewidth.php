...
<head>
  ...
  <title>PHP: ps_setlinewidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setlinewidth.php">
 <link rel="shorturl" href="https://www.php.net/ps-setlinewidth">
 <link rel="alternate" href="https://www.php.net/ps-setlinewidth" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setlinejoin.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setmiterlimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setlinewidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setlinewidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setlinewidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setlinewidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setlinewidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setlinewidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setlinewidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setlinewidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setlinewidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setlinewidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setlinewidth.php" hreflang="zh">
...
<meta name="Description" content="Sets width of a line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setlinewidth - Manual" />
<meta name="twitter:description" content="Sets width of a line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setlinewidth - Manual" />
<meta itemprop="description" content="Sets width of a line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets width of a line" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-setmiterlimit.php">
          ps_setmiterlimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-setlinejoin.php">
          &laquo; ps_setlinejoin        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setlinewidth.php' selected="selected">English</option>
            <option value='de/function.ps-setlinewidth.php'>German</option>
            <option value='es/function.ps-setlinewidth.php'>Spanish</option>
            <option value='fr/function.ps-setlinewidth.php'>French</option>
            <option value='it/function.ps-setlinewidth.php'>Italian</option>
            <option value='ja/function.ps-setlinewidth.php'>Japanese</option>
            <option value='pt_BR/function.ps-setlinewidth.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setlinewidth.php'>Russian</option>
            <option value='tr/function.ps-setlinewidth.php'>Turkish</option>
            <option value='uk/function.ps-setlinewidth.php'>Ukrainian</option>
            <option value='zh/function.ps-setlinewidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setlinewidth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setlinewidth</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setlinewidth</span> &mdash; <span class="dc-title">Sets width of a line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setlinewidth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setlinewidth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setlinewidth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setlinewidth-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setlinewidth-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setmiterlimit.php" class="function" rel="rdfs-seeAlso">ps_setmiterlimit()</a> - Sets the miter limit</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setlinewidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setlinewidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setlinewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setlinewidth.php">＋<small>add a note</small></a></span>
