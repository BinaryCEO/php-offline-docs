...
<head>
  ...
  <title>PHP: stream_set_blocking - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-set-blocking.php">
 <link rel="shorturl" href="https://www.php.net/stream-set-blocking">
 <link rel="alternate" href="https://www.php.net/stream-set-blocking" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-select.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-set-chunk-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-set-blocking.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-set-blocking.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-set-blocking.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-set-blocking.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-set-blocking.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-set-blocking.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-set-blocking.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-set-blocking.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-set-blocking.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-set-blocking.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-set-blocking.php" hreflang="zh">
...
<meta name="Description" content="Set blocking/non-blocking mode on a stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_set_blocking - Manual" />
<meta name="twitter:description" content="Set blocking/non-blocking mode on a stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_set_blocking - Manual" />
<meta itemprop="description" content="Set blocking/non-blocking mode on a stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set blocking/non-blocking mode on a stream" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stream-set-chunk-size.php">
          stream_set_chunk_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-select.php">
          &laquo; stream_select        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-set-blocking.php' selected="selected">English</option>
            <option value='de/function.stream-set-blocking.php'>German</option>
            <option value='es/function.stream-set-blocking.php'>Spanish</option>
            <option value='fr/function.stream-set-blocking.php'>French</option>
            <option value='it/function.stream-set-blocking.php'>Italian</option>
            <option value='ja/function.stream-set-blocking.php'>Japanese</option>
            <option value='pt_BR/function.stream-set-blocking.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-set-blocking.php'>Russian</option>
            <option value='tr/function.stream-set-blocking.php'>Turkish</option>
            <option value='uk/function.stream-set-blocking.php'>Ukrainian</option>
            <option value='zh/function.stream-set-blocking.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-set-blocking" class="refentry">
  ...
  <ul class="simplelist">
   ...
   arrays of streams with a timeout specified by seconds and microseconds</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-set-blocking.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-set-blocking%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-set-blocking&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-set-blocking.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110997">  <div class="votes">
    <div id="Vu110997">
    <a href="/manual/vote-note.php?id=110997&amp;page=function.stream-set-blocking&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110997">
    <a href="/manual/vote-note.php?id=110997&amp;page=function.stream-set-blocking&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110997" title="71% like this...">
    33
    </div>
  </div>
  <a href="#110997" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#110997"> &para;</a><div class="date" title="2013-01-04 07:38"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110997">
<div class="phpcode"><code><span class="html">On Windows this function does not work with pipes opened with proc_open (<a href="https://bugs.php.net/bug.php?id=47918," rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=47918,</a> <a href="https://bugs.php.net/bug.php?id=34972," rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=34972,</a> <a href="https://bugs.php.net/bug.php?id=51800" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=51800</a>)</span></code></div>
  </div>
 </div>
  <div class="note" id="69505">  <div class="votes">
    <div id="Vu69505">
    <a href="/manual/vote-note.php?id=69505&amp;page=function.stream-set-blocking&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd69505">
    <a href="/manual/vote-note.php?id=69505&amp;page=function.stream-set-blocking&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V69505" title="62% like this...">
    14
    </div>
  </div>
  <a href="#69505" class="name">
  <strong class="user"><em>MagicalTux at ookoo dot org</em></strong></a><a class="genanchor" href="#69505"> &para;</a><div class="date" title="2006-09-07 11:13"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom69505">
<div class="phpcode"><code><span class="html">When you use fwrite() on a non-blocking stream, data isn't discarded silently as t dot starling said.<br /><br />Remember that fwrite() returns an int, and this int represents the amount of data really written to the stream. So, if you see that fwrite() returns less than the amount of written data, it means you'll have to call fwrite() again in the future to write the remaining amount of data.<br /><br />You can use stream_select() to wait for the stream to be available for writing, then continue writing data to the stream.<br /><br />Non-blocking streams are useful as you can have more than one non-blocking stream, and wait for them to be available for writing.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-set-blocking&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-set-blocking.php">＋<small>add a note</small></a></div>
