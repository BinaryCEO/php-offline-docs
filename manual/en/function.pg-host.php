...
<head>
  ...
  <title>PHP: pg_host - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-host.php">
 <link rel="shorturl" href="https://www.php.net/pg-host">
 <link rel="alternate" href="https://www.php.net/pg-host" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-get-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-insert.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-host.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-host.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-host.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-host.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-host.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-host.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-host.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-host.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-host.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-host.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-host.php" hreflang="zh">
...
<meta name="Description" content="Returns the host name associated with the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_host - Manual" />
<meta name="twitter:description" content="Returns the host name associated with the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_host - Manual" />
<meta itemprop="description" content="Returns the host name associated with the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the host name associated with the connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-host.php' selected="selected">English</option>
            <option value='de/function.pg-host.php'>German</option>
            <option value='es/function.pg-host.php'>Spanish</option>
            <option value='fr/function.pg-host.php'>French</option>
            <option value='it/function.pg-host.php'>Italian</option>
            <option value='ja/function.pg-host.php'>Japanese</option>
            <option value='pt_BR/function.pg-host.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-host.php'>Russian</option>
            <option value='tr/function.pg-host.php'>Turkish</option>
            <option value='uk/function.pg-host.php'>Ukrainian</option>
            <option value='zh/function.pg-host.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-host" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_host</h1> 
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_host</span> &mdash; <span class="dc-title">
   Returns the host name associated with the connection
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-host-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_host</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_host()</strong></span> returns the host name of the given
   PostgreSQL <code class="parameter">connection</code> instance is
   connected to.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-host-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-host-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the name of the host the
   <code class="parameter">connection</code> is to, or an empty string on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-host-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pgsql_conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=mark host=localhost"</span><span style="color: #007700">);<br /><br />if (</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) {<br />   print </span><span style="color: #DD0000">"Successfully connected to: " </span><span style="color: #007700">. </span><span style="color: #0000BB">pg_host</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">) . </span><span style="color: #DD0000">"&lt;br/&gt;\n"</span><span style="color: #007700">;<br />} else {<br />   print </span><span style="color: #0000BB">pg_last_error</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br />   exit;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-host-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-pconnect.php" class="function" rel="rdfs-seeAlso">pg_pconnect()</a> - Open a persistent PostgreSQL connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-host.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-host%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-host&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-host.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="30626">  <div class="votes">
    <div id="Vu30626">
    <a href="/manual/vote-note.php?id=30626&amp;page=function.pg-host&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30626">
    <a href="/manual/vote-note.php?id=30626&amp;page=function.pg-host&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30626" title="no votes...">
    0
    </div>
  </div>
  <a href="#30626" class="name">
  <strong class="user"><em>mark at redbrick dot dcu dot ie</em></strong></a><a class="genanchor" href="#30626"> &para;</a><div class="date" title="2003-03-24 06:21"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30626">
<div class="phpcode"><code><span class="html">This is a simple example of this function, which returns the name of which PostreSQL Database you are currently connected to.<br /><br /><span class="default">&lt;?php<br />    $pgsql_conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"dbname=mark host=localhost"</span><span class="keyword">);<br /><br />    if (</span><span class="default">$pgsql_conn</span><span class="keyword">) {<br />        print </span><span class="string">"Successfully connected to: " </span><span class="keyword">. </span><span class="default">pg_host</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">) . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />    } else {<br />        print </span><span class="default">pg_last_error</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">);<br />        exit;<br />    }<br /></span><span class="default">?&gt;<br /></span><br />This function is extremely useful for sites which connect to multiple Postgresql services.<br /><br />Regards,  --mark</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-host&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-host.php">＋<small>add a note</small></a></div>
