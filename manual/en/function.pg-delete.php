...
<head>
  ...
  <title>PHP: pg_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-delete.php">
 <link rel="shorturl" href="https://www.php.net/pg-delete">
 <link rel="alternate" href="https://www.php.net/pg-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-dbname.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-end-copy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-delete.php" hreflang="zh">
...
<meta name="Description" content="Deletes records" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_delete - Manual" />
<meta name="twitter:description" content="Deletes records" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_delete - Manual" />
<meta itemprop="description" content="Deletes records" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes records" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-delete.php' selected="selected">English</option>
            <option value='de/function.pg-delete.php'>German</option>
            <option value='es/function.pg-delete.php'>Spanish</option>
            <option value='fr/function.pg-delete.php'>French</option>
            <option value='it/function.pg-delete.php'>Italian</option>
            <option value='ja/function.pg-delete.php'>Japanese</option>
            <option value='pt_BR/function.pg-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-delete.php'>Russian</option>
            <option value='tr/function.pg-delete.php'>Turkish</option>
            <option value='uk/function.pg-delete.php'>Ukrainian</option>
            <option value='zh/function.pg-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-delete" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_delete</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_delete</span> &mdash; <span class="dc-title">
   Deletes records
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-delete-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_delete</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$table_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$conditions</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="pgsql.constants.php#constant.pgsql-dml-exec">PGSQL_DML_EXEC</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_delete()</strong></span> deletes records from a table
   specified by the keys and values in <code class="parameter">conditions</code>.
  </p>
  <p class="para">
  ...
  <p class="para">
   By default <span class="function"><strong>pg_delete()</strong></span> passes raw values.
...
<div class="refsect1 parameters" id="refsect1-function.pg-delete-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-delete-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-delete-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-delete-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2050">
    <p><strong>Example #1 <span class="function"><strong>pg_delete()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php <br />  $db </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'dbname=foo'</span><span style="color: #007700">);<br />  </span><span style="color: #FF8000">// This is safe somewhat, since all values are escaped.<br />  // However PostgreSQL supports JSON/Array. These are not<br />  // safe by neither escape nor prepared query.<br />  </span><span style="color: #0000BB">$res </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$db</span><span style="color: #007700">, </span><span style="color: #DD0000">'post_log'</span><span style="color: #007700">, </span><span style="color: #0000BB">$_POST</span><span style="color: #007700">, </span><span style="color: #0000BB">PG_DML_ESCAPE</span><span style="color: #007700">);<br />  if (</span><span style="color: #0000BB">$res</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">"POST data is deleted: </span><span style="color: #0000BB">$res</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />  } else {<br />      echo </span><span style="color: #DD0000">"User must have sent wrong inputs\n"</span><span style="color: #007700">;<br />  }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-delete-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-convert.php" class="function" rel="rdfs-seeAlso">pg_convert()</a> - Convert associative array values into forms suitable for SQL statements</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-delete.php">＋<small>add a note</small></a></span>
