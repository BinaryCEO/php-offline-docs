...
<head>
  ...
  <title>PHP: MongoDB\Driver\Command::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-command.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-command.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-command.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-command.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mongodb-driver-command.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mongodb-driver-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-command.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-command.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-command.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-command.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-command.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-command.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-command.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-command.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-command.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-command.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-command.construct.php" hreflang="zh">
...
<meta name="Description" content="Create a new Command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Command::__construct - Manual" />
<meta name="twitter:description" content="Create a new Command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Command::__construct - Manual" />
<meta itemprop="description" content="Create a new Command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new Command" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.mongodb-driver-query.php">
          MongoDB\Driver\Query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mongodb-driver-command.php">
          &laquo; MongoDB\Driver\Command        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.database.php'>Database Extensions</a></li>      <li><a href='refs.database.vendors.php'>Vendor Specific Database Extensions</a></li>      <li><a href='book.mongodb.php'>MongoDB</a></li>      <li><a href='mongodb.mongodb.php'>MongoDB\Driver</a></li>      <li><a href='class.mongodb-driver-command.php'>MongoDB\Driver\Command</a></li>      </ul>
    </div>
  </div>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-command.construct.php' selected="selected">English</option>
            <option value='de/mongodb-driver-command.construct.php'>German</option>
            <option value='es/mongodb-driver-command.construct.php'>Spanish</option>
            <option value='fr/mongodb-driver-command.construct.php'>French</option>
            <option value='it/mongodb-driver-command.construct.php'>Italian</option>
            <option value='ja/mongodb-driver-command.construct.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-command.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-command.construct.php'>Russian</option>
            <option value='tr/mongodb-driver-command.construct.php'>Turkish</option>
            <option value='uk/mongodb-driver-command.construct.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-command.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-command.construct" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-command.construct-description">
  ...
  <p class="para rdfs-comment">
   Constructs a new <span class="classname"><a href="class.mongodb-driver-command.php" class="classname">MongoDB\Driver\Command</a></span>, which is an
         ...
         <tr>
          ...
          <td>
           <p class="para">
            ...
            a tailable cursor (e.g. <a href="https://www.mongodb.com/docs/manual/changeStreams/" class="link external">&raquo;&nbsp;Change
            Streams</a>).
           </p>
          </td>
         </tr>
...
something similar to:</p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-mongodb-driver-command.construct-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="mongodb-driver-manager.executecommand.php" class="methodname" rel="rdfs-seeAlso">MongoDB\Driver\Manager::executeCommand()</a> - Execute a database command</span></li>
   <li><span class="classname"><a href="class.mongodb-driver-cursor.php" class="classname">MongoDB\Driver\Cursor</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/command/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-command.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-command.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-command.construct.php">＋<small>add a note</small></a></span>
 ...
 <div class="note">There are no user contributed notes for this page.</div></section>    </section><!-- layout-content -->
        ...
        <ul class='parent-menu-list'>
                                    <li>
                <a href="class.mongodb-driver-command.php">MongoDB\Driver\Command</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="mongodb-driver-command.construct.php" title="_&#8203;_&#8203;construct">_&#8203;_&#8203;construct</a>
                        </li>
