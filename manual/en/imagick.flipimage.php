...
<head>
  ...
  <title>PHP: Imagick::flipImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.flipimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.flipimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.flipimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.flattenimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.floodfillpaintimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.flipimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.flipimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.flipimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.flipimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.flipimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.flipimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.flipimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.flipimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.flipimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.flipimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.flipimage.php" hreflang="zh">
...
<meta name="Description" content="Creates a vertical mirror image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::flipImage - Manual" />
<meta name="twitter:description" content="Creates a vertical mirror image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::flipImage - Manual" />
<meta itemprop="description" content="Creates a vertical mirror image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a vertical mirror image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.floodfillpaintimage.php">
          Imagick::floodFillPaintImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.flattenimages.php">
          &laquo; Imagick::flattenImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.flipimage.php' selected="selected">English</option>
            <option value='de/imagick.flipimage.php'>German</option>
            <option value='es/imagick.flipimage.php'>Spanish</option>
            <option value='fr/imagick.flipimage.php'>French</option>
            <option value='it/imagick.flipimage.php'>Italian</option>
            <option value='ja/imagick.flipimage.php'>Japanese</option>
            <option value='pt_BR/imagick.flipimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.flipimage.php'>Russian</option>
            <option value='tr/imagick.flipimage.php'>Turkish</option>
            <option value='uk/imagick.flipimage.php'>Ukrainian</option>
            <option value='zh/imagick.flipimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.flipimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::flipImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::flipImage</span> &mdash; <span class="dc-title">Creates a vertical mirror image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.flipimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::flipImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.flipimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.flipimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.flipimage-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.flipimage-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="imagick.flopimage.php" class="function" rel="rdfs-seeAlso">Imagick::flopimage()</a> - Creates a horizontal mirror image</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/flipimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.flipimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.flipimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.flipimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113838">  <div class="votes">
    <div id="Vu113838">
    <a href="/manual/vote-note.php?id=113838&amp;page=imagick.flipimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113838">
    <a href="/manual/vote-note.php?id=113838&amp;page=imagick.flipimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113838" title="75% like this...">
    10
    </div>
  </div>
  <a href="#113838" class="name">
  <strong class="user"><em>jeff at jeffharris dot us</em></strong></a><a class="genanchor" href="#113838"> &para;</a><div class="date" title="2013-12-06 10:39"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113838">
<div class="phpcode"><code><span class="html">To avoid the x-axis and y-axis discussion, flipping emulates a mirror at the bottom (or top) of the image. <br />ʇo ɐʌoıp ʇɥǝ x-ɐxıs ɐup ʎ-ɐxıs pısɔnssıou, ɟןıddıuƃ ǝɯnןɐʇǝs ɐ ɯıɹɹoɹ ɐʇ ʇɥǝ qoʇʇoɯ )oɹ ʇod( oɟ ʇɥǝ ıɯɐƃǝ˙</span></code></div>
  </div>
 </div>
  <div class="note" id="125969">  <div class="votes">
    <div id="Vu125969">
    <a href="/manual/vote-note.php?id=125969&amp;page=imagick.flipimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125969">
    <a href="/manual/vote-note.php?id=125969&amp;page=imagick.flipimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125969" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#125969" class="name">
  <strong class="user"><em>thenickdude</em></strong></a><a class="genanchor" href="#125969"> &para;</a><div class="date" title="2021-03-29 06:58"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125969">
<div class="phpcode"><code><span class="html">The horizontal equivalent to this function is called transverseImage()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.flipimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.flipimage.php">＋<small>add a note</small></a></div>
