...
<head>
  ...
  <title>PHP: socket_export_stream - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-export-stream.php">
 <link rel="shorturl" href="https://www.php.net/socket-export-stream">
 <link rel="alternate" href="https://www.php.net/socket-export-stream" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-create-pair.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-get-option.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-export-stream.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-export-stream.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-export-stream.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-export-stream.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-export-stream.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-export-stream.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-export-stream.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-export-stream.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-export-stream.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-export-stream.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-export-stream.php" hreflang="zh">
...
<meta name="Description" content="Export a socket into a stream that encapsulates a socket" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_export_stream - Manual" />
<meta name="twitter:description" content="Export a socket into a stream that encapsulates a socket" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_export_stream - Manual" />
<meta itemprop="description" content="Export a socket into a stream that encapsulates a socket" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Export a socket into a stream that encapsulates a socket" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-get-option.php">
          socket_get_option &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-create-pair.php">
          &laquo; socket_create_pair        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-export-stream.php' selected="selected">English</option>
            <option value='de/function.socket-export-stream.php'>German</option>
            <option value='es/function.socket-export-stream.php'>Spanish</option>
            <option value='fr/function.socket-export-stream.php'>French</option>
            <option value='it/function.socket-export-stream.php'>Italian</option>
            <option value='ja/function.socket-export-stream.php'>Japanese</option>
            <option value='pt_BR/function.socket-export-stream.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-export-stream.php'>Russian</option>
            <option value='tr/function.socket-export-stream.php'>Turkish</option>
            <option value='uk/function.socket-export-stream.php'>Ukrainian</option>
            <option value='zh/function.socket-export-stream.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-export-stream" class="refentry">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-export-stream-returnvalues">
  ...
  <p class="para">
   Return resource or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <td>
   ...
   previously, it was a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-export-stream.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-export-stream%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-export-stream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-export-stream.php">＋<small>add a note</small></a></span>
