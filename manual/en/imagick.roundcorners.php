...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.roundcorners.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.roundcorners.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.roundcorners.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.rotationalblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.sampleimage.php">
...
<meta name="Description" content="Rounds image corners" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::roundCorners - Manual" />
<meta name="twitter:description" content="Rounds image corners" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::roundCorners - Manual" />
<meta itemprop="description" content="Rounds image corners" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rounds image corners" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.roundcorners.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.roundcorners.php'>Russian</option>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.roundcorners-examples">
  ...
  <p class="para">
   <div class="example" id="example-3083">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #DD0000">"magick:rose"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">roundCorners</span><span style="color: #007700">(</span><span style="color: #0000BB">5</span><span style="color: #007700">,</span><span style="color: #0000BB">3</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">writeImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"rounded.png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/roundcorners.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.roundcorners%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.roundcorners&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.roundcorners.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="121747">  <div class="votes">
    ...
    <div class="tally" id="V121747" title="65% like this...">
    8
    </div>
  </div>
  <a href="#121747" class="name">
  <strong class="user"><em>mmehdibalouchi at gmail dot com</em></strong></a><a class="genanchor" href="#121747"> &para;</a><div class="date" title="2017-10-11 11:50"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121747">
<div class="phpcode"><code><span class="html">Is this method deprecated? <br />what can we do instead ?</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Alternative solution:<br />// example values<br />$width = 250;<br />$height = 250;<br />$cornerRadius = 10;<br /><br />// create mask image<br />$mask = new Imagick();<br />$mask-&gt;newImage($width, $height, new ImagickPixel('transparent'), 'png');<br />// create the rounded rectangle<br />$shape = new ImagickDraw();<br />$shape-&gt;setFillColor(new ImagickPixel('black'));<br />$shape-&gt;roundRectangle(0, 0, $width, $height, $cornerRadius, $cornerRadius);<br />// draw the rectangle<br />$mask-&gt;drawImage($shape);<br />// apply mask<br />$image-&gt;compositeImage($mask, Imagick::COMPOSITE_DSTIN, 0, 0);<br /><br />I found solution here:<br /><a href="https://github.com/Imagick/imagick/issues/213#issuecomment-385928740" rel="nofollow" target="_blank">https://github.com/Imagick/imagick/issues/213#issuecomment-385928740</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.roundcorners&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.roundcorners.php">＋<small>add a note</small></a></div>
