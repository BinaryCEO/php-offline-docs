...
<head>
  ...
  <title>PHP: ps_set_text_pos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-text-pos.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-text-pos">
 <link rel="alternate" href="https://www.php.net/ps-set-text-pos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-parameter.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-value.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-text-pos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-text-pos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-text-pos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-text-pos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-text-pos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-text-pos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-text-pos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-text-pos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-text-pos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-text-pos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-text-pos.php" hreflang="zh">
...
<meta name="Description" content="Sets position for text output" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_text_pos - Manual" />
<meta name="twitter:description" content="Sets position for text output" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_text_pos - Manual" />
<meta itemprop="description" content="Sets position for text output" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets position for text output" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-set-value.php">
          ps_set_value &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-set-parameter.php">
          &laquo; ps_set_parameter        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-text-pos.php' selected="selected">English</option>
            <option value='de/function.ps-set-text-pos.php'>German</option>
            <option value='es/function.ps-set-text-pos.php'>Spanish</option>
            <option value='fr/function.ps-set-text-pos.php'>French</option>
            <option value='it/function.ps-set-text-pos.php'>Italian</option>
            <option value='ja/function.ps-set-text-pos.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-text-pos.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-text-pos.php'>Russian</option>
            <option value='tr/function.ps-set-text-pos.php'>Turkish</option>
            <option value='uk/function.ps-set-text-pos.php'>Ukrainian</option>
            <option value='zh/function.ps-set-text-pos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-text-pos" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_set_text_pos</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_set_text_pos</span> &mdash; <span class="dc-title">Sets position for text output</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-set-text-pos-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_text_pos</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Set the position for the next text output. You may alternatively set the x
   and y value separately by calling <span class="function"><a href="function.ps-set-value.php" class="function">ps_set_value()</a></span> and
   choosing <code class="literal">textx</code> respectively <code class="literal">texty</code> as
   the value name.
  </p>
  <p class="para">
   If you want to output text at a certain position it is more convenient
   to use <span class="function"><a href="function.ps-show-xy.php" class="function">ps_show_xy()</a></span> instead of setting the text position
   and calling <span class="function"><a href="function.ps-show.php" class="function">ps_show()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-set-text-pos-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-set-text-pos-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ps </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_new</span><span style="color: #007700">();<br />if (!</span><span style="color: #0000BB">ps_open_file</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"text.ps"</span><span style="color: #007700">)) {<br />  print </span><span style="color: #DD0000">"Cannot open PostScript file\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Creator"</span><span style="color: #007700">, </span><span style="color: #DD0000">"rectangle.php"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Author"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Uwe Steinmann"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Title"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Text placement example"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_begin_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">596</span><span style="color: #007700">, </span><span style="color: #0000BB">842</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$psfont </span><span style="color: #007700">= </span><span style="color: #0000BB">ps_findfont</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Helvetica"</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_setfont</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #0000BB">$psfont</span><span style="color: #007700">, </span><span style="color: #0000BB">8.0</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_show_xy</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Some text at (100, 100)"</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_set_value</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"textx"</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_set_value</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"texty"</span><span style="color: #007700">, </span><span style="color: #0000BB">120</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_show</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">, </span><span style="color: #DD0000">"Some text at (100, 120)"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ps_end_page</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">ps_delete</span><span style="color: #007700">(</span><span style="color: #0000BB">$ps</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-set-text-pos-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-show.php" class="function" rel="rdfs-seeAlso">ps_show()</a> - Output text</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-text-pos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-text-pos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-text-pos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-text-pos.php">＋<small>add a note</small></a></span>
