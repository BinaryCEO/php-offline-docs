...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/curl.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/curl.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/curl.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/curl.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/curl.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/curl.resources.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/curl.configuration.php' selected="selected">English</option>
            ...
            <option value='ja/curl.configuration.php'>Japanese</option>
...
The behaviour of these functions is affected by settings in <var class="filename">php.ini</var>.
 ...
 <p class="para">
  <table class="doctable table">
   <caption><strong>cURL Configuration Options</strong></caption>
...
the configuration directives.</p>
 ...
 <p class="para">
  <dl>
    ...
    <dd>
     <p class="para">
      A default value for the <strong><code><a href="curl.constants.php#constant.curlopt-cainfo">CURLOPT_CAINFO</a></code></strong> option. This
      is required to be an absolute path.
     </p>
    </dd>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcurl.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=curl.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/curl.configuration.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">cURL error 60: SSL certificate problem: unable to get local issuer certificate<br /><br />This problem can occur when developing locally on windows. I am using windows 10 (x64)<br /><br />In order to fix the error, I downloaded cacert.pem from <a href="https://curl.haxx.se/docs/caextract.html" rel="nofollow" target="_blank">https://curl.haxx.se/docs/caextract.html</a><br /><br />Set the following value for in php.ini<br /><br />curl.cainfo = "C: \ php-8.0.7 \ extras \ ssl \ cacert.pem"</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">cURL error 60: SSL certificate problem: unable to get local issuer certificate<br /><br />This local development error comes when curl.cainfo variable is not set correctly.<br /><br />I faced this issue in PHP Version 7.3.1<br /><br />In order to fix the error, I downloaded cacert.pem from <a href="https://curl.haxx.se/docs/caextract.html" rel="nofollow" target="_blank">https://curl.haxx.se/docs/caextract.html</a><br /><br />Set the following paths in php.ini<br /><br />curl.cainfo="D:\wamp64\bin\php\php7.3.1\extras\ssl\cacert.pem"<br />openssl.cafile="D:\wamp64\bin\php\php7.3.1\extras\ssl\cacert.pem"<br /><br />Even after adding the paths and restart Apache, Inside phpinfo(), both the paths were showing blank.<br /><br />The error will go only if we set via php code of the project.<br /><br />Example code worked for me :-<br /><br />$guzzle = new \GuzzleHttp\Client(['verify' =&gt; 'D:\wamp64\bin\php\php7.3.1\extras\ssl\cacert.pem']);</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I was editing wrong php.ini file in last comment.<br /><br />Even though loaded configuration path was showing as "D:\wamp64\bin\apache\apache2.4.37\bin\php.ini" inside phpinfo() of WAMP Server, It was actually loading "D:\wamp64\bin\apache\apache2.4.37\bin\phpForApache.ini"<br /><br />Once I set both the variables inside phpForApache.ini, details are displayed in phpinfo() and error has gone without extra coding line.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=curl.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/curl.configuration.php">＋<small>add a note</small></a></div>
