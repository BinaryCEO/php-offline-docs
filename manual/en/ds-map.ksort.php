...
<head>
  ...
  <title>PHP: Ds\Map::ksort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-map.ksort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-map.ksort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.ksort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-map.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-map.keys.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-map.ksorted.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.ksort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds-map.ksort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds-map.ksort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds-map.ksort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds-map.ksort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds-map.ksort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds-map.ksort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds-map.ksort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds-map.ksort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds-map.ksort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds-map.ksort.php" hreflang="zh">
...
<meta name="Description" content="Sorts the map in-place by key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Map::ksort - Manual" />
<meta name="twitter:description" content="Sorts the map in-place by key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Map::ksort - Manual" />
<meta itemprop="description" content="Sorts the map in-place by key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sorts the map in-place by key" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-map.ksort.php' selected="selected">English</option>
            <option value='de/ds-map.ksort.php'>German</option>
            <option value='es/ds-map.ksort.php'>Spanish</option>
            <option value='fr/ds-map.ksort.php'>French</option>
            <option value='it/ds-map.ksort.php'>Italian</option>
            <option value='ja/ds-map.ksort.php'>Japanese</option>
            <option value='pt_BR/ds-map.ksort.php'>Brazilian Portuguese</option>
            <option value='ru/ds-map.ksort.php'>Russian</option>
            <option value='tr/ds-map.ksort.php'>Turkish</option>
            <option value='uk/ds-map.ksort.php'>Ukrainian</option>
            <option value='zh/ds-map.ksort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds-map.ksort" class="refentry">
...
(
    ...
    [2] =&gt; Ds\Pair Object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/map/ksort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-map.ksort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-map.ksort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-map.ksort.php">＋<small>add a note</small></a></span>
