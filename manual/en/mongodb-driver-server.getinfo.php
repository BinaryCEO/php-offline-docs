...
<head>
  ...
  <title>PHP: MongoDB\Driver\Server::getInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-server.getinfo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-server.getinfo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.getinfo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-server.gethost.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-server.getlatency.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.getinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-server.getinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-server.getinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-server.getinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-server.getinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-server.getinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-server.getinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-server.getinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-server.getinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-server.getinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-server.getinfo.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of information describing this server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Server::getInfo - Manual" />
<meta name="twitter:description" content="Returns an array of information describing this server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Server::getInfo - Manual" />
<meta itemprop="description" content="Returns an array of information describing this server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of information describing this server" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-server.getlatency.php">
          MongoDB\Driver\Server::getLatency &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-server.gethost.php">
          &laquo; MongoDB\Driver\Server::getHost        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-server.getinfo.php' selected="selected">English</option>
            <option value='de/mongodb-driver-server.getinfo.php'>German</option>
            <option value='es/mongodb-driver-server.getinfo.php'>Spanish</option>
            <option value='fr/mongodb-driver-server.getinfo.php'>French</option>
            <option value='it/mongodb-driver-server.getinfo.php'>Italian</option>
            <option value='ja/mongodb-driver-server.getinfo.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-server.getinfo.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-server.getinfo.php'>Russian</option>
            <option value='tr/mongodb-driver-server.getinfo.php'>Turkish</option>
            <option value='uk/mongodb-driver-server.getinfo.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-server.getinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-server.getinfo" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">MongoDB\Driver\Server::getInfo</h1>
  <p class="verinfo">(mongodb &gt;=1.0.0)</p><p class="refpurpose"><span class="refname">MongoDB\Driver\Server::getInfo</span> &mdash; <span class="dc-title">Returns an array of information describing this server</span></p>
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-server.getinfo-description">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    to other methods (e.g. <span class="function"><a href="mongodb-driver-server.gettype.php" class="function">MongoDB\Driver\Server::getType()</a></span>),
...
<div class="examplescode"><pre class="examplescode">array(23) {
     ...
     <tbody class="tbody">
      <tr>
       ...
       <td>
        ...
        the backing server&#039;s <code class="literal">hello</code> command response from the
 ...
 <div class="refsect1 seealso" id="refsect1-mongodb-driver-server.getinfo-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="mongodb-driver-serverdescription.gethelloresponse.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\ServerDescription::getHelloResponse()</a> - Returns the server's most recent &quot;hello&quot; response</span></li>
   ...
   <li><a href="https://github.com/mongodb/specifications/blob/master/source/server-discovery-and-monitoring/server-discovery-and-monitoring.md" class="link external">&raquo;&nbsp;Server Discovery and Monitoring Specification</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/server/getinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-server.getinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-server.getinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-server.getinfo.php">＋<small>add a note</small></a></span>
