...
<head>
  ...
  <title>PHP: SNMP::set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/snmp.set.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/snmp.set.php">
 <link rel="alternate" href="https://www.php.net/manual/en/snmp.set.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/snmp.getnext.php">
 <link rel="next" href="https://www.php.net/manual/en/snmp.setsecurity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/snmp.set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/snmp.set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/snmp.set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/snmp.set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/snmp.set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/snmp.set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/snmp.set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/snmp.set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/snmp.set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/snmp.set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/snmp.set.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: SNMP::set - Manual" />
<meta name="twitter:description" content="Set the value of an SNMP object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SNMP::set - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="snmp.setsecurity.php">
          SNMP::setSecurity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="snmp.getnext.php">
          &laquo; SNMP::getnext        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/snmp.set.php' selected="selected">English</option>
            <option value='de/snmp.set.php'>German</option>
            <option value='es/snmp.set.php'>Spanish</option>
            <option value='fr/snmp.set.php'>French</option>
            <option value='it/snmp.set.php'>Italian</option>
            <option value='ja/snmp.set.php'>Japanese</option>
            <option value='pt_BR/snmp.set.php'>Brazilian Portuguese</option>
            <option value='ru/snmp.set.php'>Russian</option>
            <option value='tr/snmp.set.php'>Turkish</option>
            <option value='uk/snmp.set.php'>Ukrainian</option>
            <option value='zh/snmp.set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="snmp.set" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="snmp.get.php" class="methodname" rel="rdfs-seeAlso">SNMP::get()</a> - Fetch an SNMP object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/snmp/set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsnmp.set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=snmp.set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/snmp.set.php">＋<small>add a note</small></a></span>
