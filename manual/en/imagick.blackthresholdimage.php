...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.blackthresholdimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.blackthresholdimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.blackthresholdimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.averageimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.blueshiftimage.php">
...
<meta name="Description" content="Forces all pixels below the threshold into black" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::blackThresholdImage - Manual" />
<meta name="twitter:description" content="Forces all pixels below the threshold into black" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::blackThresholdImage - Manual" />
<meta itemprop="description" content="Forces all pixels below the threshold into black" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Forces all pixels below the threshold into black" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.blackthresholdimage.php' selected="selected">English</option>
            <option value='de/imagick.blackthresholdimage.php'>German</option>
            <option value='es/imagick.blackthresholdimage.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::blackThresholdImage</span> &mdash; <span class="dc-title">Forces all pixels below the threshold into black</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.blackthresholdimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::blackThresholdImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$threshold</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.blackthresholdimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-2971">
      <p><strong>Example #1  <span class="function"><strong>Imagick::blackThresholdImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/blackthresholdimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.blackthresholdimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.blackthresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.blackthresholdimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">You need to pass this function a colour:<br /><br /><span class="default">&lt;?php<br /><br />$img</span><span class="keyword">-&gt;</span><span class="default">blackThresholdImage</span><span class="keyword">( </span><span class="string">"#FFFFFF" </span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />E.g. this blackens any pixel which isn't pure white.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>elmer at web-axis dot net</em></strong></a><a class="genanchor" href="#87329"> &para;</a><div class="date" title="2008-11-30 03:33"><strong>16 years ago</strong></div>
...
<br />  </span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">blackThresholdImage</span><span class="keyword">(</span><span class="string">'grey'</span><span class="keyword">);
...
<div class="foot"><a href="/manual/add-note.php?sect=imagick.blackthresholdimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.blackthresholdimage.php">＋<small>add a note</small></a></div>
