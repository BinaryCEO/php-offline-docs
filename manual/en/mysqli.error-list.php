...
<head>
  ...
  <title>PHP: mysqli::$error_list - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.error-list.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.error-list.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.error-list.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.error.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.execute-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.error-list.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.error-list.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.error-list.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.error-list.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.error-list.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.error-list.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.error-list.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.error-list.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.error-list.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.error-list.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.error-list.php" hreflang="zh">
...
<meta name="Description" content="Returns a list of errors from the last command executed" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$error_list - Manual" />
<meta name="twitter:description" content="Returns a list of errors from the last command executed" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$error_list - Manual" />
<meta itemprop="description" content="Returns a list of errors from the last command executed" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a list of errors from the last command executed" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.execute-query.php">
          mysqli::execute_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.error.php">
          &laquo; mysqli::$error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.error-list.php' selected="selected">English</option>
            <option value='de/mysqli.error-list.php'>German</option>
            <option value='es/mysqli.error-list.php'>Spanish</option>
            <option value='fr/mysqli.error-list.php'>French</option>
            <option value='it/mysqli.error-list.php'>Italian</option>
            <option value='ja/mysqli.error-list.php'>Japanese</option>
            <option value='pt_BR/mysqli.error-list.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.error-list.php'>Russian</option>
            <option value='tr/mysqli.error-list.php'>Turkish</option>
            <option value='uk/mysqli.error-list.php'>Ukrainian</option>
            <option value='zh/mysqli.error-list.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.error-list" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$error_list</h1>
  <h1 class="refname">mysqli_error_list</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$error_list</span> -- <span class="refname">mysqli_error_list</span> &mdash; <span class="dc-title">Returns a list of errors from the last command executed</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli.error-list-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <var class="varname"><a href="mysqli.error-list.php">$mysqli-&gt;error_list</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_error_list</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli.error-list-parameters">
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.error-list-returnvalues">
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.error-list-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_sqlstate()</a> - Returns the SQLSTATE error from previous MySQL operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/error-list.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.error-list%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.error-list&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.error-list.php">＋<small>add a note</small></a></span>
