...
<head>
  ...
  <title>PHP: ibase_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/ibase-num-fields">
 <link rel="alternate" href="https://www.php.net/ibase-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-name-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-num-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Get the number of fields in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_num_fields - Manual" />
<meta name="twitter:description" content="Get the number of fields in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_num_fields - Manual" />
<meta itemprop="description" content="Get the number of fields in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the number of fields in a result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-num-params.php">
          ibase_num_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-name-result.php">
          &laquo; ibase_name_result        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-num-fields.php' selected="selected">English</option>
            <option value='de/function.ibase-num-fields.php'>German</option>
            <option value='es/function.ibase-num-fields.php'>Spanish</option>
            <option value='fr/function.ibase-num-fields.php'>French</option>
            <option value='it/function.ibase-num-fields.php'>Italian</option>
            <option value='ja/function.ibase-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.ibase-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-num-fields.php'>Russian</option>
            <option value='tr/function.ibase-num-fields.php'>Turkish</option>
            <option value='uk/function.ibase-num-fields.php'>Ukrainian</option>
            <option value='zh/function.ibase-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_num_fields</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_num_fields</span> &mdash; <span class="dc-title">Get the number of fields in a result set</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-num-fields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_num_fields</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result_id</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-num-fields-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-num-fields-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-num-fields-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1330">
    <p><strong>Example #1 <span class="function"><strong>ibase_num_fields()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$rs </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT * FROM tablename"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$coln </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_num_fields</span><span style="color: #007700">(</span><span style="color: #0000BB">$rs</span><span style="color: #007700">);<br />for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$coln</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />    </span><span style="color: #0000BB">$col_info </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_field_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$rs</span><span style="color: #007700">, </span><span style="color: #0000BB">$i</span><span style="color: #007700">);<br />    echo </span><span style="color: #DD0000">"name: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$col_info</span><span style="color: #007700">[</span><span style="color: #DD0000">'name'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">"alias: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$col_info</span><span style="color: #007700">[</span><span style="color: #DD0000">'alias'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">"relation: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$col_info</span><span style="color: #007700">[</span><span style="color: #DD0000">'relation'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">"length: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$col_info</span><span style="color: #007700">[</span><span style="color: #DD0000">'length'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />    echo </span><span style="color: #DD0000">"type: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$col_info</span><span style="color: #007700">[</span><span style="color: #DD0000">'type'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-num-fields-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-field-info.php" class="function" rel="rdfs-seeAlso">ibase_field_info()</a> - Get information about a field</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-num-fields.php">＋<small>add a note</small></a></span>
