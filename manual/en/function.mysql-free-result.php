...
<head>
  ...
  <title>PHP: mysql_free_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-free-result.php">
 <link rel="shorturl" href="https://www.php.net/mysql-free-result">
 <link rel="alternate" href="https://www.php.net/mysql-free-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-get-client-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-free-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-free-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-free-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-free-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-free-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-free-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-free-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-free-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-free-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-free-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-free-result.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_free_result - Manual" />
<meta name="twitter:description" content="Free result memory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_free_result - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-get-client-info.php">
          mysql_get_client_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-type.php">
          &laquo; mysql_field_type        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-free-result.php' selected="selected">English</option>
            <option value='de/function.mysql-free-result.php'>German</option>
            <option value='es/function.mysql-free-result.php'>Spanish</option>
            <option value='fr/function.mysql-free-result.php'>French</option>
            <option value='it/function.mysql-free-result.php'>Italian</option>
            <option value='ja/function.mysql-free-result.php'>Japanese</option>
            <option value='pt_BR/function.mysql-free-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-free-result.php'>Russian</option>
            <option value='tr/function.mysql-free-result.php'>Turkish</option>
            <option value='uk/function.mysql-free-result.php'>Ukrainian</option>
            <option value='zh/function.mysql-free-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-free-result" class="refentry">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli-result.free.php" class="function">mysqli_free_result()</a></span></li>
    <li>Assign the value of <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> to the PDO object, or <span class="methodname"><a href="pdostatement.closecursor.php" class="methodname">PDOStatement::closeCursor()</a></span></li>
   </ul>
  </div>
 </div>
 ...
 <div class="refsect1 description" id="refsect1-function.mysql-free-result-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_free_result</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>mysql_free_result()</strong></span> will free all memory
   associated with the result identifier <code class="parameter">result</code>.
  </p>
  <p class="para">
   <span class="function"><strong>mysql_free_result()</strong></span> only needs to be called if
...
<span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-free-result-returnvalues">
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.mysql-query.php" class="function">mysql_query()</a></span> only returns a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.is-resource.php" class="function" rel="rdfs-seeAlso">is_resource()</a> - Finds whether a variable is a resource</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-free-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-free-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-free-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-free-result.php">＋<small>add a note</small></a></span>
