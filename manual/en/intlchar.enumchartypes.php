...
<head>
  ...
  <title>PHP: IntlChar::enumCharTypes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.enumchartypes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.enumchartypes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.enumchartypes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.enumcharnames.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.foldcase.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.enumchartypes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.enumchartypes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.enumchartypes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.enumchartypes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.enumchartypes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.enumchartypes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.enumchartypes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.enumchartypes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.enumchartypes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.enumchartypes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.enumchartypes.php" hreflang="zh">
...
<meta name="Description" content="Enumerate all code points with their Unicode general categories" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::enumCharTypes - Manual" />
<meta name="twitter:description" content="Enumerate all code points with their Unicode general categories" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::enumCharTypes - Manual" />
<meta itemprop="description" content="Enumerate all code points with their Unicode general categories" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enumerate all code points with their Unicode general categories" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.foldcase.php">
          IntlChar::foldCase &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.enumcharnames.php">
          &laquo; IntlChar::enumCharNames        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.enumchartypes.php' selected="selected">English</option>
            <option value='de/intlchar.enumchartypes.php'>German</option>
            <option value='es/intlchar.enumchartypes.php'>Spanish</option>
            <option value='fr/intlchar.enumchartypes.php'>French</option>
            <option value='it/intlchar.enumchartypes.php'>Italian</option>
            <option value='ja/intlchar.enumchartypes.php'>Japanese</option>
            <option value='pt_BR/intlchar.enumchartypes.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.enumchartypes.php'>Russian</option>
            <option value='tr/intlchar.enumchartypes.php'>Turkish</option>
            <option value='uk/intlchar.enumchartypes.php'>Ukrainian</option>
            <option value='zh/intlchar.enumchartypes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.enumchartypes" class="refentry">
...
...</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/enumchartypes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.enumchartypes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.enumchartypes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.enumchartypes.php">＋<small>add a note</small></a></span>
