...
<head>
  ...
  <title>PHP: pg_lo_truncate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-truncate.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-truncate">
 <link rel="alternate" href="https://www.php.net/pg-lo-truncate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-tell.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-unlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-truncate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-truncate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-truncate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-truncate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-truncate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-truncate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-truncate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-truncate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-truncate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-truncate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-truncate.php" hreflang="zh">
...
<meta name="Description" content="Truncates a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_truncate - Manual" />
<meta name="twitter:description" content="Truncates a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_truncate - Manual" />
<meta itemprop="description" content="Truncates a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Truncates a large object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-truncate.php' selected="selected">English</option>
            <option value='de/function.pg-lo-truncate.php'>German</option>
            <option value='es/function.pg-lo-truncate.php'>Spanish</option>
            <option value='fr/function.pg-lo-truncate.php'>French</option>
            <option value='it/function.pg-lo-truncate.php'>Italian</option>
            <option value='ja/function.pg-lo-truncate.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-truncate.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-truncate.php'>Russian</option>
            <option value='tr/function.pg-lo-truncate.php'>Turkish</option>
            <option value='uk/function.pg-lo-truncate.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-truncate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-truncate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_lo_truncate</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_lo_truncate</span> &mdash; <span class="dc-title">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-truncate-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_lo_truncate</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-lob.php" class="type PgSql\Lob">PgSql\Lob</a></span> <code class="parameter">$lob</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$size</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_lo_truncate()</strong></span> truncates an <span class="classname"><a href="class.pgsql-lob.php" class="classname">PgSql\Lob</a></span> instance.
  </p>
  <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $doc_oid </span><span style="color: #007700">= </span><span style="color: #0000BB">189762345</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$database </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=jacarta"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"begin"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #0000BB">$doc_oid</span><span style="color: #007700">, </span><span style="color: #DD0000">"r"</span><span style="color: #007700">);<br />   </span><span style="color: #FF8000">// Truncate to 0<br />   </span><span style="color: #0000BB">pg_lo_truncate</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"commit"</span><span style="color: #007700">);<br />   echo </span><span style="color: #0000BB">$data</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-lo-truncate-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-lo-tell.php" class="function" rel="rdfs-seeAlso">pg_lo_tell()</a> - Returns current seek position a of large object</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-truncate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-truncate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-truncate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-truncate.php">＋<small>add a note</small></a></span>
