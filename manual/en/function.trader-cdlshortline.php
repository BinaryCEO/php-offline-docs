...
<head>
  ...
  <title>PHP: trader_cdlshortline - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdlshortline.php">
 <link rel="shorturl" href="https://www.php.net/trader-cdlshortline">
 <link rel="alternate" href="https://www.php.net/trader-cdlshortline" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdlshootingstar.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdlspinningtop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cdlshortline.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cdlshortline.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cdlshortline.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cdlshortline.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cdlshortline.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cdlshortline.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cdlshortline.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cdlshortline.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cdlshortline.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cdlshortline.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cdlshortline.php" hreflang="zh">
...
<meta name="Description" content="Short Line Candle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cdlshortline - Manual" />
<meta name="twitter:description" content="Short Line Candle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cdlshortline - Manual" />
<meta itemprop="description" content="Short Line Candle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Short Line Candle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-cdlspinningtop.php">
          trader_cdlspinningtop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-cdlshootingstar.php">
          &laquo; trader_cdlshootingstar        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdlshortline.php' selected="selected">English</option>
            <option value='de/function.trader-cdlshortline.php'>German</option>
            <option value='es/function.trader-cdlshortline.php'>Spanish</option>
            <option value='fr/function.trader-cdlshortline.php'>French</option>
            <option value='it/function.trader-cdlshortline.php'>Italian</option>
            <option value='ja/function.trader-cdlshortline.php'>Japanese</option>
            <option value='pt_BR/function.trader-cdlshortline.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cdlshortline.php'>Russian</option>
            <option value='tr/function.trader-cdlshortline.php'>Turkish</option>
            <option value='uk/function.trader-cdlshortline.php'>Ukrainian</option>
            <option value='zh/function.trader-cdlshortline.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cdlshortline" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cdlshortline</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdlshortline</span> &mdash; <span class="dc-title">Short Line Candle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cdlshortline-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cdlshortline</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cdlshortline-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdlshortline-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdlshortline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdlshortline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdlshortline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdlshortline.php">＋<small>add a note</small></a></span>
