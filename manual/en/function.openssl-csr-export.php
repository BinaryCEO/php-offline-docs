...
<head>
  ...
  <title>PHP: openssl_csr_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-csr-export.php">
 <link rel="shorturl" href="https://www.php.net/openssl-csr-export">
 <link rel="alternate" href="https://www.php.net/openssl-csr-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cms-verify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-csr-export-to-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-csr-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-csr-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-csr-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-csr-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-csr-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-csr-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-csr-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-csr-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-csr-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-csr-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-csr-export.php" hreflang="zh">
...
<meta name="Description" content="Exports a CSR as a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_csr_export - Manual" />
<meta name="twitter:description" content="Exports a CSR as a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_csr_export - Manual" />
<meta itemprop="description" content="Exports a CSR as a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a CSR as a string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-csr-export-to-file.php">
          openssl_csr_export_to_file &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-cms-verify.php">
          &laquo; openssl_cms_verify        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-csr-export.php' selected="selected">English</option>
            <option value='de/function.openssl-csr-export.php'>German</option>
            <option value='es/function.openssl-csr-export.php'>Spanish</option>
            <option value='fr/function.openssl-csr-export.php'>French</option>
            <option value='it/function.openssl-csr-export.php'>Italian</option>
            <option value='ja/function.openssl-csr-export.php'>Japanese</option>
            <option value='pt_BR/function.openssl-csr-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-csr-export.php'>Russian</option>
            <option value='tr/function.openssl-csr-export.php'>Turkish</option>
            <option value='uk/function.openssl-csr-export.php'>Ukrainian</option>
            <option value='zh/function.openssl-csr-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-csr-export" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_csr_export</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_csr_export</span> &mdash; <span class="dc-title">Exports a <abbr title="Certificate Signing Request">CSR</abbr> as a string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-csr-export-description">
  ...
  <p class="para rdfs-comment">
   ...
   Request represented by <code class="parameter">csr</code> and stores it in
   <abbr title="Privacy-Enhanced Mail">PEM</abbr> format in <code class="parameter">output</code>, which is passed by
   reference.
  </p>
 </div>
 ...
 <dd>
  <p class="para">
   See <a href="openssl.certparams.php" class="link">CSR parameters</a> for a list of valid values.
     ...
     <dd>
      <p class="para">
       on success, this string will contain the <abbr title="Privacy-Enhanced Mail">PEM</abbr>
       encoded <abbr title="Certificate Signing Request">CSR</abbr>
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
 The optional parameter <code class="parameter">notext</code> affects
 the verbosity of the output; if it is <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>, then additional human-readable
 information is included in the output. The default value of
 <code class="parameter">notext</code> is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.
</p>
     </dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-csr-export-examples">
  ...
  <p class="para">
   <div class="example" id="example-1013">
    <p><strong>Example #1 openssl_csr_export() example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$subject </span><span style="color: #007700">= array(<br />    </span><span style="color: #DD0000">"commonName" </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">"example.com"</span><span style="color: #007700">,<br />);<br /></span><span style="color: #0000BB">$private_key </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_pkey_new</span><span style="color: #007700">(array(<br />    </span><span style="color: #DD0000">"private_key_bits" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">2048</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">"private_key_type" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">OPENSSL_KEYTYPE_RSA</span><span style="color: #007700">,<br />));<br /></span><span style="color: #0000BB">$configargs </span><span style="color: #007700">= array(<br />    </span><span style="color: #DD0000">'digest_alg' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'sha256WithRSAEncryption'<br /></span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$csr </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_csr_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$subject</span><span style="color: #007700">, </span><span style="color: #0000BB">$private_key</span><span style="color: #007700">, </span><span style="color: #0000BB">$configargs</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">openssl_csr_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$csr</span><span style="color: #007700">, </span><span style="color: #0000BB">$csr_string</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$csr_string</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.openssl-csr-export-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-csr-export-to-file.php" class="function" rel="rdfs-seeAlso">openssl_csr_export_to_file()</a> - Exports a CSR to a file</span></li>
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-csr-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-csr-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-csr-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-export.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="22696">  <div class="votes">
    <div id="Vu22696">
    <a href="/manual/vote-note.php?id=22696&amp;page=function.openssl-csr-export&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd22696">
    <a href="/manual/vote-note.php?id=22696&amp;page=function.openssl-csr-export&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V22696" title="80% like this...">
    3
    </div>
  </div>
  <a href="#22696" class="name">
  <strong class="user"><em>carlos AT wfmh DOT org DOT pl</em></strong></a><a class="genanchor" href="#22696"> &para;</a><div class="date" title="2002-06-26 07:44"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom22696">
<div class="phpcode"><code><span class="html">Here you come with the example of how to use this function. <br /><br />if( $csr = openssl_csr_new( array( <br />     "countryName"=&gt;"PL",<br />     "stateOrProvinceName" =&gt; "blah",<br />     "organizationName" =&gt; "company ltd",<br />     "commonName"=&gt;"foo.bar.com",<br />     "Email"=&gt;"blah@foo.bar.com"), $privkey )<br />                  )<br />   {<br />   openssl_csr_export_to_file( $csr, "out.csr");<br />   }<br />else<br />   {<br />   printf("failed\n");<br />   }<br /><br />Keep in mind that keys are case sensitive (i.e. give "email" instead of "Email" and you get warning). Also remember it's important to keep the order of the arguments in array. Move the "Email" above commonName and check what you get (in case you don't know how: "openssl req -noout -text -in out.csr"). <br /><br />It also happened to me me I got segfault when order was rubbish (afair Email after countryName, or plenty Email's here and there), so be awared.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-csr-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-export.php">＋<small>add a note</small></a></div>
