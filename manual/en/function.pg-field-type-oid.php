...
<head>
  ...
  <title>PHP: pg_field_type_oid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-field-type-oid.php">
 <link rel="shorturl" href="https://www.php.net/pg-field-type-oid">
 <link rel="alternate" href="https://www.php.net/pg-field-type-oid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-field-type.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-flush.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-field-type-oid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-field-type-oid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-field-type-oid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-field-type-oid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-field-type-oid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-field-type-oid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-field-type-oid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-field-type-oid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-field-type-oid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-field-type-oid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-field-type-oid.php" hreflang="zh">
...
<meta name="Description" content="Returns the type ID (OID) for the corresponding field number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_field_type_oid - Manual" />
<meta name="twitter:description" content="Returns the type ID (OID) for the corresponding field number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_field_type_oid - Manual" />
<meta itemprop="description" content="Returns the type ID (OID) for the corresponding field number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the type ID (OID) for the corresponding field number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-flush.php">
          pg_flush &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-field-type.php">
          &laquo; pg_field_type        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-field-type-oid.php' selected="selected">English</option>
            <option value='de/function.pg-field-type-oid.php'>German</option>
            <option value='es/function.pg-field-type-oid.php'>Spanish</option>
            <option value='fr/function.pg-field-type-oid.php'>French</option>
            <option value='it/function.pg-field-type-oid.php'>Italian</option>
            <option value='ja/function.pg-field-type-oid.php'>Japanese</option>
            <option value='pt_BR/function.pg-field-type-oid.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-field-type-oid.php'>Russian</option>
            <option value='tr/function.pg-field-type-oid.php'>Turkish</option>
            <option value='uk/function.pg-field-type-oid.php'>Ukrainian</option>
            <option value='zh/function.pg-field-type-oid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-field-type-oid" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-field-type-oid-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_field_type_oid</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span></div>
...
<div class="examplescode"><pre class="examplescode">Title field type OID: 1043</pre>
</div>
    </div>
   </div> 
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-field-name.php" class="function" rel="rdfs-seeAlso">pg_field_name()</a> - Returns the name of a field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-field-type-oid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-field-type-oid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-field-type-oid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-type-oid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125702">  <div class="votes">
    <div id="Vu125702">
    <a href="/manual/vote-note.php?id=125702&amp;page=function.pg-field-type-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125702">
    <a href="/manual/vote-note.php?id=125702&amp;page=function.pg-field-type-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125702" title="no votes...">
    0
    </div>
  </div>
  <a href="#125702" class="name">
  <strong class="user"><em>stanislav dot perfilov at gmail dot com</em></strong></a><a class="genanchor" href="#125702"> &para;</a><div class="date" title="2021-01-20 01:23"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125702">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="keyword">private function </span><span class="default">mapping</span><span class="keyword">(</span><span class="default">$q</span><span class="keyword">, </span><span class="default">$result</span><span class="keyword">)<br />    {<br />        </span><span class="default">$types </span><span class="keyword">= [];<br />        for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">, </span><span class="default">$count </span><span class="keyword">= </span><span class="default">\pg_num_fields</span><span class="keyword">(</span><span class="default">$q</span><span class="keyword">); </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$count</span><span class="keyword">; ++</span><span class="default">$i</span><span class="keyword">) {<br />            </span><span class="default">$types</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] = </span><span class="default">\pg_field_type_oid</span><span class="keyword">(</span><span class="default">$q</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">);<br />        }<br />        foreach (</span><span class="default">$result </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; &amp;</span><span class="default">$row</span><span class="keyword">) {<br />            </span><span class="default">$i </span><span class="keyword">= -</span><span class="default">1</span><span class="keyword">;<br />            foreach (</span><span class="default">$row </span><span class="keyword">as </span><span class="default">$name </span><span class="keyword">=&gt; &amp;</span><span class="default">$value</span><span class="keyword">) {<br />                ++</span><span class="default">$i</span><span class="keyword">;<br />                if (</span><span class="default">$value </span><span class="keyword">=== </span><span class="default">null</span><span class="keyword">) {<br />                    continue;<br />                }<br />                switch (</span><span class="default">$types</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]) {<br />                    case </span><span class="default">20</span><span class="keyword">:<br />                    case </span><span class="default">21</span><span class="keyword">:<br />                    case </span><span class="default">23</span><span class="keyword">: </span><span class="default">$value </span><span class="keyword">= (int)</span><span class="default">$value</span><span class="keyword">; break;<br />                    case </span><span class="default">16507</span><span class="keyword">: </span><span class="comment">/*$value = (string)$value; */</span><span class="keyword">break;<br />                    default:<br />                        throw new </span><span class="default">\RuntimeException</span><span class="keyword">(<br />                            </span><span class="default">\pg_field_type</span><span class="keyword">(</span><span class="default">$q</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">) .</span><span class="string">' type. Need mapping ' </span><span class="keyword">. </span><span class="default">\pg_field_type_oid</span><span class="keyword">(</span><span class="default">$q</span><span class="keyword">, </span><span class="default">$i</span><span class="keyword">)<br />                        );<br />                }<br />            }<br />        }<br />        unset(</span><span class="default">$value</span><span class="keyword">, </span><span class="default">$row</span><span class="keyword">);<br /><br />        return </span><span class="default">$result</span><span class="keyword">;<br />    }<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="51251">  <div class="votes">
    <div id="Vu51251">
    <a href="/manual/vote-note.php?id=51251&amp;page=function.pg-field-type-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51251">
    <a href="/manual/vote-note.php?id=51251&amp;page=function.pg-field-type-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51251" title="no votes...">
    0
    </div>
  </div>
  <a href="#51251" class="name">
  <strong class="user"><em>mauroi at digbang dot com</em></strong></a><a class="genanchor" href="#51251"> &para;</a><div class="date" title="2005-03-24 07:55"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51251">
<div class="phpcode"><code><span class="html">This function can be used to improve the performance of your application. <br />pg_field_type() makes an internal query to the pg_type table and it can be really slow. <br />So if your application previously know the oids of your database, you can save the execution time of this query in every request.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-field-type-oid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-field-type-oid.php">＋<small>add a note</small></a></div>
