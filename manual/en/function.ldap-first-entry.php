...
<head>
  ...
  <title>PHP: ldap_first_entry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-first-entry.php">
 <link rel="shorturl" href="https://www.php.net/ldap-first-entry">
 <link rel="alternate" href="https://www.php.net/ldap-first-entry" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-first-attribute.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-first-reference.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-first-entry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-first-entry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-first-entry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-first-entry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-first-entry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-first-entry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-first-entry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-first-entry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-first-entry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-first-entry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-first-entry.php" hreflang="zh">
...
<meta name="Description" content="Return first result id" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_first_entry - Manual" />
<meta name="twitter:description" content="Return first result id" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_first_entry - Manual" />
<meta itemprop="description" content="Return first result id" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return first result id" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ldap-first-reference.php">
          ldap_first_reference &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-first-attribute.php">
          &laquo; ldap_first_attribute        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-first-entry.php' selected="selected">English</option>
            <option value='de/function.ldap-first-entry.php'>German</option>
            <option value='es/function.ldap-first-entry.php'>Spanish</option>
            <option value='fr/function.ldap-first-entry.php'>French</option>
            <option value='it/function.ldap-first-entry.php'>Italian</option>
            <option value='ja/function.ldap-first-entry.php'>Japanese</option>
            <option value='pt_BR/function.ldap-first-entry.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-first-entry.php'>Russian</option>
            <option value='tr/function.ldap-first-entry.php'>Turkish</option>
            <option value='uk/function.ldap-first-entry.php'>Ukrainian</option>
            <option value='zh/function.ldap-first-entry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-first-entry" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-first-entry-returnvalues">
  ...
  <p class="para">
   Returns an <span class="classname"><a href="class.ldap-result-entry.php" class="classname">LDAP\ResultEntry</a></span> instance, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-get-entries.php" class="function" rel="rdfs-seeAlso">ldap_get_entries()</a> - Get all result entries</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-first-entry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-first-entry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-first-entry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-first-entry.php">＋<small>add a note</small></a></span>
