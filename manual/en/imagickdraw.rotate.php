...
<head>
  ...
  <title>PHP: ImagickDraw::rotate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.rotate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.rotate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.rotate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.resetvectorgraphics.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.roundrectangle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.rotate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.rotate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.rotate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.rotate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.rotate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.rotate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.rotate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.rotate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.rotate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.rotate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.rotate.php" hreflang="zh">
...
<meta name="Description" content="Applies the specified rotation to the current coordinate space" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::rotate - Manual" />
<meta name="twitter:description" content="Applies the specified rotation to the current coordinate space" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::rotate - Manual" />
<meta itemprop="description" content="Applies the specified rotation to the current coordinate space" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies the specified rotation to the current coordinate space" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.roundrectangle.php">
          ImagickDraw::roundRectangle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.resetvectorgraphics.php">
          &laquo; ImagickDraw::resetVectorGraphics        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.rotate.php' selected="selected">English</option>
            <option value='de/imagickdraw.rotate.php'>German</option>
            <option value='es/imagickdraw.rotate.php'>Spanish</option>
            <option value='fr/imagickdraw.rotate.php'>French</option>
            <option value='it/imagickdraw.rotate.php'>Italian</option>
            <option value='ja/imagickdraw.rotate.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.rotate.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.rotate.php'>Russian</option>
            <option value='tr/imagickdraw.rotate.php'>Turkish</option>
            <option value='uk/imagickdraw.rotate.php'>Ukrainian</option>
            <option value='zh/imagickdraw.rotate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.rotate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::rotate</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::rotate</span> &mdash; <span class="dc-title">Applies the specified rotation to the current coordinate space</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.rotate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::rotate</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.rotate-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.rotate-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.rotate-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3164">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::rotate()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/rotate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.rotate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.rotate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.rotate.php">＋<small>add a note</small></a></span>
