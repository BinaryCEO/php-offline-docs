...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagesize.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagesize.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagesize.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagesignature.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagesize.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.getimagesize.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageSize</span> &mdash; <span class="dc-title">Returns the image length in bytes</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagesize-description">
  ...
  <p class="para rdfs-comment">
   ...
   Deprecated in favour of <a href="imagick.getimagelength.php" class="link">Imagick::getImageLength()</a>
  </p>
 </div>
  ...
  <p class="para">
   Returns an int containing the current image size.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagesize.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagesize%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagesize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagesize.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Practical use to get the dimensions of the image:
<br />
...
<div class="phpcode"><code><span class="html">Try Imagick::getSize, Imagick::getImageWidth, or Imagick::getImageHeight if you are looking to get dimensions in pixels (rows, columns) of the current image.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>murphy(at)murphyslantech(dot)de</em></strong></a><a class="genanchor" href="#101162"> &para;</a><div class="date" title="2010-11-30 07:21"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101162">
<div class="phpcode"><code><span class="html">If you get an error or warning (when using strict settings for PHP), telling you, that this function should not be used anymore try getImageLength() instead ...</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>nikolaus</em></strong></a><a class="genanchor" href="#94120"> &para;</a><div class="date" title="2009-10-17 12:52"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94120">
<div class="phpcode"><code><span class="html">If you're planning to stream imagick images via http, pay attention that this function may return the uncompressed image size, so it's not directly suitable for setting the content-length http header.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>perching_eagle at yahoo dot com</em></strong></a><a class="genanchor" href="#78274"> &para;</a><div class="date" title="2007-10-04 06:37"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78274">
<div class="phpcode"><code><span class="html">/* get the size of the image in bytes */<br />$image=new Imagick("c:/htdocs/rose.jpg");<br />$size=$image-&gt;getImageSize();<br />print "the size of the picture is ".$size." bytes";<br /><br />result<br /><br />the size of the picture is 3461 bytes</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagesize&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagesize.php">＋<small>add a note</small></a></div>
