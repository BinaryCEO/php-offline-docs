...
<div class="phpcode"><code><span class="html">You can obtain the decimal fraction of the Julian date with the php gregoriantojd() function or the function shown below by applying this code to the returned value.
<br />
<br /><span class="default">&lt;?php
<br />  $julianDate </span><span class="keyword">= </span><span class="default">gregoriantojd</span><span class="keyword">(</span><span class="default">$month</span><span class="keyword">, </span><span class="default">$day</span><span class="keyword">, </span><span class="default">$year</span><span class="keyword">);
<br />
<br />  </span><span class="comment">//correct for half-day offset
<br />  </span><span class="default">$dayfrac </span><span class="keyword">= </span><span class="default">date</span><span class="keyword">(</span><span class="string">'G'</span><span class="keyword">) / </span><span class="default">24 </span><span class="keyword">- </span><span class="default">.5</span><span class="keyword">;
<br />  if (</span><span class="default">$dayfrac </span><span class="keyword">&lt; </span><span class="default">0</span><span class="keyword">) </span><span class="default">$dayfrac </span><span class="keyword">+= </span><span class="default">1</span><span class="keyword">;
<br />
<br />  </span><span class="comment">//now set the fraction of a day
<br />  </span><span class="default">$frac </span><span class="keyword">= </span><span class="default">$dayfrac </span><span class="keyword">+ (</span><span class="default">date</span><span class="keyword">(</span><span class="string">'i'</span><span class="keyword">) + </span><span class="default">date</span><span class="keyword">(</span><span class="string">'s'</span><span class="keyword">) / </span><span class="default">60</span><span class="keyword">) / </span><span class="default">60 </span><span class="keyword">/ </span><span class="default">24</span><span class="keyword">;
<br />
<br />  </span><span class="default">$julianDate </span><span class="keyword">= </span><span class="default">$julianDate </span><span class="keyword">+ </span><span class="default">$frac</span><span class="keyword">;
...
<div class="phpcode"><code><span class="html">This function also ignores decimal fractions in JD dates, and it uses non-standard format for returning the Gregorian date. <br /><br />So, if your JD date is 2453056.28673, the Gregorian returned value is 2/20/2004, not "2004-02-20 23:45:36"<br /><br />The decimal part is important, since the Julian day begins at noon, for example 2453056.49 is on Friday, 2453056.50 is on Saturday. Discarding the decimal part means that your returned Gregorian Date will be wrong 50% of the time.</span></code></div>
  </div>
 </div>
  <div class="note" id="90138">  <div class="votes">
    <div id="Vu90138">
    <a href="/manual/vote-note.php?id=90138&amp;page=function.gregoriantojd&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90138">
    <a href="/manual/vote-note.php?id=90138&amp;page=function.gregoriantojd&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90138" title="14% like this...">
    -5
    </div>
  </div>
  <a href="#90138" class="name">
  <strong class="user"><em>jfg</em></strong></a><a class="genanchor" href="#90138"> &para;</a><div class="date" title="2009-04-07 01:19"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90138">
<div class="phpcode"><code><span class="html">If you need the same output as the g_date_get_julian function of the GlibC, here is my php implementation :<br /><br /><span class="default">&lt;?php<br />    </span><span class="comment">/**<br />     * Glib g_date_get_julian PHP implementation<br />     *<br />     * @param  $str  Date string in a format accepted by strtotime<br />     * @author jfg<br />     */<br />    </span><span class="keyword">private function </span><span class="default">_get_julian</span><span class="keyword">( </span><span class="default">$str </span><span class="keyword">)<br />    {<br />        </span><span class="default">$d </span><span class="keyword">= </span><span class="default">date_create</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">);<br /><br />        if( </span><span class="default">$d </span><span class="keyword">== </span><span class="default">false </span><span class="keyword">)<br />            return </span><span class="default">0</span><span class="keyword">;<br />        <br />        </span><span class="default">$day_in_year </span><span class="keyword">= (int) </span><span class="default">date_format</span><span class="keyword">(</span><span class="default">$d</span><span class="keyword">, </span><span class="string">"z"</span><span class="keyword">);<br />        </span><span class="default">$year        </span><span class="keyword">= (int) </span><span class="default">date_format</span><span class="keyword">(</span><span class="default">$d</span><span class="keyword">, </span><span class="string">"Y"</span><span class="keyword">) - </span><span class="default">1</span><span class="keyword">;<br />        </span><span class="default">$julian_days </span><span class="keyword">= </span><span class="default">$year </span><span class="keyword">* </span><span class="default">365</span><span class="keyword">;<br />        </span><span class="default">$julian_days </span><span class="keyword">+= (</span><span class="default">$year </span><span class="keyword">&gt;&gt;= </span><span class="default">2</span><span class="keyword">);<br />        </span><span class="default">$julian_days </span><span class="keyword">-= (</span><span class="default">$year </span><span class="keyword">/= </span><span class="default">25</span><span class="keyword">);<br />        </span><span class="default">$julian_days </span><span class="keyword">+= </span><span class="default">$year </span><span class="keyword">&gt;&gt; </span><span class="default">2</span><span class="keyword">;<br />        </span><span class="default">$julian_days </span><span class="keyword">+= </span><span class="default">$day_in_year </span><span class="keyword">+ </span><span class="default">1</span><span class="keyword">;<br /><br />        return </span><span class="default">ceil</span><span class="keyword">(</span><span class="default">$julian_days</span><span class="keyword">);<br />    }<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
