...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.nextimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.nextimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.nextimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.newpseudoimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.normalizeimage.php">
...
<meta name="Description" content="Moves to the next image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::nextImage - Manual" />
<meta name="twitter:description" content="Moves to the next image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::nextImage - Manual" />
<meta itemprop="description" content="Moves to the next image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Moves to the next image" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.nextimage.php' selected="selected">English</option>
            ...
            <option value='tr/imagick.nextimage.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::nextImage</span> &mdash; <span class="dc-title">Moves to the next image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.nextimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::nextImage</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/nextimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.nextimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.nextimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.nextimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The following function applies a callback to each image in an Imagick object.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">imagickMap</span><span class="keyword">(</span><span class="default">$callback</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">)<br />{<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setFirstIterator</span><span class="keyword">();<br /><br />    do<br />    {<br />        </span><span class="default">$callback</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">);<br />    }<br />    while ( </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">nextImage</span><span class="keyword">() );<br />}<br /></span><span class="default">?&gt;<br /></span><br />E.g. to convert a series of images to grayscale:<br /><br /><span class="default">&lt;?php<br />imagickMap</span><span class="keyword">(<br />    function(</span><span class="default">$im</span><span class="keyword">)<br />    {<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageType</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_GRAYSCALEMATTE</span><span class="keyword">);<br />    },<br />    </span><span class="default">$im<br /></span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>markus dot s dot schmitz at gmail dot com</em></strong></a><a class="genanchor" href="#110812"> &para;</a><div class="date" title="2012-12-11 10:46"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110812">
<div class="phpcode"><code><span class="html">Convert PDF to JPG page-wise:<br /><br /><span class="default">&lt;?php<br />$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br /><br /></span><span class="default">$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'myfile.pdf'</span><span class="keyword">);<br />while(</span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">hasNextImage</span><span class="keyword">()) {<br />    </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(++</span><span class="default">$i</span><span class="keyword">.</span><span class="string">'-converted.jpg'</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br />    </span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">nextImage</span><span class="keyword">();<br />}<br /></span><span class="default">?&gt;<br /></span><br />See also: <a href="http://php.net/manual/en/imagick.readimage.php" rel="nofollow" target="_blank">http://php.net/manual/en/imagick.readimage.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.nextimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.nextimage.php">＋<small>add a note</small></a></div>
