...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/changelog.strings.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/changelog.strings.php">
 <link rel="alternate" href="https://www.php.net/manual/en/changelog.strings.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wordwrap.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.basic.vartype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/changelog.strings.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/changelog.strings.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/changelog.strings.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/changelog.strings.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/changelog.strings.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/changelog.strings.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/changelog.strings.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/changelog.strings.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/changelog.strings.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/changelog.strings.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/changelog.strings.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="refs.basic.vartype.php">
          Variable and Type Related Extensions &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/changelog.strings.php' selected="selected">English</option>
            <option value='de/changelog.strings.php'>German</option>
            <option value='es/changelog.strings.php'>Spanish</option>
            <option value='fr/changelog.strings.php'>French</option>
            <option value='it/changelog.strings.php'>Italian</option>
            <option value='ja/changelog.strings.php'>Japanese</option>
            <option value='pt_BR/changelog.strings.php'>Brazilian Portuguese</option>
            <option value='ru/changelog.strings.php'>Russian</option>
            <option value='tr/changelog.strings.php'>Turkish</option>
            <option value='uk/changelog.strings.php'>Ukrainian</option>
            <option value='zh/changelog.strings.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="changelog.strings" class="appendix">
 <h1 class="title">Changelog</h1>

 <p class="para">The following changes have been made to classes/functions/methods of this extension.</p>
 <table class='doctable table' rules='groups'><thead><tr><th>Version</th><th>Function</th><th>Description</th></tr></thead><tbody class="gen-changelog v"><tr><td>8.4.0</td><td><a href='function.str-getcsv.php'>str_getcsv</a></td><td>Relying on the default value of escape is now
        ...
        the search would incorrectly stop at the first null byte in string.</td></tr></tbody><tbody class="gen-changelog v8-4-0"><tr><td>8.3.0</td><td><a href='function.number-format.php'>number_format</a></td><td>Added handling of negative values for decimals.</td></tr><tr><td>&nbsp;</td><td><a href='function.str-getcsv.php'>str_getcsv</a></td><td>An empty string is returned instead of a string with a single
        null byte for the last field if it contains only an unterminated
        enclosure.</td></tr><tr><td>&nbsp;</td><td><a href='function.strrchr.php'>strrchr</a></td><td>The before_needle parameter was added.</td></tr><tr><td>&nbsp;</td><td><a href='function.strtok.php'>strtok</a></td><td>Now emits E_WARNING when token is not provided.</td></tr></tbody><tbody class="gen-changelog v8-3-0"><tr><td>8.2.0</td><td><a href='function.lcfirst.php'>lcfirst</a></td><td>Case conversion no longer depends on the locale set with
   setlocale. Only ASCII characters will be converted.</td></tr><tr><td>&nbsp;</td><td><a href='function.str-ireplace.php'>str_ireplace</a></td><td>Case folding no longer depends on the locale set with
  ...
  strlen($string1) - strlen($string2) when string lengths
  are not equal, but may now return -1 or
  1 instead.</td></tr><tr><td>&nbsp;</td><td><a href='function.ucfirst.php'>ucfirst</a></td><td>Case conversion no longer depends on the locale set with
   ...
   setlocale. Only ASCII characters will be converted.</td></tr><tr><td>&nbsp;</td><td><a href='function.utf8-decode.php'>utf8_decode</a></td><td>This function has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.utf8-encode.php'>utf8_encode</a></td><td>This function has been deprecated.</td></tr></tbody><tbody class="gen-changelog v8-2-0"><tr><td>8.1.0</td><td><a href='function.get-html-translation-table.php'>get_html_translation_table</a></td><td>flags changed from ENT_COMPAT to ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401.</td></tr><tr><td>&nbsp;</td><td><a href='function.html-entity-decode.php'>html_entity_decode</a></td><td>flags changed from ENT_COMPAT to ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401.</td></tr><tr><td>&nbsp;</td><td><a href='function.htmlentities.php'>htmlentities</a></td><td>flags changed from ENT_COMPAT to ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401.</td></tr><tr><td>&nbsp;</td><td><a href='function.htmlspecialchars.php'>htmlspecialchars</a></td><td>flags changed from ENT_COMPAT to ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401.</td></tr><tr><td>&nbsp;</td><td><a href='function.htmlspecialchars-decode.php'>htmlspecialchars_decode</a></td><td>flags changed from ENT_COMPAT to ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401.</td></tr></tbody><tbody class="gen-changelog v8-1-0"><tr><td>8.0.0</td><td><a href='function.convert-cyr-string.php'>convert_cyr_string</a></td><td>Removed this function.</td></tr><tr><td>&nbsp;</td><td><a href='function.convert-uuencode.php'>convert_uuencode</a></td><td>Prior to this version, trying to convert an empty string returned false
       for no particular reason.</td></tr><tr><td>&nbsp;</td><td><a href='function.count-chars.php'>count_chars</a></td><td>Prior to this version, the function returned false on failure.</td></tr><tr><td>&nbsp;</td><td><a href='function.crypt.php'>crypt</a></td><td>The salt is no longer optional.</td></tr><tr><td>&nbsp;</td><td><a href='function.explode.php'>explode</a></td><td>explode will now throw ValueError
       when separator parameter is given an empty string
       (&quot;&quot;).
       Previously, explode returned false instead.</td></tr><tr><td>&nbsp;</td><td><a href='function.fprintf.php'>fprintf</a></td><td>This function no longer returns false on failure.</td></tr><tr><td>&nbsp;</td><td><a href='function.fprintf.php'>fprintf</a></td><td>Throw a ValueError if the number of arguments is zero;
       ...
       previously this function emitted a E_WARNING instead.</td></tr><tr><td>&nbsp;</td><td><a href='function.hebrevc.php'>hebrevc</a></td><td>Removed this function.</td></tr><tr><td>&nbsp;</td><td><a href='function.html-entity-decode.php'>html_entity_decode</a></td><td>encoding is nullable now.</td></tr><tr><td>&nbsp;</td><td><a href='function.htmlentities.php'>htmlentities</a></td><td>encoding is nullable now.</td></tr><tr><td>&nbsp;</td><td><a href='function.implode.php'>implode</a></td><td>Passing the separator after the array
       is no longer supported.</td></tr><tr><td>&nbsp;</td><td><a href='function.levenshtein.php'>levenshtein</a></td><td>Prior to this version, levenshtein had to be called
       ...
       if one of the argument strings is longer than 255 characters.</td></tr><tr><td>&nbsp;</td><td><a href='function.metaphone.php'>metaphone</a></td><td>The function returned false on failure.</td></tr><tr><td>&nbsp;</td><td><a href='function.money-format.php'>money_format</a></td><td>Removed this function.</td></tr><tr><td>&nbsp;</td><td><a href='function.number-format.php'>number_format</a></td><td>Prior to this version, number_format accepted
        one, two, or four parameters (but not three).</td></tr><tr><td>&nbsp;</td><td><a href='function.parse-str.php'>parse_str</a></td><td>result is no longer optional.</td></tr><tr><td>&nbsp;</td><td><a href='function.printf.php'>printf</a></td><td>This function no longer returns false on failure.</td></tr><tr><td>&nbsp;</td><td><a href='function.printf.php'>printf</a></td><td>Throw a ValueError if the number of arguments is zero;
       ...
       previously this function emitted a E_WARNING instead.</td></tr><tr><td>&nbsp;</td><td><a href='function.soundex.php'>soundex</a></td><td>Prior to this version, calling the function with an empty string returned false
       for no particular reason.</td></tr><tr><td>&nbsp;</td><td><a href='function.sprintf.php'>sprintf</a></td><td>This function no longer returns false on failure.</td></tr><tr><td>&nbsp;</td><td><a href='function.sprintf.php'>sprintf</a></td><td>Throw a ValueError if the number of arguments is zero;
       ...
       previously in this case it emitted an E_WARNING and returned false.</td></tr></tbody><tbody class="gen-changelog v8-0-0"><tr><td>7.4.0</td><td><a href='function.chr.php'>chr</a></td><td>The function no longer silently accepts unsupported codepoints,
       and casts these to 0.</td></tr><tr><td>&nbsp;</td><td><a href='function.convert-cyr-string.php'>convert_cyr_string</a></td><td>Deprecated this function.</td></tr><tr><td>&nbsp;</td><td><a href='function.hebrevc.php'>hebrevc</a></td><td>Deprecated this function.</td></tr><tr><td>&nbsp;</td><td><a href='function.implode.php'>implode</a></td><td>Passing the separator after the array
       (i.e. using the legacy signature) has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.money-format.php'>money_format</a></td><td>Deprecated this function. Instead, 
        use NumberFormatter::formatCurrency.</td></tr><tr><td>&nbsp;</td><td><a href='function.str-getcsv.php'>str_getcsv</a></td><td>The escape parameter now interprets an empty
        string as signal to disable the proprietary escape mechanism. Formerly,
        an empty string was treated like the default parameter value.</td></tr><tr><td>&nbsp;</td><td><a href='function.strip-tags.php'>strip_tags</a></td><td>The allowed_tags now alternatively accepts an array.</td></tr></tbody><tbody class="gen-changelog v7-4-0"><tr><td>7.3.5</td><td><a href='function.substr-compare.php'>substr_compare</a></td><td>offset may now be equal to the length of haystack.</td></tr></tbody><tbody class="gen-changelog v7-3-5"><tr><td>7.3.0</td><td><a href='function.stripos.php'>stripos</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.stristr.php'>stristr</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.strpos.php'>strpos</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.strrchr.php'>strrchr</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.strripos.php'>strripos</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.strrpos.php'>strrpos</a></td><td>Passing an int as needle has been deprecated.</td></tr><tr><td>&nbsp;</td><td><a href='function.strstr.php'>strstr</a></td><td>Passing an int as needle has been deprecated.</td></tr></tbody><tbody class="gen-changelog v7-3-0"><tr><td>7.2.18</td><td><a href='function.substr-compare.php'>substr_compare</a></td><td>offset may now be equal to the length of haystack.</td></tr></tbody><tbody class="gen-changelog v7-2-18"><tr><td>7.2.0</td><td><a href='function.number-format.php'>number_format</a></td><td>number_format was changed to not being able to return 
        -0, previously -0 could be returned 
        for cases like where num would be -0.01.</td></tr><tr><td>&nbsp;</td><td><a href='function.parse-str.php'>parse_str</a></td><td>Usage of parse_str without a second parameter
        now emits an E_DEPRECATED notice.</td></tr><tr><td>&nbsp;</td><td><a href='function.utf8-decode.php'>utf8_decode</a></td><td>This function has been moved from the XML extension to the core of PHP.
        ...
        In previous versions, it was only available if the XML extension was installed.</td></tr></tbody><tbody class="gen-changelog v7-2-0"><tr><td>7.1.0</td><td><a href='function.str-shuffle.php'>str_shuffle</a></td><td>The internal randomization algorithm has been changed to use the Mersenne Twister Random Number Generator instead of the libc rand function.</td></tr><tr><td>&nbsp;</td><td><a href='function.stripos.php'>stripos</a></td><td>Support for negative offsets has been added.</td></tr><tr><td>&nbsp;</td><td><a href='function.strpos.php'>strpos</a></td><td>Support for negative offsets has been added.</td></tr><tr><td>&nbsp;</td><td><a href='function.substr-count.php'>substr_count</a></td><td>Support for negative offsets and lengths has been added.
        length may also be 0 now.</td></tr></tbody></table>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fchangelog.strings%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=changelog.strings&amp;repo=en&amp;redirect=https://www.php.net/manual/en/changelog.strings.php">＋<small>add a note</small></a></span>
