...
<head>
  ...
  <title>PHP: CommonMark\Node\Code - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-code.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-code">
 <link rel="alternate" href="https://www.php.net/commonmark-node-code" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-linebreak.php">
 <link rel="next" href="https://www.php.net/manual/en/class.commonmark-node-codeblock.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-code.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-code.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-code.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-code.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-code.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-code.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-code.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-code.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-code.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-code.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-code.php" hreflang="zh">
...
<meta name="Description" content="Code concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\Code - Manual" />
<meta name="twitter:description" content="Code concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\Code - Manual" />
<meta itemprop="description" content="Code concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Code concrete CommonMark\Node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.commonmark-node-codeblock.php">
          CommonMark\Node\CodeBlock &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.commonmark-node-linebreak.php">
          &laquo; CommonMark\Node\LineBreak        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-code.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-code.php'>German</option>
            <option value='es/class.commonmark-node-code.php'>Spanish</option>
            <option value='fr/class.commonmark-node-code.php'>French</option>
            <option value='it/class.commonmark-node-code.php'>Italian</option>
            <option value='ja/class.commonmark-node-code.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-code.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-code.php'>Russian</option>
            <option value='tr/class.commonmark-node-code.php'>Turkish</option>
            <option value='uk/class.commonmark-node-code.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-code.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-code" class="reference">

 <h1 class="title">Code concrete CommonMark\Node</h1>
 

 <div class="partintro"><p class="verinfo">(cmark &gt;= 1.0.0)</p>

  <div class="section" id="commonmark-node-code.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\Code</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node.accept.php" class="methodname">CommonMark\Node::accept</a></span>(<span class="methodparam"><span class="type"><a href="class.commonmark-interfaces-ivisitor.php" class="type CommonMark\Interfaces\IVisitor">CommonMark\Interfaces\IVisitor</a></span> <code class="parameter">$visitor</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.code.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-code%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-code&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-code.php">＋<small>add a note</small></a></span>
