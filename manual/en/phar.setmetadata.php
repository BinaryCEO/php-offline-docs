...
<head>
  ...
  <title>PHP: Phar::setMetadata - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.setmetadata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.setmetadata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.setmetadata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.setdefaultstub.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.setsignaturealgorithm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.setmetadata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.setmetadata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.setmetadata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.setmetadata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.setmetadata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.setmetadata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.setmetadata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.setmetadata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.setmetadata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.setmetadata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.setmetadata.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Phar::setMetadata - Manual" />
<meta name="twitter:description" content="Sets phar archive meta-data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::setMetadata - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.setsignaturealgorithm.php">
          Phar::setSignatureAlgorithm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.setdefaultstub.php">
          &laquo; Phar::setDefaultStub        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.setmetadata.php' selected="selected">English</option>
            <option value='de/phar.setmetadata.php'>German</option>
            <option value='es/phar.setmetadata.php'>Spanish</option>
            <option value='fr/phar.setmetadata.php'>French</option>
            <option value='it/phar.setmetadata.php'>Italian</option>
            <option value='ja/phar.setmetadata.php'>Japanese</option>
            <option value='pt_BR/phar.setmetadata.php'>Brazilian Portuguese</option>
            <option value='ru/phar.setmetadata.php'>Russian</option>
            <option value='tr/phar.setmetadata.php'>Turkish</option>
            <option value='uk/phar.setmetadata.php'>Ukrainian</option>
            <option value='zh/phar.setmetadata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.setmetadata" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::setMetadata</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Phar::setMetadata</span> &mdash; <span class="dc-title">Sets phar archive meta-data</span></p>

 </div>
 
 
 <div class="refsect1 description" id="refsect1-phar.setmetadata-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::setMetadata</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$metadata</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 parameters" id="refsect1-phar.setmetadata-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.setmetadata-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-phar.setmetadata-examples">
...
<div class="examplescode"><pre class="examplescode">array(1) {
 ...
 <div class="refsect1 seealso" id="refsect1-phar.setmetadata-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.hasmetadata.php" class="function" rel="rdfs-seeAlso">Phar::hasMetadata()</a> - Returns whether phar has global meta-data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/setMetadata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.setmetadata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.setmetadata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.setmetadata.php">＋<small>add a note</small></a></span>
