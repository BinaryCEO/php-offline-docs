...
<head>
  ...
  <title>PHP: Imagick::getImageClipMask - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageclipmask.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageclipmask.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageclipmask.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagechannelstatistics.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecolormapcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageclipmask.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageclipmask.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageclipmask.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageclipmask.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageclipmask.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageclipmask.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageclipmask.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageclipmask.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageclipmask.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageclipmask.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageclipmask.php" hreflang="zh">
...
<meta name="Description" content="Gets image clip mask" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageClipMask - Manual" />
<meta name="twitter:description" content="Gets image clip mask" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageClipMask - Manual" />
<meta itemprop="description" content="Gets image clip mask" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets image clip mask" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagecolormapcolor.php">
          Imagick::getImageColormapColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagechannelstatistics.php">
          &laquo; Imagick::getImageChannelStatistics        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageclipmask.php' selected="selected">English</option>
            <option value='de/imagick.getimageclipmask.php'>German</option>
            <option value='es/imagick.getimageclipmask.php'>Spanish</option>
            <option value='fr/imagick.getimageclipmask.php'>French</option>
            <option value='it/imagick.getimageclipmask.php'>Italian</option>
            <option value='ja/imagick.getimageclipmask.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageclipmask.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageclipmask.php'>Russian</option>
            <option value='tr/imagick.getimageclipmask.php'>Turkish</option>
            <option value='uk/imagick.getimageclipmask.php'>Ukrainian</option>
            <option value='zh/imagick.getimageclipmask.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageclipmask" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageClipMask</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageClipMask</span> &mdash; <span class="dc-title">Gets image clip mask</span></p>

 </div>

 <div id="imagick.getimageclipmask-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageclipmask-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageClipMask</strong></span>(): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageclipmask-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageclipmask-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimageclipmask-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageclipmask.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageclipmask%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageclipmask&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageclipmask.php">＋<small>add a note</small></a></span>
