...
<head>
  ...
  <title>PHP: fann_destroy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-destroy.php">
 <link rel="shorturl" href="https://www.php.net/fann-destroy">
 <link rel="alternate" href="https://www.php.net/fann-destroy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-descale-train.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-destroy-train.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-destroy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-destroy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-destroy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-destroy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-destroy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-destroy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-destroy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-destroy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-destroy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-destroy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-destroy.php" hreflang="zh">
...
<meta name="Description" content="Destroys the entire network and properly freeing all the associated memory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_destroy - Manual" />
<meta name="twitter:description" content="Destroys the entire network and properly freeing all the associated memory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_destroy - Manual" />
<meta itemprop="description" content="Destroys the entire network and properly freeing all the associated memory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Destroys the entire network and properly freeing all the associated memory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-destroy-train.php">
          fann_destroy_train &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-descale-train.php">
          &laquo; fann_descale_train        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-destroy.php' selected="selected">English</option>
            <option value='de/function.fann-destroy.php'>German</option>
            <option value='es/function.fann-destroy.php'>Spanish</option>
            <option value='fr/function.fann-destroy.php'>French</option>
            <option value='it/function.fann-destroy.php'>Italian</option>
            <option value='ja/function.fann-destroy.php'>Japanese</option>
            <option value='pt_BR/function.fann-destroy.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-destroy.php'>Russian</option>
            <option value='tr/function.fann-destroy.php'>Turkish</option>
            <option value='uk/function.fann-destroy.php'>Ukrainian</option>
            <option value='zh/function.fann-destroy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-destroy" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-destroy-returnvalues">
  ...
  <p class="para">Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-destroy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-destroy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-destroy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-destroy.php">＋<small>add a note</small></a></span>
