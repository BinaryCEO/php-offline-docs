...
<head>
  ...
  <title>PHP: curl_pause - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-pause.php">
 <link rel="shorturl" href="https://www.php.net/curl-pause">
 <link rel="alternate" href="https://www.php.net/curl-pause" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-multi-strerror.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-reset.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-pause.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-pause.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-pause.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-pause.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-pause.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-pause.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-pause.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-pause.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-pause.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-pause.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-pause.php" hreflang="zh">
...
<meta name="Description" content="Pause and unpause a connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_pause - Manual" />
<meta name="twitter:description" content="Pause and unpause a connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_pause - Manual" />
<meta itemprop="description" content="Pause and unpause a connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Pause and unpause a connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-pause.php' selected="selected">English</option>
            <option value='de/function.curl-pause.php'>German</option>
            <option value='es/function.curl-pause.php'>Spanish</option>
            <option value='fr/function.curl-pause.php'>French</option>
            <option value='it/function.curl-pause.php'>Italian</option>
            <option value='ja/function.curl-pause.php'>Japanese</option>
            <option value='pt_BR/function.curl-pause.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-pause.php'>Russian</option>
            <option value='tr/function.curl-pause.php'>Turkish</option>
            <option value='uk/function.curl-pause.php'>Ukrainian</option>
            <option value='zh/function.curl-pause.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-pause" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-pause.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-pause%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-pause&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-pause.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112815">  <div class="votes">
    <div id="Vu112815">
    <a href="/manual/vote-note.php?id=112815&amp;page=function.curl-pause&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112815">
    <a href="/manual/vote-note.php?id=112815&amp;page=function.curl-pause&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112815" title="40% like this...">
    -4
    </div>
  </div>
  <a href="#112815" class="name">
  <strong class="user"><em>Alex Autrey</em></strong></a><a class="genanchor" href="#112815"> &para;</a><div class="date" title="2013-07-26 12:01"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112815">
<div class="phpcode"><code><span class="html"><a href="http://curl.haxx.se/libcurl/c/curl_easy_pause.html" rel="nofollow" target="_blank">http://curl.haxx.se/libcurl/c/curl_easy_pause.html</a><br /><br />Using this function, you can explicitly mark a running connection to get paused, and you can unpause a connection that was previously paused.<br /><br />A connection can be paused by using this function or by letting the read or the write callbacks return the proper magic return code (CURL_READFUNC_PAUSE and CURL_WRITEFUNC_PAUSE). A write callback that returns pause signals to the library that it couldn't take care of any data at all, and that data will then be delivered again to the callback when the writing is later unpaused.<br /><br />NOTE: while it may feel tempting, take care and notice that you cannot call this function from another thread.<br /><br />When this function is called to unpause reading, the chance is high that you will get your write callback called before this function returns.<br /><br />The handle argument is of course identifying the handle that operates on the connection you want to pause or unpause.<br /><br />The bitmask argument is a set of bits that sets the new state of the connection. The following bits can be used:</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-pause&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-pause.php">＋<small>add a note</small></a></div>
