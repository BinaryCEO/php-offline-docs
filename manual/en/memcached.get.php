...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.get.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.get.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.get.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.flush.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getallkeys.php">
...
<meta name="Description" content="Retrieve an item" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::get - Manual" />
<meta name="twitter:description" content="Retrieve an item" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::get - Manual" />
<meta itemprop="description" content="Retrieve an item" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve an item" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.get.php' selected="selected">English</option>
            <option value='de/memcached.get.php'>German</option>
            <option value='es/memcached.get.php'>Spanish</option>
 ...
 <div class="refsect1 description" id="refsect1-memcached.get-description">
  ...
  <p class="para rdfs-comment">
   ...
   the <code class="parameter">get_flags</code> is given <strong><code><a href="memcached.constants.php#memcached.constants.get-extended">Memcached::GET_EXTENDED</a></code></strong>,
   it will also return the CAS token value for the item. See
   <span class="methodname"><a href="memcached.cas.php" class="methodname">Memcached::cas()</a></span> for how to use CAS tokens.
   <a href="memcached.callbacks.php" class="link">Read-through caching callback</a> may be
 ...
 <div class="refsect1 parameters" id="refsect1-memcached.get-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Flags to control the returned result. When <strong><code><a href="memcached.constants.php#memcached.constants.get-extended">Memcached::GET_EXTENDED</a></code></strong>
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.get-returnvalues">
  ...
  <p class="para">
   ...
   If the <code class="parameter">get_flags</code> is set to <strong><code><a href="memcached.constants.php#memcached.constants.get-extended">Memcached::GET_EXTENDED</a></code></strong>,
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$m </span><span style="color: #007700">= new </span><span style="color: #0000BB">Memcached</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addServer</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #0000BB">11211</span><span style="color: #007700">);<br /><br />if (!(</span><span style="color: #0000BB">$ip </span><span style="color: #007700">= </span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">get</span><span style="color: #007700">(</span><span style="color: #DD0000">'ip_block'</span><span style="color: #007700">))) {<br />    if (</span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getResultCode</span><span style="color: #007700">() == </span><span style="color: #0000BB">Memcached</span><span style="color: #007700">::</span><span style="color: #0000BB">RES_NOTFOUND</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$ip </span><span style="color: #007700">= array();<br />        </span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">set</span><span style="color: #007700">(</span><span style="color: #DD0000">'ip_block'</span><span style="color: #007700">, </span><span style="color: #0000BB">$ip</span><span style="color: #007700">);<br />    } else {<br />        </span><span style="color: #FF8000">/* log error */<br />        /* ...       */<br />    </span><span style="color: #007700">}<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.get-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.getbykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::getByKey()</a> - Retrieve an item from a specific server</span></li>
    ...
    <li><span class="methodname"><a href="memcached.getdelayed.php" class="methodname" rel="rdfs-seeAlso">Memcached::getDelayed()</a> - Request multiple items</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.get.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This method also returns false in case you set the value to false, so in order to have a proper fault mechanism in place you need to check the result code to be certain that a key really does not exist in memcached.<br /><br /><span class="default">&lt;?php<br />$Memcached </span><span class="keyword">= new </span><span class="default">Memcached</span><span class="keyword">();<br /></span><span class="default">$Memcached</span><span class="keyword">-&gt;</span><span class="default">addServer</span><span class="keyword">(</span><span class="string">'localhost'</span><span class="keyword">, </span><span class="default">11211</span><span class="keyword">);<br /></span><span class="default">$Memcached</span><span class="keyword">-&gt;</span><span class="default">set</span><span class="keyword">(</span><span class="string">'key'</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$Memcached</span><span class="keyword">-&gt;</span><span class="default">get</span><span class="keyword">(</span><span class="string">'key'</span><span class="keyword">));       </span><span class="comment">// boolean false<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$Memcached</span><span class="keyword">-&gt;</span><span class="default">getResultCode</span><span class="keyword">());  </span><span class="comment">// int 0 which is Memcached::RES_SUCCESS<br /></span><span class="default">?&gt;<br /></span><br />Or just make sure the values are not false :)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Note that this function can return NULL as FALSE, so don't make checks with === FALSE as with the old Memcache class, because it won't work. :O <br /><br />Use the not (!) operator and check the result code with getResultCode() as mentioned in the documentation :)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.get.php">＋<small>add a note</small></a></div>
