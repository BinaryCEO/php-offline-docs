...
<head>
  ...
  <title>PHP: Phar::compress - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.compress.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.compress.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.compress.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.canwrite.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.compressfiles.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.compress.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.compress.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.compress.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.compress.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.compress.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.compress.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.compress.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.compress.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.compress.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.compress.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.compress.php" hreflang="zh">
...
<meta name="Description" content="Compresses the entire Phar archive using Gzip or Bzip2 compression" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::compress - Manual" />
<meta name="twitter:description" content="Compresses the entire Phar archive using Gzip or Bzip2 compression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::compress - Manual" />
<meta itemprop="description" content="Compresses the entire Phar archive using Gzip or Bzip2 compression" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compresses the entire Phar archive using Gzip or Bzip2 compression" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.compressfiles.php">
          Phar::compressFiles &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.canwrite.php">
          &laquo; Phar::canWrite        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.compress.php' selected="selected">English</option>
            <option value='de/phar.compress.php'>German</option>
            <option value='es/phar.compress.php'>Spanish</option>
            <option value='fr/phar.compress.php'>French</option>
            <option value='it/phar.compress.php'>Italian</option>
            <option value='ja/phar.compress.php'>Japanese</option>
            <option value='pt_BR/phar.compress.php'>Brazilian Portuguese</option>
            <option value='ru/phar.compress.php'>Russian</option>
            <option value='tr/phar.compress.php'>Turkish</option>
            <option value='uk/phar.compress.php'>Ukrainian</option>
            <option value='zh/phar.compress.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.compress" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-phar.compress-examples">
  ...
  <p class="para">
   <div class="example" id="example-806">
    <p><strong>Example #1 A <span class="function"><strong>Phar::compress()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.decompressfiles.php" class="function" rel="rdfs-seeAlso">Phar::decompressFiles()</a> - Decompresses all files in the current Phar archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/compress.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.compress%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.compress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.compress.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102559">  <div class="votes">
    <div id="Vu102559">
    <a href="/manual/vote-note.php?id=102559&amp;page=phar.compress&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102559">
    <a href="/manual/vote-note.php?id=102559&amp;page=phar.compress&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102559" title="54% like this...">
    1
    </div>
  </div>
  <a href="#102559" class="name">
  <strong class="user"><em>mike at eyesis dot ca</em></strong></a><a class="genanchor" href="#102559"> &para;</a><div class="date" title="2011-02-21 11:50"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102559">
<div class="phpcode"><code><span class="html">For those who want the benefit of having a small compressed PHAR archive but don’t want to suffer the performance loss, use php_strip_whitespace when adding files to the archive. If your code has plenty of whitespace, docbocks, and single-line comments this function can greatly decrease archive size without the performance loss. <br /><br /><span class="default">&lt;?php<br />$sDir </span><span class="keyword">= </span><span class="string">'application'</span><span class="keyword">;<br /></span><span class="default">$oPhar </span><span class="keyword">= new </span><span class="default">Phar </span><span class="keyword">(</span><span class="string">'app.phar'</span><span class="keyword">);<br /><br /></span><span class="default">$oDir </span><span class="keyword">= new </span><span class="default">RecursiveIteratorIterator </span><span class="keyword">(new </span><span class="default">RecursiveDirectoryIterator </span><span class="keyword">(</span><span class="default">$sDir</span><span class="keyword">), </span><span class="default">RecursiveIteratorIterator</span><span class="keyword">::</span><span class="default">SELF_FIRST</span><span class="keyword">);<br /><br />foreach (</span><span class="default">$oDir </span><span class="keyword">as </span><span class="default">$sFile</span><span class="keyword">) {<br />    if ( </span><span class="default">preg_match </span><span class="keyword">(</span><span class="string">'/\\.php$/i'</span><span class="keyword">, </span><span class="default">$sFile</span><span class="keyword">) ) {<br />        </span><span class="default">$oPhar</span><span class="keyword">-&gt;</span><span class="default">addFromString </span><span class="keyword">(</span><span class="default">substr </span><span class="keyword">(</span><span class="default">$sFile</span><span class="keyword">, </span><span class="default">strlen </span><span class="keyword">(</span><span class="default">$sDir</span><span class="keyword">) + </span><span class="default">1</span><span class="keyword">), </span><span class="default">php_strip_whitespace </span><span class="keyword">(</span><span class="default">$sFile</span><span class="keyword">));<br />    }<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=phar.compress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.compress.php">＋<small>add a note</small></a></div>
