...
<head>
  ...
  <title>PHP: GmagickDraw::roundrectangle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagickdraw.roundrectangle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagickdraw.roundrectangle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagickdraw.roundrectangle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagickdraw.rotate.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagickdraw.scale.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagickdraw.roundrectangle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagickdraw.roundrectangle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagickdraw.roundrectangle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagickdraw.roundrectangle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagickdraw.roundrectangle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagickdraw.roundrectangle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagickdraw.roundrectangle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagickdraw.roundrectangle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagickdraw.roundrectangle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagickdraw.roundrectangle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagickdraw.roundrectangle.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: GmagickDraw::roundrectangle - Manual" />
<meta name="twitter:description" content="Draws a rounded rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GmagickDraw::roundrectangle - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagickdraw.scale.php">
          GmagickDraw::scale &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagickdraw.rotate.php">
          &laquo; GmagickDraw::rotate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagickdraw.roundrectangle.php' selected="selected">English</option>
            <option value='de/gmagickdraw.roundrectangle.php'>German</option>
            <option value='es/gmagickdraw.roundrectangle.php'>Spanish</option>
            <option value='fr/gmagickdraw.roundrectangle.php'>French</option>
            <option value='it/gmagickdraw.roundrectangle.php'>Italian</option>
            <option value='ja/gmagickdraw.roundrectangle.php'>Japanese</option>
            <option value='pt_BR/gmagickdraw.roundrectangle.php'>Brazilian Portuguese</option>
            <option value='ru/gmagickdraw.roundrectangle.php'>Russian</option>
            <option value='tr/gmagickdraw.roundrectangle.php'>Turkish</option>
            <option value='uk/gmagickdraw.roundrectangle.php'>Ukrainian</option>
            <option value='zh/gmagickdraw.roundrectangle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagickdraw.roundrectangle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GmagickDraw::roundrectangle</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">GmagickDraw::roundrectangle</span> &mdash; <span class="dc-title">Draws a rounded rectangle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagickdraw.roundrectangle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GmagickDraw::roundrectangle</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y1</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$rx</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ry</code></span><br>): <span class="type"><a href="class.gmagickdraw.php" class="type GmagickDraw">GmagickDraw</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagickdraw.roundrectangle-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagickdraw.roundrectangle-returnvalues">
  ...
  <p class="para">
   The <span class="classname"><a href="class.gmagickdraw.php" class="classname">GmagickDraw</a></span> object.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagickdraw/roundrectangle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagickdraw.roundrectangle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagickdraw.roundrectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagickdraw.roundrectangle.php">＋<small>add a note</small></a></span>
