...
<head>
  ...
  <title>PHP: eio_dup2 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-dup2.php">
 <link rel="shorturl" href="https://www.php.net/eio-dup2">
 <link rel="alternate" href="https://www.php.net/eio-dup2" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-custom.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-event-loop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-dup2.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-dup2.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-dup2.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-dup2.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-dup2.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-dup2.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-dup2.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-dup2.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-dup2.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-dup2.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-dup2.php" hreflang="zh">
...
<meta name="Description" content="Duplicate a file descriptor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_dup2 - Manual" />
<meta name="twitter:description" content="Duplicate a file descriptor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_dup2 - Manual" />
<meta itemprop="description" content="Duplicate a file descriptor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Duplicate a file descriptor" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.eio-event-loop.php">
          eio_event_loop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-custom.php">
          &laquo; eio_custom        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-dup2.php' selected="selected">English</option>
            <option value='de/function.eio-dup2.php'>German</option>
            <option value='es/function.eio-dup2.php'>Spanish</option>
            <option value='fr/function.eio-dup2.php'>French</option>
            <option value='it/function.eio-dup2.php'>Italian</option>
            <option value='ja/function.eio-dup2.php'>Japanese</option>
            <option value='pt_BR/function.eio-dup2.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-dup2.php'>Russian</option>
            <option value='tr/function.eio-dup2.php'>Turkish</option>
            <option value='uk/function.eio-dup2.php'>Ukrainian</option>
            <option value='zh/function.eio-dup2.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-dup2" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_dup2</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_dup2</span> &mdash; <span class="dc-title">Duplicate a file descriptor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-dup2-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_dup2</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$fd2</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_dup2()</strong></span> duplicates file descriptor.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-dup2-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">fd2</code></dt>
    <dd>
     <p class="para">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-dup2-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><strong>eio_dup2()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-dup2.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-dup2%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-dup2&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-dup2.php">＋<small>add a note</small></a></span>
