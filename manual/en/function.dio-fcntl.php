...
<head>
  ...
  <title>PHP: dio_fcntl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dio-fcntl.php">
 <link rel="shorturl" href="https://www.php.net/dio-fcntl">
 <link rel="alternate" href="https://www.php.net/dio-fcntl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dio-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dio-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dio-fcntl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dio-fcntl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dio-fcntl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dio-fcntl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dio-fcntl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dio-fcntl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dio-fcntl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dio-fcntl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dio-fcntl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dio-fcntl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dio-fcntl.php" hreflang="zh">
...
<meta name="Description" content="Performs a c library fcntl on fd" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dio_fcntl - Manual" />
<meta name="twitter:description" content="Performs a c library fcntl on fd" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dio_fcntl - Manual" />
<meta itemprop="description" content="Performs a c library fcntl on fd" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs a c library fcntl on fd" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dio-fcntl.php' selected="selected">English</option>
            <option value='de/function.dio-fcntl.php'>German</option>
            <option value='es/function.dio-fcntl.php'>Spanish</option>
            <option value='fr/function.dio-fcntl.php'>French</option>
            <option value='it/function.dio-fcntl.php'>Italian</option>
            <option value='ja/function.dio-fcntl.php'>Japanese</option>
            <option value='pt_BR/function.dio-fcntl.php'>Brazilian Portuguese</option>
            <option value='ru/function.dio-fcntl.php'>Russian</option>
            <option value='tr/function.dio-fcntl.php'>Turkish</option>
            <option value='uk/function.dio-fcntl.php'>Ukrainian</option>
            <option value='zh/function.dio-fcntl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dio-fcntl" class="refentry">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <ul class="itemizedlist">
        <li class="listitem">
         <p class="para">
          <strong><code><a href="dio.constants.php#constant.f-setlk">F_SETLK</a></code></strong> - Lock is set or cleared. If the lock
        ...
        <li class="listitem">
         <p class="para">
          <strong><code><a href="dio.constants.php#constant.f-setlkw">F_SETLKW</a></code></strong> - like <strong><code><a href="dio.constants.php#constant.f-setlk">F_SETLK</a></code></strong>,
        ...
        <li class="listitem">
         <p class="para">
          <strong><code><a href="dio.constants.php#constant.f-getlk">F_GETLK</a></code></strong> - <span class="function"><strong>dio_fcntl()</strong></span> 
          ...
          to <strong><code><a href="dio.constants.php#constant.f-unlck">F_UNLCK</a></code></strong>.
         </p>
        </li>
        <li class="listitem">
         <p class="para">
          <strong><code><a href="dio.constants.php#constant.f-dupfd">F_DUPFD</a></code></strong> - finds the lowest numbered available
        ...
        <li class="listitem">
         <p class="para">
          <strong><code><a href="dio.constants.php#constant.f-setfl">F_SETFL</a></code></strong> - Sets the file descriptors flags to 
          the value specified by <code class="parameter">args</code>, which can be
          <strong><code><a href="dio.constants.php#constant.o-append">O_APPEND</a></code></strong>, <strong><code><a href="dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></code></strong> or 
          <strong><code><a href="dio.constants.php#constant.o-async">O_ASYNC</a></code></strong>. To use <strong><code><a href="dio.constants.php#constant.o-async">O_ASYNC</a></code></strong> 
          you will need to use the <a href="ref.pcntl.php" class="link">PCNTL</a> 
          extension.
         </p>
        </li>
       </ul>
     ...
     <dd>
      <p class="para">
       ...
       <code class="parameter">cmd</code> is <strong><code><a href="dio.constants.php#constant.f-setlk">F_SETLK</a></code></strong> or
       ...
       <ul class="itemizedlist">
        ...
        <li class="listitem">
         <p class="para">
          ...
          <strong><code><a href="filesystem.constants.php#constant.seek-end">SEEK_END</a></code></strong> and <strong><code><a href="filesystem.constants.php#constant.seek-cur">SEEK_CUR</a></code></strong>
         </p>
        </li>
        <li class="listitem">
         <p class="para">
          <code class="literal">type</code> - type of lock: can be
          <strong><code><a href="dio.constants.php#constant.f-rdlck">F_RDLCK</a></code></strong> (read lock),
          <strong><code><a href="dio.constants.php#constant.f-wrlck">F_WRLCK</a></code></strong> (write lock) or
          <strong><code><a href="dio.constants.php#constant.f-unlck">F_UNLCK</a></code></strong> (unlock)
         </p>
        </li>
       </ul>
      </p>
...
implemented on Windows platforms.</span></p></blockquote>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dio/functions/dio-fcntl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dio-fcntl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dio-fcntl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dio-fcntl.php">＋<small>add a note</small></a></span>
