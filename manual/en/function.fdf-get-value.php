...
<head>
  ...
  <title>PHP: fdf_get_value - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-get-value.php">
 <link rel="shorturl" href="https://www.php.net/fdf-get-value">
 <link rel="alternate" href="https://www.php.net/fdf-get-value" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-get-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-get-version.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-get-value.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-get-value.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-get-value.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-get-value.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-get-value.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-get-value.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-get-value.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-get-value.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-get-value.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-get-value.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-get-value.php" hreflang="zh">
...
<meta name="Description" content="Get the value of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_get_value - Manual" />
<meta name="twitter:description" content="Get the value of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_get_value - Manual" />
<meta itemprop="description" content="Get the value of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the value of a field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fdf-get-version.php">
          fdf_get_version &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fdf-get-status.php">
          &laquo; fdf_get_status        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-get-value.php' selected="selected">English</option>
            <option value='de/function.fdf-get-value.php'>German</option>
            <option value='es/function.fdf-get-value.php'>Spanish</option>
            <option value='fr/function.fdf-get-value.php'>French</option>
            <option value='it/function.fdf-get-value.php'>Italian</option>
            <option value='ja/function.fdf-get-value.php'>Japanese</option>
            <option value='pt_BR/function.fdf-get-value.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-get-value.php'>Russian</option>
            <option value='tr/function.fdf-get-value.php'>Turkish</option>
            <option value='uk/function.fdf-get-value.php'>Ukrainian</option>
            <option value='zh/function.fdf-get-value.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-get-value" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_get_value</h1>
  <p class="verinfo">(PHP 4, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_get_value</span> &mdash; <span class="dc-title">Get the value of a field</span></p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fdf-get-value-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fdf-set-value.php" class="function" rel="rdfs-seeAlso">fdf_set_value()</a> - Set the value of a field</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-get-value.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-get-value%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-get-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-get-value.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="25271">  <div class="votes">
    <div id="Vu25271">
    <a href="/manual/vote-note.php?id=25271&amp;page=function.fdf-get-value&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd25271">
    <a href="/manual/vote-note.php?id=25271&amp;page=function.fdf-get-value&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V25271" title="no votes...">
    0
    </div>
  </div>
  <a href="#25271" class="name">
  <strong class="user"><em>mclinden at informed dot net</em></strong></a><a class="genanchor" href="#25271"> &para;</a><div class="date" title="2002-09-17 02:35"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom25271">
<div class="phpcode"><code><span class="html">(i filed a bug report/feature request for this on bugs.php.net and assigned it to myself hartmut@php.net)
<br />
<br />The default behavior for the FDF Toolkit is to return an FDFErcNoValue for the FDFGetValue when the field exists but has no value.
<br />
<br />Whether or not this is truly an error is debateable. It seems to become an issue in documents created by Acrobat 5 when optional fields are included in a form with required fields since the default behavior seems to be to populate the HTTP_FDF_DATA with the results of the FDFNextFieldName enumerator, which would include the fields which have no value.
<br />
<br />This would not be a problem except that the PHP function fdf_get_value() does not specifically test for the FDFErcNoValue condition but, instead, tests for the more general FDFErcOK. If this value is not the result of the error code, the system issues warnings (the display of which could be turned off), but the broader question is, should this be a warning condition at all?
<br />
<br />Put another way, should a return of FDFErcNoValue for FDFGetValue be considered an event worth generating a warning?</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fdf-get-value&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-get-value.php">＋<small>add a note</small></a></div>
