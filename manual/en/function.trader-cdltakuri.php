...
<head>
  ...
  <title>PHP: trader_cdltakuri - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cdltakuri.php">
 <link rel="shorturl" href="https://www.php.net/trader-cdltakuri">
 <link rel="alternate" href="https://www.php.net/trader-cdltakuri" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cdlsticksandwich.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cdltasukigap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cdltakuri.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cdltakuri.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cdltakuri.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cdltakuri.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cdltakuri.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cdltakuri.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cdltakuri.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cdltakuri.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cdltakuri.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cdltakuri.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cdltakuri.php" hreflang="zh">
...
<meta name="Description" content="Takuri (Dragonfly Doji with very long lower shadow)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cdltakuri - Manual" />
<meta name="twitter:description" content="Takuri (Dragonfly Doji with very long lower shadow)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cdltakuri - Manual" />
<meta itemprop="description" content="Takuri (Dragonfly Doji with very long lower shadow)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Takuri (Dragonfly Doji with very long lower shadow)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-cdltasukigap.php">
          trader_cdltasukigap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-cdlsticksandwich.php">
          &laquo; trader_cdlsticksandwich        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cdltakuri.php' selected="selected">English</option>
            <option value='de/function.trader-cdltakuri.php'>German</option>
            <option value='es/function.trader-cdltakuri.php'>Spanish</option>
            <option value='fr/function.trader-cdltakuri.php'>French</option>
            <option value='it/function.trader-cdltakuri.php'>Italian</option>
            <option value='ja/function.trader-cdltakuri.php'>Japanese</option>
            <option value='pt_BR/function.trader-cdltakuri.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cdltakuri.php'>Russian</option>
            <option value='tr/function.trader-cdltakuri.php'>Turkish</option>
            <option value='uk/function.trader-cdltakuri.php'>Ukrainian</option>
            <option value='zh/function.trader-cdltakuri.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cdltakuri" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cdltakuri</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cdltakuri</span> &mdash; <span class="dc-title">Takuri (Dragonfly Doji with very long lower shadow)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cdltakuri-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cdltakuri</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cdltakuri-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cdltakuri-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cdltakuri.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cdltakuri%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cdltakuri&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cdltakuri.php">＋<small>add a note</small></a></span>
