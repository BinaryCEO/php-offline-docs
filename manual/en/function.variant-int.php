...
<head>
  ...
  <title>PHP: variant_int - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-int.php">
 <link rel="shorturl" href="https://www.php.net/variant-int">
 <link rel="alternate" href="https://www.php.net/variant-int" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-imp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-mod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-int.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-int.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-int.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-int.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-int.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-int.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-int.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-int.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-int.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-int.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-int.php" hreflang="zh">
...
<meta name="Description" content="Returns the integer portion of a variant" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_int - Manual" />
<meta name="twitter:description" content="Returns the integer portion of a variant" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_int - Manual" />
<meta itemprop="description" content="Returns the integer portion of a variant" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the integer portion of a variant" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-mod.php">
          variant_mod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.variant-imp.php">
          &laquo; variant_imp        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-int.php' selected="selected">English</option>
            <option value='de/function.variant-int.php'>German</option>
            <option value='es/function.variant-int.php'>Spanish</option>
            <option value='fr/function.variant-int.php'>French</option>
            <option value='it/function.variant-int.php'>Italian</option>
            <option value='ja/function.variant-int.php'>Japanese</option>
            <option value='pt_BR/function.variant-int.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-int.php'>Russian</option>
            <option value='tr/function.variant-int.php'>Turkish</option>
            <option value='uk/function.variant-int.php'>Ukrainian</option>
            <option value='zh/function.variant-int.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-int" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_int</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_int</span> &mdash; <span class="dc-title">Returns the integer portion of a variant</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.variant-int-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>variant_int</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.variant.php" class="type variant">variant</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.variant-int-parameters">
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.variant-int-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-function.variant-int-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-function.variant-int-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-fix.php" class="function" rel="rdfs-seeAlso">variant_fix()</a> - Returns the integer portion of a variant</span></li>
    ...
    <li><span class="function"><a href="function.round.php" class="function" rel="rdfs-seeAlso">round()</a> - Rounds a float</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-int.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-int%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-int&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-int.php">＋<small>add a note</small></a></span>
