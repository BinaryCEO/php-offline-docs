...
<head>
  ...
  <title>PHP: GearmanClient::echo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.echo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.echo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.echo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.dostatus.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.echo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.echo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.echo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.echo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.echo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.echo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.echo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.echo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.echo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.echo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.echo.php" hreflang="zh">
...
<meta name="Description" content="Send data to all job servers to see if they echo it back [deprecated]" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::echo - Manual" />
<meta name="twitter:description" content="Send data to all job servers to see if they echo it back [deprecated]" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::echo - Manual" />
<meta itemprop="description" content="Send data to all job servers to see if they echo it back [deprecated]" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send data to all job servers to see if they echo it back [deprecated]" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.error.php">
          GearmanClient::error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.dostatus.php">
          &laquo; GearmanClient::doStatus        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.echo.php' selected="selected">English</option>
            <option value='de/gearmanclient.echo.php'>German</option>
            <option value='es/gearmanclient.echo.php'>Spanish</option>
            <option value='fr/gearmanclient.echo.php'>French</option>
            <option value='it/gearmanclient.echo.php'>Italian</option>
            <option value='ja/gearmanclient.echo.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.echo.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.echo.php'>Russian</option>
            <option value='tr/gearmanclient.echo.php'>Turkish</option>
            <option value='uk/gearmanclient.echo.php'>Ukrainian</option>
            <option value='zh/gearmanclient.echo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.echo" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/echo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.echo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.echo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.echo.php">＋<small>add a note</small></a></span>
