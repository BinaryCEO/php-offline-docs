...
<head>
  ...
  <title>PHP: fann_set_train_error_function - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-train-error-function.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-train-error-function">
 <link rel="alternate" href="https://www.php.net/fann-set-train-error-function" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-scaling-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-train-stop-function.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-train-error-function.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-train-error-function.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-train-error-function.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-train-error-function.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-train-error-function.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-train-error-function.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-train-error-function.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-train-error-function.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-train-error-function.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-train-error-function.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-train-error-function.php" hreflang="zh">
...
<meta name="Description" content="Sets the error function used during training" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_train_error_function - Manual" />
<meta name="twitter:description" content="Sets the error function used during training" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_train_error_function - Manual" />
<meta itemprop="description" content="Sets the error function used during training" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the error function used during training" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-set-train-stop-function.php">
          fann_set_train_stop_function &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-scaling-params.php">
          &laquo; fann_set_scaling_params        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-train-error-function.php' selected="selected">English</option>
            <option value='de/function.fann-set-train-error-function.php'>German</option>
            <option value='es/function.fann-set-train-error-function.php'>Spanish</option>
            <option value='fr/function.fann-set-train-error-function.php'>French</option>
            <option value='it/function.fann-set-train-error-function.php'>Italian</option>
            <option value='ja/function.fann-set-train-error-function.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-train-error-function.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-train-error-function.php'>Russian</option>
            <option value='tr/function.fann-set-train-error-function.php'>Turkish</option>
            <option value='uk/function.fann-set-train-error-function.php'>Ukrainian</option>
            <option value='zh/function.fann-set-train-error-function.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-train-error-function" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_train_error_function</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_train_error_function</span> &mdash; <span class="dc-title">Sets the error function used during training</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-train-error-function-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_train_error_function</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$error_function</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-train-error-function-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">error_function</code></dt>
    <dd>
     <p class="para">
      The <a href="fann.constants.php#constants.fann-errorfunc" class="link">error function</a> constant
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-train-error-function-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-train-error-function-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-train-error-function.php" class="function" rel="rdfs-seeAlso">fann_get_train_error_function()</a> - Returns the error function used during training</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-train-error-function.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-train-error-function%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-train-error-function&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-train-error-function.php">＋<small>add a note</small></a></span>
