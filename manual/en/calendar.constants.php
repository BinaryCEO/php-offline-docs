...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/calendar.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/calendar.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/calendar.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.calendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/calendar.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.calendar.php">

 <link rel="alternate" href="https://www.php.net/manual/en/calendar.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/calendar.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/calendar.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/calendar.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/calendar.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/calendar.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/calendar.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/calendar.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/calendar.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/calendar.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/calendar.constants.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ref.calendar.php">
          Calendar Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="calendar.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/calendar.constants.php' selected="selected">English</option>
            <option value='de/calendar.constants.php'>German</option>
            <option value='es/calendar.constants.php'>Spanish</option>
            <option value='fr/calendar.constants.php'>French</option>
            <option value='it/calendar.constants.php'>Italian</option>
            <option value='ja/calendar.constants.php'>Japanese</option>
            <option value='pt_BR/calendar.constants.php'>Brazilian Portuguese</option>
            <option value='ru/calendar.constants.php'>Russian</option>
            <option value='tr/calendar.constants.php'>Turkish</option>
            <option value='uk/calendar.constants.php'>Ukrainian</option>
            <option value='zh/calendar.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="calendar.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/calendar/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcalendar.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=calendar.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/calendar.constants.php">＋<small>add a note</small></a></span>
