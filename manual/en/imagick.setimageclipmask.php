...
<head>
  ...
  <title>PHP: Imagick::setImageClipMask - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageclipmask.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageclipmask.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageclipmask.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagecolormapcolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageclipmask.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageclipmask.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageclipmask.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageclipmask.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageclipmask.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageclipmask.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageclipmask.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageclipmask.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageclipmask.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageclipmask.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageclipmask.php" hreflang="zh">
...
<meta name="Description" content="Sets image clip mask" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageClipMask - Manual" />
<meta name="twitter:description" content="Sets image clip mask" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageClipMask - Manual" />
<meta itemprop="description" content="Sets image clip mask" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets image clip mask" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagecolormapcolor.php">
          Imagick::setImageColormapColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagechanneldepth.php">
          &laquo; Imagick::setImageChannelDepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageclipmask.php' selected="selected">English</option>
            <option value='de/imagick.setimageclipmask.php'>German</option>
            <option value='es/imagick.setimageclipmask.php'>Spanish</option>
            <option value='fr/imagick.setimageclipmask.php'>French</option>
            <option value='it/imagick.setimageclipmask.php'>Italian</option>
            <option value='ja/imagick.setimageclipmask.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageclipmask.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageclipmask.php'>Russian</option>
            <option value='tr/imagick.setimageclipmask.php'>Turkish</option>
            <option value='uk/imagick.setimageclipmask.php'>Ukrainian</option>
            <option value='zh/imagick.setimageclipmask.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageclipmask" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageClipMask</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageClipMask</span> &mdash; <span class="dc-title">Sets image clip mask</span></p>

 </div>

 <div id="imagick.setimageclipmask-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimageclipmask-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageClipMask</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$clip_mask</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageclipmask-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">clip_mask</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageclipmask-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageclipmask-errors">
  ...
  <p class="para">
    <div class="example" id="example-3094">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageclipmask.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageclipmask%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageclipmask&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageclipmask.php">＋<small>add a note</small></a></span>
