...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-escape-string.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-escape-literal.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-execute.php">
...
<meta name="Description" content="Escape a string for query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_escape_string - Manual" />
<meta name="twitter:description" content="Escape a string for query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_escape_string - Manual" />
<meta itemprop="description" content="Escape a string for query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Escape a string for query" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-escape-string.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.pg-escape-string.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-escape-bytea.php" class="function" rel="rdfs-seeAlso">pg_escape_bytea()</a> - Escape a string for insertion into a bytea field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-escape-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-escape-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-escape-string.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Forthose curious, the exact escaping performed on the string may vary slightly depending on your database configuration.<br /><br />For example, if your database's standard_conforming_strings variable is OFF, backslashes are treated as a special character and pg_escape_string() will ensure they are properly escaped.  If this variable is ON, backslashes will be treated as ordinary characters, and pg_escape_string() will leave them as-is.  In either case, the behavior matches the configuration of the database connection.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">You should prefer to use pg_query_params, i.e. use parameterized queries, rather than using pg_escape_string. Or use the newer PDO interface with its parameterized query support.<br /><br />If you must substitute values directly, e.g. in DDL commands that don't support execution as parameterized queries, do so with pg_escape_literal:<br /><br /><a href="http://au1.php.net/manual/en/function.pg-escape-literal.php" rel="nofollow" target="_blank">http://au1.php.net/manual/en/function.pg-escape-literal.php</a><br /><br />Identifiers can't be used as query parameters. Always use pg_escape_identifier for these if they're substituted dynamically:<br /><br /><a href="http://au1.php.net/manual/en/function.pg-escape-identifier.php" rel="nofollow" target="_blank">http://au1.php.net/manual/en/function.pg-escape-identifier.php</a><br /><br />You should not need to change text encodings when using this function. Make sure your connection's client_encoding is set to the text encoding used by PHP, and the PostgreSQL client driver will take care of text encodings for you. No explicit utf-8 conversions should be necessary with a correctly set  client_encoding.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If your database is a UTF-8 database, you will run into problems trying to add some data into your database...
<br />
<br />for securty issues and/or compatability you may need to use the: utf_encode() (<a href="http://php.net/utf8-encode" rel="nofollow" target="_blank">http://php.net/utf8-encode</a>) function.
<br />
<br />for example:
<br /><span class="default">&lt;?php
<br />$my_data </span><span class="keyword">= </span><span class="default">pg_escape_string</span><span class="keyword">(</span><span class="default">utf8_encode</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'my_data'</span><span class="keyword">]));
...
<div class="phpcode"><code><span class="html">For those who escape their single quotes with a backslash (ie \') instead of two single quotes in a row (ie '') there has recently been a SERIOUS sql injection vulnerability that can be employed taking advantage of your chosen escaping method.  More info here: <a href="http://www.postgresql.org/docs/techdocs.50" rel="nofollow" target="_blank">http://www.postgresql.org/docs/techdocs.50</a><br />Even after the postgre update, you may still be limited to what you can do with your queries if you still insist on backslash escaping. It's a lesson to always use the PHP functions to do proper escaping instead of adhoc addslashes or magic quotes escaping.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Since php 5.1 the new function pg_query_params() was introduced. With this function you can use bind variables and don't have to escape strings. If you can use it, do so. If unsure why, check the changelog for Postgres 8.0.8.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Creating a double-tick is just fine. It works the same as the backslash-tick syntax. From the PostgreSQL docs:<br /><br />The fact that string constants are bound by single quotes presents an obvious semantic problem, however, in that if the sequence itself contains a single quote, the literal bounds of the constant are made ambiguous. To escape (make literal) a single quote within the string, you may type two adjacent single quotes. The parser will interpret the two adjacent single quotes within the string constant as a single, literal single quote. PostgreSQL will also allow single quotes to be embedded by using a C-style backslash.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">pg_escape_string() won't cast array arguments to the "Array" string like php usually does; it returns NULL instead. The following statements all evaluate to true:<br /><br /><span class="default">&lt;?php<br />$a </span><span class="keyword">= array(</span><span class="string">'foo'</span><span class="keyword">, </span><span class="string">'bar'</span><span class="keyword">);<br /><br /></span><span class="string">"</span><span class="default">$a</span><span class="string">" </span><span class="keyword">== </span><span class="string">'Array'</span><span class="keyword">;<br />(string)</span><span class="default">$a </span><span class="keyword">== </span><span class="string">'Array'</span><span class="keyword">;<br /></span><span class="default">$a </span><span class="keyword">. </span><span class="string">'' </span><span class="keyword">== </span><span class="string">'Array'</span><span class="keyword">;<br /><br /></span><span class="default">is_null</span><span class="keyword">(</span><span class="default">pg_escape_string</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">));<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-escape-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-escape-string.php">＋<small>add a note</small></a></div>
