...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlnd.install.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlnd.install.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.install.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqlnd.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlnd.overview.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlnd.config.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.install.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlnd.install.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlnd.install.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlnd.install.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlnd.install.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlnd.install.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlnd.install.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlnd.install.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlnd.install.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlnd.install.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlnd.install.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlnd.install.php' selected="selected">English</option>
            <option value='de/mysqlnd.install.php'>German</option>
            <option value='es/mysqlnd.install.php'>Spanish</option>
            <option value='fr/mysqlnd.install.php'>French</option>
            <option value='it/mysqlnd.install.php'>Italian</option>
            <option value='ja/mysqlnd.install.php'>Japanese</option>
            <option value='pt_BR/mysqlnd.install.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlnd.install.php'>Russian</option>
            <option value='tr/mysqlnd.install.php'>Turkish</option>
            <option value='uk/mysqlnd.install.php'>Ukrainian</option>
            <option value='zh/mysqlnd.install.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlnd.install" class="chapter">
   ...
   <table class="doctable informaltable">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqlnd/install.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlnd.install%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlnd.install&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlnd.install.php">＋<small>add a note</small></a></span>
