...
<head>
  ...
  <title>PHP: xdiff_file_diff_binary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xdiff-file-diff-binary.php">
 <link rel="shorturl" href="https://www.php.net/xdiff-file-diff-binary">
 <link rel="alternate" href="https://www.php.net/xdiff-file-diff-binary" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xdiff.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xdiff-file-diff.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xdiff-file-merge3.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xdiff-file-diff-binary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xdiff-file-diff-binary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xdiff-file-diff-binary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xdiff-file-diff-binary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xdiff-file-diff-binary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xdiff-file-diff-binary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xdiff-file-diff-binary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xdiff-file-diff-binary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xdiff-file-diff-binary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xdiff-file-diff-binary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xdiff-file-diff-binary.php" hreflang="zh">
...
<meta name="Description" content="Alias of xdiff_file_bdiff" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xdiff_file_diff_binary - Manual" />
<meta name="twitter:description" content="Alias of xdiff_file_bdiff" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xdiff_file_diff_binary - Manual" />
<meta itemprop="description" content="Alias of xdiff_file_bdiff" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of xdiff_file_bdiff" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.xdiff-file-merge3.php">
          xdiff_file_merge3 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xdiff-file-diff.php">
          &laquo; xdiff_file_diff        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xdiff-file-diff-binary.php' selected="selected">English</option>
            <option value='de/function.xdiff-file-diff-binary.php'>German</option>
            <option value='es/function.xdiff-file-diff-binary.php'>Spanish</option>
            <option value='fr/function.xdiff-file-diff-binary.php'>French</option>
            <option value='it/function.xdiff-file-diff-binary.php'>Italian</option>
            <option value='ja/function.xdiff-file-diff-binary.php'>Japanese</option>
            <option value='pt_BR/function.xdiff-file-diff-binary.php'>Brazilian Portuguese</option>
            <option value='ru/function.xdiff-file-diff-binary.php'>Russian</option>
            <option value='tr/function.xdiff-file-diff-binary.php'>Turkish</option>
            <option value='uk/function.xdiff-file-diff-binary.php'>Ukrainian</option>
            <option value='zh/function.xdiff-file-diff-binary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xdiff-file-diff-binary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">xdiff_file_diff_binary</h1>
  <p class="verinfo">(PECL xdiff &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">xdiff_file_diff_binary</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.xdiff-file-bdiff.php" class="function">xdiff_file_bdiff()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.xdiff-file-diff-binary-description">
  ...
  <p class="para rdfs-comment">
   ...
   file can be later applied using <span class="function"><a href="function.xdiff-file-bpatch.php" class="function">xdiff_file_bpatch()</a></span>.
  </p>
  <p class="para">
   Starting with version 1.5.0 this function is an alias of <span class="function"><a href="function.xdiff-file-bdiff.php" class="function">xdiff_file_bdiff()</a></span>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.xdiff-file-diff-binary-examples">
  ...
  <p class="para">
   <div class="example" id="example-2442">
    <p><strong>Example #1 <span class="function"><strong>xdiff_file_diff_binary()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.xdiff-file-bpatch.php" class="function" rel="rdfs-seeAlso">xdiff_file_bpatch()</a> - Patch a file with a binary diff</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xdiff/functions/xdiff-file-diff-binary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xdiff-file-diff-binary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xdiff-file-diff-binary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xdiff-file-diff-binary.php">＋<small>add a note</small></a></span>
