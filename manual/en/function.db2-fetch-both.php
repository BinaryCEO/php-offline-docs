...
<head>
  ...
  <title>PHP: db2_fetch_both - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-fetch-both.php">
 <link rel="shorturl" href="https://www.php.net/db2-fetch-both">
 <link rel="alternate" href="https://www.php.net/db2-fetch-both" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-fetch-assoc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-fetch-object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-fetch-both.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-fetch-both.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-fetch-both.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-fetch-both.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-fetch-both.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-fetch-both.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-fetch-both.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-fetch-both.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-fetch-both.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-fetch-both.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-fetch-both.php" hreflang="zh">
...
<meta name="Description" content="Returns an array, indexed by both column name and position, representing a row in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_fetch_both - Manual" />
<meta name="twitter:description" content="Returns an array, indexed by both column name and position, representing a row in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_fetch_both - Manual" />
<meta itemprop="description" content="Returns an array, indexed by both column name and position, representing a row in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array, indexed by both column name and position, representing a row in a result set" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-fetch-object.php">
          db2_fetch_object &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-fetch-assoc.php">
          &laquo; db2_fetch_assoc        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-fetch-both.php' selected="selected">English</option>
            <option value='de/function.db2-fetch-both.php'>German</option>
            <option value='es/function.db2-fetch-both.php'>Spanish</option>
            <option value='fr/function.db2-fetch-both.php'>French</option>
            <option value='it/function.db2-fetch-both.php'>Italian</option>
            <option value='ja/function.db2-fetch-both.php'>Japanese</option>
            <option value='pt_BR/function.db2-fetch-both.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-fetch-both.php'>Russian</option>
            <option value='tr/function.db2-fetch-both.php'>Turkish</option>
            <option value='uk/function.db2-fetch-both.php'>Ukrainian</option>
            <option value='zh/function.db2-fetch-both.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-fetch-both" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.db2-fetch-both-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_fetch_both</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$row_number</code><span class="initializer"> = -1</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-fetch-both-returnvalues">
  ...
  <p class="para">
   ...
   requested row in the result set. Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there are no rows left
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-result.php" class="function" rel="rdfs-seeAlso">db2_result()</a> - Returns a single column from a row in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-fetch-both.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-fetch-both%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-fetch-both&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-fetch-both.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="83637">  <div class="votes">
    <div id="Vu83637">
    <a href="/manual/vote-note.php?id=83637&amp;page=function.db2-fetch-both&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83637">
    <a href="/manual/vote-note.php?id=83637&amp;page=function.db2-fetch-both&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83637" title="50% like this...">
    0
    </div>
  </div>
  <a href="#83637" class="name">
  <strong class="user"><em>eacosta at openware dot biz</em></strong></a><a class="genanchor" href="#83637"> &para;</a><div class="date" title="2008-06-05 08:55"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83637">
<div class="phpcode"><code><span class="html">Hello,<br /><br />Some weeks ago I faced difficulties with walk a big number of <br />records from a result set.<br /><br />I was using the function db2_fetch_both in a method of a database adapter<br />class to retrieve just one record at a time. The total number of records<br />were: 5647 and when I reach record number 1600 the function crashed<br />generating the below message in "Actual result" field.<br /><br />I am copying table's description next:<br /><br />TMP_TABLE<br />-----------------------------------------------------------------<br />| ID        | TYPE        | SIZE        | NULL        |<br />-----------------------------------------------------------------<br />| ID        | INTEGER    | 4        | NO        |<br />| SERVICE    | VARCHAR    | 30        | NO        |<br />| ID_v        | VARCHAR    | 30        | NO        |<br />| INFORMATION    | CLOB        | 65536        | YES        |<br />| EXP_LEVEL    | INTEGER    | 4        | NO        |<br />| IP4B        | BIGINT    | 8        | NO        |<br />| MODIFIED    | INTEGER    | 4        | YES        |<br />| DETAIL    | VARCHAR    | 200        | YES        |<br />| FALSPOS    | INTEGER    | 4        | YES        |<br />-----------------------------------------------------------------<br /><br />When it crashed I received this message from db2_fetch_both<br /><br />db2_fetch_array() [function.db2-fetch-array]: Fetch Failure<br /><br />After reported this message to IBM OpenDev I was helped by a OpenDev IBMer who noticed me <br />that it wasn't a ibm_db2 module problem, in fact it was a database configuration <br />issue. The OpenDev IBMer looked into my DB2 Client CLI TRACE files and found out what was happen.<br />So I had to modify APP_CTL_HEAP_SZ and everything seems to works fine now.<br /><br />-- <br />Esteban Acosta Villafañe<br />Area I+D<br /><a href="http://www.openware.biz/opendev" rel="nofollow" target="_blank">http://www.openware.biz/opendev</a><br />Linkein Profile: <a href="http://www.linkedin.com/in/estebanav" rel="nofollow" target="_blank">http://www.linkedin.com/in/estebanav</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-fetch-both&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-fetch-both.php">＋<small>add a note</small></a></div>
