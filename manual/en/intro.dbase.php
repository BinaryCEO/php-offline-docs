...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intro.dbase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intro.dbase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intro.dbase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/book.dbase.php">
 <link rel="next" href="https://www.php.net/manual/en/dbase.setup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intro.dbase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intro.dbase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intro.dbase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intro.dbase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intro.dbase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intro.dbase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intro.dbase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intro.dbase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intro.dbase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intro.dbase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intro.dbase.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intro.dbase.php' selected="selected">English</option>
            <option value='de/intro.dbase.php'>German</option>
            <option value='es/intro.dbase.php'>Spanish</option>
            <option value='fr/intro.dbase.php'>French</option>
            <option value='it/intro.dbase.php'>Italian</option>
            <option value='ja/intro.dbase.php'>Japanese</option>
            <option value='pt_BR/intro.dbase.php'>Brazilian Portuguese</option>
            <option value='ru/intro.dbase.php'>Russian</option>
            <option value='tr/intro.dbase.php'>Turkish</option>
            <option value='uk/intro.dbase.php'>Ukrainian</option>
            <option value='zh/intro.dbase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intro.dbase" class="preface">
   ...
   <p class="para">
    There is no support for indexes or memo fields.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintro.dbase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intro.dbase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intro.dbase.php">＋<small>add a note</small></a></span>
