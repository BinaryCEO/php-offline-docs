...
<head>
  ...
  <title>PHP: openssl_get_md_methods - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-get-md-methods.php">
 <link rel="shorturl" href="https://www.php.net/openssl-get-md-methods">
 <link rel="alternate" href="https://www.php.net/openssl-get-md-methods" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-get-curve-names.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-get-privatekey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-get-md-methods.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-get-md-methods.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-get-md-methods.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-get-md-methods.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-get-md-methods.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-get-md-methods.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-get-md-methods.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-get-md-methods.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-get-md-methods.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-get-md-methods.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-get-md-methods.php" hreflang="zh">
...
<meta name="Description" content="Gets available digest methods" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_get_md_methods - Manual" />
<meta name="twitter:description" content="Gets available digest methods" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_get_md_methods - Manual" />
<meta itemprop="description" content="Gets available digest methods" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets available digest methods" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-get-privatekey.php">
          openssl_get_privatekey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-get-curve-names.php">
          &laquo; openssl_get_curve_names        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-get-md-methods.php' selected="selected">English</option>
            <option value='de/function.openssl-get-md-methods.php'>German</option>
            <option value='es/function.openssl-get-md-methods.php'>Spanish</option>
            <option value='fr/function.openssl-get-md-methods.php'>French</option>
            <option value='it/function.openssl-get-md-methods.php'>Italian</option>
            <option value='ja/function.openssl-get-md-methods.php'>Japanese</option>
            <option value='pt_BR/function.openssl-get-md-methods.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-get-md-methods.php'>Russian</option>
            <option value='tr/function.openssl-get-md-methods.php'>Turkish</option>
            <option value='uk/function.openssl-get-md-methods.php'>Ukrainian</option>
            <option value='zh/function.openssl-get-md-methods.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-get-md-methods" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_get_md_methods</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_get_md_methods</span> &mdash; <span class="dc-title">Gets available digest methods</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-get-md-methods-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_get_md_methods</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$aliases</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.openssl-get-md-methods-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if digest aliases should be included within the
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-get-md-methods-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of available digest methods.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-get-md-methods-examples">
  ...
  <p class="para">
   <div class="example" id="example-1028">
    <p><strong>Example #1 <span class="function"><strong>openssl_get_md_methods()</strong></span> example</strong></p>
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.openssl-get-md-methods-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-digest.php" class="function" rel="rdfs-seeAlso">openssl_digest()</a> - Computes a digest</span></li>
    <li><span class="function"><a href="function.openssl-get-cipher-methods.php" class="function" rel="rdfs-seeAlso">openssl_get_cipher_methods()</a> - Gets available cipher methods</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-get-md-methods.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-get-md-methods%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-get-md-methods&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-get-md-methods.php">＋<small>add a note</small></a></span>
