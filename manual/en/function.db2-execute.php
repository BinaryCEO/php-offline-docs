...
<head>
  ...
  <title>PHP: db2_execute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-execute.php">
 <link rel="shorturl" href="https://www.php.net/db2-execute">
 <link rel="alternate" href="https://www.php.net/db2-execute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-exec.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-fetch-array.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-execute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-execute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-execute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-execute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-execute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-execute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-execute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-execute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-execute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-execute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-execute.php" hreflang="zh">
...
<meta name="Description" content="Executes a prepared SQL statement" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_execute - Manual" />
<meta name="twitter:description" content="Executes a prepared SQL statement" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_execute - Manual" />
<meta itemprop="description" content="Executes a prepared SQL statement" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Executes a prepared SQL statement" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-fetch-array.php">
          db2_fetch_array &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-execute.php' selected="selected">English</option>
            <option value='de/function.db2-execute.php'>German</option>
            <option value='es/function.db2-execute.php'>Spanish</option>
            <option value='fr/function.db2-execute.php'>French</option>
            <option value='it/function.db2-execute.php'>Italian</option>
            <option value='ja/function.db2-execute.php'>Japanese</option>
            <option value='pt_BR/function.db2-execute.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-execute.php'>Russian</option>
            <option value='tr/function.db2-execute.php'>Turkish</option>
            <option value='uk/function.db2-execute.php'>Ukrainian</option>
            <option value='zh/function.db2-execute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-execute" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-result.php" class="function" rel="rdfs-seeAlso">db2_result()</a> - Returns a single column from a row in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-execute.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118698">  <div class="votes">
    <div id="Vu118698">
    <a href="/manual/vote-note.php?id=118698&amp;page=function.db2-execute&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118698">
    <a href="/manual/vote-note.php?id=118698&amp;page=function.db2-execute&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118698" title="no votes...">
    0
    </div>
  </div>
  <a href="#118698" class="name">
  <strong class="user"><em>stefanov at uk dot ibm dot com</em></strong></a><a class="genanchor" href="#118698"> &para;</a><div class="date" title="2016-01-20 07:26"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118698">
<div class="phpcode"><code><span class="html">You CANNOT bind parameters for table and/or column names. Binding parameters only works for values:<br /><br />YES: $sqlQuery = "UPDATE ".TB_NAME." SET ".CN_NAME." = ? WHERE DAY = ?";<br />NO: $sqlQuery = "UPDATE ? SET ? = ? WHERE DAY = ?";<br /><br />Any attempt to bind column or table names will result in the following error during db2_execute():<br />PHP Warning:  db2_bind_param(): Describe Param Failed in ...</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-execute.php">＋<small>add a note</small></a></div>
