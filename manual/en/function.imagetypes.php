...
<head>
  ...
  <title>PHP: imagetypes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagetypes.php">
 <link rel="shorturl" href="https://www.php.net/imagetypes">
 <link rel="alternate" href="https://www.php.net/imagetypes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagettftext.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagewbmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagetypes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagetypes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagetypes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagetypes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagetypes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagetypes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagetypes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagetypes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagetypes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagetypes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagetypes.php" hreflang="zh">
...
<meta name="Description" content="Return the image types supported by this PHP build" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagetypes - Manual" />
<meta name="twitter:description" content="Return the image types supported by this PHP build" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagetypes - Manual" />
<meta itemprop="description" content="Return the image types supported by this PHP build" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the image types supported by this PHP build" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagetypes.php' selected="selected">English</option>
            <option value='de/function.imagetypes.php'>German</option>
            <option value='es/function.imagetypes.php'>Spanish</option>
            <option value='fr/function.imagetypes.php'>French</option>
            <option value='it/function.imagetypes.php'>Italian</option>
            <option value='ja/function.imagetypes.php'>Japanese</option>
            <option value='pt_BR/function.imagetypes.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagetypes.php'>Russian</option>
            <option value='tr/function.imagetypes.php'>Turkish</option>
            <option value='uk/function.imagetypes.php'>Ukrainian</option>
            <option value='zh/function.imagetypes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagetypes" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.gd-info.php" class="function" rel="rdfs-seeAlso">gd_info()</a> - Retrieve information about the currently installed GD library</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagetypes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagetypes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagetypes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagetypes.php">＋<small>add a note</small></a></span>
