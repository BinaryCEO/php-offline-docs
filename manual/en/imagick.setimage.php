...
<head>
  ...
  <title>PHP: Imagick::setImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setgravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimage.php" hreflang="zh">
...
<meta name="Description" content="Replaces image in the object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImage - Manual" />
<meta name="twitter:description" content="Replaces image in the object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImage - Manual" />
<meta itemprop="description" content="Replaces image in the object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces image in the object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagealphachannel.php">
          Imagick::setImageAlphaChannel &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setgravity.php">
          &laquo; Imagick::setGravity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimage.php' selected="selected">English</option>
            <option value='de/imagick.setimage.php'>German</option>
            <option value='es/imagick.setimage.php'>Spanish</option>
            <option value='fr/imagick.setimage.php'>French</option>
            <option value='it/imagick.setimage.php'>Italian</option>
            <option value='ja/imagick.setimage.php'>Japanese</option>
            <option value='pt_BR/imagick.setimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimage.php'>Russian</option>
            <option value='tr/imagick.setimage.php'>Turkish</option>
            <option value='uk/imagick.setimage.php'>Ukrainian</option>
            <option value='zh/imagick.setimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImage</span> &mdash; <span class="dc-title">Replaces image in the object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$replace</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3091">
    <p><strong>Example #1 A <span class="function"><strong>Imagick::setImage()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     An example of using Imagick::setImage()
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create the objects */<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'source.jpg'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$replace </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'replace.jpg'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* source.jpg is replaced with replace.jpg */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$replace</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* output the image */<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/jpeg'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimage.php">＋<small>add a note</small></a></span>
