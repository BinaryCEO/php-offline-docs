...
<head>
  ...
  <title>PHP: IntlChar::isgraph - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.isgraph.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.isgraph.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isgraph.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.isdigit.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isidignorable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.isgraph.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.isgraph.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.isgraph.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.isgraph.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.isgraph.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.isgraph.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.isgraph.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.isgraph.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.isgraph.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.isgraph.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.isgraph.php" hreflang="zh">
...
<meta name="Description" content="Check if code point is a graphic character" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isgraph - Manual" />
<meta name="twitter:description" content="Check if code point is a graphic character" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isgraph - Manual" />
<meta itemprop="description" content="Check if code point is a graphic character" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point is a graphic character" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.isidignorable.php">
          IntlChar::isIDIgnorable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.isdigit.php">
          &laquo; IntlChar::isdigit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.isgraph.php' selected="selected">English</option>
            <option value='de/intlchar.isgraph.php'>German</option>
            <option value='es/intlchar.isgraph.php'>Spanish</option>
            <option value='fr/intlchar.isgraph.php'>French</option>
            <option value='it/intlchar.isgraph.php'>Italian</option>
            <option value='ja/intlchar.isgraph.php'>Japanese</option>
            <option value='pt_BR/intlchar.isgraph.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.isgraph.php'>Russian</option>
            <option value='tr/intlchar.isgraph.php'>Turkish</option>
            <option value='uk/intlchar.isgraph.php'>Ukrainian</option>
            <option value='zh/intlchar.isgraph.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.isgraph" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isgraph</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isgraph</span> &mdash; <span class="dc-title">Check if code point is a graphic character</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.isgraph-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isgraph</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   Determines whether the specified code point is a &quot;graphic&quot; character (printable, excluding spaces).
  </p>
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> for all characters except those with general categories &quot;Cc&quot; (control codes), &quot;Cf&quot; (format controls), &quot;Cs&quot; (surrogates), &quot;Cn&quot; (unassigned), and &quot;Z&quot; (separators).
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-intlchar.isgraph-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.isgraph-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">codepoint</code> is a &quot;graphic&quot; character, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.isgraph-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2727">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isgraph</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isgraph</span><span style="color: #007700">(</span><span style="color: #DD0000">"1"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isgraph</span><span style="color: #007700">(</span><span style="color: #DD0000">"\u{2603}"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isgraph</span><span style="color: #007700">(</span><span style="color: #DD0000">"\n"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.isgraph-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ctype-graph.php" class="function" rel="rdfs-seeAlso">ctype_graph()</a> - Check for any printable character(s) except space</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/isgraph.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.isgraph%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.isgraph&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.isgraph.php">＋<small>add a note</small></a></span>
