...
<head>
  ...
  <title>PHP: apache_note - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.apache-note.php">
 <link rel="shorturl" href="https://www.php.net/apache-note">
 <link rel="alternate" href="https://www.php.net/apache-note" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.apache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.apache-lookup-uri.php">
 <link rel="next" href="https://www.php.net/manual/en/function.apache-request-headers.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.apache-note.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.apache-note.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.apache-note.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.apache-note.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.apache-note.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.apache-note.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.apache-note.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.apache-note.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.apache-note.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.apache-note.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.apache-note.php" hreflang="zh">
...
<meta name="Description" content="Get and set apache request notes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: apache_note - Manual" />
<meta name="twitter:description" content="Get and set apache request notes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: apache_note - Manual" />
<meta itemprop="description" content="Get and set apache request notes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get and set apache request notes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.apache-request-headers.php">
          apache_request_headers &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.apache-lookup-uri.php">
          &laquo; apache_lookup_uri        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.apache-note.php' selected="selected">English</option>
            <option value='de/function.apache-note.php'>German</option>
            <option value='es/function.apache-note.php'>Spanish</option>
            <option value='fr/function.apache-note.php'>French</option>
            <option value='it/function.apache-note.php'>Italian</option>
            <option value='ja/function.apache-note.php'>Japanese</option>
            <option value='pt_BR/function.apache-note.php'>Brazilian Portuguese</option>
            <option value='ru/function.apache-note.php'>Russian</option>
            <option value='tr/function.apache-note.php'>Turkish</option>
            <option value='uk/function.apache-note.php'>Ukrainian</option>
            <option value='zh/function.apache-note.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.apache-note" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.apache-note-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>apache_note</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$note_name</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$note_value</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.apache-note-returnvalues">
  ...
  <p class="para">
   If <code class="parameter">note_value</code> is omitted or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, it returns the current value of note
   ...
   If the note cannot be retrieved, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.virtual.php" class="function" rel="rdfs-seeAlso">virtual()</a> - Perform an Apache sub-request</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/apache/functions/apache-note.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.apache-note%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.apache-note&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.apache-note.php">＋<small>add a note</small></a></span>
