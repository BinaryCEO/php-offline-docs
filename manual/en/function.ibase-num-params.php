...
<head>
  ...
  <title>PHP: ibase_num_params - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-num-params.php">
 <link rel="shorturl" href="https://www.php.net/ibase-num-params">
 <link rel="alternate" href="https://www.php.net/ibase-num-params" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-num-fields.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-param-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-num-params.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-num-params.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-num-params.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-num-params.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-num-params.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-num-params.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-num-params.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-num-params.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-num-params.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-num-params.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-num-params.php" hreflang="zh">
...
<meta name="Description" content="Return the number of parameters in a prepared query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_num_params - Manual" />
<meta name="twitter:description" content="Return the number of parameters in a prepared query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_num_params - Manual" />
<meta itemprop="description" content="Return the number of parameters in a prepared query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the number of parameters in a prepared query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-param-info.php">
          ibase_param_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-num-fields.php">
          &laquo; ibase_num_fields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-num-params.php' selected="selected">English</option>
            <option value='de/function.ibase-num-params.php'>German</option>
            <option value='es/function.ibase-num-params.php'>Spanish</option>
            <option value='fr/function.ibase-num-params.php'>French</option>
            <option value='it/function.ibase-num-params.php'>Italian</option>
            <option value='ja/function.ibase-num-params.php'>Japanese</option>
            <option value='pt_BR/function.ibase-num-params.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-num-params.php'>Russian</option>
            <option value='tr/function.ibase-num-params.php'>Turkish</option>
            <option value='uk/function.ibase-num-params.php'>Ukrainian</option>
            <option value='zh/function.ibase-num-params.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-num-params" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_num_params</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_num_params</span> &mdash; <span class="dc-title">Return the number of parameters in a prepared query</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-num-params-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_num_params</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$query</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   This function returns the number of parameters in the prepared query specified
   by <code class="parameter">query</code>. This is the number of binding arguments that
   must be present when calling <span class="function"><a href="function.ibase-execute.php" class="function">ibase_execute()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-num-params-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-num-params-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-num-params-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-param-info.php" class="function" rel="rdfs-seeAlso">ibase_param_info()</a> - Return information about a parameter in a prepared query</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-num-params.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-num-params%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-num-params&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-num-params.php">＋<small>add a note</small></a></span>
