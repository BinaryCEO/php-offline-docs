...
<head>
  ...
  <title>PHP: MongoDB\BSON\Unserializable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-unserializable.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-unserializable">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-unserializable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-serializable.bsonserialize.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-unserializable.bsonunserialize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-unserializable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-unserializable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-unserializable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-unserializable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-unserializable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-unserializable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-unserializable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-unserializable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-unserializable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-unserializable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-unserializable.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Unserializable interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Unserializable - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Unserializable interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Unserializable - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Unserializable interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Unserializable interface" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-bson-unserializable.bsonunserialize.php">
          MongoDB\BSON\Unserializable::bsonUnserialize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-serializable.bsonserialize.php">
          &laquo; MongoDB\BSON\Serializable::bsonSerialize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-unserializable.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-unserializable.php'>German</option>
            <option value='es/class.mongodb-bson-unserializable.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-unserializable.php'>French</option>
            <option value='it/class.mongodb-bson-unserializable.php'>Italian</option>
            <option value='ja/class.mongodb-bson-unserializable.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-unserializable.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-unserializable.php'>Russian</option>
            <option value='tr/class.mongodb-bson-unserializable.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-unserializable.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-unserializable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-unserializable" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;=1.0.0)</p>
  ...
  <div class="section" id="mongodb-bson-unserializable.intro">
   ...
   <p class="para">
    ...
    <a href="mongodb.persistence.php#mongodb.persistence.typemaps" class="link">type map</a> for
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-unserializable.bsonunserialize.php">MongoDB\BSON\Unserializable::bsonUnserialize</a> — Constructs the object from a BSON array or document</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/unserializable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-unserializable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-unserializable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-unserializable.php">＋<small>add a note</small></a></span>
