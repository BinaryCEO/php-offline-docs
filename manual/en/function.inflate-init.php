...
<head>
  ...
  <title>PHP: inflate_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.inflate-init.php">
 <link rel="shorturl" href="https://www.php.net/inflate-init">
 <link rel="alternate" href="https://www.php.net/inflate-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.inflate-get-status.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ob-gzhandler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.inflate-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.inflate-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.inflate-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.inflate-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.inflate-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.inflate-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.inflate-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.inflate-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.inflate-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.inflate-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.inflate-init.php" hreflang="zh">
...
<meta name="Description" content="Initialize an incremental inflate context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: inflate_init - Manual" />
<meta name="twitter:description" content="Initialize an incremental inflate context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: inflate_init - Manual" />
<meta itemprop="description" content="Initialize an incremental inflate context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize an incremental inflate context" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ob-gzhandler.php">
          ob_gzhandler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.inflate-get-status.php">
          &laquo; inflate_get_status        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.inflate-init.php' selected="selected">English</option>
            <option value='de/function.inflate-init.php'>German</option>
            <option value='es/function.inflate-init.php'>Spanish</option>
            <option value='fr/function.inflate-init.php'>French</option>
            <option value='it/function.inflate-init.php'>Italian</option>
            <option value='ja/function.inflate-init.php'>Japanese</option>
            <option value='pt_BR/function.inflate-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.inflate-init.php'>Russian</option>
            <option value='tr/function.inflate-init.php'>Turkish</option>
            <option value='uk/function.inflate-init.php'>Ukrainian</option>
            <option value='zh/function.inflate-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.inflate-init" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.inflate-init-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>inflate_init</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$encoding</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$options</code><span class="initializer"> = []</span></span>): <span class="type"><span class="type"><a href="class.inflatecontext.php" class="type InflateContext">InflateContext</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.deflate-init.php" class="function" rel="rdfs-seeAlso">deflate_init()</a> - Initialize an incremental deflate context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/inflate_init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.inflate-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.inflate-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.inflate-init.php">＋<small>add a note</small></a></span>
