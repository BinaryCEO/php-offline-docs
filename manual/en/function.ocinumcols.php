...
<head>
  ...
  <title>PHP: ocinumcols - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocinumcols.php">
 <link rel="shorturl" href="https://www.php.net/ocinumcols">
 <link rel="alternate" href="https://www.php.net/ocinumcols" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocinlogon.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociparse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocinumcols.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocinumcols.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocinumcols.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocinumcols.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocinumcols.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocinumcols.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocinumcols.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocinumcols.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocinumcols.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocinumcols.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocinumcols.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_num_fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocinumcols - Manual" />
<meta name="twitter:description" content="Alias of oci_num_fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocinumcols - Manual" />
<meta itemprop="description" content="Alias of oci_num_fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_num_fields" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ociparse.php">
          ociparse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocinlogon.php">
          &laquo; ocinlogon        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocinumcols.php' selected="selected">English</option>
            <option value='de/function.ocinumcols.php'>German</option>
            <option value='es/function.ocinumcols.php'>Spanish</option>
            <option value='fr/function.ocinumcols.php'>French</option>
            <option value='it/function.ocinumcols.php'>Italian</option>
            <option value='ja/function.ocinumcols.php'>Japanese</option>
            <option value='pt_BR/function.ocinumcols.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocinumcols.php'>Russian</option>
            <option value='tr/function.ocinumcols.php'>Turkish</option>
            <option value='uk/function.ocinumcols.php'>Ukrainian</option>
            <option value='zh/function.ocinumcols.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocinumcols" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocinumcols</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocinumcols</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-num-fields.php" class="function">oci_num_fields()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocinumcols-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-num-fields.php" class="function">oci_num_fields()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocinumcols.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocinumcols%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocinumcols&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocinumcols.php">＋<small>add a note</small></a></span>
