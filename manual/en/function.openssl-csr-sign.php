...
<head>
  ...
  <title>PHP: openssl_csr_sign - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-csr-sign.php">
 <link rel="shorturl" href="https://www.php.net/openssl-csr-sign">
 <link rel="alternate" href="https://www.php.net/openssl-csr-sign" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-csr-new.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-decrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-csr-sign.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-csr-sign.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-csr-sign.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-csr-sign.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-csr-sign.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-csr-sign.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-csr-sign.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-csr-sign.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-csr-sign.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-csr-sign.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-csr-sign.php" hreflang="zh">
...
<meta name="Description" content="Sign a CSR with another certificate (or itself) and generate a certificate" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_csr_sign - Manual" />
<meta name="twitter:description" content="Sign a CSR with another certificate (or itself) and generate a certificate" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_csr_sign - Manual" />
<meta itemprop="description" content="Sign a CSR with another certificate (or itself) and generate a certificate" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sign a CSR with another certificate (or itself) and generate a certificate" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-decrypt.php">
          openssl_decrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-csr-new.php">
          &laquo; openssl_csr_new        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-csr-sign.php' selected="selected">English</option>
            <option value='de/function.openssl-csr-sign.php'>German</option>
            <option value='es/function.openssl-csr-sign.php'>Spanish</option>
            <option value='fr/function.openssl-csr-sign.php'>French</option>
            <option value='it/function.openssl-csr-sign.php'>Italian</option>
            <option value='ja/function.openssl-csr-sign.php'>Japanese</option>
            <option value='pt_BR/function.openssl-csr-sign.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-csr-sign.php'>Russian</option>
            <option value='tr/function.openssl-csr-sign.php'>Turkish</option>
            <option value='uk/function.openssl-csr-sign.php'>Ukrainian</option>
            <option value='zh/function.openssl-csr-sign.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-csr-sign" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_csr_sign</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_csr_sign</span> &mdash; <span class="dc-title">Sign a <abbr title="Certificate Signing Request">CSR</abbr> with another certificate (or itself) and generate a certificate</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-csr-sign-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_csr_sign</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="class.opensslcertificatesigningrequest.php" class="type OpenSSLCertificateSigningRequest">OpenSSLCertificateSigningRequest</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$csr</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$ca_certificate</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><span class="type"><a href="class.opensslasymmetrickey.php" class="type OpenSSLAsymmetricKey">OpenSSLAsymmetricKey</a></span>|<span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$private_key</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$days</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$options</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$serial</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$serial_hex</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_csr_sign()</strong></span> generates an x509 certificate from the given <abbr title="Certificate Signing Request">CSR</abbr>.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.openssl-csr-sign-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       A <abbr title="Certificate Signing Request">CSR</abbr> previously generated by <span class="function"><a href="function.openssl-csr-new.php" class="function">openssl_csr_new()</a></span>.
       It can also be the path to a <abbr title="Privacy-Enhanced Mail">PEM</abbr> encoded <abbr title="Certificate Signing Request">CSR</abbr> when specified as
       <var class="filename">file://path/to/csr</var> or an exported string generated
       by <span class="function"><a href="function.openssl-csr-export.php" class="function">openssl_csr_export()</a></span>.
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       The generated certificate will be signed by <code class="parameter">ca_certificate</code>.
       If <code class="parameter">ca_certificate</code> is <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, the generated certificate
     ...
     <dd>
      <p class="para">
       <code class="parameter">private_key</code> is the private key that corresponds to
     ...
     <dd>
      <p class="para">
       <code class="parameter">days</code> specifies the length of time for which the
     ...
     <dd>
      <p class="para">
       You can finetune the <abbr title="Certificate Signing Request">CSR</abbr> signing by <code class="parameter">options</code>.
       See <span class="function"><a href="function.openssl-csr-new.php" class="function">openssl_csr_new()</a></span> for more information about
     ...
     <dd>
      <p class="para">
       ...
       <code class="parameter">serial</code> parameter value. If not specified or set
       to <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, the <code class="parameter">serial</code> parameter value is used
       instead.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-csr-sign-returnvalues">
  ...
  <p class="para">
   Returns an <span class="classname"><a href="class.opensslcertificate.php" class="classname">OpenSSLCertificate</a></span> on success, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       The <code class="parameter">serial_hex</code> parameter is added.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       On success, this function returns an <span class="classname"><a href="class.opensslcertificate.php" class="classname">OpenSSLCertificate</a></span> instance now;
       previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> of type <code class="literal">OpenSSL X.509</code> was returned.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">ca_certificate</code> accepts an <span class="classname"><a href="class.opensslcertificate.php" class="classname">OpenSSLCertificate</a></span> instance now;
  ...
  <p class="para">
   <div class="example" id="example-1019">
    <p><strong>Example #1 <span class="function"><strong>openssl_csr_sign()</strong></span> example - signing a
     <abbr title="Certificate Signing Request">CSR</abbr> (how to implement your own CA)</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Let's assume that this script is set to receive a CSR that has<br />// been pasted into a textarea from another page<br /></span><span style="color: #0000BB">$csrdata </span><span style="color: #007700">= </span><span style="color: #0000BB">$_POST</span><span style="color: #007700">[</span><span style="color: #DD0000">"CSR"</span><span style="color: #007700">];<br /><br /></span><span style="color: #FF8000">// We will sign the request using our own "certificate authority"<br />// certificate.  You can use any certificate to sign another, but<br />// the process is worthless unless the signing certificate is trusted<br />// by the software/users that will deal with the newly signed certificate<br /><br />// We need our CA cert and its private key<br /></span><span style="color: #0000BB">$cacert </span><span style="color: #007700">= </span><span style="color: #DD0000">"file://path/to/ca.crt"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$privkey </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"file://path/to/ca.key"</span><span style="color: #007700">, </span><span style="color: #DD0000">"your_ca_key_passphrase"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$usercert </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_csr_sign</span><span style="color: #007700">(</span><span style="color: #0000BB">$csrdata</span><span style="color: #007700">, </span><span style="color: #0000BB">$cacert</span><span style="color: #007700">, </span><span style="color: #0000BB">$privkey</span><span style="color: #007700">, </span><span style="color: #0000BB">365</span><span style="color: #007700">, array(</span><span style="color: #DD0000">'digest_alg'</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">'sha256'</span><span style="color: #007700">) );<br /><br /></span><span style="color: #FF8000">// Now display the generated certificate so that the user can<br />// copy and paste it into their local configuration (such as a file<br />// to hold the certificate for their SSL server)<br /></span><span style="color: #0000BB">openssl_x509_export</span><span style="color: #007700">(</span><span style="color: #0000BB">$usercert</span><span style="color: #007700">, </span><span style="color: #0000BB">$certout</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$certout</span><span style="color: #007700">;<br /><br /></span><span style="color: #FF8000">// Show any errors that occurred here<br /></span><span style="color: #007700">while ((</span><span style="color: #0000BB">$e </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_error_string</span><span style="color: #007700">()) !== </span><span style="color: #0000BB">false</span><span style="color: #007700">) {<br />    echo </span><span style="color: #0000BB">$e </span><span style="color: #007700">. </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-csr-sign.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-csr-sign%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-csr-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-sign.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="22331">  <div class="votes">
    <div id="Vu22331">
    <a href="/manual/vote-note.php?id=22331&amp;page=function.openssl-csr-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd22331">
    <a href="/manual/vote-note.php?id=22331&amp;page=function.openssl-csr-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V22331" title="44% like this...">
    -1
    </div>
  </div>
  <a href="#22331" class="name">
  <strong class="user"><em>eric at ypass dot net</em></strong></a><a class="genanchor" href="#22331"> &para;</a><div class="date" title="2002-06-13 04:13"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom22331">
<div class="phpcode"><code><span class="html">To generate a self-signed certificate, pass NULL as the signing certificate (2nd parameter).  For example:<br /><br />$req_key = openssl_pkey_new();<br />$dn = array(<br />    "countryName" =&gt; "US",<br />    "stateOrProvinceName" =&gt; "Colorado",<br />    "organizationName" =&gt; "yPass.net",<br />    "organizationalUnitName" =&gt; "yPass.net",<br />    "commonName" =&gt; "yPass.net Root Certificate"<br />);<br />$req_csr = openssl_csr_new($dn, $req_key);<br />$req_cert = openssl_csr_sign($req_csr, NULL, $req_key, 365);</span></code></div>
  </div>
 </div>
  <div class="note" id="23190">  <div class="votes">
    <div id="Vu23190">
    <a href="/manual/vote-note.php?id=23190&amp;page=function.openssl-csr-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd23190">
    <a href="/manual/vote-note.php?id=23190&amp;page=function.openssl-csr-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V23190" title="40% like this...">
    -2
    </div>
  </div>
  <a href="#23190" class="name">
  <strong class="user"><em>thomas dot lussnig at bewegungsmelder dot de</em></strong></a><a class="genanchor" href="#23190"> &para;</a><div class="date" title="2002-07-11 08:34"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom23190">
<div class="phpcode"><code><span class="html">Here is an sample how to create valid X.509 Public and Private Key (cert/key).<br />When not using self signed the 4.2.1 segault. You need the CVS code at least for openssl.<br /><br />&lt;?<br />Header("Content-Type: text/plain");<br />$CA_CERT = "CA.cert.pem";<br />$CA_KEY  = "CA.key.pem";<br />$req_key = openssl_pkey_new();<br />if(openssl_pkey_export ($req_key, $out_key)) {<br />        $dn = array(<br />                "countryName"            =&gt; "DE",<br />                "stateOrProvinceName"    =&gt; "Frankfurt",<br />                "organizationName"       =&gt; "smcc.net",<br />                "organizationalUnitName" =&gt; "E-Mail",<br />                "commonName"             =&gt; "Testcert"<br />                );<br />        $req_csr  = openssl_csr_new ($dn, $req_key);<br />        $req_cert = openssl_csr_sign($req_csr, "file://$CA_CERT", "file://$CA_KEY", 365);<br />        if(openssl_x509_export ($req_cert, $out_cert)) {<br />                echo "$out_key\n";<br />                echo "$out_cert\n";<br />                }<br />        else    echo "Failed Cert\n";<br />        }<br />else            echo "FailedKey\n";<br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="117863">  <div class="votes">
    <div id="Vu117863">
    <a href="/manual/vote-note.php?id=117863&amp;page=function.openssl-csr-sign&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117863">
    <a href="/manual/vote-note.php?id=117863&amp;page=function.openssl-csr-sign&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117863" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#117863" class="name">
  <strong class="user"><em>Sriraam</em></strong></a><a class="genanchor" href="#117863"> &para;</a><div class="date" title="2015-08-21 08:58"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117863">
<div class="phpcode"><code><span class="html">config_section_section is incorrect. The correct keyword to use is "config_section_name".</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-csr-sign&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-csr-sign.php">＋<small>add a note</small></a></div>
