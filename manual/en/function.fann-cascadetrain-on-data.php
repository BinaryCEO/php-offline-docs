...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-data.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-cascadetrain-on-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-cascadetrain-on-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-cascadetrain-on-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-cascadetrain-on-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-cascadetrain-on-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-cascadetrain-on-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-cascadetrain-on-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-cascadetrain-on-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-cascadetrain-on-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-cascadetrain-on-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-cascadetrain-on-data.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-cascadetrain-on-data.php' selected="selected">English</option>
            ...
            <option value='tr/function.fann-cascadetrain-on-data.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-cascadetrain-on-file.php" class="function" rel="rdfs-seeAlso">fann_cascadetrain_on_file()</a> - Trains on an entire dataset read from file, for a period of time using the Cascade2 training algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-cascadetrain-on-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-cascadetrain-on-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-cascadetrain-on-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-cascadetrain-on-data.php">＋<small>add a note</small></a></span>
