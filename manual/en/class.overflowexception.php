...
<head>
  ...
  <title>PHP: OverflowException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.overflowexception.php">
 <link rel="shorturl" href="https://www.php.net/overflowexception">
 <link rel="alternate" href="https://www.php.net/overflowexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.outofrangeexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.rangeexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.overflowexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.overflowexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.overflowexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.overflowexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.overflowexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.overflowexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.overflowexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.overflowexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.overflowexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.overflowexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.overflowexception.php" hreflang="zh">
...
<meta name="Description" content="The OverflowException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: OverflowException - Manual" />
<meta name="twitter:description" content="The OverflowException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: OverflowException - Manual" />
<meta itemprop="description" content="The OverflowException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The OverflowException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.rangeexception.php">
          RangeException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.outofrangeexception.php">
          &laquo; OutOfRangeException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.overflowexception.php' selected="selected">English</option>
            <option value='de/class.overflowexception.php'>German</option>
            <option value='es/class.overflowexception.php'>Spanish</option>
            <option value='fr/class.overflowexception.php'>French</option>
            <option value='it/class.overflowexception.php'>Italian</option>
            <option value='ja/class.overflowexception.php'>Japanese</option>
            <option value='pt_BR/class.overflowexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.overflowexception.php'>Russian</option>
            <option value='tr/class.overflowexception.php'>Turkish</option>
            <option value='uk/class.overflowexception.php'>Ukrainian</option>
            <option value='zh/class.overflowexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.overflowexception" class="reference">
 <h1 class="title">The OverflowException class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="overflowexception.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">OverflowException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/overflowexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.overflowexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.overflowexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.overflowexception.php">＋<small>add a note</small></a></span>
