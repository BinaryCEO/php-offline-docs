...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-config.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-create-request.php">
...
<meta name="Description" content="Causes the library to read the given configuration file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_config - Manual" />
<meta name="twitter:description" content="Causes the library to read the given configuration file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_config - Manual" />
<meta itemprop="description" content="Causes the library to read the given configuration file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Causes the library to read the given configuration file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-config.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.radius-config.php'>Brazilian Portuguese</option>
 ...
 <div class="refsect1 seealso" id="refsect1-function.radius-config-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.radius-add-server.php" class="function" rel="rdfs-seeAlso">radius_add_server()</a> - Adds a server</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-config.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-config%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-config&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-config.php">＋<small>add a note</small></a></span>
