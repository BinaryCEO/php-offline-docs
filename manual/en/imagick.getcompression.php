...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getcompression.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getcompression.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcompression.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getcolorspace.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getcompressionquality.php">
...
<meta name="Description" content="Gets the object compression type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getCompression - Manual" />
<meta name="twitter:description" content="Gets the object compression type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getCompression - Manual" />
<meta itemprop="description" content="Gets the object compression type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the object compression type" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getcompression.php' selected="selected">English</option>
            <option value='de/imagick.getcompression.php'>German</option>
            <option value='es/imagick.getcompression.php'>Spanish</option>
            <option value='fr/imagick.getcompression.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getCompression</span> &mdash; <span class="dc-title">Gets the object compression type</span></p>
  ...
  <p class="para">
   Returns the compression constant
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getcompression.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getcompression%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getcompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getcompression.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The ImageMagick PHP function for getCompression returns an integer representing the value associated with the ImageMagick Compression constant.  You'll get numbers from 0 to 13, each representing a different particular type of compression.  If printed out, the ImageMagick constants for compression come out as...<br /><br />imagick::COMPRESSION_UNDEFINED    0<br />imagick::COMPRESSION_NO    1<br />imagick::COMPRESSION_BZIP    2<br />imagick::COMPRESSION_DXT1    3<br />imagick::COMPRESSION_DXT3    4<br />imagick::COMPRESSION_DXT5    5<br />imagick::COMPRESSION_FAX    6<br />imagick::COMPRESSION_GROUP4    7<br />imagick::COMPRESSION_JPEG    8<br />imagick::COMPRESSION_JPEG2000    9<br />imagick::COMPRESSION_LOSSLESSJPEG    10<br />imagick::COMPRESSION_LZW    11<br />imagick::COMPRESSION_RLE    12<br />imagick::COMPRESSION_ZIP    13<br /><br />Every time I have used this, whether on a jpeg image, a png image, a gif image, or a bmp image, it has always returned '0' as a value.  There's a good chance that this is simply a value that is set by means of get/set, as opposed to actually producing values for a given image.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Quantum Range<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$imagick_type_compression </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getCompression</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Print Results<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">print(</span><span class="string">"&lt;pre&gt;"</span><span class="keyword">);<br />    print(</span><span class="default">$imagick_type_compression</span><span class="keyword">);<br />    print(</span><span class="string">"&lt;/pre&gt;"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getcompression&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getcompression.php">＋<small>add a note</small></a></div>
