...
<head>
  ...
  <title>PHP: sodium_compare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-compare.php">
 <link rel="shorturl" href="https://www.php.net/sodium-compare">
 <link rel="alternate" href="https://www.php.net/sodium-compare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-bin2hex.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aegis128l-decrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-compare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-compare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-compare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-compare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-compare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-compare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-compare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-compare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-compare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-compare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-compare.php" hreflang="zh">
...
<meta name="Description" content="Compare large numbers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_compare - Manual" />
<meta name="twitter:description" content="Compare large numbers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_compare - Manual" />
<meta itemprop="description" content="Compare large numbers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compare large numbers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-aead-aegis128l-decrypt.php">
          sodium_crypto_aead_aegis128l_decrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-bin2hex.php">
          &laquo; sodium_bin2hex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-compare.php' selected="selected">English</option>
            <option value='de/function.sodium-compare.php'>German</option>
            <option value='es/function.sodium-compare.php'>Spanish</option>
            <option value='fr/function.sodium-compare.php'>French</option>
            <option value='it/function.sodium-compare.php'>Italian</option>
            <option value='ja/function.sodium-compare.php'>Japanese</option>
            <option value='pt_BR/function.sodium-compare.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-compare.php'>Russian</option>
            <option value='tr/function.sodium-compare.php'>Turkish</option>
            <option value='uk/function.sodium-compare.php'>Ukrainian</option>
            <option value='zh/function.sodium-compare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-compare" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_compare</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_compare</span> &mdash; <span class="dc-title">Compare large numbers</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-compare-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_compare</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string1</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string2</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-compare-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-compare-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="literal">-1</code> if <code class="parameter">string1</code> is less than <code class="parameter">string2</code>.
  </p>
  <p class="para">
   Returns <code class="literal">1</code> if <code class="parameter">string1</code> is greater than <code class="parameter">string2</code>.
  </p>
  <p class="para">
   Returns <code class="literal">0</code> if both strings are equal.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-compare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-compare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-compare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-compare.php">＋<small>add a note</small></a></span>
