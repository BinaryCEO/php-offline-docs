...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/resourcebundle.geterrormessage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/resourcebundle.geterrormessage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/resourcebundle.geterrormessage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.resourcebundle.php">
 <link rel="prev" href="https://www.php.net/manual/en/resourcebundle.geterrorcode.php">
 <link rel="next" href="https://www.php.net/manual/en/resourcebundle.locales.php">
...
<meta name="Description" content="Get bundle's last error message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ResourceBundle::getErrorMessage - Manual" />
<meta name="twitter:description" content="Get bundle's last error message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ResourceBundle::getErrorMessage - Manual" />
<meta itemprop="description" content="Get bundle's last error message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get bundle's last error message" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/resourcebundle.geterrormessage.php' selected="selected">English</option>
            ...
            <option value='fr/resourcebundle.geterrormessage.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.2, PHP 7, PHP 8, PECL intl &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">ResourceBundle::getErrorMessage</span> -- <span class="refname">resourcebundle_get_error_message</span> &mdash; <span class="dc-title">Get bundle&#039;s last error message</span></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$r </span><span style="color: #007700">= new </span><span style="color: #0000BB">ResourceBundle</span><span style="color: #007700">( </span><span style="color: #DD0000">'es'</span><span style="color: #007700">, </span><span style="color: #DD0000">"/usr/share/data/myapp"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$r</span><span style="color: #007700">[</span><span style="color: #DD0000">'somestring'</span><span style="color: #007700">];<br />if(</span><span style="color: #0000BB">intl_is_failure</span><span style="color: #007700">(</span><span style="color: #0000BB">ResourceBundle</span><span style="color: #007700">::</span><span style="color: #0000BB">getErrorCode</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">))) {<br />    </span><span style="color: #0000BB">report_error</span><span style="color: #007700">(</span><span style="color: #DD0000">"Bundle error: "</span><span style="color: #007700">.</span><span style="color: #0000BB">ResourceBundle</span><span style="color: #007700">::</span><span style="color: #0000BB">getErrorMessage</span><span style="color: #007700">(</span><span style="color: #0000BB">$r</span><span style="color: #007700">));<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-resourcebundle.geterrormessage-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="resourcebundle.geterrorcode.php" class="function" rel="rdfs-seeAlso">resourcebundle_get_error_code()</a> - Get bundle's last error code</span></li>
    ...
    <li><span class="function"><a href="function.intl-is-failure.php" class="function" rel="rdfs-seeAlso">intl_is_failure()</a> - Check whether the given error code indicates failure</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/resourcebundle/get-error-message.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fresourcebundle.geterrormessage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=resourcebundle.geterrormessage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/resourcebundle.geterrormessage.php">＋<small>add a note</small></a></span>
