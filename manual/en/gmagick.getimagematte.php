...
<head>
  ...
  <title>PHP: Gmagick::getimagematte - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagematte.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagematte.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagematte.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageiterations.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagematte.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagematte.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagematte.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagematte.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagematte.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagematte.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagematte.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagematte.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagematte.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagematte.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagematte.php" hreflang="zh">
...
<meta name="Description" content="Check if the image has a matte channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagematte - Manual" />
<meta name="twitter:description" content="Check if the image has a matte channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagematte - Manual" />
<meta itemprop="description" content="Check if the image has a matte channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if the image has a matte channel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagemattecolor.php">
          Gmagick::getimagemattecolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageiterations.php">
          &laquo; Gmagick::getimageiterations        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagematte.php' selected="selected">English</option>
            <option value='de/gmagick.getimagematte.php'>German</option>
            <option value='es/gmagick.getimagematte.php'>Spanish</option>
            <option value='fr/gmagick.getimagematte.php'>French</option>
            <option value='it/gmagick.getimagematte.php'>Italian</option>
            <option value='ja/gmagick.getimagematte.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagematte.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagematte.php'>Russian</option>
            <option value='tr/gmagick.getimagematte.php'>Turkish</option>
            <option value='uk/gmagick.getimagematte.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagematte.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagematte" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagematte</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagematte</span> &mdash; <span class="dc-title">Check if the image has a matte channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagematte-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagematte</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the image has a matte channel, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-gmagick.getimagematte-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagematte-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagematte-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagematte.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagematte%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagematte&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagematte.php">＋<small>add a note</small></a></span>
