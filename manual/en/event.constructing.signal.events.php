...
<head>
  ...
  <title>PHP: Constructing signal events - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/event.constructing.signal.events.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/event.constructing.signal.events.php">
 <link rel="alternate" href="https://www.php.net/manual/en/event.constructing.signal.events.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/event.callbacks.php">
 <link rel="next" href="https://www.php.net/manual/en/class.event.php">

 <link rel="alternate" href="https://www.php.net/manual/en/event.constructing.signal.events.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/event.constructing.signal.events.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/event.constructing.signal.events.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/event.constructing.signal.events.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/event.constructing.signal.events.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/event.constructing.signal.events.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/event.constructing.signal.events.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/event.constructing.signal.events.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/event.constructing.signal.events.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/event.constructing.signal.events.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/event.constructing.signal.events.php" hreflang="zh">
...
<meta name="Description" content="Constructing signal events" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Constructing signal events - Manual" />
<meta name="twitter:description" content="Constructing signal events" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Constructing signal events - Manual" />
<meta itemprop="description" content="Constructing signal events" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructing signal events" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.event.php">
          Event &raquo;
              ...
              <div class="prev">
        <a href="event.callbacks.php">
          &laquo; Event callbacks        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/event.constructing.signal.events.php' selected="selected">English</option>
            <option value='de/event.constructing.signal.events.php'>German</option>
            <option value='es/event.constructing.signal.events.php'>Spanish</option>
            <option value='fr/event.constructing.signal.events.php'>French</option>
            <option value='it/event.constructing.signal.events.php'>Italian</option>
            <option value='ja/event.constructing.signal.events.php'>Japanese</option>
            <option value='pt_BR/event.constructing.signal.events.php'>Brazilian Portuguese</option>
            <option value='ru/event.constructing.signal.events.php'>Russian</option>
            <option value='tr/event.constructing.signal.events.php'>Turkish</option>
            <option value='uk/event.constructing.signal.events.php'>Ukrainian</option>
            <option value='zh/event.constructing.signal.events.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="event.constructing.signal.events" class="chapter">
 ...
 Events</a>.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/event.constructing.signal.events.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fevent.constructing.signal.events%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=event.constructing.signal.events&amp;repo=en&amp;redirect=https://www.php.net/manual/en/event.constructing.signal.events.php">＋<small>add a note</small></a></span>
