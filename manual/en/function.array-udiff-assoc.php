...
<head>
  ...
  <title>PHP: array_udiff_assoc - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-udiff-assoc.php">
 <link rel="shorturl" href="https://www.php.net/array-udiff-assoc">
 <link rel="alternate" href="https://www.php.net/array-udiff-assoc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-udiff.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-udiff-uassoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-udiff-assoc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-udiff-assoc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-udiff-assoc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-udiff-assoc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-udiff-assoc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-udiff-assoc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-udiff-assoc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-udiff-assoc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-udiff-assoc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-udiff-assoc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-udiff-assoc.php" hreflang="zh">
...
<meta name="Description" content="Computes the difference of arrays with additional index check, compares data by a callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_udiff_assoc - Manual" />
<meta name="twitter:description" content="Computes the difference of arrays with additional index check, compares data by a callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_udiff_assoc - Manual" />
<meta itemprop="description" content="Computes the difference of arrays with additional index check, compares data by a callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the difference of arrays with additional index check, compares data by a callback function" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-udiff-assoc.php' selected="selected">English</option>
            <option value='de/function.array-udiff-assoc.php'>German</option>
            <option value='es/function.array-udiff-assoc.php'>Spanish</option>
            <option value='fr/function.array-udiff-assoc.php'>French</option>
            <option value='it/function.array-udiff-assoc.php'>Italian</option>
            <option value='ja/function.array-udiff-assoc.php'>Japanese</option>
            <option value='pt_BR/function.array-udiff-assoc.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-udiff-assoc.php'>Russian</option>
            <option value='tr/function.array-udiff-assoc.php'>Turkish</option>
            <option value='uk/function.array-udiff-assoc.php'>Ukrainian</option>
            <option value='zh/function.array-udiff-assoc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-udiff-assoc" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.array-uintersect-uassoc.php" class="function" rel="rdfs-seeAlso">array_uintersect_uassoc()</a> - Computes the intersection of arrays with additional index check, compares data and indexes by separate callback functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-udiff-assoc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-udiff-assoc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-udiff-assoc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-udiff-assoc.php">＋<small>add a note</small></a></span>
