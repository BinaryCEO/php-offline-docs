...
<head>
  ...
  <title>PHP: MongoDB\BSON\Document::toRelaxedExtendedJSON - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-bson-document.torelaxedextendedjson.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-bson-document.torelaxedextendedjson.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-document.torelaxedextendedjson.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-bson-document.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-document.tophp.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-document.tostring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-document.torelaxedextendedjson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-bson-document.torelaxedextendedjson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-bson-document.torelaxedextendedjson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-bson-document.torelaxedextendedjson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-bson-document.torelaxedextendedjson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-bson-document.torelaxedextendedjson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-bson-document.torelaxedextendedjson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-bson-document.torelaxedextendedjson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-bson-document.torelaxedextendedjson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-bson-document.torelaxedextendedjson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-bson-document.torelaxedextendedjson.php" hreflang="zh">
...
<meta name="Description" content="Returns the Relaxed Extended JSON representation of the BSON document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Document::toRelaxedExtendedJSON - Manual" />
<meta name="twitter:description" content="Returns the Relaxed Extended JSON representation of the BSON document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Document::toRelaxedExtendedJSON - Manual" />
<meta itemprop="description" content="Returns the Relaxed Extended JSON representation of the BSON document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Relaxed Extended JSON representation of the BSON document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-document.tostring.php">
          MongoDB\BSON\Document::__toString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-document.tophp.php">
          &laquo; MongoDB\BSON\Document::toPHP        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-bson-document.torelaxedextendedjson.php' selected="selected">English</option>
            <option value='de/mongodb-bson-document.torelaxedextendedjson.php'>German</option>
            <option value='es/mongodb-bson-document.torelaxedextendedjson.php'>Spanish</option>
            <option value='fr/mongodb-bson-document.torelaxedextendedjson.php'>French</option>
            <option value='it/mongodb-bson-document.torelaxedextendedjson.php'>Italian</option>
            <option value='ja/mongodb-bson-document.torelaxedextendedjson.php'>Japanese</option>
            <option value='pt_BR/mongodb-bson-document.torelaxedextendedjson.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-bson-document.torelaxedextendedjson.php'>Russian</option>
            <option value='tr/mongodb-bson-document.torelaxedextendedjson.php'>Turkish</option>
            <option value='uk/mongodb-bson-document.torelaxedextendedjson.php'>Ukrainian</option>
            <option value='zh/mongodb-bson-document.torelaxedextendedjson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-bson-document.torelaxedextendedjson" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">MongoDB\BSON\Document::toRelaxedExtendedJSON</h1>
  <p class="verinfo">(mongodb &gt;=1.16.0)</p><p class="refpurpose"><span class="refname">MongoDB\BSON\Document::toRelaxedExtendedJSON</span> &mdash; <span class="dc-title">Returns the Relaxed Extended JSON representation of the BSON document</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mongodb-bson-document.torelaxedextendedjson-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><strong>MongoDB\BSON\Document::toRelaxedExtendedJSON</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mongodb-bson-document.torelaxedextendedjson-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-mongodb-bson-document.torelaxedextendedjson-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mongodb-bson-document.torelaxedextendedjson-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1497">
   <p><strong>Example #1 <span class="methodname"><strong>MongoDB\BSON\Document::toRelaxedExtendedJSON()</strong></span> example</strong></p>
...
{ &quot;maxkey&quot; : { &quot;$maxKey&quot; : 1 } }</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mongodb-bson-document.torelaxedextendedjson-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="mongodb-bson-document.tocanonicalextendedjson.php" class="methodname" rel="rdfs-seeAlso">MongoDB\BSON\Document::toCanonicalExtendedJSON()</a> - Returns the Canonical Extended JSON representation of the BSON document</span></li>
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;BSON Types</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/document/torelaxedextendedjson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-bson-document.torelaxedextendedjson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-bson-document.torelaxedextendedjson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-bson-document.torelaxedextendedjson.php">＋<small>add a note</small></a></span>
