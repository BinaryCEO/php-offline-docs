...
<head>
  ...
  <title>PHP: RecursiveCallbackFilterIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.recursivecallbackfilteriterator.php">
 <link rel="shorturl" href="https://www.php.net/recursivecallbackfilteriterator">
 <link rel="alternate" href="https://www.php.net/recursivecallbackfilteriterator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.iterators.php">
 <link rel="prev" href="https://www.php.net/manual/en/recursivecachingiterator.haschildren.php">
 <link rel="next" href="https://www.php.net/manual/en/recursivecallbackfilteriterator.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.recursivecallbackfilteriterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.recursivecallbackfilteriterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.recursivecallbackfilteriterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.recursivecallbackfilteriterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.recursivecallbackfilteriterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.recursivecallbackfilteriterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.recursivecallbackfilteriterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.recursivecallbackfilteriterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.recursivecallbackfilteriterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.recursivecallbackfilteriterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.recursivecallbackfilteriterator.php" hreflang="zh">
...
<meta name="Description" content="The RecursiveCallbackFilterIterator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: RecursiveCallbackFilterIterator - Manual" />
<meta name="twitter:description" content="The RecursiveCallbackFilterIterator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: RecursiveCallbackFilterIterator - Manual" />
<meta itemprop="description" content="The RecursiveCallbackFilterIterator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The RecursiveCallbackFilterIterator class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="recursivecallbackfilteriterator.construct.php">
          RecursiveCallbackFilterIterator::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="recursivecachingiterator.haschildren.php">
          &laquo; RecursiveCachingIterator::hasChildren        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.recursivecallbackfilteriterator.php' selected="selected">English</option>
            <option value='de/class.recursivecallbackfilteriterator.php'>German</option>
            <option value='es/class.recursivecallbackfilteriterator.php'>Spanish</option>
            <option value='fr/class.recursivecallbackfilteriterator.php'>French</option>
            <option value='it/class.recursivecallbackfilteriterator.php'>Italian</option>
            <option value='ja/class.recursivecallbackfilteriterator.php'>Japanese</option>
            <option value='pt_BR/class.recursivecallbackfilteriterator.php'>Brazilian Portuguese</option>
            <option value='ru/class.recursivecallbackfilteriterator.php'>Russian</option>
            <option value='tr/class.recursivecallbackfilteriterator.php'>Turkish</option>
            <option value='uk/class.recursivecallbackfilteriterator.php'>Ukrainian</option>
            <option value='zh/class.recursivecallbackfilteriterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.recursivecallbackfilteriterator" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="recursivecallbackfilteriterator.construct.php">RecursiveCallbackFilterIterator::__construct</a> — Create a RecursiveCallbackFilterIterator from a RecursiveIterator</li><li><a href="recursivecallbackfilteriterator.getchildren.php">RecursiveCallbackFilterIterator::getChildren</a> — Return the inner iterator's children contained in a RecursiveCallbackFilterIterator</li><li><a href="recursivecallbackfilteriterator.haschildren.php">RecursiveCallbackFilterIterator::hasChildren</a> — Check whether the inner iterator's current element has children</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/recursivecallbackfilteriterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.recursivecallbackfilteriterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.recursivecallbackfilteriterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.recursivecallbackfilteriterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110974">  <div class="votes">
    <div id="Vu110974">
    <a href="/manual/vote-note.php?id=110974&amp;page=class.recursivecallbackfilteriterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110974">
    <a href="/manual/vote-note.php?id=110974&amp;page=class.recursivecallbackfilteriterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110974" title="90% like this...">
    8
    </div>
  </div>
  <a href="#110974" class="name">
  <strong class="user"><em>a dot belloundja at gmail dot com</em></strong></a><a class="genanchor" href="#110974"> &para;</a><div class="date" title="2013-01-01 11:26"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110974">
<div class="phpcode"><code><span class="html">Here is a code that may implement similar functionality in PHP 5.2 or 5.3 :<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">RecursiveCallbackFilterIterator </span><span class="keyword">extends </span><span class="default">RecursiveFilterIterator </span><span class="keyword">{<br />    <br />    public function </span><span class="default">__construct </span><span class="keyword">( </span><span class="default">RecursiveIterator $iterator</span><span class="keyword">, </span><span class="default">$callback </span><span class="keyword">) {<br />        <br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback </span><span class="keyword">= </span><span class="default">$callback</span><span class="keyword">;<br />        <br />        </span><span class="default">parent</span><span class="keyword">::</span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$iterator</span><span class="keyword">);<br />        <br />    }<br />    <br />    public function </span><span class="default">accept </span><span class="keyword">() {<br />        <br />        </span><span class="default">$callback </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">;<br />        <br />        return </span><span class="default">$callback</span><span class="keyword">(</span><span class="default">parent</span><span class="keyword">::</span><span class="default">current</span><span class="keyword">(), </span><span class="default">parent</span><span class="keyword">::</span><span class="default">key</span><span class="keyword">(), </span><span class="default">parent</span><span class="keyword">::</span><span class="default">getInnerIterator</span><span class="keyword">());<br />        <br />    }<br />    <br />    public function </span><span class="default">getChildren </span><span class="keyword">() {<br />        <br />        return new </span><span class="default">self</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getInnerIterator</span><span class="keyword">()-&gt;</span><span class="default">getChildren</span><span class="keyword">(), </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callback</span><span class="keyword">);<br />        <br />    }<br />    <br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="106848">  <div class="votes">
    <div id="Vu106848">
    <a href="/manual/vote-note.php?id=106848&amp;page=class.recursivecallbackfilteriterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106848">
    <a href="/manual/vote-note.php?id=106848&amp;page=class.recursivecallbackfilteriterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106848" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#106848" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#106848"> &para;</a><div class="date" title="2011-12-11 01:31"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106848">
<div class="phpcode"><code><span class="html">Note that the following filters out both files and directories whos names start with the letter "T". The important thing here is that since the function returns false for a directory entry whos name starts with T, the directory is also not traversed recursively.<br /><br /><span class="default">&lt;?php<br />$doesntStartWithLetterT </span><span class="keyword">= function (</span><span class="default">$current</span><span class="keyword">) {<br />    return </span><span class="default">$current</span><span class="keyword">-&gt;</span><span class="default">getFileName</span><span class="keyword">()[</span><span class="default">0</span><span class="keyword">] !== </span><span class="string">'T'</span><span class="keyword">;<br />};<br /><br /></span><span class="default">$rdi </span><span class="keyword">= new </span><span class="default">RecursiveDirectoryIterator</span><span class="keyword">(</span><span class="default">__DIR__</span><span class="keyword">);<br /></span><span class="default">$files </span><span class="keyword">= new </span><span class="default">RecursiveCallbackFilterIterator</span><span class="keyword">(</span><span class="default">$rdi</span><span class="keyword">, </span><span class="default">$doesntStartWithLetterT</span><span class="keyword">);<br />foreach (new </span><span class="default">RecursiveIteratorIterator</span><span class="keyword">(</span><span class="default">$files</span><span class="keyword">) as </span><span class="default">$file</span><span class="keyword">) {<br />    echo </span><span class="default">$file</span><span class="keyword">-&gt;</span><span class="default">getPathname</span><span class="keyword">() . </span><span class="default">PHP_EOL</span><span class="keyword">;<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.recursivecallbackfilteriterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.recursivecallbackfilteriterator.php">＋<small>add a note</small></a></div>
