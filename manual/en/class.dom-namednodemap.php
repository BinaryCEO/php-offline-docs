...
<head>
  ...
  <title>PHP: Dom\NamedNodeMap - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-namednodemap.php">
 <link rel="shorturl" href="https://www.php.net/dom-namednodemap">
 <link rel="alternate" href="https://www.php.net/dom-namednodemap" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-implementation.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-namespaceinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-namednodemap.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-namednodemap.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-namednodemap.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-namednodemap.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-namednodemap.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-namednodemap.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-namednodemap.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-namednodemap.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-namednodemap.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-namednodemap.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-namednodemap.php" hreflang="zh">
...
<meta name="Description" content="The Dom\NamedNodeMap class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\NamedNodeMap - Manual" />
<meta name="twitter:description" content="The Dom\NamedNodeMap class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\NamedNodeMap - Manual" />
<meta itemprop="description" content="The Dom\NamedNodeMap class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\NamedNodeMap class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dom-namespaceinfo.php">
          Dom\NamespaceInfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-implementation.php">
          &laquo; Dom\Implementation        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-namednodemap.php' selected="selected">English</option>
            <option value='de/class.dom-namednodemap.php'>German</option>
            <option value='es/class.dom-namednodemap.php'>Spanish</option>
            <option value='fr/class.dom-namednodemap.php'>French</option>
            <option value='it/class.dom-namednodemap.php'>Italian</option>
            <option value='ja/class.dom-namednodemap.php'>Japanese</option>
            <option value='pt_BR/class.dom-namednodemap.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-namednodemap.php'>Russian</option>
            <option value='tr/class.dom-namednodemap.php'>Turkish</option>
            <option value='uk/class.dom-namednodemap.php'>Ukrainian</option>
            <option value='zh/class.dom-namednodemap.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-namednodemap" class="reference">
 <h1 class="title">The Dom\NamedNodeMap class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-namednodemap.intro">
  ...
  <div class="section" id="dom-namednodemap.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\NamedNodeMap</strong></strong>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="varname"><a href="class.dom-namednodemap.php#dom-namednodemap.props.length">$<var class="varname">length</var></a></var>;</div>
  ...
  <div class="section" id="dom-namednodemap.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-namednodemap.props.length"><var class="varname">length</var></dt>
     <dd>
      <span class="simpara">The number of attributes.</span>
     </dd>
  ...
  The parser methods auto-detect the encoding or allow the caller to specify an encoding.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-namednodemap.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-namednodemap%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-namednodemap&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-namednodemap.php">＋<small>add a note</small></a></span>
