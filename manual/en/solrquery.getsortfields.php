...
<head>
  ...
  <title>PHP: SolrQuery::getSortFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getsortfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getsortfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getsortfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getrows.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getstart.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getsortfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getsortfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getsortfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getsortfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getsortfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getsortfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getsortfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getsortfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getsortfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getsortfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getsortfields.php" hreflang="zh">
...
<meta name="Description" content="Returns all the sort fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getSortFields - Manual" />
<meta name="twitter:description" content="Returns all the sort fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getSortFields - Manual" />
<meta itemprop="description" content="Returns all the sort fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the sort fields" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getstart.php">
          SolrQuery::getStart &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getrows.php">
          &laquo; SolrQuery::getRows        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getsortfields.php' selected="selected">English</option>
            <option value='de/solrquery.getsortfields.php'>German</option>
            <option value='es/solrquery.getsortfields.php'>Spanish</option>
            <option value='fr/solrquery.getsortfields.php'>French</option>
            <option value='it/solrquery.getsortfields.php'>Italian</option>
            <option value='ja/solrquery.getsortfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getsortfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getsortfields.php'>Russian</option>
            <option value='tr/solrquery.getsortfields.php'>Turkish</option>
            <option value='uk/solrquery.getsortfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getsortfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getsortfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getSortFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getSortFields</span> &mdash; <span class="dc-title">Returns all the sort fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getsortfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getSortFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
...
Returns all the sort fields
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getsortfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getsortfields-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if none of the parameters was set.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getsortfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getsortfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getsortfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getsortfields.php">＋<small>add a note</small></a></span>
