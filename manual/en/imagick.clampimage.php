...
<head>
  ...
  <title>PHP: Imagick::clampImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clampimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clampimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clampimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.chopimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clear.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clampimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clampimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clampimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clampimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clampimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clampimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clampimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clampimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clampimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clampimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clampimage.php" hreflang="zh">
...
<meta name="Description" content="Restricts the color range from 0 to the quantum depth." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clampImage - Manual" />
<meta name="twitter:description" content="Restricts the color range from 0 to the quantum depth." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clampImage - Manual" />
<meta itemprop="description" content="Restricts the color range from 0 to the quantum depth." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restricts the color range from 0 to the quantum depth." />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.clear.php">
          Imagick::clear &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.chopimage.php">
          &laquo; Imagick::chopImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clampimage.php' selected="selected">English</option>
            <option value='de/imagick.clampimage.php'>German</option>
            <option value='es/imagick.clampimage.php'>Spanish</option>
            <option value='fr/imagick.clampimage.php'>French</option>
            <option value='it/imagick.clampimage.php'>Italian</option>
            <option value='ja/imagick.clampimage.php'>Japanese</option>
            <option value='pt_BR/imagick.clampimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clampimage.php'>Russian</option>
            <option value='tr/imagick.clampimage.php'>Turkish</option>
            <option value='uk/imagick.clampimage.php'>Ukrainian</option>
            <option value='zh/imagick.clampimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clampimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::clampImage</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::clampImage</span> &mdash; <span class="dc-title">Restricts the color range from 0 to the quantum depth.</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.clampimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::clampImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.clampimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.clampimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clampimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clampimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clampimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clampimage.php">＋<small>add a note</small></a></span>
