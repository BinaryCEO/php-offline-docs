...
<head>
  ...
  <title>PHP: Gmagick::trimimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.trimimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.trimimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.trimimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.write.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.trimimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.trimimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.trimimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.trimimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.trimimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.trimimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.trimimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.trimimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.trimimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.trimimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.trimimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::trimimage - Manual" />
<meta name="twitter:description" content="Remove edges from the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::trimimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.write.php">
          Gmagick::write &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.thumbnailimage.php">
          &laquo; Gmagick::thumbnailimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.trimimage.php' selected="selected">English</option>
            <option value='de/gmagick.trimimage.php'>German</option>
            <option value='es/gmagick.trimimage.php'>Spanish</option>
            <option value='fr/gmagick.trimimage.php'>French</option>
            <option value='it/gmagick.trimimage.php'>Italian</option>
            <option value='ja/gmagick.trimimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.trimimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.trimimage.php'>Russian</option>
            <option value='tr/gmagick.trimimage.php'>Turkish</option>
            <option value='uk/gmagick.trimimage.php'>Ukrainian</option>
            <option value='zh/gmagick.trimimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.trimimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::trimimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::trimimage</span> &mdash; <span class="dc-title">Remove edges from the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.trimimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::trimimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$fuzz</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.trimimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.trimimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.trimimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/trimimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.trimimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.trimimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.trimimage.php">＋<small>add a note</small></a></span>
