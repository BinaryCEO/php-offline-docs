...
<head>
  ...
  <title>PHP: Gmagick::mapimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.mapimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.mapimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.mapimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.magnifyimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.medianfilterimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.mapimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.mapimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.mapimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.mapimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.mapimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.mapimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.mapimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.mapimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.mapimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.mapimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.mapimage.php" hreflang="zh">
...
<meta name="Description" content="Replaces the colors of an image with the closest color from a reference image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::mapimage - Manual" />
<meta name="twitter:description" content="Replaces the colors of an image with the closest color from a reference image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::mapimage - Manual" />
<meta itemprop="description" content="Replaces the colors of an image with the closest color from a reference image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Replaces the colors of an image with the closest color from a reference image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.medianfilterimage.php">
          Gmagick::medianfilterimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.magnifyimage.php">
          &laquo; Gmagick::magnifyimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.mapimage.php' selected="selected">English</option>
            <option value='de/gmagick.mapimage.php'>German</option>
            <option value='es/gmagick.mapimage.php'>Spanish</option>
            <option value='fr/gmagick.mapimage.php'>French</option>
            <option value='it/gmagick.mapimage.php'>Italian</option>
            <option value='ja/gmagick.mapimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.mapimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.mapimage.php'>Russian</option>
            <option value='tr/gmagick.mapimage.php'>Turkish</option>
            <option value='uk/gmagick.mapimage.php'>Ukrainian</option>
            <option value='zh/gmagick.mapimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.mapimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::mapimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::mapimage</span> &mdash; <span class="dc-title">Replaces the colors of an image with the closest color from a reference image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.mapimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::mapimage</strong></span>(<span class="methodparam"><span class="type"><a href="class.gmagick.php" class="type gmagick">gmagick</a></span> <code class="parameter">$gmagick</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$dither</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.mapimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">gmagick</code></dt>
     <dd>
      <p class="para">
       The reference image.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.mapimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.mapimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/mapimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.mapimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.mapimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.mapimage.php">＋<small>add a note</small></a></span>
