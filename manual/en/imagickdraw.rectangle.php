...
<head>
  ...
  <title>PHP: ImagickDraw::rectangle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.rectangle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.rectangle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.rectangle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pushpattern.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.render.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.rectangle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.rectangle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.rectangle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.rectangle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.rectangle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.rectangle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.rectangle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.rectangle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.rectangle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.rectangle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.rectangle.php" hreflang="zh">
...
<meta name="Description" content="Draws a rectangle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::rectangle - Manual" />
<meta name="twitter:description" content="Draws a rectangle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::rectangle - Manual" />
<meta itemprop="description" content="Draws a rectangle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a rectangle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.render.php">
          ImagickDraw::render &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pushpattern.php">
          &laquo; ImagickDraw::pushPattern        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.rectangle.php' selected="selected">English</option>
            <option value='de/imagickdraw.rectangle.php'>German</option>
            <option value='es/imagickdraw.rectangle.php'>Spanish</option>
            <option value='fr/imagickdraw.rectangle.php'>French</option>
            <option value='it/imagickdraw.rectangle.php'>Italian</option>
            <option value='ja/imagickdraw.rectangle.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.rectangle.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.rectangle.php'>Russian</option>
            <option value='tr/imagickdraw.rectangle.php'>Turkish</option>
            <option value='uk/imagickdraw.rectangle.php'>Ukrainian</option>
            <option value='zh/imagickdraw.rectangle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.rectangle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::rectangle</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::rectangle</span> &mdash; <span class="dc-title">Draws a rectangle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.rectangle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::rectangle</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$top_left_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$top_left_y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$bottom_right_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$bottom_right_y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.rectangle-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">top_left_x</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">top_left_y</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">bottom_right_x</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">bottom_right_y</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.rectangle-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.rectangle-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3163">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::rectangle()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/rectangle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.rectangle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.rectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.rectangle.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96464">  <div class="votes">
    <div id="Vu96464">
    <a href="/manual/vote-note.php?id=96464&amp;page=imagickdraw.rectangle&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96464">
    <a href="/manual/vote-note.php?id=96464&amp;page=imagickdraw.rectangle&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96464" title="83% like this...">
    8
    </div>
  </div>
  <a href="#96464" class="name">
  <strong class="user"><em>garym at binaryfarm dot com</em></strong></a><a class="genanchor" href="#96464"> &para;</a><div class="date" title="2010-02-28 04:32"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96464">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br /></span><span class="comment">// Draw a simple rectangle or three for the newbies.<br />// I'm trying to comment these as best I can for a non-OOP person.<br />// commets or criticism are welcome. Gary Melander<br /><br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();    </span><span class="comment">// Create a new instance an $image class<br /><br /></span><span class="default">$width </span><span class="keyword">=  </span><span class="default">600</span><span class="keyword">;        </span><span class="comment">// Some necessary dimensions<br /></span><span class="default">$height </span><span class="keyword">= </span><span class="default">400</span><span class="keyword">; <br /><br /></span><span class="comment">// $image class now inherits some attributes. i.e. Dimensions, bkgcolor...<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">( </span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">, new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'lightgray' </span><span class="keyword">) );<br /><br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw</span><span class="keyword">();    </span><span class="comment">//Create a new drawing class (?)<br /><br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'wheat'</span><span class="keyword">);    </span><span class="comment">// Set up some colors to use for fill and outline<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'green' </span><span class="keyword">) );<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">( </span><span class="default">100</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">200</span><span class="keyword">, </span><span class="default">200 </span><span class="keyword">);    </span><span class="comment">// Draw the rectangle <br /><br />// Lets draw another<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'navy'</span><span class="keyword">);    </span><span class="comment">// Set up some colors to use for fill and outline<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'yellow' </span><span class="keyword">) );<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeWidth</span><span class="keyword">(</span><span class="default">4</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">( </span><span class="default">150</span><span class="keyword">, </span><span class="default">225</span><span class="keyword">, </span><span class="default">350</span><span class="keyword">, </span><span class="default">300 </span><span class="keyword">);    </span><span class="comment">// Draw the rectangle <br /><br />// and another<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="string">'magenta'</span><span class="keyword">);    </span><span class="comment">// Set up some colors to use for fill and outline<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'cyan' </span><span class="keyword">) );<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setStrokeWidth</span><span class="keyword">(</span><span class="default">2</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">rectangle</span><span class="keyword">( </span><span class="default">380</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">400</span><span class="keyword">, </span><span class="default">350 </span><span class="keyword">);    </span><span class="comment">// Draw the rectangle <br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">( </span><span class="default">$draw </span><span class="keyword">);    </span><span class="comment">// Apply the stuff from the draw class to the image canvas<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'jpg'</span><span class="keyword">);    </span><span class="comment">// Give the image a format<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/jpeg'</span><span class="keyword">);     </span><span class="comment">// Prepare the web browser to display an image<br /></span><span class="keyword">echo </span><span class="default">$image</span><span class="keyword">;                </span><span class="comment">// Publish it to the world!<br /><br />//$image-&gt;writeImage('someimage.jpg");    // ...Or just write it to a file...<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.rectangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.rectangle.php">＋<small>add a note</small></a></div>
