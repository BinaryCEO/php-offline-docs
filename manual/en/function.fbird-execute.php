...
<head>
  ...
  <title>PHP: fbird_execute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-execute.php">
 <link rel="shorturl" href="https://www.php.net/fbird-execute">
 <link rel="alternate" href="https://www.php.net/fbird-execute" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-errmsg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-execute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-execute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-execute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-execute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-execute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-execute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-execute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-execute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-execute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-execute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-execute.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_execute" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_execute - Manual" />
<meta name="twitter:description" content="Alias of ibase_execute" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_execute - Manual" />
<meta itemprop="description" content="Alias of ibase_execute" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_execute" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-fetch-assoc.php">
          fbird_fetch_assoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-errmsg.php">
          &laquo; fbird_errmsg        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-execute.php' selected="selected">English</option>
            <option value='de/function.fbird-execute.php'>German</option>
            <option value='es/function.fbird-execute.php'>Spanish</option>
            <option value='fr/function.fbird-execute.php'>French</option>
            <option value='it/function.fbird-execute.php'>Italian</option>
            <option value='ja/function.fbird-execute.php'>Japanese</option>
            <option value='pt_BR/function.fbird-execute.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-execute.php'>Russian</option>
            <option value='tr/function.fbird-execute.php'>Turkish</option>
            <option value='uk/function.fbird-execute.php'>Ukrainian</option>
            <option value='zh/function.fbird-execute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-execute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_execute</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_execute</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-execute.php" class="function">ibase_execute()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-execute-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-execute-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-query.php" class="function" rel="rdfs-seeAlso">fbird_query()</a> - Alias of ibase_query</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-execute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-execute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-execute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-execute.php">＋<small>add a note</small></a></span>
