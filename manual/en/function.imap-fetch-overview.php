...
<head>
  ...
  <title>PHP: imap_fetch_overview - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-fetch-overview.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-expunge.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-fetchbody.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-fetch-overview.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-fetch-overview.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-fetch-overview.php" hreflang="uk">
...
<meta name="Description" content="Read an overview of the information in the headers of the given message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_fetch_overview - Manual" />
<meta name="twitter:description" content="Read an overview of the information in the headers of the given message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_fetch_overview - Manual" />
<meta itemprop="description" content="Read an overview of the information in the headers of the given message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read an overview of the information in the headers of the given message" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-fetchbody.php">
          imap_fetchbody &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-expunge.php">
          &laquo; imap_expunge        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-fetch-overview.php' selected="selected">English</option>
            <option value='de/function.imap-fetch-overview.php'>German</option>
            <option value='es/function.imap-fetch-overview.php'>Spanish</option>
            <option value='fr/function.imap-fetch-overview.php'>French</option>
            <option value='it/function.imap-fetch-overview.php'>Italian</option>
            <option value='ja/function.imap-fetch-overview.php'>Japanese</option>
            <option value='pt_BR/function.imap-fetch-overview.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-fetch-overview.php'>Russian</option>
            <option value='tr/function.imap-fetch-overview.php'>Turkish</option>
            <option value='uk/function.imap-fetch-overview.php'>Ukrainian</option>
            <option value='zh/function.imap-fetch-overview.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-fetch-overview" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.imap-fetch-overview-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_fetch_overview</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$sequence</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.imap-fetch-overview-examples">
  ...
  <p class="para">
   <div class="example" id="example-3229">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mbox </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_open</span><span style="color: #007700">(</span><span style="color: #DD0000">"{imap.example.org:143}INBOX"</span><span style="color: #007700">, </span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">)<br />     or die(</span><span style="color: #DD0000">"can't connect: " </span><span style="color: #007700">. </span><span style="color: #0000BB">imap_last_error</span><span style="color: #007700">());<br /><br /></span><span style="color: #0000BB">$MC </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_check</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Fetch an overview for all messages in INBOX<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">imap_fetch_overview</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">,</span><span style="color: #DD0000">"1:</span><span style="color: #007700">{</span><span style="color: #0000BB">$MC</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">Nmsgs</span><span style="color: #007700">}</span><span style="color: #DD0000">"</span><span style="color: #007700">,</span><span style="color: #0000BB">0</span><span style="color: #007700">);<br />foreach (</span><span style="color: #0000BB">$result </span><span style="color: #007700">as </span><span style="color: #0000BB">$overview</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"#</span><span style="color: #007700">{</span><span style="color: #0000BB">$overview</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">msgno</span><span style="color: #007700">}</span><span style="color: #DD0000"> (</span><span style="color: #007700">{</span><span style="color: #0000BB">$overview</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">date</span><span style="color: #007700">}</span><span style="color: #DD0000">) - From: </span><span style="color: #007700">{</span><span style="color: #0000BB">$overview</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">from</span><span style="color: #007700">}</span><span style="color: #DD0000"><br />    </span><span style="color: #007700">{</span><span style="color: #0000BB">$overview</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">subject</span><span style="color: #007700">}</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">imap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$mbox</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-fetch-overview-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-fetchheader.php" class="function" rel="rdfs-seeAlso">imap_fetchheader()</a> - Returns header for a message</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-fetch-overview.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-fetch-overview%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-fetch-overview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-fetch-overview.php">＋<small>add a note</small></a></span>
