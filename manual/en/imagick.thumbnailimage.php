...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.thumbnailimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.thumbnailimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.thumbnailimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.thresholdimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.tintimage.php">
...
<meta name="Description" content="Changes the size of an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::thumbnailImage - Manual" />
<meta name="twitter:description" content="Changes the size of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::thumbnailImage - Manual" />
<meta itemprop="description" content="Changes the size of an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes the size of an image" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.thumbnailimage.php' selected="selected">English</option>
            <option value='de/imagick.thumbnailimage.php'>German</option>
            <option value='es/imagick.thumbnailimage.php'>Spanish</option>
 ...
 <div class="refsect1 description" id="refsect1-imagick.thumbnailimage-description">
  ...
  <p class="para rdfs-comment">
   ...
   If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> is given as a third parameter then columns and rows parameters
 ...
 <div class="refsect1 examples" id="refsect1-imagick.thumbnailimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3132">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/thumbnailimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.thumbnailimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.thumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.thumbnailimage.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If the 3rd parameter is true, the image will be resized in such a way that it’ll be contained within the dimensions mentioned.<br />It’s like changing the dimensions of the image so that it can be contained in a box of given dimension.<br /><br />Eg: Image’s dimension is 1600*800. If we use thumbnailImage(400, 400, true), the new image’s dimension will be 400*200.<br /><br />Some of the previous notes in this page mentions that the image is resized proportionally so that its _smallest_ dimension matches the width or height specified, NOT both.<br />But this is not the case now. Both width &amp; height of the image will be &lt;= that mentioned in thumbnailImage().<br />Maybe imagick changed/updated the functionality.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">When shrinking a jpg you can get more then double the performance if you use <span class="default">&lt;?php $image</span><span class="keyword">-&gt;</span><span class="default">setOption</span><span class="keyword">(</span><span class="string">'jpeg:size'</span><span class="keyword">, </span><span class="string">'800x532'</span><span class="keyword">) </span><span class="default">?&gt;</span>, exchanging 800x532 to the resolution you want the final image to be. For instance instead of this:<br /><br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'foo.jpg'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />You would use this:<br /><br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setOption</span><span class="keyword">(</span><span class="string">'jpeg:size'</span><span class="keyword">, </span><span class="string">'800x532'</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'foo.jpg'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you want to resize your picture to fit smallest parameter:<br /><br />$fitbyWidth = (($maxWidth/$w)&lt;($maxHeight/$h)) ?true:false;<br /><br />if($fitbyWidth){<br />    $im-&gt;thumbnailImage($maxWidth, 0, false);<br />}else{<br />    $im-&gt;thumbnailImage(0, $maxHeight, false);<br />}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">As noted here<br /><a href="http://php.net/manual/en/ref.imagick.php" rel="nofollow" target="_blank">http://php.net/manual/en/ref.imagick.php</a><br />With either of the params as 0, the aspect ratio is maintained.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>sgarner at expio dot co dot nz</em></strong></a><a class="genanchor" href="#78553"> &para;</a><div class="date" title="2007-10-16 10:11"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78553">
<div class="phpcode"><code><span class="html">With $fit == true, the image is resized proportionally so that its _smallest_ dimension matches the width or height specified, NOT both.<br /><br />For example, if you say thumbnailImage(400, 400, true), on an image of 1600x800, it will be resized to 800x400, NOT 400x200 as you might expect.<br /><br />The solution is to compare the original image's dimensions to the specified dimensions, and substitute zero for the smaller dimension, and set $fit = false.<br /><br />i.e.: thumbnailImage(400, 0, false) would resize that 1600x800 image to 400x200.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.thumbnailimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.thumbnailimage.php">＋<small>add a note</small></a></div>
