...
<head>
  ...
  <title>PHP: ibase_blob_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-open.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-open">
 <link rel="alternate" href="https://www.php.net/ibase-blob-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-open.php" hreflang="zh">
...
<meta name="Description" content="Open blob for retrieving data parts" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_open - Manual" />
<meta name="twitter:description" content="Open blob for retrieving data parts" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_open - Manual" />
<meta itemprop="description" content="Open blob for retrieving data parts" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open blob for retrieving data parts" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-close.php">
          ibase_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-info.php">
          &laquo; ibase_blob_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-open.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-open.php'>German</option>
            <option value='es/function.ibase-blob-open.php'>Spanish</option>
            <option value='fr/function.ibase-blob-open.php'>French</option>
            <option value='it/function.ibase-blob-open.php'>Italian</option>
            <option value='ja/function.ibase-blob-open.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-open.php'>Russian</option>
            <option value='tr/function.ibase-blob-open.php'>Turkish</option>
            <option value='uk/function.ibase-blob-open.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-open" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_blob_open</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_open</span> &mdash; <span class="dc-title">Open blob for retrieving data parts</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-blob-open-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_blob_open</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$blob_id</code></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>ibase_blob_open</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$blob_id</code></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-open-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-open-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a BLOB handle for later use with 
   <span class="function"><a href="function.ibase-blob-get.php" class="function">ibase_blob_get()</a></span> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.ibase-blob-open-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-echo.php" class="function" rel="rdfs-seeAlso">ibase_blob_echo()</a> - Output blob contents to browser</span></li>
    <li><span class="function"><a href="function.ibase-blob-get.php" class="function" rel="rdfs-seeAlso">ibase_blob_get()</a> - Get len bytes data from open blob</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-open.php">＋<small>add a note</small></a></span>
