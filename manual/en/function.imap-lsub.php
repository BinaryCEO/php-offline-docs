...
<head>
  ...
  <title>PHP: imap_lsub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-lsub.php">
 <link rel="shorturl" href="https://www.php.net/imap-lsub">
 <link rel="alternate" href="https://www.php.net/imap-lsub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-listsubscribed.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-mail.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-lsub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-lsub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-lsub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-lsub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-lsub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-lsub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-lsub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-lsub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-lsub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-lsub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-lsub.php" hreflang="zh">
...
<meta name="Description" content="List all the subscribed mailboxes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_lsub - Manual" />
<meta name="twitter:description" content="List all the subscribed mailboxes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_lsub - Manual" />
<meta itemprop="description" content="List all the subscribed mailboxes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List all the subscribed mailboxes" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-mail.php">
          imap_mail &raquo;
              ...
              <div class="prev">
        <a href="function.imap-listsubscribed.php">
          &laquo; imap_listsubscribed        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-lsub.php' selected="selected">English</option>
            <option value='de/function.imap-lsub.php'>German</option>
            <option value='es/function.imap-lsub.php'>Spanish</option>
            <option value='fr/function.imap-lsub.php'>French</option>
            <option value='it/function.imap-lsub.php'>Italian</option>
            <option value='ja/function.imap-lsub.php'>Japanese</option>
            <option value='pt_BR/function.imap-lsub.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-lsub.php'>Russian</option>
            <option value='tr/function.imap-lsub.php'>Turkish</option>
            <option value='uk/function.imap-lsub.php'>Ukrainian</option>
            <option value='zh/function.imap-lsub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-lsub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_lsub</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_lsub</span> &mdash; <span class="dc-title">List all the subscribed mailboxes</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-lsub-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_lsub</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$reference</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-lsub-parameters">
...
mailboxes; &#039;<code class="literal">~/mail/%</code>&#039; on <code class="literal">UW_IMAPD</code> will return every mailbox in the <var class="filename">~/mail</var> directory, but none in subfolders of that directory.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-lsub-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array of all the subscribed mailboxes,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imap-lsub-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-lsub-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-list.php" class="function" rel="rdfs-seeAlso">imap_list()</a> - Read the list of mailboxes</span></li>
    <li><span class="function"><a href="function.imap-getmailboxes.php" class="function" rel="rdfs-seeAlso">imap_getmailboxes()</a> - Read the list of mailboxes, returning detailed information on each one</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-lsub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-lsub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-lsub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-lsub.php">＋<small>add a note</small></a></span>
