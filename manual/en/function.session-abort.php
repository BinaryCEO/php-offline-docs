...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.session-abort.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.session.php">
 <link rel="next" href="https://www.php.net/manual/en/function.session-cache-expire.php">
...
<meta name="Description" content="Discard session array changes and finish session" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: session_abort - Manual" />
<meta name="twitter:description" content="Discard session array changes and finish session" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: session_abort - Manual" />
<meta itemprop="description" content="Discard session array changes and finish session" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Discard session array changes and finish session" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.session-abort.php' selected="selected">English</option>
            ...
            <option value='ja/function.session-abort.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">session_abort</span> &mdash; <span class="dc-title">Discard session array changes and finish session</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.session-abort-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>session_abort()</strong></span> finishes session without saving
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.session-commit.php" class="function" rel="rdfs-seeAlso">session_commit()</a> - Alias of session_write_close</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/session/functions/session-abort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.session-abort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.session-abort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.session-abort.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="117936">  <div class="votes">
    ...
    <div class="tally" id="V117936" title="57% like this...">
    14
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">session_abort()  closes the current session and discards the changes applied to Session array in the current page  , it doesn't delete the session file <br />let me explain with one example. <br />page 1.php :<br /><span class="default">&lt;?php<br />session_start</span><span class="keyword">();<br /></span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'city'</span><span class="keyword">]=</span><span class="string">"Sydney"</span><span class="keyword">;<br />echo </span><span class="string">"&lt;a href=\"2.php\"&gt; page2&lt;/a&gt;"</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span>when you open this page , a session file is created on the server (to find out where session files are saved run "echo session_save_path()" )  with the name of session_id  and the content of  the variable :<br /><br />  sess_o22iabs75j93uhc7i4jf1lecjk  (file name)<br />  city|s:6:"Sydney";               (content)<br /><br />if we go to 2.php containing this code :<br /><br /><span class="default">&lt;?php<br />session_start</span><span class="keyword">();<br /></span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'country'</span><span class="keyword">]=</span><span class="string">"Australia"</span><span class="keyword">;<br />echo </span><span class="default">session_encode</span><span class="keyword">();<br /></span><span class="default">session_abort</span><span class="keyword">();<br /></span><span class="default">session_start</span><span class="keyword">();<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">.</span><span class="default">session_encode</span><span class="keyword">();<br /></span><span class="default">?&gt;<br /></span><br />when session_abort is executed , the session is closed and the change which here is the 'country' element of Session array is discarded . <br /><br />Output : <br />city|s:6:"Sydney";country|s:9:"Australia";<br />city|s:6:"Sydney";</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.session-abort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.session-abort.php">＋<small>add a note</small></a></div>
