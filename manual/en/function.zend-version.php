...
<head>
  ...
  <title>PHP: zend_version - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.zend-version.php">
 <link rel="shorturl" href="https://www.php.net/zend-version">
 <link rel="alternate" href="https://www.php.net/zend-version" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.zend-thread-id.php">
 <link rel="next" href="https://www.php.net/manual/en/book.phpdbg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.zend-version.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.zend-version.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.zend-version.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.zend-version.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.zend-version.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.zend-version.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.zend-version.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.zend-version.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.zend-version.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.zend-version.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.zend-version.php" hreflang="zh">
...
<meta name="Description" content="Gets the version of the current Zend engine" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: zend_version - Manual" />
<meta name="twitter:description" content="Gets the version of the current Zend engine" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: zend_version - Manual" />
<meta itemprop="description" content="Gets the version of the current Zend engine" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the version of the current Zend engine" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.phpdbg.php">
          phpdbg &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.zend-thread-id.php">
          &laquo; zend_thread_id        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.zend-version.php' selected="selected">English</option>
            <option value='de/function.zend-version.php'>German</option>
            <option value='es/function.zend-version.php'>Spanish</option>
            <option value='fr/function.zend-version.php'>French</option>
            <option value='it/function.zend-version.php'>Italian</option>
            <option value='ja/function.zend-version.php'>Japanese</option>
            <option value='pt_BR/function.zend-version.php'>Brazilian Portuguese</option>
            <option value='ru/function.zend-version.php'>Russian</option>
            <option value='tr/function.zend-version.php'>Turkish</option>
            <option value='uk/function.zend-version.php'>Ukrainian</option>
            <option value='zh/function.zend-version.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.zend-version" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">zend_version</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">zend_version</span> &mdash; <span class="dc-title">Gets the version of the current Zend engine</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-function.zend-version-examples">
  ...
  <p class="para">
   <div class="example" id="example-682">
    <p><strong>Example #1 <span class="function"><strong>zend_version()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.phpversion.php" class="function" rel="rdfs-seeAlso">phpversion()</a> - Gets the current PHP version</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/zend-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.zend-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.zend-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.zend-version.php">＋<small>add a note</small></a></span>
