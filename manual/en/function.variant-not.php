...
<head>
  ...
  <title>PHP: variant_not - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-not.php">
 <link rel="shorturl" href="https://www.php.net/variant-not">
 <link rel="alternate" href="https://www.php.net/variant-not" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-neg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-or.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-not.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-not.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-not.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-not.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-not.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-not.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-not.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-not.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-not.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-not.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-not.php" hreflang="zh">
...
<meta name="Description" content="Performs bitwise not negation on a variant" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_not - Manual" />
<meta name="twitter:description" content="Performs bitwise not negation on a variant" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_not - Manual" />
<meta itemprop="description" content="Performs bitwise not negation on a variant" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs bitwise not negation on a variant" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-not.php' selected="selected">English</option>
            <option value='de/function.variant-not.php'>German</option>
            <option value='es/function.variant-not.php'>Spanish</option>
            <option value='fr/function.variant-not.php'>French</option>
            <option value='it/function.variant-not.php'>Italian</option>
            <option value='ja/function.variant-not.php'>Japanese</option>
            <option value='pt_BR/function.variant-not.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-not.php'>Russian</option>
            <option value='tr/function.variant-not.php'>Turkish</option>
            <option value='uk/function.variant-not.php'>Ukrainian</option>
            <option value='zh/function.variant-not.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-not" class="refentry">
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.com-exception.php" class="classname">com_exception</a></span> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-not.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-not%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-not&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-not.php">＋<small>add a note</small></a></span>
