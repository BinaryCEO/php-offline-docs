...
<head>
  ...
  <title>PHP: ps_place_image - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-place-image.php">
 <link rel="shorturl" href="https://www.php.net/ps-place-image">
 <link rel="alternate" href="https://www.php.net/ps-place-image" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-open-memory-image.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-rect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-place-image.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-place-image.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-place-image.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-place-image.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-place-image.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-place-image.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-place-image.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-place-image.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-place-image.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-place-image.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-place-image.php" hreflang="zh">
...
<meta name="Description" content="Places image on the page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_place_image - Manual" />
<meta name="twitter:description" content="Places image on the page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_place_image - Manual" />
<meta itemprop="description" content="Places image on the page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Places image on the page" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-rect.php">
          ps_rect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-open-memory-image.php">
          &laquo; ps_open_memory_image        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-place-image.php' selected="selected">English</option>
            <option value='de/function.ps-place-image.php'>German</option>
            <option value='es/function.ps-place-image.php'>Spanish</option>
            <option value='fr/function.ps-place-image.php'>French</option>
            <option value='it/function.ps-place-image.php'>Italian</option>
            <option value='ja/function.ps-place-image.php'>Japanese</option>
            <option value='pt_BR/function.ps-place-image.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-place-image.php'>Russian</option>
            <option value='tr/function.ps-place-image.php'>Turkish</option>
            <option value='uk/function.ps-place-image.php'>Ukrainian</option>
            <option value='zh/function.ps-place-image.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-place-image" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_place_image</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_place_image</span> &mdash; <span class="dc-title">Places image on the page</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-place-image-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_place_image</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$imageid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$scale</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   coordinate system before with <span class="function"><a href="function.ps-rotate.php" class="function">ps_rotate()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ps-place-image-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">imageid</code></dt>
     <dd>
      <p class="para">
       The resource identifier of the image as returned by 
       <span class="function"><a href="function.ps-open-image.php" class="function">ps_open_image()</a></span> or
       <span class="function"><a href="function.ps-open-image-file.php" class="function">ps_open_image_file()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-place-image-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-place-image-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-open-image.php" class="function" rel="rdfs-seeAlso">ps_open_image()</a> - Reads an image for later placement</span></li>
    <li><span class="function"><a href="function.ps-open-image-file.php" class="function" rel="rdfs-seeAlso">ps_open_image_file()</a> - Opens image from file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-place-image.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-place-image%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-place-image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-place-image.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="75104">  <div class="votes">
    <div id="Vu75104">
    <a href="/manual/vote-note.php?id=75104&amp;page=function.ps-place-image&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd75104">
    <a href="/manual/vote-note.php?id=75104&amp;page=function.ps-place-image&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V75104" title="66% like this...">
    1
    </div>
  </div>
  <a href="#75104" class="name">
  <strong class="user"><em>mike at lasaero dot com</em></strong></a><a class="genanchor" href="#75104"> &para;</a><div class="date" title="2007-05-12 06:11"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom75104">
<div class="phpcode"><code><span class="html">To get png images to work I had to save them as indexed colour (128 colours).</span></code></div>
  </div>
 </div>
  <div class="note" id="91517">  <div class="votes">
    <div id="Vu91517">
    <a href="/manual/vote-note.php?id=91517&amp;page=function.ps-place-image&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91517">
    <a href="/manual/vote-note.php?id=91517&amp;page=function.ps-place-image&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91517" title="50% like this...">
    0
    </div>
  </div>
  <a href="#91517" class="name">
  <strong class="user"><em>php at catchall dot toao dot net</em></strong></a><a class="genanchor" href="#91517"> &para;</a><div class="date" title="2009-06-14 02:05"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91517">
<div class="phpcode"><code><span class="html">If you want to make a template with graphics software and place it on your PostScript page, one way to do it is with an eps file.<br /><br /><span class="default">&lt;?php<br />$template </span><span class="keyword">= </span><span class="default">ps_open_image_file</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="string">'eps'</span><span class="keyword">, </span><span class="string">'template.eps'</span><span class="keyword">);<br /></span><span class="default">ps_place_image</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="default">$template</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Professional page layout software such as InDesign will typically be able to generate an eps file.  If your software can't, one way to do it (on Windows) is to set up a printer that prints to file with the driver "Lexmark Color 4079 plus PS".  This driver is included with Windows and has the option in its advanced preferences to generate an EPS file.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-place-image&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-place-image.php">＋<small>add a note</small></a></div>
