...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightRegexMaxAnalyzedChars - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlightquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightregexpattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightregexmaxanalyzedchars.php" hreflang="zh">
...
<meta name="Description" content="Specify the maximum number of characters to analyze" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightRegexMaxAnalyzedChars - Manual" />
<meta name="twitter:description" content="Specify the maximum number of characters to analyze" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightRegexMaxAnalyzedChars - Manual" />
<meta itemprop="description" content="Specify the maximum number of characters to analyze" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specify the maximum number of characters to analyze" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.sethighlightregexpattern.php">
          SolrQuery::setHighlightRegexPattern &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlightquery.php">
          &laquo; SolrQuery::setHighlightQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightregexmaxanalyzedchars.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightregexmaxanalyzedchars.php'>German</option>
            <option value='es/solrquery.sethighlightregexmaxanalyzedchars.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightregexmaxanalyzedchars.php'>French</option>
            <option value='it/solrquery.sethighlightregexmaxanalyzedchars.php'>Italian</option>
            <option value='ja/solrquery.sethighlightregexmaxanalyzedchars.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightregexmaxanalyzedchars.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightregexmaxanalyzedchars.php'>Russian</option>
            <option value='tr/solrquery.sethighlightregexmaxanalyzedchars.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightregexmaxanalyzedchars.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightregexmaxanalyzedchars.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightregexmaxanalyzedchars" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightRegexMaxAnalyzedChars</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightRegexMaxAnalyzedChars</span> &mdash; <span class="dc-title">Specify the maximum number of characters to analyze</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightregexmaxanalyzedchars-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightRegexMaxAnalyzedChars</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$maxAnalyzedChars</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightregexmaxanalyzedchars-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">maxAnalyzedChars</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightregexmaxanalyzedchars-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightregexmaxanalyzedchars.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightregexmaxanalyzedchars%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightregexmaxanalyzedchars&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightregexmaxanalyzedchars.php">＋<small>add a note</small></a></span>
