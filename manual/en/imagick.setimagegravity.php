...
<head>
  ...
  <title>PHP: Imagick::setImageGravity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagegravity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagegravity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagegravity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagegamma.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagegravity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagegravity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagegravity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagegravity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagegravity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagegravity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagegravity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagegravity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagegravity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagegravity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagegravity.php" hreflang="zh">
...
<meta name="Description" content="Sets the image gravity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageGravity - Manual" />
<meta name="twitter:description" content="Sets the image gravity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageGravity - Manual" />
<meta itemprop="description" content="Sets the image gravity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image gravity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagegreenprimary.php">
          Imagick::setImageGreenPrimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagegamma.php">
          &laquo; Imagick::setImageGamma        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagegravity.php' selected="selected">English</option>
            <option value='de/imagick.setimagegravity.php'>German</option>
            <option value='es/imagick.setimagegravity.php'>Spanish</option>
            <option value='fr/imagick.setimagegravity.php'>French</option>
            <option value='it/imagick.setimagegravity.php'>Italian</option>
            <option value='ja/imagick.setimagegravity.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagegravity.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagegravity.php'>Russian</option>
            <option value='tr/imagick.setimagegravity.php'>Turkish</option>
            <option value='uk/imagick.setimagegravity.php'>Ukrainian</option>
            <option value='zh/imagick.setimagegravity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagegravity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageGravity</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageGravity</span> &mdash; <span class="dc-title">Sets the image gravity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagegravity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageGravity</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$gravity</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagegravity-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagegravity-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagegravity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagegravity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagegravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagegravity.php">＋<small>add a note</small></a></span>
