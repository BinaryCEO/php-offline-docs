...
<head>
  ...
  <title>PHP: odbc_field_len - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-field-len.php">
 <link rel="shorturl" href="https://www.php.net/odbc-field-len">
 <link rel="alternate" href="https://www.php.net/odbc-field-len" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-fetch-row.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-field-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-field-len.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-field-len.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-field-len.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-field-len.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-field-len.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-field-len.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-field-len.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-field-len.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-field-len.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-field-len.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-field-len.php" hreflang="zh">
...
<meta name="Description" content="Get the length (precision) of a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_field_len - Manual" />
<meta name="twitter:description" content="Get the length (precision) of a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_field_len - Manual" />
<meta itemprop="description" content="Get the length (precision) of a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the length (precision) of a field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.odbc-field-name.php">
          odbc_field_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-fetch-row.php">
          &laquo; odbc_fetch_row        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-field-len.php' selected="selected">English</option>
            <option value='de/function.odbc-field-len.php'>German</option>
            <option value='es/function.odbc-field-len.php'>Spanish</option>
            <option value='fr/function.odbc-field-len.php'>French</option>
            <option value='it/function.odbc-field-len.php'>Italian</option>
            <option value='ja/function.odbc-field-len.php'>Japanese</option>
            <option value='pt_BR/function.odbc-field-len.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-field-len.php'>Russian</option>
            <option value='tr/function.odbc-field-len.php'>Turkish</option>
            <option value='uk/function.odbc-field-len.php'>Ukrainian</option>
            <option value='zh/function.odbc-field-len.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-field-len" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_field_len</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_field_len</span> &mdash; <span class="dc-title">Get the length (precision) of a field</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-field-len-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_field_len</strong></span>(<span class="methodparam"><span class="type">Odbc\Result</span> <code class="parameter">$statement</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-field-len-returnvalues">
  ...
  <p class="para">
   Returns the field length, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.odbc-field-len-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.odbc-field-len-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.odbc-field-scale.php" class="function" rel="rdfs-seeAlso">odbc_field_scale()</a> - Get the scale of a field</span> to get the scale of a
    floating point number</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-field-len.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-field-len%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-field-len&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-field-len.php">＋<small>add a note</small></a></span>
