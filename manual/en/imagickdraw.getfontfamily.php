...
<head>
  ...
  <title>PHP: ImagickDraw::getFontFamily - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getfont.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getfontsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getfontfamily.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getfontfamily.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getfontfamily.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getfontfamily.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getfontfamily.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getfontfamily.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getfontfamily.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getfontfamily.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getfontfamily.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getfontfamily.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getfontfamily.php" hreflang="zh">
...
<meta name="Description" content="Returns the font family" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getFontFamily - Manual" />
<meta name="twitter:description" content="Returns the font family" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getFontFamily - Manual" />
<meta itemprop="description" content="Returns the font family" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the font family" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.getfontsize.php">
          ImagickDraw::getFontSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getfont.php">
          &laquo; ImagickDraw::getFont        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getfontfamily.php' selected="selected">English</option>
            <option value='de/imagickdraw.getfontfamily.php'>German</option>
            <option value='es/imagickdraw.getfontfamily.php'>Spanish</option>
            <option value='fr/imagickdraw.getfontfamily.php'>French</option>
            <option value='it/imagickdraw.getfontfamily.php'>Italian</option>
            <option value='ja/imagickdraw.getfontfamily.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getfontfamily.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getfontfamily.php'>Russian</option>
            <option value='tr/imagickdraw.getfontfamily.php'>Turkish</option>
            <option value='uk/imagickdraw.getfontfamily.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getfontfamily.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getfontfamily" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getFontFamily</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getFontFamily</span> &mdash; <span class="dc-title">Returns the font family</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getfontfamily-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getFontFamily</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getfontfamily-returnvalues">
  ...
  <p class="para">
   Returns the font family currently selected or false if font family is not set. 
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getfontfamily.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getfontfamily%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getfontfamily&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getfontfamily.php">＋<small>add a note</small></a></span>
