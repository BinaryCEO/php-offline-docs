...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrinputdocument.addchilddocuments.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrinputdocument.addchilddocuments.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrinputdocument.addchilddocuments.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrinputdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrinputdocument.addchilddocument.php">
 <link rel="next" href="https://www.php.net/manual/en/solrinputdocument.addfield.php">
...
<meta name="Description" content="Adds an array of child documents" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrInputDocument::addChildDocuments - Manual" />
<meta name="twitter:description" content="Adds an array of child documents" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrInputDocument::addChildDocuments - Manual" />
<meta itemprop="description" content="Adds an array of child documents" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds an array of child documents" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrinputdocument.addchilddocuments.php' selected="selected">English</option>
            ...
            <option value='ru/solrinputdocument.addchilddocuments.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 2.3.0)</p><p class="refpurpose"><span class="refname">SolrInputDocument::addChildDocuments</span> &mdash; <span class="dc-title">Adds an array of child documents</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-solrinputdocument.addchilddocuments-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of <span class="type"><a href="class.solrinputdocument.php" class="type SolrInputDocument">SolrInputDocument</a></span> objects.
     </p>
    </dd>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrinputdocument.getchilddocumentscount.php" class="methodname" rel="rdfs-seeAlso">SolrInputDocument::getChildDocumentsCount()</a> - Returns the number of child documents</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrinputdocument/addchilddocuments.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrinputdocument.addchilddocuments%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrinputdocument.addchilddocuments&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrinputdocument.addchilddocuments.php">＋<small>add a note</small></a></span>
