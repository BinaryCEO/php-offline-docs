...
<head>
  ...
  <title>PHP: Imagick::getImageDepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagedepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagedepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagedelay.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagedispose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagedepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagedepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagedepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagedepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagedepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagedepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagedepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagedepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagedepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagedepth.php" hreflang="zh">
...
<meta name="Description" content="Gets the image depth" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageDepth - Manual" />
<meta name="twitter:description" content="Gets the image depth" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageDepth - Manual" />
<meta itemprop="description" content="Gets the image depth" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image depth" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagedispose.php">
          Imagick::getImageDispose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagedelay.php">
          &laquo; Imagick::getImageDelay        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagedepth.php' selected="selected">English</option>
            <option value='de/imagick.getimagedepth.php'>German</option>
            <option value='es/imagick.getimagedepth.php'>Spanish</option>
            <option value='fr/imagick.getimagedepth.php'>French</option>
            <option value='it/imagick.getimagedepth.php'>Italian</option>
            <option value='ja/imagick.getimagedepth.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagedepth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagedepth.php'>Russian</option>
            <option value='tr/imagick.getimagedepth.php'>Turkish</option>
            <option value='uk/imagick.getimagedepth.php'>Ukrainian</option>
            <option value='zh/imagick.getimagedepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagedepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageDepth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageDepth</span> &mdash; <span class="dc-title">Gets the image depth</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagedepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageDepth</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagedepth-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagedepth-returnvalues">
  ...
  <p class="para">
   The image depth.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagedepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagedepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagedepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagedepth.php">＋<small>add a note</small></a></span>
