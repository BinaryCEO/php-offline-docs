...
<head>
  ...
  <title>PHP: sodium_add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-add.php">
 <link rel="shorturl" href="https://www.php.net/sodium-add">
 <link rel="alternate" href="https://www.php.net/sodium-add" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-base642bin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-add.php" hreflang="zh">
...
<meta name="Description" content="Add large numbers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_add - Manual" />
<meta name="twitter:description" content="Add large numbers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_add - Manual" />
<meta itemprop="description" content="Add large numbers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add large numbers" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-base642bin.php">
          sodium_base642bin &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.sodium.php">
          &laquo; Sodium Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-add.php' selected="selected">English</option>
            <option value='de/function.sodium-add.php'>German</option>
            <option value='es/function.sodium-add.php'>Spanish</option>
            <option value='fr/function.sodium-add.php'>French</option>
            <option value='it/function.sodium-add.php'>Italian</option>
            <option value='ja/function.sodium-add.php'>Japanese</option>
            <option value='pt_BR/function.sodium-add.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-add.php'>Russian</option>
            <option value='tr/function.sodium-add.php'>Turkish</option>
            <option value='uk/function.sodium-add.php'>Ukrainian</option>
            <option value='zh/function.sodium-add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_add</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_add</span> &mdash; <span class="dc-title">Add large numbers</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-add-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_add</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$string1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string2</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   This adds the parameter <code class="parameter">string2</code> to <code class="parameter">string1</code>, overwriting
   the value stored in <code class="parameter">string1</code>. This function assumes both parameters are binary
   strings that represent unsigned integers in little-endian byte order.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-add-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-add-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-add.php">＋<small>add a note</small></a></span>
