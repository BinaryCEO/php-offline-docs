...
<head>
  ...
  <title>PHP: sodium_crypto_aead_aegis256_keygen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-keygen.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-aead-aegis256-keygen">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-aead-aegis256-keygen" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-aead-aegis256-keygen.php" hreflang="zh">
...
<meta name="Description" content="Generate a random AEGIS-256 key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_aegis256_keygen - Manual" />
<meta name="twitter:description" content="Generate a random AEGIS-256 key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_aegis256_keygen - Manual" />
<meta itemprop="description" content="Generate a random AEGIS-256 key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a random AEGIS-256 key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-aead-aes256gcm-decrypt.php">
          sodium_crypto_aead_aes256gcm_decrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-aegis256-encrypt.php">
          &laquo; sodium_crypto_aead_aegis256_encrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-aegis256-keygen.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-aead-aegis256-keygen.php'>German</option>
            <option value='es/function.sodium-crypto-aead-aegis256-keygen.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-aead-aegis256-keygen.php'>French</option>
            <option value='it/function.sodium-crypto-aead-aegis256-keygen.php'>Italian</option>
            <option value='ja/function.sodium-crypto-aead-aegis256-keygen.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-aead-aegis256-keygen.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-aead-aegis256-keygen.php'>Russian</option>
            <option value='tr/function.sodium-crypto-aead-aegis256-keygen.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-aead-aegis256-keygen.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-aead-aegis256-keygen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-aead-aegis256-keygen" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_aead_aegis256_keygen</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.4.0)</p><p class="refpurpose"><span class="refname">sodium_crypto_aead_aegis256_keygen</span> &mdash; <span class="dc-title">Generate a random AEGIS-256 key</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-aegis256-keygen-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_aead_aegis256_keygen</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="simpara">
   Generate a random key for use with <span class="function"><a href="function.sodium-crypto-aead-aegis256-encrypt.php" class="function">sodium_crypto_aead_aegis256_encrypt()</a></span> and
   <span class="function"><a href="function.sodium-crypto-aead-aegis256-decrypt.php" class="function">sodium_crypto_aead_aegis256_decrypt()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-aead-aegis256-keygen-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-aegis256-keygen-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-aead-aegis256-keygen-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.sodium-crypto-aead-aegis256-encrypt.php" class="function" rel="rdfs-seeAlso">sodium_crypto_aead_aegis256_encrypt()</a> - Encrypt then authenticate a message with AEGIS-256</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-aegis256-keygen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-aegis256-keygen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aegis256-keygen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-keygen.php">＋<small>add a note</small></a></span>
