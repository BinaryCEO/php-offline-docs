...
<head>
  ...
  <title>PHP: mcrypt_get_cipher_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-get-cipher-name.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-get-cipher-name">
 <link rel="alternate" href="https://www.php.net/mcrypt-get-cipher-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-get-block-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-get-iv-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-get-cipher-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-get-cipher-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-get-cipher-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-get-cipher-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-get-cipher-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-get-cipher-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-get-cipher-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-get-cipher-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-get-cipher-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-get-cipher-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-get-cipher-name.php" hreflang="zh">
...
<meta name="Description" content="Gets the name of the specified cipher" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_get_cipher_name - Manual" />
<meta name="twitter:description" content="Gets the name of the specified cipher" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_get_cipher_name - Manual" />
<meta itemprop="description" content="Gets the name of the specified cipher" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the name of the specified cipher" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mcrypt-get-iv-size.php">
          mcrypt_get_iv_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-get-block-size.php">
          &laquo; mcrypt_get_block_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-get-cipher-name.php' selected="selected">English</option>
            <option value='de/function.mcrypt-get-cipher-name.php'>German</option>
            <option value='es/function.mcrypt-get-cipher-name.php'>Spanish</option>
            <option value='fr/function.mcrypt-get-cipher-name.php'>French</option>
            <option value='it/function.mcrypt-get-cipher-name.php'>Italian</option>
            <option value='ja/function.mcrypt-get-cipher-name.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-get-cipher-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-get-cipher-name.php'>Russian</option>
            <option value='tr/function.mcrypt-get-cipher-name.php'>Turkish</option>
            <option value='uk/function.mcrypt-get-cipher-name.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-get-cipher-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-get-cipher-name" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.mcrypt-get-cipher-name-examples">
  ...
  <p class="para">
   <div class="example" id="example-997">
    <p><strong>Example #1 <span class="function"><strong>mcrypt_get_cipher_name()</strong></span> Example</strong></p>
...
<div class="examplescode"><pre class="examplescode">3DES</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-get-cipher-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-get-cipher-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-get-cipher-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-get-cipher-name.php">＋<small>add a note</small></a></span>
