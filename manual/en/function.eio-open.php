...
<head>
  ...
  <title>PHP: eio_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-open.php">
 <link rel="shorturl" href="https://www.php.net/eio-open">
 <link rel="alternate" href="https://www.php.net/eio-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-nthreads.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-poll.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-open.php" hreflang="zh">
...
<meta name="Description" content="Opens a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_open - Manual" />
<meta name="twitter:description" content="Opens a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_open - Manual" />
<meta itemprop="description" content="Opens a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens a file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-open.php' selected="selected">English</option>
            <option value='de/function.eio-open.php'>German</option>
            <option value='es/function.eio-open.php'>Spanish</option>
            <option value='fr/function.eio-open.php'>French</option>
            <option value='it/function.eio-open.php'>Italian</option>
            <option value='ja/function.eio-open.php'>Japanese</option>
            <option value='pt_BR/function.eio-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-open.php'>Russian</option>
            <option value='tr/function.eio-open.php'>Turkish</option>
            <option value='uk/function.eio-open.php'>Ukrainian</option>
            <option value='zh/function.eio-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-open" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-open-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_open</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.eio-open-parameters">
  ...
  <dl>
    ...
    <dd>
     ...
     In some SAPIs(e.g. <em>PHP-FPM</em>) it could fail, if you
    ...
    <dd>
    <p class="para">One of <em>EIO_O_*</em> constants, or their
    combinations. <em>EIO_O_*</em> constants have the same
    meaning, as their corresponding <em>O_*</em> counterparts
    defined in <code class="literal">fnctl.h</code> C header file. Default is
    ...
    <dd>
    <p class="para">One of <em>EIO_S_I*</em> constants, or their combination
    (via bitwise OR operator). The constants have the same meaning as their
    <em>S_I*</em> counterparts defined in <a href="http://pubs.opengroup.org/onlinepubs/9699919799/basedefs/sys_stat.h.html" class="link external">&raquo;&nbsp;sys/stat.h</a>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-open-seealso">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-mknod.php" class="function" rel="rdfs-seeAlso">eio_mknod()</a> - Create a special or ordinary file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-open.php">＋<small>add a note</small></a></span>
