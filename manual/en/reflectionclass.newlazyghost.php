...
<head>
  ...
  <title>PHP: ReflectionClass::newLazyGhost - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.newlazyghost.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.newlazyghost.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.newlazyghost.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.newinstancewithoutconstructor.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.newlazyproxy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.newlazyghost.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.newlazyghost.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.newlazyghost.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.newlazyghost.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.newlazyghost.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.newlazyghost.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.newlazyghost.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.newlazyghost.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.newlazyghost.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.newlazyghost.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.newlazyghost.php" hreflang="zh">
...
<meta name="Description" content="Creates a new lazy ghost instance" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::newLazyGhost - Manual" />
<meta name="twitter:description" content="Creates a new lazy ghost instance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::newLazyGhost - Manual" />
<meta itemprop="description" content="Creates a new lazy ghost instance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a new lazy ghost instance" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.newlazyproxy.php">
          ReflectionClass::newLazyProxy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.newinstancewithoutconstructor.php">
          &laquo; ReflectionClass::newInstanceWithoutConstructor        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.newlazyghost.php' selected="selected">English</option>
            <option value='de/reflectionclass.newlazyghost.php'>German</option>
            <option value='es/reflectionclass.newlazyghost.php'>Spanish</option>
            <option value='fr/reflectionclass.newlazyghost.php'>French</option>
            <option value='it/reflectionclass.newlazyghost.php'>Italian</option>
            <option value='ja/reflectionclass.newlazyghost.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.newlazyghost.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.newlazyghost.php'>Russian</option>
            <option value='tr/reflectionclass.newlazyghost.php'>Turkish</option>
            <option value='uk/reflectionclass.newlazyghost.php'>Ukrainian</option>
            <option value='zh/reflectionclass.newlazyghost.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.newlazyghost" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionproperty.islazy.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::isLazy()</a> - Checks whether a property is lazy</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/newlazyghost.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.newlazyghost%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.newlazyghost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.newlazyghost.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129870">  <div class="votes">
    <div id="Vu129870">
    <a href="/manual/vote-note.php?id=129870&amp;page=reflectionclass.newlazyghost&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129870">
    <a href="/manual/vote-note.php?id=129870&amp;page=reflectionclass.newlazyghost&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129870" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129870" class="name">
  <strong class="user"><em>dave1010 at gmail dot com</em></strong></a><a class="genanchor" href="#129870"> &para;</a><div class="date" title="2024-11-25 01:11"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129870">
<div class="phpcode"><code><span class="html">Simple helper function that makes it easier to understand:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">createLazyGhost</span><span class="keyword">(<br />    </span><span class="default">string $class</span><span class="keyword">,<br />    ?callable </span><span class="default">$initializer </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">,<br />    ?array </span><span class="default">$propertySetterCallables </span><span class="keyword">= </span><span class="default">null<br /></span><span class="keyword">): </span><span class="default">object </span><span class="keyword">{<br />    </span><span class="default">$reflection </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">);<br /><br />    return </span><span class="default">$reflection</span><span class="keyword">-&gt;</span><span class="default">newLazyGhost</span><span class="keyword">(function (</span><span class="default">object $object</span><span class="keyword">) use (</span><span class="default">$initializer</span><span class="keyword">, </span><span class="default">$propertySetterCallables</span><span class="keyword">) {<br />        </span><span class="comment">// Initialize via the main initializer if provided<br />        </span><span class="keyword">if (</span><span class="default">$initializer</span><span class="keyword">) {<br />            </span><span class="default">$initializer</span><span class="keyword">(</span><span class="default">$object</span><span class="keyword">);<br />        }<br /><br />        </span><span class="comment">// Set properties using the callables if provided<br />        </span><span class="keyword">if (</span><span class="default">$propertySetterCallables</span><span class="keyword">) {<br />            foreach (</span><span class="default">$propertySetterCallables </span><span class="keyword">as </span><span class="default">$property </span><span class="keyword">=&gt; </span><span class="default">$callable</span><span class="keyword">) {<br />                if (</span><span class="default">is_callable</span><span class="keyword">(</span><span class="default">$callable</span><span class="keyword">)) {<br />                    </span><span class="default">$object</span><span class="keyword">-&gt;</span><span class="default">$property </span><span class="keyword">= </span><span class="default">$callable</span><span class="keyword">();<br />                }<br />            }<br />        }<br />    });<br />}<br /><br /></span><span class="default">?&gt;<br /></span><br />This supports using either a main object initializer and/or property initializers.<br /><br />Here's an example, where generating order IDs and calculating totals is considered expensive, so we only do it when necessary:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">class </span><span class="default">Order </span><span class="keyword">{<br />    public </span><span class="default">string $orderId </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />    public </span><span class="default">float $total </span><span class="keyword">= </span><span class="default">0.0</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$initializer </span><span class="keyword">= function (</span><span class="default">Order $order</span><span class="keyword">) {<br />    </span><span class="default">$order</span><span class="keyword">-&gt;</span><span class="default">orderId </span><span class="keyword">= </span><span class="string">'ORD12345'</span><span class="keyword">;<br />};<br /><br /></span><span class="default">$propertySetters </span><span class="keyword">= [<br />    </span><span class="string">'total' </span><span class="keyword">=&gt; fn() =&gt; </span><span class="default">200.75</span><span class="keyword">,<br />];<br /><br /></span><span class="comment">// Lazy ghost with both an initializer and property callables<br /></span><span class="default">$lazyOrder </span><span class="keyword">= </span><span class="default">createLazyGhost</span><span class="keyword">(</span><span class="default">Order</span><span class="keyword">::class, </span><span class="default">$initializer</span><span class="keyword">, </span><span class="default">$propertySetters</span><span class="keyword">);<br /><br /></span><span class="comment">// We can now use $lazyOrder as normal, even though the properties haven't been calculated yet.<br /><br />// Do something that triggers initialization<br /></span><span class="keyword">echo </span><span class="default">$lazyOrder</span><span class="keyword">-&gt;</span><span class="default">orderId </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br />echo </span><span class="default">$lazyOrder</span><span class="keyword">-&gt;</span><span class="default">total </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.newlazyghost&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.newlazyghost.php">＋<small>add a note</small></a></div>
