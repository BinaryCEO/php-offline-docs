...
<head>
  ...
  <title>PHP: Imagick::clone - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.clone.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.clone.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clone.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.clippathimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.clutimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.clone.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.clone.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.clone.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.clone.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.clone.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.clone.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.clone.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.clone.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.clone.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.clone.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.clone.php" hreflang="zh">
...
<meta name="Description" content="Makes an exact copy of the Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::clone - Manual" />
<meta name="twitter:description" content="Makes an exact copy of the Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::clone - Manual" />
<meta itemprop="description" content="Makes an exact copy of the Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Makes an exact copy of the Imagick object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.clutimage.php">
          Imagick::clutImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.clippathimage.php">
          &laquo; Imagick::clipPathImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.clone.php' selected="selected">English</option>
            <option value='de/imagick.clone.php'>German</option>
            <option value='es/imagick.clone.php'>Spanish</option>
            <option value='fr/imagick.clone.php'>French</option>
            <option value='it/imagick.clone.php'>Italian</option>
            <option value='ja/imagick.clone.php'>Japanese</option>
            <option value='pt_BR/imagick.clone.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.clone.php'>Russian</option>
            <option value='tr/imagick.clone.php'>Turkish</option>
            <option value='uk/imagick.clone.php'>Ukrainian</option>
            <option value='zh/imagick.clone.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.clone" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.clone-examples">
  ...
  <p class="para">
   <div class="example" id="example-2978">
    <p><strong>Example #1 Imagick object cloning in different versions of imagick</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Cloning an Imagick object in imagick 2.x and 3.0:<br /></span><span style="color: #0000BB">$newImage </span><span style="color: #007700">= </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">clone</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">// Cloning an Imagick object from 3.1.0 on:<br /></span><span style="color: #0000BB">$newImage </span><span style="color: #007700">= clone </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/clone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.clone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.clone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.clone.php">＋<small>add a note</small></a></span>
