...
<head>
  ...
  <title>PHP: SolrDocument::sort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrdocument.sort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrdocument.sort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrdocument.sort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrdocument.set.php">
 <link rel="next" href="https://www.php.net/manual/en/solrdocument.toarray.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrdocument.sort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrdocument.sort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrdocument.sort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrdocument.sort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrdocument.sort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrdocument.sort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrdocument.sort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrdocument.sort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrdocument.sort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrdocument.sort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrdocument.sort.php" hreflang="zh">
...
<meta name="Description" content="Sorts the fields in the document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrDocument::sort - Manual" />
<meta name="twitter:description" content="Sorts the fields in the document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrDocument::sort - Manual" />
<meta itemprop="description" content="Sorts the fields in the document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sorts the fields in the document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrdocument.toarray.php">
          SolrDocument::toArray &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrdocument.set.php">
          &laquo; SolrDocument::__set        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrdocument.sort.php' selected="selected">English</option>
            <option value='de/solrdocument.sort.php'>German</option>
            <option value='es/solrdocument.sort.php'>Spanish</option>
            <option value='fr/solrdocument.sort.php'>French</option>
            <option value='it/solrdocument.sort.php'>Italian</option>
            <option value='ja/solrdocument.sort.php'>Japanese</option>
            <option value='pt_BR/solrdocument.sort.php'>Brazilian Portuguese</option>
            <option value='ru/solrdocument.sort.php'>Russian</option>
            <option value='tr/solrdocument.sort.php'>Turkish</option>
            <option value='uk/solrdocument.sort.php'>Ukrainian</option>
            <option value='zh/solrdocument.sort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrdocument.sort" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrdocument/sort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrdocument.sort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrdocument.sort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrdocument.sort.php">＋<small>add a note</small></a></span>
