...
<head>
  ...
  <title>PHP: ps_setcolor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setcolor.php">
 <link rel="shorturl" href="https://www.php.net/ps-setcolor">
 <link rel="alternate" href="https://www.php.net/ps-setcolor" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-value.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setdash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setcolor.php" hreflang="zh">
...
<meta name="Description" content="Sets current color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setcolor - Manual" />
<meta name="twitter:description" content="Sets current color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setcolor - Manual" />
<meta itemprop="description" content="Sets current color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets current color" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-setdash.php">
          ps_setdash &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-set-value.php">
          &laquo; ps_set_value        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setcolor.php' selected="selected">English</option>
            <option value='de/function.ps-setcolor.php'>German</option>
            <option value='es/function.ps-setcolor.php'>Spanish</option>
            <option value='fr/function.ps-setcolor.php'>French</option>
            <option value='it/function.ps-setcolor.php'>Italian</option>
            <option value='ja/function.ps-setcolor.php'>Japanese</option>
            <option value='pt_BR/function.ps-setcolor.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setcolor.php'>Russian</option>
            <option value='tr/function.ps-setcolor.php'>Turkish</option>
            <option value='uk/function.ps-setcolor.php'>Ukrainian</option>
            <option value='zh/function.ps-setcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setcolor" class="refentry">
   ...
   <p class="para">
    ...
    <code class="literal">fillstroke</code> were passed.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setcolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="91514">  <div class="votes">
    <div id="Vu91514">
    <a href="/manual/vote-note.php?id=91514&amp;page=function.ps-setcolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd91514">
    <a href="/manual/vote-note.php?id=91514&amp;page=function.ps-setcolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V91514" title="no votes...">
    0
    </div>
  </div>
  <a href="#91514" class="name">
  <strong class="user"><em>php at catchall dot toao dot net</em></strong></a><a class="genanchor" href="#91514"> &para;</a><div class="date" title="2009-06-14 08:29"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom91514">
<div class="phpcode"><code><span class="html">Note that if you specify colors in RGB, the parameters C1, C2, and C3 should be specified in decimal form.  To calculate this, divide the value by 255.  Example: rgb(58,110,165) becomes <span class="default">&lt;?php ps_setcolor</span><span class="keyword">(</span><span class="default">$ps</span><span class="keyword">, </span><span class="string">"stroke"</span><span class="keyword">, </span><span class="string">"rgb"</span><span class="keyword">, </span><span class="default">.23</span><span class="keyword">, </span><span class="default">.43</span><span class="keyword">, </span><span class="default">.65</span><span class="keyword">, </span><span class="default">0.0</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />However, since this is PostScript, most if not all files will be destined for printing and colors should be specified in CMYK anyway.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-setcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setcolor.php">＋<small>add a note</small></a></div>
