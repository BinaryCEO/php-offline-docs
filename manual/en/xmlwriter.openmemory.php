...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/xmlwriter.openmemory.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/xmlwriter.openmemory.php">
 <link rel="alternate" href="https://www.php.net/manual/en/xmlwriter.openmemory.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.xmlwriter.php">
 <link rel="prev" href="https://www.php.net/manual/en/xmlwriter.fullendelement.php">
 <link rel="next" href="https://www.php.net/manual/en/xmlwriter.openuri.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/xmlwriter.openmemory.php' selected="selected">English</option>
            ...
            <option value='pt_BR/xmlwriter.openmemory.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8, PECL xmlwriter &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">XMLWriter::openMemory</span> -- <span class="refname">xmlwriter_open_memory</span> &mdash; <span class="dc-title">Create new xmlwriter using memory for string output</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-xmlwriter.openmemory-returnvalues">
  ...
  <p class="para">
   Procedural style: Returns a new <span class="classname"><a href="class.xmlwriter.php" class="classname">XMLWriter</a></span> for later use with the
 ...
 <div class="refsect1 seealso" id="refsect1-xmlwriter.openmemory-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="xmlwriter.openuri.php" class="methodname" rel="rdfs-seeAlso">XMLWriter::openUri()</a> - Create new xmlwriter using source uri for output</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xmlwriter/xmlwriter/openmemory.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fxmlwriter.openmemory%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=xmlwriter.openmemory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/xmlwriter.openmemory.php">＋<small>add a note</small></a></span>
