...
<head>
  ...
  <title>PHP: imap_getsubscribed - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-getsubscribed.php">
 <link rel="shorturl" href="https://www.php.net/imap-getsubscribed">
 <link rel="alternate" href="https://www.php.net/imap-getsubscribed" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-getmailboxes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-header.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-getsubscribed.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-getsubscribed.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-getsubscribed.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-getsubscribed.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-getsubscribed.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-getsubscribed.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-getsubscribed.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-getsubscribed.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-getsubscribed.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-getsubscribed.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-getsubscribed.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imap_getsubscribed - Manual" />
<meta name="twitter:description" content="List all the subscribed mailboxes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_getsubscribed - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-getsubscribed.php' selected="selected">English</option>
            <option value='de/function.imap-getsubscribed.php'>German</option>
            <option value='es/function.imap-getsubscribed.php'>Spanish</option>
            <option value='fr/function.imap-getsubscribed.php'>French</option>
            <option value='it/function.imap-getsubscribed.php'>Italian</option>
            <option value='ja/function.imap-getsubscribed.php'>Japanese</option>
            <option value='pt_BR/function.imap-getsubscribed.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-getsubscribed.php'>Russian</option>
            <option value='tr/function.imap-getsubscribed.php'>Turkish</option>
            <option value='uk/function.imap-getsubscribed.php'>Ukrainian</option>
            <option value='zh/function.imap-getsubscribed.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-getsubscribed" class="refentry">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">imap</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-getsubscribed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-getsubscribed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-getsubscribed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-getsubscribed.php">＋<small>add a note</small></a></span>
