...
<head>
  ...
  <title>PHP: gmp_sub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-sub.php">
 <link rel="shorturl" href="https://www.php.net/gmp-sub">
 <link rel="alternate" href="https://www.php.net/gmp-sub" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-strval.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-testbit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-sub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-sub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-sub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-sub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-sub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-sub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-sub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-sub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-sub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-sub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-sub.php" hreflang="zh">
...
<meta name="Description" content="Subtract numbers" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_sub - Manual" />
<meta name="twitter:description" content="Subtract numbers" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_sub - Manual" />
<meta itemprop="description" content="Subtract numbers" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Subtract numbers" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.gmp-testbit.php">
          gmp_testbit &raquo;
              ...
              <div class="prev">
        <a href="function.gmp-strval.php">
          &laquo; gmp_strval        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-sub.php' selected="selected">English</option>
            <option value='de/function.gmp-sub.php'>German</option>
            <option value='es/function.gmp-sub.php'>Spanish</option>
            <option value='fr/function.gmp-sub.php'>French</option>
            <option value='it/function.gmp-sub.php'>Italian</option>
            <option value='ja/function.gmp-sub.php'>Japanese</option>
            <option value='pt_BR/function.gmp-sub.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-sub.php'>Russian</option>
            <option value='tr/function.gmp-sub.php'>Turkish</option>
            <option value='uk/function.gmp-sub.php'>Ukrainian</option>
            <option value='zh/function.gmp-sub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-sub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_sub</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_sub</span> &mdash; <span class="dc-title">Subtract numbers</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-sub-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_sub</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-sub-parameters">
 ...
 base detection (i.e. when <code class="parameter">base</code> is equal to 0).
     ...
     <dd>
      <p class="para">
       The number subtracted from <code class="parameter">num1</code>.
      </p>
      <p class="para">
 A <span class="classname"><a href="class.gmp.php" class="classname">GMP</a></span> object, an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>,
 or a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> that can be interpreted as a number following the same logic
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-sub-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-sub-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3356">
    <p><strong>Example #1 <span class="function"><strong>gmp_sub()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">281470681743360</pre>
</div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-sub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-sub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-sub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-sub.php">＋<small>add a note</small></a></span>
