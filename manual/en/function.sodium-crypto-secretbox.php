...
<head>
  ...
  <title>PHP: sodium_crypto_secretbox - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-secretbox">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-secretbox" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult-ristretto255-base.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox-keygen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-secretbox.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-secretbox.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-secretbox.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-secretbox.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-secretbox.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-secretbox.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-secretbox.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-secretbox.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-secretbox.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-secretbox.php" hreflang="zh">
...
<meta name="Description" content="Authenticated shared-key encryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_secretbox - Manual" />
<meta name="twitter:description" content="Authenticated shared-key encryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_secretbox - Manual" />
<meta itemprop="description" content="Authenticated shared-key encryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Authenticated shared-key encryption" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-secretbox-keygen.php">
          sodium_crypto_secretbox_keygen &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-scalarmult-ristretto255-base.php">
          &laquo; sodium_crypto_scalarmult_ristretto255_base        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-secretbox.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-secretbox.php'>German</option>
            <option value='es/function.sodium-crypto-secretbox.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-secretbox.php'>French</option>
            <option value='it/function.sodium-crypto-secretbox.php'>Italian</option>
            <option value='ja/function.sodium-crypto-secretbox.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-secretbox.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-secretbox.php'>Russian</option>
            <option value='tr/function.sodium-crypto-secretbox.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-secretbox.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-secretbox.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-secretbox" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-secretbox-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_secretbox</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 errors" id="refsect1-function.sodium-crypto-secretbox-errors">
  ...
  <ul class="itemizedlist">
   ...
   <li class="listitem">
    <span class="simpara">
     Throws a <span class="classname"><a href="class.sodiumexception.php" class="classname">SodiumException</a></span> on failure.
    </span>
   </li>
  </ul>
 </div>
...
string(23) &quot;message to be encrypted&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.sodium-crypto-secretbox-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.sodium-crypto-secretbox-open.php" class="function" rel="rdfs-seeAlso">sodium_crypto_secretbox_open()</a> - Authenticated shared-key decryption</span></li>
    ...
    <li><span class="function"><a href="function.random-bytes.php" class="function" rel="rdfs-seeAlso">random_bytes()</a> - Get cryptographically secure random bytes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-secretbox.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-secretbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-secretbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-secretbox.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125178">  <div class="votes">
    <div id="Vu125178">
    <a href="/manual/vote-note.php?id=125178&amp;page=function.sodium-crypto-secretbox&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125178">
    <a href="/manual/vote-note.php?id=125178&amp;page=function.sodium-crypto-secretbox&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125178" title="60% like this...">
    1
    </div>
  </div>
  <a href="#125178" class="name">
  <strong class="user"><em>celso fontes</em></strong></a><a class="genanchor" href="#125178"> &para;</a><div class="date" title="2020-07-08 02:20"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125178">
<div class="phpcode"><code><span class="html">An example to how encrypt or decrypt using sodium:<br /><br /><span class="default">&lt;?php<br /><br />$key </span><span class="keyword">= </span><span class="default">random_bytes</span><span class="keyword">(</span><span class="default">SODIUM_CRYPTO_SECRETBOX_KEYBYTES</span><span class="keyword">);<br /><br /></span><span class="default">$nonce </span><span class="keyword">= </span><span class="default">random_bytes</span><span class="keyword">(</span><span class="default">SODIUM_CRYPTO_SECRETBOX_NONCEBYTES</span><span class="keyword">);<br /></span><span class="default">$ciphertext </span><span class="keyword">= </span><span class="default">sodium_crypto_secretbox</span><span class="keyword">(</span><span class="string">"Hello World !"</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br /><br /></span><span class="default">$plaintext </span><span class="keyword">= </span><span class="default">sodium_crypto_secretbox_open</span><span class="keyword">(</span><span class="default">$ciphertext</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br />if (</span><span class="default">$plaintext </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {<br />    throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Bad ciphertext"</span><span class="keyword">);<br />}<br /><br />echo </span><span class="default">$plaintext</span><span class="keyword">;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-secretbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-secretbox.php">＋<small>add a note</small></a></div>
