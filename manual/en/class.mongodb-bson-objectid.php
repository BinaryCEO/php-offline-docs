...
<head>
  ...
  <title>PHP: MongoDB\BSON\ObjectId - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-objectid.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-objectid">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-objectid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-minkey.jsonserialize.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-objectid.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-objectid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-objectid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-objectid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-objectid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-objectid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-objectid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-objectid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-objectid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-objectid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-objectid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-objectid.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\ObjectId class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\ObjectId - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\ObjectId class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\ObjectId - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\ObjectId class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\ObjectId class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-objectid.construct.php">
          MongoDB\BSON\ObjectId::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-minkey.jsonserialize.php">
          &laquo; MongoDB\BSON\MinKey::jsonSerialize        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-objectid.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-objectid.php'>German</option>
            <option value='es/class.mongodb-bson-objectid.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-objectid.php'>French</option>
            <option value='it/class.mongodb-bson-objectid.php'>Italian</option>
            <option value='ja/class.mongodb-bson-objectid.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-objectid.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-objectid.php'>Russian</option>
            <option value='tr/class.mongodb-bson-objectid.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-objectid.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-objectid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-objectid" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-objectid.construct.php">MongoDB\BSON\ObjectId::__construct</a> — Construct a new ObjectId</li><li><a href="mongodb-bson-objectid.gettimestamp.php">MongoDB\BSON\ObjectId::getTimestamp</a> — Returns the timestamp component of this ObjectId</li><li><a href="mongodb-bson-objectid.jsonserialize.php">MongoDB\BSON\ObjectId::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="mongodb-bson-objectid.tostring.php">MongoDB\BSON\ObjectId::__toString</a> — Returns the hexidecimal representation of this ObjectId</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/objectid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-objectid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-objectid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-objectid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122051">  <div class="votes">
    <div id="Vu122051">
    <a href="/manual/vote-note.php?id=122051&amp;page=class.mongodb-bson-objectid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122051">
    <a href="/manual/vote-note.php?id=122051&amp;page=class.mongodb-bson-objectid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122051" title="82% like this...">
    32
    </div>
  </div>
  <a href="#122051" class="name">
  <strong class="user"><em>naip1984 at gmail dot com</em></strong></a><a class="genanchor" href="#122051"> &para;</a><div class="date" title="2017-12-20 01:44"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122051">
<div class="phpcode"><code><span class="html">I struggled for awhile to identify the way to find() using a ObjectID <br /><br />This seems to work, I hope this helps someone else out.  <br /><br />$mongoId = '5a2493c33c95a1281836eb6a';<br /><br />$collection-&gt;find(['_id'=&gt; new MongoDB\BSON\ObjectId("$mongoId")]);<br /><br />I found it here:   <a href="https://docs.mongodb.com/php-library/current/reference/method/MongoDBCollection-findOne/" rel="nofollow" target="_blank">https://docs.mongodb.com/php-library/current/reference/method/MongoDBCollection-findOne/</a><br /><br />Note this is for the PHP library, not the legacy library.</span></code></div>
  </div>
 </div>
  <div class="note" id="122768">  <div class="votes">
    <div id="Vu122768">
    <a href="/manual/vote-note.php?id=122768&amp;page=class.mongodb-bson-objectid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122768">
    <a href="/manual/vote-note.php?id=122768&amp;page=class.mongodb-bson-objectid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122768" title="65% like this...">
    7
    </div>
  </div>
  <a href="#122768" class="name">
  <strong class="user"><em>Mike T</em></strong></a><a class="genanchor" href="#122768"> &para;</a><div class="date" title="2018-05-25 12:58"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122768">
<div class="phpcode"><code><span class="html">Worth noting this will throw an InvalidArgumentException if string is not in the correct format</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.mongodb-bson-objectid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-objectid.php">＋<small>add a note</small></a></div>
