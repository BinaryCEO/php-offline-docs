...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-default-timezone-get.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.date-date-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-default-timezone-set.php">
...
<meta name="Description" content="Gets the default timezone used by all date/time functions in a script" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_default_timezone_get - Manual" />
<meta name="twitter:description" content="Gets the default timezone used by all date/time functions in a script" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_default_timezone_get - Manual" />
<meta itemprop="description" content="Gets the default timezone used by all date/time functions in a script" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the default timezone used by all date/time functions in a script" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-default-timezone-get.php' selected="selected">English</option>
            ...
            <option value='tr/function.date-default-timezone-get.php'>Turkish</option>
 ...
 <div class="refsect1 description" id="refsect1-function.date-default-timezone-get-description">
   ...
   <ul class="itemizedlist">
    <li class="listitem">
     <p class="para">
      ...
      <span class="function"><a href="function.date-default-timezone-set.php" class="function">date_default_timezone_set()</a></span> function (if any)
     </p>
    </li>
    <li class="listitem">
     <p class="para">
  ...
  <p class="para">
   ...
   will return a default timezone of <code class="literal">UTC</code>.
  </p>
 </div>
...
<div class="examplescode"><pre class="examplescode">date_default_timezone_set: Europe/London
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />date_default_timezone_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'America/Los_Angeles'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">date_default_timezone_get</span><span style="color: #007700">() . </span><span style="color: #DD0000">' =&gt; ' </span><span style="color: #007700">. </span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'e'</span><span style="color: #007700">) . </span><span style="color: #DD0000">' =&gt; ' </span><span style="color: #007700">. </span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'T'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">America/Los_Angeles =&gt; America/Los_Angeles =&gt; PST</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.date-default-timezone-get-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.date-default-timezone-set.php" class="function" rel="rdfs-seeAlso">date_default_timezone_set()</a> - Sets the default timezone used by all date/time functions in a script</span></li>
    <li><a href="timezones.php" class="xref">List of Supported Timezones</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-default-timezone-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-default-timezone-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-default-timezone-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-default-timezone-get.php">＋<small>add a note</small></a></span>
