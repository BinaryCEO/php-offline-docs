...
<head>
  ...
  <title>PHP: ReflectionObject - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionobject.php">
 <link rel="shorturl" href="https://www.php.net/reflectionobject">
 <link rel="alternate" href="https://www.php.net/reflectionobject" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionnamedtype.isbuiltin.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionobject.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionobject.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionobject.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionobject.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionobject.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionobject.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionobject.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionobject.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionobject.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionobject.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionobject.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionobject.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionObject class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionObject - Manual" />
<meta name="twitter:description" content="The ReflectionObject class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionObject - Manual" />
<meta itemprop="description" content="The ReflectionObject class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionObject class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionobject.construct.php">
          ReflectionObject::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionnamedtype.isbuiltin.php">
          &laquo; ReflectionNamedType::isBuiltin        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionobject.php' selected="selected">English</option>
            <option value='de/class.reflectionobject.php'>German</option>
            <option value='es/class.reflectionobject.php'>Spanish</option>
            <option value='fr/class.reflectionobject.php'>French</option>
            <option value='it/class.reflectionobject.php'>Italian</option>
            <option value='ja/class.reflectionobject.php'>Japanese</option>
            <option value='pt_BR/class.reflectionobject.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionobject.php'>Russian</option>
            <option value='tr/class.reflectionobject.php'>Turkish</option>
            <option value='uk/class.reflectionobject.php'>Ukrainian</option>
            <option value='zh/class.reflectionobject.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionobject" class="reference">

 <h1 class="title">The ReflectionObject class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5, PHP 7, PHP 8)</p>


  <div class="section" id="reflectionobject.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The <span class="classname"><strong class="classname">ReflectionObject</strong></span> class reports
    information about an <span class="type"><a href="language.types.object.php" class="type object">object</a></span>.
   </p>
  </div>


  <div class="section" id="reflectionobject.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">ReflectionObject</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="reflectionobject.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.object.php" class="type object">object</a></span> <code class="parameter">$object</code></span>)</div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.0.0</td>
       <td>
        <span class="methodname"><a href="reflectionobject.export.php" class="methodname">ReflectionObject::export()</a></span> was removed.
       </td>
      </tr>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionobject.construct.php">ReflectionObject::__construct</a> — Constructs a ReflectionObject</li><li><a href="reflectionobject.export.php">ReflectionObject::export</a> — Export</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionobject.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionobject%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionobject&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionobject.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="93305">  <div class="votes">
    <div id="Vu93305">
    <a href="/manual/vote-note.php?id=93305&amp;page=class.reflectionobject&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93305">
    <a href="/manual/vote-note.php?id=93305&amp;page=class.reflectionobject&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93305" title="60% like this...">
    5
    </div>
  </div>
  <a href="#93305" class="name">
  <strong class="user"><em>marcel dot nolte at noltecomputer dot de</em></strong></a><a class="genanchor" href="#93305"> &para;</a><div class="date" title="2009-09-02 02:42"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom93305">
<div class="phpcode"><code><span class="html">To simply enlist all methods and properties of an object simply write:
<br />
<br /><span class="default">&lt;?php ReflectionObject</span><span class="keyword">::</span><span class="default">export</span><span class="keyword">(</span><span class="default">$yourObject</span><span class="keyword">); </span><span class="default">?&gt;
<br /></span>
<br />,which will cause an var_export-like output.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.reflectionobject&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionobject.php">＋<small>add a note</small></a></div>
