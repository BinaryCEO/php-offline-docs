...
<head>
  ...
  <title>PHP: ReflectionClass::markLazyObjectAsInitialized - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isuserdefined.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.newinstance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.marklazyobjectasinitialized.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.marklazyobjectasinitialized.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.marklazyobjectasinitialized.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.marklazyobjectasinitialized.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.marklazyobjectasinitialized.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.marklazyobjectasinitialized.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.marklazyobjectasinitialized.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.marklazyobjectasinitialized.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.marklazyobjectasinitialized.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.marklazyobjectasinitialized.php" hreflang="zh">
...
<meta name="Description" content="Marks a lazy object as initialized without calling the initializer or factory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::markLazyObjectAsInitialized - Manual" />
<meta name="twitter:description" content="Marks a lazy object as initialized without calling the initializer or factory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::markLazyObjectAsInitialized - Manual" />
<meta itemprop="description" content="Marks a lazy object as initialized without calling the initializer or factory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Marks a lazy object as initialized without calling the initializer or factory" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.newinstance.php">
          ReflectionClass::newInstance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isuserdefined.php">
          &laquo; ReflectionClass::isUserDefined        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.marklazyobjectasinitialized.php' selected="selected">English</option>
            <option value='de/reflectionclass.marklazyobjectasinitialized.php'>German</option>
            <option value='es/reflectionclass.marklazyobjectasinitialized.php'>Spanish</option>
            <option value='fr/reflectionclass.marklazyobjectasinitialized.php'>French</option>
            <option value='it/reflectionclass.marklazyobjectasinitialized.php'>Italian</option>
            <option value='ja/reflectionclass.marklazyobjectasinitialized.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.marklazyobjectasinitialized.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.marklazyobjectasinitialized.php'>Russian</option>
            <option value='tr/reflectionclass.marklazyobjectasinitialized.php'>Turkish</option>
            <option value='uk/reflectionclass.marklazyobjectasinitialized.php'>Ukrainian</option>
            <option value='zh/reflectionclass.marklazyobjectasinitialized.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.marklazyobjectasinitialized" class="refentry">
...
<div class="annotation-interactive examplescode"><pre class="examplescode">lazy ghost object(Example)#3 (1) {
  [&quot;prop1&quot;]=&gt;
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class </span><span style="color: #0000BB">Example<br /></span><span style="color: #007700">{<br />    public </span><span style="color: #0000BB">string $prop1</span><span style="color: #007700">;<br />    public </span><span style="color: #0000BB">string $prop2</span><span style="color: #007700">;<br />    public </span><span style="color: #0000BB">string $prop3 </span><span style="color: #007700">= </span><span style="color: #DD0000">'default value'</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">$reflector </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionClass</span><span style="color: #007700">(</span><span style="color: #0000BB">Example</span><span style="color: #007700">::class);<br /><br /></span><span style="color: #0000BB">$object </span><span style="color: #007700">= </span><span style="color: #0000BB">$reflector</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newLazyGhost</span><span style="color: #007700">(function (</span><span style="color: #0000BB">$object</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">"Initializer called\n"</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$object</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">prop1 </span><span style="color: #007700">= </span><span style="color: #DD0000">'initialized'</span><span style="color: #007700">;<br />});<br /><br /></span><span style="color: #0000BB">$reflector</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getProperty</span><span style="color: #007700">(</span><span style="color: #DD0000">'prop1'</span><span style="color: #007700">)<br />          -&gt;</span><span style="color: #0000BB">setRawValueWithoutLazyInitialization</span><span style="color: #007700">(</span><span style="color: #0000BB">$object</span><span style="color: #007700">, </span><span style="color: #DD0000">'prop1 value'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$object</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">prop3</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$object</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$reflector</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">markLazyObjectAsInitialized</span><span style="color: #007700">(</span><span style="color: #0000BB">$object</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$object</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>The above example will output:</p></div>
    <div class="example-contents screen">
<div class="annotation-interactive examplescode"><pre class="examplescode">Initializer called
string(13) &quot;default value&quot;
object(Example)#3 (2) {
  [&quot;prop1&quot;]=&gt;
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionclass.isuninitializedlazyobject.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::isUninitializedLazyObject()</a> - Checks if an object is lazy and uninitialized</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/marklazyobjectasinitialized.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.marklazyobjectasinitialized%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.marklazyobjectasinitialized&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.marklazyobjectasinitialized.php">＋<small>add a note</small></a></span>
