...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-countable.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.is-callable.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-double.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-countable.php' selected="selected">English</option>
            <option value='de/function.is-countable.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.is-countable-examples">
  ...
  <p class="para">
   <div class="example" id="example-5651">
    <p><strong>Example #1 <span class="function"><strong>is_countable()</strong></span> examples</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.is-bool.php" class="function" rel="rdfs-seeAlso">is_bool()</a> - Finds out whether a variable is a boolean</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/var/functions/is-countable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-countable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-countable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-countable.php">＋<small>add a note</small></a></span>
...
<div class="foot"><a href="/manual/add-note.php?sect=function.is-countable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-countable.php">＋<small>add a note</small></a></div>
