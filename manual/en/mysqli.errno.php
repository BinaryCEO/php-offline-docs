...
<head>
  ...
  <title>PHP: mysqli::$errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.errno.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.errno.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.errno.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.dump-debug-info.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.errno.php" hreflang="zh">
...
<meta name="Description" content="Returns the error code for the most recent function call" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$errno - Manual" />
<meta name="twitter:description" content="Returns the error code for the most recent function call" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$errno - Manual" />
<meta itemprop="description" content="Returns the error code for the most recent function call" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the error code for the most recent function call" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mysqli.error.php">
          mysqli::$error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.dump-debug-info.php">
          &laquo; mysqli::dump_debug_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.errno.php' selected="selected">English</option>
            <option value='de/mysqli.errno.php'>German</option>
            <option value='es/mysqli.errno.php'>Spanish</option>
            <option value='fr/mysqli.errno.php'>French</option>
            <option value='it/mysqli.errno.php'>Italian</option>
            <option value='ja/mysqli.errno.php'>Japanese</option>
            <option value='pt_BR/mysqli.errno.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.errno.php'>Russian</option>
            <option value='tr/mysqli.errno.php'>Turkish</option>
            <option value='uk/mysqli.errno.php'>Ukrainian</option>
            <option value='zh/mysqli.errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$errno</h1>
  <h1 class="refname">mysqli_errno</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$errno</span> -- <span class="refname">mysqli_errno</span> &mdash; <span class="dc-title">Returns the error code for the most recent function call</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli.errno-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli.errno.php">$mysqli-&gt;errno</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_errno</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli.errno-parameters">
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.errno-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.errno-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1588">
   <p><strong>Example #1 <var class="varname">$mysqli->errno</var> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Errorcode: 1193</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.errno-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_sqlstate()</a> - Returns the SQLSTATE error from previous MySQL operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.errno.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112548">  <div class="votes">
    <div id="Vu112548">
    <a href="/manual/vote-note.php?id=112548&amp;page=mysqli.errno&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112548">
    <a href="/manual/vote-note.php?id=112548&amp;page=mysqli.errno&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112548" title="73% like this...">
    21
    </div>
  </div>
  <a href="#112548" class="name">
  <strong class="user"><em>erwin at transpontine dot com</em></strong></a><a class="genanchor" href="#112548"> &para;</a><div class="date" title="2013-06-28 05:31"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112548">
<div class="phpcode"><code><span class="html">You can also find the error codes for for example MySQL 5.5 here: <a href="http://dev.mysql.com/doc/refman/5.5/en/error-handling.html" rel="nofollow" target="_blank">http://dev.mysql.com/doc/refman/5.5/en/error-handling.html</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.errno.php">＋<small>add a note</small></a></div>
