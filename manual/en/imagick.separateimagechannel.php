...
<head>
  ...
  <title>PHP: Imagick::separateImageChannel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.separateimagechannel.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.separateimagechannel.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.separateimagechannel.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.selectiveblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.sepiatoneimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.separateimagechannel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.separateimagechannel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.separateimagechannel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.separateimagechannel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.separateimagechannel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.separateimagechannel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.separateimagechannel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.separateimagechannel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.separateimagechannel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.separateimagechannel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.separateimagechannel.php" hreflang="zh">
...
<meta name="Description" content="Separates a channel from the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::separateImageChannel - Manual" />
<meta name="twitter:description" content="Separates a channel from the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::separateImageChannel - Manual" />
<meta itemprop="description" content="Separates a channel from the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Separates a channel from the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.sepiatoneimage.php">
          Imagick::sepiaToneImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.selectiveblurimage.php">
          &laquo; Imagick::selectiveBlurImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.separateimagechannel.php' selected="selected">English</option>
            <option value='de/imagick.separateimagechannel.php'>German</option>
            <option value='es/imagick.separateimagechannel.php'>Spanish</option>
            <option value='fr/imagick.separateimagechannel.php'>French</option>
            <option value='it/imagick.separateimagechannel.php'>Italian</option>
            <option value='ja/imagick.separateimagechannel.php'>Japanese</option>
            <option value='pt_BR/imagick.separateimagechannel.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.separateimagechannel.php'>Russian</option>
            <option value='tr/imagick.separateimagechannel.php'>Turkish</option>
            <option value='uk/imagick.separateimagechannel.php'>Ukrainian</option>
            <option value='zh/imagick.separateimagechannel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.separateimagechannel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::separateImageChannel</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::separateImageChannel</span> &mdash; <span class="dc-title">Separates a channel from the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.separateimagechannel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::separateImageChannel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.separateimagechannel-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.separateimagechannel-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.separateimagechannel-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.separateimagechannel-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3087">
      <p><strong>Example #1  <span class="function"><strong>Imagick::separateImageChannel()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/separateimagechannel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.separateimagechannel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.separateimagechannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.separateimagechannel.php">＋<small>add a note</small></a></span>
