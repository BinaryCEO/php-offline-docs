...
<head>
  ...
  <title>PHP: ps_set_border_color - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-border-color.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-border-color">
 <link rel="alternate" href="https://www.php.net/ps-set-border-color" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-scale.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-border-dash.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-border-color.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-border-color.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-border-color.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-border-color.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-border-color.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-border-color.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-border-color.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-border-color.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-border-color.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-border-color.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-border-color.php" hreflang="zh">
...
<meta name="Description" content="Sets color of border for annotations" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_border_color - Manual" />
<meta name="twitter:description" content="Sets color of border for annotations" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_border_color - Manual" />
<meta itemprop="description" content="Sets color of border for annotations" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets color of border for annotations" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-set-border-dash.php">
          ps_set_border_dash &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-scale.php">
          &laquo; ps_scale        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-border-color.php' selected="selected">English</option>
            <option value='de/function.ps-set-border-color.php'>German</option>
            <option value='es/function.ps-set-border-color.php'>Spanish</option>
            <option value='fr/function.ps-set-border-color.php'>French</option>
            <option value='it/function.ps-set-border-color.php'>Italian</option>
            <option value='ja/function.ps-set-border-color.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-border-color.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-border-color.php'>Russian</option>
            <option value='tr/function.ps-set-border-color.php'>Turkish</option>
            <option value='uk/function.ps-set-border-color.php'>Ukrainian</option>
            <option value='zh/function.ps-set-border-color.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-border-color" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_set_border_color</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_set_border_color</span> &mdash; <span class="dc-title">Sets color of border for annotations</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-set-border-color-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_border_color</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$red</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$green</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$blue</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-set-border-color-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-set-border-color-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-set-border-color-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-set-border-style.php" class="function" rel="rdfs-seeAlso">ps_set_border_style()</a> - Sets border style of annotations</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-border-color.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-border-color%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-border-color&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-border-color.php">＋<small>add a note</small></a></span>
