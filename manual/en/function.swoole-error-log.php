...
<head>
  ...
  <title>PHP: swoole_error_log - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.swoole-error-log.php">
 <link rel="shorturl" href="https://www.php.net/swoole-error-log">
 <link rel="alternate" href="https://www.php.net/swoole-error-log" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.swoole-funcs.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.swoole-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.swoole-event-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.swoole-error-log.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.swoole-error-log.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.swoole-error-log.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.swoole-error-log.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.swoole-error-log.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.swoole-error-log.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.swoole-error-log.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.swoole-error-log.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.swoole-error-log.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.swoole-error-log.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.swoole-error-log.php" hreflang="zh">
...
<meta name="Description" content="Output error messages to the log" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: swoole_error_log - Manual" />
<meta name="twitter:description" content="Output error messages to the log" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: swoole_error_log - Manual" />
<meta itemprop="description" content="Output error messages to the log" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Output error messages to the log" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.swoole-event-add.php">
          swoole_event_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.swoole-errno.php">
          &laquo; swoole_errno        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.swoole-error-log.php' selected="selected">English</option>
            <option value='de/function.swoole-error-log.php'>German</option>
            <option value='es/function.swoole-error-log.php'>Spanish</option>
            <option value='fr/function.swoole-error-log.php'>French</option>
            <option value='it/function.swoole-error-log.php'>Italian</option>
            <option value='ja/function.swoole-error-log.php'>Japanese</option>
            <option value='pt_BR/function.swoole-error-log.php'>Brazilian Portuguese</option>
            <option value='ru/function.swoole-error-log.php'>Russian</option>
            <option value='tr/function.swoole-error-log.php'>Turkish</option>
            <option value='uk/function.swoole-error-log.php'>Ukrainian</option>
            <option value='zh/function.swoole-error-log.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.swoole-error-log" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">swoole_error_log</h1>
  <p class="verinfo">(PECL swoole &gt;= 4.5.8)</p><p class="refpurpose"><span class="refname">swoole_error_log</span> &mdash; <span class="dc-title">Output error messages to the log</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.swoole-error-log-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Log Level, constants can be used: <strong><code><a href="swoole.constants.php#constant.swoole-log-debug">SWOOLE_LOG_DEBUG</a></code></strong>,
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/functions/swoole-error-log.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.swoole-error-log%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.swoole-error-log&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.swoole-error-log.php">＋<small>add a note</small></a></span>
