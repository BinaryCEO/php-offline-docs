...
<head>
  ...
  <title>PHP: SolrQuery::getFilterQueries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfilterqueries.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfilterqueries.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfilterqueries.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfilterqueries.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfilterqueries.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfilterqueries.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfilterqueries.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfilterqueries.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfilterqueries.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfilterqueries.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfilterqueries.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of filter queries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFilterQueries - Manual" />
<meta name="twitter:description" content="Returns an array of filter queries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFilterQueries - Manual" />
<meta itemprop="description" content="Returns an array of filter queries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of filter queries" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgroup.php">
          SolrQuery::getGroup &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfields.php">
          &laquo; SolrQuery::getFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfilterqueries.php' selected="selected">English</option>
            <option value='de/solrquery.getfilterqueries.php'>German</option>
            <option value='es/solrquery.getfilterqueries.php'>Spanish</option>
            <option value='fr/solrquery.getfilterqueries.php'>French</option>
            <option value='it/solrquery.getfilterqueries.php'>Italian</option>
            <option value='ja/solrquery.getfilterqueries.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfilterqueries.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfilterqueries.php'>Russian</option>
            <option value='tr/solrquery.getfilterqueries.php'>Turkish</option>
            <option value='uk/solrquery.getfilterqueries.php'>Ukrainian</option>
            <option value='zh/solrquery.getfilterqueries.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfilterqueries" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFilterQueries</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFilterQueries</span> &mdash; <span class="dc-title">Returns an array of filter queries</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfilterqueries-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFilterQueries</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfilterqueries-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfilterqueries-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfilterqueries.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfilterqueries%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfilterqueries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfilterqueries.php">＋<small>add a note</small></a></span>
