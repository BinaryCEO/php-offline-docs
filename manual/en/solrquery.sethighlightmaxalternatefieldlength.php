...
<head>
  ...
  <title>PHP: SolrQuery::setHighlightMaxAlternateFieldLength - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.sethighlighthighlightmultiterm.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.sethighlightmaxanalyzedchars.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.sethighlightmaxalternatefieldlength.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum number of characters of the field to return" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setHighlightMaxAlternateFieldLength - Manual" />
<meta name="twitter:description" content="Sets the maximum number of characters of the field to return" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setHighlightMaxAlternateFieldLength - Manual" />
<meta itemprop="description" content="Sets the maximum number of characters of the field to return" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum number of characters of the field to return" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.sethighlightmaxanalyzedchars.php">
          SolrQuery::setHighlightMaxAnalyzedChars &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.sethighlighthighlightmultiterm.php">
          &laquo; SolrQuery::setHighlightHighlightMultiTerm        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.sethighlightmaxalternatefieldlength.php' selected="selected">English</option>
            <option value='de/solrquery.sethighlightmaxalternatefieldlength.php'>German</option>
            <option value='es/solrquery.sethighlightmaxalternatefieldlength.php'>Spanish</option>
            <option value='fr/solrquery.sethighlightmaxalternatefieldlength.php'>French</option>
            <option value='it/solrquery.sethighlightmaxalternatefieldlength.php'>Italian</option>
            <option value='ja/solrquery.sethighlightmaxalternatefieldlength.php'>Japanese</option>
            <option value='pt_BR/solrquery.sethighlightmaxalternatefieldlength.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.sethighlightmaxalternatefieldlength.php'>Russian</option>
            <option value='tr/solrquery.sethighlightmaxalternatefieldlength.php'>Turkish</option>
            <option value='uk/solrquery.sethighlightmaxalternatefieldlength.php'>Ukrainian</option>
            <option value='zh/solrquery.sethighlightmaxalternatefieldlength.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.sethighlightmaxalternatefieldlength" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setHighlightMaxAlternateFieldLength</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setHighlightMaxAlternateFieldLength</span> &mdash; <span class="dc-title">Sets the maximum number of characters of the field to return</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.sethighlightmaxalternatefieldlength-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setHighlightMaxAlternateFieldLength</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fieldLength</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>

  <p class="para rdfs-comment">
   If SolrQuery::setHighlightAlternateField() was passed the value <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, this parameter specifies the maximum number of characters of the field to return
  </p>
 <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.sethighlightmaxalternatefieldlength-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">fieldLength</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.sethighlightmaxalternatefieldlength-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/sethighlightmaxalternatefieldlength.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.sethighlightmaxalternatefieldlength%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.sethighlightmaxalternatefieldlength&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.sethighlightmaxalternatefieldlength.php">＋<small>add a note</small></a></span>
