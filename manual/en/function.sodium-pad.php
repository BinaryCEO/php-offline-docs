...
<head>
  ...
  <title>PHP: sodium_pad - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-pad.php">
 <link rel="shorturl" href="https://www.php.net/sodium-pad">
 <link rel="alternate" href="https://www.php.net/sodium-pad" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-memzero.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-unpad.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-pad.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-pad.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-pad.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-pad.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-pad.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-pad.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-pad.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-pad.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-pad.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-pad.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-pad.php" hreflang="zh">
...
<meta name="Description" content="Add padding data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_pad - Manual" />
<meta name="twitter:description" content="Add padding data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_pad - Manual" />
<meta itemprop="description" content="Add padding data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add padding data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-unpad.php">
          sodium_unpad &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-memzero.php">
          &laquo; sodium_memzero        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-pad.php' selected="selected">English</option>
            <option value='de/function.sodium-pad.php'>German</option>
            <option value='es/function.sodium-pad.php'>Spanish</option>
            <option value='fr/function.sodium-pad.php'>French</option>
            <option value='it/function.sodium-pad.php'>Italian</option>
            <option value='ja/function.sodium-pad.php'>Japanese</option>
            <option value='pt_BR/function.sodium-pad.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-pad.php'>Russian</option>
            <option value='tr/function.sodium-pad.php'>Turkish</option>
            <option value='uk/function.sodium-pad.php'>Ukrainian</option>
            <option value='zh/function.sodium-pad.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-pad" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_pad</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_pad</span> &mdash; <span class="dc-title">Add padding data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-pad-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_pad</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$block_size</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-pad-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-pad-returnvalues">
  ...
  <p class="para">
   Padded string.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-pad.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-pad%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-pad&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-pad.php">＋<small>add a note</small></a></span>
