...
<head>
  ...
  <title>PHP: Increment and Decrement - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.operators.increment.php">
 <link rel="shorturl" href="https://www.php.net/operators.increment">
 <link rel="alternate" href="https://www.php.net/operators.increment" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.operators.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.operators.arithmetic.php">
 <link rel="next" href="https://www.php.net/manual/en/language.operators.assignment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.operators.increment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.operators.increment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.operators.increment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.operators.increment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.operators.increment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.operators.increment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.operators.increment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.operators.increment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.operators.increment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.operators.increment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.operators.increment.php" hreflang="zh">
...
<meta name="Description" content="Incrementing/Decrementing Operators" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Increment and Decrement - Manual" />
<meta name="twitter:description" content="Incrementing/Decrementing Operators" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Increment and Decrement - Manual" />
<meta itemprop="description" content="Incrementing/Decrementing Operators" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Incrementing/Decrementing Operators" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/language.operators.increment.php'>Italian</option>
            ...
            <option value='uk/language.operators.increment.php'>Ukrainian</option>
 ...
 <p class="para">
  <div class="example" id="example-156">
   <p><strong>Example #1 Examples of Increment/Decrement</strong></p>
...
int(4)
 ...
 <div class="sect2" id="language.operators.increment.string">
  ...
  <div class="example" id="example-157">
   <p><strong>Example #2 PERL string increment example</strong></p>
   <div class="example-contents">
...
A14
  ...
  <div class="warning"><strong class="warning">Warning</strong>
   ...
   <div class="example" id="example-158">
    <p><strong>Example #3 Alphanumerical string converted to float</strong></p>
    <div class="example-contents">
    ...
    <div class="example-contents"><p>
     ...
     before being incremented.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/operators/increment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.operators.increment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.operators.increment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.operators.increment.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="109621">  <div class="votes">
    ...
    <div class="tally" id="V109621" title="61% like this...">
    67
    </div>
  </div>
  <a href="#109621" class="name">
  <strong class="user"><em>hartmut at php dot net</em></strong></a><a class="genanchor" href="#109621"> &para;</a><div class="date" title="2012-08-02 03:28"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109621">
<div class="phpcode"><code><span class="html">Note that <br /><br />$a="9D9"; var_dump(++$a);   =&gt; string(3) "9E0"<br /><br />but counting onwards from there <br /><br />$a="9E0"; var_dump(++$a);   =&gt; float(10)<br /><br />this is due to "9E0" being interpreted as a string representation of the float constant 9E0 (or 9e0), and thus evalutes to 9 * 10^0 = 9 (in a float context)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.operators.increment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.operators.increment.php">＋<small>add a note</small></a></div>
