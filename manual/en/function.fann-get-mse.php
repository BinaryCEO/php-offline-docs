...
<head>
  ...
  <title>PHP: fann_get_MSE - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-mse.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-mse">
 <link rel="alternate" href="https://www.php.net/fann-get-mse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-learning-rate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-network-type.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-mse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-mse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-mse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-mse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-mse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-mse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-mse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-mse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-mse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-mse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-mse.php" hreflang="zh">
...
<meta name="Description" content="Reads the mean square error from the network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_MSE - Manual" />
<meta name="twitter:description" content="Reads the mean square error from the network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_MSE - Manual" />
<meta itemprop="description" content="Reads the mean square error from the network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads the mean square error from the network" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-get-network-type.php">
          fann_get_network_type &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-learning-rate.php">
          &laquo; fann_get_learning_rate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-mse.php' selected="selected">English</option>
            <option value='de/function.fann-get-mse.php'>German</option>
            <option value='es/function.fann-get-mse.php'>Spanish</option>
            <option value='fr/function.fann-get-mse.php'>French</option>
            <option value='it/function.fann-get-mse.php'>Italian</option>
            <option value='ja/function.fann-get-mse.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-mse.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-mse.php'>Russian</option>
            <option value='tr/function.fann-get-mse.php'>Turkish</option>
            <option value='uk/function.fann-get-mse.php'>Ukrainian</option>
            <option value='zh/function.fann-get-mse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-mse" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.fann-get-mse-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_MSE</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-mse-returnvalues">
  ...
  <p class="para">
   The mean square error, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-test-data.php" class="function" rel="rdfs-seeAlso">fann_test_data()</a> - Test a set of training data and calculates the MSE for the training data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-mse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-mse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-mse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-mse.php">＋<small>add a note</small></a></span>
