...
<head>
  ...
  <title>PHP: Serialization - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.enumerations.serialization.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/language.enumerations.listing.php">
 <link rel="next" href="https://www.php.net/manual/en/language.enumerations.object-differences.inheritance.php">
...
<meta name="twitter:title" content="PHP: Serialization - Manual" />
<meta name="twitter:description" content="Serialization" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Serialization - Manual" />
<meta itemprop="description" content="Serialization" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Serialization" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.enumerations.object-differences.inheritance.php">
          Why enums aren't extendable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.enumerations.listing.php">
          &laquo; Value listing        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.enumerations.serialization.php' selected="selected">English</option>
            ...
            <option value='fr/language.enumerations.serialization.php'>French</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">enum </span><span style="color: #0000BB">Foo </span><span style="color: #007700">{<br />    case </span><span style="color: #0000BB">Bar</span><span style="color: #007700">;<br />}<br /><br />enum </span><span style="color: #0000BB">Baz</span><span style="color: #007700">: </span><span style="color: #0000BB">int </span><span style="color: #007700">{<br />    case </span><span style="color: #0000BB">Beep </span><span style="color: #007700">= </span><span style="color: #0000BB">5</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">Foo</span><span style="color: #007700">::</span><span style="color: #0000BB">Bar</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">print_r</span><span style="color: #007700">(</span><span style="color: #0000BB">Baz</span><span style="color: #007700">::</span><span style="color: #0000BB">Beep</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Produces<br /><br />Foo Enum (<br />    [name] =&gt; Bar<br />)<br />Baz Enum:int {<br />    [name] =&gt; Beep<br />    [value] =&gt; 5<br />}<br />*/<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.enumerations.serialization%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.enumerations.serialization&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.enumerations.serialization.php">＋<small>add a note</small></a></span>
