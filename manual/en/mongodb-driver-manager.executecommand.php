...
<head>
  ...
  <title>PHP: MongoDB\Driver\Manager::executeCommand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-manager.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-manager.executebulkwritecommand.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-manager.executequery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mongodb-driver-manager.executecommand.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mongodb-driver-manager.executecommand.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mongodb-driver-manager.executecommand.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb-driver-manager.executecommand.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mongodb-driver-manager.executecommand.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mongodb-driver-manager.executecommand.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mongodb-driver-manager.executecommand.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mongodb-driver-manager.executecommand.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb-driver-manager.executecommand.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mongodb-driver-manager.executecommand.php" hreflang="zh">
...
<meta name="Description" content="Execute a database command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Manager::executeCommand - Manual" />
<meta name="twitter:description" content="Execute a database command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Manager::executeCommand - Manual" />
<meta itemprop="description" content="Execute a database command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Execute a database command" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-manager.executequery.php">
          MongoDB\Driver\Manager::executeQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-manager.executebulkwritecommand.php">
          &laquo; MongoDB\Driver\Manager::executeBulkWriteCommand        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-manager.executecommand.php' selected="selected">English</option>
            <option value='de/mongodb-driver-manager.executecommand.php'>German</option>
            <option value='es/mongodb-driver-manager.executecommand.php'>Spanish</option>
            <option value='fr/mongodb-driver-manager.executecommand.php'>French</option>
            <option value='it/mongodb-driver-manager.executecommand.php'>Italian</option>
            <option value='ja/mongodb-driver-manager.executecommand.php'>Japanese</option>
            <option value='pt_BR/mongodb-driver-manager.executecommand.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb-driver-manager.executecommand.php'>Russian</option>
            <option value='tr/mongodb-driver-manager.executecommand.php'>Turkish</option>
            <option value='uk/mongodb-driver-manager.executecommand.php'>Ukrainian</option>
            <option value='zh/mongodb-driver-manager.executecommand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb-driver-manager.executecommand" class="refentry">
...
object(stdClass)#7 (2) {
  ...
  <div class="example" id="example-1400">
   ...
   <div class="example-contents"><p>
    ...
    <span class="classname"><a href="class.mongodb-driver-command.php" class="classname">MongoDB\Driver\Command</a></span> document. Note that this time
    limit is enforced on the server side and does not take network latency into
    account. See
    <a href="https://www.mongodb.com/docs/manual/tutorial/terminate-running-operations/#maxtimems" class="link external">&raquo;&nbsp;Terminate Running Operations</a>
    in the MongoDB manual for more information.
   </p></div>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$manager </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Manager</span><span style="color: #007700">(</span><span style="color: #DD0000">'mongodb://localhost:27017'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$command </span><span style="color: #007700">= new </span><span style="color: #0000BB">MongoDB\Driver\Command</span><span style="color: #007700">([<br />    </span><span style="color: #DD0000">'count' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'collection'</span><span style="color: #007700">,<br />    </span><span style="color: #DD0000">'query' </span><span style="color: #007700">=&gt; [</span><span style="color: #DD0000">'x' </span><span style="color: #007700">=&gt; [</span><span style="color: #DD0000">'$gt' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">]],<br />    </span><span style="color: #DD0000">'maxTimeMS' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1000</span><span style="color: #007700">,<br />]);<br /><br /></span><span style="color: #0000BB">$cursor </span><span style="color: #007700">= </span><span style="color: #0000BB">$manager</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">executeCommand</span><span style="color: #007700">(</span><span style="color: #DD0000">'db'</span><span style="color: #007700">, </span><span style="color: #0000BB">$command</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$cursor</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">toArray</span><span style="color: #007700">()[</span><span style="color: #0000BB">0</span><span style="color: #007700">]);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>

   <div class="example-contents"><p>
    If the command fails to complete after one second of execution time on the
    server, a
    <span class="classname"><a href="class.mongodb-driver-exception-executiontimeoutexception.php" class="classname">MongoDB\Driver\Exception\ExecutionTimeoutException</a></span>
    will be thrown.
   </p></div>
  </div>
 </div>
 ...
 <div class="refsect1 notes" id="refsect1-mongodb-driver-manager.executecommand-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    ...
    <a href="mongodb-driver-manager.construct.php#mongodb-driver-manager.construct-uri" class="link">MongoDB Connection
    URI</a>. Applications in need of that behavior should consider using
    <span class="function"><a href="mongodb-driver-manager.executereadcommand.php" class="function">MongoDB\Driver\Manager::executeReadCommand()</a></span>.
   </span>
  </p></blockquote>
 </div>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="mongodb-driver-server.executecommand.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::executeCommand()</a> - Execute a database command on this server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/manager/executecommand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-manager.executecommand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-manager.executecommand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-manager.executecommand.php">＋<small>add a note</small></a></span>
