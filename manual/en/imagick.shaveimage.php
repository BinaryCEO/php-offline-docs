...
<head>
  ...
  <title>PHP: Imagick::shaveImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.shaveimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.shaveimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shaveimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.sharpenimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.shearimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shaveimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.shaveimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.shaveimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.shaveimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.shaveimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.shaveimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.shaveimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.shaveimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.shaveimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.shaveimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.shaveimage.php" hreflang="zh">
...
<meta name="Description" content="Shaves pixels from the image edges" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::shaveImage - Manual" />
<meta name="twitter:description" content="Shaves pixels from the image edges" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::shaveImage - Manual" />
<meta itemprop="description" content="Shaves pixels from the image edges" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Shaves pixels from the image edges" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.shearimage.php">
          Imagick::shearImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.sharpenimage.php">
          &laquo; Imagick::sharpenImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.shaveimage.php' selected="selected">English</option>
            <option value='de/imagick.shaveimage.php'>German</option>
            <option value='es/imagick.shaveimage.php'>Spanish</option>
            <option value='fr/imagick.shaveimage.php'>French</option>
            <option value='it/imagick.shaveimage.php'>Italian</option>
            <option value='ja/imagick.shaveimage.php'>Japanese</option>
            <option value='pt_BR/imagick.shaveimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.shaveimage.php'>Russian</option>
            <option value='tr/imagick.shaveimage.php'>Turkish</option>
            <option value='uk/imagick.shaveimage.php'>Ukrainian</option>
            <option value='zh/imagick.shaveimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.shaveimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::shaveImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::shaveImage</span> &mdash; <span class="dc-title">Shaves pixels from the image edges</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.shaveimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::shaveImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.shaveimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.shaveimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3113">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/shaveimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.shaveimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.shaveimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shaveimage.php">＋<small>add a note</small></a></span>
