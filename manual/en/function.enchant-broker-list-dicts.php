...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-list-dicts.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-broker-request-dict.php">
...
<meta name="Description" content="Returns a list of available dictionaries" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: enchant_broker_list_dicts - Manual" />
<meta name="twitter:description" content="Returns a list of available dictionaries" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: enchant_broker_list_dicts - Manual" />
<meta itemprop="description" content="Returns a list of available dictionaries" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a list of available dictionaries" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-list-dicts.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL enchant &gt;= 1.0.1)</p><p class="refpurpose"><span class="refname">enchant_broker_list_dicts</span> &mdash; <span class="dc-title">Returns a list of available dictionaries</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.enchant-broker-list-dicts-returnvalues">
  ...
  <p class="para">
   Returns an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of available dictionaries with their details.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.enchant-broker-list-dicts-examples">
  ...
  <p class="para">
   <div class="example" id="example-2454">
    <p><strong>Example #1 List all available dictionaries for one broker</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.enchant-broker-describe.php" class="function" rel="rdfs-seeAlso">enchant_broker_describe()</a> - Enumerates the Enchant providers</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-list-dicts.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-list-dicts%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-list-dicts&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-list-dicts.php">＋<small>add a note</small></a></span>
