...
<head>
  ...
  <title>PHP: imap_num_recent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-num-recent.php">
 <link rel="shorturl" href="https://www.php.net/imap-num-recent">
 <link rel="alternate" href="https://www.php.net/imap-num-recent" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-num-msg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-num-recent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-num-recent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-num-recent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-num-recent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-num-recent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-num-recent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-num-recent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-num-recent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-num-recent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-num-recent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-num-recent.php" hreflang="zh">
...
<meta name="Description" content="Gets the number of recent messages in current mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_num_recent - Manual" />
<meta name="twitter:description" content="Gets the number of recent messages in current mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_num_recent - Manual" />
<meta itemprop="description" content="Gets the number of recent messages in current mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of recent messages in current mailbox" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-open.php">
          imap_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-num-msg.php">
          &laquo; imap_num_msg        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-num-recent.php' selected="selected">English</option>
            <option value='de/function.imap-num-recent.php'>German</option>
            <option value='es/function.imap-num-recent.php'>Spanish</option>
            <option value='fr/function.imap-num-recent.php'>French</option>
            <option value='it/function.imap-num-recent.php'>Italian</option>
            <option value='ja/function.imap-num-recent.php'>Japanese</option>
            <option value='pt_BR/function.imap-num-recent.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-num-recent.php'>Russian</option>
            <option value='tr/function.imap-num-recent.php'>Turkish</option>
            <option value='uk/function.imap-num-recent.php'>Ukrainian</option>
            <option value='zh/function.imap-num-recent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-num-recent" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_num_recent</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_num_recent</span> &mdash; <span class="dc-title">Gets the number of recent messages in current mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-num-recent-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_num_recent</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-num-recent-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-num-recent-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.imap-num-recent-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-num-recent-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-num-msg.php" class="function" rel="rdfs-seeAlso">imap_num_msg()</a> - Gets the number of messages in the current mailbox</span></li>
    <li><span class="function"><a href="function.imap-status.php" class="function" rel="rdfs-seeAlso">imap_status()</a> - Returns status information on a mailbox</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-num-recent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-num-recent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-num-recent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-num-recent.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="24749">  <div class="votes">
    <div id="Vu24749">
    <a href="/manual/vote-note.php?id=24749&amp;page=function.imap-num-recent&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd24749">
    <a href="/manual/vote-note.php?id=24749&amp;page=function.imap-num-recent&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V24749" title="57% like this...">
    1
    </div>
  </div>
  <a href="#24749" class="name">
  <strong class="user"><em>rok at ipunkt dot biz</em></strong></a><a class="genanchor" href="#24749"> &para;</a><div class="date" title="2002-08-27 02:10"><strong>23 years ago</strong></div>
  <div class="text" id="Hcom24749">
<div class="phpcode"><code><span class="html">The num_recent value does all the work it has to do. It returns only a number if the mail is not touched any time before.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-num-recent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-num-recent.php">＋<small>add a note</small></a></div>
