...
<head>
  ...
  <title>PHP: mailparse_msg_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mailparse-msg-create.php">
 <link rel="shorturl" href="https://www.php.net/mailparse-msg-create">
 <link rel="alternate" href="https://www.php.net/mailparse-msg-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mailparse.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mailparse-determine-best-xfer-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mailparse-msg-extract-part.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mailparse-msg-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mailparse-msg-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mailparse-msg-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mailparse-msg-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mailparse-msg-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mailparse-msg-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mailparse-msg-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mailparse-msg-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mailparse-msg-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mailparse-msg-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mailparse-msg-create.php" hreflang="zh">
...
<meta name="Description" content="Create a mime mail resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mailparse_msg_create - Manual" />
<meta name="twitter:description" content="Create a mime mail resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mailparse_msg_create - Manual" />
<meta itemprop="description" content="Create a mime mail resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a mime mail resource" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mailparse-msg-extract-part.php">
          mailparse_msg_extract_part &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mailparse-determine-best-xfer-encoding.php">
          &laquo; mailparse_determine_best_xfer_encoding        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mailparse-msg-create.php' selected="selected">English</option>
            <option value='de/function.mailparse-msg-create.php'>German</option>
            <option value='es/function.mailparse-msg-create.php'>Spanish</option>
            <option value='fr/function.mailparse-msg-create.php'>French</option>
            <option value='it/function.mailparse-msg-create.php'>Italian</option>
            <option value='ja/function.mailparse-msg-create.php'>Japanese</option>
            <option value='pt_BR/function.mailparse-msg-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.mailparse-msg-create.php'>Russian</option>
            <option value='tr/function.mailparse-msg-create.php'>Turkish</option>
            <option value='uk/function.mailparse-msg-create.php'>Ukrainian</option>
            <option value='zh/function.mailparse-msg-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mailparse-msg-create" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mailparse-msg-parse-file.php" class="function" rel="rdfs-seeAlso">mailparse_msg_parse_file()</a> - Parses a file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mailparse/functions/mailparse-msg-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mailparse-msg-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mailparse-msg-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mailparse-msg-create.php">＋<small>add a note</small></a></span>
