...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeWidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokepatternurl.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextalignment.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokewidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokewidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokewidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokewidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokewidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokewidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokewidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokewidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokewidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokewidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokewidth.php" hreflang="zh">
...
<meta name="Description" content="Sets the width of the stroke used to draw object outlines" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeWidth - Manual" />
<meta name="twitter:description" content="Sets the width of the stroke used to draw object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeWidth - Manual" />
<meta itemprop="description" content="Sets the width of the stroke used to draw object outlines" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the width of the stroke used to draw object outlines" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.settextalignment.php">
          ImagickDraw::setTextAlignment &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokepatternurl.php">
          &laquo; ImagickDraw::setStrokePatternURL        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokewidth.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokewidth.php'>German</option>
            <option value='es/imagickdraw.setstrokewidth.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokewidth.php'>French</option>
            <option value='it/imagickdraw.setstrokewidth.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokewidth.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokewidth.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokewidth.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokewidth.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokewidth.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokewidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokewidth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeWidth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeWidth</span> &mdash; <span class="dc-title">Sets the width of the stroke used to draw object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokewidth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeWidth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$width</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokewidth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokewidth-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.setstrokewidth-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3190">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::setStrokeWidth()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokewidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokewidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92109">  <div class="votes">
    <div id="Vu92109">
    <a href="/manual/vote-note.php?id=92109&amp;page=imagickdraw.setstrokewidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92109">
    <a href="/manual/vote-note.php?id=92109&amp;page=imagickdraw.setstrokewidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92109" title="100% like this...">
    2
    </div>
  </div>
  <a href="#92109" class="name">
  <strong class="user"><em>Peter - the Pete - de Pijd</em></strong></a><a class="genanchor" href="#92109"> &para;</a><div class="date" title="2009-07-09 02:31"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92109">
<div class="phpcode"><code><span class="html">If you set the stroke width to 0, there will often still be a hairline. To remove this hairline, use transparency, f.e. using:<br />setStrokeColor("#00000000")<br />hex 0-6 = color -&gt; black<br />hex 6-8 = opacity -&gt; full transparency</span></code></div>
  </div>
 </div>
  <div class="note" id="86778">  <div class="votes">
    <div id="Vu86778">
    <a href="/manual/vote-note.php?id=86778&amp;page=imagickdraw.setstrokewidth&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86778">
    <a href="/manual/vote-note.php?id=86778&amp;page=imagickdraw.setstrokewidth&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86778" title="66% like this...">
    1
    </div>
  </div>
  <a href="#86778" class="name">
  <strong class="user"><em>r dot vinke at gmail dot com</em></strong></a><a class="genanchor" href="#86778"> &para;</a><div class="date" title="2008-11-03 06:27"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86778">
<div class="phpcode"><code><span class="html">Please note that this function only works (as in: the stroke width changes) when setStrokeColor() is called before.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.setstrokewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokewidth.php">＋<small>add a note</small></a></div>
