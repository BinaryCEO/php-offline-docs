...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sapi-windows-cp-is-utf8.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sapi-windows-cp-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sapi-windows-cp-set.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sapi-windows-cp-is-utf8.php' selected="selected">English</option>
            <option value='de/function.sapi-windows-cp-is-utf8.php'>German</option>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.sapi-windows-cp-get.php" class="function" rel="rdfs-seeAlso">sapi_windows_cp_get()</a> - Get current codepage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/sapi-windows-cp-is-utf8.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sapi-windows-cp-is-utf8%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sapi-windows-cp-is-utf8&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sapi-windows-cp-is-utf8.php">＋<small>add a note</small></a></span>
