...
<head>
  ...
  <title>PHP: variant_div - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-div.php">
 <link rel="shorturl" href="https://www.php.net/variant-div">
 <link rel="alternate" href="https://www.php.net/variant-div" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-date-to-timestamp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-eqv.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-div.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-div.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-div.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-div.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-div.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-div.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-div.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-div.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-div.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-div.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-div.php" hreflang="zh">
...
<meta name="Description" content="Returns the result from dividing two variants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_div - Manual" />
<meta name="twitter:description" content="Returns the result from dividing two variants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_div - Manual" />
<meta itemprop="description" content="Returns the result from dividing two variants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the result from dividing two variants" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-eqv.php">
          variant_eqv &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.variant-date-to-timestamp.php">
          &laquo; variant_date_to_timestamp        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-div.php' selected="selected">English</option>
            <option value='de/function.variant-div.php'>German</option>
            <option value='es/function.variant-div.php'>Spanish</option>
            <option value='fr/function.variant-div.php'>French</option>
            <option value='it/function.variant-div.php'>Italian</option>
            <option value='ja/function.variant-div.php'>Japanese</option>
            <option value='pt_BR/function.variant-div.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-div.php'>Russian</option>
            <option value='tr/function.variant-div.php'>Turkish</option>
            <option value='uk/function.variant-div.php'>Ukrainian</option>
            <option value='zh/function.variant-div.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-div" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-idiv.php" class="function" rel="rdfs-seeAlso">variant_idiv()</a> - Converts variants to integers and then returns the result from dividing them</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-div.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-div%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-div&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-div.php">＋<small>add a note</small></a></span>
