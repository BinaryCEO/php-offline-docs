...
<head>
  ...
  <title>PHP: UnexpectedValueException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.unexpectedvalueexception.php">
 <link rel="shorturl" href="https://www.php.net/unexpectedvalueexception">
 <link rel="alternate" href="https://www.php.net/unexpectedvalueexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.underflowexception.php">
 <link rel="next" href="https://www.php.net/manual/en/spl.iterators.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.unexpectedvalueexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.unexpectedvalueexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.unexpectedvalueexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.unexpectedvalueexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.unexpectedvalueexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.unexpectedvalueexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.unexpectedvalueexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.unexpectedvalueexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.unexpectedvalueexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.unexpectedvalueexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.unexpectedvalueexception.php" hreflang="zh">
...
<meta name="Description" content="The UnexpectedValueException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UnexpectedValueException - Manual" />
<meta name="twitter:description" content="The UnexpectedValueException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UnexpectedValueException - Manual" />
<meta itemprop="description" content="The UnexpectedValueException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The UnexpectedValueException class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.unexpectedvalueexception.php' selected="selected">English</option>
            <option value='de/class.unexpectedvalueexception.php'>German</option>
            <option value='es/class.unexpectedvalueexception.php'>Spanish</option>
            <option value='fr/class.unexpectedvalueexception.php'>French</option>
            <option value='it/class.unexpectedvalueexception.php'>Italian</option>
            <option value='ja/class.unexpectedvalueexception.php'>Japanese</option>
            <option value='pt_BR/class.unexpectedvalueexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.unexpectedvalueexception.php'>Russian</option>
            <option value='tr/class.unexpectedvalueexception.php'>Turkish</option>
            <option value='uk/class.unexpectedvalueexception.php'>Ukrainian</option>
            <option value='zh/class.unexpectedvalueexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.unexpectedvalueexception" class="reference">
 <h1 class="title">The UnexpectedValueException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="unexpectedvalueexception.intro">
  ...
  <div class="section" id="unexpectedvalueexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">UnexpectedValueException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/unexpectedvalueexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.unexpectedvalueexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.unexpectedvalueexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.unexpectedvalueexception.php">＋<small>add a note</small></a></span>
