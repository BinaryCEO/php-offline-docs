...
<head>
  ...
  <title>PHP: ZipArchive::setEncryptionName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.setencryptionindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.setexternalattributesindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.setencryptionname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.setencryptionname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.setencryptionname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.setencryptionname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.setencryptionname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.setencryptionname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.setencryptionname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.setencryptionname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.setencryptionname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.setencryptionname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.setencryptionname.php" hreflang="zh">
...
<meta name="Description" content="Set the encryption method of an entry defined by its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::setEncryptionName - Manual" />
<meta name="twitter:description" content="Set the encryption method of an entry defined by its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::setEncryptionName - Manual" />
<meta itemprop="description" content="Set the encryption method of an entry defined by its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the encryption method of an entry defined by its name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ziparchive.setexternalattributesindex.php">
          ZipArchive::setExternalAttributesIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.setencryptionindex.php">
          &laquo; ZipArchive::setEncryptionIndex        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.setencryptionname.php' selected="selected">English</option>
            <option value='de/ziparchive.setencryptionname.php'>German</option>
            <option value='es/ziparchive.setencryptionname.php'>Spanish</option>
            <option value='fr/ziparchive.setencryptionname.php'>French</option>
            <option value='it/ziparchive.setencryptionname.php'>Italian</option>
            <option value='ja/ziparchive.setencryptionname.php'>Japanese</option>
            <option value='pt_BR/ziparchive.setencryptionname.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.setencryptionname.php'>Russian</option>
            <option value='tr/ziparchive.setencryptionname.php'>Turkish</option>
            <option value='uk/ziparchive.setencryptionname.php'>Ukrainian</option>
            <option value='zh/ziparchive.setencryptionname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.setencryptionname" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-ziparchive.setencryptionname-examples">
  <h3 class="title">Examples</h3>
    ...
    <div class="example" id="example-953">
     <p><strong>Example #1 Archive and encrypt a file</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="ziparchive.setencryptionindex.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::setEncryptionIndex()</a> - Set the encryption method of an entry defined by its index</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/setencryptionname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.setencryptionname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.setencryptionname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setencryptionname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125270">  <div class="votes">
    <div id="Vu125270">
    <a href="/manual/vote-note.php?id=125270&amp;page=ziparchive.setencryptionname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125270">
    <a href="/manual/vote-note.php?id=125270&amp;page=ziparchive.setencryptionname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125270" title="81% like this...">
    10
    </div>
  </div>
  <a href="#125270" class="name">
  <strong class="user"><em>mauro dot chojrin at leewayweb dot com</em></strong></a><a class="genanchor" href="#125270"> &para;</a><div class="date" title="2020-08-14 05:13"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125270">
<div class="phpcode"><code><span class="html">Files compressed using this function on Linux won't be decompressed using Windows.<br /><br />There seems to be some incompatibility with Windows built-in decompressor.<br /><br />There's an alternative library that works better here: <a href="https://github.com/Ne-Lexa/php-zip" rel="nofollow" target="_blank">https://github.com/Ne-Lexa/php-zip</a><br /><br />I got windows to open a file created with it by using the PKWARE encryption method</span></code></div>
  </div>
 </div>
  <div class="note" id="125971">  <div class="votes">
    <div id="Vu125971">
    <a href="/manual/vote-note.php?id=125971&amp;page=ziparchive.setencryptionname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125971">
    <a href="/manual/vote-note.php?id=125971&amp;page=ziparchive.setencryptionname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125971" title="100% like this...">
    2
    </div>
  </div>
  <a href="#125971" class="name">
  <strong class="user"><em>romke at romke dot nl</em></strong></a><a class="genanchor" href="#125971"> &para;</a><div class="date" title="2021-03-30 10:34"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125971">
<div class="phpcode"><code><span class="html">On windows is the "EM_AES_256" by default not supported, but you can use winrar, winzip or 7zip.<br /><br />At first we had a password of 128 chars (this was to long) and all extract applications give an error that the password was incorrect.<br /><br />The next time we did use a password of 52 chars., this time i did work!</span></code></div>
  </div>
 </div>
  <div class="note" id="129837">  <div class="votes">
    <div id="Vu129837">
    <a href="/manual/vote-note.php?id=129837&amp;page=ziparchive.setencryptionname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129837">
    <a href="/manual/vote-note.php?id=129837&amp;page=ziparchive.setencryptionname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129837" title="no votes...">
    0
    </div>
  </div>
  <a href="#129837" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#129837"> &para;</a><div class="date" title="2024-11-06 06:53"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129837">
<div class="phpcode"><code><span class="html">When using setEncryptionName, the first parameter is equal to the entry name of the file you added.<br />In case you set an explicit entry name with the second parameters of the addFile method, then you need to use that entry name.<br />Using the first parameter of addFile will only work in case the second parameter is not used.<br /><br />This works :<br />$zip-&gt;addFile('test.txt', 'my_awesome_textfile.txt');<br />$zip-&gt;setEncryptionName('my_awesome_textfile.txt', ZipArchive::EM_AES_256);<br /><br />This does not work and will generate an archive without any encryption :<br />$zip-&gt;addFile('test.txt', 'my_awesome_textfile.txt');<br />$zip-&gt;setEncryptionName('text.txt', ZipArchive::EM_AES_256);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.setencryptionname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.setencryptionname.php">＋<small>add a note</small></a></div>
