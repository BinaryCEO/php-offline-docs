...
<head>
  ...
  <title>PHP: imagecreatefromxbm - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefromxbm.php">
 <link rel="shorturl" href="https://www.php.net/imagecreatefromxbm">
 <link rel="alternate" href="https://www.php.net/imagecreatefromxbm" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreatefromwebp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatefromxpm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecreatefromxbm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecreatefromxbm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecreatefromxbm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecreatefromxbm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecreatefromxbm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecreatefromxbm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecreatefromxbm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecreatefromxbm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecreatefromxbm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecreatefromxbm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecreatefromxbm.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecreatefromxbm - Manual" />
<meta name="twitter:description" content="Create a new image from file or URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecreatefromxbm - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecreatefromxpm.php">
          imagecreatefromxpm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagecreatefromwebp.php">
          &laquo; imagecreatefromwebp        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefromxbm.php' selected="selected">English</option>
            <option value='de/function.imagecreatefromxbm.php'>German</option>
            <option value='es/function.imagecreatefromxbm.php'>Spanish</option>
            <option value='fr/function.imagecreatefromxbm.php'>French</option>
            <option value='it/function.imagecreatefromxbm.php'>Italian</option>
            <option value='ja/function.imagecreatefromxbm.php'>Japanese</option>
            <option value='pt_BR/function.imagecreatefromxbm.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecreatefromxbm.php'>Russian</option>
            <option value='tr/function.imagecreatefromxbm.php'>Turkish</option>
            <option value='uk/function.imagecreatefromxbm.php'>Ukrainian</option>
            <option value='zh/function.imagecreatefromxbm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecreatefromxbm" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecreatefromxbm</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.1, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagecreatefromxbm</span> &mdash; <span class="dc-title">Create a new image from file or URL</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagecreatefromxbm-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecreatefromxbm</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
provide.</p></div>
 ...
 <div class="refsect1 changelog" id="refsect1-function.imagecreatefromxbm-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Load the xbm file<br /></span><span style="color: #0000BB">$xbm </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromxbm</span><span style="color: #007700">(</span><span style="color: #DD0000">'./example.xbm'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Convert it to a png file<br /></span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$xbm</span><span style="color: #007700">, </span><span style="color: #DD0000">'./example.png'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefromxbm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefromxbm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefromxbm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromxbm.php">＋<small>add a note</small></a></span>
