...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-cms-decrypt.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-cipher-key-length.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-cms-encrypt.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-cms-decrypt.php' selected="selected">English</option>
            ...
            <option value='zh/function.openssl-cms-decrypt.php'>Chinese (Simplified)</option>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-cms-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-cms-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-cms-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-decrypt.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">It took me a while to find out the correct way how to decrypt and verify data with these functions.<br />I needed that to communicate with German Health Insurance Providers as part of a DiGA. Maybe someone finds that useful.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">decryptAndVerify</span><span class="keyword">(</span><span class="default">$signedAndEncryptedRawData</span><span class="keyword">): </span><span class="default">string<br /></span><span class="keyword">{<br />    </span><span class="default">$tempDir </span><span class="keyword">= </span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/tmp'</span><span class="keyword">;<br />    </span><span class="default">$originalFile </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'original'</span><span class="keyword">);<br />    </span><span class="default">$decryptedFile </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'decrypted'</span><span class="keyword">);<br />    </span><span class="default">$verifiedFile </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="default">$tempDir</span><span class="keyword">, </span><span class="string">'verified'</span><span class="keyword">);<br /><br />    </span><span class="default">file_put_contents</span><span class="keyword">(</span><span class="default">$originalFile</span><span class="keyword">, </span><span class="default">$signedAndEncryptedRawData</span><span class="keyword">);<br />    <br />    </span><span class="comment">// One file with all possible certificates one after the other<br />    // -----BEGIN CERTIFICATE----- ...-----END CERTIFICATE-----<br />    </span><span class="default">$allPossibleSenderCertificates </span><span class="keyword">= </span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/untrusted.pem'</span><span class="keyword">;<br /><br />    </span><span class="comment">// Certificate:<br />    //    Data:<br />    //        Version: 3 (0x2)...<br />    </span><span class="default">$myCertificate </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/my.crt'</span><span class="keyword">);<br />    </span><span class="default">$myPrivateKey </span><span class="keyword">= </span><span class="default">openssl_pkey_get_private</span><span class="keyword">(<br />    </span><span class="comment">// -----BEGIN RSA PRIVATE KEY----- ... -----END RSA PRIVATE KEY-----<br />        </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/my.prv.key.pem'</span><span class="keyword">)<br />    );<br />    <br />    </span><span class="default">openssl_cms_decrypt</span><span class="keyword">(<br />        </span><span class="default">input_filename</span><span class="keyword">: </span><span class="default">$originalFile</span><span class="keyword">,<br />        </span><span class="default">output_filename</span><span class="keyword">: </span><span class="default">$decryptedFile</span><span class="keyword">,<br />        </span><span class="default">certificate</span><span class="keyword">: </span><span class="default">$myCertificate</span><span class="keyword">,<br />        </span><span class="default">private_key</span><span class="keyword">: </span><span class="default">$myPrivateKey</span><span class="keyword">,<br />        </span><span class="default">encoding</span><span class="keyword">: </span><span class="default">OPENSSL_ENCODING_DER<br />    </span><span class="keyword">);<br /><br />    </span><span class="default">openssl_cms_verify</span><span class="keyword">(<br />        </span><span class="default">input_filename</span><span class="keyword">: </span><span class="default">$decryptedFile</span><span class="keyword">,<br />        </span><span class="default">flags</span><span class="keyword">: </span><span class="default">OPENSSL_CMS_BINARY </span><span class="keyword">| </span><span class="default">OPENSSL_CMS_NOSIGS </span><span class="keyword">| </span><span class="default">OPENSSL_CMS_NOVERIFY</span><span class="keyword">,<br />        </span><span class="default">ca_info</span><span class="keyword">: [],<br />        </span><span class="default">untrusted_certificates_filename</span><span class="keyword">: </span><span class="default">$allPossibleSenderCertificates</span><span class="keyword">,<br />        </span><span class="default">content</span><span class="keyword">: </span><span class="default">$verifiedFile</span><span class="keyword">,<br />        </span><span class="default">encoding</span><span class="keyword">: </span><span class="default">OPENSSL_ENCODING_DER<br />    </span><span class="keyword">);<br />    return </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="default">$verifiedFile</span><span class="keyword">);<br />}</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-cms-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-cms-decrypt.php">＋<small>add a note</small></a></div>
