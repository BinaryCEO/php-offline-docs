...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/cmark.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/cmark.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/cmark.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.cmark.php">
 <link rel="next" href="https://www.php.net/manual/en/cmark.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/cmark.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/cmark.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/cmark.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/cmark.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/cmark.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/cmark.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/cmark.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/cmark.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/cmark.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/cmark.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/cmark.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/cmark.setup.php' selected="selected">English</option>
            <option value='de/cmark.setup.php'>German</option>
            <option value='es/cmark.setup.php'>Spanish</option>
            <option value='fr/cmark.setup.php'>French</option>
            <option value='it/cmark.setup.php'>Italian</option>
            <option value='ja/cmark.setup.php'>Japanese</option>
            <option value='pt_BR/cmark.setup.php'>Brazilian Portuguese</option>
            <option value='ru/cmark.setup.php'>Russian</option>
            <option value='tr/cmark.setup.php'>Turkish</option>
            <option value='uk/cmark.setup.php'>Ukrainian</option>
            <option value='zh/cmark.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="cmark.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="cmark.requirements.php">Requirements</a></li><li><a href="cmark.installation.php">Installation</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcmark.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=cmark.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/cmark.setup.php">＋<small>add a note</small></a></span>
