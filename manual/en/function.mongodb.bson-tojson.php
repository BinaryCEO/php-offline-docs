...
<head>
  ...
  <title>PHP: MongoDB\BSON\toJSON - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mongodb.bson-tojson.php">
 <link rel="shorturl" href="https://www.php.net/mongodb.bson-tojson">
 <link rel="alternate" href="https://www.php.net/mongodb.bson-tojson" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.bson.functions.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mongodb.bson-tocanonicalextendedjson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mongodb.bson-tophp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mongodb.bson-tojson.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mongodb.bson-tojson.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mongodb.bson-tojson.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mongodb.bson-tojson.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mongodb.bson-tojson.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mongodb.bson-tojson.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mongodb.bson-tojson.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mongodb.bson-tojson.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mongodb.bson-tojson.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mongodb.bson-tojson.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mongodb.bson-tojson.php" hreflang="zh">
...
<meta name="Description" content="Returns the Legacy Extended JSON representation of a BSON value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\toJSON - Manual" />
<meta name="twitter:description" content="Returns the Legacy Extended JSON representation of a BSON value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\toJSON - Manual" />
<meta itemprop="description" content="Returns the Legacy Extended JSON representation of a BSON value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Legacy Extended JSON representation of a BSON value" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mongodb.bson-tophp.php">
          MongoDB\BSON\toPHP &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mongodb.bson-tocanonicalextendedjson.php">
          &laquo; MongoDB\BSON\toCanonicalExtendedJSON        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mongodb.bson-tojson.php' selected="selected">English</option>
            <option value='de/function.mongodb.bson-tojson.php'>German</option>
            <option value='es/function.mongodb.bson-tojson.php'>Spanish</option>
            <option value='fr/function.mongodb.bson-tojson.php'>French</option>
            <option value='it/function.mongodb.bson-tojson.php'>Italian</option>
            <option value='ja/function.mongodb.bson-tojson.php'>Japanese</option>
            <option value='pt_BR/function.mongodb.bson-tojson.php'>Brazilian Portuguese</option>
            <option value='ru/function.mongodb.bson-tojson.php'>Russian</option>
            <option value='tr/function.mongodb.bson-tojson.php'>Turkish</option>
            <option value='uk/function.mongodb.bson-tojson.php'>Ukrainian</option>
            <option value='zh/function.mongodb.bson-tojson.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mongodb.bson-tojson" class="refentry">
 ...
 <div id="function.mongodb.bson-tojson-refsynopsisdiv">
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="para">
    ...
    <span class="methodname"><a href="mongodb-bson-document.tocanonicalextendedjson.php" class="methodname">MongoDB\BSON\Document::toCanonicalExtendedJSON()</a></span> or
 ...
 <div class="refsect1 description" id="refsect1-function.mongodb.bson-tojson-description">
  ...
  <p class="para rdfs-comment">
   ...
   <a href="https://www.mongodb.com/docs/manual/reference/mongodb-extended-json/" class="link external">&raquo;&nbsp;Legacy Extended JSON</a>
   representation.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    ...
    the
    <a href="https://github.com/mongodb/specifications/blob/master/source/extended-json/extended-json.md" class="link external">&raquo;&nbsp;Extended JSON Specification</a>
    and implemented by <span class="function"><a href="function.mongodb.bson-tocanonicalextendedjson.php" class="function">MongoDB\BSON\toCanonicalExtendedJSON()</a></span>
    and <span class="function"><a href="function.mongodb.bson-torelaxedextendedjson.php" class="function">MongoDB\BSON\toRelaxedExtendedJSON()</a></span>, respectively.
   </span>
  </p></blockquote>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    <a href="http://www.json.org/" class="link external">&raquo;&nbsp;JSON</a> does not support
    <a href="language.types.float.php#language.types.float.nan" class="link"><strong><code><a href="math.constants.php#constant.nan">NAN</a></code></strong></a> and
    <a href="function.is-infinite.php" class="link"><strong><code><a href="math.constants.php#constant.inf">INF</a></code></strong></a> and
    MongoDB&#039;s Legacy Extended JSON format does not define an alternative
    representation for these values
    (<a href="https://github.com/mongodb/mongo-c-driver/tree/master/src/libbson" class="link external">&raquo;&nbsp;libbson</a> will output
    ...
    <span class="function"><a href="function.mongodb.bson-tocanonicalextendedjson.php" class="function">MongoDB\BSON\toCanonicalExtendedJSON()</a></span> or
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;MongoDB BSON</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/functions/bson/tojson.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mongodb.bson-tojson%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mongodb.bson-tojson&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mongodb.bson-tojson.php">＋<small>add a note</small></a></span>
