...
<head>
  ...
  <title>PHP: ImagickDraw::setStrokeMiterLimit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setstrokelinejoin.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setstrokeopacity.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setstrokemiterlimit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setstrokemiterlimit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setstrokemiterlimit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setstrokemiterlimit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setstrokemiterlimit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setstrokemiterlimit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setstrokemiterlimit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setstrokemiterlimit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setstrokemiterlimit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setstrokemiterlimit.php" hreflang="zh">
...
<meta name="Description" content="Specifies the miter limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setStrokeMiterLimit - Manual" />
<meta name="twitter:description" content="Specifies the miter limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setStrokeMiterLimit - Manual" />
<meta itemprop="description" content="Specifies the miter limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies the miter limit" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.setstrokeopacity.php">
          ImagickDraw::setStrokeOpacity &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setstrokelinejoin.php">
          &laquo; ImagickDraw::setStrokeLineJoin        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setstrokemiterlimit.php' selected="selected">English</option>
            <option value='de/imagickdraw.setstrokemiterlimit.php'>German</option>
            <option value='es/imagickdraw.setstrokemiterlimit.php'>Spanish</option>
            <option value='fr/imagickdraw.setstrokemiterlimit.php'>French</option>
            <option value='it/imagickdraw.setstrokemiterlimit.php'>Italian</option>
            <option value='ja/imagickdraw.setstrokemiterlimit.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setstrokemiterlimit.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setstrokemiterlimit.php'>Russian</option>
            <option value='tr/imagickdraw.setstrokemiterlimit.php'>Turkish</option>
            <option value='uk/imagickdraw.setstrokemiterlimit.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setstrokemiterlimit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setstrokemiterlimit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setStrokeMiterLimit</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setStrokeMiterLimit</span> &mdash; <span class="dc-title">Specifies the miter limit</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setstrokemiterlimit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setStrokeMiterLimit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$miterlimit</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setstrokemiterlimit-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">miterlimit</code></dt>
     <dd>
      <p class="para">
       the miter limit
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setstrokemiterlimit-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3188">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setstrokemiterlimit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setstrokemiterlimit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setstrokemiterlimit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setstrokemiterlimit.php">＋<small>add a note</small></a></span>
