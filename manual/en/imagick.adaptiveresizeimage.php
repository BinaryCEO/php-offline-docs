...
<head>
  ...
  <title>PHP: Imagick::adaptiveResizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.adaptiveblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.adaptiveresizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.adaptiveresizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.adaptiveresizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.adaptiveresizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.adaptiveresizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.adaptiveresizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.adaptiveresizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.adaptiveresizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.adaptiveresizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.adaptiveresizeimage.php" hreflang="zh">
...
<meta name="Description" content="Adaptively resize image with data dependent triangulation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::adaptiveResizeImage - Manual" />
<meta name="twitter:description" content="Adaptively resize image with data dependent triangulation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::adaptiveResizeImage - Manual" />
<meta itemprop="description" content="Adaptively resize image with data dependent triangulation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adaptively resize image with data dependent triangulation" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.adaptivesharpenimage.php">
          Imagick::adaptiveSharpenImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.adaptiveblurimage.php">
          &laquo; Imagick::adaptiveBlurImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.adaptiveresizeimage.php' selected="selected">English</option>
            <option value='de/imagick.adaptiveresizeimage.php'>German</option>
            <option value='es/imagick.adaptiveresizeimage.php'>Spanish</option>
            <option value='fr/imagick.adaptiveresizeimage.php'>French</option>
            <option value='it/imagick.adaptiveresizeimage.php'>Italian</option>
            <option value='ja/imagick.adaptiveresizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.adaptiveresizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.adaptiveresizeimage.php'>Russian</option>
            <option value='tr/imagick.adaptiveresizeimage.php'>Turkish</option>
            <option value='uk/imagick.adaptiveresizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.adaptiveresizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.adaptiveresizeimage" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.adaptiveresizeimage-examples">
  ...
  <p class="para">
   <div class="example" id="example-2963">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.trimimage.php" class="function" rel="rdfs-seeAlso">Imagick::trimImage()</a> - Remove edges from the image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/adaptiveresizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.adaptiveresizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.adaptiveresizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.adaptiveresizeimage.php">＋<small>add a note</small></a></span>
