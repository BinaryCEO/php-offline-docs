...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-set-max-parallel.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-set-max-idle.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-set-max-poll-reqs.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-set-max-parallel.php' selected="selected">English</option>
            ...
            <option value='tr/function.eio-set-max-parallel.php'>Turkish</option>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.eio-set-min-parallel.php" class="function" rel="rdfs-seeAlso">eio_set_min_parallel()</a> - Set minimum parallel thread number</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-set-max-parallel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-set-max-parallel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-set-max-parallel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-set-max-parallel.php">＋<small>add a note</small></a></span>
