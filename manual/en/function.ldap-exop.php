...
<head>
  ...
  <title>PHP: ldap_exop - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-exop.php">
 <link rel="shorturl" href="https://www.php.net/ldap-exop">
 <link rel="alternate" href="https://www.php.net/ldap-exop" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-escape.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-exop-passwd.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-exop.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-exop.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-exop.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-exop.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-exop.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-exop.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-exop.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-exop.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-exop.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-exop.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-exop.php" hreflang="zh">
...
<meta name="Description" content="Performs an extended operation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_exop - Manual" />
<meta name="twitter:description" content="Performs an extended operation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_exop - Manual" />
<meta itemprop="description" content="Performs an extended operation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs an extended operation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-exop-passwd.php">
          ldap_exop_passwd &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-exop.php' selected="selected">English</option>
            <option value='de/function.ldap-exop.php'>German</option>
            <option value='es/function.ldap-exop.php'>Spanish</option>
            <option value='fr/function.ldap-exop.php'>French</option>
            <option value='it/function.ldap-exop.php'>Italian</option>
            <option value='ja/function.ldap-exop.php'>Japanese</option>
            <option value='pt_BR/function.ldap-exop.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-exop.php'>Russian</option>
            <option value='tr/function.ldap-exop.php'>Turkish</option>
            <option value='uk/function.ldap-exop.php'>Ukrainian</option>
            <option value='zh/function.ldap-exop.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-exop" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_exop</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_exop</span> &mdash; <span class="dc-title">Performs an extended operation</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-exop-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_exop</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$request_oid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$request_data</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$controls</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$response_data</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$response_oid</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>

  <p class="para rdfs-comment">
   Performs an extended operation on the specified <code class="parameter">ldap</code> with
   <code class="parameter">request_oid</code> the OID of the operation and
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-exop-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
       The extended operation request OID. You may use one of <strong><code><a href="ldap.constants.php#constant.ldap-exop-start-tls">LDAP_EXOP_START_TLS</a></code></strong>, <strong><code><a href="ldap.constants.php#constant.ldap-exop-modify-passwd">LDAP_EXOP_MODIFY_PASSWD</a></code></strong>, <strong><code><a href="ldap.constants.php#constant.ldap-exop-refresh">LDAP_EXOP_REFRESH</a></code></strong>, <strong><code><a href="ldap.constants.php#constant.ldap-exop-who-am-i">LDAP_EXOP_WHO_AM_I</a></code></strong>, <strong><code><a href="ldap.constants.php#constant.ldap-exop-turn">LDAP_EXOP_TURN</a></code></strong>, or a string with the OID of the operation you want to send.
     </p>
    </dd>
    ...
    <dd>
     <p class="para">
       The extended operation request data. May be NULL for some operations like <strong><code><a href="ldap.constants.php#constant.ldap-exop-who-am-i">LDAP_EXOP_WHO_AM_I</a></code></strong>, may also need to be BER encoded.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-exop-returnvalues">
  ...
  <p class="para">
   When used with <code class="parameter">response_data</code>, returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
   When used without <code class="parameter">response_data</code>, returns a result identifier or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$ds </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">);  </span><span style="color: #FF8000">// assuming the LDAP server is on this host<br /><br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">$ds</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// bind with appropriate dn to give update access<br />    </span><span style="color: #0000BB">$bind </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_bind</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #DD0000">"cn=root, o=My Company, c=US"</span><span style="color: #007700">, </span><span style="color: #DD0000">"secret"</span><span style="color: #007700">);<br />    if (!</span><span style="color: #0000BB">$bind</span><span style="color: #007700">) {<br />      echo </span><span style="color: #DD0000">"Unable to bind to LDAP server"</span><span style="color: #007700">;<br />      exit;<br />    }<br /><br />    </span><span style="color: #FF8000">// Call WHOAMI EXOP<br />    </span><span style="color: #0000BB">$r </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_exop</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">LDAP_EXOP_WHO_AM_I</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">// Parse the result object<br />    </span><span style="color: #0000BB">ldap_parse_exop</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">$r</span><span style="color: #007700">, </span><span style="color: #0000BB">$retdata</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// Output: string(31) "dn:cn=root, o=My Company, c=US"<br />    </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$retdata</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">// Same thing using $response_data parameter<br />    </span><span style="color: #0000BB">$success </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_exop</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">LDAP_EXOP_WHO_AM_I</span><span style="color: #007700">, </span><span style="color: #0000BB">NULL</span><span style="color: #007700">, </span><span style="color: #0000BB">NULL</span><span style="color: #007700">, </span><span style="color: #0000BB">$retdata</span><span style="color: #007700">, </span><span style="color: #0000BB">$retoid</span><span style="color: #007700">);<br />    if (</span><span style="color: #0000BB">$success</span><span style="color: #007700">) {<br />      </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$retdata</span><span style="color: #007700">);<br />    }<br /><br />    </span><span style="color: #0000BB">ldap_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">);<br />} else {<br />    echo </span><span style="color: #DD0000">"Unable to connect to LDAP server"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-exop-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-parse-result.php" class="function" rel="rdfs-seeAlso">ldap_parse_result()</a> - Extract information from result</span></li>
    ...
    <li><span class="function"><a href="function.ldap-exop-passwd.php" class="function" rel="rdfs-seeAlso">ldap_exop_passwd()</a> - PASSWD extended operation helper</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-exop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-exop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-exop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122950">  <div class="votes">
    <div id="Vu122950">
    <a href="/manual/vote-note.php?id=122950&amp;page=function.ldap-exop&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122950">
    <a href="/manual/vote-note.php?id=122950&amp;page=function.ldap-exop&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122950" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#122950" class="name">
  <strong class="user"><em>Roland Gruber</em></strong></a><a class="genanchor" href="#122950"> &para;</a><div class="date" title="2018-07-16 03:50"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122950">
<div class="phpcode"><code><span class="html">The following can be used to run the refresh command in PHP 7.2 as ldap_exop_refresh comes with 7.3.<br /><br />$dn= 'cn=user,dc=test,dc=org';<br />$ttl = 3600;<br />$data = '';<br />$data .= '80' . sprintf("%'.02x", strlen($dn)) . bin2hex($dn);<br />$data .= '81' . sprintf("%'.02x", 4) . sprintf("%'.08x", $ttl);<br />$data = hex2bin('30' . sprintf("%'.02x", strlen($data)/2) . $data);<br />$success = ldap_exop($ldapHandle, LDAP_EXOP_REFRESH, $data);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-exop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-exop.php">＋<small>add a note</small></a></div>
