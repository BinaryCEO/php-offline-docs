...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/closure.fromcallable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/closure.fromcallable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/closure.fromcallable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.closure.php">
 <link rel="prev" href="https://www.php.net/manual/en/closure.call.php">
 <link rel="next" href="https://www.php.net/manual/en/class.stdclass.php">
...
<meta name="Description" content="Converts a callable into a closure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Closure::fromCallable - Manual" />
<meta name="twitter:description" content="Converts a callable into a closure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Closure::fromCallable - Manual" />
<meta itemprop="description" content="Converts a callable into a closure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts a callable into a closure" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/closure.fromcallable.php' selected="selected">English</option>
            <option value='de/closure.fromcallable.php'>German</option>
            <option value='es/closure.fromcallable.php'>Spanish</option>
            <option value='fr/closure.fromcallable.php'>French</option>
  ...
  <ul class="simplelist">
   ...
   <li><a href="functions.first_class_callable_syntax.php" class="link">First class callable syntax</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/closure/fromcallable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclosure.fromcallable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=closure.fromcallable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/closure.fromcallable.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">I have two points:<br /><br />It is possible to use Closure::fromCallable to convert private/protected methods to closures and use them outside the class.<br /><br />Closure::fromCallable accepts late dynamic bindings using the keyword static if provided as a string. <br /><br />My code below demonstrate how a private static method can be used as a callback in a function outside the class.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">myCustomMapper </span><span class="keyword">( Callable </span><span class="default">$callable</span><span class="keyword">, </span><span class="default">string $str </span><span class="keyword">): </span><span class="default">string </span><span class="keyword">{<br />  return </span><span class="default">join</span><span class="keyword">(</span><span class="string">' '</span><span class="keyword">, </span><span class="default">array_map</span><span class="keyword">( </span><span class="default">$callable</span><span class="keyword">, </span><span class="default">explode</span><span class="keyword">(</span><span class="string">' '</span><span class="keyword">, </span><span class="default">$str</span><span class="keyword">) ) );<br />}<br /><br />class </span><span class="default">MyClass </span><span class="keyword">{<br /><br />    public static function </span><span class="default">mapUCFirst </span><span class="keyword">( </span><span class="default">string $str </span><span class="keyword">): </span><span class="default">string </span><span class="keyword">{<br />        </span><span class="default">$privateMethod </span><span class="keyword">= </span><span class="string">'static::mapper'</span><span class="keyword">;<br />        </span><span class="default">$mapper </span><span class="keyword">= </span><span class="default">Closure</span><span class="keyword">::</span><span class="default">fromCallable</span><span class="keyword">( </span><span class="default">$privateMethod </span><span class="keyword">);<br />        return </span><span class="default">myCustomMapper</span><span class="keyword">( </span><span class="default">$mapper</span><span class="keyword">, </span><span class="default">$str </span><span class="keyword">);<br />    }<br />    private static function </span><span class="default">mapper </span><span class="keyword">( </span><span class="default">string $str </span><span class="keyword">): </span><span class="default">string </span><span class="keyword">{<br />        return </span><span class="default">ucfirst</span><span class="keyword">( </span><span class="default">$str </span><span class="keyword">);<br />    }<br /><br />}<br /><br />echo </span><span class="default">MyClass</span><span class="keyword">::</span><span class="default">mapUCFirst</span><span class="keyword">(</span><span class="string">'four little uncapitalized words'</span><span class="keyword">);<br /></span><span class="comment">// Prints: Four Little Uncapitalized Words<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Sadly, your comparison is incorrect.<br /><br />// The equivalent to<br />$cl1 = Closure::fromCallable("getName");<br />$cl1 = $cl1-&gt;bindTo($bob, 'A');<br /><br />// is most likely this<br />$cl2 = function() {<br />    return call_user_func_array("getName", func_get_args());<br />};<br />$cl2 = $cl2-&gt;bindTo($bob, 'A');<br /><br />Executing one or the other Closure should result in the same access violation error you already postet.<br /><br />----<br />A simple PHP 7.0 polyfill could look like this:<br />----<br /><br />namespace YourPackage;<br /><br />/**<br /> * Class Closure<br /> *<br /> * @see \Closure<br /> */<br />class Closure<br />{<br />    /**<br />     * @see \Closure::fromCallable()<br />     * @param callable $callable<br />     * @return \Closure<br />     */<br />    public static function fromCallable(callable $callable)<br />    {<br />        // In case we've got it native, let's use that native one!<br />        if(method_exists(\Closure::class, 'fromCallable')) {<br />            return \Closure::fromCallable($callable);<br />        }<br /><br />        return function () use ($callable) {<br />            return call_user_func_array($callable, func_get_args());<br />        };<br />    }<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=closure.fromcallable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/closure.fromcallable.php">＋<small>add a note</small></a></div>
