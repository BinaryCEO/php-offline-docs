...
<head>
  ...
  <title>PHP: Imagick::paintFloodfillImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.paintfloodfillimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.paintfloodfillimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.paintfloodfillimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.orderedposterizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.paintopaqueimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.paintfloodfillimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.paintfloodfillimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.paintfloodfillimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.paintfloodfillimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.paintfloodfillimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.paintfloodfillimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.paintfloodfillimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.paintfloodfillimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.paintfloodfillimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.paintfloodfillimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.paintfloodfillimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::paintFloodfillImage - Manual" />
<meta name="twitter:description" content="Changes the color value of any pixel that matches target" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::paintFloodfillImage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.paintopaqueimage.php">
          Imagick::paintOpaqueImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.orderedposterizeimage.php">
          &laquo; Imagick::orderedPosterizeImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.paintfloodfillimage.php' selected="selected">English</option>
            <option value='de/imagick.paintfloodfillimage.php'>German</option>
            <option value='es/imagick.paintfloodfillimage.php'>Spanish</option>
            <option value='fr/imagick.paintfloodfillimage.php'>French</option>
            <option value='it/imagick.paintfloodfillimage.php'>Italian</option>
            <option value='ja/imagick.paintfloodfillimage.php'>Japanese</option>
            <option value='pt_BR/imagick.paintfloodfillimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.paintfloodfillimage.php'>Russian</option>
            <option value='tr/imagick.paintfloodfillimage.php'>Turkish</option>
            <option value='uk/imagick.paintfloodfillimage.php'>Ukrainian</option>
            <option value='zh/imagick.paintfloodfillimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.paintfloodfillimage" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/paintfloodfillimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.paintfloodfillimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.paintfloodfillimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.paintfloodfillimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102483">  <div class="votes">
    <div id="Vu102483">
    <a href="/manual/vote-note.php?id=102483&amp;page=imagick.paintfloodfillimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102483">
    <a href="/manual/vote-note.php?id=102483&amp;page=imagick.paintfloodfillimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102483" title="no votes...">
    0
    </div>
  </div>
  <a href="#102483" class="name">
  <strong class="user"><em>mamcia at gmail dot com</em></strong></a><a class="genanchor" href="#102483"> &para;</a><div class="date" title="2011-02-17 01:08"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102483">
<div class="phpcode"><code><span class="html">Seems that this method doesn't work as expected. Use Imagick::floodFillPaintImage() instead.
<br />
<br /><span class="default">&lt;?php
<br />$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'/tmp/test.png'</span><span class="keyword">);
<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">floodFillPaintImage</span><span class="keyword">(</span><span class="string">'green'</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="string">'white'</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);
<br /></span><span class="default">$img</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'/tmp/out.png'</span><span class="keyword">);
...
<div class="foot"><a href="/manual/add-note.php?sect=imagick.paintfloodfillimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.paintfloodfillimage.php">＋<small>add a note</small></a></div>
