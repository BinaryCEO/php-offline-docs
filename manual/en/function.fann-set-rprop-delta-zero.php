...
<head>
  ...
  <title>PHP: fann_set_rprop_delta_zero - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-rprop-delta-zero.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-rprop-delta-zero">
 <link rel="alternate" href="https://www.php.net/fann-set-rprop-delta-zero" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-rprop-delta-min.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-rprop-increase-factor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-rprop-delta-zero.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-rprop-delta-zero.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-rprop-delta-zero.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-rprop-delta-zero.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-rprop-delta-zero.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-rprop-delta-zero.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-rprop-delta-zero.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-rprop-delta-zero.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-rprop-delta-zero.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-rprop-delta-zero.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-rprop-delta-zero.php" hreflang="zh">
...
<meta name="Description" content="Sets the initial step-size" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_rprop_delta_zero - Manual" />
<meta name="twitter:description" content="Sets the initial step-size" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_rprop_delta_zero - Manual" />
<meta itemprop="description" content="Sets the initial step-size" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the initial step-size" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-rprop-increase-factor.php">
          fann_set_rprop_increase_factor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-rprop-delta-min.php">
          &laquo; fann_set_rprop_delta_min        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-rprop-delta-zero.php' selected="selected">English</option>
            <option value='de/function.fann-set-rprop-delta-zero.php'>German</option>
            <option value='es/function.fann-set-rprop-delta-zero.php'>Spanish</option>
            <option value='fr/function.fann-set-rprop-delta-zero.php'>French</option>
            <option value='it/function.fann-set-rprop-delta-zero.php'>Italian</option>
            <option value='ja/function.fann-set-rprop-delta-zero.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-rprop-delta-zero.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-rprop-delta-zero.php'>Russian</option>
            <option value='tr/function.fann-set-rprop-delta-zero.php'>Turkish</option>
            <option value='uk/function.fann-set-rprop-delta-zero.php'>Ukrainian</option>
            <option value='zh/function.fann-set-rprop-delta-zero.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-rprop-delta-zero" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_rprop_delta_zero</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_rprop_delta_zero</span> &mdash; <span class="dc-title">Sets the initial step-size</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-rprop-delta-zero-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_rprop_delta_zero</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$rprop_delta_zero</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-rprop-delta-zero-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">rprop_delta_zero</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-rprop-delta-zero-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-rprop-delta-zero-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-rprop-delta-zero.php" class="function" rel="rdfs-seeAlso">fann_get_rprop_delta_zero()</a> - Returns the initial step-size</span></li>
    ...
    <li><span class="function"><a href="function.fann-get-rprop-delta-max.php" class="function" rel="rdfs-seeAlso">fann_get_rprop_delta_max()</a> - Returns the maximum step-size</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-rprop-delta-zero.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-rprop-delta-zero%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-rprop-delta-zero&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-rprop-delta-zero.php">＋<small>add a note</small></a></span>
