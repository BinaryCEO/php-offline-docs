...
<head>
  ...
  <title>PHP: streamWrapper::dir_readdir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.dir-readdir.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.dir-readdir.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.dir-readdir.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.dir-opendir.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.dir-rewinddir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.dir-readdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.dir-readdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.dir-readdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.dir-readdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.dir-readdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.dir-readdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.dir-readdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.dir-readdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.dir-readdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.dir-readdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.dir-readdir.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: streamWrapper::dir_readdir - Manual" />
<meta name="twitter:description" content="Read entry from directory handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::dir_readdir - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="streamwrapper.dir-rewinddir.php">
          streamWrapper::dir_rewinddir &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.dir-opendir.php">
          &laquo; streamWrapper::dir_opendir        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.dir-readdir.php' selected="selected">English</option>
            <option value='de/streamwrapper.dir-readdir.php'>German</option>
            <option value='es/streamwrapper.dir-readdir.php'>Spanish</option>
            <option value='fr/streamwrapper.dir-readdir.php'>French</option>
            <option value='it/streamwrapper.dir-readdir.php'>Italian</option>
            <option value='ja/streamwrapper.dir-readdir.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.dir-readdir.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.dir-readdir.php'>Russian</option>
            <option value='tr/streamwrapper.dir-readdir.php'>Turkish</option>
            <option value='uk/streamwrapper.dir-readdir.php'>Ukrainian</option>
            <option value='zh/streamwrapper.dir-readdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.dir-readdir" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-streamwrapper.dir-readdir-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>streamWrapper::dir_readdir</strong></span>(): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>

  <p class="para rdfs-comment">
   This method is called in response to <span class="function"><a href="function.readdir.php" class="function">readdir()</a></span>.
  </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-streamwrapper.dir-readdir-returnvalues">
  ...
  <p class="para">
   Should return <span class="type"><a href="language.types.string.php" class="type string">string</a></span> representing the next filename, or
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there is no next file.
  </p>
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    Returning <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span> or <span class="type"><a href="language.types.singleton.php" class="type false">false</a></span> will have the same
    effect of signaling there is no next file. However, returning
    <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span> is discouraged and <span class="type"><a href="language.types.singleton.php" class="type false">false</a></span> should be
    used to signal this condition instead.
   </p>
  </div>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    A non-boolean return value will be casted to <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
   </p>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.readdir.php" class="function" rel="rdfs-seeAlso">readdir()</a> - Read entry from directory handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/dir-readdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.dir-readdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.dir-readdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.dir-readdir.php">＋<small>add a note</small></a></span>
