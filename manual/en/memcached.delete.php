...
<head>
  ...
  <title>PHP: Memcached::delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.delete.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.delete.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.delete.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.decrementbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.deletebykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.delete.php" hreflang="zh">
...
<meta name="Description" content="Delete an item" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::delete - Manual" />
<meta name="twitter:description" content="Delete an item" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::delete - Manual" />
<meta itemprop="description" content="Delete an item" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an item" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.deletebykey.php">
          Memcached::deleteByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.decrementbykey.php">
          &laquo; Memcached::decrementByKey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.delete.php' selected="selected">English</option>
            <option value='de/memcached.delete.php'>German</option>
            <option value='es/memcached.delete.php'>Spanish</option>
            <option value='fr/memcached.delete.php'>French</option>
            <option value='it/memcached.delete.php'>Italian</option>
            <option value='ja/memcached.delete.php'>Japanese</option>
            <option value='pt_BR/memcached.delete.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.delete.php'>Russian</option>
            <option value='tr/memcached.delete.php'>Turkish</option>
            <option value='uk/memcached.delete.php'>Ukrainian</option>
            <option value='zh/memcached.delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.delete" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-memcached.delete-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::delete</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$time</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Delete the <code class="parameter">key</code> from the server.
  </p>
 </div>
   ...
   <dl>
     ...
     <dd>
      ...
      <blockquote class="note"><p><strong class="note">Note</strong>: <span class="simpara">
       ...
       supported. Passing a non-zero <code class="parameter">time</code> will cause
       the deletion to fail. <span class="methodname"><a href="memcached.getresultcode.php" class="methodname">Memcached::getResultCode()</a></span>
       will return <strong><code>MEMCACHED_INVALID_ARGUMENTS</code></strong>.
      </span></p></blockquote>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$m </span><span style="color: #007700">= new </span><span style="color: #0000BB">Memcached</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addServer</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #0000BB">11211</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$m</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">delete</span><span style="color: #007700">(</span><span style="color: #DD0000">'key1'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.delete-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.deletebykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::deleteByKey()</a> - Delete an item from a specific server</span></li>
    <li><span class="methodname"><a href="memcached.deletemulti.php" class="methodname" rel="rdfs-seeAlso">Memcached::deleteMulti()</a> - Delete multiple items</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.delete.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115712">  <div class="votes">
    <div id="Vu115712">
    <a href="/manual/vote-note.php?id=115712&amp;page=memcached.delete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115712">
    <a href="/manual/vote-note.php?id=115712&amp;page=memcached.delete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115712" title="90% like this...">
    17
    </div>
  </div>
  <a href="#115712" class="name">
  <strong class="user"><em>Pramod Patil</em></strong></a><a class="genanchor" href="#115712"> &para;</a><div class="date" title="2014-09-12 07:09"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115712">
<div class="phpcode"><code><span class="html">--For PECL memcached 2.10--<br />delete used with second argument 'time' returns false and set the error code and message for invalid arguments unless used without Memcached::OPT_BINARY_PROTOCOL.<br /><br />getResultCode() and getResultMessage() returns  38 and INVALID ARGUMENTS respectively.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.delete.php">＋<small>add a note</small></a></div>
