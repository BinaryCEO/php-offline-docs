...
<head>
  ...
  <title>PHP: fann_get_cascade_activation_functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions.php">
 <link rel="shorturl" href="https://www.php.net/fann-get-cascade-activation-functions">
 <link rel="alternate" href="https://www.php.net/fann-get-cascade-activation-functions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-bit-fail-limit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions-count.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-get-cascade-activation-functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-get-cascade-activation-functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-get-cascade-activation-functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-get-cascade-activation-functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-get-cascade-activation-functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-get-cascade-activation-functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-get-cascade-activation-functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-get-cascade-activation-functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-get-cascade-activation-functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-get-cascade-activation-functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-get-cascade-activation-functions.php" hreflang="zh">
...
<meta name="Description" content="Returns the cascade activation functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_get_cascade_activation_functions - Manual" />
<meta name="twitter:description" content="Returns the cascade activation functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_get_cascade_activation_functions - Manual" />
<meta itemprop="description" content="Returns the cascade activation functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the cascade activation functions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-get-cascade-activation-functions-count.php">
          fann_get_cascade_activation_functions_count &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-bit-fail-limit.php">
          &laquo; fann_get_bit_fail_limit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-get-cascade-activation-functions.php' selected="selected">English</option>
            <option value='de/function.fann-get-cascade-activation-functions.php'>German</option>
            <option value='es/function.fann-get-cascade-activation-functions.php'>Spanish</option>
            <option value='fr/function.fann-get-cascade-activation-functions.php'>French</option>
            <option value='it/function.fann-get-cascade-activation-functions.php'>Italian</option>
            <option value='ja/function.fann-get-cascade-activation-functions.php'>Japanese</option>
            <option value='pt_BR/function.fann-get-cascade-activation-functions.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-get-cascade-activation-functions.php'>Russian</option>
            <option value='tr/function.fann-get-cascade-activation-functions.php'>Turkish</option>
            <option value='uk/function.fann-get-cascade-activation-functions.php'>Ukrainian</option>
            <option value='zh/function.fann-get-cascade-activation-functions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-get-cascade-activation-functions" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_get_cascade_activation_functions</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_get_cascade_activation_functions</span> &mdash; <span class="dc-title">Returns the cascade activation functions</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-get-cascade-activation-functions-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_get_cascade_activation_functions</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   The cascade activation functions array is an array of the different activation functions used by the candidates
  </p>
  <p class="para">
   See <span class="function"><a href="function.fann-get-cascade-num-candidates.php" class="function">fann_get_cascade_num_candidates()</a></span> for a description of which candidate neurons will be generated by this array.
  </p>
  <p class="para">
   The default activation functions are <strong><code><a href="fann.constants.php#constant.fann-sigmoid">FANN_SIGMOID</a></code></strong>, <strong><code><a href="fann.constants.php#constant.fann-sigmoid-symmetric">FANN_SIGMOID_SYMMETRIC</a></code></strong>,
   <strong><code><a href="fann.constants.php#constant.fann-gaussian">FANN_GAUSSIAN</a></code></strong>, <strong><code><a href="fann.constants.php#constant.fann-gaussian-symmetric">FANN_GAUSSIAN_SYMMETRIC</a></code></strong>, <strong><code><a href="fann.constants.php#constant.fann-elliot">FANN_ELLIOT</a></code></strong>,
   <strong><code><a href="fann.constants.php#constant.fann-elliot-symmetric">FANN_ELLIOT_SYMMETRIC</a></code></strong>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-get-cascade-activation-functions-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-get-cascade-activation-functions-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The cascade activation functions, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-get-cascade-activation-functions-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-cascade-activation-functions.php" class="function" rel="rdfs-seeAlso">fann_set_cascade_activation_functions()</a> - Sets the array of cascade candidate activation functions</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-get-cascade-activation-functions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-get-cascade-activation-functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-get-cascade-activation-functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-get-cascade-activation-functions.php">＋<small>add a note</small></a></span>
