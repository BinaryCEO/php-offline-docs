...
<head>
  ...
  <title>PHP: cubrid_ping - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-ping.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-ping">
 <link rel="alternate" href="https://www.php.net/cubrid-ping" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/cubridmysql.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-num-fields.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-ping.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-ping.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-ping.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-ping.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-ping.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-ping.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-ping.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-ping.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-ping.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-ping.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-ping.php" hreflang="zh">
...
<meta name="Description" content="Ping a server connection or reconnect if there is no connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_ping - Manual" />
<meta name="twitter:description" content="Ping a server connection or reconnect if there is no connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_ping - Manual" />
<meta itemprop="description" content="Ping a server connection or reconnect if there is no connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Ping a server connection or reconnect if there is no connection" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.cubrid-query.php">
          cubrid_query &raquo;
              ...
              <div class="prev">
        <a href="function.cubrid-num-fields.php">
          &laquo; cubrid_num_fields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-ping.php' selected="selected">English</option>
            <option value='de/function.cubrid-ping.php'>German</option>
            <option value='es/function.cubrid-ping.php'>Spanish</option>
            <option value='fr/function.cubrid-ping.php'>French</option>
            <option value='it/function.cubrid-ping.php'>Italian</option>
            <option value='ja/function.cubrid-ping.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-ping.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-ping.php'>Russian</option>
            <option value='tr/function.cubrid-ping.php'>Turkish</option>
            <option value='uk/function.cubrid-ping.php'>Ukrainian</option>
            <option value='zh/function.cubrid-ping.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-ping" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.cubrid-ping-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_ping</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-ping-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the connection to the server CUBRID server is working, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />set_time_limit</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">'demodb'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Assuming this query will take a long time */<br /></span><span style="color: #0000BB">$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"select * from athlete"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$sql</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">'Query #1 failed, exiting.'</span><span style="color: #007700">;<br />    exit;<br />}<br /><br /></span><span style="color: #FF8000">/* Make sure the connection is still alive, if not, try to reconnect */<br /></span><span style="color: #007700">if (!</span><span style="color: #0000BB">cubrid_ping</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">)) {<br />    echo </span><span style="color: #DD0000">'Lost connection, exiting after query #1'</span><span style="color: #007700">;<br />    exit;<br />}<br /></span><span style="color: #0000BB">cubrid_free_result</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* So the connection is still alive, let's run another query */<br /></span><span style="color: #0000BB">$sql2 </span><span style="color: #007700">= </span><span style="color: #DD0000">"select * from code"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$result2 </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$sql2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/cubridmysql/cubrid-ping.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-ping%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-ping&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-ping.php">＋<small>add a note</small></a></span>
