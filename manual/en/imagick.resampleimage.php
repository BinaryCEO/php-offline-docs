...
<head>
  ...
  <title>PHP: Imagick::resampleImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.resampleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.resampleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.resampleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.render.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.resetimagepage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.resampleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.resampleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.resampleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.resampleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.resampleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.resampleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.resampleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.resampleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.resampleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.resampleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.resampleimage.php" hreflang="zh">
...
<meta name="Description" content="Resample image to desired resolution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::resampleImage - Manual" />
<meta name="twitter:description" content="Resample image to desired resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::resampleImage - Manual" />
<meta itemprop="description" content="Resample image to desired resolution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resample image to desired resolution" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.resetimagepage.php">
          Imagick::resetImagePage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.render.php">
          &laquo; Imagick::render        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.resampleimage.php' selected="selected">English</option>
            <option value='de/imagick.resampleimage.php'>German</option>
            <option value='es/imagick.resampleimage.php'>Spanish</option>
            <option value='fr/imagick.resampleimage.php'>French</option>
            <option value='it/imagick.resampleimage.php'>Italian</option>
            <option value='ja/imagick.resampleimage.php'>Japanese</option>
            <option value='pt_BR/imagick.resampleimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.resampleimage.php'>Russian</option>
            <option value='tr/imagick.resampleimage.php'>Turkish</option>
            <option value='uk/imagick.resampleimage.php'>Ukrainian</option>
            <option value='zh/imagick.resampleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.resampleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::resampleImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::resampleImage</span> &mdash; <span class="dc-title">Resample image to desired resolution</span></p>
  ...
  <p class="para">
    <div class="example" id="example-3078">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/resampleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.resampleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.resampleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.resampleimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118403">  <div class="votes">
    <div id="Vu118403">
    <a href="/manual/vote-note.php?id=118403&amp;page=imagick.resampleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118403">
    <a href="/manual/vote-note.php?id=118403&amp;page=imagick.resampleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118403" title="100% like this...">
    2
    </div>
  </div>
  <a href="#118403" class="name">
  <strong class="user"><em>simon</em></strong></a><a class="genanchor" href="#118403"> &para;</a><div class="date" title="2015-12-01 12:13"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118403">
<div class="phpcode"><code><span class="html">Please not that I had extremely high CPU usage using this function on Ubuntu linux 15.10. Switching to the resizeImage function fixed the problem.</span></code></div>
  </div>
 </div>
  <div class="note" id="113734">  <div class="votes">
    <div id="Vu113734">
    <a href="/manual/vote-note.php?id=113734&amp;page=imagick.resampleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113734">
    <a href="/manual/vote-note.php?id=113734&amp;page=imagick.resampleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113734" title="100% like this...">
    1
    </div>
  </div>
  <a href="#113734" class="name">
  <strong class="user"><em>bleighty at dvidshub dot net</em></strong></a><a class="genanchor" href="#113734"> &para;</a><div class="date" title="2013-11-22 02:53"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113734">
<div class="phpcode"><code><span class="html">Please note that blur of 1 should not affect the image if I'm understanding correctly from this page:<br /><a href="http://www.php.net/manual/en/imagick.resizeimage.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.resizeimage.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="106739">  <div class="votes">
    <div id="Vu106739">
    <a href="/manual/vote-note.php?id=106739&amp;page=imagick.resampleimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106739">
    <a href="/manual/vote-note.php?id=106739&amp;page=imagick.resampleimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106739" title="16% like this...">
    -4
    </div>
  </div>
  <a href="#106739" class="name">
  <strong class="user"><em>anagai at yahoo dot com</em></strong></a><a class="genanchor" href="#106739"> &para;</a><div class="date" title="2011-12-02 12:14"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106739">
<div class="phpcode"><code><span class="html">Lets say you want to reduce the resolution of uploaded images for the web.
<br />
<br />The following will load a image at whatever resolution and resample it down to 72 dpi and save as a different file.
<br />
<br />The dpi for setImageResolution() and resampleImage() should be whatever dpi your resampling too.
<br />
<br /><span class="default">&lt;?php
<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'image.jpg'</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageResolution</span><span class="keyword">(</span><span class="default">72</span><span class="keyword">,</span><span class="default">72</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">resampleImage</span><span class="keyword">(</span><span class="default">72</span><span class="keyword">,</span><span class="default">72</span><span class="keyword">,</span><span class="default">imagick</span><span class="keyword">::</span><span class="default">FILTER_UNDEFINED</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'image72.jpg'</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.resampleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.resampleimage.php">＋<small>add a note</small></a></div>
