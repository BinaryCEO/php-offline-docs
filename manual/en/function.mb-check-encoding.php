...
<head>
  ...
  <title>PHP: mb_check_encoding - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-check-encoding.php">
 <link rel="shorturl" href="https://www.php.net/mb-check-encoding">
 <link rel="alternate" href="https://www.php.net/mb-check-encoding" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-chr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-check-encoding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-check-encoding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-check-encoding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-check-encoding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-check-encoding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-check-encoding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-check-encoding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-check-encoding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-check-encoding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-check-encoding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-check-encoding.php" hreflang="zh">
...
<meta name="Description" content="Check if strings are valid for the specified encoding" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_check_encoding - Manual" />
<meta name="twitter:description" content="Check if strings are valid for the specified encoding" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_check_encoding - Manual" />
<meta itemprop="description" content="Check if strings are valid for the specified encoding" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if strings are valid for the specified encoding" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-chr.php">
          mb_chr &raquo;
              ...
              <div class="prev">
        <a href="ref.mbstring.php">
          &laquo; Multibyte String Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-check-encoding.php' selected="selected">English</option>
            <option value='de/function.mb-check-encoding.php'>German</option>
            <option value='es/function.mb-check-encoding.php'>Spanish</option>
            <option value='fr/function.mb-check-encoding.php'>French</option>
            <option value='it/function.mb-check-encoding.php'>Italian</option>
            <option value='ja/function.mb-check-encoding.php'>Japanese</option>
            <option value='pt_BR/function.mb-check-encoding.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-check-encoding.php'>Russian</option>
            <option value='tr/function.mb-check-encoding.php'>Turkish</option>
            <option value='uk/function.mb-check-encoding.php'>Ukrainian</option>
            <option value='zh/function.mb-check-encoding.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-check-encoding" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_check_encoding</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.4.3, PHP 5 &gt;= 5.1.3, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_check_encoding</span> &mdash; <span class="dc-title">Check if strings are valid for the specified encoding</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-check-encoding-description">
  ...
  <p class="para rdfs-comment">
   ...
   If <code class="parameter">value</code> is of type <span class="type"><a href="language.types.array.php" class="type array">array</a></span>, all keys and values are
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-check-encoding-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
        The byte stream or <span class="type"><a href="language.types.array.php" class="type array">array</a></span> to check. If it is omitted, this function checks
        all the input from the beginning of the request.
      </p>

      <div class="warning"><strong class="warning">Warning</strong>
        <p class="para">
          As of PHP 8.1.0, omitting this parameter or passing <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> is deprecated.
        </p>
      </div>
     </dd>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.1.0</td>
      <td>
       Calling this function with <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> as <code class="parameter">value</code> or without argument is deprecated.
      </td>
     </tr>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">value</code> and <code class="parameter">encoding</code> are nullable now.
      </td>
     </tr>
     ...
     <tr>
      <td>7.2.0</td>
      <td>
       This function now also accepts an <span class="type"><a href="language.types.array.php" class="type array">array</a></span> as <code class="parameter">value</code>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-check-encoding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-check-encoding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-check-encoding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-check-encoding.php">＋<small>add a note</small></a></span>
