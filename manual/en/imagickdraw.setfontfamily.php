...
<head>
  ...
  <title>PHP: ImagickDraw::setFontFamily - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setfontfamily.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setfontfamily.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontfamily.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setfont.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfontsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setfontfamily.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setfontfamily.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setfontfamily.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setfontfamily.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setfontfamily.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setfontfamily.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setfontfamily.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setfontfamily.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setfontfamily.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setfontfamily.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setfontfamily.php" hreflang="zh">
...
<meta name="Description" content="Sets the font family to use when annotating with text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setFontFamily - Manual" />
<meta name="twitter:description" content="Sets the font family to use when annotating with text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setFontFamily - Manual" />
<meta itemprop="description" content="Sets the font family to use when annotating with text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the font family to use when annotating with text" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfontsize.php">
          ImagickDraw::setFontSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setfont.php">
          &laquo; ImagickDraw::setFont        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setfontfamily.php' selected="selected">English</option>
            <option value='de/imagickdraw.setfontfamily.php'>German</option>
            <option value='es/imagickdraw.setfontfamily.php'>Spanish</option>
            <option value='fr/imagickdraw.setfontfamily.php'>French</option>
            <option value='it/imagickdraw.setfontfamily.php'>Italian</option>
            <option value='ja/imagickdraw.setfontfamily.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setfontfamily.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setfontfamily.php'>Russian</option>
            <option value='tr/imagickdraw.setfontfamily.php'>Turkish</option>
            <option value='uk/imagickdraw.setfontfamily.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setfontfamily.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setfontfamily" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setFontFamily</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setFontFamily</span> &mdash; <span class="dc-title">Sets the font family to use when annotating with text</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setfontfamily-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setFontFamily</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$font_family</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setfontfamily-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">font_family</code></dt>
     <dd>
      <p class="para">
       the font family
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setfontfamily-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3175">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setfontfamily.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setfontfamily%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setfontfamily&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setfontfamily.php">＋<small>add a note</small></a></span>
