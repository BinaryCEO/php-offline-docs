...
<head>
  ...
  <title>PHP: ps_findfont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-findfont.php">
 <link rel="shorturl" href="https://www.php.net/ps-findfont">
 <link rel="alternate" href="https://www.php.net/ps-findfont" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-fill-stroke.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-get-buffer.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-findfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-findfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-findfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-findfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-findfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-findfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-findfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-findfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-findfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-findfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-findfont.php" hreflang="zh">
...
<meta name="Description" content="Loads a font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_findfont - Manual" />
<meta name="twitter:description" content="Loads a font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_findfont - Manual" />
<meta itemprop="description" content="Loads a font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Loads a font" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-get-buffer.php">
          ps_get_buffer &raquo;
              ...
              <div class="prev">
        <a href="function.ps-fill-stroke.php">
          &laquo; ps_fill_stroke        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-findfont.php' selected="selected">English</option>
            <option value='de/function.ps-findfont.php'>German</option>
            <option value='es/function.ps-findfont.php'>Spanish</option>
            <option value='fr/function.ps-findfont.php'>French</option>
            <option value='it/function.ps-findfont.php'>Italian</option>
            <option value='ja/function.ps-findfont.php'>Japanese</option>
            <option value='pt_BR/function.ps-findfont.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-findfont.php'>Russian</option>
            <option value='tr/function.ps-findfont.php'>Turkish</option>
            <option value='uk/function.ps-findfont.php'>Ukrainian</option>
            <option value='zh/function.ps-findfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-findfont" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-setfont.php" class="function" rel="rdfs-seeAlso">ps_setfont()</a> - Sets font to use for following output</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-findfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-findfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-findfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-findfont.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="80689">  <div class="votes">
    <div id="Vu80689">
    <a href="/manual/vote-note.php?id=80689&amp;page=function.ps-findfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80689">
    <a href="/manual/vote-note.php?id=80689&amp;page=function.ps-findfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80689" title="66% like this...">
    1
    </div>
  </div>
  <a href="#80689" class="name">
  <strong class="user"><em>yarych at bigmir dot net</em></strong></a><a class="genanchor" href="#80689"> &para;</a><div class="date" title="2008-01-29 03:40"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80689">
<div class="phpcode"><code><span class="html">I've found out that pslib is searching for fonts in its data dir (/usr/share/pslib). There is no way to change the search path now.</span></code></div>
  </div>
 </div>
  <div class="note" id="82044">  <div class="votes">
    <div id="Vu82044">
    <a href="/manual/vote-note.php?id=82044&amp;page=function.ps-findfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82044">
    <a href="/manual/vote-note.php?id=82044&amp;page=function.ps-findfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82044" title="60% like this...">
    1
    </div>
  </div>
  <a href="#82044" class="name">
  <strong class="user"><em>yarych at bigmir dot net</em></strong></a><a class="genanchor" href="#82044"> &para;</a><div class="date" title="2008-03-25 12:39"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82044">
<div class="phpcode"><code><span class="html">Ok, now I found the way to set the path I need for fonts - before calling ps_findfont() make a call like this:<br /><span class="default">&lt;?php ps_set_parameter</span><span class="keyword">(</span><span class="default">$psdoc</span><span class="keyword">, </span><span class="string">'SearchPath'</span><span class="keyword">, </span><span class="default">$fonts_dir</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />It works for pslib 0.4.1 version. (Looks like it didn't work in some earlier versions.)</span></code></div>
  </div>
 </div>
  <div class="note" id="55093">  <div class="votes">
    <div id="Vu55093">
    <a href="/manual/vote-note.php?id=55093&amp;page=function.ps-findfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55093">
    <a href="/manual/vote-note.php?id=55093&amp;page=function.ps-findfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55093" title="60% like this...">
    1
    </div>
  </div>
  <a href="#55093" class="name">
  <strong class="user"><em>zeldorblat at gmail dot com</em></strong></a><a class="genanchor" href="#55093"> &para;</a><div class="date" title="2005-07-25 07:47"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55093">
<div class="phpcode"><code><span class="html">I found that my Postscript files were taking an incredibly long time to generate and the file sizes were abnormally large.  The problem was that, everytime I chose to set a font I would call ps_findfont() followed by ps_setfont().<br /><br />It seems that every time ps_findfont() is called, the font gets embedded in the file.  To prevent this, I keep an array of fonts I've already loaded, keyed by the font name.  When I go to set the font, I first check this array to see if I've already loaded the font, and, if so, return the resource handle from that array.  Otherwise, I call ps_findfont() and store the handle in the array.<br /><br />Note that, if your call to ps_findfont() occurs while inside a page, the font will not be available on other pages.  To get around this I just clear out the array at the end of each page.<br /><br />My PS file went from 10 M to 75 K, and the time to create the file went from around 15 seconds to less than 1 second.</span></code></div>
  </div>
 </div>
  <div class="note" id="64388">  <div class="votes">
    <div id="Vu64388">
    <a href="/manual/vote-note.php?id=64388&amp;page=function.ps-findfont&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd64388">
    <a href="/manual/vote-note.php?id=64388&amp;page=function.ps-findfont&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V64388" title="50% like this...">
    0
    </div>
  </div>
  <a href="#64388" class="name">
  <strong class="user"><em>pepe at dexef dot hu</em></strong></a><a class="genanchor" href="#64388"> &para;</a><div class="date" title="2006-04-13 03:19"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom64388">
<div class="phpcode"><code><span class="html">I found out that you must copy the &lt;fontname&gt;.afm files next to your php because it's searched there in default.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ps-findfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-findfont.php">＋<small>add a note</small></a></div>
