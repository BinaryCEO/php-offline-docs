...
<head>
  ...
  <title>PHP: stats_stat_innerproduct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-stat-innerproduct.php">
 <link rel="shorturl" href="https://www.php.net/stats-stat-innerproduct">
 <link rel="alternate" href="https://www.php.net/stats-stat-innerproduct" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-stat-independent-t.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-stat-paired-t.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-stat-innerproduct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-stat-innerproduct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-stat-innerproduct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-stat-innerproduct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-stat-innerproduct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-stat-innerproduct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-stat-innerproduct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-stat-innerproduct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-stat-innerproduct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-stat-innerproduct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-stat-innerproduct.php" hreflang="zh">
...
<meta name="Description" content="Returns the inner product of two vectors" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_stat_innerproduct - Manual" />
<meta name="twitter:description" content="Returns the inner product of two vectors" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_stat_innerproduct - Manual" />
<meta itemprop="description" content="Returns the inner product of two vectors" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the inner product of two vectors" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-stat-paired-t.php">
          stats_stat_paired_t &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-stat-independent-t.php">
          &laquo; stats_stat_independent_t        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-stat-innerproduct.php' selected="selected">English</option>
            <option value='de/function.stats-stat-innerproduct.php'>German</option>
            <option value='es/function.stats-stat-innerproduct.php'>Spanish</option>
            <option value='fr/function.stats-stat-innerproduct.php'>French</option>
            <option value='it/function.stats-stat-innerproduct.php'>Italian</option>
            <option value='ja/function.stats-stat-innerproduct.php'>Japanese</option>
            <option value='pt_BR/function.stats-stat-innerproduct.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-stat-innerproduct.php'>Russian</option>
            <option value='tr/function.stats-stat-innerproduct.php'>Turkish</option>
            <option value='uk/function.stats-stat-innerproduct.php'>Ukrainian</option>
            <option value='zh/function.stats-stat-innerproduct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-stat-innerproduct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_stat_innerproduct</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_stat_innerproduct</span> &mdash; <span class="dc-title">Returns the inner product of two vectors</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-stat-innerproduct-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_stat_innerproduct</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$arr1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$arr2</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   Returns the inner product of <code class="parameter">arr1</code> and <code class="parameter">arr2</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-stat-innerproduct-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-stat-innerproduct-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-stat-innerproduct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-stat-innerproduct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-stat-innerproduct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-stat-innerproduct.php">＋<small>add a note</small></a></span>
