...
<head>
  ...
  <title>PHP: ImagickDraw::affine - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.affine.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.affine.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.affine.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.annotation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.affine.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.affine.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.affine.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.affine.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.affine.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.affine.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.affine.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.affine.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.affine.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.affine.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.affine.php" hreflang="zh">
...
<meta name="Description" content="Adjusts the current affine transformation matrix" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::affine - Manual" />
<meta name="twitter:description" content="Adjusts the current affine transformation matrix" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::affine - Manual" />
<meta itemprop="description" content="Adjusts the current affine transformation matrix" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adjusts the current affine transformation matrix" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.annotation.php">
          ImagickDraw::annotation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.imagickdraw.php">
          &laquo; ImagickDraw        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.affine.php' selected="selected">English</option>
            <option value='de/imagickdraw.affine.php'>German</option>
            <option value='es/imagickdraw.affine.php'>Spanish</option>
            <option value='fr/imagickdraw.affine.php'>French</option>
            <option value='it/imagickdraw.affine.php'>Italian</option>
            <option value='ja/imagickdraw.affine.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.affine.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.affine.php'>Russian</option>
            <option value='tr/imagickdraw.affine.php'>Turkish</option>
            <option value='uk/imagickdraw.affine.php'>Ukrainian</option>
            <option value='zh/imagickdraw.affine.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.affine" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::affine</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::affine</span> &mdash; <span class="dc-title">Adjusts the current affine transformation matrix</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.affine-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::affine</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$affine</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.affine-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.affine-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.affine-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3145">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::affine()</strong></span> example</strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">affine</span><span style="color: #007700">(</span><span style="color: #0000BB">$strokeColor</span><span style="color: #007700">, </span><span style="color: #0000BB">$fillColor</span><span style="color: #007700">, </span><span style="color: #0000BB">$backgroundColor</span><span style="color: #007700">) {<br /><br />    </span><span style="color: #0000BB">$draw </span><span style="color: #007700">= new </span><span style="color: #0000BB">\ImagickDraw</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeWidth</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeOpacity</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeColor</span><span style="color: #007700">(</span><span style="color: #0000BB">$strokeColor</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFillColor</span><span style="color: #007700">(</span><span style="color: #0000BB">$fillColor</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setStrokeWidth</span><span style="color: #007700">(</span><span style="color: #0000BB">2</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$PI </span><span style="color: #007700">= </span><span style="color: #0000BB">3.141592653589794</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$angle </span><span style="color: #007700">= </span><span style="color: #0000BB">60 </span><span style="color: #007700">* </span><span style="color: #0000BB">$PI </span><span style="color: #007700">/ </span><span style="color: #0000BB">360</span><span style="color: #007700">;<br /><br />    </span><span style="color: #FF8000">//Scale the drawing co-ordinates.<br />    </span><span style="color: #0000BB">$affineScale </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"sx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1.75</span><span style="color: #007700">, </span><span style="color: #DD0000">"sy" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1.75</span><span style="color: #007700">, </span><span style="color: #DD0000">"rx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ry" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"tx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ty" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Shear the drawing co-ordinates.<br />    </span><span style="color: #0000BB">$affineShear </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"sx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"sy" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"rx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">sin</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"ry" </span><span style="color: #007700">=&gt; -</span><span style="color: #0000BB">sin</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"tx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ty" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Rotate the drawing co-ordinates. The shear affine matrix<br />    //produces incorrectly scaled drawings.<br />    </span><span style="color: #0000BB">$affineRotate </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"sx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">cos</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"sy" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">cos</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"rx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">sin</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"ry" </span><span style="color: #007700">=&gt; -</span><span style="color: #0000BB">sin</span><span style="color: #007700">(</span><span style="color: #0000BB">$angle</span><span style="color: #007700">), </span><span style="color: #DD0000">"tx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ty" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">,);<br /><br />    </span><span style="color: #FF8000">//Translate (offset) the drawing<br />    </span><span style="color: #0000BB">$affineTranslate </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"sx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"sy" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"rx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ry" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"tx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">30</span><span style="color: #007700">, </span><span style="color: #DD0000">"ty" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">30</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//The identiy affine matrix<br />    </span><span style="color: #0000BB">$affineIdentity </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"sx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"sy" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"rx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ry" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"tx" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ty" </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">0</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$examples </span><span style="color: #007700">= [</span><span style="color: #0000BB">$affineScale</span><span style="color: #007700">, </span><span style="color: #0000BB">$affineShear</span><span style="color: #007700">, </span><span style="color: #0000BB">$affineRotate</span><span style="color: #007700">, </span><span style="color: #0000BB">$affineTranslate</span><span style="color: #007700">, </span><span style="color: #0000BB">$affineIdentity</span><span style="color: #007700">,];<br /><br />    </span><span style="color: #0000BB">$count </span><span style="color: #007700">= </span><span style="color: #0000BB">0</span><span style="color: #007700">;<br /><br />    foreach (</span><span style="color: #0000BB">$examples </span><span style="color: #007700">as </span><span style="color: #0000BB">$example</span><span style="color: #007700">) {<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">translate</span><span style="color: #007700">((</span><span style="color: #0000BB">$count </span><span style="color: #007700">% </span><span style="color: #0000BB">2</span><span style="color: #007700">) * </span><span style="color: #0000BB">250</span><span style="color: #007700">, </span><span style="color: #0000BB">intval</span><span style="color: #007700">(</span><span style="color: #0000BB">$count </span><span style="color: #007700">/ </span><span style="color: #0000BB">2</span><span style="color: #007700">) * </span><span style="color: #0000BB">250</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">translate</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">affine</span><span style="color: #007700">(</span><span style="color: #0000BB">$example</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">rectangle</span><span style="color: #007700">(-</span><span style="color: #0000BB">50</span><span style="color: #007700">, -</span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$draw</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">pop</span><span style="color: #007700">();<br />        </span><span style="color: #0000BB">$count</span><span style="color: #007700">++;<br />    }<br /><br />    </span><span style="color: #FF8000">//Create an image object which the draw commands can be rendered into<br />    </span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">500</span><span style="color: #007700">, </span><span style="color: #0000BB">750</span><span style="color: #007700">, </span><span style="color: #0000BB">$backgroundColor</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Render the draw commands in the ImagickDraw object <br />    //into the image.<br />    </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">drawImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$draw</span><span style="color: #007700">);<br /><br />    </span><span style="color: #FF8000">//Send the image to the browser<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/affine.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.affine%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.affine&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.affine.php">＋<small>add a note</small></a></span>
