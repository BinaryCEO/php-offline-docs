...
<head>
  ...
  <title>PHP: sodium_crypto_secretbox_open - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox-open.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-secretbox-open">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-secretbox-open" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox-open.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-secretbox-open.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-secretbox-open.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-secretbox-open.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-secretbox-open.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-secretbox-open.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-secretbox-open.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-secretbox-open.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-secretbox-open.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-secretbox-open.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-secretbox-open.php" hreflang="zh">
...
<meta name="Description" content="Authenticated shared-key decryption" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_secretbox_open - Manual" />
<meta name="twitter:description" content="Authenticated shared-key decryption" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_secretbox_open - Manual" />
<meta itemprop="description" content="Authenticated shared-key decryption" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Authenticated shared-key decryption" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php">
          sodium_crypto_secretstream_xchacha20poly1305_init_pull &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-secretbox-keygen.php">
          &laquo; sodium_crypto_secretbox_keygen        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-secretbox-open.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-secretbox-open.php'>German</option>
            <option value='es/function.sodium-crypto-secretbox-open.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-secretbox-open.php'>French</option>
            <option value='it/function.sodium-crypto-secretbox-open.php'>Italian</option>
            <option value='ja/function.sodium-crypto-secretbox-open.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-secretbox-open.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-secretbox-open.php'>Russian</option>
            <option value='tr/function.sodium-crypto-secretbox-open.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-secretbox-open.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-secretbox-open.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-secretbox-open" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.random-bytes.php" class="function" rel="rdfs-seeAlso">random_bytes()</a> - Get cryptographically secure random bytes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-secretbox-open.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-secretbox-open%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-secretbox-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-secretbox-open.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123480">  <div class="votes">
    <div id="Vu123480">
    <a href="/manual/vote-note.php?id=123480&amp;page=function.sodium-crypto-secretbox-open&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123480">
    <a href="/manual/vote-note.php?id=123480&amp;page=function.sodium-crypto-secretbox-open&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123480" title="63% like this...">
    3
    </div>
  </div>
  <a href="#123480" class="name">
  <strong class="user"><em>khalyomede at gmail dot com</em></strong></a><a class="genanchor" href="#123480"> &para;</a><div class="date" title="2018-12-31 11:26"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123480">
<div class="phpcode"><code><span class="html">This method will return a string, or false if the data failed to be decrypted.<br /><br />$key = 'secret';<br />$data = 'binarydata';<br />$nonce = random_bytes(SODIUM_CRYPT_SECRETBOX_NONCEBYTES);<br /><br />$decrypted = sodium_crypto_secretbox_open($data, $nonce, $key);<br /><br />if ($decrypted === false) {<br />  throw new Exception('failed to decrypt data');<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-secretbox-open&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-secretbox-open.php">＋<small>add a note</small></a></div>
