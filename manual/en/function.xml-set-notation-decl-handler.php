...
<head>
  ...
  <title>PHP: xml_set_notation_decl_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.xml-set-notation-decl-handler.php">
 <link rel="shorturl" href="https://www.php.net/xml-set-notation-decl-handler">
 <link rel="alternate" href="https://www.php.net/xml-set-notation-decl-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.xml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.xml-set-external-entity-ref-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.xml-set-object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.xml-set-notation-decl-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.xml-set-notation-decl-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.xml-set-notation-decl-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.xml-set-notation-decl-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.xml-set-notation-decl-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.xml-set-notation-decl-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.xml-set-notation-decl-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.xml-set-notation-decl-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.xml-set-notation-decl-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.xml-set-notation-decl-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.xml-set-notation-decl-handler.php" hreflang="zh">
...
<meta name="Description" content="Set up notation declaration handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: xml_set_notation_decl_handler - Manual" />
<meta name="twitter:description" content="Set up notation declaration handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: xml_set_notation_decl_handler - Manual" />
<meta itemprop="description" content="Set up notation declaration handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set up notation declaration handler" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.xml-set-object.php">
          xml_set_object &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.xml-set-external-entity-ref-handler.php">
          &laquo; xml_set_external_entity_ref_handler        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.xml-set-notation-decl-handler.php' selected="selected">English</option>
            <option value='de/function.xml-set-notation-decl-handler.php'>German</option>
            <option value='es/function.xml-set-notation-decl-handler.php'>Spanish</option>
            <option value='fr/function.xml-set-notation-decl-handler.php'>French</option>
            <option value='it/function.xml-set-notation-decl-handler.php'>Italian</option>
            <option value='ja/function.xml-set-notation-decl-handler.php'>Japanese</option>
            <option value='pt_BR/function.xml-set-notation-decl-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.xml-set-notation-decl-handler.php'>Russian</option>
            <option value='tr/function.xml-set-notation-decl-handler.php'>Turkish</option>
            <option value='uk/function.xml-set-notation-decl-handler.php'>Ukrainian</option>
            <option value='zh/function.xml-set-notation-decl-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.xml-set-notation-decl-handler" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">xml_set_notation_decl_handler</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">xml_set_notation_decl_handler</span> &mdash; <span class="dc-title">Set up notation declaration handler</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.xml-set-notation-decl-handler-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>xml_set_notation_decl_handler</strong></span>(<span class="methodparam"><span class="type"><a href="class.xmlparser.php" class="type XMLParser">XMLParser</a></span> <code class="parameter">$parser</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span> <code class="parameter">$handler</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
<div class="annotation-interactive xmlcode"><pre class="xmlcode">&lt;!NOTATION &lt;parameter&gt;name&lt;/parameter&gt;
...
<div class="warning"><strong class="warning">Warning</strong>
 <p class="simpara">
  ...
  using a proper <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> for the method is recommended instead.
      ...
      <p class="para">
       ...
       <div class="methodsynopsis dc-description"><span class="methodname"><span class="replaceable">handler</span></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.xmlparser.php" class="type XMLParser">XMLParser</a></span> <code class="parameter">$parser</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$notation_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span> <code class="parameter">$base</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$system_id</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span> <code class="parameter">$public_id</code></span><br>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
   ...
   The XML parser calling the handler.
         ...
         <dd>
          <span class="simpara">
           ...
           (<code class="literal">system_id</code>) of the notation declaration.
          </span>
         </dd>
 ...
 <div class="refsect1 changelog" id="refsect1-function.xml-set-notation-decl-handler-changelog">
 ...
 <td>
  ...
  instance now; previously, a valid <code class="literal">xml</code> <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/xml/functions/xml-set-notation-decl-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.xml-set-notation-decl-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.xml-set-notation-decl-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.xml-set-notation-decl-handler.php">＋<small>add a note</small></a></span>
