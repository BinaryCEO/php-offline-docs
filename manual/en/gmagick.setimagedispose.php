...
<head>
  ...
  <title>PHP: Gmagick::setimagedispose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagedispose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagedispose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagedispose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagedepth.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagefilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagedispose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagedispose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagedispose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagedispose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagedispose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagedispose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagedispose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagedispose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagedispose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagedispose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagedispose.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagedispose - Manual" />
<meta name="twitter:description" content="Sets the image disposal method" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagedispose - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagefilename.php">
          Gmagick::setimagefilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagedepth.php">
          &laquo; Gmagick::setimagedepth        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagedispose.php' selected="selected">English</option>
            <option value='de/gmagick.setimagedispose.php'>German</option>
            <option value='es/gmagick.setimagedispose.php'>Spanish</option>
            <option value='fr/gmagick.setimagedispose.php'>French</option>
            <option value='it/gmagick.setimagedispose.php'>Italian</option>
            <option value='ja/gmagick.setimagedispose.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagedispose.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagedispose.php'>Russian</option>
            <option value='tr/gmagick.setimagedispose.php'>Turkish</option>
            <option value='uk/gmagick.setimagedispose.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagedispose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagedispose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagedispose</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagedispose</span> &mdash; <span class="dc-title">Sets the image disposal method</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagedispose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagedispose</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$disposeType</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagedispose-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">disposeType</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagedispose-returnvalues">
  ...
  <div class="refsect1 errors" id="refsect1-gmagick.setimagedispose-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagedispose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagedispose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagedispose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagedispose.php">＋<small>add a note</small></a></span>
