...
<head>
  ...
  <title>PHP: SolrQuery::setFacetOffset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetoffset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetoffset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetoffset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetoffset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetoffset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetoffset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetoffset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetoffset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetoffset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetoffset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetoffset.php" hreflang="zh">
...
<meta name="Description" content="Sets the offset into the list of constraints to allow for pagination" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetOffset - Manual" />
<meta name="twitter:description" content="Sets the offset into the list of constraints to allow for pagination" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetOffset - Manual" />
<meta itemprop="description" content="Sets the offset into the list of constraints to allow for pagination" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the offset into the list of constraints to allow for pagination" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setfacetprefix.php">
          SolrQuery::setFacetPrefix &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetmissing.php">
          &laquo; SolrQuery::setFacetMissing        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetoffset.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetoffset.php'>German</option>
            <option value='es/solrquery.setfacetoffset.php'>Spanish</option>
            <option value='fr/solrquery.setfacetoffset.php'>French</option>
            <option value='it/solrquery.setfacetoffset.php'>Italian</option>
            <option value='ja/solrquery.setfacetoffset.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetoffset.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetoffset.php'>Russian</option>
            <option value='tr/solrquery.setfacetoffset.php'>Turkish</option>
            <option value='uk/solrquery.setfacetoffset.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetoffset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetoffset" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetOffset</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetOffset</span> &mdash; <span class="dc-title">Sets the offset into the list of constraints to allow for pagination</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetoffset-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetOffset</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetoffset-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetoffset-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetoffset.php">＋<small>add a note</small></a></span>
