...
<head>
  ...
  <title>PHP: posix_getgid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getgid.php">
 <link rel="shorturl" href="https://www.php.net/posix-getgid">
 <link rel="alternate" href="https://www.php.net/posix-getgid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-geteuid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getgrgid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getgid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getgid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getgid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getgid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getgid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getgid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getgid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getgid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getgid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getgid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getgid.php" hreflang="zh">
...
<meta name="Description" content="Return the real group ID of the current process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getgid - Manual" />
<meta name="twitter:description" content="Return the real group ID of the current process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getgid - Manual" />
<meta itemprop="description" content="Return the real group ID of the current process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the real group ID of the current process" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.posix-getgrgid.php">
          posix_getgrgid &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.posix-geteuid.php">
          &laquo; posix_geteuid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getgid.php' selected="selected">English</option>
            <option value='de/function.posix-getgid.php'>German</option>
            <option value='es/function.posix-getgid.php'>Spanish</option>
            <option value='fr/function.posix-getgid.php'>French</option>
            <option value='it/function.posix-getgid.php'>Italian</option>
            <option value='ja/function.posix-getgid.php'>Japanese</option>
            <option value='pt_BR/function.posix-getgid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getgid.php'>Russian</option>
            <option value='tr/function.posix-getgid.php'>Turkish</option>
            <option value='uk/function.posix-getgid.php'>Ukrainian</option>
            <option value='zh/function.posix-getgid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getgid" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-getgid-examples">
  ...
  <p class="para">
   <div class="example" id="example-3578">
    <p><strong>Example #1 <span class="function"><strong>posix_getgid()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li>POSIX man page GETGID(2)</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getgid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getgid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getgid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="106152">  <div class="votes">
    <div id="Vu106152">
    <a href="/manual/vote-note.php?id=106152&amp;page=function.posix-getgid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106152">
    <a href="/manual/vote-note.php?id=106152&amp;page=function.posix-getgid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106152" title="55% like this...">
    2
    </div>
  </div>
  <a href="#106152" class="name">
  <strong class="user"><em>vector from ionisis.com</em></strong></a><a class="genanchor" href="#106152"> &para;</a><div class="date" title="2011-10-14 05:07"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106152">
<div class="phpcode"><code><span class="html">i came across this error:
<br />Call to undefined function posix_getuid()
<br />
<br />which was solved by these commands:
<br />yum -y install php-process
<br />service httpd restart</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.posix-getgid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getgid.php">＋<small>add a note</small></a></div>
