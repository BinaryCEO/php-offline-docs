...
<head>
  ...
  <title>PHP: SolrQuery::removeFilterQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removefilterquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removefilterquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefilterquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removefield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removehighlightfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefilterquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removefilterquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removefilterquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removefilterquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removefilterquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removefilterquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removefilterquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removefilterquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removefilterquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removefilterquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removefilterquery.php" hreflang="zh">
...
<meta name="Description" content="Removes a filter query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeFilterQuery - Manual" />
<meta name="twitter:description" content="Removes a filter query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeFilterQuery - Manual" />
<meta itemprop="description" content="Removes a filter query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes a filter query" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removehighlightfield.php">
          SolrQuery::removeHighlightField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removefield.php">
          &laquo; SolrQuery::removeField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removefilterquery.php' selected="selected">English</option>
            <option value='de/solrquery.removefilterquery.php'>German</option>
            <option value='es/solrquery.removefilterquery.php'>Spanish</option>
            <option value='fr/solrquery.removefilterquery.php'>French</option>
            <option value='it/solrquery.removefilterquery.php'>Italian</option>
            <option value='ja/solrquery.removefilterquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.removefilterquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removefilterquery.php'>Russian</option>
            <option value='tr/solrquery.removefilterquery.php'>Turkish</option>
            <option value='uk/solrquery.removefilterquery.php'>Ukrainian</option>
            <option value='zh/solrquery.removefilterquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removefilterquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeFilterQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeFilterQuery</span> &mdash; <span class="dc-title">Removes a filter query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removefilterquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeFilterQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fq</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removefilterquery-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removefilterquery-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removefilterquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removefilterquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removefilterquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removefilterquery.php">＋<small>add a note</small></a></span>
