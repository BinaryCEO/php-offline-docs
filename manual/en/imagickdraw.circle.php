...
<head>
  ...
  <title>PHP: ImagickDraw::circle - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.circle.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.circle.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.circle.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.bezier.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.clear.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.circle.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.circle.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.circle.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.circle.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.circle.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.circle.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.circle.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.circle.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.circle.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.circle.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.circle.php" hreflang="zh">
...
<meta name="Description" content="Draws a circle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::circle - Manual" />
<meta name="twitter:description" content="Draws a circle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::circle - Manual" />
<meta itemprop="description" content="Draws a circle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a circle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.clear.php">
          ImagickDraw::clear &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.bezier.php">
          &laquo; ImagickDraw::bezier        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.circle.php' selected="selected">English</option>
            <option value='de/imagickdraw.circle.php'>German</option>
            <option value='es/imagickdraw.circle.php'>Spanish</option>
            <option value='fr/imagickdraw.circle.php'>French</option>
            <option value='it/imagickdraw.circle.php'>Italian</option>
            <option value='ja/imagickdraw.circle.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.circle.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.circle.php'>Russian</option>
            <option value='tr/imagickdraw.circle.php'>Turkish</option>
            <option value='uk/imagickdraw.circle.php'>Ukrainian</option>
            <option value='zh/imagickdraw.circle.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.circle" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::circle</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::circle</span> &mdash; <span class="dc-title">Draws a circle</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.circle-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::circle</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$origin_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$origin_y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$perimeter_x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$perimeter_y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.circle-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">origin_x</code></dt>
     <dd>
      <p class="para">
       origin x coordinate
      </p>
     ...
     <dt><code class="parameter">origin_y</code></dt>
     <dd>
      <p class="para">
       origin y coordinate
      </p>
     ...
     <dt><code class="parameter">perimeter_x</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">perimeter_y</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.circle-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3148">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/circle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.circle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.circle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.circle.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114236">  <div class="votes">
    <div id="Vu114236">
    <a href="/manual/vote-note.php?id=114236&amp;page=imagickdraw.circle&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114236">
    <a href="/manual/vote-note.php?id=114236&amp;page=imagickdraw.circle&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114236" title="78% like this...">
    11
    </div>
  </div>
  <a href="#114236" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#114236"> &para;</a><div class="date" title="2014-01-27 09:26"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114236">
<div class="phpcode"><code><span class="html">The four values required here are a bit confusing. After all, a circle is defined by three values: the x, y coordinates of the centre, and the radius, r.<br /><br />The fourth value is redundant, but has to be given, otherwise the function fails. One way of coping with this redundancy is:<br /><br /><span class="default">&lt;?php<br />$draw </span><span class="keyword">= new </span><span class="default">ImagickDraw </span><span class="keyword">();<br /></span><span class="comment">//given that $x and $y are the coordinates of the centre, and $r the radius:<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">circle </span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">, </span><span class="default">$x </span><span class="keyword">+ </span><span class="default">$r</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />There are any number of actions which are synonymous with the last, including:<br /><span class="default">&lt;?php<br />$draw</span><span class="keyword">-&gt;</span><span class="default">circle </span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">, </span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y </span><span class="keyword">+ </span><span class="default">$r</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">circle </span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">, </span><span class="default">$x </span><span class="keyword">- </span><span class="default">$r</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">);<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">circle </span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y</span><span class="keyword">, </span><span class="default">$x</span><span class="keyword">, </span><span class="default">$y </span><span class="keyword">- </span><span class="default">$r</span><span class="keyword">);<br /></span><span class="comment">// etc, etc.<br /></span><span class="default">?&gt;<br /></span><br />Hope this helps.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.circle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.circle.php">＋<small>add a note</small></a></div>
