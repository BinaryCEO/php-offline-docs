...
<head>
  ...
  <title>PHP: fann_train_on_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-train-on-file.php">
 <link rel="shorturl" href="https://www.php.net/fann-train-on-file">
 <link rel="alternate" href="https://www.php.net/fann-train-on-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-train-on-data.php">
 <link rel="next" href="https://www.php.net/manual/en/class.fannconnection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-train-on-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-train-on-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-train-on-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-train-on-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-train-on-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-train-on-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-train-on-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-train-on-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-train-on-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-train-on-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-train-on-file.php" hreflang="zh">
...
<meta name="Description" content="Trains on an entire dataset, which is read from file, for a period of time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_train_on_file - Manual" />
<meta name="twitter:description" content="Trains on an entire dataset, which is read from file, for a period of time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_train_on_file - Manual" />
<meta itemprop="description" content="Trains on an entire dataset, which is read from file, for a period of time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Trains on an entire dataset, which is read from file, for a period of time" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.fannconnection.php">
          FANNConnection &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-train-on-data.php">
          &laquo; fann_train_on_data        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-train-on-file.php' selected="selected">English</option>
            <option value='de/function.fann-train-on-file.php'>German</option>
            <option value='es/function.fann-train-on-file.php'>Spanish</option>
            <option value='fr/function.fann-train-on-file.php'>French</option>
            <option value='it/function.fann-train-on-file.php'>Italian</option>
            <option value='ja/function.fann-train-on-file.php'>Japanese</option>
            <option value='pt_BR/function.fann-train-on-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-train-on-file.php'>Russian</option>
            <option value='tr/function.fann-train-on-file.php'>Turkish</option>
            <option value='uk/function.fann-train-on-file.php'>Ukrainian</option>
            <option value='zh/function.fann-train-on-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-train-on-file" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-callback.php" class="function" rel="rdfs-seeAlso">fann_set_callback()</a> - Sets the callback function for use during training</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-train-on-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-train-on-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-train-on-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-train-on-file.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123294">  <div class="votes">
    <div id="Vu123294">
    <a href="/manual/vote-note.php?id=123294&amp;page=function.fann-train-on-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123294">
    <a href="/manual/vote-note.php?id=123294&amp;page=function.fann-train-on-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123294" title="100% like this...">
    1
    </div>
  </div>
  <a href="#123294" class="name">
  <strong class="user"><em>geekgirljoy at gmail dot com</em></strong></a><a class="genanchor" href="#123294"> &para;</a><div class="date" title="2018-11-01 05:11"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123294">
<div class="phpcode"><code><span class="html">Training File (xor.data):<br />4 2 1<br />-1 -1<br />-1<br />-1 1<br />1<br />1 -1<br />1<br />1 1<br />-1<br /><br /><span class="default">&lt;?php<br />$num_input </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">;<br /></span><span class="default">$num_output </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br /></span><span class="default">$num_layers </span><span class="keyword">= </span><span class="default">3</span><span class="keyword">;<br /></span><span class="default">$num_neurons_hidden </span><span class="keyword">= </span><span class="default">3</span><span class="keyword">;<br /></span><span class="default">$desired_error </span><span class="keyword">= </span><span class="default">0.001</span><span class="keyword">;<br /></span><span class="default">$max_epochs </span><span class="keyword">= </span><span class="default">500000</span><span class="keyword">;<br /></span><span class="default">$epochs_between_reports </span><span class="keyword">= </span><span class="default">1000</span><span class="keyword">;<br /></span><span class="default">$training_data </span><span class="keyword">= </span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">) . </span><span class="string">"/xor.data"</span><span class="keyword">;  </span><span class="comment">// training data file<br /></span><span class="default">$ann_save_file </span><span class="keyword">= </span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">) . </span><span class="string">"/xor_float.net"</span><span class="keyword">;  </span><span class="comment">// training data file<br /><br />// Create ANN object using<br /></span><span class="default">$ann </span><span class="keyword">= </span><span class="default">fann_create_standard</span><span class="keyword">(</span><span class="default">$num_layers</span><span class="keyword">, </span><span class="default">$num_input</span><span class="keyword">, </span><span class="default">$num_neurons_hidden</span><span class="keyword">, </span><span class="default">$num_output</span><span class="keyword">);<br /><br />if (</span><span class="default">$ann</span><span class="keyword">) {<br />    <br />    </span><span class="comment">// Configure the ANN Activation Function <br />    </span><span class="default">fann_set_activation_function_hidden</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br />    </span><span class="default">fann_set_activation_function_output</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">FANN_SIGMOID_SYMMETRIC</span><span class="keyword">);<br />    <br />    </span><span class="comment">// Try to train using fann_train_on_file()<br />    </span><span class="keyword">if (</span><span class="default">fann_train_on_file</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$training_data</span><span class="keyword">, </span><span class="default">$max_epochs</span><span class="keyword">, </span><span class="default">$epochs_between_reports</span><span class="keyword">, </span><span class="default">$desired_error</span><span class="keyword">)){<br />        echo </span><span class="string">'xor trained.' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">);<br />    }<br />    <br />    </span><span class="comment">// Try to save<br />    </span><span class="keyword">if (</span><span class="default">fann_save</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">, </span><span class="default">$ann_save_file</span><span class="keyword">)){<br />        echo </span><span class="string">'xor saved.' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">);<br />    }<br />    <br />    </span><span class="comment">// Destroy the $ann object<br />    </span><span class="default">fann_destroy</span><span class="keyword">(</span><span class="default">$ann</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-train-on-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-train-on-file.php">＋<small>add a note</small></a></div>
