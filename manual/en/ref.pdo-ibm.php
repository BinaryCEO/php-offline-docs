...
<head>
  ...
  <title>PHP: IBM PDO Driver - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.pdo-ibm.php">
 <link rel="shorturl" href="https://www.php.net/pdo-ibm">
 <link rel="alternate" href="https://www.php.net/pdo-ibm" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/pdo.drivers.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdo-firebird.getapiversion.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.pdo-ibm.connection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.pdo-ibm.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.pdo-ibm.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.pdo-ibm.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.pdo-ibm.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.pdo-ibm.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.pdo-ibm.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.pdo-ibm.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.pdo-ibm.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.pdo-ibm.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.pdo-ibm.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.pdo-ibm.php" hreflang="zh">
...
<meta name="Description" content="IBM PDO Driver (PDO_IBM)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IBM PDO Driver - Manual" />
<meta name="twitter:description" content="IBM PDO Driver (PDO_IBM)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IBM PDO Driver - Manual" />
<meta itemprop="description" content="IBM PDO Driver (PDO_IBM)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="IBM PDO Driver (PDO_IBM)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdo-firebird.getapiversion.php">
          &laquo; Pdo\Firebird::getApiVersion        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.pdo-ibm.php' selected="selected">English</option>
            <option value='de/ref.pdo-ibm.php'>German</option>
            <option value='es/ref.pdo-ibm.php'>Spanish</option>
            <option value='fr/ref.pdo-ibm.php'>French</option>
            <option value='it/ref.pdo-ibm.php'>Italian</option>
            <option value='ja/ref.pdo-ibm.php'>Japanese</option>
            <option value='pt_BR/ref.pdo-ibm.php'>Brazilian Portuguese</option>
            <option value='ru/ref.pdo-ibm.php'>Russian</option>
            <option value='tr/ref.pdo-ibm.php'>Turkish</option>
            <option value='uk/ref.pdo-ibm.php'>Ukrainian</option>
            <option value='zh/ref.pdo-ibm.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.pdo-ibm" class="reference">
 ...
 <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ref.pdo-ibm.connection.php">PDO_IBM DSN</a> — Connecting to IBM databases</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.pdo-ibm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.pdo-ibm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.pdo-ibm.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127965">  <div class="votes">
    <div id="Vu127965">
    <a href="/manual/vote-note.php?id=127965&amp;page=ref.pdo-ibm&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127965">
    <a href="/manual/vote-note.php?id=127965&amp;page=ref.pdo-ibm&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127965" title="no votes...">
    0
    </div>
  </div>
  <a href="#127965" class="name">
  <strong class="user"><em>jwoehr at softwoehr dot com</em></strong></a><a class="genanchor" href="#127965"> &para;</a><div class="date" title="2022-11-27 05:00"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127965">
<div class="phpcode"><code><span class="html">Connecting to IBM i (called "i5" above in the article) Db2 is usually simpler using PDO_ODBC with the IBM i ODBC driver for IBM i itself, Windows, Linux, or Mac, all free to download ... see <a href="https://www.ibm.com/support/pages/odbc-driver-ibm-i-access-client-solutions" rel="nofollow" target="_blank">https://www.ibm.com/support/pages/odbc-driver-ibm-i-access-client-solutions</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ref.pdo-ibm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.pdo-ibm.php">＋<small>add a note</small></a></div>
