...
<head>
  ...
  <title>PHP: bcpowmod - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.bcpowmod.php">
 <link rel="shorturl" href="https://www.php.net/bcpowmod">
 <link rel="alternate" href="https://www.php.net/bcpowmod" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.bc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.bcpow.php">
 <link rel="next" href="https://www.php.net/manual/en/function.bcround.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.bcpowmod.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.bcpowmod.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.bcpowmod.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.bcpowmod.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.bcpowmod.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.bcpowmod.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.bcpowmod.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.bcpowmod.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.bcpowmod.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.bcpowmod.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.bcpowmod.php" hreflang="zh">
...
<meta name="Description" content="Raise an arbitrary precision number to another, reduced by a specified modulus" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: bcpowmod - Manual" />
<meta name="twitter:description" content="Raise an arbitrary precision number to another, reduced by a specified modulus" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: bcpowmod - Manual" />
<meta itemprop="description" content="Raise an arbitrary precision number to another, reduced by a specified modulus" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Raise an arbitrary precision number to another, reduced by a specified modulus" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.bcpowmod.php' selected="selected">English</option>
            <option value='de/function.bcpowmod.php'>German</option>
            <option value='es/function.bcpowmod.php'>Spanish</option>
            <option value='fr/function.bcpowmod.php'>French</option>
            <option value='it/function.bcpowmod.php'>Italian</option>
            <option value='ja/function.bcpowmod.php'>Japanese</option>
            <option value='pt_BR/function.bcpowmod.php'>Brazilian Portuguese</option>
            <option value='ru/function.bcpowmod.php'>Russian</option>
            <option value='tr/function.bcpowmod.php'>Turkish</option>
            <option value='uk/function.bcpowmod.php'>Ukrainian</option>
            <option value='zh/function.bcpowmod.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.bcpowmod" class="refentry">
  ...
  <p class="para">
   ...
   <li><span class="methodname"><a href="bcmath-number.powmod.php" class="methodname" rel="rdfs-seeAlso">BcMath\Number::powmod()</a> - Raises an arbitrary precision number, reduced by a specified modulus</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/bc/functions/bcpowmod.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.bcpowmod%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.bcpowmod&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.bcpowmod.php">＋<small>add a note</small></a></span>
