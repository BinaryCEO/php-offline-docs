...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-seq-drop.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-schema.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-seq-insert.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-seq-drop.php' selected="selected">English</option>
...
<div class="refsect1 parameters" id="refsect1-function.cubrid-seq-drop-parameters">
 ...
 <div class="refsect1 examples" id="refsect1-function.cubrid-seq-drop-examples">
  ...
  <div class="example" id="example-1273">
   <p><strong>Example #1 <span class="function"><strong>cubrid_seq_drop()</strong></span> example</strong></p>
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-seq-put.php" class="function" rel="rdfs-seeAlso">cubrid_seq_put()</a> - Update the element value of sequence type column using OID</span></li>   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-seq-drop.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-seq-drop%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-seq-drop&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-seq-drop.php">＋<small>add a note</small></a></span>
