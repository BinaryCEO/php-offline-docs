...
<head>
  ...
  <title>PHP: trader_cos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-cos.php">
 <link rel="shorturl" href="https://www.php.net/trader-cos">
 <link rel="alternate" href="https://www.php.net/trader-cos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-correl.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cosh.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-cos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-cos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-cos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-cos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-cos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-cos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-cos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-cos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-cos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-cos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-cos.php" hreflang="zh">
...
<meta name="Description" content="Vector Trigonometric Cos" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_cos - Manual" />
<meta name="twitter:description" content="Vector Trigonometric Cos" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_cos - Manual" />
<meta itemprop="description" content="Vector Trigonometric Cos" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Vector Trigonometric Cos" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-cosh.php">
          trader_cosh &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-correl.php">
          &laquo; trader_correl        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-cos.php' selected="selected">English</option>
            <option value='de/function.trader-cos.php'>German</option>
            <option value='es/function.trader-cos.php'>Spanish</option>
            <option value='fr/function.trader-cos.php'>French</option>
            <option value='it/function.trader-cos.php'>Italian</option>
            <option value='ja/function.trader-cos.php'>Japanese</option>
            <option value='pt_BR/function.trader-cos.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-cos.php'>Russian</option>
            <option value='tr/function.trader-cos.php'>Turkish</option>
            <option value='uk/function.trader-cos.php'>Ukrainian</option>
            <option value='zh/function.trader-cos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-cos" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_cos</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_cos</span> &mdash; <span class="dc-title">Vector Trigonometric Cos</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-cos-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_cos</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-cos-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-cos-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-cos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-cos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-cos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cos.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125762">  <div class="votes">
    <div id="Vu125762">
    <a href="/manual/vote-note.php?id=125762&amp;page=function.trader-cos&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125762">
    <a href="/manual/vote-note.php?id=125762&amp;page=function.trader-cos&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125762" title="no votes...">
    0
    </div>
  </div>
  <a href="#125762" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125762"> &para;</a><div class="date" title="2021-02-03 05:48"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125762">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />$real </span><span class="keyword">= array(</span><span class="default">0</span><span class="keyword">, </span><span class="default">0.1</span><span class="keyword">, </span><span class="default">0.2</span><span class="keyword">, </span><span class="default">0.3</span><span class="keyword">, </span><span class="default">0.4</span><span class="keyword">, </span><span class="default">0.5</span><span class="keyword">, </span><span class="default">0.6</span><span class="keyword">, </span><span class="default">0.7</span><span class="keyword">, </span><span class="default">0.8</span><span class="keyword">, </span><span class="default">0.9</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">1.1</span><span class="keyword">);<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">trader_cos</span><span class="keyword">(</span><span class="default">$real</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(12) {<br />  [0]=&gt;<br />  float(1)<br />  [1]=&gt;<br />  float(0.995)<br />  [2]=&gt;<br />  float(0.98)<br />  [3]=&gt;<br />  float(0.955)<br />  [4]=&gt;<br />  float(0.921)<br />  [5]=&gt;<br />  float(0.878)<br />  [6]=&gt;<br />  float(0.825)<br />  [7]=&gt;<br />  float(0.765)<br />  [8]=&gt;<br />  float(0.697)<br />  [9]=&gt;<br />  float(0.622)<br />  [10]=&gt;<br />  float(0.54)<br />  [11]=&gt;<br />  float(0.454)<br />}<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-cos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-cos.php">＋<small>add a note</small></a></div>
