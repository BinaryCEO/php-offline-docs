...
<head>
  ...
  <title>PHP: DOMDocument::schemaValidateSource - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domdocument.schemavalidatesource.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domdocument.schemavalidatesource.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.schemavalidatesource.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domdocument.php">
 <link rel="prev" href="https://www.php.net/manual/en/domdocument.schemavalidate.php">
 <link rel="next" href="https://www.php.net/manual/en/domdocument.validate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/domdocument.schemavalidatesource.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/domdocument.schemavalidatesource.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/domdocument.schemavalidatesource.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/domdocument.schemavalidatesource.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/domdocument.schemavalidatesource.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/domdocument.schemavalidatesource.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/domdocument.schemavalidatesource.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/domdocument.schemavalidatesource.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/domdocument.schemavalidatesource.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/domdocument.schemavalidatesource.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/domdocument.schemavalidatesource.php" hreflang="zh">
...
<meta name="Description" content="Validates a document based on a schema" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMDocument::schemaValidateSource - Manual" />
<meta name="twitter:description" content="Validates a document based on a schema" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMDocument::schemaValidateSource - Manual" />
<meta itemprop="description" content="Validates a document based on a schema" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Validates a document based on a schema" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="domdocument.validate.php">
          DOMDocument::validate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="domdocument.schemavalidate.php">
          &laquo; DOMDocument::schemaValidate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domdocument.schemavalidatesource.php' selected="selected">English</option>
            <option value='de/domdocument.schemavalidatesource.php'>German</option>
            <option value='es/domdocument.schemavalidatesource.php'>Spanish</option>
            <option value='fr/domdocument.schemavalidatesource.php'>French</option>
            <option value='it/domdocument.schemavalidatesource.php'>Italian</option>
            <option value='ja/domdocument.schemavalidatesource.php'>Japanese</option>
            <option value='pt_BR/domdocument.schemavalidatesource.php'>Brazilian Portuguese</option>
            <option value='ru/domdocument.schemavalidatesource.php'>Russian</option>
            <option value='tr/domdocument.schemavalidatesource.php'>Turkish</option>
            <option value='uk/domdocument.schemavalidatesource.php'>Ukrainian</option>
            <option value='zh/domdocument.schemavalidatesource.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="domdocument.schemavalidatesource" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="domdocument.validate.php" class="methodname" rel="rdfs-seeAlso">DOMDocument::validate()</a> - Validates the document based on its DTD</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domdocument/schemavalidatesource.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomdocument.schemavalidatesource%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domdocument.schemavalidatesource&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domdocument.schemavalidatesource.php">＋<small>add a note</small></a></span>
