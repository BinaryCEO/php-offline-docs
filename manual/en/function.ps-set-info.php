...
<head>
  ...
  <title>PHP: ps_set_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-set-info.php">
 <link rel="shorturl" href="https://www.php.net/ps-set-info">
 <link rel="alternate" href="https://www.php.net/ps-set-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-set-border-style.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-set-parameter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-set-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-set-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-set-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-set-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-set-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-set-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-set-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-set-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-set-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-set-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-set-info.php" hreflang="zh">
...
<meta name="Description" content="Sets information fields of document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_set_info - Manual" />
<meta name="twitter:description" content="Sets information fields of document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_set_info - Manual" />
<meta itemprop="description" content="Sets information fields of document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets information fields of document" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-set-parameter.php">
          ps_set_parameter &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-set-border-style.php">
          &laquo; ps_set_border_style        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-set-info.php' selected="selected">English</option>
            <option value='de/function.ps-set-info.php'>German</option>
            <option value='es/function.ps-set-info.php'>Spanish</option>
            <option value='fr/function.ps-set-info.php'>French</option>
            <option value='it/function.ps-set-info.php'>Italian</option>
            <option value='ja/function.ps-set-info.php'>Japanese</option>
            <option value='pt_BR/function.ps-set-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-set-info.php'>Russian</option>
            <option value='tr/function.ps-set-info.php'>Turkish</option>
            <option value='uk/function.ps-set-info.php'>Ukrainian</option>
            <option value='zh/function.ps-set-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-set-info" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ps-set-info-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_set_info</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$p</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$val</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ps-begin-page.php" class="function" rel="rdfs-seeAlso">ps_begin_page()</a> - Start a new page</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-set-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-set-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-set-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-set-info.php">＋<small>add a note</small></a></span>
