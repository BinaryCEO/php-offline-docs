...
<head>
  ...
  <title>PHP: vfprintf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.vfprintf.php">
 <link rel="shorturl" href="https://www.php.net/vfprintf">
 <link rel="alternate" href="https://www.php.net/vfprintf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.strings.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.utf8-encode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.vprintf.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.vfprintf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.vfprintf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.vfprintf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.vfprintf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.vfprintf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.vfprintf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.vfprintf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.vfprintf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.vfprintf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.vfprintf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.vfprintf.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.vfprintf.php' selected="selected">English</option>
            <option value='de/function.vfprintf.php'>German</option>
            <option value='es/function.vfprintf.php'>Spanish</option>
            <option value='fr/function.vfprintf.php'>French</option>
            <option value='it/function.vfprintf.php'>Italian</option>
            <option value='ja/function.vfprintf.php'>Japanese</option>
            <option value='pt_BR/function.vfprintf.php'>Brazilian Portuguese</option>
            <option value='ru/function.vfprintf.php'>Russian</option>
            <option value='tr/function.vfprintf.php'>Turkish</option>
            <option value='uk/function.vfprintf.php'>Ukrainian</option>
            <option value='zh/function.vfprintf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.vfprintf" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">vfprintf</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">vfprintf</span> &mdash; <span class="dc-title">Write a formatted string to a stream</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.vfprintf-description">
  ...
  <p class="para">
   Operates as <span class="function"><a href="function.fprintf.php" class="function">fprintf()</a></span> but accepts an array of
 ...
 <div class="refsect1 examples" id="refsect1-function.vfprintf-examples">
  ...
  <p class="para">
   <div class="example" id="example-5198">
    <p><strong>Example #1 <span class="function"><strong>vfprintf()</strong></span>: zero-padded integers</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.date.php" class="function" rel="rdfs-seeAlso">date()</a> - Format a Unix timestamp</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/vfprintf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.vfprintf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.vfprintf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.vfprintf.php">＋<small>add a note</small></a></span>
