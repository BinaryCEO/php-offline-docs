...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.long2ip.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ip2long.php">
 <link rel="next" href="https://www.php.net/manual/en/function.net-get-interfaces.php">
...
<meta name="Description" content="Converts a long integer address into a string in (IPv4) Internet standard dotted format" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: long2ip - Manual" />
<meta name="twitter:description" content="Converts a long integer address into a string in (IPv4) Internet standard dotted format" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: long2ip - Manual" />
<meta itemprop="description" content="Converts a long integer address into a string in (IPv4) Internet standard dotted format" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts a long integer address into a string in (IPv4) Internet standard dotted format" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.long2ip.php' selected="selected">English</option>
            ...
            <option value='tr/function.long2ip.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">long2ip</span> &mdash; <span class="dc-title">Converts a long integer address into a string in (IPv4) Internet standard dotted format</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.long2ip-returnvalues">
  ...
  <p class="para">
   Returns the Internet IP address as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
  </p>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       Return type changed from <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span> to <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
      </td>
     </tr>
     ...
     <tr>
      <td>7.1.0</td>
      <td>
       The parameter type of <code class="parameter">ip</code> has been
       changed from <span class="type"><a href="language.types.string.php" class="type string">string</a></span> to <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>.
      </td>
     </tr>
 ...
 <div class="refsect1 notes" id="refsect1-function.long2ip-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    from <span class="type"><a href="language.types.string.php" class="type string">string</a></span> to <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> will not give
    correct results for numbers which exceed <strong><code><a href="reserved.constants.php#constant.php-int-max">PHP_INT_MAX</a></code></strong>.
   </p>
  </p></blockquote>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ip2long.php" class="function" rel="rdfs-seeAlso">ip2long()</a> - Converts a string containing an (IPv4) Internet Protocol dotted address into a long integer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/long2ip.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.long2ip%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.long2ip&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.long2ip.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If the function doesn't exist:<br /><br />&lt;?<br />    if (!function_exists("long2ip")) {<br />        function long2ip($long) {<br />            // Valid range: 0.0.0.0 -&gt; 255.255.255.255<br />            if ($long &lt; 0 || $long &gt; 4294967295) return false;<br />            $ip = "";<br />            for ($i=3;$i&gt;=0;$i--) {<br />                $ip .= (int)($long / pow(256,$i));<br />                $long -= (int)($long / pow(256,$i))*pow(256,$i);<br />                if ($i&gt;0) $ip .= ".";<br />            }<br />            return $ip;<br />        }<br />    }<br />?&gt;</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>steve at computurn dot com</em></strong></a><a class="genanchor" href="#123279"> &para;</a><div class="date" title="2018-10-30 01:38"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123279">
<div class="phpcode"><code><span class="html">For a 32bit safe long2ip, which can accept string or signed integer input, try:<br /><br />  function safelong2ip($long) {<br />    $binStr = sprintf("%032s", decbin((float)$long));<br />    if (strlen($binStr) != 32) {<br />      throw new Exception("Invalid IPv4 subnet!");<br />    }<br /><br />    $ipArr = [];<br />    for ($i = 0; $i &lt; 4; ++$i) {<br />      $ipArr[] = bindec(substr($binStr, $i*8, 8));<br />    }<br /><br />    return implode('.', $ipArr);<br />  }</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.long2ip&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.long2ip.php">＋<small>add a note</small></a></div>
