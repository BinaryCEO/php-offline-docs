...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/snmp.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/snmp.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/snmp.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/snmp.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.snmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/snmp.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/snmp.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/snmp.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/snmp.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/snmp.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/snmp.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/snmp.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/snmp.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/snmp.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/snmp.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/snmp.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/snmp.constants.php' selected="selected">English</option>
            <option value='de/snmp.constants.php'>German</option>
            <option value='es/snmp.constants.php'>Spanish</option>
            <option value='fr/snmp.constants.php'>French</option>
            <option value='it/snmp.constants.php'>Italian</option>
            <option value='ja/snmp.constants.php'>Japanese</option>
            <option value='pt_BR/snmp.constants.php'>Brazilian Portuguese</option>
            <option value='ru/snmp.constants.php'>Russian</option>
            <option value='tr/snmp.constants.php'>Turkish</option>
            <option value='uk/snmp.constants.php'>Ukrainian</option>
            <option value='zh/snmp.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="snmp.constants" class="appendix">
   ...
   <dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsnmp.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=snmp.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/snmp.constants.php">＋<small>add a note</small></a></span>
