...
<head>
  ...
  <title>PHP: mb_language - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-language.php">
 <link rel="shorturl" href="https://www.php.net/mb-language">
 <link rel="alternate" href="https://www.php.net/mb-language" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-internal-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-lcfirst.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-language.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-language.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-language.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-language.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-language.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-language.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-language.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-language.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-language.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-language.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-language.php" hreflang="zh">
...
<meta name="Description" content="Set/Get current language" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_language - Manual" />
<meta name="twitter:description" content="Set/Get current language" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_language - Manual" />
<meta itemprop="description" content="Set/Get current language" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set/Get current language" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-language.php' selected="selected">English</option>
            <option value='de/function.mb-language.php'>German</option>
            <option value='es/function.mb-language.php'>Spanish</option>
            <option value='fr/function.mb-language.php'>French</option>
            <option value='it/function.mb-language.php'>Italian</option>
            <option value='ja/function.mb-language.php'>Japanese</option>
            <option value='pt_BR/function.mb-language.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-language.php'>Russian</option>
            <option value='tr/function.mb-language.php'>Turkish</option>
            <option value='uk/function.mb-language.php'>Ukrainian</option>
            <option value='zh/function.mb-language.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-language" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_language</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_language</span> &mdash; <span class="dc-title">Set/Get current language</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-language-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_language</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$language</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-language-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <span class="function"><a href="function.mb-send-mail.php" class="function">mb_send_mail()</a></span> uses this setting to encode e-mail.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-language-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   If <code class="parameter">language</code> is set and
   <code class="parameter">language</code> is valid, it returns
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>. Otherwise, it returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>. 
   When <code class="parameter">language</code> is omitted or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>, it returns the language
   name as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.mb-language-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">language</code> is nullable now.
      </td>
     </tr>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-language-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mb-send-mail.php" class="function" rel="rdfs-seeAlso">mb_send_mail()</a> - Send encoded mail</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-language.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-language%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-language&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-language.php">＋<small>add a note</small></a></span>
