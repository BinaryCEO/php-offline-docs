...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/regexiterator.getflags.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/regexiterator.getflags.php">
 <link rel="alternate" href="https://www.php.net/manual/en/regexiterator.getflags.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.regexiterator.php">
 <link rel="prev" href="https://www.php.net/manual/en/regexiterator.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/regexiterator.getmode.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/regexiterator.getflags.php' selected="selected">English</option>
            ...
            <option value='pt_BR/regexiterator.getflags.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">RegexIterator::getFlags</span> &mdash; <span class="dc-title">Get flags</span></p>
 ...
 <div class="refsect1 description" id="refsect1-regexiterator.getflags-description">
  ...
  <p class="para rdfs-comment">
   Returns the flags, see <span class="methodname"><a href="regexiterator.setflags.php" class="methodname">RegexIterator::setFlags()</a></span>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="regexiterator.setflags.php" class="methodname" rel="rdfs-seeAlso">RegexIterator::setFlags()</a> - Sets the flags</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/regexiterator/getflags.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fregexiterator.getflags%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=regexiterator.getflags&amp;repo=en&amp;redirect=https://www.php.net/manual/en/regexiterator.getflags.php">＋<small>add a note</small></a></span>
