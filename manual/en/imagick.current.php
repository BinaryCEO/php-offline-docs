...
<head>
  ...
  <title>PHP: Imagick::current - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.current.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.current.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.current.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.cropthumbnailimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.cyclecolormapimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.current.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.current.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.current.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.current.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.current.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.current.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.current.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.current.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.current.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.current.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.current.php" hreflang="zh">
...
<meta name="Description" content="Returns a reference to the current Imagick object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::current - Manual" />
<meta name="twitter:description" content="Returns a reference to the current Imagick object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::current - Manual" />
<meta itemprop="description" content="Returns a reference to the current Imagick object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a reference to the current Imagick object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.cyclecolormapimage.php">
          Imagick::cycleColormapImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.cropthumbnailimage.php">
          &laquo; Imagick::cropThumbnailImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.current.php' selected="selected">English</option>
            <option value='de/imagick.current.php'>German</option>
            <option value='es/imagick.current.php'>Spanish</option>
            <option value='fr/imagick.current.php'>French</option>
            <option value='it/imagick.current.php'>Italian</option>
            <option value='ja/imagick.current.php'>Japanese</option>
            <option value='pt_BR/imagick.current.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.current.php'>Russian</option>
            <option value='tr/imagick.current.php'>Turkish</option>
            <option value='uk/imagick.current.php'>Ukrainian</option>
            <option value='zh/imagick.current.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.current" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::current</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::current</span> &mdash; <span class="dc-title">Returns a reference to the current Imagick object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.current-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::current</strong></span>(): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.current-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.current-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.current-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/current.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.current%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.current&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.current.php">＋<small>add a note</small></a></span>
