...
<head>
  ...
  <title>PHP: trader_correl - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-correl.php">
 <link rel="shorturl" href="https://www.php.net/trader-correl">
 <link rel="alternate" href="https://www.php.net/trader-correl" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-cmo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-cos.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-correl.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-correl.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-correl.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-correl.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-correl.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-correl.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-correl.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-correl.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-correl.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-correl.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-correl.php" hreflang="zh">
...
<meta name="Description" content="Pearson's Correlation Coefficient (r)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_correl - Manual" />
<meta name="twitter:description" content="Pearson's Correlation Coefficient (r)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_correl - Manual" />
<meta itemprop="description" content="Pearson's Correlation Coefficient (r)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Pearson's Correlation Coefficient (r)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-cos.php">
          trader_cos &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-correl.php' selected="selected">English</option>
            <option value='de/function.trader-correl.php'>German</option>
            <option value='es/function.trader-correl.php'>Spanish</option>
            <option value='fr/function.trader-correl.php'>French</option>
            <option value='it/function.trader-correl.php'>Italian</option>
            <option value='ja/function.trader-correl.php'>Japanese</option>
            <option value='pt_BR/function.trader-correl.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-correl.php'>Russian</option>
            <option value='tr/function.trader-correl.php'>Turkish</option>
            <option value='uk/function.trader-correl.php'>Ukrainian</option>
            <option value='zh/function.trader-correl.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-correl" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_correl</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_correl</span> &mdash; <span class="dc-title">Pearson&#039;s Correlation Coefficient (r)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-correl-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_correl</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real0</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-correl-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-correl-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-correl.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-correl%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-correl&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-correl.php">＋<small>add a note</small></a></span>
