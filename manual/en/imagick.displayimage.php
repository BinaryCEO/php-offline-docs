...
<head>
  ...
  <title>PHP: Imagick::displayImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.displayimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.displayimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.displayimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.displayimages.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.displayimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.displayimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.displayimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.displayimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.displayimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.displayimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.displayimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.displayimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.displayimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.displayimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.displayimage.php" hreflang="zh">
...
<meta name="Description" content="Displays an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::displayImage - Manual" />
<meta name="twitter:description" content="Displays an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::displayImage - Manual" />
<meta itemprop="description" content="Displays an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Displays an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.displayimages.php">
          Imagick::displayImages &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.destroy.php">
          &laquo; Imagick::destroy        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.displayimage.php' selected="selected">English</option>
            <option value='de/imagick.displayimage.php'>German</option>
            <option value='es/imagick.displayimage.php'>Spanish</option>
            <option value='fr/imagick.displayimage.php'>French</option>
            <option value='it/imagick.displayimage.php'>Italian</option>
            <option value='ja/imagick.displayimage.php'>Japanese</option>
            <option value='pt_BR/imagick.displayimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.displayimage.php'>Russian</option>
            <option value='tr/imagick.displayimage.php'>Turkish</option>
            <option value='uk/imagick.displayimage.php'>Ukrainian</option>
            <option value='zh/imagick.displayimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.displayimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::displayImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::displayImage</span> &mdash; <span class="dc-title">Displays an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.displayimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::displayImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$servername</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.displayimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.displayimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.displayimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/displayimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.displayimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.displayimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.displayimage.php">＋<small>add a note</small></a></span>
