...
<head>
  ...
  <title>PHP: SolrQuery::getFacetDateHardEnd - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatehardend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetdatehardend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetdatehardend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetdatehardend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetdatehardend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetdatehardend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetdatehardend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetdatehardend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetdatehardend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetdatehardend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetdatehardend.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of the facet.date.hardend parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetDateHardEnd - Manual" />
<meta name="twitter:description" content="Returns the value of the facet.date.hardend parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetDateHardEnd - Manual" />
<meta itemprop="description" content="Returns the value of the facet.date.hardend parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of the facet.date.hardend parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetdateother.php">
          SolrQuery::getFacetDateOther &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetdategap.php">
          &laquo; SolrQuery::getFacetDateGap        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetdatehardend.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetdatehardend.php'>German</option>
            <option value='es/solrquery.getfacetdatehardend.php'>Spanish</option>
            <option value='fr/solrquery.getfacetdatehardend.php'>French</option>
            <option value='it/solrquery.getfacetdatehardend.php'>Italian</option>
            <option value='ja/solrquery.getfacetdatehardend.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetdatehardend.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetdatehardend.php'>Russian</option>
            <option value='tr/solrquery.getfacetdatehardend.php'>Turkish</option>
            <option value='uk/solrquery.getfacetdatehardend.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetdatehardend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetdatehardend" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetDateHardEnd</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetDateHardEnd</span> &mdash; <span class="dc-title">Returns the value of the facet.date.hardend parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetdatehardend-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetDateHardEnd</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetdatehardend-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetdatehardend-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetdatehardend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetdatehardend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetdatehardend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetdatehardend.php">＋<small>add a note</small></a></span>
