...
<head>
  ...
  <title>PHP: mysql_get_host_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-get-host-info.php">
 <link rel="shorturl" href="https://www.php.net/mysql-get-host-info">
 <link rel="alternate" href="https://www.php.net/mysql-get-host-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-get-client-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-get-proto-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-get-host-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-get-host-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-get-host-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-get-host-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-get-host-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-get-host-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-get-host-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-get-host-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-get-host-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-get-host-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-get-host-info.php" hreflang="zh">
...
<meta name="Description" content="Get MySQL host info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_get_host_info - Manual" />
<meta name="twitter:description" content="Get MySQL host info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_get_host_info - Manual" />
<meta itemprop="description" content="Get MySQL host info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get MySQL host info" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-get-proto-info.php">
          mysql_get_proto_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-get-client-info.php">
          &laquo; mysql_get_client_info        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-get-host-info.php' selected="selected">English</option>
            <option value='de/function.mysql-get-host-info.php'>German</option>
            <option value='es/function.mysql-get-host-info.php'>Spanish</option>
            <option value='fr/function.mysql-get-host-info.php'>French</option>
            <option value='it/function.mysql-get-host-info.php'>Italian</option>
            <option value='ja/function.mysql-get-host-info.php'>Japanese</option>
            <option value='pt_BR/function.mysql-get-host-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-get-host-info.php'>Russian</option>
            <option value='tr/function.mysql-get-host-info.php'>Turkish</option>
            <option value='uk/function.mysql-get-host-info.php'>Ukrainian</option>
            <option value='zh/function.mysql-get-host-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-get-host-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_get_host_info</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_get_host_info</span> &mdash; <span class="dc-title">Get MySQL host info</span></p>
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-get-host-info-returnvalues">
  ...
  <p class="para">
   ...
   connection or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-get-host-info-examples">
  ...
  <p class="para">
   <div class="example" id="example-1906">
    <p><strong>Example #1 <span class="function"><strong>mysql_get_host_info()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-get-server-info.php" class="function" rel="rdfs-seeAlso">mysql_get_server_info()</a> - Get MySQL server info</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-get-host-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-get-host-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-get-host-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-get-host-info.php">＋<small>add a note</small></a></span>
