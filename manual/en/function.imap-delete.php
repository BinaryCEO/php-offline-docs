...
<head>
  ...
  <title>PHP: imap_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-delete.php">
 <link rel="shorturl" href="https://www.php.net/imap-delete">
 <link rel="alternate" href="https://www.php.net/imap-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-createmailbox.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-deletemailbox.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-delete.php" hreflang="zh">
...
<meta name="Description" content="Mark a message for deletion from current mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_delete - Manual" />
<meta name="twitter:description" content="Mark a message for deletion from current mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_delete - Manual" />
<meta itemprop="description" content="Mark a message for deletion from current mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Mark a message for deletion from current mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-deletemailbox.php">
          imap_deletemailbox &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-createmailbox.php">
          &laquo; imap_createmailbox        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-delete.php' selected="selected">English</option>
            <option value='de/function.imap-delete.php'>German</option>
            <option value='es/function.imap-delete.php'>Spanish</option>
            <option value='fr/function.imap-delete.php'>French</option>
            <option value='it/function.imap-delete.php'>Italian</option>
            <option value='ja/function.imap-delete.php'>Japanese</option>
            <option value='pt_BR/function.imap-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-delete.php'>Russian</option>
            <option value='tr/function.imap-delete.php'>Turkish</option>
            <option value='uk/function.imap-delete.php'>Ukrainian</option>
            <option value='zh/function.imap-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-delete" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-close.php" class="function" rel="rdfs-seeAlso">imap_close()</a> - Close an IMAP stream</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-delete.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111750">  <div class="votes">
    <div id="Vu111750">
    <a href="/manual/vote-note.php?id=111750&amp;page=function.imap-delete&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111750">
    <a href="/manual/vote-note.php?id=111750&amp;page=function.imap-delete&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111750" title="70% like this...">
    7
    </div>
  </div>
  <a href="#111750" class="name">
  <strong class="user"><em>erational</em></strong></a><a class="genanchor" href="#111750"> &para;</a><div class="date" title="2013-03-25 02:26"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111750">
<div class="phpcode"><code><span class="html">the function is using the message number (and not the uid !)<br />$uid = $mail-&gt;uid; <br />$msgno = $mail-&gt;msgno;<br /><br />if you want to use the uid, simply option value<br />imap_delete($mbox, $uid, FT_UID);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-delete.php">＋<small>add a note</small></a></div>
