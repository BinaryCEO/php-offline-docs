...
<head>
  ...
  <title>PHP: fann_reset_errno - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-reset-errno.php">
 <link rel="shorturl" href="https://www.php.net/fann-reset-errno">
 <link rel="alternate" href="https://www.php.net/fann-reset-errno" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-read-train-from-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-reset-errstr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-reset-errno.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-reset-errno.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-reset-errno.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-reset-errno.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-reset-errno.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-reset-errno.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-reset-errno.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-reset-errno.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-reset-errno.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-reset-errno.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-reset-errno.php" hreflang="zh">
...
<meta name="Description" content="Resets the last error number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_reset_errno - Manual" />
<meta name="twitter:description" content="Resets the last error number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_reset_errno - Manual" />
<meta itemprop="description" content="Resets the last error number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resets the last error number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-reset-errstr.php">
          fann_reset_errstr &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-read-train-from-file.php">
          &laquo; fann_read_train_from_file        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-reset-errno.php' selected="selected">English</option>
            <option value='de/function.fann-reset-errno.php'>German</option>
            <option value='es/function.fann-reset-errno.php'>Spanish</option>
            <option value='fr/function.fann-reset-errno.php'>French</option>
            <option value='it/function.fann-reset-errno.php'>Italian</option>
            <option value='ja/function.fann-reset-errno.php'>Japanese</option>
            <option value='pt_BR/function.fann-reset-errno.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-reset-errno.php'>Russian</option>
            <option value='tr/function.fann-reset-errno.php'>Turkish</option>
            <option value='uk/function.fann-reset-errno.php'>Ukrainian</option>
            <option value='zh/function.fann-reset-errno.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-reset-errno" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_reset_errno</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_reset_errno</span> &mdash; <span class="dc-title">Resets the last error number</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-reset-errno-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_reset_errno</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$errdat</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-reset-errno-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-reset-errno-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">No value is returned.</p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fann-reset-errno-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-errno.php" class="function" rel="rdfs-seeAlso">fann_get_errno()</a> - Returns the last error number</span></li>
    <li><span class="function"><a href="function.fann-reset-errstr.php" class="function" rel="rdfs-seeAlso">fann_reset_errstr()</a> - Resets the last error string</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-reset-errno.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-reset-errno%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-reset-errno&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-reset-errno.php">＋<small>add a note</small></a></span>
