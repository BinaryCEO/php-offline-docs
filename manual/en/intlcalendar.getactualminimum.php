...
<head>
  ...
  <title>PHP: IntlCalendar::getActualMinimum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getactualminimum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getactualminimum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getactualminimum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getactualmaximum.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getavailablelocales.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getactualminimum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.getactualminimum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.getactualminimum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.getactualminimum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.getactualminimum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.getactualminimum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.getactualminimum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.getactualminimum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.getactualminimum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.getactualminimum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.getactualminimum.php" hreflang="zh">
...
<meta name="Description" content="The minimum value for a field, considering the objectʼs current time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getActualMinimum - Manual" />
<meta name="twitter:description" content="The minimum value for a field, considering the objectʼs current time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getActualMinimum - Manual" />
<meta itemprop="description" content="The minimum value for a field, considering the objectʼs current time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The minimum value for a field, considering the objectʼs current time" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.getavailablelocales.php">
          IntlCalendar::getAvailableLocales &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.getactualmaximum.php">
          &laquo; IntlCalendar::getActualMaximum        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getactualminimum.php' selected="selected">English</option>
            <option value='de/intlcalendar.getactualminimum.php'>German</option>
            <option value='es/intlcalendar.getactualminimum.php'>Spanish</option>
            <option value='fr/intlcalendar.getactualminimum.php'>French</option>
            <option value='it/intlcalendar.getactualminimum.php'>Italian</option>
            <option value='ja/intlcalendar.getactualminimum.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.getactualminimum.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.getactualminimum.php'>Russian</option>
            <option value='tr/intlcalendar.getactualminimum.php'>Turkish</option>
            <option value='uk/intlcalendar.getactualminimum.php'>Ukrainian</option>
            <option value='zh/intlcalendar.getactualminimum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.getactualminimum" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="intlcalendar.getactualmaximum.php" class="methodname" rel="rdfs-seeAlso">IntlCalendar::getActualMaximum()</a> - The maximum value for a field, considering the objectʼs current time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getactualminimum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getactualminimum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getactualminimum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getactualminimum.php">＋<small>add a note</small></a></span>
