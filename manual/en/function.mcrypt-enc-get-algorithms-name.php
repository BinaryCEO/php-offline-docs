...
<head>
  ...
  <title>PHP: mcrypt_enc_get_algorithms_name - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-enc-get-algorithms-name.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-enc-get-algorithms-name">
 <link rel="alternate" href="https://www.php.net/mcrypt-enc-get-algorithms-name" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-decrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-enc-get-block-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-enc-get-algorithms-name.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-enc-get-algorithms-name.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-enc-get-algorithms-name.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-enc-get-algorithms-name.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-enc-get-algorithms-name.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-enc-get-algorithms-name.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-enc-get-algorithms-name.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-enc-get-algorithms-name.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-enc-get-algorithms-name.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-enc-get-algorithms-name.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-enc-get-algorithms-name.php" hreflang="zh">
...
<meta name="Description" content="Returns the name of the opened algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_enc_get_algorithms_name - Manual" />
<meta name="twitter:description" content="Returns the name of the opened algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_enc_get_algorithms_name - Manual" />
<meta itemprop="description" content="Returns the name of the opened algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the name of the opened algorithm" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mcrypt-enc-get-block-size.php">
          mcrypt_enc_get_block_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-decrypt.php">
          &laquo; mcrypt_decrypt        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-enc-get-algorithms-name.php' selected="selected">English</option>
            <option value='de/function.mcrypt-enc-get-algorithms-name.php'>German</option>
            <option value='es/function.mcrypt-enc-get-algorithms-name.php'>Spanish</option>
            <option value='fr/function.mcrypt-enc-get-algorithms-name.php'>French</option>
            <option value='it/function.mcrypt-enc-get-algorithms-name.php'>Italian</option>
            <option value='ja/function.mcrypt-enc-get-algorithms-name.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-enc-get-algorithms-name.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-enc-get-algorithms-name.php'>Russian</option>
            <option value='tr/function.mcrypt-enc-get-algorithms-name.php'>Turkish</option>
            <option value='uk/function.mcrypt-enc-get-algorithms-name.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-enc-get-algorithms-name.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-enc-get-algorithms-name" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_enc_get_algorithms_name</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_enc_get_algorithms_name</span> &mdash; <span class="dc-title">Returns the name of the opened algorithm</span></p>

 </div>
 
 <div id="function.mcrypt-enc-get-algorithms-name-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.mcrypt-enc-get-algorithms-name-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mcrypt_enc_get_algorithms_name</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$td</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mcrypt-enc-get-algorithms-name-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mcrypt-enc-get-algorithms-name-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.mcrypt-enc-get-algorithms-name-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-992">
    <p><strong>Example #1 <span class="function"><strong>mcrypt_enc_get_algorithms_name()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">CAST-256
CAST-256</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-enc-get-algorithms-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-enc-get-algorithms-name%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-enc-get-algorithms-name&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-enc-get-algorithms-name.php">＋<small>add a note</small></a></span>
