...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocirowcount.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ocirollback.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocisavelob.php">
...
<meta name="Description" content="Alias of oci_num_rows" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocirowcount - Manual" />
<meta name="twitter:description" content="Alias of oci_num_rows" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocirowcount - Manual" />
<meta itemprop="description" content="Alias of oci_num_rows" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_num_rows" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocirowcount.php' selected="selected">English</option>
            <option value='de/function.ocirowcount.php'>German</option>
            <option value='es/function.ocirowcount.php'>Spanish</option>
            <option value='fr/function.ocirowcount.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocirowcount</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-num-rows.php" class="function">oci_num_rows()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocirowcount-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-num-rows.php" class="function">oci_num_rows()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocirowcount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocirowcount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocirowcount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocirowcount.php">＋<small>add a note</small></a></span>
