...
<head>
  ...
  <title>PHP: sodium_crypto_box_secretkey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box-secretkey.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-box-secretkey">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-box-secretkey" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-box-seal-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-seed-keypair.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-box-secretkey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-box-secretkey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-box-secretkey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-box-secretkey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-box-secretkey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-box-secretkey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-box-secretkey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-box-secretkey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-box-secretkey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-box-secretkey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-box-secretkey.php" hreflang="zh">
...
<meta name="Description" content="Extracts the secret key from a crypto_box keypair" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box_secretkey - Manual" />
<meta name="twitter:description" content="Extracts the secret key from a crypto_box keypair" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box_secretkey - Manual" />
<meta itemprop="description" content="Extracts the secret key from a crypto_box keypair" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extracts the secret key from a crypto_box keypair" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-box-seed-keypair.php">
          sodium_crypto_box_seed_keypair &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-box-seal-open.php">
          &laquo; sodium_crypto_box_seal_open        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box-secretkey.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-box-secretkey.php'>German</option>
            <option value='es/function.sodium-crypto-box-secretkey.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-box-secretkey.php'>French</option>
            <option value='it/function.sodium-crypto-box-secretkey.php'>Italian</option>
            <option value='ja/function.sodium-crypto-box-secretkey.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-box-secretkey.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-box-secretkey.php'>Russian</option>
            <option value='tr/function.sodium-crypto-box-secretkey.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-box-secretkey.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-box-secretkey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-box-secretkey" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_box_secretkey</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_box_secretkey</span> &mdash; <span class="dc-title">Extracts the secret key from a crypto_box keypair</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-box-secretkey-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_box_secretkey</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key_pair</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-box-secretkey-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-box-secretkey-returnvalues">
  ...
  <p class="para">
   X25519 secret key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box-secretkey.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box-secretkey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-secretkey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-secretkey.php">＋<small>add a note</small></a></span>
