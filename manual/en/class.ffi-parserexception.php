...
<head>
  ...
  <title>PHP: FFI\ParserException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ffi-parserexception.php">
 <link rel="shorturl" href="https://www.php.net/ffi-parserexception">
 <link rel="alternate" href="https://www.php.net/ffi-parserexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ffi.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.ffi-exception.php">
 <link rel="next" href="https://www.php.net/manual/en/book.opcache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ffi-parserexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ffi-parserexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ffi-parserexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ffi-parserexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ffi-parserexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ffi-parserexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ffi-parserexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ffi-parserexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ffi-parserexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ffi-parserexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ffi-parserexception.php" hreflang="zh">
...
<meta name="Description" content="FFI Parser Exceptions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: FFI\ParserException - Manual" />
<meta name="twitter:description" content="FFI Parser Exceptions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: FFI\ParserException - Manual" />
<meta itemprop="description" content="FFI Parser Exceptions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="FFI Parser Exceptions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.opcache.php">
          OPcache &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.ffi-exception.php">
          &laquo; FFI\Exception        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ffi-parserexception.php' selected="selected">English</option>
            <option value='de/class.ffi-parserexception.php'>German</option>
            <option value='es/class.ffi-parserexception.php'>Spanish</option>
            <option value='fr/class.ffi-parserexception.php'>French</option>
            <option value='it/class.ffi-parserexception.php'>Italian</option>
            <option value='ja/class.ffi-parserexception.php'>Japanese</option>
            <option value='pt_BR/class.ffi-parserexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.ffi-parserexception.php'>Russian</option>
            <option value='tr/class.ffi-parserexception.php'>Turkish</option>
            <option value='uk/class.ffi-parserexception.php'>Ukrainian</option>
            <option value='zh/class.ffi-parserexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ffi-parserexception" class="reference">

 <h1 class="title">FFI Parser Exceptions</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 7 &gt;= 7.4.0, PHP 8)</p>


  <div class="section" id="ffi-parserexception.intro">
  ...
  <div class="section" id="ffi-parserexception.synopsis">
   ...
   <div class="classsynopsis"><div class="classsynopsisinfo">
     ...
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">FFI\ParserException</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.ffi-exception.php" class="classname">FFI\Exception</a>
     {</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ffi/ffi.parserexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ffi-parserexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ffi-parserexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ffi-parserexception.php">＋<small>add a note</small></a></span>
