...
<head>
  ...
  <title>PHP: curl_share_init - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-share-init.php">
 <link rel="shorturl" href="https://www.php.net/curl-share-init">
 <link rel="alternate" href="https://www.php.net/curl-share-init" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-share-errno.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-share-init-persistent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-share-init.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-share-init.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-share-init.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-share-init.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-share-init.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-share-init.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-share-init.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-share-init.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-share-init.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-share-init.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-share-init.php" hreflang="zh">
...
<meta name="Description" content="Initialize a cURL share handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_share_init - Manual" />
<meta name="twitter:description" content="Initialize a cURL share handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_share_init - Manual" />
<meta itemprop="description" content="Initialize a cURL share handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize a cURL share handle" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.curl-share-init-persistent.php">
          curl_share_init_persistent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.curl-share-errno.php">
          &laquo; curl_share_errno        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-share-init.php' selected="selected">English</option>
            <option value='de/function.curl-share-init.php'>German</option>
            <option value='es/function.curl-share-init.php'>Spanish</option>
            <option value='fr/function.curl-share-init.php'>French</option>
            <option value='it/function.curl-share-init.php'>Italian</option>
            <option value='ja/function.curl-share-init.php'>Japanese</option>
            <option value='pt_BR/function.curl-share-init.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-share-init.php'>Russian</option>
            <option value='tr/function.curl-share-init.php'>Turkish</option>
            <option value='uk/function.curl-share-init.php'>Ukrainian</option>
            <option value='zh/function.curl-share-init.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-share-init" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-function.curl-share-init-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.curl-share-close.php" class="function" rel="rdfs-seeAlso">curl_share_close()</a> - Close a cURL share handle</span></li>
    <li><span class="function"><a href="function.curl-share-init-persistent.php" class="function" rel="rdfs-seeAlso">curl_share_init_persistent()</a> - Initialize a persistent cURL share handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-share-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-share-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-share-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-share-init.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121270">  <div class="votes">
    <div id="Vu121270">
    <a href="/manual/vote-note.php?id=121270&amp;page=function.curl-share-init&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121270">
    <a href="/manual/vote-note.php?id=121270&amp;page=function.curl-share-init&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121270" title="50% like this...">
    0
    </div>
  </div>
  <a href="#121270" class="name">
  <strong class="user"><em>Robert Chapin</em></strong></a><a class="genanchor" href="#121270"> &para;</a><div class="date" title="2017-06-24 06:15"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121270">
<div class="phpcode"><code><span class="html">Cookie handling is DISABLED by default.  The following must be used prior to CURLOPT_SHARE.<br /><br />curl_setopt($ch1, CURLOPT_COOKIEFILE, "");<br />curl_setopt($ch2, CURLOPT_COOKIEFILE, "");<br /><br />Also, do not attempt to use CURLOPT_SHARE with curl_setopt_array because this can cause the options to be set in the wrong order, which will fail.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.curl-share-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-share-init.php">＋<small>add a note</small></a></div>
