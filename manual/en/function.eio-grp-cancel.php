...
<head>
  ...
  <title>PHP: eio_grp_cancel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-grp-cancel.php">
 <link rel="shorturl" href="https://www.php.net/eio-grp-cancel">
 <link rel="alternate" href="https://www.php.net/eio-grp-cancel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-grp-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-grp-limit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-grp-cancel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-grp-cancel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-grp-cancel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-grp-cancel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-grp-cancel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-grp-cancel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-grp-cancel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-grp-cancel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-grp-cancel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-grp-cancel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-grp-cancel.php" hreflang="zh">
...
<meta name="Description" content="Cancels a request group" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_grp_cancel - Manual" />
<meta name="twitter:description" content="Cancels a request group" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_grp_cancel - Manual" />
<meta itemprop="description" content="Cancels a request group" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Cancels a request group" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-grp-limit.php">
          eio_grp_limit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-grp-add.php">
          &laquo; eio_grp_add        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-grp-cancel.php' selected="selected">English</option>
            <option value='de/function.eio-grp-cancel.php'>German</option>
            <option value='es/function.eio-grp-cancel.php'>Spanish</option>
            <option value='fr/function.eio-grp-cancel.php'>French</option>
            <option value='it/function.eio-grp-cancel.php'>Italian</option>
            <option value='ja/function.eio-grp-cancel.php'>Japanese</option>
            <option value='pt_BR/function.eio-grp-cancel.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-grp-cancel.php'>Russian</option>
            <option value='tr/function.eio-grp-cancel.php'>Turkish</option>
            <option value='uk/function.eio-grp-cancel.php'>Ukrainian</option>
            <option value='zh/function.eio-grp-cancel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-grp-cancel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_grp_cancel</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_grp_cancel</span> &mdash; <span class="dc-title">Cancels a request group</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-grp-cancel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_grp_cancel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$grp</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_grp_cancel()</strong></span> cancels a group request specified by
  <code class="parameter">grp</code> request group resource.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-grp-cancel-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
     The request group resource returned by <span class="function"><a href="function.eio-grp.php" class="function">eio_grp()</a></span>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-grp-cancel-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-grp-cancel-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-grp.php" class="function" rel="rdfs-seeAlso">eio_grp()</a> - Creates a request group</span></li>
   <li><span class="function"><a href="function.eio-grp-add.php" class="function" rel="rdfs-seeAlso">eio_grp_add()</a> - Adds a request to the request group</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-grp-cancel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-grp-cancel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-grp-cancel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-grp-cancel.php">＋<small>add a note</small></a></span>
