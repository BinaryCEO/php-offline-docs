...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/random.constants.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/random.constants.php">
 <link rel="alternate" href="https://www.php.net/manual/en/random.constants.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.random.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.random.php">
 <link rel="next" href="https://www.php.net/manual/en/random.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/random.constants.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/random.constants.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/random.constants.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/random.constants.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/random.constants.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/random.constants.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/random.constants.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/random.constants.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/random.constants.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/random.constants.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/random.constants.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/random.constants.php' selected="selected">English</option>
            <option value='de/random.constants.php'>German</option>
            <option value='es/random.constants.php'>Spanish</option>
            <option value='fr/random.constants.php'>French</option>
            <option value='it/random.constants.php'>Italian</option>
            <option value='ja/random.constants.php'>Japanese</option>
            <option value='pt_BR/random.constants.php'>Brazilian Portuguese</option>
            <option value='ru/random.constants.php'>Russian</option>
            <option value='tr/random.constants.php'>Turkish</option>
            <option value='uk/random.constants.php'>Ukrainian</option>
            <option value='zh/random.constants.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="random.constants" class="appendix">
...
is highly discouraged.</p></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/constants.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Frandom.constants%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=random.constants&amp;repo=en&amp;redirect=https://www.php.net/manual/en/random.constants.php">＋<small>add a note</small></a></span>
