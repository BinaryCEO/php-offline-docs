...
<head>
  ...
  <title>PHP: SolrQuery::setFacetSort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetsort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetsort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetsort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetprefix.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroup.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setfacetsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setfacetsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setfacetsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setfacetsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setfacetsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setfacetsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setfacetsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setfacetsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setfacetsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setfacetsort.php" hreflang="zh">
...
<meta name="Description" content="Determines the ordering of the facet field constraints" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetSort - Manual" />
<meta name="twitter:description" content="Determines the ordering of the facet field constraints" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetSort - Manual" />
<meta itemprop="description" content="Determines the ordering of the facet field constraints" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines the ordering of the facet field constraints" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setgroup.php">
          SolrQuery::setGroup &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setfacetprefix.php">
          &laquo; SolrQuery::setFacetPrefix        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetsort.php' selected="selected">English</option>
            <option value='de/solrquery.setfacetsort.php'>German</option>
            <option value='es/solrquery.setfacetsort.php'>Spanish</option>
            <option value='fr/solrquery.setfacetsort.php'>French</option>
            <option value='it/solrquery.setfacetsort.php'>Italian</option>
            <option value='ja/solrquery.setfacetsort.php'>Japanese</option>
            <option value='pt_BR/solrquery.setfacetsort.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setfacetsort.php'>Russian</option>
            <option value='tr/solrquery.setfacetsort.php'>Turkish</option>
            <option value='uk/solrquery.setfacetsort.php'>Ukrainian</option>
            <option value='zh/solrquery.setfacetsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setfacetsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setFacetSort</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetSort</span> &mdash; <span class="dc-title">Determines the ordering of the facet field constraints</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setfacetsort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setFacetSort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$facetSort</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setfacetsort-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">facetSort</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setfacetsort-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetsort.php">＋<small>add a note</small></a></span>
