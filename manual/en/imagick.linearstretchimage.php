...
<head>
  ...
  <title>PHP: Imagick::linearStretchImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.linearstretchimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.linearstretchimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.linearstretchimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.levelimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.liquidrescaleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.linearstretchimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.linearstretchimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.linearstretchimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.linearstretchimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.linearstretchimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.linearstretchimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.linearstretchimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.linearstretchimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.linearstretchimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.linearstretchimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.linearstretchimage.php" hreflang="zh">
...
<meta name="Description" content="Stretches with saturation the image intensity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::linearStretchImage - Manual" />
<meta name="twitter:description" content="Stretches with saturation the image intensity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::linearStretchImage - Manual" />
<meta itemprop="description" content="Stretches with saturation the image intensity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Stretches with saturation the image intensity" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.liquidrescaleimage.php">
          Imagick::liquidRescaleImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.levelimage.php">
          &laquo; Imagick::levelImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.linearstretchimage.php' selected="selected">English</option>
            <option value='de/imagick.linearstretchimage.php'>German</option>
            <option value='es/imagick.linearstretchimage.php'>Spanish</option>
            <option value='fr/imagick.linearstretchimage.php'>French</option>
            <option value='it/imagick.linearstretchimage.php'>Italian</option>
            <option value='ja/imagick.linearstretchimage.php'>Japanese</option>
            <option value='pt_BR/imagick.linearstretchimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.linearstretchimage.php'>Russian</option>
            <option value='tr/imagick.linearstretchimage.php'>Turkish</option>
            <option value='uk/imagick.linearstretchimage.php'>Ukrainian</option>
            <option value='zh/imagick.linearstretchimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.linearstretchimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::linearStretchImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::linearStretchImage</span> &mdash; <span class="dc-title">Stretches with saturation the image intensity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.linearstretchimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::linearStretchImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$blackPoint</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$whitePoint</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.linearstretchimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.linearstretchimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3025">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/linearstretchimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.linearstretchimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.linearstretchimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.linearstretchimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115193">  <div class="votes">
    <div id="Vu115193">
    <a href="/manual/vote-note.php?id=115193&amp;page=imagick.linearstretchimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115193">
    <a href="/manual/vote-note.php?id=115193&amp;page=imagick.linearstretchimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115193" title="66% like this...">
    1
    </div>
  </div>
  <a href="#115193" class="name">
  <strong class="user"><em>SkepticaLee</em></strong></a><a class="genanchor" href="#115193"> &para;</a><div class="date" title="2014-06-11 12:54"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115193">
<div class="phpcode"><code><span class="html">"Black" and "white" points here are pixel counts from the darkest and brightest ends respectively. To turn the darkest 90% of the pixels black, and the brightest 5% white, use the following:<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick </span><span class="keyword">(</span><span class="string">"some image.png"</span><span class="keyword">);<br />list (</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$height</span><span class="keyword">) = </span><span class="default">array_values </span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry </span><span class="keyword">());<br /></span><span class="default">$px </span><span class="keyword">= </span><span class="default">$width </span><span class="keyword">* </span><span class="default">$height</span><span class="keyword">;<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">modulateImage </span><span class="keyword">(</span><span class="default">100</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">linearStretchImage </span><span class="keyword">(</span><span class="default">$px </span><span class="keyword">* </span><span class="default">0.9</span><span class="keyword">, </span><span class="default">$px </span><span class="keyword">* </span><span class="default">0.05</span><span class="keyword">);<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage </span><span class="keyword">(</span><span class="string">"temp.jpg"</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.linearstretchimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.linearstretchimage.php">＋<small>add a note</small></a></div>
