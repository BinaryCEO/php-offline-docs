...
<head>
  ...
  <title>PHP: fbird_maintain_db - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-maintain-db.php">
 <link rel="shorturl" href="https://www.php.net/fbird-maintain-db">
 <link rel="alternate" href="https://www.php.net/fbird-maintain-db" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-gen-id.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-modify-user.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-maintain-db.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-maintain-db.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-maintain-db.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-maintain-db.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-maintain-db.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-maintain-db.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-maintain-db.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-maintain-db.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-maintain-db.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-maintain-db.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-maintain-db.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_maintain_db" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_maintain_db - Manual" />
<meta name="twitter:description" content="Alias of ibase_maintain_db" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_maintain_db - Manual" />
<meta itemprop="description" content="Alias of ibase_maintain_db" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_maintain_db" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-modify-user.php">
          fbird_modify_user &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-gen-id.php">
          &laquo; fbird_gen_id        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-maintain-db.php' selected="selected">English</option>
            <option value='de/function.fbird-maintain-db.php'>German</option>
            <option value='es/function.fbird-maintain-db.php'>Spanish</option>
            <option value='fr/function.fbird-maintain-db.php'>French</option>
            <option value='it/function.fbird-maintain-db.php'>Italian</option>
            <option value='ja/function.fbird-maintain-db.php'>Japanese</option>
            <option value='pt_BR/function.fbird-maintain-db.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-maintain-db.php'>Russian</option>
            <option value='tr/function.fbird-maintain-db.php'>Turkish</option>
            <option value='uk/function.fbird-maintain-db.php'>Ukrainian</option>
            <option value='zh/function.fbird-maintain-db.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-maintain-db" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_maintain_db</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_maintain_db</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-maintain-db.php" class="function">ibase_maintain_db()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-maintain-db-description">
  ...
  <p class="simpara">
   ...
   <span class="function"><a href="function.ibase-maintain-db.php" class="function">ibase_maintain_db()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-maintain-db.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-maintain-db%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-maintain-db&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-maintain-db.php">＋<small>add a note</small></a></span>
