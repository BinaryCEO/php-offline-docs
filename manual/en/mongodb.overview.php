...
<head>
  ...
  <title>PHP: Architecture - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb.overview.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb.overview.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb.overview.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.architecture.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb.architecture.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb.connection-handling.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mongodb.overview.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/mongodb.overview.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/mongodb.overview.php" hreflang="uk">
...
<meta name="twitter:title" content="PHP: Architecture - Manual" />
<meta name="twitter:description" content="Architecture Overview" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Architecture - Manual" />
<meta itemprop="description" content="Architecture Overview" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Architecture Overview" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb.architecture.php">
          &laquo; Driver Architecture and Internals        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb.overview.php' selected="selected">English</option>
            <option value='de/mongodb.overview.php'>German</option>
            <option value='es/mongodb.overview.php'>Spanish</option>
            <option value='fr/mongodb.overview.php'>French</option>
            <option value='it/mongodb.overview.php'>Italian</option>
            <option value='ja/mongodb.overview.php'>Japanese</option>
            <option value='pt_BR/mongodb.overview.php'>Brazilian Portuguese</option>
            <option value='ru/mongodb.overview.php'>Russian</option>
            <option value='tr/mongodb.overview.php'>Turkish</option>
            <option value='uk/mongodb.overview.php'>Ukrainian</option>
            <option value='zh/mongodb.overview.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mongodb.overview" class="section">
    ...
    <caption><strong>Driver Source Code and JIRA Projects</strong></caption>
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb.overview%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb.overview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb.overview.php">＋<small>add a note</small></a></span>
