...
<div class="phpcode"><code><span class="html">Unfortunate that pg_fetch_all_columns() doesn't support fetching a column by its name -- if you want to do that, you'll need to use pg_field_num() as an intermediary:<br /><br />For example:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">if (</span><span class="default">$foo</span><span class="keyword">)<br />  </span><span class="default">$cols </span><span class="keyword">= </span><span class="string">"email_address"</span><span class="keyword">;<br /><br />else<br />  </span><span class="default">$cols </span><span class="keyword">= </span><span class="string">"last_name, middle_init"</span><span class="keyword">;<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">pg_query</span><span class="keyword">(</span><span class="string">"Select first_name, </span><span class="default">$info</span><span class="string">, birthday from users_table"</span><span class="keyword">);<br /><br /></span><span class="comment">// Problem -- does column #2 refer to the 'birthday' or 'middle_init' field?<br /></span><span class="default">$array </span><span class="keyword">= </span><span class="default">pg_fetch_all_columns</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br /><br /></span><span class="comment">// Won't work, must use a column number instead of its name<br /></span><span class="default">$array </span><span class="keyword">= </span><span class="default">pg_fetch_all_columns</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="string">'birthday'</span><span class="keyword">);<br /><br /></span><span class="comment">// Works<br /></span><span class="default">$array </span><span class="keyword">= </span><span class="default">pg_fetch_all_columns</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">pg_field_num</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="string">'birthday'</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>spambin at ya dot ru</em></strong></a><a class="genanchor" href="#113723"> &para;</a><div class="date" title="2013-11-21 11:48"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113723">
<div class="phpcode"><code><span class="html">pg_fetch_all_columns() returns array (empty array) even if the result set in empty (while pg_fetch_all() returns FALSE when the result set is empty)<br /><br />&lt;?<br />$result = pg_query("<br />    SELECT 'something'<br />    WHERE 1 = 2<br />");<br />var_dump( pg_fetch_all($result) ); // boolean false<br />var_dump( pg_fetch_all_columns($result) ); // array(0){}<br />?&gt;</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>massiv at nerdshack dot com</em></strong></a><a class="genanchor" href="#86502"> &para;</a><div class="date" title="2008-10-22 05:56"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86502">
<div class="phpcode"><code><span class="html">php 4 equivalent:<br /><br /><span class="default">&lt;?php <br />$conn </span><span class="keyword">= </span><span class="default">pg_pconnect</span><span class="keyword">(</span><span class="string">"dbname=publisher"</span><span class="keyword">);<br />if (!</span><span class="default">$conn</span><span class="keyword">) {<br />  echo </span><span class="string">"An error occured.\n"</span><span class="keyword">;<br />  exit;<br />}<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">pg_query</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">"SELECT title, name, address FROM authors"</span><span class="keyword">);<br />if (!</span><span class="default">$result</span><span class="keyword">) {<br />  echo </span><span class="string">"An error occured.\n"</span><span class="keyword">;<br />  exit;<br />}<br /><br /></span><span class="comment">// Get an array of all author names<br /></span><span class="default">$arr </span><span class="keyword">= array();<br />while (</span><span class="default">$line </span><span class="keyword">= </span><span class="default">pg_fetch_array</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">)) {<br />  </span><span class="default">array_push</span><span class="keyword">(</span><span class="default">$arr</span><span class="keyword">, </span><span class="default">$line</span><span class="keyword">[</span><span class="string">'name'</span><span class="keyword">]);<br />}<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$arr</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
