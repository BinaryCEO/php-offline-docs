...
<head>
  ...
  <title>PHP: Transactions and auto-commit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdo.transactions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdo.transactions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdo.transactions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.pdo.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdo.connections.php">
 <link rel="next" href="https://www.php.net/manual/en/pdo.prepared-statements.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/pdo.transactions.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/pdo.transactions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pdo.transactions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pdo.transactions.php" hreflang="uk">
...
<meta name="Description" content="Transactions and auto-commit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Transactions and auto-commit - Manual" />
<meta name="twitter:description" content="Transactions and auto-commit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Transactions and auto-commit - Manual" />
<meta itemprop="description" content="Transactions and auto-commit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Transactions and auto-commit" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdo.prepared-statements.php">
          Prepared statements and stored procedures &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdo.connections.php">
          &laquo; Connections and Connection management        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdo.transactions.php' selected="selected">English</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">beginTransaction</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">exec</span><span style="color: #007700">(</span><span style="color: #DD0000">"INSERT INTO users (name) VALUES ('Rasmus')"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">exec</span><span style="color: #007700">(</span><span style="color: #DD0000">"CREATE TABLE test (id INT PRIMARY KEY)"</span><span style="color: #007700">); </span><span style="color: #FF8000">// Implicit COMMIT occurs here<br /></span><span style="color: #0000BB">$pdo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">rollBack</span><span style="color: #007700">(); </span><span style="color: #FF8000">// This will NOT undo the INSERT/CREATE for MySQL or Oracle<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <p class="para">
  <div class="example" id="example-1116"><p><strong>Example #2 Executing a batch in a transaction</strong></p>
  ...
  documentation provided by your database server.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/transactions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdo.transactions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdo.transactions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdo.transactions.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127219">  <div class="votes">
    <div id="Vu127219">
    <a href="/manual/vote-note.php?id=127219&amp;page=pdo.transactions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127219">
    <a href="/manual/vote-note.php?id=127219&amp;page=pdo.transactions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127219" title="65% like this...">
    6
    </div>
  </div>
  <a href="#127219" class="name">
  <strong class="user"><em>hooby404 at gmail dot com</em></strong></a><a class="genanchor" href="#127219"> &para;</a><div class="date" title="2022-07-05 08:08"><strong>3 years ago</strong></div>
  <div class="text" id="Hcom127219">
<div class="phpcode"><code><span class="html">&gt; You're not limited to making updates in a transaction; you can also issue complex <br />&gt; queries to extract data, and possibly use that information to build up more updates <br />&gt; and queries; while the transaction is active, you are guaranteed that no one else can <br />&gt; make changes while you are in the middle of your work. For further reading on <br />&gt; transactions, refer to the documentation provided by your database server. <br /><br />This only holds true if you specifically do "SELECT .... FOR UPDATE". <br /><br />Without the "FOR UPDATE" part, when two transactions run at the same time, the second transaction could change a value AFTER the first transaction read it, but BEFORE the first transaction used it for updates.<br /><br />Without the "FOR UPDATE" part you are absolutely NOT GUARANTEED that no one else can make changes while you are in the middle of your work.</span></code></div>
  </div>
 </div>
  <div class="note" id="122037">  <div class="votes">
    <div id="Vu122037">
    <a href="/manual/vote-note.php?id=122037&amp;page=pdo.transactions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122037">
    <a href="/manual/vote-note.php?id=122037&amp;page=pdo.transactions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122037" title="54% like this...">
    4
    </div>
  </div>
  <a href="#122037" class="name">
  <strong class="user"><em>harl at gmail dot com</em></strong></a><a class="genanchor" href="#122037"> &para;</a><div class="date" title="2017-12-18 03:11"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122037">
<div class="phpcode"><code><span class="html">Some DBMSs allow DDL (table creation/alteration) within transactions, some do not. Asking "Does my DBMS allow DDL within transactions without forcing a commit?" gives the following example answers:<br /><br />CUBRID: Yes<br />DB2 UDB: Yes<br />Firebird: Yes<br />Informix: Yes<br />MySQL: No<br />Oracle: No (although schema upgrades can be rolled out using "edition-based redefinition")<br />PostgreSQL: Yes<br />SQLite: Yes<br />SQL Server: Sometimes, depending on isolation level, type of command, etc.<br />Sybase: Yes</span></code></div>
  </div>
 </div>
  <div class="note" id="110483">  <div class="votes">
    <div id="Vu110483">
    <a href="/manual/vote-note.php?id=110483&amp;page=pdo.transactions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110483">
    <a href="/manual/vote-note.php?id=110483&amp;page=pdo.transactions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110483" title="51% like this...">
    3
    </div>
  </div>
  <a href="#110483" class="name">
  <strong class="user"><em>pasamio at gmail dot com</em></strong></a><a class="genanchor" href="#110483"> &para;</a><div class="date" title="2012-10-26 07:25"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110483">
<div class="phpcode"><code><span class="html">Typically data definition language clauses (DDL) will trigger the database engine to automatically commit:<br /><a href="http://dev.mysql.com/doc/refman/5.0/en/implicit-commit.html" rel="nofollow" target="_blank">http://dev.mysql.com/doc/refman/5.0/en/implicit-commit.html</a><br /><br />Many other databases (e.g. Oracle) will implicitly commit before and after running DDL statements.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=pdo.transactions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdo.transactions.php">＋<small>add a note</small></a></div>
