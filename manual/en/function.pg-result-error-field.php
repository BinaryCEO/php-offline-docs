...
<head>
  ...
  <title>PHP: pg_result_error_field - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-result-error-field.php">
 <link rel="shorturl" href="https://www.php.net/pg-result-error-field">
 <link rel="alternate" href="https://www.php.net/pg-result-error-field" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-result-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-result-memory-size.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-result-error-field.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-result-error-field.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-result-error-field.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-result-error-field.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-result-error-field.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-result-error-field.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-result-error-field.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-result-error-field.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-result-error-field.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-result-error-field.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-result-error-field.php" hreflang="zh">
...
<meta name="Description" content="Returns an individual field of an error report" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_result_error_field - Manual" />
<meta name="twitter:description" content="Returns an individual field of an error report" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_result_error_field - Manual" />
<meta itemprop="description" content="Returns an individual field of an error report" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an individual field of an error report" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-result-memory-size.php">
          pg_result_memory_size &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-result-error.php">
          &laquo; pg_result_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-result-error-field.php' selected="selected">English</option>
            <option value='de/function.pg-result-error-field.php'>German</option>
            <option value='es/function.pg-result-error-field.php'>Spanish</option>
            <option value='fr/function.pg-result-error-field.php'>French</option>
            <option value='it/function.pg-result-error-field.php'>Italian</option>
            <option value='ja/function.pg-result-error-field.php'>Japanese</option>
            <option value='pt_BR/function.pg-result-error-field.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-result-error-field.php'>Russian</option>
            <option value='tr/function.pg-result-error-field.php'>Turkish</option>
            <option value='uk/function.pg-result-error-field.php'>Ukrainian</option>
            <option value='zh/function.pg-result-error-field.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-result-error-field" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_result_error_field</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_result_error_field</span> &mdash; <span class="dc-title">Returns an individual field of an error report</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-result-error-field-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_result_error_field</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field_code</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_result_error_field()</strong></span> returns one of the detailed error message
   fields associated with <code class="parameter">result</code> instance. It is only available
   against a PostgreSQL 7.4 or above server.  The error field is specified by
   the <code class="parameter">field_code</code>.
  </p>
  <p class="para">
   Because <span class="function"><a href="function.pg-query.php" class="function">pg_query()</a></span> and <span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the query fails,
  ...
  <p class="para">
   If you need to get additional error information from failed <span class="function"><a href="function.pg-query.php" class="function">pg_query()</a></span> queries,  
   use <span class="function"><a href="function.pg-set-error-verbosity.php" class="function">pg_set_error_verbosity()</a></span> and <span class="function"><a href="function.pg-last-error.php" class="function">pg_last_error()</a></span>
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
     ...
     <dt><code class="parameter">field_code</code></dt>
     <dd>
        <p class="para">
         Possible <code class="parameter">field_code</code> values are: <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-severity">PGSQL_DIAG_SEVERITY</a></code></strong>,
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-sqlstate">PGSQL_DIAG_SQLSTATE</a></code></strong>, <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-message-primary">PGSQL_DIAG_MESSAGE_PRIMARY</a></code></strong>,
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-message-detail">PGSQL_DIAG_MESSAGE_DETAIL</a></code></strong>,
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-message-hint">PGSQL_DIAG_MESSAGE_HINT</a></code></strong>, <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-statement-position">PGSQL_DIAG_STATEMENT_POSITION</a></code></strong>,
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-internal-position">PGSQL_DIAG_INTERNAL_POSITION</a></code></strong> (PostgreSQL 8.0+ only),
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-internal-query">PGSQL_DIAG_INTERNAL_QUERY</a></code></strong> (PostgreSQL 8.0+ only),
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-context">PGSQL_DIAG_CONTEXT</a></code></strong>, <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-source-file">PGSQL_DIAG_SOURCE_FILE</a></code></strong>,
         <strong><code><a href="pgsql.constants.php#constant.pgsql-diag-source-line">PGSQL_DIAG_SOURCE_LINE</a></code></strong> or
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-result-error-field-returnvalues">
  ...
  <p class="para">A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the contents of the error field, <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if the field does not exist or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
  on failure.</p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-result-error-field-changelog">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-result-error.php" class="function" rel="rdfs-seeAlso">pg_result_error()</a> - Get error message associated with result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-result-error-field.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-result-error-field%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-result-error-field&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-error-field.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128769">  <div class="votes">
    <div id="Vu128769">
    <a href="/manual/vote-note.php?id=128769&amp;page=function.pg-result-error-field&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128769">
    <a href="/manual/vote-note.php?id=128769&amp;page=function.pg-result-error-field&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128769" title="no votes...">
    0
    </div>
  </div>
  <a href="#128769" class="name">
  <strong class="user"><em>dev at gwouite dot fr</em></strong></a><a class="genanchor" href="#128769"> &para;</a><div class="date" title="2023-07-30 09:23"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128769">
<div class="phpcode"><code><span class="html">Complete list of field codes from libpq documentation...<br /><br />Warning : they are prefixed with "PG_", just change to "PGSQL_" and they'll be available as defined PHP values.<br /><br />For me, most importants fields are suffixed with a star ;)<br /><br />PG_DIAG_SEVERITY<br />PG_DIAG_SEVERITY_NONLOCALIZED  *<br />PG_DIAG_SQLSTATE  *<br />PG_DIAG_MESSAGE_PRIMARY<br />PG_DIAG_MESSAGE_DETAIL<br />PG_DIAG_MESSAGE_HINT<br />PG_DIAG_STATEMENT_POSITION<br />PG_DIAG_INTERNAL_POSITION<br />PG_DIAG_INTERNAL_QUERY<br />PG_DIAG_CONTEXT<br />PG_DIAG_SCHEMA_NAME  *<br />PG_DIAG_TABLE_NAME  *<br />PG_DIAG_COLUMN_NAME  *<br />PG_DIAG_DATATYPE_NAME  *<br />PG_DIAG_CONSTRAINT_NAME<br />PG_DIAG_SOURCE_FILE<br />PG_DIAG_SOURCE_LINE<br />PG_DIAG_SOURCE_FUNCTION<br /><br />Source and field codes details : <a href="https://www.postgresql.org/docs/current/libpq-exec.html" rel="nofollow" target="_blank">https://www.postgresql.org/docs/current/libpq-exec.html</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-result-error-field&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-result-error-field.php">＋<small>add a note</small></a></div>
