...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rewind.php">
 <link rel="shorturl" href="https://www.php.net/rewind">
 <link rel="alternate" href="https://www.php.net/rewind" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rmdir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rewind.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rewind.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rewind.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rewind.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rewind.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rewind.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rewind.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rewind.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rewind.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rewind.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rewind.php" hreflang="zh">
...
<meta name="Description" content="Rewind the position of a file pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rewind - Manual" />
<meta name="twitter:description" content="Rewind the position of a file pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rewind - Manual" />
<meta itemprop="description" content="Rewind the position of a file pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rewind the position of a file pointer" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rewind.php' selected="selected">English</option>
            <option value='de/function.rewind.php'>German</option>
            <option value='es/function.rewind.php'>Spanish</option>
            <option value='fr/function.rewind.php'>French</option>
            <option value='it/function.rewind.php'>Italian</option>
            <option value='ja/function.rewind.php'>Japanese</option>
            <option value='pt_BR/function.rewind.php'>Brazilian Portuguese</option>
            <option value='ru/function.rewind.php'>Russian</option>
            <option value='tr/function.rewind.php'>Turkish</option>
            <option value='uk/function.rewind.php'>Ukrainian</option>
            <option value='zh/function.rewind.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rewind" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">rewind</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">rewind</span> &mdash; <span class="dc-title">Rewind the position of a file pointer</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.rewind-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>rewind</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets the file position indicator for <code class="parameter">stream</code>
 ...
 <div class="refsect1 parameters" id="refsect1-function.rewind-parameters">
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       successfully opened by <span class="function"><a href="function.fopen.php" class="function">fopen()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.rewind-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.rewind-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2421">
    <p><strong>Example #1 <span class="function"><strong>rewind()</strong></span> overwriting example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Foolly long sentence.</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.rewind-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fwrite.php" class="function" rel="rdfs-seeAlso">fwrite()</a> - Binary-safe file write</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/rewind.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rewind%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rewind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rewind.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="79427">  <div class="votes">
    <div id="Vu79427">
    <a href="/manual/vote-note.php?id=79427&amp;page=function.rewind&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79427">
    <a href="/manual/vote-note.php?id=79427&amp;page=function.rewind&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79427" title="62% like this...">
    12
    </div>
  </div>
  <a href="#79427" class="name">
  <strong class="user"><em>MagicalTux at kinoko dot fr</em></strong></a><a class="genanchor" href="#79427"> &para;</a><div class="date" title="2007-11-26 10:53"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79427">
<div class="phpcode"><code><span class="html">Note that rewind($fd) is exactly the same as fseek($fd, 0, SEEK_SET)<br /><br />rewind() just moves the location inside the file to the beginning, nothing more. Check if your stream is "seekable" before planning to use fseek/rewind.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.rewind&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rewind.php">＋<small>add a note</small></a></div>
