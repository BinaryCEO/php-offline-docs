...
<head>
  ...
  <title>PHP: pg_parameter_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-parameter-status.php">
 <link rel="shorturl" href="https://www.php.net/pg-parameter-status">
 <link rel="alternate" href="https://www.php.net/pg-parameter-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-options.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-pconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-parameter-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-parameter-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-parameter-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-parameter-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-parameter-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-parameter-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-parameter-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-parameter-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-parameter-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-parameter-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-parameter-status.php" hreflang="zh">
...
<meta name="Description" content="Looks up a current parameter setting of the server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_parameter_status - Manual" />
<meta name="twitter:description" content="Looks up a current parameter setting of the server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_parameter_status - Manual" />
<meta itemprop="description" content="Looks up a current parameter setting of the server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Looks up a current parameter setting of the server" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-parameter-status.php' selected="selected">English</option>
            <option value='de/function.pg-parameter-status.php'>German</option>
            <option value='es/function.pg-parameter-status.php'>Spanish</option>
            <option value='fr/function.pg-parameter-status.php'>French</option>
            <option value='it/function.pg-parameter-status.php'>Italian</option>
            <option value='ja/function.pg-parameter-status.php'>Japanese</option>
            <option value='pt_BR/function.pg-parameter-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-parameter-status.php'>Russian</option>
            <option value='tr/function.pg-parameter-status.php'>Turkish</option>
            <option value='uk/function.pg-parameter-status.php'>Ukrainian</option>
            <option value='zh/function.pg-parameter-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-parameter-status" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pg-parameter-status-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_parameter_status</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$param_name</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <p class="para">
    ...
    parameter if known, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the parameter is not known.
  </p>
  <p class="para">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-parameter-status-returnvalues">
  ...
  <p class="para">A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the value of the parameter, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure or invalid
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-parameter-status-examples">
  ...
  <p class="para">
   <div class="example" id="example-2097">
...
<div class="examplescode"><pre class="examplescode">Server encoding: SQL_ASCII</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-parameter-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-parameter-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-parameter-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-parameter-status.php">＋<small>add a note</small></a></span>
