...
<head>
  ...
  <title>PHP: Character sets - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlinfo.concepts.charset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlinfo.concepts.charset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.concepts.charset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqlinfo.concepts.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlinfo.concepts.buffering.php">
 <link rel="next" href="https://www.php.net/manual/en/book.mysqli.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlinfo.concepts.charset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlinfo.concepts.charset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlinfo.concepts.charset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlinfo.concepts.charset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlinfo.concepts.charset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlinfo.concepts.charset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlinfo.concepts.charset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlinfo.concepts.charset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlinfo.concepts.charset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlinfo.concepts.charset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlinfo.concepts.charset.php" hreflang="zh">
...
<meta name="Description" content="Character sets" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Character sets - Manual" />
<meta name="twitter:description" content="Character sets" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Character sets - Manual" />
<meta itemprop="description" content="Character sets" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Character sets" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqlinfo.concepts.buffering.php">
          &laquo; Buffered and Unbuffered queries        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlinfo.concepts.charset.php' selected="selected">English</option>
            <option value='de/mysqlinfo.concepts.charset.php'>German</option>
            <option value='es/mysqlinfo.concepts.charset.php'>Spanish</option>
            <option value='fr/mysqlinfo.concepts.charset.php'>French</option>
            <option value='it/mysqlinfo.concepts.charset.php'>Italian</option>
            <option value='ja/mysqlinfo.concepts.charset.php'>Japanese</option>
            <option value='pt_BR/mysqlinfo.concepts.charset.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlinfo.concepts.charset.php'>Russian</option>
            <option value='tr/mysqlinfo.concepts.charset.php'>Turkish</option>
            <option value='uk/mysqlinfo.concepts.charset.php'>Ukrainian</option>
            <option value='zh/mysqlinfo.concepts.charset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlinfo.concepts.charset" class="section">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mysqli </span><span style="color: #007700">= new </span><span style="color: #0000BB">mysqli</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_password"</span><span style="color: #007700">, </span><span style="color: #DD0000">"world"</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #DD0000">'Initial character set: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">character_set_name</span><span style="color: #007700">() . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /><br />if (!</span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">set_charset</span><span style="color: #007700">(</span><span style="color: #DD0000">'utf8mb4'</span><span style="color: #007700">)) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Error loading character set utf8mb4: %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">error</span><span style="color: #007700">);<br />    exit;<br />}<br /><br />echo </span><span style="color: #DD0000">'Your current character set is: ' </span><span style="color: #007700">. </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">character_set_name</span><span style="color: #007700">() . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="example" id="example-1546">
   <p><strong>Example #3 Setting the character set example: <a href="ref.pdo-mysql.connection.php" class="link">pdo_mysql</a></strong></p>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pdo </span><span style="color: #007700">= new </span><span style="color: #0000BB">PDO</span><span style="color: #007700">(</span><span style="color: #DD0000">"mysql:host=localhost;dbname=world;charset=utf8mb4"</span><span style="color: #007700">, </span><span style="color: #DD0000">'my_user'</span><span style="color: #007700">, </span><span style="color: #DD0000">'my_pass'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlinfo.concepts.charset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlinfo.concepts.charset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.concepts.charset.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121888">  <div class="votes">
    <div id="Vu121888">
    <a href="/manual/vote-note.php?id=121888&amp;page=mysqlinfo.concepts.charset&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121888">
    <a href="/manual/vote-note.php?id=121888&amp;page=mysqlinfo.concepts.charset&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121888" title="80% like this...">
    22
    </div>
  </div>
  <a href="#121888" class="name">
  <strong class="user"><em>mkroese at eljakim dot nl</em></strong></a><a class="genanchor" href="#121888"> &para;</a><div class="date" title="2017-11-21 06:44"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121888">
<div class="phpcode"><code><span class="html">Please note that MySQL's utf8 encoding has a maximum of 3 bytes and is unable to encode *all* unicode characters.<br /><br />If you need to encode characters beyond the BMP (Basic Multilingual Plane), like emoji or other special characters, you will need to use a different encoding like utf8mb4 or any other encoding supporting the higher planes. Mysql will discard any characters encoded in 4 bytes (or more).<br /><br />See <a href="https://dev.mysql.com/doc/refman/5.7/en/charset-unicode-utf8mb4.html" rel="nofollow" target="_blank">https://dev.mysql.com/doc/refman/5.7/en/charset-unicode-utf8mb4.html</a> for more information on the matter</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqlinfo.concepts.charset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlinfo.concepts.charset.php">＋<small>add a note</small></a></div>
