...
<head>
  ...
  <title>PHP: ps_setdash - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setdash.php">
 <link rel="shorturl" href="https://www.php.net/ps-setdash">
 <link rel="alternate" href="https://www.php.net/ps-setdash" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setflat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setdash.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setdash.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setdash.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setdash.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setdash.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setdash.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setdash.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setdash.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setdash.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setdash.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setdash.php" hreflang="zh">
...
<meta name="Description" content="Sets appearance of a dashed line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setdash - Manual" />
<meta name="twitter:description" content="Sets appearance of a dashed line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setdash - Manual" />
<meta itemprop="description" content="Sets appearance of a dashed line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets appearance of a dashed line" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ps-setflat.php">
          ps_setflat &raquo;
              ...
              <div class="prev">
        <a href="function.ps-setcolor.php">
          &laquo; ps_setcolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setdash.php' selected="selected">English</option>
            <option value='de/function.ps-setdash.php'>German</option>
            <option value='es/function.ps-setdash.php'>Spanish</option>
            <option value='fr/function.ps-setdash.php'>French</option>
            <option value='it/function.ps-setdash.php'>Italian</option>
            <option value='ja/function.ps-setdash.php'>Japanese</option>
            <option value='pt_BR/function.ps-setdash.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setdash.php'>Russian</option>
            <option value='tr/function.ps-setdash.php'>Turkish</option>
            <option value='uk/function.ps-setdash.php'>Ukrainian</option>
            <option value='zh/function.ps-setdash.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setdash" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setdash</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setdash</span> &mdash; <span class="dc-title">Sets appearance of a dashed line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setdash-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setdash</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$on</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$off</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setdash-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">on</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">off</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setdash-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-setdash-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-setpolydash.php" class="function" rel="rdfs-seeAlso">ps_setpolydash()</a> - Sets appearance of a dashed line</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setdash.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setdash%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setdash&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setdash.php">＋<small>add a note</small></a></span>
