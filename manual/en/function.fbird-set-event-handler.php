...
<head>
  ...
  <title>PHP: fbird_set_event_handler - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-set-event-handler.php">
 <link rel="shorturl" href="https://www.php.net/fbird-set-event-handler">
 <link rel="alternate" href="https://www.php.net/fbird-set-event-handler" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-service-detach.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-trans.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-set-event-handler.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-set-event-handler.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-set-event-handler.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-set-event-handler.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-set-event-handler.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-set-event-handler.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-set-event-handler.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-set-event-handler.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-set-event-handler.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-set-event-handler.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-set-event-handler.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_set_event_handler" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_set_event_handler - Manual" />
<meta name="twitter:description" content="Alias of ibase_set_event_handler" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_set_event_handler - Manual" />
<meta itemprop="description" content="Alias of ibase_set_event_handler" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_set_event_handler" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-trans.php">
          fbird_trans &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-service-detach.php">
          &laquo; fbird_service_detach        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-set-event-handler.php' selected="selected">English</option>
            <option value='de/function.fbird-set-event-handler.php'>German</option>
            <option value='es/function.fbird-set-event-handler.php'>Spanish</option>
            <option value='fr/function.fbird-set-event-handler.php'>French</option>
            <option value='it/function.fbird-set-event-handler.php'>Italian</option>
            <option value='ja/function.fbird-set-event-handler.php'>Japanese</option>
            <option value='pt_BR/function.fbird-set-event-handler.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-set-event-handler.php'>Russian</option>
            <option value='tr/function.fbird-set-event-handler.php'>Turkish</option>
            <option value='uk/function.fbird-set-event-handler.php'>Ukrainian</option>
            <option value='zh/function.fbird-set-event-handler.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-set-event-handler" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_set_event_handler</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_set_event_handler</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-set-event-handler.php" class="function">ibase_set_event_handler()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-set-event-handler-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-set-event-handler-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-free-event-handler.php" class="function" rel="rdfs-seeAlso">fbird_free_event_handler()</a> - Alias of ibase_free_event_handler</span></li>
    <li><span class="function"><a href="function.fbird-wait-event.php" class="function" rel="rdfs-seeAlso">fbird_wait_event()</a> - Alias of ibase_wait_event</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-set-event-handler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-set-event-handler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-set-event-handler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-set-event-handler.php">＋<small>add a note</small></a></span>
