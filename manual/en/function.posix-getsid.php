...
<head>
  ...
  <title>PHP: posix_getsid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-getsid.php">
 <link rel="shorturl" href="https://www.php.net/posix-getsid">
 <link rel="alternate" href="https://www.php.net/posix-getsid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-getrlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-getuid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-getsid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-getsid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-getsid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-getsid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-getsid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-getsid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-getsid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-getsid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-getsid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-getsid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-getsid.php" hreflang="zh">
...
<meta name="Description" content="Get the current sid of the process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_getsid - Manual" />
<meta name="twitter:description" content="Get the current sid of the process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_getsid - Manual" />
<meta itemprop="description" content="Get the current sid of the process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the current sid of the process" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-getsid.php' selected="selected">English</option>
            <option value='de/function.posix-getsid.php'>German</option>
            <option value='es/function.posix-getsid.php'>Spanish</option>
            <option value='fr/function.posix-getsid.php'>French</option>
            <option value='it/function.posix-getsid.php'>Italian</option>
            <option value='ja/function.posix-getsid.php'>Japanese</option>
            <option value='pt_BR/function.posix-getsid.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-getsid.php'>Russian</option>
            <option value='tr/function.posix-getsid.php'>Turkish</option>
            <option value='uk/function.posix-getsid.php'>Ukrainian</option>
            <option value='zh/function.posix-getsid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-getsid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_getsid</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getsid</span> &mdash; <span class="dc-title">Get the current sid of the process</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.posix-getsid-description">
  ...
  <p class="para rdfs-comment">
   Return the session id of the process <code class="parameter">process_id</code>.
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       assumed.  If an invalid <code class="parameter">process_id</code> is
       specified, then <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is returned and an error is set which
       can be checked with <span class="function"><a href="function.posix-get-last-error.php" class="function">posix_get_last_error()</a></span>.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-getsid-returnvalues">
  ...
  <p class="para">
   Returns the identifier, as an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.posix-getsid-examples">
  ...
  <p class="para">
   <div class="example" id="example-3589">
    <p><strong>Example #1 Example use of <span class="function"><strong>posix_getsid()</strong></span></strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pid </span><span style="color: #007700">= </span><span style="color: #0000BB">posix_getpid</span><span style="color: #007700">();<br />echo </span><span style="color: #0000BB">posix_getsid</span><span style="color: #007700">(</span><span style="color: #0000BB">$pid</span><span style="color: #007700">); </span><span style="color: #FF8000">//8805<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.posix-getsid-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li>
     <span class="function"><a href="function.posix-getpgid.php" class="function" rel="rdfs-seeAlso">posix_getpgid()</a> - Get process group id for job control</span>
    </li>
    <li>
     <span class="function"><a href="function.posix-setsid.php" class="function" rel="rdfs-seeAlso">posix_setsid()</a> - Make the current process a session leader</span>
    </li>
    <li>POSIX man page GETSID(2)</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-getsid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-getsid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-getsid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-getsid.php">＋<small>add a note</small></a></span>
