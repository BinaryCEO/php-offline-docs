...
<head>
  ...
  <title>PHP: fann_set_activation_function - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-activation-function.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-activation-function">
 <link rel="alternate" href="https://www.php.net/fann-set-activation-function" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-scale-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-activation-function-hidden.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-activation-function.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-activation-function.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-activation-function.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-activation-function.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-activation-function.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-activation-function.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-activation-function.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-activation-function.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-activation-function.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-activation-function.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-activation-function.php" hreflang="zh">
...
<meta name="Description" content="Sets the activation function for supplied neuron and layer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_activation_function - Manual" />
<meta name="twitter:description" content="Sets the activation function for supplied neuron and layer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_activation_function - Manual" />
<meta itemprop="description" content="Sets the activation function for supplied neuron and layer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the activation function for supplied neuron and layer" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-set-activation-function-hidden.php">
          fann_set_activation_function_hidden &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-scale-train-data.php">
          &laquo; fann_scale_train_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-activation-function.php' selected="selected">English</option>
            <option value='de/function.fann-set-activation-function.php'>German</option>
            <option value='es/function.fann-set-activation-function.php'>Spanish</option>
            <option value='fr/function.fann-set-activation-function.php'>French</option>
            <option value='it/function.fann-set-activation-function.php'>Italian</option>
            <option value='ja/function.fann-set-activation-function.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-activation-function.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-activation-function.php'>Russian</option>
            <option value='tr/function.fann-set-activation-function.php'>Turkish</option>
            <option value='uk/function.fann-set-activation-function.php'>Ukrainian</option>
            <option value='zh/function.fann-set-activation-function.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-activation-function" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.fann-set-activation-function-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_activation_function</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$activation_function</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$layer</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$neuron</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Set the activation function for neuron number <code class="literal">neuron</code> in layer number
   <code class="literal">layer</code>, counting the input layer as layer 0.
  </p>
  <p class="para">
  ...
  <p class="para">
   ...
   <strong><code><a href="fann.constants.php#constant.fann-sigmoid">FANN_SIGMOID</a></code></strong> is e.g. in the 0 - 1 range while <strong><code><a href="fann.constants.php#constant.fann-sigmoid-symmetric">FANN_SIGMOID_SYMMETRIC</a></code></strong> is
   in the -1 - 1 range and <strong><code><a href="fann.constants.php#constant.fann-linear">FANN_LINEAR</a></code></strong> is unbound.
  </p>
  <p class="para">
   The supplied activation_function value must be
   one of the <a href="fann.constants.php#constants.fann-activation-funcs" class="link">activation functions</a> constants.
  </p>
  <p class="para">
   The return value is one of the <a href="fann.constants.php#constants.fann-train" class="link">activation functions</a> constants.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-activation-function-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">activation_function</code></dt>
    <dd>
     <p class="para">
      The <a href="fann.constants.php#constants.fann-activation-funcs" class="link">activation functions</a> constant.
     </p>
    </dd>
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-activation-function-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-set-activation-function-layer.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function_layer()</a> - Sets the activation function for all the neurons in the supplied layer</span></li>
    <li><span class="function"><a href="function.fann-set-activation-function-hidden.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function_hidden()</a> - Sets the activation function for all of the hidden layers</span></li>
    <li><span class="function"><a href="function.fann-set-activation-function-output.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function_output()</a> - Sets the activation function for the output layer</span></li>
    ...
    <li><span class="function"><a href="function.fann-get-activation-function.php" class="function" rel="rdfs-seeAlso">fann_get_activation_function()</a> - Returns the activation function</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-activation-function.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-activation-function%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-activation-function&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-activation-function.php">＋<small>add a note</small></a></span>
