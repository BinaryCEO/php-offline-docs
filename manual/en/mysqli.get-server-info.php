...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.get-server-info.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.get-server-info.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.get-server-info.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.get-proto-info.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.get-server-version.php">
...
<meta name="Description" content="Returns the version of the MySQL server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$server_info - Manual" />
<meta name="twitter:description" content="Returns the version of the MySQL server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$server_info - Manual" />
<meta itemprop="description" content="Returns the version of the MySQL server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the version of the MySQL server" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.get-server-info.php' selected="selected">English</option>
            <option value='de/mysqli.get-server-info.php'>German</option>
            <option value='es/mysqli.get-server-info.php'>Spanish</option>
            <option value='fr/mysqli.get-server-info.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$server_info</span> -- <span class="refname">mysqli::get_server_info</span> -- <span class="refname">mysqli_get_server_info</span> &mdash; <span class="dc-title">Returns the version of the MySQL server</span></p>
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.get-server-info-examples">
  ...
  <div class="example" id="example-1599">
   <p><strong>Example #1 <var class="varname">$mysqli->server_info</var> example</strong></p>
   <div class="example-contents"><p>Object-oriented style</p></div>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />mysqli_report</span><span style="color: #007700">(</span><span style="color: #0000BB">MYSQLI_REPORT_ERROR </span><span style="color: #007700">| </span><span style="color: #0000BB">MYSQLI_REPORT_STRICT</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$mysqli </span><span style="color: #007700">= new </span><span style="color: #0000BB">mysqli</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_password"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* print server version */<br /></span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Server version: %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">server_info</span><span style="color: #007700">);</span></span></code></div>
   </div>
...
<div class="examplescode"><pre class="examplescode">Server version: 8.0.21</pre>
</div>
   </div>
  </div>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.get-server-version.php" class="function" rel="rdfs-seeAlso">mysqli_get_server_version()</a> - Returns the version of the MySQL server as an integer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/get-server-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.get-server-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.get-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.get-server-info.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="118822">  <div class="votes">
    ...
    <div class="tally" id="V118822" title="71% like this...">
    6
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Please note that this property returns different versionstrings for MariaDB instances on LINUX and WINDOWS environments.<br /><br />For a MariaDB instance 10.0.17:<br /><br />on LINUX, this returns strings like "10.0.17-MariaDB-log"<br />on WINDOWS environments, this returns strings like "5.5.5-10.0.17-MariaDB-log"<br /><br />To avoid this extra "5.5.5" on windows environments, you could use the SQL query "select version();" rather than this property of the mysqli extension</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=mysqli.get-server-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.get-server-info.php">＋<small>add a note</small></a></div>
