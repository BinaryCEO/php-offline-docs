...
<head>
  ...
  <title>PHP: sodium_memcmp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-memcmp.php">
 <link rel="shorturl" href="https://www.php.net/sodium-memcmp">
 <link rel="alternate" href="https://www.php.net/sodium-memcmp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-increment.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-memzero.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-memcmp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-memcmp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-memcmp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-memcmp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-memcmp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-memcmp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-memcmp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-memcmp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-memcmp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-memcmp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-memcmp.php" hreflang="zh">
...
<meta name="Description" content="Test for equality in constant-time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_memcmp - Manual" />
<meta name="twitter:description" content="Test for equality in constant-time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_memcmp - Manual" />
<meta itemprop="description" content="Test for equality in constant-time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Test for equality in constant-time" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-memzero.php">
          sodium_memzero &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-increment.php">
          &laquo; sodium_increment        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-memcmp.php' selected="selected">English</option>
            <option value='de/function.sodium-memcmp.php'>German</option>
            <option value='es/function.sodium-memcmp.php'>Spanish</option>
            <option value='fr/function.sodium-memcmp.php'>French</option>
            <option value='it/function.sodium-memcmp.php'>Italian</option>
            <option value='ja/function.sodium-memcmp.php'>Japanese</option>
            <option value='pt_BR/function.sodium-memcmp.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-memcmp.php'>Russian</option>
            <option value='tr/function.sodium-memcmp.php'>Turkish</option>
            <option value='uk/function.sodium-memcmp.php'>Ukrainian</option>
            <option value='zh/function.sodium-memcmp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-memcmp" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_memcmp</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_memcmp</span> &mdash; <span class="dc-title">Test for equality in constant-time</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-memcmp-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_memcmp</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string1</code></span>, <span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string2</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Compare two strings in constant-time.
  </p>
  <p class="para">
   In practice, you almost always want to use <span class="function"><a href="function.hash-equals.php" class="function">hash_equals()</a></span> instead,
   since it provides the same logic but returns a <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> instead of an
   <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>. However, if you&#039;re using the return value of a comparison in a
   calculation that&#039;s timing-sensitive, and worried about timing leaks with bool-to-int
   conversions, <span class="function"><strong>sodium_memcmp()</strong></span> is an ideal replacement.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-memcmp-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-memcmp-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="literal">0</code> if both strings are equal; <code class="literal">-1</code> otherwise.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-memcmp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-memcmp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-memcmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-memcmp.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124198">  <div class="votes">
    <div id="Vu124198">
    <a href="/manual/vote-note.php?id=124198&amp;page=function.sodium-memcmp&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124198">
    <a href="/manual/vote-note.php?id=124198&amp;page=function.sodium-memcmp&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124198" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#124198" class="name">
  <strong class="user"><em>divinity76 at gmail dot com</em></strong></a><a class="genanchor" href="#124198"> &para;</a><div class="date" title="2019-09-15 07:17"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom124198">
<div class="phpcode"><code><span class="html">seems to me that this function does the same as the hash_equals() function. hash_equals() has nothing to do with hashes really, it is just a constant-time string equality check function, apparently like sodium_memcmp()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-memcmp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-memcmp.php">＋<small>add a note</small></a></div>
