...
<head>
  ...
  <title>PHP: ImagickDraw::push - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.push.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.push.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.push.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.poppattern.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pushclippath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.push.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.push.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.push.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.push.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.push.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.push.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.push.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.push.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.push.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.push.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.push.php" hreflang="zh">
...
<meta name="Description" content="Clones the current ImagickDraw and pushes it to the stack" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::push - Manual" />
<meta name="twitter:description" content="Clones the current ImagickDraw and pushes it to the stack" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::push - Manual" />
<meta itemprop="description" content="Clones the current ImagickDraw and pushes it to the stack" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clones the current ImagickDraw and pushes it to the stack" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagickdraw.pushclippath.php">
          ImagickDraw::pushClipPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.poppattern.php">
          &laquo; ImagickDraw::popPattern        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.push.php' selected="selected">English</option>
            <option value='de/imagickdraw.push.php'>German</option>
            <option value='es/imagickdraw.push.php'>Spanish</option>
            <option value='fr/imagickdraw.push.php'>French</option>
            <option value='it/imagickdraw.push.php'>Italian</option>
            <option value='ja/imagickdraw.push.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.push.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.push.php'>Russian</option>
            <option value='tr/imagickdraw.push.php'>Turkish</option>
            <option value='uk/imagickdraw.push.php'>Ukrainian</option>
            <option value='zh/imagickdraw.push.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.push" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::push</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::push</span> &mdash; <span class="dc-title">Clones the current ImagickDraw and pushes it to the stack</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.push-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::push</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
  ...
  <p class="para">
   ...
   returned to by invoking <span class="methodname"><a href="imagickdraw.pop.php" class="methodname">ImagickDraw::pop()</a></span>. The ImagickDraws are stored on a
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.push-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3161">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/push.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.push%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.push&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.push.php">＋<small>add a note</small></a></span>
