...
<head>
  ...
  <title>PHP: svn_repos_hotcopy - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-repos-hotcopy.php">
 <link rel="shorturl" href="https://www.php.net/svn-repos-hotcopy">
 <link rel="alternate" href="https://www.php.net/svn-repos-hotcopy" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-repos-fs-commit-txn.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-repos-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-repos-hotcopy.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-repos-hotcopy.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-repos-hotcopy.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-repos-hotcopy.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-repos-hotcopy.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-repos-hotcopy.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-repos-hotcopy.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-repos-hotcopy.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-repos-hotcopy.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-repos-hotcopy.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-repos-hotcopy.php" hreflang="zh">
...
<meta name="Description" content="Make a hot-copy of the repos at repospath; copy it to destpath" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_repos_hotcopy - Manual" />
<meta name="twitter:description" content="Make a hot-copy of the repos at repospath; copy it to destpath" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_repos_hotcopy - Manual" />
<meta itemprop="description" content="Make a hot-copy of the repos at repospath; copy it to destpath" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Make a hot-copy of the repos at repospath; copy it to destpath" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.svn-repos-open.php">
          svn_repos_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.svn-repos-fs-commit-txn.php">
          &laquo; svn_repos_fs_commit_txn        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-repos-hotcopy.php' selected="selected">English</option>
            <option value='de/function.svn-repos-hotcopy.php'>German</option>
            <option value='es/function.svn-repos-hotcopy.php'>Spanish</option>
            <option value='fr/function.svn-repos-hotcopy.php'>French</option>
            <option value='it/function.svn-repos-hotcopy.php'>Italian</option>
            <option value='ja/function.svn-repos-hotcopy.php'>Japanese</option>
            <option value='pt_BR/function.svn-repos-hotcopy.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-repos-hotcopy.php'>Russian</option>
            <option value='tr/function.svn-repos-hotcopy.php'>Turkish</option>
            <option value='uk/function.svn-repos-hotcopy.php'>Ukrainian</option>
            <option value='zh/function.svn-repos-hotcopy.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-repos-hotcopy" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">svn_repos_hotcopy</h1>
  <p class="verinfo">(PECL svn &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">svn_repos_hotcopy</span> &mdash; <span class="dc-title">Make a hot-copy of the repos at repospath; copy it to destpath</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.svn-repos-hotcopy-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>svn_repos_hotcopy</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$repospath</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$destpath</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$cleanlogs</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 notes" id="refsect1-function.svn-repos-hotcopy-notes">
...
This function should be used at your own risk.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-repos-hotcopy.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-repos-hotcopy%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-repos-hotcopy&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-repos-hotcopy.php">＋<small>add a note</small></a></span>
