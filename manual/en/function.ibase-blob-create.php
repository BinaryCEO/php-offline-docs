...
<head>
  ...
  <title>PHP: ibase_blob_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-create.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-create">
 <link rel="alternate" href="https://www.php.net/ibase-blob-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-echo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-create.php" hreflang="zh">
...
<meta name="Description" content="Create a new blob for adding data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_create - Manual" />
<meta name="twitter:description" content="Create a new blob for adding data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_create - Manual" />
<meta itemprop="description" content="Create a new blob for adding data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new blob for adding data" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-blob-echo.php">
          ibase_blob_echo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-close.php">
          &laquo; ibase_blob_close        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-create.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-create.php'>German</option>
            <option value='es/function.ibase-blob-create.php'>Spanish</option>
            <option value='fr/function.ibase-blob-create.php'>French</option>
            <option value='it/function.ibase-blob-create.php'>Italian</option>
            <option value='ja/function.ibase-blob-create.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-create.php'>Russian</option>
            <option value='tr/function.ibase-blob-create.php'>Turkish</option>
            <option value='uk/function.ibase-blob-create.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-create" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_blob_create</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_blob_create</span> &mdash; <span class="dc-title">Create a new blob for adding data</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-blob-create-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_blob_create</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>ibase_blob_create()</strong></span> creates a new BLOB for filling with
   data.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-blob-create-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-blob-create-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a BLOB handle for later use with
   <span class="function"><a href="function.ibase-blob-add.php" class="function">ibase_blob_add()</a></span> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.ibase-blob-create-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-import.php" class="function" rel="rdfs-seeAlso">ibase_blob_import()</a> - Create blob, copy file in it, and close it</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-create.php">＋<small>add a note</small></a></span>
