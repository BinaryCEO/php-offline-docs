...
<head>
  ...
  <title>PHP: ps_setflat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-setflat.php">
 <link rel="shorturl" href="https://www.php.net/ps-setflat">
 <link rel="alternate" href="https://www.php.net/ps-setflat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-setdash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-setfont.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-setflat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-setflat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-setflat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-setflat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-setflat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-setflat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-setflat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-setflat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-setflat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-setflat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-setflat.php" hreflang="zh">
...
<meta name="Description" content="Sets flatness" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_setflat - Manual" />
<meta name="twitter:description" content="Sets flatness" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_setflat - Manual" />
<meta itemprop="description" content="Sets flatness" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets flatness" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-setflat.php' selected="selected">English</option>
            <option value='de/function.ps-setflat.php'>German</option>
            <option value='es/function.ps-setflat.php'>Spanish</option>
            <option value='fr/function.ps-setflat.php'>French</option>
            <option value='it/function.ps-setflat.php'>Italian</option>
            <option value='ja/function.ps-setflat.php'>Japanese</option>
            <option value='pt_BR/function.ps-setflat.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-setflat.php'>Russian</option>
            <option value='tr/function.ps-setflat.php'>Turkish</option>
            <option value='uk/function.ps-setflat.php'>Ukrainian</option>
            <option value='zh/function.ps-setflat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-setflat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_setflat</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_setflat</span> &mdash; <span class="dc-title">Sets flatness</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-setflat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_setflat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-setflat-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <code class="parameter">value</code> must be between 0.2 and 1.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-setflat-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-setflat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-setflat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-setflat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-setflat.php">＋<small>add a note</small></a></span>
