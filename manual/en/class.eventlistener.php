...
<head>
  ...
  <title>PHP: EventListener - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.eventlistener.php">
 <link rel="shorturl" href="https://www.php.net/eventlistener">
 <link rel="alternate" href="https://www.php.net/eventlistener" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventhttprequest.sendreplystart.php">
 <link rel="next" href="https://www.php.net/manual/en/eventlistener.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.eventlistener.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.eventlistener.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.eventlistener.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.eventlistener.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.eventlistener.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.eventlistener.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.eventlistener.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.eventlistener.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.eventlistener.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.eventlistener.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.eventlistener.php" hreflang="zh">
...
<meta name="Description" content="The EventListener class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventListener - Manual" />
<meta name="twitter:description" content="The EventListener class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventListener - Manual" />
<meta itemprop="description" content="The EventListener class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The EventListener class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventlistener.construct.php">
          EventListener::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventhttprequest.sendreplystart.php">
          &laquo; EventHttpRequest::sendReplyStart        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.eventlistener.php' selected="selected">English</option>
            <option value='de/class.eventlistener.php'>German</option>
            <option value='es/class.eventlistener.php'>Spanish</option>
            <option value='fr/class.eventlistener.php'>French</option>
            <option value='it/class.eventlistener.php'>Italian</option>
            <option value='ja/class.eventlistener.php'>Japanese</option>
            <option value='pt_BR/class.eventlistener.php'>Brazilian Portuguese</option>
            <option value='ru/class.eventlistener.php'>Russian</option>
            <option value='tr/class.eventlistener.php'>Turkish</option>
            <option value='uk/class.eventlistener.php'>Ukrainian</option>
            <option value='zh/class.eventlistener.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.eventlistener" class="reference">
 <h1 class="title">The EventListener class</h1>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <code class="literal">event-1.6.0</code>
       .)
      </p>
     </dd>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       socket when the
       <span class="classname"><strong class="classname">EventListener</strong></span>
       object is freed.
      </p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="eventlistener.construct.php">EventListener::__construct</a> — Creates new connection listener associated with an event base</li><li><a href="eventlistener.disable.php">EventListener::disable</a> — Disables an event connect listener object</li><li><a href="eventlistener.enable.php">EventListener::enable</a> — Enables an event connect listener object</li><li><a href="eventlistener.getbase.php">EventListener::getBase</a> — Returns event base associated with the event listener</li><li><a href="eventlistener.getsocketname.php">EventListener::getSocketName</a> — Retreives the current address to which the
  listener's socket is bound</li><li><a href="eventlistener.setcallback.php">EventListener::setCallback</a> — The setCallback purpose</li><li><a href="eventlistener.seterrorcallback.php">EventListener::setErrorCallback</a> — Set event listener's error callback</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventlistener.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.eventlistener%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.eventlistener&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.eventlistener.php">＋<small>add a note</small></a></span>
