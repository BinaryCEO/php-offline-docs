...
<head>
  ...
  <title>PHP: Imagick::negateImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.negateimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.negateimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.negateimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.motionblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.newimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.negateimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.negateimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.negateimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.negateimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.negateimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.negateimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.negateimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.negateimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.negateimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.negateimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.negateimage.php" hreflang="zh">
...
<meta name="Description" content="Negates the colors in the reference image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::negateImage - Manual" />
<meta name="twitter:description" content="Negates the colors in the reference image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::negateImage - Manual" />
<meta itemprop="description" content="Negates the colors in the reference image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Negates the colors in the reference image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.newimage.php">
          Imagick::newImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.motionblurimage.php">
          &laquo; Imagick::motionBlurImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.negateimage.php' selected="selected">English</option>
            <option value='de/imagick.negateimage.php'>German</option>
            <option value='es/imagick.negateimage.php'>Spanish</option>
            <option value='fr/imagick.negateimage.php'>French</option>
            <option value='it/imagick.negateimage.php'>Italian</option>
            <option value='ja/imagick.negateimage.php'>Japanese</option>
            <option value='pt_BR/imagick.negateimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.negateimage.php'>Russian</option>
            <option value='tr/imagick.negateimage.php'>Turkish</option>
            <option value='uk/imagick.negateimage.php'>Ukrainian</option>
            <option value='zh/imagick.negateimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.negateimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::negateImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::negateImage</span> &mdash; <span class="dc-title">Negates the colors in the reference image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.negateimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::negateImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$gray</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.negateimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">gray</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.negateimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.negateimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3057">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/negateimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.negateimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.negateimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.negateimage.php">＋<small>add a note</small></a></span>
