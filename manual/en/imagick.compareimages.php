...
<div id="layout" class="clearfix">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.compareimages-examples">
  ...
  <p class="para">
   <div class="example" id="example-2984">
...
<div class="phpcode"><code><span class="html">If you get the following non-descriptive error message:<br /><br />Uncaught exception 'ImagickException' with message 'Compare images failed'<br /><br />Check your picture dimensions! i compared a 21x20 png to a 20x20 png which resulted in that error. Took me forever to figure out that the dimensions have to be exactly the same.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The *Absolute Error* metric is not listed as an available metric constant. However, you can still use it if needed by passing the internal constant definition for AE which is 1. This is useful when you wish to compare using a desired fuzz factor. Example:<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// init the image objects<br /></span><span class="default">$image1 </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">();<br /></span><span class="default">$image2 </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">();<br /><br /></span><span class="comment">// set the fuzz factor (must be done BEFORE reading in the images)<br /></span><span class="default">$image1</span><span class="keyword">-&gt;</span><span class="default">SetOption</span><span class="keyword">(</span><span class="string">'fuzz'</span><span class="keyword">, </span><span class="string">'2%'</span><span class="keyword">);<br /><br /></span><span class="comment">// read in the images<br /></span><span class="default">$image1</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">"php_step29_actual.png"</span><span class="keyword">);<br /></span><span class="default">$image2</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">"php_step29_correct.png"</span><span class="keyword">);<br /><br /></span><span class="comment">// compare the images using METRIC=1 (Absolute Error)<br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">$image1</span><span class="keyword">-&gt;</span><span class="default">compareImages</span><span class="keyword">(</span><span class="default">$image2</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br /><br /></span><span class="comment">// print out the result<br /></span><span class="keyword">echo </span><span class="string">"The image comparison 2% Fuzz factor is: " </span><span class="keyword">. </span><span class="default">$result</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">];<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
