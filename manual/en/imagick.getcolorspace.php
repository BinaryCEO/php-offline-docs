...
<head>
  ...
  <title>PHP: Imagick::getColorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getcolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getcolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.gaussianblurimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getcompression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getcolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getcolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getcolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getcolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getcolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getcolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getcolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getcolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getcolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getcolorspace.php" hreflang="zh">
...
<meta name="Description" content="Gets the colorspace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getColorspace - Manual" />
<meta name="twitter:description" content="Gets the colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getColorspace - Manual" />
<meta itemprop="description" content="Gets the colorspace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the colorspace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getcompression.php">
          Imagick::getCompression &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.gaussianblurimage.php">
          &laquo; Imagick::gaussianBlurImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getcolorspace.php' selected="selected">English</option>
            <option value='de/imagick.getcolorspace.php'>German</option>
            <option value='es/imagick.getcolorspace.php'>Spanish</option>
            <option value='fr/imagick.getcolorspace.php'>French</option>
            <option value='it/imagick.getcolorspace.php'>Italian</option>
            <option value='ja/imagick.getcolorspace.php'>Japanese</option>
            <option value='pt_BR/imagick.getcolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getcolorspace.php'>Russian</option>
            <option value='tr/imagick.getcolorspace.php'>Turkish</option>
            <option value='uk/imagick.getcolorspace.php'>Ukrainian</option>
            <option value='zh/imagick.getcolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getcolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getColorspace</h1>
  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getColorspace</span> &mdash; <span class="dc-title">Gets the colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getcolorspace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getColorspace</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getcolorspace-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getcolorspace-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an integer which can be compared against <a href="imagick.constants.php#imagick.constants.colorspace" class="link">COLORSPACE constants</a>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getcolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getcolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getcolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getcolorspace.php">＋<small>add a note</small></a></span>
