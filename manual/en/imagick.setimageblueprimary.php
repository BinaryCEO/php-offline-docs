...
<head>
  ...
  <title>PHP: Imagick::setImageBluePrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagebiasquantum.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimageblueprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimageblueprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimageblueprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimageblueprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimageblueprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimageblueprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimageblueprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimageblueprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimageblueprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimageblueprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimageblueprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setImageBluePrimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity blue primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageBluePrimary - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagebordercolor.php">
          Imagick::setImageBorderColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagebiasquantum.php">
          &laquo; Imagick::setImageBiasQuantum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimageblueprimary.php' selected="selected">English</option>
            <option value='de/imagick.setimageblueprimary.php'>German</option>
            <option value='es/imagick.setimageblueprimary.php'>Spanish</option>
            <option value='fr/imagick.setimageblueprimary.php'>French</option>
            <option value='it/imagick.setimageblueprimary.php'>Italian</option>
            <option value='ja/imagick.setimageblueprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.setimageblueprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimageblueprimary.php'>Russian</option>
            <option value='tr/imagick.setimageblueprimary.php'>Turkish</option>
            <option value='uk/imagick.setimageblueprimary.php'>Ukrainian</option>
            <option value='zh/imagick.setimageblueprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimageblueprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageBluePrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageBluePrimary</span> &mdash; <span class="dc-title">Sets the image chromaticity blue primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimageblueprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageBluePrimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimageblueprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimageblueprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimageblueprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimageblueprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimageblueprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimageblueprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimageblueprimary.php">＋<small>add a note</small></a></span>
