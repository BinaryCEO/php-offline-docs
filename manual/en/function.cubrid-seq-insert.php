...
<head>
  ...
  <title>PHP: cubrid_seq_insert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-seq-insert.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-seq-insert">
 <link rel="alternate" href="https://www.php.net/cubrid-seq-insert" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-seq-drop.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-seq-put.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-seq-insert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-seq-insert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-seq-insert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-seq-insert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-seq-insert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-seq-insert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-seq-insert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-seq-insert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-seq-insert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-seq-insert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-seq-insert.php" hreflang="zh">
...
<meta name="Description" content="Insert an element to a sequence type column using OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_seq_insert - Manual" />
<meta name="twitter:description" content="Insert an element to a sequence type column using OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_seq_insert - Manual" />
<meta itemprop="description" content="Insert an element to a sequence type column using OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Insert an element to a sequence type column using OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-seq-put.php">
          cubrid_seq_put &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-seq-drop.php">
          &laquo; cubrid_seq_drop        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-seq-insert.php' selected="selected">English</option>
            <option value='de/function.cubrid-seq-insert.php'>German</option>
            <option value='es/function.cubrid-seq-insert.php'>Spanish</option>
            <option value='fr/function.cubrid-seq-insert.php'>French</option>
            <option value='it/function.cubrid-seq-insert.php'>Italian</option>
            <option value='ja/function.cubrid-seq-insert.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-seq-insert.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-seq-insert.php'>Russian</option>
            <option value='tr/function.cubrid-seq-insert.php'>Turkish</option>
            <option value='uk/function.cubrid-seq-insert.php'>Ukrainian</option>
            <option value='zh/function.cubrid-seq-insert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-seq-insert" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_seq_insert</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_seq_insert</span> &mdash; <span class="dc-title">Insert an element to a sequence type column using OID</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-seq-insert-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_seq_insert</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$oid</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$attr_name</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$index</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$seq_element</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_col_insert()</strong></span> function is used to insert an
    element to a sequence type attribute in a requested location.
  </p>
 </div>


<div class="refsect1 parameters" id="refsect1-function.cubrid-seq-insert-parameters">
  ...
  <dd><p class="para">Name of the attribute you want to insert an instance to.</p></dd>
   
   
  <dt><code class="parameter">index</code></dt>
  <dd><p class="para">Location of the element, you want to insert the element to (1-based).</p></dd>
   
  
  <dt><code class="parameter">seq_element</code></dt>
  <dd><p class="para">Content of the element that you want to insert.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.cubrid-seq-insert-returnvalues">
...
array(5) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-seq-insert-seealso">
   ...
   <ul class="simplelist"> 
    ...
    <li><span class="function"><a href="function.cubrid-seq-put.php" class="function" rel="rdfs-seeAlso">cubrid_seq_put()</a> - Update the element value of sequence type column using OID</span></li>   
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-seq-insert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-seq-insert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-seq-insert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-seq-insert.php">＋<small>add a note</small></a></span>
