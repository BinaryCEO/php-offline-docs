...
<head>
  ...
  <title>PHP: Imagick::getImageFilename - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagefilename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagefilename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagefilename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageextrema.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagefilename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagefilename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagefilename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagefilename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagefilename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagefilename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagefilename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagefilename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagefilename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagefilename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagefilename.php" hreflang="zh">
...
<meta name="Description" content="Returns the filename of a particular image in a sequence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageFilename - Manual" />
<meta name="twitter:description" content="Returns the filename of a particular image in a sequence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageFilename - Manual" />
<meta itemprop="description" content="Returns the filename of a particular image in a sequence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the filename of a particular image in a sequence" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageformat.php">
          Imagick::getImageFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageextrema.php">
          &laquo; Imagick::getImageExtrema        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagefilename.php' selected="selected">English</option>
            <option value='de/imagick.getimagefilename.php'>German</option>
            <option value='es/imagick.getimagefilename.php'>Spanish</option>
            <option value='fr/imagick.getimagefilename.php'>French</option>
            <option value='it/imagick.getimagefilename.php'>Italian</option>
            <option value='ja/imagick.getimagefilename.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagefilename.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagefilename.php'>Russian</option>
            <option value='tr/imagick.getimagefilename.php'>Turkish</option>
            <option value='uk/imagick.getimagefilename.php'>Ukrainian</option>
            <option value='zh/imagick.getimagefilename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagefilename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageFilename</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageFilename</span> &mdash; <span class="dc-title">Returns the filename of a particular image in a sequence</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagefilename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageFilename</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagefilename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagefilename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagefilename-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagefilename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagefilename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagefilename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagefilename.php">＋<small>add a note</small></a></span>
