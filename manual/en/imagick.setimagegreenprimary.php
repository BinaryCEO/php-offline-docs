...
<head>
  ...
  <title>PHP: Imagick::setImageGreenPrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagegravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagegreenprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagegreenprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagegreenprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagegreenprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagegreenprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagegreenprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagegreenprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagegreenprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagegreenprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagegreenprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagegreenprimary.php" hreflang="zh">
...
<meta name="Description" content="Sets the image chromaticity green primary point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageGreenPrimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity green primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageGreenPrimary - Manual" />
<meta itemprop="description" content="Sets the image chromaticity green primary point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image chromaticity green primary point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageindex.php">
          Imagick::setImageIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagegravity.php">
          &laquo; Imagick::setImageGravity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagegreenprimary.php' selected="selected">English</option>
            <option value='de/imagick.setimagegreenprimary.php'>German</option>
            <option value='es/imagick.setimagegreenprimary.php'>Spanish</option>
            <option value='fr/imagick.setimagegreenprimary.php'>French</option>
            <option value='it/imagick.setimagegreenprimary.php'>Italian</option>
            <option value='ja/imagick.setimagegreenprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagegreenprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagegreenprimary.php'>Russian</option>
            <option value='tr/imagick.setimagegreenprimary.php'>Turkish</option>
            <option value='uk/imagick.setimagegreenprimary.php'>Ukrainian</option>
            <option value='zh/imagick.setimagegreenprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagegreenprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageGreenPrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageGreenPrimary</span> &mdash; <span class="dc-title">Sets the image chromaticity green primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagegreenprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageGreenPrimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagegreenprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagegreenprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagegreenprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagegreenprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagegreenprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagegreenprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagegreenprimary.php">＋<small>add a note</small></a></span>
