...
<head>
  ...
  <title>PHP: Imagick::adaptiveBlurImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.adaptiveblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.adaptiveblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptiveblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptiveblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.adaptiveblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.adaptiveblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.adaptiveblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.adaptiveblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.adaptiveblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.adaptiveblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.adaptiveblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.adaptiveblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.adaptiveblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.adaptiveblurimage.php" hreflang="zh">
...
<meta name="Description" content="Adds adaptive blur filter to image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::adaptiveBlurImage - Manual" />
<meta name="twitter:description" content="Adds adaptive blur filter to image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::adaptiveBlurImage - Manual" />
<meta itemprop="description" content="Adds adaptive blur filter to image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds adaptive blur filter to image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.adaptiveresizeimage.php">
          Imagick::adaptiveResizeImage &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.adaptiveblurimage.php' selected="selected">English</option>
            <option value='de/imagick.adaptiveblurimage.php'>German</option>
            <option value='es/imagick.adaptiveblurimage.php'>Spanish</option>
            <option value='fr/imagick.adaptiveblurimage.php'>French</option>
            <option value='it/imagick.adaptiveblurimage.php'>Italian</option>
            <option value='ja/imagick.adaptiveblurimage.php'>Japanese</option>
            <option value='pt_BR/imagick.adaptiveblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.adaptiveblurimage.php'>Russian</option>
            <option value='tr/imagick.adaptiveblurimage.php'>Turkish</option>
            <option value='uk/imagick.adaptiveblurimage.php'>Ukrainian</option>
            <option value='zh/imagick.adaptiveblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.adaptiveblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::adaptiveBlurImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::adaptiveBlurImage</span> &mdash; <span class="dc-title">Adds adaptive blur filter to image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.adaptiveblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::adaptiveBlurImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$sigma</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.adaptiveblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.adaptiveblurimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.adaptiveblurimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.adaptiveblurimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2962">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::adaptiveBlurImage()</strong></span>:</strong></p>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-adaptiveBlurImage.gif" alt="Output of example : Using Imagick::adaptiveBlurImage()" width="120" height="67" />
     </div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.adaptiveblurimage-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="imagick.radialblurimage.php" class="function" rel="rdfs-seeAlso">Imagick::radialBlurImage()</a> - Radial blurs an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/adaptiveblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.adaptiveblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.adaptiveblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.adaptiveblurimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115628">  <div class="votes">
    <div id="Vu115628">
    <a href="/manual/vote-note.php?id=115628&amp;page=imagick.adaptiveblurimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115628">
    <a href="/manual/vote-note.php?id=115628&amp;page=imagick.adaptiveblurimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115628" title="60% like this...">
    1
    </div>
  </div>
  <a href="#115628" class="name">
  <strong class="user"><em>michael at dodwell dot us</em></strong></a><a class="genanchor" href="#115628"> &para;</a><div class="date" title="2014-08-28 12:59"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115628">
<div class="phpcode"><code><span class="html">Be aware that this function is extremely CPU intensive.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.adaptiveblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.adaptiveblurimage.php">＋<small>add a note</small></a></div>
