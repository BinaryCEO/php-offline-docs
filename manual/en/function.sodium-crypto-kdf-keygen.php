...
<head>
  ...
  <title>PHP: sodium_crypto_kdf_keygen - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-keygen.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-kdf-keygen">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-kdf-keygen" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-kx-client-session-keys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-kdf-keygen.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-kdf-keygen.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-kdf-keygen.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-kdf-keygen.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-kdf-keygen.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-kdf-keygen.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-kdf-keygen.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-kdf-keygen.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-kdf-keygen.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-kdf-keygen.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-kdf-keygen.php" hreflang="zh">
...
<meta name="Description" content="Generate a random root key for the KDF interface" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_kdf_keygen - Manual" />
<meta name="twitter:description" content="Generate a random root key for the KDF interface" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_kdf_keygen - Manual" />
<meta itemprop="description" content="Generate a random root key for the KDF interface" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a random root key for the KDF interface" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-kx-client-session-keys.php">
          sodium_crypto_kx_client_session_keys &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-kdf-derive-from-key.php">
          &laquo; sodium_crypto_kdf_derive_from_key        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-kdf-keygen.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-kdf-keygen.php'>German</option>
            <option value='es/function.sodium-crypto-kdf-keygen.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-kdf-keygen.php'>French</option>
            <option value='it/function.sodium-crypto-kdf-keygen.php'>Italian</option>
            <option value='ja/function.sodium-crypto-kdf-keygen.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-kdf-keygen.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-kdf-keygen.php'>Russian</option>
            <option value='tr/function.sodium-crypto-kdf-keygen.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-kdf-keygen.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-kdf-keygen.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-kdf-keygen" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_kdf_keygen</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_kdf_keygen</span> &mdash; <span class="dc-title">Generate a random root key for the KDF interface</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-kdf-keygen-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_kdf_keygen</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Generates a random key suitable for serving as the root key for <span class="function"><a href="function.sodium-crypto-kdf-derive-from-key.php" class="function">sodium_crypto_kdf_derive_from_key()</a></span>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-kdf-keygen-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-kdf-keygen-returnvalues">
  ...
  <p class="para">
   A random 256-bit key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-kdf-keygen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-kdf-keygen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-kdf-keygen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-kdf-keygen.php">＋<small>add a note</small></a></span>
