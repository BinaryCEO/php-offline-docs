...
<head>
  ...
  <title>PHP: cubrid_current_oid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-current-oid.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-current-oid">
 <link rel="alternate" href="https://www.php.net/cubrid-current-oid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-connect-with-url.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-disconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-current-oid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-current-oid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-current-oid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-current-oid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-current-oid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-current-oid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-current-oid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-current-oid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-current-oid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-current-oid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-current-oid.php" hreflang="zh">
...
<meta name="Description" content="Get OID of the current cursor location" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_current_oid - Manual" />
<meta name="twitter:description" content="Get OID of the current cursor location" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_current_oid - Manual" />
<meta itemprop="description" content="Get OID of the current cursor location" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get OID of the current cursor location" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-disconnect.php">
          cubrid_disconnect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-connect-with-url.php">
          &laquo; cubrid_connect_with_url        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-current-oid.php' selected="selected">English</option>
            <option value='de/function.cubrid-current-oid.php'>German</option>
            <option value='es/function.cubrid-current-oid.php'>Spanish</option>
            <option value='fr/function.cubrid-current-oid.php'>French</option>
            <option value='it/function.cubrid-current-oid.php'>Italian</option>
            <option value='ja/function.cubrid-current-oid.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-current-oid.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-current-oid.php'>Russian</option>
            <option value='tr/function.cubrid-current-oid.php'>Turkish</option>
            <option value='uk/function.cubrid-current-oid.php'>Ukrainian</option>
            <option value='zh/function.cubrid-current-oid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-current-oid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_current_oid</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_current_oid</span> &mdash; <span class="dc-title">Get OID of the current cursor location</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-current-oid-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_current_oid</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_current_oid()</strong></span> function is used to get the
    oid of the current cursor location from the query result.  To use
    <span class="function"><strong>cubrid_current_oid()</strong></span>, the query executed must be a
    updatable query, and the <strong><code>CUBRID_INCLUDE_OID</code></strong> option must be included during
    the query execution.
  </p>
 </div>


  <div class="refsect1 parameters" id="refsect1-function.cubrid-current-oid-parameters">
 ...
 <p class="para">
  ...
  <div class="refsect1 returnvalues" id="refsect1-function.cubrid-current-oid-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    Oid of current cursor location, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.cubrid-current-oid-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1228">
   <p><strong>Example #1 <span class="function"><strong>cubrid_current_oid()</strong></span> example</strong></p>
...
(
    ...
    <div class="refsect1 seealso" id="refsect1-function.cubrid-current-oid-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-execute.php" class="function" rel="rdfs-seeAlso">cubrid_execute()</a> - Execute a prepared SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-current-oid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-current-oid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-current-oid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-current-oid.php">＋<small>add a note</small></a></span>
