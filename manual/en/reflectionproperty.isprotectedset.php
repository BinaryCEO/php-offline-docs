...
<head>
  ...
  <title>PHP: ReflectionProperty::isProtectedSet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.isprotectedset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.isprotectedset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.isprotectedset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.isprotected.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.ispublic.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.isprotectedset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.isprotectedset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.isprotectedset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.isprotectedset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.isprotectedset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.isprotectedset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.isprotectedset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.isprotectedset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.isprotectedset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.isprotectedset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.isprotectedset.php" hreflang="zh">
...
<meta name="Description" content="Checks whether the property is protected for writing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::isProtectedSet - Manual" />
<meta name="twitter:description" content="Checks whether the property is protected for writing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::isProtectedSet - Manual" />
<meta itemprop="description" content="Checks whether the property is protected for writing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks whether the property is protected for writing" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionproperty.ispublic.php">
          ReflectionProperty::isPublic &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.isprotected.php">
          &laquo; ReflectionProperty::isProtected        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.isprotectedset.php' selected="selected">English</option>
            <option value='de/reflectionproperty.isprotectedset.php'>German</option>
            <option value='es/reflectionproperty.isprotectedset.php'>Spanish</option>
            <option value='fr/reflectionproperty.isprotectedset.php'>French</option>
            <option value='it/reflectionproperty.isprotectedset.php'>Italian</option>
            <option value='ja/reflectionproperty.isprotectedset.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.isprotectedset.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.isprotectedset.php'>Russian</option>
            <option value='tr/reflectionproperty.isprotectedset.php'>Turkish</option>
            <option value='uk/reflectionproperty.isprotectedset.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.isprotectedset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.isprotectedset" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionproperty.isstatic.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::isStatic()</a> - Checks if property is static</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/isprotectedset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.isprotectedset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.isprotectedset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.isprotectedset.php">＋<small>add a note</small></a></span>
