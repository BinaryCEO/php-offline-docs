...
<head>
  ...
  <title>PHP: DateInvalidOperationException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dateinvalidoperationexception.php">
 <link rel="shorturl" href="https://www.php.net/dateinvalidoperationexception">
 <link rel="alternate" href="https://www.php.net/dateinvalidoperationexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dateexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dateinvalidtimezoneexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dateinvalidoperationexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dateinvalidoperationexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dateinvalidoperationexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dateinvalidoperationexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dateinvalidoperationexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dateinvalidoperationexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dateinvalidoperationexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dateinvalidoperationexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dateinvalidoperationexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dateinvalidoperationexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dateinvalidoperationexception.php" hreflang="zh">
...
<meta name="Description" content="The DateInvalidOperationException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateInvalidOperationException - Manual" />
<meta name="twitter:description" content="The DateInvalidOperationException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateInvalidOperationException - Manual" />
<meta itemprop="description" content="The DateInvalidOperationException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateInvalidOperationException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dateinvalidtimezoneexception.php">
          DateInvalidTimeZoneException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dateexception.php">
          &laquo; DateException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dateinvalidoperationexception.php' selected="selected">English</option>
            <option value='de/class.dateinvalidoperationexception.php'>German</option>
            <option value='es/class.dateinvalidoperationexception.php'>Spanish</option>
            <option value='fr/class.dateinvalidoperationexception.php'>French</option>
            <option value='it/class.dateinvalidoperationexception.php'>Italian</option>
            <option value='ja/class.dateinvalidoperationexception.php'>Japanese</option>
            <option value='pt_BR/class.dateinvalidoperationexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.dateinvalidoperationexception.php'>Russian</option>
            <option value='tr/class.dateinvalidoperationexception.php'>Turkish</option>
            <option value='uk/class.dateinvalidoperationexception.php'>Ukrainian</option>
            <option value='zh/class.dateinvalidoperationexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dateinvalidoperationexception" class="reference">
 <h1 class="title">The DateInvalidOperationException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="dateinvalidoperationexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown by <span class="methodname"><a href="datetimeimmutable.sub.php" class="methodname">DateTimeImmutable::sub()</a></span> and
    <span class="methodname"><a href="datetime.sub.php" class="methodname">DateTime::sub()</a></span> when an unsupported operation is
    attempted.
   </p>
   <p class="para">
    ...
    specifications such as <code class="literal">next weekday</code>, as no logical
    reversed statement can be constructed.
   </p>
  </div>


  <div class="section" id="dateinvalidoperationexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateInvalidOperationException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateinvalidoperationexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dateinvalidoperationexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dateinvalidoperationexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dateinvalidoperationexception.php">＋<small>add a note</small></a></span>
