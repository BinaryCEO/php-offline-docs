...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-log10.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-ln.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-ma.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-log10.php' selected="selected">English</option>
            ...
            <option value='ja/function.trader-log10.php'>Japanese</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-log10-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-log10.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-log10%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-log10&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-log10.php">＋<small>add a note</small></a></span>
