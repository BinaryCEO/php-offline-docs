...
<head>
  ...
  <title>PHP: Gmagick::readimageblob - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.readimageblob.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.readimageblob.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimageblob.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.readimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.readimagefile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.readimageblob.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.readimageblob.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.readimageblob.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.readimageblob.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.readimageblob.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.readimageblob.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.readimageblob.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.readimageblob.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.readimageblob.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.readimageblob.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.readimageblob.php" hreflang="zh">
...
<meta name="Description" content="Reads image from a binary string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::readimageblob - Manual" />
<meta name="twitter:description" content="Reads image from a binary string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::readimageblob - Manual" />
<meta itemprop="description" content="Reads image from a binary string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads image from a binary string" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.readimagefile.php">
          Gmagick::readimagefile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.readimage.php">
          &laquo; Gmagick::readimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.readimageblob.php' selected="selected">English</option>
            <option value='de/gmagick.readimageblob.php'>German</option>
            <option value='es/gmagick.readimageblob.php'>Spanish</option>
            <option value='fr/gmagick.readimageblob.php'>French</option>
            <option value='it/gmagick.readimageblob.php'>Italian</option>
            <option value='ja/gmagick.readimageblob.php'>Japanese</option>
            <option value='pt_BR/gmagick.readimageblob.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.readimageblob.php'>Russian</option>
            <option value='tr/gmagick.readimageblob.php'>Turkish</option>
            <option value='uk/gmagick.readimageblob.php'>Ukrainian</option>
            <option value='zh/gmagick.readimageblob.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.readimageblob" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::readimageblob</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::readimageblob</span> &mdash; <span class="dc-title">Reads image from a binary string</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.readimageblob-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::readimageblob</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$imageContents</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.readimageblob-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">imageContents</code></dt>
     <dd>
      <p class="para">
       Content of image.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.readimageblob-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.readimageblob-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/readimageblob.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.readimageblob%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.readimageblob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.readimageblob.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="98639">  <div class="votes">
    <div id="Vu98639">
    <a href="/manual/vote-note.php?id=98639&amp;page=gmagick.readimageblob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd98639">
    <a href="/manual/vote-note.php?id=98639&amp;page=gmagick.readimageblob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V98639" title="100% like this...">
    6
    </div>
  </div>
  <a href="#98639" class="name">
  <strong class="user"><em>MPLong</em></strong></a><a class="genanchor" href="#98639"> &para;</a><div class="date" title="2010-06-28 11:29"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom98639">
<div class="phpcode"><code><span class="html">If you want to be able to do the opposite (output your gmagick object to a blob), then use getImageBlob() like this:<br /><br />$outputstring = $im-&gt;getImageBlob();<br /><br />This is apparently undocumented here, but since the entire library is ported/modeled on the imagemagick library, it makes sense that it uses the same name as imagemagick.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.readimageblob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.readimageblob.php">＋<small>add a note</small></a></div>
