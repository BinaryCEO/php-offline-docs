...
<head>
  ...
  <title>PHP: SolrMissingMandatoryParameterException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.solrmissingmandatoryparameterexception.php">
 <link rel="shorturl" href="https://www.php.net/solrmissingmandatoryparameterexception">
 <link rel="alternate" href="https://www.php.net/solrmissingmandatoryparameterexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrillegaloperationexception.getinternalinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/refs.utilspec.server.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.solrmissingmandatoryparameterexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.solrmissingmandatoryparameterexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.solrmissingmandatoryparameterexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.solrmissingmandatoryparameterexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.solrmissingmandatoryparameterexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.solrmissingmandatoryparameterexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.solrmissingmandatoryparameterexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.solrmissingmandatoryparameterexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.solrmissingmandatoryparameterexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.solrmissingmandatoryparameterexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.solrmissingmandatoryparameterexception.php" hreflang="zh">
...
<meta name="Description" content="The SolrMissingMandatoryParameterException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrMissingMandatoryParameterException - Manual" />
<meta name="twitter:description" content="The SolrMissingMandatoryParameterException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrMissingMandatoryParameterException - Manual" />
<meta itemprop="description" content="The SolrMissingMandatoryParameterException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SolrMissingMandatoryParameterException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="refs.utilspec.server.php">
          Server Specific Extensions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrillegaloperationexception.getinternalinfo.php">
          &laquo; SolrIllegalOperationException::getInternalInfo        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.solrmissingmandatoryparameterexception.php' selected="selected">English</option>
            <option value='de/class.solrmissingmandatoryparameterexception.php'>German</option>
            <option value='es/class.solrmissingmandatoryparameterexception.php'>Spanish</option>
            <option value='fr/class.solrmissingmandatoryparameterexception.php'>French</option>
            <option value='it/class.solrmissingmandatoryparameterexception.php'>Italian</option>
            <option value='ja/class.solrmissingmandatoryparameterexception.php'>Japanese</option>
            <option value='pt_BR/class.solrmissingmandatoryparameterexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.solrmissingmandatoryparameterexception.php'>Russian</option>
            <option value='tr/class.solrmissingmandatoryparameterexception.php'>Turkish</option>
            <option value='uk/class.solrmissingmandatoryparameterexception.php'>Ukrainian</option>
            <option value='zh/class.solrmissingmandatoryparameterexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.solrmissingmandatoryparameterexception" class="reference">

 <h1 class="title">The SolrMissingMandatoryParameterException class</h1>
 

 <div class="partintro"><p class="verinfo">(No version information available, might only be in Git)</p>


  <div class="section" id="solrmissingmandatoryparameterexception.intro">
  ...
  <div class="section" id="solrmissingmandatoryparameterexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">SolrMissingMandatoryParameterException</strong>
     </span>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrmissingmandatoryparameterexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.solrmissingmandatoryparameterexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.solrmissingmandatoryparameterexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.solrmissingmandatoryparameterexception.php">＋<small>add a note</small></a></span>
