...
<head>
  ...
  <title>PHP: db2_field_precision - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-field-precision.php">
 <link rel="shorturl" href="https://www.php.net/db2-field-precision">
 <link rel="alternate" href="https://www.php.net/db2-field-precision" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-field-num.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-field-scale.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-field-precision.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-field-precision.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-field-precision.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-field-precision.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-field-precision.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-field-precision.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-field-precision.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-field-precision.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-field-precision.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-field-precision.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-field-precision.php" hreflang="zh">
...
<meta name="Description" content="Returns the precision of the indicated column in a result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_field_precision - Manual" />
<meta name="twitter:description" content="Returns the precision of the indicated column in a result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_field_precision - Manual" />
<meta itemprop="description" content="Returns the precision of the indicated column in a result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the precision of the indicated column in a result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-field-scale.php">
          db2_field_scale &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-field-num.php">
          &laquo; db2_field_num        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-field-precision.php' selected="selected">English</option>
            <option value='de/function.db2-field-precision.php'>German</option>
            <option value='es/function.db2-field-precision.php'>Spanish</option>
            <option value='fr/function.db2-field-precision.php'>French</option>
            <option value='it/function.db2-field-precision.php'>Italian</option>
            <option value='ja/function.db2-field-precision.php'>Japanese</option>
            <option value='pt_BR/function.db2-field-precision.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-field-precision.php'>Russian</option>
            <option value='tr/function.db2-field-precision.php'>Turkish</option>
            <option value='uk/function.db2-field-precision.php'>Ukrainian</option>
            <option value='zh/function.db2-field-precision.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-field-precision" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_field_precision</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_field_precision</span> &mdash; <span class="dc-title">
   Returns the precision of the indicated column in a result set
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-field-precision-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_field_precision</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$column</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.db2-field-precision-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-field-precision-returnvalues">
  ...
  <p class="para">
   ...
   <span class="function"><strong>db2_field_precision()</strong></span> returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-field-precision-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-field-width.php" class="function" rel="rdfs-seeAlso">db2_field_width()</a> - Returns the width of the current value of the indicated column in a result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-field-precision.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-field-precision%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-field-precision&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-field-precision.php">＋<small>add a note</small></a></span>
