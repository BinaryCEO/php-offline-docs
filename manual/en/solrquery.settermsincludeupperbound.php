...
<head>
  ...
  <title>PHP: SolrQuery::setTermsIncludeUpperBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.settermsincludelowerbound.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.settermslimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.settermsincludeupperbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.settermsincludeupperbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.settermsincludeupperbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.settermsincludeupperbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.settermsincludeupperbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.settermsincludeupperbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.settermsincludeupperbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.settermsincludeupperbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.settermsincludeupperbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.settermsincludeupperbound.php" hreflang="zh">
...
<meta name="Description" content="Include the upper bound term in the result set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setTermsIncludeUpperBound - Manual" />
<meta name="twitter:description" content="Include the upper bound term in the result set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setTermsIncludeUpperBound - Manual" />
<meta itemprop="description" content="Include the upper bound term in the result set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Include the upper bound term in the result set" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.settermslimit.php">
          SolrQuery::setTermsLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.settermsincludelowerbound.php">
          &laquo; SolrQuery::setTermsIncludeLowerBound        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.settermsincludeupperbound.php' selected="selected">English</option>
            <option value='de/solrquery.settermsincludeupperbound.php'>German</option>
            <option value='es/solrquery.settermsincludeupperbound.php'>Spanish</option>
            <option value='fr/solrquery.settermsincludeupperbound.php'>French</option>
            <option value='it/solrquery.settermsincludeupperbound.php'>Italian</option>
            <option value='ja/solrquery.settermsincludeupperbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.settermsincludeupperbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.settermsincludeupperbound.php'>Russian</option>
            <option value='tr/solrquery.settermsincludeupperbound.php'>Turkish</option>
            <option value='uk/solrquery.settermsincludeupperbound.php'>Ukrainian</option>
            <option value='zh/solrquery.settermsincludeupperbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.settermsincludeupperbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setTermsIncludeUpperBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setTermsIncludeUpperBound</span> &mdash; <span class="dc-title">Include the upper bound term in the result set</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.settermsincludeupperbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setTermsIncludeUpperBound</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$flag</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.settermsincludeupperbound-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.settermsincludeupperbound-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/settermsincludeupperbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.settermsincludeupperbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.settermsincludeupperbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.settermsincludeupperbound.php">＋<small>add a note</small></a></span>
