...
<head>
  ...
  <title>PHP: Collator::getSortKey - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/collator.getsortkey.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/collator.getsortkey.php">
 <link rel="alternate" href="https://www.php.net/manual/en/collator.getsortkey.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.collator.php">
 <link rel="prev" href="https://www.php.net/manual/en/collator.getlocale.php">
 <link rel="next" href="https://www.php.net/manual/en/collator.getstrength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/collator.getsortkey.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/collator.getsortkey.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/collator.getsortkey.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/collator.getsortkey.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/collator.getsortkey.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/collator.getsortkey.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/collator.getsortkey.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/collator.getsortkey.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/collator.getsortkey.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/collator.getsortkey.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/collator.getsortkey.php" hreflang="zh">
...
<meta name="Description" content="Get sorting key for a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collator::getSortKey - Manual" />
<meta name="twitter:description" content="Get sorting key for a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collator::getSortKey - Manual" />
<meta itemprop="description" content="Get sorting key for a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get sorting key for a string" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="collator.getstrength.php">
          Collator::getStrength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="collator.getlocale.php">
          &laquo; Collator::getLocale        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/collator.getsortkey.php' selected="selected">English</option>
            <option value='de/collator.getsortkey.php'>German</option>
            <option value='es/collator.getsortkey.php'>Spanish</option>
            <option value='fr/collator.getsortkey.php'>French</option>
            <option value='it/collator.getsortkey.php'>Italian</option>
            <option value='ja/collator.getsortkey.php'>Japanese</option>
            <option value='pt_BR/collator.getsortkey.php'>Brazilian Portuguese</option>
            <option value='ru/collator.getsortkey.php'>Russian</option>
            <option value='tr/collator.getsortkey.php'>Turkish</option>
            <option value='uk/collator.getsortkey.php'>Ukrainian</option>
            <option value='zh/collator.getsortkey.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="collator.getsortkey" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-collator.getsortkey-returnvalues">
  ...
  <p class="para">Returns the collation key for the string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.</p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="collator.sortwithsortkeys.php" class="function" rel="rdfs-seeAlso">collator_sort_with_sort_keys()</a> - Sort array using specified collator and sort keys</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/collator/get-sort-key.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcollator.getsortkey%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=collator.getsortkey&amp;repo=en&amp;redirect=https://www.php.net/manual/en/collator.getsortkey.php">＋<small>add a note</small></a></span>
