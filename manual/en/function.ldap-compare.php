...
<head>
  ...
  <title>PHP: ldap_compare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-compare.php">
 <link rel="shorturl" href="https://www.php.net/ldap-compare">
 <link rel="alternate" href="https://www.php.net/ldap-compare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-compare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-compare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-compare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-compare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-compare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-compare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-compare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-compare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-compare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-compare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-compare.php" hreflang="zh">
...
<meta name="Description" content="Compare value of attribute found in entry specified with DN" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_compare - Manual" />
<meta name="twitter:description" content="Compare value of attribute found in entry specified with DN" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_compare - Manual" />
<meta itemprop="description" content="Compare value of attribute found in entry specified with DN" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Compare value of attribute found in entry specified with DN" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-connect.php">
          ldap_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-close.php">
          &laquo; ldap_close        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-compare.php' selected="selected">English</option>
            <option value='de/function.ldap-compare.php'>German</option>
            <option value='es/function.ldap-compare.php'>Spanish</option>
            <option value='fr/function.ldap-compare.php'>French</option>
            <option value='it/function.ldap-compare.php'>Italian</option>
            <option value='ja/function.ldap-compare.php'>Japanese</option>
            <option value='pt_BR/function.ldap-compare.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-compare.php'>Russian</option>
            <option value='tr/function.ldap-compare.php'>Turkish</option>
            <option value='uk/function.ldap-compare.php'>Ukrainian</option>
            <option value='zh/function.ldap-compare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-compare" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.ldap-compare-examples">
  ...
  <p class="para">
   <div class="example" id="example-4624">
   ...
   <p class="para">
    <span class="function"><strong>ldap_compare()</strong></span> can NOT be used to compare BINARY values!
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-compare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-compare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-compare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-compare.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="44453">  <div class="votes">
    <div id="Vu44453">
    <a href="/manual/vote-note.php?id=44453&amp;page=function.ldap-compare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd44453">
    <a href="/manual/vote-note.php?id=44453&amp;page=function.ldap-compare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V44453" title="91% like this...">
    19
    </div>
  </div>
  <a href="#44453" class="name">
  <strong class="user"><em>chuck+ldap at 2006 dot snew dot com</em></strong></a><a class="genanchor" href="#44453"> &para;</a><div class="date" title="2004-08-05 10:08"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom44453">
<div class="phpcode"><code><span class="html">Just a side note that this is not how you'd ever AUTHENTICATE someone, just an example code.<br /><br />The common way to authenticate is to get the users name, use search and perhaps selection to the user to get her DN (single value) then attempt to BIND to the ldapserver using that dn and the offered password.  If it works, then it's the right password.<br /><br />Note that the password offered MUST NOT BE EMPTY or many LDAPs will presume you meant to authenticate anonymously and it will succeed, leaving you thinking it's the right password.</span></code></div>
  </div>
 </div>
  <div class="note" id="51788">  <div class="votes">
    <div id="Vu51788">
    <a href="/manual/vote-note.php?id=51788&amp;page=function.ldap-compare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd51788">
    <a href="/manual/vote-note.php?id=51788&amp;page=function.ldap-compare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V51788" title="55% like this...">
    1
    </div>
  </div>
  <a href="#51788" class="name">
  <strong class="user"><em>oudejans at zeelandnet dot nl</em></strong></a><a class="genanchor" href="#51788"> &para;</a><div class="date" title="2005-04-11 05:10"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom51788">
<div class="phpcode"><code><span class="html">With PHP 4.3.* is Password no longer a valid attribute.. try to use userPassword</span></code></div>
  </div>
 </div>
  <div class="note" id="11009">  <div class="votes">
    <div id="Vu11009">
    <a href="/manual/vote-note.php?id=11009&amp;page=function.ldap-compare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd11009">
    <a href="/manual/vote-note.php?id=11009&amp;page=function.ldap-compare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V11009" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#11009" class="name">
  <strong class="user"><em>Brian Kerhin &amp;lt;kerhin at bigfoot dot com&amp;gt;</em></strong></a><a class="genanchor" href="#11009"> &para;</a><div class="date" title="2001-01-31 06:13"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom11009">
<div class="phpcode"><code><span class="html">Not probably, will.  With PHP 4.0.4 and openldap 1.2.9 this little script, even with the correct attributes for the password does not do the job.  Would superb if it did!</span></code></div>
  </div>
 </div>
  <div class="note" id="9280">  <div class="votes">
    <div id="Vu9280">
    <a href="/manual/vote-note.php?id=9280&amp;page=function.ldap-compare&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd9280">
    <a href="/manual/vote-note.php?id=9280&amp;page=function.ldap-compare&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V9280" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#9280" class="name">
  <strong class="user"><em>334647 at swin dot edu dot au</em></strong></a><a class="genanchor" href="#9280"> &para;</a><div class="date" title="2000-10-25 07:06"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom9280">
<div class="phpcode"><code><span class="html">Interesting example. Apart from the fact that very few people would allow comaprisions of the password attribute for security reasons. The attribute name of "password" does not match the usual schemas.
<br />
<br />The usual method of user id + password verification is to attempt to bind using the supplied credentials.
<br />
<br />Ldap compare on password values will probably fail with ns directroy server and openldap v2+ becuase of server support for password hashing.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-compare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-compare.php">＋<small>add a note</small></a></div>
