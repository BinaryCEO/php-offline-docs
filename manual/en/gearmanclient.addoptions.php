...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.addoptions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.addoptions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addoptions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.addserver.php">
...
<meta name="Description" content="Add client options" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::addOptions - Manual" />
<meta name="twitter:description" content="Add client options" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::addOptions - Manual" />
<meta itemprop="description" content="Add client options" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add client options" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.addoptions.php' selected="selected">English</option>
            ...
            <option value='ru/gearmanclient.addoptions.php'>Russian</option>
  ...
  <p class="para">
   Always returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/addoptions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.addoptions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.addoptions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addoptions.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To add multiple options at once use pipe separated list.<br /><span class="default">&lt;?php<br />$client </span><span class="keyword">= new </span><span class="default">GearmanClient</span><span class="keyword">();<br /></span><span class="default">$client</span><span class="keyword">-&gt;</span><span class="default">addOptions</span><span class="keyword">(</span><span class="default">GEARMAN_CLIENT_NON_BLOCKING </span><span class="keyword">| </span><span class="default">GEARMAN_CLIENT_FREE_TASKS </span><span class="keyword">| </span><span class="default">GEARMAN_CLIENT_UNBUFFERED_RESULT</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gearmanclient.addoptions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addoptions.php">＋<small>add a note</small></a></div>
