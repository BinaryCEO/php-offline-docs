...
<head>
  ...
  <title>PHP: radius_add_server - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-add-server.php">
 <link rel="shorturl" href="https://www.php.net/radius-add-server">
 <link rel="alternate" href="https://www.php.net/radius-add-server" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.radius.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-acct-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-auth-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.radius-add-server.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.radius-add-server.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.radius-add-server.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.radius-add-server.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.radius-add-server.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.radius-add-server.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.radius-add-server.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.radius-add-server.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.radius-add-server.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.radius-add-server.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.radius-add-server.php" hreflang="zh">
...
<meta name="Description" content="Adds a server" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_add_server - Manual" />
<meta name="twitter:description" content="Adds a server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_add_server - Manual" />
<meta itemprop="description" content="Adds a server" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a server" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.radius-auth-open.php">
          radius_auth_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.radius-acct-open.php">
          &laquo; radius_acct_open        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-add-server.php' selected="selected">English</option>
            <option value='de/function.radius-add-server.php'>German</option>
            <option value='es/function.radius-add-server.php'>Spanish</option>
            <option value='fr/function.radius-add-server.php'>French</option>
            <option value='it/function.radius-add-server.php'>Italian</option>
            <option value='ja/function.radius-add-server.php'>Japanese</option>
            <option value='pt_BR/function.radius-add-server.php'>Brazilian Portuguese</option>
            <option value='ru/function.radius-add-server.php'>Russian</option>
            <option value='tr/function.radius-add-server.php'>Turkish</option>
            <option value='uk/function.radius-add-server.php'>Ukrainian</option>
            <option value='zh/function.radius-add-server.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.radius-add-server" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.radius-config.php" class="function" rel="rdfs-seeAlso">radius_config()</a> - Causes the library to read the given configuration file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-add-server.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-add-server%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-add-server&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-add-server.php">＋<small>add a note</small></a></span>
