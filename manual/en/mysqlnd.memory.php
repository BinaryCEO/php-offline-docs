...
<head>
  ...
  <title>PHP: Memory management - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlnd.memory.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlnd.memory.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.memory.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqlnd.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqlnd.notes.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlnd.plugin.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.memory.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlnd.memory.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlnd.memory.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlnd.memory.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlnd.memory.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlnd.memory.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlnd.memory.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlnd.memory.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlnd.memory.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlnd.memory.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlnd.memory.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Memory management - Manual" />
<meta name="twitter:description" content="Memory management" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memory management - Manual" />
<meta itemprop="description" content="Memory management" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Memory management" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqlnd.plugin.php">
          MySQL Native Driver Plugin API &raquo;
        </a>
      </div>
              <div class="prev">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlnd.memory.php' selected="selected">English</option>
            <option value='de/mysqlnd.memory.php'>German</option>
            <option value='es/mysqlnd.memory.php'>Spanish</option>
            <option value='fr/mysqlnd.memory.php'>French</option>
            <option value='it/mysqlnd.memory.php'>Italian</option>
            <option value='ja/mysqlnd.memory.php'>Japanese</option>
            <option value='pt_BR/mysqlnd.memory.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlnd.memory.php'>Russian</option>
            <option value='tr/mysqlnd.memory.php'>Turkish</option>
            <option value='uk/mysqlnd.memory.php'>Ukrainian</option>
            <option value='zh/mysqlnd.memory.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlnd.memory" class="chapter">
 ...
 <p class="para">
  <strong>Memory management functions used</strong>
 </p>
 <p class="para">
  ...
  using PHP API calls, such as <span class="function"><a href="function.memory-get-usage.php" class="function">memory_get_usage()</a></span>. Because memory is
 ...
 <p class="para">
   <strong>Handling of result sets</strong>
 </p>
 <p class="para">
  The various MySQL Server and the various client APIs differentiate
  between <a href="mysqli.quickstart.statements.php" class="link">buffered and unbuffered</a>
 ...
 <p class="para">
  ...
  is released. Use the <a href="mysqlnd.stats.php" class="link">statistics</a> to check whether
 ...
 <p class="para">
  ...
  of PHP scripts, then check the <a href="mysqlnd.stats.php" class="link">statistics</a>
 ...
 <p class="para">
  The <a href="mysqlnd.config.php#ini.mysqlnd.debug" class="link">debug</a> trace log can be configured to
 ...
 <p class="para">
  ...
  C developers of the library or mysqlnd <a href="mysqlnd.plugin.php" class="link">plugin</a>
  ...
  modified at any time without prior notice.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqlnd/memory.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlnd.memory%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlnd.memory&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlnd.memory.php">＋<small>add a note</small></a></span>
