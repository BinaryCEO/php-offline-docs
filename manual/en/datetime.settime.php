...
<head>
  ...
  <title>PHP: DateTime::setTime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/datetime.settime.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/datetime.settime.php">
 <link rel="alternate" href="https://www.php.net/manual/en/datetime.settime.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/datetime.setisodate.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.settimestamp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/datetime.settime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/datetime.settime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/datetime.settime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/datetime.settime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/datetime.settime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/datetime.settime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/datetime.settime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/datetime.settime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/datetime.settime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/datetime.settime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/datetime.settime.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: DateTime::setTime - Manual" />
<meta name="twitter:description" content="Sets the time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTime::setTime - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="datetime.settimestamp.php">
          DateTime::setTimestamp &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.setisodate.php">
          &laquo; DateTime::setISODate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/datetime.settime.php' selected="selected">English</option>
            <option value='de/datetime.settime.php'>German</option>
            <option value='es/datetime.settime.php'>Spanish</option>
            <option value='fr/datetime.settime.php'>French</option>
            <option value='it/datetime.settime.php'>Italian</option>
            <option value='ja/datetime.settime.php'>Japanese</option>
            <option value='pt_BR/datetime.settime.php'>Brazilian Portuguese</option>
            <option value='ru/datetime.settime.php'>Russian</option>
            <option value='tr/datetime.settime.php'>Turkish</option>
            <option value='uk/datetime.settime.php'>Ukrainian</option>
            <option value='zh/datetime.settime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="datetime.settime" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="datetimeimmutable.settime.php" class="function" rel="rdfs-seeAlso">DateTimeImmutable::setTime()</a> - Sets the time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetime/settime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdatetime.settime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=datetime.settime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/datetime.settime.php">＋<small>add a note</small></a></span>
