...
<head>
  ...
  <title>PHP: Imagick::combineImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.combineimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.combineimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.combineimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.colormatriximage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.commentimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.combineimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.combineimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.combineimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.combineimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.combineimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.combineimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.combineimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.combineimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.combineimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.combineimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.combineimages.php" hreflang="zh">
...
<meta name="Description" content="Combines one or more images into a single image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::combineImages - Manual" />
<meta name="twitter:description" content="Combines one or more images into a single image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::combineImages - Manual" />
<meta itemprop="description" content="Combines one or more images into a single image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Combines one or more images into a single image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.commentimage.php">
          Imagick::commentImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.colormatriximage.php">
          &laquo; Imagick::colorMatrixImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.combineimages.php' selected="selected">English</option>
            <option value='de/imagick.combineimages.php'>German</option>
            <option value='es/imagick.combineimages.php'>Spanish</option>
            <option value='fr/imagick.combineimages.php'>French</option>
            <option value='it/imagick.combineimages.php'>Italian</option>
            <option value='ja/imagick.combineimages.php'>Japanese</option>
            <option value='pt_BR/imagick.combineimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.combineimages.php'>Russian</option>
            <option value='tr/imagick.combineimages.php'>Turkish</option>
            <option value='uk/imagick.combineimages.php'>Ukrainian</option>
            <option value='zh/imagick.combineimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.combineimages" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/combineimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.combineimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.combineimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.combineimages.php">＋<small>add a note</small></a></span>
