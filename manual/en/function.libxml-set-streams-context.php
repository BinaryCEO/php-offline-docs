...
<head>
  ...
  <title>PHP: libxml_set_streams_context - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.libxml-set-streams-context.php">
 <link rel="shorturl" href="https://www.php.net/libxml-set-streams-context">
 <link rel="alternate" href="https://www.php.net/libxml-set-streams-context" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.libxml.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.libxml-set-external-entity-loader.php">
 <link rel="next" href="https://www.php.net/manual/en/function.libxml-use-internal-errors.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.libxml-set-streams-context.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.libxml-set-streams-context.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.libxml-set-streams-context.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.libxml-set-streams-context.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.libxml-set-streams-context.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.libxml-set-streams-context.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.libxml-set-streams-context.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.libxml-set-streams-context.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.libxml-set-streams-context.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.libxml-set-streams-context.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.libxml-set-streams-context.php" hreflang="zh">
...
<meta name="Description" content="Set the streams context for the next libxml document load or write" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: libxml_set_streams_context - Manual" />
<meta name="twitter:description" content="Set the streams context for the next libxml document load or write" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: libxml_set_streams_context - Manual" />
<meta itemprop="description" content="Set the streams context for the next libxml document load or write" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the streams context for the next libxml document load or write" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.libxml-use-internal-errors.php">
          libxml_use_internal_errors &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.libxml-set-external-entity-loader.php">
          &laquo; libxml_set_external_entity_loader        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.libxml-set-streams-context.php' selected="selected">English</option>
            <option value='de/function.libxml-set-streams-context.php'>German</option>
            <option value='es/function.libxml-set-streams-context.php'>Spanish</option>
            <option value='fr/function.libxml-set-streams-context.php'>French</option>
            <option value='it/function.libxml-set-streams-context.php'>Italian</option>
            <option value='ja/function.libxml-set-streams-context.php'>Japanese</option>
            <option value='pt_BR/function.libxml-set-streams-context.php'>Brazilian Portuguese</option>
            <option value='ru/function.libxml-set-streams-context.php'>Russian</option>
            <option value='tr/function.libxml-set-streams-context.php'>Turkish</option>
            <option value='uk/function.libxml-set-streams-context.php'>Ukrainian</option>
            <option value='zh/function.libxml-set-streams-context.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.libxml-set-streams-context" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.libxml-set-streams-context-examples">
  ...
  <p class="para">
   <div class="example" id="example-5858">
    <p><strong>Example #1 A <span class="function"><strong>libxml_set_streams_context()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.stream-context-create.php" class="function" rel="rdfs-seeAlso">stream_context_create()</a> - Creates a stream context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/libxml/functions/libxml-set-streams-context.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.libxml-set-streams-context%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.libxml-set-streams-context&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.libxml-set-streams-context.php">＋<small>add a note</small></a></span>
