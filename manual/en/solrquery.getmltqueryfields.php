...
<head>
  ...
  <title>PHP: SolrQuery::getMltQueryFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getmltminwordlength.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getmltqueryfields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getmltqueryfields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getmltqueryfields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getmltqueryfields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getmltqueryfields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getmltqueryfields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getmltqueryfields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getmltqueryfields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getmltqueryfields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getmltqueryfields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getmltqueryfields.php" hreflang="zh">
...
<meta name="Description" content="Returns the query fields and their boosts" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getMltQueryFields - Manual" />
<meta name="twitter:description" content="Returns the query fields and their boosts" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getMltQueryFields - Manual" />
<meta itemprop="description" content="Returns the query fields and their boosts" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the query fields and their boosts" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getquery.php">
          SolrQuery::getQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getmltminwordlength.php">
          &laquo; SolrQuery::getMltMinWordLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getmltqueryfields.php' selected="selected">English</option>
            <option value='de/solrquery.getmltqueryfields.php'>German</option>
            <option value='es/solrquery.getmltqueryfields.php'>Spanish</option>
            <option value='fr/solrquery.getmltqueryfields.php'>French</option>
            <option value='it/solrquery.getmltqueryfields.php'>Italian</option>
            <option value='ja/solrquery.getmltqueryfields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getmltqueryfields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getmltqueryfields.php'>Russian</option>
            <option value='tr/solrquery.getmltqueryfields.php'>Turkish</option>
            <option value='uk/solrquery.getmltqueryfields.php'>Ukrainian</option>
            <option value='zh/solrquery.getmltqueryfields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getmltqueryfields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getMltQueryFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getMltQueryFields</span> &mdash; <span class="dc-title">Returns the query fields and their boosts</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getmltqueryfields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getMltQueryFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getmltqueryfields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getmltqueryfields-returnvalues">
...
Returns an array on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getmltqueryfields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getmltqueryfields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getmltqueryfields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getmltqueryfields.php">＋<small>add a note</small></a></span>
