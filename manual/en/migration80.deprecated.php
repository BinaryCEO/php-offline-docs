...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration80.deprecated.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration80.deprecated.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration80.deprecated.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration80.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration80.incompatible.php">
 <link rel="next" href="https://www.php.net/manual/en/migration80.other-changes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration80.deprecated.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration80.deprecated.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration80.deprecated.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration80.deprecated.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration80.deprecated.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration80.deprecated.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration80.deprecated.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration80.deprecated.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration80.deprecated.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration80.deprecated.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration80.deprecated.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="migration80.other-changes.php">
          Other Changes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="migration80.incompatible.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration80.deprecated.php' selected="selected">English</option>
            <option value='de/migration80.deprecated.php'>German</option>
            <option value='es/migration80.deprecated.php'>Spanish</option>
            <option value='fr/migration80.deprecated.php'>French</option>
            <option value='it/migration80.deprecated.php'>Italian</option>
            <option value='ja/migration80.deprecated.php'>Japanese</option>
            <option value='pt_BR/migration80.deprecated.php'>Brazilian Portuguese</option>
            <option value='ru/migration80.deprecated.php'>Russian</option>
            <option value='tr/migration80.deprecated.php'>Turkish</option>
            <option value='uk/migration80.deprecated.php'>Ukrainian</option>
            <option value='zh/migration80.deprecated.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration80.deprecated" class="sect1">
    ...
    <p class="para">
     ...
     <span class="classname"><a href="class.reflectiontype.php" class="classname">ReflectionType</a></span> APIs should be used instead.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration80/deprecated.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration80.deprecated%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration80.deprecated&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration80.deprecated.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="130482">  <div class="votes">
    <div id="Vu130482">
    <a href="/manual/vote-note.php?id=130482&amp;page=migration80.deprecated&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130482">
    <a href="/manual/vote-note.php?id=130482&amp;page=migration80.deprecated&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130482" title="no votes...">
    0
    </div>
  </div>
  <a href="#130482" class="name">
  <strong class="user"><em>john2014an at gmail dot com</em></strong></a><a class="genanchor" href="#130482"> &para;</a><div class="date" title="2025-09-13 04:03"><strong>16 days ago</strong></div>
  <div class="text" id="Hcom130482">
<div class="phpcode"><code><span class="html">if a $_SESSION['example'] variable has not been set before being used, PHP version 7.4 just returned false, PHP 8.0 throws a PHP Warning: Undefined array key "example"</span></code></div>
  </div>
 </div>
  <div class="note" id="126181">  <div class="votes">
    <div id="Vu126181">
    <a href="/manual/vote-note.php?id=126181&amp;page=migration80.deprecated&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126181">
    <a href="/manual/vote-note.php?id=126181&amp;page=migration80.deprecated&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126181" title="50% like this...">
    0
    </div>
  </div>
  <a href="#126181" class="name">
  <strong class="user"><em>dominique dot vienne at ik dot me</em></strong></a><a class="genanchor" href="#126181"> &para;</a><div class="date" title="2021-06-21 01:23"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126181">
<div class="phpcode"><code><span class="html">If you try to get all methods / functions assigning an optional argument before a mandatory one, try this regex (single line)<br /><br /><span class="default">&lt;?php<br />function\s</span><span class="keyword">+[</span><span class="default">a</span><span class="keyword">-</span><span class="default">z</span><span class="keyword">][</span><span class="default">a</span><span class="keyword">-</span><span class="default">zA</span><span class="keyword">-</span><span class="default">Z0</span><span class="keyword">-</span><span class="default">9_</span><span class="keyword">]*\((?:\$[</span><span class="default">a</span><span class="keyword">-</span><span class="default">z</span><span class="keyword">][</span><span class="default">a</span><span class="keyword">-</span><span class="default">zA</span><span class="keyword">-</span><span class="default">Z0</span><span class="keyword">-</span><span class="default">9</span><span class="keyword">]*</span><span class="default">\s</span><span class="keyword">*,</span><span class="default">\s</span><span class="keyword">*)*<br />(?:\$[</span><span class="default">a</span><span class="keyword">-</span><span class="default">z</span><span class="keyword">][</span><span class="default">A</span><span class="keyword">-</span><span class="default">Za</span><span class="keyword">-</span><span class="default">z0</span><span class="keyword">-</span><span class="default">9_</span><span class="keyword">]*</span><span class="default">\s</span><span class="keyword">*=[^\$\)]+)+\$[</span><span class="default">a</span><span class="keyword">-</span><span class="default">z</span><span class="keyword">][</span><span class="default">a</span><span class="keyword">-</span><span class="default">zA</span><span class="keyword">-</span><span class="default">Z0</span><span class="keyword">-</span><span class="default">9_</span><span class="keyword">]*\)<br /></span><span class="default">?&gt;<br /></span><br />for<br /><span class="default">&lt;?php<br /></span><span class="keyword">public function </span><span class="default">test</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">) {<br /></span><span class="default">$a </span><span class="keyword">= [];<br /></span><span class="default">$b </span><span class="keyword">= [</span><span class="default">$abc </span><span class="keyword">=&gt; </span><span class="default">$ss</span><span class="keyword">[],<br />];<br />}<br /><br />private function </span><span class="default">too</span><span class="keyword">(</span><span class="default">$c</span><span class="keyword">, </span><span class="default">$a </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">) {<br />}<br /><br />protected function </span><span class="default">bar</span><span class="keyword">(</span><span class="default">$a </span><span class="keyword">= []) {<br />}<br /><br />public function </span><span class="default">foo</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$b </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">) {<br />} <br /><br />public function </span><span class="default">fooBar32</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">=</span><span class="default">true</span><span class="keyword">, </span><span class="default">$b </span><span class="keyword">= [], </span><span class="default">$c</span><span class="keyword">) {<br />}<br /><br />private function </span><span class="default">oo_bAr</span><span class="keyword">(</span><span class="default">$a </span><span class="keyword">= []) {<br />}<br /></span><span class="default">?&gt;<br /></span>it will match too() and fooBar32() <br /><br />Have a nice migration! ;)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=migration80.deprecated&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration80.deprecated.php">＋<small>add a note</small></a></div>
