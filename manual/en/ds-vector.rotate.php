...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-vector.rotate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-vector.rotate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-vector.rotate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-vector.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-vector.reversed.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-vector.set.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-vector.rotate.php' selected="selected">English</option>
            ...
            <option value='zh/ds-vector.rotate.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-ds-vector.rotate-examples">
  ...
  <div class="example" id="example-4314">
   <p><strong>Example #1 <span class="function"><strong>Ds\Vector::rotate()</strong></span> example</strong></p>
...
(
    ...
    [3] =&gt; c
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/vector/rotate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-vector.rotate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-vector.rotate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-vector.rotate.php">＋<small>add a note</small></a></span>
