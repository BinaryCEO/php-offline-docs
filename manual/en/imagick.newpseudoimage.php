...
<head>
  ...
  <title>PHP: Imagick::newPseudoImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.newpseudoimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.newpseudoimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.newpseudoimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.newimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.nextimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.newpseudoimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.newpseudoimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.newpseudoimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.newpseudoimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.newpseudoimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.newpseudoimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.newpseudoimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.newpseudoimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.newpseudoimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.newpseudoimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.newpseudoimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::newPseudoImage - Manual" />
<meta name="twitter:description" content="Creates a new image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::newPseudoImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.nextimage.php">
          Imagick::nextImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.newimage.php">
          &laquo; Imagick::newImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.newpseudoimage.php' selected="selected">English</option>
            <option value='de/imagick.newpseudoimage.php'>German</option>
            <option value='es/imagick.newpseudoimage.php'>Spanish</option>
            <option value='fr/imagick.newpseudoimage.php'>French</option>
            <option value='it/imagick.newpseudoimage.php'>Italian</option>
            <option value='ja/imagick.newpseudoimage.php'>Japanese</option>
            <option value='pt_BR/imagick.newpseudoimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.newpseudoimage.php'>Russian</option>
            <option value='tr/imagick.newpseudoimage.php'>Turkish</option>
            <option value='uk/imagick.newpseudoimage.php'>Ukrainian</option>
            <option value='zh/imagick.newpseudoimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.newpseudoimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::newPseudoImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::newPseudoImage</span> &mdash; <span class="dc-title">Creates a new image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.newpseudoimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::newPseudoImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pseudoString</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.newpseudoimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">pseudoString</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.newpseudoimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.newpseudoimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.newpseudoimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3059">
      <p><strong>Example #1  <span class="function"><strong>Imagick::newPseudoImage()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$canvasType</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$imagick </span><span style="color: #007700">= new </span><span style="color: #0000BB">\Imagick</span><span style="color: #007700">();<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">300</span><span style="color: #007700">, </span><span style="color: #0000BB">$canvasType</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />    echo </span><span style="color: #0000BB">$imagick</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageBlob</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #FF8000">//newPseudoImage('gradient:red-rgba(64, 255, 255, 0.5)');<br />//newPseudoImage("radial-gradient:red-blue");<br /></span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"plasma:fractal"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/newpseudoimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.newpseudoimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.newpseudoimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.newpseudoimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99019">  <div class="votes">
    <div id="Vu99019">
    <a href="/manual/vote-note.php?id=99019&amp;page=imagick.newpseudoimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99019">
    <a href="/manual/vote-note.php?id=99019&amp;page=imagick.newpseudoimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99019" title="88% like this...">
    21
    </div>
  </div>
  <a href="#99019" class="name">
  <strong class="user"><em>Pekka Jrvinen</em></strong></a><a class="genanchor" href="#99019"> &para;</a><div class="date" title="2010-07-22 06:47"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99019">
<div class="phpcode"><code><span class="html">See <a href="http://www.imagemagick.org/script/formats.php" rel="nofollow" target="_blank">http://www.imagemagick.org/script/formats.php</a> for pseudoString parameter</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.newpseudoimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.newpseudoimage.php">＋<small>add a note</small></a></div>
