...
<head>
  ...
  <title>PHP: Imagick::reduceNoiseImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.reducenoiseimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.reducenoiseimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.reducenoiseimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.recolorimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.remapimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.reducenoiseimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.reducenoiseimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.reducenoiseimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.reducenoiseimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.reducenoiseimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.reducenoiseimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.reducenoiseimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.reducenoiseimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.reducenoiseimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.reducenoiseimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.reducenoiseimage.php" hreflang="zh">
...
<meta name="Description" content="Smooths the contours of an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::reduceNoiseImage - Manual" />
<meta name="twitter:description" content="Smooths the contours of an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::reduceNoiseImage - Manual" />
<meta itemprop="description" content="Smooths the contours of an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Smooths the contours of an image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.remapimage.php">
          Imagick::remapImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.recolorimage.php">
          &laquo; Imagick::recolorImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.reducenoiseimage.php' selected="selected">English</option>
            <option value='de/imagick.reducenoiseimage.php'>German</option>
            <option value='es/imagick.reducenoiseimage.php'>Spanish</option>
            <option value='fr/imagick.reducenoiseimage.php'>French</option>
            <option value='it/imagick.reducenoiseimage.php'>Italian</option>
            <option value='ja/imagick.reducenoiseimage.php'>Japanese</option>
            <option value='pt_BR/imagick.reducenoiseimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.reducenoiseimage.php'>Russian</option>
            <option value='tr/imagick.reducenoiseimage.php'>Turkish</option>
            <option value='uk/imagick.reducenoiseimage.php'>Ukrainian</option>
            <option value='zh/imagick.reducenoiseimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.reducenoiseimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::reduceNoiseImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::reduceNoiseImage</span> &mdash; <span class="dc-title">Smooths the contours of an image</span></p>

 </div>

 <div id="imagick.reducenoiseimage-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.reducenoiseimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::reduceNoiseImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.reducenoiseimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.reducenoiseimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.reducenoiseimage-errors">
  ...
  <p class="para">
    <div class="example" id="example-3077">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/reducenoiseimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.reducenoiseimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.reducenoiseimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.reducenoiseimage.php">＋<small>add a note</small></a></span>
