...
<head>
  ...
  <title>PHP: Gmagick::despeckleimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.despeckleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.despeckleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.despeckleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.deconstructimages.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.destroy.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.despeckleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.despeckleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.despeckleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.despeckleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.despeckleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.despeckleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.despeckleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.despeckleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.despeckleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.despeckleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.despeckleimage.php" hreflang="zh">
...
<meta name="Description" content="The despeckleimage purpose" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::despeckleimage - Manual" />
<meta name="twitter:description" content="The despeckleimage purpose" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::despeckleimage - Manual" />
<meta itemprop="description" content="The despeckleimage purpose" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The despeckleimage purpose" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.destroy.php">
          Gmagick::destroy &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.deconstructimages.php">
          &laquo; Gmagick::deconstructimages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.despeckleimage.php' selected="selected">English</option>
            <option value='de/gmagick.despeckleimage.php'>German</option>
            <option value='es/gmagick.despeckleimage.php'>Spanish</option>
            <option value='fr/gmagick.despeckleimage.php'>French</option>
            <option value='it/gmagick.despeckleimage.php'>Italian</option>
            <option value='ja/gmagick.despeckleimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.despeckleimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.despeckleimage.php'>Russian</option>
            <option value='tr/gmagick.despeckleimage.php'>Turkish</option>
            <option value='uk/gmagick.despeckleimage.php'>Ukrainian</option>
            <option value='zh/gmagick.despeckleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.despeckleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::despeckleimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::despeckleimage</span> &mdash; <span class="dc-title">The despeckleimage purpose</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.despeckleimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::despeckleimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.despeckleimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.despeckleimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The despeckled <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.despeckleimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
 ...
 <div class="refsect1 examples" id="refsect1-gmagick.despeckleimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2954">
    <p><strong>Example #1 <span class="methodname"><strong>Gmagick::despeckleimage()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">...</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/despeckleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.despeckleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.despeckleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.despeckleimage.php">＋<small>add a note</small></a></span>
