...
<head>
  ...
  <title>PHP: Dom\NamespaceInfo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-namespaceinfo.php">
 <link rel="shorturl" href="https://www.php.net/dom-namespaceinfo">
 <link rel="alternate" href="https://www.php.net/dom-namespaceinfo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-namednodemap.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-node.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-namespaceinfo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-namespaceinfo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-namespaceinfo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-namespaceinfo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-namespaceinfo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-namespaceinfo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-namespaceinfo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-namespaceinfo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-namespaceinfo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-namespaceinfo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-namespaceinfo.php" hreflang="zh">
...
<meta name="Description" content="The Dom\NamespaceInfo class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\NamespaceInfo - Manual" />
<meta name="twitter:description" content="The Dom\NamespaceInfo class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\NamespaceInfo - Manual" />
<meta itemprop="description" content="The Dom\NamespaceInfo class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\NamespaceInfo class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-node.php">
          Dom\Node &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-namednodemap.php">
          &laquo; Dom\NamedNodeMap        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-namespaceinfo.php' selected="selected">English</option>
            <option value='de/class.dom-namespaceinfo.php'>German</option>
            <option value='es/class.dom-namespaceinfo.php'>Spanish</option>
            <option value='fr/class.dom-namespaceinfo.php'>French</option>
            <option value='it/class.dom-namespaceinfo.php'>Italian</option>
            <option value='ja/class.dom-namespaceinfo.php'>Japanese</option>
            <option value='pt_BR/class.dom-namespaceinfo.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-namespaceinfo.php'>Russian</option>
            <option value='tr/class.dom-namespaceinfo.php'>Turkish</option>
            <option value='uk/class.dom-namespaceinfo.php'>Ukrainian</option>
            <option value='zh/class.dom-namespaceinfo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-namespaceinfo" class="reference">
 <h1 class="title">The Dom\NamespaceInfo class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  <div class="section" id="dom-namespaceinfo.intro">
  ...
  <div class="section" id="dom-namespaceinfo.synopsis">
   <h2 class="title">Class synopsis</h2>
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">final</span>
     <span class="modifier">readonly</span>
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\NamespaceInfo</strong></strong>
     {</div>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-namespaceinfo.php#dom-namespaceinfo.props.prefix">$<var class="varname">prefix</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname"><a href="class.dom-namespaceinfo.php#dom-namespaceinfo.props.namespaceuri">$<var class="varname">namespaceURI</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type"><a href="class.dom-element.php" class="type Dom\Element">Dom\Element</a></span>
      <var class="varname"><a href="class.dom-namespaceinfo.php#dom-namespaceinfo.props.element">$<var class="varname">element</var></a></var>;</div>
  ...
  <div class="section" id="dom-namespaceinfo.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-namespaceinfo.props.prefix"><var class="varname">prefix</var></dt>
     <dd>
      <span class="simpara">The namespace prefix of the attribute.</span>
     </dd>
    
    
     <dt id="dom-namespaceinfo.props.namespaceuri"><var class="varname">namespaceURI</var></dt>
     <dd>
      <span class="simpara">The namespace <abbr class="abbrev">URI</abbr> of the attribute.</span>
     </dd>
    
    
     <dt id="dom-namespaceinfo.props.element"><var class="varname">element</var></dt>
     <dd>
      <span class="simpara">The element that this namespace information is about.</span>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-namespaceinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-namespaceinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-namespaceinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-namespaceinfo.php">＋<small>add a note</small></a></span>
