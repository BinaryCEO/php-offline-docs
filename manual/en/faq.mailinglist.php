...
<head>
  ...
  <title>PHP: Mailing lists - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/faq.mailinglist.php">
 <link rel="shorturl" href="https://www.php.net/mailinglist">
 <link rel="alternate" href="https://www.php.net/mailinglist" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/faq.php">
 <link rel="prev" href="https://www.php.net/manual/en/faq.general.php">
 <link rel="next" href="https://www.php.net/manual/en/faq.obtaining.php">

 <link rel="alternate" href="https://www.php.net/manual/en/faq.mailinglist.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/faq.mailinglist.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/faq.mailinglist.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/faq.mailinglist.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/faq.mailinglist.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/faq.mailinglist.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/faq.mailinglist.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/faq.mailinglist.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/faq.mailinglist.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/faq.mailinglist.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/faq.mailinglist.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Mailing lists - Manual" />
<meta name="twitter:description" content="Mailing lists" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Mailing lists - Manual" />
<meta itemprop="description" content="Mailing lists" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Mailing lists" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/faq.mailinglist.php' selected="selected">English</option>
            <option value='de/faq.mailinglist.php'>German</option>
            <option value='es/faq.mailinglist.php'>Spanish</option>
            <option value='fr/faq.mailinglist.php'>French</option>
            <option value='it/faq.mailinglist.php'>Italian</option>
            <option value='ja/faq.mailinglist.php'>Japanese</option>
            <option value='pt_BR/faq.mailinglist.php'>Brazilian Portuguese</option>
            <option value='ru/faq.mailinglist.php'>Russian</option>
            <option value='tr/faq.mailinglist.php'>Turkish</option>
            <option value='uk/faq.mailinglist.php'>Ukrainian</option>
            <option value='zh/faq.mailinglist.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="faq.mailinglist" class="chapter">
   ...
   <dl class="qandaentry" id="faq.mailinglist.isthere">
    ...
    <dd class="answer">
     <p class="para">
      ...
      <a href="https://www.php.net/mailing-lists.php" class="link external">&raquo;&nbsp;mailing list</a> page.
     </p>
     <p class="para">
      The most general mailing list is <code class="literal">php-general</code>.
     ...
     <p class="para">
      ...
      interface on our <a href="https://www.php.net/mailing-lists.php" class="link external">&raquo;&nbsp;mailing list</a>
   ...
   <dl class="qandaentry" id="faq.mailinglist.others">
    ...
    <dd class="answer">
     <p class="para">
      ...
      on our <a href="https://www.php.net/support.php" class="link external">&raquo;&nbsp;Support</a> page.
     </p>
    </dd>
   </dl>
   ...
   <dl class="qandaentry" id="faq.mailinglist.subscribing">
    ...
    <dd class="answer">
     <p class="para">
      ...
      your email address is <code class="literal">elephpant@example.com</code>, but you
      subscribed to the mailing list with the forwarder
      <code class="literal">php-lists@example.com</code> and forward that to
      <code class="literal">elephpant@example.com</code>, attempting to unsubscribe
      <code class="literal">elephpant@example.com</code> will not work, as that address
      ...
      <code class="literal">php-lists@example.com</code>.
     </p>
    </dd>
   </dl>
   ...
   <dl class="qandaentry" id="faq.mailinglist.question">
    ...
    <dd class="answer">
     ...
     <p class="para">
      ...
      the <code class="literal">php-install</code> mailing list.  A caveat: some lists
      ...
      list, <em>not</em> to the Windows Internals list.
     </p>
     <p class="para">
   ...
   <dl class="qandaentry" id="faq.mailinglist.guideline">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/faq/mailinglist.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffaq.mailinglist%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=faq.mailinglist&amp;repo=en&amp;redirect=https://www.php.net/manual/en/faq.mailinglist.php">＋<small>add a note</small></a></span>
