...
<head>
  ...
  <title>PHP: GearmanClient::doStatus - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.dostatus.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.dostatus.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dostatus.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.donormal.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.echo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dostatus.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.dostatus.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.dostatus.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.dostatus.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.dostatus.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.dostatus.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.dostatus.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.dostatus.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.dostatus.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.dostatus.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.dostatus.php" hreflang="zh">
...
<meta name="Description" content="Get the status for the running task" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doStatus - Manual" />
<meta name="twitter:description" content="Get the status for the running task" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doStatus - Manual" />
<meta itemprop="description" content="Get the status for the running task" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the status for the running task" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.echo.php">
          GearmanClient::echo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.donormal.php">
          &laquo; GearmanClient::doNormal        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.dostatus.php' selected="selected">English</option>
            <option value='de/gearmanclient.dostatus.php'>German</option>
            <option value='es/gearmanclient.dostatus.php'>Spanish</option>
            <option value='fr/gearmanclient.dostatus.php'>French</option>
            <option value='it/gearmanclient.dostatus.php'>Italian</option>
            <option value='ja/gearmanclient.dostatus.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.dostatus.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.dostatus.php'>Russian</option>
            <option value='tr/gearmanclient.dostatus.php'>Turkish</option>
            <option value='uk/gearmanclient.dostatus.php'>Ukrainian</option>
            <option value='zh/gearmanclient.dostatus.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.dostatus" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanjob.status.php" class="methodname" rel="rdfs-seeAlso">GearmanJob::status()</a> - Send status (deprecated)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/dostatus.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.dostatus%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.dostatus&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dostatus.php">＋<small>add a note</small></a></span>
