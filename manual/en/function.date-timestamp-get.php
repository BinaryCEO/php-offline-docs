...
<head>
  ...
  <title>PHP: date_timestamp_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.date-timestamp-get.php">
 <link rel="shorturl" href="https://www.php.net/date-timestamp-get">
 <link rel="alternate" href="https://www.php.net/date-timestamp-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.date-time-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.date-timestamp-set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.date-timestamp-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.date-timestamp-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.date-timestamp-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.date-timestamp-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.date-timestamp-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.date-timestamp-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.date-timestamp-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.date-timestamp-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.date-timestamp-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.date-timestamp-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.date-timestamp-get.php" hreflang="zh">
...
<meta name="Description" content="Alias of DateTime::getTimestamp" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: date_timestamp_get - Manual" />
<meta name="twitter:description" content="Alias of DateTime::getTimestamp" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: date_timestamp_get - Manual" />
<meta itemprop="description" content="Alias of DateTime::getTimestamp" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of DateTime::getTimestamp" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.date-timestamp-set.php">
          date_timestamp_set &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.date-time-set.php">
          &laquo; date_time_set        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.date-timestamp-get.php' selected="selected">English</option>
            <option value='de/function.date-timestamp-get.php'>German</option>
            <option value='es/function.date-timestamp-get.php'>Spanish</option>
            <option value='fr/function.date-timestamp-get.php'>French</option>
            <option value='it/function.date-timestamp-get.php'>Italian</option>
            <option value='ja/function.date-timestamp-get.php'>Japanese</option>
            <option value='pt_BR/function.date-timestamp-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.date-timestamp-get.php'>Russian</option>
            <option value='tr/function.date-timestamp-get.php'>Turkish</option>
            <option value='uk/function.date-timestamp-get.php'>Ukrainian</option>
            <option value='zh/function.date-timestamp-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.date-timestamp-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">date_timestamp_get</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">date_timestamp_get</span> &mdash; <span class="dc-title">Alias of <span class="methodname"><a href="datetime.gettimestamp.php" class="methodname">DateTime::getTimestamp()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.date-timestamp-get-description">
  <h3 class="title">Description</h3>
  <p class="para">
   This function is an alias of:  <span class="methodname"><a href="datetime.gettimestamp.php" class="methodname">DateTime::getTimestamp()</a></span>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/date-timestamp-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.date-timestamp-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.date-timestamp-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.date-timestamp-get.php">＋<small>add a note</small></a></span>
