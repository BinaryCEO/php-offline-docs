...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-info.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-get-server-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-insert-id.php">
...
<meta name="Description" content="Get information about the most recent query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_info - Manual" />
<meta name="twitter:description" content="Get information about the most recent query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_info - Manual" />
<meta itemprop="description" content="Get information about the most recent query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get information about the most recent query" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-info.php' selected="selected">English</option>
            <option value='de/function.mysql-info.php'>German</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-stat.php" class="function" rel="rdfs-seeAlso">mysql_stat()</a> - Get current system status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-info.php">＋<small>add a note</small></a></span>
