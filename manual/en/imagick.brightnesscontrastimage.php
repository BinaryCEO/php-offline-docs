...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.brightnesscontrastimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.brightnesscontrastimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.brightnesscontrastimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.borderimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.charcoalimage.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.brightnesscontrastimage.php' selected="selected">English</option>
            <option value='de/imagick.brightnesscontrastimage.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.brightnesscontrastimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-2975">
      <p><strong>Example #1  <span class="function"><strong>Imagick::brightnessContrastImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/brightnesscontrastimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.brightnesscontrastimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.brightnesscontrastimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.brightnesscontrastimage.php">＋<small>add a note</small></a></span>
