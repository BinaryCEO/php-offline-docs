...
<head>
  ...
  <title>PHP: ReflectionClass::inNamespace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.innamespace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.innamespace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.innamespace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.initializelazyobject.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isabstract.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.innamespace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.innamespace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.innamespace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.innamespace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.innamespace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.innamespace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.innamespace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.innamespace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.innamespace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.innamespace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.innamespace.php" hreflang="zh">
...
<meta name="Description" content="Checks if in namespace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::inNamespace - Manual" />
<meta name="twitter:description" content="Checks if in namespace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::inNamespace - Manual" />
<meta itemprop="description" content="Checks if in namespace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if in namespace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isabstract.php">
          ReflectionClass::isAbstract &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.initializelazyobject.php">
          &laquo; ReflectionClass::initializeLazyObject        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.innamespace.php' selected="selected">English</option>
            <option value='de/reflectionclass.innamespace.php'>German</option>
            <option value='es/reflectionclass.innamespace.php'>Spanish</option>
            <option value='fr/reflectionclass.innamespace.php'>French</option>
            <option value='it/reflectionclass.innamespace.php'>Italian</option>
            <option value='ja/reflectionclass.innamespace.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.innamespace.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.innamespace.php'>Russian</option>
            <option value='tr/reflectionclass.innamespace.php'>Turkish</option>
            <option value='uk/reflectionclass.innamespace.php'>Ukrainian</option>
            <option value='zh/reflectionclass.innamespace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.innamespace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::inNamespace</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::inNamespace</span> &mdash; <span class="dc-title">Checks if in namespace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.innamespace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::inNamespace</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.innamespace-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.innamespace-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.innamespace-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5495">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::inNamespace()</strong></span> example</strong></p>
...
string(3) &quot;Foo&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.innamespace-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getnamespacename.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getNamespaceName()</a> - Gets namespace name</span></li>
    <li><a href="language.namespaces.php" class="link">PHP Namespaces</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/innamespace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.innamespace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.innamespace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.innamespace.php">＋<small>add a note</small></a></span>
