...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds-map.ksorted.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds-map.ksorted.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds-map.ksorted.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ds-map.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds-map.ksort.php">
 <link rel="next" href="https://www.php.net/manual/en/ds-map.last.php">
...
<meta name="Description" content="Returns a copy, sorted by key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Ds\Map::ksorted - Manual" />
<meta name="twitter:description" content="Returns a copy, sorted by key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Ds\Map::ksorted - Manual" />
<meta itemprop="description" content="Returns a copy, sorted by key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a copy, sorted by key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds-map.ksorted.php' selected="selected">English</option>
            ...
            <option value='ru/ds-map.ksorted.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">Ds\Map::ksorted</span> &mdash; <span class="dc-title">Returns a copy, sorted by key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-ds-map.ksorted-description">
  ...
  <p class="para rdfs-comment">
    Returns a copy sorted by key, using an optional <code class="parameter">comparator</code> function.
  </p>
...
<div class="caution"><strong class="caution">Caution</strong>
 ...
 <div class="refsect1 examples" id="refsect1-ds-map.ksorted-examples">
  ...
  <div class="example" id="example-4386">
   <p><strong>Example #1 <span class="function"><strong>Ds\Map::ksorted()</strong></span> example</strong></p>
...
(
  ...
  <div class="example" id="example-4387">
   <p><strong>Example #2 <span class="function"><strong>Ds\Map::ksorted()</strong></span> example using a comparator</strong></p>
   <div class="example-contents">
...
(
    ...
    [2] =&gt; Ds\Pair Object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/ds/map/ksorted.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds-map.ksorted%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds-map.ksorted&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds-map.ksorted.php">＋<small>add a note</small></a></span>
