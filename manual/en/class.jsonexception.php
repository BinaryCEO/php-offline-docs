...
<head>
  ...
  <title>PHP: JsonException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.jsonexception.php">
 <link rel="shorturl" href="https://www.php.net/jsonexception">
 <link rel="alternate" href="https://www.php.net/jsonexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.json.php">
 <link rel="prev" href="https://www.php.net/manual/en/json.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/class.jsonserializable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.jsonexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.jsonexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.jsonexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.jsonexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.jsonexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.jsonexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.jsonexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.jsonexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.jsonexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.jsonexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.jsonexception.php" hreflang="zh">
...
<meta name="Description" content="The JsonException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: JsonException - Manual" />
<meta name="twitter:description" content="The JsonException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: JsonException - Manual" />
<meta itemprop="description" content="The JsonException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The JsonException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.jsonserializable.php">
          JsonSerializable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="json.constants.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.jsonexception.php' selected="selected">English</option>
            <option value='de/class.jsonexception.php'>German</option>
            <option value='es/class.jsonexception.php'>Spanish</option>
            <option value='fr/class.jsonexception.php'>French</option>
            <option value='it/class.jsonexception.php'>Italian</option>
            <option value='ja/class.jsonexception.php'>Japanese</option>
            <option value='pt_BR/class.jsonexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.jsonexception.php'>Russian</option>
            <option value='tr/class.jsonexception.php'>Turkish</option>
            <option value='uk/class.jsonexception.php'>Ukrainian</option>
            <option value='zh/class.jsonexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.jsonexception" class="reference">
 <h1 class="title">The JsonException class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p>
  ...
  <div class="section" id="jsonexception.intro">
   ...
   <p class="para">
    Exception thrown if <strong><code><a href="json.constants.php#constant.json-throw-on-error">JSON_THROW_ON_ERROR</a></code></strong> option is
    set for <span class="function"><a href="function.json-encode.php" class="function">json_encode()</a></span> or
    <span class="function"><a href="function.json-decode.php" class="function">json_decode()</a></span>. <var class="varname">code</var> contains the error
    type, for possible values see <span class="function"><a href="function.json-last-error.php" class="function">json_last_error()</a></span>.
   </p>
  </div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/json/jsonexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.jsonexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.jsonexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.jsonexception.php">＋<small>add a note</small></a></span>
