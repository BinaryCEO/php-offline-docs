...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.enchant-broker-init.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.enchant-broker-get-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.enchant-broker-list-dicts.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.enchant-broker-init.php' selected="selected">English</option>
            ...
            <option value='it/function.enchant-broker-init.php'>Italian</option>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.enchant-broker-free.php" class="function" rel="rdfs-seeAlso">enchant_broker_free()</a> - Free the broker resource and its dictionaries</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/enchant/functions/enchant-broker-init.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.enchant-broker-init%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.enchant-broker-init&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.enchant-broker-init.php">＋<small>add a note</small></a></span>
