...
<head>
  ...
  <title>PHP: RangeException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.rangeexception.php">
 <link rel="shorturl" href="https://www.php.net/rangeexception">
 <link rel="alternate" href="https://www.php.net/rangeexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.overflowexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.runtimeexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.rangeexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.rangeexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.rangeexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.rangeexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.rangeexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.rangeexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.rangeexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.rangeexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.rangeexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.rangeexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.rangeexception.php" hreflang="zh">
...
<meta name="Description" content="The RangeException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: RangeException - Manual" />
<meta name="twitter:description" content="The RangeException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: RangeException - Manual" />
<meta itemprop="description" content="The RangeException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The RangeException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.runtimeexception.php">
          RuntimeException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.overflowexception.php">
          &laquo; OverflowException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.rangeexception.php' selected="selected">English</option>
            <option value='de/class.rangeexception.php'>German</option>
            <option value='es/class.rangeexception.php'>Spanish</option>
            <option value='fr/class.rangeexception.php'>French</option>
            <option value='it/class.rangeexception.php'>Italian</option>
            <option value='ja/class.rangeexception.php'>Japanese</option>
            <option value='pt_BR/class.rangeexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.rangeexception.php'>Russian</option>
            <option value='tr/class.rangeexception.php'>Turkish</option>
            <option value='uk/class.rangeexception.php'>Ukrainian</option>
            <option value='zh/class.rangeexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.rangeexception" class="reference">
 <h1 class="title">The RangeException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="rangeexception.intro">
   ...
   <p class="para">
    ...
    <span class="classname"><a href="class.domainexception.php" class="classname">DomainException</a></span>.
   </p>
  </div>

 
  <div class="section" id="rangeexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">RangeException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/rangeexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.rangeexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.rangeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.rangeexception.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120535">  <div class="votes">
    <div id="Vu120535">
    <a href="/manual/vote-note.php?id=120535&amp;page=class.rangeexception&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120535">
    <a href="/manual/vote-note.php?id=120535&amp;page=class.rangeexception&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120535" title="60% like this...">
    2
    </div>
  </div>
  <a href="#120535" class="name">
  <strong class="user"><em>evguenia dot chagnon at gmail dot com</em></strong></a><a class="genanchor" href="#120535"> &para;</a><div class="date" title="2017-01-26 01:30"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120535">
<div class="phpcode"><code><span class="html">CF. DomainException  : "DomainException corresponds to RangeException and we should use them in simillar situations.  But first exception is designed to use when we are sure the problem is with our project, third-part elements etc. (simply: logical error), the second way is designed to use when we are sure the problem is with input data or environment (simply: runtime error)."<br /><br />function divide($divident, $input) {<br />    if(!is_numeric($divident) || !is_numeric($input)) {<br />        throw new InvalidArgumentException("Function accepts only numeric values");<br />    }<br />    if($input == 0) {<br />        throw new RangeException("Divisor must not be zero");<br />    }<br />    return $divident / $input;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.rangeexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.rangeexception.php">＋<small>add a note</small></a></div>
