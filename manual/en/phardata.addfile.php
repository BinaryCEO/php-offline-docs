...
<head>
  ...
  <title>PHP: PharData::addFile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phardata.addfile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phardata.addfile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phardata.addfile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phardata.php">
 <link rel="prev" href="https://www.php.net/manual/en/phardata.addemptydir.php">
 <link rel="next" href="https://www.php.net/manual/en/phardata.addfromstring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phardata.addfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phardata.addfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phardata.addfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phardata.addfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phardata.addfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phardata.addfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phardata.addfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phardata.addfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phardata.addfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phardata.addfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phardata.addfile.php" hreflang="zh">
...
<meta name="Description" content="Add a file from the filesystem to the tar/zip archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PharData::addFile - Manual" />
<meta name="twitter:description" content="Add a file from the filesystem to the tar/zip archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PharData::addFile - Manual" />
<meta itemprop="description" content="Add a file from the filesystem to the tar/zip archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a file from the filesystem to the tar/zip archive" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phardata.addfromstring.php">
          PharData::addFromString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phardata.addemptydir.php">
          &laquo; PharData::addEmptyDir        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phardata.addfile.php' selected="selected">English</option>
            <option value='de/phardata.addfile.php'>German</option>
            <option value='es/phardata.addfile.php'>Spanish</option>
            <option value='fr/phardata.addfile.php'>French</option>
            <option value='it/phardata.addfile.php'>Italian</option>
            <option value='ja/phardata.addfile.php'>Japanese</option>
            <option value='pt_BR/phardata.addfile.php'>Brazilian Portuguese</option>
            <option value='ru/phardata.addfile.php'>Russian</option>
            <option value='tr/phardata.addfile.php'>Turkish</option>
            <option value='uk/phardata.addfile.php'>Ukrainian</option>
            <option value='zh/phardata.addfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phardata.addfile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">PharData::addFile</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">PharData::addFile</span> &mdash; <span class="dc-title">Add a file from the filesystem to the tar/zip archive</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phardata.addfile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>PharData::addFile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$localName</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>


  <p class="para rdfs-comment">
   With this method, any file or URL can be added to the tar/zip archive.  If
   the optional second parameter <code class="literal">localname</code> is specified,
 ...
 <div class="refsect1 changelog" id="refsect1-phardata.addfile-changelog">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$a </span><span style="color: #007700">= new </span><span style="color: #0000BB">PharData</span><span style="color: #007700">(</span><span style="color: #DD0000">'/path/to/my.tar'</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'/full/path/to/file'</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// demonstrates how this file is stored<br />    </span><span style="color: #0000BB">$b </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'full/path/to/file'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getContent</span><span style="color: #007700">();<br /><br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'/full/path/to/file'</span><span style="color: #007700">, </span><span style="color: #DD0000">'my/file.txt'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$c </span><span style="color: #007700">= </span><span style="color: #0000BB">$a</span><span style="color: #007700">[</span><span style="color: #DD0000">'my/file.txt'</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getContent</span><span style="color: #007700">();<br /><br />    </span><span style="color: #FF8000">// demonstrate URL usage<br />    </span><span style="color: #0000BB">$a</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addFile</span><span style="color: #007700">(</span><span style="color: #DD0000">'http://www.example.com'</span><span style="color: #007700">, </span><span style="color: #DD0000">'example.html'</span><span style="color: #007700">);<br />} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle errors here<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-phardata.addfile-notes">
  <h3 class="title">Notes</h3>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
 <span class="simpara">
  <span class="function"><strong>PharData::addFile()</strong></span>, <span class="function"><a href="phardata.addfromstring.php" class="function">PharData::addFromString()</a></span> and <span class="function"><a href="phardata.offsetset.php" class="function">PharData::offsetSet()</a></span>
 ...
 <div class="refsect1 seealso" id="refsect1-phardata.addfile-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.addfile.php" class="function" rel="rdfs-seeAlso">Phar::addFile()</a> - Add a file from the filesystem to the phar archive</span></li>
    ...
    <li><span class="function"><a href="phardata.addemptydir.php" class="function" rel="rdfs-seeAlso">PharData::addEmptyDir()</a> - Add an empty directory to the tar/zip archive</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/PharData/addFile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphardata.addfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phardata.addfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phardata.addfile.php">＋<small>add a note</small></a></span>
