...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupoffset.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupoffset.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupoffset.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupngroups.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgrouptruncate.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupoffset.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupoffset.php'>German</option>
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupoffset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupoffset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupoffset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupoffset.php">＋<small>add a note</small></a></span>
