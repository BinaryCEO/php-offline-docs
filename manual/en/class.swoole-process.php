...
<head>
  ...
  <title>PHP: Swoole\Process - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.swoole-process.php">
 <link rel="shorturl" href="https://www.php.net/swoole-process">
 <link rel="alternate" href="https://www.php.net/swoole-process" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.swoole.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.swoole-mysql-exception.php">
 <link rel="next" href="https://www.php.net/manual/en/swoole-process.alarm.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.swoole-process.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.swoole-process.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.swoole-process.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.swoole-process.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.swoole-process.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.swoole-process.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.swoole-process.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.swoole-process.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.swoole-process.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.swoole-process.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.swoole-process.php" hreflang="zh">
...
<meta name="Description" content="The Swoole\Process class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Swoole\Process - Manual" />
<meta name="twitter:description" content="The Swoole\Process class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Swoole\Process - Manual" />
<meta itemprop="description" content="The Swoole\Process class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Swoole\Process class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="swoole-process.alarm.php">
          Swoole\Process::alarm &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.swoole-mysql-exception.php">
          &laquo; Swoole\MySQL\Exception        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.swoole-process.php' selected="selected">English</option>
            <option value='de/class.swoole-process.php'>German</option>
            <option value='es/class.swoole-process.php'>Spanish</option>
            <option value='fr/class.swoole-process.php'>French</option>
            <option value='it/class.swoole-process.php'>Italian</option>
            <option value='ja/class.swoole-process.php'>Japanese</option>
            <option value='pt_BR/class.swoole-process.php'>Brazilian Portuguese</option>
            <option value='ru/class.swoole-process.php'>Russian</option>
            <option value='tr/class.swoole-process.php'>Turkish</option>
            <option value='uk/class.swoole-process.php'>Ukrainian</option>
            <option value='zh/class.swoole-process.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.swoole-process" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="swoole-process.alarm.php">Swoole\Process::alarm</a> — High precision timer which triggers signal with fixed interval.</li><li><a href="swoole-process.close.php">Swoole\Process::close</a> — Close the pipe to the child process.</li><li><a href="swoole-process.construct.php">Swoole\Process::__construct</a> — Construct a process.</li><li><a href="swoole-process.daemon.php">Swoole\Process::daemon</a> — Change the process to be a daemon process.</li><li><a href="swoole-process.destruct.php">Swoole\Process::__destruct</a> — Destroy the process.</li><li><a href="swoole-process.exec.php">Swoole\Process::exec</a> — Execute system commands.</li><li><a href="swoole-process.exit.php">Swoole\Process::exit</a> — Stop the child processes.</li><li><a href="swoole-process.freequeue.php">Swoole\Process::freeQueue</a> — Destroy the message queue created by swoole_process::useQueue.</li><li><a href="swoole-process.kill.php">Swoole\Process::kill</a> — Send signal to the child process.</li><li><a href="swoole-process.name.php">Swoole\Process::name</a> — Set name of the process.</li><li><a href="swoole-process.pop.php">Swoole\Process::pop</a> — Read and pop data from the message queue.</li><li><a href="swoole-process.push.php">Swoole\Process::push</a> — Write and push data into the message queue.</li><li><a href="swoole-process.read.php">Swoole\Process::read</a> — Read data sending to the process.</li><li><a href="swoole-process.signal.php">Swoole\Process::signal</a> — Send signal to the child processes.</li><li><a href="swoole-process.start.php">Swoole\Process::start</a> — Start the process.</li><li><a href="swoole-process.statqueue.php">Swoole\Process::statQueue</a> — Get the stats of the message queue used as the communication method between processes.</li><li><a href="swoole-process.usequeue.php">Swoole\Process::useQueue</a> — Create a message queue as the communication method between the parent process and child processes.</li><li><a href="swoole-process.wait.php">Swoole\Process::wait</a> — Wait for the events of child processes.</li><li><a href="swoole-process.write.php">Swoole\Process::write</a> — Write data into the pipe and communicate with the parent process or child processes.</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/swoole/swoole.process.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.swoole-process%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.swoole-process&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.swoole-process.php">＋<small>add a note</small></a></span>
