...
<head>
  ...
  <title>PHP: fbird_blob_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-blob-get.php">
 <link rel="shorturl" href="https://www.php.net/fbird-blob-get">
 <link rel="alternate" href="https://www.php.net/fbird-blob-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-blob-echo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-blob-import.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-blob-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-blob-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-blob-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-blob-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-blob-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-blob-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-blob-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-blob-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-blob-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-blob-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-blob-get.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_blob_get" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_blob_get - Manual" />
<meta name="twitter:description" content="Alias of ibase_blob_get" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_blob_get - Manual" />
<meta itemprop="description" content="Alias of ibase_blob_get" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_blob_get" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fbird-blob-import.php">
          fbird_blob_import &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-blob-echo.php">
          &laquo; fbird_blob_echo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-blob-get.php' selected="selected">English</option>
            <option value='de/function.fbird-blob-get.php'>German</option>
            <option value='es/function.fbird-blob-get.php'>Spanish</option>
            <option value='fr/function.fbird-blob-get.php'>French</option>
            <option value='it/function.fbird-blob-get.php'>Italian</option>
            <option value='ja/function.fbird-blob-get.php'>Japanese</option>
            <option value='pt_BR/function.fbird-blob-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-blob-get.php'>Russian</option>
            <option value='tr/function.fbird-blob-get.php'>Turkish</option>
            <option value='uk/function.fbird-blob-get.php'>Ukrainian</option>
            <option value='zh/function.fbird-blob-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-blob-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_blob_get</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_blob_get</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-blob-get.php" class="function">ibase_blob_get()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-blob-get-description">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fbird-blob-get-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fbird-blob-echo.php" class="function" rel="rdfs-seeAlso">fbird_blob_echo()</a> - Alias of ibase_blob_echo</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-blob-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-blob-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-blob-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-blob-get.php">＋<small>add a note</small></a></span>
