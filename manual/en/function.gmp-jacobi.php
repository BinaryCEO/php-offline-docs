...
<head>
  ...
  <title>PHP: gmp_jacobi - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-jacobi.php">
 <link rel="shorturl" href="https://www.php.net/gmp-jacobi">
 <link rel="alternate" href="https://www.php.net/gmp-jacobi" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-invert.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-kronecker.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-jacobi.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-jacobi.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-jacobi.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-jacobi.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-jacobi.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-jacobi.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-jacobi.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-jacobi.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-jacobi.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-jacobi.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-jacobi.php" hreflang="zh">
...
<meta name="Description" content="Jacobi symbol" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_jacobi - Manual" />
<meta name="twitter:description" content="Jacobi symbol" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_jacobi - Manual" />
<meta itemprop="description" content="Jacobi symbol" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Jacobi symbol" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-jacobi.php' selected="selected">English</option>
            <option value='de/function.gmp-jacobi.php'>German</option>
            <option value='es/function.gmp-jacobi.php'>Spanish</option>
            <option value='fr/function.gmp-jacobi.php'>French</option>
            <option value='it/function.gmp-jacobi.php'>Italian</option>
            <option value='ja/function.gmp-jacobi.php'>Japanese</option>
            <option value='pt_BR/function.gmp-jacobi.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-jacobi.php'>Russian</option>
            <option value='tr/function.gmp-jacobi.php'>Turkish</option>
            <option value='uk/function.gmp-jacobi.php'>Ukrainian</option>
            <option value='zh/function.gmp-jacobi.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-jacobi" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_jacobi</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_jacobi</span> &mdash; <span class="dc-title">Jacobi symbol</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-jacobi-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_jacobi</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num1</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num2</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Computes
   <a href="http://primes.utm.edu/glossary/page.php?sort=JacobiSymbol" class="link external">&raquo;&nbsp;Jacobi symbol</a> of <code class="parameter">num1</code> and
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-jacobi-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-jacobi-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-jacobi-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3331">
    <p><strong>Example #1 <span class="function"><strong>gmp_jacobi()</strong></span> example</strong></p>
...
0</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.gmp-jacobi-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.gmp-legendre.php" class="function" rel="rdfs-seeAlso">gmp_legendre()</a> - Legendre symbol</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-jacobi.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-jacobi%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-jacobi&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-jacobi.php">＋<small>add a note</small></a></span>
