...
<head>
  ...
  <title>PHP: Imagick::setColorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setcolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setcolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setbackgroundcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setcompression.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setcolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setcolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setcolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setcolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setcolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setcolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setcolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setcolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setcolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setcolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setcolorspace.php" hreflang="zh">
...
<meta name="Description" content="Set colorspace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setColorspace - Manual" />
<meta name="twitter:description" content="Set colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setColorspace - Manual" />
<meta itemprop="description" content="Set colorspace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set colorspace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setcompression.php">
          Imagick::setCompression &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setbackgroundcolor.php">
          &laquo; Imagick::setBackgroundColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setcolorspace.php' selected="selected">English</option>
            <option value='de/imagick.setcolorspace.php'>German</option>
            <option value='es/imagick.setcolorspace.php'>Spanish</option>
            <option value='fr/imagick.setcolorspace.php'>French</option>
            <option value='it/imagick.setcolorspace.php'>Italian</option>
            <option value='ja/imagick.setcolorspace.php'>Japanese</option>
            <option value='pt_BR/imagick.setcolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setcolorspace.php'>Russian</option>
            <option value='tr/imagick.setcolorspace.php'>Turkish</option>
            <option value='uk/imagick.setcolorspace.php'>Ukrainian</option>
            <option value='zh/imagick.setcolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setcolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setColorspace</h1>
  <p class="verinfo">(PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setColorspace</span> &mdash; <span class="dc-title">Set colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setcolorspace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setColorspace</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$COLORSPACE</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setcolorspace-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setcolorspace-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setcolorspace-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setcolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setcolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setcolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setcolorspace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124858">  <div class="votes">
    <div id="Vu124858">
    <a href="/manual/vote-note.php?id=124858&amp;page=imagick.setcolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124858">
    <a href="/manual/vote-note.php?id=124858&amp;page=imagick.setcolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124858" title="71% like this...">
    3
    </div>
  </div>
  <a href="#124858" class="name">
  <strong class="user"><em>simonjjarrett at gmail dot com</em></strong></a><a class="genanchor" href="#124858"> &para;</a><div class="date" title="2020-03-26 05:29"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124858">
<div class="phpcode"><code><span class="html">This method has to be called BEFORE any files are loaded into the Imagick object.<br /><br />By default, Imagick will incorrectly read CMYK PDFs - it will read each channel as a greyscale page resulting in 4 times the number of pages. By specifying the desired colorspace (usually SRGB) before reading the file, GhostScript will automatically convert it.<br /><br /><span class="default">&lt;?php<br />$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /><br /></span><span class="comment">// set the sampling resolution<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setResolution</span><span class="keyword">(</span><span class="default">200</span><span class="keyword">,</span><span class="default">200</span><span class="keyword">);<br /><br /></span><span class="comment">// set the desired format<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">SetColorspace</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COLORSPACE_SRGB</span><span class="keyword">);<br /><br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readimage</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">[</span><span class="string">'tmp_name'</span><span class="keyword">]);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116407">  <div class="votes">
    <div id="Vu116407">
    <a href="/manual/vote-note.php?id=116407&amp;page=imagick.setcolorspace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116407">
    <a href="/manual/vote-note.php?id=116407&amp;page=imagick.setcolorspace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116407" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#116407" class="name">
  <strong class="user"><em>T</em></strong></a><a class="genanchor" href="#116407"> &para;</a><div class="date" title="2014-12-28 09:20"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116407">
<div class="phpcode"><code><span class="html">Right now this function doesn't appear to do anything, ref: <a href="http://stackoverflow.com/q/10739822/2685496" rel="nofollow" target="_blank">http://stackoverflow.com/q/10739822/2685496</a>
<br />
<br />As mentioned in the answer, modulateImage works fine as a replacement for converting to gray scale.
<br />
<br /><span class="default">&lt;?php
<br />
<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"input.jpg"</span><span class="keyword">);
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">modulateImage</span><span class="keyword">(</span><span class="default">100</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">);
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">"output.jpg"</span><span class="keyword">);
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">clear</span><span class="keyword">();
<br />
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setcolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setcolorspace.php">＋<small>add a note</small></a></div>
