...
<head>
  ...
  <title>PHP: fbird_param_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-param-info.php">
 <link rel="shorturl" href="https://www.php.net/fbird-param-info">
 <link rel="alternate" href="https://www.php.net/fbird-param-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-num-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-pconnect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-param-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-param-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-param-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-param-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-param-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-param-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-param-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-param-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-param-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-param-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-param-info.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_param_info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_param_info - Manual" />
<meta name="twitter:description" content="Alias of ibase_param_info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_param_info - Manual" />
<meta itemprop="description" content="Alias of ibase_param_info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_param_info" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-pconnect.php">
          fbird_pconnect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-num-params.php">
          &laquo; fbird_num_params        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-param-info.php' selected="selected">English</option>
            <option value='de/function.fbird-param-info.php'>German</option>
            <option value='es/function.fbird-param-info.php'>Spanish</option>
            <option value='fr/function.fbird-param-info.php'>French</option>
            <option value='it/function.fbird-param-info.php'>Italian</option>
            <option value='ja/function.fbird-param-info.php'>Japanese</option>
            <option value='pt_BR/function.fbird-param-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-param-info.php'>Russian</option>
            <option value='tr/function.fbird-param-info.php'>Turkish</option>
            <option value='uk/function.fbird-param-info.php'>Ukrainian</option>
            <option value='zh/function.fbird-param-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-param-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_param_info</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_param_info</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-param-info.php" class="function">ibase_param_info()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-param-info-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-param-info.php" class="function">ibase_param_info()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fbird-param-info-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-field-info.php" class="function" rel="rdfs-seeAlso">fbird_field_info()</a> - Alias of ibase_field_info</span></li>
    <li><span class="function"><a href="function.fbird-num-params.php" class="function" rel="rdfs-seeAlso">fbird_num_params()</a> - Alias of ibase_num_params</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-param-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-param-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-param-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-param-info.php">＋<small>add a note</small></a></span>
