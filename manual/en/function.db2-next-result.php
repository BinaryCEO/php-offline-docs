...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-next-result.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-lob-read.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-num-fields.php">
...
<meta name="Description" content="Requests the next result set from a stored procedure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_next_result - Manual" />
<meta name="twitter:description" content="Requests the next result set from a stored procedure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_next_result - Manual" />
<meta itemprop="description" content="Requests the next result set from a stored procedure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Requests the next result set from a stored procedure" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-next-result.php' selected="selected">English</option>
            <option value='de/function.db2-next-result.php'>German</option>
            <option value='es/function.db2-next-result.php'>Spanish</option>
            <option value='fr/function.db2-next-result.php'>French</option>
...
array(1) {
  ...
  string(16) &quot;Gizmo           &quot;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-next-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-next-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-next-result.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Some not so obvious but imported notes:<br /><br />1) You must always use the original statement return when fetching the next result set.<br />2) You can not remove a reference to a previous result set if you wish to access another result set.<br /><br />----------------WILL NOT WORK-------------------------<br /><span class="default">&lt;?php<br />$originalStatementReturn </span><span class="keyword">= </span><span class="default">db2_exec</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'CALL multiResults()'</span><span class="keyword">);<br /><br /></span><span class="default">$firstResultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$originalStatementReturn</span><span class="keyword">);<br /><br /></span><span class="default">$secondResultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$firstResultHolder</span><span class="keyword">);<br /><br />if (</span><span class="default">$secondResultHolder</span><span class="keyword">) {<br />  while (</span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_array</span><span class="keyword">(</span><span class="default">$secondResultHolder</span><span class="keyword">)) {<br />     </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$row</span><span class="keyword">);<br />  }<br />}<br /></span><span class="default">?&gt;<br /></span>-----------------------------------------------------------------<br /><br />----------------WILL NOT WORK-------------------------<br /><span class="default">&lt;?php<br />$originalStatementReturn </span><span class="keyword">= </span><span class="default">db2_exec</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'CALL multiResults()'</span><span class="keyword">);<br /><br /></span><span class="default">$resultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$originalStatementReturn</span><span class="keyword">);<br /><br /></span><span class="default">$resultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$originalStatementReturn</span><span class="keyword">);<br /><br />if (</span><span class="default">$resultHolder</span><span class="keyword">) {<br />  while (</span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_array</span><span class="keyword">(</span><span class="default">$resultHolder</span><span class="keyword">)) {<br />     </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$row</span><span class="keyword">);<br />  }<br />}<br /></span><span class="default">?&gt;<br /></span>-----------------------------------------------------------------<br /><br />----------------WILL WORK--------------------------------<br /><span class="default">&lt;?php<br />$originalStatementReturn </span><span class="keyword">= </span><span class="default">db2_exec</span><span class="keyword">(</span><span class="default">$conn</span><span class="keyword">, </span><span class="string">'CALL multiResults()'</span><span class="keyword">);<br /><br /></span><span class="default">$firstResultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$originalStatementReturn</span><span class="keyword">);<br /><br /></span><span class="default">$secondResultHolder </span><span class="keyword">= </span><span class="default">db2_next_result</span><span class="keyword">(</span><span class="default">$originalStatementReturn</span><span class="keyword">);<br /><br />if (</span><span class="default">$secondResultHolder</span><span class="keyword">) {<br />  while (</span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_array</span><span class="keyword">(</span><span class="default">$secondResultHolder</span><span class="keyword">)) {<br />     </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$row</span><span class="keyword">);<br />  }<br />}<br /></span><span class="default">?&gt;<br /></span>-----------------------------------------------------------------</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-next-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-next-result.php">＋<small>add a note</small></a></div>
