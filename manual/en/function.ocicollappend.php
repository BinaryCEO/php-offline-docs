...
<head>
  ...
  <title>PHP: ocicollappend - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicollappend.php">
 <link rel="shorturl" href="https://www.php.net/ocicollappend">
 <link rel="alternate" href="https://www.php.net/ocicollappend" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicloselob.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicollassign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicollappend.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicollappend.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicollappend.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicollappend.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicollappend.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicollappend.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicollappend.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicollappend.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicollappend.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicollappend.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicollappend.php" hreflang="zh">
...
<meta name="Description" content="Alias of OCICollection::append" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicollappend - Manual" />
<meta name="twitter:description" content="Alias of OCICollection::append" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicollappend - Manual" />
<meta itemprop="description" content="Alias of OCICollection::append" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of OCICollection::append" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocicollassign.php">
          ocicollassign &raquo;
              ...
              <div class="prev">
        <a href="function.ocicloselob.php">
          &laquo; ocicloselob        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicollappend.php' selected="selected">English</option>
            <option value='de/function.ocicollappend.php'>German</option>
            <option value='es/function.ocicollappend.php'>Spanish</option>
            <option value='fr/function.ocicollappend.php'>French</option>
            <option value='it/function.ocicollappend.php'>Italian</option>
            <option value='ja/function.ocicollappend.php'>Japanese</option>
            <option value='pt_BR/function.ocicollappend.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicollappend.php'>Russian</option>
            <option value='tr/function.ocicollappend.php'>Turkish</option>
            <option value='uk/function.ocicollappend.php'>Ukrainian</option>
            <option value='zh/function.ocicollappend.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicollappend" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicollappend</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicollappend</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocicollection.append.php" class="function">OCICollection::append()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicollappend-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocicollection.append.php" class="function">OCICollection::append()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicollappend.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicollappend%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicollappend&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicollappend.php">＋<small>add a note</small></a></span>
