...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-driver-server.ispassive.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-driver-server.ispassive.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-driver-server.ispassive.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-driver-server.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-server.ishidden.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-server.isprimary.php">
...
<meta name="Description" content="Checks if this server is a passive member of a replica set" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Server::isPassive - Manual" />
<meta name="twitter:description" content="Checks if this server is a passive member of a replica set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Server::isPassive - Manual" />
<meta itemprop="description" content="Checks if this server is a passive member of a replica set" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if this server is a passive member of a replica set" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-driver-server.ispassive.php' selected="selected">English</option>
            ...
            <option value='fr/mongodb-driver-server.ispassive.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-mongodb-driver-server.ispassive-description">
  ...
  <p class="para rdfs-comment">
   ...
   <a href="https://www.mongodb.com/docs/manual/reference/glossary/#term-passive-member" class="link external">&raquo;&nbsp;passive member</a>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mongodb-driver-server.ispassive-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if this server is a passive member of a replica set, and
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="mongodb-driver-server.getinfo.php" class="function" rel="rdfs-seeAlso">MongoDB\Driver\Server::getInfo()</a> - Returns an array of information describing this server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/server/ispassive.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-driver-server.ispassive%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-driver-server.ispassive&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-driver-server.ispassive.php">＋<small>add a note</small></a></span>
