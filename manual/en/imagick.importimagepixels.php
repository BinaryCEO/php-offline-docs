...
<head>
  ...
  <title>PHP: Imagick::importImagePixels - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.importimagepixels.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.importimagepixels.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.importimagepixels.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.implodeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.inversefouriertransformimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.importimagepixels.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.importimagepixels.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.importimagepixels.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.importimagepixels.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.importimagepixels.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.importimagepixels.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.importimagepixels.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.importimagepixels.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.importimagepixels.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.importimagepixels.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.importimagepixels.php" hreflang="zh">
...
<meta name="Description" content="Imports image pixels" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::importImagePixels - Manual" />
<meta name="twitter:description" content="Imports image pixels" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::importImagePixels - Manual" />
<meta itemprop="description" content="Imports image pixels" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Imports image pixels" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.inversefouriertransformimage.php">
          Imagick::inverseFourierTransformImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.implodeimage.php">
          &laquo; Imagick::implodeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.importimagepixels.php' selected="selected">English</option>
            <option value='de/imagick.importimagepixels.php'>German</option>
            <option value='es/imagick.importimagepixels.php'>Spanish</option>
            <option value='fr/imagick.importimagepixels.php'>French</option>
            <option value='it/imagick.importimagepixels.php'>Italian</option>
            <option value='ja/imagick.importimagepixels.php'>Japanese</option>
            <option value='pt_BR/imagick.importimagepixels.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.importimagepixels.php'>Russian</option>
            <option value='tr/imagick.importimagepixels.php'>Turkish</option>
            <option value='uk/imagick.importimagepixels.php'>Ukrainian</option>
            <option value='zh/imagick.importimagepixels.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.importimagepixels" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::importImagePixels</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::importImagePixels</span> &mdash; <span class="dc-title">Imports image pixels</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.importimagepixels-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::importImagePixels</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$map</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$storage</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$pixels</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Imports pixels from an array into an image. The <code class="parameter">map</code> is usually
   &#039;RGB&#039;. This method imposes the following constraints for the parameters: amount of pixels
   in the array must match <code class="parameter">width</code> x <code class="parameter">height</code> x length of the map.
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.importimagepixels-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Map of pixel ordering as a string. This can be for example <code class="literal">RGB</code>.
     ...
     <dd>
      <p class="para">
       ...
       Refer to this list of <a href="imagick.constants.php#imagick.constants.pixel" class="link">pixel constants</a>.
      </p>
     </dd>
    
    
     <dt><code class="parameter">pixels</code></dt>
     <dd>
      <p class="para">
       The array of pixels
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.importimagepixels-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.importimagepixels-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.importimagepixels-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3023">
    <p><strong>Example #1 <span class="methodname"><strong>Imagick::importImagePixels()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Generate array of pixels. 2000 pixels per color stripe */<br /></span><span style="color: #0000BB">$count </span><span style="color: #007700">= </span><span style="color: #0000BB">2000 </span><span style="color: #007700">* </span><span style="color: #0000BB">3</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$pixels </span><span style="color: #007700">= <br />   </span><span style="color: #0000BB">array_merge</span><span style="color: #007700">(</span><span style="color: #0000BB">array_pad</span><span style="color: #007700">(array(), </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">),<br />               </span><span style="color: #0000BB">array_pad</span><span style="color: #007700">(array(), </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">255</span><span style="color: #007700">), <br />               </span><span style="color: #0000BB">array_pad</span><span style="color: #007700">(array(), </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">),<br />               </span><span style="color: #0000BB">array_pad</span><span style="color: #007700">(array(), </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">255</span><span style="color: #007700">),<br />               </span><span style="color: #0000BB">array_pad</span><span style="color: #007700">(array(), </span><span style="color: #0000BB">$count</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">));<br /><br /></span><span style="color: #FF8000">/* Width and height. The area is amount of pixels divided<br />   by three. Three comes from 'RGB', three values per pixel */<br /></span><span style="color: #0000BB">$width </span><span style="color: #007700">= </span><span style="color: #0000BB">$height </span><span style="color: #007700">= </span><span style="color: #0000BB">pow</span><span style="color: #007700">((</span><span style="color: #0000BB">count</span><span style="color: #007700">(</span><span style="color: #0000BB">$pixels</span><span style="color: #007700">) / </span><span style="color: #0000BB">3</span><span style="color: #007700">), </span><span style="color: #0000BB">0.5</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Create empty image */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">$width</span><span style="color: #007700">, </span><span style="color: #0000BB">$height</span><span style="color: #007700">, </span><span style="color: #DD0000">'gray'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Import the pixels into image.<br />   width * height * strlen("RGB") must match count($pixels) */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">importImagePixels</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">$width</span><span style="color: #007700">, </span><span style="color: #0000BB">$height</span><span style="color: #007700">, </span><span style="color: #DD0000">"RGB"</span><span style="color: #007700">, </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">::</span><span style="color: #0000BB">PIXEL_CHAR</span><span style="color: #007700">, </span><span style="color: #0000BB">$pixels</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* output as jpeg image */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">'jpg'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/jpg"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$im</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-importimagepixels.jpg" alt="Output of example : Imagick::importImagePixels()" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/importimagepixels.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.importimagepixels%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.importimagepixels&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.importimagepixels.php">＋<small>add a note</small></a></span>
