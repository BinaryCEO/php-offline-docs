...
<head>
  ...
  <title>PHP: snmp_get_quick_print - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp-get-quick-print.php">
 <link rel="shorturl" href="https://www.php.net/snmp-get-quick-print">
 <link rel="alternate" href="https://www.php.net/snmp-get-quick-print" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmp-get-valueretrieval.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmp-get-quick-print.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmp-get-quick-print.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmp-get-quick-print.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmp-get-quick-print.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmp-get-quick-print.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmp-get-quick-print.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmp-get-quick-print.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmp-get-quick-print.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmp-get-quick-print.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmp-get-quick-print.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmp-get-quick-print.php" hreflang="zh">
...
<meta name="Description" content="Fetches the current value of the NET-SNMP library's quick_print setting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: snmp_get_quick_print - Manual" />
<meta name="twitter:description" content="Fetches the current value of the NET-SNMP library's quick_print setting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: snmp_get_quick_print - Manual" />
<meta itemprop="description" content="Fetches the current value of the NET-SNMP library's quick_print setting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetches the current value of the NET-SNMP library's quick_print setting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.snmp-get-valueretrieval.php">
          snmp_get_valueretrieval &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.snmp.php">
          &laquo; SNMP Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp-get-quick-print.php' selected="selected">English</option>
            <option value='de/function.snmp-get-quick-print.php'>German</option>
            <option value='es/function.snmp-get-quick-print.php'>Spanish</option>
            <option value='fr/function.snmp-get-quick-print.php'>French</option>
            <option value='it/function.snmp-get-quick-print.php'>Italian</option>
            <option value='ja/function.snmp-get-quick-print.php'>Japanese</option>
            <option value='pt_BR/function.snmp-get-quick-print.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmp-get-quick-print.php'>Russian</option>
            <option value='tr/function.snmp-get-quick-print.php'>Turkish</option>
            <option value='uk/function.snmp-get-quick-print.php'>Ukrainian</option>
            <option value='zh/function.snmp-get-quick-print.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmp-get-quick-print" class="refentry">
    ...
    <li><span class="function"><a href="function.snmp-set-quick-print.php" class="function" rel="rdfs-seeAlso">snmp_set_quick_print()</a> - Set the value of enable within the NET-SNMP library</span> for a full description
     of what quick_print does.</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp-get-quick-print.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp-get-quick-print%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp-get-quick-print&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp-get-quick-print.php">＋<small>add a note</small></a></span>
