...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-tables.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-table-privileges.php">
 <link rel="next" href="https://www.php.net/manual/en/book.mongodb.php">
...
<meta name="Description" content="Returns a result set listing the tables and associated metadata in a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_tables - Manual" />
<meta name="twitter:description" content="Returns a result set listing the tables and associated metadata in a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_tables - Manual" />
<meta itemprop="description" content="Returns a result set listing the tables and associated metadata in a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the tables and associated metadata in a database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-tables.php' selected="selected">English</option>
            ...
            <option value='ru/function.db2-tables.php'>Russian</option>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       types, pass <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> or an empty string. Valid table type identifiers
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-table-privileges.php" class="function" rel="rdfs-seeAlso">db2_table_privileges()</a> - Returns a result set listing the tables and associated privileges in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-tables.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-tables%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-tables&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-tables.php">＋<small>add a note</small></a></span>
