...
<head>
  ...
  <title>PHP: Deprecated features in PHP 7.2.x - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration72.deprecated.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration72.deprecated.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration72.deprecated.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration72.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration72.incompatible.php">
 <link rel="next" href="https://www.php.net/manual/en/migration72.other-changes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration72.deprecated.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration72.deprecated.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration72.deprecated.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration72.deprecated.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration72.deprecated.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration72.deprecated.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration72.deprecated.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration72.deprecated.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration72.deprecated.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration72.deprecated.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration72.deprecated.php" hreflang="zh">
...
<meta name="Description" content="Deprecated features in PHP 7.2.x" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Deprecated features in PHP 7.2.x - Manual" />
<meta name="twitter:description" content="Deprecated features in PHP 7.2.x" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Deprecated features in PHP 7.2.x - Manual" />
<meta itemprop="description" content="Deprecated features in PHP 7.2.x" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deprecated features in PHP 7.2.x" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration72.deprecated.php' selected="selected">English</option>
            <option value='de/migration72.deprecated.php'>German</option>
            <option value='es/migration72.deprecated.php'>Spanish</option>
            <option value='fr/migration72.deprecated.php'>French</option>
            <option value='it/migration72.deprecated.php'>Italian</option>
            <option value='ja/migration72.deprecated.php'>Japanese</option>
            <option value='pt_BR/migration72.deprecated.php'>Brazilian Portuguese</option>
            <option value='ru/migration72.deprecated.php'>Russian</option>
            <option value='tr/migration72.deprecated.php'>Turkish</option>
            <option value='uk/migration72.deprecated.php'>Ukrainian</option>
            <option value='zh/migration72.deprecated.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration72.deprecated" class="sect1">
  ...
  <p class="para">
   ...
   The <span class="function"><a href="function.exif-read-data.php" class="function">exif_read_data()</a></span> function should be used instead.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration72/deprecated.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration72.deprecated%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration72.deprecated&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration72.deprecated.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="122979">  <div class="votes">
    <div id="Vu122979">
    <a href="/manual/vote-note.php?id=122979&amp;page=migration72.deprecated&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122979">
    <a href="/manual/vote-note.php?id=122979&amp;page=migration72.deprecated&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122979" title="52% like this...">
    2
    </div>
  </div>
  <a href="#122979" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#122979"> &para;</a><div class="date" title="2018-07-26 05:09"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122979">
<div class="phpcode"><code><span class="html">An empty &lt;?php?&gt; Codeblock in PHP 7.2.0 will put out an "Unquoted strings" warning. To prevent that, add at least one empty space into the codeblock.<br /><br />Example:<br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">&lt;?</span><span class="default">php</span><span class="comment">/*<br />echo "This was some useful code.\n";<br />*/</span><span class="default">?&gt;<br /></span><br />?&gt;<br />Gives: PHP Warning:  Use of undefined constant php - assumed 'php' (this will throw an Error in a future version of PHP)<br /><br />Fix via:<br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">&lt;?</span><span class="default">php   </span><span class="comment">/*<br />echo "This was some useful code.\";<br />*/</span><span class="default">?&gt;<br /></span><br />?&gt;<br /><br />Don't know if that is an intentional behaviour or a side effect.</span></code></div>
  </div>
 </div>
  <div class="note" id="122339">  <div class="votes">
    <div id="Vu122339">
    <a href="/manual/vote-note.php?id=122339&amp;page=migration72.deprecated&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122339">
    <a href="/manual/vote-note.php?id=122339&amp;page=migration72.deprecated&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122339" title="51% like this...">
    2
    </div>
  </div>
  <a href="#122339" class="name">
  <strong class="user"><em>webmaster at thedigitalorchard dot ca</em></strong></a><a class="genanchor" href="#122339"> &para;</a><div class="date" title="2018-02-01 05:14"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122339">
<div class="phpcode"><code><span class="html">Instead of __autoload(), you can use spl_autoload_register() very easily, as per the documentation:<br /><br />spl_autoload_register(function ($class) {<br />    include 'classes/' . $class . '.class.php';<br />});<br /><br />And this lets you have multiple autoloaders instead of one global one.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=migration72.deprecated&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration72.deprecated.php">＋<small>add a note</small></a></div>
