...
<head>
  ...
  <title>PHP: Imagick::getImageGreenPrimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagegreenprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagegreenprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagegreenprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagegravity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageheight.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagegreenprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagegreenprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagegreenprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagegreenprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagegreenprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagegreenprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagegreenprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagegreenprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagegreenprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagegreenprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagegreenprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageGreenPrimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticy green primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageGreenPrimary - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageheight.php">
          Imagick::getImageHeight &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagegravity.php">
          &laquo; Imagick::getImageGravity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagegreenprimary.php' selected="selected">English</option>
            <option value='de/imagick.getimagegreenprimary.php'>German</option>
            <option value='es/imagick.getimagegreenprimary.php'>Spanish</option>
            <option value='fr/imagick.getimagegreenprimary.php'>French</option>
            <option value='it/imagick.getimagegreenprimary.php'>Italian</option>
            <option value='ja/imagick.getimagegreenprimary.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagegreenprimary.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagegreenprimary.php'>Russian</option>
            <option value='tr/imagick.getimagegreenprimary.php'>Turkish</option>
            <option value='uk/imagick.getimagegreenprimary.php'>Ukrainian</option>
            <option value='zh/imagick.getimagegreenprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagegreenprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageGreenPrimary</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageGreenPrimary</span> &mdash; <span class="dc-title">Returns the chromaticy green primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagegreenprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageGreenPrimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagegreenprimary-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagegreenprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagegreenprimary-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagegreenprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagegreenprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagegreenprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagegreenprimary.php">＋<small>add a note</small></a></span>
