...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.sessionhandler.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.session-write-close.php">
 <link rel="next" href="https://www.php.net/manual/en/sessionhandler.close.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/class.sessionhandler.php" hreflang="uk">
...
<meta name="Description" content="The SessionHandler class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SessionHandler - Manual" />
<meta name="twitter:description" content="The SessionHandler class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SessionHandler - Manual" />
<meta itemprop="description" content="The SessionHandler class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SessionHandler class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="sessionhandler.close.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.sessionhandler.php' selected="selected">English</option>
            ...
            <option value='ru/class.sessionhandler.php'>Russian</option>
            <option value='tr/class.sessionhandler.php'>Turkish</option>
            <option value='uk/class.sessionhandler.php'>Ukrainian</option>
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="sessionhandler.intro">
   ...
   <p class="para">
    ...
    <span class="function"><a href="function.session-set-save-handler.php" class="function">session_set_save_handler()</a></span> it will wrap the current save handlers.
   ...
   <p class="para">
    ...
    <a href="session.configuration.php#ini.session.save-handler" class="link">session.save_handler</a> and then pass an instance of
    <span class="classname"><strong class="classname">SessionHandler</strong></span> or one extending it to <span class="function"><a href="function.session-set-save-handler.php" class="function">session_set_save_handler()</a></span>.
   </p>
   <p class="para">
    ...
    by PHP.  For more information on the session workflow, please refer to <span class="function"><a href="function.session-set-save-handler.php" class="function">session_set_save_handler()</a></span>.
   </p>
  </div>
  ...
  <div class="section" id="session.notes">
   ...
   <div class="warning"><strong class="warning">Warning</strong>
    <p class="para">
     ...
     write your own custom save handlers, please implement the <span class="classname"><a href="class.sessionhandlerinterface.php" class="classname">SessionHandlerInterface</a></span>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /> </span><span style="color: #FF8000">/**<br />  * decrypt AES 256<br />  *<br />  * @param data $edata<br />  * @param string $password<br />  * @return decrypted data<br />  */<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">decrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$edata</span><span style="color: #007700">, </span><span style="color: #0000BB">$password</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">base64_decode</span><span style="color: #007700">(</span><span style="color: #0000BB">$edata</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$salt </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">16</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$ct </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">16</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$rounds </span><span style="color: #007700">= </span><span style="color: #0000BB">3</span><span style="color: #007700">; </span><span style="color: #FF8000">// depends on key length<br />    </span><span style="color: #0000BB">$data00 </span><span style="color: #007700">= </span><span style="color: #0000BB">$password</span><span style="color: #007700">.</span><span style="color: #0000BB">$salt</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$hash </span><span style="color: #007700">= array();<br />    </span><span style="color: #0000BB">$hash</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">] = </span><span style="color: #0000BB">hash</span><span style="color: #007700">(</span><span style="color: #DD0000">'sha256'</span><span style="color: #007700">, </span><span style="color: #0000BB">$data00</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$hash</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">];<br />    for (</span><span style="color: #0000BB">$i </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">; </span><span style="color: #0000BB">$i </span><span style="color: #007700">&lt; </span><span style="color: #0000BB">$rounds</span><span style="color: #007700">; </span><span style="color: #0000BB">$i</span><span style="color: #007700">++) {<br />        </span><span style="color: #0000BB">$hash</span><span style="color: #007700">[</span><span style="color: #0000BB">$i</span><span style="color: #007700">] = </span><span style="color: #0000BB">hash</span><span style="color: #007700">(</span><span style="color: #DD0000">'sha256'</span><span style="color: #007700">, </span><span style="color: #0000BB">$hash</span><span style="color: #007700">[</span><span style="color: #0000BB">$i </span><span style="color: #007700">- </span><span style="color: #0000BB">1</span><span style="color: #007700">].</span><span style="color: #0000BB">$data00</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">$result </span><span style="color: #007700">.= </span><span style="color: #0000BB">$hash</span><span style="color: #007700">[</span><span style="color: #0000BB">$i</span><span style="color: #007700">];<br />    }<br />    </span><span style="color: #0000BB">$key </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">32</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$iv  </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">, </span><span style="color: #0000BB">32</span><span style="color: #007700">,</span><span style="color: #0000BB">16</span><span style="color: #007700">);<br /><br />    return </span><span style="color: #0000BB">openssl_decrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$ct</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES-256-CBC'</span><span style="color: #007700">, </span><span style="color: #0000BB">$key</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">, </span><span style="color: #0000BB">$iv</span><span style="color: #007700">);<br />  }<br /><br /></span><span style="color: #FF8000">/**<br /> * crypt AES 256<br /> *<br /> * @param data $data<br /> * @param string $password<br /> * @return base64 encrypted data<br /> */<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">encrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">$password</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// Generate a cryptographically secure random salt using random_bytes()<br />    </span><span style="color: #0000BB">$salt </span><span style="color: #007700">= </span><span style="color: #0000BB">random_bytes</span><span style="color: #007700">(</span><span style="color: #0000BB">16</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$salted </span><span style="color: #007700">= </span><span style="color: #DD0000">''</span><span style="color: #007700">;<br />    </span><span style="color: #0000BB">$dx </span><span style="color: #007700">= </span><span style="color: #DD0000">''</span><span style="color: #007700">;<br />    </span><span style="color: #FF8000">// Salt the key(32) and iv(16) = 48<br />    </span><span style="color: #007700">while (</span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$salted</span><span style="color: #007700">) &lt; </span><span style="color: #0000BB">48</span><span style="color: #007700">) {<br />      </span><span style="color: #0000BB">$dx </span><span style="color: #007700">= </span><span style="color: #0000BB">hash</span><span style="color: #007700">(</span><span style="color: #DD0000">'sha256'</span><span style="color: #007700">, </span><span style="color: #0000BB">$dx</span><span style="color: #007700">.</span><span style="color: #0000BB">$password</span><span style="color: #007700">.</span><span style="color: #0000BB">$salt</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br />      </span><span style="color: #0000BB">$salted </span><span style="color: #007700">.= </span><span style="color: #0000BB">$dx</span><span style="color: #007700">;<br />    }<br /><br />    </span><span style="color: #0000BB">$key </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$salted</span><span style="color: #007700">, </span><span style="color: #0000BB">0</span><span style="color: #007700">, </span><span style="color: #0000BB">32</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$iv  </span><span style="color: #007700">= </span><span style="color: #0000BB">substr</span><span style="color: #007700">(</span><span style="color: #0000BB">$salted</span><span style="color: #007700">, </span><span style="color: #0000BB">32</span><span style="color: #007700">,</span><span style="color: #0000BB">16</span><span style="color: #007700">);<br /><br />    </span><span style="color: #0000BB">$encrypted_data </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_encrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #DD0000">'AES-256-CBC'</span><span style="color: #007700">, </span><span style="color: #0000BB">$key</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">, </span><span style="color: #0000BB">$iv</span><span style="color: #007700">);<br />    return </span><span style="color: #0000BB">base64_encode</span><span style="color: #007700">(</span><span style="color: #0000BB">$salt </span><span style="color: #007700">. </span><span style="color: #0000BB">$encrypted_data</span><span style="color: #007700">);<br />}<br /><br />class </span><span style="color: #0000BB">EncryptedSessionHandler </span><span style="color: #007700">extends </span><span style="color: #0000BB">SessionHandler<br /></span><span style="color: #007700">{<br />    private </span><span style="color: #0000BB">$key</span><span style="color: #007700">;<br /><br />    public function </span><span style="color: #0000BB">__construct</span><span style="color: #007700">(</span><span style="color: #0000BB">$key</span><span style="color: #007700">)<br />    {<br />        </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">key </span><span style="color: #007700">= </span><span style="color: #0000BB">$key</span><span style="color: #007700">;<br />    }<br /><br />    public function </span><span style="color: #0000BB">read</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">)<br />    {<br />        </span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">parent</span><span style="color: #007700">::</span><span style="color: #0000BB">read</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">);<br /><br />        if (!</span><span style="color: #0000BB">$data</span><span style="color: #007700">) {<br />            return </span><span style="color: #DD0000">""</span><span style="color: #007700">;<br />        } else {<br />            return </span><span style="color: #0000BB">decrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">key</span><span style="color: #007700">);<br />        }<br />    }<br /><br />    public function </span><span style="color: #0000BB">write</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$data</span><span style="color: #007700">)<br />    {<br />        </span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">encrypt</span><span style="color: #007700">(</span><span style="color: #0000BB">$data</span><span style="color: #007700">, </span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">key</span><span style="color: #007700">);<br /><br />        return </span><span style="color: #0000BB">parent</span><span style="color: #007700">::</span><span style="color: #0000BB">write</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">, </span><span style="color: #0000BB">$data</span><span style="color: #007700">);<br />    }<br />}<br /><br /></span><span style="color: #FF8000">// we'll intercept the native 'files' handler, but will equally work<br />// with other internal native handlers like 'sqlite', 'memcache' or 'memcached'<br />// which are provided by PHP extensions.<br /></span><span style="color: #0000BB">ini_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'session.save_handler'</span><span style="color: #007700">, </span><span style="color: #DD0000">'files'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$key </span><span style="color: #007700">= </span><span style="color: #DD0000">'secret_string'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$handler </span><span style="color: #007700">= new </span><span style="color: #0000BB">EncryptedSessionHandler</span><span style="color: #007700">(</span><span style="color: #0000BB">$key</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">session_set_save_handler</span><span style="color: #007700">(</span><span style="color: #0000BB">$handler</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">session_start</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">// proceed to set and retrieve values by key from $_SESSION</span></span></code></div>
   ...
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <p class="para">
     ...
     child class calls to parent methods (i.e. the actual internal native handlers) will return <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> unless
     the session has actually been started (either automatically, or by explicit <span class="function"><a href="function.session-start.php" class="function">session_start()</a></span>).
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="sessionhandler.close.php">SessionHandler::close</a> — Close the session</li><li><a href="sessionhandler.create-sid.php">SessionHandler::create_sid</a> — Return a new session ID</li><li><a href="sessionhandler.destroy.php">SessionHandler::destroy</a> — Destroy a session</li><li><a href="sessionhandler.gc.php">SessionHandler::gc</a> — Cleanup old sessions</li><li><a href="sessionhandler.open.php">SessionHandler::open</a> — Initialize session</li><li><a href="sessionhandler.read.php">SessionHandler::read</a> — Read session data</li><li><a href="sessionhandler.write.php">SessionHandler::write</a> — Write session data</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/session/sessionhandler.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.sessionhandler%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.sessionhandler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.sessionhandler.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">8 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="117756">  <div class="votes">
    <div id="Vu117756">
    <a href="/manual/vote-note.php?id=117756&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117756">
    <a href="/manual/vote-note.php?id=117756&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117756" title="94% like this...">
    47
    </div>
  </div>
  <a href="#117756" class="name">
  <strong class="user"><em>rasmus at mindplay dot dk</em></strong></a><a class="genanchor" href="#117756"> &para;</a><div class="date" title="2015-08-03 09:08"><strong>10 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">As the life-cycle of a session handler is fairly complex, I found it difficult to understand when explained using just words - so I traced the function calls made to a custom SessionHandler, and created this overview of precisely what happens when you call various session methods:<br /><br /><a href="https://gist.github.com/mindplay-dk/623bdd50c1b4c0553cd3" rel="nofollow" target="_blank">https://gist.github.com/mindplay-dk/623bdd50c1b4c0553cd3</a><br /><br />I hope this makes it considerably easier to implement a custom SessionHandler and get it right the first time :-)</span></code></div>
  ...
  <div class="note" id="128184">  <div class="votes">
    <div id="Vu128184">
    <a href="/manual/vote-note.php?id=128184&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128184">
    <a href="/manual/vote-note.php?id=128184&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128184" title="100% like this...">
    9
    </div>
  </div>
  <a href="#128184" class="name">
  <strong class="user"><em>tuncdan dot ozdemir dot peng at gmail dot com</em></strong></a><a class="genanchor" href="#128184"> &para;</a><div class="date" title="2023-02-03 07:57"><strong>2 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Those who are planning to implement your own SessionHandler, let's say using a Database system, please make sure your 'create_sid' method creates a new record in your database with empty string '' as your 'data' using the new session ID created, otherwise when 'read' method is called (which is always called no matter if it is a brand new session or not), you will get an error because there is no record with that session ID yet.  The funny part is that the error you get will sound like PHP is trying open the session on your local drive (coming from your .ini file).</span></code></div>
  ...
  <div class="note" id="122826">  <div class="votes">
    <div id="Vu122826">
    <a href="/manual/vote-note.php?id=122826&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122826">
    <a href="/manual/vote-note.php?id=122826&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122826" title="80% like this...">
    6
    </div>
  </div>
  <a href="#122826" class="name">
  <strong class="user"><em>tony at marston-home dot demon dot co dot uk</em></strong></a><a class="genanchor" href="#122826"> &para;</a><div class="date" title="2018-06-12 07:55"><strong>7 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Your custom session handler should not contain calls to any of the session functions, such as session_name() or session_id(), as the relevant values are passed as arguments on various handler methods. Attempting to obtain values from alternative sources may not work as expected.</span></code></div>
  ...
  <div class="note" id="128181">  <div class="votes">
    <div id="Vu128181">
    <a href="/manual/vote-note.php?id=128181&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128181">
    <a href="/manual/vote-note.php?id=128181&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128181" title="75% like this...">
    4
    </div>
  </div>
  <a href="#128181" class="name">
  <strong class="user"><em>tuncdan dot ozdemir dot peng at gmail dot com</em></strong></a><a class="genanchor" href="#128181"> &para;</a><div class="date" title="2023-02-02 10:06"><strong>2 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">The best way to set up your own session handler is to extend the native SessionHandler (override the 7 methods + constructor as per your need, keeping the same signatures).  Optionally, you can also implement SessionUpdateTimestampHandlerInterface if you plan to use 'lazy_write':<br /><br />Option 1:<br /><br />class MyOwnSessionHandler extends \SessionHandler { ..... }<br /><br />Option 2:<br /><br />class MyOwnSessionHandler extends \SessionHandler implements \SessionUpdateTimestampHandlerInterface { ..... }<br /><br />I would NOT recommend to do this:<br /><br />class MyOwnSessionHandler implements \SessionHandlerInterface, \SessionIdInterface, \SessionUpdateTimestampHandlerInterface { ... }<br /><br />If you are curious, here are the methods called in the order (using PHP 8.2 with XAMPP v3.3.0 on Windows 11 64-bit):<br /><br />- open (always called)<br /><br />- validateId and/or create_sid:<br /><br />    validateId is called if you implement SessionUpdateTimestampHandlerInterface.  If validation fails, create_sid is called.     <br /><br />    create_sid is called if a new session ID is needed: new session, etc.<br /><br />- read (always called)<br /><br />- write OR updateTimestamp OR destroy:<br /><br />    if you call 'destroy', neither 'write' or 'updateTimestamp' is called,<br /><br />    if you have the 'lazy_write' on AND implemented SessionUpdateTimestampHandlerInterface, <br />    then 'updateTimestamp' is called instead of 'write' if nothing changes.<br /><br />- close (always called)</span></code></div>
  ...
  <div class="note" id="124829">  <div class="votes">
    <div id="Vu124829">
    <a href="/manual/vote-note.php?id=124829&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124829">
    <a href="/manual/vote-note.php?id=124829&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124829" title="66% like this...">
    2
    </div>
  </div>
  <a href="#124829" class="name">
  <strong class="user"><em>saccani dot francesco dot NOSPAM at gmail dot com</em></strong></a><a class="genanchor" href="#124829"> &para;</a><div class="date" title="2020-03-15 08:07"><strong>5 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">I made this gist to provide a complete overview of the PHP session handler life cycle updated to version 7.0 or above. In particular, I wanted to emphasize what methods and in what order are called when the native PHP functions are used for session management.<br /><br /><a href="https://gist.github.com/franksacco/d6e943c41189f8ee306c182bf8f07654" rel="nofollow" target="_blank">https://gist.github.com/franksacco/d6e943c41189f8ee306c182bf8f07654</a><br /><br />I hope this analysis will help all the developers interested in understanding in detail the native session management performed by PHP and what a custom session handler should do.<br />Any comment or suggestion is appreciated.</span></code></div>
  ...
  <div class="note" id="129448">  <div class="votes">
    <div id="Vu129448">
    <a href="/manual/vote-note.php?id=129448&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129448">
    <a href="/manual/vote-note.php?id=129448&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129448" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129448" class="name">
  <strong class="user"><em>RomanV</em></strong></a><a class="genanchor" href="#129448"> &para;</a><div class="date" title="2024-05-01 01:13"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129448">
<div class="phpcode"><code><span class="html">Be aware that when you inherit from \SessionHandler you implicitly disable session strict mode because it doesn't implement SessionUpdateTimestampHandlerInterface (see: <a href="https://www.php.net/manual/en/session.configuration.php#ini.session.use-strict-mode" rel="nofollow" target="_blank">https://www.php.net/manual/en/session.configuration.php#ini.session.use-strict-mode</a>) thus validateId() is not called.<br /><br />It's CRUCIAL to call the session_regenerate_id() function whenever any privilege level is changed (i.e. during authentication, password/permission/user role change) to mitigate the session fixation attack!</span></code></div>
  </div>
 </div>
  <div class="note" id="118964">  <div class="votes">
    <div id="Vu118964">
    <a href="/manual/vote-note.php?id=118964&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118964">
    <a href="/manual/vote-note.php?id=118964&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118964" title="41% like this...">
    -3
    </div>
  </div>
  <a href="#118964" class="name">
  <strong class="user"><em>jeremie dot legrand at komori-chambon dot fr</em></strong></a><a class="genanchor" href="#118964"> &para;</a><div class="date" title="2016-03-09 09:22"><strong>9 years ago</strong></div>
...
<div class="phpcode"><code><span class="html">Here is a wrapper to log in a file each session's operations. Useful to investigate sessions locks (which prevent PHP to serve simultaneous requests for a same client).<br />Just change the file name at the end to dump logs where you want. <br /><br />class DumpSessionHandler extends SessionHandler {<br />    private $fich;<br /><br />    public function __construct($fich) {<br />        $this-&gt;fich = $fich;<br />    }<br /><br />    public function close() {<br />        $this-&gt;log('close');<br />        return parent::close();<br />    }<br /><br />    public function create_sid() {<br />        $this-&gt;log('create_sid');<br />        return parent::create_sid();<br />    }<br /><br />    public function destroy($session_id) {<br />        $this-&gt;log('destroy('.$session_id.')');<br />        return parent::destroy($session_id);<br />    }<br /><br />    public function gc($maxlifetime) {<br />        $this-&gt;log('close('.$maxlifetime.')');<br />        return parent::gc($maxlifetime);<br />    }<br /><br />    public function open($save_path, $session_name) {<br />        $this-&gt;log('open('.$save_path.', '.$session_name.')');<br />        return parent::open($save_path, $session_name);<br />    }<br /><br />    public function read($session_id) {<br />        $this-&gt;log('read('.$session_id.')');<br />        return parent::read($session_id);<br />    }<br /><br />    public function write($session_id, $session_data) {<br />        $this-&gt;log('write('.$session_id.', '.$session_data.')');<br />        return parent::write($session_id, $session_data);<br />    }<br /><br />    private function log($action) {<br />        $base_uri = explode('?', $_SERVER['REQUEST_URI'], 2)[0];<br />        $hdl = fopen($this-&gt;fich, 'a');<br />        fwrite($hdl, date('Y-m-d h:i:s').' '.$base_uri.' : '.$action."\n");<br />        fclose($hdl);<br />    }<br />}<br />ini_set('session.save_handler', 'files');<br />$handler = new DumpSessionHandler('/path/to/dump_sessions.log');<br />session_set_save_handler($handler, true);</span></code></div>
  ...
  <div class="note" id="123892">  <div class="votes">
    <div id="Vu123892">
    <a href="/manual/vote-note.php?id=123892&amp;page=class.sessionhandler&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123892">
    <a href="/manual/vote-note.php?id=123892&amp;page=class.sessionhandler&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123892" title="28% like this...">
    -3
    </div>
  </div>
  <a href="#123892" class="name">
  <strong class="user"><em>wei dot kavin at gmail dot com</em></strong></a><a class="genanchor" href="#123892"> &para;</a><div class="date" title="2019-05-29 07:38"><strong>6 years ago</strong></div>
...
<div class="foot"><a href="/manual/add-note.php?sect=class.sessionhandler&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.sessionhandler.php">＋<small>add a note</small></a></div>
