...
<head>
  ...
  <title>PHP: Memcached::getMulti - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.getmulti.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.getmulti.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getmulti.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.getdelayedbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.getmultibykey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.getmulti.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.getmulti.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.getmulti.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.getmulti.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.getmulti.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.getmulti.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.getmulti.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.getmulti.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.getmulti.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.getmulti.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.getmulti.php" hreflang="zh">
...
<meta name="Description" content="Retrieve multiple items" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::getMulti - Manual" />
<meta name="twitter:description" content="Retrieve multiple items" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::getMulti - Manual" />
<meta itemprop="description" content="Retrieve multiple items" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve multiple items" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.getmultibykey.php">
          Memcached::getMultiByKey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.getdelayedbykey.php">
          &laquo; Memcached::getDelayedByKey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.getmulti.php' selected="selected">English</option>
            <option value='de/memcached.getmulti.php'>German</option>
            <option value='es/memcached.getmulti.php'>Spanish</option>
            <option value='fr/memcached.getmulti.php'>French</option>
            <option value='it/memcached.getmulti.php'>Italian</option>
            <option value='ja/memcached.getmulti.php'>Japanese</option>
            <option value='pt_BR/memcached.getmulti.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.getmulti.php'>Russian</option>
            <option value='tr/memcached.getmulti.php'>Turkish</option>
            <option value='uk/memcached.getmulti.php'>Ukrainian</option>
            <option value='zh/memcached.getmulti.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.getmulti" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::getMulti</h1>
  <p class="verinfo">(PECL memcached &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">Memcached::getMulti</span> &mdash; <span class="dc-title">Retrieve multiple items</span></p>
 ...
 <div class="refsect1 description" id="refsect1-memcached.getmulti-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::getMulti</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$keys</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$get_flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::getMulti()</strong></span> is similar to
   <span class="methodname"><a href="memcached.get.php" class="methodname">Memcached::get()</a></span>, but instead of a single key
   item, it retrieves multiple items the keys of which are specified in the
   <code class="parameter">keys</code> array.
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <p class="para">
     Before v3.0 a second argument <code class="parameter reference">&cas_tokens</code> was in use.
     It was filled with the CAS token values for the found items.
     The <code class="parameter reference">&cas_tokens</code> parameter was removed in v3.0 of the extension.
     It was replaced with a new flag <strong><code><a href="memcached.constants.php#memcached.constants.get-extended">Memcached::GET_EXTENDED</a></code></strong>
     that needs is to be used as the value for <code class="parameter">get_flags</code>.
    </p>
   </p></blockquote>
  </p>
  <p class="para">
   The <code class="parameter">get_flags</code> parameter can be used to specify
   additional options for <span class="function"><strong>Memcached::getMulti()</strong></span>.
   <strong><code><a href="memcached.constants.php#memcached.constants.get-preserve-order">Memcached::GET_PRESERVE_ORDER</a></code></strong> ensures that the
   keys are returned in the same order as they were requested in.
   <strong><code><a href="memcached.constants.php#memcached.constants.get-extended">Memcached::GET_EXTENDED</a></code></strong> ensures that the
 ...
 <div class="refsect1 returnvalues" id="refsect1-memcached.getmulti-returnvalues">
  ...
  <p class="para">
   Returns the array of found items or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
...
array(2) {
  ...
  <p class="para">
   <div class="example" id="example-4686">
    <p><strong>Example #3 <strong><code><a href="memcached.constants.php#memcached.constants.get-preserve-order">Memcached::GET_PRESERVE_ORDER</a></code></strong> example for Memcached v3</strong></p>
    <div class="example-contents">
...
something similar to:</p></div>
    <div class="example-contents screen">
<div class="examplescode"><pre class="examplescode">foo foo-data
bar bar-data
baz baz-data
lol lol-data
kek kek-data
zoo</pre>
  ...
  <p class="para">
   <div class="example" id="example-4687">
    <p><strong>Example #4 <strong><code><a href="memcached.constants.php#memcached.constants.get-preserve-order">Memcached::GET_PRESERVE_ORDER</a></code></strong> example for Memcached v1 and v2</strong></p>
    <div class="example-contents">
...
zoo</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-memcached.getmulti-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="memcached.getmultibykey.php" class="methodname" rel="rdfs-seeAlso">Memcached::getMultiByKey()</a> - Retrieve multiple items from a specific server</span></li>
    ...
    <li><span class="methodname"><a href="memcached.getdelayed.php" class="methodname" rel="rdfs-seeAlso">Memcached::getDelayed()</a> - Request multiple items</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/getmulti.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.getmulti%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.getmulti&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getmulti.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115665">  <div class="votes">
    <div id="Vu115665">
    <a href="/manual/vote-note.php?id=115665&amp;page=memcached.getmulti&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115665">
    <a href="/manual/vote-note.php?id=115665&amp;page=memcached.getmulti&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115665" title="100% like this...">
    2
    </div>
  </div>
  <a href="#115665" class="name">
  <strong class="user"><em>gabriel dot maybrun at demandmedia dot com</em></strong></a><a class="genanchor" href="#115665"> &para;</a><div class="date" title="2014-09-04 11:58"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115665">
...
<div class="foot"><a href="/manual/add-note.php?sect=memcached.getmulti&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.getmulti.php">＋<small>add a note</small></a></div>
