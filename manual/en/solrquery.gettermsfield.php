...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getterms.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsincludelowerbound.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsfield.php' selected="selected">English</option>
            ...
            <option value='tr/solrquery.gettermsfield.php'>Turkish</option>
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsfield.php">＋<small>add a note</small></a></span>
