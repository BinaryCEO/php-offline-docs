...
<head>
  ...
  <title>PHP: mysql_field_table - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-field-table.php">
 <link rel="shorturl" href="https://www.php.net/mysql-field-table">
 <link rel="alternate" href="https://www.php.net/mysql-field-table" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-field-seek.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-field-type.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-field-table.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-field-table.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-field-table.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-field-table.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-field-table.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-field-table.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-field-table.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-field-table.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-field-table.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-field-table.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-field-table.php" hreflang="zh">
...
<meta name="Description" content="Get name of the table the specified field is in" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_field_table - Manual" />
<meta name="twitter:description" content="Get name of the table the specified field is in" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_field_table - Manual" />
<meta itemprop="description" content="Get name of the table the specified field is in" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get name of the table the specified field is in" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-field-type.php">
          mysql_field_type &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-field-seek.php">
          &laquo; mysql_field_seek        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-field-table.php' selected="selected">English</option>
            <option value='de/function.mysql-field-table.php'>German</option>
            <option value='es/function.mysql-field-table.php'>Spanish</option>
            <option value='fr/function.mysql-field-table.php'>French</option>
            <option value='it/function.mysql-field-table.php'>Italian</option>
            <option value='ja/function.mysql-field-table.php'>Japanese</option>
            <option value='pt_BR/function.mysql-field-table.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-field-table.php'>Russian</option>
            <option value='tr/function.mysql-field-table.php'>Turkish</option>
            <option value='uk/function.mysql-field-table.php'>Ukrainian</option>
            <option value='zh/function.mysql-field-table.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-field-table" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-list-tables.php" class="function" rel="rdfs-seeAlso">mysql_list_tables()</a> - List tables in a MySQL database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-field-table.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-field-table%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-field-table&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-field-table.php">＋<small>add a note</small></a></span>
