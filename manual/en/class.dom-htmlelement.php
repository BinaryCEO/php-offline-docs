...
<head>
  ...
  <title>PHP: Dom\HTMLElement - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-htmlelement.php">
 <link rel="shorturl" href="https://www.php.net/dom-htmlelement">
 <link rel="alternate" href="https://www.php.net/dom-htmlelement" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/dom-htmldocument.savexmlfile.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-implementation.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-htmlelement.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-htmlelement.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-htmlelement.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-htmlelement.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-htmlelement.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-htmlelement.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-htmlelement.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-htmlelement.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-htmlelement.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-htmlelement.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-htmlelement.php" hreflang="zh">
...
<meta name="Description" content="The Dom\HTMLElement class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\HTMLElement - Manual" />
<meta name="twitter:description" content="The Dom\HTMLElement class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\HTMLElement - Manual" />
<meta itemprop="description" content="The Dom\HTMLElement class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\HTMLElement class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-implementation.php">
          Dom\Implementation &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="dom-htmldocument.savexmlfile.php">
          &laquo; Dom\HTMLDocument::saveXmlFile        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-htmlelement.php' selected="selected">English</option>
            <option value='de/class.dom-htmlelement.php'>German</option>
            <option value='es/class.dom-htmlelement.php'>Spanish</option>
            <option value='fr/class.dom-htmlelement.php'>French</option>
            <option value='it/class.dom-htmlelement.php'>Italian</option>
            <option value='ja/class.dom-htmlelement.php'>Japanese</option>
            <option value='pt_BR/class.dom-htmlelement.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-htmlelement.php'>Russian</option>
            <option value='tr/class.dom-htmlelement.php'>Turkish</option>
            <option value='uk/class.dom-htmlelement.php'>Ukrainian</option>
            <option value='zh/class.dom-htmlelement.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-htmlelement" class="reference">
 <h1 class="title">The Dom\HTMLElement class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-htmlelement.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    Represents an element in the <abbr title="Hyper Text Markup Language">HTML</abbr> namespace.
   </p>
  </div>

  <div class="section" id="dom-htmlelement.synopsis">
   <h2 class="title">Class synopsis</h2>

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\HTMLElement</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.dom-element.php" class="classname">Dom\Element</a>
     {</div>
  ...
  The parser methods auto-detect the encoding or allow the caller to specify an encoding.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-htmlelement.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-htmlelement%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-htmlelement&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-htmlelement.php">＋<small>add a note</small></a></span>
