...
<head>
  ...
  <title>PHP: msg_stat_queue - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.msg-stat-queue.php">
 <link rel="shorturl" href="https://www.php.net/msg-stat-queue">
 <link rel="alternate" href="https://www.php.net/msg-stat-queue" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.msg-set-queue.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sem-acquire.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.msg-stat-queue.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.msg-stat-queue.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.msg-stat-queue.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.msg-stat-queue.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.msg-stat-queue.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.msg-stat-queue.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.msg-stat-queue.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.msg-stat-queue.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.msg-stat-queue.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.msg-stat-queue.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.msg-stat-queue.php" hreflang="zh">
...
<meta name="Description" content="Returns information from the message queue data structure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: msg_stat_queue - Manual" />
<meta name="twitter:description" content="Returns information from the message queue data structure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: msg_stat_queue - Manual" />
<meta itemprop="description" content="Returns information from the message queue data structure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns information from the message queue data structure" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.msg-stat-queue.php' selected="selected">English</option>
            <option value='de/function.msg-stat-queue.php'>German</option>
            <option value='es/function.msg-stat-queue.php'>Spanish</option>
            <option value='fr/function.msg-stat-queue.php'>French</option>
            <option value='it/function.msg-stat-queue.php'>Italian</option>
            <option value='ja/function.msg-stat-queue.php'>Japanese</option>
            <option value='pt_BR/function.msg-stat-queue.php'>Brazilian Portuguese</option>
            <option value='ru/function.msg-stat-queue.php'>Russian</option>
            <option value='tr/function.msg-stat-queue.php'>Turkish</option>
            <option value='uk/function.msg-stat-queue.php'>Ukrainian</option>
            <option value='zh/function.msg-stat-queue.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.msg-stat-queue" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.msg-set-queue.php" class="function" rel="rdfs-seeAlso">msg_set_queue()</a> - Set information in the message queue data structure</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sem/functions/msg-stat-queue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.msg-stat-queue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.msg-stat-queue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.msg-stat-queue.php">＋<small>add a note</small></a></span>
