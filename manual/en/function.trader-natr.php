...
<head>
  ...
  <title>PHP: trader_natr - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-natr.php">
 <link rel="shorturl" href="https://www.php.net/trader-natr">
 <link rel="alternate" href="https://www.php.net/trader-natr" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-mult.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-obv.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-natr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-natr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-natr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-natr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-natr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-natr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-natr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-natr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-natr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-natr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-natr.php" hreflang="zh">
...
<meta name="Description" content="Normalized Average True Range" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_natr - Manual" />
<meta name="twitter:description" content="Normalized Average True Range" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_natr - Manual" />
<meta itemprop="description" content="Normalized Average True Range" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Normalized Average True Range" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-obv.php">
          trader_obv &raquo;
              ...
              <div class="prev">
        <a href="function.trader-mult.php">
          &laquo; trader_mult        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-natr.php' selected="selected">English</option>
            <option value='de/function.trader-natr.php'>German</option>
            <option value='es/function.trader-natr.php'>Spanish</option>
            <option value='fr/function.trader-natr.php'>French</option>
            <option value='it/function.trader-natr.php'>Italian</option>
            <option value='ja/function.trader-natr.php'>Japanese</option>
            <option value='pt_BR/function.trader-natr.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-natr.php'>Russian</option>
            <option value='tr/function.trader-natr.php'>Turkish</option>
            <option value='uk/function.trader-natr.php'>Ukrainian</option>
            <option value='zh/function.trader-natr.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-natr" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_natr</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_natr</span> &mdash; <span class="dc-title">Normalized Average True Range</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-natr-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_natr</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-natr-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-natr-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-natr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-natr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-natr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-natr.php">＋<small>add a note</small></a></span>
