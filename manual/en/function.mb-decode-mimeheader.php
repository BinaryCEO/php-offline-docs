...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-decode-mimeheader.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-convert-variables.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-decode-numericentity.php">
...
<meta name="Description" content="Decode string in MIME header field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_decode_mimeheader - Manual" />
<meta name="twitter:description" content="Decode string in MIME header field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_decode_mimeheader - Manual" />
<meta itemprop="description" content="Decode string in MIME header field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decode string in MIME header field" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-decode-mimeheader.php' selected="selected">English</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_decode_mimeheader</span> &mdash; <span class="dc-title">Decode string in MIME header field</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-decode-mimeheader-description">
  ...
  <p class="para rdfs-comment">
   Decodes encoded-word <span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">string</code> in MIME header. 
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-decode-mimeheader-returnvalues">
  ...
  <p class="para">
   The decoded <span class="type"><a href="language.types.string.php" class="type string">string</a></span> in internal character encoding.
  </p>
 </div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.3.0</td>
       <td>
        Underscores are converted to spaces as specified by
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mb-encode-mimeheader.php" class="function" rel="rdfs-seeAlso">mb_encode_mimeheader()</a> - Encode string for MIME header</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-decode-mimeheader.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-decode-mimeheader%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-decode-mimeheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-decode-mimeheader.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">This function ignores any encoded-word specified in a character set not supported by the mbstring extension (e.g. Arabic windows-1256). Such encoded-words pass straight through.<br /><br />RFC2047 doesn't specify the behaviour, but common agents such as Gmail, Windows Mail, etc. DO NOT ignore such encoded words. They are decoded as if they were declared to be in the local character set. <br /><br />Be aware of this idiosyncrasy.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">See also the following functions which may work better in some cases:<br />iconv_mime_decode() - <a href="http://php.net/manual/function.iconv-mime-decode.php" rel="nofollow" target="_blank">http://php.net/manual/function.iconv-mime-decode.php</a><br />imap_utf8() - <a href="http://php.net/manual/function.imap-utf8.php" rel="nofollow" target="_blank">http://php.net/manual/function.imap-utf8.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="126205">  <div class="votes">
    ...
    <div class="tally" id="V126205" title="50% like this...">
    0
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">In Q encoding mode, RFC 2047 encodes spaces as _ (Section 4.2).  <br /><br />mb_decode_mimeheader()<br /><br />does not appear to do this. Thus, to avoid names or subjects with underscores, one needs to apply strtr() or similar function to the input string.<br /><br />On the other hand, lower-case strings do now work correctly.</span></code></div>
  </div>
 </div>
  <div class="note" id="21843">  <div class="votes">
    ...
    <div class="tally" id="V21843" title="50% like this...">
    0
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Using quoted-printable-encoding the hex-numbers must be written in uppercase letters!<br /><br />Works: =?iso-8859-1?q?=3F=3F=3F?=<br />Fails: =?iso-8859-1?q?=3f=3f=3f?=</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-decode-mimeheader&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-decode-mimeheader.php">＋<small>add a note</small></a></div>
