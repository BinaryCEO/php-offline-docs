...
<head>
  ...
  <title>PHP: Gmagick::getimagehistogram - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageheight.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagehistogram.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagehistogram.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagehistogram.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagehistogram.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagehistogram.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagehistogram.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagehistogram.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagehistogram.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagehistogram.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagehistogram.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagehistogram.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagehistogram - Manual" />
<meta name="twitter:description" content="Gets the image histogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagehistogram - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimageindex.php">
          Gmagick::getimageindex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageheight.php">
          &laquo; Gmagick::getimageheight        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagehistogram.php' selected="selected">English</option>
            <option value='de/gmagick.getimagehistogram.php'>German</option>
            <option value='es/gmagick.getimagehistogram.php'>Spanish</option>
            <option value='fr/gmagick.getimagehistogram.php'>French</option>
            <option value='it/gmagick.getimagehistogram.php'>Italian</option>
            <option value='ja/gmagick.getimagehistogram.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagehistogram.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagehistogram.php'>Russian</option>
            <option value='tr/gmagick.getimagehistogram.php'>Turkish</option>
            <option value='uk/gmagick.getimagehistogram.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagehistogram.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagehistogram" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagehistogram</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagehistogram</span> &mdash; <span class="dc-title">Gets the image histogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagehistogram-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagehistogram</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Returns the image histogram as an array of <span class="classname"><a href="class.gmagickpixel.php" class="classname">GmagickPixel</a></span> objects. 
   Throw an <span class="classname"><strong class="classname">GmagickException</strong></span> on error.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagehistogram-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagehistogram-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagehistogram-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagehistogram.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagehistogram%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagehistogram&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagehistogram.php">＋<small>add a note</small></a></span>
