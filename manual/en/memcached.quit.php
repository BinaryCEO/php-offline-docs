...
<head>
  ...
  <title>PHP: Memcached::quit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.quit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.quit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.quit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.prependbykey.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.replace.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.quit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.quit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.quit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.quit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.quit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.quit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.quit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.quit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.quit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.quit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.quit.php" hreflang="zh">
...
<meta name="Description" content="Close any open connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::quit - Manual" />
<meta name="twitter:description" content="Close any open connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::quit - Manual" />
<meta itemprop="description" content="Close any open connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close any open connections" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcached.replace.php">
          Memcached::replace &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.prependbykey.php">
          &laquo; Memcached::prependByKey        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.quit.php' selected="selected">English</option>
            <option value='de/memcached.quit.php'>German</option>
            <option value='es/memcached.quit.php'>Spanish</option>
            <option value='fr/memcached.quit.php'>French</option>
            <option value='it/memcached.quit.php'>Italian</option>
            <option value='ja/memcached.quit.php'>Japanese</option>
            <option value='pt_BR/memcached.quit.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.quit.php'>Russian</option>
            <option value='tr/memcached.quit.php'>Turkish</option>
            <option value='uk/memcached.quit.php'>Ukrainian</option>
            <option value='zh/memcached.quit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.quit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcached::quit</h1>
  <p class="verinfo">(PECL memcached &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Memcached::quit</span> &mdash; <span class="dc-title">Close any open connections</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-memcached.quit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Memcached::quit</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>Memcached::quit()</strong></span> closes any open connections to the
   memcache servers.
  </p>
 ...
 <div class="refsect1 parameters" id="refsect1-memcached.quit-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-memcached.quit-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/quit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.quit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.quit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.quit.php">＋<small>add a note</small></a></span>
