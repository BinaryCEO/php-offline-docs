...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ui.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ui.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ui.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.ui.php">
 <link rel="next" href="https://www.php.net/manual/en/ui.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ui.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ui.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ui.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ui.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ui.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ui.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ui.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ui.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ui.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ui.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ui.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ui.setup.php' selected="selected">English</option>
            <option value='de/ui.setup.php'>German</option>
            <option value='es/ui.setup.php'>Spanish</option>
            <option value='fr/ui.setup.php'>French</option>
            <option value='it/ui.setup.php'>Italian</option>
            <option value='ja/ui.setup.php'>Japanese</option>
            <option value='pt_BR/ui.setup.php'>Brazilian Portuguese</option>
            <option value='ru/ui.setup.php'>Russian</option>
            <option value='tr/ui.setup.php'>Turkish</option>
            <option value='uk/ui.setup.php'>Ukrainian</option>
            <option value='zh/ui.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ui.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="ui.requirements.php">Requirements</a></li><li><a href="ui.installation.php">Installation</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fui.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ui.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ui.setup.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125820">  <div class="votes">
    <div id="Vu125820">
    <a href="/manual/vote-note.php?id=125820&amp;page=ui.setup&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125820">
    <a href="/manual/vote-note.php?id=125820&amp;page=ui.setup&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125820" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125820" class="name">
  <strong class="user"><em>shevegen at gmail dot com</em></strong></a><a class="genanchor" href="#125820"> &para;</a><div class="date" title="2021-02-14 09:01"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125820">
<div class="phpcode"><code><span class="html">I believe this example is not correct; for example it shows "cmake" in<br />use but after you git clone the above URL, there are no cmake files.<br /><br />So this can not possibly have worked; and I actually don't think there<br />ever was cmake used in the above repository, which makes you wonder<br />why the above code used cmake to begin with. Did it ever work? I am not sure;<br />I tend to assume it did not work.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ui.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ui.setup.php">＋<small>add a note</small></a></div>
