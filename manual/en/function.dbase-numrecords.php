...
<head>
  ...
  <title>PHP: dbase_numrecords - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-numrecords.php">
 <link rel="shorturl" href="https://www.php.net/dbase-numrecords">
 <link rel="alternate" href="https://www.php.net/dbase-numrecords" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.dbase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-numfields.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dbase-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dbase-numrecords.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dbase-numrecords.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dbase-numrecords.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dbase-numrecords.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dbase-numrecords.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dbase-numrecords.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dbase-numrecords.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dbase-numrecords.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dbase-numrecords.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dbase-numrecords.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dbase-numrecords.php" hreflang="zh">
...
<meta name="Description" content="Gets the number of records in a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_numrecords - Manual" />
<meta name="twitter:description" content="Gets the number of records in a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_numrecords - Manual" />
<meta itemprop="description" content="Gets the number of records in a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of records in a database" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-numrecords.php' selected="selected">English</option>
            <option value='de/function.dbase-numrecords.php'>German</option>
            <option value='es/function.dbase-numrecords.php'>Spanish</option>
            <option value='fr/function.dbase-numrecords.php'>French</option>
            <option value='it/function.dbase-numrecords.php'>Italian</option>
            <option value='ja/function.dbase-numrecords.php'>Japanese</option>
            <option value='pt_BR/function.dbase-numrecords.php'>Brazilian Portuguese</option>
            <option value='ru/function.dbase-numrecords.php'>Russian</option>
            <option value='tr/function.dbase-numrecords.php'>Turkish</option>
            <option value='uk/function.dbase-numrecords.php'>Ukrainian</option>
            <option value='zh/function.dbase-numrecords.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dbase-numrecords" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.dbase-numfields.php" class="function" rel="rdfs-seeAlso">dbase_numfields()</a> - Gets the number of fields of a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-numrecords.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-numrecords%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-numrecords&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-numrecords.php">＋<small>add a note</small></a></span>
