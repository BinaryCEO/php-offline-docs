...
<head>
  ...
  <title>PHP: ReflectionClass::getConstant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.getconstant.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.getconstant.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getconstant.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getattributes.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.getconstants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.getconstant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.getconstant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.getconstant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.getconstant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.getconstant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.getconstant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.getconstant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.getconstant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.getconstant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.getconstant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.getconstant.php" hreflang="zh">
...
<meta name="Description" content="Gets defined constant" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getConstant - Manual" />
<meta name="twitter:description" content="Gets defined constant" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getConstant - Manual" />
<meta itemprop="description" content="Gets defined constant" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets defined constant" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.getconstants.php">
          ReflectionClass::getConstants &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getattributes.php">
          &laquo; ReflectionClass::getAttributes        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.getconstant.php' selected="selected">English</option>
            <option value='de/reflectionclass.getconstant.php'>German</option>
            <option value='es/reflectionclass.getconstant.php'>Spanish</option>
            <option value='fr/reflectionclass.getconstant.php'>French</option>
            <option value='it/reflectionclass.getconstant.php'>Italian</option>
            <option value='ja/reflectionclass.getconstant.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.getconstant.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.getconstant.php'>Russian</option>
            <option value='tr/reflectionclass.getconstant.php'>Turkish</option>
            <option value='uk/reflectionclass.getconstant.php'>Ukrainian</option>
            <option value='zh/reflectionclass.getconstant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.getconstant" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getConstant</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getConstant</span> &mdash; <span class="dc-title">Gets defined constant</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.getconstant-returnvalues">
  ...
  <p class="para">
   Value of the constant with the name <code class="parameter">name</code>.
   Returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the constant was not found in the class.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.getconstant-examples">
  ...
  <p class="para">
   <div class="example" id="example-5472">
    <p><strong>Example #1 Usage of <span class="methodname"><strong>ReflectionClass::getConstant()</strong></span></strong></p>
...
bool(false)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.getconstant-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.getconstants.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getConstants()</a> - Gets constants</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/getconstant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.getconstant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.getconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getconstant.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="113642">  <div class="votes">
    <div id="Vu113642">
    <a href="/manual/vote-note.php?id=113642&amp;page=reflectionclass.getconstant&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113642">
    <a href="/manual/vote-note.php?id=113642&amp;page=reflectionclass.getconstant&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113642" title="64% like this...">
    4
    </div>
  </div>
  <a href="#113642" class="name">
  <strong class="user"><em>aurelien dot tisserand at wavesoftware dot ch</em></strong></a><a class="genanchor" href="#113642"> &para;</a><div class="date" title="2013-11-08 03:27"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113642">
<div class="phpcode"><code><span class="html">If the $name constant doesn't exist in the targetted class the function returns bool(false), not empty nor null but false (you to test with "==="<br /><br />$constFounded = false ;<br />$this-&gt;currentlangClass = new ReflectionClass($langFile);<br />$this-&gt;currentlangClass-&gt;getConstant($constant);<br />if($myConst !== false){<br />              $constFounded = true ;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="108880">  <div class="votes">
    <div id="Vu108880">
    <a href="/manual/vote-note.php?id=108880&amp;page=reflectionclass.getconstant&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108880">
    <a href="/manual/vote-note.php?id=108880&amp;page=reflectionclass.getconstant&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108880" title="66% like this...">
    3
    </div>
  </div>
  <a href="#108880" class="name">
  <strong class="user"><em>Bhimsen</em></strong></a><a class="genanchor" href="#108880"> &para;</a><div class="date" title="2012-05-31 05:46"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108880">
<div class="phpcode"><code><span class="html">The "getconstant" method can be used to get the value associated with a constant <br />of a particular class that you are examining.<br />The following code snippet shows this:<br /><br /><span class="default">&lt;?php<br />    </span><span class="keyword">class </span><span class="default">Test</span><span class="keyword">{<br />        const </span><span class="default">ONE </span><span class="keyword">= </span><span class="string">"Number one"</span><span class="keyword">;<br />        const </span><span class="default">TWO </span><span class="keyword">= </span><span class="string">"Number two"</span><span class="keyword">;<br />    }<br />    <br />    </span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">( </span><span class="string">"Test" </span><span class="keyword">);<br />    echo </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">getconstant</span><span class="keyword">( </span><span class="string">"ONE" </span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">;<br />    echo </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">getconstant</span><span class="keyword">( </span><span class="string">"TWO" </span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">;<br />    <br /></span><span class="default">?&gt;<br /></span><br />output:<br />Number one<br />Number two</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.getconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.getconstant.php">＋<small>add a note</small></a></div>
