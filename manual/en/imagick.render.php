...
<head>
  ...
  <title>PHP: Imagick::render - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.render.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.render.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.render.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.removeimageprofile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.resampleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.render.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.render.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.render.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.render.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.render.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.render.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.render.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.render.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.render.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.render.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.render.php" hreflang="zh">
...
<meta name="Description" content="Renders all preceding drawing commands" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::render - Manual" />
<meta name="twitter:description" content="Renders all preceding drawing commands" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::render - Manual" />
<meta itemprop="description" content="Renders all preceding drawing commands" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Renders all preceding drawing commands" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.resampleimage.php">
          Imagick::resampleImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.removeimageprofile.php">
          &laquo; Imagick::removeImageProfile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.render.php' selected="selected">English</option>
            <option value='de/imagick.render.php'>German</option>
            <option value='es/imagick.render.php'>Spanish</option>
            <option value='fr/imagick.render.php'>French</option>
            <option value='it/imagick.render.php'>Italian</option>
            <option value='ja/imagick.render.php'>Japanese</option>
            <option value='pt_BR/imagick.render.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.render.php'>Russian</option>
            <option value='tr/imagick.render.php'>Turkish</option>
            <option value='uk/imagick.render.php'>Ukrainian</option>
            <option value='zh/imagick.render.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.render" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::render</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::render</span> &mdash; <span class="dc-title">Renders all preceding drawing commands</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.render-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::render</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.render-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.render-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/render.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.render%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.render&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.render.php">＋<small>add a note</small></a></span>
