...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-size.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ftp-site.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-ssl-connect.php">
...
<meta name="Description" content="Returns the size of the given file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_size - Manual" />
<meta name="twitter:description" content="Returns the size of the given file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_size - Manual" />
<meta itemprop="description" content="Returns the size of the given file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the size of the given file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-size.php' selected="selected">English</option>
            <option value='de/function.ftp-size.php'>German</option>
            <option value='es/function.ftp-size.php'>Spanish</option>
            <option value='fr/function.ftp-size.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ftp_size</span> &mdash; <span class="dc-title">Returns the size of the given file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.ftp-size-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>ftp_size()</strong></span> returns the size of the given file in
   bytes.
  </p>
 ...
 <div class="refsect1 examples" id="refsect1-function.ftp-size-examples">
  ...
  <p class="para">
   <div class="example" id="example-4586">
    <p><strong>Example #1 <span class="function"><strong>ftp_size()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ftp-rawlist.php" class="function" rel="rdfs-seeAlso">ftp_rawlist()</a> - Returns a detailed list of files in the given directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-size.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-size%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-size.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To overcome the 2 GB limitation, the ftp_raw solution below is probably the nicest. You can also perform this command using regular FTP commands:
<br />
<br /><span class="default">&lt;?php
<br />$response </span><span class="keyword">=  </span><span class="default">ftp_raw</span><span class="keyword">(</span><span class="default">$ftpConnection</span><span class="keyword">, </span><span class="string">"SIZE </span><span class="default">$filename</span><span class="string">"</span><span class="keyword">);
<br /></span><span class="default">$filesize </span><span class="keyword">= </span><span class="default">floatval</span><span class="keyword">(</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'213 '</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">$response</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]));
<br /></span><span class="default">?&gt;
<br /></span>
<br />[However, this] is insufficient for use on directories. As per RFC 3659 (<a href="http://tools.ietf.org/html/rfc3659#section-4.2" rel="nofollow" target="_blank">http://tools.ietf.org/html/rfc3659#section-4.2</a>), servers should return error 550 (File not found) if the command is issued on something else than a file, or if some other error occurred. For example, Filezilla indeed returns this string when using the ftp_raw command on a directory:
<br />
<br />array(1) {
<br />  [0]=&gt;
<br />  string(18) "550 File not found"
<br />}
<br />
<br />RFC 959 (<a href="http://tools.ietf.org/html/rfc959" rel="nofollow" target="_blank">http://tools.ietf.org/html/rfc959</a>) dictates that the returned string always consists of exactly 3 digits, followed by 1 space, followed by some text. (Multi-line text is allowed, but I am ignoring that.) So it is probably better to split the string with substr, or even a regular expression.
<br />
<br /><span class="default">&lt;?php
<br />$response </span><span class="keyword">= </span><span class="default">ftp_raw</span><span class="keyword">(</span><span class="default">$ftp</span><span class="keyword">, </span><span class="string">"SIZE </span><span class="default">$filename</span><span class="string">"</span><span class="keyword">);
<br /></span><span class="default">$responseCode </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">], </span><span class="default">0</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">);
<br /></span><span class="default">$responseMessage </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$response</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">], </span><span class="default">4</span><span class="keyword">);
<br /></span><span class="default">?&gt;
<br /></span>
<br />Or with a regular expression:
<br />
<br /><span class="default">&lt;?php
<br />$response </span><span class="keyword">= </span><span class="default">ftp_raw</span><span class="keyword">(</span><span class="default">$ftp</span><span class="keyword">, </span><span class="string">"SIZE </span><span class="default">$filename</span><span class="string">"</span><span class="keyword">);
<br />if (</span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">"/^(\\d{3}) (.*)$/"</span><span class="keyword">, </span><span class="default">$response</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">], </span><span class="default">$matches</span><span class="keyword">) == </span><span class="default">0</span><span class="keyword">)
<br />    throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Unable to parse FTP reply: "</span><span class="keyword">.</span><span class="default">$response</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]);
<br />list(</span><span class="default">$response</span><span class="keyword">, </span><span class="default">$responseCode</span><span class="keyword">, </span><span class="default">$responseMessage</span><span class="keyword">) = </span><span class="default">$matches</span><span class="keyword">;
<br /></span><span class="default">?&gt;
<br /></span>
<br />You could then decide to assume that response code '550' means that it's a directory. I guess that's just as 'dangerous' as assuming that ftp_size -1 means that it's a directory.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Just to let people out there know, on my windows 2000 server running Apache and php i was returned 0 not -1 for directories.<br /><br />foreach ($dir_list as $item)<br />    {<br />      if(ftp_size($conn_id, $item) == "0")<br />      {<br />      echo "&lt;br&gt;Directory:: ".$item;<br />      } else {<br />      echo "&lt;br&gt;File:: ".$item;<br />      }<br />    }<br /><br />This outputs a list of the remote directory and indicates which items are directories and which are files.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">If you experience troubles with size of large file then you can use ftp_rawlist function and parse it result</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">note that project_t4 at hotmail dot com's example above doesn't work in general, though it works on his Win2K/Apache server; as far as I can tell there is no way to check over ftp whether a directory exists.  This function's behavior given a directory name seems to be at least somewhat dependent on your OS, web server, or ftp server, I don't know which.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Well this function is nice but if you have files larger then 2.1Gb or 2.1 Billion Bytes you cannot get its size.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">To get a dirsize recursive you can use this simple function:<br /><br /><span class="default">&lt;?php </span><span class="comment"># copyright by fackelkind | codeMaster<br />    </span><span class="keyword">function </span><span class="default">getRecDirSize </span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">, </span><span class="default">$dir</span><span class="keyword">){<br />        </span><span class="default">$temp </span><span class="keyword">= </span><span class="default">ftp_rawlist </span><span class="keyword">(</span><span class="default">$connection</span><span class="keyword">, </span><span class="string">"-alR </span><span class="default">$dir</span><span class="string">"</span><span class="keyword">);<br />        foreach (</span><span class="default">$temp </span><span class="keyword">as </span><span class="default">$file</span><span class="keyword">){<br />            if (</span><span class="default">ereg </span><span class="keyword">(</span><span class="string">"([-d][rwxst-]+).* ([0-9]) ([a-zA-Z0-9]+).* ([a-zA-Z0-9]+).* ([0-9]*) ([a-zA-Z]+[0-9: ]*[0-9]) ([0-9]{2}:[0-9]{2}) (.+)"</span><span class="keyword">, </span><span class="default">$file</span><span class="keyword">, </span><span class="default">$regs</span><span class="keyword">)){  <br />                </span><span class="default">$isdir </span><span class="keyword">= (</span><span class="default">substr </span><span class="keyword">(</span><span class="default">$regs</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">],</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">) == </span><span class="string">"d"</span><span class="keyword">);<br />                if (!</span><span class="default">$isdir</span><span class="keyword">)<br />                    </span><span class="default">$size </span><span class="keyword">+= </span><span class="default">$regs</span><span class="keyword">[</span><span class="default">5</span><span class="keyword">];<br />            }<br />        }<br />        return </span><span class="default">$size</span><span class="keyword">;<br />    }<br />    </span><span class="default">$dirSize </span><span class="keyword">= </span><span class="default">getRecDirSize </span><span class="keyword">(</span><span class="default">$conID</span><span class="keyword">, </span><span class="string">"/"</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>nicke_ at at_h9k dot com</em></strong></a><a class="genanchor" href="#36297"> &para;</a><div class="date" title="2003-10-03 06:48"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom36297">
<div class="phpcode"><code><span class="html">This will return the filesize on remote host and the size if you download it in FTP_BINARY mode. If you are using FTP_ASCII in ftp_get() the size can be changed.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>victor59 at yahoo dot com dot hk</em></strong></a><a class="genanchor" href="#27883"> &para;</a><div class="date" title="2002-12-23 01:44"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom27883">
<div class="phpcode"><code><span class="html">$file= 'filename with space.txt';<br />$size = ftp_size($this-&gt;ftp, urldecode($file) );<br /><br />this one can correctly return the size<br />otherwize, it always return -1</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>miccots at gmail dot com</em></strong></a><a class="genanchor" href="#78834"> &para;</a><div class="date" title="2007-10-30 01:55"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78834">
<div class="phpcode"><code><span class="html">2 adams[AT]techweavers[DOT]net:<br />To get a size of large file (f. ex.: 3.2 Gb) you have to format the result returned by ftp_size():<br /><br />$size = sprintf ("%u", ftp_size($connection, $file_name));<br /><br />So you can get the real size of big files. But this method is not good for checking is this a dir (when ftp_size() returns -1).</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">For checking if a certain folder exists try using ftp_nlist() function to get a directory list in array. By using in_array('foldername') you can find out if it is there or not.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">To overcome the 2GB file size limit, you can open your own socket to get the file size of a large file. Quick and dirty script:
<br />
<br /><span class="default">&lt;?php
<br />$socket</span><span class="keyword">=</span><span class="default">fsockopen</span><span class="keyword">(</span><span class="default">$hostName</span><span class="keyword">, </span><span class="default">21</span><span class="keyword">);
<br /></span><span class="default">$t</span><span class="keyword">=</span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">);
<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="string">"USER </span><span class="default">$myLogin</span><span class="string">\r\n"</span><span class="keyword">);
<br /></span><span class="default">$t</span><span class="keyword">=</span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">);
<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="string">"PASS </span><span class="default">$myPass</span><span class="string">\r\n"</span><span class="keyword">);
<br /></span><span class="default">$t</span><span class="keyword">=</span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">);
<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="string">"SIZE </span><span class="default">$fileName</span><span class="string">\r\n"</span><span class="keyword">);
<br /></span><span class="default">$t</span><span class="keyword">=</span><span class="default">fgets</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="default">128</span><span class="keyword">);
<br /></span><span class="default">$fileSize</span><span class="keyword">=</span><span class="default">floatval</span><span class="keyword">(</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">"213 "</span><span class="keyword">,</span><span class="string">""</span><span class="keyword">,</span><span class="default">$t</span><span class="keyword">));
<br />echo </span><span class="default">$fileSize</span><span class="keyword">;
<br /></span><span class="default">fwrite</span><span class="keyword">(</span><span class="default">$socket</span><span class="keyword">, </span><span class="string">"QUIT\r\n"</span><span class="keyword">);
...
<div class="foot"><a href="/manual/add-note.php?sect=function.ftp-size&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-size.php">＋<small>add a note</small></a></div>
