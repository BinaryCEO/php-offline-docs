...
<head>
  ...
  <title>PHP: mysql_list_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-list-fields.php">
 <link rel="shorturl" href="https://www.php.net/mysql-list-fields">
 <link rel="alternate" href="https://www.php.net/mysql-list-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-list-dbs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-list-processes.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-list-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-list-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-list-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-list-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-list-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-list-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-list-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-list-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-list-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-list-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-list-fields.php" hreflang="zh">
...
<meta name="Description" content="List MySQL table fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_list_fields - Manual" />
<meta name="twitter:description" content="List MySQL table fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_list_fields - Manual" />
<meta itemprop="description" content="List MySQL table fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="List MySQL table fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mysql-list-processes.php">
          mysql_list_processes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-list-dbs.php">
          &laquo; mysql_list_dbs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-list-fields.php' selected="selected">English</option>
            <option value='de/function.mysql-list-fields.php'>German</option>
            <option value='es/function.mysql-list-fields.php'>Spanish</option>
            <option value='fr/function.mysql-list-fields.php'>French</option>
            <option value='it/function.mysql-list-fields.php'>Italian</option>
            <option value='ja/function.mysql-list-fields.php'>Japanese</option>
            <option value='pt_BR/function.mysql-list-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-list-fields.php'>Russian</option>
            <option value='tr/function.mysql-list-fields.php'>Turkish</option>
            <option value='uk/function.mysql-list-fields.php'>Ukrainian</option>
            <option value='zh/function.mysql-list-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-list-fields" class="refentry">
...
<strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is generated.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mysql-list-fields-returnvalues">
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.mysql-field-name.php" class="function">mysql_field_name()</a></span> and
 ...
 <div class="refsect1 examples" id="refsect1-function.mysql-list-fields-examples">
  ...
  <p class="para">
   <div class="example" id="example-1912">
    <p><strong>Example #1 Alternate to deprecated <span class="function"><strong>mysql_list_fields()</strong></span></strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-info.php" class="function" rel="rdfs-seeAlso">mysql_info()</a> - Get information about the most recent query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-list-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-list-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-list-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-list-fields.php">＋<small>add a note</small></a></span>
