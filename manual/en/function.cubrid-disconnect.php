...
<head>
  ...
  <title>PHP: cubrid_disconnect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-disconnect.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-disconnect">
 <link rel="alternate" href="https://www.php.net/cubrid-disconnect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-current-oid.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-drop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-disconnect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-disconnect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-disconnect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-disconnect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-disconnect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-disconnect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-disconnect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-disconnect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-disconnect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-disconnect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-disconnect.php" hreflang="zh">
...
<meta name="Description" content="Close a database connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_disconnect - Manual" />
<meta name="twitter:description" content="Close a database connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_disconnect - Manual" />
<meta itemprop="description" content="Close a database connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close a database connection" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-drop.php">
          cubrid_drop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-current-oid.php">
          &laquo; cubrid_current_oid        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-disconnect.php' selected="selected">English</option>
            <option value='de/function.cubrid-disconnect.php'>German</option>
            <option value='es/function.cubrid-disconnect.php'>Spanish</option>
            <option value='fr/function.cubrid-disconnect.php'>French</option>
            <option value='it/function.cubrid-disconnect.php'>Italian</option>
            <option value='ja/function.cubrid-disconnect.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-disconnect.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-disconnect.php'>Russian</option>
            <option value='tr/function.cubrid-disconnect.php'>Turkish</option>
            <option value='uk/function.cubrid-disconnect.php'>Ukrainian</option>
            <option value='zh/function.cubrid-disconnect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-disconnect" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_disconnect</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_disconnect</span> &mdash; <span class="dc-title">Close a database connection</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-disconnect-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_disconnect</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$conn_identifier</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_disconnect()</strong></span> function closes the connection
    handle and disconnects from server. If any request handle is not closed at this point, 
    it will be closed. It is similar to the CUBRID MySQL compatible function <span class="function"><a href="function.cubrid-close.php" class="function">cubrid_close()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.cubrid-disconnect-parameters">
 ...
 <p class="para">
  ...
  <div class="refsect1 returnvalues" id="refsect1-function.cubrid-disconnect-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$con </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_connect </span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #0000BB">33000</span><span style="color: #007700">, </span><span style="color: #DD0000">"demodb"</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$con</span><span style="color: #007700">) {<br />   echo </span><span style="color: #DD0000">"connected successfully"</span><span style="color: #007700">;<br />   <br />   </span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">( </span><span style="color: #0000BB">$con</span><span style="color: #007700">, </span><span style="color: #DD0000">"create table person(id int,name char(10))"</span><span style="color: #007700">);<br />   if (</span><span style="color: #0000BB">$req</span><span style="color: #007700">) {<br />      </span><span style="color: #0000BB">cubrid_close_request</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br />      </span><span style="color: #0000BB">cubrid_commit</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />   } else {<br />      </span><span style="color: #0000BB">cubrid_rollback</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />   }<br />   <br />   </span><span style="color: #0000BB">$req </span><span style="color: #007700">= </span><span style="color: #0000BB">cubrid_execute</span><span style="color: #007700">( </span><span style="color: #0000BB">$con</span><span style="color: #007700">, </span><span style="color: #DD0000">"insert into person values(1,'James')"</span><span style="color: #007700">);<br />   if (</span><span style="color: #0000BB">$req</span><span style="color: #007700">) {<br />      </span><span style="color: #0000BB">cubrid_close_request</span><span style="color: #007700">(</span><span style="color: #0000BB">$req</span><span style="color: #007700">);<br />      </span><span style="color: #0000BB">cubrid_commit</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />   } else {<br />      </span><span style="color: #0000BB">cubrid_rollback</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />   }<br />   </span><span style="color: #0000BB">cubrid_disconnect</span><span style="color: #007700">(</span><span style="color: #0000BB">$con</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.cubrid-disconnect-seealso">
  ...
  <p class="para">
   ...
   <li><span class="function"><a href="function.cubrid-connect-with-url.php" class="function" rel="rdfs-seeAlso">cubrid_connect_with_url()</a> - Establish the environment for connecting to CUBRID server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-disconnect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-disconnect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-disconnect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-disconnect.php">＋<small>add a note</small></a></span>
