...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ds.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ds.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ds.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ds.php">
 <link rel="prev" href="https://www.php.net/manual/en/ds.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ds-collection.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ds.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ds.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ds.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ds.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ds.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ds.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ds.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ds.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ds.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ds.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ds.examples.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ds.examples.php' selected="selected">English</option>
            <option value='de/ds.examples.php'>German</option>
            <option value='es/ds.examples.php'>Spanish</option>
            <option value='fr/ds.examples.php'>French</option>
            <option value='it/ds.examples.php'>Italian</option>
            <option value='ja/ds.examples.php'>Japanese</option>
            <option value='pt_BR/ds.examples.php'>Brazilian Portuguese</option>
            <option value='ru/ds.examples.php'>Russian</option>
            <option value='tr/ds.examples.php'>Turkish</option>
            <option value='uk/ds.examples.php'>Ukrainian</option>
            <option value='zh/ds.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ds.examples" class="chapter">
...
(
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ds/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fds.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ds.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ds.examples.php">＋<small>add a note</small></a></span>
