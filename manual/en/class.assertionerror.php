...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.assertionerror.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/class.arithmeticerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.divisionbyzeroerror.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.assertionerror.php' selected="selected">English</option>
            ...
            <option value='zh/class.assertionerror.php'>Chinese (Simplified)</option>
 ...
 <div class="partintro"><p class="verinfo">(PHP 7, PHP 8)</p>
  ...
  <div class="section" id="assertionerror.intro">
   ...
   <p class="para">
    <span class="ooclass"><span class="classname"><strong class="classname">AssertionError</strong></span></span> is thrown when
    an assertion made via <span class="function"><a href="function.assert.php" class="function">assert()</a></span> fails.
   </p>
  </div>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/assertionerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.assertionerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.assertionerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.assertionerror.php">＋<small>add a note</small></a></span>
