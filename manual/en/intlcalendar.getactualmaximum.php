...
<head>
  ...
  <title>PHP: IntlCalendar::getActualMaximum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getactualmaximum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getactualmaximum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getactualmaximum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.get.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getactualminimum.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getactualmaximum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.getactualmaximum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.getactualmaximum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.getactualmaximum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.getactualmaximum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.getactualmaximum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.getactualmaximum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.getactualmaximum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.getactualmaximum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.getactualmaximum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.getactualmaximum.php" hreflang="zh">
...
<meta name="Description" content="The maximum value for a field, considering the objectʼs current time" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getActualMaximum - Manual" />
<meta name="twitter:description" content="The maximum value for a field, considering the objectʼs current time" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getActualMaximum - Manual" />
<meta itemprop="description" content="The maximum value for a field, considering the objectʼs current time" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The maximum value for a field, considering the objectʼs current time" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.getactualminimum.php">
          IntlCalendar::getActualMinimum &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.get.php">
          &laquo; IntlCalendar::get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getactualmaximum.php' selected="selected">English</option>
            <option value='de/intlcalendar.getactualmaximum.php'>German</option>
            <option value='es/intlcalendar.getactualmaximum.php'>Spanish</option>
            <option value='fr/intlcalendar.getactualmaximum.php'>French</option>
            <option value='it/intlcalendar.getactualmaximum.php'>Italian</option>
            <option value='ja/intlcalendar.getactualmaximum.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.getactualmaximum.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.getactualmaximum.php'>Russian</option>
            <option value='tr/intlcalendar.getactualmaximum.php'>Turkish</option>
            <option value='uk/intlcalendar.getactualmaximum.php'>Ukrainian</option>
            <option value='zh/intlcalendar.getactualmaximum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.getactualmaximum" class="refentry">
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getactualmaximum-returnvalues">
  ...
  <p class="para">
   ...
   with the given <code class="parameter">field</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="intlcalendar.getactualminimum.php" class="methodname" rel="rdfs-seeAlso">IntlCalendar::getActualMinimum()</a> - The minimum value for a field, considering the objectʼs current time</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getactualmaximum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getactualmaximum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getactualmaximum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getactualmaximum.php">＋<small>add a note</small></a></span>
