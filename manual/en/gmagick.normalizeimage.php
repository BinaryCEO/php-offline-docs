...
<head>
  ...
  <title>PHP: Gmagick::normalizeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.normalizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.normalizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.normalizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.nextimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.oilpaintimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.normalizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.normalizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.normalizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.normalizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.normalizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.normalizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.normalizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.normalizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.normalizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.normalizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.normalizeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::normalizeimage - Manual" />
<meta name="twitter:description" content="Enhances the contrast of a color image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::normalizeimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.oilpaintimage.php">
          Gmagick::oilpaintimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.nextimage.php">
          &laquo; Gmagick::nextimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.normalizeimage.php' selected="selected">English</option>
            <option value='de/gmagick.normalizeimage.php'>German</option>
            <option value='es/gmagick.normalizeimage.php'>Spanish</option>
            <option value='fr/gmagick.normalizeimage.php'>French</option>
            <option value='it/gmagick.normalizeimage.php'>Italian</option>
            <option value='ja/gmagick.normalizeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.normalizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.normalizeimage.php'>Russian</option>
            <option value='tr/gmagick.normalizeimage.php'>Turkish</option>
            <option value='uk/gmagick.normalizeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.normalizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.normalizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::normalizeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::normalizeimage</span> &mdash; <span class="dc-title">Enhances the contrast of a color image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.normalizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::normalizeimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.normalizeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.normalizeimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.normalizeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/normalizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.normalizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.normalizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.normalizeimage.php">＋<small>add a note</small></a></span>
