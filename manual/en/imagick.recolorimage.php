...
<head>
  ...
  <title>PHP: Imagick::recolorImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.recolorimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.recolorimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.recolorimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.readimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.reducenoiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.recolorimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.recolorimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.recolorimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.recolorimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.recolorimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.recolorimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.recolorimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.recolorimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.recolorimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.recolorimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.recolorimage.php" hreflang="zh">
...
<meta name="Description" content="Recolors image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::recolorImage - Manual" />
<meta name="twitter:description" content="Recolors image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::recolorImage - Manual" />
<meta itemprop="description" content="Recolors image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Recolors image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.reducenoiseimage.php">
          Imagick::reduceNoiseImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.readimages.php">
          &laquo; Imagick::readimages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.recolorimage.php' selected="selected">English</option>
            <option value='de/imagick.recolorimage.php'>German</option>
            <option value='es/imagick.recolorimage.php'>Spanish</option>
            <option value='fr/imagick.recolorimage.php'>French</option>
            <option value='it/imagick.recolorimage.php'>Italian</option>
            <option value='ja/imagick.recolorimage.php'>Japanese</option>
            <option value='pt_BR/imagick.recolorimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.recolorimage.php'>Russian</option>
            <option value='tr/imagick.recolorimage.php'>Turkish</option>
            <option value='uk/imagick.recolorimage.php'>Ukrainian</option>
            <option value='zh/imagick.recolorimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.recolorimage" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.recolorimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-3076">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.displayimage.php" class="function" rel="rdfs-seeAlso">Imagick::displayImage()</a> - Displays an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/recolorimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.recolorimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.recolorimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.recolorimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="112095">  <div class="votes">
    <div id="Vu112095">
    <a href="/manual/vote-note.php?id=112095&amp;page=imagick.recolorimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd112095">
    <a href="/manual/vote-note.php?id=112095&amp;page=imagick.recolorimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V112095" title="100% like this...">
    1
    </div>
  </div>
  <a href="#112095" class="name">
  <strong class="user"><em>softmixt at gmail dot com</em></strong></a><a class="genanchor" href="#112095"> &para;</a><div class="date" title="2013-05-02 11:59"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112095">
<div class="phpcode"><code><span class="html">Simple example :<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'test.jpg'</span><span class="keyword">);<br /><br /></span><span class="default">$CMYK_color_model </span><span class="keyword">= array(</span><span class="default">0</span><span class="keyword">,</span><span class="default">100</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">recolorImage</span><span class="keyword">(</span><span class="default">$CMYK_color_model</span><span class="keyword">) ;<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/jpg'</span><span class="keyword">);<br /><br />echo </span><span class="default">$image<br />?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.recolorimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.recolorimage.php">＋<small>add a note</small></a></div>
