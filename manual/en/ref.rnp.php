...
<head>
  ...
  <title>PHP: Rnp Functions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.rnp.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/rnp.examples-clearsign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-backend-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.rnp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.rnp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.rnp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.rnp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.rnp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.rnp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.rnp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.rnp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.rnp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.rnp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.rnp.php" hreflang="zh">
...
<meta name="Description" content="Rnp Functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Rnp Functions - Manual" />
<meta name="twitter:description" content="Rnp Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Rnp Functions - Manual" />
<meta itemprop="description" content="Rnp Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rnp Functions" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-backend-string.php">
          rnp_backend_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="rnp.examples-clearsign.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.rnp.php' selected="selected">English</option>
            <option value='de/ref.rnp.php'>German</option>
            <option value='es/ref.rnp.php'>Spanish</option>
            <option value='fr/ref.rnp.php'>French</option>
            <option value='it/ref.rnp.php'>Italian</option>
            <option value='ja/ref.rnp.php'>Japanese</option>
            <option value='pt_BR/ref.rnp.php'>Brazilian Portuguese</option>
            <option value='ru/ref.rnp.php'>Russian</option>
            <option value='tr/ref.rnp.php'>Turkish</option>
            <option value='uk/ref.rnp.php'>Ukrainian</option>
            <option value='zh/ref.rnp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.rnp" class="reference">
   ...
   encryption subkey, signature)</li><li><a href="function.rnp-key-export-revocation.php">rnp_key_export_revocation</a> — Generate and export primary key revocation signature</li><li><a href="function.rnp-key-get-info.php">rnp_key_get_info</a> — Get information about the key</li><li><a href="function.rnp-key-remove.php">rnp_key_remove</a> — Remove a key from keyring(s)</li><li><a href="function.rnp-key-revoke.php">rnp_key_revoke</a> — Revoke a key or subkey by generating and adding revocation signature</li><li><a href="function.rnp-list-keys.php">rnp_list_keys</a> — Enumerate all keys present in a keyring by specified identifer type</li><li><a href="function.rnp-load-keys.php">rnp_load_keys</a> — Load keys from PHP string</li><li><a href="function.rnp-load-keys-from-path.php">rnp_load_keys_from_path</a> — Load keys from specified path</li><li><a href="function.rnp-locate-key.php">rnp_locate_key</a> — Search for the key</li><li><a href="function.rnp-op-encrypt.php">rnp_op_encrypt</a> — Encrypt message</li><li><a href="function.rnp-op-generate-key.php">rnp_op_generate_key</a> — Generate key</li><li><a href="function.rnp-op-sign.php">rnp_op_sign</a> — Perform signing operation on a binary data, return embedded signature(s)</li><li><a href="function.rnp-op-sign-cleartext.php">rnp_op_sign_cleartext</a> — Perform signing operation on a textual data, return cleartext signed message</li><li><a href="function.rnp-op-sign-detached.php">rnp_op_sign_detached</a> — Perform signing operation, return detached signature(s)</li><li><a href="function.rnp-op-verify.php">rnp_op_verify</a> — Verify embedded or cleartext signatures</li><li><a href="function.rnp-op-verify-detached.php">rnp_op_verify_detached</a> — Verify detached signatures</li><li><a href="function.rnp-save-keys.php">rnp_save_keys</a> — Save keys to PHP string</li><li><a href="function.rnp-save-keys-to-path.php">rnp_save_keys_to_path</a> — Save keys to specified path</li><li><a href="function.rnp-supported-features.php">rnp_supported_features</a> — Get supported features in JSON format</li><li><a href="function.rnp-version-string.php">rnp_version_string</a> — RNP library version</li><li><a href="function.rnp-version-string-full.php">rnp_version_string_full</a> — Full version string of RNP library</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.rnp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.rnp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.rnp.php">＋<small>add a note</small></a></span>
