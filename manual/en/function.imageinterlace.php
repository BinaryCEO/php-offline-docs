...
<head>
  ...
  <title>PHP: imageinterlace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imageinterlace.php">
 <link rel="shorturl" href="https://www.php.net/imageinterlace">
 <link rel="alternate" href="https://www.php.net/imageinterlace" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagegrabwindow.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageistruecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imageinterlace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imageinterlace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imageinterlace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imageinterlace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imageinterlace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imageinterlace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imageinterlace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imageinterlace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imageinterlace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imageinterlace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imageinterlace.php" hreflang="zh">
...
<meta name="Description" content="Enable or disable interlace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imageinterlace - Manual" />
<meta name="twitter:description" content="Enable or disable interlace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imageinterlace - Manual" />
<meta itemprop="description" content="Enable or disable interlace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enable or disable interlace" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imageistruecolor.php">
          imageistruecolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagegrabwindow.php">
          &laquo; imagegrabwindow        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imageinterlace.php' selected="selected">English</option>
            <option value='de/function.imageinterlace.php'>German</option>
            <option value='es/function.imageinterlace.php'>Spanish</option>
            <option value='fr/function.imageinterlace.php'>French</option>
            <option value='it/function.imageinterlace.php'>Italian</option>
            <option value='ja/function.imageinterlace.php'>Japanese</option>
            <option value='pt_BR/function.imageinterlace.php'>Brazilian Portuguese</option>
            <option value='ru/function.imageinterlace.php'>Russian</option>
            <option value='tr/function.imageinterlace.php'>Turkish</option>
            <option value='uk/function.imageinterlace.php'>Ukrainian</option>
            <option value='zh/function.imageinterlace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imageinterlace" class="refentry">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
     ...
     <dt><code class="parameter">interlace</code></dt>
     <dd>
      <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Create an image instance<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromgif</span><span style="color: #007700">(</span><span style="color: #DD0000">'php.gif'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Enable interlancing<br /></span><span style="color: #0000BB">imageinterlace</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Save the interlaced image<br /></span><span style="color: #0000BB">imagegif</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'./php_interlaced.gif'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imageinterlace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imageinterlace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imageinterlace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageinterlace.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">11 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125476">  <div class="votes">
    <div id="Vu125476">
    <a href="/manual/vote-note.php?id=125476&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125476">
    <a href="/manual/vote-note.php?id=125476&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125476" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125476" class="name">
  <strong class="user"><em>info at dvorakj dot com</em></strong></a><a class="genanchor" href="#125476"> &para;</a><div class="date" title="2020-10-29 09:09"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125476">
<div class="phpcode"><code><span class="html">This function will be great only after that browsers will stop sending next data if it is already sent enought to display them on users’s screen due to its possibilities and more pixels to send are absolutely useless. This is the current purpose of jpeg progressivity and still not implemented. After that, you doesn’t have to create many versions of pictures for different densities of screens and it will save a lot of things.</span></code></div>
  </div>
 </div>
  <div class="note" id="124610">  <div class="votes">
    <div id="Vu124610">
    <a href="/manual/vote-note.php?id=124610&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124610">
    <a href="/manual/vote-note.php?id=124610&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124610" title="no votes...">
    0
    </div>
  </div>
  <a href="#124610" class="name">
  <strong class="user"><em>razvan_bc at yahoo dot com</em></strong></a><a class="genanchor" href="#124610"> &para;</a><div class="date" title="2020-01-14 08:54"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124610">
<div class="phpcode"><code><span class="html">this function really saved my day !!!<br /><br />well for testing i should upload several jpg some had jfif encoding ,<br />so some are color losing when i include them in fpdf ,tcpdf (i tryed 2 open sources to minimize errors to know wht's wrong) .<br />the thumb function i used now (fixed) is<br /><br />public static function jpgtofilethumb($file,$thumb,$lun,$quality){<br />        //de la php.net<br />        list ($x, $y) = @getimagesize ($file);<br />        $img = @imagecreatefromjpeg ($file);<br />        if ($x &gt; $y) {<br />            $tx = $lun;<br />            $ty = round($lun / $x * $y);<br />        } else {<br />            $tx = round($lun / $y * $x);<br />            $ty = $lun;<br />        }<br />        $thb = imagecreatetruecolor ($tx, $ty);<br /><br />        // Enable interlancing<br />        if(imageistruecolor($thb)) imageinterlace($thb, true);<br /><br />        imagecopyresampled ($thb,$img, 0,0, 0,0, $tx,$ty, $x,$y);<br />        imagejpeg ($thb, $thumb, $quality);<br />        imagedestroy ($thb);<br />        imagedestroy ($img);<br />    }</span></code></div>
  </div>
 </div>
  <div class="note" id="72581">  <div class="votes">
    <div id="Vu72581">
    <a href="/manual/vote-note.php?id=72581&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd72581">
    <a href="/manual/vote-note.php?id=72581&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V72581" title="50% like this...">
    0
    </div>
  </div>
  <a href="#72581" class="name">
  <strong class="user"><em>Gerry Danen</em></strong></a><a class="genanchor" href="#72581"> &para;</a><div class="date" title="2007-01-24 05:20"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom72581">
<div class="phpcode"><code><span class="html">It was suggested that this function can be used to retrieve the interlace bit of an image that is stored in a file. This is not the case. <br />While imageinterlace() returns 0 or 1 if a valid Image resource is passed, passing a file name as a string results in a PHP warning and the return value is neither 0 nor 1.</span></code></div>
  </div>
 </div>
  <div class="note" id="60805">  <div class="votes">
    <div id="Vu60805">
    <a href="/manual/vote-note.php?id=60805&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd60805">
    <a href="/manual/vote-note.php?id=60805&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V60805" title="50% like this...">
    0
    </div>
  </div>
  <a href="#60805" class="name">
  <strong class="user"><em>mangobrain.co.uk</em></strong></a><a class="genanchor" href="#60805"> &para;</a><div class="date" title="2006-01-17 02:03"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom60805">
<div class="phpcode"><code><span class="html">dr_snapid's comment that "the server sends every Nth line" is not entirely true. A web server need not know anything about the contents of the file it is sending; its job is simply to send the data. Rather, the image is created in such a way that the data corresponding to "every Nth line" appears at the beginning of the file, with the details becoming able to be filled in as more of the file is received by the browser. In PHP's case, the data may have been generated dynamically instead of pulled from a file, but this does not change the fact that it is the data itself that is different, not the manner in which it is sent.*<br /><br />In fact, with JPEG, it is less "every Nth line", and more "every Nth pixel", where N is gradually decreased, resulting in a grid that gets progressively more fine-grained as the data is received (hence the appearance of a low res image becoming more detailed). The browser basically estimates what goes in the gaps between pixels, probably by simply blending between the colours, whilst the "real" data continues arriving. This is a fundamentally different method for encoding the data when compared to non-progressive JPEGs, and coupled with the format's other compression techniques, may indeed result in a different file size.<br /><br />*Can you imagine how much more buggy the Web would be if servers were expected to send different file types using different algorithms, and browsers were expected to be able to receive every one of them?</span></code></div>
  </div>
 </div>
  <div class="note" id="54792">  <div class="votes">
    <div id="Vu54792">
    <a href="/manual/vote-note.php?id=54792&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54792">
    <a href="/manual/vote-note.php?id=54792&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54792" title="50% like this...">
    0
    </div>
  </div>
  <a href="#54792" class="name">
  <strong class="user"><em>thomas dot brandl at barff dot de</em></strong></a><a class="genanchor" href="#54792"> &para;</a><div class="date" title="2005-07-15 12:28"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54792">
<div class="phpcode"><code><span class="html">Set imageinterlace() to 0 if you need to load the generated images in Flash. Flash does not support progressive JPEGs</span></code></div>
  </div>
 </div>
  <div class="note" id="47535">  <div class="votes">
    <div id="Vu47535">
    <a href="/manual/vote-note.php?id=47535&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd47535">
    <a href="/manual/vote-note.php?id=47535&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V47535" title="50% like this...">
    0
    </div>
  </div>
  <a href="#47535" class="name">
  <strong class="user"><em>mironto at mironto dot sk</em></strong></a><a class="genanchor" href="#47535"> &para;</a><div class="date" title="2004-11-19 06:17"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom47535">
<div class="phpcode"><code><span class="html">just to add my 5 cents on the progressive principle of jpeg: there are no several lowres images stored in jpeg along with original picture, the only thing altered is the order of "pixels". in jpeg the image is divided in areas 8x8 pixels, so instead of linear order of pixels (row-by-row), first there is one pixel form each 8x8 area included in the begining of the image data stream, so when the browser recieves all 8x8 area pixels, it can display "pixelate" image and as soon as it recieves more data, the browser can add more pixels and "sharpen" the image.</span></code></div>
  </div>
 </div>
  <div class="note" id="61267">  <div class="votes">
    <div id="Vu61267">
    <a href="/manual/vote-note.php?id=61267&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61267">
    <a href="/manual/vote-note.php?id=61267&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61267" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#61267" class="name">
  <strong class="user"><em>julien / at / theoconcept.com</em></strong></a><a class="genanchor" href="#61267"> &para;</a><div class="date" title="2006-01-29 02:33"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61267">
<div class="phpcode"><code><span class="html">This function is useful when working with Ming, as SWFBitmap constructor will use a NON INTERLACED Jpeg file, so you have to use imageinterlace(0);</span></code></div>
  </div>
 </div>
  <div class="note" id="41582">  <div class="votes">
    <div id="Vu41582">
    <a href="/manual/vote-note.php?id=41582&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd41582">
    <a href="/manual/vote-note.php?id=41582&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V41582" title="40% like this...">
    -1
    </div>
  </div>
  <a href="#41582" class="name">
  <strong class="user"><em>manuel.warum at edu.uni-klu.ac.at</em></strong></a><a class="genanchor" href="#41582"> &para;</a><div class="date" title="2004-04-15 10:41"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom41582">
<div class="phpcode"><code><span class="html">About MichaelSoft's note "Imageinterlace($im, 1) creates a JPG which is first loaded completely before showing anything":<br /><br />Actually, that's not completely true.<br />This only happens with Internet Explorer (any version, for the time being) as it doesn't seem to support progressive displaying and rather shows the image, when it's 100% done with loading. Other browsers (Mozilla, Mozilla Firefox, Opera, Konqueror, etc.) do their job as they're supposed to do: Displaying a very low-res image, then overlaying a midlow-res image (while loading), and then displaying more and more details.</span></code></div>
  </div>
 </div>
  <div class="note" id="40929">  <div class="votes">
    <div id="Vu40929">
    <a href="/manual/vote-note.php?id=40929&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd40929">
    <a href="/manual/vote-note.php?id=40929&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V40929" title="25% like this...">
    -2
    </div>
  </div>
  <a href="#40929" class="name">
  <strong class="user"><em>ben dash xo at dubplates dot org</em></strong></a><a class="genanchor" href="#40929"> &para;</a><div class="date" title="2004-03-19 06:25"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom40929">
<div class="phpcode"><code><span class="html">There is a bug in Microsoft Internet Explorer (at least at present) that means that often, a progressive/interlaced JPEG will actually NOT show at all whilst loading, suddenly appearing only when the entire picture has loaded. A regular NON-interlaced/NON-progressive JPEG will display line by line as it loads, which paradoxically gives the illusion that it's loading faster. MSIE definitely has this one backwards!!<br /><br />This behaviour is not apparent in other browsers such as Mozilla/FireFox - in these browsers, the image loads progressively, as it should.</span></code></div>
  </div>
 </div>
  <div class="note" id="58954">  <div class="votes">
    <div id="Vu58954">
    <a href="/manual/vote-note.php?id=58954&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd58954">
    <a href="/manual/vote-note.php?id=58954&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V58954" title="28% like this...">
    -3
    </div>
  </div>
  <a href="#58954" class="name">
  <strong class="user"><em>dr_snapid at mxm dot com dot au</em></strong></a><a class="genanchor" href="#58954"> &para;</a><div class="date" title="2005-11-21 08:16"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom58954">
<div class="phpcode"><code><span class="html">Interlacing doesnt store another image, it simple changes the order in which the images lines are sent and rendered. The server sends every Nth line, reaches the end, then goes back to the start, reading the lines in between. <br /><br />After each pass the browser displays the downloaded lines, plus filles the lines not yet received the same, but with each pass the gaps being filled get smaller and the image sharpens. After several passes every line has been read, and the browser has rendered the image in full detail.<br /><br />Hope that makes sense, it does explain why there should not really be any difference in filesize, so I cant explain why some people have observed a file size difference.<br /><br />As I understand it, there is only 1 bit in the file which says if its interlaced or not, and the server and client (browser) just handle it differently if it is set to 1.</span></code></div>
  </div>
 </div>
  <div class="note" id="53753">  <div class="votes">
    <div id="Vu53753">
    <a href="/manual/vote-note.php?id=53753&amp;page=function.imageinterlace&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53753">
    <a href="/manual/vote-note.php?id=53753&amp;page=function.imageinterlace&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53753" title="0% like this...">
    -5
    </div>
  </div>
  <a href="#53753" class="name">
  <strong class="user"><em>drake127</em></strong></a><a class="genanchor" href="#53753"> &para;</a><div class="date" title="2005-06-11 03:51"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53753">
<div class="phpcode"><code><span class="html">Interlancing works also with PNG files but it increase filesize (from 14.4M to 17.7M).</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imageinterlace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imageinterlace.php">＋<small>add a note</small></a></div>
