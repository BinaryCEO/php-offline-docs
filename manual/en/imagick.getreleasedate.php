...
<head>
  ...
  <title>PHP: Imagick::getReleaseDate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getreleasedate.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getreleasedate.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getreleasedate.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getregistry.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getresource.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getreleasedate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getreleasedate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getreleasedate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getreleasedate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getreleasedate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getreleasedate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getreleasedate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getreleasedate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getreleasedate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getreleasedate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getreleasedate.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick release date" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getReleaseDate - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick release date" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getReleaseDate - Manual" />
<meta itemprop="description" content="Returns the ImageMagick release date" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick release date" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getresource.php">
          Imagick::getResource &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getregistry.php">
          &laquo; Imagick::getRegistry        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getreleasedate.php' selected="selected">English</option>
            <option value='de/imagick.getreleasedate.php'>German</option>
            <option value='es/imagick.getreleasedate.php'>Spanish</option>
            <option value='fr/imagick.getreleasedate.php'>French</option>
            <option value='it/imagick.getreleasedate.php'>Italian</option>
            <option value='ja/imagick.getreleasedate.php'>Japanese</option>
            <option value='pt_BR/imagick.getreleasedate.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getreleasedate.php'>Russian</option>
            <option value='tr/imagick.getreleasedate.php'>Turkish</option>
            <option value='uk/imagick.getreleasedate.php'>Ukrainian</option>
            <option value='zh/imagick.getreleasedate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getreleasedate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getReleaseDate</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getReleaseDate</span> &mdash; <span class="dc-title">Returns the ImageMagick release date</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getreleasedate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getReleaseDate</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getreleasedate-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getreleasedate-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getreleasedate-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getreleasedate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getreleasedate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getreleasedate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getreleasedate.php">＋<small>add a note</small></a></span>
