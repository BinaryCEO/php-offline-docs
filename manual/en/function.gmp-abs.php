...
<head>
  ...
  <title>PHP: gmp_abs - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-abs.php">
 <link rel="shorturl" href="https://www.php.net/gmp-abs">
 <link rel="alternate" href="https://www.php.net/gmp-abs" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-abs.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-abs.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-abs.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-abs.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-abs.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-abs.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-abs.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-abs.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-abs.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-abs.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-abs.php" hreflang="zh">
...
<meta name="Description" content="Absolute value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_abs - Manual" />
<meta name="twitter:description" content="Absolute value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_abs - Manual" />
<meta itemprop="description" content="Absolute value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Absolute value" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-abs.php' selected="selected">English</option>
            <option value='de/function.gmp-abs.php'>German</option>
            <option value='es/function.gmp-abs.php'>Spanish</option>
            <option value='fr/function.gmp-abs.php'>French</option>
            <option value='it/function.gmp-abs.php'>Italian</option>
            <option value='ja/function.gmp-abs.php'>Japanese</option>
            <option value='pt_BR/function.gmp-abs.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-abs.php'>Russian</option>
            <option value='tr/function.gmp-abs.php'>Turkish</option>
            <option value='uk/function.gmp-abs.php'>Ukrainian</option>
            <option value='zh/function.gmp-abs.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-abs" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gmp_abs</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_abs</span> &mdash; <span class="dc-title">Absolute value</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.gmp-abs-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gmp_abs</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span>|<span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$num</code></span>): <span class="type"><a href="class.gmp.php" class="type GMP">GMP</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gmp-abs-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-abs-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the absolute value of <code class="parameter">num</code>, as a GMP number.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.gmp-abs-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3312">
    <p><strong>Example #1 <span class="function"><strong>gmp_abs()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">274982683358
274982683358</pre>
</div>
    </div>
   </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-abs.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-abs%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-abs&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-abs.php">＋<small>add a note</small></a></span>
