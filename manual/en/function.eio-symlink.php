...
<head>
  ...
  <title>PHP: eio_symlink - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-symlink.php">
 <link rel="shorturl" href="https://www.php.net/eio-symlink">
 <link rel="alternate" href="https://www.php.net/eio-symlink" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-statvfs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-sync.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-symlink.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-symlink.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-symlink.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-symlink.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-symlink.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-symlink.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-symlink.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-symlink.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-symlink.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-symlink.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-symlink.php" hreflang="zh">
...
<meta name="Description" content="Create a symbolic link" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_symlink - Manual" />
<meta name="twitter:description" content="Create a symbolic link" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_symlink - Manual" />
<meta itemprop="description" content="Create a symbolic link" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a symbolic link" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-sync.php">
          eio_sync &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-statvfs.php">
          &laquo; eio_statvfs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-symlink.php' selected="selected">English</option>
            <option value='de/function.eio-symlink.php'>German</option>
            <option value='es/function.eio-symlink.php'>Spanish</option>
            <option value='fr/function.eio-symlink.php'>French</option>
            <option value='it/function.eio-symlink.php'>Italian</option>
            <option value='ja/function.eio-symlink.php'>Japanese</option>
            <option value='pt_BR/function.eio-symlink.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-symlink.php'>Russian</option>
            <option value='tr/function.eio-symlink.php'>Turkish</option>
            <option value='uk/function.eio-symlink.php'>Ukrainian</option>
            <option value='zh/function.eio-symlink.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-symlink" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_symlink</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_symlink</span> &mdash; <span class="dc-title">Create a symbolic link</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-symlink-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_symlink</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_symlink()</strong></span> creates a symbolic link
  <code class="parameter">new_path</code> to <code class="parameter">path</code>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-symlink-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">new_path</code></dt>
    <dd>
     <p class="para">
     Target path
     </p>
...
string(16) &quot;/tmp/symlink.dat&quot;</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.eio-symlink-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-link.php" class="function" rel="rdfs-seeAlso">eio_link()</a> - Create a hardlink for file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-symlink.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-symlink%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-symlink&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-symlink.php">＋<small>add a note</small></a></span>
