...
<head>
  ...
  <title>PHP: Imagick::commentImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.commentimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.commentimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.commentimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.combineimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.compareimagechannels.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.commentimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.commentimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.commentimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.commentimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.commentimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.commentimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.commentimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.commentimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.commentimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.commentimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.commentimage.php" hreflang="zh">
...
<meta name="Description" content="Adds a comment to your image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::commentImage - Manual" />
<meta name="twitter:description" content="Adds a comment to your image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::commentImage - Manual" />
<meta itemprop="description" content="Adds a comment to your image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a comment to your image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.compareimagechannels.php">
          Imagick::compareImageChannels &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.combineimages.php">
          &laquo; Imagick::combineImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.commentimage.php' selected="selected">English</option>
            <option value='de/imagick.commentimage.php'>German</option>
            <option value='es/imagick.commentimage.php'>Spanish</option>
            <option value='fr/imagick.commentimage.php'>French</option>
            <option value='it/imagick.commentimage.php'>Italian</option>
            <option value='ja/imagick.commentimage.php'>Japanese</option>
            <option value='pt_BR/imagick.commentimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.commentimage.php'>Russian</option>
            <option value='tr/imagick.commentimage.php'>Turkish</option>
            <option value='uk/imagick.commentimage.php'>Ukrainian</option>
            <option value='zh/imagick.commentimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.commentimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::commentImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::commentImage</span> &mdash; <span class="dc-title">Adds a comment to your image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.commentimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::commentImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$comment</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.commentimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.commentimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.commentimage-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.commentimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2982">
    <p><strong>Example #1 Using <span class="function"><strong>Imagick::commentImage()</strong></span>:</strong></p>
    <div class="example-contents"><p>
     Commenting an image and retrieving the comment:
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Create new Imagick object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* Create an empty image */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, new </span><span style="color: #0000BB">ImagickPixel</span><span style="color: #007700">(</span><span style="color: #DD0000">"red"</span><span style="color: #007700">));<br /><br /></span><span style="color: #FF8000">/* Add comment to the image */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">commentImage</span><span style="color: #007700">(</span><span style="color: #DD0000">"Hello World!"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Display the comment */<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getImageProperty</span><span style="color: #007700">(</span><span style="color: #DD0000">"comment"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/commentimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.commentimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.commentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.commentimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125318">  <div class="votes">
    <div id="Vu125318">
    <a href="/manual/vote-note.php?id=125318&amp;page=imagick.commentimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125318">
    <a href="/manual/vote-note.php?id=125318&amp;page=imagick.commentimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125318" title="100% like this...">
    2
    </div>
  </div>
  <a href="#125318" class="name">
  <strong class="user"><em>nick_khor at hotmail dot com</em></strong></a><a class="genanchor" href="#125318"> &para;</a><div class="date" title="2020-09-02 02:55"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125318">
<div class="phpcode"><code><span class="html">This function only support JPEG file.<br /><br /><a href="https://github.com/Imagick/imagick/issues/124#issuecomment-226942140" rel="nofollow" target="_blank">https://github.com/Imagick/imagick/issues/124#issuecomment-226942140</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.commentimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.commentimage.php">＋<small>add a note</small></a></div>
