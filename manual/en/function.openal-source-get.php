...
<head>
  ...
  <title>PHP: openal_source_get - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openal-source-get.php">
 <link rel="shorturl" href="https://www.php.net/openal-source-get">
 <link rel="alternate" href="https://www.php.net/openal-source-get" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openal.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openal-source-destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openal-source-pause.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openal-source-get.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openal-source-get.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openal-source-get.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openal-source-get.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openal-source-get.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openal-source-get.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openal-source-get.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openal-source-get.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openal-source-get.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openal-source-get.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openal-source-get.php" hreflang="zh">
...
<meta name="Description" content="Retrieve an OpenAL source property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openal_source_get - Manual" />
<meta name="twitter:description" content="Retrieve an OpenAL source property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openal_source_get - Manual" />
<meta itemprop="description" content="Retrieve an OpenAL source property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieve an OpenAL source property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openal-source-pause.php">
          openal_source_pause &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openal-source-destroy.php">
          &laquo; openal_source_destroy        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openal-source-get.php' selected="selected">English</option>
            <option value='de/function.openal-source-get.php'>German</option>
            <option value='es/function.openal-source-get.php'>Spanish</option>
            <option value='fr/function.openal-source-get.php'>French</option>
            <option value='it/function.openal-source-get.php'>Italian</option>
            <option value='ja/function.openal-source-get.php'>Japanese</option>
            <option value='pt_BR/function.openal-source-get.php'>Brazilian Portuguese</option>
            <option value='ru/function.openal-source-get.php'>Russian</option>
            <option value='tr/function.openal-source-get.php'>Turkish</option>
            <option value='uk/function.openal-source-get.php'>Ukrainian</option>
            <option value='zh/function.openal-source-get.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openal-source-get" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openal_source_get</h1>
  <p class="verinfo">(PECL openal &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">openal_source_get</span> &mdash; <span class="dc-title">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openal-source-play.php" class="function" rel="rdfs-seeAlso">openal_source_play()</a> - Start playing the source</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openal/functions/openal-source-get.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openal-source-get%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openal-source-get&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openal-source-get.php">＋<small>add a note</small></a></span>
