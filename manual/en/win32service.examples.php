...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/win32service.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/win32service.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/win32service.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.win32service.php">
 <link rel="prev" href="https://www.php.net/manual/en/win32service-rightinfo.is-grant-access.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.win32service.php">

 <link rel="alternate" href="https://www.php.net/manual/en/win32service.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/win32service.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/win32service.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/win32service.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/win32service.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/win32service.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/win32service.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/win32service.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/win32service.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/win32service.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/win32service.examples.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ref.win32service.php">
          win32service Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="win32service-rightinfo.is-grant-access.php">
          &laquo; Win32Service\RightInfo::isGrantAccess        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/win32service.examples.php' selected="selected">English</option>
            <option value='de/win32service.examples.php'>German</option>
            <option value='es/win32service.examples.php'>Spanish</option>
            <option value='fr/win32service.examples.php'>French</option>
            <option value='it/win32service.examples.php'>Italian</option>
            <option value='ja/win32service.examples.php'>Japanese</option>
            <option value='pt_BR/win32service.examples.php'>Brazilian Portuguese</option>
            <option value='ru/win32service.examples.php'>Russian</option>
            <option value='tr/win32service.examples.php'>Turkish</option>
            <option value='uk/win32service.examples.php'>Ukrainian</option>
            <option value='zh/win32service.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="win32service.examples" class="chapter">
 <h1 class="title">Examples</h1>

 <p class="para">
  <div class="example" id="example-5747">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />win32_create_service</span><span style="color: #007700">(array(<br />    </span><span style="color: #DD0000">'service'     </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'dummyphp'</span><span style="color: #007700">,                                           </span><span style="color: #FF8000"># the name of your service<br />    </span><span style="color: #DD0000">'display'     </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'sample dummy PHP service'</span><span style="color: #007700">,                           </span><span style="color: #FF8000"># short description<br />    </span><span style="color: #DD0000">'description' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'This is a dummy Windows service created using PHP.'</span><span style="color: #007700">, </span><span style="color: #FF8000"># long description<br />    </span><span style="color: #DD0000">'params'      </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'"' </span><span style="color: #007700">. </span><span style="color: #0000BB">__FILE__ </span><span style="color: #007700">. </span><span style="color: #DD0000">'"  run'</span><span style="color: #007700">,                            </span><span style="color: #FF8000"># path to the script and parameters<br /></span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <p class="para">
  <div class="example" id="example-5748">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">$argv</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">] == </span><span style="color: #DD0000">'run'</span><span style="color: #007700">) {<br />  </span><span style="color: #0000BB">win32_start_service_ctrl_dispatcher</span><span style="color: #007700">(</span><span style="color: #DD0000">'dummyphp'</span><span style="color: #007700">);<br /><br />  while (</span><span style="color: #0000BB">WIN32_SERVICE_CONTROL_STOP </span><span style="color: #007700">!= </span><span style="color: #0000BB">win32_get_last_control_message</span><span style="color: #007700">()) {<br />    </span><span style="color: #FF8000"># do your work here.<br />    # try not to take up more than 30 seconds before going around the loop<br />    # again<br />  </span><span style="color: #007700">}<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/win32service/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fwin32service.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=win32service.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/win32service.examples.php">＋<small>add a note</small></a></span>
