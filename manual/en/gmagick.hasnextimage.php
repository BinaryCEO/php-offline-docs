...
<head>
  ...
  <title>PHP: Gmagick::hasnextimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.hasnextimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.hasnextimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.hasnextimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getversion.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.haspreviousimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.hasnextimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.hasnextimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.hasnextimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.hasnextimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.hasnextimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.hasnextimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.hasnextimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.hasnextimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.hasnextimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.hasnextimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.hasnextimage.php" hreflang="zh">
...
<meta name="Description" content="Checks if the object has more images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::hasnextimage - Manual" />
<meta name="twitter:description" content="Checks if the object has more images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::hasnextimage - Manual" />
<meta itemprop="description" content="Checks if the object has more images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the object has more images" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.haspreviousimage.php">
          Gmagick::haspreviousimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getversion.php">
          &laquo; Gmagick::getversion        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.hasnextimage.php' selected="selected">English</option>
            <option value='de/gmagick.hasnextimage.php'>German</option>
            <option value='es/gmagick.hasnextimage.php'>Spanish</option>
            <option value='fr/gmagick.hasnextimage.php'>French</option>
            <option value='it/gmagick.hasnextimage.php'>Italian</option>
            <option value='ja/gmagick.hasnextimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.hasnextimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.hasnextimage.php'>Russian</option>
            <option value='tr/gmagick.hasnextimage.php'>Turkish</option>
            <option value='uk/gmagick.hasnextimage.php'>Ukrainian</option>
            <option value='zh/gmagick.hasnextimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.hasnextimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::hasnextimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::hasnextimage</span> &mdash; <span class="dc-title">Checks if the object has more images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.hasnextimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::hasnextimage</strong></span>(): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.hasnextimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.hasnextimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the object has more images when traversing the list in the forward direction, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if there are none. 
  </p>
 </div>

 <div class="refsect1 errors" id="refsect1-gmagick.hasnextimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/hasnextimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.hasnextimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.hasnextimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.hasnextimage.php">＋<small>add a note</small></a></span>
