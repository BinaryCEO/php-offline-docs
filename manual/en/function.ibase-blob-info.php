...
<head>
  ...
  <title>PHP: ibase_blob_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-info.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-info">
 <link rel="alternate" href="https://www.php.net/ibase-blob-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-import.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-open.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-info.php" hreflang="zh">
...
<meta name="Description" content="Return blob length and other useful info" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_info - Manual" />
<meta name="twitter:description" content="Return blob length and other useful info" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_info - Manual" />
<meta itemprop="description" content="Return blob length and other useful info" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return blob length and other useful info" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-blob-open.php">
          ibase_blob_open &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-import.php">
          &laquo; ibase_blob_import        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-info.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-info.php'>German</option>
            <option value='es/function.ibase-blob-info.php'>Spanish</option>
            <option value='fr/function.ibase-blob-info.php'>French</option>
            <option value='it/function.ibase-blob-info.php'>Italian</option>
            <option value='ja/function.ibase-blob-info.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-info.php'>Russian</option>
            <option value='tr/function.ibase-blob-info.php'>Turkish</option>
            <option value='uk/function.ibase-blob-info.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-info" class="refentry">
  ...
  <p class="para">
   ...
   of the largest segment, and whether it is a stream BLOB or a segmented BLOB.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-info.php">＋<small>add a note</small></a></span>
