...
<head>
  ...
  <title>PHP: SolrQuery::addMltQueryField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addmltfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addsortfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addmltqueryfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addmltqueryfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addmltqueryfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addmltqueryfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addmltqueryfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addmltqueryfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addmltqueryfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addmltqueryfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addmltqueryfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addmltqueryfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addmltqueryfield.php" hreflang="zh">
...
<meta name="Description" content="Maps to mlt.qf" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addMltQueryField - Manual" />
<meta name="twitter:description" content="Maps to mlt.qf" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addMltQueryField - Manual" />
<meta itemprop="description" content="Maps to mlt.qf" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to mlt.qf" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.addsortfield.php">
          SolrQuery::addSortField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addmltfield.php">
          &laquo; SolrQuery::addMltField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addmltqueryfield.php' selected="selected">English</option>
            <option value='de/solrquery.addmltqueryfield.php'>German</option>
            <option value='es/solrquery.addmltqueryfield.php'>Spanish</option>
            <option value='fr/solrquery.addmltqueryfield.php'>French</option>
            <option value='it/solrquery.addmltqueryfield.php'>Italian</option>
            <option value='ja/solrquery.addmltqueryfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addmltqueryfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addmltqueryfield.php'>Russian</option>
            <option value='tr/solrquery.addmltqueryfield.php'>Turkish</option>
            <option value='uk/solrquery.addmltqueryfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addmltqueryfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addmltqueryfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addMltQueryField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addMltQueryField</span> &mdash; <span class="dc-title">Maps to mlt.qf</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addmltqueryfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addMltQueryField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$boost</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addmltqueryfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addmltqueryfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addmltqueryfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addmltqueryfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addmltqueryfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addmltqueryfield.php">＋<small>add a note</small></a></span>
