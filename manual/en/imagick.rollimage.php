...
<head>
  ...
  <title>PHP: Imagick::rollImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.rollimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.rollimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rollimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.resizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.rotateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.rollimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.rollimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.rollimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.rollimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.rollimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.rollimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.rollimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.rollimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.rollimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.rollimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.rollimage.php" hreflang="zh">
...
<meta name="Description" content="Offsets an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::rollImage - Manual" />
<meta name="twitter:description" content="Offsets an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::rollImage - Manual" />
<meta itemprop="description" content="Offsets an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Offsets an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.rotateimage.php">
          Imagick::rotateImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.resizeimage.php">
          &laquo; Imagick::resizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.rollimage.php' selected="selected">English</option>
            <option value='de/imagick.rollimage.php'>German</option>
            <option value='es/imagick.rollimage.php'>Spanish</option>
            <option value='fr/imagick.rollimage.php'>French</option>
            <option value='it/imagick.rollimage.php'>Italian</option>
            <option value='ja/imagick.rollimage.php'>Japanese</option>
            <option value='pt_BR/imagick.rollimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.rollimage.php'>Russian</option>
            <option value='tr/imagick.rollimage.php'>Turkish</option>
            <option value='uk/imagick.rollimage.php'>Ukrainian</option>
            <option value='zh/imagick.rollimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.rollimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::rollImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::rollImage</span> &mdash; <span class="dc-title">Offsets an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.rollimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::rollImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.rollimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.rollimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3080">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/rollimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.rollimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.rollimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.rollimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124853">  <div class="votes">
    <div id="Vu124853">
    <a href="/manual/vote-note.php?id=124853&amp;page=imagick.rollimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124853">
    <a href="/manual/vote-note.php?id=124853&amp;page=imagick.rollimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124853" title="100% like this...">
    2
    </div>
  </div>
  <a href="#124853" class="name">
  <strong class="user"><em>simonjjarrett at gmail dot com</em></strong></a><a class="genanchor" href="#124853"> &para;</a><div class="date" title="2020-03-24 02:12"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124853">
<div class="phpcode"><code><span class="html">This function will make the image wrap around from bottom to top or side to side, hence "roll". If you want to just offset an image without the wrap-around, use Imagick::extentImage instead.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.rollimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.rollimage.php">＋<small>add a note</small></a></div>
