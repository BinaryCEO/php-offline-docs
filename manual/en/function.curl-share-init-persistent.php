...
<head>
  ...
  <title>PHP: curl_share_init_persistent - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-share-init-persistent.php">
 <link rel="shorturl" href="https://www.php.net/curl-share-init-persistent">
 <link rel="alternate" href="https://www.php.net/curl-share-init-persistent" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-share-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-share-setopt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-share-init-persistent.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-share-init-persistent.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-share-init-persistent.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-share-init-persistent.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-share-init-persistent.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-share-init-persistent.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-share-init-persistent.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-share-init-persistent.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-share-init-persistent.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-share-init-persistent.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-share-init-persistent.php" hreflang="zh">
...
<meta name="Description" content="Initialize a persistent cURL share handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_share_init_persistent - Manual" />
<meta name="twitter:description" content="Initialize a persistent cURL share handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_share_init_persistent - Manual" />
<meta itemprop="description" content="Initialize a persistent cURL share handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize a persistent cURL share handle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.curl-share-setopt.php">
          curl_share_setopt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.curl-share-init.php">
          &laquo; curl_share_init        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-share-init-persistent.php' selected="selected">English</option>
            <option value='de/function.curl-share-init-persistent.php'>German</option>
            <option value='es/function.curl-share-init-persistent.php'>Spanish</option>
            <option value='fr/function.curl-share-init-persistent.php'>French</option>
            <option value='it/function.curl-share-init-persistent.php'>Italian</option>
            <option value='ja/function.curl-share-init-persistent.php'>Japanese</option>
            <option value='pt_BR/function.curl-share-init-persistent.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-share-init-persistent.php'>Russian</option>
            <option value='tr/function.curl-share-init-persistent.php'>Turkish</option>
            <option value='uk/function.curl-share-init-persistent.php'>Ukrainian</option>
            <option value='zh/function.curl-share-init-persistent.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-share-init-persistent" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.curl-share-init.php" class="function" rel="rdfs-seeAlso">curl_share_init()</a> - Initialize a cURL share handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-share-init-persistent.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-share-init-persistent%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-share-init-persistent&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-share-init-persistent.php">＋<small>add a note</small></a></span>
