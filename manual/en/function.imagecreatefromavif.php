...
<head>
  ...
  <title>PHP: imagecreatefromavif - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecreatefromavif.php">
 <link rel="shorturl" href="https://www.php.net/imagecreatefromavif">
 <link rel="alternate" href="https://www.php.net/imagecreatefromavif" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecreate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecreatefrombmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecreatefromavif.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecreatefromavif.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecreatefromavif.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecreatefromavif.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecreatefromavif.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecreatefromavif.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecreatefromavif.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecreatefromavif.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecreatefromavif.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecreatefromavif.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecreatefromavif.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecreatefromavif - Manual" />
<meta name="twitter:description" content="Create a new image from file or URL" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecreatefromavif - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecreatefromavif.php' selected="selected">English</option>
            <option value='de/function.imagecreatefromavif.php'>German</option>
            <option value='es/function.imagecreatefromavif.php'>Spanish</option>
            <option value='fr/function.imagecreatefromavif.php'>French</option>
            <option value='it/function.imagecreatefromavif.php'>Italian</option>
            <option value='ja/function.imagecreatefromavif.php'>Japanese</option>
            <option value='pt_BR/function.imagecreatefromavif.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecreatefromavif.php'>Russian</option>
            <option value='tr/function.imagecreatefromavif.php'>Turkish</option>
            <option value='uk/function.imagecreatefromavif.php'>Ukrainian</option>
            <option value='zh/function.imagecreatefromavif.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecreatefromavif" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagecreatefromavif</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.1.0)</p><p class="refpurpose"><span class="refname">imagecreatefromavif</span> &mdash; <span class="dc-title">Create a new image from file or URL</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.imagecreatefromavif-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagecreatefromavif</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$filename</code></span>): <span class="type"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagecreatefromavif()</strong></span> returns an image object
   representing the image obtained from the given filename.
  </p>
 </div>

 
 <div class="refsect1 parameters" id="refsect1-function.imagecreatefromavif-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
        Path to the <abbr>AVIF</abbr> raster image.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imagecreatefromavif-returnvalues">
  ...
  <p class="para">
   Returns an image object on success, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on errors.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecreatefromavif.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecreatefromavif%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecreatefromavif&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecreatefromavif.php">＋<small>add a note</small></a></span>
