...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setfacetmincount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setfacetmincount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setfacetmincount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setfacetmethod.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setfacetmissing.php">
...
<meta name="Description" content="Maps to facet.mincount" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setFacetMinCount - Manual" />
<meta name="twitter:description" content="Maps to facet.mincount" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setFacetMinCount - Manual" />
<meta itemprop="description" content="Maps to facet.mincount" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to facet.mincount" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setfacetmincount.php' selected="selected">English</option>
            ...
            <option value='pt_BR/solrquery.setfacetmincount.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setFacetMinCount</span> &mdash; <span class="dc-title">Maps to facet.mincount</span></p>
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setfacetmincount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setfacetmincount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setfacetmincount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setfacetmincount.php">＋<small>add a note</small></a></span>
