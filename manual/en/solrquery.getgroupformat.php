...
<head>
  ...
  <title>PHP: SolrQuery::getGroupFormat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupformat.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupformat.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupformat.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupformat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupformat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupformat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupformat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupformat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupformat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupformat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupformat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupformat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupformat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupformat.php" hreflang="zh">
...
<meta name="Description" content="Returns the group.format value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupFormat - Manual" />
<meta name="twitter:description" content="Returns the group.format value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupFormat - Manual" />
<meta itemprop="description" content="Returns the group.format value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.format value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getgroupfunctions.php">
          SolrQuery::getGroupFunctions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupfields.php">
          &laquo; SolrQuery::getGroupFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupformat.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupformat.php'>German</option>
            <option value='es/solrquery.getgroupformat.php'>Spanish</option>
            <option value='fr/solrquery.getgroupformat.php'>French</option>
            <option value='it/solrquery.getgroupformat.php'>Italian</option>
            <option value='ja/solrquery.getgroupformat.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupformat.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupformat.php'>Russian</option>
            <option value='tr/solrquery.getgroupformat.php'>Turkish</option>
            <option value='uk/solrquery.getgroupformat.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupformat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupformat" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupFormat</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupFormat</span> &mdash; <span class="dc-title">Returns the group.format value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupformat-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupFormat</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupformat-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupformat-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupformat-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroupformat.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupFormat()</a> - Sets the group format, result structure (group.format parameter)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupformat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupformat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupformat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupformat.php">＋<small>add a note</small></a></span>
