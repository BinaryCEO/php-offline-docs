...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-rowresult.getwarningscount.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-rowresult.getwarningscount.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-rowresult.getwarningscount.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-rowresult.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-rowresult.getwarnings.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mysql-xdevapi-schema.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-rowresult.getwarningscount.php' selected="selected">English</option>
            ...
            <option value='zh/mysql-xdevapi-rowresult.getwarningscount.php'>Chinese (Simplified)</option>
...
<div class="examplescode"><pre class="examplescode">2</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/rowresult/getwarningscount.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-rowresult.getwarningscount%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-rowresult.getwarningscount&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-rowresult.getwarningscount.php">＋<small>add a note</small></a></span>
