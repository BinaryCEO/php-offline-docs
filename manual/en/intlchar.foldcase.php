...
<head>
  ...
  <title>PHP: IntlChar::foldCase - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.foldcase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.foldcase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.foldcase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.enumchartypes.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.fordigit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.foldcase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.foldcase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.foldcase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.foldcase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.foldcase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.foldcase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.foldcase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.foldcase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.foldcase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.foldcase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.foldcase.php" hreflang="zh">
...
<meta name="Description" content="Perform case folding on a code point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::foldCase - Manual" />
<meta name="twitter:description" content="Perform case folding on a code point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::foldCase - Manual" />
<meta itemprop="description" content="Perform case folding on a code point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Perform case folding on a code point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.fordigit.php">
          IntlChar::forDigit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.enumchartypes.php">
          &laquo; IntlChar::enumCharTypes        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.foldcase.php' selected="selected">English</option>
            <option value='de/intlchar.foldcase.php'>German</option>
            <option value='es/intlchar.foldcase.php'>Spanish</option>
            <option value='fr/intlchar.foldcase.php'>French</option>
            <option value='it/intlchar.foldcase.php'>Italian</option>
            <option value='ja/intlchar.foldcase.php'>Japanese</option>
            <option value='pt_BR/intlchar.foldcase.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.foldcase.php'>Russian</option>
            <option value='tr/intlchar.foldcase.php'>Turkish</option>
            <option value='uk/intlchar.foldcase.php'>Ukrainian</option>
            <option value='zh/intlchar.foldcase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.foldcase" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::foldCase</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::foldCase</span> &mdash; <span class="dc-title">Perform case folding on a code point</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.foldcase-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::foldCase</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = IntlChar::FOLD_CASE_DEFAULT</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.foldcase-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Either <strong><code><a href="class.intlchar.php#intlchar.constants.fold-case-default">IntlChar::FOLD_CASE_DEFAULT</a></code></strong> (default)
      or <strong><code><a href="class.intlchar.php#intlchar.constants.fold-case-exclude-special-i">IntlChar::FOLD_CASE_EXCLUDE_SPECIAL_I</a></code></strong>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.foldcase-returnvalues">
  ...
  <p class="para">
   Returns the <em>Simple_Case_Folding</em> of the code point, if any; otherwise the code point itself on success,
   or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/foldcase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.foldcase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.foldcase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.foldcase.php">＋<small>add a note</small></a></span>
