...
<head>
  ...
  <title>PHP: ReflectionClass::hasConstant - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.hasconstant.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.hasconstant.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.hasconstant.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.gettraits.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.hasmethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.hasconstant.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.hasconstant.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.hasconstant.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.hasconstant.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.hasconstant.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.hasconstant.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.hasconstant.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.hasconstant.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.hasconstant.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.hasconstant.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.hasconstant.php" hreflang="zh">
...
<meta name="Description" content="Checks if constant is defined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::hasConstant - Manual" />
<meta name="twitter:description" content="Checks if constant is defined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::hasConstant - Manual" />
<meta itemprop="description" content="Checks if constant is defined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if constant is defined" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.hasmethod.php">
          ReflectionClass::hasMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.gettraits.php">
          &laquo; ReflectionClass::getTraits        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.hasconstant.php' selected="selected">English</option>
            <option value='de/reflectionclass.hasconstant.php'>German</option>
            <option value='es/reflectionclass.hasconstant.php'>Spanish</option>
            <option value='fr/reflectionclass.hasconstant.php'>French</option>
            <option value='it/reflectionclass.hasconstant.php'>Italian</option>
            <option value='ja/reflectionclass.hasconstant.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.hasconstant.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.hasconstant.php'>Russian</option>
            <option value='tr/reflectionclass.hasconstant.php'>Turkish</option>
            <option value='uk/reflectionclass.hasconstant.php'>Ukrainian</option>
            <option value='zh/reflectionclass.hasconstant.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.hasconstant" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::hasConstant</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::hasConstant</span> &mdash; <span class="dc-title">Checks if constant is defined</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.hasconstant-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the constant is defined, otherwise <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.hasconstant-examples">
  ...
  <p class="para">
   <div class="example" id="example-5491">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::hasConstant()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.hasproperty.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::hasProperty()</a> - Checks if property is defined</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/hasconstant.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.hasconstant%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.hasconstant&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.hasconstant.php">＋<small>add a note</small></a></span>
