...
<head>
  ...
  <title>PHP: RequestParseBodyException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.requestparsebodyexception.php">
 <link rel="shorturl" href="https://www.php.net/requestparsebodyexception">
 <link rel="alternate" href="https://www.php.net/requestparsebodyexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/fibererror.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/reserved.interfaces.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.requestparsebodyexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.requestparsebodyexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.requestparsebodyexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.requestparsebodyexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.requestparsebodyexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.requestparsebodyexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.requestparsebodyexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.requestparsebodyexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.requestparsebodyexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.requestparsebodyexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.requestparsebodyexception.php" hreflang="zh">
...
<meta name="Description" content="RequestParseBodyException" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: RequestParseBodyException - Manual" />
<meta name="twitter:description" content="RequestParseBodyException" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: RequestParseBodyException - Manual" />
<meta itemprop="description" content="RequestParseBodyException" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="RequestParseBodyException" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reserved.interfaces.php">
          Predefined Interfaces and Classes &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="fibererror.construct.php">
          &laquo; FiberError::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.requestparsebodyexception.php' selected="selected">English</option>
            <option value='de/class.requestparsebodyexception.php'>German</option>
            <option value='es/class.requestparsebodyexception.php'>Spanish</option>
            <option value='fr/class.requestparsebodyexception.php'>French</option>
            <option value='it/class.requestparsebodyexception.php'>Italian</option>
            <option value='ja/class.requestparsebodyexception.php'>Japanese</option>
            <option value='pt_BR/class.requestparsebodyexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.requestparsebodyexception.php'>Russian</option>
            <option value='tr/class.requestparsebodyexception.php'>Turkish</option>
            <option value='uk/class.requestparsebodyexception.php'>Ukrainian</option>
            <option value='zh/class.requestparsebodyexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.requestparsebodyexception" class="reference">
 <h1 class="title">RequestParseBodyException</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>


  <div class="section" id="RequestParseBodyException.intro">
   <h2 class="title">Introduction</h2>
   <p class="simpara">
    A <span class="classname"><strong class="classname">RequestParseBodyException</strong></span> is thrown in
    <span class="function"><a href="function.request-parse-body.php" class="function">request_parse_body()</a></span> when the request body is invalid,
    according to the <code class="literal">Content-Type</code> header.
   </p>
  </div>


  <div class="section" id="RequestParseBodyException.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">RequestParseBodyException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/requestparsebodyexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.requestparsebodyexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.requestparsebodyexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.requestparsebodyexception.php">＋<small>add a note</small></a></span>
