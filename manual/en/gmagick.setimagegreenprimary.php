...
<head>
  ...
  <title>PHP: Gmagick::setimagegreenprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagegamma.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagegreenprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagegreenprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagegreenprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagegreenprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagegreenprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagegreenprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagegreenprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagegreenprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagegreenprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagegreenprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagegreenprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagegreenprimary - Manual" />
<meta name="twitter:description" content="Sets the image chromaticity green primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagegreenprimary - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimageindex.php">
          Gmagick::setimageindex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagegamma.php">
          &laquo; Gmagick::setimagegamma        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagegreenprimary.php' selected="selected">English</option>
            <option value='de/gmagick.setimagegreenprimary.php'>German</option>
            <option value='es/gmagick.setimagegreenprimary.php'>Spanish</option>
            <option value='fr/gmagick.setimagegreenprimary.php'>French</option>
            <option value='it/gmagick.setimagegreenprimary.php'>Italian</option>
            <option value='ja/gmagick.setimagegreenprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagegreenprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagegreenprimary.php'>Russian</option>
            <option value='tr/gmagick.setimagegreenprimary.php'>Turkish</option>
            <option value='uk/gmagick.setimagegreenprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagegreenprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagegreenprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagegreenprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagegreenprimary</span> &mdash; <span class="dc-title">Sets the image chromaticity green primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagegreenprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagegreenprimary</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagegreenprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagegreenprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagegreenprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagegreenprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagegreenprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagegreenprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagegreenprimary.php">＋<small>add a note</small></a></span>
