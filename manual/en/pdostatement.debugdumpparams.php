...
<head>
  ...
  <title>PHP: PDOStatement::debugDumpParams - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php">
 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.pdostatement.php">
 <link rel="prev" href="https://www.php.net/manual/en/pdostatement.columncount.php">
 <link rel="next" href="https://www.php.net/manual/en/pdostatement.errorcode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/pdostatement.debugdumpparams.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/pdostatement.debugdumpparams.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/pdostatement.debugdumpparams.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/pdostatement.debugdumpparams.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/pdostatement.debugdumpparams.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/pdostatement.debugdumpparams.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/pdostatement.debugdumpparams.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/pdostatement.debugdumpparams.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/pdostatement.debugdumpparams.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/pdostatement.debugdumpparams.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/pdostatement.debugdumpparams.php" hreflang="zh">
...
<meta name="Description" content="Dump an SQL prepared command" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: PDOStatement::debugDumpParams - Manual" />
<meta name="twitter:description" content="Dump an SQL prepared command" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: PDOStatement::debugDumpParams - Manual" />
<meta itemprop="description" content="Dump an SQL prepared command" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Dump an SQL prepared command" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="pdostatement.errorcode.php">
          PDOStatement::errorCode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="pdostatement.columncount.php">
          &laquo; PDOStatement::columnCount        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/pdostatement.debugdumpparams.php' selected="selected">English</option>
            <option value='de/pdostatement.debugdumpparams.php'>German</option>
            <option value='es/pdostatement.debugdumpparams.php'>Spanish</option>
            <option value='fr/pdostatement.debugdumpparams.php'>French</option>
            <option value='it/pdostatement.debugdumpparams.php'>Italian</option>
            <option value='ja/pdostatement.debugdumpparams.php'>Japanese</option>
            <option value='pt_BR/pdostatement.debugdumpparams.php'>Brazilian Portuguese</option>
            <option value='ru/pdostatement.debugdumpparams.php'>Russian</option>
            <option value='tr/pdostatement.debugdumpparams.php'>Turkish</option>
            <option value='uk/pdostatement.debugdumpparams.php'>Ukrainian</option>
            <option value='zh/pdostatement.debugdumpparams.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="pdostatement.debugdumpparams" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="pdostatement.bindvalue.php" class="methodname" rel="rdfs-seeAlso">PDOStatement::bindValue()</a> - Binds a value to a parameter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo/pdostatement/debugdumpparams.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fpdostatement.debugdumpparams%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=pdostatement.debugdumpparams&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.debugdumpparams.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111944">  <div class="votes">
    <div id="Vu111944">
    <a href="/manual/vote-note.php?id=111944&amp;page=pdostatement.debugdumpparams&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111944">
    <a href="/manual/vote-note.php?id=111944&amp;page=pdostatement.debugdumpparams&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111944" title="90% like this...">
    71
    </div>
  </div>
  <a href="#111944" class="name">
  <strong class="user"><em>thefox</em></strong></a><a class="genanchor" href="#111944"> &para;</a><div class="date" title="2013-04-16 05:58"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111944">
<div class="phpcode"><code><span class="html">This function doesn't print parameter values despite the documentation says it does. See <a href="https://bugs.php.net/bug.php?id=52384" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=52384</a> (filed back in 2010).</span></code></div>
  </div>
 </div>
  <div class="note" id="113400">  <div class="votes">
    <div id="Vu113400">
    <a href="/manual/vote-note.php?id=113400&amp;page=pdostatement.debugdumpparams&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113400">
    <a href="/manual/vote-note.php?id=113400&amp;page=pdostatement.debugdumpparams&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113400" title="71% like this...">
    29
    </div>
  </div>
  <a href="#113400" class="name">
  <strong class="user"><em>mark at manngo dot net</em></strong></a><a class="genanchor" href="#113400"> &para;</a><div class="date" title="2013-10-07 01:21"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113400">
<div class="phpcode"><code><span class="html">As noted, this doesn’t actually simply print the prepared statement with data to be executed.<br /><br />For trouble shooting purposes, I find the following useful:<br /><br /><span class="default">&lt;?php<br />    </span><span class="keyword">function </span><span class="default">parms</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">$data</span><span class="keyword">) {<br />        </span><span class="default">$indexed</span><span class="keyword">=</span><span class="default">$data</span><span class="keyword">==</span><span class="default">array_values</span><span class="keyword">(</span><span class="default">$data</span><span class="keyword">);<br />        foreach(</span><span class="default">$data </span><span class="keyword">as </span><span class="default">$k</span><span class="keyword">=&gt;</span><span class="default">$v</span><span class="keyword">) {<br />            if(</span><span class="default">is_string</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">)) </span><span class="default">$v</span><span class="keyword">=</span><span class="string">"'</span><span class="default">$v</span><span class="string">'"</span><span class="keyword">;<br />            if(</span><span class="default">$indexed</span><span class="keyword">) </span><span class="default">$string</span><span class="keyword">=</span><span class="default">preg_replace</span><span class="keyword">(</span><span class="string">'/\?/'</span><span class="keyword">,</span><span class="default">$v</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">);<br />            else </span><span class="default">$string</span><span class="keyword">=</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">":</span><span class="default">$k</span><span class="string">"</span><span class="keyword">,</span><span class="default">$v</span><span class="keyword">,</span><span class="default">$string</span><span class="keyword">);<br />        }<br />        return </span><span class="default">$string</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">//    Index Parameters<br />        </span><span class="default">$string</span><span class="keyword">=</span><span class="string">'INSERT INTO stuff(name,value) VALUES (?,?)'</span><span class="keyword">;<br />        </span><span class="default">$data</span><span class="keyword">=array(</span><span class="string">'Fred'</span><span class="keyword">,</span><span class="default">23</span><span class="keyword">);<br /><br />    </span><span class="comment">//    Named Parameters<br />        </span><span class="default">$string</span><span class="keyword">=</span><span class="string">'INSERT INTO stuff(name,value) VALUES (:name,:value)'</span><span class="keyword">;<br />        </span><span class="default">$data</span><span class="keyword">=array(</span><span class="string">'name'</span><span class="keyword">=&gt;</span><span class="string">'Fred'</span><span class="keyword">,</span><span class="string">'value'</span><span class="keyword">=&gt;</span><span class="default">23</span><span class="keyword">);<br /><br />    print </span><span class="default">parms</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">,</span><span class="default">$data</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="118492">  <div class="votes">
    <div id="Vu118492">
    <a href="/manual/vote-note.php?id=118492&amp;page=pdostatement.debugdumpparams&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118492">
    <a href="/manual/vote-note.php?id=118492&amp;page=pdostatement.debugdumpparams&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118492" title="67% like this...">
    16
    </div>
  </div>
  <a href="#118492" class="name">
  <strong class="user"><em>Lucas</em></strong></a><a class="genanchor" href="#118492"> &para;</a><div class="date" title="2015-12-15 02:15"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118492">
<div class="phpcode"><code><span class="html">This function doesn't have a return, so if you want to do something with it you'll have to do something like<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">pdo_debugStrParams</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">) {<br />  </span><span class="default">ob_start</span><span class="keyword">();<br />  </span><span class="default">$stmt</span><span class="keyword">-&gt;</span><span class="default">debugDumpParams</span><span class="keyword">();<br />  </span><span class="default">$r </span><span class="keyword">= </span><span class="default">ob_get_contents</span><span class="keyword">();<br />  </span><span class="default">ob_end_clean</span><span class="keyword">();<br />  return </span><span class="default">$r</span><span class="keyword">;<br />}<br /><br /></span><span class="comment">// omitted: connect to the database and prepare a statement<br /></span><span class="keyword">echo </span><span class="string">'&lt;pre&gt;'</span><span class="keyword">.</span><span class="default">htmlspecialchars</span><span class="keyword">(</span><span class="default">pdo_debugStrParams</span><span class="keyword">(</span><span class="default">$stmt</span><span class="keyword">)).</span><span class="string">'&lt;/pre&gt;'</span><span class="keyword">;<br />?<br /><br /></span><span class="default">Source</span><span class="keyword">: </span><span class="default">http</span><span class="keyword">:</span><span class="comment">//stackoverflow.com/questions/22157331/something-like-debugdumpparams-in-pdo-settable-to-a-string</span></span></code></div>
  </div>
 </div>
  <div class="note" id="129901">  <div class="votes">
    <div id="Vu129901">
    <a href="/manual/vote-note.php?id=129901&amp;page=pdostatement.debugdumpparams&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129901">
    <a href="/manual/vote-note.php?id=129901&amp;page=pdostatement.debugdumpparams&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129901" title="100% like this...">
    1
    </div>
  </div>
  <a href="#129901" class="name">
  <strong class="user"><em>wchasroth at gmail dot com</em></strong></a><a class="genanchor" href="#129901"> &para;</a><div class="date" title="2024-12-06 07:41"><strong>9 months ago</strong></div>
  <div class="text" id="Hcom129901">
<div class="phpcode"><code><span class="html">Using PHP 8.3 and MySQL 8.2, debugDumpParams() DOES display the "raw" SQL, with parameter values.<br /><br />E.g. <br />$sql = "SELECT tid, miv_title, ballot_order FROM title WHERE tid LIKE :tid AND ballot_order = :order";<br />$stm = $pdo-&gt;prepare($sql);<br />$stm-&gt;bindValue(":tid",   "mi:%");<br />$stm-&gt;bindValue(":order", 5000, PDO::PARAM_INT);<br />$stm-&gt;execute();<br />$stm-&gt;debugDumpParams();<br /><br />... displays ...<br /><br />SQL: [92] SELECT tid, miv_title, ballot_order FROM title WHERE tid LIKE :tid AND ballot_order = :order<br />Sent SQL: [92] SELECT tid, miv_title, ballot_order FROM title WHERE tid LIKE 'mi:%' AND ballot_order = 5000<br />Params:  2<br />Key: Name: [4] :tid<br />paramno=-1<br />name=[4] ":tid"<br />is_param=1<br />param_type=2<br />Key: Name: [6] :order<br />paramno=-1<br />name=[6] ":order"<br />is_param=1<br />param_type=1</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=pdostatement.debugdumpparams&amp;repo=en&amp;redirect=https://www.php.net/manual/en/pdostatement.debugdumpparams.php">＋<small>add a note</small></a></div>
