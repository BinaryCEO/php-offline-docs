...
<head>
  ...
  <title>PHP: fann_save_train - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-save-train.php">
 <link rel="shorturl" href="https://www.php.net/fann-save-train">
 <link rel="alternate" href="https://www.php.net/fann-save-train" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-save.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-scale-input.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-save-train.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-save-train.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-save-train.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-save-train.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-save-train.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-save-train.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-save-train.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-save-train.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-save-train.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-save-train.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-save-train.php" hreflang="zh">
...
<meta name="Description" content="Save the training structure to a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_save_train - Manual" />
<meta name="twitter:description" content="Save the training structure to a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_save_train - Manual" />
<meta itemprop="description" content="Save the training structure to a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Save the training structure to a file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-save-train.php' selected="selected">English</option>
            <option value='de/function.fann-save-train.php'>German</option>
            <option value='es/function.fann-save-train.php'>Spanish</option>
            <option value='fr/function.fann-save-train.php'>French</option>
            <option value='it/function.fann-save-train.php'>Italian</option>
            <option value='ja/function.fann-save-train.php'>Japanese</option>
            <option value='pt_BR/function.fann-save-train.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-save-train.php'>Russian</option>
            <option value='tr/function.fann-save-train.php'>Turkish</option>
            <option value='uk/function.fann-save-train.php'>Ukrainian</option>
            <option value='zh/function.fann-save-train.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-save-train" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_save_train</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_save_train</span> &mdash; <span class="dc-title">Save the training structure to a file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-save-train-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_save_train</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$data</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$file_name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Save the training data to a file, with the format as specified in <span class="function"><a href="function.fann-read-train-from-file.php" class="function">fann_read_train_from_file()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-save-train-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-save-train-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-save-train-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-read-train-from-file.php" class="function" rel="rdfs-seeAlso">fann_read_train_from_file()</a> - Reads a file that stores training data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-save-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-save-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-save-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-save-train.php">＋<small>add a note</small></a></span>
