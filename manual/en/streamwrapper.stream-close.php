...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-close.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-close.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-close.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-cast.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-eof.php">
...
<meta name="Description" content="Close a resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: streamWrapper::stream_close - Manual" />
<meta name="twitter:description" content="Close a resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_close - Manual" />
<meta itemprop="description" content="Close a resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close a resource" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-close.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-close.php'>German</option>
            <option value='es/streamwrapper.stream-close.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.3.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">streamWrapper::stream_close</span> &mdash; <span class="dc-title">Close a resource</span></p>
 ...
 <div class="refsect1 description" id="refsect1-streamwrapper.stream-close-description">
  ...
  <p class="para rdfs-comment">
   This method is called in response to <span class="function"><a href="function.fclose.php" class="function">fclose()</a></span>.
  </p>
  <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="streamwrapper.dir-closedir.php" class="methodname" rel="rdfs-seeAlso">streamWrapper::dir_closedir()</a> - Close directory handle</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-close.php">＋<small>add a note</small></a></span>
