...
<head>
  ...
  <title>PHP: DateMalformedPeriodStringException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.datemalformedperiodstringexception.php">
 <link rel="shorturl" href="https://www.php.net/datemalformedperiodstringexception">
 <link rel="alternate" href="https://www.php.net/datemalformedperiodstringexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.datemalformedintervalstringexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.datemalformedstringexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.datemalformedperiodstringexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.datemalformedperiodstringexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.datemalformedperiodstringexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.datemalformedperiodstringexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.datemalformedperiodstringexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.datemalformedperiodstringexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.datemalformedperiodstringexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.datemalformedperiodstringexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.datemalformedperiodstringexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.datemalformedperiodstringexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.datemalformedperiodstringexception.php" hreflang="zh">
...
<meta name="Description" content="The DateMalformedPeriodStringException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateMalformedPeriodStringException - Manual" />
<meta name="twitter:description" content="The DateMalformedPeriodStringException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateMalformedPeriodStringException - Manual" />
<meta itemprop="description" content="The DateMalformedPeriodStringException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateMalformedPeriodStringException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.datemalformedstringexception.php">
          DateMalformedStringException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.datemalformedintervalstringexception.php">
          &laquo; DateMalformedIntervalStringException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.datemalformedperiodstringexception.php' selected="selected">English</option>
            <option value='de/class.datemalformedperiodstringexception.php'>German</option>
            <option value='es/class.datemalformedperiodstringexception.php'>Spanish</option>
            <option value='fr/class.datemalformedperiodstringexception.php'>French</option>
            <option value='it/class.datemalformedperiodstringexception.php'>Italian</option>
            <option value='ja/class.datemalformedperiodstringexception.php'>Japanese</option>
            <option value='pt_BR/class.datemalformedperiodstringexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.datemalformedperiodstringexception.php'>Russian</option>
            <option value='tr/class.datemalformedperiodstringexception.php'>Turkish</option>
            <option value='uk/class.datemalformedperiodstringexception.php'>Ukrainian</option>
            <option value='zh/class.datemalformedperiodstringexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.datemalformedperiodstringexception" class="reference">
 <h1 class="title">The DateMalformedPeriodStringException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="datemalformedperiodstringexception.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    Thrown when an invalid <code class="parameter">isostr</code> argument is passed to
    <span class="methodname"><a href="dateperiod.construct.php" class="methodname">DatePeriod::__construct()</a></span>.
   </p>
  </div>


  <div class="section" id="datemalformedperiodstringexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateMalformedPeriodStringException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datemalformedperiodstringexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.datemalformedperiodstringexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.datemalformedperiodstringexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.datemalformedperiodstringexception.php">＋<small>add a note</small></a></span>
