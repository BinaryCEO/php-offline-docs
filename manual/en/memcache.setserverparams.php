...
<head>
  ...
  <title>PHP: Memcache::setServerParams - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcache.setserverparams.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcache.setserverparams.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcache.setserverparams.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcache.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcache.setcompressthreshold.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.memcache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcache.setserverparams.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcache.setserverparams.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcache.setserverparams.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcache.setserverparams.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcache.setserverparams.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcache.setserverparams.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcache.setserverparams.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcache.setserverparams.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcache.setserverparams.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcache.setserverparams.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcache.setserverparams.php" hreflang="zh">
...
<meta name="Description" content="Changes server parameters and status at runtime" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcache::setServerParams - Manual" />
<meta name="twitter:description" content="Changes server parameters and status at runtime" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcache::setServerParams - Manual" />
<meta itemprop="description" content="Changes server parameters and status at runtime" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Changes server parameters and status at runtime" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ref.memcache.php">
          Memcache Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcache.setcompressthreshold.php">
          &laquo; Memcache::setCompressThreshold        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcache.setserverparams.php' selected="selected">English</option>
            <option value='de/memcache.setserverparams.php'>German</option>
            <option value='es/memcache.setserverparams.php'>Spanish</option>
            <option value='fr/memcache.setserverparams.php'>French</option>
            <option value='it/memcache.setserverparams.php'>Italian</option>
            <option value='ja/memcache.setserverparams.php'>Japanese</option>
            <option value='pt_BR/memcache.setserverparams.php'>Brazilian Portuguese</option>
            <option value='ru/memcache.setserverparams.php'>Russian</option>
            <option value='tr/memcache.setserverparams.php'>Turkish</option>
            <option value='uk/memcache.setserverparams.php'>Ukrainian</option>
            <option value='zh/memcache.setserverparams.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcache.setserverparams" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Memcache::setServerParams</h1>
  <h1 class="refname">memcache_set_server_params</h1>
  <p class="verinfo">(PECL memcache &gt;= 2.1.0)</p><p class="refpurpose"><span class="refname">Memcache::setServerParams</span> -- <span class="refname">memcache_set_server_params</span> &mdash; <span class="dc-title">Changes server parameters and status at runtime</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="memcache.getserverstatus.php" class="function" rel="rdfs-seeAlso">Memcache::getServerStatus()</a> - Returns server status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcache/memcache/setserverparams.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcache.setserverparams%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcache.setserverparams&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.setserverparams.php">＋<small>add a note</small></a></span>
