...
<head>
  ...
  <title>PHP: db2_statistics - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-statistics.php">
 <link rel="shorturl" href="https://www.php.net/db2-statistics">
 <link rel="alternate" href="https://www.php.net/db2-statistics" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-special-columns.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-stmt-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-statistics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-statistics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-statistics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-statistics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-statistics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-statistics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-statistics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-statistics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-statistics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-statistics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-statistics.php" hreflang="zh">
...
<meta name="Description" content="Returns a result set listing the index and statistics for a table" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_statistics - Manual" />
<meta name="twitter:description" content="Returns a result set listing the index and statistics for a table" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_statistics - Manual" />
<meta itemprop="description" content="Returns a result set listing the index and statistics for a table" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the index and statistics for a table" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.db2-stmt-error.php">
          db2_stmt_error &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-special-columns.php">
          &laquo; db2_special_columns        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-statistics.php' selected="selected">English</option>
            <option value='de/function.db2-statistics.php'>German</option>
            <option value='es/function.db2-statistics.php'>Spanish</option>
            <option value='fr/function.db2-statistics.php'>French</option>
            <option value='it/function.db2-statistics.php'>Italian</option>
            <option value='ja/function.db2-statistics.php'>Japanese</option>
            <option value='pt_BR/function.db2-statistics.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-statistics.php'>Russian</option>
            <option value='tr/function.db2-statistics.php'>Turkish</option>
            <option value='uk/function.db2-statistics.php'>Ukrainian</option>
            <option value='zh/function.db2-statistics.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-statistics" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-tables.php" class="function" rel="rdfs-seeAlso">db2_tables()</a> - Returns a result set listing the tables and associated metadata in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-statistics.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-statistics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-statistics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-statistics.php">＋<small>add a note</small></a></span>
