...
<head>
  ...
  <title>PHP: getmygid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getmygid.php">
 <link rel="shorturl" href="https://www.php.net/getmygid">
 <link rel="alternate" href="https://www.php.net/getmygid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.getlastmod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getmyinode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.getmygid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.getmygid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.getmygid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.getmygid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.getmygid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.getmygid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.getmygid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.getmygid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.getmygid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.getmygid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.getmygid.php" hreflang="zh">
...
<meta name="Description" content="Get PHP script owner's GID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getmygid - Manual" />
<meta name="twitter:description" content="Get PHP script owner's GID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getmygid - Manual" />
<meta itemprop="description" content="Get PHP script owner's GID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get PHP script owner's GID" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getmygid.php' selected="selected">English</option>
            <option value='de/function.getmygid.php'>German</option>
            <option value='es/function.getmygid.php'>Spanish</option>
            <option value='fr/function.getmygid.php'>French</option>
            <option value='it/function.getmygid.php'>Italian</option>
            <option value='ja/function.getmygid.php'>Japanese</option>
            <option value='pt_BR/function.getmygid.php'>Brazilian Portuguese</option>
            <option value='ru/function.getmygid.php'>Russian</option>
            <option value='tr/function.getmygid.php'>Turkish</option>
            <option value='uk/function.getmygid.php'>Ukrainian</option>
            <option value='zh/function.getmygid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.getmygid" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">getmygid</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">getmygid</span> &mdash; <span class="dc-title">Get PHP script owner&#039;s GID</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.getmygid-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>getmygid</strong></span>(): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.getmygid-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.getmygid-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the group ID of the current script, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.getmygid-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.getlastmod.php" class="function" rel="rdfs-seeAlso">getlastmod()</a> - Gets time of last page modification</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/getmygid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getmygid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getmygid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getmygid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124780">  <div class="votes">
    <div id="Vu124780">
    <a href="/manual/vote-note.php?id=124780&amp;page=function.getmygid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124780">
    <a href="/manual/vote-note.php?id=124780&amp;page=function.getmygid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124780" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124780" class="name">
  <strong class="user"><em>chris at ocproducts dot com</em></strong></a><a class="genanchor" href="#124780"> &para;</a><div class="date" title="2020-03-02 02:32"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124780">
<div class="phpcode"><code><span class="html">On Windows this will always return 0, except when "php -r" is used, when it returns 1.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getmygid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getmygid.php">＋<small>add a note</small></a></div>
