...
<head>
  ...
  <title>PHP: SolrQuery::removeFacetQuery - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removefacetquery.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removefacetquery.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetquery.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removefacetfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removefield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetquery.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removefacetquery.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removefacetquery.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removefacetquery.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removefacetquery.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removefacetquery.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removefacetquery.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removefacetquery.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removefacetquery.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removefacetquery.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removefacetquery.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the facet.query parameters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeFacetQuery - Manual" />
<meta name="twitter:description" content="Removes one of the facet.query parameters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeFacetQuery - Manual" />
<meta itemprop="description" content="Removes one of the facet.query parameters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the facet.query parameters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removefield.php">
          SolrQuery::removeField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removefacetfield.php">
          &laquo; SolrQuery::removeFacetField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removefacetquery.php' selected="selected">English</option>
            <option value='de/solrquery.removefacetquery.php'>German</option>
            <option value='es/solrquery.removefacetquery.php'>Spanish</option>
            <option value='fr/solrquery.removefacetquery.php'>French</option>
            <option value='it/solrquery.removefacetquery.php'>Italian</option>
            <option value='ja/solrquery.removefacetquery.php'>Japanese</option>
            <option value='pt_BR/solrquery.removefacetquery.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removefacetquery.php'>Russian</option>
            <option value='tr/solrquery.removefacetquery.php'>Turkish</option>
            <option value='uk/solrquery.removefacetquery.php'>Ukrainian</option>
            <option value='zh/solrquery.removefacetquery.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removefacetquery" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeFacetQuery</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeFacetQuery</span> &mdash; <span class="dc-title">Removes one of the facet.query parameters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removefacetquery-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeFacetQuery</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removefacetquery-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removefacetquery-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removefacetquery.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removefacetquery%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removefacetquery&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removefacetquery.php">＋<small>add a note</small></a></span>
