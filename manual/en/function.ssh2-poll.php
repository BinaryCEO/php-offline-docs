...
<head>
  ...
  <title>PHP: ssh2_poll - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ssh2-poll.php">
 <link rel="shorturl" href="https://www.php.net/ssh2-poll">
 <link rel="alternate" href="https://www.php.net/ssh2-poll" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ssh2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ssh2-methods-negotiated.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ssh2-publickey-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ssh2-poll.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ssh2-poll.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ssh2-poll.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ssh2-poll.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ssh2-poll.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ssh2-poll.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ssh2-poll.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ssh2-poll.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ssh2-poll.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ssh2-poll.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ssh2-poll.php" hreflang="zh">
...
<meta name="Description" content="Poll the channels/listeners/streams for events" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ssh2_poll - Manual" />
<meta name="twitter:description" content="Poll the channels/listeners/streams for events" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ssh2_poll - Manual" />
<meta itemprop="description" content="Poll the channels/listeners/streams for events" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Poll the channels/listeners/streams for events" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ssh2-publickey-add.php">
          ssh2_publickey_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ssh2-methods-negotiated.php">
          &laquo; ssh2_methods_negotiated        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ssh2-poll.php' selected="selected">English</option>
            <option value='de/function.ssh2-poll.php'>German</option>
            <option value='es/function.ssh2-poll.php'>Spanish</option>
            <option value='fr/function.ssh2-poll.php'>French</option>
            <option value='it/function.ssh2-poll.php'>Italian</option>
            <option value='ja/function.ssh2-poll.php'>Japanese</option>
            <option value='pt_BR/function.ssh2-poll.php'>Brazilian Portuguese</option>
            <option value='ru/function.ssh2-poll.php'>Russian</option>
            <option value='tr/function.ssh2-poll.php'>Turkish</option>
            <option value='uk/function.ssh2-poll.php'>Ukrainian</option>
            <option value='zh/function.ssh2-poll.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ssh2-poll" class="refentry">
  ...
  <p class="para">
   Returns the number of descriptors which returned non-zero revents.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ssh2/functions/ssh2-poll.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ssh2-poll%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ssh2-poll&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ssh2-poll.php">＋<small>add a note</small></a></span>
