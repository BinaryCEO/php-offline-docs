...
<head>
  ...
  <title>PHP: sodium_crypto_sign_keypair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-sign-keypair.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-sign-keypair">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-sign-keypair" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-sign-ed25519-sk-to-curve25519.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-sign-keypair-from-secretkey-and-publickey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-sign-keypair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-sign-keypair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-sign-keypair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-sign-keypair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-sign-keypair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-sign-keypair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-sign-keypair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-sign-keypair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-sign-keypair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-sign-keypair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-sign-keypair.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: sodium_crypto_sign_keypair - Manual" />
...
<meta itemprop="name" content="PHP: sodium_crypto_sign_keypair - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-sign-keypair-from-secretkey-and-publickey.php">
          sodium_crypto_sign_keypair_from_secretkey_and_publickey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-sign-ed25519-sk-to-curve25519.php">
          &laquo; sodium_crypto_sign_ed25519_sk_to_curve25519        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-sign-keypair.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-sign-keypair.php'>German</option>
            <option value='es/function.sodium-crypto-sign-keypair.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-sign-keypair.php'>French</option>
            <option value='it/function.sodium-crypto-sign-keypair.php'>Italian</option>
            <option value='ja/function.sodium-crypto-sign-keypair.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-sign-keypair.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-sign-keypair.php'>Russian</option>
            <option value='tr/function.sodium-crypto-sign-keypair.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-sign-keypair.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-sign-keypair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-sign-keypair" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_sign_keypair</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_sign_keypair</span> &mdash; <span class="dc-title">Randomly generate a secret key and a corresponding public key</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-sign-keypair-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_sign_keypair</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-sign-keypair-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-sign-keypair-returnvalues">
  ...
  <p class="para">
   Ed25519 keypair.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-sign-keypair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-sign-keypair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-sign-keypair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-sign-keypair.php">＋<small>add a note</small></a></span>
