...
<head>
  ...
  <title>PHP: is_readable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-readable.php">
 <link rel="shorturl" href="https://www.php.net/is-readable">
 <link rel="alternate" href="https://www.php.net/is-readable" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.filesystem.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-link.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-uploaded-file.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-readable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-readable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-readable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-readable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-readable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-readable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-readable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-readable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-readable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-readable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-readable.php" hreflang="zh">
...
<meta name="Description" content="Tells whether a file exists and is readable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_readable - Manual" />
<meta name="twitter:description" content="Tells whether a file exists and is readable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_readable - Manual" />
<meta itemprop="description" content="Tells whether a file exists and is readable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tells whether a file exists and is readable" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-readable.php' selected="selected">English</option>
            <option value='de/function.is-readable.php'>German</option>
            <option value='es/function.is-readable.php'>Spanish</option>
            <option value='fr/function.is-readable.php'>French</option>
            <option value='it/function.is-readable.php'>Italian</option>
            <option value='ja/function.is-readable.php'>Japanese</option>
            <option value='pt_BR/function.is-readable.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-readable.php'>Russian</option>
            <option value='tr/function.is-readable.php'>Turkish</option>
            <option value='uk/function.is-readable.php'>Ukrainian</option>
            <option value='zh/function.is-readable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-readable" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.is-readable-examples">
  ...
  <p class="para">
   <div class="example" id="example-2391">
    <p><strong>Example #1 <span class="function"><strong>is_readable()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fgets.php" class="function" rel="rdfs-seeAlso">fgets()</a> - Gets line from file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/is-readable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-readable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-readable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-readable.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="61293">  <div class="votes">
    <div id="Vu61293">
    <a href="/manual/vote-note.php?id=61293&amp;page=function.is-readable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61293">
    <a href="/manual/vote-note.php?id=61293&amp;page=function.is-readable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61293" title="61% like this...">
    8
    </div>
  </div>
  <a href="#61293" class="name">
  <strong class="user"><em>jo at durchholz dot org</em></strong></a><a class="genanchor" href="#61293"> &para;</a><div class="date" title="2006-01-30 09:15"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61293">
<div class="phpcode"><code><span class="html">DrTebi at yahoo dot com is wrong. is_readable() checks whether you can do file_get_contents() or similar calls, no more, no less. If the location given returns a 500 or 403 error, you can still read() that (you'll simply get the error page), but it's still read()able. Using is_readable to check the validity of a URL is simply the wrong function.</span></code></div>
  </div>
 </div>
  <div class="note" id="92618">  <div class="votes">
    <div id="Vu92618">
    <a href="/manual/vote-note.php?id=92618&amp;page=function.is-readable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92618">
    <a href="/manual/vote-note.php?id=92618&amp;page=function.is-readable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92618" title="52% like this...">
    1
    </div>
  </div>
  <a href="#92618" class="name">
  <strong class="user"><em>pgl at yoyo dot org</em></strong></a><a class="genanchor" href="#92618"> &para;</a><div class="date" title="2009-07-31 07:13"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92618">
<div class="phpcode"><code><span class="html">Note that is_readable() will return false for streams, eg, php://stdin.</span></code></div>
  </div>
 </div>
  <div class="note" id="130325">  <div class="votes">
    <div id="Vu130325">
    <a href="/manual/vote-note.php?id=130325&amp;page=function.is-readable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130325">
    <a href="/manual/vote-note.php?id=130325&amp;page=function.is-readable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130325" title="no votes...">
    0
    </div>
  </div>
  <a href="#130325" class="name">
  <strong class="user"><em>johninen at gmail dot com</em></strong></a><a class="genanchor" href="#130325"> &para;</a><div class="date" title="2025-05-28 11:27"><strong>4 months ago</strong></div>
  <div class="text" id="Hcom130325">
<div class="phpcode"><code><span class="html">This will return false on urls, even if file_get_contents() reads them. So, only for files.</span></code></div>
  </div>
 </div>
  <div class="note" id="118668">  <div class="votes">
    <div id="Vu118668">
    <a href="/manual/vote-note.php?id=118668&amp;page=function.is-readable&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118668">
    <a href="/manual/vote-note.php?id=118668&amp;page=function.is-readable&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118668" title="50% like this...">
    0
    </div>
  </div>
  <a href="#118668" class="name">
  <strong class="user"><em>arikan134 at gmail dot com</em></strong></a><a class="genanchor" href="#118668"> &para;</a><div class="date" title="2016-01-17 12:12"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118668">
<div class="phpcode"><code><span class="html">is readable recursively. Check all sub directories and files readable<br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">is_readable_r</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">) {<br />    if (</span><span class="default">is_dir</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">)) {<br />        if(</span><span class="default">is_readable</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">)){<br />            </span><span class="default">$objects </span><span class="keyword">= </span><span class="default">scandir</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">);<br />            foreach (</span><span class="default">$objects </span><span class="keyword">as </span><span class="default">$object</span><span class="keyword">) {<br />                if (</span><span class="default">$object </span><span class="keyword">!= </span><span class="string">"." </span><span class="keyword">&amp;&amp; </span><span class="default">$object </span><span class="keyword">!= </span><span class="string">".."</span><span class="keyword">) {<br />                    if (!</span><span class="default">is_readable_r</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">.</span><span class="string">"/"</span><span class="keyword">.</span><span class="default">$object</span><span class="keyword">)) return </span><span class="default">false</span><span class="keyword">;<br />                    else continue;<br />                }<br />            }    <br />            return </span><span class="default">true</span><span class="keyword">;    <br />        }else{<br />            return </span><span class="default">false</span><span class="keyword">;<br />        }<br />        <br />    }else if(</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">)){<br />        return (</span><span class="default">is_readable</span><span class="keyword">(</span><span class="default">$dir</span><span class="keyword">));<br />        <br />    }<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-readable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-readable.php">＋<small>add a note</small></a></div>
