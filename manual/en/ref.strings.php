...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.strings.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/string.constants.php">
 <link rel="next" href="https://www.php.net/manual/en/function.addcslashes.php">
...
<meta name="twitter:title" content="PHP: String Functions - Manual" />
<meta name="twitter:description" content="String Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: String Functions - Manual" />
<meta itemprop="description" content="String Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="String Functions" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.strings.php' selected="selected">English</option>
 ...
 <div class="partintro">
  ...
  <p class="para">
   ...
   take a look at the <a href="ref.pcre.php" class="link">Perl
   compatible regular expression functions</a>.
   For working with multibyte character encodings, take a look at the
   <a href="ref.mbstring.php" class="link">Multibyte String functions</a>.
  </p>
 </div>
   ...
   characters</li><li><a href="function.utf8-encode.php">utf8_encode</a> — Converts a string from ISO-8859-1 to UTF-8</li><li><a href="function.vfprintf.php">vfprintf</a> — Write a formatted string to a stream</li><li><a href="function.vprintf.php">vprintf</a> — Output a formatted string</li><li><a href="function.vsprintf.php">vsprintf</a> — Return a formatted string</li><li><a href="function.wordwrap.php">wordwrap</a> — Wraps a string to a given number of characters</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/reference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.strings%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.strings&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.strings.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="126364">  <div class="votes">
    ...
    <div class="tally" id="V126364" title="51% like this...">
    5
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">I'm converting 30 year old code and needed a string TAB function:<br /><br />  //tab function similar to TAB used in old BASIC languages<br />  //though some of them did not truncate if the string were<br />  //longer than the requested position<br />  function tab($instring="",$topos=0){<br />    if(strlen($instring)&lt;$topos){<br />      $result=str_pad($instring,$topos-1," ",STR_PAD_RIGHT);<br />    }else{<br />      $result=substr($instring,0,$topos-1);<br />    }<br />    return $result;<br />  }<br /><br />  $pline="String with this tab to 50 and";<br />  $tline=tab($pline,50)."finish it.";<br />  echo $tline.PHP_EOL;<br />  $pline="101010101020202020203030303030404040404050505050506060606060";<br />  $tline=tab($pline,50)."finish it.";<br />  echo $tline.PHP_EOL;<br /><br />  //Results in this output:<br />  //String with this tab to 50 and                   finish it.<br />  //1010101010202020202030303030304040404040505050505finish it.</span></code></div>
  </div>
 </div>
  <div class="note" id="48626">  <div class="votes">
    ...
    <div class="tally" id="V48626" title="48% like this...">
    -2
    </div>
  </div>
