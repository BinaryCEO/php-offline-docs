...
<head>
  ...
  <title>PHP: SolrQuery::removeField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removefield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removefield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removefacetquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removefilterquery.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removefield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removefield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removefield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removefield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removefield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removefield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removefield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removefield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removefield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removefield.php" hreflang="zh">
...
<meta name="Description" content="Removes a field from the list of fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeField - Manual" />
<meta name="twitter:description" content="Removes a field from the list of fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeField - Manual" />
<meta itemprop="description" content="Removes a field from the list of fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes a field from the list of fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.removefilterquery.php">
          SolrQuery::removeFilterQuery &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removefacetquery.php">
          &laquo; SolrQuery::removeFacetQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removefield.php' selected="selected">English</option>
            <option value='de/solrquery.removefield.php'>German</option>
            <option value='es/solrquery.removefield.php'>Spanish</option>
            <option value='fr/solrquery.removefield.php'>French</option>
            <option value='it/solrquery.removefield.php'>Italian</option>
            <option value='ja/solrquery.removefield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removefield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removefield.php'>Russian</option>
            <option value='tr/solrquery.removefield.php'>Turkish</option>
            <option value='uk/solrquery.removefield.php'>Ukrainian</option>
            <option value='zh/solrquery.removefield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removefield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeField</span> &mdash; <span class="dc-title">Removes a field from the list of fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removefield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removefield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removefield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removefield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removefield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removefield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removefield.php">＋<small>add a note</small></a></span>
