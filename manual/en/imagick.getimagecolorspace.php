...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagecolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagecolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagecolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagecolors.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagecompose.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagecolorspace.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.getimagecolorspace.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageColorspace</span> &mdash; <span class="dc-title">Gets the image colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagecolorspace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageColorspace</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   Returns an integer which can be compared against <a href="imagick.constants.php#imagick.constants.colorspace" class="link">COLORSPACE constants</a>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagecolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagecolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagecolorspace.php">＋<small>add a note</small></a></span>
