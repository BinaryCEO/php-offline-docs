...
<head>
  ...
  <title>PHP: stats_rand_setall - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-setall.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-setall">
 <link rel="alternate" href="https://www.php.net/stats-rand-setall" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-ranf.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-skew.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-setall.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-setall.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-setall.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-setall.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-setall.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-setall.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-setall.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-setall.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-setall.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-setall.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-setall.php" hreflang="zh">
...
<meta name="Description" content="Set seed values to the random generator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_setall - Manual" />
<meta name="twitter:description" content="Set seed values to the random generator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_setall - Manual" />
<meta itemprop="description" content="Set seed values to the random generator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set seed values to the random generator" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-skew.php">
          stats_skew &raquo;
              ...
              <div class="prev">
        <a href="function.stats-rand-ranf.php">
          &laquo; stats_rand_ranf        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-setall.php' selected="selected">English</option>
            <option value='de/function.stats-rand-setall.php'>German</option>
            <option value='es/function.stats-rand-setall.php'>Spanish</option>
            <option value='fr/function.stats-rand-setall.php'>French</option>
            <option value='it/function.stats-rand-setall.php'>Italian</option>
            <option value='ja/function.stats-rand-setall.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-setall.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-setall.php'>Russian</option>
            <option value='tr/function.stats-rand-setall.php'>Turkish</option>
            <option value='uk/function.stats-rand-setall.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-setall.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-setall" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_setall</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_setall</span> &mdash; <span class="dc-title">Set seed values to the random generator</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-setall-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>stats_rand_setall</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$iseed1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$iseed2</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   Set <code class="parameter">iseed1</code> and <code class="parameter">iseed2</code> as seed values to the random generator
   used in statistic functions.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-rand-setall-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">iseed1</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">iseed2</code></dt>
     <dd>
      <p class="para">
       The value which is used as the random seed
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-setall-returnvalues">
  ...
  <p class="para">
   No values are returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-setall.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-setall%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-setall&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-setall.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119798">  <div class="votes">
    <div id="Vu119798">
    <a href="/manual/vote-note.php?id=119798&amp;page=function.stats-rand-setall&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119798">
    <a href="/manual/vote-note.php?id=119798&amp;page=function.stats-rand-setall&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119798" title="100% like this...">
    1
    </div>
  </div>
  <a href="#119798" class="name">
  <strong class="user"><em>geoffreyj dot lee at gmail dot com</em></strong></a><a class="genanchor" href="#119798"> &para;</a><div class="date" title="2016-08-29 06:37"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119798">
<div class="phpcode"><code><span class="html">tl;dr - This random number generator is implemented using linear congruential generators. The arguments iseed1 and iseed2 each expect a 32-bit integer.<br /><br />I can't believe this PECL package has such terrible documentation that I have to dig into the C source code to figure out how to use it.<br /><br />Documentation from PECL source, lines 246-262 of "com.c" found at:<br /><a href="http://git.php.net/?p=pecl/math/stats.git;a=blob;f=com.c;h=7740ac636969e500254c61697125dfa8857dd715;hb=refs/heads/master" rel="nofollow" target="_blank">http://git.php.net/?p=pecl/math/stats.git;a=blob;f=com.c;h=7740ac636969e500254c61697125dfa8857dd715;hb=refs/heads/master</a><br /><br />/*<br />**********************************************************************<br />void setall(long iseed1,long iseed2)<br />          SET ALL random number generators<br />Sets the initial seed of generator 1 to ISEED1 and ISEED2. The<br />initial seeds of the other generators are set accordingly, and<br />all generators states are set to these seeds.<br />This is a transcription from Pascal to Fortran of routine<br />Set_Initial_Seed from the paper<br />L'Ecuyer, P. and Cote, S. "Implementing a Random Number Package<br />with Splitting Facilities." ACM Transactions on Mathematical<br />Software, 17:98-111 (1991)<br />                         Arguments<br />iseed1 -&gt; First of two integer seeds<br />iseed2 -&gt; Second of two integer seeds<br />**********************************************************************<br />*/<br /><br />Looking further into the referenced paper, we see:<br /><br />PROCEDURE Set_lnitiaI_Seed (S1, S2 INTEGER);<br />Resets the initial seed of generator 1 to the values S1 and S2, which must satisfy: 1 &lt;= S1 &lt;= 2147483562 and 1 &lt;= S2 &lt;= 2147483398. The initial seeds of all other generators are recomputed accordingly, and all generator’s states are reset to these initial seeds. This procedure is called automatically at the beginning of program execution, with (default) parameter values S1 = 1234567890 and S2 = 123456789.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-rand-setall&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-setall.php">＋<small>add a note</small></a></div>
