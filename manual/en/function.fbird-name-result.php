...
<head>
  ...
  <title>PHP: fbird_name_result - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-name-result.php">
 <link rel="shorturl" href="https://www.php.net/fbird-name-result">
 <link rel="alternate" href="https://www.php.net/fbird-name-result" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-modify-user.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-num-fields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-name-result.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-name-result.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-name-result.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-name-result.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-name-result.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-name-result.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-name-result.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-name-result.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-name-result.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-name-result.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-name-result.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_name_result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_name_result - Manual" />
<meta name="twitter:description" content="Alias of ibase_name_result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_name_result - Manual" />
<meta itemprop="description" content="Alias of ibase_name_result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_name_result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-num-fields.php">
          fbird_num_fields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-modify-user.php">
          &laquo; fbird_modify_user        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-name-result.php' selected="selected">English</option>
            <option value='de/function.fbird-name-result.php'>German</option>
            <option value='es/function.fbird-name-result.php'>Spanish</option>
            <option value='fr/function.fbird-name-result.php'>French</option>
            <option value='it/function.fbird-name-result.php'>Italian</option>
            <option value='ja/function.fbird-name-result.php'>Japanese</option>
            <option value='pt_BR/function.fbird-name-result.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-name-result.php'>Russian</option>
            <option value='tr/function.fbird-name-result.php'>Turkish</option>
            <option value='uk/function.fbird-name-result.php'>Ukrainian</option>
            <option value='zh/function.fbird-name-result.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-name-result" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_name_result</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_name_result</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-name-result.php" class="function">ibase_name_result()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-name-result-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-name-result.php" class="function">ibase_name_result()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fbird-name-result-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-prepare.php" class="function" rel="rdfs-seeAlso">fbird_prepare()</a> - Alias of ibase_prepare</span></li>
    <li><span class="function"><a href="function.fbird-execute.php" class="function" rel="rdfs-seeAlso">fbird_execute()</a> - Alias of ibase_execute</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-name-result.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-name-result%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-name-result&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-name-result.php">＋<small>add a note</small></a></span>
