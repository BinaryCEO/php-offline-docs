...
<head>
  ...
  <title>PHP: ftp_connect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-connect.php">
 <link rel="shorturl" href="https://www.php.net/ftp-connect">
 <link rel="alternate" href="https://www.php.net/ftp-connect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ftp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ftp-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-delete.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ftp-connect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ftp-connect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ftp-connect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ftp-connect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ftp-connect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ftp-connect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ftp-connect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ftp-connect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ftp-connect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ftp-connect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ftp-connect.php" hreflang="zh">
...
<meta name="Description" content="Opens an FTP connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_connect - Manual" />
<meta name="twitter:description" content="Opens an FTP connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_connect - Manual" />
<meta itemprop="description" content="Opens an FTP connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Opens an FTP connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-connect.php' selected="selected">English</option>
            <option value='de/function.ftp-connect.php'>German</option>
            <option value='es/function.ftp-connect.php'>Spanish</option>
            <option value='fr/function.ftp-connect.php'>French</option>
            <option value='it/function.ftp-connect.php'>Italian</option>
            <option value='ja/function.ftp-connect.php'>Japanese</option>
            <option value='pt_BR/function.ftp-connect.php'>Brazilian Portuguese</option>
            <option value='ru/function.ftp-connect.php'>Russian</option>
            <option value='tr/function.ftp-connect.php'>Turkish</option>
            <option value='uk/function.ftp-connect.php'>Ukrainian</option>
            <option value='zh/function.ftp-connect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ftp-connect" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ftp-ssl-connect.php" class="function" rel="rdfs-seeAlso">ftp_ssl_connect()</a> - Opens a Secure SSL-FTP connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-connect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-connect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-connect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="89811">  <div class="votes">
    <div id="Vu89811">
    <a href="/manual/vote-note.php?id=89811&amp;page=function.ftp-connect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89811">
    <a href="/manual/vote-note.php?id=89811&amp;page=function.ftp-connect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89811" title="53% like this...">
    14
    </div>
  </div>
  <a href="#89811" class="name">
  <strong class="user"><em>sean at boyercentral dot net</em></strong></a><a class="genanchor" href="#89811"> &para;</a><div class="date" title="2009-03-24 05:05"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89811">
<div class="phpcode"><code><span class="html">Ever needed to create an FTP connection resource defaulted to a particular dir from a URI? Here's a simple function that will take a URI like <a href="ftp://username:password@subdomain.example.com/path1/path2/," rel="nofollow" target="_blank">ftp://username:password@subdomain.example.com/path1/path2/,</a> and return an FTP connection resource.
<br />
...
<div class="foot"><a href="/manual/add-note.php?sect=function.ftp-connect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-connect.php">＋<small>add a note</small></a></div>
