...
<head>
  ...
  <title>PHP: trader_ad - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-ad.php">
 <link rel="shorturl" href="https://www.php.net/trader-ad">
 <link rel="alternate" href="https://www.php.net/trader-ad" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-acos.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-ad.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-ad.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-ad.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-ad.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-ad.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-ad.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-ad.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-ad.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-ad.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-ad.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-ad.php" hreflang="zh">
...
<meta name="Description" content="Chaikin A/D Line" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_ad - Manual" />
<meta name="twitter:description" content="Chaikin A/D Line" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_ad - Manual" />
<meta itemprop="description" content="Chaikin A/D Line" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Chaikin A/D Line" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-add.php">
          trader_add &raquo;
              ...
              <div class="prev">
        <a href="function.trader-acos.php">
          &laquo; trader_acos        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-ad.php' selected="selected">English</option>
            <option value='de/function.trader-ad.php'>German</option>
            <option value='es/function.trader-ad.php'>Spanish</option>
            <option value='fr/function.trader-ad.php'>French</option>
            <option value='it/function.trader-ad.php'>Italian</option>
            <option value='ja/function.trader-ad.php'>Japanese</option>
            <option value='pt_BR/function.trader-ad.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-ad.php'>Russian</option>
            <option value='tr/function.trader-ad.php'>Turkish</option>
            <option value='uk/function.trader-ad.php'>Ukrainian</option>
            <option value='zh/function.trader-ad.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-ad" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_ad</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_ad</span> &mdash; <span class="dc-title">Chaikin A/D Line</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-ad-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_ad</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$volume</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-ad-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-ad-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-ad.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-ad%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-ad&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ad.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125746">  <div class="votes">
    <div id="Vu125746">
    <a href="/manual/vote-note.php?id=125746&amp;page=function.trader-ad&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125746">
    <a href="/manual/vote-note.php?id=125746&amp;page=function.trader-ad&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125746" title="100% like this...">
    1
    </div>
  </div>
  <a href="#125746" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125746"> &para;</a><div class="date" title="2021-01-31 06:55"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125746">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />$highs </span><span class="keyword">= array(</span><span class="default">136.74</span><span class="keyword">, </span><span class="default">141.99</span><span class="keyword">, </span><span class="default">144.3</span><span class="keyword">, </span><span class="default">144.3</span><span class="keyword">);<br /></span><span class="default">$lows </span><span class="keyword">= array(</span><span class="default">130.21</span><span class="keyword">, </span><span class="default">136.7</span><span class="keyword">, </span><span class="default">140.41</span><span class="keyword">, </span><span class="default">141.37</span><span class="keyword">);<br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">131.96</span><span class="keyword">, </span><span class="default">137.09</span><span class="keyword">, </span><span class="default">142.06</span><span class="keyword">, </span><span class="default">143.16</span><span class="keyword">);<br /></span><span class="default">$volumes </span><span class="keyword">= array(</span><span class="default">177523812.0</span><span class="keyword">, </span><span class="default">142621128.0</span><span class="keyword">, </span><span class="default">140843759.0</span><span class="keyword">, </span><span class="default">98390555.0</span><span class="keyword">);<br /><br /></span><span class="default">$Chaikin_AD_Result </span><span class="keyword">= </span><span class="default">trader_ad</span><span class="keyword">(</span><span class="default">$highs</span><span class="keyword">, </span><span class="default">$lows </span><span class="keyword">, </span><span class="default">$closes</span><span class="keyword">, </span><span class="default">$volumes</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$Chaikin_AD_Result</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(4) {<br />  [0]=&gt;<br />  float(-82373223.639)<br />  [1]=&gt;<br />  float(-203965149.4)<br />  [2]=&gt;<br />  float(-225327056.292)<br />  [3]=&gt;<br />  float(-203499800.064)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-ad&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-ad.php">＋<small>add a note</small></a></div>
