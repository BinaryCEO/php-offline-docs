...
<head>
  ...
  <title>PHP: Memcached::setSaslAuthData - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcached.setsaslauthdata.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcached.setsaslauthdata.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setsaslauthdata.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.memcached.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcached.setoptions.php">
 <link rel="next" href="https://www.php.net/manual/en/memcached.touch.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcached.setsaslauthdata.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcached.setsaslauthdata.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcached.setsaslauthdata.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcached.setsaslauthdata.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcached.setsaslauthdata.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcached.setsaslauthdata.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcached.setsaslauthdata.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcached.setsaslauthdata.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcached.setsaslauthdata.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcached.setsaslauthdata.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcached.setsaslauthdata.php" hreflang="zh">
...
<meta name="Description" content="Set the credentials to use for authentication" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Memcached::setSaslAuthData - Manual" />
<meta name="twitter:description" content="Set the credentials to use for authentication" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Memcached::setSaslAuthData - Manual" />
<meta itemprop="description" content="Set the credentials to use for authentication" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the credentials to use for authentication" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcached.touch.php">
          Memcached::touch &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcached.setoptions.php">
          &laquo; Memcached::setOptions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcached.setsaslauthdata.php' selected="selected">English</option>
            <option value='de/memcached.setsaslauthdata.php'>German</option>
            <option value='es/memcached.setsaslauthdata.php'>Spanish</option>
            <option value='fr/memcached.setsaslauthdata.php'>French</option>
            <option value='it/memcached.setsaslauthdata.php'>Italian</option>
            <option value='ja/memcached.setsaslauthdata.php'>Japanese</option>
            <option value='pt_BR/memcached.setsaslauthdata.php'>Brazilian Portuguese</option>
            <option value='ru/memcached.setsaslauthdata.php'>Russian</option>
            <option value='tr/memcached.setsaslauthdata.php'>Turkish</option>
            <option value='uk/memcached.setsaslauthdata.php'>Ukrainian</option>
            <option value='zh/memcached.setsaslauthdata.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcached.setsaslauthdata" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcached/memcached/setsaslauthdata.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcached.setsaslauthdata%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcached.setsaslauthdata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.setsaslauthdata.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116644">  <div class="votes">
    <div id="Vu116644">
    <a href="/manual/vote-note.php?id=116644&amp;page=memcached.setsaslauthdata&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116644">
    <a href="/manual/vote-note.php?id=116644&amp;page=memcached.setsaslauthdata&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116644" title="75% like this...">
    4
    </div>
  </div>
  <a href="#116644" class="name">
  <strong class="user"><em>me at koen dot pt</em></strong></a><a class="genanchor" href="#116644"> &para;</a><div class="date" title="2015-02-03 10:47"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116644">
<div class="phpcode"><code><span class="html">When using setSaslAuthData(), it's a good change you'll get the following warning:<br /><br />Warning: Memcached::setSaslAuthData(): SASL is only supported with binary protocol in test.php on line 8<br /><br />To enable binary protocol you'll have to set the Memcached::OPT_BINARY_PROTOCOL option to true:<br /><br /><span class="default">&lt;?php<br />$mc</span><span class="keyword">-&gt;</span><span class="default">setOption</span><span class="keyword">(</span><span class="default">Memcached</span><span class="keyword">::</span><span class="default">OPT_BINARY_PROTOCOL</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcached.setsaslauthdata&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcached.setsaslauthdata.php">＋<small>add a note</small></a></div>
