...
<head>
  ...
  <title>PHP: ZipArchive::deleteName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.deletename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.deletename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.deletename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.deleteindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.extractto.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.deletename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.deletename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.deletename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.deletename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.deletename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.deletename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.deletename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.deletename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.deletename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.deletename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.deletename.php" hreflang="zh">
...
<meta name="Description" content="Delete an entry in the archive using its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::deleteName - Manual" />
<meta name="twitter:description" content="Delete an entry in the archive using its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::deleteName - Manual" />
<meta itemprop="description" content="Delete an entry in the archive using its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete an entry in the archive using its name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ziparchive.extractto.php">
          ZipArchive::extractTo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.deleteindex.php">
          &laquo; ZipArchive::deleteIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.deletename.php' selected="selected">English</option>
            <option value='de/ziparchive.deletename.php'>German</option>
            <option value='es/ziparchive.deletename.php'>Spanish</option>
            <option value='fr/ziparchive.deletename.php'>French</option>
            <option value='it/ziparchive.deletename.php'>Italian</option>
            <option value='ja/ziparchive.deletename.php'>Japanese</option>
            <option value='pt_BR/ziparchive.deletename.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.deletename.php'>Russian</option>
            <option value='tr/ziparchive.deletename.php'>Turkish</option>
            <option value='uk/ziparchive.deletename.php'>Ukrainian</option>
            <option value='zh/ziparchive.deletename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.deletename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ZipArchive::deleteName</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.5.0)</p><p class="refpurpose"><span class="refname">ZipArchive::deleteName</span> &mdash; <span class="dc-title">Delete an entry in the archive using its name</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-ziparchive.deletename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::deleteName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-ziparchive.deletename-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-ziparchive.deletename-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$zip </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">;<br />if (</span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test1.zip'</span><span style="color: #007700">) === </span><span style="color: #0000BB">TRUE</span><span style="color: #007700">) {<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">deleteName</span><span style="color: #007700">(</span><span style="color: #DD0000">'testfromfile.php'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">deleteName</span><span style="color: #007700">(</span><span style="color: #DD0000">'testDir/'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$zip</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />    echo </span><span style="color: #DD0000">'ok'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'failed'</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/deletename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.deletename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.deletename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.deletename.php">＋<small>add a note</small></a></span>
