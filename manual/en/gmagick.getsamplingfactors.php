...
<head>
  ...
  <title>PHP: Gmagick::getsamplingfactors - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getsamplingfactors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getsamplingfactors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getsamplingfactors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getreleasedate.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getsize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getsamplingfactors.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getsamplingfactors.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getsamplingfactors.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getsamplingfactors.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getsamplingfactors.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getsamplingfactors.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getsamplingfactors.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getsamplingfactors.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getsamplingfactors.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getsamplingfactors.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getsamplingfactors.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getsamplingfactors - Manual" />
<meta name="twitter:description" content="Gets the horizontal and vertical sampling factor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getsamplingfactors - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getsize.php">
          Gmagick::getsize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getreleasedate.php">
          &laquo; Gmagick::getreleasedate        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getsamplingfactors.php' selected="selected">English</option>
            <option value='de/gmagick.getsamplingfactors.php'>German</option>
            <option value='es/gmagick.getsamplingfactors.php'>Spanish</option>
            <option value='fr/gmagick.getsamplingfactors.php'>French</option>
            <option value='it/gmagick.getsamplingfactors.php'>Italian</option>
            <option value='ja/gmagick.getsamplingfactors.php'>Japanese</option>
            <option value='pt_BR/gmagick.getsamplingfactors.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getsamplingfactors.php'>Russian</option>
            <option value='tr/gmagick.getsamplingfactors.php'>Turkish</option>
            <option value='uk/gmagick.getsamplingfactors.php'>Ukrainian</option>
            <option value='zh/gmagick.getsamplingfactors.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getsamplingfactors" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getsamplingfactors</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getsamplingfactors</span> &mdash; <span class="dc-title">Gets the horizontal and vertical sampling factor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getsamplingfactors-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getsamplingfactors</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getsamplingfactors-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getsamplingfactors-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getsamplingfactors-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getsamplingfactors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getsamplingfactors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getsamplingfactors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getsamplingfactors.php">＋<small>add a note</small></a></span>
