...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.variables.basics.php">
 <link rel="shorturl" href="https://www.php.net/variables.basics">
 <link rel="alternate" href="https://www.php.net/variables.basics" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.variables.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.variables.php">
 <link rel="next" href="https://www.php.net/manual/en/language.variables.predefined.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.variables.basics.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.variables.basics.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.variables.basics.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.variables.basics.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.variables.basics.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.variables.basics.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.variables.basics.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.variables.basics.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.variables.basics.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.variables.basics.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.variables.basics.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.variables.basics.php' selected="selected">English</option>
            ...
            <option value='it/language.variables.basics.php'>Italian</option>
            ...
            <option value='uk/language.variables.basics.php'>Ukrainian</option>
  ...
  </div><div id="language.variables.basics" class="sect1">
   ...
   <p class="simpara">
    ...
    <a href="ref.var.php" class="link">Variable Functions Reference</a>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.variables.basics%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.variables.basics&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.variables.basics.php">＋<small>add a note</small></a></span>
