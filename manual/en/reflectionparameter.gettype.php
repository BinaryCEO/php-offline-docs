...
<head>
  ...
  <title>PHP: ReflectionParameter::getType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.gettype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.gettype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.gettype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.getposition.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionparameter.hastype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.gettype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.gettype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.gettype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.gettype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.gettype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.gettype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.gettype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.gettype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.gettype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.gettype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.gettype.php" hreflang="zh">
...
<meta name="Description" content="Gets a parameter's type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionParameter::getType - Manual" />
<meta name="twitter:description" content="Gets a parameter's type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::getType - Manual" />
<meta itemprop="description" content="Gets a parameter's type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a parameter's type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionparameter.hastype.php">
          ReflectionParameter::hasType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.getposition.php">
          &laquo; ReflectionParameter::getPosition        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.gettype.php' selected="selected">English</option>
            <option value='de/reflectionparameter.gettype.php'>German</option>
            <option value='es/reflectionparameter.gettype.php'>Spanish</option>
            <option value='fr/reflectionparameter.gettype.php'>French</option>
            <option value='it/reflectionparameter.gettype.php'>Italian</option>
            <option value='ja/reflectionparameter.gettype.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.gettype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.gettype.php'>Russian</option>
            <option value='tr/reflectionparameter.gettype.php'>Turkish</option>
            <option value='uk/reflectionparameter.gettype.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.gettype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.gettype" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.gettype-examples">
  ...
  <p class="para">
   <div class="example" id="example-5586">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionParameter::getType()</strong></span> Usage as of PHP 7.1.0</strong></p>
...
NULL</pre>
  ...
  <p class="para">
   <div class="example" id="example-5587">
    <p><strong>Example #2 <span class="methodname"><strong>ReflectionParameter::getType()</strong></span> Usage before PHP 7.1.0</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">someFunction</span><span style="color: #007700">(</span><span style="color: #0000BB">int $param</span><span style="color: #007700">, </span><span style="color: #0000BB">$param2</span><span style="color: #007700">) {}<br /><br /></span><span style="color: #0000BB">$reflectionFunc </span><span style="color: #007700">= new </span><span style="color: #0000BB">ReflectionFunction</span><span style="color: #007700">(</span><span style="color: #DD0000">'someFunction'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$reflectionParams </span><span style="color: #007700">= </span><span style="color: #0000BB">$reflectionFunc</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getParameters</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$reflectionType1 </span><span style="color: #007700">= </span><span style="color: #0000BB">$reflectionParams</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getType</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$reflectionType2 </span><span style="color: #007700">= </span><span style="color: #0000BB">$reflectionParams</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">]-&gt;</span><span style="color: #0000BB">getType</span><span style="color: #007700">();<br /><br />echo </span><span style="color: #0000BB">$reflectionType1</span><span style="color: #007700">, </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$reflectionType2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>

    <div class="example-contents"><p>Output of the above example in PHP 7.0:</p></div>
    <div class="example-contents screen">
<div class="annotation-interactive examplescode"><pre class="examplescode">int
NULL</pre>
</div>
   ...
   <p><strong>Example #3 <span class="methodname"><strong>ReflectionParameter::getType()</strong></span> Usage in PHP 8.0.0 and later</strong></p>
    <div class="example-contents"><p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectiontype.tostring.php" class="methodname" rel="rdfs-seeAlso">ReflectionType::__toString()</a> - To string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/gettype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.gettype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.gettype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.gettype.php">＋<small>add a note</small></a></span>
