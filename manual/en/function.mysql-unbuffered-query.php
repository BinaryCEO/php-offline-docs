...
<head>
  ...
  <title>PHP: mysql_unbuffered_query - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-unbuffered-query.php">
 <link rel="shorturl" href="https://www.php.net/mysql-unbuffered-query">
 <link rel="alternate" href="https://www.php.net/mysql-unbuffered-query" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-thread-id.php">
 <link rel="next" href="https://www.php.net/manual/en/book.mysqlnd.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-unbuffered-query.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-unbuffered-query.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-unbuffered-query.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-unbuffered-query.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-unbuffered-query.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-unbuffered-query.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-unbuffered-query.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-unbuffered-query.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-unbuffered-query.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-unbuffered-query.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-unbuffered-query.php" hreflang="zh">
...
<meta name="Description" content="Send an SQL query to MySQL without fetching and buffering the result rows" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_unbuffered_query - Manual" />
<meta name="twitter:description" content="Send an SQL query to MySQL without fetching and buffering the result rows" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_unbuffered_query - Manual" />
<meta itemprop="description" content="Send an SQL query to MySQL without fetching and buffering the result rows" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Send an SQL query to MySQL without fetching and buffering the result rows" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.mysqlnd.php">
          Mysqlnd &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-thread-id.php">
          &laquo; mysql_thread_id        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-unbuffered-query.php' selected="selected">English</option>
            <option value='de/function.mysql-unbuffered-query.php'>German</option>
            <option value='es/function.mysql-unbuffered-query.php'>Spanish</option>
            <option value='fr/function.mysql-unbuffered-query.php'>French</option>
            <option value='it/function.mysql-unbuffered-query.php'>Italian</option>
            <option value='ja/function.mysql-unbuffered-query.php'>Japanese</option>
            <option value='pt_BR/function.mysql-unbuffered-query.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-unbuffered-query.php'>Russian</option>
            <option value='tr/function.mysql-unbuffered-query.php'>Turkish</option>
            <option value='uk/function.mysql-unbuffered-query.php'>Ukrainian</option>
            <option value='zh/function.mysql-unbuffered-query.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-unbuffered-query" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-query.php" class="function" rel="rdfs-seeAlso">mysql_query()</a> - Send a MySQL query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-unbuffered-query.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-unbuffered-query%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-unbuffered-query&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-unbuffered-query.php">＋<small>add a note</small></a></span>
