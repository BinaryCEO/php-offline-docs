...
<head>
  ...
  <title>PHP: ZookeeperOperationTimeoutException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeeperoperationtimeoutexception.php">
 <link rel="shorturl" href="https://www.php.net/zookeeperoperationtimeoutexception">
 <link rel="alternate" href="https://www.php.net/zookeeperoperationtimeoutexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.zookeepernonodeexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.zookeepersessionexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zookeeperoperationtimeoutexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zookeeperoperationtimeoutexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zookeeperoperationtimeoutexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zookeeperoperationtimeoutexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zookeeperoperationtimeoutexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zookeeperoperationtimeoutexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zookeeperoperationtimeoutexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zookeeperoperationtimeoutexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zookeeperoperationtimeoutexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zookeeperoperationtimeoutexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zookeeperoperationtimeoutexception.php" hreflang="zh">
...
<meta name="Description" content="The ZookeeperOperationTimeoutException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperOperationTimeoutException - Manual" />
<meta name="twitter:description" content="The ZookeeperOperationTimeoutException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperOperationTimeoutException - Manual" />
<meta itemprop="description" content="The ZookeeperOperationTimeoutException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZookeeperOperationTimeoutException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.zookeepersessionexception.php">
          ZookeeperSessionException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.zookeepernonodeexception.php">
          &laquo; ZookeeperNoNodeException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeeperoperationtimeoutexception.php' selected="selected">English</option>
            <option value='de/class.zookeeperoperationtimeoutexception.php'>German</option>
            <option value='es/class.zookeeperoperationtimeoutexception.php'>Spanish</option>
            <option value='fr/class.zookeeperoperationtimeoutexception.php'>French</option>
            <option value='it/class.zookeeperoperationtimeoutexception.php'>Italian</option>
            <option value='ja/class.zookeeperoperationtimeoutexception.php'>Japanese</option>
            <option value='pt_BR/class.zookeeperoperationtimeoutexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.zookeeperoperationtimeoutexception.php'>Russian</option>
            <option value='tr/class.zookeeperoperationtimeoutexception.php'>Turkish</option>
            <option value='uk/class.zookeeperoperationtimeoutexception.php'>Ukrainian</option>
            <option value='zh/class.zookeeperoperationtimeoutexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zookeeperoperationtimeoutexception" class="reference">
 <h1 class="title">The ZookeeperOperationTimeoutException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PECL zookeeper &gt;= 0.3.0)</p>
 

  <div class="section" id="zookeeperoperationtimeoutexception.intro">
  ...
  <div class="section" id="zookeeperoperationtimeoutexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">ZookeeperOperationTimeoutException</strong>
     </span>
     <span class="ooclass">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeperoperationtimeoutexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeeperoperationtimeoutexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeeperoperationtimeoutexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeeperoperationtimeoutexception.php">＋<small>add a note</small></a></span>
