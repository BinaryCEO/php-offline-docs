...
<head>
  ...
  <title>PHP: ibase_service_attach - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-service-attach.php">
 <link rel="shorturl" href="https://www.php.net/ibase-service-attach">
 <link rel="alternate" href="https://www.php.net/ibase-service-attach" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-server-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-service-detach.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-service-attach.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-service-attach.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-service-attach.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-service-attach.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-service-attach.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-service-attach.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-service-attach.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-service-attach.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-service-attach.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-service-attach.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-service-attach.php" hreflang="zh">
...
<meta name="Description" content="Connect to the service manager" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_service_attach - Manual" />
<meta name="twitter:description" content="Connect to the service manager" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_service_attach - Manual" />
<meta itemprop="description" content="Connect to the service manager" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Connect to the service manager" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-service-detach.php">
          ibase_service_detach &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-server-info.php">
          &laquo; ibase_server_info        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-service-attach.php' selected="selected">English</option>
            <option value='de/function.ibase-service-attach.php'>German</option>
            <option value='es/function.ibase-service-attach.php'>Spanish</option>
            <option value='fr/function.ibase-service-attach.php'>French</option>
            <option value='it/function.ibase-service-attach.php'>Italian</option>
            <option value='ja/function.ibase-service-attach.php'>Japanese</option>
            <option value='pt_BR/function.ibase-service-attach.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-service-attach.php'>Russian</option>
            <option value='tr/function.ibase-service-attach.php'>Turkish</option>
            <option value='uk/function.ibase-service-attach.php'>Ukrainian</option>
            <option value='zh/function.ibase-service-attach.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-service-attach" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ibase-service-attach-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_service_attach</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$host</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dba_username</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dba_password</code></span>): <span class="type"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-service-attach-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">dba_username</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">dba_password</code></dt>
     <dd>
      <p class="para">
       The user&#039;s password.
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-service-attach-returnvalues">
  ...
  <p class="para">
   Returns a Interbase / Firebird link identifier on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #FF8000">// Attach to the remote Firebird server by name. Use Port 3050.<br />    </span><span style="color: #007700">if ((</span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach</span><span style="color: #007700">(</span><span style="color: #DD0000">'FB-SRV-01.contoso.local/3050'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">)) != </span><span style="color: #0000BB">FALSE</span><span style="color: #007700">) {<br />        <br />        </span><span style="color: #FF8000">// Successfully attached. <br />        // Fetch server version (something like 'LI-V3.0.4.33054 Firebird 3.0')<br />        </span><span style="color: #0000BB">$server_version  </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_SERVER_VERSION</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// Fetch server implementation (something like 'Firebird/Linux/AMD/Intel/x64')<br />        </span><span style="color: #0000BB">$server_implementation </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_server_info</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_SVC_IMPLEMENTATION</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// Detach from server (disconnect)<br />        </span><span style="color: #0000BB">ibase_service_detach</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /><br />        </span><span style="color: #FF8000">// Output the info<br />        </span><span style="color: #007700">echo </span><span style="color: #DD0000">"Server version: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$server_version </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br/&gt;"</span><span style="color: #007700">;<br />        echo </span><span style="color: #DD0000">"Server implementation: " </span><span style="color: #007700">. </span><span style="color: #0000BB">$server_implementation</span><span style="color: #007700">;<br />    }<br />    else {<br />        </span><span style="color: #FF8000">// Output message on error<br />        </span><span style="color: #0000BB">$conn_error </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_errmsg</span><span style="color: #007700">();<br />        die(</span><span style="color: #0000BB">$conn_error</span><span style="color: #007700">);<br />    }<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-service-attach-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-service-detach.php" class="function" rel="rdfs-seeAlso">ibase_service_detach()</a> - Disconnect from the service manager</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-service-attach.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-service-attach%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-service-attach&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-service-attach.php">＋<small>add a note</small></a></span>
