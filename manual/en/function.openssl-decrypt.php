...
<head>
  ...
  <title>PHP: openssl_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-decrypt.php">
 <link rel="shorturl" href="https://www.php.net/openssl-decrypt">
 <link rel="alternate" href="https://www.php.net/openssl-decrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-csr-sign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-dh-compute-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-decrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-decrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-decrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-decrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-decrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-decrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-decrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-decrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-decrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-decrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-decrypt.php" hreflang="zh">
...
<meta name="Description" content="Decrypts data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_decrypt - Manual" />
<meta name="twitter:description" content="Decrypts data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_decrypt - Manual" />
<meta itemprop="description" content="Decrypts data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrypts data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-dh-compute-key.php">
          openssl_dh_compute_key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-csr-sign.php">
          &laquo; openssl_csr_sign        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-decrypt.php' selected="selected">English</option>
            <option value='de/function.openssl-decrypt.php'>German</option>
            <option value='es/function.openssl-decrypt.php'>Spanish</option>
            <option value='fr/function.openssl-decrypt.php'>French</option>
            <option value='it/function.openssl-decrypt.php'>Italian</option>
            <option value='ja/function.openssl-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.openssl-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-decrypt.php'>Russian</option>
            <option value='tr/function.openssl-decrypt.php'>Turkish</option>
            <option value='uk/function.openssl-decrypt.php'>Ukrainian</option>
            <option value='zh/function.openssl-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-decrypt" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-decrypt-returnvalues">
  ...
  <p class="para">
   The decrypted string on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.openssl-decrypt-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.openssl-encrypt.php" class="function" rel="rdfs-seeAlso">openssl_encrypt()</a> - Encrypts data</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-decrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119577">  <div class="votes">
    <div id="Vu119577">
    <a href="/manual/vote-note.php?id=119577&amp;page=function.openssl-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119577">
    <a href="/manual/vote-note.php?id=119577&amp;page=function.openssl-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119577" title="59% like this...">
    26
    </div>
  </div>
  <a href="#119577" class="name">
  <strong class="user"><em>Hernanibus</em></strong></a><a class="genanchor" href="#119577"> &para;</a><div class="date" title="2016-07-11 06:04"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119577">
<div class="phpcode"><code><span class="html">Parameters may seem obvius to some but not for everyone so:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="120714">  <div class="votes">
    <div id="Vu120714">
    <a href="/manual/vote-note.php?id=120714&amp;page=function.openssl-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120714">
    <a href="/manual/vote-note.php?id=120714&amp;page=function.openssl-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120714" title="54% like this...">
    3
    </div>
  </div>
  <a href="#120714" class="name">
  <strong class="user"><em>lucianonapoli at yahoo dot it</em></strong></a><a class="genanchor" href="#120714"> &para;</a><div class="date" title="2017-02-28 10:19"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120714">
<div class="phpcode"><code><span class="html">The parameter string $password must be in binary form and is derived from the exadecimal key value.<br /><br />Example:<br /><br />encrypting in command line console with openssl<br />openssl AES-256-CBC -K 5ae1b8a17bad4da4fdac796f64c16ecd -iv 34857d973953e44afb49ea9d61104d8c -in doc.txt -out doc.enc.txt<br /><br />decripting in php<br />$key = hex2bin('5ae1b8a17bad4da4fdac796f64c16ecd');<br />$iv = hex2bin('34857d973953e44afb49ea9d61104d8c');<br /><br />$output = openssl_decrypt($encstr, 'AES-256-CBC', $key, OPENSSL_RAW_DATA, $iv);</span></code></div>
  </div>
 </div>
  <div class="note" id="120987">  <div class="votes">
    <div id="Vu120987">
    <a href="/manual/vote-note.php?id=120987&amp;page=function.openssl-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120987">
    <a href="/manual/vote-note.php?id=120987&amp;page=function.openssl-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120987" title="53% like this...">
    2
    </div>
  </div>
  <a href="#120987" class="name">
  <strong class="user"><em>markagius dot co dot uk</em></strong></a><a class="genanchor" href="#120987"> &para;</a><div class="date" title="2017-04-16 09:35"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120987">
<div class="phpcode"><code><span class="html">openssl_decrypt(..) works with most but not all method types.<br />This list can vary, depending on the data (Message) and key (Password) used.<br /><br />See the following code and edit the $text and $password values.<br />Code checks if text is the same after encrypting then decrypting it.<br /><br />Note:<br />  You can still use openssl_encrypt(..) with;<br />  User enters 'Log-in password'<br />  (Encrypted and stored using openssl_encrypt)<br />  Next time.<br />  User logs-in with 'Log-in password'<br />  (Check that encrypted 'Log-in password' = stored data)<br /><br />&lt;CODE&gt;<br />  // Please edit $password=... and $text=...<br /><br />  $password = "This is a journey into sound";<br /><br />  $text = "";<br />  for($charNo=0; $charNo&lt;=255; $charNo=$charNo+1){<br />    // if($charNo==127) {$charNo=$charNo+1;}<br />    if(!$charNo&lt;127){<br />      // $text = $text."&amp;#x".strtoupper(dechex($charNo)).";";<br />      $text = $text.chr($charNo);<br />    } else {<br />      $text = $text.chr($charNo);<br />    }<br />  }<br /><br />$text = "This is a test message.";<br /><br />  print "&lt;TABLE BORDER=\"1\"&gt;\n";<br />  print "&lt;TR&gt;&lt;TD&gt;&lt;B&gt;Encryption type:&lt;/B&gt;&lt;/TD&gt;&lt;TD&gt;&lt;B&gt;String after converting back:&lt;/B&gt;&lt;/TD&gt;&lt;/TR&gt;\n";<br />  $ciphers = openssl_get_cipher_methods();<br />  for($pointer=0; $pointer&lt;count($ciphers); $pointer=$pointer+1){<br />    $edit  = EncryptDecrypt($text, true,  $password, $ciphers[$pointer]);<br />    $check = EncryptDecrypt($edit, false, $password, $ciphers[$pointer]);<br />    if($text!=$check){<br />      $info  = $check;<br />      print "&lt;TR&gt;&lt;TD&gt;".$ciphers[$pointer]."&lt;/TD&gt;&lt;TD&gt;".$info."&lt;/TD&gt;&lt;/TR&gt;\n";<br />    }<br />  }<br />  print "&lt;/TABLE&gt;\n";<br /><br />function EncryptDecrypt($oldText, $encryptIt=true, $password="PASSWORD", $encryptType=""){<br />  $ciphers = openssl_get_cipher_methods();<br />  $foundEncType = false;<br />  for($pointer=0; $pointer&lt;count($ciphers); $pointer=$pointer+1){<br />    if($ciphers[$pointer]==$encryptType){$foundEncType=true;}<br />  }<br />  if(!$foundEncType){<br />    $encryptType = "RC2-64-CBC"; // Default value used if not set or listed.<br />  }<br />  if($encryptIt){<br />    $newText = openssl_encrypt($oldText,$encryptType,$password);<br />  } else {<br />    $newText = openssl_decrypt($oldText,$encryptType,$password);<br />  }<br />  return $newText;<br />}<br />&lt;/CODE&gt;<br />The following (sometimes) don't work:<br />    DES-EDE3-CFB1    (sometimes)<br />    aes-128-gcm<br />    aes-192-gcm<br />    aes-256-gcm<br />    des-ede3-cfb1        (sometimes)<br />    id-aes128-GCM<br />    id-aes192-GCM<br />    id-aes256-GCM</span></code></div>
  </div>
 </div>
  <div class="note" id="111832">  <div class="votes">
    <div id="Vu111832">
    <a href="/manual/vote-note.php?id=111832&amp;page=function.openssl-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111832">
    <a href="/manual/vote-note.php?id=111832&amp;page=function.openssl-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111832" title="52% like this...">
    3
    </div>
  </div>
  <a href="#111832" class="name">
  <strong class="user"><em>ittasks at gmail dot com</em></strong></a><a class="genanchor" href="#111832"> &para;</a><div class="date" title="2013-04-03 12:02"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111832">
<div class="phpcode"><code><span class="html">in case that hosting do not provide openssl_encrypt decrypt functions - it could be mimiced via commad prompt executions  <br />this functions will check is if openssl is installed and try to use it by default<br /><br />function sslPrm()<br />{<br /> return array("your_password","IV (optional)","aes-128-cbc");<br />}<br />function sslEnc($msg)<br />{<br />  list ($pass, $iv, $method)=sslPrm();<br />  if(function_exists('openssl_encrypt'))<br />     return urlencode(openssl_encrypt(urlencode($msg), $method, $pass, false, $iv));<br />  else<br />     return urlencode(exec("echo \"".urlencode($msg)."\" | openssl enc -".urlencode($method)." -base64 -nosalt -K ".bin2hex($pass)." -iv ".bin2hex($iv)));<br />}<br />function sslDec($msg)<br />{<br />  list ($pass, $iv, $method)=sslPrm();<br />  if(function_exists('openssl_decrypt'))<br />     return trim(urldecode(openssl_decrypt(urldecode($msg), $method, $pass, false, $iv)));<br />  else<br />     return trim(urldecode(exec("echo \"".urldecode($msg)."\" | openssl enc -".$method." -d -base64 -nosalt -K ".bin2hex($pass)." -iv ".bin2hex($iv))));<br />}<br /><br />//example of usage:<br />$r= sslEnc("This is encryption/decryption test!");<br />echo "&lt;br&gt;\n".$r.":".sslDec($r);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-decrypt.php">＋<small>add a note</small></a></div>
