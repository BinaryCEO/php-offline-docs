...
<head>
  ...
  <title>PHP: is_subclass_of - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.is-subclass-of.php">
 <link rel="shorturl" href="https://www.php.net/is-subclass-of">
 <link rel="alternate" href="https://www.php.net/is-subclass-of" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.classobj.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.is-a.php">
 <link rel="next" href="https://www.php.net/manual/en/function.method-exists.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.is-subclass-of.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.is-subclass-of.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.is-subclass-of.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.is-subclass-of.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.is-subclass-of.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.is-subclass-of.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.is-subclass-of.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.is-subclass-of.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.is-subclass-of.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.is-subclass-of.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.is-subclass-of.php" hreflang="zh">
...
<meta name="Description" content="Checks if the object has this class as one of its parents or implements it" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: is_subclass_of - Manual" />
<meta name="twitter:description" content="Checks if the object has this class as one of its parents or implements it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: is_subclass_of - Manual" />
<meta itemprop="description" content="Checks if the object has this class as one of its parents or implements it" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if the object has this class as one of its parents or implements it" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.is-subclass-of.php' selected="selected">English</option>
            <option value='de/function.is-subclass-of.php'>German</option>
            <option value='es/function.is-subclass-of.php'>Spanish</option>
            <option value='fr/function.is-subclass-of.php'>French</option>
            <option value='it/function.is-subclass-of.php'>Italian</option>
            <option value='ja/function.is-subclass-of.php'>Japanese</option>
            <option value='pt_BR/function.is-subclass-of.php'>Brazilian Portuguese</option>
            <option value='ru/function.is-subclass-of.php'>Russian</option>
            <option value='tr/function.is-subclass-of.php'>Turkish</option>
            <option value='uk/function.is-subclass-of.php'>Ukrainian</option>
            <option value='zh/function.is-subclass-of.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.is-subclass-of" class="refentry">
...
yes, WidgetFactory_Child is a subclass of WidgetFactory</pre>
  ...
  <p class="para">
   <div class="example" id="example-5358">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.class-parents.php" class="function" rel="rdfs-seeAlso">class_parents()</a> - Return the parent classes of the given class</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/classobj/functions/is-subclass-of.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.is-subclass-of%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.is-subclass-of&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-subclass-of.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="66378">  <div class="votes">
    <div id="Vu66378">
    <a href="/manual/vote-note.php?id=66378&amp;page=function.is-subclass-of&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd66378">
    <a href="/manual/vote-note.php?id=66378&amp;page=function.is-subclass-of&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V66378" title="90% like this...">
    18
    </div>
  </div>
  <a href="#66378" class="name">
  <strong class="user"><em>gunniboyh at web dot de</em></strong></a><a class="genanchor" href="#66378"> &para;</a><div class="date" title="2006-05-20 06:16"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom66378">
<div class="phpcode"><code><span class="html">is_subclass_of() works also with classes between the class of obj and the superclass.<br /><br />example:<br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">A </span><span class="keyword">{};<br />class </span><span class="default">B </span><span class="keyword">extends </span><span class="default">A </span><span class="keyword">{};<br />class </span><span class="default">C </span><span class="keyword">extends </span><span class="default">B </span><span class="keyword">{};<br /><br /></span><span class="default">$foo</span><span class="keyword">=new </span><span class="default">C</span><span class="keyword">();<br />echo ((</span><span class="default">is_subclass_of</span><span class="keyword">(</span><span class="default">$foo</span><span class="keyword">,</span><span class="string">'A'</span><span class="keyword">)) ? </span><span class="string">'true' </span><span class="keyword">: </span><span class="string">'false'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />echoes 'true' .</span></code></div>
  </div>
 </div>
  <div class="note" id="89647">  <div class="votes">
    <div id="Vu89647">
    <a href="/manual/vote-note.php?id=89647&amp;page=function.is-subclass-of&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd89647">
    <a href="/manual/vote-note.php?id=89647&amp;page=function.is-subclass-of&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V89647" title="91% like this...">
    10
    </div>
  </div>
  <a href="#89647" class="name">
  <strong class="user"><em>nicholas at aquarionics dot com</em></strong></a><a class="genanchor" href="#89647"> &para;</a><div class="date" title="2009-03-17 01:02"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom89647">
<div class="phpcode"><code><span class="html">This might be useful to someone, so:<br /><br />If you're using Autoload, you should be aware that this will attempt to autoload $classname if it isn't already loaded. I discovered this when I had something using is_subclass_of inside an error thrown by autoload, which then recursed until it ran out of memory.</span></code></div>
  </div>
 </div>
  <div class="note" id="122864">  <div class="votes">
    <div id="Vu122864">
    <a href="/manual/vote-note.php?id=122864&amp;page=function.is-subclass-of&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd122864">
    <a href="/manual/vote-note.php?id=122864&amp;page=function.is-subclass-of&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V122864" title="100% like this...">
    2
    </div>
  </div>
  <a href="#122864" class="name">
  <strong class="user"><em>alan at jynxy.net</em></strong></a><a class="genanchor" href="#122864"> &para;</a><div class="date" title="2018-06-21 06:56"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom122864">
<div class="phpcode"><code><span class="html">The $allow_string parameter is not very clearly documented. When true, it simply allows the first parameter to be the name of a class, instead of an object whose class we are interested in.<br /><br />Some usage examples:<br /><br />class parent_class {<br />    // objects and methods ...<br />}<br /><br />$possible_child_object = new possible_child_class(); // might be an extension of parent_class<br /><br />$result = is_subclass_of($possible_child_object, 'parent_class'); //  valid<br />$result = is_subclass_of($possible_child_object, 'parent_class', false); //  valid<br />$result = is_subclass_of('possible_child_class', 'parent_class', true); // valid<br />$result = is_subclass_of('possible_child_class', 'parent_class', false); // not valid</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.is-subclass-of&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.is-subclass-of.php">＋<small>add a note</small></a></div>
