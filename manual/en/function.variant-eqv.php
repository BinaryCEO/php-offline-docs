...
<head>
  ...
  <title>PHP: variant_eqv - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-eqv.php">
 <link rel="shorturl" href="https://www.php.net/variant-eqv">
 <link rel="alternate" href="https://www.php.net/variant-eqv" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-div.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-fix.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-eqv.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-eqv.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-eqv.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-eqv.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-eqv.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-eqv.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-eqv.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-eqv.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-eqv.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-eqv.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-eqv.php" hreflang="zh">
...
<meta name="Description" content="Performs a bitwise equivalence on two variants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_eqv - Manual" />
<meta name="twitter:description" content="Performs a bitwise equivalence on two variants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_eqv - Manual" />
<meta itemprop="description" content="Performs a bitwise equivalence on two variants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs a bitwise equivalence on two variants" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-fix.php">
          variant_fix &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-eqv.php' selected="selected">English</option>
            <option value='de/function.variant-eqv.php'>German</option>
            <option value='es/function.variant-eqv.php'>Spanish</option>
            <option value='fr/function.variant-eqv.php'>French</option>
            <option value='it/function.variant-eqv.php'>Italian</option>
            <option value='ja/function.variant-eqv.php'>Japanese</option>
            <option value='pt_BR/function.variant-eqv.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-eqv.php'>Russian</option>
            <option value='tr/function.variant-eqv.php'>Turkish</option>
            <option value='uk/function.variant-eqv.php'>Ukrainian</option>
            <option value='zh/function.variant-eqv.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-eqv" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_eqv</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_eqv</span> &mdash; <span class="dc-title">Performs a bitwise equivalence on two variants</span></p>
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.variant-eqv-returnvalues">
  ...
  <p class="para">
   If each bit in <code class="parameter">left</code> is equal to the corresponding
   bit in <code class="parameter">right</code> then <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> is returned, otherwise
  ...
  <p class="para">
   Throws a <span class="classname"><a href="class.com-exception.php" class="classname">com_exception</a></span> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-eqv.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-eqv%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-eqv&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-eqv.php">＋<small>add a note</small></a></span>
