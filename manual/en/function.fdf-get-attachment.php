...
<head>
  ...
  <title>PHP: fdf_get_attachment - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-get-attachment.php">
 <link rel="shorturl" href="https://www.php.net/fdf-get-attachment">
 <link rel="alternate" href="https://www.php.net/fdf-get-attachment" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-get-ap.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-get-encoding.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-get-attachment.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-get-attachment.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-get-attachment.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-get-attachment.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-get-attachment.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-get-attachment.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-get-attachment.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-get-attachment.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-get-attachment.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-get-attachment.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-get-attachment.php" hreflang="zh">
...
<meta name="Description" content="Extracts uploaded file embedded in the FDF" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_get_attachment - Manual" />
<meta name="twitter:description" content="Extracts uploaded file embedded in the FDF" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_get_attachment - Manual" />
<meta itemprop="description" content="Extracts uploaded file embedded in the FDF" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Extracts uploaded file embedded in the FDF" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fdf-get-encoding.php">
          fdf_get_encoding &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fdf-get-ap.php">
          &laquo; fdf_get_ap        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-get-attachment.php' selected="selected">English</option>
            <option value='de/function.fdf-get-attachment.php'>German</option>
            <option value='es/function.fdf-get-attachment.php'>Spanish</option>
            <option value='fr/function.fdf-get-attachment.php'>French</option>
            <option value='it/function.fdf-get-attachment.php'>Italian</option>
            <option value='ja/function.fdf-get-attachment.php'>Japanese</option>
            <option value='pt_BR/function.fdf-get-attachment.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-get-attachment.php'>Russian</option>
            <option value='tr/function.fdf-get-attachment.php'>Turkish</option>
            <option value='uk/function.fdf-get-attachment.php'>Ukrainian</option>
            <option value='zh/function.fdf-get-attachment.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-get-attachment" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_get_attachment</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_get_attachment</span> &mdash; <span class="dc-title">Extracts uploaded file embedded in the FDF</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.fdf-get-attachment-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fdf_get_attachment</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$fdf_document</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fieldname</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$savepath</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fdf-get-attachment-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">savepath</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.fdf-get-attachment-examples">
  ...
  <p class="para">
   <div class="example" id="example-3400">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />  $fdf </span><span style="color: #007700">= </span><span style="color: #0000BB">fdf_open_string</span><span style="color: #007700">(</span><span style="color: #0000BB">$HTTP_FDF_DATA</span><span style="color: #007700">);<br />  </span><span style="color: #0000BB">$data </span><span style="color: #007700">= </span><span style="color: #0000BB">fdf_get_attachment</span><span style="color: #007700">(</span><span style="color: #0000BB">$fdf</span><span style="color: #007700">, </span><span style="color: #DD0000">"filename"</span><span style="color: #007700">, </span><span style="color: #DD0000">"/tmpdir"</span><span style="color: #007700">);<br />  echo </span><span style="color: #DD0000">"The uploaded file is stored in </span><span style="color: #0000BB">$data</span><span style="color: #007700">[</span><span style="color: #0000BB">path</span><span style="color: #007700">]</span><span style="color: #DD0000">"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-get-attachment.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-get-attachment%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-get-attachment&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-get-attachment.php">＋<small>add a note</small></a></span>
