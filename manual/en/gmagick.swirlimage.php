...
<head>
  ...
  <title>PHP: Gmagick::swirlimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.swirlimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.swirlimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.swirlimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.stripimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.thumbnailimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.swirlimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.swirlimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.swirlimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.swirlimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.swirlimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.swirlimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.swirlimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.swirlimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.swirlimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.swirlimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.swirlimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::swirlimage - Manual" />
<meta name="twitter:description" content="Swirls the pixels about the center of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::swirlimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.thumbnailimage.php">
          Gmagick::thumbnailimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.stripimage.php">
          &laquo; Gmagick::stripimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.swirlimage.php' selected="selected">English</option>
            <option value='de/gmagick.swirlimage.php'>German</option>
            <option value='es/gmagick.swirlimage.php'>Spanish</option>
            <option value='fr/gmagick.swirlimage.php'>French</option>
            <option value='it/gmagick.swirlimage.php'>Italian</option>
            <option value='ja/gmagick.swirlimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.swirlimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.swirlimage.php'>Russian</option>
            <option value='tr/gmagick.swirlimage.php'>Turkish</option>
            <option value='uk/gmagick.swirlimage.php'>Ukrainian</option>
            <option value='zh/gmagick.swirlimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.swirlimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::swirlimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::swirlimage</span> &mdash; <span class="dc-title">Swirls the pixels about the center of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.swirlimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::swirlimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$degrees</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.swirlimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.swirlimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.swirlimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/swirlimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.swirlimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.swirlimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.swirlimage.php">＋<small>add a note</small></a></span>
