...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagewidth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagewidth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagewidth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagewhitepoint.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getpackagename.php">
...
<meta name="Description" content="Returns the width of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagewidth - Manual" />
<meta name="twitter:description" content="Returns the width of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagewidth - Manual" />
<meta itemprop="description" content="Returns the width of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the width of the image" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagewidth.php' selected="selected">English</option>
            ...
            <option value='ru/gmagick.getimagewidth.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagewidth</span> &mdash; <span class="dc-title">Returns the width of the image</span></p>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagewidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagewidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagewidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagewidth.php">＋<small>add a note</small></a></span>
