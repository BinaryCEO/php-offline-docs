...
<head>
  ...
  <title>PHP: trader_apo - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-apo.php">
 <link rel="shorturl" href="https://www.php.net/trader-apo">
 <link rel="alternate" href="https://www.php.net/trader-apo" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-adxr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-aroon.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-apo.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-apo.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-apo.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-apo.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-apo.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-apo.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-apo.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-apo.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-apo.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-apo.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-apo.php" hreflang="zh">
...
<meta name="Description" content="Absolute Price Oscillator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_apo - Manual" />
<meta name="twitter:description" content="Absolute Price Oscillator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_apo - Manual" />
<meta itemprop="description" content="Absolute Price Oscillator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Absolute Price Oscillator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-aroon.php">
          trader_aroon &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-adxr.php">
          &laquo; trader_adxr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-apo.php' selected="selected">English</option>
            <option value='de/function.trader-apo.php'>German</option>
            <option value='es/function.trader-apo.php'>Spanish</option>
            <option value='fr/function.trader-apo.php'>French</option>
            <option value='it/function.trader-apo.php'>Italian</option>
            <option value='ja/function.trader-apo.php'>Japanese</option>
            <option value='pt_BR/function.trader-apo.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-apo.php'>Russian</option>
            <option value='tr/function.trader-apo.php'>Turkish</option>
            <option value='uk/function.trader-apo.php'>Ukrainian</option>
            <option value='zh/function.trader-apo.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-apo" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-apo-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_apo</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$fastPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$slowPeriod</code><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mAType</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-apo-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Type of Moving Average. <a href="trader.constants.php" class="link">TRADER_MA_TYPE_*</a> series of constants should be used.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-apo-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-apo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-apo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-apo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-apo.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125822">  <div class="votes">
    <div id="Vu125822">
    <a href="/manual/vote-note.php?id=125822&amp;page=function.trader-apo&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125822">
    <a href="/manual/vote-note.php?id=125822&amp;page=function.trader-apo&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125822" title="100% like this...">
    4
    </div>
  </div>
  <a href="#125822" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125822"> &para;</a><div class="date" title="2021-02-15 04:23"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125822">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">/*<br />APO crossing above zero is "bullish", crossing below zero is "bearish".<br />Positive values are "upward movement", Negative values are "downward movement", <br />*/<br /><br /></span><span class="default">$mATypes </span><span class="keyword">= array(</span><span class="default">TRADER_MA_TYPE_SMA</span><span class="keyword">,  </span><span class="comment">// Simple Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_EMA</span><span class="keyword">,  </span><span class="comment">// Exponential Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_WMA</span><span class="keyword">,  </span><span class="comment">// Weighted Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_DEMA</span><span class="keyword">, </span><span class="comment">// Double Exponential Moving Average <br />                 </span><span class="default">TRADER_MA_TYPE_TEMA</span><span class="keyword">, </span><span class="comment">// Triple Exponential Moving Average <br />                 </span><span class="default">TRADER_MA_TYPE_TRIMA</span><span class="keyword">,</span><span class="comment">// Triangular Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_KAMA</span><span class="keyword">, </span><span class="comment">// Kaufman's Adaptive Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_MAMA</span><span class="keyword">, </span><span class="comment">// MESA Adaptive Moving Average<br />                 </span><span class="default">TRADER_MA_TYPE_T3</span><span class="keyword">);  </span><span class="comment">// T3 Moving Average<br />                 <br /></span><span class="default">$fast_period </span><span class="keyword">= </span><span class="default">12</span><span class="keyword">;<br /></span><span class="default">$slow_period </span><span class="keyword">= </span><span class="default">30</span><span class="keyword">;<br /><br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">131.96</span><span class="keyword">, </span><span class="default">137.09</span><span class="keyword">, </span><span class="default">142.06</span><span class="keyword">, </span><span class="default">143.16</span><span class="keyword">, </span><span class="default">142.92</span><span class="keyword">, </span><span class="default">139.07</span><span class="keyword">, </span><span class="default">136.87</span><span class="keyword">, </span><span class="default">132.03</span><span class="keyword">, </span><span class="default">127.83</span><span class="keyword">, </span><span class="default">127.14</span><span class="keyword">, </span><span class="default">128.91</span><span class="keyword">, </span><span class="default">130.89</span><span class="keyword">, </span><span class="default">128.8</span><span class="keyword">, </span><span class="default">128.98</span><span class="keyword">, </span><span class="default">132.05</span><span class="keyword">, </span><span class="default">130.92</span><span class="keyword">, </span><span class="default">126.6</span><span class="keyword">, </span><span class="default">131.01</span><span class="keyword">, </span><span class="default">129.41</span><span class="keyword">, </span><span class="default">132.69</span><span class="keyword">, </span><span class="default">133.72</span><span class="keyword">, </span><span class="default">134.87</span><span class="keyword">, </span><span class="default">136.69</span><span class="keyword">, </span><span class="default">131.97</span><span class="keyword">, </span><span class="default">130.96</span><span class="keyword">, </span><span class="default">131.88</span><span class="keyword">, </span><span class="default">128.23</span><span class="keyword">, </span><span class="default">126.655</span><span class="keyword">, </span><span class="default">128.7</span><span class="keyword">, </span><span class="default">127.81</span><span class="keyword">, </span><span class="default">127.88</span><span class="keyword">, </span><span class="default">121.78</span><span class="keyword">, </span><span class="default">122.41</span><span class="keyword">, </span><span class="default">123.24</span><span class="keyword">, </span><span class="default">121.78</span><span class="keyword">, </span><span class="default">124.38</span><span class="keyword">, </span><span class="default">123.75</span><span class="keyword">, </span><span class="default">122.25</span><span class="keyword">, </span><span class="default">122.94</span><span class="keyword">, </span><span class="default">123.08</span><span class="keyword">, </span><span class="default">122.72</span><span class="keyword">, </span><span class="default">119.05</span><span class="keyword">, </span><span class="default">116.59</span><span class="keyword">, </span><span class="default">116.03</span><span class="keyword">, </span><span class="default">115.17</span><span class="keyword">, </span><span class="default">113.85</span><span class="keyword">, </span><span class="default">117.34</span><span class="keyword">, </span><span class="default">118.64</span><span class="keyword">, </span><span class="default">118.03</span><span class="keyword">, </span><span class="default">119.39</span><span class="keyword">, </span><span class="default">120.3</span><span class="keyword">, </span><span class="default">119.26</span><span class="keyword">, </span><span class="default">119.21</span><span class="keyword">, </span><span class="default">119.49</span><span class="keyword">, </span><span class="default">115.97</span><span class="keyword">, </span><span class="default">116.32</span><span class="keyword">, </span><span class="default">118.69</span><span class="keyword">, </span><span class="default">119.03</span><span class="keyword">, </span><span class="default">114.95</span><span class="keyword">, </span><span class="default">110.44</span><span class="keyword">, </span><span class="default">108.77</span><span class="keyword">, </span><span class="default">108.86</span><span class="keyword">, </span><span class="default">115.32</span><span class="keyword">, </span><span class="default">111.2</span><span class="keyword">, </span><span class="default">116.6</span><span class="keyword">, </span><span class="default">115.05</span><span class="keyword">, </span><span class="default">115.04</span><span class="keyword">, </span><span class="default">115.75</span><span class="keyword">, </span><span class="default">116.87</span><span class="keyword">, </span><span class="default">117.51</span><span class="keyword">, </span><span class="default">115.98</span><span class="keyword">, </span><span class="default">119.02</span><span class="keyword">, </span><span class="default">120.71</span><span class="keyword">, </span><span class="default">121.19</span><span class="keyword">, </span><span class="default">121.1</span><span class="keyword">, </span><span class="default">124.4</span><span class="keyword">, </span><span class="default">116.97</span><span class="keyword">, </span><span class="default">114.97</span><span class="keyword">, </span><span class="default">115.08</span><span class="keyword">, </span><span class="default">113.16</span><span class="keyword">, </span><span class="default">116.5</span><span class="keyword">, </span><span class="default">113.02</span><span class="keyword">, </span><span class="default">116.79</span><span class="keyword">, </span><span class="default">115.81</span><span class="keyword">, </span><span class="default">114.09</span><span class="keyword">, </span><span class="default">114.96</span><span class="keyword">, </span><span class="default">112.28</span><span class="keyword">, </span><span class="default">108.22</span><span class="keyword">, </span><span class="default">107.12</span><span class="keyword">, </span><span class="default">111.81</span><span class="keyword">, </span><span class="default">110.08</span><span class="keyword">, </span><span class="default">106.84</span><span class="keyword">, </span><span class="default">110.34</span><span class="keyword">, </span><span class="default">112.13</span><span class="keyword">, </span><span class="default">115.54</span><span class="keyword">, </span><span class="default">115.355</span><span class="keyword">, </span><span class="default">112</span><span class="keyword">, </span><span class="default">113.49</span><span class="keyword">, </span><span class="default">117.32</span><span class="keyword">, </span><span class="default">112.82</span><span class="keyword">);<br /><br /></span><span class="default">$Absolute_Price_Oscillators </span><span class="keyword">= array();<br /><br />foreach(</span><span class="default">$mATypes </span><span class="keyword">as </span><span class="default">$mA</span><span class="keyword">){<br />    <br />    </span><span class="default">$key </span><span class="keyword">= </span><span class="string">'sma'</span><span class="keyword">;<br />    if(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_EMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'ema'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_WMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'wma'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_DEMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'dema'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_TEMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'tema'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_TRIMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'trima'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_KAMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'kama'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_MAMA</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'mama'</span><span class="keyword">;}<br />    elseif(</span><span class="default">$mA </span><span class="keyword">== </span><span class="default">TRADER_MA_TYPE_T3</span><span class="keyword">){</span><span class="default">$key </span><span class="keyword">= </span><span class="string">'t3'</span><span class="keyword">;}<br />    <br />    </span><span class="default">$Absolute_Price_Oscillators</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">trader_apo </span><span class="keyword">(</span><span class="default">$closes</span><span class="keyword">, </span><span class="default">$fast_period</span><span class="keyword">, </span><span class="default">$slow_period</span><span class="keyword">, </span><span class="default">$mA</span><span class="keyword">);<br />}<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$Absolute_Price_Oscillators</span><span class="keyword">[</span><span class="string">'sma'</span><span class="keyword">]);<br /></span><span class="comment">/*<br />array(71) {<br />  [29]=&gt;<br />  float(-1.264)<br />  [30]=&gt;<br />  float(-1.255)<br />  [31]=&gt;<br />  float(-1.654)<br />  [32]=&gt;<br />  float(-1.942)<br />  [33]=&gt;<br />  float(-2.247)<br />  [34]=&gt;<br />  float(-2.785)<br />  [35]=&gt;<br />  float(-2.927)<br />  [36]=&gt;<br />  float(-3.091)<br />  [37]=&gt;<br />  float(-3.567)<br />  [38]=&gt;<br />  float(-3.845)<br />  [39]=&gt;<br />  float(-4.008)<br />  [40]=&gt;<br />  float(-4.3)<br />  [41]=&gt;<br />  float(-4.635)<br />  [42]=&gt;<br />  float(-5.169)<br />  [43]=&gt;<br />  float(-5.217)<br />  [44]=&gt;<br />  float(-5.257)<br />  [45]=&gt;<br />  float(-5.471)<br />  [46]=&gt;<br />  float(-5.532)<br />  [47]=&gt;<br />  float(-5.598)<br />  [48]=&gt;<br />  float(-5.695)<br />  [49]=&gt;<br />  float(-5.49)<br />  [50]=&gt;<br />  float(-5.263)<br />  [51]=&gt;<br />  float(-5.061)<br />  [52]=&gt;<br />  float(-4.771)<br />  [53]=&gt;<br />  float(-4.318)<br />  [54]=&gt;<br />  float(-3.87)<br />  [55]=&gt;<br />  float(-3.327)<br />  [56]=&gt;<br />  float(-2.716)<br />  [57]=&gt;<br />  float(-2.03)<br />  [58]=&gt;<br />  float(-1.771)<br />  [59]=&gt;<br />  float(-1.875)<br />  [60]=&gt;<br />  float(-2.01)<br />  [61]=&gt;<br />  float(-2.457)<br />  [62]=&gt;<br />  float(-2.636)<br />  [63]=&gt;<br />  float(-2.906)<br />  [64]=&gt;<br />  float(-2.951)<br />  [65]=&gt;<br />  float(-3.01)<br />  [66]=&gt;<br />  float(-2.797)<br />  [67]=&gt;<br />  float(-2.628)<br />  [68]=&gt;<br />  float(-2.577)<br />  [69]=&gt;<br />  float(-2.518)<br />  [70]=&gt;<br />  float(-2.208)<br />  [71]=&gt;<br />  float(-1.492)<br />  [72]=&gt;<br />  float(-0.634)<br />  [73]=&gt;<br />  float(0.222)<br />  [74]=&gt;<br />  float(0.506)<br />  [75]=&gt;<br />  float(1.254)<br />  [76]=&gt;<br />  float(1.297)<br />  [77]=&gt;<br />  float(1.413)<br />  [78]=&gt;<br />  float(1.515)<br />  [79]=&gt;<br />  float(1.506)<br />  [80]=&gt;<br />  float(1.602)<br />  [81]=&gt;<br />  float(1.436)<br />  [82]=&gt;<br />  float(1.584)<br />  [83]=&gt;<br />  float(1.439)<br />  [84]=&gt;<br />  float(0.95)<br />  [85]=&gt;<br />  float(0.477)<br />  [86]=&gt;<br />  float(-0.045)<br />  [87]=&gt;<br />  float(-1.033)<br />  [88]=&gt;<br />  float(-1.593)<br />  [89]=&gt;<br />  float(-1.902)<br />  [90]=&gt;<br />  float(-2.362)<br />  [91]=&gt;<br />  float(-2.821)<br />  [92]=&gt;<br />  float(-3.169)<br />  [93]=&gt;<br />  float(-3.274)<br />  [94]=&gt;<br />  float(-3.343)<br />  [95]=&gt;<br />  float(-3.391)<br />  [96]=&gt;<br />  float(-3.464)<br />  [97]=&gt;<br />  float(-3.511)<br />  [98]=&gt;<br />  float(-3.106)<br />  [99]=&gt;<br />  float(-2.566)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-apo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-apo.php">＋<small>add a note</small></a></div>
