...
<head>
  ...
  <title>PHP: SolrQuery::getTermsUpperBound - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gettermsupperbound.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gettermsupperbound.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsupperbound.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gettermssort.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettimeallowed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gettermsupperbound.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gettermsupperbound.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gettermsupperbound.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gettermsupperbound.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gettermsupperbound.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gettermsupperbound.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gettermsupperbound.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gettermsupperbound.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gettermsupperbound.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gettermsupperbound.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gettermsupperbound.php" hreflang="zh">
...
<meta name="Description" content="Returns the term to stop at" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTermsUpperBound - Manual" />
<meta name="twitter:description" content="Returns the term to stop at" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTermsUpperBound - Manual" />
<meta itemprop="description" content="Returns the term to stop at" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the term to stop at" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gettimeallowed.php">
          SolrQuery::getTimeAllowed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gettermssort.php">
          &laquo; SolrQuery::getTermsSort        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gettermsupperbound.php' selected="selected">English</option>
            <option value='de/solrquery.gettermsupperbound.php'>German</option>
            <option value='es/solrquery.gettermsupperbound.php'>Spanish</option>
            <option value='fr/solrquery.gettermsupperbound.php'>French</option>
            <option value='it/solrquery.gettermsupperbound.php'>Italian</option>
            <option value='ja/solrquery.gettermsupperbound.php'>Japanese</option>
            <option value='pt_BR/solrquery.gettermsupperbound.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gettermsupperbound.php'>Russian</option>
            <option value='tr/solrquery.gettermsupperbound.php'>Turkish</option>
            <option value='uk/solrquery.gettermsupperbound.php'>Ukrainian</option>
            <option value='zh/solrquery.gettermsupperbound.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gettermsupperbound" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTermsUpperBound</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTermsUpperBound</span> &mdash; <span class="dc-title">Returns the term to stop at</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gettermsupperbound-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTermsUpperBound</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gettermsupperbound-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gettermsupperbound-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gettermsupperbound.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gettermsupperbound%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gettermsupperbound&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gettermsupperbound.php">＋<small>add a note</small></a></span>
