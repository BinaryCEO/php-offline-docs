...
<head>
  ...
  <title>PHP: Imagick::getImageMatte - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagematte.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagematte.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagematte.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagelength.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagemattecolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagematte.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagematte.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagematte.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagematte.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagematte.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagematte.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagematte.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagematte.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagematte.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagematte.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagematte.php" hreflang="zh">
...
<meta name="Description" content="Return if the image has a matte channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageMatte - Manual" />
<meta name="twitter:description" content="Return if the image has a matte channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageMatte - Manual" />
<meta itemprop="description" content="Return if the image has a matte channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return if the image has a matte channel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagemattecolor.php">
          Imagick::getImageMatteColor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagelength.php">
          &laquo; Imagick::getImageLength        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagematte.php' selected="selected">English</option>
            <option value='de/imagick.getimagematte.php'>German</option>
            <option value='es/imagick.getimagematte.php'>Spanish</option>
            <option value='fr/imagick.getimagematte.php'>French</option>
            <option value='it/imagick.getimagematte.php'>Italian</option>
            <option value='ja/imagick.getimagematte.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagematte.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagematte.php'>Russian</option>
            <option value='tr/imagick.getimagematte.php'>Turkish</option>
            <option value='uk/imagick.getimagematte.php'>Ukrainian</option>
            <option value='zh/imagick.getimagematte.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagematte" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageMatte</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageMatte</span> &mdash; <span class="dc-title">Return if the image has a matte channel</span></p>

 </div>

 <div id="imagick.getimagematte-refsynopsisdiv">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagematte-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageMatte</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>


  <p class="para rdfs-comment">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the image has a matte channel otherwise false.
   This method is available if Imagick has been compiled against ImageMagick version 6.2.9 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.getimagematte-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagematte-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagematte.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagematte%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagematte&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagematte.php">＋<small>add a note</small></a></span>
