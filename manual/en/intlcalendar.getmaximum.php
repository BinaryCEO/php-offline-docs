...
<head>
  ...
  <title>PHP: IntlCalendar::getMaximum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getmaximum.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getmaximum.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getmaximum.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.getlocale.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getminimaldaysinfirstweek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getmaximum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.getmaximum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.getmaximum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.getmaximum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.getmaximum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.getmaximum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.getmaximum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.getmaximum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.getmaximum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.getmaximum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.getmaximum.php" hreflang="zh">
...
<meta name="Description" content="Get the global maximum value for a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getMaximum - Manual" />
<meta name="twitter:description" content="Get the global maximum value for a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getMaximum - Manual" />
<meta itemprop="description" content="Get the global maximum value for a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the global maximum value for a field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.getminimaldaysinfirstweek.php">
          IntlCalendar::getMinimalDaysInFirstWeek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlcalendar.getlocale.php">
          &laquo; IntlCalendar::getLocale        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getmaximum.php' selected="selected">English</option>
            <option value='de/intlcalendar.getmaximum.php'>German</option>
            <option value='es/intlcalendar.getmaximum.php'>Spanish</option>
            <option value='fr/intlcalendar.getmaximum.php'>French</option>
            <option value='it/intlcalendar.getmaximum.php'>Italian</option>
            <option value='ja/intlcalendar.getmaximum.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.getmaximum.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.getmaximum.php'>Russian</option>
            <option value='tr/intlcalendar.getmaximum.php'>Turkish</option>
            <option value='uk/intlcalendar.getmaximum.php'>Ukrainian</option>
            <option value='zh/intlcalendar.getmaximum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.getmaximum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::getMaximum</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::getMaximum</span> &mdash; <span class="dc-title">Get the global maximum value for a field</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlcalendar.getmaximum-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::getMaximum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_get_maximum</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Gets the global maximum for a field, in this specific calendar. This value
   is larger or equal to that returned by
   <span class="function"><a href="intlcalendar.getactualmaximum.php" class="function">IntlCalendar::getActualMaximum()</a></span>, which is in its turn
   larger or equal to that returned by
   <span class="function"><a href="intlcalendar.getleastmaximum.php" class="function">IntlCalendar::getLeastMaximum()</a></span>.
  </p>
 </div>
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getmaximum-returnvalues">
  ...
  <p class="para">
   ...
   unit or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="intlcalendar.getminimum.php" class="methodname" rel="rdfs-seeAlso">IntlCalendar::getMinimum()</a> - Get the global minimum value for a field</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getmaximum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getmaximum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getmaximum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getmaximum.php">＋<small>add a note</small></a></span>
