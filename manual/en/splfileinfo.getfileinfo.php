...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/splfileinfo.getfileinfo.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/splfileinfo.getfileinfo.php">
 <link rel="alternate" href="https://www.php.net/manual/en/splfileinfo.getfileinfo.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.splfileinfo.php">
 <link rel="prev" href="https://www.php.net/manual/en/splfileinfo.getextension.php">
 <link rel="next" href="https://www.php.net/manual/en/splfileinfo.getfilename.php">
...
<meta name="Description" content="Gets an SplFileInfo object for the file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SplFileInfo::getFileInfo - Manual" />
<meta name="twitter:description" content="Gets an SplFileInfo object for the file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SplFileInfo::getFileInfo - Manual" />
<meta itemprop="description" content="Gets an SplFileInfo object for the file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets an SplFileInfo object for the file" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/splfileinfo.getfileinfo.php' selected="selected">English</option>
            ...
            <option value='pt_BR/splfileinfo.getfileinfo.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.2, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">SplFileInfo::getFileInfo</span> &mdash; <span class="dc-title">Gets an SplFileInfo object for the file</span></p>
 ...
 <div class="refsect1 description" id="refsect1-splfileinfo.getfileinfo-description">
  ...
  <p class="para rdfs-comment">
   This method gets an <span class="classname"><a href="class.splfileinfo.php" class="classname">SplFileInfo</a></span> object for the referenced file.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-splfileinfo.getfileinfo-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       Name of an <span class="classname"><a href="class.splfileinfo.php" class="classname">SplFileInfo</a></span> derived class to use. 
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-splfileinfo.getfileinfo-returnvalues">
  ...
  <p class="para">
   An <span class="classname"><a href="class.splfileinfo.php" class="classname">SplFileInfo</a></span> object created for the file.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="splfileinfo.setinfoclass.php" class="methodname" rel="rdfs-seeAlso">SplFileInfo::setInfoClass()</a> - Sets the class used with SplFileInfo::getFileInfo and SplFileInfo::getPathInfo</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/splfileinfo/getfileinfo.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsplfileinfo.getfileinfo%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=splfileinfo.getfileinfo&amp;repo=en&amp;redirect=https://www.php.net/manual/en/splfileinfo.getfileinfo.php">＋<small>add a note</small></a></span>
