...
<div id="layout" class="clearfix">
 ...
 <div class="head">
  ...
  <strong class="user"><em>tim at leethost dot com</em></strong></a><a class="genanchor" href="#107089"> &para;</a><div class="date" title="2012-01-05 03:50"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom107089">
<div class="phpcode"><code><span class="html">I was having a problem clearing all session variables, deleting the session, and creating a new session without leaving old session stuff behind in all browsers.  The below code is perfect for a logout script to totally delete everything and start new.  It even works in Chrome which seems to not work as other browsers when trying do logout and start a new session.<br /><br /><span class="default">&lt;?php<br />    session_start</span><span class="keyword">();<br />    </span><span class="default">session_unset</span><span class="keyword">();<br />    </span><span class="default">session_destroy</span><span class="keyword">();<br />    </span><span class="default">session_write_close</span><span class="keyword">();<br />    </span><span class="default">setcookie</span><span class="keyword">(</span><span class="default">session_name</span><span class="keyword">(),</span><span class="string">''</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="string">'/'</span><span class="keyword">);<br />    </span><span class="default">session_regenerate_id</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>jerry</em></strong></a><a class="genanchor" href="#118222"> &para;</a><div class="date" title="2015-10-29 12:37"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118222">
<div class="phpcode"><code><span class="html">The difference between both session_unset and session_destroy is as follows:<br /><br />session_unset just clears out the session for usage. The session is still on the users computer. Note that by using session_unset, the variable still exists. session_unset just remove all session variables. it does not destroy the session....so the session would still be active.<br /><br />Using session_unset in tandem with session_destroy however, is a much more effective means of actually clearing out data. As stated in the example above, this works very well, cross browser. session_destroy is destroy the session. session_destroy() to kill all session information.....This is the more secure function to use.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The solution provided by tim at leethost dot com is nice but you must check a active session first, because else you fill the logs with PHP Errors or Notices depending on your settings. I use it as a function, and it works smooth. <br /><br />```php<br />    /** @return void  */<br />    public static function sayonara():void<br />    {<br />        if (session_status() !== PHP_SESSION_ACTIVE) :void<br />        {<br />            session_start();<br />            session_unset();<br />            session_destroy();<br />            session_write_close();<br />            setcookie(session_name(), '', 0, '/');<br />            session_regenerate_id(true);<br />        }        <br />    }<br /><br />    sayonara();<br />```</span></code></div>
  </div>
 </div></div>
