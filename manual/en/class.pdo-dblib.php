...
<head>
  ...
  <title>PHP: Pdo\Dblib - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.pdo-dblib.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.pdo-dblib.connection.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.pdo-firebird.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.pdo-dblib.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.pdo-dblib.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.pdo-dblib.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.pdo-dblib.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.pdo-dblib.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.pdo-dblib.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.pdo-dblib.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.pdo-dblib.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.pdo-dblib.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.pdo-dblib.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.pdo-dblib.php" hreflang="zh">
...
<meta name="Description" content="The Pdo\Dblib class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Pdo\Dblib - Manual" />
<meta name="twitter:description" content="The Pdo\Dblib class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Pdo\Dblib - Manual" />
<meta itemprop="description" content="The Pdo\Dblib class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Pdo\Dblib class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ref.pdo-firebird.php">
          Firebird PDO Driver &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.pdo-dblib.connection.php">
          &laquo; PDO_DBLIB DSN        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.pdo-dblib.php' selected="selected">English</option>
            <option value='de/class.pdo-dblib.php'>German</option>
            <option value='es/class.pdo-dblib.php'>Spanish</option>
            <option value='fr/class.pdo-dblib.php'>French</option>
            <option value='it/class.pdo-dblib.php'>Italian</option>
            <option value='ja/class.pdo-dblib.php'>Japanese</option>
            <option value='pt_BR/class.pdo-dblib.php'>Brazilian Portuguese</option>
            <option value='ru/class.pdo-dblib.php'>Russian</option>
            <option value='tr/class.pdo-dblib.php'>Turkish</option>
            <option value='uk/class.pdo-dblib.php'>Ukrainian</option>
            <option value='zh/class.pdo-dblib.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.pdo-dblib" class="reference">
 <h1 class="title">The Pdo\Dblib class</h1>
 ...
 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>
  ...
  <div class="section" id="pdo-dblib.synopsis">
   <h2 class="title">Class synopsis</h2>
   
   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Pdo\Dblib</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-connection-timeout"><var class="varname">ATTR_CONNECTION_TIMEOUT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-query-timeout"><var class="varname">ATTR_QUERY_TIMEOUT</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-stringify-uniqueidentifier"><var class="varname">ATTR_STRINGIFY_UNIQUEIDENTIFIER</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-version"><var class="varname">ATTR_VERSION</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-tds-version"><var class="varname">ATTR_TDS_VERSION</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-skip-empty-rowsets"><var class="varname">ATTR_SKIP_EMPTY_ROWSETS</var></a></var>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-datetime-convert"><var class="varname">ATTR_DATETIME_CONVERT</var></a></var>;</div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="pdo.setattribute.php" class="methodname">PDO::setAttribute</a></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$attribute</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="pdo-dblib.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>
    
     <dt id="pdo-dblib.constants.attr-connection-timeout"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-connection-timeout">Pdo\Dblib::ATTR_CONNECTION_TIMEOUT</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-query-timeout"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-query-timeout">Pdo\Dblib::ATTR_QUERY_TIMEOUT</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-stringify-uniqueidentifier"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-stringify-uniqueidentifier">Pdo\Dblib::ATTR_STRINGIFY_UNIQUEIDENTIFIER</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-version"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-version">Pdo\Dblib::ATTR_VERSION</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-tds-version"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-tds-version">Pdo\Dblib::ATTR_TDS_VERSION</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-skip-empty-rowsets"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-skip-empty-rowsets">Pdo\Dblib::ATTR_SKIP_EMPTY_ROWSETS</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
     ...
     <dt id="pdo-dblib.constants.attr-datetime-convert"><strong><code><a href="class.pdo-dblib.php#pdo-dblib.constants.attr-datetime-convert">Pdo\Dblib::ATTR_DATETIME_CONVERT</a></code></strong></dt>
     <dd>
      <span class="simpara">
      </span>
     </dd>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pdo_dblib/pdo-dblib.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.pdo-dblib%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.pdo-dblib&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.pdo-dblib.php">＋<small>add a note</small></a></span>
