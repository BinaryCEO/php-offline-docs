...
<head>
  ...
  <title>PHP: ReflectionProperty::skipLazyInitialization - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.skiplazyinitialization.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.skiplazyinitialization.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.skiplazyinitialization.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.setvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.tostring.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.skiplazyinitialization.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.skiplazyinitialization.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.skiplazyinitialization.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.skiplazyinitialization.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.skiplazyinitialization.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.skiplazyinitialization.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.skiplazyinitialization.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.skiplazyinitialization.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.skiplazyinitialization.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.skiplazyinitialization.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.skiplazyinitialization.php" hreflang="zh">
...
<meta name="Description" content="Marks property as non-lazy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::skipLazyInitialization - Manual" />
<meta name="twitter:description" content="Marks property as non-lazy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::skipLazyInitialization - Manual" />
<meta itemprop="description" content="Marks property as non-lazy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Marks property as non-lazy" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.tostring.php">
          ReflectionProperty::__toString &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.setvalue.php">
          &laquo; ReflectionProperty::setValue        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.skiplazyinitialization.php' selected="selected">English</option>
            <option value='de/reflectionproperty.skiplazyinitialization.php'>German</option>
            <option value='es/reflectionproperty.skiplazyinitialization.php'>Spanish</option>
            <option value='fr/reflectionproperty.skiplazyinitialization.php'>French</option>
            <option value='it/reflectionproperty.skiplazyinitialization.php'>Italian</option>
            <option value='ja/reflectionproperty.skiplazyinitialization.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.skiplazyinitialization.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.skiplazyinitialization.php'>Russian</option>
            <option value='tr/reflectionproperty.skiplazyinitialization.php'>Turkish</option>
            <option value='uk/reflectionproperty.skiplazyinitialization.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.skiplazyinitialization.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.skiplazyinitialization" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionclass.newlazyghost.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::newLazyGhost()</a> - Creates a new lazy ghost instance</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/skiplazyinitialization.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.skiplazyinitialization%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.skiplazyinitialization&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.skiplazyinitialization.php">＋<small>add a note</small></a></span>
