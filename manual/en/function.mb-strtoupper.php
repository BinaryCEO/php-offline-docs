...
<head>
  ...
  <title>PHP: mb_strtoupper - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-strtoupper.php">
 <link rel="shorturl" href="https://www.php.net/mb-strtoupper">
 <link rel="alternate" href="https://www.php.net/mb-strtoupper" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-strtolower.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-strwidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-strtoupper.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-strtoupper.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-strtoupper.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-strtoupper.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-strtoupper.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-strtoupper.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-strtoupper.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-strtoupper.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-strtoupper.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-strtoupper.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-strtoupper.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mb_strtoupper - Manual" />
<meta name="twitter:description" content="Make a string uppercase" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_strtoupper - Manual" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-strwidth.php">
          mb_strwidth &raquo;
              ...
              <div class="prev">
        <a href="function.mb-strtolower.php">
          &laquo; mb_strtolower        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-strtoupper.php' selected="selected">English</option>
            <option value='de/function.mb-strtoupper.php'>German</option>
            <option value='es/function.mb-strtoupper.php'>Spanish</option>
            <option value='fr/function.mb-strtoupper.php'>French</option>
            <option value='it/function.mb-strtoupper.php'>Italian</option>
            <option value='ja/function.mb-strtoupper.php'>Japanese</option>
            <option value='pt_BR/function.mb-strtoupper.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-strtoupper.php'>Russian</option>
            <option value='tr/function.mb-strtoupper.php'>Turkish</option>
            <option value='uk/function.mb-strtoupper.php'>Ukrainian</option>
            <option value='zh/function.mb-strtoupper.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-strtoupper" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_strtoupper</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_strtoupper</span> &mdash; <span class="dc-title">Make a string uppercase</span></p>

 </div>
   
 <div class="refsect1 description" id="refsect1-function.mb-strtoupper-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mb_strtoupper</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$encoding</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-strtoupper-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The <span class="type"><a href="language.types.string.php" class="type string">string</a></span> being uppercased.
      </p>
     </dd>
...
encoding value will be used.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-strtoupper-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <code class="parameter">string</code> with all alphabetic characters converted to uppercase.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.mb-strtoupper-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2790">
    <p><strong>Example #1 <span class="function"><strong>mb_strtoupper()</strong></span> example</strong></p>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$str </span><span style="color: #007700">= </span><span style="color: #DD0000">"Mary Had A Little Lamb and She LOVED It So"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$str </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_strtoupper</span><span style="color: #007700">(</span><span style="color: #0000BB">$str</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$str</span><span style="color: #007700">; </span><span style="color: #FF8000">// Prints MARY HAD A LITTLE LAMB AND SHE LOVED IT SO<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <p class="para">
   <div class="example" id="example-2791">
    <p><strong>Example #2 <span class="function"><strong>mb_strtoupper()</strong></span> example with non-Latin UTF-8 text</strong></p>
    <div class="example-contents">
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$str </span><span style="color: #007700">= </span><span style="color: #DD0000">"Τάχιστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$str </span><span style="color: #007700">= </span><span style="color: #0000BB">mb_strtoupper</span><span style="color: #007700">(</span><span style="color: #0000BB">$str</span><span style="color: #007700">, </span><span style="color: #DD0000">'UTF-8'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$str</span><span style="color: #007700">; </span><span style="color: #FF8000">// Prints ΤΆΧΙΣΤΗ ΑΛΏΠΗΞ ΒΑΦΉΣ ΨΗΜΈΝΗ ΓΗ, ΔΡΑΣΚΕΛΊΖΕΙ ΥΠΈΡ ΝΩΘΡΟΎ ΚΥΝΌΣ<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.mb-strtoupper-notes">
  <h3 class="title">Notes</h3>
  <p class="para">
   By contrast to <span class="function"><a href="function.strtoupper.php" class="function">strtoupper()</a></span>, &#039;alphabetic&#039; is
 ...
 <div class="refsect1 seealso" id="refsect1-function.mb-strtoupper-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strtoupper.php" class="function" rel="rdfs-seeAlso">strtoupper()</a> - Make a string uppercase</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-strtoupper.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-strtoupper%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-strtoupper&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strtoupper.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124253">  <div class="votes">
    <div id="Vu124253">
    <a href="/manual/vote-note.php?id=124253&amp;page=function.mb-strtoupper&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124253">
    <a href="/manual/vote-note.php?id=124253&amp;page=function.mb-strtoupper&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124253" title="56% like this...">
    6
    </div>
  </div>
  <a href="#124253" class="name">
  <strong class="user"><em>serg_x</em></strong></a><a class="genanchor" href="#124253"> &para;</a><div class="date" title="2019-09-30 04:28"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124253">
<div class="phpcode"><code><span class="html">Only first letter<br /><br />function mb_ucfirst($string, $encoding = 'UTF-8'){<br />  $strlen = mb_strlen($string, $encoding);<br />  $firstChar = mb_substr($string, 0, 1, $encoding);<br />  $then = mb_substr($string, 1, $strlen - 1, $encoding);<br />  return mb_strtoupper($firstChar, $encoding) . $then;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-strtoupper&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-strtoupper.php">＋<small>add a note</small></a></div>
