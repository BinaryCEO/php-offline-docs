...
<head>
  ...
  <title>PHP: Imagick::getCompressionQuality - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getcompressionquality.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getcompressionquality.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcompressionquality.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getcompression.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getcopyright.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getcompressionquality.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getcompressionquality.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getcompressionquality.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getcompressionquality.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getcompressionquality.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getcompressionquality.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getcompressionquality.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getcompressionquality.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getcompressionquality.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getcompressionquality.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getcompressionquality.php" hreflang="zh">
...
<meta name="Description" content="Gets the object compression quality" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getCompressionQuality - Manual" />
<meta name="twitter:description" content="Gets the object compression quality" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getCompressionQuality - Manual" />
<meta itemprop="description" content="Gets the object compression quality" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the object compression quality" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getcopyright.php">
          Imagick::getCopyright &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getcompression.php">
          &laquo; Imagick::getCompression        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getcompressionquality.php' selected="selected">English</option>
            <option value='de/imagick.getcompressionquality.php'>German</option>
            <option value='es/imagick.getcompressionquality.php'>Spanish</option>
            <option value='fr/imagick.getcompressionquality.php'>French</option>
            <option value='it/imagick.getcompressionquality.php'>Italian</option>
            <option value='ja/imagick.getcompressionquality.php'>Japanese</option>
            <option value='pt_BR/imagick.getcompressionquality.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getcompressionquality.php'>Russian</option>
            <option value='tr/imagick.getcompressionquality.php'>Turkish</option>
            <option value='uk/imagick.getcompressionquality.php'>Ukrainian</option>
            <option value='zh/imagick.getcompressionquality.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getcompressionquality" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getCompressionQuality</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getCompressionQuality</span> &mdash; <span class="dc-title">Gets the object compression quality</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getcompressionquality-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getCompressionQuality</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getcompressionquality-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getcompressionquality-returnvalues">
  ...
  <p class="para">
   Returns integer describing the compression quality
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getcompressionquality.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getcompressionquality%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getcompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getcompressionquality.php">＋<small>add a note</small></a></span>
