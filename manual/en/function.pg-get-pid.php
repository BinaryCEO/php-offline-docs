...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-get-pid.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-get-notify.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-get-result.php">
...
<meta name="Description" content="Gets the backend's process ID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_get_pid - Manual" />
<meta name="twitter:description" content="Gets the backend's process ID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_get_pid - Manual" />
<meta itemprop="description" content="Gets the backend's process ID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the backend's process ID" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-get-pid.php' selected="selected">English</option>
            ...
            <option value='ru/function.pg-get-pid.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_get_pid</span> &mdash; <span class="dc-title">Gets the backend&#039;s process ID</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-get-pid-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>pg_get_pid()</strong></span> gets the backend&#039;s (database server
   process) PID. The PID is useful to determine whether or not a <code class="literal">NOTIFY</code>
   message received via <span class="function"><a href="function.pg-get-notify.php" class="function">pg_get_notify()</a></span> is sent from another process
   or not.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-get-pid-examples">
  ...
  <p class="para">
   <div class="example" id="example-2074">
    <p><strong>Example #1 PostgreSQL backend PID</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php <br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"An error occurred.\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #FF8000">// Backend process PID. Use PID with pg_get_notify()<br /></span><span style="color: #0000BB">$pid </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_get_pid</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-get-pid-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-get-notify.php" class="function" rel="rdfs-seeAlso">pg_get_notify()</a> - Gets SQL NOTIFY message</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-get-pid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-get-pid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-get-pid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-get-pid.php">＋<small>add a note</small></a></span>
