...
<head>
  ...
  <title>PHP: stats_kurtosis - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-kurtosis.php">
 <link rel="shorturl" href="https://www.php.net/stats-kurtosis">
 <link rel="alternate" href="https://www.php.net/stats-kurtosis" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-harmonic-mean.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-beta.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-kurtosis.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-kurtosis.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-kurtosis.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-kurtosis.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-kurtosis.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-kurtosis.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-kurtosis.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-kurtosis.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-kurtosis.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-kurtosis.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-kurtosis.php" hreflang="zh">
...
<meta name="Description" content="Computes the kurtosis of the data in the array" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_kurtosis - Manual" />
<meta name="twitter:description" content="Computes the kurtosis of the data in the array" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_kurtosis - Manual" />
<meta itemprop="description" content="Computes the kurtosis of the data in the array" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Computes the kurtosis of the data in the array" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-rand-gen-beta.php">
          stats_rand_gen_beta &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-harmonic-mean.php">
          &laquo; stats_harmonic_mean        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-kurtosis.php' selected="selected">English</option>
            <option value='de/function.stats-kurtosis.php'>German</option>
            <option value='es/function.stats-kurtosis.php'>Spanish</option>
            <option value='fr/function.stats-kurtosis.php'>French</option>
            <option value='it/function.stats-kurtosis.php'>Italian</option>
            <option value='ja/function.stats-kurtosis.php'>Japanese</option>
            <option value='pt_BR/function.stats-kurtosis.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-kurtosis.php'>Russian</option>
            <option value='tr/function.stats-kurtosis.php'>Turkish</option>
            <option value='uk/function.stats-kurtosis.php'>Ukrainian</option>
            <option value='zh/function.stats-kurtosis.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-kurtosis" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_kurtosis</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_kurtosis</span> &mdash; <span class="dc-title">Computes the kurtosis of the data in the array</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-kurtosis-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_kurtosis</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$a</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   Returns the kurtosis of the values in <code class="parameter">a</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-kurtosis-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-kurtosis-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if <code class="parameter">a</code> is empty or is not an array.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-kurtosis.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-kurtosis%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-kurtosis&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-kurtosis.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118473">  <div class="votes">
    <div id="Vu118473">
    <a href="/manual/vote-note.php?id=118473&amp;page=function.stats-kurtosis&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118473">
    <a href="/manual/vote-note.php?id=118473&amp;page=function.stats-kurtosis&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118473" title="60% like this...">
    1
    </div>
  </div>
  <a href="#118473" class="name">
  <strong class="user"><em>Angel J. Salinas</em></strong></a><a class="genanchor" href="#118473"> &para;</a><div class="date" title="2015-12-12 09:35"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118473">
<div class="phpcode"><code><span class="html">// If you don't have the php_stats library, you can use this function:<br />public static function getKurtosis( $values )<br />{<br />  $numValues = count( $values );<br />  if ( $numValues == 0 ) {<br />    return 0.0;<br />  }<br />  <br />  // Use function from php_stats library if available<br />  if ( function_exists( 'stats_kurtosis' ) ) {<br />    return stats_kurtosis( $values );<br />  }<br />  <br />  $mean = array_sum( $values ) / floatval( $numValues );<br />  $add2 = 0.0;<br />  $add4 = 0.0;<br />  <br />  foreach ( $values as $value ) {<br />    if ( ! is_numeric( $value ) ) {<br />      return false;<br />    }<br />    $dif = $value - $mean;<br />    $dif2 = $dif * $dif;<br />    $add2 += $dif2;<br />    $add4 += ( $dif2 * $dif2 );<br />  } // foreach values<br />  <br />  $variance = $add2 / floatval( $numValues );<br />  return ( $add4 * $numValues ) / ( $add2 * $add2 ) - 3.0;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stats-kurtosis&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-kurtosis.php">＋<small>add a note</small></a></div>
