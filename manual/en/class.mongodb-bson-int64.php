...
<head>
  ...
  <title>PHP: MongoDB\BSON\Int64 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-int64.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-int64">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-int64" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-dbpointer.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-int64.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-int64.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-int64.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-int64.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-int64.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-int64.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-int64.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-int64.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-int64.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-int64.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-int64.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-int64.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Int64 class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Int64 - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Int64 class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Int64 - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Int64 class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Int64 class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-int64.construct.php">
          MongoDB\BSON\Int64::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-dbpointer.tostring.php">
          &laquo; MongoDB\BSON\DBPointer::__toString        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-int64.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-int64.php'>German</option>
            <option value='es/class.mongodb-bson-int64.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-int64.php'>French</option>
            <option value='it/class.mongodb-bson-int64.php'>Italian</option>
            <option value='ja/class.mongodb-bson-int64.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-int64.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-int64.php'>Russian</option>
            <option value='tr/class.mongodb-bson-int64.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-int64.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-int64.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-int64" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;=1.5.0)</p>
  ...
  <div class="section" id="mongodb-bson-int64.intro">
   ...
   <p class="para">
    ...
    <span class="classname"><a href="class.mongodb-bson-packedarray.php" class="classname">MongoDB\BSON\PackedArray</a></span>, and
    <span class="classname"><a href="class.mongodb-bson-iterator.php" class="classname">MongoDB\BSON\Iterator</a></span> classes, any 64-bit integer
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-int64.construct.php">MongoDB\BSON\Int64::__construct</a> — Construct a new Int64</li><li><a href="mongodb-bson-int64.jsonserialize.php">MongoDB\BSON\Int64::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="mongodb-bson-int64.tostring.php">MongoDB\BSON\Int64::__toString</a> — Returns the string representation of this Int64</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/int64.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-int64%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-int64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-int64.php">＋<small>add a note</small></a></span>
