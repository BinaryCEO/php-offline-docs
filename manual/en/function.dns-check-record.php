...
<head>
  ...
  <title>PHP: dns_check_record - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dns-check-record.php">
 <link rel="shorturl" href="https://www.php.net/dns-check-record">
 <link rel="alternate" href="https://www.php.net/dns-check-record" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.closelog.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dns-get-mx.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.dns-check-record.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.dns-check-record.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.dns-check-record.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.dns-check-record.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.dns-check-record.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.dns-check-record.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.dns-check-record.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.dns-check-record.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.dns-check-record.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.dns-check-record.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.dns-check-record.php" hreflang="zh">
...
<meta name="Description" content="Alias of checkdnsrr" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dns_check_record - Manual" />
<meta name="twitter:description" content="Alias of checkdnsrr" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dns_check_record - Manual" />
<meta itemprop="description" content="Alias of checkdnsrr" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of checkdnsrr" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dns-check-record.php' selected="selected">English</option>
            <option value='de/function.dns-check-record.php'>German</option>
            <option value='es/function.dns-check-record.php'>Spanish</option>
            <option value='fr/function.dns-check-record.php'>French</option>
            <option value='it/function.dns-check-record.php'>Italian</option>
            <option value='ja/function.dns-check-record.php'>Japanese</option>
            <option value='pt_BR/function.dns-check-record.php'>Brazilian Portuguese</option>
            <option value='ru/function.dns-check-record.php'>Russian</option>
            <option value='tr/function.dns-check-record.php'>Turkish</option>
            <option value='uk/function.dns-check-record.php'>Ukrainian</option>
            <option value='zh/function.dns-check-record.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.dns-check-record" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">dns_check_record</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">dns_check_record</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.checkdnsrr.php" class="function">checkdnsrr()</a></span></span></p>
  ...
  <p class="para">
   ...
   <span class="function"><a href="function.checkdnsrr.php" class="function">checkdnsrr()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/dns-check-record.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dns-check-record%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dns-check-record&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dns-check-record.php">＋<small>add a note</small></a></span>
