...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqlnd.overview.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqlnd.overview.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.overview.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqlnd.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.mysqlnd.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqlnd.install.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqlnd.overview.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqlnd.overview.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqlnd.overview.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqlnd.overview.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqlnd.overview.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqlnd.overview.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqlnd.overview.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqlnd.overview.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqlnd.overview.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqlnd.overview.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqlnd.overview.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqlnd.overview.php' selected="selected">English</option>
            <option value='de/mysqlnd.overview.php'>German</option>
            <option value='es/mysqlnd.overview.php'>Spanish</option>
            <option value='fr/mysqlnd.overview.php'>French</option>
            <option value='it/mysqlnd.overview.php'>Italian</option>
            <option value='ja/mysqlnd.overview.php'>Japanese</option>
            <option value='pt_BR/mysqlnd.overview.php'>Brazilian Portuguese</option>
            <option value='ru/mysqlnd.overview.php'>Russian</option>
            <option value='tr/mysqlnd.overview.php'>Turkish</option>
            <option value='uk/mysqlnd.overview.php'>Ukrainian</option>
            <option value='zh/mysqlnd.overview.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqlnd.overview" class="chapter">
  ...
  Named pipes can be used to connect on Windows environments.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqlnd/overview.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqlnd.overview%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqlnd.overview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqlnd.overview.php">＋<small>add a note</small></a></span>
