...
<head>
  ...
  <title>PHP: openssl_spki_export_challenge - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-spki-export-challenge.php">
 <link rel="shorturl" href="https://www.php.net/openssl-spki-export-challenge">
 <link rel="alternate" href="https://www.php.net/openssl-spki-export-challenge" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-spki-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-spki-new.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-spki-export-challenge.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-spki-export-challenge.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-spki-export-challenge.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-spki-export-challenge.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-spki-export-challenge.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-spki-export-challenge.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-spki-export-challenge.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-spki-export-challenge.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-spki-export-challenge.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-spki-export-challenge.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-spki-export-challenge.php" hreflang="zh">
...
<meta name="Description" content="Exports the challenge associated with a signed public key and challenge" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_spki_export_challenge - Manual" />
<meta name="twitter:description" content="Exports the challenge associated with a signed public key and challenge" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_spki_export_challenge - Manual" />
<meta itemprop="description" content="Exports the challenge associated with a signed public key and challenge" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports the challenge associated with a signed public key and challenge" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-spki-new.php">
          openssl_spki_new &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-spki-export.php">
          &laquo; openssl_spki_export        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-spki-export-challenge.php' selected="selected">English</option>
            <option value='de/function.openssl-spki-export-challenge.php'>German</option>
            <option value='es/function.openssl-spki-export-challenge.php'>Spanish</option>
            <option value='fr/function.openssl-spki-export-challenge.php'>French</option>
            <option value='it/function.openssl-spki-export-challenge.php'>Italian</option>
            <option value='ja/function.openssl-spki-export-challenge.php'>Japanese</option>
            <option value='pt_BR/function.openssl-spki-export-challenge.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-spki-export-challenge.php'>Russian</option>
            <option value='tr/function.openssl-spki-export-challenge.php'>Turkish</option>
            <option value='uk/function.openssl-spki-export-challenge.php'>Ukrainian</option>
            <option value='zh/function.openssl-spki-export-challenge.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-spki-export-challenge" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_spki_export_challenge</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.6.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_spki_export_challenge</span> &mdash; <span class="dc-title">Exports the challenge associated with a signed public key and challenge</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.openssl-spki-export-challenge-returnvalues">
  ...
  <p class="para">
   Returns the associated challenge string or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-spki-export-challenge-examples">
  ...
  <div class="example" id="openssl_spki_export_challenge.example.basic">
   <p><strong>Example #1 <span class="function"><strong>openssl_spki_export_challenge()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pkey </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_pkey_new</span><span style="color: #007700">(</span><span style="color: #DD0000">'secret password'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$spkac </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_spki_new</span><span style="color: #007700">(</span><span style="color: #0000BB">$pkey</span><span style="color: #007700">, </span><span style="color: #DD0000">'challenge string'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$challenge </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_spki_export_challenge</span><span style="color: #007700">(</span><span style="color: #0000BB">preg_replace</span><span style="color: #007700">(</span><span style="color: #DD0000">'/SPKAC=/'</span><span style="color: #007700">, </span><span style="color: #DD0000">''</span><span style="color: #007700">, </span><span style="color: #0000BB">$spkac</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="example" id="openssl_spki_export_challenge.example.keygen">
   <p><strong>Example #2 <span class="function"><strong>openssl_spki_export_challenge()</strong></span> example from &lt;keygen&gt;</strong></p>
   <div class="example-contents"><p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-spki-export-challenge.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-spki-export-challenge%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-spki-export-challenge&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-export-challenge.php">＋<small>add a note</small></a></span>
