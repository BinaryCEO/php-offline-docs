...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ftp-alloc.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/ref.ftp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ftp-append.php">
...
<meta name="Description" content="Allocates space for a file to be uploaded" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ftp_alloc - Manual" />
<meta name="twitter:description" content="Allocates space for a file to be uploaded" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ftp_alloc - Manual" />
<meta itemprop="description" content="Allocates space for a file to be uploaded" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Allocates space for a file to be uploaded" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ftp-alloc.php' selected="selected">English</option>
            ...
            <option value='ru/function.ftp-alloc.php'>Russian</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ftp-fput.php" class="function" rel="rdfs-seeAlso">ftp_fput()</a> - Uploads from an open file to the FTP server</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ftp/functions/ftp-alloc.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ftp-alloc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ftp-alloc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ftp-alloc.php">＋<small>add a note</small></a></span>
