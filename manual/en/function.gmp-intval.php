...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-intval.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-init.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-invert.php">
...
<meta name="Description" content="Convert GMP number to integer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_intval - Manual" />
<meta name="twitter:description" content="Convert GMP number to integer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_intval - Manual" />
<meta itemprop="description" content="Convert GMP number to integer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Convert GMP number to integer" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-intval.php' selected="selected">English</option>
            ...
            <option value='ja/function.gmp-intval.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_intval</span> &mdash; <span class="dc-title">Convert GMP number to integer</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-intval-description">
  ...
  <p class="para rdfs-comment">
   This function converts GMP number into native PHP <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>s.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gmp-intval-returnvalues">
  ...
  <p class="para">
   The <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> value of <code class="parameter">num</code>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-intval-examples">
  ...
  <p class="para">
   <div class="example" id="example-3329">
    <p><strong>Example #1 <span class="function"><strong>gmp_intval()</strong></span> example</strong></p>
 ...
 <div class="refsect1 notes" id="refsect1-function.gmp-intval-notes">
  ...
  <div class="warning"><strong class="warning">Warning</strong>
   <p class="simpara">
    ...
    number, use <span class="function"><a href="function.gmp-strval.php" class="function">gmp_strval()</a></span>.
   </p>
  </div>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-intval.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-intval%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-intval&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-intval.php">＋<small>add a note</small></a></span>
