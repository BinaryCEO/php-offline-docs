...
<head>
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.getmxrr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.getprotobynumber.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.getprotobyname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.getprotobyname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.getprotobyname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.getprotobyname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.getprotobyname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.getprotobyname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.getprotobyname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.getprotobyname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.getprotobyname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.getprotobyname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.getprotobyname.php" hreflang="zh">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$protocol </span><span style="color: #007700">= </span><span style="color: #DD0000">'tcp'</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$get_prot </span><span style="color: #007700">= </span><span style="color: #0000BB">getprotobyname</span><span style="color: #007700">(</span><span style="color: #0000BB">$protocol</span><span style="color: #007700">);<br />if (</span><span style="color: #0000BB">$get_prot </span><span style="color: #007700">=== </span><span style="color: #0000BB">FALSE</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">'Invalid Protocol'</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">'Protocol #' </span><span style="color: #007700">. </span><span style="color: #0000BB">$get_prot</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getprotobyname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getprotobyname.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="83064">  <div class="votes">
    ...
    <div class="tally" id="V83064" title="55% like this...">
    2
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">getprotobyname()<br />=====================<br /><br />getprotobyname() gives the protocol number for the given protocol name on the local system.<br />If the protocol is not recognized, then the function returns -1.<br />The given code snippet gives the list of protocols along with their protocol numbers<br />&lt;?<br />$arr=array("ip","icmp","ggp","tcp",<br />"egp","pup","udp","hmp","xns-idp",<br />"rdp","rvd" );<br />//Reads the names of protocols into an array..<br />for($i=0;$i&lt;11;$i++)<br />{<br />$proname=$arr[$i];<br />echo $proname .":", getprotobyname ($proname)."&lt;br /&gt;";<br />}<br /><br />?&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.getprotobyname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getprotobyname.php">＋<small>add a note</small></a></div>
