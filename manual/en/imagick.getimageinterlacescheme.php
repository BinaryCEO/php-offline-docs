...
<head>
  ...
  <title>PHP: Imagick::getImageInterlaceScheme - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimageindex.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageinterlacescheme.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageinterlacescheme.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageinterlacescheme.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageinterlacescheme.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageinterlacescheme.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageinterlacescheme.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageinterlacescheme.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageinterlacescheme.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageinterlacescheme.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageinterlacescheme.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageinterlacescheme.php" hreflang="zh">
...
<meta name="Description" content="Gets the image interlace scheme" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageInterlaceScheme - Manual" />
<meta name="twitter:description" content="Gets the image interlace scheme" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageInterlaceScheme - Manual" />
<meta itemprop="description" content="Gets the image interlace scheme" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image interlace scheme" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageinterpolatemethod.php">
          Imagick::getImageInterpolateMethod &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimageindex.php">
          &laquo; Imagick::getImageIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageinterlacescheme.php' selected="selected">English</option>
            <option value='de/imagick.getimageinterlacescheme.php'>German</option>
            <option value='es/imagick.getimageinterlacescheme.php'>Spanish</option>
            <option value='fr/imagick.getimageinterlacescheme.php'>French</option>
            <option value='it/imagick.getimageinterlacescheme.php'>Italian</option>
            <option value='ja/imagick.getimageinterlacescheme.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageinterlacescheme.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageinterlacescheme.php'>Russian</option>
            <option value='tr/imagick.getimageinterlacescheme.php'>Turkish</option>
            <option value='uk/imagick.getimageinterlacescheme.php'>Ukrainian</option>
            <option value='zh/imagick.getimageinterlacescheme.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageinterlacescheme" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageInterlaceScheme</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageInterlaceScheme</span> &mdash; <span class="dc-title">Gets the image interlace scheme</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimageinterlacescheme-returnvalues">
  ...
  <p class="para">
   ...
   Throw an
<span class="classname"><strong class="classname">ImagickException</strong></span> on error.   
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageinterlacescheme.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageinterlacescheme%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="111659">  <div class="votes">
    <div id="Vu111659">
    <a href="/manual/vote-note.php?id=111659&amp;page=imagick.getimageinterlacescheme&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111659">
    <a href="/manual/vote-note.php?id=111659&amp;page=imagick.getimageinterlacescheme&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111659" title="no votes...">
    0
    </div>
  </div>
  <a href="#111659" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#111659"> &para;</a><div class="date" title="2013-03-13 01:59"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111659">
<div class="phpcode"><code><span class="html">Image Interlacing is simply combining two images by layering one over the other with a certain opacity (usually 50%).  The intention is to use the image in video, so that two images are displayed within one single frame, thereby doubling the frames-per-second without doubling the actual, physical amount of frames.  Wikipedia provides a fairly decent explanation of this type of video technology: <a href="http://en.wikipedia.org/wiki/Interlaced_video" rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Interlaced_video</a> .<br /><br />Best Description :<br /><a href="http://www.100fps.com/" rel="nofollow" target="_blank">http://www.100fps.com/</a><br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.jpg"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Rendering Intent Values<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_rendering_intent </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageRenderingIntent</span><span class="keyword">();<br />    <br />    switch(</span><span class="default">$imagick_rendering_intent</span><span class="keyword">)<br />    {<br />        case </span><span class="string">'0'</span><span class="keyword">:<br />            </span><span class="default">$image_rendering_intent_evaluated </span><span class="keyword">= </span><span class="string">"Undefined"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="string">'1'</span><span class="keyword">:<br />            </span><span class="default">$image_rendering_intent_evaluated </span><span class="keyword">= </span><span class="string">"Saturation"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="string">'2'</span><span class="keyword">:<br />            </span><span class="default">$image_rendering_intent_evaluated </span><span class="keyword">= </span><span class="string">"Perceptual"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="string">'3'</span><span class="keyword">:<br />            </span><span class="default">$image_rendering_intent_evaluated </span><span class="keyword">= </span><span class="string">"Absolute"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="string">'4'</span><span class="keyword">:<br />            </span><span class="default">$image_rendering_intent_evaluated </span><span class="keyword">= </span><span class="string">"Relative"</span><span class="keyword">;<br />            break;<br />    }<br />    <br />        </span><span class="comment">// Print Rendering Intent Values<br />        // ---------------------------------------------<br />    <br />    </span><span class="keyword">print(</span><span class="string">"# </span><span class="default">$imagick_rendering_intent</span><span class="string"> - </span><span class="default">$image_rendering_intent_evaluated</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageinterlacescheme.php">＋<small>add a note</small></a></div>
