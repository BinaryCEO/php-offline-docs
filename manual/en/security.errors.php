...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/security.errors.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/security.errors.php">
 <link rel="alternate" href="https://www.php.net/manual/en/security.errors.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/security.php">
 <link rel="prev" href="https://www.php.net/manual/en/security.database.sql-injection.php">
 <link rel="next" href="https://www.php.net/manual/en/security.variables.php">
...
<meta name="twitter:title" content="PHP: Error Reporting - Manual" />
<meta name="twitter:description" content="Error Reporting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Error Reporting - Manual" />
<meta itemprop="description" content="Error Reporting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Error Reporting" />
...
&lt;/form&gt;</pre>
   ...
   <p class="para">
    ...
    By testing your code, prior to deployment, with <strong><code><a href="errorfunc.constants.php#constant.e-all">E_ALL</a></code></strong>,
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">$username</span><span style="color: #007700">) {  </span><span style="color: #FF8000">// Not initialized or checked before usage<br />    </span><span style="color: #0000BB">$good_login </span><span style="color: #007700">= </span><span style="color: #0000BB">1</span><span style="color: #007700">;<br />}<br />if (</span><span style="color: #0000BB">$good_login </span><span style="color: #007700">== </span><span style="color: #0000BB">1</span><span style="color: #007700">) { </span><span style="color: #FF8000">// If above test fails, not initialized or checked before usage<br />    </span><span style="color: #0000BB">readfile </span><span style="color: #007700">(</span><span style="color: #DD0000">"/highly/sensitive/data/index.html"</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/security/errors.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsecurity.errors%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=security.errors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.errors.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Note for those of you using OpenBSD and PHP.  The default php.ini has display_errors=off . This is contrary to the PHP default of display_errors=on . If your having trouble seeing errors on OpenBSD make sure to edit your php.ini to have display_errors=on. (I had this problem on OpenBSD 4.4)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=security.errors&amp;repo=en&amp;redirect=https://www.php.net/manual/en/security.errors.php">＋<small>add a note</small></a></div>
