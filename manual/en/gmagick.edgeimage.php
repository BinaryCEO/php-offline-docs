...
<head>
  ...
  <title>PHP: Gmagick::edgeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.edgeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.edgeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.edgeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.drawimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.embossimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.edgeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.edgeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.edgeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.edgeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.edgeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.edgeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.edgeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.edgeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.edgeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.edgeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.edgeimage.php" hreflang="zh">
...
<meta name="Description" content="Enhance edges within the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::edgeimage - Manual" />
<meta name="twitter:description" content="Enhance edges within the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::edgeimage - Manual" />
<meta itemprop="description" content="Enhance edges within the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Enhance edges within the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.embossimage.php">
          Gmagick::embossimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.drawimage.php">
          &laquo; Gmagick::drawimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.edgeimage.php' selected="selected">English</option>
            <option value='de/gmagick.edgeimage.php'>German</option>
            <option value='es/gmagick.edgeimage.php'>Spanish</option>
            <option value='fr/gmagick.edgeimage.php'>French</option>
            <option value='it/gmagick.edgeimage.php'>Italian</option>
            <option value='ja/gmagick.edgeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.edgeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.edgeimage.php'>Russian</option>
            <option value='tr/gmagick.edgeimage.php'>Turkish</option>
            <option value='uk/gmagick.edgeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.edgeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.edgeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::edgeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::edgeimage</span> &mdash; <span class="dc-title">Enhance edges within the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.edgeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::edgeimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.edgeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.edgeimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object with edges enhanced.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.edgeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/edgeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.edgeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.edgeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.edgeimage.php">＋<small>add a note</small></a></span>
