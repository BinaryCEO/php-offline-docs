...
<head>
  ...
  <title>PHP: trader_adx - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-adx.php">
 <link rel="shorturl" href="https://www.php.net/trader-adx">
 <link rel="alternate" href="https://www.php.net/trader-adx" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-adosc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-adxr.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-adx.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-adx.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-adx.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-adx.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-adx.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-adx.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-adx.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-adx.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-adx.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-adx.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-adx.php" hreflang="zh">
...
<meta name="Description" content="Average Directional Movement Index" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_adx - Manual" />
<meta name="twitter:description" content="Average Directional Movement Index" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_adx - Manual" />
<meta itemprop="description" content="Average Directional Movement Index" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Average Directional Movement Index" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-adx.php' selected="selected">English</option>
            <option value='de/function.trader-adx.php'>German</option>
            <option value='es/function.trader-adx.php'>Spanish</option>
            <option value='fr/function.trader-adx.php'>French</option>
            <option value='it/function.trader-adx.php'>Italian</option>
            <option value='ja/function.trader-adx.php'>Japanese</option>
            <option value='pt_BR/function.trader-adx.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-adx.php'>Russian</option>
            <option value='tr/function.trader-adx.php'>Turkish</option>
            <option value='uk/function.trader-adx.php'>Ukrainian</option>
            <option value='zh/function.trader-adx.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-adx" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-adx-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_adx</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-adx-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-adx.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-adx%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-adx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-adx.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125909">  <div class="votes">
    <div id="Vu125909">
    <a href="/manual/vote-note.php?id=125909&amp;page=function.trader-adx&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125909">
    <a href="/manual/vote-note.php?id=125909&amp;page=function.trader-adx&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125909" title="60% like this...">
    1
    </div>
  </div>
  <a href="#125909" class="name">
  <strong class="user"><em>tl4gvx29ku39 at opayq dot com</em></strong></a><a class="genanchor" href="#125909"> &para;</a><div class="date" title="2021-03-11 03:54"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125909">
<div class="phpcode"><code><span class="html">After hours of trial and error, I feel fairly confident the adx function works like many others. Insert a block(s) of ohlc data and set a time period for an output. <br /><br />For example, I am using 48 30-min blocks of ohlc data (1 day). But I wanted the indicators true to design (adx is usually 14 periods) so I would trim the data to 14 periods in and set timePeriods=14 and get errors. No need to do all that. Put the entire 48 period array(s) in and set the period to 14 (or whatever you like). The output is close to online sources. The function will use the last 14 periods or whatever you set to generate the correct output. <br /><br />The best/closest I can find for a manual to these functions is located tulipindicators dot org which you can test using excel with a free plugin at tulipcell dot org. <br /><br />I was able to pull my historical indicator data generated with these functions and was able to recreate the numbers which matched closely to online trading platforms.</span></code></div>
  </div>
 </div>
  <div class="note" id="125787">  <div class="votes">
    <div id="Vu125787">
    <a href="/manual/vote-note.php?id=125787&amp;page=function.trader-adx&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125787">
    <a href="/manual/vote-note.php?id=125787&amp;page=function.trader-adx&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125787" title="50% like this...">
    0
    </div>
  </div>
  <a href="#125787" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125787"> &para;</a><div class="date" title="2021-02-07 07:48"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125787">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">// Per wikipedia ADX is "an indicator of trend strength in a series of prices of a financial instrument."<br />// The original implementation used 14 days.<br /><br /></span><span class="default">$highs </span><span class="keyword">= array(</span><span class="default">118.99</span><span class="keyword">, </span><span class="default">119.14</span><span class="keyword">, </span><span class="default">120.5</span><span class="keyword">, </span><span class="default">115.23</span><span class="keyword">, </span><span class="default">115.93</span><span class="keyword">, </span><span class="default">118.829</span><span class="keyword">, </span><span class="default">116</span><span class="keyword">, </span><span class="default">112.2</span><span class="keyword">, </span><span class="default">110.88</span><span class="keyword">, </span><span class="default">110.19</span><span class="keyword">, </span><span class="default">112.86</span><span class="keyword">, </span><span class="default">112.11</span><span class="keyword">, </span><span class="default">110.25</span><span class="keyword">, </span><span class="default">112.44</span><span class="keyword">);<br /></span><span class="default">$lows </span><span class="keyword">= array(</span><span class="default">112.68</span><span class="keyword">, </span><span class="default">115.26</span><span class="keyword">, </span><span class="default">112.5</span><span class="keyword">, </span><span class="default">110</span><span class="keyword">, </span><span class="default">112.8</span><span class="keyword">, </span><span class="default">113.61</span><span class="keyword">, </span><span class="default">112.04</span><span class="keyword">, </span><span class="default">108.71</span><span class="keyword">, </span><span class="default">106.09</span><span class="keyword">, </span><span class="default">103.1</span><span class="keyword">, </span><span class="default">109.16</span><span class="keyword">, </span><span class="default">106.77</span><span class="keyword">, </span><span class="default">105</span><span class="keyword">, </span><span class="default">107.67</span><span class="keyword">);<br /></span><span class="default">$closes </span><span class="keyword">= array(</span><span class="default">112.82</span><span class="keyword">, </span><span class="default">117.32</span><span class="keyword">, </span><span class="default">113.49</span><span class="keyword">, </span><span class="default">112</span><span class="keyword">, </span><span class="default">115.355</span><span class="keyword">, </span><span class="default">115.54</span><span class="keyword">, </span><span class="default">112.13</span><span class="keyword">, </span><span class="default">110.34</span><span class="keyword">, </span><span class="default">106.84</span><span class="keyword">, </span><span class="default">110.08</span><span class="keyword">, </span><span class="default">111.81</span><span class="keyword">, </span><span class="default">107.12</span><span class="keyword">, </span><span class="default">108.22</span><span class="keyword">, </span><span class="default">112.28</span><span class="keyword">);<br /><br /></span><span class="default">$time_period </span><span class="keyword">= </span><span class="default">floor</span><span class="keyword">(</span><span class="default">count</span><span class="keyword">(</span><span class="default">$highs</span><span class="keyword">) / </span><span class="default">2</span><span class="keyword">); </span><span class="comment">// Per Wikipedia on the ADX indicator calculation:<br />                                         // UpMove = today's high − yesterday's high<br />                                         // DownMove = yesterday's low − today's low<br />                                         //<br />                                         // Thence: The maximal length for $time_period <br />                                         // is: floor(count($the_number_of_samples) / 2);<br />                                         <br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">trader_adx</span><span class="keyword">(</span><span class="default">$highs</span><span class="keyword">, </span><span class="default">$lows</span><span class="keyword">, </span><span class="default">$closes</span><span class="keyword">, </span><span class="default">$time_period</span><span class="keyword">));<br /></span><span class="comment">/*<br />array(1) {<br />  [13]=&gt;<br />  float(48.909)<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-adx&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-adx.php">＋<small>add a note</small></a></div>
