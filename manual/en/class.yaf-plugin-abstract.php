...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.yaf-plugin-abstract.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/yaf-loader.setlibrarypath.php">
 <link rel="next" href="https://www.php.net/manual/en/yaf-plugin-abstract.dispatchloopshutdown.php">
...
<meta name="Description" content="The Yaf_Plugin_Abstract class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Yaf_Plugin_Abstract - Manual" />
<meta name="twitter:description" content="The Yaf_Plugin_Abstract class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Yaf_Plugin_Abstract - Manual" />
<meta itemprop="description" content="The Yaf_Plugin_Abstract class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Yaf_Plugin_Abstract class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.yaf-plugin-abstract.php' selected="selected">English</option>
            ...
            <option value='pt_BR/class.yaf-plugin-abstract.php'>Brazilian Portuguese</option>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="yaf-plugin-abstract.dispatchloopshutdown.php">Yaf_Plugin_Abstract::dispatchLoopShutdown</a> — The dispatchLoopShutdown purpose</li><li><a href="yaf-plugin-abstract.dispatchloopstartup.php">Yaf_Plugin_Abstract::dispatchLoopStartup</a> — Hook before dispatch loop</li><li><a href="yaf-plugin-abstract.postdispatch.php">Yaf_Plugin_Abstract::postDispatch</a> — The postDispatch purpose</li><li><a href="yaf-plugin-abstract.predispatch.php">Yaf_Plugin_Abstract::preDispatch</a> — The preDispatch purpose</li><li><a href="yaf-plugin-abstract.preresponse.php">Yaf_Plugin_Abstract::preResponse</a> — The preResponse purpose</li><li><a href="yaf-plugin-abstract.routershutdown.php">Yaf_Plugin_Abstract::routerShutdown</a> — The routerShutdown purpose</li><li><a href="yaf-plugin-abstract.routerstartup.php">Yaf_Plugin_Abstract::routerStartup</a> — RouterStartup hook</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/yaf/yaf-plugin-abstract.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.yaf-plugin-abstract%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.yaf-plugin-abstract&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-plugin-abstract.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>gianjason#gmail.com</em></strong></a><a class="genanchor" href="#111044"> &para;</a><div class="date" title="2013-01-09 07:59"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111044">
<div class="phpcode"><code><span class="html">All the methods which the plugin implemented according to this interface, will be called at the proper time automatically.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.yaf-plugin-abstract&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.yaf-plugin-abstract.php">＋<small>add a note</small></a></div>
