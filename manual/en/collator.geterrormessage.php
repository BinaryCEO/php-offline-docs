...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/collator.geterrormessage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/collator.geterrormessage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/collator.geterrormessage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.collator.php">
 <link rel="prev" href="https://www.php.net/manual/en/collator.geterrorcode.php">
 <link rel="next" href="https://www.php.net/manual/en/collator.getlocale.php">
...
<meta name="Description" content="Get text for collator's last error code" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Collator::getErrorMessage - Manual" />
<meta name="twitter:description" content="Get text for collator's last error code" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Collator::getErrorMessage - Manual" />
<meta itemprop="description" content="Get text for collator's last error code" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get text for collator's last error code" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/collator.geterrormessage.php' selected="selected">English</option>
            ...
            <option value='ru/collator.geterrormessage.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Collator::getErrorMessage</span> -- <span class="refname">collator_get_error_message</span> &mdash; <span class="dc-title">Get text for collator&#039;s last error code</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-collator.geterrormessage-returnvalues">
  ...
  <p class="para">
   Description of an error occurred in the last Collator <abbr title="Application Programming Interface">API</abbr> function call,
 ...
 <div class="refsect1 examples" id="refsect1-collator.geterrormessage-examples">
  ...
  <p class="para">
   <div class="example" id="example-2485">
    <p><strong>Example #1 <span class="function"><strong>collator_get_error_message()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="collator.geterrorcode.php" class="function" rel="rdfs-seeAlso">collator_get_error_code()</a> - Get collator's last error code</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/collator/get-error-message.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcollator.geterrormessage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=collator.geterrormessage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/collator.geterrormessage.php">＋<small>add a note</small></a></span>
