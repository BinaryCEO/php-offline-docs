...
<head>
  ...
  <title>PHP: image_type_to_mime_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.image-type-to-mime-type.php">
 <link rel="shorturl" href="https://www.php.net/image-type-to-mime-type">
 <link rel="alternate" href="https://www.php.net/image-type-to-mime-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.image-type-to-extension.php">
 <link rel="next" href="https://www.php.net/manual/en/function.image2wbmp.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.image-type-to-mime-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.image-type-to-mime-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.image-type-to-mime-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.image-type-to-mime-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.image-type-to-mime-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.image-type-to-mime-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.image-type-to-mime-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.image-type-to-mime-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.image-type-to-mime-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.image-type-to-mime-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.image-type-to-mime-type.php" hreflang="zh">
...
<meta name="Description" content="Get Mime-Type for image-type returned by getimagesize,
   exif_read_data, exif_thumbnail, exif_imagetype" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: image_type_to_mime_type - Manual" />
<meta name="twitter:description" content="Get Mime-Type for image-type returned by getimagesize,
   exif_read_data, exif_thumbnail, exif_imagetype" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: image_type_to_mime_type - Manual" />
<meta itemprop="description" content="Get Mime-Type for image-type returned by getimagesize,
   exif_read_data, exif_thumbnail, exif_imagetype" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get Mime-Type for image-type returned by getimagesize,
   exif_read_data, exif_thumbnail, exif_imagetype" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.image-type-to-extension.php">
          &laquo; image_type_to_extension        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.image-type-to-mime-type.php' selected="selected">English</option>
            <option value='de/function.image-type-to-mime-type.php'>German</option>
            <option value='es/function.image-type-to-mime-type.php'>Spanish</option>
            <option value='fr/function.image-type-to-mime-type.php'>French</option>
            <option value='it/function.image-type-to-mime-type.php'>Italian</option>
            <option value='ja/function.image-type-to-mime-type.php'>Japanese</option>
            <option value='pt_BR/function.image-type-to-mime-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.image-type-to-mime-type.php'>Russian</option>
            <option value='tr/function.image-type-to-mime-type.php'>Turkish</option>
            <option value='uk/function.image-type-to-mime-type.php'>Ukrainian</option>
            <option value='zh/function.image-type-to-mime-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.image-type-to-mime-type" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.exif-thumbnail.php" class="function" rel="rdfs-seeAlso">exif_thumbnail()</a> - Retrieve the embedded thumbnail of an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/image-type-to-mime-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.image-type-to-mime-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.image-type-to-mime-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.image-type-to-mime-type.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114569">  <div class="votes">
    <div id="Vu114569">
    <a href="/manual/vote-note.php?id=114569&amp;page=function.image-type-to-mime-type&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114569">
    <a href="/manual/vote-note.php?id=114569&amp;page=function.image-type-to-mime-type&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114569" title="61% like this...">
    12
    </div>
  </div>
  <a href="#114569" class="name">
  <strong class="user"><em>slegersjohn at gmail dot com</em></strong></a><a class="genanchor" href="#114569"> &para;</a><div class="date" title="2014-03-06 04:39"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114569">
<div class="phpcode"><code><span class="html">If you are working with Images only and you need mime type (e.g. for headers), then this is a fast and reliable technique:<br /> <br /><span class="default">&lt;?php<br />$file </span><span class="keyword">= </span><span class="string">'path/to/image.jpg'</span><span class="keyword">;<br /></span><span class="default">$image_mime </span><span class="keyword">= </span><span class="default">image_type_to_mime_type</span><span class="keyword">(</span><span class="default">exif_imagetype</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">));<br /></span><span class="default">?&gt;<br /></span><br />It will output true image mime type even if you rename your image file.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.image-type-to-mime-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.image-type-to-mime-type.php">＋<small>add a note</small></a></div>
