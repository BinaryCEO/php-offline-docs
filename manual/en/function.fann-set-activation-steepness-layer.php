...
<head>
  ...
  <title>PHP: fann_set_activation_steepness_layer - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-layer.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-activation-steepness-layer">
 <link rel="alternate" href="https://www.php.net/fann-set-activation-steepness-layer" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-hidden.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-output.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-activation-steepness-layer.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-activation-steepness-layer.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-activation-steepness-layer.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-activation-steepness-layer.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-activation-steepness-layer.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-activation-steepness-layer.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-activation-steepness-layer.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-activation-steepness-layer.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-activation-steepness-layer.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-activation-steepness-layer.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-activation-steepness-layer.php" hreflang="zh">
...
<meta name="Description" content="Sets the activation steepness for all of the neurons in the supplied layer number" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_activation_steepness_layer - Manual" />
<meta name="twitter:description" content="Sets the activation steepness for all of the neurons in the supplied layer number" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_activation_steepness_layer - Manual" />
<meta itemprop="description" content="Sets the activation steepness for all of the neurons in the supplied layer number" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the activation steepness for all of the neurons in the supplied layer number" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-set-activation-steepness-output.php">
          fann_set_activation_steepness_output &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-activation-steepness-hidden.php">
          &laquo; fann_set_activation_steepness_hidden        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-activation-steepness-layer.php' selected="selected">English</option>
            <option value='de/function.fann-set-activation-steepness-layer.php'>German</option>
            <option value='es/function.fann-set-activation-steepness-layer.php'>Spanish</option>
            <option value='fr/function.fann-set-activation-steepness-layer.php'>French</option>
            <option value='it/function.fann-set-activation-steepness-layer.php'>Italian</option>
            <option value='ja/function.fann-set-activation-steepness-layer.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-activation-steepness-layer.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-activation-steepness-layer.php'>Russian</option>
            <option value='tr/function.fann-set-activation-steepness-layer.php'>Turkish</option>
            <option value='uk/function.fann-set-activation-steepness-layer.php'>Ukrainian</option>
            <option value='zh/function.fann-set-activation-steepness-layer.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-activation-steepness-layer" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_activation_steepness_layer</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_activation_steepness_layer</span> &mdash; <span class="dc-title">Sets the activation steepness for all of the neurons in the supplied layer number</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-activation-steepness-layer-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_activation_steepness_layer</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$activation_steepness</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$layer</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Set the activation steepness for all of the neurons in layer number <code class="literal">layer</code>,
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-activation-steepness-layer-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-activation-steepness-layer-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-activation-steepness-layer-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-set-activation-function.php" class="function" rel="rdfs-seeAlso">fann_set_activation_function()</a> - Sets the activation function for supplied neuron and layer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-activation-steepness-layer.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-activation-steepness-layer%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-activation-steepness-layer&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-activation-steepness-layer.php">＋<small>add a note</small></a></span>
