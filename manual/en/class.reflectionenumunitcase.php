...
<head>
  ...
  <title>PHP: ReflectionEnumUnitCase - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.reflectionenumunitcase.php">
 <link rel="shorturl" href="https://www.php.net/reflectionenumunitcase">
 <link rel="alternate" href="https://www.php.net/reflectionenumunitcase" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.reflection.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionenum.isbacked.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionenumunitcase.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.reflectionenumunitcase.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.reflectionenumunitcase.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.reflectionenumunitcase.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.reflectionenumunitcase.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.reflectionenumunitcase.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.reflectionenumunitcase.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.reflectionenumunitcase.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.reflectionenumunitcase.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.reflectionenumunitcase.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.reflectionenumunitcase.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.reflectionenumunitcase.php" hreflang="zh">
...
<meta name="Description" content="The ReflectionEnumUnitCase class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionEnumUnitCase - Manual" />
<meta name="twitter:description" content="The ReflectionEnumUnitCase class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionEnumUnitCase - Manual" />
<meta itemprop="description" content="The ReflectionEnumUnitCase class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ReflectionEnumUnitCase class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionenumunitcase.construct.php">
          ReflectionEnumUnitCase::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionenum.isbacked.php">
          &laquo; ReflectionEnum::isBacked        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.reflectionenumunitcase.php' selected="selected">English</option>
            <option value='de/class.reflectionenumunitcase.php'>German</option>
            <option value='es/class.reflectionenumunitcase.php'>Spanish</option>
            <option value='fr/class.reflectionenumunitcase.php'>French</option>
            <option value='it/class.reflectionenumunitcase.php'>Italian</option>
            <option value='ja/class.reflectionenumunitcase.php'>Japanese</option>
            <option value='pt_BR/class.reflectionenumunitcase.php'>Brazilian Portuguese</option>
            <option value='ru/class.reflectionenumunitcase.php'>Russian</option>
            <option value='tr/class.reflectionenumunitcase.php'>Turkish</option>
            <option value='uk/class.reflectionenumunitcase.php'>Ukrainian</option>
            <option value='zh/class.reflectionenumunitcase.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.reflectionenumunitcase" class="reference">
 <h1 class="title">The ReflectionEnumUnitCase class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.1.0)</p>


  <div class="section" id="reflectionenumunitcase.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    The <span class="classname"><strong class="classname">ReflectionEnumUnitCase</strong></span> class reports
    information about an Enum unit case, which has no scalar equivalent.
   </p>
  </div>


  <div class="section" id="reflectionenumunitcase.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">ReflectionEnumUnitCase</strong></strong>
    

    
     <span class="modifier">extends</span>
      <a href="class.reflectionclassconstant.php" class="classname">ReflectionClassConstant</a>
     {</div>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="reflectionenumunitcase.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.object.php" class="type object">object</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$class</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$constant</code></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionenumunitcase.getenum.php" class="methodname">getEnum</a></span>(): <span class="type"><a href="class.reflectionenum.php" class="type ReflectionEnum">ReflectionEnum</a></span></div>
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionenumunitcase.getvalue.php" class="methodname">getValue</a></span>(): <span class="type"><a href="class.unitenum.php" class="type UnitEnum">UnitEnum</a></span></div>
...
<div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="reflectionclassconstant.tostring.php" class="methodname">ReflectionClassConstant::__toString</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <div class="section" id="reflectionenumunitcase.seealso">
   <h2 class="title">See Also</h2>
   <p class="para">
    <ul class="simplelist">
     <li><a href="language.enumerations.php" class="link">Enumerations</a></li>
     <li><span class="classname"><a href="class.reflectionenumbackedcase.php" class="classname">ReflectionEnumBackedCase</a></span></li>
    </ul>
   </p>
  </div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="reflectionenumunitcase.construct.php">ReflectionEnumUnitCase::__construct</a> — Instantiates a ReflectionEnumUnitCase object</li><li><a href="reflectionenumunitcase.getenum.php">ReflectionEnumUnitCase::getEnum</a> — Gets the reflection of the enum of this case</li><li><a href="reflectionenumunitcase.getvalue.php">ReflectionEnumUnitCase::getValue</a> — Gets the enum case object described by this reflection object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionenumunitcase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.reflectionenumunitcase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.reflectionenumunitcase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.reflectionenumunitcase.php">＋<small>add a note</small></a></span>
