...
<head>
  ...
  <title>PHP: sodium_crypto_box_keypair - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-box-keypair.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-box-keypair">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-box-keypair" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-box.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-box-keypair-from-secretkey-and-publickey.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-box-keypair.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-box-keypair.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-box-keypair.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-box-keypair.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-box-keypair.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-box-keypair.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-box-keypair.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-box-keypair.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-box-keypair.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-box-keypair.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-box-keypair.php" hreflang="zh">
...
<meta name="Description" content="Randomly generate a secret key and a corresponding public key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_box_keypair - Manual" />
<meta name="twitter:description" content="Randomly generate a secret key and a corresponding public key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_box_keypair - Manual" />
<meta itemprop="description" content="Randomly generate a secret key and a corresponding public key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Randomly generate a secret key and a corresponding public key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-box-keypair-from-secretkey-and-publickey.php">
          sodium_crypto_box_keypair_from_secretkey_and_publickey &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-box.php">
          &laquo; sodium_crypto_box        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-box-keypair.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-box-keypair.php'>German</option>
            <option value='es/function.sodium-crypto-box-keypair.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-box-keypair.php'>French</option>
            <option value='it/function.sodium-crypto-box-keypair.php'>Italian</option>
            <option value='ja/function.sodium-crypto-box-keypair.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-box-keypair.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-box-keypair.php'>Russian</option>
            <option value='tr/function.sodium-crypto-box-keypair.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-box-keypair.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-box-keypair.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-box-keypair" class="refentry">
  ...
  <p class="para">
   One string containing both the X25519 secret key and corresponding X25519 public key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-box-keypair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-box-keypair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-keypair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-keypair.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124503">  <div class="votes">
    <div id="Vu124503">
    <a href="/manual/vote-note.php?id=124503&amp;page=function.sodium-crypto-box-keypair&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124503">
    <a href="/manual/vote-note.php?id=124503&amp;page=function.sodium-crypto-box-keypair&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124503" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124503" class="name">
  <strong class="user"><em>mickey at disneyland dot com</em></strong></a><a class="genanchor" href="#124503"> &para;</a><div class="date" title="2019-12-12 11:15"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124503">
<div class="phpcode"><code><span class="html">To get the actual public and secret keys, use `sodium_crypto_box_publickey()` and `sodium_crypto_box_secretkey()`.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-box-keypair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-box-keypair.php">＋<small>add a note</small></a></div>
