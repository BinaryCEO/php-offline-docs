...
<head>
  ...
  <title>PHP: eio_readdir - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-readdir.php">
 <link rel="shorturl" href="https://www.php.net/eio-readdir">
 <link rel="alternate" href="https://www.php.net/eio-readdir" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-readahead.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-readlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-readdir.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-readdir.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-readdir.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-readdir.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-readdir.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-readdir.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-readdir.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-readdir.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-readdir.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-readdir.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-readdir.php" hreflang="zh">
...
<meta name="Description" content="Reads through a whole directory" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_readdir - Manual" />
<meta name="twitter:description" content="Reads through a whole directory" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_readdir - Manual" />
<meta itemprop="description" content="Reads through a whole directory" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads through a whole directory" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-readdir.php' selected="selected">English</option>
            <option value='de/function.eio-readdir.php'>German</option>
            <option value='es/function.eio-readdir.php'>Spanish</option>
            <option value='fr/function.eio-readdir.php'>French</option>
            <option value='it/function.eio-readdir.php'>Italian</option>
            <option value='ja/function.eio-readdir.php'>Japanese</option>
            <option value='pt_BR/function.eio-readdir.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-readdir.php'>Russian</option>
            <option value='tr/function.eio-readdir.php'>Turkish</option>
            <option value='uk/function.eio-readdir.php'>Ukrainian</option>
            <option value='zh/function.eio-readdir.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-readdir" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.eio-readdir-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_readdir</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-readdir-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_readdir()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. 
    ...
    array(3)
    {
     [&quot;name&quot;]=&gt;
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-readdir.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-readdir%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-readdir&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-readdir.php">＋<small>add a note</small></a></span>
