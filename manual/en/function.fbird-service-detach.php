...
<head>
  ...
  <title>PHP: fbird_service_detach - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-service-detach.php">
 <link rel="shorturl" href="https://www.php.net/fbird-service-detach">
 <link rel="alternate" href="https://www.php.net/fbird-service-detach" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-service-attach.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-set-event-handler.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-service-detach.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-service-detach.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-service-detach.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-service-detach.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-service-detach.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-service-detach.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-service-detach.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-service-detach.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-service-detach.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-service-detach.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-service-detach.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_service_detach" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_service_detach - Manual" />
<meta name="twitter:description" content="Alias of ibase_service_detach" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_service_detach - Manual" />
<meta itemprop="description" content="Alias of ibase_service_detach" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_service_detach" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-set-event-handler.php">
          fbird_set_event_handler &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-service-attach.php">
          &laquo; fbird_service_attach        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-service-detach.php' selected="selected">English</option>
            <option value='de/function.fbird-service-detach.php'>German</option>
            <option value='es/function.fbird-service-detach.php'>Spanish</option>
            <option value='fr/function.fbird-service-detach.php'>French</option>
            <option value='it/function.fbird-service-detach.php'>Italian</option>
            <option value='ja/function.fbird-service-detach.php'>Japanese</option>
            <option value='pt_BR/function.fbird-service-detach.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-service-detach.php'>Russian</option>
            <option value='tr/function.fbird-service-detach.php'>Turkish</option>
            <option value='uk/function.fbird-service-detach.php'>Ukrainian</option>
            <option value='zh/function.fbird-service-detach.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-service-detach" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_service_detach</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_service_detach</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-service-detach.php" class="function">ibase_service_detach()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-service-detach-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-service-detach.php" class="function">ibase_service_detach()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-service-detach.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-service-detach%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-service-detach&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-service-detach.php">＋<small>add a note</small></a></span>
