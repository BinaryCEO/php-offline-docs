...
<head>
  ...
  <title>PHP: stream_context_set_params - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-set-params.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-set-params">
 <link rel="alternate" href="https://www.php.net/stream-context-set-params" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-set-options.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-copy-to-stream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-set-params.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-set-params.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-set-params.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-set-params.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-set-params.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-set-params.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-set-params.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-set-params.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-set-params.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-set-params.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-set-params.php" hreflang="zh">
...
<meta name="Description" content="Set parameters for a stream/wrapper/context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_set_params - Manual" />
<meta name="twitter:description" content="Set parameters for a stream/wrapper/context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_set_params - Manual" />
<meta itemprop="description" content="Set parameters for a stream/wrapper/context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set parameters for a stream/wrapper/context" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-copy-to-stream.php">
          stream_copy_to_stream &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-set-options.php">
          &laquo; stream_context_set_options        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-set-params.php' selected="selected">English</option>
            <option value='de/function.stream-context-set-params.php'>German</option>
            <option value='es/function.stream-context-set-params.php'>Spanish</option>
            <option value='fr/function.stream-context-set-params.php'>French</option>
            <option value='it/function.stream-context-set-params.php'>Italian</option>
            <option value='ja/function.stream-context-set-params.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-set-params.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-set-params.php'>Russian</option>
            <option value='tr/function.stream-context-set-params.php'>Turkish</option>
            <option value='uk/function.stream-context-set-params.php'>Ukrainian</option>
            <option value='zh/function.stream-context-set-params.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-set-params" class="refentry">
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.stream-notification-callback.php" class="function" rel="rdfs-seeAlso">stream_notification_callback()</a> - A callback function for the notification context parameter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-set-params.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-set-params%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-set-params&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-set-params.php">＋<small>add a note</small></a></span>
