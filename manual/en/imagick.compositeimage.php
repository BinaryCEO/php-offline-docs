...
<head>
  ...
  <title>PHP: Imagick::compositeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.compositeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.compositeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.compositeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.compareimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.compositeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.compositeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.compositeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.compositeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.compositeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.compositeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.compositeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.compositeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.compositeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.compositeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.compositeimage.php" hreflang="zh">
...
<meta name="Description" content="Composite one image onto another" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::compositeImage - Manual" />
<meta name="twitter:description" content="Composite one image onto another" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::compositeImage - Manual" />
<meta itemprop="description" content="Composite one image onto another" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Composite one image onto another" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.construct.php">
          Imagick::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.compareimages.php">
          &laquo; Imagick::compareImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.compositeimage.php' selected="selected">English</option>
            <option value='de/imagick.compositeimage.php'>German</option>
            <option value='es/imagick.compositeimage.php'>Spanish</option>
            <option value='fr/imagick.compositeimage.php'>French</option>
            <option value='it/imagick.compositeimage.php'>Italian</option>
            <option value='ja/imagick.compositeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.compositeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.compositeimage.php'>Russian</option>
            <option value='tr/imagick.compositeimage.php'>Turkish</option>
            <option value='uk/imagick.compositeimage.php'>Ukrainian</option>
            <option value='zh/imagick.compositeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.compositeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::compositeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::compositeImage</span> &mdash; <span class="dc-title">Composite one image onto another</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.compositeimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::compositeImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$composite_object</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$composite</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.compositeimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">composite_object</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">compose</code></dt>
     <dd>
      <p class="para">
       Composite operator. See <a href="imagick.constants.php#imagick.constants.compositeop" class="link">Composite Operator
       Constants</a>
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       bitwise operators. Refer to this list of <a href="imagick.constants.php#imagick.constants.channel" class="link">channel constants</a>.
      </p>
     </dd>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.setimageartifact.php" class="function" rel="rdfs-seeAlso">Imagick::setImageArtifact()</a> - Set image artifact</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/compositeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.compositeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.compositeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.compositeimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="81060">  <div class="votes">
    <div id="Vu81060">
    <a href="/manual/vote-note.php?id=81060&amp;page=imagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81060">
    <a href="/manual/vote-note.php?id=81060&amp;page=imagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81060" title="68% like this...">
    6
    </div>
  </div>
  <a href="#81060" class="name">
  <strong class="user"><em>m dot roszka at textend dot net</em></strong></a><a class="genanchor" href="#81060"> &para;</a><div class="date" title="2008-02-12 06:55"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81060">
...
<br />{
<br />    </span><span class="comment">// Let's check whether we can perform the magick.
<br />    </span><span class="keyword">if (</span><span class="default">TRUE </span><span class="keyword">!== </span><span class="default">extension_loaded</span><span class="keyword">(</span><span class="string">'imagick'</span><span class="keyword">))
<br />    {
<br />        throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Imagick extension is not loaded.'</span><span class="keyword">);
<br />    }
<br />
<br />    </span><span class="comment">// This check is an alternative to the previous one.
<br />    // Use the one that suits you better.
<br />    </span><span class="keyword">if (</span><span class="default">TRUE </span><span class="keyword">!== </span><span class="default">class_exists</span><span class="keyword">(</span><span class="string">'Imagick'</span><span class="keyword">))
<br />    {
<br />        throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Imagick class does not exist.'</span><span class="keyword">);
<br />    }
<br />
<br />    </span><span class="comment">// Let's find out where we are.
<br />    </span><span class="default">$dir </span><span class="keyword">= </span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">);
<br />
<br />    </span><span class="comment">// Let's read the images.
<br />    </span><span class="default">$glasses </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />    if (</span><span class="default">FALSE </span><span class="keyword">=== </span><span class="default">$glasses</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$dir </span><span class="keyword">. </span><span class="string">'/glasses.png'</span><span class="keyword">))
<br />    {
<br />        throw new </span><span class="default">Exception</span><span class="keyword">();
<br />    }
<br />
<br />    </span><span class="default">$face </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();
<br />    if (</span><span class="default">FALSE </span><span class="keyword">=== </span><span class="default">$face</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$dir </span><span class="keyword">. </span><span class="string">'/face.jpg'</span><span class="keyword">))
<br />    {
<br />        throw new </span><span class="default">Exception</span><span class="keyword">();
<br />    }
<br />
<br />    </span><span class="comment">// Let's put the glasses on (10 pixels from left, 20 pixels from top of face).
<br />    </span><span class="default">$face</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$glasses</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_DEFAULT</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="default">20</span><span class="keyword">);
<br />
<br />    </span><span class="comment">// Let's merge all layers (it is not mandatory).
<br />    </span><span class="default">$face</span><span class="keyword">-&gt;</span><span class="default">flattenImages</span><span class="keyword">();
<br />
<br />    </span><span class="comment">// We do not want to overwrite face.jpg.
<br />    </span><span class="default">$face</span><span class="keyword">-&gt;</span><span class="default">setImageFileName</span><span class="keyword">(</span><span class="default">$dir </span><span class="keyword">. </span><span class="string">'/face_and_glasses.jpg'</span><span class="keyword">);
<br />
<br />    </span><span class="comment">// Let's write the image.
<br />    </span><span class="keyword">if  (</span><span class="default">FALSE </span><span class="keyword">== </span><span class="default">$face</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">())
<br />    {
<br />        throw new </span><span class="default">Exception</span><span class="keyword">();
<br />    }
<br />}
...
<br /></span>Also a couple more words on the Imagick::COMPOSITE_DEFAULT argument. The images we are composing together are separate layers. Not only can we put them in specific order, but we can also choose the way we want them to interfere with each other. And here comes the second argument of the compositeImage method. It can be given either as a constant or as the integer value of that constant. You can use the reflection API of PHP5 to get the list of them.
<br />
<br /><span class="default">&lt;?php
<br />Reflection</span><span class="keyword">::</span><span class="default">export</span><span class="keyword">(new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Imagick'</span><span class="keyword">));
<br /></span><span class="default">?&gt;
<br /></span>
<br />Just look for COMPOSITE_* constants in the "Constants" section.</span></code></div>
  </div>
 </div>
  <div class="note" id="125671">  <div class="votes">
    <div id="Vu125671">
    <a href="/manual/vote-note.php?id=125671&amp;page=imagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125671">
    <a href="/manual/vote-note.php?id=125671&amp;page=imagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125671" title="75% like this...">
    2
    </div>
  </div>
  <a href="#125671" class="name">
  <strong class="user"><em>elizapinchley at google dot com</em></strong></a><a class="genanchor" href="#125671"> &para;</a><div class="date" title="2021-01-10 11:16"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125671">
<div class="phpcode"><code><span class="html">There has been changes to Imagick constants in new version. Please read new list of constants like this.<br /><br /><span class="default">&lt;?php<br /><br />$img </span><span class="keyword">= new </span><span class="default">\Imagick</span><span class="keyword">();<br /></span><span class="default">$reflection_class </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="default">$img</span><span class="keyword">);<br /><br />die(</span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$reflection_class</span><span class="keyword">-&gt;</span><span class="default">getConstants</span><span class="keyword">()));<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="104759">  <div class="votes">
    <div id="Vu104759">
    <a href="/manual/vote-note.php?id=104759&amp;page=imagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd104759">
    <a href="/manual/vote-note.php?id=104759&amp;page=imagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V104759" title="50% like this...">
    0
    </div>
  </div>
  <a href="#104759" class="name">
  <strong class="user"><em>Iddles</em></strong></a><a class="genanchor" href="#104759"> &para;</a><div class="date" title="2011-07-05 10:01"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104759">
<div class="phpcode"><code><span class="html">To copy the alpha channel from one image to another, you can do the following:<br /><br /><span class="default">&lt;?php<br /><br />$img1 </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">"image1.png" </span><span class="keyword">);<br /></span><span class="default">$img2 </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">( </span><span class="string">"image2.png" </span><span class="keyword">);<br /><br /></span><span class="default">$img1</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">( </span><span class="default">$img2</span><span class="keyword">, </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_COPYOPACITY</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0 </span><span class="keyword">);<br /><br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Content-type: image/png'</span><span class="keyword">);<br />echo </span><span class="default">$img1</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="95759">  <div class="votes">
    <div id="Vu95759">
    <a href="/manual/vote-note.php?id=95759&amp;page=imagick.compositeimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd95759">
    <a href="/manual/vote-note.php?id=95759&amp;page=imagick.compositeimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V95759" title="50% like this...">
    0
    </div>
  </div>
  <a href="#95759" class="name">
  <strong class="user"><em>giso at connectholland dot nl</em></strong></a><a class="genanchor" href="#95759"> &para;</a><div class="date" title="2010-01-20 08:30"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom95759">
<div class="phpcode"><code><span class="html">You might need to set the colorspace the same when composing two images over each other
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="comment">//Creating two Imagick object
<br /></span><span class="default">$first </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'first.jpg'</span><span class="keyword">);
<br /></span><span class="default">$second </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'second.jpg'</span><span class="keyword">);
<br />
<br /></span><span class="comment">// Set the colorspace to the same value
<br /></span><span class="default">$first</span><span class="keyword">-&gt;</span><span class="default">setImageColorspace</span><span class="keyword">(</span><span class="default">$second</span><span class="keyword">-&gt;</span><span class="default">getImageColorspace</span><span class="keyword">() );
<br />
<br /></span><span class="comment">//Second image is put on top of the first
<br /></span><span class="default">$first</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">(</span><span class="default">$second</span><span class="keyword">, </span><span class="default">$second</span><span class="keyword">-&gt;</span><span class="default">getImageCompose</span><span class="keyword">(), </span><span class="default">5</span><span class="keyword">, </span><span class="default">5</span><span class="keyword">);
<br />
<br /></span><span class="comment">//new image is saved as final.jpg
<br /></span><span class="default">$first</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'final.jpg'</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.compositeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.compositeimage.php">＋<small>add a note</small></a></div>
