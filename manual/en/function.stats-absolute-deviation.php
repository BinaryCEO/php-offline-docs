...
<head>
  ...
  <title>PHP: stats_absolute_deviation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-absolute-deviation.php">
 <link rel="shorturl" href="https://www.php.net/stats-absolute-deviation">
 <link rel="alternate" href="https://www.php.net/stats-absolute-deviation" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-cdf-beta.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-absolute-deviation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-absolute-deviation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-absolute-deviation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-absolute-deviation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-absolute-deviation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-absolute-deviation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-absolute-deviation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-absolute-deviation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-absolute-deviation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-absolute-deviation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-absolute-deviation.php" hreflang="zh">
...
<meta name="Description" content="Returns the absolute deviation of an array of values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_absolute_deviation - Manual" />
<meta name="twitter:description" content="Returns the absolute deviation of an array of values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_absolute_deviation - Manual" />
<meta itemprop="description" content="Returns the absolute deviation of an array of values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the absolute deviation of an array of values" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-cdf-beta.php">
          stats_cdf_beta &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.stats.php">
          &laquo; Statistic Functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-absolute-deviation.php' selected="selected">English</option>
            <option value='de/function.stats-absolute-deviation.php'>German</option>
            <option value='es/function.stats-absolute-deviation.php'>Spanish</option>
            <option value='fr/function.stats-absolute-deviation.php'>French</option>
            <option value='it/function.stats-absolute-deviation.php'>Italian</option>
            <option value='ja/function.stats-absolute-deviation.php'>Japanese</option>
            <option value='pt_BR/function.stats-absolute-deviation.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-absolute-deviation.php'>Russian</option>
            <option value='tr/function.stats-absolute-deviation.php'>Turkish</option>
            <option value='uk/function.stats-absolute-deviation.php'>Ukrainian</option>
            <option value='zh/function.stats-absolute-deviation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-absolute-deviation" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_absolute_deviation</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_absolute_deviation</span> &mdash; <span class="dc-title">Returns the absolute deviation of an array of values</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-absolute-deviation-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_absolute_deviation</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$a</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   Returns the absolute deviation of the values in <code class="parameter">a</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-absolute-deviation-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-absolute-deviation-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if <code class="parameter">a</code> is empty or is not an array.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-absolute-deviation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-absolute-deviation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-absolute-deviation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-absolute-deviation.php">＋<small>add a note</small></a></span>
