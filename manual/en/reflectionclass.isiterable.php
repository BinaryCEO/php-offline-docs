...
<head>
  ...
  <title>PHP: ReflectionClass::isIterable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isiterable.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isiterable.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isiterable.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isinternal.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isiterateable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isiterable.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isiterable.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isiterable.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isiterable.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isiterable.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isiterable.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isiterable.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isiterable.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isiterable.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isiterable.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isiterable.php" hreflang="zh">
...
<meta name="Description" content="Check whether this class is iterable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isIterable - Manual" />
<meta name="twitter:description" content="Check whether this class is iterable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isIterable - Manual" />
<meta itemprop="description" content="Check whether this class is iterable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check whether this class is iterable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isiterateable.php">
          ReflectionClass::isIterateable &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isinternal.php">
          &laquo; ReflectionClass::isInternal        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isiterable.php' selected="selected">English</option>
            <option value='de/reflectionclass.isiterable.php'>German</option>
            <option value='es/reflectionclass.isiterable.php'>Spanish</option>
            <option value='fr/reflectionclass.isiterable.php'>French</option>
            <option value='it/reflectionclass.isiterable.php'>Italian</option>
            <option value='ja/reflectionclass.isiterable.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isiterable.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isiterable.php'>Russian</option>
            <option value='tr/reflectionclass.isiterable.php'>Turkish</option>
            <option value='uk/reflectionclass.isiterable.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isiterable.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isiterable" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isIterable</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isIterable</span> &mdash; <span class="dc-title">Check whether this class is iterable</span></p>
 ...
 <div class="refsect1 description" id="refsect1-reflectionclass.isiterable-description">
  ...
  <p class="para rdfs-comment">
   Check whether this class is iterable (i.e. can be used inside <a href="control-structures.foreach.php" class="link"><code class="literal">foreach</code></a>).
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionclass.construct.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::__construct()</a> - Constructs a ReflectionClass</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isiterable.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isiterable%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isiterable&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isiterable.php">＋<small>add a note</small></a></span>
