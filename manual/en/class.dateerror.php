...
<head>
  ...
  <title>PHP: DateError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dateerror.php">
 <link rel="shorturl" href="https://www.php.net/dateerror">
 <link rel="alternate" href="https://www.php.net/dateerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/timezones.others.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dateobjecterror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dateerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dateerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dateerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dateerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dateerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dateerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dateerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dateerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dateerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dateerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dateerror.php" hreflang="zh">
...
<meta name="Description" content="The DateError class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateError - Manual" />
<meta name="twitter:description" content="The DateError class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateError - Manual" />
<meta itemprop="description" content="The DateError class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateError class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.dateobjecterror.php">
          DateObjectError &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="timezones.others.php">
          &laquo; Others        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dateerror.php' selected="selected">English</option>
            <option value='de/class.dateerror.php'>German</option>
            <option value='es/class.dateerror.php'>Spanish</option>
            <option value='fr/class.dateerror.php'>French</option>
            <option value='it/class.dateerror.php'>Italian</option>
            <option value='ja/class.dateerror.php'>Japanese</option>
            <option value='pt_BR/class.dateerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.dateerror.php'>Russian</option>
            <option value='tr/class.dateerror.php'>Turkish</option>
            <option value='uk/class.dateerror.php'>Ukrainian</option>
            <option value='zh/class.dateerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dateerror" class="reference">
 <h1 class="title">The DateError class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="dateerror.intro">
   ...
   <p class="para">
    ...
    child-exceptions (<span class="exceptionname"><a href="class.dateobjecterror.php" class="exceptionname">DateObjectError</a></span> and
    <span class="exceptionname"><a href="class.daterangeerror.php" class="exceptionname">DateRangeError</a></span>) which are thrown depending
    on programmer error or range related issues.
   </p>
  </div>


  <div class="section" id="dateerror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateError</strong></strong>
   ...
   <ul class="simplelist">
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dateerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dateerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dateerror.php">＋<small>add a note</small></a></span>
