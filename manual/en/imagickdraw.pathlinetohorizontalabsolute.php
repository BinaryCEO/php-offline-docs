...
<head>
  ...
  <title>PHP: ImagickDraw::pathLineToHorizontalAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalrelative.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathlinetohorizontalabsolute.php" hreflang="zh">
...
<meta name="Description" content="Draws a horizontal line path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathLineToHorizontalAbsolute - Manual" />
<meta name="twitter:description" content="Draws a horizontal line path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathLineToHorizontalAbsolute - Manual" />
<meta itemprop="description" content="Draws a horizontal line path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draws a horizontal line path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathlinetohorizontalrelative.php">
          ImagickDraw::pathLineToHorizontalRelative &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathlinetoabsolute.php">
          &laquo; ImagickDraw::pathLineToAbsolute        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathlinetohorizontalabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathlinetohorizontalabsolute.php'>German</option>
            <option value='es/imagickdraw.pathlinetohorizontalabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathlinetohorizontalabsolute.php'>French</option>
            <option value='it/imagickdraw.pathlinetohorizontalabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathlinetohorizontalabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathlinetohorizontalabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathlinetohorizontalabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathlinetohorizontalabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathlinetohorizontalabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathlinetohorizontalabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathlinetohorizontalabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathLineToHorizontalAbsolute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathLineToHorizontalAbsolute</span> &mdash; <span class="dc-title">Draws a horizontal line path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathlinetohorizontalabsolute-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathLineToHorizontalAbsolute</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathlinetohorizontalabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathlinetohorizontalabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathlinetohorizontalabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathlinetohorizontalabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathlinetohorizontalabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php">＋<small>add a note</small></a></span>
