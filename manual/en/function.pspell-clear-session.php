...
<head>
  ...
  <title>PHP: pspell_clear_session - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pspell-clear-session.php">
 <link rel="shorturl" href="https://www.php.net/pspell-clear-session">
 <link rel="alternate" href="https://www.php.net/pspell-clear-session" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pspell.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pspell-check.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pspell-config-create.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pspell-clear-session.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pspell-clear-session.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pspell-clear-session.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pspell-clear-session.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pspell-clear-session.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pspell-clear-session.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pspell-clear-session.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pspell-clear-session.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pspell-clear-session.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pspell-clear-session.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pspell-clear-session.php" hreflang="zh">
...
<meta name="Description" content="Clear the current session" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pspell_clear_session - Manual" />
<meta name="twitter:description" content="Clear the current session" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pspell_clear_session - Manual" />
<meta itemprop="description" content="Clear the current session" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Clear the current session" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pspell-config-create.php">
          pspell_config_create &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pspell-check.php">
          &laquo; pspell_check        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pspell-clear-session.php' selected="selected">English</option>
            <option value='de/function.pspell-clear-session.php'>German</option>
            <option value='es/function.pspell-clear-session.php'>Spanish</option>
            <option value='fr/function.pspell-clear-session.php'>French</option>
            <option value='it/function.pspell-clear-session.php'>Italian</option>
            <option value='ja/function.pspell-clear-session.php'>Japanese</option>
            <option value='pt_BR/function.pspell-clear-session.php'>Brazilian Portuguese</option>
            <option value='ru/function.pspell-clear-session.php'>Russian</option>
            <option value='tr/function.pspell-clear-session.php'>Turkish</option>
            <option value='uk/function.pspell-clear-session.php'>Ukrainian</option>
            <option value='zh/function.pspell-clear-session.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pspell-clear-session" class="refentry">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$pspell_config </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_config_create</span><span style="color: #007700">(</span><span style="color: #DD0000">"en"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_config_personal</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">, </span><span style="color: #DD0000">"/var/dictionaries/custom.pws"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$pspell </span><span style="color: #007700">= </span><span style="color: #0000BB">pspell_new_config</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell_config</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">pspell_add_to_personal</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">, </span><span style="color: #DD0000">"Vlad"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_clear_session</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">pspell_save_wordlist</span><span style="color: #007700">(</span><span style="color: #0000BB">$pspell</span><span style="color: #007700">);    </span><span style="color: #FF8000">//"Vlad" will not be saved<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pspell/functions/pspell-clear-session.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pspell-clear-session%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pspell-clear-session&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pspell-clear-session.php">＋<small>add a note</small></a></span>
