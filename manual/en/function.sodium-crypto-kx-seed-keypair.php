...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-kx-seed-keypair.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-kx-secretkey.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-kx-server-session-keys.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-kx-seed-keypair.php' selected="selected">English</option>
            ...
            <option value='ru/function.sodium-crypto-kx-seed-keypair.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_kx_seed_keypair</span> &mdash; <span class="dc-title">Description</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-kx-seed-keypair-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-kx-seed-keypair.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-kx-seed-keypair%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-kx-seed-keypair&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-kx-seed-keypair.php">＋<small>add a note</small></a></span>
