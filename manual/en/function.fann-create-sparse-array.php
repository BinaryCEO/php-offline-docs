...
<head>
  ...
  <title>PHP: fann_create_sparse_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-create-sparse-array.php">
 <link rel="shorturl" href="https://www.php.net/fann-create-sparse-array">
 <link rel="alternate" href="https://www.php.net/fann-create-sparse-array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-create-sparse.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-create-standard.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-create-sparse-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-create-sparse-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-create-sparse-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-create-sparse-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-create-sparse-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-create-sparse-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-create-sparse-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-create-sparse-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-create-sparse-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-create-sparse-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-create-sparse-array.php" hreflang="zh">
...
<meta name="Description" content="Creates a standard backpropagation neural network, which is not fully connected using an array of layer sizes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_create_sparse_array - Manual" />
<meta name="twitter:description" content="Creates a standard backpropagation neural network, which is not fully connected using an array of layer sizes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_create_sparse_array - Manual" />
<meta itemprop="description" content="Creates a standard backpropagation neural network, which is not fully connected using an array of layer sizes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a standard backpropagation neural network, which is not fully connected using an array of layer sizes" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-create-standard.php">
          fann_create_standard &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-create-sparse.php">
          &laquo; fann_create_sparse        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-create-sparse-array.php' selected="selected">English</option>
            <option value='de/function.fann-create-sparse-array.php'>German</option>
            <option value='es/function.fann-create-sparse-array.php'>Spanish</option>
            <option value='fr/function.fann-create-sparse-array.php'>French</option>
            <option value='it/function.fann-create-sparse-array.php'>Italian</option>
            <option value='ja/function.fann-create-sparse-array.php'>Japanese</option>
            <option value='pt_BR/function.fann-create-sparse-array.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-create-sparse-array.php'>Russian</option>
            <option value='tr/function.fann-create-sparse-array.php'>Turkish</option>
            <option value='uk/function.fann-create-sparse-array.php'>Ukrainian</option>
            <option value='zh/function.fann-create-sparse-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-create-sparse-array" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-create-shortcut.php" class="function" rel="rdfs-seeAlso">fann_create_shortcut()</a> - Creates a standard backpropagation neural network which is not fully connectected and has shortcut connections</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-create-sparse-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-create-sparse-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-create-sparse-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-create-sparse-array.php">＋<small>add a note</small></a></span>
