...
<head>
  ...
  <title>PHP: pg_lo_create - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-create.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-create">
 <link rel="alternate" href="https://www.php.net/pg-lo-create" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-export.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-create.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-create.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-create.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-create.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-create.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-create.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-create.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-create.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-create.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-create.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-create.php" hreflang="zh">
...
<meta name="Description" content="Create a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_create - Manual" />
<meta name="twitter:description" content="Create a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_create - Manual" />
<meta itemprop="description" content="Create a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a large object" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-create.php' selected="selected">English</option>
            <option value='de/function.pg-lo-create.php'>German</option>
            <option value='es/function.pg-lo-create.php'>Spanish</option>
            <option value='fr/function.pg-lo-create.php'>French</option>
            <option value='it/function.pg-lo-create.php'>Italian</option>
            <option value='ja/function.pg-lo-create.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-create.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-create.php'>Russian</option>
            <option value='tr/function.pg-lo-create.php'>Turkish</option>
            <option value='uk/function.pg-lo-create.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-create.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-create" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_lo_create</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_lo_create</span> &mdash; <span class="dc-title">Create a large object</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.pg-lo-create-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_lo_create</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$object_id</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <div class="methodsynopsis dc-description"><span class="methodname"><strong>pg_lo_create</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$object_id</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
  ...
  <p class="para">
   ...
   column type and <span class="function"><a href="function.pg-escape-bytea.php" class="function">pg_escape_bytea()</a></span>.
  </p>
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-lo-create-returnvalues">
  ...
  <p class="para">
   A large object <var class="varname">OID</var>,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $database </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=jacarta"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"begin"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">$oid </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_create</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">);<br />   echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$oid</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_lo_open</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #0000BB">$oid</span><span style="color: #007700">, </span><span style="color: #DD0000">"w"</span><span style="color: #007700">);<br />   echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$handle</span><span style="color: #DD0000">\n"</span><span style="color: #007700">;<br />   </span><span style="color: #0000BB">pg_lo_write</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #DD0000">"large object data"</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_lo_close</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">);<br />   </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$database</span><span style="color: #007700">, </span><span style="color: #DD0000">"commit"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-create.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="31828">  <div class="votes">
    <div id="Vu31828">
    <a href="/manual/vote-note.php?id=31828&amp;page=function.pg-lo-create&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31828">
    <a href="/manual/vote-note.php?id=31828&amp;page=function.pg-lo-create&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31828" title="50% like this...">
    0
    </div>
  </div>
  <a href="#31828" class="name">
  <strong class="user"><em>andrea dot galli at acotel dot com</em></strong></a><a class="genanchor" href="#31828"> &para;</a><div class="date" title="2003-05-05 10:21"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31828">
...
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-create.php">＋<small>add a note</small></a></div>
