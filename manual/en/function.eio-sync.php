...
<head>
  ...
  <title>PHP: eio_sync - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-sync.php">
 <link rel="shorturl" href="https://www.php.net/eio-sync">
 <link rel="alternate" href="https://www.php.net/eio-sync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-symlink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-sync-file-range.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-sync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-sync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-sync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-sync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-sync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-sync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-sync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-sync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-sync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-sync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-sync.php" hreflang="zh">
...
<meta name="Description" content="Commit buffer cache to disk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_sync - Manual" />
<meta name="twitter:description" content="Commit buffer cache to disk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_sync - Manual" />
<meta itemprop="description" content="Commit buffer cache to disk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Commit buffer cache to disk" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-sync.php' selected="selected">English</option>
            <option value='de/function.eio-sync.php'>German</option>
            <option value='es/function.eio-sync.php'>Spanish</option>
            <option value='fr/function.eio-sync.php'>French</option>
            <option value='it/function.eio-sync.php'>Italian</option>
            <option value='ja/function.eio-sync.php'>Japanese</option>
            <option value='pt_BR/function.eio-sync.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-sync.php'>Russian</option>
            <option value='tr/function.eio-sync.php'>Turkish</option>
            <option value='uk/function.eio-sync.php'>Ukrainian</option>
            <option value='zh/function.eio-sync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-sync" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-sync-returnvalues">
  ...
  <p class="para">
   <span class="function"><strong>eio_sync()</strong></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-sync.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-sync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-sync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-sync.php">＋<small>add a note</small></a></span>
