...
<head>
  ...
  <title>PHP: LengthException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.lengthexception.php">
 <link rel="shorturl" href="https://www.php.net/lengthexception">
 <link rel="alternate" href="https://www.php.net/lengthexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.invalidargumentexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.logicexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.lengthexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.lengthexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.lengthexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.lengthexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.lengthexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.lengthexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.lengthexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.lengthexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.lengthexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.lengthexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.lengthexception.php" hreflang="zh">
...
<meta name="Description" content="The LengthException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: LengthException - Manual" />
<meta name="twitter:description" content="The LengthException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: LengthException - Manual" />
<meta itemprop="description" content="The LengthException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The LengthException class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.logicexception.php">
          LogicException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.invalidargumentexception.php">
          &laquo; InvalidArgumentException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.lengthexception.php' selected="selected">English</option>
            <option value='de/class.lengthexception.php'>German</option>
            <option value='es/class.lengthexception.php'>Spanish</option>
            <option value='fr/class.lengthexception.php'>French</option>
            <option value='it/class.lengthexception.php'>Italian</option>
            <option value='ja/class.lengthexception.php'>Japanese</option>
            <option value='pt_BR/class.lengthexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.lengthexception.php'>Russian</option>
            <option value='tr/class.lengthexception.php'>Turkish</option>
            <option value='uk/class.lengthexception.php'>Ukrainian</option>
            <option value='zh/class.lengthexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.lengthexception" class="reference">
 <h1 class="title">The LengthException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p>
 

  <div class="section" id="lengthexception.intro">
  ...
  <div class="section" id="lengthexception.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">LengthException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/lengthexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.lengthexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.lengthexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.lengthexception.php">＋<small>add a note</small></a></span>
