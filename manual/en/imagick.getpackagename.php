...
<head>
  ...
  <title>PHP: Imagick::getPackageName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getpackagename.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getpackagename.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpackagename.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getoption.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getpage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getpackagename.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getpackagename.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getpackagename.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getpackagename.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getpackagename.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getpackagename.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getpackagename.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getpackagename.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getpackagename.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getpackagename.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getpackagename.php" hreflang="zh">
...
<meta name="Description" content="Returns the ImageMagick package name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getPackageName - Manual" />
<meta name="twitter:description" content="Returns the ImageMagick package name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getPackageName - Manual" />
<meta itemprop="description" content="Returns the ImageMagick package name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the ImageMagick package name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getpage.php">
          Imagick::getPage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getoption.php">
          &laquo; Imagick::getOption        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getpackagename.php' selected="selected">English</option>
            <option value='de/imagick.getpackagename.php'>German</option>
            <option value='es/imagick.getpackagename.php'>Spanish</option>
            <option value='fr/imagick.getpackagename.php'>French</option>
            <option value='it/imagick.getpackagename.php'>Italian</option>
            <option value='ja/imagick.getpackagename.php'>Japanese</option>
            <option value='pt_BR/imagick.getpackagename.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getpackagename.php'>Russian</option>
            <option value='tr/imagick.getpackagename.php'>Turkish</option>
            <option value='uk/imagick.getpackagename.php'>Ukrainian</option>
            <option value='zh/imagick.getpackagename.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getpackagename" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getPackageName</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getPackageName</span> &mdash; <span class="dc-title">Returns the ImageMagick package name</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getpackagename-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getPackageName</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getpackagename-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getpackagename-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getpackagename-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getpackagename.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getpackagename%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getpackagename&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getpackagename.php">＋<small>add a note</small></a></span>
