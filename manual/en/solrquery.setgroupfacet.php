...
<head>
  ...
  <title>PHP: SolrQuery::setGroupFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setgroupcachepercent.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setgroupformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setgroupfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setgroupfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setgroupfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setgroupfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setgroupfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setgroupfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setgroupfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setgroupfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setgroupfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setgroupfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setgroupfacet.php" hreflang="zh">
...
<meta name="Description" content="Sets group.facet parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setGroupFacet - Manual" />
<meta name="twitter:description" content="Sets group.facet parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setGroupFacet - Manual" />
<meta itemprop="description" content="Sets group.facet parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets group.facet parameter" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setgroupformat.php">
          SolrQuery::setGroupFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setgroupcachepercent.php">
          &laquo; SolrQuery::setGroupCachePercent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setgroupfacet.php' selected="selected">English</option>
            <option value='de/solrquery.setgroupfacet.php'>German</option>
            <option value='es/solrquery.setgroupfacet.php'>Spanish</option>
            <option value='fr/solrquery.setgroupfacet.php'>French</option>
            <option value='it/solrquery.setgroupfacet.php'>Italian</option>
            <option value='ja/solrquery.setgroupfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.setgroupfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setgroupfacet.php'>Russian</option>
            <option value='tr/solrquery.setgroupfacet.php'>Turkish</option>
            <option value='uk/solrquery.setgroupfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.setgroupfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setgroupfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setGroupFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setGroupFacet</span> &mdash; <span class="dc-title">Sets group.facet parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setgroupfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setGroupFacet</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setgroupfacet-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setgroupfacet-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.setgroupfacet-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.setgroupcachepercent.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupCachePercent()</a> - Enables caching for result grouping</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setgroupfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setgroupfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setgroupfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setgroupfacet.php">＋<small>add a note</small></a></span>
