...
<head>
  ...
  <title>PHP: Phar::getPath - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.getpath.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.getpath.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.getpath.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.getmodified.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.getsignature.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.getpath.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.getpath.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.getpath.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.getpath.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.getpath.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.getpath.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.getpath.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.getpath.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.getpath.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.getpath.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.getpath.php" hreflang="zh">
...
<meta name="Description" content="Get the real path to the Phar archive on disk" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::getPath - Manual" />
<meta name="twitter:description" content="Get the real path to the Phar archive on disk" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::getPath - Manual" />
<meta itemprop="description" content="Get the real path to the Phar archive on disk" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the real path to the Phar archive on disk" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.getsignature.php">
          Phar::getSignature &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.getmodified.php">
          &laquo; Phar::getModified        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.getpath.php' selected="selected">English</option>
            <option value='de/phar.getpath.php'>German</option>
            <option value='es/phar.getpath.php'>Spanish</option>
            <option value='fr/phar.getpath.php'>French</option>
            <option value='it/phar.getpath.php'>Italian</option>
            <option value='ja/phar.getpath.php'>Japanese</option>
            <option value='pt_BR/phar.getpath.php'>Brazilian Portuguese</option>
            <option value='ru/phar.getpath.php'>Russian</option>
            <option value='tr/phar.getpath.php'>Turkish</option>
            <option value='uk/phar.getpath.php'>Ukrainian</option>
            <option value='zh/phar.getpath.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.getpath" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::getPath</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">Phar::getPath</span> &mdash; <span class="dc-title">Get the real path to the Phar archive on disk</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-phar.getpath-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::getPath</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-phar.getpath-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-phar.getpath-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/getPath.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.getpath%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.getpath&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.getpath.php">＋<small>add a note</small></a></span>
