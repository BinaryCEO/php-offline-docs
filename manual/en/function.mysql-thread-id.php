...
<head>
  ...
  <title>PHP: mysql_thread_id - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-thread-id.php">
 <link rel="shorturl" href="https://www.php.net/mysql-thread-id">
 <link rel="alternate" href="https://www.php.net/mysql-thread-id" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-tablename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-unbuffered-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-thread-id.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-thread-id.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-thread-id.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-thread-id.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-thread-id.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-thread-id.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-thread-id.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-thread-id.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-thread-id.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-thread-id.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-thread-id.php" hreflang="zh">
...
<meta name="Description" content="Return the current thread ID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_thread_id - Manual" />
<meta name="twitter:description" content="Return the current thread ID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_thread_id - Manual" />
<meta itemprop="description" content="Return the current thread ID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return the current thread ID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mysql-unbuffered-query.php">
          mysql_unbuffered_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mysql-tablename.php">
          &laquo; mysql_tablename        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-thread-id.php' selected="selected">English</option>
            <option value='de/function.mysql-thread-id.php'>German</option>
            <option value='es/function.mysql-thread-id.php'>Spanish</option>
            <option value='fr/function.mysql-thread-id.php'>French</option>
            <option value='it/function.mysql-thread-id.php'>Italian</option>
            <option value='ja/function.mysql-thread-id.php'>Japanese</option>
            <option value='pt_BR/function.mysql-thread-id.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-thread-id.php'>Russian</option>
            <option value='tr/function.mysql-thread-id.php'>Turkish</option>
            <option value='uk/function.mysql-thread-id.php'>Ukrainian</option>
            <option value='zh/function.mysql-thread-id.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-thread-id" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysql_thread_id</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5)</p><p class="refpurpose"><span class="refname">mysql_thread_id</span> &mdash; <span class="dc-title">Return the current thread ID</span></p>

 </div>

 <div id="function.mysql-thread-id-refsynopsisdiv">
...
Alternatives to this function include:</p>
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.thread-id.php" class="function">mysqli_thread_id()</a></span></li>
   </ul>
  </div>
 </div>

 <div class="refsect1 description" id="refsect1-function.mysql-thread-id-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysql_thread_id</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$link_identifier</code><span class="initializer"> = NULL</span></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Retrieves the current thread ID. If the connection is lost, and a reconnect 
   with <span class="function"><a href="function.mysql-ping.php" class="function">mysql_ping()</a></span> is executed, the thread ID will 
   change. This means only retrieve the thread ID when needed.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.mysql-thread-id-parameters">
...
<div class="examplescode"><pre class="examplescode">current thread id is 73</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.mysql-thread-id-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.mysql-ping.php" class="function" rel="rdfs-seeAlso">mysql_ping()</a> - Ping a server connection or reconnect if there is no connection</span></li>
    <li><span class="function"><a href="function.mysql-list-processes.php" class="function" rel="rdfs-seeAlso">mysql_list_processes()</a> - List MySQL processes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-thread-id.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-thread-id%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-thread-id&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-thread-id.php">＋<small>add a note</small></a></span>
