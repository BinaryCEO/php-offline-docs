...
<head>
  ...
  <title>PHP: trader_avgprice - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-avgprice.php">
 <link rel="shorturl" href="https://www.php.net/trader-avgprice">
 <link rel="alternate" href="https://www.php.net/trader-avgprice" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-atr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-bbands.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-avgprice.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-avgprice.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-avgprice.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-avgprice.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-avgprice.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-avgprice.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-avgprice.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-avgprice.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-avgprice.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-avgprice.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-avgprice.php" hreflang="zh">
...
<meta name="Description" content="Average Price" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_avgprice - Manual" />
<meta name="twitter:description" content="Average Price" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_avgprice - Manual" />
<meta itemprop="description" content="Average Price" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Average Price" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-bbands.php">
          trader_bbands &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-atr.php">
          &laquo; trader_atr        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-avgprice.php' selected="selected">English</option>
            <option value='de/function.trader-avgprice.php'>German</option>
            <option value='es/function.trader-avgprice.php'>Spanish</option>
            <option value='fr/function.trader-avgprice.php'>French</option>
            <option value='it/function.trader-avgprice.php'>Italian</option>
            <option value='ja/function.trader-avgprice.php'>Japanese</option>
            <option value='pt_BR/function.trader-avgprice.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-avgprice.php'>Russian</option>
            <option value='tr/function.trader-avgprice.php'>Turkish</option>
            <option value='uk/function.trader-avgprice.php'>Ukrainian</option>
            <option value='zh/function.trader-avgprice.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-avgprice" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_avgprice</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_avgprice</span> &mdash; <span class="dc-title">Average Price</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-avgprice-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_avgprice</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$open</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$high</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$low</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$close</code></span><br>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-avgprice-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-avgprice-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-avgprice.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-avgprice%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-avgprice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-avgprice.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125745">  <div class="votes">
    <div id="Vu125745">
    <a href="/manual/vote-note.php?id=125745&amp;page=function.trader-avgprice&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125745">
    <a href="/manual/vote-note.php?id=125745&amp;page=function.trader-avgprice&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125745" title="66% like this...">
    1
    </div>
  </div>
  <a href="#125745" class="name">
  <strong class="user"><em>geekgirl dot joy at gmail dot com</em></strong></a><a class="genanchor" href="#125745"> &para;</a><div class="date" title="2021-01-31 06:35"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125745">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br />$p </span><span class="keyword">=  </span><span class="default">trader_avgprice</span><span class="keyword">([</span><span class="default">1</span><span class="keyword">,</span><span class="default">2</span><span class="keyword">] , [</span><span class="default">1.2</span><span class="keyword">, </span><span class="default">3</span><span class="keyword">] , [</span><span class="default">0.99</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">] , [</span><span class="default">1.2</span><span class="keyword">, </span><span class="default">2.5</span><span class="keyword">]);<br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">);<br /></span><span class="comment">/*<br />array(2) {<br />  [0]=&gt;<br />  float(1.097) // (1 + 1.2 + 0.99 + 1.2) / 4<br />  [1]=&gt;<br />  float(2.375) // (2 + 3 + 2 + 2.5) / 4<br />}<br />*/</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-avgprice&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-avgprice.php">＋<small>add a note</small></a></div>
