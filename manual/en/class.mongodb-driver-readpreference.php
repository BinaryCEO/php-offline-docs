...
<head>
  ...
  <title>PHP: MongoDB\Driver\ReadPreference - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-readpreference.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-readpreference">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-readpreference" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-writeconcern.isdefault.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-readpreference.bsonserialize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-readpreference.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-readpreference.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-readpreference.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-readpreference.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-readpreference.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-readpreference.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-readpreference.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-readpreference.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-readpreference.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-readpreference.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-readpreference.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\ReadPreference class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\ReadPreference - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\ReadPreference class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\ReadPreference - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\ReadPreference class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\ReadPreference class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-driver-readpreference.bsonserialize.php">
          MongoDB\Driver\ReadPreference::bsonSerialize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-writeconcern.isdefault.php">
          &laquo; MongoDB\Driver\WriteConcern::isDefault        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-readpreference.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-readpreference.php'>German</option>
            <option value='es/class.mongodb-driver-readpreference.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-readpreference.php'>French</option>
            <option value='it/class.mongodb-driver-readpreference.php'>Italian</option>
            <option value='ja/class.mongodb-driver-readpreference.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-readpreference.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-readpreference.php'>Russian</option>
            <option value='tr/class.mongodb-driver-readpreference.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-readpreference.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-readpreference.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-readpreference" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-readpreference.bsonserialize.php">MongoDB\Driver\ReadPreference::bsonSerialize</a> — Returns an object for BSON serialization</li><li><a href="mongodb-driver-readpreference.construct.php">MongoDB\Driver\ReadPreference::__construct</a> — Create a new ReadPreference</li><li><a href="mongodb-driver-readpreference.gethedge.php">MongoDB\Driver\ReadPreference::getHedge</a> — Returns the ReadPreference's &quot;hedge&quot; option</li><li><a href="mongodb-driver-readpreference.getmaxstalenessseconds.php">MongoDB\Driver\ReadPreference::getMaxStalenessSeconds</a> — Returns the ReadPreference's &quot;maxStalenessSeconds&quot; option</li><li><a href="mongodb-driver-readpreference.getmode.php">MongoDB\Driver\ReadPreference::getMode</a> — Returns the ReadPreference's &quot;mode&quot; option</li><li><a href="mongodb-driver-readpreference.getmodestring.php">MongoDB\Driver\ReadPreference::getModeString</a> — Returns the ReadPreference's &quot;mode&quot; option</li><li><a href="mongodb-driver-readpreference.gettagsets.php">MongoDB\Driver\ReadPreference::getTagSets</a> — Returns the ReadPreference's &quot;tagSets&quot; option</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/readpreference.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-readpreference%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-readpreference&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-readpreference.php">＋<small>add a note</small></a></span>
