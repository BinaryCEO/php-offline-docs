...
<head>
  ...
  <title>PHP: IntlChar::isMirrored - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.ismirrored.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.ismirrored.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.ismirrored.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.islower.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.isprint.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.ismirrored.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.ismirrored.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.ismirrored.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.ismirrored.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.ismirrored.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.ismirrored.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.ismirrored.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.ismirrored.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.ismirrored.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.ismirrored.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.ismirrored.php" hreflang="zh">
...
<meta name="Description" content="Check if code point has the Bidi_Mirrored property" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::isMirrored - Manual" />
<meta name="twitter:description" content="Check if code point has the Bidi_Mirrored property" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::isMirrored - Manual" />
<meta itemprop="description" content="Check if code point has the Bidi_Mirrored property" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if code point has the Bidi_Mirrored property" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.isprint.php">
          IntlChar::isprint &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.islower.php">
          &laquo; IntlChar::islower        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.ismirrored.php' selected="selected">English</option>
            <option value='de/intlchar.ismirrored.php'>German</option>
            <option value='es/intlchar.ismirrored.php'>Spanish</option>
            <option value='fr/intlchar.ismirrored.php'>French</option>
            <option value='it/intlchar.ismirrored.php'>Italian</option>
            <option value='ja/intlchar.ismirrored.php'>Japanese</option>
            <option value='pt_BR/intlchar.ismirrored.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.ismirrored.php'>Russian</option>
            <option value='tr/intlchar.ismirrored.php'>Turkish</option>
            <option value='uk/intlchar.ismirrored.php'>Ukrainian</option>
            <option value='zh/intlchar.ismirrored.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.ismirrored" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::isMirrored</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::isMirrored</span> &mdash; <span class="dc-title">Check if code point has the Bidi_Mirrored property</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlchar.ismirrored-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>IntlChar::isMirrored</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$codepoint</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-intlchar.ismirrored-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.ismirrored-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if
   <code class="parameter">codepoint</code> has the Bidi_Mirrored property, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not. Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-intlchar.ismirrored-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-2736">
   <p><strong>Example #1 Testing different code points</strong></p>
   <div class="example-contents">
    <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isMirrored</span><span style="color: #007700">(</span><span style="color: #DD0000">"A"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isMirrored</span><span style="color: #007700">(</span><span style="color: #DD0000">"&lt;"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">IntlChar</span><span style="color: #007700">::</span><span style="color: #0000BB">isMirrored</span><span style="color: #007700">(</span><span style="color: #DD0000">"("</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlchar.ismirrored-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="intlchar.charmirror.php" class="function" rel="rdfs-seeAlso">IntlChar::charMirror()</a> - Get the &quot;mirror-image&quot; character for a code point</span></li>
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-bidi-mirrored">IntlChar::PROPERTY_BIDI_MIRRORED</a></code></strong></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/ismirrored.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.ismirrored%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.ismirrored&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.ismirrored.php">＋<small>add a note</small></a></span>
