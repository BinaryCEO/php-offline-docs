...
<head>
  ...
  <title>PHP: pg_options - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-options.php">
 <link rel="shorturl" href="https://www.php.net/pg-options">
 <link rel="alternate" href="https://www.php.net/pg-options" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-num-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-parameter-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-options.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-options.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-options.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-options.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-options.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-options.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-options.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-options.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-options.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-options.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-options.php" hreflang="zh">
...
<meta name="Description" content="Get the options associated with the connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_options - Manual" />
<meta name="twitter:description" content="Get the options associated with the connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_options - Manual" />
<meta itemprop="description" content="Get the options associated with the connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the options associated with the connection" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-options.php' selected="selected">English</option>
            <option value='de/function.pg-options.php'>German</option>
            <option value='es/function.pg-options.php'>Spanish</option>
            <option value='fr/function.pg-options.php'>French</option>
            <option value='it/function.pg-options.php'>Italian</option>
            <option value='ja/function.pg-options.php'>Japanese</option>
            <option value='pt_BR/function.pg-options.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-options.php'>Russian</option>
            <option value='tr/function.pg-options.php'>Turkish</option>
            <option value='uk/function.pg-options.php'>Ukrainian</option>
            <option value='zh/function.pg-options.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-options" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_options</h1> 
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_options</span> &mdash; <span class="dc-title">Get the options associated with the connection</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-options-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_options</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_options()</strong></span> will return a string containing
 ...
 <div class="refsect1 parameters" id="refsect1-function.pg-options-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-options-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   A <span class="type"><a href="language.types.string.php" class="type string">string</a></span> containing the <code class="parameter">connection</code>
   options.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-options-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-options-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2096">
    <p><strong>Example #1 <span class="function"><strong>pg_options()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />   $pgsql_conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_connect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=mark host=localhost"</span><span style="color: #007700">);<br />   echo </span><span style="color: #0000BB">pg_options</span><span style="color: #007700">(</span><span style="color: #0000BB">$pgsql_conn</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-options-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-connect.php" class="function" rel="rdfs-seeAlso">pg_connect()</a> - Open a PostgreSQL connection</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-options.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-options%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-options.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="48602">  <div class="votes">
    <div id="Vu48602">
    <a href="/manual/vote-note.php?id=48602&amp;page=function.pg-options&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd48602">
    <a href="/manual/vote-note.php?id=48602&amp;page=function.pg-options&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V48602" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#48602" class="name">
  <strong class="user"><em>Robert Treat &lt;xzilla at sourceforge&gt;</em></strong></a><a class="genanchor" href="#48602"> &para;</a><div class="date" title="2004-12-31 08:07"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom48602">
<div class="phpcode"><code><span class="html">Apparently this function does not return the database name given in the connection string.  I tried this on apache 2.x/php4.3.x/pg7.4.x and apache 1.3.x/php5.x/pg8rc1 and saw this behavior on both setups.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-options.php">＋<small>add a note</small></a></div>
