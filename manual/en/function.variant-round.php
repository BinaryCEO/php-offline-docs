...
<head>
  ...
  <title>PHP: variant_round - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-round.php">
 <link rel="shorturl" href="https://www.php.net/variant-round">
 <link rel="alternate" href="https://www.php.net/variant-round" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-pow.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-set.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-round.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-round.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-round.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-round.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-round.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-round.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-round.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-round.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-round.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-round.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-round.php" hreflang="zh">
...
<meta name="Description" content="Rounds a variant to the specified number of decimal places" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_round - Manual" />
<meta name="twitter:description" content="Rounds a variant to the specified number of decimal places" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_round - Manual" />
<meta itemprop="description" content="Rounds a variant to the specified number of decimal places" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rounds a variant to the specified number of decimal places" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-round.php' selected="selected">English</option>
            <option value='de/function.variant-round.php'>German</option>
            <option value='es/function.variant-round.php'>Spanish</option>
            <option value='fr/function.variant-round.php'>French</option>
            <option value='it/function.variant-round.php'>Italian</option>
            <option value='ja/function.variant-round.php'>Japanese</option>
            <option value='pt_BR/function.variant-round.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-round.php'>Russian</option>
            <option value='tr/function.variant-round.php'>Turkish</option>
            <option value='uk/function.variant-round.php'>Ukrainian</option>
            <option value='zh/function.variant-round.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-round" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_round</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_round</span> &mdash; <span class="dc-title">Rounds a variant to the specified number of decimal places</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.variant-round-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>variant_round</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$decimals</code></span>): <span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="class.variant.php" class="type variant">variant</a></span></span></div>

  <p class="para rdfs-comment">
   Returns the value of <code class="parameter">value</code> rounded to
   <code class="parameter">decimals</code> decimal places.
  </p>
 </div>
...
<p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.variant-round-returnvalues">
  ...
  <p class="para">
   Returns the rounded value, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.round.php" class="function" rel="rdfs-seeAlso">round()</a> - Rounds a float</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-round.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-round%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-round&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-round.php">＋<small>add a note</small></a></span>
