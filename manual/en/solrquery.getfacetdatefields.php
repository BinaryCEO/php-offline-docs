...
<head>
  ...
  <title>PHP: SolrQuery::getFacetDateFields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetdatefields.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetdatefields.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatefields.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetdateend.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetdategap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatefields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetdatefields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetdatefields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetdatefields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetdatefields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetdatefields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetdatefields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetdatefields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetdatefields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetdatefields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetdatefields.php" hreflang="zh">
...
<meta name="Description" content="Returns all the facet.date fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetDateFields - Manual" />
<meta name="twitter:description" content="Returns all the facet.date fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetDateFields - Manual" />
<meta itemprop="description" content="Returns all the facet.date fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the facet.date fields" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getfacetdategap.php">
          SolrQuery::getFacetDateGap &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetdateend.php">
          &laquo; SolrQuery::getFacetDateEnd        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetdatefields.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetdatefields.php'>German</option>
            <option value='es/solrquery.getfacetdatefields.php'>Spanish</option>
            <option value='fr/solrquery.getfacetdatefields.php'>French</option>
            <option value='it/solrquery.getfacetdatefields.php'>Italian</option>
            <option value='ja/solrquery.getfacetdatefields.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetdatefields.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetdatefields.php'>Russian</option>
            <option value='tr/solrquery.getfacetdatefields.php'>Turkish</option>
            <option value='uk/solrquery.getfacetdatefields.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetdatefields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetdatefields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetDateFields</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetDateFields</span> &mdash; <span class="dc-title">Returns all the facet.date fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetdatefields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetDateFields</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetdatefields-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetdatefields-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns all the facet.date fields as an array or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if none was set
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetdatefields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetdatefields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetdatefields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetdatefields.php">＋<small>add a note</small></a></span>
