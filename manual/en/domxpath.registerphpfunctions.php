...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/domxpath.registerphpfunctions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/domxpath.registerphpfunctions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/domxpath.registerphpfunctions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.domxpath.php">
 <link rel="prev" href="https://www.php.net/manual/en/domxpath.registerphpfunctionns.php">
 <link rel="next" href="https://www.php.net/manual/en/enum.dom-adjacentposition.php">
...
<meta name="Description" content="Register PHP functions as XPath functions" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DOMXPath::registerPhpFunctions - Manual" />
<meta name="twitter:description" content="Register PHP functions as XPath functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DOMXPath::registerPhpFunctions - Manual" />
<meta itemprop="description" content="Register PHP functions as XPath functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register PHP functions as XPath functions" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/domxpath.registerphpfunctions.php' selected="selected">English</option>
            ...
            <option value='pt_BR/domxpath.registerphpfunctions.php'>Brazilian Portuguese</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="xsltprocessor.registerphpfunctions.php" class="methodname" rel="rdfs-seeAlso">XSLTProcessor::registerPHPFunctions()</a> - Enables the ability to use PHP functions as XSLT functions</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/domxpath/registerphpfunctions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fdomxpath.registerphpfunctions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=domxpath.registerphpfunctions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/domxpath.registerphpfunctions.php">＋<small>add a note</small></a></span>
