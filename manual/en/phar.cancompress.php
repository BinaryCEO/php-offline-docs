...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.cancompress.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.cancompress.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.cancompress.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.buildfromiterator.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.canwrite.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.cancompress.php' selected="selected">English</option>
            ...
            <option value='tr/phar.cancompress.php'>Turkish</option>
 ...
 <div class="refsect1 examples" id="refsect1-phar.cancompress-examples">
  ...
  <p class="para">
   <div class="example" id="example-804">
    <p><strong>Example #1 A <span class="function"><strong>Phar::canCompress()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.converttodata.php" class="function" rel="rdfs-seeAlso">Phar::convertToData()</a> - Convert a phar archive to a non-executable tar or zip file</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/canCompress.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.cancompress%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.cancompress&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.cancompress.php">＋<small>add a note</small></a></span>
