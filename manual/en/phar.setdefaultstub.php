...
<head>
  ...
  <title>PHP: Phar::setDefaultStub - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.setdefaultstub.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.setdefaultstub.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.setdefaultstub.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.setalias.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.setmetadata.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.setdefaultstub.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.setdefaultstub.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.setdefaultstub.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.setdefaultstub.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.setdefaultstub.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.setdefaultstub.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.setdefaultstub.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.setdefaultstub.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.setdefaultstub.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.setdefaultstub.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.setdefaultstub.php" hreflang="zh">
...
<meta name="Description" content="Used to set the PHP loader or bootstrap stub of a Phar archive to the default loader" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::setDefaultStub - Manual" />
<meta name="twitter:description" content="Used to set the PHP loader or bootstrap stub of a Phar archive to the default loader" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::setDefaultStub - Manual" />
<meta itemprop="description" content="Used to set the PHP loader or bootstrap stub of a Phar archive to the default loader" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Used to set the PHP loader or bootstrap stub of a Phar archive to the default loader" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.setmetadata.php">
          Phar::setMetadata &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.setalias.php">
          &laquo; Phar::setAlias        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.setdefaultstub.php' selected="selected">English</option>
            <option value='de/phar.setdefaultstub.php'>German</option>
            <option value='es/phar.setdefaultstub.php'>Spanish</option>
            <option value='fr/phar.setdefaultstub.php'>French</option>
            <option value='it/phar.setdefaultstub.php'>Italian</option>
            <option value='ja/phar.setdefaultstub.php'>Japanese</option>
            <option value='pt_BR/phar.setdefaultstub.php'>Brazilian Portuguese</option>
            <option value='ru/phar.setdefaultstub.php'>Russian</option>
            <option value='tr/phar.setdefaultstub.php'>Turkish</option>
            <option value='uk/phar.setdefaultstub.php'>Ukrainian</option>
            <option value='zh/phar.setdefaultstub.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.setdefaultstub" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::setDefaultStub</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 2.0.0)</p><p class="refpurpose"><span class="refname">Phar::setDefaultStub</span> &mdash; <span class="dc-title">Used to set the PHP loader or bootstrap stub of a Phar archive to the default loader</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-phar.setdefaultstub-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Phar::setDefaultStub</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$index</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>, <span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$webIndex</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
  <p class="para">
   ...
   <span class="function"><a href="phar.createdefaultstub.php" class="function">Phar::createDefaultStub()</a></span> and <span class="function"><a href="phar.setstub.php" class="function">Phar::setStub()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-phar.setdefaultstub-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.setdefaultstub-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-phar.setdefaultstub-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-phar.setdefaultstub-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       <span class="methodname"><strong>Phar::setDefaultStub()</strong></span>
     ...
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">webIndex</code> is nullable now.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-phar.setdefaultstub-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-836">
    <p><strong>Example #1 A <span class="function"><strong>Phar::setDefaultStub()</strong></span> example</strong></p>
    <div class="example-contents"><p>
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$phar </span><span style="color: #007700">= new </span><span style="color: #0000BB">Phar</span><span style="color: #007700">(</span><span style="color: #DD0000">'myphar.phar'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$phar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setDefaultStub</span><span style="color: #007700">(</span><span style="color: #DD0000">'cli.php'</span><span style="color: #007700">, </span><span style="color: #DD0000">'web/index.php'</span><span style="color: #007700">);<br />    </span><span style="color: #FF8000">// this is the same as:<br />    // $phar-&gt;setStub($phar-&gt;createDefaultStub('cli.php', 'web/index.php'));<br /></span><span style="color: #007700">} catch (</span><span style="color: #0000BB">Exception $e</span><span style="color: #007700">) {<br />    </span><span style="color: #FF8000">// handle errors<br /></span><span style="color: #007700">}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-phar.setdefaultstub-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.createdefaultstub.php" class="function" rel="rdfs-seeAlso">Phar::createDefaultStub()</a> - Create a phar-file format specific stub</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/setDefaultStub.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.setdefaultstub%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.setdefaultstub&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.setdefaultstub.php">＋<small>add a note</small></a></span>
