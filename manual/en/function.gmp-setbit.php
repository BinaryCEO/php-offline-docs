...
<head>
  ...
  <title>PHP: gmp_setbit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-setbit.php">
 <link rel="shorturl" href="https://www.php.net/gmp-setbit">
 <link rel="alternate" href="https://www.php.net/gmp-setbit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.gmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-scan1.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-sign.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gmp-setbit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gmp-setbit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gmp-setbit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gmp-setbit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gmp-setbit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gmp-setbit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gmp-setbit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gmp-setbit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gmp-setbit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gmp-setbit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gmp-setbit.php" hreflang="zh">
...
<meta name="Description" content="Set bit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gmp_setbit - Manual" />
<meta name="twitter:description" content="Set bit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_setbit - Manual" />
<meta itemprop="description" content="Set bit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set bit" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.gmp-sign.php">
          gmp_sign &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.gmp-scan1.php">
          &laquo; gmp_scan1        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-setbit.php' selected="selected">English</option>
            <option value='de/function.gmp-setbit.php'>German</option>
            <option value='es/function.gmp-setbit.php'>Spanish</option>
            <option value='fr/function.gmp-setbit.php'>French</option>
            <option value='it/function.gmp-setbit.php'>Italian</option>
            <option value='ja/function.gmp-setbit.php'>Japanese</option>
            <option value='pt_BR/function.gmp-setbit.php'>Brazilian Portuguese</option>
            <option value='ru/function.gmp-setbit.php'>Russian</option>
            <option value='tr/function.gmp-setbit.php'>Turkish</option>
            <option value='uk/function.gmp-setbit.php'>Ukrainian</option>
            <option value='zh/function.gmp-setbit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gmp-setbit" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-setbit-examples">
  ...
  <p class="para">
   <div class="example" id="example-3349">
    <p><strong>Example #1 <span class="function"><strong>gmp_setbit()</strong></span> example - 0 index</strong></p>
...
3 -&gt; 0b11</pre>
   ...
   <div class="example" id="example-3350">
    <p><strong>Example #2 <span class="function"><strong>gmp_setbit()</strong></span> example - 1 index</strong></p>
    <div class="example-contents">
...
255 -&gt; 0b11111111</pre>
   ...
   <div class="example" id="example-3351">
    <p><strong>Example #3 <span class="function"><strong>gmp_setbit()</strong></span> example - clearing a bit</strong></p>
    <div class="example-contents">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-testbit.php" class="function" rel="rdfs-seeAlso">gmp_testbit()</a> - Tests if a bit is set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-setbit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-setbit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-setbit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-setbit.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="76719">  <div class="votes">
    <div id="Vu76719">
    <a href="/manual/vote-note.php?id=76719&amp;page=function.gmp-setbit&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd76719">
    <a href="/manual/vote-note.php?id=76719&amp;page=function.gmp-setbit&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V76719" title="50% like this...">
    0
    </div>
  </div>
  <a href="#76719" class="name">
  <strong class="user"><em>bluej100@gmail</em></strong></a><a class="genanchor" href="#76719"> &para;</a><div class="date" title="2007-07-27 09:07"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom76719">
<div class="phpcode"><code><span class="html">The third parameter is somewhat confusingly named; it would probably be better described as "$set_state". If true, it sets the bit to 1. If false, it sets the bit to 0. Default is true.<br /><br /><span class="default">&lt;?php<br />$num </span><span class="keyword">= </span><span class="default">gmp_init</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">gmp_setbit</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">);<br />echo </span><span class="string">'gmp_setbit(1, 1): '</span><span class="keyword">.</span><span class="default">gmp_strval</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// 11<br /><br /></span><span class="default">$num </span><span class="keyword">= </span><span class="default">gmp_init</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">gmp_setbit</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br />echo </span><span class="string">'gmp_setbit(1, 1, true): '</span><span class="keyword">.</span><span class="default">gmp_strval</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// 11<br /><br /></span><span class="default">$num </span><span class="keyword">= </span><span class="default">gmp_init</span><span class="keyword">(</span><span class="default">1</span><span class="keyword">);<br /></span><span class="default">gmp_setbit</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br />echo </span><span class="string">'gmp_setbit(1, 0, false): '</span><span class="keyword">.</span><span class="default">gmp_strval</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">).</span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// 0<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.gmp-setbit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-setbit.php">＋<small>add a note</small></a></div>
