...
<head>
  ...
  <title>PHP: ps_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-delete.php">
 <link rel="shorturl" href="https://www.php.net/ps-delete">
 <link rel="alternate" href="https://www.php.net/ps-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-curveto.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-end-page.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-delete.php" hreflang="zh">
...
<meta name="Description" content="Deletes all resources of a PostScript document" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_delete - Manual" />
<meta name="twitter:description" content="Deletes all resources of a PostScript document" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_delete - Manual" />
<meta itemprop="description" content="Deletes all resources of a PostScript document" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Deletes all resources of a PostScript document" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ps-end-page.php">
          ps_end_page &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ps-curveto.php">
          &laquo; ps_curveto        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-delete.php' selected="selected">English</option>
            <option value='de/function.ps-delete.php'>German</option>
            <option value='es/function.ps-delete.php'>Spanish</option>
            <option value='fr/function.ps-delete.php'>French</option>
            <option value='it/function.ps-delete.php'>Italian</option>
            <option value='ja/function.ps-delete.php'>Japanese</option>
            <option value='pt_BR/function.ps-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-delete.php'>Russian</option>
            <option value='tr/function.ps-delete.php'>Turkish</option>
            <option value='uk/function.ps-delete.php'>Ukrainian</option>
            <option value='zh/function.ps-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-delete" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ps_delete</h1>
  <p class="verinfo">(PECL ps &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ps_delete</span> &mdash; <span class="dc-title">Deletes all resources of a PostScript document</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ps-delete-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ps_delete</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$psdoc</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Mainly frees memory used by the document. Also closes a file, if it was not
   closed before with <span class="function"><a href="function.ps-close.php" class="function">ps_close()</a></span>. You should in any case
   close the file with <span class="function"><a href="function.ps-close.php" class="function">ps_close()</a></span> before, because
   <span class="function"><a href="function.ps-close.php" class="function">ps_close()</a></span> not just closes the file but also outputs a
 ...
 <div class="refsect1 parameters" id="refsect1-function.ps-delete-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ps-delete-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ps-delete-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-close.php" class="function" rel="rdfs-seeAlso">ps_close()</a> - Closes a PostScript document</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-delete.php">＋<small>add a note</small></a></span>
