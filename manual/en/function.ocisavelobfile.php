...
<head>
  ...
  <title>PHP: ocisavelobfile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocisavelobfile.php">
 <link rel="shorturl" href="https://www.php.net/ocisavelobfile">
 <link rel="alternate" href="https://www.php.net/ocisavelobfile" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocisavelob.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociserverversion.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocisavelobfile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocisavelobfile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocisavelobfile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocisavelobfile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocisavelobfile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocisavelobfile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocisavelobfile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocisavelobfile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocisavelobfile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocisavelobfile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocisavelobfile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ocisavelobfile - Manual" />
<meta name="twitter:description" content="Alias of OCILob::import" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocisavelobfile - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocisavelobfile.php' selected="selected">English</option>
            <option value='de/function.ocisavelobfile.php'>German</option>
            <option value='es/function.ocisavelobfile.php'>Spanish</option>
            <option value='fr/function.ocisavelobfile.php'>French</option>
            <option value='it/function.ocisavelobfile.php'>Italian</option>
            <option value='ja/function.ocisavelobfile.php'>Japanese</option>
            <option value='pt_BR/function.ocisavelobfile.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocisavelobfile.php'>Russian</option>
            <option value='tr/function.ocisavelobfile.php'>Turkish</option>
            <option value='uk/function.ocisavelobfile.php'>Ukrainian</option>
            <option value='zh/function.ocisavelobfile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocisavelobfile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocisavelobfile</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocisavelobfile</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="ocilob.import.php" class="function">OCILob::import()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocisavelobfile-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="ocilob.import.php" class="function">OCILob::import()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocisavelobfile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocisavelobfile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocisavelobfile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocisavelobfile.php">＋<small>add a note</small></a></span>
