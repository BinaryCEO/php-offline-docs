...
<head>
  ...
  <title>PHP: eio_truncate - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.eio-truncate.php">
 <link rel="shorturl" href="https://www.php.net/eio-truncate">
 <link rel="alternate" href="https://www.php.net/eio-truncate" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.eio.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.eio-syncfs.php">
 <link rel="next" href="https://www.php.net/manual/en/function.eio-unlink.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.eio-truncate.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.eio-truncate.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.eio-truncate.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.eio-truncate.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.eio-truncate.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.eio-truncate.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.eio-truncate.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.eio-truncate.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.eio-truncate.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.eio-truncate.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.eio-truncate.php" hreflang="zh">
...
<meta name="Description" content="Truncate a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: eio_truncate - Manual" />
<meta name="twitter:description" content="Truncate a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: eio_truncate - Manual" />
<meta itemprop="description" content="Truncate a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Truncate a file" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.eio-unlink.php">
          eio_unlink &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.eio-syncfs.php">
          &laquo; eio_syncfs        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.eio-truncate.php' selected="selected">English</option>
            <option value='de/function.eio-truncate.php'>German</option>
            <option value='es/function.eio-truncate.php'>Spanish</option>
            <option value='fr/function.eio-truncate.php'>French</option>
            <option value='it/function.eio-truncate.php'>Italian</option>
            <option value='ja/function.eio-truncate.php'>Japanese</option>
            <option value='pt_BR/function.eio-truncate.php'>Brazilian Portuguese</option>
            <option value='ru/function.eio-truncate.php'>Russian</option>
            <option value='tr/function.eio-truncate.php'>Turkish</option>
            <option value='uk/function.eio-truncate.php'>Ukrainian</option>
            <option value='zh/function.eio-truncate.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.eio-truncate" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">eio_truncate</h1>
  <p class="verinfo">(PECL eio &gt;= 0.0.1dev)</p><p class="refpurpose"><span class="refname">eio_truncate</span> &mdash; <span class="dc-title">Truncate a file</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.eio-truncate-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>eio_truncate</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$offset</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pri</code><span class="initializer"> = EIO_PRI_DEFAULT</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span> <code class="parameter">$callback</code><span class="initializer"> = NULL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$data</code><span class="initializer"> = NULL</span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
  <span class="function"><strong>eio_truncate()</strong></span> causes the regular file named by <code class="parameter">path</code> to be truncated to
  a size of precisely <code class="parameter">length</code> bytes
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.eio-truncate-parameters">
...
<dd><p class="para">is optional request resource which can be used with functions like <span class="function"><a href="function.eio-get-last-error.php" class="function">eio_get_last_error()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.eio-truncate-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   <span class="function"><a href="function.eio-busy.php" class="function">eio_busy()</a></span> returns request resource on success, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.eio-truncate-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.eio-ftruncate.php" class="function" rel="rdfs-seeAlso">eio_ftruncate()</a> - Truncate a file</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/eio/functions/eio-truncate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.eio-truncate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.eio-truncate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.eio-truncate.php">＋<small>add a note</small></a></span>
