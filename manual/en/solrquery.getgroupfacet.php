...
<head>
  ...
  <title>PHP: SolrQuery::getGroupFacet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupcachepercent.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfacet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupfacet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupfacet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupfacet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupfacet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupfacet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupfacet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupfacet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupfacet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupfacet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupfacet.php" hreflang="zh">
...
<meta name="Description" content="Returns the group.facet parameter value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupFacet - Manual" />
<meta name="twitter:description" content="Returns the group.facet parameter value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupFacet - Manual" />
<meta itemprop="description" content="Returns the group.facet parameter value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the group.facet parameter value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getgroupfields.php">
          SolrQuery::getGroupFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupcachepercent.php">
          &laquo; SolrQuery::getGroupCachePercent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupfacet.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupfacet.php'>German</option>
            <option value='es/solrquery.getgroupfacet.php'>Spanish</option>
            <option value='fr/solrquery.getgroupfacet.php'>French</option>
            <option value='it/solrquery.getgroupfacet.php'>Italian</option>
            <option value='ja/solrquery.getgroupfacet.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupfacet.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupfacet.php'>Russian</option>
            <option value='tr/solrquery.getgroupfacet.php'>Turkish</option>
            <option value='uk/solrquery.getgroupfacet.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupfacet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupfacet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupFacet</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupFacet</span> &mdash; <span class="dc-title">Returns the group.facet parameter value</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupfacet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupFacet</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupfacet-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupfacet-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupfacet-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.setgroupfacet.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::setGroupFacet()</a> - Sets group.facet parameter</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupfacet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupfacet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupfacet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupfacet.php">＋<small>add a note</small></a></span>
