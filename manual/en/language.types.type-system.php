...
<head>
  ...
  <title>PHP: Type System - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.types.type-system.php">
 <link rel="shorturl" href="https://www.php.net/types.type-system">
 <link rel="alternate" href="https://www.php.net/types.type-system" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.types.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.types.intro.php">
 <link rel="next" href="https://www.php.net/manual/en/language.types.null.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.types.type-system.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.types.type-system.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.types.type-system.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.types.type-system.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.types.type-system.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.types.type-system.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.types.type-system.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.types.type-system.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.types.type-system.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.types.type-system.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.types.type-system.php" hreflang="zh">
...
<meta name="Description" content="Type System" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Type System - Manual" />
<meta name="twitter:description" content="Type System" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Type System - Manual" />
<meta itemprop="description" content="Type System" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Type System" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="language.types.null.php">
          NULL &raquo;
              ...
              <div class="prev">
        <a href="language.types.intro.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.types.type-system.php' selected="selected">English</option>
            <option value='de/language.types.type-system.php'>German</option>
            <option value='es/language.types.type-system.php'>Spanish</option>
            <option value='fr/language.types.type-system.php'>French</option>
            <option value='it/language.types.type-system.php'>Italian</option>
            <option value='ja/language.types.type-system.php'>Japanese</option>
            <option value='pt_BR/language.types.type-system.php'>Brazilian Portuguese</option>
            <option value='ru/language.types.type-system.php'>Russian</option>
            <option value='tr/language.types.type-system.php'>Turkish</option>
            <option value='uk/language.types.type-system.php'>Ukrainian</option>
            <option value='zh/language.types.type-system.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.types.type-system" class="sect1">
   ...
   <span class="simpara">
    PHP does not support user-defined type aliases.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/types/type-system.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types.type-system%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.type-system&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.type-system.php">＋<small>add a note</small></a></span>
